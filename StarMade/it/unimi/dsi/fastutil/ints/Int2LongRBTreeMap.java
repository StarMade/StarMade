...
/*      */ 
/*      */ public class Int2LongRBTreeMap extends AbstractInt2LongSortedMap
...
/*      */   protected volatile transient ObjectSortedSet<Int2LongMap.Entry> entries;
...
/*  119 */           return Int2LongRBTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  122 */           return Int2LongRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     long oldValue = put(ok.intValue(), ov.longValue());
/*  731 */     return this.modified ? null : Long.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Long remove(Object ok)
/*      */   {
/*  737 */     long oldValue = remove(((Integer)ok).intValue());
...
/* 1141 */         final Comparator<? super Int2LongMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2LongMap.Entry x, Int2LongMap.Entry y) {
/* 1143 */             return Int2LongRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Int2LongRBTreeMap.EntryIterator(Int2LongRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry from) {
/* 1153 */           return new Int2LongRBTreeMap.EntryIterator(Int2LongRBTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Int2LongRBTreeMap.Entry f = Int2LongRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1166 */           Int2LongRBTreeMap.Entry f = Int2LongRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1167 */           if (f != null) Int2LongRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Int2LongRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Int2LongRBTreeMap.this.clear(); } 
/* 1172 */         public Int2LongMap.Entry first() { return Int2LongRBTreeMap.this.firstEntry; } 
/* 1173 */         public Int2LongMap.Entry last() { return Int2LongRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry from, Int2LongMap.Entry to) { return Int2LongRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2LongEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry to) { return Int2LongRBTreeMap.this.headMap((Integer)to.getKey()).int2LongEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry from) { return Int2LongRBTreeMap.this.tailMap((Integer)from.getKey()).int2LongEntrySet(); }
/*      */       };
...
/* 1242 */           return new Int2LongRBTreeMap.ValueIterator(Int2LongRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(long k) {
/* 1245 */           return Int2LongRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Int2LongRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Int2LongRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Int2LongRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readInt(), s.readLong());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readInt(), s.readLong());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readInt(), s.readLong()));
...
/*      */ 
/*      */ 
/*      */   private final class Submap extends AbstractInt2LongSortedMap
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Int2LongRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Int2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator() {
/* 1329 */             return new Int2LongRBTreeMap.Submap.SubmapEntryIterator(Int2LongRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry from) {
/* 1332 */             return new Int2LongRBTreeMap.Submap.SubmapEntryIterator(Int2LongRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1334 */           public Comparator<? super Int2LongMap.Entry> comparator() { return Int2LongRBTreeMap.this.int2LongEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Int2LongRBTreeMap.Entry f = Int2LongRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1340 */             return (f != null) && (Int2LongRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Int2LongRBTreeMap.Entry f = Int2LongRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1347 */             if ((f != null) && (Int2LongRBTreeMap.Submap.this.in(f.key))) Int2LongRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Int2LongRBTreeMap.Submap.SubmapIterator(Int2LongRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Int2LongRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Int2LongMap.Entry first() { return Int2LongRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Int2LongMap.Entry last() { return Int2LongRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry from, Int2LongMap.Entry to) { return Int2LongRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2LongEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry to) { return Int2LongRBTreeMap.Submap.this.headMap((Integer)to.getKey()).int2LongEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry from) { return Int2LongRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2LongEntrySet(); }
/*      */         };
...
/*      */           public LongIterator iterator() {
/* 1376 */             return new Int2LongRBTreeMap.Submap.SubmapValueIterator(Int2LongRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(long k) {
/* 1379 */             return Int2LongRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Int2LongRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Int2LongRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1392 */       return (in(k)) && (Int2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(long v) {
...
/* 1407 */       return (in(kk)) && ((e = Int2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public long put(int k, long v) {
/* 1410 */       Int2LongRBTreeMap.this.modified = false;
...
/* 1412 */       long oldValue = Int2LongRBTreeMap.this.put(k, v);
/* 1413 */       return Int2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Long put(Integer ok, Long ov) {
/* 1416 */       long oldValue = put(ok.intValue(), ov.longValue());
/* 1417 */       return Int2LongRBTreeMap.this.modified ? null : Long.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public long remove(int k) {
/* 1421 */       Int2LongRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       long oldValue = Int2LongRBTreeMap.this.remove(k);
/* 1424 */       return Int2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Long remove(Object ok) {
/* 1427 */       long oldValue = remove(((Integer)ok).intValue());
/* 1428 */       return Int2LongRBTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1443 */       return Int2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2LongSortedMap headMap(int to) {
/* 1446 */       if (this.top) return new Submap(Int2LongRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Int2LongRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2LongRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2LongSortedMap tailMap(int from) {
/* 1450 */       if (this.bottom) return new Submap(Int2LongRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Int2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2LongRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2LongSortedMap subMap(int from, int to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Int2LongRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Int2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Int2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Int2LongRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2LongRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Int2LongRBTreeMap.this.tree == null) return null;
/* 1468 */       Int2LongRBTreeMap.Entry e;
/*      */       Int2LongRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Int2LongRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Int2LongRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Int2LongRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Int2LongRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2LongRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Int2LongRBTreeMap.this.tree == null) return null;
/* 1486 */       Int2LongRBTreeMap.Entry e;
/*      */       Int2LongRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Int2LongRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Int2LongRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Int2LongRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Int2LongRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1497 */       Int2LongRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1502 */       Int2LongRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1507 */       Int2LongRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1512 */       Int2LongRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2LongRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2LongRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2LongRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Int2LongMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Int2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Int2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Int2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Int2LongRBTreeMap.Submap.this.bottom) && (Int2LongRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Int2LongRBTreeMap.Submap.this.top) && (Int2LongRBTreeMap.this.compare(k, (this.prev = Int2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Int2LongRBTreeMap.this.locateKey(k);
/* 1534 */             if (Int2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Int2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2LongRBTreeMap.this.compare(this.prev.key, Int2LongRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Int2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Int2LongRBTreeMap.this.compare(this.next.key, Int2LongRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public IntBidirectionalIterator iterator() { return new Int2LongRBTreeMap.Submap.SubmapKeyIterator(Int2LongRBTreeMap.Submap.this); } 
/* 1367 */       public IntBidirectionalIterator iterator(int from) { return new Int2LongRBTreeMap.Submap.SubmapKeyIterator(Int2LongRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2LongRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public IntBidirectionalIterator iterator() { return new Int2LongRBTreeMap.KeyIterator(Int2LongRBTreeMap.this); } 
/* 1201 */     public IntBidirectionalIterator iterator(int from) { return new Int2LongRBTreeMap.KeyIterator(Int2LongRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2LongRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2LongRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2LongMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Int2LongMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Int2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Int2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Int2LongRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1067 */       if ((this.next = Int2LongRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Int2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Int2LongRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */     implements Cloneable, Int2LongMap.Entry
/*      */   {
...
/*      */ 
/*  979 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
