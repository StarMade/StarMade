  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2LongRBTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2LongRBTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2LongRBTreeMap(Map<? extends Integer, ? extends Long> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2LongRBTreeMap(SortedMap<Integer, Long> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2LongRBTreeMap(Int2LongMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2LongRBTreeMap(Int2LongSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2LongRBTreeMap(int[] local_k, long[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2LongRBTreeMap(int[] local_k, long[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2LongMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Int2LongRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2LongRBTreeMap.EntryIterator(Int2LongRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry from)
        {
          return new Int2LongRBTreeMap.EntryIterator(Int2LongRBTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2LongRBTreeMap.Entry local_f = Int2LongRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2LongRBTreeMap.Entry local_f = Int2LongRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2LongRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2LongRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2LongEntrySet();
        }
        
        public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry local_to)
        {
          return Int2LongRBTreeMap.this.headMap((Integer)local_to.getKey()).int2LongEntrySet();
        }
        
        public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry from)
        {
          return Int2LongRBTreeMap.this.tailMap((Integer)from.getKey()).int2LongEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Int2LongRBTreeMap.ValueIterator(Int2LongRBTreeMap.this, null);
        }
        
        public boolean contains(long local_k)
        {
          return Int2LongRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2LongRBTreeMap local_c;
    try
    {
      local_c = (Int2LongRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2LongRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Int2LongRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2LongRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator()
          {
            return new Int2LongRBTreeMap.Submap.SubmapEntryIterator(Int2LongRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry from)
          {
            return new Int2LongRBTreeMap.Submap.SubmapEntryIterator(Int2LongRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, Long> local_e = (Map.Entry)local_o;
            Int2LongRBTreeMap.Entry local_f = Int2LongRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2LongRBTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, Long> local_e = (Map.Entry)local_o;
            Int2LongRBTreeMap.Entry local_f = Int2LongRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2LongRBTreeMap.Submap.this.in4(local_f.key))) {
              Int2LongRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2LongRBTreeMap.Submap.SubmapIterator(Int2LongRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2LongRBTreeMap.Submap.this.clear();
          }
          
          public Int2LongMap.Entry first()
          {
            return Int2LongRBTreeMap.Submap.this.firstEntry();
          }
          
          public Int2LongMap.Entry last()
          {
            return Int2LongRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry from, Int2LongMap.Entry local_to)
          {
            return Int2LongRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2LongEntrySet();
          }
          
          public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry local_to)
          {
            return Int2LongRBTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2LongEntrySet();
          }
          
          public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry from)
          {
            return Int2LongRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2LongEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public LongCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractLongCollection()
        {
          public LongIterator iterator()
          {
            return new Int2LongRBTreeMap.Submap.SubmapValueIterator(Int2LongRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(long local_k)
          {
            return Int2LongRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2LongRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2LongRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2LongRBTreeMap.Entry local_e;
      return (in4(local_kk)) && ((local_e = Int2LongRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public long put(int local_k, long local_v)
    {
      ...
      long oldValue = Int2LongRBTreeMap.this.put(local_k, local_v);
    ...
    public long remove(int local_k)
    {
      ...
      long oldValue = Int2LongRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2LongRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2LongRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2LongRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2LongSortedMap tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2LongRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2LongRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2LongSortedMap subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2LongRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2LongRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2LongRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2LongRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2LongRBTreeMap.this.locateKey(this.from);
        if (Int2LongRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2LongRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2LongRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2LongRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2LongRBTreeMap.this.locateKey(this.field_47);
        if (Int2LongRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2LongRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2LongRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2LongRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Int2LongRBTreeMap.Submap.SubmapIterator
      ...
      extends Int2LongRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Int2LongRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2LongRBTreeMap.Submap.this.bottom) && (Int2LongRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2LongRBTreeMap.Submap.this.top) && (Int2LongRBTreeMap.this.compare(local_k, (this.prev = Int2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2LongRBTreeMap.this.locateKey(local_k);
            if (Int2LongRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2LongRBTreeMap.this.compare(this.prev.key, Int2LongRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Int2LongRBTreeMap.this.compare(this.next.key, Int2LongRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2LongSortedMap.KeySet
    {
      ...
      {
        return new Int2LongRBTreeMap.Submap.SubmapKeyIterator(Int2LongRBTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2LongRBTreeMap.Submap.SubmapKeyIterator(Int2LongRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2LongSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2LongRBTreeMap.KeyIterator(Int2LongRBTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2LongRBTreeMap.KeyIterator(Int2LongRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2LongRBTreeMap.this.locateKey(local_k)) != null) {
        if (Int2LongRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
