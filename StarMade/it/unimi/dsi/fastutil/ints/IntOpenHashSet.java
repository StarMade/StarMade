...
/*  13:    */
/*  78:    */public class IntOpenHashSet
/*  79:    */  extends AbstractIntSet
...
/*  84:    */  protected transient int[] key;
...
/*  91:    */  
/*  92:    */  public IntOpenHashSet(int expected, float f)
/*  93:    */  {
...
/* 100:100 */    this.key = new int[this.n];
/* 101:101 */    this.used = new boolean[this.n];
/* 102:    */  }
/* 103:    */  
/* 106:    */  public IntOpenHashSet(int expected)
/* 107:    */  {
/* 108:108 */    this(expected, 0.75F);
/* 109:    */  }
/* 110:    */  
/* 112:    */  public IntOpenHashSet()
/* 113:    */  {
/* 114:114 */    this(16, 0.75F);
/* 115:    */  }
/* 116:    */  
/* 120:    */  public IntOpenHashSet(Collection<? extends Integer> c, float f)
/* 121:    */  {
/* 122:122 */    this(c.size(), f);
/* 123:123 */    addAll(c);
/* 124:    */  }
/* 125:    */  
/* 129:    */  public IntOpenHashSet(Collection<? extends Integer> c)
/* 130:    */  {
/* 131:131 */    this(c, 0.75F);
/* 132:    */  }
/* 133:    */  
/* 137:    */  public IntOpenHashSet(IntCollection c, float f)
/* 138:    */  {
/* 139:139 */    this(c.size(), f);
/* 140:140 */    addAll(c);
/* 141:    */  }
/* 142:    */  
/* 146:    */  public IntOpenHashSet(IntCollection c)
/* 147:    */  {
/* 148:148 */    this(c, 0.75F);
/* 149:    */  }
/* 150:    */  
/* 154:    */  public IntOpenHashSet(IntIterator i, float f)
/* 155:    */  {
/* 156:156 */    this(16, f);
/* 157:157 */    while (i.hasNext()) { add(i.nextInt());
/* 158:    */    }
/* 159:    */  }
/* 160:    */  
/* 162:    */  public IntOpenHashSet(IntIterator i)
/* 163:    */  {
/* 164:164 */    this(i, 0.75F);
/* 165:    */  }
/* 166:    */  
/* 170:    */  public IntOpenHashSet(Iterator<?> i, float f)
/* 171:    */  {
/* 172:172 */    this(IntIterators.asIntIterator(i), f);
/* 173:    */  }
/* 174:    */  
/* 177:    */  public IntOpenHashSet(Iterator<?> i)
/* 178:    */  {
/* 179:179 */    this(IntIterators.asIntIterator(i));
/* 180:    */  }
/* 181:    */  
/* 187:    */  public IntOpenHashSet(int[] a, int offset, int length, float f)
/* 188:    */  {
/* 189:189 */    this(length < 0 ? 0 : length, f);
/* 190:190 */    IntArrays.ensureOffsetLength(a, offset, length);
/* 191:191 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 192:    */    }
/* 193:    */  }
/* 194:    */  
/* 198:    */  public IntOpenHashSet(int[] a, int offset, int length)
/* 199:    */  {
/* 200:200 */    this(a, offset, length, 0.75F);
/* 201:    */  }
/* 202:    */  
/* 206:    */  public IntOpenHashSet(int[] a, float f)
/* 207:    */  {
/* 208:208 */    this(a, 0, a.length, f);
/* 209:    */  }
/* 210:    */  
/* 214:    */  public IntOpenHashSet(int[] a)
/* 215:    */  {
/* 216:216 */    this(a, 0.75F);
/* 217:    */  }
/* 218:    */  
/* 222:    */  public boolean add(int k)
/* 223:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 259:    */  public boolean remove(int k)
/* 260:    */  {
...
/* 273:    */  }
/* 274:    */  
/* 275:    */  public boolean contains(int k)
/* 276:    */  {
...
/* 318:    */  
/* 319:    */  private class SetIterator extends AbstractIntIterator {
/* 320:    */    int pos;
/* 321:    */    int last;
/* 322:    */    
/* 323:323 */    private SetIterator() { this.pos = IntOpenHashSet.this.n;
/* 324:    */      
/* 326:326 */      this.last = -1;
/* 327:    */      
/* 328:328 */      this.c = IntOpenHashSet.this.size;
/* 329:    */      
/* 333:333 */      boolean[] used = IntOpenHashSet.this.used;
/* 334:334 */      while ((this.c != 0) && (used[(--this.pos)] == 0)) {}
/* 335:    */    }
/* 336:    */    
/* 337:337 */    public boolean hasNext() { return this.c != 0; }
/* 338:    */    
/* 339:    */    public int nextInt() {
/* 340:340 */      if (!hasNext()) throw new NoSuchElementException();
/* 341:341 */      this.c -= 1;
/* 342:    */      
/* 343:343 */      if (this.pos < 0) return this.wrapped.getInt(-(this.last = --this.pos) - 2);
/* 344:344 */      int retVal = IntOpenHashSet.this.key[(this.last = this.pos)];
/* 345:    */      
/* 346:346 */      if (this.c != 0) {
/* 347:347 */        boolean[] used = IntOpenHashSet.this.used;
...
/* 362:    */      for (;;)
/* 363:    */      {
/* 364:364 */        pos = (last = pos) + 1 & IntOpenHashSet.this.mask;
/* 365:365 */        while (IntOpenHashSet.this.used[pos] != 0) {
/* 366:366 */          int slot = HashCommon.murmurHash3(IntOpenHashSet.this.key[pos]) & IntOpenHashSet.this.mask;
/* 367:367 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 368:368 */          pos = pos + 1 & IntOpenHashSet.this.mask;
/* 369:    */        }
/* 370:370 */        if (IntOpenHashSet.this.used[pos] == 0) break;
/* 371:371 */        if (pos < last)
/* 372:    */        {
/* 373:373 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 374:374 */          this.wrapped.add(IntOpenHashSet.this.key[pos]);
/* 375:    */        }
/* 376:376 */        IntOpenHashSet.this.key[last] = IntOpenHashSet.this.key[pos];
/* 377:    */      }
/* 378:378 */      IntOpenHashSet.this.used[last] = false;
/* 379:379 */      return last;
/* 380:    */    }
/* 381:    */    
...
/* 385:    */      {
/* 386:386 */        IntOpenHashSet.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 387:387 */        this.last = -1;
/* 388:388 */        return;
/* 389:    */      }
/* 390:390 */      IntOpenHashSet.this.size -= 1;
...
/* 397:    */  }
/* 398:    */  
/* 399:    */  public IntIterator iterator() {
...
/* 477:    */    
/* 478:478 */    int[] key = this.key;
/* 479:479 */    int newMask = newN - 1;
/* 480:480 */    int[] newKey = new int[newN];
...
/* 496:    */  }
/* 497:    */  
/* 501:    */  public IntOpenHashSet clone()
/* 502:    */  {
/* 503:    */    IntOpenHashSet c;
/* 504:    */    
/* 506:    */    try
/* 507:    */    {
/* 508:508 */      c = (IntOpenHashSet)super.clone();
/* 509:    */    }
/* 510:    */    catch (CloneNotSupportedException cantHappen) {
/* 511:511 */      throw new InternalError();
/* 512:    */    }
/* 513:513 */    c.key = ((int[])this.key.clone());
...
/* 534:    */  }
/* 535:    */  
/* 536:536 */  private void writeObject(ObjectOutputStream s) throws IOException { IntIterator i = iterator();
/* 537:537 */    s.defaultWriteObject();
/* 538:538 */    for (int j = this.size; j-- != 0; s.writeInt(i.nextInt())) {}
/* 539:    */  }
/* 540:    */  
