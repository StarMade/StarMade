  ...
  implements Serializable, Cloneable, IntSortedSet
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return IntAVLTreeSet.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public IntAVLTreeSet(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public IntAVLTreeSet(Collection<? extends Integer> local_c)
  {
    this();
    addAll(local_c);
  }
  
  public IntAVLTreeSet(SortedSet<Integer> local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public IntAVLTreeSet(IntCollection local_c)
  {
    this();
    addAll(local_c);
  }
  
  public IntAVLTreeSet(IntSortedSet local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public IntAVLTreeSet(IntIterator local_i)
  {
    allocatePaths();
  ...
  public IntAVLTreeSet(Iterator<? extends Integer> local_i)
  {
    this(IntIterators.asIntIterator(local_i));
  }
  
  public IntAVLTreeSet(int[] local_a, int offset, int length, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public IntAVLTreeSet(int[] local_a, int offset, int length)
  {
    this(local_a, offset, length, null);
  }
  
  public IntAVLTreeSet(int[] local_a)
  {
    this();
  ...
  public IntAVLTreeSet(int[] local_a, Comparator<? super Integer> local_c)
  {
    this(local_c);
    int local_i = local_a.length;
    while (local_i-- != 0) {
  ...
  public Object clone()
  {
    IntAVLTreeSet local_c;
    try
    {
      local_c = (IntAVLTreeSet)super.clone();
    }
    ...
    implements Serializable, IntSortedSet
  {
    ...
    {
      if ((!bottom) && (!top) && (IntAVLTreeSet.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (IntAVLTreeSet.this.compare(local_k, this.from) >= 0)) && ((this.top) || (IntAVLTreeSet.this.compare(local_k, this.field_328) < 0));
    }
    
    public boolean contains(int local_k)
    {
      return (in(local_k)) && (IntAVLTreeSet.this.contains(local_k));
    }
    ...
    public boolean add(int local_k)
    {
      ...
      return IntAVLTreeSet.this.add(local_k);
    }
    ...
    public boolean remove(int local_k)
    {
      ...
      return IntAVLTreeSet.this.remove(local_k);
    }
    ...
    {
      if (this.top) {
        return new Subset(IntAVLTreeSet.this, this.from, this.bottom, local_to, false);
      }
      return IntAVLTreeSet.this.compare(local_to, this.field_328) < 0 ? new Subset(IntAVLTreeSet.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public IntSortedSet tailSet(int from)
    {
      if (this.bottom) {
        return new Subset(IntAVLTreeSet.this, from, false, this.field_328, this.top);
      }
      return IntAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(IntAVLTreeSet.this, from, false, this.field_328, this.top) : this;
    }
    
    public IntSortedSet subSet(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Subset(IntAVLTreeSet.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = IntAVLTreeSet.this.compare(local_to, this.field_328) < 0 ? local_to : this.field_328;
      }
      if (!this.bottom) {
    ...
    public IntAVLTreeSet.Entry firstEntry()
    {
      ...
      IntAVLTreeSet.Entry local_e;
      IntAVLTreeSet.Entry local_e;
      if (this.bottom)
      {
        local_e = IntAVLTreeSet.this.firstEntry;
      }
      else
      {
        local_e = IntAVLTreeSet.this.locateKey(this.from);
        if (IntAVLTreeSet.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (IntAVLTreeSet.this.compare(local_e.key, this.field_328) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public IntAVLTreeSet.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = IntAVLTreeSet.this.lastEntry;
      }
      else
      {
        local_e = IntAVLTreeSet.this.locateKey(this.field_328);
        if (IntAVLTreeSet.this.compare(local_e.key, this.field_328) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (IntAVLTreeSet.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstInt()
    {
      IntAVLTreeSet.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastInt()
    {
      IntAVLTreeSet.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends IntAVLTreeSet.SetIterator
    {
      ...
      {
        super();
        this.next = IntAVLTreeSet.Subset.this.firstEntry();
      }
      ...
      SubsetIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!IntAVLTreeSet.Subset.this.bottom) && (IntAVLTreeSet.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!IntAVLTreeSet.Subset.this.top) && (IntAVLTreeSet.this.compare(local_k, (this.prev = IntAVLTreeSet.Subset.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = IntAVLTreeSet.this.locateKey(local_k);
            if (IntAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!IntAVLTreeSet.Subset.this.bottom) && (this.prev != null) && (IntAVLTreeSet.this.compare(this.prev.key, IntAVLTreeSet.Subset.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!IntAVLTreeSet.Subset.this.top) && (this.next != null) && (IntAVLTreeSet.this.compare(this.next.key, IntAVLTreeSet.Subset.this.field_328) >= 0)) {
          this.next = null;
        }
      }
    }
    ...
    extends AbstractIntListIterator
  {
    ...
    {
      if ((this.next = IntAVLTreeSet.this.locateKey(local_k)) != null) {
        if (IntAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
