...
/*  18:    */
/*  87:    */public class Int2FloatOpenHashMap
/*  88:    */  extends AbstractInt2FloatMap
...
/* 101:    */  protected volatile transient Int2FloatMap.FastEntrySet entries;
/* 102:    */  protected volatile transient IntSet keys;
/* 103:    */  protected volatile transient FloatCollection values;
/* 104:    */  
/* 105:    */  public Int2FloatOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Int2FloatOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Int2FloatOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Int2FloatOpenHashMap(Map<? extends Integer, ? extends Float> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Int2FloatOpenHashMap(Map<? extends Integer, ? extends Float> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Int2FloatOpenHashMap(Int2FloatMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Int2FloatOpenHashMap(Int2FloatMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Int2FloatOpenHashMap(int[] k, float[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Int2FloatOpenHashMap(int[] k, float[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public float put(int k, float v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Float put(Integer ok, Float ov) { float v = ov.floatValue();
...
/* 226:    */  }
/* 227:    */  
/* 238:    */  public float add(int k, float incr)
/* 239:    */  {
...
/* 312:    */  }
/* 313:    */  
/* 314:314 */  public Float get(Integer ok) { int k = ok.intValue();
/* 315:    */    
...
/* 389:    */    implements Int2FloatMap.Entry, Map.Entry<Integer, Float>
/* 390:    */  {
...
/* 396:    */    }
/* 397:    */    
/* 398:398 */    public Integer getKey() { return Integer.valueOf(Int2FloatOpenHashMap.this.key[this.index]); }
/* 399:    */    
/* 400:    */    public int getIntKey() {
/* 401:401 */      return Int2FloatOpenHashMap.this.key[this.index];
/* 402:    */    }
/* 403:    */    
/* 404:404 */    public Float getValue() { return Float.valueOf(Int2FloatOpenHashMap.this.value[this.index]); }
/* 405:    */    
/* 407:407 */    public float getFloatValue() { return Int2FloatOpenHashMap.this.value[this.index]; }
/* 408:    */    
/* 409:    */    public float setValue(float v) {
/* 410:410 */      float oldValue = Int2FloatOpenHashMap.this.value[this.index];
/* 411:411 */      Int2FloatOpenHashMap.this.value[this.index] = v;
...
/* 420:420 */      Map.Entry<Integer, Float> e = (Map.Entry)o;
/* 421:421 */      return (Int2FloatOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2FloatOpenHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public int hashCode() { return Int2FloatOpenHashMap.this.key[this.index] ^ HashCommon.float2int(Int2FloatOpenHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public String toString() { return Int2FloatOpenHashMap.this.key[this.index] + "=>" + Int2FloatOpenHashMap.this.value[this.index]; } }
/* 428:    */  
...
/* 433:    */    
/* 434:434 */    private MapIterator() { this.pos = Int2FloatOpenHashMap.this.n;
/* 435:    */      
/* 437:437 */      this.last = -1;
/* 438:    */      
/* 439:439 */      this.c = Int2FloatOpenHashMap.this.size;
/* 440:    */      
/* 444:444 */      boolean[] used = Int2FloatOpenHashMap.this.used;
...
/* 456:    */        
/* 457:457 */        int pos = HashCommon.murmurHash3(k) & Int2FloatOpenHashMap.this.mask;
/* 458:    */        
/* 459:459 */        while (Int2FloatOpenHashMap.this.used[pos] != 0) {
/* 460:460 */          if (Int2FloatOpenHashMap.this.key[pos] == k) return pos;
/* 461:461 */          pos = pos + 1 & Int2FloatOpenHashMap.this.mask;
/* 462:    */        }
/* 463:    */      }
/* 464:464 */      this.last = this.pos;
/* 465:    */      
/* 466:466 */      if (this.c != 0) {
/* 467:467 */        boolean[] used = Int2FloatOpenHashMap.this.used;
...
/* 482:    */      for (;;)
/* 483:    */      {
/* 484:484 */        pos = (last = pos) + 1 & Int2FloatOpenHashMap.this.mask;
/* 485:485 */        while (Int2FloatOpenHashMap.this.used[pos] != 0) {
/* 486:486 */          int slot = HashCommon.murmurHash3(Int2FloatOpenHashMap.this.key[pos]) & Int2FloatOpenHashMap.this.mask;
/* 487:487 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488:488 */          pos = pos + 1 & Int2FloatOpenHashMap.this.mask;
/* 489:    */        }
/* 490:490 */        if (Int2FloatOpenHashMap.this.used[pos] == 0) break;
/* 491:491 */        if (pos < last)
/* 492:    */        {
/* 493:493 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 494:494 */          this.wrapped.add(Int2FloatOpenHashMap.this.key[pos]);
/* 495:    */        }
/* 496:496 */        Int2FloatOpenHashMap.this.key[last] = Int2FloatOpenHashMap.this.key[pos];
/* 497:497 */        Int2FloatOpenHashMap.this.value[last] = Int2FloatOpenHashMap.this.value[pos];
/* 498:    */      }
/* 499:499 */      Int2FloatOpenHashMap.this.used[last] = false;
/* 500:500 */      return last;
/* 501:    */    }
/* 502:    */    
...
/* 506:    */      {
/* 507:507 */        Int2FloatOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 508:508 */        this.last = -1;
/* 509:509 */        return;
/* 510:    */      }
/* 511:511 */      Int2FloatOpenHashMap.this.size -= 1;
...
/* 523:    */    } }
/* 524:    */  
/* 525:525 */  private class EntryIterator extends Int2FloatOpenHashMap.MapIterator implements ObjectIterator<Int2FloatMap.Entry> { private EntryIterator() { super(null); }
/* 526:    */    
/* 527:    */    private Int2FloatOpenHashMap.MapEntry entry;
/* 528:528 */    public Int2FloatMap.Entry next() { return this.entry = new Int2FloatOpenHashMap.MapEntry(Int2FloatOpenHashMap.this, nextEntry()); }
/* 529:    */    
/* 530:    */    public void remove()
/* 531:    */    {
/* 532:532 */      super.remove();
/* 533:533 */      Int2FloatOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 534:    */    } }
/* 535:    */  
/* 536:536 */  private class FastEntryIterator extends Int2FloatOpenHashMap.MapIterator implements ObjectIterator<Int2FloatMap.Entry> { private FastEntryIterator() { super(null); }
/* 537:537 */    final AbstractInt2FloatMap.BasicEntry entry = new AbstractInt2FloatMap.BasicEntry(0, 0.0F);
/* 538:    */    
/* 539:539 */    public AbstractInt2FloatMap.BasicEntry next() { int e = nextEntry();
/* 540:540 */      this.entry.key = Int2FloatOpenHashMap.this.key[e];
/* 541:541 */      this.entry.value = Int2FloatOpenHashMap.this.value[e];
/* 542:542 */      return this.entry;
/* 543:    */    } }
/* 544:    */  
/* 545:    */  private final class MapEntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements Int2FloatMap.FastEntrySet { private MapEntrySet() {}
/* 546:    */    
/* 547:547 */    public ObjectIterator<Int2FloatMap.Entry> iterator() { return new Int2FloatOpenHashMap.EntryIterator(Int2FloatOpenHashMap.this, null); }
/* 548:    */    
/* 549:    */    public ObjectIterator<Int2FloatMap.Entry> fastIterator() {
/* 550:550 */      return new Int2FloatOpenHashMap.FastEntryIterator(Int2FloatOpenHashMap.this, null);
/* 551:    */    }
/* 552:    */    
/* 553:    */    public boolean contains(Object o) {
/* 554:554 */      if (!(o instanceof Map.Entry)) return false;
/* 555:555 */      Map.Entry<Integer, Float> e = (Map.Entry)o;
/* 556:556 */      int k = ((Integer)e.getKey()).intValue();
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(k) & Int2FloatOpenHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Int2FloatOpenHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Int2FloatOpenHashMap.this.key[pos] == k) return Int2FloatOpenHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 562:562 */        pos = pos + 1 & Int2FloatOpenHashMap.this.mask;
/* 563:    */      }
...
/* 569:569 */      Map.Entry<Integer, Float> e = (Map.Entry)o;
/* 570:570 */      int k = ((Integer)e.getKey()).intValue();
/* 571:    */      
/* 572:572 */      int pos = HashCommon.murmurHash3(k) & Int2FloatOpenHashMap.this.mask;
/* 573:    */      
/* 574:574 */      while (Int2FloatOpenHashMap.this.used[pos] != 0) {
/* 575:575 */        if (Int2FloatOpenHashMap.this.key[pos] == k) {
/* 576:576 */          Int2FloatOpenHashMap.this.remove(e.getKey());
/* 577:577 */          return true;
/* 578:    */        }
/* 579:579 */        pos = pos + 1 & Int2FloatOpenHashMap.this.mask;
/* 580:    */      }
/* 581:581 */      return false;
/* 582:    */    }
/* 583:    */    
/* 584:584 */    public int size() { return Int2FloatOpenHashMap.this.size; }
/* 585:    */    
/* 587:587 */    public void clear() { Int2FloatOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public Int2FloatMap.FastEntrySet int2FloatEntrySet() {
...
/* 598:    */    extends Int2FloatOpenHashMap.MapIterator
/* 599:    */    implements IntIterator
/* 600:    */  {
/* 601:601 */    public KeyIterator() { super(null); }
/* 602:602 */    public int nextInt() { return Int2FloatOpenHashMap.this.key[nextEntry()]; }
/* 603:603 */    public Integer next() { return Integer.valueOf(Int2FloatOpenHashMap.this.key[nextEntry()]); } }
/* 604:    */  
/* 605:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 606:    */    
/* 607:607 */    public IntIterator iterator() { return new Int2FloatOpenHashMap.KeyIterator(Int2FloatOpenHashMap.this); }
/* 608:    */    
/* 609:    */    public int size() {
/* 610:610 */      return Int2FloatOpenHashMap.this.size;
/* 611:    */    }
/* 612:    */    
/* 613:613 */    public boolean contains(int k) { return Int2FloatOpenHashMap.this.containsKey(k); }
/* 614:    */    
/* 615:    */    public boolean remove(int k) {
/* 616:616 */      int oldSize = Int2FloatOpenHashMap.this.size;
/* 617:617 */      Int2FloatOpenHashMap.this.remove(k);
/* 618:618 */      return Int2FloatOpenHashMap.this.size != oldSize;
/* 619:    */    }
/* 620:    */    
/* 621:621 */    public void clear() { Int2FloatOpenHashMap.this.clear(); }
/* 622:    */  }
/* 623:    */  
...
/* 632:    */    extends Int2FloatOpenHashMap.MapIterator
/* 633:    */    implements FloatIterator
/* 634:    */  {
/* 635:635 */    public ValueIterator() { super(null); }
/* 636:636 */    public float nextFloat() { return Int2FloatOpenHashMap.this.value[nextEntry()]; }
/* 637:637 */    public Float next() { return Float.valueOf(Int2FloatOpenHashMap.this.value[nextEntry()]); }
/* 638:    */  }
/* 639:    */  
...
/* 642:642 */          return new Int2FloatOpenHashMap.ValueIterator(Int2FloatOpenHashMap.this);
/* 643:    */        }
/* 644:    */        
/* 645:645 */        public int size() { return Int2FloatOpenHashMap.this.size; }
/* 646:    */        
/* 647:    */        public boolean contains(float v) {
/* 648:648 */          return Int2FloatOpenHashMap.this.containsValue(v);
/* 649:    */        }
/* 650:    */        
/* 651:651 */        public void clear() { Int2FloatOpenHashMap.this.clear(); }
/* 652:    */      };
/* 653:    */    }
...
/* 754:    */  }
/* 755:    */  
/* 759:    */  public Int2FloatOpenHashMap clone()
/* 760:    */  {
/* 761:    */    Int2FloatOpenHashMap c;
/* 762:    */    
/* 764:    */    try
/* 765:    */    {
/* 766:766 */      c = (Int2FloatOpenHashMap)super.clone();
/* 767:    */    }
