...
/*      */ 
/*      */ public class Int2BooleanRBTreeMap extends AbstractInt2BooleanSortedMap
...
/*  119 */           return Int2BooleanRBTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  122 */           return Int2BooleanRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     boolean oldValue = put(ok.intValue(), ov.booleanValue());
/*  731 */     return this.modified ? null : Boolean.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Boolean remove(Object ok)
/*      */   {
/*  737 */     boolean oldValue = remove(((Integer)ok).intValue());
...
/* 1141 */         final Comparator<? super Int2BooleanMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2BooleanMap.Entry x, Int2BooleanMap.Entry y) {
/* 1143 */             return Int2BooleanRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Int2BooleanRBTreeMap.EntryIterator(Int2BooleanRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry from) {
/* 1153 */           return new Int2BooleanRBTreeMap.EntryIterator(Int2BooleanRBTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Int2BooleanRBTreeMap.Entry f = Int2BooleanRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1166 */           Int2BooleanRBTreeMap.Entry f = Int2BooleanRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1167 */           if (f != null) Int2BooleanRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Int2BooleanRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Int2BooleanRBTreeMap.this.clear(); } 
/* 1172 */         public Int2BooleanMap.Entry first() { return Int2BooleanRBTreeMap.this.firstEntry; } 
/* 1173 */         public Int2BooleanMap.Entry last() { return Int2BooleanRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry from, Int2BooleanMap.Entry to) { return Int2BooleanRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2BooleanEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry to) { return Int2BooleanRBTreeMap.this.headMap((Integer)to.getKey()).int2BooleanEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry from) { return Int2BooleanRBTreeMap.this.tailMap((Integer)from.getKey()).int2BooleanEntrySet(); }
/*      */       };
...
/* 1242 */           return new Int2BooleanRBTreeMap.ValueIterator(Int2BooleanRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(boolean k) {
/* 1245 */           return Int2BooleanRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Int2BooleanRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
...
/*      */     try
/*      */     {
/* 1611 */       c = (Int2BooleanRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readInt(), s.readBoolean());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readInt(), s.readBoolean());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readInt(), s.readBoolean()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Int2BooleanRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Int2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1323 */       return ((this.bottom) || (Int2BooleanRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
/* 1327 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator() {
/* 1329 */             return new Int2BooleanRBTreeMap.Submap.SubmapEntryIterator(Int2BooleanRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry from) {
/* 1332 */             return new Int2BooleanRBTreeMap.Submap.SubmapEntryIterator(Int2BooleanRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1334 */           public Comparator<? super Int2BooleanMap.Entry> comparator() { return Int2BooleanRBTreeMap.this.int2BooleanEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Int2BooleanRBTreeMap.Entry f = Int2BooleanRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1340 */             return (f != null) && (Int2BooleanRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Int2BooleanRBTreeMap.Entry f = Int2BooleanRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1347 */             if ((f != null) && (Int2BooleanRBTreeMap.Submap.this.in(f.key))) Int2BooleanRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Int2BooleanRBTreeMap.Submap.SubmapIterator(Int2BooleanRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Int2BooleanRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Int2BooleanMap.Entry first() { return Int2BooleanRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Int2BooleanMap.Entry last() { return Int2BooleanRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry from, Int2BooleanMap.Entry to) { return Int2BooleanRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2BooleanEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry to) { return Int2BooleanRBTreeMap.Submap.this.headMap((Integer)to.getKey()).int2BooleanEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry from) { return Int2BooleanRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2BooleanEntrySet(); }
/*      */         };
...
/*      */           public BooleanIterator iterator() {
/* 1376 */             return new Int2BooleanRBTreeMap.Submap.SubmapValueIterator(Int2BooleanRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(boolean k) {
/* 1379 */             return Int2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Int2BooleanRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Int2BooleanRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1392 */       return (in(k)) && (Int2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(boolean v) {
...
/* 1407 */       return (in(kk)) && ((e = Int2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public boolean put(int k, boolean v) {
/* 1410 */       Int2BooleanRBTreeMap.this.modified = false;
...
/* 1412 */       boolean oldValue = Int2BooleanRBTreeMap.this.put(k, v);
/* 1413 */       return Int2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Boolean put(Integer ok, Boolean ov) {
/* 1416 */       boolean oldValue = put(ok.intValue(), ov.booleanValue());
/* 1417 */       return Int2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public boolean remove(int k) {
/* 1421 */       Int2BooleanRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       boolean oldValue = Int2BooleanRBTreeMap.this.remove(k);
/* 1424 */       return Int2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Boolean remove(Object ok) {
/* 1427 */       boolean oldValue = remove(((Integer)ok).intValue());
/* 1428 */       return Int2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1443 */       return Int2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2BooleanSortedMap headMap(int to) {
/* 1446 */       if (this.top) return new Submap(Int2BooleanRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Int2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2BooleanRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2BooleanSortedMap tailMap(int from) {
/* 1450 */       if (this.bottom) return new Submap(Int2BooleanRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Int2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2BooleanRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2BooleanSortedMap subMap(int from, int to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Int2BooleanRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Int2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Int2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Int2BooleanRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2BooleanRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Int2BooleanRBTreeMap.this.tree == null) return null;
/* 1468 */       Int2BooleanRBTreeMap.Entry e;
/*      */       Int2BooleanRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Int2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Int2BooleanRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Int2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Int2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2BooleanRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Int2BooleanRBTreeMap.this.tree == null) return null;
/* 1486 */       Int2BooleanRBTreeMap.Entry e;
/*      */       Int2BooleanRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Int2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Int2BooleanRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Int2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Int2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1497 */       Int2BooleanRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1502 */       Int2BooleanRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1507 */       Int2BooleanRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1512 */       Int2BooleanRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Int2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Int2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Int2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Int2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Int2BooleanRBTreeMap.Submap.this.bottom) && (Int2BooleanRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Int2BooleanRBTreeMap.Submap.this.top) && (Int2BooleanRBTreeMap.this.compare(k, (this.prev = Int2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Int2BooleanRBTreeMap.this.locateKey(k);
/* 1534 */             if (Int2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Int2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2BooleanRBTreeMap.this.compare(this.prev.key, Int2BooleanRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Int2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Int2BooleanRBTreeMap.this.compare(this.next.key, Int2BooleanRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public IntBidirectionalIterator iterator() { return new Int2BooleanRBTreeMap.Submap.SubmapKeyIterator(Int2BooleanRBTreeMap.Submap.this); } 
/* 1367 */       public IntBidirectionalIterator iterator(int from) { return new Int2BooleanRBTreeMap.Submap.SubmapKeyIterator(Int2BooleanRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2BooleanRBTreeMap.TreeIterator
/*      */     implements BooleanListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public IntBidirectionalIterator iterator() { return new Int2BooleanRBTreeMap.KeyIterator(Int2BooleanRBTreeMap.this); } 
/* 1201 */     public IntBidirectionalIterator iterator(int from) { return new Int2BooleanRBTreeMap.KeyIterator(Int2BooleanRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2BooleanRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2BooleanRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2BooleanMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Int2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Int2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Int2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Int2BooleanRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1067 */       if ((this.next = Int2BooleanRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Int2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Int2BooleanRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
