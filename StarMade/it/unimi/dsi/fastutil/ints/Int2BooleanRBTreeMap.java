...
/*   21:     */
/*   73:     */public class Int2BooleanRBTreeMap
...
/*   91:     */  
/*   92:     */  public Int2BooleanRBTreeMap()
/*   93:     */  {
/*   94:  94 */    allocatePaths();
/*   95:     */    
...
/*  119: 119 */          return Int2BooleanRBTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*  120:     */        }
/*  121:     */        
/*  122: 122 */        public int compare(Integer ok1, Integer ok2) { return Int2BooleanRBTreeMap.this.storedComparator.compare(ok1, ok2); }
/*  123:     */      };
/*  124:     */    }
/*  125:     */  }
/*  126:     */  
/*  133:     */  public Int2BooleanRBTreeMap(Comparator<? super Integer> c)
/*  134:     */  {
/*  135: 135 */    this();
...
/*  138:     */  }
/*  139:     */  
/*  145:     */  public Int2BooleanRBTreeMap(Map<? extends Integer, ? extends Boolean> m)
/*  146:     */  {
/*  147: 147 */    this();
/*  148: 148 */    putAll(m);
/*  149:     */  }
/*  150:     */  
/*  155:     */  public Int2BooleanRBTreeMap(SortedMap<Integer, Boolean> m)
/*  156:     */  {
/*  157: 157 */    this(m.comparator());
/*  158: 158 */    putAll(m);
/*  159:     */  }
/*  160:     */  
/*  165:     */  public Int2BooleanRBTreeMap(Int2BooleanMap m)
/*  166:     */  {
/*  167: 167 */    this();
/*  168: 168 */    putAll(m);
/*  169:     */  }
/*  170:     */  
/*  175:     */  public Int2BooleanRBTreeMap(Int2BooleanSortedMap m)
/*  176:     */  {
/*  177: 177 */    this(m.comparator());
/*  178: 178 */    putAll(m);
/*  179:     */  }
/*  180:     */  
/*  188:     */  public Int2BooleanRBTreeMap(int[] k, boolean[] v, Comparator<? super Integer> c)
/*  189:     */  {
/*  190: 190 */    this(c);
...
/*  194:     */  }
/*  195:     */  
/*  201:     */  public Int2BooleanRBTreeMap(int[] k, boolean[] v)
/*  202:     */  {
...
/*  278:     */  }
/*  279:     */  
/*  282:     */  public boolean put(int k, boolean v)
/*  283:     */  {
...
/*  448:     */  }
/*  449:     */  
/*  454:     */  public boolean remove(int k)
/*  455:     */  {
...
/*  724:     */  }
/*  725:     */  
/*  728:     */  public Boolean put(Integer ok, Boolean ov)
/*  729:     */  {
/*  730: 730 */    boolean oldValue = put(ok.intValue(), ov.booleanValue());
/*  731: 731 */    return this.modified ? null : Boolean.valueOf(oldValue);
/*  732:     */  }
/*  733:     */  
/*  735:     */  public Boolean remove(Object ok)
/*  736:     */  {
/*  737: 737 */    boolean oldValue = remove(((Integer)ok).intValue());
...
/*  769:     */    implements Cloneable, Int2BooleanMap.Entry
/*  770:     */  {
...
/*  977: 977 */      Map.Entry<Integer, Boolean> e = (Map.Entry)o;
/*  978:     */      
/*  979: 979 */      return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*  980:     */    }
/*  981:     */    
...
/* 1054:     */  {
/* 1055:     */    Int2BooleanRBTreeMap.Entry prev;
/* 1056:     */    
/* 1058:     */    Int2BooleanRBTreeMap.Entry next;
/* 1059:     */    
/* 1060:     */    Int2BooleanRBTreeMap.Entry curr;
/* 1061:     */    
/* 1062:1062 */    int index = 0;
/* 1063:     */    
/* 1064:1064 */    TreeIterator() { this.next = Int2BooleanRBTreeMap.this.firstEntry; }
/* 1065:     */    
/* 1066:     */    TreeIterator(int k) {
/* 1067:1067 */      if ((this.next = Int2BooleanRBTreeMap.this.locateKey(k)) != null)
/* 1068:1068 */        if (Int2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1079:     */    
/* 1080:     */    Int2BooleanRBTreeMap.Entry nextEntry() {
...
/* 1089:     */    
/* 1090:     */    Int2BooleanRBTreeMap.Entry previousEntry() {
...
/* 1111:1111 */      Int2BooleanRBTreeMap.this.remove(this.curr.key);
...
/* 1127:     */    extends Int2BooleanRBTreeMap.TreeIterator
/* 1128:     */    implements ObjectListIterator<Int2BooleanMap.Entry>
/* 1129:     */  {
/* 1130:1130 */    EntryIterator() { super(); }
/* 1131:     */    
/* 1132:1132 */    EntryIterator(int k) { super(k); }
/* 1133:     */    
/* 1134:1134 */    public Int2BooleanMap.Entry next() { return nextEntry(); }
/* 1135:1135 */    public Int2BooleanMap.Entry previous() { return previousEntry(); }
/* 1136:1136 */    public void set(Int2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1137:1137 */    public void add(Int2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1138:     */  }
/* 1139:     */  
/* 1140:1140 */  public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1141:1141 */        final Comparator<? super Int2BooleanMap.Entry> comparator = new Comparator() {
/* 1142:     */          public int compare(Int2BooleanMap.Entry x, Int2BooleanMap.Entry y) {
/* 1143:1143 */            return Int2BooleanRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/* 1144:     */          }
/* 1145:     */        };
/* 1146:     */        
/* 1147:1147 */        public Comparator<? super Int2BooleanMap.Entry> comparator() { return this.comparator; }
/* 1148:     */        
/* 1149:     */        public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator() {
/* 1150:1150 */          return new Int2BooleanRBTreeMap.EntryIterator(Int2BooleanRBTreeMap.this);
/* 1151:     */        }
/* 1152:     */        
/* 1153:1153 */        public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry from) { return new Int2BooleanRBTreeMap.EntryIterator(Int2BooleanRBTreeMap.this, ((Integer)from.getKey()).intValue()); }
/* 1154:     */        
/* 1155:     */        public boolean contains(Object o)
/* 1156:     */        {
/* 1157:1157 */          if (!(o instanceof Map.Entry)) return false;
/* 1158:1158 */          Map.Entry<Integer, Boolean> e = (Map.Entry)o;
/* 1159:1159 */          Int2BooleanRBTreeMap.Entry f = Int2BooleanRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1160:1160 */          return e.equals(f);
/* 1161:     */        }
/* 1162:     */        
/* 1163:     */        public boolean remove(Object o) {
/* 1164:1164 */          if (!(o instanceof Map.Entry)) return false;
/* 1165:1165 */          Map.Entry<Integer, Boolean> e = (Map.Entry)o;
/* 1166:1166 */          Int2BooleanRBTreeMap.Entry f = Int2BooleanRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1167:1167 */          if (f != null) Int2BooleanRBTreeMap.this.remove(f.key);
/* 1168:1168 */          return f != null; }
/* 1169:     */        
/* 1170:1170 */        public int size() { return Int2BooleanRBTreeMap.this.count; }
/* 1171:1171 */        public void clear() { Int2BooleanRBTreeMap.this.clear(); }
/* 1172:1172 */        public Int2BooleanMap.Entry first() { return Int2BooleanRBTreeMap.this.firstEntry; }
/* 1173:1173 */        public Int2BooleanMap.Entry last() { return Int2BooleanRBTreeMap.this.lastEntry; }
/* 1174:1174 */        public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry from, Int2BooleanMap.Entry to) { return Int2BooleanRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2BooleanEntrySet(); }
/* 1175:1175 */        public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry to) { return Int2BooleanRBTreeMap.this.headMap((Integer)to.getKey()).int2BooleanEntrySet(); }
/* 1176:1176 */        public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry from) { return Int2BooleanRBTreeMap.this.tailMap((Integer)from.getKey()).int2BooleanEntrySet(); }
/* 1177:     */      };
/* 1178:1178 */    return this.entries;
/* 1179:     */  }
/* 1180:     */  
/* 1183:     */  private final class KeyIterator
/* 1184:     */    extends Int2BooleanRBTreeMap.TreeIterator
...
/* 1197:     */  }
/* 1198:     */  
/* 1199:1199 */  private class KeySet extends AbstractInt2BooleanSortedMap.KeySet { private KeySet() { super(); }
/* 1200:1200 */    public IntBidirectionalIterator iterator() { return new Int2BooleanRBTreeMap.KeyIterator(Int2BooleanRBTreeMap.this); }
/* 1201:1201 */    public IntBidirectionalIterator iterator(int from) { return new Int2BooleanRBTreeMap.KeyIterator(Int2BooleanRBTreeMap.this, from); }
/* 1202:     */  }
/* 1203:     */  
...
/* 1218:     */    extends Int2BooleanRBTreeMap.TreeIterator
...
/* 1242:1242 */          return new Int2BooleanRBTreeMap.ValueIterator(Int2BooleanRBTreeMap.this, null);
/* 1243:     */        }
/* 1244:     */        
/* 1245:1245 */        public boolean contains(boolean k) { return Int2BooleanRBTreeMap.this.containsValue(k); }
/* 1246:     */        
/* 1247:     */        public int size() {
/* 1248:1248 */          return Int2BooleanRBTreeMap.this.count;
/* 1249:     */        }
/* 1250:     */        
/* 1251:1251 */        public void clear() { Int2BooleanRBTreeMap.this.clear(); }
/* 1252:     */      };
/* 1253:     */    }
...
/* 1258:     */  
/* 1259:     */  public Int2BooleanSortedMap headMap(int to) {
/* 1260:1260 */    return new Submap(0, true, to, false);
/* 1261:     */  }
/* 1262:     */  
/* 1263:1263 */  public Int2BooleanSortedMap tailMap(int from) { return new Submap(from, false, 0, true); }
/* 1264:     */  
/* 1265:     */  public Int2BooleanSortedMap subMap(int from, int to) {
/* 1266:1266 */    return new Submap(from, false, to, false);
/* 1267:     */  }
/* 1268:     */  
/* 1272:     */  private final class Submap
/* 1273:     */    extends AbstractInt2BooleanSortedMap
...
/* 1289:     */    boolean top;
/* 1290:     */    
/* 1292:     */    protected volatile transient ObjectSortedSet<Int2BooleanMap.Entry> entries;
/* 1293:     */    
...
/* 1303:     */    {
/* 1304:1304 */      if ((!bottom) && (!top) && (Int2BooleanRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305:1305 */      this.from = from;
/* 1306:1306 */      this.bottom = bottom;
/* 1307:1307 */      this.to = to;
/* 1308:1308 */      this.top = top;
/* 1309:1309 */      this.defRetValue = Int2BooleanRBTreeMap.this.defRetValue;
/* 1310:     */    }
/* 1311:     */    
...
/* 1322:     */    {
/* 1323:1323 */      return ((this.bottom) || (Int2BooleanRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/* 1324:     */    }
/* 1325:     */    
/* 1326:     */    public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet() {
/* 1327:1327 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1328:     */          public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator() {
/* 1329:1329 */            return new Int2BooleanRBTreeMap.Submap.SubmapEntryIterator(Int2BooleanRBTreeMap.Submap.this);
/* 1330:     */          }
/* 1331:     */          
/* 1332:1332 */          public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry from) { return new Int2BooleanRBTreeMap.Submap.SubmapEntryIterator(Int2BooleanRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue()); }
/* 1333:     */          
/* 1334:1334 */          public Comparator<? super Int2BooleanMap.Entry> comparator() { return Int2BooleanRBTreeMap.this.int2BooleanEntrySet().comparator(); }
/* 1335:     */          
/* 1336:     */          public boolean contains(Object o) {
/* 1337:1337 */            if (!(o instanceof Map.Entry)) return false;
/* 1338:1338 */            Map.Entry<Integer, Boolean> e = (Map.Entry)o;
/* 1339:1339 */            Int2BooleanRBTreeMap.Entry f = Int2BooleanRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1340:1340 */            return (f != null) && (Int2BooleanRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1341:     */          }
/* 1342:     */          
/* 1343:     */          public boolean remove(Object o) {
/* 1344:1344 */            if (!(o instanceof Map.Entry)) return false;
/* 1345:1345 */            Map.Entry<Integer, Boolean> e = (Map.Entry)o;
/* 1346:1346 */            Int2BooleanRBTreeMap.Entry f = Int2BooleanRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1347:1347 */            if ((f != null) && (Int2BooleanRBTreeMap.Submap.this.in(f.key))) Int2BooleanRBTreeMap.Submap.this.remove(f.key);
...
/* 1353:1353 */            return c; }
/* 1354:     */          
/* 1355:1355 */          public boolean isEmpty() { return !new Int2BooleanRBTreeMap.Submap.SubmapIterator(Int2BooleanRBTreeMap.Submap.this).hasNext(); }
/* 1356:1356 */          public void clear() { Int2BooleanRBTreeMap.Submap.this.clear(); }
/* 1357:1357 */          public Int2BooleanMap.Entry first() { return Int2BooleanRBTreeMap.Submap.this.firstEntry(); }
/* 1358:1358 */          public Int2BooleanMap.Entry last() { return Int2BooleanRBTreeMap.Submap.this.lastEntry(); }
/* 1359:1359 */          public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry from, Int2BooleanMap.Entry to) { return Int2BooleanRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2BooleanEntrySet(); }
/* 1360:1360 */          public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry to) { return Int2BooleanRBTreeMap.Submap.this.headMap((Integer)to.getKey()).int2BooleanEntrySet(); }
/* 1361:1361 */          public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry from) { return Int2BooleanRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2BooleanEntrySet(); }
/* 1362:     */        };
/* 1363:1363 */      return this.entries; }
/* 1364:     */    
/* 1365:1365 */    private class KeySet extends AbstractInt2BooleanSortedMap.KeySet { private KeySet() { super(); }
/* 1366:1366 */      public IntBidirectionalIterator iterator() { return new Int2BooleanRBTreeMap.Submap.SubmapKeyIterator(Int2BooleanRBTreeMap.Submap.this); }
/* 1367:1367 */      public IntBidirectionalIterator iterator(int from) { return new Int2BooleanRBTreeMap.Submap.SubmapKeyIterator(Int2BooleanRBTreeMap.Submap.this, from); }
/* 1368:     */    }
/* 1369:     */    
...
/* 1376:1376 */            return new Int2BooleanRBTreeMap.Submap.SubmapValueIterator(Int2BooleanRBTreeMap.Submap.this, null);
/* 1377:     */          }
/* 1378:     */          
/* 1379:1379 */          public boolean contains(boolean k) { return Int2BooleanRBTreeMap.Submap.this.containsValue(k); }
/* 1380:     */          
/* 1381:     */          public int size() {
/* 1382:1382 */            return Int2BooleanRBTreeMap.Submap.this.size();
/* 1383:     */          }
/* 1384:     */          
/* 1385:1385 */          public void clear() { Int2BooleanRBTreeMap.Submap.this.clear(); }
/* 1386:     */        };
/* 1387:     */      }
/* 1388:1388 */      return this.values;
/* 1389:     */    }
/* 1390:     */    
/* 1392:1392 */    public boolean containsKey(int k) { return (in(k)) && (Int2BooleanRBTreeMap.this.containsKey(k)); }
/* 1393:     */    
...
/* 1402:     */    }
/* 1403:     */    
/* 1404:     */    public boolean get(int k)
/* 1405:     */    {
/* 1406:1406 */      int kk = k;
/* 1407:1407 */      Int2BooleanRBTreeMap.Entry e; return (in(kk)) && ((e = Int2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1408:     */    }
/* 1409:     */    
/* 1410:1410 */    public boolean put(int k, boolean v) { Int2BooleanRBTreeMap.this.modified = false;
...
/* 1412:1412 */      boolean oldValue = Int2BooleanRBTreeMap.this.put(k, v);
/* 1413:1413 */      return Int2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1414:     */    }
/* 1415:     */    
/* 1416:1416 */    public Boolean put(Integer ok, Boolean ov) { boolean oldValue = put(ok.intValue(), ov.booleanValue());
/* 1417:1417 */      return Int2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
/* 1418:     */    }
/* 1419:     */    
/* 1420:     */    public boolean remove(int k) {
/* 1421:1421 */      Int2BooleanRBTreeMap.this.modified = false;
/* 1422:1422 */      if (!in(k)) return this.defRetValue;
/* 1423:1423 */      boolean oldValue = Int2BooleanRBTreeMap.this.remove(k);
/* 1424:1424 */      return Int2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1425:     */    }
/* 1426:     */    
/* 1427:1427 */    public Boolean remove(Object ok) { boolean oldValue = remove(((Integer)ok).intValue());
/* 1428:1428 */      return Int2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
/* 1429:     */    }
/* 1430:     */    
...
/* 1441:     */    
/* 1443:1443 */    public IntComparator comparator() { return Int2BooleanRBTreeMap.this.actualComparator; }
/* 1444:     */    
/* 1445:     */    public Int2BooleanSortedMap headMap(int to) {
/* 1446:1446 */      if (this.top) return new Submap(Int2BooleanRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447:1447 */      return Int2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2BooleanRBTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1448:     */    }
/* 1449:     */    
/* 1450:1450 */    public Int2BooleanSortedMap tailMap(int from) { if (this.bottom) return new Submap(Int2BooleanRBTreeMap.this, from, false, this.to, this.top);
/* 1451:1451 */      return Int2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2BooleanRBTreeMap.this, from, false, this.to, this.top) : this;
/* 1452:     */    }
/* 1453:     */    
/* 1454:1454 */    public Int2BooleanSortedMap subMap(int from, int to) { if ((this.top) && (this.bottom)) return new Submap(Int2BooleanRBTreeMap.this, from, false, to, false);
/* 1455:1455 */      if (!this.top) to = Int2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456:1456 */      if (!this.bottom) from = Int2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457:1457 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458:1458 */      return new Submap(Int2BooleanRBTreeMap.this, from, false, to, false);
/* 1459:     */    }
/* 1460:     */    
/* 1463:     */    public Int2BooleanRBTreeMap.Entry firstEntry()
/* 1464:     */    {
/* 1465:1465 */      if (Int2BooleanRBTreeMap.this.tree == null) return null;
/* 1466:     */      Int2BooleanRBTreeMap.Entry e;
/* 1467:     */      Int2BooleanRBTreeMap.Entry e;
/* 1468:1468 */      if (this.bottom) { e = Int2BooleanRBTreeMap.this.firstEntry;
/* 1469:     */      } else {
/* 1470:1470 */        e = Int2BooleanRBTreeMap.this.locateKey(this.from);
/* 1471:     */        
/* 1472:1472 */        if (Int2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1473:     */        }
/* 1474:     */      }
/* 1475:1475 */      if ((e == null) || ((!this.top) && (Int2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476:1476 */      return e;
/* 1477:     */    }
/* 1478:     */    
/* 1481:     */    public Int2BooleanRBTreeMap.Entry lastEntry()
/* 1482:     */    {
/* 1483:1483 */      if (Int2BooleanRBTreeMap.this.tree == null) return null;
/* 1484:     */      Int2BooleanRBTreeMap.Entry e;
/* 1485:     */      Int2BooleanRBTreeMap.Entry e;
/* 1486:1486 */      if (this.top) { e = Int2BooleanRBTreeMap.this.lastEntry;
/* 1487:     */      } else {
/* 1488:1488 */        e = Int2BooleanRBTreeMap.this.locateKey(this.to);
/* 1489:     */        
/* 1490:1490 */        if (Int2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1491:     */        }
/* 1492:     */      }
/* 1493:1493 */      if ((e == null) || ((!this.bottom) && (Int2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494:1494 */      return e;
/* 1495:     */    }
/* 1496:     */    
/* 1497:1497 */    public int firstIntKey() { Int2BooleanRBTreeMap.Entry e = firstEntry();
/* 1498:1498 */      if (e == null) throw new NoSuchElementException();
/* 1499:1499 */      return e.key;
/* 1500:     */    }
/* 1501:     */    
/* 1502:1502 */    public int lastIntKey() { Int2BooleanRBTreeMap.Entry e = lastEntry();
/* 1503:1503 */      if (e == null) throw new NoSuchElementException();
/* 1504:1504 */      return e.key;
/* 1505:     */    }
/* 1506:     */    
/* 1507:1507 */    public Integer firstKey() { Int2BooleanRBTreeMap.Entry e = firstEntry();
/* 1508:1508 */      if (e == null) throw new NoSuchElementException();
/* 1509:1509 */      return e.getKey();
/* 1510:     */    }
/* 1511:     */    
/* 1512:1512 */    public Integer lastKey() { Int2BooleanRBTreeMap.Entry e = lastEntry();
/* 1513:1513 */      if (e == null) throw new NoSuchElementException();
/* 1514:1514 */      return e.getKey();
/* 1515:     */    }
/* 1516:     */    
/* 1519:     */    private class SubmapIterator
/* 1520:     */      extends Int2BooleanRBTreeMap.TreeIterator
/* 1521:     */    {
/* 1522:     */      SubmapIterator()
/* 1523:     */      {
/* 1524:1524 */        super();
/* 1525:1525 */        this.next = Int2BooleanRBTreeMap.Submap.this.firstEntry();
/* 1526:     */      }
/* 1527:     */      
/* 1528:1528 */      SubmapIterator(int k) { this();
/* 1529:1529 */        if (this.next != null)
/* 1530:1530 */          if ((!Int2BooleanRBTreeMap.Submap.this.bottom) && (Int2BooleanRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531:1531 */          } else if ((!Int2BooleanRBTreeMap.Submap.this.top) && (Int2BooleanRBTreeMap.this.compare(k, (this.prev = Int2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1532:     */          } else {
/* 1533:1533 */            this.next = Int2BooleanRBTreeMap.this.locateKey(k);
/* 1534:1534 */            if (Int2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544:1544 */        if ((!Int2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2BooleanRBTreeMap.this.compare(this.prev.key, Int2BooleanRBTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1545:     */      }
/* 1546:     */      
/* 1547:1547 */      void updateNext() { this.next = this.next.next();
/* 1548:1548 */        if ((!Int2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Int2BooleanRBTreeMap.this.compare(this.next.key, Int2BooleanRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1549:     */      }
/* 1550:     */    }
/* 1551:     */    
/* 1552:1552 */    private class SubmapEntryIterator extends Int2BooleanRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2BooleanMap.Entry> { SubmapEntryIterator() { super(); }
/* 1553:     */      
/* 1554:1554 */      SubmapEntryIterator(int k) { super(k); }
/* 1555:     */      
/* 1556:1556 */      public Int2BooleanMap.Entry next() { return nextEntry(); }
/* 1557:1557 */      public Int2BooleanMap.Entry previous() { return previousEntry(); }
/* 1558:1558 */      public void set(Int2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1559:1559 */      public void add(Int2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1560:     */    }
/* 1561:     */    
/* 1566:     */    private final class SubmapKeyIterator
/* 1567:     */      extends Int2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1586:     */      extends Int2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1599:     */  }
/* 1600:     */  
/* 1604:     */  public Int2BooleanRBTreeMap clone()
/* 1605:     */  {
/* 1606:     */    Int2BooleanRBTreeMap c;
/* 1607:     */    
/* 1609:     */    try
/* 1610:     */    {
/* 1611:1611 */      c = (Int2BooleanRBTreeMap)super.clone();
/* 1612:     */    }
...
/* 1682:     */  {
/* 1683:1683 */    if (n == 1) {
/* 1684:1684 */      Entry top = new Entry(s.readInt(), s.readBoolean());
...
/* 1690:1690 */    if (n == 2)
/* 1691:     */    {
/* 1693:1693 */      Entry top = new Entry(s.readInt(), s.readBoolean());
/* 1694:1694 */      top.black(true);
/* 1695:1695 */      top.right(new Entry(s.readInt(), s.readBoolean()));
