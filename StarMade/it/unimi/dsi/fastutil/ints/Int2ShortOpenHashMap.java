  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2ShortOpenHashMap(int expected, float local_f)
  {
  ...
  public Int2ShortOpenHashMap(Map<? extends Integer, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2ShortOpenHashMap(Map<? extends Integer, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2ShortOpenHashMap(Int2ShortMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2ShortOpenHashMap(Int2ShortMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2ShortOpenHashMap(int[] local_k, short[] local_v, float local_f)
  {
  ...
  public Int2ShortOpenHashMap(int[] local_k, short[] local_v)
  {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Int2ShortOpenHashMap.ValueIterator(Int2ShortOpenHashMap.this);
        }
        ...
        {
          return Int2ShortOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2ShortOpenHashMap local_c;
    try
    {
      local_c = (Int2ShortOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2ShortOpenHashMap.MapIterator
    implements ShortIterator
  {
    ...
    public Short next()
    {
      return Short.valueOf(Int2ShortOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSet
  {
    ...
    {
      return new Int2ShortOpenHashMap.KeyIterator(Int2ShortOpenHashMap.this);
    }
    ...
    {
      return Int2ShortOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2ShortOpenHashMap.this.size;
      Int2ShortOpenHashMap.this.remove(local_k);
    ...
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2ShortOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2ShortMap.FastEntrySet
  {
    ...
    {
      return new Int2ShortOpenHashMap.EntryIterator(Int2ShortOpenHashMap.this, null);
    }
    
    public ObjectIterator<Int2ShortMap.Entry> fastIterator()
    {
      return new Int2ShortOpenHashMap.FastEntryIterator(Int2ShortOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2ShortOpenHashMap.this.mask; Int2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ShortOpenHashMap.this.mask) {
        if (Int2ShortOpenHashMap.this.key[pos] == local_k) {
          return Int2ShortOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2ShortOpenHashMap.this.mask; Int2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ShortOpenHashMap.this.mask) {
        if (Int2ShortOpenHashMap.this.key[pos] == local_k)
        {
          Int2ShortOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2ShortMap.Entry>
  {
    ...
    public AbstractInt2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2ShortOpenHashMap.this.key[local_e];
      this.entry.value = Int2ShortOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Int2ShortOpenHashMap.MapEntry(Int2ShortOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2ShortOpenHashMap.this.field_49;
    int last = -1;
    int field_1879 = Int2ShortOpenHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2ShortOpenHashMap.this.used;
      while ((this.field_1879 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1879 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1879 != 0)
      {
        boolean[] local_k = Int2ShortOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2ShortOpenHashMap.this.mask; Int2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ShortOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2ShortOpenHashMap.this.key[pos]) & Int2ShortOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2ShortOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Int2ShortOpenHashMap.this.key[pos]);
        }
        Int2ShortOpenHashMap.this.key[last] = Int2ShortOpenHashMap.this.key[pos];
        Int2ShortOpenHashMap.this.value[last] = Int2ShortOpenHashMap.this.value[pos];
      }
      Int2ShortOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Int2ShortOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
        this.last = -1;
        return;
      }
      Int2ShortOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1879 > 0))
      {
        this.field_1879 += 1;
        nextEntry();
      }
    ...
    implements Int2ShortMap.Entry, Map.Entry<Integer, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Int2ShortOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Short> local_e = (Map.Entry)local_o;
      return (Int2ShortOpenHashMap.this.key[this.index] == ((Integer)local_e.getKey()).intValue()) && (Int2ShortOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
