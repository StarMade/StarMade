...
public class Int2ReferenceFunctions
{
  ...
  public static <V> Int2ReferenceFunction<V> synchronize(Int2ReferenceFunction<V> local_f)
  {
    return new SynchronizedFunction(local_f);
  }
  
  public static <V> Int2ReferenceFunction<V> synchronize(Int2ReferenceFunction<V> local_f, Object sync)
  {
    return new SynchronizedFunction(local_f, sync);
  }
  
  public static <V> Int2ReferenceFunction<V> unmodifiable(Int2ReferenceFunction<V> local_f)
  {
    ...
    implements Serializable
  {
    ...
    protected UnmodifiableFunction(Int2ReferenceFunction<V> local_f)
    {
      if (local_f == null) {
    ...
    implements Serializable
  {
    ...
    protected SynchronizedFunction(Int2ReferenceFunction<V> local_f, Object sync)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
    ...
    protected SynchronizedFunction(Int2ReferenceFunction<V> local_f)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
