...
/*     */     try
/*     */     {
/* 269 */       c = (Int2IntArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Int2IntMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Int2IntArrayMap.this.size; }
/*     */ 
/*     */         public Int2IntMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractInt2IntMap.BasicEntry(Int2IntArrayMap.this.key[this.next], Int2IntArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractInt2IntMap.BasicEntry entry = new AbstractInt2IntMap.BasicEntry(0, 0);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Int2IntArrayMap.this.size; }
/*     */ 
/*     */         public Int2IntMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Int2IntArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Int2IntArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Int2IntArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Int2IntArrayMap.this.containsKey(k)) && (Int2IntArrayMap.this.get(k) == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */   }
/*     */ }
