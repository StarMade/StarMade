...
public abstract interface Int2ReferenceMap<V> extends Int2ReferenceFunction<V>, Map<Integer, V>
{
  ...
  public static abstract interface Entry<V> extends Map.Entry<Integer, V>
  {
    public abstract int getIntKey();
  }

  public static abstract interface FastEntrySet<V> extends ObjectSet<Int2ReferenceMap.Entry<V>>
  {
