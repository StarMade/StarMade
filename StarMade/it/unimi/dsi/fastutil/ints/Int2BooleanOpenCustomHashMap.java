...
/* 632 */           return new Int2BooleanOpenCustomHashMap.ValueIterator(Int2BooleanOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 635 */           return Int2BooleanOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(boolean v) {
/* 638 */           return Int2BooleanOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 641 */           Int2BooleanOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 756 */       c = (Int2BooleanOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Int2BooleanOpenCustomHashMap.MapIterator
/*     */     implements BooleanIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 625 */       super(null); } 
/* 626 */     public boolean nextBoolean() { return Int2BooleanOpenCustomHashMap.this.value[nextEntry()]; } 
/* 627 */     public Boolean next() { return Boolean.valueOf(Int2BooleanOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 597 */       return new Int2BooleanOpenCustomHashMap.KeyIterator(Int2BooleanOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 600 */       return Int2BooleanOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(int k) {
/* 603 */       return Int2BooleanOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(int k) {
/* 606 */       int oldSize = Int2BooleanOpenCustomHashMap.this.size;
/* 607 */       Int2BooleanOpenCustomHashMap.this.remove(k);
/* 608 */       return Int2BooleanOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 611 */       Int2BooleanOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Int2BooleanOpenCustomHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 591 */       super(null); } 
/* 592 */     public int nextInt() { return Int2BooleanOpenCustomHashMap.this.key[nextEntry()]; } 
/* 593 */     public Integer next() { return Integer.valueOf(Int2BooleanOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 537 */       return new Int2BooleanOpenCustomHashMap.EntryIterator(Int2BooleanOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Int2BooleanMap.Entry> fastIterator() {
/* 540 */       return new Int2BooleanOpenCustomHashMap.FastEntryIterator(Int2BooleanOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 548 */       int pos = HashCommon.murmurHash3(Int2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Int2BooleanOpenCustomHashMap.this.mask;
/*     */ 
/* 550 */       while (Int2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 551 */         if (Int2BooleanOpenCustomHashMap.this.strategy.equals(Int2BooleanOpenCustomHashMap.this.key[pos], k)) return Int2BooleanOpenCustomHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/* 552 */         pos = pos + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/*     */       }
/* 554 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 562 */       int pos = HashCommon.murmurHash3(Int2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Int2BooleanOpenCustomHashMap.this.mask;
/*     */ 
/* 564 */       while (Int2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 565 */         if (Int2BooleanOpenCustomHashMap.this.strategy.equals(Int2BooleanOpenCustomHashMap.this.key[pos], k)) {
/* 566 */           Int2BooleanOpenCustomHashMap.this.remove(e.getKey());
/* 567 */           return true;
/*     */         }
/* 569 */         pos = pos + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/*     */       }
/* 571 */       return false;
/*     */     }
/*     */     public int size() {
/* 574 */       return Int2BooleanOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 577 */       Int2BooleanOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Int2BooleanOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Int2BooleanMap.Entry>
/*     */   {
/* 527 */     final AbstractInt2BooleanMap.BasicEntry entry = new AbstractInt2BooleanMap.BasicEntry(0, false);
/*     */ 
...
/* 529 */       int e = nextEntry();
/* 530 */       this.entry.key = Int2BooleanOpenCustomHashMap.this.key[e];
/* 531 */       this.entry.value = Int2BooleanOpenCustomHashMap.this.value[e];
/* 532 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Int2BooleanOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Int2BooleanMap.Entry>
/*     */   {
...
/* 518 */       return this.entry = new Int2BooleanOpenCustomHashMap.MapEntry(Int2BooleanOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 522 */       super.remove();
/* 523 */       Int2BooleanOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 424 */       this.pos = Int2BooleanOpenCustomHashMap.this.n;
/*     */ 
/* 427 */       this.last = -1;
/*     */ 
/* 429 */       this.c = Int2BooleanOpenCustomHashMap.this.size;
/*     */ 
/* 434 */       boolean[] used = Int2BooleanOpenCustomHashMap.this.used;
...
/*     */ 
/* 447 */         int pos = HashCommon.murmurHash3(Int2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Int2BooleanOpenCustomHashMap.this.mask;
/*     */ 
/* 449 */         while (Int2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 450 */           if (Int2BooleanOpenCustomHashMap.this.strategy.equals(Int2BooleanOpenCustomHashMap.this.key[pos], k)) return pos;
/* 451 */           pos = pos + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 454 */       this.last = this.pos;
/*     */ 
/* 456 */       if (this.c != 0) {
/* 457 */         boolean[] used = Int2BooleanOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 474 */         pos = (last = pos) + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/* 475 */         while (Int2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 476 */           int slot = HashCommon.murmurHash3(Int2BooleanOpenCustomHashMap.this.strategy.hashCode(Int2BooleanOpenCustomHashMap.this.key[pos])) & Int2BooleanOpenCustomHashMap.this.mask;
/* 477 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 478 */           pos = pos + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/*     */         }
/* 480 */         if (Int2BooleanOpenCustomHashMap.this.used[pos] == 0) break;
/* 481 */         if (pos < last)
/*     */         {
/* 483 */           if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 484 */           this.wrapped.add(Int2BooleanOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 486 */         Int2BooleanOpenCustomHashMap.this.key[last] = Int2BooleanOpenCustomHashMap.this.key[pos];
/* 487 */         Int2BooleanOpenCustomHashMap.this.value[last] = Int2BooleanOpenCustomHashMap.this.value[pos];
/*     */       }
/* 489 */       Int2BooleanOpenCustomHashMap.this.used[last] = false;
/* 490 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 495 */       if (this.pos < -1)
/*     */       {
/* 497 */         Int2BooleanOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 498 */         this.last = -1;
/* 499 */         return;
/*     */       }
/* 501 */       Int2BooleanOpenCustomHashMap.this.size -= 1;
...
/* 388 */       return Integer.valueOf(Int2BooleanOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public int getIntKey() {
/* 391 */       return Int2BooleanOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Boolean getValue() {
/* 394 */       return Boolean.valueOf(Int2BooleanOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public boolean getBooleanValue() {
/* 397 */       return Int2BooleanOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public boolean setValue(boolean v) {
/* 400 */       boolean oldValue = Int2BooleanOpenCustomHashMap.this.value[this.index];
/* 401 */       Int2BooleanOpenCustomHashMap.this.value[this.index] = v;
/* 402 */       return oldValue;
/*     */     }
/*     */     public Boolean setValue(Boolean v) {
...
/* 411 */       return (Int2BooleanOpenCustomHashMap.this.strategy.equals(Int2BooleanOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue())) && (Int2BooleanOpenCustomHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*     */     }
/*     */     public int hashCode() {
/* 414 */       return Int2BooleanOpenCustomHashMap.this.strategy.hashCode(Int2BooleanOpenCustomHashMap.this.key[this.index]) ^ (Int2BooleanOpenCustomHashMap.this.value[this.index] != 0 ? 1231 : 1237);
/*     */     }
/*     */     public String toString() {
/* 417 */       return Int2BooleanOpenCustomHashMap.this.key[this.index] + "=>" + Int2BooleanOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
