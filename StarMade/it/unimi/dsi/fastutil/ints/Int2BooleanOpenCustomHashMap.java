...
/*  18:    */
/*  90:    */public class Int2BooleanOpenCustomHashMap
/*  91:    */  extends AbstractInt2BooleanMap
...
/* 104:    */  protected volatile transient Int2BooleanMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Int2BooleanOpenCustomHashMap(int expected, float f, IntHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Int2BooleanOpenCustomHashMap(int expected, IntHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Int2BooleanOpenCustomHashMap(IntHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Int2BooleanOpenCustomHashMap(Map<? extends Integer, ? extends Boolean> m, float f, IntHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Int2BooleanOpenCustomHashMap(Map<? extends Integer, ? extends Boolean> m, IntHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Int2BooleanOpenCustomHashMap(Int2BooleanMap m, float f, IntHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Int2BooleanOpenCustomHashMap(Int2BooleanMap m, IntHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Int2BooleanOpenCustomHashMap(int[] k, boolean[] v, float f, IntHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Int2BooleanOpenCustomHashMap(int[] k, boolean[] v, IntHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public boolean put(int k, boolean v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Boolean put(Integer ok, Boolean ov) { boolean v = ov.booleanValue();
...
/* 269:    */  }
/* 270:    */  
/* 271:    */  public boolean remove(int k)
/* 272:    */  {
...
/* 302:    */  }
/* 303:    */  
/* 304:304 */  public Boolean get(Integer ok) { int k = ok.intValue();
/* 305:    */    
...
/* 379:    */    implements Int2BooleanMap.Entry, Map.Entry<Integer, Boolean>
/* 380:    */  {
...
/* 386:    */    }
/* 387:    */    
/* 388:388 */    public Integer getKey() { return Integer.valueOf(Int2BooleanOpenCustomHashMap.this.key[this.index]); }
/* 389:    */    
/* 390:    */    public int getIntKey() {
/* 391:391 */      return Int2BooleanOpenCustomHashMap.this.key[this.index];
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public Boolean getValue() { return Boolean.valueOf(Int2BooleanOpenCustomHashMap.this.value[this.index]); }
/* 395:    */    
/* 397:397 */    public boolean getBooleanValue() { return Int2BooleanOpenCustomHashMap.this.value[this.index]; }
/* 398:    */    
/* 399:    */    public boolean setValue(boolean v) {
/* 400:400 */      boolean oldValue = Int2BooleanOpenCustomHashMap.this.value[this.index];
/* 401:401 */      Int2BooleanOpenCustomHashMap.this.value[this.index] = v;
...
/* 410:410 */      Map.Entry<Integer, Boolean> e = (Map.Entry)o;
/* 411:411 */      return (Int2BooleanOpenCustomHashMap.this.strategy.equals(Int2BooleanOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue())) && (Int2BooleanOpenCustomHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/* 412:    */    }
/* 413:    */    
/* 414:414 */    public int hashCode() { return Int2BooleanOpenCustomHashMap.this.strategy.hashCode(Int2BooleanOpenCustomHashMap.this.key[this.index]) ^ (Int2BooleanOpenCustomHashMap.this.value[this.index] != 0 ? 1231 : 1237); }
/* 415:    */    
/* 417:417 */    public String toString() { return Int2BooleanOpenCustomHashMap.this.key[this.index] + "=>" + Int2BooleanOpenCustomHashMap.this.value[this.index]; } }
/* 418:    */  
...
/* 423:    */    
/* 424:424 */    private MapIterator() { this.pos = Int2BooleanOpenCustomHashMap.this.n;
/* 425:    */      
/* 427:427 */      this.last = -1;
/* 428:    */      
/* 429:429 */      this.c = Int2BooleanOpenCustomHashMap.this.size;
/* 430:    */      
/* 434:434 */      boolean[] used = Int2BooleanOpenCustomHashMap.this.used;
...
/* 446:    */        
/* 447:447 */        int pos = HashCommon.murmurHash3(Int2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Int2BooleanOpenCustomHashMap.this.mask;
/* 448:    */        
/* 449:449 */        while (Int2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 450:450 */          if (Int2BooleanOpenCustomHashMap.this.strategy.equals(Int2BooleanOpenCustomHashMap.this.key[pos], k)) return pos;
/* 451:451 */          pos = pos + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/* 452:    */        }
/* 453:    */      }
/* 454:454 */      this.last = this.pos;
/* 455:    */      
/* 456:456 */      if (this.c != 0) {
/* 457:457 */        boolean[] used = Int2BooleanOpenCustomHashMap.this.used;
...
/* 472:    */      for (;;)
/* 473:    */      {
/* 474:474 */        pos = (last = pos) + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/* 475:475 */        while (Int2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 476:476 */          int slot = HashCommon.murmurHash3(Int2BooleanOpenCustomHashMap.this.strategy.hashCode(Int2BooleanOpenCustomHashMap.this.key[pos])) & Int2BooleanOpenCustomHashMap.this.mask;
/* 477:477 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 478:478 */          pos = pos + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/* 479:    */        }
/* 480:480 */        if (Int2BooleanOpenCustomHashMap.this.used[pos] == 0) break;
/* 481:481 */        if (pos < last)
/* 482:    */        {
/* 483:483 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 484:484 */          this.wrapped.add(Int2BooleanOpenCustomHashMap.this.key[pos]);
/* 485:    */        }
/* 486:486 */        Int2BooleanOpenCustomHashMap.this.key[last] = Int2BooleanOpenCustomHashMap.this.key[pos];
/* 487:487 */        Int2BooleanOpenCustomHashMap.this.value[last] = Int2BooleanOpenCustomHashMap.this.value[pos];
/* 488:    */      }
/* 489:489 */      Int2BooleanOpenCustomHashMap.this.used[last] = false;
/* 490:490 */      return last;
/* 491:    */    }
/* 492:    */    
...
/* 496:    */      {
/* 497:497 */        Int2BooleanOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 498:498 */        this.last = -1;
/* 499:499 */        return;
/* 500:    */      }
/* 501:501 */      Int2BooleanOpenCustomHashMap.this.size -= 1;
...
/* 513:    */    } }
/* 514:    */  
/* 515:515 */  private class EntryIterator extends Int2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Int2BooleanMap.Entry> { private EntryIterator() { super(null); }
/* 516:    */    
/* 517:    */    private Int2BooleanOpenCustomHashMap.MapEntry entry;
/* 518:518 */    public Int2BooleanMap.Entry next() { return this.entry = new Int2BooleanOpenCustomHashMap.MapEntry(Int2BooleanOpenCustomHashMap.this, nextEntry()); }
/* 519:    */    
/* 520:    */    public void remove()
/* 521:    */    {
/* 522:522 */      super.remove();
/* 523:523 */      Int2BooleanOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 524:    */    } }
/* 525:    */  
/* 526:526 */  private class FastEntryIterator extends Int2BooleanOpenCustomHashMap.MapIterator implements ObjectIterator<Int2BooleanMap.Entry> { private FastEntryIterator() { super(null); }
/* 527:527 */    final AbstractInt2BooleanMap.BasicEntry entry = new AbstractInt2BooleanMap.BasicEntry(0, false);
/* 528:    */    
/* 529:529 */    public AbstractInt2BooleanMap.BasicEntry next() { int e = nextEntry();
/* 530:530 */      this.entry.key = Int2BooleanOpenCustomHashMap.this.key[e];
/* 531:531 */      this.entry.value = Int2BooleanOpenCustomHashMap.this.value[e];
/* 532:532 */      return this.entry;
/* 533:    */    } }
/* 534:    */  
/* 535:    */  private final class MapEntrySet extends AbstractObjectSet<Int2BooleanMap.Entry> implements Int2BooleanMap.FastEntrySet { private MapEntrySet() {}
/* 536:    */    
/* 537:537 */    public ObjectIterator<Int2BooleanMap.Entry> iterator() { return new Int2BooleanOpenCustomHashMap.EntryIterator(Int2BooleanOpenCustomHashMap.this, null); }
/* 538:    */    
/* 539:    */    public ObjectIterator<Int2BooleanMap.Entry> fastIterator() {
/* 540:540 */      return new Int2BooleanOpenCustomHashMap.FastEntryIterator(Int2BooleanOpenCustomHashMap.this, null);
/* 541:    */    }
/* 542:    */    
/* 543:    */    public boolean contains(Object o) {
/* 544:544 */      if (!(o instanceof Map.Entry)) return false;
/* 545:545 */      Map.Entry<Integer, Boolean> e = (Map.Entry)o;
/* 546:546 */      int k = ((Integer)e.getKey()).intValue();
/* 547:    */      
/* 548:548 */      int pos = HashCommon.murmurHash3(Int2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Int2BooleanOpenCustomHashMap.this.mask;
/* 549:    */      
/* 550:550 */      while (Int2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 551:551 */        if (Int2BooleanOpenCustomHashMap.this.strategy.equals(Int2BooleanOpenCustomHashMap.this.key[pos], k)) return Int2BooleanOpenCustomHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/* 552:552 */        pos = pos + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/* 553:    */      }
...
/* 559:559 */      Map.Entry<Integer, Boolean> e = (Map.Entry)o;
/* 560:560 */      int k = ((Integer)e.getKey()).intValue();
/* 561:    */      
/* 562:562 */      int pos = HashCommon.murmurHash3(Int2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Int2BooleanOpenCustomHashMap.this.mask;
/* 563:    */      
/* 564:564 */      while (Int2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 565:565 */        if (Int2BooleanOpenCustomHashMap.this.strategy.equals(Int2BooleanOpenCustomHashMap.this.key[pos], k)) {
/* 566:566 */          Int2BooleanOpenCustomHashMap.this.remove(e.getKey());
/* 567:567 */          return true;
/* 568:    */        }
/* 569:569 */        pos = pos + 1 & Int2BooleanOpenCustomHashMap.this.mask;
/* 570:    */      }
/* 571:571 */      return false;
/* 572:    */    }
/* 573:    */    
/* 574:574 */    public int size() { return Int2BooleanOpenCustomHashMap.this.size; }
/* 575:    */    
/* 577:577 */    public void clear() { Int2BooleanOpenCustomHashMap.this.clear(); }
/* 578:    */  }
/* 579:    */  
/* 580:    */  public Int2BooleanMap.FastEntrySet int2BooleanEntrySet() {
...
/* 588:    */    extends Int2BooleanOpenCustomHashMap.MapIterator
/* 589:    */    implements IntIterator
/* 590:    */  {
/* 591:591 */    public KeyIterator() { super(null); }
/* 592:592 */    public int nextInt() { return Int2BooleanOpenCustomHashMap.this.key[nextEntry()]; }
/* 593:593 */    public Integer next() { return Integer.valueOf(Int2BooleanOpenCustomHashMap.this.key[nextEntry()]); } }
/* 594:    */  
/* 595:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 596:    */    
/* 597:597 */    public IntIterator iterator() { return new Int2BooleanOpenCustomHashMap.KeyIterator(Int2BooleanOpenCustomHashMap.this); }
/* 598:    */    
/* 599:    */    public int size() {
/* 600:600 */      return Int2BooleanOpenCustomHashMap.this.size;
/* 601:    */    }
/* 602:    */    
/* 603:603 */    public boolean contains(int k) { return Int2BooleanOpenCustomHashMap.this.containsKey(k); }
/* 604:    */    
/* 605:    */    public boolean remove(int k) {
/* 606:606 */      int oldSize = Int2BooleanOpenCustomHashMap.this.size;
/* 607:607 */      Int2BooleanOpenCustomHashMap.this.remove(k);
/* 608:608 */      return Int2BooleanOpenCustomHashMap.this.size != oldSize;
/* 609:    */    }
/* 610:    */    
/* 611:611 */    public void clear() { Int2BooleanOpenCustomHashMap.this.clear(); }
/* 612:    */  }
/* 613:    */  
...
/* 622:    */    extends Int2BooleanOpenCustomHashMap.MapIterator
/* 623:    */    implements BooleanIterator
/* 624:    */  {
/* 625:625 */    public ValueIterator() { super(null); }
/* 626:626 */    public boolean nextBoolean() { return Int2BooleanOpenCustomHashMap.this.value[nextEntry()]; }
/* 627:627 */    public Boolean next() { return Boolean.valueOf(Int2BooleanOpenCustomHashMap.this.value[nextEntry()]); }
/* 628:    */  }
/* 629:    */  
...
/* 632:632 */          return new Int2BooleanOpenCustomHashMap.ValueIterator(Int2BooleanOpenCustomHashMap.this);
/* 633:    */        }
/* 634:    */        
/* 635:635 */        public int size() { return Int2BooleanOpenCustomHashMap.this.size; }
/* 636:    */        
/* 637:    */        public boolean contains(boolean v) {
/* 638:638 */          return Int2BooleanOpenCustomHashMap.this.containsValue(v);
/* 639:    */        }
/* 640:    */        
/* 641:641 */        public void clear() { Int2BooleanOpenCustomHashMap.this.clear(); }
/* 642:    */      };
/* 643:    */    }
...
/* 744:    */  }
/* 745:    */  
/* 749:    */  public Int2BooleanOpenCustomHashMap clone()
/* 750:    */  {
/* 751:    */    Int2BooleanOpenCustomHashMap c;
/* 752:    */    
/* 754:    */    try
/* 755:    */    {
/* 756:756 */      c = (Int2BooleanOpenCustomHashMap)super.clone();
/* 757:    */    }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.ints.Int2BooleanOpenCustomHashMap
