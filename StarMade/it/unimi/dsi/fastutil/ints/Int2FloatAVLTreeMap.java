  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2FloatAVLTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2FloatAVLTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2FloatAVLTreeMap(Map<? extends Integer, ? extends Float> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2FloatAVLTreeMap(SortedMap<Integer, Float> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2FloatAVLTreeMap(Int2FloatMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2FloatAVLTreeMap(Int2FloatSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2FloatAVLTreeMap(int[] local_k, float[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2FloatAVLTreeMap(int[] local_k, float[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2FloatMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Int2FloatAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2FloatAVLTreeMap.EntryIterator(Int2FloatAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from)
        {
          return new Int2FloatAVLTreeMap.EntryIterator(Int2FloatAVLTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2FloatAVLTreeMap.Entry local_f = Int2FloatAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2FloatAVLTreeMap.Entry local_f = Int2FloatAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2FloatAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2FloatAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2FloatEntrySet();
        }
        
        public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry local_to)
        {
          return Int2FloatAVLTreeMap.this.headMap((Integer)local_to.getKey()).int2FloatEntrySet();
        }
        
        public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from)
        {
          return Int2FloatAVLTreeMap.this.tailMap((Integer)from.getKey()).int2FloatEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Int2FloatAVLTreeMap.ValueIterator(Int2FloatAVLTreeMap.this, null);
        }
        
        public boolean contains(float local_k)
        {
          return Int2FloatAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2FloatAVLTreeMap local_c;
    try
    {
      local_c = (Int2FloatAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2FloatAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Int2FloatAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2FloatAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator()
          {
            return new Int2FloatAVLTreeMap.Submap.SubmapEntryIterator(Int2FloatAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from)
          {
            return new Int2FloatAVLTreeMap.Submap.SubmapEntryIterator(Int2FloatAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, Float> local_e = (Map.Entry)local_o;
            Int2FloatAVLTreeMap.Entry local_f = Int2FloatAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2FloatAVLTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, Float> local_e = (Map.Entry)local_o;
            Int2FloatAVLTreeMap.Entry local_f = Int2FloatAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2FloatAVLTreeMap.Submap.this.in4(local_f.key))) {
              Int2FloatAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2FloatAVLTreeMap.Submap.SubmapIterator(Int2FloatAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2FloatAVLTreeMap.Submap.this.clear();
          }
          
          public Int2FloatMap.Entry first()
          {
            return Int2FloatAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Int2FloatMap.Entry last()
          {
            return Int2FloatAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry from, Int2FloatMap.Entry local_to)
          {
            return Int2FloatAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2FloatEntrySet();
          }
          
          public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry local_to)
          {
            return Int2FloatAVLTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2FloatEntrySet();
          }
          
          public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from)
          {
            return Int2FloatAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2FloatEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public FloatCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractFloatCollection()
        {
          public FloatIterator iterator()
          {
            return new Int2FloatAVLTreeMap.Submap.SubmapValueIterator(Int2FloatAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(float local_k)
          {
            return Int2FloatAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2FloatAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2FloatAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2FloatAVLTreeMap.Entry local_e;
      return (in4(local_kk)) && ((local_e = Int2FloatAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public float put(int local_k, float local_v)
    {
      ...
      float oldValue = Int2FloatAVLTreeMap.this.put(local_k, local_v);
    ...
    public float remove(int local_k)
    {
      ...
      float oldValue = Int2FloatAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2FloatAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2FloatAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2FloatAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2FloatSortedMap tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2FloatAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2FloatAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2FloatSortedMap subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2FloatAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2FloatAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2FloatAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2FloatAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2FloatAVLTreeMap.this.locateKey(this.from);
        if (Int2FloatAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2FloatAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2FloatAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2FloatAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2FloatAVLTreeMap.this.locateKey(this.field_47);
        if (Int2FloatAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2FloatAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2FloatAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2FloatAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Int2FloatAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Int2FloatAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2FloatAVLTreeMap.Submap.this.bottom) && (Int2FloatAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2FloatAVLTreeMap.Submap.this.top) && (Int2FloatAVLTreeMap.this.compare(local_k, (this.prev = Int2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2FloatAVLTreeMap.this.locateKey(local_k);
            if (Int2FloatAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2FloatAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2FloatAVLTreeMap.this.compare(this.prev.key, Int2FloatAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2FloatAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2FloatAVLTreeMap.this.compare(this.next.key, Int2FloatAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2FloatSortedMap.KeySet
    {
      ...
      {
        return new Int2FloatAVLTreeMap.Submap.SubmapKeyIterator(Int2FloatAVLTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2FloatAVLTreeMap.Submap.SubmapKeyIterator(Int2FloatAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2FloatSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2FloatAVLTreeMap.KeyIterator(Int2FloatAVLTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2FloatAVLTreeMap.KeyIterator(Int2FloatAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2FloatAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Int2FloatAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
