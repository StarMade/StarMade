...
/*   22:     */
/*   73:     */public class Int2FloatAVLTreeMap
...
/*  117: 117 */          return Int2FloatAVLTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*  118:     */        }
/*  119:     */        
/*  120: 120 */        public int compare(Integer ok1, Integer ok2) { return Int2FloatAVLTreeMap.this.storedComparator.compare(ok1, ok2); }
/*  121:     */      };
/*  122:     */    }
/*  123:     */  }
/*  124:     */  
/*  131:     */  public Int2FloatAVLTreeMap(Comparator<? super Integer> c)
/*  132:     */  {
/*  133: 133 */    this();
...
/*  136:     */  }
/*  137:     */  
/*  143:     */  public Int2FloatAVLTreeMap(Map<? extends Integer, ? extends Float> m)
/*  144:     */  {
/*  145: 145 */    this();
/*  146: 146 */    putAll(m);
/*  147:     */  }
/*  148:     */  
/*  153:     */  public Int2FloatAVLTreeMap(SortedMap<Integer, Float> m)
/*  154:     */  {
/*  155: 155 */    this(m.comparator());
/*  156: 156 */    putAll(m);
/*  157:     */  }
/*  158:     */  
/*  163:     */  public Int2FloatAVLTreeMap(Int2FloatMap m)
/*  164:     */  {
/*  165: 165 */    this();
/*  166: 166 */    putAll(m);
/*  167:     */  }
/*  168:     */  
/*  173:     */  public Int2FloatAVLTreeMap(Int2FloatSortedMap m)
/*  174:     */  {
/*  175: 175 */    this(m.comparator());
/*  176: 176 */    putAll(m);
/*  177:     */  }
/*  178:     */  
/*  186:     */  public Int2FloatAVLTreeMap(int[] k, float[] v, Comparator<? super Integer> c)
/*  187:     */  {
/*  188: 188 */    this(c);
...
/*  192:     */  }
/*  193:     */  
/*  199:     */  public Int2FloatAVLTreeMap(int[] k, float[] v)
/*  200:     */  {
...
/*  273:     */  }
/*  274:     */  
/*  278:     */  public float put(int k, float v)
/*  279:     */  {
...
/*  774:     */  }
/*  775:     */  
/*  777:     */  public Float put(Integer ok, Float ov)
/*  778:     */  {
/*  779: 779 */    float oldValue = put(ok.intValue(), ov.floatValue());
/*  780: 780 */    return this.modified ? null : Float.valueOf(oldValue);
/*  781:     */  }
/*  782:     */  
/*  786:     */  public Float remove(Object ok)
/*  787:     */  {
/*  788: 788 */    float oldValue = remove(((Integer)ok).intValue());
...
/*  819:     */    implements Cloneable, Int2FloatMap.Entry
/*  820:     */  {
...
/* 1036:1036 */      Map.Entry<Integer, Float> e = (Map.Entry)o;
/* 1037:     */      
/* 1038:1038 */      return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Float)e.getValue()).floatValue());
/* 1039:     */    }
/* 1040:     */    
...
/* 1116:     */  {
/* 1117:     */    Int2FloatAVLTreeMap.Entry prev;
/* 1118:     */    
/* 1120:     */    Int2FloatAVLTreeMap.Entry next;
/* 1121:     */    
/* 1122:     */    Int2FloatAVLTreeMap.Entry curr;
/* 1123:     */    
/* 1124:1124 */    int index = 0;
/* 1125:     */    
/* 1126:1126 */    TreeIterator() { this.next = Int2FloatAVLTreeMap.this.firstEntry; }
/* 1127:     */    
/* 1128:     */    TreeIterator(int k) {
/* 1129:1129 */      if ((this.next = Int2FloatAVLTreeMap.this.locateKey(k)) != null)
/* 1130:1130 */        if (Int2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1141:     */    
/* 1142:     */    Int2FloatAVLTreeMap.Entry nextEntry() {
...
/* 1151:     */    
/* 1152:     */    Int2FloatAVLTreeMap.Entry previousEntry() {
...
/* 1173:1173 */      Int2FloatAVLTreeMap.this.remove(this.curr.key);
...
/* 1189:     */    extends Int2FloatAVLTreeMap.TreeIterator
/* 1190:     */    implements ObjectListIterator<Int2FloatMap.Entry>
/* 1191:     */  {
/* 1192:1192 */    EntryIterator() { super(); }
/* 1193:     */    
/* 1194:1194 */    EntryIterator(int k) { super(k); }
/* 1195:     */    
/* 1196:1196 */    public Int2FloatMap.Entry next() { return nextEntry(); }
/* 1197:1197 */    public Int2FloatMap.Entry previous() { return previousEntry(); }
/* 1198:1198 */    public void set(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1199:1199 */    public void add(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1200:     */  }
/* 1201:     */  
/* 1202:1202 */  public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1203:1203 */        final Comparator<? super Int2FloatMap.Entry> comparator = new Comparator() {
/* 1204:     */          public int compare(Int2FloatMap.Entry x, Int2FloatMap.Entry y) {
/* 1205:1205 */            return Int2FloatAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/* 1206:     */          }
/* 1207:     */        };
/* 1208:     */        
/* 1209:1209 */        public Comparator<? super Int2FloatMap.Entry> comparator() { return this.comparator; }
/* 1210:     */        
/* 1211:     */        public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator() {
/* 1212:1212 */          return new Int2FloatAVLTreeMap.EntryIterator(Int2FloatAVLTreeMap.this);
/* 1213:     */        }
/* 1214:     */        
/* 1215:1215 */        public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from) { return new Int2FloatAVLTreeMap.EntryIterator(Int2FloatAVLTreeMap.this, ((Integer)from.getKey()).intValue()); }
/* 1216:     */        
/* 1217:     */        public boolean contains(Object o)
/* 1218:     */        {
/* 1219:1219 */          if (!(o instanceof Map.Entry)) return false;
/* 1220:1220 */          Map.Entry<Integer, Float> e = (Map.Entry)o;
/* 1221:1221 */          Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1222:1222 */          return e.equals(f);
/* 1223:     */        }
/* 1224:     */        
/* 1225:     */        public boolean remove(Object o) {
/* 1226:1226 */          if (!(o instanceof Map.Entry)) return false;
/* 1227:1227 */          Map.Entry<Integer, Float> e = (Map.Entry)o;
/* 1228:1228 */          Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1229:1229 */          if (f != null) Int2FloatAVLTreeMap.this.remove(f.key);
/* 1230:1230 */          return f != null; }
/* 1231:     */        
/* 1232:1232 */        public int size() { return Int2FloatAVLTreeMap.this.count; }
/* 1233:1233 */        public void clear() { Int2FloatAVLTreeMap.this.clear(); }
/* 1234:1234 */        public Int2FloatMap.Entry first() { return Int2FloatAVLTreeMap.this.firstEntry; }
/* 1235:1235 */        public Int2FloatMap.Entry last() { return Int2FloatAVLTreeMap.this.lastEntry; }
/* 1236:1236 */        public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry from, Int2FloatMap.Entry to) { return Int2FloatAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2FloatEntrySet(); }
/* 1237:1237 */        public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry to) { return Int2FloatAVLTreeMap.this.headMap((Integer)to.getKey()).int2FloatEntrySet(); }
/* 1238:1238 */        public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from) { return Int2FloatAVLTreeMap.this.tailMap((Integer)from.getKey()).int2FloatEntrySet(); }
/* 1239:     */      };
/* 1240:1240 */    return this.entries;
/* 1241:     */  }
/* 1242:     */  
/* 1245:     */  private final class KeyIterator
/* 1246:     */    extends Int2FloatAVLTreeMap.TreeIterator
...
/* 1259:     */  }
/* 1260:     */  
/* 1261:1261 */  private class KeySet extends AbstractInt2FloatSortedMap.KeySet { private KeySet() { super(); }
/* 1262:1262 */    public IntBidirectionalIterator iterator() { return new Int2FloatAVLTreeMap.KeyIterator(Int2FloatAVLTreeMap.this); }
/* 1263:1263 */    public IntBidirectionalIterator iterator(int from) { return new Int2FloatAVLTreeMap.KeyIterator(Int2FloatAVLTreeMap.this, from); }
/* 1264:     */  }
/* 1265:     */  
...
/* 1280:     */    extends Int2FloatAVLTreeMap.TreeIterator
...
/* 1304:1304 */          return new Int2FloatAVLTreeMap.ValueIterator(Int2FloatAVLTreeMap.this, null);
/* 1305:     */        }
/* 1306:     */        
/* 1307:1307 */        public boolean contains(float k) { return Int2FloatAVLTreeMap.this.containsValue(k); }
/* 1308:     */        
/* 1309:     */        public int size() {
/* 1310:1310 */          return Int2FloatAVLTreeMap.this.count;
/* 1311:     */        }
/* 1312:     */        
/* 1313:1313 */        public void clear() { Int2FloatAVLTreeMap.this.clear(); }
/* 1314:     */      };
/* 1315:     */    }
...
/* 1320:     */  
/* 1321:     */  public Int2FloatSortedMap headMap(int to) {
/* 1322:1322 */    return new Submap(0, true, to, false);
/* 1323:     */  }
/* 1324:     */  
/* 1325:1325 */  public Int2FloatSortedMap tailMap(int from) { return new Submap(from, false, 0, true); }
/* 1326:     */  
/* 1327:     */  public Int2FloatSortedMap subMap(int from, int to) {
/* 1328:1328 */    return new Submap(from, false, to, false);
/* 1329:     */  }
/* 1330:     */  
/* 1334:     */  private final class Submap
/* 1335:     */    extends AbstractInt2FloatSortedMap
...
/* 1351:     */    boolean top;
/* 1352:     */    
/* 1354:     */    protected volatile transient ObjectSortedSet<Int2FloatMap.Entry> entries;
/* 1355:     */    
...
/* 1365:     */    {
/* 1366:1366 */      if ((!bottom) && (!top) && (Int2FloatAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367:1367 */      this.from = from;
/* 1368:1368 */      this.bottom = bottom;
/* 1369:1369 */      this.to = to;
/* 1370:1370 */      this.top = top;
/* 1371:1371 */      this.defRetValue = Int2FloatAVLTreeMap.this.defRetValue;
/* 1372:     */    }
/* 1373:     */    
...
/* 1384:     */    {
/* 1385:1385 */      return ((this.bottom) || (Int2FloatAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2FloatAVLTreeMap.this.compare(k, this.to) < 0));
/* 1386:     */    }
/* 1387:     */    
/* 1388:     */    public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
/* 1389:1389 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1390:     */          public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator() {
/* 1391:1391 */            return new Int2FloatAVLTreeMap.Submap.SubmapEntryIterator(Int2FloatAVLTreeMap.Submap.this);
/* 1392:     */          }
/* 1393:     */          
/* 1394:1394 */          public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from) { return new Int2FloatAVLTreeMap.Submap.SubmapEntryIterator(Int2FloatAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue()); }
/* 1395:     */          
/* 1396:1396 */          public Comparator<? super Int2FloatMap.Entry> comparator() { return Int2FloatAVLTreeMap.this.entrySet().comparator(); }
/* 1397:     */          
/* 1398:     */          public boolean contains(Object o) {
/* 1399:1399 */            if (!(o instanceof Map.Entry)) return false;
/* 1400:1400 */            Map.Entry<Integer, Float> e = (Map.Entry)o;
/* 1401:1401 */            Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1402:1402 */            return (f != null) && (Int2FloatAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1403:     */          }
/* 1404:     */          
/* 1405:     */          public boolean remove(Object o) {
/* 1406:1406 */            if (!(o instanceof Map.Entry)) return false;
/* 1407:1407 */            Map.Entry<Integer, Float> e = (Map.Entry)o;
/* 1408:1408 */            Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1409:1409 */            if ((f != null) && (Int2FloatAVLTreeMap.Submap.this.in(f.key))) Int2FloatAVLTreeMap.Submap.this.remove(f.key);
...
/* 1416:     */          }
/* 1417:     */          
/* 1418:1418 */          public boolean isEmpty() { return !new Int2FloatAVLTreeMap.Submap.SubmapIterator(Int2FloatAVLTreeMap.Submap.this).hasNext(); }
/* 1419:     */          
/* 1421:1421 */          public void clear() { Int2FloatAVLTreeMap.Submap.this.clear(); }
/* 1422:     */          
/* 1423:1423 */          public Int2FloatMap.Entry first() { return Int2FloatAVLTreeMap.Submap.this.firstEntry(); }
/* 1424:1424 */          public Int2FloatMap.Entry last() { return Int2FloatAVLTreeMap.Submap.this.lastEntry(); }
/* 1425:1425 */          public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry from, Int2FloatMap.Entry to) { return Int2FloatAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2FloatEntrySet(); }
/* 1426:1426 */          public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry to) { return Int2FloatAVLTreeMap.Submap.this.headMap((Integer)to.getKey()).int2FloatEntrySet(); }
/* 1427:1427 */          public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from) { return Int2FloatAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2FloatEntrySet(); }
/* 1428:     */        };
/* 1429:1429 */      return this.entries; }
/* 1430:     */    
/* 1431:1431 */    private class KeySet extends AbstractInt2FloatSortedMap.KeySet { private KeySet() { super(); }
/* 1432:1432 */      public IntBidirectionalIterator iterator() { return new Int2FloatAVLTreeMap.Submap.SubmapKeyIterator(Int2FloatAVLTreeMap.Submap.this); }
/* 1433:1433 */      public IntBidirectionalIterator iterator(int from) { return new Int2FloatAVLTreeMap.Submap.SubmapKeyIterator(Int2FloatAVLTreeMap.Submap.this, from); }
/* 1434:     */    }
/* 1435:     */    
...
/* 1442:1442 */            return new Int2FloatAVLTreeMap.Submap.SubmapValueIterator(Int2FloatAVLTreeMap.Submap.this, null);
/* 1443:     */          }
/* 1444:     */          
/* 1445:1445 */          public boolean contains(float k) { return Int2FloatAVLTreeMap.Submap.this.containsValue(k); }
/* 1446:     */          
/* 1447:     */          public int size() {
/* 1448:1448 */            return Int2FloatAVLTreeMap.Submap.this.size();
/* 1449:     */          }
/* 1450:     */          
/* 1451:1451 */          public void clear() { Int2FloatAVLTreeMap.Submap.this.clear(); }
/* 1452:     */        };
/* 1453:     */      }
/* 1454:1454 */      return this.values;
/* 1455:     */    }
/* 1456:     */    
/* 1458:1458 */    public boolean containsKey(int k) { return (in(k)) && (Int2FloatAVLTreeMap.this.containsKey(k)); }
/* 1459:     */    
...
/* 1468:     */    }
/* 1469:     */    
/* 1470:     */    public float get(int k)
/* 1471:     */    {
/* 1472:1472 */      int kk = k;
/* 1473:1473 */      Int2FloatAVLTreeMap.Entry e; return (in(kk)) && ((e = Int2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1474:     */    }
/* 1475:     */    
/* 1476:1476 */    public float put(int k, float v) { Int2FloatAVLTreeMap.this.modified = false;
...
/* 1478:1478 */      float oldValue = Int2FloatAVLTreeMap.this.put(k, v);
/* 1479:1479 */      return Int2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1480:     */    }
/* 1481:     */    
/* 1482:1482 */    public Float put(Integer ok, Float ov) { float oldValue = put(ok.intValue(), ov.floatValue());
/* 1483:1483 */      return Int2FloatAVLTreeMap.this.modified ? null : Float.valueOf(oldValue);
/* 1484:     */    }
/* 1485:     */    
/* 1486:     */    public float remove(int k) {
/* 1487:1487 */      Int2FloatAVLTreeMap.this.modified = false;
/* 1488:1488 */      if (!in(k)) return this.defRetValue;
/* 1489:1489 */      float oldValue = Int2FloatAVLTreeMap.this.remove(k);
/* 1490:1490 */      return Int2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1491:     */    }
/* 1492:     */    
/* 1493:1493 */    public Float remove(Object ok) { float oldValue = remove(((Integer)ok).intValue());
/* 1494:1494 */      return Int2FloatAVLTreeMap.this.modified ? Float.valueOf(oldValue) : null;
/* 1495:     */    }
/* 1496:     */    
...
/* 1507:     */    
/* 1509:1509 */    public IntComparator comparator() { return Int2FloatAVLTreeMap.this.actualComparator; }
/* 1510:     */    
/* 1511:     */    public Int2FloatSortedMap headMap(int to) {
/* 1512:1512 */      if (this.top) return new Submap(Int2FloatAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513:1513 */      return Int2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2FloatAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1514:     */    }
/* 1515:     */    
/* 1516:1516 */    public Int2FloatSortedMap tailMap(int from) { if (this.bottom) return new Submap(Int2FloatAVLTreeMap.this, from, false, this.to, this.top);
/* 1517:1517 */      return Int2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2FloatAVLTreeMap.this, from, false, this.to, this.top) : this;
/* 1518:     */    }
/* 1519:     */    
/* 1520:1520 */    public Int2FloatSortedMap subMap(int from, int to) { if ((this.top) && (this.bottom)) return new Submap(Int2FloatAVLTreeMap.this, from, false, to, false);
/* 1521:1521 */      if (!this.top) to = Int2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522:1522 */      if (!this.bottom) from = Int2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523:1523 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524:1524 */      return new Submap(Int2FloatAVLTreeMap.this, from, false, to, false);
/* 1525:     */    }
/* 1526:     */    
/* 1529:     */    public Int2FloatAVLTreeMap.Entry firstEntry()
/* 1530:     */    {
/* 1531:1531 */      if (Int2FloatAVLTreeMap.this.tree == null) return null;
/* 1532:     */      Int2FloatAVLTreeMap.Entry e;
/* 1533:     */      Int2FloatAVLTreeMap.Entry e;
/* 1534:1534 */      if (this.bottom) { e = Int2FloatAVLTreeMap.this.firstEntry;
/* 1535:     */      } else {
/* 1536:1536 */        e = Int2FloatAVLTreeMap.this.locateKey(this.from);
/* 1537:     */        
/* 1538:1538 */        if (Int2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1539:     */        }
/* 1540:     */      }
/* 1541:1541 */      if ((e == null) || ((!this.top) && (Int2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542:1542 */      return e;
/* 1543:     */    }
/* 1544:     */    
/* 1547:     */    public Int2FloatAVLTreeMap.Entry lastEntry()
/* 1548:     */    {
/* 1549:1549 */      if (Int2FloatAVLTreeMap.this.tree == null) return null;
/* 1550:     */      Int2FloatAVLTreeMap.Entry e;
/* 1551:     */      Int2FloatAVLTreeMap.Entry e;
/* 1552:1552 */      if (this.top) { e = Int2FloatAVLTreeMap.this.lastEntry;
/* 1553:     */      } else {
/* 1554:1554 */        e = Int2FloatAVLTreeMap.this.locateKey(this.to);
/* 1555:     */        
/* 1556:1556 */        if (Int2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1557:     */        }
/* 1558:     */      }
/* 1559:1559 */      if ((e == null) || ((!this.bottom) && (Int2FloatAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560:1560 */      return e;
/* 1561:     */    }
/* 1562:     */    
/* 1563:1563 */    public int firstIntKey() { Int2FloatAVLTreeMap.Entry e = firstEntry();
/* 1564:1564 */      if (e == null) throw new NoSuchElementException();
/* 1565:1565 */      return e.key;
/* 1566:     */    }
/* 1567:     */    
/* 1568:1568 */    public int lastIntKey() { Int2FloatAVLTreeMap.Entry e = lastEntry();
/* 1569:1569 */      if (e == null) throw new NoSuchElementException();
/* 1570:1570 */      return e.key;
/* 1571:     */    }
/* 1572:     */    
/* 1573:1573 */    public Integer firstKey() { Int2FloatAVLTreeMap.Entry e = firstEntry();
/* 1574:1574 */      if (e == null) throw new NoSuchElementException();
/* 1575:1575 */      return e.getKey();
/* 1576:     */    }
/* 1577:     */    
/* 1578:1578 */    public Integer lastKey() { Int2FloatAVLTreeMap.Entry e = lastEntry();
/* 1579:1579 */      if (e == null) throw new NoSuchElementException();
/* 1580:1580 */      return e.getKey();
/* 1581:     */    }
/* 1582:     */    
/* 1585:     */    private class SubmapIterator
/* 1586:     */      extends Int2FloatAVLTreeMap.TreeIterator
/* 1587:     */    {
/* 1588:     */      SubmapIterator()
/* 1589:     */      {
/* 1590:1590 */        super();
/* 1591:1591 */        this.next = Int2FloatAVLTreeMap.Submap.this.firstEntry();
/* 1592:     */      }
/* 1593:     */      
/* 1594:1594 */      SubmapIterator(int k) { this();
/* 1595:1595 */        if (this.next != null)
/* 1596:1596 */          if ((!Int2FloatAVLTreeMap.Submap.this.bottom) && (Int2FloatAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597:1597 */          } else if ((!Int2FloatAVLTreeMap.Submap.this.top) && (Int2FloatAVLTreeMap.this.compare(k, (this.prev = Int2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1598:     */          } else {
/* 1599:1599 */            this.next = Int2FloatAVLTreeMap.this.locateKey(k);
/* 1600:1600 */            if (Int2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610:1610 */        if ((!Int2FloatAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2FloatAVLTreeMap.this.compare(this.prev.key, Int2FloatAVLTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1611:     */      }
/* 1612:     */      
/* 1613:1613 */      void updateNext() { this.next = this.next.next();
/* 1614:1614 */        if ((!Int2FloatAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2FloatAVLTreeMap.this.compare(this.next.key, Int2FloatAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1615:     */      }
/* 1616:     */    }
/* 1617:     */    
/* 1618:1618 */    private class SubmapEntryIterator extends Int2FloatAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Int2FloatMap.Entry> { SubmapEntryIterator() { super(); }
/* 1619:     */      
/* 1620:1620 */      SubmapEntryIterator(int k) { super(k); }
/* 1621:     */      
/* 1622:1622 */      public Int2FloatMap.Entry next() { return nextEntry(); }
/* 1623:1623 */      public Int2FloatMap.Entry previous() { return previousEntry(); }
/* 1624:1624 */      public void set(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1625:1625 */      public void add(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1626:     */    }
/* 1627:     */    
/* 1632:     */    private final class SubmapKeyIterator
/* 1633:     */      extends Int2FloatAVLTreeMap.Submap.SubmapIterator
...
/* 1652:     */      extends Int2FloatAVLTreeMap.Submap.SubmapIterator
...
/* 1665:     */  }
/* 1666:     */  
/* 1670:     */  public Int2FloatAVLTreeMap clone()
/* 1671:     */  {
/* 1672:     */    Int2FloatAVLTreeMap c;
/* 1673:     */    
/* 1675:     */    try
/* 1676:     */    {
/* 1677:1677 */      c = (Int2FloatAVLTreeMap)super.clone();
/* 1678:     */    }
...
/* 1748:     */  {
/* 1749:1749 */    if (n == 1) {
/* 1750:1750 */      Entry top = new Entry(s.readInt(), s.readFloat());
...
/* 1755:1755 */    if (n == 2)
/* 1756:     */    {
/* 1758:1758 */      Entry top = new Entry(s.readInt(), s.readFloat());
/* 1759:1759 */      top.right(new Entry(s.readInt(), s.readFloat()));
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.ints.Int2FloatAVLTreeMap
