...
/*      */ 
/*      */ public class Int2FloatAVLTreeMap extends AbstractInt2FloatSortedMap
...
/*  117 */           return Int2FloatAVLTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  120 */           return Int2FloatAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     float oldValue = put(ok.intValue(), ov.floatValue());
/*  780 */     return this.modified ? null : Float.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Float remove(Object ok)
/*      */   {
/*  788 */     float oldValue = remove(((Integer)ok).intValue());
...
/* 1203 */         final Comparator<? super Int2FloatMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2FloatMap.Entry x, Int2FloatMap.Entry y) {
/* 1205 */             return Int2FloatAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Int2FloatAVLTreeMap.EntryIterator(Int2FloatAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from) {
/* 1215 */           return new Int2FloatAVLTreeMap.EntryIterator(Int2FloatAVLTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1228 */           Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1229 */           if (f != null) Int2FloatAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Int2FloatAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Int2FloatAVLTreeMap.this.clear(); } 
/* 1234 */         public Int2FloatMap.Entry first() { return Int2FloatAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Int2FloatMap.Entry last() { return Int2FloatAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry from, Int2FloatMap.Entry to) { return Int2FloatAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2FloatEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry to) { return Int2FloatAVLTreeMap.this.headMap((Integer)to.getKey()).int2FloatEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from) { return Int2FloatAVLTreeMap.this.tailMap((Integer)from.getKey()).int2FloatEntrySet(); }
/*      */       };
...
/* 1304 */           return new Int2FloatAVLTreeMap.ValueIterator(Int2FloatAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(float k) {
/* 1307 */           return Int2FloatAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Int2FloatAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Int2FloatAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Int2FloatAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readInt(), s.readFloat());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readInt(), s.readFloat());
/* 1759 */       top.right(new Entry(s.readInt(), s.readFloat()));
...
/*      */   }
/*      */ 
/*      */   private final class Submap extends AbstractInt2FloatSortedMap
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Int2FloatAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Int2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Int2FloatAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2FloatAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator() {
/* 1391 */             return new Int2FloatAVLTreeMap.Submap.SubmapEntryIterator(Int2FloatAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from) {
/* 1394 */             return new Int2FloatAVLTreeMap.Submap.SubmapEntryIterator(Int2FloatAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1396 */           public Comparator<? super Int2FloatMap.Entry> comparator() { return Int2FloatAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1402 */             return (f != null) && (Int2FloatAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Int2FloatAVLTreeMap.Entry f = Int2FloatAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1409 */             if ((f != null) && (Int2FloatAVLTreeMap.Submap.this.in(f.key))) Int2FloatAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Int2FloatAVLTreeMap.Submap.SubmapIterator(Int2FloatAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Int2FloatAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Int2FloatMap.Entry first() { return Int2FloatAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Int2FloatMap.Entry last() { return Int2FloatAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry from, Int2FloatMap.Entry to) { return Int2FloatAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2FloatEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry to) { return Int2FloatAVLTreeMap.Submap.this.headMap((Integer)to.getKey()).int2FloatEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from) { return Int2FloatAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2FloatEntrySet(); }
/*      */         };
...
/*      */           public FloatIterator iterator() {
/* 1442 */             return new Int2FloatAVLTreeMap.Submap.SubmapValueIterator(Int2FloatAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(float k) {
/* 1445 */             return Int2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Int2FloatAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Int2FloatAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1458 */       return (in(k)) && (Int2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(float v) {
...
/* 1473 */       return (in(kk)) && ((e = Int2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public float put(int k, float v) {
/* 1476 */       Int2FloatAVLTreeMap.this.modified = false;
...
/* 1478 */       float oldValue = Int2FloatAVLTreeMap.this.put(k, v);
/* 1479 */       return Int2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Float put(Integer ok, Float ov) {
/* 1482 */       float oldValue = put(ok.intValue(), ov.floatValue());
/* 1483 */       return Int2FloatAVLTreeMap.this.modified ? null : Float.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public float remove(int k) {
/* 1487 */       Int2FloatAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       float oldValue = Int2FloatAVLTreeMap.this.remove(k);
/* 1490 */       return Int2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Float remove(Object ok) {
/* 1493 */       float oldValue = remove(((Integer)ok).intValue());
/* 1494 */       return Int2FloatAVLTreeMap.this.modified ? Float.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1509 */       return Int2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2FloatSortedMap headMap(int to) {
/* 1512 */       if (this.top) return new Submap(Int2FloatAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Int2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2FloatAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2FloatSortedMap tailMap(int from) {
/* 1516 */       if (this.bottom) return new Submap(Int2FloatAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Int2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2FloatAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2FloatSortedMap subMap(int from, int to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Int2FloatAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Int2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Int2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Int2FloatAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2FloatAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Int2FloatAVLTreeMap.this.tree == null) return null;
/* 1534 */       Int2FloatAVLTreeMap.Entry e;
/*      */       Int2FloatAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Int2FloatAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Int2FloatAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Int2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Int2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2FloatAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Int2FloatAVLTreeMap.this.tree == null) return null;
/* 1552 */       Int2FloatAVLTreeMap.Entry e;
/*      */       Int2FloatAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Int2FloatAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Int2FloatAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Int2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Int2FloatAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1563 */       Int2FloatAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1568 */       Int2FloatAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1573 */       Int2FloatAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1578 */       Int2FloatAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2FloatAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2FloatAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2FloatAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Int2FloatMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Int2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Int2FloatAVLTreeMap.Submap.this.bottom) && (Int2FloatAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Int2FloatAVLTreeMap.Submap.this.top) && (Int2FloatAVLTreeMap.this.compare(k, (this.prev = Int2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Int2FloatAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Int2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Int2FloatAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2FloatAVLTreeMap.this.compare(this.prev.key, Int2FloatAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Int2FloatAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2FloatAVLTreeMap.this.compare(this.next.key, Int2FloatAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public IntBidirectionalIterator iterator() { return new Int2FloatAVLTreeMap.Submap.SubmapKeyIterator(Int2FloatAVLTreeMap.Submap.this); } 
/* 1433 */       public IntBidirectionalIterator iterator(int from) { return new Int2FloatAVLTreeMap.Submap.SubmapKeyIterator(Int2FloatAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2FloatAVLTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public IntBidirectionalIterator iterator() { return new Int2FloatAVLTreeMap.KeyIterator(Int2FloatAVLTreeMap.this); } 
/* 1263 */     public IntBidirectionalIterator iterator(int from) { return new Int2FloatAVLTreeMap.KeyIterator(Int2FloatAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2FloatAVLTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2FloatAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2FloatMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Int2FloatMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Int2FloatAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1129 */       if ((this.next = Int2FloatAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Int2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Int2FloatAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Float)e.getValue()).floatValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
