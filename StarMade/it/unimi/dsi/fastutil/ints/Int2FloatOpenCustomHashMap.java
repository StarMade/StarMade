  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2FloatOpenCustomHashMap(int expected, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2FloatOpenCustomHashMap(Map<? extends Integer, ? extends Float> local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2FloatOpenCustomHashMap(Map<? extends Integer, ? extends Float> local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2FloatOpenCustomHashMap(Int2FloatMap local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2FloatOpenCustomHashMap(Int2FloatMap local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2FloatOpenCustomHashMap(int[] local_k, float[] local_v, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2FloatOpenCustomHashMap(int[] local_k, float[] local_v, IntHash.Strategy strategy)
  {
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Int2FloatOpenCustomHashMap.ValueIterator(Int2FloatOpenCustomHashMap.this);
        }
        ...
        {
          return Int2FloatOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2FloatOpenCustomHashMap local_c;
    try
    {
      local_c = (Int2FloatOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2FloatOpenCustomHashMap.MapIterator
    implements FloatIterator
  {
    ...
    {
      return Int2FloatOpenCustomHashMap.this.value[nextEntry()];
    }
    
    public Float next()
    {
      return Float.valueOf(Int2FloatOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSet
  {
    ...
    {
      return new Int2FloatOpenCustomHashMap.KeyIterator(Int2FloatOpenCustomHashMap.this);
    }
    ...
    {
      return Int2FloatOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2FloatOpenCustomHashMap.this.size;
      Int2FloatOpenCustomHashMap.this.remove(local_k);
    ...
    implements IntIterator
  {
    ...
    public int nextInt()
    {
      return Int2FloatOpenCustomHashMap.this.key[nextEntry()];
    }
    
    public Integer next()
    {
      return Integer.valueOf(Int2FloatOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2FloatMap.FastEntrySet
  {
    ...
    {
      return new Int2FloatOpenCustomHashMap.EntryIterator(Int2FloatOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Int2FloatMap.Entry> fastIterator()
    {
      return new Int2FloatOpenCustomHashMap.FastEntryIterator(Int2FloatOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2FloatOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2FloatOpenCustomHashMap.this.mask; Int2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask) {
        if (Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[pos], local_k)) {
          return Int2FloatOpenCustomHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2FloatOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2FloatOpenCustomHashMap.this.mask; Int2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask) {
        if (Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[pos], local_k))
        {
          Int2FloatOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2FloatMap.Entry>
  {
    ...
    public AbstractInt2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2FloatOpenCustomHashMap.this.key[local_e];
      this.entry.value = Int2FloatOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Int2FloatOpenCustomHashMap.MapEntry(Int2FloatOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2FloatOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1807 = Int2FloatOpenCustomHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2FloatOpenCustomHashMap.this.used;
      while ((this.field_1807 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1807 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1807 != 0)
      {
        boolean[] local_k = Int2FloatOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2FloatOpenCustomHashMap.this.mask; Int2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2FloatOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2FloatOpenCustomHashMap.this.strategy.hashCode(Int2FloatOpenCustomHashMap.this.key[pos])) & Int2FloatOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2FloatOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Int2FloatOpenCustomHashMap.this.key[pos]);
        }
        Int2FloatOpenCustomHashMap.this.key[last] = Int2FloatOpenCustomHashMap.this.key[pos];
        Int2FloatOpenCustomHashMap.this.value[last] = Int2FloatOpenCustomHashMap.this.value[pos];
      }
      Int2FloatOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Int2FloatOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
        this.last = -1;
        return;
      }
      Int2FloatOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1807 > 0))
      {
        this.field_1807 += 1;
        nextEntry();
      }
    ...
    implements Int2FloatMap.Entry, Map.Entry<Integer, Float>
  {
    ...
    {
      return Integer.valueOf(Int2FloatOpenCustomHashMap.this.key[this.index]);
    }
    ...
    public float setValue(float local_v)
    {
      ...
      Int2FloatOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Float> local_e = (Map.Entry)local_o;
      return (Int2FloatOpenCustomHashMap.this.strategy.equals(Int2FloatOpenCustomHashMap.this.key[this.index], ((Integer)local_e.getKey()).intValue())) && (Int2FloatOpenCustomHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
