  ...
  implements IntIndirectPriorityQueue
{
  ...
  public IntArrayIndirectPriorityQueue(int[] refArray, int capacity, IntComparator local_c)
  {
    if (capacity > 0) {
  ...
  public IntArrayIndirectPriorityQueue(int[] refArray, IntComparator local_c)
  {
  ...
  public IntArrayIndirectPriorityQueue(int[] refArray, int[] local_a, int size, IntComparator local_c)
  {
  ...
  public IntArrayIndirectPriorityQueue(int[] refArray, int[] local_a, IntComparator local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public IntArrayIndirectPriorityQueue(int[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public IntArrayIndirectPriorityQueue(int[] refArray, int[] local_a)
  {
