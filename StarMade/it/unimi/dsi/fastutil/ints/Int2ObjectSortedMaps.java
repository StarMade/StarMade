...
/*     */     }
/* 302 */     public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.int2ObjectEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Integer, V>> entrySet() {
/* 304 */       return int2ObjectEntrySet(); } 
...
/* 308 */     public Int2ObjectSortedMap<V> headMap(int to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Int2ObjectSortedMap<V> tailMap(int from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Int2ObjectSortedMap<V> headMap(Integer to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Int2ObjectSortedMap<V> tailMap(Integer from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.int2ObjectEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Integer, V>> entrySet() {
/* 244 */       return int2ObjectEntrySet(); } 
...
/* 248 */     public Int2ObjectSortedMap<V> headMap(int to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Int2ObjectSortedMap<V> tailMap(int from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public int firstIntKey() {
...
/* 259 */     public Int2ObjectSortedMap<V> headMap(Integer to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Int2ObjectSortedMap<V> tailMap(Integer from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Int2ObjectMaps.Singleton.SingletonEntry(this), Int2ObjectSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Integer, V>> entrySet() { return int2ObjectEntrySet(); } 
/*     */     public IntSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = IntSortedSets.singleton(this.key, this.comparator); return (IntSortedSet)this.keys;
/*     */     }
/*     */     public Int2ObjectSortedMap<V> subMap(int from, int to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Int2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Int2ObjectSortedMap<V> headMap(int to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Int2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Int2ObjectSortedMap<V> tailMap(int from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Int2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Int2ObjectSortedMap<V> tailMap(Integer ofrom) { return tailMap(ofrom.intValue()); } 
/* 156 */     public Int2ObjectSortedMap<V> subMap(Integer ofrom, Integer oto) { return subMap(ofrom.intValue(), oto.intValue()); } 
/*     */     public Integer firstKey() {
...
/*  77 */       return null;
/*     */     }
/*  79 */     public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Integer, V>> entrySet() {
/*  81 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  83 */     public IntSortedSet keySet() { return IntSortedSets.EMPTY_SET; } 
/*     */     public Int2ObjectSortedMap<V> subMap(int from, int to) {
/*  85 */       return Int2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*  87 */     public Int2ObjectSortedMap<V> headMap(int to) { return Int2ObjectSortedMaps.EMPTY_MAP; } 
/*     */     public Int2ObjectSortedMap<V> tailMap(int from) {
/*  89 */       return Int2ObjectSortedMaps.EMPTY_MAP; } 
/*  90 */     public int firstIntKey() { throw new NoSuchElementException(); } 
/*  91 */     public int lastIntKey() { throw new NoSuchElementException(); } 
/*  92 */     public Int2ObjectSortedMap<V> headMap(Integer oto) { return headMap(oto.intValue()); } 
/*  93 */     public Int2ObjectSortedMap<V> tailMap(Integer ofrom) { return tailMap(ofrom.intValue()); } 
/*  94 */     public Int2ObjectSortedMap<V> subMap(Integer ofrom, Integer oto) { return subMap(ofrom.intValue(), oto.intValue()); } 
