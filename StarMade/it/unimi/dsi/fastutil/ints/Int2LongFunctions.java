...
public class Int2LongFunctions
{
  ...
  public static Int2LongFunction synchronize(Int2LongFunction local_f)
  {
    return new SynchronizedFunction(local_f);
  }
  
  public static Int2LongFunction synchronize(Int2LongFunction local_f, Object sync)
  {
    return new SynchronizedFunction(local_f, sync);
  }
  
  public static Int2LongFunction unmodifiable(Int2LongFunction local_f)
  {
    ...
    implements Serializable
  {
    ...
    protected UnmodifiableFunction(Int2LongFunction local_f)
    {
      if (local_f == null) {
    ...
    implements Serializable
  {
    ...
    protected SynchronizedFunction(Int2LongFunction local_f, Object sync)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
    ...
    protected SynchronizedFunction(Int2LongFunction local_f)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
