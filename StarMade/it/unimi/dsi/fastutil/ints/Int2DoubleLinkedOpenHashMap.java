...
/*  786 */   public Int2DoubleSortedMap tailMap(int from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Int2DoubleSortedMap headMap(int to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Int2DoubleSortedMap subMap(int from, int to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Int2DoubleLinkedOpenHashMap.ValueIterator(Int2DoubleLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Int2DoubleLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(double v) {
/* 1113 */           return Int2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Int2DoubleLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Int2DoubleLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public double previousDouble()
/*      */     {
/* 1094 */       return Int2DoubleLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Double previous() { return Double.valueOf(Int2DoubleLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public double nextDouble() { return Int2DoubleLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Double next() { return Double.valueOf(Int2DoubleLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Int2DoubleLinkedOpenHashMap.KeyIterator(Int2DoubleLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public IntListIterator iterator() {
/* 1054 */       return new Int2DoubleLinkedOpenHashMap.KeyIterator(Int2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Int2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(int k) {
/* 1060 */       return Int2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(int k) {
/* 1063 */       int oldSize = Int2DoubleLinkedOpenHashMap.this.size;
/* 1064 */       Int2DoubleLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Int2DoubleLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Int2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public int firstInt() {
/* 1071 */       if (Int2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Int2DoubleLinkedOpenHashMap.this.key[Int2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public int lastInt() {
/* 1075 */       if (Int2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Int2DoubleLinkedOpenHashMap.this.key[Int2DoubleLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator(int k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public int previousInt() { return Int2DoubleLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Integer previous() { return Integer.valueOf(Int2DoubleLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public int nextInt() { return Int2DoubleLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Integer next() { return Integer.valueOf(Int2DoubleLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Int2DoubleMap.Entry>
...
/*      */     {
/*  966 */       return new Int2DoubleLinkedOpenHashMap.EntryIterator(Int2DoubleLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Int2DoubleMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry fromElement, Int2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Int2DoubleMap.Entry first() {
/*  973 */       if (Int2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Int2DoubleLinkedOpenHashMap.MapEntry(Int2DoubleLinkedOpenHashMap.this, Int2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Int2DoubleMap.Entry last() {
/*  977 */       if (Int2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Int2DoubleLinkedOpenHashMap.MapEntry(Int2DoubleLinkedOpenHashMap.this, Int2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Int2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Int2DoubleLinkedOpenHashMap.this.key[pos] == k) return Int2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/*  990 */         pos = pos + 1 & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Int2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Int2DoubleLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Int2DoubleLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Int2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Int2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from) {
/* 1018 */       return new Int2DoubleLinkedOpenHashMap.EntryIterator(Int2DoubleLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Int2DoubleMap.Entry> fastIterator() {
/* 1021 */       return new Int2DoubleLinkedOpenHashMap.FastEntryIterator(Int2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Int2DoubleMap.Entry> fastIterator(Int2DoubleMap.Entry from) {
/* 1024 */       return new Int2DoubleLinkedOpenHashMap.FastEntryIterator(Int2DoubleLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Int2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Int2DoubleMap.Entry>
/*      */   {
/*  944 */     final AbstractInt2DoubleMap.BasicEntry entry = new AbstractInt2DoubleMap.BasicEntry(0, 0.0D);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Int2DoubleLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Int2DoubleLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractInt2DoubleMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Int2DoubleLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Int2DoubleLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Int2DoubleMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Int2DoubleLinkedOpenHashMap.MapEntry(Int2DoubleLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Int2DoubleLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Int2DoubleLinkedOpenHashMap.MapEntry(Int2DoubleLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Int2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Int2DoubleLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(int from) {
/*  809 */       if (Int2DoubleLinkedOpenHashMap.this.key[Int2DoubleLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Int2DoubleLinkedOpenHashMap.this.last;
/*  811 */         this.index = Int2DoubleLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Int2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Int2DoubleLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Int2DoubleLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Int2DoubleLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Int2DoubleLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Int2DoubleLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Int2DoubleLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Int2DoubleLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Int2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Int2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Int2DoubleLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Int2DoubleLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Int2DoubleLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Int2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Int2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Int2DoubleLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Int2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Int2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Int2DoubleLinkedOpenHashMap.this.mask;
/*  897 */         while (Int2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Int2DoubleLinkedOpenHashMap.this.key[pos]) & Int2DoubleLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Int2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Int2DoubleLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Int2DoubleLinkedOpenHashMap.this.key[last] = Int2DoubleLinkedOpenHashMap.this.key[pos];
/*  904 */         Int2DoubleLinkedOpenHashMap.this.value[last] = Int2DoubleLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Int2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Int2DoubleLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*  669 */       return Integer.valueOf(Int2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public int getIntKey() {
/*  672 */       return Int2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Double getValue() {
/*  675 */       return Double.valueOf(Int2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public double getDoubleValue() {
/*  678 */       return Int2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public double setValue(double v) {
/*  681 */       double oldValue = Int2DoubleLinkedOpenHashMap.this.value[this.index];
/*  682 */       Int2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Double setValue(Double v) {
...
/*  692 */       return (Int2DoubleLinkedOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Int2DoubleLinkedOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Int2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Int2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Int2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
