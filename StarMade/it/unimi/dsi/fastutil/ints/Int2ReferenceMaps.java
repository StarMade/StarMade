...
/*  14:    */
/*  58:    */public class Int2ReferenceMaps
/*  59:    */{
/*  60:    */  public static class EmptyMap<V>
/*  61:    */    extends Int2ReferenceFunctions.EmptyFunction<V>
/*  62:    */    implements Int2ReferenceMap<V>, Serializable, Cloneable
/*  63:    */  {
...
/*  67: 67 */    public void putAll(Map<? extends Integer, ? extends V> m) { throw new UnsupportedOperationException(); }
/*  68:    */    
/*  69: 69 */    public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() { return ObjectSets.EMPTY_SET; }
/*  70:    */    
/*  71: 71 */    public IntSet keySet() { return IntSets.EMPTY_SET; }
/*  72:    */    
/*  73: 73 */    public ReferenceCollection<V> values() { return ReferenceSets.EMPTY_SET; }
/*  74: 74 */    private Object readResolve() { return Int2ReferenceMaps.EMPTY_MAP; }
/*  75: 75 */    public Object clone() { return Int2ReferenceMaps.EMPTY_MAP; }
/*  76:    */    
/*  77: 77 */    public boolean isEmpty() { return true; }
/*  78:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<Integer, V>> entrySet() { return int2ReferenceEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Int2ReferenceFunctions.Singleton<V>
/* 103:    */    implements Int2ReferenceMap<V>, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Int2ReferenceMap.Entry<V>> entries;
/* 108:    */    
...
/* 125:    */    
/* 126:126 */    public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Int2ReferenceMap.Entry<V>, Map.Entry<Integer, V> { protected SingletonEntry() {}
/* 131:131 */      public Integer getKey() { return Integer.valueOf(Int2ReferenceMaps.Singleton.this.key); }
/* 132:132 */      public V getValue() { return Int2ReferenceMaps.Singleton.this.value; }
/* 133:    */      
/* 134:    */      public int getIntKey() {
/* 135:135 */        return Int2ReferenceMaps.Singleton.this.key;
/* 136:    */      }
/* 137:    */      
...
/* 148:    */        
/* 149:149 */        return (Int2ReferenceMaps.Singleton.this.key == ((Integer)e.getKey()).intValue()) && (Int2ReferenceMaps.Singleton.this.value == e.getValue());
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return Int2ReferenceMaps.Singleton.this.key ^ (Int2ReferenceMaps.Singleton.this.value == null ? 0 : System.identityHashCode(Int2ReferenceMaps.Singleton.this.value)); }
/* 153:153 */      public String toString() { return Int2ReferenceMaps.Singleton.this.key + "->" + Int2ReferenceMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<Integer, V>> entrySet() { return int2ReferenceEntrySet(); }
/* 160:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static <V> Int2ReferenceMap<V> singleton(int key, V value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static <V> Int2ReferenceMap<V> singleton(Integer key, V value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key.intValue(), value);
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap<V>
/* 205:    */    extends Int2ReferenceFunctions.SynchronizedFunction<V>
/* 206:    */    implements Int2ReferenceMap<V>, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Int2ReferenceMap<V> map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Int2ReferenceMap.Entry<V>> entries;
/* 213:    */    
/* 214:    */    protected volatile transient IntSet keys;
/* 215:    */    protected volatile transient ReferenceCollection<V> values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Int2ReferenceMap<V> m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Int2ReferenceMap<V> m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 239:    */    
/* 240:240 */    public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.int2ReferenceEntrySet(), this.sync); return this.entries; }
...
/* 261:    */  }
/* 262:    */  
/* 264:    */  public static <V> Int2ReferenceMap<V> synchronize(Int2ReferenceMap<V> m)
/* 265:    */  {
/* 266:266 */    return new SynchronizedMap(m);
/* 267:    */  }
/* 268:    */  
/* 274:274 */  public static <V> Int2ReferenceMap<V> synchronize(Int2ReferenceMap<V> m, Object sync) { return new SynchronizedMap(m, sync); }
/* 275:    */  
/* 276:    */  public static class UnmodifiableMap<V> extends Int2ReferenceFunctions.UnmodifiableFunction<V> implements Int2ReferenceMap<V>, Serializable {
/* 277:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 278:    */    protected final Int2ReferenceMap<V> map;
/* 279:    */    protected volatile transient ObjectSet<Int2ReferenceMap.Entry<V>> entries;
/* 280:    */    protected volatile transient IntSet keys;
/* 281:    */    protected volatile transient ReferenceCollection<V> values;
/* 282:    */    
/* 283:283 */    protected UnmodifiableMap(Int2ReferenceMap<V> m) { super();
/* 284:284 */      this.map = m; }
/* 285:    */    
...
/* 294:294 */    public ObjectSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.int2ReferenceEntrySet()); return this.entries; }
...
/* 306:    */  }
/* 307:    */  
/* 311:    */  public static <V> Int2ReferenceMap<V> unmodifiable(Int2ReferenceMap<V> m)
/* 312:    */  {
