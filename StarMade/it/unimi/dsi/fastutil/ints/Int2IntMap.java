...
public abstract interface Int2IntMap extends Int2IntFunction, Map<Integer, Integer>
{
  ...
  public static abstract interface Entry extends Map.Entry<Integer, Integer>
  {
  ...
  public static abstract interface FastEntrySet extends ObjectSet<Int2IntMap.Entry>
  {
