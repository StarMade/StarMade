  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2FloatLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Int2FloatLinkedOpenHashMap(Map<? extends Integer, ? extends Float> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2FloatLinkedOpenHashMap(Map<? extends Integer, ? extends Float> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2FloatLinkedOpenHashMap(Int2FloatMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2FloatLinkedOpenHashMap(Int2FloatMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2FloatLinkedOpenHashMap(int[] local_k, float[] local_v, float local_f)
  {
  ...
  public Int2FloatLinkedOpenHashMap(int[] local_k, float[] local_v)
  {
  ...
  public float getAndMoveToFirst(int local_k)
  {
    int[] key = this.key;
  ...
  public float getAndMoveToLast(int local_k)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public float putAndMoveToFirst(int local_k, float local_v)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public float putAndMoveToLast(int local_k, float local_v)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Int2FloatLinkedOpenHashMap.ValueIterator(Int2FloatLinkedOpenHashMap.this);
        }
        ...
        {
          return Int2FloatLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2FloatLinkedOpenHashMap local_c;
    try
    {
      local_c = (Int2FloatLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2FloatLinkedOpenHashMap.MapIterator
    implements FloatListIterator
  {
    ...
    {
      return Float.valueOf(Int2FloatLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Int2FloatLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSortedSet
  {
    ...
    {
      return new Int2FloatLinkedOpenHashMap.KeyIterator(Int2FloatLinkedOpenHashMap.this, from);
    }
    
    public IntListIterator iterator()
    {
      return new Int2FloatLinkedOpenHashMap.KeyIterator(Int2FloatLinkedOpenHashMap.this);
    }
    ...
    {
      return Int2FloatLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2FloatLinkedOpenHashMap.this.size;
      Int2FloatLinkedOpenHashMap.this.remove(local_k);
    ...
    implements IntListIterator
  {
    ...
    {
      return Integer.valueOf(Int2FloatLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2FloatLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2FloatSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Int2FloatLinkedOpenHashMap.EntryIterator(Int2FloatLinkedOpenHashMap.this);
    }
    ...
    public Int2FloatMap.Entry first()
    {
      ...
      return new Int2FloatLinkedOpenHashMap.MapEntry(Int2FloatLinkedOpenHashMap.this, Int2FloatLinkedOpenHashMap.this.first);
    }
    ...
    public Int2FloatMap.Entry last()
    {
      ...
      return new Int2FloatLinkedOpenHashMap.MapEntry(Int2FloatLinkedOpenHashMap.this, Int2FloatLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2FloatLinkedOpenHashMap.this.mask; Int2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask) {
        if (Int2FloatLinkedOpenHashMap.this.key[pos] == local_k) {
          return Int2FloatLinkedOpenHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2FloatLinkedOpenHashMap.this.mask; Int2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask) {
        if (Int2FloatLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Int2FloatLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Int2FloatLinkedOpenHashMap.EntryIterator(Int2FloatLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
    
    public ObjectBidirectionalIterator<Int2FloatMap.Entry> fastIterator()
    {
      return new Int2FloatLinkedOpenHashMap.FastEntryIterator(Int2FloatLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Int2FloatMap.Entry> fastIterator(Int2FloatMap.Entry from)
    {
      return new Int2FloatLinkedOpenHashMap.FastEntryIterator(Int2FloatLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
  }
    ...
    implements ObjectListIterator<Int2FloatMap.Entry>
  {
    ...
    public AbstractInt2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2FloatLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Int2FloatLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Int2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Int2FloatLinkedOpenHashMap.MapEntry(Int2FloatLinkedOpenHashMap.this, nextEntry());
    }
    
    public Int2FloatLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Int2FloatLinkedOpenHashMap.MapEntry(Int2FloatLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2FloatLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(int from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Int2FloatLinkedOpenHashMap.this.mask; Int2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Int2FloatLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Int2FloatLinkedOpenHashMap.this.first = this.next;
      } else {
        Int2FloatLinkedOpenHashMap.this.link[this.prev] ^= (Int2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Int2FloatLinkedOpenHashMap.this.last = this.prev;
      } else {
        Int2FloatLinkedOpenHashMap.this.link[this.next] ^= (Int2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2FloatLinkedOpenHashMap.this.mask; Int2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2FloatLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2FloatLinkedOpenHashMap.this.key[pos]) & Int2FloatLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2FloatLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Int2FloatLinkedOpenHashMap.this.key[last] = Int2FloatLinkedOpenHashMap.this.key[pos];
      ...
      Int2FloatLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Int2FloatMap.Entry, Map.Entry<Integer, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Int2FloatLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Float> local_e = (Map.Entry)local_o;
      return (Int2FloatLinkedOpenHashMap.this.key[this.index] == ((Integer)local_e.getKey()).intValue()) && (Int2FloatLinkedOpenHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
