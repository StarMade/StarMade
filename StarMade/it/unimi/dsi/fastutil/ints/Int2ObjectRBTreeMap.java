...
/*      */ 
/*      */ public class Int2ObjectRBTreeMap<V> extends AbstractInt2ObjectSortedMap<V>
...
/*  119 */           return Int2ObjectRBTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  122 */           return Int2ObjectRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* 1118 */         final Comparator<? super Int2ObjectMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Int2ObjectMap.Entry<V> x, Int2ObjectMap.Entry<V> y) {
/* 1120 */             return Int2ObjectRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Int2ObjectRBTreeMap.EntryIterator(Int2ObjectRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator(Int2ObjectMap.Entry<V> from) {
/* 1130 */           return new Int2ObjectRBTreeMap.EntryIterator(Int2ObjectRBTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Int2ObjectRBTreeMap.Entry f = Int2ObjectRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1143 */           Int2ObjectRBTreeMap.Entry f = Int2ObjectRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1144 */           if (f != null) Int2ObjectRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Int2ObjectRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Int2ObjectRBTreeMap.this.clear(); } 
/* 1149 */         public Int2ObjectMap.Entry<V> first() { return Int2ObjectRBTreeMap.this.firstEntry; } 
/* 1150 */         public Int2ObjectMap.Entry<V> last() { return Int2ObjectRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Int2ObjectMap.Entry<V>> subSet(Int2ObjectMap.Entry<V> from, Int2ObjectMap.Entry<V> to) { return Int2ObjectRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2ObjectEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Int2ObjectMap.Entry<V>> headSet(Int2ObjectMap.Entry<V> to) { return Int2ObjectRBTreeMap.this.headMap((Integer)to.getKey()).int2ObjectEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Int2ObjectMap.Entry<V>> tailSet(Int2ObjectMap.Entry<V> from) { return Int2ObjectRBTreeMap.this.tailMap((Integer)from.getKey()).int2ObjectEntrySet(); }
/*      */       };
...
/* 1215 */           return new Int2ObjectRBTreeMap.ValueIterator(Int2ObjectRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Int2ObjectRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Int2ObjectRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Int2ObjectRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1580 */       c = (Int2ObjectRBTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Int2ObjectRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Int2ObjectRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator() {
/* 1302 */             return new Int2ObjectRBTreeMap.Submap.SubmapEntryIterator(Int2ObjectRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator(Int2ObjectMap.Entry<V> from) {
/* 1305 */             return new Int2ObjectRBTreeMap.Submap.SubmapEntryIterator(Int2ObjectRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1307 */           public Comparator<? super Int2ObjectMap.Entry<V>> comparator() { return Int2ObjectRBTreeMap.this.int2ObjectEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Int2ObjectRBTreeMap.Entry f = Int2ObjectRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1313 */             return (f != null) && (Int2ObjectRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Int2ObjectRBTreeMap.Entry f = Int2ObjectRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1320 */             if ((f != null) && (Int2ObjectRBTreeMap.Submap.this.in(f.key))) Int2ObjectRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Int2ObjectRBTreeMap.Submap.SubmapIterator(Int2ObjectRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Int2ObjectRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Int2ObjectMap.Entry<V> first() { return Int2ObjectRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Int2ObjectMap.Entry<V> last() { return Int2ObjectRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Int2ObjectMap.Entry<V>> subSet(Int2ObjectMap.Entry<V> from, Int2ObjectMap.Entry<V> to) { return Int2ObjectRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2ObjectEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Int2ObjectMap.Entry<V>> headSet(Int2ObjectMap.Entry<V> to) { return Int2ObjectRBTreeMap.Submap.this.headMap((Integer)to.getKey()).int2ObjectEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Int2ObjectMap.Entry<V>> tailSet(Int2ObjectMap.Entry<V> from) { return Int2ObjectRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2ObjectEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Int2ObjectRBTreeMap.Submap.SubmapValueIterator(Int2ObjectRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Int2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Int2ObjectRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Int2ObjectRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1365 */       return (in(k)) && (Int2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       int kk = k;
/*      */       Int2ObjectRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Int2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(int k, V v) {
/* 1383 */       Int2ObjectRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Int2ObjectRBTreeMap.this.put(k, v);
/* 1386 */       return Int2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Integer ok, V ov) {
/* 1389 */       Object oldValue = put(ok.intValue(), ov);
/* 1390 */       return Int2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(int k) {
/* 1394 */       Int2ObjectRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Int2ObjectRBTreeMap.this.remove(k);
/* 1397 */       return Int2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Integer)ok).intValue());
/* 1401 */       return Int2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1416 */       return Int2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2ObjectSortedMap<V> headMap(int to) {
/* 1419 */       if (this.top) return new Submap(Int2ObjectRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Int2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2ObjectRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2ObjectSortedMap<V> tailMap(int from) {
/* 1423 */       if (this.bottom) return new Submap(Int2ObjectRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Int2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2ObjectRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2ObjectSortedMap<V> subMap(int from, int to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Int2ObjectRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Int2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Int2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Int2ObjectRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2ObjectRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Int2ObjectRBTreeMap.this.tree == null) return null;
/* 1441 */       Int2ObjectRBTreeMap.Entry e;
/*      */       Int2ObjectRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Int2ObjectRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Int2ObjectRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Int2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Int2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2ObjectRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Int2ObjectRBTreeMap.this.tree == null) return null;
/* 1459 */       Int2ObjectRBTreeMap.Entry e;
/*      */       Int2ObjectRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Int2ObjectRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Int2ObjectRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Int2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Int2ObjectRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1470 */       Int2ObjectRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1475 */       Int2ObjectRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1480 */       Int2ObjectRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1485 */       Int2ObjectRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2ObjectRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/* 1530 */       public Int2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Int2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Int2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Int2ObjectRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Int2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Int2ObjectRBTreeMap.Submap.this.bottom) && (Int2ObjectRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Int2ObjectRBTreeMap.Submap.this.top) && (Int2ObjectRBTreeMap.this.compare(k, (this.prev = Int2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Int2ObjectRBTreeMap.this.locateKey(k);
/* 1507 */             if (Int2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Int2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2ObjectRBTreeMap.this.compare(this.prev.key, Int2ObjectRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Int2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Int2ObjectRBTreeMap.this.compare(this.next.key, Int2ObjectRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public IntBidirectionalIterator iterator() { return new Int2ObjectRBTreeMap.Submap.SubmapKeyIterator(Int2ObjectRBTreeMap.Submap.this); } 
/* 1340 */       public IntBidirectionalIterator iterator(int from) { return new Int2ObjectRBTreeMap.Submap.SubmapKeyIterator(Int2ObjectRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public IntBidirectionalIterator iterator() { return new Int2ObjectRBTreeMap.KeyIterator(Int2ObjectRBTreeMap.this); } 
/* 1178 */     public IntBidirectionalIterator iterator(int from) { return new Int2ObjectRBTreeMap.KeyIterator(Int2ObjectRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2ObjectRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Int2ObjectMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1112 */     public Int2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Int2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Int2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Int2ObjectRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1044 */       if ((this.next = Int2ObjectRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Int2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Int2ObjectRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
