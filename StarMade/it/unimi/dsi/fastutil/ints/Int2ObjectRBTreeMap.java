  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2ObjectRBTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2ObjectRBTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2ObjectRBTreeMap(Map<? extends Integer, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ObjectRBTreeMap(SortedMap<Integer, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ObjectRBTreeMap(Int2ObjectMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ObjectRBTreeMap(Int2ObjectSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ObjectRBTreeMap(int[] local_k, V[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2ObjectRBTreeMap(int[] local_k, V[] local_v)
  {
  ...
  {
    Int2ObjectRBTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2ObjectMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Int2ObjectRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2ObjectRBTreeMap.EntryIterator(Int2ObjectRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator(Int2ObjectMap.Entry<V> from)
        {
          return new Int2ObjectRBTreeMap.EntryIterator(Int2ObjectRBTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2ObjectRBTreeMap.Entry<V> local_f = Int2ObjectRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2ObjectRBTreeMap.Entry<V> local_f = Int2ObjectRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2ObjectRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2ObjectRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Int2ObjectMap.Entry<V>> headSet(Int2ObjectMap.Entry<V> local_to)
        {
          return Int2ObjectRBTreeMap.this.headMap((Integer)local_to.getKey()).int2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Int2ObjectMap.Entry<V>> tailSet(Int2ObjectMap.Entry<V> from)
        {
          return Int2ObjectRBTreeMap.this.tailMap((Integer)from.getKey()).int2ObjectEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Int2ObjectRBTreeMap.ValueIterator(Int2ObjectRBTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Int2ObjectRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2ObjectRBTreeMap<V> local_c;
    try
    {
      local_c = (Int2ObjectRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Int2ObjectRBTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2ObjectRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Int2ObjectRBTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Int2ObjectRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2ObjectRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator()
          {
            return new Int2ObjectRBTreeMap.Submap.SubmapEntryIterator(Int2ObjectRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator(Int2ObjectMap.Entry<V> from)
          {
            return new Int2ObjectRBTreeMap.Submap.SubmapEntryIterator(Int2ObjectRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
            Int2ObjectRBTreeMap.Entry<V> local_f = Int2ObjectRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2ObjectRBTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
            Int2ObjectRBTreeMap.Entry<V> local_f = Int2ObjectRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2ObjectRBTreeMap.Submap.this.in4(local_f.key))) {
              Int2ObjectRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2ObjectRBTreeMap.Submap.SubmapIterator(Int2ObjectRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2ObjectRBTreeMap.Submap.this.clear();
          }
          
          public Int2ObjectMap.Entry<V> first()
          {
            return Int2ObjectRBTreeMap.Submap.this.firstEntry();
          }
          
          public Int2ObjectMap.Entry<V> last()
          {
            return Int2ObjectRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2ObjectMap.Entry<V>> subSet(Int2ObjectMap.Entry<V> from, Int2ObjectMap.Entry<V> local_to)
          {
            return Int2ObjectRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Int2ObjectMap.Entry<V>> headSet(Int2ObjectMap.Entry<V> local_to)
          {
            return Int2ObjectRBTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Int2ObjectMap.Entry<V>> tailSet(Int2ObjectMap.Entry<V> from)
          {
            return Int2ObjectRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Int2ObjectRBTreeMap.Submap.SubmapValueIterator(Int2ObjectRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Int2ObjectRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2ObjectRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2ObjectRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2ObjectRBTreeMap.Entry<V> local_e;
      return (in4(local_kk)) && ((local_e = Int2ObjectRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(int local_k, V local_v)
    {
      ...
      V oldValue = Int2ObjectRBTreeMap.this.put(local_k, local_v);
    ...
    public V remove(int local_k)
    {
      ...
      V oldValue = Int2ObjectRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2ObjectRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2ObjectRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2ObjectRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2ObjectSortedMap<V> tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2ObjectRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2ObjectRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2ObjectSortedMap<V> subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2ObjectRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2ObjectRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2ObjectRBTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2ObjectRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2ObjectRBTreeMap.this.locateKey(this.from);
        if (Int2ObjectRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2ObjectRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2ObjectRBTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2ObjectRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2ObjectRBTreeMap.this.locateKey(this.field_47);
        if (Int2ObjectRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2ObjectRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2ObjectRBTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2ObjectRBTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Int2ObjectRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Int2ObjectRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Int2ObjectRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2ObjectRBTreeMap.Submap.this.bottom) && (Int2ObjectRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2ObjectRBTreeMap.Submap.this.top) && (Int2ObjectRBTreeMap.this.compare(local_k, (this.prev = Int2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2ObjectRBTreeMap.this.locateKey(local_k);
            if (Int2ObjectRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2ObjectRBTreeMap.this.compare(this.prev.key, Int2ObjectRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Int2ObjectRBTreeMap.this.compare(this.next.key, Int2ObjectRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Int2ObjectRBTreeMap.Submap.SubmapKeyIterator(Int2ObjectRBTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2ObjectRBTreeMap.Submap.SubmapKeyIterator(Int2ObjectRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2ObjectSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2ObjectRBTreeMap.KeyIterator(Int2ObjectRBTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2ObjectRBTreeMap.KeyIterator(Int2ObjectRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2ObjectRBTreeMap.this.locateKey(local_k)) != null) {
        if (Int2ObjectRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
