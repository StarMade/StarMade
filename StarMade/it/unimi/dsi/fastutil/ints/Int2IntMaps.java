...
/*     */   {
/* 200 */     return new Singleton(key.intValue(), value.intValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Int2IntMap.Entry> int2IntEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.int2IntEntrySet()); return this.entries; } 
...
/* 335 */     public int get(int k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Integer, Integer>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Integer, ? extends Integer> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Int2IntMap.Entry> int2IntEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.int2IntEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public int get(int k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Integer, Integer>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Int2IntMap.Entry> int2IntEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/*     */       {
/* 131 */         return Integer.valueOf(Int2IntMaps.Singleton.this.key); } 
/* 132 */       public Integer getValue() { return Integer.valueOf(Int2IntMaps.Singleton.this.value); }
/*     */ 
/*     */       public int getIntKey() {
/* 135 */         return Int2IntMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public int getIntValue() {
/* 139 */         return Int2IntMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Int2IntMaps.Singleton.this.key == ((Integer)e.getKey()).intValue()) && (Int2IntMaps.Singleton.this.value == ((Integer)e.getValue()).intValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return Int2IntMaps.Singleton.this.key ^ Int2IntMaps.Singleton.this.value; } 
/* 153 */       public String toString() { return Int2IntMaps.Singleton.this.key + "->" + Int2IntMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Integer, ? extends Integer> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Int2IntMap.Entry> int2IntEntrySet() {
...
/*  76 */     private Object readResolve() { return Int2IntMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Int2IntMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Integer, Integer>> entrySet() {
/*  80 */       return int2IntEntrySet();
/*     */     }
