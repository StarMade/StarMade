  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2LongOpenCustomHashMap(int expected, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2LongOpenCustomHashMap(Map<? extends Integer, ? extends Long> local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2LongOpenCustomHashMap(Map<? extends Integer, ? extends Long> local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2LongOpenCustomHashMap(Int2LongMap local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2LongOpenCustomHashMap(Int2LongMap local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2LongOpenCustomHashMap(int[] local_k, long[] local_v, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2LongOpenCustomHashMap(int[] local_k, long[] local_v, IntHash.Strategy strategy)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Int2LongOpenCustomHashMap.ValueIterator(Int2LongOpenCustomHashMap.this);
        }
        ...
        {
          return Int2LongOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2LongOpenCustomHashMap local_c;
    try
    {
      local_c = (Int2LongOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2LongOpenCustomHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Int2LongOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSet
  {
    ...
    {
      return new Int2LongOpenCustomHashMap.KeyIterator(Int2LongOpenCustomHashMap.this);
    }
    ...
    {
      return Int2LongOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2LongOpenCustomHashMap.this.size;
      Int2LongOpenCustomHashMap.this.remove(local_k);
    ...
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2LongOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2LongMap.FastEntrySet
  {
    ...
    {
      return new Int2LongOpenCustomHashMap.EntryIterator(Int2LongOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Int2LongMap.Entry> fastIterator()
    {
      return new Int2LongOpenCustomHashMap.FastEntryIterator(Int2LongOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2LongOpenCustomHashMap.this.mask; Int2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongOpenCustomHashMap.this.mask) {
        if (Int2LongOpenCustomHashMap.this.strategy.equals(Int2LongOpenCustomHashMap.this.key[pos], local_k)) {
          return Int2LongOpenCustomHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2LongOpenCustomHashMap.this.mask; Int2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongOpenCustomHashMap.this.mask) {
        if (Int2LongOpenCustomHashMap.this.strategy.equals(Int2LongOpenCustomHashMap.this.key[pos], local_k))
        {
          Int2LongOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2LongMap.Entry>
  {
    ...
    public AbstractInt2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2LongOpenCustomHashMap.this.key[local_e];
      this.entry.value = Int2LongOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Int2LongOpenCustomHashMap.MapEntry(Int2LongOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2LongOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2LongOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_510 = Int2LongOpenCustomHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2LongOpenCustomHashMap.this.used;
      while ((this.field_510 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_510 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      if (this.field_510 != 0)
      {
        boolean[] local_k = Int2LongOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2LongOpenCustomHashMap.this.mask; Int2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2LongOpenCustomHashMap.this.strategy.hashCode(Int2LongOpenCustomHashMap.this.key[pos])) & Int2LongOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2LongOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Int2LongOpenCustomHashMap.this.key[pos]);
        }
        Int2LongOpenCustomHashMap.this.key[last] = Int2LongOpenCustomHashMap.this.key[pos];
        Int2LongOpenCustomHashMap.this.value[last] = Int2LongOpenCustomHashMap.this.value[pos];
      }
      Int2LongOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Int2LongOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
        this.last = -1;
        return;
      }
      Int2LongOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_510 > 0))
      {
        this.field_510 += 1;
        nextEntry();
      }
    ...
    implements Int2LongMap.Entry, Map.Entry<Integer, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Int2LongOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Long> local_e = (Map.Entry)local_o;
      return (Int2LongOpenCustomHashMap.this.strategy.equals(Int2LongOpenCustomHashMap.this.key[this.index], ((Integer)local_e.getKey()).intValue())) && (Int2LongOpenCustomHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
