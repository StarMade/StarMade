...
/*  15:    */
/*  62:    */public abstract class AbstractInt2DoubleMap
/*  63:    */  extends AbstractInt2DoubleFunction
/*  64:    */  implements Int2DoubleMap, Serializable
/*  65:    */{
...
/*  79:    */  }
/*  80:    */  
/*  86:    */  public void putAll(Map<? extends Integer, ? extends Double> m)
/*  87:    */  {
/*  88: 88 */    int n = m.size();
/*  89: 89 */    Iterator<? extends Map.Entry<? extends Integer, ? extends Double>> i = m.entrySet().iterator();
/*  90: 90 */    if ((m instanceof Int2DoubleMap))
/*  91:    */    {
/*  92: 92 */      while (n-- != 0) {
/*  93: 93 */        Int2DoubleMap.Entry e = (Int2DoubleMap.Entry)i.next();
/*  94: 94 */        put(e.getIntKey(), e.getDoubleValue());
/*  95:    */      }
/*  96:    */      
/*  97:    */    }
/*  98:    */    else
/*  99: 99 */      while (n-- != 0) {
/* 100:100 */        Map.Entry<? extends Integer, ? extends Double> e = (Map.Entry)i.next();
/* 101:101 */        put((Integer)e.getKey(), (Double)e.getValue());
/* 102:    */      }
/* 103:    */  }
/* 104:    */  
...
/* 111:    */    implements Int2DoubleMap.Entry
/* 112:    */  {
/* 113:    */    protected int key;
/* 114:    */    protected double value;
/* 115:    */    
/* 116:    */    public BasicEntry(Integer key, Double value)
/* 117:    */    {
/* 118:118 */      this.key = key.intValue();
/* 119:119 */      this.value = value.doubleValue();
/* 120:    */    }
/* 121:    */    
/* 122:122 */    public BasicEntry(int key, double value) { this.key = key;
...
/* 162:    */      
/* 163:163 */      return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Double)e.getValue()).doubleValue());
/* 164:    */    }
/* 165:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(int k) { return AbstractInt2DoubleMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractInt2DoubleMap.this.size(); }
/* 196:196 */      public void clear() { AbstractInt2DoubleMap.this.clear(); }
/* 197:    */      
/* 198:    */      public IntIterator iterator() {
/* 199:199 */        new AbstractIntIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<Integer, Double>> i = AbstractInt2DoubleMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public int nextInt() { return ((Int2DoubleMap.Entry)this.i.next()).getIntKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(double k) { return AbstractInt2DoubleMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractInt2DoubleMap.this.size(); }
/* 229:229 */      public void clear() { AbstractInt2DoubleMap.this.clear(); }
/* 230:    */      
/* 231:    */      public DoubleIterator iterator() {
/* 232:232 */        new AbstractDoubleIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<Integer, Double>> i = AbstractInt2DoubleMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public double nextDouble() { return ((Int2DoubleMap.Entry)this.i.next()).getDoubleValue(); }
/* 236:    */          
...
/* 241:    */  }
/* 242:    */  
/* 244:    */  public ObjectSet<Map.Entry<Integer, Double>> entrySet()
/* 245:    */  {
/* 246:246 */    return int2DoubleEntrySet();
/* 247:    */  }
/* 248:    */  
/* 257:    */  public int hashCode()
/* 258:    */  {
/* 259:259 */    int h = 0;int n = size();
/* 260:260 */    ObjectIterator<? extends Map.Entry<Integer, Double>> i = entrySet().iterator();
/* 261:    */    
...
/* 278:278 */    ObjectIterator<? extends Map.Entry<Integer, Double>> i = entrySet().iterator();
/* 279:279 */    int n = size();
/* 280:    */    
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Int2DoubleMap.Entry e = (Int2DoubleMap.Entry)i.next();
/* 290:    */      
