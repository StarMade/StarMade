...
/*     */ 
/*     */ public class Int2ByteOpenHashMap extends AbstractInt2ByteMap
...
/* 642 */           return new Int2ByteOpenHashMap.ValueIterator(Int2ByteOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Int2ByteOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(byte v) {
/* 648 */           return Int2ByteOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Int2ByteOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Int2ByteOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Int2ByteOpenHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public byte nextByte() { return Int2ByteOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Byte next() { return Byte.valueOf(Int2ByteOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Int2ByteOpenHashMap.KeyIterator(Int2ByteOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Int2ByteOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(int k) {
/* 613 */       return Int2ByteOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(int k) {
/* 616 */       int oldSize = Int2ByteOpenHashMap.this.size;
/* 617 */       Int2ByteOpenHashMap.this.remove(k);
/* 618 */       return Int2ByteOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Int2ByteOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Int2ByteOpenHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public int nextInt() { return Int2ByteOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Integer next() { return Integer.valueOf(Int2ByteOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Int2ByteOpenHashMap.EntryIterator(Int2ByteOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Int2ByteMap.Entry> fastIterator() {
/* 550 */       return new Int2ByteOpenHashMap.FastEntryIterator(Int2ByteOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Int2ByteOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Int2ByteOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Int2ByteOpenHashMap.this.key[pos] == k) return Int2ByteOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 562 */         pos = pos + 1 & Int2ByteOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Int2ByteOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Int2ByteOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Int2ByteOpenHashMap.this.key[pos] == k) {
/* 576 */           Int2ByteOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Int2ByteOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Int2ByteOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Int2ByteOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Int2ByteOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Int2ByteMap.Entry>
/*     */   {
/* 537 */     final AbstractInt2ByteMap.BasicEntry entry = new AbstractInt2ByteMap.BasicEntry(0, (byte)0);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Int2ByteOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Int2ByteOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Int2ByteOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Int2ByteMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Int2ByteOpenHashMap.MapEntry(Int2ByteOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Int2ByteOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Int2ByteOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Int2ByteOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Int2ByteOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Int2ByteOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Int2ByteOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Int2ByteOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Int2ByteOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Int2ByteOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Int2ByteOpenHashMap.this.mask;
/* 485 */         while (Int2ByteOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Int2ByteOpenHashMap.this.key[pos]) & Int2ByteOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Int2ByteOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Int2ByteOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 494 */           this.wrapped.add(Int2ByteOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Int2ByteOpenHashMap.this.key[last] = Int2ByteOpenHashMap.this.key[pos];
/* 497 */         Int2ByteOpenHashMap.this.value[last] = Int2ByteOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Int2ByteOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Int2ByteOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Int2ByteOpenHashMap.this.size -= 1;
...
/* 398 */       return Integer.valueOf(Int2ByteOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public int getIntKey() {
/* 401 */       return Int2ByteOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Byte getValue() {
/* 404 */       return Byte.valueOf(Int2ByteOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public byte getByteValue() {
/* 407 */       return Int2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public byte setValue(byte v) {
/* 410 */       byte oldValue = Int2ByteOpenHashMap.this.value[this.index];
/* 411 */       Int2ByteOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Byte setValue(Byte v) {
...
/* 421 */       return (Int2ByteOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Int2ByteOpenHashMap.this.key[this.index] ^ Int2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 427 */       return Int2ByteOpenHashMap.this.key[this.index] + "=>" + Int2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
