...
public abstract interface Int2ObjectMap<V> extends Int2ObjectFunction<V>, Map<Integer, V>
{
  ...
  public static abstract interface FastEntrySet<V> extends ObjectSet<Int2ObjectMap.Entry<V>>
  {
