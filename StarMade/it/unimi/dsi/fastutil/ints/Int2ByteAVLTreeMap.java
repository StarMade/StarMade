...
/*      */ 
/*      */ public class Int2ByteAVLTreeMap extends AbstractInt2ByteSortedMap
...
/*  117 */           return Int2ByteAVLTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  120 */           return Int2ByteAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     byte oldValue = put(ok.intValue(), ov.byteValue());
/*  780 */     return this.modified ? null : Byte.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Byte remove(Object ok)
/*      */   {
/*  788 */     byte oldValue = remove(((Integer)ok).intValue());
...
/* 1203 */         final Comparator<? super Int2ByteMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2ByteMap.Entry x, Int2ByteMap.Entry y) {
/* 1205 */             return Int2ByteAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Int2ByteAVLTreeMap.EntryIterator(Int2ByteAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry from) {
/* 1215 */           return new Int2ByteAVLTreeMap.EntryIterator(Int2ByteAVLTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1228 */           Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1229 */           if (f != null) Int2ByteAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Int2ByteAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Int2ByteAVLTreeMap.this.clear(); } 
/* 1234 */         public Int2ByteMap.Entry first() { return Int2ByteAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Int2ByteMap.Entry last() { return Int2ByteAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Int2ByteMap.Entry> subSet(Int2ByteMap.Entry from, Int2ByteMap.Entry to) { return Int2ByteAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2ByteEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry to) { return Int2ByteAVLTreeMap.this.headMap((Integer)to.getKey()).int2ByteEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry from) { return Int2ByteAVLTreeMap.this.tailMap((Integer)from.getKey()).int2ByteEntrySet(); }
/*      */       };
...
/* 1304 */           return new Int2ByteAVLTreeMap.ValueIterator(Int2ByteAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(byte k) {
/* 1307 */           return Int2ByteAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Int2ByteAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Int2ByteAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Int2ByteAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readInt(), s.readByte());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readInt(), s.readByte());
/* 1759 */       top.right(new Entry(s.readInt(), s.readByte()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Int2ByteAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Int2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Int2ByteAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator() {
/* 1391 */             return new Int2ByteAVLTreeMap.Submap.SubmapEntryIterator(Int2ByteAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry from) {
/* 1394 */             return new Int2ByteAVLTreeMap.Submap.SubmapEntryIterator(Int2ByteAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1396 */           public Comparator<? super Int2ByteMap.Entry> comparator() { return Int2ByteAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1402 */             return (f != null) && (Int2ByteAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Int2ByteAVLTreeMap.Entry f = Int2ByteAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1409 */             if ((f != null) && (Int2ByteAVLTreeMap.Submap.this.in(f.key))) Int2ByteAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Int2ByteAVLTreeMap.Submap.SubmapIterator(Int2ByteAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Int2ByteAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Int2ByteMap.Entry first() { return Int2ByteAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Int2ByteMap.Entry last() { return Int2ByteAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Int2ByteMap.Entry> subSet(Int2ByteMap.Entry from, Int2ByteMap.Entry to) { return Int2ByteAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2ByteEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry to) { return Int2ByteAVLTreeMap.Submap.this.headMap((Integer)to.getKey()).int2ByteEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry from) { return Int2ByteAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2ByteEntrySet(); }
/*      */         };
...
/*      */           public ByteIterator iterator() {
/* 1442 */             return new Int2ByteAVLTreeMap.Submap.SubmapValueIterator(Int2ByteAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(byte k) {
/* 1445 */             return Int2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Int2ByteAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Int2ByteAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1458 */       return (in(k)) && (Int2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(byte v) {
...
/* 1473 */       return (in(kk)) && ((e = Int2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public byte put(int k, byte v) {
/* 1476 */       Int2ByteAVLTreeMap.this.modified = false;
...
/* 1478 */       byte oldValue = Int2ByteAVLTreeMap.this.put(k, v);
/* 1479 */       return Int2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Byte put(Integer ok, Byte ov) {
/* 1482 */       byte oldValue = put(ok.intValue(), ov.byteValue());
/* 1483 */       return Int2ByteAVLTreeMap.this.modified ? null : Byte.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public byte remove(int k) {
/* 1487 */       Int2ByteAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       byte oldValue = Int2ByteAVLTreeMap.this.remove(k);
/* 1490 */       return Int2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Byte remove(Object ok) {
/* 1493 */       byte oldValue = remove(((Integer)ok).intValue());
/* 1494 */       return Int2ByteAVLTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1509 */       return Int2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2ByteSortedMap headMap(int to) {
/* 1512 */       if (this.top) return new Submap(Int2ByteAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Int2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2ByteAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2ByteSortedMap tailMap(int from) {
/* 1516 */       if (this.bottom) return new Submap(Int2ByteAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Int2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2ByteAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2ByteSortedMap subMap(int from, int to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Int2ByteAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Int2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Int2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Int2ByteAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2ByteAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Int2ByteAVLTreeMap.this.tree == null) return null;
/* 1534 */       Int2ByteAVLTreeMap.Entry e;
/*      */       Int2ByteAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Int2ByteAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Int2ByteAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Int2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Int2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2ByteAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Int2ByteAVLTreeMap.this.tree == null) return null;
/* 1552 */       Int2ByteAVLTreeMap.Entry e;
/*      */       Int2ByteAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Int2ByteAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Int2ByteAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Int2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Int2ByteAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1563 */       Int2ByteAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1568 */       Int2ByteAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1573 */       Int2ByteAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1578 */       Int2ByteAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2ByteAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2ByteAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2ByteAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Int2ByteMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Int2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Int2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Int2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Int2ByteAVLTreeMap.Submap.this.bottom) && (Int2ByteAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Int2ByteAVLTreeMap.Submap.this.top) && (Int2ByteAVLTreeMap.this.compare(k, (this.prev = Int2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Int2ByteAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Int2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Int2ByteAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2ByteAVLTreeMap.this.compare(this.prev.key, Int2ByteAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Int2ByteAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2ByteAVLTreeMap.this.compare(this.next.key, Int2ByteAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public IntBidirectionalIterator iterator() { return new Int2ByteAVLTreeMap.Submap.SubmapKeyIterator(Int2ByteAVLTreeMap.Submap.this); } 
/* 1433 */       public IntBidirectionalIterator iterator(int from) { return new Int2ByteAVLTreeMap.Submap.SubmapKeyIterator(Int2ByteAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2ByteAVLTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public IntBidirectionalIterator iterator() { return new Int2ByteAVLTreeMap.KeyIterator(Int2ByteAVLTreeMap.this); } 
/* 1263 */     public IntBidirectionalIterator iterator(int from) { return new Int2ByteAVLTreeMap.KeyIterator(Int2ByteAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2ByteAVLTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2ByteAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2ByteMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Int2ByteMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Int2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Int2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Int2ByteAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1129 */       if ((this.next = Int2ByteAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Int2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Int2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
