  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2ByteAVLTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2ByteAVLTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2ByteAVLTreeMap(Map<? extends Integer, ? extends Byte> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ByteAVLTreeMap(SortedMap<Integer, Byte> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ByteAVLTreeMap(Int2ByteMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ByteAVLTreeMap(Int2ByteSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ByteAVLTreeMap(int[] local_k, byte[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2ByteAVLTreeMap(int[] local_k, byte[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2ByteMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Int2ByteAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2ByteAVLTreeMap.EntryIterator(Int2ByteAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry from)
        {
          return new Int2ByteAVLTreeMap.EntryIterator(Int2ByteAVLTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2ByteAVLTreeMap.Entry local_f = Int2ByteAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2ByteAVLTreeMap.Entry local_f = Int2ByteAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2ByteAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2ByteAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ByteEntrySet();
        }
        
        public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry local_to)
        {
          return Int2ByteAVLTreeMap.this.headMap((Integer)local_to.getKey()).int2ByteEntrySet();
        }
        
        public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry from)
        {
          return Int2ByteAVLTreeMap.this.tailMap((Integer)from.getKey()).int2ByteEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Int2ByteAVLTreeMap.ValueIterator(Int2ByteAVLTreeMap.this, null);
        }
        
        public boolean contains(byte local_k)
        {
          return Int2ByteAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2ByteAVLTreeMap local_c;
    try
    {
      local_c = (Int2ByteAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2ByteAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Int2ByteAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2ByteAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2ByteMap.Entry> int2ByteEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator()
          {
            return new Int2ByteAVLTreeMap.Submap.SubmapEntryIterator(Int2ByteAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2ByteMap.Entry> iterator(Int2ByteMap.Entry from)
          {
            return new Int2ByteAVLTreeMap.Submap.SubmapEntryIterator(Int2ByteAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, Byte> local_e = (Map.Entry)local_o;
            Int2ByteAVLTreeMap.Entry local_f = Int2ByteAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2ByteAVLTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, Byte> local_e = (Map.Entry)local_o;
            Int2ByteAVLTreeMap.Entry local_f = Int2ByteAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2ByteAVLTreeMap.Submap.this.in4(local_f.key))) {
              Int2ByteAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2ByteAVLTreeMap.Submap.SubmapIterator(Int2ByteAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2ByteAVLTreeMap.Submap.this.clear();
          }
          
          public Int2ByteMap.Entry first()
          {
            return Int2ByteAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Int2ByteMap.Entry last()
          {
            return Int2ByteAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2ByteMap.Entry> subSet(Int2ByteMap.Entry from, Int2ByteMap.Entry local_to)
          {
            return Int2ByteAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ByteEntrySet();
          }
          
          public ObjectSortedSet<Int2ByteMap.Entry> headSet(Int2ByteMap.Entry local_to)
          {
            return Int2ByteAVLTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2ByteEntrySet();
          }
          
          public ObjectSortedSet<Int2ByteMap.Entry> tailSet(Int2ByteMap.Entry from)
          {
            return Int2ByteAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2ByteEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ByteCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractByteCollection()
        {
          public ByteIterator iterator()
          {
            return new Int2ByteAVLTreeMap.Submap.SubmapValueIterator(Int2ByteAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(byte local_k)
          {
            return Int2ByteAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2ByteAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2ByteAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2ByteAVLTreeMap.Entry local_e;
      return (in4(local_kk)) && ((local_e = Int2ByteAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public byte put(int local_k, byte local_v)
    {
      ...
      byte oldValue = Int2ByteAVLTreeMap.this.put(local_k, local_v);
    ...
    public byte remove(int local_k)
    {
      ...
      byte oldValue = Int2ByteAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2ByteAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2ByteAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2ByteAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2ByteSortedMap tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2ByteAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2ByteAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2ByteSortedMap subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2ByteAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2ByteAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2ByteAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2ByteAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2ByteAVLTreeMap.this.locateKey(this.from);
        if (Int2ByteAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2ByteAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2ByteAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2ByteAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2ByteAVLTreeMap.this.locateKey(this.field_47);
        if (Int2ByteAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2ByteAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2ByteAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2ByteAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Int2ByteAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Int2ByteAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2ByteAVLTreeMap.Submap.this.bottom) && (Int2ByteAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2ByteAVLTreeMap.Submap.this.top) && (Int2ByteAVLTreeMap.this.compare(local_k, (this.prev = Int2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2ByteAVLTreeMap.this.locateKey(local_k);
            if (Int2ByteAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2ByteAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2ByteAVLTreeMap.this.compare(this.prev.key, Int2ByteAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2ByteAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2ByteAVLTreeMap.this.compare(this.next.key, Int2ByteAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2ByteSortedMap.KeySet
    {
      ...
      {
        return new Int2ByteAVLTreeMap.Submap.SubmapKeyIterator(Int2ByteAVLTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2ByteAVLTreeMap.Submap.SubmapKeyIterator(Int2ByteAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2ByteSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2ByteAVLTreeMap.KeyIterator(Int2ByteAVLTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2ByteAVLTreeMap.KeyIterator(Int2ByteAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2ByteAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Int2ByteAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
