  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2DoubleRBTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2DoubleRBTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2DoubleRBTreeMap(Map<? extends Integer, ? extends Double> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2DoubleRBTreeMap(SortedMap<Integer, Double> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2DoubleRBTreeMap(Int2DoubleMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2DoubleRBTreeMap(Int2DoubleSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2DoubleRBTreeMap(int[] local_k, double[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2DoubleRBTreeMap(int[] local_k, double[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2DoubleMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Int2DoubleRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2DoubleRBTreeMap.EntryIterator(Int2DoubleRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from)
        {
          return new Int2DoubleRBTreeMap.EntryIterator(Int2DoubleRBTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2DoubleRBTreeMap.Entry local_f = Int2DoubleRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2DoubleRBTreeMap.Entry local_f = Int2DoubleRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2DoubleRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2DoubleRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry local_to)
        {
          return Int2DoubleRBTreeMap.this.headMap((Integer)local_to.getKey()).int2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from)
        {
          return Int2DoubleRBTreeMap.this.tailMap((Integer)from.getKey()).int2DoubleEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Int2DoubleRBTreeMap.ValueIterator(Int2DoubleRBTreeMap.this, null);
        }
        
        public boolean contains(double local_k)
        {
          return Int2DoubleRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2DoubleRBTreeMap local_c;
    try
    {
      local_c = (Int2DoubleRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2DoubleRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Int2DoubleRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2DoubleRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator()
          {
            return new Int2DoubleRBTreeMap.Submap.SubmapEntryIterator(Int2DoubleRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from)
          {
            return new Int2DoubleRBTreeMap.Submap.SubmapEntryIterator(Int2DoubleRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, Double> local_e = (Map.Entry)local_o;
            Int2DoubleRBTreeMap.Entry local_f = Int2DoubleRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2DoubleRBTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, Double> local_e = (Map.Entry)local_o;
            Int2DoubleRBTreeMap.Entry local_f = Int2DoubleRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2DoubleRBTreeMap.Submap.this.in4(local_f.key))) {
              Int2DoubleRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2DoubleRBTreeMap.Submap.SubmapIterator(Int2DoubleRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2DoubleRBTreeMap.Submap.this.clear();
          }
          
          public Int2DoubleMap.Entry first()
          {
            return Int2DoubleRBTreeMap.Submap.this.firstEntry();
          }
          
          public Int2DoubleMap.Entry last()
          {
            return Int2DoubleRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry local_to)
          {
            return Int2DoubleRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry local_to)
          {
            return Int2DoubleRBTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from)
          {
            return Int2DoubleRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2DoubleEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public DoubleCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractDoubleCollection()
        {
          public DoubleIterator iterator()
          {
            return new Int2DoubleRBTreeMap.Submap.SubmapValueIterator(Int2DoubleRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(double local_k)
          {
            return Int2DoubleRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2DoubleRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2DoubleRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2DoubleRBTreeMap.Entry local_e;
      return (in4(local_kk)) && ((local_e = Int2DoubleRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public double put(int local_k, double local_v)
    {
      ...
      double oldValue = Int2DoubleRBTreeMap.this.put(local_k, local_v);
    ...
    public double remove(int local_k)
    {
      ...
      double oldValue = Int2DoubleRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2DoubleRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2DoubleRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2DoubleRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2DoubleSortedMap tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2DoubleRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2DoubleRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2DoubleSortedMap subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2DoubleRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2DoubleRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2DoubleRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2DoubleRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2DoubleRBTreeMap.this.locateKey(this.from);
        if (Int2DoubleRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2DoubleRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2DoubleRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2DoubleRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2DoubleRBTreeMap.this.locateKey(this.field_47);
        if (Int2DoubleRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2DoubleRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2DoubleRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2DoubleRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Int2DoubleRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Int2DoubleRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2DoubleRBTreeMap.Submap.this.bottom) && (Int2DoubleRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2DoubleRBTreeMap.Submap.this.top) && (Int2DoubleRBTreeMap.this.compare(local_k, (this.prev = Int2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2DoubleRBTreeMap.this.locateKey(local_k);
            if (Int2DoubleRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2DoubleRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2DoubleRBTreeMap.this.compare(this.prev.key, Int2DoubleRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2DoubleRBTreeMap.Submap.this.top) && (this.next != null) && (Int2DoubleRBTreeMap.this.compare(this.next.key, Int2DoubleRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2DoubleSortedMap.KeySet
    {
      ...
      {
        return new Int2DoubleRBTreeMap.Submap.SubmapKeyIterator(Int2DoubleRBTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2DoubleRBTreeMap.Submap.SubmapKeyIterator(Int2DoubleRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2DoubleSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2DoubleRBTreeMap.KeyIterator(Int2DoubleRBTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2DoubleRBTreeMap.KeyIterator(Int2DoubleRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2DoubleRBTreeMap.this.locateKey(local_k)) != null) {
        if (Int2DoubleRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
