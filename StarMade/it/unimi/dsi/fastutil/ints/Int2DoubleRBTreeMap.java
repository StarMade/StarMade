...
/*      */ 
/*      */ public class Int2DoubleRBTreeMap extends AbstractInt2DoubleSortedMap
...
/*  119 */           return Int2DoubleRBTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  122 */           return Int2DoubleRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     double oldValue = put(ok.intValue(), ov.doubleValue());
/*  731 */     return this.modified ? null : Double.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Double remove(Object ok)
/*      */   {
/*  737 */     double oldValue = remove(((Integer)ok).intValue());
...
/* 1141 */         final Comparator<? super Int2DoubleMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2DoubleMap.Entry x, Int2DoubleMap.Entry y) {
/* 1143 */             return Int2DoubleRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Int2DoubleRBTreeMap.EntryIterator(Int2DoubleRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from) {
/* 1153 */           return new Int2DoubleRBTreeMap.EntryIterator(Int2DoubleRBTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Int2DoubleRBTreeMap.Entry f = Int2DoubleRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1166 */           Int2DoubleRBTreeMap.Entry f = Int2DoubleRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1167 */           if (f != null) Int2DoubleRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Int2DoubleRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Int2DoubleRBTreeMap.this.clear(); } 
/* 1172 */         public Int2DoubleMap.Entry first() { return Int2DoubleRBTreeMap.this.firstEntry; } 
/* 1173 */         public Int2DoubleMap.Entry last() { return Int2DoubleRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) { return Int2DoubleRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2DoubleEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry to) { return Int2DoubleRBTreeMap.this.headMap((Integer)to.getKey()).int2DoubleEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from) { return Int2DoubleRBTreeMap.this.tailMap((Integer)from.getKey()).int2DoubleEntrySet(); }
/*      */       };
...
/* 1242 */           return new Int2DoubleRBTreeMap.ValueIterator(Int2DoubleRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(double k) {
/* 1245 */           return Int2DoubleRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Int2DoubleRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Int2DoubleRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Int2DoubleRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readInt(), s.readDouble());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readInt(), s.readDouble());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readInt(), s.readDouble()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Int2DoubleRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Int2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator() {
/* 1329 */             return new Int2DoubleRBTreeMap.Submap.SubmapEntryIterator(Int2DoubleRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from) {
/* 1332 */             return new Int2DoubleRBTreeMap.Submap.SubmapEntryIterator(Int2DoubleRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1334 */           public Comparator<? super Int2DoubleMap.Entry> comparator() { return Int2DoubleRBTreeMap.this.int2DoubleEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Int2DoubleRBTreeMap.Entry f = Int2DoubleRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1340 */             return (f != null) && (Int2DoubleRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Int2DoubleRBTreeMap.Entry f = Int2DoubleRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1347 */             if ((f != null) && (Int2DoubleRBTreeMap.Submap.this.in(f.key))) Int2DoubleRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Int2DoubleRBTreeMap.Submap.SubmapIterator(Int2DoubleRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Int2DoubleRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Int2DoubleMap.Entry first() { return Int2DoubleRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Int2DoubleMap.Entry last() { return Int2DoubleRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) { return Int2DoubleRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2DoubleEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry to) { return Int2DoubleRBTreeMap.Submap.this.headMap((Integer)to.getKey()).int2DoubleEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from) { return Int2DoubleRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2DoubleEntrySet(); }
/*      */         };
...
/*      */           public DoubleIterator iterator() {
/* 1376 */             return new Int2DoubleRBTreeMap.Submap.SubmapValueIterator(Int2DoubleRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(double k) {
/* 1379 */             return Int2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Int2DoubleRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Int2DoubleRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1392 */       return (in(k)) && (Int2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(double v) {
...
/* 1407 */       return (in(kk)) && ((e = Int2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public double put(int k, double v) {
/* 1410 */       Int2DoubleRBTreeMap.this.modified = false;
...
/* 1412 */       double oldValue = Int2DoubleRBTreeMap.this.put(k, v);
/* 1413 */       return Int2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Double put(Integer ok, Double ov) {
/* 1416 */       double oldValue = put(ok.intValue(), ov.doubleValue());
/* 1417 */       return Int2DoubleRBTreeMap.this.modified ? null : Double.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public double remove(int k) {
/* 1421 */       Int2DoubleRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       double oldValue = Int2DoubleRBTreeMap.this.remove(k);
/* 1424 */       return Int2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Double remove(Object ok) {
/* 1427 */       double oldValue = remove(((Integer)ok).intValue());
/* 1428 */       return Int2DoubleRBTreeMap.this.modified ? Double.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1443 */       return Int2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2DoubleSortedMap headMap(int to) {
/* 1446 */       if (this.top) return new Submap(Int2DoubleRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Int2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2DoubleRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2DoubleSortedMap tailMap(int from) {
/* 1450 */       if (this.bottom) return new Submap(Int2DoubleRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Int2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2DoubleRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2DoubleSortedMap subMap(int from, int to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Int2DoubleRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Int2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Int2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Int2DoubleRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2DoubleRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Int2DoubleRBTreeMap.this.tree == null) return null;
/* 1468 */       Int2DoubleRBTreeMap.Entry e;
/*      */       Int2DoubleRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Int2DoubleRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Int2DoubleRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Int2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Int2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2DoubleRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Int2DoubleRBTreeMap.this.tree == null) return null;
/* 1486 */       Int2DoubleRBTreeMap.Entry e;
/*      */       Int2DoubleRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Int2DoubleRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Int2DoubleRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Int2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Int2DoubleRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1497 */       Int2DoubleRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1502 */       Int2DoubleRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1507 */       Int2DoubleRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1512 */       Int2DoubleRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2DoubleRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2DoubleRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2DoubleRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Int2DoubleMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Int2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Int2DoubleRBTreeMap.Submap.this.bottom) && (Int2DoubleRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Int2DoubleRBTreeMap.Submap.this.top) && (Int2DoubleRBTreeMap.this.compare(k, (this.prev = Int2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Int2DoubleRBTreeMap.this.locateKey(k);
/* 1534 */             if (Int2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Int2DoubleRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2DoubleRBTreeMap.this.compare(this.prev.key, Int2DoubleRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Int2DoubleRBTreeMap.Submap.this.top) && (this.next != null) && (Int2DoubleRBTreeMap.this.compare(this.next.key, Int2DoubleRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public IntBidirectionalIterator iterator() { return new Int2DoubleRBTreeMap.Submap.SubmapKeyIterator(Int2DoubleRBTreeMap.Submap.this); } 
/* 1367 */       public IntBidirectionalIterator iterator(int from) { return new Int2DoubleRBTreeMap.Submap.SubmapKeyIterator(Int2DoubleRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2DoubleRBTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public IntBidirectionalIterator iterator() { return new Int2DoubleRBTreeMap.KeyIterator(Int2DoubleRBTreeMap.this); } 
/* 1201 */     public IntBidirectionalIterator iterator(int from) { return new Int2DoubleRBTreeMap.KeyIterator(Int2DoubleRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2DoubleRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2DoubleRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2DoubleMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Int2DoubleMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Int2DoubleRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1067 */       if ((this.next = Int2DoubleRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Int2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Int2DoubleRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
