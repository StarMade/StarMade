  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2IntRBTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2IntRBTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2IntRBTreeMap(Map<? extends Integer, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2IntRBTreeMap(SortedMap<Integer, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2IntRBTreeMap(Int2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2IntRBTreeMap(Int2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2IntRBTreeMap(int[] local_k, int[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2IntRBTreeMap(int[] local_k, int[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2IntMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Int2IntRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2IntRBTreeMap.EntryIterator(Int2IntRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator(Int2IntMap.Entry from)
        {
          return new Int2IntRBTreeMap.EntryIterator(Int2IntRBTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2IntRBTreeMap.Entry local_f = Int2IntRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2IntRBTreeMap.Entry local_f = Int2IntRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2IntRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2IntRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2IntEntrySet();
        }
        
        public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry local_to)
        {
          return Int2IntRBTreeMap.this.headMap((Integer)local_to.getKey()).int2IntEntrySet();
        }
        
        public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry from)
        {
          return Int2IntRBTreeMap.this.tailMap((Integer)from.getKey()).int2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Int2IntRBTreeMap.ValueIterator(Int2IntRBTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Int2IntRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2IntRBTreeMap local_c;
    try
    {
      local_c = (Int2IntRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2IntRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Int2IntRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2IntRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator()
          {
            return new Int2IntRBTreeMap.Submap.SubmapEntryIterator(Int2IntRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator(Int2IntMap.Entry from)
          {
            return new Int2IntRBTreeMap.Submap.SubmapEntryIterator(Int2IntRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, Integer> local_e = (Map.Entry)local_o;
            Int2IntRBTreeMap.Entry local_f = Int2IntRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2IntRBTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, Integer> local_e = (Map.Entry)local_o;
            Int2IntRBTreeMap.Entry local_f = Int2IntRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2IntRBTreeMap.Submap.this.in4(local_f.key))) {
              Int2IntRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2IntRBTreeMap.Submap.SubmapIterator(Int2IntRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2IntRBTreeMap.Submap.this.clear();
          }
          
          public Int2IntMap.Entry first()
          {
            return Int2IntRBTreeMap.Submap.this.firstEntry();
          }
          
          public Int2IntMap.Entry last()
          {
            return Int2IntRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry from, Int2IntMap.Entry local_to)
          {
            return Int2IntRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2IntEntrySet();
          }
          
          public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry local_to)
          {
            return Int2IntRBTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2IntEntrySet();
          }
          
          public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry from)
          {
            return Int2IntRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Int2IntRBTreeMap.Submap.SubmapValueIterator(Int2IntRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Int2IntRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2IntRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2IntRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2IntRBTreeMap.Entry local_e;
      return (in4(local_kk)) && ((local_e = Int2IntRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(int local_k, int local_v)
    {
      ...
      int oldValue = Int2IntRBTreeMap.this.put(local_k, local_v);
    ...
    public int remove(int local_k)
    {
      ...
      int oldValue = Int2IntRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2IntRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2IntRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2IntSortedMap tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2IntRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2IntRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2IntSortedMap subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2IntRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2IntRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2IntRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2IntRBTreeMap.this.locateKey(this.from);
        if (Int2IntRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2IntRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2IntRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2IntRBTreeMap.this.locateKey(this.field_47);
        if (Int2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2IntRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2IntRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2IntRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Int2IntRBTreeMap.Submap.SubmapIterator
      ...
      extends Int2IntRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Int2IntRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2IntRBTreeMap.Submap.this.bottom) && (Int2IntRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2IntRBTreeMap.Submap.this.top) && (Int2IntRBTreeMap.this.compare(local_k, (this.prev = Int2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2IntRBTreeMap.this.locateKey(local_k);
            if (Int2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2IntRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2IntRBTreeMap.this.compare(this.prev.key, Int2IntRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2IntRBTreeMap.Submap.this.top) && (this.next != null) && (Int2IntRBTreeMap.this.compare(this.next.key, Int2IntRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2IntSortedMap.KeySet
    {
      ...
      {
        return new Int2IntRBTreeMap.Submap.SubmapKeyIterator(Int2IntRBTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2IntRBTreeMap.Submap.SubmapKeyIterator(Int2IntRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2IntSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2IntRBTreeMap.KeyIterator(Int2IntRBTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2IntRBTreeMap.KeyIterator(Int2IntRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2IntRBTreeMap.this.locateKey(local_k)) != null) {
        if (Int2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
