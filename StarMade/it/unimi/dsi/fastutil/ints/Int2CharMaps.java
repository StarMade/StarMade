...
public class Int2CharMaps
{
  ...
  public static Int2CharMap synchronize(Int2CharMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Int2CharMap synchronize(Int2CharMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Int2CharMap unmodifiable(Int2CharMap local_m)
  {
    ...
    implements Int2CharMap, Serializable
  {
    ...
    protected UnmodifiableMap(Int2CharMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Int2CharMap, Serializable
  {
    ...
    protected SynchronizedMap(Int2CharMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Int2CharMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Int2CharMap, Serializable, Cloneable
  {
      ...
      implements Int2CharMap.Entry, Map.Entry<Integer, Character>
    {
      ...
      {
        return Integer.valueOf(Int2CharMaps.Singleton.this.key);
      }
      
      public Character getValue()
      {
        return Character.valueOf(Int2CharMaps.Singleton.this.value);
      }
      
      public int getIntKey()
      {
        return Int2CharMaps.Singleton.this.key;
      }
      
      public char getCharValue()
      {
        return Int2CharMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Int2CharMaps.Singleton.this.key == ((Integer)local_e.getKey()).intValue()) && (Int2CharMaps.Singleton.this.value == ((Character)local_e.getValue()).charValue());
      }
      
      public int hashCode()
      {
        return Int2CharMaps.Singleton.this.key ^ Int2CharMaps.Singleton.this.value;
      }
