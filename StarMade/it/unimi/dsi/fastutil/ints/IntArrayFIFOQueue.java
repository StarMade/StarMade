...
/*   4:    */
/*  54:    */public class IntArrayFIFOQueue
/*  55:    */  extends AbstractIntPriorityQueue
/*  56:    */{
...
/*  68:    */  
/*  71:    */  public IntArrayFIFOQueue(int capacity)
/*  72:    */  {
/*  73: 73 */    if (capacity > 0) this.array = new int[capacity];
/*  74: 74 */    this.length = this.array.length;
/*  75:    */  }
/*  76:    */  
/*  77:    */  public IntArrayFIFOQueue()
/*  78:    */  {
/*  79: 79 */    this(16);
/*  80:    */  }
/*  81:    */  
/*  84:    */  public IntComparator comparator()
/*  85:    */  {
/*  86: 86 */    return null;
/*  87:    */  }
/*  88:    */  
/*  89:    */  public int dequeueInt() {
/*  90: 90 */    if (this.start == this.end) throw new NoSuchElementException();
/*  91: 91 */    int t = this.array[this.start];
/*  92: 92 */    if (++this.start == this.length) this.start = 0;
/*  93: 93 */    return t;
/*  94:    */  }
/*  95:    */  
/*  99:    */  public int dequeueLastInt()
/* 100:    */  {
/* 101:101 */    if (this.start == this.end) throw new NoSuchElementException();
/* 102:102 */    if (this.end == 0) this.end = this.length;
/* 103:103 */    int t = this.array[(--this.end)];
/* 104:    */    
/* 106:106 */    return t;
/* 107:    */  }
/* 108:    */  
/* 109:    */  private final void expand() {
/* 110:110 */    int[] newArray = IntArrays.grow(this.array, this.length + 1, 0);
...
/* 124:    */  }
/* 125:    */  
/* 126:    */  public void enqueueFirst(int x)
/* 127:    */  {
...
/* 166:166 */    int[] newArray = new int[size + 1];
/* 167:    */    
