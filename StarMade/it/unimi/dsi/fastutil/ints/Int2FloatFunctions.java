...
/*     */   {
/* 124 */     return new Singleton(key.intValue(), value.floatValue());
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static class UnmodifiableFunction extends AbstractInt2FloatFunction
...
/* 227 */     public float get(int k) { return this.function.get(k); } 
/* 228 */     public boolean containsKey(Object ok) { return this.function.containsKey(ok); }
/*     */ 
/*     */   }
/*     */ 
/*     */   public static class SynchronizedFunction extends AbstractInt2FloatFunction
/*     */     implements Serializable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Int2FloatFunction function;
...
/* 170 */     public float get(int k) { synchronized (this.sync) { return this.function.get(k); }  } 
/* 171 */     public boolean containsKey(Object ok) { synchronized (this.sync) { return this.function.containsKey(ok); }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
/*     */   public static class Singleton extends AbstractInt2FloatFunction
...
/*     */     }
/*  92 */     public float get(int k) { if (this.key == k) return this.value; return this.defRetValue; } 
/*     */     public int size() {
/*  94 */       return 1;
/*     */     }
...
/*     */   }
/*     */ 
/*     */   public static class EmptyFunction extends AbstractInt2FloatFunction
/*     */     implements Serializable, Cloneable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */ 
...
/*     */     public void clear() {  } 
/*  68 */     private Object readResolve() { return Int2FloatFunctions.EMPTY_FUNCTION; } 
/*  69 */     public Object clone() { return Int2FloatFunctions.EMPTY_FUNCTION; }
/*     */ 
/*     */   }
/*     */ }
