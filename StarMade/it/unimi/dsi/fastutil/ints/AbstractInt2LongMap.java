...
/*     */     {
/*  92 */       while (n-- != 0) {
/*  93 */         Int2LongMap.Entry e = (Int2LongMap.Entry)i.next();
/*  94 */         put(e.getIntKey(), e.getLongValue());
/*     */       }
/*     */     }
/*     */     else
/*     */     {
...
/* 101 */         put((Integer)e.getKey(), (Long)e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 193 */         return AbstractInt2LongMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractInt2LongMap.this.size(); } 
/* 196 */       public void clear() { AbstractInt2LongMap.this.clear(); }
/*     */ 
/*     */       public IntIterator iterator() {
/* 199 */         return new AbstractIntIterator() {
/* 200 */           final ObjectIterator<Map.Entry<Integer, Long>> i = AbstractInt2LongMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public int nextInt() { return ((Int2LongMap.Entry)this.i.next()).getIntKey(); } 
...
/* 226 */         return AbstractInt2LongMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractInt2LongMap.this.size(); } 
/* 229 */       public void clear() { AbstractInt2LongMap.this.clear(); }
/*     */ 
/*     */       public LongIterator iterator() {
/* 232 */         return new AbstractLongIterator() {
/* 233 */           final ObjectIterator<Map.Entry<Integer, Long>> i = AbstractInt2LongMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public long nextLong() { return ((Int2LongMap.Entry)this.i.next()).getLongValue(); } 
/*     */           public boolean hasNext() {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Int2LongMap.Entry e = (Int2LongMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Long)e.getValue()).longValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
