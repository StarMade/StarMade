...
/*  15:    */
/*  62:    */public abstract class AbstractInt2LongMap
/*  63:    */  extends AbstractInt2LongFunction
/*  64:    */  implements Int2LongMap, Serializable
/*  65:    */{
...
/*  79:    */  }
/*  80:    */  
/*  86:    */  public void putAll(Map<? extends Integer, ? extends Long> m)
/*  87:    */  {
/*  88: 88 */    int n = m.size();
/*  89: 89 */    Iterator<? extends Map.Entry<? extends Integer, ? extends Long>> i = m.entrySet().iterator();
/*  90: 90 */    if ((m instanceof Int2LongMap))
/*  91:    */    {
/*  92: 92 */      while (n-- != 0) {
/*  93: 93 */        Int2LongMap.Entry e = (Int2LongMap.Entry)i.next();
/*  94: 94 */        put(e.getIntKey(), e.getLongValue());
/*  95:    */      }
/*  96:    */      
/*  97:    */    }
/*  98:    */    else
/*  99: 99 */      while (n-- != 0) {
/* 100:100 */        Map.Entry<? extends Integer, ? extends Long> e = (Map.Entry)i.next();
/* 101:101 */        put((Integer)e.getKey(), (Long)e.getValue());
/* 102:    */      }
/* 103:    */  }
/* 104:    */  
...
/* 111:    */    implements Int2LongMap.Entry
/* 112:    */  {
/* 113:    */    protected int key;
/* 114:    */    protected long value;
/* 115:    */    
/* 116:    */    public BasicEntry(Integer key, Long value)
/* 117:    */    {
/* 118:118 */      this.key = key.intValue();
/* 119:119 */      this.value = value.longValue();
/* 120:    */    }
/* 121:    */    
/* 122:122 */    public BasicEntry(int key, long value) { this.key = key;
...
/* 162:    */      
/* 163:163 */      return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Long)e.getValue()).longValue());
/* 164:    */    }
/* 165:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(int k) { return AbstractInt2LongMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractInt2LongMap.this.size(); }
/* 196:196 */      public void clear() { AbstractInt2LongMap.this.clear(); }
/* 197:    */      
/* 198:    */      public IntIterator iterator() {
/* 199:199 */        new AbstractIntIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<Integer, Long>> i = AbstractInt2LongMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public int nextInt() { return ((Int2LongMap.Entry)this.i.next()).getIntKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(long k) { return AbstractInt2LongMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractInt2LongMap.this.size(); }
/* 229:229 */      public void clear() { AbstractInt2LongMap.this.clear(); }
/* 230:    */      
/* 231:    */      public LongIterator iterator() {
/* 232:232 */        new AbstractLongIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<Integer, Long>> i = AbstractInt2LongMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public long nextLong() { return ((Int2LongMap.Entry)this.i.next()).getLongValue(); }
/* 236:    */          
...
/* 241:    */  }
/* 242:    */  
/* 244:    */  public ObjectSet<Map.Entry<Integer, Long>> entrySet()
/* 245:    */  {
/* 246:246 */    return int2LongEntrySet();
/* 247:    */  }
/* 248:    */  
/* 257:    */  public int hashCode()
/* 258:    */  {
/* 259:259 */    int h = 0;int n = size();
/* 260:260 */    ObjectIterator<? extends Map.Entry<Integer, Long>> i = entrySet().iterator();
/* 261:    */    
...
/* 278:278 */    ObjectIterator<? extends Map.Entry<Integer, Long>> i = entrySet().iterator();
/* 279:279 */    int n = size();
/* 280:    */    
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Int2LongMap.Entry e = (Int2LongMap.Entry)i.next();
/* 290:    */      
