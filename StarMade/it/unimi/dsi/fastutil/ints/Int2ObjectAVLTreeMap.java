  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2ObjectAVLTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2ObjectAVLTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2ObjectAVLTreeMap(Map<? extends Integer, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ObjectAVLTreeMap(SortedMap<Integer, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ObjectAVLTreeMap(Int2ObjectMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ObjectAVLTreeMap(Int2ObjectSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ObjectAVLTreeMap(int[] local_k, V[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2ObjectAVLTreeMap(int[] local_k, V[] local_v)
  {
  ...
  {
    Int2ObjectAVLTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
  ...
  public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Int2ObjectMap.Entry<V>> comparator = new Comparator()
        {
          public int compare(Int2ObjectMap.Entry<V> local_x, Int2ObjectMap.Entry<V> local_y)
          {
            return Int2ObjectAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2ObjectAVLTreeMap.EntryIterator(Int2ObjectAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator(Int2ObjectMap.Entry<V> from)
        {
          return new Int2ObjectAVLTreeMap.EntryIterator(Int2ObjectAVLTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2ObjectAVLTreeMap.Entry<V> local_f = Int2ObjectAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2ObjectAVLTreeMap.Entry<V> local_f = Int2ObjectAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2ObjectAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Int2ObjectMap.Entry<V>> subSet(Int2ObjectMap.Entry<V> from, Int2ObjectMap.Entry<V> local_to)
        {
          return Int2ObjectAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Int2ObjectMap.Entry<V>> headSet(Int2ObjectMap.Entry<V> local_to)
        {
          return Int2ObjectAVLTreeMap.this.headMap((Integer)local_to.getKey()).int2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Int2ObjectMap.Entry<V>> tailSet(Int2ObjectMap.Entry<V> from)
        {
          return Int2ObjectAVLTreeMap.this.tailMap((Integer)from.getKey()).int2ObjectEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Int2ObjectAVLTreeMap.ValueIterator(Int2ObjectAVLTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Int2ObjectAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2ObjectAVLTreeMap<V> local_c;
    try
    {
      local_c = (Int2ObjectAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Int2ObjectAVLTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2ObjectAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Int2ObjectAVLTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Int2ObjectAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2ObjectAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2ObjectMap.Entry<V>> int2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator()
          {
            return new Int2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Int2ObjectAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator(Int2ObjectMap.Entry<V> from)
          {
            return new Int2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Int2ObjectAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
            Int2ObjectAVLTreeMap.Entry<V> local_f = Int2ObjectAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2ObjectAVLTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
            Int2ObjectAVLTreeMap.Entry<V> local_f = Int2ObjectAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2ObjectAVLTreeMap.Submap.this.in4(local_f.key))) {
              Int2ObjectAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2ObjectAVLTreeMap.Submap.SubmapIterator(Int2ObjectAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2ObjectAVLTreeMap.Submap.this.clear();
          }
          
          public Int2ObjectMap.Entry<V> first()
          {
            return Int2ObjectAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Int2ObjectMap.Entry<V> last()
          {
            return Int2ObjectAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2ObjectMap.Entry<V>> subSet(Int2ObjectMap.Entry<V> from, Int2ObjectMap.Entry<V> local_to)
          {
            return Int2ObjectAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Int2ObjectMap.Entry<V>> headSet(Int2ObjectMap.Entry<V> local_to)
          {
            return Int2ObjectAVLTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Int2ObjectMap.Entry<V>> tailSet(Int2ObjectMap.Entry<V> from)
          {
            return Int2ObjectAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Int2ObjectAVLTreeMap.Submap.SubmapValueIterator(Int2ObjectAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Int2ObjectAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2ObjectAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2ObjectAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2ObjectAVLTreeMap.Entry<V> local_e;
      return (in4(local_kk)) && ((local_e = Int2ObjectAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(int local_k, V local_v)
    {
      ...
      V oldValue = Int2ObjectAVLTreeMap.this.put(local_k, local_v);
    ...
    public V remove(int local_k)
    {
      ...
      V oldValue = Int2ObjectAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2ObjectSortedMap<V> tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2ObjectAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2ObjectAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2ObjectSortedMap<V> subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2ObjectAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2ObjectAVLTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2ObjectAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2ObjectAVLTreeMap.this.locateKey(this.from);
        if (Int2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2ObjectAVLTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2ObjectAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2ObjectAVLTreeMap.this.locateKey(this.field_47);
        if (Int2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2ObjectAVLTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2ObjectAVLTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Int2ObjectAVLTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Int2ObjectAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Int2ObjectAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2ObjectAVLTreeMap.Submap.this.bottom) && (Int2ObjectAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2ObjectAVLTreeMap.Submap.this.top) && (Int2ObjectAVLTreeMap.this.compare(local_k, (this.prev = Int2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2ObjectAVLTreeMap.this.locateKey(local_k);
            if (Int2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2ObjectAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2ObjectAVLTreeMap.this.compare(this.prev.key, Int2ObjectAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2ObjectAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2ObjectAVLTreeMap.this.compare(this.next.key, Int2ObjectAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Int2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Int2ObjectAVLTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Int2ObjectAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2ObjectSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2ObjectAVLTreeMap.KeyIterator(Int2ObjectAVLTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2ObjectAVLTreeMap.KeyIterator(Int2ObjectAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2ObjectAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Int2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
