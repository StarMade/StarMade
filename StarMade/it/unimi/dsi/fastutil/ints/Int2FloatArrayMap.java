...
/*  17:    */
/*  66:    */public class Int2FloatArrayMap
/*  67:    */  extends AbstractInt2FloatMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Int2FloatArrayMap(int[] key, float[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Int2FloatArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = IntArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = FloatArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Int2FloatArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new int[capacity];
/*  94: 94 */    this.value = new float[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Int2FloatArrayMap(Int2FloatMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Int2FloatArrayMap(Map<? extends Integer, ? extends Float> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Int2FloatArrayMap(int[] key, float[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Int2FloatMap.Entry> implements Int2FloatMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Int2FloatMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Int2FloatArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Int2FloatMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractInt2FloatMap.BasicEntry(Int2FloatArrayMap.this.key[this.next], Int2FloatArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Int2FloatMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractInt2FloatMap.BasicEntry entry = new AbstractInt2FloatMap.BasicEntry(0, 0.0F);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Int2FloatArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Int2FloatMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Int2FloatArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Int2FloatArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Int2FloatArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Integer, Float> e = (Map.Entry)o;
/* 165:165 */      int k = ((Integer)e.getKey()).intValue();
/* 166:166 */      return (Int2FloatArrayMap.this.containsKey(k)) && (Int2FloatArrayMap.this.get(k) == ((Float)e.getValue()).floatValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Int2FloatMap.FastEntrySet int2FloatEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public float put(int k, float v)
/* 213:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Int2FloatArrayMap clone()
/* 263:    */  {
/* 264:    */    Int2FloatArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Int2FloatArrayMap)super.clone();
/* 270:    */    }
