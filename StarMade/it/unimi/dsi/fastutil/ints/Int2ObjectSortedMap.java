...
public abstract interface Int2ObjectSortedMap<V> extends Int2ObjectMap<V>, SortedMap<Integer, V>
{
  ...
  public static abstract interface FastSortedEntrySet<V> extends ObjectSortedSet<Int2ObjectMap.Entry<V>>, Int2ObjectMap.FastEntrySet<V>
  {
