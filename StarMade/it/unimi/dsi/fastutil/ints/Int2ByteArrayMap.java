...
/*     */ 
/*     */ public class Int2ByteArrayMap extends AbstractInt2ByteMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Int2ByteArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Int2ByteMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Int2ByteArrayMap.this.size; }
/*     */ 
/*     */         public Int2ByteMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractInt2ByteMap.BasicEntry(Int2ByteArrayMap.this.key[this.next], Int2ByteArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractInt2ByteMap.BasicEntry entry = new AbstractInt2ByteMap.BasicEntry(0, (byte)0);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Int2ByteArrayMap.this.size; }
/*     */ 
/*     */         public Int2ByteMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Int2ByteArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Int2ByteArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Int2ByteArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Int2ByteArrayMap.this.containsKey(k)) && (Int2ByteArrayMap.this.get(k) == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */   }
/*     */ }
