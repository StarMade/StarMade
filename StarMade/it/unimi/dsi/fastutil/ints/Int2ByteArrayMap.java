  ...
  implements Serializable, Cloneable
{
  ...
  public Int2ByteArrayMap(Int2ByteMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Int2ByteArrayMap(Map<? extends Integer, ? extends Byte> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Int2ByteArrayMap local_c;
    try
    {
      local_c = (Int2ByteArrayMap)super.clone();
    }
    ...
    implements Int2ByteMap.FastEntrySet
  {
    ...
    public ObjectIterator<Int2ByteMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Int2ByteMap.Entry next()
        {
          ...
          return new AbstractInt2ByteMap.BasicEntry(Int2ByteArrayMap.this.key[this.next], Int2ByteArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Int2ByteMap.Entry> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Int2ByteMap.Entry next()
        {
          ...
          this.entry.key = Int2ByteArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Int2ByteArrayMap.this.containsKey(local_k)) && (Int2ByteArrayMap.this.get(local_k) == ((Byte)local_e.getValue()).byteValue());
    }
  }
}
