  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2LongLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Int2LongLinkedOpenHashMap(Map<? extends Integer, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2LongLinkedOpenHashMap(Map<? extends Integer, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2LongLinkedOpenHashMap(Int2LongMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2LongLinkedOpenHashMap(Int2LongMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2LongLinkedOpenHashMap(int[] local_k, long[] local_v, float local_f)
  {
  ...
  public Int2LongLinkedOpenHashMap(int[] local_k, long[] local_v)
  {
  ...
  public long add(int local_k, long incr)
  {
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k)
      {
  ...
  public long getAndMoveToFirst(int local_k)
  {
    int[] key = this.key;
  ...
  public long getAndMoveToLast(int local_k)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public long putAndMoveToFirst(int local_k, long local_v)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public long putAndMoveToLast(int local_k, long local_v)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public Long get(Integer local_ok)
  {
    int local_k = local_ok.intValue();
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k) {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Int2LongLinkedOpenHashMap.ValueIterator(Int2LongLinkedOpenHashMap.this);
        }
        ...
        {
          return Int2LongLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2LongLinkedOpenHashMap local_c;
    try
    {
      local_c = (Int2LongLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2LongLinkedOpenHashMap.MapIterator
    implements LongListIterator
  {
    public long previousLong()
    {
      return Int2LongLinkedOpenHashMap.this.value[previousEntry()];
    }
    
    public Long previous()
    {
      return Long.valueOf(Int2LongLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Int2LongLinkedOpenHashMap.this.value[nextEntry()];
    }
    
    public Long next()
    {
      return Long.valueOf(Int2LongLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSortedSet
  {
    ...
    {
      return new Int2LongLinkedOpenHashMap.KeyIterator(Int2LongLinkedOpenHashMap.this, from);
    }
    
    public IntListIterator iterator()
    {
      return new Int2LongLinkedOpenHashMap.KeyIterator(Int2LongLinkedOpenHashMap.this);
    }
    ...
    {
      return Int2LongLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2LongLinkedOpenHashMap.this.size;
      Int2LongLinkedOpenHashMap.this.remove(local_k);
    ...
    implements IntListIterator
  {
    ...
    {
      return Int2LongLinkedOpenHashMap.this.key[previousEntry()];
    }
    ...
    {
      return Integer.valueOf(Int2LongLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public int nextInt()
    {
      return Int2LongLinkedOpenHashMap.this.key[nextEntry()];
    }
    
    public Integer next()
    {
      return Integer.valueOf(Int2LongLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2LongSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Int2LongLinkedOpenHashMap.EntryIterator(Int2LongLinkedOpenHashMap.this);
    }
    ...
    public Int2LongMap.Entry first()
    {
      ...
      return new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this, Int2LongLinkedOpenHashMap.this.first);
    }
    ...
    public Int2LongMap.Entry last()
    {
      ...
      return new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this, Int2LongLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2LongLinkedOpenHashMap.this.mask; Int2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask) {
        if (Int2LongLinkedOpenHashMap.this.key[pos] == local_k) {
          return Int2LongLinkedOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2LongLinkedOpenHashMap.this.mask; Int2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask) {
        if (Int2LongLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Int2LongLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Int2LongLinkedOpenHashMap.EntryIterator(Int2LongLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
    
    public ObjectBidirectionalIterator<Int2LongMap.Entry> fastIterator()
    {
      return new Int2LongLinkedOpenHashMap.FastEntryIterator(Int2LongLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Int2LongMap.Entry> fastIterator(Int2LongMap.Entry from)
    {
      return new Int2LongLinkedOpenHashMap.FastEntryIterator(Int2LongLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
  }
    ...
    implements ObjectListIterator<Int2LongMap.Entry>
  {
    ...
    public AbstractInt2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2LongLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Int2LongLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Int2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this, nextEntry());
    }
    
    public Int2LongLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(int from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Int2LongLinkedOpenHashMap.this.mask; Int2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Int2LongLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Int2LongLinkedOpenHashMap.this.first = this.next;
      } else {
        Int2LongLinkedOpenHashMap.this.link[this.prev] ^= (Int2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Int2LongLinkedOpenHashMap.this.last = this.prev;
      } else {
        Int2LongLinkedOpenHashMap.this.link[this.next] ^= (Int2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2LongLinkedOpenHashMap.this.mask; Int2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2LongLinkedOpenHashMap.this.key[pos]) & Int2LongLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2LongLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Int2LongLinkedOpenHashMap.this.key[last] = Int2LongLinkedOpenHashMap.this.key[pos];
      ...
      Int2LongLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Int2LongMap.Entry, Map.Entry<Integer, Long>
  {
    ...
    {
      return Integer.valueOf(Int2LongLinkedOpenHashMap.this.key[this.index]);
    }
    ...
    {
      return Long.valueOf(Int2LongLinkedOpenHashMap.this.value[this.index]);
    }
    ...
    public long setValue(long local_v)
    {
      ...
      Int2LongLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Long> local_e = (Map.Entry)local_o;
      return (Int2LongLinkedOpenHashMap.this.key[this.index] == ((Integer)local_e.getKey()).intValue()) && (Int2LongLinkedOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
