...
/*      */   protected int size;
/*      */   protected volatile transient Int2LongSortedMap.FastSortedEntrySet entries;
...
/*  786 */   public Int2LongSortedMap tailMap(int from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Int2LongSortedMap headMap(int to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Int2LongSortedMap subMap(int from, int to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Int2LongLinkedOpenHashMap.ValueIterator(Int2LongLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Int2LongLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(long v) {
/* 1113 */           return Int2LongLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Int2LongLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Int2LongLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2LongLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public long previousLong()
/*      */     {
/* 1094 */       return Int2LongLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Long previous() { return Long.valueOf(Int2LongLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public long nextLong() { return Int2LongLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Long next() { return Long.valueOf(Int2LongLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Int2LongLinkedOpenHashMap.KeyIterator(Int2LongLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public IntListIterator iterator() {
/* 1054 */       return new Int2LongLinkedOpenHashMap.KeyIterator(Int2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Int2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(int k) {
/* 1060 */       return Int2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(int k) {
/* 1063 */       int oldSize = Int2LongLinkedOpenHashMap.this.size;
/* 1064 */       Int2LongLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Int2LongLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Int2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public int firstInt() {
/* 1071 */       if (Int2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public int lastInt() {
/* 1075 */       if (Int2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2LongLinkedOpenHashMap.MapIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator(int k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public int previousInt() { return Int2LongLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Integer previous() { return Integer.valueOf(Int2LongLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public int nextInt() { return Int2LongLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Integer next() { return Integer.valueOf(Int2LongLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Int2LongMap.Entry>
...
/*      */     {
/*  966 */       return new Int2LongLinkedOpenHashMap.EntryIterator(Int2LongLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Int2LongMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry fromElement, Int2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Int2LongMap.Entry first() {
/*  973 */       if (Int2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this, Int2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Int2LongMap.Entry last() {
/*  977 */       if (Int2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this, Int2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Int2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Int2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Int2LongLinkedOpenHashMap.this.key[pos] == k) return Int2LongLinkedOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  990 */         pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Int2LongLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Int2LongLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Int2LongLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Int2LongLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Int2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Int2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry from) {
/* 1018 */       return new Int2LongLinkedOpenHashMap.EntryIterator(Int2LongLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Int2LongMap.Entry> fastIterator() {
/* 1021 */       return new Int2LongLinkedOpenHashMap.FastEntryIterator(Int2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Int2LongMap.Entry> fastIterator(Int2LongMap.Entry from) {
/* 1024 */       return new Int2LongLinkedOpenHashMap.FastEntryIterator(Int2LongLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Int2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Int2LongMap.Entry>
/*      */   {
/*  944 */     final AbstractInt2LongMap.BasicEntry entry = new AbstractInt2LongMap.BasicEntry(0, 0L);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Int2LongLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Int2LongLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractInt2LongMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Int2LongLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Int2LongLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Int2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Int2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Int2LongMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Int2LongLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Int2LongLinkedOpenHashMap.MapEntry(Int2LongLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Int2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Int2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Int2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Int2LongLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(int from) {
/*  809 */       if (Int2LongLinkedOpenHashMap.this.key[Int2LongLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Int2LongLinkedOpenHashMap.this.last;
/*  811 */         this.index = Int2LongLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Int2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Int2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Int2LongLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Int2LongLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Int2LongLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Int2LongLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Int2LongLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Int2LongLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Int2LongLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Int2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Int2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Int2LongLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Int2LongLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Int2LongLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Int2LongLinkedOpenHashMap.this.link[this.prev] ^= (Int2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Int2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Int2LongLinkedOpenHashMap.this.link[this.next] ^= (Int2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*  897 */         while (Int2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Int2LongLinkedOpenHashMap.this.key[pos]) & Int2LongLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Int2LongLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Int2LongLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Int2LongLinkedOpenHashMap.this.key[last] = Int2LongLinkedOpenHashMap.this.key[pos];
/*  904 */         Int2LongLinkedOpenHashMap.this.value[last] = Int2LongLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Int2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Int2LongLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*  669 */       return Integer.valueOf(Int2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public int getIntKey() {
/*  672 */       return Int2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Long getValue() {
/*  675 */       return Long.valueOf(Int2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public long getLongValue() {
/*  678 */       return Int2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public long setValue(long v) {
/*  681 */       long oldValue = Int2LongLinkedOpenHashMap.this.value[this.index];
/*  682 */       Int2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Long setValue(Long v) {
...
/*  692 */       return (Int2LongLinkedOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Int2LongLinkedOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Int2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Int2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Int2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
