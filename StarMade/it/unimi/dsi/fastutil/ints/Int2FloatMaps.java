...
public class Int2FloatMaps
{
  ...
  public static Int2FloatMap synchronize(Int2FloatMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Int2FloatMap synchronize(Int2FloatMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Int2FloatMap unmodifiable(Int2FloatMap local_m)
  {
    ...
    implements Int2FloatMap, Serializable
  {
    ...
    protected UnmodifiableMap(Int2FloatMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Int2FloatMap, Serializable
  {
    ...
    protected SynchronizedMap(Int2FloatMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Int2FloatMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Int2FloatMap, Serializable, Cloneable
  {
      ...
      implements Int2FloatMap.Entry, Map.Entry<Integer, Float>
    {
      ...
      {
        return Integer.valueOf(Int2FloatMaps.Singleton.this.key);
      }
      
      public Float getValue()
      {
        return Float.valueOf(Int2FloatMaps.Singleton.this.value);
      }
      
      public int getIntKey()
      {
        return Int2FloatMaps.Singleton.this.key;
      }
      
      public float getFloatValue()
      {
        return Int2FloatMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Int2FloatMaps.Singleton.this.key == ((Integer)local_e.getKey()).intValue()) && (Int2FloatMaps.Singleton.this.value == ((Float)local_e.getValue()).floatValue());
      }
      
      public int hashCode()
      {
        return Int2FloatMaps.Singleton.this.key ^ HashCommon.float2int(Int2FloatMaps.Singleton.this.value);
      }
      
      public String toString()
      {
        return Int2FloatMaps.Singleton.this.key + "->" + Int2FloatMaps.Singleton.this.value;
      }
    }
  }
