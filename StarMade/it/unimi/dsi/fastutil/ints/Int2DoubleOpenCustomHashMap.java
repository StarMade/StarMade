  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2DoubleOpenCustomHashMap(int expected, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2DoubleOpenCustomHashMap(Map<? extends Integer, ? extends Double> local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2DoubleOpenCustomHashMap(Map<? extends Integer, ? extends Double> local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2DoubleOpenCustomHashMap(Int2DoubleMap local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2DoubleOpenCustomHashMap(Int2DoubleMap local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2DoubleOpenCustomHashMap(int[] local_k, double[] local_v, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2DoubleOpenCustomHashMap(int[] local_k, double[] local_v, IntHash.Strategy strategy)
  {
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Int2DoubleOpenCustomHashMap.ValueIterator(Int2DoubleOpenCustomHashMap.this);
        }
        ...
        {
          return Int2DoubleOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2DoubleOpenCustomHashMap local_c;
    try
    {
      local_c = (Int2DoubleOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2DoubleOpenCustomHashMap.MapIterator
    implements DoubleIterator
  {
    ...
    public Double next()
    {
      return Double.valueOf(Int2DoubleOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSet
  {
    ...
    {
      return new Int2DoubleOpenCustomHashMap.KeyIterator(Int2DoubleOpenCustomHashMap.this);
    }
    ...
    {
      return Int2DoubleOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2DoubleOpenCustomHashMap.this.size;
      Int2DoubleOpenCustomHashMap.this.remove(local_k);
    ...
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2DoubleOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2DoubleMap.FastEntrySet
  {
    ...
    {
      return new Int2DoubleOpenCustomHashMap.EntryIterator(Int2DoubleOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Int2DoubleMap.Entry> fastIterator()
    {
      return new Int2DoubleOpenCustomHashMap.FastEntryIterator(Int2DoubleOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2DoubleOpenCustomHashMap.this.mask; Int2DoubleOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask) {
        if (Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[pos], local_k)) {
          return Int2DoubleOpenCustomHashMap.this.value[pos] == ((Double)local_e.getValue()).doubleValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2DoubleOpenCustomHashMap.this.mask; Int2DoubleOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask) {
        if (Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[pos], local_k))
        {
          Int2DoubleOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2DoubleMap.Entry>
  {
    ...
    public AbstractInt2DoubleMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2DoubleOpenCustomHashMap.this.key[local_e];
      this.entry.value = Int2DoubleOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2DoubleMap.Entry>
  {
    ...
    {
      return this.entry = new Int2DoubleOpenCustomHashMap.MapEntry(Int2DoubleOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2DoubleOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2DoubleOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2030 = Int2DoubleOpenCustomHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2DoubleOpenCustomHashMap.this.used;
      while ((this.field_2030 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2030 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2030 != 0)
      {
        boolean[] local_k = Int2DoubleOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2DoubleOpenCustomHashMap.this.mask; Int2DoubleOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(Int2DoubleOpenCustomHashMap.this.key[pos])) & Int2DoubleOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2DoubleOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Int2DoubleOpenCustomHashMap.this.key[pos]);
        }
        Int2DoubleOpenCustomHashMap.this.key[last] = Int2DoubleOpenCustomHashMap.this.key[pos];
        Int2DoubleOpenCustomHashMap.this.value[last] = Int2DoubleOpenCustomHashMap.this.value[pos];
      }
      Int2DoubleOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Int2DoubleOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
        this.last = -1;
        return;
      }
      Int2DoubleOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2030 > 0))
      {
        this.field_2030 += 1;
        nextEntry();
      }
    ...
    implements Int2DoubleMap.Entry, Map.Entry<Integer, Double>
  {
    ...
    public double setValue(double local_v)
    {
      ...
      Int2DoubleOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Double> local_e = (Map.Entry)local_o;
      return (Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[this.index], ((Integer)local_e.getKey()).intValue())) && (Int2DoubleOpenCustomHashMap.this.value[this.index] == ((Double)local_e.getValue()).doubleValue());
    }
