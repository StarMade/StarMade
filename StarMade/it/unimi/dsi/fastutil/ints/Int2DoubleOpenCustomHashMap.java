...
/*  18:    */
/*  90:    */public class Int2DoubleOpenCustomHashMap
/*  91:    */  extends AbstractInt2DoubleMap
...
/* 104:    */  protected volatile transient Int2DoubleMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Int2DoubleOpenCustomHashMap(int expected, float f, IntHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Int2DoubleOpenCustomHashMap(int expected, IntHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Int2DoubleOpenCustomHashMap(IntHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Int2DoubleOpenCustomHashMap(Map<? extends Integer, ? extends Double> m, float f, IntHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Int2DoubleOpenCustomHashMap(Map<? extends Integer, ? extends Double> m, IntHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Int2DoubleOpenCustomHashMap(Int2DoubleMap m, float f, IntHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Int2DoubleOpenCustomHashMap(Int2DoubleMap m, IntHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Int2DoubleOpenCustomHashMap(int[] k, double[] v, float f, IntHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Int2DoubleOpenCustomHashMap(int[] k, double[] v, IntHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public double put(int k, double v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Double put(Integer ok, Double ov) { double v = ov.doubleValue();
...
/* 246:    */  }
/* 247:    */  
/* 258:    */  public double add(int k, double incr)
/* 259:    */  {
...
/* 299:    */  }
/* 300:    */  
/* 301:    */  public double remove(int k)
/* 302:    */  {
...
/* 332:    */  }
/* 333:    */  
/* 334:334 */  public Double get(Integer ok) { int k = ok.intValue();
/* 335:    */    
...
/* 409:    */    implements Int2DoubleMap.Entry, Map.Entry<Integer, Double>
/* 410:    */  {
...
/* 416:    */    }
/* 417:    */    
/* 418:418 */    public Integer getKey() { return Integer.valueOf(Int2DoubleOpenCustomHashMap.this.key[this.index]); }
/* 419:    */    
/* 420:    */    public int getIntKey() {
/* 421:421 */      return Int2DoubleOpenCustomHashMap.this.key[this.index];
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public Double getValue() { return Double.valueOf(Int2DoubleOpenCustomHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public double getDoubleValue() { return Int2DoubleOpenCustomHashMap.this.value[this.index]; }
/* 428:    */    
/* 429:    */    public double setValue(double v) {
/* 430:430 */      double oldValue = Int2DoubleOpenCustomHashMap.this.value[this.index];
/* 431:431 */      Int2DoubleOpenCustomHashMap.this.value[this.index] = v;
...
/* 440:440 */      Map.Entry<Integer, Double> e = (Map.Entry)o;
/* 441:441 */      return (Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue())) && (Int2DoubleOpenCustomHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/* 442:    */    }
/* 443:    */    
/* 444:444 */    public int hashCode() { return Int2DoubleOpenCustomHashMap.this.strategy.hashCode(Int2DoubleOpenCustomHashMap.this.key[this.index]) ^ HashCommon.double2int(Int2DoubleOpenCustomHashMap.this.value[this.index]); }
/* 445:    */    
/* 447:447 */    public String toString() { return Int2DoubleOpenCustomHashMap.this.key[this.index] + "=>" + Int2DoubleOpenCustomHashMap.this.value[this.index]; } }
/* 448:    */  
...
/* 453:    */    
/* 454:454 */    private MapIterator() { this.pos = Int2DoubleOpenCustomHashMap.this.n;
/* 455:    */      
/* 457:457 */      this.last = -1;
/* 458:    */      
/* 459:459 */      this.c = Int2DoubleOpenCustomHashMap.this.size;
/* 460:    */      
/* 464:464 */      boolean[] used = Int2DoubleOpenCustomHashMap.this.used;
...
/* 476:    */        
/* 477:477 */        int pos = HashCommon.murmurHash3(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Int2DoubleOpenCustomHashMap.this.mask;
/* 478:    */        
/* 479:479 */        while (Int2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 480:480 */          if (Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481:481 */          pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask;
/* 482:    */        }
/* 483:    */      }
/* 484:484 */      this.last = this.pos;
/* 485:    */      
/* 486:486 */      if (this.c != 0) {
/* 487:487 */        boolean[] used = Int2DoubleOpenCustomHashMap.this.used;
...
/* 502:    */      for (;;)
/* 503:    */      {
/* 504:504 */        pos = (last = pos) + 1 & Int2DoubleOpenCustomHashMap.this.mask;
/* 505:505 */        while (Int2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 506:506 */          int slot = HashCommon.murmurHash3(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(Int2DoubleOpenCustomHashMap.this.key[pos])) & Int2DoubleOpenCustomHashMap.this.mask;
/* 507:507 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508:508 */          pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask;
/* 509:    */        }
/* 510:510 */        if (Int2DoubleOpenCustomHashMap.this.used[pos] == 0) break;
/* 511:511 */        if (pos < last)
/* 512:    */        {
/* 513:513 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 514:514 */          this.wrapped.add(Int2DoubleOpenCustomHashMap.this.key[pos]);
/* 515:    */        }
/* 516:516 */        Int2DoubleOpenCustomHashMap.this.key[last] = Int2DoubleOpenCustomHashMap.this.key[pos];
/* 517:517 */        Int2DoubleOpenCustomHashMap.this.value[last] = Int2DoubleOpenCustomHashMap.this.value[pos];
/* 518:    */      }
/* 519:519 */      Int2DoubleOpenCustomHashMap.this.used[last] = false;
/* 520:520 */      return last;
/* 521:    */    }
/* 522:    */    
...
/* 526:    */      {
/* 527:527 */        Int2DoubleOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 528:528 */        this.last = -1;
/* 529:529 */        return;
/* 530:    */      }
/* 531:531 */      Int2DoubleOpenCustomHashMap.this.size -= 1;
...
/* 543:    */    } }
/* 544:    */  
/* 545:545 */  private class EntryIterator extends Int2DoubleOpenCustomHashMap.MapIterator implements ObjectIterator<Int2DoubleMap.Entry> { private EntryIterator() { super(null); }
/* 546:    */    
/* 547:    */    private Int2DoubleOpenCustomHashMap.MapEntry entry;
/* 548:548 */    public Int2DoubleMap.Entry next() { return this.entry = new Int2DoubleOpenCustomHashMap.MapEntry(Int2DoubleOpenCustomHashMap.this, nextEntry()); }
/* 549:    */    
/* 550:    */    public void remove()
/* 551:    */    {
/* 552:552 */      super.remove();
/* 553:553 */      Int2DoubleOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 554:    */    } }
/* 555:    */  
/* 556:556 */  private class FastEntryIterator extends Int2DoubleOpenCustomHashMap.MapIterator implements ObjectIterator<Int2DoubleMap.Entry> { private FastEntryIterator() { super(null); }
/* 557:557 */    final AbstractInt2DoubleMap.BasicEntry entry = new AbstractInt2DoubleMap.BasicEntry(0, 0.0D);
/* 558:    */    
/* 559:559 */    public AbstractInt2DoubleMap.BasicEntry next() { int e = nextEntry();
/* 560:560 */      this.entry.key = Int2DoubleOpenCustomHashMap.this.key[e];
/* 561:561 */      this.entry.value = Int2DoubleOpenCustomHashMap.this.value[e];
/* 562:562 */      return this.entry;
/* 563:    */    } }
/* 564:    */  
/* 565:    */  private final class MapEntrySet extends AbstractObjectSet<Int2DoubleMap.Entry> implements Int2DoubleMap.FastEntrySet { private MapEntrySet() {}
/* 566:    */    
/* 567:567 */    public ObjectIterator<Int2DoubleMap.Entry> iterator() { return new Int2DoubleOpenCustomHashMap.EntryIterator(Int2DoubleOpenCustomHashMap.this, null); }
/* 568:    */    
/* 569:    */    public ObjectIterator<Int2DoubleMap.Entry> fastIterator() {
/* 570:570 */      return new Int2DoubleOpenCustomHashMap.FastEntryIterator(Int2DoubleOpenCustomHashMap.this, null);
/* 571:    */    }
/* 572:    */    
/* 573:    */    public boolean contains(Object o) {
/* 574:574 */      if (!(o instanceof Map.Entry)) return false;
/* 575:575 */      Map.Entry<Integer, Double> e = (Map.Entry)o;
/* 576:576 */      int k = ((Integer)e.getKey()).intValue();
/* 577:    */      
/* 578:578 */      int pos = HashCommon.murmurHash3(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Int2DoubleOpenCustomHashMap.this.mask;
/* 579:    */      
/* 580:580 */      while (Int2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 581:581 */        if (Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[pos], k)) return Int2DoubleOpenCustomHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/* 582:582 */        pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask;
/* 583:    */      }
...
/* 589:589 */      Map.Entry<Integer, Double> e = (Map.Entry)o;
/* 590:590 */      int k = ((Integer)e.getKey()).intValue();
/* 591:    */      
/* 592:592 */      int pos = HashCommon.murmurHash3(Int2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Int2DoubleOpenCustomHashMap.this.mask;
/* 593:    */      
/* 594:594 */      while (Int2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 595:595 */        if (Int2DoubleOpenCustomHashMap.this.strategy.equals(Int2DoubleOpenCustomHashMap.this.key[pos], k)) {
/* 596:596 */          Int2DoubleOpenCustomHashMap.this.remove(e.getKey());
/* 597:597 */          return true;
/* 598:    */        }
/* 599:599 */        pos = pos + 1 & Int2DoubleOpenCustomHashMap.this.mask;
/* 600:    */      }
/* 601:601 */      return false;
/* 602:    */    }
/* 603:    */    
/* 604:604 */    public int size() { return Int2DoubleOpenCustomHashMap.this.size; }
/* 605:    */    
/* 607:607 */    public void clear() { Int2DoubleOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
/* 610:    */  public Int2DoubleMap.FastEntrySet int2DoubleEntrySet() {
...
/* 618:    */    extends Int2DoubleOpenCustomHashMap.MapIterator
/* 619:    */    implements IntIterator
/* 620:    */  {
/* 621:621 */    public KeyIterator() { super(null); }
/* 622:622 */    public int nextInt() { return Int2DoubleOpenCustomHashMap.this.key[nextEntry()]; }
/* 623:623 */    public Integer next() { return Integer.valueOf(Int2DoubleOpenCustomHashMap.this.key[nextEntry()]); } }
/* 624:    */  
/* 625:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 626:    */    
/* 627:627 */    public IntIterator iterator() { return new Int2DoubleOpenCustomHashMap.KeyIterator(Int2DoubleOpenCustomHashMap.this); }
/* 628:    */    
/* 629:    */    public int size() {
/* 630:630 */      return Int2DoubleOpenCustomHashMap.this.size;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    public boolean contains(int k) { return Int2DoubleOpenCustomHashMap.this.containsKey(k); }
/* 634:    */    
/* 635:    */    public boolean remove(int k) {
/* 636:636 */      int oldSize = Int2DoubleOpenCustomHashMap.this.size;
/* 637:637 */      Int2DoubleOpenCustomHashMap.this.remove(k);
/* 638:638 */      return Int2DoubleOpenCustomHashMap.this.size != oldSize;
/* 639:    */    }
/* 640:    */    
/* 641:641 */    public void clear() { Int2DoubleOpenCustomHashMap.this.clear(); }
/* 642:    */  }
/* 643:    */  
...
/* 652:    */    extends Int2DoubleOpenCustomHashMap.MapIterator
/* 653:    */    implements DoubleIterator
/* 654:    */  {
/* 655:655 */    public ValueIterator() { super(null); }
/* 656:656 */    public double nextDouble() { return Int2DoubleOpenCustomHashMap.this.value[nextEntry()]; }
/* 657:657 */    public Double next() { return Double.valueOf(Int2DoubleOpenCustomHashMap.this.value[nextEntry()]); }
/* 658:    */  }
/* 659:    */  
...
/* 662:662 */          return new Int2DoubleOpenCustomHashMap.ValueIterator(Int2DoubleOpenCustomHashMap.this);
/* 663:    */        }
/* 664:    */        
/* 665:665 */        public int size() { return Int2DoubleOpenCustomHashMap.this.size; }
/* 666:    */        
/* 667:    */        public boolean contains(double v) {
/* 668:668 */          return Int2DoubleOpenCustomHashMap.this.containsValue(v);
/* 669:    */        }
/* 670:    */        
/* 671:671 */        public void clear() { Int2DoubleOpenCustomHashMap.this.clear(); }
/* 672:    */      };
/* 673:    */    }
...
/* 774:    */  }
/* 775:    */  
/* 779:    */  public Int2DoubleOpenCustomHashMap clone()
/* 780:    */  {
/* 781:    */    Int2DoubleOpenCustomHashMap c;
/* 782:    */    
/* 784:    */    try
/* 785:    */    {
/* 786:786 */      c = (Int2DoubleOpenCustomHashMap)super.clone();
/* 787:    */    }
