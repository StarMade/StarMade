...
/*     */   {
/* 173 */     return new Singleton(key.intValue(), value.floatValue());
/*     */   }
/*     */ 
/*     */   public static Int2FloatSortedMap singleton(Integer key, Float value, IntComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.intValue(), value.floatValue(), comparator);
/*     */   }
/*     */ 
...
/*     */     }
/* 302 */     public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.int2FloatEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Integer, Float>> entrySet() {
/* 304 */       return int2FloatEntrySet(); } 
...
/* 308 */     public Int2FloatSortedMap headMap(int to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Int2FloatSortedMap tailMap(int from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Int2FloatSortedMap headMap(Integer to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Int2FloatSortedMap tailMap(Integer from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.int2FloatEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Integer, Float>> entrySet() {
/* 244 */       return int2FloatEntrySet(); } 
...
/* 248 */     public Int2FloatSortedMap headMap(int to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Int2FloatSortedMap tailMap(int from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public int firstIntKey() {
...
/* 259 */     public Int2FloatSortedMap headMap(Integer to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Int2FloatSortedMap tailMap(Integer from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Int2FloatMaps.Singleton.SingletonEntry(this), Int2FloatSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Integer, Float>> entrySet() { return int2FloatEntrySet(); } 
/*     */     public IntSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = IntSortedSets.singleton(this.key, this.comparator); return (IntSortedSet)this.keys;
/*     */     }
/*     */     public Int2FloatSortedMap subMap(int from, int to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Int2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Int2FloatSortedMap headMap(int to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Int2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Int2FloatSortedMap tailMap(int from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Int2FloatSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Int2FloatSortedMap tailMap(Integer ofrom) { return tailMap(ofrom.intValue()); } 
/* 156 */     public Int2FloatSortedMap subMap(Integer ofrom, Integer oto) { return subMap(ofrom.intValue(), oto.intValue()); } 
/*     */     public Integer firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Int2FloatMap.Entry> int2FloatEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Integer, Float>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public IntSortedSet keySet() { return IntSortedSets.EMPTY_SET; } 
/*     */     public Int2FloatSortedMap subMap(int from, int to) {
/*  86 */       return Int2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Int2FloatSortedMap headMap(int to) { return Int2FloatSortedMaps.EMPTY_MAP; } 
/*     */     public Int2FloatSortedMap tailMap(int from) {
/*  90 */       return Int2FloatSortedMaps.EMPTY_MAP; } 
/*  91 */     public int firstIntKey() { throw new NoSuchElementException(); } 
/*  92 */     public int lastIntKey() { throw new NoSuchElementException(); } 
/*  93 */     public Int2FloatSortedMap headMap(Integer oto) { return headMap(oto.intValue()); } 
/*  94 */     public Int2FloatSortedMap tailMap(Integer ofrom) { return tailMap(ofrom.intValue()); } 
/*  95 */     public Int2FloatSortedMap subMap(Integer ofrom, Integer oto) { return subMap(ofrom.intValue(), oto.intValue()); } 
