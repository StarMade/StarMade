...
/*      */ 
/*      */ public class Int2CharAVLTreeMap extends AbstractInt2CharSortedMap
...
/*  117 */           return Int2CharAVLTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  120 */           return Int2CharAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     char oldValue = put(ok.intValue(), ov.charValue());
/*  780 */     return this.modified ? null : Character.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Character remove(Object ok)
/*      */   {
/*  788 */     char oldValue = remove(((Integer)ok).intValue());
...
/* 1203 */         final Comparator<? super Int2CharMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2CharMap.Entry x, Int2CharMap.Entry y) {
/* 1205 */             return Int2CharAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Int2CharAVLTreeMap.EntryIterator(Int2CharAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator(Int2CharMap.Entry from) {
/* 1215 */           return new Int2CharAVLTreeMap.EntryIterator(Int2CharAVLTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Int2CharAVLTreeMap.Entry f = Int2CharAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1228 */           Int2CharAVLTreeMap.Entry f = Int2CharAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1229 */           if (f != null) Int2CharAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Int2CharAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Int2CharAVLTreeMap.this.clear(); } 
/* 1234 */         public Int2CharMap.Entry first() { return Int2CharAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Int2CharMap.Entry last() { return Int2CharAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Int2CharMap.Entry> subSet(Int2CharMap.Entry from, Int2CharMap.Entry to) { return Int2CharAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2CharEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry to) { return Int2CharAVLTreeMap.this.headMap((Integer)to.getKey()).int2CharEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry from) { return Int2CharAVLTreeMap.this.tailMap((Integer)from.getKey()).int2CharEntrySet(); }
/*      */       };
...
/* 1304 */           return new Int2CharAVLTreeMap.ValueIterator(Int2CharAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(char k) {
/* 1307 */           return Int2CharAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Int2CharAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Int2CharAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Int2CharAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readInt(), s.readChar());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readInt(), s.readChar());
/* 1759 */       top.right(new Entry(s.readInt(), s.readChar()));
...
/*      */   }
/*      */ 
/*      */   private final class Submap extends AbstractInt2CharSortedMap
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Int2CharAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Int2CharAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Int2CharAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2CharAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator() {
/* 1391 */             return new Int2CharAVLTreeMap.Submap.SubmapEntryIterator(Int2CharAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator(Int2CharMap.Entry from) {
/* 1394 */             return new Int2CharAVLTreeMap.Submap.SubmapEntryIterator(Int2CharAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1396 */           public Comparator<? super Int2CharMap.Entry> comparator() { return Int2CharAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Int2CharAVLTreeMap.Entry f = Int2CharAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1402 */             return (f != null) && (Int2CharAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Int2CharAVLTreeMap.Entry f = Int2CharAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1409 */             if ((f != null) && (Int2CharAVLTreeMap.Submap.this.in(f.key))) Int2CharAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Int2CharAVLTreeMap.Submap.SubmapIterator(Int2CharAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Int2CharAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Int2CharMap.Entry first() { return Int2CharAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Int2CharMap.Entry last() { return Int2CharAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Int2CharMap.Entry> subSet(Int2CharMap.Entry from, Int2CharMap.Entry to) { return Int2CharAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2CharEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry to) { return Int2CharAVLTreeMap.Submap.this.headMap((Integer)to.getKey()).int2CharEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry from) { return Int2CharAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2CharEntrySet(); }
/*      */         };
...
/*      */           public CharIterator iterator() {
/* 1442 */             return new Int2CharAVLTreeMap.Submap.SubmapValueIterator(Int2CharAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(char k) {
/* 1445 */             return Int2CharAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Int2CharAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Int2CharAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1458 */       return (in(k)) && (Int2CharAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(char v) {
...
/* 1473 */       return (in(kk)) && ((e = Int2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public char put(int k, char v) {
/* 1476 */       Int2CharAVLTreeMap.this.modified = false;
...
/* 1478 */       char oldValue = Int2CharAVLTreeMap.this.put(k, v);
/* 1479 */       return Int2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Character put(Integer ok, Character ov) {
/* 1482 */       char oldValue = put(ok.intValue(), ov.charValue());
/* 1483 */       return Int2CharAVLTreeMap.this.modified ? null : Character.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public char remove(int k) {
/* 1487 */       Int2CharAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       char oldValue = Int2CharAVLTreeMap.this.remove(k);
/* 1490 */       return Int2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Character remove(Object ok) {
/* 1493 */       char oldValue = remove(((Integer)ok).intValue());
/* 1494 */       return Int2CharAVLTreeMap.this.modified ? Character.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1509 */       return Int2CharAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2CharSortedMap headMap(int to) {
/* 1512 */       if (this.top) return new Submap(Int2CharAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Int2CharAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2CharAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2CharSortedMap tailMap(int from) {
/* 1516 */       if (this.bottom) return new Submap(Int2CharAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Int2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2CharAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2CharSortedMap subMap(int from, int to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Int2CharAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Int2CharAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Int2CharAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Int2CharAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2CharAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Int2CharAVLTreeMap.this.tree == null) return null;
/* 1534 */       Int2CharAVLTreeMap.Entry e;
/*      */       Int2CharAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Int2CharAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Int2CharAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Int2CharAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Int2CharAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2CharAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Int2CharAVLTreeMap.this.tree == null) return null;
/* 1552 */       Int2CharAVLTreeMap.Entry e;
/*      */       Int2CharAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Int2CharAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Int2CharAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Int2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Int2CharAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1563 */       Int2CharAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1568 */       Int2CharAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1573 */       Int2CharAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1578 */       Int2CharAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2CharAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2CharAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2CharAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Int2CharMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Int2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Int2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Int2CharAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Int2CharAVLTreeMap.Submap.this.bottom) && (Int2CharAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Int2CharAVLTreeMap.Submap.this.top) && (Int2CharAVLTreeMap.this.compare(k, (this.prev = Int2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Int2CharAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Int2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Int2CharAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2CharAVLTreeMap.this.compare(this.prev.key, Int2CharAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Int2CharAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2CharAVLTreeMap.this.compare(this.next.key, Int2CharAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public IntBidirectionalIterator iterator() { return new Int2CharAVLTreeMap.Submap.SubmapKeyIterator(Int2CharAVLTreeMap.Submap.this); } 
/* 1433 */       public IntBidirectionalIterator iterator(int from) { return new Int2CharAVLTreeMap.Submap.SubmapKeyIterator(Int2CharAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2CharAVLTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public IntBidirectionalIterator iterator() { return new Int2CharAVLTreeMap.KeyIterator(Int2CharAVLTreeMap.this); } 
/* 1263 */     public IntBidirectionalIterator iterator(int from) { return new Int2CharAVLTreeMap.KeyIterator(Int2CharAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2CharAVLTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2CharAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2CharMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Int2CharMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Int2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Int2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Int2CharAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1129 */       if ((this.next = Int2CharAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Int2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Int2CharAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
