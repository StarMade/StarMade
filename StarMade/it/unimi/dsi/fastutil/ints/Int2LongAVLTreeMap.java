  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2LongAVLTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2LongAVLTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2LongAVLTreeMap(Map<? extends Integer, ? extends Long> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2LongAVLTreeMap(SortedMap<Integer, Long> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2LongAVLTreeMap(Int2LongMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2LongAVLTreeMap(Int2LongSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2LongAVLTreeMap(int[] local_k, long[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2LongAVLTreeMap(int[] local_k, long[] local_v)
  {
  ...
  {
    long oldValue = put(local_ok.intValue(), local_ov.longValue());
    return this.modified ? null : Long.valueOf(oldValue);
  }
  
  public Long remove(Object local_ok)
  {
    long oldValue = remove(((Integer)local_ok).intValue());
  ...
  public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Int2LongMap.Entry> comparator = new Comparator()
        {
          public int compare(Int2LongMap.Entry local_x, Int2LongMap.Entry local_y)
          {
            return Int2LongAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2LongAVLTreeMap.EntryIterator(Int2LongAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry from)
        {
          return new Int2LongAVLTreeMap.EntryIterator(Int2LongAVLTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2LongAVLTreeMap.Entry local_f = Int2LongAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2LongAVLTreeMap.Entry local_f = Int2LongAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2LongAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry from, Int2LongMap.Entry local_to)
        {
          return Int2LongAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2LongEntrySet();
        }
        
        public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry local_to)
        {
          return Int2LongAVLTreeMap.this.headMap((Integer)local_to.getKey()).int2LongEntrySet();
        }
        
        public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry from)
        {
          return Int2LongAVLTreeMap.this.tailMap((Integer)from.getKey()).int2LongEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Int2LongAVLTreeMap.ValueIterator(Int2LongAVLTreeMap.this, null);
        }
        
        public boolean contains(long local_k)
        {
          return Int2LongAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2LongAVLTreeMap local_c;
    try
    {
      local_c = (Int2LongAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readInt(), local_s.readLong());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readInt(), local_s.readLong());
      top.right(new Entry(local_s.readInt(), local_s.readLong()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2LongAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Int2LongAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2LongAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2LongMap.Entry> int2LongEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator()
          {
            return new Int2LongAVLTreeMap.Submap.SubmapEntryIterator(Int2LongAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2LongMap.Entry> iterator(Int2LongMap.Entry from)
          {
            return new Int2LongAVLTreeMap.Submap.SubmapEntryIterator(Int2LongAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, Long> local_e = (Map.Entry)local_o;
            Int2LongAVLTreeMap.Entry local_f = Int2LongAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2LongAVLTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, Long> local_e = (Map.Entry)local_o;
            Int2LongAVLTreeMap.Entry local_f = Int2LongAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2LongAVLTreeMap.Submap.this.in4(local_f.key))) {
              Int2LongAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2LongAVLTreeMap.Submap.SubmapIterator(Int2LongAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2LongAVLTreeMap.Submap.this.clear();
          }
          
          public Int2LongMap.Entry first()
          {
            return Int2LongAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Int2LongMap.Entry last()
          {
            return Int2LongAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2LongMap.Entry> subSet(Int2LongMap.Entry from, Int2LongMap.Entry local_to)
          {
            return Int2LongAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2LongEntrySet();
          }
          
          public ObjectSortedSet<Int2LongMap.Entry> headSet(Int2LongMap.Entry local_to)
          {
            return Int2LongAVLTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2LongEntrySet();
          }
          
          public ObjectSortedSet<Int2LongMap.Entry> tailSet(Int2LongMap.Entry from)
          {
            return Int2LongAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2LongEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public LongCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractLongCollection()
        {
          public LongIterator iterator()
          {
            return new Int2LongAVLTreeMap.Submap.SubmapValueIterator(Int2LongAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(long local_k)
          {
            return Int2LongAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2LongAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2LongAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2LongAVLTreeMap.Entry local_e;
      return (in4(local_kk)) && ((local_e = Int2LongAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public long put(int local_k, long local_v)
    {
      ...
      long oldValue = Int2LongAVLTreeMap.this.put(local_k, local_v);
    ...
    public long remove(int local_k)
    {
      ...
      long oldValue = Int2LongAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2LongAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2LongAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2LongSortedMap tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2LongAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2LongAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2LongAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2LongSortedMap subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2LongAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2LongAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2LongAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2LongAVLTreeMap.this.locateKey(this.from);
        if (Int2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2LongAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2LongAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2LongAVLTreeMap.this.locateKey(this.field_47);
        if (Int2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2LongAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2LongAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      implements ObjectListIterator<Int2LongMap.Entry>
    {
      ...
      public void set(Int2LongMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Int2LongMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
      ...
      extends Int2LongAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Int2LongAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2LongAVLTreeMap.Submap.this.bottom) && (Int2LongAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2LongAVLTreeMap.Submap.this.top) && (Int2LongAVLTreeMap.this.compare(local_k, (this.prev = Int2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2LongAVLTreeMap.this.locateKey(local_k);
            if (Int2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2LongAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2LongAVLTreeMap.this.compare(this.prev.key, Int2LongAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2LongAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2LongAVLTreeMap.this.compare(this.next.key, Int2LongAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2LongSortedMap.KeySet
    {
      ...
      {
        return new Int2LongAVLTreeMap.Submap.SubmapKeyIterator(Int2LongAVLTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2LongAVLTreeMap.Submap.SubmapKeyIterator(Int2LongAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2LongSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2LongAVLTreeMap.KeyIterator(Int2LongAVLTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2LongAVLTreeMap.KeyIterator(Int2LongAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2LongAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Int2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Int2LongMap.Entry
  {
    ...
    Entry(int local_k, long local_v)
    {
      this.key = local_k;
      this.value = local_v;
