  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2ByteLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Int2ByteLinkedOpenHashMap(Map<? extends Integer, ? extends Byte> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2ByteLinkedOpenHashMap(Map<? extends Integer, ? extends Byte> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2ByteLinkedOpenHashMap(Int2ByteMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2ByteLinkedOpenHashMap(Int2ByteMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2ByteLinkedOpenHashMap(int[] local_k, byte[] local_v, float local_f)
  {
  ...
  public Int2ByteLinkedOpenHashMap(int[] local_k, byte[] local_v)
  {
  ...
  public byte getAndMoveToFirst(int local_k)
  {
    int[] key = this.key;
  ...
  public byte getAndMoveToLast(int local_k)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public byte putAndMoveToFirst(int local_k, byte local_v)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public byte putAndMoveToLast(int local_k, byte local_v)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Int2ByteLinkedOpenHashMap.ValueIterator(Int2ByteLinkedOpenHashMap.this);
        }
        ...
        {
          return Int2ByteLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2ByteLinkedOpenHashMap local_c;
    try
    {
      local_c = (Int2ByteLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2ByteLinkedOpenHashMap.MapIterator
    implements ByteListIterator
  {
    ...
    {
      return Byte.valueOf(Int2ByteLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Byte next()
    {
      return Byte.valueOf(Int2ByteLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSortedSet
  {
    ...
    {
      return new Int2ByteLinkedOpenHashMap.KeyIterator(Int2ByteLinkedOpenHashMap.this, from);
    }
    
    public IntListIterator iterator()
    {
      return new Int2ByteLinkedOpenHashMap.KeyIterator(Int2ByteLinkedOpenHashMap.this);
    }
    ...
    {
      return Int2ByteLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2ByteLinkedOpenHashMap.this.size;
      Int2ByteLinkedOpenHashMap.this.remove(local_k);
    ...
    implements IntListIterator
  {
    ...
    {
      return Integer.valueOf(Int2ByteLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2ByteLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2ByteSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Int2ByteLinkedOpenHashMap.EntryIterator(Int2ByteLinkedOpenHashMap.this);
    }
    ...
    public Int2ByteMap.Entry first()
    {
      ...
      return new Int2ByteLinkedOpenHashMap.MapEntry(Int2ByteLinkedOpenHashMap.this, Int2ByteLinkedOpenHashMap.this.first);
    }
    ...
    public Int2ByteMap.Entry last()
    {
      ...
      return new Int2ByteLinkedOpenHashMap.MapEntry(Int2ByteLinkedOpenHashMap.this, Int2ByteLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2ByteLinkedOpenHashMap.this.mask; Int2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ByteLinkedOpenHashMap.this.mask) {
        if (Int2ByteLinkedOpenHashMap.this.key[pos] == local_k) {
          return Int2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2ByteLinkedOpenHashMap.this.mask; Int2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ByteLinkedOpenHashMap.this.mask) {
        if (Int2ByteLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Int2ByteLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Int2ByteLinkedOpenHashMap.EntryIterator(Int2ByteLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
    
    public ObjectBidirectionalIterator<Int2ByteMap.Entry> fastIterator()
    {
      return new Int2ByteLinkedOpenHashMap.FastEntryIterator(Int2ByteLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Int2ByteMap.Entry> fastIterator(Int2ByteMap.Entry from)
    {
      return new Int2ByteLinkedOpenHashMap.FastEntryIterator(Int2ByteLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
  }
    ...
    implements ObjectListIterator<Int2ByteMap.Entry>
  {
    ...
    public AbstractInt2ByteMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2ByteLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Int2ByteLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Int2ByteMap.Entry>
  {
    ...
    {
      return this.entry = new Int2ByteLinkedOpenHashMap.MapEntry(Int2ByteLinkedOpenHashMap.this, nextEntry());
    }
    
    public Int2ByteLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Int2ByteLinkedOpenHashMap.MapEntry(Int2ByteLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(int from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Int2ByteLinkedOpenHashMap.this.mask; Int2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ByteLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Int2ByteLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Int2ByteLinkedOpenHashMap.this.first = this.next;
      } else {
        Int2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Int2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Int2ByteLinkedOpenHashMap.this.last = this.prev;
      } else {
        Int2ByteLinkedOpenHashMap.this.link[this.next] ^= (Int2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2ByteLinkedOpenHashMap.this.mask; Int2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ByteLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2ByteLinkedOpenHashMap.this.key[pos]) & Int2ByteLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2ByteLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Int2ByteLinkedOpenHashMap.this.key[last] = Int2ByteLinkedOpenHashMap.this.key[pos];
      ...
      Int2ByteLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Int2ByteMap.Entry, Map.Entry<Integer, Byte>
  {
    ...
    public byte setValue(byte local_v)
    {
      ...
      Int2ByteLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Byte> local_e = (Map.Entry)local_o;
      return (Int2ByteLinkedOpenHashMap.this.key[this.index] == ((Integer)local_e.getKey()).intValue()) && (Int2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
