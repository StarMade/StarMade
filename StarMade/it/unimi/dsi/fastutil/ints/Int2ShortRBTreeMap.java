  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2ShortRBTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2ShortRBTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2ShortRBTreeMap(Map<? extends Integer, ? extends Short> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ShortRBTreeMap(SortedMap<Integer, Short> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ShortRBTreeMap(Int2ShortMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ShortRBTreeMap(Int2ShortSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ShortRBTreeMap(int[] local_k, short[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2ShortRBTreeMap(int[] local_k, short[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2ShortMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Int2ShortRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2ShortRBTreeMap.EntryIterator(Int2ShortRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry from)
        {
          return new Int2ShortRBTreeMap.EntryIterator(Int2ShortRBTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2ShortRBTreeMap.Entry local_f = Int2ShortRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2ShortRBTreeMap.Entry local_f = Int2ShortRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2ShortRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2ShortRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ShortEntrySet();
        }
        
        public ObjectSortedSet<Int2ShortMap.Entry> headSet(Int2ShortMap.Entry local_to)
        {
          return Int2ShortRBTreeMap.this.headMap((Integer)local_to.getKey()).int2ShortEntrySet();
        }
        
        public ObjectSortedSet<Int2ShortMap.Entry> tailSet(Int2ShortMap.Entry from)
        {
          return Int2ShortRBTreeMap.this.tailMap((Integer)from.getKey()).int2ShortEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Int2ShortRBTreeMap.ValueIterator(Int2ShortRBTreeMap.this, null);
        }
        
        public boolean contains(short local_k)
        {
          return Int2ShortRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2ShortRBTreeMap local_c;
    try
    {
      local_c = (Int2ShortRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2ShortRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Int2ShortRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2ShortRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2ShortMap.Entry> int2ShortEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator()
          {
            return new Int2ShortRBTreeMap.Submap.SubmapEntryIterator(Int2ShortRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2ShortMap.Entry> iterator(Int2ShortMap.Entry from)
          {
            return new Int2ShortRBTreeMap.Submap.SubmapEntryIterator(Int2ShortRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, Short> local_e = (Map.Entry)local_o;
            Int2ShortRBTreeMap.Entry local_f = Int2ShortRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2ShortRBTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, Short> local_e = (Map.Entry)local_o;
            Int2ShortRBTreeMap.Entry local_f = Int2ShortRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2ShortRBTreeMap.Submap.this.in4(local_f.key))) {
              Int2ShortRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2ShortRBTreeMap.Submap.SubmapIterator(Int2ShortRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2ShortRBTreeMap.Submap.this.clear();
          }
          
          public Int2ShortMap.Entry first()
          {
            return Int2ShortRBTreeMap.Submap.this.firstEntry();
          }
          
          public Int2ShortMap.Entry last()
          {
            return Int2ShortRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2ShortMap.Entry> subSet(Int2ShortMap.Entry from, Int2ShortMap.Entry local_to)
          {
            return Int2ShortRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ShortEntrySet();
          }
          
          public ObjectSortedSet<Int2ShortMap.Entry> headSet(Int2ShortMap.Entry local_to)
          {
            return Int2ShortRBTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2ShortEntrySet();
          }
          
          public ObjectSortedSet<Int2ShortMap.Entry> tailSet(Int2ShortMap.Entry from)
          {
            return Int2ShortRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2ShortEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ShortCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractShortCollection()
        {
          public ShortIterator iterator()
          {
            return new Int2ShortRBTreeMap.Submap.SubmapValueIterator(Int2ShortRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(short local_k)
          {
            return Int2ShortRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2ShortRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2ShortRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2ShortRBTreeMap.Entry local_e;
      return (in4(local_kk)) && ((local_e = Int2ShortRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public short put(int local_k, short local_v)
    {
      ...
      short oldValue = Int2ShortRBTreeMap.this.put(local_k, local_v);
    ...
    public short remove(int local_k)
    {
      ...
      short oldValue = Int2ShortRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2ShortRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2ShortRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2ShortSortedMap tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2ShortRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2ShortRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2ShortSortedMap subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2ShortRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2ShortRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2ShortRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2ShortRBTreeMap.this.locateKey(this.from);
        if (Int2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2ShortRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2ShortRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2ShortRBTreeMap.this.locateKey(this.field_47);
        if (Int2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2ShortRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2ShortRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Int2ShortRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Int2ShortRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2ShortRBTreeMap.Submap.this.bottom) && (Int2ShortRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2ShortRBTreeMap.Submap.this.top) && (Int2ShortRBTreeMap.this.compare(local_k, (this.prev = Int2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2ShortRBTreeMap.this.locateKey(local_k);
            if (Int2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2ShortRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2ShortRBTreeMap.this.compare(this.prev.key, Int2ShortRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2ShortRBTreeMap.Submap.this.top) && (this.next != null) && (Int2ShortRBTreeMap.this.compare(this.next.key, Int2ShortRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2ShortSortedMap.KeySet
    {
      ...
      {
        return new Int2ShortRBTreeMap.Submap.SubmapKeyIterator(Int2ShortRBTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2ShortRBTreeMap.Submap.SubmapKeyIterator(Int2ShortRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2ShortSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2ShortRBTreeMap.KeyIterator(Int2ShortRBTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2ShortRBTreeMap.KeyIterator(Int2ShortRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2ShortRBTreeMap.this.locateKey(local_k)) != null) {
        if (Int2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
