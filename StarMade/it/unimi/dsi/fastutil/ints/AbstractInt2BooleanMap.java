  ...
  implements Int2BooleanMap, Serializable
{
  ...
  public void putAll(Map<? extends Integer, ? extends Boolean> local_m)
  {
    ...
    Iterator<? extends Map.Entry<? extends Integer, ? extends Boolean>> local_i = local_m.entrySet().iterator();
    if ((local_m instanceof Int2BooleanMap)) {
      while (local_n-- != 0)
      {
        Int2BooleanMap.Entry local_e = (Int2BooleanMap.Entry)local_i.next();
        put(local_e.getIntKey(), local_e.getBooleanValue());
      }
    } else {
      while (local_n-- != 0)
      {
        Map.Entry<? extends Integer, ? extends Boolean> local_e = (Map.Entry)local_i.next();
        put((Integer)local_e.getKey(), (Boolean)local_e.getValue());
      }
    }
  }
  ...
  public IntSet keySet()
  {
    new AbstractIntSet()
    {
      ...
      {
        return AbstractInt2BooleanMap.this.containsKey(local_k);
      }
      ...
      public IntIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<Integer, Boolean>> field_70 = AbstractInt2BooleanMap.this.entrySet().iterator();
          
          public int nextInt()
          {
            return ((Int2BooleanMap.Entry)this.field_70.next()).getIntKey();
          }
  ...
  public BooleanCollection values()
  {
    new AbstractBooleanCollection()
    {
      ...
      {
        return AbstractInt2BooleanMap.this.containsValue(local_k);
      }
      ...
      public BooleanIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<Integer, Boolean>> field_60 = AbstractInt2BooleanMap.this.entrySet().iterator();
          
          public boolean nextBoolean()
          {
            return ((Int2BooleanMap.Entry)this.field_60.next()).getBooleanValue();
          }
  ...
  public int hashCode()
  {
    int local_h = 0;
    int local_n = size();
    ObjectIterator<? extends Map.Entry<Integer, Boolean>> local_i = entrySet().iterator();
    while (local_n-- != 0) {
