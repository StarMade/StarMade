...
/*     */     {
/*  92 */       while (n-- != 0) {
/*  93 */         Int2ShortMap.Entry e = (Int2ShortMap.Entry)i.next();
/*  94 */         put(e.getIntKey(), e.getShortValue());
/*     */       }
/*     */     }
/*     */     else
/*     */     {
...
/* 101 */         put((Integer)e.getKey(), (Short)e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 193 */         return AbstractInt2ShortMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractInt2ShortMap.this.size(); } 
/* 196 */       public void clear() { AbstractInt2ShortMap.this.clear(); }
/*     */ 
/*     */       public IntIterator iterator() {
/* 199 */         return new AbstractIntIterator() {
/* 200 */           final ObjectIterator<Map.Entry<Integer, Short>> i = AbstractInt2ShortMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public int nextInt() { return ((Int2ShortMap.Entry)this.i.next()).getIntKey(); } 
...
/* 226 */         return AbstractInt2ShortMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractInt2ShortMap.this.size(); } 
/* 229 */       public void clear() { AbstractInt2ShortMap.this.clear(); }
/*     */ 
/*     */       public ShortIterator iterator() {
/* 232 */         return new AbstractShortIterator() {
/* 233 */           final ObjectIterator<Map.Entry<Integer, Short>> i = AbstractInt2ShortMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public short nextShort() { return ((Int2ShortMap.Entry)this.i.next()).getShortValue(); } 
/*     */           public boolean hasNext() {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Int2ShortMap.Entry e = (Int2ShortMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
