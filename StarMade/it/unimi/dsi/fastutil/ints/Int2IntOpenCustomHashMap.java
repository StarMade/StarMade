...
/*     */ 
/*     */ public class Int2IntOpenCustomHashMap extends AbstractInt2IntMap
...
/* 662 */           return new Int2IntOpenCustomHashMap.ValueIterator(Int2IntOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 665 */           return Int2IntOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(int v) {
/* 668 */           return Int2IntOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 671 */           Int2IntOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 786 */       c = (Int2IntOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Int2IntOpenCustomHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 655 */       super(null); } 
/* 656 */     public int nextInt() { return Int2IntOpenCustomHashMap.this.value[nextEntry()]; } 
/* 657 */     public Integer next() { return Integer.valueOf(Int2IntOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     public IntIterator iterator()
/*     */     {
/* 627 */       return new Int2IntOpenCustomHashMap.KeyIterator(Int2IntOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 630 */       return Int2IntOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(int k) {
/* 633 */       return Int2IntOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(int k) {
/* 636 */       int oldSize = Int2IntOpenCustomHashMap.this.size;
/* 637 */       Int2IntOpenCustomHashMap.this.remove(k);
/* 638 */       return Int2IntOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 641 */       Int2IntOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Int2IntOpenCustomHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public int nextInt() { return Int2IntOpenCustomHashMap.this.key[nextEntry()]; } 
/* 623 */     public Integer next() { return Integer.valueOf(Int2IntOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 567 */       return new Int2IntOpenCustomHashMap.EntryIterator(Int2IntOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Int2IntMap.Entry> fastIterator() {
/* 570 */       return new Int2IntOpenCustomHashMap.FastEntryIterator(Int2IntOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 578 */       int pos = HashCommon.murmurHash3(Int2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Int2IntOpenCustomHashMap.this.mask;
/*     */ 
/* 580 */       while (Int2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 581 */         if (Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[pos], k)) return Int2IntOpenCustomHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 582 */         pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask;
/*     */       }
/* 584 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 592 */       int pos = HashCommon.murmurHash3(Int2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Int2IntOpenCustomHashMap.this.mask;
/*     */ 
/* 594 */       while (Int2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 595 */         if (Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[pos], k)) {
/* 596 */           Int2IntOpenCustomHashMap.this.remove(e.getKey());
/* 597 */           return true;
/*     */         }
/* 599 */         pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask;
/*     */       }
/* 601 */       return false;
/*     */     }
/*     */     public int size() {
/* 604 */       return Int2IntOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 607 */       Int2IntOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Int2IntOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Int2IntMap.Entry>
/*     */   {
/* 557 */     final AbstractInt2IntMap.BasicEntry entry = new AbstractInt2IntMap.BasicEntry(0, 0);
/*     */ 
...
/* 559 */       int e = nextEntry();
/* 560 */       this.entry.key = Int2IntOpenCustomHashMap.this.key[e];
/* 561 */       this.entry.value = Int2IntOpenCustomHashMap.this.value[e];
/* 562 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Int2IntOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Int2IntMap.Entry>
/*     */   {
...
/* 548 */       return this.entry = new Int2IntOpenCustomHashMap.MapEntry(Int2IntOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 552 */       super.remove();
/* 553 */       Int2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 454 */       this.pos = Int2IntOpenCustomHashMap.this.n;
/*     */ 
/* 457 */       this.last = -1;
/*     */ 
/* 459 */       this.c = Int2IntOpenCustomHashMap.this.size;
/*     */ 
/* 464 */       boolean[] used = Int2IntOpenCustomHashMap.this.used;
...
/*     */ 
/* 477 */         int pos = HashCommon.murmurHash3(Int2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Int2IntOpenCustomHashMap.this.mask;
/*     */ 
/* 479 */         while (Int2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 480 */           if (Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481 */           pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 484 */       this.last = this.pos;
/*     */ 
/* 486 */       if (this.c != 0) {
/* 487 */         boolean[] used = Int2IntOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 504 */         pos = (last = pos) + 1 & Int2IntOpenCustomHashMap.this.mask;
/* 505 */         while (Int2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 506 */           int slot = HashCommon.murmurHash3(Int2IntOpenCustomHashMap.this.strategy.hashCode(Int2IntOpenCustomHashMap.this.key[pos])) & Int2IntOpenCustomHashMap.this.mask;
/* 507 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508 */           pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask;
/*     */         }
/* 510 */         if (Int2IntOpenCustomHashMap.this.used[pos] == 0) break;
/* 511 */         if (pos < last)
/*     */         {
/* 513 */           if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 514 */           this.wrapped.add(Int2IntOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 516 */         Int2IntOpenCustomHashMap.this.key[last] = Int2IntOpenCustomHashMap.this.key[pos];
/* 517 */         Int2IntOpenCustomHashMap.this.value[last] = Int2IntOpenCustomHashMap.this.value[pos];
/*     */       }
/* 519 */       Int2IntOpenCustomHashMap.this.used[last] = false;
/* 520 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 525 */       if (this.pos < -1)
/*     */       {
/* 527 */         Int2IntOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 528 */         this.last = -1;
/* 529 */         return;
/*     */       }
/* 531 */       Int2IntOpenCustomHashMap.this.size -= 1;
...
/* 418 */       return Integer.valueOf(Int2IntOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public int getIntKey() {
/* 421 */       return Int2IntOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Integer getValue() {
/* 424 */       return Integer.valueOf(Int2IntOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public int getIntValue() {
/* 427 */       return Int2IntOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public int setValue(int v) {
/* 430 */       int oldValue = Int2IntOpenCustomHashMap.this.value[this.index];
/* 431 */       Int2IntOpenCustomHashMap.this.value[this.index] = v;
/* 432 */       return oldValue;
/*     */     }
...
/* 441 */       return (Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue())) && (Int2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */     public int hashCode() {
/* 444 */       return Int2IntOpenCustomHashMap.this.strategy.hashCode(Int2IntOpenCustomHashMap.this.key[this.index]) ^ Int2IntOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 447 */       return Int2IntOpenCustomHashMap.this.key[this.index] + "=>" + Int2IntOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
