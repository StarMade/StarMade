  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2IntOpenCustomHashMap(int expected, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2IntOpenCustomHashMap(Map<? extends Integer, ? extends Integer> local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2IntOpenCustomHashMap(Map<? extends Integer, ? extends Integer> local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2IntOpenCustomHashMap(Int2IntMap local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2IntOpenCustomHashMap(Int2IntMap local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2IntOpenCustomHashMap(int[] local_k, int[] local_v, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2IntOpenCustomHashMap(int[] local_k, int[] local_v, IntHash.Strategy strategy)
  {
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Int2IntOpenCustomHashMap.ValueIterator(Int2IntOpenCustomHashMap.this);
        }
        ...
        {
          return Int2IntOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2IntOpenCustomHashMap local_c;
    try
    {
      local_c = (Int2IntOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2IntOpenCustomHashMap.MapIterator
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2IntOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSet
  {
    ...
    public IntIterator iterator()
    {
      return new Int2IntOpenCustomHashMap.KeyIterator(Int2IntOpenCustomHashMap.this);
    }
    ...
    {
      return Int2IntOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2IntOpenCustomHashMap.this.size;
      Int2IntOpenCustomHashMap.this.remove(local_k);
    ...
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2IntOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2IntMap.FastEntrySet
  {
    ...
    {
      return new Int2IntOpenCustomHashMap.EntryIterator(Int2IntOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Int2IntMap.Entry> fastIterator()
    {
      return new Int2IntOpenCustomHashMap.FastEntryIterator(Int2IntOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2IntOpenCustomHashMap.this.mask; Int2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask) {
        if (Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[pos], local_k)) {
          return Int2IntOpenCustomHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2IntOpenCustomHashMap.this.mask; Int2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask) {
        if (Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[pos], local_k))
        {
          Int2IntOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2IntMap.Entry>
  {
    ...
    public AbstractInt2IntMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2IntOpenCustomHashMap.this.key[local_e];
      this.entry.value = Int2IntOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2IntMap.Entry>
  {
    ...
    {
      return this.entry = new Int2IntOpenCustomHashMap.MapEntry(Int2IntOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2IntOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2043 = Int2IntOpenCustomHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2IntOpenCustomHashMap.this.used;
      while ((this.field_2043 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2043 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2043 != 0)
      {
        boolean[] local_k = Int2IntOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2IntOpenCustomHashMap.this.mask; Int2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2IntOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2IntOpenCustomHashMap.this.strategy.hashCode(Int2IntOpenCustomHashMap.this.key[pos])) & Int2IntOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2IntOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Int2IntOpenCustomHashMap.this.key[pos]);
        }
        Int2IntOpenCustomHashMap.this.key[last] = Int2IntOpenCustomHashMap.this.key[pos];
        Int2IntOpenCustomHashMap.this.value[last] = Int2IntOpenCustomHashMap.this.value[pos];
      }
      Int2IntOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Int2IntOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
        this.last = -1;
        return;
      }
      Int2IntOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2043 > 0))
      {
        this.field_2043 += 1;
        nextEntry();
      }
    ...
    implements Int2IntMap.Entry, Map.Entry<Integer, Integer>
  {
    ...
    public int setValue(int local_v)
    {
      ...
      Int2IntOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Integer> local_e = (Map.Entry)local_o;
      return (Int2IntOpenCustomHashMap.this.strategy.equals(Int2IntOpenCustomHashMap.this.key[this.index], ((Integer)local_e.getKey()).intValue())) && (Int2IntOpenCustomHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
