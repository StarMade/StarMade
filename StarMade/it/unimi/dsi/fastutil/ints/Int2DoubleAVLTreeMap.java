...
/*      */ 
/*      */ public class Int2DoubleAVLTreeMap extends AbstractInt2DoubleSortedMap
...
/*      */   protected volatile transient ObjectSortedSet<Int2DoubleMap.Entry> entries;
...
/*  117 */           return Int2DoubleAVLTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  120 */           return Int2DoubleAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     double oldValue = put(ok.intValue(), ov.doubleValue());
/*  780 */     return this.modified ? null : Double.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Double remove(Object ok)
/*      */   {
/*  788 */     double oldValue = remove(((Integer)ok).intValue());
...
/* 1203 */         final Comparator<? super Int2DoubleMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2DoubleMap.Entry x, Int2DoubleMap.Entry y) {
/* 1205 */             return Int2DoubleAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Int2DoubleAVLTreeMap.EntryIterator(Int2DoubleAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from) {
/* 1215 */           return new Int2DoubleAVLTreeMap.EntryIterator(Int2DoubleAVLTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1228 */           Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1229 */           if (f != null) Int2DoubleAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Int2DoubleAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Int2DoubleAVLTreeMap.this.clear(); } 
/* 1234 */         public Int2DoubleMap.Entry first() { return Int2DoubleAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Int2DoubleMap.Entry last() { return Int2DoubleAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) { return Int2DoubleAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2DoubleEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry to) { return Int2DoubleAVLTreeMap.this.headMap((Integer)to.getKey()).int2DoubleEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from) { return Int2DoubleAVLTreeMap.this.tailMap((Integer)from.getKey()).int2DoubleEntrySet(); }
/*      */       };
...
/* 1304 */           return new Int2DoubleAVLTreeMap.ValueIterator(Int2DoubleAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(double k) {
/* 1307 */           return Int2DoubleAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Int2DoubleAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Int2DoubleAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Int2DoubleAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readInt(), s.readDouble());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readInt(), s.readDouble());
/* 1759 */       top.right(new Entry(s.readInt(), s.readDouble()));
...
/*      */   }
/*      */ 
/*      */   private final class Submap extends AbstractInt2DoubleSortedMap
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Int2DoubleAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Int2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Int2DoubleAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2DoubleAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Int2DoubleMap.Entry> int2DoubleEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator() {
/* 1391 */             return new Int2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Int2DoubleAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2DoubleMap.Entry> iterator(Int2DoubleMap.Entry from) {
/* 1394 */             return new Int2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Int2DoubleAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1396 */           public Comparator<? super Int2DoubleMap.Entry> comparator() { return Int2DoubleAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1402 */             return (f != null) && (Int2DoubleAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Int2DoubleAVLTreeMap.Entry f = Int2DoubleAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1409 */             if ((f != null) && (Int2DoubleAVLTreeMap.Submap.this.in(f.key))) Int2DoubleAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Int2DoubleAVLTreeMap.Submap.SubmapIterator(Int2DoubleAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Int2DoubleAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Int2DoubleMap.Entry first() { return Int2DoubleAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Int2DoubleMap.Entry last() { return Int2DoubleAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Int2DoubleMap.Entry> subSet(Int2DoubleMap.Entry from, Int2DoubleMap.Entry to) { return Int2DoubleAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2DoubleEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Int2DoubleMap.Entry> headSet(Int2DoubleMap.Entry to) { return Int2DoubleAVLTreeMap.Submap.this.headMap((Integer)to.getKey()).int2DoubleEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Int2DoubleMap.Entry> tailSet(Int2DoubleMap.Entry from) { return Int2DoubleAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2DoubleEntrySet(); }
/*      */         };
...
/*      */           public DoubleIterator iterator() {
/* 1442 */             return new Int2DoubleAVLTreeMap.Submap.SubmapValueIterator(Int2DoubleAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(double k) {
/* 1445 */             return Int2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Int2DoubleAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Int2DoubleAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1458 */       return (in(k)) && (Int2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(double v) {
...
/* 1473 */       return (in(kk)) && ((e = Int2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public double put(int k, double v) {
/* 1476 */       Int2DoubleAVLTreeMap.this.modified = false;
...
/* 1478 */       double oldValue = Int2DoubleAVLTreeMap.this.put(k, v);
/* 1479 */       return Int2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Double put(Integer ok, Double ov) {
/* 1482 */       double oldValue = put(ok.intValue(), ov.doubleValue());
/* 1483 */       return Int2DoubleAVLTreeMap.this.modified ? null : Double.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public double remove(int k) {
/* 1487 */       Int2DoubleAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       double oldValue = Int2DoubleAVLTreeMap.this.remove(k);
/* 1490 */       return Int2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Double remove(Object ok) {
/* 1493 */       double oldValue = remove(((Integer)ok).intValue());
/* 1494 */       return Int2DoubleAVLTreeMap.this.modified ? Double.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1509 */       return Int2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2DoubleSortedMap headMap(int to) {
/* 1512 */       if (this.top) return new Submap(Int2DoubleAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Int2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2DoubleAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2DoubleSortedMap tailMap(int from) {
/* 1516 */       if (this.bottom) return new Submap(Int2DoubleAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Int2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2DoubleAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2DoubleSortedMap subMap(int from, int to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Int2DoubleAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Int2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Int2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Int2DoubleAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2DoubleAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Int2DoubleAVLTreeMap.this.tree == null) return null;
/* 1534 */       Int2DoubleAVLTreeMap.Entry e;
/*      */       Int2DoubleAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Int2DoubleAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Int2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Int2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Int2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2DoubleAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Int2DoubleAVLTreeMap.this.tree == null) return null;
/* 1552 */       Int2DoubleAVLTreeMap.Entry e;
/*      */       Int2DoubleAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Int2DoubleAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Int2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Int2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Int2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1563 */       Int2DoubleAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1568 */       Int2DoubleAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1573 */       Int2DoubleAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1578 */       Int2DoubleAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2DoubleAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2DoubleAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2DoubleAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Int2DoubleMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Int2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Int2DoubleAVLTreeMap.Submap.this.bottom) && (Int2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Int2DoubleAVLTreeMap.Submap.this.top) && (Int2DoubleAVLTreeMap.this.compare(k, (this.prev = Int2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Int2DoubleAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Int2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Int2DoubleAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2DoubleAVLTreeMap.this.compare(this.prev.key, Int2DoubleAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Int2DoubleAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2DoubleAVLTreeMap.this.compare(this.next.key, Int2DoubleAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public IntBidirectionalIterator iterator() { return new Int2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Int2DoubleAVLTreeMap.Submap.this); } 
/* 1433 */       public IntBidirectionalIterator iterator(int from) { return new Int2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Int2DoubleAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2DoubleAVLTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public IntBidirectionalIterator iterator() { return new Int2DoubleAVLTreeMap.KeyIterator(Int2DoubleAVLTreeMap.this); } 
/* 1263 */     public IntBidirectionalIterator iterator(int from) { return new Int2DoubleAVLTreeMap.KeyIterator(Int2DoubleAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2DoubleAVLTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2DoubleAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2DoubleMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Int2DoubleMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Int2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Int2DoubleAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1129 */       if ((this.next = Int2DoubleAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Int2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Int2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */     implements Cloneable, Int2DoubleMap.Entry
/*      */   {
...
/*      */ 
/* 1038 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
