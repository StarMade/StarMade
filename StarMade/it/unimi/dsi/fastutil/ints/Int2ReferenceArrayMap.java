...
/*     */ 
/*     */ public class Int2ReferenceArrayMap<V> extends AbstractInt2ReferenceMap<V>
...
/*     */     try
/*     */     {
/* 300 */       c = (Int2ReferenceArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>>
...
/* 130 */         int next = 0;
/*     */ 
/* 132 */         public boolean hasNext() { return this.next < Int2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Int2ReferenceMap.Entry<V> next()
/*     */         {
/* 136 */           if (!hasNext()) throw new NoSuchElementException();
/* 137 */           return new AbstractInt2ReferenceMap.BasicEntry(Int2ReferenceArrayMap.this.key[this.next], Int2ReferenceArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 143 */         int next = 0;
/* 144 */         final AbstractInt2ReferenceMap.BasicEntry<V> entry = new AbstractInt2ReferenceMap.BasicEntry(0, null);
/*     */ 
/* 146 */         public boolean hasNext() { return this.next < Int2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Int2ReferenceMap.Entry<V> next()
/*     */         {
/* 150 */           if (!hasNext()) throw new NoSuchElementException();
/* 151 */           this.entry.key = Int2ReferenceArrayMap.this.key[this.next];
/* 152 */           this.entry.value = Int2ReferenceArrayMap.this.value[(this.next++)];
/* 153 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 158 */       return Int2ReferenceArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 165 */       return (Int2ReferenceArrayMap.this.containsKey(k)) && (Int2ReferenceArrayMap.this.get(k) == e.getValue());
/*     */     }
/*     */   }
/*     */ }
