...
/*  18:    */
/*  90:    */public class Int2ByteOpenCustomHashMap
/*  91:    */  extends AbstractInt2ByteMap
...
/* 104:    */  protected volatile transient Int2ByteMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Int2ByteOpenCustomHashMap(int expected, float f, IntHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Int2ByteOpenCustomHashMap(int expected, IntHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Int2ByteOpenCustomHashMap(IntHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Int2ByteOpenCustomHashMap(Map<? extends Integer, ? extends Byte> m, float f, IntHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Int2ByteOpenCustomHashMap(Map<? extends Integer, ? extends Byte> m, IntHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Int2ByteOpenCustomHashMap(Int2ByteMap m, float f, IntHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Int2ByteOpenCustomHashMap(Int2ByteMap m, IntHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Int2ByteOpenCustomHashMap(int[] k, byte[] v, float f, IntHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Int2ByteOpenCustomHashMap(int[] k, byte[] v, IntHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public byte put(int k, byte v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Byte put(Integer ok, Byte ov) { byte v = ov.byteValue();
...
/* 246:    */  }
/* 247:    */  
/* 258:    */  public byte add(int k, byte incr)
/* 259:    */  {
...
/* 332:    */  }
/* 333:    */  
/* 334:334 */  public Byte get(Integer ok) { int k = ok.intValue();
/* 335:    */    
...
/* 409:    */    implements Int2ByteMap.Entry, Map.Entry<Integer, Byte>
/* 410:    */  {
...
/* 416:    */    }
/* 417:    */    
/* 418:418 */    public Integer getKey() { return Integer.valueOf(Int2ByteOpenCustomHashMap.this.key[this.index]); }
/* 419:    */    
/* 420:    */    public int getIntKey() {
/* 421:421 */      return Int2ByteOpenCustomHashMap.this.key[this.index];
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public Byte getValue() { return Byte.valueOf(Int2ByteOpenCustomHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public byte getByteValue() { return Int2ByteOpenCustomHashMap.this.value[this.index]; }
/* 428:    */    
/* 429:    */    public byte setValue(byte v) {
/* 430:430 */      byte oldValue = Int2ByteOpenCustomHashMap.this.value[this.index];
/* 431:431 */      Int2ByteOpenCustomHashMap.this.value[this.index] = v;
...
/* 440:440 */      Map.Entry<Integer, Byte> e = (Map.Entry)o;
/* 441:441 */      return (Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue())) && (Int2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/* 442:    */    }
/* 443:    */    
/* 444:444 */    public int hashCode() { return Int2ByteOpenCustomHashMap.this.strategy.hashCode(Int2ByteOpenCustomHashMap.this.key[this.index]) ^ Int2ByteOpenCustomHashMap.this.value[this.index]; }
/* 445:    */    
/* 447:447 */    public String toString() { return Int2ByteOpenCustomHashMap.this.key[this.index] + "=>" + Int2ByteOpenCustomHashMap.this.value[this.index]; } }
/* 448:    */  
...
/* 453:    */    
/* 454:454 */    private MapIterator() { this.pos = Int2ByteOpenCustomHashMap.this.n;
/* 455:    */      
/* 457:457 */      this.last = -1;
/* 458:    */      
/* 459:459 */      this.c = Int2ByteOpenCustomHashMap.this.size;
/* 460:    */      
/* 464:464 */      boolean[] used = Int2ByteOpenCustomHashMap.this.used;
...
/* 476:    */        
/* 477:477 */        int pos = HashCommon.murmurHash3(Int2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ByteOpenCustomHashMap.this.mask;
/* 478:    */        
/* 479:479 */        while (Int2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 480:480 */          if (Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481:481 */          pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask;
/* 482:    */        }
/* 483:    */      }
/* 484:484 */      this.last = this.pos;
/* 485:    */      
/* 486:486 */      if (this.c != 0) {
/* 487:487 */        boolean[] used = Int2ByteOpenCustomHashMap.this.used;
...
/* 502:    */      for (;;)
/* 503:    */      {
/* 504:504 */        pos = (last = pos) + 1 & Int2ByteOpenCustomHashMap.this.mask;
/* 505:505 */        while (Int2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 506:506 */          int slot = HashCommon.murmurHash3(Int2ByteOpenCustomHashMap.this.strategy.hashCode(Int2ByteOpenCustomHashMap.this.key[pos])) & Int2ByteOpenCustomHashMap.this.mask;
/* 507:507 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508:508 */          pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask;
/* 509:    */        }
/* 510:510 */        if (Int2ByteOpenCustomHashMap.this.used[pos] == 0) break;
/* 511:511 */        if (pos < last)
/* 512:    */        {
/* 513:513 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 514:514 */          this.wrapped.add(Int2ByteOpenCustomHashMap.this.key[pos]);
/* 515:    */        }
/* 516:516 */        Int2ByteOpenCustomHashMap.this.key[last] = Int2ByteOpenCustomHashMap.this.key[pos];
/* 517:517 */        Int2ByteOpenCustomHashMap.this.value[last] = Int2ByteOpenCustomHashMap.this.value[pos];
/* 518:    */      }
/* 519:519 */      Int2ByteOpenCustomHashMap.this.used[last] = false;
/* 520:520 */      return last;
/* 521:    */    }
/* 522:    */    
...
/* 526:    */      {
/* 527:527 */        Int2ByteOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 528:528 */        this.last = -1;
/* 529:529 */        return;
/* 530:    */      }
/* 531:531 */      Int2ByteOpenCustomHashMap.this.size -= 1;
...
/* 543:    */    } }
/* 544:    */  
/* 545:545 */  private class EntryIterator extends Int2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Int2ByteMap.Entry> { private EntryIterator() { super(null); }
/* 546:    */    
/* 547:    */    private Int2ByteOpenCustomHashMap.MapEntry entry;
/* 548:548 */    public Int2ByteMap.Entry next() { return this.entry = new Int2ByteOpenCustomHashMap.MapEntry(Int2ByteOpenCustomHashMap.this, nextEntry()); }
/* 549:    */    
/* 550:    */    public void remove()
/* 551:    */    {
/* 552:552 */      super.remove();
/* 553:553 */      Int2ByteOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 554:    */    } }
/* 555:    */  
/* 556:556 */  private class FastEntryIterator extends Int2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Int2ByteMap.Entry> { private FastEntryIterator() { super(null); }
/* 557:557 */    final AbstractInt2ByteMap.BasicEntry entry = new AbstractInt2ByteMap.BasicEntry(0, (byte)0);
/* 558:    */    
/* 559:559 */    public AbstractInt2ByteMap.BasicEntry next() { int e = nextEntry();
/* 560:560 */      this.entry.key = Int2ByteOpenCustomHashMap.this.key[e];
/* 561:561 */      this.entry.value = Int2ByteOpenCustomHashMap.this.value[e];
/* 562:562 */      return this.entry;
/* 563:    */    } }
/* 564:    */  
/* 565:    */  private final class MapEntrySet extends AbstractObjectSet<Int2ByteMap.Entry> implements Int2ByteMap.FastEntrySet { private MapEntrySet() {}
/* 566:    */    
/* 567:567 */    public ObjectIterator<Int2ByteMap.Entry> iterator() { return new Int2ByteOpenCustomHashMap.EntryIterator(Int2ByteOpenCustomHashMap.this, null); }
/* 568:    */    
/* 569:    */    public ObjectIterator<Int2ByteMap.Entry> fastIterator() {
/* 570:570 */      return new Int2ByteOpenCustomHashMap.FastEntryIterator(Int2ByteOpenCustomHashMap.this, null);
/* 571:    */    }
/* 572:    */    
/* 573:    */    public boolean contains(Object o) {
/* 574:574 */      if (!(o instanceof Map.Entry)) return false;
/* 575:575 */      Map.Entry<Integer, Byte> e = (Map.Entry)o;
/* 576:576 */      int k = ((Integer)e.getKey()).intValue();
/* 577:    */      
/* 578:578 */      int pos = HashCommon.murmurHash3(Int2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ByteOpenCustomHashMap.this.mask;
/* 579:    */      
/* 580:580 */      while (Int2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 581:581 */        if (Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[pos], k)) return Int2ByteOpenCustomHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 582:582 */        pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask;
/* 583:    */      }
...
/* 589:589 */      Map.Entry<Integer, Byte> e = (Map.Entry)o;
/* 590:590 */      int k = ((Integer)e.getKey()).intValue();
/* 591:    */      
/* 592:592 */      int pos = HashCommon.murmurHash3(Int2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ByteOpenCustomHashMap.this.mask;
/* 593:    */      
/* 594:594 */      while (Int2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 595:595 */        if (Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[pos], k)) {
/* 596:596 */          Int2ByteOpenCustomHashMap.this.remove(e.getKey());
/* 597:597 */          return true;
/* 598:    */        }
/* 599:599 */        pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask;
/* 600:    */      }
/* 601:601 */      return false;
/* 602:    */    }
/* 603:    */    
/* 604:604 */    public int size() { return Int2ByteOpenCustomHashMap.this.size; }
/* 605:    */    
/* 607:607 */    public void clear() { Int2ByteOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
/* 610:    */  public Int2ByteMap.FastEntrySet int2ByteEntrySet() {
...
/* 618:    */    extends Int2ByteOpenCustomHashMap.MapIterator
/* 619:    */    implements IntIterator
/* 620:    */  {
/* 621:621 */    public KeyIterator() { super(null); }
/* 622:622 */    public int nextInt() { return Int2ByteOpenCustomHashMap.this.key[nextEntry()]; }
/* 623:623 */    public Integer next() { return Integer.valueOf(Int2ByteOpenCustomHashMap.this.key[nextEntry()]); } }
/* 624:    */  
/* 625:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 626:    */    
/* 627:627 */    public IntIterator iterator() { return new Int2ByteOpenCustomHashMap.KeyIterator(Int2ByteOpenCustomHashMap.this); }
/* 628:    */    
/* 629:    */    public int size() {
/* 630:630 */      return Int2ByteOpenCustomHashMap.this.size;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    public boolean contains(int k) { return Int2ByteOpenCustomHashMap.this.containsKey(k); }
/* 634:    */    
/* 635:    */    public boolean remove(int k) {
/* 636:636 */      int oldSize = Int2ByteOpenCustomHashMap.this.size;
/* 637:637 */      Int2ByteOpenCustomHashMap.this.remove(k);
/* 638:638 */      return Int2ByteOpenCustomHashMap.this.size != oldSize;
/* 639:    */    }
/* 640:    */    
/* 641:641 */    public void clear() { Int2ByteOpenCustomHashMap.this.clear(); }
/* 642:    */  }
/* 643:    */  
...
/* 652:    */    extends Int2ByteOpenCustomHashMap.MapIterator
/* 653:    */    implements ByteIterator
/* 654:    */  {
/* 655:655 */    public ValueIterator() { super(null); }
/* 656:656 */    public byte nextByte() { return Int2ByteOpenCustomHashMap.this.value[nextEntry()]; }
/* 657:657 */    public Byte next() { return Byte.valueOf(Int2ByteOpenCustomHashMap.this.value[nextEntry()]); }
/* 658:    */  }
/* 659:    */  
...
/* 662:662 */          return new Int2ByteOpenCustomHashMap.ValueIterator(Int2ByteOpenCustomHashMap.this);
/* 663:    */        }
/* 664:    */        
/* 665:665 */        public int size() { return Int2ByteOpenCustomHashMap.this.size; }
/* 666:    */        
/* 667:    */        public boolean contains(byte v) {
/* 668:668 */          return Int2ByteOpenCustomHashMap.this.containsValue(v);
/* 669:    */        }
/* 670:    */        
/* 671:671 */        public void clear() { Int2ByteOpenCustomHashMap.this.clear(); }
/* 672:    */      };
/* 673:    */    }
...
/* 774:    */  }
/* 775:    */  
/* 779:    */  public Int2ByteOpenCustomHashMap clone()
/* 780:    */  {
/* 781:    */    Int2ByteOpenCustomHashMap c;
/* 782:    */    
/* 784:    */    try
/* 785:    */    {
/* 786:786 */      c = (Int2ByteOpenCustomHashMap)super.clone();
/* 787:    */    }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.ints.Int2ByteOpenCustomHashMap
