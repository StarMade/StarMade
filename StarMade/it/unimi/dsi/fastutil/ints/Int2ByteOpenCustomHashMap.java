  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2ByteOpenCustomHashMap(int expected, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2ByteOpenCustomHashMap(Map<? extends Integer, ? extends Byte> local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2ByteOpenCustomHashMap(Map<? extends Integer, ? extends Byte> local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2ByteOpenCustomHashMap(Int2ByteMap local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2ByteOpenCustomHashMap(Int2ByteMap local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2ByteOpenCustomHashMap(int[] local_k, byte[] local_v, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2ByteOpenCustomHashMap(int[] local_k, byte[] local_v, IntHash.Strategy strategy)
  {
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Int2ByteOpenCustomHashMap.ValueIterator(Int2ByteOpenCustomHashMap.this);
        }
        ...
        {
          return Int2ByteOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2ByteOpenCustomHashMap local_c;
    try
    {
      local_c = (Int2ByteOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2ByteOpenCustomHashMap.MapIterator
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Int2ByteOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSet
  {
    ...
    {
      return new Int2ByteOpenCustomHashMap.KeyIterator(Int2ByteOpenCustomHashMap.this);
    }
    ...
    {
      return Int2ByteOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2ByteOpenCustomHashMap.this.size;
      Int2ByteOpenCustomHashMap.this.remove(local_k);
    ...
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2ByteOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2ByteMap.FastEntrySet
  {
    ...
    {
      return new Int2ByteOpenCustomHashMap.EntryIterator(Int2ByteOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Int2ByteMap.Entry> fastIterator()
    {
      return new Int2ByteOpenCustomHashMap.FastEntryIterator(Int2ByteOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2ByteOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2ByteOpenCustomHashMap.this.mask; Int2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask) {
        if (Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[pos], local_k)) {
          return Int2ByteOpenCustomHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2ByteOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2ByteOpenCustomHashMap.this.mask; Int2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask) {
        if (Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[pos], local_k))
        {
          Int2ByteOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2ByteMap.Entry>
  {
    ...
    public AbstractInt2ByteMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2ByteOpenCustomHashMap.this.key[local_e];
      this.entry.value = Int2ByteOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2ByteMap.Entry>
  {
    ...
    {
      return this.entry = new Int2ByteOpenCustomHashMap.MapEntry(Int2ByteOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2ByteOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2ByteOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1734 = Int2ByteOpenCustomHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2ByteOpenCustomHashMap.this.used;
      while ((this.field_1734 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1734 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1734 != 0)
      {
        boolean[] local_k = Int2ByteOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2ByteOpenCustomHashMap.this.mask; Int2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ByteOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2ByteOpenCustomHashMap.this.strategy.hashCode(Int2ByteOpenCustomHashMap.this.key[pos])) & Int2ByteOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2ByteOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Int2ByteOpenCustomHashMap.this.key[pos]);
        }
        Int2ByteOpenCustomHashMap.this.key[last] = Int2ByteOpenCustomHashMap.this.key[pos];
        Int2ByteOpenCustomHashMap.this.value[last] = Int2ByteOpenCustomHashMap.this.value[pos];
      }
      Int2ByteOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Int2ByteOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
        this.last = -1;
        return;
      }
      Int2ByteOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1734 > 0))
      {
        this.field_1734 += 1;
        nextEntry();
      }
    ...
    implements Int2ByteMap.Entry, Map.Entry<Integer, Byte>
  {
    ...
    public byte setValue(byte local_v)
    {
      ...
      Int2ByteOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Byte> local_e = (Map.Entry)local_o;
      return (Int2ByteOpenCustomHashMap.this.strategy.equals(Int2ByteOpenCustomHashMap.this.key[this.index], ((Integer)local_e.getKey()).intValue())) && (Int2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
