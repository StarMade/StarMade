...
/*  17:    */
/*  66:    */public class Int2LongArrayMap
/*  67:    */  extends AbstractInt2LongMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Int2LongArrayMap(int[] key, long[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Int2LongArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = IntArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = LongArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Int2LongArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new int[capacity];
/*  94: 94 */    this.value = new long[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Int2LongArrayMap(Int2LongMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Int2LongArrayMap(Map<? extends Integer, ? extends Long> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Int2LongArrayMap(int[] key, long[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Int2LongMap.Entry> implements Int2LongMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Int2LongMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Int2LongArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Int2LongMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractInt2LongMap.BasicEntry(Int2LongArrayMap.this.key[this.next], Int2LongArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Int2LongMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractInt2LongMap.BasicEntry entry = new AbstractInt2LongMap.BasicEntry(0, 0L);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Int2LongArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Int2LongMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Int2LongArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Int2LongArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Int2LongArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Integer, Long> e = (Map.Entry)o;
/* 165:165 */      int k = ((Integer)e.getKey()).intValue();
/* 166:166 */      return (Int2LongArrayMap.this.containsKey(k)) && (Int2LongArrayMap.this.get(k) == ((Long)e.getValue()).longValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Int2LongMap.FastEntrySet int2LongEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public long put(int k, long v)
/* 213:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Int2LongArrayMap clone()
/* 263:    */  {
/* 264:    */    Int2LongArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Int2LongArrayMap)super.clone();
/* 270:    */    }
