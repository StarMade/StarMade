...
/*     */ 
/*     */ public class Int2LongArrayMap extends AbstractInt2LongMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Int2LongArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Int2LongMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Int2LongArrayMap.this.size; }
/*     */ 
/*     */         public Int2LongMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractInt2LongMap.BasicEntry(Int2LongArrayMap.this.key[this.next], Int2LongArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractInt2LongMap.BasicEntry entry = new AbstractInt2LongMap.BasicEntry(0, 0L);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Int2LongArrayMap.this.size; }
/*     */ 
/*     */         public Int2LongMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Int2LongArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Int2LongArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Int2LongArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Int2LongArrayMap.this.containsKey(k)) && (Int2LongArrayMap.this.get(k) == ((Long)e.getValue()).longValue());
/*     */     }
/*     */   }
/*     */ }
