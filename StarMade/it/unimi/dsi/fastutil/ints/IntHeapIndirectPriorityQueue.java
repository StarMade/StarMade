  ...
  extends IntHeapSemiIndirectPriorityQueue
{
  ...
  public IntHeapIndirectPriorityQueue(int[] refArray, int capacity, IntComparator local_c)
  {
  ...
  public IntHeapIndirectPriorityQueue(int[] refArray, IntComparator local_c)
  {
  ...
  public IntHeapIndirectPriorityQueue(int[] refArray, int[] local_a, int size, IntComparator local_c)
  {
    ...
    IntIndirectHeaps.makeHeap(refArray, local_a, this.inv, size, local_c);
  }
  
  public IntHeapIndirectPriorityQueue(int[] refArray, int[] local_a, IntComparator local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public IntHeapIndirectPriorityQueue(int[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public IntHeapIndirectPriorityQueue(int[] refArray, int[] local_a)
  {
  ...
  public void enqueue(int local_x)
  {
    ...
    IntIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, this.size - 1, this.field_69);
  }
  ...
  public int dequeue()
  {
    ...
    this.inv[result] = -1;
    if (this.size != 0) {
      IntIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.field_69);
    }
    return result;
  }
  ...
  public void changed(int index)
  {
    ...
    int newPos = IntIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, pos, this.field_69);
    IntIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.field_69);
  }
  
  public void allChanged()
  {
    IntIndirectHeaps.makeHeap(this.refArray, this.heap, this.inv, this.size, this.field_69);
  }
  ...
  public boolean remove(int index)
  {
    ...
    if (result < --this.size)
    {
      ...
      int newPos = IntIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, result, this.field_69);
      IntIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.field_69);
    }
    return true;
  }
