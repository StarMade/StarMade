  ...
  implements Serializable, Cloneable
{
  ...
  public Int2BooleanArrayMap(Int2BooleanMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Int2BooleanArrayMap(Map<? extends Integer, ? extends Boolean> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Int2BooleanArrayMap local_c;
    try
    {
      local_c = (Int2BooleanArrayMap)super.clone();
    }
    ...
    implements Int2BooleanMap.FastEntrySet
  {
    ...
    public ObjectIterator<Int2BooleanMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Int2BooleanMap.Entry next()
        {
          ...
          return new AbstractInt2BooleanMap.BasicEntry(Int2BooleanArrayMap.this.key[this.next], Int2BooleanArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Int2BooleanMap.Entry> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Int2BooleanMap.Entry next()
        {
          ...
          this.entry.key = Int2BooleanArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Int2BooleanArrayMap.this.containsKey(local_k)) && (Int2BooleanArrayMap.this.get(local_k) == ((Boolean)local_e.getValue()).booleanValue());
    }
  }
}
