...
/*  17:    */
/*  66:    */public class Int2BooleanArrayMap
/*  67:    */  extends AbstractInt2BooleanMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Int2BooleanArrayMap(int[] key, boolean[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Int2BooleanArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = IntArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = BooleanArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Int2BooleanArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new int[capacity];
/*  94: 94 */    this.value = new boolean[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Int2BooleanArrayMap(Int2BooleanMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Int2BooleanArrayMap(Map<? extends Integer, ? extends Boolean> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Int2BooleanArrayMap(int[] key, boolean[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Int2BooleanMap.Entry> implements Int2BooleanMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Int2BooleanMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Int2BooleanArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Int2BooleanMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractInt2BooleanMap.BasicEntry(Int2BooleanArrayMap.this.key[this.next], Int2BooleanArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Int2BooleanMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractInt2BooleanMap.BasicEntry entry = new AbstractInt2BooleanMap.BasicEntry(0, false);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Int2BooleanArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Int2BooleanMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Int2BooleanArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Int2BooleanArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Int2BooleanArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Integer, Boolean> e = (Map.Entry)o;
/* 165:165 */      int k = ((Integer)e.getKey()).intValue();
/* 166:166 */      return (Int2BooleanArrayMap.this.containsKey(k)) && (Int2BooleanArrayMap.this.get(k) == ((Boolean)e.getValue()).booleanValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Int2BooleanMap.FastEntrySet int2BooleanEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public boolean put(int k, boolean v)
/* 213:    */  {
...
/* 234:    */  }
/* 235:    */  
/* 236:    */  public boolean remove(int k)
/* 237:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Int2BooleanArrayMap clone()
/* 263:    */  {
/* 264:    */    Int2BooleanArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Int2BooleanArrayMap)super.clone();
/* 270:    */    }
