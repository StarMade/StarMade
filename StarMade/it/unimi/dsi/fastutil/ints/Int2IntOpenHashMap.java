...
/*  15:    */
/*  87:    */public class Int2IntOpenHashMap
/*  88:    */  extends AbstractInt2IntMap
...
/* 101:    */  protected volatile transient Int2IntMap.FastEntrySet entries;
/* 102:    */  protected volatile transient IntSet keys;
/* 103:    */  protected volatile transient IntCollection values;
/* 104:    */  
/* 105:    */  public Int2IntOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Int2IntOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Int2IntOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Int2IntOpenHashMap(Map<? extends Integer, ? extends Integer> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Int2IntOpenHashMap(Map<? extends Integer, ? extends Integer> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Int2IntOpenHashMap(Int2IntMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Int2IntOpenHashMap(Int2IntMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Int2IntOpenHashMap(int[] k, int[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Int2IntOpenHashMap(int[] k, int[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public int put(int k, int v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Integer put(Integer ok, Integer ov) { int v = ov.intValue();
...
/* 226:    */  }
/* 227:    */  
/* 238:    */  public int add(int k, int incr)
/* 239:    */  {
...
/* 312:    */  }
/* 313:    */  
/* 314:314 */  public Integer get(Integer ok) { int k = ok.intValue();
/* 315:    */    
...
/* 389:    */    implements Int2IntMap.Entry, Map.Entry<Integer, Integer>
/* 390:    */  {
...
/* 396:    */    }
/* 397:    */    
/* 398:398 */    public Integer getKey() { return Integer.valueOf(Int2IntOpenHashMap.this.key[this.index]); }
/* 399:    */    
/* 400:    */    public int getIntKey() {
/* 401:401 */      return Int2IntOpenHashMap.this.key[this.index];
/* 402:    */    }
/* 403:    */    
/* 404:404 */    public Integer getValue() { return Integer.valueOf(Int2IntOpenHashMap.this.value[this.index]); }
/* 405:    */    
/* 407:407 */    public int getIntValue() { return Int2IntOpenHashMap.this.value[this.index]; }
/* 408:    */    
/* 409:    */    public int setValue(int v) {
/* 410:410 */      int oldValue = Int2IntOpenHashMap.this.value[this.index];
/* 411:411 */      Int2IntOpenHashMap.this.value[this.index] = v;
...
/* 420:420 */      Map.Entry<Integer, Integer> e = (Map.Entry)o;
/* 421:421 */      return (Int2IntOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2IntOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public int hashCode() { return Int2IntOpenHashMap.this.key[this.index] ^ Int2IntOpenHashMap.this.value[this.index]; }
/* 425:    */    
/* 427:427 */    public String toString() { return Int2IntOpenHashMap.this.key[this.index] + "=>" + Int2IntOpenHashMap.this.value[this.index]; } }
/* 428:    */  
...
/* 433:    */    
/* 434:434 */    private MapIterator() { this.pos = Int2IntOpenHashMap.this.n;
/* 435:    */      
/* 437:437 */      this.last = -1;
/* 438:    */      
/* 439:439 */      this.c = Int2IntOpenHashMap.this.size;
/* 440:    */      
/* 444:444 */      boolean[] used = Int2IntOpenHashMap.this.used;
...
/* 456:    */        
/* 457:457 */        int pos = HashCommon.murmurHash3(k) & Int2IntOpenHashMap.this.mask;
/* 458:    */        
/* 459:459 */        while (Int2IntOpenHashMap.this.used[pos] != 0) {
/* 460:460 */          if (Int2IntOpenHashMap.this.key[pos] == k) return pos;
/* 461:461 */          pos = pos + 1 & Int2IntOpenHashMap.this.mask;
/* 462:    */        }
/* 463:    */      }
/* 464:464 */      this.last = this.pos;
/* 465:    */      
/* 466:466 */      if (this.c != 0) {
/* 467:467 */        boolean[] used = Int2IntOpenHashMap.this.used;
...
/* 482:    */      for (;;)
/* 483:    */      {
/* 484:484 */        pos = (last = pos) + 1 & Int2IntOpenHashMap.this.mask;
/* 485:485 */        while (Int2IntOpenHashMap.this.used[pos] != 0) {
/* 486:486 */          int slot = HashCommon.murmurHash3(Int2IntOpenHashMap.this.key[pos]) & Int2IntOpenHashMap.this.mask;
/* 487:487 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488:488 */          pos = pos + 1 & Int2IntOpenHashMap.this.mask;
/* 489:    */        }
/* 490:490 */        if (Int2IntOpenHashMap.this.used[pos] == 0) break;
/* 491:491 */        if (pos < last)
/* 492:    */        {
/* 493:493 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 494:494 */          this.wrapped.add(Int2IntOpenHashMap.this.key[pos]);
/* 495:    */        }
/* 496:496 */        Int2IntOpenHashMap.this.key[last] = Int2IntOpenHashMap.this.key[pos];
/* 497:497 */        Int2IntOpenHashMap.this.value[last] = Int2IntOpenHashMap.this.value[pos];
/* 498:    */      }
/* 499:499 */      Int2IntOpenHashMap.this.used[last] = false;
/* 500:500 */      return last;
/* 501:    */    }
/* 502:    */    
...
/* 506:    */      {
/* 507:507 */        Int2IntOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 508:508 */        this.last = -1;
/* 509:509 */        return;
/* 510:    */      }
/* 511:511 */      Int2IntOpenHashMap.this.size -= 1;
...
/* 523:    */    } }
/* 524:    */  
/* 525:525 */  private class EntryIterator extends Int2IntOpenHashMap.MapIterator implements ObjectIterator<Int2IntMap.Entry> { private EntryIterator() { super(null); }
/* 526:    */    
/* 527:    */    private Int2IntOpenHashMap.MapEntry entry;
/* 528:528 */    public Int2IntMap.Entry next() { return this.entry = new Int2IntOpenHashMap.MapEntry(Int2IntOpenHashMap.this, nextEntry()); }
/* 529:    */    
/* 530:    */    public void remove()
/* 531:    */    {
/* 532:532 */      super.remove();
/* 533:533 */      Int2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 534:    */    } }
/* 535:    */  
/* 536:536 */  private class FastEntryIterator extends Int2IntOpenHashMap.MapIterator implements ObjectIterator<Int2IntMap.Entry> { private FastEntryIterator() { super(null); }
/* 537:537 */    final AbstractInt2IntMap.BasicEntry entry = new AbstractInt2IntMap.BasicEntry(0, 0);
/* 538:    */    
/* 539:539 */    public AbstractInt2IntMap.BasicEntry next() { int e = nextEntry();
/* 540:540 */      this.entry.key = Int2IntOpenHashMap.this.key[e];
/* 541:541 */      this.entry.value = Int2IntOpenHashMap.this.value[e];
/* 542:542 */      return this.entry;
/* 543:    */    } }
/* 544:    */  
/* 545:    */  private final class MapEntrySet extends AbstractObjectSet<Int2IntMap.Entry> implements Int2IntMap.FastEntrySet { private MapEntrySet() {}
/* 546:    */    
/* 547:547 */    public ObjectIterator<Int2IntMap.Entry> iterator() { return new Int2IntOpenHashMap.EntryIterator(Int2IntOpenHashMap.this, null); }
/* 548:    */    
/* 549:    */    public ObjectIterator<Int2IntMap.Entry> fastIterator() {
/* 550:550 */      return new Int2IntOpenHashMap.FastEntryIterator(Int2IntOpenHashMap.this, null);
/* 551:    */    }
/* 552:    */    
/* 553:    */    public boolean contains(Object o) {
/* 554:554 */      if (!(o instanceof Map.Entry)) return false;
/* 555:555 */      Map.Entry<Integer, Integer> e = (Map.Entry)o;
/* 556:556 */      int k = ((Integer)e.getKey()).intValue();
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(k) & Int2IntOpenHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Int2IntOpenHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Int2IntOpenHashMap.this.key[pos] == k) return Int2IntOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 562:562 */        pos = pos + 1 & Int2IntOpenHashMap.this.mask;
/* 563:    */      }
...
/* 569:569 */      Map.Entry<Integer, Integer> e = (Map.Entry)o;
/* 570:570 */      int k = ((Integer)e.getKey()).intValue();
/* 571:    */      
/* 572:572 */      int pos = HashCommon.murmurHash3(k) & Int2IntOpenHashMap.this.mask;
/* 573:    */      
/* 574:574 */      while (Int2IntOpenHashMap.this.used[pos] != 0) {
/* 575:575 */        if (Int2IntOpenHashMap.this.key[pos] == k) {
/* 576:576 */          Int2IntOpenHashMap.this.remove(e.getKey());
/* 577:577 */          return true;
/* 578:    */        }
/* 579:579 */        pos = pos + 1 & Int2IntOpenHashMap.this.mask;
/* 580:    */      }
/* 581:581 */      return false;
/* 582:    */    }
/* 583:    */    
/* 584:584 */    public int size() { return Int2IntOpenHashMap.this.size; }
/* 585:    */    
/* 587:587 */    public void clear() { Int2IntOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public Int2IntMap.FastEntrySet int2IntEntrySet() {
...
/* 598:    */    extends Int2IntOpenHashMap.MapIterator
/* 599:    */    implements IntIterator
/* 600:    */  {
/* 601:601 */    public KeyIterator() { super(null); }
/* 602:602 */    public int nextInt() { return Int2IntOpenHashMap.this.key[nextEntry()]; }
/* 603:603 */    public Integer next() { return Integer.valueOf(Int2IntOpenHashMap.this.key[nextEntry()]); } }
/* 604:    */  
/* 605:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 606:    */    
/* 607:607 */    public IntIterator iterator() { return new Int2IntOpenHashMap.KeyIterator(Int2IntOpenHashMap.this); }
/* 608:    */    
/* 609:    */    public int size() {
/* 610:610 */      return Int2IntOpenHashMap.this.size;
/* 611:    */    }
/* 612:    */    
/* 613:613 */    public boolean contains(int k) { return Int2IntOpenHashMap.this.containsKey(k); }
/* 614:    */    
/* 615:    */    public boolean remove(int k) {
/* 616:616 */      int oldSize = Int2IntOpenHashMap.this.size;
/* 617:617 */      Int2IntOpenHashMap.this.remove(k);
/* 618:618 */      return Int2IntOpenHashMap.this.size != oldSize;
/* 619:    */    }
/* 620:    */    
/* 621:621 */    public void clear() { Int2IntOpenHashMap.this.clear(); }
/* 622:    */  }
/* 623:    */  
...
/* 632:    */    extends Int2IntOpenHashMap.MapIterator
/* 633:    */    implements IntIterator
/* 634:    */  {
/* 635:635 */    public ValueIterator() { super(null); }
/* 636:636 */    public int nextInt() { return Int2IntOpenHashMap.this.value[nextEntry()]; }
/* 637:637 */    public Integer next() { return Integer.valueOf(Int2IntOpenHashMap.this.value[nextEntry()]); }
/* 638:    */  }
/* 639:    */  
...
/* 642:642 */          return new Int2IntOpenHashMap.ValueIterator(Int2IntOpenHashMap.this);
/* 643:    */        }
/* 644:    */        
/* 645:645 */        public int size() { return Int2IntOpenHashMap.this.size; }
/* 646:    */        
/* 647:    */        public boolean contains(int v) {
/* 648:648 */          return Int2IntOpenHashMap.this.containsValue(v);
/* 649:    */        }
/* 650:    */        
/* 651:651 */        public void clear() { Int2IntOpenHashMap.this.clear(); }
/* 652:    */      };
/* 653:    */    }
...
/* 754:    */  }
/* 755:    */  
/* 759:    */  public Int2IntOpenHashMap clone()
/* 760:    */  {
/* 761:    */    Int2IntOpenHashMap c;
/* 762:    */    
/* 764:    */    try
/* 765:    */    {
/* 766:766 */      c = (Int2IntOpenHashMap)super.clone();
/* 767:    */    }
