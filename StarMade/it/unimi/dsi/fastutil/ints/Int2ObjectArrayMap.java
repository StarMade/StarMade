  ...
  implements Serializable, Cloneable
{
  ...
  public Int2ObjectArrayMap(Int2ObjectMap<V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Int2ObjectArrayMap(Map<? extends Integer, ? extends V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Int2ObjectArrayMap<V> local_c;
    try
    {
      local_c = (Int2ObjectArrayMap)super.clone();
    }
    ...
    implements Int2ObjectMap.FastEntrySet<V>
  {
    ...
    public ObjectIterator<Int2ObjectMap.Entry<V>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Int2ObjectMap.Entry<V> next()
        {
          ...
          return new AbstractInt2ObjectMap.BasicEntry(Int2ObjectArrayMap.this.key[this.next], Int2ObjectArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Int2ObjectMap.Entry<V>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Int2ObjectMap.Entry<V> next()
        {
          ...
          this.entry.key = Int2ObjectArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Int2ObjectArrayMap.this.containsKey(local_k)) && (Int2ObjectArrayMap.this.get(local_k) == null ? local_e.getValue() == null : Int2ObjectArrayMap.this.get(local_k).equals(local_e.getValue()));
    }
  }
}
