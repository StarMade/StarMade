...
/*    6:     */
/*   84:     */public class IntArrays
/*   85:     */{
/*   86:     */  public static final long ONEOVERPHI = 106039L;
/*   87:  87 */  public static final int[] EMPTY_ARRAY = new int[0];
/*   88:     */  
...
/*   97:     */  
/*   98:     */  public static int[] ensureCapacity(int[] array, int length)
/*   99:     */  {
/*  100: 100 */    if (length > array.length) {
/*  101: 101 */      int[] t = new int[length];
/*  102:     */      
...
/*  107:     */  }
/*  108:     */  
/*  116:     */  public static int[] ensureCapacity(int[] array, int length, int preserve)
/*  117:     */  {
/*  118: 118 */    if (length > array.length) {
/*  119: 119 */      int[] t = new int[length];
/*  120:     */      
...
/*  176:     */  }
/*  177:     */  
/*  186:     */  public static int[] trim(int[] array, int length)
/*  187:     */  {
/*  188: 188 */    if (length >= array.length) return array;
/*  189: 189 */    int[] t = length == 0 ? EMPTY_ARRAY : new int[length];
/*  190:     */    
/*  191: 191 */    System.arraycopy(array, 0, t, 0, length);
/*  192: 192 */    return t;
/*  193:     */  }
/*  194:     */  
/*  206:     */  public static int[] setLength(int[] array, int length)
/*  207:     */  {
...
/*  211:     */  }
/*  212:     */  
/*  218:     */  public static int[] copy(int[] array, int offset, int length)
/*  219:     */  {
/*  220: 220 */    ensureOffsetLength(array, offset, length);
/*  221: 221 */    int[] a = length == 0 ? EMPTY_ARRAY : new int[length];
/*  222:     */    
/*  223: 223 */    System.arraycopy(array, offset, a, 0, length);
/*  224: 224 */    return a;
/*  225:     */  }
/*  226:     */  
/*  230:     */  public static int[] copy(int[] array)
/*  231:     */  {
/*  232: 232 */    return (int[])array.clone();
/*  233:     */  }
/*  234:     */  
/*  241:     */  public static void fill(int[] array, int value)
/*  242:     */  {
...
/*  246:     */  }
/*  247:     */  
/*  256:     */  public static void fill(int[] array, int from, int to, int value)
/*  257:     */  {
...
/*  262:     */  }
/*  263:     */  
/*  270:     */  public static boolean equals(int[] a1, int[] a2)
/*  271:     */  {
...
/*  276:     */  }
/*  277:     */  
/*  286:     */  public static void ensureFromTo(int[] a, int from, int to)
/*  287:     */  {
/*  288: 288 */    it.unimi.dsi.fastutil.Arrays.ensureFromTo(a.length, from, to);
/*  289:     */  }
/*  290:     */  
/*  299:     */  public static void ensureOffsetLength(int[] a, int offset, int length)
/*  300:     */  {
/*  301: 301 */    it.unimi.dsi.fastutil.Arrays.ensureOffsetLength(a.length, offset, length);
/*  302:     */  }
/*  303:     */  
/*  304:     */  private static void swap(int[] x, int a, int b)
/*  305:     */  {
/*  306: 306 */    int t = x[a];
/*  307: 307 */    x[a] = x[b];
/*  308: 308 */    x[b] = t;
/*  309:     */  }
/*  310:     */  
/*  311: 311 */  private static void vecSwap(int[] x, int a, int b, int n) { for (int i = 0; i < n; b++) { swap(x, a, b);i++;a++;
/*  312:     */    } }
/*  313:     */  
/*  314: 314 */  private static int med3(int[] x, int a, int b, int c, IntComparator comp) { int ab = comp.compare(x[a], x[b]);
...
/*  318:     */  }
/*  319:     */  
/*  320:     */  private static void selectionSort(int[] a, int from, int to, IntComparator comp)
/*  321:     */  {
...
/*  331:     */  }
/*  332:     */  
/*  333: 333 */  private static void insertionSort(int[] a, int from, int to, IntComparator comp) { int i = from; for (;;) { i++; if (i >= to) break;
/*  334: 334 */      int t = a[i];
/*  335: 335 */      int j = i;
/*  336: 336 */      for (int u = a[(j - 1)]; comp.compare(t, u) < 0; u = a[(--j - 1)]) {
/*  337: 337 */        a[j] = u;
/*  338: 338 */        if (from == j - 1) {
/*  339: 339 */          j--;
/*  340: 340 */          break;
...
/*  345:     */  }
/*  346:     */  
/*  347:     */  private static void selectionSort(int[] a, int from, int to) {
...
/*  357:     */  }
/*  358:     */  
/*  359:     */  private static void insertionSort(int[] a, int from, int to) {
/*  360: 360 */    int i = from; for (;;) { i++; if (i >= to) break;
/*  361: 361 */      int t = a[i];
/*  362: 362 */      int j = i;
/*  363: 363 */      for (int u = a[(j - 1)]; t < u; u = a[(--j - 1)]) {
/*  364: 364 */        a[j] = u;
/*  365: 365 */        if (from == j - 1) {
/*  366: 366 */          j--;
/*  367: 367 */          break;
...
/*  372:     */  }
/*  373:     */  
/*  385:     */  public static void quickSort(int[] x, int from, int to, IntComparator comp)
/*  386:     */  {
...
/*  432:     */  }
/*  433:     */  
/*  442:     */  public static void quickSort(int[] x, IntComparator comp)
/*  443:     */  {
/*  444: 444 */    quickSort(x, 0, x.length, comp);
/*  445:     */  }
/*  446:     */  
/*  447:     */  private static int med3(int[] x, int a, int b, int c) {
...
/*  452:     */  }
/*  453:     */  
/*  466:     */  public static void quickSort(int[] x, int from, int to)
/*  467:     */  {
...
/*  513:     */  }
/*  514:     */  
/*  521:     */  public static void quickSort(int[] x)
/*  522:     */  {
/*  523: 523 */    quickSort(x, 0, x.length);
/*  524:     */  }
/*  525:     */  
/*  535:     */  public static void mergeSort(int[] a, int from, int to, int[] supp)
/*  536:     */  {
...
/*  559:     */  }
/*  560:     */  
/*  567:     */  public static void mergeSort(int[] a, int from, int to)
/*  568:     */  {
/*  569: 569 */    mergeSort(a, from, to, (int[])a.clone());
/*  570:     */  }
/*  571:     */  
/*  577:     */  public static void mergeSort(int[] a)
/*  578:     */  {
/*  579: 579 */    mergeSort(a, 0, a.length);
/*  580:     */  }
/*  581:     */  
/*  593:     */  public static void mergeSort(int[] a, int from, int to, IntComparator comp, int[] supp)
/*  594:     */  {
...
/*  617:     */  }
/*  618:     */  
/*  627:     */  public static void mergeSort(int[] a, int from, int to, IntComparator comp)
/*  628:     */  {
/*  629: 629 */    mergeSort(a, from, to, comp, (int[])a.clone());
/*  630:     */  }
/*  631:     */  
/*  639:     */  public static void mergeSort(int[] a, IntComparator comp)
/*  640:     */  {
/*  641: 641 */    mergeSort(a, 0, a.length, comp);
/*  642:     */  }
/*  643:     */  
/*  654:     */  public static int binarySearch(int[] a, int from, int to, int key)
/*  655:     */  {
/*  656:     */    
/*  657:     */    
/*  667: 667 */    while (from <= to) {
/*  668: 668 */      int mid = from + to >>> 1;
/*  669: 669 */      int midVal = a[mid];
...
/*  675:     */  }
/*  676:     */  
/*  693:     */  public static int binarySearch(int[] a, int key)
/*  694:     */  {
/*  695: 695 */    return binarySearch(a, 0, a.length, key);
/*  696:     */  }
/*  697:     */  
/*  708:     */  public static int binarySearch(int[] a, int from, int to, int key, IntComparator c)
/*  709:     */  {
/*  710:     */    
/*  711:     */    
/*  721: 721 */    while (from <= to) {
/*  722: 722 */      int mid = from + to >>> 1;
/*  723: 723 */      int midVal = a[mid];
...
/*  730:     */  }
/*  731:     */  
/*  749:     */  public static int binarySearch(int[] a, int key, IntComparator c)
/*  750:     */  {
/*  751: 751 */    return binarySearch(a, 0, a.length, key, c);
/*  752:     */  }
/*  753:     */  
/*  775:     */  public static void radixSort(int[] a)
/*  776:     */  {
/*  777: 777 */    radixSort(a, 0, a.length);
/*  778:     */  }
/*  779:     */  
/*  796:     */  public static void radixSort(int[] a, int from, int to)
/*  797:     */  {
/*  798: 798 */    int maxLevel = 3;
/*  799: 799 */    int stackSize = 766;
/*  800: 800 */    int[] offsetStack = new int[766];
/*  801: 801 */    int offsetPos = 0;
/*  802: 802 */    int[] lengthStack = new int[766];
/*  803: 803 */    int lengthPos = 0;
/*  804: 804 */    int[] levelStack = new int[766];
...
/*  816: 816 */      int signMask = level % 4 == 0 ? 128 : 0;
/*  817: 817 */      if (length < 50) {
/*  818: 818 */        selectionSort(a, first, first + length);
/*  819:     */      }
/*  820:     */      else {
/*  821: 821 */        int shift = (3 - level % 4) * 8;
/*  822:     */        
...
/*  857:     */    } }
/*  858:     */  
/*  859: 859 */  private static void insertionSortIndirect(int[] perm, int[] a, int from, int to) { int i = from; for (;;) { i++; if (i >= to) break;
...
/*  871:     */  }
/*  872:     */  
/*  895:     */  public static void radixSortIndirect(int[] perm, int[] a, boolean stable)
/*  896:     */  {
/*  897: 897 */    radixSortIndirect(perm, a, 0, perm.length, stable);
/*  898:     */  }
/*  899:     */  
/*  924:     */  public static void radixSortIndirect(int[] perm, int[] a, int from, int to, boolean stable)
/*  925:     */  {
/*  926: 926 */    int maxLevel = 3;
/*  927: 927 */    int stackSize = 766;
/*  928: 928 */    int[] offsetStack = new int[766];
/*  929: 929 */    int offsetPos = 0;
/*  930: 930 */    int[] lengthStack = new int[766];
/*  931: 931 */    int lengthPos = 0;
/*  932: 932 */    int[] levelStack = new int[766];
