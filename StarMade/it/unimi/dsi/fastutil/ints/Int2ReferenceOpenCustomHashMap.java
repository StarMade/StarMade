...
/*  18:    */
/*  89:    */public class Int2ReferenceOpenCustomHashMap<V>
/*  90:    */  extends AbstractInt2ReferenceMap<V>
...
/* 103:    */  protected volatile transient Int2ReferenceMap.FastEntrySet<V> entries;
/* 104:    */  protected volatile transient IntSet keys;
/* 105:    */  protected volatile transient ReferenceCollection<V> values;
/* 106:    */  protected IntHash.Strategy strategy;
/* 107:    */  
/* 108:    */  public Int2ReferenceOpenCustomHashMap(int expected, float f, IntHash.Strategy strategy)
/* 109:    */  {
...
/* 117:117 */    this.key = new int[this.n];
/* 118:118 */    this.value = ((Object[])new Object[this.n]);
/* 119:119 */    this.used = new boolean[this.n];
/* 120:    */  }
/* 121:    */  
/* 125:    */  public Int2ReferenceOpenCustomHashMap(int expected, IntHash.Strategy strategy)
/* 126:    */  {
/* 127:127 */    this(expected, 0.75F, strategy);
/* 128:    */  }
/* 129:    */  
/* 132:    */  public Int2ReferenceOpenCustomHashMap(IntHash.Strategy strategy)
/* 133:    */  {
/* 134:134 */    this(16, 0.75F, strategy);
/* 135:    */  }
/* 136:    */  
/* 141:    */  public Int2ReferenceOpenCustomHashMap(Map<? extends Integer, ? extends V> m, float f, IntHash.Strategy strategy)
/* 142:    */  {
/* 143:143 */    this(m.size(), f, strategy);
/* 144:144 */    putAll(m);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Int2ReferenceOpenCustomHashMap(Map<? extends Integer, ? extends V> m, IntHash.Strategy strategy)
/* 151:    */  {
/* 152:152 */    this(m, 0.75F, strategy);
/* 153:    */  }
/* 154:    */  
/* 159:    */  public Int2ReferenceOpenCustomHashMap(Int2ReferenceMap<V> m, float f, IntHash.Strategy strategy)
/* 160:    */  {
/* 161:161 */    this(m.size(), f, strategy);
/* 162:162 */    putAll(m);
/* 163:    */  }
/* 164:    */  
/* 168:    */  public Int2ReferenceOpenCustomHashMap(Int2ReferenceMap<V> m, IntHash.Strategy strategy)
/* 169:    */  {
/* 170:170 */    this(m, 0.75F, strategy);
/* 171:    */  }
/* 172:    */  
/* 179:    */  public Int2ReferenceOpenCustomHashMap(int[] k, V[] v, float f, IntHash.Strategy strategy)
/* 180:    */  {
...
/* 185:    */  }
/* 186:    */  
/* 191:    */  public Int2ReferenceOpenCustomHashMap(int[] k, V[] v, IntHash.Strategy strategy)
/* 192:    */  {
/* 193:193 */    this(k, v, 0.75F, strategy);
/* 194:    */  }
/* 195:    */  
/* 198:    */  public IntHash.Strategy strategy()
/* 199:    */  {
/* 200:200 */    return this.strategy;
/* 201:    */  }
/* 202:    */  
/* 206:    */  public V put(int k, V v)
/* 207:    */  {
...
/* 224:    */  }
/* 225:    */  
/* 226:226 */  public V put(Integer ok, V ov) { V v = ov;
/* 227:227 */    int k = ok.intValue();
/* 228:    */    
...
/* 302:    */  }
/* 303:    */  
/* 304:304 */  public V get(Integer ok) { int k = ok.intValue();
/* 305:    */    
...
/* 380:    */    implements Int2ReferenceMap.Entry<V>, Map.Entry<Integer, V>
/* 381:    */  {
...
/* 387:    */    }
/* 388:    */    
/* 389:389 */    public Integer getKey() { return Integer.valueOf(Int2ReferenceOpenCustomHashMap.this.key[this.index]); }
/* 390:    */    
/* 391:    */    public int getIntKey() {
/* 392:392 */      return Int2ReferenceOpenCustomHashMap.this.key[this.index];
/* 393:    */    }
/* 394:    */    
/* 395:395 */    public V getValue() { return Int2ReferenceOpenCustomHashMap.this.value[this.index]; }
/* 396:    */    
/* 397:    */    public V setValue(V v) {
/* 398:398 */      V oldValue = Int2ReferenceOpenCustomHashMap.this.value[this.index];
/* 399:399 */      Int2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/* 400:400 */      return oldValue;
/* 401:    */    }
/* 402:    */    
/* 403:    */    public boolean equals(Object o) {
/* 404:404 */      if (!(o instanceof Map.Entry)) return false;
/* 405:405 */      Map.Entry<Integer, V> e = (Map.Entry)o;
/* 406:406 */      return (Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue())) && (Int2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/* 407:    */    }
/* 408:    */    
/* 409:409 */    public int hashCode() { return Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(Int2ReferenceOpenCustomHashMap.this.key[this.index]) ^ (Int2ReferenceOpenCustomHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Int2ReferenceOpenCustomHashMap.this.value[this.index])); }
/* 410:    */    
/* 412:412 */    public String toString() { return Int2ReferenceOpenCustomHashMap.this.key[this.index] + "=>" + Int2ReferenceOpenCustomHashMap.this.value[this.index]; } }
/* 413:    */  
/* 414:    */  private class MapIterator { int pos;
/* 415:    */    int last;
/* 416:    */    int c;
/* 417:    */    IntArrayList wrapped;
/* 418:    */    
/* 419:419 */    private MapIterator() { this.pos = Int2ReferenceOpenCustomHashMap.this.n;
/* 420:    */      
/* 422:422 */      this.last = -1;
/* 423:    */      
/* 424:424 */      this.c = Int2ReferenceOpenCustomHashMap.this.size;
/* 425:    */      
/* 429:429 */      boolean[] used = Int2ReferenceOpenCustomHashMap.this.used;
...
/* 440:440 */        int k = this.wrapped.getInt(-(this.last = --this.pos) - 2);
/* 441:    */        
/* 442:442 */        int pos = HashCommon.murmurHash3(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask;
/* 443:    */        
/* 444:444 */        while (Int2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 445:445 */          if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446:446 */          pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/* 447:    */        }
/* 448:    */      }
/* 449:449 */      this.last = this.pos;
/* 450:    */      
/* 451:451 */      if (this.c != 0) {
/* 452:452 */        boolean[] used = Int2ReferenceOpenCustomHashMap.this.used;
...
/* 467:    */      for (;;)
/* 468:    */      {
/* 469:469 */        pos = (last = pos) + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/* 470:470 */        while (Int2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 471:471 */          int slot = HashCommon.murmurHash3(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(Int2ReferenceOpenCustomHashMap.this.key[pos])) & Int2ReferenceOpenCustomHashMap.this.mask;
/* 472:472 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473:473 */          pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/* 474:    */        }
/* 475:475 */        if (Int2ReferenceOpenCustomHashMap.this.used[pos] == 0) break;
/* 476:476 */        if (pos < last)
/* 477:    */        {
/* 478:478 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 479:479 */          this.wrapped.add(Int2ReferenceOpenCustomHashMap.this.key[pos]);
/* 480:    */        }
/* 481:481 */        Int2ReferenceOpenCustomHashMap.this.key[last] = Int2ReferenceOpenCustomHashMap.this.key[pos];
/* 482:482 */        Int2ReferenceOpenCustomHashMap.this.value[last] = Int2ReferenceOpenCustomHashMap.this.value[pos];
/* 483:    */      }
/* 484:484 */      Int2ReferenceOpenCustomHashMap.this.used[last] = false;
/* 485:485 */      Int2ReferenceOpenCustomHashMap.this.value[last] = null;
/* 486:486 */      return last;
/* 487:    */    }
/* 488:    */    
...
/* 492:    */      {
/* 493:493 */        Int2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 494:494 */        this.last = -1;
/* 495:495 */        return;
/* 496:    */      }
/* 497:497 */      Int2ReferenceOpenCustomHashMap.this.size -= 1;
...
/* 509:    */    } }
/* 510:    */  
/* 511:511 */  private class EntryIterator extends Int2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Int2ReferenceMap.Entry<V>> { private EntryIterator() { super(null); }
/* 512:    */    
/* 513:    */    private Int2ReferenceOpenCustomHashMap<V>.MapEntry entry;
/* 514:514 */    public Int2ReferenceMap.Entry<V> next() { return this.entry = new Int2ReferenceOpenCustomHashMap.MapEntry(Int2ReferenceOpenCustomHashMap.this, nextEntry()); }
/* 515:    */    
/* 516:    */    public void remove()
/* 517:    */    {
/* 518:518 */      super.remove();
/* 519:519 */      Int2ReferenceOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 520:    */    } }
/* 521:    */  
/* 522:522 */  private class FastEntryIterator extends Int2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Int2ReferenceMap.Entry<V>> { private FastEntryIterator() { super(null); }
/* 523:523 */    final AbstractInt2ReferenceMap.BasicEntry<V> entry = new AbstractInt2ReferenceMap.BasicEntry(0, null);
/* 524:    */    
/* 525:525 */    public AbstractInt2ReferenceMap.BasicEntry<V> next() { int e = nextEntry();
/* 526:526 */      this.entry.key = Int2ReferenceOpenCustomHashMap.this.key[e];
/* 527:527 */      this.entry.value = Int2ReferenceOpenCustomHashMap.this.value[e];
/* 528:528 */      return this.entry;
/* 529:    */    } }
/* 530:    */  
/* 531:    */  private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>> implements Int2ReferenceMap.FastEntrySet<V> { private MapEntrySet() {}
/* 532:    */    
/* 533:533 */    public ObjectIterator<Int2ReferenceMap.Entry<V>> iterator() { return new Int2ReferenceOpenCustomHashMap.EntryIterator(Int2ReferenceOpenCustomHashMap.this, null); }
/* 534:    */    
/* 535:    */    public ObjectIterator<Int2ReferenceMap.Entry<V>> fastIterator() {
/* 536:536 */      return new Int2ReferenceOpenCustomHashMap.FastEntryIterator(Int2ReferenceOpenCustomHashMap.this, null);
/* 537:    */    }
/* 538:    */    
/* 539:    */    public boolean contains(Object o) {
/* 540:540 */      if (!(o instanceof Map.Entry)) return false;
/* 541:541 */      Map.Entry<Integer, V> e = (Map.Entry)o;
/* 542:542 */      int k = ((Integer)e.getKey()).intValue();
/* 543:    */      
/* 544:544 */      int pos = HashCommon.murmurHash3(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask;
/* 545:    */      
/* 546:546 */      while (Int2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 547:547 */        if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[pos], k)) return Int2ReferenceOpenCustomHashMap.this.value[pos] == e.getValue();
/* 548:548 */        pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/* 549:    */      }
...
/* 555:555 */      Map.Entry<Integer, V> e = (Map.Entry)o;
/* 556:556 */      int k = ((Integer)e.getKey()).intValue();
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Int2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[pos], k)) {
/* 562:562 */          Int2ReferenceOpenCustomHashMap.this.remove(e.getKey());
/* 563:563 */          return true;
/* 564:    */        }
/* 565:565 */        pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/* 566:    */      }
/* 567:567 */      return false;
/* 568:    */    }
/* 569:    */    
/* 570:570 */    public int size() { return Int2ReferenceOpenCustomHashMap.this.size; }
/* 571:    */    
/* 573:573 */    public void clear() { Int2ReferenceOpenCustomHashMap.this.clear(); }
/* 574:    */  }
/* 575:    */  
/* 576:    */  public Int2ReferenceMap.FastEntrySet<V> int2ReferenceEntrySet() {
...
/* 584:    */    extends Int2ReferenceOpenCustomHashMap.MapIterator
/* 585:    */    implements IntIterator
/* 586:    */  {
/* 587:587 */    public KeyIterator() { super(null); }
/* 588:588 */    public int nextInt() { return Int2ReferenceOpenCustomHashMap.this.key[nextEntry()]; }
/* 589:589 */    public Integer next() { return Integer.valueOf(Int2ReferenceOpenCustomHashMap.this.key[nextEntry()]); } }
/* 590:    */  
/* 591:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 592:    */    
/* 593:593 */    public IntIterator iterator() { return new Int2ReferenceOpenCustomHashMap.KeyIterator(Int2ReferenceOpenCustomHashMap.this); }
/* 594:    */    
/* 595:    */    public int size() {
/* 596:596 */      return Int2ReferenceOpenCustomHashMap.this.size;
/* 597:    */    }
/* 598:    */    
/* 599:599 */    public boolean contains(int k) { return Int2ReferenceOpenCustomHashMap.this.containsKey(k); }
/* 600:    */    
/* 601:    */    public boolean remove(int k) {
/* 602:602 */      int oldSize = Int2ReferenceOpenCustomHashMap.this.size;
/* 603:603 */      Int2ReferenceOpenCustomHashMap.this.remove(k);
/* 604:604 */      return Int2ReferenceOpenCustomHashMap.this.size != oldSize;
/* 605:    */    }
/* 606:    */    
/* 607:607 */    public void clear() { Int2ReferenceOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
/* 610:    */  public IntSet keySet() {
/* 611:611 */    if (this.keys == null) this.keys = new KeySet(null);
/* 612:612 */    return this.keys;
/* 613:    */  }
/* 614:    */  
/* 617:    */  private final class ValueIterator
/* 618:    */    extends Int2ReferenceOpenCustomHashMap<V>.MapIterator
/* 619:    */    implements ObjectIterator<V>
/* 620:    */  {
/* 621:621 */    public ValueIterator() { super(null); }
/* 622:622 */    public V next() { return Int2ReferenceOpenCustomHashMap.this.value[nextEntry()]; }
/* 623:    */  }
/* 624:    */  
...
/* 627:627 */          return new Int2ReferenceOpenCustomHashMap.ValueIterator(Int2ReferenceOpenCustomHashMap.this);
/* 628:    */        }
/* 629:    */        
/* 630:630 */        public int size() { return Int2ReferenceOpenCustomHashMap.this.size; }
/* 631:    */        
/* 632:    */        public boolean contains(Object v) {
/* 633:633 */          return Int2ReferenceOpenCustomHashMap.this.containsValue(v);
/* 634:    */        }
/* 635:    */        
/* 636:636 */        public void clear() { Int2ReferenceOpenCustomHashMap.this.clear(); }
/* 637:    */      };
/* 638:    */    }
...
/* 716:    */    
/* 717:717 */    int[] key = this.key;
/* 718:718 */    V[] value = this.value;
/* 719:719 */    int newMask = newN - 1;
/* 720:720 */    int[] newKey = new int[newN];
...
/* 739:    */  }
/* 740:    */  
/* 744:    */  public Int2ReferenceOpenCustomHashMap<V> clone()
/* 745:    */  {
/* 746:    */    Int2ReferenceOpenCustomHashMap<V> c;
/* 747:    */    
/* 749:    */    try
/* 750:    */    {
/* 751:751 */      c = (Int2ReferenceOpenCustomHashMap)super.clone();
/* 752:    */    }
...
/* 759:759 */    c.key = ((int[])this.key.clone());
...
/* 785:    */  }
/* 786:    */  
/* 787:787 */  private void writeObject(ObjectOutputStream s) throws IOException { int[] key = this.key;
/* 788:788 */    V[] value = this.value;
/* 789:789 */    Int2ReferenceOpenCustomHashMap<V>.MapIterator i = new MapIterator(null);
/* 790:790 */    s.defaultWriteObject();
/* 791:791 */    for (int j = this.size; j-- != 0;) {
/* 792:792 */      int e = i.nextEntry();
/* 793:793 */      s.writeInt(key[e]);
...
/* 803:803 */    int[] key = this.key = new int[this.n];
