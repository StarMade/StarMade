...
/* 627 */           return new Int2ReferenceOpenCustomHashMap.ValueIterator(Int2ReferenceOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 630 */           return Int2ReferenceOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 633 */           return Int2ReferenceOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 636 */           Int2ReferenceOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 751 */       c = (Int2ReferenceOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Int2ReferenceOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public V next() { return Int2ReferenceOpenCustomHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 593 */       return new Int2ReferenceOpenCustomHashMap.KeyIterator(Int2ReferenceOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 596 */       return Int2ReferenceOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(int k) {
/* 599 */       return Int2ReferenceOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(int k) {
/* 602 */       int oldSize = Int2ReferenceOpenCustomHashMap.this.size;
/* 603 */       Int2ReferenceOpenCustomHashMap.this.remove(k);
/* 604 */       return Int2ReferenceOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 607 */       Int2ReferenceOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Int2ReferenceOpenCustomHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 587 */       super(null); } 
/* 588 */     public int nextInt() { return Int2ReferenceOpenCustomHashMap.this.key[nextEntry()]; } 
/* 589 */     public Integer next() { return Integer.valueOf(Int2ReferenceOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
/*     */   private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>>
...
/*     */     {
/* 533 */       return new Int2ReferenceOpenCustomHashMap.EntryIterator(Int2ReferenceOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Int2ReferenceMap.Entry<V>> fastIterator() {
/* 536 */       return new Int2ReferenceOpenCustomHashMap.FastEntryIterator(Int2ReferenceOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 544 */       int pos = HashCommon.murmurHash3(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask;
/*     */ 
/* 546 */       while (Int2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 547 */         if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[pos], k)) return Int2ReferenceOpenCustomHashMap.this.value[pos] == e.getValue();
/* 548 */         pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/*     */       }
/* 550 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask;
/*     */ 
/* 560 */       while (Int2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 561 */         if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[pos], k)) {
/* 562 */           Int2ReferenceOpenCustomHashMap.this.remove(e.getKey());
/* 563 */           return true;
/*     */         }
/* 565 */         pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/*     */       }
/* 567 */       return false;
/*     */     }
/*     */     public int size() {
/* 570 */       return Int2ReferenceOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 573 */       Int2ReferenceOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Int2ReferenceOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Int2ReferenceMap.Entry<V>>
/*     */   {
/* 523 */     final AbstractInt2ReferenceMap.BasicEntry<V> entry = new AbstractInt2ReferenceMap.BasicEntry(0, null);
/*     */ 
...
/* 525 */       int e = nextEntry();
/* 526 */       this.entry.key = Int2ReferenceOpenCustomHashMap.this.key[e];
/* 527 */       this.entry.value = Int2ReferenceOpenCustomHashMap.this.value[e];
/* 528 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Int2ReferenceOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Int2ReferenceMap.Entry<V>>
/*     */   {
...
/* 514 */       return this.entry = new Int2ReferenceOpenCustomHashMap.MapEntry(Int2ReferenceOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 518 */       super.remove();
/* 519 */       Int2ReferenceOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 419 */       this.pos = Int2ReferenceOpenCustomHashMap.this.n;
/*     */ 
/* 422 */       this.last = -1;
/*     */ 
/* 424 */       this.c = Int2ReferenceOpenCustomHashMap.this.size;
/*     */ 
/* 429 */       boolean[] used = Int2ReferenceOpenCustomHashMap.this.used;
...
/*     */ 
/* 442 */         int pos = HashCommon.murmurHash3(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ReferenceOpenCustomHashMap.this.mask;
/*     */ 
/* 444 */         while (Int2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 445 */           if (Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446 */           pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 449 */       this.last = this.pos;
/*     */ 
/* 451 */       if (this.c != 0) {
/* 452 */         boolean[] used = Int2ReferenceOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 469 */         pos = (last = pos) + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/* 470 */         while (Int2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 471 */           int slot = HashCommon.murmurHash3(Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(Int2ReferenceOpenCustomHashMap.this.key[pos])) & Int2ReferenceOpenCustomHashMap.this.mask;
/* 472 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473 */           pos = pos + 1 & Int2ReferenceOpenCustomHashMap.this.mask;
/*     */         }
/* 475 */         if (Int2ReferenceOpenCustomHashMap.this.used[pos] == 0) break;
/* 476 */         if (pos < last)
/*     */         {
/* 478 */           if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 479 */           this.wrapped.add(Int2ReferenceOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 481 */         Int2ReferenceOpenCustomHashMap.this.key[last] = Int2ReferenceOpenCustomHashMap.this.key[pos];
/* 482 */         Int2ReferenceOpenCustomHashMap.this.value[last] = Int2ReferenceOpenCustomHashMap.this.value[pos];
/*     */       }
/* 484 */       Int2ReferenceOpenCustomHashMap.this.used[last] = false;
/* 485 */       Int2ReferenceOpenCustomHashMap.this.value[last] = null;
/* 486 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 491 */       if (this.pos < -1)
/*     */       {
/* 493 */         Int2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 494 */         this.last = -1;
/* 495 */         return;
/*     */       }
/* 497 */       Int2ReferenceOpenCustomHashMap.this.size -= 1;
...
/* 389 */       return Integer.valueOf(Int2ReferenceOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public int getIntKey() {
/* 392 */       return Int2ReferenceOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 395 */       return Int2ReferenceOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 398 */       Object oldValue = Int2ReferenceOpenCustomHashMap.this.value[this.index];
/* 399 */       Int2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/* 400 */       return oldValue;
/*     */     }
/*     */ 
...
/* 406 */       return (Int2ReferenceOpenCustomHashMap.this.strategy.equals(Int2ReferenceOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue())) && (Int2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/*     */     }
/*     */     public int hashCode() {
/* 409 */       return Int2ReferenceOpenCustomHashMap.this.strategy.hashCode(Int2ReferenceOpenCustomHashMap.this.key[this.index]) ^ (Int2ReferenceOpenCustomHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Int2ReferenceOpenCustomHashMap.this.value[this.index]));
/*     */     }
/*     */     public String toString() {
/* 412 */       return Int2ReferenceOpenCustomHashMap.this.key[this.index] + "=>" + Int2ReferenceOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
