...
/*  18:    */
/*  86:    */public class Int2ObjectOpenHashMap<V>
/*  87:    */  extends AbstractInt2ObjectMap<V>
...
/*  92:    */  protected transient int[] key;
...
/* 100:    */  protected volatile transient Int2ObjectMap.FastEntrySet<V> entries;
/* 101:    */  protected volatile transient IntSet keys;
/* 102:    */  protected volatile transient ObjectCollection<V> values;
/* 103:    */  
/* 104:    */  public Int2ObjectOpenHashMap(int expected, float f)
/* 105:    */  {
...
/* 112:112 */    this.key = new int[this.n];
/* 113:113 */    this.value = ((Object[])new Object[this.n]);
/* 114:114 */    this.used = new boolean[this.n];
/* 115:    */  }
/* 116:    */  
/* 119:    */  public Int2ObjectOpenHashMap(int expected)
/* 120:    */  {
/* 121:121 */    this(expected, 0.75F);
/* 122:    */  }
/* 123:    */  
/* 125:    */  public Int2ObjectOpenHashMap()
/* 126:    */  {
/* 127:127 */    this(16, 0.75F);
/* 128:    */  }
/* 129:    */  
/* 133:    */  public Int2ObjectOpenHashMap(Map<? extends Integer, ? extends V> m, float f)
/* 134:    */  {
/* 135:135 */    this(m.size(), f);
/* 136:136 */    putAll(m);
/* 137:    */  }
/* 138:    */  
/* 141:    */  public Int2ObjectOpenHashMap(Map<? extends Integer, ? extends V> m)
/* 142:    */  {
/* 143:143 */    this(m, 0.75F);
/* 144:    */  }
/* 145:    */  
/* 149:    */  public Int2ObjectOpenHashMap(Int2ObjectMap<V> m, float f)
/* 150:    */  {
/* 151:151 */    this(m.size(), f);
/* 152:152 */    putAll(m);
/* 153:    */  }
/* 154:    */  
/* 157:    */  public Int2ObjectOpenHashMap(Int2ObjectMap<V> m)
/* 158:    */  {
/* 159:159 */    this(m, 0.75F);
/* 160:    */  }
/* 161:    */  
/* 167:    */  public Int2ObjectOpenHashMap(int[] k, V[] v, float f)
/* 168:    */  {
...
/* 173:    */  }
/* 174:    */  
/* 178:    */  public Int2ObjectOpenHashMap(int[] k, V[] v)
/* 179:    */  {
/* 180:180 */    this(k, v, 0.75F);
/* 181:    */  }
/* 182:    */  
/* 186:    */  public V put(int k, V v)
/* 187:    */  {
...
/* 204:    */  }
/* 205:    */  
/* 206:206 */  public V put(Integer ok, V ov) { V v = ov;
/* 207:207 */    int k = ok.intValue();
/* 208:    */    
...
/* 282:    */  }
/* 283:    */  
/* 284:284 */  public V get(Integer ok) { int k = ok.intValue();
/* 285:    */    
...
/* 360:    */    implements Int2ObjectMap.Entry<V>, Map.Entry<Integer, V>
/* 361:    */  {
...
/* 367:    */    }
/* 368:    */    
/* 369:369 */    public Integer getKey() { return Integer.valueOf(Int2ObjectOpenHashMap.this.key[this.index]); }
/* 370:    */    
/* 371:    */    public int getIntKey() {
/* 372:372 */      return Int2ObjectOpenHashMap.this.key[this.index];
/* 373:    */    }
/* 374:    */    
/* 375:375 */    public V getValue() { return Int2ObjectOpenHashMap.this.value[this.index]; }
/* 376:    */    
/* 377:    */    public V setValue(V v) {
/* 378:378 */      V oldValue = Int2ObjectOpenHashMap.this.value[this.index];
/* 379:379 */      Int2ObjectOpenHashMap.this.value[this.index] = v;
/* 380:380 */      return oldValue;
/* 381:    */    }
/* 382:    */    
/* 383:    */    public boolean equals(Object o) {
/* 384:384 */      if (!(o instanceof Map.Entry)) return false;
/* 385:385 */      Map.Entry<Integer, V> e = (Map.Entry)o;
/* 386:386 */      return (Int2ObjectOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Int2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
/* 387:    */    }
/* 388:    */    
/* 389:389 */    public int hashCode() { return Int2ObjectOpenHashMap.this.key[this.index] ^ (Int2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Int2ObjectOpenHashMap.this.value[this.index].hashCode()); }
/* 390:    */    
/* 392:392 */    public String toString() { return Int2ObjectOpenHashMap.this.key[this.index] + "=>" + Int2ObjectOpenHashMap.this.value[this.index]; } }
/* 393:    */  
/* 394:    */  private class MapIterator { int pos;
/* 395:    */    int last;
/* 396:    */    int c;
/* 397:    */    IntArrayList wrapped;
/* 398:    */    
/* 399:399 */    private MapIterator() { this.pos = Int2ObjectOpenHashMap.this.n;
/* 400:    */      
/* 402:402 */      this.last = -1;
/* 403:    */      
/* 404:404 */      this.c = Int2ObjectOpenHashMap.this.size;
/* 405:    */      
/* 409:409 */      boolean[] used = Int2ObjectOpenHashMap.this.used;
...
/* 420:420 */        int k = this.wrapped.getInt(-(this.last = --this.pos) - 2);
/* 421:    */        
/* 422:422 */        int pos = HashCommon.murmurHash3(k) & Int2ObjectOpenHashMap.this.mask;
/* 423:    */        
/* 424:424 */        while (Int2ObjectOpenHashMap.this.used[pos] != 0) {
/* 425:425 */          if (Int2ObjectOpenHashMap.this.key[pos] == k) return pos;
/* 426:426 */          pos = pos + 1 & Int2ObjectOpenHashMap.this.mask;
/* 427:    */        }
/* 428:    */      }
/* 429:429 */      this.last = this.pos;
/* 430:    */      
/* 431:431 */      if (this.c != 0) {
/* 432:432 */        boolean[] used = Int2ObjectOpenHashMap.this.used;
...
/* 447:    */      for (;;)
/* 448:    */      {
/* 449:449 */        pos = (last = pos) + 1 & Int2ObjectOpenHashMap.this.mask;
/* 450:450 */        while (Int2ObjectOpenHashMap.this.used[pos] != 0) {
/* 451:451 */          int slot = HashCommon.murmurHash3(Int2ObjectOpenHashMap.this.key[pos]) & Int2ObjectOpenHashMap.this.mask;
/* 452:452 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453:453 */          pos = pos + 1 & Int2ObjectOpenHashMap.this.mask;
/* 454:    */        }
/* 455:455 */        if (Int2ObjectOpenHashMap.this.used[pos] == 0) break;
/* 456:456 */        if (pos < last)
/* 457:    */        {
/* 458:458 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 459:459 */          this.wrapped.add(Int2ObjectOpenHashMap.this.key[pos]);
/* 460:    */        }
/* 461:461 */        Int2ObjectOpenHashMap.this.key[last] = Int2ObjectOpenHashMap.this.key[pos];
/* 462:462 */        Int2ObjectOpenHashMap.this.value[last] = Int2ObjectOpenHashMap.this.value[pos];
/* 463:    */      }
/* 464:464 */      Int2ObjectOpenHashMap.this.used[last] = false;
/* 465:465 */      Int2ObjectOpenHashMap.this.value[last] = null;
/* 466:466 */      return last;
/* 467:    */    }
/* 468:    */    
...
/* 472:    */      {
/* 473:473 */        Int2ObjectOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 474:474 */        this.last = -1;
/* 475:475 */        return;
/* 476:    */      }
/* 477:477 */      Int2ObjectOpenHashMap.this.size -= 1;
...
/* 489:    */    } }
/* 490:    */  
/* 491:491 */  private class EntryIterator extends Int2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Int2ObjectMap.Entry<V>> { private EntryIterator() { super(null); }
/* 492:    */    
/* 493:    */    private Int2ObjectOpenHashMap<V>.MapEntry entry;
/* 494:494 */    public Int2ObjectMap.Entry<V> next() { return this.entry = new Int2ObjectOpenHashMap.MapEntry(Int2ObjectOpenHashMap.this, nextEntry()); }
/* 495:    */    
/* 496:    */    public void remove()
/* 497:    */    {
/* 498:498 */      super.remove();
/* 499:499 */      Int2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 500:    */    } }
/* 501:    */  
/* 502:502 */  private class FastEntryIterator extends Int2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Int2ObjectMap.Entry<V>> { private FastEntryIterator() { super(null); }
/* 503:503 */    final AbstractInt2ObjectMap.BasicEntry<V> entry = new AbstractInt2ObjectMap.BasicEntry(0, null);
/* 504:    */    
/* 505:505 */    public AbstractInt2ObjectMap.BasicEntry<V> next() { int e = nextEntry();
/* 506:506 */      this.entry.key = Int2ObjectOpenHashMap.this.key[e];
/* 507:507 */      this.entry.value = Int2ObjectOpenHashMap.this.value[e];
/* 508:508 */      return this.entry;
/* 509:    */    } }
/* 510:    */  
/* 511:    */  private final class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V> { private MapEntrySet() {}
/* 512:    */    
/* 513:513 */    public ObjectIterator<Int2ObjectMap.Entry<V>> iterator() { return new Int2ObjectOpenHashMap.EntryIterator(Int2ObjectOpenHashMap.this, null); }
/* 514:    */    
/* 515:    */    public ObjectIterator<Int2ObjectMap.Entry<V>> fastIterator() {
/* 516:516 */      return new Int2ObjectOpenHashMap.FastEntryIterator(Int2ObjectOpenHashMap.this, null);
/* 517:    */    }
/* 518:    */    
/* 519:    */    public boolean contains(Object o) {
/* 520:520 */      if (!(o instanceof Map.Entry)) return false;
/* 521:521 */      Map.Entry<Integer, V> e = (Map.Entry)o;
/* 522:522 */      int k = ((Integer)e.getKey()).intValue();
/* 523:    */      
/* 524:524 */      int pos = HashCommon.murmurHash3(k) & Int2ObjectOpenHashMap.this.mask;
/* 525:    */      
/* 526:526 */      while (Int2ObjectOpenHashMap.this.used[pos] != 0) {
/* 527:527 */        if (Int2ObjectOpenHashMap.this.key[pos] == k) return Int2ObjectOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Int2ObjectOpenHashMap.this.value[pos].equals(e.getValue());
/* 528:528 */        pos = pos + 1 & Int2ObjectOpenHashMap.this.mask;
/* 529:    */      }
...
/* 535:535 */      Map.Entry<Integer, V> e = (Map.Entry)o;
/* 536:536 */      int k = ((Integer)e.getKey()).intValue();
/* 537:    */      
/* 538:538 */      int pos = HashCommon.murmurHash3(k) & Int2ObjectOpenHashMap.this.mask;
/* 539:    */      
/* 540:540 */      while (Int2ObjectOpenHashMap.this.used[pos] != 0) {
/* 541:541 */        if (Int2ObjectOpenHashMap.this.key[pos] == k) {
/* 542:542 */          Int2ObjectOpenHashMap.this.remove(e.getKey());
/* 543:543 */          return true;
/* 544:    */        }
/* 545:545 */        pos = pos + 1 & Int2ObjectOpenHashMap.this.mask;
/* 546:    */      }
/* 547:547 */      return false;
/* 548:    */    }
/* 549:    */    
/* 550:550 */    public int size() { return Int2ObjectOpenHashMap.this.size; }
/* 551:    */    
/* 553:553 */    public void clear() { Int2ObjectOpenHashMap.this.clear(); }
/* 554:    */  }
/* 555:    */  
/* 556:    */  public Int2ObjectMap.FastEntrySet<V> int2ObjectEntrySet() {
...
/* 564:    */    extends Int2ObjectOpenHashMap.MapIterator
/* 565:    */    implements IntIterator
/* 566:    */  {
/* 567:567 */    public KeyIterator() { super(null); }
/* 568:568 */    public int nextInt() { return Int2ObjectOpenHashMap.this.key[nextEntry()]; }
/* 569:569 */    public Integer next() { return Integer.valueOf(Int2ObjectOpenHashMap.this.key[nextEntry()]); } }
/* 570:    */  
/* 571:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 572:    */    
/* 573:573 */    public IntIterator iterator() { return new Int2ObjectOpenHashMap.KeyIterator(Int2ObjectOpenHashMap.this); }
/* 574:    */    
/* 575:    */    public int size() {
/* 576:576 */      return Int2ObjectOpenHashMap.this.size;
/* 577:    */    }
/* 578:    */    
/* 579:579 */    public boolean contains(int k) { return Int2ObjectOpenHashMap.this.containsKey(k); }
/* 580:    */    
/* 581:    */    public boolean remove(int k) {
/* 582:582 */      int oldSize = Int2ObjectOpenHashMap.this.size;
/* 583:583 */      Int2ObjectOpenHashMap.this.remove(k);
/* 584:584 */      return Int2ObjectOpenHashMap.this.size != oldSize;
/* 585:    */    }
/* 586:    */    
/* 587:587 */    public void clear() { Int2ObjectOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public IntSet keySet() {
/* 591:591 */    if (this.keys == null) this.keys = new KeySet(null);
/* 592:592 */    return this.keys;
/* 593:    */  }
/* 594:    */  
/* 597:    */  private final class ValueIterator
/* 598:    */    extends Int2ObjectOpenHashMap<V>.MapIterator
/* 599:    */    implements ObjectIterator<V>
/* 600:    */  {
/* 601:601 */    public ValueIterator() { super(null); }
/* 602:602 */    public V next() { return Int2ObjectOpenHashMap.this.value[nextEntry()]; }
/* 603:    */  }
/* 604:    */  
...
/* 607:607 */          return new Int2ObjectOpenHashMap.ValueIterator(Int2ObjectOpenHashMap.this);
/* 608:    */        }
/* 609:    */        
/* 610:610 */        public int size() { return Int2ObjectOpenHashMap.this.size; }
/* 611:    */        
/* 612:    */        public boolean contains(Object v) {
/* 613:613 */          return Int2ObjectOpenHashMap.this.containsValue(v);
/* 614:    */        }
/* 615:    */        
/* 616:616 */        public void clear() { Int2ObjectOpenHashMap.this.clear(); }
/* 617:    */      };
/* 618:    */    }
...
/* 696:    */    
/* 697:697 */    int[] key = this.key;
/* 698:698 */    V[] value = this.value;
/* 699:699 */    int newMask = newN - 1;
/* 700:700 */    int[] newKey = new int[newN];
...
/* 719:    */  }
/* 720:    */  
/* 724:    */  public Int2ObjectOpenHashMap<V> clone()
/* 725:    */  {
/* 726:    */    Int2ObjectOpenHashMap<V> c;
/* 727:    */    
/* 729:    */    try
/* 730:    */    {
/* 731:731 */      c = (Int2ObjectOpenHashMap)super.clone();
/* 732:    */    }
...
/* 739:739 */    c.key = ((int[])this.key.clone());
...
/* 764:    */  }
/* 765:    */  
/* 766:766 */  private void writeObject(ObjectOutputStream s) throws IOException { int[] key = this.key;
/* 767:767 */    V[] value = this.value;
/* 768:768 */    Int2ObjectOpenHashMap<V>.MapIterator i = new MapIterator(null);
/* 769:769 */    s.defaultWriteObject();
/* 770:770 */    for (int j = this.size; j-- != 0;) {
/* 771:771 */      int e = i.nextEntry();
/* 772:772 */      s.writeInt(key[e]);
...
/* 782:782 */    int[] key = this.key = new int[this.n];
