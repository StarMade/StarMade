  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2BooleanAVLTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2BooleanAVLTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2BooleanAVLTreeMap(Map<? extends Integer, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2BooleanAVLTreeMap(SortedMap<Integer, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2BooleanAVLTreeMap(Int2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2BooleanAVLTreeMap(Int2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2BooleanAVLTreeMap(int[] local_k, boolean[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2BooleanAVLTreeMap(int[] local_k, boolean[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2BooleanMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Int2BooleanAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2BooleanAVLTreeMap.EntryIterator(Int2BooleanAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry from)
        {
          return new Int2BooleanAVLTreeMap.EntryIterator(Int2BooleanAVLTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2BooleanAVLTreeMap.Entry local_f = Int2BooleanAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2BooleanAVLTreeMap.Entry local_f = Int2BooleanAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2BooleanAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2BooleanAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry local_to)
        {
          return Int2BooleanAVLTreeMap.this.headMap((Integer)local_to.getKey()).int2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry from)
        {
          return Int2BooleanAVLTreeMap.this.tailMap((Integer)from.getKey()).int2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Int2BooleanAVLTreeMap.ValueIterator(Int2BooleanAVLTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Int2BooleanAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2BooleanAVLTreeMap local_c;
    try
    {
      local_c = (Int2BooleanAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2BooleanAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Int2BooleanAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2BooleanAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2BooleanMap.Entry> int2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator()
          {
            return new Int2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Int2BooleanAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2BooleanMap.Entry> iterator(Int2BooleanMap.Entry from)
          {
            return new Int2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Int2BooleanAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, Boolean> local_e = (Map.Entry)local_o;
            Int2BooleanAVLTreeMap.Entry local_f = Int2BooleanAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2BooleanAVLTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, Boolean> local_e = (Map.Entry)local_o;
            Int2BooleanAVLTreeMap.Entry local_f = Int2BooleanAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2BooleanAVLTreeMap.Submap.this.in4(local_f.key))) {
              Int2BooleanAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2BooleanAVLTreeMap.Submap.SubmapIterator(Int2BooleanAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2BooleanAVLTreeMap.Submap.this.clear();
          }
          
          public Int2BooleanMap.Entry first()
          {
            return Int2BooleanAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Int2BooleanMap.Entry last()
          {
            return Int2BooleanAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2BooleanMap.Entry> subSet(Int2BooleanMap.Entry from, Int2BooleanMap.Entry local_to)
          {
            return Int2BooleanAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Int2BooleanMap.Entry> headSet(Int2BooleanMap.Entry local_to)
          {
            return Int2BooleanAVLTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Int2BooleanMap.Entry> tailSet(Int2BooleanMap.Entry from)
          {
            return Int2BooleanAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Int2BooleanAVLTreeMap.Submap.SubmapValueIterator(Int2BooleanAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Int2BooleanAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2BooleanAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2BooleanAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2BooleanAVLTreeMap.Entry local_e;
      return (in4(local_kk)) && ((local_e = Int2BooleanAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(int local_k, boolean local_v)
    {
      ...
      boolean oldValue = Int2BooleanAVLTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(int local_k)
    {
      ...
      boolean oldValue = Int2BooleanAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2BooleanSortedMap tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2BooleanAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2BooleanAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2BooleanSortedMap subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2BooleanAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2BooleanAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2BooleanAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2BooleanAVLTreeMap.this.locateKey(this.from);
        if (Int2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2BooleanAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2BooleanAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2BooleanAVLTreeMap.this.locateKey(this.field_47);
        if (Int2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2BooleanAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2BooleanAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Int2BooleanAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Int2BooleanAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2BooleanAVLTreeMap.Submap.this.bottom) && (Int2BooleanAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2BooleanAVLTreeMap.Submap.this.top) && (Int2BooleanAVLTreeMap.this.compare(local_k, (this.prev = Int2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2BooleanAVLTreeMap.this.locateKey(local_k);
            if (Int2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2BooleanAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2BooleanAVLTreeMap.this.compare(this.prev.key, Int2BooleanAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2BooleanAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2BooleanAVLTreeMap.this.compare(this.next.key, Int2BooleanAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Int2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Int2BooleanAVLTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Int2BooleanAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2BooleanSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2BooleanAVLTreeMap.KeyIterator(Int2BooleanAVLTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2BooleanAVLTreeMap.KeyIterator(Int2BooleanAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2BooleanAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Int2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
