...
/*      */ 
/*      */ public class IntRBTreeSet extends AbstractIntSortedSet
...
/*   97 */           return IntRBTreeSet.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  100 */           return IntRBTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   public IntRBTreeSet(Iterator<? extends Integer> i)
/*      */   {
...
/* 1028 */     return new Subset(0, true, to, false);
/*      */   }
/*      */   public IntSortedSet tailSet(int from) {
/* 1031 */     return new Subset(from, false, 0, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1226 */       c = (IntRBTreeSet)super.clone();
/*      */     }
...
/* 1279 */     while (n-- != 0) s.writeInt(i.nextInt());
/*      */   }
/*      */ 
...
/*      */   {
/* 1290 */     if (n == 1) {
/* 1291 */       Entry top = new Entry(s.readInt());
/* 1292 */       top.pred(pred);
/* 1293 */       top.succ(succ);
/* 1294 */       top.black(true);
/* 1295 */       return top;
...
/* 1297 */     if (n == 2)
/*      */     {
/* 1300 */       Entry top = new Entry(s.readInt());
/* 1301 */       top.black(true);
/* 1302 */       top.right(new Entry(s.readInt()));
...
/*      */     {
/* 1063 */       if ((!bottom) && (!top) && (IntRBTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1064 */       this.from = from;
...
/*      */     {
/* 1081 */       return ((this.bottom) || (IntRBTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (IntRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(int k)
/*      */     {
/* 1086 */       return (in(k)) && (IntRBTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(int k) {
...
/* 1090 */       return IntRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(int k) {
/* 1094 */       if (!in(k)) return false;
/* 1095 */       return IntRBTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1110 */       return IntRBTreeSet.this.actualComparator;
/*      */     }
/*      */     public IntBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public IntSortedSet headSet(int to) {
/* 1119 */       if (this.top) return new Subset(IntRBTreeSet.this, this.from, this.bottom, to, false);
/* 1120 */       return IntRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(IntRBTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public IntSortedSet tailSet(int from) {
/* 1123 */       if (this.bottom) return new Subset(IntRBTreeSet.this, from, false, this.to, this.top);
/* 1124 */       return IntRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(IntRBTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public IntSortedSet subSet(int from, int to) {
/* 1127 */       if ((this.top) && (this.bottom)) return new Subset(IntRBTreeSet.this, from, false, to, false);
...
/* 1131 */       return new Subset(IntRBTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public IntRBTreeSet.Entry firstEntry()
/*      */     {
/* 1138 */       if (IntRBTreeSet.this.tree == null) return null;
/* 1141 */       IntRBTreeSet.Entry e;
/*      */       IntRBTreeSet.Entry e;
/* 1141 */       if (this.bottom) { e = IntRBTreeSet.this.firstEntry;
/*      */       } else {
/* 1143 */         e = IntRBTreeSet.this.locateKey(this.from);
/*      */ 
/* 1145 */         if (IntRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1148 */       if ((e == null) || ((!this.top) && (IntRBTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1149 */       return e;
/*      */     }
/*      */ 
/*      */     public IntRBTreeSet.Entry lastEntry()
/*      */     {
/* 1156 */       if (IntRBTreeSet.this.tree == null) return null;
/* 1159 */       IntRBTreeSet.Entry e;
/*      */       IntRBTreeSet.Entry e;
/* 1159 */       if (this.top) { e = IntRBTreeSet.this.lastEntry;
/*      */       } else {
/* 1161 */         e = IntRBTreeSet.this.locateKey(this.to);
/*      */ 
/* 1163 */         if (IntRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1166 */       if ((e == null) || ((!this.bottom) && (IntRBTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1167 */       return e;
/*      */     }
/*      */     public int firstInt() {
/* 1170 */       IntRBTreeSet.Entry e = firstEntry();
/* 1171 */       if (e == null) throw new NoSuchElementException();
/* 1172 */       return e.key;
/*      */     }
/*      */     public int lastInt() {
/* 1175 */       IntRBTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1187 */         super();
/* 1188 */         this.next = IntRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(int k) {
/* 1191 */         this();
/* 1192 */         if (this.next != null)
/* 1193 */           if ((!IntRBTreeSet.Subset.this.bottom) && (IntRBTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1194 */           } else if ((!IntRBTreeSet.Subset.this.top) && (IntRBTreeSet.this.compare(k, (this.prev = IntRBTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1196 */             this.next = IntRBTreeSet.this.locateKey(k);
/* 1197 */             if (IntRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1207 */         if ((!IntRBTreeSet.Subset.this.bottom) && (this.prev != null) && (IntRBTreeSet.this.compare(this.prev.key, IntRBTreeSet.Subset.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1210 */         this.next = this.next.next();
/* 1211 */         if ((!IntRBTreeSet.Subset.this.top) && (this.next != null) && (IntRBTreeSet.this.compare(this.next.key, IntRBTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*  963 */     int index = 0;
/*      */ 
/*  965 */     SetIterator() { this.next = IntRBTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(int k) {
/*  968 */       if ((this.next = IntRBTreeSet.this.locateKey(k)) != null)
/*  969 */         if (IntRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/*  988 */     public int nextInt() { return nextEntry().key; } 
/*  989 */     public int previousInt() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1012 */       updatePrevious();
/* 1013 */       updateNext();
/* 1014 */       IntRBTreeSet.this.remove(this.curr.key);
/* 1015 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
