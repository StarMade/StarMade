  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2LongOpenHashMap(int expected, float local_f)
  {
  ...
  public Int2LongOpenHashMap(Map<? extends Integer, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2LongOpenHashMap(Map<? extends Integer, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2LongOpenHashMap(Int2LongMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2LongOpenHashMap(Int2LongMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2LongOpenHashMap(int[] local_k, long[] local_v, float local_f)
  {
  ...
  public Int2LongOpenHashMap(int[] local_k, long[] local_v)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Int2LongOpenHashMap.ValueIterator(Int2LongOpenHashMap.this);
        }
        ...
        {
          return Int2LongOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2LongOpenHashMap local_c;
    try
    {
      local_c = (Int2LongOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2LongOpenHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Int2LongOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSet
  {
    ...
    {
      return new Int2LongOpenHashMap.KeyIterator(Int2LongOpenHashMap.this);
    }
    ...
    {
      return Int2LongOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2LongOpenHashMap.this.size;
      Int2LongOpenHashMap.this.remove(local_k);
    ...
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2LongOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2LongMap.FastEntrySet
  {
    ...
    {
      return new Int2LongOpenHashMap.EntryIterator(Int2LongOpenHashMap.this, null);
    }
    
    public ObjectIterator<Int2LongMap.Entry> fastIterator()
    {
      return new Int2LongOpenHashMap.FastEntryIterator(Int2LongOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2LongOpenHashMap.this.mask; Int2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongOpenHashMap.this.mask) {
        if (Int2LongOpenHashMap.this.key[pos] == local_k) {
          return Int2LongOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2LongOpenHashMap.this.mask; Int2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongOpenHashMap.this.mask) {
        if (Int2LongOpenHashMap.this.key[pos] == local_k)
        {
          Int2LongOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2LongMap.Entry>
  {
    ...
    public AbstractInt2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2LongOpenHashMap.this.key[local_e];
      this.entry.value = Int2LongOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Int2LongOpenHashMap.MapEntry(Int2LongOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2LongOpenHashMap.this.field_49;
    int last = -1;
    int field_2203 = Int2LongOpenHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2LongOpenHashMap.this.used;
      while ((this.field_2203 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2203 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2203 != 0)
      {
        boolean[] local_k = Int2LongOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2LongOpenHashMap.this.mask; Int2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2LongOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2LongOpenHashMap.this.key[pos]) & Int2LongOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2LongOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Int2LongOpenHashMap.this.key[pos]);
        }
        Int2LongOpenHashMap.this.key[last] = Int2LongOpenHashMap.this.key[pos];
        Int2LongOpenHashMap.this.value[last] = Int2LongOpenHashMap.this.value[pos];
      }
      Int2LongOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Int2LongOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
        this.last = -1;
        return;
      }
      Int2LongOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2203 > 0))
      {
        this.field_2203 += 1;
        nextEntry();
      }
    ...
    implements Int2LongMap.Entry, Map.Entry<Integer, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Int2LongOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Long> local_e = (Map.Entry)local_o;
      return (Int2LongOpenHashMap.this.key[this.index] == ((Integer)local_e.getKey()).intValue()) && (Int2LongOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
