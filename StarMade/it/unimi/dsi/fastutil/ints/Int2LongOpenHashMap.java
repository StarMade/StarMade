...
/*     */ 
/*     */ public class Int2LongOpenHashMap extends AbstractInt2LongMap
...
/* 642 */           return new Int2LongOpenHashMap.ValueIterator(Int2LongOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Int2LongOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(long v) {
/* 648 */           return Int2LongOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Int2LongOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Int2LongOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Int2LongOpenHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public long nextLong() { return Int2LongOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Long next() { return Long.valueOf(Int2LongOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Int2LongOpenHashMap.KeyIterator(Int2LongOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Int2LongOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(int k) {
/* 613 */       return Int2LongOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(int k) {
/* 616 */       int oldSize = Int2LongOpenHashMap.this.size;
/* 617 */       Int2LongOpenHashMap.this.remove(k);
/* 618 */       return Int2LongOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Int2LongOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Int2LongOpenHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public int nextInt() { return Int2LongOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Integer next() { return Integer.valueOf(Int2LongOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Int2LongOpenHashMap.EntryIterator(Int2LongOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Int2LongMap.Entry> fastIterator() {
/* 550 */       return new Int2LongOpenHashMap.FastEntryIterator(Int2LongOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Int2LongOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Int2LongOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Int2LongOpenHashMap.this.key[pos] == k) return Int2LongOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/* 562 */         pos = pos + 1 & Int2LongOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Int2LongOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Int2LongOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Int2LongOpenHashMap.this.key[pos] == k) {
/* 576 */           Int2LongOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Int2LongOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Int2LongOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Int2LongOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Int2LongOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Int2LongMap.Entry>
/*     */   {
/* 537 */     final AbstractInt2LongMap.BasicEntry entry = new AbstractInt2LongMap.BasicEntry(0, 0L);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Int2LongOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Int2LongOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Int2LongOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Int2LongMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Int2LongOpenHashMap.MapEntry(Int2LongOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Int2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Int2LongOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Int2LongOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Int2LongOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Int2LongOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Int2LongOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Int2LongOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Int2LongOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Int2LongOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Int2LongOpenHashMap.this.mask;
/* 485 */         while (Int2LongOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Int2LongOpenHashMap.this.key[pos]) & Int2LongOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Int2LongOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Int2LongOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 494 */           this.wrapped.add(Int2LongOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Int2LongOpenHashMap.this.key[last] = Int2LongOpenHashMap.this.key[pos];
/* 497 */         Int2LongOpenHashMap.this.value[last] = Int2LongOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Int2LongOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Int2LongOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Int2LongOpenHashMap.this.size -= 1;
...
/* 398 */       return Integer.valueOf(Int2LongOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public int getIntKey() {
/* 401 */       return Int2LongOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Long getValue() {
/* 404 */       return Long.valueOf(Int2LongOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public long getLongValue() {
/* 407 */       return Int2LongOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public long setValue(long v) {
/* 410 */       long oldValue = Int2LongOpenHashMap.this.value[this.index];
/* 411 */       Int2LongOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Long setValue(Long v) {
...
/* 421 */       return (Int2LongOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Int2LongOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Int2LongOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 427 */       return Int2LongOpenHashMap.this.key[this.index] + "=>" + Int2LongOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
