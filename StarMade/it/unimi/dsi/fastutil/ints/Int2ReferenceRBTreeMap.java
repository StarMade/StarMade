...
/*  119 */           return Int2ReferenceRBTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  122 */           return Int2ReferenceRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     Object oldValue = put(ok.intValue(), ov);
/*  731 */     return this.modified ? this.defRetValue : oldValue;
/*      */   }
/*      */ 
/*      */   public V remove(Object ok)
/*      */   {
/*  737 */     Object oldValue = remove(((Integer)ok).intValue());
...
/* 1118 */         final Comparator<? super Int2ReferenceMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Int2ReferenceMap.Entry<V> x, Int2ReferenceMap.Entry<V> y) {
/* 1120 */             return Int2ReferenceRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Int2ReferenceRBTreeMap.EntryIterator(Int2ReferenceRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from) {
/* 1130 */           return new Int2ReferenceRBTreeMap.EntryIterator(Int2ReferenceRBTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Int2ReferenceRBTreeMap.Entry f = Int2ReferenceRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1143 */           Int2ReferenceRBTreeMap.Entry f = Int2ReferenceRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1144 */           if (f != null) Int2ReferenceRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Int2ReferenceRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Int2ReferenceRBTreeMap.this.clear(); } 
/* 1149 */         public Int2ReferenceMap.Entry<V> first() { return Int2ReferenceRBTreeMap.this.firstEntry; } 
/* 1150 */         public Int2ReferenceMap.Entry<V> last() { return Int2ReferenceRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Int2ReferenceMap.Entry<V>> subSet(Int2ReferenceMap.Entry<V> from, Int2ReferenceMap.Entry<V> to) { return Int2ReferenceRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2ReferenceEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> to) { return Int2ReferenceRBTreeMap.this.headMap((Integer)to.getKey()).int2ReferenceEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> from) { return Int2ReferenceRBTreeMap.this.tailMap((Integer)from.getKey()).int2ReferenceEntrySet(); }
/*      */       };
...
/* 1215 */           return new Int2ReferenceRBTreeMap.ValueIterator(Int2ReferenceRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Int2ReferenceRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Int2ReferenceRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Int2ReferenceRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/* 1233 */     return new Submap(0, true, to, false);
/*      */   }
/*      */   public Int2ReferenceSortedMap<V> tailMap(int from) {
/* 1236 */     return new Submap(from, false, 0, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1580 */       c = (Int2ReferenceRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1652 */     if (n == 1) {
/* 1653 */       Entry top = new Entry(s.readInt(), s.readObject());
/* 1654 */       top.pred(pred);
/* 1655 */       top.succ(succ);
/* 1656 */       top.black(true);
/* 1657 */       return top;
...
/* 1659 */     if (n == 2)
/*      */     {
/* 1662 */       Entry top = new Entry(s.readInt(), s.readObject());
/* 1663 */       top.black(true);
/* 1664 */       top.right(new Entry(s.readInt(), s.readObject()));
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Int2ReferenceRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Int2ReferenceRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2ReferenceRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator() {
/* 1302 */             return new Int2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Int2ReferenceRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from) {
/* 1305 */             return new Int2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Int2ReferenceRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1307 */           public Comparator<? super Int2ReferenceMap.Entry<V>> comparator() { return Int2ReferenceRBTreeMap.this.int2ReferenceEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Int2ReferenceRBTreeMap.Entry f = Int2ReferenceRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1313 */             return (f != null) && (Int2ReferenceRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Int2ReferenceRBTreeMap.Entry f = Int2ReferenceRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1320 */             if ((f != null) && (Int2ReferenceRBTreeMap.Submap.this.in(f.key))) Int2ReferenceRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Int2ReferenceRBTreeMap.Submap.SubmapIterator(Int2ReferenceRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Int2ReferenceRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Int2ReferenceMap.Entry<V> first() { return Int2ReferenceRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Int2ReferenceMap.Entry<V> last() { return Int2ReferenceRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Int2ReferenceMap.Entry<V>> subSet(Int2ReferenceMap.Entry<V> from, Int2ReferenceMap.Entry<V> to) { return Int2ReferenceRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2ReferenceEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> to) { return Int2ReferenceRBTreeMap.Submap.this.headMap((Integer)to.getKey()).int2ReferenceEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> from) { return Int2ReferenceRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2ReferenceEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Int2ReferenceRBTreeMap.Submap.SubmapValueIterator(Int2ReferenceRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Int2ReferenceRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Int2ReferenceRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Int2ReferenceRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1365 */       return (in(k)) && (Int2ReferenceRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       int kk = k;
/*      */       Int2ReferenceRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Int2ReferenceRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(int k, V v) {
/* 1383 */       Int2ReferenceRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Int2ReferenceRBTreeMap.this.put(k, v);
/* 1386 */       return Int2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Integer ok, V ov) {
/* 1389 */       Object oldValue = put(ok.intValue(), ov);
/* 1390 */       return Int2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(int k) {
/* 1394 */       Int2ReferenceRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Int2ReferenceRBTreeMap.this.remove(k);
/* 1397 */       return Int2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Integer)ok).intValue());
/* 1401 */       return Int2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1416 */       return Int2ReferenceRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2ReferenceSortedMap<V> headMap(int to) {
/* 1419 */       if (this.top) return new Submap(Int2ReferenceRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Int2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2ReferenceRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2ReferenceSortedMap<V> tailMap(int from) {
/* 1423 */       if (this.bottom) return new Submap(Int2ReferenceRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Int2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2ReferenceRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2ReferenceSortedMap<V> subMap(int from, int to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Int2ReferenceRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Int2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Int2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Int2ReferenceRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2ReferenceRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Int2ReferenceRBTreeMap.this.tree == null) return null;
/* 1441 */       Int2ReferenceRBTreeMap.Entry e;
/*      */       Int2ReferenceRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Int2ReferenceRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Int2ReferenceRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Int2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Int2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2ReferenceRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Int2ReferenceRBTreeMap.this.tree == null) return null;
/* 1459 */       Int2ReferenceRBTreeMap.Entry e;
/*      */       Int2ReferenceRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Int2ReferenceRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Int2ReferenceRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Int2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Int2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1470 */       Int2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1475 */       Int2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1480 */       Int2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1485 */       Int2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2ReferenceRBTreeMap.Submap.SubmapIterator
/*      */       implements IntListIterator
/*      */     {
/*      */       public SubmapKeyIterator()
/*      */       {
/* 1543 */         super(); } 
/* 1544 */       public SubmapKeyIterator(int from) { super(from); } 
/* 1545 */       public int nextInt() { return nextEntry().key; } 
/* 1546 */       public int previousInt() { return previousEntry().key; } 
/* 1547 */       public void set(int k) { throw new UnsupportedOperationException(); } 
/* 1548 */       public void add(int k) { throw new UnsupportedOperationException(); } 
/* 1549 */       public Integer next() { return Integer.valueOf(nextEntry().key); } 
/* 1550 */       public Integer previous() { return Integer.valueOf(previousEntry().key); } 
/* 1551 */       public void set(Integer ok) { throw new UnsupportedOperationException(); } 
/* 1552 */       public void add(Integer ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/* 1525 */         super();
/*      */       }
/* 1527 */       SubmapEntryIterator(int k) { super(k); } 
/*      */       public Int2ReferenceMap.Entry<V> next() {
/* 1529 */         return nextEntry(); } 
/* 1530 */       public Int2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Int2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Int2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Int2ReferenceRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Int2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Int2ReferenceRBTreeMap.Submap.this.bottom) && (Int2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Int2ReferenceRBTreeMap.Submap.this.top) && (Int2ReferenceRBTreeMap.this.compare(k, (this.prev = Int2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Int2ReferenceRBTreeMap.this.locateKey(k);
/* 1507 */             if (Int2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Int2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2ReferenceRBTreeMap.this.compare(this.prev.key, Int2ReferenceRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Int2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Int2ReferenceRBTreeMap.this.compare(this.next.key, Int2ReferenceRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public IntBidirectionalIterator iterator() { return new Int2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Int2ReferenceRBTreeMap.Submap.this); } 
/* 1340 */       public IntBidirectionalIterator iterator(int from) { return new Int2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Int2ReferenceRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public IntBidirectionalIterator iterator() { return new Int2ReferenceRBTreeMap.KeyIterator(Int2ReferenceRBTreeMap.this); } 
/* 1178 */     public IntBidirectionalIterator iterator(int from) { return new Int2ReferenceRBTreeMap.KeyIterator(Int2ReferenceRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2ReferenceRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1164 */       super(); } 
/* 1165 */     public KeyIterator(int k) { super(k); } 
/* 1166 */     public int nextInt() { return nextEntry().key; } 
/* 1167 */     public int previousInt() { return previousEntry().key; } 
/* 1168 */     public void set(int k) { throw new UnsupportedOperationException(); } 
/* 1169 */     public void add(int k) { throw new UnsupportedOperationException(); } 
/* 1170 */     public Integer next() { return Integer.valueOf(nextEntry().key); } 
/* 1171 */     public Integer previous() { return Integer.valueOf(previousEntry().key); } 
/* 1172 */     public void set(Integer ok) { throw new UnsupportedOperationException(); } 
/* 1173 */     public void add(Integer ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Int2ReferenceMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
/* 1107 */       super();
/*      */     }
/* 1109 */     EntryIterator(int k) { super(k); } 
/*      */     public Int2ReferenceMap.Entry<V> next() {
/* 1111 */       return nextEntry(); } 
/* 1112 */     public Int2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Int2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Int2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Int2ReferenceRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1044 */       if ((this.next = Int2ReferenceRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Int2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Int2ReferenceRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == e.getValue());
/*      */     }
/*      */     public int hashCode() {
