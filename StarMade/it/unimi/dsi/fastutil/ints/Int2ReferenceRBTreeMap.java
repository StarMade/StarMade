  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2ReferenceRBTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2ReferenceRBTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2ReferenceRBTreeMap(Map<? extends Integer, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ReferenceRBTreeMap(SortedMap<Integer, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ReferenceRBTreeMap(Int2ReferenceMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ReferenceRBTreeMap(Int2ReferenceSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ReferenceRBTreeMap(int[] local_k, V[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2ReferenceRBTreeMap(int[] local_k, V[] local_v)
  {
  ...
  {
    Int2ReferenceRBTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2ReferenceMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Int2ReferenceRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2ReferenceRBTreeMap.EntryIterator(Int2ReferenceRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from)
        {
          return new Int2ReferenceRBTreeMap.EntryIterator(Int2ReferenceRBTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2ReferenceRBTreeMap.Entry<V> local_f = Int2ReferenceRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2ReferenceRBTreeMap.Entry<V> local_f = Int2ReferenceRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2ReferenceRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2ReferenceRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> local_to)
        {
          return Int2ReferenceRBTreeMap.this.headMap((Integer)local_to.getKey()).int2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> from)
        {
          return Int2ReferenceRBTreeMap.this.tailMap((Integer)from.getKey()).int2ReferenceEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Int2ReferenceRBTreeMap.ValueIterator(Int2ReferenceRBTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Int2ReferenceRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2ReferenceRBTreeMap<V> local_c;
    try
    {
      local_c = (Int2ReferenceRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Int2ReferenceRBTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2ReferenceRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Int2ReferenceRBTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Int2ReferenceRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2ReferenceRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator()
          {
            return new Int2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Int2ReferenceRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from)
          {
            return new Int2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Int2ReferenceRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
            Int2ReferenceRBTreeMap.Entry<V> local_f = Int2ReferenceRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2ReferenceRBTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
            Int2ReferenceRBTreeMap.Entry<V> local_f = Int2ReferenceRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2ReferenceRBTreeMap.Submap.this.in4(local_f.key))) {
              Int2ReferenceRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2ReferenceRBTreeMap.Submap.SubmapIterator(Int2ReferenceRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2ReferenceRBTreeMap.Submap.this.clear();
          }
          
          public Int2ReferenceMap.Entry<V> first()
          {
            return Int2ReferenceRBTreeMap.Submap.this.firstEntry();
          }
          
          public Int2ReferenceMap.Entry<V> last()
          {
            return Int2ReferenceRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2ReferenceMap.Entry<V>> subSet(Int2ReferenceMap.Entry<V> from, Int2ReferenceMap.Entry<V> local_to)
          {
            return Int2ReferenceRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> local_to)
          {
            return Int2ReferenceRBTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> from)
          {
            return Int2ReferenceRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2ReferenceEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ReferenceCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractReferenceCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Int2ReferenceRBTreeMap.Submap.SubmapValueIterator(Int2ReferenceRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Int2ReferenceRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2ReferenceRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2ReferenceRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2ReferenceRBTreeMap.Entry<V> local_e;
      return (in4(local_kk)) && ((local_e = Int2ReferenceRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(int local_k, V local_v)
    {
      ...
      V oldValue = Int2ReferenceRBTreeMap.this.put(local_k, local_v);
    ...
    public V remove(int local_k)
    {
      ...
      V oldValue = Int2ReferenceRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2ReferenceSortedMap<V> tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2ReferenceRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2ReferenceRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2ReferenceSortedMap<V> subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2ReferenceRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2ReferenceRBTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2ReferenceRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2ReferenceRBTreeMap.this.locateKey(this.from);
        if (Int2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2ReferenceRBTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2ReferenceRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2ReferenceRBTreeMap.this.locateKey(this.field_47);
        if (Int2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2ReferenceRBTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2ReferenceRBTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Int2ReferenceRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Int2ReferenceRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Int2ReferenceRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2ReferenceRBTreeMap.Submap.this.bottom) && (Int2ReferenceRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2ReferenceRBTreeMap.Submap.this.top) && (Int2ReferenceRBTreeMap.this.compare(local_k, (this.prev = Int2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2ReferenceRBTreeMap.this.locateKey(local_k);
            if (Int2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2ReferenceRBTreeMap.this.compare(this.prev.key, Int2ReferenceRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Int2ReferenceRBTreeMap.this.compare(this.next.key, Int2ReferenceRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2ReferenceSortedMap.KeySet
    {
      ...
      {
        return new Int2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Int2ReferenceRBTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Int2ReferenceRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2ReferenceSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2ReferenceRBTreeMap.KeyIterator(Int2ReferenceRBTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2ReferenceRBTreeMap.KeyIterator(Int2ReferenceRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2ReferenceRBTreeMap.this.locateKey(local_k)) != null) {
        if (Int2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
