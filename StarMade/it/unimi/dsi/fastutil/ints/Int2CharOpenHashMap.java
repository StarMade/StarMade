...
/*  18:    */
/*  87:    */public class Int2CharOpenHashMap
/*  88:    */  extends AbstractInt2CharMap
...
/* 101:    */  protected volatile transient Int2CharMap.FastEntrySet entries;
/* 102:    */  protected volatile transient IntSet keys;
/* 103:    */  protected volatile transient CharCollection values;
/* 104:    */  
/* 105:    */  public Int2CharOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Int2CharOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Int2CharOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Int2CharOpenHashMap(Map<? extends Integer, ? extends Character> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Int2CharOpenHashMap(Map<? extends Integer, ? extends Character> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Int2CharOpenHashMap(Int2CharMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Int2CharOpenHashMap(Int2CharMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Int2CharOpenHashMap(int[] k, char[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Int2CharOpenHashMap(int[] k, char[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public char put(int k, char v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Character put(Integer ok, Character ov) { char v = ov.charValue();
...
/* 282:    */  }
/* 283:    */  
/* 284:284 */  public Character get(Integer ok) { int k = ok.intValue();
/* 285:    */    
...
/* 359:    */    implements Int2CharMap.Entry, Map.Entry<Integer, Character>
/* 360:    */  {
...
/* 366:    */    }
/* 367:    */    
/* 368:368 */    public Integer getKey() { return Integer.valueOf(Int2CharOpenHashMap.this.key[this.index]); }
/* 369:    */    
/* 370:    */    public int getIntKey() {
/* 371:371 */      return Int2CharOpenHashMap.this.key[this.index];
/* 372:    */    }
/* 373:    */    
/* 374:374 */    public Character getValue() { return Character.valueOf(Int2CharOpenHashMap.this.value[this.index]); }
/* 375:    */    
/* 377:377 */    public char getCharValue() { return Int2CharOpenHashMap.this.value[this.index]; }
/* 378:    */    
/* 379:    */    public char setValue(char v) {
/* 380:380 */      char oldValue = Int2CharOpenHashMap.this.value[this.index];
/* 381:381 */      Int2CharOpenHashMap.this.value[this.index] = v;
...
/* 390:390 */      Map.Entry<Integer, Character> e = (Map.Entry)o;
/* 391:391 */      return (Int2CharOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public int hashCode() { return Int2CharOpenHashMap.this.key[this.index] ^ Int2CharOpenHashMap.this.value[this.index]; }
/* 395:    */    
/* 397:397 */    public String toString() { return Int2CharOpenHashMap.this.key[this.index] + "=>" + Int2CharOpenHashMap.this.value[this.index]; } }
/* 398:    */  
...
/* 403:    */    
/* 404:404 */    private MapIterator() { this.pos = Int2CharOpenHashMap.this.n;
/* 405:    */      
/* 407:407 */      this.last = -1;
/* 408:    */      
/* 409:409 */      this.c = Int2CharOpenHashMap.this.size;
/* 410:    */      
/* 414:414 */      boolean[] used = Int2CharOpenHashMap.this.used;
...
/* 426:    */        
/* 427:427 */        int pos = HashCommon.murmurHash3(k) & Int2CharOpenHashMap.this.mask;
/* 428:    */        
/* 429:429 */        while (Int2CharOpenHashMap.this.used[pos] != 0) {
/* 430:430 */          if (Int2CharOpenHashMap.this.key[pos] == k) return pos;
/* 431:431 */          pos = pos + 1 & Int2CharOpenHashMap.this.mask;
/* 432:    */        }
/* 433:    */      }
/* 434:434 */      this.last = this.pos;
/* 435:    */      
/* 436:436 */      if (this.c != 0) {
/* 437:437 */        boolean[] used = Int2CharOpenHashMap.this.used;
...
/* 452:    */      for (;;)
/* 453:    */      {
/* 454:454 */        pos = (last = pos) + 1 & Int2CharOpenHashMap.this.mask;
/* 455:455 */        while (Int2CharOpenHashMap.this.used[pos] != 0) {
/* 456:456 */          int slot = HashCommon.murmurHash3(Int2CharOpenHashMap.this.key[pos]) & Int2CharOpenHashMap.this.mask;
/* 457:457 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 458:458 */          pos = pos + 1 & Int2CharOpenHashMap.this.mask;
/* 459:    */        }
/* 460:460 */        if (Int2CharOpenHashMap.this.used[pos] == 0) break;
/* 461:461 */        if (pos < last)
/* 462:    */        {
/* 463:463 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 464:464 */          this.wrapped.add(Int2CharOpenHashMap.this.key[pos]);
/* 465:    */        }
/* 466:466 */        Int2CharOpenHashMap.this.key[last] = Int2CharOpenHashMap.this.key[pos];
/* 467:467 */        Int2CharOpenHashMap.this.value[last] = Int2CharOpenHashMap.this.value[pos];
/* 468:    */      }
/* 469:469 */      Int2CharOpenHashMap.this.used[last] = false;
/* 470:470 */      return last;
/* 471:    */    }
/* 472:    */    
...
/* 476:    */      {
/* 477:477 */        Int2CharOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 478:478 */        this.last = -1;
/* 479:479 */        return;
/* 480:    */      }
/* 481:481 */      Int2CharOpenHashMap.this.size -= 1;
...
/* 493:    */    } }
/* 494:    */  
/* 495:495 */  private class EntryIterator extends Int2CharOpenHashMap.MapIterator implements ObjectIterator<Int2CharMap.Entry> { private EntryIterator() { super(null); }
/* 496:    */    
/* 497:    */    private Int2CharOpenHashMap.MapEntry entry;
/* 498:498 */    public Int2CharMap.Entry next() { return this.entry = new Int2CharOpenHashMap.MapEntry(Int2CharOpenHashMap.this, nextEntry()); }
/* 499:    */    
/* 500:    */    public void remove()
/* 501:    */    {
/* 502:502 */      super.remove();
/* 503:503 */      Int2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 504:    */    } }
/* 505:    */  
/* 506:506 */  private class FastEntryIterator extends Int2CharOpenHashMap.MapIterator implements ObjectIterator<Int2CharMap.Entry> { private FastEntryIterator() { super(null); }
/* 507:507 */    final AbstractInt2CharMap.BasicEntry entry = new AbstractInt2CharMap.BasicEntry(0, '\000');
/* 508:    */    
/* 509:509 */    public AbstractInt2CharMap.BasicEntry next() { int e = nextEntry();
/* 510:510 */      this.entry.key = Int2CharOpenHashMap.this.key[e];
/* 511:511 */      this.entry.value = Int2CharOpenHashMap.this.value[e];
/* 512:512 */      return this.entry;
/* 513:    */    } }
/* 514:    */  
/* 515:    */  private final class MapEntrySet extends AbstractObjectSet<Int2CharMap.Entry> implements Int2CharMap.FastEntrySet { private MapEntrySet() {}
/* 516:    */    
/* 517:517 */    public ObjectIterator<Int2CharMap.Entry> iterator() { return new Int2CharOpenHashMap.EntryIterator(Int2CharOpenHashMap.this, null); }
/* 518:    */    
/* 519:    */    public ObjectIterator<Int2CharMap.Entry> fastIterator() {
/* 520:520 */      return new Int2CharOpenHashMap.FastEntryIterator(Int2CharOpenHashMap.this, null);
/* 521:    */    }
/* 522:    */    
/* 523:    */    public boolean contains(Object o) {
/* 524:524 */      if (!(o instanceof Map.Entry)) return false;
/* 525:525 */      Map.Entry<Integer, Character> e = (Map.Entry)o;
/* 526:526 */      int k = ((Integer)e.getKey()).intValue();
/* 527:    */      
/* 528:528 */      int pos = HashCommon.murmurHash3(k) & Int2CharOpenHashMap.this.mask;
/* 529:    */      
/* 530:530 */      while (Int2CharOpenHashMap.this.used[pos] != 0) {
/* 531:531 */        if (Int2CharOpenHashMap.this.key[pos] == k) return Int2CharOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 532:532 */        pos = pos + 1 & Int2CharOpenHashMap.this.mask;
/* 533:    */      }
...
/* 539:539 */      Map.Entry<Integer, Character> e = (Map.Entry)o;
/* 540:540 */      int k = ((Integer)e.getKey()).intValue();
/* 541:    */      
/* 542:542 */      int pos = HashCommon.murmurHash3(k) & Int2CharOpenHashMap.this.mask;
/* 543:    */      
/* 544:544 */      while (Int2CharOpenHashMap.this.used[pos] != 0) {
/* 545:545 */        if (Int2CharOpenHashMap.this.key[pos] == k) {
/* 546:546 */          Int2CharOpenHashMap.this.remove(e.getKey());
/* 547:547 */          return true;
/* 548:    */        }
/* 549:549 */        pos = pos + 1 & Int2CharOpenHashMap.this.mask;
/* 550:    */      }
/* 551:551 */      return false;
/* 552:    */    }
/* 553:    */    
/* 554:554 */    public int size() { return Int2CharOpenHashMap.this.size; }
/* 555:    */    
/* 557:557 */    public void clear() { Int2CharOpenHashMap.this.clear(); }
/* 558:    */  }
/* 559:    */  
/* 560:    */  public Int2CharMap.FastEntrySet int2CharEntrySet() {
...
/* 568:    */    extends Int2CharOpenHashMap.MapIterator
/* 569:    */    implements IntIterator
/* 570:    */  {
/* 571:571 */    public KeyIterator() { super(null); }
/* 572:572 */    public int nextInt() { return Int2CharOpenHashMap.this.key[nextEntry()]; }
/* 573:573 */    public Integer next() { return Integer.valueOf(Int2CharOpenHashMap.this.key[nextEntry()]); } }
/* 574:    */  
/* 575:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 576:    */    
/* 577:577 */    public IntIterator iterator() { return new Int2CharOpenHashMap.KeyIterator(Int2CharOpenHashMap.this); }
/* 578:    */    
/* 579:    */    public int size() {
/* 580:580 */      return Int2CharOpenHashMap.this.size;
/* 581:    */    }
/* 582:    */    
/* 583:583 */    public boolean contains(int k) { return Int2CharOpenHashMap.this.containsKey(k); }
/* 584:    */    
/* 585:    */    public boolean remove(int k) {
/* 586:586 */      int oldSize = Int2CharOpenHashMap.this.size;
/* 587:587 */      Int2CharOpenHashMap.this.remove(k);
/* 588:588 */      return Int2CharOpenHashMap.this.size != oldSize;
/* 589:    */    }
/* 590:    */    
/* 591:591 */    public void clear() { Int2CharOpenHashMap.this.clear(); }
/* 592:    */  }
/* 593:    */  
...
/* 602:    */    extends Int2CharOpenHashMap.MapIterator
/* 603:    */    implements CharIterator
/* 604:    */  {
/* 605:605 */    public ValueIterator() { super(null); }
/* 606:606 */    public char nextChar() { return Int2CharOpenHashMap.this.value[nextEntry()]; }
/* 607:607 */    public Character next() { return Character.valueOf(Int2CharOpenHashMap.this.value[nextEntry()]); }
/* 608:    */  }
/* 609:    */  
...
/* 612:612 */          return new Int2CharOpenHashMap.ValueIterator(Int2CharOpenHashMap.this);
/* 613:    */        }
/* 614:    */        
/* 615:615 */        public int size() { return Int2CharOpenHashMap.this.size; }
/* 616:    */        
/* 617:    */        public boolean contains(char v) {
/* 618:618 */          return Int2CharOpenHashMap.this.containsValue(v);
/* 619:    */        }
/* 620:    */        
/* 621:621 */        public void clear() { Int2CharOpenHashMap.this.clear(); }
/* 622:    */      };
/* 623:    */    }
...
/* 724:    */  }
/* 725:    */  
/* 729:    */  public Int2CharOpenHashMap clone()
/* 730:    */  {
/* 731:    */    Int2CharOpenHashMap c;
/* 732:    */    
/* 734:    */    try
/* 735:    */    {
/* 736:736 */      c = (Int2CharOpenHashMap)super.clone();
/* 737:    */    }
