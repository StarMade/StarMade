  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2CharOpenHashMap(int expected, float local_f)
  {
  ...
  public Int2CharOpenHashMap(Map<? extends Integer, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2CharOpenHashMap(Map<? extends Integer, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2CharOpenHashMap(Int2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2CharOpenHashMap(Int2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2CharOpenHashMap(int[] local_k, char[] local_v, float local_f)
  {
  ...
  public Int2CharOpenHashMap(int[] local_k, char[] local_v)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Int2CharOpenHashMap.ValueIterator(Int2CharOpenHashMap.this);
        }
        ...
        {
          return Int2CharOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2CharOpenHashMap local_c;
    try
    {
      local_c = (Int2CharOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2CharOpenHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Int2CharOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSet
  {
    ...
    {
      return new Int2CharOpenHashMap.KeyIterator(Int2CharOpenHashMap.this);
    }
    ...
    {
      return Int2CharOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2CharOpenHashMap.this.size;
      Int2CharOpenHashMap.this.remove(local_k);
    ...
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2CharOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2CharMap.FastEntrySet
  {
    ...
    {
      return new Int2CharOpenHashMap.EntryIterator(Int2CharOpenHashMap.this, null);
    }
    
    public ObjectIterator<Int2CharMap.Entry> fastIterator()
    {
      return new Int2CharOpenHashMap.FastEntryIterator(Int2CharOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2CharOpenHashMap.this.mask; Int2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2CharOpenHashMap.this.mask) {
        if (Int2CharOpenHashMap.this.key[pos] == local_k) {
          return Int2CharOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2CharOpenHashMap.this.mask; Int2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2CharOpenHashMap.this.mask) {
        if (Int2CharOpenHashMap.this.key[pos] == local_k)
        {
          Int2CharOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2CharMap.Entry>
  {
    ...
    public AbstractInt2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2CharOpenHashMap.this.key[local_e];
      this.entry.value = Int2CharOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Int2CharOpenHashMap.MapEntry(Int2CharOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2CharOpenHashMap.this.field_49;
    int last = -1;
    int field_514 = Int2CharOpenHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2CharOpenHashMap.this.used;
      while ((this.field_514 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_514 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      if (this.field_514 != 0)
      {
        boolean[] local_k = Int2CharOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2CharOpenHashMap.this.mask; Int2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2CharOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2CharOpenHashMap.this.key[pos]) & Int2CharOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2CharOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Int2CharOpenHashMap.this.key[pos]);
        }
        Int2CharOpenHashMap.this.key[last] = Int2CharOpenHashMap.this.key[pos];
        Int2CharOpenHashMap.this.value[last] = Int2CharOpenHashMap.this.value[pos];
      }
      Int2CharOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Int2CharOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
        this.last = -1;
        return;
      }
      Int2CharOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_514 > 0))
      {
        this.field_514 += 1;
        nextEntry();
      }
    ...
    implements Int2CharMap.Entry, Map.Entry<Integer, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Int2CharOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Character> local_e = (Map.Entry)local_o;
      return (Int2CharOpenHashMap.this.key[this.index] == ((Integer)local_e.getKey()).intValue()) && (Int2CharOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
