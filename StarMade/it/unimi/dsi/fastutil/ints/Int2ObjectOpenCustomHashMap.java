  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2ObjectOpenCustomHashMap(int expected, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2ObjectOpenCustomHashMap(Map<? extends Integer, ? extends V> local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2ObjectOpenCustomHashMap(Map<? extends Integer, ? extends V> local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2ObjectOpenCustomHashMap(Int2ObjectMap<V> local_m, float local_f, IntHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Int2ObjectOpenCustomHashMap(Int2ObjectMap<V> local_m, IntHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Int2ObjectOpenCustomHashMap(int[] local_k, V[] local_v, float local_f, IntHash.Strategy strategy)
  {
  ...
  public Int2ObjectOpenCustomHashMap(int[] local_k, V[] local_v, IntHash.Strategy strategy)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Int2ObjectOpenCustomHashMap.ValueIterator(Int2ObjectOpenCustomHashMap.this);
        }
        ...
        {
          return Int2ObjectOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2ObjectOpenCustomHashMap<V> local_c;
    try
    {
      local_c = (Int2ObjectOpenCustomHashMap)super.clone();
    }
    ...
    throws IOException
  {
    int[] key = this.key;
    V[] value = this.value;
    Int2ObjectOpenCustomHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractIntSet
  {
    ...
    {
      return new Int2ObjectOpenCustomHashMap.KeyIterator(Int2ObjectOpenCustomHashMap.this);
    }
    ...
    {
      return Int2ObjectOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2ObjectOpenCustomHashMap.this.size;
      Int2ObjectOpenCustomHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Int2ObjectOpenCustomHashMap.MapIterator
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2ObjectOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2ObjectMap.FastEntrySet<V>
  {
    ...
    {
      return new Int2ObjectOpenCustomHashMap.EntryIterator(Int2ObjectOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Int2ObjectMap.Entry<V>> fastIterator()
    {
      return new Int2ObjectOpenCustomHashMap.FastEntryIterator(Int2ObjectOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2ObjectOpenCustomHashMap.this.mask; Int2ObjectOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask) {
        if (Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[pos], local_k)) {
          return Int2ObjectOpenCustomHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Int2ObjectOpenCustomHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(local_k)) & Int2ObjectOpenCustomHashMap.this.mask; Int2ObjectOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask) {
        if (Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[pos], local_k))
        {
          Int2ObjectOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2ObjectMap.Entry<V>>
  {
    ...
    public AbstractInt2ObjectMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Int2ObjectOpenCustomHashMap.this.key[local_e];
      this.entry.value = Int2ObjectOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2ObjectMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Int2ObjectOpenCustomHashMap.MapEntry(Int2ObjectOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2ObjectOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2ObjectOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2210 = Int2ObjectOpenCustomHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2ObjectOpenCustomHashMap.this.used;
      while ((this.field_2210 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2210 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2210 != 0)
      {
        boolean[] local_k = Int2ObjectOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2ObjectOpenCustomHashMap.this.mask; Int2ObjectOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(Int2ObjectOpenCustomHashMap.this.key[pos])) & Int2ObjectOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2ObjectOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Int2ObjectOpenCustomHashMap.this.key[pos]);
        }
        Int2ObjectOpenCustomHashMap.this.key[last] = Int2ObjectOpenCustomHashMap.this.key[pos];
        Int2ObjectOpenCustomHashMap.this.value[last] = Int2ObjectOpenCustomHashMap.this.value[pos];
      }
      Int2ObjectOpenCustomHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Int2ObjectOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
        this.last = -1;
        return;
      }
      Int2ObjectOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2210 > 0))
      {
        this.field_2210 += 1;
        nextEntry();
      }
    ...
    implements Int2ObjectMap.Entry<V>, Map.Entry<Integer, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Int2ObjectOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
      return (Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[this.index], ((Integer)local_e.getKey()).intValue())) && (Int2ObjectOpenCustomHashMap.this.value[this.index] == null ? local_e.getValue() == null : Int2ObjectOpenCustomHashMap.this.value[this.index].equals(local_e.getValue()));
    }
