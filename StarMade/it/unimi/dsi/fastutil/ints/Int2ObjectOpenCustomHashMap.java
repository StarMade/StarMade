...
/*  18:    */
/*  89:    */public class Int2ObjectOpenCustomHashMap<V>
/*  90:    */  extends AbstractInt2ObjectMap<V>
...
/* 103:    */  protected volatile transient Int2ObjectMap.FastEntrySet<V> entries;
...
/* 107:    */  
/* 108:    */  public Int2ObjectOpenCustomHashMap(int expected, float f, IntHash.Strategy strategy)
/* 109:    */  {
...
/* 120:    */  }
/* 121:    */  
/* 125:    */  public Int2ObjectOpenCustomHashMap(int expected, IntHash.Strategy strategy)
/* 126:    */  {
/* 127:127 */    this(expected, 0.75F, strategy);
/* 128:    */  }
/* 129:    */  
/* 132:    */  public Int2ObjectOpenCustomHashMap(IntHash.Strategy strategy)
/* 133:    */  {
/* 134:134 */    this(16, 0.75F, strategy);
/* 135:    */  }
/* 136:    */  
/* 141:    */  public Int2ObjectOpenCustomHashMap(Map<? extends Integer, ? extends V> m, float f, IntHash.Strategy strategy)
/* 142:    */  {
/* 143:143 */    this(m.size(), f, strategy);
/* 144:144 */    putAll(m);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Int2ObjectOpenCustomHashMap(Map<? extends Integer, ? extends V> m, IntHash.Strategy strategy)
/* 151:    */  {
/* 152:152 */    this(m, 0.75F, strategy);
/* 153:    */  }
/* 154:    */  
/* 159:    */  public Int2ObjectOpenCustomHashMap(Int2ObjectMap<V> m, float f, IntHash.Strategy strategy)
/* 160:    */  {
/* 161:161 */    this(m.size(), f, strategy);
/* 162:162 */    putAll(m);
/* 163:    */  }
/* 164:    */  
/* 168:    */  public Int2ObjectOpenCustomHashMap(Int2ObjectMap<V> m, IntHash.Strategy strategy)
/* 169:    */  {
/* 170:170 */    this(m, 0.75F, strategy);
/* 171:    */  }
/* 172:    */  
/* 179:    */  public Int2ObjectOpenCustomHashMap(int[] k, V[] v, float f, IntHash.Strategy strategy)
/* 180:    */  {
...
/* 185:    */  }
/* 186:    */  
/* 191:    */  public Int2ObjectOpenCustomHashMap(int[] k, V[] v, IntHash.Strategy strategy)
/* 192:    */  {
...
/* 380:    */    implements Int2ObjectMap.Entry<V>, Map.Entry<Integer, V>
/* 381:    */  {
...
/* 387:    */    }
/* 388:    */    
/* 389:389 */    public Integer getKey() { return Integer.valueOf(Int2ObjectOpenCustomHashMap.this.key[this.index]); }
/* 390:    */    
/* 391:    */    public int getIntKey() {
/* 392:392 */      return Int2ObjectOpenCustomHashMap.this.key[this.index];
/* 393:    */    }
/* 394:    */    
/* 395:395 */    public V getValue() { return Int2ObjectOpenCustomHashMap.this.value[this.index]; }
/* 396:    */    
/* 397:    */    public V setValue(V v) {
/* 398:398 */      V oldValue = Int2ObjectOpenCustomHashMap.this.value[this.index];
/* 399:399 */      Int2ObjectOpenCustomHashMap.this.value[this.index] = v;
...
/* 406:406 */      return (Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[this.index], ((Integer)e.getKey()).intValue())) && (Int2ObjectOpenCustomHashMap.this.value[this.index] == null ? e.getValue() == null : Int2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()));
/* 407:    */    }
/* 408:    */    
/* 409:409 */    public int hashCode() { return Int2ObjectOpenCustomHashMap.this.strategy.hashCode(Int2ObjectOpenCustomHashMap.this.key[this.index]) ^ (Int2ObjectOpenCustomHashMap.this.value[this.index] == null ? 0 : Int2ObjectOpenCustomHashMap.this.value[this.index].hashCode()); }
/* 410:    */    
/* 412:412 */    public String toString() { return Int2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Int2ObjectOpenCustomHashMap.this.value[this.index]; } }
/* 413:    */  
...
/* 418:    */    
/* 419:419 */    private MapIterator() { this.pos = Int2ObjectOpenCustomHashMap.this.n;
/* 420:    */      
/* 422:422 */      this.last = -1;
/* 423:    */      
/* 424:424 */      this.c = Int2ObjectOpenCustomHashMap.this.size;
/* 425:    */      
/* 429:429 */      boolean[] used = Int2ObjectOpenCustomHashMap.this.used;
...
/* 441:    */        
/* 442:442 */        int pos = HashCommon.murmurHash3(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ObjectOpenCustomHashMap.this.mask;
/* 443:    */        
/* 444:444 */        while (Int2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 445:445 */          if (Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446:446 */          pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask;
/* 447:    */        }
/* 448:    */      }
/* 449:449 */      this.last = this.pos;
/* 450:    */      
/* 451:451 */      if (this.c != 0) {
/* 452:452 */        boolean[] used = Int2ObjectOpenCustomHashMap.this.used;
...
/* 467:    */      for (;;)
/* 468:    */      {
/* 469:469 */        pos = (last = pos) + 1 & Int2ObjectOpenCustomHashMap.this.mask;
/* 470:470 */        while (Int2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 471:471 */          int slot = HashCommon.murmurHash3(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(Int2ObjectOpenCustomHashMap.this.key[pos])) & Int2ObjectOpenCustomHashMap.this.mask;
/* 472:472 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473:473 */          pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask;
/* 474:    */        }
/* 475:475 */        if (Int2ObjectOpenCustomHashMap.this.used[pos] == 0) break;
/* 476:476 */        if (pos < last)
/* 477:    */        {
/* 478:478 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 479:479 */          this.wrapped.add(Int2ObjectOpenCustomHashMap.this.key[pos]);
/* 480:    */        }
/* 481:481 */        Int2ObjectOpenCustomHashMap.this.key[last] = Int2ObjectOpenCustomHashMap.this.key[pos];
/* 482:482 */        Int2ObjectOpenCustomHashMap.this.value[last] = Int2ObjectOpenCustomHashMap.this.value[pos];
/* 483:    */      }
/* 484:484 */      Int2ObjectOpenCustomHashMap.this.used[last] = false;
/* 485:485 */      Int2ObjectOpenCustomHashMap.this.value[last] = null;
/* 486:486 */      return last;
/* 487:    */    }
/* 488:    */    
...
/* 492:    */      {
/* 493:493 */        Int2ObjectOpenCustomHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 494:494 */        this.last = -1;
/* 495:495 */        return;
/* 496:    */      }
/* 497:497 */      Int2ObjectOpenCustomHashMap.this.size -= 1;
...
/* 509:    */    } }
/* 510:    */  
/* 511:511 */  private class EntryIterator extends Int2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Int2ObjectMap.Entry<V>> { private EntryIterator() { super(null); }
/* 512:    */    
/* 513:    */    private Int2ObjectOpenCustomHashMap<V>.MapEntry entry;
/* 514:514 */    public Int2ObjectMap.Entry<V> next() { return this.entry = new Int2ObjectOpenCustomHashMap.MapEntry(Int2ObjectOpenCustomHashMap.this, nextEntry()); }
/* 515:    */    
/* 516:    */    public void remove()
/* 517:    */    {
/* 518:518 */      super.remove();
/* 519:519 */      Int2ObjectOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 520:    */    } }
/* 521:    */  
/* 522:522 */  private class FastEntryIterator extends Int2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Int2ObjectMap.Entry<V>> { private FastEntryIterator() { super(null); }
/* 523:523 */    final AbstractInt2ObjectMap.BasicEntry<V> entry = new AbstractInt2ObjectMap.BasicEntry(0, null);
/* 524:    */    
/* 525:525 */    public AbstractInt2ObjectMap.BasicEntry<V> next() { int e = nextEntry();
/* 526:526 */      this.entry.key = Int2ObjectOpenCustomHashMap.this.key[e];
/* 527:527 */      this.entry.value = Int2ObjectOpenCustomHashMap.this.value[e];
/* 528:528 */      return this.entry;
/* 529:    */    } }
/* 530:    */  
/* 531:    */  private final class MapEntrySet extends AbstractObjectSet<Int2ObjectMap.Entry<V>> implements Int2ObjectMap.FastEntrySet<V> { private MapEntrySet() {}
/* 532:    */    
/* 533:533 */    public ObjectIterator<Int2ObjectMap.Entry<V>> iterator() { return new Int2ObjectOpenCustomHashMap.EntryIterator(Int2ObjectOpenCustomHashMap.this, null); }
/* 534:    */    
/* 535:    */    public ObjectIterator<Int2ObjectMap.Entry<V>> fastIterator() {
/* 536:536 */      return new Int2ObjectOpenCustomHashMap.FastEntryIterator(Int2ObjectOpenCustomHashMap.this, null);
/* 537:    */    }
/* 538:    */    
...
/* 543:    */      
/* 544:544 */      int pos = HashCommon.murmurHash3(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ObjectOpenCustomHashMap.this.mask;
/* 545:    */      
/* 546:546 */      while (Int2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 547:547 */        if (Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[pos], k)) return Int2ObjectOpenCustomHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Int2ObjectOpenCustomHashMap.this.value[pos].equals(e.getValue());
/* 548:548 */        pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask;
/* 549:    */      }
...
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(Int2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Int2ObjectOpenCustomHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Int2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Int2ObjectOpenCustomHashMap.this.strategy.equals(Int2ObjectOpenCustomHashMap.this.key[pos], k)) {
/* 562:562 */          Int2ObjectOpenCustomHashMap.this.remove(e.getKey());
/* 563:563 */          return true;
/* 564:    */        }
/* 565:565 */        pos = pos + 1 & Int2ObjectOpenCustomHashMap.this.mask;
/* 566:    */      }
/* 567:567 */      return false;
/* 568:    */    }
/* 569:    */    
/* 570:570 */    public int size() { return Int2ObjectOpenCustomHashMap.this.size; }
/* 571:    */    
/* 573:573 */    public void clear() { Int2ObjectOpenCustomHashMap.this.clear(); }
/* 574:    */  }
/* 575:    */  
/* 576:    */  public Int2ObjectMap.FastEntrySet<V> int2ObjectEntrySet() {
...
/* 584:    */    extends Int2ObjectOpenCustomHashMap.MapIterator
/* 585:    */    implements IntIterator
/* 586:    */  {
/* 587:587 */    public KeyIterator() { super(null); }
/* 588:588 */    public int nextInt() { return Int2ObjectOpenCustomHashMap.this.key[nextEntry()]; }
/* 589:589 */    public Integer next() { return Integer.valueOf(Int2ObjectOpenCustomHashMap.this.key[nextEntry()]); } }
/* 590:    */  
/* 591:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 592:    */    
/* 593:593 */    public IntIterator iterator() { return new Int2ObjectOpenCustomHashMap.KeyIterator(Int2ObjectOpenCustomHashMap.this); }
/* 594:    */    
/* 595:    */    public int size() {
/* 596:596 */      return Int2ObjectOpenCustomHashMap.this.size;
/* 597:    */    }
/* 598:    */    
/* 599:599 */    public boolean contains(int k) { return Int2ObjectOpenCustomHashMap.this.containsKey(k); }
/* 600:    */    
/* 601:    */    public boolean remove(int k) {
/* 602:602 */      int oldSize = Int2ObjectOpenCustomHashMap.this.size;
/* 603:603 */      Int2ObjectOpenCustomHashMap.this.remove(k);
/* 604:604 */      return Int2ObjectOpenCustomHashMap.this.size != oldSize;
/* 605:    */    }
/* 606:    */    
/* 607:607 */    public void clear() { Int2ObjectOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
...
/* 618:    */    extends Int2ObjectOpenCustomHashMap<V>.MapIterator
/* 619:    */    implements ObjectIterator<V>
/* 620:    */  {
/* 621:621 */    public ValueIterator() { super(null); }
/* 622:622 */    public V next() { return Int2ObjectOpenCustomHashMap.this.value[nextEntry()]; }
/* 623:    */  }
/* 624:    */  
...
/* 627:627 */          return new Int2ObjectOpenCustomHashMap.ValueIterator(Int2ObjectOpenCustomHashMap.this);
/* 628:    */        }
/* 629:    */        
/* 630:630 */        public int size() { return Int2ObjectOpenCustomHashMap.this.size; }
/* 631:    */        
/* 632:    */        public boolean contains(Object v) {
/* 633:633 */          return Int2ObjectOpenCustomHashMap.this.containsValue(v);
/* 634:    */        }
/* 635:    */        
/* 636:636 */        public void clear() { Int2ObjectOpenCustomHashMap.this.clear(); }
/* 637:    */      };
/* 638:    */    }
...
/* 739:    */  }
/* 740:    */  
/* 744:    */  public Int2ObjectOpenCustomHashMap<V> clone()
/* 745:    */  {
/* 746:    */    Int2ObjectOpenCustomHashMap<V> c;
/* 747:    */    
/* 749:    */    try
/* 750:    */    {
/* 751:751 */      c = (Int2ObjectOpenCustomHashMap)super.clone();
/* 752:    */    }
...
/* 789:789 */    Int2ObjectOpenCustomHashMap<V>.MapIterator i = new MapIterator(null);
