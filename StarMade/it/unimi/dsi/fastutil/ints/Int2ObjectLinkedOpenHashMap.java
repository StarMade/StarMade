...
/*   22:     */
/*  101:     */public class Int2ObjectLinkedOpenHashMap<V>
/*  102:     */  extends AbstractInt2ObjectSortedMap<V>
...
/*  115:     */  protected volatile transient Int2ObjectSortedMap.FastSortedEntrySet<V> entries;
...
/*  129:     */  
/*  137:     */  public Int2ObjectLinkedOpenHashMap(int expected, float f)
/*  138:     */  {
...
/*  149:     */  }
/*  150:     */  
/*  153:     */  public Int2ObjectLinkedOpenHashMap(int expected)
/*  154:     */  {
/*  155: 155 */    this(expected, 0.75F);
/*  156:     */  }
/*  157:     */  
/*  159:     */  public Int2ObjectLinkedOpenHashMap()
/*  160:     */  {
/*  161: 161 */    this(16, 0.75F);
/*  162:     */  }
/*  163:     */  
/*  167:     */  public Int2ObjectLinkedOpenHashMap(Map<? extends Integer, ? extends V> m, float f)
/*  168:     */  {
/*  169: 169 */    this(m.size(), f);
/*  170: 170 */    putAll(m);
/*  171:     */  }
/*  172:     */  
/*  175:     */  public Int2ObjectLinkedOpenHashMap(Map<? extends Integer, ? extends V> m)
/*  176:     */  {
/*  177: 177 */    this(m, 0.75F);
/*  178:     */  }
/*  179:     */  
/*  183:     */  public Int2ObjectLinkedOpenHashMap(Int2ObjectMap<V> m, float f)
/*  184:     */  {
/*  185: 185 */    this(m.size(), f);
/*  186: 186 */    putAll(m);
/*  187:     */  }
/*  188:     */  
/*  191:     */  public Int2ObjectLinkedOpenHashMap(Int2ObjectMap<V> m)
/*  192:     */  {
/*  193: 193 */    this(m, 0.75F);
/*  194:     */  }
/*  195:     */  
/*  201:     */  public Int2ObjectLinkedOpenHashMap(int[] k, V[] v, float f)
/*  202:     */  {
...
/*  207:     */  }
/*  208:     */  
/*  212:     */  public Int2ObjectLinkedOpenHashMap(int[] k, V[] v)
/*  213:     */  {
...
/*  610:     */    implements Int2ObjectMap.Entry<V>, Map.Entry<Integer, V>
/*  611:     */  {
...
/*  617:     */    }
/*  618:     */    
/*  619: 619 */    public Integer getKey() { return Integer.valueOf(Int2ObjectLinkedOpenHashMap.this.key[this.index]); }
/*  620:     */    
/*  621:     */    public int getIntKey() {
/*  622: 622 */      return Int2ObjectLinkedOpenHashMap.this.key[this.index];
/*  623:     */    }
/*  624:     */    
/*  625: 625 */    public V getValue() { return Int2ObjectLinkedOpenHashMap.this.value[this.index]; }
/*  626:     */    
/*  627:     */    public V setValue(V v) {
/*  628: 628 */      V oldValue = Int2ObjectLinkedOpenHashMap.this.value[this.index];
/*  629: 629 */      Int2ObjectLinkedOpenHashMap.this.value[this.index] = v;
...
/*  636: 636 */      return (Int2ObjectLinkedOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Int2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*  637:     */    }
/*  638:     */    
/*  639: 639 */    public int hashCode() { return Int2ObjectLinkedOpenHashMap.this.key[this.index] ^ (Int2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Int2ObjectLinkedOpenHashMap.this.value[this.index].hashCode()); }
/*  640:     */    
/*  641:     */    public String toString() {
/*  642: 642 */      return Int2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Int2ObjectLinkedOpenHashMap.this.value[this.index];
/*  643:     */    }
/*  644:     */  }
/*  645:     */  
...
/*  730: 730 */  public Int2ObjectSortedMap<V> tailMap(int from) { throw new UnsupportedOperationException(); }
/*  731: 731 */  public Int2ObjectSortedMap<V> headMap(int to) { throw new UnsupportedOperationException(); }
/*  732: 732 */  public Int2ObjectSortedMap<V> subMap(int from, int to) { throw new UnsupportedOperationException(); }
/*  733:     */  
...
/*  747: 747 */    int index = -1;
/*  748:     */    
/*  749: 749 */    private MapIterator() { this.next = Int2ObjectLinkedOpenHashMap.this.first;
/*  750: 750 */      this.index = 0;
/*  751:     */    }
/*  752:     */    
/*  753: 753 */    private MapIterator(int from) { if (Int2ObjectLinkedOpenHashMap.this.key[Int2ObjectLinkedOpenHashMap.this.last] == from) {
/*  754: 754 */        this.prev = Int2ObjectLinkedOpenHashMap.this.last;
/*  755: 755 */        this.index = Int2ObjectLinkedOpenHashMap.this.size;
/*  756:     */      }
/*  757:     */      else
/*  758:     */      {
/*  759: 759 */        int pos = HashCommon.murmurHash3(from) & Int2ObjectLinkedOpenHashMap.this.mask;
/*  760:     */        
/*  761: 761 */        while (Int2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  762: 762 */          if (Int2ObjectLinkedOpenHashMap.this.key[pos] == from)
/*  763:     */          {
/*  764: 764 */            this.next = ((int)Int2ObjectLinkedOpenHashMap.this.link[pos]);
/*  765: 765 */            this.prev = pos;
/*  766: 766 */            return;
/*  767:     */          }
/*  768: 768 */          pos = pos + 1 & Int2ObjectLinkedOpenHashMap.this.mask;
/*  769:     */        }
...
/*  782: 782 */        this.index = Int2ObjectLinkedOpenHashMap.this.size;
/*  783: 783 */        return;
/*  784:     */      }
/*  785: 785 */      int pos = Int2ObjectLinkedOpenHashMap.this.first;
/*  786: 786 */      this.index = 1;
/*  787: 787 */      while (pos != this.prev) {
/*  788: 788 */        pos = (int)Int2ObjectLinkedOpenHashMap.this.link[pos];
...
/*  799:     */    }
/*  800:     */    
/*  801: 801 */    public int nextEntry() { if (!hasNext()) return Int2ObjectLinkedOpenHashMap.this.size();
/*  802: 802 */      this.curr = this.next;
/*  803: 803 */      this.next = ((int)Int2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  811: 811 */      this.prev = ((int)(Int2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  824: 824 */        this.prev = ((int)(Int2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  825:     */      }
/*  826:     */      else {
/*  827: 827 */        this.next = ((int)Int2ObjectLinkedOpenHashMap.this.link[this.curr]); }
/*  828: 828 */      Int2ObjectLinkedOpenHashMap.this.size -= 1;
/*  829:     */      
/*  831: 831 */      if (this.prev == -1) { Int2ObjectLinkedOpenHashMap.this.first = this.next;
/*  832:     */      } else
/*  833: 833 */        Int2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Int2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834: 834 */      if (this.next == -1) { Int2ObjectLinkedOpenHashMap.this.last = this.prev;
/*  835:     */      } else
/*  836: 836 */        Int2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Int2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  837: 837 */      int pos = this.curr;
/*  838:     */      int last;
/*  839:     */      for (;;) {
/*  840: 840 */        pos = (last = pos) + 1 & Int2ObjectLinkedOpenHashMap.this.mask;
/*  841: 841 */        while (Int2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  842: 842 */          int slot = HashCommon.murmurHash3(Int2ObjectLinkedOpenHashMap.this.key[pos]) & Int2ObjectLinkedOpenHashMap.this.mask;
/*  843: 843 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844: 844 */          pos = pos + 1 & Int2ObjectLinkedOpenHashMap.this.mask;
/*  845:     */        }
/*  846: 846 */        if (Int2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847: 847 */        Int2ObjectLinkedOpenHashMap.this.key[last] = Int2ObjectLinkedOpenHashMap.this.key[pos];
/*  848: 848 */        Int2ObjectLinkedOpenHashMap.this.value[last] = Int2ObjectLinkedOpenHashMap.this.value[pos];
/*  849: 849 */        if (this.next == pos) this.next = last;
/*  850: 850 */        if (this.prev == pos) this.prev = last;
/*  851: 851 */        Int2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*  852:     */      }
/*  853: 853 */      Int2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  854: 854 */      Int2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  855: 855 */      this.curr = -1;
/*  856:     */    }
/*  857:     */    
...
/*  866:     */    } }
/*  867:     */  
/*  868:     */  private class EntryIterator extends Int2ObjectLinkedOpenHashMap<V>.MapIterator implements ObjectListIterator<Int2ObjectMap.Entry<V>> { private Int2ObjectLinkedOpenHashMap<V>.MapEntry entry;
/*  869:     */    
/*  870: 870 */    public EntryIterator() { super(null); }
/*  871:     */    
/*  872: 872 */    public EntryIterator(int from) { super(from, null); }
/*  873:     */    
/*  874:     */    public Int2ObjectLinkedOpenHashMap<V>.MapEntry next() {
/*  875: 875 */      return this.entry = new Int2ObjectLinkedOpenHashMap.MapEntry(Int2ObjectLinkedOpenHashMap.this, nextEntry());
/*  876:     */    }
/*  877:     */    
/*  878: 878 */    public Int2ObjectLinkedOpenHashMap<V>.MapEntry previous() { return this.entry = new Int2ObjectLinkedOpenHashMap.MapEntry(Int2ObjectLinkedOpenHashMap.this, previousEntry()); }
/*  879:     */    
/*  880:     */    public void remove()
/*  881:     */    {
/*  882: 882 */      super.remove();
/*  883: 883 */      Int2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  884:     */    
/*  885: 885 */    public void set(Int2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*  886: 886 */    public void add(Int2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*  887:     */  }
/*  888:     */  
/*  889: 889 */  private class FastEntryIterator extends Int2ObjectLinkedOpenHashMap<V>.MapIterator implements ObjectListIterator<Int2ObjectMap.Entry<V>> { final AbstractInt2ObjectMap.BasicEntry<V> entry = new AbstractInt2ObjectMap.BasicEntry(0, null);
/*  890: 890 */    public FastEntryIterator() { super(null); }
/*  891:     */    
/*  892: 892 */    public FastEntryIterator(int from) { super(from, null); }
/*  893:     */    
/*  894:     */    public AbstractInt2ObjectMap.BasicEntry<V> next() {
/*  895: 895 */      int e = nextEntry();
/*  896: 896 */      this.entry.key = Int2ObjectLinkedOpenHashMap.this.key[e];
/*  897: 897 */      this.entry.value = Int2ObjectLinkedOpenHashMap.this.value[e];
/*  898: 898 */      return this.entry;
/*  899:     */    }
/*  900:     */    
/*  901: 901 */    public AbstractInt2ObjectMap.BasicEntry<V> previous() { int e = previousEntry();
/*  902: 902 */      this.entry.key = Int2ObjectLinkedOpenHashMap.this.key[e];
/*  903: 903 */      this.entry.value = Int2ObjectLinkedOpenHashMap.this.value[e];
/*  904: 904 */      return this.entry; }
/*  905:     */    
/*  906: 906 */    public void set(Int2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*  907: 907 */    public void add(Int2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } }
/*  908:     */  
/*  909:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Int2ObjectMap.Entry<V>> implements Int2ObjectSortedMap.FastSortedEntrySet<V> { private MapEntrySet() {}
/*  910:     */    
/*  911: 911 */    public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator() { return new Int2ObjectLinkedOpenHashMap.EntryIterator(Int2ObjectLinkedOpenHashMap.this); }
/*  912:     */    
/*  913: 913 */    public Comparator<? super Int2ObjectMap.Entry<V>> comparator() { return null; }
/*  914: 914 */    public ObjectSortedSet<Int2ObjectMap.Entry<V>> subSet(Int2ObjectMap.Entry<V> fromElement, Int2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); }
/*  915: 915 */    public ObjectSortedSet<Int2ObjectMap.Entry<V>> headSet(Int2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); }
/*  916: 916 */    public ObjectSortedSet<Int2ObjectMap.Entry<V>> tailSet(Int2ObjectMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); }
/*  917:     */    
/*  918: 918 */    public Int2ObjectMap.Entry<V> first() { if (Int2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919: 919 */      return new Int2ObjectLinkedOpenHashMap.MapEntry(Int2ObjectLinkedOpenHashMap.this, Int2ObjectLinkedOpenHashMap.this.first);
/*  920:     */    }
/*  921:     */    
/*  922: 922 */    public Int2ObjectMap.Entry<V> last() { if (Int2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923: 923 */      return new Int2ObjectLinkedOpenHashMap.MapEntry(Int2ObjectLinkedOpenHashMap.this, Int2ObjectLinkedOpenHashMap.this.last);
/*  924:     */    }
/*  925:     */    
...
/*  930:     */      
/*  931: 931 */      int pos = HashCommon.murmurHash3(k) & Int2ObjectLinkedOpenHashMap.this.mask;
/*  932:     */      
/*  933: 933 */      while (Int2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  934: 934 */        if (Int2ObjectLinkedOpenHashMap.this.key[pos] == k) return Int2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Int2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  935: 935 */        pos = pos + 1 & Int2ObjectLinkedOpenHashMap.this.mask;
/*  936:     */      }
...
/*  944:     */      
/*  945: 945 */      int pos = HashCommon.murmurHash3(k) & Int2ObjectLinkedOpenHashMap.this.mask;
/*  946:     */      
/*  947: 947 */      while (Int2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  948: 948 */        if (Int2ObjectLinkedOpenHashMap.this.key[pos] == k) {
/*  949: 949 */          Int2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  950: 950 */          return true;
/*  951:     */        }
/*  952: 952 */        pos = pos + 1 & Int2ObjectLinkedOpenHashMap.this.mask;
/*  953:     */      }
/*  954: 954 */      return false;
/*  955:     */    }
/*  956:     */    
/*  957: 957 */    public int size() { return Int2ObjectLinkedOpenHashMap.this.size; }
/*  958:     */    
/*  959:     */    public void clear() {
/*  960: 960 */      Int2ObjectLinkedOpenHashMap.this.clear();
/*  961:     */    }
/*  962:     */    
/*  963: 963 */    public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> iterator(Int2ObjectMap.Entry<V> from) { return new Int2ObjectLinkedOpenHashMap.EntryIterator(Int2ObjectLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue()); }
/*  964:     */    
/*  965:     */    public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> fastIterator() {
/*  966: 966 */      return new Int2ObjectLinkedOpenHashMap.FastEntryIterator(Int2ObjectLinkedOpenHashMap.this);
/*  967:     */    }
/*  968:     */    
/*  969: 969 */    public ObjectBidirectionalIterator<Int2ObjectMap.Entry<V>> fastIterator(Int2ObjectMap.Entry<V> from) { return new Int2ObjectLinkedOpenHashMap.FastEntryIterator(Int2ObjectLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue()); }
/*  970:     */  }
/*  971:     */  
/*  972:     */  public Int2ObjectSortedMap.FastSortedEntrySet<V> int2ObjectEntrySet() {
...
/*  980:     */    extends Int2ObjectLinkedOpenHashMap.MapIterator
/*  981:     */    implements IntListIterator
/*  982:     */  {
/*  983: 983 */    public KeyIterator(int k) { super(k, null); }
/*  984: 984 */    public int previousInt() { return Int2ObjectLinkedOpenHashMap.this.key[previousEntry()]; }
...
/*  987: 987 */    public Integer previous() { return Integer.valueOf(Int2ObjectLinkedOpenHashMap.this.key[previousEntry()]); }
...
/*  991: 991 */    public int nextInt() { return Int2ObjectLinkedOpenHashMap.this.key[nextEntry()]; }
/*  992: 992 */    public Integer next() { return Integer.valueOf(Int2ObjectLinkedOpenHashMap.this.key[nextEntry()]); } }
/*  993:     */  
/*  994:     */  private final class KeySet extends AbstractIntSortedSet { private KeySet() {}
/*  995:     */    
/*  996: 996 */    public IntListIterator iterator(int from) { return new Int2ObjectLinkedOpenHashMap.KeyIterator(Int2ObjectLinkedOpenHashMap.this, from); }
/*  997:     */    
/*  998:     */    public IntListIterator iterator() {
/*  999: 999 */      return new Int2ObjectLinkedOpenHashMap.KeyIterator(Int2ObjectLinkedOpenHashMap.this);
/* 1000:     */    }
/* 1001:     */    
/* 1002:1002 */    public int size() { return Int2ObjectLinkedOpenHashMap.this.size; }
/* 1003:     */    
/* 1005:1005 */    public boolean contains(int k) { return Int2ObjectLinkedOpenHashMap.this.containsKey(k); }
/* 1006:     */    
/* 1007:     */    public boolean remove(int k) {
/* 1008:1008 */      int oldSize = Int2ObjectLinkedOpenHashMap.this.size;
/* 1009:1009 */      Int2ObjectLinkedOpenHashMap.this.remove(k);
/* 1010:1010 */      return Int2ObjectLinkedOpenHashMap.this.size != oldSize;
/* 1011:     */    }
/* 1012:     */    
/* 1013:1013 */    public void clear() { Int2ObjectLinkedOpenHashMap.this.clear(); }
/* 1014:     */    
/* 1015:     */    public int firstInt() {
/* 1016:1016 */      if (Int2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017:1017 */      return Int2ObjectLinkedOpenHashMap.this.key[Int2ObjectLinkedOpenHashMap.this.first];
/* 1018:     */    }
/* 1019:     */    
/* 1020:1020 */    public int lastInt() { if (Int2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021:1021 */      return Int2ObjectLinkedOpenHashMap.this.key[Int2ObjectLinkedOpenHashMap.this.last]; }
/* 1022:     */    
...
/* 1036:     */    extends Int2ObjectLinkedOpenHashMap<V>.MapIterator
/* 1037:     */    implements ObjectListIterator<V>
/* 1038:     */  {
/* 1039:1039 */    public V previous() { return Int2ObjectLinkedOpenHashMap.this.value[previousEntry()]; }
...
/* 1043:1043 */    public V next() { return Int2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1044:     */  }
/* 1045:     */  
...
/* 1048:1048 */          return new Int2ObjectLinkedOpenHashMap.ValueIterator(Int2ObjectLinkedOpenHashMap.this);
/* 1049:     */        }
/* 1050:     */        
/* 1051:1051 */        public int size() { return Int2ObjectLinkedOpenHashMap.this.size; }
/* 1052:     */        
/* 1053:     */        public boolean contains(Object v) {
/* 1054:1054 */          return Int2ObjectLinkedOpenHashMap.this.containsValue(v);
/* 1055:     */        }
/* 1056:     */        
/* 1057:1057 */        public void clear() { Int2ObjectLinkedOpenHashMap.this.clear(); }
/* 1058:     */      };
/* 1059:     */    }
...
/* 1179:     */  }
/* 1180:     */  
/* 1183:     */  public Int2ObjectLinkedOpenHashMap<V> clone()
/* 1184:     */  {
/* 1185:     */    Int2ObjectLinkedOpenHashMap<V> c;
/* 1186:     */    
/* 1188:     */    try
/* 1189:     */    {
/* 1190:1190 */      c = (Int2ObjectLinkedOpenHashMap)super.clone();
/* 1191:     */    }
...
/* 1228:1228 */    Int2ObjectLinkedOpenHashMap<V>.MapIterator i = new MapIterator(null);
