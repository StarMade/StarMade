  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2CharLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Int2CharLinkedOpenHashMap(Map<? extends Integer, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2CharLinkedOpenHashMap(Map<? extends Integer, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2CharLinkedOpenHashMap(Int2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2CharLinkedOpenHashMap(Int2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2CharLinkedOpenHashMap(int[] local_k, char[] local_v, float local_f)
  {
  ...
  public Int2CharLinkedOpenHashMap(int[] local_k, char[] local_v)
  {
  ...
  public char getAndMoveToFirst(int local_k)
  {
    int[] key = this.key;
  ...
  public char getAndMoveToLast(int local_k)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToFirst(int local_k, char local_v)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToLast(int local_k, char local_v)
  {
    int[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Int2CharLinkedOpenHashMap.ValueIterator(Int2CharLinkedOpenHashMap.this);
        }
        ...
        {
          return Int2CharLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2CharLinkedOpenHashMap local_c;
    try
    {
      local_c = (Int2CharLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Int2CharLinkedOpenHashMap.MapIterator
    implements CharListIterator
  {
    ...
    {
      return Character.valueOf(Int2CharLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Character.valueOf(Int2CharLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractIntSortedSet
  {
    ...
    {
      return new Int2CharLinkedOpenHashMap.KeyIterator(Int2CharLinkedOpenHashMap.this, from);
    }
    
    public IntListIterator iterator()
    {
      return new Int2CharLinkedOpenHashMap.KeyIterator(Int2CharLinkedOpenHashMap.this);
    }
    ...
    {
      return Int2CharLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2CharLinkedOpenHashMap.this.size;
      Int2CharLinkedOpenHashMap.this.remove(local_k);
    ...
    implements IntListIterator
  {
    ...
    {
      return Integer.valueOf(Int2CharLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2CharLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2CharSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Int2CharLinkedOpenHashMap.EntryIterator(Int2CharLinkedOpenHashMap.this);
    }
    ...
    public Int2CharMap.Entry first()
    {
      ...
      return new Int2CharLinkedOpenHashMap.MapEntry(Int2CharLinkedOpenHashMap.this, Int2CharLinkedOpenHashMap.this.first);
    }
    ...
    public Int2CharMap.Entry last()
    {
      ...
      return new Int2CharLinkedOpenHashMap.MapEntry(Int2CharLinkedOpenHashMap.this, Int2CharLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2CharLinkedOpenHashMap.this.mask; Int2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2CharLinkedOpenHashMap.this.mask) {
        if (Int2CharLinkedOpenHashMap.this.key[pos] == local_k) {
          return Int2CharLinkedOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2CharLinkedOpenHashMap.this.mask; Int2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2CharLinkedOpenHashMap.this.mask) {
        if (Int2CharLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Int2CharLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Int2CharLinkedOpenHashMap.EntryIterator(Int2CharLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
    
    public ObjectBidirectionalIterator<Int2CharMap.Entry> fastIterator()
    {
      return new Int2CharLinkedOpenHashMap.FastEntryIterator(Int2CharLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Int2CharMap.Entry> fastIterator(Int2CharMap.Entry from)
    {
      return new Int2CharLinkedOpenHashMap.FastEntryIterator(Int2CharLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
  }
    ...
    implements ObjectListIterator<Int2CharMap.Entry>
  {
    ...
    public AbstractInt2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Int2CharLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Int2CharLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Int2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Int2CharLinkedOpenHashMap.MapEntry(Int2CharLinkedOpenHashMap.this, nextEntry());
    }
    
    public Int2CharLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Int2CharLinkedOpenHashMap.MapEntry(Int2CharLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(int from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Int2CharLinkedOpenHashMap.this.mask; Int2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2CharLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Int2CharLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Int2CharLinkedOpenHashMap.this.first = this.next;
      } else {
        Int2CharLinkedOpenHashMap.this.link[this.prev] ^= (Int2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Int2CharLinkedOpenHashMap.this.last = this.prev;
      } else {
        Int2CharLinkedOpenHashMap.this.link[this.next] ^= (Int2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2CharLinkedOpenHashMap.this.mask; Int2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2CharLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2CharLinkedOpenHashMap.this.key[pos]) & Int2CharLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2CharLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Int2CharLinkedOpenHashMap.this.key[last] = Int2CharLinkedOpenHashMap.this.key[pos];
      ...
      Int2CharLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Int2CharMap.Entry, Map.Entry<Integer, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Int2CharLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, Character> local_e = (Map.Entry)local_o;
      return (Int2CharLinkedOpenHashMap.this.key[this.index] == ((Integer)local_e.getKey()).intValue()) && (Int2CharLinkedOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
