...
/*      */ 
/*      */ public class Int2IntAVLTreeMap extends AbstractInt2IntSortedMap
...
/*  117 */           return Int2IntAVLTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  120 */           return Int2IntAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     int oldValue = put(ok.intValue(), ov.intValue());
/*  780 */     return this.modified ? null : Integer.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Integer remove(Object ok)
/*      */   {
/*  788 */     int oldValue = remove(((Integer)ok).intValue());
...
/* 1203 */         final Comparator<? super Int2IntMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2IntMap.Entry x, Int2IntMap.Entry y) {
/* 1205 */             return Int2IntAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Int2IntAVLTreeMap.EntryIterator(Int2IntAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator(Int2IntMap.Entry from) {
/* 1215 */           return new Int2IntAVLTreeMap.EntryIterator(Int2IntAVLTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Int2IntAVLTreeMap.Entry f = Int2IntAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1228 */           Int2IntAVLTreeMap.Entry f = Int2IntAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1229 */           if (f != null) Int2IntAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Int2IntAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Int2IntAVLTreeMap.this.clear(); } 
/* 1234 */         public Int2IntMap.Entry first() { return Int2IntAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Int2IntMap.Entry last() { return Int2IntAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry from, Int2IntMap.Entry to) { return Int2IntAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2IntEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry to) { return Int2IntAVLTreeMap.this.headMap((Integer)to.getKey()).int2IntEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry from) { return Int2IntAVLTreeMap.this.tailMap((Integer)from.getKey()).int2IntEntrySet(); }
/*      */       };
...
/* 1304 */           return new Int2IntAVLTreeMap.ValueIterator(Int2IntAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(int k) {
/* 1307 */           return Int2IntAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Int2IntAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Int2IntAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Int2IntAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readInt(), s.readInt());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readInt(), s.readInt());
/* 1759 */       top.right(new Entry(s.readInt(), s.readInt()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Int2IntAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Int2IntAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Int2IntAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Int2IntAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Int2IntMap.Entry> int2IntEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator() {
/* 1391 */             return new Int2IntAVLTreeMap.Submap.SubmapEntryIterator(Int2IntAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2IntMap.Entry> iterator(Int2IntMap.Entry from) {
/* 1394 */             return new Int2IntAVLTreeMap.Submap.SubmapEntryIterator(Int2IntAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1396 */           public Comparator<? super Int2IntMap.Entry> comparator() { return Int2IntAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Int2IntAVLTreeMap.Entry f = Int2IntAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1402 */             return (f != null) && (Int2IntAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Int2IntAVLTreeMap.Entry f = Int2IntAVLTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1409 */             if ((f != null) && (Int2IntAVLTreeMap.Submap.this.in(f.key))) Int2IntAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Int2IntAVLTreeMap.Submap.SubmapIterator(Int2IntAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Int2IntAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Int2IntMap.Entry first() { return Int2IntAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Int2IntMap.Entry last() { return Int2IntAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Int2IntMap.Entry> subSet(Int2IntMap.Entry from, Int2IntMap.Entry to) { return Int2IntAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2IntEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Int2IntMap.Entry> headSet(Int2IntMap.Entry to) { return Int2IntAVLTreeMap.Submap.this.headMap((Integer)to.getKey()).int2IntEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Int2IntMap.Entry> tailSet(Int2IntMap.Entry from) { return Int2IntAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2IntEntrySet(); }
/*      */         };
...
/*      */           public IntIterator iterator() {
/* 1442 */             return new Int2IntAVLTreeMap.Submap.SubmapValueIterator(Int2IntAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(int k) {
/* 1445 */             return Int2IntAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Int2IntAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Int2IntAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1458 */       return (in(k)) && (Int2IntAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(int v) {
...
/* 1473 */       return (in(kk)) && ((e = Int2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public int put(int k, int v) {
/* 1476 */       Int2IntAVLTreeMap.this.modified = false;
...
/* 1478 */       int oldValue = Int2IntAVLTreeMap.this.put(k, v);
/* 1479 */       return Int2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Integer put(Integer ok, Integer ov) {
/* 1482 */       int oldValue = put(ok.intValue(), ov.intValue());
/* 1483 */       return Int2IntAVLTreeMap.this.modified ? null : Integer.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public int remove(int k) {
/* 1487 */       Int2IntAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       int oldValue = Int2IntAVLTreeMap.this.remove(k);
/* 1490 */       return Int2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Integer remove(Object ok) {
/* 1493 */       int oldValue = remove(((Integer)ok).intValue());
/* 1494 */       return Int2IntAVLTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1509 */       return Int2IntAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2IntSortedMap headMap(int to) {
/* 1512 */       if (this.top) return new Submap(Int2IntAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Int2IntAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2IntAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2IntSortedMap tailMap(int from) {
/* 1516 */       if (this.bottom) return new Submap(Int2IntAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Int2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2IntAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2IntSortedMap subMap(int from, int to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Int2IntAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Int2IntAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Int2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Int2IntAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2IntAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Int2IntAVLTreeMap.this.tree == null) return null;
/* 1534 */       Int2IntAVLTreeMap.Entry e;
/*      */       Int2IntAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Int2IntAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Int2IntAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Int2IntAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Int2IntAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2IntAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Int2IntAVLTreeMap.this.tree == null) return null;
/* 1552 */       Int2IntAVLTreeMap.Entry e;
/*      */       Int2IntAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Int2IntAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Int2IntAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Int2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Int2IntAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1563 */       Int2IntAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1568 */       Int2IntAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1573 */       Int2IntAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1578 */       Int2IntAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2IntAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2IntAVLTreeMap.Submap.SubmapIterator
/*      */       implements IntListIterator
/*      */     {
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2IntAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Int2IntMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Int2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Int2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Int2IntAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Int2IntAVLTreeMap.Submap.this.bottom) && (Int2IntAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Int2IntAVLTreeMap.Submap.this.top) && (Int2IntAVLTreeMap.this.compare(k, (this.prev = Int2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Int2IntAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Int2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Int2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2IntAVLTreeMap.this.compare(this.prev.key, Int2IntAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Int2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2IntAVLTreeMap.this.compare(this.next.key, Int2IntAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public IntBidirectionalIterator iterator() { return new Int2IntAVLTreeMap.Submap.SubmapKeyIterator(Int2IntAVLTreeMap.Submap.this); } 
/* 1433 */       public IntBidirectionalIterator iterator(int from) { return new Int2IntAVLTreeMap.Submap.SubmapKeyIterator(Int2IntAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2IntAVLTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public IntBidirectionalIterator iterator() { return new Int2IntAVLTreeMap.KeyIterator(Int2IntAVLTreeMap.this); } 
/* 1263 */     public IntBidirectionalIterator iterator(int from) { return new Int2IntAVLTreeMap.KeyIterator(Int2IntAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2IntAVLTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2IntAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2IntMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Int2IntMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Int2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Int2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Int2IntAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1129 */       if ((this.next = Int2IntAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Int2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Int2IntAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
