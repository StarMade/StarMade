...
/*  14:    */
/*  59:    */public class Int2ByteMaps
/*  60:    */{
/*  61:    */  public static class EmptyMap
/*  62:    */    extends Int2ByteFunctions.EmptyFunction
/*  63:    */    implements Int2ByteMap, Serializable, Cloneable
/*  64:    */  {
/*  65:    */    public static final long serialVersionUID = -7046029254386353129L;
/*  66:    */    
/*  67: 67 */    public boolean containsValue(byte v) { return false; }
/*  68: 68 */    public void putAll(Map<? extends Integer, ? extends Byte> m) { throw new UnsupportedOperationException(); }
/*  69:    */    
/*  70: 70 */    public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() { return ObjectSets.EMPTY_SET; }
/*  71:    */    
...
/*  76: 76 */    private Object readResolve() { return Int2ByteMaps.EMPTY_MAP; }
/*  77: 77 */    public Object clone() { return Int2ByteMaps.EMPTY_MAP; }
/*  78: 78 */    public boolean isEmpty() { return true; }
/*  79:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<Integer, Byte>> entrySet() { return int2ByteEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Int2ByteFunctions.Singleton
/* 103:    */    implements Int2ByteMap, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Int2ByteMap.Entry> entries;
/* 108:    */    
/* 109:    */    protected volatile transient IntSet keys;
/* 110:    */    
/* 111:    */    protected volatile transient ByteCollection values;
/* 112:    */    
/* 114:    */    protected Singleton(int key, byte value)
/* 115:    */    {
/* 116:116 */      super(value);
/* 117:    */    }
/* 118:    */    
...
/* 122:    */    
/* 124:124 */    public void putAll(Map<? extends Integer, ? extends Byte> m) { throw new UnsupportedOperationException(); }
/* 125:    */    
/* 126:126 */    public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Int2ByteMap.Entry, Map.Entry<Integer, Byte> { protected SingletonEntry() {}
/* 131:131 */      public Integer getKey() { return Integer.valueOf(Int2ByteMaps.Singleton.this.key); }
/* 132:132 */      public Byte getValue() { return Byte.valueOf(Int2ByteMaps.Singleton.this.value); }
/* 133:    */      
/* 134:    */      public int getIntKey() {
/* 135:135 */        return Int2ByteMaps.Singleton.this.key;
/* 136:    */      }
/* 137:    */      
/* 139:139 */      public byte getByteValue() { return Int2ByteMaps.Singleton.this.value; }
...
/* 148:    */        
/* 149:149 */        return (Int2ByteMaps.Singleton.this.key == ((Integer)e.getKey()).intValue()) && (Int2ByteMaps.Singleton.this.value == ((Byte)e.getValue()).byteValue());
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return Int2ByteMaps.Singleton.this.key ^ Int2ByteMaps.Singleton.this.value; }
/* 153:153 */      public String toString() { return Int2ByteMaps.Singleton.this.key + "->" + Int2ByteMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<Integer, Byte>> entrySet() { return int2ByteEntrySet(); }
/* 160:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static Int2ByteMap singleton(int key, byte value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static Int2ByteMap singleton(Integer key, Byte value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key.intValue(), value.byteValue());
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap
/* 205:    */    extends Int2ByteFunctions.SynchronizedFunction
/* 206:    */    implements Int2ByteMap, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Int2ByteMap map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Int2ByteMap.Entry> entries;
/* 213:    */    
/* 214:    */    protected volatile transient IntSet keys;
/* 215:    */    protected volatile transient ByteCollection values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Int2ByteMap m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Int2ByteMap m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 234:    */    
/* 235:235 */    public byte put(int k, byte v) { synchronized (this.sync) { return this.map.put(k, v);
/* 236:    */      } }
/* 237:    */    
/* 238:238 */    public void putAll(Map<? extends Integer, ? extends Byte> m) { synchronized (this.sync) { this.map.putAll(m); } }
/* 239:    */    
/* 240:240 */    public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.int2ByteEntrySet(), this.sync); return this.entries; }
...
/* 246:    */      } }
/* 247:    */    
/* 248:248 */    public Byte put(Integer k, Byte v) { synchronized (this.sync) { return (Byte)this.map.put(k, v);
/* 249:    */      }
/* 250:    */    }
/* 251:    */    
/* 252:252 */    public byte remove(int k) { synchronized (this.sync) { return this.map.remove(k); } }
/* 253:253 */    public byte get(int k) { synchronized (this.sync) { return this.map.get(k); } }
...
/* 267:267 */    public ObjectSet<Map.Entry<Integer, Byte>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); } }
/* 268:    */    
...
/* 273:    */  }
/* 274:    */  
/* 277:    */  public static Int2ByteMap synchronize(Int2ByteMap m)
/* 278:    */  {
/* 279:279 */    return new SynchronizedMap(m);
/* 280:    */  }
/* 281:    */  
/* 287:    */  public static Int2ByteMap synchronize(Int2ByteMap m, Object sync)
/* 288:    */  {
/* 289:289 */    return new SynchronizedMap(m, sync);
/* 290:    */  }
/* 291:    */  
/* 293:    */  public static class UnmodifiableMap
/* 294:    */    extends Int2ByteFunctions.UnmodifiableFunction
/* 295:    */    implements Int2ByteMap, Serializable
/* 296:    */  {
/* 297:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 298:    */    
/* 299:    */    protected final Int2ByteMap map;
/* 300:    */    protected volatile transient ObjectSet<Int2ByteMap.Entry> entries;
/* 301:    */    protected volatile transient IntSet keys;
/* 302:    */    protected volatile transient ByteCollection values;
/* 303:    */    
/* 304:    */    protected UnmodifiableMap(Int2ByteMap m)
/* 305:    */    {
/* 306:306 */      super();
/* 307:307 */      this.map = m;
/* 308:    */    }
...
/* 316:    */    
/* 317:317 */    public byte put(int k, byte v) { throw new UnsupportedOperationException(); }
/* 318:    */    
/* 320:320 */    public void putAll(Map<? extends Integer, ? extends Byte> m) { throw new UnsupportedOperationException(); }
/* 321:    */    
/* 322:322 */    public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.int2ByteEntrySet()); return this.entries; }
...
/* 328:    */    
/* 329:    */    public Byte put(Integer k, Byte v) {
/* 330:330 */      throw new UnsupportedOperationException();
/* 331:    */    }
/* 332:    */    
/* 334:334 */    public byte remove(int k) { throw new UnsupportedOperationException(); }
/* 335:335 */    public byte get(int k) { return this.map.get(k); }
...
/* 349:349 */    public ObjectSet<Map.Entry<Integer, Byte>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/* 350:    */  }
/* 351:    */  
/* 356:    */  public static Int2ByteMap unmodifiable(Int2ByteMap m)
/* 357:    */  {
