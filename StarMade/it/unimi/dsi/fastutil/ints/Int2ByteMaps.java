...
/*     */   {
/* 200 */     return new Singleton(key.intValue(), value.byteValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.int2ByteEntrySet()); return this.entries; } 
...
/* 335 */     public byte get(int k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Integer, Byte>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Integer, ? extends Byte> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.int2ByteEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public byte get(int k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Integer, Byte>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/*     */       {
/* 131 */         return Integer.valueOf(Int2ByteMaps.Singleton.this.key); } 
/* 132 */       public Byte getValue() { return Byte.valueOf(Int2ByteMaps.Singleton.this.value); }
/*     */ 
/*     */       public int getIntKey() {
/* 135 */         return Int2ByteMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public byte getByteValue() {
/* 139 */         return Int2ByteMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Int2ByteMaps.Singleton.this.key == ((Integer)e.getKey()).intValue()) && (Int2ByteMaps.Singleton.this.value == ((Byte)e.getValue()).byteValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return Int2ByteMaps.Singleton.this.key ^ Int2ByteMaps.Singleton.this.value; } 
/* 153 */       public String toString() { return Int2ByteMaps.Singleton.this.key + "->" + Int2ByteMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Integer, ? extends Byte> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Int2ByteMap.Entry> int2ByteEntrySet() {
...
/*  76 */     private Object readResolve() { return Int2ByteMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Int2ByteMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Integer, Byte>> entrySet() {
/*  80 */       return int2ByteEntrySet();
/*     */     }
