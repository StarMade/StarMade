...
/*      */ 
/*      */ public class Int2CharRBTreeMap extends AbstractInt2CharSortedMap
...
/*  119 */           return Int2CharRBTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  122 */           return Int2CharRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     char oldValue = put(ok.intValue(), ov.charValue());
/*  731 */     return this.modified ? null : Character.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Character remove(Object ok)
/*      */   {
/*  737 */     char oldValue = remove(((Integer)ok).intValue());
...
/* 1141 */         final Comparator<? super Int2CharMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2CharMap.Entry x, Int2CharMap.Entry y) {
/* 1143 */             return Int2CharRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Int2CharRBTreeMap.EntryIterator(Int2CharRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator(Int2CharMap.Entry from) {
/* 1153 */           return new Int2CharRBTreeMap.EntryIterator(Int2CharRBTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Int2CharRBTreeMap.Entry f = Int2CharRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1166 */           Int2CharRBTreeMap.Entry f = Int2CharRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1167 */           if (f != null) Int2CharRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Int2CharRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Int2CharRBTreeMap.this.clear(); } 
/* 1172 */         public Int2CharMap.Entry first() { return Int2CharRBTreeMap.this.firstEntry; } 
/* 1173 */         public Int2CharMap.Entry last() { return Int2CharRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Int2CharMap.Entry> subSet(Int2CharMap.Entry from, Int2CharMap.Entry to) { return Int2CharRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2CharEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry to) { return Int2CharRBTreeMap.this.headMap((Integer)to.getKey()).int2CharEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry from) { return Int2CharRBTreeMap.this.tailMap((Integer)from.getKey()).int2CharEntrySet(); }
/*      */       };
...
/* 1242 */           return new Int2CharRBTreeMap.ValueIterator(Int2CharRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(char k) {
/* 1245 */           return Int2CharRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Int2CharRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Int2CharRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Int2CharRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readInt(), s.readChar());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readInt(), s.readChar());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readInt(), s.readChar()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Int2CharRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Int2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator() {
/* 1329 */             return new Int2CharRBTreeMap.Submap.SubmapEntryIterator(Int2CharRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator(Int2CharMap.Entry from) {
/* 1332 */             return new Int2CharRBTreeMap.Submap.SubmapEntryIterator(Int2CharRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1334 */           public Comparator<? super Int2CharMap.Entry> comparator() { return Int2CharRBTreeMap.this.int2CharEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Int2CharRBTreeMap.Entry f = Int2CharRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1340 */             return (f != null) && (Int2CharRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Int2CharRBTreeMap.Entry f = Int2CharRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1347 */             if ((f != null) && (Int2CharRBTreeMap.Submap.this.in(f.key))) Int2CharRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Int2CharRBTreeMap.Submap.SubmapIterator(Int2CharRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Int2CharRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Int2CharMap.Entry first() { return Int2CharRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Int2CharMap.Entry last() { return Int2CharRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Int2CharMap.Entry> subSet(Int2CharMap.Entry from, Int2CharMap.Entry to) { return Int2CharRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2CharEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry to) { return Int2CharRBTreeMap.Submap.this.headMap((Integer)to.getKey()).int2CharEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry from) { return Int2CharRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2CharEntrySet(); }
/*      */         };
...
/*      */           public CharIterator iterator() {
/* 1376 */             return new Int2CharRBTreeMap.Submap.SubmapValueIterator(Int2CharRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(char k) {
/* 1379 */             return Int2CharRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Int2CharRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Int2CharRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1392 */       return (in(k)) && (Int2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(char v) {
...
/* 1407 */       return (in(kk)) && ((e = Int2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public char put(int k, char v) {
/* 1410 */       Int2CharRBTreeMap.this.modified = false;
...
/* 1412 */       char oldValue = Int2CharRBTreeMap.this.put(k, v);
/* 1413 */       return Int2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Character put(Integer ok, Character ov) {
/* 1416 */       char oldValue = put(ok.intValue(), ov.charValue());
/* 1417 */       return Int2CharRBTreeMap.this.modified ? null : Character.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public char remove(int k) {
/* 1421 */       Int2CharRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       char oldValue = Int2CharRBTreeMap.this.remove(k);
/* 1424 */       return Int2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Character remove(Object ok) {
/* 1427 */       char oldValue = remove(((Integer)ok).intValue());
/* 1428 */       return Int2CharRBTreeMap.this.modified ? Character.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1443 */       return Int2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2CharSortedMap headMap(int to) {
/* 1446 */       if (this.top) return new Submap(Int2CharRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Int2CharRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2CharRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2CharSortedMap tailMap(int from) {
/* 1450 */       if (this.bottom) return new Submap(Int2CharRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Int2CharRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2CharRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2CharSortedMap subMap(int from, int to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Int2CharRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Int2CharRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Int2CharRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Int2CharRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2CharRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Int2CharRBTreeMap.this.tree == null) return null;
/* 1468 */       Int2CharRBTreeMap.Entry e;
/*      */       Int2CharRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Int2CharRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Int2CharRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Int2CharRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Int2CharRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2CharRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Int2CharRBTreeMap.this.tree == null) return null;
/* 1486 */       Int2CharRBTreeMap.Entry e;
/*      */       Int2CharRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Int2CharRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Int2CharRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Int2CharRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Int2CharRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1497 */       Int2CharRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1502 */       Int2CharRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1507 */       Int2CharRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1512 */       Int2CharRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2CharRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2CharRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2CharRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Int2CharMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Int2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Int2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Int2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Int2CharRBTreeMap.Submap.this.bottom) && (Int2CharRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Int2CharRBTreeMap.Submap.this.top) && (Int2CharRBTreeMap.this.compare(k, (this.prev = Int2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Int2CharRBTreeMap.this.locateKey(k);
/* 1534 */             if (Int2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Int2CharRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2CharRBTreeMap.this.compare(this.prev.key, Int2CharRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Int2CharRBTreeMap.Submap.this.top) && (this.next != null) && (Int2CharRBTreeMap.this.compare(this.next.key, Int2CharRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public IntBidirectionalIterator iterator() { return new Int2CharRBTreeMap.Submap.SubmapKeyIterator(Int2CharRBTreeMap.Submap.this); } 
/* 1367 */       public IntBidirectionalIterator iterator(int from) { return new Int2CharRBTreeMap.Submap.SubmapKeyIterator(Int2CharRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2CharRBTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public IntBidirectionalIterator iterator() { return new Int2CharRBTreeMap.KeyIterator(Int2CharRBTreeMap.this); } 
/* 1201 */     public IntBidirectionalIterator iterator(int from) { return new Int2CharRBTreeMap.KeyIterator(Int2CharRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2CharRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2CharRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2CharMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Int2CharMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Int2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Int2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Int2CharRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1067 */       if ((this.next = Int2CharRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Int2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Int2CharRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
