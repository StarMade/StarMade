  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2CharRBTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2CharRBTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2CharRBTreeMap(Map<? extends Integer, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2CharRBTreeMap(SortedMap<Integer, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2CharRBTreeMap(Int2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2CharRBTreeMap(Int2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2CharRBTreeMap(int[] local_k, char[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2CharRBTreeMap(int[] local_k, char[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Int2CharMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Int2CharRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2CharRBTreeMap.EntryIterator(Int2CharRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator(Int2CharMap.Entry from)
        {
          return new Int2CharRBTreeMap.EntryIterator(Int2CharRBTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2CharRBTreeMap.Entry local_f = Int2CharRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2CharRBTreeMap.Entry local_f = Int2CharRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2CharRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Int2CharRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2CharEntrySet();
        }
        
        public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry local_to)
        {
          return Int2CharRBTreeMap.this.headMap((Integer)local_to.getKey()).int2CharEntrySet();
        }
        
        public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry from)
        {
          return Int2CharRBTreeMap.this.tailMap((Integer)from.getKey()).int2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Int2CharRBTreeMap.ValueIterator(Int2CharRBTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Int2CharRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2CharRBTreeMap local_c;
    try
    {
      local_c = (Int2CharRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2CharRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Int2CharRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2CharRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2CharMap.Entry> int2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator()
          {
            return new Int2CharRBTreeMap.Submap.SubmapEntryIterator(Int2CharRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2CharMap.Entry> iterator(Int2CharMap.Entry from)
          {
            return new Int2CharRBTreeMap.Submap.SubmapEntryIterator(Int2CharRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, Character> local_e = (Map.Entry)local_o;
            Int2CharRBTreeMap.Entry local_f = Int2CharRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2CharRBTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, Character> local_e = (Map.Entry)local_o;
            Int2CharRBTreeMap.Entry local_f = Int2CharRBTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2CharRBTreeMap.Submap.this.in4(local_f.key))) {
              Int2CharRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2CharRBTreeMap.Submap.SubmapIterator(Int2CharRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2CharRBTreeMap.Submap.this.clear();
          }
          
          public Int2CharMap.Entry first()
          {
            return Int2CharRBTreeMap.Submap.this.firstEntry();
          }
          
          public Int2CharMap.Entry last()
          {
            return Int2CharRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2CharMap.Entry> subSet(Int2CharMap.Entry from, Int2CharMap.Entry local_to)
          {
            return Int2CharRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2CharEntrySet();
          }
          
          public ObjectSortedSet<Int2CharMap.Entry> headSet(Int2CharMap.Entry local_to)
          {
            return Int2CharRBTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2CharEntrySet();
          }
          
          public ObjectSortedSet<Int2CharMap.Entry> tailSet(Int2CharMap.Entry from)
          {
            return Int2CharRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Int2CharRBTreeMap.Submap.SubmapValueIterator(Int2CharRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Int2CharRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2CharRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2CharRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2CharRBTreeMap.Entry local_e;
      return (in4(local_kk)) && ((local_e = Int2CharRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(int local_k, char local_v)
    {
      ...
      char oldValue = Int2CharRBTreeMap.this.put(local_k, local_v);
    ...
    public char remove(int local_k)
    {
      ...
      char oldValue = Int2CharRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2CharRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2CharRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2CharSortedMap tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2CharRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2CharRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2CharRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2CharSortedMap subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2CharRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2CharRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2CharRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2CharRBTreeMap.this.locateKey(this.from);
        if (Int2CharRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2CharRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2CharRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2CharRBTreeMap.this.locateKey(this.field_47);
        if (Int2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2CharRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2CharRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2CharRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Int2CharRBTreeMap.Submap.SubmapIterator
      ...
      extends Int2CharRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Int2CharRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2CharRBTreeMap.Submap.this.bottom) && (Int2CharRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2CharRBTreeMap.Submap.this.top) && (Int2CharRBTreeMap.this.compare(local_k, (this.prev = Int2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2CharRBTreeMap.this.locateKey(local_k);
            if (Int2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2CharRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2CharRBTreeMap.this.compare(this.prev.key, Int2CharRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2CharRBTreeMap.Submap.this.top) && (this.next != null) && (Int2CharRBTreeMap.this.compare(this.next.key, Int2CharRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2CharSortedMap.KeySet
    {
      ...
      {
        return new Int2CharRBTreeMap.Submap.SubmapKeyIterator(Int2CharRBTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2CharRBTreeMap.Submap.SubmapKeyIterator(Int2CharRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2CharSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2CharRBTreeMap.KeyIterator(Int2CharRBTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2CharRBTreeMap.KeyIterator(Int2CharRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2CharRBTreeMap.this.locateKey(local_k)) != null) {
        if (Int2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
