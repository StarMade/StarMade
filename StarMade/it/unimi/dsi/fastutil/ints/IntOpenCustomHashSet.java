...
/*  13:    */
/*  81:    */public class IntOpenCustomHashSet
/*  82:    */  extends AbstractIntSet
...
/*  87:    */  protected transient int[] key;
...
/*  94:    */  protected IntHash.Strategy strategy;
/*  95:    */  
/*  96:    */  public IntOpenCustomHashSet(int expected, float f, IntHash.Strategy strategy)
/*  97:    */  {
...
/* 105:105 */    this.key = new int[this.n];
/* 106:106 */    this.used = new boolean[this.n];
/* 107:    */  }
/* 108:    */  
/* 112:    */  public IntOpenCustomHashSet(int expected, IntHash.Strategy strategy)
/* 113:    */  {
/* 114:114 */    this(expected, 0.75F, strategy);
/* 115:    */  }
/* 116:    */  
/* 119:    */  public IntOpenCustomHashSet(IntHash.Strategy strategy)
/* 120:    */  {
/* 121:121 */    this(16, 0.75F, strategy);
/* 122:    */  }
/* 123:    */  
/* 128:    */  public IntOpenCustomHashSet(Collection<? extends Integer> c, float f, IntHash.Strategy strategy)
/* 129:    */  {
/* 130:130 */    this(c.size(), f, strategy);
/* 131:131 */    addAll(c);
/* 132:    */  }
/* 133:    */  
/* 138:    */  public IntOpenCustomHashSet(Collection<? extends Integer> c, IntHash.Strategy strategy)
/* 139:    */  {
/* 140:140 */    this(c, 0.75F, strategy);
/* 141:    */  }
/* 142:    */  
/* 147:    */  public IntOpenCustomHashSet(IntCollection c, float f, IntHash.Strategy strategy)
/* 148:    */  {
/* 149:149 */    this(c.size(), f, strategy);
/* 150:150 */    addAll(c);
/* 151:    */  }
/* 152:    */  
/* 157:    */  public IntOpenCustomHashSet(IntCollection c, IntHash.Strategy strategy)
/* 158:    */  {
/* 159:159 */    this(c, 0.75F, strategy);
/* 160:    */  }
/* 161:    */  
/* 166:    */  public IntOpenCustomHashSet(IntIterator i, float f, IntHash.Strategy strategy)
/* 167:    */  {
/* 168:168 */    this(16, f, strategy);
/* 169:169 */    while (i.hasNext()) { add(i.nextInt());
/* 170:    */    }
/* 171:    */  }
/* 172:    */  
/* 175:    */  public IntOpenCustomHashSet(IntIterator i, IntHash.Strategy strategy)
/* 176:    */  {
/* 177:177 */    this(i, 0.75F, strategy);
/* 178:    */  }
/* 179:    */  
/* 184:    */  public IntOpenCustomHashSet(Iterator<?> i, float f, IntHash.Strategy strategy)
/* 185:    */  {
/* 186:186 */    this(IntIterators.asIntIterator(i), f, strategy);
/* 187:    */  }
/* 188:    */  
/* 192:    */  public IntOpenCustomHashSet(Iterator<?> i, IntHash.Strategy strategy)
/* 193:    */  {
/* 194:194 */    this(IntIterators.asIntIterator(i), strategy);
/* 195:    */  }
/* 196:    */  
/* 203:    */  public IntOpenCustomHashSet(int[] a, int offset, int length, float f, IntHash.Strategy strategy)
/* 204:    */  {
/* 205:205 */    this(length < 0 ? 0 : length, f, strategy);
/* 206:206 */    IntArrays.ensureOffsetLength(a, offset, length);
/* 207:207 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 208:    */    }
/* 209:    */  }
/* 210:    */  
/* 215:    */  public IntOpenCustomHashSet(int[] a, int offset, int length, IntHash.Strategy strategy)
/* 216:    */  {
/* 217:217 */    this(a, offset, length, 0.75F, strategy);
/* 218:    */  }
/* 219:    */  
/* 224:    */  public IntOpenCustomHashSet(int[] a, float f, IntHash.Strategy strategy)
/* 225:    */  {
/* 226:226 */    this(a, 0, a.length, f, strategy);
/* 227:    */  }
/* 228:    */  
/* 233:    */  public IntOpenCustomHashSet(int[] a, IntHash.Strategy strategy)
/* 234:    */  {
/* 235:235 */    this(a, 0.75F, strategy);
/* 236:    */  }
/* 237:    */  
/* 240:    */  public IntHash.Strategy strategy()
/* 241:    */  {
...
/* 283:    */  }
/* 284:    */  
/* 285:    */  public boolean remove(int k)
/* 286:    */  {
...
/* 299:    */  }
/* 300:    */  
/* 301:    */  public boolean contains(int k)
/* 302:    */  {
...
/* 344:    */  
/* 345:    */  private class SetIterator extends AbstractIntIterator {
/* 346:    */    int pos;
/* 347:    */    int last;
/* 348:    */    
/* 349:349 */    private SetIterator() { this.pos = IntOpenCustomHashSet.this.n;
/* 350:    */      
/* 352:352 */      this.last = -1;
/* 353:    */      
/* 354:354 */      this.c = IntOpenCustomHashSet.this.size;
/* 355:    */      
/* 359:359 */      boolean[] used = IntOpenCustomHashSet.this.used;
...
/* 367:367 */      this.c -= 1;
/* 368:    */      
/* 369:369 */      if (this.pos < 0) return this.wrapped.getInt(-(this.last = --this.pos) - 2);
/* 370:370 */      int retVal = IntOpenCustomHashSet.this.key[(this.last = this.pos)];
/* 371:    */      
/* 372:372 */      if (this.c != 0) {
/* 373:373 */        boolean[] used = IntOpenCustomHashSet.this.used;
...
/* 388:    */      for (;;)
/* 389:    */      {
/* 390:390 */        pos = (last = pos) + 1 & IntOpenCustomHashSet.this.mask;
/* 391:391 */        while (IntOpenCustomHashSet.this.used[pos] != 0) {
/* 392:392 */          int slot = HashCommon.murmurHash3(IntOpenCustomHashSet.this.strategy.hashCode(IntOpenCustomHashSet.this.key[pos])) & IntOpenCustomHashSet.this.mask;
/* 393:393 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 394:394 */          pos = pos + 1 & IntOpenCustomHashSet.this.mask;
/* 395:    */        }
/* 396:396 */        if (IntOpenCustomHashSet.this.used[pos] == 0) break;
/* 397:397 */        if (pos < last)
/* 398:    */        {
/* 399:399 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 400:400 */          this.wrapped.add(IntOpenCustomHashSet.this.key[pos]);
/* 401:    */        }
/* 402:402 */        IntOpenCustomHashSet.this.key[last] = IntOpenCustomHashSet.this.key[pos];
/* 403:    */      }
/* 404:404 */      IntOpenCustomHashSet.this.used[last] = false;
/* 405:405 */      return last;
/* 406:    */    }
/* 407:    */    
...
/* 411:    */      {
/* 412:412 */        IntOpenCustomHashSet.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 413:413 */        this.last = -1;
/* 414:414 */        return;
/* 415:    */      }
/* 416:416 */      IntOpenCustomHashSet.this.size -= 1;
...
/* 423:    */  }
/* 424:    */  
/* 425:    */  public IntIterator iterator() {
...
/* 503:    */    
/* 504:504 */    int[] key = this.key;
/* 505:505 */    int newMask = newN - 1;
/* 506:506 */    int[] newKey = new int[newN];
...
/* 522:    */  }
/* 523:    */  
/* 527:    */  public IntOpenCustomHashSet clone()
/* 528:    */  {
/* 529:    */    IntOpenCustomHashSet c;
/* 530:    */    
/* 532:    */    try
/* 533:    */    {
/* 534:534 */      c = (IntOpenCustomHashSet)super.clone();
/* 535:    */    }
/* 536:    */    catch (CloneNotSupportedException cantHappen) {
/* 537:537 */      throw new InternalError();
/* 538:    */    }
/* 539:539 */    c.key = ((int[])this.key.clone());
...
/* 561:    */  }
/* 562:    */  
/* 563:563 */  private void writeObject(ObjectOutputStream s) throws IOException { IntIterator i = iterator();
/* 564:564 */    s.defaultWriteObject();
/* 565:565 */    for (int j = this.size; j-- != 0; s.writeInt(i.nextInt())) {}
/* 566:    */  }
/* 567:    */  
