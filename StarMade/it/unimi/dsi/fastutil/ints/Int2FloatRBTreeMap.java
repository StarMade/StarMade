...
/*      */ 
/*      */ public class Int2FloatRBTreeMap extends AbstractInt2FloatSortedMap
...
/*  119 */           return Int2FloatRBTreeMap.this.storedComparator.compare(Integer.valueOf(k1), Integer.valueOf(k2));
/*      */         }
/*      */         public int compare(Integer ok1, Integer ok2) {
/*  122 */           return Int2FloatRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     float oldValue = put(ok.intValue(), ov.floatValue());
/*  731 */     return this.modified ? null : Float.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Float remove(Object ok)
/*      */   {
/*  737 */     float oldValue = remove(((Integer)ok).intValue());
...
/* 1141 */         final Comparator<? super Int2FloatMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Int2FloatMap.Entry x, Int2FloatMap.Entry y) {
/* 1143 */             return Int2FloatRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Int2FloatRBTreeMap.EntryIterator(Int2FloatRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from) {
/* 1153 */           return new Int2FloatRBTreeMap.EntryIterator(Int2FloatRBTreeMap.this, ((Integer)from.getKey()).intValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Int2FloatRBTreeMap.Entry f = Int2FloatRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
...
/* 1166 */           Int2FloatRBTreeMap.Entry f = Int2FloatRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1167 */           if (f != null) Int2FloatRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Int2FloatRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Int2FloatRBTreeMap.this.clear(); } 
/* 1172 */         public Int2FloatMap.Entry first() { return Int2FloatRBTreeMap.this.firstEntry; } 
/* 1173 */         public Int2FloatMap.Entry last() { return Int2FloatRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry from, Int2FloatMap.Entry to) { return Int2FloatRBTreeMap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2FloatEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry to) { return Int2FloatRBTreeMap.this.headMap((Integer)to.getKey()).int2FloatEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from) { return Int2FloatRBTreeMap.this.tailMap((Integer)from.getKey()).int2FloatEntrySet(); }
/*      */       };
...
/* 1242 */           return new Int2FloatRBTreeMap.ValueIterator(Int2FloatRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(float k) {
/* 1245 */           return Int2FloatRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Int2FloatRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Int2FloatRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Int2FloatRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readInt(), s.readFloat());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readInt(), s.readFloat());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readInt(), s.readFloat()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Int2FloatRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Int2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator() {
/* 1329 */             return new Int2FloatRBTreeMap.Submap.SubmapEntryIterator(Int2FloatRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Int2FloatMap.Entry> iterator(Int2FloatMap.Entry from) {
/* 1332 */             return new Int2FloatRBTreeMap.Submap.SubmapEntryIterator(Int2FloatRBTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
/*      */           }
/* 1334 */           public Comparator<? super Int2FloatMap.Entry> comparator() { return Int2FloatRBTreeMap.this.int2FloatEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Int2FloatRBTreeMap.Entry f = Int2FloatRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1340 */             return (f != null) && (Int2FloatRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Int2FloatRBTreeMap.Entry f = Int2FloatRBTreeMap.this.findKey(((Integer)e.getKey()).intValue());
/* 1347 */             if ((f != null) && (Int2FloatRBTreeMap.Submap.this.in(f.key))) Int2FloatRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Int2FloatRBTreeMap.Submap.SubmapIterator(Int2FloatRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Int2FloatRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Int2FloatMap.Entry first() { return Int2FloatRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Int2FloatMap.Entry last() { return Int2FloatRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Int2FloatMap.Entry> subSet(Int2FloatMap.Entry from, Int2FloatMap.Entry to) { return Int2FloatRBTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)to.getKey()).int2FloatEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Int2FloatMap.Entry> headSet(Int2FloatMap.Entry to) { return Int2FloatRBTreeMap.Submap.this.headMap((Integer)to.getKey()).int2FloatEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Int2FloatMap.Entry> tailSet(Int2FloatMap.Entry from) { return Int2FloatRBTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2FloatEntrySet(); }
/*      */         };
...
/*      */           public FloatIterator iterator() {
/* 1376 */             return new Int2FloatRBTreeMap.Submap.SubmapValueIterator(Int2FloatRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(float k) {
/* 1379 */             return Int2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Int2FloatRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Int2FloatRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(int k) {
/* 1392 */       return (in(k)) && (Int2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(float v) {
...
/* 1407 */       return (in(kk)) && ((e = Int2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public float put(int k, float v) {
/* 1410 */       Int2FloatRBTreeMap.this.modified = false;
...
/* 1412 */       float oldValue = Int2FloatRBTreeMap.this.put(k, v);
/* 1413 */       return Int2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Float put(Integer ok, Float ov) {
/* 1416 */       float oldValue = put(ok.intValue(), ov.floatValue());
/* 1417 */       return Int2FloatRBTreeMap.this.modified ? null : Float.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public float remove(int k) {
/* 1421 */       Int2FloatRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       float oldValue = Int2FloatRBTreeMap.this.remove(k);
/* 1424 */       return Int2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Float remove(Object ok) {
/* 1427 */       float oldValue = remove(((Integer)ok).intValue());
/* 1428 */       return Int2FloatRBTreeMap.this.modified ? Float.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public IntComparator comparator() {
/* 1443 */       return Int2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Int2FloatSortedMap headMap(int to) {
/* 1446 */       if (this.top) return new Submap(Int2FloatRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Int2FloatRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Int2FloatRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Int2FloatSortedMap tailMap(int from) {
/* 1450 */       if (this.bottom) return new Submap(Int2FloatRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Int2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2FloatRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Int2FloatSortedMap subMap(int from, int to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Int2FloatRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Int2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Int2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Int2FloatRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Int2FloatRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Int2FloatRBTreeMap.this.tree == null) return null;
/* 1468 */       Int2FloatRBTreeMap.Entry e;
/*      */       Int2FloatRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Int2FloatRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Int2FloatRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Int2FloatRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Int2FloatRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Int2FloatRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Int2FloatRBTreeMap.this.tree == null) return null;
/* 1486 */       Int2FloatRBTreeMap.Entry e;
/*      */       Int2FloatRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Int2FloatRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Int2FloatRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Int2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Int2FloatRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public int firstIntKey() {
/* 1497 */       Int2FloatRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public int lastIntKey() {
/* 1502 */       Int2FloatRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Integer firstKey() {
/* 1507 */       Int2FloatRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Integer lastKey() {
/* 1512 */       Int2FloatRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Int2FloatRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Int2FloatRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Int2FloatRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Int2FloatMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Int2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(int k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Int2FloatRBTreeMap.Submap.this.bottom) && (Int2FloatRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Int2FloatRBTreeMap.Submap.this.top) && (Int2FloatRBTreeMap.this.compare(k, (this.prev = Int2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Int2FloatRBTreeMap.this.locateKey(k);
/* 1534 */             if (Int2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Int2FloatRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2FloatRBTreeMap.this.compare(this.prev.key, Int2FloatRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Int2FloatRBTreeMap.Submap.this.top) && (this.next != null) && (Int2FloatRBTreeMap.this.compare(this.next.key, Int2FloatRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public IntBidirectionalIterator iterator() { return new Int2FloatRBTreeMap.Submap.SubmapKeyIterator(Int2FloatRBTreeMap.Submap.this); } 
/* 1367 */       public IntBidirectionalIterator iterator(int from) { return new Int2FloatRBTreeMap.Submap.SubmapKeyIterator(Int2FloatRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2FloatRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public IntBidirectionalIterator iterator() { return new Int2FloatRBTreeMap.KeyIterator(Int2FloatRBTreeMap.this); } 
/* 1201 */     public IntBidirectionalIterator iterator(int from) { return new Int2FloatRBTreeMap.KeyIterator(Int2FloatRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2FloatRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2FloatRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Int2FloatMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Int2FloatMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Int2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Int2FloatRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(int k) {
/* 1067 */       if ((this.next = Int2FloatRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Int2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Int2FloatRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Integer)e.getKey()).intValue()) && (this.value == ((Float)e.getValue()).floatValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
