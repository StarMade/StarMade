...
/*      */   protected int size;
/*      */   protected volatile transient Int2ReferenceSortedMap.FastSortedEntrySet<V> entries;
...
/*      */   }
/*  729 */   public IntComparator comparator() { return null; } 
/*  730 */   public Int2ReferenceSortedMap<V> tailMap(int from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Int2ReferenceSortedMap<V> headMap(int to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Int2ReferenceSortedMap<V> subMap(int from, int to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Int2ReferenceLinkedOpenHashMap.ValueIterator(Int2ReferenceLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Int2ReferenceLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Int2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Int2ReferenceLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1190 */       c = (Int2ReferenceLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1242 */     int[] key = this.key = new int[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Int2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Int2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Int2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Int2ReferenceLinkedOpenHashMap.KeyIterator(Int2ReferenceLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public IntListIterator iterator() {
/*  999 */       return new Int2ReferenceLinkedOpenHashMap.KeyIterator(Int2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Int2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(int k) {
/* 1005 */       return Int2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(int k) {
/* 1008 */       int oldSize = Int2ReferenceLinkedOpenHashMap.this.size;
/* 1009 */       Int2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Int2ReferenceLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Int2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public int firstInt() {
/* 1016 */       if (Int2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Int2ReferenceLinkedOpenHashMap.this.key[Int2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public int lastInt() {
/* 1020 */       if (Int2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Int2ReferenceLinkedOpenHashMap.this.key[Int2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
/* 1023 */     public IntComparator comparator() { return null; } 
/* 1024 */     public final IntSortedSet tailSet(int from) { throw new UnsupportedOperationException(); } 
/* 1025 */     public final IntSortedSet headSet(int to) { throw new UnsupportedOperationException(); } 
/* 1026 */     public final IntSortedSet subSet(int from, int to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Int2ReferenceLinkedOpenHashMap.MapIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public KeyIterator(int k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public int previousInt() { return Int2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; } 
/*  985 */     public void set(int k) { throw new UnsupportedOperationException(); } 
/*  986 */     public void add(int k) { throw new UnsupportedOperationException(); } 
/*  987 */     public Integer previous() { return Integer.valueOf(Int2ReferenceLinkedOpenHashMap.this.key[previousEntry()]); } 
/*  988 */     public void set(Integer ok) { throw new UnsupportedOperationException(); } 
/*  989 */     public void add(Integer ok) { throw new UnsupportedOperationException(); } 
/*  990 */     public KeyIterator() { super(null); } 
/*  991 */     public int nextInt() { return Int2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Integer next() { return Integer.valueOf(Int2ReferenceLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Int2ReferenceLinkedOpenHashMap.EntryIterator(Int2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Int2ReferenceMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Int2ReferenceMap.Entry<V>> subSet(Int2ReferenceMap.Entry<V> fromElement, Int2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Int2ReferenceMap.Entry<V> first() {
/*  918 */       if (Int2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Int2ReferenceLinkedOpenHashMap.MapEntry(Int2ReferenceLinkedOpenHashMap.this, Int2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Int2ReferenceMap.Entry<V> last() {
/*  922 */       if (Int2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Int2ReferenceLinkedOpenHashMap.MapEntry(Int2ReferenceLinkedOpenHashMap.this, Int2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     public boolean contains(Object o) {
/*  927 */       if (!(o instanceof Map.Entry)) return false;
/*  928 */       Map.Entry e = (Map.Entry)o;
/*  929 */       int k = ((Integer)e.getKey()).intValue();
/*      */ 
/*  931 */       int pos = HashCommon.murmurHash3(k) & Int2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Int2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Int2ReferenceLinkedOpenHashMap.this.key[pos] == k) return Int2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  935 */         pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*  943 */       int k = ((Integer)e.getKey()).intValue();
/*      */ 
/*  945 */       int pos = HashCommon.murmurHash3(k) & Int2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Int2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Int2ReferenceLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Int2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Int2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Int2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from) {
/*  963 */       return new Int2ReferenceLinkedOpenHashMap.EntryIterator(Int2ReferenceLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> fastIterator() {
/*  966 */       return new Int2ReferenceLinkedOpenHashMap.FastEntryIterator(Int2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> fastIterator(Int2ReferenceMap.Entry<V> from) {
/*  969 */       return new Int2ReferenceLinkedOpenHashMap.FastEntryIterator(Int2ReferenceLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Int2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Int2ReferenceMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractInt2ReferenceMap.BasicEntry<V> entry = new AbstractInt2ReferenceMap.BasicEntry(0, null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Int2ReferenceLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Int2ReferenceLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractInt2ReferenceMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Int2ReferenceLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Int2ReferenceLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Int2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Int2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Int2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Int2ReferenceMap.Entry<V>>
/*      */   {
...
/*  870 */       super(null);
/*      */     }
/*  872 */     public EntryIterator(int from) { super(from, null); }
/*      */ 
/*      */     public Int2ReferenceLinkedOpenHashMap<V>.MapEntry next() {
/*  875 */       return this.entry = new Int2ReferenceLinkedOpenHashMap.MapEntry(Int2ReferenceLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Int2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Int2ReferenceLinkedOpenHashMap.MapEntry(Int2ReferenceLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Int2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Int2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Int2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Int2ReferenceLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(int from) {
/*  753 */       if (Int2ReferenceLinkedOpenHashMap.this.key[Int2ReferenceLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Int2ReferenceLinkedOpenHashMap.this.last;
/*  755 */         this.index = Int2ReferenceLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = HashCommon.murmurHash3(from) & Int2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Int2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Int2ReferenceLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Int2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Int2ReferenceLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Int2ReferenceLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Int2ReferenceLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Int2ReferenceLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Int2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Int2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Int2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Int2ReferenceLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Int2ReferenceLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Int2ReferenceLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Int2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Int2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Int2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Int2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Int2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Int2ReferenceLinkedOpenHashMap.this.mask;
/*  841 */         while (Int2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = HashCommon.murmurHash3(Int2ReferenceLinkedOpenHashMap.this.key[pos]) & Int2ReferenceLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Int2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Int2ReferenceLinkedOpenHashMap.this.key[last] = Int2ReferenceLinkedOpenHashMap.this.key[pos];
/*  848 */         Int2ReferenceLinkedOpenHashMap.this.value[last] = Int2ReferenceLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Int2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Int2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Int2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*  619 */       return Integer.valueOf(Int2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public int getIntKey() {
/*  622 */       return Int2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Int2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Int2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  629 */       Int2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Int2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return Int2ReferenceLinkedOpenHashMap.this.key[this.index] ^ (Int2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Int2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */     public String toString() {
/*  642 */       return Int2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Int2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
