  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2ReferenceLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Int2ReferenceLinkedOpenHashMap(Map<? extends Integer, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2ReferenceLinkedOpenHashMap(Map<? extends Integer, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2ReferenceLinkedOpenHashMap(Int2ReferenceMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2ReferenceLinkedOpenHashMap(Int2ReferenceMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2ReferenceLinkedOpenHashMap(int[] local_k, V[] local_v, float local_f)
  {
  ...
  public Int2ReferenceLinkedOpenHashMap(int[] local_k, V[] local_v)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Int2ReferenceLinkedOpenHashMap.ValueIterator(Int2ReferenceLinkedOpenHashMap.this);
        }
        ...
        {
          return Int2ReferenceLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2ReferenceLinkedOpenHashMap<V> local_c;
    try
    {
      local_c = (Int2ReferenceLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    int[] key = this.key;
    V[] value = this.value;
    Int2ReferenceLinkedOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractIntSortedSet
  {
    ...
    {
      return new Int2ReferenceLinkedOpenHashMap.KeyIterator(Int2ReferenceLinkedOpenHashMap.this, from);
    }
    
    public IntListIterator iterator()
    {
      return new Int2ReferenceLinkedOpenHashMap.KeyIterator(Int2ReferenceLinkedOpenHashMap.this);
    }
    ...
    {
      return Int2ReferenceLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2ReferenceLinkedOpenHashMap.this.size;
      Int2ReferenceLinkedOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Int2ReferenceLinkedOpenHashMap.MapIterator
    implements IntListIterator
  {
    ...
    {
      return Integer.valueOf(Int2ReferenceLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Integer next()
    {
      return Integer.valueOf(Int2ReferenceLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2ReferenceSortedMap.FastSortedEntrySet<V>
  {
    ...
    {
      return new Int2ReferenceLinkedOpenHashMap.EntryIterator(Int2ReferenceLinkedOpenHashMap.this);
    }
    ...
    public Int2ReferenceMap.Entry<V> first()
    {
      ...
      return new Int2ReferenceLinkedOpenHashMap.MapEntry(Int2ReferenceLinkedOpenHashMap.this, Int2ReferenceLinkedOpenHashMap.this.first);
    }
    ...
    public Int2ReferenceMap.Entry<V> last()
    {
      ...
      return new Int2ReferenceLinkedOpenHashMap.MapEntry(Int2ReferenceLinkedOpenHashMap.this, Int2ReferenceLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2ReferenceLinkedOpenHashMap.this.mask; Int2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask) {
        if (Int2ReferenceLinkedOpenHashMap.this.key[pos] == local_k) {
          return Int2ReferenceLinkedOpenHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2ReferenceLinkedOpenHashMap.this.mask; Int2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask) {
        if (Int2ReferenceLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Int2ReferenceLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Int2ReferenceLinkedOpenHashMap.EntryIterator(Int2ReferenceLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
    
    public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> fastIterator()
    {
      return new Int2ReferenceLinkedOpenHashMap.FastEntryIterator(Int2ReferenceLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> fastIterator(Int2ReferenceMap.Entry<V> from)
    {
      return new Int2ReferenceLinkedOpenHashMap.FastEntryIterator(Int2ReferenceLinkedOpenHashMap.this, ((Integer)from.getKey()).intValue());
    }
  }
    ...
    implements ObjectListIterator<Int2ReferenceMap.Entry<V>>
  {
    ...
    public AbstractInt2ReferenceMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Int2ReferenceLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Int2ReferenceLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Int2ReferenceMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Int2ReferenceLinkedOpenHashMap.MapEntry(Int2ReferenceLinkedOpenHashMap.this, nextEntry());
    }
    
    public Int2ReferenceLinkedOpenHashMap<V>.MapEntry previous()
    {
      return this.entry = new Int2ReferenceLinkedOpenHashMap.MapEntry(Int2ReferenceLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(int from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Int2ReferenceLinkedOpenHashMap.this.mask; Int2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Int2ReferenceLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Int2ReferenceLinkedOpenHashMap.this.first = this.next;
      } else {
        Int2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Int2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Int2ReferenceLinkedOpenHashMap.this.last = this.prev;
      } else {
        Int2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Int2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2ReferenceLinkedOpenHashMap.this.mask; Int2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ReferenceLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2ReferenceLinkedOpenHashMap.this.key[pos]) & Int2ReferenceLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2ReferenceLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Int2ReferenceLinkedOpenHashMap.this.key[last] = Int2ReferenceLinkedOpenHashMap.this.key[pos];
      ...
      Int2ReferenceLinkedOpenHashMap.this.used[last] = false;
    ...
    implements Int2ReferenceMap.Entry<V>, Map.Entry<Integer, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Int2ReferenceLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
      return (Int2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Integer)local_e.getKey()).intValue()) && (Int2ReferenceLinkedOpenHashMap.this.value[this.index] == local_e.getValue());
    }
