  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof IntComparator))) {
      ...
      this.actualComparator = new IntComparator()
      {
        ...
        {
          return Int2ReferenceAVLTreeMap.this.storedComparator.compare(Integer.valueOf(local_k1), Integer.valueOf(local_k2));
        }
  ...
  public Int2ReferenceAVLTreeMap(Comparator<? super Integer> local_c)
  {
    this();
  ...
  public Int2ReferenceAVLTreeMap(Map<? extends Integer, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ReferenceAVLTreeMap(SortedMap<Integer, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ReferenceAVLTreeMap(Int2ReferenceMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Int2ReferenceAVLTreeMap(Int2ReferenceSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Int2ReferenceAVLTreeMap(int[] local_k, V[] local_v, Comparator<? super Integer> local_c)
  {
    this(local_c);
  ...
  public Int2ReferenceAVLTreeMap(int[] local_k, V[] local_v)
  {
  ...
  final Entry<V> findKey(int local_k)
  {
    int cmp;
  ...
  final Entry<V> locateKey(int local_k)
  {
  ...
  {
    V oldValue = put(local_ok.intValue(), local_ov);
    return this.modified ? this.defRetValue : oldValue;
  }
  
  public V remove(Object local_ok)
  {
    V oldValue = remove(((Integer)local_ok).intValue());
    return this.modified ? oldValue : this.defRetValue;
  }
  
  public boolean containsValue(Object local_v)
  {
    Int2ReferenceAVLTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
  ...
  public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Int2ReferenceMap.Entry<V>> comparator = new Comparator()
        {
          public int compare(Int2ReferenceMap.Entry<V> local_x, Int2ReferenceMap.Entry<V> local_y)
          {
            return Int2ReferenceAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Int2ReferenceAVLTreeMap.EntryIterator(Int2ReferenceAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from)
        {
          return new Int2ReferenceAVLTreeMap.EntryIterator(Int2ReferenceAVLTreeMap.this, ((Integer)from.getKey()).intValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Int2ReferenceAVLTreeMap.Entry<V> local_f = Int2ReferenceAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Int2ReferenceAVLTreeMap.Entry<V> local_f = Int2ReferenceAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
          if (local_f != null) {
            Int2ReferenceAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Int2ReferenceMap.Entry<V>> subSet(Int2ReferenceMap.Entry<V> from, Int2ReferenceMap.Entry<V> local_to)
        {
          return Int2ReferenceAVLTreeMap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> local_to)
        {
          return Int2ReferenceAVLTreeMap.this.headMap((Integer)local_to.getKey()).int2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> from)
        {
          return Int2ReferenceAVLTreeMap.this.tailMap((Integer)from.getKey()).int2ReferenceEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Int2ReferenceAVLTreeMap.ValueIterator(Int2ReferenceAVLTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Int2ReferenceAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Int2ReferenceAVLTreeMap<V> local_c;
    try
    {
      local_c = (Int2ReferenceAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Int2ReferenceAVLTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry<V> top = new Entry(local_s.readInt(), local_s.readObject());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry<V> top = new Entry(local_s.readInt(), local_s.readObject());
      top.right(new Entry(local_s.readInt(), local_s.readObject()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Int2ReferenceAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Int2ReferenceAVLTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Int2ReferenceAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Int2ReferenceAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Int2ReferenceMap.Entry<V>> int2ReferenceEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator()
          {
            return new Int2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(Int2ReferenceAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Int2ReferenceMap.Entry<V>> iterator(Int2ReferenceMap.Entry<V> from)
          {
            return new Int2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(Int2ReferenceAVLTreeMap.Submap.this, ((Integer)from.getKey()).intValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
            Int2ReferenceAVLTreeMap.Entry<V> local_f = Int2ReferenceAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            return (local_f != null) && (Int2ReferenceAVLTreeMap.Submap.this.in4(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
            Int2ReferenceAVLTreeMap.Entry<V> local_f = Int2ReferenceAVLTreeMap.this.findKey(((Integer)local_e.getKey()).intValue());
            if ((local_f != null) && (Int2ReferenceAVLTreeMap.Submap.this.in4(local_f.key))) {
              Int2ReferenceAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Int2ReferenceAVLTreeMap.Submap.SubmapIterator(Int2ReferenceAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Int2ReferenceAVLTreeMap.Submap.this.clear();
          }
          
          public Int2ReferenceMap.Entry<V> first()
          {
            return Int2ReferenceAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Int2ReferenceMap.Entry<V> last()
          {
            return Int2ReferenceAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Int2ReferenceMap.Entry<V>> subSet(Int2ReferenceMap.Entry<V> from, Int2ReferenceMap.Entry<V> local_to)
          {
            return Int2ReferenceAVLTreeMap.Submap.this.subMap((Integer)from.getKey(), (Integer)local_to.getKey()).int2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Int2ReferenceMap.Entry<V>> headSet(Int2ReferenceMap.Entry<V> local_to)
          {
            return Int2ReferenceAVLTreeMap.Submap.this.headMap((Integer)local_to.getKey()).int2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Int2ReferenceMap.Entry<V>> tailSet(Int2ReferenceMap.Entry<V> from)
          {
            return Int2ReferenceAVLTreeMap.Submap.this.tailMap((Integer)from.getKey()).int2ReferenceEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ReferenceCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractReferenceCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Int2ReferenceAVLTreeMap.Submap.SubmapValueIterator(Int2ReferenceAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Int2ReferenceAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Int2ReferenceAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(int local_k)
    {
      return (in4(local_k)) && (Int2ReferenceAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      int local_kk = local_k;
      Int2ReferenceAVLTreeMap.Entry<V> local_e;
      return (in4(local_kk)) && ((local_e = Int2ReferenceAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(int local_k, V local_v)
    {
      ...
      V oldValue = Int2ReferenceAVLTreeMap.this.put(local_k, local_v);
    ...
    public V remove(int local_k)
    {
      ...
      V oldValue = Int2ReferenceAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Int2ReferenceAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Int2ReferenceAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Int2ReferenceAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Int2ReferenceSortedMap<V> tailMap(int from)
    {
      if (this.bottom) {
        return new Submap(Int2ReferenceAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Int2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Int2ReferenceAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Int2ReferenceSortedMap<V> subMap(int from, int local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Int2ReferenceAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Int2ReferenceAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Int2ReferenceAVLTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Int2ReferenceAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Int2ReferenceAVLTreeMap.this.locateKey(this.from);
        if (Int2ReferenceAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Int2ReferenceAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Int2ReferenceAVLTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Int2ReferenceAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Int2ReferenceAVLTreeMap.this.locateKey(this.field_47);
        if (Int2ReferenceAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Int2ReferenceAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public int firstIntKey()
    {
      Int2ReferenceAVLTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public int lastIntKey()
    {
      Int2ReferenceAVLTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Int2ReferenceAVLTreeMap.Submap.SubmapIterator
      ...
      implements ObjectListIterator<Int2ReferenceMap.Entry<V>>
    {
      ...
      public void set(Int2ReferenceMap.Entry<V> local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Int2ReferenceMap.Entry<V> local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
    ...
    private class SubmapIterator
      extends Int2ReferenceAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Int2ReferenceAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(int local_k)
      {
        this();
        if (this.next != null) {
          if ((!Int2ReferenceAVLTreeMap.Submap.this.bottom) && (Int2ReferenceAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Int2ReferenceAVLTreeMap.Submap.this.top) && (Int2ReferenceAVLTreeMap.this.compare(local_k, (this.prev = Int2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Int2ReferenceAVLTreeMap.this.locateKey(local_k);
            if (Int2ReferenceAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Int2ReferenceAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Int2ReferenceAVLTreeMap.this.compare(this.prev.key, Int2ReferenceAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Int2ReferenceAVLTreeMap.Submap.this.top) && (this.next != null) && (Int2ReferenceAVLTreeMap.this.compare(this.next.key, Int2ReferenceAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractInt2ReferenceSortedMap.KeySet
    {
      ...
      {
        return new Int2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(Int2ReferenceAVLTreeMap.Submap.this);
      }
      
      public IntBidirectionalIterator iterator(int from)
      {
        return new Int2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(Int2ReferenceAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractInt2ReferenceSortedMap.KeySet
  {
    ...
    public IntBidirectionalIterator iterator()
    {
      return new Int2ReferenceAVLTreeMap.KeyIterator(Int2ReferenceAVLTreeMap.this);
    }
    
    public IntBidirectionalIterator iterator(int from)
    {
      return new Int2ReferenceAVLTreeMap.KeyIterator(Int2ReferenceAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Int2ReferenceAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Int2ReferenceAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
