...
/* 607 */           return new Int2ReferenceOpenHashMap.ValueIterator(Int2ReferenceOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 610 */           return Int2ReferenceOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 613 */           return Int2ReferenceOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 616 */           Int2ReferenceOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 731 */       c = (Int2ReferenceOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Int2ReferenceOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public V next() { return Int2ReferenceOpenHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 573 */       return new Int2ReferenceOpenHashMap.KeyIterator(Int2ReferenceOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 576 */       return Int2ReferenceOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(int k) {
/* 579 */       return Int2ReferenceOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(int k) {
/* 582 */       int oldSize = Int2ReferenceOpenHashMap.this.size;
/* 583 */       Int2ReferenceOpenHashMap.this.remove(k);
/* 584 */       return Int2ReferenceOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 587 */       Int2ReferenceOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Int2ReferenceOpenHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 567 */       super(null); } 
/* 568 */     public int nextInt() { return Int2ReferenceOpenHashMap.this.key[nextEntry()]; } 
/* 569 */     public Integer next() { return Integer.valueOf(Int2ReferenceOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 513 */       return new Int2ReferenceOpenHashMap.EntryIterator(Int2ReferenceOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Int2ReferenceMap.Entry<V>> fastIterator() {
/* 516 */       return new Int2ReferenceOpenHashMap.FastEntryIterator(Int2ReferenceOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 524 */       int pos = HashCommon.murmurHash3(k) & Int2ReferenceOpenHashMap.this.mask;
/*     */ 
/* 526 */       while (Int2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 527 */         if (Int2ReferenceOpenHashMap.this.key[pos] == k) return Int2ReferenceOpenHashMap.this.value[pos] == e.getValue();
/* 528 */         pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask;
/*     */       }
/* 530 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 538 */       int pos = HashCommon.murmurHash3(k) & Int2ReferenceOpenHashMap.this.mask;
/*     */ 
/* 540 */       while (Int2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 541 */         if (Int2ReferenceOpenHashMap.this.key[pos] == k) {
/* 542 */           Int2ReferenceOpenHashMap.this.remove(e.getKey());
/* 543 */           return true;
/*     */         }
/* 545 */         pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask;
/*     */       }
/* 547 */       return false;
/*     */     }
/*     */     public int size() {
/* 550 */       return Int2ReferenceOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 553 */       Int2ReferenceOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Int2ReferenceOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Int2ReferenceMap.Entry<V>>
/*     */   {
/* 503 */     final AbstractInt2ReferenceMap.BasicEntry<V> entry = new AbstractInt2ReferenceMap.BasicEntry(0, null);
/*     */ 
...
/* 505 */       int e = nextEntry();
/* 506 */       this.entry.key = Int2ReferenceOpenHashMap.this.key[e];
/* 507 */       this.entry.value = Int2ReferenceOpenHashMap.this.value[e];
/* 508 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Int2ReferenceOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Int2ReferenceMap.Entry<V>>
/*     */   {
...
/* 494 */       return this.entry = new Int2ReferenceOpenHashMap.MapEntry(Int2ReferenceOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 498 */       super.remove();
/* 499 */       Int2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 399 */       this.pos = Int2ReferenceOpenHashMap.this.n;
/*     */ 
/* 402 */       this.last = -1;
/*     */ 
/* 404 */       this.c = Int2ReferenceOpenHashMap.this.size;
/*     */ 
/* 409 */       boolean[] used = Int2ReferenceOpenHashMap.this.used;
...
/*     */ 
/* 422 */         int pos = HashCommon.murmurHash3(k) & Int2ReferenceOpenHashMap.this.mask;
/*     */ 
/* 424 */         while (Int2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 425 */           if (Int2ReferenceOpenHashMap.this.key[pos] == k) return pos;
/* 426 */           pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 429 */       this.last = this.pos;
/*     */ 
/* 431 */       if (this.c != 0) {
/* 432 */         boolean[] used = Int2ReferenceOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 449 */         pos = (last = pos) + 1 & Int2ReferenceOpenHashMap.this.mask;
/* 450 */         while (Int2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 451 */           int slot = HashCommon.murmurHash3(Int2ReferenceOpenHashMap.this.key[pos]) & Int2ReferenceOpenHashMap.this.mask;
/* 452 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453 */           pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask;
/*     */         }
/* 455 */         if (Int2ReferenceOpenHashMap.this.used[pos] == 0) break;
/* 456 */         if (pos < last)
/*     */         {
/* 458 */           if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 459 */           this.wrapped.add(Int2ReferenceOpenHashMap.this.key[pos]);
/*     */         }
/* 461 */         Int2ReferenceOpenHashMap.this.key[last] = Int2ReferenceOpenHashMap.this.key[pos];
/* 462 */         Int2ReferenceOpenHashMap.this.value[last] = Int2ReferenceOpenHashMap.this.value[pos];
/*     */       }
/* 464 */       Int2ReferenceOpenHashMap.this.used[last] = false;
/* 465 */       Int2ReferenceOpenHashMap.this.value[last] = null;
/* 466 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 471 */       if (this.pos < -1)
/*     */       {
/* 473 */         Int2ReferenceOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 474 */         this.last = -1;
/* 475 */         return;
/*     */       }
/* 477 */       Int2ReferenceOpenHashMap.this.size -= 1;
...
/* 369 */       return Integer.valueOf(Int2ReferenceOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public int getIntKey() {
/* 372 */       return Int2ReferenceOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 375 */       return Int2ReferenceOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 378 */       Object oldValue = Int2ReferenceOpenHashMap.this.value[this.index];
/* 379 */       Int2ReferenceOpenHashMap.this.value[this.index] = v;
/* 380 */       return oldValue;
/*     */     }
/*     */ 
...
/* 386 */       return (Int2ReferenceOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/*     */     }
/*     */     public int hashCode() {
/* 389 */       return Int2ReferenceOpenHashMap.this.key[this.index] ^ (Int2ReferenceOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Int2ReferenceOpenHashMap.this.value[this.index]));
/*     */     }
/*     */     public String toString() {
/* 392 */       return Int2ReferenceOpenHashMap.this.key[this.index] + "=>" + Int2ReferenceOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
