...
/*  18:    */
/*  86:    */public class Int2ReferenceOpenHashMap<V>
/*  87:    */  extends AbstractInt2ReferenceMap<V>
...
/* 100:    */  protected volatile transient Int2ReferenceMap.FastEntrySet<V> entries;
/* 101:    */  protected volatile transient IntSet keys;
/* 102:    */  protected volatile transient ReferenceCollection<V> values;
/* 103:    */  
/* 104:    */  public Int2ReferenceOpenHashMap(int expected, float f)
/* 105:    */  {
...
/* 115:    */  }
/* 116:    */  
/* 119:    */  public Int2ReferenceOpenHashMap(int expected)
/* 120:    */  {
/* 121:121 */    this(expected, 0.75F);
/* 122:    */  }
/* 123:    */  
/* 125:    */  public Int2ReferenceOpenHashMap()
/* 126:    */  {
/* 127:127 */    this(16, 0.75F);
/* 128:    */  }
/* 129:    */  
/* 133:    */  public Int2ReferenceOpenHashMap(Map<? extends Integer, ? extends V> m, float f)
/* 134:    */  {
/* 135:135 */    this(m.size(), f);
/* 136:136 */    putAll(m);
/* 137:    */  }
/* 138:    */  
/* 141:    */  public Int2ReferenceOpenHashMap(Map<? extends Integer, ? extends V> m)
/* 142:    */  {
/* 143:143 */    this(m, 0.75F);
/* 144:    */  }
/* 145:    */  
/* 149:    */  public Int2ReferenceOpenHashMap(Int2ReferenceMap<V> m, float f)
/* 150:    */  {
/* 151:151 */    this(m.size(), f);
/* 152:152 */    putAll(m);
/* 153:    */  }
/* 154:    */  
/* 157:    */  public Int2ReferenceOpenHashMap(Int2ReferenceMap<V> m)
/* 158:    */  {
/* 159:159 */    this(m, 0.75F);
/* 160:    */  }
/* 161:    */  
/* 167:    */  public Int2ReferenceOpenHashMap(int[] k, V[] v, float f)
/* 168:    */  {
...
/* 173:    */  }
/* 174:    */  
/* 178:    */  public Int2ReferenceOpenHashMap(int[] k, V[] v)
/* 179:    */  {
...
/* 360:    */    implements Int2ReferenceMap.Entry<V>, Map.Entry<Integer, V>
/* 361:    */  {
...
/* 367:    */    }
/* 368:    */    
/* 369:369 */    public Integer getKey() { return Integer.valueOf(Int2ReferenceOpenHashMap.this.key[this.index]); }
/* 370:    */    
/* 371:    */    public int getIntKey() {
/* 372:372 */      return Int2ReferenceOpenHashMap.this.key[this.index];
/* 373:    */    }
/* 374:    */    
/* 375:375 */    public V getValue() { return Int2ReferenceOpenHashMap.this.value[this.index]; }
/* 376:    */    
/* 377:    */    public V setValue(V v) {
/* 378:378 */      V oldValue = Int2ReferenceOpenHashMap.this.value[this.index];
/* 379:379 */      Int2ReferenceOpenHashMap.this.value[this.index] = v;
...
/* 386:386 */      return (Int2ReferenceOpenHashMap.this.key[this.index] == ((Integer)e.getKey()).intValue()) && (Int2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/* 387:    */    }
/* 388:    */    
/* 389:389 */    public int hashCode() { return Int2ReferenceOpenHashMap.this.key[this.index] ^ (Int2ReferenceOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Int2ReferenceOpenHashMap.this.value[this.index])); }
/* 390:    */    
/* 392:392 */    public String toString() { return Int2ReferenceOpenHashMap.this.key[this.index] + "=>" + Int2ReferenceOpenHashMap.this.value[this.index]; } }
/* 393:    */  
...
/* 398:    */    
/* 399:399 */    private MapIterator() { this.pos = Int2ReferenceOpenHashMap.this.n;
/* 400:    */      
/* 402:402 */      this.last = -1;
/* 403:    */      
/* 404:404 */      this.c = Int2ReferenceOpenHashMap.this.size;
/* 405:    */      
/* 409:409 */      boolean[] used = Int2ReferenceOpenHashMap.this.used;
...
/* 421:    */        
/* 422:422 */        int pos = HashCommon.murmurHash3(k) & Int2ReferenceOpenHashMap.this.mask;
/* 423:    */        
/* 424:424 */        while (Int2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 425:425 */          if (Int2ReferenceOpenHashMap.this.key[pos] == k) return pos;
/* 426:426 */          pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask;
/* 427:    */        }
/* 428:    */      }
/* 429:429 */      this.last = this.pos;
/* 430:    */      
/* 431:431 */      if (this.c != 0) {
/* 432:432 */        boolean[] used = Int2ReferenceOpenHashMap.this.used;
...
/* 447:    */      for (;;)
/* 448:    */      {
/* 449:449 */        pos = (last = pos) + 1 & Int2ReferenceOpenHashMap.this.mask;
/* 450:450 */        while (Int2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 451:451 */          int slot = HashCommon.murmurHash3(Int2ReferenceOpenHashMap.this.key[pos]) & Int2ReferenceOpenHashMap.this.mask;
/* 452:452 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453:453 */          pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask;
/* 454:    */        }
/* 455:455 */        if (Int2ReferenceOpenHashMap.this.used[pos] == 0) break;
/* 456:456 */        if (pos < last)
/* 457:    */        {
/* 458:458 */          if (this.wrapped == null) this.wrapped = new IntArrayList();
/* 459:459 */          this.wrapped.add(Int2ReferenceOpenHashMap.this.key[pos]);
/* 460:    */        }
/* 461:461 */        Int2ReferenceOpenHashMap.this.key[last] = Int2ReferenceOpenHashMap.this.key[pos];
/* 462:462 */        Int2ReferenceOpenHashMap.this.value[last] = Int2ReferenceOpenHashMap.this.value[pos];
/* 463:    */      }
/* 464:464 */      Int2ReferenceOpenHashMap.this.used[last] = false;
/* 465:465 */      Int2ReferenceOpenHashMap.this.value[last] = null;
/* 466:466 */      return last;
/* 467:    */    }
/* 468:    */    
...
/* 472:    */      {
/* 473:473 */        Int2ReferenceOpenHashMap.this.remove(this.wrapped.getInt(-this.pos - 2));
/* 474:474 */        this.last = -1;
/* 475:475 */        return;
/* 476:    */      }
/* 477:477 */      Int2ReferenceOpenHashMap.this.size -= 1;
...
/* 489:    */    } }
/* 490:    */  
/* 491:491 */  private class EntryIterator extends Int2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Int2ReferenceMap.Entry<V>> { private EntryIterator() { super(null); }
/* 492:    */    
/* 493:    */    private Int2ReferenceOpenHashMap<V>.MapEntry entry;
/* 494:494 */    public Int2ReferenceMap.Entry<V> next() { return this.entry = new Int2ReferenceOpenHashMap.MapEntry(Int2ReferenceOpenHashMap.this, nextEntry()); }
/* 495:    */    
/* 496:    */    public void remove()
/* 497:    */    {
/* 498:498 */      super.remove();
/* 499:499 */      Int2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 500:    */    } }
/* 501:    */  
/* 502:502 */  private class FastEntryIterator extends Int2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Int2ReferenceMap.Entry<V>> { private FastEntryIterator() { super(null); }
/* 503:503 */    final AbstractInt2ReferenceMap.BasicEntry<V> entry = new AbstractInt2ReferenceMap.BasicEntry(0, null);
/* 504:    */    
/* 505:505 */    public AbstractInt2ReferenceMap.BasicEntry<V> next() { int e = nextEntry();
/* 506:506 */      this.entry.key = Int2ReferenceOpenHashMap.this.key[e];
/* 507:507 */      this.entry.value = Int2ReferenceOpenHashMap.this.value[e];
/* 508:508 */      return this.entry;
/* 509:    */    } }
/* 510:    */  
/* 511:    */  private final class MapEntrySet extends AbstractObjectSet<Int2ReferenceMap.Entry<V>> implements Int2ReferenceMap.FastEntrySet<V> { private MapEntrySet() {}
/* 512:    */    
/* 513:513 */    public ObjectIterator<Int2ReferenceMap.Entry<V>> iterator() { return new Int2ReferenceOpenHashMap.EntryIterator(Int2ReferenceOpenHashMap.this, null); }
/* 514:    */    
/* 515:    */    public ObjectIterator<Int2ReferenceMap.Entry<V>> fastIterator() {
/* 516:516 */      return new Int2ReferenceOpenHashMap.FastEntryIterator(Int2ReferenceOpenHashMap.this, null);
/* 517:    */    }
/* 518:    */    
...
/* 523:    */      
/* 524:524 */      int pos = HashCommon.murmurHash3(k) & Int2ReferenceOpenHashMap.this.mask;
/* 525:    */      
/* 526:526 */      while (Int2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 527:527 */        if (Int2ReferenceOpenHashMap.this.key[pos] == k) return Int2ReferenceOpenHashMap.this.value[pos] == e.getValue();
/* 528:528 */        pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask;
/* 529:    */      }
...
/* 537:    */      
/* 538:538 */      int pos = HashCommon.murmurHash3(k) & Int2ReferenceOpenHashMap.this.mask;
/* 539:    */      
/* 540:540 */      while (Int2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 541:541 */        if (Int2ReferenceOpenHashMap.this.key[pos] == k) {
/* 542:542 */          Int2ReferenceOpenHashMap.this.remove(e.getKey());
/* 543:543 */          return true;
/* 544:    */        }
/* 545:545 */        pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask;
/* 546:    */      }
/* 547:547 */      return false;
/* 548:    */    }
/* 549:    */    
/* 550:550 */    public int size() { return Int2ReferenceOpenHashMap.this.size; }
/* 551:    */    
/* 553:553 */    public void clear() { Int2ReferenceOpenHashMap.this.clear(); }
/* 554:    */  }
/* 555:    */  
/* 556:    */  public Int2ReferenceMap.FastEntrySet<V> int2ReferenceEntrySet() {
...
/* 564:    */    extends Int2ReferenceOpenHashMap.MapIterator
/* 565:    */    implements IntIterator
/* 566:    */  {
/* 567:567 */    public KeyIterator() { super(null); }
/* 568:568 */    public int nextInt() { return Int2ReferenceOpenHashMap.this.key[nextEntry()]; }
/* 569:569 */    public Integer next() { return Integer.valueOf(Int2ReferenceOpenHashMap.this.key[nextEntry()]); } }
/* 570:    */  
/* 571:    */  private final class KeySet extends AbstractIntSet { private KeySet() {}
/* 572:    */    
/* 573:573 */    public IntIterator iterator() { return new Int2ReferenceOpenHashMap.KeyIterator(Int2ReferenceOpenHashMap.this); }
/* 574:    */    
/* 575:    */    public int size() {
/* 576:576 */      return Int2ReferenceOpenHashMap.this.size;
/* 577:    */    }
/* 578:    */    
/* 579:579 */    public boolean contains(int k) { return Int2ReferenceOpenHashMap.this.containsKey(k); }
/* 580:    */    
/* 581:    */    public boolean remove(int k) {
/* 582:582 */      int oldSize = Int2ReferenceOpenHashMap.this.size;
/* 583:583 */      Int2ReferenceOpenHashMap.this.remove(k);
/* 584:584 */      return Int2ReferenceOpenHashMap.this.size != oldSize;
/* 585:    */    }
/* 586:    */    
/* 587:587 */    public void clear() { Int2ReferenceOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
...
/* 598:    */    extends Int2ReferenceOpenHashMap<V>.MapIterator
/* 599:    */    implements ObjectIterator<V>
/* 600:    */  {
/* 601:601 */    public ValueIterator() { super(null); }
/* 602:602 */    public V next() { return Int2ReferenceOpenHashMap.this.value[nextEntry()]; }
/* 603:    */  }
/* 604:    */  
...
/* 607:607 */          return new Int2ReferenceOpenHashMap.ValueIterator(Int2ReferenceOpenHashMap.this);
/* 608:    */        }
/* 609:    */        
/* 610:610 */        public int size() { return Int2ReferenceOpenHashMap.this.size; }
/* 611:    */        
/* 612:    */        public boolean contains(Object v) {
/* 613:613 */          return Int2ReferenceOpenHashMap.this.containsValue(v);
/* 614:    */        }
/* 615:    */        
/* 616:616 */        public void clear() { Int2ReferenceOpenHashMap.this.clear(); }
/* 617:    */      };
/* 618:    */    }
...
/* 719:    */  }
/* 720:    */  
/* 724:    */  public Int2ReferenceOpenHashMap<V> clone()
/* 725:    */  {
/* 726:    */    Int2ReferenceOpenHashMap<V> c;
/* 727:    */    
/* 729:    */    try
/* 730:    */    {
/* 731:731 */      c = (Int2ReferenceOpenHashMap)super.clone();
/* 732:    */    }
...
/* 768:768 */    Int2ReferenceOpenHashMap<V>.MapIterator i = new MapIterator(null);
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.ints.Int2ReferenceOpenHashMap
