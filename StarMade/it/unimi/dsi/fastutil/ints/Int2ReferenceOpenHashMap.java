  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Int2ReferenceOpenHashMap(int expected, float local_f)
  {
  ...
  public Int2ReferenceOpenHashMap(Map<? extends Integer, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2ReferenceOpenHashMap(Map<? extends Integer, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2ReferenceOpenHashMap(Int2ReferenceMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Int2ReferenceOpenHashMap(Int2ReferenceMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Int2ReferenceOpenHashMap(int[] local_k, V[] local_v, float local_f)
  {
  ...
  public Int2ReferenceOpenHashMap(int[] local_k, V[] local_v)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Int2ReferenceOpenHashMap.ValueIterator(Int2ReferenceOpenHashMap.this);
        }
        ...
        {
          return Int2ReferenceOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Int2ReferenceOpenHashMap<V> local_c;
    try
    {
      local_c = (Int2ReferenceOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    int[] key = this.key;
    V[] value = this.value;
    Int2ReferenceOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    implements ObjectIterator<V>
  {
    ...
    public V next()
    {
      return Int2ReferenceOpenHashMap.this.value[nextEntry()];
    }
  }
    ...
    extends AbstractIntSet
  {
    ...
    {
      return new Int2ReferenceOpenHashMap.KeyIterator(Int2ReferenceOpenHashMap.this);
    }
    ...
    {
      return Int2ReferenceOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(int local_k)
    {
      int oldSize = Int2ReferenceOpenHashMap.this.size;
      Int2ReferenceOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Int2ReferenceOpenHashMap.MapIterator
    implements IntIterator
  {
    ...
    public int nextInt()
    {
      return Int2ReferenceOpenHashMap.this.key[nextEntry()];
    }
    
    public Integer next()
    {
      return Integer.valueOf(Int2ReferenceOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Int2ReferenceMap.FastEntrySet<V>
  {
    ...
    {
      return new Int2ReferenceOpenHashMap.EntryIterator(Int2ReferenceOpenHashMap.this, null);
    }
    
    public ObjectIterator<Int2ReferenceMap.Entry<V>> fastIterator()
    {
      return new Int2ReferenceOpenHashMap.FastEntryIterator(Int2ReferenceOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2ReferenceOpenHashMap.this.mask; Int2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask) {
        if (Int2ReferenceOpenHashMap.this.key[pos] == local_k) {
          return Int2ReferenceOpenHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Int2ReferenceOpenHashMap.this.mask; Int2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask) {
        if (Int2ReferenceOpenHashMap.this.key[pos] == local_k)
        {
          Int2ReferenceOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Int2ReferenceMap.Entry<V>>
  {
    ...
    public AbstractInt2ReferenceMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Int2ReferenceOpenHashMap.this.key[local_e];
      this.entry.value = Int2ReferenceOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Int2ReferenceMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Int2ReferenceOpenHashMap.MapEntry(Int2ReferenceOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Int2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Int2ReferenceOpenHashMap.this.field_49;
    int last = -1;
    int field_2167 = Int2ReferenceOpenHashMap.this.size;
    IntArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Int2ReferenceOpenHashMap.this.used;
      while ((this.field_2167 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2167 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2167 != 0)
      {
        boolean[] local_k = Int2ReferenceOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Int2ReferenceOpenHashMap.this.mask; Int2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Int2ReferenceOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Int2ReferenceOpenHashMap.this.key[pos]) & Int2ReferenceOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Int2ReferenceOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
    ...
    public void remove()
    {
      ...
      Int2ReferenceOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2167 > 0))
      {
        this.field_2167 += 1;
        nextEntry();
      }
    ...
    implements Int2ReferenceMap.Entry<V>, Map.Entry<Integer, V>
  {
    ...
    {
      return Integer.valueOf(Int2ReferenceOpenHashMap.this.key[this.index]);
    }
    ...
    public V setValue(V local_v)
    {
      ...
      Int2ReferenceOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Integer, V> local_e = (Map.Entry)local_o;
      return (Int2ReferenceOpenHashMap.this.key[this.index] == ((Integer)local_e.getKey()).intValue()) && (Int2ReferenceOpenHashMap.this.value[this.index] == local_e.getValue());
    }
