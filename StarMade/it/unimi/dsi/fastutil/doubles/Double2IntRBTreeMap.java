  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2IntRBTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2IntRBTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2IntRBTreeMap(Map<? extends Double, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2IntRBTreeMap(SortedMap<Double, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2IntRBTreeMap(Double2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2IntRBTreeMap(Double2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2IntRBTreeMap(double[] local_k, int[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2IntRBTreeMap(double[] local_k, int[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Double2IntMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Double2IntRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2IntRBTreeMap.EntryIterator(Double2IntRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from)
        {
          return new Double2IntRBTreeMap.EntryIterator(Double2IntRBTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2IntRBTreeMap.Entry local_f = Double2IntRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2IntRBTreeMap.Entry local_f = Double2IntRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2IntRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Double2IntRBTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2IntEntrySet();
        }
        
        public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry local_to)
        {
          return Double2IntRBTreeMap.this.headMap((Double)local_to.getKey()).double2IntEntrySet();
        }
        
        public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from)
        {
          return Double2IntRBTreeMap.this.tailMap((Double)from.getKey()).double2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Double2IntRBTreeMap.ValueIterator(Double2IntRBTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Double2IntRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2IntRBTreeMap local_c;
    try
    {
      local_c = (Double2IntRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2IntRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Double2IntRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2IntRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator()
          {
            return new Double2IntRBTreeMap.Submap.SubmapEntryIterator(Double2IntRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from)
          {
            return new Double2IntRBTreeMap.Submap.SubmapEntryIterator(Double2IntRBTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, Integer> local_e = (Map.Entry)local_o;
            Double2IntRBTreeMap.Entry local_f = Double2IntRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2IntRBTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, Integer> local_e = (Map.Entry)local_o;
            Double2IntRBTreeMap.Entry local_f = Double2IntRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2IntRBTreeMap.Submap.this.in7(local_f.key))) {
              Double2IntRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2IntRBTreeMap.Submap.SubmapIterator(Double2IntRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2IntRBTreeMap.Submap.this.clear();
          }
          
          public Double2IntMap.Entry first()
          {
            return Double2IntRBTreeMap.Submap.this.firstEntry();
          }
          
          public Double2IntMap.Entry last()
          {
            return Double2IntRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry local_to)
          {
            return Double2IntRBTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2IntEntrySet();
          }
          
          public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry local_to)
          {
            return Double2IntRBTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2IntEntrySet();
          }
          
          public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from)
          {
            return Double2IntRBTreeMap.Submap.this.tailMap((Double)from.getKey()).double2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Double2IntRBTreeMap.Submap.SubmapValueIterator(Double2IntRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Double2IntRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2IntRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2IntRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2IntRBTreeMap.Entry local_e;
      return (in7(local_kk)) && ((local_e = Double2IntRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(double local_k, int local_v)
    {
      ...
      int oldValue = Double2IntRBTreeMap.this.put(local_k, local_v);
    ...
    public int remove(double local_k)
    {
      ...
      int oldValue = Double2IntRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2IntRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2IntRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2IntSortedMap tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2IntRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2IntRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2IntSortedMap subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2IntRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2IntRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2IntRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2IntRBTreeMap.this.locateKey(this.from);
        if (Double2IntRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2IntRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2IntRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2IntRBTreeMap.this.locateKey(this.field_47);
        if (Double2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2IntRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2IntRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2IntRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Double2IntRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Double2IntRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2IntRBTreeMap.Submap.this.bottom) && (Double2IntRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2IntRBTreeMap.Submap.this.top) && (Double2IntRBTreeMap.this.compare(local_k, (this.prev = Double2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2IntRBTreeMap.this.locateKey(local_k);
            if (Double2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2IntRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2IntRBTreeMap.this.compare(this.prev.key, Double2IntRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2IntRBTreeMap.Submap.this.top) && (this.next != null) && (Double2IntRBTreeMap.this.compare(this.next.key, Double2IntRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2IntSortedMap.KeySet
    {
      ...
      {
        return new Double2IntRBTreeMap.Submap.SubmapKeyIterator(Double2IntRBTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2IntRBTreeMap.Submap.SubmapKeyIterator(Double2IntRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2IntSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2IntRBTreeMap.KeyIterator(Double2IntRBTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2IntRBTreeMap.KeyIterator(Double2IntRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2IntRBTreeMap.this.locateKey(local_k)) != null) {
        if (Double2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
