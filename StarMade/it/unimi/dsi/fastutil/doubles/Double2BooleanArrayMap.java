...
/*  17:    */
/*  66:    */public class Double2BooleanArrayMap
/*  67:    */  extends AbstractDouble2BooleanMap
/*  68:    */  implements Serializable, Cloneable
/*  69:    */{
/*  70:    */  private static final long serialVersionUID = 1L;
/*  71:    */  private transient double[] key;
/*  72:    */  private transient boolean[] value;
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Double2BooleanArrayMap(double[] key, boolean[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Double2BooleanArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = DoubleArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = BooleanArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Double2BooleanArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new double[capacity];
/*  94: 94 */    this.value = new boolean[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Double2BooleanArrayMap(Double2BooleanMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Double2BooleanArrayMap(Map<? extends Double, ? extends Boolean> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Double2BooleanArrayMap(double[] key, boolean[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Double2BooleanMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Double2BooleanArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Double2BooleanMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractDouble2BooleanMap.BasicEntry(Double2BooleanArrayMap.this.key[this.next], Double2BooleanArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Double2BooleanMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractDouble2BooleanMap.BasicEntry entry = new AbstractDouble2BooleanMap.BasicEntry(0.0D, false);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Double2BooleanArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Double2BooleanMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Double2BooleanArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Double2BooleanArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Double2BooleanArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Double, Boolean> e = (Map.Entry)o;
/* 165:165 */      double k = ((Double)e.getKey()).doubleValue();
/* 166:166 */      return (Double2BooleanArrayMap.this.containsKey(k)) && (Double2BooleanArrayMap.this.get(k) == ((Boolean)e.getValue()).booleanValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Double2BooleanMap.FastEntrySet double2BooleanEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 176:    */  }
/* 177:    */  
/* 182:    */  public boolean get(double k)
/* 183:    */  {
...
/* 200:    */  }
/* 201:    */  
/* 202:    */  public boolean containsValue(boolean v)
/* 203:    */  {
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public boolean put(double k, boolean v)
/* 213:    */  {
/* 214:214 */    int oldKey = findKey(k);
/* 215:215 */    if (oldKey != -1) {
/* 216:216 */      boolean oldValue = this.value[oldKey];
...
/* 222:222 */      boolean[] newValue = new boolean[this.size == 0 ? 2 : this.size * 2];
...
/* 234:    */  }
/* 235:    */  
/* 236:    */  public boolean remove(double k)
/* 237:    */  {
/* 238:238 */    int oldPos = findKey(k);
/* 239:239 */    if (oldPos == -1) return this.defRetValue;
/* 240:240 */    boolean oldValue = this.value[oldPos];
...
/* 253:    */  }
/* 254:    */  
/* 255:    */  public BooleanCollection values() {
/* 256:256 */    return BooleanCollections.unmodifiable(new BooleanArraySet(this.value, this.size));
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Double2BooleanArrayMap clone()
/* 263:    */  {
/* 264:    */    Double2BooleanArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Double2BooleanArrayMap)super.clone();
/* 270:    */    }
/* 271:    */    catch (CloneNotSupportedException cantHappen) {
/* 272:272 */      throw new InternalError();
/* 273:    */    }
/* 274:274 */    c.key = ((double[])this.key.clone());
/* 275:275 */    c.value = ((boolean[])this.value.clone());
/* 276:276 */    return c;
/* 277:    */  }
/* 278:    */  
...
/* 282:282 */      s.writeBoolean(this.value[i]);
/* 283:    */    }
/* 284:    */  }
/* 285:    */  
...
/* 289:289 */    this.value = new boolean[this.size];
/* 290:290 */    for (int i = 0; i < this.size; i++) {
/* 291:291 */      this.key[i] = s.readDouble();
/* 292:292 */      this.value[i] = s.readBoolean();
/* 293:    */    }
/* 294:    */  }
/* 295:    */}
