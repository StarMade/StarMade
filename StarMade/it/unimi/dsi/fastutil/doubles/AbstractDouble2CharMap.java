  ...
  implements Double2CharMap, Serializable
{
  ...
  public void putAll(Map<? extends Double, ? extends Character> local_m)
  {
    ...
    Iterator<? extends Map.Entry<? extends Double, ? extends Character>> local_i = local_m.entrySet().iterator();
    if ((local_m instanceof Double2CharMap)) {
      while (local_n-- != 0)
      {
        Double2CharMap.Entry local_e = (Double2CharMap.Entry)local_i.next();
        put(local_e.getDoubleKey(), local_e.getCharValue());
      }
    } else {
      while (local_n-- != 0)
      {
        Map.Entry<? extends Double, ? extends Character> local_e = (Map.Entry)local_i.next();
        put((Double)local_e.getKey(), (Character)local_e.getValue());
      }
    }
  }
  ...
  public DoubleSet keySet()
  {
    new AbstractDoubleSet()
    {
      ...
      {
        return AbstractDouble2CharMap.this.containsKey(local_k);
      }
      ...
      public DoubleIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<Double, Character>> field_68 = AbstractDouble2CharMap.this.entrySet().iterator();
          
          public double nextDouble()
          {
            return ((Double2CharMap.Entry)this.field_68.next()).getDoubleKey();
          }
  ...
  public CharCollection values()
  {
    new AbstractCharCollection()
    {
      ...
      {
        return AbstractDouble2CharMap.this.containsValue(local_k);
      }
      ...
      public CharIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<Double, Character>> field_67 = AbstractDouble2CharMap.this.entrySet().iterator();
          
          public char nextChar()
          {
            return ((Double2CharMap.Entry)this.field_67.next()).getCharValue();
          }
  ...
  public int hashCode()
  {
    int local_h = 0;
    int local_n = size();
    ObjectIterator<? extends Map.Entry<Double, Character>> local_i = entrySet().iterator();
    while (local_n-- != 0) {
