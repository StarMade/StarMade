  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2LongOpenCustomHashMap(int expected, float local_f, DoubleHash.Strategy strategy)
  {
  ...
  public Double2LongOpenCustomHashMap(Map<? extends Double, ? extends Long> local_m, float local_f, DoubleHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Double2LongOpenCustomHashMap(Map<? extends Double, ? extends Long> local_m, DoubleHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Double2LongOpenCustomHashMap(Double2LongMap local_m, float local_f, DoubleHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Double2LongOpenCustomHashMap(Double2LongMap local_m, DoubleHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Double2LongOpenCustomHashMap(double[] local_k, long[] local_v, float local_f, DoubleHash.Strategy strategy)
  {
  ...
  public Double2LongOpenCustomHashMap(double[] local_k, long[] local_v, DoubleHash.Strategy strategy)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Double2LongOpenCustomHashMap.ValueIterator(Double2LongOpenCustomHashMap.this);
        }
        ...
        {
          return Double2LongOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2LongOpenCustomHashMap local_c;
    try
    {
      local_c = (Double2LongOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Double2LongOpenCustomHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Double2LongOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSet
  {
    ...
    {
      return new Double2LongOpenCustomHashMap.KeyIterator(Double2LongOpenCustomHashMap.this);
    }
    ...
    {
      return Double2LongOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2LongOpenCustomHashMap.this.size;
      Double2LongOpenCustomHashMap.this.remove(local_k);
    ...
    implements DoubleIterator
  {
    ...
    public Double next()
    {
      return Double.valueOf(Double2LongOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2LongMap.FastEntrySet
  {
    ...
    {
      return new Double2LongOpenCustomHashMap.EntryIterator(Double2LongOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Double2LongMap.Entry> fastIterator()
    {
      return new Double2LongOpenCustomHashMap.FastEntryIterator(Double2LongOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Double2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Double2LongOpenCustomHashMap.this.mask; Double2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongOpenCustomHashMap.this.mask) {
        if (Double2LongOpenCustomHashMap.this.strategy.equals(Double2LongOpenCustomHashMap.this.key[pos], local_k)) {
          return Double2LongOpenCustomHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Double2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Double2LongOpenCustomHashMap.this.mask; Double2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongOpenCustomHashMap.this.mask) {
        if (Double2LongOpenCustomHashMap.this.strategy.equals(Double2LongOpenCustomHashMap.this.key[pos], local_k))
        {
          Double2LongOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Double2LongMap.Entry>
  {
    ...
    public AbstractDouble2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2LongOpenCustomHashMap.this.key[local_e];
      this.entry.value = Double2LongOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Double2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Double2LongOpenCustomHashMap.MapEntry(Double2LongOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2LongOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Double2LongOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1667 = Double2LongOpenCustomHashMap.this.size;
    DoubleArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Double2LongOpenCustomHashMap.this.used;
      while ((this.field_1667 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1667 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1667 != 0)
      {
        boolean[] local_k = Double2LongOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2LongOpenCustomHashMap.this.mask; Double2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Double2LongOpenCustomHashMap.this.strategy.hashCode(Double2LongOpenCustomHashMap.this.key[pos])) & Double2LongOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2LongOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Double2LongOpenCustomHashMap.this.key[pos]);
        }
        Double2LongOpenCustomHashMap.this.key[last] = Double2LongOpenCustomHashMap.this.key[pos];
        Double2LongOpenCustomHashMap.this.value[last] = Double2LongOpenCustomHashMap.this.value[pos];
      }
      Double2LongOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Double2LongOpenCustomHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
        this.last = -1;
        return;
      }
      Double2LongOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1667 > 0))
      {
        this.field_1667 += 1;
        nextEntry();
      }
    ...
    implements Double2LongMap.Entry, Map.Entry<Double, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Double2LongOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Long> local_e = (Map.Entry)local_o;
      return (Double2LongOpenCustomHashMap.this.strategy.equals(Double2LongOpenCustomHashMap.this.key[this.index], ((Double)local_e.getKey()).doubleValue())) && (Double2LongOpenCustomHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
