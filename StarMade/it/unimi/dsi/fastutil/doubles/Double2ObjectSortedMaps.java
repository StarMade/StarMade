...
public class Double2ObjectSortedMaps
{
  ...
  public static <V> Double2ObjectSortedMap<V> synchronize(Double2ObjectSortedMap<V> local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static <V> Double2ObjectSortedMap<V> synchronize(Double2ObjectSortedMap<V> local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static <V> Double2ObjectSortedMap<V> unmodifiable(Double2ObjectSortedMap<V> local_m)
  {
    ...
    implements Double2ObjectSortedMap<V>, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Double2ObjectSortedMap<V> local_m)
    {
      super();
    ...
    implements Double2ObjectSortedMap<V>, Serializable
  {
    ...
    protected SynchronizedSortedMap(Double2ObjectSortedMap<V> local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Double2ObjectSortedMap<V> local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Double2ObjectSortedMap<V>, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Double2ObjectMaps.Singleton.SingletonEntry(this), Double2ObjectSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
