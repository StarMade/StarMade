...
/*     */     }
/* 302 */     public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.double2ObjectEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Double, V>> entrySet() {
/* 304 */       return double2ObjectEntrySet(); } 
...
/* 308 */     public Double2ObjectSortedMap<V> headMap(double to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Double2ObjectSortedMap<V> tailMap(double from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Double2ObjectSortedMap<V> headMap(Double to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Double2ObjectSortedMap<V> tailMap(Double from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.double2ObjectEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Double, V>> entrySet() {
/* 244 */       return double2ObjectEntrySet(); } 
...
/* 248 */     public Double2ObjectSortedMap<V> headMap(double to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Double2ObjectSortedMap<V> tailMap(double from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public double firstDoubleKey() {
...
/* 259 */     public Double2ObjectSortedMap<V> headMap(Double to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Double2ObjectSortedMap<V> tailMap(Double from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Double2ObjectMaps.Singleton.SingletonEntry(this), Double2ObjectSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Double, V>> entrySet() { return double2ObjectEntrySet(); } 
...
/*     */     }
/*     */     public Double2ObjectSortedMap<V> subMap(double from, double to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Double2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Double2ObjectSortedMap<V> headMap(double to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Double2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Double2ObjectSortedMap<V> tailMap(double from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Double2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Double2ObjectSortedMap<V> tailMap(Double ofrom) { return tailMap(ofrom.doubleValue()); } 
/* 156 */     public Double2ObjectSortedMap<V> subMap(Double ofrom, Double oto) { return subMap(ofrom.doubleValue(), oto.doubleValue()); } 
/*     */     public Double firstKey() {
...
/*  77 */       return null;
/*     */     }
/*  79 */     public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Double, V>> entrySet() {
/*  81 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  83 */     public DoubleSortedSet keySet() { return DoubleSortedSets.EMPTY_SET; } 
/*     */     public Double2ObjectSortedMap<V> subMap(double from, double to) {
/*  85 */       return Double2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*  87 */     public Double2ObjectSortedMap<V> headMap(double to) { return Double2ObjectSortedMaps.EMPTY_MAP; } 
/*     */     public Double2ObjectSortedMap<V> tailMap(double from) {
/*  89 */       return Double2ObjectSortedMaps.EMPTY_MAP; } 
...
/*  92 */     public Double2ObjectSortedMap<V> headMap(Double oto) { return headMap(oto.doubleValue()); } 
/*  93 */     public Double2ObjectSortedMap<V> tailMap(Double ofrom) { return tailMap(ofrom.doubleValue()); } 
/*  94 */     public Double2ObjectSortedMap<V> subMap(Double ofrom, Double oto) { return subMap(ofrom.doubleValue(), oto.doubleValue()); } 
