...
/*   22:     */
/*   73:     */public class Double2BooleanRBTreeMap
...
/*   91:     */  
/*   92:     */  public Double2BooleanRBTreeMap()
/*   93:     */  {
/*   94:  94 */    allocatePaths();
/*   95:     */    
...
/*  119: 119 */          return Double2BooleanRBTreeMap.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*  120:     */        }
/*  121:     */        
/*  122: 122 */        public int compare(Double ok1, Double ok2) { return Double2BooleanRBTreeMap.this.storedComparator.compare(ok1, ok2); }
/*  123:     */      };
/*  124:     */    }
/*  125:     */  }
/*  126:     */  
/*  133:     */  public Double2BooleanRBTreeMap(Comparator<? super Double> c)
/*  134:     */  {
/*  135: 135 */    this();
...
/*  138:     */  }
/*  139:     */  
/*  145:     */  public Double2BooleanRBTreeMap(Map<? extends Double, ? extends Boolean> m)
/*  146:     */  {
/*  147: 147 */    this();
/*  148: 148 */    putAll(m);
/*  149:     */  }
/*  150:     */  
/*  155:     */  public Double2BooleanRBTreeMap(SortedMap<Double, Boolean> m)
/*  156:     */  {
/*  157: 157 */    this(m.comparator());
/*  158: 158 */    putAll(m);
/*  159:     */  }
/*  160:     */  
/*  165:     */  public Double2BooleanRBTreeMap(Double2BooleanMap m)
/*  166:     */  {
/*  167: 167 */    this();
/*  168: 168 */    putAll(m);
/*  169:     */  }
/*  170:     */  
/*  175:     */  public Double2BooleanRBTreeMap(Double2BooleanSortedMap m)
/*  176:     */  {
/*  177: 177 */    this(m.comparator());
/*  178: 178 */    putAll(m);
/*  179:     */  }
/*  180:     */  
/*  188:     */  public Double2BooleanRBTreeMap(double[] k, boolean[] v, Comparator<? super Double> c)
/*  189:     */  {
/*  190: 190 */    this(c);
...
/*  194:     */  }
/*  195:     */  
/*  201:     */  public Double2BooleanRBTreeMap(double[] k, boolean[] v)
/*  202:     */  {
...
/*  278:     */  }
/*  279:     */  
/*  282:     */  public boolean put(double k, boolean v)
/*  283:     */  {
...
/*  448:     */  }
/*  449:     */  
/*  454:     */  public boolean remove(double k)
/*  455:     */  {
...
/*  724:     */  }
/*  725:     */  
/*  728:     */  public Boolean put(Double ok, Boolean ov)
/*  729:     */  {
/*  730: 730 */    boolean oldValue = put(ok.doubleValue(), ov.booleanValue());
/*  731: 731 */    return this.modified ? null : Boolean.valueOf(oldValue);
/*  732:     */  }
/*  733:     */  
/*  735:     */  public Boolean remove(Object ok)
/*  736:     */  {
/*  737: 737 */    boolean oldValue = remove(((Double)ok).doubleValue());
...
/*  769:     */    implements Cloneable, Double2BooleanMap.Entry
/*  770:     */  {
...
/*  977: 977 */      Map.Entry<Double, Boolean> e = (Map.Entry)o;
/*  978:     */      
/*  979: 979 */      return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*  980:     */    }
/*  981:     */    
/*  982:     */    public int hashCode() {
/*  983: 983 */      return HashCommon.double2int(this.key) ^ (this.value ? 1231 : 1237);
/*  984:     */    }
/*  985:     */    
...
/* 1034:     */  }
/* 1035:     */  
/* 1037:     */  public boolean get(double k)
/* 1038:     */  {
...
/* 1054:     */  {
/* 1055:     */    Double2BooleanRBTreeMap.Entry prev;
/* 1056:     */    
/* 1058:     */    Double2BooleanRBTreeMap.Entry next;
/* 1059:     */    
/* 1060:     */    Double2BooleanRBTreeMap.Entry curr;
/* 1061:     */    
/* 1062:1062 */    int index = 0;
/* 1063:     */    
/* 1064:1064 */    TreeIterator() { this.next = Double2BooleanRBTreeMap.this.firstEntry; }
/* 1065:     */    
/* 1066:     */    TreeIterator(double k) {
/* 1067:1067 */      if ((this.next = Double2BooleanRBTreeMap.this.locateKey(k)) != null)
/* 1068:1068 */        if (Double2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1079:     */    
/* 1080:     */    Double2BooleanRBTreeMap.Entry nextEntry() {
...
/* 1089:     */    
/* 1090:     */    Double2BooleanRBTreeMap.Entry previousEntry() {
...
/* 1111:1111 */      Double2BooleanRBTreeMap.this.remove(this.curr.key);
...
/* 1127:     */    extends Double2BooleanRBTreeMap.TreeIterator
/* 1128:     */    implements ObjectListIterator<Double2BooleanMap.Entry>
/* 1129:     */  {
/* 1130:1130 */    EntryIterator() { super(); }
/* 1131:     */    
/* 1132:1132 */    EntryIterator(double k) { super(k); }
/* 1133:     */    
/* 1134:1134 */    public Double2BooleanMap.Entry next() { return nextEntry(); }
/* 1135:1135 */    public Double2BooleanMap.Entry previous() { return previousEntry(); }
/* 1136:1136 */    public void set(Double2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1137:1137 */    public void add(Double2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1138:     */  }
/* 1139:     */  
/* 1140:1140 */  public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1141:1141 */        final Comparator<? super Double2BooleanMap.Entry> comparator = new Comparator() {
/* 1142:     */          public int compare(Double2BooleanMap.Entry x, Double2BooleanMap.Entry y) {
/* 1143:1143 */            return Double2BooleanRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/* 1144:     */          }
/* 1145:     */        };
/* 1146:     */        
/* 1147:1147 */        public Comparator<? super Double2BooleanMap.Entry> comparator() { return this.comparator; }
/* 1148:     */        
/* 1149:     */        public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator() {
/* 1150:1150 */          return new Double2BooleanRBTreeMap.EntryIterator(Double2BooleanRBTreeMap.this);
/* 1151:     */        }
/* 1152:     */        
/* 1153:1153 */        public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator(Double2BooleanMap.Entry from) { return new Double2BooleanRBTreeMap.EntryIterator(Double2BooleanRBTreeMap.this, ((Double)from.getKey()).doubleValue()); }
/* 1154:     */        
/* 1155:     */        public boolean contains(Object o)
/* 1156:     */        {
/* 1157:1157 */          if (!(o instanceof Map.Entry)) return false;
/* 1158:1158 */          Map.Entry<Double, Boolean> e = (Map.Entry)o;
/* 1159:1159 */          Double2BooleanRBTreeMap.Entry f = Double2BooleanRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1160:1160 */          return e.equals(f);
/* 1161:     */        }
/* 1162:     */        
/* 1163:     */        public boolean remove(Object o) {
/* 1164:1164 */          if (!(o instanceof Map.Entry)) return false;
/* 1165:1165 */          Map.Entry<Double, Boolean> e = (Map.Entry)o;
/* 1166:1166 */          Double2BooleanRBTreeMap.Entry f = Double2BooleanRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1167:1167 */          if (f != null) Double2BooleanRBTreeMap.this.remove(f.key);
/* 1168:1168 */          return f != null; }
/* 1169:     */        
/* 1170:1170 */        public int size() { return Double2BooleanRBTreeMap.this.count; }
/* 1171:1171 */        public void clear() { Double2BooleanRBTreeMap.this.clear(); }
/* 1172:1172 */        public Double2BooleanMap.Entry first() { return Double2BooleanRBTreeMap.this.firstEntry; }
/* 1173:1173 */        public Double2BooleanMap.Entry last() { return Double2BooleanRBTreeMap.this.lastEntry; }
/* 1174:1174 */        public ObjectSortedSet<Double2BooleanMap.Entry> subSet(Double2BooleanMap.Entry from, Double2BooleanMap.Entry to) { return Double2BooleanRBTreeMap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2BooleanEntrySet(); }
/* 1175:1175 */        public ObjectSortedSet<Double2BooleanMap.Entry> headSet(Double2BooleanMap.Entry to) { return Double2BooleanRBTreeMap.this.headMap((Double)to.getKey()).double2BooleanEntrySet(); }
/* 1176:1176 */        public ObjectSortedSet<Double2BooleanMap.Entry> tailSet(Double2BooleanMap.Entry from) { return Double2BooleanRBTreeMap.this.tailMap((Double)from.getKey()).double2BooleanEntrySet(); }
/* 1177:     */      };
/* 1178:1178 */    return this.entries;
/* 1179:     */  }
/* 1180:     */  
/* 1183:     */  private final class KeyIterator
/* 1184:     */    extends Double2BooleanRBTreeMap.TreeIterator
...
/* 1197:     */  }
/* 1198:     */  
/* 1199:1199 */  private class KeySet extends AbstractDouble2BooleanSortedMap.KeySet { private KeySet() { super(); }
/* 1200:1200 */    public DoubleBidirectionalIterator iterator() { return new Double2BooleanRBTreeMap.KeyIterator(Double2BooleanRBTreeMap.this); }
/* 1201:1201 */    public DoubleBidirectionalIterator iterator(double from) { return new Double2BooleanRBTreeMap.KeyIterator(Double2BooleanRBTreeMap.this, from); }
/* 1202:     */  }
/* 1203:     */  
...
/* 1218:     */    extends Double2BooleanRBTreeMap.TreeIterator
...
/* 1242:1242 */          return new Double2BooleanRBTreeMap.ValueIterator(Double2BooleanRBTreeMap.this, null);
/* 1243:     */        }
/* 1244:     */        
/* 1245:1245 */        public boolean contains(boolean k) { return Double2BooleanRBTreeMap.this.containsValue(k); }
/* 1246:     */        
/* 1247:     */        public int size() {
/* 1248:1248 */          return Double2BooleanRBTreeMap.this.count;
/* 1249:     */        }
/* 1250:     */        
/* 1251:1251 */        public void clear() { Double2BooleanRBTreeMap.this.clear(); }
/* 1252:     */      };
/* 1253:     */    }
...
/* 1258:     */  
/* 1259:     */  public Double2BooleanSortedMap headMap(double to) {
/* 1260:1260 */    return new Submap(0.0D, true, to, false);
/* 1261:     */  }
/* 1262:     */  
/* 1263:1263 */  public Double2BooleanSortedMap tailMap(double from) { return new Submap(from, false, 0.0D, true); }
/* 1264:     */  
/* 1265:     */  public Double2BooleanSortedMap subMap(double from, double to) {
/* 1266:1266 */    return new Submap(from, false, to, false);
/* 1267:     */  }
/* 1268:     */  
/* 1272:     */  private final class Submap
/* 1273:     */    extends AbstractDouble2BooleanSortedMap
...
/* 1289:     */    boolean top;
/* 1290:     */    
/* 1292:     */    protected volatile transient ObjectSortedSet<Double2BooleanMap.Entry> entries;
/* 1293:     */    
...
/* 1303:     */    {
/* 1304:1304 */      if ((!bottom) && (!top) && (Double2BooleanRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305:1305 */      this.from = from;
/* 1306:1306 */      this.bottom = bottom;
/* 1307:1307 */      this.to = to;
/* 1308:1308 */      this.top = top;
/* 1309:1309 */      this.defRetValue = Double2BooleanRBTreeMap.this.defRetValue;
/* 1310:     */    }
/* 1311:     */    
...
/* 1322:     */    {
/* 1323:1323 */      return ((this.bottom) || (Double2BooleanRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Double2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/* 1324:     */    }
/* 1325:     */    
/* 1326:     */    public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet() {
/* 1327:1327 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1328:     */          public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator() {
/* 1329:1329 */            return new Double2BooleanRBTreeMap.Submap.SubmapEntryIterator(Double2BooleanRBTreeMap.Submap.this);
/* 1330:     */          }
/* 1331:     */          
/* 1332:1332 */          public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator(Double2BooleanMap.Entry from) { return new Double2BooleanRBTreeMap.Submap.SubmapEntryIterator(Double2BooleanRBTreeMap.Submap.this, ((Double)from.getKey()).doubleValue()); }
/* 1333:     */          
/* 1334:1334 */          public Comparator<? super Double2BooleanMap.Entry> comparator() { return Double2BooleanRBTreeMap.this.double2BooleanEntrySet().comparator(); }
/* 1335:     */          
/* 1336:     */          public boolean contains(Object o) {
/* 1337:1337 */            if (!(o instanceof Map.Entry)) return false;
/* 1338:1338 */            Map.Entry<Double, Boolean> e = (Map.Entry)o;
/* 1339:1339 */            Double2BooleanRBTreeMap.Entry f = Double2BooleanRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1340:1340 */            return (f != null) && (Double2BooleanRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1341:     */          }
/* 1342:     */          
/* 1343:     */          public boolean remove(Object o) {
/* 1344:1344 */            if (!(o instanceof Map.Entry)) return false;
/* 1345:1345 */            Map.Entry<Double, Boolean> e = (Map.Entry)o;
/* 1346:1346 */            Double2BooleanRBTreeMap.Entry f = Double2BooleanRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1347:1347 */            if ((f != null) && (Double2BooleanRBTreeMap.Submap.this.in(f.key))) Double2BooleanRBTreeMap.Submap.this.remove(f.key);
...
/* 1353:1353 */            return c; }
/* 1354:     */          
/* 1355:1355 */          public boolean isEmpty() { return !new Double2BooleanRBTreeMap.Submap.SubmapIterator(Double2BooleanRBTreeMap.Submap.this).hasNext(); }
/* 1356:1356 */          public void clear() { Double2BooleanRBTreeMap.Submap.this.clear(); }
/* 1357:1357 */          public Double2BooleanMap.Entry first() { return Double2BooleanRBTreeMap.Submap.this.firstEntry(); }
/* 1358:1358 */          public Double2BooleanMap.Entry last() { return Double2BooleanRBTreeMap.Submap.this.lastEntry(); }
/* 1359:1359 */          public ObjectSortedSet<Double2BooleanMap.Entry> subSet(Double2BooleanMap.Entry from, Double2BooleanMap.Entry to) { return Double2BooleanRBTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2BooleanEntrySet(); }
/* 1360:1360 */          public ObjectSortedSet<Double2BooleanMap.Entry> headSet(Double2BooleanMap.Entry to) { return Double2BooleanRBTreeMap.Submap.this.headMap((Double)to.getKey()).double2BooleanEntrySet(); }
/* 1361:1361 */          public ObjectSortedSet<Double2BooleanMap.Entry> tailSet(Double2BooleanMap.Entry from) { return Double2BooleanRBTreeMap.Submap.this.tailMap((Double)from.getKey()).double2BooleanEntrySet(); }
/* 1362:     */        };
/* 1363:1363 */      return this.entries; }
/* 1364:     */    
/* 1365:1365 */    private class KeySet extends AbstractDouble2BooleanSortedMap.KeySet { private KeySet() { super(); }
/* 1366:1366 */      public DoubleBidirectionalIterator iterator() { return new Double2BooleanRBTreeMap.Submap.SubmapKeyIterator(Double2BooleanRBTreeMap.Submap.this); }
/* 1367:1367 */      public DoubleBidirectionalIterator iterator(double from) { return new Double2BooleanRBTreeMap.Submap.SubmapKeyIterator(Double2BooleanRBTreeMap.Submap.this, from); }
/* 1368:     */    }
/* 1369:     */    
...
/* 1376:1376 */            return new Double2BooleanRBTreeMap.Submap.SubmapValueIterator(Double2BooleanRBTreeMap.Submap.this, null);
/* 1377:     */          }
/* 1378:     */          
/* 1379:1379 */          public boolean contains(boolean k) { return Double2BooleanRBTreeMap.Submap.this.containsValue(k); }
/* 1380:     */          
/* 1381:     */          public int size() {
/* 1382:1382 */            return Double2BooleanRBTreeMap.Submap.this.size();
/* 1383:     */          }
/* 1384:     */          
/* 1385:1385 */          public void clear() { Double2BooleanRBTreeMap.Submap.this.clear(); }
/* 1386:     */        };
/* 1387:     */      }
/* 1388:1388 */      return this.values;
/* 1389:     */    }
/* 1390:     */    
/* 1392:1392 */    public boolean containsKey(double k) { return (in(k)) && (Double2BooleanRBTreeMap.this.containsKey(k)); }
/* 1393:     */    
...
/* 1402:     */    }
/* 1403:     */    
/* 1404:     */    public boolean get(double k)
/* 1405:     */    {
/* 1406:1406 */      double kk = k;
/* 1407:1407 */      Double2BooleanRBTreeMap.Entry e; return (in(kk)) && ((e = Double2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1408:     */    }
/* 1409:     */    
/* 1410:1410 */    public boolean put(double k, boolean v) { Double2BooleanRBTreeMap.this.modified = false;
...
/* 1412:1412 */      boolean oldValue = Double2BooleanRBTreeMap.this.put(k, v);
/* 1413:1413 */      return Double2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1414:     */    }
/* 1415:     */    
/* 1416:1416 */    public Boolean put(Double ok, Boolean ov) { boolean oldValue = put(ok.doubleValue(), ov.booleanValue());
/* 1417:1417 */      return Double2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
/* 1418:     */    }
/* 1419:     */    
/* 1420:     */    public boolean remove(double k) {
/* 1421:1421 */      Double2BooleanRBTreeMap.this.modified = false;
/* 1422:1422 */      if (!in(k)) return this.defRetValue;
/* 1423:1423 */      boolean oldValue = Double2BooleanRBTreeMap.this.remove(k);
/* 1424:1424 */      return Double2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1425:     */    }
/* 1426:     */    
/* 1427:1427 */    public Boolean remove(Object ok) { boolean oldValue = remove(((Double)ok).doubleValue());
/* 1428:1428 */      return Double2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
/* 1429:     */    }
/* 1430:     */    
...
/* 1441:     */    
/* 1443:1443 */    public DoubleComparator comparator() { return Double2BooleanRBTreeMap.this.actualComparator; }
/* 1444:     */    
/* 1445:     */    public Double2BooleanSortedMap headMap(double to) {
/* 1446:1446 */      if (this.top) return new Submap(Double2BooleanRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447:1447 */      return Double2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Double2BooleanRBTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1448:     */    }
/* 1449:     */    
/* 1450:1450 */    public Double2BooleanSortedMap tailMap(double from) { if (this.bottom) return new Submap(Double2BooleanRBTreeMap.this, from, false, this.to, this.top);
/* 1451:1451 */      return Double2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2BooleanRBTreeMap.this, from, false, this.to, this.top) : this;
/* 1452:     */    }
/* 1453:     */    
/* 1454:1454 */    public Double2BooleanSortedMap subMap(double from, double to) { if ((this.top) && (this.bottom)) return new Submap(Double2BooleanRBTreeMap.this, from, false, to, false);
/* 1455:1455 */      if (!this.top) to = Double2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456:1456 */      if (!this.bottom) from = Double2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457:1457 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458:1458 */      return new Submap(Double2BooleanRBTreeMap.this, from, false, to, false);
/* 1459:     */    }
/* 1460:     */    
/* 1463:     */    public Double2BooleanRBTreeMap.Entry firstEntry()
/* 1464:     */    {
/* 1465:1465 */      if (Double2BooleanRBTreeMap.this.tree == null) return null;
/* 1466:     */      Double2BooleanRBTreeMap.Entry e;
/* 1467:     */      Double2BooleanRBTreeMap.Entry e;
/* 1468:1468 */      if (this.bottom) { e = Double2BooleanRBTreeMap.this.firstEntry;
/* 1469:     */      } else {
/* 1470:1470 */        e = Double2BooleanRBTreeMap.this.locateKey(this.from);
/* 1471:     */        
/* 1472:1472 */        if (Double2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1473:     */        }
/* 1474:     */      }
/* 1475:1475 */      if ((e == null) || ((!this.top) && (Double2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476:1476 */      return e;
/* 1477:     */    }
/* 1478:     */    
/* 1481:     */    public Double2BooleanRBTreeMap.Entry lastEntry()
/* 1482:     */    {
/* 1483:1483 */      if (Double2BooleanRBTreeMap.this.tree == null) return null;
/* 1484:     */      Double2BooleanRBTreeMap.Entry e;
/* 1485:     */      Double2BooleanRBTreeMap.Entry e;
/* 1486:1486 */      if (this.top) { e = Double2BooleanRBTreeMap.this.lastEntry;
/* 1487:     */      } else {
/* 1488:1488 */        e = Double2BooleanRBTreeMap.this.locateKey(this.to);
/* 1489:     */        
/* 1490:1490 */        if (Double2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1491:     */        }
/* 1492:     */      }
/* 1493:1493 */      if ((e == null) || ((!this.bottom) && (Double2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494:1494 */      return e;
/* 1495:     */    }
/* 1496:     */    
/* 1497:1497 */    public double firstDoubleKey() { Double2BooleanRBTreeMap.Entry e = firstEntry();
/* 1498:1498 */      if (e == null) throw new NoSuchElementException();
/* 1499:1499 */      return e.key;
/* 1500:     */    }
/* 1501:     */    
/* 1502:1502 */    public double lastDoubleKey() { Double2BooleanRBTreeMap.Entry e = lastEntry();
/* 1503:1503 */      if (e == null) throw new NoSuchElementException();
/* 1504:1504 */      return e.key;
/* 1505:     */    }
/* 1506:     */    
/* 1507:1507 */    public Double firstKey() { Double2BooleanRBTreeMap.Entry e = firstEntry();
/* 1508:1508 */      if (e == null) throw new NoSuchElementException();
/* 1509:1509 */      return e.getKey();
/* 1510:     */    }
/* 1511:     */    
/* 1512:1512 */    public Double lastKey() { Double2BooleanRBTreeMap.Entry e = lastEntry();
/* 1513:1513 */      if (e == null) throw new NoSuchElementException();
/* 1514:1514 */      return e.getKey();
/* 1515:     */    }
/* 1516:     */    
/* 1519:     */    private class SubmapIterator
/* 1520:     */      extends Double2BooleanRBTreeMap.TreeIterator
/* 1521:     */    {
/* 1522:     */      SubmapIterator()
/* 1523:     */      {
/* 1524:1524 */        super();
/* 1525:1525 */        this.next = Double2BooleanRBTreeMap.Submap.this.firstEntry();
/* 1526:     */      }
/* 1527:     */      
/* 1528:1528 */      SubmapIterator(double k) { this();
/* 1529:1529 */        if (this.next != null)
/* 1530:1530 */          if ((!Double2BooleanRBTreeMap.Submap.this.bottom) && (Double2BooleanRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531:1531 */          } else if ((!Double2BooleanRBTreeMap.Submap.this.top) && (Double2BooleanRBTreeMap.this.compare(k, (this.prev = Double2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1532:     */          } else {
/* 1533:1533 */            this.next = Double2BooleanRBTreeMap.this.locateKey(k);
/* 1534:1534 */            if (Double2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544:1544 */        if ((!Double2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2BooleanRBTreeMap.this.compare(this.prev.key, Double2BooleanRBTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1545:     */      }
/* 1546:     */      
/* 1547:1547 */      void updateNext() { this.next = this.next.next();
/* 1548:1548 */        if ((!Double2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Double2BooleanRBTreeMap.this.compare(this.next.key, Double2BooleanRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1549:     */      }
/* 1550:     */    }
/* 1551:     */    
/* 1552:1552 */    private class SubmapEntryIterator extends Double2BooleanRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Double2BooleanMap.Entry> { SubmapEntryIterator() { super(); }
/* 1553:     */      
/* 1554:1554 */      SubmapEntryIterator(double k) { super(k); }
/* 1555:     */      
/* 1556:1556 */      public Double2BooleanMap.Entry next() { return nextEntry(); }
/* 1557:1557 */      public Double2BooleanMap.Entry previous() { return previousEntry(); }
/* 1558:1558 */      public void set(Double2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1559:1559 */      public void add(Double2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1560:     */    }
/* 1561:     */    
/* 1566:     */    private final class SubmapKeyIterator
/* 1567:     */      extends Double2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1586:     */      extends Double2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1599:     */  }
/* 1600:     */  
/* 1604:     */  public Double2BooleanRBTreeMap clone()
/* 1605:     */  {
/* 1606:     */    Double2BooleanRBTreeMap c;
/* 1607:     */    
/* 1609:     */    try
/* 1610:     */    {
/* 1611:1611 */      c = (Double2BooleanRBTreeMap)super.clone();
/* 1612:     */    }
...
/* 1682:     */  {
/* 1683:1683 */    if (n == 1) {
/* 1684:1684 */      Entry top = new Entry(s.readDouble(), s.readBoolean());
...
/* 1690:1690 */    if (n == 2)
/* 1691:     */    {
/* 1693:1693 */      Entry top = new Entry(s.readDouble(), s.readBoolean());
/* 1694:1694 */      top.black(true);
/* 1695:1695 */      top.right(new Entry(s.readDouble(), s.readBoolean()));
