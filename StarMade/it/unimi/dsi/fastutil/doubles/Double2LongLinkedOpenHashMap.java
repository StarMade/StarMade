...
/*  786 */   public Double2LongSortedMap tailMap(double from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Double2LongSortedMap headMap(double to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Double2LongSortedMap subMap(double from, double to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Double2LongLinkedOpenHashMap.ValueIterator(Double2LongLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Double2LongLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(long v) {
/* 1113 */           return Double2LongLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Double2LongLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Double2LongLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2LongLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public long previousLong()
/*      */     {
/* 1094 */       return Double2LongLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Long previous() { return Long.valueOf(Double2LongLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public long nextLong() { return Double2LongLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Long next() { return Long.valueOf(Double2LongLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Double2LongLinkedOpenHashMap.KeyIterator(Double2LongLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public DoubleListIterator iterator() {
/* 1054 */       return new Double2LongLinkedOpenHashMap.KeyIterator(Double2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Double2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(double k) {
/* 1060 */       return Double2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(double k) {
/* 1063 */       int oldSize = Double2LongLinkedOpenHashMap.this.size;
/* 1064 */       Double2LongLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Double2LongLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Double2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public double firstDouble() {
/* 1071 */       if (Double2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Double2LongLinkedOpenHashMap.this.key[Double2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public double lastDouble() {
/* 1075 */       if (Double2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Double2LongLinkedOpenHashMap.this.key[Double2LongLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2LongLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator(double k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public double previousDouble() { return Double2LongLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Double previous() { return Double.valueOf(Double2LongLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public double nextDouble() { return Double2LongLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Double next() { return Double.valueOf(Double2LongLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Double2LongLinkedOpenHashMap.EntryIterator(Double2LongLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Double2LongMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Double2LongMap.Entry> subSet(Double2LongMap.Entry fromElement, Double2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Double2LongMap.Entry first() {
/*  973 */       if (Double2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Double2LongLinkedOpenHashMap.MapEntry(Double2LongLinkedOpenHashMap.this, Double2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Double2LongMap.Entry last() {
/*  977 */       if (Double2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Double2LongLinkedOpenHashMap.MapEntry(Double2LongLinkedOpenHashMap.this, Double2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Double2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Double2LongLinkedOpenHashMap.this.key[pos] == k) return Double2LongLinkedOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  990 */         pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2LongLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Double2LongLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Double2LongLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Double2LongLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Double2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Double2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry from) {
/* 1018 */       return new Double2LongLinkedOpenHashMap.EntryIterator(Double2LongLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2LongMap.Entry> fastIterator() {
/* 1021 */       return new Double2LongLinkedOpenHashMap.FastEntryIterator(Double2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2LongMap.Entry> fastIterator(Double2LongMap.Entry from) {
/* 1024 */       return new Double2LongLinkedOpenHashMap.FastEntryIterator(Double2LongLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Double2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Double2LongMap.Entry>
/*      */   {
/*  944 */     final AbstractDouble2LongMap.BasicEntry entry = new AbstractDouble2LongMap.BasicEntry(0.0D, 0L);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Double2LongLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Double2LongLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractDouble2LongMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Double2LongLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Double2LongLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Double2LongMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Double2LongLinkedOpenHashMap.MapEntry(Double2LongLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Double2LongLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Double2LongLinkedOpenHashMap.MapEntry(Double2LongLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Double2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Double2LongLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(double from) {
/*  809 */       if (Double2LongLinkedOpenHashMap.this.key[Double2LongLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Double2LongLinkedOpenHashMap.this.last;
/*  811 */         this.index = Double2LongLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Double2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Double2LongLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Double2LongLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Double2LongLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Double2LongLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Double2LongLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Double2LongLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Double2LongLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Double2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Double2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Double2LongLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Double2LongLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Double2LongLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Double2LongLinkedOpenHashMap.this.link[this.prev] ^= (Double2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Double2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Double2LongLinkedOpenHashMap.this.link[this.next] ^= (Double2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Double2LongLinkedOpenHashMap.this.mask;
/*  897 */         while (Double2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2LongLinkedOpenHashMap.this.key[pos])) & Double2LongLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Double2LongLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Double2LongLinkedOpenHashMap.this.key[last] = Double2LongLinkedOpenHashMap.this.key[pos];
/*  904 */         Double2LongLinkedOpenHashMap.this.value[last] = Double2LongLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Double2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Double2LongLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*  669 */       return Double.valueOf(Double2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public double getDoubleKey() {
/*  672 */       return Double2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Long getValue() {
/*  675 */       return Long.valueOf(Double2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public long getLongValue() {
/*  678 */       return Double2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public long setValue(long v) {
/*  681 */       long oldValue = Double2LongLinkedOpenHashMap.this.value[this.index];
/*  682 */       Double2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Long setValue(Long v) {
...
/*  692 */       return (Double2LongLinkedOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.double2int(Double2LongLinkedOpenHashMap.this.key[this.index]) ^ HashCommon.long2int(Double2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Double2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Double2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
