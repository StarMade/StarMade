  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2LongLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Double2LongLinkedOpenHashMap(Map<? extends Double, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2LongLinkedOpenHashMap(Map<? extends Double, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2LongLinkedOpenHashMap(Double2LongMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2LongLinkedOpenHashMap(Double2LongMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2LongLinkedOpenHashMap(double[] local_k, long[] local_v, float local_f)
  {
  ...
  public Double2LongLinkedOpenHashMap(double[] local_k, long[] local_v)
  {
  ...
  public long add(double local_k, long incr)
  {
    for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k)
      {
  ...
  public long getAndMoveToFirst(double local_k)
  {
    double[] key = this.key;
  ...
  public long getAndMoveToLast(double local_k)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public long putAndMoveToFirst(double local_k, long local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public long putAndMoveToLast(double local_k, long local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public Long get(Double local_ok)
  {
    double local_k = local_ok.doubleValue();
    for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k) {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Double2LongLinkedOpenHashMap.ValueIterator(Double2LongLinkedOpenHashMap.this);
        }
        ...
        {
          return Double2LongLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2LongLinkedOpenHashMap local_c;
    try
    {
      local_c = (Double2LongLinkedOpenHashMap)super.clone();
    }
    ...
    implements LongListIterator
  {
    ...
    {
      return Long.valueOf(Double2LongLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Long next()
    {
      return Long.valueOf(Double2LongLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSortedSet
  {
    ...
    {
      return new Double2LongLinkedOpenHashMap.KeyIterator(Double2LongLinkedOpenHashMap.this, from);
    }
    
    public DoubleListIterator iterator()
    {
      return new Double2LongLinkedOpenHashMap.KeyIterator(Double2LongLinkedOpenHashMap.this);
    }
    ...
    {
      return Double2LongLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2LongLinkedOpenHashMap.this.size;
      Double2LongLinkedOpenHashMap.this.remove(local_k);
    ...
    implements DoubleListIterator
  {
    ...
    {
      return Double.valueOf(Double2LongLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Double next()
    {
      return Double.valueOf(Double2LongLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2LongSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Double2LongLinkedOpenHashMap.EntryIterator(Double2LongLinkedOpenHashMap.this);
    }
    ...
    public Double2LongMap.Entry first()
    {
      ...
      return new Double2LongLinkedOpenHashMap.MapEntry(Double2LongLinkedOpenHashMap.this, Double2LongLinkedOpenHashMap.this.first);
    }
    ...
    public Double2LongMap.Entry last()
    {
      ...
      return new Double2LongLinkedOpenHashMap.MapEntry(Double2LongLinkedOpenHashMap.this, Double2LongLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2LongLinkedOpenHashMap.this.mask; Double2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask) {
        if (Double2LongLinkedOpenHashMap.this.key[pos] == local_k) {
          return Double2LongLinkedOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2LongLinkedOpenHashMap.this.mask; Double2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask) {
        if (Double2LongLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Double2LongLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Double2LongLinkedOpenHashMap.EntryIterator(Double2LongLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
    
    public ObjectBidirectionalIterator<Double2LongMap.Entry> fastIterator()
    {
      return new Double2LongLinkedOpenHashMap.FastEntryIterator(Double2LongLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Double2LongMap.Entry> fastIterator(Double2LongMap.Entry from)
    {
      return new Double2LongLinkedOpenHashMap.FastEntryIterator(Double2LongLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
  }
  ...
  {
    final AbstractDouble2LongMap.BasicEntry entry = new AbstractDouble2LongMap.BasicEntry(0.0D, 0L);
    ...
    public AbstractDouble2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2LongLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Double2LongLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Double2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Double2LongLinkedOpenHashMap.MapEntry(Double2LongLinkedOpenHashMap.this, nextEntry());
    }
    
    public Double2LongLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Double2LongLinkedOpenHashMap.MapEntry(Double2LongLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(double from)
    {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2LongLinkedOpenHashMap.this.mask; Double2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Double2LongLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Double2LongLinkedOpenHashMap.this.first = this.next;
      } else {
        Double2LongLinkedOpenHashMap.this.link[this.prev] ^= (Double2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Double2LongLinkedOpenHashMap.this.last = this.prev;
      } else {
        Double2LongLinkedOpenHashMap.this.link[this.next] ^= (Double2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2LongLinkedOpenHashMap.this.mask; Double2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongLinkedOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2LongLinkedOpenHashMap.this.key[pos])) & Double2LongLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2LongLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Double2LongMap.Entry, Map.Entry<Double, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Double2LongLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Long> local_e = (Map.Entry)local_o;
      return (Double2LongLinkedOpenHashMap.this.key[this.index] == ((Double)local_e.getKey()).doubleValue()) && (Double2LongLinkedOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
