  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2ReferenceRBTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2ReferenceRBTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2ReferenceRBTreeMap(Map<? extends Double, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2ReferenceRBTreeMap(SortedMap<Double, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2ReferenceRBTreeMap(Double2ReferenceMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2ReferenceRBTreeMap(Double2ReferenceSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2ReferenceRBTreeMap(double[] local_k, V[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2ReferenceRBTreeMap(double[] local_k, V[] local_v)
  {
  ...
  {
    Double2ReferenceRBTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Double2ReferenceMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Double2ReferenceRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2ReferenceRBTreeMap.EntryIterator(Double2ReferenceRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator(Double2ReferenceMap.Entry<V> from)
        {
          return new Double2ReferenceRBTreeMap.EntryIterator(Double2ReferenceRBTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2ReferenceRBTreeMap.Entry<V> local_f = Double2ReferenceRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2ReferenceRBTreeMap.Entry<V> local_f = Double2ReferenceRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2ReferenceRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Double2ReferenceRBTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Double2ReferenceMap.Entry<V>> headSet(Double2ReferenceMap.Entry<V> local_to)
        {
          return Double2ReferenceRBTreeMap.this.headMap((Double)local_to.getKey()).double2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Double2ReferenceMap.Entry<V>> tailSet(Double2ReferenceMap.Entry<V> from)
        {
          return Double2ReferenceRBTreeMap.this.tailMap((Double)from.getKey()).double2ReferenceEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Double2ReferenceRBTreeMap.ValueIterator(Double2ReferenceRBTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Double2ReferenceRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2ReferenceRBTreeMap<V> local_c;
    try
    {
      local_c = (Double2ReferenceRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Double2ReferenceRBTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2ReferenceRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Double2ReferenceRBTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Double2ReferenceRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2ReferenceRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator()
          {
            return new Double2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Double2ReferenceRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator(Double2ReferenceMap.Entry<V> from)
          {
            return new Double2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Double2ReferenceRBTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, V> local_e = (Map.Entry)local_o;
            Double2ReferenceRBTreeMap.Entry<V> local_f = Double2ReferenceRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2ReferenceRBTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, V> local_e = (Map.Entry)local_o;
            Double2ReferenceRBTreeMap.Entry<V> local_f = Double2ReferenceRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2ReferenceRBTreeMap.Submap.this.in7(local_f.key))) {
              Double2ReferenceRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2ReferenceRBTreeMap.Submap.SubmapIterator(Double2ReferenceRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2ReferenceRBTreeMap.Submap.this.clear();
          }
          
          public Double2ReferenceMap.Entry<V> first()
          {
            return Double2ReferenceRBTreeMap.Submap.this.firstEntry();
          }
          
          public Double2ReferenceMap.Entry<V> last()
          {
            return Double2ReferenceRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2ReferenceMap.Entry<V>> subSet(Double2ReferenceMap.Entry<V> from, Double2ReferenceMap.Entry<V> local_to)
          {
            return Double2ReferenceRBTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Double2ReferenceMap.Entry<V>> headSet(Double2ReferenceMap.Entry<V> local_to)
          {
            return Double2ReferenceRBTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Double2ReferenceMap.Entry<V>> tailSet(Double2ReferenceMap.Entry<V> from)
          {
            return Double2ReferenceRBTreeMap.Submap.this.tailMap((Double)from.getKey()).double2ReferenceEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ReferenceCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractReferenceCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Double2ReferenceRBTreeMap.Submap.SubmapValueIterator(Double2ReferenceRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Double2ReferenceRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2ReferenceRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2ReferenceRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2ReferenceRBTreeMap.Entry<V> local_e;
      return (in7(local_kk)) && ((local_e = Double2ReferenceRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(double local_k, V local_v)
    {
      ...
      V oldValue = Double2ReferenceRBTreeMap.this.put(local_k, local_v);
    ...
    public V remove(double local_k)
    {
      ...
      V oldValue = Double2ReferenceRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2ReferenceSortedMap<V> tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2ReferenceRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2ReferenceRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2ReferenceSortedMap<V> subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2ReferenceRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2ReferenceRBTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2ReferenceRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2ReferenceRBTreeMap.this.locateKey(this.from);
        if (Double2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2ReferenceRBTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2ReferenceRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2ReferenceRBTreeMap.this.locateKey(this.field_47);
        if (Double2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2ReferenceRBTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2ReferenceRBTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Double2ReferenceRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Double2ReferenceRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Double2ReferenceRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2ReferenceRBTreeMap.Submap.this.bottom) && (Double2ReferenceRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2ReferenceRBTreeMap.Submap.this.top) && (Double2ReferenceRBTreeMap.this.compare(local_k, (this.prev = Double2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2ReferenceRBTreeMap.this.locateKey(local_k);
            if (Double2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2ReferenceRBTreeMap.this.compare(this.prev.key, Double2ReferenceRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Double2ReferenceRBTreeMap.this.compare(this.next.key, Double2ReferenceRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2ReferenceSortedMap.KeySet
    {
      ...
      {
        return new Double2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Double2ReferenceRBTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Double2ReferenceRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2ReferenceSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2ReferenceRBTreeMap.KeyIterator(Double2ReferenceRBTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2ReferenceRBTreeMap.KeyIterator(Double2ReferenceRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2ReferenceRBTreeMap.this.locateKey(local_k)) != null) {
        if (Double2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
