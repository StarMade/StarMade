...
/*  17:    */
/*  65:    */public class Double2ReferenceArrayMap<V>
/*  66:    */  extends AbstractDouble2ReferenceMap<V>
/*  67:    */  implements Serializable, Cloneable
/*  68:    */{
/*  69:    */  private static final long serialVersionUID = 1L;
/*  70:    */  private transient double[] key;
/*  71:    */  private transient Object[] value;
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Double2ReferenceArrayMap(double[] key, Object[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Double2ReferenceArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = DoubleArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = ObjectArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Double2ReferenceArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new double[capacity];
/*  93: 93 */    this.value = new Object[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Double2ReferenceArrayMap(Double2ReferenceMap<V> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Double2ReferenceArrayMap(Map<? extends Double, ? extends V> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Double2ReferenceArrayMap(double[] key, Object[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Double2ReferenceMap.Entry<V>> implements Double2ReferenceMap.FastEntrySet<V> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Double2ReferenceMap.Entry<V>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Double2ReferenceArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Double2ReferenceMap.Entry<V> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractDouble2ReferenceMap.BasicEntry(Double2ReferenceArrayMap.this.key[this.next], Double2ReferenceArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Double2ReferenceMap.Entry<V>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractDouble2ReferenceMap.BasicEntry<V> entry = new AbstractDouble2ReferenceMap.BasicEntry(0.0D, null);
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Double2ReferenceArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Double2ReferenceMap.Entry<V> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Double2ReferenceArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Double2ReferenceArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Double2ReferenceArrayMap.this.size; }
/* 159:    */    
/* 160:    */    public boolean contains(Object o)
/* 161:    */    {
/* 162:162 */      if (!(o instanceof Map.Entry)) return false;
/* 163:163 */      Map.Entry<Double, V> e = (Map.Entry)o;
/* 164:164 */      double k = ((Double)e.getKey()).doubleValue();
/* 165:165 */      return (Double2ReferenceArrayMap.this.containsKey(k)) && (Double2ReferenceArrayMap.this.get(k) == e.getValue());
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Double2ReferenceMap.FastEntrySet<V> double2ReferenceEntrySet() { return new EntrySet(null); }
/* 170:    */  
/* 171:    */  private int findKey(double k)
/* 172:    */  {
...
/* 206:    */  }
/* 207:    */  
/* 208:    */  public boolean containsKey(double k)
/* 209:    */  {
...
/* 235:235 */      double[] newKey = new double[this.size == 0 ? 2 : this.size * 2];
...
/* 274:    */  }
/* 275:    */  
/* 278:    */  public DoubleSet keySet()
/* 279:    */  {
/* 280:280 */    return new DoubleArraySet(this.key, this.size);
/* 281:    */  }
/* 282:    */  
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Double2ReferenceArrayMap<V> clone()
/* 293:    */  {
/* 294:    */    Double2ReferenceArrayMap<V> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Double2ReferenceArrayMap)super.clone();
/* 301:    */    }
/* 302:    */    catch (CloneNotSupportedException cantHappen) {
/* 303:303 */      throw new InternalError();
/* 304:    */    }
/* 305:305 */    c.key = ((double[])this.key.clone());
...
/* 313:313 */      s.writeDouble(this.key[i]);
