  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2DoubleOpenHashMap(int expected, float local_f)
  {
  ...
  public Double2DoubleOpenHashMap(Map<? extends Double, ? extends Double> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2DoubleOpenHashMap(Map<? extends Double, ? extends Double> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2DoubleOpenHashMap(Double2DoubleMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2DoubleOpenHashMap(Double2DoubleMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2DoubleOpenHashMap(double[] local_k, double[] local_v, float local_f)
  {
  ...
  public Double2DoubleOpenHashMap(double[] local_k, double[] local_v)
  {
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Double2DoubleOpenHashMap.ValueIterator(Double2DoubleOpenHashMap.this);
        }
        ...
        {
          return Double2DoubleOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2DoubleOpenHashMap local_c;
    try
    {
      local_c = (Double2DoubleOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Double2DoubleOpenHashMap.MapIterator
    implements DoubleIterator
  {
    ...
    {
      return Double2DoubleOpenHashMap.this.value[nextEntry()];
    }
    
    public Double next()
    {
      return Double.valueOf(Double2DoubleOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSet
  {
    ...
    public DoubleIterator iterator()
    {
      return new Double2DoubleOpenHashMap.KeyIterator(Double2DoubleOpenHashMap.this);
    }
    ...
    {
      return Double2DoubleOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2DoubleOpenHashMap.this.size;
      Double2DoubleOpenHashMap.this.remove(local_k);
    ...
    implements DoubleIterator
  {
    ...
    public double nextDouble()
    {
      return Double2DoubleOpenHashMap.this.key[nextEntry()];
    }
    
    public Double next()
    {
      return Double.valueOf(Double2DoubleOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2DoubleMap.FastEntrySet
  {
    ...
    {
      return new Double2DoubleOpenHashMap.EntryIterator(Double2DoubleOpenHashMap.this, null);
    }
    
    public ObjectIterator<Double2DoubleMap.Entry> fastIterator()
    {
      return new Double2DoubleOpenHashMap.FastEntryIterator(Double2DoubleOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2DoubleOpenHashMap.this.mask; Double2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2DoubleOpenHashMap.this.mask) {
        if (Double2DoubleOpenHashMap.this.key[pos] == local_k) {
          return Double2DoubleOpenHashMap.this.value[pos] == ((Double)local_e.getValue()).doubleValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2DoubleOpenHashMap.this.mask; Double2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2DoubleOpenHashMap.this.mask) {
        if (Double2DoubleOpenHashMap.this.key[pos] == local_k)
        {
          Double2DoubleOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Double2DoubleMap.Entry>
  {
    ...
    public AbstractDouble2DoubleMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2DoubleOpenHashMap.this.key[local_e];
      this.entry.value = Double2DoubleOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Double2DoubleMap.Entry>
  {
    ...
    {
      return this.entry = new Double2DoubleOpenHashMap.MapEntry(Double2DoubleOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2DoubleOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Double2DoubleOpenHashMap.this.field_49;
    int last = -1;
    int field_1762 = Double2DoubleOpenHashMap.this.size;
    DoubleArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Double2DoubleOpenHashMap.this.used;
      while ((this.field_1762 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1762 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Double2DoubleOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2DoubleOpenHashMap.this.mask; Double2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2DoubleOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2DoubleOpenHashMap.this.key[pos])) & Double2DoubleOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2DoubleOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Double2DoubleOpenHashMap.this.key[pos]);
        }
        Double2DoubleOpenHashMap.this.key[last] = Double2DoubleOpenHashMap.this.key[pos];
        Double2DoubleOpenHashMap.this.value[last] = Double2DoubleOpenHashMap.this.value[pos];
      }
      Double2DoubleOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Double2DoubleOpenHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
        this.last = -1;
        return;
      }
      Double2DoubleOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1762 > 0))
      {
        this.field_1762 += 1;
        nextEntry();
      }
    ...
    implements Double2DoubleMap.Entry, Map.Entry<Double, Double>
  {
    ...
    {
      return Double.valueOf(Double2DoubleOpenHashMap.this.key[this.index]);
    }
    ...
    {
      return Double.valueOf(Double2DoubleOpenHashMap.this.value[this.index]);
    }
    ...
    public double setValue(double local_v)
    {
      ...
      Double2DoubleOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Double> local_e = (Map.Entry)local_o;
      return (Double2DoubleOpenHashMap.this.key[this.index] == ((Double)local_e.getKey()).doubleValue()) && (Double2DoubleOpenHashMap.this.value[this.index] == ((Double)local_e.getValue()).doubleValue());
    }
