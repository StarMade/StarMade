  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2ByteRBTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2ByteRBTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2ByteRBTreeMap(Map<? extends Double, ? extends Byte> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2ByteRBTreeMap(SortedMap<Double, Byte> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2ByteRBTreeMap(Double2ByteMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2ByteRBTreeMap(Double2ByteSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2ByteRBTreeMap(double[] local_k, byte[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2ByteRBTreeMap(double[] local_k, byte[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Double2ByteMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Double2ByteRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2ByteRBTreeMap.EntryIterator(Double2ByteRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry from)
        {
          return new Double2ByteRBTreeMap.EntryIterator(Double2ByteRBTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2ByteRBTreeMap.Entry local_f = Double2ByteRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2ByteRBTreeMap.Entry local_f = Double2ByteRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2ByteRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Double2ByteRBTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2ByteEntrySet();
        }
        
        public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry local_to)
        {
          return Double2ByteRBTreeMap.this.headMap((Double)local_to.getKey()).double2ByteEntrySet();
        }
        
        public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry from)
        {
          return Double2ByteRBTreeMap.this.tailMap((Double)from.getKey()).double2ByteEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Double2ByteRBTreeMap.ValueIterator(Double2ByteRBTreeMap.this, null);
        }
        
        public boolean contains(byte local_k)
        {
          return Double2ByteRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2ByteRBTreeMap local_c;
    try
    {
      local_c = (Double2ByteRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2ByteRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Double2ByteRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2ByteRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2ByteMap.Entry> double2ByteEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator()
          {
            return new Double2ByteRBTreeMap.Submap.SubmapEntryIterator(Double2ByteRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry from)
          {
            return new Double2ByteRBTreeMap.Submap.SubmapEntryIterator(Double2ByteRBTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, Byte> local_e = (Map.Entry)local_o;
            Double2ByteRBTreeMap.Entry local_f = Double2ByteRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2ByteRBTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, Byte> local_e = (Map.Entry)local_o;
            Double2ByteRBTreeMap.Entry local_f = Double2ByteRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2ByteRBTreeMap.Submap.this.in7(local_f.key))) {
              Double2ByteRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2ByteRBTreeMap.Submap.SubmapIterator(Double2ByteRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2ByteRBTreeMap.Submap.this.clear();
          }
          
          public Double2ByteMap.Entry first()
          {
            return Double2ByteRBTreeMap.Submap.this.firstEntry();
          }
          
          public Double2ByteMap.Entry last()
          {
            return Double2ByteRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry from, Double2ByteMap.Entry local_to)
          {
            return Double2ByteRBTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2ByteEntrySet();
          }
          
          public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry local_to)
          {
            return Double2ByteRBTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2ByteEntrySet();
          }
          
          public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry from)
          {
            return Double2ByteRBTreeMap.Submap.this.tailMap((Double)from.getKey()).double2ByteEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ByteCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractByteCollection()
        {
          public ByteIterator iterator()
          {
            return new Double2ByteRBTreeMap.Submap.SubmapValueIterator(Double2ByteRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(byte local_k)
          {
            return Double2ByteRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2ByteRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2ByteRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2ByteRBTreeMap.Entry local_e;
      return (in7(local_kk)) && ((local_e = Double2ByteRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public byte put(double local_k, byte local_v)
    {
      ...
      byte oldValue = Double2ByteRBTreeMap.this.put(local_k, local_v);
    ...
    public byte remove(double local_k)
    {
      ...
      byte oldValue = Double2ByteRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2ByteRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2ByteRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2ByteSortedMap tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2ByteRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2ByteRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2ByteSortedMap subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2ByteRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2ByteRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2ByteRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2ByteRBTreeMap.this.locateKey(this.from);
        if (Double2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2ByteRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2ByteRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2ByteRBTreeMap.this.locateKey(this.field_47);
        if (Double2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2ByteRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2ByteRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Double2ByteRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Double2ByteRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2ByteRBTreeMap.Submap.this.bottom) && (Double2ByteRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2ByteRBTreeMap.Submap.this.top) && (Double2ByteRBTreeMap.this.compare(local_k, (this.prev = Double2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2ByteRBTreeMap.this.locateKey(local_k);
            if (Double2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2ByteRBTreeMap.this.compare(this.prev.key, Double2ByteRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Double2ByteRBTreeMap.this.compare(this.next.key, Double2ByteRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2ByteSortedMap.KeySet
    {
      ...
      {
        return new Double2ByteRBTreeMap.Submap.SubmapKeyIterator(Double2ByteRBTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2ByteRBTreeMap.Submap.SubmapKeyIterator(Double2ByteRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2ByteSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2ByteRBTreeMap.KeyIterator(Double2ByteRBTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2ByteRBTreeMap.KeyIterator(Double2ByteRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2ByteRBTreeMap.this.locateKey(local_k)) != null) {
        if (Double2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
