...
/*      */ 
/*      */ public class Double2ByteRBTreeMap extends AbstractDouble2ByteSortedMap
...
/*  119 */           return Double2ByteRBTreeMap.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*      */         }
/*      */         public int compare(Double ok1, Double ok2) {
/*  122 */           return Double2ByteRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     byte oldValue = put(ok.doubleValue(), ov.byteValue());
/*  731 */     return this.modified ? null : Byte.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Byte remove(Object ok)
/*      */   {
/*  737 */     byte oldValue = remove(((Double)ok).doubleValue());
...
/* 1141 */         final Comparator<? super Double2ByteMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Double2ByteMap.Entry x, Double2ByteMap.Entry y) {
/* 1143 */             return Double2ByteRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Double2ByteRBTreeMap.EntryIterator(Double2ByteRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry from) {
/* 1153 */           return new Double2ByteRBTreeMap.EntryIterator(Double2ByteRBTreeMap.this, ((Double)from.getKey()).doubleValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Double2ByteRBTreeMap.Entry f = Double2ByteRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1166 */           Double2ByteRBTreeMap.Entry f = Double2ByteRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1167 */           if (f != null) Double2ByteRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Double2ByteRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Double2ByteRBTreeMap.this.clear(); } 
/* 1172 */         public Double2ByteMap.Entry first() { return Double2ByteRBTreeMap.this.firstEntry; } 
/* 1173 */         public Double2ByteMap.Entry last() { return Double2ByteRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry from, Double2ByteMap.Entry to) { return Double2ByteRBTreeMap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2ByteEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry to) { return Double2ByteRBTreeMap.this.headMap((Double)to.getKey()).double2ByteEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry from) { return Double2ByteRBTreeMap.this.tailMap((Double)from.getKey()).double2ByteEntrySet(); }
/*      */       };
...
/* 1242 */           return new Double2ByteRBTreeMap.ValueIterator(Double2ByteRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(byte k) {
/* 1245 */           return Double2ByteRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Double2ByteRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Double2ByteRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Double2ByteRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readDouble(), s.readByte());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readDouble(), s.readByte());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readDouble(), s.readByte()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Double2ByteRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Double2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator() {
/* 1329 */             return new Double2ByteRBTreeMap.Submap.SubmapEntryIterator(Double2ByteRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry from) {
/* 1332 */             return new Double2ByteRBTreeMap.Submap.SubmapEntryIterator(Double2ByteRBTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
/*      */           }
/* 1334 */           public Comparator<? super Double2ByteMap.Entry> comparator() { return Double2ByteRBTreeMap.this.double2ByteEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Double2ByteRBTreeMap.Entry f = Double2ByteRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1340 */             return (f != null) && (Double2ByteRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Double2ByteRBTreeMap.Entry f = Double2ByteRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1347 */             if ((f != null) && (Double2ByteRBTreeMap.Submap.this.in(f.key))) Double2ByteRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Double2ByteRBTreeMap.Submap.SubmapIterator(Double2ByteRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Double2ByteRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Double2ByteMap.Entry first() { return Double2ByteRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Double2ByteMap.Entry last() { return Double2ByteRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry from, Double2ByteMap.Entry to) { return Double2ByteRBTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2ByteEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry to) { return Double2ByteRBTreeMap.Submap.this.headMap((Double)to.getKey()).double2ByteEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry from) { return Double2ByteRBTreeMap.Submap.this.tailMap((Double)from.getKey()).double2ByteEntrySet(); }
/*      */         };
...
/*      */           public ByteIterator iterator() {
/* 1376 */             return new Double2ByteRBTreeMap.Submap.SubmapValueIterator(Double2ByteRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(byte k) {
/* 1379 */             return Double2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Double2ByteRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Double2ByteRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(double k) {
/* 1392 */       return (in(k)) && (Double2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(byte v) {
...
/* 1407 */       return (in(kk)) && ((e = Double2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public byte put(double k, byte v) {
/* 1410 */       Double2ByteRBTreeMap.this.modified = false;
...
/* 1412 */       byte oldValue = Double2ByteRBTreeMap.this.put(k, v);
/* 1413 */       return Double2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Byte put(Double ok, Byte ov) {
/* 1416 */       byte oldValue = put(ok.doubleValue(), ov.byteValue());
/* 1417 */       return Double2ByteRBTreeMap.this.modified ? null : Byte.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public byte remove(double k) {
/* 1421 */       Double2ByteRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       byte oldValue = Double2ByteRBTreeMap.this.remove(k);
/* 1424 */       return Double2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Byte remove(Object ok) {
/* 1427 */       byte oldValue = remove(((Double)ok).doubleValue());
/* 1428 */       return Double2ByteRBTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public DoubleComparator comparator() {
/* 1443 */       return Double2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Double2ByteSortedMap headMap(double to) {
/* 1446 */       if (this.top) return new Submap(Double2ByteRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Double2ByteRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Double2ByteRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Double2ByteSortedMap tailMap(double from) {
/* 1450 */       if (this.bottom) return new Submap(Double2ByteRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Double2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2ByteRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Double2ByteSortedMap subMap(double from, double to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Double2ByteRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Double2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Double2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Double2ByteRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Double2ByteRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Double2ByteRBTreeMap.this.tree == null) return null;
/* 1468 */       Double2ByteRBTreeMap.Entry e;
/*      */       Double2ByteRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Double2ByteRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Double2ByteRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Double2ByteRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Double2ByteRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Double2ByteRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Double2ByteRBTreeMap.this.tree == null) return null;
/* 1486 */       Double2ByteRBTreeMap.Entry e;
/*      */       Double2ByteRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Double2ByteRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Double2ByteRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Double2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Double2ByteRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public double firstDoubleKey() {
/* 1497 */       Double2ByteRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public double lastDoubleKey() {
/* 1502 */       Double2ByteRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Double firstKey() {
/* 1507 */       Double2ByteRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Double lastKey() {
/* 1512 */       Double2ByteRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Double2ByteRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Double2ByteRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Double2ByteRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Double2ByteMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Double2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Double2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Double2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(double k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Double2ByteRBTreeMap.Submap.this.bottom) && (Double2ByteRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Double2ByteRBTreeMap.Submap.this.top) && (Double2ByteRBTreeMap.this.compare(k, (this.prev = Double2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Double2ByteRBTreeMap.this.locateKey(k);
/* 1534 */             if (Double2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Double2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2ByteRBTreeMap.this.compare(this.prev.key, Double2ByteRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Double2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Double2ByteRBTreeMap.this.compare(this.next.key, Double2ByteRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public DoubleBidirectionalIterator iterator() { return new Double2ByteRBTreeMap.Submap.SubmapKeyIterator(Double2ByteRBTreeMap.Submap.this); } 
/* 1367 */       public DoubleBidirectionalIterator iterator(double from) { return new Double2ByteRBTreeMap.Submap.SubmapKeyIterator(Double2ByteRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2ByteRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public DoubleBidirectionalIterator iterator() { return new Double2ByteRBTreeMap.KeyIterator(Double2ByteRBTreeMap.this); } 
/* 1201 */     public DoubleBidirectionalIterator iterator(double from) { return new Double2ByteRBTreeMap.KeyIterator(Double2ByteRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2ByteRBTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2ByteRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Double2ByteMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Double2ByteMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Double2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Double2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Double2ByteRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(double k) {
/* 1067 */       if ((this.next = Double2ByteRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Double2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Double2ByteRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
