  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2CharOpenHashMap(int expected, float local_f)
  {
  ...
  public Double2CharOpenHashMap(Map<? extends Double, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2CharOpenHashMap(Map<? extends Double, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2CharOpenHashMap(Double2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2CharOpenHashMap(Double2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2CharOpenHashMap(double[] local_k, char[] local_v, float local_f)
  {
  ...
  public Double2CharOpenHashMap(double[] local_k, char[] local_v)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Double2CharOpenHashMap.ValueIterator(Double2CharOpenHashMap.this);
        }
        ...
        {
          return Double2CharOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2CharOpenHashMap local_c;
    try
    {
      local_c = (Double2CharOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Double2CharOpenHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Double2CharOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSet
  {
    ...
    {
      return new Double2CharOpenHashMap.KeyIterator(Double2CharOpenHashMap.this);
    }
    ...
    {
      return Double2CharOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2CharOpenHashMap.this.size;
      Double2CharOpenHashMap.this.remove(local_k);
    ...
    implements DoubleIterator
  {
    ...
    public Double next()
    {
      return Double.valueOf(Double2CharOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2CharMap.FastEntrySet
  {
    ...
    {
      return new Double2CharOpenHashMap.EntryIterator(Double2CharOpenHashMap.this, null);
    }
    
    public ObjectIterator<Double2CharMap.Entry> fastIterator()
    {
      return new Double2CharOpenHashMap.FastEntryIterator(Double2CharOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2CharOpenHashMap.this.mask; Double2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2CharOpenHashMap.this.mask) {
        if (Double2CharOpenHashMap.this.key[pos] == local_k) {
          return Double2CharOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2CharOpenHashMap.this.mask; Double2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2CharOpenHashMap.this.mask) {
        if (Double2CharOpenHashMap.this.key[pos] == local_k)
        {
          Double2CharOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Double2CharMap.Entry>
  {
    ...
    public AbstractDouble2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2CharOpenHashMap.this.key[local_e];
      this.entry.value = Double2CharOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Double2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Double2CharOpenHashMap.MapEntry(Double2CharOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Double2CharOpenHashMap.this.field_49;
    int last = -1;
    int field_1808 = Double2CharOpenHashMap.this.size;
    DoubleArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Double2CharOpenHashMap.this.used;
      while ((this.field_1808 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1808 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1808 != 0)
      {
        boolean[] local_k = Double2CharOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2CharOpenHashMap.this.mask; Double2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2CharOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2CharOpenHashMap.this.key[pos])) & Double2CharOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2CharOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
    ...
    public void remove()
    {
      ...
      Double2CharOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1808 > 0))
      {
        this.field_1808 += 1;
        nextEntry();
      }
    ...
    implements Double2CharMap.Entry, Map.Entry<Double, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Double2CharOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Character> local_e = (Map.Entry)local_o;
      return (Double2CharOpenHashMap.this.key[this.index] == ((Double)local_e.getKey()).doubleValue()) && (Double2CharOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
