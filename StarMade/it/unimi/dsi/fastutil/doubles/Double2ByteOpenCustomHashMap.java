  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2ByteOpenCustomHashMap(int expected, float local_f, DoubleHash.Strategy strategy)
  {
  ...
  public Double2ByteOpenCustomHashMap(Map<? extends Double, ? extends Byte> local_m, float local_f, DoubleHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Double2ByteOpenCustomHashMap(Map<? extends Double, ? extends Byte> local_m, DoubleHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Double2ByteOpenCustomHashMap(Double2ByteMap local_m, float local_f, DoubleHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Double2ByteOpenCustomHashMap(Double2ByteMap local_m, DoubleHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Double2ByteOpenCustomHashMap(double[] local_k, byte[] local_v, float local_f, DoubleHash.Strategy strategy)
  {
  ...
  public Double2ByteOpenCustomHashMap(double[] local_k, byte[] local_v, DoubleHash.Strategy strategy)
  {
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Double2ByteOpenCustomHashMap.ValueIterator(Double2ByteOpenCustomHashMap.this);
        }
        ...
        {
          return Double2ByteOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2ByteOpenCustomHashMap local_c;
    try
    {
      local_c = (Double2ByteOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Double2ByteOpenCustomHashMap.MapIterator
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Double2ByteOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSet
  {
    ...
    {
      return new Double2ByteOpenCustomHashMap.KeyIterator(Double2ByteOpenCustomHashMap.this);
    }
    ...
    {
      return Double2ByteOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2ByteOpenCustomHashMap.this.size;
      Double2ByteOpenCustomHashMap.this.remove(local_k);
    ...
    implements DoubleIterator
  {
    ...
    public Double next()
    {
      return Double.valueOf(Double2ByteOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2ByteMap.FastEntrySet
  {
    ...
    {
      return new Double2ByteOpenCustomHashMap.EntryIterator(Double2ByteOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Double2ByteMap.Entry> fastIterator()
    {
      return new Double2ByteOpenCustomHashMap.FastEntryIterator(Double2ByteOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Double2ByteOpenCustomHashMap.this.strategy.hashCode(local_k)) & Double2ByteOpenCustomHashMap.this.mask; Double2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ByteOpenCustomHashMap.this.mask) {
        if (Double2ByteOpenCustomHashMap.this.strategy.equals(Double2ByteOpenCustomHashMap.this.key[pos], local_k)) {
          return Double2ByteOpenCustomHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Double2ByteOpenCustomHashMap.this.strategy.hashCode(local_k)) & Double2ByteOpenCustomHashMap.this.mask; Double2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ByteOpenCustomHashMap.this.mask) {
        if (Double2ByteOpenCustomHashMap.this.strategy.equals(Double2ByteOpenCustomHashMap.this.key[pos], local_k))
        {
          Double2ByteOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Double2ByteMap.Entry>
  {
    ...
    public AbstractDouble2ByteMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2ByteOpenCustomHashMap.this.key[local_e];
      this.entry.value = Double2ByteOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Double2ByteMap.Entry>
  {
    ...
    {
      return this.entry = new Double2ByteOpenCustomHashMap.MapEntry(Double2ByteOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2ByteOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Double2ByteOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1780 = Double2ByteOpenCustomHashMap.this.size;
    DoubleArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Double2ByteOpenCustomHashMap.this.used;
      while ((this.field_1780 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1780 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1780 != 0)
      {
        boolean[] local_k = Double2ByteOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2ByteOpenCustomHashMap.this.mask; Double2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ByteOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Double2ByteOpenCustomHashMap.this.strategy.hashCode(Double2ByteOpenCustomHashMap.this.key[pos])) & Double2ByteOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2ByteOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Double2ByteOpenCustomHashMap.this.key[pos]);
        }
        Double2ByteOpenCustomHashMap.this.key[last] = Double2ByteOpenCustomHashMap.this.key[pos];
        Double2ByteOpenCustomHashMap.this.value[last] = Double2ByteOpenCustomHashMap.this.value[pos];
      }
      Double2ByteOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Double2ByteOpenCustomHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
        this.last = -1;
        return;
      }
      Double2ByteOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1780 > 0))
      {
        this.field_1780 += 1;
        nextEntry();
      }
    ...
    implements Double2ByteMap.Entry, Map.Entry<Double, Byte>
  {
    ...
    public byte setValue(byte local_v)
    {
      ...
      Double2ByteOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Byte> local_e = (Map.Entry)local_o;
      return (Double2ByteOpenCustomHashMap.this.strategy.equals(Double2ByteOpenCustomHashMap.this.key[this.index], ((Double)local_e.getKey()).doubleValue())) && (Double2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
