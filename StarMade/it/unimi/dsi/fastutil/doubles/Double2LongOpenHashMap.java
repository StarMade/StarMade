  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2LongOpenHashMap(int expected, float local_f)
  {
  ...
  public Double2LongOpenHashMap(Map<? extends Double, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2LongOpenHashMap(Map<? extends Double, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2LongOpenHashMap(Double2LongMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2LongOpenHashMap(Double2LongMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2LongOpenHashMap(double[] local_k, long[] local_v, float local_f)
  {
  ...
  public Double2LongOpenHashMap(double[] local_k, long[] local_v)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Double2LongOpenHashMap.ValueIterator(Double2LongOpenHashMap.this);
        }
        ...
        {
          return Double2LongOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2LongOpenHashMap local_c;
    try
    {
      local_c = (Double2LongOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Double2LongOpenHashMap.MapIterator
    ...
    extends AbstractDoubleSet
  {
    ...
    {
      return new Double2LongOpenHashMap.KeyIterator(Double2LongOpenHashMap.this);
    }
    ...
    {
      return Double2LongOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2LongOpenHashMap.this.size;
      Double2LongOpenHashMap.this.remove(local_k);
    ...
    implements Double2LongMap.FastEntrySet
  {
    ...
    {
      return new Double2LongOpenHashMap.EntryIterator(Double2LongOpenHashMap.this, null);
    }
    
    public ObjectIterator<Double2LongMap.Entry> fastIterator()
    {
      return new Double2LongOpenHashMap.FastEntryIterator(Double2LongOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2LongOpenHashMap.this.mask; Double2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongOpenHashMap.this.mask) {
        if (Double2LongOpenHashMap.this.key[pos] == local_k) {
          return Double2LongOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2LongOpenHashMap.this.mask; Double2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongOpenHashMap.this.mask) {
        if (Double2LongOpenHashMap.this.key[pos] == local_k)
        {
          Double2LongOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Double2LongMap.Entry>
  {
    ...
    public AbstractDouble2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2LongOpenHashMap.this.key[local_e];
      this.entry.value = Double2LongOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Double2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Double2LongOpenHashMap.MapEntry(Double2LongOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Double2LongOpenHashMap.this.field_49;
    int last = -1;
    int field_1660 = Double2LongOpenHashMap.this.size;
    DoubleArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Double2LongOpenHashMap.this.used;
      while ((this.field_1660 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1660 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1660 != 0)
      {
        boolean[] local_k = Double2LongOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2LongOpenHashMap.this.mask; Double2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2LongOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2LongOpenHashMap.this.key[pos])) & Double2LongOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2LongOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Double2LongOpenHashMap.this.key[pos]);
        }
        Double2LongOpenHashMap.this.key[last] = Double2LongOpenHashMap.this.key[pos];
        Double2LongOpenHashMap.this.value[last] = Double2LongOpenHashMap.this.value[pos];
      }
      Double2LongOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Double2LongOpenHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
        this.last = -1;
        return;
      }
      Double2LongOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1660 > 0))
      {
        this.field_1660 += 1;
        nextEntry();
      }
    ...
    implements Double2LongMap.Entry, Map.Entry<Double, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Double2LongOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Long> local_e = (Map.Entry)local_o;
      return (Double2LongOpenHashMap.this.key[this.index] == ((Double)local_e.getKey()).doubleValue()) && (Double2LongOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
