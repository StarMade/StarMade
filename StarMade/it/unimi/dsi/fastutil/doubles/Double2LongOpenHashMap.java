...
/* 642 */           return new Double2LongOpenHashMap.ValueIterator(Double2LongOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Double2LongOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(long v) {
/* 648 */           return Double2LongOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Double2LongOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Double2LongOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Double2LongOpenHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public long nextLong() { return Double2LongOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Long next() { return Long.valueOf(Double2LongOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Double2LongOpenHashMap.KeyIterator(Double2LongOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Double2LongOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(double k) {
/* 613 */       return Double2LongOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(double k) {
/* 616 */       int oldSize = Double2LongOpenHashMap.this.size;
/* 617 */       Double2LongOpenHashMap.this.remove(k);
/* 618 */       return Double2LongOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Double2LongOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Double2LongOpenHashMap.MapIterator
/*     */     implements DoubleIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public double nextDouble() { return Double2LongOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Double next() { return Double.valueOf(Double2LongOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Double2LongOpenHashMap.EntryIterator(Double2LongOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Double2LongMap.Entry> fastIterator() {
/* 550 */       return new Double2LongOpenHashMap.FastEntryIterator(Double2LongOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2LongOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Double2LongOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Double2LongOpenHashMap.this.key[pos] == k) return Double2LongOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/* 562 */         pos = pos + 1 & Double2LongOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2LongOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Double2LongOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Double2LongOpenHashMap.this.key[pos] == k) {
/* 576 */           Double2LongOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Double2LongOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Double2LongOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Double2LongOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Double2LongOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Double2LongMap.Entry>
/*     */   {
/* 537 */     final AbstractDouble2LongMap.BasicEntry entry = new AbstractDouble2LongMap.BasicEntry(0.0D, 0L);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Double2LongOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Double2LongOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Double2LongOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Double2LongMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Double2LongOpenHashMap.MapEntry(Double2LongOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Double2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Double2LongOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Double2LongOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Double2LongOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2LongOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Double2LongOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Double2LongOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Double2LongOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Double2LongOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Double2LongOpenHashMap.this.mask;
/* 485 */         while (Double2LongOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2LongOpenHashMap.this.key[pos])) & Double2LongOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Double2LongOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Double2LongOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new DoubleArrayList();
/* 494 */           this.wrapped.add(Double2LongOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Double2LongOpenHashMap.this.key[last] = Double2LongOpenHashMap.this.key[pos];
/* 497 */         Double2LongOpenHashMap.this.value[last] = Double2LongOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Double2LongOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Double2LongOpenHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Double2LongOpenHashMap.this.size -= 1;
...
/* 398 */       return Double.valueOf(Double2LongOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public double getDoubleKey() {
/* 401 */       return Double2LongOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Long getValue() {
/* 404 */       return Long.valueOf(Double2LongOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public long getLongValue() {
/* 407 */       return Double2LongOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public long setValue(long v) {
/* 410 */       long oldValue = Double2LongOpenHashMap.this.value[this.index];
/* 411 */       Double2LongOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Long setValue(Long v) {
...
/* 421 */       return (Double2LongOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return HashCommon.double2int(Double2LongOpenHashMap.this.key[this.index]) ^ HashCommon.long2int(Double2LongOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 427 */       return Double2LongOpenHashMap.this.key[this.index] + "=>" + Double2LongOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
