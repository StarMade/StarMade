...
/*     */   public static Double2LongMap singleton(Double key, Long value)
/*     */   {
/* 200 */     return new Singleton(key.doubleValue(), value.longValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Double2LongMap.Entry> double2LongEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.double2LongEntrySet()); return this.entries; } 
...
/* 335 */     public long get(double k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Double, Long>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Double, ? extends Long> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Double2LongMap.Entry> double2LongEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.double2LongEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public long get(double k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Double, Long>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Double2LongMap.Entry> double2LongEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return double2LongEntrySet();
/*     */     }
/* 161 */     public int hashCode() { return HashCommon.double2int(this.key) ^ HashCommon.long2int(this.value); }
/*     */ 
...
/*     */       {
/* 131 */         return Double.valueOf(Double2LongMaps.Singleton.this.key); } 
/* 132 */       public Long getValue() { return Long.valueOf(Double2LongMaps.Singleton.this.value); }
/*     */ 
/*     */       public double getDoubleKey() {
/* 135 */         return Double2LongMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public long getLongValue() {
/* 139 */         return Double2LongMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Double2LongMaps.Singleton.this.key == ((Double)e.getKey()).doubleValue()) && (Double2LongMaps.Singleton.this.value == ((Long)e.getValue()).longValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return HashCommon.double2int(Double2LongMaps.Singleton.this.key) ^ HashCommon.long2int(Double2LongMaps.Singleton.this.value); } 
/* 153 */       public String toString() { return Double2LongMaps.Singleton.this.key + "->" + Double2LongMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Double, ? extends Long> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Double2LongMap.Entry> double2LongEntrySet() {
...
/*  76 */     private Object readResolve() { return Double2LongMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Double2LongMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Double, Long>> entrySet() {
/*  80 */       return double2LongEntrySet();
/*     */     }
