...
/*  730 */   public Double2ReferenceSortedMap<V> tailMap(double from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Double2ReferenceSortedMap<V> headMap(double to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Double2ReferenceSortedMap<V> subMap(double from, double to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Double2ReferenceLinkedOpenHashMap.ValueIterator(Double2ReferenceLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Double2ReferenceLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Double2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Double2ReferenceLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1190 */       c = (Double2ReferenceLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Double2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Double2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Double2ReferenceLinkedOpenHashMap.KeyIterator(Double2ReferenceLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public DoubleListIterator iterator() {
/*  999 */       return new Double2ReferenceLinkedOpenHashMap.KeyIterator(Double2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Double2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(double k) {
/* 1005 */       return Double2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(double k) {
/* 1008 */       int oldSize = Double2ReferenceLinkedOpenHashMap.this.size;
/* 1009 */       Double2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Double2ReferenceLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Double2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public double firstDouble() {
/* 1016 */       if (Double2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Double2ReferenceLinkedOpenHashMap.this.key[Double2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public double lastDouble() {
/* 1020 */       if (Double2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Double2ReferenceLinkedOpenHashMap.this.key[Double2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2ReferenceLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator(double k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public double previousDouble() { return Double2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  987 */     public Double previous() { return Double.valueOf(Double2ReferenceLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/*  991 */     public double nextDouble() { return Double2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Double next() { return Double.valueOf(Double2ReferenceLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Double2ReferenceLinkedOpenHashMap.EntryIterator(Double2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Double2ReferenceMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Double2ReferenceMap.Entry<V>> subSet(Double2ReferenceMap.Entry<V> fromElement, Double2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Double2ReferenceMap.Entry<V>> headSet(Double2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Double2ReferenceMap.Entry<V>> tailSet(Double2ReferenceMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Double2ReferenceMap.Entry<V> first() {
/*  918 */       if (Double2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Double2ReferenceLinkedOpenHashMap.MapEntry(Double2ReferenceLinkedOpenHashMap.this, Double2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Double2ReferenceMap.Entry<V> last() {
/*  922 */       if (Double2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Double2ReferenceLinkedOpenHashMap.MapEntry(Double2ReferenceLinkedOpenHashMap.this, Double2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  931 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Double2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Double2ReferenceLinkedOpenHashMap.this.key[pos] == k) return Double2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  935 */         pos = pos + 1 & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  945 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Double2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Double2ReferenceLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Double2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Double2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Double2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator(Double2ReferenceMap.Entry<V> from) {
/*  963 */       return new Double2ReferenceLinkedOpenHashMap.EntryIterator(Double2ReferenceLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> fastIterator() {
/*  966 */       return new Double2ReferenceLinkedOpenHashMap.FastEntryIterator(Double2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> fastIterator(Double2ReferenceMap.Entry<V> from) {
/*  969 */       return new Double2ReferenceLinkedOpenHashMap.FastEntryIterator(Double2ReferenceLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Double2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Double2ReferenceMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractDouble2ReferenceMap.BasicEntry<V> entry = new AbstractDouble2ReferenceMap.BasicEntry(0.0D, null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Double2ReferenceLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Double2ReferenceLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractDouble2ReferenceMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Double2ReferenceLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Double2ReferenceLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Double2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Double2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Double2ReferenceMap.Entry<V>>
/*      */   {
...
/*  875 */       return this.entry = new Double2ReferenceLinkedOpenHashMap.MapEntry(Double2ReferenceLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Double2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Double2ReferenceLinkedOpenHashMap.MapEntry(Double2ReferenceLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Double2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Double2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Double2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Double2ReferenceLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(double from) {
/*  753 */       if (Double2ReferenceLinkedOpenHashMap.this.key[Double2ReferenceLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Double2ReferenceLinkedOpenHashMap.this.last;
/*  755 */         this.index = Double2ReferenceLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Double2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Double2ReferenceLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Double2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Double2ReferenceLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Double2ReferenceLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Double2ReferenceLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Double2ReferenceLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Double2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Double2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Double2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Double2ReferenceLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Double2ReferenceLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Double2ReferenceLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Double2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Double2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Double2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Double2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Double2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Double2ReferenceLinkedOpenHashMap.this.mask;
/*  841 */         while (Double2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2ReferenceLinkedOpenHashMap.this.key[pos])) & Double2ReferenceLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Double2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Double2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Double2ReferenceLinkedOpenHashMap.this.key[last] = Double2ReferenceLinkedOpenHashMap.this.key[pos];
/*  848 */         Double2ReferenceLinkedOpenHashMap.this.value[last] = Double2ReferenceLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Double2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Double2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Double2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*  619 */       return Double.valueOf(Double2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public double getDoubleKey() {
/*  622 */       return Double2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Double2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Double2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  629 */       Double2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Double2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return HashCommon.double2int(Double2ReferenceLinkedOpenHashMap.this.key[this.index]) ^ (Double2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Double2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */     public String toString() {
/*  642 */       return Double2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Double2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
