...
public class DoubleBigArrays
{
  ...
  {
    double local_t = array[BigArrays.segment(first)][BigArrays.displacement(first)];
  ...
  {
    array[BigArrays.segment(index)][BigArrays.displacement(index)] += 1.0D;
  }
  ...
  public static double[][] newBigArray(long length)
  {
    ...
    if (residual != 0)
    {
      for (int local_i = 0; local_i < baseLength - 1; local_i++) {
        base[local_i] = new double[134217728];
      }
  ...
  public static double[][] wrap(double[] array)
  {
    ...
    double[][] bigArray = newBigArray(array.length);
  ...
  public static double[][] copy(double[][] array, long offset, long length)
  {
    ...
    double[][] local_a = newBigArray(length);
  ...
  public static double[][] copy(double[][] array)
  {
    ...
    while (local_i-- != 0) {
      base[local_i] = ((double[])array[local_i].clone());
    }
    return base;
  }
  ...
  public static void fill(double[][] array, double value)
  {
    ...
    while (local_i-- != 0) {
      DoubleArrays.fill(array[local_i], value);
    }
  }
  
  public static void fill(double[][] array, long from, long local_to, double value)
  {
    ...
    DoubleArrays.fill(array[fromSegment], fromDispl, 134217728, value);
  }
  ...
  public static String toString(double[][] local_a)
  {
    if (local_a == null) {
      return "null";
    }
  ...
  public static void ensureFromTo(double[][] local_a, long from, long local_to)
  {
    BigArrays.ensureFromTo(length(local_a), from, local_to);
  }
  
  public static void ensureOffsetLength(double[][] local_a, long offset, long length)
  {
    BigArrays.ensureOffsetLength(length(local_a), offset, length);
  }
  
  private static void vecSwap(double[][] local_x, long local_a, long local_b, long local_n)
  {
    int local_i = 0;
  ...
  private static long med3(double[][] local_x, long local_a, long local_b, long local_c, DoubleComparator comp)
  {
  ...
  private static void selectionSort(double[][] local_a, long from, long local_to, DoubleComparator comp)
  {
  ...
  public static void quickSort(double[][] local_x, long from, long local_to, DoubleComparator comp)
  {
    ...
    double local_j = get(local_x, local_i);
    long local_n = from;
  ...
  private static long med3(double[][] local_x, long local_a, long local_b, long local_c)
  {
  ...
  private static void selectionSort(double[][] local_a, long from, long local_to)
  {
    for (long local_i = from; local_i < local_to - 1L; local_i += 1L)
    {
      long local_m = local_i;
  ...
  public static void quickSort(double[][] local_x, long from, long local_to)
  {
    long len = local_to - from;
    if (len < 7L)
    {
  ...
  public static long binarySearch(double[][] local_a, long from, long local_to, double key)
  {
    local_to -= 1L;
    while (from <= local_to)
    {
      long mid = from + local_to >>> 1;
      double midVal = get(local_a, mid);
      if (midVal < key) {
        from = mid + 1L;
      } else if (midVal > key) {
        local_to = mid - 1L;
  ...
  public static long binarySearch(double[][] local_a, double key)
  {
    return binarySearch(local_a, 0L, length(local_a), key);
  }
  
  public static long binarySearch(double[][] local_a, long from, long local_to, double key, DoubleComparator local_c)
  {
    local_to -= 1L;
    while (from <= local_to)
    {
  ...
  public static long binarySearch(double[][] local_a, double key, DoubleComparator local_c)
  {
  ...
  public static void radixSort(double[][] local_a, long from, long local_to)
  {
    int maxLevel = 7;
    int stackSize = 1786;
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        long local_i = length;
        while (local_i-- != 0L) {
          ByteBigArrays.set(digit, local_i, (byte)(int)(fixDouble(get(local_a, first + local_i)) >>> shift & 0xFF ^ signMask));
        }
        long local_i = length;
        while (local_i-- != 0L) {
        ...
        for (int local_i1 = 0; local_i1 < 256; local_i1++)
        {
          ...
          long tmp364_363 = (local_p + count[local_i1]);
          local_p = tmp364_363;
          pos[local_i1] = tmp364_363;
        }
        ...
        {
          double local_t = get(local_a, local_i2 + first);
  ...
  private static void selectionSort(double[][] local_a, double[][] local_b, long from, long local_to)
  {
    for (long local_i = from; local_i < local_to - 1L; local_i += 1L)
    {
      long local_m = local_i;
      ...
      if (local_m != local_i)
      {
        double local_j = get(local_a, local_i);
  ...
  public static void radixSort(double[][] local_a, double[][] local_b, long from, long local_to)
  {
    int layers = 2;
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        long local_i = length;
        while (local_i-- != 0L) {
          ByteBigArrays.set(digit, local_i, (byte)(int)(fixDouble(get(local_k, first + local_i)) >>> shift & 0xFF ^ signMask));
        }
        long local_i = length;
        while (local_i-- != 0L) {
          count[(ByteBigArrays.get(digit, local_i) & 0xFF)] += 1L;
        ...
        for (int local_i1 = 0; local_i1 < 256; local_i1++)
        {
          ...
          long tmp408_407 = (local_p + count[local_i1]);
          local_p = tmp408_407;
        ...
        {
          double local_t = get(local_a, local_i2 + first);
          double local_u = get(local_b, local_i2 + first);
          local_c = ByteBigArrays.get(digit, local_i2) & 0xFF;
          for (;;)
          {
            long local_d;
  ...
  public static double[][] shuffle(double[][] local_a, long from, long local_to, Random random)
  {
    long local_i = local_to - from;
    while (local_i-- != 0L)
    {
      long local_p = (random.nextLong() & 0xFFFFFFFF) % (local_i + 1L);
      double local_t = get(local_a, from + local_i);
  ...
  public static double[][] shuffle(double[][] local_a, Random random)
  {
    ...
    {
      long local_p = (random.nextLong() & 0xFFFFFFFF) % (local_i + 1L);
      double local_t = get(local_a, local_i);
    ...
    implements Hash.Strategy<double[][]>, Serializable
  {
    ...
    {
      return DoubleBigArrays.equals(local_a, local_b);
    }
  }
}
