...
/*      */ 
/*      */ public class Double2LongRBTreeMap extends AbstractDouble2LongSortedMap
...
/*  119 */           return Double2LongRBTreeMap.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*      */         }
/*      */         public int compare(Double ok1, Double ok2) {
/*  122 */           return Double2LongRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     long oldValue = put(ok.doubleValue(), ov.longValue());
/*  731 */     return this.modified ? null : Long.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Long remove(Object ok)
/*      */   {
/*  737 */     long oldValue = remove(((Double)ok).doubleValue());
...
/* 1141 */         final Comparator<? super Double2LongMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Double2LongMap.Entry x, Double2LongMap.Entry y) {
/* 1143 */             return Double2LongRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Double2LongRBTreeMap.EntryIterator(Double2LongRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry from) {
/* 1153 */           return new Double2LongRBTreeMap.EntryIterator(Double2LongRBTreeMap.this, ((Double)from.getKey()).doubleValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Double2LongRBTreeMap.Entry f = Double2LongRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1166 */           Double2LongRBTreeMap.Entry f = Double2LongRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1167 */           if (f != null) Double2LongRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Double2LongRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Double2LongRBTreeMap.this.clear(); } 
/* 1172 */         public Double2LongMap.Entry first() { return Double2LongRBTreeMap.this.firstEntry; } 
/* 1173 */         public Double2LongMap.Entry last() { return Double2LongRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Double2LongMap.Entry> subSet(Double2LongMap.Entry from, Double2LongMap.Entry to) { return Double2LongRBTreeMap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2LongEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry to) { return Double2LongRBTreeMap.this.headMap((Double)to.getKey()).double2LongEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry from) { return Double2LongRBTreeMap.this.tailMap((Double)from.getKey()).double2LongEntrySet(); }
/*      */       };
...
/* 1242 */           return new Double2LongRBTreeMap.ValueIterator(Double2LongRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(long k) {
/* 1245 */           return Double2LongRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Double2LongRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Double2LongRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Double2LongRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readDouble(), s.readLong());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readDouble(), s.readLong());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readDouble(), s.readLong()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Double2LongRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Double2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator() {
/* 1329 */             return new Double2LongRBTreeMap.Submap.SubmapEntryIterator(Double2LongRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry from) {
/* 1332 */             return new Double2LongRBTreeMap.Submap.SubmapEntryIterator(Double2LongRBTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
/*      */           }
/* 1334 */           public Comparator<? super Double2LongMap.Entry> comparator() { return Double2LongRBTreeMap.this.double2LongEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Double2LongRBTreeMap.Entry f = Double2LongRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1340 */             return (f != null) && (Double2LongRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Double2LongRBTreeMap.Entry f = Double2LongRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1347 */             if ((f != null) && (Double2LongRBTreeMap.Submap.this.in(f.key))) Double2LongRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Double2LongRBTreeMap.Submap.SubmapIterator(Double2LongRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Double2LongRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Double2LongMap.Entry first() { return Double2LongRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Double2LongMap.Entry last() { return Double2LongRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Double2LongMap.Entry> subSet(Double2LongMap.Entry from, Double2LongMap.Entry to) { return Double2LongRBTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2LongEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry to) { return Double2LongRBTreeMap.Submap.this.headMap((Double)to.getKey()).double2LongEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry from) { return Double2LongRBTreeMap.Submap.this.tailMap((Double)from.getKey()).double2LongEntrySet(); }
/*      */         };
...
/*      */           public LongIterator iterator() {
/* 1376 */             return new Double2LongRBTreeMap.Submap.SubmapValueIterator(Double2LongRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(long k) {
/* 1379 */             return Double2LongRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Double2LongRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Double2LongRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(double k) {
/* 1392 */       return (in(k)) && (Double2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(long v) {
...
/* 1407 */       return (in(kk)) && ((e = Double2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public long put(double k, long v) {
/* 1410 */       Double2LongRBTreeMap.this.modified = false;
...
/* 1412 */       long oldValue = Double2LongRBTreeMap.this.put(k, v);
/* 1413 */       return Double2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Long put(Double ok, Long ov) {
/* 1416 */       long oldValue = put(ok.doubleValue(), ov.longValue());
/* 1417 */       return Double2LongRBTreeMap.this.modified ? null : Long.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public long remove(double k) {
/* 1421 */       Double2LongRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       long oldValue = Double2LongRBTreeMap.this.remove(k);
/* 1424 */       return Double2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Long remove(Object ok) {
/* 1427 */       long oldValue = remove(((Double)ok).doubleValue());
/* 1428 */       return Double2LongRBTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public DoubleComparator comparator() {
/* 1443 */       return Double2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Double2LongSortedMap headMap(double to) {
/* 1446 */       if (this.top) return new Submap(Double2LongRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Double2LongRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Double2LongRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Double2LongSortedMap tailMap(double from) {
/* 1450 */       if (this.bottom) return new Submap(Double2LongRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Double2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2LongRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Double2LongSortedMap subMap(double from, double to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Double2LongRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Double2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Double2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Double2LongRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Double2LongRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Double2LongRBTreeMap.this.tree == null) return null;
/* 1468 */       Double2LongRBTreeMap.Entry e;
/*      */       Double2LongRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Double2LongRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Double2LongRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Double2LongRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Double2LongRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Double2LongRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Double2LongRBTreeMap.this.tree == null) return null;
/* 1486 */       Double2LongRBTreeMap.Entry e;
/*      */       Double2LongRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Double2LongRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Double2LongRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Double2LongRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Double2LongRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public double firstDoubleKey() {
/* 1497 */       Double2LongRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public double lastDoubleKey() {
/* 1502 */       Double2LongRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Double firstKey() {
/* 1507 */       Double2LongRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Double lastKey() {
/* 1512 */       Double2LongRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Double2LongRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Double2LongRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Double2LongRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Double2LongMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Double2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(double k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Double2LongRBTreeMap.Submap.this.bottom) && (Double2LongRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Double2LongRBTreeMap.Submap.this.top) && (Double2LongRBTreeMap.this.compare(k, (this.prev = Double2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Double2LongRBTreeMap.this.locateKey(k);
/* 1534 */             if (Double2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Double2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2LongRBTreeMap.this.compare(this.prev.key, Double2LongRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Double2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Double2LongRBTreeMap.this.compare(this.next.key, Double2LongRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public DoubleBidirectionalIterator iterator() { return new Double2LongRBTreeMap.Submap.SubmapKeyIterator(Double2LongRBTreeMap.Submap.this); } 
/* 1367 */       public DoubleBidirectionalIterator iterator(double from) { return new Double2LongRBTreeMap.Submap.SubmapKeyIterator(Double2LongRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2LongRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public DoubleBidirectionalIterator iterator() { return new Double2LongRBTreeMap.KeyIterator(Double2LongRBTreeMap.this); } 
/* 1201 */     public DoubleBidirectionalIterator iterator(double from) { return new Double2LongRBTreeMap.KeyIterator(Double2LongRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2LongRBTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2LongRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Double2LongMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Double2LongMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Double2LongRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(double k) {
/* 1067 */       if ((this.next = Double2LongRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Double2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Double2LongRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/*  983 */       return HashCommon.double2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
