...
/*     */   {
/* 124 */     return new Singleton(key.doubleValue(), value.intValue());
/*     */   }
/*     */ 
...
/* 227 */     public int get(double k) { return this.function.get(k); } 
/* 228 */     public boolean containsKey(Object ok) { return this.function.containsKey(ok); }
/*     */ 
/*     */   }
/*     */ 
/*     */   public static class SynchronizedFunction extends AbstractDouble2IntFunction
/*     */     implements Serializable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Double2IntFunction function;
...
/* 170 */     public int get(double k) { synchronized (this.sync) { return this.function.get(k); }  } 
/* 171 */     public boolean containsKey(Object ok) { synchronized (this.sync) { return this.function.containsKey(ok); }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
/*     */   public static class Singleton extends AbstractDouble2IntFunction
...
/*     */     }
/*  92 */     public int get(double k) { if (this.key == k) return this.value; return this.defRetValue; } 
/*     */     public int size() {
/*  94 */       return 1;
/*     */     }
...
/*     */   }
/*     */ 
/*     */   public static class EmptyFunction extends AbstractDouble2IntFunction
/*     */     implements Serializable, Cloneable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */ 
...
/*     */     public void clear() {  } 
/*  68 */     private Object readResolve() { return Double2IntFunctions.EMPTY_FUNCTION; } 
/*  69 */     public Object clone() { return Double2IntFunctions.EMPTY_FUNCTION; }
/*     */ 
/*     */   }
/*     */ }
