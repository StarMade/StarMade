...
public abstract interface Double2ReferenceMap<V> extends Double2ReferenceFunction<V>, Map<Double, V>
{
  ...
  public static abstract interface FastEntrySet<V> extends ObjectSet<Double2ReferenceMap.Entry<V>>
  {
