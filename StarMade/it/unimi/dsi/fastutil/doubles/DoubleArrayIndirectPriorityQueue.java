  ...
  implements DoubleIndirectPriorityQueue
{
  ...
  public DoubleArrayIndirectPriorityQueue(double[] refArray, int capacity, DoubleComparator local_c)
  {
    if (capacity > 0) {
  ...
  public DoubleArrayIndirectPriorityQueue(double[] refArray, DoubleComparator local_c)
  {
  ...
  public DoubleArrayIndirectPriorityQueue(double[] refArray, int[] local_a, int size, DoubleComparator local_c)
  {
  ...
  public DoubleArrayIndirectPriorityQueue(double[] refArray, int[] local_a, DoubleComparator local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public DoubleArrayIndirectPriorityQueue(double[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public DoubleArrayIndirectPriorityQueue(double[] refArray, int[] local_a)
  {
  ...
  {
    double top = this.refArray[this.array[findFirst()]];
    int local_i = this.size;
    int local_c = 0;
    while (local_i-- != 0) {
