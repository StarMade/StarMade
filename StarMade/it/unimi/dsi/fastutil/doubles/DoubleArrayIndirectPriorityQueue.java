...
/* 165 */     double first = this.refArray[this.array[firstIndex]];
/*     */ 
...
/* 179 */     double last = this.refArray[this.array[lastIndex]];
/*     */ 
...
/* 270 */     double top = this.refArray[this.array[findFirst()]];
