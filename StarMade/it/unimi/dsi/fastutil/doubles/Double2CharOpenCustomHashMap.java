...
/*  18:    */
/*  90:    */public class Double2CharOpenCustomHashMap
/*  91:    */  extends AbstractDouble2CharMap
...
/* 104:    */  protected volatile transient Double2CharMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Double2CharOpenCustomHashMap(int expected, float f, DoubleHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Double2CharOpenCustomHashMap(int expected, DoubleHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Double2CharOpenCustomHashMap(DoubleHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Double2CharOpenCustomHashMap(Map<? extends Double, ? extends Character> m, float f, DoubleHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Double2CharOpenCustomHashMap(Map<? extends Double, ? extends Character> m, DoubleHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Double2CharOpenCustomHashMap(Double2CharMap m, float f, DoubleHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Double2CharOpenCustomHashMap(Double2CharMap m, DoubleHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Double2CharOpenCustomHashMap(double[] k, char[] v, float f, DoubleHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Double2CharOpenCustomHashMap(double[] k, char[] v, DoubleHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public char put(double k, char v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Character put(Double ok, Character ov) { char v = ov.charValue();
...
/* 269:    */  }
/* 270:    */  
/* 271:    */  public char remove(double k)
/* 272:    */  {
...
/* 302:    */  }
/* 303:    */  
/* 304:304 */  public Character get(Double ok) { double k = ok.doubleValue();
/* 305:    */    
...
/* 379:    */    implements Double2CharMap.Entry, Map.Entry<Double, Character>
/* 380:    */  {
...
/* 386:    */    }
/* 387:    */    
/* 388:388 */    public Double getKey() { return Double.valueOf(Double2CharOpenCustomHashMap.this.key[this.index]); }
/* 389:    */    
/* 390:    */    public double getDoubleKey() {
/* 391:391 */      return Double2CharOpenCustomHashMap.this.key[this.index];
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public Character getValue() { return Character.valueOf(Double2CharOpenCustomHashMap.this.value[this.index]); }
/* 395:    */    
/* 397:397 */    public char getCharValue() { return Double2CharOpenCustomHashMap.this.value[this.index]; }
/* 398:    */    
/* 399:    */    public char setValue(char v) {
/* 400:400 */      char oldValue = Double2CharOpenCustomHashMap.this.value[this.index];
/* 401:401 */      Double2CharOpenCustomHashMap.this.value[this.index] = v;
...
/* 410:410 */      Map.Entry<Double, Character> e = (Map.Entry)o;
/* 411:411 */      return (Double2CharOpenCustomHashMap.this.strategy.equals(Double2CharOpenCustomHashMap.this.key[this.index], ((Double)e.getKey()).doubleValue())) && (Double2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 412:    */    }
/* 413:    */    
/* 414:414 */    public int hashCode() { return Double2CharOpenCustomHashMap.this.strategy.hashCode(Double2CharOpenCustomHashMap.this.key[this.index]) ^ Double2CharOpenCustomHashMap.this.value[this.index]; }
/* 415:    */    
/* 417:417 */    public String toString() { return Double2CharOpenCustomHashMap.this.key[this.index] + "=>" + Double2CharOpenCustomHashMap.this.value[this.index]; } }
/* 418:    */  
...
/* 423:    */    
/* 424:424 */    private MapIterator() { this.pos = Double2CharOpenCustomHashMap.this.n;
/* 425:    */      
/* 427:427 */      this.last = -1;
/* 428:    */      
/* 429:429 */      this.c = Double2CharOpenCustomHashMap.this.size;
/* 430:    */      
/* 434:434 */      boolean[] used = Double2CharOpenCustomHashMap.this.used;
...
/* 446:    */        
/* 447:447 */        int pos = HashCommon.murmurHash3(Double2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Double2CharOpenCustomHashMap.this.mask;
/* 448:    */        
/* 449:449 */        while (Double2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 450:450 */          if (Double2CharOpenCustomHashMap.this.strategy.equals(Double2CharOpenCustomHashMap.this.key[pos], k)) return pos;
/* 451:451 */          pos = pos + 1 & Double2CharOpenCustomHashMap.this.mask;
/* 452:    */        }
/* 453:    */      }
/* 454:454 */      this.last = this.pos;
/* 455:    */      
/* 456:456 */      if (this.c != 0) {
/* 457:457 */        boolean[] used = Double2CharOpenCustomHashMap.this.used;
...
/* 472:    */      for (;;)
/* 473:    */      {
/* 474:474 */        pos = (last = pos) + 1 & Double2CharOpenCustomHashMap.this.mask;
/* 475:475 */        while (Double2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 476:476 */          int slot = HashCommon.murmurHash3(Double2CharOpenCustomHashMap.this.strategy.hashCode(Double2CharOpenCustomHashMap.this.key[pos])) & Double2CharOpenCustomHashMap.this.mask;
/* 477:477 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 478:478 */          pos = pos + 1 & Double2CharOpenCustomHashMap.this.mask;
/* 479:    */        }
/* 480:480 */        if (Double2CharOpenCustomHashMap.this.used[pos] == 0) break;
/* 481:481 */        if (pos < last)
/* 482:    */        {
/* 483:483 */          if (this.wrapped == null) this.wrapped = new DoubleArrayList();
/* 484:484 */          this.wrapped.add(Double2CharOpenCustomHashMap.this.key[pos]);
/* 485:    */        }
/* 486:486 */        Double2CharOpenCustomHashMap.this.key[last] = Double2CharOpenCustomHashMap.this.key[pos];
/* 487:487 */        Double2CharOpenCustomHashMap.this.value[last] = Double2CharOpenCustomHashMap.this.value[pos];
/* 488:    */      }
/* 489:489 */      Double2CharOpenCustomHashMap.this.used[last] = false;
/* 490:490 */      return last;
/* 491:    */    }
/* 492:    */    
...
/* 496:    */      {
/* 497:497 */        Double2CharOpenCustomHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
/* 498:498 */        this.last = -1;
/* 499:499 */        return;
/* 500:    */      }
/* 501:501 */      Double2CharOpenCustomHashMap.this.size -= 1;
...
/* 513:    */    } }
/* 514:    */  
/* 515:515 */  private class EntryIterator extends Double2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Double2CharMap.Entry> { private EntryIterator() { super(null); }
/* 516:    */    
/* 517:    */    private Double2CharOpenCustomHashMap.MapEntry entry;
/* 518:518 */    public Double2CharMap.Entry next() { return this.entry = new Double2CharOpenCustomHashMap.MapEntry(Double2CharOpenCustomHashMap.this, nextEntry()); }
/* 519:    */    
/* 520:    */    public void remove()
/* 521:    */    {
/* 522:522 */      super.remove();
/* 523:523 */      Double2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 524:    */    } }
/* 525:    */  
/* 526:526 */  private class FastEntryIterator extends Double2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Double2CharMap.Entry> { private FastEntryIterator() { super(null); }
/* 527:527 */    final AbstractDouble2CharMap.BasicEntry entry = new AbstractDouble2CharMap.BasicEntry(0.0D, '\000');
/* 528:    */    
/* 529:529 */    public AbstractDouble2CharMap.BasicEntry next() { int e = nextEntry();
/* 530:530 */      this.entry.key = Double2CharOpenCustomHashMap.this.key[e];
/* 531:531 */      this.entry.value = Double2CharOpenCustomHashMap.this.value[e];
/* 532:532 */      return this.entry;
/* 533:    */    } }
/* 534:    */  
/* 535:    */  private final class MapEntrySet extends AbstractObjectSet<Double2CharMap.Entry> implements Double2CharMap.FastEntrySet { private MapEntrySet() {}
/* 536:    */    
/* 537:537 */    public ObjectIterator<Double2CharMap.Entry> iterator() { return new Double2CharOpenCustomHashMap.EntryIterator(Double2CharOpenCustomHashMap.this, null); }
/* 538:    */    
/* 539:    */    public ObjectIterator<Double2CharMap.Entry> fastIterator() {
/* 540:540 */      return new Double2CharOpenCustomHashMap.FastEntryIterator(Double2CharOpenCustomHashMap.this, null);
/* 541:    */    }
/* 542:    */    
/* 543:    */    public boolean contains(Object o) {
/* 544:544 */      if (!(o instanceof Map.Entry)) return false;
/* 545:545 */      Map.Entry<Double, Character> e = (Map.Entry)o;
/* 546:546 */      double k = ((Double)e.getKey()).doubleValue();
/* 547:    */      
/* 548:548 */      int pos = HashCommon.murmurHash3(Double2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Double2CharOpenCustomHashMap.this.mask;
/* 549:    */      
/* 550:550 */      while (Double2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 551:551 */        if (Double2CharOpenCustomHashMap.this.strategy.equals(Double2CharOpenCustomHashMap.this.key[pos], k)) return Double2CharOpenCustomHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 552:552 */        pos = pos + 1 & Double2CharOpenCustomHashMap.this.mask;
/* 553:    */      }
...
/* 559:559 */      Map.Entry<Double, Character> e = (Map.Entry)o;
/* 560:560 */      double k = ((Double)e.getKey()).doubleValue();
/* 561:    */      
/* 562:562 */      int pos = HashCommon.murmurHash3(Double2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Double2CharOpenCustomHashMap.this.mask;
/* 563:    */      
/* 564:564 */      while (Double2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 565:565 */        if (Double2CharOpenCustomHashMap.this.strategy.equals(Double2CharOpenCustomHashMap.this.key[pos], k)) {
/* 566:566 */          Double2CharOpenCustomHashMap.this.remove(e.getKey());
/* 567:567 */          return true;
/* 568:    */        }
/* 569:569 */        pos = pos + 1 & Double2CharOpenCustomHashMap.this.mask;
/* 570:    */      }
/* 571:571 */      return false;
/* 572:    */    }
/* 573:    */    
/* 574:574 */    public int size() { return Double2CharOpenCustomHashMap.this.size; }
/* 575:    */    
/* 577:577 */    public void clear() { Double2CharOpenCustomHashMap.this.clear(); }
/* 578:    */  }
/* 579:    */  
/* 580:    */  public Double2CharMap.FastEntrySet double2CharEntrySet() {
...
/* 588:    */    extends Double2CharOpenCustomHashMap.MapIterator
/* 589:    */    implements DoubleIterator
/* 590:    */  {
/* 591:591 */    public KeyIterator() { super(null); }
/* 592:592 */    public double nextDouble() { return Double2CharOpenCustomHashMap.this.key[nextEntry()]; }
/* 593:593 */    public Double next() { return Double.valueOf(Double2CharOpenCustomHashMap.this.key[nextEntry()]); } }
/* 594:    */  
/* 595:    */  private final class KeySet extends AbstractDoubleSet { private KeySet() {}
/* 596:    */    
/* 597:597 */    public DoubleIterator iterator() { return new Double2CharOpenCustomHashMap.KeyIterator(Double2CharOpenCustomHashMap.this); }
/* 598:    */    
/* 599:    */    public int size() {
/* 600:600 */      return Double2CharOpenCustomHashMap.this.size;
/* 601:    */    }
/* 602:    */    
/* 603:603 */    public boolean contains(double k) { return Double2CharOpenCustomHashMap.this.containsKey(k); }
/* 604:    */    
/* 605:    */    public boolean remove(double k) {
/* 606:606 */      int oldSize = Double2CharOpenCustomHashMap.this.size;
/* 607:607 */      Double2CharOpenCustomHashMap.this.remove(k);
/* 608:608 */      return Double2CharOpenCustomHashMap.this.size != oldSize;
/* 609:    */    }
/* 610:    */    
/* 611:611 */    public void clear() { Double2CharOpenCustomHashMap.this.clear(); }
/* 612:    */  }
/* 613:    */  
...
/* 622:    */    extends Double2CharOpenCustomHashMap.MapIterator
/* 623:    */    implements CharIterator
/* 624:    */  {
/* 625:625 */    public ValueIterator() { super(null); }
/* 626:626 */    public char nextChar() { return Double2CharOpenCustomHashMap.this.value[nextEntry()]; }
/* 627:627 */    public Character next() { return Character.valueOf(Double2CharOpenCustomHashMap.this.value[nextEntry()]); }
/* 628:    */  }
/* 629:    */  
...
/* 632:632 */          return new Double2CharOpenCustomHashMap.ValueIterator(Double2CharOpenCustomHashMap.this);
/* 633:    */        }
/* 634:    */        
/* 635:635 */        public int size() { return Double2CharOpenCustomHashMap.this.size; }
/* 636:    */        
/* 637:    */        public boolean contains(char v) {
/* 638:638 */          return Double2CharOpenCustomHashMap.this.containsValue(v);
/* 639:    */        }
/* 640:    */        
/* 641:641 */        public void clear() { Double2CharOpenCustomHashMap.this.clear(); }
/* 642:    */      };
/* 643:    */    }
...
/* 744:    */  }
/* 745:    */  
/* 749:    */  public Double2CharOpenCustomHashMap clone()
/* 750:    */  {
/* 751:    */    Double2CharOpenCustomHashMap c;
/* 752:    */    
/* 754:    */    try
/* 755:    */    {
/* 756:756 */      c = (Double2CharOpenCustomHashMap)super.clone();
/* 757:    */    }
