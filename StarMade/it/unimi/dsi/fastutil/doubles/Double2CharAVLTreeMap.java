  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2CharAVLTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2CharAVLTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2CharAVLTreeMap(Map<? extends Double, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2CharAVLTreeMap(SortedMap<Double, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2CharAVLTreeMap(Double2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2CharAVLTreeMap(Double2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2CharAVLTreeMap(double[] local_k, char[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2CharAVLTreeMap(double[] local_k, char[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Double2CharMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Double2CharAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2CharAVLTreeMap.EntryIterator(Double2CharAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from)
        {
          return new Double2CharAVLTreeMap.EntryIterator(Double2CharAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2CharAVLTreeMap.Entry local_f = Double2CharAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2CharAVLTreeMap.Entry local_f = Double2CharAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2CharAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Double2CharAVLTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2CharEntrySet();
        }
        
        public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry local_to)
        {
          return Double2CharAVLTreeMap.this.headMap((Double)local_to.getKey()).double2CharEntrySet();
        }
        
        public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry from)
        {
          return Double2CharAVLTreeMap.this.tailMap((Double)from.getKey()).double2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Double2CharAVLTreeMap.ValueIterator(Double2CharAVLTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Double2CharAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2CharAVLTreeMap local_c;
    try
    {
      local_c = (Double2CharAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2CharAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Double2CharAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2CharAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2CharMap.Entry> double2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator()
          {
            return new Double2CharAVLTreeMap.Submap.SubmapEntryIterator(Double2CharAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from)
          {
            return new Double2CharAVLTreeMap.Submap.SubmapEntryIterator(Double2CharAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, Character> local_e = (Map.Entry)local_o;
            Double2CharAVLTreeMap.Entry local_f = Double2CharAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2CharAVLTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, Character> local_e = (Map.Entry)local_o;
            Double2CharAVLTreeMap.Entry local_f = Double2CharAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2CharAVLTreeMap.Submap.this.in7(local_f.key))) {
              Double2CharAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2CharAVLTreeMap.Submap.SubmapIterator(Double2CharAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2CharAVLTreeMap.Submap.this.clear();
          }
          
          public Double2CharMap.Entry first()
          {
            return Double2CharAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Double2CharMap.Entry last()
          {
            return Double2CharAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry from, Double2CharMap.Entry local_to)
          {
            return Double2CharAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2CharEntrySet();
          }
          
          public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry local_to)
          {
            return Double2CharAVLTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2CharEntrySet();
          }
          
          public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry from)
          {
            return Double2CharAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Double2CharAVLTreeMap.Submap.SubmapValueIterator(Double2CharAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Double2CharAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2CharAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2CharAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2CharAVLTreeMap.Entry local_e;
      return (in7(local_kk)) && ((local_e = Double2CharAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(double local_k, char local_v)
    {
      ...
      char oldValue = Double2CharAVLTreeMap.this.put(local_k, local_v);
    ...
    public char remove(double local_k)
    {
      ...
      char oldValue = Double2CharAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2CharAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2CharAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2CharSortedMap tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2CharAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2CharAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2CharSortedMap subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2CharAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2CharAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2CharAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2CharAVLTreeMap.this.locateKey(this.from);
        if (Double2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2CharAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2CharAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2CharAVLTreeMap.this.locateKey(this.field_47);
        if (Double2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2CharAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2CharAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Double2CharAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Double2CharAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2CharAVLTreeMap.Submap.this.bottom) && (Double2CharAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2CharAVLTreeMap.Submap.this.top) && (Double2CharAVLTreeMap.this.compare(local_k, (this.prev = Double2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2CharAVLTreeMap.this.locateKey(local_k);
            if (Double2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2CharAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2CharAVLTreeMap.this.compare(this.prev.key, Double2CharAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2CharAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2CharAVLTreeMap.this.compare(this.next.key, Double2CharAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2CharSortedMap.KeySet
    {
      ...
      {
        return new Double2CharAVLTreeMap.Submap.SubmapKeyIterator(Double2CharAVLTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2CharAVLTreeMap.Submap.SubmapKeyIterator(Double2CharAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2CharSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2CharAVLTreeMap.KeyIterator(Double2CharAVLTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2CharAVLTreeMap.KeyIterator(Double2CharAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2CharAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Double2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
