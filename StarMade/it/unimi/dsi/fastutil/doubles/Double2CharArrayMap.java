...
/*     */ 
/*     */ public class Double2CharArrayMap extends AbstractDouble2CharMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Double2CharArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Double2CharMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Double2CharArrayMap.this.size; }
/*     */ 
/*     */         public Double2CharMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractDouble2CharMap.BasicEntry(Double2CharArrayMap.this.key[this.next], Double2CharArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractDouble2CharMap.BasicEntry entry = new AbstractDouble2CharMap.BasicEntry(0.0D, '\000');
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Double2CharArrayMap.this.size; }
/*     */ 
/*     */         public Double2CharMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Double2CharArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Double2CharArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Double2CharArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Double2CharArrayMap.this.containsKey(k)) && (Double2CharArrayMap.this.get(k) == ((Character)e.getValue()).charValue());
/*     */     }
/*     */   }
/*     */ }
