...
/*      */   protected int size;
/*      */   protected volatile transient Double2ObjectSortedMap.FastSortedEntrySet<V> entries;
...
/*  145 */     this.key = new double[this.n];
...
/*      */   {
/*  222 */     int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
/*      */ 
...
/*  292 */         int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(this.key[pos])) & this.mask;
...
/*  324 */     double k = ((Double)ok).doubleValue();
/*      */ 
/*  326 */     int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
/*      */ 
...
/*      */ 
/*  422 */     int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & mask;
/*      */ 
...
/*      */ 
/*  443 */     int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & mask;
/*      */ 
...
/*      */   {
/*  461 */     double[] key = this.key;
/*  462 */     boolean[] used = this.used;
/*  463 */     int mask = this.mask;
/*      */ 
/*  465 */     int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & mask;
/*      */ 
...
/*      */   {
/*  500 */     double[] key = this.key;
/*  501 */     boolean[] used = this.used;
/*  502 */     int mask = this.mask;
/*      */ 
/*  504 */     int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & mask;
/*      */ 
...
/*  533 */     double k = ok.doubleValue();
/*      */ 
/*  535 */     int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
/*      */ 
...
/*  568 */     for (int i = this.n; i-- != 0; return true) label16: if ((used[i] == 0) || (value[i] == null ? v != null : !value[i].equals(v)))
...
/*      */   }
/*  729 */   public DoubleComparator comparator() { return null; } 
/*  730 */   public Double2ObjectSortedMap<V> tailMap(double from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Double2ObjectSortedMap<V> headMap(double to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Double2ObjectSortedMap<V> subMap(double from, double to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/* 1046 */     if (this.values == null) this.values = new AbstractObjectCollection() {
/*      */         public ObjectIterator<V> iterator() {
/* 1048 */           return new Double2ObjectLinkedOpenHashMap.ValueIterator(Double2ObjectLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Double2ObjectLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Double2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Double2ObjectLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/* 1140 */     double[] newKey = new double[newN];
...
/* 1147 */       double k = key[i];
/* 1148 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & newMask;
...
/*      */     try
/*      */     {
/* 1190 */       c = (Double2ObjectLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1196 */     c.values = null;
/* 1197 */     c.entries = null;
/* 1198 */     c.key = ((double[])this.key.clone());
...
/* 1217 */       t = HashCommon.double2int(this.key[i]);
/* 1218 */       if (this != this.value[i])
/* 1219 */         t ^= (this.value[i] == null ? 0 : this.value[i].hashCode());
/* 1220 */       h += t;
/* 1221 */       i++;
/*      */     }
/* 1223 */     return h;
...
/* 1242 */     double[] key = this.key = new double[this.n];
...
/* 1251 */       double k = s.readDouble();
/* 1252 */       Object v = s.readObject();
/* 1253 */       pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Double2ObjectLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Double2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Double2ObjectLinkedOpenHashMap.KeyIterator(Double2ObjectLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public DoubleListIterator iterator() {
/*  999 */       return new Double2ObjectLinkedOpenHashMap.KeyIterator(Double2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Double2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(double k) {
/* 1005 */       return Double2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(double k) {
/* 1008 */       int oldSize = Double2ObjectLinkedOpenHashMap.this.size;
/* 1009 */       Double2ObjectLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Double2ObjectLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Double2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public double firstDouble() {
/* 1016 */       if (Double2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Double2ObjectLinkedOpenHashMap.this.key[Double2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public double lastDouble() {
/* 1020 */       if (Double2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Double2ObjectLinkedOpenHashMap.this.key[Double2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/* 1023 */     public DoubleComparator comparator() { return null; } 
/* 1024 */     public final DoubleSortedSet tailSet(double from) { throw new UnsupportedOperationException(); } 
/* 1025 */     public final DoubleSortedSet headSet(double to) { throw new UnsupportedOperationException(); } 
/* 1026 */     public final DoubleSortedSet subSet(double from, double to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2ObjectLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator(double k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public double previousDouble() { return Double2ObjectLinkedOpenHashMap.this.key[previousEntry()]; } 
/*  985 */     public void set(double k) { throw new UnsupportedOperationException(); } 
/*  986 */     public void add(double k) { throw new UnsupportedOperationException(); } 
/*  987 */     public Double previous() { return Double.valueOf(Double2ObjectLinkedOpenHashMap.this.key[previousEntry()]); } 
/*  988 */     public void set(Double ok) { throw new UnsupportedOperationException(); } 
/*  989 */     public void add(Double ok) { throw new UnsupportedOperationException(); } 
/*  990 */     public KeyIterator() { super(null); } 
/*  991 */     public double nextDouble() { return Double2ObjectLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Double next() { return Double.valueOf(Double2ObjectLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Double2ObjectLinkedOpenHashMap.EntryIterator(Double2ObjectLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Double2ObjectMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> fromElement, Double2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Double2ObjectMap.Entry<V> first() {
/*  918 */       if (Double2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Double2ObjectLinkedOpenHashMap.MapEntry(Double2ObjectLinkedOpenHashMap.this, Double2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Double2ObjectMap.Entry<V> last() {
/*  922 */       if (Double2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Double2ObjectLinkedOpenHashMap.MapEntry(Double2ObjectLinkedOpenHashMap.this, Double2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     public boolean contains(Object o) {
/*  927 */       if (!(o instanceof Map.Entry)) return false;
/*  928 */       Map.Entry e = (Map.Entry)o;
/*  929 */       double k = ((Double)e.getKey()).doubleValue();
/*      */ 
/*  931 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Double2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Double2ObjectLinkedOpenHashMap.this.key[pos] == k) return Double2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Double2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  935 */         pos = pos + 1 & Double2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*  943 */       double k = ((Double)e.getKey()).doubleValue();
/*      */ 
/*  945 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Double2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Double2ObjectLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Double2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Double2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Double2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Double2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(Double2ObjectMap.Entry<V> from) {
/*  963 */       return new Double2ObjectLinkedOpenHashMap.EntryIterator(Double2ObjectLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> fastIterator() {
/*  966 */       return new Double2ObjectLinkedOpenHashMap.FastEntryIterator(Double2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> fastIterator(Double2ObjectMap.Entry<V> from) {
/*  969 */       return new Double2ObjectLinkedOpenHashMap.FastEntryIterator(Double2ObjectLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Double2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Double2ObjectMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractDouble2ObjectMap.BasicEntry<V> entry = new AbstractDouble2ObjectMap.BasicEntry(0.0D, null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Double2ObjectLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Double2ObjectLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractDouble2ObjectMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Double2ObjectLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Double2ObjectLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Double2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Double2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Double2ObjectMap.Entry<V>>
/*      */   {
...
/*  870 */       super(null);
/*      */     }
/*  872 */     public EntryIterator(double from) { super(from, null); }
/*      */ 
/*      */     public Double2ObjectLinkedOpenHashMap<V>.MapEntry next() {
/*  875 */       return this.entry = new Double2ObjectLinkedOpenHashMap.MapEntry(Double2ObjectLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Double2ObjectLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Double2ObjectLinkedOpenHashMap.MapEntry(Double2ObjectLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Double2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Double2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Double2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Double2ObjectLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(double from) {
/*  753 */       if (Double2ObjectLinkedOpenHashMap.this.key[Double2ObjectLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Double2ObjectLinkedOpenHashMap.this.last;
/*  755 */         this.index = Double2ObjectLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Double2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Double2ObjectLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Double2ObjectLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Double2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Double2ObjectLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Double2ObjectLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Double2ObjectLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Double2ObjectLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Double2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Double2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Double2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Double2ObjectLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Double2ObjectLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Double2ObjectLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Double2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Double2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Double2ObjectLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Double2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Double2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Double2ObjectLinkedOpenHashMap.this.mask;
/*  841 */         while (Double2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2ObjectLinkedOpenHashMap.this.key[pos])) & Double2ObjectLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Double2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Double2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Double2ObjectLinkedOpenHashMap.this.key[last] = Double2ObjectLinkedOpenHashMap.this.key[pos];
/*  848 */         Double2ObjectLinkedOpenHashMap.this.value[last] = Double2ObjectLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Double2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Double2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Double2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*  619 */       return Double.valueOf(Double2ObjectLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public double getDoubleKey() {
/*  622 */       return Double2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Double2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Double2ObjectLinkedOpenHashMap.this.value[this.index];
/*  629 */       Double2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Double2ObjectLinkedOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Double2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return HashCommon.double2int(Double2ObjectLinkedOpenHashMap.this.key[this.index]) ^ (Double2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Double2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     public String toString() {
/*  642 */       return Double2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Double2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
