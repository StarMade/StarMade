  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2ObjectLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Double2ObjectLinkedOpenHashMap(Map<? extends Double, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2ObjectLinkedOpenHashMap(Map<? extends Double, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2ObjectLinkedOpenHashMap(Double2ObjectMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2ObjectLinkedOpenHashMap(Double2ObjectMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2ObjectLinkedOpenHashMap(double[] local_k, V[] local_v, float local_f)
  {
  ...
  public Double2ObjectLinkedOpenHashMap(double[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Double2ObjectLinkedOpenHashMap.ValueIterator(Double2ObjectLinkedOpenHashMap.this);
        }
        ...
        {
          return Double2ObjectLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2ObjectLinkedOpenHashMap<V> local_c;
    try
    {
      local_c = (Double2ObjectLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    double[] key = this.key;
    V[] value = this.value;
    Double2ObjectLinkedOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractDoubleSortedSet
  {
    ...
    {
      return new Double2ObjectLinkedOpenHashMap.KeyIterator(Double2ObjectLinkedOpenHashMap.this, from);
    }
    
    public DoubleListIterator iterator()
    {
      return new Double2ObjectLinkedOpenHashMap.KeyIterator(Double2ObjectLinkedOpenHashMap.this);
    }
    ...
    {
      return Double2ObjectLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2ObjectLinkedOpenHashMap.this.size;
      Double2ObjectLinkedOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Double2ObjectLinkedOpenHashMap.MapIterator
    implements DoubleListIterator
  {
    ...
    {
      return Double.valueOf(Double2ObjectLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Double next()
    {
      return Double.valueOf(Double2ObjectLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2ObjectSortedMap.FastSortedEntrySet<V>
  {
    ...
    {
      return new Double2ObjectLinkedOpenHashMap.EntryIterator(Double2ObjectLinkedOpenHashMap.this);
    }
    ...
    public Double2ObjectMap.Entry<V> first()
    {
      ...
      return new Double2ObjectLinkedOpenHashMap.MapEntry(Double2ObjectLinkedOpenHashMap.this, Double2ObjectLinkedOpenHashMap.this.first);
    }
    ...
    public Double2ObjectMap.Entry<V> last()
    {
      ...
      return new Double2ObjectLinkedOpenHashMap.MapEntry(Double2ObjectLinkedOpenHashMap.this, Double2ObjectLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2ObjectLinkedOpenHashMap.this.mask; Double2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ObjectLinkedOpenHashMap.this.mask) {
        if (Double2ObjectLinkedOpenHashMap.this.key[pos] == local_k) {
          return Double2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Double2ObjectLinkedOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2ObjectLinkedOpenHashMap.this.mask; Double2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ObjectLinkedOpenHashMap.this.mask) {
        if (Double2ObjectLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Double2ObjectLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Double2ObjectLinkedOpenHashMap.EntryIterator(Double2ObjectLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
    
    public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> fastIterator()
    {
      return new Double2ObjectLinkedOpenHashMap.FastEntryIterator(Double2ObjectLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> fastIterator(Double2ObjectMap.Entry<V> from)
    {
      return new Double2ObjectLinkedOpenHashMap.FastEntryIterator(Double2ObjectLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
  }
    ...
    implements ObjectListIterator<Double2ObjectMap.Entry<V>>
  {
    ...
    public AbstractDouble2ObjectMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Double2ObjectLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Double2ObjectLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Double2ObjectMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Double2ObjectLinkedOpenHashMap.MapEntry(Double2ObjectLinkedOpenHashMap.this, nextEntry());
    }
    
    public Double2ObjectLinkedOpenHashMap<V>.MapEntry previous()
    {
      return this.entry = new Double2ObjectLinkedOpenHashMap.MapEntry(Double2ObjectLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    {
      if (Double2ObjectLinkedOpenHashMap.this.key[Double2ObjectLinkedOpenHashMap.this.last] == from)
      {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2ObjectLinkedOpenHashMap.this.mask; Double2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ObjectLinkedOpenHashMap.this.mask) {
          if (Double2ObjectLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Double2ObjectLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Double2ObjectLinkedOpenHashMap.this.first = this.next;
      } else {
        Double2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Double2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Double2ObjectLinkedOpenHashMap.this.last = this.prev;
      } else {
        Double2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Double2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2ObjectLinkedOpenHashMap.this.mask; Double2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ObjectLinkedOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2ObjectLinkedOpenHashMap.this.key[pos])) & Double2ObjectLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2ObjectLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Double2ObjectLinkedOpenHashMap.this.key[last] = Double2ObjectLinkedOpenHashMap.this.key[pos];
      ...
      Double2ObjectLinkedOpenHashMap.this.used[last] = false;
    ...
    implements Double2ObjectMap.Entry<V>, Map.Entry<Double, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Double2ObjectLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, V> local_e = (Map.Entry)local_o;
      return (Double2ObjectLinkedOpenHashMap.this.key[this.index] == ((Double)local_e.getKey()).doubleValue()) && (Double2ObjectLinkedOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Double2ObjectLinkedOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
