...
/*  18:    */
/*  87:    */public class Double2BooleanOpenHashMap
/*  88:    */  extends AbstractDouble2BooleanMap
...
/* 101:    */  protected volatile transient Double2BooleanMap.FastEntrySet entries;
/* 102:    */  protected volatile transient DoubleSet keys;
/* 103:    */  protected volatile transient BooleanCollection values;
/* 104:    */  
/* 105:    */  public Double2BooleanOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Double2BooleanOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Double2BooleanOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Double2BooleanOpenHashMap(Map<? extends Double, ? extends Boolean> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Double2BooleanOpenHashMap(Map<? extends Double, ? extends Boolean> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Double2BooleanOpenHashMap(Double2BooleanMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Double2BooleanOpenHashMap(Double2BooleanMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Double2BooleanOpenHashMap(double[] k, boolean[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Double2BooleanOpenHashMap(double[] k, boolean[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public boolean put(double k, boolean v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Boolean put(Double ok, Boolean ov) { boolean v = ov.booleanValue();
...
/* 249:    */  }
/* 250:    */  
/* 251:    */  public boolean remove(double k)
/* 252:    */  {
...
/* 282:    */  }
/* 283:    */  
/* 284:284 */  public Boolean get(Double ok) { double k = ok.doubleValue();
/* 285:    */    
...
/* 293:    */  }
/* 294:    */  
/* 295:    */  public boolean get(double k)
/* 296:    */  {
...
/* 359:    */    implements Double2BooleanMap.Entry, Map.Entry<Double, Boolean>
/* 360:    */  {
...
/* 366:    */    }
/* 367:    */    
/* 368:368 */    public Double getKey() { return Double.valueOf(Double2BooleanOpenHashMap.this.key[this.index]); }
/* 369:    */    
/* 370:    */    public double getDoubleKey() {
/* 371:371 */      return Double2BooleanOpenHashMap.this.key[this.index];
/* 372:    */    }
/* 373:    */    
/* 374:374 */    public Boolean getValue() { return Boolean.valueOf(Double2BooleanOpenHashMap.this.value[this.index]); }
/* 375:    */    
/* 377:377 */    public boolean getBooleanValue() { return Double2BooleanOpenHashMap.this.value[this.index]; }
/* 378:    */    
/* 379:    */    public boolean setValue(boolean v) {
/* 380:380 */      boolean oldValue = Double2BooleanOpenHashMap.this.value[this.index];
/* 381:381 */      Double2BooleanOpenHashMap.this.value[this.index] = v;
...
/* 390:390 */      Map.Entry<Double, Boolean> e = (Map.Entry)o;
/* 391:391 */      return (Double2BooleanOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2BooleanOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public int hashCode() { return HashCommon.double2int(Double2BooleanOpenHashMap.this.key[this.index]) ^ (Double2BooleanOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237); }
/* 395:    */    
/* 397:397 */    public String toString() { return Double2BooleanOpenHashMap.this.key[this.index] + "=>" + Double2BooleanOpenHashMap.this.value[this.index]; } }
/* 398:    */  
...
/* 403:    */    
/* 404:404 */    private MapIterator() { this.pos = Double2BooleanOpenHashMap.this.n;
/* 405:    */      
/* 407:407 */      this.last = -1;
/* 408:    */      
/* 409:409 */      this.c = Double2BooleanOpenHashMap.this.size;
/* 410:    */      
/* 414:414 */      boolean[] used = Double2BooleanOpenHashMap.this.used;
...
/* 426:    */        
/* 427:427 */        int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2BooleanOpenHashMap.this.mask;
/* 428:    */        
/* 429:429 */        while (Double2BooleanOpenHashMap.this.used[pos] != 0) {
/* 430:430 */          if (Double2BooleanOpenHashMap.this.key[pos] == k) return pos;
/* 431:431 */          pos = pos + 1 & Double2BooleanOpenHashMap.this.mask;
/* 432:    */        }
/* 433:    */      }
/* 434:434 */      this.last = this.pos;
/* 435:    */      
/* 436:436 */      if (this.c != 0) {
/* 437:437 */        boolean[] used = Double2BooleanOpenHashMap.this.used;
...
/* 452:    */      for (;;)
/* 453:    */      {
/* 454:454 */        pos = (last = pos) + 1 & Double2BooleanOpenHashMap.this.mask;
/* 455:455 */        while (Double2BooleanOpenHashMap.this.used[pos] != 0) {
/* 456:456 */          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2BooleanOpenHashMap.this.key[pos])) & Double2BooleanOpenHashMap.this.mask;
/* 457:457 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 458:458 */          pos = pos + 1 & Double2BooleanOpenHashMap.this.mask;
/* 459:    */        }
/* 460:460 */        if (Double2BooleanOpenHashMap.this.used[pos] == 0) break;
/* 461:461 */        if (pos < last)
/* 462:    */        {
/* 463:463 */          if (this.wrapped == null) this.wrapped = new DoubleArrayList();
/* 464:464 */          this.wrapped.add(Double2BooleanOpenHashMap.this.key[pos]);
/* 465:    */        }
/* 466:466 */        Double2BooleanOpenHashMap.this.key[last] = Double2BooleanOpenHashMap.this.key[pos];
/* 467:467 */        Double2BooleanOpenHashMap.this.value[last] = Double2BooleanOpenHashMap.this.value[pos];
/* 468:    */      }
/* 469:469 */      Double2BooleanOpenHashMap.this.used[last] = false;
/* 470:470 */      return last;
/* 471:    */    }
/* 472:    */    
...
/* 476:    */      {
/* 477:477 */        Double2BooleanOpenHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
/* 478:478 */        this.last = -1;
/* 479:479 */        return;
/* 480:    */      }
/* 481:481 */      Double2BooleanOpenHashMap.this.size -= 1;
...
/* 493:    */    } }
/* 494:    */  
/* 495:495 */  private class EntryIterator extends Double2BooleanOpenHashMap.MapIterator implements ObjectIterator<Double2BooleanMap.Entry> { private EntryIterator() { super(null); }
/* 496:    */    
/* 497:    */    private Double2BooleanOpenHashMap.MapEntry entry;
/* 498:498 */    public Double2BooleanMap.Entry next() { return this.entry = new Double2BooleanOpenHashMap.MapEntry(Double2BooleanOpenHashMap.this, nextEntry()); }
/* 499:    */    
/* 500:    */    public void remove()
/* 501:    */    {
/* 502:502 */      super.remove();
/* 503:503 */      Double2BooleanOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 504:    */    } }
/* 505:    */  
/* 506:506 */  private class FastEntryIterator extends Double2BooleanOpenHashMap.MapIterator implements ObjectIterator<Double2BooleanMap.Entry> { private FastEntryIterator() { super(null); }
/* 507:507 */    final AbstractDouble2BooleanMap.BasicEntry entry = new AbstractDouble2BooleanMap.BasicEntry(0.0D, false);
/* 508:    */    
/* 509:509 */    public AbstractDouble2BooleanMap.BasicEntry next() { int e = nextEntry();
/* 510:510 */      this.entry.key = Double2BooleanOpenHashMap.this.key[e];
/* 511:511 */      this.entry.value = Double2BooleanOpenHashMap.this.value[e];
/* 512:512 */      return this.entry;
/* 513:    */    } }
/* 514:    */  
/* 515:    */  private final class MapEntrySet extends AbstractObjectSet<Double2BooleanMap.Entry> implements Double2BooleanMap.FastEntrySet { private MapEntrySet() {}
/* 516:    */    
/* 517:517 */    public ObjectIterator<Double2BooleanMap.Entry> iterator() { return new Double2BooleanOpenHashMap.EntryIterator(Double2BooleanOpenHashMap.this, null); }
/* 518:    */    
/* 519:    */    public ObjectIterator<Double2BooleanMap.Entry> fastIterator() {
/* 520:520 */      return new Double2BooleanOpenHashMap.FastEntryIterator(Double2BooleanOpenHashMap.this, null);
/* 521:    */    }
/* 522:    */    
/* 523:    */    public boolean contains(Object o) {
/* 524:524 */      if (!(o instanceof Map.Entry)) return false;
/* 525:525 */      Map.Entry<Double, Boolean> e = (Map.Entry)o;
/* 526:526 */      double k = ((Double)e.getKey()).doubleValue();
/* 527:    */      
/* 528:528 */      int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2BooleanOpenHashMap.this.mask;
/* 529:    */      
/* 530:530 */      while (Double2BooleanOpenHashMap.this.used[pos] != 0) {
/* 531:531 */        if (Double2BooleanOpenHashMap.this.key[pos] == k) return Double2BooleanOpenHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/* 532:532 */        pos = pos + 1 & Double2BooleanOpenHashMap.this.mask;
/* 533:    */      }
...
/* 539:539 */      Map.Entry<Double, Boolean> e = (Map.Entry)o;
/* 540:540 */      double k = ((Double)e.getKey()).doubleValue();
/* 541:    */      
/* 542:542 */      int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2BooleanOpenHashMap.this.mask;
/* 543:    */      
/* 544:544 */      while (Double2BooleanOpenHashMap.this.used[pos] != 0) {
/* 545:545 */        if (Double2BooleanOpenHashMap.this.key[pos] == k) {
/* 546:546 */          Double2BooleanOpenHashMap.this.remove(e.getKey());
/* 547:547 */          return true;
/* 548:    */        }
/* 549:549 */        pos = pos + 1 & Double2BooleanOpenHashMap.this.mask;
/* 550:    */      }
/* 551:551 */      return false;
/* 552:    */    }
/* 553:    */    
/* 554:554 */    public int size() { return Double2BooleanOpenHashMap.this.size; }
/* 555:    */    
/* 557:557 */    public void clear() { Double2BooleanOpenHashMap.this.clear(); }
/* 558:    */  }
/* 559:    */  
/* 560:    */  public Double2BooleanMap.FastEntrySet double2BooleanEntrySet() {
...
/* 568:    */    extends Double2BooleanOpenHashMap.MapIterator
/* 569:    */    implements DoubleIterator
/* 570:    */  {
/* 571:571 */    public KeyIterator() { super(null); }
/* 572:572 */    public double nextDouble() { return Double2BooleanOpenHashMap.this.key[nextEntry()]; }
/* 573:573 */    public Double next() { return Double.valueOf(Double2BooleanOpenHashMap.this.key[nextEntry()]); } }
/* 574:    */  
/* 575:    */  private final class KeySet extends AbstractDoubleSet { private KeySet() {}
/* 576:    */    
/* 577:577 */    public DoubleIterator iterator() { return new Double2BooleanOpenHashMap.KeyIterator(Double2BooleanOpenHashMap.this); }
/* 578:    */    
/* 579:    */    public int size() {
/* 580:580 */      return Double2BooleanOpenHashMap.this.size;
/* 581:    */    }
/* 582:    */    
/* 583:583 */    public boolean contains(double k) { return Double2BooleanOpenHashMap.this.containsKey(k); }
/* 584:    */    
/* 585:    */    public boolean remove(double k) {
/* 586:586 */      int oldSize = Double2BooleanOpenHashMap.this.size;
/* 587:587 */      Double2BooleanOpenHashMap.this.remove(k);
/* 588:588 */      return Double2BooleanOpenHashMap.this.size != oldSize;
/* 589:    */    }
/* 590:    */    
/* 591:591 */    public void clear() { Double2BooleanOpenHashMap.this.clear(); }
/* 592:    */  }
/* 593:    */  
...
/* 602:    */    extends Double2BooleanOpenHashMap.MapIterator
/* 603:    */    implements BooleanIterator
/* 604:    */  {
/* 605:605 */    public ValueIterator() { super(null); }
/* 606:606 */    public boolean nextBoolean() { return Double2BooleanOpenHashMap.this.value[nextEntry()]; }
/* 607:607 */    public Boolean next() { return Boolean.valueOf(Double2BooleanOpenHashMap.this.value[nextEntry()]); }
/* 608:    */  }
/* 609:    */  
...
/* 612:612 */          return new Double2BooleanOpenHashMap.ValueIterator(Double2BooleanOpenHashMap.this);
/* 613:    */        }
/* 614:    */        
/* 615:615 */        public int size() { return Double2BooleanOpenHashMap.this.size; }
/* 616:    */        
/* 617:    */        public boolean contains(boolean v) {
/* 618:618 */          return Double2BooleanOpenHashMap.this.containsValue(v);
/* 619:    */        }
/* 620:    */        
/* 621:621 */        public void clear() { Double2BooleanOpenHashMap.this.clear(); }
/* 622:    */      };
/* 623:    */    }
...
/* 724:    */  }
/* 725:    */  
/* 729:    */  public Double2BooleanOpenHashMap clone()
/* 730:    */  {
/* 731:    */    Double2BooleanOpenHashMap c;
/* 732:    */    
/* 734:    */    try
/* 735:    */    {
/* 736:736 */      c = (Double2BooleanOpenHashMap)super.clone();
/* 737:    */    }
