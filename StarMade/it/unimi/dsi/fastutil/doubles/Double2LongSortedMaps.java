...
public class Double2LongSortedMaps
{
  ...
  public static Double2LongSortedMap synchronize(Double2LongSortedMap local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static Double2LongSortedMap synchronize(Double2LongSortedMap local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static Double2LongSortedMap unmodifiable(Double2LongSortedMap local_m)
  {
    ...
    implements Double2LongSortedMap, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Double2LongSortedMap local_m)
    {
      super();
    ...
    implements Double2LongSortedMap, Serializable
  {
    ...
    protected SynchronizedSortedMap(Double2LongSortedMap local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Double2LongSortedMap local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Double2LongSortedMap, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Double2LongMaps.Singleton.SingletonEntry(this), Double2LongSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
