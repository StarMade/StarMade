...
/*   2:    */
/*  60:    */public class DoubleHeaps
/*  61:    */{
/*  62:    */  public static int downHeap(double[] heap, int size, int i, DoubleComparator c)
/*  63:    */  {
/*  64: 64 */    if (i >= size) throw new IllegalArgumentException("Heap position (" + i + ") is larger than or equal to heap size (" + size + ")");
/*  65: 65 */    double e = heap[i];
/*  66:    */    
...
/* 111:    */  }
/* 112:    */  
/* 117:    */  public static void makeHeap(double[] heap, int size, DoubleComparator c)
/* 118:    */  {
