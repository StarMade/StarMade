...
public abstract interface Double2ObjectSortedMap<V> extends Double2ObjectMap<V>, SortedMap<Double, V>
{
  ...
  public static abstract interface FastSortedEntrySet<V> extends ObjectSortedSet<Double2ObjectMap.Entry<V>>, Double2ObjectMap.FastEntrySet<V>
  {
