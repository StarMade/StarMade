  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2BooleanAVLTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2BooleanAVLTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2BooleanAVLTreeMap(Map<? extends Double, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2BooleanAVLTreeMap(SortedMap<Double, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2BooleanAVLTreeMap(Double2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2BooleanAVLTreeMap(Double2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2BooleanAVLTreeMap(double[] local_k, boolean[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2BooleanAVLTreeMap(double[] local_k, boolean[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Double2BooleanMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Double2BooleanAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2BooleanAVLTreeMap.EntryIterator(Double2BooleanAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator(Double2BooleanMap.Entry from)
        {
          return new Double2BooleanAVLTreeMap.EntryIterator(Double2BooleanAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2BooleanAVLTreeMap.Entry local_f = Double2BooleanAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2BooleanAVLTreeMap.Entry local_f = Double2BooleanAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2BooleanAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Double2BooleanAVLTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Double2BooleanMap.Entry> headSet(Double2BooleanMap.Entry local_to)
        {
          return Double2BooleanAVLTreeMap.this.headMap((Double)local_to.getKey()).double2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Double2BooleanMap.Entry> tailSet(Double2BooleanMap.Entry from)
        {
          return Double2BooleanAVLTreeMap.this.tailMap((Double)from.getKey()).double2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Double2BooleanAVLTreeMap.ValueIterator(Double2BooleanAVLTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Double2BooleanAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2BooleanAVLTreeMap local_c;
    try
    {
      local_c = (Double2BooleanAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2BooleanAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Double2BooleanAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2BooleanAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2BooleanMap.Entry> double2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator()
          {
            return new Double2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Double2BooleanAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2BooleanMap.Entry> iterator(Double2BooleanMap.Entry from)
          {
            return new Double2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Double2BooleanAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, Boolean> local_e = (Map.Entry)local_o;
            Double2BooleanAVLTreeMap.Entry local_f = Double2BooleanAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2BooleanAVLTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, Boolean> local_e = (Map.Entry)local_o;
            Double2BooleanAVLTreeMap.Entry local_f = Double2BooleanAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2BooleanAVLTreeMap.Submap.this.in7(local_f.key))) {
              Double2BooleanAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2BooleanAVLTreeMap.Submap.SubmapIterator(Double2BooleanAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2BooleanAVLTreeMap.Submap.this.clear();
          }
          
          public Double2BooleanMap.Entry first()
          {
            return Double2BooleanAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Double2BooleanMap.Entry last()
          {
            return Double2BooleanAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2BooleanMap.Entry> subSet(Double2BooleanMap.Entry from, Double2BooleanMap.Entry local_to)
          {
            return Double2BooleanAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Double2BooleanMap.Entry> headSet(Double2BooleanMap.Entry local_to)
          {
            return Double2BooleanAVLTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Double2BooleanMap.Entry> tailSet(Double2BooleanMap.Entry from)
          {
            return Double2BooleanAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Double2BooleanAVLTreeMap.Submap.SubmapValueIterator(Double2BooleanAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Double2BooleanAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2BooleanAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2BooleanAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2BooleanAVLTreeMap.Entry local_e;
      return (in7(local_kk)) && ((local_e = Double2BooleanAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(double local_k, boolean local_v)
    {
      ...
      boolean oldValue = Double2BooleanAVLTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(double local_k)
    {
      ...
      boolean oldValue = Double2BooleanAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2BooleanSortedMap tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2BooleanAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2BooleanAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2BooleanSortedMap subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2BooleanAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2BooleanAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2BooleanAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2BooleanAVLTreeMap.this.locateKey(this.from);
        if (Double2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2BooleanAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2BooleanAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2BooleanAVLTreeMap.this.locateKey(this.field_47);
        if (Double2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2BooleanAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2BooleanAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Double2BooleanAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Double2BooleanAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2BooleanAVLTreeMap.Submap.this.bottom) && (Double2BooleanAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2BooleanAVLTreeMap.Submap.this.top) && (Double2BooleanAVLTreeMap.this.compare(local_k, (this.prev = Double2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2BooleanAVLTreeMap.this.locateKey(local_k);
            if (Double2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2BooleanAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2BooleanAVLTreeMap.this.compare(this.prev.key, Double2BooleanAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2BooleanAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2BooleanAVLTreeMap.this.compare(this.next.key, Double2BooleanAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Double2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Double2BooleanAVLTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Double2BooleanAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2BooleanSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2BooleanAVLTreeMap.KeyIterator(Double2BooleanAVLTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2BooleanAVLTreeMap.KeyIterator(Double2BooleanAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2BooleanAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Double2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
