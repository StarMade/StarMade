...
public class Double2CharSortedMaps
{
  ...
  public static Double2CharSortedMap synchronize(Double2CharSortedMap local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static Double2CharSortedMap synchronize(Double2CharSortedMap local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static Double2CharSortedMap unmodifiable(Double2CharSortedMap local_m)
  {
    ...
    implements Double2CharSortedMap, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Double2CharSortedMap local_m)
    {
      super();
    ...
    implements Double2CharSortedMap, Serializable
  {
    ...
    protected SynchronizedSortedMap(Double2CharSortedMap local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Double2CharSortedMap local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Double2CharSortedMap, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Double2CharMaps.Singleton.SingletonEntry(this), Double2CharSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
