...
/*  15:    */
/*  59:    */public class Double2IntMaps
/*  60:    */{
/*  61:    */  public static class EmptyMap
/*  62:    */    extends Double2IntFunctions.EmptyFunction
/*  63:    */    implements Double2IntMap, Serializable, Cloneable
/*  64:    */  {
/*  65:    */    public static final long serialVersionUID = -7046029254386353129L;
/*  66:    */    
/*  67: 67 */    public boolean containsValue(int v) { return false; }
/*  68: 68 */    public void putAll(Map<? extends Double, ? extends Integer> m) { throw new UnsupportedOperationException(); }
/*  69:    */    
/*  70: 70 */    public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() { return ObjectSets.EMPTY_SET; }
/*  71:    */    
...
/*  76: 76 */    private Object readResolve() { return Double2IntMaps.EMPTY_MAP; }
/*  77: 77 */    public Object clone() { return Double2IntMaps.EMPTY_MAP; }
/*  78: 78 */    public boolean isEmpty() { return true; }
/*  79:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<Double, Integer>> entrySet() { return double2IntEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Double2IntFunctions.Singleton
/* 103:    */    implements Double2IntMap, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Double2IntMap.Entry> entries;
/* 108:    */    
/* 109:    */    protected volatile transient DoubleSet keys;
/* 110:    */    
/* 111:    */    protected volatile transient IntCollection values;
/* 112:    */    
/* 114:    */    protected Singleton(double key, int value)
/* 115:    */    {
/* 116:116 */      super(value);
/* 117:    */    }
/* 118:    */    
...
/* 122:    */    
/* 124:124 */    public void putAll(Map<? extends Double, ? extends Integer> m) { throw new UnsupportedOperationException(); }
/* 125:    */    
/* 126:126 */    public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Double2IntMap.Entry, Map.Entry<Double, Integer> { protected SingletonEntry() {}
/* 131:131 */      public Double getKey() { return Double.valueOf(Double2IntMaps.Singleton.this.key); }
/* 132:132 */      public Integer getValue() { return Integer.valueOf(Double2IntMaps.Singleton.this.value); }
/* 133:    */      
/* 134:    */      public double getDoubleKey() {
/* 135:135 */        return Double2IntMaps.Singleton.this.key;
/* 136:    */      }
/* 137:    */      
/* 139:139 */      public int getIntValue() { return Double2IntMaps.Singleton.this.value; }
...
/* 148:    */        
/* 149:149 */        return (Double2IntMaps.Singleton.this.key == ((Double)e.getKey()).doubleValue()) && (Double2IntMaps.Singleton.this.value == ((Integer)e.getValue()).intValue());
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return HashCommon.double2int(Double2IntMaps.Singleton.this.key) ^ Double2IntMaps.Singleton.this.value; }
/* 153:153 */      public String toString() { return Double2IntMaps.Singleton.this.key + "->" + Double2IntMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<Double, Integer>> entrySet() { return double2IntEntrySet(); }
/* 160:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static Double2IntMap singleton(double key, int value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static Double2IntMap singleton(Double key, Integer value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key.doubleValue(), value.intValue());
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap
/* 205:    */    extends Double2IntFunctions.SynchronizedFunction
/* 206:    */    implements Double2IntMap, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Double2IntMap map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Double2IntMap.Entry> entries;
/* 213:    */    
/* 214:    */    protected volatile transient DoubleSet keys;
/* 215:    */    protected volatile transient IntCollection values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Double2IntMap m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Double2IntMap m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 234:    */    
/* 235:235 */    public int put(double k, int v) { synchronized (this.sync) { return this.map.put(k, v);
/* 236:    */      } }
/* 237:    */    
/* 238:238 */    public void putAll(Map<? extends Double, ? extends Integer> m) { synchronized (this.sync) { this.map.putAll(m); } }
/* 239:    */    
/* 240:240 */    public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.double2IntEntrySet(), this.sync); return this.entries; }
...
/* 246:    */      } }
/* 247:    */    
/* 248:248 */    public Integer put(Double k, Integer v) { synchronized (this.sync) { return (Integer)this.map.put(k, v);
/* 249:    */      }
/* 250:    */    }
/* 251:    */    
/* 252:252 */    public int remove(double k) { synchronized (this.sync) { return this.map.remove(k); } }
/* 253:253 */    public int get(double k) { synchronized (this.sync) { return this.map.get(k); } }
...
/* 267:267 */    public ObjectSet<Map.Entry<Double, Integer>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); } }
/* 268:    */    
...
/* 273:    */  }
/* 274:    */  
/* 277:    */  public static Double2IntMap synchronize(Double2IntMap m)
/* 278:    */  {
/* 279:279 */    return new SynchronizedMap(m);
/* 280:    */  }
/* 281:    */  
/* 287:    */  public static Double2IntMap synchronize(Double2IntMap m, Object sync)
/* 288:    */  {
/* 289:289 */    return new SynchronizedMap(m, sync);
/* 290:    */  }
/* 291:    */  
/* 293:    */  public static class UnmodifiableMap
/* 294:    */    extends Double2IntFunctions.UnmodifiableFunction
/* 295:    */    implements Double2IntMap, Serializable
/* 296:    */  {
/* 297:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 298:    */    
/* 299:    */    protected final Double2IntMap map;
/* 300:    */    protected volatile transient ObjectSet<Double2IntMap.Entry> entries;
/* 301:    */    protected volatile transient DoubleSet keys;
/* 302:    */    protected volatile transient IntCollection values;
/* 303:    */    
/* 304:    */    protected UnmodifiableMap(Double2IntMap m)
/* 305:    */    {
/* 306:306 */      super();
/* 307:307 */      this.map = m;
/* 308:    */    }
...
/* 316:    */    
/* 317:317 */    public int put(double k, int v) { throw new UnsupportedOperationException(); }
/* 318:    */    
/* 320:320 */    public void putAll(Map<? extends Double, ? extends Integer> m) { throw new UnsupportedOperationException(); }
/* 321:    */    
/* 322:322 */    public ObjectSet<Double2IntMap.Entry> double2IntEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.double2IntEntrySet()); return this.entries; }
...
/* 328:    */    
/* 329:    */    public Integer put(Double k, Integer v) {
/* 330:330 */      throw new UnsupportedOperationException();
/* 331:    */    }
/* 332:    */    
/* 334:334 */    public int remove(double k) { throw new UnsupportedOperationException(); }
/* 335:335 */    public int get(double k) { return this.map.get(k); }
...
/* 349:349 */    public ObjectSet<Map.Entry<Double, Integer>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/* 350:    */  }
/* 351:    */  
/* 356:    */  public static Double2IntMap unmodifiable(Double2IntMap m)
/* 357:    */  {
