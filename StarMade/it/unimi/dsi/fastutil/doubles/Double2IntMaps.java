...
public class Double2IntMaps
{
  ...
  public static Double2IntMap synchronize(Double2IntMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Double2IntMap synchronize(Double2IntMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Double2IntMap unmodifiable(Double2IntMap local_m)
  {
    ...
    implements Double2IntMap, Serializable
  {
    ...
    protected UnmodifiableMap(Double2IntMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Double2IntMap, Serializable
  {
    ...
    protected SynchronizedMap(Double2IntMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Double2IntMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Double2IntMap, Serializable, Cloneable
  {
      ...
      implements Double2IntMap.Entry, Map.Entry<Double, Integer>
    {
      ...
      {
        return Double.valueOf(Double2IntMaps.Singleton.this.key);
      }
      
      public Integer getValue()
      {
        return Integer.valueOf(Double2IntMaps.Singleton.this.value);
      }
      
      public double getDoubleKey()
      {
        return Double2IntMaps.Singleton.this.key;
      }
      
      public int getIntValue()
      {
        return Double2IntMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Double2IntMaps.Singleton.this.key == ((Double)local_e.getKey()).doubleValue()) && (Double2IntMaps.Singleton.this.value == ((Integer)local_e.getValue()).intValue());
      }
      
      public int hashCode()
      {
        return HashCommon.double2int(Double2IntMaps.Singleton.this.key) ^ Double2IntMaps.Singleton.this.value;
      }
      
      public String toString()
      {
        return Double2IntMaps.Singleton.this.key + "->" + Double2IntMaps.Singleton.this.value;
      }
    }
  }
