...
/*      */ 
/*      */ public class Double2ShortRBTreeMap extends AbstractDouble2ShortSortedMap
...
/*  119 */           return Double2ShortRBTreeMap.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*      */         }
/*      */         public int compare(Double ok1, Double ok2) {
/*  122 */           return Double2ShortRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     short oldValue = put(ok.doubleValue(), ov.shortValue());
/*  731 */     return this.modified ? null : Short.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Short remove(Object ok)
/*      */   {
/*  737 */     short oldValue = remove(((Double)ok).doubleValue());
...
/* 1141 */         final Comparator<? super Double2ShortMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Double2ShortMap.Entry x, Double2ShortMap.Entry y) {
/* 1143 */             return Double2ShortRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Double2ShortRBTreeMap.EntryIterator(Double2ShortRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry from) {
/* 1153 */           return new Double2ShortRBTreeMap.EntryIterator(Double2ShortRBTreeMap.this, ((Double)from.getKey()).doubleValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Double2ShortRBTreeMap.Entry f = Double2ShortRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1166 */           Double2ShortRBTreeMap.Entry f = Double2ShortRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1167 */           if (f != null) Double2ShortRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Double2ShortRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Double2ShortRBTreeMap.this.clear(); } 
/* 1172 */         public Double2ShortMap.Entry first() { return Double2ShortRBTreeMap.this.firstEntry; } 
/* 1173 */         public Double2ShortMap.Entry last() { return Double2ShortRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry from, Double2ShortMap.Entry to) { return Double2ShortRBTreeMap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2ShortEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry to) { return Double2ShortRBTreeMap.this.headMap((Double)to.getKey()).double2ShortEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry from) { return Double2ShortRBTreeMap.this.tailMap((Double)from.getKey()).double2ShortEntrySet(); }
/*      */       };
...
/* 1242 */           return new Double2ShortRBTreeMap.ValueIterator(Double2ShortRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(short k) {
/* 1245 */           return Double2ShortRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Double2ShortRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Double2ShortRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Double2ShortRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readDouble(), s.readShort());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readDouble(), s.readShort());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readDouble(), s.readShort()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Double2ShortRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Double2ShortRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator() {
/* 1329 */             return new Double2ShortRBTreeMap.Submap.SubmapEntryIterator(Double2ShortRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry from) {
/* 1332 */             return new Double2ShortRBTreeMap.Submap.SubmapEntryIterator(Double2ShortRBTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
/*      */           }
/* 1334 */           public Comparator<? super Double2ShortMap.Entry> comparator() { return Double2ShortRBTreeMap.this.double2ShortEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Double2ShortRBTreeMap.Entry f = Double2ShortRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1340 */             return (f != null) && (Double2ShortRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Double2ShortRBTreeMap.Entry f = Double2ShortRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1347 */             if ((f != null) && (Double2ShortRBTreeMap.Submap.this.in(f.key))) Double2ShortRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Double2ShortRBTreeMap.Submap.SubmapIterator(Double2ShortRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Double2ShortRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Double2ShortMap.Entry first() { return Double2ShortRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Double2ShortMap.Entry last() { return Double2ShortRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry from, Double2ShortMap.Entry to) { return Double2ShortRBTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2ShortEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry to) { return Double2ShortRBTreeMap.Submap.this.headMap((Double)to.getKey()).double2ShortEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry from) { return Double2ShortRBTreeMap.Submap.this.tailMap((Double)from.getKey()).double2ShortEntrySet(); }
/*      */         };
...
/*      */           public ShortIterator iterator() {
/* 1376 */             return new Double2ShortRBTreeMap.Submap.SubmapValueIterator(Double2ShortRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(short k) {
/* 1379 */             return Double2ShortRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Double2ShortRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Double2ShortRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(double k) {
/* 1392 */       return (in(k)) && (Double2ShortRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(short v) {
...
/* 1407 */       return (in(kk)) && ((e = Double2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public short put(double k, short v) {
/* 1410 */       Double2ShortRBTreeMap.this.modified = false;
...
/* 1412 */       short oldValue = Double2ShortRBTreeMap.this.put(k, v);
/* 1413 */       return Double2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Short put(Double ok, Short ov) {
/* 1416 */       short oldValue = put(ok.doubleValue(), ov.shortValue());
/* 1417 */       return Double2ShortRBTreeMap.this.modified ? null : Short.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public short remove(double k) {
/* 1421 */       Double2ShortRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       short oldValue = Double2ShortRBTreeMap.this.remove(k);
/* 1424 */       return Double2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Short remove(Object ok) {
/* 1427 */       short oldValue = remove(((Double)ok).doubleValue());
/* 1428 */       return Double2ShortRBTreeMap.this.modified ? Short.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public DoubleComparator comparator() {
/* 1443 */       return Double2ShortRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Double2ShortSortedMap headMap(double to) {
/* 1446 */       if (this.top) return new Submap(Double2ShortRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Double2ShortRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Double2ShortRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Double2ShortSortedMap tailMap(double from) {
/* 1450 */       if (this.bottom) return new Submap(Double2ShortRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Double2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2ShortRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Double2ShortSortedMap subMap(double from, double to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Double2ShortRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Double2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Double2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Double2ShortRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Double2ShortRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Double2ShortRBTreeMap.this.tree == null) return null;
/* 1468 */       Double2ShortRBTreeMap.Entry e;
/*      */       Double2ShortRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Double2ShortRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Double2ShortRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Double2ShortRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Double2ShortRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Double2ShortRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Double2ShortRBTreeMap.this.tree == null) return null;
/* 1486 */       Double2ShortRBTreeMap.Entry e;
/*      */       Double2ShortRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Double2ShortRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Double2ShortRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Double2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Double2ShortRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public double firstDoubleKey() {
/* 1497 */       Double2ShortRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public double lastDoubleKey() {
/* 1502 */       Double2ShortRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Double firstKey() {
/* 1507 */       Double2ShortRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Double lastKey() {
/* 1512 */       Double2ShortRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Double2ShortRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Double2ShortRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Double2ShortRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Double2ShortMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Double2ShortRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(double k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Double2ShortRBTreeMap.Submap.this.bottom) && (Double2ShortRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Double2ShortRBTreeMap.Submap.this.top) && (Double2ShortRBTreeMap.this.compare(k, (this.prev = Double2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Double2ShortRBTreeMap.this.locateKey(k);
/* 1534 */             if (Double2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Double2ShortRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2ShortRBTreeMap.this.compare(this.prev.key, Double2ShortRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Double2ShortRBTreeMap.Submap.this.top) && (this.next != null) && (Double2ShortRBTreeMap.this.compare(this.next.key, Double2ShortRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public DoubleBidirectionalIterator iterator() { return new Double2ShortRBTreeMap.Submap.SubmapKeyIterator(Double2ShortRBTreeMap.Submap.this); } 
/* 1367 */       public DoubleBidirectionalIterator iterator(double from) { return new Double2ShortRBTreeMap.Submap.SubmapKeyIterator(Double2ShortRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2ShortRBTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public DoubleBidirectionalIterator iterator() { return new Double2ShortRBTreeMap.KeyIterator(Double2ShortRBTreeMap.this); } 
/* 1201 */     public DoubleBidirectionalIterator iterator(double from) { return new Double2ShortRBTreeMap.KeyIterator(Double2ShortRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2ShortRBTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2ShortRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Double2ShortMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Double2ShortMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Double2ShortRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(double k) {
/* 1067 */       if ((this.next = Double2ShortRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Double2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Double2ShortRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
