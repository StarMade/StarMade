  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2ShortRBTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2ShortRBTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2ShortRBTreeMap(Map<? extends Double, ? extends Short> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2ShortRBTreeMap(SortedMap<Double, Short> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2ShortRBTreeMap(Double2ShortMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2ShortRBTreeMap(Double2ShortSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2ShortRBTreeMap(double[] local_k, short[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2ShortRBTreeMap(double[] local_k, short[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Double2ShortMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Double2ShortRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2ShortRBTreeMap.EntryIterator(Double2ShortRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry from)
        {
          return new Double2ShortRBTreeMap.EntryIterator(Double2ShortRBTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2ShortRBTreeMap.Entry local_f = Double2ShortRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2ShortRBTreeMap.Entry local_f = Double2ShortRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2ShortRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Double2ShortRBTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2ShortEntrySet();
        }
        
        public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry local_to)
        {
          return Double2ShortRBTreeMap.this.headMap((Double)local_to.getKey()).double2ShortEntrySet();
        }
        
        public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry from)
        {
          return Double2ShortRBTreeMap.this.tailMap((Double)from.getKey()).double2ShortEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Double2ShortRBTreeMap.ValueIterator(Double2ShortRBTreeMap.this, null);
        }
        
        public boolean contains(short local_k)
        {
          return Double2ShortRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2ShortRBTreeMap local_c;
    try
    {
      local_c = (Double2ShortRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2ShortRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Double2ShortRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2ShortRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2ShortMap.Entry> double2ShortEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator()
          {
            return new Double2ShortRBTreeMap.Submap.SubmapEntryIterator(Double2ShortRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry from)
          {
            return new Double2ShortRBTreeMap.Submap.SubmapEntryIterator(Double2ShortRBTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, Short> local_e = (Map.Entry)local_o;
            Double2ShortRBTreeMap.Entry local_f = Double2ShortRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2ShortRBTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, Short> local_e = (Map.Entry)local_o;
            Double2ShortRBTreeMap.Entry local_f = Double2ShortRBTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2ShortRBTreeMap.Submap.this.in7(local_f.key))) {
              Double2ShortRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2ShortRBTreeMap.Submap.SubmapIterator(Double2ShortRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2ShortRBTreeMap.Submap.this.clear();
          }
          
          public Double2ShortMap.Entry first()
          {
            return Double2ShortRBTreeMap.Submap.this.firstEntry();
          }
          
          public Double2ShortMap.Entry last()
          {
            return Double2ShortRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry from, Double2ShortMap.Entry local_to)
          {
            return Double2ShortRBTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2ShortEntrySet();
          }
          
          public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry local_to)
          {
            return Double2ShortRBTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2ShortEntrySet();
          }
          
          public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry from)
          {
            return Double2ShortRBTreeMap.Submap.this.tailMap((Double)from.getKey()).double2ShortEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ShortCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractShortCollection()
        {
          public ShortIterator iterator()
          {
            return new Double2ShortRBTreeMap.Submap.SubmapValueIterator(Double2ShortRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(short local_k)
          {
            return Double2ShortRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2ShortRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2ShortRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2ShortRBTreeMap.Entry local_e;
      return (in7(local_kk)) && ((local_e = Double2ShortRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public short put(double local_k, short local_v)
    {
      ...
      short oldValue = Double2ShortRBTreeMap.this.put(local_k, local_v);
    ...
    public short remove(double local_k)
    {
      ...
      short oldValue = Double2ShortRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2ShortRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2ShortRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2ShortSortedMap tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2ShortRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2ShortRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2ShortSortedMap subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2ShortRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2ShortRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2ShortRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2ShortRBTreeMap.this.locateKey(this.from);
        if (Double2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2ShortRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2ShortRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2ShortRBTreeMap.this.locateKey(this.field_47);
        if (Double2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2ShortRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2ShortRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Double2ShortRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Double2ShortRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2ShortRBTreeMap.Submap.this.bottom) && (Double2ShortRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2ShortRBTreeMap.Submap.this.top) && (Double2ShortRBTreeMap.this.compare(local_k, (this.prev = Double2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2ShortRBTreeMap.this.locateKey(local_k);
            if (Double2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2ShortRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2ShortRBTreeMap.this.compare(this.prev.key, Double2ShortRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2ShortRBTreeMap.Submap.this.top) && (this.next != null) && (Double2ShortRBTreeMap.this.compare(this.next.key, Double2ShortRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2ShortSortedMap.KeySet
    {
      ...
      {
        return new Double2ShortRBTreeMap.Submap.SubmapKeyIterator(Double2ShortRBTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2ShortRBTreeMap.Submap.SubmapKeyIterator(Double2ShortRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2ShortSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2ShortRBTreeMap.KeyIterator(Double2ShortRBTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2ShortRBTreeMap.KeyIterator(Double2ShortRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2ShortRBTreeMap.this.locateKey(local_k)) != null) {
        if (Double2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
