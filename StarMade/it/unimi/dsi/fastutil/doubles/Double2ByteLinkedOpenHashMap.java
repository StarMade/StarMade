  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2ByteLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Double2ByteLinkedOpenHashMap(Map<? extends Double, ? extends Byte> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2ByteLinkedOpenHashMap(Map<? extends Double, ? extends Byte> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2ByteLinkedOpenHashMap(Double2ByteMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2ByteLinkedOpenHashMap(Double2ByteMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2ByteLinkedOpenHashMap(double[] local_k, byte[] local_v, float local_f)
  {
  ...
  public Double2ByteLinkedOpenHashMap(double[] local_k, byte[] local_v)
  {
  ...
  public byte getAndMoveToFirst(double local_k)
  {
    double[] key = this.key;
  ...
  public byte getAndMoveToLast(double local_k)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public byte putAndMoveToFirst(double local_k, byte local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public byte putAndMoveToLast(double local_k, byte local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Double2ByteLinkedOpenHashMap.ValueIterator(Double2ByteLinkedOpenHashMap.this);
        }
        ...
        {
          return Double2ByteLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2ByteLinkedOpenHashMap local_c;
    try
    {
      local_c = (Double2ByteLinkedOpenHashMap)super.clone();
    }
    ...
    implements ByteListIterator
  {
    ...
    {
      return Byte.valueOf(Double2ByteLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Byte next()
    {
      return Byte.valueOf(Double2ByteLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSortedSet
  {
    ...
    {
      return new Double2ByteLinkedOpenHashMap.KeyIterator(Double2ByteLinkedOpenHashMap.this, from);
    }
    
    public DoubleListIterator iterator()
    {
      return new Double2ByteLinkedOpenHashMap.KeyIterator(Double2ByteLinkedOpenHashMap.this);
    }
    ...
    {
      return Double2ByteLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2ByteLinkedOpenHashMap.this.size;
      Double2ByteLinkedOpenHashMap.this.remove(local_k);
    ...
    implements DoubleListIterator
  {
    ...
    {
      return Double.valueOf(Double2ByteLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Double next()
    {
      return Double.valueOf(Double2ByteLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2ByteSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Double2ByteLinkedOpenHashMap.EntryIterator(Double2ByteLinkedOpenHashMap.this);
    }
    ...
    public Double2ByteMap.Entry first()
    {
      ...
      return new Double2ByteLinkedOpenHashMap.MapEntry(Double2ByteLinkedOpenHashMap.this, Double2ByteLinkedOpenHashMap.this.first);
    }
    ...
    public Double2ByteMap.Entry last()
    {
      ...
      return new Double2ByteLinkedOpenHashMap.MapEntry(Double2ByteLinkedOpenHashMap.this, Double2ByteLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2ByteLinkedOpenHashMap.this.mask; Double2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ByteLinkedOpenHashMap.this.mask) {
        if (Double2ByteLinkedOpenHashMap.this.key[pos] == local_k) {
          return Double2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2ByteLinkedOpenHashMap.this.mask; Double2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ByteLinkedOpenHashMap.this.mask) {
        if (Double2ByteLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Double2ByteLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Double2ByteLinkedOpenHashMap.EntryIterator(Double2ByteLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
    
    public ObjectBidirectionalIterator<Double2ByteMap.Entry> fastIterator()
    {
      return new Double2ByteLinkedOpenHashMap.FastEntryIterator(Double2ByteLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Double2ByteMap.Entry> fastIterator(Double2ByteMap.Entry from)
    {
      return new Double2ByteLinkedOpenHashMap.FastEntryIterator(Double2ByteLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
  }
    ...
    implements ObjectListIterator<Double2ByteMap.Entry>
  {
    ...
    public AbstractDouble2ByteMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2ByteLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Double2ByteLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Double2ByteMap.Entry>
  {
    ...
    {
      return this.entry = new Double2ByteLinkedOpenHashMap.MapEntry(Double2ByteLinkedOpenHashMap.this, nextEntry());
    }
    
    public Double2ByteLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Double2ByteLinkedOpenHashMap.MapEntry(Double2ByteLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(double from)
    {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2ByteLinkedOpenHashMap.this.mask; Double2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ByteLinkedOpenHashMap.this.mask) {
          if (Double2ByteLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Double2ByteLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Double2ByteLinkedOpenHashMap.this.first = this.next;
      } else {
        Double2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Double2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Double2ByteLinkedOpenHashMap.this.last = this.prev;
      } else {
        Double2ByteLinkedOpenHashMap.this.link[this.next] ^= (Double2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2ByteLinkedOpenHashMap.this.mask; Double2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ByteLinkedOpenHashMap.this.mask)
        {
        ...
        if (Double2ByteLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Double2ByteMap.Entry, Map.Entry<Double, Byte>
  {
    ...
    public byte setValue(byte local_v)
    {
      ...
      Double2ByteLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Byte> local_e = (Map.Entry)local_o;
      return (Double2ByteLinkedOpenHashMap.this.key[this.index] == ((Double)local_e.getKey()).doubleValue()) && (Double2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
