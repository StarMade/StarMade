...
/*   22:     */
/*  113:     */public class Double2ByteLinkedOpenHashMap
/*  114:     */  extends AbstractDouble2ByteSortedMap
...
/*  127:     */  protected volatile transient Double2ByteSortedMap.FastSortedEntrySet entries;
...
/*  141:     */  
/*  149:     */  public Double2ByteLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Double2ByteLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Double2ByteLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Double2ByteLinkedOpenHashMap(Map<? extends Double, ? extends Byte> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Double2ByteLinkedOpenHashMap(Map<? extends Double, ? extends Byte> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Double2ByteLinkedOpenHashMap(Double2ByteMap m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Double2ByteLinkedOpenHashMap(Double2ByteMap m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Double2ByteLinkedOpenHashMap(double[] k, byte[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Double2ByteLinkedOpenHashMap(double[] k, byte[] v)
/*  225:     */  {
/*  226: 226 */    this(k, v, 0.75F);
/*  227:     */  }
/*  228:     */  
/*  232:     */  public byte put(double k, byte v)
/*  233:     */  {
...
/*  260:     */  }
/*  261:     */  
/*  262: 262 */  public Byte put(Double ok, Byte ov) { byte v = ov.byteValue();
...
/*  291:     */  }
/*  292:     */  
/*  303:     */  public byte add(double k, byte incr)
/*  304:     */  {
...
/*  310: 310 */          tmp52_50 = pos; byte[] tmp52_47 = this.value;tmp52_47[tmp52_50] = ((byte)(tmp52_47[tmp52_50] + incr));
...
/*  355:     */  }
/*  356:     */  
/*  357:     */  public byte remove(double k)
/*  358:     */  {
...
/*  462:     */  }
/*  463:     */  
/*  467:     */  public byte getAndMoveToFirst(double k)
/*  468:     */  {
...
/*  483:     */  }
/*  484:     */  
/*  488:     */  public byte getAndMoveToLast(double k)
/*  489:     */  {
...
/*  504:     */  }
/*  505:     */  
/*  510:     */  public byte putAndMoveToFirst(double k, byte v)
/*  511:     */  {
...
/*  543:     */  }
/*  544:     */  
/*  549:     */  public byte putAndMoveToLast(double k, byte v)
/*  550:     */  {
...
/*  582:     */  }
/*  583:     */  
/*  584: 584 */  public Byte get(Double ok) { double k = ok.doubleValue();
/*  585:     */    
...
/*  660:     */    implements Double2ByteMap.Entry, Map.Entry<Double, Byte>
/*  661:     */  {
...
/*  667:     */    }
/*  668:     */    
/*  669: 669 */    public Double getKey() { return Double.valueOf(Double2ByteLinkedOpenHashMap.this.key[this.index]); }
/*  670:     */    
/*  671:     */    public double getDoubleKey() {
/*  672: 672 */      return Double2ByteLinkedOpenHashMap.this.key[this.index];
/*  673:     */    }
/*  674:     */    
/*  675: 675 */    public Byte getValue() { return Byte.valueOf(Double2ByteLinkedOpenHashMap.this.value[this.index]); }
/*  676:     */    
/*  678: 678 */    public byte getByteValue() { return Double2ByteLinkedOpenHashMap.this.value[this.index]; }
/*  679:     */    
/*  680:     */    public byte setValue(byte v) {
/*  681: 681 */      byte oldValue = Double2ByteLinkedOpenHashMap.this.value[this.index];
/*  682: 682 */      Double2ByteLinkedOpenHashMap.this.value[this.index] = v;
...
/*  691: 691 */      Map.Entry<Double, Byte> e = (Map.Entry)o;
/*  692: 692 */      return (Double2ByteLinkedOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*  693:     */    }
/*  694:     */    
/*  695: 695 */    public int hashCode() { return HashCommon.double2int(Double2ByteLinkedOpenHashMap.this.key[this.index]) ^ Double2ByteLinkedOpenHashMap.this.value[this.index]; }
/*  696:     */    
/*  697:     */    public String toString() {
/*  698: 698 */      return Double2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Double2ByteLinkedOpenHashMap.this.value[this.index];
/*  699:     */    }
/*  700:     */  }
/*  701:     */  
...
/*  786: 786 */  public Double2ByteSortedMap tailMap(double from) { throw new UnsupportedOperationException(); }
/*  787: 787 */  public Double2ByteSortedMap headMap(double to) { throw new UnsupportedOperationException(); }
/*  788: 788 */  public Double2ByteSortedMap subMap(double from, double to) { throw new UnsupportedOperationException(); }
/*  789:     */  
...
/*  803: 803 */    int index = -1;
/*  804:     */    
/*  805: 805 */    private MapIterator() { this.next = Double2ByteLinkedOpenHashMap.this.first;
/*  806: 806 */      this.index = 0;
/*  807:     */    }
/*  808:     */    
/*  809: 809 */    private MapIterator(double from) { if (Double2ByteLinkedOpenHashMap.this.key[Double2ByteLinkedOpenHashMap.this.last] == from) {
/*  810: 810 */        this.prev = Double2ByteLinkedOpenHashMap.this.last;
/*  811: 811 */        this.index = Double2ByteLinkedOpenHashMap.this.size;
/*  812:     */      }
/*  813:     */      else
/*  814:     */      {
/*  815: 815 */        int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2ByteLinkedOpenHashMap.this.mask;
/*  816:     */        
/*  817: 817 */        while (Double2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  818: 818 */          if (Double2ByteLinkedOpenHashMap.this.key[pos] == from)
/*  819:     */          {
/*  820: 820 */            this.next = ((int)Double2ByteLinkedOpenHashMap.this.link[pos]);
/*  821: 821 */            this.prev = pos;
/*  822: 822 */            return;
/*  823:     */          }
/*  824: 824 */          pos = pos + 1 & Double2ByteLinkedOpenHashMap.this.mask;
/*  825:     */        }
...
/*  838: 838 */        this.index = Double2ByteLinkedOpenHashMap.this.size;
/*  839: 839 */        return;
/*  840:     */      }
/*  841: 841 */      int pos = Double2ByteLinkedOpenHashMap.this.first;
/*  842: 842 */      this.index = 1;
/*  843: 843 */      while (pos != this.prev) {
/*  844: 844 */        pos = (int)Double2ByteLinkedOpenHashMap.this.link[pos];
...
/*  855:     */    }
/*  856:     */    
/*  857: 857 */    public int nextEntry() { if (!hasNext()) return Double2ByteLinkedOpenHashMap.this.size();
/*  858: 858 */      this.curr = this.next;
/*  859: 859 */      this.next = ((int)Double2ByteLinkedOpenHashMap.this.link[this.curr]);
...
/*  867: 867 */      this.prev = ((int)(Double2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  880: 880 */        this.prev = ((int)(Double2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  881:     */      }
/*  882:     */      else {
/*  883: 883 */        this.next = ((int)Double2ByteLinkedOpenHashMap.this.link[this.curr]); }
/*  884: 884 */      Double2ByteLinkedOpenHashMap.this.size -= 1;
/*  885:     */      
/*  887: 887 */      if (this.prev == -1) { Double2ByteLinkedOpenHashMap.this.first = this.next;
/*  888:     */      } else
/*  889: 889 */        Double2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Double2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890: 890 */      if (this.next == -1) { Double2ByteLinkedOpenHashMap.this.last = this.prev;
/*  891:     */      } else
/*  892: 892 */        Double2ByteLinkedOpenHashMap.this.link[this.next] ^= (Double2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  893: 893 */      int pos = this.curr;
/*  894:     */      int last;
/*  895:     */      for (;;) {
/*  896: 896 */        pos = (last = pos) + 1 & Double2ByteLinkedOpenHashMap.this.mask;
/*  897: 897 */        while (Double2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  898: 898 */          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2ByteLinkedOpenHashMap.this.key[pos])) & Double2ByteLinkedOpenHashMap.this.mask;
/*  899: 899 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900: 900 */          pos = pos + 1 & Double2ByteLinkedOpenHashMap.this.mask;
/*  901:     */        }
/*  902: 902 */        if (Double2ByteLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903: 903 */        Double2ByteLinkedOpenHashMap.this.key[last] = Double2ByteLinkedOpenHashMap.this.key[pos];
/*  904: 904 */        Double2ByteLinkedOpenHashMap.this.value[last] = Double2ByteLinkedOpenHashMap.this.value[pos];
/*  905: 905 */        if (this.next == pos) this.next = last;
/*  906: 906 */        if (this.prev == pos) this.prev = last;
/*  907: 907 */        Double2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*  908:     */      }
/*  909: 909 */      Double2ByteLinkedOpenHashMap.this.used[last] = false;
/*  910: 910 */      this.curr = -1;
/*  911:     */    }
/*  912:     */    
...
/*  921:     */    } }
/*  922:     */  
/*  923:     */  private class EntryIterator extends Double2ByteLinkedOpenHashMap.MapIterator implements ObjectListIterator<Double2ByteMap.Entry> { private Double2ByteLinkedOpenHashMap.MapEntry entry;
/*  924:     */    
/*  925: 925 */    public EntryIterator() { super(null); }
/*  926:     */    
/*  927: 927 */    public EntryIterator(double from) { super(from, null); }
/*  928:     */    
/*  929:     */    public Double2ByteLinkedOpenHashMap.MapEntry next() {
/*  930: 930 */      return this.entry = new Double2ByteLinkedOpenHashMap.MapEntry(Double2ByteLinkedOpenHashMap.this, nextEntry());
/*  931:     */    }
/*  932:     */    
/*  933: 933 */    public Double2ByteLinkedOpenHashMap.MapEntry previous() { return this.entry = new Double2ByteLinkedOpenHashMap.MapEntry(Double2ByteLinkedOpenHashMap.this, previousEntry()); }
/*  934:     */    
/*  935:     */    public void remove()
/*  936:     */    {
/*  937: 937 */      super.remove();
/*  938: 938 */      Double2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  939:     */    
/*  940: 940 */    public void set(Double2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  941: 941 */    public void add(Double2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  942:     */  }
/*  943:     */  
/*  944: 944 */  private class FastEntryIterator extends Double2ByteLinkedOpenHashMap.MapIterator implements ObjectListIterator<Double2ByteMap.Entry> { final AbstractDouble2ByteMap.BasicEntry entry = new AbstractDouble2ByteMap.BasicEntry(0.0D, (byte)0);
/*  945: 945 */    public FastEntryIterator() { super(null); }
/*  946:     */    
/*  947: 947 */    public FastEntryIterator(double from) { super(from, null); }
/*  948:     */    
/*  949:     */    public AbstractDouble2ByteMap.BasicEntry next() {
/*  950: 950 */      int e = nextEntry();
/*  951: 951 */      this.entry.key = Double2ByteLinkedOpenHashMap.this.key[e];
/*  952: 952 */      this.entry.value = Double2ByteLinkedOpenHashMap.this.value[e];
/*  953: 953 */      return this.entry;
/*  954:     */    }
/*  955:     */    
/*  956: 956 */    public AbstractDouble2ByteMap.BasicEntry previous() { int e = previousEntry();
/*  957: 957 */      this.entry.key = Double2ByteLinkedOpenHashMap.this.key[e];
/*  958: 958 */      this.entry.value = Double2ByteLinkedOpenHashMap.this.value[e];
/*  959: 959 */      return this.entry; }
/*  960:     */    
/*  961: 961 */    public void set(Double2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  962: 962 */    public void add(Double2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } }
/*  963:     */  
/*  964:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Double2ByteMap.Entry> implements Double2ByteSortedMap.FastSortedEntrySet { private MapEntrySet() {}
/*  965:     */    
/*  966: 966 */    public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator() { return new Double2ByteLinkedOpenHashMap.EntryIterator(Double2ByteLinkedOpenHashMap.this); }
/*  967:     */    
/*  968: 968 */    public Comparator<? super Double2ByteMap.Entry> comparator() { return null; }
/*  969: 969 */    public ObjectSortedSet<Double2ByteMap.Entry> subSet(Double2ByteMap.Entry fromElement, Double2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  970: 970 */    public ObjectSortedSet<Double2ByteMap.Entry> headSet(Double2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  971: 971 */    public ObjectSortedSet<Double2ByteMap.Entry> tailSet(Double2ByteMap.Entry fromElement) { throw new UnsupportedOperationException(); }
/*  972:     */    
/*  973: 973 */    public Double2ByteMap.Entry first() { if (Double2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974: 974 */      return new Double2ByteLinkedOpenHashMap.MapEntry(Double2ByteLinkedOpenHashMap.this, Double2ByteLinkedOpenHashMap.this.first);
/*  975:     */    }
/*  976:     */    
/*  977: 977 */    public Double2ByteMap.Entry last() { if (Double2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978: 978 */      return new Double2ByteLinkedOpenHashMap.MapEntry(Double2ByteLinkedOpenHashMap.this, Double2ByteLinkedOpenHashMap.this.last);
/*  979:     */    }
/*  980:     */    
/*  981:     */    public boolean contains(Object o) {
/*  982: 982 */      if (!(o instanceof Map.Entry)) return false;
/*  983: 983 */      Map.Entry<Double, Byte> e = (Map.Entry)o;
/*  984: 984 */      double k = ((Double)e.getKey()).doubleValue();
/*  985:     */      
/*  986: 986 */      int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ByteLinkedOpenHashMap.this.mask;
/*  987:     */      
/*  988: 988 */      while (Double2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  989: 989 */        if (Double2ByteLinkedOpenHashMap.this.key[pos] == k) return Double2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/*  990: 990 */        pos = pos + 1 & Double2ByteLinkedOpenHashMap.this.mask;
/*  991:     */      }
...
/*  997: 997 */      Map.Entry<Double, Byte> e = (Map.Entry)o;
/*  998: 998 */      double k = ((Double)e.getKey()).doubleValue();
/*  999:     */      
/* 1000:1000 */      int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ByteLinkedOpenHashMap.this.mask;
/* 1001:     */      
/* 1002:1002 */      while (Double2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003:1003 */        if (Double2ByteLinkedOpenHashMap.this.key[pos] == k) {
/* 1004:1004 */          Double2ByteLinkedOpenHashMap.this.remove(e.getKey());
/* 1005:1005 */          return true;
/* 1006:     */        }
/* 1007:1007 */        pos = pos + 1 & Double2ByteLinkedOpenHashMap.this.mask;
/* 1008:     */      }
/* 1009:1009 */      return false;
/* 1010:     */    }
/* 1011:     */    
/* 1012:1012 */    public int size() { return Double2ByteLinkedOpenHashMap.this.size; }
/* 1013:     */    
/* 1014:     */    public void clear() {
/* 1015:1015 */      Double2ByteLinkedOpenHashMap.this.clear();
/* 1016:     */    }
/* 1017:     */    
/* 1018:1018 */    public ObjectBidirectionalIterator<Double2ByteMap.Entry> iterator(Double2ByteMap.Entry from) { return new Double2ByteLinkedOpenHashMap.EntryIterator(Double2ByteLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue()); }
/* 1019:     */    
/* 1020:     */    public ObjectBidirectionalIterator<Double2ByteMap.Entry> fastIterator() {
/* 1021:1021 */      return new Double2ByteLinkedOpenHashMap.FastEntryIterator(Double2ByteLinkedOpenHashMap.this);
/* 1022:     */    }
/* 1023:     */    
/* 1024:1024 */    public ObjectBidirectionalIterator<Double2ByteMap.Entry> fastIterator(Double2ByteMap.Entry from) { return new Double2ByteLinkedOpenHashMap.FastEntryIterator(Double2ByteLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue()); }
/* 1025:     */  }
/* 1026:     */  
/* 1027:     */  public Double2ByteSortedMap.FastSortedEntrySet double2ByteEntrySet() {
...
/* 1035:     */    extends Double2ByteLinkedOpenHashMap.MapIterator
/* 1036:     */    implements DoubleListIterator
/* 1037:     */  {
/* 1038:1038 */    public KeyIterator(double k) { super(k, null); }
/* 1039:1039 */    public double previousDouble() { return Double2ByteLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1042:1042 */    public Double previous() { return Double.valueOf(Double2ByteLinkedOpenHashMap.this.key[previousEntry()]); }
...
/* 1046:1046 */    public double nextDouble() { return Double2ByteLinkedOpenHashMap.this.key[nextEntry()]; }
/* 1047:1047 */    public Double next() { return Double.valueOf(Double2ByteLinkedOpenHashMap.this.key[nextEntry()]); } }
/* 1048:     */  
/* 1049:     */  private final class KeySet extends AbstractDoubleSortedSet { private KeySet() {}
/* 1050:     */    
/* 1051:1051 */    public DoubleListIterator iterator(double from) { return new Double2ByteLinkedOpenHashMap.KeyIterator(Double2ByteLinkedOpenHashMap.this, from); }
/* 1052:     */    
/* 1053:     */    public DoubleListIterator iterator() {
/* 1054:1054 */      return new Double2ByteLinkedOpenHashMap.KeyIterator(Double2ByteLinkedOpenHashMap.this);
/* 1055:     */    }
/* 1056:     */    
/* 1057:1057 */    public int size() { return Double2ByteLinkedOpenHashMap.this.size; }
/* 1058:     */    
/* 1060:1060 */    public boolean contains(double k) { return Double2ByteLinkedOpenHashMap.this.containsKey(k); }
/* 1061:     */    
/* 1062:     */    public boolean remove(double k) {
/* 1063:1063 */      int oldSize = Double2ByteLinkedOpenHashMap.this.size;
/* 1064:1064 */      Double2ByteLinkedOpenHashMap.this.remove(k);
/* 1065:1065 */      return Double2ByteLinkedOpenHashMap.this.size != oldSize;
/* 1066:     */    }
/* 1067:     */    
/* 1068:1068 */    public void clear() { Double2ByteLinkedOpenHashMap.this.clear(); }
/* 1069:     */    
/* 1070:     */    public double firstDouble() {
/* 1071:1071 */      if (Double2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072:1072 */      return Double2ByteLinkedOpenHashMap.this.key[Double2ByteLinkedOpenHashMap.this.first];
/* 1073:     */    }
/* 1074:     */    
/* 1075:1075 */    public double lastDouble() { if (Double2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076:1076 */      return Double2ByteLinkedOpenHashMap.this.key[Double2ByteLinkedOpenHashMap.this.last]; }
/* 1077:     */    
...
/* 1091:     */    extends Double2ByteLinkedOpenHashMap.MapIterator
/* 1092:     */    implements ByteListIterator
/* 1093:     */  {
/* 1094:1094 */    public byte previousByte() { return Double2ByteLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1095:1095 */    public Byte previous() { return Byte.valueOf(Double2ByteLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1101:1101 */    public byte nextByte() { return Double2ByteLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1102:1102 */    public Byte next() { return Byte.valueOf(Double2ByteLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1103:     */  }
/* 1104:     */  
...
/* 1107:1107 */          return new Double2ByteLinkedOpenHashMap.ValueIterator(Double2ByteLinkedOpenHashMap.this);
/* 1108:     */        }
/* 1109:     */        
/* 1110:1110 */        public int size() { return Double2ByteLinkedOpenHashMap.this.size; }
/* 1111:     */        
/* 1112:     */        public boolean contains(byte v) {
/* 1113:1113 */          return Double2ByteLinkedOpenHashMap.this.containsValue(v);
/* 1114:     */        }
/* 1115:     */        
/* 1116:1116 */        public void clear() { Double2ByteLinkedOpenHashMap.this.clear(); }
/* 1117:     */      };
/* 1118:     */    }
...
/* 1238:     */  }
/* 1239:     */  
/* 1242:     */  public Double2ByteLinkedOpenHashMap clone()
/* 1243:     */  {
/* 1244:     */    Double2ByteLinkedOpenHashMap c;
/* 1245:     */    
/* 1247:     */    try
/* 1248:     */    {
/* 1249:1249 */      c = (Double2ByteLinkedOpenHashMap)super.clone();
/* 1250:     */    }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.doubles.Double2ByteLinkedOpenHashMap
