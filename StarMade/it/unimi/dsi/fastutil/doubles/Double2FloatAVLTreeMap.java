  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2FloatAVLTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2FloatAVLTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2FloatAVLTreeMap(Map<? extends Double, ? extends Float> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2FloatAVLTreeMap(SortedMap<Double, Float> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2FloatAVLTreeMap(Double2FloatMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2FloatAVLTreeMap(Double2FloatSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2FloatAVLTreeMap(double[] local_k, float[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2FloatAVLTreeMap(double[] local_k, float[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Double2FloatMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Double2FloatAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2FloatAVLTreeMap.EntryIterator(Double2FloatAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2FloatMap.Entry> iterator(Double2FloatMap.Entry from)
        {
          return new Double2FloatAVLTreeMap.EntryIterator(Double2FloatAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2FloatAVLTreeMap.Entry local_f = Double2FloatAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2FloatAVLTreeMap.Entry local_f = Double2FloatAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2FloatAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Double2FloatAVLTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2FloatEntrySet();
        }
        
        public ObjectSortedSet<Double2FloatMap.Entry> headSet(Double2FloatMap.Entry local_to)
        {
          return Double2FloatAVLTreeMap.this.headMap((Double)local_to.getKey()).double2FloatEntrySet();
        }
        
        public ObjectSortedSet<Double2FloatMap.Entry> tailSet(Double2FloatMap.Entry from)
        {
          return Double2FloatAVLTreeMap.this.tailMap((Double)from.getKey()).double2FloatEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Double2FloatAVLTreeMap.ValueIterator(Double2FloatAVLTreeMap.this, null);
        }
        
        public boolean contains(float local_k)
        {
          return Double2FloatAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2FloatAVLTreeMap local_c;
    try
    {
      local_c = (Double2FloatAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2FloatAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Double2FloatAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2FloatAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2FloatMap.Entry> double2FloatEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2FloatMap.Entry> iterator()
          {
            return new Double2FloatAVLTreeMap.Submap.SubmapEntryIterator(Double2FloatAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2FloatMap.Entry> iterator(Double2FloatMap.Entry from)
          {
            return new Double2FloatAVLTreeMap.Submap.SubmapEntryIterator(Double2FloatAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, Float> local_e = (Map.Entry)local_o;
            Double2FloatAVLTreeMap.Entry local_f = Double2FloatAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2FloatAVLTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, Float> local_e = (Map.Entry)local_o;
            Double2FloatAVLTreeMap.Entry local_f = Double2FloatAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2FloatAVLTreeMap.Submap.this.in7(local_f.key))) {
              Double2FloatAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2FloatAVLTreeMap.Submap.SubmapIterator(Double2FloatAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2FloatAVLTreeMap.Submap.this.clear();
          }
          
          public Double2FloatMap.Entry first()
          {
            return Double2FloatAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Double2FloatMap.Entry last()
          {
            return Double2FloatAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2FloatMap.Entry> subSet(Double2FloatMap.Entry from, Double2FloatMap.Entry local_to)
          {
            return Double2FloatAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2FloatEntrySet();
          }
          
          public ObjectSortedSet<Double2FloatMap.Entry> headSet(Double2FloatMap.Entry local_to)
          {
            return Double2FloatAVLTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2FloatEntrySet();
          }
          
          public ObjectSortedSet<Double2FloatMap.Entry> tailSet(Double2FloatMap.Entry from)
          {
            return Double2FloatAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2FloatEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public FloatCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractFloatCollection()
        {
          public FloatIterator iterator()
          {
            return new Double2FloatAVLTreeMap.Submap.SubmapValueIterator(Double2FloatAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(float local_k)
          {
            return Double2FloatAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2FloatAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2FloatAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2FloatAVLTreeMap.Entry local_e;
      return (in7(local_kk)) && ((local_e = Double2FloatAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public float put(double local_k, float local_v)
    {
      ...
      float oldValue = Double2FloatAVLTreeMap.this.put(local_k, local_v);
    ...
    public float remove(double local_k)
    {
      ...
      float oldValue = Double2FloatAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2FloatAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2FloatAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2FloatAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2FloatSortedMap tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2FloatAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2FloatAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2FloatSortedMap subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2FloatAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2FloatAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2FloatAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2FloatAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2FloatAVLTreeMap.this.locateKey(this.from);
        if (Double2FloatAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2FloatAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2FloatAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2FloatAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2FloatAVLTreeMap.this.locateKey(this.field_47);
        if (Double2FloatAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2FloatAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2FloatAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2FloatAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Double2FloatAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Double2FloatAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2FloatAVLTreeMap.Submap.this.bottom) && (Double2FloatAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2FloatAVLTreeMap.Submap.this.top) && (Double2FloatAVLTreeMap.this.compare(local_k, (this.prev = Double2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2FloatAVLTreeMap.this.locateKey(local_k);
            if (Double2FloatAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2FloatAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2FloatAVLTreeMap.this.compare(this.prev.key, Double2FloatAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2FloatAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2FloatAVLTreeMap.this.compare(this.next.key, Double2FloatAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2FloatSortedMap.KeySet
    {
      ...
      {
        return new Double2FloatAVLTreeMap.Submap.SubmapKeyIterator(Double2FloatAVLTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2FloatAVLTreeMap.Submap.SubmapKeyIterator(Double2FloatAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2FloatSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2FloatAVLTreeMap.KeyIterator(Double2FloatAVLTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2FloatAVLTreeMap.KeyIterator(Double2FloatAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2FloatAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Double2FloatAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
