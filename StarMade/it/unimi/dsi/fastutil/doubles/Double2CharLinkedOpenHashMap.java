...
/*  746 */   public Double2CharSortedMap tailMap(double from) { throw new UnsupportedOperationException(); } 
/*  747 */   public Double2CharSortedMap headMap(double to) { throw new UnsupportedOperationException(); } 
/*  748 */   public Double2CharSortedMap subMap(double from, double to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1067 */           return new Double2CharLinkedOpenHashMap.ValueIterator(Double2CharLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1070 */           return Double2CharLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(char v) {
/* 1073 */           return Double2CharLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1076 */           Double2CharLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1209 */       c = (Double2CharLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2CharLinkedOpenHashMap.MapIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public char previousChar()
/*      */     {
/* 1054 */       return Double2CharLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1055 */     public Character previous() { return Character.valueOf(Double2CharLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1061 */     public char nextChar() { return Double2CharLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1062 */     public Character next() { return Character.valueOf(Double2CharLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1011 */       return new Double2CharLinkedOpenHashMap.KeyIterator(Double2CharLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public DoubleListIterator iterator() {
/* 1014 */       return new Double2CharLinkedOpenHashMap.KeyIterator(Double2CharLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1017 */       return Double2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(double k) {
/* 1020 */       return Double2CharLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(double k) {
/* 1023 */       int oldSize = Double2CharLinkedOpenHashMap.this.size;
/* 1024 */       Double2CharLinkedOpenHashMap.this.remove(k);
/* 1025 */       return Double2CharLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1028 */       Double2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public double firstDouble() {
/* 1031 */       if (Double2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1032 */       return Double2CharLinkedOpenHashMap.this.key[Double2CharLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public double lastDouble() {
/* 1035 */       if (Double2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1036 */       return Double2CharLinkedOpenHashMap.this.key[Double2CharLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2CharLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator(double k)
/*      */     {
/*  998 */       super(k, null); } 
/*  999 */     public double previousDouble() { return Double2CharLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1002 */     public Double previous() { return Double.valueOf(Double2CharLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1006 */     public double nextDouble() { return Double2CharLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1007 */     public Double next() { return Double.valueOf(Double2CharLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  926 */       return new Double2CharLinkedOpenHashMap.EntryIterator(Double2CharLinkedOpenHashMap.this);
/*      */     }
/*  928 */     public Comparator<? super Double2CharMap.Entry> comparator() { return null; } 
/*  929 */     public ObjectSortedSet<Double2CharMap.Entry> subSet(Double2CharMap.Entry fromElement, Double2CharMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  930 */     public ObjectSortedSet<Double2CharMap.Entry> headSet(Double2CharMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  931 */     public ObjectSortedSet<Double2CharMap.Entry> tailSet(Double2CharMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Double2CharMap.Entry first() {
/*  933 */       if (Double2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  934 */       return new Double2CharLinkedOpenHashMap.MapEntry(Double2CharLinkedOpenHashMap.this, Double2CharLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Double2CharMap.Entry last() {
/*  937 */       if (Double2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  938 */       return new Double2CharLinkedOpenHashMap.MapEntry(Double2CharLinkedOpenHashMap.this, Double2CharLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  946 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2CharLinkedOpenHashMap.this.mask;
/*      */ 
/*  948 */       while (Double2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  949 */         if (Double2CharLinkedOpenHashMap.this.key[pos] == k) return Double2CharLinkedOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/*  950 */         pos = pos + 1 & Double2CharLinkedOpenHashMap.this.mask;
/*      */       }
/*  952 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  960 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2CharLinkedOpenHashMap.this.mask;
/*      */ 
/*  962 */       while (Double2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  963 */         if (Double2CharLinkedOpenHashMap.this.key[pos] == k) {
/*  964 */           Double2CharLinkedOpenHashMap.this.remove(e.getKey());
/*  965 */           return true;
/*      */         }
/*  967 */         pos = pos + 1 & Double2CharLinkedOpenHashMap.this.mask;
/*      */       }
/*  969 */       return false;
/*      */     }
/*      */     public int size() {
/*  972 */       return Double2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  975 */       Double2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2CharMap.Entry> iterator(Double2CharMap.Entry from) {
/*  978 */       return new Double2CharLinkedOpenHashMap.EntryIterator(Double2CharLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2CharMap.Entry> fastIterator() {
/*  981 */       return new Double2CharLinkedOpenHashMap.FastEntryIterator(Double2CharLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2CharMap.Entry> fastIterator(Double2CharMap.Entry from) {
/*  984 */       return new Double2CharLinkedOpenHashMap.FastEntryIterator(Double2CharLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Double2CharLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Double2CharMap.Entry>
/*      */   {
/*  904 */     final AbstractDouble2CharMap.BasicEntry entry = new AbstractDouble2CharMap.BasicEntry(0.0D, '\000');
/*      */ 
...
/*  910 */       int e = nextEntry();
/*  911 */       this.entry.key = Double2CharLinkedOpenHashMap.this.key[e];
/*  912 */       this.entry.value = Double2CharLinkedOpenHashMap.this.value[e];
/*  913 */       return this.entry;
/*      */     }
/*      */     public AbstractDouble2CharMap.BasicEntry previous() {
/*  916 */       int e = previousEntry();
/*  917 */       this.entry.key = Double2CharLinkedOpenHashMap.this.key[e];
/*  918 */       this.entry.value = Double2CharLinkedOpenHashMap.this.value[e];
/*  919 */       return this.entry;
/*      */     }
/*  921 */     public void set(Double2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  922 */     public void add(Double2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2CharLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Double2CharMap.Entry>
/*      */   {
...
/*  890 */       return this.entry = new Double2CharLinkedOpenHashMap.MapEntry(Double2CharLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Double2CharLinkedOpenHashMap.MapEntry previous() {
/*  893 */       return this.entry = new Double2CharLinkedOpenHashMap.MapEntry(Double2CharLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  897 */       super.remove();
/*  898 */       Double2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  900 */     public void set(Double2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  901 */     public void add(Double2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  763 */     int index = -1;
/*      */ 
/*  765 */     private MapIterator() { this.next = Double2CharLinkedOpenHashMap.this.first;
/*  766 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(double from) {
/*  769 */       if (Double2CharLinkedOpenHashMap.this.key[Double2CharLinkedOpenHashMap.this.last] == from) {
/*  770 */         this.prev = Double2CharLinkedOpenHashMap.this.last;
/*  771 */         this.index = Double2CharLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  775 */         int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2CharLinkedOpenHashMap.this.mask;
/*      */ 
/*  777 */         while (Double2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  778 */           if (Double2CharLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  780 */             this.next = ((int)Double2CharLinkedOpenHashMap.this.link[pos]);
/*  781 */             this.prev = pos;
/*  782 */             return;
/*      */           }
/*  784 */           pos = pos + 1 & Double2CharLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  797 */       if (this.next == -1) {
/*  798 */         this.index = Double2CharLinkedOpenHashMap.this.size;
/*  799 */         return;
/*      */       }
/*  801 */       int pos = Double2CharLinkedOpenHashMap.this.first;
/*  802 */       this.index = 1;
/*  803 */       while (pos != this.prev) {
/*  804 */         pos = (int)Double2CharLinkedOpenHashMap.this.link[pos];
/*  805 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  817 */       if (!hasNext()) return Double2CharLinkedOpenHashMap.this.size();
/*  818 */       this.curr = this.next;
/*  819 */       this.next = ((int)Double2CharLinkedOpenHashMap.this.link[this.curr]);
...
/*  827 */       this.prev = ((int)(Double2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  839 */         this.index -= 1;
/*  840 */         this.prev = ((int)(Double2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  843 */         this.next = ((int)Double2CharLinkedOpenHashMap.this.link[this.curr]);
/*  844 */       }Double2CharLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  847 */       if (this.prev == -1) Double2CharLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  849 */         Double2CharLinkedOpenHashMap.this.link[this.prev] ^= (Double2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  850 */       if (this.next == -1) Double2CharLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  852 */         Double2CharLinkedOpenHashMap.this.link[this.next] ^= (Double2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  856 */         pos = (last = pos) + 1 & Double2CharLinkedOpenHashMap.this.mask;
/*  857 */         while (Double2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  858 */           int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2CharLinkedOpenHashMap.this.key[pos])) & Double2CharLinkedOpenHashMap.this.mask;
/*  859 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  860 */           pos = pos + 1 & Double2CharLinkedOpenHashMap.this.mask;
/*      */         }
/*  862 */         if (Double2CharLinkedOpenHashMap.this.used[pos] == 0) break;
/*  863 */         Double2CharLinkedOpenHashMap.this.key[last] = Double2CharLinkedOpenHashMap.this.key[pos];
/*  864 */         Double2CharLinkedOpenHashMap.this.value[last] = Double2CharLinkedOpenHashMap.this.value[pos];
/*  865 */         if (this.next == pos) this.next = last;
/*  866 */         if (this.prev == pos) this.prev = last;
/*  867 */         Double2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  869 */       Double2CharLinkedOpenHashMap.this.used[last] = false;
/*  870 */       this.curr = -1;
/*      */     }
...
/*  629 */       return Double.valueOf(Double2CharLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public double getDoubleKey() {
/*  632 */       return Double2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Character getValue() {
/*  635 */       return Character.valueOf(Double2CharLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public char getCharValue() {
/*  638 */       return Double2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public char setValue(char v) {
/*  641 */       char oldValue = Double2CharLinkedOpenHashMap.this.value[this.index];
/*  642 */       Double2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  643 */       return oldValue;
/*      */     }
...
/*  652 */       return (Double2CharLinkedOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     public int hashCode() {
/*  655 */       return HashCommon.double2int(Double2CharLinkedOpenHashMap.this.key[this.index]) ^ Double2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  658 */       return Double2CharLinkedOpenHashMap.this.key[this.index] + "=>" + Double2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
