  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2CharLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Double2CharLinkedOpenHashMap(Map<? extends Double, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2CharLinkedOpenHashMap(Map<? extends Double, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2CharLinkedOpenHashMap(Double2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2CharLinkedOpenHashMap(Double2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2CharLinkedOpenHashMap(double[] local_k, char[] local_v, float local_f)
  {
  ...
  public Double2CharLinkedOpenHashMap(double[] local_k, char[] local_v)
  {
  ...
  public char getAndMoveToFirst(double local_k)
  {
    double[] key = this.key;
  ...
  public char getAndMoveToLast(double local_k)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToFirst(double local_k, char local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToLast(double local_k, char local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Double2CharLinkedOpenHashMap.ValueIterator(Double2CharLinkedOpenHashMap.this);
        }
        ...
        {
          return Double2CharLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2CharLinkedOpenHashMap local_c;
    try
    {
      local_c = (Double2CharLinkedOpenHashMap)super.clone();
    }
    ...
    implements CharListIterator
  {
    ...
    {
      return Character.valueOf(Double2CharLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Character.valueOf(Double2CharLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSortedSet
  {
    ...
    {
      return new Double2CharLinkedOpenHashMap.KeyIterator(Double2CharLinkedOpenHashMap.this, from);
    }
    
    public DoubleListIterator iterator()
    {
      return new Double2CharLinkedOpenHashMap.KeyIterator(Double2CharLinkedOpenHashMap.this);
    }
    ...
    {
      return Double2CharLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2CharLinkedOpenHashMap.this.size;
      Double2CharLinkedOpenHashMap.this.remove(local_k);
    ...
    implements DoubleListIterator
  {
    ...
    {
      return Double.valueOf(Double2CharLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Double next()
    {
      return Double.valueOf(Double2CharLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2CharSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Double2CharLinkedOpenHashMap.EntryIterator(Double2CharLinkedOpenHashMap.this);
    }
    ...
    public Double2CharMap.Entry first()
    {
      ...
      return new Double2CharLinkedOpenHashMap.MapEntry(Double2CharLinkedOpenHashMap.this, Double2CharLinkedOpenHashMap.this.first);
    }
    ...
    public Double2CharMap.Entry last()
    {
      ...
      return new Double2CharLinkedOpenHashMap.MapEntry(Double2CharLinkedOpenHashMap.this, Double2CharLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2CharLinkedOpenHashMap.this.mask; Double2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2CharLinkedOpenHashMap.this.mask) {
        if (Double2CharLinkedOpenHashMap.this.key[pos] == local_k) {
          return Double2CharLinkedOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2CharLinkedOpenHashMap.this.mask; Double2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2CharLinkedOpenHashMap.this.mask) {
        if (Double2CharLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Double2CharLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Double2CharLinkedOpenHashMap.EntryIterator(Double2CharLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
    
    public ObjectBidirectionalIterator<Double2CharMap.Entry> fastIterator()
    {
      return new Double2CharLinkedOpenHashMap.FastEntryIterator(Double2CharLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Double2CharMap.Entry> fastIterator(Double2CharMap.Entry from)
    {
      return new Double2CharLinkedOpenHashMap.FastEntryIterator(Double2CharLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
  }
    ...
    implements ObjectListIterator<Double2CharMap.Entry>
  {
    ...
    public AbstractDouble2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2CharLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Double2CharLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Double2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Double2CharLinkedOpenHashMap.MapEntry(Double2CharLinkedOpenHashMap.this, nextEntry());
    }
    
    public Double2CharLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Double2CharLinkedOpenHashMap.MapEntry(Double2CharLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(double from)
    {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2CharLinkedOpenHashMap.this.mask; Double2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2CharLinkedOpenHashMap.this.mask) {
          if (Double2CharLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Double2CharLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Double2CharLinkedOpenHashMap.this.first = this.next;
      } else {
        Double2CharLinkedOpenHashMap.this.link[this.prev] ^= (Double2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Double2CharLinkedOpenHashMap.this.last = this.prev;
      } else {
        Double2CharLinkedOpenHashMap.this.link[this.next] ^= (Double2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2CharLinkedOpenHashMap.this.mask; Double2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2CharLinkedOpenHashMap.this.mask)
        {
        ...
        if (Double2CharLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Double2CharMap.Entry, Map.Entry<Double, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Double2CharLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Character> local_e = (Map.Entry)local_o;
      return (Double2CharLinkedOpenHashMap.this.key[this.index] == ((Double)local_e.getKey()).doubleValue()) && (Double2CharLinkedOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
