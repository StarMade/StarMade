...
/*  117 */           return Double2ReferenceAVLTreeMap.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*      */         }
/*      */         public int compare(Double ok1, Double ok2) {
/*  120 */           return Double2ReferenceAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* 1179 */         final Comparator<? super Double2ReferenceMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Double2ReferenceMap.Entry<V> x, Double2ReferenceMap.Entry<V> y) {
/* 1181 */             return Double2ReferenceAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1179 */         };
/*      */ 
...
/* 1188 */           return new Double2ReferenceAVLTreeMap.EntryIterator(Double2ReferenceAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator(Double2ReferenceMap.Entry<V> from) {
/* 1191 */           return new Double2ReferenceAVLTreeMap.EntryIterator(Double2ReferenceAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1195 */           if (!(o instanceof Map.Entry)) return false;
/* 1196 */           Map.Entry e = (Map.Entry)o;
/* 1197 */           Double2ReferenceAVLTreeMap.Entry f = Double2ReferenceAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1204 */           Double2ReferenceAVLTreeMap.Entry f = Double2ReferenceAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1205 */           if (f != null) Double2ReferenceAVLTreeMap.this.remove(f.key);
/* 1206 */           return f != null;
/*      */         }
/* 1208 */         public int size() { return Double2ReferenceAVLTreeMap.this.count; } 
/* 1209 */         public void clear() { Double2ReferenceAVLTreeMap.this.clear(); } 
/* 1210 */         public Double2ReferenceMap.Entry<V> first() { return Double2ReferenceAVLTreeMap.this.firstEntry; } 
/* 1211 */         public Double2ReferenceMap.Entry<V> last() { return Double2ReferenceAVLTreeMap.this.lastEntry; } 
/* 1212 */         public ObjectSortedSet<Double2ReferenceMap.Entry<V>> subSet(Double2ReferenceMap.Entry<V> from, Double2ReferenceMap.Entry<V> to) { return Double2ReferenceAVLTreeMap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2ReferenceEntrySet(); } 
/* 1213 */         public ObjectSortedSet<Double2ReferenceMap.Entry<V>> headSet(Double2ReferenceMap.Entry<V> to) { return Double2ReferenceAVLTreeMap.this.headMap((Double)to.getKey()).double2ReferenceEntrySet(); } 
/* 1214 */         public ObjectSortedSet<Double2ReferenceMap.Entry<V>> tailSet(Double2ReferenceMap.Entry<V> from) { return Double2ReferenceAVLTreeMap.this.tailMap((Double)from.getKey()).double2ReferenceEntrySet(); }
/*      */       };
...
/* 1276 */           return new Double2ReferenceAVLTreeMap.ValueIterator(Double2ReferenceAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1279 */           return Double2ReferenceAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1282 */           return Double2ReferenceAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1285 */           Double2ReferenceAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1645 */       c = (Double2ReferenceAVLTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1338 */       if ((!bottom) && (!top) && (Double2ReferenceAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1339 */       this.from = from;
/* 1340 */       this.bottom = bottom;
/* 1341 */       this.to = to;
/* 1342 */       this.top = top;
/* 1343 */       this.defRetValue = Double2ReferenceAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1357 */       return ((this.bottom) || (Double2ReferenceAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Double2ReferenceAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Double2ReferenceMap.Entry<V>> double2ReferenceEntrySet() {
/* 1361 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator() {
/* 1363 */             return new Double2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(Double2ReferenceAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Double2ReferenceMap.Entry<V>> iterator(Double2ReferenceMap.Entry<V> from) {
/* 1366 */             return new Double2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(Double2ReferenceAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
/*      */           }
/* 1368 */           public Comparator<? super Double2ReferenceMap.Entry<V>> comparator() { return Double2ReferenceAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1371 */             if (!(o instanceof Map.Entry)) return false;
/* 1372 */             Map.Entry e = (Map.Entry)o;
/* 1373 */             Double2ReferenceAVLTreeMap.Entry f = Double2ReferenceAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1374 */             return (f != null) && (Double2ReferenceAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1378 */             if (!(o instanceof Map.Entry)) return false;
/* 1379 */             Map.Entry e = (Map.Entry)o;
/* 1380 */             Double2ReferenceAVLTreeMap.Entry f = Double2ReferenceAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1381 */             if ((f != null) && (Double2ReferenceAVLTreeMap.Submap.this.in(f.key))) Double2ReferenceAVLTreeMap.Submap.this.remove(f.key);
/* 1382 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1385 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1390 */             return !new Double2ReferenceAVLTreeMap.Submap.SubmapIterator(Double2ReferenceAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1393 */             Double2ReferenceAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1395 */           public Double2ReferenceMap.Entry<V> first() { return Double2ReferenceAVLTreeMap.Submap.this.firstEntry(); } 
/* 1396 */           public Double2ReferenceMap.Entry<V> last() { return Double2ReferenceAVLTreeMap.Submap.this.lastEntry(); } 
/* 1397 */           public ObjectSortedSet<Double2ReferenceMap.Entry<V>> subSet(Double2ReferenceMap.Entry<V> from, Double2ReferenceMap.Entry<V> to) { return Double2ReferenceAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2ReferenceEntrySet(); } 
/* 1398 */           public ObjectSortedSet<Double2ReferenceMap.Entry<V>> headSet(Double2ReferenceMap.Entry<V> to) { return Double2ReferenceAVLTreeMap.Submap.this.headMap((Double)to.getKey()).double2ReferenceEntrySet(); } 
/* 1399 */           public ObjectSortedSet<Double2ReferenceMap.Entry<V>> tailSet(Double2ReferenceMap.Entry<V> from) { return Double2ReferenceAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2ReferenceEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1414 */             return new Double2ReferenceAVLTreeMap.Submap.SubmapValueIterator(Double2ReferenceAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1417 */             return Double2ReferenceAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1420 */             return Double2ReferenceAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1423 */             Double2ReferenceAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(double k) {
/* 1430 */       return (in(k)) && (Double2ReferenceAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1444 */       double kk = k;
/*      */       Double2ReferenceAVLTreeMap.Entry e;
/* 1445 */       return (in(kk)) && ((e = Double2ReferenceAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(double k, V v) {
/* 1448 */       Double2ReferenceAVLTreeMap.this.modified = false;
...
/* 1450 */       Object oldValue = Double2ReferenceAVLTreeMap.this.put(k, v);
/* 1451 */       return Double2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Double ok, V ov) {
/* 1454 */       Object oldValue = put(ok.doubleValue(), ov);
/* 1455 */       return Double2ReferenceAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(double k) {
/* 1459 */       Double2ReferenceAVLTreeMap.this.modified = false;
/* 1460 */       if (!in(k)) return this.defRetValue;
/* 1461 */       Object oldValue = Double2ReferenceAVLTreeMap.this.remove(k);
/* 1462 */       return Double2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1465 */       Object oldValue = remove(((Double)ok).doubleValue());
/* 1466 */       return Double2ReferenceAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public DoubleComparator comparator() {
/* 1481 */       return Double2ReferenceAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Double2ReferenceSortedMap<V> headMap(double to) {
/* 1484 */       if (this.top) return new Submap(Double2ReferenceAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1485 */       return Double2ReferenceAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Double2ReferenceAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Double2ReferenceSortedMap<V> tailMap(double from) {
/* 1488 */       if (this.bottom) return new Submap(Double2ReferenceAVLTreeMap.this, from, false, this.to, this.top);
/* 1489 */       return Double2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2ReferenceAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Double2ReferenceSortedMap<V> subMap(double from, double to) {
/* 1492 */       if ((this.top) && (this.bottom)) return new Submap(Double2ReferenceAVLTreeMap.this, from, false, to, false);
/* 1493 */       if (!this.top) to = Double2ReferenceAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1494 */       if (!this.bottom) from = Double2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1495 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1496 */       return new Submap(Double2ReferenceAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Double2ReferenceAVLTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1503 */       if (Double2ReferenceAVLTreeMap.this.tree == null) return null;
/* 1506 */       Double2ReferenceAVLTreeMap.Entry e;
/*      */       Double2ReferenceAVLTreeMap.Entry e;
/* 1506 */       if (this.bottom) { e = Double2ReferenceAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1508 */         e = Double2ReferenceAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1510 */         if (Double2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1513 */       if ((e == null) || ((!this.top) && (Double2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1514 */       return e;
/*      */     }
/*      */ 
/*      */     public Double2ReferenceAVLTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1521 */       if (Double2ReferenceAVLTreeMap.this.tree == null) return null;
/* 1524 */       Double2ReferenceAVLTreeMap.Entry e;
/*      */       Double2ReferenceAVLTreeMap.Entry e;
/* 1524 */       if (this.top) { e = Double2ReferenceAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1526 */         e = Double2ReferenceAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1528 */         if (Double2ReferenceAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1531 */       if ((e == null) || ((!this.bottom) && (Double2ReferenceAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1532 */       return e;
/*      */     }
/*      */     public double firstDoubleKey() {
/* 1535 */       Double2ReferenceAVLTreeMap.Entry e = firstEntry();
/* 1536 */       if (e == null) throw new NoSuchElementException();
/* 1537 */       return e.key;
/*      */     }
/*      */     public double lastDoubleKey() {
/* 1540 */       Double2ReferenceAVLTreeMap.Entry e = lastEntry();
/* 1541 */       if (e == null) throw new NoSuchElementException();
/* 1542 */       return e.key;
/*      */     }
/*      */     public Double firstKey() {
/* 1545 */       Double2ReferenceAVLTreeMap.Entry e = firstEntry();
/* 1546 */       if (e == null) throw new NoSuchElementException();
/* 1547 */       return e.getKey();
/*      */     }
/*      */     public Double lastKey() {
/* 1550 */       Double2ReferenceAVLTreeMap.Entry e = lastEntry();
/* 1551 */       if (e == null) throw new NoSuchElementException();
/* 1552 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Double2ReferenceAVLTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Double2ReferenceAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Double2ReferenceAVLTreeMap<V>.Submap.SubmapIterator
...
/* 1595 */       public Double2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1596 */       public void set(Double2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1597 */       public void add(Double2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Double2ReferenceAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1562 */         super();
/* 1563 */         this.next = Double2ReferenceAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(double k) {
/* 1566 */         this();
/* 1567 */         if (this.next != null)
/* 1568 */           if ((!Double2ReferenceAVLTreeMap.Submap.this.bottom) && (Double2ReferenceAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1569 */           } else if ((!Double2ReferenceAVLTreeMap.Submap.this.top) && (Double2ReferenceAVLTreeMap.this.compare(k, (this.prev = Double2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1571 */             this.next = Double2ReferenceAVLTreeMap.this.locateKey(k);
/* 1572 */             if (Double2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1582 */         if ((!Double2ReferenceAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2ReferenceAVLTreeMap.this.compare(this.prev.key, Double2ReferenceAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1585 */         this.next = this.next.next();
/* 1586 */         if ((!Double2ReferenceAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2ReferenceAVLTreeMap.this.compare(this.next.key, Double2ReferenceAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1403 */         super(); } 
/* 1404 */       public DoubleBidirectionalIterator iterator() { return new Double2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(Double2ReferenceAVLTreeMap.Submap.this); } 
/* 1405 */       public DoubleBidirectionalIterator iterator(double from) { return new Double2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(Double2ReferenceAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2ReferenceAVLTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1237 */       super(); } 
/* 1238 */     public DoubleBidirectionalIterator iterator() { return new Double2ReferenceAVLTreeMap.KeyIterator(Double2ReferenceAVLTreeMap.this); } 
/* 1239 */     public DoubleBidirectionalIterator iterator(double from) { return new Double2ReferenceAVLTreeMap.KeyIterator(Double2ReferenceAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2ReferenceAVLTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2ReferenceAVLTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Double2ReferenceMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1173 */     public Double2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1174 */     public void set(Double2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1175 */     public void add(Double2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1100 */     int index = 0;
/*      */ 
/* 1102 */     TreeIterator() { this.next = Double2ReferenceAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(double k) {
/* 1105 */       if ((this.next = Double2ReferenceAVLTreeMap.this.locateKey(k)) != null)
/* 1106 */         if (Double2ReferenceAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1147 */       updatePrevious();
/* 1148 */       updateNext();
/* 1149 */       Double2ReferenceAVLTreeMap.this.remove(this.curr.key);
/* 1150 */       this.curr = null;
/*      */     }
...
/* 1025 */       return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/* 1028 */       return HashCommon.double2int(this.key) ^ (this.value == null ? 0 : System.identityHashCode(this.value));
/*      */     }
