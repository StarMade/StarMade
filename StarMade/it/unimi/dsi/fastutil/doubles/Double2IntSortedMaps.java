...
/*     */   {
/* 173 */     return new Singleton(key.doubleValue(), value.intValue());
/*     */   }
/*     */ 
/*     */   public static Double2IntSortedMap singleton(Double key, Integer value, DoubleComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.doubleValue(), value.intValue(), comparator);
/*     */   }
/*     */ 
...
/*     */     }
/* 302 */     public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.double2IntEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Double, Integer>> entrySet() {
/* 304 */       return double2IntEntrySet(); } 
...
/* 308 */     public Double2IntSortedMap headMap(double to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Double2IntSortedMap tailMap(double from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Double2IntSortedMap headMap(Double to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Double2IntSortedMap tailMap(Double from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.double2IntEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Double, Integer>> entrySet() {
/* 244 */       return double2IntEntrySet(); } 
...
/* 248 */     public Double2IntSortedMap headMap(double to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Double2IntSortedMap tailMap(double from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public double firstDoubleKey() {
...
/* 259 */     public Double2IntSortedMap headMap(Double to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Double2IntSortedMap tailMap(Double from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Double2IntMaps.Singleton.SingletonEntry(this), Double2IntSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Double, Integer>> entrySet() { return double2IntEntrySet(); } 
...
/*     */     }
/*     */     public Double2IntSortedMap subMap(double from, double to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Double2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Double2IntSortedMap headMap(double to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Double2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Double2IntSortedMap tailMap(double from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Double2IntSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Double2IntSortedMap tailMap(Double ofrom) { return tailMap(ofrom.doubleValue()); } 
/* 156 */     public Double2IntSortedMap subMap(Double ofrom, Double oto) { return subMap(ofrom.doubleValue(), oto.doubleValue()); } 
/*     */     public Double firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Double, Integer>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public DoubleSortedSet keySet() { return DoubleSortedSets.EMPTY_SET; } 
/*     */     public Double2IntSortedMap subMap(double from, double to) {
/*  86 */       return Double2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Double2IntSortedMap headMap(double to) { return Double2IntSortedMaps.EMPTY_MAP; } 
/*     */     public Double2IntSortedMap tailMap(double from) {
/*  90 */       return Double2IntSortedMaps.EMPTY_MAP; } 
...
/*  93 */     public Double2IntSortedMap headMap(Double oto) { return headMap(oto.doubleValue()); } 
/*  94 */     public Double2IntSortedMap tailMap(Double ofrom) { return tailMap(ofrom.doubleValue()); } 
/*  95 */     public Double2IntSortedMap subMap(Double ofrom, Double oto) { return subMap(ofrom.doubleValue(), oto.doubleValue()); } 
