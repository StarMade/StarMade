...
public class Double2IntSortedMaps
{
  ...
  public static Double2IntSortedMap synchronize(Double2IntSortedMap local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static Double2IntSortedMap synchronize(Double2IntSortedMap local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static Double2IntSortedMap unmodifiable(Double2IntSortedMap local_m)
  {
    ...
    implements Double2IntSortedMap, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Double2IntSortedMap local_m)
    {
      super();
    ...
    implements Double2IntSortedMap, Serializable
  {
    ...
    protected SynchronizedSortedMap(Double2IntSortedMap local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Double2IntSortedMap local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Double2IntSortedMap, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Double2IntMaps.Singleton.SingletonEntry(this), Double2IntSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
