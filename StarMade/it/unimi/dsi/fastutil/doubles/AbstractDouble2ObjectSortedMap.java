...
/*  10:    */
/*  50:    */public abstract class AbstractDouble2ObjectSortedMap<V>
/*  51:    */  extends AbstractDouble2ObjectMap<V>
/*  52:    */  implements Double2ObjectSortedMap<V>
/*  53:    */{
/*  54:    */  public static final long serialVersionUID = -1773560792952436569L;
/*  55:    */  
/*  56:    */  public Double2ObjectSortedMap<V> headMap(Double to)
/*  57:    */  {
/*  58: 58 */    return headMap(to.doubleValue());
/*  59:    */  }
/*  60:    */  
/*  61:    */  public Double2ObjectSortedMap<V> tailMap(Double from) {
/*  62: 62 */    return tailMap(from.doubleValue());
/*  63:    */  }
/*  64:    */  
/*  65:    */  public Double2ObjectSortedMap<V> subMap(Double from, Double to) {
...
/*  91:    */    
/*  92: 92 */    public boolean contains(double k) { return AbstractDouble2ObjectSortedMap.this.containsKey(k); }
/*  93: 93 */    public int size() { return AbstractDouble2ObjectSortedMap.this.size(); }
/*  94: 94 */    public void clear() { AbstractDouble2ObjectSortedMap.this.clear(); }
/*  95: 95 */    public DoubleComparator comparator() { return AbstractDouble2ObjectSortedMap.this.comparator(); }
/*  96: 96 */    public double firstDouble() { return AbstractDouble2ObjectSortedMap.this.firstDoubleKey(); }
/*  97: 97 */    public double lastDouble() { return AbstractDouble2ObjectSortedMap.this.lastDoubleKey(); }
/*  98:    */    
/*  99: 99 */    public DoubleSortedSet headSet(double to) { return AbstractDouble2ObjectSortedMap.this.headMap(to).keySet(); }
/* 100:100 */    public DoubleSortedSet tailSet(double from) { return AbstractDouble2ObjectSortedMap.this.tailMap(from).keySet(); }
/* 101:101 */    public DoubleSortedSet subSet(double from, double to) { return AbstractDouble2ObjectSortedMap.this.subMap(from, to).keySet(); }
/* 102:    */    
/* 103:103 */    public DoubleBidirectionalIterator iterator(double from) { return new AbstractDouble2ObjectSortedMap.KeySetIterator(AbstractDouble2ObjectSortedMap.this.entrySet().iterator(new AbstractDouble2ObjectMap.BasicEntry(from, null))); }
/* 104:104 */    public DoubleBidirectionalIterator iterator() { return new AbstractDouble2ObjectSortedMap.KeySetIterator(AbstractDouble2ObjectSortedMap.this.entrySet().iterator()); }
/* 105:    */  }
/* 106:    */  
...
/* 147:    */    
/* 148:148 */    public ObjectIterator<V> iterator() { return new AbstractDouble2ObjectSortedMap.ValuesIterator(AbstractDouble2ObjectSortedMap.this.entrySet().iterator()); }
/* 149:149 */    public boolean contains(Object k) { return AbstractDouble2ObjectSortedMap.this.containsValue(k); }
/* 150:150 */    public int size() { return AbstractDouble2ObjectSortedMap.this.size(); }
/* 151:151 */    public void clear() { AbstractDouble2ObjectSortedMap.this.clear(); }
/* 152:    */  }
/* 153:    */  
...
/* 173:    */  {
/* 174:174 */    return double2ObjectEntrySet();
/* 175:    */  }
/* 176:    */}
