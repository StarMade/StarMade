...
/*     */ 
/*     */ public class Double2FloatArrayMap extends AbstractDouble2FloatMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Double2FloatArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Double2FloatMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Double2FloatArrayMap.this.size; }
/*     */ 
/*     */         public Double2FloatMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractDouble2FloatMap.BasicEntry(Double2FloatArrayMap.this.key[this.next], Double2FloatArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractDouble2FloatMap.BasicEntry entry = new AbstractDouble2FloatMap.BasicEntry(0.0D, 0.0F);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Double2FloatArrayMap.this.size; }
/*     */ 
/*     */         public Double2FloatMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Double2FloatArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Double2FloatArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Double2FloatArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Double2FloatArrayMap.this.containsKey(k)) && (Double2FloatArrayMap.this.get(k) == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */   }
/*     */ }
