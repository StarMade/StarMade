...
{
  public static int downHeap(double[] refArray, int[] heap, int[] inv, int size, int local_i, DoubleComparator local_c)
  {
    if (local_i >= size) {
  ...
  public static int upHeap(double[] refArray, int[] heap, int[] inv, int size, int local_i, DoubleComparator local_c)
  {
    if (local_i >= size) {
      throw new IllegalArgumentException("Heap position (" + local_i + ") is larger than or equal to heap size (" + size + ")");
    }
  ...
  public static void makeHeap(double[] refArray, int offset, int length, int[] heap, int[] inv, DoubleComparator local_c)
  {
  ...
  public static void makeHeap(double[] refArray, int[] heap, int[] inv, int size, DoubleComparator local_c)
  {
    int local_i = size / 2;
    while (local_i-- != 0) {
