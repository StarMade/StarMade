...
/*   4:    */
/*  63:    */public class DoubleIndirectHeaps
/*  64:    */{
/*  65:    */  public static int downHeap(double[] refArray, int[] heap, int[] inv, int size, int i, DoubleComparator c)
/*  66:    */  {
/*  67: 67 */    if (i >= size) throw new IllegalArgumentException("Heap position (" + i + ") is larger than or equal to heap size (" + size + ")");
/*  68: 68 */    int e = heap[i];
/*  69: 69 */    double E = refArray[e];
/*  70:    */    
...
/*  90:    */  }
/*  91:    */  
/* 103:    */  public static int upHeap(double[] refArray, int[] heap, int[] inv, int size, int i, DoubleComparator c)
/* 104:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 135:    */  public static void makeHeap(double[] refArray, int offset, int length, int[] heap, int[] inv, DoubleComparator c)
/* 136:    */  {
/* 137:137 */    DoubleArrays.ensureOffsetLength(refArray, offset, length);
