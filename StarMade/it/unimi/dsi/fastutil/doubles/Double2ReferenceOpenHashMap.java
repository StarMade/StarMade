...
/* 607 */           return new Double2ReferenceOpenHashMap.ValueIterator(Double2ReferenceOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 610 */           return Double2ReferenceOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 613 */           return Double2ReferenceOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 616 */           Double2ReferenceOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 731 */       c = (Double2ReferenceOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Double2ReferenceOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public V next() { return Double2ReferenceOpenHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 573 */       return new Double2ReferenceOpenHashMap.KeyIterator(Double2ReferenceOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 576 */       return Double2ReferenceOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(double k) {
/* 579 */       return Double2ReferenceOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(double k) {
/* 582 */       int oldSize = Double2ReferenceOpenHashMap.this.size;
/* 583 */       Double2ReferenceOpenHashMap.this.remove(k);
/* 584 */       return Double2ReferenceOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 587 */       Double2ReferenceOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Double2ReferenceOpenHashMap.MapIterator
/*     */     implements DoubleIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 567 */       super(null); } 
/* 568 */     public double nextDouble() { return Double2ReferenceOpenHashMap.this.key[nextEntry()]; } 
/* 569 */     public Double next() { return Double.valueOf(Double2ReferenceOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 513 */       return new Double2ReferenceOpenHashMap.EntryIterator(Double2ReferenceOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Double2ReferenceMap.Entry<V>> fastIterator() {
/* 516 */       return new Double2ReferenceOpenHashMap.FastEntryIterator(Double2ReferenceOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 524 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ReferenceOpenHashMap.this.mask;
/*     */ 
/* 526 */       while (Double2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 527 */         if (Double2ReferenceOpenHashMap.this.key[pos] == k) return Double2ReferenceOpenHashMap.this.value[pos] == e.getValue();
/* 528 */         pos = pos + 1 & Double2ReferenceOpenHashMap.this.mask;
/*     */       }
/* 530 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 538 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ReferenceOpenHashMap.this.mask;
/*     */ 
/* 540 */       while (Double2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 541 */         if (Double2ReferenceOpenHashMap.this.key[pos] == k) {
/* 542 */           Double2ReferenceOpenHashMap.this.remove(e.getKey());
/* 543 */           return true;
/*     */         }
/* 545 */         pos = pos + 1 & Double2ReferenceOpenHashMap.this.mask;
/*     */       }
/* 547 */       return false;
/*     */     }
/*     */     public int size() {
/* 550 */       return Double2ReferenceOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 553 */       Double2ReferenceOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Double2ReferenceOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Double2ReferenceMap.Entry<V>>
/*     */   {
/* 503 */     final AbstractDouble2ReferenceMap.BasicEntry<V> entry = new AbstractDouble2ReferenceMap.BasicEntry(0.0D, null);
/*     */ 
...
/* 505 */       int e = nextEntry();
/* 506 */       this.entry.key = Double2ReferenceOpenHashMap.this.key[e];
/* 507 */       this.entry.value = Double2ReferenceOpenHashMap.this.value[e];
/* 508 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Double2ReferenceOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Double2ReferenceMap.Entry<V>>
/*     */   {
...
/* 494 */       return this.entry = new Double2ReferenceOpenHashMap.MapEntry(Double2ReferenceOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 498 */       super.remove();
/* 499 */       Double2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 399 */       this.pos = Double2ReferenceOpenHashMap.this.n;
/*     */ 
/* 402 */       this.last = -1;
/*     */ 
/* 404 */       this.c = Double2ReferenceOpenHashMap.this.size;
/*     */ 
/* 409 */       boolean[] used = Double2ReferenceOpenHashMap.this.used;
...
/*     */ 
/* 422 */         int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ReferenceOpenHashMap.this.mask;
/*     */ 
/* 424 */         while (Double2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 425 */           if (Double2ReferenceOpenHashMap.this.key[pos] == k) return pos;
/* 426 */           pos = pos + 1 & Double2ReferenceOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 429 */       this.last = this.pos;
/*     */ 
/* 431 */       if (this.c != 0) {
/* 432 */         boolean[] used = Double2ReferenceOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 449 */         pos = (last = pos) + 1 & Double2ReferenceOpenHashMap.this.mask;
/* 450 */         while (Double2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 451 */           int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2ReferenceOpenHashMap.this.key[pos])) & Double2ReferenceOpenHashMap.this.mask;
/* 452 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453 */           pos = pos + 1 & Double2ReferenceOpenHashMap.this.mask;
/*     */         }
/* 455 */         if (Double2ReferenceOpenHashMap.this.used[pos] == 0) break;
/* 456 */         if (pos < last)
/*     */         {
/* 458 */           if (this.wrapped == null) this.wrapped = new DoubleArrayList();
/* 459 */           this.wrapped.add(Double2ReferenceOpenHashMap.this.key[pos]);
/*     */         }
/* 461 */         Double2ReferenceOpenHashMap.this.key[last] = Double2ReferenceOpenHashMap.this.key[pos];
/* 462 */         Double2ReferenceOpenHashMap.this.value[last] = Double2ReferenceOpenHashMap.this.value[pos];
/*     */       }
/* 464 */       Double2ReferenceOpenHashMap.this.used[last] = false;
/* 465 */       Double2ReferenceOpenHashMap.this.value[last] = null;
/* 466 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 471 */       if (this.pos < -1)
/*     */       {
/* 473 */         Double2ReferenceOpenHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
/* 474 */         this.last = -1;
/* 475 */         return;
/*     */       }
/* 477 */       Double2ReferenceOpenHashMap.this.size -= 1;
...
/* 369 */       return Double.valueOf(Double2ReferenceOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public double getDoubleKey() {
/* 372 */       return Double2ReferenceOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 375 */       return Double2ReferenceOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 378 */       Object oldValue = Double2ReferenceOpenHashMap.this.value[this.index];
/* 379 */       Double2ReferenceOpenHashMap.this.value[this.index] = v;
/* 380 */       return oldValue;
/*     */     }
/*     */ 
...
/* 386 */       return (Double2ReferenceOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/*     */     }
/*     */     public int hashCode() {
/* 389 */       return HashCommon.double2int(Double2ReferenceOpenHashMap.this.key[this.index]) ^ (Double2ReferenceOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Double2ReferenceOpenHashMap.this.value[this.index]));
/*     */     }
/*     */     public String toString() {
/* 392 */       return Double2ReferenceOpenHashMap.this.key[this.index] + "=>" + Double2ReferenceOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
