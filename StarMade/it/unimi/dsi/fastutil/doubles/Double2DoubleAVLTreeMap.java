  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2DoubleAVLTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2DoubleAVLTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2DoubleAVLTreeMap(Map<? extends Double, ? extends Double> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2DoubleAVLTreeMap(SortedMap<Double, Double> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2DoubleAVLTreeMap(Double2DoubleMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2DoubleAVLTreeMap(Double2DoubleSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2DoubleAVLTreeMap(double[] local_k, double[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2DoubleAVLTreeMap(double[] local_k, double[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Double2DoubleMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Double2DoubleAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2DoubleAVLTreeMap.EntryIterator(Double2DoubleAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2DoubleMap.Entry> iterator(Double2DoubleMap.Entry from)
        {
          return new Double2DoubleAVLTreeMap.EntryIterator(Double2DoubleAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2DoubleAVLTreeMap.Entry local_f = Double2DoubleAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2DoubleAVLTreeMap.Entry local_f = Double2DoubleAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2DoubleAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Double2DoubleAVLTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Double2DoubleMap.Entry> headSet(Double2DoubleMap.Entry local_to)
        {
          return Double2DoubleAVLTreeMap.this.headMap((Double)local_to.getKey()).double2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Double2DoubleMap.Entry> tailSet(Double2DoubleMap.Entry from)
        {
          return Double2DoubleAVLTreeMap.this.tailMap((Double)from.getKey()).double2DoubleEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Double2DoubleAVLTreeMap.ValueIterator(Double2DoubleAVLTreeMap.this, null);
        }
        
        public boolean contains(double local_k)
        {
          return Double2DoubleAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2DoubleAVLTreeMap local_c;
    try
    {
      local_c = (Double2DoubleAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2DoubleAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Double2DoubleAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2DoubleAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2DoubleMap.Entry> double2DoubleEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2DoubleMap.Entry> iterator()
          {
            return new Double2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Double2DoubleAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2DoubleMap.Entry> iterator(Double2DoubleMap.Entry from)
          {
            return new Double2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Double2DoubleAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, Double> local_e = (Map.Entry)local_o;
            Double2DoubleAVLTreeMap.Entry local_f = Double2DoubleAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2DoubleAVLTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, Double> local_e = (Map.Entry)local_o;
            Double2DoubleAVLTreeMap.Entry local_f = Double2DoubleAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2DoubleAVLTreeMap.Submap.this.in7(local_f.key))) {
              Double2DoubleAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2DoubleAVLTreeMap.Submap.SubmapIterator(Double2DoubleAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2DoubleAVLTreeMap.Submap.this.clear();
          }
          
          public Double2DoubleMap.Entry first()
          {
            return Double2DoubleAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Double2DoubleMap.Entry last()
          {
            return Double2DoubleAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2DoubleMap.Entry> subSet(Double2DoubleMap.Entry from, Double2DoubleMap.Entry local_to)
          {
            return Double2DoubleAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Double2DoubleMap.Entry> headSet(Double2DoubleMap.Entry local_to)
          {
            return Double2DoubleAVLTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Double2DoubleMap.Entry> tailSet(Double2DoubleMap.Entry from)
          {
            return Double2DoubleAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2DoubleEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public DoubleCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractDoubleCollection()
        {
          public DoubleIterator iterator()
          {
            return new Double2DoubleAVLTreeMap.Submap.SubmapValueIterator(Double2DoubleAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(double local_k)
          {
            return Double2DoubleAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2DoubleAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2DoubleAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2DoubleAVLTreeMap.Entry local_e;
      return (in7(local_kk)) && ((local_e = Double2DoubleAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public double put(double local_k, double local_v)
    {
      ...
      double oldValue = Double2DoubleAVLTreeMap.this.put(local_k, local_v);
    ...
    public double remove(double local_k)
    {
      ...
      double oldValue = Double2DoubleAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2DoubleSortedMap tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2DoubleAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2DoubleAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2DoubleSortedMap subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2DoubleAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2DoubleAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2DoubleAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2DoubleAVLTreeMap.this.locateKey(this.from);
        if (Double2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2DoubleAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2DoubleAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2DoubleAVLTreeMap.this.locateKey(this.field_47);
        if (Double2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2DoubleAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2DoubleAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Double2DoubleAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Double2DoubleAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2DoubleAVLTreeMap.Submap.this.bottom) && (Double2DoubleAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2DoubleAVLTreeMap.Submap.this.top) && (Double2DoubleAVLTreeMap.this.compare(local_k, (this.prev = Double2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2DoubleAVLTreeMap.this.locateKey(local_k);
            if (Double2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2DoubleAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2DoubleAVLTreeMap.this.compare(this.prev.key, Double2DoubleAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2DoubleAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2DoubleAVLTreeMap.this.compare(this.next.key, Double2DoubleAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2DoubleSortedMap.KeySet
    {
      ...
      {
        return new Double2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Double2DoubleAVLTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Double2DoubleAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2DoubleSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2DoubleAVLTreeMap.KeyIterator(Double2DoubleAVLTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2DoubleAVLTreeMap.KeyIterator(Double2DoubleAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2DoubleAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Double2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
