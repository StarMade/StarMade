...
/*  18:    */
/*  90:    */public class Double2IntOpenCustomHashMap
/*  91:    */  extends AbstractDouble2IntMap
...
/* 104:    */  protected volatile transient Double2IntMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Double2IntOpenCustomHashMap(int expected, float f, DoubleHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Double2IntOpenCustomHashMap(int expected, DoubleHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Double2IntOpenCustomHashMap(DoubleHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Double2IntOpenCustomHashMap(Map<? extends Double, ? extends Integer> m, float f, DoubleHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Double2IntOpenCustomHashMap(Map<? extends Double, ? extends Integer> m, DoubleHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Double2IntOpenCustomHashMap(Double2IntMap m, float f, DoubleHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Double2IntOpenCustomHashMap(Double2IntMap m, DoubleHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Double2IntOpenCustomHashMap(double[] k, int[] v, float f, DoubleHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Double2IntOpenCustomHashMap(double[] k, int[] v, DoubleHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public int put(double k, int v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Integer put(Double ok, Integer ov) { int v = ov.intValue();
...
/* 246:    */  }
/* 247:    */  
/* 258:    */  public int add(double k, int incr)
/* 259:    */  {
...
/* 299:    */  }
/* 300:    */  
/* 301:    */  public int remove(double k)
/* 302:    */  {
...
/* 332:    */  }
/* 333:    */  
/* 334:334 */  public Integer get(Double ok) { double k = ok.doubleValue();
/* 335:    */    
...
/* 409:    */    implements Double2IntMap.Entry, Map.Entry<Double, Integer>
/* 410:    */  {
...
/* 416:    */    }
/* 417:    */    
/* 418:418 */    public Double getKey() { return Double.valueOf(Double2IntOpenCustomHashMap.this.key[this.index]); }
/* 419:    */    
/* 420:    */    public double getDoubleKey() {
/* 421:421 */      return Double2IntOpenCustomHashMap.this.key[this.index];
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public Integer getValue() { return Integer.valueOf(Double2IntOpenCustomHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public int getIntValue() { return Double2IntOpenCustomHashMap.this.value[this.index]; }
/* 428:    */    
/* 429:    */    public int setValue(int v) {
/* 430:430 */      int oldValue = Double2IntOpenCustomHashMap.this.value[this.index];
/* 431:431 */      Double2IntOpenCustomHashMap.this.value[this.index] = v;
...
/* 440:440 */      Map.Entry<Double, Integer> e = (Map.Entry)o;
/* 441:441 */      return (Double2IntOpenCustomHashMap.this.strategy.equals(Double2IntOpenCustomHashMap.this.key[this.index], ((Double)e.getKey()).doubleValue())) && (Double2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/* 442:    */    }
/* 443:    */    
/* 444:444 */    public int hashCode() { return Double2IntOpenCustomHashMap.this.strategy.hashCode(Double2IntOpenCustomHashMap.this.key[this.index]) ^ Double2IntOpenCustomHashMap.this.value[this.index]; }
/* 445:    */    
/* 447:447 */    public String toString() { return Double2IntOpenCustomHashMap.this.key[this.index] + "=>" + Double2IntOpenCustomHashMap.this.value[this.index]; } }
/* 448:    */  
...
/* 453:    */    
/* 454:454 */    private MapIterator() { this.pos = Double2IntOpenCustomHashMap.this.n;
/* 455:    */      
/* 457:457 */      this.last = -1;
/* 458:    */      
/* 459:459 */      this.c = Double2IntOpenCustomHashMap.this.size;
/* 460:    */      
/* 464:464 */      boolean[] used = Double2IntOpenCustomHashMap.this.used;
...
/* 476:    */        
/* 477:477 */        int pos = HashCommon.murmurHash3(Double2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Double2IntOpenCustomHashMap.this.mask;
/* 478:    */        
/* 479:479 */        while (Double2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 480:480 */          if (Double2IntOpenCustomHashMap.this.strategy.equals(Double2IntOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481:481 */          pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask;
/* 482:    */        }
/* 483:    */      }
/* 484:484 */      this.last = this.pos;
/* 485:    */      
/* 486:486 */      if (this.c != 0) {
/* 487:487 */        boolean[] used = Double2IntOpenCustomHashMap.this.used;
...
/* 502:    */      for (;;)
/* 503:    */      {
/* 504:504 */        pos = (last = pos) + 1 & Double2IntOpenCustomHashMap.this.mask;
/* 505:505 */        while (Double2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 506:506 */          int slot = HashCommon.murmurHash3(Double2IntOpenCustomHashMap.this.strategy.hashCode(Double2IntOpenCustomHashMap.this.key[pos])) & Double2IntOpenCustomHashMap.this.mask;
/* 507:507 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508:508 */          pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask;
/* 509:    */        }
/* 510:510 */        if (Double2IntOpenCustomHashMap.this.used[pos] == 0) break;
/* 511:511 */        if (pos < last)
/* 512:    */        {
/* 513:513 */          if (this.wrapped == null) this.wrapped = new DoubleArrayList();
/* 514:514 */          this.wrapped.add(Double2IntOpenCustomHashMap.this.key[pos]);
/* 515:    */        }
/* 516:516 */        Double2IntOpenCustomHashMap.this.key[last] = Double2IntOpenCustomHashMap.this.key[pos];
/* 517:517 */        Double2IntOpenCustomHashMap.this.value[last] = Double2IntOpenCustomHashMap.this.value[pos];
/* 518:    */      }
/* 519:519 */      Double2IntOpenCustomHashMap.this.used[last] = false;
/* 520:520 */      return last;
/* 521:    */    }
/* 522:    */    
...
/* 526:    */      {
/* 527:527 */        Double2IntOpenCustomHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
/* 528:528 */        this.last = -1;
/* 529:529 */        return;
/* 530:    */      }
/* 531:531 */      Double2IntOpenCustomHashMap.this.size -= 1;
...
/* 543:    */    } }
/* 544:    */  
/* 545:545 */  private class EntryIterator extends Double2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Double2IntMap.Entry> { private EntryIterator() { super(null); }
/* 546:    */    
/* 547:    */    private Double2IntOpenCustomHashMap.MapEntry entry;
/* 548:548 */    public Double2IntMap.Entry next() { return this.entry = new Double2IntOpenCustomHashMap.MapEntry(Double2IntOpenCustomHashMap.this, nextEntry()); }
/* 549:    */    
/* 550:    */    public void remove()
/* 551:    */    {
/* 552:552 */      super.remove();
/* 553:553 */      Double2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 554:    */    } }
/* 555:    */  
/* 556:556 */  private class FastEntryIterator extends Double2IntOpenCustomHashMap.MapIterator implements ObjectIterator<Double2IntMap.Entry> { private FastEntryIterator() { super(null); }
/* 557:557 */    final AbstractDouble2IntMap.BasicEntry entry = new AbstractDouble2IntMap.BasicEntry(0.0D, 0);
/* 558:    */    
/* 559:559 */    public AbstractDouble2IntMap.BasicEntry next() { int e = nextEntry();
/* 560:560 */      this.entry.key = Double2IntOpenCustomHashMap.this.key[e];
/* 561:561 */      this.entry.value = Double2IntOpenCustomHashMap.this.value[e];
/* 562:562 */      return this.entry;
/* 563:    */    } }
/* 564:    */  
/* 565:    */  private final class MapEntrySet extends AbstractObjectSet<Double2IntMap.Entry> implements Double2IntMap.FastEntrySet { private MapEntrySet() {}
/* 566:    */    
/* 567:567 */    public ObjectIterator<Double2IntMap.Entry> iterator() { return new Double2IntOpenCustomHashMap.EntryIterator(Double2IntOpenCustomHashMap.this, null); }
/* 568:    */    
/* 569:    */    public ObjectIterator<Double2IntMap.Entry> fastIterator() {
/* 570:570 */      return new Double2IntOpenCustomHashMap.FastEntryIterator(Double2IntOpenCustomHashMap.this, null);
/* 571:    */    }
/* 572:    */    
/* 573:    */    public boolean contains(Object o) {
/* 574:574 */      if (!(o instanceof Map.Entry)) return false;
/* 575:575 */      Map.Entry<Double, Integer> e = (Map.Entry)o;
/* 576:576 */      double k = ((Double)e.getKey()).doubleValue();
/* 577:    */      
/* 578:578 */      int pos = HashCommon.murmurHash3(Double2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Double2IntOpenCustomHashMap.this.mask;
/* 579:    */      
/* 580:580 */      while (Double2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 581:581 */        if (Double2IntOpenCustomHashMap.this.strategy.equals(Double2IntOpenCustomHashMap.this.key[pos], k)) return Double2IntOpenCustomHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 582:582 */        pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask;
/* 583:    */      }
...
/* 589:589 */      Map.Entry<Double, Integer> e = (Map.Entry)o;
/* 590:590 */      double k = ((Double)e.getKey()).doubleValue();
/* 591:    */      
/* 592:592 */      int pos = HashCommon.murmurHash3(Double2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Double2IntOpenCustomHashMap.this.mask;
/* 593:    */      
/* 594:594 */      while (Double2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 595:595 */        if (Double2IntOpenCustomHashMap.this.strategy.equals(Double2IntOpenCustomHashMap.this.key[pos], k)) {
/* 596:596 */          Double2IntOpenCustomHashMap.this.remove(e.getKey());
/* 597:597 */          return true;
/* 598:    */        }
/* 599:599 */        pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask;
/* 600:    */      }
/* 601:601 */      return false;
/* 602:    */    }
/* 603:    */    
/* 604:604 */    public int size() { return Double2IntOpenCustomHashMap.this.size; }
/* 605:    */    
/* 607:607 */    public void clear() { Double2IntOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
/* 610:    */  public Double2IntMap.FastEntrySet double2IntEntrySet() {
...
/* 618:    */    extends Double2IntOpenCustomHashMap.MapIterator
/* 619:    */    implements DoubleIterator
/* 620:    */  {
/* 621:621 */    public KeyIterator() { super(null); }
/* 622:622 */    public double nextDouble() { return Double2IntOpenCustomHashMap.this.key[nextEntry()]; }
/* 623:623 */    public Double next() { return Double.valueOf(Double2IntOpenCustomHashMap.this.key[nextEntry()]); } }
/* 624:    */  
/* 625:    */  private final class KeySet extends AbstractDoubleSet { private KeySet() {}
/* 626:    */    
/* 627:627 */    public DoubleIterator iterator() { return new Double2IntOpenCustomHashMap.KeyIterator(Double2IntOpenCustomHashMap.this); }
/* 628:    */    
/* 629:    */    public int size() {
/* 630:630 */      return Double2IntOpenCustomHashMap.this.size;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    public boolean contains(double k) { return Double2IntOpenCustomHashMap.this.containsKey(k); }
/* 634:    */    
/* 635:    */    public boolean remove(double k) {
/* 636:636 */      int oldSize = Double2IntOpenCustomHashMap.this.size;
/* 637:637 */      Double2IntOpenCustomHashMap.this.remove(k);
/* 638:638 */      return Double2IntOpenCustomHashMap.this.size != oldSize;
/* 639:    */    }
/* 640:    */    
/* 641:641 */    public void clear() { Double2IntOpenCustomHashMap.this.clear(); }
/* 642:    */  }
/* 643:    */  
...
/* 652:    */    extends Double2IntOpenCustomHashMap.MapIterator
/* 653:    */    implements IntIterator
/* 654:    */  {
/* 655:655 */    public ValueIterator() { super(null); }
/* 656:656 */    public int nextInt() { return Double2IntOpenCustomHashMap.this.value[nextEntry()]; }
/* 657:657 */    public Integer next() { return Integer.valueOf(Double2IntOpenCustomHashMap.this.value[nextEntry()]); }
/* 658:    */  }
/* 659:    */  
...
/* 662:662 */          return new Double2IntOpenCustomHashMap.ValueIterator(Double2IntOpenCustomHashMap.this);
/* 663:    */        }
/* 664:    */        
/* 665:665 */        public int size() { return Double2IntOpenCustomHashMap.this.size; }
/* 666:    */        
/* 667:    */        public boolean contains(int v) {
/* 668:668 */          return Double2IntOpenCustomHashMap.this.containsValue(v);
/* 669:    */        }
/* 670:    */        
/* 671:671 */        public void clear() { Double2IntOpenCustomHashMap.this.clear(); }
/* 672:    */      };
/* 673:    */    }
...
/* 774:    */  }
/* 775:    */  
/* 779:    */  public Double2IntOpenCustomHashMap clone()
/* 780:    */  {
/* 781:    */    Double2IntOpenCustomHashMap c;
/* 782:    */    
/* 784:    */    try
/* 785:    */    {
/* 786:786 */      c = (Double2IntOpenCustomHashMap)super.clone();
/* 787:    */    }
