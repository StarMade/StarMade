  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2IntOpenCustomHashMap(int expected, float local_f, DoubleHash.Strategy strategy)
  {
  ...
  public Double2IntOpenCustomHashMap(Map<? extends Double, ? extends Integer> local_m, float local_f, DoubleHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Double2IntOpenCustomHashMap(Map<? extends Double, ? extends Integer> local_m, DoubleHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Double2IntOpenCustomHashMap(Double2IntMap local_m, float local_f, DoubleHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Double2IntOpenCustomHashMap(Double2IntMap local_m, DoubleHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Double2IntOpenCustomHashMap(double[] local_k, int[] local_v, float local_f, DoubleHash.Strategy strategy)
  {
  ...
  public Double2IntOpenCustomHashMap(double[] local_k, int[] local_v, DoubleHash.Strategy strategy)
  {
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Double2IntOpenCustomHashMap.ValueIterator(Double2IntOpenCustomHashMap.this);
        }
        ...
        {
          return Double2IntOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2IntOpenCustomHashMap local_c;
    try
    {
      local_c = (Double2IntOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Double2IntOpenCustomHashMap.MapIterator
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Double2IntOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSet
  {
    ...
    {
      return new Double2IntOpenCustomHashMap.KeyIterator(Double2IntOpenCustomHashMap.this);
    }
    ...
    {
      return Double2IntOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2IntOpenCustomHashMap.this.size;
      Double2IntOpenCustomHashMap.this.remove(local_k);
    ...
    implements DoubleIterator
  {
    ...
    public Double next()
    {
      return Double.valueOf(Double2IntOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2IntMap.FastEntrySet
  {
    ...
    {
      return new Double2IntOpenCustomHashMap.EntryIterator(Double2IntOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Double2IntMap.Entry> fastIterator()
    {
      return new Double2IntOpenCustomHashMap.FastEntryIterator(Double2IntOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Double2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Double2IntOpenCustomHashMap.this.mask; Double2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask) {
        if (Double2IntOpenCustomHashMap.this.strategy.equals(Double2IntOpenCustomHashMap.this.key[pos], local_k)) {
          return Double2IntOpenCustomHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Double2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Double2IntOpenCustomHashMap.this.mask; Double2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask) {
        if (Double2IntOpenCustomHashMap.this.strategy.equals(Double2IntOpenCustomHashMap.this.key[pos], local_k))
        {
          Double2IntOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Double2IntMap.Entry>
  {
    ...
    public AbstractDouble2IntMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2IntOpenCustomHashMap.this.key[local_e];
      this.entry.value = Double2IntOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Double2IntMap.Entry>
  {
    ...
    {
      return this.entry = new Double2IntOpenCustomHashMap.MapEntry(Double2IntOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Double2IntOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1936 = Double2IntOpenCustomHashMap.this.size;
    DoubleArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Double2IntOpenCustomHashMap.this.used;
      while ((this.field_1936 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1936 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1936 != 0)
      {
        boolean[] local_k = Double2IntOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2IntOpenCustomHashMap.this.mask; Double2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2IntOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Double2IntOpenCustomHashMap.this.strategy.hashCode(Double2IntOpenCustomHashMap.this.key[pos])) & Double2IntOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2IntOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Double2IntOpenCustomHashMap.this.key[pos]);
        }
        Double2IntOpenCustomHashMap.this.key[last] = Double2IntOpenCustomHashMap.this.key[pos];
        Double2IntOpenCustomHashMap.this.value[last] = Double2IntOpenCustomHashMap.this.value[pos];
      }
      Double2IntOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Double2IntOpenCustomHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
        this.last = -1;
        return;
      }
      Double2IntOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1936 > 0))
      {
        this.field_1936 += 1;
        nextEntry();
      }
    ...
    implements Double2IntMap.Entry, Map.Entry<Double, Integer>
  {
    ...
    public int setValue(int local_v)
    {
      ...
      Double2IntOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Integer> local_e = (Map.Entry)local_o;
      return (Double2IntOpenCustomHashMap.this.strategy.equals(Double2IntOpenCustomHashMap.this.key[this.index], ((Double)local_e.getKey()).doubleValue())) && (Double2IntOpenCustomHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
