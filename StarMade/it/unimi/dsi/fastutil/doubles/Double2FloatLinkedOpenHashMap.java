  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2FloatLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Double2FloatLinkedOpenHashMap(Map<? extends Double, ? extends Float> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2FloatLinkedOpenHashMap(Map<? extends Double, ? extends Float> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2FloatLinkedOpenHashMap(Double2FloatMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2FloatLinkedOpenHashMap(Double2FloatMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2FloatLinkedOpenHashMap(double[] local_k, float[] local_v, float local_f)
  {
  ...
  public Double2FloatLinkedOpenHashMap(double[] local_k, float[] local_v)
  {
  ...
  public float getAndMoveToFirst(double local_k)
  {
    double[] key = this.key;
  ...
  public float getAndMoveToLast(double local_k)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public float putAndMoveToFirst(double local_k, float local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public float putAndMoveToLast(double local_k, float local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Double2FloatLinkedOpenHashMap.ValueIterator(Double2FloatLinkedOpenHashMap.this);
        }
        ...
        {
          return Double2FloatLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2FloatLinkedOpenHashMap local_c;
    try
    {
      local_c = (Double2FloatLinkedOpenHashMap)super.clone();
    }
    ...
    implements FloatListIterator
  {
    ...
    {
      return Float.valueOf(Double2FloatLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Double2FloatLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSortedSet
  {
    ...
    {
      return new Double2FloatLinkedOpenHashMap.KeyIterator(Double2FloatLinkedOpenHashMap.this, from);
    }
    
    public DoubleListIterator iterator()
    {
      return new Double2FloatLinkedOpenHashMap.KeyIterator(Double2FloatLinkedOpenHashMap.this);
    }
    ...
    {
      return Double2FloatLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2FloatLinkedOpenHashMap.this.size;
      Double2FloatLinkedOpenHashMap.this.remove(local_k);
    ...
    implements DoubleListIterator
  {
    ...
    {
      return Double.valueOf(Double2FloatLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Double next()
    {
      return Double.valueOf(Double2FloatLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2FloatSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Double2FloatLinkedOpenHashMap.EntryIterator(Double2FloatLinkedOpenHashMap.this);
    }
    ...
    public Double2FloatMap.Entry first()
    {
      ...
      return new Double2FloatLinkedOpenHashMap.MapEntry(Double2FloatLinkedOpenHashMap.this, Double2FloatLinkedOpenHashMap.this.first);
    }
    ...
    public Double2FloatMap.Entry last()
    {
      ...
      return new Double2FloatLinkedOpenHashMap.MapEntry(Double2FloatLinkedOpenHashMap.this, Double2FloatLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2FloatLinkedOpenHashMap.this.mask; Double2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2FloatLinkedOpenHashMap.this.mask) {
        if (Double2FloatLinkedOpenHashMap.this.key[pos] == local_k) {
          return Double2FloatLinkedOpenHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2FloatLinkedOpenHashMap.this.mask; Double2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2FloatLinkedOpenHashMap.this.mask) {
        if (Double2FloatLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Double2FloatLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Double2FloatLinkedOpenHashMap.EntryIterator(Double2FloatLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
    
    public ObjectBidirectionalIterator<Double2FloatMap.Entry> fastIterator()
    {
      return new Double2FloatLinkedOpenHashMap.FastEntryIterator(Double2FloatLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Double2FloatMap.Entry> fastIterator(Double2FloatMap.Entry from)
    {
      return new Double2FloatLinkedOpenHashMap.FastEntryIterator(Double2FloatLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
  }
    ...
    implements ObjectListIterator<Double2FloatMap.Entry>
  {
    ...
    public AbstractDouble2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2FloatLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Double2FloatLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Double2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Double2FloatLinkedOpenHashMap.MapEntry(Double2FloatLinkedOpenHashMap.this, nextEntry());
    }
    
    public Double2FloatLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Double2FloatLinkedOpenHashMap.MapEntry(Double2FloatLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2FloatLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    {
      if (Double2FloatLinkedOpenHashMap.this.key[Double2FloatLinkedOpenHashMap.this.last] == from)
      {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2FloatLinkedOpenHashMap.this.mask; Double2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2FloatLinkedOpenHashMap.this.mask) {
          if (Double2FloatLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Double2FloatLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Double2FloatLinkedOpenHashMap.this.first = this.next;
      } else {
        Double2FloatLinkedOpenHashMap.this.link[this.prev] ^= (Double2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Double2FloatLinkedOpenHashMap.this.last = this.prev;
      } else {
        Double2FloatLinkedOpenHashMap.this.link[this.next] ^= (Double2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2FloatLinkedOpenHashMap.this.mask; Double2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2FloatLinkedOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2FloatLinkedOpenHashMap.this.key[pos])) & Double2FloatLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2FloatLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Double2FloatLinkedOpenHashMap.this.key[last] = Double2FloatLinkedOpenHashMap.this.key[pos];
      ...
      Double2FloatLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Double2FloatMap.Entry, Map.Entry<Double, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Double2FloatLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Float> local_e = (Map.Entry)local_o;
      return (Double2FloatLinkedOpenHashMap.this.key[this.index] == ((Double)local_e.getKey()).doubleValue()) && (Double2FloatLinkedOpenHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
