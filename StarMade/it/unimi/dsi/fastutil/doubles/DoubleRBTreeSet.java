  ...
  implements Serializable, Cloneable, DoubleSortedSet
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return DoubleRBTreeSet.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public DoubleRBTreeSet(Comparator<? super Double> local_c)
  {
    this();
  ...
  public DoubleRBTreeSet(Collection<? extends Double> local_c)
  {
    this();
    addAll(local_c);
  }
  
  public DoubleRBTreeSet(SortedSet<Double> local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public DoubleRBTreeSet(DoubleCollection local_c)
  {
    this();
    addAll(local_c);
  }
  
  public DoubleRBTreeSet(DoubleSortedSet local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public DoubleRBTreeSet(DoubleIterator local_i)
  {
    allocatePaths();
  ...
  public DoubleRBTreeSet(Iterator<? extends Double> local_i)
  {
    this(DoubleIterators.asDoubleIterator(local_i));
  }
  
  public DoubleRBTreeSet(double[] local_a, int offset, int length, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public DoubleRBTreeSet(double[] local_a, int offset, int length)
  {
    this(local_a, offset, length, null);
  }
  
  public DoubleRBTreeSet(double[] local_a)
  {
    this();
  ...
  public DoubleRBTreeSet(double[] local_a, Comparator<? super Double> local_c)
  {
    this(local_c);
    int local_i = local_a.length;
    while (local_i-- != 0) {
  ...
  public Object clone()
  {
    DoubleRBTreeSet local_c;
    try
    {
      local_c = (DoubleRBTreeSet)super.clone();
    }
    ...
    implements Serializable, DoubleSortedSet
  {
    ...
    {
      if ((!bottom) && (!top) && (DoubleRBTreeSet.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (DoubleRBTreeSet.this.compare(local_k, this.from) >= 0)) && ((this.top) || (DoubleRBTreeSet.this.compare(local_k, this.field_297) < 0));
    }
    
    public boolean contains(double local_k)
    {
      return (in(local_k)) && (DoubleRBTreeSet.this.contains(local_k));
    }
    ...
    public boolean add(double local_k)
    {
      ...
      return DoubleRBTreeSet.this.add(local_k);
    }
    ...
    public boolean remove(double local_k)
    {
      ...
      return DoubleRBTreeSet.this.remove(local_k);
    }
    ...
    {
      if (this.top) {
        return new Subset(DoubleRBTreeSet.this, this.from, this.bottom, local_to, false);
      }
      return DoubleRBTreeSet.this.compare(local_to, this.field_297) < 0 ? new Subset(DoubleRBTreeSet.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public DoubleSortedSet tailSet(double from)
    {
      if (this.bottom) {
        return new Subset(DoubleRBTreeSet.this, from, false, this.field_297, this.top);
      }
      return DoubleRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(DoubleRBTreeSet.this, from, false, this.field_297, this.top) : this;
    }
    
    public DoubleSortedSet subSet(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Subset(DoubleRBTreeSet.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = DoubleRBTreeSet.this.compare(local_to, this.field_297) < 0 ? local_to : this.field_297;
      }
      if (!this.bottom) {
    ...
    public DoubleRBTreeSet.Entry firstEntry()
    {
      ...
      DoubleRBTreeSet.Entry local_e;
      DoubleRBTreeSet.Entry local_e;
      if (this.bottom)
      {
        local_e = DoubleRBTreeSet.this.firstEntry;
      }
      else
      {
        local_e = DoubleRBTreeSet.this.locateKey(this.from);
        if (DoubleRBTreeSet.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (DoubleRBTreeSet.this.compare(local_e.key, this.field_297) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public DoubleRBTreeSet.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = DoubleRBTreeSet.this.lastEntry;
      }
      else
      {
        local_e = DoubleRBTreeSet.this.locateKey(this.field_297);
        if (DoubleRBTreeSet.this.compare(local_e.key, this.field_297) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (DoubleRBTreeSet.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDouble()
    {
      DoubleRBTreeSet.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDouble()
    {
      DoubleRBTreeSet.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends DoubleRBTreeSet.SetIterator
    {
      ...
      {
        super();
        this.next = DoubleRBTreeSet.Subset.this.firstEntry();
      }
      ...
      SubsetIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!DoubleRBTreeSet.Subset.this.bottom) && (DoubleRBTreeSet.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!DoubleRBTreeSet.Subset.this.top) && (DoubleRBTreeSet.this.compare(local_k, (this.prev = DoubleRBTreeSet.Subset.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = DoubleRBTreeSet.this.locateKey(local_k);
            if (DoubleRBTreeSet.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!DoubleRBTreeSet.Subset.this.bottom) && (this.prev != null) && (DoubleRBTreeSet.this.compare(this.prev.key, DoubleRBTreeSet.Subset.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!DoubleRBTreeSet.Subset.this.top) && (this.next != null) && (DoubleRBTreeSet.this.compare(this.next.key, DoubleRBTreeSet.Subset.this.field_297) >= 0)) {
          this.next = null;
        }
      }
    }
    ...
    extends AbstractDoubleListIterator
  {
    ...
    {
      if ((this.next = DoubleRBTreeSet.this.locateKey(local_k)) != null) {
        if (DoubleRBTreeSet.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
