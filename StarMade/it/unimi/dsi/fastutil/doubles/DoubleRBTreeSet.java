...
/*   97 */           return DoubleRBTreeSet.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*      */         }
/*      */         public int compare(Double ok1, Double ok2) {
/*  100 */           return DoubleRBTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   public DoubleRBTreeSet(Iterator<? extends Double> i)
/*      */   {
...
/* 1028 */     return new Subset(0.0D, true, to, false);
/*      */   }
/*      */   public DoubleSortedSet tailSet(double from) {
/* 1031 */     return new Subset(from, false, 0.0D, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1226 */       c = (DoubleRBTreeSet)super.clone();
/*      */     }
...
/* 1279 */     while (n-- != 0) s.writeDouble(i.nextDouble());
/*      */   }
/*      */ 
...
/*      */   {
/* 1290 */     if (n == 1) {
/* 1291 */       Entry top = new Entry(s.readDouble());
/* 1292 */       top.pred(pred);
/* 1293 */       top.succ(succ);
/* 1294 */       top.black(true);
/* 1295 */       return top;
...
/* 1297 */     if (n == 2)
/*      */     {
/* 1300 */       Entry top = new Entry(s.readDouble());
/* 1301 */       top.black(true);
/* 1302 */       top.right(new Entry(s.readDouble()));
...
/*      */     {
/* 1063 */       if ((!bottom) && (!top) && (DoubleRBTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1064 */       this.from = from;
...
/*      */     {
/* 1081 */       return ((this.bottom) || (DoubleRBTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (DoubleRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(double k)
/*      */     {
/* 1086 */       return (in(k)) && (DoubleRBTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(double k) {
...
/* 1090 */       return DoubleRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(double k) {
/* 1094 */       if (!in(k)) return false;
/* 1095 */       return DoubleRBTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public DoubleComparator comparator() {
/* 1110 */       return DoubleRBTreeSet.this.actualComparator;
/*      */     }
/*      */     public DoubleBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public DoubleSortedSet headSet(double to) {
/* 1119 */       if (this.top) return new Subset(DoubleRBTreeSet.this, this.from, this.bottom, to, false);
/* 1120 */       return DoubleRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(DoubleRBTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public DoubleSortedSet tailSet(double from) {
/* 1123 */       if (this.bottom) return new Subset(DoubleRBTreeSet.this, from, false, this.to, this.top);
/* 1124 */       return DoubleRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(DoubleRBTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public DoubleSortedSet subSet(double from, double to) {
/* 1127 */       if ((this.top) && (this.bottom)) return new Subset(DoubleRBTreeSet.this, from, false, to, false);
...
/* 1131 */       return new Subset(DoubleRBTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public DoubleRBTreeSet.Entry firstEntry()
/*      */     {
/* 1138 */       if (DoubleRBTreeSet.this.tree == null) return null;
/* 1141 */       DoubleRBTreeSet.Entry e;
/*      */       DoubleRBTreeSet.Entry e;
/* 1141 */       if (this.bottom) { e = DoubleRBTreeSet.this.firstEntry;
/*      */       } else {
/* 1143 */         e = DoubleRBTreeSet.this.locateKey(this.from);
/*      */ 
/* 1145 */         if (DoubleRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1148 */       if ((e == null) || ((!this.top) && (DoubleRBTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1149 */       return e;
/*      */     }
/*      */ 
/*      */     public DoubleRBTreeSet.Entry lastEntry()
/*      */     {
/* 1156 */       if (DoubleRBTreeSet.this.tree == null) return null;
/* 1159 */       DoubleRBTreeSet.Entry e;
/*      */       DoubleRBTreeSet.Entry e;
/* 1159 */       if (this.top) { e = DoubleRBTreeSet.this.lastEntry;
/*      */       } else {
/* 1161 */         e = DoubleRBTreeSet.this.locateKey(this.to);
/*      */ 
/* 1163 */         if (DoubleRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1166 */       if ((e == null) || ((!this.bottom) && (DoubleRBTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1167 */       return e;
/*      */     }
/*      */     public double firstDouble() {
/* 1170 */       DoubleRBTreeSet.Entry e = firstEntry();
/* 1171 */       if (e == null) throw new NoSuchElementException();
/* 1172 */       return e.key;
/*      */     }
/*      */     public double lastDouble() {
/* 1175 */       DoubleRBTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1187 */         super();
/* 1188 */         this.next = DoubleRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(double k) {
/* 1191 */         this();
/* 1192 */         if (this.next != null)
/* 1193 */           if ((!DoubleRBTreeSet.Subset.this.bottom) && (DoubleRBTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1194 */           } else if ((!DoubleRBTreeSet.Subset.this.top) && (DoubleRBTreeSet.this.compare(k, (this.prev = DoubleRBTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1196 */             this.next = DoubleRBTreeSet.this.locateKey(k);
/* 1197 */             if (DoubleRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1207 */         if ((!DoubleRBTreeSet.Subset.this.bottom) && (this.prev != null) && (DoubleRBTreeSet.this.compare(this.prev.key, DoubleRBTreeSet.Subset.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1210 */         this.next = this.next.next();
/* 1211 */         if ((!DoubleRBTreeSet.Subset.this.top) && (this.next != null) && (DoubleRBTreeSet.this.compare(this.next.key, DoubleRBTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*  963 */     int index = 0;
/*      */ 
/*  965 */     SetIterator() { this.next = DoubleRBTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(double k) {
/*  968 */       if ((this.next = DoubleRBTreeSet.this.locateKey(k)) != null)
/*  969 */         if (DoubleRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/*  988 */     public double nextDouble() { return nextEntry().key; } 
/*  989 */     public double previousDouble() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1012 */       updatePrevious();
/* 1013 */       updateNext();
/* 1014 */       DoubleRBTreeSet.this.remove(this.curr.key);
/* 1015 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*      */     }
/*      */     public int hashCode() {
/*  900 */       return HashCommon.double2int(this.key);
/*      */     }
