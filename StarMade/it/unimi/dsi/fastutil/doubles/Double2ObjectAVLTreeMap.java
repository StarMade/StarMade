  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2ObjectAVLTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2ObjectAVLTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2ObjectAVLTreeMap(Map<? extends Double, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2ObjectAVLTreeMap(SortedMap<Double, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2ObjectAVLTreeMap(Double2ObjectMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2ObjectAVLTreeMap(Double2ObjectSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2ObjectAVLTreeMap(double[] local_k, V[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2ObjectAVLTreeMap(double[] local_k, V[] local_v)
  {
  ...
  {
    Double2ObjectAVLTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
  ...
  public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Double2ObjectMap.Entry<V>> comparator = new Comparator()
        {
          public int compare(Double2ObjectMap.Entry<V> local_x, Double2ObjectMap.Entry<V> local_y)
          {
            return Double2ObjectAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2ObjectAVLTreeMap.EntryIterator(Double2ObjectAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(Double2ObjectMap.Entry<V> from)
        {
          return new Double2ObjectAVLTreeMap.EntryIterator(Double2ObjectAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2ObjectAVLTreeMap.Entry<V> local_f = Double2ObjectAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2ObjectAVLTreeMap.Entry<V> local_f = Double2ObjectAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2ObjectAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> from, Double2ObjectMap.Entry<V> local_to)
        {
          return Double2ObjectAVLTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> local_to)
        {
          return Double2ObjectAVLTreeMap.this.headMap((Double)local_to.getKey()).double2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> from)
        {
          return Double2ObjectAVLTreeMap.this.tailMap((Double)from.getKey()).double2ObjectEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Double2ObjectAVLTreeMap.ValueIterator(Double2ObjectAVLTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Double2ObjectAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2ObjectAVLTreeMap<V> local_c;
    try
    {
      local_c = (Double2ObjectAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Double2ObjectAVLTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2ObjectAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Double2ObjectAVLTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Double2ObjectAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2ObjectAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator()
          {
            return new Double2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Double2ObjectAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(Double2ObjectMap.Entry<V> from)
          {
            return new Double2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Double2ObjectAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, V> local_e = (Map.Entry)local_o;
            Double2ObjectAVLTreeMap.Entry<V> local_f = Double2ObjectAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2ObjectAVLTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, V> local_e = (Map.Entry)local_o;
            Double2ObjectAVLTreeMap.Entry<V> local_f = Double2ObjectAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2ObjectAVLTreeMap.Submap.this.in7(local_f.key))) {
              Double2ObjectAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2ObjectAVLTreeMap.Submap.SubmapIterator(Double2ObjectAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2ObjectAVLTreeMap.Submap.this.clear();
          }
          
          public Double2ObjectMap.Entry<V> first()
          {
            return Double2ObjectAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Double2ObjectMap.Entry<V> last()
          {
            return Double2ObjectAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> from, Double2ObjectMap.Entry<V> local_to)
          {
            return Double2ObjectAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> local_to)
          {
            return Double2ObjectAVLTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> from)
          {
            return Double2ObjectAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Double2ObjectAVLTreeMap.Submap.SubmapValueIterator(Double2ObjectAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Double2ObjectAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2ObjectAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2ObjectAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2ObjectAVLTreeMap.Entry<V> local_e;
      return (in7(local_kk)) && ((local_e = Double2ObjectAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(double local_k, V local_v)
    {
      ...
      V oldValue = Double2ObjectAVLTreeMap.this.put(local_k, local_v);
    ...
    public V remove(double local_k)
    {
      ...
      V oldValue = Double2ObjectAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2ObjectSortedMap<V> tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2ObjectAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2ObjectAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2ObjectSortedMap<V> subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2ObjectAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2ObjectAVLTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2ObjectAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2ObjectAVLTreeMap.this.locateKey(this.from);
        if (Double2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2ObjectAVLTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2ObjectAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2ObjectAVLTreeMap.this.locateKey(this.field_47);
        if (Double2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2ObjectAVLTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2ObjectAVLTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Double2ObjectAVLTreeMap.Submap.SubmapIterator
      ...
      implements ObjectListIterator<Double2ObjectMap.Entry<V>>
    {
      ...
      public void set(Double2ObjectMap.Entry<V> local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Double2ObjectMap.Entry<V> local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
    ...
    private class SubmapIterator
      extends Double2ObjectAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Double2ObjectAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2ObjectAVLTreeMap.Submap.this.bottom) && (Double2ObjectAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2ObjectAVLTreeMap.Submap.this.top) && (Double2ObjectAVLTreeMap.this.compare(local_k, (this.prev = Double2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2ObjectAVLTreeMap.this.locateKey(local_k);
            if (Double2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2ObjectAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2ObjectAVLTreeMap.this.compare(this.prev.key, Double2ObjectAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2ObjectAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2ObjectAVLTreeMap.this.compare(this.next.key, Double2ObjectAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Double2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Double2ObjectAVLTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Double2ObjectAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2ObjectSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2ObjectAVLTreeMap.KeyIterator(Double2ObjectAVLTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2ObjectAVLTreeMap.KeyIterator(Double2ObjectAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2ObjectAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Double2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
