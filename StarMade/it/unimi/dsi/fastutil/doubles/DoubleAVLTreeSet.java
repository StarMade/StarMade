...
/*      */   {
/*   94 */     if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) this.actualComparator = ((DoubleComparator)this.storedComparator); else
/*   95 */       this.actualComparator = new DoubleComparator() {
/*      */         public int compare(double k1, double k2) {
/*   97 */           return DoubleAVLTreeSet.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*      */         }
/*      */         public int compare(Double ok1, Double ok2) {
/*  100 */           return DoubleAVLTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*   74 */     allocatePaths();
/*      */ 
/*  160 */     while (i.hasNext()) add(i.nextDouble());
/*      */   }
/*      */ 
/*      */   public DoubleAVLTreeSet(Iterator<? extends Double> i)
/*      */   {
/*  171 */     this(DoubleIterators.asDoubleIterator(i));
/*      */   }
/*      */ 
/*      */   public DoubleAVLTreeSet(double[] a, int offset, int length, Comparator<? super Double> c)
/*      */   {
/*  184 */     this(c);
/*  185 */     DoubleArrays.ensureOffsetLength(a, offset, length);
...
/* 1086 */     return new Subset(0.0D, true, to, false);
/*      */   }
/*      */   public DoubleSortedSet tailSet(double from) {
/* 1089 */     return new Subset(from, false, 0.0D, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1284 */       c = (DoubleAVLTreeSet)super.clone();
/*      */     }
...
/* 1337 */     while (n-- != 0) s.writeDouble(i.nextDouble());
/*      */   }
/*      */ 
...
/*      */   {
/* 1348 */     if (n == 1) {
/* 1349 */       Entry top = new Entry(s.readDouble());
/* 1350 */       top.pred(pred);
/* 1351 */       top.succ(succ);
/* 1352 */       return top;
/*      */     }
/* 1354 */     if (n == 2)
/*      */     {
/* 1357 */       Entry top = new Entry(s.readDouble());
/* 1358 */       top.right(new Entry(s.readDouble()));
...
/*      */   }
/*      */ 
/*      */   private final class Subset extends AbstractDoubleSortedSet
...
/*      */     {
/* 1121 */       if ((!bottom) && (!top) && (DoubleAVLTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1122 */       this.from = from;
...
/*      */     {
/* 1139 */       return ((this.bottom) || (DoubleAVLTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (DoubleAVLTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(double k)
/*      */     {
/* 1144 */       return (in(k)) && (DoubleAVLTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(double k) {
...
/* 1148 */       return DoubleAVLTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(double k) {
/* 1152 */       if (!in(k)) return false;
/* 1153 */       return DoubleAVLTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public DoubleComparator comparator() {
/* 1168 */       return DoubleAVLTreeSet.this.actualComparator;
/*      */     }
/*      */     public DoubleBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public DoubleSortedSet headSet(double to) {
/* 1177 */       if (this.top) return new Subset(DoubleAVLTreeSet.this, this.from, this.bottom, to, false);
/* 1178 */       return DoubleAVLTreeSet.this.compare(to, this.to) < 0 ? new Subset(DoubleAVLTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public DoubleSortedSet tailSet(double from) {
/* 1181 */       if (this.bottom) return new Subset(DoubleAVLTreeSet.this, from, false, this.to, this.top);
/* 1182 */       return DoubleAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(DoubleAVLTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public DoubleSortedSet subSet(double from, double to) {
/* 1185 */       if ((this.top) && (this.bottom)) return new Subset(DoubleAVLTreeSet.this, from, false, to, false);
/* 1186 */       if (!this.top) to = DoubleAVLTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1187 */       if (!this.bottom) from = DoubleAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1188 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1189 */       return new Subset(DoubleAVLTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public DoubleAVLTreeSet.Entry firstEntry()
/*      */     {
/* 1196 */       if (DoubleAVLTreeSet.this.tree == null) return null;
/* 1199 */       DoubleAVLTreeSet.Entry e;
/*      */       DoubleAVLTreeSet.Entry e;
/* 1199 */       if (this.bottom) { e = DoubleAVLTreeSet.this.firstEntry;
/*      */       } else {
/* 1201 */         e = DoubleAVLTreeSet.this.locateKey(this.from);
/*      */ 
/* 1203 */         if (DoubleAVLTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1206 */       if ((e == null) || ((!this.top) && (DoubleAVLTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1207 */       return e;
/*      */     }
/*      */ 
/*      */     public DoubleAVLTreeSet.Entry lastEntry()
/*      */     {
/* 1214 */       if (DoubleAVLTreeSet.this.tree == null) return null;
/* 1217 */       DoubleAVLTreeSet.Entry e;
/*      */       DoubleAVLTreeSet.Entry e;
/* 1217 */       if (this.top) { e = DoubleAVLTreeSet.this.lastEntry;
/*      */       } else {
/* 1219 */         e = DoubleAVLTreeSet.this.locateKey(this.to);
/*      */ 
/* 1221 */         if (DoubleAVLTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1224 */       if ((e == null) || ((!this.bottom) && (DoubleAVLTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1225 */       return e;
/*      */     }
/*      */     public double firstDouble() {
/* 1228 */       DoubleAVLTreeSet.Entry e = firstEntry();
/* 1229 */       if (e == null) throw new NoSuchElementException();
/* 1230 */       return e.key;
/*      */     }
/*      */     public double lastDouble() {
/* 1233 */       DoubleAVLTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1245 */         super();
/* 1246 */         this.next = DoubleAVLTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(double k) {
/* 1249 */         this();
/* 1250 */         if (this.next != null)
/* 1251 */           if ((!DoubleAVLTreeSet.Subset.this.bottom) && (DoubleAVLTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1252 */           } else if ((!DoubleAVLTreeSet.Subset.this.top) && (DoubleAVLTreeSet.this.compare(k, (this.prev = DoubleAVLTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1254 */             this.next = DoubleAVLTreeSet.this.locateKey(k);
/* 1255 */             if (DoubleAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1269 */         if ((!DoubleAVLTreeSet.Subset.this.top) && (this.next != null) && (DoubleAVLTreeSet.this.compare(this.next.key, DoubleAVLTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/* 1021 */     int index = 0;
/*      */ 
/* 1023 */     SetIterator() { this.next = DoubleAVLTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(double k) {
/* 1026 */       if ((this.next = DoubleAVLTreeSet.this.locateKey(k)) != null)
/* 1027 */         if (DoubleAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/* 1046 */     public double nextDouble() { return nextEntry().key; } 
/* 1047 */     public double previousDouble() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1070 */       updatePrevious();
/* 1071 */       updateNext();
/* 1072 */       DoubleAVLTreeSet.this.remove(this.curr.key);
/* 1073 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*      */     }
/*      */     public int hashCode() {
/*  958 */       return HashCommon.double2int(this.key);
/*      */     }
