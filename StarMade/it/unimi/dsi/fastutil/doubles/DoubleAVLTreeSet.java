  ...
  implements Serializable, Cloneable, DoubleSortedSet
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return DoubleAVLTreeSet.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public DoubleAVLTreeSet(Comparator<? super Double> local_c)
  {
    this();
  ...
  public DoubleAVLTreeSet(Collection<? extends Double> local_c)
  {
    this();
    addAll(local_c);
  }
  
  public DoubleAVLTreeSet(SortedSet<Double> local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public DoubleAVLTreeSet(DoubleCollection local_c)
  {
    this();
    addAll(local_c);
  }
  
  public DoubleAVLTreeSet(DoubleSortedSet local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public DoubleAVLTreeSet(DoubleIterator local_i)
  {
    allocatePaths();
  ...
  public DoubleAVLTreeSet(Iterator<? extends Double> local_i)
  {
    this(DoubleIterators.asDoubleIterator(local_i));
  }
  
  public DoubleAVLTreeSet(double[] local_a, int offset, int length, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public DoubleAVLTreeSet(double[] local_a, int offset, int length)
  {
    this(local_a, offset, length, null);
  }
  
  public DoubleAVLTreeSet(double[] local_a)
  {
    this();
  ...
  public DoubleAVLTreeSet(double[] local_a, Comparator<? super Double> local_c)
  {
    this(local_c);
    int local_i = local_a.length;
    while (local_i-- != 0) {
  ...
  private Entry findKey(double local_k)
  {
    int cmp;
  ...
  {
    return new Subset(0.0D, true, local_to, false);
  }
  ...
  public Object clone()
  {
    DoubleAVLTreeSet local_c;
    try
    {
      local_c = (DoubleAVLTreeSet)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readDouble());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readDouble());
      top.right(new Entry(local_s.readDouble()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable, DoubleSortedSet
  {
    ...
    public Subset(double from, boolean bottom, double local_to, boolean top)
    {
      if ((!bottom) && (!top) && (DoubleAVLTreeSet.this.compare(from, local_to) > 0)) {
    ...
    final boolean in(double local_k)
    {
      return ((this.bottom) || (DoubleAVLTreeSet.this.compare(local_k, this.from) >= 0)) && ((this.top) || (DoubleAVLTreeSet.this.compare(local_k, this.field_297) < 0));
    }
    
    public boolean contains(double local_k)
    {
      return (in(local_k)) && (DoubleAVLTreeSet.this.contains(local_k));
    }
    
    public boolean add(double local_k)
    {
      if (!in(local_k)) {
        throw new IllegalArgumentException("Element (" + local_k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.field_297)) + ")");
      }
      return DoubleAVLTreeSet.this.add(local_k);
    }
    ...
    public boolean remove(double local_k)
    {
      ...
      return DoubleAVLTreeSet.this.remove(local_k);
    }
    ...
    {
      if (this.top) {
        return new Subset(DoubleAVLTreeSet.this, this.from, this.bottom, local_to, false);
      }
      return DoubleAVLTreeSet.this.compare(local_to, this.field_297) < 0 ? new Subset(DoubleAVLTreeSet.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public DoubleSortedSet tailSet(double from)
    {
      if (this.bottom) {
        return new Subset(DoubleAVLTreeSet.this, from, false, this.field_297, this.top);
      }
      return DoubleAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(DoubleAVLTreeSet.this, from, false, this.field_297, this.top) : this;
    }
    
    public DoubleSortedSet subSet(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Subset(DoubleAVLTreeSet.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = DoubleAVLTreeSet.this.compare(local_to, this.field_297) < 0 ? local_to : this.field_297;
      }
      if (!this.bottom) {
        from = DoubleAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
      }
      if ((!this.top) && (!this.bottom) && (from == this.from) && (local_to == this.field_297)) {
        return this;
      }
      return new Subset(DoubleAVLTreeSet.this, from, false, local_to, false);
    }
    ...
    public DoubleAVLTreeSet.Entry firstEntry()
    {
      ...
      DoubleAVLTreeSet.Entry local_e;
      DoubleAVLTreeSet.Entry local_e;
      if (this.bottom)
      {
        local_e = DoubleAVLTreeSet.this.firstEntry;
      }
      else
      {
        local_e = DoubleAVLTreeSet.this.locateKey(this.from);
        if (DoubleAVLTreeSet.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (DoubleAVLTreeSet.this.compare(local_e.key, this.field_297) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public DoubleAVLTreeSet.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = DoubleAVLTreeSet.this.lastEntry;
      }
      else
      {
        local_e = DoubleAVLTreeSet.this.locateKey(this.field_297);
        if (DoubleAVLTreeSet.this.compare(local_e.key, this.field_297) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (DoubleAVLTreeSet.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDouble()
    {
      DoubleAVLTreeSet.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDouble()
    {
      DoubleAVLTreeSet.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends DoubleAVLTreeSet.SetIterator
    {
      ...
      {
        super();
        this.next = DoubleAVLTreeSet.Subset.this.firstEntry();
      }
      
      SubsetIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!DoubleAVLTreeSet.Subset.this.bottom) && (DoubleAVLTreeSet.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!DoubleAVLTreeSet.Subset.this.top) && (DoubleAVLTreeSet.this.compare(local_k, (this.prev = DoubleAVLTreeSet.Subset.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = DoubleAVLTreeSet.this.locateKey(local_k);
            if (DoubleAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!DoubleAVLTreeSet.Subset.this.bottom) && (this.prev != null) && (DoubleAVLTreeSet.this.compare(this.prev.key, DoubleAVLTreeSet.Subset.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!DoubleAVLTreeSet.Subset.this.top) && (this.next != null) && (DoubleAVLTreeSet.this.compare(this.next.key, DoubleAVLTreeSet.Subset.this.field_297) >= 0)) {
          this.next = null;
        }
      }
    }
    ...
    extends AbstractDoubleListIterator
  {
    ...
    SetIterator(double local_k)
    {
      if ((this.next = DoubleAVLTreeSet.this.locateKey(local_k)) != null) {
        if (DoubleAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
