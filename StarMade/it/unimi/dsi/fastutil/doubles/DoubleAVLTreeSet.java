...
/*   13:     */
/*   58:     */public class DoubleAVLTreeSet
/*   59:     */  extends AbstractDoubleSortedSet
/*   60:     */  implements Serializable, Cloneable, DoubleSortedSet
/*   61:     */{
...
/*   66:     */  protected Comparator<? super Double> storedComparator;
/*   67:     */  protected transient DoubleComparator actualComparator;
...
/*   93:     */  {
/*   94:  94 */    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) this.actualComparator = ((DoubleComparator)this.storedComparator); else {
/*   95:  95 */      this.actualComparator = new DoubleComparator() {
/*   96:     */        public int compare(double k1, double k2) {
/*   97:  97 */          return DoubleAVLTreeSet.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*   98:     */        }
/*   99:     */        
/*  100: 100 */        public int compare(Double ok1, Double ok2) { return DoubleAVLTreeSet.this.storedComparator.compare(ok1, ok2); }
/*  101:     */      };
/*  102:     */    }
/*  103:     */  }
/*  104:     */  
/*  107:     */  public DoubleAVLTreeSet(Comparator<? super Double> c)
/*  108:     */  {
/*  109: 109 */    this();
...
/*  112:     */  }
/*  113:     */  
/*  117:     */  public DoubleAVLTreeSet(Collection<? extends Double> c)
/*  118:     */  {
/*  119: 119 */    this();
/*  120: 120 */    addAll(c);
/*  121:     */  }
/*  122:     */  
/*  127:     */  public DoubleAVLTreeSet(SortedSet<Double> s)
/*  128:     */  {
/*  129: 129 */    this(s.comparator());
/*  130: 130 */    addAll(s);
/*  131:     */  }
/*  132:     */  
/*  137:     */  public DoubleAVLTreeSet(DoubleCollection c)
/*  138:     */  {
/*  139: 139 */    this();
/*  140: 140 */    addAll(c);
/*  141:     */  }
/*  142:     */  
/*  147:     */  public DoubleAVLTreeSet(DoubleSortedSet s)
/*  148:     */  {
/*  149: 149 */    this(s.comparator());
/*  150: 150 */    addAll(s);
/*  151:     */  }
/*  152:     */  
/*  153:     */  public DoubleAVLTreeSet(DoubleIterator i)
/*  154:     */  {
/*  155:  74 */    allocatePaths();
/*  156:     */    
/*  241: 160 */    while (i.hasNext()) { add(i.nextDouble());
/*  242:     */    }
/*  243:     */  }
/*  244:     */  
/*  250:     */  public DoubleAVLTreeSet(Iterator<? extends Double> i)
/*  251:     */  {
/*  252: 171 */    this(DoubleIterators.asDoubleIterator(i));
/*  253:     */  }
/*  254:     */  
/*  263:     */  public DoubleAVLTreeSet(double[] a, int offset, int length, Comparator<? super Double> c)
/*  264:     */  {
/*  265: 184 */    this(c);
/*  266: 185 */    DoubleArrays.ensureOffsetLength(a, offset, length);
/*  267: 186 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/*  268:     */    }
/*  269:     */  }
/*  270:     */  
/*  277:     */  public DoubleAVLTreeSet(double[] a, int offset, int length)
/*  278:     */  {
/*  279: 198 */    this(a, offset, length, null);
/*  280:     */  }
/*  281:     */  
/*  287:     */  public DoubleAVLTreeSet(double[] a)
/*  288:     */  {
/*  289: 208 */    this();
...
/*  293:     */  }
/*  294:     */  
/*  300:     */  public DoubleAVLTreeSet(double[] a, Comparator<? super Double> c)
/*  301:     */  {
/*  302: 221 */    this(c);
...
/*  353:     */  }
/*  354:     */  
/*  361:     */  final Entry locateKey(double k)
/*  362:     */  {
...
/*  381:     */  }
/*  382:     */  
/*  384:     */  public boolean add(double k)
/*  385:     */  {
...
/*  870:     */  }
/*  871:     */  
/*  874: 793 */  public boolean contains(double k) { return findKey(k) != null; }
/*  875:     */  
...
/* 1037:     */    }
/* 1038:     */    
/* 1039: 958 */    public int hashCode() { return HashCommon.double2int(this.key); }
/* 1040:     */    
...
/* 1081:     */  
/* 1082:     */  public double firstDouble() {
/* 1083:1002 */    if (this.tree == null) throw new NoSuchElementException();
/* 1084:1003 */    return this.firstEntry.key;
/* 1085:     */  }
/* 1086:     */  
/* 1087:1006 */  public double lastDouble() { if (this.tree == null) throw new NoSuchElementException();
/* 1088:1007 */    return this.lastEntry.key;
/* 1089:     */  }
/* 1090:     */  
/* 1093:     */  private class SetIterator
/* 1094:     */    extends AbstractDoubleListIterator
/* 1095:     */  {
/* 1096:     */    DoubleAVLTreeSet.Entry prev;
/* 1097:     */    
/* 1098:     */    DoubleAVLTreeSet.Entry next;
/* 1099:     */    
/* 1100:     */    DoubleAVLTreeSet.Entry curr;
/* 1101:     */    
/* 1102:1021 */    int index = 0;
/* 1103:     */    
/* 1104:1023 */    SetIterator() { this.next = DoubleAVLTreeSet.this.firstEntry; }
/* 1105:     */    
/* 1106:     */    SetIterator(double k) {
/* 1107:1026 */      if ((this.next = DoubleAVLTreeSet.this.locateKey(k)) != null)
/* 1108:1027 */        if (DoubleAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1119:     */    
/* 1120:     */    DoubleAVLTreeSet.Entry nextEntry() {
...
/* 1126:     */    
/* 1127:1046 */    public double nextDouble() { return nextEntry().key; }
/* 1128:1047 */    public double previousDouble() { return previousEntry().key; }
/* 1129:     */    
/* 1130:1049 */    void updatePrevious() { this.prev = this.prev.prev(); }
/* 1131:     */    
/* 1132:     */    DoubleAVLTreeSet.Entry previousEntry() {
...
/* 1153:1072 */      DoubleAVLTreeSet.this.remove(this.curr.key);
/* 1154:1073 */      this.curr = null;
/* 1155:     */    }
/* 1156:     */  }
/* 1157:     */  
/* 1158:1077 */  public DoubleBidirectionalIterator iterator() { return new SetIterator(); }
/* 1159:     */  
/* 1160:     */  public DoubleBidirectionalIterator iterator(double from) {
/* 1161:1080 */    return new SetIterator(from);
/* 1162:     */  }
/* 1163:     */  
/* 1164:1083 */  public DoubleComparator comparator() { return this.actualComparator; }
/* 1165:     */  
/* 1166:     */  public DoubleSortedSet headSet(double to) {
/* 1167:1086 */    return new Subset(0.0D, true, to, false);
/* 1168:     */  }
/* 1169:     */  
/* 1170:1089 */  public DoubleSortedSet tailSet(double from) { return new Subset(from, false, 0.0D, true); }
/* 1171:     */  
/* 1172:     */  public DoubleSortedSet subSet(double from, double to) {
/* 1173:1092 */    return new Subset(from, false, to, false);
/* 1174:     */  }
/* 1175:     */  
/* 1179:     */  private final class Subset
/* 1180:     */    extends AbstractDoubleSortedSet
/* 1181:     */    implements Serializable, DoubleSortedSet
/* 1182:     */  {
...
/* 1196:     */    boolean top;
/* 1197:     */    
/* 1200:     */    public Subset(double from, boolean bottom, double to, boolean top)
/* 1201:     */    {
/* 1202:1121 */      if ((!bottom) && (!top) && (DoubleAVLTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
...
/* 1214:     */    }
/* 1215:     */    
/* 1218:     */    final boolean in(double k)
/* 1219:     */    {
/* 1220:1139 */      return ((this.bottom) || (DoubleAVLTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (DoubleAVLTreeSet.this.compare(k, this.to) < 0));
/* 1221:     */    }
/* 1222:     */    
/* 1225:1144 */    public boolean contains(double k) { return (in(k)) && (DoubleAVLTreeSet.this.contains(k)); }
/* 1226:     */    
/* 1227:     */    public boolean add(double k) {
...
/* 1229:1148 */      return DoubleAVLTreeSet.this.add(k);
/* 1230:     */    }
/* 1231:     */    
/* 1232:     */    public boolean remove(double k) {
/* 1233:1152 */      if (!in(k)) return false;
/* 1234:1153 */      return DoubleAVLTreeSet.this.remove(k);
/* 1235:     */    }
/* 1236:     */    
...
/* 1247:     */    
/* 1248:     */    public DoubleComparator comparator() {
/* 1249:1168 */      return DoubleAVLTreeSet.this.actualComparator;
/* 1250:     */    }
/* 1251:     */    
/* 1252:1171 */    public DoubleBidirectionalIterator iterator() { return new SubsetIterator(); }
/* 1253:     */    
/* 1255:1174 */    public DoubleBidirectionalIterator iterator(double from) { return new SubsetIterator(from); }
/* 1256:     */    
/* 1257:     */    public DoubleSortedSet headSet(double to) {
/* 1258:1177 */      if (this.top) return new Subset(DoubleAVLTreeSet.this, this.from, this.bottom, to, false);
/* 1259:1178 */      return DoubleAVLTreeSet.this.compare(to, this.to) < 0 ? new Subset(DoubleAVLTreeSet.this, this.from, this.bottom, to, false) : this;
/* 1260:     */    }
/* 1261:     */    
/* 1262:1181 */    public DoubleSortedSet tailSet(double from) { if (this.bottom) return new Subset(DoubleAVLTreeSet.this, from, false, this.to, this.top);
/* 1263:1182 */      return DoubleAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(DoubleAVLTreeSet.this, from, false, this.to, this.top) : this;
/* 1264:     */    }
/* 1265:     */    
/* 1266:1185 */    public DoubleSortedSet subSet(double from, double to) { if ((this.top) && (this.bottom)) return new Subset(DoubleAVLTreeSet.this, from, false, to, false);
/* 1267:1186 */      if (!this.top) to = DoubleAVLTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1268:1187 */      if (!this.bottom) from = DoubleAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1269:1188 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1270:1189 */      return new Subset(DoubleAVLTreeSet.this, from, false, to, false);
/* 1271:     */    }
/* 1272:     */    
/* 1275:     */    public DoubleAVLTreeSet.Entry firstEntry()
/* 1276:     */    {
/* 1277:1196 */      if (DoubleAVLTreeSet.this.tree == null) return null;
/* 1278:     */      DoubleAVLTreeSet.Entry e;
/* 1279:     */      DoubleAVLTreeSet.Entry e;
/* 1280:1199 */      if (this.bottom) { e = DoubleAVLTreeSet.this.firstEntry;
/* 1281:     */      } else {
/* 1282:1201 */        e = DoubleAVLTreeSet.this.locateKey(this.from);
/* 1283:     */        
/* 1284:1203 */        if (DoubleAVLTreeSet.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1285:     */        }
/* 1286:     */      }
/* 1287:1206 */      if ((e == null) || ((!this.top) && (DoubleAVLTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1288:1207 */      return e;
/* 1289:     */    }
/* 1290:     */    
/* 1293:     */    public DoubleAVLTreeSet.Entry lastEntry()
/* 1294:     */    {
/* 1295:1214 */      if (DoubleAVLTreeSet.this.tree == null) return null;
/* 1296:     */      DoubleAVLTreeSet.Entry e;
/* 1297:     */      DoubleAVLTreeSet.Entry e;
/* 1298:1217 */      if (this.top) { e = DoubleAVLTreeSet.this.lastEntry;
/* 1299:     */      } else {
/* 1300:1219 */        e = DoubleAVLTreeSet.this.locateKey(this.to);
/* 1301:     */        
/* 1302:1221 */        if (DoubleAVLTreeSet.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1303:     */        }
/* 1304:     */      }
/* 1305:1224 */      if ((e == null) || ((!this.bottom) && (DoubleAVLTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1306:1225 */      return e;
/* 1307:     */    }
/* 1308:     */    
/* 1309:1228 */    public double firstDouble() { DoubleAVLTreeSet.Entry e = firstEntry();
/* 1310:1229 */      if (e == null) throw new NoSuchElementException();
/* 1311:1230 */      return e.key;
/* 1312:     */    }
/* 1313:     */    
/* 1314:1233 */    public double lastDouble() { DoubleAVLTreeSet.Entry e = lastEntry();
/* 1315:1234 */      if (e == null) throw new NoSuchElementException();
/* 1316:1235 */      return e.key;
/* 1317:     */    }
/* 1318:     */    
/* 1321:     */    private final class SubsetIterator
/* 1322:     */      extends DoubleAVLTreeSet.SetIterator
/* 1323:     */    {
/* 1324:     */      SubsetIterator()
/* 1325:     */      {
/* 1326:1245 */        super();
/* 1327:1246 */        this.next = DoubleAVLTreeSet.Subset.this.firstEntry();
/* 1328:     */      }
/* 1329:     */      
/* 1330:1249 */      SubsetIterator(double k) { this();
/* 1331:1250 */        if (this.next != null)
/* 1332:1251 */          if ((!DoubleAVLTreeSet.Subset.this.bottom) && (DoubleAVLTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1333:1252 */          } else if ((!DoubleAVLTreeSet.Subset.this.top) && (DoubleAVLTreeSet.this.compare(k, (this.prev = DoubleAVLTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1334:     */          } else {
/* 1335:1254 */            this.next = DoubleAVLTreeSet.this.locateKey(k);
/* 1336:1255 */            if (DoubleAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1346:1265 */        if ((!DoubleAVLTreeSet.Subset.this.bottom) && (this.prev != null) && (DoubleAVLTreeSet.this.compare(this.prev.key, DoubleAVLTreeSet.Subset.this.from) < 0)) this.prev = null;
/* 1347:     */      }
/* 1348:     */      
/* 1349:1268 */      void updateNext() { this.next = this.next.next();
/* 1350:1269 */        if ((!DoubleAVLTreeSet.Subset.this.top) && (this.next != null) && (DoubleAVLTreeSet.this.compare(this.next.key, DoubleAVLTreeSet.Subset.this.to) >= 0)) { this.next = null;
/* 1351:     */        }
/* 1352:     */      }
/* 1353:     */    }
/* 1354:     */  }
...
/* 1359:     */  {
/* 1360:     */    DoubleAVLTreeSet c;
/* 1361:     */    
/* 1363:     */    try
/* 1364:     */    {
/* 1365:1284 */      c = (DoubleAVLTreeSet)super.clone();
/* 1366:     */    }
...
/* 1418:1337 */    while (n-- != 0) { s.writeDouble(i.nextDouble());
/* 1419:     */    }
/* 1420:     */  }
/* 1421:     */  
...
/* 1428:     */  {
/* 1429:1348 */    if (n == 1) {
/* 1430:1349 */      Entry top = new Entry(s.readDouble());
...
/* 1435:1354 */    if (n == 2)
/* 1436:     */    {
/* 1438:1357 */      Entry top = new Entry(s.readDouble());
/* 1439:1358 */      top.right(new Entry(s.readDouble()));
...
/* 1450:1369 */    top.key = s.readDouble();
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.doubles.DoubleAVLTreeSet
