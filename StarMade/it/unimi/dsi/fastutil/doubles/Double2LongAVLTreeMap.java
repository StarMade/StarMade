  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2LongAVLTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2LongAVLTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2LongAVLTreeMap(Map<? extends Double, ? extends Long> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2LongAVLTreeMap(SortedMap<Double, Long> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2LongAVLTreeMap(Double2LongMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2LongAVLTreeMap(Double2LongSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2LongAVLTreeMap(double[] local_k, long[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2LongAVLTreeMap(double[] local_k, long[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Double2LongMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Double2LongAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2LongAVLTreeMap.EntryIterator(Double2LongAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry from)
        {
          return new Double2LongAVLTreeMap.EntryIterator(Double2LongAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2LongAVLTreeMap.Entry local_f = Double2LongAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2LongAVLTreeMap.Entry local_f = Double2LongAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2LongAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Double2LongAVLTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2LongEntrySet();
        }
        
        public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry local_to)
        {
          return Double2LongAVLTreeMap.this.headMap((Double)local_to.getKey()).double2LongEntrySet();
        }
        
        public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry from)
        {
          return Double2LongAVLTreeMap.this.tailMap((Double)from.getKey()).double2LongEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Double2LongAVLTreeMap.ValueIterator(Double2LongAVLTreeMap.this, null);
        }
        
        public boolean contains(long local_k)
        {
          return Double2LongAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2LongAVLTreeMap local_c;
    try
    {
      local_c = (Double2LongAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2LongAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Double2LongAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2LongAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator()
          {
            return new Double2LongAVLTreeMap.Submap.SubmapEntryIterator(Double2LongAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry from)
          {
            return new Double2LongAVLTreeMap.Submap.SubmapEntryIterator(Double2LongAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, Long> local_e = (Map.Entry)local_o;
            Double2LongAVLTreeMap.Entry local_f = Double2LongAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2LongAVLTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, Long> local_e = (Map.Entry)local_o;
            Double2LongAVLTreeMap.Entry local_f = Double2LongAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2LongAVLTreeMap.Submap.this.in7(local_f.key))) {
              Double2LongAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2LongAVLTreeMap.Submap.SubmapIterator(Double2LongAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2LongAVLTreeMap.Submap.this.clear();
          }
          
          public Double2LongMap.Entry first()
          {
            return Double2LongAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Double2LongMap.Entry last()
          {
            return Double2LongAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2LongMap.Entry> subSet(Double2LongMap.Entry from, Double2LongMap.Entry local_to)
          {
            return Double2LongAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2LongEntrySet();
          }
          
          public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry local_to)
          {
            return Double2LongAVLTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2LongEntrySet();
          }
          
          public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry from)
          {
            return Double2LongAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2LongEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public LongCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractLongCollection()
        {
          public LongIterator iterator()
          {
            return new Double2LongAVLTreeMap.Submap.SubmapValueIterator(Double2LongAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(long local_k)
          {
            return Double2LongAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2LongAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2LongAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2LongAVLTreeMap.Entry local_e;
      return (in7(local_kk)) && ((local_e = Double2LongAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public long put(double local_k, long local_v)
    {
      ...
      long oldValue = Double2LongAVLTreeMap.this.put(local_k, local_v);
    ...
    public long remove(double local_k)
    {
      ...
      long oldValue = Double2LongAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2LongAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2LongAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2LongSortedMap tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2LongAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2LongAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2LongAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2LongSortedMap subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2LongAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2LongAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2LongAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2LongAVLTreeMap.this.locateKey(this.from);
        if (Double2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2LongAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2LongAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2LongAVLTreeMap.this.locateKey(this.field_47);
        if (Double2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2LongAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2LongAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Double2LongAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Double2LongAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2LongAVLTreeMap.Submap.this.bottom) && (Double2LongAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2LongAVLTreeMap.Submap.this.top) && (Double2LongAVLTreeMap.this.compare(local_k, (this.prev = Double2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2LongAVLTreeMap.this.locateKey(local_k);
            if (Double2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2LongAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2LongAVLTreeMap.this.compare(this.prev.key, Double2LongAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2LongAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2LongAVLTreeMap.this.compare(this.next.key, Double2LongAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2LongSortedMap.KeySet
    {
      ...
      {
        return new Double2LongAVLTreeMap.Submap.SubmapKeyIterator(Double2LongAVLTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2LongAVLTreeMap.Submap.SubmapKeyIterator(Double2LongAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2LongSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2LongAVLTreeMap.KeyIterator(Double2LongAVLTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2LongAVLTreeMap.KeyIterator(Double2LongAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2LongAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Double2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
