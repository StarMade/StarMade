...
/*      */ 
/*      */ public class Double2LongAVLTreeMap extends AbstractDouble2LongSortedMap
...
/*  117 */           return Double2LongAVLTreeMap.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*      */         }
/*      */         public int compare(Double ok1, Double ok2) {
/*  120 */           return Double2LongAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     long oldValue = put(ok.doubleValue(), ov.longValue());
/*  780 */     return this.modified ? null : Long.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Long remove(Object ok)
/*      */   {
/*  788 */     long oldValue = remove(((Double)ok).doubleValue());
...
/* 1203 */         final Comparator<? super Double2LongMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Double2LongMap.Entry x, Double2LongMap.Entry y) {
/* 1205 */             return Double2LongAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Double2LongAVLTreeMap.EntryIterator(Double2LongAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry from) {
/* 1215 */           return new Double2LongAVLTreeMap.EntryIterator(Double2LongAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Double2LongAVLTreeMap.Entry f = Double2LongAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1228 */           Double2LongAVLTreeMap.Entry f = Double2LongAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1229 */           if (f != null) Double2LongAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Double2LongAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Double2LongAVLTreeMap.this.clear(); } 
/* 1234 */         public Double2LongMap.Entry first() { return Double2LongAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Double2LongMap.Entry last() { return Double2LongAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Double2LongMap.Entry> subSet(Double2LongMap.Entry from, Double2LongMap.Entry to) { return Double2LongAVLTreeMap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2LongEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry to) { return Double2LongAVLTreeMap.this.headMap((Double)to.getKey()).double2LongEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry from) { return Double2LongAVLTreeMap.this.tailMap((Double)from.getKey()).double2LongEntrySet(); }
/*      */       };
...
/* 1304 */           return new Double2LongAVLTreeMap.ValueIterator(Double2LongAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(long k) {
/* 1307 */           return Double2LongAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Double2LongAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Double2LongAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Double2LongAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readDouble(), s.readLong());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readDouble(), s.readLong());
/* 1759 */       top.right(new Entry(s.readDouble(), s.readLong()));
...
/*      */   }
/*      */ 
/*      */   private final class Submap extends AbstractDouble2LongSortedMap
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Double2LongAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Double2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Double2LongAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Double2LongAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Double2LongMap.Entry> double2LongEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator() {
/* 1391 */             return new Double2LongAVLTreeMap.Submap.SubmapEntryIterator(Double2LongAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Double2LongMap.Entry> iterator(Double2LongMap.Entry from) {
/* 1394 */             return new Double2LongAVLTreeMap.Submap.SubmapEntryIterator(Double2LongAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
/*      */           }
/* 1396 */           public Comparator<? super Double2LongMap.Entry> comparator() { return Double2LongAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Double2LongAVLTreeMap.Entry f = Double2LongAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1402 */             return (f != null) && (Double2LongAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Double2LongAVLTreeMap.Entry f = Double2LongAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1409 */             if ((f != null) && (Double2LongAVLTreeMap.Submap.this.in(f.key))) Double2LongAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Double2LongAVLTreeMap.Submap.SubmapIterator(Double2LongAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Double2LongAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Double2LongMap.Entry first() { return Double2LongAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Double2LongMap.Entry last() { return Double2LongAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Double2LongMap.Entry> subSet(Double2LongMap.Entry from, Double2LongMap.Entry to) { return Double2LongAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2LongEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Double2LongMap.Entry> headSet(Double2LongMap.Entry to) { return Double2LongAVLTreeMap.Submap.this.headMap((Double)to.getKey()).double2LongEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Double2LongMap.Entry> tailSet(Double2LongMap.Entry from) { return Double2LongAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2LongEntrySet(); }
/*      */         };
...
/*      */           public LongIterator iterator() {
/* 1442 */             return new Double2LongAVLTreeMap.Submap.SubmapValueIterator(Double2LongAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(long k) {
/* 1445 */             return Double2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Double2LongAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Double2LongAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(double k) {
/* 1458 */       return (in(k)) && (Double2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(long v) {
...
/* 1473 */       return (in(kk)) && ((e = Double2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public long put(double k, long v) {
/* 1476 */       Double2LongAVLTreeMap.this.modified = false;
...
/* 1478 */       long oldValue = Double2LongAVLTreeMap.this.put(k, v);
/* 1479 */       return Double2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Long put(Double ok, Long ov) {
/* 1482 */       long oldValue = put(ok.doubleValue(), ov.longValue());
/* 1483 */       return Double2LongAVLTreeMap.this.modified ? null : Long.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public long remove(double k) {
/* 1487 */       Double2LongAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       long oldValue = Double2LongAVLTreeMap.this.remove(k);
/* 1490 */       return Double2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Long remove(Object ok) {
/* 1493 */       long oldValue = remove(((Double)ok).doubleValue());
/* 1494 */       return Double2LongAVLTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public DoubleComparator comparator() {
/* 1509 */       return Double2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Double2LongSortedMap headMap(double to) {
/* 1512 */       if (this.top) return new Submap(Double2LongAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Double2LongAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Double2LongAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Double2LongSortedMap tailMap(double from) {
/* 1516 */       if (this.bottom) return new Submap(Double2LongAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Double2LongAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2LongAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Double2LongSortedMap subMap(double from, double to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Double2LongAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Double2LongAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Double2LongAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Double2LongAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Double2LongAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Double2LongAVLTreeMap.this.tree == null) return null;
/* 1534 */       Double2LongAVLTreeMap.Entry e;
/*      */       Double2LongAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Double2LongAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Double2LongAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Double2LongAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Double2LongAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Double2LongAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Double2LongAVLTreeMap.this.tree == null) return null;
/* 1552 */       Double2LongAVLTreeMap.Entry e;
/*      */       Double2LongAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Double2LongAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Double2LongAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Double2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Double2LongAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public double firstDoubleKey() {
/* 1563 */       Double2LongAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public double lastDoubleKey() {
/* 1568 */       Double2LongAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Double firstKey() {
/* 1573 */       Double2LongAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Double lastKey() {
/* 1578 */       Double2LongAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Double2LongAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Double2LongAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Double2LongAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Double2LongMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Double2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(double k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Double2LongAVLTreeMap.Submap.this.bottom) && (Double2LongAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Double2LongAVLTreeMap.Submap.this.top) && (Double2LongAVLTreeMap.this.compare(k, (this.prev = Double2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Double2LongAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Double2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Double2LongAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2LongAVLTreeMap.this.compare(this.prev.key, Double2LongAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Double2LongAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2LongAVLTreeMap.this.compare(this.next.key, Double2LongAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public DoubleBidirectionalIterator iterator() { return new Double2LongAVLTreeMap.Submap.SubmapKeyIterator(Double2LongAVLTreeMap.Submap.this); } 
/* 1433 */       public DoubleBidirectionalIterator iterator(double from) { return new Double2LongAVLTreeMap.Submap.SubmapKeyIterator(Double2LongAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2LongAVLTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public DoubleBidirectionalIterator iterator() { return new Double2LongAVLTreeMap.KeyIterator(Double2LongAVLTreeMap.this); } 
/* 1263 */     public DoubleBidirectionalIterator iterator(double from) { return new Double2LongAVLTreeMap.KeyIterator(Double2LongAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2LongAVLTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2LongAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Double2LongMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Double2LongMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Double2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Double2LongAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(double k) {
/* 1129 */       if ((this.next = Double2LongAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Double2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Double2LongAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/* 1042 */       return HashCommon.double2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
