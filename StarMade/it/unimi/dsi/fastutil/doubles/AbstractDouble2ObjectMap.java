...
/*   5:    */import it.unimi.dsi.fastutil.objects.AbstractObjectIterator;
...
/*  14:    */
/*  61:    */public abstract class AbstractDouble2ObjectMap<V>
/*  62:    */  extends AbstractDouble2ObjectFunction<V>
/*  63:    */  implements Double2ObjectMap<V>, Serializable
/*  64:    */{
...
/*  85: 85 */    if ((m instanceof Double2ObjectMap))
/*  86:    */    {
/*  87: 87 */      while (n-- != 0) {
/*  88: 88 */        Double2ObjectMap.Entry<? extends V> e = (Double2ObjectMap.Entry)i.next();
...
/* 106:    */    implements Double2ObjectMap.Entry<V>
/* 107:    */  {
...
/* 153:153 */      return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public int hashCode() { return HashCommon.double2int(this.key) ^ (this.value == null ? 0 : this.value.hashCode()); }
/* 157:    */    
...
/* 175:175 */      public boolean contains(double k) { return AbstractDouble2ObjectMap.this.containsKey(k); }
/* 176:176 */      public int size() { return AbstractDouble2ObjectMap.this.size(); }
/* 177:177 */      public void clear() { AbstractDouble2ObjectMap.this.clear(); }
/* 178:    */      
/* 179:179 */      public DoubleIterator iterator() { new AbstractDoubleIterator() {
/* 180:180 */          final ObjectIterator<Map.Entry<Double, V>> i = AbstractDouble2ObjectMap.this.entrySet().iterator();
/* 181:181 */          public double nextDouble() { return ((Double2ObjectMap.Entry)this.i.next()).getDoubleKey(); }
...
/* 200:200 */      public boolean contains(Object k) { return AbstractDouble2ObjectMap.this.containsValue(k); }
/* 201:201 */      public int size() { return AbstractDouble2ObjectMap.this.size(); }
/* 202:202 */      public void clear() { AbstractDouble2ObjectMap.this.clear(); }
/* 203:    */      
/* 204:204 */      public ObjectIterator<V> iterator() { new AbstractObjectIterator() {
/* 205:205 */          final ObjectIterator<Map.Entry<Double, V>> i = AbstractDouble2ObjectMap.this.entrySet().iterator();
/* 206:206 */          public V next() { return ((Double2ObjectMap.Entry)this.i.next()).getValue(); }
...
/* 213:    */  {
/* 214:214 */    return double2ObjectEntrySet();
/* 215:    */  }
/* 216:    */  
...
/* 244:244 */        s.append(", ");
/* 245:245 */      Double2ObjectMap.Entry<V> e = (Double2ObjectMap.Entry)i.next();
