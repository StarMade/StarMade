  ...
  implements Serializable, Cloneable
{
  ...
  public Double2ByteArrayMap(Double2ByteMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Double2ByteArrayMap(Map<? extends Double, ? extends Byte> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Double2ByteArrayMap local_c;
    try
    {
      local_c = (Double2ByteArrayMap)super.clone();
    }
    ...
    implements Double2ByteMap.FastEntrySet
  {
    ...
    public ObjectIterator<Double2ByteMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Double2ByteMap.Entry next()
        {
          ...
          return new AbstractDouble2ByteMap.BasicEntry(Double2ByteArrayMap.this.key[this.next], Double2ByteArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Double2ByteMap.Entry> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Double2ByteMap.Entry next()
        {
          ...
          this.entry.key = Double2ByteArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Double2ByteArrayMap.this.containsKey(local_k)) && (Double2ByteArrayMap.this.get(local_k) == ((Byte)local_e.getValue()).byteValue());
    }
  }
}
