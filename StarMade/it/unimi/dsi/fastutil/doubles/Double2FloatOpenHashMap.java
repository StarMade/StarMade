...
/* 642 */           return new Double2FloatOpenHashMap.ValueIterator(Double2FloatOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Double2FloatOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(float v) {
/* 648 */           return Double2FloatOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Double2FloatOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Double2FloatOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Double2FloatOpenHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public float nextFloat() { return Double2FloatOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Float next() { return Float.valueOf(Double2FloatOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Double2FloatOpenHashMap.KeyIterator(Double2FloatOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Double2FloatOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(double k) {
/* 613 */       return Double2FloatOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(double k) {
/* 616 */       int oldSize = Double2FloatOpenHashMap.this.size;
/* 617 */       Double2FloatOpenHashMap.this.remove(k);
/* 618 */       return Double2FloatOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Double2FloatOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Double2FloatOpenHashMap.MapIterator
/*     */     implements DoubleIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public double nextDouble() { return Double2FloatOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Double next() { return Double.valueOf(Double2FloatOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Double2FloatOpenHashMap.EntryIterator(Double2FloatOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Double2FloatMap.Entry> fastIterator() {
/* 550 */       return new Double2FloatOpenHashMap.FastEntryIterator(Double2FloatOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2FloatOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Double2FloatOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Double2FloatOpenHashMap.this.key[pos] == k) return Double2FloatOpenHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 562 */         pos = pos + 1 & Double2FloatOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2FloatOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Double2FloatOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Double2FloatOpenHashMap.this.key[pos] == k) {
/* 576 */           Double2FloatOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Double2FloatOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Double2FloatOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Double2FloatOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Double2FloatOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Double2FloatMap.Entry>
/*     */   {
/* 537 */     final AbstractDouble2FloatMap.BasicEntry entry = new AbstractDouble2FloatMap.BasicEntry(0.0D, 0.0F);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Double2FloatOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Double2FloatOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Double2FloatOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Double2FloatMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Double2FloatOpenHashMap.MapEntry(Double2FloatOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Double2FloatOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Double2FloatOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Double2FloatOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Double2FloatOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2FloatOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Double2FloatOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Double2FloatOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Double2FloatOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Double2FloatOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Double2FloatOpenHashMap.this.mask;
/* 485 */         while (Double2FloatOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2FloatOpenHashMap.this.key[pos])) & Double2FloatOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Double2FloatOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Double2FloatOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new DoubleArrayList();
/* 494 */           this.wrapped.add(Double2FloatOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Double2FloatOpenHashMap.this.key[last] = Double2FloatOpenHashMap.this.key[pos];
/* 497 */         Double2FloatOpenHashMap.this.value[last] = Double2FloatOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Double2FloatOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Double2FloatOpenHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Double2FloatOpenHashMap.this.size -= 1;
...
/* 398 */       return Double.valueOf(Double2FloatOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public double getDoubleKey() {
/* 401 */       return Double2FloatOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Float getValue() {
/* 404 */       return Float.valueOf(Double2FloatOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public float getFloatValue() {
/* 407 */       return Double2FloatOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public float setValue(float v) {
/* 410 */       float oldValue = Double2FloatOpenHashMap.this.value[this.index];
/* 411 */       Double2FloatOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Float setValue(Float v) {
...
/* 421 */       return (Double2FloatOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2FloatOpenHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return HashCommon.double2int(Double2FloatOpenHashMap.this.key[this.index]) ^ HashCommon.float2int(Double2FloatOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 427 */       return Double2FloatOpenHashMap.this.key[this.index] + "=>" + Double2FloatOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
