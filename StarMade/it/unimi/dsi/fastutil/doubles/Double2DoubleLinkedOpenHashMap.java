...
/*  786 */   public Double2DoubleSortedMap tailMap(double from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Double2DoubleSortedMap headMap(double to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Double2DoubleSortedMap subMap(double from, double to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Double2DoubleLinkedOpenHashMap.ValueIterator(Double2DoubleLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Double2DoubleLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(double v) {
/* 1113 */           return Double2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Double2DoubleLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Double2DoubleLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public double previousDouble()
/*      */     {
/* 1094 */       return Double2DoubleLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Double previous() { return Double.valueOf(Double2DoubleLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public double nextDouble() { return Double2DoubleLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Double next() { return Double.valueOf(Double2DoubleLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Double2DoubleLinkedOpenHashMap.KeyIterator(Double2DoubleLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public DoubleListIterator iterator() {
/* 1054 */       return new Double2DoubleLinkedOpenHashMap.KeyIterator(Double2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Double2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(double k) {
/* 1060 */       return Double2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(double k) {
/* 1063 */       int oldSize = Double2DoubleLinkedOpenHashMap.this.size;
/* 1064 */       Double2DoubleLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Double2DoubleLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Double2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public double firstDouble() {
/* 1071 */       if (Double2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Double2DoubleLinkedOpenHashMap.this.key[Double2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public double lastDouble() {
/* 1075 */       if (Double2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Double2DoubleLinkedOpenHashMap.this.key[Double2DoubleLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator(double k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public double previousDouble() { return Double2DoubleLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Double previous() { return Double.valueOf(Double2DoubleLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public double nextDouble() { return Double2DoubleLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Double next() { return Double.valueOf(Double2DoubleLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Double2DoubleLinkedOpenHashMap.EntryIterator(Double2DoubleLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Double2DoubleMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Double2DoubleMap.Entry> subSet(Double2DoubleMap.Entry fromElement, Double2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Double2DoubleMap.Entry> headSet(Double2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Double2DoubleMap.Entry> tailSet(Double2DoubleMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Double2DoubleMap.Entry first() {
/*  973 */       if (Double2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Double2DoubleLinkedOpenHashMap.MapEntry(Double2DoubleLinkedOpenHashMap.this, Double2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Double2DoubleMap.Entry last() {
/*  977 */       if (Double2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Double2DoubleLinkedOpenHashMap.MapEntry(Double2DoubleLinkedOpenHashMap.this, Double2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Double2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Double2DoubleLinkedOpenHashMap.this.key[pos] == k) return Double2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/*  990 */         pos = pos + 1 & Double2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Double2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Double2DoubleLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Double2DoubleLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Double2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Double2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Double2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2DoubleMap.Entry> iterator(Double2DoubleMap.Entry from) {
/* 1018 */       return new Double2DoubleLinkedOpenHashMap.EntryIterator(Double2DoubleLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2DoubleMap.Entry> fastIterator() {
/* 1021 */       return new Double2DoubleLinkedOpenHashMap.FastEntryIterator(Double2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2DoubleMap.Entry> fastIterator(Double2DoubleMap.Entry from) {
/* 1024 */       return new Double2DoubleLinkedOpenHashMap.FastEntryIterator(Double2DoubleLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Double2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Double2DoubleMap.Entry>
/*      */   {
/*  944 */     final AbstractDouble2DoubleMap.BasicEntry entry = new AbstractDouble2DoubleMap.BasicEntry(0.0D, 0.0D);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Double2DoubleLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Double2DoubleLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractDouble2DoubleMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Double2DoubleLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Double2DoubleLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Double2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Double2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Double2DoubleMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Double2DoubleLinkedOpenHashMap.MapEntry(Double2DoubleLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Double2DoubleLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Double2DoubleLinkedOpenHashMap.MapEntry(Double2DoubleLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Double2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Double2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Double2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Double2DoubleLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(double from) {
/*  809 */       if (Double2DoubleLinkedOpenHashMap.this.key[Double2DoubleLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Double2DoubleLinkedOpenHashMap.this.last;
/*  811 */         this.index = Double2DoubleLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Double2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Double2DoubleLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Double2DoubleLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Double2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Double2DoubleLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Double2DoubleLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Double2DoubleLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Double2DoubleLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Double2DoubleLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Double2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Double2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Double2DoubleLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Double2DoubleLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Double2DoubleLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Double2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Double2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Double2DoubleLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Double2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Double2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Double2DoubleLinkedOpenHashMap.this.mask;
/*  897 */         while (Double2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2DoubleLinkedOpenHashMap.this.key[pos])) & Double2DoubleLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Double2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Double2DoubleLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Double2DoubleLinkedOpenHashMap.this.key[last] = Double2DoubleLinkedOpenHashMap.this.key[pos];
/*  904 */         Double2DoubleLinkedOpenHashMap.this.value[last] = Double2DoubleLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Double2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Double2DoubleLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*  669 */       return Double.valueOf(Double2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public double getDoubleKey() {
/*  672 */       return Double2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Double getValue() {
/*  675 */       return Double.valueOf(Double2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public double getDoubleValue() {
/*  678 */       return Double2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public double setValue(double v) {
/*  681 */       double oldValue = Double2DoubleLinkedOpenHashMap.this.value[this.index];
/*  682 */       Double2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Double setValue(Double v) {
...
/*  692 */       return (Double2DoubleLinkedOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.double2int(Double2DoubleLinkedOpenHashMap.this.key[this.index]) ^ HashCommon.double2int(Double2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Double2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Double2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
