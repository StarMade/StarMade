  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2BooleanLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Double2BooleanLinkedOpenHashMap(Map<? extends Double, ? extends Boolean> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2BooleanLinkedOpenHashMap(Map<? extends Double, ? extends Boolean> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2BooleanLinkedOpenHashMap(Double2BooleanMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Double2BooleanLinkedOpenHashMap(Double2BooleanMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Double2BooleanLinkedOpenHashMap(double[] local_k, boolean[] local_v, float local_f)
  {
  ...
  public Double2BooleanLinkedOpenHashMap(double[] local_k, boolean[] local_v)
  {
  ...
  public boolean getAndMoveToFirst(double local_k)
  {
    double[] key = this.key;
  ...
  public boolean getAndMoveToLast(double local_k)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public boolean putAndMoveToFirst(double local_k, boolean local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public boolean putAndMoveToLast(double local_k, boolean local_v)
  {
    double[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Double2BooleanLinkedOpenHashMap.ValueIterator(Double2BooleanLinkedOpenHashMap.this);
        }
        ...
        {
          return Double2BooleanLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2BooleanLinkedOpenHashMap local_c;
    try
    {
      local_c = (Double2BooleanLinkedOpenHashMap)super.clone();
    }
    ...
    implements BooleanListIterator
  {
    ...
    {
      return Boolean.valueOf(Double2BooleanLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Boolean next()
    {
      return Boolean.valueOf(Double2BooleanLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractDoubleSortedSet
  {
    ...
    {
      return new Double2BooleanLinkedOpenHashMap.KeyIterator(Double2BooleanLinkedOpenHashMap.this, from);
    }
    
    public DoubleListIterator iterator()
    {
      return new Double2BooleanLinkedOpenHashMap.KeyIterator(Double2BooleanLinkedOpenHashMap.this);
    }
    ...
    {
      return Double2BooleanLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2BooleanLinkedOpenHashMap.this.size;
      Double2BooleanLinkedOpenHashMap.this.remove(local_k);
    ...
    implements DoubleListIterator
  {
    ...
    {
      return Double.valueOf(Double2BooleanLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Double next()
    {
      return Double.valueOf(Double2BooleanLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2BooleanSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Double2BooleanLinkedOpenHashMap.EntryIterator(Double2BooleanLinkedOpenHashMap.this);
    }
    ...
    public Double2BooleanMap.Entry first()
    {
      ...
      return new Double2BooleanLinkedOpenHashMap.MapEntry(Double2BooleanLinkedOpenHashMap.this, Double2BooleanLinkedOpenHashMap.this.first);
    }
    ...
    public Double2BooleanMap.Entry last()
    {
      ...
      return new Double2BooleanLinkedOpenHashMap.MapEntry(Double2BooleanLinkedOpenHashMap.this, Double2BooleanLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2BooleanLinkedOpenHashMap.this.mask; Double2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2BooleanLinkedOpenHashMap.this.mask) {
        if (Double2BooleanLinkedOpenHashMap.this.key[pos] == local_k) {
          return Double2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)local_e.getValue()).booleanValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(local_k)) & Double2BooleanLinkedOpenHashMap.this.mask; Double2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2BooleanLinkedOpenHashMap.this.mask) {
        if (Double2BooleanLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Double2BooleanLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Double2BooleanLinkedOpenHashMap.EntryIterator(Double2BooleanLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
    
    public ObjectBidirectionalIterator<Double2BooleanMap.Entry> fastIterator()
    {
      return new Double2BooleanLinkedOpenHashMap.FastEntryIterator(Double2BooleanLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Double2BooleanMap.Entry> fastIterator(Double2BooleanMap.Entry from)
    {
      return new Double2BooleanLinkedOpenHashMap.FastEntryIterator(Double2BooleanLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
    }
  }
    ...
    implements ObjectListIterator<Double2BooleanMap.Entry>
  {
    ...
    public AbstractDouble2BooleanMap.BasicEntry next()
    {
      ...
      this.entry.key = Double2BooleanLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Double2BooleanLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Double2BooleanMap.Entry>
  {
    ...
    {
      return this.entry = new Double2BooleanLinkedOpenHashMap.MapEntry(Double2BooleanLinkedOpenHashMap.this, nextEntry());
    }
    
    public Double2BooleanLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Double2BooleanLinkedOpenHashMap.MapEntry(Double2BooleanLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    {
      if (Double2BooleanLinkedOpenHashMap.this.key[Double2BooleanLinkedOpenHashMap.this.last] == from)
      {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2BooleanLinkedOpenHashMap.this.mask; Double2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2BooleanLinkedOpenHashMap.this.mask) {
          if (Double2BooleanLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Double2BooleanLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Double2BooleanLinkedOpenHashMap.this.first = this.next;
      } else {
        Double2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Double2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Double2BooleanLinkedOpenHashMap.this.last = this.prev;
      } else {
        Double2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Double2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2BooleanLinkedOpenHashMap.this.mask; Double2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Double2BooleanLinkedOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2BooleanLinkedOpenHashMap.this.key[pos])) & Double2BooleanLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2BooleanLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Double2BooleanLinkedOpenHashMap.this.key[last] = Double2BooleanLinkedOpenHashMap.this.key[pos];
      ...
      Double2BooleanLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Double2BooleanMap.Entry, Map.Entry<Double, Boolean>
  {
    ...
    public boolean setValue(boolean local_v)
    {
      ...
      Double2BooleanLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, Boolean> local_e = (Map.Entry)local_o;
      return (Double2BooleanLinkedOpenHashMap.this.key[this.index] == ((Double)local_e.getKey()).doubleValue()) && (Double2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)local_e.getValue()).booleanValue());
    }
    
    public int hashCode()
    {
      return HashCommon.double2int(Double2BooleanLinkedOpenHashMap.this.key[this.index]) ^ (Double2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
    }
