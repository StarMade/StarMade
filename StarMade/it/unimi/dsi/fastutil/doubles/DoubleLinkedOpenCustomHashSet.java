...
/* 129 */     this.key = new double[this.n];
...
/* 194 */     while (i.hasNext()) add(i.nextDouble());
/*     */   }
/*     */ 
...
/*     */   {
/* 211 */     this(DoubleIterators.asDoubleIterator(i), f, strategy);
/*     */   }
/*     */ 
/*     */   public DoubleLinkedOpenCustomHashSet(Iterator<?> i, DoubleHash.Strategy strategy)
/*     */   {
/* 219 */     this(DoubleIterators.asDoubleIterator(i), strategy);
/*     */   }
/*     */ 
...
/*     */   }
/* 609 */   public DoubleSortedSet tailSet(double from) { throw new UnsupportedOperationException(); } 
/* 610 */   public DoubleSortedSet headSet(double to) { throw new UnsupportedOperationException(); } 
/* 611 */   public DoubleSortedSet subSet(double from, double to) { throw new UnsupportedOperationException(); } 
/* 612 */   public DoubleComparator comparator() { return null; }
/*     */ 
/*     */ 
...
/*     */ 
/* 825 */     double[] key = this.key;
/* 826 */     int newMask = newN - 1;
/* 827 */     double[] newKey = new double[newN];
...
/*     */     try
/*     */     {
/* 874 */       c = (DoubleLinkedOpenCustomHashSet)super.clone();
/*     */     }
/*     */     catch (CloneNotSupportedException cantHappen) {
/* 877 */       throw new InternalError();
/*     */     }
/* 879 */     c.key = ((double[])this.key.clone());
...
/*     */     }
/* 901 */     return h; } 
/* 904 */   private void writeObject(ObjectOutputStream s) throws IOException { DoubleIterator i = iterator();
/* 905 */     s.defaultWriteObject();
/* 906 */     for (int j = this.size; j-- != 0; s.writeDouble(i.nextDouble()));
/*     */   }
/*     */ 
...
/* 914 */     double[] key = this.key = new double[this.n];
...
/* 627 */     int index = -1;
/*     */ 
/* 629 */     SetIterator() { this.next = DoubleLinkedOpenCustomHashSet.this.first;
/* 630 */       this.index = 0; }
/*     */ 
/*     */     SetIterator(double from) {
/* 633 */       if (DoubleLinkedOpenCustomHashSet.this.strategy.equals(DoubleLinkedOpenCustomHashSet.this.key[DoubleLinkedOpenCustomHashSet.this.last], from)) {
/* 634 */         this.prev = DoubleLinkedOpenCustomHashSet.this.last;
/* 635 */         this.index = DoubleLinkedOpenCustomHashSet.this.size;
/*     */       }
/*     */       else
/*     */       {
/* 639 */         int pos = HashCommon.murmurHash3(DoubleLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & DoubleLinkedOpenCustomHashSet.this.mask;
/*     */ 
/* 641 */         while (DoubleLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 642 */           if (DoubleLinkedOpenCustomHashSet.this.strategy.equals(DoubleLinkedOpenCustomHashSet.this.key[pos], from))
/*     */           {
/* 644 */             this.next = ((int)DoubleLinkedOpenCustomHashSet.this.link[pos]);
/* 645 */             this.prev = pos;
/* 646 */             return;
/*     */           }
/* 648 */           pos = pos + 1 & DoubleLinkedOpenCustomHashSet.this.mask;
/*     */         }
...
/* 658 */       this.next = ((int)DoubleLinkedOpenCustomHashSet.this.link[this.curr]);
/* 659 */       this.prev = this.curr;
/* 660 */       if (this.index >= 0) this.index += 1;
/*     */ 
/* 662 */       return DoubleLinkedOpenCustomHashSet.this.key[this.curr];
/*     */     }
/*     */     public double previousDouble() {
/* 665 */       if (!hasPrevious()) throw new NoSuchElementException();
/* 666 */       this.curr = this.prev;
/* 667 */       this.prev = ((int)(DoubleLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 668 */       this.next = this.curr;
/* 669 */       if (this.index >= 0) this.index -= 1;
/* 670 */       return DoubleLinkedOpenCustomHashSet.this.key[this.curr];
/*     */     }
...
/*     */       }
/* 678 */       if (this.next == -1) {
/* 679 */         this.index = DoubleLinkedOpenCustomHashSet.this.size;
/* 680 */         return;
/*     */       }
/* 682 */       int pos = DoubleLinkedOpenCustomHashSet.this.first;
/* 683 */       this.index = 1;
/* 684 */       while (pos != this.prev) {
/* 685 */         pos = (int)DoubleLinkedOpenCustomHashSet.this.link[pos];
/* 686 */         this.index += 1;
/*     */       }
/*     */     }
/*     */ 
...
/*     */       {
/* 704 */         this.index -= 1;
/* 705 */         this.prev = ((int)(DoubleLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/*     */       }
/*     */       else {
/* 708 */         this.next = ((int)DoubleLinkedOpenCustomHashSet.this.link[this.curr]);
/* 709 */       }DoubleLinkedOpenCustomHashSet.this.size -= 1;
/*     */ 
/* 712 */       if (this.prev == -1) DoubleLinkedOpenCustomHashSet.this.first = this.next;
/*     */       else
/* 714 */         DoubleLinkedOpenCustomHashSet.this.link[this.prev] ^= (DoubleLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/* 715 */       if (this.next == -1) DoubleLinkedOpenCustomHashSet.this.last = this.prev;
/*     */       else
/* 717 */         DoubleLinkedOpenCustomHashSet.this.link[this.next] ^= (DoubleLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*     */       int last;
/*     */       while (true) {
/* 721 */         pos = (last = pos) + 1 & DoubleLinkedOpenCustomHashSet.this.mask;
/* 722 */         while (DoubleLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 723 */           int slot = HashCommon.murmurHash3(DoubleLinkedOpenCustomHashSet.this.strategy.hashCode(DoubleLinkedOpenCustomHashSet.this.key[pos])) & DoubleLinkedOpenCustomHashSet.this.mask;
/* 724 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 725 */           pos = pos + 1 & DoubleLinkedOpenCustomHashSet.this.mask;
/*     */         }
/* 727 */         if (DoubleLinkedOpenCustomHashSet.this.used[pos] == 0) break;
/* 728 */         DoubleLinkedOpenCustomHashSet.this.key[last] = DoubleLinkedOpenCustomHashSet.this.key[pos];
/* 729 */         if (this.next == pos) this.next = last;
/* 730 */         if (this.prev == pos) this.prev = last;
/* 731 */         DoubleLinkedOpenCustomHashSet.this.fixPointers(pos, last);
/*     */       }
/* 733 */       DoubleLinkedOpenCustomHashSet.this.used[last] = false;
/* 734 */       this.curr = -1;
/*     */     }
/*     */   }
/*     */ }
