  ...
  implements Double2ReferenceMap<V>, Serializable
{
  ...
  public void putAll(Map<? extends Double, ? extends V> local_m)
  {
    ...
    if ((local_m instanceof Double2ReferenceMap)) {
      while (local_n-- != 0)
      {
        Double2ReferenceMap.Entry<? extends V> local_e = (Double2ReferenceMap.Entry)local_i.next();
  ...
  public DoubleSet keySet()
  {
    new AbstractDoubleSet()
    {
      ...
      {
        return AbstractDouble2ReferenceMap.this.containsKey(local_k);
      }
      ...
      public DoubleIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<Double, V>> field_68 = AbstractDouble2ReferenceMap.this.entrySet().iterator();
          
          public double nextDouble()
          {
            return ((Double2ReferenceMap.Entry)this.field_68.next()).getDoubleKey();
          }
  ...
  public ReferenceCollection<V> values()
  {
    new AbstractReferenceCollection()
    {
      ...
      {
        return AbstractDouble2ReferenceMap.this.containsValue(local_k);
      }
      ...
      public ObjectIterator<V> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<Double, V>> field_3 = AbstractDouble2ReferenceMap.this.entrySet().iterator();
          
          public V next()
          {
            return ((Double2ReferenceMap.Entry)this.field_3.next()).getValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Double2ReferenceMap.Entry<V> local_e = (Double2ReferenceMap.Entry)local_i.next();
