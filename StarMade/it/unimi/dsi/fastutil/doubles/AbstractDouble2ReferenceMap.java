...
/*  85 */     if ((m instanceof Double2ReferenceMap))
/*     */     {
/*  87 */       while (n-- != 0) {
/*  88 */         Double2ReferenceMap.Entry e = (Double2ReferenceMap.Entry)i.next();
...
/* 175 */       public boolean contains(double k) { return AbstractDouble2ReferenceMap.this.containsKey(k); } 
/* 176 */       public int size() { return AbstractDouble2ReferenceMap.this.size(); } 
/* 177 */       public void clear() { AbstractDouble2ReferenceMap.this.clear(); } 
/*     */       public DoubleIterator iterator() {
/* 179 */         return new AbstractDoubleIterator() {
/* 180 */           final ObjectIterator<Map.Entry<Double, V>> i = AbstractDouble2ReferenceMap.this.entrySet().iterator();
/*     */ 
/* 181 */           public double nextDouble() { return ((Double2ReferenceMap.Entry)this.i.next()).getDoubleKey(); } 
...
/* 200 */       public boolean contains(Object k) { return AbstractDouble2ReferenceMap.this.containsValue(k); } 
/* 201 */       public int size() { return AbstractDouble2ReferenceMap.this.size(); } 
/* 202 */       public void clear() { AbstractDouble2ReferenceMap.this.clear(); } 
/*     */       public ObjectIterator<V> iterator() {
/* 204 */         return new AbstractObjectIterator() {
/* 205 */           final ObjectIterator<Map.Entry<Double, V>> i = AbstractDouble2ReferenceMap.this.entrySet().iterator();
/*     */ 
/* 206 */           public V next() { return ((Double2ReferenceMap.Entry)this.i.next()).getValue(); } 
...
/* 214 */     return double2ReferenceEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 244 */         s.append(", ");
/* 245 */       Double2ReferenceMap.Entry e = (Double2ReferenceMap.Entry)i.next();
...
/* 153 */       return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == e.getValue());
/*     */     }
/*     */     public int hashCode() {
/* 156 */       return HashCommon.double2int(this.key) ^ (this.value == null ? 0 : System.identityHashCode(this.value));
/*     */     }
/*     */     public String toString() {
