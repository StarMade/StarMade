  ...
  implements Serializable, Cloneable
{
  ...
  public Double2LongArrayMap(Double2LongMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Double2LongArrayMap(Map<? extends Double, ? extends Long> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Double2LongArrayMap local_c;
    try
    {
      local_c = (Double2LongArrayMap)super.clone();
    }
    ...
    implements Double2LongMap.FastEntrySet
  {
    ...
    public ObjectIterator<Double2LongMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Double2LongMap.Entry next()
        {
          ...
          return new AbstractDouble2LongMap.BasicEntry(Double2LongArrayMap.this.key[this.next], Double2LongArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Double2LongMap.Entry> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Double2LongMap.Entry next()
        {
          ...
          this.entry.key = Double2LongArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Double2LongArrayMap.this.containsKey(local_k)) && (Double2LongArrayMap.this.get(local_k) == ((Long)local_e.getValue()).longValue());
    }
  }
}
