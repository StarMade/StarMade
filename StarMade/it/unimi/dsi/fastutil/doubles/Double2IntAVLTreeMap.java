...
/*      */ 
/*      */ public class Double2IntAVLTreeMap extends AbstractDouble2IntSortedMap
...
/*      */   protected volatile transient ObjectSortedSet<Double2IntMap.Entry> entries;
...
/*  117 */           return Double2IntAVLTreeMap.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*      */         }
/*      */         public int compare(Double ok1, Double ok2) {
/*  120 */           return Double2IntAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     int oldValue = put(ok.doubleValue(), ov.intValue());
/*  780 */     return this.modified ? null : Integer.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Integer remove(Object ok)
/*      */   {
/*  788 */     int oldValue = remove(((Double)ok).doubleValue());
...
/* 1203 */         final Comparator<? super Double2IntMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Double2IntMap.Entry x, Double2IntMap.Entry y) {
/* 1205 */             return Double2IntAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Double2IntAVLTreeMap.EntryIterator(Double2IntAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from) {
/* 1215 */           return new Double2IntAVLTreeMap.EntryIterator(Double2IntAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Double2IntAVLTreeMap.Entry f = Double2IntAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1228 */           Double2IntAVLTreeMap.Entry f = Double2IntAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1229 */           if (f != null) Double2IntAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Double2IntAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Double2IntAVLTreeMap.this.clear(); } 
/* 1234 */         public Double2IntMap.Entry first() { return Double2IntAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Double2IntMap.Entry last() { return Double2IntAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry to) { return Double2IntAVLTreeMap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2IntEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry to) { return Double2IntAVLTreeMap.this.headMap((Double)to.getKey()).double2IntEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from) { return Double2IntAVLTreeMap.this.tailMap((Double)from.getKey()).double2IntEntrySet(); }
/*      */       };
...
/* 1304 */           return new Double2IntAVLTreeMap.ValueIterator(Double2IntAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(int k) {
/* 1307 */           return Double2IntAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Double2IntAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Double2IntAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Double2IntAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readDouble(), s.readInt());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readDouble(), s.readInt());
/* 1759 */       top.right(new Entry(s.readDouble(), s.readInt()));
...
/*      */   }
/*      */ 
/*      */   private final class Submap extends AbstractDouble2IntSortedMap
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Double2IntAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Double2IntAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Double2IntAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Double2IntAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator() {
/* 1391 */             return new Double2IntAVLTreeMap.Submap.SubmapEntryIterator(Double2IntAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from) {
/* 1394 */             return new Double2IntAVLTreeMap.Submap.SubmapEntryIterator(Double2IntAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
/*      */           }
/* 1396 */           public Comparator<? super Double2IntMap.Entry> comparator() { return Double2IntAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Double2IntAVLTreeMap.Entry f = Double2IntAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1402 */             return (f != null) && (Double2IntAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Double2IntAVLTreeMap.Entry f = Double2IntAVLTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1409 */             if ((f != null) && (Double2IntAVLTreeMap.Submap.this.in(f.key))) Double2IntAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Double2IntAVLTreeMap.Submap.SubmapIterator(Double2IntAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Double2IntAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Double2IntMap.Entry first() { return Double2IntAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Double2IntMap.Entry last() { return Double2IntAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry to) { return Double2IntAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2IntEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry to) { return Double2IntAVLTreeMap.Submap.this.headMap((Double)to.getKey()).double2IntEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from) { return Double2IntAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2IntEntrySet(); }
/*      */         };
...
/*      */           public IntIterator iterator() {
/* 1442 */             return new Double2IntAVLTreeMap.Submap.SubmapValueIterator(Double2IntAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(int k) {
/* 1445 */             return Double2IntAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Double2IntAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Double2IntAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(double k) {
/* 1458 */       return (in(k)) && (Double2IntAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(int v) {
...
/* 1473 */       return (in(kk)) && ((e = Double2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public int put(double k, int v) {
/* 1476 */       Double2IntAVLTreeMap.this.modified = false;
...
/* 1478 */       int oldValue = Double2IntAVLTreeMap.this.put(k, v);
/* 1479 */       return Double2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Integer put(Double ok, Integer ov) {
/* 1482 */       int oldValue = put(ok.doubleValue(), ov.intValue());
/* 1483 */       return Double2IntAVLTreeMap.this.modified ? null : Integer.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public int remove(double k) {
/* 1487 */       Double2IntAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       int oldValue = Double2IntAVLTreeMap.this.remove(k);
/* 1490 */       return Double2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Integer remove(Object ok) {
/* 1493 */       int oldValue = remove(((Double)ok).doubleValue());
/* 1494 */       return Double2IntAVLTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public DoubleComparator comparator() {
/* 1509 */       return Double2IntAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Double2IntSortedMap headMap(double to) {
/* 1512 */       if (this.top) return new Submap(Double2IntAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Double2IntAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Double2IntAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Double2IntSortedMap tailMap(double from) {
/* 1516 */       if (this.bottom) return new Submap(Double2IntAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Double2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2IntAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Double2IntSortedMap subMap(double from, double to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Double2IntAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Double2IntAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Double2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Double2IntAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Double2IntAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Double2IntAVLTreeMap.this.tree == null) return null;
/* 1534 */       Double2IntAVLTreeMap.Entry e;
/*      */       Double2IntAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Double2IntAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Double2IntAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Double2IntAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Double2IntAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Double2IntAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Double2IntAVLTreeMap.this.tree == null) return null;
/* 1552 */       Double2IntAVLTreeMap.Entry e;
/*      */       Double2IntAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Double2IntAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Double2IntAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Double2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Double2IntAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public double firstDoubleKey() {
/* 1563 */       Double2IntAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public double lastDoubleKey() {
/* 1568 */       Double2IntAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Double firstKey() {
/* 1573 */       Double2IntAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Double lastKey() {
/* 1578 */       Double2IntAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Double2IntAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Double2IntAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Double2IntAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Double2IntMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Double2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Double2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Double2IntAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(double k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Double2IntAVLTreeMap.Submap.this.bottom) && (Double2IntAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Double2IntAVLTreeMap.Submap.this.top) && (Double2IntAVLTreeMap.this.compare(k, (this.prev = Double2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Double2IntAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Double2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Double2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2IntAVLTreeMap.this.compare(this.prev.key, Double2IntAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Double2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2IntAVLTreeMap.this.compare(this.next.key, Double2IntAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public DoubleBidirectionalIterator iterator() { return new Double2IntAVLTreeMap.Submap.SubmapKeyIterator(Double2IntAVLTreeMap.Submap.this); } 
/* 1433 */       public DoubleBidirectionalIterator iterator(double from) { return new Double2IntAVLTreeMap.Submap.SubmapKeyIterator(Double2IntAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2IntAVLTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public DoubleBidirectionalIterator iterator() { return new Double2IntAVLTreeMap.KeyIterator(Double2IntAVLTreeMap.this); } 
/* 1263 */     public DoubleBidirectionalIterator iterator(double from) { return new Double2IntAVLTreeMap.KeyIterator(Double2IntAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2IntAVLTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2IntAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Double2IntMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Double2IntMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Double2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Double2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Double2IntAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(double k) {
/* 1129 */       if ((this.next = Double2IntAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Double2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Double2IntAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */     implements Cloneable, Double2IntMap.Entry
/*      */   {
...
/*      */ 
/* 1038 */       return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
