  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof DoubleComparator))) {
      ...
      this.actualComparator = new DoubleComparator()
      {
        ...
        {
          return Double2IntAVLTreeMap.this.storedComparator.compare(Double.valueOf(local_k1), Double.valueOf(local_k2));
        }
  ...
  public Double2IntAVLTreeMap(Comparator<? super Double> local_c)
  {
    this();
  ...
  public Double2IntAVLTreeMap(Map<? extends Double, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2IntAVLTreeMap(SortedMap<Double, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2IntAVLTreeMap(Double2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Double2IntAVLTreeMap(Double2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Double2IntAVLTreeMap(double[] local_k, int[] local_v, Comparator<? super Double> local_c)
  {
    this(local_c);
  ...
  public Double2IntAVLTreeMap(double[] local_k, int[] local_v)
  {
  ...
  {
    int oldValue = put(local_ok.doubleValue(), local_ov.intValue());
    return this.modified ? null : Integer.valueOf(oldValue);
  }
  
  public Integer remove(Object local_ok)
  {
    int oldValue = remove(((Double)local_ok).doubleValue());
  ...
  public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Double2IntMap.Entry> comparator = new Comparator()
        {
          public int compare(Double2IntMap.Entry local_x, Double2IntMap.Entry local_y)
          {
            return Double2IntAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Double2IntAVLTreeMap.EntryIterator(Double2IntAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from)
        {
          return new Double2IntAVLTreeMap.EntryIterator(Double2IntAVLTreeMap.this, ((Double)from.getKey()).doubleValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Double2IntAVLTreeMap.Entry local_f = Double2IntAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Double2IntAVLTreeMap.Entry local_f = Double2IntAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
          if (local_f != null) {
            Double2IntAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry local_to)
        {
          return Double2IntAVLTreeMap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2IntEntrySet();
        }
        
        public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry local_to)
        {
          return Double2IntAVLTreeMap.this.headMap((Double)local_to.getKey()).double2IntEntrySet();
        }
        
        public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from)
        {
          return Double2IntAVLTreeMap.this.tailMap((Double)from.getKey()).double2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Double2IntAVLTreeMap.ValueIterator(Double2IntAVLTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Double2IntAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Double2IntAVLTreeMap local_c;
    try
    {
      local_c = (Double2IntAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readDouble(), local_s.readInt());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readDouble(), local_s.readInt());
      top.right(new Entry(local_s.readDouble(), local_s.readInt()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Double2IntAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Double2IntAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Double2IntAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Double2IntMap.Entry> double2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator()
          {
            return new Double2IntAVLTreeMap.Submap.SubmapEntryIterator(Double2IntAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Double2IntMap.Entry> iterator(Double2IntMap.Entry from)
          {
            return new Double2IntAVLTreeMap.Submap.SubmapEntryIterator(Double2IntAVLTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Double, Integer> local_e = (Map.Entry)local_o;
            Double2IntAVLTreeMap.Entry local_f = Double2IntAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            return (local_f != null) && (Double2IntAVLTreeMap.Submap.this.in7(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Double, Integer> local_e = (Map.Entry)local_o;
            Double2IntAVLTreeMap.Entry local_f = Double2IntAVLTreeMap.this.findKey(((Double)local_e.getKey()).doubleValue());
            if ((local_f != null) && (Double2IntAVLTreeMap.Submap.this.in7(local_f.key))) {
              Double2IntAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Double2IntAVLTreeMap.Submap.SubmapIterator(Double2IntAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Double2IntAVLTreeMap.Submap.this.clear();
          }
          
          public Double2IntMap.Entry first()
          {
            return Double2IntAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Double2IntMap.Entry last()
          {
            return Double2IntAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Double2IntMap.Entry> subSet(Double2IntMap.Entry from, Double2IntMap.Entry local_to)
          {
            return Double2IntAVLTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)local_to.getKey()).double2IntEntrySet();
          }
          
          public ObjectSortedSet<Double2IntMap.Entry> headSet(Double2IntMap.Entry local_to)
          {
            return Double2IntAVLTreeMap.Submap.this.headMap((Double)local_to.getKey()).double2IntEntrySet();
          }
          
          public ObjectSortedSet<Double2IntMap.Entry> tailSet(Double2IntMap.Entry from)
          {
            return Double2IntAVLTreeMap.Submap.this.tailMap((Double)from.getKey()).double2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Double2IntAVLTreeMap.Submap.SubmapValueIterator(Double2IntAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Double2IntAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Double2IntAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(double local_k)
    {
      return (in7(local_k)) && (Double2IntAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      double local_kk = local_k;
      Double2IntAVLTreeMap.Entry local_e;
      return (in7(local_kk)) && ((local_e = Double2IntAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(double local_k, int local_v)
    {
      ...
      int oldValue = Double2IntAVLTreeMap.this.put(local_k, local_v);
    ...
    public int remove(double local_k)
    {
      ...
      int oldValue = Double2IntAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Double2IntAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Double2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Double2IntAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Double2IntSortedMap tailMap(double from)
    {
      if (this.bottom) {
        return new Submap(Double2IntAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Double2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2IntAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Double2IntSortedMap subMap(double from, double local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Double2IntAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Double2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Double2IntAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Double2IntAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Double2IntAVLTreeMap.this.locateKey(this.from);
        if (Double2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Double2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Double2IntAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Double2IntAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Double2IntAVLTreeMap.this.locateKey(this.field_47);
        if (Double2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Double2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public double firstDoubleKey()
    {
      Double2IntAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public double lastDoubleKey()
    {
      Double2IntAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Double2IntAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Double2IntAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(double local_k)
      {
        this();
        if (this.next != null) {
          if ((!Double2IntAVLTreeMap.Submap.this.bottom) && (Double2IntAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Double2IntAVLTreeMap.Submap.this.top) && (Double2IntAVLTreeMap.this.compare(local_k, (this.prev = Double2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Double2IntAVLTreeMap.this.locateKey(local_k);
            if (Double2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Double2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2IntAVLTreeMap.this.compare(this.prev.key, Double2IntAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Double2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Double2IntAVLTreeMap.this.compare(this.next.key, Double2IntAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractDouble2IntSortedMap.KeySet
    {
      ...
      {
        return new Double2IntAVLTreeMap.Submap.SubmapKeyIterator(Double2IntAVLTreeMap.Submap.this);
      }
      
      public DoubleBidirectionalIterator iterator(double from)
      {
        return new Double2IntAVLTreeMap.Submap.SubmapKeyIterator(Double2IntAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractDouble2IntSortedMap.KeySet
  {
    ...
    public DoubleBidirectionalIterator iterator()
    {
      return new Double2IntAVLTreeMap.KeyIterator(Double2IntAVLTreeMap.this);
    }
    
    public DoubleBidirectionalIterator iterator(double from)
    {
      return new Double2IntAVLTreeMap.KeyIterator(Double2IntAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Double2IntAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Double2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Double2IntMap.Entry
  {
    ...
    Entry(double local_k, int local_v)
    {
      this.key = local_k;
      this.value = local_v;
