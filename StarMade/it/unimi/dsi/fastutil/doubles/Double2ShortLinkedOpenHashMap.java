...
/*  786 */   public Double2ShortSortedMap tailMap(double from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Double2ShortSortedMap headMap(double to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Double2ShortSortedMap subMap(double from, double to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Double2ShortLinkedOpenHashMap.ValueIterator(Double2ShortLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Double2ShortLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(short v) {
/* 1113 */           return Double2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Double2ShortLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Double2ShortLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public short previousShort()
/*      */     {
/* 1094 */       return Double2ShortLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Short previous() { return Short.valueOf(Double2ShortLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public short nextShort() { return Double2ShortLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Short next() { return Short.valueOf(Double2ShortLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Double2ShortLinkedOpenHashMap.KeyIterator(Double2ShortLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public DoubleListIterator iterator() {
/* 1054 */       return new Double2ShortLinkedOpenHashMap.KeyIterator(Double2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Double2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(double k) {
/* 1060 */       return Double2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(double k) {
/* 1063 */       int oldSize = Double2ShortLinkedOpenHashMap.this.size;
/* 1064 */       Double2ShortLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Double2ShortLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Double2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public double firstDouble() {
/* 1071 */       if (Double2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Double2ShortLinkedOpenHashMap.this.key[Double2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public double lastDouble() {
/* 1075 */       if (Double2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Double2ShortLinkedOpenHashMap.this.key[Double2ShortLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2ShortLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator(double k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public double previousDouble() { return Double2ShortLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Double previous() { return Double.valueOf(Double2ShortLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public double nextDouble() { return Double2ShortLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Double next() { return Double.valueOf(Double2ShortLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Double2ShortLinkedOpenHashMap.EntryIterator(Double2ShortLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Double2ShortMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Double2ShortMap.Entry> subSet(Double2ShortMap.Entry fromElement, Double2ShortMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Double2ShortMap.Entry> headSet(Double2ShortMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Double2ShortMap.Entry> tailSet(Double2ShortMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Double2ShortMap.Entry first() {
/*  973 */       if (Double2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Double2ShortLinkedOpenHashMap.MapEntry(Double2ShortLinkedOpenHashMap.this, Double2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Double2ShortMap.Entry last() {
/*  977 */       if (Double2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Double2ShortLinkedOpenHashMap.MapEntry(Double2ShortLinkedOpenHashMap.this, Double2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Double2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Double2ShortLinkedOpenHashMap.this.key[pos] == k) return Double2ShortLinkedOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/*  990 */         pos = pos + 1 & Double2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & Double2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Double2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Double2ShortLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Double2ShortLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Double2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Double2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Double2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2ShortMap.Entry> iterator(Double2ShortMap.Entry from) {
/* 1018 */       return new Double2ShortLinkedOpenHashMap.EntryIterator(Double2ShortLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2ShortMap.Entry> fastIterator() {
/* 1021 */       return new Double2ShortLinkedOpenHashMap.FastEntryIterator(Double2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Double2ShortMap.Entry> fastIterator(Double2ShortMap.Entry from) {
/* 1024 */       return new Double2ShortLinkedOpenHashMap.FastEntryIterator(Double2ShortLinkedOpenHashMap.this, ((Double)from.getKey()).doubleValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Double2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Double2ShortMap.Entry>
/*      */   {
/*  944 */     final AbstractDouble2ShortMap.BasicEntry entry = new AbstractDouble2ShortMap.BasicEntry(0.0D, (short)0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Double2ShortLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Double2ShortLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractDouble2ShortMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Double2ShortLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Double2ShortLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Double2ShortMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Double2ShortLinkedOpenHashMap.MapEntry(Double2ShortLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Double2ShortLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Double2ShortLinkedOpenHashMap.MapEntry(Double2ShortLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Double2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Double2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Double2ShortLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(double from) {
/*  809 */       if (Double2ShortLinkedOpenHashMap.this.key[Double2ShortLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Double2ShortLinkedOpenHashMap.this.last;
/*  811 */         this.index = Double2ShortLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & Double2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Double2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Double2ShortLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Double2ShortLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Double2ShortLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Double2ShortLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Double2ShortLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Double2ShortLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Double2ShortLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Double2ShortLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Double2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Double2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Double2ShortLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Double2ShortLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Double2ShortLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Double2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Double2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Double2ShortLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Double2ShortLinkedOpenHashMap.this.link[this.next] ^= (Double2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Double2ShortLinkedOpenHashMap.this.mask;
/*  897 */         while (Double2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(Double2ShortLinkedOpenHashMap.this.key[pos])) & Double2ShortLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Double2ShortLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Double2ShortLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Double2ShortLinkedOpenHashMap.this.key[last] = Double2ShortLinkedOpenHashMap.this.key[pos];
/*  904 */         Double2ShortLinkedOpenHashMap.this.value[last] = Double2ShortLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Double2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Double2ShortLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*  669 */       return Double.valueOf(Double2ShortLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public double getDoubleKey() {
/*  672 */       return Double2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Short getValue() {
/*  675 */       return Short.valueOf(Double2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public short getShortValue() {
/*  678 */       return Double2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public short setValue(short v) {
/*  681 */       short oldValue = Double2ShortLinkedOpenHashMap.this.value[this.index];
/*  682 */       Double2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Short setValue(Short v) {
...
/*  692 */       return (Double2ShortLinkedOpenHashMap.this.key[this.index] == ((Double)e.getKey()).doubleValue()) && (Double2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.double2int(Double2ShortLinkedOpenHashMap.this.key[this.index]) ^ Double2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Double2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Double2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
