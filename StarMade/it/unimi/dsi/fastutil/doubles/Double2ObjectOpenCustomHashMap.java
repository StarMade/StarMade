  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Double2ObjectOpenCustomHashMap(int expected, float local_f, DoubleHash.Strategy strategy)
  {
  ...
  public Double2ObjectOpenCustomHashMap(Map<? extends Double, ? extends V> local_m, float local_f, DoubleHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Double2ObjectOpenCustomHashMap(Map<? extends Double, ? extends V> local_m, DoubleHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Double2ObjectOpenCustomHashMap(Double2ObjectMap<V> local_m, float local_f, DoubleHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Double2ObjectOpenCustomHashMap(Double2ObjectMap<V> local_m, DoubleHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Double2ObjectOpenCustomHashMap(double[] local_k, V[] local_v, float local_f, DoubleHash.Strategy strategy)
  {
  ...
  public Double2ObjectOpenCustomHashMap(double[] local_k, V[] local_v, DoubleHash.Strategy strategy)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Double2ObjectOpenCustomHashMap.ValueIterator(Double2ObjectOpenCustomHashMap.this);
        }
        ...
        {
          return Double2ObjectOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Double2ObjectOpenCustomHashMap<V> local_c;
    try
    {
      local_c = (Double2ObjectOpenCustomHashMap)super.clone();
    }
    ...
    throws IOException
  {
    double[] key = this.key;
    V[] value = this.value;
    Double2ObjectOpenCustomHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractDoubleSet
  {
    ...
    {
      return new Double2ObjectOpenCustomHashMap.KeyIterator(Double2ObjectOpenCustomHashMap.this);
    }
    ...
    {
      return Double2ObjectOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(double local_k)
    {
      int oldSize = Double2ObjectOpenCustomHashMap.this.size;
      Double2ObjectOpenCustomHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Double2ObjectOpenCustomHashMap.MapIterator
    implements DoubleIterator
  {
    ...
    public Double next()
    {
      return Double.valueOf(Double2ObjectOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Double2ObjectMap.FastEntrySet<V>
  {
    ...
    {
      return new Double2ObjectOpenCustomHashMap.EntryIterator(Double2ObjectOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Double2ObjectMap.Entry<V>> fastIterator()
    {
      return new Double2ObjectOpenCustomHashMap.FastEntryIterator(Double2ObjectOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Double2ObjectOpenCustomHashMap.this.strategy.hashCode(local_k)) & Double2ObjectOpenCustomHashMap.this.mask; Double2ObjectOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ObjectOpenCustomHashMap.this.mask) {
        if (Double2ObjectOpenCustomHashMap.this.strategy.equals(Double2ObjectOpenCustomHashMap.this.key[pos], local_k)) {
          return Double2ObjectOpenCustomHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Double2ObjectOpenCustomHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Double2ObjectOpenCustomHashMap.this.strategy.hashCode(local_k)) & Double2ObjectOpenCustomHashMap.this.mask; Double2ObjectOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ObjectOpenCustomHashMap.this.mask) {
        if (Double2ObjectOpenCustomHashMap.this.strategy.equals(Double2ObjectOpenCustomHashMap.this.key[pos], local_k))
        {
          Double2ObjectOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Double2ObjectMap.Entry<V>>
  {
    ...
    public AbstractDouble2ObjectMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Double2ObjectOpenCustomHashMap.this.key[local_e];
      this.entry.value = Double2ObjectOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Double2ObjectMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Double2ObjectOpenCustomHashMap.MapEntry(Double2ObjectOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Double2ObjectOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Double2ObjectOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1904 = Double2ObjectOpenCustomHashMap.this.size;
    DoubleArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Double2ObjectOpenCustomHashMap.this.used;
      while ((this.field_1904 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1904 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1904 != 0)
      {
        boolean[] local_k = Double2ObjectOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Double2ObjectOpenCustomHashMap.this.mask; Double2ObjectOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Double2ObjectOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Double2ObjectOpenCustomHashMap.this.strategy.hashCode(Double2ObjectOpenCustomHashMap.this.key[pos])) & Double2ObjectOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Double2ObjectOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Double2ObjectOpenCustomHashMap.this.key[pos]);
        }
        Double2ObjectOpenCustomHashMap.this.key[last] = Double2ObjectOpenCustomHashMap.this.key[pos];
        Double2ObjectOpenCustomHashMap.this.value[last] = Double2ObjectOpenCustomHashMap.this.value[pos];
      }
      Double2ObjectOpenCustomHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Double2ObjectOpenCustomHashMap.this.remove(this.wrapped.getDouble(-this.pos - 2));
        this.last = -1;
        return;
      }
      Double2ObjectOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1904 > 0))
      {
        this.field_1904 += 1;
        nextEntry();
      }
    ...
    implements Double2ObjectMap.Entry<V>, Map.Entry<Double, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Double2ObjectOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Double, V> local_e = (Map.Entry)local_o;
      return (Double2ObjectOpenCustomHashMap.this.strategy.equals(Double2ObjectOpenCustomHashMap.this.key[this.index], ((Double)local_e.getKey()).doubleValue())) && (Double2ObjectOpenCustomHashMap.this.value[this.index] == null ? local_e.getValue() == null : Double2ObjectOpenCustomHashMap.this.value[this.index].equals(local_e.getValue()));
    }
