...
/*  13:    */
/*  66:    */public class Double2DoubleArrayMap
/*  67:    */  extends AbstractDouble2DoubleMap
/*  68:    */  implements Serializable, Cloneable
/*  69:    */{
/*  70:    */  private static final long serialVersionUID = 1L;
/*  71:    */  private transient double[] key;
/*  72:    */  private transient double[] value;
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Double2DoubleArrayMap(double[] key, double[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Double2DoubleArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = DoubleArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = DoubleArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Double2DoubleArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new double[capacity];
/*  94: 94 */    this.value = new double[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Double2DoubleArrayMap(Double2DoubleMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Double2DoubleArrayMap(Map<? extends Double, ? extends Double> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Double2DoubleArrayMap(double[] key, double[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Double2DoubleMap.Entry> implements Double2DoubleMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Double2DoubleMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Double2DoubleArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Double2DoubleMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractDouble2DoubleMap.BasicEntry(Double2DoubleArrayMap.this.key[this.next], Double2DoubleArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Double2DoubleMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractDouble2DoubleMap.BasicEntry entry = new AbstractDouble2DoubleMap.BasicEntry(0.0D, 0.0D);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Double2DoubleArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Double2DoubleMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Double2DoubleArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Double2DoubleArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Double2DoubleArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Double, Double> e = (Map.Entry)o;
/* 165:165 */      double k = ((Double)e.getKey()).doubleValue();
/* 166:166 */      return (Double2DoubleArrayMap.this.containsKey(k)) && (Double2DoubleArrayMap.this.get(k) == ((Double)e.getValue()).doubleValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Double2DoubleMap.FastEntrySet double2DoubleEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 176:    */  }
/* 177:    */  
/* 182:    */  public double get(double k)
/* 183:    */  {
...
/* 200:    */  }
/* 201:    */  
/* 202:    */  public boolean containsValue(double v)
/* 203:    */  {
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public double put(double k, double v)
/* 213:    */  {
/* 214:214 */    int oldKey = findKey(k);
/* 215:215 */    if (oldKey != -1) {
/* 216:216 */      double oldValue = this.value[oldKey];
...
/* 222:222 */      double[] newValue = new double[this.size == 0 ? 2 : this.size * 2];
...
/* 234:    */  }
/* 235:    */  
/* 236:    */  public double remove(double k)
/* 237:    */  {
/* 238:238 */    int oldPos = findKey(k);
/* 239:239 */    if (oldPos == -1) return this.defRetValue;
/* 240:240 */    double oldValue = this.value[oldPos];
...
/* 253:    */  }
/* 254:    */  
/* 255:    */  public DoubleCollection values() {
/* 256:256 */    return DoubleCollections.unmodifiable(new DoubleArraySet(this.value, this.size));
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Double2DoubleArrayMap clone()
/* 263:    */  {
/* 264:    */    Double2DoubleArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Double2DoubleArrayMap)super.clone();
/* 270:    */    }
/* 271:    */    catch (CloneNotSupportedException cantHappen) {
/* 272:272 */      throw new InternalError();
/* 273:    */    }
/* 274:274 */    c.key = ((double[])this.key.clone());
/* 275:275 */    c.value = ((double[])this.value.clone());
/* 276:276 */    return c;
/* 277:    */  }
/* 278:    */  
...
/* 282:282 */      s.writeDouble(this.value[i]);
/* 283:    */    }
/* 284:    */  }
/* 285:    */  
...
/* 289:289 */    this.value = new double[this.size];
/* 290:290 */    for (int i = 0; i < this.size; i++) {
/* 291:291 */      this.key[i] = s.readDouble();
/* 292:292 */      this.value[i] = s.readDouble();
/* 293:    */    }
/* 294:    */  }
/* 295:    */}
