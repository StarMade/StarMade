...
public class Double2BooleanSortedMaps
{
  ...
  public static Double2BooleanSortedMap synchronize(Double2BooleanSortedMap local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static Double2BooleanSortedMap synchronize(Double2BooleanSortedMap local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static Double2BooleanSortedMap unmodifiable(Double2BooleanSortedMap local_m)
  {
    ...
    implements Double2BooleanSortedMap, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Double2BooleanSortedMap local_m)
    {
      super();
    ...
    implements Double2BooleanSortedMap, Serializable
  {
    ...
    protected SynchronizedSortedMap(Double2BooleanSortedMap local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Double2BooleanSortedMap local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Double2BooleanSortedMap, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Double2BooleanMaps.Singleton.SingletonEntry(this), Double2BooleanSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
