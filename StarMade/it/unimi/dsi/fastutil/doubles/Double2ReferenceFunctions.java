...
/*   4:    */
/*  52:    */public class Double2ReferenceFunctions
/*  53:    */{
/*  54:    */  public static class EmptyFunction<V>
/*  55:    */    extends AbstractDouble2ReferenceFunction<V>
/*  56:    */    implements Serializable, Cloneable
/*  57:    */  {
/*  58:    */    public static final long serialVersionUID = -7046029254386353129L;
/*  59:    */    
/*  60: 60 */    public V get(double k) { return null; }
/*  61: 61 */    public boolean containsKey(double k) { return false; }
...
/*  67: 67 */    private Object readResolve() { return Double2ReferenceFunctions.EMPTY_FUNCTION; }
/*  68: 68 */    public Object clone() { return Double2ReferenceFunctions.EMPTY_FUNCTION; }
/*  69:    */  }
/*  70:    */  
/*  72: 72 */  public static final EmptyFunction EMPTY_FUNCTION = new EmptyFunction();
/*  73:    */  
/*  75:    */  public static class Singleton<V>
/*  76:    */    extends AbstractDouble2ReferenceFunction<V>
...
/*  83:    */    
/*  84:    */    protected Singleton(double key, V value)
/*  85:    */    {
/*  86: 86 */      this.key = key;
...
/*  91:    */    
/*  92: 92 */    public V get(double k) { if (this.key == k) return this.value; return this.defRetValue; }
/*  93:    */    
...
/*  97:    */  }
/*  98:    */  
/* 107:    */  public static <V> Double2ReferenceFunction<V> singleton(double key, V value)
/* 108:    */  {
/* 109:109 */    return new Singleton(key, value);
/* 110:    */  }
/* 111:    */  
/* 122:    */  public static <V> Double2ReferenceFunction<V> singleton(Double key, V value)
/* 123:    */  {
/* 124:124 */    return new Singleton(key.doubleValue(), value);
/* 125:    */  }
/* 126:    */  
/* 128:    */  public static class SynchronizedFunction<V>
/* 129:    */    extends AbstractDouble2ReferenceFunction<V>
/* 130:    */    implements Serializable
/* 131:    */  {
/* 132:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 133:    */    
/* 134:    */    protected final Double2ReferenceFunction<V> function;
/* 135:    */    
/* 136:    */    protected final Object sync;
/* 137:    */    
/* 138:    */    protected SynchronizedFunction(Double2ReferenceFunction<V> f, Object sync)
/* 139:    */    {
...
/* 143:    */    }
/* 144:    */    
/* 145:    */    protected SynchronizedFunction(Double2ReferenceFunction<V> f) {
...
/* 156:    */    
/* 157:157 */    public V put(double k, V v) { synchronized (this.sync) { return this.function.put(k, v); } }
/* 158:    */    
...
/* 161:    */      } }
/* 162:    */    
/* 163:163 */    public V put(Double k, V v) { synchronized (this.sync) { return this.function.put(k, v); } }
...
/* 167:    */    }
/* 168:    */    
/* 169:169 */    public V remove(double k) { synchronized (this.sync) { return this.function.remove(k); } }
/* 170:170 */    public V get(double k) { synchronized (this.sync) { return this.function.get(k); } }
/* 171:171 */    public boolean containsKey(Object ok) { synchronized (this.sync) { return this.function.containsKey(ok);
/* 172:    */      }
/* 173:    */    }
/* 174:    */  }
/* 175:    */  
/* 185:    */  public static <V> Double2ReferenceFunction<V> synchronize(Double2ReferenceFunction<V> f)
/* 186:    */  {
/* 187:187 */    return new SynchronizedFunction(f);
/* 188:    */  }
/* 189:    */  
/* 195:    */  public static <V> Double2ReferenceFunction<V> synchronize(Double2ReferenceFunction<V> f, Object sync)
/* 196:    */  {
/* 197:197 */    return new SynchronizedFunction(f, sync);
/* 198:    */  }
/* 199:    */  
/* 201:    */  public static class UnmodifiableFunction<V>
/* 202:    */    extends AbstractDouble2ReferenceFunction<V>
/* 203:    */    implements Serializable
/* 204:    */  {
/* 205:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 206:    */    protected final Double2ReferenceFunction<V> function;
/* 207:    */    
/* 208:    */    protected UnmodifiableFunction(Double2ReferenceFunction<V> f)
/* 209:    */    {
...
/* 219:    */    
/* 220:220 */    public V put(double k, V v) { throw new UnsupportedOperationException(); }
/* 221:    */    
...
/* 224:    */    
/* 226:226 */    public V remove(double k) { throw new UnsupportedOperationException(); }
/* 227:227 */    public V get(double k) { return this.function.get(k); }
...
/* 234:    */  }
/* 235:    */  
/* 242:    */  public static <V> Double2ReferenceFunction<V> unmodifiable(Double2ReferenceFunction<V> f)
/* 243:    */  {
