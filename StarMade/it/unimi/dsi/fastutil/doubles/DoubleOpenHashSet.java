  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public DoubleOpenHashSet(int expected, float local_f)
  {
  ...
  public DoubleOpenHashSet(Collection<? extends Double> local_c, float local_f)
  {
    this(local_c.size(), local_f);
    addAll(local_c);
  }
  
  public DoubleOpenHashSet(Collection<? extends Double> local_c)
  {
    this(local_c, 0.75F);
  }
  
  public DoubleOpenHashSet(DoubleCollection local_c, float local_f)
  {
    this(local_c.size(), local_f);
    addAll(local_c);
  }
  
  public DoubleOpenHashSet(DoubleCollection local_c)
  {
    this(local_c, 0.75F);
  }
  
  public DoubleOpenHashSet(DoubleIterator local_i, float local_f)
  {
    this(16, local_f);
  ...
  public DoubleOpenHashSet(DoubleIterator local_i)
  {
    this(local_i, 0.75F);
  }
  
  public DoubleOpenHashSet(Iterator<?> local_i, float local_f)
  {
    this(DoubleIterators.asDoubleIterator(local_i), local_f);
  }
  
  public DoubleOpenHashSet(Iterator<?> local_i)
  {
    this(DoubleIterators.asDoubleIterator(local_i));
  }
  
  public DoubleOpenHashSet(double[] local_a, int offset, int length, float local_f)
  {
  ...
  public DoubleOpenHashSet(double[] local_a, int offset, int length)
  {
    this(local_a, offset, length, 0.75F);
  }
  
  public DoubleOpenHashSet(double[] local_a, float local_f)
  {
    this(local_a, 0, local_a.length, local_f);
  }
  
  public DoubleOpenHashSet(double[] local_a)
  {
    this(local_a, 0.75F);
  }
  ...
  {
    DoubleOpenHashSet local_c;
    try
    {
      local_c = (DoubleOpenHashSet)super.clone();
    }
  ...
  {
    int pos = DoubleOpenHashSet.this.field_65;
    int last = -1;
    int field_301 = DoubleOpenHashSet.this.size;
    ...
    public double nextDouble()
    {
      ...
      double retVal = DoubleOpenHashSet.this.key[(this.last = this.pos)];
      if (this.field_301 != 0)
      {
        boolean[] used = DoubleOpenHashSet.this.used;
    ...
    final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & DoubleOpenHashSet.this.mask; DoubleOpenHashSet.this.used[pos] != 0; pos = pos + 1 & DoubleOpenHashSet.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(DoubleOpenHashSet.this.key[pos])) & DoubleOpenHashSet.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (DoubleOpenHashSet.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
