...
/*  13:    */
/*  78:    */public class DoubleOpenHashSet
/*  79:    */  extends AbstractDoubleSet
...
/*  84:    */  protected transient double[] key;
...
/*  91:    */  
/*  92:    */  public DoubleOpenHashSet(int expected, float f)
/*  93:    */  {
...
/* 100:100 */    this.key = new double[this.n];
/* 101:101 */    this.used = new boolean[this.n];
/* 102:    */  }
/* 103:    */  
/* 106:    */  public DoubleOpenHashSet(int expected)
/* 107:    */  {
/* 108:108 */    this(expected, 0.75F);
/* 109:    */  }
/* 110:    */  
/* 112:    */  public DoubleOpenHashSet()
/* 113:    */  {
/* 114:114 */    this(16, 0.75F);
/* 115:    */  }
/* 116:    */  
/* 120:    */  public DoubleOpenHashSet(Collection<? extends Double> c, float f)
/* 121:    */  {
/* 122:122 */    this(c.size(), f);
/* 123:123 */    addAll(c);
/* 124:    */  }
/* 125:    */  
/* 129:    */  public DoubleOpenHashSet(Collection<? extends Double> c)
/* 130:    */  {
/* 131:131 */    this(c, 0.75F);
/* 132:    */  }
/* 133:    */  
/* 137:    */  public DoubleOpenHashSet(DoubleCollection c, float f)
/* 138:    */  {
/* 139:139 */    this(c.size(), f);
/* 140:140 */    addAll(c);
/* 141:    */  }
/* 142:    */  
/* 146:    */  public DoubleOpenHashSet(DoubleCollection c)
/* 147:    */  {
/* 148:148 */    this(c, 0.75F);
/* 149:    */  }
/* 150:    */  
/* 154:    */  public DoubleOpenHashSet(DoubleIterator i, float f)
/* 155:    */  {
/* 156:156 */    this(16, f);
/* 157:157 */    while (i.hasNext()) { add(i.nextDouble());
/* 158:    */    }
/* 159:    */  }
/* 160:    */  
/* 162:    */  public DoubleOpenHashSet(DoubleIterator i)
/* 163:    */  {
/* 164:164 */    this(i, 0.75F);
/* 165:    */  }
/* 166:    */  
/* 170:    */  public DoubleOpenHashSet(Iterator<?> i, float f)
/* 171:    */  {
/* 172:172 */    this(DoubleIterators.asDoubleIterator(i), f);
/* 173:    */  }
/* 174:    */  
/* 177:    */  public DoubleOpenHashSet(Iterator<?> i)
/* 178:    */  {
/* 179:179 */    this(DoubleIterators.asDoubleIterator(i));
/* 180:    */  }
/* 181:    */  
/* 187:    */  public DoubleOpenHashSet(double[] a, int offset, int length, float f)
/* 188:    */  {
/* 189:189 */    this(length < 0 ? 0 : length, f);
/* 190:190 */    DoubleArrays.ensureOffsetLength(a, offset, length);
/* 191:191 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 192:    */    }
/* 193:    */  }
/* 194:    */  
/* 198:    */  public DoubleOpenHashSet(double[] a, int offset, int length)
/* 199:    */  {
/* 200:200 */    this(a, offset, length, 0.75F);
/* 201:    */  }
/* 202:    */  
/* 206:    */  public DoubleOpenHashSet(double[] a, float f)
/* 207:    */  {
/* 208:208 */    this(a, 0, a.length, f);
/* 209:    */  }
/* 210:    */  
/* 214:    */  public DoubleOpenHashSet(double[] a)
/* 215:    */  {
/* 216:216 */    this(a, 0.75F);
/* 217:    */  }
/* 218:    */  
/* 222:    */  public boolean add(double k)
/* 223:    */  {
/* 224:224 */    int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
/* 225:    */    
...
/* 248:248 */        int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(this.key[pos])) & this.mask;
...
/* 257:    */  }
/* 258:    */  
/* 259:    */  public boolean remove(double k)
/* 260:    */  {
/* 261:261 */    int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
/* 262:    */    
...
/* 273:    */  }
/* 274:    */  
/* 275:    */  public boolean contains(double k)
/* 276:    */  {
/* 277:277 */    int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
/* 278:    */    
...
/* 318:    */  
/* 319:    */  private class SetIterator extends AbstractDoubleIterator {
/* 320:    */    int pos;
/* 321:    */    int last;
/* 322:    */    
/* 323:323 */    private SetIterator() { this.pos = DoubleOpenHashSet.this.n;
/* 324:    */      
/* 326:326 */      this.last = -1;
/* 327:    */      
/* 328:328 */      this.c = DoubleOpenHashSet.this.size;
/* 329:    */      
/* 333:333 */      boolean[] used = DoubleOpenHashSet.this.used;
/* 334:334 */      while ((this.c != 0) && (used[(--this.pos)] == 0)) {}
/* 335:    */    }
/* 336:    */    
/* 337:337 */    public boolean hasNext() { return this.c != 0; }
/* 338:    */    
/* 339:    */    public double nextDouble() {
/* 340:340 */      if (!hasNext()) throw new NoSuchElementException();
/* 341:341 */      this.c -= 1;
/* 342:    */      
/* 343:343 */      if (this.pos < 0) return this.wrapped.getDouble(-(this.last = --this.pos) - 2);
/* 344:344 */      double retVal = DoubleOpenHashSet.this.key[(this.last = this.pos)];
/* 345:    */      
/* 346:346 */      if (this.c != 0) {
/* 347:347 */        boolean[] used = DoubleOpenHashSet.this.used;
...
/* 362:    */      for (;;)
/* 363:    */      {
/* 364:364 */        pos = (last = pos) + 1 & DoubleOpenHashSet.this.mask;
/* 365:365 */        while (DoubleOpenHashSet.this.used[pos] != 0) {
/* 366:366 */          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(DoubleOpenHashSet.this.key[pos])) & DoubleOpenHashSet.this.mask;
/* 367:367 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 368:368 */          pos = pos + 1 & DoubleOpenHashSet.this.mask;
/* 369:    */        }
/* 370:370 */        if (DoubleOpenHashSet.this.used[pos] == 0) break;
/* 371:371 */        if (pos < last)
/* 372:    */        {
/* 373:373 */          if (this.wrapped == null) this.wrapped = new DoubleArrayList();
/* 374:374 */          this.wrapped.add(DoubleOpenHashSet.this.key[pos]);
/* 375:    */        }
/* 376:376 */        DoubleOpenHashSet.this.key[last] = DoubleOpenHashSet.this.key[pos];
/* 377:    */      }
/* 378:378 */      DoubleOpenHashSet.this.used[last] = false;
/* 379:379 */      return last;
/* 380:    */    }
/* 381:    */    
...
/* 385:    */      {
/* 386:386 */        DoubleOpenHashSet.this.remove(this.wrapped.getDouble(-this.pos - 2));
/* 387:387 */        this.last = -1;
/* 388:388 */        return;
/* 389:    */      }
/* 390:390 */      DoubleOpenHashSet.this.size -= 1;
...
/* 397:    */  }
/* 398:    */  
/* 399:    */  public DoubleIterator iterator() {
...
/* 477:    */    
/* 478:478 */    double[] key = this.key;
/* 479:479 */    int newMask = newN - 1;
/* 480:480 */    double[] newKey = new double[newN];
/* 481:481 */    boolean[] newUsed = new boolean[newN];
/* 482:482 */    for (int j = this.size; j-- != 0;) {
/* 483:483 */      while (used[i] == 0) i++;
/* 484:484 */      double k = key[i];
/* 485:485 */      int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & newMask;
...
/* 496:    */  }
/* 497:    */  
/* 501:    */  public DoubleOpenHashSet clone()
/* 502:    */  {
/* 503:    */    DoubleOpenHashSet c;
/* 504:    */    
/* 506:    */    try
/* 507:    */    {
/* 508:508 */      c = (DoubleOpenHashSet)super.clone();
/* 509:    */    }
/* 510:    */    catch (CloneNotSupportedException cantHappen) {
/* 511:511 */      throw new InternalError();
/* 512:    */    }
/* 513:513 */    c.key = ((double[])this.key.clone());
...
/* 530:530 */      h += HashCommon.double2int(this.key[i]);
/* 531:531 */      i++;
/* 532:    */    }
/* 533:533 */    return h;
/* 534:    */  }
/* 535:    */  
/* 536:536 */  private void writeObject(ObjectOutputStream s) throws IOException { DoubleIterator i = iterator();
/* 537:537 */    s.defaultWriteObject();
/* 538:538 */    for (int j = this.size; j-- != 0; s.writeDouble(i.nextDouble())) {}
/* 539:    */  }
/* 540:    */  
...
/* 546:546 */    double[] key = this.key = new double[this.n];
/* 547:547 */    boolean[] used = this.used = new boolean[this.n];
/* 548:    */    
/* 549:549 */    int i = this.size; for (int pos = 0; i-- != 0;) {
/* 550:550 */      double k = s.readDouble();
/* 551:551 */      pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
