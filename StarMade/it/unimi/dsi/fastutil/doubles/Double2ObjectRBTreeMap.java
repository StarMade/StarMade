...
/*  119 */           return Double2ObjectRBTreeMap.this.storedComparator.compare(Double.valueOf(k1), Double.valueOf(k2));
/*      */         }
/*      */         public int compare(Double ok1, Double ok2) {
/*  122 */           return Double2ObjectRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* 1118 */         final Comparator<? super Double2ObjectMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Double2ObjectMap.Entry<V> x, Double2ObjectMap.Entry<V> y) {
/* 1120 */             return Double2ObjectRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Double2ObjectRBTreeMap.EntryIterator(Double2ObjectRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(Double2ObjectMap.Entry<V> from) {
/* 1130 */           return new Double2ObjectRBTreeMap.EntryIterator(Double2ObjectRBTreeMap.this, ((Double)from.getKey()).doubleValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Double2ObjectRBTreeMap.Entry f = Double2ObjectRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
...
/* 1143 */           Double2ObjectRBTreeMap.Entry f = Double2ObjectRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1144 */           if (f != null) Double2ObjectRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Double2ObjectRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Double2ObjectRBTreeMap.this.clear(); } 
/* 1149 */         public Double2ObjectMap.Entry<V> first() { return Double2ObjectRBTreeMap.this.firstEntry; } 
/* 1150 */         public Double2ObjectMap.Entry<V> last() { return Double2ObjectRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> from, Double2ObjectMap.Entry<V> to) { return Double2ObjectRBTreeMap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2ObjectEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> to) { return Double2ObjectRBTreeMap.this.headMap((Double)to.getKey()).double2ObjectEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> from) { return Double2ObjectRBTreeMap.this.tailMap((Double)from.getKey()).double2ObjectEntrySet(); }
/*      */       };
...
/* 1215 */           return new Double2ObjectRBTreeMap.ValueIterator(Double2ObjectRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Double2ObjectRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Double2ObjectRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Double2ObjectRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1580 */       c = (Double2ObjectRBTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Double2ObjectRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Double2ObjectRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Double2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Double2ObjectMap.Entry<V>> double2ObjectEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator() {
/* 1302 */             return new Double2ObjectRBTreeMap.Submap.SubmapEntryIterator(Double2ObjectRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Double2ObjectMap.Entry<V>> iterator(Double2ObjectMap.Entry<V> from) {
/* 1305 */             return new Double2ObjectRBTreeMap.Submap.SubmapEntryIterator(Double2ObjectRBTreeMap.Submap.this, ((Double)from.getKey()).doubleValue());
/*      */           }
/* 1307 */           public Comparator<? super Double2ObjectMap.Entry<V>> comparator() { return Double2ObjectRBTreeMap.this.double2ObjectEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Double2ObjectRBTreeMap.Entry f = Double2ObjectRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1313 */             return (f != null) && (Double2ObjectRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Double2ObjectRBTreeMap.Entry f = Double2ObjectRBTreeMap.this.findKey(((Double)e.getKey()).doubleValue());
/* 1320 */             if ((f != null) && (Double2ObjectRBTreeMap.Submap.this.in(f.key))) Double2ObjectRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Double2ObjectRBTreeMap.Submap.SubmapIterator(Double2ObjectRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Double2ObjectRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Double2ObjectMap.Entry<V> first() { return Double2ObjectRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Double2ObjectMap.Entry<V> last() { return Double2ObjectRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Double2ObjectMap.Entry<V>> subSet(Double2ObjectMap.Entry<V> from, Double2ObjectMap.Entry<V> to) { return Double2ObjectRBTreeMap.Submap.this.subMap((Double)from.getKey(), (Double)to.getKey()).double2ObjectEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Double2ObjectMap.Entry<V>> headSet(Double2ObjectMap.Entry<V> to) { return Double2ObjectRBTreeMap.Submap.this.headMap((Double)to.getKey()).double2ObjectEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Double2ObjectMap.Entry<V>> tailSet(Double2ObjectMap.Entry<V> from) { return Double2ObjectRBTreeMap.Submap.this.tailMap((Double)from.getKey()).double2ObjectEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Double2ObjectRBTreeMap.Submap.SubmapValueIterator(Double2ObjectRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Double2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Double2ObjectRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Double2ObjectRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(double k) {
/* 1365 */       return (in(k)) && (Double2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       double kk = k;
/*      */       Double2ObjectRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Double2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(double k, V v) {
/* 1383 */       Double2ObjectRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Double2ObjectRBTreeMap.this.put(k, v);
/* 1386 */       return Double2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Double ok, V ov) {
/* 1389 */       Object oldValue = put(ok.doubleValue(), ov);
/* 1390 */       return Double2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(double k) {
/* 1394 */       Double2ObjectRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Double2ObjectRBTreeMap.this.remove(k);
/* 1397 */       return Double2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Double)ok).doubleValue());
/* 1401 */       return Double2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public DoubleComparator comparator() {
/* 1416 */       return Double2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Double2ObjectSortedMap<V> headMap(double to) {
/* 1419 */       if (this.top) return new Submap(Double2ObjectRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Double2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Double2ObjectRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Double2ObjectSortedMap<V> tailMap(double from) {
/* 1423 */       if (this.bottom) return new Submap(Double2ObjectRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Double2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Double2ObjectRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Double2ObjectSortedMap<V> subMap(double from, double to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Double2ObjectRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Double2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Double2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Double2ObjectRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Double2ObjectRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Double2ObjectRBTreeMap.this.tree == null) return null;
/* 1441 */       Double2ObjectRBTreeMap.Entry e;
/*      */       Double2ObjectRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Double2ObjectRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Double2ObjectRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Double2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Double2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Double2ObjectRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Double2ObjectRBTreeMap.this.tree == null) return null;
/* 1459 */       Double2ObjectRBTreeMap.Entry e;
/*      */       Double2ObjectRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Double2ObjectRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Double2ObjectRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Double2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Double2ObjectRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public double firstDoubleKey() {
/* 1470 */       Double2ObjectRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public double lastDoubleKey() {
/* 1475 */       Double2ObjectRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Double firstKey() {
/* 1480 */       Double2ObjectRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Double lastKey() {
/* 1485 */       Double2ObjectRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Double2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Double2ObjectRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Double2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/* 1530 */       public Double2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Double2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Double2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Double2ObjectRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Double2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(double k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Double2ObjectRBTreeMap.Submap.this.bottom) && (Double2ObjectRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Double2ObjectRBTreeMap.Submap.this.top) && (Double2ObjectRBTreeMap.this.compare(k, (this.prev = Double2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Double2ObjectRBTreeMap.this.locateKey(k);
/* 1507 */             if (Double2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Double2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Double2ObjectRBTreeMap.this.compare(this.prev.key, Double2ObjectRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Double2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Double2ObjectRBTreeMap.this.compare(this.next.key, Double2ObjectRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public DoubleBidirectionalIterator iterator() { return new Double2ObjectRBTreeMap.Submap.SubmapKeyIterator(Double2ObjectRBTreeMap.Submap.this); } 
/* 1340 */       public DoubleBidirectionalIterator iterator(double from) { return new Double2ObjectRBTreeMap.Submap.SubmapKeyIterator(Double2ObjectRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Double2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public DoubleBidirectionalIterator iterator() { return new Double2ObjectRBTreeMap.KeyIterator(Double2ObjectRBTreeMap.this); } 
/* 1178 */     public DoubleBidirectionalIterator iterator(double from) { return new Double2ObjectRBTreeMap.KeyIterator(Double2ObjectRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Double2ObjectRBTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Double2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Double2ObjectMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1112 */     public Double2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Double2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Double2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Double2ObjectRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(double k) {
/* 1044 */       if ((this.next = Double2ObjectRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Double2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Double2ObjectRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Double)e.getKey()).doubleValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  969 */       return HashCommon.double2int(this.key) ^ (this.value == null ? 0 : this.value.hashCode());
/*      */     }
