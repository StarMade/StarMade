...
/*  13:    */
/*  89:    */public class DoubleLinkedOpenHashSet
...
/* 111:    */  
/* 117:    */  public DoubleLinkedOpenHashSet(int expected, float f)
/* 118:    */  {
...
/* 125:125 */    this.key = new double[this.n];
/* 126:126 */    this.used = new boolean[this.n];
/* 127:127 */    this.link = new long[this.n];
/* 128:    */  }
/* 129:    */  
/* 132:    */  public DoubleLinkedOpenHashSet(int expected)
/* 133:    */  {
/* 134:134 */    this(expected, 0.75F);
/* 135:    */  }
/* 136:    */  
/* 138:    */  public DoubleLinkedOpenHashSet()
/* 139:    */  {
/* 140:140 */    this(16, 0.75F);
/* 141:    */  }
/* 142:    */  
/* 146:    */  public DoubleLinkedOpenHashSet(Collection<? extends Double> c, float f)
/* 147:    */  {
/* 148:148 */    this(c.size(), f);
/* 149:149 */    addAll(c);
/* 150:    */  }
/* 151:    */  
/* 155:    */  public DoubleLinkedOpenHashSet(Collection<? extends Double> c)
/* 156:    */  {
/* 157:157 */    this(c, 0.75F);
/* 158:    */  }
/* 159:    */  
/* 163:    */  public DoubleLinkedOpenHashSet(DoubleCollection c, float f)
/* 164:    */  {
/* 165:165 */    this(c.size(), f);
/* 166:166 */    addAll(c);
/* 167:    */  }
/* 168:    */  
/* 172:    */  public DoubleLinkedOpenHashSet(DoubleCollection c)
/* 173:    */  {
/* 174:174 */    this(c, 0.75F);
/* 175:    */  }
/* 176:    */  
/* 180:    */  public DoubleLinkedOpenHashSet(DoubleIterator i, float f)
/* 181:    */  {
/* 182:182 */    this(16, f);
/* 183:183 */    while (i.hasNext()) { add(i.nextDouble());
/* 184:    */    }
/* 185:    */  }
/* 186:    */  
/* 188:    */  public DoubleLinkedOpenHashSet(DoubleIterator i)
/* 189:    */  {
/* 190:190 */    this(i, 0.75F);
/* 191:    */  }
/* 192:    */  
/* 196:    */  public DoubleLinkedOpenHashSet(Iterator<?> i, float f)
/* 197:    */  {
/* 198:198 */    this(DoubleIterators.asDoubleIterator(i), f);
/* 199:    */  }
/* 200:    */  
/* 203:    */  public DoubleLinkedOpenHashSet(Iterator<?> i)
/* 204:    */  {
/* 205:205 */    this(DoubleIterators.asDoubleIterator(i));
/* 206:    */  }
/* 207:    */  
/* 213:    */  public DoubleLinkedOpenHashSet(double[] a, int offset, int length, float f)
/* 214:    */  {
/* 215:215 */    this(length < 0 ? 0 : length, f);
/* 216:216 */    DoubleArrays.ensureOffsetLength(a, offset, length);
/* 217:217 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 218:    */    }
/* 219:    */  }
/* 220:    */  
/* 224:    */  public DoubleLinkedOpenHashSet(double[] a, int offset, int length)
/* 225:    */  {
/* 226:226 */    this(a, offset, length, 0.75F);
/* 227:    */  }
/* 228:    */  
/* 232:    */  public DoubleLinkedOpenHashSet(double[] a, float f)
/* 233:    */  {
/* 234:234 */    this(a, 0, a.length, f);
/* 235:    */  }
/* 236:    */  
/* 240:    */  public DoubleLinkedOpenHashSet(double[] a)
/* 241:    */  {
...
/* 249:    */  {
/* 250:250 */    int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
/* 251:    */    
...
/* 284:284 */        int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(this.key[pos])) & this.mask;
...
/* 294:    */  }
/* 295:    */  
/* 296:    */  public boolean remove(double k)
/* 297:    */  {
/* 298:298 */    int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
/* 299:    */    
...
/* 311:    */  }
/* 312:    */  
/* 313:    */  public boolean contains(double k)
/* 314:    */  {
/* 315:315 */    int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
/* 316:    */    
...
/* 322:    */  }
/* 323:    */  
/* 326:    */  public double removeFirstDouble()
/* 327:    */  {
...
/* 336:    */    }
/* 337:337 */    double k = this.key[pos];
/* 338:338 */    shiftKeys(pos);
/* 339:339 */    return k;
/* 340:    */  }
/* 341:    */  
/* 344:    */  public double removeLastDouble()
/* 345:    */  {
...
/* 394:    */  }
/* 395:    */  
/* 399:    */  public boolean addAndMoveToFirst(double k)
/* 400:    */  {
/* 401:401 */    double[] key = this.key;
/* 402:402 */    boolean[] used = this.used;
/* 403:403 */    int mask = this.mask;
/* 404:    */    
/* 405:405 */    int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & mask;
/* 406:    */    
...
/* 429:    */  }
/* 430:    */  
/* 434:    */  public boolean addAndMoveToLast(double k)
/* 435:    */  {
/* 436:436 */    double[] key = this.key;
/* 437:437 */    boolean[] used = this.used;
/* 438:438 */    int mask = this.mask;
/* 439:    */    
/* 440:440 */    int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & mask;
/* 441:    */    
...
/* 567:    */  }
/* 568:    */  
/* 571:    */  public double firstDouble()
/* 572:    */  {
/* 573:573 */    if (this.size == 0) throw new NoSuchElementException();
/* 574:574 */    return this.key[this.first];
/* 575:    */  }
/* 576:    */  
/* 579:    */  public double lastDouble()
/* 580:    */  {
/* 581:581 */    if (this.size == 0) throw new NoSuchElementException();
/* 582:582 */    return this.key[this.last]; }
/* 583:    */  
/* 584:584 */  public DoubleSortedSet tailSet(double from) { throw new UnsupportedOperationException(); }
/* 585:585 */  public DoubleSortedSet headSet(double to) { throw new UnsupportedOperationException(); }
/* 586:586 */  public DoubleSortedSet subSet(double from, double to) { throw new UnsupportedOperationException(); }
/* 587:587 */  public DoubleComparator comparator() { return null; }
/* 588:    */  
/* 593:    */  private class SetIterator
/* 594:    */    extends AbstractDoubleListIterator
/* 595:    */  {
/* 596:596 */    int prev = -1;
/* 597:    */    
/* 598:598 */    int next = -1;
...
/* 602:602 */    int index = -1;
/* 603:    */    
/* 604:604 */    SetIterator() { this.next = DoubleLinkedOpenHashSet.this.first;
/* 605:605 */      this.index = 0;
/* 606:    */    }
/* 607:    */    
/* 608:608 */    SetIterator(double from) { if (DoubleLinkedOpenHashSet.this.key[DoubleLinkedOpenHashSet.this.last] == from) {
/* 609:609 */        this.prev = DoubleLinkedOpenHashSet.this.last;
/* 610:610 */        this.index = DoubleLinkedOpenHashSet.this.size;
/* 611:    */      }
/* 612:    */      else
/* 613:    */      {
/* 614:614 */        int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(from)) & DoubleLinkedOpenHashSet.this.mask;
/* 615:    */        
/* 616:616 */        while (DoubleLinkedOpenHashSet.this.used[pos] != 0) {
/* 617:617 */          if (DoubleLinkedOpenHashSet.this.key[pos] == from)
/* 618:    */          {
/* 619:619 */            this.next = ((int)DoubleLinkedOpenHashSet.this.link[pos]);
/* 620:620 */            this.prev = pos;
/* 621:621 */            return;
/* 622:    */          }
/* 623:623 */          pos = pos + 1 & DoubleLinkedOpenHashSet.this.mask;
/* 624:    */        }
...
/* 630:    */    
/* 631:631 */    public double nextDouble() { if (!hasNext()) throw new NoSuchElementException();
/* 632:632 */      this.curr = this.next;
/* 633:633 */      this.next = ((int)DoubleLinkedOpenHashSet.this.link[this.curr]);
/* 634:634 */      this.prev = this.curr;
/* 635:635 */      if (this.index >= 0) { this.index += 1;
/* 636:    */      }
/* 637:637 */      return DoubleLinkedOpenHashSet.this.key[this.curr];
/* 638:    */    }
/* 639:    */    
/* 640:640 */    public double previousDouble() { if (!hasPrevious()) throw new NoSuchElementException();
/* 641:641 */      this.curr = this.prev;
/* 642:642 */      this.prev = ((int)(DoubleLinkedOpenHashSet.this.link[this.curr] >>> 32));
/* 643:643 */      this.next = this.curr;
/* 644:644 */      if (this.index >= 0) this.index -= 1;
/* 645:645 */      return DoubleLinkedOpenHashSet.this.key[this.curr];
/* 646:    */    }
/* 647:    */    
...
/* 654:654 */        this.index = DoubleLinkedOpenHashSet.this.size;
/* 655:655 */        return;
/* 656:    */      }
/* 657:657 */      int pos = DoubleLinkedOpenHashSet.this.first;
/* 658:658 */      this.index = 1;
/* 659:659 */      while (pos != this.prev) {
/* 660:660 */        pos = (int)DoubleLinkedOpenHashSet.this.link[pos];
...
/* 680:680 */        this.prev = ((int)(DoubleLinkedOpenHashSet.this.link[this.curr] >>> 32));
/* 681:    */      }
/* 682:    */      else {
/* 683:683 */        this.next = ((int)DoubleLinkedOpenHashSet.this.link[this.curr]); }
/* 684:684 */      DoubleLinkedOpenHashSet.this.size -= 1;
/* 685:    */      
/* 687:687 */      if (this.prev == -1) { DoubleLinkedOpenHashSet.this.first = this.next;
/* 688:    */      } else
/* 689:689 */        DoubleLinkedOpenHashSet.this.link[this.prev] ^= (DoubleLinkedOpenHashSet.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/* 690:690 */      if (this.next == -1) { DoubleLinkedOpenHashSet.this.last = this.prev;
/* 691:    */      } else
/* 692:692 */        DoubleLinkedOpenHashSet.this.link[this.next] ^= (DoubleLinkedOpenHashSet.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/* 693:693 */      int pos = this.curr;
/* 694:    */      int last;
/* 695:    */      for (;;) {
/* 696:696 */        pos = (last = pos) + 1 & DoubleLinkedOpenHashSet.this.mask;
/* 697:697 */        while (DoubleLinkedOpenHashSet.this.used[pos] != 0) {
/* 698:698 */          int slot = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(DoubleLinkedOpenHashSet.this.key[pos])) & DoubleLinkedOpenHashSet.this.mask;
/* 699:699 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 700:700 */          pos = pos + 1 & DoubleLinkedOpenHashSet.this.mask;
/* 701:    */        }
/* 702:702 */        if (DoubleLinkedOpenHashSet.this.used[pos] == 0) break;
/* 703:703 */        DoubleLinkedOpenHashSet.this.key[last] = DoubleLinkedOpenHashSet.this.key[pos];
/* 704:704 */        if (this.next == pos) this.next = last;
/* 705:705 */        if (this.prev == pos) this.prev = last;
/* 706:706 */        DoubleLinkedOpenHashSet.this.fixPointers(pos, last);
/* 707:    */      }
/* 708:708 */      DoubleLinkedOpenHashSet.this.used[last] = false;
/* 709:709 */      this.curr = -1;
/* 710:    */    }
/* 711:    */  }
/* 712:    */  
/* 718:    */  public DoubleListIterator iterator(double from)
/* 719:    */  {
/* 720:720 */    return new SetIterator(from);
/* 721:    */  }
/* 722:    */  
/* 723:723 */  public DoubleListIterator iterator() { return new SetIterator(); }
/* 724:    */  
/* 734:    */  @Deprecated
...
/* 799:    */    
/* 800:800 */    double[] key = this.key;
/* 801:801 */    int newMask = newN - 1;
/* 802:802 */    double[] newKey = new double[newN];
...
/* 808:808 */      double k = key[i];
/* 809:809 */      int pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & newMask;
...
/* 838:    */  }
/* 839:    */  
/* 842:    */  public DoubleLinkedOpenHashSet clone()
/* 843:    */  {
/* 844:    */    DoubleLinkedOpenHashSet c;
/* 845:    */    
/* 847:    */    try
/* 848:    */    {
/* 849:849 */      c = (DoubleLinkedOpenHashSet)super.clone();
/* 850:    */    }
/* 851:    */    catch (CloneNotSupportedException cantHappen) {
/* 852:852 */      throw new InternalError();
/* 853:    */    }
/* 854:854 */    c.key = ((double[])this.key.clone());
...
/* 872:872 */      h += HashCommon.double2int(this.key[i]);
/* 873:873 */      i++;
/* 874:    */    }
/* 875:875 */    return h;
/* 876:    */  }
/* 877:    */  
/* 878:878 */  private void writeObject(ObjectOutputStream s) throws IOException { DoubleIterator i = iterator();
/* 879:879 */    s.defaultWriteObject();
/* 880:880 */    for (int j = this.size; j-- != 0; s.writeDouble(i.nextDouble())) {}
/* 881:    */  }
/* 882:    */  
...
/* 888:888 */    double[] key = this.key = new double[this.n];
...
/* 895:895 */      double k = s.readDouble();
/* 896:896 */      pos = (int)HashCommon.murmurHash3(Double.doubleToRawLongBits(k)) & this.mask;
