...
/*  119 */           return Float2ReferenceRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  122 */           return Float2ReferenceRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     Object oldValue = put(ok.floatValue(), ov);
/*  731 */     return this.modified ? this.defRetValue : oldValue;
/*      */   }
/*      */ 
/*      */   public V remove(Object ok)
/*      */   {
/*  737 */     Object oldValue = remove(((Float)ok).floatValue());
...
/* 1118 */         final Comparator<? super Float2ReferenceMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Float2ReferenceMap.Entry<V> x, Float2ReferenceMap.Entry<V> y) {
/* 1120 */             return Float2ReferenceRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Float2ReferenceRBTreeMap.EntryIterator(Float2ReferenceRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> iterator(Float2ReferenceMap.Entry<V> from) {
/* 1130 */           return new Float2ReferenceRBTreeMap.EntryIterator(Float2ReferenceRBTreeMap.this, ((Float)from.getKey()).floatValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Float2ReferenceRBTreeMap.Entry f = Float2ReferenceRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1143 */           Float2ReferenceRBTreeMap.Entry f = Float2ReferenceRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1144 */           if (f != null) Float2ReferenceRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Float2ReferenceRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Float2ReferenceRBTreeMap.this.clear(); } 
/* 1149 */         public Float2ReferenceMap.Entry<V> first() { return Float2ReferenceRBTreeMap.this.firstEntry; } 
/* 1150 */         public Float2ReferenceMap.Entry<V> last() { return Float2ReferenceRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Float2ReferenceMap.Entry<V>> subSet(Float2ReferenceMap.Entry<V> from, Float2ReferenceMap.Entry<V> to) { return Float2ReferenceRBTreeMap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ReferenceEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Float2ReferenceMap.Entry<V>> headSet(Float2ReferenceMap.Entry<V> to) { return Float2ReferenceRBTreeMap.this.headMap((Float)to.getKey()).float2ReferenceEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Float2ReferenceMap.Entry<V>> tailSet(Float2ReferenceMap.Entry<V> from) { return Float2ReferenceRBTreeMap.this.tailMap((Float)from.getKey()).float2ReferenceEntrySet(); }
/*      */       };
...
/* 1215 */           return new Float2ReferenceRBTreeMap.ValueIterator(Float2ReferenceRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Float2ReferenceRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Float2ReferenceRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Float2ReferenceRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/* 1233 */     return new Submap(0.0F, true, to, false);
/*      */   }
/*      */   public Float2ReferenceSortedMap<V> tailMap(float from) {
/* 1236 */     return new Submap(from, false, 0.0F, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1580 */       c = (Float2ReferenceRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1652 */     if (n == 1) {
/* 1653 */       Entry top = new Entry(s.readFloat(), s.readObject());
/* 1654 */       top.pred(pred);
/* 1655 */       top.succ(succ);
/* 1656 */       top.black(true);
/* 1657 */       return top;
...
/* 1659 */     if (n == 2)
/*      */     {
/* 1662 */       Entry top = new Entry(s.readFloat(), s.readObject());
/* 1663 */       top.black(true);
/* 1664 */       top.right(new Entry(s.readFloat(), s.readObject()));
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Float2ReferenceRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Float2ReferenceRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Float2ReferenceRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Float2ReferenceMap.Entry<V>> float2ReferenceEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> iterator() {
/* 1302 */             return new Float2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Float2ReferenceRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> iterator(Float2ReferenceMap.Entry<V> from) {
/* 1305 */             return new Float2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Float2ReferenceRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
/*      */           }
/* 1307 */           public Comparator<? super Float2ReferenceMap.Entry<V>> comparator() { return Float2ReferenceRBTreeMap.this.float2ReferenceEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Float2ReferenceRBTreeMap.Entry f = Float2ReferenceRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1313 */             return (f != null) && (Float2ReferenceRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Float2ReferenceRBTreeMap.Entry f = Float2ReferenceRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1320 */             if ((f != null) && (Float2ReferenceRBTreeMap.Submap.this.in(f.key))) Float2ReferenceRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Float2ReferenceRBTreeMap.Submap.SubmapIterator(Float2ReferenceRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Float2ReferenceRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Float2ReferenceMap.Entry<V> first() { return Float2ReferenceRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Float2ReferenceMap.Entry<V> last() { return Float2ReferenceRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Float2ReferenceMap.Entry<V>> subSet(Float2ReferenceMap.Entry<V> from, Float2ReferenceMap.Entry<V> to) { return Float2ReferenceRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ReferenceEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Float2ReferenceMap.Entry<V>> headSet(Float2ReferenceMap.Entry<V> to) { return Float2ReferenceRBTreeMap.Submap.this.headMap((Float)to.getKey()).float2ReferenceEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Float2ReferenceMap.Entry<V>> tailSet(Float2ReferenceMap.Entry<V> from) { return Float2ReferenceRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2ReferenceEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Float2ReferenceRBTreeMap.Submap.SubmapValueIterator(Float2ReferenceRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Float2ReferenceRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Float2ReferenceRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Float2ReferenceRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(float k) {
/* 1365 */       return (in(k)) && (Float2ReferenceRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       float kk = k;
/*      */       Float2ReferenceRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Float2ReferenceRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(float k, V v) {
/* 1383 */       Float2ReferenceRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Float2ReferenceRBTreeMap.this.put(k, v);
/* 1386 */       return Float2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Float ok, V ov) {
/* 1389 */       Object oldValue = put(ok.floatValue(), ov);
/* 1390 */       return Float2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(float k) {
/* 1394 */       Float2ReferenceRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Float2ReferenceRBTreeMap.this.remove(k);
/* 1397 */       return Float2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Float)ok).floatValue());
/* 1401 */       return Float2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1416 */       return Float2ReferenceRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Float2ReferenceSortedMap<V> headMap(float to) {
/* 1419 */       if (this.top) return new Submap(Float2ReferenceRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Float2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Float2ReferenceRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Float2ReferenceSortedMap<V> tailMap(float from) {
/* 1423 */       if (this.bottom) return new Submap(Float2ReferenceRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Float2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2ReferenceRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Float2ReferenceSortedMap<V> subMap(float from, float to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Float2ReferenceRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Float2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Float2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Float2ReferenceRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Float2ReferenceRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Float2ReferenceRBTreeMap.this.tree == null) return null;
/* 1441 */       Float2ReferenceRBTreeMap.Entry e;
/*      */       Float2ReferenceRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Float2ReferenceRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Float2ReferenceRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Float2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Float2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Float2ReferenceRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Float2ReferenceRBTreeMap.this.tree == null) return null;
/* 1459 */       Float2ReferenceRBTreeMap.Entry e;
/*      */       Float2ReferenceRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Float2ReferenceRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Float2ReferenceRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Float2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Float2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public float firstFloatKey() {
/* 1470 */       Float2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public float lastFloatKey() {
/* 1475 */       Float2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Float firstKey() {
/* 1480 */       Float2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Float lastKey() {
/* 1485 */       Float2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Float2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Float2ReferenceRBTreeMap.Submap.SubmapIterator
/*      */       implements FloatListIterator
/*      */     {
/*      */       public SubmapKeyIterator()
/*      */       {
/* 1543 */         super(); } 
/* 1544 */       public SubmapKeyIterator(float from) { super(from); } 
/* 1545 */       public float nextFloat() { return nextEntry().key; } 
/* 1546 */       public float previousFloat() { return previousEntry().key; } 
/* 1547 */       public void set(float k) { throw new UnsupportedOperationException(); } 
/* 1548 */       public void add(float k) { throw new UnsupportedOperationException(); } 
/* 1549 */       public Float next() { return Float.valueOf(nextEntry().key); } 
/* 1550 */       public Float previous() { return Float.valueOf(previousEntry().key); } 
/* 1551 */       public void set(Float ok) { throw new UnsupportedOperationException(); } 
/* 1552 */       public void add(Float ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Float2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/* 1525 */         super();
/*      */       }
/* 1527 */       SubmapEntryIterator(float k) { super(k); } 
/*      */       public Float2ReferenceMap.Entry<V> next() {
/* 1529 */         return nextEntry(); } 
/* 1530 */       public Float2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Float2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Float2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Float2ReferenceRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Float2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Float2ReferenceRBTreeMap.Submap.this.bottom) && (Float2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Float2ReferenceRBTreeMap.Submap.this.top) && (Float2ReferenceRBTreeMap.this.compare(k, (this.prev = Float2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Float2ReferenceRBTreeMap.this.locateKey(k);
/* 1507 */             if (Float2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Float2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2ReferenceRBTreeMap.this.compare(this.prev.key, Float2ReferenceRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Float2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Float2ReferenceRBTreeMap.this.compare(this.next.key, Float2ReferenceRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public FloatBidirectionalIterator iterator() { return new Float2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Float2ReferenceRBTreeMap.Submap.this); } 
/* 1340 */       public FloatBidirectionalIterator iterator(float from) { return new Float2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Float2ReferenceRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public FloatBidirectionalIterator iterator() { return new Float2ReferenceRBTreeMap.KeyIterator(Float2ReferenceRBTreeMap.this); } 
/* 1178 */     public FloatBidirectionalIterator iterator(float from) { return new Float2ReferenceRBTreeMap.KeyIterator(Float2ReferenceRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2ReferenceRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1164 */       super(); } 
/* 1165 */     public KeyIterator(float k) { super(k); } 
/* 1166 */     public float nextFloat() { return nextEntry().key; } 
/* 1167 */     public float previousFloat() { return previousEntry().key; } 
/* 1168 */     public void set(float k) { throw new UnsupportedOperationException(); } 
/* 1169 */     public void add(float k) { throw new UnsupportedOperationException(); } 
/* 1170 */     public Float next() { return Float.valueOf(nextEntry().key); } 
/* 1171 */     public Float previous() { return Float.valueOf(previousEntry().key); } 
/* 1172 */     public void set(Float ok) { throw new UnsupportedOperationException(); } 
/* 1173 */     public void add(Float ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Float2ReferenceMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
/* 1107 */       super();
/*      */     }
/* 1109 */     EntryIterator(float k) { super(k); } 
/*      */     public Float2ReferenceMap.Entry<V> next() {
/* 1111 */       return nextEntry(); } 
/* 1112 */     public Float2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Float2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Float2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Float2ReferenceRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(float k) {
/* 1044 */       if ((this.next = Float2ReferenceRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Float2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Float2ReferenceRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  969 */       return HashCommon.float2int(this.key) ^ (this.value == null ? 0 : System.identityHashCode(this.value));
/*      */     }
