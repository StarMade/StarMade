  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2LongOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2LongOpenHashMap(Map<? extends Float, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2LongOpenHashMap(Map<? extends Float, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2LongOpenHashMap(Float2LongMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2LongOpenHashMap(Float2LongMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2LongOpenHashMap(float[] local_k, long[] local_v, float local_f)
  {
  ...
  public Float2LongOpenHashMap(float[] local_k, long[] local_v)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Float2LongOpenHashMap.ValueIterator(Float2LongOpenHashMap.this);
        }
        ...
        {
          return Float2LongOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2LongOpenHashMap local_c;
    try
    {
      local_c = (Float2LongOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Float2LongOpenHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Float2LongOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSet
  {
    ...
    {
      return new Float2LongOpenHashMap.KeyIterator(Float2LongOpenHashMap.this);
    }
    ...
    {
      return Float2LongOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2LongOpenHashMap.this.size;
      Float2LongOpenHashMap.this.remove(local_k);
    ...
    implements FloatIterator
  {
    ...
    public Float next()
    {
      return Float.valueOf(Float2LongOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2LongMap.FastEntrySet
  {
    ...
    {
      return new Float2LongOpenHashMap.EntryIterator(Float2LongOpenHashMap.this, null);
    }
    
    public ObjectIterator<Float2LongMap.Entry> fastIterator()
    {
      return new Float2LongOpenHashMap.FastEntryIterator(Float2LongOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2LongOpenHashMap.this.mask; Float2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2LongOpenHashMap.this.mask) {
        if (Float2LongOpenHashMap.this.key[pos] == local_k) {
          return Float2LongOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2LongOpenHashMap.this.mask; Float2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2LongOpenHashMap.this.mask) {
        if (Float2LongOpenHashMap.this.key[pos] == local_k)
        {
          Float2LongOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Float2LongMap.Entry>
  {
    ...
    public AbstractFloat2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2LongOpenHashMap.this.key[local_e];
      this.entry.value = Float2LongOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Float2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Float2LongOpenHashMap.MapEntry(Float2LongOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Float2LongOpenHashMap.this.field_49;
    int last = -1;
    int field_2039 = Float2LongOpenHashMap.this.size;
    FloatArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Float2LongOpenHashMap.this.used;
      while ((this.field_2039 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2039 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2039 != 0)
      {
        boolean[] local_k = Float2LongOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2LongOpenHashMap.this.mask; Float2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2LongOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2LongOpenHashMap.this.key[pos])) & Float2LongOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2LongOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Float2LongOpenHashMap.this.key[pos]);
        }
        Float2LongOpenHashMap.this.key[last] = Float2LongOpenHashMap.this.key[pos];
        Float2LongOpenHashMap.this.value[last] = Float2LongOpenHashMap.this.value[pos];
      }
      Float2LongOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Float2LongOpenHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
        this.last = -1;
        return;
      }
      Float2LongOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2039 > 0))
      {
        this.field_2039 += 1;
        nextEntry();
      }
    ...
    implements Float2LongMap.Entry, Map.Entry<Float, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Float2LongOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Long> local_e = (Map.Entry)local_o;
      return (Float2LongOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2LongOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
