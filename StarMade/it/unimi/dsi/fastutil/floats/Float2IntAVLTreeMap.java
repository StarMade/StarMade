  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof FloatComparator))) {
      ...
      this.actualComparator = new FloatComparator()
      {
        ...
        {
          return Float2IntAVLTreeMap.this.storedComparator.compare(Float.valueOf(local_k1), Float.valueOf(local_k2));
        }
  ...
  public Float2IntAVLTreeMap(Comparator<? super Float> local_c)
  {
    this();
  ...
  public Float2IntAVLTreeMap(Map<? extends Float, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2IntAVLTreeMap(SortedMap<Float, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2IntAVLTreeMap(Float2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2IntAVLTreeMap(Float2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2IntAVLTreeMap(float[] local_k, int[] local_v, Comparator<? super Float> local_c)
  {
    this(local_c);
  ...
  public Float2IntAVLTreeMap(float[] local_k, int[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Float2IntMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Float2IntAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Float2IntAVLTreeMap.EntryIterator(Float2IntAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator(Float2IntMap.Entry from)
        {
          return new Float2IntAVLTreeMap.EntryIterator(Float2IntAVLTreeMap.this, ((Float)from.getKey()).floatValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Float2IntAVLTreeMap.Entry local_f = Float2IntAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Float2IntAVLTreeMap.Entry local_f = Float2IntAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
          if (local_f != null) {
            Float2IntAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Float2IntAVLTreeMap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2IntEntrySet();
        }
        
        public ObjectSortedSet<Float2IntMap.Entry> headSet(Float2IntMap.Entry local_to)
        {
          return Float2IntAVLTreeMap.this.headMap((Float)local_to.getKey()).float2IntEntrySet();
        }
        
        public ObjectSortedSet<Float2IntMap.Entry> tailSet(Float2IntMap.Entry from)
        {
          return Float2IntAVLTreeMap.this.tailMap((Float)from.getKey()).float2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Float2IntAVLTreeMap.ValueIterator(Float2IntAVLTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Float2IntAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Float2IntAVLTreeMap local_c;
    try
    {
      local_c = (Float2IntAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Float2IntAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Float2IntAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Float2IntAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Float2IntMap.Entry> float2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator()
          {
            return new Float2IntAVLTreeMap.Submap.SubmapEntryIterator(Float2IntAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator(Float2IntMap.Entry from)
          {
            return new Float2IntAVLTreeMap.Submap.SubmapEntryIterator(Float2IntAVLTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Float, Integer> local_e = (Map.Entry)local_o;
            Float2IntAVLTreeMap.Entry local_f = Float2IntAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            return (local_f != null) && (Float2IntAVLTreeMap.Submap.this.in(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Float, Integer> local_e = (Map.Entry)local_o;
            Float2IntAVLTreeMap.Entry local_f = Float2IntAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            if ((local_f != null) && (Float2IntAVLTreeMap.Submap.this.in(local_f.key))) {
              Float2IntAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Float2IntAVLTreeMap.Submap.SubmapIterator(Float2IntAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Float2IntAVLTreeMap.Submap.this.clear();
          }
          
          public Float2IntMap.Entry first()
          {
            return Float2IntAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Float2IntMap.Entry last()
          {
            return Float2IntAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Float2IntMap.Entry> subSet(Float2IntMap.Entry from, Float2IntMap.Entry local_to)
          {
            return Float2IntAVLTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2IntEntrySet();
          }
          
          public ObjectSortedSet<Float2IntMap.Entry> headSet(Float2IntMap.Entry local_to)
          {
            return Float2IntAVLTreeMap.Submap.this.headMap((Float)local_to.getKey()).float2IntEntrySet();
          }
          
          public ObjectSortedSet<Float2IntMap.Entry> tailSet(Float2IntMap.Entry from)
          {
            return Float2IntAVLTreeMap.Submap.this.tailMap((Float)from.getKey()).float2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Float2IntAVLTreeMap.Submap.SubmapValueIterator(Float2IntAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Float2IntAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Float2IntAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(float local_k)
    {
      return (in(local_k)) && (Float2IntAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      float local_kk = local_k;
      Float2IntAVLTreeMap.Entry local_e;
      return (in(local_kk)) && ((local_e = Float2IntAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(float local_k, int local_v)
    {
      ...
      int oldValue = Float2IntAVLTreeMap.this.put(local_k, local_v);
    ...
    public int remove(float local_k)
    {
      ...
      int oldValue = Float2IntAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Float2IntAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Float2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Float2IntAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Float2IntSortedMap tailMap(float from)
    {
      if (this.bottom) {
        return new Submap(Float2IntAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Float2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2IntAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Float2IntSortedMap subMap(float from, float local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Float2IntAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Float2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Float2IntAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Float2IntAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Float2IntAVLTreeMap.this.locateKey(this.from);
        if (Float2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Float2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Float2IntAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Float2IntAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Float2IntAVLTreeMap.this.locateKey(this.field_47);
        if (Float2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Float2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public float firstFloatKey()
    {
      Float2IntAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public float lastFloatKey()
    {
      Float2IntAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Float2IntAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Float2IntAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(float local_k)
      {
        this();
        if (this.next != null) {
          if ((!Float2IntAVLTreeMap.Submap.this.bottom) && (Float2IntAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Float2IntAVLTreeMap.Submap.this.top) && (Float2IntAVLTreeMap.this.compare(local_k, (this.prev = Float2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Float2IntAVLTreeMap.this.locateKey(local_k);
            if (Float2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Float2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2IntAVLTreeMap.this.compare(this.prev.key, Float2IntAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Float2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Float2IntAVLTreeMap.this.compare(this.next.key, Float2IntAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractFloat2IntSortedMap.KeySet
    {
      ...
      {
        return new Float2IntAVLTreeMap.Submap.SubmapKeyIterator(Float2IntAVLTreeMap.Submap.this);
      }
      
      public FloatBidirectionalIterator iterator(float from)
      {
        return new Float2IntAVLTreeMap.Submap.SubmapKeyIterator(Float2IntAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractFloat2IntSortedMap.KeySet
  {
    ...
    public FloatBidirectionalIterator iterator()
    {
      return new Float2IntAVLTreeMap.KeyIterator(Float2IntAVLTreeMap.this);
    }
    
    public FloatBidirectionalIterator iterator(float from)
    {
      return new Float2IntAVLTreeMap.KeyIterator(Float2IntAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Float2IntAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Float2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
