...
/*     */   {
/* 173 */     return new Singleton(key.floatValue(), value.floatValue());
/*     */   }
/*     */ 
/*     */   public static Float2FloatSortedMap singleton(Float key, Float value, FloatComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.floatValue(), value.floatValue(), comparator);
/*     */   }
/*     */ 
/*     */   public static Float2FloatSortedMap singleton(float key, float value)
/*     */   {
...
/*     */     }
/* 302 */     public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.float2FloatEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, Float>> entrySet() {
/* 304 */       return float2FloatEntrySet(); } 
...
/* 308 */     public Float2FloatSortedMap headMap(float to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Float2FloatSortedMap tailMap(float from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Float2FloatSortedMap headMap(Float to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Float2FloatSortedMap tailMap(Float from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.float2FloatEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, Float>> entrySet() {
/* 244 */       return float2FloatEntrySet(); } 
...
/* 248 */     public Float2FloatSortedMap headMap(float to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Float2FloatSortedMap tailMap(float from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public float firstFloatKey() {
...
/* 259 */     public Float2FloatSortedMap headMap(Float to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Float2FloatSortedMap tailMap(Float from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Float2FloatMaps.Singleton.SingletonEntry(this), Float2FloatSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Float, Float>> entrySet() { return float2FloatEntrySet(); } 
/*     */     public FloatSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = FloatSortedSets.singleton(this.key, this.comparator); return (FloatSortedSet)this.keys;
/*     */     }
/*     */     public Float2FloatSortedMap subMap(float from, float to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Float2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Float2FloatSortedMap headMap(float to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Float2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Float2FloatSortedMap tailMap(float from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Float2FloatSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Float2FloatSortedMap tailMap(Float ofrom) { return tailMap(ofrom.floatValue()); } 
/* 156 */     public Float2FloatSortedMap subMap(Float ofrom, Float oto) { return subMap(ofrom.floatValue(), oto.floatValue()); } 
/*     */     public Float firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, Float>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public FloatSortedSet keySet() { return FloatSortedSets.EMPTY_SET; } 
/*     */     public Float2FloatSortedMap subMap(float from, float to) {
/*  86 */       return Float2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Float2FloatSortedMap headMap(float to) { return Float2FloatSortedMaps.EMPTY_MAP; } 
/*     */     public Float2FloatSortedMap tailMap(float from) {
/*  90 */       return Float2FloatSortedMaps.EMPTY_MAP; } 
...
/*  93 */     public Float2FloatSortedMap headMap(Float oto) { return headMap(oto.floatValue()); } 
/*  94 */     public Float2FloatSortedMap tailMap(Float ofrom) { return tailMap(ofrom.floatValue()); } 
/*  95 */     public Float2FloatSortedMap subMap(Float ofrom, Float oto) { return subMap(ofrom.floatValue(), oto.floatValue()); } 
