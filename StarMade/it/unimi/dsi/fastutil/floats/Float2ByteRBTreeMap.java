...
/*      */ 
/*      */ public class Float2ByteRBTreeMap extends AbstractFloat2ByteSortedMap
...
/*  119 */           return Float2ByteRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  122 */           return Float2ByteRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     byte oldValue = put(ok.floatValue(), ov.byteValue());
/*  731 */     return this.modified ? null : Byte.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Byte remove(Object ok)
/*      */   {
/*  737 */     byte oldValue = remove(((Float)ok).floatValue());
...
/* 1141 */         final Comparator<? super Float2ByteMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Float2ByteMap.Entry x, Float2ByteMap.Entry y) {
/* 1143 */             return Float2ByteRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Float2ByteRBTreeMap.EntryIterator(Float2ByteRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1153 */           return new Float2ByteRBTreeMap.EntryIterator(Float2ByteRBTreeMap.this, ((Float)from.getKey()).floatValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1166 */           Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1167 */           if (f != null) Float2ByteRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Float2ByteRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Float2ByteRBTreeMap.this.clear(); } 
/* 1172 */         public Float2ByteMap.Entry first() { return Float2ByteRBTreeMap.this.firstEntry; } 
/* 1173 */         public Float2ByteMap.Entry last() { return Float2ByteRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) { return Float2ByteRBTreeMap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ByteEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) { return Float2ByteRBTreeMap.this.headMap((Float)to.getKey()).float2ByteEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) { return Float2ByteRBTreeMap.this.tailMap((Float)from.getKey()).float2ByteEntrySet(); }
/*      */       };
...
/* 1242 */           return new Float2ByteRBTreeMap.ValueIterator(Float2ByteRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(byte k) {
/* 1245 */           return Float2ByteRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Float2ByteRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Float2ByteRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Float2ByteRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readFloat(), s.readByte());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readFloat(), s.readByte());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readFloat(), s.readByte()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Float2ByteRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Float2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator() {
/* 1329 */             return new Float2ByteRBTreeMap.Submap.SubmapEntryIterator(Float2ByteRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1332 */             return new Float2ByteRBTreeMap.Submap.SubmapEntryIterator(Float2ByteRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
/*      */           }
/* 1334 */           public Comparator<? super Float2ByteMap.Entry> comparator() { return Float2ByteRBTreeMap.this.float2ByteEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1340 */             return (f != null) && (Float2ByteRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Float2ByteRBTreeMap.Entry f = Float2ByteRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1347 */             if ((f != null) && (Float2ByteRBTreeMap.Submap.this.in(f.key))) Float2ByteRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Float2ByteRBTreeMap.Submap.SubmapIterator(Float2ByteRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Float2ByteRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Float2ByteMap.Entry first() { return Float2ByteRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Float2ByteMap.Entry last() { return Float2ByteRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) { return Float2ByteRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ByteEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) { return Float2ByteRBTreeMap.Submap.this.headMap((Float)to.getKey()).float2ByteEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) { return Float2ByteRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2ByteEntrySet(); }
/*      */         };
...
/*      */           public ByteIterator iterator() {
/* 1376 */             return new Float2ByteRBTreeMap.Submap.SubmapValueIterator(Float2ByteRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(byte k) {
/* 1379 */             return Float2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Float2ByteRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Float2ByteRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(float k) {
/* 1392 */       return (in(k)) && (Float2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(byte v) {
...
/* 1407 */       return (in(kk)) && ((e = Float2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public byte put(float k, byte v) {
/* 1410 */       Float2ByteRBTreeMap.this.modified = false;
...
/* 1412 */       byte oldValue = Float2ByteRBTreeMap.this.put(k, v);
/* 1413 */       return Float2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Byte put(Float ok, Byte ov) {
/* 1416 */       byte oldValue = put(ok.floatValue(), ov.byteValue());
/* 1417 */       return Float2ByteRBTreeMap.this.modified ? null : Byte.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public byte remove(float k) {
/* 1421 */       Float2ByteRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       byte oldValue = Float2ByteRBTreeMap.this.remove(k);
/* 1424 */       return Float2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Byte remove(Object ok) {
/* 1427 */       byte oldValue = remove(((Float)ok).floatValue());
/* 1428 */       return Float2ByteRBTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1443 */       return Float2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Float2ByteSortedMap headMap(float to) {
/* 1446 */       if (this.top) return new Submap(Float2ByteRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Float2ByteRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Float2ByteRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Float2ByteSortedMap tailMap(float from) {
/* 1450 */       if (this.bottom) return new Submap(Float2ByteRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Float2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2ByteRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Float2ByteSortedMap subMap(float from, float to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Float2ByteRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Float2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Float2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Float2ByteRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Float2ByteRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Float2ByteRBTreeMap.this.tree == null) return null;
/* 1468 */       Float2ByteRBTreeMap.Entry e;
/*      */       Float2ByteRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Float2ByteRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Float2ByteRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Float2ByteRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Float2ByteRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Float2ByteRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Float2ByteRBTreeMap.this.tree == null) return null;
/* 1486 */       Float2ByteRBTreeMap.Entry e;
/*      */       Float2ByteRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Float2ByteRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Float2ByteRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Float2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Float2ByteRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public float firstFloatKey() {
/* 1497 */       Float2ByteRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public float lastFloatKey() {
/* 1502 */       Float2ByteRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Float firstKey() {
/* 1507 */       Float2ByteRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Float lastKey() {
/* 1512 */       Float2ByteRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Float2ByteRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Float2ByteRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Float2ByteRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Float2ByteMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Float2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Float2ByteRBTreeMap.Submap.this.bottom) && (Float2ByteRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Float2ByteRBTreeMap.Submap.this.top) && (Float2ByteRBTreeMap.this.compare(k, (this.prev = Float2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Float2ByteRBTreeMap.this.locateKey(k);
/* 1534 */             if (Float2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Float2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2ByteRBTreeMap.this.compare(this.prev.key, Float2ByteRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Float2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Float2ByteRBTreeMap.this.compare(this.next.key, Float2ByteRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public FloatBidirectionalIterator iterator() { return new Float2ByteRBTreeMap.Submap.SubmapKeyIterator(Float2ByteRBTreeMap.Submap.this); } 
/* 1367 */       public FloatBidirectionalIterator iterator(float from) { return new Float2ByteRBTreeMap.Submap.SubmapKeyIterator(Float2ByteRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2ByteRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public FloatBidirectionalIterator iterator() { return new Float2ByteRBTreeMap.KeyIterator(Float2ByteRBTreeMap.this); } 
/* 1201 */     public FloatBidirectionalIterator iterator(float from) { return new Float2ByteRBTreeMap.KeyIterator(Float2ByteRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2ByteRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2ByteRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Float2ByteMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Float2ByteMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Float2ByteRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(float k) {
/* 1067 */       if ((this.next = Float2ByteRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Float2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Float2ByteRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
