  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof FloatComparator))) {
      ...
      this.actualComparator = new FloatComparator()
      {
        ...
        {
          return Float2ByteRBTreeMap.this.storedComparator.compare(Float.valueOf(local_k1), Float.valueOf(local_k2));
        }
  ...
  public Float2ByteRBTreeMap(Comparator<? super Float> local_c)
  {
    this();
  ...
  public Float2ByteRBTreeMap(Map<? extends Float, ? extends Byte> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2ByteRBTreeMap(SortedMap<Float, Byte> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2ByteRBTreeMap(Float2ByteMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2ByteRBTreeMap(Float2ByteSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2ByteRBTreeMap(float[] local_k, byte[] local_v, Comparator<? super Float> local_c)
  {
    this(local_c);
  ...
  public Float2ByteRBTreeMap(float[] local_k, byte[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Float2ByteMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Float2ByteRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Float2ByteRBTreeMap.EntryIterator(Float2ByteRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from)
        {
          return new Float2ByteRBTreeMap.EntryIterator(Float2ByteRBTreeMap.this, ((Float)from.getKey()).floatValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Float2ByteRBTreeMap.Entry local_f = Float2ByteRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Float2ByteRBTreeMap.Entry local_f = Float2ByteRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
          if (local_f != null) {
            Float2ByteRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Float2ByteRBTreeMap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2ByteEntrySet();
        }
        
        public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry local_to)
        {
          return Float2ByteRBTreeMap.this.headMap((Float)local_to.getKey()).float2ByteEntrySet();
        }
        
        public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from)
        {
          return Float2ByteRBTreeMap.this.tailMap((Float)from.getKey()).float2ByteEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Float2ByteRBTreeMap.ValueIterator(Float2ByteRBTreeMap.this, null);
        }
        
        public boolean contains(byte local_k)
        {
          return Float2ByteRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Float2ByteRBTreeMap local_c;
    try
    {
      local_c = (Float2ByteRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Float2ByteRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Float2ByteRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Float2ByteRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator()
          {
            return new Float2ByteRBTreeMap.Submap.SubmapEntryIterator(Float2ByteRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from)
          {
            return new Float2ByteRBTreeMap.Submap.SubmapEntryIterator(Float2ByteRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Float, Byte> local_e = (Map.Entry)local_o;
            Float2ByteRBTreeMap.Entry local_f = Float2ByteRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            return (local_f != null) && (Float2ByteRBTreeMap.Submap.this.in(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Float, Byte> local_e = (Map.Entry)local_o;
            Float2ByteRBTreeMap.Entry local_f = Float2ByteRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            if ((local_f != null) && (Float2ByteRBTreeMap.Submap.this.in(local_f.key))) {
              Float2ByteRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Float2ByteRBTreeMap.Submap.SubmapIterator(Float2ByteRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Float2ByteRBTreeMap.Submap.this.clear();
          }
          
          public Float2ByteMap.Entry first()
          {
            return Float2ByteRBTreeMap.Submap.this.firstEntry();
          }
          
          public Float2ByteMap.Entry last()
          {
            return Float2ByteRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry local_to)
          {
            return Float2ByteRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2ByteEntrySet();
          }
          
          public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry local_to)
          {
            return Float2ByteRBTreeMap.Submap.this.headMap((Float)local_to.getKey()).float2ByteEntrySet();
          }
          
          public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from)
          {
            return Float2ByteRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2ByteEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ByteCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractByteCollection()
        {
          public ByteIterator iterator()
          {
            return new Float2ByteRBTreeMap.Submap.SubmapValueIterator(Float2ByteRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(byte local_k)
          {
            return Float2ByteRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Float2ByteRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(float local_k)
    {
      return (in(local_k)) && (Float2ByteRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      float local_kk = local_k;
      Float2ByteRBTreeMap.Entry local_e;
      return (in(local_kk)) && ((local_e = Float2ByteRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public byte put(float local_k, byte local_v)
    {
      ...
      byte oldValue = Float2ByteRBTreeMap.this.put(local_k, local_v);
    ...
    public byte remove(float local_k)
    {
      ...
      byte oldValue = Float2ByteRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Float2ByteRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Float2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Float2ByteRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Float2ByteSortedMap tailMap(float from)
    {
      if (this.bottom) {
        return new Submap(Float2ByteRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Float2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2ByteRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Float2ByteSortedMap subMap(float from, float local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Float2ByteRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Float2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Float2ByteRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Float2ByteRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Float2ByteRBTreeMap.this.locateKey(this.from);
        if (Float2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Float2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Float2ByteRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Float2ByteRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Float2ByteRBTreeMap.this.locateKey(this.field_47);
        if (Float2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Float2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public float firstFloatKey()
    {
      Float2ByteRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public float lastFloatKey()
    {
      Float2ByteRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Float2ByteRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Float2ByteRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(float local_k)
      {
        this();
        if (this.next != null) {
          if ((!Float2ByteRBTreeMap.Submap.this.bottom) && (Float2ByteRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Float2ByteRBTreeMap.Submap.this.top) && (Float2ByteRBTreeMap.this.compare(local_k, (this.prev = Float2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Float2ByteRBTreeMap.this.locateKey(local_k);
            if (Float2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Float2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2ByteRBTreeMap.this.compare(this.prev.key, Float2ByteRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Float2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Float2ByteRBTreeMap.this.compare(this.next.key, Float2ByteRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractFloat2ByteSortedMap.KeySet
    {
      ...
      {
        return new Float2ByteRBTreeMap.Submap.SubmapKeyIterator(Float2ByteRBTreeMap.Submap.this);
      }
      
      public FloatBidirectionalIterator iterator(float from)
      {
        return new Float2ByteRBTreeMap.Submap.SubmapKeyIterator(Float2ByteRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractFloat2ByteSortedMap.KeySet
  {
    ...
    public FloatBidirectionalIterator iterator()
    {
      return new Float2ByteRBTreeMap.KeyIterator(Float2ByteRBTreeMap.this);
    }
    
    public FloatBidirectionalIterator iterator(float from)
    {
      return new Float2ByteRBTreeMap.KeyIterator(Float2ByteRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Float2ByteRBTreeMap.this.locateKey(local_k)) != null) {
        if (Float2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
