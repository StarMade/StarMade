  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2IntOpenCustomHashMap(int expected, float local_f, FloatHash.Strategy strategy)
  {
  ...
  public Float2IntOpenCustomHashMap(Map<? extends Float, ? extends Integer> local_m, float local_f, FloatHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Float2IntOpenCustomHashMap(Map<? extends Float, ? extends Integer> local_m, FloatHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Float2IntOpenCustomHashMap(Float2IntMap local_m, float local_f, FloatHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Float2IntOpenCustomHashMap(Float2IntMap local_m, FloatHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Float2IntOpenCustomHashMap(float[] local_k, int[] local_v, float local_f, FloatHash.Strategy strategy)
  {
  ...
  public Float2IntOpenCustomHashMap(float[] local_k, int[] local_v, FloatHash.Strategy strategy)
  {
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Float2IntOpenCustomHashMap.ValueIterator(Float2IntOpenCustomHashMap.this);
        }
        ...
        {
          return Float2IntOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2IntOpenCustomHashMap local_c;
    try
    {
      local_c = (Float2IntOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Float2IntOpenCustomHashMap.MapIterator
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Float2IntOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSet
  {
    ...
    {
      return new Float2IntOpenCustomHashMap.KeyIterator(Float2IntOpenCustomHashMap.this);
    }
    ...
    {
      return Float2IntOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2IntOpenCustomHashMap.this.size;
      Float2IntOpenCustomHashMap.this.remove(local_k);
    ...
    implements FloatIterator
  {
    ...
    public Float next()
    {
      return Float.valueOf(Float2IntOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2IntMap.FastEntrySet
  {
    ...
    {
      return new Float2IntOpenCustomHashMap.EntryIterator(Float2IntOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Float2IntMap.Entry> fastIterator()
    {
      return new Float2IntOpenCustomHashMap.FastEntryIterator(Float2IntOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Float2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Float2IntOpenCustomHashMap.this.mask; Float2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2IntOpenCustomHashMap.this.mask) {
        if (Float2IntOpenCustomHashMap.this.strategy.equals(Float2IntOpenCustomHashMap.this.key[pos], local_k)) {
          return Float2IntOpenCustomHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Float2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Float2IntOpenCustomHashMap.this.mask; Float2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2IntOpenCustomHashMap.this.mask) {
        if (Float2IntOpenCustomHashMap.this.strategy.equals(Float2IntOpenCustomHashMap.this.key[pos], local_k))
        {
          Float2IntOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Float2IntMap.Entry>
  {
    ...
    public AbstractFloat2IntMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2IntOpenCustomHashMap.this.key[local_e];
      this.entry.value = Float2IntOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Float2IntMap.Entry>
  {
    ...
    {
      return this.entry = new Float2IntOpenCustomHashMap.MapEntry(Float2IntOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Float2IntOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1914 = Float2IntOpenCustomHashMap.this.size;
    FloatArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Float2IntOpenCustomHashMap.this.used;
      while ((this.field_1914 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1914 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1914 != 0)
      {
        boolean[] local_k = Float2IntOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2IntOpenCustomHashMap.this.mask; Float2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2IntOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Float2IntOpenCustomHashMap.this.strategy.hashCode(Float2IntOpenCustomHashMap.this.key[pos])) & Float2IntOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2IntOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Float2IntOpenCustomHashMap.this.key[pos]);
        }
        Float2IntOpenCustomHashMap.this.key[last] = Float2IntOpenCustomHashMap.this.key[pos];
        Float2IntOpenCustomHashMap.this.value[last] = Float2IntOpenCustomHashMap.this.value[pos];
      }
      Float2IntOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Float2IntOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
        this.last = -1;
        return;
      }
      Float2IntOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1914 > 0))
      {
        this.field_1914 += 1;
        nextEntry();
      }
    ...
    implements Float2IntMap.Entry, Map.Entry<Float, Integer>
  {
    ...
    public int setValue(int local_v)
    {
      ...
      Float2IntOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Integer> local_e = (Map.Entry)local_o;
      return (Float2IntOpenCustomHashMap.this.strategy.equals(Float2IntOpenCustomHashMap.this.key[this.index], ((Float)local_e.getKey()).floatValue())) && (Float2IntOpenCustomHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
