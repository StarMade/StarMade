...
public class Float2ReferenceSortedMaps
{
  ...
  public static <V> Float2ReferenceSortedMap<V> synchronize(Float2ReferenceSortedMap<V> local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static <V> Float2ReferenceSortedMap<V> synchronize(Float2ReferenceSortedMap<V> local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static <V> Float2ReferenceSortedMap<V> unmodifiable(Float2ReferenceSortedMap<V> local_m)
  {
    ...
    implements Float2ReferenceSortedMap<V>, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Float2ReferenceSortedMap<V> local_m)
    {
      super();
    ...
    implements Float2ReferenceSortedMap<V>, Serializable
  {
    ...
    protected SynchronizedSortedMap(Float2ReferenceSortedMap<V> local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Float2ReferenceSortedMap<V> local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Float2ReferenceSortedMap<V>, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Float2ReferenceMaps.Singleton.SingletonEntry(this), Float2ReferenceSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
