...
/*      */   protected int size;
/*      */   protected volatile transient Float2ShortSortedMap.FastSortedEntrySet entries;
...
/*      */   }
/*      */ 
/*      */   public short add(float k, short incr)
/*      */   {
...
/*      */         int tmp46_45 = pos;
/*      */         short[] tmp46_42 = this.value; tmp46_42[tmp46_45] = ((short)(tmp46_42[tmp46_45] + incr));
/*  311 */         return oldValue;
/*      */       }
...
/*  786 */   public Float2ShortSortedMap tailMap(float from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Float2ShortSortedMap headMap(float to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Float2ShortSortedMap subMap(float from, float to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Float2ShortLinkedOpenHashMap.ValueIterator(Float2ShortLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Float2ShortLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(short v) {
/* 1113 */           return Float2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Float2ShortLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Float2ShortLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public short previousShort()
/*      */     {
/* 1094 */       return Float2ShortLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Short previous() { return Short.valueOf(Float2ShortLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public short nextShort() { return Float2ShortLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Short next() { return Short.valueOf(Float2ShortLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Float2ShortLinkedOpenHashMap.KeyIterator(Float2ShortLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public FloatListIterator iterator() {
/* 1054 */       return new Float2ShortLinkedOpenHashMap.KeyIterator(Float2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Float2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(float k) {
/* 1060 */       return Float2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(float k) {
/* 1063 */       int oldSize = Float2ShortLinkedOpenHashMap.this.size;
/* 1064 */       Float2ShortLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Float2ShortLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Float2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public float firstFloat() {
/* 1071 */       if (Float2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public float lastFloat() {
/* 1075 */       if (Float2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2ShortLinkedOpenHashMap.MapIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator(float k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public float previousFloat() { return Float2ShortLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Float previous() { return Float.valueOf(Float2ShortLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public float nextFloat() { return Float2ShortLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Float next() { return Float.valueOf(Float2ShortLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Float2ShortLinkedOpenHashMap.EntryIterator(Float2ShortLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Float2ShortMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Float2ShortMap.Entry> subSet(Float2ShortMap.Entry fromElement, Float2ShortMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Float2ShortMap.Entry> headSet(Float2ShortMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Float2ShortMap.Entry> tailSet(Float2ShortMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Float2ShortMap.Entry first() {
/*  973 */       if (Float2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this, Float2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Float2ShortMap.Entry last() {
/*  977 */       if (Float2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this, Float2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Float2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Float2ShortLinkedOpenHashMap.this.key[pos] == k) return Float2ShortLinkedOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/*  990 */         pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Float2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Float2ShortLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Float2ShortLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Float2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Float2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator(Float2ShortMap.Entry from) {
/* 1018 */       return new Float2ShortLinkedOpenHashMap.EntryIterator(Float2ShortLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2ShortMap.Entry> fastIterator() {
/* 1021 */       return new Float2ShortLinkedOpenHashMap.FastEntryIterator(Float2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2ShortMap.Entry> fastIterator(Float2ShortMap.Entry from) {
/* 1024 */       return new Float2ShortLinkedOpenHashMap.FastEntryIterator(Float2ShortLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Float2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2ShortMap.Entry>
/*      */   {
/*  944 */     final AbstractFloat2ShortMap.BasicEntry entry = new AbstractFloat2ShortMap.BasicEntry(0.0F, (short)0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Float2ShortLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Float2ShortLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractFloat2ShortMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Float2ShortLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Float2ShortLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2ShortMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Float2ShortLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Float2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Float2ShortLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(float from) {
/*  809 */       if (Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Float2ShortLinkedOpenHashMap.this.last;
/*  811 */         this.index = Float2ShortLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Float2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Float2ShortLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Float2ShortLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Float2ShortLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Float2ShortLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Float2ShortLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Float2ShortLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Float2ShortLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Float2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Float2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Float2ShortLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Float2ShortLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Float2ShortLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Float2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Float2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Float2ShortLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Float2ShortLinkedOpenHashMap.this.link[this.next] ^= (Float2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Float2ShortLinkedOpenHashMap.this.mask;
/*  897 */         while (Float2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ShortLinkedOpenHashMap.this.key[pos])) & Float2ShortLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Float2ShortLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Float2ShortLinkedOpenHashMap.this.key[last] = Float2ShortLinkedOpenHashMap.this.key[pos];
/*  904 */         Float2ShortLinkedOpenHashMap.this.value[last] = Float2ShortLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Float2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Float2ShortLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Float getKey() {
/*  669 */       return Float.valueOf(Float2ShortLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public float getFloatKey() {
/*  672 */       return Float2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Short getValue() {
/*  675 */       return Short.valueOf(Float2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public short getShortValue() {
/*  678 */       return Float2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public short setValue(short v) {
/*  681 */       short oldValue = Float2ShortLinkedOpenHashMap.this.value[this.index];
/*  682 */       Float2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Short setValue(Short v) {
...
/*  692 */       return (Float2ShortLinkedOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.float2int(Float2ShortLinkedOpenHashMap.this.key[this.index]) ^ Float2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Float2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Float2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
