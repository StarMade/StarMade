  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2ShortLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2ShortLinkedOpenHashMap(Map<? extends Float, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2ShortLinkedOpenHashMap(Map<? extends Float, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2ShortLinkedOpenHashMap(Float2ShortMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2ShortLinkedOpenHashMap(Float2ShortMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2ShortLinkedOpenHashMap(float[] local_k, short[] local_v, float local_f)
  {
  ...
  public Float2ShortLinkedOpenHashMap(float[] local_k, short[] local_v)
  {
  ...
  public short add(float local_k, short incr)
  {
    for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k)
      {
        short oldValue = this.value[pos];
        int tmp46_45 = pos;
        short[] tmp46_42 = this.value;
        tmp46_42[tmp46_45] = ((short)(tmp46_42[tmp46_45] + incr));
        return oldValue;
      }
    }
    this.used[pos] = true;
  ...
  public short getAndMoveToFirst(float local_k)
  {
    float[] key = this.key;
  ...
  public short getAndMoveToLast(float local_k)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public short putAndMoveToFirst(float local_k, short local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public short putAndMoveToLast(float local_k, short local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public Short get(Float local_ok)
  {
    float local_k = local_ok.floatValue();
    for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k) {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Float2ShortLinkedOpenHashMap.ValueIterator(Float2ShortLinkedOpenHashMap.this);
        }
        ...
        {
          return Float2ShortLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2ShortLinkedOpenHashMap local_c;
    try
    {
      local_c = (Float2ShortLinkedOpenHashMap)super.clone();
    }
    ...
    implements ShortListIterator
  {
    ...
    {
      return Short.valueOf(Float2ShortLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Short next()
    {
      return Short.valueOf(Float2ShortLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSortedSet
  {
    ...
    {
      return new Float2ShortLinkedOpenHashMap.KeyIterator(Float2ShortLinkedOpenHashMap.this, from);
    }
    
    public FloatListIterator iterator()
    {
      return new Float2ShortLinkedOpenHashMap.KeyIterator(Float2ShortLinkedOpenHashMap.this);
    }
    ...
    {
      return Float2ShortLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2ShortLinkedOpenHashMap.this.size;
      Float2ShortLinkedOpenHashMap.this.remove(local_k);
    ...
    implements FloatListIterator
  {
    ...
    {
      return Float.valueOf(Float2ShortLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Float2ShortLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2ShortSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Float2ShortLinkedOpenHashMap.EntryIterator(Float2ShortLinkedOpenHashMap.this);
    }
    ...
    public Float2ShortMap.Entry first()
    {
      ...
      return new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this, Float2ShortLinkedOpenHashMap.this.first);
    }
    ...
    public Float2ShortMap.Entry last()
    {
      ...
      return new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this, Float2ShortLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2ShortLinkedOpenHashMap.this.mask; Float2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask) {
        if (Float2ShortLinkedOpenHashMap.this.key[pos] == local_k) {
          return Float2ShortLinkedOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2ShortLinkedOpenHashMap.this.mask; Float2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask) {
        if (Float2ShortLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Float2ShortLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Float2ShortLinkedOpenHashMap.EntryIterator(Float2ShortLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
    
    public ObjectBidirectionalIterator<Float2ShortMap.Entry> fastIterator()
    {
      return new Float2ShortLinkedOpenHashMap.FastEntryIterator(Float2ShortLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Float2ShortMap.Entry> fastIterator(Float2ShortMap.Entry from)
    {
      return new Float2ShortLinkedOpenHashMap.FastEntryIterator(Float2ShortLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
  }
  ...
  {
    final AbstractFloat2ShortMap.BasicEntry entry = new AbstractFloat2ShortMap.BasicEntry(0.0F, (short)0);
    ...
    public AbstractFloat2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2ShortLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Float2ShortLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Float2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this, nextEntry());
    }
    
    public Float2ShortLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Float2ShortLinkedOpenHashMap.MapEntry(Float2ShortLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    {
      if (Float2ShortLinkedOpenHashMap.this.key[Float2ShortLinkedOpenHashMap.this.last] == from)
      {
      ...
      {
        for (int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2ShortLinkedOpenHashMap.this.mask; Float2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask) {
          if (Float2ShortLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Float2ShortLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Float2ShortLinkedOpenHashMap.this.first = this.next;
      } else {
        Float2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Float2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Float2ShortLinkedOpenHashMap.this.last = this.prev;
      } else {
        Float2ShortLinkedOpenHashMap.this.link[this.next] ^= (Float2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2ShortLinkedOpenHashMap.this.mask; Float2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ShortLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ShortLinkedOpenHashMap.this.key[pos])) & Float2ShortLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2ShortLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Float2ShortLinkedOpenHashMap.this.key[last] = Float2ShortLinkedOpenHashMap.this.key[pos];
      ...
      Float2ShortLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Float2ShortMap.Entry, Map.Entry<Float, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Float2ShortLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Short> local_e = (Map.Entry)local_o;
      return (Float2ShortLinkedOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
