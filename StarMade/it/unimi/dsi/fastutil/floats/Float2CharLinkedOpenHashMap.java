  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2CharLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2CharLinkedOpenHashMap(Map<? extends Float, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2CharLinkedOpenHashMap(Map<? extends Float, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2CharLinkedOpenHashMap(Float2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2CharLinkedOpenHashMap(Float2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2CharLinkedOpenHashMap(float[] local_k, char[] local_v, float local_f)
  {
  ...
  public Float2CharLinkedOpenHashMap(float[] local_k, char[] local_v)
  {
  ...
  public char getAndMoveToFirst(float local_k)
  {
    float[] key = this.key;
  ...
  public char getAndMoveToLast(float local_k)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToFirst(float local_k, char local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToLast(float local_k, char local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Float2CharLinkedOpenHashMap.ValueIterator(Float2CharLinkedOpenHashMap.this);
        }
        ...
        {
          return Float2CharLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2CharLinkedOpenHashMap local_c;
    try
    {
      local_c = (Float2CharLinkedOpenHashMap)super.clone();
    }
    ...
    implements CharListIterator
  {
    ...
    {
      return Float2CharLinkedOpenHashMap.this.value[previousEntry()];
    }
    
    public Character previous()
    {
      return Character.valueOf(Float2CharLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Float2CharLinkedOpenHashMap.this.value[nextEntry()];
    }
    
    public Character next()
    {
      return Character.valueOf(Float2CharLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSortedSet
  {
    ...
    {
      return new Float2CharLinkedOpenHashMap.KeyIterator(Float2CharLinkedOpenHashMap.this, from);
    }
    
    public FloatListIterator iterator()
    {
      return new Float2CharLinkedOpenHashMap.KeyIterator(Float2CharLinkedOpenHashMap.this);
    }
    ...
    {
      return Float2CharLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2CharLinkedOpenHashMap.this.size;
      Float2CharLinkedOpenHashMap.this.remove(local_k);
    ...
    implements FloatListIterator
  {
    ...
    {
      return Float2CharLinkedOpenHashMap.this.key[previousEntry()];
    }
    ...
    {
      return Float.valueOf(Float2CharLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    {
      return Float2CharLinkedOpenHashMap.this.key[nextEntry()];
    }
    
    public Float next()
    {
      return Float.valueOf(Float2CharLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2CharSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Float2CharLinkedOpenHashMap.EntryIterator(Float2CharLinkedOpenHashMap.this);
    }
    ...
    public Float2CharMap.Entry first()
    {
      ...
      return new Float2CharLinkedOpenHashMap.MapEntry(Float2CharLinkedOpenHashMap.this, Float2CharLinkedOpenHashMap.this.first);
    }
    ...
    public Float2CharMap.Entry last()
    {
      ...
      return new Float2CharLinkedOpenHashMap.MapEntry(Float2CharLinkedOpenHashMap.this, Float2CharLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2CharLinkedOpenHashMap.this.mask; Float2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2CharLinkedOpenHashMap.this.mask) {
        if (Float2CharLinkedOpenHashMap.this.key[pos] == local_k) {
          return Float2CharLinkedOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2CharLinkedOpenHashMap.this.mask; Float2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2CharLinkedOpenHashMap.this.mask) {
        if (Float2CharLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Float2CharLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Float2CharLinkedOpenHashMap.EntryIterator(Float2CharLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
    
    public ObjectBidirectionalIterator<Float2CharMap.Entry> fastIterator()
    {
      return new Float2CharLinkedOpenHashMap.FastEntryIterator(Float2CharLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Float2CharMap.Entry> fastIterator(Float2CharMap.Entry from)
    {
      return new Float2CharLinkedOpenHashMap.FastEntryIterator(Float2CharLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
  }
    ...
    implements ObjectListIterator<Float2CharMap.Entry>
  {
    ...
    public AbstractFloat2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2CharLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Float2CharLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Float2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Float2CharLinkedOpenHashMap.MapEntry(Float2CharLinkedOpenHashMap.this, nextEntry());
    }
    
    public Float2CharLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Float2CharLinkedOpenHashMap.MapEntry(Float2CharLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(float from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2CharLinkedOpenHashMap.this.mask; Float2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2CharLinkedOpenHashMap.this.mask) {
          if (Float2CharLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Float2CharLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Float2CharLinkedOpenHashMap.this.first = this.next;
      } else {
        Float2CharLinkedOpenHashMap.this.link[this.prev] ^= (Float2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Float2CharLinkedOpenHashMap.this.last = this.prev;
      } else {
        Float2CharLinkedOpenHashMap.this.link[this.next] ^= (Float2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2CharLinkedOpenHashMap.this.mask; Float2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2CharLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2CharLinkedOpenHashMap.this.key[pos])) & Float2CharLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2CharLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Float2CharLinkedOpenHashMap.this.key[last] = Float2CharLinkedOpenHashMap.this.key[pos];
      ...
      Float2CharLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Float2CharMap.Entry, Map.Entry<Float, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Float2CharLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Character> local_e = (Map.Entry)local_o;
      return (Float2CharLinkedOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2CharLinkedOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
