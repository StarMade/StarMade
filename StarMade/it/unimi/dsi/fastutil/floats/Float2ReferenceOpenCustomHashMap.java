  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2ReferenceOpenCustomHashMap(int expected, float local_f, FloatHash.Strategy strategy)
  {
  ...
  public Float2ReferenceOpenCustomHashMap(Map<? extends Float, ? extends V> local_m, float local_f, FloatHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Float2ReferenceOpenCustomHashMap(Map<? extends Float, ? extends V> local_m, FloatHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Float2ReferenceOpenCustomHashMap(Float2ReferenceMap<V> local_m, float local_f, FloatHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Float2ReferenceOpenCustomHashMap(Float2ReferenceMap<V> local_m, FloatHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Float2ReferenceOpenCustomHashMap(float[] local_k, V[] local_v, float local_f, FloatHash.Strategy strategy)
  {
  ...
  public Float2ReferenceOpenCustomHashMap(float[] local_k, V[] local_v, FloatHash.Strategy strategy)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Float2ReferenceOpenCustomHashMap.ValueIterator(Float2ReferenceOpenCustomHashMap.this);
        }
        ...
        {
          return Float2ReferenceOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2ReferenceOpenCustomHashMap<V> local_c;
    try
    {
      local_c = (Float2ReferenceOpenCustomHashMap)super.clone();
    }
    ...
    throws IOException
  {
    float[] key = this.key;
    V[] value = this.value;
    Float2ReferenceOpenCustomHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    implements ObjectIterator<V>
  {
    ...
    public V next()
    {
      return Float2ReferenceOpenCustomHashMap.this.value[nextEntry()];
    }
  }
    ...
    extends AbstractFloatSet
  {
    ...
    {
      return new Float2ReferenceOpenCustomHashMap.KeyIterator(Float2ReferenceOpenCustomHashMap.this);
    }
    ...
    {
      return Float2ReferenceOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2ReferenceOpenCustomHashMap.this.size;
      Float2ReferenceOpenCustomHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Float2ReferenceOpenCustomHashMap.MapIterator
    implements FloatIterator
  {
    ...
    {
      return Float2ReferenceOpenCustomHashMap.this.key[nextEntry()];
    }
    
    public Float next()
    {
      return Float.valueOf(Float2ReferenceOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2ReferenceMap.FastEntrySet<V>
  {
    ...
    {
      return new Float2ReferenceOpenCustomHashMap.EntryIterator(Float2ReferenceOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Float2ReferenceMap.Entry<V>> fastIterator()
    {
      return new Float2ReferenceOpenCustomHashMap.FastEntryIterator(Float2ReferenceOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Float2ReferenceOpenCustomHashMap.this.strategy.hashCode(local_k)) & Float2ReferenceOpenCustomHashMap.this.mask; Float2ReferenceOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ReferenceOpenCustomHashMap.this.mask) {
        if (Float2ReferenceOpenCustomHashMap.this.strategy.equals(Float2ReferenceOpenCustomHashMap.this.key[pos], local_k)) {
          return Float2ReferenceOpenCustomHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Float2ReferenceOpenCustomHashMap.this.strategy.hashCode(local_k)) & Float2ReferenceOpenCustomHashMap.this.mask; Float2ReferenceOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ReferenceOpenCustomHashMap.this.mask) {
        if (Float2ReferenceOpenCustomHashMap.this.strategy.equals(Float2ReferenceOpenCustomHashMap.this.key[pos], local_k))
        {
          Float2ReferenceOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Float2ReferenceMap.Entry<V>>
  {
    ...
    public AbstractFloat2ReferenceMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Float2ReferenceOpenCustomHashMap.this.key[local_e];
      this.entry.value = Float2ReferenceOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Float2ReferenceMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Float2ReferenceOpenCustomHashMap.MapEntry(Float2ReferenceOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2ReferenceOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Float2ReferenceOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1677 = Float2ReferenceOpenCustomHashMap.this.size;
    FloatArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Float2ReferenceOpenCustomHashMap.this.used;
      while ((this.field_1677 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1677 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1677 != 0)
      {
        boolean[] local_k = Float2ReferenceOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2ReferenceOpenCustomHashMap.this.mask; Float2ReferenceOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ReferenceOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Float2ReferenceOpenCustomHashMap.this.strategy.hashCode(Float2ReferenceOpenCustomHashMap.this.key[pos])) & Float2ReferenceOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2ReferenceOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Float2ReferenceOpenCustomHashMap.this.key[pos]);
        }
        Float2ReferenceOpenCustomHashMap.this.key[last] = Float2ReferenceOpenCustomHashMap.this.key[pos];
        Float2ReferenceOpenCustomHashMap.this.value[last] = Float2ReferenceOpenCustomHashMap.this.value[pos];
      }
      Float2ReferenceOpenCustomHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Float2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
        this.last = -1;
        return;
      }
      Float2ReferenceOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1677 > 0))
      {
        this.field_1677 += 1;
        nextEntry();
      }
    ...
    implements Float2ReferenceMap.Entry<V>, Map.Entry<Float, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Float2ReferenceOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, V> local_e = (Map.Entry)local_o;
      return (Float2ReferenceOpenCustomHashMap.this.strategy.equals(Float2ReferenceOpenCustomHashMap.this.key[this.index], ((Float)local_e.getKey()).floatValue())) && (Float2ReferenceOpenCustomHashMap.this.value[this.index] == local_e.getValue());
    }
