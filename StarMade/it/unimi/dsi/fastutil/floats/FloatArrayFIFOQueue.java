...
/*     */   {
/*  73 */     if (capacity > 0) this.array = new float[capacity];
...
/*  91 */     float t = this.array[this.start];
...
/* 110 */     float[] newArray = FloatArrays.grow(this.array, this.length + 1, 0);
...
/*     */   {
/* 165 */     int size = size();
/* 166 */     float[] newArray = new float[size + 1];
/*     */ 
