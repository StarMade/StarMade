...
/*   4:    */
/*  54:    */public class FloatArrayFIFOQueue
/*  55:    */  extends AbstractFloatPriorityQueue
/*  56:    */{
...
/*  68:    */  
/*  71:    */  public FloatArrayFIFOQueue(int capacity)
/*  72:    */  {
/*  73: 73 */    if (capacity > 0) this.array = new float[capacity];
/*  74: 74 */    this.length = this.array.length;
/*  75:    */  }
/*  76:    */  
/*  77:    */  public FloatArrayFIFOQueue()
/*  78:    */  {
/*  79: 79 */    this(16);
/*  80:    */  }
/*  81:    */  
/*  84:    */  public FloatComparator comparator()
/*  85:    */  {
/*  86: 86 */    return null;
/*  87:    */  }
/*  88:    */  
/*  89:    */  public float dequeueFloat() {
/*  90: 90 */    if (this.start == this.end) throw new NoSuchElementException();
/*  91: 91 */    float t = this.array[this.start];
/*  92: 92 */    if (++this.start == this.length) this.start = 0;
/*  93: 93 */    return t;
/*  94:    */  }
/*  95:    */  
/*  99:    */  public float dequeueLastFloat()
/* 100:    */  {
/* 101:101 */    if (this.start == this.end) throw new NoSuchElementException();
/* 102:102 */    if (this.end == 0) this.end = this.length;
/* 103:103 */    float t = this.array[(--this.end)];
/* 104:    */    
/* 106:106 */    return t;
/* 107:    */  }
/* 108:    */  
/* 109:    */  private final void expand() {
/* 110:110 */    float[] newArray = FloatArrays.grow(this.array, this.length + 1, 0);
...
/* 116:    */  }
/* 117:    */  
/* 118:    */  public void enqueue(float x)
/* 119:    */  {
...
/* 124:    */  }
/* 125:    */  
/* 126:    */  public void enqueueFirst(float x)
/* 127:    */  {
...
/* 166:166 */    float[] newArray = new float[size + 1];
/* 167:    */    
