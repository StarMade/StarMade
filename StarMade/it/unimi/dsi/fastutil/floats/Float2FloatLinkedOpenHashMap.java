  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2FloatLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2FloatLinkedOpenHashMap(Map<? extends Float, ? extends Float> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2FloatLinkedOpenHashMap(Map<? extends Float, ? extends Float> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2FloatLinkedOpenHashMap(Float2FloatMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2FloatLinkedOpenHashMap(Float2FloatMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2FloatLinkedOpenHashMap(float[] local_k, float[] local_v, float local_f)
  {
  ...
  public Float2FloatLinkedOpenHashMap(float[] local_k, float[] local_v)
  {
  ...
  public float getAndMoveToFirst(float local_k)
  {
    float[] key = this.key;
  ...
  public float getAndMoveToLast(float local_k)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public float putAndMoveToFirst(float local_k, float local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public float putAndMoveToLast(float local_k, float local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Float2FloatLinkedOpenHashMap.ValueIterator(Float2FloatLinkedOpenHashMap.this);
        }
        ...
        {
          return Float2FloatLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2FloatLinkedOpenHashMap local_c;
    try
    {
      local_c = (Float2FloatLinkedOpenHashMap)super.clone();
    }
    ...
    implements FloatListIterator
  {
    ...
    {
      return Float.valueOf(Float2FloatLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Float2FloatLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSortedSet
  {
    ...
    {
      return new Float2FloatLinkedOpenHashMap.KeyIterator(Float2FloatLinkedOpenHashMap.this, from);
    }
    
    public FloatListIterator iterator()
    {
      return new Float2FloatLinkedOpenHashMap.KeyIterator(Float2FloatLinkedOpenHashMap.this);
    }
    ...
    {
      return Float2FloatLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2FloatLinkedOpenHashMap.this.size;
      Float2FloatLinkedOpenHashMap.this.remove(local_k);
    ...
    implements FloatListIterator
  {
    ...
    public Float previous()
    {
      return Float.valueOf(Float2FloatLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Float2FloatLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2FloatSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Float2FloatLinkedOpenHashMap.EntryIterator(Float2FloatLinkedOpenHashMap.this);
    }
    ...
    public Float2FloatMap.Entry first()
    {
      ...
      return new Float2FloatLinkedOpenHashMap.MapEntry(Float2FloatLinkedOpenHashMap.this, Float2FloatLinkedOpenHashMap.this.first);
    }
    ...
    public Float2FloatMap.Entry last()
    {
      ...
      return new Float2FloatLinkedOpenHashMap.MapEntry(Float2FloatLinkedOpenHashMap.this, Float2FloatLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2FloatLinkedOpenHashMap.this.mask; Float2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2FloatLinkedOpenHashMap.this.mask) {
        if (Float2FloatLinkedOpenHashMap.this.key[pos] == local_k) {
          return Float2FloatLinkedOpenHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2FloatLinkedOpenHashMap.this.mask; Float2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2FloatLinkedOpenHashMap.this.mask) {
        if (Float2FloatLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Float2FloatLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Float2FloatLinkedOpenHashMap.EntryIterator(Float2FloatLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
    
    public ObjectBidirectionalIterator<Float2FloatMap.Entry> fastIterator()
    {
      return new Float2FloatLinkedOpenHashMap.FastEntryIterator(Float2FloatLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Float2FloatMap.Entry> fastIterator(Float2FloatMap.Entry from)
    {
      return new Float2FloatLinkedOpenHashMap.FastEntryIterator(Float2FloatLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
  }
    ...
    implements ObjectListIterator<Float2FloatMap.Entry>
  {
    ...
    public AbstractFloat2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2FloatLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Float2FloatLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Float2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Float2FloatLinkedOpenHashMap.MapEntry(Float2FloatLinkedOpenHashMap.this, nextEntry());
    }
    
    public Float2FloatLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Float2FloatLinkedOpenHashMap.MapEntry(Float2FloatLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2FloatLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    {
      if (Float2FloatLinkedOpenHashMap.this.key[Float2FloatLinkedOpenHashMap.this.last] == from)
      {
      ...
      {
        for (int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2FloatLinkedOpenHashMap.this.mask; Float2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2FloatLinkedOpenHashMap.this.mask) {
          if (Float2FloatLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Float2FloatLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Float2FloatLinkedOpenHashMap.this.first = this.next;
      } else {
        Float2FloatLinkedOpenHashMap.this.link[this.prev] ^= (Float2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Float2FloatLinkedOpenHashMap.this.last = this.prev;
      } else {
        Float2FloatLinkedOpenHashMap.this.link[this.next] ^= (Float2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2FloatLinkedOpenHashMap.this.mask; Float2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2FloatLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2FloatLinkedOpenHashMap.this.key[pos])) & Float2FloatLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2FloatLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Float2FloatLinkedOpenHashMap.this.key[last] = Float2FloatLinkedOpenHashMap.this.key[pos];
      ...
      Float2FloatLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Float2FloatMap.Entry, Map.Entry<Float, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Float2FloatLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Float> local_e = (Map.Entry)local_o;
      return (Float2FloatLinkedOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2FloatLinkedOpenHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
