...
/* 607 */           return new Float2ReferenceOpenHashMap.ValueIterator(Float2ReferenceOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 610 */           return Float2ReferenceOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 613 */           return Float2ReferenceOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 616 */           Float2ReferenceOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 731 */       c = (Float2ReferenceOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Float2ReferenceOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public V next() { return Float2ReferenceOpenHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 573 */       return new Float2ReferenceOpenHashMap.KeyIterator(Float2ReferenceOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 576 */       return Float2ReferenceOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(float k) {
/* 579 */       return Float2ReferenceOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(float k) {
/* 582 */       int oldSize = Float2ReferenceOpenHashMap.this.size;
/* 583 */       Float2ReferenceOpenHashMap.this.remove(k);
/* 584 */       return Float2ReferenceOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 587 */       Float2ReferenceOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Float2ReferenceOpenHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 567 */       super(null); } 
/* 568 */     public float nextFloat() { return Float2ReferenceOpenHashMap.this.key[nextEntry()]; } 
/* 569 */     public Float next() { return Float.valueOf(Float2ReferenceOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 513 */       return new Float2ReferenceOpenHashMap.EntryIterator(Float2ReferenceOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Float2ReferenceMap.Entry<V>> fastIterator() {
/* 516 */       return new Float2ReferenceOpenHashMap.FastEntryIterator(Float2ReferenceOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 524 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ReferenceOpenHashMap.this.mask;
/*     */ 
/* 526 */       while (Float2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 527 */         if (Float2ReferenceOpenHashMap.this.key[pos] == k) return Float2ReferenceOpenHashMap.this.value[pos] == e.getValue();
/* 528 */         pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask;
/*     */       }
/* 530 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 538 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ReferenceOpenHashMap.this.mask;
/*     */ 
/* 540 */       while (Float2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 541 */         if (Float2ReferenceOpenHashMap.this.key[pos] == k) {
/* 542 */           Float2ReferenceOpenHashMap.this.remove(e.getKey());
/* 543 */           return true;
/*     */         }
/* 545 */         pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask;
/*     */       }
/* 547 */       return false;
/*     */     }
/*     */     public int size() {
/* 550 */       return Float2ReferenceOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 553 */       Float2ReferenceOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Float2ReferenceOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Float2ReferenceMap.Entry<V>>
/*     */   {
/* 503 */     final AbstractFloat2ReferenceMap.BasicEntry<V> entry = new AbstractFloat2ReferenceMap.BasicEntry(0.0F, null);
/*     */ 
...
/* 505 */       int e = nextEntry();
/* 506 */       this.entry.key = Float2ReferenceOpenHashMap.this.key[e];
/* 507 */       this.entry.value = Float2ReferenceOpenHashMap.this.value[e];
/* 508 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Float2ReferenceOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Float2ReferenceMap.Entry<V>>
/*     */   {
...
/* 494 */       return this.entry = new Float2ReferenceOpenHashMap.MapEntry(Float2ReferenceOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 498 */       super.remove();
/* 499 */       Float2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 399 */       this.pos = Float2ReferenceOpenHashMap.this.n;
/*     */ 
/* 402 */       this.last = -1;
/*     */ 
/* 404 */       this.c = Float2ReferenceOpenHashMap.this.size;
/*     */ 
/* 409 */       boolean[] used = Float2ReferenceOpenHashMap.this.used;
...
/*     */ 
/* 422 */         int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ReferenceOpenHashMap.this.mask;
/*     */ 
/* 424 */         while (Float2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 425 */           if (Float2ReferenceOpenHashMap.this.key[pos] == k) return pos;
/* 426 */           pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 429 */       this.last = this.pos;
/*     */ 
/* 431 */       if (this.c != 0) {
/* 432 */         boolean[] used = Float2ReferenceOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 449 */         pos = (last = pos) + 1 & Float2ReferenceOpenHashMap.this.mask;
/* 450 */         while (Float2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 451 */           int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ReferenceOpenHashMap.this.key[pos])) & Float2ReferenceOpenHashMap.this.mask;
/* 452 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453 */           pos = pos + 1 & Float2ReferenceOpenHashMap.this.mask;
/*     */         }
/* 455 */         if (Float2ReferenceOpenHashMap.this.used[pos] == 0) break;
/* 456 */         if (pos < last)
/*     */         {
/* 458 */           if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 459 */           this.wrapped.add(Float2ReferenceOpenHashMap.this.key[pos]);
/*     */         }
/* 461 */         Float2ReferenceOpenHashMap.this.key[last] = Float2ReferenceOpenHashMap.this.key[pos];
/* 462 */         Float2ReferenceOpenHashMap.this.value[last] = Float2ReferenceOpenHashMap.this.value[pos];
/*     */       }
/* 464 */       Float2ReferenceOpenHashMap.this.used[last] = false;
/* 465 */       Float2ReferenceOpenHashMap.this.value[last] = null;
/* 466 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 471 */       if (this.pos < -1)
/*     */       {
/* 473 */         Float2ReferenceOpenHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 474 */         this.last = -1;
/* 475 */         return;
/*     */       }
/* 477 */       Float2ReferenceOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Float getKey() {
/* 369 */       return Float.valueOf(Float2ReferenceOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public float getFloatKey() {
/* 372 */       return Float2ReferenceOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 375 */       return Float2ReferenceOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 378 */       Object oldValue = Float2ReferenceOpenHashMap.this.value[this.index];
/* 379 */       Float2ReferenceOpenHashMap.this.value[this.index] = v;
/* 380 */       return oldValue;
/*     */     }
/*     */ 
...
/* 386 */       return (Float2ReferenceOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/*     */     }
/*     */     public int hashCode() {
/* 389 */       return HashCommon.float2int(Float2ReferenceOpenHashMap.this.key[this.index]) ^ (Float2ReferenceOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Float2ReferenceOpenHashMap.this.value[this.index]));
/*     */     }
/*     */     public String toString() {
/* 392 */       return Float2ReferenceOpenHashMap.this.key[this.index] + "=>" + Float2ReferenceOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
