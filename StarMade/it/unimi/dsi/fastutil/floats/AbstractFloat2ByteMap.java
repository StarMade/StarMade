...
/*     */     {
/*  92 */       while (n-- != 0) {
/*  93 */         Float2ByteMap.Entry e = (Float2ByteMap.Entry)i.next();
/*  94 */         put(e.getFloatKey(), e.getByteValue());
/*     */       }
/*     */     }
/*     */     else
/*     */     {
...
/* 101 */         put((Float)e.getKey(), (Byte)e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 193 */         return AbstractFloat2ByteMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractFloat2ByteMap.this.size(); } 
/* 196 */       public void clear() { AbstractFloat2ByteMap.this.clear(); }
/*     */ 
/*     */       public FloatIterator iterator() {
/* 199 */         return new AbstractFloatIterator() {
/* 200 */           final ObjectIterator<Map.Entry<Float, Byte>> i = AbstractFloat2ByteMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public float nextFloat() { return ((Float2ByteMap.Entry)this.i.next()).getFloatKey(); } 
...
/* 226 */         return AbstractFloat2ByteMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractFloat2ByteMap.this.size(); } 
/* 229 */       public void clear() { AbstractFloat2ByteMap.this.clear(); }
/*     */ 
/*     */       public ByteIterator iterator() {
/* 232 */         return new AbstractByteIterator() {
/* 233 */           final ObjectIterator<Map.Entry<Float, Byte>> i = AbstractFloat2ByteMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public byte nextByte() { return ((Float2ByteMap.Entry)this.i.next()).getByteValue(); } 
/*     */           public boolean hasNext() {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Float2ByteMap.Entry e = (Float2ByteMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
