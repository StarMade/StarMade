...
/*     */   public static <V> Float2ObjectFunction<V> singleton(Float key, V value)
/*     */   {
/* 124 */     return new Singleton(key.floatValue(), value);
/*     */   }
/*     */ 
...
/* 227 */     public V get(float k) { return this.function.get(k); } 
...
/*     */   }
/*     */ 
/*     */   public static class SynchronizedFunction<V> extends AbstractFloat2ObjectFunction<V>
/*     */     implements Serializable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Float2ObjectFunction<V> function;
...
/* 170 */     public V get(float k) { synchronized (this.sync) { return this.function.get(k); }  } 
...
/*     */     }
/*  92 */     public V get(float k) { if (this.key == k) return this.value; return this.defRetValue; } 
/*     */     public int size() {
/*  94 */       return 1;
/*     */     }
...
/*     */     {
/*  60 */       return null; } 
/*  61 */     public boolean containsKey(float k) { return false; } 
...
/*     */     public void clear() {  } 
/*  67 */     private Object readResolve() { return Float2ObjectFunctions.EMPTY_FUNCTION; } 
/*  68 */     public Object clone() { return Float2ObjectFunctions.EMPTY_FUNCTION; }
/*     */ 
/*     */   }
/*     */ }
