...
public class Float2ReferenceMaps
{
  ...
  public static <V> Float2ReferenceMap<V> synchronize(Float2ReferenceMap<V> local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static <V> Float2ReferenceMap<V> synchronize(Float2ReferenceMap<V> local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static <V> Float2ReferenceMap<V> unmodifiable(Float2ReferenceMap<V> local_m)
  {
    ...
    implements Float2ReferenceMap<V>, Serializable
  {
    ...
    protected UnmodifiableMap(Float2ReferenceMap<V> local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Float2ReferenceMap<V>, Serializable
  {
    ...
    protected SynchronizedMap(Float2ReferenceMap<V> local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Float2ReferenceMap<V> local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Float2ReferenceMap<V>, Serializable, Cloneable
  {
      ...
      implements Float2ReferenceMap.Entry<V>, Map.Entry<Float, V>
    {
      ...
      public Float getKey()
      {
        return Float.valueOf(Float2ReferenceMaps.Singleton.this.key);
      }
      
      public V getValue()
      {
        return Float2ReferenceMaps.Singleton.this.value;
      }
      
      public float getFloatKey()
      {
        return Float2ReferenceMaps.Singleton.this.key;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Float2ReferenceMaps.Singleton.this.key == ((Float)local_e.getKey()).floatValue()) && (Float2ReferenceMaps.Singleton.this.value == local_e.getValue());
      }
      
      public int hashCode()
      {
        return HashCommon.float2int(Float2ReferenceMaps.Singleton.this.key) ^ (Float2ReferenceMaps.Singleton.this.value == null ? 0 : System.identityHashCode(Float2ReferenceMaps.Singleton.this.value));
      }
      
      public String toString()
      {
        return Float2ReferenceMaps.Singleton.this.key + "->" + Float2ReferenceMaps.Singleton.this.value;
      }
    }
  }
