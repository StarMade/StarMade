...
/*  18:    */
/*  89:    */public class Float2ObjectOpenCustomHashMap<V>
/*  90:    */  extends AbstractFloat2ObjectMap<V>
...
/* 103:    */  protected volatile transient Float2ObjectMap.FastEntrySet<V> entries;
...
/* 107:    */  
/* 108:    */  public Float2ObjectOpenCustomHashMap(int expected, float f, FloatHash.Strategy strategy)
/* 109:    */  {
...
/* 120:    */  }
/* 121:    */  
/* 125:    */  public Float2ObjectOpenCustomHashMap(int expected, FloatHash.Strategy strategy)
/* 126:    */  {
/* 127:127 */    this(expected, 0.75F, strategy);
/* 128:    */  }
/* 129:    */  
/* 132:    */  public Float2ObjectOpenCustomHashMap(FloatHash.Strategy strategy)
/* 133:    */  {
/* 134:134 */    this(16, 0.75F, strategy);
/* 135:    */  }
/* 136:    */  
/* 141:    */  public Float2ObjectOpenCustomHashMap(Map<? extends Float, ? extends V> m, float f, FloatHash.Strategy strategy)
/* 142:    */  {
/* 143:143 */    this(m.size(), f, strategy);
/* 144:144 */    putAll(m);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Float2ObjectOpenCustomHashMap(Map<? extends Float, ? extends V> m, FloatHash.Strategy strategy)
/* 151:    */  {
/* 152:152 */    this(m, 0.75F, strategy);
/* 153:    */  }
/* 154:    */  
/* 159:    */  public Float2ObjectOpenCustomHashMap(Float2ObjectMap<V> m, float f, FloatHash.Strategy strategy)
/* 160:    */  {
/* 161:161 */    this(m.size(), f, strategy);
/* 162:162 */    putAll(m);
/* 163:    */  }
/* 164:    */  
/* 168:    */  public Float2ObjectOpenCustomHashMap(Float2ObjectMap<V> m, FloatHash.Strategy strategy)
/* 169:    */  {
/* 170:170 */    this(m, 0.75F, strategy);
/* 171:    */  }
/* 172:    */  
/* 179:    */  public Float2ObjectOpenCustomHashMap(float[] k, V[] v, float f, FloatHash.Strategy strategy)
/* 180:    */  {
...
/* 185:    */  }
/* 186:    */  
/* 191:    */  public Float2ObjectOpenCustomHashMap(float[] k, V[] v, FloatHash.Strategy strategy)
/* 192:    */  {
...
/* 380:    */    implements Float2ObjectMap.Entry<V>, Map.Entry<Float, V>
/* 381:    */  {
...
/* 387:    */    }
/* 388:    */    
/* 389:389 */    public Float getKey() { return Float.valueOf(Float2ObjectOpenCustomHashMap.this.key[this.index]); }
/* 390:    */    
/* 391:    */    public float getFloatKey() {
/* 392:392 */      return Float2ObjectOpenCustomHashMap.this.key[this.index];
/* 393:    */    }
/* 394:    */    
/* 395:395 */    public V getValue() { return Float2ObjectOpenCustomHashMap.this.value[this.index]; }
/* 396:    */    
/* 397:    */    public V setValue(V v) {
/* 398:398 */      V oldValue = Float2ObjectOpenCustomHashMap.this.value[this.index];
/* 399:399 */      Float2ObjectOpenCustomHashMap.this.value[this.index] = v;
...
/* 406:406 */      return (Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue())) && (Float2ObjectOpenCustomHashMap.this.value[this.index] == null ? e.getValue() == null : Float2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()));
/* 407:    */    }
/* 408:    */    
/* 409:409 */    public int hashCode() { return Float2ObjectOpenCustomHashMap.this.strategy.hashCode(Float2ObjectOpenCustomHashMap.this.key[this.index]) ^ (Float2ObjectOpenCustomHashMap.this.value[this.index] == null ? 0 : Float2ObjectOpenCustomHashMap.this.value[this.index].hashCode()); }
/* 410:    */    
/* 412:412 */    public String toString() { return Float2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Float2ObjectOpenCustomHashMap.this.value[this.index]; } }
/* 413:    */  
...
/* 418:    */    
/* 419:419 */    private MapIterator() { this.pos = Float2ObjectOpenCustomHashMap.this.n;
/* 420:    */      
/* 422:422 */      this.last = -1;
/* 423:    */      
/* 424:424 */      this.c = Float2ObjectOpenCustomHashMap.this.size;
/* 425:    */      
/* 429:429 */      boolean[] used = Float2ObjectOpenCustomHashMap.this.used;
...
/* 441:    */        
/* 442:442 */        int pos = HashCommon.murmurHash3(Float2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ObjectOpenCustomHashMap.this.mask;
/* 443:    */        
/* 444:444 */        while (Float2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 445:445 */          if (Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446:446 */          pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/* 447:    */        }
/* 448:    */      }
/* 449:449 */      this.last = this.pos;
/* 450:    */      
/* 451:451 */      if (this.c != 0) {
/* 452:452 */        boolean[] used = Float2ObjectOpenCustomHashMap.this.used;
...
/* 467:    */      for (;;)
/* 468:    */      {
/* 469:469 */        pos = (last = pos) + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/* 470:470 */        while (Float2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 471:471 */          int slot = HashCommon.murmurHash3(Float2ObjectOpenCustomHashMap.this.strategy.hashCode(Float2ObjectOpenCustomHashMap.this.key[pos])) & Float2ObjectOpenCustomHashMap.this.mask;
/* 472:472 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473:473 */          pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/* 474:    */        }
/* 475:475 */        if (Float2ObjectOpenCustomHashMap.this.used[pos] == 0) break;
/* 476:476 */        if (pos < last)
/* 477:    */        {
/* 478:478 */          if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 479:479 */          this.wrapped.add(Float2ObjectOpenCustomHashMap.this.key[pos]);
/* 480:    */        }
/* 481:481 */        Float2ObjectOpenCustomHashMap.this.key[last] = Float2ObjectOpenCustomHashMap.this.key[pos];
/* 482:482 */        Float2ObjectOpenCustomHashMap.this.value[last] = Float2ObjectOpenCustomHashMap.this.value[pos];
/* 483:    */      }
/* 484:484 */      Float2ObjectOpenCustomHashMap.this.used[last] = false;
/* 485:485 */      Float2ObjectOpenCustomHashMap.this.value[last] = null;
/* 486:486 */      return last;
/* 487:    */    }
/* 488:    */    
...
/* 492:    */      {
/* 493:493 */        Float2ObjectOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 494:494 */        this.last = -1;
/* 495:495 */        return;
/* 496:    */      }
/* 497:497 */      Float2ObjectOpenCustomHashMap.this.size -= 1;
...
/* 509:    */    } }
/* 510:    */  
/* 511:511 */  private class EntryIterator extends Float2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Float2ObjectMap.Entry<V>> { private EntryIterator() { super(null); }
/* 512:    */    
/* 513:    */    private Float2ObjectOpenCustomHashMap<V>.MapEntry entry;
/* 514:514 */    public Float2ObjectMap.Entry<V> next() { return this.entry = new Float2ObjectOpenCustomHashMap.MapEntry(Float2ObjectOpenCustomHashMap.this, nextEntry()); }
/* 515:    */    
/* 516:    */    public void remove()
/* 517:    */    {
/* 518:518 */      super.remove();
/* 519:519 */      Float2ObjectOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 520:    */    } }
/* 521:    */  
/* 522:522 */  private class FastEntryIterator extends Float2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Float2ObjectMap.Entry<V>> { private FastEntryIterator() { super(null); }
/* 523:523 */    final AbstractFloat2ObjectMap.BasicEntry<V> entry = new AbstractFloat2ObjectMap.BasicEntry(0.0F, null);
/* 524:    */    
/* 525:525 */    public AbstractFloat2ObjectMap.BasicEntry<V> next() { int e = nextEntry();
/* 526:526 */      this.entry.key = Float2ObjectOpenCustomHashMap.this.key[e];
/* 527:527 */      this.entry.value = Float2ObjectOpenCustomHashMap.this.value[e];
/* 528:528 */      return this.entry;
/* 529:    */    } }
/* 530:    */  
/* 531:    */  private final class MapEntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectMap.FastEntrySet<V> { private MapEntrySet() {}
/* 532:    */    
/* 533:533 */    public ObjectIterator<Float2ObjectMap.Entry<V>> iterator() { return new Float2ObjectOpenCustomHashMap.EntryIterator(Float2ObjectOpenCustomHashMap.this, null); }
/* 534:    */    
/* 535:    */    public ObjectIterator<Float2ObjectMap.Entry<V>> fastIterator() {
/* 536:536 */      return new Float2ObjectOpenCustomHashMap.FastEntryIterator(Float2ObjectOpenCustomHashMap.this, null);
/* 537:    */    }
/* 538:    */    
...
/* 543:    */      
/* 544:544 */      int pos = HashCommon.murmurHash3(Float2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ObjectOpenCustomHashMap.this.mask;
/* 545:    */      
/* 546:546 */      while (Float2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 547:547 */        if (Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[pos], k)) return Float2ObjectOpenCustomHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Float2ObjectOpenCustomHashMap.this.value[pos].equals(e.getValue());
/* 548:548 */        pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/* 549:    */      }
...
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(Float2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ObjectOpenCustomHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Float2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[pos], k)) {
/* 562:562 */          Float2ObjectOpenCustomHashMap.this.remove(e.getKey());
/* 563:563 */          return true;
/* 564:    */        }
/* 565:565 */        pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/* 566:    */      }
/* 567:567 */      return false;
/* 568:    */    }
/* 569:    */    
/* 570:570 */    public int size() { return Float2ObjectOpenCustomHashMap.this.size; }
/* 571:    */    
/* 573:573 */    public void clear() { Float2ObjectOpenCustomHashMap.this.clear(); }
/* 574:    */  }
/* 575:    */  
/* 576:    */  public Float2ObjectMap.FastEntrySet<V> float2ObjectEntrySet() {
...
/* 584:    */    extends Float2ObjectOpenCustomHashMap.MapIterator
/* 585:    */    implements FloatIterator
/* 586:    */  {
/* 587:587 */    public KeyIterator() { super(null); }
/* 588:588 */    public float nextFloat() { return Float2ObjectOpenCustomHashMap.this.key[nextEntry()]; }
/* 589:589 */    public Float next() { return Float.valueOf(Float2ObjectOpenCustomHashMap.this.key[nextEntry()]); } }
/* 590:    */  
/* 591:    */  private final class KeySet extends AbstractFloatSet { private KeySet() {}
/* 592:    */    
/* 593:593 */    public FloatIterator iterator() { return new Float2ObjectOpenCustomHashMap.KeyIterator(Float2ObjectOpenCustomHashMap.this); }
/* 594:    */    
/* 595:    */    public int size() {
/* 596:596 */      return Float2ObjectOpenCustomHashMap.this.size;
/* 597:    */    }
/* 598:    */    
/* 599:599 */    public boolean contains(float k) { return Float2ObjectOpenCustomHashMap.this.containsKey(k); }
/* 600:    */    
/* 601:    */    public boolean remove(float k) {
/* 602:602 */      int oldSize = Float2ObjectOpenCustomHashMap.this.size;
/* 603:603 */      Float2ObjectOpenCustomHashMap.this.remove(k);
/* 604:604 */      return Float2ObjectOpenCustomHashMap.this.size != oldSize;
/* 605:    */    }
/* 606:    */    
/* 607:607 */    public void clear() { Float2ObjectOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
...
/* 618:    */    extends Float2ObjectOpenCustomHashMap<V>.MapIterator
/* 619:    */    implements ObjectIterator<V>
/* 620:    */  {
/* 621:621 */    public ValueIterator() { super(null); }
/* 622:622 */    public V next() { return Float2ObjectOpenCustomHashMap.this.value[nextEntry()]; }
/* 623:    */  }
/* 624:    */  
...
/* 627:627 */          return new Float2ObjectOpenCustomHashMap.ValueIterator(Float2ObjectOpenCustomHashMap.this);
/* 628:    */        }
/* 629:    */        
/* 630:630 */        public int size() { return Float2ObjectOpenCustomHashMap.this.size; }
/* 631:    */        
/* 632:    */        public boolean contains(Object v) {
/* 633:633 */          return Float2ObjectOpenCustomHashMap.this.containsValue(v);
/* 634:    */        }
/* 635:    */        
/* 636:636 */        public void clear() { Float2ObjectOpenCustomHashMap.this.clear(); }
/* 637:    */      };
/* 638:    */    }
...
/* 739:    */  }
/* 740:    */  
/* 744:    */  public Float2ObjectOpenCustomHashMap<V> clone()
/* 745:    */  {
/* 746:    */    Float2ObjectOpenCustomHashMap<V> c;
/* 747:    */    
/* 749:    */    try
/* 750:    */    {
/* 751:751 */      c = (Float2ObjectOpenCustomHashMap)super.clone();
/* 752:    */    }
...
/* 789:789 */    Float2ObjectOpenCustomHashMap<V>.MapIterator i = new MapIterator(null);
