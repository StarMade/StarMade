...
/* 627 */           return new Float2ObjectOpenCustomHashMap.ValueIterator(Float2ObjectOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 630 */           return Float2ObjectOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 633 */           return Float2ObjectOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 636 */           Float2ObjectOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 751 */       c = (Float2ObjectOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Float2ObjectOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public V next() { return Float2ObjectOpenCustomHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 593 */       return new Float2ObjectOpenCustomHashMap.KeyIterator(Float2ObjectOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 596 */       return Float2ObjectOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(float k) {
/* 599 */       return Float2ObjectOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(float k) {
/* 602 */       int oldSize = Float2ObjectOpenCustomHashMap.this.size;
/* 603 */       Float2ObjectOpenCustomHashMap.this.remove(k);
/* 604 */       return Float2ObjectOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 607 */       Float2ObjectOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Float2ObjectOpenCustomHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 587 */       super(null); } 
/* 588 */     public float nextFloat() { return Float2ObjectOpenCustomHashMap.this.key[nextEntry()]; } 
/* 589 */     public Float next() { return Float.valueOf(Float2ObjectOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 533 */       return new Float2ObjectOpenCustomHashMap.EntryIterator(Float2ObjectOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Float2ObjectMap.Entry<V>> fastIterator() {
/* 536 */       return new Float2ObjectOpenCustomHashMap.FastEntryIterator(Float2ObjectOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 544 */       int pos = HashCommon.murmurHash3(Float2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ObjectOpenCustomHashMap.this.mask;
/*     */ 
/* 546 */       while (Float2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 547 */         if (Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[pos], k)) return Float2ObjectOpenCustomHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Float2ObjectOpenCustomHashMap.this.value[pos].equals(e.getValue());
/* 548 */         pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/*     */       }
/* 550 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(Float2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ObjectOpenCustomHashMap.this.mask;
/*     */ 
/* 560 */       while (Float2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 561 */         if (Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[pos], k)) {
/* 562 */           Float2ObjectOpenCustomHashMap.this.remove(e.getKey());
/* 563 */           return true;
/*     */         }
/* 565 */         pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/*     */       }
/* 567 */       return false;
/*     */     }
/*     */     public int size() {
/* 570 */       return Float2ObjectOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 573 */       Float2ObjectOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Float2ObjectOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Float2ObjectMap.Entry<V>>
/*     */   {
/* 523 */     final AbstractFloat2ObjectMap.BasicEntry<V> entry = new AbstractFloat2ObjectMap.BasicEntry(0.0F, null);
/*     */ 
...
/* 525 */       int e = nextEntry();
/* 526 */       this.entry.key = Float2ObjectOpenCustomHashMap.this.key[e];
/* 527 */       this.entry.value = Float2ObjectOpenCustomHashMap.this.value[e];
/* 528 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Float2ObjectOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Float2ObjectMap.Entry<V>>
/*     */   {
...
/* 514 */       return this.entry = new Float2ObjectOpenCustomHashMap.MapEntry(Float2ObjectOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 518 */       super.remove();
/* 519 */       Float2ObjectOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 419 */       this.pos = Float2ObjectOpenCustomHashMap.this.n;
/*     */ 
/* 422 */       this.last = -1;
/*     */ 
/* 424 */       this.c = Float2ObjectOpenCustomHashMap.this.size;
/*     */ 
/* 429 */       boolean[] used = Float2ObjectOpenCustomHashMap.this.used;
...
/*     */ 
/* 442 */         int pos = HashCommon.murmurHash3(Float2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ObjectOpenCustomHashMap.this.mask;
/*     */ 
/* 444 */         while (Float2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 445 */           if (Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446 */           pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 449 */       this.last = this.pos;
/*     */ 
/* 451 */       if (this.c != 0) {
/* 452 */         boolean[] used = Float2ObjectOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 469 */         pos = (last = pos) + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/* 470 */         while (Float2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 471 */           int slot = HashCommon.murmurHash3(Float2ObjectOpenCustomHashMap.this.strategy.hashCode(Float2ObjectOpenCustomHashMap.this.key[pos])) & Float2ObjectOpenCustomHashMap.this.mask;
/* 472 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473 */           pos = pos + 1 & Float2ObjectOpenCustomHashMap.this.mask;
/*     */         }
/* 475 */         if (Float2ObjectOpenCustomHashMap.this.used[pos] == 0) break;
/* 476 */         if (pos < last)
/*     */         {
/* 478 */           if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 479 */           this.wrapped.add(Float2ObjectOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 481 */         Float2ObjectOpenCustomHashMap.this.key[last] = Float2ObjectOpenCustomHashMap.this.key[pos];
/* 482 */         Float2ObjectOpenCustomHashMap.this.value[last] = Float2ObjectOpenCustomHashMap.this.value[pos];
/*     */       }
/* 484 */       Float2ObjectOpenCustomHashMap.this.used[last] = false;
/* 485 */       Float2ObjectOpenCustomHashMap.this.value[last] = null;
/* 486 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 491 */       if (this.pos < -1)
/*     */       {
/* 493 */         Float2ObjectOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 494 */         this.last = -1;
/* 495 */         return;
/*     */       }
/* 497 */       Float2ObjectOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Float getKey() {
/* 389 */       return Float.valueOf(Float2ObjectOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public float getFloatKey() {
/* 392 */       return Float2ObjectOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 395 */       return Float2ObjectOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 398 */       Object oldValue = Float2ObjectOpenCustomHashMap.this.value[this.index];
/* 399 */       Float2ObjectOpenCustomHashMap.this.value[this.index] = v;
/* 400 */       return oldValue;
/*     */     }
/*     */ 
...
/* 406 */       return (Float2ObjectOpenCustomHashMap.this.strategy.equals(Float2ObjectOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue())) && (Float2ObjectOpenCustomHashMap.this.value[this.index] == null ? e.getValue() == null : Float2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
/* 409 */       return Float2ObjectOpenCustomHashMap.this.strategy.hashCode(Float2ObjectOpenCustomHashMap.this.key[this.index]) ^ (Float2ObjectOpenCustomHashMap.this.value[this.index] == null ? 0 : Float2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
/*     */     }
/*     */     public String toString() {
/* 412 */       return Float2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Float2ObjectOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
