  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof FloatComparator))) {
      ...
      this.actualComparator = new FloatComparator()
      {
        ...
        {
          return Float2BooleanAVLTreeMap.this.storedComparator.compare(Float.valueOf(local_k1), Float.valueOf(local_k2));
        }
  ...
  public Float2BooleanAVLTreeMap(Comparator<? super Float> local_c)
  {
    this();
  ...
  public Float2BooleanAVLTreeMap(Map<? extends Float, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2BooleanAVLTreeMap(SortedMap<Float, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2BooleanAVLTreeMap(Float2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2BooleanAVLTreeMap(Float2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2BooleanAVLTreeMap(float[] local_k, boolean[] local_v, Comparator<? super Float> local_c)
  {
    this(local_c);
  ...
  public Float2BooleanAVLTreeMap(float[] local_k, boolean[] local_v)
  {
  ...
  {
    boolean oldValue = put(local_ok.floatValue(), local_ov.booleanValue());
    return this.modified ? null : Boolean.valueOf(oldValue);
  }
  
  public Boolean remove(Object local_ok)
  {
    boolean oldValue = remove(((Float)local_ok).floatValue());
  ...
  public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Float2BooleanMap.Entry> comparator = new Comparator()
        {
          public int compare(Float2BooleanMap.Entry local_x, Float2BooleanMap.Entry local_y)
          {
            return Float2BooleanAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Float2BooleanAVLTreeMap.EntryIterator(Float2BooleanAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry from)
        {
          return new Float2BooleanAVLTreeMap.EntryIterator(Float2BooleanAVLTreeMap.this, ((Float)from.getKey()).floatValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Float2BooleanAVLTreeMap.Entry local_f = Float2BooleanAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Float2BooleanAVLTreeMap.Entry local_f = Float2BooleanAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
          if (local_f != null) {
            Float2BooleanAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry from, Float2BooleanMap.Entry local_to)
        {
          return Float2BooleanAVLTreeMap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry local_to)
        {
          return Float2BooleanAVLTreeMap.this.headMap((Float)local_to.getKey()).float2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry from)
        {
          return Float2BooleanAVLTreeMap.this.tailMap((Float)from.getKey()).float2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Float2BooleanAVLTreeMap.ValueIterator(Float2BooleanAVLTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Float2BooleanAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Float2BooleanAVLTreeMap local_c;
    try
    {
      local_c = (Float2BooleanAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readFloat(), local_s.readBoolean());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readFloat(), local_s.readBoolean());
      top.right(new Entry(local_s.readFloat(), local_s.readBoolean()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Float2BooleanAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Float2BooleanAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Float2BooleanAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator()
          {
            return new Float2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Float2BooleanAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry from)
          {
            return new Float2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Float2BooleanAVLTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Float, Boolean> local_e = (Map.Entry)local_o;
            Float2BooleanAVLTreeMap.Entry local_f = Float2BooleanAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            return (local_f != null) && (Float2BooleanAVLTreeMap.Submap.this.in(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Float, Boolean> local_e = (Map.Entry)local_o;
            Float2BooleanAVLTreeMap.Entry local_f = Float2BooleanAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            if ((local_f != null) && (Float2BooleanAVLTreeMap.Submap.this.in(local_f.key))) {
              Float2BooleanAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Float2BooleanAVLTreeMap.Submap.SubmapIterator(Float2BooleanAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Float2BooleanAVLTreeMap.Submap.this.clear();
          }
          
          public Float2BooleanMap.Entry first()
          {
            return Float2BooleanAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Float2BooleanMap.Entry last()
          {
            return Float2BooleanAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry from, Float2BooleanMap.Entry local_to)
          {
            return Float2BooleanAVLTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry local_to)
          {
            return Float2BooleanAVLTreeMap.Submap.this.headMap((Float)local_to.getKey()).float2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry from)
          {
            return Float2BooleanAVLTreeMap.Submap.this.tailMap((Float)from.getKey()).float2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Float2BooleanAVLTreeMap.Submap.SubmapValueIterator(Float2BooleanAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Float2BooleanAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Float2BooleanAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(float local_k)
    {
      return (in(local_k)) && (Float2BooleanAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      float local_kk = local_k;
      Float2BooleanAVLTreeMap.Entry local_e;
      return (in(local_kk)) && ((local_e = Float2BooleanAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(float local_k, boolean local_v)
    {
      ...
      boolean oldValue = Float2BooleanAVLTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(float local_k)
    {
      ...
      boolean oldValue = Float2BooleanAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Float2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Float2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Float2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Float2BooleanSortedMap tailMap(float from)
    {
      if (this.bottom) {
        return new Submap(Float2BooleanAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Float2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2BooleanAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Float2BooleanSortedMap subMap(float from, float local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Float2BooleanAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Float2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Float2BooleanAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Float2BooleanAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Float2BooleanAVLTreeMap.this.locateKey(this.from);
        if (Float2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Float2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Float2BooleanAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Float2BooleanAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Float2BooleanAVLTreeMap.this.locateKey(this.field_47);
        if (Float2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Float2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public float firstFloatKey()
    {
      Float2BooleanAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public float lastFloatKey()
    {
      Float2BooleanAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      implements ObjectListIterator<Float2BooleanMap.Entry>
    {
      ...
      public void set(Float2BooleanMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Float2BooleanMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
      ...
      extends Float2BooleanAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Float2BooleanAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(float local_k)
      {
        this();
        if (this.next != null) {
          if ((!Float2BooleanAVLTreeMap.Submap.this.bottom) && (Float2BooleanAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Float2BooleanAVLTreeMap.Submap.this.top) && (Float2BooleanAVLTreeMap.this.compare(local_k, (this.prev = Float2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Float2BooleanAVLTreeMap.this.locateKey(local_k);
            if (Float2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Float2BooleanAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2BooleanAVLTreeMap.this.compare(this.prev.key, Float2BooleanAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Float2BooleanAVLTreeMap.Submap.this.top) && (this.next != null) && (Float2BooleanAVLTreeMap.this.compare(this.next.key, Float2BooleanAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractFloat2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Float2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Float2BooleanAVLTreeMap.Submap.this);
      }
      
      public FloatBidirectionalIterator iterator(float from)
      {
        return new Float2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Float2BooleanAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractFloat2BooleanSortedMap.KeySet
  {
    ...
    public FloatBidirectionalIterator iterator()
    {
      return new Float2BooleanAVLTreeMap.KeyIterator(Float2BooleanAVLTreeMap.this);
    }
    
    public FloatBidirectionalIterator iterator(float from)
    {
      return new Float2BooleanAVLTreeMap.KeyIterator(Float2BooleanAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Float2BooleanAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Float2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Float2BooleanMap.Entry
  {
    ...
    Entry(float local_k, boolean local_v)
    {
      this.key = local_k;
      this.value = local_v;
