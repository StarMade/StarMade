...
/*     */   {
/* 173 */     return new Singleton(key.floatValue(), value.shortValue());
/*     */   }
/*     */ 
/*     */   public static Float2ShortSortedMap singleton(Float key, Short value, FloatComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.floatValue(), value.shortValue(), comparator);
/*     */   }
/*     */ 
/*     */   public static Float2ShortSortedMap singleton(float key, short value)
/*     */   {
...
/*     */     }
/* 302 */     public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.float2ShortEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, Short>> entrySet() {
/* 304 */       return float2ShortEntrySet(); } 
...
/* 308 */     public Float2ShortSortedMap headMap(float to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Float2ShortSortedMap tailMap(float from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Float2ShortSortedMap headMap(Float to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Float2ShortSortedMap tailMap(Float from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.float2ShortEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, Short>> entrySet() {
/* 244 */       return float2ShortEntrySet(); } 
...
/* 248 */     public Float2ShortSortedMap headMap(float to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Float2ShortSortedMap tailMap(float from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public float firstFloatKey() {
...
/* 259 */     public Float2ShortSortedMap headMap(Float to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Float2ShortSortedMap tailMap(Float from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Float2ShortMaps.Singleton.SingletonEntry(this), Float2ShortSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Float, Short>> entrySet() { return float2ShortEntrySet(); } 
/*     */     public FloatSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = FloatSortedSets.singleton(this.key, this.comparator); return (FloatSortedSet)this.keys;
/*     */     }
/*     */     public Float2ShortSortedMap subMap(float from, float to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Float2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Float2ShortSortedMap headMap(float to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Float2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Float2ShortSortedMap tailMap(float from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Float2ShortSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Float2ShortSortedMap tailMap(Float ofrom) { return tailMap(ofrom.floatValue()); } 
/* 156 */     public Float2ShortSortedMap subMap(Float ofrom, Float oto) { return subMap(ofrom.floatValue(), oto.floatValue()); } 
/*     */     public Float firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Float2ShortMap.Entry> float2ShortEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, Short>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public FloatSortedSet keySet() { return FloatSortedSets.EMPTY_SET; } 
/*     */     public Float2ShortSortedMap subMap(float from, float to) {
/*  86 */       return Float2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Float2ShortSortedMap headMap(float to) { return Float2ShortSortedMaps.EMPTY_MAP; } 
/*     */     public Float2ShortSortedMap tailMap(float from) {
/*  90 */       return Float2ShortSortedMaps.EMPTY_MAP; } 
...
/*  93 */     public Float2ShortSortedMap headMap(Float oto) { return headMap(oto.floatValue()); } 
/*  94 */     public Float2ShortSortedMap tailMap(Float ofrom) { return tailMap(ofrom.floatValue()); } 
/*  95 */     public Float2ShortSortedMap subMap(Float ofrom, Float oto) { return subMap(ofrom.floatValue(), oto.floatValue()); } 
