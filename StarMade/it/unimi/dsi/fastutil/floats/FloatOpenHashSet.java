...
/*  13:    */
/*  78:    */public class FloatOpenHashSet
/*  79:    */  extends AbstractFloatSet
...
/*  84:    */  protected transient float[] key;
...
/*  91:    */  
/*  92:    */  public FloatOpenHashSet(int expected, float f)
/*  93:    */  {
...
/* 100:100 */    this.key = new float[this.n];
/* 101:101 */    this.used = new boolean[this.n];
/* 102:    */  }
/* 103:    */  
/* 106:    */  public FloatOpenHashSet(int expected)
/* 107:    */  {
/* 108:108 */    this(expected, 0.75F);
/* 109:    */  }
/* 110:    */  
/* 112:    */  public FloatOpenHashSet()
/* 113:    */  {
/* 114:114 */    this(16, 0.75F);
/* 115:    */  }
/* 116:    */  
/* 120:    */  public FloatOpenHashSet(Collection<? extends Float> c, float f)
/* 121:    */  {
/* 122:122 */    this(c.size(), f);
/* 123:123 */    addAll(c);
/* 124:    */  }
/* 125:    */  
/* 129:    */  public FloatOpenHashSet(Collection<? extends Float> c)
/* 130:    */  {
/* 131:131 */    this(c, 0.75F);
/* 132:    */  }
/* 133:    */  
/* 137:    */  public FloatOpenHashSet(FloatCollection c, float f)
/* 138:    */  {
/* 139:139 */    this(c.size(), f);
/* 140:140 */    addAll(c);
/* 141:    */  }
/* 142:    */  
/* 146:    */  public FloatOpenHashSet(FloatCollection c)
/* 147:    */  {
/* 148:148 */    this(c, 0.75F);
/* 149:    */  }
/* 150:    */  
/* 154:    */  public FloatOpenHashSet(FloatIterator i, float f)
/* 155:    */  {
/* 156:156 */    this(16, f);
/* 157:157 */    while (i.hasNext()) { add(i.nextFloat());
/* 158:    */    }
/* 159:    */  }
/* 160:    */  
/* 162:    */  public FloatOpenHashSet(FloatIterator i)
/* 163:    */  {
/* 164:164 */    this(i, 0.75F);
/* 165:    */  }
/* 166:    */  
/* 170:    */  public FloatOpenHashSet(Iterator<?> i, float f)
/* 171:    */  {
/* 172:172 */    this(FloatIterators.asFloatIterator(i), f);
/* 173:    */  }
/* 174:    */  
/* 177:    */  public FloatOpenHashSet(Iterator<?> i)
/* 178:    */  {
/* 179:179 */    this(FloatIterators.asFloatIterator(i));
/* 180:    */  }
/* 181:    */  
/* 187:    */  public FloatOpenHashSet(float[] a, int offset, int length, float f)
/* 188:    */  {
/* 189:189 */    this(length < 0 ? 0 : length, f);
/* 190:190 */    FloatArrays.ensureOffsetLength(a, offset, length);
/* 191:191 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 192:    */    }
/* 193:    */  }
/* 194:    */  
/* 198:    */  public FloatOpenHashSet(float[] a, int offset, int length)
/* 199:    */  {
/* 200:200 */    this(a, offset, length, 0.75F);
/* 201:    */  }
/* 202:    */  
/* 206:    */  public FloatOpenHashSet(float[] a, float f)
/* 207:    */  {
/* 208:208 */    this(a, 0, a.length, f);
/* 209:    */  }
/* 210:    */  
/* 214:    */  public FloatOpenHashSet(float[] a)
/* 215:    */  {
/* 216:216 */    this(a, 0.75F);
/* 217:    */  }
/* 218:    */  
/* 222:    */  public boolean add(float k)
/* 223:    */  {
/* 224:224 */    int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & this.mask;
/* 225:    */    
...
/* 248:248 */        int slot = HashCommon.murmurHash3(HashCommon.float2int(this.key[pos])) & this.mask;
...
/* 257:    */  }
/* 258:    */  
/* 259:    */  public boolean remove(float k)
/* 260:    */  {
/* 261:261 */    int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & this.mask;
/* 262:    */    
...
/* 273:    */  }
/* 274:    */  
/* 275:    */  public boolean contains(float k)
/* 276:    */  {
/* 277:277 */    int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & this.mask;
/* 278:    */    
...
/* 318:    */  
/* 319:    */  private class SetIterator extends AbstractFloatIterator {
/* 320:    */    int pos;
/* 321:    */    int last;
/* 322:    */    
/* 323:323 */    private SetIterator() { this.pos = FloatOpenHashSet.this.n;
/* 324:    */      
/* 326:326 */      this.last = -1;
/* 327:    */      
/* 328:328 */      this.c = FloatOpenHashSet.this.size;
/* 329:    */      
/* 333:333 */      boolean[] used = FloatOpenHashSet.this.used;
/* 334:334 */      while ((this.c != 0) && (used[(--this.pos)] == 0)) {}
/* 335:    */    }
/* 336:    */    
/* 337:337 */    public boolean hasNext() { return this.c != 0; }
/* 338:    */    
/* 339:    */    public float nextFloat() {
/* 340:340 */      if (!hasNext()) throw new NoSuchElementException();
/* 341:341 */      this.c -= 1;
/* 342:    */      
/* 343:343 */      if (this.pos < 0) return this.wrapped.getFloat(-(this.last = --this.pos) - 2);
/* 344:344 */      float retVal = FloatOpenHashSet.this.key[(this.last = this.pos)];
/* 345:    */      
/* 346:346 */      if (this.c != 0) {
/* 347:347 */        boolean[] used = FloatOpenHashSet.this.used;
...
/* 362:    */      for (;;)
/* 363:    */      {
/* 364:364 */        pos = (last = pos) + 1 & FloatOpenHashSet.this.mask;
/* 365:365 */        while (FloatOpenHashSet.this.used[pos] != 0) {
/* 366:366 */          int slot = HashCommon.murmurHash3(HashCommon.float2int(FloatOpenHashSet.this.key[pos])) & FloatOpenHashSet.this.mask;
/* 367:367 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 368:368 */          pos = pos + 1 & FloatOpenHashSet.this.mask;
/* 369:    */        }
/* 370:370 */        if (FloatOpenHashSet.this.used[pos] == 0) break;
/* 371:371 */        if (pos < last)
/* 372:    */        {
/* 373:373 */          if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 374:374 */          this.wrapped.add(FloatOpenHashSet.this.key[pos]);
/* 375:    */        }
/* 376:376 */        FloatOpenHashSet.this.key[last] = FloatOpenHashSet.this.key[pos];
/* 377:    */      }
/* 378:378 */      FloatOpenHashSet.this.used[last] = false;
/* 379:379 */      return last;
/* 380:    */    }
/* 381:    */    
...
/* 385:    */      {
/* 386:386 */        FloatOpenHashSet.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 387:387 */        this.last = -1;
/* 388:388 */        return;
/* 389:    */      }
/* 390:390 */      FloatOpenHashSet.this.size -= 1;
...
/* 397:    */  }
/* 398:    */  
/* 399:    */  public FloatIterator iterator() {
...
/* 477:    */    
/* 478:478 */    float[] key = this.key;
/* 479:479 */    int newMask = newN - 1;
/* 480:480 */    float[] newKey = new float[newN];
/* 481:481 */    boolean[] newUsed = new boolean[newN];
/* 482:482 */    for (int j = this.size; j-- != 0;) {
/* 483:483 */      while (used[i] == 0) i++;
/* 484:484 */      float k = key[i];
/* 485:485 */      int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & newMask;
...
/* 496:    */  }
/* 497:    */  
/* 501:    */  public FloatOpenHashSet clone()
/* 502:    */  {
/* 503:    */    FloatOpenHashSet c;
/* 504:    */    
/* 506:    */    try
/* 507:    */    {
/* 508:508 */      c = (FloatOpenHashSet)super.clone();
/* 509:    */    }
/* 510:    */    catch (CloneNotSupportedException cantHappen) {
/* 511:511 */      throw new InternalError();
/* 512:    */    }
/* 513:513 */    c.key = ((float[])this.key.clone());
...
/* 530:530 */      h += HashCommon.float2int(this.key[i]);
/* 531:531 */      i++;
/* 532:    */    }
/* 533:533 */    return h;
/* 534:    */  }
/* 535:    */  
/* 536:536 */  private void writeObject(ObjectOutputStream s) throws IOException { FloatIterator i = iterator();
/* 537:537 */    s.defaultWriteObject();
/* 538:538 */    for (int j = this.size; j-- != 0; s.writeFloat(i.nextFloat())) {}
/* 539:    */  }
/* 540:    */  
...
/* 546:546 */    float[] key = this.key = new float[this.n];
/* 547:547 */    boolean[] used = this.used = new boolean[this.n];
/* 548:    */    
/* 549:549 */    int i = this.size; for (int pos = 0; i-- != 0;) {
/* 550:550 */      float k = s.readFloat();
/* 551:551 */      pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & this.mask;
