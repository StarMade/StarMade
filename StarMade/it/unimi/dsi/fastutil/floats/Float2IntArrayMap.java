...
/*     */ 
/*     */ public class Float2IntArrayMap extends AbstractFloat2IntMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Float2IntArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Float2IntMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Float2IntArrayMap.this.size; }
/*     */ 
/*     */         public Float2IntMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractFloat2IntMap.BasicEntry(Float2IntArrayMap.this.key[this.next], Float2IntArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractFloat2IntMap.BasicEntry entry = new AbstractFloat2IntMap.BasicEntry(0.0F, 0);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Float2IntArrayMap.this.size; }
/*     */ 
/*     */         public Float2IntMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Float2IntArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Float2IntArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Float2IntArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Float2IntArrayMap.this.containsKey(k)) && (Float2IntArrayMap.this.get(k) == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */   }
/*     */ }
