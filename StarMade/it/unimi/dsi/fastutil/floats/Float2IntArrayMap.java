  ...
  implements Serializable, Cloneable
{
  ...
  public Float2IntArrayMap(Float2IntMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Float2IntArrayMap(Map<? extends Float, ? extends Integer> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Float2IntArrayMap local_c;
    try
    {
      local_c = (Float2IntArrayMap)super.clone();
    }
    ...
    implements Float2IntMap.FastEntrySet
  {
    ...
    public ObjectIterator<Float2IntMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Float2IntMap.Entry next()
        {
          ...
          return new AbstractFloat2IntMap.BasicEntry(Float2IntArrayMap.this.key[this.next], Float2IntArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Float2IntArrayMap.this.containsKey(local_k)) && (Float2IntArrayMap.this.get(local_k) == ((Integer)local_e.getValue()).intValue());
    }
  }
}
