...
/*      */ 
/*      */ public class Float2ByteAVLTreeMap extends AbstractFloat2ByteSortedMap
...
/*  117 */           return Float2ByteAVLTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  120 */           return Float2ByteAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     byte oldValue = put(ok.floatValue(), ov.byteValue());
/*  780 */     return this.modified ? null : Byte.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Byte remove(Object ok)
/*      */   {
/*  788 */     byte oldValue = remove(((Float)ok).floatValue());
...
/* 1203 */         final Comparator<? super Float2ByteMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Float2ByteMap.Entry x, Float2ByteMap.Entry y) {
/* 1205 */             return Float2ByteAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Float2ByteAVLTreeMap.EntryIterator(Float2ByteAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1215 */           return new Float2ByteAVLTreeMap.EntryIterator(Float2ByteAVLTreeMap.this, ((Float)from.getKey()).floatValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Float2ByteAVLTreeMap.Entry f = Float2ByteAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1228 */           Float2ByteAVLTreeMap.Entry f = Float2ByteAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1229 */           if (f != null) Float2ByteAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Float2ByteAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Float2ByteAVLTreeMap.this.clear(); } 
/* 1234 */         public Float2ByteMap.Entry first() { return Float2ByteAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Float2ByteMap.Entry last() { return Float2ByteAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) { return Float2ByteAVLTreeMap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ByteEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) { return Float2ByteAVLTreeMap.this.headMap((Float)to.getKey()).float2ByteEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) { return Float2ByteAVLTreeMap.this.tailMap((Float)from.getKey()).float2ByteEntrySet(); }
/*      */       };
...
/* 1304 */           return new Float2ByteAVLTreeMap.ValueIterator(Float2ByteAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(byte k) {
/* 1307 */           return Float2ByteAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Float2ByteAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Float2ByteAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Float2ByteAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readFloat(), s.readByte());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readFloat(), s.readByte());
/* 1759 */       top.right(new Entry(s.readFloat(), s.readByte()));
...
/*      */   }
/*      */ 
/*      */   private final class Submap extends AbstractFloat2ByteSortedMap
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Float2ByteAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Float2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Float2ByteAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Float2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator() {
/* 1391 */             return new Float2ByteAVLTreeMap.Submap.SubmapEntryIterator(Float2ByteAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1394 */             return new Float2ByteAVLTreeMap.Submap.SubmapEntryIterator(Float2ByteAVLTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
/*      */           }
/* 1396 */           public Comparator<? super Float2ByteMap.Entry> comparator() { return Float2ByteAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Float2ByteAVLTreeMap.Entry f = Float2ByteAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1402 */             return (f != null) && (Float2ByteAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Float2ByteAVLTreeMap.Entry f = Float2ByteAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1409 */             if ((f != null) && (Float2ByteAVLTreeMap.Submap.this.in(f.key))) Float2ByteAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Float2ByteAVLTreeMap.Submap.SubmapIterator(Float2ByteAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Float2ByteAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Float2ByteMap.Entry first() { return Float2ByteAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Float2ByteMap.Entry last() { return Float2ByteAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry from, Float2ByteMap.Entry to) { return Float2ByteAVLTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ByteEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry to) { return Float2ByteAVLTreeMap.Submap.this.headMap((Float)to.getKey()).float2ByteEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry from) { return Float2ByteAVLTreeMap.Submap.this.tailMap((Float)from.getKey()).float2ByteEntrySet(); }
/*      */         };
...
/*      */           public ByteIterator iterator() {
/* 1442 */             return new Float2ByteAVLTreeMap.Submap.SubmapValueIterator(Float2ByteAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(byte k) {
/* 1445 */             return Float2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Float2ByteAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Float2ByteAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(float k) {
/* 1458 */       return (in(k)) && (Float2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(byte v) {
...
/* 1473 */       return (in(kk)) && ((e = Float2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public byte put(float k, byte v) {
/* 1476 */       Float2ByteAVLTreeMap.this.modified = false;
...
/* 1478 */       byte oldValue = Float2ByteAVLTreeMap.this.put(k, v);
/* 1479 */       return Float2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Byte put(Float ok, Byte ov) {
/* 1482 */       byte oldValue = put(ok.floatValue(), ov.byteValue());
/* 1483 */       return Float2ByteAVLTreeMap.this.modified ? null : Byte.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public byte remove(float k) {
/* 1487 */       Float2ByteAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       byte oldValue = Float2ByteAVLTreeMap.this.remove(k);
/* 1490 */       return Float2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Byte remove(Object ok) {
/* 1493 */       byte oldValue = remove(((Float)ok).floatValue());
/* 1494 */       return Float2ByteAVLTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1509 */       return Float2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Float2ByteSortedMap headMap(float to) {
/* 1512 */       if (this.top) return new Submap(Float2ByteAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Float2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Float2ByteAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Float2ByteSortedMap tailMap(float from) {
/* 1516 */       if (this.bottom) return new Submap(Float2ByteAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Float2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2ByteAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Float2ByteSortedMap subMap(float from, float to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Float2ByteAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Float2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Float2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Float2ByteAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Float2ByteAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Float2ByteAVLTreeMap.this.tree == null) return null;
/* 1534 */       Float2ByteAVLTreeMap.Entry e;
/*      */       Float2ByteAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Float2ByteAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Float2ByteAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Float2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Float2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Float2ByteAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Float2ByteAVLTreeMap.this.tree == null) return null;
/* 1552 */       Float2ByteAVLTreeMap.Entry e;
/*      */       Float2ByteAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Float2ByteAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Float2ByteAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Float2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Float2ByteAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public float firstFloatKey() {
/* 1563 */       Float2ByteAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public float lastFloatKey() {
/* 1568 */       Float2ByteAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Float firstKey() {
/* 1573 */       Float2ByteAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Float lastKey() {
/* 1578 */       Float2ByteAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Float2ByteAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Float2ByteAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Float2ByteAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Float2ByteMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Float2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Float2ByteAVLTreeMap.Submap.this.bottom) && (Float2ByteAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Float2ByteAVLTreeMap.Submap.this.top) && (Float2ByteAVLTreeMap.this.compare(k, (this.prev = Float2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Float2ByteAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Float2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Float2ByteAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2ByteAVLTreeMap.this.compare(this.prev.key, Float2ByteAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Float2ByteAVLTreeMap.Submap.this.top) && (this.next != null) && (Float2ByteAVLTreeMap.this.compare(this.next.key, Float2ByteAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public FloatBidirectionalIterator iterator() { return new Float2ByteAVLTreeMap.Submap.SubmapKeyIterator(Float2ByteAVLTreeMap.Submap.this); } 
/* 1433 */       public FloatBidirectionalIterator iterator(float from) { return new Float2ByteAVLTreeMap.Submap.SubmapKeyIterator(Float2ByteAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2ByteAVLTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public FloatBidirectionalIterator iterator() { return new Float2ByteAVLTreeMap.KeyIterator(Float2ByteAVLTreeMap.this); } 
/* 1263 */     public FloatBidirectionalIterator iterator(float from) { return new Float2ByteAVLTreeMap.KeyIterator(Float2ByteAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2ByteAVLTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2ByteAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Float2ByteMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Float2ByteMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Float2ByteAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(float k) {
/* 1129 */       if ((this.next = Float2ByteAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Float2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Float2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
