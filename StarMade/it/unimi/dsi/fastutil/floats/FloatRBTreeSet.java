...
/*      */ 
/*      */ public class FloatRBTreeSet extends AbstractFloatSortedSet
...
/*   97 */           return FloatRBTreeSet.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  100 */           return FloatRBTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   public FloatRBTreeSet(Iterator<? extends Float> i)
/*      */   {
...
/* 1028 */     return new Subset(0.0F, true, to, false);
/*      */   }
/*      */   public FloatSortedSet tailSet(float from) {
/* 1031 */     return new Subset(from, false, 0.0F, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1226 */       c = (FloatRBTreeSet)super.clone();
/*      */     }
...
/* 1279 */     while (n-- != 0) s.writeFloat(i.nextFloat());
/*      */   }
/*      */ 
...
/*      */   {
/* 1290 */     if (n == 1) {
/* 1291 */       Entry top = new Entry(s.readFloat());
/* 1292 */       top.pred(pred);
/* 1293 */       top.succ(succ);
/* 1294 */       top.black(true);
/* 1295 */       return top;
...
/* 1297 */     if (n == 2)
/*      */     {
/* 1300 */       Entry top = new Entry(s.readFloat());
/* 1301 */       top.black(true);
/* 1302 */       top.right(new Entry(s.readFloat()));
...
/*      */     {
/* 1063 */       if ((!bottom) && (!top) && (FloatRBTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1064 */       this.from = from;
...
/*      */     {
/* 1081 */       return ((this.bottom) || (FloatRBTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (FloatRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(float k)
/*      */     {
/* 1086 */       return (in(k)) && (FloatRBTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(float k) {
...
/* 1090 */       return FloatRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(float k) {
/* 1094 */       if (!in(k)) return false;
/* 1095 */       return FloatRBTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1110 */       return FloatRBTreeSet.this.actualComparator;
/*      */     }
/*      */     public FloatBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public FloatSortedSet headSet(float to) {
/* 1119 */       if (this.top) return new Subset(FloatRBTreeSet.this, this.from, this.bottom, to, false);
/* 1120 */       return FloatRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(FloatRBTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public FloatSortedSet tailSet(float from) {
/* 1123 */       if (this.bottom) return new Subset(FloatRBTreeSet.this, from, false, this.to, this.top);
/* 1124 */       return FloatRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(FloatRBTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public FloatSortedSet subSet(float from, float to) {
/* 1127 */       if ((this.top) && (this.bottom)) return new Subset(FloatRBTreeSet.this, from, false, to, false);
...
/* 1131 */       return new Subset(FloatRBTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public FloatRBTreeSet.Entry firstEntry()
/*      */     {
/* 1138 */       if (FloatRBTreeSet.this.tree == null) return null;
/* 1141 */       FloatRBTreeSet.Entry e;
/*      */       FloatRBTreeSet.Entry e;
/* 1141 */       if (this.bottom) { e = FloatRBTreeSet.this.firstEntry;
/*      */       } else {
/* 1143 */         e = FloatRBTreeSet.this.locateKey(this.from);
/*      */ 
/* 1145 */         if (FloatRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1148 */       if ((e == null) || ((!this.top) && (FloatRBTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1149 */       return e;
/*      */     }
/*      */ 
/*      */     public FloatRBTreeSet.Entry lastEntry()
/*      */     {
/* 1156 */       if (FloatRBTreeSet.this.tree == null) return null;
/* 1159 */       FloatRBTreeSet.Entry e;
/*      */       FloatRBTreeSet.Entry e;
/* 1159 */       if (this.top) { e = FloatRBTreeSet.this.lastEntry;
/*      */       } else {
/* 1161 */         e = FloatRBTreeSet.this.locateKey(this.to);
/*      */ 
/* 1163 */         if (FloatRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1166 */       if ((e == null) || ((!this.bottom) && (FloatRBTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1167 */       return e;
/*      */     }
/*      */     public float firstFloat() {
/* 1170 */       FloatRBTreeSet.Entry e = firstEntry();
/* 1171 */       if (e == null) throw new NoSuchElementException();
/* 1172 */       return e.key;
/*      */     }
/*      */     public float lastFloat() {
/* 1175 */       FloatRBTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1187 */         super();
/* 1188 */         this.next = FloatRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(float k) {
/* 1191 */         this();
/* 1192 */         if (this.next != null)
/* 1193 */           if ((!FloatRBTreeSet.Subset.this.bottom) && (FloatRBTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1194 */           } else if ((!FloatRBTreeSet.Subset.this.top) && (FloatRBTreeSet.this.compare(k, (this.prev = FloatRBTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1196 */             this.next = FloatRBTreeSet.this.locateKey(k);
/* 1197 */             if (FloatRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1207 */         if ((!FloatRBTreeSet.Subset.this.bottom) && (this.prev != null) && (FloatRBTreeSet.this.compare(this.prev.key, FloatRBTreeSet.Subset.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1210 */         this.next = this.next.next();
/* 1211 */         if ((!FloatRBTreeSet.Subset.this.top) && (this.next != null) && (FloatRBTreeSet.this.compare(this.next.key, FloatRBTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*  963 */     int index = 0;
/*      */ 
/*  965 */     SetIterator() { this.next = FloatRBTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(float k) {
/*  968 */       if ((this.next = FloatRBTreeSet.this.locateKey(k)) != null)
/*  969 */         if (FloatRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/*  988 */     public float nextFloat() { return nextEntry().key; } 
/*  989 */     public float previousFloat() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1012 */       updatePrevious();
/* 1013 */       updateNext();
/* 1014 */       FloatRBTreeSet.this.remove(this.curr.key);
/* 1015 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*      */     }
/*      */     public int hashCode() {
/*  900 */       return HashCommon.float2int(this.key);
/*      */     }
