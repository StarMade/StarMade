...
/*  14:    */
/*  57:    */public class Float2ObjectMaps
/*  58:    */{
/*  59:    */  public static class EmptyMap<V>
/*  60:    */    extends Float2ObjectFunctions.EmptyFunction<V>
/*  61:    */    implements Float2ObjectMap<V>, Serializable, Cloneable
/*  62:    */  {
...
/*  66: 66 */    public void putAll(Map<? extends Float, ? extends V> m) { throw new UnsupportedOperationException(); }
/*  67:    */    
/*  68: 68 */    public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() { return ObjectSets.EMPTY_SET; }
/*  69:    */    
/*  70: 70 */    public FloatSet keySet() { return FloatSets.EMPTY_SET; }
/*  71:    */    
/*  72: 72 */    public ObjectCollection<V> values() { return ObjectSets.EMPTY_SET; }
/*  73: 73 */    private Object readResolve() { return Float2ObjectMaps.EMPTY_MAP; }
/*  74:    */    
/*  75: 75 */    public Object clone() { return Float2ObjectMaps.EMPTY_MAP; }
/*  76:    */    
/*  77: 77 */    public boolean isEmpty() { return true; }
/*  78:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<Float, V>> entrySet() { return float2ObjectEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Float2ObjectFunctions.Singleton<V>
/* 103:    */    implements Float2ObjectMap<V>, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Float2ObjectMap.Entry<V>> entries;
/* 108:    */    
...
/* 125:    */    
/* 126:126 */    public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Float2ObjectMap.Entry<V>, Map.Entry<Float, V> { protected SingletonEntry() {}
/* 131:131 */      public Float getKey() { return Float.valueOf(Float2ObjectMaps.Singleton.this.key); }
/* 132:132 */      public V getValue() { return Float2ObjectMaps.Singleton.this.value; }
/* 133:    */      
/* 134:    */      public float getFloatKey() {
/* 135:135 */        return Float2ObjectMaps.Singleton.this.key;
/* 136:    */      }
/* 137:    */      
...
/* 148:    */        
/* 149:149 */        return (Float2ObjectMaps.Singleton.this.key == ((Float)e.getKey()).floatValue()) && (Float2ObjectMaps.Singleton.this.value == null ? e.getValue() == null : Float2ObjectMaps.Singleton.this.value.equals(e.getValue()));
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return HashCommon.float2int(Float2ObjectMaps.Singleton.this.key) ^ (Float2ObjectMaps.Singleton.this.value == null ? 0 : Float2ObjectMaps.Singleton.this.value.hashCode()); }
/* 153:153 */      public String toString() { return Float2ObjectMaps.Singleton.this.key + "->" + Float2ObjectMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<Float, V>> entrySet() { return float2ObjectEntrySet(); }
/* 160:    */    
/* 161:161 */    public int hashCode() { return HashCommon.float2int(this.key) ^ (this.value == null ? 0 : this.value.hashCode()); }
/* 162:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static <V> Float2ObjectMap<V> singleton(float key, V value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static <V> Float2ObjectMap<V> singleton(Float key, V value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key.floatValue(), value);
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap<V>
/* 205:    */    extends Float2ObjectFunctions.SynchronizedFunction<V>
/* 206:    */    implements Float2ObjectMap<V>, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Float2ObjectMap<V> map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Float2ObjectMap.Entry<V>> entries;
/* 213:    */    
/* 214:    */    protected volatile transient FloatSet keys;
/* 215:    */    protected volatile transient ObjectCollection<V> values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Float2ObjectMap<V> m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Float2ObjectMap<V> m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 239:    */    
/* 240:240 */    public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.float2ObjectEntrySet(), this.sync); return this.entries; }
...
/* 261:    */  }
/* 262:    */  
/* 264:    */  public static <V> Float2ObjectMap<V> synchronize(Float2ObjectMap<V> m)
/* 265:    */  {
/* 266:266 */    return new SynchronizedMap(m);
/* 267:    */  }
/* 268:    */  
/* 274:274 */  public static <V> Float2ObjectMap<V> synchronize(Float2ObjectMap<V> m, Object sync) { return new SynchronizedMap(m, sync); }
/* 275:    */  
/* 276:    */  public static class UnmodifiableMap<V> extends Float2ObjectFunctions.UnmodifiableFunction<V> implements Float2ObjectMap<V>, Serializable {
/* 277:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 278:    */    protected final Float2ObjectMap<V> map;
/* 279:    */    protected volatile transient ObjectSet<Float2ObjectMap.Entry<V>> entries;
/* 280:    */    protected volatile transient FloatSet keys;
/* 281:    */    protected volatile transient ObjectCollection<V> values;
/* 282:    */    
/* 283:283 */    protected UnmodifiableMap(Float2ObjectMap<V> m) { super();
/* 284:284 */      this.map = m; }
/* 285:    */    
...
/* 294:294 */    public ObjectSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.float2ObjectEntrySet()); return this.entries; }
...
/* 306:    */  }
/* 307:    */  
/* 311:    */  public static <V> Float2ObjectMap<V> unmodifiable(Float2ObjectMap<V> m)
/* 312:    */  {
