...
/*      */ 
/*      */ public class Float2ShortRBTreeMap extends AbstractFloat2ShortSortedMap
...
/*  119 */           return Float2ShortRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  122 */           return Float2ShortRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     short oldValue = put(ok.floatValue(), ov.shortValue());
/*  731 */     return this.modified ? null : Short.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Short remove(Object ok)
/*      */   {
/*  737 */     short oldValue = remove(((Float)ok).floatValue());
...
/* 1141 */         final Comparator<? super Float2ShortMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Float2ShortMap.Entry x, Float2ShortMap.Entry y) {
/* 1143 */             return Float2ShortRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Float2ShortRBTreeMap.EntryIterator(Float2ShortRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator(Float2ShortMap.Entry from) {
/* 1153 */           return new Float2ShortRBTreeMap.EntryIterator(Float2ShortRBTreeMap.this, ((Float)from.getKey()).floatValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Float2ShortRBTreeMap.Entry f = Float2ShortRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1166 */           Float2ShortRBTreeMap.Entry f = Float2ShortRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1167 */           if (f != null) Float2ShortRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Float2ShortRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Float2ShortRBTreeMap.this.clear(); } 
/* 1172 */         public Float2ShortMap.Entry first() { return Float2ShortRBTreeMap.this.firstEntry; } 
/* 1173 */         public Float2ShortMap.Entry last() { return Float2ShortRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Float2ShortMap.Entry> subSet(Float2ShortMap.Entry from, Float2ShortMap.Entry to) { return Float2ShortRBTreeMap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ShortEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Float2ShortMap.Entry> headSet(Float2ShortMap.Entry to) { return Float2ShortRBTreeMap.this.headMap((Float)to.getKey()).float2ShortEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Float2ShortMap.Entry> tailSet(Float2ShortMap.Entry from) { return Float2ShortRBTreeMap.this.tailMap((Float)from.getKey()).float2ShortEntrySet(); }
/*      */       };
...
/* 1242 */           return new Float2ShortRBTreeMap.ValueIterator(Float2ShortRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(short k) {
/* 1245 */           return Float2ShortRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Float2ShortRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Float2ShortRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Float2ShortRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readFloat(), s.readShort());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readFloat(), s.readShort());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readFloat(), s.readShort()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Float2ShortRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Float2ShortRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator() {
/* 1329 */             return new Float2ShortRBTreeMap.Submap.SubmapEntryIterator(Float2ShortRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Float2ShortMap.Entry> iterator(Float2ShortMap.Entry from) {
/* 1332 */             return new Float2ShortRBTreeMap.Submap.SubmapEntryIterator(Float2ShortRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
/*      */           }
/* 1334 */           public Comparator<? super Float2ShortMap.Entry> comparator() { return Float2ShortRBTreeMap.this.float2ShortEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Float2ShortRBTreeMap.Entry f = Float2ShortRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1340 */             return (f != null) && (Float2ShortRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Float2ShortRBTreeMap.Entry f = Float2ShortRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1347 */             if ((f != null) && (Float2ShortRBTreeMap.Submap.this.in(f.key))) Float2ShortRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Float2ShortRBTreeMap.Submap.SubmapIterator(Float2ShortRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Float2ShortRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Float2ShortMap.Entry first() { return Float2ShortRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Float2ShortMap.Entry last() { return Float2ShortRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Float2ShortMap.Entry> subSet(Float2ShortMap.Entry from, Float2ShortMap.Entry to) { return Float2ShortRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ShortEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Float2ShortMap.Entry> headSet(Float2ShortMap.Entry to) { return Float2ShortRBTreeMap.Submap.this.headMap((Float)to.getKey()).float2ShortEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Float2ShortMap.Entry> tailSet(Float2ShortMap.Entry from) { return Float2ShortRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2ShortEntrySet(); }
/*      */         };
...
/*      */           public ShortIterator iterator() {
/* 1376 */             return new Float2ShortRBTreeMap.Submap.SubmapValueIterator(Float2ShortRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(short k) {
/* 1379 */             return Float2ShortRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Float2ShortRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Float2ShortRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(float k) {
/* 1392 */       return (in(k)) && (Float2ShortRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(short v) {
...
/* 1407 */       return (in(kk)) && ((e = Float2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public short put(float k, short v) {
/* 1410 */       Float2ShortRBTreeMap.this.modified = false;
...
/* 1412 */       short oldValue = Float2ShortRBTreeMap.this.put(k, v);
/* 1413 */       return Float2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Short put(Float ok, Short ov) {
/* 1416 */       short oldValue = put(ok.floatValue(), ov.shortValue());
/* 1417 */       return Float2ShortRBTreeMap.this.modified ? null : Short.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public short remove(float k) {
/* 1421 */       Float2ShortRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       short oldValue = Float2ShortRBTreeMap.this.remove(k);
/* 1424 */       return Float2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Short remove(Object ok) {
/* 1427 */       short oldValue = remove(((Float)ok).floatValue());
/* 1428 */       return Float2ShortRBTreeMap.this.modified ? Short.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1443 */       return Float2ShortRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Float2ShortSortedMap headMap(float to) {
/* 1446 */       if (this.top) return new Submap(Float2ShortRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Float2ShortRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Float2ShortRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Float2ShortSortedMap tailMap(float from) {
/* 1450 */       if (this.bottom) return new Submap(Float2ShortRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Float2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2ShortRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Float2ShortSortedMap subMap(float from, float to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Float2ShortRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Float2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Float2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Float2ShortRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Float2ShortRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Float2ShortRBTreeMap.this.tree == null) return null;
/* 1468 */       Float2ShortRBTreeMap.Entry e;
/*      */       Float2ShortRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Float2ShortRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Float2ShortRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Float2ShortRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Float2ShortRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Float2ShortRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Float2ShortRBTreeMap.this.tree == null) return null;
/* 1486 */       Float2ShortRBTreeMap.Entry e;
/*      */       Float2ShortRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Float2ShortRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Float2ShortRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Float2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Float2ShortRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public float firstFloatKey() {
/* 1497 */       Float2ShortRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public float lastFloatKey() {
/* 1502 */       Float2ShortRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Float firstKey() {
/* 1507 */       Float2ShortRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Float lastKey() {
/* 1512 */       Float2ShortRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Float2ShortRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Float2ShortRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Float2ShortRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Float2ShortMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Float2ShortRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Float2ShortRBTreeMap.Submap.this.bottom) && (Float2ShortRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Float2ShortRBTreeMap.Submap.this.top) && (Float2ShortRBTreeMap.this.compare(k, (this.prev = Float2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Float2ShortRBTreeMap.this.locateKey(k);
/* 1534 */             if (Float2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Float2ShortRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2ShortRBTreeMap.this.compare(this.prev.key, Float2ShortRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Float2ShortRBTreeMap.Submap.this.top) && (this.next != null) && (Float2ShortRBTreeMap.this.compare(this.next.key, Float2ShortRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public FloatBidirectionalIterator iterator() { return new Float2ShortRBTreeMap.Submap.SubmapKeyIterator(Float2ShortRBTreeMap.Submap.this); } 
/* 1367 */       public FloatBidirectionalIterator iterator(float from) { return new Float2ShortRBTreeMap.Submap.SubmapKeyIterator(Float2ShortRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2ShortRBTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public FloatBidirectionalIterator iterator() { return new Float2ShortRBTreeMap.KeyIterator(Float2ShortRBTreeMap.this); } 
/* 1201 */     public FloatBidirectionalIterator iterator(float from) { return new Float2ShortRBTreeMap.KeyIterator(Float2ShortRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2ShortRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2ShortRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Float2ShortMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Float2ShortMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Float2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Float2ShortRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(float k) {
/* 1067 */       if ((this.next = Float2ShortRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Float2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Float2ShortRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/*  983 */       return HashCommon.float2int(this.key) ^ this.value;
/*      */     }
/*      */ 
