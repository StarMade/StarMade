...
/*  786 */   public Float2DoubleSortedMap tailMap(float from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Float2DoubleSortedMap headMap(float to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Float2DoubleSortedMap subMap(float from, float to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Float2DoubleLinkedOpenHashMap.ValueIterator(Float2DoubleLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Float2DoubleLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(double v) {
/* 1113 */           return Float2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Float2DoubleLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Float2DoubleLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public double previousDouble()
/*      */     {
/* 1094 */       return Float2DoubleLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Double previous() { return Double.valueOf(Float2DoubleLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public double nextDouble() { return Float2DoubleLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Double next() { return Double.valueOf(Float2DoubleLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Float2DoubleLinkedOpenHashMap.KeyIterator(Float2DoubleLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public FloatListIterator iterator() {
/* 1054 */       return new Float2DoubleLinkedOpenHashMap.KeyIterator(Float2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Float2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(float k) {
/* 1060 */       return Float2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(float k) {
/* 1063 */       int oldSize = Float2DoubleLinkedOpenHashMap.this.size;
/* 1064 */       Float2DoubleLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Float2DoubleLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Float2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public float firstFloat() {
/* 1071 */       if (Float2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Float2DoubleLinkedOpenHashMap.this.key[Float2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public float lastFloat() {
/* 1075 */       if (Float2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Float2DoubleLinkedOpenHashMap.this.key[Float2DoubleLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator(float k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public float previousFloat() { return Float2DoubleLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Float previous() { return Float.valueOf(Float2DoubleLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public float nextFloat() { return Float2DoubleLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Float next() { return Float.valueOf(Float2DoubleLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Float2DoubleLinkedOpenHashMap.EntryIterator(Float2DoubleLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Float2DoubleMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Float2DoubleMap.Entry> subSet(Float2DoubleMap.Entry fromElement, Float2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Float2DoubleMap.Entry> headSet(Float2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Float2DoubleMap.Entry> tailSet(Float2DoubleMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Float2DoubleMap.Entry first() {
/*  973 */       if (Float2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Float2DoubleLinkedOpenHashMap.MapEntry(Float2DoubleLinkedOpenHashMap.this, Float2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Float2DoubleMap.Entry last() {
/*  977 */       if (Float2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Float2DoubleLinkedOpenHashMap.MapEntry(Float2DoubleLinkedOpenHashMap.this, Float2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Float2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Float2DoubleLinkedOpenHashMap.this.key[pos] == k) return Float2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/*  990 */         pos = pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Float2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Float2DoubleLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Float2DoubleLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Float2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Float2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2DoubleMap.Entry> iterator(Float2DoubleMap.Entry from) {
/* 1018 */       return new Float2DoubleLinkedOpenHashMap.EntryIterator(Float2DoubleLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2DoubleMap.Entry> fastIterator() {
/* 1021 */       return new Float2DoubleLinkedOpenHashMap.FastEntryIterator(Float2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2DoubleMap.Entry> fastIterator(Float2DoubleMap.Entry from) {
/* 1024 */       return new Float2DoubleLinkedOpenHashMap.FastEntryIterator(Float2DoubleLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Float2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2DoubleMap.Entry>
/*      */   {
/*  944 */     final AbstractFloat2DoubleMap.BasicEntry entry = new AbstractFloat2DoubleMap.BasicEntry(0.0F, 0.0D);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Float2DoubleLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Float2DoubleLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractFloat2DoubleMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Float2DoubleLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Float2DoubleLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Float2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Float2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2DoubleMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Float2DoubleLinkedOpenHashMap.MapEntry(Float2DoubleLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Float2DoubleLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Float2DoubleLinkedOpenHashMap.MapEntry(Float2DoubleLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Float2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Float2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Float2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Float2DoubleLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(float from) {
/*  809 */       if (Float2DoubleLinkedOpenHashMap.this.key[Float2DoubleLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Float2DoubleLinkedOpenHashMap.this.last;
/*  811 */         this.index = Float2DoubleLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Float2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Float2DoubleLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Float2DoubleLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Float2DoubleLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Float2DoubleLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Float2DoubleLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Float2DoubleLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Float2DoubleLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Float2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Float2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Float2DoubleLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Float2DoubleLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Float2DoubleLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Float2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Float2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Float2DoubleLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Float2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Float2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Float2DoubleLinkedOpenHashMap.this.mask;
/*  897 */         while (Float2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2DoubleLinkedOpenHashMap.this.key[pos])) & Float2DoubleLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Float2DoubleLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Float2DoubleLinkedOpenHashMap.this.key[last] = Float2DoubleLinkedOpenHashMap.this.key[pos];
/*  904 */         Float2DoubleLinkedOpenHashMap.this.value[last] = Float2DoubleLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Float2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Float2DoubleLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Float getKey() {
/*  669 */       return Float.valueOf(Float2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public float getFloatKey() {
/*  672 */       return Float2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Double getValue() {
/*  675 */       return Double.valueOf(Float2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public double getDoubleValue() {
/*  678 */       return Float2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public double setValue(double v) {
/*  681 */       double oldValue = Float2DoubleLinkedOpenHashMap.this.value[this.index];
/*  682 */       Float2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Double setValue(Double v) {
...
/*  692 */       return (Float2DoubleLinkedOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.float2int(Float2DoubleLinkedOpenHashMap.this.key[this.index]) ^ HashCommon.double2int(Float2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Float2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Float2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
