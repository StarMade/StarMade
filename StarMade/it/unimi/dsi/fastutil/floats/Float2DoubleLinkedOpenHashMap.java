  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2DoubleLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2DoubleLinkedOpenHashMap(Map<? extends Float, ? extends Double> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2DoubleLinkedOpenHashMap(Map<? extends Float, ? extends Double> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2DoubleLinkedOpenHashMap(Float2DoubleMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2DoubleLinkedOpenHashMap(Float2DoubleMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2DoubleLinkedOpenHashMap(float[] local_k, double[] local_v, float local_f)
  {
  ...
  public Float2DoubleLinkedOpenHashMap(float[] local_k, double[] local_v)
  {
  ...
  public double getAndMoveToFirst(float local_k)
  {
    float[] key = this.key;
  ...
  public double getAndMoveToLast(float local_k)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public double putAndMoveToFirst(float local_k, double local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public double putAndMoveToLast(float local_k, double local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Float2DoubleLinkedOpenHashMap.ValueIterator(Float2DoubleLinkedOpenHashMap.this);
        }
        ...
        {
          return Float2DoubleLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2DoubleLinkedOpenHashMap local_c;
    try
    {
      local_c = (Float2DoubleLinkedOpenHashMap)super.clone();
    }
    ...
    implements DoubleListIterator
  {
    ...
    {
      return Float2DoubleLinkedOpenHashMap.this.value[previousEntry()];
    }
    
    public Double previous()
    {
      return Double.valueOf(Float2DoubleLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Float2DoubleLinkedOpenHashMap.this.value[nextEntry()];
    }
    
    public Double next()
    {
      return Double.valueOf(Float2DoubleLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSortedSet
  {
    ...
    {
      return new Float2DoubleLinkedOpenHashMap.KeyIterator(Float2DoubleLinkedOpenHashMap.this, from);
    }
    
    public FloatListIterator iterator()
    {
      return new Float2DoubleLinkedOpenHashMap.KeyIterator(Float2DoubleLinkedOpenHashMap.this);
    }
    ...
    {
      return Float2DoubleLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2DoubleLinkedOpenHashMap.this.size;
      Float2DoubleLinkedOpenHashMap.this.remove(local_k);
    ...
    implements FloatListIterator
  {
    ...
    {
      return Float2DoubleLinkedOpenHashMap.this.key[previousEntry()];
    }
    ...
    {
      return Float.valueOf(Float2DoubleLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    {
      return Float2DoubleLinkedOpenHashMap.this.key[nextEntry()];
    }
    
    public Float next()
    {
      return Float.valueOf(Float2DoubleLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2DoubleSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Float2DoubleLinkedOpenHashMap.EntryIterator(Float2DoubleLinkedOpenHashMap.this);
    }
    ...
    public Float2DoubleMap.Entry first()
    {
      ...
      return new Float2DoubleLinkedOpenHashMap.MapEntry(Float2DoubleLinkedOpenHashMap.this, Float2DoubleLinkedOpenHashMap.this.first);
    }
    ...
    public Float2DoubleMap.Entry last()
    {
      ...
      return new Float2DoubleLinkedOpenHashMap.MapEntry(Float2DoubleLinkedOpenHashMap.this, Float2DoubleLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2DoubleLinkedOpenHashMap.this.mask; Float2DoubleLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask) {
        if (Float2DoubleLinkedOpenHashMap.this.key[pos] == local_k) {
          return Float2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)local_e.getValue()).doubleValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2DoubleLinkedOpenHashMap.this.mask; Float2DoubleLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask) {
        if (Float2DoubleLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Float2DoubleLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Float2DoubleLinkedOpenHashMap.EntryIterator(Float2DoubleLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
    
    public ObjectBidirectionalIterator<Float2DoubleMap.Entry> fastIterator()
    {
      return new Float2DoubleLinkedOpenHashMap.FastEntryIterator(Float2DoubleLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Float2DoubleMap.Entry> fastIterator(Float2DoubleMap.Entry from)
    {
      return new Float2DoubleLinkedOpenHashMap.FastEntryIterator(Float2DoubleLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
  }
    ...
    implements ObjectListIterator<Float2DoubleMap.Entry>
  {
    ...
    public AbstractFloat2DoubleMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2DoubleLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Float2DoubleLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Float2DoubleMap.Entry>
  {
    ...
    {
      return this.entry = new Float2DoubleLinkedOpenHashMap.MapEntry(Float2DoubleLinkedOpenHashMap.this, nextEntry());
    }
    
    public Float2DoubleLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Float2DoubleLinkedOpenHashMap.MapEntry(Float2DoubleLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(float from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2DoubleLinkedOpenHashMap.this.mask; Float2DoubleLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask) {
          if (Float2DoubleLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Float2DoubleLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Float2DoubleLinkedOpenHashMap.this.first = this.next;
      } else {
        Float2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Float2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Float2DoubleLinkedOpenHashMap.this.last = this.prev;
      } else {
        Float2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Float2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2DoubleLinkedOpenHashMap.this.mask; Float2DoubleLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2DoubleLinkedOpenHashMap.this.mask)
        {
        ...
        if (Float2DoubleLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Float2DoubleMap.Entry, Map.Entry<Float, Double>
  {
    ...
    {
      return Double.valueOf(Float2DoubleLinkedOpenHashMap.this.value[this.index]);
    }
    ...
    public double setValue(double local_v)
    {
      ...
      Float2DoubleLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Double> local_e = (Map.Entry)local_o;
      return (Float2DoubleLinkedOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)local_e.getValue()).doubleValue());
    }
