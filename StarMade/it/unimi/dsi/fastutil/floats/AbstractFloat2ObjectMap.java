...
/*  14:    */
/*  61:    */public abstract class AbstractFloat2ObjectMap<V>
/*  62:    */  extends AbstractFloat2ObjectFunction<V>
/*  63:    */  implements Float2ObjectMap<V>, Serializable
/*  64:    */{
...
/*  85: 85 */    if ((m instanceof Float2ObjectMap))
/*  86:    */    {
/*  87: 87 */      while (n-- != 0) {
/*  88: 88 */        Float2ObjectMap.Entry<? extends V> e = (Float2ObjectMap.Entry)i.next();
...
/* 106:    */    implements Float2ObjectMap.Entry<V>
/* 107:    */  {
...
/* 153:153 */      return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public int hashCode() { return HashCommon.float2int(this.key) ^ (this.value == null ? 0 : this.value.hashCode()); }
/* 157:    */    
...
/* 175:175 */      public boolean contains(float k) { return AbstractFloat2ObjectMap.this.containsKey(k); }
/* 176:176 */      public int size() { return AbstractFloat2ObjectMap.this.size(); }
/* 177:177 */      public void clear() { AbstractFloat2ObjectMap.this.clear(); }
/* 178:    */      
/* 179:179 */      public FloatIterator iterator() { new AbstractFloatIterator() {
/* 180:180 */          final ObjectIterator<Map.Entry<Float, V>> i = AbstractFloat2ObjectMap.this.entrySet().iterator();
/* 181:181 */          public float nextFloat() { return ((Float2ObjectMap.Entry)this.i.next()).getFloatKey(); }
...
/* 200:200 */      public boolean contains(Object k) { return AbstractFloat2ObjectMap.this.containsValue(k); }
/* 201:201 */      public int size() { return AbstractFloat2ObjectMap.this.size(); }
/* 202:202 */      public void clear() { AbstractFloat2ObjectMap.this.clear(); }
/* 203:    */      
/* 204:204 */      public ObjectIterator<V> iterator() { new AbstractObjectIterator() {
/* 205:205 */          final ObjectIterator<Map.Entry<Float, V>> i = AbstractFloat2ObjectMap.this.entrySet().iterator();
/* 206:206 */          public V next() { return ((Float2ObjectMap.Entry)this.i.next()).getValue(); }
...
/* 213:    */  {
/* 214:214 */    return float2ObjectEntrySet();
/* 215:    */  }
/* 216:    */  
...
/* 244:244 */        s.append(", ");
/* 245:245 */      Float2ObjectMap.Entry<V> e = (Float2ObjectMap.Entry)i.next();
