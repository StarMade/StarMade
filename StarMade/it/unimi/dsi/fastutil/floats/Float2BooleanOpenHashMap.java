  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2BooleanOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2BooleanOpenHashMap(Map<? extends Float, ? extends Boolean> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2BooleanOpenHashMap(Map<? extends Float, ? extends Boolean> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2BooleanOpenHashMap(Float2BooleanMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2BooleanOpenHashMap(Float2BooleanMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2BooleanOpenHashMap(float[] local_k, boolean[] local_v, float local_f)
  {
  ...
  public Float2BooleanOpenHashMap(float[] local_k, boolean[] local_v)
  {
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Float2BooleanOpenHashMap.ValueIterator(Float2BooleanOpenHashMap.this);
        }
        ...
        {
          return Float2BooleanOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2BooleanOpenHashMap local_c;
    try
    {
      local_c = (Float2BooleanOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Float2BooleanOpenHashMap.MapIterator
    implements BooleanIterator
  {
    ...
    public Boolean next()
    {
      return Boolean.valueOf(Float2BooleanOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSet
  {
    ...
    {
      return new Float2BooleanOpenHashMap.KeyIterator(Float2BooleanOpenHashMap.this);
    }
    ...
    {
      return Float2BooleanOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2BooleanOpenHashMap.this.size;
      Float2BooleanOpenHashMap.this.remove(local_k);
    ...
    implements FloatIterator
  {
    ...
    public Float next()
    {
      return Float.valueOf(Float2BooleanOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2BooleanMap.FastEntrySet
  {
    ...
    {
      return new Float2BooleanOpenHashMap.EntryIterator(Float2BooleanOpenHashMap.this, null);
    }
    
    public ObjectIterator<Float2BooleanMap.Entry> fastIterator()
    {
      return new Float2BooleanOpenHashMap.FastEntryIterator(Float2BooleanOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2BooleanOpenHashMap.this.mask; Float2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2BooleanOpenHashMap.this.mask) {
        if (Float2BooleanOpenHashMap.this.key[pos] == local_k) {
          return Float2BooleanOpenHashMap.this.value[pos] == ((Boolean)local_e.getValue()).booleanValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2BooleanOpenHashMap.this.mask; Float2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2BooleanOpenHashMap.this.mask) {
        if (Float2BooleanOpenHashMap.this.key[pos] == local_k)
        {
          Float2BooleanOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Float2BooleanMap.Entry>
  {
    ...
    public AbstractFloat2BooleanMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2BooleanOpenHashMap.this.key[local_e];
      this.entry.value = Float2BooleanOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Float2BooleanMap.Entry>
  {
    ...
    {
      return this.entry = new Float2BooleanOpenHashMap.MapEntry(Float2BooleanOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2BooleanOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Float2BooleanOpenHashMap.this.field_49;
    int last = -1;
    int field_2125 = Float2BooleanOpenHashMap.this.size;
    FloatArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Float2BooleanOpenHashMap.this.used;
      while ((this.field_2125 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2125 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2125 != 0)
      {
        boolean[] local_k = Float2BooleanOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2BooleanOpenHashMap.this.mask; Float2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2BooleanOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2BooleanOpenHashMap.this.key[pos])) & Float2BooleanOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2BooleanOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Float2BooleanOpenHashMap.this.key[pos]);
        }
        Float2BooleanOpenHashMap.this.key[last] = Float2BooleanOpenHashMap.this.key[pos];
        Float2BooleanOpenHashMap.this.value[last] = Float2BooleanOpenHashMap.this.value[pos];
      }
      Float2BooleanOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Float2BooleanOpenHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
        this.last = -1;
        return;
      }
      Float2BooleanOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2125 > 0))
      {
        this.field_2125 += 1;
        nextEntry();
      }
    ...
    implements Float2BooleanMap.Entry, Map.Entry<Float, Boolean>
  {
    ...
    public boolean setValue(boolean local_v)
    {
      ...
      Float2BooleanOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Boolean> local_e = (Map.Entry)local_o;
      return (Float2BooleanOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2BooleanOpenHashMap.this.value[this.index] == ((Boolean)local_e.getValue()).booleanValue());
    }
    
    public int hashCode()
    {
      return HashCommon.float2int(Float2BooleanOpenHashMap.this.key[this.index]) ^ (Float2BooleanOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
    }
