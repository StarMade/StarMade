...
/*      */ 
/*      */ public class Float2CharRBTreeMap extends AbstractFloat2CharSortedMap
...
/*  119 */           return Float2CharRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  122 */           return Float2CharRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     char oldValue = put(ok.floatValue(), ov.charValue());
/*  731 */     return this.modified ? null : Character.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Character remove(Object ok)
/*      */   {
/*  737 */     char oldValue = remove(((Float)ok).floatValue());
...
/* 1141 */         final Comparator<? super Float2CharMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Float2CharMap.Entry x, Float2CharMap.Entry y) {
/* 1143 */             return Float2CharRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Float2CharRBTreeMap.EntryIterator(Float2CharRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from) {
/* 1153 */           return new Float2CharRBTreeMap.EntryIterator(Float2CharRBTreeMap.this, ((Float)from.getKey()).floatValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Float2CharRBTreeMap.Entry f = Float2CharRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1166 */           Float2CharRBTreeMap.Entry f = Float2CharRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1167 */           if (f != null) Float2CharRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Float2CharRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Float2CharRBTreeMap.this.clear(); } 
/* 1172 */         public Float2CharMap.Entry first() { return Float2CharRBTreeMap.this.firstEntry; } 
/* 1173 */         public Float2CharMap.Entry last() { return Float2CharRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) { return Float2CharRBTreeMap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2CharEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry to) { return Float2CharRBTreeMap.this.headMap((Float)to.getKey()).float2CharEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from) { return Float2CharRBTreeMap.this.tailMap((Float)from.getKey()).float2CharEntrySet(); }
/*      */       };
...
/* 1242 */           return new Float2CharRBTreeMap.ValueIterator(Float2CharRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(char k) {
/* 1245 */           return Float2CharRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Float2CharRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Float2CharRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Float2CharRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readFloat(), s.readChar());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readFloat(), s.readChar());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readFloat(), s.readChar()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Float2CharRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Float2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator() {
/* 1329 */             return new Float2CharRBTreeMap.Submap.SubmapEntryIterator(Float2CharRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from) {
/* 1332 */             return new Float2CharRBTreeMap.Submap.SubmapEntryIterator(Float2CharRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
/*      */           }
/* 1334 */           public Comparator<? super Float2CharMap.Entry> comparator() { return Float2CharRBTreeMap.this.float2CharEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Float2CharRBTreeMap.Entry f = Float2CharRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1340 */             return (f != null) && (Float2CharRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Float2CharRBTreeMap.Entry f = Float2CharRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1347 */             if ((f != null) && (Float2CharRBTreeMap.Submap.this.in(f.key))) Float2CharRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Float2CharRBTreeMap.Submap.SubmapIterator(Float2CharRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Float2CharRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Float2CharMap.Entry first() { return Float2CharRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Float2CharMap.Entry last() { return Float2CharRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry to) { return Float2CharRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2CharEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry to) { return Float2CharRBTreeMap.Submap.this.headMap((Float)to.getKey()).float2CharEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from) { return Float2CharRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2CharEntrySet(); }
/*      */         };
...
/*      */           public CharIterator iterator() {
/* 1376 */             return new Float2CharRBTreeMap.Submap.SubmapValueIterator(Float2CharRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(char k) {
/* 1379 */             return Float2CharRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Float2CharRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Float2CharRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(float k) {
/* 1392 */       return (in(k)) && (Float2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(char v) {
...
/* 1407 */       return (in(kk)) && ((e = Float2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public char put(float k, char v) {
/* 1410 */       Float2CharRBTreeMap.this.modified = false;
...
/* 1412 */       char oldValue = Float2CharRBTreeMap.this.put(k, v);
/* 1413 */       return Float2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Character put(Float ok, Character ov) {
/* 1416 */       char oldValue = put(ok.floatValue(), ov.charValue());
/* 1417 */       return Float2CharRBTreeMap.this.modified ? null : Character.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public char remove(float k) {
/* 1421 */       Float2CharRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       char oldValue = Float2CharRBTreeMap.this.remove(k);
/* 1424 */       return Float2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Character remove(Object ok) {
/* 1427 */       char oldValue = remove(((Float)ok).floatValue());
/* 1428 */       return Float2CharRBTreeMap.this.modified ? Character.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1443 */       return Float2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Float2CharSortedMap headMap(float to) {
/* 1446 */       if (this.top) return new Submap(Float2CharRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Float2CharRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Float2CharRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Float2CharSortedMap tailMap(float from) {
/* 1450 */       if (this.bottom) return new Submap(Float2CharRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Float2CharRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2CharRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Float2CharSortedMap subMap(float from, float to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Float2CharRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Float2CharRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Float2CharRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Float2CharRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Float2CharRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Float2CharRBTreeMap.this.tree == null) return null;
/* 1468 */       Float2CharRBTreeMap.Entry e;
/*      */       Float2CharRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Float2CharRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Float2CharRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Float2CharRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Float2CharRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Float2CharRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Float2CharRBTreeMap.this.tree == null) return null;
/* 1486 */       Float2CharRBTreeMap.Entry e;
/*      */       Float2CharRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Float2CharRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Float2CharRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Float2CharRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Float2CharRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public float firstFloatKey() {
/* 1497 */       Float2CharRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public float lastFloatKey() {
/* 1502 */       Float2CharRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Float firstKey() {
/* 1507 */       Float2CharRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Float lastKey() {
/* 1512 */       Float2CharRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Float2CharRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Float2CharRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Float2CharRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Float2CharMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Float2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Float2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Float2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Float2CharRBTreeMap.Submap.this.bottom) && (Float2CharRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Float2CharRBTreeMap.Submap.this.top) && (Float2CharRBTreeMap.this.compare(k, (this.prev = Float2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Float2CharRBTreeMap.this.locateKey(k);
/* 1534 */             if (Float2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Float2CharRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2CharRBTreeMap.this.compare(this.prev.key, Float2CharRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Float2CharRBTreeMap.Submap.this.top) && (this.next != null) && (Float2CharRBTreeMap.this.compare(this.next.key, Float2CharRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public FloatBidirectionalIterator iterator() { return new Float2CharRBTreeMap.Submap.SubmapKeyIterator(Float2CharRBTreeMap.Submap.this); } 
/* 1367 */       public FloatBidirectionalIterator iterator(float from) { return new Float2CharRBTreeMap.Submap.SubmapKeyIterator(Float2CharRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2CharRBTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public FloatBidirectionalIterator iterator() { return new Float2CharRBTreeMap.KeyIterator(Float2CharRBTreeMap.this); } 
/* 1201 */     public FloatBidirectionalIterator iterator(float from) { return new Float2CharRBTreeMap.KeyIterator(Float2CharRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2CharRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2CharRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Float2CharMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Float2CharMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Float2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Float2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Float2CharRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(float k) {
/* 1067 */       if ((this.next = Float2CharRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Float2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Float2CharRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
