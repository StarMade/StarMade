  ...
  implements Float2ObjectSortedMap<V>
{
    ...
    extends AbstractObjectCollection<V>
  {
    ...
    {
      return new AbstractFloat2ObjectSortedMap.ValuesIterator(AbstractFloat2ObjectSortedMap.this.entrySet().iterator());
    }
    
    public boolean contains(Object local_k)
    {
      return AbstractFloat2ObjectSortedMap.this.containsValue(local_k);
    }
    ...
    extends AbstractFloatSortedSet
  {
    ...
    {
      return AbstractFloat2ObjectSortedMap.this.containsKey(local_k);
    }
    ...
    {
      return AbstractFloat2ObjectSortedMap.this.headMap(local_to).keySet();
    }
    ...
    {
      return AbstractFloat2ObjectSortedMap.this.subMap(from, local_to).keySet();
    }
    
    public FloatBidirectionalIterator iterator(float from)
    {
      return new AbstractFloat2ObjectSortedMap.KeySetIterator(AbstractFloat2ObjectSortedMap.this.entrySet().iterator(new AbstractFloat2ObjectMap.BasicEntry(from, null)));
    }
    
    public FloatBidirectionalIterator iterator()
    {
      return new AbstractFloat2ObjectSortedMap.KeySetIterator(AbstractFloat2ObjectSortedMap.this.entrySet().iterator());
    }
  }
}
