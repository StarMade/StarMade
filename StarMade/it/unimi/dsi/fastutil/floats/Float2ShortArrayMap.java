  ...
  implements Serializable, Cloneable
{
  ...
  public Float2ShortArrayMap(Float2ShortMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Float2ShortArrayMap(Map<? extends Float, ? extends Short> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Float2ShortArrayMap local_c;
    try
    {
      local_c = (Float2ShortArrayMap)super.clone();
    }
    ...
    implements Float2ShortMap.FastEntrySet
  {
    ...
    public ObjectIterator<Float2ShortMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Float2ShortMap.Entry next()
        {
          ...
          return new AbstractFloat2ShortMap.BasicEntry(Float2ShortArrayMap.this.key[this.next], Float2ShortArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Float2ShortMap.Entry> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Float2ShortMap.Entry next()
        {
          ...
          this.entry.key = Float2ShortArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Float2ShortArrayMap.this.containsKey(local_k)) && (Float2ShortArrayMap.this.get(local_k) == ((Short)local_e.getValue()).shortValue());
    }
  }
}
