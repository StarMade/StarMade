...
/*     */ 
/*     */ public class Float2ShortArrayMap extends AbstractFloat2ShortMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Float2ShortArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Float2ShortMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Float2ShortArrayMap.this.size; }
/*     */ 
/*     */         public Float2ShortMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractFloat2ShortMap.BasicEntry(Float2ShortArrayMap.this.key[this.next], Float2ShortArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractFloat2ShortMap.BasicEntry entry = new AbstractFloat2ShortMap.BasicEntry(0.0F, (short)0);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Float2ShortArrayMap.this.size; }
/*     */ 
/*     */         public Float2ShortMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Float2ShortArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Float2ShortArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Float2ShortArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Float2ShortArrayMap.this.containsKey(k)) && (Float2ShortArrayMap.this.get(k) == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */   }
/*     */ }
