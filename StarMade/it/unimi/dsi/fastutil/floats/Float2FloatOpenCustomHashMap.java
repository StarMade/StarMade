  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2FloatOpenCustomHashMap(int expected, float local_f, FloatHash.Strategy strategy)
  {
  ...
  public Float2FloatOpenCustomHashMap(Map<? extends Float, ? extends Float> local_m, float local_f, FloatHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Float2FloatOpenCustomHashMap(Map<? extends Float, ? extends Float> local_m, FloatHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Float2FloatOpenCustomHashMap(Float2FloatMap local_m, float local_f, FloatHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Float2FloatOpenCustomHashMap(Float2FloatMap local_m, FloatHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Float2FloatOpenCustomHashMap(float[] local_k, float[] local_v, float local_f, FloatHash.Strategy strategy)
  {
  ...
  public Float2FloatOpenCustomHashMap(float[] local_k, float[] local_v, FloatHash.Strategy strategy)
  {
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Float2FloatOpenCustomHashMap.ValueIterator(Float2FloatOpenCustomHashMap.this);
        }
        ...
        {
          return Float2FloatOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2FloatOpenCustomHashMap local_c;
    try
    {
      local_c = (Float2FloatOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Float2FloatOpenCustomHashMap.MapIterator
    implements FloatIterator
  {
    ...
    {
      return Float2FloatOpenCustomHashMap.this.value[nextEntry()];
    }
    
    public Float next()
    {
      return Float.valueOf(Float2FloatOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSet
  {
    ...
    public FloatIterator iterator()
    {
      return new Float2FloatOpenCustomHashMap.KeyIterator(Float2FloatOpenCustomHashMap.this);
    }
    ...
    {
      return Float2FloatOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2FloatOpenCustomHashMap.this.size;
      Float2FloatOpenCustomHashMap.this.remove(local_k);
    ...
    implements FloatIterator
  {
    ...
    public float nextFloat()
    {
      return Float2FloatOpenCustomHashMap.this.key[nextEntry()];
    }
    
    public Float next()
    {
      return Float.valueOf(Float2FloatOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2FloatMap.FastEntrySet
  {
    ...
    {
      return new Float2FloatOpenCustomHashMap.EntryIterator(Float2FloatOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Float2FloatMap.Entry> fastIterator()
    {
      return new Float2FloatOpenCustomHashMap.FastEntryIterator(Float2FloatOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Float2FloatOpenCustomHashMap.this.strategy.hashCode(local_k)) & Float2FloatOpenCustomHashMap.this.mask; Float2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask) {
        if (Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[pos], local_k)) {
          return Float2FloatOpenCustomHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Float2FloatOpenCustomHashMap.this.strategy.hashCode(local_k)) & Float2FloatOpenCustomHashMap.this.mask; Float2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask) {
        if (Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[pos], local_k))
        {
          Float2FloatOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Float2FloatMap.Entry>
  {
    ...
    public AbstractFloat2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2FloatOpenCustomHashMap.this.key[local_e];
      this.entry.value = Float2FloatOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Float2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Float2FloatOpenCustomHashMap.MapEntry(Float2FloatOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Float2FloatOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2029 = Float2FloatOpenCustomHashMap.this.size;
    FloatArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Float2FloatOpenCustomHashMap.this.used;
      while ((this.field_2029 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2029 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Float2FloatOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2FloatOpenCustomHashMap.this.mask; Float2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Float2FloatOpenCustomHashMap.this.strategy.hashCode(Float2FloatOpenCustomHashMap.this.key[pos])) & Float2FloatOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2FloatOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Float2FloatOpenCustomHashMap.this.key[pos]);
        }
        Float2FloatOpenCustomHashMap.this.key[last] = Float2FloatOpenCustomHashMap.this.key[pos];
        Float2FloatOpenCustomHashMap.this.value[last] = Float2FloatOpenCustomHashMap.this.value[pos];
      }
      Float2FloatOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Float2FloatOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
        this.last = -1;
        return;
      }
      Float2FloatOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2029 > 0))
      {
        this.field_2029 += 1;
        nextEntry();
      }
    ...
    implements Float2FloatMap.Entry, Map.Entry<Float, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Float2FloatOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Float> local_e = (Map.Entry)local_o;
      return (Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[this.index], ((Float)local_e.getKey()).floatValue())) && (Float2FloatOpenCustomHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
