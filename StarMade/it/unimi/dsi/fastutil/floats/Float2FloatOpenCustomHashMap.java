...
/* 662 */           return new Float2FloatOpenCustomHashMap.ValueIterator(Float2FloatOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 665 */           return Float2FloatOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(float v) {
/* 668 */           return Float2FloatOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 671 */           Float2FloatOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 786 */       c = (Float2FloatOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Float2FloatOpenCustomHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 655 */       super(null); } 
/* 656 */     public float nextFloat() { return Float2FloatOpenCustomHashMap.this.value[nextEntry()]; } 
/* 657 */     public Float next() { return Float.valueOf(Float2FloatOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     public FloatIterator iterator()
/*     */     {
/* 627 */       return new Float2FloatOpenCustomHashMap.KeyIterator(Float2FloatOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 630 */       return Float2FloatOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(float k) {
/* 633 */       return Float2FloatOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(float k) {
/* 636 */       int oldSize = Float2FloatOpenCustomHashMap.this.size;
/* 637 */       Float2FloatOpenCustomHashMap.this.remove(k);
/* 638 */       return Float2FloatOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 641 */       Float2FloatOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Float2FloatOpenCustomHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public float nextFloat() { return Float2FloatOpenCustomHashMap.this.key[nextEntry()]; } 
/* 623 */     public Float next() { return Float.valueOf(Float2FloatOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 567 */       return new Float2FloatOpenCustomHashMap.EntryIterator(Float2FloatOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Float2FloatMap.Entry> fastIterator() {
/* 570 */       return new Float2FloatOpenCustomHashMap.FastEntryIterator(Float2FloatOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 578 */       int pos = HashCommon.murmurHash3(Float2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Float2FloatOpenCustomHashMap.this.mask;
/*     */ 
/* 580 */       while (Float2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 581 */         if (Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[pos], k)) return Float2FloatOpenCustomHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 582 */         pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask;
/*     */       }
/* 584 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 592 */       int pos = HashCommon.murmurHash3(Float2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Float2FloatOpenCustomHashMap.this.mask;
/*     */ 
/* 594 */       while (Float2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 595 */         if (Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[pos], k)) {
/* 596 */           Float2FloatOpenCustomHashMap.this.remove(e.getKey());
/* 597 */           return true;
/*     */         }
/* 599 */         pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask;
/*     */       }
/* 601 */       return false;
/*     */     }
/*     */     public int size() {
/* 604 */       return Float2FloatOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 607 */       Float2FloatOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Float2FloatOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Float2FloatMap.Entry>
/*     */   {
/* 557 */     final AbstractFloat2FloatMap.BasicEntry entry = new AbstractFloat2FloatMap.BasicEntry(0.0F, 0.0F);
/*     */ 
...
/* 559 */       int e = nextEntry();
/* 560 */       this.entry.key = Float2FloatOpenCustomHashMap.this.key[e];
/* 561 */       this.entry.value = Float2FloatOpenCustomHashMap.this.value[e];
/* 562 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Float2FloatOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Float2FloatMap.Entry>
/*     */   {
...
/* 548 */       return this.entry = new Float2FloatOpenCustomHashMap.MapEntry(Float2FloatOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 552 */       super.remove();
/* 553 */       Float2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 454 */       this.pos = Float2FloatOpenCustomHashMap.this.n;
/*     */ 
/* 457 */       this.last = -1;
/*     */ 
/* 459 */       this.c = Float2FloatOpenCustomHashMap.this.size;
/*     */ 
/* 464 */       boolean[] used = Float2FloatOpenCustomHashMap.this.used;
...
/*     */ 
/* 477 */         int pos = HashCommon.murmurHash3(Float2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Float2FloatOpenCustomHashMap.this.mask;
/*     */ 
/* 479 */         while (Float2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 480 */           if (Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481 */           pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 484 */       this.last = this.pos;
/*     */ 
/* 486 */       if (this.c != 0) {
/* 487 */         boolean[] used = Float2FloatOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 504 */         pos = (last = pos) + 1 & Float2FloatOpenCustomHashMap.this.mask;
/* 505 */         while (Float2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 506 */           int slot = HashCommon.murmurHash3(Float2FloatOpenCustomHashMap.this.strategy.hashCode(Float2FloatOpenCustomHashMap.this.key[pos])) & Float2FloatOpenCustomHashMap.this.mask;
/* 507 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508 */           pos = pos + 1 & Float2FloatOpenCustomHashMap.this.mask;
/*     */         }
/* 510 */         if (Float2FloatOpenCustomHashMap.this.used[pos] == 0) break;
/* 511 */         if (pos < last)
/*     */         {
/* 513 */           if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 514 */           this.wrapped.add(Float2FloatOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 516 */         Float2FloatOpenCustomHashMap.this.key[last] = Float2FloatOpenCustomHashMap.this.key[pos];
/* 517 */         Float2FloatOpenCustomHashMap.this.value[last] = Float2FloatOpenCustomHashMap.this.value[pos];
/*     */       }
/* 519 */       Float2FloatOpenCustomHashMap.this.used[last] = false;
/* 520 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 525 */       if (this.pos < -1)
/*     */       {
/* 527 */         Float2FloatOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 528 */         this.last = -1;
/* 529 */         return;
/*     */       }
/* 531 */       Float2FloatOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Float getKey() {
/* 418 */       return Float.valueOf(Float2FloatOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public float getFloatKey() {
/* 421 */       return Float2FloatOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Float getValue() {
/* 424 */       return Float.valueOf(Float2FloatOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public float getFloatValue() {
/* 427 */       return Float2FloatOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public float setValue(float v) {
/* 430 */       float oldValue = Float2FloatOpenCustomHashMap.this.value[this.index];
/* 431 */       Float2FloatOpenCustomHashMap.this.value[this.index] = v;
/* 432 */       return oldValue;
/*     */     }
/*     */     public Float setValue(Float v) {
...
/* 441 */       return (Float2FloatOpenCustomHashMap.this.strategy.equals(Float2FloatOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue())) && (Float2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */     public int hashCode() {
/* 444 */       return Float2FloatOpenCustomHashMap.this.strategy.hashCode(Float2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Float2FloatOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 447 */       return Float2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Float2FloatOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
