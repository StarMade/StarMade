...
/* 662 */           return new Float2ByteOpenCustomHashMap.ValueIterator(Float2ByteOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 665 */           return Float2ByteOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(byte v) {
/* 668 */           return Float2ByteOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 671 */           Float2ByteOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 786 */       c = (Float2ByteOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Float2ByteOpenCustomHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 655 */       super(null); } 
/* 656 */     public byte nextByte() { return Float2ByteOpenCustomHashMap.this.value[nextEntry()]; } 
/* 657 */     public Byte next() { return Byte.valueOf(Float2ByteOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 627 */       return new Float2ByteOpenCustomHashMap.KeyIterator(Float2ByteOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 630 */       return Float2ByteOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(float k) {
/* 633 */       return Float2ByteOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(float k) {
/* 636 */       int oldSize = Float2ByteOpenCustomHashMap.this.size;
/* 637 */       Float2ByteOpenCustomHashMap.this.remove(k);
/* 638 */       return Float2ByteOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 641 */       Float2ByteOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Float2ByteOpenCustomHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public float nextFloat() { return Float2ByteOpenCustomHashMap.this.key[nextEntry()]; } 
/* 623 */     public Float next() { return Float.valueOf(Float2ByteOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 567 */       return new Float2ByteOpenCustomHashMap.EntryIterator(Float2ByteOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Float2ByteMap.Entry> fastIterator() {
/* 570 */       return new Float2ByteOpenCustomHashMap.FastEntryIterator(Float2ByteOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 578 */       int pos = HashCommon.murmurHash3(Float2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ByteOpenCustomHashMap.this.mask;
/*     */ 
/* 580 */       while (Float2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 581 */         if (Float2ByteOpenCustomHashMap.this.strategy.equals(Float2ByteOpenCustomHashMap.this.key[pos], k)) return Float2ByteOpenCustomHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 582 */         pos = pos + 1 & Float2ByteOpenCustomHashMap.this.mask;
/*     */       }
/* 584 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 592 */       int pos = HashCommon.murmurHash3(Float2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ByteOpenCustomHashMap.this.mask;
/*     */ 
/* 594 */       while (Float2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 595 */         if (Float2ByteOpenCustomHashMap.this.strategy.equals(Float2ByteOpenCustomHashMap.this.key[pos], k)) {
/* 596 */           Float2ByteOpenCustomHashMap.this.remove(e.getKey());
/* 597 */           return true;
/*     */         }
/* 599 */         pos = pos + 1 & Float2ByteOpenCustomHashMap.this.mask;
/*     */       }
/* 601 */       return false;
/*     */     }
/*     */     public int size() {
/* 604 */       return Float2ByteOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 607 */       Float2ByteOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Float2ByteOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Float2ByteMap.Entry>
/*     */   {
/* 557 */     final AbstractFloat2ByteMap.BasicEntry entry = new AbstractFloat2ByteMap.BasicEntry(0.0F, (byte)0);
/*     */ 
...
/* 559 */       int e = nextEntry();
/* 560 */       this.entry.key = Float2ByteOpenCustomHashMap.this.key[e];
/* 561 */       this.entry.value = Float2ByteOpenCustomHashMap.this.value[e];
/* 562 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Float2ByteOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Float2ByteMap.Entry>
/*     */   {
...
/* 548 */       return this.entry = new Float2ByteOpenCustomHashMap.MapEntry(Float2ByteOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 552 */       super.remove();
/* 553 */       Float2ByteOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 454 */       this.pos = Float2ByteOpenCustomHashMap.this.n;
/*     */ 
/* 457 */       this.last = -1;
/*     */ 
/* 459 */       this.c = Float2ByteOpenCustomHashMap.this.size;
/*     */ 
/* 464 */       boolean[] used = Float2ByteOpenCustomHashMap.this.used;
...
/*     */ 
/* 477 */         int pos = HashCommon.murmurHash3(Float2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ByteOpenCustomHashMap.this.mask;
/*     */ 
/* 479 */         while (Float2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 480 */           if (Float2ByteOpenCustomHashMap.this.strategy.equals(Float2ByteOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481 */           pos = pos + 1 & Float2ByteOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 484 */       this.last = this.pos;
/*     */ 
/* 486 */       if (this.c != 0) {
/* 487 */         boolean[] used = Float2ByteOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 504 */         pos = (last = pos) + 1 & Float2ByteOpenCustomHashMap.this.mask;
/* 505 */         while (Float2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 506 */           int slot = HashCommon.murmurHash3(Float2ByteOpenCustomHashMap.this.strategy.hashCode(Float2ByteOpenCustomHashMap.this.key[pos])) & Float2ByteOpenCustomHashMap.this.mask;
/* 507 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508 */           pos = pos + 1 & Float2ByteOpenCustomHashMap.this.mask;
/*     */         }
/* 510 */         if (Float2ByteOpenCustomHashMap.this.used[pos] == 0) break;
/* 511 */         if (pos < last)
/*     */         {
/* 513 */           if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 514 */           this.wrapped.add(Float2ByteOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 516 */         Float2ByteOpenCustomHashMap.this.key[last] = Float2ByteOpenCustomHashMap.this.key[pos];
/* 517 */         Float2ByteOpenCustomHashMap.this.value[last] = Float2ByteOpenCustomHashMap.this.value[pos];
/*     */       }
/* 519 */       Float2ByteOpenCustomHashMap.this.used[last] = false;
/* 520 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 525 */       if (this.pos < -1)
/*     */       {
/* 527 */         Float2ByteOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 528 */         this.last = -1;
/* 529 */         return;
/*     */       }
/* 531 */       Float2ByteOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Float getKey() {
/* 418 */       return Float.valueOf(Float2ByteOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public float getFloatKey() {
/* 421 */       return Float2ByteOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Byte getValue() {
/* 424 */       return Byte.valueOf(Float2ByteOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public byte getByteValue() {
/* 427 */       return Float2ByteOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public byte setValue(byte v) {
/* 430 */       byte oldValue = Float2ByteOpenCustomHashMap.this.value[this.index];
/* 431 */       Float2ByteOpenCustomHashMap.this.value[this.index] = v;
/* 432 */       return oldValue;
/*     */     }
/*     */     public Byte setValue(Byte v) {
...
/* 441 */       return (Float2ByteOpenCustomHashMap.this.strategy.equals(Float2ByteOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue())) && (Float2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */     public int hashCode() {
/* 444 */       return Float2ByteOpenCustomHashMap.this.strategy.hashCode(Float2ByteOpenCustomHashMap.this.key[this.index]) ^ Float2ByteOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 447 */       return Float2ByteOpenCustomHashMap.this.key[this.index] + "=>" + Float2ByteOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
