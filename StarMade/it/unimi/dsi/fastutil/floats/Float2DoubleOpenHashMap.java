  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2DoubleOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2DoubleOpenHashMap(Map<? extends Float, ? extends Double> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2DoubleOpenHashMap(Map<? extends Float, ? extends Double> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2DoubleOpenHashMap(Float2DoubleMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2DoubleOpenHashMap(Float2DoubleMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2DoubleOpenHashMap(float[] local_k, double[] local_v, float local_f)
  {
  ...
  public Float2DoubleOpenHashMap(float[] local_k, double[] local_v)
  {
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Float2DoubleOpenHashMap.ValueIterator(Float2DoubleOpenHashMap.this);
        }
        ...
        {
          return Float2DoubleOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2DoubleOpenHashMap local_c;
    try
    {
      local_c = (Float2DoubleOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Float2DoubleOpenHashMap.MapIterator
    implements DoubleIterator
  {
    ...
    {
      return Float2DoubleOpenHashMap.this.value[nextEntry()];
    }
    
    public Double next()
    {
      return Double.valueOf(Float2DoubleOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSet
  {
    ...
    {
      return new Float2DoubleOpenHashMap.KeyIterator(Float2DoubleOpenHashMap.this);
    }
    ...
    {
      return Float2DoubleOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2DoubleOpenHashMap.this.size;
      Float2DoubleOpenHashMap.this.remove(local_k);
    ...
    implements FloatIterator
  {
    ...
    {
      return Float2DoubleOpenHashMap.this.key[nextEntry()];
    }
    
    public Float next()
    {
      return Float.valueOf(Float2DoubleOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2DoubleMap.FastEntrySet
  {
    ...
    {
      return new Float2DoubleOpenHashMap.EntryIterator(Float2DoubleOpenHashMap.this, null);
    }
    
    public ObjectIterator<Float2DoubleMap.Entry> fastIterator()
    {
      return new Float2DoubleOpenHashMap.FastEntryIterator(Float2DoubleOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2DoubleOpenHashMap.this.mask; Float2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2DoubleOpenHashMap.this.mask) {
        if (Float2DoubleOpenHashMap.this.key[pos] == local_k) {
          return Float2DoubleOpenHashMap.this.value[pos] == ((Double)local_e.getValue()).doubleValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2DoubleOpenHashMap.this.mask; Float2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2DoubleOpenHashMap.this.mask) {
        if (Float2DoubleOpenHashMap.this.key[pos] == local_k)
        {
          Float2DoubleOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Float2DoubleMap.Entry>
  {
    ...
    public AbstractFloat2DoubleMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2DoubleOpenHashMap.this.key[local_e];
      this.entry.value = Float2DoubleOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Float2DoubleMap.Entry>
  {
    ...
    {
      return this.entry = new Float2DoubleOpenHashMap.MapEntry(Float2DoubleOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2DoubleOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Float2DoubleOpenHashMap.this.field_49;
    int last = -1;
    int field_2246 = Float2DoubleOpenHashMap.this.size;
    FloatArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Float2DoubleOpenHashMap.this.used;
      while ((this.field_2246 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2246 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2246 != 0)
      {
        boolean[] local_k = Float2DoubleOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2DoubleOpenHashMap.this.mask; Float2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2DoubleOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2DoubleOpenHashMap.this.key[pos])) & Float2DoubleOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2DoubleOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
    ...
    public void remove()
    {
      ...
      Float2DoubleOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2246 > 0))
      {
        this.field_2246 += 1;
        nextEntry();
      }
    ...
    implements Float2DoubleMap.Entry, Map.Entry<Float, Double>
  {
    ...
    {
      return Double.valueOf(Float2DoubleOpenHashMap.this.value[this.index]);
    }
    ...
    public double setValue(double local_v)
    {
      ...
      Float2DoubleOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Double> local_e = (Map.Entry)local_o;
      return (Float2DoubleOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2DoubleOpenHashMap.this.value[this.index] == ((Double)local_e.getValue()).doubleValue());
    }
