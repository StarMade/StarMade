  ...
  extends FloatHeapSemiIndirectPriorityQueue
{
  ...
  public FloatHeapIndirectPriorityQueue(float[] refArray, int capacity, FloatComparator local_c)
  {
  ...
  public FloatHeapIndirectPriorityQueue(float[] refArray, FloatComparator local_c)
  {
  ...
  public FloatHeapIndirectPriorityQueue(float[] refArray, int[] local_a, int size, FloatComparator local_c)
  {
    ...
    FloatIndirectHeaps.makeHeap(refArray, local_a, this.inv, size, local_c);
  }
  
  public FloatHeapIndirectPriorityQueue(float[] refArray, int[] local_a, FloatComparator local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public FloatHeapIndirectPriorityQueue(float[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public FloatHeapIndirectPriorityQueue(float[] refArray, int[] local_a)
  {
  ...
  public void enqueue(int local_x)
  {
    ...
    FloatIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, this.size - 1, this.field_69);
  }
  ...
  public int dequeue()
  {
    ...
    this.inv[result] = -1;
    if (this.size != 0) {
      FloatIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.field_69);
    }
    return result;
  }
  ...
  public void changed(int index)
  {
    ...
    int newPos = FloatIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, pos, this.field_69);
    FloatIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.field_69);
  }
  
  public void allChanged()
  {
    FloatIndirectHeaps.makeHeap(this.refArray, this.heap, this.inv, this.size, this.field_69);
  }
  ...
  public boolean remove(int index)
  {
    ...
    if (result < --this.size)
    {
      ...
      int newPos = FloatIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, result, this.field_69);
      FloatIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.field_69);
    }
    return true;
  }
