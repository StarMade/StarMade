...
/*   22:     */
/*  113:     */public class Float2IntLinkedOpenHashMap
/*  114:     */  extends AbstractFloat2IntSortedMap
...
/*  127:     */  protected volatile transient Float2IntSortedMap.FastSortedEntrySet entries;
...
/*  141:     */  
/*  149:     */  public Float2IntLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Float2IntLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Float2IntLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Float2IntLinkedOpenHashMap(Map<? extends Float, ? extends Integer> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Float2IntLinkedOpenHashMap(Map<? extends Float, ? extends Integer> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Float2IntLinkedOpenHashMap(Float2IntMap m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Float2IntLinkedOpenHashMap(Float2IntMap m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Float2IntLinkedOpenHashMap(float[] k, int[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Float2IntLinkedOpenHashMap(float[] k, int[] v)
/*  225:     */  {
/*  226: 226 */    this(k, v, 0.75F);
/*  227:     */  }
/*  228:     */  
/*  232:     */  public int put(float k, int v)
/*  233:     */  {
...
/*  260:     */  }
/*  261:     */  
/*  262: 262 */  public Integer put(Float ok, Integer ov) { int v = ov.intValue();
...
/*  291:     */  }
/*  292:     */  
/*  303:     */  public int add(float k, int incr)
/*  304:     */  {
...
/*  462:     */  }
/*  463:     */  
/*  467:     */  public int getAndMoveToFirst(float k)
/*  468:     */  {
...
/*  483:     */  }
/*  484:     */  
/*  488:     */  public int getAndMoveToLast(float k)
/*  489:     */  {
...
/*  504:     */  }
/*  505:     */  
/*  510:     */  public int putAndMoveToFirst(float k, int v)
/*  511:     */  {
...
/*  543:     */  }
/*  544:     */  
/*  549:     */  public int putAndMoveToLast(float k, int v)
/*  550:     */  {
...
/*  582:     */  }
/*  583:     */  
/*  584: 584 */  public Integer get(Float ok) { float k = ok.floatValue();
/*  585:     */    
...
/*  660:     */    implements Float2IntMap.Entry, Map.Entry<Float, Integer>
/*  661:     */  {
...
/*  667:     */    }
/*  668:     */    
/*  669: 669 */    public Float getKey() { return Float.valueOf(Float2IntLinkedOpenHashMap.this.key[this.index]); }
/*  670:     */    
/*  671:     */    public float getFloatKey() {
/*  672: 672 */      return Float2IntLinkedOpenHashMap.this.key[this.index];
/*  673:     */    }
/*  674:     */    
/*  675: 675 */    public Integer getValue() { return Integer.valueOf(Float2IntLinkedOpenHashMap.this.value[this.index]); }
/*  676:     */    
/*  678: 678 */    public int getIntValue() { return Float2IntLinkedOpenHashMap.this.value[this.index]; }
/*  679:     */    
/*  680:     */    public int setValue(int v) {
/*  681: 681 */      int oldValue = Float2IntLinkedOpenHashMap.this.value[this.index];
/*  682: 682 */      Float2IntLinkedOpenHashMap.this.value[this.index] = v;
...
/*  691: 691 */      Map.Entry<Float, Integer> e = (Map.Entry)o;
/*  692: 692 */      return (Float2IntLinkedOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*  693:     */    }
/*  694:     */    
/*  695: 695 */    public int hashCode() { return HashCommon.float2int(Float2IntLinkedOpenHashMap.this.key[this.index]) ^ Float2IntLinkedOpenHashMap.this.value[this.index]; }
/*  696:     */    
/*  697:     */    public String toString() {
/*  698: 698 */      return Float2IntLinkedOpenHashMap.this.key[this.index] + "=>" + Float2IntLinkedOpenHashMap.this.value[this.index];
/*  699:     */    }
/*  700:     */  }
/*  701:     */  
...
/*  786: 786 */  public Float2IntSortedMap tailMap(float from) { throw new UnsupportedOperationException(); }
/*  787: 787 */  public Float2IntSortedMap headMap(float to) { throw new UnsupportedOperationException(); }
/*  788: 788 */  public Float2IntSortedMap subMap(float from, float to) { throw new UnsupportedOperationException(); }
/*  789:     */  
...
/*  803: 803 */    int index = -1;
/*  804:     */    
/*  805: 805 */    private MapIterator() { this.next = Float2IntLinkedOpenHashMap.this.first;
/*  806: 806 */      this.index = 0;
/*  807:     */    }
/*  808:     */    
/*  809: 809 */    private MapIterator(float from) { if (Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.last] == from) {
/*  810: 810 */        this.prev = Float2IntLinkedOpenHashMap.this.last;
/*  811: 811 */        this.index = Float2IntLinkedOpenHashMap.this.size;
/*  812:     */      }
/*  813:     */      else
/*  814:     */      {
/*  815: 815 */        int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2IntLinkedOpenHashMap.this.mask;
/*  816:     */        
/*  817: 817 */        while (Float2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  818: 818 */          if (Float2IntLinkedOpenHashMap.this.key[pos] == from)
/*  819:     */          {
/*  820: 820 */            this.next = ((int)Float2IntLinkedOpenHashMap.this.link[pos]);
/*  821: 821 */            this.prev = pos;
/*  822: 822 */            return;
/*  823:     */          }
/*  824: 824 */          pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*  825:     */        }
...
/*  838: 838 */        this.index = Float2IntLinkedOpenHashMap.this.size;
/*  839: 839 */        return;
/*  840:     */      }
/*  841: 841 */      int pos = Float2IntLinkedOpenHashMap.this.first;
/*  842: 842 */      this.index = 1;
/*  843: 843 */      while (pos != this.prev) {
/*  844: 844 */        pos = (int)Float2IntLinkedOpenHashMap.this.link[pos];
...
/*  855:     */    }
/*  856:     */    
/*  857: 857 */    public int nextEntry() { if (!hasNext()) return Float2IntLinkedOpenHashMap.this.size();
/*  858: 858 */      this.curr = this.next;
/*  859: 859 */      this.next = ((int)Float2IntLinkedOpenHashMap.this.link[this.curr]);
...
/*  867: 867 */      this.prev = ((int)(Float2IntLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  880: 880 */        this.prev = ((int)(Float2IntLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  881:     */      }
/*  882:     */      else {
/*  883: 883 */        this.next = ((int)Float2IntLinkedOpenHashMap.this.link[this.curr]); }
/*  884: 884 */      Float2IntLinkedOpenHashMap.this.size -= 1;
/*  885:     */      
/*  887: 887 */      if (this.prev == -1) { Float2IntLinkedOpenHashMap.this.first = this.next;
/*  888:     */      } else
/*  889: 889 */        Float2IntLinkedOpenHashMap.this.link[this.prev] ^= (Float2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890: 890 */      if (this.next == -1) { Float2IntLinkedOpenHashMap.this.last = this.prev;
/*  891:     */      } else
/*  892: 892 */        Float2IntLinkedOpenHashMap.this.link[this.next] ^= (Float2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  893: 893 */      int pos = this.curr;
/*  894:     */      int last;
/*  895:     */      for (;;) {
/*  896: 896 */        pos = (last = pos) + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*  897: 897 */        while (Float2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  898: 898 */          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2IntLinkedOpenHashMap.this.key[pos])) & Float2IntLinkedOpenHashMap.this.mask;
/*  899: 899 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900: 900 */          pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*  901:     */        }
/*  902: 902 */        if (Float2IntLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903: 903 */        Float2IntLinkedOpenHashMap.this.key[last] = Float2IntLinkedOpenHashMap.this.key[pos];
/*  904: 904 */        Float2IntLinkedOpenHashMap.this.value[last] = Float2IntLinkedOpenHashMap.this.value[pos];
/*  905: 905 */        if (this.next == pos) this.next = last;
/*  906: 906 */        if (this.prev == pos) this.prev = last;
/*  907: 907 */        Float2IntLinkedOpenHashMap.this.fixPointers(pos, last);
/*  908:     */      }
/*  909: 909 */      Float2IntLinkedOpenHashMap.this.used[last] = false;
/*  910: 910 */      this.curr = -1;
/*  911:     */    }
/*  912:     */    
...
/*  921:     */    } }
/*  922:     */  
/*  923:     */  private class EntryIterator extends Float2IntLinkedOpenHashMap.MapIterator implements ObjectListIterator<Float2IntMap.Entry> { private Float2IntLinkedOpenHashMap.MapEntry entry;
/*  924:     */    
/*  925: 925 */    public EntryIterator() { super(null); }
/*  926:     */    
/*  927: 927 */    public EntryIterator(float from) { super(from, null); }
/*  928:     */    
/*  929:     */    public Float2IntLinkedOpenHashMap.MapEntry next() {
/*  930: 930 */      return this.entry = new Float2IntLinkedOpenHashMap.MapEntry(Float2IntLinkedOpenHashMap.this, nextEntry());
/*  931:     */    }
/*  932:     */    
/*  933: 933 */    public Float2IntLinkedOpenHashMap.MapEntry previous() { return this.entry = new Float2IntLinkedOpenHashMap.MapEntry(Float2IntLinkedOpenHashMap.this, previousEntry()); }
/*  934:     */    
/*  935:     */    public void remove()
/*  936:     */    {
/*  937: 937 */      super.remove();
/*  938: 938 */      Float2IntLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  939:     */    
/*  940: 940 */    public void set(Float2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  941: 941 */    public void add(Float2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  942:     */  }
/*  943:     */  
/*  944: 944 */  private class FastEntryIterator extends Float2IntLinkedOpenHashMap.MapIterator implements ObjectListIterator<Float2IntMap.Entry> { final AbstractFloat2IntMap.BasicEntry entry = new AbstractFloat2IntMap.BasicEntry(0.0F, 0);
/*  945: 945 */    public FastEntryIterator() { super(null); }
/*  946:     */    
/*  947: 947 */    public FastEntryIterator(float from) { super(from, null); }
/*  948:     */    
/*  949:     */    public AbstractFloat2IntMap.BasicEntry next() {
/*  950: 950 */      int e = nextEntry();
/*  951: 951 */      this.entry.key = Float2IntLinkedOpenHashMap.this.key[e];
/*  952: 952 */      this.entry.value = Float2IntLinkedOpenHashMap.this.value[e];
/*  953: 953 */      return this.entry;
/*  954:     */    }
/*  955:     */    
/*  956: 956 */    public AbstractFloat2IntMap.BasicEntry previous() { int e = previousEntry();
/*  957: 957 */      this.entry.key = Float2IntLinkedOpenHashMap.this.key[e];
/*  958: 958 */      this.entry.value = Float2IntLinkedOpenHashMap.this.value[e];
/*  959: 959 */      return this.entry; }
/*  960:     */    
/*  961: 961 */    public void set(Float2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  962: 962 */    public void add(Float2IntMap.Entry ok) { throw new UnsupportedOperationException(); } }
/*  963:     */  
/*  964:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Float2IntMap.Entry> implements Float2IntSortedMap.FastSortedEntrySet { private MapEntrySet() {}
/*  965:     */    
/*  966: 966 */    public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator() { return new Float2IntLinkedOpenHashMap.EntryIterator(Float2IntLinkedOpenHashMap.this); }
/*  967:     */    
/*  968: 968 */    public Comparator<? super Float2IntMap.Entry> comparator() { return null; }
/*  969: 969 */    public ObjectSortedSet<Float2IntMap.Entry> subSet(Float2IntMap.Entry fromElement, Float2IntMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  970: 970 */    public ObjectSortedSet<Float2IntMap.Entry> headSet(Float2IntMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  971: 971 */    public ObjectSortedSet<Float2IntMap.Entry> tailSet(Float2IntMap.Entry fromElement) { throw new UnsupportedOperationException(); }
/*  972:     */    
/*  973: 973 */    public Float2IntMap.Entry first() { if (Float2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974: 974 */      return new Float2IntLinkedOpenHashMap.MapEntry(Float2IntLinkedOpenHashMap.this, Float2IntLinkedOpenHashMap.this.first);
/*  975:     */    }
/*  976:     */    
/*  977: 977 */    public Float2IntMap.Entry last() { if (Float2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978: 978 */      return new Float2IntLinkedOpenHashMap.MapEntry(Float2IntLinkedOpenHashMap.this, Float2IntLinkedOpenHashMap.this.last);
/*  979:     */    }
/*  980:     */    
/*  981:     */    public boolean contains(Object o) {
/*  982: 982 */      if (!(o instanceof Map.Entry)) return false;
/*  983: 983 */      Map.Entry<Float, Integer> e = (Map.Entry)o;
/*  984: 984 */      float k = ((Float)e.getKey()).floatValue();
/*  985:     */      
/*  986: 986 */      int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2IntLinkedOpenHashMap.this.mask;
/*  987:     */      
/*  988: 988 */      while (Float2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  989: 989 */        if (Float2IntLinkedOpenHashMap.this.key[pos] == k) return Float2IntLinkedOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/*  990: 990 */        pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask;
/*  991:     */      }
...
/*  997: 997 */      Map.Entry<Float, Integer> e = (Map.Entry)o;
/*  998: 998 */      float k = ((Float)e.getKey()).floatValue();
/*  999:     */      
/* 1000:1000 */      int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2IntLinkedOpenHashMap.this.mask;
/* 1001:     */      
/* 1002:1002 */      while (Float2IntLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003:1003 */        if (Float2IntLinkedOpenHashMap.this.key[pos] == k) {
/* 1004:1004 */          Float2IntLinkedOpenHashMap.this.remove(e.getKey());
/* 1005:1005 */          return true;
/* 1006:     */        }
/* 1007:1007 */        pos = pos + 1 & Float2IntLinkedOpenHashMap.this.mask;
/* 1008:     */      }
/* 1009:1009 */      return false;
/* 1010:     */    }
/* 1011:     */    
/* 1012:1012 */    public int size() { return Float2IntLinkedOpenHashMap.this.size; }
/* 1013:     */    
/* 1014:     */    public void clear() {
/* 1015:1015 */      Float2IntLinkedOpenHashMap.this.clear();
/* 1016:     */    }
/* 1017:     */    
/* 1018:1018 */    public ObjectBidirectionalIterator<Float2IntMap.Entry> iterator(Float2IntMap.Entry from) { return new Float2IntLinkedOpenHashMap.EntryIterator(Float2IntLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue()); }
/* 1019:     */    
/* 1020:     */    public ObjectBidirectionalIterator<Float2IntMap.Entry> fastIterator() {
/* 1021:1021 */      return new Float2IntLinkedOpenHashMap.FastEntryIterator(Float2IntLinkedOpenHashMap.this);
/* 1022:     */    }
/* 1023:     */    
/* 1024:1024 */    public ObjectBidirectionalIterator<Float2IntMap.Entry> fastIterator(Float2IntMap.Entry from) { return new Float2IntLinkedOpenHashMap.FastEntryIterator(Float2IntLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue()); }
/* 1025:     */  }
/* 1026:     */  
/* 1027:     */  public Float2IntSortedMap.FastSortedEntrySet float2IntEntrySet() {
...
/* 1035:     */    extends Float2IntLinkedOpenHashMap.MapIterator
/* 1036:     */    implements FloatListIterator
/* 1037:     */  {
/* 1038:1038 */    public KeyIterator(float k) { super(k, null); }
/* 1039:1039 */    public float previousFloat() { return Float2IntLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1042:1042 */    public Float previous() { return Float.valueOf(Float2IntLinkedOpenHashMap.this.key[previousEntry()]); }
...
/* 1046:1046 */    public float nextFloat() { return Float2IntLinkedOpenHashMap.this.key[nextEntry()]; }
/* 1047:1047 */    public Float next() { return Float.valueOf(Float2IntLinkedOpenHashMap.this.key[nextEntry()]); } }
/* 1048:     */  
/* 1049:     */  private final class KeySet extends AbstractFloatSortedSet { private KeySet() {}
/* 1050:     */    
/* 1051:1051 */    public FloatListIterator iterator(float from) { return new Float2IntLinkedOpenHashMap.KeyIterator(Float2IntLinkedOpenHashMap.this, from); }
/* 1052:     */    
/* 1053:     */    public FloatListIterator iterator() {
/* 1054:1054 */      return new Float2IntLinkedOpenHashMap.KeyIterator(Float2IntLinkedOpenHashMap.this);
/* 1055:     */    }
/* 1056:     */    
/* 1057:1057 */    public int size() { return Float2IntLinkedOpenHashMap.this.size; }
/* 1058:     */    
/* 1060:1060 */    public boolean contains(float k) { return Float2IntLinkedOpenHashMap.this.containsKey(k); }
/* 1061:     */    
/* 1062:     */    public boolean remove(float k) {
/* 1063:1063 */      int oldSize = Float2IntLinkedOpenHashMap.this.size;
/* 1064:1064 */      Float2IntLinkedOpenHashMap.this.remove(k);
/* 1065:1065 */      return Float2IntLinkedOpenHashMap.this.size != oldSize;
/* 1066:     */    }
/* 1067:     */    
/* 1068:1068 */    public void clear() { Float2IntLinkedOpenHashMap.this.clear(); }
/* 1069:     */    
/* 1070:     */    public float firstFloat() {
/* 1071:1071 */      if (Float2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072:1072 */      return Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.first];
/* 1073:     */    }
/* 1074:     */    
/* 1075:1075 */    public float lastFloat() { if (Float2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076:1076 */      return Float2IntLinkedOpenHashMap.this.key[Float2IntLinkedOpenHashMap.this.last]; }
/* 1077:     */    
...
/* 1091:     */    extends Float2IntLinkedOpenHashMap.MapIterator
/* 1092:     */    implements IntListIterator
/* 1093:     */  {
/* 1094:1094 */    public int previousInt() { return Float2IntLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1095:1095 */    public Integer previous() { return Integer.valueOf(Float2IntLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1101:1101 */    public int nextInt() { return Float2IntLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1102:1102 */    public Integer next() { return Integer.valueOf(Float2IntLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1103:     */  }
/* 1104:     */  
...
/* 1107:1107 */          return new Float2IntLinkedOpenHashMap.ValueIterator(Float2IntLinkedOpenHashMap.this);
/* 1108:     */        }
/* 1109:     */        
/* 1110:1110 */        public int size() { return Float2IntLinkedOpenHashMap.this.size; }
/* 1111:     */        
/* 1112:     */        public boolean contains(int v) {
/* 1113:1113 */          return Float2IntLinkedOpenHashMap.this.containsValue(v);
/* 1114:     */        }
/* 1115:     */        
/* 1116:1116 */        public void clear() { Float2IntLinkedOpenHashMap.this.clear(); }
/* 1117:     */      };
/* 1118:     */    }
...
/* 1238:     */  }
/* 1239:     */  
/* 1242:     */  public Float2IntLinkedOpenHashMap clone()
/* 1243:     */  {
/* 1244:     */    Float2IntLinkedOpenHashMap c;
/* 1245:     */    
/* 1247:     */    try
/* 1248:     */    {
/* 1249:1249 */      c = (Float2IntLinkedOpenHashMap)super.clone();
/* 1250:     */    }
