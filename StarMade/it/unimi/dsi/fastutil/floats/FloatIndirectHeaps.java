...
/*   4:    */
/*  63:    */public class FloatIndirectHeaps
/*  64:    */{
/*  65:    */  public static int downHeap(float[] refArray, int[] heap, int[] inv, int size, int i, FloatComparator c)
/*  66:    */  {
/*  67: 67 */    if (i >= size) throw new IllegalArgumentException("Heap position (" + i + ") is larger than or equal to heap size (" + size + ")");
/*  68: 68 */    int e = heap[i];
/*  69: 69 */    float E = refArray[e];
/*  70:    */    
...
/*  90:    */  }
/*  91:    */  
/* 103:    */  public static int upHeap(float[] refArray, int[] heap, int[] inv, int size, int i, FloatComparator c)
/* 104:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 135:    */  public static void makeHeap(float[] refArray, int offset, int length, int[] heap, int[] inv, FloatComparator c)
/* 136:    */  {
/* 137:137 */    FloatArrays.ensureOffsetLength(refArray, offset, length);
