...
/*  18:    */
/*  87:    */public class Float2ByteOpenHashMap
/*  88:    */  extends AbstractFloat2ByteMap
...
/* 101:    */  protected volatile transient Float2ByteMap.FastEntrySet entries;
/* 102:    */  protected volatile transient FloatSet keys;
/* 103:    */  protected volatile transient ByteCollection values;
/* 104:    */  
/* 105:    */  public Float2ByteOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Float2ByteOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Float2ByteOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Float2ByteOpenHashMap(Map<? extends Float, ? extends Byte> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Float2ByteOpenHashMap(Map<? extends Float, ? extends Byte> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Float2ByteOpenHashMap(Float2ByteMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Float2ByteOpenHashMap(Float2ByteMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Float2ByteOpenHashMap(float[] k, byte[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Float2ByteOpenHashMap(float[] k, byte[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public byte put(float k, byte v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Byte put(Float ok, Byte ov) { byte v = ov.byteValue();
...
/* 226:    */  }
/* 227:    */  
/* 238:    */  public byte add(float k, byte incr)
/* 239:    */  {
...
/* 245:245 */          tmp46_45 = pos; byte[] tmp46_42 = this.value;tmp46_42[tmp46_45] = ((byte)(tmp46_42[tmp46_45] + incr));
...
/* 279:    */  }
/* 280:    */  
/* 281:    */  public byte remove(float k)
/* 282:    */  {
...
/* 312:    */  }
/* 313:    */  
/* 314:314 */  public Byte get(Float ok) { float k = ok.floatValue();
/* 315:    */    
...
/* 389:    */    implements Float2ByteMap.Entry, Map.Entry<Float, Byte>
/* 390:    */  {
...
/* 396:    */    }
/* 397:    */    
/* 398:398 */    public Float getKey() { return Float.valueOf(Float2ByteOpenHashMap.this.key[this.index]); }
/* 399:    */    
/* 400:    */    public float getFloatKey() {
/* 401:401 */      return Float2ByteOpenHashMap.this.key[this.index];
/* 402:    */    }
/* 403:    */    
/* 404:404 */    public Byte getValue() { return Byte.valueOf(Float2ByteOpenHashMap.this.value[this.index]); }
/* 405:    */    
/* 407:407 */    public byte getByteValue() { return Float2ByteOpenHashMap.this.value[this.index]; }
/* 408:    */    
/* 409:    */    public byte setValue(byte v) {
/* 410:410 */      byte oldValue = Float2ByteOpenHashMap.this.value[this.index];
/* 411:411 */      Float2ByteOpenHashMap.this.value[this.index] = v;
...
/* 420:420 */      Map.Entry<Float, Byte> e = (Map.Entry)o;
/* 421:421 */      return (Float2ByteOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public int hashCode() { return HashCommon.float2int(Float2ByteOpenHashMap.this.key[this.index]) ^ Float2ByteOpenHashMap.this.value[this.index]; }
/* 425:    */    
/* 427:427 */    public String toString() { return Float2ByteOpenHashMap.this.key[this.index] + "=>" + Float2ByteOpenHashMap.this.value[this.index]; } }
/* 428:    */  
...
/* 433:    */    
/* 434:434 */    private MapIterator() { this.pos = Float2ByteOpenHashMap.this.n;
/* 435:    */      
/* 437:437 */      this.last = -1;
/* 438:    */      
/* 439:439 */      this.c = Float2ByteOpenHashMap.this.size;
/* 440:    */      
/* 444:444 */      boolean[] used = Float2ByteOpenHashMap.this.used;
...
/* 456:    */        
/* 457:457 */        int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ByteOpenHashMap.this.mask;
/* 458:    */        
/* 459:459 */        while (Float2ByteOpenHashMap.this.used[pos] != 0) {
/* 460:460 */          if (Float2ByteOpenHashMap.this.key[pos] == k) return pos;
/* 461:461 */          pos = pos + 1 & Float2ByteOpenHashMap.this.mask;
/* 462:    */        }
/* 463:    */      }
/* 464:464 */      this.last = this.pos;
/* 465:    */      
/* 466:466 */      if (this.c != 0) {
/* 467:467 */        boolean[] used = Float2ByteOpenHashMap.this.used;
...
/* 482:    */      for (;;)
/* 483:    */      {
/* 484:484 */        pos = (last = pos) + 1 & Float2ByteOpenHashMap.this.mask;
/* 485:485 */        while (Float2ByteOpenHashMap.this.used[pos] != 0) {
/* 486:486 */          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ByteOpenHashMap.this.key[pos])) & Float2ByteOpenHashMap.this.mask;
/* 487:487 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488:488 */          pos = pos + 1 & Float2ByteOpenHashMap.this.mask;
/* 489:    */        }
/* 490:490 */        if (Float2ByteOpenHashMap.this.used[pos] == 0) break;
/* 491:491 */        if (pos < last)
/* 492:    */        {
/* 493:493 */          if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 494:494 */          this.wrapped.add(Float2ByteOpenHashMap.this.key[pos]);
/* 495:    */        }
/* 496:496 */        Float2ByteOpenHashMap.this.key[last] = Float2ByteOpenHashMap.this.key[pos];
/* 497:497 */        Float2ByteOpenHashMap.this.value[last] = Float2ByteOpenHashMap.this.value[pos];
/* 498:    */      }
/* 499:499 */      Float2ByteOpenHashMap.this.used[last] = false;
/* 500:500 */      return last;
/* 501:    */    }
/* 502:    */    
...
/* 506:    */      {
/* 507:507 */        Float2ByteOpenHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 508:508 */        this.last = -1;
/* 509:509 */        return;
/* 510:    */      }
/* 511:511 */      Float2ByteOpenHashMap.this.size -= 1;
...
/* 523:    */    } }
/* 524:    */  
/* 525:525 */  private class EntryIterator extends Float2ByteOpenHashMap.MapIterator implements ObjectIterator<Float2ByteMap.Entry> { private EntryIterator() { super(null); }
/* 526:    */    
/* 527:    */    private Float2ByteOpenHashMap.MapEntry entry;
/* 528:528 */    public Float2ByteMap.Entry next() { return this.entry = new Float2ByteOpenHashMap.MapEntry(Float2ByteOpenHashMap.this, nextEntry()); }
/* 529:    */    
/* 530:    */    public void remove()
/* 531:    */    {
/* 532:532 */      super.remove();
/* 533:533 */      Float2ByteOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 534:    */    } }
/* 535:    */  
/* 536:536 */  private class FastEntryIterator extends Float2ByteOpenHashMap.MapIterator implements ObjectIterator<Float2ByteMap.Entry> { private FastEntryIterator() { super(null); }
/* 537:537 */    final AbstractFloat2ByteMap.BasicEntry entry = new AbstractFloat2ByteMap.BasicEntry(0.0F, (byte)0);
/* 538:    */    
/* 539:539 */    public AbstractFloat2ByteMap.BasicEntry next() { int e = nextEntry();
/* 540:540 */      this.entry.key = Float2ByteOpenHashMap.this.key[e];
/* 541:541 */      this.entry.value = Float2ByteOpenHashMap.this.value[e];
/* 542:542 */      return this.entry;
/* 543:    */    } }
/* 544:    */  
/* 545:    */  private final class MapEntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteMap.FastEntrySet { private MapEntrySet() {}
/* 546:    */    
/* 547:547 */    public ObjectIterator<Float2ByteMap.Entry> iterator() { return new Float2ByteOpenHashMap.EntryIterator(Float2ByteOpenHashMap.this, null); }
/* 548:    */    
/* 549:    */    public ObjectIterator<Float2ByteMap.Entry> fastIterator() {
/* 550:550 */      return new Float2ByteOpenHashMap.FastEntryIterator(Float2ByteOpenHashMap.this, null);
/* 551:    */    }
/* 552:    */    
/* 553:    */    public boolean contains(Object o) {
/* 554:554 */      if (!(o instanceof Map.Entry)) return false;
/* 555:555 */      Map.Entry<Float, Byte> e = (Map.Entry)o;
/* 556:556 */      float k = ((Float)e.getKey()).floatValue();
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ByteOpenHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Float2ByteOpenHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Float2ByteOpenHashMap.this.key[pos] == k) return Float2ByteOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 562:562 */        pos = pos + 1 & Float2ByteOpenHashMap.this.mask;
/* 563:    */      }
...
/* 569:569 */      Map.Entry<Float, Byte> e = (Map.Entry)o;
/* 570:570 */      float k = ((Float)e.getKey()).floatValue();
/* 571:    */      
/* 572:572 */      int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ByteOpenHashMap.this.mask;
/* 573:    */      
/* 574:574 */      while (Float2ByteOpenHashMap.this.used[pos] != 0) {
/* 575:575 */        if (Float2ByteOpenHashMap.this.key[pos] == k) {
/* 576:576 */          Float2ByteOpenHashMap.this.remove(e.getKey());
/* 577:577 */          return true;
/* 578:    */        }
/* 579:579 */        pos = pos + 1 & Float2ByteOpenHashMap.this.mask;
/* 580:    */      }
/* 581:581 */      return false;
/* 582:    */    }
/* 583:    */    
/* 584:584 */    public int size() { return Float2ByteOpenHashMap.this.size; }
/* 585:    */    
/* 587:587 */    public void clear() { Float2ByteOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public Float2ByteMap.FastEntrySet float2ByteEntrySet() {
...
/* 598:    */    extends Float2ByteOpenHashMap.MapIterator
/* 599:    */    implements FloatIterator
/* 600:    */  {
/* 601:601 */    public KeyIterator() { super(null); }
/* 602:602 */    public float nextFloat() { return Float2ByteOpenHashMap.this.key[nextEntry()]; }
/* 603:603 */    public Float next() { return Float.valueOf(Float2ByteOpenHashMap.this.key[nextEntry()]); } }
/* 604:    */  
/* 605:    */  private final class KeySet extends AbstractFloatSet { private KeySet() {}
/* 606:    */    
/* 607:607 */    public FloatIterator iterator() { return new Float2ByteOpenHashMap.KeyIterator(Float2ByteOpenHashMap.this); }
/* 608:    */    
/* 609:    */    public int size() {
/* 610:610 */      return Float2ByteOpenHashMap.this.size;
/* 611:    */    }
/* 612:    */    
/* 613:613 */    public boolean contains(float k) { return Float2ByteOpenHashMap.this.containsKey(k); }
/* 614:    */    
/* 615:    */    public boolean remove(float k) {
/* 616:616 */      int oldSize = Float2ByteOpenHashMap.this.size;
/* 617:617 */      Float2ByteOpenHashMap.this.remove(k);
/* 618:618 */      return Float2ByteOpenHashMap.this.size != oldSize;
/* 619:    */    }
/* 620:    */    
/* 621:621 */    public void clear() { Float2ByteOpenHashMap.this.clear(); }
/* 622:    */  }
/* 623:    */  
...
/* 632:    */    extends Float2ByteOpenHashMap.MapIterator
/* 633:    */    implements ByteIterator
/* 634:    */  {
/* 635:635 */    public ValueIterator() { super(null); }
/* 636:636 */    public byte nextByte() { return Float2ByteOpenHashMap.this.value[nextEntry()]; }
/* 637:637 */    public Byte next() { return Byte.valueOf(Float2ByteOpenHashMap.this.value[nextEntry()]); }
/* 638:    */  }
/* 639:    */  
...
/* 642:642 */          return new Float2ByteOpenHashMap.ValueIterator(Float2ByteOpenHashMap.this);
/* 643:    */        }
/* 644:    */        
/* 645:645 */        public int size() { return Float2ByteOpenHashMap.this.size; }
/* 646:    */        
/* 647:    */        public boolean contains(byte v) {
/* 648:648 */          return Float2ByteOpenHashMap.this.containsValue(v);
/* 649:    */        }
/* 650:    */        
/* 651:651 */        public void clear() { Float2ByteOpenHashMap.this.clear(); }
/* 652:    */      };
/* 653:    */    }
...
/* 754:    */  }
/* 755:    */  
/* 759:    */  public Float2ByteOpenHashMap clone()
/* 760:    */  {
/* 761:    */    Float2ByteOpenHashMap c;
/* 762:    */    
/* 764:    */    try
/* 765:    */    {
/* 766:766 */      c = (Float2ByteOpenHashMap)super.clone();
/* 767:    */    }
