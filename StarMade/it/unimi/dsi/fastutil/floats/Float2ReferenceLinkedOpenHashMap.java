  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2ReferenceLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2ReferenceLinkedOpenHashMap(Map<? extends Float, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2ReferenceLinkedOpenHashMap(Map<? extends Float, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2ReferenceLinkedOpenHashMap(Float2ReferenceMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2ReferenceLinkedOpenHashMap(Float2ReferenceMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2ReferenceLinkedOpenHashMap(float[] local_k, V[] local_v, float local_f)
  {
  ...
  public Float2ReferenceLinkedOpenHashMap(float[] local_k, V[] local_v)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Float2ReferenceLinkedOpenHashMap.ValueIterator(Float2ReferenceLinkedOpenHashMap.this);
        }
        ...
        {
          return Float2ReferenceLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2ReferenceLinkedOpenHashMap<V> local_c;
    try
    {
      local_c = (Float2ReferenceLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    float[] key = this.key;
    V[] value = this.value;
    Float2ReferenceLinkedOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractFloatSortedSet
  {
    ...
    {
      return new Float2ReferenceLinkedOpenHashMap.KeyIterator(Float2ReferenceLinkedOpenHashMap.this, from);
    }
    
    public FloatListIterator iterator()
    {
      return new Float2ReferenceLinkedOpenHashMap.KeyIterator(Float2ReferenceLinkedOpenHashMap.this);
    }
    ...
    {
      return Float2ReferenceLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2ReferenceLinkedOpenHashMap.this.size;
      Float2ReferenceLinkedOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Float2ReferenceLinkedOpenHashMap.MapIterator
    implements FloatListIterator
  {
    ...
    {
      return Float.valueOf(Float2ReferenceLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Float2ReferenceLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2ReferenceSortedMap.FastSortedEntrySet<V>
  {
    ...
    {
      return new Float2ReferenceLinkedOpenHashMap.EntryIterator(Float2ReferenceLinkedOpenHashMap.this);
    }
    ...
    public Float2ReferenceMap.Entry<V> first()
    {
      ...
      return new Float2ReferenceLinkedOpenHashMap.MapEntry(Float2ReferenceLinkedOpenHashMap.this, Float2ReferenceLinkedOpenHashMap.this.first);
    }
    ...
    public Float2ReferenceMap.Entry<V> last()
    {
      ...
      return new Float2ReferenceLinkedOpenHashMap.MapEntry(Float2ReferenceLinkedOpenHashMap.this, Float2ReferenceLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2ReferenceLinkedOpenHashMap.this.mask; Float2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ReferenceLinkedOpenHashMap.this.mask) {
        if (Float2ReferenceLinkedOpenHashMap.this.key[pos] == local_k) {
          return Float2ReferenceLinkedOpenHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2ReferenceLinkedOpenHashMap.this.mask; Float2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ReferenceLinkedOpenHashMap.this.mask) {
        if (Float2ReferenceLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Float2ReferenceLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Float2ReferenceLinkedOpenHashMap.EntryIterator(Float2ReferenceLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
    
    public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> fastIterator()
    {
      return new Float2ReferenceLinkedOpenHashMap.FastEntryIterator(Float2ReferenceLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Float2ReferenceMap.Entry<V>> fastIterator(Float2ReferenceMap.Entry<V> from)
    {
      return new Float2ReferenceLinkedOpenHashMap.FastEntryIterator(Float2ReferenceLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
  }
    ...
    implements ObjectListIterator<Float2ReferenceMap.Entry<V>>
  {
    ...
    public AbstractFloat2ReferenceMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Float2ReferenceLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Float2ReferenceLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Float2ReferenceMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Float2ReferenceLinkedOpenHashMap.MapEntry(Float2ReferenceLinkedOpenHashMap.this, nextEntry());
    }
    
    public Float2ReferenceLinkedOpenHashMap<V>.MapEntry previous()
    {
      return this.entry = new Float2ReferenceLinkedOpenHashMap.MapEntry(Float2ReferenceLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    {
      if (Float2ReferenceLinkedOpenHashMap.this.key[Float2ReferenceLinkedOpenHashMap.this.last] == from)
      {
      ...
      {
        for (int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2ReferenceLinkedOpenHashMap.this.mask; Float2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ReferenceLinkedOpenHashMap.this.mask) {
          if (Float2ReferenceLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Float2ReferenceLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Float2ReferenceLinkedOpenHashMap.this.first = this.next;
      } else {
        Float2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Float2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Float2ReferenceLinkedOpenHashMap.this.last = this.prev;
      } else {
        Float2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Float2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2ReferenceLinkedOpenHashMap.this.mask; Float2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ReferenceLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ReferenceLinkedOpenHashMap.this.key[pos])) & Float2ReferenceLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2ReferenceLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Float2ReferenceLinkedOpenHashMap.this.key[last] = Float2ReferenceLinkedOpenHashMap.this.key[pos];
      ...
      Float2ReferenceLinkedOpenHashMap.this.used[last] = false;
    ...
    implements Float2ReferenceMap.Entry<V>, Map.Entry<Float, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Float2ReferenceLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, V> local_e = (Map.Entry)local_o;
      return (Float2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2ReferenceLinkedOpenHashMap.this.value[this.index] == local_e.getValue());
    }
