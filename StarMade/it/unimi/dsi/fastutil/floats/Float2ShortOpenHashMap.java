...
/* 642 */           return new Float2ShortOpenHashMap.ValueIterator(Float2ShortOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Float2ShortOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(short v) {
/* 648 */           return Float2ShortOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Float2ShortOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Float2ShortOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Float2ShortOpenHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public short nextShort() { return Float2ShortOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Short next() { return Short.valueOf(Float2ShortOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Float2ShortOpenHashMap.KeyIterator(Float2ShortOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Float2ShortOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(float k) {
/* 613 */       return Float2ShortOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(float k) {
/* 616 */       int oldSize = Float2ShortOpenHashMap.this.size;
/* 617 */       Float2ShortOpenHashMap.this.remove(k);
/* 618 */       return Float2ShortOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Float2ShortOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Float2ShortOpenHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public float nextFloat() { return Float2ShortOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Float next() { return Float.valueOf(Float2ShortOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Float2ShortOpenHashMap.EntryIterator(Float2ShortOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Float2ShortMap.Entry> fastIterator() {
/* 550 */       return new Float2ShortOpenHashMap.FastEntryIterator(Float2ShortOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ShortOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Float2ShortOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Float2ShortOpenHashMap.this.key[pos] == k) return Float2ShortOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 562 */         pos = pos + 1 & Float2ShortOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ShortOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Float2ShortOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Float2ShortOpenHashMap.this.key[pos] == k) {
/* 576 */           Float2ShortOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Float2ShortOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Float2ShortOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Float2ShortOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Float2ShortOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Float2ShortMap.Entry>
/*     */   {
/* 537 */     final AbstractFloat2ShortMap.BasicEntry entry = new AbstractFloat2ShortMap.BasicEntry(0.0F, (short)0);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Float2ShortOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Float2ShortOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Float2ShortOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Float2ShortMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Float2ShortOpenHashMap.MapEntry(Float2ShortOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Float2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Float2ShortOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Float2ShortOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Float2ShortOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ShortOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Float2ShortOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Float2ShortOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Float2ShortOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Float2ShortOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Float2ShortOpenHashMap.this.mask;
/* 485 */         while (Float2ShortOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ShortOpenHashMap.this.key[pos])) & Float2ShortOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Float2ShortOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Float2ShortOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 494 */           this.wrapped.add(Float2ShortOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Float2ShortOpenHashMap.this.key[last] = Float2ShortOpenHashMap.this.key[pos];
/* 497 */         Float2ShortOpenHashMap.this.value[last] = Float2ShortOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Float2ShortOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Float2ShortOpenHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Float2ShortOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Float getKey() {
/* 398 */       return Float.valueOf(Float2ShortOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public float getFloatKey() {
/* 401 */       return Float2ShortOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Short getValue() {
/* 404 */       return Short.valueOf(Float2ShortOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public short getShortValue() {
/* 407 */       return Float2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public short setValue(short v) {
/* 410 */       short oldValue = Float2ShortOpenHashMap.this.value[this.index];
/* 411 */       Float2ShortOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Short setValue(Short v) {
...
/* 421 */       return (Float2ShortOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2ShortOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return HashCommon.float2int(Float2ShortOpenHashMap.this.key[this.index]) ^ Float2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 427 */       return Float2ShortOpenHashMap.this.key[this.index] + "=>" + Float2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
