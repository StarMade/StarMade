  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2ShortOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2ShortOpenHashMap(Map<? extends Float, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2ShortOpenHashMap(Map<? extends Float, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2ShortOpenHashMap(Float2ShortMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2ShortOpenHashMap(Float2ShortMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2ShortOpenHashMap(float[] local_k, short[] local_v, float local_f)
  {
  ...
  public Float2ShortOpenHashMap(float[] local_k, short[] local_v)
  {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Float2ShortOpenHashMap.ValueIterator(Float2ShortOpenHashMap.this);
        }
        ...
        {
          return Float2ShortOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2ShortOpenHashMap local_c;
    try
    {
      local_c = (Float2ShortOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Float2ShortOpenHashMap.MapIterator
    ...
    extends AbstractFloatSet
  {
    ...
    {
      return new Float2ShortOpenHashMap.KeyIterator(Float2ShortOpenHashMap.this);
    }
    ...
    {
      return Float2ShortOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2ShortOpenHashMap.this.size;
      Float2ShortOpenHashMap.this.remove(local_k);
    ...
    implements Float2ShortMap.FastEntrySet
  {
    ...
    {
      return new Float2ShortOpenHashMap.EntryIterator(Float2ShortOpenHashMap.this, null);
    }
    
    public ObjectIterator<Float2ShortMap.Entry> fastIterator()
    {
      return new Float2ShortOpenHashMap.FastEntryIterator(Float2ShortOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2ShortOpenHashMap.this.mask; Float2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ShortOpenHashMap.this.mask) {
        if (Float2ShortOpenHashMap.this.key[pos] == local_k) {
          return Float2ShortOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2ShortOpenHashMap.this.mask; Float2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ShortOpenHashMap.this.mask) {
        if (Float2ShortOpenHashMap.this.key[pos] == local_k)
        {
          Float2ShortOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Float2ShortMap.Entry>
  {
    ...
    public AbstractFloat2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2ShortOpenHashMap.this.key[local_e];
      this.entry.value = Float2ShortOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Float2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Float2ShortOpenHashMap.MapEntry(Float2ShortOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Float2ShortOpenHashMap.this.field_49;
    int last = -1;
    int field_1819 = Float2ShortOpenHashMap.this.size;
    FloatArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Float2ShortOpenHashMap.this.used;
      while ((this.field_1819 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1819 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1819 != 0)
      {
        boolean[] local_k = Float2ShortOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2ShortOpenHashMap.this.mask; Float2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ShortOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ShortOpenHashMap.this.key[pos])) & Float2ShortOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2ShortOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Float2ShortOpenHashMap.this.key[pos]);
        }
        Float2ShortOpenHashMap.this.key[last] = Float2ShortOpenHashMap.this.key[pos];
        Float2ShortOpenHashMap.this.value[last] = Float2ShortOpenHashMap.this.value[pos];
      }
      Float2ShortOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      Float2ShortOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1819 > 0))
      {
        this.field_1819 += 1;
        nextEntry();
      }
    ...
    implements Float2ShortMap.Entry, Map.Entry<Float, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Float2ShortOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Short> local_e = (Map.Entry)local_o;
      return (Float2ShortOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2ShortOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
