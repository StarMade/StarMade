...
/*     */   {
/* 173 */     return new Singleton(key.floatValue(), value.byteValue());
/*     */   }
/*     */ 
/*     */   public static Float2ByteSortedMap singleton(Float key, Byte value, FloatComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.floatValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */   public static Float2ByteSortedMap singleton(float key, byte value)
/*     */   {
...
/*     */     }
/* 302 */     public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.float2ByteEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, Byte>> entrySet() {
/* 304 */       return float2ByteEntrySet(); } 
...
/* 308 */     public Float2ByteSortedMap headMap(float to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Float2ByteSortedMap tailMap(float from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Float2ByteSortedMap headMap(Float to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Float2ByteSortedMap tailMap(Float from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.float2ByteEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, Byte>> entrySet() {
/* 244 */       return float2ByteEntrySet(); } 
...
/* 248 */     public Float2ByteSortedMap headMap(float to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Float2ByteSortedMap tailMap(float from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public float firstFloatKey() {
...
/* 259 */     public Float2ByteSortedMap headMap(Float to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Float2ByteSortedMap tailMap(Float from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Float2ByteMaps.Singleton.SingletonEntry(this), Float2ByteSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Float, Byte>> entrySet() { return float2ByteEntrySet(); } 
/*     */     public FloatSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = FloatSortedSets.singleton(this.key, this.comparator); return (FloatSortedSet)this.keys;
/*     */     }
/*     */     public Float2ByteSortedMap subMap(float from, float to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Float2ByteSortedMap headMap(float to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Float2ByteSortedMap tailMap(float from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Float2ByteSortedMap tailMap(Float ofrom) { return tailMap(ofrom.floatValue()); } 
/* 156 */     public Float2ByteSortedMap subMap(Float ofrom, Float oto) { return subMap(ofrom.floatValue(), oto.floatValue()); } 
/*     */     public Float firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Float2ByteMap.Entry> float2ByteEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, Byte>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public FloatSortedSet keySet() { return FloatSortedSets.EMPTY_SET; } 
/*     */     public Float2ByteSortedMap subMap(float from, float to) {
/*  86 */       return Float2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Float2ByteSortedMap headMap(float to) { return Float2ByteSortedMaps.EMPTY_MAP; } 
/*     */     public Float2ByteSortedMap tailMap(float from) {
/*  90 */       return Float2ByteSortedMaps.EMPTY_MAP; } 
...
/*  93 */     public Float2ByteSortedMap headMap(Float oto) { return headMap(oto.floatValue()); } 
/*  94 */     public Float2ByteSortedMap tailMap(Float ofrom) { return tailMap(ofrom.floatValue()); } 
/*  95 */     public Float2ByteSortedMap subMap(Float ofrom, Float oto) { return subMap(ofrom.floatValue(), oto.floatValue()); } 
