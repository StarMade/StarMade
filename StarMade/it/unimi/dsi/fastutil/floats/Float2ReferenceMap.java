...
public abstract interface Float2ReferenceMap<V> extends Float2ReferenceFunction<V>, Map<Float, V>
{
  ...
  public static abstract interface Entry<V> extends Map.Entry<Float, V>
  {
    public abstract float getFloatKey();
  }

  public static abstract interface FastEntrySet<V> extends ObjectSet<Float2ReferenceMap.Entry<V>>
  {
