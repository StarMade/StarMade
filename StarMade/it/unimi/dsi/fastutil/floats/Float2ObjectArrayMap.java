...
/*  17:    */
/*  65:    */public class Float2ObjectArrayMap<V>
/*  66:    */  extends AbstractFloat2ObjectMap<V>
...
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Float2ObjectArrayMap(float[] key, Object[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Float2ObjectArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = FloatArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = ObjectArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Float2ObjectArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new float[capacity];
/*  93: 93 */    this.value = new Object[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Float2ObjectArrayMap(Float2ObjectMap<V> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Float2ObjectArrayMap(Map<? extends Float, ? extends V> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Float2ObjectArrayMap(float[] key, Object[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Float2ObjectMap.Entry<V>> implements Float2ObjectMap.FastEntrySet<V> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Float2ObjectMap.Entry<V>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Float2ObjectArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Float2ObjectMap.Entry<V> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractFloat2ObjectMap.BasicEntry(Float2ObjectArrayMap.this.key[this.next], Float2ObjectArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Float2ObjectMap.Entry<V>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractFloat2ObjectMap.BasicEntry<V> entry = new AbstractFloat2ObjectMap.BasicEntry(0.0F, null);
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Float2ObjectArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Float2ObjectMap.Entry<V> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Float2ObjectArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Float2ObjectArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Float2ObjectArrayMap.this.size; }
/* 159:    */    
...
/* 165:165 */      return (Float2ObjectArrayMap.this.containsKey(k)) && (Float2ObjectArrayMap.this.get(k) == null ? e.getValue() == null : Float2ObjectArrayMap.this.get(k).equals(e.getValue()));
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Float2ObjectMap.FastEntrySet<V> float2ObjectEntrySet() { return new EntrySet(null); }
/* 170:    */  
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Float2ObjectArrayMap<V> clone()
/* 293:    */  {
/* 294:    */    Float2ObjectArrayMap<V> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Float2ObjectArrayMap)super.clone();
/* 301:    */    }
