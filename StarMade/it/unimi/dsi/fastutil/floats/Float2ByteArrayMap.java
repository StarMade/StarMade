...
/*  17:    */
/*  66:    */public class Float2ByteArrayMap
/*  67:    */  extends AbstractFloat2ByteMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Float2ByteArrayMap(float[] key, byte[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Float2ByteArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = FloatArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = ByteArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Float2ByteArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new float[capacity];
/*  94: 94 */    this.value = new byte[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Float2ByteArrayMap(Float2ByteMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Float2ByteArrayMap(Map<? extends Float, ? extends Byte> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Float2ByteArrayMap(float[] key, byte[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Float2ByteMap.Entry> implements Float2ByteMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Float2ByteMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Float2ByteArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Float2ByteMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractFloat2ByteMap.BasicEntry(Float2ByteArrayMap.this.key[this.next], Float2ByteArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Float2ByteMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractFloat2ByteMap.BasicEntry entry = new AbstractFloat2ByteMap.BasicEntry(0.0F, (byte)0);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Float2ByteArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Float2ByteMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Float2ByteArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Float2ByteArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Float2ByteArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Float, Byte> e = (Map.Entry)o;
/* 165:165 */      float k = ((Float)e.getKey()).floatValue();
/* 166:166 */      return (Float2ByteArrayMap.this.containsKey(k)) && (Float2ByteArrayMap.this.get(k) == ((Byte)e.getValue()).byteValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Float2ByteMap.FastEntrySet float2ByteEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public byte put(float k, byte v)
/* 213:    */  {
...
/* 234:    */  }
/* 235:    */  
/* 236:    */  public byte remove(float k)
/* 237:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Float2ByteArrayMap clone()
/* 263:    */  {
/* 264:    */    Float2ByteArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Float2ByteArrayMap)super.clone();
/* 270:    */    }
