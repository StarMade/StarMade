...
/*  18:    */
/*  90:    */public class Float2CharOpenCustomHashMap
/*  91:    */  extends AbstractFloat2CharMap
...
/* 104:    */  protected volatile transient Float2CharMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Float2CharOpenCustomHashMap(int expected, float f, FloatHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Float2CharOpenCustomHashMap(int expected, FloatHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Float2CharOpenCustomHashMap(FloatHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Float2CharOpenCustomHashMap(Map<? extends Float, ? extends Character> m, float f, FloatHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Float2CharOpenCustomHashMap(Map<? extends Float, ? extends Character> m, FloatHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Float2CharOpenCustomHashMap(Float2CharMap m, float f, FloatHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Float2CharOpenCustomHashMap(Float2CharMap m, FloatHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Float2CharOpenCustomHashMap(float[] k, char[] v, float f, FloatHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Float2CharOpenCustomHashMap(float[] k, char[] v, FloatHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public char put(float k, char v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Character put(Float ok, Character ov) { char v = ov.charValue();
...
/* 269:    */  }
/* 270:    */  
/* 271:    */  public char remove(float k)
/* 272:    */  {
...
/* 302:    */  }
/* 303:    */  
/* 304:304 */  public Character get(Float ok) { float k = ok.floatValue();
/* 305:    */    
...
/* 379:    */    implements Float2CharMap.Entry, Map.Entry<Float, Character>
/* 380:    */  {
...
/* 386:    */    }
/* 387:    */    
/* 388:388 */    public Float getKey() { return Float.valueOf(Float2CharOpenCustomHashMap.this.key[this.index]); }
/* 389:    */    
/* 390:    */    public float getFloatKey() {
/* 391:391 */      return Float2CharOpenCustomHashMap.this.key[this.index];
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public Character getValue() { return Character.valueOf(Float2CharOpenCustomHashMap.this.value[this.index]); }
/* 395:    */    
/* 397:397 */    public char getCharValue() { return Float2CharOpenCustomHashMap.this.value[this.index]; }
/* 398:    */    
/* 399:    */    public char setValue(char v) {
/* 400:400 */      char oldValue = Float2CharOpenCustomHashMap.this.value[this.index];
/* 401:401 */      Float2CharOpenCustomHashMap.this.value[this.index] = v;
...
/* 410:410 */      Map.Entry<Float, Character> e = (Map.Entry)o;
/* 411:411 */      return (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue())) && (Float2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 412:    */    }
/* 413:    */    
/* 414:414 */    public int hashCode() { return Float2CharOpenCustomHashMap.this.strategy.hashCode(Float2CharOpenCustomHashMap.this.key[this.index]) ^ Float2CharOpenCustomHashMap.this.value[this.index]; }
/* 415:    */    
/* 417:417 */    public String toString() { return Float2CharOpenCustomHashMap.this.key[this.index] + "=>" + Float2CharOpenCustomHashMap.this.value[this.index]; } }
/* 418:    */  
...
/* 423:    */    
/* 424:424 */    private MapIterator() { this.pos = Float2CharOpenCustomHashMap.this.n;
/* 425:    */      
/* 427:427 */      this.last = -1;
/* 428:    */      
/* 429:429 */      this.c = Float2CharOpenCustomHashMap.this.size;
/* 430:    */      
/* 434:434 */      boolean[] used = Float2CharOpenCustomHashMap.this.used;
...
/* 446:    */        
/* 447:447 */        int pos = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Float2CharOpenCustomHashMap.this.mask;
/* 448:    */        
/* 449:449 */        while (Float2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 450:450 */          if (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[pos], k)) return pos;
/* 451:451 */          pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask;
/* 452:    */        }
/* 453:    */      }
/* 454:454 */      this.last = this.pos;
/* 455:    */      
/* 456:456 */      if (this.c != 0) {
/* 457:457 */        boolean[] used = Float2CharOpenCustomHashMap.this.used;
...
/* 472:    */      for (;;)
/* 473:    */      {
/* 474:474 */        pos = (last = pos) + 1 & Float2CharOpenCustomHashMap.this.mask;
/* 475:475 */        while (Float2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 476:476 */          int slot = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(Float2CharOpenCustomHashMap.this.key[pos])) & Float2CharOpenCustomHashMap.this.mask;
/* 477:477 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 478:478 */          pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask;
/* 479:    */        }
/* 480:480 */        if (Float2CharOpenCustomHashMap.this.used[pos] == 0) break;
/* 481:481 */        if (pos < last)
/* 482:    */        {
/* 483:483 */          if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 484:484 */          this.wrapped.add(Float2CharOpenCustomHashMap.this.key[pos]);
/* 485:    */        }
/* 486:486 */        Float2CharOpenCustomHashMap.this.key[last] = Float2CharOpenCustomHashMap.this.key[pos];
/* 487:487 */        Float2CharOpenCustomHashMap.this.value[last] = Float2CharOpenCustomHashMap.this.value[pos];
/* 488:    */      }
/* 489:489 */      Float2CharOpenCustomHashMap.this.used[last] = false;
/* 490:490 */      return last;
/* 491:    */    }
/* 492:    */    
...
/* 496:    */      {
/* 497:497 */        Float2CharOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 498:498 */        this.last = -1;
/* 499:499 */        return;
/* 500:    */      }
/* 501:501 */      Float2CharOpenCustomHashMap.this.size -= 1;
...
/* 513:    */    } }
/* 514:    */  
/* 515:515 */  private class EntryIterator extends Float2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Float2CharMap.Entry> { private EntryIterator() { super(null); }
/* 516:    */    
/* 517:    */    private Float2CharOpenCustomHashMap.MapEntry entry;
/* 518:518 */    public Float2CharMap.Entry next() { return this.entry = new Float2CharOpenCustomHashMap.MapEntry(Float2CharOpenCustomHashMap.this, nextEntry()); }
/* 519:    */    
/* 520:    */    public void remove()
/* 521:    */    {
/* 522:522 */      super.remove();
/* 523:523 */      Float2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 524:    */    } }
/* 525:    */  
/* 526:526 */  private class FastEntryIterator extends Float2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Float2CharMap.Entry> { private FastEntryIterator() { super(null); }
/* 527:527 */    final AbstractFloat2CharMap.BasicEntry entry = new AbstractFloat2CharMap.BasicEntry(0.0F, '\000');
/* 528:    */    
/* 529:529 */    public AbstractFloat2CharMap.BasicEntry next() { int e = nextEntry();
/* 530:530 */      this.entry.key = Float2CharOpenCustomHashMap.this.key[e];
/* 531:531 */      this.entry.value = Float2CharOpenCustomHashMap.this.value[e];
/* 532:532 */      return this.entry;
/* 533:    */    } }
/* 534:    */  
/* 535:    */  private final class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements Float2CharMap.FastEntrySet { private MapEntrySet() {}
/* 536:    */    
/* 537:537 */    public ObjectIterator<Float2CharMap.Entry> iterator() { return new Float2CharOpenCustomHashMap.EntryIterator(Float2CharOpenCustomHashMap.this, null); }
/* 538:    */    
/* 539:    */    public ObjectIterator<Float2CharMap.Entry> fastIterator() {
/* 540:540 */      return new Float2CharOpenCustomHashMap.FastEntryIterator(Float2CharOpenCustomHashMap.this, null);
/* 541:    */    }
/* 542:    */    
/* 543:    */    public boolean contains(Object o) {
/* 544:544 */      if (!(o instanceof Map.Entry)) return false;
/* 545:545 */      Map.Entry<Float, Character> e = (Map.Entry)o;
/* 546:546 */      float k = ((Float)e.getKey()).floatValue();
/* 547:    */      
/* 548:548 */      int pos = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Float2CharOpenCustomHashMap.this.mask;
/* 549:    */      
/* 550:550 */      while (Float2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 551:551 */        if (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[pos], k)) return Float2CharOpenCustomHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 552:552 */        pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask;
/* 553:    */      }
...
/* 559:559 */      Map.Entry<Float, Character> e = (Map.Entry)o;
/* 560:560 */      float k = ((Float)e.getKey()).floatValue();
/* 561:    */      
/* 562:562 */      int pos = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Float2CharOpenCustomHashMap.this.mask;
/* 563:    */      
/* 564:564 */      while (Float2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 565:565 */        if (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[pos], k)) {
/* 566:566 */          Float2CharOpenCustomHashMap.this.remove(e.getKey());
/* 567:567 */          return true;
/* 568:    */        }
/* 569:569 */        pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask;
/* 570:    */      }
/* 571:571 */      return false;
/* 572:    */    }
/* 573:    */    
/* 574:574 */    public int size() { return Float2CharOpenCustomHashMap.this.size; }
/* 575:    */    
/* 577:577 */    public void clear() { Float2CharOpenCustomHashMap.this.clear(); }
/* 578:    */  }
/* 579:    */  
/* 580:    */  public Float2CharMap.FastEntrySet float2CharEntrySet() {
...
/* 588:    */    extends Float2CharOpenCustomHashMap.MapIterator
/* 589:    */    implements FloatIterator
/* 590:    */  {
/* 591:591 */    public KeyIterator() { super(null); }
/* 592:592 */    public float nextFloat() { return Float2CharOpenCustomHashMap.this.key[nextEntry()]; }
/* 593:593 */    public Float next() { return Float.valueOf(Float2CharOpenCustomHashMap.this.key[nextEntry()]); } }
/* 594:    */  
/* 595:    */  private final class KeySet extends AbstractFloatSet { private KeySet() {}
/* 596:    */    
/* 597:597 */    public FloatIterator iterator() { return new Float2CharOpenCustomHashMap.KeyIterator(Float2CharOpenCustomHashMap.this); }
/* 598:    */    
/* 599:    */    public int size() {
/* 600:600 */      return Float2CharOpenCustomHashMap.this.size;
/* 601:    */    }
/* 602:    */    
/* 603:603 */    public boolean contains(float k) { return Float2CharOpenCustomHashMap.this.containsKey(k); }
/* 604:    */    
/* 605:    */    public boolean remove(float k) {
/* 606:606 */      int oldSize = Float2CharOpenCustomHashMap.this.size;
/* 607:607 */      Float2CharOpenCustomHashMap.this.remove(k);
/* 608:608 */      return Float2CharOpenCustomHashMap.this.size != oldSize;
/* 609:    */    }
/* 610:    */    
/* 611:611 */    public void clear() { Float2CharOpenCustomHashMap.this.clear(); }
/* 612:    */  }
/* 613:    */  
...
/* 622:    */    extends Float2CharOpenCustomHashMap.MapIterator
/* 623:    */    implements CharIterator
/* 624:    */  {
/* 625:625 */    public ValueIterator() { super(null); }
/* 626:626 */    public char nextChar() { return Float2CharOpenCustomHashMap.this.value[nextEntry()]; }
/* 627:627 */    public Character next() { return Character.valueOf(Float2CharOpenCustomHashMap.this.value[nextEntry()]); }
/* 628:    */  }
/* 629:    */  
...
/* 632:632 */          return new Float2CharOpenCustomHashMap.ValueIterator(Float2CharOpenCustomHashMap.this);
/* 633:    */        }
/* 634:    */        
/* 635:635 */        public int size() { return Float2CharOpenCustomHashMap.this.size; }
/* 636:    */        
/* 637:    */        public boolean contains(char v) {
/* 638:638 */          return Float2CharOpenCustomHashMap.this.containsValue(v);
/* 639:    */        }
/* 640:    */        
/* 641:641 */        public void clear() { Float2CharOpenCustomHashMap.this.clear(); }
/* 642:    */      };
/* 643:    */    }
...
/* 744:    */  }
/* 745:    */  
/* 749:    */  public Float2CharOpenCustomHashMap clone()
/* 750:    */  {
/* 751:    */    Float2CharOpenCustomHashMap c;
/* 752:    */    
/* 754:    */    try
/* 755:    */    {
/* 756:756 */      c = (Float2CharOpenCustomHashMap)super.clone();
/* 757:    */    }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.floats.Float2CharOpenCustomHashMap
