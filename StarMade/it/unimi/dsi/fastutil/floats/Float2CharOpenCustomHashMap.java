  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2CharOpenCustomHashMap(int expected, float local_f, FloatHash.Strategy strategy)
  {
  ...
  public Float2CharOpenCustomHashMap(Map<? extends Float, ? extends Character> local_m, float local_f, FloatHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Float2CharOpenCustomHashMap(Map<? extends Float, ? extends Character> local_m, FloatHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Float2CharOpenCustomHashMap(Float2CharMap local_m, float local_f, FloatHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Float2CharOpenCustomHashMap(Float2CharMap local_m, FloatHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Float2CharOpenCustomHashMap(float[] local_k, char[] local_v, float local_f, FloatHash.Strategy strategy)
  {
  ...
  public Float2CharOpenCustomHashMap(float[] local_k, char[] local_v, FloatHash.Strategy strategy)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Float2CharOpenCustomHashMap.ValueIterator(Float2CharOpenCustomHashMap.this);
        }
        ...
        {
          return Float2CharOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2CharOpenCustomHashMap local_c;
    try
    {
      local_c = (Float2CharOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Float2CharOpenCustomHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Float2CharOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSet
  {
    ...
    {
      return new Float2CharOpenCustomHashMap.KeyIterator(Float2CharOpenCustomHashMap.this);
    }
    ...
    {
      return Float2CharOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2CharOpenCustomHashMap.this.size;
      Float2CharOpenCustomHashMap.this.remove(local_k);
    ...
    implements FloatIterator
  {
    ...
    public Float next()
    {
      return Float.valueOf(Float2CharOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2CharMap.FastEntrySet
  {
    ...
    {
      return new Float2CharOpenCustomHashMap.EntryIterator(Float2CharOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Float2CharMap.Entry> fastIterator()
    {
      return new Float2CharOpenCustomHashMap.FastEntryIterator(Float2CharOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(local_k)) & Float2CharOpenCustomHashMap.this.mask; Float2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask) {
        if (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[pos], local_k)) {
          return Float2CharOpenCustomHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(local_k)) & Float2CharOpenCustomHashMap.this.mask; Float2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask) {
        if (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[pos], local_k))
        {
          Float2CharOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Float2CharMap.Entry>
  {
    ...
    public AbstractFloat2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2CharOpenCustomHashMap.this.key[local_e];
      this.entry.value = Float2CharOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Float2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Float2CharOpenCustomHashMap.MapEntry(Float2CharOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Float2CharOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1801 = Float2CharOpenCustomHashMap.this.size;
    FloatArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Float2CharOpenCustomHashMap.this.used;
      while ((this.field_1801 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1801 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1801 != 0)
      {
        boolean[] local_k = Float2CharOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2CharOpenCustomHashMap.this.mask; Float2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(Float2CharOpenCustomHashMap.this.key[pos])) & Float2CharOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2CharOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Float2CharOpenCustomHashMap.this.key[pos]);
        }
        Float2CharOpenCustomHashMap.this.key[last] = Float2CharOpenCustomHashMap.this.key[pos];
        Float2CharOpenCustomHashMap.this.value[last] = Float2CharOpenCustomHashMap.this.value[pos];
      }
      Float2CharOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Float2CharOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
        this.last = -1;
        return;
      }
      Float2CharOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1801 > 0))
      {
        this.field_1801 += 1;
        nextEntry();
      }
    ...
    implements Float2CharMap.Entry, Map.Entry<Float, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Float2CharOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Character> local_e = (Map.Entry)local_o;
      return (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[this.index], ((Float)local_e.getKey()).floatValue())) && (Float2CharOpenCustomHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
