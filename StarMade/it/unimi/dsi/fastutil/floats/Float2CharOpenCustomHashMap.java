...
/* 632 */           return new Float2CharOpenCustomHashMap.ValueIterator(Float2CharOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 635 */           return Float2CharOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(char v) {
/* 638 */           return Float2CharOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 641 */           Float2CharOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 756 */       c = (Float2CharOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Float2CharOpenCustomHashMap.MapIterator
/*     */     implements CharIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 625 */       super(null); } 
/* 626 */     public char nextChar() { return Float2CharOpenCustomHashMap.this.value[nextEntry()]; } 
/* 627 */     public Character next() { return Character.valueOf(Float2CharOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 597 */       return new Float2CharOpenCustomHashMap.KeyIterator(Float2CharOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 600 */       return Float2CharOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(float k) {
/* 603 */       return Float2CharOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(float k) {
/* 606 */       int oldSize = Float2CharOpenCustomHashMap.this.size;
/* 607 */       Float2CharOpenCustomHashMap.this.remove(k);
/* 608 */       return Float2CharOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 611 */       Float2CharOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Float2CharOpenCustomHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 591 */       super(null); } 
/* 592 */     public float nextFloat() { return Float2CharOpenCustomHashMap.this.key[nextEntry()]; } 
/* 593 */     public Float next() { return Float.valueOf(Float2CharOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 537 */       return new Float2CharOpenCustomHashMap.EntryIterator(Float2CharOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Float2CharMap.Entry> fastIterator() {
/* 540 */       return new Float2CharOpenCustomHashMap.FastEntryIterator(Float2CharOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 548 */       int pos = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Float2CharOpenCustomHashMap.this.mask;
/*     */ 
/* 550 */       while (Float2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 551 */         if (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[pos], k)) return Float2CharOpenCustomHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 552 */         pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask;
/*     */       }
/* 554 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 562 */       int pos = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Float2CharOpenCustomHashMap.this.mask;
/*     */ 
/* 564 */       while (Float2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 565 */         if (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[pos], k)) {
/* 566 */           Float2CharOpenCustomHashMap.this.remove(e.getKey());
/* 567 */           return true;
/*     */         }
/* 569 */         pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask;
/*     */       }
/* 571 */       return false;
/*     */     }
/*     */     public int size() {
/* 574 */       return Float2CharOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 577 */       Float2CharOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Float2CharOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Float2CharMap.Entry>
/*     */   {
/* 527 */     final AbstractFloat2CharMap.BasicEntry entry = new AbstractFloat2CharMap.BasicEntry(0.0F, '\000');
/*     */ 
...
/* 529 */       int e = nextEntry();
/* 530 */       this.entry.key = Float2CharOpenCustomHashMap.this.key[e];
/* 531 */       this.entry.value = Float2CharOpenCustomHashMap.this.value[e];
/* 532 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Float2CharOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Float2CharMap.Entry>
/*     */   {
...
/* 518 */       return this.entry = new Float2CharOpenCustomHashMap.MapEntry(Float2CharOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 522 */       super.remove();
/* 523 */       Float2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 424 */       this.pos = Float2CharOpenCustomHashMap.this.n;
/*     */ 
/* 427 */       this.last = -1;
/*     */ 
/* 429 */       this.c = Float2CharOpenCustomHashMap.this.size;
/*     */ 
/* 434 */       boolean[] used = Float2CharOpenCustomHashMap.this.used;
...
/*     */ 
/* 447 */         int pos = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Float2CharOpenCustomHashMap.this.mask;
/*     */ 
/* 449 */         while (Float2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 450 */           if (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[pos], k)) return pos;
/* 451 */           pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 454 */       this.last = this.pos;
/*     */ 
/* 456 */       if (this.c != 0) {
/* 457 */         boolean[] used = Float2CharOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 474 */         pos = (last = pos) + 1 & Float2CharOpenCustomHashMap.this.mask;
/* 475 */         while (Float2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 476 */           int slot = HashCommon.murmurHash3(Float2CharOpenCustomHashMap.this.strategy.hashCode(Float2CharOpenCustomHashMap.this.key[pos])) & Float2CharOpenCustomHashMap.this.mask;
/* 477 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 478 */           pos = pos + 1 & Float2CharOpenCustomHashMap.this.mask;
/*     */         }
/* 480 */         if (Float2CharOpenCustomHashMap.this.used[pos] == 0) break;
/* 481 */         if (pos < last)
/*     */         {
/* 483 */           if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 484 */           this.wrapped.add(Float2CharOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 486 */         Float2CharOpenCustomHashMap.this.key[last] = Float2CharOpenCustomHashMap.this.key[pos];
/* 487 */         Float2CharOpenCustomHashMap.this.value[last] = Float2CharOpenCustomHashMap.this.value[pos];
/*     */       }
/* 489 */       Float2CharOpenCustomHashMap.this.used[last] = false;
/* 490 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 495 */       if (this.pos < -1)
/*     */       {
/* 497 */         Float2CharOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 498 */         this.last = -1;
/* 499 */         return;
/*     */       }
/* 501 */       Float2CharOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Float getKey() {
/* 388 */       return Float.valueOf(Float2CharOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public float getFloatKey() {
/* 391 */       return Float2CharOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Character getValue() {
/* 394 */       return Character.valueOf(Float2CharOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public char getCharValue() {
/* 397 */       return Float2CharOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public char setValue(char v) {
/* 400 */       char oldValue = Float2CharOpenCustomHashMap.this.value[this.index];
/* 401 */       Float2CharOpenCustomHashMap.this.value[this.index] = v;
/* 402 */       return oldValue;
/*     */     }
...
/* 411 */       return (Float2CharOpenCustomHashMap.this.strategy.equals(Float2CharOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue())) && (Float2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*     */     }
/*     */     public int hashCode() {
/* 414 */       return Float2CharOpenCustomHashMap.this.strategy.hashCode(Float2CharOpenCustomHashMap.this.key[this.index]) ^ Float2CharOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 417 */       return Float2CharOpenCustomHashMap.this.key[this.index] + "=>" + Float2CharOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
