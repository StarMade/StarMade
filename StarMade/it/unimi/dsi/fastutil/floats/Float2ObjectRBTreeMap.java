...
/*  119 */           return Float2ObjectRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  122 */           return Float2ObjectRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* 1118 */         final Comparator<? super Float2ObjectMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Float2ObjectMap.Entry<V> x, Float2ObjectMap.Entry<V> y) {
/* 1120 */             return Float2ObjectRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Float2ObjectRBTreeMap.EntryIterator(Float2ObjectRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator(Float2ObjectMap.Entry<V> from) {
/* 1130 */           return new Float2ObjectRBTreeMap.EntryIterator(Float2ObjectRBTreeMap.this, ((Float)from.getKey()).floatValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Float2ObjectRBTreeMap.Entry f = Float2ObjectRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1143 */           Float2ObjectRBTreeMap.Entry f = Float2ObjectRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1144 */           if (f != null) Float2ObjectRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Float2ObjectRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Float2ObjectRBTreeMap.this.clear(); } 
/* 1149 */         public Float2ObjectMap.Entry<V> first() { return Float2ObjectRBTreeMap.this.firstEntry; } 
/* 1150 */         public Float2ObjectMap.Entry<V> last() { return Float2ObjectRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Float2ObjectMap.Entry<V>> subSet(Float2ObjectMap.Entry<V> from, Float2ObjectMap.Entry<V> to) { return Float2ObjectRBTreeMap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ObjectEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Float2ObjectMap.Entry<V>> headSet(Float2ObjectMap.Entry<V> to) { return Float2ObjectRBTreeMap.this.headMap((Float)to.getKey()).float2ObjectEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Float2ObjectMap.Entry<V>> tailSet(Float2ObjectMap.Entry<V> from) { return Float2ObjectRBTreeMap.this.tailMap((Float)from.getKey()).float2ObjectEntrySet(); }
/*      */       };
...
/* 1215 */           return new Float2ObjectRBTreeMap.ValueIterator(Float2ObjectRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Float2ObjectRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Float2ObjectRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Float2ObjectRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1580 */       c = (Float2ObjectRBTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Float2ObjectRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Float2ObjectRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Float2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator() {
/* 1302 */             return new Float2ObjectRBTreeMap.Submap.SubmapEntryIterator(Float2ObjectRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator(Float2ObjectMap.Entry<V> from) {
/* 1305 */             return new Float2ObjectRBTreeMap.Submap.SubmapEntryIterator(Float2ObjectRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
/*      */           }
/* 1307 */           public Comparator<? super Float2ObjectMap.Entry<V>> comparator() { return Float2ObjectRBTreeMap.this.float2ObjectEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Float2ObjectRBTreeMap.Entry f = Float2ObjectRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1313 */             return (f != null) && (Float2ObjectRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Float2ObjectRBTreeMap.Entry f = Float2ObjectRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1320 */             if ((f != null) && (Float2ObjectRBTreeMap.Submap.this.in(f.key))) Float2ObjectRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Float2ObjectRBTreeMap.Submap.SubmapIterator(Float2ObjectRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Float2ObjectRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Float2ObjectMap.Entry<V> first() { return Float2ObjectRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Float2ObjectMap.Entry<V> last() { return Float2ObjectRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Float2ObjectMap.Entry<V>> subSet(Float2ObjectMap.Entry<V> from, Float2ObjectMap.Entry<V> to) { return Float2ObjectRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2ObjectEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Float2ObjectMap.Entry<V>> headSet(Float2ObjectMap.Entry<V> to) { return Float2ObjectRBTreeMap.Submap.this.headMap((Float)to.getKey()).float2ObjectEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Float2ObjectMap.Entry<V>> tailSet(Float2ObjectMap.Entry<V> from) { return Float2ObjectRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2ObjectEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Float2ObjectRBTreeMap.Submap.SubmapValueIterator(Float2ObjectRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Float2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Float2ObjectRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Float2ObjectRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(float k) {
/* 1365 */       return (in(k)) && (Float2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       float kk = k;
/*      */       Float2ObjectRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Float2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(float k, V v) {
/* 1383 */       Float2ObjectRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Float2ObjectRBTreeMap.this.put(k, v);
/* 1386 */       return Float2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Float ok, V ov) {
/* 1389 */       Object oldValue = put(ok.floatValue(), ov);
/* 1390 */       return Float2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(float k) {
/* 1394 */       Float2ObjectRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Float2ObjectRBTreeMap.this.remove(k);
/* 1397 */       return Float2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Float)ok).floatValue());
/* 1401 */       return Float2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1416 */       return Float2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Float2ObjectSortedMap<V> headMap(float to) {
/* 1419 */       if (this.top) return new Submap(Float2ObjectRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Float2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Float2ObjectRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Float2ObjectSortedMap<V> tailMap(float from) {
/* 1423 */       if (this.bottom) return new Submap(Float2ObjectRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Float2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2ObjectRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Float2ObjectSortedMap<V> subMap(float from, float to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Float2ObjectRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Float2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Float2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Float2ObjectRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Float2ObjectRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Float2ObjectRBTreeMap.this.tree == null) return null;
/* 1441 */       Float2ObjectRBTreeMap.Entry e;
/*      */       Float2ObjectRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Float2ObjectRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Float2ObjectRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Float2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Float2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Float2ObjectRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Float2ObjectRBTreeMap.this.tree == null) return null;
/* 1459 */       Float2ObjectRBTreeMap.Entry e;
/*      */       Float2ObjectRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Float2ObjectRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Float2ObjectRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Float2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Float2ObjectRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public float firstFloatKey() {
/* 1470 */       Float2ObjectRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public float lastFloatKey() {
/* 1475 */       Float2ObjectRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Float firstKey() {
/* 1480 */       Float2ObjectRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Float lastKey() {
/* 1485 */       Float2ObjectRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Float2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Float2ObjectRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Float2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/* 1530 */       public Float2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Float2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Float2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Float2ObjectRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Float2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Float2ObjectRBTreeMap.Submap.this.bottom) && (Float2ObjectRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Float2ObjectRBTreeMap.Submap.this.top) && (Float2ObjectRBTreeMap.this.compare(k, (this.prev = Float2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Float2ObjectRBTreeMap.this.locateKey(k);
/* 1507 */             if (Float2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Float2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2ObjectRBTreeMap.this.compare(this.prev.key, Float2ObjectRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Float2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Float2ObjectRBTreeMap.this.compare(this.next.key, Float2ObjectRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public FloatBidirectionalIterator iterator() { return new Float2ObjectRBTreeMap.Submap.SubmapKeyIterator(Float2ObjectRBTreeMap.Submap.this); } 
/* 1340 */       public FloatBidirectionalIterator iterator(float from) { return new Float2ObjectRBTreeMap.Submap.SubmapKeyIterator(Float2ObjectRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public FloatBidirectionalIterator iterator() { return new Float2ObjectRBTreeMap.KeyIterator(Float2ObjectRBTreeMap.this); } 
/* 1178 */     public FloatBidirectionalIterator iterator(float from) { return new Float2ObjectRBTreeMap.KeyIterator(Float2ObjectRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2ObjectRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Float2ObjectMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1112 */     public Float2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Float2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Float2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Float2ObjectRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(float k) {
/* 1044 */       if ((this.next = Float2ObjectRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Float2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Float2ObjectRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  969 */       return HashCommon.float2int(this.key) ^ (this.value == null ? 0 : this.value.hashCode());
/*      */     }
