  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof FloatComparator))) {
      ...
      this.actualComparator = new FloatComparator()
      {
        ...
        {
          return Float2ObjectRBTreeMap.this.storedComparator.compare(Float.valueOf(local_k1), Float.valueOf(local_k2));
        }
  ...
  public Float2ObjectRBTreeMap(Comparator<? super Float> local_c)
  {
    this();
  ...
  public Float2ObjectRBTreeMap(Map<? extends Float, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2ObjectRBTreeMap(SortedMap<Float, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2ObjectRBTreeMap(Float2ObjectMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2ObjectRBTreeMap(Float2ObjectSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2ObjectRBTreeMap(float[] local_k, V[] local_v, Comparator<? super Float> local_c)
  {
    this(local_c);
  ...
  public Float2ObjectRBTreeMap(float[] local_k, V[] local_v)
  {
  ...
  {
    Float2ObjectRBTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Float2ObjectMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Float2ObjectRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Float2ObjectRBTreeMap.EntryIterator(Float2ObjectRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator(Float2ObjectMap.Entry<V> from)
        {
          return new Float2ObjectRBTreeMap.EntryIterator(Float2ObjectRBTreeMap.this, ((Float)from.getKey()).floatValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Float2ObjectRBTreeMap.Entry<V> local_f = Float2ObjectRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Float2ObjectRBTreeMap.Entry<V> local_f = Float2ObjectRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
          if (local_f != null) {
            Float2ObjectRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Float2ObjectRBTreeMap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Float2ObjectMap.Entry<V>> headSet(Float2ObjectMap.Entry<V> local_to)
        {
          return Float2ObjectRBTreeMap.this.headMap((Float)local_to.getKey()).float2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Float2ObjectMap.Entry<V>> tailSet(Float2ObjectMap.Entry<V> from)
        {
          return Float2ObjectRBTreeMap.this.tailMap((Float)from.getKey()).float2ObjectEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Float2ObjectRBTreeMap.ValueIterator(Float2ObjectRBTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Float2ObjectRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Float2ObjectRBTreeMap<V> local_c;
    try
    {
      local_c = (Float2ObjectRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Float2ObjectRBTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Float2ObjectRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Float2ObjectRBTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Float2ObjectRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Float2ObjectRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator()
          {
            return new Float2ObjectRBTreeMap.Submap.SubmapEntryIterator(Float2ObjectRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator(Float2ObjectMap.Entry<V> from)
          {
            return new Float2ObjectRBTreeMap.Submap.SubmapEntryIterator(Float2ObjectRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Float, V> local_e = (Map.Entry)local_o;
            Float2ObjectRBTreeMap.Entry<V> local_f = Float2ObjectRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            return (local_f != null) && (Float2ObjectRBTreeMap.Submap.this.in(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Float, V> local_e = (Map.Entry)local_o;
            Float2ObjectRBTreeMap.Entry<V> local_f = Float2ObjectRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            if ((local_f != null) && (Float2ObjectRBTreeMap.Submap.this.in(local_f.key))) {
              Float2ObjectRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Float2ObjectRBTreeMap.Submap.SubmapIterator(Float2ObjectRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Float2ObjectRBTreeMap.Submap.this.clear();
          }
          
          public Float2ObjectMap.Entry<V> first()
          {
            return Float2ObjectRBTreeMap.Submap.this.firstEntry();
          }
          
          public Float2ObjectMap.Entry<V> last()
          {
            return Float2ObjectRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Float2ObjectMap.Entry<V>> subSet(Float2ObjectMap.Entry<V> from, Float2ObjectMap.Entry<V> local_to)
          {
            return Float2ObjectRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Float2ObjectMap.Entry<V>> headSet(Float2ObjectMap.Entry<V> local_to)
          {
            return Float2ObjectRBTreeMap.Submap.this.headMap((Float)local_to.getKey()).float2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Float2ObjectMap.Entry<V>> tailSet(Float2ObjectMap.Entry<V> from)
          {
            return Float2ObjectRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Float2ObjectRBTreeMap.Submap.SubmapValueIterator(Float2ObjectRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Float2ObjectRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Float2ObjectRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(float local_k)
    {
      return (in(local_k)) && (Float2ObjectRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      float local_kk = local_k;
      Float2ObjectRBTreeMap.Entry<V> local_e;
      return (in(local_kk)) && ((local_e = Float2ObjectRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(float local_k, V local_v)
    {
      ...
      V oldValue = Float2ObjectRBTreeMap.this.put(local_k, local_v);
    ...
    public V remove(float local_k)
    {
      ...
      V oldValue = Float2ObjectRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Float2ObjectRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Float2ObjectRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Float2ObjectRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Float2ObjectSortedMap<V> tailMap(float from)
    {
      if (this.bottom) {
        return new Submap(Float2ObjectRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Float2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2ObjectRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Float2ObjectSortedMap<V> subMap(float from, float local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Float2ObjectRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Float2ObjectRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Float2ObjectRBTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Float2ObjectRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Float2ObjectRBTreeMap.this.locateKey(this.from);
        if (Float2ObjectRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Float2ObjectRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Float2ObjectRBTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Float2ObjectRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Float2ObjectRBTreeMap.this.locateKey(this.field_47);
        if (Float2ObjectRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Float2ObjectRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public float firstFloatKey()
    {
      Float2ObjectRBTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public float lastFloatKey()
    {
      Float2ObjectRBTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Float2ObjectRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Float2ObjectRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Float2ObjectRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(float local_k)
      {
        this();
        if (this.next != null) {
          if ((!Float2ObjectRBTreeMap.Submap.this.bottom) && (Float2ObjectRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Float2ObjectRBTreeMap.Submap.this.top) && (Float2ObjectRBTreeMap.this.compare(local_k, (this.prev = Float2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Float2ObjectRBTreeMap.this.locateKey(local_k);
            if (Float2ObjectRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Float2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2ObjectRBTreeMap.this.compare(this.prev.key, Float2ObjectRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Float2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Float2ObjectRBTreeMap.this.compare(this.next.key, Float2ObjectRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractFloat2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Float2ObjectRBTreeMap.Submap.SubmapKeyIterator(Float2ObjectRBTreeMap.Submap.this);
      }
      
      public FloatBidirectionalIterator iterator(float from)
      {
        return new Float2ObjectRBTreeMap.Submap.SubmapKeyIterator(Float2ObjectRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractFloat2ObjectSortedMap.KeySet
  {
    ...
    public FloatBidirectionalIterator iterator()
    {
      return new Float2ObjectRBTreeMap.KeyIterator(Float2ObjectRBTreeMap.this);
    }
    
    public FloatBidirectionalIterator iterator(float from)
    {
      return new Float2ObjectRBTreeMap.KeyIterator(Float2ObjectRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Float2ObjectRBTreeMap.this.locateKey(local_k)) != null) {
        if (Float2ObjectRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
