...
/*     */     try
/*     */     {
/* 300 */       c = (Float2ReferenceArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Float2ReferenceMap.Entry<V>>
...
/* 130 */         int next = 0;
/*     */ 
/* 132 */         public boolean hasNext() { return this.next < Float2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Float2ReferenceMap.Entry<V> next()
/*     */         {
/* 136 */           if (!hasNext()) throw new NoSuchElementException();
/* 137 */           return new AbstractFloat2ReferenceMap.BasicEntry(Float2ReferenceArrayMap.this.key[this.next], Float2ReferenceArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 143 */         int next = 0;
/* 144 */         final AbstractFloat2ReferenceMap.BasicEntry<V> entry = new AbstractFloat2ReferenceMap.BasicEntry(0.0F, null);
/*     */ 
/* 146 */         public boolean hasNext() { return this.next < Float2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Float2ReferenceMap.Entry<V> next()
/*     */         {
/* 150 */           if (!hasNext()) throw new NoSuchElementException();
/* 151 */           this.entry.key = Float2ReferenceArrayMap.this.key[this.next];
/* 152 */           this.entry.value = Float2ReferenceArrayMap.this.value[(this.next++)];
/* 153 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 158 */       return Float2ReferenceArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 165 */       return (Float2ReferenceArrayMap.this.containsKey(k)) && (Float2ReferenceArrayMap.this.get(k) == e.getValue());
/*     */     }
/*     */   }
/*     */ }
