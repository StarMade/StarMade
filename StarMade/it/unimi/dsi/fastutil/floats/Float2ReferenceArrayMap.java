...
/*  17:    */
/*  65:    */public class Float2ReferenceArrayMap<V>
/*  66:    */  extends AbstractFloat2ReferenceMap<V>
/*  67:    */  implements Serializable, Cloneable
/*  68:    */{
/*  69:    */  private static final long serialVersionUID = 1L;
/*  70:    */  private transient float[] key;
/*  71:    */  private transient Object[] value;
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Float2ReferenceArrayMap(float[] key, Object[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Float2ReferenceArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = FloatArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = ObjectArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Float2ReferenceArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new float[capacity];
/*  93: 93 */    this.value = new Object[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Float2ReferenceArrayMap(Float2ReferenceMap<V> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Float2ReferenceArrayMap(Map<? extends Float, ? extends V> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Float2ReferenceArrayMap(float[] key, Object[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Float2ReferenceMap.Entry<V>> implements Float2ReferenceMap.FastEntrySet<V> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Float2ReferenceMap.Entry<V>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Float2ReferenceArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Float2ReferenceMap.Entry<V> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractFloat2ReferenceMap.BasicEntry(Float2ReferenceArrayMap.this.key[this.next], Float2ReferenceArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Float2ReferenceMap.Entry<V>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractFloat2ReferenceMap.BasicEntry<V> entry = new AbstractFloat2ReferenceMap.BasicEntry(0.0F, null);
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Float2ReferenceArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Float2ReferenceMap.Entry<V> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Float2ReferenceArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Float2ReferenceArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Float2ReferenceArrayMap.this.size; }
/* 159:    */    
/* 160:    */    public boolean contains(Object o)
/* 161:    */    {
/* 162:162 */      if (!(o instanceof Map.Entry)) return false;
/* 163:163 */      Map.Entry<Float, V> e = (Map.Entry)o;
/* 164:164 */      float k = ((Float)e.getKey()).floatValue();
/* 165:165 */      return (Float2ReferenceArrayMap.this.containsKey(k)) && (Float2ReferenceArrayMap.this.get(k) == e.getValue());
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Float2ReferenceMap.FastEntrySet<V> float2ReferenceEntrySet() { return new EntrySet(null); }
/* 170:    */  
/* 171:    */  private int findKey(float k)
/* 172:    */  {
...
/* 206:    */  }
/* 207:    */  
/* 208:    */  public boolean containsKey(float k)
/* 209:    */  {
...
/* 235:235 */      float[] newKey = new float[this.size == 0 ? 2 : this.size * 2];
...
/* 274:    */  }
/* 275:    */  
/* 278:    */  public FloatSet keySet()
/* 279:    */  {
/* 280:280 */    return new FloatArraySet(this.key, this.size);
/* 281:    */  }
/* 282:    */  
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Float2ReferenceArrayMap<V> clone()
/* 293:    */  {
/* 294:    */    Float2ReferenceArrayMap<V> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Float2ReferenceArrayMap)super.clone();
/* 301:    */    }
/* 302:    */    catch (CloneNotSupportedException cantHappen) {
/* 303:303 */      throw new InternalError();
/* 304:    */    }
/* 305:305 */    c.key = ((float[])this.key.clone());
...
/* 313:313 */      s.writeFloat(this.key[i]);
