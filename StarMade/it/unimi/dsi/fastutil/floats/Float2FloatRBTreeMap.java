...
/*      */ 
/*      */ public class Float2FloatRBTreeMap extends AbstractFloat2FloatSortedMap
...
/*  119 */           return Float2FloatRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  122 */           return Float2FloatRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     float oldValue = put(ok.floatValue(), ov.floatValue());
/*  731 */     return this.modified ? null : Float.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Float remove(Object ok)
/*      */   {
/*  737 */     float oldValue = remove(((Float)ok).floatValue());
...
/* 1141 */         final Comparator<? super Float2FloatMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Float2FloatMap.Entry x, Float2FloatMap.Entry y) {
/* 1143 */             return Float2FloatRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Float2FloatRBTreeMap.EntryIterator(Float2FloatRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator(Float2FloatMap.Entry from) {
/* 1153 */           return new Float2FloatRBTreeMap.EntryIterator(Float2FloatRBTreeMap.this, ((Float)from.getKey()).floatValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Float2FloatRBTreeMap.Entry f = Float2FloatRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1166 */           Float2FloatRBTreeMap.Entry f = Float2FloatRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1167 */           if (f != null) Float2FloatRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Float2FloatRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Float2FloatRBTreeMap.this.clear(); } 
/* 1172 */         public Float2FloatMap.Entry first() { return Float2FloatRBTreeMap.this.firstEntry; } 
/* 1173 */         public Float2FloatMap.Entry last() { return Float2FloatRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Float2FloatMap.Entry> subSet(Float2FloatMap.Entry from, Float2FloatMap.Entry to) { return Float2FloatRBTreeMap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2FloatEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Float2FloatMap.Entry> headSet(Float2FloatMap.Entry to) { return Float2FloatRBTreeMap.this.headMap((Float)to.getKey()).float2FloatEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Float2FloatMap.Entry> tailSet(Float2FloatMap.Entry from) { return Float2FloatRBTreeMap.this.tailMap((Float)from.getKey()).float2FloatEntrySet(); }
/*      */       };
...
/* 1242 */           return new Float2FloatRBTreeMap.ValueIterator(Float2FloatRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(float k) {
/* 1245 */           return Float2FloatRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Float2FloatRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Float2FloatRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Float2FloatRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readFloat(), s.readFloat());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readFloat(), s.readFloat());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readFloat(), s.readFloat()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Float2FloatRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Float2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1323 */       return ((this.bottom) || (Float2FloatRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Float2FloatRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet() {
/* 1327 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator() {
/* 1329 */             return new Float2FloatRBTreeMap.Submap.SubmapEntryIterator(Float2FloatRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator(Float2FloatMap.Entry from) {
/* 1332 */             return new Float2FloatRBTreeMap.Submap.SubmapEntryIterator(Float2FloatRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
/*      */           }
/* 1334 */           public Comparator<? super Float2FloatMap.Entry> comparator() { return Float2FloatRBTreeMap.this.float2FloatEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Float2FloatRBTreeMap.Entry f = Float2FloatRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1340 */             return (f != null) && (Float2FloatRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Float2FloatRBTreeMap.Entry f = Float2FloatRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1347 */             if ((f != null) && (Float2FloatRBTreeMap.Submap.this.in(f.key))) Float2FloatRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Float2FloatRBTreeMap.Submap.SubmapIterator(Float2FloatRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Float2FloatRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Float2FloatMap.Entry first() { return Float2FloatRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Float2FloatMap.Entry last() { return Float2FloatRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Float2FloatMap.Entry> subSet(Float2FloatMap.Entry from, Float2FloatMap.Entry to) { return Float2FloatRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2FloatEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Float2FloatMap.Entry> headSet(Float2FloatMap.Entry to) { return Float2FloatRBTreeMap.Submap.this.headMap((Float)to.getKey()).float2FloatEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Float2FloatMap.Entry> tailSet(Float2FloatMap.Entry from) { return Float2FloatRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2FloatEntrySet(); }
/*      */         };
...
/*      */           public FloatIterator iterator() {
/* 1376 */             return new Float2FloatRBTreeMap.Submap.SubmapValueIterator(Float2FloatRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(float k) {
/* 1379 */             return Float2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Float2FloatRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Float2FloatRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(float k) {
/* 1392 */       return (in(k)) && (Float2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(float v) {
...
/* 1407 */       return (in(kk)) && ((e = Float2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public float put(float k, float v) {
/* 1410 */       Float2FloatRBTreeMap.this.modified = false;
...
/* 1412 */       float oldValue = Float2FloatRBTreeMap.this.put(k, v);
/* 1413 */       return Float2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Float put(Float ok, Float ov) {
/* 1416 */       float oldValue = put(ok.floatValue(), ov.floatValue());
/* 1417 */       return Float2FloatRBTreeMap.this.modified ? null : Float.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public float remove(float k) {
/* 1421 */       Float2FloatRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       float oldValue = Float2FloatRBTreeMap.this.remove(k);
/* 1424 */       return Float2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Float remove(Object ok) {
/* 1427 */       float oldValue = remove(((Float)ok).floatValue());
/* 1428 */       return Float2FloatRBTreeMap.this.modified ? Float.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1443 */       return Float2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Float2FloatSortedMap headMap(float to) {
/* 1446 */       if (this.top) return new Submap(Float2FloatRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Float2FloatRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Float2FloatRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Float2FloatSortedMap tailMap(float from) {
/* 1450 */       if (this.bottom) return new Submap(Float2FloatRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Float2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2FloatRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Float2FloatSortedMap subMap(float from, float to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Float2FloatRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Float2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Float2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Float2FloatRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Float2FloatRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Float2FloatRBTreeMap.this.tree == null) return null;
/* 1468 */       Float2FloatRBTreeMap.Entry e;
/*      */       Float2FloatRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Float2FloatRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Float2FloatRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Float2FloatRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Float2FloatRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Float2FloatRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Float2FloatRBTreeMap.this.tree == null) return null;
/* 1486 */       Float2FloatRBTreeMap.Entry e;
/*      */       Float2FloatRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Float2FloatRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Float2FloatRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Float2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Float2FloatRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public float firstFloatKey() {
/* 1497 */       Float2FloatRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public float lastFloatKey() {
/* 1502 */       Float2FloatRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Float firstKey() {
/* 1507 */       Float2FloatRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Float lastKey() {
/* 1512 */       Float2FloatRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Float2FloatRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Float2FloatRBTreeMap.Submap.SubmapIterator
/*      */       implements FloatListIterator
/*      */     {
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Float2FloatRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Float2FloatMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Float2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Float2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Float2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Float2FloatRBTreeMap.Submap.this.bottom) && (Float2FloatRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Float2FloatRBTreeMap.Submap.this.top) && (Float2FloatRBTreeMap.this.compare(k, (this.prev = Float2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Float2FloatRBTreeMap.this.locateKey(k);
/* 1534 */             if (Float2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Float2FloatRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2FloatRBTreeMap.this.compare(this.prev.key, Float2FloatRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Float2FloatRBTreeMap.Submap.this.top) && (this.next != null) && (Float2FloatRBTreeMap.this.compare(this.next.key, Float2FloatRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public FloatBidirectionalIterator iterator() { return new Float2FloatRBTreeMap.Submap.SubmapKeyIterator(Float2FloatRBTreeMap.Submap.this); } 
/* 1367 */       public FloatBidirectionalIterator iterator(float from) { return new Float2FloatRBTreeMap.Submap.SubmapKeyIterator(Float2FloatRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2FloatRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public FloatBidirectionalIterator iterator() { return new Float2FloatRBTreeMap.KeyIterator(Float2FloatRBTreeMap.this); } 
/* 1201 */     public FloatBidirectionalIterator iterator(float from) { return new Float2FloatRBTreeMap.KeyIterator(Float2FloatRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2FloatRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2FloatRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Float2FloatMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Float2FloatMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Float2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Float2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Float2FloatRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(float k) {
/* 1067 */       if ((this.next = Float2FloatRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Float2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Float2FloatRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == ((Float)e.getValue()).floatValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/*  983 */       return HashCommon.float2int(this.key) ^ HashCommon.float2int(this.value);
/*      */     }
/*      */ 
