...
/*  786 */   public Float2ByteSortedMap tailMap(float from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Float2ByteSortedMap headMap(float to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Float2ByteSortedMap subMap(float from, float to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Float2ByteLinkedOpenHashMap.ValueIterator(Float2ByteLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Float2ByteLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(byte v) {
/* 1113 */           return Float2ByteLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Float2ByteLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Float2ByteLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public byte previousByte()
/*      */     {
/* 1094 */       return Float2ByteLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Byte previous() { return Byte.valueOf(Float2ByteLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public byte nextByte() { return Float2ByteLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Byte next() { return Byte.valueOf(Float2ByteLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Float2ByteLinkedOpenHashMap.KeyIterator(Float2ByteLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public FloatListIterator iterator() {
/* 1054 */       return new Float2ByteLinkedOpenHashMap.KeyIterator(Float2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Float2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(float k) {
/* 1060 */       return Float2ByteLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(float k) {
/* 1063 */       int oldSize = Float2ByteLinkedOpenHashMap.this.size;
/* 1064 */       Float2ByteLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Float2ByteLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Float2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public float firstFloat() {
/* 1071 */       if (Float2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Float2ByteLinkedOpenHashMap.this.key[Float2ByteLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public float lastFloat() {
/* 1075 */       if (Float2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Float2ByteLinkedOpenHashMap.this.key[Float2ByteLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2ByteLinkedOpenHashMap.MapIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator(float k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public float previousFloat() { return Float2ByteLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Float previous() { return Float.valueOf(Float2ByteLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public float nextFloat() { return Float2ByteLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Float next() { return Float.valueOf(Float2ByteLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Float2ByteMap.Entry>
...
/*      */     {
/*  966 */       return new Float2ByteLinkedOpenHashMap.EntryIterator(Float2ByteLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Float2ByteMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Float2ByteMap.Entry> subSet(Float2ByteMap.Entry fromElement, Float2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Float2ByteMap.Entry> headSet(Float2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Float2ByteMap.Entry> tailSet(Float2ByteMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Float2ByteMap.Entry first() {
/*  973 */       if (Float2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Float2ByteLinkedOpenHashMap.MapEntry(Float2ByteLinkedOpenHashMap.this, Float2ByteLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Float2ByteMap.Entry last() {
/*  977 */       if (Float2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Float2ByteLinkedOpenHashMap.MapEntry(Float2ByteLinkedOpenHashMap.this, Float2ByteLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Float2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Float2ByteLinkedOpenHashMap.this.key[pos] == k) return Float2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/*  990 */         pos = pos + 1 & Float2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Float2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Float2ByteLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Float2ByteLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Float2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Float2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Float2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2ByteMap.Entry> iterator(Float2ByteMap.Entry from) {
/* 1018 */       return new Float2ByteLinkedOpenHashMap.EntryIterator(Float2ByteLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2ByteMap.Entry> fastIterator() {
/* 1021 */       return new Float2ByteLinkedOpenHashMap.FastEntryIterator(Float2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2ByteMap.Entry> fastIterator(Float2ByteMap.Entry from) {
/* 1024 */       return new Float2ByteLinkedOpenHashMap.FastEntryIterator(Float2ByteLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Float2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2ByteMap.Entry>
/*      */   {
/*  944 */     final AbstractFloat2ByteMap.BasicEntry entry = new AbstractFloat2ByteMap.BasicEntry(0.0F, (byte)0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Float2ByteLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Float2ByteLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractFloat2ByteMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Float2ByteLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Float2ByteLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2ByteMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Float2ByteLinkedOpenHashMap.MapEntry(Float2ByteLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Float2ByteLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Float2ByteLinkedOpenHashMap.MapEntry(Float2ByteLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Float2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Float2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Float2ByteLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(float from) {
/*  809 */       if (Float2ByteLinkedOpenHashMap.this.key[Float2ByteLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Float2ByteLinkedOpenHashMap.this.last;
/*  811 */         this.index = Float2ByteLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Float2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Float2ByteLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Float2ByteLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Float2ByteLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Float2ByteLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Float2ByteLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Float2ByteLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Float2ByteLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Float2ByteLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Float2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Float2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Float2ByteLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Float2ByteLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Float2ByteLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Float2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Float2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Float2ByteLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Float2ByteLinkedOpenHashMap.this.link[this.next] ^= (Float2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Float2ByteLinkedOpenHashMap.this.mask;
/*  897 */         while (Float2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ByteLinkedOpenHashMap.this.key[pos])) & Float2ByteLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Float2ByteLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Float2ByteLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Float2ByteLinkedOpenHashMap.this.key[last] = Float2ByteLinkedOpenHashMap.this.key[pos];
/*  904 */         Float2ByteLinkedOpenHashMap.this.value[last] = Float2ByteLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Float2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Float2ByteLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Float getKey() {
/*  669 */       return Float.valueOf(Float2ByteLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public float getFloatKey() {
/*  672 */       return Float2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Byte getValue() {
/*  675 */       return Byte.valueOf(Float2ByteLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public byte getByteValue() {
/*  678 */       return Float2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public byte setValue(byte v) {
/*  681 */       byte oldValue = Float2ByteLinkedOpenHashMap.this.value[this.index];
/*  682 */       Float2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Byte setValue(Byte v) {
...
/*  692 */       return (Float2ByteLinkedOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.float2int(Float2ByteLinkedOpenHashMap.this.key[this.index]) ^ Float2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Float2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Float2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
