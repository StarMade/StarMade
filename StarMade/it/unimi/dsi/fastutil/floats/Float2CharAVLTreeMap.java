  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof FloatComparator))) {
      ...
      this.actualComparator = new FloatComparator()
      {
        ...
        {
          return Float2CharAVLTreeMap.this.storedComparator.compare(Float.valueOf(local_k1), Float.valueOf(local_k2));
        }
  ...
  public Float2CharAVLTreeMap(Comparator<? super Float> local_c)
  {
    this();
  ...
  public Float2CharAVLTreeMap(Map<? extends Float, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2CharAVLTreeMap(SortedMap<Float, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2CharAVLTreeMap(Float2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2CharAVLTreeMap(Float2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2CharAVLTreeMap(float[] local_k, char[] local_v, Comparator<? super Float> local_c)
  {
    this(local_c);
  ...
  public Float2CharAVLTreeMap(float[] local_k, char[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Float2CharMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Float2CharAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Float2CharAVLTreeMap.EntryIterator(Float2CharAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from)
        {
          return new Float2CharAVLTreeMap.EntryIterator(Float2CharAVLTreeMap.this, ((Float)from.getKey()).floatValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Float2CharAVLTreeMap.Entry local_f = Float2CharAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Float2CharAVLTreeMap.Entry local_f = Float2CharAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
          if (local_f != null) {
            Float2CharAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Float2CharAVLTreeMap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2CharEntrySet();
        }
        
        public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry local_to)
        {
          return Float2CharAVLTreeMap.this.headMap((Float)local_to.getKey()).float2CharEntrySet();
        }
        
        public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from)
        {
          return Float2CharAVLTreeMap.this.tailMap((Float)from.getKey()).float2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Float2CharAVLTreeMap.ValueIterator(Float2CharAVLTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Float2CharAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Float2CharAVLTreeMap local_c;
    try
    {
      local_c = (Float2CharAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Float2CharAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Float2CharAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Float2CharAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Float2CharMap.Entry> float2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator()
          {
            return new Float2CharAVLTreeMap.Submap.SubmapEntryIterator(Float2CharAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Float2CharMap.Entry> iterator(Float2CharMap.Entry from)
          {
            return new Float2CharAVLTreeMap.Submap.SubmapEntryIterator(Float2CharAVLTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Float, Character> local_e = (Map.Entry)local_o;
            Float2CharAVLTreeMap.Entry local_f = Float2CharAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            return (local_f != null) && (Float2CharAVLTreeMap.Submap.this.in(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Float, Character> local_e = (Map.Entry)local_o;
            Float2CharAVLTreeMap.Entry local_f = Float2CharAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            if ((local_f != null) && (Float2CharAVLTreeMap.Submap.this.in(local_f.key))) {
              Float2CharAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Float2CharAVLTreeMap.Submap.SubmapIterator(Float2CharAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Float2CharAVLTreeMap.Submap.this.clear();
          }
          
          public Float2CharMap.Entry first()
          {
            return Float2CharAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Float2CharMap.Entry last()
          {
            return Float2CharAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Float2CharMap.Entry> subSet(Float2CharMap.Entry from, Float2CharMap.Entry local_to)
          {
            return Float2CharAVLTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2CharEntrySet();
          }
          
          public ObjectSortedSet<Float2CharMap.Entry> headSet(Float2CharMap.Entry local_to)
          {
            return Float2CharAVLTreeMap.Submap.this.headMap((Float)local_to.getKey()).float2CharEntrySet();
          }
          
          public ObjectSortedSet<Float2CharMap.Entry> tailSet(Float2CharMap.Entry from)
          {
            return Float2CharAVLTreeMap.Submap.this.tailMap((Float)from.getKey()).float2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Float2CharAVLTreeMap.Submap.SubmapValueIterator(Float2CharAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Float2CharAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Float2CharAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(float local_k)
    {
      return (in(local_k)) && (Float2CharAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      float local_kk = local_k;
      Float2CharAVLTreeMap.Entry local_e;
      return (in(local_kk)) && ((local_e = Float2CharAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(float local_k, char local_v)
    {
      ...
      char oldValue = Float2CharAVLTreeMap.this.put(local_k, local_v);
    ...
    public char remove(float local_k)
    {
      ...
      char oldValue = Float2CharAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Float2CharAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Float2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Float2CharAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Float2CharSortedMap tailMap(float from)
    {
      if (this.bottom) {
        return new Submap(Float2CharAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Float2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2CharAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Float2CharSortedMap subMap(float from, float local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Float2CharAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Float2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Float2CharAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Float2CharAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Float2CharAVLTreeMap.this.locateKey(this.from);
        if (Float2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Float2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Float2CharAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Float2CharAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Float2CharAVLTreeMap.this.locateKey(this.field_47);
        if (Float2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Float2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public float firstFloatKey()
    {
      Float2CharAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public float lastFloatKey()
    {
      Float2CharAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Float2CharAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Float2CharAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(float local_k)
      {
        this();
        if (this.next != null) {
          if ((!Float2CharAVLTreeMap.Submap.this.bottom) && (Float2CharAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Float2CharAVLTreeMap.Submap.this.top) && (Float2CharAVLTreeMap.this.compare(local_k, (this.prev = Float2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Float2CharAVLTreeMap.this.locateKey(local_k);
            if (Float2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Float2CharAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2CharAVLTreeMap.this.compare(this.prev.key, Float2CharAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Float2CharAVLTreeMap.Submap.this.top) && (this.next != null) && (Float2CharAVLTreeMap.this.compare(this.next.key, Float2CharAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractFloat2CharSortedMap.KeySet
    {
      ...
      {
        return new Float2CharAVLTreeMap.Submap.SubmapKeyIterator(Float2CharAVLTreeMap.Submap.this);
      }
      
      public FloatBidirectionalIterator iterator(float from)
      {
        return new Float2CharAVLTreeMap.Submap.SubmapKeyIterator(Float2CharAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractFloat2CharSortedMap.KeySet
  {
    ...
    public FloatBidirectionalIterator iterator()
    {
      return new Float2CharAVLTreeMap.KeyIterator(Float2CharAVLTreeMap.this);
    }
    
    public FloatBidirectionalIterator iterator(float from)
    {
      return new Float2CharAVLTreeMap.KeyIterator(Float2CharAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Float2CharAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Float2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
