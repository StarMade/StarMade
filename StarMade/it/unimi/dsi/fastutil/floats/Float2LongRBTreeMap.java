  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof FloatComparator))) {
      ...
      this.actualComparator = new FloatComparator()
      {
        ...
        {
          return Float2LongRBTreeMap.this.storedComparator.compare(Float.valueOf(local_k1), Float.valueOf(local_k2));
        }
  ...
  public Float2LongRBTreeMap(Comparator<? super Float> local_c)
  {
    this();
  ...
  public Float2LongRBTreeMap(Map<? extends Float, ? extends Long> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2LongRBTreeMap(SortedMap<Float, Long> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2LongRBTreeMap(Float2LongMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2LongRBTreeMap(Float2LongSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2LongRBTreeMap(float[] local_k, long[] local_v, Comparator<? super Float> local_c)
  {
    this(local_c);
  ...
  public Float2LongRBTreeMap(float[] local_k, long[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Float2LongMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Float2LongRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Float2LongRBTreeMap.EntryIterator(Float2LongRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry from)
        {
          return new Float2LongRBTreeMap.EntryIterator(Float2LongRBTreeMap.this, ((Float)from.getKey()).floatValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Float2LongRBTreeMap.Entry local_f = Float2LongRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Float2LongRBTreeMap.Entry local_f = Float2LongRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
          if (local_f != null) {
            Float2LongRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Float2LongRBTreeMap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2LongEntrySet();
        }
        
        public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry local_to)
        {
          return Float2LongRBTreeMap.this.headMap((Float)local_to.getKey()).float2LongEntrySet();
        }
        
        public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry from)
        {
          return Float2LongRBTreeMap.this.tailMap((Float)from.getKey()).float2LongEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Float2LongRBTreeMap.ValueIterator(Float2LongRBTreeMap.this, null);
        }
        
        public boolean contains(long local_k)
        {
          return Float2LongRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Float2LongRBTreeMap local_c;
    try
    {
      local_c = (Float2LongRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Float2LongRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Float2LongRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Float2LongRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator()
          {
            return new Float2LongRBTreeMap.Submap.SubmapEntryIterator(Float2LongRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry from)
          {
            return new Float2LongRBTreeMap.Submap.SubmapEntryIterator(Float2LongRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Float, Long> local_e = (Map.Entry)local_o;
            Float2LongRBTreeMap.Entry local_f = Float2LongRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            return (local_f != null) && (Float2LongRBTreeMap.Submap.this.in(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Float, Long> local_e = (Map.Entry)local_o;
            Float2LongRBTreeMap.Entry local_f = Float2LongRBTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            if ((local_f != null) && (Float2LongRBTreeMap.Submap.this.in(local_f.key))) {
              Float2LongRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Float2LongRBTreeMap.Submap.SubmapIterator(Float2LongRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Float2LongRBTreeMap.Submap.this.clear();
          }
          
          public Float2LongMap.Entry first()
          {
            return Float2LongRBTreeMap.Submap.this.firstEntry();
          }
          
          public Float2LongMap.Entry last()
          {
            return Float2LongRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry from, Float2LongMap.Entry local_to)
          {
            return Float2LongRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2LongEntrySet();
          }
          
          public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry local_to)
          {
            return Float2LongRBTreeMap.Submap.this.headMap((Float)local_to.getKey()).float2LongEntrySet();
          }
          
          public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry from)
          {
            return Float2LongRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2LongEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public LongCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractLongCollection()
        {
          public LongIterator iterator()
          {
            return new Float2LongRBTreeMap.Submap.SubmapValueIterator(Float2LongRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(long local_k)
          {
            return Float2LongRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Float2LongRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(float local_k)
    {
      return (in(local_k)) && (Float2LongRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      float local_kk = local_k;
      Float2LongRBTreeMap.Entry local_e;
      return (in(local_kk)) && ((local_e = Float2LongRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public long put(float local_k, long local_v)
    {
      ...
      long oldValue = Float2LongRBTreeMap.this.put(local_k, local_v);
    ...
    public long remove(float local_k)
    {
      ...
      long oldValue = Float2LongRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Float2LongRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Float2LongRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Float2LongRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Float2LongSortedMap tailMap(float from)
    {
      if (this.bottom) {
        return new Submap(Float2LongRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Float2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2LongRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Float2LongSortedMap subMap(float from, float local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Float2LongRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Float2LongRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Float2LongRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Float2LongRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Float2LongRBTreeMap.this.locateKey(this.from);
        if (Float2LongRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Float2LongRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Float2LongRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Float2LongRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Float2LongRBTreeMap.this.locateKey(this.field_47);
        if (Float2LongRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Float2LongRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public float firstFloatKey()
    {
      Float2LongRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public float lastFloatKey()
    {
      Float2LongRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Float2LongRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Float2LongRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(float local_k)
      {
        this();
        if (this.next != null) {
          if ((!Float2LongRBTreeMap.Submap.this.bottom) && (Float2LongRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Float2LongRBTreeMap.Submap.this.top) && (Float2LongRBTreeMap.this.compare(local_k, (this.prev = Float2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Float2LongRBTreeMap.this.locateKey(local_k);
            if (Float2LongRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Float2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2LongRBTreeMap.this.compare(this.prev.key, Float2LongRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Float2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Float2LongRBTreeMap.this.compare(this.next.key, Float2LongRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractFloat2LongSortedMap.KeySet
    {
      ...
      {
        return new Float2LongRBTreeMap.Submap.SubmapKeyIterator(Float2LongRBTreeMap.Submap.this);
      }
      
      public FloatBidirectionalIterator iterator(float from)
      {
        return new Float2LongRBTreeMap.Submap.SubmapKeyIterator(Float2LongRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractFloat2LongSortedMap.KeySet
  {
    ...
    public FloatBidirectionalIterator iterator()
    {
      return new Float2LongRBTreeMap.KeyIterator(Float2LongRBTreeMap.this);
    }
    
    public FloatBidirectionalIterator iterator(float from)
    {
      return new Float2LongRBTreeMap.KeyIterator(Float2LongRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Float2LongRBTreeMap.this.locateKey(local_k)) != null) {
        if (Float2LongRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
