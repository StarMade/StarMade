...
public class Float2IntMaps
{
  ...
  public static Float2IntMap synchronize(Float2IntMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Float2IntMap synchronize(Float2IntMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Float2IntMap unmodifiable(Float2IntMap local_m)
  {
    ...
    implements Float2IntMap, Serializable
  {
    ...
    protected UnmodifiableMap(Float2IntMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    public Integer put(Float local_k, Integer local_v)
    {
      throw new UnsupportedOperationException();
    }
    ...
    implements Float2IntMap, Serializable
  {
    ...
    protected SynchronizedMap(Float2IntMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Float2IntMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Float2IntMap, Serializable, Cloneable
  {
      ...
      implements Float2IntMap.Entry, Map.Entry<Float, Integer>
    {
      ...
      public Float getKey()
      {
        return Float.valueOf(Float2IntMaps.Singleton.this.key);
      }
      
      public Integer getValue()
      {
        return Integer.valueOf(Float2IntMaps.Singleton.this.value);
      }
      
      public float getFloatKey()
      {
        return Float2IntMaps.Singleton.this.key;
      }
      
      public int getIntValue()
      {
        return Float2IntMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Float2IntMaps.Singleton.this.key == ((Float)local_e.getKey()).floatValue()) && (Float2IntMaps.Singleton.this.value == ((Integer)local_e.getValue()).intValue());
      }
      
      public int hashCode()
      {
        return HashCommon.float2int(Float2IntMaps.Singleton.this.key) ^ Float2IntMaps.Singleton.this.value;
      }
      
      public String toString()
      {
        return Float2IntMaps.Singleton.this.key + "->" + Float2IntMaps.Singleton.this.value;
      }
    }
  }
