  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2BooleanLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2BooleanLinkedOpenHashMap(Map<? extends Float, ? extends Boolean> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2BooleanLinkedOpenHashMap(Map<? extends Float, ? extends Boolean> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2BooleanLinkedOpenHashMap(Float2BooleanMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2BooleanLinkedOpenHashMap(Float2BooleanMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2BooleanLinkedOpenHashMap(float[] local_k, boolean[] local_v, float local_f)
  {
  ...
  public Float2BooleanLinkedOpenHashMap(float[] local_k, boolean[] local_v)
  {
  ...
  public boolean getAndMoveToFirst(float local_k)
  {
    float[] key = this.key;
  ...
  public boolean getAndMoveToLast(float local_k)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public boolean putAndMoveToFirst(float local_k, boolean local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public boolean putAndMoveToLast(float local_k, boolean local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Float2BooleanLinkedOpenHashMap.ValueIterator(Float2BooleanLinkedOpenHashMap.this);
        }
        ...
        {
          return Float2BooleanLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2BooleanLinkedOpenHashMap local_c;
    try
    {
      local_c = (Float2BooleanLinkedOpenHashMap)super.clone();
    }
    ...
    implements BooleanListIterator
  {
    ...
    {
      return Boolean.valueOf(Float2BooleanLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Boolean next()
    {
      return Boolean.valueOf(Float2BooleanLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSortedSet
  {
    ...
    {
      return new Float2BooleanLinkedOpenHashMap.KeyIterator(Float2BooleanLinkedOpenHashMap.this, from);
    }
    
    public FloatListIterator iterator()
    {
      return new Float2BooleanLinkedOpenHashMap.KeyIterator(Float2BooleanLinkedOpenHashMap.this);
    }
    ...
    {
      return Float2BooleanLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2BooleanLinkedOpenHashMap.this.size;
      Float2BooleanLinkedOpenHashMap.this.remove(local_k);
    ...
    implements FloatListIterator
  {
    ...
    {
      return Float.valueOf(Float2BooleanLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Float2BooleanLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2BooleanSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Float2BooleanLinkedOpenHashMap.EntryIterator(Float2BooleanLinkedOpenHashMap.this);
    }
    ...
    public Float2BooleanMap.Entry first()
    {
      ...
      return new Float2BooleanLinkedOpenHashMap.MapEntry(Float2BooleanLinkedOpenHashMap.this, Float2BooleanLinkedOpenHashMap.this.first);
    }
    ...
    public Float2BooleanMap.Entry last()
    {
      ...
      return new Float2BooleanLinkedOpenHashMap.MapEntry(Float2BooleanLinkedOpenHashMap.this, Float2BooleanLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2BooleanLinkedOpenHashMap.this.mask; Float2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2BooleanLinkedOpenHashMap.this.mask) {
        if (Float2BooleanLinkedOpenHashMap.this.key[pos] == local_k) {
          return Float2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)local_e.getValue()).booleanValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2BooleanLinkedOpenHashMap.this.mask; Float2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2BooleanLinkedOpenHashMap.this.mask) {
        if (Float2BooleanLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Float2BooleanLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Float2BooleanLinkedOpenHashMap.EntryIterator(Float2BooleanLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
    
    public ObjectBidirectionalIterator<Float2BooleanMap.Entry> fastIterator()
    {
      return new Float2BooleanLinkedOpenHashMap.FastEntryIterator(Float2BooleanLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Float2BooleanMap.Entry> fastIterator(Float2BooleanMap.Entry from)
    {
      return new Float2BooleanLinkedOpenHashMap.FastEntryIterator(Float2BooleanLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
  }
    ...
    implements ObjectListIterator<Float2BooleanMap.Entry>
  {
    ...
    public AbstractFloat2BooleanMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2BooleanLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Float2BooleanLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Float2BooleanMap.Entry>
  {
    ...
    {
      return this.entry = new Float2BooleanLinkedOpenHashMap.MapEntry(Float2BooleanLinkedOpenHashMap.this, nextEntry());
    }
    
    public Float2BooleanLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Float2BooleanLinkedOpenHashMap.MapEntry(Float2BooleanLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(float from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2BooleanLinkedOpenHashMap.this.mask; Float2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2BooleanLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Float2BooleanLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Float2BooleanLinkedOpenHashMap.this.first = this.next;
      } else {
        Float2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Float2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Float2BooleanLinkedOpenHashMap.this.last = this.prev;
      } else {
        Float2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Float2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2BooleanLinkedOpenHashMap.this.mask; Float2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2BooleanLinkedOpenHashMap.this.mask)
        {
        ...
        if (Float2BooleanLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Float2BooleanMap.Entry, Map.Entry<Float, Boolean>
  {
    ...
    public boolean setValue(boolean local_v)
    {
      ...
      Float2BooleanLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Boolean> local_e = (Map.Entry)local_o;
      return (Float2BooleanLinkedOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)local_e.getValue()).booleanValue());
    }
    
    public int hashCode()
    {
      return HashCommon.float2int(Float2BooleanLinkedOpenHashMap.this.key[this.index]) ^ (Float2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
    }
