...
/*  746 */   public Float2BooleanSortedMap tailMap(float from) { throw new UnsupportedOperationException(); } 
/*  747 */   public Float2BooleanSortedMap headMap(float to) { throw new UnsupportedOperationException(); } 
/*  748 */   public Float2BooleanSortedMap subMap(float from, float to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1067 */           return new Float2BooleanLinkedOpenHashMap.ValueIterator(Float2BooleanLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1070 */           return Float2BooleanLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(boolean v) {
/* 1073 */           return Float2BooleanLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1076 */           Float2BooleanLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1209 */       c = (Float2BooleanLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2BooleanLinkedOpenHashMap.MapIterator
/*      */     implements BooleanListIterator
/*      */   {
/*      */     public boolean previousBoolean()
/*      */     {
/* 1054 */       return Float2BooleanLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1055 */     public Boolean previous() { return Boolean.valueOf(Float2BooleanLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1061 */     public boolean nextBoolean() { return Float2BooleanLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1062 */     public Boolean next() { return Boolean.valueOf(Float2BooleanLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1011 */       return new Float2BooleanLinkedOpenHashMap.KeyIterator(Float2BooleanLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public FloatListIterator iterator() {
/* 1014 */       return new Float2BooleanLinkedOpenHashMap.KeyIterator(Float2BooleanLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1017 */       return Float2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(float k) {
/* 1020 */       return Float2BooleanLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(float k) {
/* 1023 */       int oldSize = Float2BooleanLinkedOpenHashMap.this.size;
/* 1024 */       Float2BooleanLinkedOpenHashMap.this.remove(k);
/* 1025 */       return Float2BooleanLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1028 */       Float2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public float firstFloat() {
/* 1031 */       if (Float2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1032 */       return Float2BooleanLinkedOpenHashMap.this.key[Float2BooleanLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public float lastFloat() {
/* 1035 */       if (Float2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1036 */       return Float2BooleanLinkedOpenHashMap.this.key[Float2BooleanLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2BooleanLinkedOpenHashMap.MapIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator(float k)
/*      */     {
/*  998 */       super(k, null); } 
/*  999 */     public float previousFloat() { return Float2BooleanLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1002 */     public Float previous() { return Float.valueOf(Float2BooleanLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1006 */     public float nextFloat() { return Float2BooleanLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1007 */     public Float next() { return Float.valueOf(Float2BooleanLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  926 */       return new Float2BooleanLinkedOpenHashMap.EntryIterator(Float2BooleanLinkedOpenHashMap.this);
/*      */     }
/*  928 */     public Comparator<? super Float2BooleanMap.Entry> comparator() { return null; } 
/*  929 */     public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry fromElement, Float2BooleanMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  930 */     public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  931 */     public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Float2BooleanMap.Entry first() {
/*  933 */       if (Float2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  934 */       return new Float2BooleanLinkedOpenHashMap.MapEntry(Float2BooleanLinkedOpenHashMap.this, Float2BooleanLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Float2BooleanMap.Entry last() {
/*  937 */       if (Float2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  938 */       return new Float2BooleanLinkedOpenHashMap.MapEntry(Float2BooleanLinkedOpenHashMap.this, Float2BooleanLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  946 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2BooleanLinkedOpenHashMap.this.mask;
/*      */ 
/*  948 */       while (Float2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  949 */         if (Float2BooleanLinkedOpenHashMap.this.key[pos] == k) return Float2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/*  950 */         pos = pos + 1 & Float2BooleanLinkedOpenHashMap.this.mask;
/*      */       }
/*  952 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  960 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2BooleanLinkedOpenHashMap.this.mask;
/*      */ 
/*  962 */       while (Float2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  963 */         if (Float2BooleanLinkedOpenHashMap.this.key[pos] == k) {
/*  964 */           Float2BooleanLinkedOpenHashMap.this.remove(e.getKey());
/*  965 */           return true;
/*      */         }
/*  967 */         pos = pos + 1 & Float2BooleanLinkedOpenHashMap.this.mask;
/*      */       }
/*  969 */       return false;
/*      */     }
/*      */     public int size() {
/*  972 */       return Float2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  975 */       Float2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry from) {
/*  978 */       return new Float2BooleanLinkedOpenHashMap.EntryIterator(Float2BooleanLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2BooleanMap.Entry> fastIterator() {
/*  981 */       return new Float2BooleanLinkedOpenHashMap.FastEntryIterator(Float2BooleanLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2BooleanMap.Entry> fastIterator(Float2BooleanMap.Entry from) {
/*  984 */       return new Float2BooleanLinkedOpenHashMap.FastEntryIterator(Float2BooleanLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Float2BooleanLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2BooleanMap.Entry>
/*      */   {
/*  904 */     final AbstractFloat2BooleanMap.BasicEntry entry = new AbstractFloat2BooleanMap.BasicEntry(0.0F, false);
/*      */ 
...
/*  910 */       int e = nextEntry();
/*  911 */       this.entry.key = Float2BooleanLinkedOpenHashMap.this.key[e];
/*  912 */       this.entry.value = Float2BooleanLinkedOpenHashMap.this.value[e];
/*  913 */       return this.entry;
/*      */     }
/*      */     public AbstractFloat2BooleanMap.BasicEntry previous() {
/*  916 */       int e = previousEntry();
/*  917 */       this.entry.key = Float2BooleanLinkedOpenHashMap.this.key[e];
/*  918 */       this.entry.value = Float2BooleanLinkedOpenHashMap.this.value[e];
/*  919 */       return this.entry;
/*      */     }
/*  921 */     public void set(Float2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  922 */     public void add(Float2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2BooleanLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2BooleanMap.Entry>
/*      */   {
...
/*  890 */       return this.entry = new Float2BooleanLinkedOpenHashMap.MapEntry(Float2BooleanLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Float2BooleanLinkedOpenHashMap.MapEntry previous() {
/*  893 */       return this.entry = new Float2BooleanLinkedOpenHashMap.MapEntry(Float2BooleanLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  897 */       super.remove();
/*  898 */       Float2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  900 */     public void set(Float2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  901 */     public void add(Float2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  763 */     int index = -1;
/*      */ 
/*  765 */     private MapIterator() { this.next = Float2BooleanLinkedOpenHashMap.this.first;
/*  766 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(float from) {
/*  769 */       if (Float2BooleanLinkedOpenHashMap.this.key[Float2BooleanLinkedOpenHashMap.this.last] == from) {
/*  770 */         this.prev = Float2BooleanLinkedOpenHashMap.this.last;
/*  771 */         this.index = Float2BooleanLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  775 */         int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2BooleanLinkedOpenHashMap.this.mask;
/*      */ 
/*  777 */         while (Float2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  778 */           if (Float2BooleanLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  780 */             this.next = ((int)Float2BooleanLinkedOpenHashMap.this.link[pos]);
/*  781 */             this.prev = pos;
/*  782 */             return;
/*      */           }
/*  784 */           pos = pos + 1 & Float2BooleanLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  797 */       if (this.next == -1) {
/*  798 */         this.index = Float2BooleanLinkedOpenHashMap.this.size;
/*  799 */         return;
/*      */       }
/*  801 */       int pos = Float2BooleanLinkedOpenHashMap.this.first;
/*  802 */       this.index = 1;
/*  803 */       while (pos != this.prev) {
/*  804 */         pos = (int)Float2BooleanLinkedOpenHashMap.this.link[pos];
/*  805 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  817 */       if (!hasNext()) return Float2BooleanLinkedOpenHashMap.this.size();
/*  818 */       this.curr = this.next;
/*  819 */       this.next = ((int)Float2BooleanLinkedOpenHashMap.this.link[this.curr]);
...
/*  827 */       this.prev = ((int)(Float2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  839 */         this.index -= 1;
/*  840 */         this.prev = ((int)(Float2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  843 */         this.next = ((int)Float2BooleanLinkedOpenHashMap.this.link[this.curr]);
/*  844 */       }Float2BooleanLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  847 */       if (this.prev == -1) Float2BooleanLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  849 */         Float2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Float2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  850 */       if (this.next == -1) Float2BooleanLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  852 */         Float2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Float2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  856 */         pos = (last = pos) + 1 & Float2BooleanLinkedOpenHashMap.this.mask;
/*  857 */         while (Float2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  858 */           int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2BooleanLinkedOpenHashMap.this.key[pos])) & Float2BooleanLinkedOpenHashMap.this.mask;
/*  859 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  860 */           pos = pos + 1 & Float2BooleanLinkedOpenHashMap.this.mask;
/*      */         }
/*  862 */         if (Float2BooleanLinkedOpenHashMap.this.used[pos] == 0) break;
/*  863 */         Float2BooleanLinkedOpenHashMap.this.key[last] = Float2BooleanLinkedOpenHashMap.this.key[pos];
/*  864 */         Float2BooleanLinkedOpenHashMap.this.value[last] = Float2BooleanLinkedOpenHashMap.this.value[pos];
/*  865 */         if (this.next == pos) this.next = last;
/*  866 */         if (this.prev == pos) this.prev = last;
/*  867 */         Float2BooleanLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  869 */       Float2BooleanLinkedOpenHashMap.this.used[last] = false;
/*  870 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Float getKey() {
/*  629 */       return Float.valueOf(Float2BooleanLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public float getFloatKey() {
/*  632 */       return Float2BooleanLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Boolean getValue() {
/*  635 */       return Boolean.valueOf(Float2BooleanLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public boolean getBooleanValue() {
/*  638 */       return Float2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public boolean setValue(boolean v) {
/*  641 */       boolean oldValue = Float2BooleanLinkedOpenHashMap.this.value[this.index];
/*  642 */       Float2BooleanLinkedOpenHashMap.this.value[this.index] = v;
/*  643 */       return oldValue;
/*      */     }
/*      */     public Boolean setValue(Boolean v) {
...
/*  652 */       return (Float2BooleanLinkedOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     public int hashCode() {
/*  655 */       return HashCommon.float2int(Float2BooleanLinkedOpenHashMap.this.key[this.index]) ^ (Float2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
/*      */     }
/*      */     public String toString() {
/*  658 */       return Float2BooleanLinkedOpenHashMap.this.key[this.index] + "=>" + Float2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
