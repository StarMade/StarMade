...
/*  18:    */
/*  87:    */public class Float2CharOpenHashMap
/*  88:    */  extends AbstractFloat2CharMap
...
/* 101:    */  protected volatile transient Float2CharMap.FastEntrySet entries;
/* 102:    */  protected volatile transient FloatSet keys;
/* 103:    */  protected volatile transient CharCollection values;
/* 104:    */  
/* 105:    */  public Float2CharOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Float2CharOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Float2CharOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Float2CharOpenHashMap(Map<? extends Float, ? extends Character> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Float2CharOpenHashMap(Map<? extends Float, ? extends Character> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Float2CharOpenHashMap(Float2CharMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Float2CharOpenHashMap(Float2CharMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Float2CharOpenHashMap(float[] k, char[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Float2CharOpenHashMap(float[] k, char[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public char put(float k, char v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Character put(Float ok, Character ov) { char v = ov.charValue();
...
/* 249:    */  }
/* 250:    */  
/* 251:    */  public char remove(float k)
/* 252:    */  {
...
/* 282:    */  }
/* 283:    */  
/* 284:284 */  public Character get(Float ok) { float k = ok.floatValue();
/* 285:    */    
...
/* 359:    */    implements Float2CharMap.Entry, Map.Entry<Float, Character>
/* 360:    */  {
...
/* 366:    */    }
/* 367:    */    
/* 368:368 */    public Float getKey() { return Float.valueOf(Float2CharOpenHashMap.this.key[this.index]); }
/* 369:    */    
/* 370:    */    public float getFloatKey() {
/* 371:371 */      return Float2CharOpenHashMap.this.key[this.index];
/* 372:    */    }
/* 373:    */    
/* 374:374 */    public Character getValue() { return Character.valueOf(Float2CharOpenHashMap.this.value[this.index]); }
/* 375:    */    
/* 377:377 */    public char getCharValue() { return Float2CharOpenHashMap.this.value[this.index]; }
/* 378:    */    
/* 379:    */    public char setValue(char v) {
/* 380:380 */      char oldValue = Float2CharOpenHashMap.this.value[this.index];
/* 381:381 */      Float2CharOpenHashMap.this.value[this.index] = v;
...
/* 390:390 */      Map.Entry<Float, Character> e = (Map.Entry)o;
/* 391:391 */      return (Float2CharOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public int hashCode() { return HashCommon.float2int(Float2CharOpenHashMap.this.key[this.index]) ^ Float2CharOpenHashMap.this.value[this.index]; }
/* 395:    */    
/* 397:397 */    public String toString() { return Float2CharOpenHashMap.this.key[this.index] + "=>" + Float2CharOpenHashMap.this.value[this.index]; } }
/* 398:    */  
...
/* 403:    */    
/* 404:404 */    private MapIterator() { this.pos = Float2CharOpenHashMap.this.n;
/* 405:    */      
/* 407:407 */      this.last = -1;
/* 408:    */      
/* 409:409 */      this.c = Float2CharOpenHashMap.this.size;
/* 410:    */      
/* 414:414 */      boolean[] used = Float2CharOpenHashMap.this.used;
...
/* 426:    */        
/* 427:427 */        int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2CharOpenHashMap.this.mask;
/* 428:    */        
/* 429:429 */        while (Float2CharOpenHashMap.this.used[pos] != 0) {
/* 430:430 */          if (Float2CharOpenHashMap.this.key[pos] == k) return pos;
/* 431:431 */          pos = pos + 1 & Float2CharOpenHashMap.this.mask;
/* 432:    */        }
/* 433:    */      }
/* 434:434 */      this.last = this.pos;
/* 435:    */      
/* 436:436 */      if (this.c != 0) {
/* 437:437 */        boolean[] used = Float2CharOpenHashMap.this.used;
...
/* 452:    */      for (;;)
/* 453:    */      {
/* 454:454 */        pos = (last = pos) + 1 & Float2CharOpenHashMap.this.mask;
/* 455:455 */        while (Float2CharOpenHashMap.this.used[pos] != 0) {
/* 456:456 */          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2CharOpenHashMap.this.key[pos])) & Float2CharOpenHashMap.this.mask;
/* 457:457 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 458:458 */          pos = pos + 1 & Float2CharOpenHashMap.this.mask;
/* 459:    */        }
/* 460:460 */        if (Float2CharOpenHashMap.this.used[pos] == 0) break;
/* 461:461 */        if (pos < last)
/* 462:    */        {
/* 463:463 */          if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 464:464 */          this.wrapped.add(Float2CharOpenHashMap.this.key[pos]);
/* 465:    */        }
/* 466:466 */        Float2CharOpenHashMap.this.key[last] = Float2CharOpenHashMap.this.key[pos];
/* 467:467 */        Float2CharOpenHashMap.this.value[last] = Float2CharOpenHashMap.this.value[pos];
/* 468:    */      }
/* 469:469 */      Float2CharOpenHashMap.this.used[last] = false;
/* 470:470 */      return last;
/* 471:    */    }
/* 472:    */    
...
/* 476:    */      {
/* 477:477 */        Float2CharOpenHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 478:478 */        this.last = -1;
/* 479:479 */        return;
/* 480:    */      }
/* 481:481 */      Float2CharOpenHashMap.this.size -= 1;
...
/* 493:    */    } }
/* 494:    */  
/* 495:495 */  private class EntryIterator extends Float2CharOpenHashMap.MapIterator implements ObjectIterator<Float2CharMap.Entry> { private EntryIterator() { super(null); }
/* 496:    */    
/* 497:    */    private Float2CharOpenHashMap.MapEntry entry;
/* 498:498 */    public Float2CharMap.Entry next() { return this.entry = new Float2CharOpenHashMap.MapEntry(Float2CharOpenHashMap.this, nextEntry()); }
/* 499:    */    
/* 500:    */    public void remove()
/* 501:    */    {
/* 502:502 */      super.remove();
/* 503:503 */      Float2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 504:    */    } }
/* 505:    */  
/* 506:506 */  private class FastEntryIterator extends Float2CharOpenHashMap.MapIterator implements ObjectIterator<Float2CharMap.Entry> { private FastEntryIterator() { super(null); }
/* 507:507 */    final AbstractFloat2CharMap.BasicEntry entry = new AbstractFloat2CharMap.BasicEntry(0.0F, '\000');
/* 508:    */    
/* 509:509 */    public AbstractFloat2CharMap.BasicEntry next() { int e = nextEntry();
/* 510:510 */      this.entry.key = Float2CharOpenHashMap.this.key[e];
/* 511:511 */      this.entry.value = Float2CharOpenHashMap.this.value[e];
/* 512:512 */      return this.entry;
/* 513:    */    } }
/* 514:    */  
/* 515:    */  private final class MapEntrySet extends AbstractObjectSet<Float2CharMap.Entry> implements Float2CharMap.FastEntrySet { private MapEntrySet() {}
/* 516:    */    
/* 517:517 */    public ObjectIterator<Float2CharMap.Entry> iterator() { return new Float2CharOpenHashMap.EntryIterator(Float2CharOpenHashMap.this, null); }
/* 518:    */    
/* 519:    */    public ObjectIterator<Float2CharMap.Entry> fastIterator() {
/* 520:520 */      return new Float2CharOpenHashMap.FastEntryIterator(Float2CharOpenHashMap.this, null);
/* 521:    */    }
/* 522:    */    
/* 523:    */    public boolean contains(Object o) {
/* 524:524 */      if (!(o instanceof Map.Entry)) return false;
/* 525:525 */      Map.Entry<Float, Character> e = (Map.Entry)o;
/* 526:526 */      float k = ((Float)e.getKey()).floatValue();
/* 527:    */      
/* 528:528 */      int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2CharOpenHashMap.this.mask;
/* 529:    */      
/* 530:530 */      while (Float2CharOpenHashMap.this.used[pos] != 0) {
/* 531:531 */        if (Float2CharOpenHashMap.this.key[pos] == k) return Float2CharOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 532:532 */        pos = pos + 1 & Float2CharOpenHashMap.this.mask;
/* 533:    */      }
...
/* 539:539 */      Map.Entry<Float, Character> e = (Map.Entry)o;
/* 540:540 */      float k = ((Float)e.getKey()).floatValue();
/* 541:    */      
/* 542:542 */      int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2CharOpenHashMap.this.mask;
/* 543:    */      
/* 544:544 */      while (Float2CharOpenHashMap.this.used[pos] != 0) {
/* 545:545 */        if (Float2CharOpenHashMap.this.key[pos] == k) {
/* 546:546 */          Float2CharOpenHashMap.this.remove(e.getKey());
/* 547:547 */          return true;
/* 548:    */        }
/* 549:549 */        pos = pos + 1 & Float2CharOpenHashMap.this.mask;
/* 550:    */      }
/* 551:551 */      return false;
/* 552:    */    }
/* 553:    */    
/* 554:554 */    public int size() { return Float2CharOpenHashMap.this.size; }
/* 555:    */    
/* 557:557 */    public void clear() { Float2CharOpenHashMap.this.clear(); }
/* 558:    */  }
/* 559:    */  
/* 560:    */  public Float2CharMap.FastEntrySet float2CharEntrySet() {
...
/* 568:    */    extends Float2CharOpenHashMap.MapIterator
/* 569:    */    implements FloatIterator
/* 570:    */  {
/* 571:571 */    public KeyIterator() { super(null); }
/* 572:572 */    public float nextFloat() { return Float2CharOpenHashMap.this.key[nextEntry()]; }
/* 573:573 */    public Float next() { return Float.valueOf(Float2CharOpenHashMap.this.key[nextEntry()]); } }
/* 574:    */  
/* 575:    */  private final class KeySet extends AbstractFloatSet { private KeySet() {}
/* 576:    */    
/* 577:577 */    public FloatIterator iterator() { return new Float2CharOpenHashMap.KeyIterator(Float2CharOpenHashMap.this); }
/* 578:    */    
/* 579:    */    public int size() {
/* 580:580 */      return Float2CharOpenHashMap.this.size;
/* 581:    */    }
/* 582:    */    
/* 583:583 */    public boolean contains(float k) { return Float2CharOpenHashMap.this.containsKey(k); }
/* 584:    */    
/* 585:    */    public boolean remove(float k) {
/* 586:586 */      int oldSize = Float2CharOpenHashMap.this.size;
/* 587:587 */      Float2CharOpenHashMap.this.remove(k);
/* 588:588 */      return Float2CharOpenHashMap.this.size != oldSize;
/* 589:    */    }
/* 590:    */    
/* 591:591 */    public void clear() { Float2CharOpenHashMap.this.clear(); }
/* 592:    */  }
/* 593:    */  
...
/* 602:    */    extends Float2CharOpenHashMap.MapIterator
/* 603:    */    implements CharIterator
/* 604:    */  {
/* 605:605 */    public ValueIterator() { super(null); }
/* 606:606 */    public char nextChar() { return Float2CharOpenHashMap.this.value[nextEntry()]; }
/* 607:607 */    public Character next() { return Character.valueOf(Float2CharOpenHashMap.this.value[nextEntry()]); }
/* 608:    */  }
/* 609:    */  
...
/* 612:612 */          return new Float2CharOpenHashMap.ValueIterator(Float2CharOpenHashMap.this);
/* 613:    */        }
/* 614:    */        
/* 615:615 */        public int size() { return Float2CharOpenHashMap.this.size; }
/* 616:    */        
/* 617:    */        public boolean contains(char v) {
/* 618:618 */          return Float2CharOpenHashMap.this.containsValue(v);
/* 619:    */        }
/* 620:    */        
/* 621:621 */        public void clear() { Float2CharOpenHashMap.this.clear(); }
/* 622:    */      };
/* 623:    */    }
...
/* 724:    */  }
/* 725:    */  
/* 729:    */  public Float2CharOpenHashMap clone()
/* 730:    */  {
/* 731:    */    Float2CharOpenHashMap c;
/* 732:    */    
/* 734:    */    try
/* 735:    */    {
/* 736:736 */      c = (Float2CharOpenHashMap)super.clone();
/* 737:    */    }
