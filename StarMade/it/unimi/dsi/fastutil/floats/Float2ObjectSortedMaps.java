...
/*     */     }
/* 302 */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.float2ObjectEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, V>> entrySet() {
/* 304 */       return float2ObjectEntrySet(); } 
...
/* 308 */     public Float2ObjectSortedMap<V> headMap(float to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Float2ObjectSortedMap<V> tailMap(float from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Float2ObjectSortedMap<V> headMap(Float to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Float2ObjectSortedMap<V> tailMap(Float from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.float2ObjectEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, V>> entrySet() {
/* 244 */       return float2ObjectEntrySet(); } 
...
/* 248 */     public Float2ObjectSortedMap<V> headMap(float to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Float2ObjectSortedMap<V> tailMap(float from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public float firstFloatKey() {
...
/* 259 */     public Float2ObjectSortedMap<V> headMap(Float to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Float2ObjectSortedMap<V> tailMap(Float from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Float2ObjectMaps.Singleton.SingletonEntry(this), Float2ObjectSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Float, V>> entrySet() { return float2ObjectEntrySet(); } 
/*     */     public FloatSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = FloatSortedSets.singleton(this.key, this.comparator); return (FloatSortedSet)this.keys;
/*     */     }
/*     */     public Float2ObjectSortedMap<V> subMap(float from, float to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Float2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Float2ObjectSortedMap<V> headMap(float to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Float2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Float2ObjectSortedMap<V> tailMap(float from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Float2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Float2ObjectSortedMap<V> tailMap(Float ofrom) { return tailMap(ofrom.floatValue()); } 
/* 156 */     public Float2ObjectSortedMap<V> subMap(Float ofrom, Float oto) { return subMap(ofrom.floatValue(), oto.floatValue()); } 
/*     */     public Float firstKey() {
...
/*  77 */       return null;
/*     */     }
/*  79 */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> float2ObjectEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Float, V>> entrySet() {
/*  81 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  83 */     public FloatSortedSet keySet() { return FloatSortedSets.EMPTY_SET; } 
/*     */     public Float2ObjectSortedMap<V> subMap(float from, float to) {
/*  85 */       return Float2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*  87 */     public Float2ObjectSortedMap<V> headMap(float to) { return Float2ObjectSortedMaps.EMPTY_MAP; } 
/*     */     public Float2ObjectSortedMap<V> tailMap(float from) {
/*  89 */       return Float2ObjectSortedMaps.EMPTY_MAP; } 
...
/*  92 */     public Float2ObjectSortedMap<V> headMap(Float oto) { return headMap(oto.floatValue()); } 
/*  93 */     public Float2ObjectSortedMap<V> tailMap(Float ofrom) { return tailMap(ofrom.floatValue()); } 
/*  94 */     public Float2ObjectSortedMap<V> subMap(Float ofrom, Float oto) { return subMap(ofrom.floatValue(), oto.floatValue()); } 
