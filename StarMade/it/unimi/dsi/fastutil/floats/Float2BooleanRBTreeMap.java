...
/*      */ 
/*      */ public class Float2BooleanRBTreeMap extends AbstractFloat2BooleanSortedMap
...
/*  119 */           return Float2BooleanRBTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  122 */           return Float2BooleanRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     boolean oldValue = put(ok.floatValue(), ov.booleanValue());
/*  731 */     return this.modified ? null : Boolean.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Boolean remove(Object ok)
/*      */   {
/*  737 */     boolean oldValue = remove(((Float)ok).floatValue());
...
/* 1141 */         final Comparator<? super Float2BooleanMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Float2BooleanMap.Entry x, Float2BooleanMap.Entry y) {
/* 1143 */             return Float2BooleanRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Float2BooleanRBTreeMap.EntryIterator(Float2BooleanRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry from) {
/* 1153 */           return new Float2BooleanRBTreeMap.EntryIterator(Float2BooleanRBTreeMap.this, ((Float)from.getKey()).floatValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Float2BooleanRBTreeMap.Entry f = Float2BooleanRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1166 */           Float2BooleanRBTreeMap.Entry f = Float2BooleanRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1167 */           if (f != null) Float2BooleanRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Float2BooleanRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Float2BooleanRBTreeMap.this.clear(); } 
/* 1172 */         public Float2BooleanMap.Entry first() { return Float2BooleanRBTreeMap.this.firstEntry; } 
/* 1173 */         public Float2BooleanMap.Entry last() { return Float2BooleanRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry from, Float2BooleanMap.Entry to) { return Float2BooleanRBTreeMap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2BooleanEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry to) { return Float2BooleanRBTreeMap.this.headMap((Float)to.getKey()).float2BooleanEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry from) { return Float2BooleanRBTreeMap.this.tailMap((Float)from.getKey()).float2BooleanEntrySet(); }
/*      */       };
...
/* 1242 */           return new Float2BooleanRBTreeMap.ValueIterator(Float2BooleanRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(boolean k) {
/* 1245 */           return Float2BooleanRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Float2BooleanRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Float2BooleanRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Float2BooleanRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readFloat(), s.readBoolean());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readFloat(), s.readBoolean());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readFloat(), s.readBoolean()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Float2BooleanRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Float2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1323 */       return ((this.bottom) || (Float2BooleanRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Float2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Float2BooleanMap.Entry> float2BooleanEntrySet() {
/* 1327 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator() {
/* 1329 */             return new Float2BooleanRBTreeMap.Submap.SubmapEntryIterator(Float2BooleanRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Float2BooleanMap.Entry> iterator(Float2BooleanMap.Entry from) {
/* 1332 */             return new Float2BooleanRBTreeMap.Submap.SubmapEntryIterator(Float2BooleanRBTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
/*      */           }
/* 1334 */           public Comparator<? super Float2BooleanMap.Entry> comparator() { return Float2BooleanRBTreeMap.this.float2BooleanEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Float2BooleanRBTreeMap.Entry f = Float2BooleanRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1340 */             return (f != null) && (Float2BooleanRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Float2BooleanRBTreeMap.Entry f = Float2BooleanRBTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1347 */             if ((f != null) && (Float2BooleanRBTreeMap.Submap.this.in(f.key))) Float2BooleanRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Float2BooleanRBTreeMap.Submap.SubmapIterator(Float2BooleanRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Float2BooleanRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Float2BooleanMap.Entry first() { return Float2BooleanRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Float2BooleanMap.Entry last() { return Float2BooleanRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Float2BooleanMap.Entry> subSet(Float2BooleanMap.Entry from, Float2BooleanMap.Entry to) { return Float2BooleanRBTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2BooleanEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Float2BooleanMap.Entry> headSet(Float2BooleanMap.Entry to) { return Float2BooleanRBTreeMap.Submap.this.headMap((Float)to.getKey()).float2BooleanEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Float2BooleanMap.Entry> tailSet(Float2BooleanMap.Entry from) { return Float2BooleanRBTreeMap.Submap.this.tailMap((Float)from.getKey()).float2BooleanEntrySet(); }
/*      */         };
...
/*      */           public BooleanIterator iterator() {
/* 1376 */             return new Float2BooleanRBTreeMap.Submap.SubmapValueIterator(Float2BooleanRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(boolean k) {
/* 1379 */             return Float2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Float2BooleanRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Float2BooleanRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(float k) {
/* 1392 */       return (in(k)) && (Float2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(boolean v) {
...
/* 1407 */       return (in(kk)) && ((e = Float2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public boolean put(float k, boolean v) {
/* 1410 */       Float2BooleanRBTreeMap.this.modified = false;
...
/* 1412 */       boolean oldValue = Float2BooleanRBTreeMap.this.put(k, v);
/* 1413 */       return Float2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Boolean put(Float ok, Boolean ov) {
/* 1416 */       boolean oldValue = put(ok.floatValue(), ov.booleanValue());
/* 1417 */       return Float2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public boolean remove(float k) {
/* 1421 */       Float2BooleanRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       boolean oldValue = Float2BooleanRBTreeMap.this.remove(k);
/* 1424 */       return Float2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Boolean remove(Object ok) {
/* 1427 */       boolean oldValue = remove(((Float)ok).floatValue());
/* 1428 */       return Float2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1443 */       return Float2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Float2BooleanSortedMap headMap(float to) {
/* 1446 */       if (this.top) return new Submap(Float2BooleanRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Float2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Float2BooleanRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Float2BooleanSortedMap tailMap(float from) {
/* 1450 */       if (this.bottom) return new Submap(Float2BooleanRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Float2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2BooleanRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Float2BooleanSortedMap subMap(float from, float to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Float2BooleanRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Float2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Float2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Float2BooleanRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Float2BooleanRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Float2BooleanRBTreeMap.this.tree == null) return null;
/* 1468 */       Float2BooleanRBTreeMap.Entry e;
/*      */       Float2BooleanRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Float2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Float2BooleanRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Float2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Float2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Float2BooleanRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Float2BooleanRBTreeMap.this.tree == null) return null;
/* 1486 */       Float2BooleanRBTreeMap.Entry e;
/*      */       Float2BooleanRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Float2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Float2BooleanRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Float2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Float2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public float firstFloatKey() {
/* 1497 */       Float2BooleanRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public float lastFloatKey() {
/* 1502 */       Float2BooleanRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Float firstKey() {
/* 1507 */       Float2BooleanRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Float lastKey() {
/* 1512 */       Float2BooleanRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Float2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Float2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Float2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Float2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Float2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Float2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Float2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Float2BooleanRBTreeMap.Submap.this.bottom) && (Float2BooleanRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Float2BooleanRBTreeMap.Submap.this.top) && (Float2BooleanRBTreeMap.this.compare(k, (this.prev = Float2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Float2BooleanRBTreeMap.this.locateKey(k);
/* 1534 */             if (Float2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Float2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2BooleanRBTreeMap.this.compare(this.prev.key, Float2BooleanRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Float2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Float2BooleanRBTreeMap.this.compare(this.next.key, Float2BooleanRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public FloatBidirectionalIterator iterator() { return new Float2BooleanRBTreeMap.Submap.SubmapKeyIterator(Float2BooleanRBTreeMap.Submap.this); } 
/* 1367 */       public FloatBidirectionalIterator iterator(float from) { return new Float2BooleanRBTreeMap.Submap.SubmapKeyIterator(Float2BooleanRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2BooleanRBTreeMap.TreeIterator
/*      */     implements BooleanListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public FloatBidirectionalIterator iterator() { return new Float2BooleanRBTreeMap.KeyIterator(Float2BooleanRBTreeMap.this); } 
/* 1201 */     public FloatBidirectionalIterator iterator(float from) { return new Float2BooleanRBTreeMap.KeyIterator(Float2BooleanRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2BooleanRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2BooleanRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Float2BooleanMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Float2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Float2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Float2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Float2BooleanRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(float k) {
/* 1067 */       if ((this.next = Float2BooleanRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Float2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Float2BooleanRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/*  983 */       return HashCommon.float2int(this.key) ^ (this.value ? 1231 : 1237);
/*      */     }
/*      */ 
