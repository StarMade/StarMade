...
/*      */ 
/*      */ public class FloatAVLTreeSet extends AbstractFloatSortedSet
...
/*      */   {
/*   94 */     if ((this.storedComparator == null) || ((this.storedComparator instanceof FloatComparator))) this.actualComparator = ((FloatComparator)this.storedComparator); else
/*   95 */       this.actualComparator = new FloatComparator() {
/*      */         public int compare(float k1, float k2) {
/*   97 */           return FloatAVLTreeSet.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  100 */           return FloatAVLTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*   74 */     allocatePaths();
/*      */ 
/*  160 */     while (i.hasNext()) add(i.nextFloat());
/*      */   }
/*      */ 
/*      */   public FloatAVLTreeSet(Iterator<? extends Float> i)
/*      */   {
/*  171 */     this(FloatIterators.asFloatIterator(i));
/*      */   }
/*      */ 
/*      */   public FloatAVLTreeSet(float[] a, int offset, int length, Comparator<? super Float> c)
/*      */   {
/*  184 */     this(c);
/*  185 */     FloatArrays.ensureOffsetLength(a, offset, length);
...
/* 1086 */     return new Subset(0.0F, true, to, false);
/*      */   }
/*      */   public FloatSortedSet tailSet(float from) {
/* 1089 */     return new Subset(from, false, 0.0F, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1284 */       c = (FloatAVLTreeSet)super.clone();
/*      */     }
...
/* 1337 */     while (n-- != 0) s.writeFloat(i.nextFloat());
/*      */   }
/*      */ 
...
/*      */   {
/* 1348 */     if (n == 1) {
/* 1349 */       Entry top = new Entry(s.readFloat());
/* 1350 */       top.pred(pred);
/* 1351 */       top.succ(succ);
/* 1352 */       return top;
/*      */     }
/* 1354 */     if (n == 2)
/*      */     {
/* 1357 */       Entry top = new Entry(s.readFloat());
/* 1358 */       top.right(new Entry(s.readFloat()));
...
/*      */   }
/*      */ 
/*      */   private final class Subset extends AbstractFloatSortedSet
...
/*      */     {
/* 1121 */       if ((!bottom) && (!top) && (FloatAVLTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1122 */       this.from = from;
...
/*      */     {
/* 1139 */       return ((this.bottom) || (FloatAVLTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (FloatAVLTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(float k)
/*      */     {
/* 1144 */       return (in(k)) && (FloatAVLTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(float k) {
...
/* 1148 */       return FloatAVLTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(float k) {
/* 1152 */       if (!in(k)) return false;
/* 1153 */       return FloatAVLTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1168 */       return FloatAVLTreeSet.this.actualComparator;
/*      */     }
/*      */     public FloatBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public FloatSortedSet headSet(float to) {
/* 1177 */       if (this.top) return new Subset(FloatAVLTreeSet.this, this.from, this.bottom, to, false);
/* 1178 */       return FloatAVLTreeSet.this.compare(to, this.to) < 0 ? new Subset(FloatAVLTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public FloatSortedSet tailSet(float from) {
/* 1181 */       if (this.bottom) return new Subset(FloatAVLTreeSet.this, from, false, this.to, this.top);
/* 1182 */       return FloatAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(FloatAVLTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public FloatSortedSet subSet(float from, float to) {
/* 1185 */       if ((this.top) && (this.bottom)) return new Subset(FloatAVLTreeSet.this, from, false, to, false);
/* 1186 */       if (!this.top) to = FloatAVLTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1187 */       if (!this.bottom) from = FloatAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1188 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1189 */       return new Subset(FloatAVLTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public FloatAVLTreeSet.Entry firstEntry()
/*      */     {
/* 1196 */       if (FloatAVLTreeSet.this.tree == null) return null;
/* 1199 */       FloatAVLTreeSet.Entry e;
/*      */       FloatAVLTreeSet.Entry e;
/* 1199 */       if (this.bottom) { e = FloatAVLTreeSet.this.firstEntry;
/*      */       } else {
/* 1201 */         e = FloatAVLTreeSet.this.locateKey(this.from);
/*      */ 
/* 1203 */         if (FloatAVLTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1206 */       if ((e == null) || ((!this.top) && (FloatAVLTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1207 */       return e;
/*      */     }
/*      */ 
/*      */     public FloatAVLTreeSet.Entry lastEntry()
/*      */     {
/* 1214 */       if (FloatAVLTreeSet.this.tree == null) return null;
/* 1217 */       FloatAVLTreeSet.Entry e;
/*      */       FloatAVLTreeSet.Entry e;
/* 1217 */       if (this.top) { e = FloatAVLTreeSet.this.lastEntry;
/*      */       } else {
/* 1219 */         e = FloatAVLTreeSet.this.locateKey(this.to);
/*      */ 
/* 1221 */         if (FloatAVLTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1224 */       if ((e == null) || ((!this.bottom) && (FloatAVLTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1225 */       return e;
/*      */     }
/*      */     public float firstFloat() {
/* 1228 */       FloatAVLTreeSet.Entry e = firstEntry();
/* 1229 */       if (e == null) throw new NoSuchElementException();
/* 1230 */       return e.key;
/*      */     }
/*      */     public float lastFloat() {
/* 1233 */       FloatAVLTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1245 */         super();
/* 1246 */         this.next = FloatAVLTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(float k) {
/* 1249 */         this();
/* 1250 */         if (this.next != null)
/* 1251 */           if ((!FloatAVLTreeSet.Subset.this.bottom) && (FloatAVLTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1252 */           } else if ((!FloatAVLTreeSet.Subset.this.top) && (FloatAVLTreeSet.this.compare(k, (this.prev = FloatAVLTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1254 */             this.next = FloatAVLTreeSet.this.locateKey(k);
/* 1255 */             if (FloatAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1269 */         if ((!FloatAVLTreeSet.Subset.this.top) && (this.next != null) && (FloatAVLTreeSet.this.compare(this.next.key, FloatAVLTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/* 1021 */     int index = 0;
/*      */ 
/* 1023 */     SetIterator() { this.next = FloatAVLTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(float k) {
/* 1026 */       if ((this.next = FloatAVLTreeSet.this.locateKey(k)) != null)
/* 1027 */         if (FloatAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/* 1046 */     public float nextFloat() { return nextEntry().key; } 
/* 1047 */     public float previousFloat() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1070 */       updatePrevious();
/* 1071 */       updateNext();
/* 1072 */       FloatAVLTreeSet.this.remove(this.curr.key);
/* 1073 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*      */     }
/*      */     public int hashCode() {
/*  958 */       return HashCommon.float2int(this.key);
/*      */     }
