...
/*      */ 
/*      */ public class Float2LongAVLTreeMap extends AbstractFloat2LongSortedMap
...
/*  117 */           return Float2LongAVLTreeMap.this.storedComparator.compare(Float.valueOf(k1), Float.valueOf(k2));
/*      */         }
/*      */         public int compare(Float ok1, Float ok2) {
/*  120 */           return Float2LongAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     long oldValue = put(ok.floatValue(), ov.longValue());
/*  780 */     return this.modified ? null : Long.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Long remove(Object ok)
/*      */   {
/*  788 */     long oldValue = remove(((Float)ok).floatValue());
...
/* 1203 */         final Comparator<? super Float2LongMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Float2LongMap.Entry x, Float2LongMap.Entry y) {
/* 1205 */             return Float2LongAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Float2LongAVLTreeMap.EntryIterator(Float2LongAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry from) {
/* 1215 */           return new Float2LongAVLTreeMap.EntryIterator(Float2LongAVLTreeMap.this, ((Float)from.getKey()).floatValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Float2LongAVLTreeMap.Entry f = Float2LongAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
...
/* 1228 */           Float2LongAVLTreeMap.Entry f = Float2LongAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1229 */           if (f != null) Float2LongAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Float2LongAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Float2LongAVLTreeMap.this.clear(); } 
/* 1234 */         public Float2LongMap.Entry first() { return Float2LongAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Float2LongMap.Entry last() { return Float2LongAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry from, Float2LongMap.Entry to) { return Float2LongAVLTreeMap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2LongEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry to) { return Float2LongAVLTreeMap.this.headMap((Float)to.getKey()).float2LongEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry from) { return Float2LongAVLTreeMap.this.tailMap((Float)from.getKey()).float2LongEntrySet(); }
/*      */       };
...
/* 1304 */           return new Float2LongAVLTreeMap.ValueIterator(Float2LongAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(long k) {
/* 1307 */           return Float2LongAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Float2LongAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Float2LongAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Float2LongAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readFloat(), s.readLong());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readFloat(), s.readLong());
/* 1759 */       top.right(new Entry(s.readFloat(), s.readLong()));
...
/*      */   }
/*      */ 
/*      */   private final class Submap extends AbstractFloat2LongSortedMap
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Float2LongAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Float2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Float2LongAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Float2LongAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Float2LongMap.Entry> float2LongEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator() {
/* 1391 */             return new Float2LongAVLTreeMap.Submap.SubmapEntryIterator(Float2LongAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry from) {
/* 1394 */             return new Float2LongAVLTreeMap.Submap.SubmapEntryIterator(Float2LongAVLTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
/*      */           }
/* 1396 */           public Comparator<? super Float2LongMap.Entry> comparator() { return Float2LongAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Float2LongAVLTreeMap.Entry f = Float2LongAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1402 */             return (f != null) && (Float2LongAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Float2LongAVLTreeMap.Entry f = Float2LongAVLTreeMap.this.findKey(((Float)e.getKey()).floatValue());
/* 1409 */             if ((f != null) && (Float2LongAVLTreeMap.Submap.this.in(f.key))) Float2LongAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Float2LongAVLTreeMap.Submap.SubmapIterator(Float2LongAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Float2LongAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Float2LongMap.Entry first() { return Float2LongAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Float2LongMap.Entry last() { return Float2LongAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry from, Float2LongMap.Entry to) { return Float2LongAVLTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)to.getKey()).float2LongEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry to) { return Float2LongAVLTreeMap.Submap.this.headMap((Float)to.getKey()).float2LongEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry from) { return Float2LongAVLTreeMap.Submap.this.tailMap((Float)from.getKey()).float2LongEntrySet(); }
/*      */         };
...
/*      */           public LongIterator iterator() {
/* 1442 */             return new Float2LongAVLTreeMap.Submap.SubmapValueIterator(Float2LongAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(long k) {
/* 1445 */             return Float2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Float2LongAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Float2LongAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(float k) {
/* 1458 */       return (in(k)) && (Float2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(long v) {
...
/* 1473 */       return (in(kk)) && ((e = Float2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public long put(float k, long v) {
/* 1476 */       Float2LongAVLTreeMap.this.modified = false;
...
/* 1478 */       long oldValue = Float2LongAVLTreeMap.this.put(k, v);
/* 1479 */       return Float2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Long put(Float ok, Long ov) {
/* 1482 */       long oldValue = put(ok.floatValue(), ov.longValue());
/* 1483 */       return Float2LongAVLTreeMap.this.modified ? null : Long.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public long remove(float k) {
/* 1487 */       Float2LongAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       long oldValue = Float2LongAVLTreeMap.this.remove(k);
/* 1490 */       return Float2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Long remove(Object ok) {
/* 1493 */       long oldValue = remove(((Float)ok).floatValue());
/* 1494 */       return Float2LongAVLTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public FloatComparator comparator() {
/* 1509 */       return Float2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Float2LongSortedMap headMap(float to) {
/* 1512 */       if (this.top) return new Submap(Float2LongAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Float2LongAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Float2LongAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Float2LongSortedMap tailMap(float from) {
/* 1516 */       if (this.bottom) return new Submap(Float2LongAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Float2LongAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2LongAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Float2LongSortedMap subMap(float from, float to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Float2LongAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Float2LongAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Float2LongAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Float2LongAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Float2LongAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Float2LongAVLTreeMap.this.tree == null) return null;
/* 1534 */       Float2LongAVLTreeMap.Entry e;
/*      */       Float2LongAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Float2LongAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Float2LongAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Float2LongAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Float2LongAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Float2LongAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Float2LongAVLTreeMap.this.tree == null) return null;
/* 1552 */       Float2LongAVLTreeMap.Entry e;
/*      */       Float2LongAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Float2LongAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Float2LongAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Float2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Float2LongAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public float firstFloatKey() {
/* 1563 */       Float2LongAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public float lastFloatKey() {
/* 1568 */       Float2LongAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Float firstKey() {
/* 1573 */       Float2LongAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Float lastKey() {
/* 1578 */       Float2LongAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Float2LongAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Float2LongAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Float2LongAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Float2LongMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Float2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Float2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Float2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(float k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Float2LongAVLTreeMap.Submap.this.bottom) && (Float2LongAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Float2LongAVLTreeMap.Submap.this.top) && (Float2LongAVLTreeMap.this.compare(k, (this.prev = Float2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Float2LongAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Float2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Float2LongAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2LongAVLTreeMap.this.compare(this.prev.key, Float2LongAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Float2LongAVLTreeMap.Submap.this.top) && (this.next != null) && (Float2LongAVLTreeMap.this.compare(this.next.key, Float2LongAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public FloatBidirectionalIterator iterator() { return new Float2LongAVLTreeMap.Submap.SubmapKeyIterator(Float2LongAVLTreeMap.Submap.this); } 
/* 1433 */       public FloatBidirectionalIterator iterator(float from) { return new Float2LongAVLTreeMap.Submap.SubmapKeyIterator(Float2LongAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2LongAVLTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public FloatBidirectionalIterator iterator() { return new Float2LongAVLTreeMap.KeyIterator(Float2LongAVLTreeMap.this); } 
/* 1263 */     public FloatBidirectionalIterator iterator(float from) { return new Float2LongAVLTreeMap.KeyIterator(Float2LongAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2LongAVLTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2LongAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Float2LongMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Float2LongMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Float2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Float2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Float2LongAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(float k) {
/* 1129 */       if ((this.next = Float2LongAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Float2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Float2LongAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/* 1042 */       return HashCommon.float2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
