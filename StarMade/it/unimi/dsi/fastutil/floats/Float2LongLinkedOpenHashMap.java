...
/*      */   protected int size;
/*      */   protected volatile transient Float2LongSortedMap.FastSortedEntrySet entries;
...
/*  786 */   public Float2LongSortedMap tailMap(float from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Float2LongSortedMap headMap(float to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Float2LongSortedMap subMap(float from, float to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Float2LongLinkedOpenHashMap.ValueIterator(Float2LongLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Float2LongLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(long v) {
/* 1113 */           return Float2LongLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Float2LongLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Float2LongLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2LongLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public long previousLong()
/*      */     {
/* 1094 */       return Float2LongLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Long previous() { return Long.valueOf(Float2LongLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public long nextLong() { return Float2LongLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Long next() { return Long.valueOf(Float2LongLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Float2LongLinkedOpenHashMap.KeyIterator(Float2LongLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public FloatListIterator iterator() {
/* 1054 */       return new Float2LongLinkedOpenHashMap.KeyIterator(Float2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Float2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(float k) {
/* 1060 */       return Float2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(float k) {
/* 1063 */       int oldSize = Float2LongLinkedOpenHashMap.this.size;
/* 1064 */       Float2LongLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Float2LongLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Float2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public float firstFloat() {
/* 1071 */       if (Float2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Float2LongLinkedOpenHashMap.this.key[Float2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public float lastFloat() {
/* 1075 */       if (Float2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Float2LongLinkedOpenHashMap.this.key[Float2LongLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2LongLinkedOpenHashMap.MapIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator(float k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public float previousFloat() { return Float2LongLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Float previous() { return Float.valueOf(Float2LongLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public float nextFloat() { return Float2LongLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Float next() { return Float.valueOf(Float2LongLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Float2LongMap.Entry>
...
/*      */     {
/*  966 */       return new Float2LongLinkedOpenHashMap.EntryIterator(Float2LongLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Float2LongMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Float2LongMap.Entry> subSet(Float2LongMap.Entry fromElement, Float2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Float2LongMap.Entry> headSet(Float2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Float2LongMap.Entry> tailSet(Float2LongMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Float2LongMap.Entry first() {
/*  973 */       if (Float2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Float2LongLinkedOpenHashMap.MapEntry(Float2LongLinkedOpenHashMap.this, Float2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Float2LongMap.Entry last() {
/*  977 */       if (Float2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Float2LongLinkedOpenHashMap.MapEntry(Float2LongLinkedOpenHashMap.this, Float2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Float2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Float2LongLinkedOpenHashMap.this.key[pos] == k) return Float2LongLinkedOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  990 */         pos = pos + 1 & Float2LongLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2LongLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Float2LongLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Float2LongLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Float2LongLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Float2LongLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Float2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Float2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2LongMap.Entry> iterator(Float2LongMap.Entry from) {
/* 1018 */       return new Float2LongLinkedOpenHashMap.EntryIterator(Float2LongLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2LongMap.Entry> fastIterator() {
/* 1021 */       return new Float2LongLinkedOpenHashMap.FastEntryIterator(Float2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2LongMap.Entry> fastIterator(Float2LongMap.Entry from) {
/* 1024 */       return new Float2LongLinkedOpenHashMap.FastEntryIterator(Float2LongLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Float2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2LongMap.Entry>
/*      */   {
/*  944 */     final AbstractFloat2LongMap.BasicEntry entry = new AbstractFloat2LongMap.BasicEntry(0.0F, 0L);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Float2LongLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Float2LongLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractFloat2LongMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Float2LongLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Float2LongLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Float2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Float2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Float2LongMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Float2LongLinkedOpenHashMap.MapEntry(Float2LongLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Float2LongLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Float2LongLinkedOpenHashMap.MapEntry(Float2LongLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Float2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Float2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Float2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Float2LongLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(float from) {
/*  809 */       if (Float2LongLinkedOpenHashMap.this.key[Float2LongLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Float2LongLinkedOpenHashMap.this.last;
/*  811 */         this.index = Float2LongLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Float2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Float2LongLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Float2LongLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Float2LongLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Float2LongLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Float2LongLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Float2LongLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Float2LongLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Float2LongLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Float2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Float2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Float2LongLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Float2LongLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Float2LongLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Float2LongLinkedOpenHashMap.this.link[this.prev] ^= (Float2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Float2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Float2LongLinkedOpenHashMap.this.link[this.next] ^= (Float2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Float2LongLinkedOpenHashMap.this.mask;
/*  897 */         while (Float2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2LongLinkedOpenHashMap.this.key[pos])) & Float2LongLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Float2LongLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Float2LongLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Float2LongLinkedOpenHashMap.this.key[last] = Float2LongLinkedOpenHashMap.this.key[pos];
/*  904 */         Float2LongLinkedOpenHashMap.this.value[last] = Float2LongLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Float2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Float2LongLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Float getKey() {
/*  669 */       return Float.valueOf(Float2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public float getFloatKey() {
/*  672 */       return Float2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Long getValue() {
/*  675 */       return Long.valueOf(Float2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public long getLongValue() {
/*  678 */       return Float2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public long setValue(long v) {
/*  681 */       long oldValue = Float2LongLinkedOpenHashMap.this.value[this.index];
/*  682 */       Float2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Long setValue(Long v) {
...
/*  692 */       return (Float2LongLinkedOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.float2int(Float2LongLinkedOpenHashMap.this.key[this.index]) ^ HashCommon.long2int(Float2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Float2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Float2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
