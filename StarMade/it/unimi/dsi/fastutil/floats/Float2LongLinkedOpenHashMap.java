  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2LongLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2LongLinkedOpenHashMap(Map<? extends Float, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2LongLinkedOpenHashMap(Map<? extends Float, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2LongLinkedOpenHashMap(Float2LongMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2LongLinkedOpenHashMap(Float2LongMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2LongLinkedOpenHashMap(float[] local_k, long[] local_v, float local_f)
  {
  ...
  public Float2LongLinkedOpenHashMap(float[] local_k, long[] local_v)
  {
  ...
  public long getAndMoveToFirst(float local_k)
  {
    float[] key = this.key;
  ...
  public long getAndMoveToLast(float local_k)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public long putAndMoveToFirst(float local_k, long local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public long putAndMoveToLast(float local_k, long local_v)
  {
    float[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Float2LongLinkedOpenHashMap.ValueIterator(Float2LongLinkedOpenHashMap.this);
        }
        ...
        {
          return Float2LongLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2LongLinkedOpenHashMap local_c;
    try
    {
      local_c = (Float2LongLinkedOpenHashMap)super.clone();
    }
    ...
    implements LongListIterator
  {
    ...
    {
      return Long.valueOf(Float2LongLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Long next()
    {
      return Long.valueOf(Float2LongLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractFloatSortedSet
  {
    ...
    {
      return new Float2LongLinkedOpenHashMap.KeyIterator(Float2LongLinkedOpenHashMap.this, from);
    }
    
    public FloatListIterator iterator()
    {
      return new Float2LongLinkedOpenHashMap.KeyIterator(Float2LongLinkedOpenHashMap.this);
    }
    ...
    {
      return Float2LongLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2LongLinkedOpenHashMap.this.size;
      Float2LongLinkedOpenHashMap.this.remove(local_k);
    ...
    implements FloatListIterator
  {
    ...
    {
      return Float.valueOf(Float2LongLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Float2LongLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2LongSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Float2LongLinkedOpenHashMap.EntryIterator(Float2LongLinkedOpenHashMap.this);
    }
    ...
    public Float2LongMap.Entry first()
    {
      ...
      return new Float2LongLinkedOpenHashMap.MapEntry(Float2LongLinkedOpenHashMap.this, Float2LongLinkedOpenHashMap.this.first);
    }
    ...
    public Float2LongMap.Entry last()
    {
      ...
      return new Float2LongLinkedOpenHashMap.MapEntry(Float2LongLinkedOpenHashMap.this, Float2LongLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2LongLinkedOpenHashMap.this.mask; Float2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2LongLinkedOpenHashMap.this.mask) {
        if (Float2LongLinkedOpenHashMap.this.key[pos] == local_k) {
          return Float2LongLinkedOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2LongLinkedOpenHashMap.this.mask; Float2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2LongLinkedOpenHashMap.this.mask) {
        if (Float2LongLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Float2LongLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Float2LongLinkedOpenHashMap.EntryIterator(Float2LongLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
    
    public ObjectBidirectionalIterator<Float2LongMap.Entry> fastIterator()
    {
      return new Float2LongLinkedOpenHashMap.FastEntryIterator(Float2LongLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Float2LongMap.Entry> fastIterator(Float2LongMap.Entry from)
    {
      return new Float2LongLinkedOpenHashMap.FastEntryIterator(Float2LongLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
    }
  }
    ...
    implements ObjectListIterator<Float2LongMap.Entry>
  {
    ...
    public AbstractFloat2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Float2LongLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Float2LongLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Float2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Float2LongLinkedOpenHashMap.MapEntry(Float2LongLinkedOpenHashMap.this, nextEntry());
    }
    
    public Float2LongLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Float2LongLinkedOpenHashMap.MapEntry(Float2LongLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    {
      if (Float2LongLinkedOpenHashMap.this.key[Float2LongLinkedOpenHashMap.this.last] == from)
      {
      ...
      {
        for (int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2LongLinkedOpenHashMap.this.mask; Float2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2LongLinkedOpenHashMap.this.mask) {
          if (Float2LongLinkedOpenHashMap.this.key[pos] == from)
          {
    ...
    public void remove()
    {
      ...
      Float2LongLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Float2LongLinkedOpenHashMap.this.first = this.next;
      } else {
        Float2LongLinkedOpenHashMap.this.link[this.prev] ^= (Float2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Float2LongLinkedOpenHashMap.this.last = this.prev;
      } else {
        Float2LongLinkedOpenHashMap.this.link[this.next] ^= (Float2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2LongLinkedOpenHashMap.this.mask; Float2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2LongLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2LongLinkedOpenHashMap.this.key[pos])) & Float2LongLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2LongLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Float2LongLinkedOpenHashMap.this.key[last] = Float2LongLinkedOpenHashMap.this.key[pos];
      ...
      Float2LongLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Float2LongMap.Entry, Map.Entry<Float, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Float2LongLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, Long> local_e = (Map.Entry)local_o;
      return (Float2LongLinkedOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2LongLinkedOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
