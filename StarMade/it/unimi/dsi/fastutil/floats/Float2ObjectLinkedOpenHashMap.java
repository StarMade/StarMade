...
/*  730 */   public Float2ObjectSortedMap<V> tailMap(float from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Float2ObjectSortedMap<V> headMap(float to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Float2ObjectSortedMap<V> subMap(float from, float to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Float2ObjectLinkedOpenHashMap.ValueIterator(Float2ObjectLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Float2ObjectLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Float2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Float2ObjectLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1190 */       c = (Float2ObjectLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Float2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Float2ObjectLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Float2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Float2ObjectLinkedOpenHashMap.KeyIterator(Float2ObjectLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public FloatListIterator iterator() {
/*  999 */       return new Float2ObjectLinkedOpenHashMap.KeyIterator(Float2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Float2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(float k) {
/* 1005 */       return Float2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(float k) {
/* 1008 */       int oldSize = Float2ObjectLinkedOpenHashMap.this.size;
/* 1009 */       Float2ObjectLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Float2ObjectLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Float2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public float firstFloat() {
/* 1016 */       if (Float2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public float lastFloat() {
/* 1020 */       if (Float2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Float2ObjectLinkedOpenHashMap.MapIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public KeyIterator(float k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public float previousFloat() { return Float2ObjectLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  987 */     public Float previous() { return Float.valueOf(Float2ObjectLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/*  991 */     public float nextFloat() { return Float2ObjectLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Float next() { return Float.valueOf(Float2ObjectLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Float2ObjectLinkedOpenHashMap.EntryIterator(Float2ObjectLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Float2ObjectMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> subSet(Float2ObjectMap.Entry<V> fromElement, Float2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> headSet(Float2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Float2ObjectMap.Entry<V>> tailSet(Float2ObjectMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Float2ObjectMap.Entry<V> first() {
/*  918 */       if (Float2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Float2ObjectLinkedOpenHashMap.MapEntry(Float2ObjectLinkedOpenHashMap.this, Float2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Float2ObjectMap.Entry<V> last() {
/*  922 */       if (Float2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Float2ObjectLinkedOpenHashMap.MapEntry(Float2ObjectLinkedOpenHashMap.this, Float2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  931 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Float2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Float2ObjectLinkedOpenHashMap.this.key[pos] == k) return Float2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Float2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  935 */         pos = pos + 1 & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  945 */       int pos = HashCommon.murmurHash3(HashCommon.float2int(k)) & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Float2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Float2ObjectLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Float2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Float2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Float2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> iterator(Float2ObjectMap.Entry<V> from) {
/*  963 */       return new Float2ObjectLinkedOpenHashMap.EntryIterator(Float2ObjectLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> fastIterator() {
/*  966 */       return new Float2ObjectLinkedOpenHashMap.FastEntryIterator(Float2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Float2ObjectMap.Entry<V>> fastIterator(Float2ObjectMap.Entry<V> from) {
/*  969 */       return new Float2ObjectLinkedOpenHashMap.FastEntryIterator(Float2ObjectLinkedOpenHashMap.this, ((Float)from.getKey()).floatValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Float2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Float2ObjectMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractFloat2ObjectMap.BasicEntry<V> entry = new AbstractFloat2ObjectMap.BasicEntry(0.0F, null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Float2ObjectLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Float2ObjectLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractFloat2ObjectMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Float2ObjectLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Float2ObjectLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Float2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Float2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Float2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Float2ObjectMap.Entry<V>>
/*      */   {
...
/*  875 */       return this.entry = new Float2ObjectLinkedOpenHashMap.MapEntry(Float2ObjectLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Float2ObjectLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Float2ObjectLinkedOpenHashMap.MapEntry(Float2ObjectLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Float2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Float2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Float2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Float2ObjectLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(float from) {
/*  753 */       if (Float2ObjectLinkedOpenHashMap.this.key[Float2ObjectLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Float2ObjectLinkedOpenHashMap.this.last;
/*  755 */         this.index = Float2ObjectLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = HashCommon.murmurHash3(HashCommon.float2int(from)) & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Float2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Float2ObjectLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Float2ObjectLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Float2ObjectLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Float2ObjectLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Float2ObjectLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Float2ObjectLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Float2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Float2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Float2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Float2ObjectLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Float2ObjectLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Float2ObjectLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Float2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Float2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Float2ObjectLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Float2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Float2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Float2ObjectLinkedOpenHashMap.this.mask;
/*  841 */         while (Float2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ObjectLinkedOpenHashMap.this.key[pos])) & Float2ObjectLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Float2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Float2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Float2ObjectLinkedOpenHashMap.this.key[last] = Float2ObjectLinkedOpenHashMap.this.key[pos];
/*  848 */         Float2ObjectLinkedOpenHashMap.this.value[last] = Float2ObjectLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Float2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Float2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Float2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Float getKey() {
/*  619 */       return Float.valueOf(Float2ObjectLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public float getFloatKey() {
/*  622 */       return Float2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Float2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Float2ObjectLinkedOpenHashMap.this.value[this.index];
/*  629 */       Float2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Float2ObjectLinkedOpenHashMap.this.key[this.index] == ((Float)e.getKey()).floatValue()) && (Float2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Float2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return HashCommon.float2int(Float2ObjectLinkedOpenHashMap.this.key[this.index]) ^ (Float2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Float2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     public String toString() {
/*  642 */       return Float2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Float2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
