...
/*     */   public static Float2FloatMap singleton(Float key, Float value)
/*     */   {
/* 200 */     return new Singleton(key.floatValue(), value.floatValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.float2FloatEntrySet()); return this.entries; } 
...
/* 335 */     public float get(float k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Float, Float>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Float, ? extends Float> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.float2FloatEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public float get(float k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Float, Float>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return float2FloatEntrySet();
/*     */     }
/* 161 */     public int hashCode() { return HashCommon.float2int(this.key) ^ HashCommon.float2int(this.value); }
/*     */ 
...
/*     */       public Float getKey()
/*     */       {
/* 131 */         return Float.valueOf(Float2FloatMaps.Singleton.this.key); } 
/* 132 */       public Float getValue() { return Float.valueOf(Float2FloatMaps.Singleton.this.value); }
/*     */ 
/*     */       public float getFloatKey() {
/* 135 */         return Float2FloatMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public float getFloatValue() {
/* 139 */         return Float2FloatMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Float2FloatMaps.Singleton.this.key == ((Float)e.getKey()).floatValue()) && (Float2FloatMaps.Singleton.this.value == ((Float)e.getValue()).floatValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return HashCommon.float2int(Float2FloatMaps.Singleton.this.key) ^ HashCommon.float2int(Float2FloatMaps.Singleton.this.value); } 
/* 153 */       public String toString() { return Float2FloatMaps.Singleton.this.key + "->" + Float2FloatMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Float, ? extends Float> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Float2FloatMap.Entry> float2FloatEntrySet() {
...
/*  76 */     private Object readResolve() { return Float2FloatMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Float2FloatMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Float, Float>> entrySet() {
/*  80 */       return float2FloatEntrySet();
/*     */     }
