...
/*     */ 
/*     */ public class Float2LongArrayMap extends AbstractFloat2LongMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Float2LongArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Float2LongMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Float2LongArrayMap.this.size; }
/*     */ 
/*     */         public Float2LongMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractFloat2LongMap.BasicEntry(Float2LongArrayMap.this.key[this.next], Float2LongArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractFloat2LongMap.BasicEntry entry = new AbstractFloat2LongMap.BasicEntry(0.0F, 0L);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Float2LongArrayMap.this.size; }
/*     */ 
/*     */         public Float2LongMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Float2LongArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Float2LongArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Float2LongArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Float2LongArrayMap.this.containsKey(k)) && (Float2LongArrayMap.this.get(k) == ((Long)e.getValue()).longValue());
/*     */     }
/*     */   }
/*     */ }
