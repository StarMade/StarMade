...
/* 194 */     while (i.hasNext()) add(i.nextFloat());
/*     */   }
/*     */ 
...
/*     */   {
/* 211 */     this(FloatIterators.asFloatIterator(i), f, strategy);
/*     */   }
/*     */ 
/*     */   public FloatLinkedOpenCustomHashSet(Iterator<?> i, FloatHash.Strategy strategy)
/*     */   {
/* 219 */     this(FloatIterators.asFloatIterator(i), strategy);
/*     */   }
/*     */ 
...
/* 231 */     FloatArrays.ensureOffsetLength(a, offset, length);
...
/*     */   }
/* 609 */   public FloatSortedSet tailSet(float from) { throw new UnsupportedOperationException(); } 
/* 610 */   public FloatSortedSet headSet(float to) { throw new UnsupportedOperationException(); } 
/* 611 */   public FloatSortedSet subSet(float from, float to) { throw new UnsupportedOperationException(); } 
/* 612 */   public FloatComparator comparator() { return null; }
/*     */ 
/*     */ 
...
/*     */ 
/* 825 */     float[] key = this.key;
/* 826 */     int newMask = newN - 1;
/* 827 */     float[] newKey = new float[newN];
...
/*     */     try
/*     */     {
/* 874 */       c = (FloatLinkedOpenCustomHashSet)super.clone();
/*     */     }
/*     */     catch (CloneNotSupportedException cantHappen) {
/* 877 */       throw new InternalError();
/*     */     }
/* 879 */     c.key = ((float[])this.key.clone());
...
/*     */     }
/* 901 */     return h; } 
/* 904 */   private void writeObject(ObjectOutputStream s) throws IOException { FloatIterator i = iterator();
/* 905 */     s.defaultWriteObject();
/* 906 */     for (int j = this.size; j-- != 0; s.writeFloat(i.nextFloat()));
/*     */   }
/*     */ 
...
/* 914 */     float[] key = this.key = new float[this.n];
...
/* 627 */     int index = -1;
/*     */ 
/* 629 */     SetIterator() { this.next = FloatLinkedOpenCustomHashSet.this.first;
/* 630 */       this.index = 0; }
/*     */ 
/*     */     SetIterator(float from) {
/* 633 */       if (FloatLinkedOpenCustomHashSet.this.strategy.equals(FloatLinkedOpenCustomHashSet.this.key[FloatLinkedOpenCustomHashSet.this.last], from)) {
/* 634 */         this.prev = FloatLinkedOpenCustomHashSet.this.last;
/* 635 */         this.index = FloatLinkedOpenCustomHashSet.this.size;
/*     */       }
/*     */       else
/*     */       {
/* 639 */         int pos = HashCommon.murmurHash3(FloatLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & FloatLinkedOpenCustomHashSet.this.mask;
/*     */ 
/* 641 */         while (FloatLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 642 */           if (FloatLinkedOpenCustomHashSet.this.strategy.equals(FloatLinkedOpenCustomHashSet.this.key[pos], from))
/*     */           {
/* 644 */             this.next = ((int)FloatLinkedOpenCustomHashSet.this.link[pos]);
/* 645 */             this.prev = pos;
/* 646 */             return;
/*     */           }
/* 648 */           pos = pos + 1 & FloatLinkedOpenCustomHashSet.this.mask;
/*     */         }
...
/* 658 */       this.next = ((int)FloatLinkedOpenCustomHashSet.this.link[this.curr]);
/* 659 */       this.prev = this.curr;
/* 660 */       if (this.index >= 0) this.index += 1;
/*     */ 
/* 662 */       return FloatLinkedOpenCustomHashSet.this.key[this.curr];
/*     */     }
/*     */     public float previousFloat() {
/* 665 */       if (!hasPrevious()) throw new NoSuchElementException();
/* 666 */       this.curr = this.prev;
/* 667 */       this.prev = ((int)(FloatLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 668 */       this.next = this.curr;
/* 669 */       if (this.index >= 0) this.index -= 1;
/* 670 */       return FloatLinkedOpenCustomHashSet.this.key[this.curr];
/*     */     }
...
/*     */       }
/* 678 */       if (this.next == -1) {
/* 679 */         this.index = FloatLinkedOpenCustomHashSet.this.size;
/* 680 */         return;
/*     */       }
/* 682 */       int pos = FloatLinkedOpenCustomHashSet.this.first;
/* 683 */       this.index = 1;
/* 684 */       while (pos != this.prev) {
/* 685 */         pos = (int)FloatLinkedOpenCustomHashSet.this.link[pos];
/* 686 */         this.index += 1;
/*     */       }
/*     */     }
/*     */ 
...
/*     */       {
/* 704 */         this.index -= 1;
/* 705 */         this.prev = ((int)(FloatLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/*     */       }
/*     */       else {
/* 708 */         this.next = ((int)FloatLinkedOpenCustomHashSet.this.link[this.curr]);
/* 709 */       }FloatLinkedOpenCustomHashSet.this.size -= 1;
/*     */ 
/* 712 */       if (this.prev == -1) FloatLinkedOpenCustomHashSet.this.first = this.next;
/*     */       else
/* 714 */         FloatLinkedOpenCustomHashSet.this.link[this.prev] ^= (FloatLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/* 715 */       if (this.next == -1) FloatLinkedOpenCustomHashSet.this.last = this.prev;
/*     */       else
/* 717 */         FloatLinkedOpenCustomHashSet.this.link[this.next] ^= (FloatLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*     */       int last;
/*     */       while (true) {
/* 721 */         pos = (last = pos) + 1 & FloatLinkedOpenCustomHashSet.this.mask;
/* 722 */         while (FloatLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 723 */           int slot = HashCommon.murmurHash3(FloatLinkedOpenCustomHashSet.this.strategy.hashCode(FloatLinkedOpenCustomHashSet.this.key[pos])) & FloatLinkedOpenCustomHashSet.this.mask;
/* 724 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 725 */           pos = pos + 1 & FloatLinkedOpenCustomHashSet.this.mask;
/*     */         }
/* 727 */         if (FloatLinkedOpenCustomHashSet.this.used[pos] == 0) break;
/* 728 */         FloatLinkedOpenCustomHashSet.this.key[last] = FloatLinkedOpenCustomHashSet.this.key[pos];
/* 729 */         if (this.next == pos) this.next = last;
/* 730 */         if (this.prev == pos) this.prev = last;
/* 731 */         FloatLinkedOpenCustomHashSet.this.fixPointers(pos, last);
/*     */       }
/* 733 */       FloatLinkedOpenCustomHashSet.this.used[last] = false;
/* 734 */       this.curr = -1;
/*     */     }
/*     */   }
/*     */ }
