...
/*  13:    */
/*  89:    */public class FloatLinkedOpenCustomHashSet
...
/* 110:    */  
/* 114:    */  protected FloatHash.Strategy strategy;
/* 115:    */  
/* 120:    */  public FloatLinkedOpenCustomHashSet(int expected, float f, FloatHash.Strategy strategy)
/* 121:    */  {
...
/* 129:129 */    this.key = new float[this.n];
/* 130:130 */    this.used = new boolean[this.n];
/* 131:131 */    this.link = new long[this.n];
/* 132:    */  }
/* 133:    */  
/* 137:    */  public FloatLinkedOpenCustomHashSet(int expected, FloatHash.Strategy strategy)
/* 138:    */  {
/* 139:139 */    this(expected, 0.75F, strategy);
/* 140:    */  }
/* 141:    */  
/* 144:    */  public FloatLinkedOpenCustomHashSet(FloatHash.Strategy strategy)
/* 145:    */  {
/* 146:146 */    this(16, 0.75F, strategy);
/* 147:    */  }
/* 148:    */  
/* 153:    */  public FloatLinkedOpenCustomHashSet(Collection<? extends Float> c, float f, FloatHash.Strategy strategy)
/* 154:    */  {
/* 155:155 */    this(c.size(), f, strategy);
/* 156:156 */    addAll(c);
/* 157:    */  }
/* 158:    */  
/* 163:    */  public FloatLinkedOpenCustomHashSet(Collection<? extends Float> c, FloatHash.Strategy strategy)
/* 164:    */  {
/* 165:165 */    this(c, 0.75F, strategy);
/* 166:    */  }
/* 167:    */  
/* 172:    */  public FloatLinkedOpenCustomHashSet(FloatCollection c, float f, FloatHash.Strategy strategy)
/* 173:    */  {
/* 174:174 */    this(c.size(), f, strategy);
/* 175:175 */    addAll(c);
/* 176:    */  }
/* 177:    */  
/* 182:    */  public FloatLinkedOpenCustomHashSet(FloatCollection c, FloatHash.Strategy strategy)
/* 183:    */  {
/* 184:184 */    this(c, 0.75F, strategy);
/* 185:    */  }
/* 186:    */  
/* 191:    */  public FloatLinkedOpenCustomHashSet(FloatIterator i, float f, FloatHash.Strategy strategy)
/* 192:    */  {
/* 193:193 */    this(16, f, strategy);
/* 194:194 */    while (i.hasNext()) { add(i.nextFloat());
/* 195:    */    }
/* 196:    */  }
/* 197:    */  
/* 200:    */  public FloatLinkedOpenCustomHashSet(FloatIterator i, FloatHash.Strategy strategy)
/* 201:    */  {
/* 202:202 */    this(i, 0.75F, strategy);
/* 203:    */  }
/* 204:    */  
/* 209:    */  public FloatLinkedOpenCustomHashSet(Iterator<?> i, float f, FloatHash.Strategy strategy)
/* 210:    */  {
/* 211:211 */    this(FloatIterators.asFloatIterator(i), f, strategy);
/* 212:    */  }
/* 213:    */  
/* 217:    */  public FloatLinkedOpenCustomHashSet(Iterator<?> i, FloatHash.Strategy strategy)
/* 218:    */  {
/* 219:219 */    this(FloatIterators.asFloatIterator(i), strategy);
/* 220:    */  }
/* 221:    */  
/* 228:    */  public FloatLinkedOpenCustomHashSet(float[] a, int offset, int length, float f, FloatHash.Strategy strategy)
/* 229:    */  {
/* 230:230 */    this(length < 0 ? 0 : length, f, strategy);
/* 231:231 */    FloatArrays.ensureOffsetLength(a, offset, length);
/* 232:232 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 233:    */    }
/* 234:    */  }
/* 235:    */  
/* 240:    */  public FloatLinkedOpenCustomHashSet(float[] a, int offset, int length, FloatHash.Strategy strategy)
/* 241:    */  {
/* 242:242 */    this(a, offset, length, 0.75F, strategy);
/* 243:    */  }
/* 244:    */  
/* 249:    */  public FloatLinkedOpenCustomHashSet(float[] a, float f, FloatHash.Strategy strategy)
/* 250:    */  {
/* 251:251 */    this(a, 0, a.length, f, strategy);
/* 252:    */  }
/* 253:    */  
/* 258:    */  public FloatLinkedOpenCustomHashSet(float[] a, FloatHash.Strategy strategy)
/* 259:    */  {
/* 260:260 */    this(a, 0.75F, strategy);
/* 261:    */  }
/* 262:    */  
/* 265:    */  public FloatHash.Strategy strategy()
/* 266:    */  {
/* 267:267 */    return this.strategy;
/* 268:    */  }
/* 269:    */  
/* 273:    */  public boolean add(float k)
/* 274:    */  {
...
/* 319:    */  }
/* 320:    */  
/* 321:    */  public boolean remove(float k)
/* 322:    */  {
...
/* 336:    */  }
/* 337:    */  
/* 338:    */  public boolean contains(float k)
/* 339:    */  {
...
/* 347:    */  }
/* 348:    */  
/* 351:    */  public float removeFirstFloat()
/* 352:    */  {
...
/* 361:    */    }
/* 362:362 */    float k = this.key[pos];
/* 363:363 */    shiftKeys(pos);
/* 364:364 */    return k;
/* 365:    */  }
/* 366:    */  
/* 369:    */  public float removeLastFloat()
/* 370:    */  {
...
/* 419:    */  }
/* 420:    */  
/* 424:    */  public boolean addAndMoveToFirst(float k)
/* 425:    */  {
/* 426:426 */    float[] key = this.key;
...
/* 454:    */  }
/* 455:    */  
/* 459:    */  public boolean addAndMoveToLast(float k)
/* 460:    */  {
...
/* 592:    */  }
/* 593:    */  
/* 596:    */  public float firstFloat()
/* 597:    */  {
/* 598:598 */    if (this.size == 0) throw new NoSuchElementException();
/* 599:599 */    return this.key[this.first];
/* 600:    */  }
/* 601:    */  
/* 604:    */  public float lastFloat()
/* 605:    */  {
/* 606:606 */    if (this.size == 0) throw new NoSuchElementException();
/* 607:607 */    return this.key[this.last]; }
/* 608:    */  
/* 609:609 */  public FloatSortedSet tailSet(float from) { throw new UnsupportedOperationException(); }
/* 610:610 */  public FloatSortedSet headSet(float to) { throw new UnsupportedOperationException(); }
/* 611:611 */  public FloatSortedSet subSet(float from, float to) { throw new UnsupportedOperationException(); }
/* 612:612 */  public FloatComparator comparator() { return null; }
/* 613:    */  
/* 618:    */  private class SetIterator
/* 619:    */    extends AbstractFloatListIterator
/* 620:    */  {
/* 621:621 */    int prev = -1;
/* 622:    */    
/* 623:623 */    int next = -1;
...
/* 627:627 */    int index = -1;
/* 628:    */    
/* 629:629 */    SetIterator() { this.next = FloatLinkedOpenCustomHashSet.this.first;
/* 630:630 */      this.index = 0;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    SetIterator(float from) { if (FloatLinkedOpenCustomHashSet.this.strategy.equals(FloatLinkedOpenCustomHashSet.this.key[FloatLinkedOpenCustomHashSet.this.last], from)) {
/* 634:634 */        this.prev = FloatLinkedOpenCustomHashSet.this.last;
/* 635:635 */        this.index = FloatLinkedOpenCustomHashSet.this.size;
/* 636:    */      }
/* 637:    */      else
/* 638:    */      {
/* 639:639 */        int pos = HashCommon.murmurHash3(FloatLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & FloatLinkedOpenCustomHashSet.this.mask;
/* 640:    */        
/* 641:641 */        while (FloatLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 642:642 */          if (FloatLinkedOpenCustomHashSet.this.strategy.equals(FloatLinkedOpenCustomHashSet.this.key[pos], from))
/* 643:    */          {
/* 644:644 */            this.next = ((int)FloatLinkedOpenCustomHashSet.this.link[pos]);
/* 645:645 */            this.prev = pos;
/* 646:646 */            return;
/* 647:    */          }
/* 648:648 */          pos = pos + 1 & FloatLinkedOpenCustomHashSet.this.mask;
/* 649:    */        }
...
/* 655:    */    
/* 656:656 */    public float nextFloat() { if (!hasNext()) throw new NoSuchElementException();
/* 657:657 */      this.curr = this.next;
/* 658:658 */      this.next = ((int)FloatLinkedOpenCustomHashSet.this.link[this.curr]);
/* 659:659 */      this.prev = this.curr;
/* 660:660 */      if (this.index >= 0) { this.index += 1;
/* 661:    */      }
/* 662:662 */      return FloatLinkedOpenCustomHashSet.this.key[this.curr];
/* 663:    */    }
/* 664:    */    
/* 665:665 */    public float previousFloat() { if (!hasPrevious()) throw new NoSuchElementException();
/* 666:666 */      this.curr = this.prev;
/* 667:667 */      this.prev = ((int)(FloatLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 668:668 */      this.next = this.curr;
/* 669:669 */      if (this.index >= 0) this.index -= 1;
/* 670:670 */      return FloatLinkedOpenCustomHashSet.this.key[this.curr];
/* 671:    */    }
/* 672:    */    
...
/* 679:679 */        this.index = FloatLinkedOpenCustomHashSet.this.size;
/* 680:680 */        return;
/* 681:    */      }
/* 682:682 */      int pos = FloatLinkedOpenCustomHashSet.this.first;
/* 683:683 */      this.index = 1;
/* 684:684 */      while (pos != this.prev) {
/* 685:685 */        pos = (int)FloatLinkedOpenCustomHashSet.this.link[pos];
...
/* 705:705 */        this.prev = ((int)(FloatLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 706:    */      }
/* 707:    */      else {
/* 708:708 */        this.next = ((int)FloatLinkedOpenCustomHashSet.this.link[this.curr]); }
/* 709:709 */      FloatLinkedOpenCustomHashSet.this.size -= 1;
/* 710:    */      
/* 712:712 */      if (this.prev == -1) { FloatLinkedOpenCustomHashSet.this.first = this.next;
/* 713:    */      } else
/* 714:714 */        FloatLinkedOpenCustomHashSet.this.link[this.prev] ^= (FloatLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/* 715:715 */      if (this.next == -1) { FloatLinkedOpenCustomHashSet.this.last = this.prev;
/* 716:    */      } else
/* 717:717 */        FloatLinkedOpenCustomHashSet.this.link[this.next] ^= (FloatLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/* 718:718 */      int pos = this.curr;
/* 719:    */      int last;
/* 720:    */      for (;;) {
/* 721:721 */        pos = (last = pos) + 1 & FloatLinkedOpenCustomHashSet.this.mask;
/* 722:722 */        while (FloatLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 723:723 */          int slot = HashCommon.murmurHash3(FloatLinkedOpenCustomHashSet.this.strategy.hashCode(FloatLinkedOpenCustomHashSet.this.key[pos])) & FloatLinkedOpenCustomHashSet.this.mask;
/* 724:724 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 725:725 */          pos = pos + 1 & FloatLinkedOpenCustomHashSet.this.mask;
/* 726:    */        }
/* 727:727 */        if (FloatLinkedOpenCustomHashSet.this.used[pos] == 0) break;
/* 728:728 */        FloatLinkedOpenCustomHashSet.this.key[last] = FloatLinkedOpenCustomHashSet.this.key[pos];
/* 729:729 */        if (this.next == pos) this.next = last;
/* 730:730 */        if (this.prev == pos) this.prev = last;
/* 731:731 */        FloatLinkedOpenCustomHashSet.this.fixPointers(pos, last);
/* 732:    */      }
/* 733:733 */      FloatLinkedOpenCustomHashSet.this.used[last] = false;
/* 734:734 */      this.curr = -1;
/* 735:    */    }
/* 736:    */  }
/* 737:    */  
/* 743:    */  public FloatListIterator iterator(float from)
/* 744:    */  {
/* 745:745 */    return new SetIterator(from);
/* 746:    */  }
/* 747:    */  
/* 748:748 */  public FloatListIterator iterator() { return new SetIterator(); }
/* 749:    */  
/* 759:    */  @Deprecated
...
/* 824:    */    
/* 825:825 */    float[] key = this.key;
/* 826:826 */    int newMask = newN - 1;
/* 827:827 */    float[] newKey = new float[newN];
...
/* 863:    */  }
/* 864:    */  
/* 867:    */  public FloatLinkedOpenCustomHashSet clone()
/* 868:    */  {
/* 869:    */    FloatLinkedOpenCustomHashSet c;
/* 870:    */    
/* 872:    */    try
/* 873:    */    {
/* 874:874 */      c = (FloatLinkedOpenCustomHashSet)super.clone();
/* 875:    */    }
/* 876:    */    catch (CloneNotSupportedException cantHappen) {
/* 877:877 */      throw new InternalError();
/* 878:    */    }
/* 879:879 */    c.key = ((float[])this.key.clone());
...
/* 902:    */  }
/* 903:    */  
/* 904:904 */  private void writeObject(ObjectOutputStream s) throws IOException { FloatIterator i = iterator();
/* 905:905 */    s.defaultWriteObject();
/* 906:906 */    for (int j = this.size; j-- != 0; s.writeFloat(i.nextFloat())) {}
/* 907:    */  }
/* 908:    */  
...
/* 914:914 */    float[] key = this.key = new float[this.n];
