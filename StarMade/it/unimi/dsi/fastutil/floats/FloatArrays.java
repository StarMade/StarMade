...
/*    7:     */
/*   84:     */public class FloatArrays
/*   85:     */{
/*   86:     */  public static final long ONEOVERPHI = 106039L;
/*   87:  87 */  public static final float[] EMPTY_ARRAY = new float[0];
/*   88:     */  
...
/*   96:     */  private static final int DIGITS_PER_ELEMENT = 4;
/*   97:     */  
/*   98:     */  public static float[] ensureCapacity(float[] array, int length)
/*   99:     */  {
/*  100: 100 */    if (length > array.length) {
/*  101: 101 */      float[] t = new float[length];
/*  102:     */      
...
/*  107:     */  }
/*  108:     */  
/*  116:     */  public static float[] ensureCapacity(float[] array, int length, int preserve)
/*  117:     */  {
/*  118: 118 */    if (length > array.length) {
/*  119: 119 */      float[] t = new float[length];
/*  120:     */      
...
/*  176:     */  }
/*  177:     */  
/*  186:     */  public static float[] trim(float[] array, int length)
/*  187:     */  {
/*  188: 188 */    if (length >= array.length) return array;
/*  189: 189 */    float[] t = length == 0 ? EMPTY_ARRAY : new float[length];
/*  190:     */    
/*  191: 191 */    System.arraycopy(array, 0, t, 0, length);
/*  192: 192 */    return t;
/*  193:     */  }
/*  194:     */  
/*  206:     */  public static float[] setLength(float[] array, int length)
/*  207:     */  {
...
/*  211:     */  }
/*  212:     */  
/*  218:     */  public static float[] copy(float[] array, int offset, int length)
/*  219:     */  {
/*  220: 220 */    ensureOffsetLength(array, offset, length);
/*  221: 221 */    float[] a = length == 0 ? EMPTY_ARRAY : new float[length];
/*  222:     */    
/*  223: 223 */    System.arraycopy(array, offset, a, 0, length);
/*  224: 224 */    return a;
/*  225:     */  }
/*  226:     */  
/*  230:     */  public static float[] copy(float[] array)
/*  231:     */  {
/*  232: 232 */    return (float[])array.clone();
/*  233:     */  }
/*  234:     */  
/*  241:     */  public static void fill(float[] array, float value)
/*  242:     */  {
...
/*  246:     */  }
/*  247:     */  
/*  256:     */  public static void fill(float[] array, int from, int to, float value)
/*  257:     */  {
...
/*  262:     */  }
/*  263:     */  
/*  270:     */  public static boolean equals(float[] a1, float[] a2)
/*  271:     */  {
...
/*  276:     */  }
/*  277:     */  
/*  286:     */  public static void ensureFromTo(float[] a, int from, int to)
/*  287:     */  {
/*  288: 288 */    it.unimi.dsi.fastutil.Arrays.ensureFromTo(a.length, from, to);
/*  289:     */  }
/*  290:     */  
/*  299:     */  public static void ensureOffsetLength(float[] a, int offset, int length)
/*  300:     */  {
/*  301: 301 */    it.unimi.dsi.fastutil.Arrays.ensureOffsetLength(a.length, offset, length);
/*  302:     */  }
/*  303:     */  
/*  304:     */  private static void swap(float[] x, int a, int b)
/*  305:     */  {
/*  306: 306 */    float t = x[a];
/*  307: 307 */    x[a] = x[b];
/*  308: 308 */    x[b] = t;
/*  309:     */  }
/*  310:     */  
/*  311: 311 */  private static void vecSwap(float[] x, int a, int b, int n) { for (int i = 0; i < n; b++) { swap(x, a, b);i++;a++;
/*  312:     */    } }
/*  313:     */  
/*  314: 314 */  private static int med3(float[] x, int a, int b, int c, FloatComparator comp) { int ab = comp.compare(x[a], x[b]);
...
/*  318:     */  }
/*  319:     */  
/*  320:     */  private static void selectionSort(float[] a, int from, int to, FloatComparator comp)
/*  321:     */  {
...
/*  331:     */  }
/*  332:     */  
/*  333: 333 */  private static void insertionSort(float[] a, int from, int to, FloatComparator comp) { int i = from; for (;;) { i++; if (i >= to) break;
/*  334: 334 */      float t = a[i];
/*  335: 335 */      int j = i;
/*  336: 336 */      for (float u = a[(j - 1)]; comp.compare(t, u) < 0; u = a[(--j - 1)]) {
/*  337: 337 */        a[j] = u;
/*  338: 338 */        if (from == j - 1) {
/*  339: 339 */          j--;
/*  340: 340 */          break;
...
/*  345:     */  }
/*  346:     */  
/*  347:     */  private static void selectionSort(float[] a, int from, int to) {
...
/*  357:     */  }
/*  358:     */  
/*  359:     */  private static void insertionSort(float[] a, int from, int to) {
/*  360: 360 */    int i = from; for (;;) { i++; if (i >= to) break;
/*  361: 361 */      float t = a[i];
/*  362: 362 */      int j = i;
/*  363: 363 */      for (float u = a[(j - 1)]; t < u; u = a[(--j - 1)]) {
/*  364: 364 */        a[j] = u;
/*  365: 365 */        if (from == j - 1) {
/*  366: 366 */          j--;
/*  367: 367 */          break;
...
/*  372:     */  }
/*  373:     */  
/*  385:     */  public static void quickSort(float[] x, int from, int to, FloatComparator comp)
/*  386:     */  {
...
/*  432:     */  }
/*  433:     */  
/*  442:     */  public static void quickSort(float[] x, FloatComparator comp)
/*  443:     */  {
/*  444: 444 */    quickSort(x, 0, x.length, comp);
/*  445:     */  }
/*  446:     */  
/*  447:     */  private static int med3(float[] x, int a, int b, int c) {
...
/*  452:     */  }
/*  453:     */  
/*  466:     */  public static void quickSort(float[] x, int from, int to)
/*  467:     */  {
...
/*  513:     */  }
/*  514:     */  
/*  521:     */  public static void quickSort(float[] x)
/*  522:     */  {
/*  523: 523 */    quickSort(x, 0, x.length);
/*  524:     */  }
/*  525:     */  
/*  535:     */  public static void mergeSort(float[] a, int from, int to, float[] supp)
/*  536:     */  {
...
/*  559:     */  }
/*  560:     */  
/*  567:     */  public static void mergeSort(float[] a, int from, int to)
/*  568:     */  {
/*  569: 569 */    mergeSort(a, from, to, (float[])a.clone());
/*  570:     */  }
/*  571:     */  
/*  577:     */  public static void mergeSort(float[] a)
/*  578:     */  {
/*  579: 579 */    mergeSort(a, 0, a.length);
/*  580:     */  }
/*  581:     */  
/*  593:     */  public static void mergeSort(float[] a, int from, int to, FloatComparator comp, float[] supp)
/*  594:     */  {
...
/*  617:     */  }
/*  618:     */  
/*  627:     */  public static void mergeSort(float[] a, int from, int to, FloatComparator comp)
/*  628:     */  {
/*  629: 629 */    mergeSort(a, from, to, comp, (float[])a.clone());
/*  630:     */  }
/*  631:     */  
/*  639:     */  public static void mergeSort(float[] a, FloatComparator comp)
/*  640:     */  {
/*  641: 641 */    mergeSort(a, 0, a.length, comp);
/*  642:     */  }
/*  643:     */  
/*  654:     */  public static int binarySearch(float[] a, int from, int to, float key)
/*  655:     */  {
/*  656:     */    
/*  657:     */    
/*  667: 667 */    while (from <= to) {
/*  668: 668 */      int mid = from + to >>> 1;
/*  669: 669 */      float midVal = a[mid];
...
/*  675:     */  }
/*  676:     */  
/*  693:     */  public static int binarySearch(float[] a, float key)
/*  694:     */  {
/*  695: 695 */    return binarySearch(a, 0, a.length, key);
/*  696:     */  }
/*  697:     */  
/*  708:     */  public static int binarySearch(float[] a, int from, int to, float key, FloatComparator c)
/*  709:     */  {
/*  710:     */    
/*  711:     */    
/*  721: 721 */    while (from <= to) {
/*  722: 722 */      int mid = from + to >>> 1;
/*  723: 723 */      float midVal = a[mid];
...
/*  730:     */  }
/*  731:     */  
/*  749:     */  public static int binarySearch(float[] a, float key, FloatComparator c)
/*  750:     */  {
/*  751: 751 */    return binarySearch(a, 0, a.length, key, c);
/*  752:     */  }
/*  753:     */  
/*  759:     */  private static final long fixFloat(float f)
/*  760:     */  {
/*  761: 761 */    long i = Float.floatToRawIntBits(f);
/*  762: 762 */    return i >= 0L ? i : i ^ 0x7FFFFFFF;
/*  763:     */  }
/*  764:     */  
/*  779:     */  public static void radixSort(float[] a)
/*  780:     */  {
/*  781: 781 */    radixSort(a, 0, a.length);
/*  782:     */  }
/*  783:     */  
/*  800:     */  public static void radixSort(float[] a, int from, int to)
/*  801:     */  {
/*  802: 802 */    int maxLevel = 3;
/*  803: 803 */    int stackSize = 766;
/*  804: 804 */    int[] offsetStack = new int[766];
/*  805: 805 */    int offsetPos = 0;
/*  806: 806 */    int[] lengthStack = new int[766];
/*  807: 807 */    int lengthPos = 0;
/*  808: 808 */    int[] levelStack = new int[766];
...
/*  820: 820 */      int signMask = level % 4 == 0 ? 128 : 0;
/*  821: 821 */      if (length < 50) {
/*  822: 822 */        selectionSort(a, first, first + length);
/*  823:     */      }
/*  824:     */      else {
/*  825: 825 */        int shift = (3 - level % 4) * 8;
/*  826:     */        
/*  827: 827 */        for (int i = length; i-- != 0; digit[i] = ((byte)(int)(fixFloat(a[(first + i)]) >>> shift & 0xFF ^ signMask))) {}
...
/*  839:     */            }
/*  840:     */          }
/*  841: 841 */          int tmp338_337 = (p + count[i]);p = tmp338_337;pos[i] = tmp338_337;
/*  842:     */        }
/*  843:     */        
...
/*  861:     */    } }
/*  862:     */  
/*  863: 863 */  private static void insertionSortIndirect(int[] perm, float[] a, int from, int to) { int i = from; for (;;) { i++; if (i >= to) break;
...
/*  875:     */  }
/*  876:     */  
/*  899:     */  public static void radixSortIndirect(int[] perm, float[] a, boolean stable)
/*  900:     */  {
/*  901: 901 */    radixSortIndirect(perm, a, 0, perm.length, stable);
/*  902:     */  }
/*  903:     */  
/*  928:     */  public static void radixSortIndirect(int[] perm, float[] a, int from, int to, boolean stable)
/*  929:     */  {
/*  930: 930 */    int maxLevel = 3;
/*  931: 931 */    int stackSize = 766;
/*  932: 932 */    int[] offsetStack = new int[766];
/*  933: 933 */    int offsetPos = 0;
/*  934: 934 */    int[] lengthStack = new int[766];
/*  935: 935 */    int lengthPos = 0;
/*  936: 936 */    int[] levelStack = new int[766];
...
/*  949: 949 */      int signMask = level % 4 == 0 ? 128 : 0;
/*  950: 950 */      if (length < 50) {
/*  951: 951 */        insertionSortIndirect(perm, a, first, first + length);
/*  952:     */      }
/*  953:     */      else {
/*  954: 954 */        int shift = (3 - level % 4) * 8;
/*  955:     */        
/*  956: 956 */        for (int i = length; i-- != 0; digit[i] = ((byte)(int)(fixFloat(a[perm[(first + i)]]) >>> shift & 0xFF ^ signMask))) {}
...
/*  962: 962 */            lastUsed = i;
/*  963: 963 */            if ((level < 3) && (count[i] > 1)) {
/*  964: 964 */              offsetStack[(offsetPos++)] = (p + first);
/*  965: 965 */              lengthStack[(lengthPos++)] = count[i];
/*  966: 966 */              levelStack[(levelPos++)] = (level + 1);
/*  967:     */            }
/*  968:     */          }
/*  969: 969 */          if (stable) { int tmp371_370 = (p + count[i]);p = tmp371_370;count[i] = tmp371_370;
/*  970: 970 */          } else { int tmp390_389 = (p + count[i]);p = tmp390_389;pos[i] = tmp390_389;
/*  971:     */          } }
/*  972: 972 */        if (stable) {
