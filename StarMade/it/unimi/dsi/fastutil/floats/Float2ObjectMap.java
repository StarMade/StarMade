...
public abstract interface Float2ObjectMap<V> extends Float2ObjectFunction<V>, Map<Float, V>
{
  ...
  public static abstract interface FastEntrySet<V> extends ObjectSet<Float2ObjectMap.Entry<V>>
  {
