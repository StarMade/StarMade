...
{
  public static int downHeap(float[] refArray, int[] heap, int size, int local_i, FloatComparator local_c)
  {
    if (local_i >= size) {
    ...
    float local_E = refArray[local_e];
    if (local_c == null)
    {
      int child;
  ...
  public static int upHeap(float[] refArray, int[] heap, int size, int local_i, FloatComparator local_c)
  {
    if (local_i >= size) {
      throw new IllegalArgumentException("Heap position (" + local_i + ") is larger than or equal to heap size (" + size + ")");
    }
  ...
  public static void makeHeap(float[] refArray, int offset, int length, int[] heap, FloatComparator local_c)
  {
  ...
  public static int[] makeHeap(float[] refArray, int offset, int length, FloatComparator local_c)
  {
  ...
  public static void makeHeap(float[] refArray, int[] heap, int size, FloatComparator local_c)
  {
    int local_i = size / 2;
    while (local_i-- != 0) {
  ...
  public static int front(float[] refArray, int[] heap, int size, int[] local_a)
  {
