  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof FloatComparator))) {
      ...
      this.actualComparator = new FloatComparator()
      {
        ...
        {
          return Float2FloatAVLTreeMap.this.storedComparator.compare(Float.valueOf(local_k1), Float.valueOf(local_k2));
        }
  ...
  public Float2FloatAVLTreeMap(Comparator<? super Float> local_c)
  {
    this();
  ...
  public Float2FloatAVLTreeMap(Map<? extends Float, ? extends Float> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2FloatAVLTreeMap(SortedMap<Float, Float> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2FloatAVLTreeMap(Float2FloatMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Float2FloatAVLTreeMap(Float2FloatSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Float2FloatAVLTreeMap(float[] local_k, float[] local_v, Comparator<? super Float> local_c)
  {
    this(local_c);
  ...
  public Float2FloatAVLTreeMap(float[] local_k, float[] local_v)
  {
  ...
  {
    float oldValue = put(local_ok.floatValue(), local_ov.floatValue());
    return this.modified ? null : Float.valueOf(oldValue);
  }
  
  public Float remove(Object local_ok)
  {
    float oldValue = remove(((Float)local_ok).floatValue());
  ...
  public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Float2FloatMap.Entry> comparator = new Comparator()
        {
          public int compare(Float2FloatMap.Entry local_x, Float2FloatMap.Entry local_y)
          {
            return Float2FloatAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Float2FloatAVLTreeMap.EntryIterator(Float2FloatAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator(Float2FloatMap.Entry from)
        {
          return new Float2FloatAVLTreeMap.EntryIterator(Float2FloatAVLTreeMap.this, ((Float)from.getKey()).floatValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Float2FloatAVLTreeMap.Entry local_f = Float2FloatAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Float2FloatAVLTreeMap.Entry local_f = Float2FloatAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
          if (local_f != null) {
            Float2FloatAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Float2FloatMap.Entry> subSet(Float2FloatMap.Entry from, Float2FloatMap.Entry local_to)
        {
          return Float2FloatAVLTreeMap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2FloatEntrySet();
        }
        
        public ObjectSortedSet<Float2FloatMap.Entry> headSet(Float2FloatMap.Entry local_to)
        {
          return Float2FloatAVLTreeMap.this.headMap((Float)local_to.getKey()).float2FloatEntrySet();
        }
        
        public ObjectSortedSet<Float2FloatMap.Entry> tailSet(Float2FloatMap.Entry from)
        {
          return Float2FloatAVLTreeMap.this.tailMap((Float)from.getKey()).float2FloatEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Float2FloatAVLTreeMap.ValueIterator(Float2FloatAVLTreeMap.this, null);
        }
        
        public boolean contains(float local_k)
        {
          return Float2FloatAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Float2FloatAVLTreeMap local_c;
    try
    {
      local_c = (Float2FloatAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readFloat(), local_s.readFloat());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readFloat(), local_s.readFloat());
      top.right(new Entry(local_s.readFloat(), local_s.readFloat()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Float2FloatAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Float2FloatAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Float2FloatAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Float2FloatMap.Entry> float2FloatEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator()
          {
            return new Float2FloatAVLTreeMap.Submap.SubmapEntryIterator(Float2FloatAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Float2FloatMap.Entry> iterator(Float2FloatMap.Entry from)
          {
            return new Float2FloatAVLTreeMap.Submap.SubmapEntryIterator(Float2FloatAVLTreeMap.Submap.this, ((Float)from.getKey()).floatValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Float, Float> local_e = (Map.Entry)local_o;
            Float2FloatAVLTreeMap.Entry local_f = Float2FloatAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            return (local_f != null) && (Float2FloatAVLTreeMap.Submap.this.in(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Float, Float> local_e = (Map.Entry)local_o;
            Float2FloatAVLTreeMap.Entry local_f = Float2FloatAVLTreeMap.this.findKey(((Float)local_e.getKey()).floatValue());
            if ((local_f != null) && (Float2FloatAVLTreeMap.Submap.this.in(local_f.key))) {
              Float2FloatAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Float2FloatAVLTreeMap.Submap.SubmapIterator(Float2FloatAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Float2FloatAVLTreeMap.Submap.this.clear();
          }
          
          public Float2FloatMap.Entry first()
          {
            return Float2FloatAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Float2FloatMap.Entry last()
          {
            return Float2FloatAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Float2FloatMap.Entry> subSet(Float2FloatMap.Entry from, Float2FloatMap.Entry local_to)
          {
            return Float2FloatAVLTreeMap.Submap.this.subMap((Float)from.getKey(), (Float)local_to.getKey()).float2FloatEntrySet();
          }
          
          public ObjectSortedSet<Float2FloatMap.Entry> headSet(Float2FloatMap.Entry local_to)
          {
            return Float2FloatAVLTreeMap.Submap.this.headMap((Float)local_to.getKey()).float2FloatEntrySet();
          }
          
          public ObjectSortedSet<Float2FloatMap.Entry> tailSet(Float2FloatMap.Entry from)
          {
            return Float2FloatAVLTreeMap.Submap.this.tailMap((Float)from.getKey()).float2FloatEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public FloatCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractFloatCollection()
        {
          public FloatIterator iterator()
          {
            return new Float2FloatAVLTreeMap.Submap.SubmapValueIterator(Float2FloatAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(float local_k)
          {
            return Float2FloatAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Float2FloatAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(float local_k)
    {
      return (in(local_k)) && (Float2FloatAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      float local_kk = local_k;
      Float2FloatAVLTreeMap.Entry local_e;
      return (in(local_kk)) && ((local_e = Float2FloatAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public float put(float local_k, float local_v)
    {
      ...
      float oldValue = Float2FloatAVLTreeMap.this.put(local_k, local_v);
    ...
    public float remove(float local_k)
    {
      ...
      float oldValue = Float2FloatAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Float2FloatAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Float2FloatAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Float2FloatAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Float2FloatSortedMap tailMap(float from)
    {
      if (this.bottom) {
        return new Submap(Float2FloatAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Float2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Float2FloatAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Float2FloatSortedMap subMap(float from, float local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Float2FloatAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Float2FloatAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Float2FloatAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Float2FloatAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Float2FloatAVLTreeMap.this.locateKey(this.from);
        if (Float2FloatAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Float2FloatAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Float2FloatAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Float2FloatAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Float2FloatAVLTreeMap.this.locateKey(this.field_47);
        if (Float2FloatAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Float2FloatAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public float firstFloatKey()
    {
      Float2FloatAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public float lastFloatKey()
    {
      Float2FloatAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      implements ObjectListIterator<Float2FloatMap.Entry>
    {
      ...
      public void set(Float2FloatMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Float2FloatMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
      ...
      extends Float2FloatAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Float2FloatAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(float local_k)
      {
        this();
        if (this.next != null) {
          if ((!Float2FloatAVLTreeMap.Submap.this.bottom) && (Float2FloatAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Float2FloatAVLTreeMap.Submap.this.top) && (Float2FloatAVLTreeMap.this.compare(local_k, (this.prev = Float2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Float2FloatAVLTreeMap.this.locateKey(local_k);
            if (Float2FloatAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Float2FloatAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Float2FloatAVLTreeMap.this.compare(this.prev.key, Float2FloatAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Float2FloatAVLTreeMap.Submap.this.top) && (this.next != null) && (Float2FloatAVLTreeMap.this.compare(this.next.key, Float2FloatAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractFloat2FloatSortedMap.KeySet
    {
      ...
      {
        return new Float2FloatAVLTreeMap.Submap.SubmapKeyIterator(Float2FloatAVLTreeMap.Submap.this);
      }
      
      public FloatBidirectionalIterator iterator(float from)
      {
        return new Float2FloatAVLTreeMap.Submap.SubmapKeyIterator(Float2FloatAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractFloat2FloatSortedMap.KeySet
  {
    ...
    public FloatBidirectionalIterator iterator()
    {
      return new Float2FloatAVLTreeMap.KeyIterator(Float2FloatAVLTreeMap.this);
    }
    
    public FloatBidirectionalIterator iterator(float from)
    {
      return new Float2FloatAVLTreeMap.KeyIterator(Float2FloatAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Float2FloatAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Float2FloatAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Float2FloatMap.Entry
  {
    ...
    Entry(float local_k, float local_v)
    {
      this.key = local_k;
      this.value = local_v;
