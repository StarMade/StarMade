...
/*  18:    */
/*  90:    */public class Float2ShortOpenCustomHashMap
/*  91:    */  extends AbstractFloat2ShortMap
...
/* 104:    */  protected volatile transient Float2ShortMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Float2ShortOpenCustomHashMap(int expected, float f, FloatHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Float2ShortOpenCustomHashMap(int expected, FloatHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Float2ShortOpenCustomHashMap(FloatHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Float2ShortOpenCustomHashMap(Map<? extends Float, ? extends Short> m, float f, FloatHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Float2ShortOpenCustomHashMap(Map<? extends Float, ? extends Short> m, FloatHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Float2ShortOpenCustomHashMap(Float2ShortMap m, float f, FloatHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Float2ShortOpenCustomHashMap(Float2ShortMap m, FloatHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Float2ShortOpenCustomHashMap(float[] k, short[] v, float f, FloatHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Float2ShortOpenCustomHashMap(float[] k, short[] v, FloatHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public short put(float k, short v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Short put(Float ok, Short ov) { short v = ov.shortValue();
...
/* 246:    */  }
/* 247:    */  
/* 258:    */  public short add(float k, short incr)
/* 259:    */  {
...
/* 299:    */  }
/* 300:    */  
/* 301:    */  public short remove(float k)
/* 302:    */  {
...
/* 332:    */  }
/* 333:    */  
/* 334:334 */  public Short get(Float ok) { float k = ok.floatValue();
/* 335:    */    
...
/* 409:    */    implements Float2ShortMap.Entry, Map.Entry<Float, Short>
/* 410:    */  {
...
/* 416:    */    }
/* 417:    */    
/* 418:418 */    public Float getKey() { return Float.valueOf(Float2ShortOpenCustomHashMap.this.key[this.index]); }
/* 419:    */    
/* 420:    */    public float getFloatKey() {
/* 421:421 */      return Float2ShortOpenCustomHashMap.this.key[this.index];
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public Short getValue() { return Short.valueOf(Float2ShortOpenCustomHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public short getShortValue() { return Float2ShortOpenCustomHashMap.this.value[this.index]; }
/* 428:    */    
/* 429:    */    public short setValue(short v) {
/* 430:430 */      short oldValue = Float2ShortOpenCustomHashMap.this.value[this.index];
/* 431:431 */      Float2ShortOpenCustomHashMap.this.value[this.index] = v;
...
/* 440:440 */      Map.Entry<Float, Short> e = (Map.Entry)o;
/* 441:441 */      return (Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue())) && (Float2ShortOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/* 442:    */    }
/* 443:    */    
/* 444:444 */    public int hashCode() { return Float2ShortOpenCustomHashMap.this.strategy.hashCode(Float2ShortOpenCustomHashMap.this.key[this.index]) ^ Float2ShortOpenCustomHashMap.this.value[this.index]; }
/* 445:    */    
/* 447:447 */    public String toString() { return Float2ShortOpenCustomHashMap.this.key[this.index] + "=>" + Float2ShortOpenCustomHashMap.this.value[this.index]; } }
/* 448:    */  
...
/* 453:    */    
/* 454:454 */    private MapIterator() { this.pos = Float2ShortOpenCustomHashMap.this.n;
/* 455:    */      
/* 457:457 */      this.last = -1;
/* 458:    */      
/* 459:459 */      this.c = Float2ShortOpenCustomHashMap.this.size;
/* 460:    */      
/* 464:464 */      boolean[] used = Float2ShortOpenCustomHashMap.this.used;
...
/* 476:    */        
/* 477:477 */        int pos = HashCommon.murmurHash3(Float2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ShortOpenCustomHashMap.this.mask;
/* 478:    */        
/* 479:479 */        while (Float2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 480:480 */          if (Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481:481 */          pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask;
/* 482:    */        }
/* 483:    */      }
/* 484:484 */      this.last = this.pos;
/* 485:    */      
/* 486:486 */      if (this.c != 0) {
/* 487:487 */        boolean[] used = Float2ShortOpenCustomHashMap.this.used;
...
/* 502:    */      for (;;)
/* 503:    */      {
/* 504:504 */        pos = (last = pos) + 1 & Float2ShortOpenCustomHashMap.this.mask;
/* 505:505 */        while (Float2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 506:506 */          int slot = HashCommon.murmurHash3(Float2ShortOpenCustomHashMap.this.strategy.hashCode(Float2ShortOpenCustomHashMap.this.key[pos])) & Float2ShortOpenCustomHashMap.this.mask;
/* 507:507 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508:508 */          pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask;
/* 509:    */        }
/* 510:510 */        if (Float2ShortOpenCustomHashMap.this.used[pos] == 0) break;
/* 511:511 */        if (pos < last)
/* 512:    */        {
/* 513:513 */          if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 514:514 */          this.wrapped.add(Float2ShortOpenCustomHashMap.this.key[pos]);
/* 515:    */        }
/* 516:516 */        Float2ShortOpenCustomHashMap.this.key[last] = Float2ShortOpenCustomHashMap.this.key[pos];
/* 517:517 */        Float2ShortOpenCustomHashMap.this.value[last] = Float2ShortOpenCustomHashMap.this.value[pos];
/* 518:    */      }
/* 519:519 */      Float2ShortOpenCustomHashMap.this.used[last] = false;
/* 520:520 */      return last;
/* 521:    */    }
/* 522:    */    
...
/* 526:    */      {
/* 527:527 */        Float2ShortOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 528:528 */        this.last = -1;
/* 529:529 */        return;
/* 530:    */      }
/* 531:531 */      Float2ShortOpenCustomHashMap.this.size -= 1;
...
/* 543:    */    } }
/* 544:    */  
/* 545:545 */  private class EntryIterator extends Float2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Float2ShortMap.Entry> { private EntryIterator() { super(null); }
/* 546:    */    
/* 547:    */    private Float2ShortOpenCustomHashMap.MapEntry entry;
/* 548:548 */    public Float2ShortMap.Entry next() { return this.entry = new Float2ShortOpenCustomHashMap.MapEntry(Float2ShortOpenCustomHashMap.this, nextEntry()); }
/* 549:    */    
/* 550:    */    public void remove()
/* 551:    */    {
/* 552:552 */      super.remove();
/* 553:553 */      Float2ShortOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 554:    */    } }
/* 555:    */  
/* 556:556 */  private class FastEntryIterator extends Float2ShortOpenCustomHashMap.MapIterator implements ObjectIterator<Float2ShortMap.Entry> { private FastEntryIterator() { super(null); }
/* 557:557 */    final AbstractFloat2ShortMap.BasicEntry entry = new AbstractFloat2ShortMap.BasicEntry(0.0F, (short)0);
/* 558:    */    
/* 559:559 */    public AbstractFloat2ShortMap.BasicEntry next() { int e = nextEntry();
/* 560:560 */      this.entry.key = Float2ShortOpenCustomHashMap.this.key[e];
/* 561:561 */      this.entry.value = Float2ShortOpenCustomHashMap.this.value[e];
/* 562:562 */      return this.entry;
/* 563:    */    } }
/* 564:    */  
/* 565:    */  private final class MapEntrySet extends AbstractObjectSet<Float2ShortMap.Entry> implements Float2ShortMap.FastEntrySet { private MapEntrySet() {}
/* 566:    */    
/* 567:567 */    public ObjectIterator<Float2ShortMap.Entry> iterator() { return new Float2ShortOpenCustomHashMap.EntryIterator(Float2ShortOpenCustomHashMap.this, null); }
/* 568:    */    
/* 569:    */    public ObjectIterator<Float2ShortMap.Entry> fastIterator() {
/* 570:570 */      return new Float2ShortOpenCustomHashMap.FastEntryIterator(Float2ShortOpenCustomHashMap.this, null);
/* 571:    */    }
/* 572:    */    
/* 573:    */    public boolean contains(Object o) {
/* 574:574 */      if (!(o instanceof Map.Entry)) return false;
/* 575:575 */      Map.Entry<Float, Short> e = (Map.Entry)o;
/* 576:576 */      float k = ((Float)e.getKey()).floatValue();
/* 577:    */      
/* 578:578 */      int pos = HashCommon.murmurHash3(Float2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ShortOpenCustomHashMap.this.mask;
/* 579:    */      
/* 580:580 */      while (Float2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 581:581 */        if (Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[pos], k)) return Float2ShortOpenCustomHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 582:582 */        pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask;
/* 583:    */      }
...
/* 589:589 */      Map.Entry<Float, Short> e = (Map.Entry)o;
/* 590:590 */      float k = ((Float)e.getKey()).floatValue();
/* 591:    */      
/* 592:592 */      int pos = HashCommon.murmurHash3(Float2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ShortOpenCustomHashMap.this.mask;
/* 593:    */      
/* 594:594 */      while (Float2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 595:595 */        if (Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[pos], k)) {
/* 596:596 */          Float2ShortOpenCustomHashMap.this.remove(e.getKey());
/* 597:597 */          return true;
/* 598:    */        }
/* 599:599 */        pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask;
/* 600:    */      }
/* 601:601 */      return false;
/* 602:    */    }
/* 603:    */    
/* 604:604 */    public int size() { return Float2ShortOpenCustomHashMap.this.size; }
/* 605:    */    
/* 607:607 */    public void clear() { Float2ShortOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
/* 610:    */  public Float2ShortMap.FastEntrySet float2ShortEntrySet() {
...
/* 618:    */    extends Float2ShortOpenCustomHashMap.MapIterator
/* 619:    */    implements FloatIterator
/* 620:    */  {
/* 621:621 */    public KeyIterator() { super(null); }
/* 622:622 */    public float nextFloat() { return Float2ShortOpenCustomHashMap.this.key[nextEntry()]; }
/* 623:623 */    public Float next() { return Float.valueOf(Float2ShortOpenCustomHashMap.this.key[nextEntry()]); } }
/* 624:    */  
/* 625:    */  private final class KeySet extends AbstractFloatSet { private KeySet() {}
/* 626:    */    
/* 627:627 */    public FloatIterator iterator() { return new Float2ShortOpenCustomHashMap.KeyIterator(Float2ShortOpenCustomHashMap.this); }
/* 628:    */    
/* 629:    */    public int size() {
/* 630:630 */      return Float2ShortOpenCustomHashMap.this.size;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    public boolean contains(float k) { return Float2ShortOpenCustomHashMap.this.containsKey(k); }
/* 634:    */    
/* 635:    */    public boolean remove(float k) {
/* 636:636 */      int oldSize = Float2ShortOpenCustomHashMap.this.size;
/* 637:637 */      Float2ShortOpenCustomHashMap.this.remove(k);
/* 638:638 */      return Float2ShortOpenCustomHashMap.this.size != oldSize;
/* 639:    */    }
/* 640:    */    
/* 641:641 */    public void clear() { Float2ShortOpenCustomHashMap.this.clear(); }
/* 642:    */  }
/* 643:    */  
...
/* 652:    */    extends Float2ShortOpenCustomHashMap.MapIterator
/* 653:    */    implements ShortIterator
/* 654:    */  {
/* 655:655 */    public ValueIterator() { super(null); }
/* 656:656 */    public short nextShort() { return Float2ShortOpenCustomHashMap.this.value[nextEntry()]; }
/* 657:657 */    public Short next() { return Short.valueOf(Float2ShortOpenCustomHashMap.this.value[nextEntry()]); }
/* 658:    */  }
/* 659:    */  
...
/* 662:662 */          return new Float2ShortOpenCustomHashMap.ValueIterator(Float2ShortOpenCustomHashMap.this);
/* 663:    */        }
/* 664:    */        
/* 665:665 */        public int size() { return Float2ShortOpenCustomHashMap.this.size; }
/* 666:    */        
/* 667:    */        public boolean contains(short v) {
/* 668:668 */          return Float2ShortOpenCustomHashMap.this.containsValue(v);
/* 669:    */        }
/* 670:    */        
/* 671:671 */        public void clear() { Float2ShortOpenCustomHashMap.this.clear(); }
/* 672:    */      };
/* 673:    */    }
...
/* 774:    */  }
/* 775:    */  
/* 779:    */  public Float2ShortOpenCustomHashMap clone()
/* 780:    */  {
/* 781:    */    Float2ShortOpenCustomHashMap c;
/* 782:    */    
/* 784:    */    try
/* 785:    */    {
/* 786:786 */      c = (Float2ShortOpenCustomHashMap)super.clone();
/* 787:    */    }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.floats.Float2ShortOpenCustomHashMap
