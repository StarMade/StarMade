...
/* 662 */           return new Float2ShortOpenCustomHashMap.ValueIterator(Float2ShortOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 665 */           return Float2ShortOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(short v) {
/* 668 */           return Float2ShortOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 671 */           Float2ShortOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 786 */       c = (Float2ShortOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Float2ShortOpenCustomHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 655 */       super(null); } 
/* 656 */     public short nextShort() { return Float2ShortOpenCustomHashMap.this.value[nextEntry()]; } 
/* 657 */     public Short next() { return Short.valueOf(Float2ShortOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 627 */       return new Float2ShortOpenCustomHashMap.KeyIterator(Float2ShortOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 630 */       return Float2ShortOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(float k) {
/* 633 */       return Float2ShortOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(float k) {
/* 636 */       int oldSize = Float2ShortOpenCustomHashMap.this.size;
/* 637 */       Float2ShortOpenCustomHashMap.this.remove(k);
/* 638 */       return Float2ShortOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 641 */       Float2ShortOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Float2ShortOpenCustomHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public float nextFloat() { return Float2ShortOpenCustomHashMap.this.key[nextEntry()]; } 
/* 623 */     public Float next() { return Float.valueOf(Float2ShortOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
/*     */   private final class MapEntrySet extends AbstractObjectSet<Float2ShortMap.Entry>
...
/*     */     {
/* 567 */       return new Float2ShortOpenCustomHashMap.EntryIterator(Float2ShortOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Float2ShortMap.Entry> fastIterator() {
/* 570 */       return new Float2ShortOpenCustomHashMap.FastEntryIterator(Float2ShortOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 578 */       int pos = HashCommon.murmurHash3(Float2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ShortOpenCustomHashMap.this.mask;
/*     */ 
/* 580 */       while (Float2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 581 */         if (Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[pos], k)) return Float2ShortOpenCustomHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 582 */         pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask;
/*     */       }
/* 584 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 592 */       int pos = HashCommon.murmurHash3(Float2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ShortOpenCustomHashMap.this.mask;
/*     */ 
/* 594 */       while (Float2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 595 */         if (Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[pos], k)) {
/* 596 */           Float2ShortOpenCustomHashMap.this.remove(e.getKey());
/* 597 */           return true;
/*     */         }
/* 599 */         pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask;
/*     */       }
/* 601 */       return false;
/*     */     }
/*     */     public int size() {
/* 604 */       return Float2ShortOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 607 */       Float2ShortOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Float2ShortOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Float2ShortMap.Entry>
/*     */   {
/* 557 */     final AbstractFloat2ShortMap.BasicEntry entry = new AbstractFloat2ShortMap.BasicEntry(0.0F, (short)0);
/*     */ 
...
/* 559 */       int e = nextEntry();
/* 560 */       this.entry.key = Float2ShortOpenCustomHashMap.this.key[e];
/* 561 */       this.entry.value = Float2ShortOpenCustomHashMap.this.value[e];
/* 562 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Float2ShortOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Float2ShortMap.Entry>
/*     */   {
...
/* 548 */       return this.entry = new Float2ShortOpenCustomHashMap.MapEntry(Float2ShortOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 552 */       super.remove();
/* 553 */       Float2ShortOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 454 */       this.pos = Float2ShortOpenCustomHashMap.this.n;
/*     */ 
/* 457 */       this.last = -1;
/*     */ 
/* 459 */       this.c = Float2ShortOpenCustomHashMap.this.size;
/*     */ 
/* 464 */       boolean[] used = Float2ShortOpenCustomHashMap.this.used;
...
/*     */ 
/* 477 */         int pos = HashCommon.murmurHash3(Float2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Float2ShortOpenCustomHashMap.this.mask;
/*     */ 
/* 479 */         while (Float2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 480 */           if (Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481 */           pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 484 */       this.last = this.pos;
/*     */ 
/* 486 */       if (this.c != 0) {
/* 487 */         boolean[] used = Float2ShortOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 504 */         pos = (last = pos) + 1 & Float2ShortOpenCustomHashMap.this.mask;
/* 505 */         while (Float2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 506 */           int slot = HashCommon.murmurHash3(Float2ShortOpenCustomHashMap.this.strategy.hashCode(Float2ShortOpenCustomHashMap.this.key[pos])) & Float2ShortOpenCustomHashMap.this.mask;
/* 507 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508 */           pos = pos + 1 & Float2ShortOpenCustomHashMap.this.mask;
/*     */         }
/* 510 */         if (Float2ShortOpenCustomHashMap.this.used[pos] == 0) break;
/* 511 */         if (pos < last)
/*     */         {
/* 513 */           if (this.wrapped == null) this.wrapped = new FloatArrayList();
/* 514 */           this.wrapped.add(Float2ShortOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 516 */         Float2ShortOpenCustomHashMap.this.key[last] = Float2ShortOpenCustomHashMap.this.key[pos];
/* 517 */         Float2ShortOpenCustomHashMap.this.value[last] = Float2ShortOpenCustomHashMap.this.value[pos];
/*     */       }
/* 519 */       Float2ShortOpenCustomHashMap.this.used[last] = false;
/* 520 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 525 */       if (this.pos < -1)
/*     */       {
/* 527 */         Float2ShortOpenCustomHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
/* 528 */         this.last = -1;
/* 529 */         return;
/*     */       }
/* 531 */       Float2ShortOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Float getKey() {
/* 418 */       return Float.valueOf(Float2ShortOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public float getFloatKey() {
/* 421 */       return Float2ShortOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Short getValue() {
/* 424 */       return Short.valueOf(Float2ShortOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public short getShortValue() {
/* 427 */       return Float2ShortOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public short setValue(short v) {
/* 430 */       short oldValue = Float2ShortOpenCustomHashMap.this.value[this.index];
/* 431 */       Float2ShortOpenCustomHashMap.this.value[this.index] = v;
/* 432 */       return oldValue;
/*     */     }
/*     */     public Short setValue(Short v) {
...
/* 441 */       return (Float2ShortOpenCustomHashMap.this.strategy.equals(Float2ShortOpenCustomHashMap.this.key[this.index], ((Float)e.getKey()).floatValue())) && (Float2ShortOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */     public int hashCode() {
/* 444 */       return Float2ShortOpenCustomHashMap.this.strategy.hashCode(Float2ShortOpenCustomHashMap.this.key[this.index]) ^ Float2ShortOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 447 */       return Float2ShortOpenCustomHashMap.this.key[this.index] + "=>" + Float2ShortOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
