...
/*  15:    */
/*  62:    */public abstract class AbstractFloat2ShortMap
/*  63:    */  extends AbstractFloat2ShortFunction
/*  64:    */  implements Float2ShortMap, Serializable
/*  65:    */{
...
/*  79:    */  }
/*  80:    */  
/*  86:    */  public void putAll(Map<? extends Float, ? extends Short> m)
/*  87:    */  {
/*  88: 88 */    int n = m.size();
/*  89: 89 */    Iterator<? extends Map.Entry<? extends Float, ? extends Short>> i = m.entrySet().iterator();
/*  90: 90 */    if ((m instanceof Float2ShortMap))
/*  91:    */    {
/*  92: 92 */      while (n-- != 0) {
/*  93: 93 */        Float2ShortMap.Entry e = (Float2ShortMap.Entry)i.next();
/*  94: 94 */        put(e.getFloatKey(), e.getShortValue());
/*  95:    */      }
/*  96:    */      
/*  97:    */    }
/*  98:    */    else
/*  99: 99 */      while (n-- != 0) {
/* 100:100 */        Map.Entry<? extends Float, ? extends Short> e = (Map.Entry)i.next();
/* 101:101 */        put((Float)e.getKey(), (Short)e.getValue());
/* 102:    */      }
/* 103:    */  }
/* 104:    */  
...
/* 111:    */    implements Float2ShortMap.Entry
/* 112:    */  {
/* 113:    */    protected float key;
/* 114:    */    protected short value;
/* 115:    */    
/* 116:    */    public BasicEntry(Float key, Short value)
/* 117:    */    {
/* 118:118 */      this.key = key.floatValue();
/* 119:119 */      this.value = value.shortValue();
/* 120:    */    }
/* 121:    */    
/* 122:122 */    public BasicEntry(float key, short value) { this.key = key;
...
/* 162:    */      
/* 163:163 */      return (this.key == ((Float)e.getKey()).floatValue()) && (this.value == ((Short)e.getValue()).shortValue());
/* 164:    */    }
/* 165:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(float k) { return AbstractFloat2ShortMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractFloat2ShortMap.this.size(); }
/* 196:196 */      public void clear() { AbstractFloat2ShortMap.this.clear(); }
/* 197:    */      
/* 198:    */      public FloatIterator iterator() {
/* 199:199 */        new AbstractFloatIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<Float, Short>> i = AbstractFloat2ShortMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public float nextFloat() { return ((Float2ShortMap.Entry)this.i.next()).getFloatKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(short k) { return AbstractFloat2ShortMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractFloat2ShortMap.this.size(); }
/* 229:229 */      public void clear() { AbstractFloat2ShortMap.this.clear(); }
/* 230:    */      
/* 231:    */      public ShortIterator iterator() {
/* 232:232 */        new AbstractShortIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<Float, Short>> i = AbstractFloat2ShortMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public short nextShort() { return ((Float2ShortMap.Entry)this.i.next()).getShortValue(); }
/* 236:    */          
...
/* 241:    */  }
/* 242:    */  
/* 244:    */  public ObjectSet<Map.Entry<Float, Short>> entrySet()
/* 245:    */  {
/* 246:246 */    return float2ShortEntrySet();
/* 247:    */  }
/* 248:    */  
/* 257:    */  public int hashCode()
/* 258:    */  {
/* 259:259 */    int h = 0;int n = size();
/* 260:260 */    ObjectIterator<? extends Map.Entry<Float, Short>> i = entrySet().iterator();
/* 261:    */    
...
/* 278:278 */    ObjectIterator<? extends Map.Entry<Float, Short>> i = entrySet().iterator();
/* 279:279 */    int n = size();
/* 280:    */    
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Float2ShortMap.Entry e = (Float2ShortMap.Entry)i.next();
/* 290:    */      
