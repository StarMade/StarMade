...
public class Float2ByteMaps
{
  ...
  public static Float2ByteMap synchronize(Float2ByteMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Float2ByteMap synchronize(Float2ByteMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Float2ByteMap unmodifiable(Float2ByteMap local_m)
  {
    ...
    implements Float2ByteMap, Serializable
  {
    ...
    protected UnmodifiableMap(Float2ByteMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Float2ByteMap, Serializable
  {
    ...
    protected SynchronizedMap(Float2ByteMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Float2ByteMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Float2ByteMap, Serializable, Cloneable
  {
      ...
      implements Float2ByteMap.Entry, Map.Entry<Float, Byte>
    {
      ...
      public Float getKey()
      {
        return Float.valueOf(Float2ByteMaps.Singleton.this.key);
      }
      
      public Byte getValue()
      {
        return Byte.valueOf(Float2ByteMaps.Singleton.this.value);
      }
      
      public float getFloatKey()
      {
        return Float2ByteMaps.Singleton.this.key;
      }
      
      public byte getByteValue()
      {
        return Float2ByteMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Float2ByteMaps.Singleton.this.key == ((Float)local_e.getKey()).floatValue()) && (Float2ByteMaps.Singleton.this.value == ((Byte)local_e.getValue()).byteValue());
      }
      
      public int hashCode()
      {
        return HashCommon.float2int(Float2ByteMaps.Singleton.this.key) ^ Float2ByteMaps.Singleton.this.value;
      }
      
      public String toString()
      {
        return Float2ByteMaps.Singleton.this.key + "->" + Float2ByteMaps.Singleton.this.value;
      }
    }
  }
