  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Float2ObjectOpenHashMap(int expected, float local_f)
  {
  ...
  public Float2ObjectOpenHashMap(Map<? extends Float, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2ObjectOpenHashMap(Map<? extends Float, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2ObjectOpenHashMap(Float2ObjectMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Float2ObjectOpenHashMap(Float2ObjectMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Float2ObjectOpenHashMap(float[] local_k, V[] local_v, float local_f)
  {
  ...
  public Float2ObjectOpenHashMap(float[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Float2ObjectOpenHashMap.ValueIterator(Float2ObjectOpenHashMap.this);
        }
        ...
        {
          return Float2ObjectOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Float2ObjectOpenHashMap<V> local_c;
    try
    {
      local_c = (Float2ObjectOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    float[] key = this.key;
    V[] value = this.value;
    Float2ObjectOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    implements ObjectIterator<V>
  {
    ...
    public V next()
    {
      return Float2ObjectOpenHashMap.this.value[nextEntry()];
    }
  }
    ...
    extends AbstractFloatSet
  {
    ...
    {
      return new Float2ObjectOpenHashMap.KeyIterator(Float2ObjectOpenHashMap.this);
    }
    ...
    {
      return Float2ObjectOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(float local_k)
    {
      int oldSize = Float2ObjectOpenHashMap.this.size;
      Float2ObjectOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Float2ObjectOpenHashMap.MapIterator
    implements FloatIterator
  {
    ...
    {
      return Float2ObjectOpenHashMap.this.key[nextEntry()];
    }
    
    public Float next()
    {
      return Float.valueOf(Float2ObjectOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Float2ObjectMap.FastEntrySet<V>
  {
    ...
    {
      return new Float2ObjectOpenHashMap.EntryIterator(Float2ObjectOpenHashMap.this, null);
    }
    
    public ObjectIterator<Float2ObjectMap.Entry<V>> fastIterator()
    {
      return new Float2ObjectOpenHashMap.FastEntryIterator(Float2ObjectOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2ObjectOpenHashMap.this.mask; Float2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ObjectOpenHashMap.this.mask) {
        if (Float2ObjectOpenHashMap.this.key[pos] == local_k) {
          return Float2ObjectOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Float2ObjectOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(HashCommon.float2int(local_k)) & Float2ObjectOpenHashMap.this.mask; Float2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ObjectOpenHashMap.this.mask) {
        if (Float2ObjectOpenHashMap.this.key[pos] == local_k)
        {
          Float2ObjectOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Float2ObjectMap.Entry<V>>
  {
    ...
    public AbstractFloat2ObjectMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Float2ObjectOpenHashMap.this.key[local_e];
      this.entry.value = Float2ObjectOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Float2ObjectMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Float2ObjectOpenHashMap.MapEntry(Float2ObjectOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Float2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Float2ObjectOpenHashMap.this.field_49;
    int last = -1;
    int field_2028 = Float2ObjectOpenHashMap.this.size;
    FloatArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Float2ObjectOpenHashMap.this.used;
      while ((this.field_2028 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2028 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2028 != 0)
      {
        boolean[] local_k = Float2ObjectOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Float2ObjectOpenHashMap.this.mask; Float2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Float2ObjectOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(HashCommon.float2int(Float2ObjectOpenHashMap.this.key[pos])) & Float2ObjectOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Float2ObjectOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Float2ObjectOpenHashMap.this.key[pos]);
        }
        Float2ObjectOpenHashMap.this.key[last] = Float2ObjectOpenHashMap.this.key[pos];
        Float2ObjectOpenHashMap.this.value[last] = Float2ObjectOpenHashMap.this.value[pos];
      }
      Float2ObjectOpenHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Float2ObjectOpenHashMap.this.remove(this.wrapped.getFloat(-this.pos - 2));
        this.last = -1;
        return;
      }
      Float2ObjectOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2028 > 0))
      {
        this.field_2028 += 1;
        nextEntry();
      }
    ...
    implements Float2ObjectMap.Entry<V>, Map.Entry<Float, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Float2ObjectOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Float, V> local_e = (Map.Entry)local_o;
      return (Float2ObjectOpenHashMap.this.key[this.index] == ((Float)local_e.getKey()).floatValue()) && (Float2ObjectOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Float2ObjectOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
