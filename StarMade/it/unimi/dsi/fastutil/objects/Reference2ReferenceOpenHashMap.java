...
/*  13:    */
/*  84:    */public class Reference2ReferenceOpenHashMap<K, V>
/*  85:    */  extends AbstractReference2ReferenceMap<K, V>
...
/*  98:    */  protected volatile transient Reference2ReferenceMap.FastEntrySet<K, V> entries;
/*  99:    */  protected volatile transient ReferenceSet<K> keys;
/* 100:    */  protected volatile transient ReferenceCollection<V> values;
/* 101:    */  
/* 102:    */  public Reference2ReferenceOpenHashMap(int expected, float f)
/* 103:    */  {
...
/* 113:    */  }
/* 114:    */  
/* 117:    */  public Reference2ReferenceOpenHashMap(int expected)
/* 118:    */  {
/* 119:119 */    this(expected, 0.75F);
/* 120:    */  }
/* 121:    */  
/* 123:    */  public Reference2ReferenceOpenHashMap()
/* 124:    */  {
/* 125:125 */    this(16, 0.75F);
/* 126:    */  }
/* 127:    */  
/* 131:    */  public Reference2ReferenceOpenHashMap(Map<? extends K, ? extends V> m, float f)
/* 132:    */  {
/* 133:133 */    this(m.size(), f);
/* 134:134 */    putAll(m);
/* 135:    */  }
/* 136:    */  
/* 139:    */  public Reference2ReferenceOpenHashMap(Map<? extends K, ? extends V> m)
/* 140:    */  {
/* 141:141 */    this(m, 0.75F);
/* 142:    */  }
/* 143:    */  
/* 147:    */  public Reference2ReferenceOpenHashMap(Reference2ReferenceMap<K, V> m, float f)
/* 148:    */  {
/* 149:149 */    this(m.size(), f);
/* 150:150 */    putAll(m);
/* 151:    */  }
/* 152:    */  
/* 155:    */  public Reference2ReferenceOpenHashMap(Reference2ReferenceMap<K, V> m)
/* 156:    */  {
/* 157:157 */    this(m, 0.75F);
/* 158:    */  }
/* 159:    */  
/* 165:    */  public Reference2ReferenceOpenHashMap(K[] k, V[] v, float f)
/* 166:    */  {
...
/* 171:    */  }
/* 172:    */  
/* 176:    */  public Reference2ReferenceOpenHashMap(K[] k, V[] v)
/* 177:    */  {
...
/* 311:    */    implements Reference2ReferenceMap.Entry<K, V>, Map.Entry<K, V>
/* 312:    */  {
...
/* 318:    */    }
/* 319:    */    
/* 320:320 */    public K getKey() { return Reference2ReferenceOpenHashMap.this.key[this.index]; }
/* 321:    */    
/* 323:323 */    public V getValue() { return Reference2ReferenceOpenHashMap.this.value[this.index]; }
/* 324:    */    
/* 325:    */    public V setValue(V v) {
/* 326:326 */      V oldValue = Reference2ReferenceOpenHashMap.this.value[this.index];
/* 327:327 */      Reference2ReferenceOpenHashMap.this.value[this.index] = v;
...
/* 334:334 */      return (Reference2ReferenceOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/* 335:    */    }
/* 336:    */    
/* 337:337 */    public int hashCode() { return (Reference2ReferenceOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ReferenceOpenHashMap.this.key[this.index])) ^ (Reference2ReferenceOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Reference2ReferenceOpenHashMap.this.value[this.index])); }
/* 338:    */    
/* 340:340 */    public String toString() { return Reference2ReferenceOpenHashMap.this.key[this.index] + "=>" + Reference2ReferenceOpenHashMap.this.value[this.index]; } }
/* 341:    */  
...
/* 346:    */    
/* 347:347 */    private MapIterator() { this.pos = Reference2ReferenceOpenHashMap.this.n;
/* 348:    */      
/* 350:350 */      this.last = -1;
/* 351:    */      
/* 352:352 */      this.c = Reference2ReferenceOpenHashMap.this.size;
/* 353:    */      
/* 357:357 */      boolean[] used = Reference2ReferenceOpenHashMap.this.used;
...
/* 369:    */        
/* 370:370 */        int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceOpenHashMap.this.mask;
/* 371:    */        
/* 372:372 */        while (Reference2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 373:373 */          if (Reference2ReferenceOpenHashMap.this.key[pos] == k) return pos;
/* 374:374 */          pos = pos + 1 & Reference2ReferenceOpenHashMap.this.mask;
/* 375:    */        }
/* 376:    */      }
/* 377:377 */      this.last = this.pos;
/* 378:    */      
/* 379:379 */      if (this.c != 0) {
/* 380:380 */        boolean[] used = Reference2ReferenceOpenHashMap.this.used;
...
/* 395:    */      for (;;)
/* 396:    */      {
/* 397:397 */        pos = (last = pos) + 1 & Reference2ReferenceOpenHashMap.this.mask;
/* 398:398 */        while (Reference2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 399:399 */          int slot = (Reference2ReferenceOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ReferenceOpenHashMap.this.key[pos]))) & Reference2ReferenceOpenHashMap.this.mask;
/* 400:400 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 401:401 */          pos = pos + 1 & Reference2ReferenceOpenHashMap.this.mask;
/* 402:    */        }
/* 403:403 */        if (Reference2ReferenceOpenHashMap.this.used[pos] == 0) break;
/* 404:404 */        if (pos < last)
/* 405:    */        {
/* 406:406 */          if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 407:407 */          this.wrapped.add(Reference2ReferenceOpenHashMap.this.key[pos]);
/* 408:    */        }
/* 409:409 */        Reference2ReferenceOpenHashMap.this.key[last] = Reference2ReferenceOpenHashMap.this.key[pos];
/* 410:410 */        Reference2ReferenceOpenHashMap.this.value[last] = Reference2ReferenceOpenHashMap.this.value[pos];
/* 411:    */      }
/* 412:412 */      Reference2ReferenceOpenHashMap.this.used[last] = false;
/* 413:413 */      Reference2ReferenceOpenHashMap.this.key[last] = null;
/* 414:414 */      Reference2ReferenceOpenHashMap.this.value[last] = null;
/* 415:415 */      return last;
/* 416:    */    }
/* 417:    */    
...
/* 421:    */      {
/* 422:422 */        Reference2ReferenceOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 423:423 */        this.last = -1;
/* 424:424 */        return;
/* 425:    */      }
/* 426:426 */      Reference2ReferenceOpenHashMap.this.size -= 1;
...
/* 438:    */    } }
/* 439:    */  
/* 440:440 */  private class EntryIterator extends Reference2ReferenceOpenHashMap<K, V>.MapIterator implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> { private EntryIterator() { super(null); }
/* 441:    */    
/* 442:    */    private Reference2ReferenceOpenHashMap<K, V>.MapEntry entry;
/* 443:443 */    public Reference2ReferenceMap.Entry<K, V> next() { return this.entry = new Reference2ReferenceOpenHashMap.MapEntry(Reference2ReferenceOpenHashMap.this, nextEntry()); }
/* 444:    */    
/* 445:    */    public void remove()
/* 446:    */    {
/* 447:447 */      super.remove();
/* 448:448 */      Reference2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 449:    */    } }
/* 450:    */  
/* 451:451 */  private class FastEntryIterator extends Reference2ReferenceOpenHashMap<K, V>.MapIterator implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> { private FastEntryIterator() { super(null); }
/* 452:452 */    final AbstractReference2ReferenceMap.BasicEntry<K, V> entry = new AbstractReference2ReferenceMap.BasicEntry(null, null);
/* 453:    */    
/* 454:454 */    public AbstractReference2ReferenceMap.BasicEntry<K, V> next() { int e = nextEntry();
/* 455:455 */      this.entry.key = Reference2ReferenceOpenHashMap.this.key[e];
/* 456:456 */      this.entry.value = Reference2ReferenceOpenHashMap.this.value[e];
/* 457:457 */      return this.entry;
/* 458:    */    } }
/* 459:    */  
/* 460:    */  private final class MapEntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceMap.FastEntrySet<K, V> { private MapEntrySet() {}
/* 461:    */    
/* 462:462 */    public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> iterator() { return new Reference2ReferenceOpenHashMap.EntryIterator(Reference2ReferenceOpenHashMap.this, null); }
/* 463:    */    
/* 464:    */    public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator() {
/* 465:465 */      return new Reference2ReferenceOpenHashMap.FastEntryIterator(Reference2ReferenceOpenHashMap.this, null);
/* 466:    */    }
/* 467:    */    
...
/* 472:    */      
/* 473:473 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceOpenHashMap.this.mask;
/* 474:    */      
/* 475:475 */      while (Reference2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 476:476 */        if (Reference2ReferenceOpenHashMap.this.key[pos] == k) return Reference2ReferenceOpenHashMap.this.value[pos] == e.getValue();
/* 477:477 */        pos = pos + 1 & Reference2ReferenceOpenHashMap.this.mask;
/* 478:    */      }
...
/* 486:    */      
/* 487:487 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceOpenHashMap.this.mask;
/* 488:    */      
/* 489:489 */      while (Reference2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 490:490 */        if (Reference2ReferenceOpenHashMap.this.key[pos] == k) {
/* 491:491 */          Reference2ReferenceOpenHashMap.this.remove(e.getKey());
/* 492:492 */          return true;
/* 493:    */        }
/* 494:494 */        pos = pos + 1 & Reference2ReferenceOpenHashMap.this.mask;
/* 495:    */      }
/* 496:496 */      return false;
/* 497:    */    }
/* 498:    */    
/* 499:499 */    public int size() { return Reference2ReferenceOpenHashMap.this.size; }
/* 500:    */    
/* 502:502 */    public void clear() { Reference2ReferenceOpenHashMap.this.clear(); }
/* 503:    */  }
/* 504:    */  
/* 505:    */  public Reference2ReferenceMap.FastEntrySet<K, V> reference2ReferenceEntrySet() {
...
/* 513:    */    extends Reference2ReferenceOpenHashMap<K, V>.MapIterator
/* 514:    */    implements ObjectIterator<K>
/* 515:    */  {
/* 516:516 */    public KeyIterator() { super(null); }
/* 517:517 */    public K next() { return Reference2ReferenceOpenHashMap.this.key[nextEntry()]; } }
/* 518:    */  
/* 519:    */  private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/* 520:    */    
/* 521:521 */    public ObjectIterator<K> iterator() { return new Reference2ReferenceOpenHashMap.KeyIterator(Reference2ReferenceOpenHashMap.this); }
/* 522:    */    
/* 523:    */    public int size() {
/* 524:524 */      return Reference2ReferenceOpenHashMap.this.size;
/* 525:    */    }
/* 526:    */    
/* 527:527 */    public boolean contains(Object k) { return Reference2ReferenceOpenHashMap.this.containsKey(k); }
/* 528:    */    
/* 529:    */    public boolean remove(Object k) {
/* 530:530 */      int oldSize = Reference2ReferenceOpenHashMap.this.size;
/* 531:531 */      Reference2ReferenceOpenHashMap.this.remove(k);
/* 532:532 */      return Reference2ReferenceOpenHashMap.this.size != oldSize;
/* 533:    */    }
/* 534:    */    
/* 535:535 */    public void clear() { Reference2ReferenceOpenHashMap.this.clear(); }
/* 536:    */  }
/* 537:    */  
...
/* 546:    */    extends Reference2ReferenceOpenHashMap<K, V>.MapIterator
/* 547:    */    implements ObjectIterator<V>
/* 548:    */  {
/* 549:549 */    public ValueIterator() { super(null); }
/* 550:550 */    public V next() { return Reference2ReferenceOpenHashMap.this.value[nextEntry()]; }
/* 551:    */  }
/* 552:    */  
...
/* 555:555 */          return new Reference2ReferenceOpenHashMap.ValueIterator(Reference2ReferenceOpenHashMap.this);
/* 556:    */        }
/* 557:    */        
/* 558:558 */        public int size() { return Reference2ReferenceOpenHashMap.this.size; }
/* 559:    */        
/* 560:    */        public boolean contains(Object v) {
/* 561:561 */          return Reference2ReferenceOpenHashMap.this.containsValue(v);
/* 562:    */        }
/* 563:    */        
/* 564:564 */        public void clear() { Reference2ReferenceOpenHashMap.this.clear(); }
/* 565:    */      };
/* 566:    */    }
...
/* 667:    */  }
/* 668:    */  
/* 672:    */  public Reference2ReferenceOpenHashMap<K, V> clone()
/* 673:    */  {
/* 674:    */    Reference2ReferenceOpenHashMap<K, V> c;
/* 675:    */    
/* 677:    */    try
/* 678:    */    {
/* 679:679 */      c = (Reference2ReferenceOpenHashMap)super.clone();
/* 680:    */    }
...
/* 717:717 */    Reference2ReferenceOpenHashMap<K, V>.MapIterator i = new MapIterator(null);
