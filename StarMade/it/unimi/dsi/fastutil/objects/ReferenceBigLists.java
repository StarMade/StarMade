...
public class ReferenceBigLists
{
  ...
  public static <K> ReferenceBigList<K> shuffle(ReferenceBigList<K> local_l, Random random)
  {
  ...
  public static <K> ReferenceBigList<K> synchronize(ReferenceBigList<K> local_l)
  {
    return new SynchronizedBigList(local_l);
  }
  
  public static <K> ReferenceBigList<K> synchronize(ReferenceBigList<K> local_l, Object sync)
  {
    return new SynchronizedBigList(local_l, sync);
  }
  
  public static <K> ReferenceBigList<K> unmodifiable(ReferenceBigList<K> local_l)
  {
    ...
    implements Serializable
  {
    ...
    public boolean addAll(long index, ReferenceCollection<K> local_c)
    {
      return this.list.addAll(intIndex(index), local_c);
    }
    
    public boolean addAll(long index, ReferenceBigList<K> local_c)
    {
      return this.list.addAll(intIndex(index), local_c);
    }
    ...
    public boolean addAll(ReferenceBigList<K> local_c)
    {
    ...
    public boolean addAll(ReferenceCollection<K> local_c)
    {
      return this.list.addAll(local_c);
    }
    
    public boolean containsAll(ReferenceCollection<K> local_c)
    {
      return this.list.containsAll(local_c);
    }
    
    public boolean removeAll(ReferenceCollection<K> local_c)
    {
      return this.list.removeAll(local_c);
    }
    
    public boolean retainAll(ReferenceCollection<K> local_c)
    {
    ...
    implements ReferenceBigList<K>, Serializable
  {
    ...
    protected UnmodifiableBigList(ReferenceBigList<K> local_l)
    {
      super();
      this.list = local_l;
    }
    ...
    public ReferenceBigList<K> subList(long from, long local_to)
    {
      return ReferenceBigLists.unmodifiable(this.list.subList(from, local_to));
    }
    ...
    implements ReferenceBigList<K>, Serializable
  {
    ...
    protected SynchronizedBigList(ReferenceBigList<K> local_l, Object sync)
    {
      super(sync);
      this.list = local_l;
    }
    
    protected SynchronizedBigList(ReferenceBigList<K> local_l)
    {
      super();
      this.list = local_l;
    }
    ...
    public ReferenceBigList<K> subList(long from, long local_to)
    {
      synchronized (this.sync)
      {
        return ReferenceBigLists.synchronize(this.list.subList(from, local_to), this.sync);
      }
    }
