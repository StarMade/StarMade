...
/*   14:     */
/*   99:     */public class Object2ReferenceLinkedOpenHashMap<K, V>
...
/*  127:     */  
/*  135:     */  public Object2ReferenceLinkedOpenHashMap(int expected, float f)
/*  136:     */  {
...
/*  147:     */  }
/*  148:     */  
/*  151:     */  public Object2ReferenceLinkedOpenHashMap(int expected)
/*  152:     */  {
/*  153: 153 */    this(expected, 0.75F);
/*  154:     */  }
/*  155:     */  
/*  157:     */  public Object2ReferenceLinkedOpenHashMap()
/*  158:     */  {
/*  159: 159 */    this(16, 0.75F);
/*  160:     */  }
/*  161:     */  
/*  165:     */  public Object2ReferenceLinkedOpenHashMap(Map<? extends K, ? extends V> m, float f)
/*  166:     */  {
/*  167: 167 */    this(m.size(), f);
/*  168: 168 */    putAll(m);
/*  169:     */  }
/*  170:     */  
/*  173:     */  public Object2ReferenceLinkedOpenHashMap(Map<? extends K, ? extends V> m)
/*  174:     */  {
/*  175: 175 */    this(m, 0.75F);
/*  176:     */  }
/*  177:     */  
/*  181:     */  public Object2ReferenceLinkedOpenHashMap(Object2ReferenceMap<K, V> m, float f)
/*  182:     */  {
/*  183: 183 */    this(m.size(), f);
/*  184: 184 */    putAll(m);
/*  185:     */  }
/*  186:     */  
/*  189:     */  public Object2ReferenceLinkedOpenHashMap(Object2ReferenceMap<K, V> m)
/*  190:     */  {
/*  191: 191 */    this(m, 0.75F);
/*  192:     */  }
/*  193:     */  
/*  199:     */  public Object2ReferenceLinkedOpenHashMap(K[] k, V[] v, float f)
/*  200:     */  {
...
/*  205:     */  }
/*  206:     */  
/*  210:     */  public Object2ReferenceLinkedOpenHashMap(K[] k, V[] v)
/*  211:     */  {
...
/*  550:     */    implements Object2ReferenceMap.Entry<K, V>, Map.Entry<K, V>
/*  551:     */  {
...
/*  557:     */    }
/*  558:     */    
/*  559: 559 */    public K getKey() { return Object2ReferenceLinkedOpenHashMap.this.key[this.index]; }
/*  560:     */    
/*  562: 562 */    public V getValue() { return Object2ReferenceLinkedOpenHashMap.this.value[this.index]; }
/*  563:     */    
/*  564:     */    public V setValue(V v) {
/*  565: 565 */      V oldValue = Object2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  566: 566 */      Object2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
...
/*  573: 573 */      return (Object2ReferenceLinkedOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2ReferenceLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*  574:     */    }
/*  575:     */    
/*  576: 576 */    public int hashCode() { return (Object2ReferenceLinkedOpenHashMap.this.key[this.index] == null ? 0 : Object2ReferenceLinkedOpenHashMap.this.key[this.index].hashCode()) ^ (Object2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Object2ReferenceLinkedOpenHashMap.this.value[this.index])); }
/*  577:     */    
/*  578:     */    public String toString() {
/*  579: 579 */      return Object2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Object2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  580:     */    }
/*  581:     */  }
/*  582:     */  
...
/*  667: 667 */  public Object2ReferenceSortedMap<K, V> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  668: 668 */  public Object2ReferenceSortedMap<K, V> headMap(K to) { throw new UnsupportedOperationException(); }
/*  669: 669 */  public Object2ReferenceSortedMap<K, V> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  670:     */  
...
/*  684: 684 */    int index = -1;
/*  685:     */    
/*  686: 686 */    private MapIterator() { this.next = Object2ReferenceLinkedOpenHashMap.this.first;
/*  687: 687 */      this.index = 0;
/*  688:     */    }
/*  689:     */    
/*  690: 690 */    private MapIterator() { if (Object2ReferenceLinkedOpenHashMap.this.key[Object2ReferenceLinkedOpenHashMap.this.last] == null ? from == null : Object2ReferenceLinkedOpenHashMap.this.key[Object2ReferenceLinkedOpenHashMap.this.last].equals(from)) {
/*  691: 691 */        this.prev = Object2ReferenceLinkedOpenHashMap.this.last;
/*  692: 692 */        this.index = Object2ReferenceLinkedOpenHashMap.this.size;
/*  693:     */      }
/*  694:     */      else
/*  695:     */      {
/*  696: 696 */        int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2ReferenceLinkedOpenHashMap.this.mask;
/*  697:     */        
/*  698: 698 */        while (Object2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  699: 699 */          if (Object2ReferenceLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2ReferenceLinkedOpenHashMap.this.key[pos].equals(from))
/*  700:     */          {
/*  701: 701 */            this.next = ((int)Object2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  702: 702 */            this.prev = pos;
/*  703: 703 */            return;
/*  704:     */          }
/*  705: 705 */          pos = pos + 1 & Object2ReferenceLinkedOpenHashMap.this.mask;
/*  706:     */        }
...
/*  719: 719 */        this.index = Object2ReferenceLinkedOpenHashMap.this.size;
/*  720: 720 */        return;
/*  721:     */      }
/*  722: 722 */      int pos = Object2ReferenceLinkedOpenHashMap.this.first;
/*  723: 723 */      this.index = 1;
/*  724: 724 */      while (pos != this.prev) {
/*  725: 725 */        pos = (int)Object2ReferenceLinkedOpenHashMap.this.link[pos];
...
/*  736:     */    }
/*  737:     */    
/*  738: 738 */    public int nextEntry() { if (!hasNext()) return Object2ReferenceLinkedOpenHashMap.this.size();
/*  739: 739 */      this.curr = this.next;
/*  740: 740 */      this.next = ((int)Object2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  748: 748 */      this.prev = ((int)(Object2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  761: 761 */        this.prev = ((int)(Object2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  762:     */      }
/*  763:     */      else {
/*  764: 764 */        this.next = ((int)Object2ReferenceLinkedOpenHashMap.this.link[this.curr]); }
/*  765: 765 */      Object2ReferenceLinkedOpenHashMap.this.size -= 1;
/*  766:     */      
/*  768: 768 */      if (this.prev == -1) { Object2ReferenceLinkedOpenHashMap.this.first = this.next;
/*  769:     */      } else
/*  770: 770 */        Object2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Object2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  771: 771 */      if (this.next == -1) { Object2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*  772:     */      } else
/*  773: 773 */        Object2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Object2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  774: 774 */      int pos = this.curr;
/*  775:     */      int last;
/*  776:     */      for (;;) {
/*  777: 777 */        pos = (last = pos) + 1 & Object2ReferenceLinkedOpenHashMap.this.mask;
/*  778: 778 */        while (Object2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  779: 779 */          int slot = (Object2ReferenceLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ReferenceLinkedOpenHashMap.this.key[pos].hashCode())) & Object2ReferenceLinkedOpenHashMap.this.mask;
/*  780: 780 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  781: 781 */          pos = pos + 1 & Object2ReferenceLinkedOpenHashMap.this.mask;
/*  782:     */        }
/*  783: 783 */        if (Object2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  784: 784 */        Object2ReferenceLinkedOpenHashMap.this.key[last] = Object2ReferenceLinkedOpenHashMap.this.key[pos];
/*  785: 785 */        Object2ReferenceLinkedOpenHashMap.this.value[last] = Object2ReferenceLinkedOpenHashMap.this.value[pos];
/*  786: 786 */        if (this.next == pos) this.next = last;
/*  787: 787 */        if (this.prev == pos) this.prev = last;
/*  788: 788 */        Object2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*  789:     */      }
/*  790: 790 */      Object2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  791: 791 */      Object2ReferenceLinkedOpenHashMap.this.key[last] = null;
/*  792: 792 */      Object2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  793: 793 */      this.curr = -1;
/*  794:     */    }
/*  795:     */    
...
/*  804:     */    } }
/*  805:     */  
/*  806:     */  private class EntryIterator extends Object2ReferenceLinkedOpenHashMap<K, V>.MapIterator implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> { private Object2ReferenceLinkedOpenHashMap<K, V>.MapEntry entry;
/*  807:     */    
/*  808: 808 */    public EntryIterator() { super(null); }
/*  809:     */    
/*  810: 810 */    public EntryIterator() { super(from, null); }
/*  811:     */    
/*  812:     */    public Object2ReferenceLinkedOpenHashMap<K, V>.MapEntry next() {
/*  813: 813 */      return this.entry = new Object2ReferenceLinkedOpenHashMap.MapEntry(Object2ReferenceLinkedOpenHashMap.this, nextEntry());
/*  814:     */    }
/*  815:     */    
/*  816: 816 */    public Object2ReferenceLinkedOpenHashMap<K, V>.MapEntry previous() { return this.entry = new Object2ReferenceLinkedOpenHashMap.MapEntry(Object2ReferenceLinkedOpenHashMap.this, previousEntry()); }
/*  817:     */    
/*  818:     */    public void remove()
/*  819:     */    {
/*  820: 820 */      super.remove();
/*  821: 821 */      Object2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  822:     */    
/*  823: 823 */    public void set(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  824: 824 */    public void add(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  825:     */  }
/*  826:     */  
/*  827: 827 */  private class FastEntryIterator extends Object2ReferenceLinkedOpenHashMap<K, V>.MapIterator implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> { final AbstractObject2ReferenceMap.BasicEntry<K, V> entry = new AbstractObject2ReferenceMap.BasicEntry(null, null);
/*  828: 828 */    public FastEntryIterator() { super(null); }
/*  829:     */    
/*  830: 830 */    public FastEntryIterator() { super(from, null); }
/*  831:     */    
/*  832:     */    public AbstractObject2ReferenceMap.BasicEntry<K, V> next() {
/*  833: 833 */      int e = nextEntry();
/*  834: 834 */      this.entry.key = Object2ReferenceLinkedOpenHashMap.this.key[e];
/*  835: 835 */      this.entry.value = Object2ReferenceLinkedOpenHashMap.this.value[e];
/*  836: 836 */      return this.entry;
/*  837:     */    }
/*  838:     */    
/*  839: 839 */    public AbstractObject2ReferenceMap.BasicEntry<K, V> previous() { int e = previousEntry();
/*  840: 840 */      this.entry.key = Object2ReferenceLinkedOpenHashMap.this.key[e];
/*  841: 841 */      this.entry.value = Object2ReferenceLinkedOpenHashMap.this.value[e];
/*  842: 842 */      return this.entry; }
/*  843:     */    
/*  844: 844 */    public void set(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  845: 845 */    public void add(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } }
/*  846:     */  
/*  847:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>> implements Object2ReferenceSortedMap.FastSortedEntrySet<K, V> { private MapEntrySet() {}
/*  848:     */    
/*  849: 849 */    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator() { return new Object2ReferenceLinkedOpenHashMap.EntryIterator(Object2ReferenceLinkedOpenHashMap.this); }
/*  850:     */    
/*  851: 851 */    public Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator() { return null; }
/*  852: 852 */    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> fromElement, Object2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); }
/*  853: 853 */    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); }
/*  854: 854 */    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> fromElement) { throw new UnsupportedOperationException(); }
/*  855:     */    
/*  856: 856 */    public Object2ReferenceMap.Entry<K, V> first() { if (Object2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  857: 857 */      return new Object2ReferenceLinkedOpenHashMap.MapEntry(Object2ReferenceLinkedOpenHashMap.this, Object2ReferenceLinkedOpenHashMap.this.first);
/*  858:     */    }
/*  859:     */    
/*  860: 860 */    public Object2ReferenceMap.Entry<K, V> last() { if (Object2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  861: 861 */      return new Object2ReferenceLinkedOpenHashMap.MapEntry(Object2ReferenceLinkedOpenHashMap.this, Object2ReferenceLinkedOpenHashMap.this.last);
/*  862:     */    }
/*  863:     */    
...
/*  868:     */      
/*  869: 869 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ReferenceLinkedOpenHashMap.this.mask;
/*  870:     */      
/*  871: 871 */      while (Object2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  872: 872 */        if (Object2ReferenceLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2ReferenceLinkedOpenHashMap.this.key[pos].equals(k)) return Object2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  873: 873 */        pos = pos + 1 & Object2ReferenceLinkedOpenHashMap.this.mask;
/*  874:     */      }
...
/*  882:     */      
/*  883: 883 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ReferenceLinkedOpenHashMap.this.mask;
/*  884:     */      
/*  885: 885 */      while (Object2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  886: 886 */        if (Object2ReferenceLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2ReferenceLinkedOpenHashMap.this.key[pos].equals(k)) {
/*  887: 887 */          Object2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  888: 888 */          return true;
/*  889:     */        }
/*  890: 890 */        pos = pos + 1 & Object2ReferenceLinkedOpenHashMap.this.mask;
/*  891:     */      }
/*  892: 892 */      return false;
/*  893:     */    }
/*  894:     */    
/*  895: 895 */    public int size() { return Object2ReferenceLinkedOpenHashMap.this.size; }
/*  896:     */    
/*  897:     */    public void clear() {
/*  898: 898 */      Object2ReferenceLinkedOpenHashMap.this.clear();
/*  899:     */    }
/*  900:     */    
/*  901: 901 */    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> from) { return new Object2ReferenceLinkedOpenHashMap.EntryIterator(Object2ReferenceLinkedOpenHashMap.this, from.getKey()); }
/*  902:     */    
/*  903:     */    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> fastIterator() {
/*  904: 904 */      return new Object2ReferenceLinkedOpenHashMap.FastEntryIterator(Object2ReferenceLinkedOpenHashMap.this);
/*  905:     */    }
/*  906:     */    
/*  907: 907 */    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> fastIterator(Object2ReferenceMap.Entry<K, V> from) { return new Object2ReferenceLinkedOpenHashMap.FastEntryIterator(Object2ReferenceLinkedOpenHashMap.this, from.getKey()); }
/*  908:     */  }
/*  909:     */  
/*  910:     */  public Object2ReferenceSortedMap.FastSortedEntrySet<K, V> object2ReferenceEntrySet() {
...
/*  918:     */    extends Object2ReferenceLinkedOpenHashMap<K, V>.MapIterator
/*  919:     */    implements ObjectListIterator<K>
/*  920:     */  {
/*  921: 921 */    public KeyIterator() { super(k, null); }
/*  922: 922 */    public K previous() { return Object2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; }
...
/*  926: 926 */    public K next() { return Object2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; } }
/*  927:     */  
/*  928:     */  private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/*  929:     */    
/*  930: 930 */    public ObjectListIterator<K> iterator(K from) { return new Object2ReferenceLinkedOpenHashMap.KeyIterator(Object2ReferenceLinkedOpenHashMap.this, from); }
/*  931:     */    
/*  932:     */    public ObjectListIterator<K> iterator() {
/*  933: 933 */      return new Object2ReferenceLinkedOpenHashMap.KeyIterator(Object2ReferenceLinkedOpenHashMap.this);
/*  934:     */    }
/*  935:     */    
/*  936: 936 */    public int size() { return Object2ReferenceLinkedOpenHashMap.this.size; }
/*  937:     */    
/*  939: 939 */    public boolean contains(Object k) { return Object2ReferenceLinkedOpenHashMap.this.containsKey(k); }
/*  940:     */    
/*  941:     */    public boolean remove(Object k) {
/*  942: 942 */      int oldSize = Object2ReferenceLinkedOpenHashMap.this.size;
/*  943: 943 */      Object2ReferenceLinkedOpenHashMap.this.remove(k);
/*  944: 944 */      return Object2ReferenceLinkedOpenHashMap.this.size != oldSize;
/*  945:     */    }
/*  946:     */    
/*  947: 947 */    public void clear() { Object2ReferenceLinkedOpenHashMap.this.clear(); }
/*  948:     */    
/*  949:     */    public K first() {
/*  950: 950 */      if (Object2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  951: 951 */      return Object2ReferenceLinkedOpenHashMap.this.key[Object2ReferenceLinkedOpenHashMap.this.first];
/*  952:     */    }
/*  953:     */    
/*  954: 954 */    public K last() { if (Object2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  955: 955 */      return Object2ReferenceLinkedOpenHashMap.this.key[Object2ReferenceLinkedOpenHashMap.this.last]; }
/*  956:     */    
...
/*  970:     */    extends Object2ReferenceLinkedOpenHashMap<K, V>.MapIterator
/*  971:     */    implements ObjectListIterator<V>
/*  972:     */  {
/*  973: 973 */    public V previous() { return Object2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; }
...
/*  977: 977 */    public V next() { return Object2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/*  978:     */  }
/*  979:     */  
...
/*  982: 982 */          return new Object2ReferenceLinkedOpenHashMap.ValueIterator(Object2ReferenceLinkedOpenHashMap.this);
/*  983:     */        }
/*  984:     */        
/*  985: 985 */        public int size() { return Object2ReferenceLinkedOpenHashMap.this.size; }
/*  986:     */        
/*  987:     */        public boolean contains(Object v) {
/*  988: 988 */          return Object2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*  989:     */        }
/*  990:     */        
/*  991: 991 */        public void clear() { Object2ReferenceLinkedOpenHashMap.this.clear(); }
/*  992:     */      };
/*  993:     */    }
...
/* 1113:     */  }
/* 1114:     */  
/* 1117:     */  public Object2ReferenceLinkedOpenHashMap<K, V> clone()
/* 1118:     */  {
/* 1119:     */    Object2ReferenceLinkedOpenHashMap<K, V> c;
/* 1120:     */    
/* 1122:     */    try
/* 1123:     */    {
/* 1124:1124 */      c = (Object2ReferenceLinkedOpenHashMap)super.clone();
/* 1125:     */    }
...
/* 1163:1163 */    Object2ReferenceLinkedOpenHashMap<K, V>.MapIterator i = new MapIterator(null);
