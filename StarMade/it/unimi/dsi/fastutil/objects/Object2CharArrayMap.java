  ...
  implements Serializable, Cloneable
{
  ...
  public Object2CharArrayMap(Object2CharMap<K> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Object2CharArrayMap(Map<? extends K, ? extends Character> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Object2CharArrayMap<K> local_c;
    try
    {
      local_c = (Object2CharArrayMap)super.clone();
    }
    ...
    implements Object2CharMap.FastEntrySet<K>
  {
    ...
    public ObjectIterator<Object2CharMap.Entry<K>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Object2CharMap.Entry<K> next()
        {
          ...
          return new AbstractObject2CharMap.BasicEntry(Object2CharArrayMap.this.key[this.next], Object2CharArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Object2CharMap.Entry<K>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Object2CharMap.Entry<K> next()
        {
          ...
          this.entry.key = Object2CharArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Object2CharArrayMap.this.containsKey(local_k)) && (Object2CharArrayMap.this.get(local_k).charValue() == ((Character)local_e.getValue()).charValue());
    }
  }
}
