  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2ByteLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Object2ByteLinkedOpenHashMap(Map<? extends K, ? extends Byte> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ByteLinkedOpenHashMap(Map<? extends K, ? extends Byte> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ByteLinkedOpenHashMap(Object2ByteMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ByteLinkedOpenHashMap(Object2ByteMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ByteLinkedOpenHashMap(K[] local_k, byte[] local_v, float local_f)
  {
  ...
  public Object2ByteLinkedOpenHashMap(K[] local_k, byte[] local_v)
  {
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Object2ByteLinkedOpenHashMap.ValueIterator(Object2ByteLinkedOpenHashMap.this);
        }
        ...
        {
          return Object2ByteLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2ByteLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Object2ByteLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    byte[] value = this.value;
    Object2ByteLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2ByteLinkedOpenHashMap.MapIterator
    ...
    extends AbstractObjectSortedSet<K>
  {
    ...
    {
      return new Object2ByteLinkedOpenHashMap.KeyIterator(Object2ByteLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Object2ByteLinkedOpenHashMap.KeyIterator(Object2ByteLinkedOpenHashMap.this);
    }
    ...
    {
      return Object2ByteLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2ByteLinkedOpenHashMap.this.size;
      Object2ByteLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Object2ByteSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Object2ByteLinkedOpenHashMap.EntryIterator(Object2ByteLinkedOpenHashMap.this);
    }
    ...
    public Object2ByteMap.Entry<K> first()
    {
      ...
      return new Object2ByteLinkedOpenHashMap.MapEntry(Object2ByteLinkedOpenHashMap.this, Object2ByteLinkedOpenHashMap.this.first);
    }
    ...
    public Object2ByteMap.Entry<K> last()
    {
      ...
      return new Object2ByteLinkedOpenHashMap.MapEntry(Object2ByteLinkedOpenHashMap.this, Object2ByteLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ByteLinkedOpenHashMap.this.mask; Object2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ByteLinkedOpenHashMap.this.mask) {
        if (Object2ByteLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2ByteLinkedOpenHashMap.this.key[pos].equals(local_k)) {
          return Object2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ByteLinkedOpenHashMap.this.mask; Object2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ByteLinkedOpenHashMap.this.mask) {
        if (Object2ByteLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2ByteLinkedOpenHashMap.this.key[pos].equals(local_k))
        {
          Object2ByteLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Object2ByteLinkedOpenHashMap.EntryIterator(Object2ByteLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> fastIterator()
    {
      return new Object2ByteLinkedOpenHashMap.FastEntryIterator(Object2ByteLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> fastIterator(Object2ByteMap.Entry<K> from)
    {
      return new Object2ByteLinkedOpenHashMap.FastEntryIterator(Object2ByteLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Object2ByteMap.Entry<K>>
  {
    ...
    public AbstractObject2ByteMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2ByteLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Object2ByteLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Object2ByteMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2ByteLinkedOpenHashMap.MapEntry(Object2ByteLinkedOpenHashMap.this, nextEntry());
    }
    
    public Object2ByteLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Object2ByteLinkedOpenHashMap.MapEntry(Object2ByteLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2ByteLinkedOpenHashMap.this.mask; Object2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ByteLinkedOpenHashMap.this.mask) {
          if (Object2ByteLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2ByteLinkedOpenHashMap.this.key[pos].equals(from))
          {
    ...
    public void remove()
    {
      ...
      Object2ByteLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Object2ByteLinkedOpenHashMap.this.first = this.next;
      } else {
        Object2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Object2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Object2ByteLinkedOpenHashMap.this.last = this.prev;
      } else {
        Object2ByteLinkedOpenHashMap.this.link[this.next] ^= (Object2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2ByteLinkedOpenHashMap.this.mask; Object2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ByteLinkedOpenHashMap.this.mask)
        {
        ...
        if (Object2ByteLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Object2ByteMap.Entry<K>, Map.Entry<K, Byte>
  {
    ...
    public byte setValue(byte local_v)
    {
      ...
      Object2ByteLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Byte> local_e = (Map.Entry)local_o;
      return (Object2ByteLinkedOpenHashMap.this.key[this.index] == null ? local_e.getKey() == null : Object2ByteLinkedOpenHashMap.this.key[this.index].equals(local_e.getKey())) && (Object2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
