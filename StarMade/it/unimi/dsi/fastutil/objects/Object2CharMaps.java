...
public class Object2CharMaps
{
  ...
  public static <K> Object2CharMap<K> synchronize(Object2CharMap<K> local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static <K> Object2CharMap<K> synchronize(Object2CharMap<K> local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static <K> Object2CharMap<K> unmodifiable(Object2CharMap<K> local_m)
  {
    ...
    implements Object2CharMap<K>, Serializable
  {
    ...
    protected UnmodifiableMap(Object2CharMap<K> local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Object2CharMap<K>, Serializable
  {
    ...
    protected SynchronizedMap(Object2CharMap<K> local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Object2CharMap<K> local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Object2CharMap<K>, Serializable, Cloneable
  {
      ...
      implements Object2CharMap.Entry<K>, Map.Entry<K, Character>
    {
      ...
      public K getKey()
      {
        return Object2CharMaps.Singleton.this.key;
      }
      
      public Character getValue()
      {
        return Character.valueOf(Object2CharMaps.Singleton.this.value);
      }
      
      public char getCharValue()
      {
        return Object2CharMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Object2CharMaps.Singleton.this.key == null ? local_e.getKey() == null : Object2CharMaps.Singleton.this.key.equals(local_e.getKey())) && (Object2CharMaps.Singleton.this.value == ((Character)local_e.getValue()).charValue());
      }
      
      public int hashCode()
      {
        return (Object2CharMaps.Singleton.this.key == null ? 0 : Object2CharMaps.Singleton.this.key.hashCode()) ^ Object2CharMaps.Singleton.this.value;
      }
      
      public String toString()
      {
        return Object2CharMaps.Singleton.this.key + "->" + Object2CharMaps.Singleton.this.value;
      }
    }
  }
