...
/*      */   protected int size;
/*      */   protected volatile transient Reference2ShortSortedMap.FastSortedEntrySet<K> entries;
...
/*      */         int tmp54_53 = pos;
/*      */         short[] tmp54_50 = this.value; tmp54_50[tmp54_53] = ((short)(tmp54_50[tmp54_53] + incr));
/*  311 */         return oldValue;
/*      */       }
...
/*  382 */         this.size -= 1;
/*  383 */         fixPointers(pos);
/*  384 */         short v = this.value[pos];
/*  385 */         shiftKeys(pos);
/*  386 */         return Short.valueOf(v);
/*      */       }
...
/*  520 */       if (k == key[pos]) {
/*  521 */         short oldValue = this.value[pos];
...
/*  559 */       if (k == key[pos]) {
/*  560 */         short oldValue = this.value[pos];
...
/*  774 */   public Reference2ShortSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  775 */   public Reference2ShortSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  776 */   public Reference2ShortSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/* 1090 */     if (this.values == null) this.values = new AbstractShortCollection() {
/*      */         public ShortIterator iterator() {
/* 1092 */           return new Reference2ShortLinkedOpenHashMap.ValueIterator(Reference2ShortLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1095 */           return Reference2ShortLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(short v) {
/* 1098 */           return Reference2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1101 */           Reference2ShortLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1234 */       c = (Reference2ShortLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1243 */     c.value = ((short[])this.value.clone());
...
/* 1287 */     short[] value = this.value = new short[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Reference2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public short previousShort()
/*      */     {
/* 1079 */       return Reference2ShortLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1080 */     public Short previous() { return Short.valueOf(Reference2ShortLinkedOpenHashMap.this.value[previousEntry()]); } 
/* 1081 */     public void set(Short ok) { throw new UnsupportedOperationException(); } 
/* 1082 */     public void add(Short ok) { throw new UnsupportedOperationException(); } 
...
/* 1086 */     public short nextShort() { return Reference2ShortLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1087 */     public Short next() { return Short.valueOf(Reference2ShortLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1036 */       return new Reference2ShortLinkedOpenHashMap.KeyIterator(Reference2ShortLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1039 */       return new Reference2ShortLinkedOpenHashMap.KeyIterator(Reference2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1042 */       return Reference2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1045 */       return Reference2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1048 */       int oldSize = Reference2ShortLinkedOpenHashMap.this.size;
/* 1049 */       Reference2ShortLinkedOpenHashMap.this.remove(k);
/* 1050 */       return Reference2ShortLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1053 */       Reference2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1056 */       if (Reference2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057 */       return Reference2ShortLinkedOpenHashMap.this.key[Reference2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1060 */       if (Reference2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061 */       return Reference2ShortLinkedOpenHashMap.this.key[Reference2ShortLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Reference2ShortLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1027 */       super(k, null); } 
/* 1028 */     public K previous() { return Reference2ShortLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1032 */     public K next() { return Reference2ShortLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  955 */       return new Reference2ShortLinkedOpenHashMap.EntryIterator(Reference2ShortLinkedOpenHashMap.this);
/*      */     }
/*  957 */     public Comparator<? super Reference2ShortMap.Entry<K>> comparator() { return null; } 
/*  958 */     public ObjectSortedSet<Reference2ShortMap.Entry<K>> subSet(Reference2ShortMap.Entry<K> fromElement, Reference2ShortMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  959 */     public ObjectSortedSet<Reference2ShortMap.Entry<K>> headSet(Reference2ShortMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  960 */     public ObjectSortedSet<Reference2ShortMap.Entry<K>> tailSet(Reference2ShortMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Reference2ShortMap.Entry<K> first() {
/*  962 */       if (Reference2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963 */       return new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this, Reference2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Reference2ShortMap.Entry<K> last() {
/*  966 */       if (Reference2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967 */       return new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this, Reference2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  975 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  977 */       while (Reference2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  978 */         if (Reference2ShortLinkedOpenHashMap.this.key[pos] == k) return Reference2ShortLinkedOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/*  979 */         pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/*  981 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  989 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  991 */       while (Reference2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  992 */         if (Reference2ShortLinkedOpenHashMap.this.key[pos] == k) {
/*  993 */           Reference2ShortLinkedOpenHashMap.this.remove(e.getKey());
/*  994 */           return true;
/*      */         }
/*  996 */         pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/*  998 */       return false;
/*      */     }
/*      */     public int size() {
/* 1001 */       return Reference2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1004 */       Reference2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ShortMap.Entry<K>> iterator(Reference2ShortMap.Entry<K> from) {
/* 1007 */       return new Reference2ShortLinkedOpenHashMap.EntryIterator(Reference2ShortLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ShortMap.Entry<K>> fastIterator() {
/* 1010 */       return new Reference2ShortLinkedOpenHashMap.FastEntryIterator(Reference2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ShortMap.Entry<K>> fastIterator(Reference2ShortMap.Entry<K> from) {
/* 1013 */       return new Reference2ShortLinkedOpenHashMap.FastEntryIterator(Reference2ShortLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Reference2ShortLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Reference2ShortMap.Entry<K>>
/*      */   {
/*  933 */     final AbstractReference2ShortMap.BasicEntry<K> entry = new AbstractReference2ShortMap.BasicEntry(null, (short)0);
/*      */ 
...
/*  939 */       int e = nextEntry();
/*  940 */       this.entry.key = Reference2ShortLinkedOpenHashMap.this.key[e];
/*  941 */       this.entry.value = Reference2ShortLinkedOpenHashMap.this.value[e];
/*  942 */       return this.entry;
/*      */     }
/*      */     public AbstractReference2ShortMap.BasicEntry<K> previous() {
/*  945 */       int e = previousEntry();
/*  946 */       this.entry.key = Reference2ShortLinkedOpenHashMap.this.key[e];
/*  947 */       this.entry.value = Reference2ShortLinkedOpenHashMap.this.value[e];
/*  948 */       return this.entry;
/*      */     }
/*  950 */     public void set(Reference2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  951 */     public void add(Reference2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Reference2ShortLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Reference2ShortMap.Entry<K>>
/*      */   {
...
/*  919 */       return this.entry = new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Reference2ShortLinkedOpenHashMap<K>.MapEntry previous() {
/*  922 */       return this.entry = new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  926 */       super.remove();
/*  927 */       Reference2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  929 */     public void set(Reference2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  930 */     public void add(Reference2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  791 */     int index = -1;
/*      */ 
/*  793 */     private MapIterator() { this.next = Reference2ShortLinkedOpenHashMap.this.first;
/*  794 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  797 */       if (Reference2ShortLinkedOpenHashMap.this.key[Reference2ShortLinkedOpenHashMap.this.last] == from) {
/*  798 */         this.prev = Reference2ShortLinkedOpenHashMap.this.last;
/*  799 */         this.index = Reference2ShortLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  803 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  805 */         while (Reference2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  806 */           if (Reference2ShortLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  808 */             this.next = ((int)Reference2ShortLinkedOpenHashMap.this.link[pos]);
/*  809 */             this.prev = pos;
/*  810 */             return;
/*      */           }
/*  812 */           pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  825 */       if (this.next == -1) {
/*  826 */         this.index = Reference2ShortLinkedOpenHashMap.this.size;
/*  827 */         return;
/*      */       }
/*  829 */       int pos = Reference2ShortLinkedOpenHashMap.this.first;
/*  830 */       this.index = 1;
/*  831 */       while (pos != this.prev) {
/*  832 */         pos = (int)Reference2ShortLinkedOpenHashMap.this.link[pos];
/*  833 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  845 */       if (!hasNext()) return Reference2ShortLinkedOpenHashMap.this.size();
/*  846 */       this.curr = this.next;
/*  847 */       this.next = ((int)Reference2ShortLinkedOpenHashMap.this.link[this.curr]);
...
/*  855 */       this.prev = ((int)(Reference2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  867 */         this.index -= 1;
/*  868 */         this.prev = ((int)(Reference2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  871 */         this.next = ((int)Reference2ShortLinkedOpenHashMap.this.link[this.curr]);
/*  872 */       }Reference2ShortLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  875 */       if (this.prev == -1) Reference2ShortLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  877 */         Reference2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Reference2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878 */       if (this.next == -1) Reference2ShortLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  880 */         Reference2ShortLinkedOpenHashMap.this.link[this.next] ^= (Reference2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  884 */         pos = (last = pos) + 1 & Reference2ShortLinkedOpenHashMap.this.mask;
/*  885 */         while (Reference2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */           int slot = (Reference2ShortLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ShortLinkedOpenHashMap.this.key[pos]))) & Reference2ShortLinkedOpenHashMap.this.mask;
/*  887 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888 */           pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask;
/*      */         }
/*  890 */         if (Reference2ShortLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891 */         Reference2ShortLinkedOpenHashMap.this.key[last] = Reference2ShortLinkedOpenHashMap.this.key[pos];
/*  892 */         Reference2ShortLinkedOpenHashMap.this.value[last] = Reference2ShortLinkedOpenHashMap.this.value[pos];
/*  893 */         if (this.next == pos) this.next = last;
/*  894 */         if (this.prev == pos) this.prev = last;
/*  895 */         Reference2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  897 */       Reference2ShortLinkedOpenHashMap.this.used[last] = false;
/*  898 */       Reference2ShortLinkedOpenHashMap.this.key[last] = null;
/*  899 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  660 */       return Reference2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Short getValue() {
/*  663 */       return Short.valueOf(Reference2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public short getShortValue() {
/*  666 */       return Reference2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public short setValue(short v) {
/*  669 */       short oldValue = Reference2ShortLinkedOpenHashMap.this.value[this.index];
/*  670 */       Reference2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  671 */       return oldValue;
/*      */     }
/*      */     public Short setValue(Short v) {
/*  674 */       return Short.valueOf(setValue(v.shortValue()));
/*      */     }
/*      */ 
/*      */     public boolean equals(Object o) {
/*  678 */       if (!(o instanceof Map.Entry)) return false;
/*  679 */       Map.Entry e = (Map.Entry)o;
/*  680 */       return (Reference2ShortLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     public int hashCode() {
/*  683 */       return (Reference2ShortLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ShortLinkedOpenHashMap.this.key[this.index])) ^ Reference2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  686 */       return Reference2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
