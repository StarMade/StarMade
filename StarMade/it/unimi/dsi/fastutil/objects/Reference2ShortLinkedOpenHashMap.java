  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2ShortLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2ShortLinkedOpenHashMap(Reference2ShortMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2ShortLinkedOpenHashMap(Reference2ShortMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2ShortLinkedOpenHashMap(K[] local_k, short[] local_v, float local_f)
  {
  ...
  public Reference2ShortLinkedOpenHashMap(K[] local_k, short[] local_v)
  {
  ...
  public short add(K local_k, short incr)
  {
    for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k)
      {
        short oldValue = this.value[pos];
        int tmp54_53 = pos;
        short[] tmp54_50 = this.value;
        tmp54_50[tmp54_53] = ((short)(tmp54_50[tmp54_53] + incr));
        return oldValue;
      }
    }
    this.used[pos] = true;
  ...
  public Reference2ShortSortedMap<K> headMap(K local_to)
  {
    throw new UnsupportedOperationException();
  }
  
  public Reference2ShortSortedMap<K> subMap(K from, K local_to)
  {
    throw new UnsupportedOperationException();
  }
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Reference2ShortLinkedOpenHashMap.ValueIterator(Reference2ShortLinkedOpenHashMap.this);
        }
        ...
        {
          return Reference2ShortLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2ShortLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Reference2ShortLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    short[] value = this.value;
    Reference2ShortLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Reference2ShortLinkedOpenHashMap.MapIterator
    implements ShortListIterator
  {
    ...
    {
      return Short.valueOf(Reference2ShortLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Short next()
    {
      return Short.valueOf(Reference2ShortLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractReferenceSortedSet<K>
  {
    ...
    {
      return new Reference2ShortLinkedOpenHashMap.KeyIterator(Reference2ShortLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Reference2ShortLinkedOpenHashMap.KeyIterator(Reference2ShortLinkedOpenHashMap.this);
    }
    ...
    {
      return Reference2ShortLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2ShortLinkedOpenHashMap.this.size;
      Reference2ShortLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Reference2ShortSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Reference2ShortLinkedOpenHashMap.EntryIterator(Reference2ShortLinkedOpenHashMap.this);
    }
    ...
    public Reference2ShortMap.Entry<K> first()
    {
      ...
      return new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this, Reference2ShortLinkedOpenHashMap.this.first);
    }
    ...
    public Reference2ShortMap.Entry<K> last()
    {
      ...
      return new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this, Reference2ShortLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2ShortLinkedOpenHashMap.this.mask; Reference2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask) {
        if (Reference2ShortLinkedOpenHashMap.this.key[pos] == local_k) {
          return Reference2ShortLinkedOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2ShortLinkedOpenHashMap.this.mask; Reference2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask) {
        if (Reference2ShortLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Reference2ShortLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Reference2ShortLinkedOpenHashMap.EntryIterator(Reference2ShortLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Reference2ShortMap.Entry<K>> fastIterator()
    {
      return new Reference2ShortLinkedOpenHashMap.FastEntryIterator(Reference2ShortLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Reference2ShortMap.Entry<K>> fastIterator(Reference2ShortMap.Entry<K> from)
    {
      return new Reference2ShortLinkedOpenHashMap.FastEntryIterator(Reference2ShortLinkedOpenHashMap.this, from.getKey());
    }
  }
  ...
  {
    final AbstractReference2ShortMap.BasicEntry<K> entry = new AbstractReference2ShortMap.BasicEntry(null, (short)0);
    ...
    public AbstractReference2ShortMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Reference2ShortLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Reference2ShortLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    public void set(Reference2ShortMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
    
    public void add(Reference2ShortMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
  }
    ...
    implements ObjectListIterator<Reference2ShortMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this, nextEntry());
    }
    
    public Reference2ShortLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Reference2ShortLinkedOpenHashMap.MapEntry(Reference2ShortLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2ShortLinkedOpenHashMap.this.mask; Reference2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Reference2ShortLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Reference2ShortLinkedOpenHashMap.this.first = this.next;
      } else {
        Reference2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Reference2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Reference2ShortLinkedOpenHashMap.this.last = this.prev;
      } else {
        Reference2ShortLinkedOpenHashMap.this.link[this.next] ^= (Reference2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2ShortLinkedOpenHashMap.this.mask; Reference2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ShortLinkedOpenHashMap.this.mask)
        {
          int slot = (Reference2ShortLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ShortLinkedOpenHashMap.this.key[pos]))) & Reference2ShortLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Reference2ShortLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Reference2ShortLinkedOpenHashMap.this.key[last] = Reference2ShortLinkedOpenHashMap.this.key[pos];
      ...
      Reference2ShortLinkedOpenHashMap.this.used[last] = false;
      Reference2ShortLinkedOpenHashMap.this.key[last] = null;
      this.curr = -1;
    }
    ...
    implements Reference2ShortMap.Entry<K>, Map.Entry<K, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Reference2ShortLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Short> local_e = (Map.Entry)local_o;
      return (Reference2ShortLinkedOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
    
    public int hashCode()
    {
      return (Reference2ShortLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ShortLinkedOpenHashMap.this.key[this.index])) ^ Reference2ShortLinkedOpenHashMap.this.value[this.index];
    }
