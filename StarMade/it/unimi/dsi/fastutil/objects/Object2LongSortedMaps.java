...
/* 246 */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.object2LongEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
/* 248 */       return object2LongEntrySet(); } 
...
/* 250 */     public Object2LongSortedMap<K> subMap(K from, K to) { return new UnmodifiableSortedMap(this.sortedMap.subMap(from, to)); } 
/* 251 */     public Object2LongSortedMap<K> headMap(K to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 252 */     public Object2LongSortedMap<K> tailMap(K from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 212 */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.object2LongEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
/* 214 */       return object2LongEntrySet(); } 
...
/* 216 */     public Object2LongSortedMap<K> subMap(K from, K to) { return new SynchronizedSortedMap(this.sortedMap.subMap(from, to), this.sync); } 
/* 217 */     public Object2LongSortedMap<K> headMap(K to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 218 */     public Object2LongSortedMap<K> tailMap(K from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Object2LongMaps.Singleton.SingletonEntry(this), Object2LongSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() { return object2LongEntrySet(); } 
...
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Object2LongSortedMap<K> headMap(K to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Object2LongSortedMap<K> tailMap(K from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
...
/*  77 */       return null;
/*     */     }
/*  79 */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<K, Long>> entrySet() {
/*  81 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  83 */     public ObjectSortedSet<K> keySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public Object2LongSortedMap<K> subMap(K from, K to) {
/*  85 */       return Object2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*  87 */     public Object2LongSortedMap<K> headMap(K to) { return Object2LongSortedMaps.EMPTY_MAP; } 
/*     */     public Object2LongSortedMap<K> tailMap(K from) {
/*  89 */       return Object2LongSortedMaps.EMPTY_MAP; } 
