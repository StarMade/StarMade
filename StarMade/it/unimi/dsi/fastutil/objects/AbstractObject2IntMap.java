  ...
  implements Object2IntMap<K>, Serializable
{
  ...
  public void putAll(Map<? extends K, ? extends Integer> local_m)
  {
    ...
    if ((local_m instanceof Object2IntMap)) {
      while (local_n-- != 0)
      {
        Object2IntMap.Entry<? extends K> local_e = (Object2IntMap.Entry)local_i.next();
  ...
  public ObjectSet<K> keySet()
  {
    new AbstractObjectSet()
    {
      ...
      {
        return AbstractObject2IntMap.this.containsKey(local_k);
      }
      ...
      public ObjectIterator<K> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Integer>> field_3 = AbstractObject2IntMap.this.entrySet().iterator();
          
          public K next()
          {
            return ((Object2IntMap.Entry)this.field_3.next()).getKey();
          }
  ...
  public IntCollection values()
  {
    new AbstractIntCollection()
    {
      ...
      {
        return AbstractObject2IntMap.this.containsValue(local_k);
      }
      ...
      public IntIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Integer>> field_70 = AbstractObject2IntMap.this.entrySet().iterator();
          
          public int nextInt()
          {
            return ((Object2IntMap.Entry)this.field_70.next()).getIntValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Object2IntMap.Entry<K> local_e = (Object2IntMap.Entry)local_i.next();
