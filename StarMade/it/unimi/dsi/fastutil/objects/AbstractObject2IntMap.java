...
/*  88 */     if ((m instanceof Object2IntMap))
/*     */     {
/*  90 */       while (n-- != 0) {
/*  91 */         Object2IntMap.Entry e = (Object2IntMap.Entry)i.next();
...
/* 193 */         return AbstractObject2IntMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractObject2IntMap.this.size(); } 
/* 196 */       public void clear() { AbstractObject2IntMap.this.clear(); }
/*     */ 
/*     */       public ObjectIterator<K> iterator() {
/* 199 */         return new AbstractObjectIterator() {
/* 200 */           final ObjectIterator<Map.Entry<K, Integer>> i = AbstractObject2IntMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public K next() { return ((Object2IntMap.Entry)this.i.next()).getKey(); } 
...
/* 226 */         return AbstractObject2IntMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractObject2IntMap.this.size(); } 
/* 229 */       public void clear() { AbstractObject2IntMap.this.clear(); }
/*     */ 
/*     */       public IntIterator iterator() {
/* 232 */         return new AbstractIntIterator() {
/* 233 */           final ObjectIterator<Map.Entry<K, Integer>> i = AbstractObject2IntMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public int nextInt() { return ((Object2IntMap.Entry)this.i.next()).getIntValue(); } 
/*     */           public boolean hasNext() {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Object2IntMap.Entry e = (Object2IntMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
