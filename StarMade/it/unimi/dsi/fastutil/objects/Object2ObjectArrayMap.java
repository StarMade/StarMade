  ...
  implements Serializable, Cloneable
{
  ...
  public Object2ObjectArrayMap(Object2ObjectMap<K, V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Object2ObjectArrayMap(Map<? extends K, ? extends V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Object2ObjectArrayMap<K, V> local_c;
    try
    {
      local_c = (Object2ObjectArrayMap)super.clone();
    }
    ...
    implements Object2ObjectMap.FastEntrySet<K, V>
  {
    ...
    public ObjectIterator<Object2ObjectMap.Entry<K, V>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Object2ObjectMap.Entry<K, V> next()
        {
          ...
          return new AbstractObject2ObjectMap.BasicEntry(Object2ObjectArrayMap.this.key[this.next], Object2ObjectArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Object2ObjectMap.Entry<K, V>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Object2ObjectMap.Entry<K, V> next()
        {
          ...
          this.entry.key = Object2ObjectArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Object2ObjectArrayMap.this.containsKey(local_k)) && (Object2ObjectArrayMap.this.get(local_k) == null ? local_e.getValue() == null : Object2ObjectArrayMap.this.get(local_k).equals(local_e.getValue()));
    }
  }
}
