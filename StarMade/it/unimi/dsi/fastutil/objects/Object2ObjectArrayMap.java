...
/*     */     try
/*     */     {
/* 300 */       c = (Object2ObjectArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<K, V>>
...
/* 129 */         int next = 0;
/*     */ 
/* 131 */         public boolean hasNext() { return this.next < Object2ObjectArrayMap.this.size; }
/*     */ 
/*     */         public Object2ObjectMap.Entry<K, V> next()
/*     */         {
/* 135 */           if (!hasNext()) throw new NoSuchElementException();
/* 136 */           return new AbstractObject2ObjectMap.BasicEntry(Object2ObjectArrayMap.this.key[this.next], Object2ObjectArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 142 */         int next = 0;
/* 143 */         final AbstractObject2ObjectMap.BasicEntry<K, V> entry = new AbstractObject2ObjectMap.BasicEntry(null, null);
/*     */ 
/* 145 */         public boolean hasNext() { return this.next < Object2ObjectArrayMap.this.size; }
/*     */ 
/*     */         public Object2ObjectMap.Entry<K, V> next()
/*     */         {
/* 149 */           if (!hasNext()) throw new NoSuchElementException();
/* 150 */           this.entry.key = Object2ObjectArrayMap.this.key[this.next];
/* 151 */           this.entry.value = Object2ObjectArrayMap.this.value[(this.next++)];
/* 152 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 157 */       return Object2ObjectArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 164 */       return (Object2ObjectArrayMap.this.containsKey(k)) && (Object2ObjectArrayMap.this.get(k) == null ? e.getValue() == null : Object2ObjectArrayMap.this.get(k).equals(e.getValue()));
/*     */     }
/*     */   }
/*     */ }
