...
/*  14:    */
/*  87:    */public class Reference2ReferenceOpenCustomHashMap<K, V>
/*  88:    */  extends AbstractReference2ReferenceMap<K, V>
...
/* 101:    */  protected volatile transient Reference2ReferenceMap.FastEntrySet<K, V> entries;
/* 102:    */  protected volatile transient ReferenceSet<K> keys;
/* 103:    */  protected volatile transient ReferenceCollection<V> values;
/* 104:    */  protected Hash.Strategy<K> strategy;
/* 105:    */  
/* 106:    */  public Reference2ReferenceOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy)
/* 107:    */  {
...
/* 118:    */  }
/* 119:    */  
/* 123:    */  public Reference2ReferenceOpenCustomHashMap(int expected, Hash.Strategy<K> strategy)
/* 124:    */  {
/* 125:125 */    this(expected, 0.75F, strategy);
/* 126:    */  }
/* 127:    */  
/* 130:    */  public Reference2ReferenceOpenCustomHashMap(Hash.Strategy<K> strategy)
/* 131:    */  {
/* 132:132 */    this(16, 0.75F, strategy);
/* 133:    */  }
/* 134:    */  
/* 139:    */  public Reference2ReferenceOpenCustomHashMap(Map<? extends K, ? extends V> m, float f, Hash.Strategy<K> strategy)
/* 140:    */  {
/* 141:141 */    this(m.size(), f, strategy);
/* 142:142 */    putAll(m);
/* 143:    */  }
/* 144:    */  
/* 148:    */  public Reference2ReferenceOpenCustomHashMap(Map<? extends K, ? extends V> m, Hash.Strategy<K> strategy)
/* 149:    */  {
/* 150:150 */    this(m, 0.75F, strategy);
/* 151:    */  }
/* 152:    */  
/* 157:    */  public Reference2ReferenceOpenCustomHashMap(Reference2ReferenceMap<K, V> m, float f, Hash.Strategy<K> strategy)
/* 158:    */  {
/* 159:159 */    this(m.size(), f, strategy);
/* 160:160 */    putAll(m);
/* 161:    */  }
/* 162:    */  
/* 166:    */  public Reference2ReferenceOpenCustomHashMap(Reference2ReferenceMap<K, V> m, Hash.Strategy<K> strategy)
/* 167:    */  {
/* 168:168 */    this(m, 0.75F, strategy);
/* 169:    */  }
/* 170:    */  
/* 177:    */  public Reference2ReferenceOpenCustomHashMap(K[] k, V[] v, float f, Hash.Strategy<K> strategy)
/* 178:    */  {
...
/* 183:    */  }
/* 184:    */  
/* 189:    */  public Reference2ReferenceOpenCustomHashMap(K[] k, V[] v, Hash.Strategy<K> strategy)
/* 190:    */  {
...
/* 289:289 */    for (int i = this.n; i-- != 0; return true) label16: if ((used[i] == 0) || (value[i] != v)) break label16;
...
/* 331:    */    implements Reference2ReferenceMap.Entry<K, V>, Map.Entry<K, V>
/* 332:    */  {
...
/* 338:    */    }
/* 339:    */    
/* 340:340 */    public K getKey() { return Reference2ReferenceOpenCustomHashMap.this.key[this.index]; }
/* 341:    */    
/* 343:343 */    public V getValue() { return Reference2ReferenceOpenCustomHashMap.this.value[this.index]; }
/* 344:    */    
/* 345:    */    public V setValue(V v) {
/* 346:346 */      V oldValue = Reference2ReferenceOpenCustomHashMap.this.value[this.index];
/* 347:347 */      Reference2ReferenceOpenCustomHashMap.this.value[this.index] = v;
...
/* 354:354 */      return (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(Reference2ReferenceOpenCustomHashMap.this.key[this.index], e.getKey())) && (Reference2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/* 355:    */    }
/* 356:    */    
/* 357:357 */    public int hashCode() { return (Reference2ReferenceOpenCustomHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ReferenceOpenCustomHashMap.this.key[this.index])) ^ (Reference2ReferenceOpenCustomHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Reference2ReferenceOpenCustomHashMap.this.value[this.index])); }
/* 358:    */    
/* 360:360 */    public String toString() { return Reference2ReferenceOpenCustomHashMap.this.key[this.index] + "=>" + Reference2ReferenceOpenCustomHashMap.this.value[this.index]; } }
/* 361:    */  
...
/* 366:    */    
/* 367:367 */    private MapIterator() { this.pos = Reference2ReferenceOpenCustomHashMap.this.n;
/* 368:    */      
/* 370:370 */      this.last = -1;
/* 371:    */      
/* 372:372 */      this.c = Reference2ReferenceOpenCustomHashMap.this.size;
/* 373:    */      
/* 377:377 */      boolean[] used = Reference2ReferenceOpenCustomHashMap.this.used;
...
/* 389:    */        
/* 390:390 */        int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceOpenCustomHashMap.this.mask;
/* 391:    */        
/* 392:392 */        while (Reference2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 393:393 */          if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(Reference2ReferenceOpenCustomHashMap.this.key[pos], k)) return pos;
/* 394:394 */          pos = pos + 1 & Reference2ReferenceOpenCustomHashMap.this.mask;
/* 395:    */        }
/* 396:    */      }
/* 397:397 */      this.last = this.pos;
/* 398:    */      
/* 399:399 */      if (this.c != 0) {
/* 400:400 */        boolean[] used = Reference2ReferenceOpenCustomHashMap.this.used;
...
/* 415:    */      for (;;)
/* 416:    */      {
/* 417:417 */        pos = (last = pos) + 1 & Reference2ReferenceOpenCustomHashMap.this.mask;
/* 418:418 */        while (Reference2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 419:419 */          int slot = (Reference2ReferenceOpenCustomHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ReferenceOpenCustomHashMap.this.key[pos]))) & Reference2ReferenceOpenCustomHashMap.this.mask;
/* 420:420 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 421:421 */          pos = pos + 1 & Reference2ReferenceOpenCustomHashMap.this.mask;
/* 422:    */        }
/* 423:423 */        if (Reference2ReferenceOpenCustomHashMap.this.used[pos] == 0) break;
/* 424:424 */        if (pos < last)
/* 425:    */        {
/* 426:426 */          if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 427:427 */          this.wrapped.add(Reference2ReferenceOpenCustomHashMap.this.key[pos]);
/* 428:    */        }
/* 429:429 */        Reference2ReferenceOpenCustomHashMap.this.key[last] = Reference2ReferenceOpenCustomHashMap.this.key[pos];
/* 430:430 */        Reference2ReferenceOpenCustomHashMap.this.value[last] = Reference2ReferenceOpenCustomHashMap.this.value[pos];
/* 431:    */      }
/* 432:432 */      Reference2ReferenceOpenCustomHashMap.this.used[last] = false;
/* 433:433 */      Reference2ReferenceOpenCustomHashMap.this.key[last] = null;
/* 434:434 */      Reference2ReferenceOpenCustomHashMap.this.value[last] = null;
/* 435:435 */      return last;
/* 436:    */    }
/* 437:    */    
...
/* 441:    */      {
/* 442:442 */        Reference2ReferenceOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 443:443 */        this.last = -1;
/* 444:444 */        return;
/* 445:    */      }
/* 446:446 */      Reference2ReferenceOpenCustomHashMap.this.size -= 1;
...
/* 458:    */    } }
/* 459:    */  
/* 460:460 */  private class EntryIterator extends Reference2ReferenceOpenCustomHashMap<K, V>.MapIterator implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> { private EntryIterator() { super(null); }
/* 461:    */    
/* 462:    */    private Reference2ReferenceOpenCustomHashMap<K, V>.MapEntry entry;
/* 463:463 */    public Reference2ReferenceMap.Entry<K, V> next() { return this.entry = new Reference2ReferenceOpenCustomHashMap.MapEntry(Reference2ReferenceOpenCustomHashMap.this, nextEntry()); }
/* 464:    */    
/* 465:    */    public void remove()
/* 466:    */    {
/* 467:467 */      super.remove();
/* 468:468 */      Reference2ReferenceOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 469:    */    } }
/* 470:    */  
/* 471:471 */  private class FastEntryIterator extends Reference2ReferenceOpenCustomHashMap<K, V>.MapIterator implements ObjectIterator<Reference2ReferenceMap.Entry<K, V>> { private FastEntryIterator() { super(null); }
/* 472:472 */    final AbstractReference2ReferenceMap.BasicEntry<K, V> entry = new AbstractReference2ReferenceMap.BasicEntry(null, null);
/* 473:    */    
/* 474:474 */    public AbstractReference2ReferenceMap.BasicEntry<K, V> next() { int e = nextEntry();
/* 475:475 */      this.entry.key = Reference2ReferenceOpenCustomHashMap.this.key[e];
/* 476:476 */      this.entry.value = Reference2ReferenceOpenCustomHashMap.this.value[e];
/* 477:477 */      return this.entry;
/* 478:    */    } }
/* 479:    */  
/* 480:    */  private final class MapEntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceMap.FastEntrySet<K, V> { private MapEntrySet() {}
/* 481:    */    
/* 482:482 */    public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> iterator() { return new Reference2ReferenceOpenCustomHashMap.EntryIterator(Reference2ReferenceOpenCustomHashMap.this, null); }
/* 483:    */    
/* 484:    */    public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator() {
/* 485:485 */      return new Reference2ReferenceOpenCustomHashMap.FastEntryIterator(Reference2ReferenceOpenCustomHashMap.this, null);
/* 486:    */    }
/* 487:    */    
...
/* 492:    */      
/* 493:493 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceOpenCustomHashMap.this.mask;
/* 494:    */      
/* 495:495 */      while (Reference2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 496:496 */        if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(Reference2ReferenceOpenCustomHashMap.this.key[pos], k)) return Reference2ReferenceOpenCustomHashMap.this.value[pos] == e.getValue();
/* 497:497 */        pos = pos + 1 & Reference2ReferenceOpenCustomHashMap.this.mask;
/* 498:    */      }
...
/* 506:    */      
/* 507:507 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceOpenCustomHashMap.this.mask;
/* 508:    */      
/* 509:509 */      while (Reference2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 510:510 */        if (Reference2ReferenceOpenCustomHashMap.this.strategy.equals(Reference2ReferenceOpenCustomHashMap.this.key[pos], k)) {
/* 511:511 */          Reference2ReferenceOpenCustomHashMap.this.remove(e.getKey());
/* 512:512 */          return true;
/* 513:    */        }
/* 514:514 */        pos = pos + 1 & Reference2ReferenceOpenCustomHashMap.this.mask;
/* 515:    */      }
/* 516:516 */      return false;
/* 517:    */    }
/* 518:    */    
/* 519:519 */    public int size() { return Reference2ReferenceOpenCustomHashMap.this.size; }
/* 520:    */    
/* 522:522 */    public void clear() { Reference2ReferenceOpenCustomHashMap.this.clear(); }
/* 523:    */  }
/* 524:    */  
/* 525:    */  public Reference2ReferenceMap.FastEntrySet<K, V> reference2ReferenceEntrySet() {
...
/* 533:    */    extends Reference2ReferenceOpenCustomHashMap<K, V>.MapIterator
/* 534:    */    implements ObjectIterator<K>
/* 535:    */  {
/* 536:536 */    public KeyIterator() { super(null); }
/* 537:537 */    public K next() { return Reference2ReferenceOpenCustomHashMap.this.key[nextEntry()]; } }
/* 538:    */  
/* 539:    */  private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/* 540:    */    
/* 541:541 */    public ObjectIterator<K> iterator() { return new Reference2ReferenceOpenCustomHashMap.KeyIterator(Reference2ReferenceOpenCustomHashMap.this); }
/* 542:    */    
/* 543:    */    public int size() {
/* 544:544 */      return Reference2ReferenceOpenCustomHashMap.this.size;
/* 545:    */    }
/* 546:    */    
/* 547:547 */    public boolean contains(Object k) { return Reference2ReferenceOpenCustomHashMap.this.containsKey(k); }
/* 548:    */    
/* 549:    */    public boolean remove(Object k) {
/* 550:550 */      int oldSize = Reference2ReferenceOpenCustomHashMap.this.size;
/* 551:551 */      Reference2ReferenceOpenCustomHashMap.this.remove(k);
/* 552:552 */      return Reference2ReferenceOpenCustomHashMap.this.size != oldSize;
/* 553:    */    }
/* 554:    */    
/* 555:555 */    public void clear() { Reference2ReferenceOpenCustomHashMap.this.clear(); }
/* 556:    */  }
/* 557:    */  
...
/* 566:    */    extends Reference2ReferenceOpenCustomHashMap<K, V>.MapIterator
/* 567:    */    implements ObjectIterator<V>
/* 568:    */  {
/* 569:569 */    public ValueIterator() { super(null); }
/* 570:570 */    public V next() { return Reference2ReferenceOpenCustomHashMap.this.value[nextEntry()]; }
/* 571:    */  }
/* 572:    */  
/* 573:573 */  public ReferenceCollection<V> values() { if (this.values == null) { this.values = new AbstractReferenceCollection() {
/* 574:    */        public ObjectIterator<V> iterator() {
/* 575:575 */          return new Reference2ReferenceOpenCustomHashMap.ValueIterator(Reference2ReferenceOpenCustomHashMap.this);
/* 576:    */        }
/* 577:    */        
/* 578:578 */        public int size() { return Reference2ReferenceOpenCustomHashMap.this.size; }
/* 579:    */        
/* 580:    */        public boolean contains(Object v) {
/* 581:581 */          return Reference2ReferenceOpenCustomHashMap.this.containsValue(v);
/* 582:    */        }
/* 583:    */        
/* 584:584 */        public void clear() { Reference2ReferenceOpenCustomHashMap.this.clear(); }
/* 585:    */      };
/* 586:    */    }
...
/* 687:    */  }
/* 688:    */  
/* 692:    */  public Reference2ReferenceOpenCustomHashMap<K, V> clone()
/* 693:    */  {
/* 694:    */    Reference2ReferenceOpenCustomHashMap<K, V> c;
/* 695:    */    
/* 697:    */    try
/* 698:    */    {
/* 699:699 */      c = (Reference2ReferenceOpenCustomHashMap)super.clone();
/* 700:    */    }
...
/* 729:729 */        t ^= (this.value[i] == null ? 0 : System.identityHashCode(this.value[i]));
/* 730:730 */      h += t;
/* 731:731 */      i++;
/* 732:    */    }
/* 733:733 */    return h;
...
/* 738:738 */    Reference2ReferenceOpenCustomHashMap<K, V>.MapIterator i = new MapIterator(null);
