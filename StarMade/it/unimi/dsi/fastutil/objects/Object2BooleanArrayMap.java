...
/*  85 */     this.value = BooleanArrays.EMPTY_ARRAY;
/*     */   }
/*     */ 
/*     */   public Object2BooleanArrayMap(int capacity)
/*     */   {
/*  92 */     this.key = new Object[capacity];
/*  93 */     this.value = new boolean[capacity];
/*     */   }
/*     */ 
...
/* 260 */     boolean oldValue = this.value[oldPos];
...
/*     */   {
/* 285 */     return BooleanCollections.unmodifiable(new BooleanArraySet(this.value, this.size));
/*     */   }
/*     */ 
...
/*     */     try
/*     */     {
/* 300 */       c = (Object2BooleanArrayMap)super.clone();
/*     */     }
/*     */     catch (CloneNotSupportedException cantHappen) {
/* 303 */       throw new InternalError();
/*     */     }
/* 305 */     c.key = ((Object[])this.key.clone());
/* 306 */     c.value = ((boolean[])this.value.clone());
/* 307 */     return c;
/*     */   }
/*     */ 
...
/* 314 */       s.writeBoolean(this.value[i]);
/*     */     }
/*     */   }
/*     */ 
...
/* 322 */     this.value = new boolean[this.size];
/* 323 */     for (int i = 0; i < this.size; i++) {
/* 324 */       this.key[i] = s.readObject();
/* 325 */       this.value[i] = s.readBoolean();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Object2BooleanMap.Entry<K>>
...
/* 130 */         int next = 0;
/*     */ 
/* 132 */         public boolean hasNext() { return this.next < Object2BooleanArrayMap.this.size; }
/*     */ 
/*     */         public Object2BooleanMap.Entry<K> next()
/*     */         {
/* 136 */           if (!hasNext()) throw new NoSuchElementException();
/* 137 */           return new AbstractObject2BooleanMap.BasicEntry(Object2BooleanArrayMap.this.key[this.next], Object2BooleanArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 143 */         int next = 0;
/* 144 */         final AbstractObject2BooleanMap.BasicEntry<K> entry = new AbstractObject2BooleanMap.BasicEntry(null, false);
/*     */ 
/* 146 */         public boolean hasNext() { return this.next < Object2BooleanArrayMap.this.size; }
/*     */ 
/*     */         public Object2BooleanMap.Entry<K> next()
/*     */         {
/* 150 */           if (!hasNext()) throw new NoSuchElementException();
/* 151 */           this.entry.key = Object2BooleanArrayMap.this.key[this.next];
/* 152 */           this.entry.value = Object2BooleanArrayMap.this.value[(this.next++)];
/* 153 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 158 */       return Object2BooleanArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 165 */       return (Object2BooleanArrayMap.this.containsKey(k)) && (Object2BooleanArrayMap.this.get(k).booleanValue() == ((Boolean)e.getValue()).booleanValue());
/*     */     }
/*     */   }
/*     */ }
