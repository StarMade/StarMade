...
/*  88 */     if ((m instanceof Object2ByteMap))
/*     */     {
/*  90 */       while (n-- != 0) {
/*  91 */         Object2ByteMap.Entry e = (Object2ByteMap.Entry)i.next();
...
/* 193 */         return AbstractObject2ByteMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractObject2ByteMap.this.size(); } 
/* 196 */       public void clear() { AbstractObject2ByteMap.this.clear(); }
/*     */ 
/*     */       public ObjectIterator<K> iterator() {
/* 199 */         return new AbstractObjectIterator() {
/* 200 */           final ObjectIterator<Map.Entry<K, Byte>> i = AbstractObject2ByteMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public K next() { return ((Object2ByteMap.Entry)this.i.next()).getKey(); } 
...
/* 226 */         return AbstractObject2ByteMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractObject2ByteMap.this.size(); } 
/* 229 */       public void clear() { AbstractObject2ByteMap.this.clear(); }
/*     */ 
/*     */       public ByteIterator iterator() {
/* 232 */         return new AbstractByteIterator() {
/* 233 */           final ObjectIterator<Map.Entry<K, Byte>> i = AbstractObject2ByteMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public byte nextByte() { return ((Object2ByteMap.Entry)this.i.next()).getByteValue(); } 
/*     */           public boolean hasNext() {
...
/*     */   {
/* 246 */     return object2ByteEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Object2ByteMap.Entry e = (Object2ByteMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
