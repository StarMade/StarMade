...
/*   18:     */
/*  113:     */public class Reference2CharLinkedOpenHashMap<K>
/*  114:     */  extends AbstractReference2CharSortedMap<K>
...
/*  127:     */  protected volatile transient Reference2CharSortedMap.FastSortedEntrySet<K> entries;
...
/*  141:     */  
/*  149:     */  public Reference2CharLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Reference2CharLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Reference2CharLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Reference2CharLinkedOpenHashMap(Map<? extends K, ? extends Character> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Reference2CharLinkedOpenHashMap(Map<? extends K, ? extends Character> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Reference2CharLinkedOpenHashMap(Reference2CharMap<K> m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Reference2CharLinkedOpenHashMap(Reference2CharMap<K> m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Reference2CharLinkedOpenHashMap(K[] k, char[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Reference2CharLinkedOpenHashMap(K[] k, char[] v)
/*  225:     */  {
...
/*  611:     */    implements Reference2CharMap.Entry<K>, Map.Entry<K, Character>
/*  612:     */  {
...
/*  618:     */    }
/*  619:     */    
/*  620: 620 */    public K getKey() { return Reference2CharLinkedOpenHashMap.this.key[this.index]; }
/*  621:     */    
/*  622:     */    public Character getValue() {
/*  623: 623 */      return Character.valueOf(Reference2CharLinkedOpenHashMap.this.value[this.index]);
/*  624:     */    }
/*  625:     */    
/*  626: 626 */    public char getCharValue() { return Reference2CharLinkedOpenHashMap.this.value[this.index]; }
/*  627:     */    
/*  628:     */    public char setValue(char v) {
/*  629: 629 */      char oldValue = Reference2CharLinkedOpenHashMap.this.value[this.index];
/*  630: 630 */      Reference2CharLinkedOpenHashMap.this.value[this.index] = v;
...
/*  640: 640 */      return (Reference2CharLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*  641:     */    }
/*  642:     */    
/*  643: 643 */    public int hashCode() { return (Reference2CharLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2CharLinkedOpenHashMap.this.key[this.index])) ^ Reference2CharLinkedOpenHashMap.this.value[this.index]; }
/*  644:     */    
/*  645:     */    public String toString() {
/*  646: 646 */      return Reference2CharLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2CharLinkedOpenHashMap.this.value[this.index];
/*  647:     */    }
/*  648:     */  }
/*  649:     */  
...
/*  734: 734 */  public Reference2CharSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  735: 735 */  public Reference2CharSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); }
/*  736: 736 */  public Reference2CharSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  737:     */  
...
/*  751: 751 */    int index = -1;
/*  752:     */    
/*  753: 753 */    private MapIterator() { this.next = Reference2CharLinkedOpenHashMap.this.first;
/*  754: 754 */      this.index = 0;
/*  755:     */    }
/*  756:     */    
/*  757: 757 */    private MapIterator() { if (Reference2CharLinkedOpenHashMap.this.key[Reference2CharLinkedOpenHashMap.this.last] == from) {
/*  758: 758 */        this.prev = Reference2CharLinkedOpenHashMap.this.last;
/*  759: 759 */        this.index = Reference2CharLinkedOpenHashMap.this.size;
/*  760:     */      }
/*  761:     */      else
/*  762:     */      {
/*  763: 763 */        int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2CharLinkedOpenHashMap.this.mask;
/*  764:     */        
/*  765: 765 */        while (Reference2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  766: 766 */          if (Reference2CharLinkedOpenHashMap.this.key[pos] == from)
/*  767:     */          {
/*  768: 768 */            this.next = ((int)Reference2CharLinkedOpenHashMap.this.link[pos]);
/*  769: 769 */            this.prev = pos;
/*  770: 770 */            return;
/*  771:     */          }
/*  772: 772 */          pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask;
/*  773:     */        }
...
/*  786: 786 */        this.index = Reference2CharLinkedOpenHashMap.this.size;
/*  787: 787 */        return;
/*  788:     */      }
/*  789: 789 */      int pos = Reference2CharLinkedOpenHashMap.this.first;
/*  790: 790 */      this.index = 1;
/*  791: 791 */      while (pos != this.prev) {
/*  792: 792 */        pos = (int)Reference2CharLinkedOpenHashMap.this.link[pos];
...
/*  803:     */    }
/*  804:     */    
/*  805: 805 */    public int nextEntry() { if (!hasNext()) return Reference2CharLinkedOpenHashMap.this.size();
/*  806: 806 */      this.curr = this.next;
/*  807: 807 */      this.next = ((int)Reference2CharLinkedOpenHashMap.this.link[this.curr]);
...
/*  815: 815 */      this.prev = ((int)(Reference2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  828: 828 */        this.prev = ((int)(Reference2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  829:     */      }
/*  830:     */      else {
/*  831: 831 */        this.next = ((int)Reference2CharLinkedOpenHashMap.this.link[this.curr]); }
/*  832: 832 */      Reference2CharLinkedOpenHashMap.this.size -= 1;
/*  833:     */      
/*  835: 835 */      if (this.prev == -1) { Reference2CharLinkedOpenHashMap.this.first = this.next;
/*  836:     */      } else
/*  837: 837 */        Reference2CharLinkedOpenHashMap.this.link[this.prev] ^= (Reference2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  838: 838 */      if (this.next == -1) { Reference2CharLinkedOpenHashMap.this.last = this.prev;
/*  839:     */      } else
/*  840: 840 */        Reference2CharLinkedOpenHashMap.this.link[this.next] ^= (Reference2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  841: 841 */      int pos = this.curr;
/*  842:     */      int last;
/*  843:     */      for (;;) {
/*  844: 844 */        pos = (last = pos) + 1 & Reference2CharLinkedOpenHashMap.this.mask;
/*  845: 845 */        while (Reference2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  846: 846 */          int slot = (Reference2CharLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2CharLinkedOpenHashMap.this.key[pos]))) & Reference2CharLinkedOpenHashMap.this.mask;
/*  847: 847 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  848: 848 */          pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask;
/*  849:     */        }
/*  850: 850 */        if (Reference2CharLinkedOpenHashMap.this.used[pos] == 0) break;
/*  851: 851 */        Reference2CharLinkedOpenHashMap.this.key[last] = Reference2CharLinkedOpenHashMap.this.key[pos];
/*  852: 852 */        Reference2CharLinkedOpenHashMap.this.value[last] = Reference2CharLinkedOpenHashMap.this.value[pos];
/*  853: 853 */        if (this.next == pos) this.next = last;
/*  854: 854 */        if (this.prev == pos) this.prev = last;
/*  855: 855 */        Reference2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*  856:     */      }
/*  857: 857 */      Reference2CharLinkedOpenHashMap.this.used[last] = false;
/*  858: 858 */      Reference2CharLinkedOpenHashMap.this.key[last] = null;
/*  859: 859 */      this.curr = -1;
/*  860:     */    }
/*  861:     */    
...
/*  870:     */    } }
/*  871:     */  
/*  872:     */  private class EntryIterator extends Reference2CharLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Reference2CharMap.Entry<K>> { private Reference2CharLinkedOpenHashMap<K>.MapEntry entry;
/*  873:     */    
/*  874: 874 */    public EntryIterator() { super(null); }
/*  875:     */    
/*  876: 876 */    public EntryIterator() { super(from, null); }
/*  877:     */    
/*  878:     */    public Reference2CharLinkedOpenHashMap<K>.MapEntry next() {
/*  879: 879 */      return this.entry = new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this, nextEntry());
/*  880:     */    }
/*  881:     */    
/*  882: 882 */    public Reference2CharLinkedOpenHashMap<K>.MapEntry previous() { return this.entry = new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this, previousEntry()); }
/*  883:     */    
/*  884:     */    public void remove()
/*  885:     */    {
/*  886: 886 */      super.remove();
/*  887: 887 */      Reference2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  888:     */    
/*  889: 889 */    public void set(Reference2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  890: 890 */    public void add(Reference2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  891:     */  }
/*  892:     */  
/*  893: 893 */  private class FastEntryIterator extends Reference2CharLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Reference2CharMap.Entry<K>> { final AbstractReference2CharMap.BasicEntry<K> entry = new AbstractReference2CharMap.BasicEntry(null, '\000');
/*  894: 894 */    public FastEntryIterator() { super(null); }
/*  895:     */    
/*  896: 896 */    public FastEntryIterator() { super(from, null); }
/*  897:     */    
/*  898:     */    public AbstractReference2CharMap.BasicEntry<K> next() {
/*  899: 899 */      int e = nextEntry();
/*  900: 900 */      this.entry.key = Reference2CharLinkedOpenHashMap.this.key[e];
/*  901: 901 */      this.entry.value = Reference2CharLinkedOpenHashMap.this.value[e];
/*  902: 902 */      return this.entry;
/*  903:     */    }
/*  904:     */    
/*  905: 905 */    public AbstractReference2CharMap.BasicEntry<K> previous() { int e = previousEntry();
/*  906: 906 */      this.entry.key = Reference2CharLinkedOpenHashMap.this.key[e];
/*  907: 907 */      this.entry.value = Reference2CharLinkedOpenHashMap.this.value[e];
/*  908: 908 */      return this.entry; }
/*  909:     */    
/*  910: 910 */    public void set(Reference2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  911: 911 */    public void add(Reference2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); } }
/*  912:     */  
/*  913:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Reference2CharMap.Entry<K>> implements Reference2CharSortedMap.FastSortedEntrySet<K> { private MapEntrySet() {}
/*  914:     */    
/*  915: 915 */    public ObjectBidirectionalIterator<Reference2CharMap.Entry<K>> iterator() { return new Reference2CharLinkedOpenHashMap.EntryIterator(Reference2CharLinkedOpenHashMap.this); }
/*  916:     */    
/*  917: 917 */    public Comparator<? super Reference2CharMap.Entry<K>> comparator() { return null; }
/*  918: 918 */    public ObjectSortedSet<Reference2CharMap.Entry<K>> subSet(Reference2CharMap.Entry<K> fromElement, Reference2CharMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  919: 919 */    public ObjectSortedSet<Reference2CharMap.Entry<K>> headSet(Reference2CharMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  920: 920 */    public ObjectSortedSet<Reference2CharMap.Entry<K>> tailSet(Reference2CharMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); }
/*  921:     */    
/*  922: 922 */    public Reference2CharMap.Entry<K> first() { if (Reference2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923: 923 */      return new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this, Reference2CharLinkedOpenHashMap.this.first);
/*  924:     */    }
/*  925:     */    
/*  926: 926 */    public Reference2CharMap.Entry<K> last() { if (Reference2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  927: 927 */      return new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this, Reference2CharLinkedOpenHashMap.this.last);
/*  928:     */    }
/*  929:     */    
...
/*  934:     */      
/*  935: 935 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2CharLinkedOpenHashMap.this.mask;
/*  936:     */      
/*  937: 937 */      while (Reference2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  938: 938 */        if (Reference2CharLinkedOpenHashMap.this.key[pos] == k) return Reference2CharLinkedOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/*  939: 939 */        pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask;
/*  940:     */      }
...
/*  948:     */      
/*  949: 949 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2CharLinkedOpenHashMap.this.mask;
/*  950:     */      
/*  951: 951 */      while (Reference2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  952: 952 */        if (Reference2CharLinkedOpenHashMap.this.key[pos] == k) {
/*  953: 953 */          Reference2CharLinkedOpenHashMap.this.remove(e.getKey());
/*  954: 954 */          return true;
/*  955:     */        }
/*  956: 956 */        pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask;
/*  957:     */      }
/*  958: 958 */      return false;
/*  959:     */    }
/*  960:     */    
/*  961: 961 */    public int size() { return Reference2CharLinkedOpenHashMap.this.size; }
/*  962:     */    
/*  963:     */    public void clear() {
/*  964: 964 */      Reference2CharLinkedOpenHashMap.this.clear();
/*  965:     */    }
/*  966:     */    
/*  967: 967 */    public ObjectBidirectionalIterator<Reference2CharMap.Entry<K>> iterator(Reference2CharMap.Entry<K> from) { return new Reference2CharLinkedOpenHashMap.EntryIterator(Reference2CharLinkedOpenHashMap.this, from.getKey()); }
/*  968:     */    
/*  969:     */    public ObjectBidirectionalIterator<Reference2CharMap.Entry<K>> fastIterator() {
/*  970: 970 */      return new Reference2CharLinkedOpenHashMap.FastEntryIterator(Reference2CharLinkedOpenHashMap.this);
/*  971:     */    }
/*  972:     */    
/*  973: 973 */    public ObjectBidirectionalIterator<Reference2CharMap.Entry<K>> fastIterator(Reference2CharMap.Entry<K> from) { return new Reference2CharLinkedOpenHashMap.FastEntryIterator(Reference2CharLinkedOpenHashMap.this, from.getKey()); }
/*  974:     */  }
/*  975:     */  
/*  976:     */  public Reference2CharSortedMap.FastSortedEntrySet<K> reference2CharEntrySet() {
...
/*  984:     */    extends Reference2CharLinkedOpenHashMap<K>.MapIterator
/*  985:     */    implements ObjectListIterator<K>
/*  986:     */  {
/*  987: 987 */    public KeyIterator() { super(k, null); }
/*  988: 988 */    public K previous() { return Reference2CharLinkedOpenHashMap.this.key[previousEntry()]; }
...
/*  992: 992 */    public K next() { return Reference2CharLinkedOpenHashMap.this.key[nextEntry()]; } }
/*  993:     */  
/*  994:     */  private final class KeySet extends AbstractReferenceSortedSet<K> { private KeySet() {}
/*  995:     */    
/*  996: 996 */    public ObjectListIterator<K> iterator(K from) { return new Reference2CharLinkedOpenHashMap.KeyIterator(Reference2CharLinkedOpenHashMap.this, from); }
/*  997:     */    
/*  998:     */    public ObjectListIterator<K> iterator() {
/*  999: 999 */      return new Reference2CharLinkedOpenHashMap.KeyIterator(Reference2CharLinkedOpenHashMap.this);
/* 1000:     */    }
/* 1001:     */    
/* 1002:1002 */    public int size() { return Reference2CharLinkedOpenHashMap.this.size; }
/* 1003:     */    
/* 1005:1005 */    public boolean contains(Object k) { return Reference2CharLinkedOpenHashMap.this.containsKey(k); }
/* 1006:     */    
/* 1007:     */    public boolean remove(Object k) {
/* 1008:1008 */      int oldSize = Reference2CharLinkedOpenHashMap.this.size;
/* 1009:1009 */      Reference2CharLinkedOpenHashMap.this.remove(k);
/* 1010:1010 */      return Reference2CharLinkedOpenHashMap.this.size != oldSize;
/* 1011:     */    }
/* 1012:     */    
/* 1013:1013 */    public void clear() { Reference2CharLinkedOpenHashMap.this.clear(); }
/* 1014:     */    
/* 1015:     */    public K first() {
/* 1016:1016 */      if (Reference2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017:1017 */      return Reference2CharLinkedOpenHashMap.this.key[Reference2CharLinkedOpenHashMap.this.first];
/* 1018:     */    }
/* 1019:     */    
/* 1020:1020 */    public K last() { if (Reference2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021:1021 */      return Reference2CharLinkedOpenHashMap.this.key[Reference2CharLinkedOpenHashMap.this.last]; }
/* 1022:     */    
...
/* 1036:     */    extends Reference2CharLinkedOpenHashMap.MapIterator
/* 1037:     */    implements CharListIterator
/* 1038:     */  {
/* 1039:1039 */    public char previousChar() { return Reference2CharLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1040:1040 */    public Character previous() { return Character.valueOf(Reference2CharLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1046:1046 */    public char nextChar() { return Reference2CharLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1047:1047 */    public Character next() { return Character.valueOf(Reference2CharLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1048:     */  }
/* 1049:     */  
...
/* 1052:1052 */          return new Reference2CharLinkedOpenHashMap.ValueIterator(Reference2CharLinkedOpenHashMap.this);
/* 1053:     */        }
/* 1054:     */        
/* 1055:1055 */        public int size() { return Reference2CharLinkedOpenHashMap.this.size; }
/* 1056:     */        
/* 1057:     */        public boolean contains(char v) {
/* 1058:1058 */          return Reference2CharLinkedOpenHashMap.this.containsValue(v);
/* 1059:     */        }
/* 1060:     */        
/* 1061:1061 */        public void clear() { Reference2CharLinkedOpenHashMap.this.clear(); }
/* 1062:     */      };
/* 1063:     */    }
...
/* 1183:     */  }
/* 1184:     */  
/* 1187:     */  public Reference2CharLinkedOpenHashMap<K> clone()
/* 1188:     */  {
/* 1189:     */    Reference2CharLinkedOpenHashMap<K> c;
/* 1190:     */    
/* 1192:     */    try
/* 1193:     */    {
/* 1194:1194 */      c = (Reference2CharLinkedOpenHashMap)super.clone();
/* 1195:     */    }
...
/* 1232:1232 */    Reference2CharLinkedOpenHashMap<K>.MapIterator i = new MapIterator(null);
