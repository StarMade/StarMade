  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2CharLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2CharLinkedOpenHashMap(Map<? extends K, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2CharLinkedOpenHashMap(Map<? extends K, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2CharLinkedOpenHashMap(Reference2CharMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2CharLinkedOpenHashMap(Reference2CharMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2CharLinkedOpenHashMap(K[] local_k, char[] local_v, float local_f)
  {
  ...
  public Reference2CharLinkedOpenHashMap(K[] local_k, char[] local_v)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Reference2CharLinkedOpenHashMap.ValueIterator(Reference2CharLinkedOpenHashMap.this);
        }
        ...
        {
          return Reference2CharLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2CharLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Reference2CharLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    char[] value = this.value;
    Reference2CharLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Reference2CharLinkedOpenHashMap.MapIterator
    implements CharListIterator
  {
    ...
    {
      return Character.valueOf(Reference2CharLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Character.valueOf(Reference2CharLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractReferenceSortedSet<K>
  {
    ...
    {
      return new Reference2CharLinkedOpenHashMap.KeyIterator(Reference2CharLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Reference2CharLinkedOpenHashMap.KeyIterator(Reference2CharLinkedOpenHashMap.this);
    }
    ...
    {
      return Reference2CharLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2CharLinkedOpenHashMap.this.size;
      Reference2CharLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Reference2CharSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Reference2CharLinkedOpenHashMap.EntryIterator(Reference2CharLinkedOpenHashMap.this);
    }
    ...
    public Reference2CharMap.Entry<K> first()
    {
      ...
      return new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this, Reference2CharLinkedOpenHashMap.this.first);
    }
    ...
    public Reference2CharMap.Entry<K> last()
    {
      ...
      return new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this, Reference2CharLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2CharLinkedOpenHashMap.this.mask; Reference2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask) {
        if (Reference2CharLinkedOpenHashMap.this.key[pos] == local_k) {
          return Reference2CharLinkedOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2CharLinkedOpenHashMap.this.mask; Reference2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask) {
        if (Reference2CharLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Reference2CharLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Reference2CharLinkedOpenHashMap.EntryIterator(Reference2CharLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Reference2CharMap.Entry<K>> fastIterator()
    {
      return new Reference2CharLinkedOpenHashMap.FastEntryIterator(Reference2CharLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Reference2CharMap.Entry<K>> fastIterator(Reference2CharMap.Entry<K> from)
    {
      return new Reference2CharLinkedOpenHashMap.FastEntryIterator(Reference2CharLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Reference2CharMap.Entry<K>>
  {
    ...
    public AbstractReference2CharMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Reference2CharLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Reference2CharLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    public void set(Reference2CharMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
    
    public void add(Reference2CharMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
  }
    ...
    implements ObjectListIterator<Reference2CharMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this, nextEntry());
    }
    
    public Reference2CharLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Reference2CharLinkedOpenHashMap.MapEntry(Reference2CharLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2CharLinkedOpenHashMap.this.mask; Reference2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Reference2CharLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Reference2CharLinkedOpenHashMap.this.first = this.next;
      } else {
        Reference2CharLinkedOpenHashMap.this.link[this.prev] ^= (Reference2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Reference2CharLinkedOpenHashMap.this.last = this.prev;
      } else {
        Reference2CharLinkedOpenHashMap.this.link[this.next] ^= (Reference2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2CharLinkedOpenHashMap.this.mask; Reference2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2CharLinkedOpenHashMap.this.mask)
        {
        ...
        if (Reference2CharLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Reference2CharMap.Entry<K>, Map.Entry<K, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Reference2CharLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Character> local_e = (Map.Entry)local_o;
      return (Reference2CharLinkedOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2CharLinkedOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
