...
/*   15:     */
/*   99:     */public class Object2ReferenceLinkedOpenCustomHashMap<K, V>
/*  100:     */  extends AbstractObject2ReferenceSortedMap<K, V>
...
/*  113:     */  protected volatile transient Object2ReferenceSortedMap.FastSortedEntrySet<K, V> entries;
...
/*  132:     */  
/*  138:     */  public Object2ReferenceLinkedOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy)
/*  139:     */  {
...
/*  151:     */  }
/*  152:     */  
/*  156:     */  public Object2ReferenceLinkedOpenCustomHashMap(int expected, Hash.Strategy<K> strategy)
/*  157:     */  {
/*  158: 158 */    this(expected, 0.75F, strategy);
/*  159:     */  }
/*  160:     */  
/*  163:     */  public Object2ReferenceLinkedOpenCustomHashMap(Hash.Strategy<K> strategy)
/*  164:     */  {
/*  165: 165 */    this(16, 0.75F, strategy);
/*  166:     */  }
/*  167:     */  
/*  172:     */  public Object2ReferenceLinkedOpenCustomHashMap(Map<? extends K, ? extends V> m, float f, Hash.Strategy<K> strategy)
/*  173:     */  {
/*  174: 174 */    this(m.size(), f, strategy);
/*  175: 175 */    putAll(m);
/*  176:     */  }
/*  177:     */  
/*  181:     */  public Object2ReferenceLinkedOpenCustomHashMap(Map<? extends K, ? extends V> m, Hash.Strategy<K> strategy)
/*  182:     */  {
/*  183: 183 */    this(m, 0.75F, strategy);
/*  184:     */  }
/*  185:     */  
/*  190:     */  public Object2ReferenceLinkedOpenCustomHashMap(Object2ReferenceMap<K, V> m, float f, Hash.Strategy<K> strategy)
/*  191:     */  {
/*  192: 192 */    this(m.size(), f, strategy);
/*  193: 193 */    putAll(m);
/*  194:     */  }
/*  195:     */  
/*  199:     */  public Object2ReferenceLinkedOpenCustomHashMap(Object2ReferenceMap<K, V> m, Hash.Strategy<K> strategy)
/*  200:     */  {
/*  201: 201 */    this(m, 0.75F, strategy);
/*  202:     */  }
/*  203:     */  
/*  210:     */  public Object2ReferenceLinkedOpenCustomHashMap(K[] k, V[] v, float f, Hash.Strategy<K> strategy)
/*  211:     */  {
...
/*  216:     */  }
/*  217:     */  
/*  222:     */  public Object2ReferenceLinkedOpenCustomHashMap(K[] k, V[] v, Hash.Strategy<K> strategy)
/*  223:     */  {
...
/*  526: 526 */    for (int i = this.n; i-- != 0; return true) label16: if ((used[i] == 0) || (value[i] != v)) break label16;
...
/*  569:     */    implements Object2ReferenceMap.Entry<K, V>, Map.Entry<K, V>
/*  570:     */  {
...
/*  576:     */    }
/*  577:     */    
/*  578: 578 */    public K getKey() { return Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index]; }
/*  579:     */    
/*  581: 581 */    public V getValue() { return Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index]; }
/*  582:     */    
/*  583:     */    public V setValue(V v) {
/*  584: 584 */      V oldValue = Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index];
/*  585: 585 */      Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index] = v;
...
/*  592: 592 */      return (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index] == e.getValue());
/*  593:     */    }
/*  594:     */    
/*  595: 595 */    public int hashCode() { return Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index]) ^ (Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index])); }
/*  596:     */    
/*  597:     */    public String toString() {
/*  598: 598 */      return Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index] + "=>" + Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index];
/*  599:     */    }
/*  600:     */  }
/*  601:     */  
...
/*  686: 686 */  public Object2ReferenceSortedMap<K, V> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  687: 687 */  public Object2ReferenceSortedMap<K, V> headMap(K to) { throw new UnsupportedOperationException(); }
/*  688: 688 */  public Object2ReferenceSortedMap<K, V> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  689:     */  
...
/*  703: 703 */    int index = -1;
/*  704:     */    
/*  705: 705 */    private MapIterator() { this.next = Object2ReferenceLinkedOpenCustomHashMap.this.first;
/*  706: 706 */      this.index = 0;
/*  707:     */    }
/*  708:     */    
/*  709: 709 */    private MapIterator() { if (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[Object2ReferenceLinkedOpenCustomHashMap.this.last], from)) {
/*  710: 710 */        this.prev = Object2ReferenceLinkedOpenCustomHashMap.this.last;
/*  711: 711 */        this.index = Object2ReferenceLinkedOpenCustomHashMap.this.size;
/*  712:     */      }
/*  713:     */      else
/*  714:     */      {
/*  715: 715 */        int pos = HashCommon.murmurHash3(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  716:     */        
/*  717: 717 */        while (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  718: 718 */          if (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[pos], from))
/*  719:     */          {
/*  720: 720 */            this.next = ((int)Object2ReferenceLinkedOpenCustomHashMap.this.link[pos]);
/*  721: 721 */            this.prev = pos;
/*  722: 722 */            return;
/*  723:     */          }
/*  724: 724 */          pos = pos + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  725:     */        }
...
/*  738: 738 */        this.index = Object2ReferenceLinkedOpenCustomHashMap.this.size;
/*  739: 739 */        return;
/*  740:     */      }
/*  741: 741 */      int pos = Object2ReferenceLinkedOpenCustomHashMap.this.first;
/*  742: 742 */      this.index = 1;
/*  743: 743 */      while (pos != this.prev) {
/*  744: 744 */        pos = (int)Object2ReferenceLinkedOpenCustomHashMap.this.link[pos];
...
/*  755:     */    }
/*  756:     */    
/*  757: 757 */    public int nextEntry() { if (!hasNext()) return Object2ReferenceLinkedOpenCustomHashMap.this.size();
/*  758: 758 */      this.curr = this.next;
/*  759: 759 */      this.next = ((int)Object2ReferenceLinkedOpenCustomHashMap.this.link[this.curr]);
...
/*  767: 767 */      this.prev = ((int)(Object2ReferenceLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
...
/*  780: 780 */        this.prev = ((int)(Object2ReferenceLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
/*  781:     */      }
/*  782:     */      else {
/*  783: 783 */        this.next = ((int)Object2ReferenceLinkedOpenCustomHashMap.this.link[this.curr]); }
/*  784: 784 */      Object2ReferenceLinkedOpenCustomHashMap.this.size -= 1;
/*  785:     */      
/*  787: 787 */      if (this.prev == -1) { Object2ReferenceLinkedOpenCustomHashMap.this.first = this.next;
/*  788:     */      } else
/*  789: 789 */        Object2ReferenceLinkedOpenCustomHashMap.this.link[this.prev] ^= (Object2ReferenceLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  790: 790 */      if (this.next == -1) { Object2ReferenceLinkedOpenCustomHashMap.this.last = this.prev;
/*  791:     */      } else
/*  792: 792 */        Object2ReferenceLinkedOpenCustomHashMap.this.link[this.next] ^= (Object2ReferenceLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  793: 793 */      int pos = this.curr;
/*  794:     */      int last;
/*  795:     */      for (;;) {
/*  796: 796 */        pos = (last = pos) + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  797: 797 */        while (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  798: 798 */          int slot = HashCommon.murmurHash3(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(Object2ReferenceLinkedOpenCustomHashMap.this.key[pos])) & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  799: 799 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  800: 800 */          pos = pos + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  801:     */        }
/*  802: 802 */        if (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] == 0) break;
/*  803: 803 */        Object2ReferenceLinkedOpenCustomHashMap.this.key[last] = Object2ReferenceLinkedOpenCustomHashMap.this.key[pos];
/*  804: 804 */        Object2ReferenceLinkedOpenCustomHashMap.this.value[last] = Object2ReferenceLinkedOpenCustomHashMap.this.value[pos];
/*  805: 805 */        if (this.next == pos) this.next = last;
/*  806: 806 */        if (this.prev == pos) this.prev = last;
/*  807: 807 */        Object2ReferenceLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*  808:     */      }
/*  809: 809 */      Object2ReferenceLinkedOpenCustomHashMap.this.used[last] = false;
/*  810: 810 */      Object2ReferenceLinkedOpenCustomHashMap.this.key[last] = null;
/*  811: 811 */      Object2ReferenceLinkedOpenCustomHashMap.this.value[last] = null;
/*  812: 812 */      this.curr = -1;
/*  813:     */    }
/*  814:     */    
...
/*  823:     */    } }
/*  824:     */  
/*  825:     */  private class EntryIterator extends Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapIterator implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> { private Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapEntry entry;
/*  826:     */    
/*  827: 827 */    public EntryIterator() { super(null); }
/*  828:     */    
/*  829: 829 */    public EntryIterator() { super(from, null); }
/*  830:     */    
/*  831:     */    public Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapEntry next() {
/*  832: 832 */      return this.entry = new Object2ReferenceLinkedOpenCustomHashMap.MapEntry(Object2ReferenceLinkedOpenCustomHashMap.this, nextEntry());
/*  833:     */    }
/*  834:     */    
/*  835: 835 */    public Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapEntry previous() { return this.entry = new Object2ReferenceLinkedOpenCustomHashMap.MapEntry(Object2ReferenceLinkedOpenCustomHashMap.this, previousEntry()); }
/*  836:     */    
/*  837:     */    public void remove()
/*  838:     */    {
/*  839: 839 */      super.remove();
/*  840: 840 */      Object2ReferenceLinkedOpenCustomHashMap.MapEntry.access$202(this.entry, -1); }
/*  841:     */    
/*  842: 842 */    public void set(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  843: 843 */    public void add(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  844:     */  }
/*  845:     */  
/*  846: 846 */  private class FastEntryIterator extends Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapIterator implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>> { final AbstractObject2ReferenceMap.BasicEntry<K, V> entry = new AbstractObject2ReferenceMap.BasicEntry(null, null);
/*  847: 847 */    public FastEntryIterator() { super(null); }
/*  848:     */    
/*  849: 849 */    public FastEntryIterator() { super(from, null); }
/*  850:     */    
/*  851:     */    public AbstractObject2ReferenceMap.BasicEntry<K, V> next() {
/*  852: 852 */      int e = nextEntry();
/*  853: 853 */      this.entry.key = Object2ReferenceLinkedOpenCustomHashMap.this.key[e];
/*  854: 854 */      this.entry.value = Object2ReferenceLinkedOpenCustomHashMap.this.value[e];
/*  855: 855 */      return this.entry;
/*  856:     */    }
/*  857:     */    
/*  858: 858 */    public AbstractObject2ReferenceMap.BasicEntry<K, V> previous() { int e = previousEntry();
/*  859: 859 */      this.entry.key = Object2ReferenceLinkedOpenCustomHashMap.this.key[e];
/*  860: 860 */      this.entry.value = Object2ReferenceLinkedOpenCustomHashMap.this.value[e];
/*  861: 861 */      return this.entry; }
/*  862:     */    
/*  863: 863 */    public void set(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  864: 864 */    public void add(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } }
/*  865:     */  
/*  866:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Object2ReferenceMap.Entry<K, V>> implements Object2ReferenceSortedMap.FastSortedEntrySet<K, V> { private MapEntrySet() {}
/*  867:     */    
/*  868: 868 */    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator() { return new Object2ReferenceLinkedOpenCustomHashMap.EntryIterator(Object2ReferenceLinkedOpenCustomHashMap.this); }
/*  869:     */    
/*  870: 870 */    public Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator() { return null; }
/*  871: 871 */    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> fromElement, Object2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); }
/*  872: 872 */    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); }
/*  873: 873 */    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> fromElement) { throw new UnsupportedOperationException(); }
/*  874:     */    
/*  875: 875 */    public Object2ReferenceMap.Entry<K, V> first() { if (Object2ReferenceLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  876: 876 */      return new Object2ReferenceLinkedOpenCustomHashMap.MapEntry(Object2ReferenceLinkedOpenCustomHashMap.this, Object2ReferenceLinkedOpenCustomHashMap.this.first);
/*  877:     */    }
/*  878:     */    
/*  879: 879 */    public Object2ReferenceMap.Entry<K, V> last() { if (Object2ReferenceLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  880: 880 */      return new Object2ReferenceLinkedOpenCustomHashMap.MapEntry(Object2ReferenceLinkedOpenCustomHashMap.this, Object2ReferenceLinkedOpenCustomHashMap.this.last);
/*  881:     */    }
/*  882:     */    
...
/*  887:     */      
/*  888: 888 */      int pos = HashCommon.murmurHash3(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  889:     */      
/*  890: 890 */      while (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  891: 891 */        if (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[pos], k)) return Object2ReferenceLinkedOpenCustomHashMap.this.value[pos] == e.getValue();
/*  892: 892 */        pos = pos + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  893:     */      }
...
/*  901:     */      
/*  902: 902 */      int pos = HashCommon.murmurHash3(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  903:     */      
/*  904: 904 */      while (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  905: 905 */        if (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[pos], k)) {
/*  906: 906 */          Object2ReferenceLinkedOpenCustomHashMap.this.remove(e.getKey());
/*  907: 907 */          return true;
/*  908:     */        }
/*  909: 909 */        pos = pos + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  910:     */      }
/*  911: 911 */      return false;
/*  912:     */    }
/*  913:     */    
/*  914: 914 */    public int size() { return Object2ReferenceLinkedOpenCustomHashMap.this.size; }
/*  915:     */    
/*  916:     */    public void clear() {
/*  917: 917 */      Object2ReferenceLinkedOpenCustomHashMap.this.clear();
/*  918:     */    }
/*  919:     */    
/*  920: 920 */    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> from) { return new Object2ReferenceLinkedOpenCustomHashMap.EntryIterator(Object2ReferenceLinkedOpenCustomHashMap.this, from.getKey()); }
/*  921:     */    
/*  922:     */    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> fastIterator() {
/*  923: 923 */      return new Object2ReferenceLinkedOpenCustomHashMap.FastEntryIterator(Object2ReferenceLinkedOpenCustomHashMap.this);
/*  924:     */    }
/*  925:     */    
/*  926: 926 */    public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> fastIterator(Object2ReferenceMap.Entry<K, V> from) { return new Object2ReferenceLinkedOpenCustomHashMap.FastEntryIterator(Object2ReferenceLinkedOpenCustomHashMap.this, from.getKey()); }
/*  927:     */  }
/*  928:     */  
/*  929:     */  public Object2ReferenceSortedMap.FastSortedEntrySet<K, V> object2ReferenceEntrySet() {
...
/*  937:     */    extends Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapIterator
/*  938:     */    implements ObjectListIterator<K>
/*  939:     */  {
/*  940: 940 */    public KeyIterator() { super(k, null); }
/*  941: 941 */    public K previous() { return Object2ReferenceLinkedOpenCustomHashMap.this.key[previousEntry()]; }
...
/*  945: 945 */    public K next() { return Object2ReferenceLinkedOpenCustomHashMap.this.key[nextEntry()]; } }
/*  946:     */  
/*  947:     */  private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/*  948:     */    
/*  949: 949 */    public ObjectListIterator<K> iterator(K from) { return new Object2ReferenceLinkedOpenCustomHashMap.KeyIterator(Object2ReferenceLinkedOpenCustomHashMap.this, from); }
/*  950:     */    
/*  951:     */    public ObjectListIterator<K> iterator() {
/*  952: 952 */      return new Object2ReferenceLinkedOpenCustomHashMap.KeyIterator(Object2ReferenceLinkedOpenCustomHashMap.this);
/*  953:     */    }
/*  954:     */    
/*  955: 955 */    public int size() { return Object2ReferenceLinkedOpenCustomHashMap.this.size; }
/*  956:     */    
/*  958: 958 */    public boolean contains(Object k) { return Object2ReferenceLinkedOpenCustomHashMap.this.containsKey(k); }
/*  959:     */    
/*  960:     */    public boolean remove(Object k) {
/*  961: 961 */      int oldSize = Object2ReferenceLinkedOpenCustomHashMap.this.size;
/*  962: 962 */      Object2ReferenceLinkedOpenCustomHashMap.this.remove(k);
/*  963: 963 */      return Object2ReferenceLinkedOpenCustomHashMap.this.size != oldSize;
/*  964:     */    }
/*  965:     */    
/*  966: 966 */    public void clear() { Object2ReferenceLinkedOpenCustomHashMap.this.clear(); }
/*  967:     */    
/*  968:     */    public K first() {
/*  969: 969 */      if (Object2ReferenceLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  970: 970 */      return Object2ReferenceLinkedOpenCustomHashMap.this.key[Object2ReferenceLinkedOpenCustomHashMap.this.first];
/*  971:     */    }
/*  972:     */    
/*  973: 973 */    public K last() { if (Object2ReferenceLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  974: 974 */      return Object2ReferenceLinkedOpenCustomHashMap.this.key[Object2ReferenceLinkedOpenCustomHashMap.this.last]; }
/*  975:     */    
...
/*  989:     */    extends Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapIterator
/*  990:     */    implements ObjectListIterator<V>
/*  991:     */  {
/*  992: 992 */    public V previous() { return Object2ReferenceLinkedOpenCustomHashMap.this.value[previousEntry()]; }
...
/*  996: 996 */    public V next() { return Object2ReferenceLinkedOpenCustomHashMap.this.value[nextEntry()]; }
/*  997:     */  }
/*  998:     */  
/*  999: 999 */  public ReferenceCollection<V> values() { if (this.values == null) { this.values = new AbstractReferenceCollection() {
/* 1000:     */        public ObjectIterator<V> iterator() {
/* 1001:1001 */          return new Object2ReferenceLinkedOpenCustomHashMap.ValueIterator(Object2ReferenceLinkedOpenCustomHashMap.this);
/* 1002:     */        }
/* 1003:     */        
/* 1004:1004 */        public int size() { return Object2ReferenceLinkedOpenCustomHashMap.this.size; }
/* 1005:     */        
/* 1006:     */        public boolean contains(Object v) {
/* 1007:1007 */          return Object2ReferenceLinkedOpenCustomHashMap.this.containsValue(v);
/* 1008:     */        }
/* 1009:     */        
/* 1010:1010 */        public void clear() { Object2ReferenceLinkedOpenCustomHashMap.this.clear(); }
/* 1011:     */      };
/* 1012:     */    }
...
/* 1132:     */  }
/* 1133:     */  
/* 1136:     */  public Object2ReferenceLinkedOpenCustomHashMap<K, V> clone()
/* 1137:     */  {
/* 1138:     */    Object2ReferenceLinkedOpenCustomHashMap<K, V> c;
/* 1139:     */    
/* 1141:     */    try
/* 1142:     */    {
/* 1143:1143 */      c = (Object2ReferenceLinkedOpenCustomHashMap)super.clone();
/* 1144:     */    }
...
/* 1174:1174 */        t ^= (this.value[i] == null ? 0 : System.identityHashCode(this.value[i]));
/* 1175:1175 */      h += t;
/* 1176:1176 */      i++;
/* 1177:     */    }
/* 1178:1178 */    return h;
...
/* 1183:1183 */    Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapIterator i = new MapIterator(null);
