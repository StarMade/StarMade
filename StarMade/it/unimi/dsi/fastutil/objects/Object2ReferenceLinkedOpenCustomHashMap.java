...
/*  526 */     for (int i = this.n; i-- != 0; return true) label16: if ((used[i] == 0) || (value[i] != v))
...
/*  686 */   public Object2ReferenceSortedMap<K, V> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  687 */   public Object2ReferenceSortedMap<K, V> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  688 */   public Object2ReferenceSortedMap<K, V> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/*  999 */     if (this.values == null) this.values = new AbstractReferenceCollection() {
/*      */         public ObjectIterator<V> iterator() {
/* 1001 */           return new Object2ReferenceLinkedOpenCustomHashMap.ValueIterator(Object2ReferenceLinkedOpenCustomHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1004 */           return Object2ReferenceLinkedOpenCustomHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1007 */           return Object2ReferenceLinkedOpenCustomHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1010 */           Object2ReferenceLinkedOpenCustomHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1143 */       c = (Object2ReferenceLinkedOpenCustomHashMap)super.clone();
/*      */     }
...
/* 1174 */         t ^= (this.value[i] == null ? 0 : System.identityHashCode(this.value[i]));
/* 1175 */       h += t;
/* 1176 */       i++;
/*      */     }
/* 1178 */     return h;
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/*  992 */       return Object2ReferenceLinkedOpenCustomHashMap.this.value[previousEntry()]; } 
...
/*  996 */     public V next() { return Object2ReferenceLinkedOpenCustomHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  949 */       return new Object2ReferenceLinkedOpenCustomHashMap.KeyIterator(Object2ReferenceLinkedOpenCustomHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/*  952 */       return new Object2ReferenceLinkedOpenCustomHashMap.KeyIterator(Object2ReferenceLinkedOpenCustomHashMap.this);
/*      */     }
/*      */     public int size() {
/*  955 */       return Object2ReferenceLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/*  958 */       return Object2ReferenceLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/*  961 */       int oldSize = Object2ReferenceLinkedOpenCustomHashMap.this.size;
/*  962 */       Object2ReferenceLinkedOpenCustomHashMap.this.remove(k);
/*  963 */       return Object2ReferenceLinkedOpenCustomHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/*  966 */       Object2ReferenceLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/*  969 */       if (Object2ReferenceLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  970 */       return Object2ReferenceLinkedOpenCustomHashMap.this.key[Object2ReferenceLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */     public K last() {
/*  973 */       if (Object2ReferenceLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return Object2ReferenceLinkedOpenCustomHashMap.this.key[Object2ReferenceLinkedOpenCustomHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/*  940 */       super(k, null); } 
/*  941 */     public K previous() { return Object2ReferenceLinkedOpenCustomHashMap.this.key[previousEntry()]; } 
...
/*  945 */     public K next() { return Object2ReferenceLinkedOpenCustomHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  868 */       return new Object2ReferenceLinkedOpenCustomHashMap.EntryIterator(Object2ReferenceLinkedOpenCustomHashMap.this);
/*      */     }
/*  870 */     public Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator() { return null; } 
/*  871 */     public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> fromElement, Object2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); } 
/*  872 */     public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); } 
/*  873 */     public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Object2ReferenceMap.Entry<K, V> first() {
/*  875 */       if (Object2ReferenceLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  876 */       return new Object2ReferenceLinkedOpenCustomHashMap.MapEntry(Object2ReferenceLinkedOpenCustomHashMap.this, Object2ReferenceLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */     public Object2ReferenceMap.Entry<K, V> last() {
/*  879 */       if (Object2ReferenceLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  880 */       return new Object2ReferenceLinkedOpenCustomHashMap.MapEntry(Object2ReferenceLinkedOpenCustomHashMap.this, Object2ReferenceLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  888 */       int pos = HashCommon.murmurHash3(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  890 */       while (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  891 */         if (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[pos], k)) return Object2ReferenceLinkedOpenCustomHashMap.this.value[pos] == e.getValue();
/*  892 */         pos = pos + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*      */       }
/*  894 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  902 */       int pos = HashCommon.murmurHash3(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  904 */       while (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  905 */         if (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[pos], k)) {
/*  906 */           Object2ReferenceLinkedOpenCustomHashMap.this.remove(e.getKey());
/*  907 */           return true;
/*      */         }
/*  909 */         pos = pos + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*      */       }
/*  911 */       return false;
/*      */     }
/*      */     public int size() {
/*  914 */       return Object2ReferenceLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  917 */       Object2ReferenceLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> from) {
/*  920 */       return new Object2ReferenceLinkedOpenCustomHashMap.EntryIterator(Object2ReferenceLinkedOpenCustomHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> fastIterator() {
/*  923 */       return new Object2ReferenceLinkedOpenCustomHashMap.FastEntryIterator(Object2ReferenceLinkedOpenCustomHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> fastIterator(Object2ReferenceMap.Entry<K, V> from) {
/*  926 */       return new Object2ReferenceLinkedOpenCustomHashMap.FastEntryIterator(Object2ReferenceLinkedOpenCustomHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>>
/*      */   {
/*  846 */     final AbstractObject2ReferenceMap.BasicEntry<K, V> entry = new AbstractObject2ReferenceMap.BasicEntry(null, null);
/*      */ 
...
/*  852 */       int e = nextEntry();
/*  853 */       this.entry.key = Object2ReferenceLinkedOpenCustomHashMap.this.key[e];
/*  854 */       this.entry.value = Object2ReferenceLinkedOpenCustomHashMap.this.value[e];
/*  855 */       return this.entry;
/*      */     }
/*      */     public AbstractObject2ReferenceMap.BasicEntry<K, V> previous() {
/*  858 */       int e = previousEntry();
/*  859 */       this.entry.key = Object2ReferenceLinkedOpenCustomHashMap.this.key[e];
/*  860 */       this.entry.value = Object2ReferenceLinkedOpenCustomHashMap.this.value[e];
/*  861 */       return this.entry;
/*      */     }
/*  863 */     public void set(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  864 */     public void add(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<Object2ReferenceMap.Entry<K, V>>
/*      */   {
...
/*  832 */       return this.entry = new Object2ReferenceLinkedOpenCustomHashMap.MapEntry(Object2ReferenceLinkedOpenCustomHashMap.this, nextEntry());
/*      */     }
/*      */     public Object2ReferenceLinkedOpenCustomHashMap<K, V>.MapEntry previous() {
/*  835 */       return this.entry = new Object2ReferenceLinkedOpenCustomHashMap.MapEntry(Object2ReferenceLinkedOpenCustomHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  839 */       super.remove();
/*  840 */       Object2ReferenceLinkedOpenCustomHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  842 */     public void set(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  843 */     public void add(Object2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  703 */     int index = -1;
/*      */ 
/*  705 */     private MapIterator() { this.next = Object2ReferenceLinkedOpenCustomHashMap.this.first;
/*  706 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  709 */       if (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[Object2ReferenceLinkedOpenCustomHashMap.this.last], from)) {
/*  710 */         this.prev = Object2ReferenceLinkedOpenCustomHashMap.this.last;
/*  711 */         this.index = Object2ReferenceLinkedOpenCustomHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  715 */         int pos = HashCommon.murmurHash3(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  717 */         while (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  718 */           if (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[pos], from))
/*      */           {
/*  720 */             this.next = ((int)Object2ReferenceLinkedOpenCustomHashMap.this.link[pos]);
/*  721 */             this.prev = pos;
/*  722 */             return;
/*      */           }
/*  724 */           pos = pos + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  737 */       if (this.next == -1) {
/*  738 */         this.index = Object2ReferenceLinkedOpenCustomHashMap.this.size;
/*  739 */         return;
/*      */       }
/*  741 */       int pos = Object2ReferenceLinkedOpenCustomHashMap.this.first;
/*  742 */       this.index = 1;
/*  743 */       while (pos != this.prev) {
/*  744 */         pos = (int)Object2ReferenceLinkedOpenCustomHashMap.this.link[pos];
/*  745 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  757 */       if (!hasNext()) return Object2ReferenceLinkedOpenCustomHashMap.this.size();
/*  758 */       this.curr = this.next;
/*  759 */       this.next = ((int)Object2ReferenceLinkedOpenCustomHashMap.this.link[this.curr]);
...
/*  767 */       this.prev = ((int)(Object2ReferenceLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  779 */         this.index -= 1;
/*  780 */         this.prev = ((int)(Object2ReferenceLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  783 */         this.next = ((int)Object2ReferenceLinkedOpenCustomHashMap.this.link[this.curr]);
/*  784 */       }Object2ReferenceLinkedOpenCustomHashMap.this.size -= 1;
/*      */ 
/*  787 */       if (this.prev == -1) Object2ReferenceLinkedOpenCustomHashMap.this.first = this.next;
/*      */       else
/*  789 */         Object2ReferenceLinkedOpenCustomHashMap.this.link[this.prev] ^= (Object2ReferenceLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  790 */       if (this.next == -1) Object2ReferenceLinkedOpenCustomHashMap.this.last = this.prev;
/*      */       else
/*  792 */         Object2ReferenceLinkedOpenCustomHashMap.this.link[this.next] ^= (Object2ReferenceLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  796 */         pos = (last = pos) + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  797 */         while (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  798 */           int slot = HashCommon.murmurHash3(Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(Object2ReferenceLinkedOpenCustomHashMap.this.key[pos])) & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*  799 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  800 */           pos = pos + 1 & Object2ReferenceLinkedOpenCustomHashMap.this.mask;
/*      */         }
/*  802 */         if (Object2ReferenceLinkedOpenCustomHashMap.this.used[pos] == 0) break;
/*  803 */         Object2ReferenceLinkedOpenCustomHashMap.this.key[last] = Object2ReferenceLinkedOpenCustomHashMap.this.key[pos];
/*  804 */         Object2ReferenceLinkedOpenCustomHashMap.this.value[last] = Object2ReferenceLinkedOpenCustomHashMap.this.value[pos];
/*  805 */         if (this.next == pos) this.next = last;
/*  806 */         if (this.prev == pos) this.prev = last;
/*  807 */         Object2ReferenceLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */       }
/*  809 */       Object2ReferenceLinkedOpenCustomHashMap.this.used[last] = false;
/*  810 */       Object2ReferenceLinkedOpenCustomHashMap.this.key[last] = null;
/*  811 */       Object2ReferenceLinkedOpenCustomHashMap.this.value[last] = null;
/*  812 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  578 */       return Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  581 */       return Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  584 */       Object oldValue = Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index];
/*  585 */       Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  586 */       return oldValue;
/*      */     }
/*      */ 
...
/*  592 */       return (Object2ReferenceLinkedOpenCustomHashMap.this.strategy.equals(Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  595 */       return Object2ReferenceLinkedOpenCustomHashMap.this.strategy.hashCode(Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index]) ^ (Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index]));
/*      */     }
/*      */     public String toString() {
/*  598 */       return Object2ReferenceLinkedOpenCustomHashMap.this.key[this.index] + "=>" + Object2ReferenceLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
