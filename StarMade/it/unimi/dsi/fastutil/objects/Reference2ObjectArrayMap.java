  ...
  implements Serializable, Cloneable
{
  ...
  public Reference2ObjectArrayMap(Reference2ObjectMap<K, V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Reference2ObjectArrayMap(Map<? extends K, ? extends V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Reference2ObjectArrayMap<K, V> local_c;
    try
    {
      local_c = (Reference2ObjectArrayMap)super.clone();
    }
    ...
    implements Reference2ObjectMap.FastEntrySet<K, V>
  {
    ...
    public ObjectIterator<Reference2ObjectMap.Entry<K, V>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Reference2ObjectMap.Entry<K, V> next()
        {
          ...
          return new AbstractReference2ObjectMap.BasicEntry(Reference2ObjectArrayMap.this.key[this.next], Reference2ObjectArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Reference2ObjectMap.Entry<K, V>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Reference2ObjectMap.Entry<K, V> next()
        {
          ...
          this.entry.key = Reference2ObjectArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Reference2ObjectArrayMap.this.containsKey(local_k)) && (Reference2ObjectArrayMap.this.get(local_k) == null ? local_e.getValue() == null : Reference2ObjectArrayMap.this.get(local_k).equals(local_e.getValue()));
    }
  }
}
