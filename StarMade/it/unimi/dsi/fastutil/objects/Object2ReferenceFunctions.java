...
/*   4:    */
/*  51:    */public class Object2ReferenceFunctions
/*  52:    */{
/*  53:    */  public static class EmptyFunction<K, V>
/*  54:    */    extends AbstractObject2ReferenceFunction<K, V>
...
/*  65: 65 */    private Object readResolve() { return Object2ReferenceFunctions.EMPTY_FUNCTION; }
/*  66: 66 */    public Object clone() { return Object2ReferenceFunctions.EMPTY_FUNCTION; }
/*  67:    */  }
/*  68:    */  
/*  70: 70 */  public static final EmptyFunction EMPTY_FUNCTION = new EmptyFunction();
/*  71:    */  
/*  73:    */  public static class Singleton<K, V>
/*  74:    */    extends AbstractObject2ReferenceFunction<K, V>
...
/*  91:    */    
/*  92: 92 */    public V get(Object k) { if (this.key == null ? k == null : this.key.equals(k)) return this.value; return this.defRetValue; }
/*  93:    */    
...
/*  97:    */  }
/*  98:    */  
/* 109:109 */  public static <K, V> Object2ReferenceFunction<K, V> singleton(K key, V value) { return new Singleton(key, value); }
/* 110:    */  
/* 111:    */  public static class SynchronizedFunction<K, V> extends AbstractObject2ReferenceFunction<K, V> implements Serializable {
/* 112:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 113:    */    protected final Object2ReferenceFunction<K, V> function;
/* 114:    */    protected final Object sync;
/* 115:    */    
/* 116:    */    protected SynchronizedFunction(Object2ReferenceFunction<K, V> f, Object sync) {
/* 117:117 */      if (f == null) throw new NullPointerException();
/* 118:118 */      this.function = f;
/* 119:119 */      this.sync = sync;
/* 120:    */    }
/* 121:    */    
/* 122:122 */    protected SynchronizedFunction(Object2ReferenceFunction<K, V> f) { if (f == null) throw new NullPointerException();
...
/* 137:    */  }
/* 138:    */  
/* 140:    */  public static <K, V> Object2ReferenceFunction<K, V> synchronize(Object2ReferenceFunction<K, V> f)
/* 141:    */  {
/* 142:142 */    return new SynchronizedFunction(f);
/* 143:    */  }
/* 144:    */  
/* 150:150 */  public static <K, V> Object2ReferenceFunction<K, V> synchronize(Object2ReferenceFunction<K, V> f, Object sync) { return new SynchronizedFunction(f, sync); }
/* 151:    */  
/* 152:    */  public static class UnmodifiableFunction<K, V> extends AbstractObject2ReferenceFunction<K, V> implements Serializable {
/* 153:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 154:    */    protected final Object2ReferenceFunction<K, V> function;
/* 155:    */    
/* 156:156 */    protected UnmodifiableFunction(Object2ReferenceFunction<K, V> f) { if (f == null) throw new NullPointerException();
...
/* 168:    */  }
/* 169:    */  
/* 173:    */  public static <K, V> Object2ReferenceFunction<K, V> unmodifiable(Object2ReferenceFunction<K, V> f)
/* 174:    */  {
