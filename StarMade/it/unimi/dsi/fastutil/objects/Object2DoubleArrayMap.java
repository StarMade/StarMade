...
/*     */ 
/*     */ public class Object2DoubleArrayMap<K> extends AbstractObject2DoubleMap<K>
...
/*     */     try
/*     */     {
/* 300 */       c = (Object2DoubleArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Object2DoubleMap.Entry<K>>
...
/* 130 */         int next = 0;
/*     */ 
/* 132 */         public boolean hasNext() { return this.next < Object2DoubleArrayMap.this.size; }
/*     */ 
/*     */         public Object2DoubleMap.Entry<K> next()
/*     */         {
/* 136 */           if (!hasNext()) throw new NoSuchElementException();
/* 137 */           return new AbstractObject2DoubleMap.BasicEntry(Object2DoubleArrayMap.this.key[this.next], Object2DoubleArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 143 */         int next = 0;
/* 144 */         final AbstractObject2DoubleMap.BasicEntry<K> entry = new AbstractObject2DoubleMap.BasicEntry(null, 0.0D);
/*     */ 
/* 146 */         public boolean hasNext() { return this.next < Object2DoubleArrayMap.this.size; }
/*     */ 
/*     */         public Object2DoubleMap.Entry<K> next()
/*     */         {
/* 150 */           if (!hasNext()) throw new NoSuchElementException();
/* 151 */           this.entry.key = Object2DoubleArrayMap.this.key[this.next];
/* 152 */           this.entry.value = Object2DoubleArrayMap.this.value[(this.next++)];
/* 153 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 158 */       return Object2DoubleArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 165 */       return (Object2DoubleArrayMap.this.containsKey(k)) && (Object2DoubleArrayMap.this.get(k).doubleValue() == ((Double)e.getValue()).doubleValue());
/*     */     }
/*     */   }
/*     */ }
