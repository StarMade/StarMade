  ...
  implements Serializable, Cloneable
{
  ...
  public Object2DoubleArrayMap(Object2DoubleMap<K> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Object2DoubleArrayMap(Map<? extends K, ? extends Double> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Object2DoubleArrayMap<K> local_c;
    try
    {
      local_c = (Object2DoubleArrayMap)super.clone();
    }
    ...
    implements Object2DoubleMap.FastEntrySet<K>
  {
    ...
    public ObjectIterator<Object2DoubleMap.Entry<K>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Object2DoubleMap.Entry<K> next()
        {
          ...
          return new AbstractObject2DoubleMap.BasicEntry(Object2DoubleArrayMap.this.key[this.next], Object2DoubleArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Object2DoubleMap.Entry<K>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Object2DoubleMap.Entry<K> next()
        {
          ...
          this.entry.key = Object2DoubleArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Object2DoubleArrayMap.this.containsKey(local_k)) && (Object2DoubleArrayMap.this.get(local_k).doubleValue() == ((Double)local_e.getValue()).doubleValue());
    }
  }
}
