...
/*   18:     */
/*   72:     */public class Object2LongRBTreeMap<K>
/*   73:     */  extends AbstractObject2LongSortedMap<K>
...
/*   80:     */  protected volatile transient ObjectSortedSet<Object2LongMap.Entry<K>> entries;
/*   81:     */  protected volatile transient ObjectSortedSet<K> keys;
/*   82:     */  protected volatile transient LongCollection values;
...
/*   90:     */  
/*   91:     */  public Object2LongRBTreeMap()
/*   92:     */  {
/*   93:  93 */    allocatePaths();
/*   94:     */    
...
/*  113:     */  }
/*  114:     */  
/*  117:     */  public Object2LongRBTreeMap(Comparator<? super K> c)
/*  118:     */  {
/*  119: 119 */    this();
...
/*  122:     */  }
/*  123:     */  
/*  126:     */  public Object2LongRBTreeMap(Map<? extends K, ? extends Long> m)
/*  127:     */  {
/*  128: 128 */    this();
/*  129: 129 */    putAll(m);
/*  130:     */  }
/*  131:     */  
/*  134:     */  public Object2LongRBTreeMap(SortedMap<K, Long> m)
/*  135:     */  {
/*  136: 136 */    this(m.comparator());
/*  137: 137 */    putAll(m);
/*  138:     */  }
/*  139:     */  
/*  142:     */  public Object2LongRBTreeMap(Object2LongMap<? extends K> m)
/*  143:     */  {
/*  144: 144 */    this();
/*  145: 145 */    putAll(m);
/*  146:     */  }
/*  147:     */  
/*  150:     */  public Object2LongRBTreeMap(Object2LongSortedMap<K> m)
/*  151:     */  {
/*  152: 152 */    this(m.comparator());
/*  153: 153 */    putAll(m);
/*  154:     */  }
/*  155:     */  
/*  161:     */  public Object2LongRBTreeMap(K[] k, long[] v, Comparator<? super K> c)
/*  162:     */  {
/*  163: 163 */    this(c);
...
/*  167:     */  }
/*  168:     */  
/*  172:     */  public Object2LongRBTreeMap(K[] k, long[] v)
/*  173:     */  {
...
/*  233:     */  }
/*  234:     */  
/*  235:     */  public long put(K k, long v)
/*  236:     */  {
...
/*  371:     */  }
/*  372:     */  
/*  374:     */  public long removeLong(Object k)
/*  375:     */  {
...
/*  595:     */  }
/*  596:     */  
/*  597: 597 */  public Long put(K ok, Long ov) { long oldValue = put(ok, ov.longValue());
/*  598: 598 */    return this.modified ? null : Long.valueOf(oldValue);
/*  599:     */  }
/*  600:     */  
/*  601: 601 */  public Long remove(Object ok) { long oldValue = removeLong(ok);
/*  602: 602 */    return this.modified ? Long.valueOf(oldValue) : null;
/*  603:     */  }
/*  604:     */  
/*  605: 605 */  public boolean containsValue(long v) { Object2LongRBTreeMap<K>.ValueIterator i = new ValueIterator(null);
/*  606:     */    
/*  607: 607 */    int j = this.count;
/*  608: 608 */    while (j-- != 0) {
/*  609: 609 */      long ev = i.nextLong();
...
/*  626:     */    implements Cloneable, Object2LongMap.Entry<K>
/*  627:     */  {
...
/*  761: 761 */      return Long.valueOf(this.value);
/*  762:     */    }
/*  763:     */    
/*  764: 764 */    public long getLongValue() { return this.value; }
/*  765:     */    
/*  766:     */    public long setValue(long value) {
/*  767: 767 */      long oldValue = this.value;
/*  768: 768 */      this.value = value;
/*  769: 769 */      return oldValue;
/*  770:     */    }
/*  771:     */    
/*  772: 772 */    public Long setValue(Long value) { return Long.valueOf(setValue(value.longValue())); }
/*  773:     */    
...
/*  791: 791 */      Map.Entry<K, Long> e = (Map.Entry)o;
/*  792: 792 */      return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Long)e.getValue()).longValue());
/*  793:     */    }
/*  794:     */    
/*  795: 795 */    public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.long2int(this.value); }
/*  796:     */    
...
/*  862:     */  {
/*  863:     */    Object2LongRBTreeMap.Entry<K> prev;
/*  864:     */    
/*  866:     */    Object2LongRBTreeMap.Entry<K> next;
/*  867:     */    
/*  868:     */    Object2LongRBTreeMap.Entry<K> curr;
/*  869:     */    
/*  870: 870 */    int index = 0;
/*  871:     */    
/*  872: 872 */    TreeIterator() { this.next = Object2LongRBTreeMap.this.firstEntry; }
/*  873:     */    
/*  874:     */    TreeIterator() {
/*  875: 875 */      if ((this.next = Object2LongRBTreeMap.this.locateKey(k)) != null)
/*  876: 876 */        if (Object2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/*  887:     */    
/*  888:     */    Object2LongRBTreeMap.Entry<K> nextEntry() {
...
/*  897:     */    
/*  898:     */    Object2LongRBTreeMap.Entry<K> previousEntry() {
...
/*  918: 918 */      updateNext();
/*  919: 919 */      Object2LongRBTreeMap.this.removeLong(this.curr.key);
...
/*  935:     */    extends Object2LongRBTreeMap<K>.TreeIterator
/*  936:     */    implements ObjectListIterator<Object2LongMap.Entry<K>>
/*  937:     */  {
/*  938: 938 */    EntryIterator() { super(); }
/*  939:     */    
/*  940: 940 */    EntryIterator() { super(k); }
/*  941:     */    
/*  942: 942 */    public Object2LongMap.Entry<K> next() { return nextEntry(); }
/*  943: 943 */    public Object2LongMap.Entry<K> previous() { return previousEntry(); }
/*  944: 944 */    public void set(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  945: 945 */    public void add(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  946:     */  }
/*  947:     */  
/*  948: 948 */  public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*  949: 949 */        final Comparator<? super Object2LongMap.Entry<K>> comparator = new Comparator() {
/*  950:     */          public int compare(Object2LongMap.Entry<K> x, Object2LongMap.Entry<K> y) {
/*  951: 951 */            return Object2LongRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*  952:     */          }
/*  953:     */        };
/*  954:     */        
/*  955: 955 */        public Comparator<? super Object2LongMap.Entry<K>> comparator() { return this.comparator; }
/*  956:     */        
/*  957:     */        public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator() {
/*  958: 958 */          return new Object2LongRBTreeMap.EntryIterator(Object2LongRBTreeMap.this);
/*  959:     */        }
/*  960:     */        
/*  961: 961 */        public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) { return new Object2LongRBTreeMap.EntryIterator(Object2LongRBTreeMap.this, from.getKey()); }
/*  962:     */        
/*  963:     */        public boolean contains(Object o)
/*  964:     */        {
/*  965: 965 */          if (!(o instanceof Map.Entry)) return false;
/*  966: 966 */          Map.Entry<K, Long> e = (Map.Entry)o;
/*  967: 967 */          Object2LongRBTreeMap.Entry<K> f = Object2LongRBTreeMap.this.findKey(e.getKey());
/*  968: 968 */          return e.equals(f);
/*  969:     */        }
/*  970:     */        
/*  971:     */        public boolean remove(Object o) {
/*  972: 972 */          if (!(o instanceof Map.Entry)) return false;
/*  973: 973 */          Map.Entry<K, Long> e = (Map.Entry)o;
/*  974: 974 */          Object2LongRBTreeMap.Entry<K> f = Object2LongRBTreeMap.this.findKey(e.getKey());
/*  975: 975 */          if (f != null) Object2LongRBTreeMap.this.removeLong(f.key);
/*  976: 976 */          return f != null; }
/*  977:     */        
/*  978: 978 */        public int size() { return Object2LongRBTreeMap.this.count; }
/*  979: 979 */        public void clear() { Object2LongRBTreeMap.this.clear(); }
/*  980: 980 */        public Object2LongMap.Entry<K> first() { return Object2LongRBTreeMap.this.firstEntry; }
/*  981: 981 */        public Object2LongMap.Entry<K> last() { return Object2LongRBTreeMap.this.lastEntry; }
/*  982: 982 */        public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) { return Object2LongRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet(); }
/*  983: 983 */        public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) { return Object2LongRBTreeMap.this.headMap(to.getKey()).object2LongEntrySet(); }
/*  984: 984 */        public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) { return Object2LongRBTreeMap.this.tailMap(from.getKey()).object2LongEntrySet(); }
/*  985:     */      };
/*  986: 986 */    return this.entries;
/*  987:     */  }
/*  988:     */  
/*  991:     */  private final class KeyIterator
/*  992:     */    extends Object2LongRBTreeMap<K>.TreeIterator
...
/* 1001:     */  }
/* 1002:     */  
/* 1003:1003 */  private class KeySet extends AbstractObject2LongSortedMap.KeySet { private KeySet() { super(); }
/* 1004:1004 */    public ObjectBidirectionalIterator<K> iterator() { return new Object2LongRBTreeMap.KeyIterator(Object2LongRBTreeMap.this); }
/* 1005:1005 */    public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2LongRBTreeMap.KeyIterator(Object2LongRBTreeMap.this, from); }
/* 1006:     */  }
/* 1007:     */  
...
/* 1022:     */    extends Object2LongRBTreeMap.TreeIterator
/* 1023:     */    implements LongListIterator
/* 1024:     */  {
/* 1025:1025 */    private ValueIterator() { super(); }
/* 1026:1026 */    public long nextLong() { return nextEntry().value; }
/* 1027:1027 */    public long previousLong() { return previousEntry().value; }
/* 1028:1028 */    public void set(long v) { throw new UnsupportedOperationException(); }
/* 1029:1029 */    public void add(long v) { throw new UnsupportedOperationException(); }
/* 1030:1030 */    public Long next() { return Long.valueOf(nextEntry().value); }
/* 1031:1031 */    public Long previous() { return Long.valueOf(previousEntry().value); }
/* 1032:1032 */    public void set(Long ok) { throw new UnsupportedOperationException(); }
/* 1033:1033 */    public void add(Long ok) { throw new UnsupportedOperationException(); }
/* 1034:     */  }
/* 1035:     */  
/* 1042:     */  public LongCollection values()
/* 1043:     */  {
/* 1044:1044 */    if (this.values == null) { this.values = new AbstractLongCollection() {
/* 1045:     */        public LongIterator iterator() {
/* 1046:1046 */          return new Object2LongRBTreeMap.ValueIterator(Object2LongRBTreeMap.this, null);
/* 1047:     */        }
/* 1048:     */        
/* 1049:1049 */        public boolean contains(long k) { return Object2LongRBTreeMap.this.containsValue(k); }
/* 1050:     */        
/* 1051:     */        public int size() {
/* 1052:1052 */          return Object2LongRBTreeMap.this.count;
/* 1053:     */        }
/* 1054:     */        
/* 1055:1055 */        public void clear() { Object2LongRBTreeMap.this.clear(); }
/* 1056:     */      };
/* 1057:     */    }
...
/* 1062:     */  
/* 1063:     */  public Object2LongSortedMap<K> headMap(K to) {
/* 1064:1064 */    return new Submap(null, true, to, false);
/* 1065:     */  }
/* 1066:     */  
/* 1067:1067 */  public Object2LongSortedMap<K> tailMap(K from) { return new Submap(from, false, null, true); }
/* 1068:     */  
/* 1069:     */  public Object2LongSortedMap<K> subMap(K from, K to) {
/* 1070:1070 */    return new Submap(from, false, to, false);
/* 1071:     */  }
/* 1072:     */  
/* 1076:     */  private final class Submap
/* 1077:     */    extends AbstractObject2LongSortedMap<K>
...
/* 1093:     */    boolean top;
/* 1094:     */    
/* 1096:     */    protected volatile transient ObjectSortedSet<Object2LongMap.Entry<K>> entries;
/* 1097:     */    
/* 1099:     */    protected volatile transient ObjectSortedSet<K> keys;
/* 1100:     */    
/* 1102:     */    protected volatile transient LongCollection values;
/* 1103:     */    
/* 1106:     */    public Submap(boolean from, K bottom, boolean to)
/* 1107:     */    {
/* 1108:1108 */      if ((!bottom) && (!top) && (Object2LongRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1109:1109 */      this.from = from;
/* 1110:1110 */      this.bottom = bottom;
/* 1111:1111 */      this.to = to;
/* 1112:1112 */      this.top = top;
/* 1113:1113 */      this.defRetValue = Object2LongRBTreeMap.this.defRetValue;
/* 1114:     */    }
/* 1115:     */    
/* 1116:1116 */    public void clear() { Object2LongRBTreeMap<K>.Submap.SubmapIterator i = new SubmapIterator();
...
/* 1126:     */    {
/* 1127:1127 */      return ((this.bottom) || (Object2LongRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Object2LongRBTreeMap.this.compare(k, this.to) < 0));
/* 1128:     */    }
/* 1129:     */    
/* 1130:     */    public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
/* 1131:1131 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1132:     */          public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator() {
/* 1133:1133 */            return new Object2LongRBTreeMap.Submap.SubmapEntryIterator(Object2LongRBTreeMap.Submap.this);
/* 1134:     */          }
/* 1135:     */          
/* 1136:1136 */          public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) { return new Object2LongRBTreeMap.Submap.SubmapEntryIterator(Object2LongRBTreeMap.Submap.this, from.getKey()); }
/* 1137:     */          
/* 1138:1138 */          public Comparator<? super Object2LongMap.Entry<K>> comparator() { return Object2LongRBTreeMap.this.object2LongEntrySet().comparator(); }
/* 1139:     */          
/* 1140:     */          public boolean contains(Object o) {
/* 1141:1141 */            if (!(o instanceof Map.Entry)) return false;
/* 1142:1142 */            Map.Entry<K, Long> e = (Map.Entry)o;
/* 1143:1143 */            Object2LongRBTreeMap.Entry<K> f = Object2LongRBTreeMap.this.findKey(e.getKey());
/* 1144:1144 */            return (f != null) && (Object2LongRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1145:     */          }
/* 1146:     */          
/* 1147:     */          public boolean remove(Object o) {
/* 1148:1148 */            if (!(o instanceof Map.Entry)) return false;
/* 1149:1149 */            Map.Entry<K, Long> e = (Map.Entry)o;
/* 1150:1150 */            Object2LongRBTreeMap.Entry<K> f = Object2LongRBTreeMap.this.findKey(e.getKey());
/* 1151:1151 */            if ((f != null) && (Object2LongRBTreeMap.Submap.this.in(f.key))) Object2LongRBTreeMap.Submap.this.removeLong(f.key);
...
/* 1157:1157 */            return c; }
/* 1158:     */          
/* 1159:1159 */          public boolean isEmpty() { return !new Object2LongRBTreeMap.Submap.SubmapIterator(Object2LongRBTreeMap.Submap.this).hasNext(); }
/* 1160:1160 */          public void clear() { Object2LongRBTreeMap.Submap.this.clear(); }
/* 1161:1161 */          public Object2LongMap.Entry<K> first() { return Object2LongRBTreeMap.Submap.this.firstEntry(); }
/* 1162:1162 */          public Object2LongMap.Entry<K> last() { return Object2LongRBTreeMap.Submap.this.lastEntry(); }
/* 1163:1163 */          public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) { return Object2LongRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet(); }
/* 1164:1164 */          public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) { return Object2LongRBTreeMap.Submap.this.headMap(to.getKey()).object2LongEntrySet(); }
/* 1165:1165 */          public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) { return Object2LongRBTreeMap.Submap.this.tailMap(from.getKey()).object2LongEntrySet(); }
/* 1166:     */        };
/* 1167:1167 */      return this.entries; }
/* 1168:     */    
/* 1169:1169 */    private class KeySet extends AbstractObject2LongSortedMap.KeySet { private KeySet() { super(); }
/* 1170:1170 */      public ObjectBidirectionalIterator<K> iterator() { return new Object2LongRBTreeMap.Submap.SubmapKeyIterator(Object2LongRBTreeMap.Submap.this); }
/* 1171:1171 */      public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2LongRBTreeMap.Submap.SubmapKeyIterator(Object2LongRBTreeMap.Submap.this, from); }
/* 1172:     */    }
/* 1173:     */    
...
/* 1176:     */    }
/* 1177:     */    
/* 1178:1178 */    public LongCollection values() { if (this.values == null) { this.values = new AbstractLongCollection() {
/* 1179:     */          public LongIterator iterator() {
/* 1180:1180 */            return new Object2LongRBTreeMap.Submap.SubmapValueIterator(Object2LongRBTreeMap.Submap.this, null);
/* 1181:     */          }
/* 1182:     */          
/* 1183:1183 */          public boolean contains(long k) { return Object2LongRBTreeMap.Submap.this.containsValue(k); }
/* 1184:     */          
/* 1185:     */          public int size() {
/* 1186:1186 */            return Object2LongRBTreeMap.Submap.this.size();
/* 1187:     */          }
/* 1188:     */          
/* 1189:1189 */          public void clear() { Object2LongRBTreeMap.Submap.this.clear(); }
/* 1190:     */        };
/* 1191:     */      }
/* 1192:1192 */      return this.values;
/* 1193:     */    }
/* 1194:     */    
/* 1196:1196 */    public boolean containsKey(Object k) { return (in(k)) && (Object2LongRBTreeMap.this.containsKey(k)); }
/* 1197:     */    
/* 1198:     */    public boolean containsValue(long v) {
/* 1199:1199 */      Object2LongRBTreeMap<K>.Submap.SubmapIterator i = new SubmapIterator();
/* 1200:     */      
/* 1201:1201 */      while (i.hasNext()) {
/* 1202:1202 */        long ev = i.nextEntry().value;
/* 1203:1203 */        if (ev == v) return true;
/* 1204:     */      }
/* 1205:1205 */      return false;
/* 1206:     */    }
/* 1207:     */    
/* 1208:     */    public long getLong(Object k)
/* 1209:     */    {
/* 1210:1210 */      K kk = k;
/* 1211:1211 */      Object2LongRBTreeMap.Entry<K> e; return (in(kk)) && ((e = Object2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1212:     */    }
/* 1213:     */    
/* 1214:     */    public Long get(Object ok)
/* 1215:     */    {
/* 1216:1216 */      K kk = ok;
/* 1217:1217 */      Object2LongRBTreeMap.Entry<K> e; return (in(kk)) && ((e = Object2LongRBTreeMap.this.findKey(kk)) != null) ? e.getValue() : null;
/* 1218:     */    }
/* 1219:     */    
/* 1220:1220 */    public long put(K k, long v) { Object2LongRBTreeMap.this.modified = false;
...
/* 1222:1222 */      long oldValue = Object2LongRBTreeMap.this.put(k, v);
/* 1223:1223 */      return Object2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1224:     */    }
/* 1225:     */    
/* 1226:1226 */    public Long put(K ok, Long ov) { long oldValue = put(ok, ov.longValue());
/* 1227:1227 */      return Object2LongRBTreeMap.this.modified ? null : Long.valueOf(oldValue);
/* 1228:     */    }
/* 1229:     */    
/* 1230:     */    public long removeLong(Object k) {
/* 1231:1231 */      Object2LongRBTreeMap.this.modified = false;
/* 1232:1232 */      if (!in(k)) return this.defRetValue;
/* 1233:1233 */      long oldValue = Object2LongRBTreeMap.this.removeLong(k);
/* 1234:1234 */      return Object2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1235:     */    }
/* 1236:     */    
/* 1237:1237 */    public Long remove(Object ok) { long oldValue = removeLong(ok);
/* 1238:1238 */      return Object2LongRBTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/* 1239:     */    }
/* 1240:     */    
/* 1241:1241 */    public int size() { Object2LongRBTreeMap<K>.Submap.SubmapIterator i = new SubmapIterator();
/* 1242:1242 */      int n = 0;
...
/* 1251:     */    
/* 1253:1253 */    public Comparator<? super K> comparator() { return Object2LongRBTreeMap.this.actualComparator; }
/* 1254:     */    
/* 1255:     */    public Object2LongSortedMap<K> headMap(K to) {
/* 1256:1256 */      if (this.top) return new Submap(Object2LongRBTreeMap.this, this.from, this.bottom, to, false);
/* 1257:1257 */      return Object2LongRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Object2LongRBTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1258:     */    }
/* 1259:     */    
/* 1260:1260 */    public Object2LongSortedMap<K> tailMap(K from) { if (this.bottom) return new Submap(Object2LongRBTreeMap.this, from, false, this.to, this.top);
/* 1261:1261 */      return Object2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2LongRBTreeMap.this, from, false, this.to, this.top) : this;
/* 1262:     */    }
/* 1263:     */    
/* 1264:1264 */    public Object2LongSortedMap<K> subMap(K from, K to) { if ((this.top) && (this.bottom)) return new Submap(Object2LongRBTreeMap.this, from, false, to, false);
/* 1265:1265 */      if (!this.top) to = Object2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1266:1266 */      if (!this.bottom) from = Object2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1267:1267 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1268:1268 */      return new Submap(Object2LongRBTreeMap.this, from, false, to, false);
/* 1269:     */    }
/* 1270:     */    
/* 1273:     */    public Object2LongRBTreeMap.Entry<K> firstEntry()
/* 1274:     */    {
/* 1275:1275 */      if (Object2LongRBTreeMap.this.tree == null) return null;
/* 1276:     */      Object2LongRBTreeMap.Entry<K> e;
/* 1277:     */      Object2LongRBTreeMap.Entry<K> e;
/* 1278:1278 */      if (this.bottom) { e = Object2LongRBTreeMap.this.firstEntry;
/* 1279:     */      } else {
/* 1280:1280 */        e = Object2LongRBTreeMap.this.locateKey(this.from);
/* 1281:     */        
/* 1282:1282 */        if (Object2LongRBTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1283:     */        }
/* 1284:     */      }
/* 1285:1285 */      if ((e == null) || ((!this.top) && (Object2LongRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1286:1286 */      return e;
/* 1287:     */    }
/* 1288:     */    
/* 1291:     */    public Object2LongRBTreeMap.Entry<K> lastEntry()
/* 1292:     */    {
/* 1293:1293 */      if (Object2LongRBTreeMap.this.tree == null) return null;
/* 1294:     */      Object2LongRBTreeMap.Entry<K> e;
/* 1295:     */      Object2LongRBTreeMap.Entry<K> e;
/* 1296:1296 */      if (this.top) { e = Object2LongRBTreeMap.this.lastEntry;
/* 1297:     */      } else {
/* 1298:1298 */        e = Object2LongRBTreeMap.this.locateKey(this.to);
/* 1299:     */        
/* 1300:1300 */        if (Object2LongRBTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1301:     */        }
/* 1302:     */      }
/* 1303:1303 */      if ((e == null) || ((!this.bottom) && (Object2LongRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1304:1304 */      return e;
/* 1305:     */    }
/* 1306:     */    
/* 1307:1307 */    public K firstKey() { Object2LongRBTreeMap.Entry<K> e = firstEntry();
/* 1308:1308 */      if (e == null) throw new NoSuchElementException();
/* 1309:1309 */      return e.key;
/* 1310:     */    }
/* 1311:     */    
/* 1312:1312 */    public K lastKey() { Object2LongRBTreeMap.Entry<K> e = lastEntry();
/* 1313:1313 */      if (e == null) throw new NoSuchElementException();
/* 1314:1314 */      return e.key;
/* 1315:     */    }
/* 1316:     */    
/* 1319:     */    private class SubmapIterator
/* 1320:     */      extends Object2LongRBTreeMap.TreeIterator
/* 1321:     */    {
/* 1322:     */      SubmapIterator()
/* 1323:     */      {
/* 1324:1324 */        super();
/* 1325:1325 */        this.next = Object2LongRBTreeMap.Submap.this.firstEntry();
/* 1326:     */      }
/* 1327:     */      
/* 1328:1328 */      SubmapIterator() { this();
/* 1329:1329 */        if (this.next != null)
/* 1330:1330 */          if ((!Object2LongRBTreeMap.Submap.this.bottom) && (Object2LongRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1331:1331 */          } else if ((!Object2LongRBTreeMap.Submap.this.top) && (Object2LongRBTreeMap.this.compare(k, (this.prev = Object2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1332:     */          } else {
/* 1333:1333 */            this.next = Object2LongRBTreeMap.this.locateKey(k);
/* 1334:1334 */            if (Object2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1344:1344 */        if ((!Object2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2LongRBTreeMap.this.compare(this.prev.key, Object2LongRBTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1345:     */      }
/* 1346:     */      
/* 1347:1347 */      void updateNext() { this.next = this.next.next();
/* 1348:1348 */        if ((!Object2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Object2LongRBTreeMap.this.compare(this.next.key, Object2LongRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1349:     */      }
/* 1350:     */    }
/* 1351:     */    
/* 1352:1352 */    private class SubmapEntryIterator extends Object2LongRBTreeMap<K>.Submap.SubmapIterator implements ObjectListIterator<Object2LongMap.Entry<K>> { SubmapEntryIterator() { super(); }
/* 1353:     */      
/* 1354:1354 */      SubmapEntryIterator() { super(k); }
/* 1355:     */      
/* 1356:1356 */      public Object2LongMap.Entry<K> next() { return nextEntry(); }
/* 1357:1357 */      public Object2LongMap.Entry<K> previous() { return previousEntry(); }
/* 1358:1358 */      public void set(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/* 1359:1359 */      public void add(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/* 1360:     */    }
/* 1361:     */    
/* 1366:     */    private final class SubmapKeyIterator
/* 1367:     */      extends Object2LongRBTreeMap<K>.Submap.SubmapIterator
...
/* 1382:     */      extends Object2LongRBTreeMap.Submap.SubmapIterator
/* 1383:     */      implements LongListIterator
/* 1384:     */    {
/* 1385:1385 */      private SubmapValueIterator() { super(); }
/* 1386:1386 */      public long nextLong() { return nextEntry().value; }
/* 1387:1387 */      public long previousLong() { return previousEntry().value; }
/* 1388:1388 */      public void set(long v) { throw new UnsupportedOperationException(); }
/* 1389:1389 */      public void add(long v) { throw new UnsupportedOperationException(); }
/* 1390:1390 */      public Long next() { return Long.valueOf(nextEntry().value); }
/* 1391:1391 */      public Long previous() { return Long.valueOf(previousEntry().value); }
/* 1392:1392 */      public void set(Long ok) { throw new UnsupportedOperationException(); }
/* 1393:1393 */      public void add(Long ok) { throw new UnsupportedOperationException(); }
/* 1394:     */    }
/* 1395:     */  }
/* 1396:     */  
/* 1400:     */  public Object2LongRBTreeMap<K> clone()
/* 1401:     */  {
/* 1402:     */    Object2LongRBTreeMap<K> c;
/* 1403:     */    
/* 1405:     */    try
/* 1406:     */    {
/* 1407:1407 */      c = (Object2LongRBTreeMap)super.clone();
/* 1408:     */    }
...
/* 1461:1461 */    Object2LongRBTreeMap<K>.EntryIterator i = new EntryIterator();
/* 1462:     */    
/* 1463:1463 */    s.defaultWriteObject();
/* 1464:1464 */    while (n-- != 0) {
/* 1465:1465 */      Entry<K> e = i.nextEntry();
/* 1466:1466 */      s.writeObject(e.key);
/* 1467:1467 */      s.writeLong(e.value);
/* 1468:     */    }
/* 1469:     */  }
/* 1470:     */  
...
/* 1478:     */  {
/* 1479:1479 */    if (n == 1) {
/* 1480:1480 */      Entry<K> top = new Entry(s.readObject(), s.readLong());
...
/* 1486:1486 */    if (n == 2)
/* 1487:     */    {
/* 1489:1489 */      Entry<K> top = new Entry(s.readObject(), s.readLong());
/* 1490:1490 */      top.black(true);
/* 1491:1491 */      top.right(new Entry(s.readObject(), s.readLong()));
...
/* 1502:1502 */    top.value = s.readLong();
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.Object2LongRBTreeMap
