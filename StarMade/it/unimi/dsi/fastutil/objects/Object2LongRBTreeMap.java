...
/*  597 */     long oldValue = put(ok, ov.longValue());
/*  598 */     return this.modified ? null : Long.valueOf(oldValue);
/*      */   }
/*      */   public Long remove(Object ok) {
/*  601 */     long oldValue = removeLong(ok);
/*  602 */     return this.modified ? Long.valueOf(oldValue) : null;
/*      */   }
...
/*  949 */         final Comparator<? super Object2LongMap.Entry<K>> comparator = new Comparator() {
/*      */           public int compare(Object2LongMap.Entry<K> x, Object2LongMap.Entry<K> y) {
/*  951 */             return Object2LongRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/*  949 */         };
/*      */ 
...
/*  958 */           return new Object2LongRBTreeMap.EntryIterator(Object2LongRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/*  961 */           return new Object2LongRBTreeMap.EntryIterator(Object2LongRBTreeMap.this, from.getKey());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/*  965 */           if (!(o instanceof Map.Entry)) return false;
/*  966 */           Map.Entry e = (Map.Entry)o;
/*  967 */           Object2LongRBTreeMap.Entry f = Object2LongRBTreeMap.this.findKey(e.getKey());
...
/*  974 */           Object2LongRBTreeMap.Entry f = Object2LongRBTreeMap.this.findKey(e.getKey());
/*  975 */           if (f != null) Object2LongRBTreeMap.this.removeLong(f.key);
/*  976 */           return f != null;
/*      */         }
/*  978 */         public int size() { return Object2LongRBTreeMap.this.count; } 
/*  979 */         public void clear() { Object2LongRBTreeMap.this.clear(); } 
/*  980 */         public Object2LongMap.Entry<K> first() { return Object2LongRBTreeMap.this.firstEntry; } 
/*  981 */         public Object2LongMap.Entry<K> last() { return Object2LongRBTreeMap.this.lastEntry; } 
/*  982 */         public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) { return Object2LongRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet(); } 
/*  983 */         public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) { return Object2LongRBTreeMap.this.headMap(to.getKey()).object2LongEntrySet(); } 
/*  984 */         public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) { return Object2LongRBTreeMap.this.tailMap(from.getKey()).object2LongEntrySet(); }
/*      */       };
...
/*      */   {
/* 1044 */     if (this.values == null) this.values = new AbstractLongCollection() {
/*      */         public LongIterator iterator() {
/* 1046 */           return new Object2LongRBTreeMap.ValueIterator(Object2LongRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(long k) {
/* 1049 */           return Object2LongRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1052 */           return Object2LongRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1055 */           Object2LongRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1407 */       c = (Object2LongRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1479 */     if (n == 1) {
/* 1480 */       Entry top = new Entry(s.readObject(), s.readLong());
/* 1481 */       top.pred(pred);
/* 1482 */       top.succ(succ);
/* 1483 */       top.black(true);
/* 1484 */       return top;
...
/* 1486 */     if (n == 2)
/*      */     {
/* 1489 */       Entry top = new Entry(s.readObject(), s.readLong());
/* 1490 */       top.black(true);
/* 1491 */       top.right(new Entry(s.readObject(), s.readLong()));
...
/*      */     {
/* 1108 */       if ((!bottom) && (!top) && (Object2LongRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1109 */       this.from = from;
/* 1110 */       this.bottom = bottom;
/* 1111 */       this.to = to;
/* 1112 */       this.top = top;
/* 1113 */       this.defRetValue = Object2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1127 */       return ((this.bottom) || (Object2LongRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Object2LongRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet() {
/* 1131 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator() {
/* 1133 */             return new Object2LongRBTreeMap.Submap.SubmapEntryIterator(Object2LongRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/* 1136 */             return new Object2LongRBTreeMap.Submap.SubmapEntryIterator(Object2LongRBTreeMap.Submap.this, from.getKey());
/*      */           }
/* 1138 */           public Comparator<? super Object2LongMap.Entry<K>> comparator() { return Object2LongRBTreeMap.this.object2LongEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1141 */             if (!(o instanceof Map.Entry)) return false;
/* 1142 */             Map.Entry e = (Map.Entry)o;
/* 1143 */             Object2LongRBTreeMap.Entry f = Object2LongRBTreeMap.this.findKey(e.getKey());
/* 1144 */             return (f != null) && (Object2LongRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1148 */             if (!(o instanceof Map.Entry)) return false;
/* 1149 */             Map.Entry e = (Map.Entry)o;
/* 1150 */             Object2LongRBTreeMap.Entry f = Object2LongRBTreeMap.this.findKey(e.getKey());
/* 1151 */             if ((f != null) && (Object2LongRBTreeMap.Submap.this.in(f.key))) Object2LongRBTreeMap.Submap.this.removeLong(f.key);
/* 1152 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1155 */             int c = 0;
...
/* 1157 */             return c;
/*      */           }
/* 1159 */           public boolean isEmpty() { return !new Object2LongRBTreeMap.Submap.SubmapIterator(Object2LongRBTreeMap.Submap.this).hasNext(); } 
/* 1160 */           public void clear() { Object2LongRBTreeMap.Submap.this.clear(); } 
/* 1161 */           public Object2LongMap.Entry<K> first() { return Object2LongRBTreeMap.Submap.this.firstEntry(); } 
/* 1162 */           public Object2LongMap.Entry<K> last() { return Object2LongRBTreeMap.Submap.this.lastEntry(); } 
/* 1163 */           public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> to) { return Object2LongRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2LongEntrySet(); } 
/* 1164 */           public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> to) { return Object2LongRBTreeMap.Submap.this.headMap(to.getKey()).object2LongEntrySet(); } 
/* 1165 */           public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from) { return Object2LongRBTreeMap.Submap.this.tailMap(from.getKey()).object2LongEntrySet(); }
/*      */         };
...
/*      */     }
/*      */     public LongCollection values() {
/* 1178 */       if (this.values == null) this.values = new AbstractLongCollection() {
/*      */           public LongIterator iterator() {
/* 1180 */             return new Object2LongRBTreeMap.Submap.SubmapValueIterator(Object2LongRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(long k) {
/* 1183 */             return Object2LongRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1186 */             return Object2LongRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1189 */             Object2LongRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(Object k) {
/* 1196 */       return (in(k)) && (Object2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(long v) {
/* 1199 */       SubmapIterator i = new SubmapIterator();
/*      */ 
/* 1201 */       while (i.hasNext()) {
/* 1202 */         long ev = i.nextEntry().value;
...
/* 1211 */       return (in(kk)) && ((e = Object2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     public Long get(Object ok)
/*      */     {
/* 1216 */       Object kk = ok;
/*      */       Object2LongRBTreeMap.Entry e;
/* 1217 */       return (in(kk)) && ((e = Object2LongRBTreeMap.this.findKey(kk)) != null) ? e.getValue() : null;
/*      */     }
/*      */     public long put(K k, long v) {
/* 1220 */       Object2LongRBTreeMap.this.modified = false;
...
/* 1222 */       long oldValue = Object2LongRBTreeMap.this.put(k, v);
/* 1223 */       return Object2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Long put(K ok, Long ov) {
/* 1226 */       long oldValue = put(ok, ov.longValue());
/* 1227 */       return Object2LongRBTreeMap.this.modified ? null : Long.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public long removeLong(Object k) {
/* 1231 */       Object2LongRBTreeMap.this.modified = false;
/* 1232 */       if (!in(k)) return this.defRetValue;
/* 1233 */       long oldValue = Object2LongRBTreeMap.this.removeLong(k);
/* 1234 */       return Object2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Long remove(Object ok) {
/* 1237 */       long oldValue = removeLong(ok);
/* 1238 */       return Object2LongRBTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public Comparator<? super K> comparator() {
/* 1253 */       return Object2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Object2LongSortedMap<K> headMap(K to) {
/* 1256 */       if (this.top) return new Submap(Object2LongRBTreeMap.this, this.from, this.bottom, to, false);
/* 1257 */       return Object2LongRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Object2LongRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Object2LongSortedMap<K> tailMap(K from) {
/* 1260 */       if (this.bottom) return new Submap(Object2LongRBTreeMap.this, from, false, this.to, this.top);
/* 1261 */       return Object2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2LongRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Object2LongSortedMap<K> subMap(K from, K to) {
/* 1264 */       if ((this.top) && (this.bottom)) return new Submap(Object2LongRBTreeMap.this, from, false, to, false);
/* 1265 */       if (!this.top) to = Object2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1266 */       if (!this.bottom) from = Object2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1267 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1268 */       return new Submap(Object2LongRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Object2LongRBTreeMap.Entry<K> firstEntry()
/*      */     {
/* 1275 */       if (Object2LongRBTreeMap.this.tree == null) return null;
/* 1278 */       Object2LongRBTreeMap.Entry e;
/*      */       Object2LongRBTreeMap.Entry e;
/* 1278 */       if (this.bottom) { e = Object2LongRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1280 */         e = Object2LongRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1282 */         if (Object2LongRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1285 */       if ((e == null) || ((!this.top) && (Object2LongRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1286 */       return e;
/*      */     }
/*      */ 
/*      */     public Object2LongRBTreeMap.Entry<K> lastEntry()
/*      */     {
/* 1293 */       if (Object2LongRBTreeMap.this.tree == null) return null;
/* 1296 */       Object2LongRBTreeMap.Entry e;
/*      */       Object2LongRBTreeMap.Entry e;
/* 1296 */       if (this.top) { e = Object2LongRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1298 */         e = Object2LongRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1300 */         if (Object2LongRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1303 */       if ((e == null) || ((!this.bottom) && (Object2LongRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1304 */       return e;
/*      */     }
/*      */     public K firstKey() {
/* 1307 */       Object2LongRBTreeMap.Entry e = firstEntry();
/* 1308 */       if (e == null) throw new NoSuchElementException();
/* 1309 */       return e.key;
/*      */     }
/*      */     public K lastKey() {
/* 1312 */       Object2LongRBTreeMap.Entry e = lastEntry();
/* 1313 */       if (e == null) throw new NoSuchElementException();
/* 1314 */       return e.key;
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Object2LongRBTreeMap.Submap.SubmapIterator
/*      */       implements LongListIterator
/*      */     {
/*      */       private SubmapValueIterator()
/*      */       {
/* 1385 */         super(); } 
/* 1386 */       public long nextLong() { return nextEntry().value; } 
/* 1387 */       public long previousLong() { return previousEntry().value; } 
/* 1388 */       public void set(long v) { throw new UnsupportedOperationException(); } 
/* 1389 */       public void add(long v) { throw new UnsupportedOperationException(); } 
/* 1390 */       public Long next() { return Long.valueOf(nextEntry().value); } 
/* 1391 */       public Long previous() { return Long.valueOf(previousEntry().value); } 
/* 1392 */       public void set(Long ok) { throw new UnsupportedOperationException(); } 
/* 1393 */       public void add(Long ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Object2LongRBTreeMap<K>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Object2LongRBTreeMap<K>.Submap.SubmapIterator
...
/* 1357 */       public Object2LongMap.Entry<K> previous() { return previousEntry(); } 
/* 1358 */       public void set(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/* 1359 */       public void add(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Object2LongRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1324 */         super();
/* 1325 */         this.next = Object2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator() {
/* 1328 */         this();
/* 1329 */         if (this.next != null)
/* 1330 */           if ((!Object2LongRBTreeMap.Submap.this.bottom) && (Object2LongRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1331 */           } else if ((!Object2LongRBTreeMap.Submap.this.top) && (Object2LongRBTreeMap.this.compare(k, (this.prev = Object2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1333 */             this.next = Object2LongRBTreeMap.this.locateKey(k);
/* 1334 */             if (Object2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1344 */         if ((!Object2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2LongRBTreeMap.this.compare(this.prev.key, Object2LongRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1347 */         this.next = this.next.next();
/* 1348 */         if ((!Object2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Object2LongRBTreeMap.this.compare(this.next.key, Object2LongRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1169 */         super(); } 
/* 1170 */       public ObjectBidirectionalIterator<K> iterator() { return new Object2LongRBTreeMap.Submap.SubmapKeyIterator(Object2LongRBTreeMap.Submap.this); } 
/* 1171 */       public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2LongRBTreeMap.Submap.SubmapKeyIterator(Object2LongRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2LongRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     private ValueIterator()
/*      */     {
/* 1025 */       super(); } 
/* 1026 */     public long nextLong() { return nextEntry().value; } 
/* 1027 */     public long previousLong() { return previousEntry().value; } 
/* 1028 */     public void set(long v) { throw new UnsupportedOperationException(); } 
/* 1029 */     public void add(long v) { throw new UnsupportedOperationException(); } 
/* 1030 */     public Long next() { return Long.valueOf(nextEntry().value); } 
/* 1031 */     public Long previous() { return Long.valueOf(previousEntry().value); } 
/* 1032 */     public void set(Long ok) { throw new UnsupportedOperationException(); } 
/* 1033 */     public void add(Long ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class KeySet extends AbstractObject2LongSortedMap.KeySet
...
/*      */     {
/* 1003 */       super(); } 
/* 1004 */     public ObjectBidirectionalIterator<K> iterator() { return new Object2LongRBTreeMap.KeyIterator(Object2LongRBTreeMap.this); } 
/* 1005 */     public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2LongRBTreeMap.KeyIterator(Object2LongRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2LongRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2LongRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<Object2LongMap.Entry<K>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/*  943 */     public Object2LongMap.Entry<K> previous() { return previousEntry(); } 
/*  944 */     public void set(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  945 */     public void add(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  870 */     int index = 0;
/*      */ 
/*  872 */     TreeIterator() { this.next = Object2LongRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator() {
/*  875 */       if ((this.next = Object2LongRBTreeMap.this.locateKey(k)) != null)
/*  876 */         if (Object2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/*  917 */       updatePrevious();
/*  918 */       updateNext();
/*  919 */       Object2LongRBTreeMap.this.removeLong(this.curr.key);
/*  920 */       this.curr = null;
/*      */     }
...
/*  761 */       return Long.valueOf(this.value);
/*      */     }
/*      */     public long getLongValue() {
/*  764 */       return this.value;
/*      */     }
/*      */     public long setValue(long value) {
/*  767 */       long oldValue = this.value;
/*  768 */       this.value = value;
/*  769 */       return oldValue;
/*      */     }
/*      */     public Long setValue(Long value) {
/*  772 */       return Long.valueOf(setValue(value.longValue()));
/*      */     }
/*      */ 
...
/*  792 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     public int hashCode() {
/*  795 */       return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.long2int(this.value);
/*      */     }
