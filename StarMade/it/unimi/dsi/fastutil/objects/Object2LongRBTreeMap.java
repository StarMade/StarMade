  ...
  implements Serializable, Cloneable
{
  ...
  public Object2LongRBTreeMap(Comparator<? super K> local_c)
  {
    this();
  ...
  public Object2LongRBTreeMap(Map<? extends K, ? extends Long> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2LongRBTreeMap(SortedMap<K, Long> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2LongRBTreeMap(Object2LongMap<? extends K> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2LongRBTreeMap(Object2LongSortedMap<K> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2LongRBTreeMap(K[] local_k, long[] local_v, Comparator<? super K> local_c)
  {
    this(local_c);
  ...
  public Object2LongRBTreeMap(K[] local_k, long[] local_v)
  {
  ...
  {
    Object2LongRBTreeMap<K>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Object2LongMap.Entry<K>> comparator = new Comparator()
        {
          ...
          {
            return Object2LongRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Object2LongRBTreeMap.EntryIterator(Object2LongRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from)
        {
          return new Object2LongRBTreeMap.EntryIterator(Object2LongRBTreeMap.this, from.getKey());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Object2LongRBTreeMap.Entry<K> local_f = Object2LongRBTreeMap.this.findKey(local_e.getKey());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Object2LongRBTreeMap.Entry<K> local_f = Object2LongRBTreeMap.this.findKey(local_e.getKey());
          if (local_f != null) {
            Object2LongRBTreeMap.this.removeLong(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Object2LongRBTreeMap.this.subMap(from.getKey(), local_to.getKey()).object2LongEntrySet();
        }
        
        public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> local_to)
        {
          return Object2LongRBTreeMap.this.headMap(local_to.getKey()).object2LongEntrySet();
        }
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Object2LongRBTreeMap.ValueIterator(Object2LongRBTreeMap.this, null);
        }
        
        public boolean contains(long local_k)
        {
          return Object2LongRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Object2LongRBTreeMap<K> local_c;
    try
    {
      local_c = (Object2LongRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Object2LongRBTreeMap<K>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Object2LongRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Object2LongRBTreeMap<K>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Object2LongRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Object2LongRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Object2LongMap.Entry<K>> object2LongEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator()
          {
            return new Object2LongRBTreeMap.Submap.SubmapEntryIterator(Object2LongRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from)
          {
            return new Object2LongRBTreeMap.Submap.SubmapEntryIterator(Object2LongRBTreeMap.Submap.this, from.getKey());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<K, Long> local_e = (Map.Entry)local_o;
            Object2LongRBTreeMap.Entry<K> local_f = Object2LongRBTreeMap.this.findKey(local_e.getKey());
            return (local_f != null) && (Object2LongRBTreeMap.Submap.this.in5(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<K, Long> local_e = (Map.Entry)local_o;
            Object2LongRBTreeMap.Entry<K> local_f = Object2LongRBTreeMap.this.findKey(local_e.getKey());
            if ((local_f != null) && (Object2LongRBTreeMap.Submap.this.in5(local_f.key))) {
              Object2LongRBTreeMap.Submap.this.removeLong(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Object2LongRBTreeMap.Submap.SubmapIterator(Object2LongRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Object2LongRBTreeMap.Submap.this.clear();
          }
          
          public Object2LongMap.Entry<K> first()
          {
            return Object2LongRBTreeMap.Submap.this.firstEntry();
          }
          
          public Object2LongMap.Entry<K> last()
          {
            return Object2LongRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> from, Object2LongMap.Entry<K> local_to)
          {
            return Object2LongRBTreeMap.Submap.this.subMap(from.getKey(), local_to.getKey()).object2LongEntrySet();
          }
          
          public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> local_to)
          {
            return Object2LongRBTreeMap.Submap.this.headMap(local_to.getKey()).object2LongEntrySet();
          }
          
          public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> from)
          {
            return Object2LongRBTreeMap.Submap.this.tailMap(from.getKey()).object2LongEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public LongCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractLongCollection()
        {
          public LongIterator iterator()
          {
            return new Object2LongRBTreeMap.Submap.SubmapValueIterator(Object2LongRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(long local_k)
          {
            return Object2LongRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Object2LongRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(Object local_k)
    {
      return (in5(local_k)) && (Object2LongRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      K local_kk = local_k;
      Object2LongRBTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2LongRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public Long get(Object local_ok)
    {
      K local_kk = local_ok;
      Object2LongRBTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2LongRBTreeMap.this.findKey(local_kk)) != null) ? local_e.getValue() : null;
    }
    ...
    public long put(K local_k, long local_v)
    {
      ...
      long oldValue = Object2LongRBTreeMap.this.put(local_k, local_v);
    ...
    public long removeLong(Object local_k)
    {
      ...
      long oldValue = Object2LongRBTreeMap.this.removeLong(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Object2LongRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Object2LongRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Object2LongRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Object2LongSortedMap<K> tailMap(K from)
    {
      if (this.bottom) {
        return new Submap(Object2LongRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Object2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2LongRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Object2LongSortedMap<K> subMap(K from, K local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Object2LongRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Object2LongRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Object2LongRBTreeMap.Entry<K> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Object2LongRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Object2LongRBTreeMap.this.locateKey(this.from);
        if (Object2LongRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Object2LongRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Object2LongRBTreeMap.Entry<K> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Object2LongRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Object2LongRBTreeMap.this.locateKey(this.field_47);
        if (Object2LongRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Object2LongRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public K firstKey()
    {
      Object2LongRBTreeMap.Entry<K> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public K lastKey()
    {
      Object2LongRBTreeMap.Entry<K> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Object2LongRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Object2LongRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Object2LongRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator()
      {
        this();
        if (this.next != null) {
          if ((!Object2LongRBTreeMap.Submap.this.bottom) && (Object2LongRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Object2LongRBTreeMap.Submap.this.top) && (Object2LongRBTreeMap.this.compare(local_k, (this.prev = Object2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Object2LongRBTreeMap.this.locateKey(local_k);
            if (Object2LongRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Object2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2LongRBTreeMap.this.compare(this.prev.key, Object2LongRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Object2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Object2LongRBTreeMap.this.compare(this.next.key, Object2LongRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractObject2LongSortedMap.KeySet
    {
      ...
      {
        return new Object2LongRBTreeMap.Submap.SubmapKeyIterator(Object2LongRBTreeMap.Submap.this);
      }
      
      public ObjectBidirectionalIterator<K> iterator(K from)
      {
        return new Object2LongRBTreeMap.Submap.SubmapKeyIterator(Object2LongRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractObject2LongSortedMap.KeySet
  {
    ...
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new Object2LongRBTreeMap.KeyIterator(Object2LongRBTreeMap.this);
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new Object2LongRBTreeMap.KeyIterator(Object2LongRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    TreeIterator()
    {
      if ((this.next = Object2LongRBTreeMap.this.locateKey(local_k)) != null) {
        if (Object2LongRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
