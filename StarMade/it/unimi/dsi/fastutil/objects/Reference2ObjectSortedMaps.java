...
/* 223 */     public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.reference2ObjectEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() {
/* 225 */       return reference2ObjectEntrySet(); } 
...
/* 227 */     public Reference2ObjectSortedMap<K, V> subMap(K from, K to) { return new UnmodifiableSortedMap(this.sortedMap.subMap(from, to)); } 
/* 228 */     public Reference2ObjectSortedMap<K, V> headMap(K to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 229 */     public Reference2ObjectSortedMap<K, V> tailMap(K from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 189 */     public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.reference2ObjectEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() {
/* 191 */       return reference2ObjectEntrySet(); } 
...
/* 193 */     public Reference2ObjectSortedMap<K, V> subMap(K from, K to) { return new SynchronizedSortedMap(this.sortedMap.subMap(from, to), this.sync); } 
/* 194 */     public Reference2ObjectSortedMap<K, V> headMap(K to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 195 */     public Reference2ObjectSortedMap<K, V> tailMap(K from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Reference2ObjectMaps.Singleton.SingletonEntry(this), Reference2ObjectSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() { return reference2ObjectEntrySet(); } 
...
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Reference2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Reference2ObjectSortedMap<K, V> headMap(K to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Reference2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Reference2ObjectSortedMap<K, V> tailMap(K from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Reference2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
...
/*  76 */       return null;
/*     */     }
/*  78 */     public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<K, V>> entrySet() {
/*  80 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  82 */     public ReferenceSortedSet<K> keySet() { return ReferenceSortedSets.EMPTY_SET; } 
/*     */     public Reference2ObjectSortedMap<K, V> subMap(K from, K to) {
/*  84 */       return Reference2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*  86 */     public Reference2ObjectSortedMap<K, V> headMap(K to) { return Reference2ObjectSortedMaps.EMPTY_MAP; } 
/*     */     public Reference2ObjectSortedMap<K, V> tailMap(K from) {
/*  88 */       return Reference2ObjectSortedMaps.EMPTY_MAP; } 
