...
public abstract interface Reference2FloatMap<K> extends Reference2FloatFunction<K>, Map<K, Float>
{
  ...
  public static abstract interface Entry<K> extends Map.Entry<K, Float>
  {
  ...
  public static abstract interface FastEntrySet<K> extends ObjectSet<Reference2FloatMap.Entry<K>>
  {
