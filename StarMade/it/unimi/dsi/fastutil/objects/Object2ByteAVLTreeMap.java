  ...
  implements Serializable, Cloneable
{
  ...
  public Object2ByteAVLTreeMap(Comparator<? super K> local_c)
  {
    this();
  ...
  public Object2ByteAVLTreeMap(Map<? extends K, ? extends Byte> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2ByteAVLTreeMap(SortedMap<K, Byte> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2ByteAVLTreeMap(Object2ByteMap<? extends K> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2ByteAVLTreeMap(Object2ByteSortedMap<K> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2ByteAVLTreeMap(K[] local_k, byte[] local_v, Comparator<? super K> local_c)
  {
    this(local_c);
  ...
  public Object2ByteAVLTreeMap(K[] local_k, byte[] local_v)
  {
  ...
  {
    Object2ByteAVLTreeMap<K>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Object2ByteMap.Entry<K>> comparator = new Comparator()
        {
          ...
          {
            return Object2ByteAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Object2ByteAVLTreeMap.EntryIterator(Object2ByteAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator(Object2ByteMap.Entry<K> from)
        {
          return new Object2ByteAVLTreeMap.EntryIterator(Object2ByteAVLTreeMap.this, from.getKey());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Object2ByteAVLTreeMap.Entry<K> local_f = Object2ByteAVLTreeMap.this.findKey(local_e.getKey());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Object2ByteAVLTreeMap.Entry<K> local_f = Object2ByteAVLTreeMap.this.findKey(local_e.getKey());
          if (local_f != null) {
            Object2ByteAVLTreeMap.this.removeByte(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Object2ByteAVLTreeMap.this.subMap(from.getKey(), local_to.getKey()).object2ByteEntrySet();
        }
        
        public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> local_to)
        {
          return Object2ByteAVLTreeMap.this.headMap(local_to.getKey()).object2ByteEntrySet();
        }
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Object2ByteAVLTreeMap.ValueIterator(Object2ByteAVLTreeMap.this, null);
        }
        
        public boolean contains(byte local_k)
        {
          return Object2ByteAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Object2ByteAVLTreeMap<K> local_c;
    try
    {
      local_c = (Object2ByteAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Object2ByteAVLTreeMap<K>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Object2ByteAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Object2ByteAVLTreeMap<K>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Object2ByteAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Object2ByteAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Object2ByteMap.Entry<K>> object2ByteEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator()
          {
            return new Object2ByteAVLTreeMap.Submap.SubmapEntryIterator(Object2ByteAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Object2ByteMap.Entry<K>> iterator(Object2ByteMap.Entry<K> from)
          {
            return new Object2ByteAVLTreeMap.Submap.SubmapEntryIterator(Object2ByteAVLTreeMap.Submap.this, from.getKey());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<K, Byte> local_e = (Map.Entry)local_o;
            Object2ByteAVLTreeMap.Entry<K> local_f = Object2ByteAVLTreeMap.this.findKey(local_e.getKey());
            return (local_f != null) && (Object2ByteAVLTreeMap.Submap.this.in5(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<K, Byte> local_e = (Map.Entry)local_o;
            Object2ByteAVLTreeMap.Entry<K> local_f = Object2ByteAVLTreeMap.this.findKey(local_e.getKey());
            if ((local_f != null) && (Object2ByteAVLTreeMap.Submap.this.in5(local_f.key))) {
              Object2ByteAVLTreeMap.Submap.this.removeByte(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Object2ByteAVLTreeMap.Submap.SubmapIterator(Object2ByteAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Object2ByteAVLTreeMap.Submap.this.clear();
          }
          
          public Object2ByteMap.Entry<K> first()
          {
            return Object2ByteAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Object2ByteMap.Entry<K> last()
          {
            return Object2ByteAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Object2ByteMap.Entry<K>> subSet(Object2ByteMap.Entry<K> from, Object2ByteMap.Entry<K> local_to)
          {
            return Object2ByteAVLTreeMap.Submap.this.subMap(from.getKey(), local_to.getKey()).object2ByteEntrySet();
          }
          
          public ObjectSortedSet<Object2ByteMap.Entry<K>> headSet(Object2ByteMap.Entry<K> local_to)
          {
            return Object2ByteAVLTreeMap.Submap.this.headMap(local_to.getKey()).object2ByteEntrySet();
          }
          
          public ObjectSortedSet<Object2ByteMap.Entry<K>> tailSet(Object2ByteMap.Entry<K> from)
          {
            return Object2ByteAVLTreeMap.Submap.this.tailMap(from.getKey()).object2ByteEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ByteCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractByteCollection()
        {
          public ByteIterator iterator()
          {
            return new Object2ByteAVLTreeMap.Submap.SubmapValueIterator(Object2ByteAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(byte local_k)
          {
            return Object2ByteAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Object2ByteAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(Object local_k)
    {
      return (in5(local_k)) && (Object2ByteAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      K local_kk = local_k;
      Object2ByteAVLTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2ByteAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public Byte get(Object local_ok)
    {
      K local_kk = local_ok;
      Object2ByteAVLTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2ByteAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.getValue() : null;
    }
    ...
    public byte put(K local_k, byte local_v)
    {
      ...
      byte oldValue = Object2ByteAVLTreeMap.this.put(local_k, local_v);
    ...
    public byte removeByte(Object local_k)
    {
      ...
      byte oldValue = Object2ByteAVLTreeMap.this.removeByte(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Object2ByteAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Object2ByteAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Object2ByteAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Object2ByteSortedMap<K> tailMap(K from)
    {
      if (this.bottom) {
        return new Submap(Object2ByteAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Object2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2ByteAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Object2ByteSortedMap<K> subMap(K from, K local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Object2ByteAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Object2ByteAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Object2ByteAVLTreeMap.Entry<K> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Object2ByteAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Object2ByteAVLTreeMap.this.locateKey(this.from);
        if (Object2ByteAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Object2ByteAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Object2ByteAVLTreeMap.Entry<K> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Object2ByteAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Object2ByteAVLTreeMap.this.locateKey(this.field_47);
        if (Object2ByteAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Object2ByteAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public K firstKey()
    {
      Object2ByteAVLTreeMap.Entry<K> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public K lastKey()
    {
      Object2ByteAVLTreeMap.Entry<K> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Object2ByteAVLTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Object2ByteAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Object2ByteAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator()
      {
        this();
        if (this.next != null) {
          if ((!Object2ByteAVLTreeMap.Submap.this.bottom) && (Object2ByteAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Object2ByteAVLTreeMap.Submap.this.top) && (Object2ByteAVLTreeMap.this.compare(local_k, (this.prev = Object2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Object2ByteAVLTreeMap.this.locateKey(local_k);
            if (Object2ByteAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Object2ByteAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2ByteAVLTreeMap.this.compare(this.prev.key, Object2ByteAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Object2ByteAVLTreeMap.Submap.this.top) && (this.next != null) && (Object2ByteAVLTreeMap.this.compare(this.next.key, Object2ByteAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractObject2ByteSortedMap.KeySet
    {
      ...
      {
        return new Object2ByteAVLTreeMap.Submap.SubmapKeyIterator(Object2ByteAVLTreeMap.Submap.this);
      }
      
      public ObjectBidirectionalIterator<K> iterator(K from)
      {
        return new Object2ByteAVLTreeMap.Submap.SubmapKeyIterator(Object2ByteAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractObject2ByteSortedMap.KeySet
  {
    ...
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new Object2ByteAVLTreeMap.KeyIterator(Object2ByteAVLTreeMap.this);
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new Object2ByteAVLTreeMap.KeyIterator(Object2ByteAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    TreeIterator()
    {
      if ((this.next = Object2ByteAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Object2ByteAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
