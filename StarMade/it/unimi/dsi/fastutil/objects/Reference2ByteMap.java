...
public abstract interface Reference2ByteMap<K> extends Reference2ByteFunction<K>, Map<K, Byte>
{
  ...
  public static abstract interface Entry<K> extends Map.Entry<K, Byte>
  {
  ...
  public static abstract interface FastEntrySet<K> extends ObjectSet<Reference2ByteMap.Entry<K>>
  {
