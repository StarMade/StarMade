...
/*  16:    */
/*  86:    */public class Object2IntOpenHashMap<K>
/*  87:    */  extends AbstractObject2IntMap<K>
...
/* 100:    */  protected volatile transient Object2IntMap.FastEntrySet<K> entries;
/* 101:    */  protected volatile transient ObjectSet<K> keys;
/* 102:    */  protected volatile transient IntCollection values;
/* 103:    */  
/* 104:    */  public Object2IntOpenHashMap(int expected, float f)
/* 105:    */  {
...
/* 115:    */  }
/* 116:    */  
/* 119:    */  public Object2IntOpenHashMap(int expected)
/* 120:    */  {
/* 121:121 */    this(expected, 0.75F);
/* 122:    */  }
/* 123:    */  
/* 125:    */  public Object2IntOpenHashMap()
/* 126:    */  {
/* 127:127 */    this(16, 0.75F);
/* 128:    */  }
/* 129:    */  
/* 133:    */  public Object2IntOpenHashMap(Map<? extends K, ? extends Integer> m, float f)
/* 134:    */  {
/* 135:135 */    this(m.size(), f);
/* 136:136 */    putAll(m);
/* 137:    */  }
/* 138:    */  
/* 141:    */  public Object2IntOpenHashMap(Map<? extends K, ? extends Integer> m)
/* 142:    */  {
/* 143:143 */    this(m, 0.75F);
/* 144:    */  }
/* 145:    */  
/* 149:    */  public Object2IntOpenHashMap(Object2IntMap<K> m, float f)
/* 150:    */  {
/* 151:151 */    this(m.size(), f);
/* 152:152 */    putAll(m);
/* 153:    */  }
/* 154:    */  
/* 157:    */  public Object2IntOpenHashMap(Object2IntMap<K> m)
/* 158:    */  {
/* 159:159 */    this(m, 0.75F);
/* 160:    */  }
/* 161:    */  
/* 167:    */  public Object2IntOpenHashMap(K[] k, int[] v, float f)
/* 168:    */  {
...
/* 173:    */  }
/* 174:    */  
/* 178:    */  public Object2IntOpenHashMap(K[] k, int[] v)
/* 179:    */  {
...
/* 379:    */    implements Object2IntMap.Entry<K>, Map.Entry<K, Integer>
/* 380:    */  {
...
/* 386:    */    }
/* 387:    */    
/* 388:388 */    public K getKey() { return Object2IntOpenHashMap.this.key[this.index]; }
/* 389:    */    
/* 390:    */    public Integer getValue() {
/* 391:391 */      return Integer.valueOf(Object2IntOpenHashMap.this.value[this.index]);
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public int getIntValue() { return Object2IntOpenHashMap.this.value[this.index]; }
/* 395:    */    
/* 396:    */    public int setValue(int v) {
/* 397:397 */      int oldValue = Object2IntOpenHashMap.this.value[this.index];
/* 398:398 */      Object2IntOpenHashMap.this.value[this.index] = v;
...
/* 408:408 */      return (Object2IntOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2IntOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2IntOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/* 409:    */    }
/* 410:    */    
/* 411:411 */    public int hashCode() { return (Object2IntOpenHashMap.this.key[this.index] == null ? 0 : Object2IntOpenHashMap.this.key[this.index].hashCode()) ^ Object2IntOpenHashMap.this.value[this.index]; }
/* 412:    */    
/* 414:414 */    public String toString() { return Object2IntOpenHashMap.this.key[this.index] + "=>" + Object2IntOpenHashMap.this.value[this.index]; } }
/* 415:    */  
...
/* 420:    */    
/* 421:421 */    private MapIterator() { this.pos = Object2IntOpenHashMap.this.n;
/* 422:    */      
/* 424:424 */      this.last = -1;
/* 425:    */      
/* 426:426 */      this.c = Object2IntOpenHashMap.this.size;
/* 427:    */      
/* 431:431 */      boolean[] used = Object2IntOpenHashMap.this.used;
...
/* 443:    */        
/* 444:444 */        int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2IntOpenHashMap.this.mask;
/* 445:    */        
/* 446:446 */        while (Object2IntOpenHashMap.this.used[pos] != 0) {
/* 447:447 */          if (Object2IntOpenHashMap.this.key[pos] == null ? k == null : Object2IntOpenHashMap.this.key[pos].equals(k)) return pos;
/* 448:448 */          pos = pos + 1 & Object2IntOpenHashMap.this.mask;
/* 449:    */        }
/* 450:    */      }
/* 451:451 */      this.last = this.pos;
/* 452:    */      
/* 453:453 */      if (this.c != 0) {
/* 454:454 */        boolean[] used = Object2IntOpenHashMap.this.used;
...
/* 469:    */      for (;;)
/* 470:    */      {
/* 471:471 */        pos = (last = pos) + 1 & Object2IntOpenHashMap.this.mask;
/* 472:472 */        while (Object2IntOpenHashMap.this.used[pos] != 0) {
/* 473:473 */          int slot = (Object2IntOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2IntOpenHashMap.this.key[pos].hashCode())) & Object2IntOpenHashMap.this.mask;
/* 474:474 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 475:475 */          pos = pos + 1 & Object2IntOpenHashMap.this.mask;
/* 476:    */        }
/* 477:477 */        if (Object2IntOpenHashMap.this.used[pos] == 0) break;
/* 478:478 */        if (pos < last)
/* 479:    */        {
/* 480:480 */          if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 481:481 */          this.wrapped.add(Object2IntOpenHashMap.this.key[pos]);
/* 482:    */        }
/* 483:483 */        Object2IntOpenHashMap.this.key[last] = Object2IntOpenHashMap.this.key[pos];
/* 484:484 */        Object2IntOpenHashMap.this.value[last] = Object2IntOpenHashMap.this.value[pos];
/* 485:    */      }
/* 486:486 */      Object2IntOpenHashMap.this.used[last] = false;
/* 487:487 */      Object2IntOpenHashMap.this.key[last] = null;
/* 488:488 */      return last;
/* 489:    */    }
/* 490:    */    
...
/* 494:    */      {
/* 495:495 */        Object2IntOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 496:496 */        this.last = -1;
/* 497:497 */        return;
/* 498:    */      }
/* 499:499 */      Object2IntOpenHashMap.this.size -= 1;
...
/* 511:    */    } }
/* 512:    */  
/* 513:513 */  private class EntryIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> { private EntryIterator() { super(null); }
/* 514:    */    
/* 515:    */    private Object2IntOpenHashMap<K>.MapEntry entry;
/* 516:516 */    public Object2IntMap.Entry<K> next() { return this.entry = new Object2IntOpenHashMap.MapEntry(Object2IntOpenHashMap.this, nextEntry()); }
/* 517:    */    
/* 518:    */    public void remove()
/* 519:    */    {
/* 520:520 */      super.remove();
/* 521:521 */      Object2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 522:    */    } }
/* 523:    */  
/* 524:524 */  private class FastEntryIterator extends Object2IntOpenHashMap<K>.MapIterator implements ObjectIterator<Object2IntMap.Entry<K>> { private FastEntryIterator() { super(null); }
/* 525:525 */    final AbstractObject2IntMap.BasicEntry<K> entry = new AbstractObject2IntMap.BasicEntry(null, 0);
/* 526:    */    
/* 527:527 */    public AbstractObject2IntMap.BasicEntry<K> next() { int e = nextEntry();
/* 528:528 */      this.entry.key = Object2IntOpenHashMap.this.key[e];
/* 529:529 */      this.entry.value = Object2IntOpenHashMap.this.value[e];
/* 530:530 */      return this.entry;
/* 531:    */    } }
/* 532:    */  
/* 533:    */  private final class MapEntrySet extends AbstractObjectSet<Object2IntMap.Entry<K>> implements Object2IntMap.FastEntrySet<K> { private MapEntrySet() {}
/* 534:    */    
/* 535:535 */    public ObjectIterator<Object2IntMap.Entry<K>> iterator() { return new Object2IntOpenHashMap.EntryIterator(Object2IntOpenHashMap.this, null); }
/* 536:    */    
/* 537:    */    public ObjectIterator<Object2IntMap.Entry<K>> fastIterator() {
/* 538:538 */      return new Object2IntOpenHashMap.FastEntryIterator(Object2IntOpenHashMap.this, null);
/* 539:    */    }
/* 540:    */    
...
/* 545:    */      
/* 546:546 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2IntOpenHashMap.this.mask;
/* 547:    */      
/* 548:548 */      while (Object2IntOpenHashMap.this.used[pos] != 0) {
/* 549:549 */        if (Object2IntOpenHashMap.this.key[pos] == null ? k == null : Object2IntOpenHashMap.this.key[pos].equals(k)) return Object2IntOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 550:550 */        pos = pos + 1 & Object2IntOpenHashMap.this.mask;
/* 551:    */      }
...
/* 559:    */      
/* 560:560 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2IntOpenHashMap.this.mask;
/* 561:    */      
/* 562:562 */      while (Object2IntOpenHashMap.this.used[pos] != 0) {
/* 563:563 */        if (Object2IntOpenHashMap.this.key[pos] == null ? k == null : Object2IntOpenHashMap.this.key[pos].equals(k)) {
/* 564:564 */          Object2IntOpenHashMap.this.remove(e.getKey());
/* 565:565 */          return true;
/* 566:    */        }
/* 567:567 */        pos = pos + 1 & Object2IntOpenHashMap.this.mask;
/* 568:    */      }
/* 569:569 */      return false;
/* 570:    */    }
/* 571:    */    
/* 572:572 */    public int size() { return Object2IntOpenHashMap.this.size; }
/* 573:    */    
/* 575:575 */    public void clear() { Object2IntOpenHashMap.this.clear(); }
/* 576:    */  }
/* 577:    */  
/* 578:    */  public Object2IntMap.FastEntrySet<K> object2IntEntrySet() {
...
/* 586:    */    extends Object2IntOpenHashMap<K>.MapIterator
/* 587:    */    implements ObjectIterator<K>
/* 588:    */  {
/* 589:589 */    public KeyIterator() { super(null); }
/* 590:590 */    public K next() { return Object2IntOpenHashMap.this.key[nextEntry()]; } }
/* 591:    */  
/* 592:    */  private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/* 593:    */    
/* 594:594 */    public ObjectIterator<K> iterator() { return new Object2IntOpenHashMap.KeyIterator(Object2IntOpenHashMap.this); }
/* 595:    */    
/* 596:    */    public int size() {
/* 597:597 */      return Object2IntOpenHashMap.this.size;
/* 598:    */    }
/* 599:    */    
/* 600:600 */    public boolean contains(Object k) { return Object2IntOpenHashMap.this.containsKey(k); }
/* 601:    */    
/* 602:    */    public boolean remove(Object k) {
/* 603:603 */      int oldSize = Object2IntOpenHashMap.this.size;
/* 604:604 */      Object2IntOpenHashMap.this.remove(k);
/* 605:605 */      return Object2IntOpenHashMap.this.size != oldSize;
/* 606:    */    }
/* 607:    */    
/* 608:608 */    public void clear() { Object2IntOpenHashMap.this.clear(); }
/* 609:    */  }
/* 610:    */  
...
/* 619:    */    extends Object2IntOpenHashMap.MapIterator
/* 620:    */    implements IntIterator
/* 621:    */  {
/* 622:622 */    public ValueIterator() { super(null); }
/* 623:623 */    public int nextInt() { return Object2IntOpenHashMap.this.value[nextEntry()]; }
/* 624:624 */    public Integer next() { return Integer.valueOf(Object2IntOpenHashMap.this.value[nextEntry()]); }
/* 625:    */  }
/* 626:    */  
...
/* 629:629 */          return new Object2IntOpenHashMap.ValueIterator(Object2IntOpenHashMap.this);
/* 630:    */        }
/* 631:    */        
/* 632:632 */        public int size() { return Object2IntOpenHashMap.this.size; }
/* 633:    */        
/* 634:    */        public boolean contains(int v) {
/* 635:635 */          return Object2IntOpenHashMap.this.containsValue(v);
/* 636:    */        }
/* 637:    */        
/* 638:638 */        public void clear() { Object2IntOpenHashMap.this.clear(); }
/* 639:    */      };
/* 640:    */    }
...
/* 741:    */  }
/* 742:    */  
/* 746:    */  public Object2IntOpenHashMap<K> clone()
/* 747:    */  {
/* 748:    */    Object2IntOpenHashMap<K> c;
/* 749:    */    
/* 751:    */    try
/* 752:    */    {
/* 753:753 */      c = (Object2IntOpenHashMap)super.clone();
/* 754:    */    }
...
/* 790:790 */    Object2IntOpenHashMap<K>.MapIterator i = new MapIterator(null);
