...
/* 193 */     ReferenceBigArrayBigList l = new ReferenceBigArrayBigList(a, false);
/* 194 */     l.size = length;
/* 195 */     return l;
/*     */   }
/*     */ 
...
/* 258 */     for (long i = 0L; i < this.size; i += 1L) if (k == ObjectBigArrays.get(this.a, i)) return i;
/* 259 */     return -1L;
/*     */   }
/*     */   public long lastIndexOf(Object k) {
/* 262 */     for (long i = this.size; i-- != 0L; ) if (k == ObjectBigArrays.get(this.a, i)) return i;
/* 263 */     return -1L;
/*     */   }
...
/*     */ 
/* 375 */       public boolean hasNext() { return this.pos < ReferenceBigArrayBigList.this.size; } 
/* 376 */       public boolean hasPrevious() { return this.pos > 0; } 
/* 377 */       public K next() { if (!hasNext()) throw new NoSuchElementException(); return ObjectBigArrays.get(ReferenceBigArrayBigList.this.a, this.last = this.pos++); } 
/* 378 */       public K previous() { if (!hasPrevious()) throw new NoSuchElementException(); return ObjectBigArrays.get(ReferenceBigArrayBigList.this.a, this.last = --this.pos); } 
...
/* 383 */         ReferenceBigArrayBigList.this.add(this.pos++, k);
/* 384 */         this.last = -1;
/*     */       }
/*     */       public void set(K k) {
/* 387 */         if (this.last == -1) throw new IllegalStateException();
/* 388 */         ReferenceBigArrayBigList.this.set(this.last, k);
/*     */       }
/*     */       public void remove() {
/* 391 */         if (this.last == -1) throw new IllegalStateException();
/* 392 */         ReferenceBigArrayBigList.this.remove(this.last);
/*     */ 
...
/* 401 */     ReferenceBigArrayBigList c = new ReferenceBigArrayBigList(this.size);
...
/*     */   {
/* 415 */     if (l == this) return true;
/* 416 */     long s = size64();
/* 417 */     if (s != l.size64()) return false;
/* 418 */     Object[][] a1 = this.a;
/* 419 */     Object[][] a2 = l.a;
/* 420 */     while (s-- != 0L) if (ObjectBigArrays.get(a1, s) != ObjectBigArrays.get(a2, s)) return false;
/* 421 */     return true;
/*     */   }
/*     */   private void writeObject(ObjectOutputStream s) throws IOException {
/* 424 */     s.defaultWriteObject();
/* 425 */     for (int i = 0; i < this.size; i++) s.writeObject(ObjectBigArrays.get(this.a, i)); 
/*     */   }
/*     */ 
/*     */   private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 429 */     s.defaultReadObject();
/* 430 */     this.a = ((Object[][])ObjectBigArrays.newBigArray(this.size));
/* 431 */     for (int i = 0; i < this.size; i++) ObjectBigArrays.set(this.a, i, s.readObject());
/*     */   }
/*     */ }
