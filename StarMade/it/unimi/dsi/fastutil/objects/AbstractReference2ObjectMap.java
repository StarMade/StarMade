...
/*   8:    */
/*  60:    */public abstract class AbstractReference2ObjectMap<K, V>
/*  61:    */  extends AbstractReference2ObjectFunction<K, V>
/*  62:    */  implements Reference2ObjectMap<K, V>, Serializable
/*  63:    */{
...
/*  84: 84 */    if ((m instanceof Reference2ObjectMap))
/*  85:    */    {
/*  86: 86 */      while (n-- != 0) {
/*  87: 87 */        Reference2ObjectMap.Entry<? extends K, ? extends V> e = (Reference2ObjectMap.Entry)i.next();
...
/* 105:    */    implements Reference2ObjectMap.Entry<K, V>
/* 106:    */  {
/* 107:    */    protected K key;
/* 108:    */    
...
/* 129:129 */      return (this.key == e.getKey()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/* 130:    */    }
/* 131:    */    
/* 132:132 */    public int hashCode() { return (this.key == null ? 0 : System.identityHashCode(this.key)) ^ (this.value == null ? 0 : this.value.hashCode()); }
/* 133:    */    
...
/* 151:151 */      public boolean contains(Object k) { return AbstractReference2ObjectMap.this.containsKey(k); }
/* 152:152 */      public int size() { return AbstractReference2ObjectMap.this.size(); }
/* 153:153 */      public void clear() { AbstractReference2ObjectMap.this.clear(); }
/* 154:    */      
/* 155:155 */      public ObjectIterator<K> iterator() { new AbstractObjectIterator() {
/* 156:156 */          final ObjectIterator<Map.Entry<K, V>> i = AbstractReference2ObjectMap.this.entrySet().iterator();
/* 157:157 */          public K next() { return ((Reference2ObjectMap.Entry)this.i.next()).getKey(); }
...
/* 176:176 */      public boolean contains(Object k) { return AbstractReference2ObjectMap.this.containsValue(k); }
/* 177:177 */      public int size() { return AbstractReference2ObjectMap.this.size(); }
/* 178:178 */      public void clear() { AbstractReference2ObjectMap.this.clear(); }
/* 179:    */      
/* 180:180 */      public ObjectIterator<V> iterator() { new AbstractObjectIterator() {
/* 181:181 */          final ObjectIterator<Map.Entry<K, V>> i = AbstractReference2ObjectMap.this.entrySet().iterator();
/* 182:182 */          public V next() { return ((Reference2ObjectMap.Entry)this.i.next()).getValue(); }
...
/* 189:    */  {
/* 190:190 */    return reference2ObjectEntrySet();
/* 191:    */  }
/* 192:    */  
...
/* 220:220 */        s.append(", ");
/* 221:221 */      Reference2ObjectMap.Entry<K, V> e = (Reference2ObjectMap.Entry)i.next();
