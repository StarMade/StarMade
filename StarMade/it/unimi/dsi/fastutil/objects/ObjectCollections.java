...
{
  public static <K> ObjectCollection<K> synchronize(ObjectCollection<K> local_c)
  {
    return new SynchronizedCollection(local_c);
  }
  
  public static <K> ObjectCollection<K> synchronize(ObjectCollection<K> local_c, Object sync)
  {
    return new SynchronizedCollection(local_c, sync);
  }
  
  public static <K> ObjectCollection<K> unmodifiable(ObjectCollection<K> local_c)
  {
    ...
    implements ObjectCollection<K>, Serializable
  {
    ...
    protected UnmodifiableCollection(ObjectCollection<K> local_c)
    {
      if (local_c == null) {
        throw new NullPointerException();
      }
    ...
    implements ObjectCollection<K>, Serializable
  {
    ...
    protected SynchronizedCollection(ObjectCollection<K> local_c, Object sync)
    {
      if (local_c == null) {
        throw new NullPointerException();
      }
    ...
    protected SynchronizedCollection(ObjectCollection<K> local_c)
    {
      if (local_c == null) {
        throw new NullPointerException();
      }
