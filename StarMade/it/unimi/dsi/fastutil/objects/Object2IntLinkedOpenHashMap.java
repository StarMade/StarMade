...
/*  774 */   public Object2IntSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  775 */   public Object2IntSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  776 */   public Object2IntSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1092 */           return new Object2IntLinkedOpenHashMap.ValueIterator(Object2IntLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1095 */           return Object2IntLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(int v) {
/* 1098 */           return Object2IntLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1101 */           Object2IntLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1234 */       c = (Object2IntLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2IntLinkedOpenHashMap.MapIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public int previousInt()
/*      */     {
/* 1079 */       return Object2IntLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1080 */     public Integer previous() { return Integer.valueOf(Object2IntLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1086 */     public int nextInt() { return Object2IntLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1087 */     public Integer next() { return Integer.valueOf(Object2IntLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1036 */       return new Object2IntLinkedOpenHashMap.KeyIterator(Object2IntLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1039 */       return new Object2IntLinkedOpenHashMap.KeyIterator(Object2IntLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1042 */       return Object2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1045 */       return Object2IntLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1048 */       int oldSize = Object2IntLinkedOpenHashMap.this.size;
/* 1049 */       Object2IntLinkedOpenHashMap.this.remove(k);
/* 1050 */       return Object2IntLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1053 */       Object2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1056 */       if (Object2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057 */       return Object2IntLinkedOpenHashMap.this.key[Object2IntLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1060 */       if (Object2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061 */       return Object2IntLinkedOpenHashMap.this.key[Object2IntLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2IntLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1027 */       super(k, null); } 
/* 1028 */     public K previous() { return Object2IntLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1032 */     public K next() { return Object2IntLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  955 */       return new Object2IntLinkedOpenHashMap.EntryIterator(Object2IntLinkedOpenHashMap.this);
/*      */     }
/*  957 */     public Comparator<? super Object2IntMap.Entry<K>> comparator() { return null; } 
/*  958 */     public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> fromElement, Object2IntMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  959 */     public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  960 */     public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(Object2IntMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Object2IntMap.Entry<K> first() {
/*  962 */       if (Object2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963 */       return new Object2IntLinkedOpenHashMap.MapEntry(Object2IntLinkedOpenHashMap.this, Object2IntLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Object2IntMap.Entry<K> last() {
/*  966 */       if (Object2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967 */       return new Object2IntLinkedOpenHashMap.MapEntry(Object2IntLinkedOpenHashMap.this, Object2IntLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  975 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2IntLinkedOpenHashMap.this.mask;
/*      */ 
/*  977 */       while (Object2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  978 */         if (Object2IntLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2IntLinkedOpenHashMap.this.key[pos].equals(k)) return Object2IntLinkedOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/*  979 */         pos = pos + 1 & Object2IntLinkedOpenHashMap.this.mask;
/*      */       }
/*  981 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  989 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2IntLinkedOpenHashMap.this.mask;
/*      */ 
/*  991 */       while (Object2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  992 */         if (Object2IntLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2IntLinkedOpenHashMap.this.key[pos].equals(k)) {
/*  993 */           Object2IntLinkedOpenHashMap.this.remove(e.getKey());
/*  994 */           return true;
/*      */         }
/*  996 */         pos = pos + 1 & Object2IntLinkedOpenHashMap.this.mask;
/*      */       }
/*  998 */       return false;
/*      */     }
/*      */     public int size() {
/* 1001 */       return Object2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1004 */       Object2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> iterator(Object2IntMap.Entry<K> from) {
/* 1007 */       return new Object2IntLinkedOpenHashMap.EntryIterator(Object2IntLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> fastIterator() {
/* 1010 */       return new Object2IntLinkedOpenHashMap.FastEntryIterator(Object2IntLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> fastIterator(Object2IntMap.Entry<K> from) {
/* 1013 */       return new Object2IntLinkedOpenHashMap.FastEntryIterator(Object2IntLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Object2IntLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2IntMap.Entry<K>>
/*      */   {
/*  933 */     final AbstractObject2IntMap.BasicEntry<K> entry = new AbstractObject2IntMap.BasicEntry(null, 0);
/*      */ 
...
/*  939 */       int e = nextEntry();
/*  940 */       this.entry.key = Object2IntLinkedOpenHashMap.this.key[e];
/*  941 */       this.entry.value = Object2IntLinkedOpenHashMap.this.value[e];
/*  942 */       return this.entry;
/*      */     }
/*      */     public AbstractObject2IntMap.BasicEntry<K> previous() {
/*  945 */       int e = previousEntry();
/*  946 */       this.entry.key = Object2IntLinkedOpenHashMap.this.key[e];
/*  947 */       this.entry.value = Object2IntLinkedOpenHashMap.this.value[e];
/*  948 */       return this.entry;
/*      */     }
/*  950 */     public void set(Object2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  951 */     public void add(Object2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2IntLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2IntMap.Entry<K>>
/*      */   {
...
/*  919 */       return this.entry = new Object2IntLinkedOpenHashMap.MapEntry(Object2IntLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Object2IntLinkedOpenHashMap<K>.MapEntry previous() {
/*  922 */       return this.entry = new Object2IntLinkedOpenHashMap.MapEntry(Object2IntLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  926 */       super.remove();
/*  927 */       Object2IntLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  929 */     public void set(Object2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  930 */     public void add(Object2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  791 */     int index = -1;
/*      */ 
/*  793 */     private MapIterator() { this.next = Object2IntLinkedOpenHashMap.this.first;
/*  794 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  797 */       if (Object2IntLinkedOpenHashMap.this.key[Object2IntLinkedOpenHashMap.this.last] == null ? from == null : Object2IntLinkedOpenHashMap.this.key[Object2IntLinkedOpenHashMap.this.last].equals(from)) {
/*  798 */         this.prev = Object2IntLinkedOpenHashMap.this.last;
/*  799 */         this.index = Object2IntLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  803 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2IntLinkedOpenHashMap.this.mask;
/*      */ 
/*  805 */         while (Object2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  806 */           if (Object2IntLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2IntLinkedOpenHashMap.this.key[pos].equals(from))
/*      */           {
/*  808 */             this.next = ((int)Object2IntLinkedOpenHashMap.this.link[pos]);
/*  809 */             this.prev = pos;
/*  810 */             return;
/*      */           }
/*  812 */           pos = pos + 1 & Object2IntLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  825 */       if (this.next == -1) {
/*  826 */         this.index = Object2IntLinkedOpenHashMap.this.size;
/*  827 */         return;
/*      */       }
/*  829 */       int pos = Object2IntLinkedOpenHashMap.this.first;
/*  830 */       this.index = 1;
/*  831 */       while (pos != this.prev) {
/*  832 */         pos = (int)Object2IntLinkedOpenHashMap.this.link[pos];
/*  833 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  845 */       if (!hasNext()) return Object2IntLinkedOpenHashMap.this.size();
/*  846 */       this.curr = this.next;
/*  847 */       this.next = ((int)Object2IntLinkedOpenHashMap.this.link[this.curr]);
...
/*  855 */       this.prev = ((int)(Object2IntLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  867 */         this.index -= 1;
/*  868 */         this.prev = ((int)(Object2IntLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  871 */         this.next = ((int)Object2IntLinkedOpenHashMap.this.link[this.curr]);
/*  872 */       }Object2IntLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  875 */       if (this.prev == -1) Object2IntLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  877 */         Object2IntLinkedOpenHashMap.this.link[this.prev] ^= (Object2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878 */       if (this.next == -1) Object2IntLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  880 */         Object2IntLinkedOpenHashMap.this.link[this.next] ^= (Object2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  884 */         pos = (last = pos) + 1 & Object2IntLinkedOpenHashMap.this.mask;
/*  885 */         while (Object2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */           int slot = (Object2IntLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2IntLinkedOpenHashMap.this.key[pos].hashCode())) & Object2IntLinkedOpenHashMap.this.mask;
/*  887 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888 */           pos = pos + 1 & Object2IntLinkedOpenHashMap.this.mask;
/*      */         }
/*  890 */         if (Object2IntLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891 */         Object2IntLinkedOpenHashMap.this.key[last] = Object2IntLinkedOpenHashMap.this.key[pos];
/*  892 */         Object2IntLinkedOpenHashMap.this.value[last] = Object2IntLinkedOpenHashMap.this.value[pos];
/*  893 */         if (this.next == pos) this.next = last;
/*  894 */         if (this.prev == pos) this.prev = last;
/*  895 */         Object2IntLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  897 */       Object2IntLinkedOpenHashMap.this.used[last] = false;
/*  898 */       Object2IntLinkedOpenHashMap.this.key[last] = null;
/*  899 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  660 */       return Object2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Integer getValue() {
/*  663 */       return Integer.valueOf(Object2IntLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public int getIntValue() {
/*  666 */       return Object2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public int setValue(int v) {
/*  669 */       int oldValue = Object2IntLinkedOpenHashMap.this.value[this.index];
/*  670 */       Object2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  671 */       return oldValue;
/*      */     }
...
/*  680 */       return (Object2IntLinkedOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2IntLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */     public int hashCode() {
/*  683 */       return (Object2IntLinkedOpenHashMap.this.key[this.index] == null ? 0 : Object2IntLinkedOpenHashMap.this.key[this.index].hashCode()) ^ Object2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  686 */       return Object2IntLinkedOpenHashMap.this.key[this.index] + "=>" + Object2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
