  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2IntLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Object2IntLinkedOpenHashMap(Map<? extends K, ? extends Integer> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2IntLinkedOpenHashMap(Map<? extends K, ? extends Integer> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2IntLinkedOpenHashMap(Object2IntMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2IntLinkedOpenHashMap(Object2IntMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2IntLinkedOpenHashMap(K[] local_k, int[] local_v, float local_f)
  {
  ...
  public Object2IntLinkedOpenHashMap(K[] local_k, int[] local_v)
  {
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Object2IntLinkedOpenHashMap.ValueIterator(Object2IntLinkedOpenHashMap.this);
        }
        ...
        {
          return Object2IntLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2IntLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Object2IntLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    int[] value = this.value;
    Object2IntLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2IntLinkedOpenHashMap.MapIterator
    ...
    extends AbstractObjectSortedSet<K>
  {
    ...
    {
      return new Object2IntLinkedOpenHashMap.KeyIterator(Object2IntLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Object2IntLinkedOpenHashMap.KeyIterator(Object2IntLinkedOpenHashMap.this);
    }
    ...
    {
      return Object2IntLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2IntLinkedOpenHashMap.this.size;
      Object2IntLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Object2IntSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Object2IntLinkedOpenHashMap.EntryIterator(Object2IntLinkedOpenHashMap.this);
    }
    ...
    public Object2IntMap.Entry<K> first()
    {
      ...
      return new Object2IntLinkedOpenHashMap.MapEntry(Object2IntLinkedOpenHashMap.this, Object2IntLinkedOpenHashMap.this.first);
    }
    ...
    public Object2IntMap.Entry<K> last()
    {
      ...
      return new Object2IntLinkedOpenHashMap.MapEntry(Object2IntLinkedOpenHashMap.this, Object2IntLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2IntLinkedOpenHashMap.this.mask; Object2IntLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2IntLinkedOpenHashMap.this.mask) {
        if (Object2IntLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2IntLinkedOpenHashMap.this.key[pos].equals(local_k)) {
          return Object2IntLinkedOpenHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2IntLinkedOpenHashMap.this.mask; Object2IntLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2IntLinkedOpenHashMap.this.mask) {
        if (Object2IntLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2IntLinkedOpenHashMap.this.key[pos].equals(local_k))
        {
          Object2IntLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Object2IntLinkedOpenHashMap.EntryIterator(Object2IntLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> fastIterator()
    {
      return new Object2IntLinkedOpenHashMap.FastEntryIterator(Object2IntLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> fastIterator(Object2IntMap.Entry<K> from)
    {
      return new Object2IntLinkedOpenHashMap.FastEntryIterator(Object2IntLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Object2IntMap.Entry<K>>
  {
    ...
    public AbstractObject2IntMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2IntLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Object2IntLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Object2IntMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2IntLinkedOpenHashMap.MapEntry(Object2IntLinkedOpenHashMap.this, nextEntry());
    }
    
    public Object2IntLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Object2IntLinkedOpenHashMap.MapEntry(Object2IntLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2IntLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2IntLinkedOpenHashMap.this.mask; Object2IntLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2IntLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Object2IntLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Object2IntLinkedOpenHashMap.this.first = this.next;
      } else {
        Object2IntLinkedOpenHashMap.this.link[this.prev] ^= (Object2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Object2IntLinkedOpenHashMap.this.last = this.prev;
      } else {
        Object2IntLinkedOpenHashMap.this.link[this.next] ^= (Object2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2IntLinkedOpenHashMap.this.mask; Object2IntLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2IntLinkedOpenHashMap.this.mask)
        {
        ...
        if (Object2IntLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Object2IntMap.Entry<K>, Map.Entry<K, Integer>
  {
    ...
    public int setValue(int local_v)
    {
      ...
      Object2IntLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Integer> local_e = (Map.Entry)local_o;
      return (Object2IntLinkedOpenHashMap.this.key[this.index] == null ? local_e.getKey() == null : Object2IntLinkedOpenHashMap.this.key[this.index].equals(local_e.getKey())) && (Object2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
