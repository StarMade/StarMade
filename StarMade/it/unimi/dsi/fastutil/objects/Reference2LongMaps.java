...
/*  12:    */
/*  58:    */public class Reference2LongMaps
/*  59:    */{
/*  60:    */  public static class EmptyMap<K>
/*  61:    */    extends Reference2LongFunctions.EmptyFunction<K>
/*  62:    */    implements Reference2LongMap<K>, Serializable, Cloneable
/*  63:    */  {
...
/*  68:    */    
/*  69: 69 */    public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() { return ObjectSets.EMPTY_SET; }
/*  70:    */    
...
/*  75: 75 */    private Object readResolve() { return Reference2LongMaps.EMPTY_MAP; }
/*  76: 76 */    public Object clone() { return Reference2LongMaps.EMPTY_MAP; }
/*  77: 77 */    public boolean isEmpty() { return true; }
/*  78:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<K, Long>> entrySet() { return reference2LongEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Reference2LongFunctions.Singleton<K>
/* 103:    */    implements Reference2LongMap<K>, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Reference2LongMap.Entry<K>> entries;
/* 108:    */    
...
/* 125:    */    
/* 126:126 */    public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Reference2LongMap.Entry<K>, Map.Entry<K, Long> { protected SingletonEntry() {}
/* 131:131 */      public K getKey() { return Reference2LongMaps.Singleton.this.key; }
/* 132:132 */      public Long getValue() { return Long.valueOf(Reference2LongMaps.Singleton.this.value); }
/* 133:    */      
/* 139:139 */      public long getLongValue() { return Reference2LongMaps.Singleton.this.value; }
...
/* 148:    */        
/* 149:149 */        return (Reference2LongMaps.Singleton.this.key == e.getKey()) && (Reference2LongMaps.Singleton.this.value == ((Long)e.getValue()).longValue());
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return (Reference2LongMaps.Singleton.this.key == null ? 0 : System.identityHashCode(Reference2LongMaps.Singleton.this.key)) ^ HashCommon.long2int(Reference2LongMaps.Singleton.this.value); }
/* 153:153 */      public String toString() { return Reference2LongMaps.Singleton.this.key + "->" + Reference2LongMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<K, Long>> entrySet() { return reference2LongEntrySet(); }
/* 160:    */    
/* 161:161 */    public int hashCode() { return (this.key == null ? 0 : System.identityHashCode(this.key)) ^ HashCommon.long2int(this.value); }
/* 162:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static <K> Reference2LongMap<K> singleton(K key, long value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static <K> Reference2LongMap<K> singleton(K key, Long value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key, value.longValue());
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap<K>
/* 205:    */    extends Reference2LongFunctions.SynchronizedFunction<K>
/* 206:    */    implements Reference2LongMap<K>, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Reference2LongMap<K> map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Reference2LongMap.Entry<K>> entries;
/* 213:    */    
/* 214:    */    protected volatile transient ReferenceSet<K> keys;
/* 215:    */    protected volatile transient LongCollection values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Reference2LongMap<K> m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Reference2LongMap<K> m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 239:    */    
/* 240:240 */    public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2LongEntrySet(), this.sync); return this.entries; }
...
/* 258:    */  }
/* 259:    */  
/* 261:    */  public static <K> Reference2LongMap<K> synchronize(Reference2LongMap<K> m)
/* 262:    */  {
/* 263:263 */    return new SynchronizedMap(m);
/* 264:    */  }
/* 265:    */  
/* 271:271 */  public static <K> Reference2LongMap<K> synchronize(Reference2LongMap<K> m, Object sync) { return new SynchronizedMap(m, sync); }
/* 272:    */  
/* 273:    */  public static class UnmodifiableMap<K> extends Reference2LongFunctions.UnmodifiableFunction<K> implements Reference2LongMap<K>, Serializable {
/* 274:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 275:    */    protected final Reference2LongMap<K> map;
/* 276:    */    protected volatile transient ObjectSet<Reference2LongMap.Entry<K>> entries;
/* 277:    */    protected volatile transient ReferenceSet<K> keys;
/* 278:    */    protected volatile transient LongCollection values;
/* 279:    */    
/* 280:280 */    protected UnmodifiableMap(Reference2LongMap<K> m) { super();
/* 281:281 */      this.map = m; }
/* 282:    */    
...
/* 291:291 */    public ObjectSet<Reference2LongMap.Entry<K>> reference2LongEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.reference2LongEntrySet()); return this.entries; }
...
/* 301:    */  }
/* 302:    */  
/* 306:    */  public static <K> Reference2LongMap<K> unmodifiable(Reference2LongMap<K> m)
/* 307:    */  {
