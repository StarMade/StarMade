...
/* 291 */     public ObjectSet<Object2IntMap.Entry<K>> object2IntEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2IntEntrySet()); return this.entries; } 
...
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2IntEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Object2IntMap.Entry<K>> object2IntEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Object2IntMaps.Singleton.this.key; } 
/* 132 */       public Integer getValue() { return Integer.valueOf(Object2IntMaps.Singleton.this.value); }
/*     */ 
/*     */ 
/*     */       public int getIntValue()
/*     */       {
/* 139 */         return Object2IntMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Object2IntMaps.Singleton.this.key == null ? e.getKey() == null : Object2IntMaps.Singleton.this.key.equals(e.getKey())) && (Object2IntMaps.Singleton.this.value == ((Integer)e.getValue()).intValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return (Object2IntMaps.Singleton.this.key == null ? 0 : Object2IntMaps.Singleton.this.key.hashCode()) ^ Object2IntMaps.Singleton.this.value; } 
/* 153 */       public String toString() { return Object2IntMaps.Singleton.this.key + "->" + Object2IntMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*  75 */     private Object readResolve() { return Object2IntMaps.EMPTY_MAP; } 
/*  76 */     public Object clone() { return Object2IntMaps.EMPTY_MAP; } 
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, Integer>> entrySet() {
/*  80 */       return object2IntEntrySet();
/*     */     }
