...
/*  11:    */
/*  58:    */public class Reference2BooleanMaps
/*  59:    */{
/*  60:    */  public static class EmptyMap<K>
/*  61:    */    extends Reference2BooleanFunctions.EmptyFunction<K>
/*  62:    */    implements Reference2BooleanMap<K>, Serializable, Cloneable
/*  63:    */  {
...
/*  68:    */    
/*  69: 69 */    public ObjectSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() { return ObjectSets.EMPTY_SET; }
/*  70:    */    
...
/*  75: 75 */    private Object readResolve() { return Reference2BooleanMaps.EMPTY_MAP; }
/*  76: 76 */    public Object clone() { return Reference2BooleanMaps.EMPTY_MAP; }
/*  77: 77 */    public boolean isEmpty() { return true; }
/*  78:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<K, Boolean>> entrySet() { return reference2BooleanEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Reference2BooleanFunctions.Singleton<K>
/* 103:    */    implements Reference2BooleanMap<K>, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Reference2BooleanMap.Entry<K>> entries;
/* 108:    */    
...
/* 125:    */    
/* 126:126 */    public ObjectSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Reference2BooleanMap.Entry<K>, Map.Entry<K, Boolean> { protected SingletonEntry() {}
/* 131:131 */      public K getKey() { return Reference2BooleanMaps.Singleton.this.key; }
/* 132:132 */      public Boolean getValue() { return Boolean.valueOf(Reference2BooleanMaps.Singleton.this.value); }
/* 133:    */      
/* 139:139 */      public boolean getBooleanValue() { return Reference2BooleanMaps.Singleton.this.value; }
...
/* 148:    */        
/* 149:149 */        return (Reference2BooleanMaps.Singleton.this.key == e.getKey()) && (Reference2BooleanMaps.Singleton.this.value == ((Boolean)e.getValue()).booleanValue());
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return (Reference2BooleanMaps.Singleton.this.key == null ? 0 : System.identityHashCode(Reference2BooleanMaps.Singleton.this.key)) ^ (Reference2BooleanMaps.Singleton.this.value ? 1231 : 1237); }
/* 153:153 */      public String toString() { return Reference2BooleanMaps.Singleton.this.key + "->" + Reference2BooleanMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<K, Boolean>> entrySet() { return reference2BooleanEntrySet(); }
/* 160:    */    
/* 161:161 */    public int hashCode() { return (this.key == null ? 0 : System.identityHashCode(this.key)) ^ (this.value ? 1231 : 1237); }
/* 162:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static <K> Reference2BooleanMap<K> singleton(K key, boolean value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static <K> Reference2BooleanMap<K> singleton(K key, Boolean value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key, value.booleanValue());
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap<K>
/* 205:    */    extends Reference2BooleanFunctions.SynchronizedFunction<K>
/* 206:    */    implements Reference2BooleanMap<K>, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Reference2BooleanMap<K> map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Reference2BooleanMap.Entry<K>> entries;
/* 213:    */    
/* 214:    */    protected volatile transient ReferenceSet<K> keys;
/* 215:    */    protected volatile transient BooleanCollection values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Reference2BooleanMap<K> m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Reference2BooleanMap<K> m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 239:    */    
/* 240:240 */    public ObjectSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2BooleanEntrySet(), this.sync); return this.entries; }
...
/* 258:    */  }
/* 259:    */  
/* 261:    */  public static <K> Reference2BooleanMap<K> synchronize(Reference2BooleanMap<K> m)
/* 262:    */  {
/* 263:263 */    return new SynchronizedMap(m);
/* 264:    */  }
/* 265:    */  
/* 271:271 */  public static <K> Reference2BooleanMap<K> synchronize(Reference2BooleanMap<K> m, Object sync) { return new SynchronizedMap(m, sync); }
/* 272:    */  
/* 273:    */  public static class UnmodifiableMap<K> extends Reference2BooleanFunctions.UnmodifiableFunction<K> implements Reference2BooleanMap<K>, Serializable {
/* 274:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 275:    */    protected final Reference2BooleanMap<K> map;
/* 276:    */    protected volatile transient ObjectSet<Reference2BooleanMap.Entry<K>> entries;
/* 277:    */    protected volatile transient ReferenceSet<K> keys;
/* 278:    */    protected volatile transient BooleanCollection values;
/* 279:    */    
/* 280:280 */    protected UnmodifiableMap(Reference2BooleanMap<K> m) { super();
/* 281:281 */      this.map = m; }
/* 282:    */    
...
/* 291:291 */    public ObjectSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.reference2BooleanEntrySet()); return this.entries; }
...
/* 301:    */  }
/* 302:    */  
/* 306:    */  public static <K> Reference2BooleanMap<K> unmodifiable(Reference2BooleanMap<K> m)
/* 307:    */  {
