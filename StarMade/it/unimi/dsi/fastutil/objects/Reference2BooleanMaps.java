...
/* 291 */     public ObjectSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.reference2BooleanEntrySet()); return this.entries; } 
...
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2BooleanEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Reference2BooleanMap.Entry<K>> reference2BooleanEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return reference2BooleanEntrySet();
/*     */     }
/* 161 */     public int hashCode() { return (this.key == null ? 0 : System.identityHashCode(this.key)) ^ (this.value ? 1231 : 1237); }
/*     */ 
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Reference2BooleanMaps.Singleton.this.key; } 
/* 132 */       public Boolean getValue() { return Boolean.valueOf(Reference2BooleanMaps.Singleton.this.value); }
/*     */ 
/*     */ 
/*     */       public boolean getBooleanValue()
/*     */       {
/* 139 */         return Reference2BooleanMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Reference2BooleanMaps.Singleton.this.key == e.getKey()) && (Reference2BooleanMaps.Singleton.this.value == ((Boolean)e.getValue()).booleanValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return (Reference2BooleanMaps.Singleton.this.key == null ? 0 : System.identityHashCode(Reference2BooleanMaps.Singleton.this.key)) ^ (Reference2BooleanMaps.Singleton.this.value ? 1231 : 1237); } 
/* 153 */       public String toString() { return Reference2BooleanMaps.Singleton.this.key + "->" + Reference2BooleanMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*  75 */     private Object readResolve() { return Reference2BooleanMaps.EMPTY_MAP; } 
/*  76 */     public Object clone() { return Reference2BooleanMaps.EMPTY_MAP; } 
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, Boolean>> entrySet() {
/*  80 */       return reference2BooleanEntrySet();
/*     */     }
