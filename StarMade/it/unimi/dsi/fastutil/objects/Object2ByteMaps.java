...
/* 291 */     public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2ByteEntrySet()); return this.entries; } 
...
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2ByteEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Object2ByteMap.Entry<K>> object2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return object2ByteEntrySet();
/*     */     }
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Object2ByteMaps.Singleton.this.key; } 
/* 132 */       public Byte getValue() { return Byte.valueOf(Object2ByteMaps.Singleton.this.value); }
/*     */ 
/*     */ 
/*     */       public byte getByteValue()
/*     */       {
/* 139 */         return Object2ByteMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Object2ByteMaps.Singleton.this.key == null ? e.getKey() == null : Object2ByteMaps.Singleton.this.key.equals(e.getKey())) && (Object2ByteMaps.Singleton.this.value == ((Byte)e.getValue()).byteValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return (Object2ByteMaps.Singleton.this.key == null ? 0 : Object2ByteMaps.Singleton.this.key.hashCode()) ^ Object2ByteMaps.Singleton.this.value; } 
/* 153 */       public String toString() { return Object2ByteMaps.Singleton.this.key + "->" + Object2ByteMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*  75 */     private Object readResolve() { return Object2ByteMaps.EMPTY_MAP; } 
/*  76 */     public Object clone() { return Object2ByteMaps.EMPTY_MAP; } 
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, Byte>> entrySet() {
/*  80 */       return object2ByteEntrySet();
/*     */     }
