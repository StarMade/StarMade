...
/* 291 */     public ObjectSet<Object2LongMap.Entry<K>> object2LongEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2LongEntrySet()); return this.entries; } 
...
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2LongEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Object2LongMap.Entry<K>> object2LongEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return object2LongEntrySet();
/*     */     }
/* 161 */     public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.long2int(this.value); }
/*     */ 
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Object2LongMaps.Singleton.this.key; } 
/* 132 */       public Long getValue() { return Long.valueOf(Object2LongMaps.Singleton.this.value); }
/*     */ 
/*     */ 
/*     */       public long getLongValue()
/*     */       {
/* 139 */         return Object2LongMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Object2LongMaps.Singleton.this.key == null ? e.getKey() == null : Object2LongMaps.Singleton.this.key.equals(e.getKey())) && (Object2LongMaps.Singleton.this.value == ((Long)e.getValue()).longValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return (Object2LongMaps.Singleton.this.key == null ? 0 : Object2LongMaps.Singleton.this.key.hashCode()) ^ HashCommon.long2int(Object2LongMaps.Singleton.this.value); } 
/* 153 */       public String toString() { return Object2LongMaps.Singleton.this.key + "->" + Object2LongMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*  75 */     private Object readResolve() { return Object2LongMaps.EMPTY_MAP; } 
/*  76 */     public Object clone() { return Object2LongMaps.EMPTY_MAP; } 
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, Long>> entrySet() {
/*  80 */       return object2LongEntrySet();
/*     */     }
