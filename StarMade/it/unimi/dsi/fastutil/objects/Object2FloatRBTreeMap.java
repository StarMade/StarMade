  ...
  implements Serializable, Cloneable
{
  ...
  public Object2FloatRBTreeMap(Comparator<? super K> local_c)
  {
    this();
  ...
  public Object2FloatRBTreeMap(Map<? extends K, ? extends Float> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2FloatRBTreeMap(SortedMap<K, Float> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2FloatRBTreeMap(Object2FloatMap<? extends K> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2FloatRBTreeMap(Object2FloatSortedMap<K> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2FloatRBTreeMap(K[] local_k, float[] local_v, Comparator<? super K> local_c)
  {
    this(local_c);
  ...
  public Object2FloatRBTreeMap(K[] local_k, float[] local_v)
  {
  ...
  {
    Object2FloatRBTreeMap<K>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Object2FloatMap.Entry<K>> comparator = new Comparator()
        {
          ...
          {
            return Object2FloatRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Object2FloatRBTreeMap.EntryIterator(Object2FloatRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> from)
        {
          return new Object2FloatRBTreeMap.EntryIterator(Object2FloatRBTreeMap.this, from.getKey());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Object2FloatRBTreeMap.Entry<K> local_f = Object2FloatRBTreeMap.this.findKey(local_e.getKey());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Object2FloatRBTreeMap.Entry<K> local_f = Object2FloatRBTreeMap.this.findKey(local_e.getKey());
          if (local_f != null) {
            Object2FloatRBTreeMap.this.removeFloat(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Object2FloatRBTreeMap.this.subMap(from.getKey(), local_to.getKey()).object2FloatEntrySet();
        }
        
        public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> local_to)
        {
          return Object2FloatRBTreeMap.this.headMap(local_to.getKey()).object2FloatEntrySet();
        }
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Object2FloatRBTreeMap.ValueIterator(Object2FloatRBTreeMap.this, null);
        }
        
        public boolean contains(float local_k)
        {
          return Object2FloatRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Object2FloatRBTreeMap<K> local_c;
    try
    {
      local_c = (Object2FloatRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Object2FloatRBTreeMap<K>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Object2FloatRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Object2FloatRBTreeMap<K>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Object2FloatRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Object2FloatRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator()
          {
            return new Object2FloatRBTreeMap.Submap.SubmapEntryIterator(Object2FloatRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> from)
          {
            return new Object2FloatRBTreeMap.Submap.SubmapEntryIterator(Object2FloatRBTreeMap.Submap.this, from.getKey());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<K, Float> local_e = (Map.Entry)local_o;
            Object2FloatRBTreeMap.Entry<K> local_f = Object2FloatRBTreeMap.this.findKey(local_e.getKey());
            return (local_f != null) && (Object2FloatRBTreeMap.Submap.this.in5(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<K, Float> local_e = (Map.Entry)local_o;
            Object2FloatRBTreeMap.Entry<K> local_f = Object2FloatRBTreeMap.this.findKey(local_e.getKey());
            if ((local_f != null) && (Object2FloatRBTreeMap.Submap.this.in5(local_f.key))) {
              Object2FloatRBTreeMap.Submap.this.removeFloat(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Object2FloatRBTreeMap.Submap.SubmapIterator(Object2FloatRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Object2FloatRBTreeMap.Submap.this.clear();
          }
          
          public Object2FloatMap.Entry<K> first()
          {
            return Object2FloatRBTreeMap.Submap.this.firstEntry();
          }
          
          public Object2FloatMap.Entry<K> last()
          {
            return Object2FloatRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> from, Object2FloatMap.Entry<K> local_to)
          {
            return Object2FloatRBTreeMap.Submap.this.subMap(from.getKey(), local_to.getKey()).object2FloatEntrySet();
          }
          
          public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> local_to)
          {
            return Object2FloatRBTreeMap.Submap.this.headMap(local_to.getKey()).object2FloatEntrySet();
          }
          
          public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> from)
          {
            return Object2FloatRBTreeMap.Submap.this.tailMap(from.getKey()).object2FloatEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public FloatCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractFloatCollection()
        {
          public FloatIterator iterator()
          {
            return new Object2FloatRBTreeMap.Submap.SubmapValueIterator(Object2FloatRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(float local_k)
          {
            return Object2FloatRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Object2FloatRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(Object local_k)
    {
      return (in5(local_k)) && (Object2FloatRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      K local_kk = local_k;
      Object2FloatRBTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2FloatRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public Float get(Object local_ok)
    {
      K local_kk = local_ok;
      Object2FloatRBTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2FloatRBTreeMap.this.findKey(local_kk)) != null) ? local_e.getValue() : null;
    }
    ...
    public float put(K local_k, float local_v)
    {
      ...
      float oldValue = Object2FloatRBTreeMap.this.put(local_k, local_v);
    ...
    public float removeFloat(Object local_k)
    {
      ...
      float oldValue = Object2FloatRBTreeMap.this.removeFloat(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Object2FloatRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Object2FloatRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Object2FloatRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Object2FloatSortedMap<K> tailMap(K from)
    {
      if (this.bottom) {
        return new Submap(Object2FloatRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Object2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2FloatRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Object2FloatSortedMap<K> subMap(K from, K local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Object2FloatRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Object2FloatRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Object2FloatRBTreeMap.Entry<K> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Object2FloatRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Object2FloatRBTreeMap.this.locateKey(this.from);
        if (Object2FloatRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Object2FloatRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Object2FloatRBTreeMap.Entry<K> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Object2FloatRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Object2FloatRBTreeMap.this.locateKey(this.field_47);
        if (Object2FloatRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Object2FloatRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public K firstKey()
    {
      Object2FloatRBTreeMap.Entry<K> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public K lastKey()
    {
      Object2FloatRBTreeMap.Entry<K> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Object2FloatRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Object2FloatRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Object2FloatRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator()
      {
        this();
        if (this.next != null) {
          if ((!Object2FloatRBTreeMap.Submap.this.bottom) && (Object2FloatRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Object2FloatRBTreeMap.Submap.this.top) && (Object2FloatRBTreeMap.this.compare(local_k, (this.prev = Object2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Object2FloatRBTreeMap.this.locateKey(local_k);
            if (Object2FloatRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Object2FloatRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2FloatRBTreeMap.this.compare(this.prev.key, Object2FloatRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Object2FloatRBTreeMap.Submap.this.top) && (this.next != null) && (Object2FloatRBTreeMap.this.compare(this.next.key, Object2FloatRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractObject2FloatSortedMap.KeySet
    {
      ...
      {
        return new Object2FloatRBTreeMap.Submap.SubmapKeyIterator(Object2FloatRBTreeMap.Submap.this);
      }
      
      public ObjectBidirectionalIterator<K> iterator(K from)
      {
        return new Object2FloatRBTreeMap.Submap.SubmapKeyIterator(Object2FloatRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractObject2FloatSortedMap.KeySet
  {
    ...
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new Object2FloatRBTreeMap.KeyIterator(Object2FloatRBTreeMap.this);
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new Object2FloatRBTreeMap.KeyIterator(Object2FloatRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    TreeIterator()
    {
      if ((this.next = Object2FloatRBTreeMap.this.locateKey(local_k)) != null) {
        if (Object2FloatRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
