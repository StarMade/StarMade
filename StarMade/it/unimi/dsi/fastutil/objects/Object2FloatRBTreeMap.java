...
/*  597 */     float oldValue = put(ok, ov.floatValue());
/*  598 */     return this.modified ? null : Float.valueOf(oldValue);
/*      */   }
/*      */   public Float remove(Object ok) {
/*  601 */     float oldValue = removeFloat(ok);
/*  602 */     return this.modified ? Float.valueOf(oldValue) : null;
/*      */   }
...
/*  949 */         final Comparator<? super Object2FloatMap.Entry<K>> comparator = new Comparator() {
/*      */           public int compare(Object2FloatMap.Entry<K> x, Object2FloatMap.Entry<K> y) {
/*  951 */             return Object2FloatRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/*  949 */         };
/*      */ 
...
/*  958 */           return new Object2FloatRBTreeMap.EntryIterator(Object2FloatRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> from) {
/*  961 */           return new Object2FloatRBTreeMap.EntryIterator(Object2FloatRBTreeMap.this, from.getKey());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/*  965 */           if (!(o instanceof Map.Entry)) return false;
/*  966 */           Map.Entry e = (Map.Entry)o;
/*  967 */           Object2FloatRBTreeMap.Entry f = Object2FloatRBTreeMap.this.findKey(e.getKey());
...
/*  974 */           Object2FloatRBTreeMap.Entry f = Object2FloatRBTreeMap.this.findKey(e.getKey());
/*  975 */           if (f != null) Object2FloatRBTreeMap.this.removeFloat(f.key);
/*  976 */           return f != null;
/*      */         }
/*  978 */         public int size() { return Object2FloatRBTreeMap.this.count; } 
/*  979 */         public void clear() { Object2FloatRBTreeMap.this.clear(); } 
/*  980 */         public Object2FloatMap.Entry<K> first() { return Object2FloatRBTreeMap.this.firstEntry; } 
/*  981 */         public Object2FloatMap.Entry<K> last() { return Object2FloatRBTreeMap.this.lastEntry; } 
/*  982 */         public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> from, Object2FloatMap.Entry<K> to) { return Object2FloatRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2FloatEntrySet(); } 
/*  983 */         public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> to) { return Object2FloatRBTreeMap.this.headMap(to.getKey()).object2FloatEntrySet(); } 
/*  984 */         public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> from) { return Object2FloatRBTreeMap.this.tailMap(from.getKey()).object2FloatEntrySet(); }
/*      */       };
...
/*      */   {
/* 1044 */     if (this.values == null) this.values = new AbstractFloatCollection() {
/*      */         public FloatIterator iterator() {
/* 1046 */           return new Object2FloatRBTreeMap.ValueIterator(Object2FloatRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(float k) {
/* 1049 */           return Object2FloatRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1052 */           return Object2FloatRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1055 */           Object2FloatRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1407 */       c = (Object2FloatRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1479 */     if (n == 1) {
/* 1480 */       Entry top = new Entry(s.readObject(), s.readFloat());
/* 1481 */       top.pred(pred);
/* 1482 */       top.succ(succ);
/* 1483 */       top.black(true);
/* 1484 */       return top;
...
/* 1486 */     if (n == 2)
/*      */     {
/* 1489 */       Entry top = new Entry(s.readObject(), s.readFloat());
/* 1490 */       top.black(true);
/* 1491 */       top.right(new Entry(s.readObject(), s.readFloat()));
...
/*      */     {
/* 1108 */       if ((!bottom) && (!top) && (Object2FloatRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1109 */       this.from = from;
/* 1110 */       this.bottom = bottom;
/* 1111 */       this.to = to;
/* 1112 */       this.top = top;
/* 1113 */       this.defRetValue = Object2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1127 */       return ((this.bottom) || (Object2FloatRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Object2FloatRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() {
/* 1131 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator() {
/* 1133 */             return new Object2FloatRBTreeMap.Submap.SubmapEntryIterator(Object2FloatRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Object2FloatMap.Entry<K>> iterator(Object2FloatMap.Entry<K> from) {
/* 1136 */             return new Object2FloatRBTreeMap.Submap.SubmapEntryIterator(Object2FloatRBTreeMap.Submap.this, from.getKey());
/*      */           }
/* 1138 */           public Comparator<? super Object2FloatMap.Entry<K>> comparator() { return Object2FloatRBTreeMap.this.object2FloatEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1141 */             if (!(o instanceof Map.Entry)) return false;
/* 1142 */             Map.Entry e = (Map.Entry)o;
/* 1143 */             Object2FloatRBTreeMap.Entry f = Object2FloatRBTreeMap.this.findKey(e.getKey());
/* 1144 */             return (f != null) && (Object2FloatRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1148 */             if (!(o instanceof Map.Entry)) return false;
/* 1149 */             Map.Entry e = (Map.Entry)o;
/* 1150 */             Object2FloatRBTreeMap.Entry f = Object2FloatRBTreeMap.this.findKey(e.getKey());
/* 1151 */             if ((f != null) && (Object2FloatRBTreeMap.Submap.this.in(f.key))) Object2FloatRBTreeMap.Submap.this.removeFloat(f.key);
/* 1152 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1155 */             int c = 0;
...
/* 1157 */             return c;
/*      */           }
/* 1159 */           public boolean isEmpty() { return !new Object2FloatRBTreeMap.Submap.SubmapIterator(Object2FloatRBTreeMap.Submap.this).hasNext(); } 
/* 1160 */           public void clear() { Object2FloatRBTreeMap.Submap.this.clear(); } 
/* 1161 */           public Object2FloatMap.Entry<K> first() { return Object2FloatRBTreeMap.Submap.this.firstEntry(); } 
/* 1162 */           public Object2FloatMap.Entry<K> last() { return Object2FloatRBTreeMap.Submap.this.lastEntry(); } 
/* 1163 */           public ObjectSortedSet<Object2FloatMap.Entry<K>> subSet(Object2FloatMap.Entry<K> from, Object2FloatMap.Entry<K> to) { return Object2FloatRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2FloatEntrySet(); } 
/* 1164 */           public ObjectSortedSet<Object2FloatMap.Entry<K>> headSet(Object2FloatMap.Entry<K> to) { return Object2FloatRBTreeMap.Submap.this.headMap(to.getKey()).object2FloatEntrySet(); } 
/* 1165 */           public ObjectSortedSet<Object2FloatMap.Entry<K>> tailSet(Object2FloatMap.Entry<K> from) { return Object2FloatRBTreeMap.Submap.this.tailMap(from.getKey()).object2FloatEntrySet(); }
/*      */         };
...
/*      */     }
/*      */     public FloatCollection values() {
/* 1178 */       if (this.values == null) this.values = new AbstractFloatCollection() {
/*      */           public FloatIterator iterator() {
/* 1180 */             return new Object2FloatRBTreeMap.Submap.SubmapValueIterator(Object2FloatRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(float k) {
/* 1183 */             return Object2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1186 */             return Object2FloatRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1189 */             Object2FloatRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(Object k) {
/* 1196 */       return (in(k)) && (Object2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(float v) {
/* 1199 */       SubmapIterator i = new SubmapIterator();
/*      */ 
/* 1201 */       while (i.hasNext()) {
/* 1202 */         float ev = i.nextEntry().value;
...
/*      */     {
/* 1210 */       Object kk = k;
/*      */       Object2FloatRBTreeMap.Entry e;
/* 1211 */       return (in(kk)) && ((e = Object2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     public Float get(Object ok)
/*      */     {
/* 1216 */       Object kk = ok;
/*      */       Object2FloatRBTreeMap.Entry e;
/* 1217 */       return (in(kk)) && ((e = Object2FloatRBTreeMap.this.findKey(kk)) != null) ? e.getValue() : null;
/*      */     }
/*      */     public float put(K k, float v) {
/* 1220 */       Object2FloatRBTreeMap.this.modified = false;
...
/* 1222 */       float oldValue = Object2FloatRBTreeMap.this.put(k, v);
/* 1223 */       return Object2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Float put(K ok, Float ov) {
/* 1226 */       float oldValue = put(ok, ov.floatValue());
/* 1227 */       return Object2FloatRBTreeMap.this.modified ? null : Float.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public float removeFloat(Object k) {
/* 1231 */       Object2FloatRBTreeMap.this.modified = false;
/* 1232 */       if (!in(k)) return this.defRetValue;
/* 1233 */       float oldValue = Object2FloatRBTreeMap.this.removeFloat(k);
/* 1234 */       return Object2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Float remove(Object ok) {
/* 1237 */       float oldValue = removeFloat(ok);
/* 1238 */       return Object2FloatRBTreeMap.this.modified ? Float.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public Comparator<? super K> comparator() {
/* 1253 */       return Object2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Object2FloatSortedMap<K> headMap(K to) {
/* 1256 */       if (this.top) return new Submap(Object2FloatRBTreeMap.this, this.from, this.bottom, to, false);
/* 1257 */       return Object2FloatRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Object2FloatRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Object2FloatSortedMap<K> tailMap(K from) {
/* 1260 */       if (this.bottom) return new Submap(Object2FloatRBTreeMap.this, from, false, this.to, this.top);
/* 1261 */       return Object2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2FloatRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Object2FloatSortedMap<K> subMap(K from, K to) {
/* 1264 */       if ((this.top) && (this.bottom)) return new Submap(Object2FloatRBTreeMap.this, from, false, to, false);
/* 1265 */       if (!this.top) to = Object2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1266 */       if (!this.bottom) from = Object2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1267 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1268 */       return new Submap(Object2FloatRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Object2FloatRBTreeMap.Entry<K> firstEntry()
/*      */     {
/* 1275 */       if (Object2FloatRBTreeMap.this.tree == null) return null;
/* 1278 */       Object2FloatRBTreeMap.Entry e;
/*      */       Object2FloatRBTreeMap.Entry e;
/* 1278 */       if (this.bottom) { e = Object2FloatRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1280 */         e = Object2FloatRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1282 */         if (Object2FloatRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1285 */       if ((e == null) || ((!this.top) && (Object2FloatRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1286 */       return e;
/*      */     }
/*      */ 
/*      */     public Object2FloatRBTreeMap.Entry<K> lastEntry()
/*      */     {
/* 1293 */       if (Object2FloatRBTreeMap.this.tree == null) return null;
/* 1296 */       Object2FloatRBTreeMap.Entry e;
/*      */       Object2FloatRBTreeMap.Entry e;
/* 1296 */       if (this.top) { e = Object2FloatRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1298 */         e = Object2FloatRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1300 */         if (Object2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1303 */       if ((e == null) || ((!this.bottom) && (Object2FloatRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1304 */       return e;
/*      */     }
/*      */     public K firstKey() {
/* 1307 */       Object2FloatRBTreeMap.Entry e = firstEntry();
/* 1308 */       if (e == null) throw new NoSuchElementException();
/* 1309 */       return e.key;
/*      */     }
/*      */     public K lastKey() {
/* 1312 */       Object2FloatRBTreeMap.Entry e = lastEntry();
/* 1313 */       if (e == null) throw new NoSuchElementException();
/* 1314 */       return e.key;
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Object2FloatRBTreeMap.Submap.SubmapIterator
/*      */       implements FloatListIterator
/*      */     {
/*      */       private SubmapValueIterator()
/*      */       {
/* 1385 */         super(); } 
/* 1386 */       public float nextFloat() { return nextEntry().value; } 
/* 1387 */       public float previousFloat() { return previousEntry().value; } 
/* 1388 */       public void set(float v) { throw new UnsupportedOperationException(); } 
/* 1389 */       public void add(float v) { throw new UnsupportedOperationException(); } 
/* 1390 */       public Float next() { return Float.valueOf(nextEntry().value); } 
/* 1391 */       public Float previous() { return Float.valueOf(previousEntry().value); } 
/* 1392 */       public void set(Float ok) { throw new UnsupportedOperationException(); } 
/* 1393 */       public void add(Float ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Object2FloatRBTreeMap<K>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Object2FloatRBTreeMap<K>.Submap.SubmapIterator
...
/* 1357 */       public Object2FloatMap.Entry<K> previous() { return previousEntry(); } 
/* 1358 */       public void set(Object2FloatMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/* 1359 */       public void add(Object2FloatMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Object2FloatRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1324 */         super();
/* 1325 */         this.next = Object2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator() {
/* 1328 */         this();
/* 1329 */         if (this.next != null)
/* 1330 */           if ((!Object2FloatRBTreeMap.Submap.this.bottom) && (Object2FloatRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1331 */           } else if ((!Object2FloatRBTreeMap.Submap.this.top) && (Object2FloatRBTreeMap.this.compare(k, (this.prev = Object2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1333 */             this.next = Object2FloatRBTreeMap.this.locateKey(k);
/* 1334 */             if (Object2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1344 */         if ((!Object2FloatRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2FloatRBTreeMap.this.compare(this.prev.key, Object2FloatRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1347 */         this.next = this.next.next();
/* 1348 */         if ((!Object2FloatRBTreeMap.Submap.this.top) && (this.next != null) && (Object2FloatRBTreeMap.this.compare(this.next.key, Object2FloatRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1169 */         super(); } 
/* 1170 */       public ObjectBidirectionalIterator<K> iterator() { return new Object2FloatRBTreeMap.Submap.SubmapKeyIterator(Object2FloatRBTreeMap.Submap.this); } 
/* 1171 */       public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2FloatRBTreeMap.Submap.SubmapKeyIterator(Object2FloatRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2FloatRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     private ValueIterator()
/*      */     {
/* 1025 */       super(); } 
/* 1026 */     public float nextFloat() { return nextEntry().value; } 
/* 1027 */     public float previousFloat() { return previousEntry().value; } 
/* 1028 */     public void set(float v) { throw new UnsupportedOperationException(); } 
/* 1029 */     public void add(float v) { throw new UnsupportedOperationException(); } 
/* 1030 */     public Float next() { return Float.valueOf(nextEntry().value); } 
/* 1031 */     public Float previous() { return Float.valueOf(previousEntry().value); } 
/* 1032 */     public void set(Float ok) { throw new UnsupportedOperationException(); } 
/* 1033 */     public void add(Float ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class KeySet extends AbstractObject2FloatSortedMap.KeySet
...
/*      */     {
/* 1003 */       super(); } 
/* 1004 */     public ObjectBidirectionalIterator<K> iterator() { return new Object2FloatRBTreeMap.KeyIterator(Object2FloatRBTreeMap.this); } 
/* 1005 */     public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2FloatRBTreeMap.KeyIterator(Object2FloatRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2FloatRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2FloatRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<Object2FloatMap.Entry<K>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/*  943 */     public Object2FloatMap.Entry<K> previous() { return previousEntry(); } 
/*  944 */     public void set(Object2FloatMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  945 */     public void add(Object2FloatMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  870 */     int index = 0;
/*      */ 
/*  872 */     TreeIterator() { this.next = Object2FloatRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator() {
/*  875 */       if ((this.next = Object2FloatRBTreeMap.this.locateKey(k)) != null)
/*  876 */         if (Object2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/*  917 */       updatePrevious();
/*  918 */       updateNext();
/*  919 */       Object2FloatRBTreeMap.this.removeFloat(this.curr.key);
/*  920 */       this.curr = null;
/*      */     }
...
/*  761 */       return Float.valueOf(this.value);
/*      */     }
/*      */     public float getFloatValue() {
/*  764 */       return this.value;
/*      */     }
/*      */     public float setValue(float value) {
/*  767 */       float oldValue = this.value;
/*  768 */       this.value = value;
/*  769 */       return oldValue;
/*      */     }
/*      */     public Float setValue(Float value) {
/*  772 */       return Float.valueOf(setValue(value.floatValue()));
/*      */     }
/*      */ 
...
/*  792 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Float)e.getValue()).floatValue());
/*      */     }
/*      */     public int hashCode() {
/*  795 */       return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.float2int(this.value);
/*      */     }
