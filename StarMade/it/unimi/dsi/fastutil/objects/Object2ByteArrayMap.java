...
/*     */ 
/*     */ public class Object2ByteArrayMap<K> extends AbstractObject2ByteMap<K>
...
/*     */     try
/*     */     {
/* 300 */       c = (Object2ByteArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Object2ByteMap.Entry<K>>
...
/* 130 */         int next = 0;
/*     */ 
/* 132 */         public boolean hasNext() { return this.next < Object2ByteArrayMap.this.size; }
/*     */ 
/*     */         public Object2ByteMap.Entry<K> next()
/*     */         {
/* 136 */           if (!hasNext()) throw new NoSuchElementException();
/* 137 */           return new AbstractObject2ByteMap.BasicEntry(Object2ByteArrayMap.this.key[this.next], Object2ByteArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 143 */         int next = 0;
/* 144 */         final AbstractObject2ByteMap.BasicEntry<K> entry = new AbstractObject2ByteMap.BasicEntry(null, (byte)0);
/*     */ 
/* 146 */         public boolean hasNext() { return this.next < Object2ByteArrayMap.this.size; }
/*     */ 
/*     */         public Object2ByteMap.Entry<K> next()
/*     */         {
/* 150 */           if (!hasNext()) throw new NoSuchElementException();
/* 151 */           this.entry.key = Object2ByteArrayMap.this.key[this.next];
/* 152 */           this.entry.value = Object2ByteArrayMap.this.value[(this.next++)];
/* 153 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 158 */       return Object2ByteArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 165 */       return (Object2ByteArrayMap.this.containsKey(k)) && (Object2ByteArrayMap.this.get(k).byteValue() == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */   }
/*     */ }
