...
/*  14:    */
/*  65:    */public class Object2ByteArrayMap<K>
/*  66:    */  extends AbstractObject2ByteMap<K>
...
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Object2ByteArrayMap(Object[] key, byte[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Object2ByteArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = ObjectArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = ByteArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Object2ByteArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new Object[capacity];
/*  93: 93 */    this.value = new byte[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Object2ByteArrayMap(Object2ByteMap<K> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Object2ByteArrayMap(Map<? extends K, ? extends Byte> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Object2ByteArrayMap(Object[] key, byte[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Object2ByteMap.Entry<K>> implements Object2ByteMap.FastEntrySet<K> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Object2ByteMap.Entry<K>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Object2ByteArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Object2ByteMap.Entry<K> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractObject2ByteMap.BasicEntry(Object2ByteArrayMap.this.key[this.next], Object2ByteArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Object2ByteMap.Entry<K>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractObject2ByteMap.BasicEntry<K> entry = new AbstractObject2ByteMap.BasicEntry(null, (byte)0);
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Object2ByteArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Object2ByteMap.Entry<K> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Object2ByteArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Object2ByteArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Object2ByteArrayMap.this.size; }
/* 159:    */    
...
/* 165:165 */      return (Object2ByteArrayMap.this.containsKey(k)) && (Object2ByteArrayMap.this.get(k).byteValue() == ((Byte)e.getValue()).byteValue());
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Object2ByteMap.FastEntrySet<K> object2ByteEntrySet() { return new EntrySet(null); }
/* 170:    */  
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Object2ByteArrayMap<K> clone()
/* 293:    */  {
/* 294:    */    Object2ByteArrayMap<K> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Object2ByteArrayMap)super.clone();
/* 301:    */    }
