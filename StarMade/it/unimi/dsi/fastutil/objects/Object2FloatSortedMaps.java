...
/* 246 */     public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.object2FloatEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() {
/* 248 */       return object2FloatEntrySet(); } 
...
/* 250 */     public Object2FloatSortedMap<K> subMap(K from, K to) { return new UnmodifiableSortedMap(this.sortedMap.subMap(from, to)); } 
/* 251 */     public Object2FloatSortedMap<K> headMap(K to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 252 */     public Object2FloatSortedMap<K> tailMap(K from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 212 */     public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.object2FloatEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() {
/* 214 */       return object2FloatEntrySet(); } 
...
/* 216 */     public Object2FloatSortedMap<K> subMap(K from, K to) { return new SynchronizedSortedMap(this.sortedMap.subMap(from, to), this.sync); } 
/* 217 */     public Object2FloatSortedMap<K> headMap(K to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 218 */     public Object2FloatSortedMap<K> tailMap(K from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Object2FloatMaps.Singleton.SingletonEntry(this), Object2FloatSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() { return object2FloatEntrySet(); } 
...
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Object2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Object2FloatSortedMap<K> headMap(K to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Object2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Object2FloatSortedMap<K> tailMap(K from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Object2FloatSortedMaps.EMPTY_MAP;
/*     */     }
...
/*  77 */       return null;
/*     */     }
/*  79 */     public ObjectSortedSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() {
/*  81 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  83 */     public ObjectSortedSet<K> keySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public Object2FloatSortedMap<K> subMap(K from, K to) {
/*  85 */       return Object2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*  87 */     public Object2FloatSortedMap<K> headMap(K to) { return Object2FloatSortedMaps.EMPTY_MAP; } 
/*     */     public Object2FloatSortedMap<K> tailMap(K from) {
/*  89 */       return Object2FloatSortedMaps.EMPTY_MAP; } 
