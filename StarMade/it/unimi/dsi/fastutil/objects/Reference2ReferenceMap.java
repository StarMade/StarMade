...
public abstract interface Reference2ReferenceMap<K, V> extends Reference2ReferenceFunction<K, V>, Map<K, V>
{
  ...
  public static abstract interface FastEntrySet<K, V> extends ObjectSet<Reference2ReferenceMap.Entry<K, V>>
  {
