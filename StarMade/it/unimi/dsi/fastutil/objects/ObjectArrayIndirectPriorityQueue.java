  ...
  implements IndirectPriorityQueue<K>
{
  ...
  public ObjectArrayIndirectPriorityQueue(K[] refArray, int capacity, Comparator<? super K> local_c)
  {
    if (capacity > 0) {
  ...
  public ObjectArrayIndirectPriorityQueue(K[] refArray, Comparator<? super K> local_c)
  {
  ...
  public ObjectArrayIndirectPriorityQueue(K[] refArray, int[] local_a, int size, Comparator<? super K> local_c)
  {
  ...
  public ObjectArrayIndirectPriorityQueue(K[] refArray, int[] local_a, Comparator<? super K> local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public ObjectArrayIndirectPriorityQueue(K[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public ObjectArrayIndirectPriorityQueue(K[] refArray, int[] local_a)
  {
  ...
  private int findFirst()
  {
    ...
    if (this.field_69 == null) {
      while (local_i-- != 0) {
        if (((Comparable)this.refArray[this.array[local_i]]).compareTo(first) < 0) {
  ...
  private int findLast()
  {
    ...
    if (this.field_69 == null) {
      while (local_i-- != 0) {
        if (((Comparable)last).compareTo(this.refArray[this.array[local_i]]) < 0) {
  ...
  public void enqueue(int local_x)
  {
    ...
    if (this.firstIndexValid)
    {
      if (this.field_69 == null)
      {
        if (((Comparable)this.refArray[local_x]).compareTo(this.refArray[this.array[this.firstIndex]]) < 0) {
  ...
  public int front(int[] local_a)
  {
    ...
    int local_c = 0;
    while (local_i-- != 0) {
      if (top.equals(this.refArray[this.array[local_i]])) {
