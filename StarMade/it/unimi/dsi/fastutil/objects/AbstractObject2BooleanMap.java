  ...
  implements Object2BooleanMap<K>, Serializable
{
  ...
  public void putAll(Map<? extends K, ? extends Boolean> local_m)
  {
    ...
    if ((local_m instanceof Object2BooleanMap)) {
      while (local_n-- != 0)
      {
        Object2BooleanMap.Entry<? extends K> local_e = (Object2BooleanMap.Entry)local_i.next();
  ...
  public ObjectSet<K> keySet()
  {
    new AbstractObjectSet()
    {
      ...
      {
        return AbstractObject2BooleanMap.this.containsKey(local_k);
      }
      ...
      public ObjectIterator<K> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Boolean>> field_3 = AbstractObject2BooleanMap.this.entrySet().iterator();
          
          public K next()
          {
            return ((Object2BooleanMap.Entry)this.field_3.next()).getKey();
          }
  ...
  public BooleanCollection values()
  {
    new AbstractBooleanCollection()
    {
      ...
      {
        return AbstractObject2BooleanMap.this.containsValue(local_k);
      }
      ...
      public BooleanIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Boolean>> field_60 = AbstractObject2BooleanMap.this.entrySet().iterator();
          
          public boolean nextBoolean()
          {
            return ((Object2BooleanMap.Entry)this.field_60.next()).getBooleanValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Object2BooleanMap.Entry<K> local_e = (Object2BooleanMap.Entry)local_i.next();
