...
/*  88 */     if ((m instanceof Object2BooleanMap))
/*     */     {
/*  90 */       while (n-- != 0) {
/*  91 */         Object2BooleanMap.Entry e = (Object2BooleanMap.Entry)i.next();
...
/* 193 */         return AbstractObject2BooleanMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractObject2BooleanMap.this.size(); } 
/* 196 */       public void clear() { AbstractObject2BooleanMap.this.clear(); }
/*     */ 
/*     */       public ObjectIterator<K> iterator() {
/* 199 */         return new AbstractObjectIterator() {
/* 200 */           final ObjectIterator<Map.Entry<K, Boolean>> i = AbstractObject2BooleanMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public K next() { return ((Object2BooleanMap.Entry)this.i.next()).getKey(); } 
...
/* 226 */         return AbstractObject2BooleanMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractObject2BooleanMap.this.size(); } 
/* 229 */       public void clear() { AbstractObject2BooleanMap.this.clear(); }
/*     */ 
/*     */       public BooleanIterator iterator() {
/* 232 */         return new AbstractBooleanIterator() {
/* 233 */           final ObjectIterator<Map.Entry<K, Boolean>> i = AbstractObject2BooleanMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public boolean nextBoolean() { return ((Object2BooleanMap.Entry)this.i.next()).getBooleanValue(); } 
/*     */           public boolean hasNext() {
...
/*     */   {
/* 246 */     return object2BooleanEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Object2BooleanMap.Entry e = (Object2BooleanMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
/* 167 */       return (this.key == null ? 0 : this.key.hashCode()) ^ (this.value ? 1231 : 1237);
/*     */     }
/*     */ 
/*     */     public String toString()
/*     */     {
