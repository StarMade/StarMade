...
public class ReferenceLists
{
  ...
  public static <K> ReferenceList<K> shuffle(ReferenceList<K> local_l, Random random)
  {
  ...
  public static <K> ReferenceList<K> synchronize(ReferenceList<K> local_l)
  {
    return new SynchronizedList(local_l);
  }
  
  public static <K> ReferenceList<K> synchronize(ReferenceList<K> local_l, Object sync)
  {
    return new SynchronizedList(local_l, sync);
  }
  
  public static <K> ReferenceList<K> unmodifiable(ReferenceList<K> local_l)
  {
    ...
    implements ReferenceList<K>, Serializable
  {
    ...
    protected UnmodifiableList(ReferenceList<K> local_l)
    {
      super();
      this.list = local_l;
    }
    ...
    {
      return ReferenceLists.unmodifiable(this.list.subList(from, local_to));
    }
    ...
    implements ReferenceList<K>, Serializable
  {
    ...
    protected SynchronizedList(ReferenceList<K> local_l, Object sync)
    {
      super(sync);
      this.list = local_l;
    }
    
    protected SynchronizedList(ReferenceList<K> local_l)
    {
      super();
      this.list = local_l;
    }
    ...
    public ReferenceList<K> subList(int from, int local_to)
    {
      synchronized (this.sync)
      {
        return ReferenceLists.synchronize(this.list.subList(from, local_to), this.sync);
      }
    }
