...
/*     */     try
/*     */     {
/* 300 */       c = (Reference2BooleanArrayMap)super.clone();
/*     */     }
...
/* 130 */         int next = 0;
/*     */ 
/* 132 */         public boolean hasNext() { return this.next < Reference2BooleanArrayMap.this.size; }
/*     */ 
/*     */         public Reference2BooleanMap.Entry<K> next()
/*     */         {
/* 136 */           if (!hasNext()) throw new NoSuchElementException();
/* 137 */           return new AbstractReference2BooleanMap.BasicEntry(Reference2BooleanArrayMap.this.key[this.next], Reference2BooleanArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 143 */         int next = 0;
/* 144 */         final AbstractReference2BooleanMap.BasicEntry<K> entry = new AbstractReference2BooleanMap.BasicEntry(null, false);
/*     */ 
/* 146 */         public boolean hasNext() { return this.next < Reference2BooleanArrayMap.this.size; }
/*     */ 
/*     */         public Reference2BooleanMap.Entry<K> next()
/*     */         {
/* 150 */           if (!hasNext()) throw new NoSuchElementException();
/* 151 */           this.entry.key = Reference2BooleanArrayMap.this.key[this.next];
/* 152 */           this.entry.value = Reference2BooleanArrayMap.this.value[(this.next++)];
/* 153 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 158 */       return Reference2BooleanArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 165 */       return (Reference2BooleanArrayMap.this.containsKey(k)) && (Reference2BooleanArrayMap.this.get(k).booleanValue() == ((Boolean)e.getValue()).booleanValue());
/*     */     }
/*     */   }
/*     */ }
