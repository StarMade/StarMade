  ...
  implements Serializable, Cloneable
{
  ...
  public ReferenceArraySet(Object[] local_a)
  {
  ...
  public ReferenceArraySet(ReferenceCollection<K> local_c)
  {
    this(local_c.size());
    addAll(local_c);
  }
  
  public ReferenceArraySet(Collection<? extends K> local_c)
  {
    this(local_c.size());
    addAll(local_c);
  }
  
  public ReferenceArraySet(Object[] local_a, int size)
  {
    this.field_75 = local_a;
    this.size = size;
  ...
  private int findKey(Object local_o)
  {
    ...
    while (local_i-- != 0) {
      if (this.field_75[local_i] == local_o) {
        return local_i;
      }
    }
    return -1;
  ...
  {
    ReferenceArraySet<K> local_c;
    try
    {
      local_c = (ReferenceArraySet)super.clone();
    }
