...
/* 649 */           return new Object2ByteOpenCustomHashMap.ValueIterator(Object2ByteOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 652 */           return Object2ByteOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(byte v) {
/* 655 */           return Object2ByteOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 658 */           Object2ByteOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 773 */       c = (Object2ByteOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Object2ByteOpenCustomHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 642 */       super(null); } 
/* 643 */     public byte nextByte() { return Object2ByteOpenCustomHashMap.this.value[nextEntry()]; } 
/* 644 */     public Byte next() { return Byte.valueOf(Object2ByteOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 614 */       return new Object2ByteOpenCustomHashMap.KeyIterator(Object2ByteOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 617 */       return Object2ByteOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 620 */       return Object2ByteOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 623 */       int oldSize = Object2ByteOpenCustomHashMap.this.size;
/* 624 */       Object2ByteOpenCustomHashMap.this.remove(k);
/* 625 */       return Object2ByteOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 628 */       Object2ByteOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Object2ByteOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 609 */       super(null); } 
/* 610 */     public K next() { return Object2ByteOpenCustomHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
/*     */   private final class MapEntrySet extends AbstractObjectSet<Object2ByteMap.Entry<K>>
...
/*     */     {
/* 555 */       return new Object2ByteOpenCustomHashMap.EntryIterator(Object2ByteOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Object2ByteMap.Entry<K>> fastIterator() {
/* 558 */       return new Object2ByteOpenCustomHashMap.FastEntryIterator(Object2ByteOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 566 */       int pos = HashCommon.murmurHash3(Object2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteOpenCustomHashMap.this.mask;
/*     */ 
/* 568 */       while (Object2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 569 */         if (Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[pos], k)) return Object2ByteOpenCustomHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 570 */         pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask;
/*     */       }
/* 572 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 580 */       int pos = HashCommon.murmurHash3(Object2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteOpenCustomHashMap.this.mask;
/*     */ 
/* 582 */       while (Object2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 583 */         if (Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[pos], k)) {
/* 584 */           Object2ByteOpenCustomHashMap.this.remove(e.getKey());
/* 585 */           return true;
/*     */         }
/* 587 */         pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask;
/*     */       }
/* 589 */       return false;
/*     */     }
/*     */     public int size() {
/* 592 */       return Object2ByteOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 595 */       Object2ByteOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Object2ByteOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2ByteMap.Entry<K>>
/*     */   {
/* 545 */     final AbstractObject2ByteMap.BasicEntry<K> entry = new AbstractObject2ByteMap.BasicEntry(null, (byte)0);
/*     */ 
...
/* 547 */       int e = nextEntry();
/* 548 */       this.entry.key = Object2ByteOpenCustomHashMap.this.key[e];
/* 549 */       this.entry.value = Object2ByteOpenCustomHashMap.this.value[e];
/* 550 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Object2ByteOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2ByteMap.Entry<K>>
/*     */   {
...
/* 536 */       return this.entry = new Object2ByteOpenCustomHashMap.MapEntry(Object2ByteOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 540 */       super.remove();
/* 541 */       Object2ByteOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 441 */       this.pos = Object2ByteOpenCustomHashMap.this.n;
/*     */ 
/* 444 */       this.last = -1;
/*     */ 
/* 446 */       this.c = Object2ByteOpenCustomHashMap.this.size;
/*     */ 
/* 451 */       boolean[] used = Object2ByteOpenCustomHashMap.this.used;
...
/*     */ 
/* 464 */         int pos = HashCommon.murmurHash3(Object2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ByteOpenCustomHashMap.this.mask;
/*     */ 
/* 466 */         while (Object2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 467 */           if (Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[pos], k)) return pos;
/* 468 */           pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 471 */       this.last = this.pos;
/*     */ 
/* 473 */       if (this.c != 0) {
/* 474 */         boolean[] used = Object2ByteOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 491 */         pos = (last = pos) + 1 & Object2ByteOpenCustomHashMap.this.mask;
/* 492 */         while (Object2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 493 */           int slot = HashCommon.murmurHash3(Object2ByteOpenCustomHashMap.this.strategy.hashCode(Object2ByteOpenCustomHashMap.this.key[pos])) & Object2ByteOpenCustomHashMap.this.mask;
/* 494 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 495 */           pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask;
/*     */         }
/* 497 */         if (Object2ByteOpenCustomHashMap.this.used[pos] == 0) break;
/* 498 */         if (pos < last)
/*     */         {
/* 500 */           if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 501 */           this.wrapped.add(Object2ByteOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 503 */         Object2ByteOpenCustomHashMap.this.key[last] = Object2ByteOpenCustomHashMap.this.key[pos];
/* 504 */         Object2ByteOpenCustomHashMap.this.value[last] = Object2ByteOpenCustomHashMap.this.value[pos];
/*     */       }
/* 506 */       Object2ByteOpenCustomHashMap.this.used[last] = false;
/* 507 */       Object2ByteOpenCustomHashMap.this.key[last] = null;
/* 508 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 513 */       if (this.pos < -1)
/*     */       {
/* 515 */         Object2ByteOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 516 */         this.last = -1;
/* 517 */         return;
/*     */       }
/* 519 */       Object2ByteOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 408 */       return Object2ByteOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Byte getValue() {
/* 411 */       return Byte.valueOf(Object2ByteOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public byte getByteValue() {
/* 414 */       return Object2ByteOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public byte setValue(byte v) {
/* 417 */       byte oldValue = Object2ByteOpenCustomHashMap.this.value[this.index];
/* 418 */       Object2ByteOpenCustomHashMap.this.value[this.index] = v;
/* 419 */       return oldValue;
/*     */     }
/*     */     public Byte setValue(Byte v) {
...
/* 428 */       return (Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */     public int hashCode() {
/* 431 */       return Object2ByteOpenCustomHashMap.this.strategy.hashCode(Object2ByteOpenCustomHashMap.this.key[this.index]) ^ Object2ByteOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 434 */       return Object2ByteOpenCustomHashMap.this.key[this.index] + "=>" + Object2ByteOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
