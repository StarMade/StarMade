  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2ByteOpenCustomHashMap(int expected, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2ByteOpenCustomHashMap(Map<? extends K, ? extends Byte> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2ByteOpenCustomHashMap(Object2ByteMap<K> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2ByteOpenCustomHashMap(Object2ByteMap<K> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2ByteOpenCustomHashMap(K[] local_k, byte[] local_v, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2ByteOpenCustomHashMap(K[] local_k, byte[] local_v, Hash.Strategy<K> strategy)
  {
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Object2ByteOpenCustomHashMap.ValueIterator(Object2ByteOpenCustomHashMap.this);
        }
        ...
        {
          return Object2ByteOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2ByteOpenCustomHashMap<K> local_c;
    try
    {
      local_c = (Object2ByteOpenCustomHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    byte[] value = this.value;
    Object2ByteOpenCustomHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2ByteOpenCustomHashMap.MapIterator
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Object2ByteOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractObjectSet<K>
  {
    ...
    {
      return new Object2ByteOpenCustomHashMap.KeyIterator(Object2ByteOpenCustomHashMap.this);
    }
    ...
    {
      return Object2ByteOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2ByteOpenCustomHashMap.this.size;
      Object2ByteOpenCustomHashMap.this.remove(local_k);
    ...
    implements Object2ByteMap.FastEntrySet<K>
  {
    ...
    {
      return new Object2ByteOpenCustomHashMap.EntryIterator(Object2ByteOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Object2ByteMap.Entry<K>> fastIterator()
    {
      return new Object2ByteOpenCustomHashMap.FastEntryIterator(Object2ByteOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2ByteOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2ByteOpenCustomHashMap.this.mask; Object2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask) {
        if (Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[pos], local_k)) {
          return Object2ByteOpenCustomHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2ByteOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2ByteOpenCustomHashMap.this.mask; Object2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask) {
        if (Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[pos], local_k))
        {
          Object2ByteOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Object2ByteMap.Entry<K>>
  {
    ...
    public AbstractObject2ByteMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2ByteOpenCustomHashMap.this.key[local_e];
      this.entry.value = Object2ByteOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Object2ByteMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2ByteOpenCustomHashMap.MapEntry(Object2ByteOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2ByteOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Object2ByteOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2149 = Object2ByteOpenCustomHashMap.this.size;
    ObjectArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Object2ByteOpenCustomHashMap.this.used;
      while ((this.field_2149 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2149 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Object2ByteOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2ByteOpenCustomHashMap.this.mask; Object2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ByteOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Object2ByteOpenCustomHashMap.this.strategy.hashCode(Object2ByteOpenCustomHashMap.this.key[pos])) & Object2ByteOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2ByteOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Object2ByteOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
        this.last = -1;
        return;
      }
      Object2ByteOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2149 > 0))
      {
        this.field_2149 += 1;
        nextEntry();
      }
    ...
    implements Object2ByteMap.Entry<K>, Map.Entry<K, Byte>
  {
    ...
    public byte setValue(byte local_v)
    {
      ...
      Object2ByteOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Byte> local_e = (Map.Entry)local_o;
      return (Object2ByteOpenCustomHashMap.this.strategy.equals(Object2ByteOpenCustomHashMap.this.key[this.index], local_e.getKey())) && (Object2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
