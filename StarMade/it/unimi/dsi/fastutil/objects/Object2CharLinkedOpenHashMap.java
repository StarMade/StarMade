  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2CharLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Object2CharLinkedOpenHashMap(Map<? extends K, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2CharLinkedOpenHashMap(Map<? extends K, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2CharLinkedOpenHashMap(Object2CharMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2CharLinkedOpenHashMap(Object2CharMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2CharLinkedOpenHashMap(K[] local_k, char[] local_v, float local_f)
  {
  ...
  public Object2CharLinkedOpenHashMap(K[] local_k, char[] local_v)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Object2CharLinkedOpenHashMap.ValueIterator(Object2CharLinkedOpenHashMap.this);
        }
        ...
        {
          return Object2CharLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2CharLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Object2CharLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    char[] value = this.value;
    Object2CharLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2CharLinkedOpenHashMap.MapIterator
    implements CharListIterator
  {
    public char previousChar()
    {
      return Object2CharLinkedOpenHashMap.this.value[previousEntry()];
    }
    
    public Character previous()
    {
      return Character.valueOf(Object2CharLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Object2CharLinkedOpenHashMap.this.value[nextEntry()];
    }
    
    public Character next()
    {
      return Character.valueOf(Object2CharLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractObjectSortedSet<K>
  {
    ...
    {
      return new Object2CharLinkedOpenHashMap.KeyIterator(Object2CharLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Object2CharLinkedOpenHashMap.KeyIterator(Object2CharLinkedOpenHashMap.this);
    }
    ...
    {
      return Object2CharLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2CharLinkedOpenHashMap.this.size;
      Object2CharLinkedOpenHashMap.this.remove(local_k);
    ...
    implements ObjectListIterator<K>
  {
    ...
    public K previous()
    {
      return Object2CharLinkedOpenHashMap.this.key[previousEntry()];
    }
    ...
    public K next()
    {
      return Object2CharLinkedOpenHashMap.this.key[nextEntry()];
    }
  }
    ...
    implements Object2CharSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Object2CharLinkedOpenHashMap.EntryIterator(Object2CharLinkedOpenHashMap.this);
    }
    ...
    public Object2CharMap.Entry<K> first()
    {
      ...
      return new Object2CharLinkedOpenHashMap.MapEntry(Object2CharLinkedOpenHashMap.this, Object2CharLinkedOpenHashMap.this.first);
    }
    ...
    public Object2CharMap.Entry<K> last()
    {
      ...
      return new Object2CharLinkedOpenHashMap.MapEntry(Object2CharLinkedOpenHashMap.this, Object2CharLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2CharLinkedOpenHashMap.this.mask; Object2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask) {
        if (Object2CharLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2CharLinkedOpenHashMap.this.key[pos].equals(local_k)) {
          return Object2CharLinkedOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2CharLinkedOpenHashMap.this.mask; Object2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask) {
        if (Object2CharLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2CharLinkedOpenHashMap.this.key[pos].equals(local_k))
        {
          Object2CharLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Object2CharLinkedOpenHashMap.EntryIterator(Object2CharLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> fastIterator()
    {
      return new Object2CharLinkedOpenHashMap.FastEntryIterator(Object2CharLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> fastIterator(Object2CharMap.Entry<K> from)
    {
      return new Object2CharLinkedOpenHashMap.FastEntryIterator(Object2CharLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Object2CharMap.Entry<K>>
  {
    ...
    public AbstractObject2CharMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2CharLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Object2CharLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Object2CharMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2CharLinkedOpenHashMap.MapEntry(Object2CharLinkedOpenHashMap.this, nextEntry());
    }
    
    public Object2CharLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Object2CharLinkedOpenHashMap.MapEntry(Object2CharLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2CharLinkedOpenHashMap.this.mask; Object2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask) {
          if (Object2CharLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2CharLinkedOpenHashMap.this.key[pos].equals(from))
          {
    ...
    public void remove()
    {
      ...
      Object2CharLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Object2CharLinkedOpenHashMap.this.first = this.next;
      } else {
        Object2CharLinkedOpenHashMap.this.link[this.prev] ^= (Object2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Object2CharLinkedOpenHashMap.this.last = this.prev;
      } else {
        Object2CharLinkedOpenHashMap.this.link[this.next] ^= (Object2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2CharLinkedOpenHashMap.this.mask; Object2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharLinkedOpenHashMap.this.mask)
        {
          int slot = (Object2CharLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2CharLinkedOpenHashMap.this.key[pos].hashCode())) & Object2CharLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2CharLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Object2CharLinkedOpenHashMap.this.key[last] = Object2CharLinkedOpenHashMap.this.key[pos];
      ...
      Object2CharLinkedOpenHashMap.this.used[last] = false;
      Object2CharLinkedOpenHashMap.this.key[last] = null;
      this.curr = -1;
    }
    ...
    implements Object2CharMap.Entry<K>, Map.Entry<K, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Object2CharLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Character> local_e = (Map.Entry)local_o;
      return (Object2CharLinkedOpenHashMap.this.key[this.index] == null ? local_e.getKey() == null : Object2CharLinkedOpenHashMap.this.key[this.index].equals(local_e.getKey())) && (Object2CharLinkedOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
