...
/*    7:     */import it.unimi.dsi.fastutil.doubles.AbstractDoubleCollection;
/*    8:     */import it.unimi.dsi.fastutil.doubles.DoubleCollection;
/*    9:     */import it.unimi.dsi.fastutil.doubles.DoubleIterator;
/*   10:     */import it.unimi.dsi.fastutil.doubles.DoubleListIterator;
...
/*   19:     */
/*  113:     */public class Object2DoubleLinkedOpenCustomHashMap<K>
/*  114:     */  extends AbstractObject2DoubleSortedMap<K>
...
/*  127:     */  protected volatile transient Object2DoubleSortedMap.FastSortedEntrySet<K> entries;
...
/*  146:     */  
/*  152:     */  public Object2DoubleLinkedOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy)
/*  153:     */  {
...
/*  162: 162 */    this.value = new double[this.n];
/*  163: 163 */    this.used = new boolean[this.n];
/*  164: 164 */    this.link = new long[this.n];
/*  165:     */  }
/*  166:     */  
/*  170:     */  public Object2DoubleLinkedOpenCustomHashMap(int expected, Hash.Strategy<K> strategy)
/*  171:     */  {
/*  172: 172 */    this(expected, 0.75F, strategy);
/*  173:     */  }
/*  174:     */  
/*  177:     */  public Object2DoubleLinkedOpenCustomHashMap(Hash.Strategy<K> strategy)
/*  178:     */  {
/*  179: 179 */    this(16, 0.75F, strategy);
/*  180:     */  }
/*  181:     */  
/*  186:     */  public Object2DoubleLinkedOpenCustomHashMap(Map<? extends K, ? extends Double> m, float f, Hash.Strategy<K> strategy)
/*  187:     */  {
/*  188: 188 */    this(m.size(), f, strategy);
/*  189: 189 */    putAll(m);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Object2DoubleLinkedOpenCustomHashMap(Map<? extends K, ? extends Double> m, Hash.Strategy<K> strategy)
/*  196:     */  {
/*  197: 197 */    this(m, 0.75F, strategy);
/*  198:     */  }
/*  199:     */  
/*  204:     */  public Object2DoubleLinkedOpenCustomHashMap(Object2DoubleMap<K> m, float f, Hash.Strategy<K> strategy)
/*  205:     */  {
/*  206: 206 */    this(m.size(), f, strategy);
/*  207: 207 */    putAll(m);
/*  208:     */  }
/*  209:     */  
/*  213:     */  public Object2DoubleLinkedOpenCustomHashMap(Object2DoubleMap<K> m, Hash.Strategy<K> strategy)
/*  214:     */  {
/*  215: 215 */    this(m, 0.75F, strategy);
/*  216:     */  }
/*  217:     */  
/*  224:     */  public Object2DoubleLinkedOpenCustomHashMap(K[] k, double[] v, float f, Hash.Strategy<K> strategy)
/*  225:     */  {
...
/*  230:     */  }
/*  231:     */  
/*  236:     */  public Object2DoubleLinkedOpenCustomHashMap(K[] k, double[] v, Hash.Strategy<K> strategy)
/*  237:     */  {
...
/*  246:     */  }
/*  247:     */  
/*  251:     */  public double put(K k, double v)
/*  252:     */  {
...
/*  257: 257 */        double oldValue = this.value[pos];
...
/*  279:     */  }
/*  280:     */  
/*  281: 281 */  public Double put(K ok, Double ov) { double v = ov.doubleValue();
/*  282: 282 */    K k = ok;
/*  283:     */    
...
/*  288: 288 */        Double oldValue = Double.valueOf(this.value[pos]);
...
/*  310:     */  }
/*  311:     */  
/*  322:     */  public double add(K k, double incr)
/*  323:     */  {
...
/*  328: 328 */        double oldValue = this.value[pos];
...
/*  375:     */  }
/*  376:     */  
/*  377:     */  public double removeDouble(Object k)
/*  378:     */  {
...
/*  385: 385 */        double v = this.value[pos];
...
/*  392:     */  }
/*  393:     */  
/*  394:     */  public Double remove(Object ok) {
/*  395: 395 */    K k = ok;
/*  396:     */    
...
/*  403: 403 */        double v = this.value[pos];
/*  404: 404 */        shiftKeys(pos);
/*  405: 405 */        return Double.valueOf(v);
/*  406:     */      }
...
/*  410:     */  }
/*  411:     */  
/*  414:     */  public double removeFirstDouble()
/*  415:     */  {
...
/*  424:     */    }
/*  425: 425 */    double v = this.value[pos];
/*  426: 426 */    shiftKeys(pos);
/*  427: 427 */    return v;
/*  428:     */  }
/*  429:     */  
/*  432:     */  public double removeLastDouble()
/*  433:     */  {
...
/*  442:     */    }
/*  443: 443 */    double v = this.value[pos];
...
/*  482:     */  }
/*  483:     */  
/*  487:     */  public double getAndMoveToFirst(K k)
/*  488:     */  {
...
/*  503:     */  }
/*  504:     */  
/*  508:     */  public double getAndMoveToLast(K k)
/*  509:     */  {
...
/*  524:     */  }
/*  525:     */  
/*  530:     */  public double putAndMoveToFirst(K k, double v)
/*  531:     */  {
...
/*  540: 540 */        double oldValue = this.value[pos];
...
/*  563:     */  }
/*  564:     */  
/*  569:     */  public double putAndMoveToLast(K k, double v)
/*  570:     */  {
...
/*  579: 579 */        double oldValue = this.value[pos];
...
/*  602:     */  }
/*  603:     */  
/*  604:     */  public double getDouble(Object k)
/*  605:     */  {
...
/*  624:     */  }
/*  625:     */  
/*  626: 626 */  public boolean containsValue(double v) { double[] value = this.value;
...
/*  670:     */    implements Object2DoubleMap.Entry<K>, Map.Entry<K, Double>
/*  671:     */  {
...
/*  677:     */    }
/*  678:     */    
/*  679: 679 */    public K getKey() { return Object2DoubleLinkedOpenCustomHashMap.this.key[this.index]; }
/*  680:     */    
/*  681:     */    public Double getValue() {
/*  682: 682 */      return Double.valueOf(Object2DoubleLinkedOpenCustomHashMap.this.value[this.index]);
/*  683:     */    }
/*  684:     */    
/*  685: 685 */    public double getDoubleValue() { return Object2DoubleLinkedOpenCustomHashMap.this.value[this.index]; }
/*  686:     */    
/*  687:     */    public double setValue(double v) {
/*  688: 688 */      double oldValue = Object2DoubleLinkedOpenCustomHashMap.this.value[this.index];
/*  689: 689 */      Object2DoubleLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  690: 690 */      return oldValue;
/*  691:     */    }
/*  692:     */    
/*  693: 693 */    public Double setValue(Double v) { return Double.valueOf(setValue(v.doubleValue())); }
/*  694:     */    
/*  695:     */    public boolean equals(Object o)
/*  696:     */    {
/*  697: 697 */      if (!(o instanceof Map.Entry)) return false;
/*  698: 698 */      Map.Entry<K, Double> e = (Map.Entry)o;
/*  699: 699 */      return (Object2DoubleLinkedOpenCustomHashMap.this.strategy.equals(Object2DoubleLinkedOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2DoubleLinkedOpenCustomHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*  700:     */    }
/*  701:     */    
/*  702: 702 */    public int hashCode() { return Object2DoubleLinkedOpenCustomHashMap.this.strategy.hashCode(Object2DoubleLinkedOpenCustomHashMap.this.key[this.index]) ^ HashCommon.double2int(Object2DoubleLinkedOpenCustomHashMap.this.value[this.index]); }
/*  703:     */    
/*  704:     */    public String toString() {
/*  705: 705 */      return Object2DoubleLinkedOpenCustomHashMap.this.key[this.index] + "=>" + Object2DoubleLinkedOpenCustomHashMap.this.value[this.index];
/*  706:     */    }
/*  707:     */  }
/*  708:     */  
...
/*  793: 793 */  public Object2DoubleSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  794: 794 */  public Object2DoubleSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); }
/*  795: 795 */  public Object2DoubleSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  796:     */  
...
/*  810: 810 */    int index = -1;
/*  811:     */    
/*  812: 812 */    private MapIterator() { this.next = Object2DoubleLinkedOpenCustomHashMap.this.first;
/*  813: 813 */      this.index = 0;
/*  814:     */    }
/*  815:     */    
/*  816: 816 */    private MapIterator() { if (Object2DoubleLinkedOpenCustomHashMap.this.strategy.equals(Object2DoubleLinkedOpenCustomHashMap.this.key[Object2DoubleLinkedOpenCustomHashMap.this.last], from)) {
/*  817: 817 */        this.prev = Object2DoubleLinkedOpenCustomHashMap.this.last;
/*  818: 818 */        this.index = Object2DoubleLinkedOpenCustomHashMap.this.size;
/*  819:     */      }
/*  820:     */      else
/*  821:     */      {
/*  822: 822 */        int pos = HashCommon.murmurHash3(Object2DoubleLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2DoubleLinkedOpenCustomHashMap.this.mask;
/*  823:     */        
/*  824: 824 */        while (Object2DoubleLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  825: 825 */          if (Object2DoubleLinkedOpenCustomHashMap.this.strategy.equals(Object2DoubleLinkedOpenCustomHashMap.this.key[pos], from))
/*  826:     */          {
/*  827: 827 */            this.next = ((int)Object2DoubleLinkedOpenCustomHashMap.this.link[pos]);
/*  828: 828 */            this.prev = pos;
/*  829: 829 */            return;
/*  830:     */          }
/*  831: 831 */          pos = pos + 1 & Object2DoubleLinkedOpenCustomHashMap.this.mask;
/*  832:     */        }
...
/*  845: 845 */        this.index = Object2DoubleLinkedOpenCustomHashMap.this.size;
/*  846: 846 */        return;
/*  847:     */      }
/*  848: 848 */      int pos = Object2DoubleLinkedOpenCustomHashMap.this.first;
/*  849: 849 */      this.index = 1;
/*  850: 850 */      while (pos != this.prev) {
/*  851: 851 */        pos = (int)Object2DoubleLinkedOpenCustomHashMap.this.link[pos];
...
/*  862:     */    }
/*  863:     */    
/*  864: 864 */    public int nextEntry() { if (!hasNext()) return Object2DoubleLinkedOpenCustomHashMap.this.size();
/*  865: 865 */      this.curr = this.next;
/*  866: 866 */      this.next = ((int)Object2DoubleLinkedOpenCustomHashMap.this.link[this.curr]);
...
/*  874: 874 */      this.prev = ((int)(Object2DoubleLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
...
/*  887: 887 */        this.prev = ((int)(Object2DoubleLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
/*  888:     */      }
/*  889:     */      else {
/*  890: 890 */        this.next = ((int)Object2DoubleLinkedOpenCustomHashMap.this.link[this.curr]); }
/*  891: 891 */      Object2DoubleLinkedOpenCustomHashMap.this.size -= 1;
/*  892:     */      
/*  894: 894 */      if (this.prev == -1) { Object2DoubleLinkedOpenCustomHashMap.this.first = this.next;
/*  895:     */      } else
/*  896: 896 */        Object2DoubleLinkedOpenCustomHashMap.this.link[this.prev] ^= (Object2DoubleLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  897: 897 */      if (this.next == -1) { Object2DoubleLinkedOpenCustomHashMap.this.last = this.prev;
/*  898:     */      } else
/*  899: 899 */        Object2DoubleLinkedOpenCustomHashMap.this.link[this.next] ^= (Object2DoubleLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  900: 900 */      int pos = this.curr;
/*  901:     */      int last;
/*  902:     */      for (;;) {
/*  903: 903 */        pos = (last = pos) + 1 & Object2DoubleLinkedOpenCustomHashMap.this.mask;
/*  904: 904 */        while (Object2DoubleLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  905: 905 */          int slot = HashCommon.murmurHash3(Object2DoubleLinkedOpenCustomHashMap.this.strategy.hashCode(Object2DoubleLinkedOpenCustomHashMap.this.key[pos])) & Object2DoubleLinkedOpenCustomHashMap.this.mask;
/*  906: 906 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  907: 907 */          pos = pos + 1 & Object2DoubleLinkedOpenCustomHashMap.this.mask;
/*  908:     */        }
/*  909: 909 */        if (Object2DoubleLinkedOpenCustomHashMap.this.used[pos] == 0) break;
/*  910: 910 */        Object2DoubleLinkedOpenCustomHashMap.this.key[last] = Object2DoubleLinkedOpenCustomHashMap.this.key[pos];
/*  911: 911 */        Object2DoubleLinkedOpenCustomHashMap.this.value[last] = Object2DoubleLinkedOpenCustomHashMap.this.value[pos];
/*  912: 912 */        if (this.next == pos) this.next = last;
/*  913: 913 */        if (this.prev == pos) this.prev = last;
/*  914: 914 */        Object2DoubleLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*  915:     */      }
/*  916: 916 */      Object2DoubleLinkedOpenCustomHashMap.this.used[last] = false;
/*  917: 917 */      Object2DoubleLinkedOpenCustomHashMap.this.key[last] = null;
/*  918: 918 */      this.curr = -1;
/*  919:     */    }
/*  920:     */    
...
/*  929:     */    } }
/*  930:     */  
/*  931:     */  private class EntryIterator extends Object2DoubleLinkedOpenCustomHashMap<K>.MapIterator implements ObjectListIterator<Object2DoubleMap.Entry<K>> { private Object2DoubleLinkedOpenCustomHashMap<K>.MapEntry entry;
/*  932:     */    
/*  933: 933 */    public EntryIterator() { super(null); }
/*  934:     */    
/*  935: 935 */    public EntryIterator() { super(from, null); }
/*  936:     */    
/*  937:     */    public Object2DoubleLinkedOpenCustomHashMap<K>.MapEntry next() {
/*  938: 938 */      return this.entry = new Object2DoubleLinkedOpenCustomHashMap.MapEntry(Object2DoubleLinkedOpenCustomHashMap.this, nextEntry());
/*  939:     */    }
/*  940:     */    
/*  941: 941 */    public Object2DoubleLinkedOpenCustomHashMap<K>.MapEntry previous() { return this.entry = new Object2DoubleLinkedOpenCustomHashMap.MapEntry(Object2DoubleLinkedOpenCustomHashMap.this, previousEntry()); }
/*  942:     */    
/*  943:     */    public void remove()
/*  944:     */    {
/*  945: 945 */      super.remove();
/*  946: 946 */      Object2DoubleLinkedOpenCustomHashMap.MapEntry.access$202(this.entry, -1); }
/*  947:     */    
/*  948: 948 */    public void set(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  949: 949 */    public void add(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  950:     */  }
/*  951:     */  
/*  952: 952 */  private class FastEntryIterator extends Object2DoubleLinkedOpenCustomHashMap<K>.MapIterator implements ObjectListIterator<Object2DoubleMap.Entry<K>> { final AbstractObject2DoubleMap.BasicEntry<K> entry = new AbstractObject2DoubleMap.BasicEntry(null, 0.0D);
/*  953: 953 */    public FastEntryIterator() { super(null); }
/*  954:     */    
/*  955: 955 */    public FastEntryIterator() { super(from, null); }
/*  956:     */    
/*  957:     */    public AbstractObject2DoubleMap.BasicEntry<K> next() {
/*  958: 958 */      int e = nextEntry();
/*  959: 959 */      this.entry.key = Object2DoubleLinkedOpenCustomHashMap.this.key[e];
/*  960: 960 */      this.entry.value = Object2DoubleLinkedOpenCustomHashMap.this.value[e];
/*  961: 961 */      return this.entry;
/*  962:     */    }
/*  963:     */    
/*  964: 964 */    public AbstractObject2DoubleMap.BasicEntry<K> previous() { int e = previousEntry();
/*  965: 965 */      this.entry.key = Object2DoubleLinkedOpenCustomHashMap.this.key[e];
/*  966: 966 */      this.entry.value = Object2DoubleLinkedOpenCustomHashMap.this.value[e];
/*  967: 967 */      return this.entry; }
/*  968:     */    
/*  969: 969 */    public void set(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  970: 970 */    public void add(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); } }
/*  971:     */  
/*  972:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Object2DoubleMap.Entry<K>> implements Object2DoubleSortedMap.FastSortedEntrySet<K> { private MapEntrySet() {}
/*  973:     */    
/*  974: 974 */    public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator() { return new Object2DoubleLinkedOpenCustomHashMap.EntryIterator(Object2DoubleLinkedOpenCustomHashMap.this); }
/*  975:     */    
/*  976: 976 */    public Comparator<? super Object2DoubleMap.Entry<K>> comparator() { return null; }
/*  977: 977 */    public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> fromElement, Object2DoubleMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  978: 978 */    public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  979: 979 */    public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); }
/*  980:     */    
/*  981: 981 */    public Object2DoubleMap.Entry<K> first() { if (Object2DoubleLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  982: 982 */      return new Object2DoubleLinkedOpenCustomHashMap.MapEntry(Object2DoubleLinkedOpenCustomHashMap.this, Object2DoubleLinkedOpenCustomHashMap.this.first);
/*  983:     */    }
/*  984:     */    
/*  985: 985 */    public Object2DoubleMap.Entry<K> last() { if (Object2DoubleLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  986: 986 */      return new Object2DoubleLinkedOpenCustomHashMap.MapEntry(Object2DoubleLinkedOpenCustomHashMap.this, Object2DoubleLinkedOpenCustomHashMap.this.last);
/*  987:     */    }
/*  988:     */    
/*  989:     */    public boolean contains(Object o) {
/*  990: 990 */      if (!(o instanceof Map.Entry)) return false;
/*  991: 991 */      Map.Entry<K, Double> e = (Map.Entry)o;
/*  992: 992 */      K k = e.getKey();
/*  993:     */      
/*  994: 994 */      int pos = HashCommon.murmurHash3(Object2DoubleLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2DoubleLinkedOpenCustomHashMap.this.mask;
/*  995:     */      
/*  996: 996 */      while (Object2DoubleLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  997: 997 */        if (Object2DoubleLinkedOpenCustomHashMap.this.strategy.equals(Object2DoubleLinkedOpenCustomHashMap.this.key[pos], k)) return Object2DoubleLinkedOpenCustomHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/*  998: 998 */        pos = pos + 1 & Object2DoubleLinkedOpenCustomHashMap.this.mask;
/*  999:     */      }
...
/* 1005:1005 */      Map.Entry<K, Double> e = (Map.Entry)o;
/* 1006:1006 */      K k = e.getKey();
/* 1007:     */      
/* 1008:1008 */      int pos = HashCommon.murmurHash3(Object2DoubleLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2DoubleLinkedOpenCustomHashMap.this.mask;
/* 1009:     */      
/* 1010:1010 */      while (Object2DoubleLinkedOpenCustomHashMap.this.used[pos] != 0) {
/* 1011:1011 */        if (Object2DoubleLinkedOpenCustomHashMap.this.strategy.equals(Object2DoubleLinkedOpenCustomHashMap.this.key[pos], k)) {
/* 1012:1012 */          Object2DoubleLinkedOpenCustomHashMap.this.remove(e.getKey());
/* 1013:1013 */          return true;
/* 1014:     */        }
/* 1015:1015 */        pos = pos + 1 & Object2DoubleLinkedOpenCustomHashMap.this.mask;
/* 1016:     */      }
/* 1017:1017 */      return false;
/* 1018:     */    }
/* 1019:     */    
/* 1020:1020 */    public int size() { return Object2DoubleLinkedOpenCustomHashMap.this.size; }
/* 1021:     */    
/* 1022:     */    public void clear() {
/* 1023:1023 */      Object2DoubleLinkedOpenCustomHashMap.this.clear();
/* 1024:     */    }
/* 1025:     */    
/* 1026:1026 */    public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) { return new Object2DoubleLinkedOpenCustomHashMap.EntryIterator(Object2DoubleLinkedOpenCustomHashMap.this, from.getKey()); }
/* 1027:     */    
/* 1028:     */    public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> fastIterator() {
/* 1029:1029 */      return new Object2DoubleLinkedOpenCustomHashMap.FastEntryIterator(Object2DoubleLinkedOpenCustomHashMap.this);
/* 1030:     */    }
/* 1031:     */    
/* 1032:1032 */    public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> fastIterator(Object2DoubleMap.Entry<K> from) { return new Object2DoubleLinkedOpenCustomHashMap.FastEntryIterator(Object2DoubleLinkedOpenCustomHashMap.this, from.getKey()); }
/* 1033:     */  }
/* 1034:     */  
/* 1035:     */  public Object2DoubleSortedMap.FastSortedEntrySet<K> object2DoubleEntrySet() {
...
/* 1043:     */    extends Object2DoubleLinkedOpenCustomHashMap<K>.MapIterator
/* 1044:     */    implements ObjectListIterator<K>
/* 1045:     */  {
/* 1046:1046 */    public KeyIterator() { super(k, null); }
/* 1047:1047 */    public K previous() { return Object2DoubleLinkedOpenCustomHashMap.this.key[previousEntry()]; }
...
/* 1051:1051 */    public K next() { return Object2DoubleLinkedOpenCustomHashMap.this.key[nextEntry()]; } }
/* 1052:     */  
/* 1053:     */  private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/* 1054:     */    
/* 1055:1055 */    public ObjectListIterator<K> iterator(K from) { return new Object2DoubleLinkedOpenCustomHashMap.KeyIterator(Object2DoubleLinkedOpenCustomHashMap.this, from); }
/* 1056:     */    
/* 1057:     */    public ObjectListIterator<K> iterator() {
/* 1058:1058 */      return new Object2DoubleLinkedOpenCustomHashMap.KeyIterator(Object2DoubleLinkedOpenCustomHashMap.this);
/* 1059:     */    }
/* 1060:     */    
/* 1061:1061 */    public int size() { return Object2DoubleLinkedOpenCustomHashMap.this.size; }
/* 1062:     */    
/* 1064:1064 */    public boolean contains(Object k) { return Object2DoubleLinkedOpenCustomHashMap.this.containsKey(k); }
/* 1065:     */    
/* 1066:     */    public boolean remove(Object k) {
/* 1067:1067 */      int oldSize = Object2DoubleLinkedOpenCustomHashMap.this.size;
/* 1068:1068 */      Object2DoubleLinkedOpenCustomHashMap.this.remove(k);
/* 1069:1069 */      return Object2DoubleLinkedOpenCustomHashMap.this.size != oldSize;
/* 1070:     */    }
/* 1071:     */    
/* 1072:1072 */    public void clear() { Object2DoubleLinkedOpenCustomHashMap.this.clear(); }
/* 1073:     */    
/* 1074:     */    public K first() {
/* 1075:1075 */      if (Object2DoubleLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076:1076 */      return Object2DoubleLinkedOpenCustomHashMap.this.key[Object2DoubleLinkedOpenCustomHashMap.this.first];
/* 1077:     */    }
/* 1078:     */    
/* 1079:1079 */    public K last() { if (Object2DoubleLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1080:1080 */      return Object2DoubleLinkedOpenCustomHashMap.this.key[Object2DoubleLinkedOpenCustomHashMap.this.last]; }
/* 1081:     */    
...
/* 1095:     */    extends Object2DoubleLinkedOpenCustomHashMap.MapIterator
/* 1096:     */    implements DoubleListIterator
/* 1097:     */  {
/* 1098:1098 */    public double previousDouble() { return Object2DoubleLinkedOpenCustomHashMap.this.value[previousEntry()]; }
/* 1099:1099 */    public Double previous() { return Double.valueOf(Object2DoubleLinkedOpenCustomHashMap.this.value[previousEntry()]); }
/* 1100:1100 */    public void set(Double ok) { throw new UnsupportedOperationException(); }
/* 1101:1101 */    public void add(Double ok) { throw new UnsupportedOperationException(); }
/* 1102:1102 */    public void set(double v) { throw new UnsupportedOperationException(); }
/* 1103:1103 */    public void add(double v) { throw new UnsupportedOperationException(); }
/* 1104:1104 */    public ValueIterator() { super(null); }
/* 1105:1105 */    public double nextDouble() { return Object2DoubleLinkedOpenCustomHashMap.this.value[nextEntry()]; }
/* 1106:1106 */    public Double next() { return Double.valueOf(Object2DoubleLinkedOpenCustomHashMap.this.value[nextEntry()]); }
/* 1107:     */  }
/* 1108:     */  
/* 1109:1109 */  public DoubleCollection values() { if (this.values == null) { this.values = new AbstractDoubleCollection() {
/* 1110:     */        public DoubleIterator iterator() {
/* 1111:1111 */          return new Object2DoubleLinkedOpenCustomHashMap.ValueIterator(Object2DoubleLinkedOpenCustomHashMap.this);
/* 1112:     */        }
/* 1113:     */        
/* 1114:1114 */        public int size() { return Object2DoubleLinkedOpenCustomHashMap.this.size; }
/* 1115:     */        
/* 1116:     */        public boolean contains(double v) {
/* 1117:1117 */          return Object2DoubleLinkedOpenCustomHashMap.this.containsValue(v);
/* 1118:     */        }
/* 1119:     */        
/* 1120:1120 */        public void clear() { Object2DoubleLinkedOpenCustomHashMap.this.clear(); }
/* 1121:     */      };
/* 1122:     */    }
...
/* 1201:1201 */    double[] value = this.value;
/* 1202:1202 */    int newMask = newN - 1;
/* 1203:1203 */    K[] newKey = (Object[])new Object[newN];
/* 1204:1204 */    double[] newValue = new double[newN];
...
/* 1242:     */  }
/* 1243:     */  
/* 1246:     */  public Object2DoubleLinkedOpenCustomHashMap<K> clone()
/* 1247:     */  {
/* 1248:     */    Object2DoubleLinkedOpenCustomHashMap<K> c;
/* 1249:     */    
/* 1251:     */    try
/* 1252:     */    {
/* 1253:1253 */      c = (Object2DoubleLinkedOpenCustomHashMap)super.clone();
/* 1254:     */    }
...
/* 1262:1262 */    c.value = ((double[])this.value.clone());
...
/* 1283:1283 */      t ^= HashCommon.double2int(this.value[i]);
/* 1284:1284 */      h += t;
/* 1285:1285 */      i++;
/* 1286:     */    }
/* 1287:1287 */    return h;
...
/* 1291:1291 */    double[] value = this.value;
/* 1292:1292 */    Object2DoubleLinkedOpenCustomHashMap<K>.MapIterator i = new MapIterator(null);
/* 1293:1293 */    s.defaultWriteObject();
/* 1294:1294 */    for (int j = this.size; j-- != 0;) {
/* 1295:1295 */      int e = i.nextEntry();
/* 1296:1296 */      s.writeObject(key[e]);
/* 1297:1297 */      s.writeDouble(value[e]);
/* 1298:     */    }
/* 1299:     */  }
/* 1300:     */  
...
/* 1307:1307 */    double[] value = this.value = new double[this.n];
...
/* 1316:1316 */      double v = s.readDouble();
