...
/* 649 */           return new Reference2FloatOpenCustomHashMap.ValueIterator(Reference2FloatOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 652 */           return Reference2FloatOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(float v) {
/* 655 */           return Reference2FloatOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 658 */           Reference2FloatOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 773 */       c = (Reference2FloatOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Reference2FloatOpenCustomHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 642 */       super(null); } 
/* 643 */     public float nextFloat() { return Reference2FloatOpenCustomHashMap.this.value[nextEntry()]; } 
/* 644 */     public Float next() { return Float.valueOf(Reference2FloatOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 614 */       return new Reference2FloatOpenCustomHashMap.KeyIterator(Reference2FloatOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 617 */       return Reference2FloatOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 620 */       return Reference2FloatOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 623 */       int oldSize = Reference2FloatOpenCustomHashMap.this.size;
/* 624 */       Reference2FloatOpenCustomHashMap.this.remove(k);
/* 625 */       return Reference2FloatOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 628 */       Reference2FloatOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Reference2FloatOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 609 */       super(null); } 
/* 610 */     public K next() { return Reference2FloatOpenCustomHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 555 */       return new Reference2FloatOpenCustomHashMap.EntryIterator(Reference2FloatOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Reference2FloatMap.Entry<K>> fastIterator() {
/* 558 */       return new Reference2FloatOpenCustomHashMap.FastEntryIterator(Reference2FloatOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 566 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2FloatOpenCustomHashMap.this.mask;
/*     */ 
/* 568 */       while (Reference2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 569 */         if (Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[pos], k)) return Reference2FloatOpenCustomHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 570 */         pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask;
/*     */       }
/* 572 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 580 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2FloatOpenCustomHashMap.this.mask;
/*     */ 
/* 582 */       while (Reference2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 583 */         if (Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[pos], k)) {
/* 584 */           Reference2FloatOpenCustomHashMap.this.remove(e.getKey());
/* 585 */           return true;
/*     */         }
/* 587 */         pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask;
/*     */       }
/* 589 */       return false;
/*     */     }
/*     */     public int size() {
/* 592 */       return Reference2FloatOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 595 */       Reference2FloatOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Reference2FloatOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2FloatMap.Entry<K>>
/*     */   {
/* 545 */     final AbstractReference2FloatMap.BasicEntry<K> entry = new AbstractReference2FloatMap.BasicEntry(null, 0.0F);
/*     */ 
...
/* 547 */       int e = nextEntry();
/* 548 */       this.entry.key = Reference2FloatOpenCustomHashMap.this.key[e];
/* 549 */       this.entry.value = Reference2FloatOpenCustomHashMap.this.value[e];
/* 550 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Reference2FloatOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2FloatMap.Entry<K>>
/*     */   {
...
/* 536 */       return this.entry = new Reference2FloatOpenCustomHashMap.MapEntry(Reference2FloatOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 540 */       super.remove();
/* 541 */       Reference2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 441 */       this.pos = Reference2FloatOpenCustomHashMap.this.n;
/*     */ 
/* 444 */       this.last = -1;
/*     */ 
/* 446 */       this.c = Reference2FloatOpenCustomHashMap.this.size;
/*     */ 
/* 451 */       boolean[] used = Reference2FloatOpenCustomHashMap.this.used;
...
/*     */ 
/* 464 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2FloatOpenCustomHashMap.this.mask;
/*     */ 
/* 466 */         while (Reference2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 467 */           if (Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[pos], k)) return pos;
/* 468 */           pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 471 */       this.last = this.pos;
/*     */ 
/* 473 */       if (this.c != 0) {
/* 474 */         boolean[] used = Reference2FloatOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 491 */         pos = (last = pos) + 1 & Reference2FloatOpenCustomHashMap.this.mask;
/* 492 */         while (Reference2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 493 */           int slot = (Reference2FloatOpenCustomHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2FloatOpenCustomHashMap.this.key[pos]))) & Reference2FloatOpenCustomHashMap.this.mask;
/* 494 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 495 */           pos = pos + 1 & Reference2FloatOpenCustomHashMap.this.mask;
/*     */         }
/* 497 */         if (Reference2FloatOpenCustomHashMap.this.used[pos] == 0) break;
/* 498 */         if (pos < last)
/*     */         {
/* 500 */           if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 501 */           this.wrapped.add(Reference2FloatOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 503 */         Reference2FloatOpenCustomHashMap.this.key[last] = Reference2FloatOpenCustomHashMap.this.key[pos];
/* 504 */         Reference2FloatOpenCustomHashMap.this.value[last] = Reference2FloatOpenCustomHashMap.this.value[pos];
/*     */       }
/* 506 */       Reference2FloatOpenCustomHashMap.this.used[last] = false;
/* 507 */       Reference2FloatOpenCustomHashMap.this.key[last] = null;
/* 508 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 513 */       if (this.pos < -1)
/*     */       {
/* 515 */         Reference2FloatOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 516 */         this.last = -1;
/* 517 */         return;
/*     */       }
/* 519 */       Reference2FloatOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 408 */       return Reference2FloatOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Float getValue() {
/* 411 */       return Float.valueOf(Reference2FloatOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public float getFloatValue() {
/* 414 */       return Reference2FloatOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public float setValue(float v) {
/* 417 */       float oldValue = Reference2FloatOpenCustomHashMap.this.value[this.index];
/* 418 */       Reference2FloatOpenCustomHashMap.this.value[this.index] = v;
/* 419 */       return oldValue;
/*     */     }
/*     */     public Float setValue(Float v) {
...
/* 428 */       return (Reference2FloatOpenCustomHashMap.this.strategy.equals(Reference2FloatOpenCustomHashMap.this.key[this.index], e.getKey())) && (Reference2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */     public int hashCode() {
/* 431 */       return (Reference2FloatOpenCustomHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2FloatOpenCustomHashMap.this.key[this.index])) ^ HashCommon.float2int(Reference2FloatOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 434 */       return Reference2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Reference2FloatOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
