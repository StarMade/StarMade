...
/*  12:    */
/*  60:    */public abstract class AbstractReference2BooleanMap<K>
/*  61:    */  extends AbstractReference2BooleanFunction<K>
/*  62:    */  implements Reference2BooleanMap<K>, Serializable
/*  63:    */{
...
/*  88: 88 */    if ((m instanceof Reference2BooleanMap))
/*  89:    */    {
/*  90: 90 */      while (n-- != 0) {
/*  91: 91 */        Reference2BooleanMap.Entry<? extends K> e = (Reference2BooleanMap.Entry)i.next();
...
/* 109:    */    implements Reference2BooleanMap.Entry<K>
/* 110:    */  {
/* 111:    */    protected K key;
...
/* 162:    */      
/* 163:163 */      return (this.key == e.getKey()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/* 164:    */    }
/* 165:    */    
/* 166:    */    public int hashCode() {
/* 167:167 */      return (this.key == null ? 0 : System.identityHashCode(this.key)) ^ (this.value ? 1231 : 1237);
/* 168:    */    }
/* 169:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(Object k) { return AbstractReference2BooleanMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractReference2BooleanMap.this.size(); }
/* 196:196 */      public void clear() { AbstractReference2BooleanMap.this.clear(); }
/* 197:    */      
/* 198:    */      public ObjectIterator<K> iterator() {
/* 199:199 */        new AbstractObjectIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<K, Boolean>> i = AbstractReference2BooleanMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public K next() { return ((Reference2BooleanMap.Entry)this.i.next()).getKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(boolean k) { return AbstractReference2BooleanMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractReference2BooleanMap.this.size(); }
/* 229:229 */      public void clear() { AbstractReference2BooleanMap.this.clear(); }
/* 230:    */      
/* 231:    */      public BooleanIterator iterator() {
/* 232:232 */        new AbstractBooleanIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<K, Boolean>> i = AbstractReference2BooleanMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public boolean nextBoolean() { return ((Reference2BooleanMap.Entry)this.i.next()).getBooleanValue(); }
/* 236:    */          
...
/* 245:    */  {
/* 246:246 */    return reference2BooleanEntrySet();
/* 247:    */  }
/* 248:    */  
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Reference2BooleanMap.Entry<K> e = (Reference2BooleanMap.Entry)i.next();
/* 290:    */      
