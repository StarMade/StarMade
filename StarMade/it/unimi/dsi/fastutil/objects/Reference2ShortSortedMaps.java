...
public class Reference2ShortSortedMaps
{
  ...
  public static <K> Reference2ShortSortedMap<K> synchronize(Reference2ShortSortedMap<K> local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static <K> Reference2ShortSortedMap<K> synchronize(Reference2ShortSortedMap<K> local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static <K> Reference2ShortSortedMap<K> unmodifiable(Reference2ShortSortedMap<K> local_m)
  {
    ...
    implements Reference2ShortSortedMap<K>, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Reference2ShortSortedMap<K> local_m)
    {
      super();
    ...
    implements Reference2ShortSortedMap<K>, Serializable
  {
    ...
    protected SynchronizedSortedMap(Reference2ShortSortedMap<K> local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Reference2ShortSortedMap<K> local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Reference2ShortSortedMap<K>, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Reference2ShortMaps.Singleton.SingletonEntry(this), Reference2ShortSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
