  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2ReferenceOpenHashMap(int expected, float local_f)
  {
  ...
  public Object2ReferenceOpenHashMap(Map<? extends K, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ReferenceOpenHashMap(Map<? extends K, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ReferenceOpenHashMap(Object2ReferenceMap<K, V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ReferenceOpenHashMap(Object2ReferenceMap<K, V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ReferenceOpenHashMap(K[] local_k, V[] local_v, float local_f)
  {
  ...
  public Object2ReferenceOpenHashMap(K[] local_k, V[] local_v)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Object2ReferenceOpenHashMap.ValueIterator(Object2ReferenceOpenHashMap.this);
        }
        ...
        {
          return Object2ReferenceOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2ReferenceOpenHashMap<K, V> local_c;
    try
    {
      local_c = (Object2ReferenceOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    V[] value = this.value;
    Object2ReferenceOpenHashMap<K, V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractObjectSet<K>
  {
    ...
    {
      return new Object2ReferenceOpenHashMap.KeyIterator(Object2ReferenceOpenHashMap.this);
    }
    ...
    {
      return Object2ReferenceOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2ReferenceOpenHashMap.this.size;
      Object2ReferenceOpenHashMap.this.remove(local_k);
    ...
    implements Object2ReferenceMap.FastEntrySet<K, V>
  {
    ...
    {
      return new Object2ReferenceOpenHashMap.EntryIterator(Object2ReferenceOpenHashMap.this, null);
    }
    
    public ObjectIterator<Object2ReferenceMap.Entry<K, V>> fastIterator()
    {
      return new Object2ReferenceOpenHashMap.FastEntryIterator(Object2ReferenceOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ReferenceOpenHashMap.this.mask; Object2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ReferenceOpenHashMap.this.mask) {
        if (Object2ReferenceOpenHashMap.this.key[pos] == null ? local_k == null : Object2ReferenceOpenHashMap.this.key[pos].equals(local_k)) {
          return Object2ReferenceOpenHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ReferenceOpenHashMap.this.mask; Object2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ReferenceOpenHashMap.this.mask) {
        if (Object2ReferenceOpenHashMap.this.key[pos] == null ? local_k == null : Object2ReferenceOpenHashMap.this.key[pos].equals(local_k))
        {
          Object2ReferenceOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Object2ReferenceMap.Entry<K, V>>
  {
    ...
    public AbstractObject2ReferenceMap.BasicEntry<K, V> next()
    {
      ...
      this.entry.key = Object2ReferenceOpenHashMap.this.key[local_e];
      this.entry.value = Object2ReferenceOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Object2ReferenceMap.Entry<K, V>>
  {
    ...
    {
      return this.entry = new Object2ReferenceOpenHashMap.MapEntry(Object2ReferenceOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Object2ReferenceOpenHashMap.this.field_49;
    int last = -1;
    int field_1884 = Object2ReferenceOpenHashMap.this.size;
    ObjectArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Object2ReferenceOpenHashMap.this.used;
      while ((this.field_1884 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1884 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1884 != 0)
      {
        boolean[] local_k = Object2ReferenceOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2ReferenceOpenHashMap.this.mask; Object2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ReferenceOpenHashMap.this.mask)
        {
          int slot = (Object2ReferenceOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ReferenceOpenHashMap.this.key[pos].hashCode())) & Object2ReferenceOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2ReferenceOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Object2ReferenceOpenHashMap.this.key[pos]);
        }
        Object2ReferenceOpenHashMap.this.key[last] = Object2ReferenceOpenHashMap.this.key[pos];
        Object2ReferenceOpenHashMap.this.value[last] = Object2ReferenceOpenHashMap.this.value[pos];
      }
      Object2ReferenceOpenHashMap.this.used[last] = false;
      Object2ReferenceOpenHashMap.this.key[last] = null;
    ...
    public void remove()
    {
      ...
      Object2ReferenceOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1884 > 0))
      {
        this.field_1884 += 1;
        nextEntry();
      }
    ...
    implements Object2ReferenceMap.Entry<K, V>, Map.Entry<K, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Object2ReferenceOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, V> local_e = (Map.Entry)local_o;
      return (Object2ReferenceOpenHashMap.this.key[this.index] == null ? local_e.getKey() == null : Object2ReferenceOpenHashMap.this.key[this.index].equals(local_e.getKey())) && (Object2ReferenceOpenHashMap.this.value[this.index] == local_e.getValue());
    }
