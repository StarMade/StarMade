...
public class Reference2ReferenceFunctions
{
  ...
  public static <K, V> Reference2ReferenceFunction<K, V> synchronize(Reference2ReferenceFunction<K, V> local_f)
  {
    return new SynchronizedFunction(local_f);
  }
  
  public static <K, V> Reference2ReferenceFunction<K, V> synchronize(Reference2ReferenceFunction<K, V> local_f, Object sync)
  {
    return new SynchronizedFunction(local_f, sync);
  }
  
  public static <K, V> Reference2ReferenceFunction<K, V> unmodifiable(Reference2ReferenceFunction<K, V> local_f)
  {
    ...
    implements Serializable
  {
    ...
    protected UnmodifiableFunction(Reference2ReferenceFunction<K, V> local_f)
    {
      if (local_f == null) {
    ...
    implements Serializable
  {
    ...
    protected SynchronizedFunction(Reference2ReferenceFunction<K, V> local_f, Object sync)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
    ...
    protected SynchronizedFunction(Reference2ReferenceFunction<K, V> local_f)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
