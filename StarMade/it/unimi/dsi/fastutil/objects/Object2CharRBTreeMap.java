...
/*  597 */     char oldValue = put(ok, ov.charValue());
/*  598 */     return this.modified ? null : Character.valueOf(oldValue);
/*      */   }
/*      */   public Character remove(Object ok) {
/*  601 */     char oldValue = removeChar(ok);
/*  602 */     return this.modified ? Character.valueOf(oldValue) : null;
/*      */   }
...
/*  949 */         final Comparator<? super Object2CharMap.Entry<K>> comparator = new Comparator() {
/*      */           public int compare(Object2CharMap.Entry<K> x, Object2CharMap.Entry<K> y) {
/*  951 */             return Object2CharRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/*  949 */         };
/*      */ 
...
/*  958 */           return new Object2CharRBTreeMap.EntryIterator(Object2CharRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator(Object2CharMap.Entry<K> from) {
/*  961 */           return new Object2CharRBTreeMap.EntryIterator(Object2CharRBTreeMap.this, from.getKey());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/*  965 */           if (!(o instanceof Map.Entry)) return false;
/*  966 */           Map.Entry e = (Map.Entry)o;
/*  967 */           Object2CharRBTreeMap.Entry f = Object2CharRBTreeMap.this.findKey(e.getKey());
...
/*  974 */           Object2CharRBTreeMap.Entry f = Object2CharRBTreeMap.this.findKey(e.getKey());
/*  975 */           if (f != null) Object2CharRBTreeMap.this.removeChar(f.key);
/*  976 */           return f != null;
/*      */         }
/*  978 */         public int size() { return Object2CharRBTreeMap.this.count; } 
/*  979 */         public void clear() { Object2CharRBTreeMap.this.clear(); } 
/*  980 */         public Object2CharMap.Entry<K> first() { return Object2CharRBTreeMap.this.firstEntry; } 
/*  981 */         public Object2CharMap.Entry<K> last() { return Object2CharRBTreeMap.this.lastEntry; } 
/*  982 */         public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> from, Object2CharMap.Entry<K> to) { return Object2CharRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2CharEntrySet(); } 
/*  983 */         public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> to) { return Object2CharRBTreeMap.this.headMap(to.getKey()).object2CharEntrySet(); } 
/*  984 */         public ObjectSortedSet<Object2CharMap.Entry<K>> tailSet(Object2CharMap.Entry<K> from) { return Object2CharRBTreeMap.this.tailMap(from.getKey()).object2CharEntrySet(); }
/*      */       };
...
/*      */   {
/* 1044 */     if (this.values == null) this.values = new AbstractCharCollection() {
/*      */         public CharIterator iterator() {
/* 1046 */           return new Object2CharRBTreeMap.ValueIterator(Object2CharRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(char k) {
/* 1049 */           return Object2CharRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1052 */           return Object2CharRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1055 */           Object2CharRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1407 */       c = (Object2CharRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1479 */     if (n == 1) {
/* 1480 */       Entry top = new Entry(s.readObject(), s.readChar());
/* 1481 */       top.pred(pred);
/* 1482 */       top.succ(succ);
/* 1483 */       top.black(true);
/* 1484 */       return top;
...
/* 1486 */     if (n == 2)
/*      */     {
/* 1489 */       Entry top = new Entry(s.readObject(), s.readChar());
/* 1490 */       top.black(true);
/* 1491 */       top.right(new Entry(s.readObject(), s.readChar()));
...
/*      */     {
/* 1108 */       if ((!bottom) && (!top) && (Object2CharRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1109 */       this.from = from;
/* 1110 */       this.bottom = bottom;
/* 1111 */       this.to = to;
/* 1112 */       this.top = top;
/* 1113 */       this.defRetValue = Object2CharRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1127 */       return ((this.bottom) || (Object2CharRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Object2CharRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Object2CharMap.Entry<K>> object2CharEntrySet() {
/* 1131 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator() {
/* 1133 */             return new Object2CharRBTreeMap.Submap.SubmapEntryIterator(Object2CharRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator(Object2CharMap.Entry<K> from) {
/* 1136 */             return new Object2CharRBTreeMap.Submap.SubmapEntryIterator(Object2CharRBTreeMap.Submap.this, from.getKey());
/*      */           }
/* 1138 */           public Comparator<? super Object2CharMap.Entry<K>> comparator() { return Object2CharRBTreeMap.this.object2CharEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1141 */             if (!(o instanceof Map.Entry)) return false;
/* 1142 */             Map.Entry e = (Map.Entry)o;
/* 1143 */             Object2CharRBTreeMap.Entry f = Object2CharRBTreeMap.this.findKey(e.getKey());
/* 1144 */             return (f != null) && (Object2CharRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1148 */             if (!(o instanceof Map.Entry)) return false;
/* 1149 */             Map.Entry e = (Map.Entry)o;
/* 1150 */             Object2CharRBTreeMap.Entry f = Object2CharRBTreeMap.this.findKey(e.getKey());
/* 1151 */             if ((f != null) && (Object2CharRBTreeMap.Submap.this.in(f.key))) Object2CharRBTreeMap.Submap.this.removeChar(f.key);
/* 1152 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1155 */             int c = 0;
...
/* 1157 */             return c;
/*      */           }
/* 1159 */           public boolean isEmpty() { return !new Object2CharRBTreeMap.Submap.SubmapIterator(Object2CharRBTreeMap.Submap.this).hasNext(); } 
/* 1160 */           public void clear() { Object2CharRBTreeMap.Submap.this.clear(); } 
/* 1161 */           public Object2CharMap.Entry<K> first() { return Object2CharRBTreeMap.Submap.this.firstEntry(); } 
/* 1162 */           public Object2CharMap.Entry<K> last() { return Object2CharRBTreeMap.Submap.this.lastEntry(); } 
/* 1163 */           public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> from, Object2CharMap.Entry<K> to) { return Object2CharRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2CharEntrySet(); } 
/* 1164 */           public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> to) { return Object2CharRBTreeMap.Submap.this.headMap(to.getKey()).object2CharEntrySet(); } 
/* 1165 */           public ObjectSortedSet<Object2CharMap.Entry<K>> tailSet(Object2CharMap.Entry<K> from) { return Object2CharRBTreeMap.Submap.this.tailMap(from.getKey()).object2CharEntrySet(); }
/*      */         };
...
/*      */     }
/*      */     public CharCollection values() {
/* 1178 */       if (this.values == null) this.values = new AbstractCharCollection() {
/*      */           public CharIterator iterator() {
/* 1180 */             return new Object2CharRBTreeMap.Submap.SubmapValueIterator(Object2CharRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(char k) {
/* 1183 */             return Object2CharRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1186 */             return Object2CharRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1189 */             Object2CharRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(Object k) {
/* 1196 */       return (in(k)) && (Object2CharRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(char v) {
/* 1199 */       SubmapIterator i = new SubmapIterator();
/*      */ 
/* 1201 */       while (i.hasNext()) {
/* 1202 */         char ev = i.nextEntry().value;
...
/*      */     {
/* 1210 */       Object kk = k;
/*      */       Object2CharRBTreeMap.Entry e;
/* 1211 */       return (in(kk)) && ((e = Object2CharRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     public Character get(Object ok)
/*      */     {
/* 1216 */       Object kk = ok;
/*      */       Object2CharRBTreeMap.Entry e;
/* 1217 */       return (in(kk)) && ((e = Object2CharRBTreeMap.this.findKey(kk)) != null) ? e.getValue() : null;
/*      */     }
/*      */     public char put(K k, char v) {
/* 1220 */       Object2CharRBTreeMap.this.modified = false;
...
/* 1222 */       char oldValue = Object2CharRBTreeMap.this.put(k, v);
/* 1223 */       return Object2CharRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Character put(K ok, Character ov) {
/* 1226 */       char oldValue = put(ok, ov.charValue());
/* 1227 */       return Object2CharRBTreeMap.this.modified ? null : Character.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public char removeChar(Object k) {
/* 1231 */       Object2CharRBTreeMap.this.modified = false;
/* 1232 */       if (!in(k)) return this.defRetValue;
/* 1233 */       char oldValue = Object2CharRBTreeMap.this.removeChar(k);
/* 1234 */       return Object2CharRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Character remove(Object ok) {
/* 1237 */       char oldValue = removeChar(ok);
/* 1238 */       return Object2CharRBTreeMap.this.modified ? Character.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public Comparator<? super K> comparator() {
/* 1253 */       return Object2CharRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Object2CharSortedMap<K> headMap(K to) {
/* 1256 */       if (this.top) return new Submap(Object2CharRBTreeMap.this, this.from, this.bottom, to, false);
/* 1257 */       return Object2CharRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Object2CharRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Object2CharSortedMap<K> tailMap(K from) {
/* 1260 */       if (this.bottom) return new Submap(Object2CharRBTreeMap.this, from, false, this.to, this.top);
/* 1261 */       return Object2CharRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2CharRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Object2CharSortedMap<K> subMap(K from, K to) {
/* 1264 */       if ((this.top) && (this.bottom)) return new Submap(Object2CharRBTreeMap.this, from, false, to, false);
/* 1265 */       if (!this.top) to = Object2CharRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1266 */       if (!this.bottom) from = Object2CharRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1267 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1268 */       return new Submap(Object2CharRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Object2CharRBTreeMap.Entry<K> firstEntry()
/*      */     {
/* 1275 */       if (Object2CharRBTreeMap.this.tree == null) return null;
/* 1278 */       Object2CharRBTreeMap.Entry e;
/*      */       Object2CharRBTreeMap.Entry e;
/* 1278 */       if (this.bottom) { e = Object2CharRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1280 */         e = Object2CharRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1282 */         if (Object2CharRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1285 */       if ((e == null) || ((!this.top) && (Object2CharRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1286 */       return e;
/*      */     }
/*      */ 
/*      */     public Object2CharRBTreeMap.Entry<K> lastEntry()
/*      */     {
/* 1293 */       if (Object2CharRBTreeMap.this.tree == null) return null;
/* 1296 */       Object2CharRBTreeMap.Entry e;
/*      */       Object2CharRBTreeMap.Entry e;
/* 1296 */       if (this.top) { e = Object2CharRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1298 */         e = Object2CharRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1300 */         if (Object2CharRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1303 */       if ((e == null) || ((!this.bottom) && (Object2CharRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1304 */       return e;
/*      */     }
/*      */     public K firstKey() {
/* 1307 */       Object2CharRBTreeMap.Entry e = firstEntry();
/* 1308 */       if (e == null) throw new NoSuchElementException();
/* 1309 */       return e.key;
/*      */     }
/*      */     public K lastKey() {
/* 1312 */       Object2CharRBTreeMap.Entry e = lastEntry();
/* 1313 */       if (e == null) throw new NoSuchElementException();
/* 1314 */       return e.key;
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Object2CharRBTreeMap.Submap.SubmapIterator
/*      */       implements CharListIterator
/*      */     {
/*      */       private SubmapValueIterator()
/*      */       {
/* 1385 */         super(); } 
/* 1386 */       public char nextChar() { return nextEntry().value; } 
/* 1387 */       public char previousChar() { return previousEntry().value; } 
/* 1388 */       public void set(char v) { throw new UnsupportedOperationException(); } 
/* 1389 */       public void add(char v) { throw new UnsupportedOperationException(); } 
/* 1390 */       public Character next() { return Character.valueOf(nextEntry().value); } 
/* 1391 */       public Character previous() { return Character.valueOf(previousEntry().value); } 
/* 1392 */       public void set(Character ok) { throw new UnsupportedOperationException(); } 
/* 1393 */       public void add(Character ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Object2CharRBTreeMap<K>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Object2CharRBTreeMap<K>.Submap.SubmapIterator
...
/* 1357 */       public Object2CharMap.Entry<K> previous() { return previousEntry(); } 
/* 1358 */       public void set(Object2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/* 1359 */       public void add(Object2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Object2CharRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1324 */         super();
/* 1325 */         this.next = Object2CharRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator() {
/* 1328 */         this();
/* 1329 */         if (this.next != null)
/* 1330 */           if ((!Object2CharRBTreeMap.Submap.this.bottom) && (Object2CharRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1331 */           } else if ((!Object2CharRBTreeMap.Submap.this.top) && (Object2CharRBTreeMap.this.compare(k, (this.prev = Object2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1333 */             this.next = Object2CharRBTreeMap.this.locateKey(k);
/* 1334 */             if (Object2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1344 */         if ((!Object2CharRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2CharRBTreeMap.this.compare(this.prev.key, Object2CharRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1347 */         this.next = this.next.next();
/* 1348 */         if ((!Object2CharRBTreeMap.Submap.this.top) && (this.next != null) && (Object2CharRBTreeMap.this.compare(this.next.key, Object2CharRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1169 */         super(); } 
/* 1170 */       public ObjectBidirectionalIterator<K> iterator() { return new Object2CharRBTreeMap.Submap.SubmapKeyIterator(Object2CharRBTreeMap.Submap.this); } 
/* 1171 */       public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2CharRBTreeMap.Submap.SubmapKeyIterator(Object2CharRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2CharRBTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     private ValueIterator()
/*      */     {
/* 1025 */       super(); } 
/* 1026 */     public char nextChar() { return nextEntry().value; } 
/* 1027 */     public char previousChar() { return previousEntry().value; } 
/* 1028 */     public void set(char v) { throw new UnsupportedOperationException(); } 
/* 1029 */     public void add(char v) { throw new UnsupportedOperationException(); } 
/* 1030 */     public Character next() { return Character.valueOf(nextEntry().value); } 
/* 1031 */     public Character previous() { return Character.valueOf(previousEntry().value); } 
/* 1032 */     public void set(Character ok) { throw new UnsupportedOperationException(); } 
/* 1033 */     public void add(Character ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class KeySet extends AbstractObject2CharSortedMap.KeySet
...
/*      */     {
/* 1003 */       super(); } 
/* 1004 */     public ObjectBidirectionalIterator<K> iterator() { return new Object2CharRBTreeMap.KeyIterator(Object2CharRBTreeMap.this); } 
/* 1005 */     public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2CharRBTreeMap.KeyIterator(Object2CharRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2CharRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2CharRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<Object2CharMap.Entry<K>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/*  943 */     public Object2CharMap.Entry<K> previous() { return previousEntry(); } 
/*  944 */     public void set(Object2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  945 */     public void add(Object2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  870 */     int index = 0;
/*      */ 
/*  872 */     TreeIterator() { this.next = Object2CharRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator() {
/*  875 */       if ((this.next = Object2CharRBTreeMap.this.locateKey(k)) != null)
/*  876 */         if (Object2CharRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/*  917 */       updatePrevious();
/*  918 */       updateNext();
/*  919 */       Object2CharRBTreeMap.this.removeChar(this.curr.key);
/*  920 */       this.curr = null;
/*      */     }
...
/*  761 */       return Character.valueOf(this.value);
/*      */     }
/*      */     public char getCharValue() {
/*  764 */       return this.value;
/*      */     }
/*      */     public char setValue(char value) {
/*  767 */       char oldValue = this.value;
/*  768 */       this.value = value;
/*  769 */       return oldValue;
/*      */     }
/*      */     public Character setValue(Character value) {
/*  772 */       return Character.valueOf(setValue(value.charValue()));
/*      */     }
/*      */ 
...
/*  792 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     public int hashCode() {
