  ...
  implements Serializable, Cloneable
{
  ...
  public Object2ReferenceAVLTreeMap(Comparator<? super K> local_c)
  {
    this();
  ...
  public Object2ReferenceAVLTreeMap(Map<? extends K, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2ReferenceAVLTreeMap(SortedMap<K, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2ReferenceAVLTreeMap(Object2ReferenceMap<? extends K, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2ReferenceAVLTreeMap(Object2ReferenceSortedMap<K, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2ReferenceAVLTreeMap(K[] local_k, V[] local_v, Comparator<? super K> local_c)
  {
    this(local_c);
  ...
  public Object2ReferenceAVLTreeMap(K[] local_k, V[] local_v)
  {
  ...
  {
    Object2ReferenceAVLTreeMap<K, V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Object2ReferenceMap.Entry<K, V>> comparator = new Comparator()
        {
          ...
          {
            return Object2ReferenceAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Object2ReferenceAVLTreeMap.EntryIterator(Object2ReferenceAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> from)
        {
          return new Object2ReferenceAVLTreeMap.EntryIterator(Object2ReferenceAVLTreeMap.this, from.getKey());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Object2ReferenceAVLTreeMap.Entry<K, V> local_f = Object2ReferenceAVLTreeMap.this.findKey(local_e.getKey());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Object2ReferenceAVLTreeMap.Entry<K, V> local_f = Object2ReferenceAVLTreeMap.this.findKey(local_e.getKey());
          if (local_f != null) {
            Object2ReferenceAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Object2ReferenceAVLTreeMap.this.subMap(from.getKey(), local_to.getKey()).object2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> local_to)
        {
          return Object2ReferenceAVLTreeMap.this.headMap(local_to.getKey()).object2ReferenceEntrySet();
        }
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Object2ReferenceAVLTreeMap.ValueIterator(Object2ReferenceAVLTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Object2ReferenceAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Object2ReferenceAVLTreeMap<K, V> local_c;
    try
    {
      local_c = (Object2ReferenceAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Object2ReferenceAVLTreeMap<K, V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Object2ReferenceAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Object2ReferenceAVLTreeMap<K, V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Object2ReferenceAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Object2ReferenceAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator()
          {
            return new Object2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(Object2ReferenceAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Object2ReferenceMap.Entry<K, V>> iterator(Object2ReferenceMap.Entry<K, V> from)
          {
            return new Object2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(Object2ReferenceAVLTreeMap.Submap.this, from.getKey());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<K, V> local_e = (Map.Entry)local_o;
            Object2ReferenceAVLTreeMap.Entry<K, V> local_f = Object2ReferenceAVLTreeMap.this.findKey(local_e.getKey());
            return (local_f != null) && (Object2ReferenceAVLTreeMap.Submap.this.in5(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<K, V> local_e = (Map.Entry)local_o;
            Object2ReferenceAVLTreeMap.Entry<K, V> local_f = Object2ReferenceAVLTreeMap.this.findKey(local_e.getKey());
            if ((local_f != null) && (Object2ReferenceAVLTreeMap.Submap.this.in5(local_f.key))) {
              Object2ReferenceAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Object2ReferenceAVLTreeMap.Submap.SubmapIterator(Object2ReferenceAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Object2ReferenceAVLTreeMap.Submap.this.clear();
          }
          
          public Object2ReferenceMap.Entry<K, V> first()
          {
            return Object2ReferenceAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Object2ReferenceMap.Entry<K, V> last()
          {
            return Object2ReferenceAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> subSet(Object2ReferenceMap.Entry<K, V> from, Object2ReferenceMap.Entry<K, V> local_to)
          {
            return Object2ReferenceAVLTreeMap.Submap.this.subMap(from.getKey(), local_to.getKey()).object2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> headSet(Object2ReferenceMap.Entry<K, V> local_to)
          {
            return Object2ReferenceAVLTreeMap.Submap.this.headMap(local_to.getKey()).object2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Object2ReferenceMap.Entry<K, V>> tailSet(Object2ReferenceMap.Entry<K, V> from)
          {
            return Object2ReferenceAVLTreeMap.Submap.this.tailMap(from.getKey()).object2ReferenceEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ReferenceCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractReferenceCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Object2ReferenceAVLTreeMap.Submap.SubmapValueIterator(Object2ReferenceAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Object2ReferenceAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Object2ReferenceAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(Object local_k)
    {
      return (in5(local_k)) && (Object2ReferenceAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      K local_kk = local_k;
      Object2ReferenceAVLTreeMap.Entry<K, V> local_e;
      return (in5(local_kk)) && ((local_e = Object2ReferenceAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(K local_k, V local_v)
    {
      ...
      V oldValue = Object2ReferenceAVLTreeMap.this.put(local_k, local_v);
    ...
    public V remove(Object local_k)
    {
      ...
      V oldValue = Object2ReferenceAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Object2ReferenceAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Object2ReferenceAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Object2ReferenceAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Object2ReferenceSortedMap<K, V> tailMap(K from)
    {
      if (this.bottom) {
        return new Submap(Object2ReferenceAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Object2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2ReferenceAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Object2ReferenceSortedMap<K, V> subMap(K from, K local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Object2ReferenceAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Object2ReferenceAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Object2ReferenceAVLTreeMap.Entry<K, V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Object2ReferenceAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Object2ReferenceAVLTreeMap.this.locateKey(this.from);
        if (Object2ReferenceAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Object2ReferenceAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Object2ReferenceAVLTreeMap.Entry<K, V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Object2ReferenceAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Object2ReferenceAVLTreeMap.this.locateKey(this.field_47);
        if (Object2ReferenceAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Object2ReferenceAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public K firstKey()
    {
      Object2ReferenceAVLTreeMap.Entry<K, V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public K lastKey()
    {
      Object2ReferenceAVLTreeMap.Entry<K, V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private class SubmapIterator
      extends Object2ReferenceAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Object2ReferenceAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator()
      {
        this();
        if (this.next != null) {
          if ((!Object2ReferenceAVLTreeMap.Submap.this.bottom) && (Object2ReferenceAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Object2ReferenceAVLTreeMap.Submap.this.top) && (Object2ReferenceAVLTreeMap.this.compare(local_k, (this.prev = Object2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Object2ReferenceAVLTreeMap.this.locateKey(local_k);
            if (Object2ReferenceAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Object2ReferenceAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2ReferenceAVLTreeMap.this.compare(this.prev.key, Object2ReferenceAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Object2ReferenceAVLTreeMap.Submap.this.top) && (this.next != null) && (Object2ReferenceAVLTreeMap.this.compare(this.next.key, Object2ReferenceAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractObject2ReferenceSortedMap.KeySet
    {
      ...
      {
        return new Object2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(Object2ReferenceAVLTreeMap.Submap.this);
      }
      
      public ObjectBidirectionalIterator<K> iterator(K from)
      {
        return new Object2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(Object2ReferenceAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractObject2ReferenceSortedMap.KeySet
  {
    ...
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new Object2ReferenceAVLTreeMap.KeyIterator(Object2ReferenceAVLTreeMap.this);
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new Object2ReferenceAVLTreeMap.KeyIterator(Object2ReferenceAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    TreeIterator()
    {
      if ((this.next = Object2ReferenceAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Object2ReferenceAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
