...
/*   8:    */
/*  60:    */public abstract class AbstractObject2ReferenceMap<K, V>
/*  61:    */  extends AbstractObject2ReferenceFunction<K, V>
/*  62:    */  implements Object2ReferenceMap<K, V>, Serializable
/*  63:    */{
...
/*  84: 84 */    if ((m instanceof Object2ReferenceMap))
/*  85:    */    {
/*  86: 86 */      while (n-- != 0) {
/*  87: 87 */        Object2ReferenceMap.Entry<? extends K, ? extends V> e = (Object2ReferenceMap.Entry)i.next();
...
/* 105:    */    implements Object2ReferenceMap.Entry<K, V>
/* 106:    */  {
/* 107:    */    protected K key;
/* 108:    */    
...
/* 129:129 */      return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == e.getValue());
/* 130:    */    }
/* 131:    */    
/* 132:132 */    public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ (this.value == null ? 0 : System.identityHashCode(this.value)); }
/* 133:    */    
...
/* 151:151 */      public boolean contains(Object k) { return AbstractObject2ReferenceMap.this.containsKey(k); }
/* 152:152 */      public int size() { return AbstractObject2ReferenceMap.this.size(); }
/* 153:153 */      public void clear() { AbstractObject2ReferenceMap.this.clear(); }
/* 154:    */      
/* 155:155 */      public ObjectIterator<K> iterator() { new AbstractObjectIterator() {
/* 156:156 */          final ObjectIterator<Map.Entry<K, V>> i = AbstractObject2ReferenceMap.this.entrySet().iterator();
/* 157:157 */          public K next() { return ((Object2ReferenceMap.Entry)this.i.next()).getKey(); }
...
/* 176:176 */      public boolean contains(Object k) { return AbstractObject2ReferenceMap.this.containsValue(k); }
/* 177:177 */      public int size() { return AbstractObject2ReferenceMap.this.size(); }
/* 178:178 */      public void clear() { AbstractObject2ReferenceMap.this.clear(); }
/* 179:    */      
/* 180:180 */      public ObjectIterator<V> iterator() { new AbstractObjectIterator() {
/* 181:181 */          final ObjectIterator<Map.Entry<K, V>> i = AbstractObject2ReferenceMap.this.entrySet().iterator();
/* 182:182 */          public V next() { return ((Object2ReferenceMap.Entry)this.i.next()).getValue(); }
...
/* 189:    */  {
/* 190:190 */    return object2ReferenceEntrySet();
/* 191:    */  }
/* 192:    */  
...
/* 220:220 */        s.append(", ");
/* 221:221 */      Object2ReferenceMap.Entry<K, V> e = (Object2ReferenceMap.Entry)i.next();
