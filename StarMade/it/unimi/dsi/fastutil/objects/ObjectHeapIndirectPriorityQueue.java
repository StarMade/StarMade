  ...
  extends ObjectHeapSemiIndirectPriorityQueue<K>
{
  ...
  public ObjectHeapIndirectPriorityQueue(K[] refArray, int capacity, Comparator<? super K> local_c)
  {
  ...
  public ObjectHeapIndirectPriorityQueue(K[] refArray, Comparator<? super K> local_c)
  {
  ...
  public ObjectHeapIndirectPriorityQueue(K[] refArray, int[] local_a, int size, Comparator<? super K> local_c)
  {
    ...
    ObjectIndirectHeaps.makeHeap(refArray, local_a, this.inv, size, local_c);
  }
  
  public ObjectHeapIndirectPriorityQueue(K[] refArray, int[] local_a, Comparator<? super K> local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public ObjectHeapIndirectPriorityQueue(K[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public ObjectHeapIndirectPriorityQueue(K[] refArray, int[] local_a)
  {
  ...
  public void enqueue(int local_x)
  {
    ...
    ObjectIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, this.size - 1, this.field_69);
  }
  ...
  public int dequeue()
  {
    ...
    this.inv[result] = -1;
    if (this.size != 0) {
      ObjectIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.field_69);
    }
    return result;
  }
  ...
  public void changed(int index)
  {
    ...
    int newPos = ObjectIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, pos, this.field_69);
    ObjectIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.field_69);
  }
  
  public void allChanged()
  {
    ObjectIndirectHeaps.makeHeap(this.refArray, this.heap, this.inv, this.size, this.field_69);
  }
  ...
  public boolean remove(int index)
  {
    ...
    if (result < --this.size)
    {
      ...
      int newPos = ObjectIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, result, this.field_69);
      ObjectIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.field_69);
    }
    return true;
  }
