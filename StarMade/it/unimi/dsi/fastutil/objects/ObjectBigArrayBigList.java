  ...
  implements RandomAccess, Cloneable, Serializable
{
  ...
  protected ObjectBigArrayBigList(K[][] local_a, boolean dummy)
  {
  ...
  public ObjectBigArrayBigList(ObjectCollection<? extends K> local_c)
  {
    this(local_c.size());
  ...
  public ObjectBigArrayBigList(ObjectBigList<? extends K> local_l)
  {
    this(local_l.size64());
    local_l.getElements(0L, this.field_75, 0L, this.size = local_l.size64());
  }
  
  public ObjectBigArrayBigList(K[][] local_a)
  {
    this(local_a, 0L, ObjectBigArrays.length(local_a));
  }
  
  public ObjectBigArrayBigList(K[][] local_a, long offset, long length)
  {
    this(length);
  ...
  public ObjectBigArrayBigList(Iterator<? extends K> local_i)
  {
    this();
    while (local_i.hasNext()) {
      add(local_i.next());
  ...
  public ObjectBigArrayBigList(ObjectIterator<? extends K> local_i)
  {
    this();
    while (local_i.hasNext()) {
      add(local_i.next());
  ...
  public static <K> ObjectBigArrayBigList<K> wrap(K[][] local_a, long length)
  {
    ...
    ObjectBigArrayBigList<K> local_l = new ObjectBigArrayBigList(local_a, false);
    local_l.size = length;
    return local_l;
  }
  
  public static <K> ObjectBigArrayBigList<K> wrap(K[][] local_a)
  {
  ...
  public long indexOf(Object local_k)
  {
    for (long local_i = 0L; local_i < this.size; local_i += 1L) {
      if (local_k == null ? ObjectBigArrays.get(this.field_75, local_i) == null : local_k.equals(ObjectBigArrays.get(this.field_75, local_i))) {
        return local_i;
      }
    }
    return -1L;
  ...
  public ObjectBigListIterator<K> listIterator(final int index)
  {
    ...
    new AbstractObjectBigListIterator()
    {
      ...
      public K next()
      {
        ...
        return ObjectBigArrays.get(ObjectBigArrayBigList.this.field_75, this.last = this.pos++);
      }
      ...
      public void add(K local_k)
      {
        ...
        ObjectBigArrayBigList.this.add(this.pos++, local_k);
        this.last = -1;
      }
      ...
      public void set(K local_k)
      {
        ...
        ObjectBigArrayBigList.this.set(this.last, local_k);
      }
  ...
  {
    ObjectBigArrayBigList<K> local_c = new ObjectBigArrayBigList(this.size);
  ...
  public boolean equals(ObjectBigArrayBigList<K> local_l)
  {
    if (local_l == this) {
      return true;
    }
    ...
    while (local_s-- != 0L) {
      if (!valEquals(ObjectBigArrays.get(local_a1, local_s), ObjectBigArrays.get(local_a2, local_s))) {
        return false;
      }
    }
    return true;
  ...
  public int compareTo(ObjectBigArrayBigList<? extends K> local_l)
  {
    ...
    {
      K local_e1 = ObjectBigArrays.get(local_a1, local_i);
      K local_e2 = ObjectBigArrays.get(local_a2, local_i);
      int local_r;
