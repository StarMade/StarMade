...
/* 291 */     public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.reference2CharEntrySet()); return this.entries; } 
...
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2CharEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Reference2CharMap.Entry<K>> reference2CharEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return reference2CharEntrySet();
/*     */     }
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Reference2CharMaps.Singleton.this.key; } 
/* 132 */       public Character getValue() { return Character.valueOf(Reference2CharMaps.Singleton.this.value); }
/*     */ 
/*     */ 
/*     */       public char getCharValue()
/*     */       {
/* 139 */         return Reference2CharMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Reference2CharMaps.Singleton.this.key == e.getKey()) && (Reference2CharMaps.Singleton.this.value == ((Character)e.getValue()).charValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return (Reference2CharMaps.Singleton.this.key == null ? 0 : System.identityHashCode(Reference2CharMaps.Singleton.this.key)) ^ Reference2CharMaps.Singleton.this.value; } 
/* 153 */       public String toString() { return Reference2CharMaps.Singleton.this.key + "->" + Reference2CharMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*  75 */     private Object readResolve() { return Reference2CharMaps.EMPTY_MAP; } 
/*  76 */     public Object clone() { return Reference2CharMaps.EMPTY_MAP; } 
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, Character>> entrySet() {
/*  80 */       return reference2CharEntrySet();
/*     */     }
