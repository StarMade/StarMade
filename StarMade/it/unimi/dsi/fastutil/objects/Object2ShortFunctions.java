...
/*     */   }
/*     */ 
/*     */   public static class SynchronizedFunction<K> extends AbstractObject2ShortFunction<K>
/*     */     implements Serializable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Object2ShortFunction<K> function;
...
/*     */     }
/*  92 */     public short getShort(Object k) { if (this.key == null ? k == null : this.key.equals(k)) return this.value; return this.defRetValue; } 
/*     */     public int size() {
/*  94 */       return 1;
/*     */     }
...
/*     */     public void clear() {  } 
/*  66 */     private Object readResolve() { return Object2ShortFunctions.EMPTY_FUNCTION; } 
/*  67 */     public Object clone() { return Object2ShortFunctions.EMPTY_FUNCTION; }
/*     */ 
/*     */   }
/*     */ }
