...
/*   14:     */
/*   99:     */public class Reference2ReferenceLinkedOpenHashMap<K, V>
/*  100:     */  extends AbstractReference2ReferenceSortedMap<K, V>
...
/*  113:     */  protected volatile transient Reference2ReferenceSortedMap.FastSortedEntrySet<K, V> entries;
/*  114:     */  protected volatile transient ReferenceSortedSet<K> keys;
/*  115:     */  protected volatile transient ReferenceCollection<V> values;
...
/*  127:     */  
/*  135:     */  public Reference2ReferenceLinkedOpenHashMap(int expected, float f)
/*  136:     */  {
...
/*  147:     */  }
/*  148:     */  
/*  151:     */  public Reference2ReferenceLinkedOpenHashMap(int expected)
/*  152:     */  {
/*  153: 153 */    this(expected, 0.75F);
/*  154:     */  }
/*  155:     */  
/*  157:     */  public Reference2ReferenceLinkedOpenHashMap()
/*  158:     */  {
/*  159: 159 */    this(16, 0.75F);
/*  160:     */  }
/*  161:     */  
/*  165:     */  public Reference2ReferenceLinkedOpenHashMap(Map<? extends K, ? extends V> m, float f)
/*  166:     */  {
/*  167: 167 */    this(m.size(), f);
/*  168: 168 */    putAll(m);
/*  169:     */  }
/*  170:     */  
/*  173:     */  public Reference2ReferenceLinkedOpenHashMap(Map<? extends K, ? extends V> m)
/*  174:     */  {
/*  175: 175 */    this(m, 0.75F);
/*  176:     */  }
/*  177:     */  
/*  181:     */  public Reference2ReferenceLinkedOpenHashMap(Reference2ReferenceMap<K, V> m, float f)
/*  182:     */  {
/*  183: 183 */    this(m.size(), f);
/*  184: 184 */    putAll(m);
/*  185:     */  }
/*  186:     */  
/*  189:     */  public Reference2ReferenceLinkedOpenHashMap(Reference2ReferenceMap<K, V> m)
/*  190:     */  {
/*  191: 191 */    this(m, 0.75F);
/*  192:     */  }
/*  193:     */  
/*  199:     */  public Reference2ReferenceLinkedOpenHashMap(K[] k, V[] v, float f)
/*  200:     */  {
...
/*  205:     */  }
/*  206:     */  
/*  210:     */  public Reference2ReferenceLinkedOpenHashMap(K[] k, V[] v)
/*  211:     */  {
...
/*  219:     */  {
/*  220: 220 */    int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
/*  221:     */    
/*  222: 222 */    while (this.used[pos] != 0) {
/*  223: 223 */      if (this.key[pos] == k) {
...
/*  259: 259 */        int slot = (this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(this.key[pos]))) & this.mask;
...
/*  275:     */  {
/*  276: 276 */    int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
/*  277:     */    
/*  278: 278 */    while (this.used[pos] != 0) {
/*  279: 279 */      if (this.key[pos] == k) {
/*  280: 280 */        this.size -= 1;
...
/*  371:     */    
/*  372: 372 */    int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & mask;
/*  373:     */    
/*  374: 374 */    while (used[pos] != 0) {
/*  375: 375 */      if (k == key[pos]) {
...
/*  392:     */    
/*  393: 393 */    int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & mask;
/*  394:     */    
/*  395: 395 */    while (used[pos] != 0) {
/*  396: 396 */      if (k == key[pos]) {
...
/*  414:     */    
/*  415: 415 */    int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & mask;
/*  416:     */    
/*  417: 417 */    while (used[pos] != 0) {
/*  418: 418 */      if (k == key[pos]) {
...
/*  453:     */    
/*  454: 454 */    int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & mask;
/*  455:     */    
...
/*  484:     */  {
/*  485: 485 */    int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
/*  486:     */    
/*  487: 487 */    while (this.used[pos] != 0) {
/*  488: 488 */      if (this.key[pos] == k) return this.value[pos];
...
/*  495:     */  {
/*  496: 496 */    int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
/*  497:     */    
/*  498: 498 */    while (this.used[pos] != 0) {
/*  499: 499 */      if (this.key[pos] == k) return true;
...
/*  507: 507 */    for (int i = this.n; i-- != 0; return true) label16: if ((used[i] == 0) || (value[i] != v)) break label16;
...
/*  550:     */    implements Reference2ReferenceMap.Entry<K, V>, Map.Entry<K, V>
/*  551:     */  {
...
/*  557:     */    }
/*  558:     */    
/*  559: 559 */    public K getKey() { return Reference2ReferenceLinkedOpenHashMap.this.key[this.index]; }
/*  560:     */    
/*  562: 562 */    public V getValue() { return Reference2ReferenceLinkedOpenHashMap.this.value[this.index]; }
/*  563:     */    
/*  564:     */    public V setValue(V v) {
/*  565: 565 */      V oldValue = Reference2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  566: 566 */      Reference2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
...
/*  573: 573 */      return (Reference2ReferenceLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*  574:     */    }
/*  575:     */    
/*  576: 576 */    public int hashCode() { return (Reference2ReferenceLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ReferenceLinkedOpenHashMap.this.key[this.index])) ^ (Reference2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Reference2ReferenceLinkedOpenHashMap.this.value[this.index])); }
/*  577:     */    
/*  578:     */    public String toString() {
/*  579: 579 */      return Reference2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  580:     */    }
/*  581:     */  }
/*  582:     */  
...
/*  667: 667 */  public Reference2ReferenceSortedMap<K, V> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  668: 668 */  public Reference2ReferenceSortedMap<K, V> headMap(K to) { throw new UnsupportedOperationException(); }
/*  669: 669 */  public Reference2ReferenceSortedMap<K, V> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  670:     */  
...
/*  684: 684 */    int index = -1;
/*  685:     */    
/*  686: 686 */    private MapIterator() { this.next = Reference2ReferenceLinkedOpenHashMap.this.first;
/*  687: 687 */      this.index = 0;
/*  688:     */    }
/*  689:     */    
/*  690: 690 */    private MapIterator() { if (Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.last] == from) {
/*  691: 691 */        this.prev = Reference2ReferenceLinkedOpenHashMap.this.last;
/*  692: 692 */        this.index = Reference2ReferenceLinkedOpenHashMap.this.size;
/*  693:     */      }
/*  694:     */      else
/*  695:     */      {
/*  696: 696 */        int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  697:     */        
/*  698: 698 */        while (Reference2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  699: 699 */          if (Reference2ReferenceLinkedOpenHashMap.this.key[pos] == from)
/*  700:     */          {
/*  701: 701 */            this.next = ((int)Reference2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  702: 702 */            this.prev = pos;
/*  703: 703 */            return;
/*  704:     */          }
/*  705: 705 */          pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  706:     */        }
...
/*  719: 719 */        this.index = Reference2ReferenceLinkedOpenHashMap.this.size;
/*  720: 720 */        return;
/*  721:     */      }
/*  722: 722 */      int pos = Reference2ReferenceLinkedOpenHashMap.this.first;
/*  723: 723 */      this.index = 1;
/*  724: 724 */      while (pos != this.prev) {
/*  725: 725 */        pos = (int)Reference2ReferenceLinkedOpenHashMap.this.link[pos];
...
/*  736:     */    }
/*  737:     */    
/*  738: 738 */    public int nextEntry() { if (!hasNext()) return Reference2ReferenceLinkedOpenHashMap.this.size();
/*  739: 739 */      this.curr = this.next;
/*  740: 740 */      this.next = ((int)Reference2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  748: 748 */      this.prev = ((int)(Reference2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  761: 761 */        this.prev = ((int)(Reference2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  762:     */      }
/*  763:     */      else {
/*  764: 764 */        this.next = ((int)Reference2ReferenceLinkedOpenHashMap.this.link[this.curr]); }
/*  765: 765 */      Reference2ReferenceLinkedOpenHashMap.this.size -= 1;
/*  766:     */      
/*  768: 768 */      if (this.prev == -1) { Reference2ReferenceLinkedOpenHashMap.this.first = this.next;
/*  769:     */      } else
/*  770: 770 */        Reference2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Reference2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  771: 771 */      if (this.next == -1) { Reference2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*  772:     */      } else
/*  773: 773 */        Reference2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Reference2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  774: 774 */      int pos = this.curr;
/*  775:     */      int last;
/*  776:     */      for (;;) {
/*  777: 777 */        pos = (last = pos) + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  778: 778 */        while (Reference2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  779: 779 */          int slot = (Reference2ReferenceLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ReferenceLinkedOpenHashMap.this.key[pos]))) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  780: 780 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  781: 781 */          pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  782:     */        }
/*  783: 783 */        if (Reference2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  784: 784 */        Reference2ReferenceLinkedOpenHashMap.this.key[last] = Reference2ReferenceLinkedOpenHashMap.this.key[pos];
/*  785: 785 */        Reference2ReferenceLinkedOpenHashMap.this.value[last] = Reference2ReferenceLinkedOpenHashMap.this.value[pos];
/*  786: 786 */        if (this.next == pos) this.next = last;
/*  787: 787 */        if (this.prev == pos) this.prev = last;
/*  788: 788 */        Reference2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*  789:     */      }
/*  790: 790 */      Reference2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  791: 791 */      Reference2ReferenceLinkedOpenHashMap.this.key[last] = null;
/*  792: 792 */      Reference2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  793: 793 */      this.curr = -1;
/*  794:     */    }
/*  795:     */    
...
/*  804:     */    } }
/*  805:     */  
/*  806:     */  private class EntryIterator extends Reference2ReferenceLinkedOpenHashMap<K, V>.MapIterator implements ObjectListIterator<Reference2ReferenceMap.Entry<K, V>> { private Reference2ReferenceLinkedOpenHashMap<K, V>.MapEntry entry;
/*  807:     */    
/*  808: 808 */    public EntryIterator() { super(null); }
/*  809:     */    
/*  810: 810 */    public EntryIterator() { super(from, null); }
/*  811:     */    
/*  812:     */    public Reference2ReferenceLinkedOpenHashMap<K, V>.MapEntry next() {
/*  813: 813 */      return this.entry = new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this, nextEntry());
/*  814:     */    }
/*  815:     */    
/*  816: 816 */    public Reference2ReferenceLinkedOpenHashMap<K, V>.MapEntry previous() { return this.entry = new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this, previousEntry()); }
/*  817:     */    
/*  818:     */    public void remove()
/*  819:     */    {
/*  820: 820 */      super.remove();
/*  821: 821 */      Reference2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  822:     */    
/*  823: 823 */    public void set(Reference2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  824: 824 */    public void add(Reference2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  825:     */  }
/*  826:     */  
/*  827: 827 */  private class FastEntryIterator extends Reference2ReferenceLinkedOpenHashMap<K, V>.MapIterator implements ObjectListIterator<Reference2ReferenceMap.Entry<K, V>> { final AbstractReference2ReferenceMap.BasicEntry<K, V> entry = new AbstractReference2ReferenceMap.BasicEntry(null, null);
/*  828: 828 */    public FastEntryIterator() { super(null); }
/*  829:     */    
/*  830: 830 */    public FastEntryIterator() { super(from, null); }
/*  831:     */    
/*  832:     */    public AbstractReference2ReferenceMap.BasicEntry<K, V> next() {
/*  833: 833 */      int e = nextEntry();
/*  834: 834 */      this.entry.key = Reference2ReferenceLinkedOpenHashMap.this.key[e];
/*  835: 835 */      this.entry.value = Reference2ReferenceLinkedOpenHashMap.this.value[e];
/*  836: 836 */      return this.entry;
/*  837:     */    }
/*  838:     */    
/*  839: 839 */    public AbstractReference2ReferenceMap.BasicEntry<K, V> previous() { int e = previousEntry();
/*  840: 840 */      this.entry.key = Reference2ReferenceLinkedOpenHashMap.this.key[e];
/*  841: 841 */      this.entry.value = Reference2ReferenceLinkedOpenHashMap.this.value[e];
/*  842: 842 */      return this.entry; }
/*  843:     */    
/*  844: 844 */    public void set(Reference2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  845: 845 */    public void add(Reference2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } }
/*  846:     */  
/*  847:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceSortedMap.FastSortedEntrySet<K, V> { private MapEntrySet() {}
/*  848:     */    
/*  849: 849 */    public ObjectBidirectionalIterator<Reference2ReferenceMap.Entry<K, V>> iterator() { return new Reference2ReferenceLinkedOpenHashMap.EntryIterator(Reference2ReferenceLinkedOpenHashMap.this); }
/*  850:     */    
/*  851: 851 */    public Comparator<? super Reference2ReferenceMap.Entry<K, V>> comparator() { return null; }
/*  852: 852 */    public ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> subSet(Reference2ReferenceMap.Entry<K, V> fromElement, Reference2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); }
/*  853: 853 */    public ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> headSet(Reference2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); }
/*  854: 854 */    public ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> tailSet(Reference2ReferenceMap.Entry<K, V> fromElement) { throw new UnsupportedOperationException(); }
/*  855:     */    
/*  856: 856 */    public Reference2ReferenceMap.Entry<K, V> first() { if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  857: 857 */      return new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this, Reference2ReferenceLinkedOpenHashMap.this.first);
/*  858:     */    }
/*  859:     */    
/*  860: 860 */    public Reference2ReferenceMap.Entry<K, V> last() { if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  861: 861 */      return new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this, Reference2ReferenceLinkedOpenHashMap.this.last);
/*  862:     */    }
/*  863:     */    
...
/*  868:     */      
/*  869: 869 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  870:     */      
/*  871: 871 */      while (Reference2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  872: 872 */        if (Reference2ReferenceLinkedOpenHashMap.this.key[pos] == k) return Reference2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  873: 873 */        pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  874:     */      }
...
/*  882:     */      
/*  883: 883 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  884:     */      
/*  885: 885 */      while (Reference2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  886: 886 */        if (Reference2ReferenceLinkedOpenHashMap.this.key[pos] == k) {
/*  887: 887 */          Reference2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  888: 888 */          return true;
/*  889:     */        }
/*  890: 890 */        pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  891:     */      }
/*  892: 892 */      return false;
/*  893:     */    }
/*  894:     */    
/*  895: 895 */    public int size() { return Reference2ReferenceLinkedOpenHashMap.this.size; }
/*  896:     */    
/*  897:     */    public void clear() {
/*  898: 898 */      Reference2ReferenceLinkedOpenHashMap.this.clear();
/*  899:     */    }
/*  900:     */    
/*  901: 901 */    public ObjectBidirectionalIterator<Reference2ReferenceMap.Entry<K, V>> iterator(Reference2ReferenceMap.Entry<K, V> from) { return new Reference2ReferenceLinkedOpenHashMap.EntryIterator(Reference2ReferenceLinkedOpenHashMap.this, from.getKey()); }
/*  902:     */    
/*  903:     */    public ObjectBidirectionalIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator() {
/*  904: 904 */      return new Reference2ReferenceLinkedOpenHashMap.FastEntryIterator(Reference2ReferenceLinkedOpenHashMap.this);
/*  905:     */    }
/*  906:     */    
/*  907: 907 */    public ObjectBidirectionalIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator(Reference2ReferenceMap.Entry<K, V> from) { return new Reference2ReferenceLinkedOpenHashMap.FastEntryIterator(Reference2ReferenceLinkedOpenHashMap.this, from.getKey()); }
/*  908:     */  }
/*  909:     */  
/*  910:     */  public Reference2ReferenceSortedMap.FastSortedEntrySet<K, V> reference2ReferenceEntrySet() {
...
/*  918:     */    extends Reference2ReferenceLinkedOpenHashMap<K, V>.MapIterator
/*  919:     */    implements ObjectListIterator<K>
/*  920:     */  {
/*  921: 921 */    public KeyIterator() { super(k, null); }
/*  922: 922 */    public K previous() { return Reference2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; }
...
/*  926: 926 */    public K next() { return Reference2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; } }
/*  927:     */  
/*  928:     */  private final class KeySet extends AbstractReferenceSortedSet<K> { private KeySet() {}
/*  929:     */    
/*  930: 930 */    public ObjectListIterator<K> iterator(K from) { return new Reference2ReferenceLinkedOpenHashMap.KeyIterator(Reference2ReferenceLinkedOpenHashMap.this, from); }
/*  931:     */    
/*  932:     */    public ObjectListIterator<K> iterator() {
/*  933: 933 */      return new Reference2ReferenceLinkedOpenHashMap.KeyIterator(Reference2ReferenceLinkedOpenHashMap.this);
/*  934:     */    }
/*  935:     */    
/*  936: 936 */    public int size() { return Reference2ReferenceLinkedOpenHashMap.this.size; }
/*  937:     */    
/*  939: 939 */    public boolean contains(Object k) { return Reference2ReferenceLinkedOpenHashMap.this.containsKey(k); }
/*  940:     */    
/*  941:     */    public boolean remove(Object k) {
/*  942: 942 */      int oldSize = Reference2ReferenceLinkedOpenHashMap.this.size;
/*  943: 943 */      Reference2ReferenceLinkedOpenHashMap.this.remove(k);
/*  944: 944 */      return Reference2ReferenceLinkedOpenHashMap.this.size != oldSize;
/*  945:     */    }
/*  946:     */    
/*  947: 947 */    public void clear() { Reference2ReferenceLinkedOpenHashMap.this.clear(); }
/*  948:     */    
/*  949:     */    public K first() {
/*  950: 950 */      if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  951: 951 */      return Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.first];
/*  952:     */    }
/*  953:     */    
/*  954: 954 */    public K last() { if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  955: 955 */      return Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.last]; }
/*  956:     */    
/*  957: 957 */    public Comparator<? super K> comparator() { return null; }
/*  958: 958 */    public final ReferenceSortedSet<K> tailSet(K from) { throw new UnsupportedOperationException(); }
/*  959: 959 */    public final ReferenceSortedSet<K> headSet(K to) { throw new UnsupportedOperationException(); }
/*  960: 960 */    public final ReferenceSortedSet<K> subSet(K from, K to) { throw new UnsupportedOperationException(); }
/*  961:     */  }
/*  962:     */  
/*  963: 963 */  public ReferenceSortedSet<K> keySet() { if (this.keys == null) this.keys = new KeySet(null);
/*  964: 964 */    return this.keys;
/*  965:     */  }
/*  966:     */  
/*  969:     */  private final class ValueIterator
/*  970:     */    extends Reference2ReferenceLinkedOpenHashMap<K, V>.MapIterator
/*  971:     */    implements ObjectListIterator<V>
/*  972:     */  {
/*  973: 973 */    public V previous() { return Reference2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; }
...
/*  977: 977 */    public V next() { return Reference2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/*  978:     */  }
/*  979:     */  
/*  980: 980 */  public ReferenceCollection<V> values() { if (this.values == null) { this.values = new AbstractReferenceCollection() {
/*  981:     */        public ObjectIterator<V> iterator() {
/*  982: 982 */          return new Reference2ReferenceLinkedOpenHashMap.ValueIterator(Reference2ReferenceLinkedOpenHashMap.this);
/*  983:     */        }
/*  984:     */        
/*  985: 985 */        public int size() { return Reference2ReferenceLinkedOpenHashMap.this.size; }
/*  986:     */        
/*  987:     */        public boolean contains(Object v) {
/*  988: 988 */          return Reference2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*  989:     */        }
/*  990:     */        
/*  991: 991 */        public void clear() { Reference2ReferenceLinkedOpenHashMap.this.clear(); }
/*  992:     */      };
/*  993:     */    }
...
/* 1081:1081 */      K k = key[i];
/* 1082:1082 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & newMask;
...
/* 1113:     */  }
/* 1114:     */  
/* 1117:     */  public Reference2ReferenceLinkedOpenHashMap<K, V> clone()
/* 1118:     */  {
/* 1119:     */    Reference2ReferenceLinkedOpenHashMap<K, V> c;
/* 1120:     */    
/* 1122:     */    try
/* 1123:     */    {
/* 1124:1124 */      c = (Reference2ReferenceLinkedOpenHashMap)super.clone();
/* 1125:     */    }
...
/* 1152:1152 */        t = this.key[i] == null ? 0 : System.identityHashCode(this.key[i]);
/* 1153:1153 */      if (this != this.value[i])
/* 1154:1154 */        t ^= (this.value[i] == null ? 0 : System.identityHashCode(this.value[i]));
/* 1155:1155 */      h += t;
/* 1156:1156 */      i++;
/* 1157:     */    }
/* 1158:1158 */    return h;
...
/* 1163:1163 */    Reference2ReferenceLinkedOpenHashMap<K, V>.MapIterator i = new MapIterator(null);
...
/* 1188:1188 */      pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
