...
/*  667 */   public Reference2ReferenceSortedMap<K, V> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  668 */   public Reference2ReferenceSortedMap<K, V> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  669 */   public Reference2ReferenceSortedMap<K, V> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*  982 */           return new Reference2ReferenceLinkedOpenHashMap.ValueIterator(Reference2ReferenceLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/*  985 */           return Reference2ReferenceLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/*  988 */           return Reference2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/*  991 */           Reference2ReferenceLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1124 */       c = (Reference2ReferenceLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Reference2ReferenceLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/*  973 */       return Reference2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/*  977 */     public V next() { return Reference2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  930 */       return new Reference2ReferenceLinkedOpenHashMap.KeyIterator(Reference2ReferenceLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/*  933 */       return new Reference2ReferenceLinkedOpenHashMap.KeyIterator(Reference2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/*  936 */       return Reference2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/*  939 */       return Reference2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/*  942 */       int oldSize = Reference2ReferenceLinkedOpenHashMap.this.size;
/*  943 */       Reference2ReferenceLinkedOpenHashMap.this.remove(k);
/*  944 */       return Reference2ReferenceLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/*  947 */       Reference2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/*  950 */       if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  951 */       return Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/*  954 */       if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  955 */       return Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Reference2ReferenceLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/*  921 */       super(k, null); } 
/*  922 */     public K previous() { return Reference2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  926 */     public K next() { return Reference2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  849 */       return new Reference2ReferenceLinkedOpenHashMap.EntryIterator(Reference2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*  851 */     public Comparator<? super Reference2ReferenceMap.Entry<K, V>> comparator() { return null; } 
/*  852 */     public ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> subSet(Reference2ReferenceMap.Entry<K, V> fromElement, Reference2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); } 
/*  853 */     public ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> headSet(Reference2ReferenceMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); } 
/*  854 */     public ObjectSortedSet<Reference2ReferenceMap.Entry<K, V>> tailSet(Reference2ReferenceMap.Entry<K, V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Reference2ReferenceMap.Entry<K, V> first() {
/*  856 */       if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  857 */       return new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this, Reference2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Reference2ReferenceMap.Entry<K, V> last() {
/*  860 */       if (Reference2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  861 */       return new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this, Reference2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  869 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  871 */       while (Reference2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  872 */         if (Reference2ReferenceLinkedOpenHashMap.this.key[pos] == k) return Reference2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  873 */         pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  875 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  883 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  885 */       while (Reference2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */         if (Reference2ReferenceLinkedOpenHashMap.this.key[pos] == k) {
/*  887 */           Reference2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  888 */           return true;
/*      */         }
/*  890 */         pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  892 */       return false;
/*      */     }
/*      */     public int size() {
/*  895 */       return Reference2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  898 */       Reference2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ReferenceMap.Entry<K, V>> iterator(Reference2ReferenceMap.Entry<K, V> from) {
/*  901 */       return new Reference2ReferenceLinkedOpenHashMap.EntryIterator(Reference2ReferenceLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator() {
/*  904 */       return new Reference2ReferenceLinkedOpenHashMap.FastEntryIterator(Reference2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator(Reference2ReferenceMap.Entry<K, V> from) {
/*  907 */       return new Reference2ReferenceLinkedOpenHashMap.FastEntryIterator(Reference2ReferenceLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Reference2ReferenceLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<Reference2ReferenceMap.Entry<K, V>>
/*      */   {
/*  827 */     final AbstractReference2ReferenceMap.BasicEntry<K, V> entry = new AbstractReference2ReferenceMap.BasicEntry(null, null);
/*      */ 
...
/*  833 */       int e = nextEntry();
/*  834 */       this.entry.key = Reference2ReferenceLinkedOpenHashMap.this.key[e];
/*  835 */       this.entry.value = Reference2ReferenceLinkedOpenHashMap.this.value[e];
/*  836 */       return this.entry;
/*      */     }
/*      */     public AbstractReference2ReferenceMap.BasicEntry<K, V> previous() {
/*  839 */       int e = previousEntry();
/*  840 */       this.entry.key = Reference2ReferenceLinkedOpenHashMap.this.key[e];
/*  841 */       this.entry.value = Reference2ReferenceLinkedOpenHashMap.this.value[e];
/*  842 */       return this.entry;
/*      */     }
/*  844 */     public void set(Reference2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  845 */     public void add(Reference2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Reference2ReferenceLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<Reference2ReferenceMap.Entry<K, V>>
/*      */   {
...
/*  813 */       return this.entry = new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Reference2ReferenceLinkedOpenHashMap<K, V>.MapEntry previous() {
/*  816 */       return this.entry = new Reference2ReferenceLinkedOpenHashMap.MapEntry(Reference2ReferenceLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  820 */       super.remove();
/*  821 */       Reference2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  823 */     public void set(Reference2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  824 */     public void add(Reference2ReferenceMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  684 */     int index = -1;
/*      */ 
/*  686 */     private MapIterator() { this.next = Reference2ReferenceLinkedOpenHashMap.this.first;
/*  687 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  690 */       if (Reference2ReferenceLinkedOpenHashMap.this.key[Reference2ReferenceLinkedOpenHashMap.this.last] == from) {
/*  691 */         this.prev = Reference2ReferenceLinkedOpenHashMap.this.last;
/*  692 */         this.index = Reference2ReferenceLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  696 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  698 */         while (Reference2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  699 */           if (Reference2ReferenceLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  701 */             this.next = ((int)Reference2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  702 */             this.prev = pos;
/*  703 */             return;
/*      */           }
/*  705 */           pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  718 */       if (this.next == -1) {
/*  719 */         this.index = Reference2ReferenceLinkedOpenHashMap.this.size;
/*  720 */         return;
/*      */       }
/*  722 */       int pos = Reference2ReferenceLinkedOpenHashMap.this.first;
/*  723 */       this.index = 1;
/*  724 */       while (pos != this.prev) {
/*  725 */         pos = (int)Reference2ReferenceLinkedOpenHashMap.this.link[pos];
/*  726 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  738 */       if (!hasNext()) return Reference2ReferenceLinkedOpenHashMap.this.size();
/*  739 */       this.curr = this.next;
/*  740 */       this.next = ((int)Reference2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  748 */       this.prev = ((int)(Reference2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  760 */         this.index -= 1;
/*  761 */         this.prev = ((int)(Reference2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  764 */         this.next = ((int)Reference2ReferenceLinkedOpenHashMap.this.link[this.curr]);
/*  765 */       }Reference2ReferenceLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  768 */       if (this.prev == -1) Reference2ReferenceLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  770 */         Reference2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Reference2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  771 */       if (this.next == -1) Reference2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  773 */         Reference2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Reference2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  777 */         pos = (last = pos) + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  778 */         while (Reference2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  779 */           int slot = (Reference2ReferenceLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ReferenceLinkedOpenHashMap.this.key[pos]))) & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*  780 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  781 */           pos = pos + 1 & Reference2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
/*  783 */         if (Reference2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  784 */         Reference2ReferenceLinkedOpenHashMap.this.key[last] = Reference2ReferenceLinkedOpenHashMap.this.key[pos];
/*  785 */         Reference2ReferenceLinkedOpenHashMap.this.value[last] = Reference2ReferenceLinkedOpenHashMap.this.value[pos];
/*  786 */         if (this.next == pos) this.next = last;
/*  787 */         if (this.prev == pos) this.prev = last;
/*  788 */         Reference2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  790 */       Reference2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  791 */       Reference2ReferenceLinkedOpenHashMap.this.key[last] = null;
/*  792 */       Reference2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  793 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  559 */       return Reference2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  562 */       return Reference2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  565 */       Object oldValue = Reference2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  566 */       Reference2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  567 */       return oldValue;
/*      */     }
/*      */ 
...
/*  573 */       return (Reference2ReferenceLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  576 */       return (Reference2ReferenceLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ReferenceLinkedOpenHashMap.this.key[this.index])) ^ (Reference2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Reference2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */     public String toString() {
/*  579 */       return Reference2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
