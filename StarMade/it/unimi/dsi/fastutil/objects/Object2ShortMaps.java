...
/* 291 */     public ObjectSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2ShortEntrySet()); return this.entries; } 
...
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2ShortEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Object2ShortMap.Entry<K>> object2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return object2ShortEntrySet();
/*     */     }
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Object2ShortMaps.Singleton.this.key; } 
/* 132 */       public Short getValue() { return Short.valueOf(Object2ShortMaps.Singleton.this.value); }
/*     */ 
/*     */ 
/*     */       public short getShortValue()
/*     */       {
/* 139 */         return Object2ShortMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Object2ShortMaps.Singleton.this.key == null ? e.getKey() == null : Object2ShortMaps.Singleton.this.key.equals(e.getKey())) && (Object2ShortMaps.Singleton.this.value == ((Short)e.getValue()).shortValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return (Object2ShortMaps.Singleton.this.key == null ? 0 : Object2ShortMaps.Singleton.this.key.hashCode()) ^ Object2ShortMaps.Singleton.this.value; } 
/* 153 */       public String toString() { return Object2ShortMaps.Singleton.this.key + "->" + Object2ShortMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*  75 */     private Object readResolve() { return Object2ShortMaps.EMPTY_MAP; } 
/*  76 */     public Object clone() { return Object2ShortMaps.EMPTY_MAP; } 
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, Short>> entrySet() {
/*  80 */       return object2ShortEntrySet();
/*     */     }
