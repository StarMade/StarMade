...
/*  10:    */
/*  64:    */public class Object2ReferenceArrayMap<K, V>
/*  65:    */  extends AbstractObject2ReferenceMap<K, V>
...
/*  71:    */  private int size;
/*  72:    */  
/*  73:    */  public Object2ReferenceArrayMap(Object[] key, Object[] value)
/*  74:    */  {
/*  75: 75 */    this.key = key;
...
/*  79:    */  }
/*  80:    */  
/*  81:    */  public Object2ReferenceArrayMap()
/*  82:    */  {
/*  83: 83 */    this.key = ObjectArrays.EMPTY_ARRAY;
/*  84: 84 */    this.value = ObjectArrays.EMPTY_ARRAY;
/*  85:    */  }
/*  86:    */  
/*  89:    */  public Object2ReferenceArrayMap(int capacity)
/*  90:    */  {
/*  91: 91 */    this.key = new Object[capacity];
/*  92: 92 */    this.value = new Object[capacity];
/*  93:    */  }
/*  94:    */  
/*  97:    */  public Object2ReferenceArrayMap(Object2ReferenceMap<K, V> m)
/*  98:    */  {
/*  99: 99 */    this(m.size());
/* 100:100 */    putAll(m);
/* 101:    */  }
/* 102:    */  
/* 105:    */  public Object2ReferenceArrayMap(Map<? extends K, ? extends V> m)
/* 106:    */  {
/* 107:107 */    this(m.size());
/* 108:108 */    putAll(m);
/* 109:    */  }
/* 110:    */  
/* 117:    */  public Object2ReferenceArrayMap(Object[] key, Object[] value, int size)
/* 118:    */  {
...
/* 124:    */  }
/* 125:    */  
/* 126:    */  private final class EntrySet extends AbstractObjectSet<Object2ReferenceMap.Entry<K, V>> implements Object2ReferenceMap.FastEntrySet<K, V> { private EntrySet() {}
/* 127:    */    
/* 128:128 */    public ObjectIterator<Object2ReferenceMap.Entry<K, V>> iterator() { new AbstractObjectIterator() {
/* 129:129 */        int next = 0;
/* 130:    */        
/* 131:131 */        public boolean hasNext() { return this.next < Object2ReferenceArrayMap.this.size; }
/* 132:    */        
/* 133:    */        public Object2ReferenceMap.Entry<K, V> next()
/* 134:    */        {
/* 135:135 */          if (!hasNext()) throw new NoSuchElementException();
/* 136:136 */          return new AbstractObject2ReferenceMap.BasicEntry(Object2ReferenceArrayMap.this.key[this.next], Object2ReferenceArrayMap.this.value[(this.next++)]);
/* 137:    */        }
/* 138:    */      }; }
/* 139:    */    
/* 140:    */    public ObjectIterator<Object2ReferenceMap.Entry<K, V>> fastIterator() {
/* 141:141 */      new AbstractObjectIterator() {
/* 142:142 */        int next = 0;
/* 143:143 */        final AbstractObject2ReferenceMap.BasicEntry<K, V> entry = new AbstractObject2ReferenceMap.BasicEntry(null, null);
/* 144:    */        
/* 145:145 */        public boolean hasNext() { return this.next < Object2ReferenceArrayMap.this.size; }
/* 146:    */        
/* 147:    */        public Object2ReferenceMap.Entry<K, V> next()
/* 148:    */        {
/* 149:149 */          if (!hasNext()) throw new NoSuchElementException();
/* 150:150 */          this.entry.key = Object2ReferenceArrayMap.this.key[this.next];
/* 151:151 */          this.entry.value = Object2ReferenceArrayMap.this.value[(this.next++)];
/* 152:152 */          return this.entry;
/* 153:    */        }
/* 154:    */      };
/* 155:    */    }
/* 156:    */    
/* 157:157 */    public int size() { return Object2ReferenceArrayMap.this.size; }
/* 158:    */    
...
/* 164:164 */      return (Object2ReferenceArrayMap.this.containsKey(k)) && (Object2ReferenceArrayMap.this.get(k) == e.getValue());
/* 165:    */    }
/* 166:    */  }
/* 167:    */  
/* 168:    */  public Object2ReferenceMap.FastEntrySet<K, V> object2ReferenceEntrySet() {
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Object2ReferenceArrayMap<K, V> clone()
/* 293:    */  {
/* 294:    */    Object2ReferenceArrayMap<K, V> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Object2ReferenceArrayMap)super.clone();
/* 301:    */    }
