  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2LongLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2LongLinkedOpenHashMap(Map<? extends K, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2LongLinkedOpenHashMap(Map<? extends K, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2LongLinkedOpenHashMap(Reference2LongMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2LongLinkedOpenHashMap(Reference2LongMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2LongLinkedOpenHashMap(K[] local_k, long[] local_v, float local_f)
  {
  ...
  public Reference2LongLinkedOpenHashMap(K[] local_k, long[] local_v)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Reference2LongLinkedOpenHashMap.ValueIterator(Reference2LongLinkedOpenHashMap.this);
        }
        ...
        {
          return Reference2LongLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2LongLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Reference2LongLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    long[] value = this.value;
    Reference2LongLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Reference2LongLinkedOpenHashMap.MapIterator
    implements LongListIterator
  {
    ...
    {
      return Long.valueOf(Reference2LongLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Long next()
    {
      return Long.valueOf(Reference2LongLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractReferenceSortedSet<K>
  {
    ...
    {
      return new Reference2LongLinkedOpenHashMap.KeyIterator(Reference2LongLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Reference2LongLinkedOpenHashMap.KeyIterator(Reference2LongLinkedOpenHashMap.this);
    }
    ...
    {
      return Reference2LongLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2LongLinkedOpenHashMap.this.size;
      Reference2LongLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Reference2LongSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Reference2LongLinkedOpenHashMap.EntryIterator(Reference2LongLinkedOpenHashMap.this);
    }
    ...
    public Reference2LongMap.Entry<K> first()
    {
      ...
      return new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, Reference2LongLinkedOpenHashMap.this.first);
    }
    ...
    public Reference2LongMap.Entry<K> last()
    {
      ...
      return new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, Reference2LongLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2LongLinkedOpenHashMap.this.mask; Reference2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask) {
        if (Reference2LongLinkedOpenHashMap.this.key[pos] == local_k) {
          return Reference2LongLinkedOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2LongLinkedOpenHashMap.this.mask; Reference2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask) {
        if (Reference2LongLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Reference2LongLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Reference2LongLinkedOpenHashMap.EntryIterator(Reference2LongLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> fastIterator()
    {
      return new Reference2LongLinkedOpenHashMap.FastEntryIterator(Reference2LongLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> fastIterator(Reference2LongMap.Entry<K> from)
    {
      return new Reference2LongLinkedOpenHashMap.FastEntryIterator(Reference2LongLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Reference2LongMap.Entry<K>>
  {
    ...
    public AbstractReference2LongMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Reference2LongLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Reference2LongLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    public void set(Reference2LongMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
    
    public void add(Reference2LongMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
  }
    ...
    implements ObjectListIterator<Reference2LongMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, nextEntry());
    }
    
    public Reference2LongLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2LongLinkedOpenHashMap.this.mask; Reference2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Reference2LongLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Reference2LongLinkedOpenHashMap.this.first = this.next;
      } else {
        Reference2LongLinkedOpenHashMap.this.link[this.prev] ^= (Reference2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Reference2LongLinkedOpenHashMap.this.last = this.prev;
      } else {
        Reference2LongLinkedOpenHashMap.this.link[this.next] ^= (Reference2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2LongLinkedOpenHashMap.this.mask; Reference2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask)
        {
          int slot = (Reference2LongLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2LongLinkedOpenHashMap.this.key[pos]))) & Reference2LongLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Reference2LongLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Reference2LongLinkedOpenHashMap.this.key[last] = Reference2LongLinkedOpenHashMap.this.key[pos];
      ...
      Reference2LongLinkedOpenHashMap.this.used[last] = false;
      Reference2LongLinkedOpenHashMap.this.key[last] = null;
      this.curr = -1;
    }
    ...
    implements Reference2LongMap.Entry<K>, Map.Entry<K, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Reference2LongLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Long> local_e = (Map.Entry)local_o;
      return (Reference2LongLinkedOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2LongLinkedOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
    
    public int hashCode()
    {
      return (Reference2LongLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2LongLinkedOpenHashMap.this.key[this.index])) ^ HashCommon.long2int(Reference2LongLinkedOpenHashMap.this.value[this.index]);
    }
