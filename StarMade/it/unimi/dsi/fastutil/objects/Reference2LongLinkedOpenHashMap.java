...
/*      */   protected int size;
/*      */   protected volatile transient Reference2LongSortedMap.FastSortedEntrySet<K> entries;
...
/*  382 */         this.size -= 1;
/*  383 */         fixPointers(pos);
/*  384 */         long v = this.value[pos];
/*  385 */         shiftKeys(pos);
/*  386 */         return Long.valueOf(v);
/*      */       }
...
/*  520 */       if (k == key[pos]) {
/*  521 */         long oldValue = this.value[pos];
...
/*  559 */       if (k == key[pos]) {
/*  560 */         long oldValue = this.value[pos];
...
/*  774 */   public Reference2LongSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  775 */   public Reference2LongSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  776 */   public Reference2LongSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/* 1090 */     if (this.values == null) this.values = new AbstractLongCollection() {
/*      */         public LongIterator iterator() {
/* 1092 */           return new Reference2LongLinkedOpenHashMap.ValueIterator(Reference2LongLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1095 */           return Reference2LongLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(long v) {
/* 1098 */           return Reference2LongLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1101 */           Reference2LongLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1234 */       c = (Reference2LongLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1243 */     c.value = ((long[])this.value.clone());
...
/* 1263 */       t ^= HashCommon.long2int(this.value[i]);
/* 1264 */       h += t;
/* 1265 */       i++;
/*      */     }
/* 1267 */     return h;
...
/* 1287 */     long[] value = this.value = new long[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Reference2LongLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public long previousLong()
/*      */     {
/* 1079 */       return Reference2LongLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1080 */     public Long previous() { return Long.valueOf(Reference2LongLinkedOpenHashMap.this.value[previousEntry()]); } 
/* 1081 */     public void set(Long ok) { throw new UnsupportedOperationException(); } 
/* 1082 */     public void add(Long ok) { throw new UnsupportedOperationException(); } 
...
/* 1086 */     public long nextLong() { return Reference2LongLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1087 */     public Long next() { return Long.valueOf(Reference2LongLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1036 */       return new Reference2LongLinkedOpenHashMap.KeyIterator(Reference2LongLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1039 */       return new Reference2LongLinkedOpenHashMap.KeyIterator(Reference2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1042 */       return Reference2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1045 */       return Reference2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1048 */       int oldSize = Reference2LongLinkedOpenHashMap.this.size;
/* 1049 */       Reference2LongLinkedOpenHashMap.this.remove(k);
/* 1050 */       return Reference2LongLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1053 */       Reference2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1056 */       if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057 */       return Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1060 */       if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061 */       return Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Reference2LongLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1027 */       super(k, null); } 
/* 1028 */     public K previous() { return Reference2LongLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1032 */     public K next() { return Reference2LongLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  955 */       return new Reference2LongLinkedOpenHashMap.EntryIterator(Reference2LongLinkedOpenHashMap.this);
/*      */     }
/*  957 */     public Comparator<? super Reference2LongMap.Entry<K>> comparator() { return null; } 
/*  958 */     public ObjectSortedSet<Reference2LongMap.Entry<K>> subSet(Reference2LongMap.Entry<K> fromElement, Reference2LongMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  959 */     public ObjectSortedSet<Reference2LongMap.Entry<K>> headSet(Reference2LongMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  960 */     public ObjectSortedSet<Reference2LongMap.Entry<K>> tailSet(Reference2LongMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Reference2LongMap.Entry<K> first() {
/*  962 */       if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963 */       return new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, Reference2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Reference2LongMap.Entry<K> last() {
/*  966 */       if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967 */       return new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, Reference2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  975 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  977 */       while (Reference2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  978 */         if (Reference2LongLinkedOpenHashMap.this.key[pos] == k) return Reference2LongLinkedOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  979 */         pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*      */       }
/*  981 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  989 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  991 */       while (Reference2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  992 */         if (Reference2LongLinkedOpenHashMap.this.key[pos] == k) {
/*  993 */           Reference2LongLinkedOpenHashMap.this.remove(e.getKey());
/*  994 */           return true;
/*      */         }
/*  996 */         pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*      */       }
/*  998 */       return false;
/*      */     }
/*      */     public int size() {
/* 1001 */       return Reference2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1004 */       Reference2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> iterator(Reference2LongMap.Entry<K> from) {
/* 1007 */       return new Reference2LongLinkedOpenHashMap.EntryIterator(Reference2LongLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> fastIterator() {
/* 1010 */       return new Reference2LongLinkedOpenHashMap.FastEntryIterator(Reference2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> fastIterator(Reference2LongMap.Entry<K> from) {
/* 1013 */       return new Reference2LongLinkedOpenHashMap.FastEntryIterator(Reference2LongLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Reference2LongLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Reference2LongMap.Entry<K>>
/*      */   {
/*  933 */     final AbstractReference2LongMap.BasicEntry<K> entry = new AbstractReference2LongMap.BasicEntry(null, 0L);
/*      */ 
...
/*  939 */       int e = nextEntry();
/*  940 */       this.entry.key = Reference2LongLinkedOpenHashMap.this.key[e];
/*  941 */       this.entry.value = Reference2LongLinkedOpenHashMap.this.value[e];
/*  942 */       return this.entry;
/*      */     }
/*      */     public AbstractReference2LongMap.BasicEntry<K> previous() {
/*  945 */       int e = previousEntry();
/*  946 */       this.entry.key = Reference2LongLinkedOpenHashMap.this.key[e];
/*  947 */       this.entry.value = Reference2LongLinkedOpenHashMap.this.value[e];
/*  948 */       return this.entry;
/*      */     }
/*  950 */     public void set(Reference2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  951 */     public void add(Reference2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Reference2LongLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Reference2LongMap.Entry<K>>
/*      */   {
...
/*  919 */       return this.entry = new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Reference2LongLinkedOpenHashMap<K>.MapEntry previous() {
/*  922 */       return this.entry = new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  926 */       super.remove();
/*  927 */       Reference2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  929 */     public void set(Reference2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  930 */     public void add(Reference2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  791 */     int index = -1;
/*      */ 
/*  793 */     private MapIterator() { this.next = Reference2LongLinkedOpenHashMap.this.first;
/*  794 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  797 */       if (Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.last] == from) {
/*  798 */         this.prev = Reference2LongLinkedOpenHashMap.this.last;
/*  799 */         this.index = Reference2LongLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  803 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  805 */         while (Reference2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  806 */           if (Reference2LongLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  808 */             this.next = ((int)Reference2LongLinkedOpenHashMap.this.link[pos]);
/*  809 */             this.prev = pos;
/*  810 */             return;
/*      */           }
/*  812 */           pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  825 */       if (this.next == -1) {
/*  826 */         this.index = Reference2LongLinkedOpenHashMap.this.size;
/*  827 */         return;
/*      */       }
/*  829 */       int pos = Reference2LongLinkedOpenHashMap.this.first;
/*  830 */       this.index = 1;
/*  831 */       while (pos != this.prev) {
/*  832 */         pos = (int)Reference2LongLinkedOpenHashMap.this.link[pos];
/*  833 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  845 */       if (!hasNext()) return Reference2LongLinkedOpenHashMap.this.size();
/*  846 */       this.curr = this.next;
/*  847 */       this.next = ((int)Reference2LongLinkedOpenHashMap.this.link[this.curr]);
...
/*  855 */       this.prev = ((int)(Reference2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  867 */         this.index -= 1;
/*  868 */         this.prev = ((int)(Reference2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  871 */         this.next = ((int)Reference2LongLinkedOpenHashMap.this.link[this.curr]);
/*  872 */       }Reference2LongLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  875 */       if (this.prev == -1) Reference2LongLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  877 */         Reference2LongLinkedOpenHashMap.this.link[this.prev] ^= (Reference2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878 */       if (this.next == -1) Reference2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  880 */         Reference2LongLinkedOpenHashMap.this.link[this.next] ^= (Reference2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  884 */         pos = (last = pos) + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*  885 */         while (Reference2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */           int slot = (Reference2LongLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2LongLinkedOpenHashMap.this.key[pos]))) & Reference2LongLinkedOpenHashMap.this.mask;
/*  887 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888 */           pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*      */         }
/*  890 */         if (Reference2LongLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891 */         Reference2LongLinkedOpenHashMap.this.key[last] = Reference2LongLinkedOpenHashMap.this.key[pos];
/*  892 */         Reference2LongLinkedOpenHashMap.this.value[last] = Reference2LongLinkedOpenHashMap.this.value[pos];
/*  893 */         if (this.next == pos) this.next = last;
/*  894 */         if (this.prev == pos) this.prev = last;
/*  895 */         Reference2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  897 */       Reference2LongLinkedOpenHashMap.this.used[last] = false;
/*  898 */       Reference2LongLinkedOpenHashMap.this.key[last] = null;
/*  899 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  660 */       return Reference2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Long getValue() {
/*  663 */       return Long.valueOf(Reference2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public long getLongValue() {
/*  666 */       return Reference2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public long setValue(long v) {
/*  669 */       long oldValue = Reference2LongLinkedOpenHashMap.this.value[this.index];
/*  670 */       Reference2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  671 */       return oldValue;
/*      */     }
/*      */     public Long setValue(Long v) {
/*  674 */       return Long.valueOf(setValue(v.longValue()));
/*      */     }
/*      */ 
/*      */     public boolean equals(Object o) {
/*  678 */       if (!(o instanceof Map.Entry)) return false;
/*  679 */       Map.Entry e = (Map.Entry)o;
/*  680 */       return (Reference2LongLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     public int hashCode() {
/*  683 */       return (Reference2LongLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2LongLinkedOpenHashMap.this.key[this.index])) ^ HashCommon.long2int(Reference2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  686 */       return Reference2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
