...
/*   18:     */
/*  113:     */public class Reference2LongLinkedOpenHashMap<K>
/*  114:     */  extends AbstractReference2LongSortedMap<K>
...
/*  127:     */  protected volatile transient Reference2LongSortedMap.FastSortedEntrySet<K> entries;
...
/*  141:     */  
/*  149:     */  public Reference2LongLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Reference2LongLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Reference2LongLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Reference2LongLinkedOpenHashMap(Map<? extends K, ? extends Long> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Reference2LongLinkedOpenHashMap(Map<? extends K, ? extends Long> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Reference2LongLinkedOpenHashMap(Reference2LongMap<K> m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Reference2LongLinkedOpenHashMap(Reference2LongMap<K> m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Reference2LongLinkedOpenHashMap(K[] k, long[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Reference2LongLinkedOpenHashMap(K[] k, long[] v)
/*  225:     */  {
...
/*  651:     */    implements Reference2LongMap.Entry<K>, Map.Entry<K, Long>
/*  652:     */  {
...
/*  658:     */    }
/*  659:     */    
/*  660: 660 */    public K getKey() { return Reference2LongLinkedOpenHashMap.this.key[this.index]; }
/*  661:     */    
/*  662:     */    public Long getValue() {
/*  663: 663 */      return Long.valueOf(Reference2LongLinkedOpenHashMap.this.value[this.index]);
/*  664:     */    }
/*  665:     */    
/*  666: 666 */    public long getLongValue() { return Reference2LongLinkedOpenHashMap.this.value[this.index]; }
/*  667:     */    
/*  668:     */    public long setValue(long v) {
/*  669: 669 */      long oldValue = Reference2LongLinkedOpenHashMap.this.value[this.index];
/*  670: 670 */      Reference2LongLinkedOpenHashMap.this.value[this.index] = v;
...
/*  680: 680 */      return (Reference2LongLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*  681:     */    }
/*  682:     */    
/*  683: 683 */    public int hashCode() { return (Reference2LongLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2LongLinkedOpenHashMap.this.key[this.index])) ^ HashCommon.long2int(Reference2LongLinkedOpenHashMap.this.value[this.index]); }
/*  684:     */    
/*  685:     */    public String toString() {
/*  686: 686 */      return Reference2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2LongLinkedOpenHashMap.this.value[this.index];
/*  687:     */    }
/*  688:     */  }
/*  689:     */  
...
/*  774: 774 */  public Reference2LongSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  775: 775 */  public Reference2LongSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); }
/*  776: 776 */  public Reference2LongSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  777:     */  
...
/*  791: 791 */    int index = -1;
/*  792:     */    
/*  793: 793 */    private MapIterator() { this.next = Reference2LongLinkedOpenHashMap.this.first;
/*  794: 794 */      this.index = 0;
/*  795:     */    }
/*  796:     */    
/*  797: 797 */    private MapIterator() { if (Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.last] == from) {
/*  798: 798 */        this.prev = Reference2LongLinkedOpenHashMap.this.last;
/*  799: 799 */        this.index = Reference2LongLinkedOpenHashMap.this.size;
/*  800:     */      }
/*  801:     */      else
/*  802:     */      {
/*  803: 803 */        int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2LongLinkedOpenHashMap.this.mask;
/*  804:     */        
/*  805: 805 */        while (Reference2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  806: 806 */          if (Reference2LongLinkedOpenHashMap.this.key[pos] == from)
/*  807:     */          {
/*  808: 808 */            this.next = ((int)Reference2LongLinkedOpenHashMap.this.link[pos]);
/*  809: 809 */            this.prev = pos;
/*  810: 810 */            return;
/*  811:     */          }
/*  812: 812 */          pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*  813:     */        }
...
/*  826: 826 */        this.index = Reference2LongLinkedOpenHashMap.this.size;
/*  827: 827 */        return;
/*  828:     */      }
/*  829: 829 */      int pos = Reference2LongLinkedOpenHashMap.this.first;
/*  830: 830 */      this.index = 1;
/*  831: 831 */      while (pos != this.prev) {
/*  832: 832 */        pos = (int)Reference2LongLinkedOpenHashMap.this.link[pos];
...
/*  843:     */    }
/*  844:     */    
/*  845: 845 */    public int nextEntry() { if (!hasNext()) return Reference2LongLinkedOpenHashMap.this.size();
/*  846: 846 */      this.curr = this.next;
/*  847: 847 */      this.next = ((int)Reference2LongLinkedOpenHashMap.this.link[this.curr]);
...
/*  855: 855 */      this.prev = ((int)(Reference2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  868: 868 */        this.prev = ((int)(Reference2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  869:     */      }
/*  870:     */      else {
/*  871: 871 */        this.next = ((int)Reference2LongLinkedOpenHashMap.this.link[this.curr]); }
/*  872: 872 */      Reference2LongLinkedOpenHashMap.this.size -= 1;
/*  873:     */      
/*  875: 875 */      if (this.prev == -1) { Reference2LongLinkedOpenHashMap.this.first = this.next;
/*  876:     */      } else
/*  877: 877 */        Reference2LongLinkedOpenHashMap.this.link[this.prev] ^= (Reference2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878: 878 */      if (this.next == -1) { Reference2LongLinkedOpenHashMap.this.last = this.prev;
/*  879:     */      } else
/*  880: 880 */        Reference2LongLinkedOpenHashMap.this.link[this.next] ^= (Reference2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  881: 881 */      int pos = this.curr;
/*  882:     */      int last;
/*  883:     */      for (;;) {
/*  884: 884 */        pos = (last = pos) + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*  885: 885 */        while (Reference2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  886: 886 */          int slot = (Reference2LongLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2LongLinkedOpenHashMap.this.key[pos]))) & Reference2LongLinkedOpenHashMap.this.mask;
/*  887: 887 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888: 888 */          pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*  889:     */        }
/*  890: 890 */        if (Reference2LongLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891: 891 */        Reference2LongLinkedOpenHashMap.this.key[last] = Reference2LongLinkedOpenHashMap.this.key[pos];
/*  892: 892 */        Reference2LongLinkedOpenHashMap.this.value[last] = Reference2LongLinkedOpenHashMap.this.value[pos];
/*  893: 893 */        if (this.next == pos) this.next = last;
/*  894: 894 */        if (this.prev == pos) this.prev = last;
/*  895: 895 */        Reference2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*  896:     */      }
/*  897: 897 */      Reference2LongLinkedOpenHashMap.this.used[last] = false;
/*  898: 898 */      Reference2LongLinkedOpenHashMap.this.key[last] = null;
/*  899: 899 */      this.curr = -1;
/*  900:     */    }
/*  901:     */    
...
/*  910:     */    } }
/*  911:     */  
/*  912:     */  private class EntryIterator extends Reference2LongLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Reference2LongMap.Entry<K>> { private Reference2LongLinkedOpenHashMap<K>.MapEntry entry;
/*  913:     */    
/*  914: 914 */    public EntryIterator() { super(null); }
/*  915:     */    
/*  916: 916 */    public EntryIterator() { super(from, null); }
/*  917:     */    
/*  918:     */    public Reference2LongLinkedOpenHashMap<K>.MapEntry next() {
/*  919: 919 */      return this.entry = new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, nextEntry());
/*  920:     */    }
/*  921:     */    
/*  922: 922 */    public Reference2LongLinkedOpenHashMap<K>.MapEntry previous() { return this.entry = new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, previousEntry()); }
/*  923:     */    
/*  924:     */    public void remove()
/*  925:     */    {
/*  926: 926 */      super.remove();
/*  927: 927 */      Reference2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  928:     */    
/*  929: 929 */    public void set(Reference2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  930: 930 */    public void add(Reference2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  931:     */  }
/*  932:     */  
/*  933: 933 */  private class FastEntryIterator extends Reference2LongLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Reference2LongMap.Entry<K>> { final AbstractReference2LongMap.BasicEntry<K> entry = new AbstractReference2LongMap.BasicEntry(null, 0L);
/*  934: 934 */    public FastEntryIterator() { super(null); }
/*  935:     */    
/*  936: 936 */    public FastEntryIterator() { super(from, null); }
/*  937:     */    
/*  938:     */    public AbstractReference2LongMap.BasicEntry<K> next() {
/*  939: 939 */      int e = nextEntry();
/*  940: 940 */      this.entry.key = Reference2LongLinkedOpenHashMap.this.key[e];
/*  941: 941 */      this.entry.value = Reference2LongLinkedOpenHashMap.this.value[e];
/*  942: 942 */      return this.entry;
/*  943:     */    }
/*  944:     */    
/*  945: 945 */    public AbstractReference2LongMap.BasicEntry<K> previous() { int e = previousEntry();
/*  946: 946 */      this.entry.key = Reference2LongLinkedOpenHashMap.this.key[e];
/*  947: 947 */      this.entry.value = Reference2LongLinkedOpenHashMap.this.value[e];
/*  948: 948 */      return this.entry; }
/*  949:     */    
/*  950: 950 */    public void set(Reference2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  951: 951 */    public void add(Reference2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); } }
/*  952:     */  
/*  953:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Reference2LongMap.Entry<K>> implements Reference2LongSortedMap.FastSortedEntrySet<K> { private MapEntrySet() {}
/*  954:     */    
/*  955: 955 */    public ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> iterator() { return new Reference2LongLinkedOpenHashMap.EntryIterator(Reference2LongLinkedOpenHashMap.this); }
/*  956:     */    
/*  957: 957 */    public Comparator<? super Reference2LongMap.Entry<K>> comparator() { return null; }
/*  958: 958 */    public ObjectSortedSet<Reference2LongMap.Entry<K>> subSet(Reference2LongMap.Entry<K> fromElement, Reference2LongMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  959: 959 */    public ObjectSortedSet<Reference2LongMap.Entry<K>> headSet(Reference2LongMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  960: 960 */    public ObjectSortedSet<Reference2LongMap.Entry<K>> tailSet(Reference2LongMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); }
/*  961:     */    
/*  962: 962 */    public Reference2LongMap.Entry<K> first() { if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963: 963 */      return new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, Reference2LongLinkedOpenHashMap.this.first);
/*  964:     */    }
/*  965:     */    
/*  966: 966 */    public Reference2LongMap.Entry<K> last() { if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967: 967 */      return new Reference2LongLinkedOpenHashMap.MapEntry(Reference2LongLinkedOpenHashMap.this, Reference2LongLinkedOpenHashMap.this.last);
/*  968:     */    }
/*  969:     */    
...
/*  974:     */      
/*  975: 975 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2LongLinkedOpenHashMap.this.mask;
/*  976:     */      
/*  977: 977 */      while (Reference2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  978: 978 */        if (Reference2LongLinkedOpenHashMap.this.key[pos] == k) return Reference2LongLinkedOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  979: 979 */        pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*  980:     */      }
...
/*  988:     */      
/*  989: 989 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2LongLinkedOpenHashMap.this.mask;
/*  990:     */      
/*  991: 991 */      while (Reference2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  992: 992 */        if (Reference2LongLinkedOpenHashMap.this.key[pos] == k) {
/*  993: 993 */          Reference2LongLinkedOpenHashMap.this.remove(e.getKey());
/*  994: 994 */          return true;
/*  995:     */        }
/*  996: 996 */        pos = pos + 1 & Reference2LongLinkedOpenHashMap.this.mask;
/*  997:     */      }
/*  998: 998 */      return false;
/*  999:     */    }
/* 1000:     */    
/* 1001:1001 */    public int size() { return Reference2LongLinkedOpenHashMap.this.size; }
/* 1002:     */    
/* 1003:     */    public void clear() {
/* 1004:1004 */      Reference2LongLinkedOpenHashMap.this.clear();
/* 1005:     */    }
/* 1006:     */    
/* 1007:1007 */    public ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> iterator(Reference2LongMap.Entry<K> from) { return new Reference2LongLinkedOpenHashMap.EntryIterator(Reference2LongLinkedOpenHashMap.this, from.getKey()); }
/* 1008:     */    
/* 1009:     */    public ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> fastIterator() {
/* 1010:1010 */      return new Reference2LongLinkedOpenHashMap.FastEntryIterator(Reference2LongLinkedOpenHashMap.this);
/* 1011:     */    }
/* 1012:     */    
/* 1013:1013 */    public ObjectBidirectionalIterator<Reference2LongMap.Entry<K>> fastIterator(Reference2LongMap.Entry<K> from) { return new Reference2LongLinkedOpenHashMap.FastEntryIterator(Reference2LongLinkedOpenHashMap.this, from.getKey()); }
/* 1014:     */  }
/* 1015:     */  
/* 1016:     */  public Reference2LongSortedMap.FastSortedEntrySet<K> reference2LongEntrySet() {
...
/* 1024:     */    extends Reference2LongLinkedOpenHashMap<K>.MapIterator
/* 1025:     */    implements ObjectListIterator<K>
/* 1026:     */  {
/* 1027:1027 */    public KeyIterator() { super(k, null); }
/* 1028:1028 */    public K previous() { return Reference2LongLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1032:1032 */    public K next() { return Reference2LongLinkedOpenHashMap.this.key[nextEntry()]; } }
/* 1033:     */  
/* 1034:     */  private final class KeySet extends AbstractReferenceSortedSet<K> { private KeySet() {}
/* 1035:     */    
/* 1036:1036 */    public ObjectListIterator<K> iterator(K from) { return new Reference2LongLinkedOpenHashMap.KeyIterator(Reference2LongLinkedOpenHashMap.this, from); }
/* 1037:     */    
/* 1038:     */    public ObjectListIterator<K> iterator() {
/* 1039:1039 */      return new Reference2LongLinkedOpenHashMap.KeyIterator(Reference2LongLinkedOpenHashMap.this);
/* 1040:     */    }
/* 1041:     */    
/* 1042:1042 */    public int size() { return Reference2LongLinkedOpenHashMap.this.size; }
/* 1043:     */    
/* 1045:1045 */    public boolean contains(Object k) { return Reference2LongLinkedOpenHashMap.this.containsKey(k); }
/* 1046:     */    
/* 1047:     */    public boolean remove(Object k) {
/* 1048:1048 */      int oldSize = Reference2LongLinkedOpenHashMap.this.size;
/* 1049:1049 */      Reference2LongLinkedOpenHashMap.this.remove(k);
/* 1050:1050 */      return Reference2LongLinkedOpenHashMap.this.size != oldSize;
/* 1051:     */    }
/* 1052:     */    
/* 1053:1053 */    public void clear() { Reference2LongLinkedOpenHashMap.this.clear(); }
/* 1054:     */    
/* 1055:     */    public K first() {
/* 1056:1056 */      if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057:1057 */      return Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.first];
/* 1058:     */    }
/* 1059:     */    
/* 1060:1060 */    public K last() { if (Reference2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061:1061 */      return Reference2LongLinkedOpenHashMap.this.key[Reference2LongLinkedOpenHashMap.this.last]; }
/* 1062:     */    
...
/* 1076:     */    extends Reference2LongLinkedOpenHashMap.MapIterator
/* 1077:     */    implements LongListIterator
/* 1078:     */  {
/* 1079:1079 */    public long previousLong() { return Reference2LongLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1080:1080 */    public Long previous() { return Long.valueOf(Reference2LongLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1086:1086 */    public long nextLong() { return Reference2LongLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1087:1087 */    public Long next() { return Long.valueOf(Reference2LongLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1088:     */  }
/* 1089:     */  
...
/* 1092:1092 */          return new Reference2LongLinkedOpenHashMap.ValueIterator(Reference2LongLinkedOpenHashMap.this);
/* 1093:     */        }
/* 1094:     */        
/* 1095:1095 */        public int size() { return Reference2LongLinkedOpenHashMap.this.size; }
/* 1096:     */        
/* 1097:     */        public boolean contains(long v) {
/* 1098:1098 */          return Reference2LongLinkedOpenHashMap.this.containsValue(v);
/* 1099:     */        }
/* 1100:     */        
/* 1101:1101 */        public void clear() { Reference2LongLinkedOpenHashMap.this.clear(); }
/* 1102:     */      };
/* 1103:     */    }
...
/* 1223:     */  }
/* 1224:     */  
/* 1227:     */  public Reference2LongLinkedOpenHashMap<K> clone()
/* 1228:     */  {
/* 1229:     */    Reference2LongLinkedOpenHashMap<K> c;
/* 1230:     */    
/* 1232:     */    try
/* 1233:     */    {
/* 1234:1234 */      c = (Reference2LongLinkedOpenHashMap)super.clone();
/* 1235:     */    }
...
/* 1272:1272 */    Reference2LongLinkedOpenHashMap<K>.MapIterator i = new MapIterator(null);
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.Reference2LongLinkedOpenHashMap
