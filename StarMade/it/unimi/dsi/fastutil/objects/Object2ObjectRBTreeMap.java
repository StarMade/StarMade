  ...
  implements Serializable, Cloneable
{
  ...
  public Object2ObjectRBTreeMap(Comparator<? super K> local_c)
  {
    this();
  ...
  public Object2ObjectRBTreeMap(Map<? extends K, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2ObjectRBTreeMap(SortedMap<K, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2ObjectRBTreeMap(Object2ObjectMap<? extends K, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2ObjectRBTreeMap(Object2ObjectSortedMap<K, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2ObjectRBTreeMap(K[] local_k, V[] local_v, Comparator<? super K> local_c)
  {
    this(local_c);
  ...
  public Object2ObjectRBTreeMap(K[] local_k, V[] local_v)
  {
  ...
  {
    Object2ObjectRBTreeMap<K, V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Object2ObjectMap.Entry<K, V>> comparator = new Comparator()
        {
          ...
          {
            return Object2ObjectRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Object2ObjectRBTreeMap.EntryIterator(Object2ObjectRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(Object2ObjectMap.Entry<K, V> from)
        {
          return new Object2ObjectRBTreeMap.EntryIterator(Object2ObjectRBTreeMap.this, from.getKey());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Object2ObjectRBTreeMap.Entry<K, V> local_f = Object2ObjectRBTreeMap.this.findKey(local_e.getKey());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Object2ObjectRBTreeMap.Entry<K, V> local_f = Object2ObjectRBTreeMap.this.findKey(local_e.getKey());
          if (local_f != null) {
            Object2ObjectRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Object2ObjectRBTreeMap.this.subMap(from.getKey(), local_to.getKey()).object2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> local_to)
        {
          return Object2ObjectRBTreeMap.this.headMap(local_to.getKey()).object2ObjectEntrySet();
        }
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Object2ObjectRBTreeMap.ValueIterator(Object2ObjectRBTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Object2ObjectRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Object2ObjectRBTreeMap<K, V> local_c;
    try
    {
      local_c = (Object2ObjectRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Object2ObjectRBTreeMap<K, V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Object2ObjectRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Object2ObjectRBTreeMap<K, V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Object2ObjectRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Object2ObjectRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator()
          {
            return new Object2ObjectRBTreeMap.Submap.SubmapEntryIterator(Object2ObjectRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(Object2ObjectMap.Entry<K, V> from)
          {
            return new Object2ObjectRBTreeMap.Submap.SubmapEntryIterator(Object2ObjectRBTreeMap.Submap.this, from.getKey());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<K, V> local_e = (Map.Entry)local_o;
            Object2ObjectRBTreeMap.Entry<K, V> local_f = Object2ObjectRBTreeMap.this.findKey(local_e.getKey());
            return (local_f != null) && (Object2ObjectRBTreeMap.Submap.this.in5(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<K, V> local_e = (Map.Entry)local_o;
            Object2ObjectRBTreeMap.Entry<K, V> local_f = Object2ObjectRBTreeMap.this.findKey(local_e.getKey());
            if ((local_f != null) && (Object2ObjectRBTreeMap.Submap.this.in5(local_f.key))) {
              Object2ObjectRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Object2ObjectRBTreeMap.Submap.SubmapIterator(Object2ObjectRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Object2ObjectRBTreeMap.Submap.this.clear();
          }
          
          public Object2ObjectMap.Entry<K, V> first()
          {
            return Object2ObjectRBTreeMap.Submap.this.firstEntry();
          }
          
          public Object2ObjectMap.Entry<K, V> last()
          {
            return Object2ObjectRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> from, Object2ObjectMap.Entry<K, V> local_to)
          {
            return Object2ObjectRBTreeMap.Submap.this.subMap(from.getKey(), local_to.getKey()).object2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> local_to)
          {
            return Object2ObjectRBTreeMap.Submap.this.headMap(local_to.getKey()).object2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from)
          {
            return Object2ObjectRBTreeMap.Submap.this.tailMap(from.getKey()).object2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Object2ObjectRBTreeMap.Submap.SubmapValueIterator(Object2ObjectRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Object2ObjectRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Object2ObjectRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(Object local_k)
    {
      return (in5(local_k)) && (Object2ObjectRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      K local_kk = local_k;
      Object2ObjectRBTreeMap.Entry<K, V> local_e;
      return (in5(local_kk)) && ((local_e = Object2ObjectRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(K local_k, V local_v)
    {
      ...
      V oldValue = Object2ObjectRBTreeMap.this.put(local_k, local_v);
    ...
    public V remove(Object local_k)
    {
      ...
      V oldValue = Object2ObjectRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Object2ObjectRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Object2ObjectRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Object2ObjectRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Object2ObjectSortedMap<K, V> tailMap(K from)
    {
      if (this.bottom) {
        return new Submap(Object2ObjectRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Object2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2ObjectRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Object2ObjectSortedMap<K, V> subMap(K from, K local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Object2ObjectRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Object2ObjectRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Object2ObjectRBTreeMap.Entry<K, V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Object2ObjectRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Object2ObjectRBTreeMap.this.locateKey(this.from);
        if (Object2ObjectRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Object2ObjectRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Object2ObjectRBTreeMap.Entry<K, V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Object2ObjectRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Object2ObjectRBTreeMap.this.locateKey(this.field_47);
        if (Object2ObjectRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Object2ObjectRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public K firstKey()
    {
      Object2ObjectRBTreeMap.Entry<K, V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public K lastKey()
    {
      Object2ObjectRBTreeMap.Entry<K, V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private class SubmapIterator
      extends Object2ObjectRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Object2ObjectRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator()
      {
        this();
        if (this.next != null) {
          if ((!Object2ObjectRBTreeMap.Submap.this.bottom) && (Object2ObjectRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Object2ObjectRBTreeMap.Submap.this.top) && (Object2ObjectRBTreeMap.this.compare(local_k, (this.prev = Object2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Object2ObjectRBTreeMap.this.locateKey(local_k);
            if (Object2ObjectRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Object2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2ObjectRBTreeMap.this.compare(this.prev.key, Object2ObjectRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Object2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Object2ObjectRBTreeMap.this.compare(this.next.key, Object2ObjectRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractObject2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Object2ObjectRBTreeMap.Submap.SubmapKeyIterator(Object2ObjectRBTreeMap.Submap.this);
      }
      
      public ObjectBidirectionalIterator<K> iterator(K from)
      {
        return new Object2ObjectRBTreeMap.Submap.SubmapKeyIterator(Object2ObjectRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractObject2ObjectSortedMap.KeySet
  {
    ...
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new Object2ObjectRBTreeMap.KeyIterator(Object2ObjectRBTreeMap.this);
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new Object2ObjectRBTreeMap.KeyIterator(Object2ObjectRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    TreeIterator()
    {
      if ((this.next = Object2ObjectRBTreeMap.this.locateKey(local_k)) != null) {
        if (Object2ObjectRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
