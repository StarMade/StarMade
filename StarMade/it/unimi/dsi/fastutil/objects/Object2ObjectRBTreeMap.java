...
/*  602 */       return true)
/*      */     {
/*  601 */       label16: Object ev = i.next();
/*  602 */       if (ev == null ? v != null : !ev.equals(v)) break label16;
/*      */     }
/*  604 */     return false;
/*      */   }
/*      */   public void clear() {
...
/*  930 */         final Comparator<? super Object2ObjectMap.Entry<K, V>> comparator = new Comparator() {
/*      */           public int compare(Object2ObjectMap.Entry<K, V> x, Object2ObjectMap.Entry<K, V> y) {
/*  932 */             return Object2ObjectRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/*  930 */         };
/*      */ 
...
/*  939 */           return new Object2ObjectRBTreeMap.EntryIterator(Object2ObjectRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(Object2ObjectMap.Entry<K, V> from) {
/*  942 */           return new Object2ObjectRBTreeMap.EntryIterator(Object2ObjectRBTreeMap.this, from.getKey());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/*  946 */           if (!(o instanceof Map.Entry)) return false;
/*  947 */           Map.Entry e = (Map.Entry)o;
/*  948 */           Object2ObjectRBTreeMap.Entry f = Object2ObjectRBTreeMap.this.findKey(e.getKey());
...
/*  955 */           Object2ObjectRBTreeMap.Entry f = Object2ObjectRBTreeMap.this.findKey(e.getKey());
/*  956 */           if (f != null) Object2ObjectRBTreeMap.this.remove(f.key);
/*  957 */           return f != null;
/*      */         }
/*  959 */         public int size() { return Object2ObjectRBTreeMap.this.count; } 
/*  960 */         public void clear() { Object2ObjectRBTreeMap.this.clear(); } 
/*  961 */         public Object2ObjectMap.Entry<K, V> first() { return Object2ObjectRBTreeMap.this.firstEntry; } 
/*  962 */         public Object2ObjectMap.Entry<K, V> last() { return Object2ObjectRBTreeMap.this.lastEntry; } 
/*  963 */         public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> from, Object2ObjectMap.Entry<K, V> to) { return Object2ObjectRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2ObjectEntrySet(); } 
/*  964 */         public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) { return Object2ObjectRBTreeMap.this.headMap(to.getKey()).object2ObjectEntrySet(); } 
/*  965 */         public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) { return Object2ObjectRBTreeMap.this.tailMap(from.getKey()).object2ObjectEntrySet(); }
/*      */       };
...
/*      */   {
/* 1021 */     if (this.values == null) this.values = new AbstractObjectCollection() {
/*      */         public ObjectIterator<V> iterator() {
/* 1023 */           return new Object2ObjectRBTreeMap.ValueIterator(Object2ObjectRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1026 */           return Object2ObjectRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1029 */           return Object2ObjectRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1032 */           Object2ObjectRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1366 */       c = (Object2ObjectRBTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1085 */       if ((!bottom) && (!top) && (Object2ObjectRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1086 */       this.from = from;
/* 1087 */       this.bottom = bottom;
/* 1088 */       this.to = to;
/* 1089 */       this.top = top;
/* 1090 */       this.defRetValue = Object2ObjectRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1104 */       return ((this.bottom) || (Object2ObjectRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Object2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
/* 1108 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator() {
/* 1110 */             return new Object2ObjectRBTreeMap.Submap.SubmapEntryIterator(Object2ObjectRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(Object2ObjectMap.Entry<K, V> from) {
/* 1113 */             return new Object2ObjectRBTreeMap.Submap.SubmapEntryIterator(Object2ObjectRBTreeMap.Submap.this, from.getKey());
/*      */           }
/* 1115 */           public Comparator<? super Object2ObjectMap.Entry<K, V>> comparator() { return Object2ObjectRBTreeMap.this.object2ObjectEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1118 */             if (!(o instanceof Map.Entry)) return false;
/* 1119 */             Map.Entry e = (Map.Entry)o;
/* 1120 */             Object2ObjectRBTreeMap.Entry f = Object2ObjectRBTreeMap.this.findKey(e.getKey());
/* 1121 */             return (f != null) && (Object2ObjectRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1125 */             if (!(o instanceof Map.Entry)) return false;
/* 1126 */             Map.Entry e = (Map.Entry)o;
/* 1127 */             Object2ObjectRBTreeMap.Entry f = Object2ObjectRBTreeMap.this.findKey(e.getKey());
/* 1128 */             if ((f != null) && (Object2ObjectRBTreeMap.Submap.this.in(f.key))) Object2ObjectRBTreeMap.Submap.this.remove(f.key);
/* 1129 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1132 */             int c = 0;
...
/* 1134 */             return c;
/*      */           }
/* 1136 */           public boolean isEmpty() { return !new Object2ObjectRBTreeMap.Submap.SubmapIterator(Object2ObjectRBTreeMap.Submap.this).hasNext(); } 
/* 1137 */           public void clear() { Object2ObjectRBTreeMap.Submap.this.clear(); } 
/* 1138 */           public Object2ObjectMap.Entry<K, V> first() { return Object2ObjectRBTreeMap.Submap.this.firstEntry(); } 
/* 1139 */           public Object2ObjectMap.Entry<K, V> last() { return Object2ObjectRBTreeMap.Submap.this.lastEntry(); } 
/* 1140 */           public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> from, Object2ObjectMap.Entry<K, V> to) { return Object2ObjectRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2ObjectEntrySet(); } 
/* 1141 */           public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) { return Object2ObjectRBTreeMap.Submap.this.headMap(to.getKey()).object2ObjectEntrySet(); } 
/* 1142 */           public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) { return Object2ObjectRBTreeMap.Submap.this.tailMap(from.getKey()).object2ObjectEntrySet(); }
/*      */         };
...
/*      */     }
/*      */     public ObjectCollection<V> values() {
/* 1155 */       if (this.values == null) this.values = new AbstractObjectCollection() {
/*      */           public ObjectIterator<V> iterator() {
/* 1157 */             return new Object2ObjectRBTreeMap.Submap.SubmapValueIterator(Object2ObjectRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1160 */             return Object2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1163 */             return Object2ObjectRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1166 */             Object2ObjectRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(Object k) {
/* 1173 */       return (in(k)) && (Object2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/* 1180 */         return true)
/*      */       {
/* 1179 */         label9: Object ev = i.nextEntry().value;
/* 1180 */         if (ev == null ? v != null : !ev.equals(v)) break label9;
/*      */       }
/* 1182 */       return false;
/*      */     }
/*      */ 
...
/*      */     {
/* 1187 */       Object kk = k;
/*      */       Object2ObjectRBTreeMap.Entry e;
/* 1188 */       return (in(kk)) && ((e = Object2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(K k, V v) {
/* 1191 */       Object2ObjectRBTreeMap.this.modified = false;
...
/* 1193 */       Object oldValue = Object2ObjectRBTreeMap.this.put(k, v);
/* 1194 */       return Object2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(Object k) {
/* 1198 */       Object2ObjectRBTreeMap.this.modified = false;
/* 1199 */       if (!in(k)) return this.defRetValue;
/* 1200 */       Object oldValue = Object2ObjectRBTreeMap.this.remove(k);
/* 1201 */       return Object2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public Comparator<? super K> comparator() {
/* 1216 */       return Object2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Object2ObjectSortedMap<K, V> headMap(K to) {
/* 1219 */       if (this.top) return new Submap(Object2ObjectRBTreeMap.this, this.from, this.bottom, to, false);
/* 1220 */       return Object2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Object2ObjectRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Object2ObjectSortedMap<K, V> tailMap(K from) {
/* 1223 */       if (this.bottom) return new Submap(Object2ObjectRBTreeMap.this, from, false, this.to, this.top);
/* 1224 */       return Object2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2ObjectRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Object2ObjectSortedMap<K, V> subMap(K from, K to) {
/* 1227 */       if ((this.top) && (this.bottom)) return new Submap(Object2ObjectRBTreeMap.this, from, false, to, false);
/* 1228 */       if (!this.top) to = Object2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1229 */       if (!this.bottom) from = Object2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1230 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1231 */       return new Submap(Object2ObjectRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Object2ObjectRBTreeMap.Entry<K, V> firstEntry()
/*      */     {
/* 1238 */       if (Object2ObjectRBTreeMap.this.tree == null) return null;
/* 1241 */       Object2ObjectRBTreeMap.Entry e;
/*      */       Object2ObjectRBTreeMap.Entry e;
/* 1241 */       if (this.bottom) { e = Object2ObjectRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1243 */         e = Object2ObjectRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1245 */         if (Object2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1248 */       if ((e == null) || ((!this.top) && (Object2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1249 */       return e;
/*      */     }
/*      */ 
/*      */     public Object2ObjectRBTreeMap.Entry<K, V> lastEntry()
/*      */     {
/* 1256 */       if (Object2ObjectRBTreeMap.this.tree == null) return null;
/* 1259 */       Object2ObjectRBTreeMap.Entry e;
/*      */       Object2ObjectRBTreeMap.Entry e;
/* 1259 */       if (this.top) { e = Object2ObjectRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1261 */         e = Object2ObjectRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1263 */         if (Object2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1266 */       if ((e == null) || ((!this.bottom) && (Object2ObjectRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1267 */       return e;
/*      */     }
/*      */     public K firstKey() {
/* 1270 */       Object2ObjectRBTreeMap.Entry e = firstEntry();
/* 1271 */       if (e == null) throw new NoSuchElementException();
/* 1272 */       return e.key;
/*      */     }
/*      */     public K lastKey() {
/* 1275 */       Object2ObjectRBTreeMap.Entry e = lastEntry();
/* 1276 */       if (e == null) throw new NoSuchElementException();
/* 1277 */       return e.key;
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Object2ObjectRBTreeMap<K, V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Object2ObjectRBTreeMap<K, V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Object2ObjectRBTreeMap<K, V>.Submap.SubmapIterator
...
/* 1320 */       public Object2ObjectMap.Entry<K, V> previous() { return previousEntry(); } 
/* 1321 */       public void set(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/* 1322 */       public void add(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Object2ObjectRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1287 */         super();
/* 1288 */         this.next = Object2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator() {
/* 1291 */         this();
/* 1292 */         if (this.next != null)
/* 1293 */           if ((!Object2ObjectRBTreeMap.Submap.this.bottom) && (Object2ObjectRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1294 */           } else if ((!Object2ObjectRBTreeMap.Submap.this.top) && (Object2ObjectRBTreeMap.this.compare(k, (this.prev = Object2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1296 */             this.next = Object2ObjectRBTreeMap.this.locateKey(k);
/* 1297 */             if (Object2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1307 */         if ((!Object2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2ObjectRBTreeMap.this.compare(this.prev.key, Object2ObjectRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1310 */         this.next = this.next.next();
/* 1311 */         if ((!Object2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Object2ObjectRBTreeMap.this.compare(this.next.key, Object2ObjectRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1146 */         super(); } 
/* 1147 */       public ObjectBidirectionalIterator<K> iterator() { return new Object2ObjectRBTreeMap.Submap.SubmapKeyIterator(Object2ObjectRBTreeMap.Submap.this); } 
/* 1148 */       public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2ObjectRBTreeMap.Submap.SubmapKeyIterator(Object2ObjectRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2ObjectRBTreeMap<K, V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/*  984 */       super(); } 
/*  985 */     public ObjectBidirectionalIterator<K> iterator() { return new Object2ObjectRBTreeMap.KeyIterator(Object2ObjectRBTreeMap.this); } 
/*  986 */     public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2ObjectRBTreeMap.KeyIterator(Object2ObjectRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2ObjectRBTreeMap<K, V>.TreeIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2ObjectRBTreeMap<K, V>.TreeIterator
/*      */     implements ObjectListIterator<Object2ObjectMap.Entry<K, V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/*  924 */     public Object2ObjectMap.Entry<K, V> previous() { return previousEntry(); } 
/*  925 */     public void set(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  926 */     public void add(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  851 */     int index = 0;
/*      */ 
/*  853 */     TreeIterator() { this.next = Object2ObjectRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator() {
/*  856 */       if ((this.next = Object2ObjectRBTreeMap.this.locateKey(k)) != null)
/*  857 */         if (Object2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/*  898 */       updatePrevious();
/*  899 */       updateNext();
/*  900 */       Object2ObjectRBTreeMap.this.remove(this.curr.key);
/*  901 */       this.curr = null;
/*      */     }
...
/*  778 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  781 */       return (this.key == null ? 0 : this.key.hashCode()) ^ (this.value == null ? 0 : this.value.hashCode());
/*      */     }
