...
public abstract interface Reference2BooleanMap<K> extends Reference2BooleanFunction<K>, Map<K, Boolean>
{
  ...
  public static abstract interface Entry<K> extends Map.Entry<K, Boolean>
  {
  ...
  public static abstract interface FastEntrySet<K> extends ObjectSet<Reference2BooleanMap.Entry<K>>
  {
