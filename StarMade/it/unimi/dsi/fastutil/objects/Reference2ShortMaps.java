...
/*  11:    */
/*  58:    */public class Reference2ShortMaps
/*  59:    */{
/*  60:    */  public static class EmptyMap<K>
/*  61:    */    extends Reference2ShortFunctions.EmptyFunction<K>
/*  62:    */    implements Reference2ShortMap<K>, Serializable, Cloneable
/*  63:    */  {
...
/*  68:    */    
/*  69: 69 */    public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() { return ObjectSets.EMPTY_SET; }
/*  70:    */    
...
/*  75: 75 */    private Object readResolve() { return Reference2ShortMaps.EMPTY_MAP; }
/*  76: 76 */    public Object clone() { return Reference2ShortMaps.EMPTY_MAP; }
/*  77: 77 */    public boolean isEmpty() { return true; }
/*  78:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<K, Short>> entrySet() { return reference2ShortEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Reference2ShortFunctions.Singleton<K>
/* 103:    */    implements Reference2ShortMap<K>, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Reference2ShortMap.Entry<K>> entries;
/* 108:    */    
...
/* 125:    */    
/* 126:126 */    public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Reference2ShortMap.Entry<K>, Map.Entry<K, Short> { protected SingletonEntry() {}
/* 131:131 */      public K getKey() { return Reference2ShortMaps.Singleton.this.key; }
/* 132:132 */      public Short getValue() { return Short.valueOf(Reference2ShortMaps.Singleton.this.value); }
/* 133:    */      
/* 139:139 */      public short getShortValue() { return Reference2ShortMaps.Singleton.this.value; }
...
/* 148:    */        
/* 149:149 */        return (Reference2ShortMaps.Singleton.this.key == e.getKey()) && (Reference2ShortMaps.Singleton.this.value == ((Short)e.getValue()).shortValue());
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return (Reference2ShortMaps.Singleton.this.key == null ? 0 : System.identityHashCode(Reference2ShortMaps.Singleton.this.key)) ^ Reference2ShortMaps.Singleton.this.value; }
/* 153:153 */      public String toString() { return Reference2ShortMaps.Singleton.this.key + "->" + Reference2ShortMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<K, Short>> entrySet() { return reference2ShortEntrySet(); }
/* 160:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static <K> Reference2ShortMap<K> singleton(K key, short value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static <K> Reference2ShortMap<K> singleton(K key, Short value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key, value.shortValue());
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap<K>
/* 205:    */    extends Reference2ShortFunctions.SynchronizedFunction<K>
/* 206:    */    implements Reference2ShortMap<K>, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Reference2ShortMap<K> map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Reference2ShortMap.Entry<K>> entries;
/* 213:    */    
/* 214:    */    protected volatile transient ReferenceSet<K> keys;
/* 215:    */    protected volatile transient ShortCollection values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Reference2ShortMap<K> m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Reference2ShortMap<K> m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 239:    */    
/* 240:240 */    public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2ShortEntrySet(), this.sync); return this.entries; }
...
/* 258:    */  }
/* 259:    */  
/* 261:    */  public static <K> Reference2ShortMap<K> synchronize(Reference2ShortMap<K> m)
/* 262:    */  {
/* 263:263 */    return new SynchronizedMap(m);
/* 264:    */  }
/* 265:    */  
/* 271:271 */  public static <K> Reference2ShortMap<K> synchronize(Reference2ShortMap<K> m, Object sync) { return new SynchronizedMap(m, sync); }
/* 272:    */  
/* 273:    */  public static class UnmodifiableMap<K> extends Reference2ShortFunctions.UnmodifiableFunction<K> implements Reference2ShortMap<K>, Serializable {
/* 274:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 275:    */    protected final Reference2ShortMap<K> map;
/* 276:    */    protected volatile transient ObjectSet<Reference2ShortMap.Entry<K>> entries;
/* 277:    */    protected volatile transient ReferenceSet<K> keys;
/* 278:    */    protected volatile transient ShortCollection values;
/* 279:    */    
/* 280:280 */    protected UnmodifiableMap(Reference2ShortMap<K> m) { super();
/* 281:281 */      this.map = m; }
/* 282:    */    
...
/* 291:291 */    public ObjectSet<Reference2ShortMap.Entry<K>> reference2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.reference2ShortEntrySet()); return this.entries; }
...
/* 301:    */  }
/* 302:    */  
/* 306:    */  public static <K> Reference2ShortMap<K> unmodifiable(Reference2ShortMap<K> m)
/* 307:    */  {
