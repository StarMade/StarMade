  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2BooleanLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2BooleanLinkedOpenHashMap(Map<? extends K, ? extends Boolean> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2BooleanLinkedOpenHashMap(Map<? extends K, ? extends Boolean> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2BooleanLinkedOpenHashMap(Reference2BooleanMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2BooleanLinkedOpenHashMap(Reference2BooleanMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2BooleanLinkedOpenHashMap(K[] local_k, boolean[] local_v, float local_f)
  {
  ...
  public Reference2BooleanLinkedOpenHashMap(K[] local_k, boolean[] local_v)
  {
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Reference2BooleanLinkedOpenHashMap.ValueIterator(Reference2BooleanLinkedOpenHashMap.this);
        }
        ...
        {
          return Reference2BooleanLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2BooleanLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Reference2BooleanLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    boolean[] value = this.value;
    Reference2BooleanLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Reference2BooleanLinkedOpenHashMap.MapIterator
    implements BooleanListIterator
  {
    ...
    {
      return Boolean.valueOf(Reference2BooleanLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Boolean next()
    {
      return Boolean.valueOf(Reference2BooleanLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractReferenceSortedSet<K>
  {
    ...
    {
      return new Reference2BooleanLinkedOpenHashMap.KeyIterator(Reference2BooleanLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Reference2BooleanLinkedOpenHashMap.KeyIterator(Reference2BooleanLinkedOpenHashMap.this);
    }
    ...
    {
      return Reference2BooleanLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2BooleanLinkedOpenHashMap.this.size;
      Reference2BooleanLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Reference2BooleanSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Reference2BooleanLinkedOpenHashMap.EntryIterator(Reference2BooleanLinkedOpenHashMap.this);
    }
    ...
    public Reference2BooleanMap.Entry<K> first()
    {
      ...
      return new Reference2BooleanLinkedOpenHashMap.MapEntry(Reference2BooleanLinkedOpenHashMap.this, Reference2BooleanLinkedOpenHashMap.this.first);
    }
    ...
    public Reference2BooleanMap.Entry<K> last()
    {
      ...
      return new Reference2BooleanLinkedOpenHashMap.MapEntry(Reference2BooleanLinkedOpenHashMap.this, Reference2BooleanLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2BooleanLinkedOpenHashMap.this.mask; Reference2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2BooleanLinkedOpenHashMap.this.mask) {
        if (Reference2BooleanLinkedOpenHashMap.this.key[pos] == local_k) {
          return Reference2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)local_e.getValue()).booleanValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2BooleanLinkedOpenHashMap.this.mask; Reference2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2BooleanLinkedOpenHashMap.this.mask) {
        if (Reference2BooleanLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Reference2BooleanLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Reference2BooleanLinkedOpenHashMap.EntryIterator(Reference2BooleanLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Reference2BooleanMap.Entry<K>> fastIterator()
    {
      return new Reference2BooleanLinkedOpenHashMap.FastEntryIterator(Reference2BooleanLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Reference2BooleanMap.Entry<K>> fastIterator(Reference2BooleanMap.Entry<K> from)
    {
      return new Reference2BooleanLinkedOpenHashMap.FastEntryIterator(Reference2BooleanLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Reference2BooleanMap.Entry<K>>
  {
    ...
    public AbstractReference2BooleanMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Reference2BooleanLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Reference2BooleanLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    public void set(Reference2BooleanMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
    
    public void add(Reference2BooleanMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
  }
    ...
    implements ObjectListIterator<Reference2BooleanMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Reference2BooleanLinkedOpenHashMap.MapEntry(Reference2BooleanLinkedOpenHashMap.this, nextEntry());
    }
    
    public Reference2BooleanLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Reference2BooleanLinkedOpenHashMap.MapEntry(Reference2BooleanLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2BooleanLinkedOpenHashMap.this.mask; Reference2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2BooleanLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Reference2BooleanLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Reference2BooleanLinkedOpenHashMap.this.first = this.next;
      } else {
        Reference2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Reference2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Reference2BooleanLinkedOpenHashMap.this.last = this.prev;
      } else {
        Reference2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Reference2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2BooleanLinkedOpenHashMap.this.mask; Reference2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2BooleanLinkedOpenHashMap.this.mask)
        {
          int slot = (Reference2BooleanLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2BooleanLinkedOpenHashMap.this.key[pos]))) & Reference2BooleanLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Reference2BooleanLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Reference2BooleanLinkedOpenHashMap.this.key[last] = Reference2BooleanLinkedOpenHashMap.this.key[pos];
      ...
      Reference2BooleanLinkedOpenHashMap.this.used[last] = false;
      Reference2BooleanLinkedOpenHashMap.this.key[last] = null;
      this.curr = -1;
    }
    ...
    implements Reference2BooleanMap.Entry<K>, Map.Entry<K, Boolean>
  {
    ...
    public boolean setValue(boolean local_v)
    {
      ...
      Reference2BooleanLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Boolean> local_e = (Map.Entry)local_o;
      return (Reference2BooleanLinkedOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)local_e.getValue()).booleanValue());
    }
    
    public int hashCode()
    {
      return (Reference2BooleanLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2BooleanLinkedOpenHashMap.this.key[this.index])) ^ (Reference2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
    }
