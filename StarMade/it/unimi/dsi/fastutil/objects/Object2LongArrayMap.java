  ...
  implements Serializable, Cloneable
{
  ...
  public Object2LongArrayMap(Object2LongMap<K> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Object2LongArrayMap(Map<? extends K, ? extends Long> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Object2LongArrayMap<K> local_c;
    try
    {
      local_c = (Object2LongArrayMap)super.clone();
    }
    ...
    implements Object2LongMap.FastEntrySet<K>
  {
    ...
    public ObjectIterator<Object2LongMap.Entry<K>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Object2LongMap.Entry<K> next()
        {
          ...
          return new AbstractObject2LongMap.BasicEntry(Object2LongArrayMap.this.key[this.next], Object2LongArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Object2LongMap.Entry<K>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Object2LongMap.Entry<K> next()
        {
          ...
          this.entry.key = Object2LongArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Object2LongArrayMap.this.containsKey(local_k)) && (Object2LongArrayMap.this.get(local_k).longValue() == ((Long)local_e.getValue()).longValue());
    }
  }
}
