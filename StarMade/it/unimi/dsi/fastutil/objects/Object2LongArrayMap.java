...
/*     */ 
/*     */ public class Object2LongArrayMap<K> extends AbstractObject2LongMap<K>
...
/*     */     try
/*     */     {
/* 300 */       c = (Object2LongArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Object2LongMap.Entry<K>>
...
/* 130 */         int next = 0;
/*     */ 
/* 132 */         public boolean hasNext() { return this.next < Object2LongArrayMap.this.size; }
/*     */ 
/*     */         public Object2LongMap.Entry<K> next()
/*     */         {
/* 136 */           if (!hasNext()) throw new NoSuchElementException();
/* 137 */           return new AbstractObject2LongMap.BasicEntry(Object2LongArrayMap.this.key[this.next], Object2LongArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 143 */         int next = 0;
/* 144 */         final AbstractObject2LongMap.BasicEntry<K> entry = new AbstractObject2LongMap.BasicEntry(null, 0L);
/*     */ 
/* 146 */         public boolean hasNext() { return this.next < Object2LongArrayMap.this.size; }
/*     */ 
/*     */         public Object2LongMap.Entry<K> next()
/*     */         {
/* 150 */           if (!hasNext()) throw new NoSuchElementException();
/* 151 */           this.entry.key = Object2LongArrayMap.this.key[this.next];
/* 152 */           this.entry.value = Object2LongArrayMap.this.value[(this.next++)];
/* 153 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 158 */       return Object2LongArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 165 */       return (Object2LongArrayMap.this.containsKey(k)) && (Object2LongArrayMap.this.get(k).longValue() == ((Long)e.getValue()).longValue());
/*     */     }
/*     */   }
/*     */ }
