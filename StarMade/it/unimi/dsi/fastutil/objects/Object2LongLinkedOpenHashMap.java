...
/*  774 */   public Object2LongSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  775 */   public Object2LongSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  776 */   public Object2LongSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1092 */           return new Object2LongLinkedOpenHashMap.ValueIterator(Object2LongLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1095 */           return Object2LongLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(long v) {
/* 1098 */           return Object2LongLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1101 */           Object2LongLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1234 */       c = (Object2LongLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2LongLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public long previousLong()
/*      */     {
/* 1079 */       return Object2LongLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1080 */     public Long previous() { return Long.valueOf(Object2LongLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1086 */     public long nextLong() { return Object2LongLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1087 */     public Long next() { return Long.valueOf(Object2LongLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1036 */       return new Object2LongLinkedOpenHashMap.KeyIterator(Object2LongLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1039 */       return new Object2LongLinkedOpenHashMap.KeyIterator(Object2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1042 */       return Object2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1045 */       return Object2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1048 */       int oldSize = Object2LongLinkedOpenHashMap.this.size;
/* 1049 */       Object2LongLinkedOpenHashMap.this.remove(k);
/* 1050 */       return Object2LongLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1053 */       Object2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1056 */       if (Object2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057 */       return Object2LongLinkedOpenHashMap.this.key[Object2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1060 */       if (Object2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061 */       return Object2LongLinkedOpenHashMap.this.key[Object2LongLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2LongLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1027 */       super(k, null); } 
/* 1028 */     public K previous() { return Object2LongLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1032 */     public K next() { return Object2LongLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  955 */       return new Object2LongLinkedOpenHashMap.EntryIterator(Object2LongLinkedOpenHashMap.this);
/*      */     }
/*  957 */     public Comparator<? super Object2LongMap.Entry<K>> comparator() { return null; } 
/*  958 */     public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> fromElement, Object2LongMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  959 */     public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  960 */     public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Object2LongMap.Entry<K> first() {
/*  962 */       if (Object2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963 */       return new Object2LongLinkedOpenHashMap.MapEntry(Object2LongLinkedOpenHashMap.this, Object2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Object2LongMap.Entry<K> last() {
/*  966 */       if (Object2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967 */       return new Object2LongLinkedOpenHashMap.MapEntry(Object2LongLinkedOpenHashMap.this, Object2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  975 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  977 */       while (Object2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  978 */         if (Object2LongLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2LongLinkedOpenHashMap.this.key[pos].equals(k)) return Object2LongLinkedOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  979 */         pos = pos + 1 & Object2LongLinkedOpenHashMap.this.mask;
/*      */       }
/*  981 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  989 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  991 */       while (Object2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  992 */         if (Object2LongLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2LongLinkedOpenHashMap.this.key[pos].equals(k)) {
/*  993 */           Object2LongLinkedOpenHashMap.this.remove(e.getKey());
/*  994 */           return true;
/*      */         }
/*  996 */         pos = pos + 1 & Object2LongLinkedOpenHashMap.this.mask;
/*      */       }
/*  998 */       return false;
/*      */     }
/*      */     public int size() {
/* 1001 */       return Object2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1004 */       Object2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/* 1007 */       return new Object2LongLinkedOpenHashMap.EntryIterator(Object2LongLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> fastIterator() {
/* 1010 */       return new Object2LongLinkedOpenHashMap.FastEntryIterator(Object2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> fastIterator(Object2LongMap.Entry<K> from) {
/* 1013 */       return new Object2LongLinkedOpenHashMap.FastEntryIterator(Object2LongLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Object2LongLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2LongMap.Entry<K>>
/*      */   {
/*  933 */     final AbstractObject2LongMap.BasicEntry<K> entry = new AbstractObject2LongMap.BasicEntry(null, 0L);
/*      */ 
...
/*  939 */       int e = nextEntry();
/*  940 */       this.entry.key = Object2LongLinkedOpenHashMap.this.key[e];
/*  941 */       this.entry.value = Object2LongLinkedOpenHashMap.this.value[e];
/*  942 */       return this.entry;
/*      */     }
/*      */     public AbstractObject2LongMap.BasicEntry<K> previous() {
/*  945 */       int e = previousEntry();
/*  946 */       this.entry.key = Object2LongLinkedOpenHashMap.this.key[e];
/*  947 */       this.entry.value = Object2LongLinkedOpenHashMap.this.value[e];
/*  948 */       return this.entry;
/*      */     }
/*  950 */     public void set(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  951 */     public void add(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2LongLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2LongMap.Entry<K>>
/*      */   {
...
/*  919 */       return this.entry = new Object2LongLinkedOpenHashMap.MapEntry(Object2LongLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Object2LongLinkedOpenHashMap<K>.MapEntry previous() {
/*  922 */       return this.entry = new Object2LongLinkedOpenHashMap.MapEntry(Object2LongLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  926 */       super.remove();
/*  927 */       Object2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  929 */     public void set(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  930 */     public void add(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  791 */     int index = -1;
/*      */ 
/*  793 */     private MapIterator() { this.next = Object2LongLinkedOpenHashMap.this.first;
/*  794 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  797 */       if (Object2LongLinkedOpenHashMap.this.key[Object2LongLinkedOpenHashMap.this.last] == null ? from == null : Object2LongLinkedOpenHashMap.this.key[Object2LongLinkedOpenHashMap.this.last].equals(from)) {
/*  798 */         this.prev = Object2LongLinkedOpenHashMap.this.last;
/*  799 */         this.index = Object2LongLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  803 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  805 */         while (Object2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  806 */           if (Object2LongLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2LongLinkedOpenHashMap.this.key[pos].equals(from))
/*      */           {
/*  808 */             this.next = ((int)Object2LongLinkedOpenHashMap.this.link[pos]);
/*  809 */             this.prev = pos;
/*  810 */             return;
/*      */           }
/*  812 */           pos = pos + 1 & Object2LongLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  825 */       if (this.next == -1) {
/*  826 */         this.index = Object2LongLinkedOpenHashMap.this.size;
/*  827 */         return;
/*      */       }
/*  829 */       int pos = Object2LongLinkedOpenHashMap.this.first;
/*  830 */       this.index = 1;
/*  831 */       while (pos != this.prev) {
/*  832 */         pos = (int)Object2LongLinkedOpenHashMap.this.link[pos];
/*  833 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  845 */       if (!hasNext()) return Object2LongLinkedOpenHashMap.this.size();
/*  846 */       this.curr = this.next;
/*  847 */       this.next = ((int)Object2LongLinkedOpenHashMap.this.link[this.curr]);
...
/*  855 */       this.prev = ((int)(Object2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  867 */         this.index -= 1;
/*  868 */         this.prev = ((int)(Object2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  871 */         this.next = ((int)Object2LongLinkedOpenHashMap.this.link[this.curr]);
/*  872 */       }Object2LongLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  875 */       if (this.prev == -1) Object2LongLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  877 */         Object2LongLinkedOpenHashMap.this.link[this.prev] ^= (Object2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878 */       if (this.next == -1) Object2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  880 */         Object2LongLinkedOpenHashMap.this.link[this.next] ^= (Object2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  884 */         pos = (last = pos) + 1 & Object2LongLinkedOpenHashMap.this.mask;
/*  885 */         while (Object2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */           int slot = (Object2LongLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2LongLinkedOpenHashMap.this.key[pos].hashCode())) & Object2LongLinkedOpenHashMap.this.mask;
/*  887 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888 */           pos = pos + 1 & Object2LongLinkedOpenHashMap.this.mask;
/*      */         }
/*  890 */         if (Object2LongLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891 */         Object2LongLinkedOpenHashMap.this.key[last] = Object2LongLinkedOpenHashMap.this.key[pos];
/*  892 */         Object2LongLinkedOpenHashMap.this.value[last] = Object2LongLinkedOpenHashMap.this.value[pos];
/*  893 */         if (this.next == pos) this.next = last;
/*  894 */         if (this.prev == pos) this.prev = last;
/*  895 */         Object2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  897 */       Object2LongLinkedOpenHashMap.this.used[last] = false;
/*  898 */       Object2LongLinkedOpenHashMap.this.key[last] = null;
/*  899 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  660 */       return Object2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Long getValue() {
/*  663 */       return Long.valueOf(Object2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public long getLongValue() {
/*  666 */       return Object2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public long setValue(long v) {
/*  669 */       long oldValue = Object2LongLinkedOpenHashMap.this.value[this.index];
/*  670 */       Object2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  671 */       return oldValue;
/*      */     }
/*      */     public Long setValue(Long v) {
...
/*  680 */       return (Object2LongLinkedOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2LongLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     public int hashCode() {
/*  683 */       return (Object2LongLinkedOpenHashMap.this.key[this.index] == null ? 0 : Object2LongLinkedOpenHashMap.this.key[this.index].hashCode()) ^ HashCommon.long2int(Object2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  686 */       return Object2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Object2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
