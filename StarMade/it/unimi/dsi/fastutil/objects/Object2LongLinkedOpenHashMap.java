  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2LongLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Object2LongLinkedOpenHashMap(Map<? extends K, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2LongLinkedOpenHashMap(Map<? extends K, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2LongLinkedOpenHashMap(Object2LongMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2LongLinkedOpenHashMap(Object2LongMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2LongLinkedOpenHashMap(K[] local_k, long[] local_v, float local_f)
  {
  ...
  public Object2LongLinkedOpenHashMap(K[] local_k, long[] local_v)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Object2LongLinkedOpenHashMap.ValueIterator(Object2LongLinkedOpenHashMap.this);
        }
        ...
        {
          return Object2LongLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2LongLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Object2LongLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    long[] value = this.value;
    Object2LongLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2LongLinkedOpenHashMap.MapIterator
    ...
    extends AbstractObjectSortedSet<K>
  {
    ...
    {
      return new Object2LongLinkedOpenHashMap.KeyIterator(Object2LongLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Object2LongLinkedOpenHashMap.KeyIterator(Object2LongLinkedOpenHashMap.this);
    }
    ...
    {
      return Object2LongLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2LongLinkedOpenHashMap.this.size;
      Object2LongLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Object2LongSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Object2LongLinkedOpenHashMap.EntryIterator(Object2LongLinkedOpenHashMap.this);
    }
    ...
    public Object2LongMap.Entry<K> first()
    {
      ...
      return new Object2LongLinkedOpenHashMap.MapEntry(Object2LongLinkedOpenHashMap.this, Object2LongLinkedOpenHashMap.this.first);
    }
    ...
    public Object2LongMap.Entry<K> last()
    {
      ...
      return new Object2LongLinkedOpenHashMap.MapEntry(Object2LongLinkedOpenHashMap.this, Object2LongLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2LongLinkedOpenHashMap.this.mask; Object2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2LongLinkedOpenHashMap.this.mask) {
        if (Object2LongLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2LongLinkedOpenHashMap.this.key[pos].equals(local_k)) {
          return Object2LongLinkedOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2LongLinkedOpenHashMap.this.mask; Object2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2LongLinkedOpenHashMap.this.mask) {
        if (Object2LongLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2LongLinkedOpenHashMap.this.key[pos].equals(local_k))
        {
          Object2LongLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Object2LongLinkedOpenHashMap.EntryIterator(Object2LongLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> fastIterator()
    {
      return new Object2LongLinkedOpenHashMap.FastEntryIterator(Object2LongLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> fastIterator(Object2LongMap.Entry<K> from)
    {
      return new Object2LongLinkedOpenHashMap.FastEntryIterator(Object2LongLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Object2LongMap.Entry<K>>
  {
    ...
    public AbstractObject2LongMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2LongLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Object2LongLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Object2LongMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2LongLinkedOpenHashMap.MapEntry(Object2LongLinkedOpenHashMap.this, nextEntry());
    }
    
    public Object2LongLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Object2LongLinkedOpenHashMap.MapEntry(Object2LongLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2LongLinkedOpenHashMap.this.mask; Object2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2LongLinkedOpenHashMap.this.mask) {
          if (Object2LongLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2LongLinkedOpenHashMap.this.key[pos].equals(from))
          {
    ...
    public void remove()
    {
      ...
      Object2LongLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Object2LongLinkedOpenHashMap.this.first = this.next;
      } else {
        Object2LongLinkedOpenHashMap.this.link[this.prev] ^= (Object2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Object2LongLinkedOpenHashMap.this.last = this.prev;
      } else {
        Object2LongLinkedOpenHashMap.this.link[this.next] ^= (Object2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2LongLinkedOpenHashMap.this.mask; Object2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2LongLinkedOpenHashMap.this.mask)
        {
          int slot = (Object2LongLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2LongLinkedOpenHashMap.this.key[pos].hashCode())) & Object2LongLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2LongLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Object2LongLinkedOpenHashMap.this.key[last] = Object2LongLinkedOpenHashMap.this.key[pos];
      ...
      Object2LongLinkedOpenHashMap.this.used[last] = false;
      Object2LongLinkedOpenHashMap.this.key[last] = null;
      this.curr = -1;
    }
    ...
    implements Object2LongMap.Entry<K>, Map.Entry<K, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Object2LongLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Long> local_e = (Map.Entry)local_o;
      return (Object2LongLinkedOpenHashMap.this.key[this.index] == null ? local_e.getKey() == null : Object2LongLinkedOpenHashMap.this.key[this.index].equals(local_e.getKey())) && (Object2LongLinkedOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
