...
/*   2:    */
/*   3:    */import it.unimi.dsi.fastutil.chars.CharArraySet;
/*   4:    */import it.unimi.dsi.fastutil.chars.CharArrays;
/*   5:    */import it.unimi.dsi.fastutil.chars.CharCollection;
/*   6:    */import it.unimi.dsi.fastutil.chars.CharCollections;
...
/*  14:    */
/*  65:    */public class Reference2CharArrayMap<K>
/*  66:    */  extends AbstractReference2CharMap<K>
/*  67:    */  implements Serializable, Cloneable
/*  68:    */{
/*  69:    */  private static final long serialVersionUID = 1L;
/*  70:    */  private transient Object[] key;
/*  71:    */  private transient char[] value;
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Reference2CharArrayMap(Object[] key, char[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Reference2CharArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = ObjectArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = CharArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Reference2CharArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new Object[capacity];
/*  93: 93 */    this.value = new char[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Reference2CharArrayMap(Reference2CharMap<K> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Reference2CharArrayMap(Map<? extends K, ? extends Character> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Reference2CharArrayMap(Object[] key, char[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Reference2CharMap.Entry<K>> implements Reference2CharMap.FastEntrySet<K> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Reference2CharMap.Entry<K>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Reference2CharArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Reference2CharMap.Entry<K> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractReference2CharMap.BasicEntry(Reference2CharArrayMap.this.key[this.next], Reference2CharArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Reference2CharMap.Entry<K>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractReference2CharMap.BasicEntry<K> entry = new AbstractReference2CharMap.BasicEntry(null, '\000');
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Reference2CharArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Reference2CharMap.Entry<K> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Reference2CharArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Reference2CharArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Reference2CharArrayMap.this.size; }
/* 159:    */    
/* 160:    */    public boolean contains(Object o)
/* 161:    */    {
/* 162:162 */      if (!(o instanceof Map.Entry)) return false;
/* 163:163 */      Map.Entry<K, Character> e = (Map.Entry)o;
/* 164:164 */      K k = e.getKey();
/* 165:165 */      return (Reference2CharArrayMap.this.containsKey(k)) && (Reference2CharArrayMap.this.get(k).charValue() == ((Character)e.getValue()).charValue());
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Reference2CharMap.FastEntrySet<K> reference2CharEntrySet() { return new EntrySet(null); }
/* 170:    */  
...
/* 176:    */  }
/* 177:    */  
/* 182:    */  public char getChar(Object k)
/* 183:    */  {
...
/* 211:    */  }
/* 212:    */  
/* 214:    */  public boolean containsValue(char v)
/* 215:    */  {
...
/* 223:    */  }
/* 224:    */  
/* 226:    */  public char put(K k, char v)
/* 227:    */  {
/* 228:228 */    int oldKey = findKey(k);
/* 229:229 */    if (oldKey != -1) {
/* 230:230 */      char oldValue = this.value[oldKey];
...
/* 236:236 */      char[] newValue = new char[this.size == 0 ? 2 : this.size * 2];
...
/* 248:    */  }
/* 249:    */  
/* 256:    */  public char removeChar(Object k)
/* 257:    */  {
/* 258:258 */    int oldPos = findKey(k);
/* 259:259 */    if (oldPos == -1) return this.defRetValue;
/* 260:260 */    char oldValue = this.value[oldPos];
...
/* 281:    */  }
/* 282:    */  
/* 283:    */  public CharCollection values()
/* 284:    */  {
/* 285:285 */    return CharCollections.unmodifiable(new CharArraySet(this.value, this.size));
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Reference2CharArrayMap<K> clone()
/* 293:    */  {
/* 294:    */    Reference2CharArrayMap<K> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Reference2CharArrayMap)super.clone();
/* 301:    */    }
/* 302:    */    catch (CloneNotSupportedException cantHappen) {
/* 303:303 */      throw new InternalError();
/* 304:    */    }
/* 305:305 */    c.key = ((Object[])this.key.clone());
/* 306:306 */    c.value = ((char[])this.value.clone());
/* 307:307 */    return c;
/* 308:    */  }
/* 309:    */  
...
/* 314:314 */      s.writeChar(this.value[i]);
/* 315:    */    }
/* 316:    */  }
/* 317:    */  
...
/* 322:322 */    this.value = new char[this.size];
/* 323:323 */    for (int i = 0; i < this.size; i++) {
/* 324:324 */      this.key[i] = s.readObject();
/* 325:325 */      this.value[i] = s.readChar();
/* 326:    */    }
/* 327:    */  }
/* 328:    */}
