...
/*  16:    */
/*  86:    */public class Reference2DoubleOpenHashMap<K>
/*  87:    */  extends AbstractReference2DoubleMap<K>
...
/* 100:    */  protected volatile transient Reference2DoubleMap.FastEntrySet<K> entries;
/* 101:    */  protected volatile transient ReferenceSet<K> keys;
/* 102:    */  protected volatile transient DoubleCollection values;
/* 103:    */  
/* 104:    */  public Reference2DoubleOpenHashMap(int expected, float f)
/* 105:    */  {
...
/* 115:    */  }
/* 116:    */  
/* 119:    */  public Reference2DoubleOpenHashMap(int expected)
/* 120:    */  {
/* 121:121 */    this(expected, 0.75F);
/* 122:    */  }
/* 123:    */  
/* 125:    */  public Reference2DoubleOpenHashMap()
/* 126:    */  {
/* 127:127 */    this(16, 0.75F);
/* 128:    */  }
/* 129:    */  
/* 133:    */  public Reference2DoubleOpenHashMap(Map<? extends K, ? extends Double> m, float f)
/* 134:    */  {
/* 135:135 */    this(m.size(), f);
/* 136:136 */    putAll(m);
/* 137:    */  }
/* 138:    */  
/* 141:    */  public Reference2DoubleOpenHashMap(Map<? extends K, ? extends Double> m)
/* 142:    */  {
/* 143:143 */    this(m, 0.75F);
/* 144:    */  }
/* 145:    */  
/* 149:    */  public Reference2DoubleOpenHashMap(Reference2DoubleMap<K> m, float f)
/* 150:    */  {
/* 151:151 */    this(m.size(), f);
/* 152:152 */    putAll(m);
/* 153:    */  }
/* 154:    */  
/* 157:    */  public Reference2DoubleOpenHashMap(Reference2DoubleMap<K> m)
/* 158:    */  {
/* 159:159 */    this(m, 0.75F);
/* 160:    */  }
/* 161:    */  
/* 167:    */  public Reference2DoubleOpenHashMap(K[] k, double[] v, float f)
/* 168:    */  {
...
/* 173:    */  }
/* 174:    */  
/* 178:    */  public Reference2DoubleOpenHashMap(K[] k, double[] v)
/* 179:    */  {
...
/* 379:    */    implements Reference2DoubleMap.Entry<K>, Map.Entry<K, Double>
/* 380:    */  {
...
/* 386:    */    }
/* 387:    */    
/* 388:388 */    public K getKey() { return Reference2DoubleOpenHashMap.this.key[this.index]; }
/* 389:    */    
/* 390:    */    public Double getValue() {
/* 391:391 */      return Double.valueOf(Reference2DoubleOpenHashMap.this.value[this.index]);
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public double getDoubleValue() { return Reference2DoubleOpenHashMap.this.value[this.index]; }
/* 395:    */    
/* 396:    */    public double setValue(double v) {
/* 397:397 */      double oldValue = Reference2DoubleOpenHashMap.this.value[this.index];
/* 398:398 */      Reference2DoubleOpenHashMap.this.value[this.index] = v;
...
/* 408:408 */      return (Reference2DoubleOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2DoubleOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/* 409:    */    }
/* 410:    */    
/* 411:411 */    public int hashCode() { return (Reference2DoubleOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2DoubleOpenHashMap.this.key[this.index])) ^ HashCommon.double2int(Reference2DoubleOpenHashMap.this.value[this.index]); }
/* 412:    */    
/* 414:414 */    public String toString() { return Reference2DoubleOpenHashMap.this.key[this.index] + "=>" + Reference2DoubleOpenHashMap.this.value[this.index]; } }
/* 415:    */  
...
/* 420:    */    
/* 421:421 */    private MapIterator() { this.pos = Reference2DoubleOpenHashMap.this.n;
/* 422:    */      
/* 424:424 */      this.last = -1;
/* 425:    */      
/* 426:426 */      this.c = Reference2DoubleOpenHashMap.this.size;
/* 427:    */      
/* 431:431 */      boolean[] used = Reference2DoubleOpenHashMap.this.used;
...
/* 443:    */        
/* 444:444 */        int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2DoubleOpenHashMap.this.mask;
/* 445:    */        
/* 446:446 */        while (Reference2DoubleOpenHashMap.this.used[pos] != 0) {
/* 447:447 */          if (Reference2DoubleOpenHashMap.this.key[pos] == k) return pos;
/* 448:448 */          pos = pos + 1 & Reference2DoubleOpenHashMap.this.mask;
/* 449:    */        }
/* 450:    */      }
/* 451:451 */      this.last = this.pos;
/* 452:    */      
/* 453:453 */      if (this.c != 0) {
/* 454:454 */        boolean[] used = Reference2DoubleOpenHashMap.this.used;
...
/* 469:    */      for (;;)
/* 470:    */      {
/* 471:471 */        pos = (last = pos) + 1 & Reference2DoubleOpenHashMap.this.mask;
/* 472:472 */        while (Reference2DoubleOpenHashMap.this.used[pos] != 0) {
/* 473:473 */          int slot = (Reference2DoubleOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2DoubleOpenHashMap.this.key[pos]))) & Reference2DoubleOpenHashMap.this.mask;
/* 474:474 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 475:475 */          pos = pos + 1 & Reference2DoubleOpenHashMap.this.mask;
/* 476:    */        }
/* 477:477 */        if (Reference2DoubleOpenHashMap.this.used[pos] == 0) break;
/* 478:478 */        if (pos < last)
/* 479:    */        {
/* 480:480 */          if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 481:481 */          this.wrapped.add(Reference2DoubleOpenHashMap.this.key[pos]);
/* 482:    */        }
/* 483:483 */        Reference2DoubleOpenHashMap.this.key[last] = Reference2DoubleOpenHashMap.this.key[pos];
/* 484:484 */        Reference2DoubleOpenHashMap.this.value[last] = Reference2DoubleOpenHashMap.this.value[pos];
/* 485:    */      }
/* 486:486 */      Reference2DoubleOpenHashMap.this.used[last] = false;
/* 487:487 */      Reference2DoubleOpenHashMap.this.key[last] = null;
/* 488:488 */      return last;
/* 489:    */    }
/* 490:    */    
...
/* 494:    */      {
/* 495:495 */        Reference2DoubleOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 496:496 */        this.last = -1;
/* 497:497 */        return;
/* 498:    */      }
/* 499:499 */      Reference2DoubleOpenHashMap.this.size -= 1;
...
/* 511:    */    } }
/* 512:    */  
/* 513:513 */  private class EntryIterator extends Reference2DoubleOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2DoubleMap.Entry<K>> { private EntryIterator() { super(null); }
/* 514:    */    
/* 515:    */    private Reference2DoubleOpenHashMap<K>.MapEntry entry;
/* 516:516 */    public Reference2DoubleMap.Entry<K> next() { return this.entry = new Reference2DoubleOpenHashMap.MapEntry(Reference2DoubleOpenHashMap.this, nextEntry()); }
/* 517:    */    
/* 518:    */    public void remove()
/* 519:    */    {
/* 520:520 */      super.remove();
/* 521:521 */      Reference2DoubleOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 522:    */    } }
/* 523:    */  
/* 524:524 */  private class FastEntryIterator extends Reference2DoubleOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2DoubleMap.Entry<K>> { private FastEntryIterator() { super(null); }
/* 525:525 */    final AbstractReference2DoubleMap.BasicEntry<K> entry = new AbstractReference2DoubleMap.BasicEntry(null, 0.0D);
/* 526:    */    
/* 527:527 */    public AbstractReference2DoubleMap.BasicEntry<K> next() { int e = nextEntry();
/* 528:528 */      this.entry.key = Reference2DoubleOpenHashMap.this.key[e];
/* 529:529 */      this.entry.value = Reference2DoubleOpenHashMap.this.value[e];
/* 530:530 */      return this.entry;
/* 531:    */    } }
/* 532:    */  
/* 533:    */  private final class MapEntrySet extends AbstractObjectSet<Reference2DoubleMap.Entry<K>> implements Reference2DoubleMap.FastEntrySet<K> { private MapEntrySet() {}
/* 534:    */    
/* 535:535 */    public ObjectIterator<Reference2DoubleMap.Entry<K>> iterator() { return new Reference2DoubleOpenHashMap.EntryIterator(Reference2DoubleOpenHashMap.this, null); }
/* 536:    */    
/* 537:    */    public ObjectIterator<Reference2DoubleMap.Entry<K>> fastIterator() {
/* 538:538 */      return new Reference2DoubleOpenHashMap.FastEntryIterator(Reference2DoubleOpenHashMap.this, null);
/* 539:    */    }
/* 540:    */    
...
/* 545:    */      
/* 546:546 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2DoubleOpenHashMap.this.mask;
/* 547:    */      
/* 548:548 */      while (Reference2DoubleOpenHashMap.this.used[pos] != 0) {
/* 549:549 */        if (Reference2DoubleOpenHashMap.this.key[pos] == k) return Reference2DoubleOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/* 550:550 */        pos = pos + 1 & Reference2DoubleOpenHashMap.this.mask;
/* 551:    */      }
...
/* 559:    */      
/* 560:560 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2DoubleOpenHashMap.this.mask;
/* 561:    */      
/* 562:562 */      while (Reference2DoubleOpenHashMap.this.used[pos] != 0) {
/* 563:563 */        if (Reference2DoubleOpenHashMap.this.key[pos] == k) {
/* 564:564 */          Reference2DoubleOpenHashMap.this.remove(e.getKey());
/* 565:565 */          return true;
/* 566:    */        }
/* 567:567 */        pos = pos + 1 & Reference2DoubleOpenHashMap.this.mask;
/* 568:    */      }
/* 569:569 */      return false;
/* 570:    */    }
/* 571:    */    
/* 572:572 */    public int size() { return Reference2DoubleOpenHashMap.this.size; }
/* 573:    */    
/* 575:575 */    public void clear() { Reference2DoubleOpenHashMap.this.clear(); }
/* 576:    */  }
/* 577:    */  
/* 578:    */  public Reference2DoubleMap.FastEntrySet<K> reference2DoubleEntrySet() {
...
/* 586:    */    extends Reference2DoubleOpenHashMap<K>.MapIterator
/* 587:    */    implements ObjectIterator<K>
/* 588:    */  {
/* 589:589 */    public KeyIterator() { super(null); }
/* 590:590 */    public K next() { return Reference2DoubleOpenHashMap.this.key[nextEntry()]; } }
/* 591:    */  
/* 592:    */  private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/* 593:    */    
/* 594:594 */    public ObjectIterator<K> iterator() { return new Reference2DoubleOpenHashMap.KeyIterator(Reference2DoubleOpenHashMap.this); }
/* 595:    */    
/* 596:    */    public int size() {
/* 597:597 */      return Reference2DoubleOpenHashMap.this.size;
/* 598:    */    }
/* 599:    */    
/* 600:600 */    public boolean contains(Object k) { return Reference2DoubleOpenHashMap.this.containsKey(k); }
/* 601:    */    
/* 602:    */    public boolean remove(Object k) {
/* 603:603 */      int oldSize = Reference2DoubleOpenHashMap.this.size;
/* 604:604 */      Reference2DoubleOpenHashMap.this.remove(k);
/* 605:605 */      return Reference2DoubleOpenHashMap.this.size != oldSize;
/* 606:    */    }
/* 607:    */    
/* 608:608 */    public void clear() { Reference2DoubleOpenHashMap.this.clear(); }
/* 609:    */  }
/* 610:    */  
...
/* 619:    */    extends Reference2DoubleOpenHashMap.MapIterator
/* 620:    */    implements DoubleIterator
/* 621:    */  {
/* 622:622 */    public ValueIterator() { super(null); }
/* 623:623 */    public double nextDouble() { return Reference2DoubleOpenHashMap.this.value[nextEntry()]; }
/* 624:624 */    public Double next() { return Double.valueOf(Reference2DoubleOpenHashMap.this.value[nextEntry()]); }
/* 625:    */  }
/* 626:    */  
...
/* 629:629 */          return new Reference2DoubleOpenHashMap.ValueIterator(Reference2DoubleOpenHashMap.this);
/* 630:    */        }
/* 631:    */        
/* 632:632 */        public int size() { return Reference2DoubleOpenHashMap.this.size; }
/* 633:    */        
/* 634:    */        public boolean contains(double v) {
/* 635:635 */          return Reference2DoubleOpenHashMap.this.containsValue(v);
/* 636:    */        }
/* 637:    */        
/* 638:638 */        public void clear() { Reference2DoubleOpenHashMap.this.clear(); }
/* 639:    */      };
/* 640:    */    }
...
/* 741:    */  }
/* 742:    */  
/* 746:    */  public Reference2DoubleOpenHashMap<K> clone()
/* 747:    */  {
/* 748:    */    Reference2DoubleOpenHashMap<K> c;
/* 749:    */    
/* 751:    */    try
/* 752:    */    {
/* 753:753 */      c = (Reference2DoubleOpenHashMap)super.clone();
/* 754:    */    }
...
/* 790:790 */    Reference2DoubleOpenHashMap<K>.MapIterator i = new MapIterator(null);
