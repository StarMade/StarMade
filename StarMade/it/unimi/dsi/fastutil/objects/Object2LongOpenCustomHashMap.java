...
/* 649 */           return new Object2LongOpenCustomHashMap.ValueIterator(Object2LongOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 652 */           return Object2LongOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(long v) {
/* 655 */           return Object2LongOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 658 */           Object2LongOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 773 */       c = (Object2LongOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Object2LongOpenCustomHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 642 */       super(null); } 
/* 643 */     public long nextLong() { return Object2LongOpenCustomHashMap.this.value[nextEntry()]; } 
/* 644 */     public Long next() { return Long.valueOf(Object2LongOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 614 */       return new Object2LongOpenCustomHashMap.KeyIterator(Object2LongOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 617 */       return Object2LongOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 620 */       return Object2LongOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 623 */       int oldSize = Object2LongOpenCustomHashMap.this.size;
/* 624 */       Object2LongOpenCustomHashMap.this.remove(k);
/* 625 */       return Object2LongOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 628 */       Object2LongOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Object2LongOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 609 */       super(null); } 
/* 610 */     public K next() { return Object2LongOpenCustomHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
/*     */   private final class MapEntrySet extends AbstractObjectSet<Object2LongMap.Entry<K>>
...
/*     */     {
/* 555 */       return new Object2LongOpenCustomHashMap.EntryIterator(Object2LongOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Object2LongMap.Entry<K>> fastIterator() {
/* 558 */       return new Object2LongOpenCustomHashMap.FastEntryIterator(Object2LongOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 566 */       int pos = HashCommon.murmurHash3(Object2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongOpenCustomHashMap.this.mask;
/*     */ 
/* 568 */       while (Object2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 569 */         if (Object2LongOpenCustomHashMap.this.strategy.equals(Object2LongOpenCustomHashMap.this.key[pos], k)) return Object2LongOpenCustomHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/* 570 */         pos = pos + 1 & Object2LongOpenCustomHashMap.this.mask;
/*     */       }
/* 572 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 580 */       int pos = HashCommon.murmurHash3(Object2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongOpenCustomHashMap.this.mask;
/*     */ 
/* 582 */       while (Object2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 583 */         if (Object2LongOpenCustomHashMap.this.strategy.equals(Object2LongOpenCustomHashMap.this.key[pos], k)) {
/* 584 */           Object2LongOpenCustomHashMap.this.remove(e.getKey());
/* 585 */           return true;
/*     */         }
/* 587 */         pos = pos + 1 & Object2LongOpenCustomHashMap.this.mask;
/*     */       }
/* 589 */       return false;
/*     */     }
/*     */     public int size() {
/* 592 */       return Object2LongOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 595 */       Object2LongOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Object2LongOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2LongMap.Entry<K>>
/*     */   {
/* 545 */     final AbstractObject2LongMap.BasicEntry<K> entry = new AbstractObject2LongMap.BasicEntry(null, 0L);
/*     */ 
...
/* 547 */       int e = nextEntry();
/* 548 */       this.entry.key = Object2LongOpenCustomHashMap.this.key[e];
/* 549 */       this.entry.value = Object2LongOpenCustomHashMap.this.value[e];
/* 550 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Object2LongOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2LongMap.Entry<K>>
/*     */   {
...
/* 536 */       return this.entry = new Object2LongOpenCustomHashMap.MapEntry(Object2LongOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 540 */       super.remove();
/* 541 */       Object2LongOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 441 */       this.pos = Object2LongOpenCustomHashMap.this.n;
/*     */ 
/* 444 */       this.last = -1;
/*     */ 
/* 446 */       this.c = Object2LongOpenCustomHashMap.this.size;
/*     */ 
/* 451 */       boolean[] used = Object2LongOpenCustomHashMap.this.used;
...
/*     */ 
/* 464 */         int pos = HashCommon.murmurHash3(Object2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongOpenCustomHashMap.this.mask;
/*     */ 
/* 466 */         while (Object2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 467 */           if (Object2LongOpenCustomHashMap.this.strategy.equals(Object2LongOpenCustomHashMap.this.key[pos], k)) return pos;
/* 468 */           pos = pos + 1 & Object2LongOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 471 */       this.last = this.pos;
/*     */ 
/* 473 */       if (this.c != 0) {
/* 474 */         boolean[] used = Object2LongOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 491 */         pos = (last = pos) + 1 & Object2LongOpenCustomHashMap.this.mask;
/* 492 */         while (Object2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 493 */           int slot = HashCommon.murmurHash3(Object2LongOpenCustomHashMap.this.strategy.hashCode(Object2LongOpenCustomHashMap.this.key[pos])) & Object2LongOpenCustomHashMap.this.mask;
/* 494 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 495 */           pos = pos + 1 & Object2LongOpenCustomHashMap.this.mask;
/*     */         }
/* 497 */         if (Object2LongOpenCustomHashMap.this.used[pos] == 0) break;
/* 498 */         if (pos < last)
/*     */         {
/* 500 */           if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 501 */           this.wrapped.add(Object2LongOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 503 */         Object2LongOpenCustomHashMap.this.key[last] = Object2LongOpenCustomHashMap.this.key[pos];
/* 504 */         Object2LongOpenCustomHashMap.this.value[last] = Object2LongOpenCustomHashMap.this.value[pos];
/*     */       }
/* 506 */       Object2LongOpenCustomHashMap.this.used[last] = false;
/* 507 */       Object2LongOpenCustomHashMap.this.key[last] = null;
/* 508 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 513 */       if (this.pos < -1)
/*     */       {
/* 515 */         Object2LongOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 516 */         this.last = -1;
/* 517 */         return;
/*     */       }
/* 519 */       Object2LongOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 408 */       return Object2LongOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Long getValue() {
/* 411 */       return Long.valueOf(Object2LongOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public long getLongValue() {
/* 414 */       return Object2LongOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public long setValue(long v) {
/* 417 */       long oldValue = Object2LongOpenCustomHashMap.this.value[this.index];
/* 418 */       Object2LongOpenCustomHashMap.this.value[this.index] = v;
/* 419 */       return oldValue;
/*     */     }
/*     */     public Long setValue(Long v) {
...
/* 428 */       return (Object2LongOpenCustomHashMap.this.strategy.equals(Object2LongOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2LongOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*     */     }
/*     */     public int hashCode() {
/* 431 */       return Object2LongOpenCustomHashMap.this.strategy.hashCode(Object2LongOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Object2LongOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 434 */       return Object2LongOpenCustomHashMap.this.key[this.index] + "=>" + Object2LongOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
