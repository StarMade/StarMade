  ...
  implements Object2LongSortedMap<K>
{
    ...
    extends AbstractLongCollection
  {
    ...
    {
      return new AbstractObject2LongSortedMap.ValuesIterator(AbstractObject2LongSortedMap.this.entrySet().iterator());
    }
    
    public boolean contains(long local_k)
    {
      return AbstractObject2LongSortedMap.this.containsValue(local_k);
    }
    ...
    extends AbstractObjectSortedSet<K>
  {
    ...
    {
      return AbstractObject2LongSortedMap.this.containsKey(local_k);
    }
    ...
    {
      return AbstractObject2LongSortedMap.this.headMap(local_to).keySet();
    }
    ...
    {
      return AbstractObject2LongSortedMap.this.subMap(from, local_to).keySet();
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new AbstractObject2LongSortedMap.KeySetIterator(AbstractObject2LongSortedMap.this.entrySet().iterator(new AbstractObject2LongMap.BasicEntry(from, 0L)));
    }
    
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new AbstractObject2LongSortedMap.KeySetIterator(AbstractObject2LongSortedMap.this.entrySet().iterator());
    }
  }
}
