...
/*  162 */     this.value = new long[this.n];
...
/*  288 */         Long oldValue = Long.valueOf(this.value[pos]);
...
/*  401 */         this.size -= 1;
/*  402 */         fixPointers(pos);
/*  403 */         long v = this.value[pos];
/*  404 */         shiftKeys(pos);
/*  405 */         return Long.valueOf(v);
/*      */       }
...
/*  540 */         long oldValue = this.value[pos];
...
/*  579 */         long oldValue = this.value[pos];
...
/*  793 */   public Object2LongSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  794 */   public Object2LongSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  795 */   public Object2LongSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/* 1109 */     if (this.values == null) this.values = new AbstractLongCollection() {
/*      */         public LongIterator iterator() {
/* 1111 */           return new Object2LongLinkedOpenCustomHashMap.ValueIterator(Object2LongLinkedOpenCustomHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1114 */           return Object2LongLinkedOpenCustomHashMap.this.size;
/*      */         }
/*      */         public boolean contains(long v) {
/* 1117 */           return Object2LongLinkedOpenCustomHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1120 */           Object2LongLinkedOpenCustomHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1253 */       c = (Object2LongLinkedOpenCustomHashMap)super.clone();
/*      */     }
...
/* 1262 */     c.value = ((long[])this.value.clone());
...
/* 1283 */       t ^= HashCommon.long2int(this.value[i]);
/* 1284 */       h += t;
/* 1285 */       i++;
/*      */     }
/* 1287 */     return h;
...
/* 1307 */     long[] value = this.value = new long[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2LongLinkedOpenCustomHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public long previousLong()
/*      */     {
/* 1098 */       return Object2LongLinkedOpenCustomHashMap.this.value[previousEntry()]; } 
/* 1099 */     public Long previous() { return Long.valueOf(Object2LongLinkedOpenCustomHashMap.this.value[previousEntry()]); } 
/* 1100 */     public void set(Long ok) { throw new UnsupportedOperationException(); } 
/* 1101 */     public void add(Long ok) { throw new UnsupportedOperationException(); } 
/* 1102 */     public void set(long v) { throw new UnsupportedOperationException(); } 
/* 1103 */     public void add(long v) { throw new UnsupportedOperationException(); } 
/* 1104 */     public ValueIterator() { super(null); } 
/* 1105 */     public long nextLong() { return Object2LongLinkedOpenCustomHashMap.this.value[nextEntry()]; } 
/* 1106 */     public Long next() { return Long.valueOf(Object2LongLinkedOpenCustomHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1055 */       return new Object2LongLinkedOpenCustomHashMap.KeyIterator(Object2LongLinkedOpenCustomHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1058 */       return new Object2LongLinkedOpenCustomHashMap.KeyIterator(Object2LongLinkedOpenCustomHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1061 */       return Object2LongLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1064 */       return Object2LongLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1067 */       int oldSize = Object2LongLinkedOpenCustomHashMap.this.size;
/* 1068 */       Object2LongLinkedOpenCustomHashMap.this.remove(k);
/* 1069 */       return Object2LongLinkedOpenCustomHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1072 */       Object2LongLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1075 */       if (Object2LongLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Object2LongLinkedOpenCustomHashMap.this.key[Object2LongLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1079 */       if (Object2LongLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1080 */       return Object2LongLinkedOpenCustomHashMap.this.key[Object2LongLinkedOpenCustomHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2LongLinkedOpenCustomHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1046 */       super(k, null); } 
/* 1047 */     public K previous() { return Object2LongLinkedOpenCustomHashMap.this.key[previousEntry()]; } 
...
/* 1051 */     public K next() { return Object2LongLinkedOpenCustomHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  974 */       return new Object2LongLinkedOpenCustomHashMap.EntryIterator(Object2LongLinkedOpenCustomHashMap.this);
/*      */     }
/*  976 */     public Comparator<? super Object2LongMap.Entry<K>> comparator() { return null; } 
/*  977 */     public ObjectSortedSet<Object2LongMap.Entry<K>> subSet(Object2LongMap.Entry<K> fromElement, Object2LongMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  978 */     public ObjectSortedSet<Object2LongMap.Entry<K>> headSet(Object2LongMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  979 */     public ObjectSortedSet<Object2LongMap.Entry<K>> tailSet(Object2LongMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Object2LongMap.Entry<K> first() {
/*  981 */       if (Object2LongLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  982 */       return new Object2LongLinkedOpenCustomHashMap.MapEntry(Object2LongLinkedOpenCustomHashMap.this, Object2LongLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */     public Object2LongMap.Entry<K> last() {
/*  985 */       if (Object2LongLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  986 */       return new Object2LongLinkedOpenCustomHashMap.MapEntry(Object2LongLinkedOpenCustomHashMap.this, Object2LongLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  994 */       int pos = HashCommon.murmurHash3(Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  996 */       while (Object2LongLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  997 */         if (Object2LongLinkedOpenCustomHashMap.this.strategy.equals(Object2LongLinkedOpenCustomHashMap.this.key[pos], k)) return Object2LongLinkedOpenCustomHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  998 */         pos = pos + 1 & Object2LongLinkedOpenCustomHashMap.this.mask;
/*      */       }
/* 1000 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1008 */       int pos = HashCommon.murmurHash3(Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2LongLinkedOpenCustomHashMap.this.mask;
/*      */ 
/* 1010 */       while (Object2LongLinkedOpenCustomHashMap.this.used[pos] != 0) {
/* 1011 */         if (Object2LongLinkedOpenCustomHashMap.this.strategy.equals(Object2LongLinkedOpenCustomHashMap.this.key[pos], k)) {
/* 1012 */           Object2LongLinkedOpenCustomHashMap.this.remove(e.getKey());
/* 1013 */           return true;
/*      */         }
/* 1015 */         pos = pos + 1 & Object2LongLinkedOpenCustomHashMap.this.mask;
/*      */       }
/* 1017 */       return false;
/*      */     }
/*      */     public int size() {
/* 1020 */       return Object2LongLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1023 */       Object2LongLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> iterator(Object2LongMap.Entry<K> from) {
/* 1026 */       return new Object2LongLinkedOpenCustomHashMap.EntryIterator(Object2LongLinkedOpenCustomHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> fastIterator() {
/* 1029 */       return new Object2LongLinkedOpenCustomHashMap.FastEntryIterator(Object2LongLinkedOpenCustomHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2LongMap.Entry<K>> fastIterator(Object2LongMap.Entry<K> from) {
/* 1032 */       return new Object2LongLinkedOpenCustomHashMap.FastEntryIterator(Object2LongLinkedOpenCustomHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Object2LongLinkedOpenCustomHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2LongMap.Entry<K>>
/*      */   {
/*  952 */     final AbstractObject2LongMap.BasicEntry<K> entry = new AbstractObject2LongMap.BasicEntry(null, 0L);
/*      */ 
...
/*  958 */       int e = nextEntry();
/*  959 */       this.entry.key = Object2LongLinkedOpenCustomHashMap.this.key[e];
/*  960 */       this.entry.value = Object2LongLinkedOpenCustomHashMap.this.value[e];
/*  961 */       return this.entry;
/*      */     }
/*      */     public AbstractObject2LongMap.BasicEntry<K> previous() {
/*  964 */       int e = previousEntry();
/*  965 */       this.entry.key = Object2LongLinkedOpenCustomHashMap.this.key[e];
/*  966 */       this.entry.value = Object2LongLinkedOpenCustomHashMap.this.value[e];
/*  967 */       return this.entry;
/*      */     }
/*  969 */     public void set(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  970 */     public void add(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2LongLinkedOpenCustomHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2LongMap.Entry<K>>
/*      */   {
...
/*  938 */       return this.entry = new Object2LongLinkedOpenCustomHashMap.MapEntry(Object2LongLinkedOpenCustomHashMap.this, nextEntry());
/*      */     }
/*      */     public Object2LongLinkedOpenCustomHashMap<K>.MapEntry previous() {
/*  941 */       return this.entry = new Object2LongLinkedOpenCustomHashMap.MapEntry(Object2LongLinkedOpenCustomHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  945 */       super.remove();
/*  946 */       Object2LongLinkedOpenCustomHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  948 */     public void set(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  949 */     public void add(Object2LongMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  810 */     int index = -1;
/*      */ 
/*  812 */     private MapIterator() { this.next = Object2LongLinkedOpenCustomHashMap.this.first;
/*  813 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  816 */       if (Object2LongLinkedOpenCustomHashMap.this.strategy.equals(Object2LongLinkedOpenCustomHashMap.this.key[Object2LongLinkedOpenCustomHashMap.this.last], from)) {
/*  817 */         this.prev = Object2LongLinkedOpenCustomHashMap.this.last;
/*  818 */         this.index = Object2LongLinkedOpenCustomHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  822 */         int pos = HashCommon.murmurHash3(Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2LongLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  824 */         while (Object2LongLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  825 */           if (Object2LongLinkedOpenCustomHashMap.this.strategy.equals(Object2LongLinkedOpenCustomHashMap.this.key[pos], from))
/*      */           {
/*  827 */             this.next = ((int)Object2LongLinkedOpenCustomHashMap.this.link[pos]);
/*  828 */             this.prev = pos;
/*  829 */             return;
/*      */           }
/*  831 */           pos = pos + 1 & Object2LongLinkedOpenCustomHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  844 */       if (this.next == -1) {
/*  845 */         this.index = Object2LongLinkedOpenCustomHashMap.this.size;
/*  846 */         return;
/*      */       }
/*  848 */       int pos = Object2LongLinkedOpenCustomHashMap.this.first;
/*  849 */       this.index = 1;
/*  850 */       while (pos != this.prev) {
/*  851 */         pos = (int)Object2LongLinkedOpenCustomHashMap.this.link[pos];
/*  852 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  864 */       if (!hasNext()) return Object2LongLinkedOpenCustomHashMap.this.size();
/*  865 */       this.curr = this.next;
/*  866 */       this.next = ((int)Object2LongLinkedOpenCustomHashMap.this.link[this.curr]);
...
/*  874 */       this.prev = ((int)(Object2LongLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  886 */         this.index -= 1;
/*  887 */         this.prev = ((int)(Object2LongLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  890 */         this.next = ((int)Object2LongLinkedOpenCustomHashMap.this.link[this.curr]);
/*  891 */       }Object2LongLinkedOpenCustomHashMap.this.size -= 1;
/*      */ 
/*  894 */       if (this.prev == -1) Object2LongLinkedOpenCustomHashMap.this.first = this.next;
/*      */       else
/*  896 */         Object2LongLinkedOpenCustomHashMap.this.link[this.prev] ^= (Object2LongLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  897 */       if (this.next == -1) Object2LongLinkedOpenCustomHashMap.this.last = this.prev;
/*      */       else
/*  899 */         Object2LongLinkedOpenCustomHashMap.this.link[this.next] ^= (Object2LongLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  903 */         pos = (last = pos) + 1 & Object2LongLinkedOpenCustomHashMap.this.mask;
/*  904 */         while (Object2LongLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  905 */           int slot = HashCommon.murmurHash3(Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(Object2LongLinkedOpenCustomHashMap.this.key[pos])) & Object2LongLinkedOpenCustomHashMap.this.mask;
/*  906 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  907 */           pos = pos + 1 & Object2LongLinkedOpenCustomHashMap.this.mask;
/*      */         }
/*  909 */         if (Object2LongLinkedOpenCustomHashMap.this.used[pos] == 0) break;
/*  910 */         Object2LongLinkedOpenCustomHashMap.this.key[last] = Object2LongLinkedOpenCustomHashMap.this.key[pos];
/*  911 */         Object2LongLinkedOpenCustomHashMap.this.value[last] = Object2LongLinkedOpenCustomHashMap.this.value[pos];
/*  912 */         if (this.next == pos) this.next = last;
/*  913 */         if (this.prev == pos) this.prev = last;
/*  914 */         Object2LongLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */       }
/*  916 */       Object2LongLinkedOpenCustomHashMap.this.used[last] = false;
/*  917 */       Object2LongLinkedOpenCustomHashMap.this.key[last] = null;
/*  918 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  679 */       return Object2LongLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     public Long getValue() {
/*  682 */       return Long.valueOf(Object2LongLinkedOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */     public long getLongValue() {
/*  685 */       return Object2LongLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     public long setValue(long v) {
/*  688 */       long oldValue = Object2LongLinkedOpenCustomHashMap.this.value[this.index];
/*  689 */       Object2LongLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  690 */       return oldValue;
/*      */     }
/*      */     public Long setValue(Long v) {
...
/*  699 */       return (Object2LongLinkedOpenCustomHashMap.this.strategy.equals(Object2LongLinkedOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2LongLinkedOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     public int hashCode() {
/*  702 */       return Object2LongLinkedOpenCustomHashMap.this.strategy.hashCode(Object2LongLinkedOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Object2LongLinkedOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  705 */       return Object2LongLinkedOpenCustomHashMap.this.key[this.index] + "=>" + Object2LongLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
