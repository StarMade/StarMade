...
public class Object2ReferenceSortedMaps
{
  ...
  public static <K, V> Object2ReferenceSortedMap<K, V> synchronize(Object2ReferenceSortedMap<K, V> local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static <K, V> Object2ReferenceSortedMap<K, V> synchronize(Object2ReferenceSortedMap<K, V> local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static <K, V> Object2ReferenceSortedMap<K, V> unmodifiable(Object2ReferenceSortedMap<K, V> local_m)
  {
    ...
    implements Object2ReferenceSortedMap<K, V>, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Object2ReferenceSortedMap<K, V> local_m)
    {
      super();
    ...
    implements Object2ReferenceSortedMap<K, V>, Serializable
  {
    ...
    protected SynchronizedSortedMap(Object2ReferenceSortedMap<K, V> local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Object2ReferenceSortedMap<K, V> local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Object2ReferenceSortedMap<K, V>, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Object2ReferenceMaps.Singleton.SingletonEntry(this), Object2ReferenceSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
