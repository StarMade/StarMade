...
/*  597 */     boolean oldValue = put(ok, ov.booleanValue());
/*  598 */     return this.modified ? null : Boolean.valueOf(oldValue);
/*      */   }
/*      */   public Boolean remove(Object ok) {
/*  601 */     boolean oldValue = removeBoolean(ok);
/*  602 */     return this.modified ? Boolean.valueOf(oldValue) : null;
/*      */   }
...
/*  949 */         final Comparator<? super Object2BooleanMap.Entry<K>> comparator = new Comparator() {
/*      */           public int compare(Object2BooleanMap.Entry<K> x, Object2BooleanMap.Entry<K> y) {
/*  951 */             return Object2BooleanRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/*  949 */         };
/*      */ 
...
/*  958 */           return new Object2BooleanRBTreeMap.EntryIterator(Object2BooleanRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator(Object2BooleanMap.Entry<K> from) {
/*  961 */           return new Object2BooleanRBTreeMap.EntryIterator(Object2BooleanRBTreeMap.this, from.getKey());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/*  965 */           if (!(o instanceof Map.Entry)) return false;
/*  966 */           Map.Entry e = (Map.Entry)o;
/*  967 */           Object2BooleanRBTreeMap.Entry f = Object2BooleanRBTreeMap.this.findKey(e.getKey());
...
/*  974 */           Object2BooleanRBTreeMap.Entry f = Object2BooleanRBTreeMap.this.findKey(e.getKey());
/*  975 */           if (f != null) Object2BooleanRBTreeMap.this.removeBoolean(f.key);
/*  976 */           return f != null;
/*      */         }
/*  978 */         public int size() { return Object2BooleanRBTreeMap.this.count; } 
/*  979 */         public void clear() { Object2BooleanRBTreeMap.this.clear(); } 
/*  980 */         public Object2BooleanMap.Entry<K> first() { return Object2BooleanRBTreeMap.this.firstEntry; } 
/*  981 */         public Object2BooleanMap.Entry<K> last() { return Object2BooleanRBTreeMap.this.lastEntry; } 
/*  982 */         public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> from, Object2BooleanMap.Entry<K> to) { return Object2BooleanRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2BooleanEntrySet(); } 
/*  983 */         public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> to) { return Object2BooleanRBTreeMap.this.headMap(to.getKey()).object2BooleanEntrySet(); } 
/*  984 */         public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> from) { return Object2BooleanRBTreeMap.this.tailMap(from.getKey()).object2BooleanEntrySet(); }
/*      */       };
...
/*      */   {
/* 1044 */     if (this.values == null) this.values = new AbstractBooleanCollection() {
/*      */         public BooleanIterator iterator() {
/* 1046 */           return new Object2BooleanRBTreeMap.ValueIterator(Object2BooleanRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(boolean k) {
/* 1049 */           return Object2BooleanRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1052 */           return Object2BooleanRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1055 */           Object2BooleanRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1407 */       c = (Object2BooleanRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1479 */     if (n == 1) {
/* 1480 */       Entry top = new Entry(s.readObject(), s.readBoolean());
/* 1481 */       top.pred(pred);
/* 1482 */       top.succ(succ);
/* 1483 */       top.black(true);
/* 1484 */       return top;
...
/* 1486 */     if (n == 2)
/*      */     {
/* 1489 */       Entry top = new Entry(s.readObject(), s.readBoolean());
/* 1490 */       top.black(true);
/* 1491 */       top.right(new Entry(s.readObject(), s.readBoolean()));
...
/*      */     {
/* 1108 */       if ((!bottom) && (!top) && (Object2BooleanRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1109 */       this.from = from;
/* 1110 */       this.bottom = bottom;
/* 1111 */       this.to = to;
/* 1112 */       this.top = top;
/* 1113 */       this.defRetValue = Object2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1127 */       return ((this.bottom) || (Object2BooleanRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Object2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Object2BooleanMap.Entry<K>> object2BooleanEntrySet() {
/* 1131 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator() {
/* 1133 */             return new Object2BooleanRBTreeMap.Submap.SubmapEntryIterator(Object2BooleanRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator(Object2BooleanMap.Entry<K> from) {
/* 1136 */             return new Object2BooleanRBTreeMap.Submap.SubmapEntryIterator(Object2BooleanRBTreeMap.Submap.this, from.getKey());
/*      */           }
/* 1138 */           public Comparator<? super Object2BooleanMap.Entry<K>> comparator() { return Object2BooleanRBTreeMap.this.object2BooleanEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1141 */             if (!(o instanceof Map.Entry)) return false;
/* 1142 */             Map.Entry e = (Map.Entry)o;
/* 1143 */             Object2BooleanRBTreeMap.Entry f = Object2BooleanRBTreeMap.this.findKey(e.getKey());
/* 1144 */             return (f != null) && (Object2BooleanRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1148 */             if (!(o instanceof Map.Entry)) return false;
/* 1149 */             Map.Entry e = (Map.Entry)o;
/* 1150 */             Object2BooleanRBTreeMap.Entry f = Object2BooleanRBTreeMap.this.findKey(e.getKey());
/* 1151 */             if ((f != null) && (Object2BooleanRBTreeMap.Submap.this.in(f.key))) Object2BooleanRBTreeMap.Submap.this.removeBoolean(f.key);
/* 1152 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1155 */             int c = 0;
...
/* 1157 */             return c;
/*      */           }
/* 1159 */           public boolean isEmpty() { return !new Object2BooleanRBTreeMap.Submap.SubmapIterator(Object2BooleanRBTreeMap.Submap.this).hasNext(); } 
/* 1160 */           public void clear() { Object2BooleanRBTreeMap.Submap.this.clear(); } 
/* 1161 */           public Object2BooleanMap.Entry<K> first() { return Object2BooleanRBTreeMap.Submap.this.firstEntry(); } 
/* 1162 */           public Object2BooleanMap.Entry<K> last() { return Object2BooleanRBTreeMap.Submap.this.lastEntry(); } 
/* 1163 */           public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> from, Object2BooleanMap.Entry<K> to) { return Object2BooleanRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2BooleanEntrySet(); } 
/* 1164 */           public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> to) { return Object2BooleanRBTreeMap.Submap.this.headMap(to.getKey()).object2BooleanEntrySet(); } 
/* 1165 */           public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> from) { return Object2BooleanRBTreeMap.Submap.this.tailMap(from.getKey()).object2BooleanEntrySet(); }
/*      */         };
...
/*      */     }
/*      */     public BooleanCollection values() {
/* 1178 */       if (this.values == null) this.values = new AbstractBooleanCollection() {
/*      */           public BooleanIterator iterator() {
/* 1180 */             return new Object2BooleanRBTreeMap.Submap.SubmapValueIterator(Object2BooleanRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(boolean k) {
/* 1183 */             return Object2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1186 */             return Object2BooleanRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1189 */             Object2BooleanRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(Object k) {
/* 1196 */       return (in(k)) && (Object2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(boolean v) {
/* 1199 */       SubmapIterator i = new SubmapIterator();
/*      */ 
/* 1201 */       while (i.hasNext()) {
/* 1202 */         boolean ev = i.nextEntry().value;
...
/*      */     {
/* 1210 */       Object kk = k;
/*      */       Object2BooleanRBTreeMap.Entry e;
/* 1211 */       return (in(kk)) && ((e = Object2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     public Boolean get(Object ok)
/*      */     {
/* 1216 */       Object kk = ok;
/*      */       Object2BooleanRBTreeMap.Entry e;
/* 1217 */       return (in(kk)) && ((e = Object2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.getValue() : null;
/*      */     }
/*      */     public boolean put(K k, boolean v) {
/* 1220 */       Object2BooleanRBTreeMap.this.modified = false;
...
/* 1222 */       boolean oldValue = Object2BooleanRBTreeMap.this.put(k, v);
/* 1223 */       return Object2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Boolean put(K ok, Boolean ov) {
/* 1226 */       boolean oldValue = put(ok, ov.booleanValue());
/* 1227 */       return Object2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public boolean removeBoolean(Object k) {
/* 1231 */       Object2BooleanRBTreeMap.this.modified = false;
/* 1232 */       if (!in(k)) return this.defRetValue;
/* 1233 */       boolean oldValue = Object2BooleanRBTreeMap.this.removeBoolean(k);
/* 1234 */       return Object2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Boolean remove(Object ok) {
/* 1237 */       boolean oldValue = removeBoolean(ok);
/* 1238 */       return Object2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public Comparator<? super K> comparator() {
/* 1253 */       return Object2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Object2BooleanSortedMap<K> headMap(K to) {
/* 1256 */       if (this.top) return new Submap(Object2BooleanRBTreeMap.this, this.from, this.bottom, to, false);
/* 1257 */       return Object2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Object2BooleanRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Object2BooleanSortedMap<K> tailMap(K from) {
/* 1260 */       if (this.bottom) return new Submap(Object2BooleanRBTreeMap.this, from, false, this.to, this.top);
/* 1261 */       return Object2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2BooleanRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Object2BooleanSortedMap<K> subMap(K from, K to) {
/* 1264 */       if ((this.top) && (this.bottom)) return new Submap(Object2BooleanRBTreeMap.this, from, false, to, false);
/* 1265 */       if (!this.top) to = Object2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1266 */       if (!this.bottom) from = Object2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1267 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1268 */       return new Submap(Object2BooleanRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Object2BooleanRBTreeMap.Entry<K> firstEntry()
/*      */     {
/* 1275 */       if (Object2BooleanRBTreeMap.this.tree == null) return null;
/* 1278 */       Object2BooleanRBTreeMap.Entry e;
/*      */       Object2BooleanRBTreeMap.Entry e;
/* 1278 */       if (this.bottom) { e = Object2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1280 */         e = Object2BooleanRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1282 */         if (Object2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1285 */       if ((e == null) || ((!this.top) && (Object2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1286 */       return e;
/*      */     }
/*      */ 
/*      */     public Object2BooleanRBTreeMap.Entry<K> lastEntry()
/*      */     {
/* 1293 */       if (Object2BooleanRBTreeMap.this.tree == null) return null;
/* 1296 */       Object2BooleanRBTreeMap.Entry e;
/*      */       Object2BooleanRBTreeMap.Entry e;
/* 1296 */       if (this.top) { e = Object2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1298 */         e = Object2BooleanRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1300 */         if (Object2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1303 */       if ((e == null) || ((!this.bottom) && (Object2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1304 */       return e;
/*      */     }
/*      */     public K firstKey() {
/* 1307 */       Object2BooleanRBTreeMap.Entry e = firstEntry();
/* 1308 */       if (e == null) throw new NoSuchElementException();
/* 1309 */       return e.key;
/*      */     }
/*      */     public K lastKey() {
/* 1312 */       Object2BooleanRBTreeMap.Entry e = lastEntry();
/* 1313 */       if (e == null) throw new NoSuchElementException();
/* 1314 */       return e.key;
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Object2BooleanRBTreeMap.Submap.SubmapIterator
/*      */       implements BooleanListIterator
/*      */     {
/*      */       private SubmapValueIterator()
/*      */       {
/* 1385 */         super(); } 
/* 1386 */       public boolean nextBoolean() { return nextEntry().value; } 
/* 1387 */       public boolean previousBoolean() { return previousEntry().value; } 
/* 1388 */       public void set(boolean v) { throw new UnsupportedOperationException(); } 
/* 1389 */       public void add(boolean v) { throw new UnsupportedOperationException(); } 
/* 1390 */       public Boolean next() { return Boolean.valueOf(nextEntry().value); } 
/* 1391 */       public Boolean previous() { return Boolean.valueOf(previousEntry().value); } 
/* 1392 */       public void set(Boolean ok) { throw new UnsupportedOperationException(); } 
/* 1393 */       public void add(Boolean ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Object2BooleanRBTreeMap<K>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Object2BooleanRBTreeMap<K>.Submap.SubmapIterator
...
/* 1357 */       public Object2BooleanMap.Entry<K> previous() { return previousEntry(); } 
/* 1358 */       public void set(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/* 1359 */       public void add(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Object2BooleanRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1324 */         super();
/* 1325 */         this.next = Object2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator() {
/* 1328 */         this();
/* 1329 */         if (this.next != null)
/* 1330 */           if ((!Object2BooleanRBTreeMap.Submap.this.bottom) && (Object2BooleanRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1331 */           } else if ((!Object2BooleanRBTreeMap.Submap.this.top) && (Object2BooleanRBTreeMap.this.compare(k, (this.prev = Object2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1333 */             this.next = Object2BooleanRBTreeMap.this.locateKey(k);
/* 1334 */             if (Object2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1344 */         if ((!Object2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2BooleanRBTreeMap.this.compare(this.prev.key, Object2BooleanRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1347 */         this.next = this.next.next();
/* 1348 */         if ((!Object2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Object2BooleanRBTreeMap.this.compare(this.next.key, Object2BooleanRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1169 */         super(); } 
/* 1170 */       public ObjectBidirectionalIterator<K> iterator() { return new Object2BooleanRBTreeMap.Submap.SubmapKeyIterator(Object2BooleanRBTreeMap.Submap.this); } 
/* 1171 */       public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2BooleanRBTreeMap.Submap.SubmapKeyIterator(Object2BooleanRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2BooleanRBTreeMap.TreeIterator
/*      */     implements BooleanListIterator
/*      */   {
/*      */     private ValueIterator()
/*      */     {
/* 1025 */       super(); } 
/* 1026 */     public boolean nextBoolean() { return nextEntry().value; } 
/* 1027 */     public boolean previousBoolean() { return previousEntry().value; } 
/* 1028 */     public void set(boolean v) { throw new UnsupportedOperationException(); } 
/* 1029 */     public void add(boolean v) { throw new UnsupportedOperationException(); } 
/* 1030 */     public Boolean next() { return Boolean.valueOf(nextEntry().value); } 
/* 1031 */     public Boolean previous() { return Boolean.valueOf(previousEntry().value); } 
/* 1032 */     public void set(Boolean ok) { throw new UnsupportedOperationException(); } 
/* 1033 */     public void add(Boolean ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class KeySet extends AbstractObject2BooleanSortedMap.KeySet
...
/*      */     {
/* 1003 */       super(); } 
/* 1004 */     public ObjectBidirectionalIterator<K> iterator() { return new Object2BooleanRBTreeMap.KeyIterator(Object2BooleanRBTreeMap.this); } 
/* 1005 */     public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2BooleanRBTreeMap.KeyIterator(Object2BooleanRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2BooleanRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2BooleanRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<Object2BooleanMap.Entry<K>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/*  943 */     public Object2BooleanMap.Entry<K> previous() { return previousEntry(); } 
/*  944 */     public void set(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  945 */     public void add(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  870 */     int index = 0;
/*      */ 
/*  872 */     TreeIterator() { this.next = Object2BooleanRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator() {
/*  875 */       if ((this.next = Object2BooleanRBTreeMap.this.locateKey(k)) != null)
/*  876 */         if (Object2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/*  917 */       updatePrevious();
/*  918 */       updateNext();
/*  919 */       Object2BooleanRBTreeMap.this.removeBoolean(this.curr.key);
/*  920 */       this.curr = null;
/*      */     }
...
/*  761 */       return Boolean.valueOf(this.value);
/*      */     }
/*      */     public boolean getBooleanValue() {
/*  764 */       return this.value;
/*      */     }
/*      */     public boolean setValue(boolean value) {
/*  767 */       boolean oldValue = this.value;
/*  768 */       this.value = value;
/*  769 */       return oldValue;
/*      */     }
/*      */     public Boolean setValue(Boolean value) {
/*  772 */       return Boolean.valueOf(setValue(value.booleanValue()));
/*      */     }
/*      */ 
...
/*  792 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     public int hashCode() {
/*  795 */       return (this.key == null ? 0 : this.key.hashCode()) ^ (this.value ? 1231 : 1237);
/*      */     }
