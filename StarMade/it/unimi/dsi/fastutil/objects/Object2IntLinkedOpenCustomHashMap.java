...
/*  288 */         Integer oldValue = Integer.valueOf(this.value[pos]);
...
/*  401 */         this.size -= 1;
/*  402 */         fixPointers(pos);
/*  403 */         int v = this.value[pos];
/*  404 */         shiftKeys(pos);
/*  405 */         return Integer.valueOf(v);
/*      */       }
...
/*  540 */         int oldValue = this.value[pos];
...
/*  579 */         int oldValue = this.value[pos];
...
/*  793 */   public Object2IntSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  794 */   public Object2IntSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  795 */   public Object2IntSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/* 1109 */     if (this.values == null) this.values = new AbstractIntCollection() {
/*      */         public IntIterator iterator() {
/* 1111 */           return new Object2IntLinkedOpenCustomHashMap.ValueIterator(Object2IntLinkedOpenCustomHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1114 */           return Object2IntLinkedOpenCustomHashMap.this.size;
/*      */         }
/*      */         public boolean contains(int v) {
/* 1117 */           return Object2IntLinkedOpenCustomHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1120 */           Object2IntLinkedOpenCustomHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1253 */       c = (Object2IntLinkedOpenCustomHashMap)super.clone();
/*      */     }
...
/* 1262 */     c.value = ((int[])this.value.clone());
...
/* 1307 */     int[] value = this.value = new int[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2IntLinkedOpenCustomHashMap.MapIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public int previousInt()
/*      */     {
/* 1098 */       return Object2IntLinkedOpenCustomHashMap.this.value[previousEntry()]; } 
/* 1099 */     public Integer previous() { return Integer.valueOf(Object2IntLinkedOpenCustomHashMap.this.value[previousEntry()]); } 
/* 1100 */     public void set(Integer ok) { throw new UnsupportedOperationException(); } 
/* 1101 */     public void add(Integer ok) { throw new UnsupportedOperationException(); } 
/* 1102 */     public void set(int v) { throw new UnsupportedOperationException(); } 
/* 1103 */     public void add(int v) { throw new UnsupportedOperationException(); } 
/* 1104 */     public ValueIterator() { super(null); } 
/* 1105 */     public int nextInt() { return Object2IntLinkedOpenCustomHashMap.this.value[nextEntry()]; } 
/* 1106 */     public Integer next() { return Integer.valueOf(Object2IntLinkedOpenCustomHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1055 */       return new Object2IntLinkedOpenCustomHashMap.KeyIterator(Object2IntLinkedOpenCustomHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1058 */       return new Object2IntLinkedOpenCustomHashMap.KeyIterator(Object2IntLinkedOpenCustomHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1061 */       return Object2IntLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1064 */       return Object2IntLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1067 */       int oldSize = Object2IntLinkedOpenCustomHashMap.this.size;
/* 1068 */       Object2IntLinkedOpenCustomHashMap.this.remove(k);
/* 1069 */       return Object2IntLinkedOpenCustomHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1072 */       Object2IntLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1075 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1079 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1080 */       return Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2IntLinkedOpenCustomHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1046 */       super(k, null); } 
/* 1047 */     public K previous() { return Object2IntLinkedOpenCustomHashMap.this.key[previousEntry()]; } 
...
/* 1051 */     public K next() { return Object2IntLinkedOpenCustomHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  974 */       return new Object2IntLinkedOpenCustomHashMap.EntryIterator(Object2IntLinkedOpenCustomHashMap.this);
/*      */     }
/*  976 */     public Comparator<? super Object2IntMap.Entry<K>> comparator() { return null; } 
/*  977 */     public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> fromElement, Object2IntMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  978 */     public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  979 */     public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(Object2IntMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Object2IntMap.Entry<K> first() {
/*  981 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  982 */       return new Object2IntLinkedOpenCustomHashMap.MapEntry(Object2IntLinkedOpenCustomHashMap.this, Object2IntLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */     public Object2IntMap.Entry<K> last() {
/*  985 */       if (Object2IntLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  986 */       return new Object2IntLinkedOpenCustomHashMap.MapEntry(Object2IntLinkedOpenCustomHashMap.this, Object2IntLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  994 */       int pos = HashCommon.murmurHash3(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  996 */       while (Object2IntLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  997 */         if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[pos], k)) return Object2IntLinkedOpenCustomHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/*  998 */         pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */       }
/* 1000 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1008 */       int pos = HashCommon.murmurHash3(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */ 
/* 1010 */       while (Object2IntLinkedOpenCustomHashMap.this.used[pos] != 0) {
/* 1011 */         if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[pos], k)) {
/* 1012 */           Object2IntLinkedOpenCustomHashMap.this.remove(e.getKey());
/* 1013 */           return true;
/*      */         }
/* 1015 */         pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */       }
/* 1017 */       return false;
/*      */     }
/*      */     public int size() {
/* 1020 */       return Object2IntLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1023 */       Object2IntLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> iterator(Object2IntMap.Entry<K> from) {
/* 1026 */       return new Object2IntLinkedOpenCustomHashMap.EntryIterator(Object2IntLinkedOpenCustomHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> fastIterator() {
/* 1029 */       return new Object2IntLinkedOpenCustomHashMap.FastEntryIterator(Object2IntLinkedOpenCustomHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> fastIterator(Object2IntMap.Entry<K> from) {
/* 1032 */       return new Object2IntLinkedOpenCustomHashMap.FastEntryIterator(Object2IntLinkedOpenCustomHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Object2IntLinkedOpenCustomHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2IntMap.Entry<K>>
/*      */   {
/*  952 */     final AbstractObject2IntMap.BasicEntry<K> entry = new AbstractObject2IntMap.BasicEntry(null, 0);
/*      */ 
...
/*  958 */       int e = nextEntry();
/*  959 */       this.entry.key = Object2IntLinkedOpenCustomHashMap.this.key[e];
/*  960 */       this.entry.value = Object2IntLinkedOpenCustomHashMap.this.value[e];
/*  961 */       return this.entry;
/*      */     }
/*      */     public AbstractObject2IntMap.BasicEntry<K> previous() {
/*  964 */       int e = previousEntry();
/*  965 */       this.entry.key = Object2IntLinkedOpenCustomHashMap.this.key[e];
/*  966 */       this.entry.value = Object2IntLinkedOpenCustomHashMap.this.value[e];
/*  967 */       return this.entry;
/*      */     }
/*  969 */     public void set(Object2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  970 */     public void add(Object2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2IntLinkedOpenCustomHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2IntMap.Entry<K>>
/*      */   {
...
/*  938 */       return this.entry = new Object2IntLinkedOpenCustomHashMap.MapEntry(Object2IntLinkedOpenCustomHashMap.this, nextEntry());
/*      */     }
/*      */     public Object2IntLinkedOpenCustomHashMap<K>.MapEntry previous() {
/*  941 */       return this.entry = new Object2IntLinkedOpenCustomHashMap.MapEntry(Object2IntLinkedOpenCustomHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  945 */       super.remove();
/*  946 */       Object2IntLinkedOpenCustomHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  948 */     public void set(Object2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  949 */     public void add(Object2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  810 */     int index = -1;
/*      */ 
/*  812 */     private MapIterator() { this.next = Object2IntLinkedOpenCustomHashMap.this.first;
/*  813 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  816 */       if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[Object2IntLinkedOpenCustomHashMap.this.last], from)) {
/*  817 */         this.prev = Object2IntLinkedOpenCustomHashMap.this.last;
/*  818 */         this.index = Object2IntLinkedOpenCustomHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  822 */         int pos = HashCommon.murmurHash3(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  824 */         while (Object2IntLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  825 */           if (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[pos], from))
/*      */           {
/*  827 */             this.next = ((int)Object2IntLinkedOpenCustomHashMap.this.link[pos]);
/*  828 */             this.prev = pos;
/*  829 */             return;
/*      */           }
/*  831 */           pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  844 */       if (this.next == -1) {
/*  845 */         this.index = Object2IntLinkedOpenCustomHashMap.this.size;
/*  846 */         return;
/*      */       }
/*  848 */       int pos = Object2IntLinkedOpenCustomHashMap.this.first;
/*  849 */       this.index = 1;
/*  850 */       while (pos != this.prev) {
/*  851 */         pos = (int)Object2IntLinkedOpenCustomHashMap.this.link[pos];
/*  852 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  864 */       if (!hasNext()) return Object2IntLinkedOpenCustomHashMap.this.size();
/*  865 */       this.curr = this.next;
/*  866 */       this.next = ((int)Object2IntLinkedOpenCustomHashMap.this.link[this.curr]);
...
/*  874 */       this.prev = ((int)(Object2IntLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  886 */         this.index -= 1;
/*  887 */         this.prev = ((int)(Object2IntLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  890 */         this.next = ((int)Object2IntLinkedOpenCustomHashMap.this.link[this.curr]);
/*  891 */       }Object2IntLinkedOpenCustomHashMap.this.size -= 1;
/*      */ 
/*  894 */       if (this.prev == -1) Object2IntLinkedOpenCustomHashMap.this.first = this.next;
/*      */       else
/*  896 */         Object2IntLinkedOpenCustomHashMap.this.link[this.prev] ^= (Object2IntLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  897 */       if (this.next == -1) Object2IntLinkedOpenCustomHashMap.this.last = this.prev;
/*      */       else
/*  899 */         Object2IntLinkedOpenCustomHashMap.this.link[this.next] ^= (Object2IntLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  903 */         pos = (last = pos) + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*  904 */         while (Object2IntLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  905 */           int slot = HashCommon.murmurHash3(Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(Object2IntLinkedOpenCustomHashMap.this.key[pos])) & Object2IntLinkedOpenCustomHashMap.this.mask;
/*  906 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  907 */           pos = pos + 1 & Object2IntLinkedOpenCustomHashMap.this.mask;
/*      */         }
/*  909 */         if (Object2IntLinkedOpenCustomHashMap.this.used[pos] == 0) break;
/*  910 */         Object2IntLinkedOpenCustomHashMap.this.key[last] = Object2IntLinkedOpenCustomHashMap.this.key[pos];
/*  911 */         Object2IntLinkedOpenCustomHashMap.this.value[last] = Object2IntLinkedOpenCustomHashMap.this.value[pos];
/*  912 */         if (this.next == pos) this.next = last;
/*  913 */         if (this.prev == pos) this.prev = last;
/*  914 */         Object2IntLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */       }
/*  916 */       Object2IntLinkedOpenCustomHashMap.this.used[last] = false;
/*  917 */       Object2IntLinkedOpenCustomHashMap.this.key[last] = null;
/*  918 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  679 */       return Object2IntLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     public Integer getValue() {
/*  682 */       return Integer.valueOf(Object2IntLinkedOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */     public int getIntValue() {
/*  685 */       return Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     public int setValue(int v) {
/*  688 */       int oldValue = Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*  689 */       Object2IntLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  690 */       return oldValue;
/*      */     }
...
/*  699 */       return (Object2IntLinkedOpenCustomHashMap.this.strategy.equals(Object2IntLinkedOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2IntLinkedOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */     public int hashCode() {
/*  702 */       return Object2IntLinkedOpenCustomHashMap.this.strategy.hashCode(Object2IntLinkedOpenCustomHashMap.this.key[this.index]) ^ Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  705 */       return Object2IntLinkedOpenCustomHashMap.this.key[this.index] + "=>" + Object2IntLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
