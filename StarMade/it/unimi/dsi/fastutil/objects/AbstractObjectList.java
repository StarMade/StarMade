  ...
  implements ObjectList<K>, Stack<K>
{
  ...
  public ObjectListIterator<K> listIterator(final int index)
  {
    new AbstractObjectListIterator()
    {
      ...
      public void add(K local_k)
      {
        ...
        AbstractObjectList.this.add(this.pos++, local_k);
        this.last = -1;
      }
      ...
      public void set(K local_k)
      {
        ...
        AbstractObjectList.this.set(this.last, local_k);
      }
  ...
  public int compareTo(List<? extends K> local_l)
  {
    if (local_l == this) {
      return 0;
    }
    if ((local_l instanceof ObjectList))
    {
      ObjectListIterator<K> local_i1 = listIterator();
      ObjectListIterator<K> local_i2 = ((ObjectList)local_l).listIterator();
    ...
    ListIterator<? extends K> local_i1 = listIterator();
    ListIterator<? extends K> local_i2 = local_l.listIterator();
    while ((local_i1.hasNext()) && (local_i2.hasNext()))
    {
      int local_r;
    ...
    implements Serializable
  {
    ...
    protected final ObjectList<K> field_56;
    protected final int from;
    protected int field_57;
    private static final boolean ASSERTS = false;
    
    public ObjectSubList(ObjectList<K> local_l, int from, int local_to)
    {
    ...
    public ObjectListIterator<K> listIterator(final int index)
    {
      ...
      new AbstractObjectListIterator()
      {
        ...
        public K next()
        {
          ...
          return AbstractObjectList.ObjectSubList.this.field_56.get(AbstractObjectList.ObjectSubList.this.from + (this.last = this.pos++));
        }
        ...
        public void add(K local_k)
        {
          ...
          AbstractObjectList.ObjectSubList.this.add(this.pos++, local_k);
          this.last = -1;
        }
        ...
        public void set(K local_k)
        {
          ...
          AbstractObjectList.ObjectSubList.this.set(this.last, local_k);
        }
