...
/*  88 */     if ((m instanceof Object2LongMap))
/*     */     {
/*  90 */       while (n-- != 0) {
/*  91 */         Object2LongMap.Entry e = (Object2LongMap.Entry)i.next();
...
/* 193 */         return AbstractObject2LongMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractObject2LongMap.this.size(); } 
/* 196 */       public void clear() { AbstractObject2LongMap.this.clear(); }
/*     */ 
/*     */       public ObjectIterator<K> iterator() {
/* 199 */         return new AbstractObjectIterator() {
/* 200 */           final ObjectIterator<Map.Entry<K, Long>> i = AbstractObject2LongMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public K next() { return ((Object2LongMap.Entry)this.i.next()).getKey(); } 
...
/* 226 */         return AbstractObject2LongMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractObject2LongMap.this.size(); } 
/* 229 */       public void clear() { AbstractObject2LongMap.this.clear(); }
/*     */ 
/*     */       public LongIterator iterator() {
/* 232 */         return new AbstractLongIterator() {
/* 233 */           final ObjectIterator<Map.Entry<K, Long>> i = AbstractObject2LongMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public long nextLong() { return ((Object2LongMap.Entry)this.i.next()).getLongValue(); } 
/*     */           public boolean hasNext() {
...
/*     */   {
/* 246 */     return object2LongEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Object2LongMap.Entry e = (Object2LongMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Long)e.getValue()).longValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
/* 167 */       return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.long2int(this.value);
/*     */     }
/*     */ 
/*     */     public String toString()
/*     */     {
