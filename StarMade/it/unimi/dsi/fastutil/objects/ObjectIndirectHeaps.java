...
/*  68 */     int e = heap[i];
/*  69 */     Object E = refArray[e];
/*     */ 
/*  71 */     if (c == null)
/*     */     {
/*     */       int child;
/*  72 */       while ((child = 2 * i + 1) < size) {
/*  73 */         if ((child + 1 < size) && (((Comparable)refArray[heap[(child + 1)]]).compareTo(refArray[heap[child]]) < 0)) child++;
/*  74 */         if (((Comparable)E).compareTo(refArray[heap[child]]) <= 0) break;
...
/* 106 */     int e = heap[i];
/* 107 */     Object E = refArray[e];
/*     */ 
/* 109 */     if (c == null)
/*     */     {
/*     */       int parent;
/* 110 */       while ((i != 0) && ((parent = (i - 1) / 2) >= 0) && 
/* 111 */         (((Comparable)refArray[heap[parent]]).compareTo(E) > 0)) {
...
/* 124 */     inv[e] = i;
/* 125 */     return i; } 
/*     */   public static <K> void makeHeap(K[] refArray, int offset, int length, int[] heap, int[] inv, Comparator<K> c) { // Byte code:
/*     */     //   0: aload_0
/*     */     //   1: iload_1
/*     */     //   2: iload_2
/*     */     //   3: invokestatic 15	it/unimi/dsi/fastutil/objects/ObjectArrays:ensureOffsetLength	([Ljava/lang/Object;II)V
/*     */     //   6: aload_3
/*     */     //   7: arraylength
/*     */     //   8: iload_2
/*     */     //   9: if_icmpge +45 -> 54
...
/*     */     //   109: arraylength
/*     */     //   110: iconst_m1
/*     */     //   111: invokestatic 20	it/unimi/dsi/fastutil/ints/IntArrays:fill	([IIII)V
/*     */     //   114: iload_2
/*     */     //   115: istore 6
/*     */     //   117: iload 6
/*     */     //   119: iinc 6 255
...
/*     */     //   160: iload 6
/*     */     //   162: aload 5
/*     */     //   164: invokestatic 21	it/unimi/dsi/fastutil/objects/ObjectIndirectHeaps:downHeap	([Ljava/lang/Object;[I[IIILjava/util/Comparator;)I
/*     */     //   167: pop
/*     */     //   168: goto -21 -> 147
/*     */     //   171: return } 
/* 158 */   public static <K> void makeHeap(K[] refArray, int[] heap, int[] inv, int size, Comparator<K> c) { int i = size / 2;
