...
/*   5:    */
/*  63:    */public class ObjectIndirectHeaps
/*  64:    */{
/*  65:    */  public static <K> int downHeap(K[] refArray, int[] heap, int[] inv, int size, int i, Comparator<K> c)
/*  66:    */  {
/*  67: 67 */    if (i >= size) throw new IllegalArgumentException("Heap position (" + i + ") is larger than or equal to heap size (" + size + ")");
/*  68: 68 */    int e = heap[i];
/*  69: 69 */    K E = refArray[e];
/*  70:    */    
/*  71: 71 */    if (c == null) { int child;
/*  72: 72 */      while ((child = 2 * i + 1) < size) {
/*  73: 73 */        if ((child + 1 < size) && (((Comparable)refArray[heap[(child + 1)]]).compareTo(refArray[heap[child]]) < 0)) child++;
/*  74: 74 */        if (((Comparable)E).compareTo(refArray[heap[child]]) <= 0) break;
...
/*  90:    */  }
/*  91:    */  
/* 103:    */  public static <K> int upHeap(K[] refArray, int[] heap, int[] inv, int size, int i, Comparator<K> c)
/* 104:    */  {
...
/* 107:107 */    K E = refArray[e];
/* 108:    */    
/* 109:109 */    if (c == null) { int parent;
/* 110:110 */      while ((i != 0) && ((parent = (i - 1) / 2) >= 0) && 
/* 111:111 */        (((Comparable)refArray[heap[parent]]).compareTo(E) > 0)) {
...
/* 126:    */  }
/* 127:    */  
/* 135:    */  public static <K> void makeHeap(K[] refArray, int offset, int length, int[] heap, int[] inv, Comparator<K> c)
/* 136:    */  {
/* 137:137 */    ObjectArrays.ensureOffsetLength(refArray, offset, length);
