...
/*  14:    */
/*  65:    */public class Reference2ByteArrayMap<K>
/*  66:    */  extends AbstractReference2ByteMap<K>
/*  67:    */  implements Serializable, Cloneable
/*  68:    */{
/*  69:    */  private static final long serialVersionUID = 1L;
/*  70:    */  private transient Object[] key;
/*  71:    */  private transient byte[] value;
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Reference2ByteArrayMap(Object[] key, byte[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Reference2ByteArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = ObjectArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = ByteArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Reference2ByteArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new Object[capacity];
/*  93: 93 */    this.value = new byte[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Reference2ByteArrayMap(Reference2ByteMap<K> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Reference2ByteArrayMap(Map<? extends K, ? extends Byte> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Reference2ByteArrayMap(Object[] key, byte[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Reference2ByteMap.Entry<K>> implements Reference2ByteMap.FastEntrySet<K> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Reference2ByteMap.Entry<K>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Reference2ByteArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Reference2ByteMap.Entry<K> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractReference2ByteMap.BasicEntry(Reference2ByteArrayMap.this.key[this.next], Reference2ByteArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Reference2ByteMap.Entry<K>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractReference2ByteMap.BasicEntry<K> entry = new AbstractReference2ByteMap.BasicEntry(null, (byte)0);
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Reference2ByteArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Reference2ByteMap.Entry<K> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Reference2ByteArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Reference2ByteArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Reference2ByteArrayMap.this.size; }
/* 159:    */    
/* 160:    */    public boolean contains(Object o)
/* 161:    */    {
/* 162:162 */      if (!(o instanceof Map.Entry)) return false;
/* 163:163 */      Map.Entry<K, Byte> e = (Map.Entry)o;
/* 164:164 */      K k = e.getKey();
/* 165:165 */      return (Reference2ByteArrayMap.this.containsKey(k)) && (Reference2ByteArrayMap.this.get(k).byteValue() == ((Byte)e.getValue()).byteValue());
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Reference2ByteMap.FastEntrySet<K> reference2ByteEntrySet() { return new EntrySet(null); }
/* 170:    */  
...
/* 176:    */  }
/* 177:    */  
/* 182:    */  public byte getByte(Object k)
/* 183:    */  {
...
/* 211:    */  }
/* 212:    */  
/* 214:    */  public boolean containsValue(byte v)
/* 215:    */  {
...
/* 223:    */  }
/* 224:    */  
/* 226:    */  public byte put(K k, byte v)
/* 227:    */  {
/* 228:228 */    int oldKey = findKey(k);
/* 229:229 */    if (oldKey != -1) {
/* 230:230 */      byte oldValue = this.value[oldKey];
...
/* 236:236 */      byte[] newValue = new byte[this.size == 0 ? 2 : this.size * 2];
...
/* 248:    */  }
/* 249:    */  
/* 256:    */  public byte removeByte(Object k)
/* 257:    */  {
/* 258:258 */    int oldPos = findKey(k);
/* 259:259 */    if (oldPos == -1) return this.defRetValue;
/* 260:260 */    byte oldValue = this.value[oldPos];
...
/* 281:    */  }
/* 282:    */  
/* 283:    */  public ByteCollection values()
/* 284:    */  {
/* 285:285 */    return ByteCollections.unmodifiable(new ByteArraySet(this.value, this.size));
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Reference2ByteArrayMap<K> clone()
/* 293:    */  {
/* 294:    */    Reference2ByteArrayMap<K> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Reference2ByteArrayMap)super.clone();
/* 301:    */    }
/* 302:    */    catch (CloneNotSupportedException cantHappen) {
/* 303:303 */      throw new InternalError();
/* 304:    */    }
/* 305:305 */    c.key = ((Object[])this.key.clone());
/* 306:306 */    c.value = ((byte[])this.value.clone());
/* 307:307 */    return c;
/* 308:    */  }
/* 309:    */  
...
/* 314:314 */      s.writeByte(this.value[i]);
/* 315:    */    }
/* 316:    */  }
/* 317:    */  
...
/* 322:322 */    this.value = new byte[this.size];
/* 323:323 */    for (int i = 0; i < this.size; i++) {
/* 324:324 */      this.key[i] = s.readObject();
/* 325:325 */      this.value[i] = s.readByte();
/* 326:    */    }
/* 327:    */  }
/* 328:    */}
