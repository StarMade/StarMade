  ...
  implements Serializable, Cloneable
{
  ...
  public Object2DoubleAVLTreeMap(Comparator<? super K> local_c)
  {
    this();
  ...
  public Object2DoubleAVLTreeMap(Map<? extends K, ? extends Double> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2DoubleAVLTreeMap(SortedMap<K, Double> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2DoubleAVLTreeMap(Object2DoubleMap<? extends K> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2DoubleAVLTreeMap(Object2DoubleSortedMap<K> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2DoubleAVLTreeMap(K[] local_k, double[] local_v, Comparator<? super K> local_c)
  {
    this(local_c);
  ...
  public Object2DoubleAVLTreeMap(K[] local_k, double[] local_v)
  {
  ...
  public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Object2DoubleMap.Entry<K>> comparator = new Comparator()
        {
          public int compare(Object2DoubleMap.Entry<K> local_x, Object2DoubleMap.Entry<K> local_y)
          {
            return Object2DoubleAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Object2DoubleAVLTreeMap.EntryIterator(Object2DoubleAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from)
        {
          return new Object2DoubleAVLTreeMap.EntryIterator(Object2DoubleAVLTreeMap.this, from.getKey());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Object2DoubleAVLTreeMap.Entry<K> local_f = Object2DoubleAVLTreeMap.this.findKey(local_e.getKey());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Object2DoubleAVLTreeMap.Entry<K> local_f = Object2DoubleAVLTreeMap.this.findKey(local_e.getKey());
          if (local_f != null) {
            Object2DoubleAVLTreeMap.this.removeDouble(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> local_to)
        {
          return Object2DoubleAVLTreeMap.this.subMap(from.getKey(), local_to.getKey()).object2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> local_to)
        {
          return Object2DoubleAVLTreeMap.this.headMap(local_to.getKey()).object2DoubleEntrySet();
        }
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Object2DoubleAVLTreeMap.ValueIterator(Object2DoubleAVLTreeMap.this, null);
        }
        
        public boolean contains(double local_k)
        {
          return Object2DoubleAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Object2DoubleAVLTreeMap<K> local_c;
    try
    {
      local_c = (Object2DoubleAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Object2DoubleAVLTreeMap<K>.EntryIterator local_i = new EntryIterator();
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry<K> top = new Entry(local_s.readObject(), local_s.readDouble());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry<K> top = new Entry(local_s.readObject(), local_s.readDouble());
      top.right(new Entry(local_s.readObject(), local_s.readDouble()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Object2DoubleAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Object2DoubleAVLTreeMap<K>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Object2DoubleAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Object2DoubleAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator()
          {
            return new Object2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Object2DoubleAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from)
          {
            return new Object2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Object2DoubleAVLTreeMap.Submap.this, from.getKey());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<K, Double> local_e = (Map.Entry)local_o;
            Object2DoubleAVLTreeMap.Entry<K> local_f = Object2DoubleAVLTreeMap.this.findKey(local_e.getKey());
            return (local_f != null) && (Object2DoubleAVLTreeMap.Submap.this.in5(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<K, Double> local_e = (Map.Entry)local_o;
            Object2DoubleAVLTreeMap.Entry<K> local_f = Object2DoubleAVLTreeMap.this.findKey(local_e.getKey());
            if ((local_f != null) && (Object2DoubleAVLTreeMap.Submap.this.in5(local_f.key))) {
              Object2DoubleAVLTreeMap.Submap.this.removeDouble(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Object2DoubleAVLTreeMap.Submap.SubmapIterator(Object2DoubleAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Object2DoubleAVLTreeMap.Submap.this.clear();
          }
          
          public Object2DoubleMap.Entry<K> first()
          {
            return Object2DoubleAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Object2DoubleMap.Entry<K> last()
          {
            return Object2DoubleAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> local_to)
          {
            return Object2DoubleAVLTreeMap.Submap.this.subMap(from.getKey(), local_to.getKey()).object2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> local_to)
          {
            return Object2DoubleAVLTreeMap.Submap.this.headMap(local_to.getKey()).object2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from)
          {
            return Object2DoubleAVLTreeMap.Submap.this.tailMap(from.getKey()).object2DoubleEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public DoubleCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractDoubleCollection()
        {
          public DoubleIterator iterator()
          {
            return new Object2DoubleAVLTreeMap.Submap.SubmapValueIterator(Object2DoubleAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(double local_k)
          {
            return Object2DoubleAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Object2DoubleAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(Object local_k)
    {
      return (in5(local_k)) && (Object2DoubleAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      K local_kk = local_k;
      Object2DoubleAVLTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2DoubleAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public Double get(Object local_ok)
    {
      K local_kk = local_ok;
      Object2DoubleAVLTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2DoubleAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.getValue() : null;
    }
    ...
    public double put(K local_k, double local_v)
    {
      ...
      double oldValue = Object2DoubleAVLTreeMap.this.put(local_k, local_v);
    ...
    public double removeDouble(Object local_k)
    {
      ...
      double oldValue = Object2DoubleAVLTreeMap.this.removeDouble(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Object2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Object2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Object2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Object2DoubleSortedMap<K> tailMap(K from)
    {
      if (this.bottom) {
        return new Submap(Object2DoubleAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Object2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2DoubleAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Object2DoubleSortedMap<K> subMap(K from, K local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Object2DoubleAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Object2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Object2DoubleAVLTreeMap.Entry<K> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Object2DoubleAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Object2DoubleAVLTreeMap.this.locateKey(this.from);
        if (Object2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Object2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Object2DoubleAVLTreeMap.Entry<K> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Object2DoubleAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Object2DoubleAVLTreeMap.this.locateKey(this.field_47);
        if (Object2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Object2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public K firstKey()
    {
      Object2DoubleAVLTreeMap.Entry<K> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public K lastKey()
    {
      Object2DoubleAVLTreeMap.Entry<K> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Object2DoubleAVLTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Object2DoubleAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Object2DoubleAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator()
      {
        this();
        if (this.next != null) {
          if ((!Object2DoubleAVLTreeMap.Submap.this.bottom) && (Object2DoubleAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Object2DoubleAVLTreeMap.Submap.this.top) && (Object2DoubleAVLTreeMap.this.compare(local_k, (this.prev = Object2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Object2DoubleAVLTreeMap.this.locateKey(local_k);
            if (Object2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Object2DoubleAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2DoubleAVLTreeMap.this.compare(this.prev.key, Object2DoubleAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Object2DoubleAVLTreeMap.Submap.this.top) && (this.next != null) && (Object2DoubleAVLTreeMap.this.compare(this.next.key, Object2DoubleAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractObject2DoubleSortedMap.KeySet
    {
      ...
      {
        return new Object2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Object2DoubleAVLTreeMap.Submap.this);
      }
      
      public ObjectBidirectionalIterator<K> iterator(K from)
      {
        return new Object2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Object2DoubleAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractObject2DoubleSortedMap.KeySet
  {
    ...
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new Object2DoubleAVLTreeMap.KeyIterator(Object2DoubleAVLTreeMap.this);
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new Object2DoubleAVLTreeMap.KeyIterator(Object2DoubleAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    TreeIterator()
    {
      if ((this.next = Object2DoubleAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Object2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Object2DoubleMap.Entry<K>
  {
    ...
    Entry(K local_k, double local_v)
    {
      this.key = local_k;
      this.value = local_v;
