  ...
  implements ObjectBigList<K>, Stack<K>
{
  ...
  public ObjectBigListIterator<K> listIterator(final long index)
  {
    new AbstractObjectBigListIterator()
    {
      ...
      public void add(K local_k)
      {
        ...
        AbstractObjectBigList.this.add(this.pos++, local_k);
        this.last = -1L;
      }
      ...
      public void set(K local_k)
      {
        ...
        AbstractObjectBigList.this.set(this.last, local_k);
      }
  ...
  public long indexOf(Object local_k)
  {
    ...
    while (local_i.hasNext())
    {
      ...
      if (local_k == null ? local_e == null : local_k.equals(local_e)) {
  ...
  public ObjectBigList<K> subList(long from, long local_to)
  {
    ...
    return new ObjectSubList(this, from, local_to);
  }
  ...
  public int compareTo(BigList<? extends K> local_l)
  {
    if (local_l == this) {
      return 0;
    }
    if ((local_l instanceof ObjectBigList))
    {
      ObjectBigListIterator<K> local_i1 = listIterator();
      ObjectBigListIterator<K> local_i2 = ((ObjectBigList)local_l).listIterator();
      while ((local_i1.hasNext()) && (local_i2.hasNext()))
      {
        K local_e1 = local_i1.next();
        K local_e2 = local_i2.next();
        int local_r;
    ...
    BigListIterator<? extends K> local_i1 = listIterator();
    BigListIterator<? extends K> local_i2 = local_l.listIterator();
    while ((local_i1.hasNext()) && (local_i2.hasNext()))
    {
      int local_r;
  ...
  public int hashCode()
  {
    ...
    while (local_s-- != 0L)
    {
      ...
      local_h = 31 * local_h + (local_k == null ? 0 : local_k.hashCode());
    }
    return local_h;
  }
    ...
    implements Serializable
  {
    ...
    protected final ObjectBigList<K> field_56;
    protected final long from;
    protected long field_57;
    private static final boolean ASSERTS = false;
    
    public ObjectSubList(ObjectBigList<K> local_l, long from, long local_to)
    {
    ...
    public ObjectBigListIterator<K> listIterator(final long index)
    {
      ...
      new AbstractObjectBigListIterator()
      {
        ...
        public boolean hasNext()
        {
          return this.pos < AbstractObjectBigList.ObjectSubList.this.size64();
        }
        ...
        public K next()
        {
          ...
          return AbstractObjectBigList.ObjectSubList.this.field_56.get(AbstractObjectBigList.ObjectSubList.this.from + (this.last = this.pos++));
        }
        ...
        public void add(K local_k)
        {
          ...
          AbstractObjectBigList.ObjectSubList.this.add(this.pos++, local_k);
          this.last = -1L;
        }
        ...
        public void set(K local_k)
        {
          ...
          AbstractObjectBigList.ObjectSubList.this.set(this.last, local_k);
        }
        ...
        public void remove()
        {
          ...
          AbstractObjectBigList.ObjectSubList.this.remove(this.last);
          if (this.last < this.pos) {
            this.pos -= 1L;
          }
          this.last = -1L;
