...
/*     */   }
/*     */ 
/*     */   public static class SynchronizedFunction<K> extends AbstractObject2BooleanFunction<K>
/*     */     implements Serializable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Object2BooleanFunction<K> function;
...
/*     */     }
/*  92 */     public boolean getBoolean(Object k) { if (this.key == null ? k == null : this.key.equals(k)) return this.value; return this.defRetValue; } 
/*     */     public int size() {
/*  94 */       return 1;
/*     */     }
...
/*     */     public void clear() {  } 
/*  66 */     private Object readResolve() { return Object2BooleanFunctions.EMPTY_FUNCTION; } 
/*  67 */     public Object clone() { return Object2BooleanFunctions.EMPTY_FUNCTION; }
/*     */ 
/*     */   }
/*     */ }
