...
/*  12:    */
/*  60:    */public abstract class AbstractObject2CharMap<K>
/*  61:    */  extends AbstractObject2CharFunction<K>
/*  62:    */  implements Object2CharMap<K>, Serializable
/*  63:    */{
...
/*  88: 88 */    if ((m instanceof Object2CharMap))
/*  89:    */    {
/*  90: 90 */      while (n-- != 0) {
/*  91: 91 */        Object2CharMap.Entry<? extends K> e = (Object2CharMap.Entry)i.next();
...
/* 109:    */    implements Object2CharMap.Entry<K>
/* 110:    */  {
/* 111:    */    protected K key;
...
/* 162:    */      
/* 163:163 */      return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Character)e.getValue()).charValue());
/* 164:    */    }
/* 165:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(Object k) { return AbstractObject2CharMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractObject2CharMap.this.size(); }
/* 196:196 */      public void clear() { AbstractObject2CharMap.this.clear(); }
/* 197:    */      
/* 198:    */      public ObjectIterator<K> iterator() {
/* 199:199 */        new AbstractObjectIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<K, Character>> i = AbstractObject2CharMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public K next() { return ((Object2CharMap.Entry)this.i.next()).getKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(char k) { return AbstractObject2CharMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractObject2CharMap.this.size(); }
/* 229:229 */      public void clear() { AbstractObject2CharMap.this.clear(); }
/* 230:    */      
/* 231:    */      public CharIterator iterator() {
/* 232:232 */        new AbstractCharIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<K, Character>> i = AbstractObject2CharMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public char nextChar() { return ((Object2CharMap.Entry)this.i.next()).getCharValue(); }
/* 236:    */          
...
/* 245:    */  {
/* 246:246 */    return object2CharEntrySet();
/* 247:    */  }
/* 248:    */  
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Object2CharMap.Entry<K> e = (Object2CharMap.Entry)i.next();
/* 290:    */      
