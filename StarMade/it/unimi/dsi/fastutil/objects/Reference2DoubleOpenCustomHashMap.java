...
/* 649 */           return new Reference2DoubleOpenCustomHashMap.ValueIterator(Reference2DoubleOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 652 */           return Reference2DoubleOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(double v) {
/* 655 */           return Reference2DoubleOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 658 */           Reference2DoubleOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 773 */       c = (Reference2DoubleOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Reference2DoubleOpenCustomHashMap.MapIterator
/*     */     implements DoubleIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 642 */       super(null); } 
/* 643 */     public double nextDouble() { return Reference2DoubleOpenCustomHashMap.this.value[nextEntry()]; } 
/* 644 */     public Double next() { return Double.valueOf(Reference2DoubleOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 614 */       return new Reference2DoubleOpenCustomHashMap.KeyIterator(Reference2DoubleOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 617 */       return Reference2DoubleOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 620 */       return Reference2DoubleOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 623 */       int oldSize = Reference2DoubleOpenCustomHashMap.this.size;
/* 624 */       Reference2DoubleOpenCustomHashMap.this.remove(k);
/* 625 */       return Reference2DoubleOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 628 */       Reference2DoubleOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Reference2DoubleOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 609 */       super(null); } 
/* 610 */     public K next() { return Reference2DoubleOpenCustomHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 555 */       return new Reference2DoubleOpenCustomHashMap.EntryIterator(Reference2DoubleOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Reference2DoubleMap.Entry<K>> fastIterator() {
/* 558 */       return new Reference2DoubleOpenCustomHashMap.FastEntryIterator(Reference2DoubleOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 566 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2DoubleOpenCustomHashMap.this.mask;
/*     */ 
/* 568 */       while (Reference2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 569 */         if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(Reference2DoubleOpenCustomHashMap.this.key[pos], k)) return Reference2DoubleOpenCustomHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/* 570 */         pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask;
/*     */       }
/* 572 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 580 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2DoubleOpenCustomHashMap.this.mask;
/*     */ 
/* 582 */       while (Reference2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 583 */         if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(Reference2DoubleOpenCustomHashMap.this.key[pos], k)) {
/* 584 */           Reference2DoubleOpenCustomHashMap.this.remove(e.getKey());
/* 585 */           return true;
/*     */         }
/* 587 */         pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask;
/*     */       }
/* 589 */       return false;
/*     */     }
/*     */     public int size() {
/* 592 */       return Reference2DoubleOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 595 */       Reference2DoubleOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Reference2DoubleOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2DoubleMap.Entry<K>>
/*     */   {
/* 545 */     final AbstractReference2DoubleMap.BasicEntry<K> entry = new AbstractReference2DoubleMap.BasicEntry(null, 0.0D);
/*     */ 
...
/* 547 */       int e = nextEntry();
/* 548 */       this.entry.key = Reference2DoubleOpenCustomHashMap.this.key[e];
/* 549 */       this.entry.value = Reference2DoubleOpenCustomHashMap.this.value[e];
/* 550 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Reference2DoubleOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2DoubleMap.Entry<K>>
/*     */   {
...
/* 536 */       return this.entry = new Reference2DoubleOpenCustomHashMap.MapEntry(Reference2DoubleOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 540 */       super.remove();
/* 541 */       Reference2DoubleOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 441 */       this.pos = Reference2DoubleOpenCustomHashMap.this.n;
/*     */ 
/* 444 */       this.last = -1;
/*     */ 
/* 446 */       this.c = Reference2DoubleOpenCustomHashMap.this.size;
/*     */ 
/* 451 */       boolean[] used = Reference2DoubleOpenCustomHashMap.this.used;
...
/*     */ 
/* 464 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2DoubleOpenCustomHashMap.this.mask;
/*     */ 
/* 466 */         while (Reference2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 467 */           if (Reference2DoubleOpenCustomHashMap.this.strategy.equals(Reference2DoubleOpenCustomHashMap.this.key[pos], k)) return pos;
/* 468 */           pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 471 */       this.last = this.pos;
/*     */ 
/* 473 */       if (this.c != 0) {
/* 474 */         boolean[] used = Reference2DoubleOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 491 */         pos = (last = pos) + 1 & Reference2DoubleOpenCustomHashMap.this.mask;
/* 492 */         while (Reference2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 493 */           int slot = (Reference2DoubleOpenCustomHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2DoubleOpenCustomHashMap.this.key[pos]))) & Reference2DoubleOpenCustomHashMap.this.mask;
/* 494 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 495 */           pos = pos + 1 & Reference2DoubleOpenCustomHashMap.this.mask;
/*     */         }
/* 497 */         if (Reference2DoubleOpenCustomHashMap.this.used[pos] == 0) break;
/* 498 */         if (pos < last)
/*     */         {
/* 500 */           if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 501 */           this.wrapped.add(Reference2DoubleOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 503 */         Reference2DoubleOpenCustomHashMap.this.key[last] = Reference2DoubleOpenCustomHashMap.this.key[pos];
/* 504 */         Reference2DoubleOpenCustomHashMap.this.value[last] = Reference2DoubleOpenCustomHashMap.this.value[pos];
/*     */       }
/* 506 */       Reference2DoubleOpenCustomHashMap.this.used[last] = false;
/* 507 */       Reference2DoubleOpenCustomHashMap.this.key[last] = null;
/* 508 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 513 */       if (this.pos < -1)
/*     */       {
/* 515 */         Reference2DoubleOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 516 */         this.last = -1;
/* 517 */         return;
/*     */       }
/* 519 */       Reference2DoubleOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 408 */       return Reference2DoubleOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Double getValue() {
/* 411 */       return Double.valueOf(Reference2DoubleOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public double getDoubleValue() {
/* 414 */       return Reference2DoubleOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public double setValue(double v) {
/* 417 */       double oldValue = Reference2DoubleOpenCustomHashMap.this.value[this.index];
/* 418 */       Reference2DoubleOpenCustomHashMap.this.value[this.index] = v;
/* 419 */       return oldValue;
/*     */     }
/*     */     public Double setValue(Double v) {
...
/* 428 */       return (Reference2DoubleOpenCustomHashMap.this.strategy.equals(Reference2DoubleOpenCustomHashMap.this.key[this.index], e.getKey())) && (Reference2DoubleOpenCustomHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*     */     }
/*     */     public int hashCode() {
/* 431 */       return (Reference2DoubleOpenCustomHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2DoubleOpenCustomHashMap.this.key[this.index])) ^ HashCommon.double2int(Reference2DoubleOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 434 */       return Reference2DoubleOpenCustomHashMap.this.key[this.index] + "=>" + Reference2DoubleOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
