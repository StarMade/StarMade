...
/*  88 */     if ((m instanceof Object2ShortMap))
/*     */     {
/*  90 */       while (n-- != 0) {
/*  91 */         Object2ShortMap.Entry e = (Object2ShortMap.Entry)i.next();
...
/* 193 */         return AbstractObject2ShortMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractObject2ShortMap.this.size(); } 
/* 196 */       public void clear() { AbstractObject2ShortMap.this.clear(); }
/*     */ 
/*     */       public ObjectIterator<K> iterator() {
/* 199 */         return new AbstractObjectIterator() {
/* 200 */           final ObjectIterator<Map.Entry<K, Short>> i = AbstractObject2ShortMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public K next() { return ((Object2ShortMap.Entry)this.i.next()).getKey(); } 
...
/* 226 */         return AbstractObject2ShortMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractObject2ShortMap.this.size(); } 
/* 229 */       public void clear() { AbstractObject2ShortMap.this.clear(); }
/*     */ 
/*     */       public ShortIterator iterator() {
/* 232 */         return new AbstractShortIterator() {
/* 233 */           final ObjectIterator<Map.Entry<K, Short>> i = AbstractObject2ShortMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public short nextShort() { return ((Object2ShortMap.Entry)this.i.next()).getShortValue(); } 
/*     */           public boolean hasNext() {
...
/*     */   {
/* 246 */     return object2ShortEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Object2ShortMap.Entry e = (Object2ShortMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
