...
/*      */   protected int size;
/*      */   protected volatile transient Reference2ObjectSortedMap.FastSortedEntrySet<K, V> entries;
...
/*      */   {
/*  220 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
/*      */ 
/*  222 */     while (this.used[pos] != 0) {
/*  223 */       if (this.key[pos] == k) {
...
/*  259 */         int slot = (this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(this.key[pos]))) & this.mask;
...
/*      */   {
/*  276 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
/*      */ 
/*  278 */     while (this.used[pos] != 0) {
/*  279 */       if (this.key[pos] == k) {
/*  280 */         this.size -= 1;
/*  281 */         fixPointers(pos);
...
/*      */ 
/*  372 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & mask;
/*      */ 
...
/*      */ 
/*  393 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & mask;
/*      */ 
...
/*      */ 
/*  415 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & mask;
/*      */ 
...
/*      */ 
/*  454 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & mask;
/*      */ 
...
/*      */   {
/*  485 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
/*      */ 
/*  487 */     while (this.used[pos] != 0) {
/*  488 */       if (this.key[pos] == k) return this.value[pos];
...
/*      */   {
/*  496 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
/*      */ 
/*  498 */     while (this.used[pos] != 0) {
/*  499 */       if (this.key[pos] == k) return true;
...
/*  507 */     for (int i = this.n; i-- != 0; return true) label16: if ((used[i] == 0) || (value[i] == null ? v != null : !value[i].equals(v)))
...
/*  667 */   public Reference2ObjectSortedMap<K, V> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  668 */   public Reference2ObjectSortedMap<K, V> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  669 */   public Reference2ObjectSortedMap<K, V> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/*  980 */     if (this.values == null) this.values = new AbstractObjectCollection() {
/*      */         public ObjectIterator<V> iterator() {
/*  982 */           return new Reference2ObjectLinkedOpenHashMap.ValueIterator(Reference2ObjectLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/*  985 */           return Reference2ObjectLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/*  988 */           return Reference2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/*  991 */           Reference2ObjectLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/* 1081 */       Object k = key[i];
/* 1082 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & newMask;
...
/*      */     try
/*      */     {
/* 1124 */       c = (Reference2ObjectLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1152 */         t = this.key[i] == null ? 0 : System.identityHashCode(this.key[i]);
...
/* 1188 */       pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & this.mask;
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/*  973 */       return Reference2ObjectLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/*  977 */     public V next() { return Reference2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  930 */       return new Reference2ObjectLinkedOpenHashMap.KeyIterator(Reference2ObjectLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/*  933 */       return new Reference2ObjectLinkedOpenHashMap.KeyIterator(Reference2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/*  936 */       return Reference2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/*  939 */       return Reference2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/*  942 */       int oldSize = Reference2ObjectLinkedOpenHashMap.this.size;
/*  943 */       Reference2ObjectLinkedOpenHashMap.this.remove(k);
/*  944 */       return Reference2ObjectLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/*  947 */       Reference2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/*  950 */       if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  951 */       return Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/*  954 */       if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  955 */       return Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/*  957 */     public Comparator<? super K> comparator() { return null; } 
/*  958 */     public final ReferenceSortedSet<K> tailSet(K from) { throw new UnsupportedOperationException(); } 
/*  959 */     public final ReferenceSortedSet<K> headSet(K to) { throw new UnsupportedOperationException(); } 
/*  960 */     public final ReferenceSortedSet<K> subSet(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/*  921 */       super(k, null); } 
/*  922 */     public K previous() { return Reference2ObjectLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  926 */     public K next() { return Reference2ObjectLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  849 */       return new Reference2ObjectLinkedOpenHashMap.EntryIterator(Reference2ObjectLinkedOpenHashMap.this);
/*      */     }
/*  851 */     public Comparator<? super Reference2ObjectMap.Entry<K, V>> comparator() { return null; } 
/*  852 */     public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> subSet(Reference2ObjectMap.Entry<K, V> fromElement, Reference2ObjectMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); } 
/*  853 */     public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> headSet(Reference2ObjectMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); } 
/*  854 */     public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> tailSet(Reference2ObjectMap.Entry<K, V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Reference2ObjectMap.Entry<K, V> first() {
/*  856 */       if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  857 */       return new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, Reference2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Reference2ObjectMap.Entry<K, V> last() {
/*  860 */       if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  861 */       return new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, Reference2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  869 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  871 */       while (Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  872 */         if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == k) return Reference2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Reference2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  873 */         pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  875 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  883 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  885 */       while (Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */         if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == k) {
/*  887 */           Reference2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  888 */           return true;
/*      */         }
/*  890 */         pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  892 */       return false;
/*      */     }
/*      */     public int size() {
/*  895 */       return Reference2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  898 */       Reference2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> iterator(Reference2ObjectMap.Entry<K, V> from) {
/*  901 */       return new Reference2ObjectLinkedOpenHashMap.EntryIterator(Reference2ObjectLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> fastIterator() {
/*  904 */       return new Reference2ObjectLinkedOpenHashMap.FastEntryIterator(Reference2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> fastIterator(Reference2ObjectMap.Entry<K, V> from) {
/*  907 */       return new Reference2ObjectLinkedOpenHashMap.FastEntryIterator(Reference2ObjectLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>>
/*      */   {
/*  827 */     final AbstractReference2ObjectMap.BasicEntry<K, V> entry = new AbstractReference2ObjectMap.BasicEntry(null, null);
/*      */ 
...
/*  833 */       int e = nextEntry();
/*  834 */       this.entry.key = Reference2ObjectLinkedOpenHashMap.this.key[e];
/*  835 */       this.entry.value = Reference2ObjectLinkedOpenHashMap.this.value[e];
/*  836 */       return this.entry;
/*      */     }
/*      */     public AbstractReference2ObjectMap.BasicEntry<K, V> previous() {
/*  839 */       int e = previousEntry();
/*  840 */       this.entry.key = Reference2ObjectLinkedOpenHashMap.this.key[e];
/*  841 */       this.entry.value = Reference2ObjectLinkedOpenHashMap.this.value[e];
/*  842 */       return this.entry;
/*      */     }
/*  844 */     public void set(Reference2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  845 */     public void add(Reference2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>>
/*      */   {
...
/*  813 */       return this.entry = new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Reference2ObjectLinkedOpenHashMap<K, V>.MapEntry previous() {
/*  816 */       return this.entry = new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  820 */       super.remove();
/*  821 */       Reference2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  823 */     public void set(Reference2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  824 */     public void add(Reference2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  684 */     int index = -1;
/*      */ 
/*  686 */     private MapIterator() { this.next = Reference2ObjectLinkedOpenHashMap.this.first;
/*  687 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  690 */       if (Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.last] == from) {
/*  691 */         this.prev = Reference2ObjectLinkedOpenHashMap.this.last;
/*  692 */         this.index = Reference2ObjectLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  696 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  698 */         while (Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  699 */           if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  701 */             this.next = ((int)Reference2ObjectLinkedOpenHashMap.this.link[pos]);
/*  702 */             this.prev = pos;
/*  703 */             return;
/*      */           }
/*  705 */           pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  718 */       if (this.next == -1) {
/*  719 */         this.index = Reference2ObjectLinkedOpenHashMap.this.size;
/*  720 */         return;
/*      */       }
/*  722 */       int pos = Reference2ObjectLinkedOpenHashMap.this.first;
/*  723 */       this.index = 1;
/*  724 */       while (pos != this.prev) {
/*  725 */         pos = (int)Reference2ObjectLinkedOpenHashMap.this.link[pos];
/*  726 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  738 */       if (!hasNext()) return Reference2ObjectLinkedOpenHashMap.this.size();
/*  739 */       this.curr = this.next;
/*  740 */       this.next = ((int)Reference2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  748 */       this.prev = ((int)(Reference2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  760 */         this.index -= 1;
/*  761 */         this.prev = ((int)(Reference2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  764 */         this.next = ((int)Reference2ObjectLinkedOpenHashMap.this.link[this.curr]);
/*  765 */       }Reference2ObjectLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  768 */       if (this.prev == -1) Reference2ObjectLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  770 */         Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  771 */       if (this.next == -1) Reference2ObjectLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  773 */         Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  777 */         pos = (last = pos) + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  778 */         while (Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  779 */           int slot = (Reference2ObjectLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ObjectLinkedOpenHashMap.this.key[pos]))) & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  780 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  781 */           pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
/*  783 */         if (Reference2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  784 */         Reference2ObjectLinkedOpenHashMap.this.key[last] = Reference2ObjectLinkedOpenHashMap.this.key[pos];
/*  785 */         Reference2ObjectLinkedOpenHashMap.this.value[last] = Reference2ObjectLinkedOpenHashMap.this.value[pos];
/*  786 */         if (this.next == pos) this.next = last;
/*  787 */         if (this.prev == pos) this.prev = last;
/*  788 */         Reference2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  790 */       Reference2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  791 */       Reference2ObjectLinkedOpenHashMap.this.key[last] = null;
/*  792 */       Reference2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  793 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  559 */       return Reference2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  562 */       return Reference2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  565 */       Object oldValue = Reference2ObjectLinkedOpenHashMap.this.value[this.index];
/*  566 */       Reference2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  567 */       return oldValue;
/*      */     }
/*      */ 
...
/*  573 */       return (Reference2ObjectLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Reference2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  576 */       return (Reference2ObjectLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ObjectLinkedOpenHashMap.this.key[this.index])) ^ (Reference2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Reference2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     public String toString() {
/*  579 */       return Reference2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
