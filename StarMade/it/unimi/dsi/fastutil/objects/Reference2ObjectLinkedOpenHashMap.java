  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2ObjectLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2ObjectLinkedOpenHashMap(Map<? extends K, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2ObjectLinkedOpenHashMap(Map<? extends K, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2ObjectLinkedOpenHashMap(Reference2ObjectMap<K, V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2ObjectLinkedOpenHashMap(Reference2ObjectMap<K, V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2ObjectLinkedOpenHashMap(K[] local_k, V[] local_v, float local_f)
  {
  ...
  public Reference2ObjectLinkedOpenHashMap(K[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Reference2ObjectLinkedOpenHashMap.ValueIterator(Reference2ObjectLinkedOpenHashMap.this);
        }
        ...
        {
          return Reference2ObjectLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2ObjectLinkedOpenHashMap<K, V> local_c;
    try
    {
      local_c = (Reference2ObjectLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    V[] value = this.value;
    Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractReferenceSortedSet<K>
  {
    ...
    {
      return new Reference2ObjectLinkedOpenHashMap.KeyIterator(Reference2ObjectLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Reference2ObjectLinkedOpenHashMap.KeyIterator(Reference2ObjectLinkedOpenHashMap.this);
    }
    ...
    {
      return Reference2ObjectLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2ObjectLinkedOpenHashMap.this.size;
      Reference2ObjectLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Reference2ObjectSortedMap.FastSortedEntrySet<K, V>
  {
    ...
    {
      return new Reference2ObjectLinkedOpenHashMap.EntryIterator(Reference2ObjectLinkedOpenHashMap.this);
    }
    ...
    public Reference2ObjectMap.Entry<K, V> first()
    {
      ...
      return new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, Reference2ObjectLinkedOpenHashMap.this.first);
    }
    ...
    public Reference2ObjectMap.Entry<K, V> last()
    {
      ...
      return new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, Reference2ObjectLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2ObjectLinkedOpenHashMap.this.mask; Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask) {
        if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == local_k) {
          return Reference2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Reference2ObjectLinkedOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2ObjectLinkedOpenHashMap.this.mask; Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask) {
        if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Reference2ObjectLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Reference2ObjectLinkedOpenHashMap.EntryIterator(Reference2ObjectLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> fastIterator()
    {
      return new Reference2ObjectLinkedOpenHashMap.FastEntryIterator(Reference2ObjectLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> fastIterator(Reference2ObjectMap.Entry<K, V> from)
    {
      return new Reference2ObjectLinkedOpenHashMap.FastEntryIterator(Reference2ObjectLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>>
  {
    ...
    public AbstractReference2ObjectMap.BasicEntry<K, V> next()
    {
      ...
      this.entry.key = Reference2ObjectLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Reference2ObjectLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    public void set(Reference2ObjectMap.Entry<K, V> local_ok)
    {
      throw new UnsupportedOperationException();
    }
    
    public void add(Reference2ObjectMap.Entry<K, V> local_ok)
    {
      throw new UnsupportedOperationException();
    }
  }
    ...
    implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>>
  {
    ...
    {
      return this.entry = new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, nextEntry());
    }
    
    public Reference2ObjectLinkedOpenHashMap<K, V>.MapEntry previous()
    {
      return this.entry = new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2ObjectLinkedOpenHashMap.this.mask; Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Reference2ObjectLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Reference2ObjectLinkedOpenHashMap.this.first = this.next;
      } else {
        Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Reference2ObjectLinkedOpenHashMap.this.last = this.prev;
      } else {
        Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2ObjectLinkedOpenHashMap.this.mask; Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask)
        {
          int slot = (Reference2ObjectLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ObjectLinkedOpenHashMap.this.key[pos]))) & Reference2ObjectLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Reference2ObjectLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Reference2ObjectLinkedOpenHashMap.this.key[last] = Reference2ObjectLinkedOpenHashMap.this.key[pos];
      ...
      Reference2ObjectLinkedOpenHashMap.this.used[last] = false;
      Reference2ObjectLinkedOpenHashMap.this.key[last] = null;
    ...
    implements Reference2ObjectMap.Entry<K, V>, Map.Entry<K, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Reference2ObjectLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, V> local_e = (Map.Entry)local_o;
      return (Reference2ObjectLinkedOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2ObjectLinkedOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Reference2ObjectLinkedOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
    
    public int hashCode()
    {
      return (Reference2ObjectLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ObjectLinkedOpenHashMap.this.key[this.index])) ^ (Reference2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Reference2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
    }
