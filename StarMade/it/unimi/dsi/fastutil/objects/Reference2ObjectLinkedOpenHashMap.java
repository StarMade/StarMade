...
/*   14:     */
/*   99:     */public class Reference2ObjectLinkedOpenHashMap<K, V>
/*  100:     */  extends AbstractReference2ObjectSortedMap<K, V>
...
/*  113:     */  protected volatile transient Reference2ObjectSortedMap.FastSortedEntrySet<K, V> entries;
...
/*  127:     */  
/*  135:     */  public Reference2ObjectLinkedOpenHashMap(int expected, float f)
/*  136:     */  {
...
/*  147:     */  }
/*  148:     */  
/*  151:     */  public Reference2ObjectLinkedOpenHashMap(int expected)
/*  152:     */  {
/*  153: 153 */    this(expected, 0.75F);
/*  154:     */  }
/*  155:     */  
/*  157:     */  public Reference2ObjectLinkedOpenHashMap()
/*  158:     */  {
/*  159: 159 */    this(16, 0.75F);
/*  160:     */  }
/*  161:     */  
/*  165:     */  public Reference2ObjectLinkedOpenHashMap(Map<? extends K, ? extends V> m, float f)
/*  166:     */  {
/*  167: 167 */    this(m.size(), f);
/*  168: 168 */    putAll(m);
/*  169:     */  }
/*  170:     */  
/*  173:     */  public Reference2ObjectLinkedOpenHashMap(Map<? extends K, ? extends V> m)
/*  174:     */  {
/*  175: 175 */    this(m, 0.75F);
/*  176:     */  }
/*  177:     */  
/*  181:     */  public Reference2ObjectLinkedOpenHashMap(Reference2ObjectMap<K, V> m, float f)
/*  182:     */  {
/*  183: 183 */    this(m.size(), f);
/*  184: 184 */    putAll(m);
/*  185:     */  }
/*  186:     */  
/*  189:     */  public Reference2ObjectLinkedOpenHashMap(Reference2ObjectMap<K, V> m)
/*  190:     */  {
/*  191: 191 */    this(m, 0.75F);
/*  192:     */  }
/*  193:     */  
/*  199:     */  public Reference2ObjectLinkedOpenHashMap(K[] k, V[] v, float f)
/*  200:     */  {
...
/*  205:     */  }
/*  206:     */  
/*  210:     */  public Reference2ObjectLinkedOpenHashMap(K[] k, V[] v)
/*  211:     */  {
...
/*  550:     */    implements Reference2ObjectMap.Entry<K, V>, Map.Entry<K, V>
/*  551:     */  {
...
/*  557:     */    }
/*  558:     */    
/*  559: 559 */    public K getKey() { return Reference2ObjectLinkedOpenHashMap.this.key[this.index]; }
/*  560:     */    
/*  562: 562 */    public V getValue() { return Reference2ObjectLinkedOpenHashMap.this.value[this.index]; }
/*  563:     */    
/*  564:     */    public V setValue(V v) {
/*  565: 565 */      V oldValue = Reference2ObjectLinkedOpenHashMap.this.value[this.index];
/*  566: 566 */      Reference2ObjectLinkedOpenHashMap.this.value[this.index] = v;
...
/*  573: 573 */      return (Reference2ObjectLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Reference2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*  574:     */    }
/*  575:     */    
/*  576: 576 */    public int hashCode() { return (Reference2ObjectLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ObjectLinkedOpenHashMap.this.key[this.index])) ^ (Reference2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Reference2ObjectLinkedOpenHashMap.this.value[this.index].hashCode()); }
/*  577:     */    
/*  578:     */    public String toString() {
/*  579: 579 */      return Reference2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2ObjectLinkedOpenHashMap.this.value[this.index];
/*  580:     */    }
/*  581:     */  }
/*  582:     */  
...
/*  667: 667 */  public Reference2ObjectSortedMap<K, V> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  668: 668 */  public Reference2ObjectSortedMap<K, V> headMap(K to) { throw new UnsupportedOperationException(); }
/*  669: 669 */  public Reference2ObjectSortedMap<K, V> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  670:     */  
...
/*  684: 684 */    int index = -1;
/*  685:     */    
/*  686: 686 */    private MapIterator() { this.next = Reference2ObjectLinkedOpenHashMap.this.first;
/*  687: 687 */      this.index = 0;
/*  688:     */    }
/*  689:     */    
/*  690: 690 */    private MapIterator() { if (Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.last] == from) {
/*  691: 691 */        this.prev = Reference2ObjectLinkedOpenHashMap.this.last;
/*  692: 692 */        this.index = Reference2ObjectLinkedOpenHashMap.this.size;
/*  693:     */      }
/*  694:     */      else
/*  695:     */      {
/*  696: 696 */        int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  697:     */        
/*  698: 698 */        while (Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  699: 699 */          if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == from)
/*  700:     */          {
/*  701: 701 */            this.next = ((int)Reference2ObjectLinkedOpenHashMap.this.link[pos]);
/*  702: 702 */            this.prev = pos;
/*  703: 703 */            return;
/*  704:     */          }
/*  705: 705 */          pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  706:     */        }
...
/*  719: 719 */        this.index = Reference2ObjectLinkedOpenHashMap.this.size;
/*  720: 720 */        return;
/*  721:     */      }
/*  722: 722 */      int pos = Reference2ObjectLinkedOpenHashMap.this.first;
/*  723: 723 */      this.index = 1;
/*  724: 724 */      while (pos != this.prev) {
/*  725: 725 */        pos = (int)Reference2ObjectLinkedOpenHashMap.this.link[pos];
...
/*  736:     */    }
/*  737:     */    
/*  738: 738 */    public int nextEntry() { if (!hasNext()) return Reference2ObjectLinkedOpenHashMap.this.size();
/*  739: 739 */      this.curr = this.next;
/*  740: 740 */      this.next = ((int)Reference2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  748: 748 */      this.prev = ((int)(Reference2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  761: 761 */        this.prev = ((int)(Reference2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  762:     */      }
/*  763:     */      else {
/*  764: 764 */        this.next = ((int)Reference2ObjectLinkedOpenHashMap.this.link[this.curr]); }
/*  765: 765 */      Reference2ObjectLinkedOpenHashMap.this.size -= 1;
/*  766:     */      
/*  768: 768 */      if (this.prev == -1) { Reference2ObjectLinkedOpenHashMap.this.first = this.next;
/*  769:     */      } else
/*  770: 770 */        Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Reference2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  771: 771 */      if (this.next == -1) { Reference2ObjectLinkedOpenHashMap.this.last = this.prev;
/*  772:     */      } else
/*  773: 773 */        Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Reference2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  774: 774 */      int pos = this.curr;
/*  775:     */      int last;
/*  776:     */      for (;;) {
/*  777: 777 */        pos = (last = pos) + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  778: 778 */        while (Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  779: 779 */          int slot = (Reference2ObjectLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ObjectLinkedOpenHashMap.this.key[pos]))) & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  780: 780 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  781: 781 */          pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  782:     */        }
/*  783: 783 */        if (Reference2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  784: 784 */        Reference2ObjectLinkedOpenHashMap.this.key[last] = Reference2ObjectLinkedOpenHashMap.this.key[pos];
/*  785: 785 */        Reference2ObjectLinkedOpenHashMap.this.value[last] = Reference2ObjectLinkedOpenHashMap.this.value[pos];
/*  786: 786 */        if (this.next == pos) this.next = last;
/*  787: 787 */        if (this.prev == pos) this.prev = last;
/*  788: 788 */        Reference2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*  789:     */      }
/*  790: 790 */      Reference2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  791: 791 */      Reference2ObjectLinkedOpenHashMap.this.key[last] = null;
/*  792: 792 */      Reference2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  793: 793 */      this.curr = -1;
/*  794:     */    }
/*  795:     */    
...
/*  804:     */    } }
/*  805:     */  
/*  806:     */  private class EntryIterator extends Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>> { private Reference2ObjectLinkedOpenHashMap<K, V>.MapEntry entry;
/*  807:     */    
/*  808: 808 */    public EntryIterator() { super(null); }
/*  809:     */    
/*  810: 810 */    public EntryIterator() { super(from, null); }
/*  811:     */    
/*  812:     */    public Reference2ObjectLinkedOpenHashMap<K, V>.MapEntry next() {
/*  813: 813 */      return this.entry = new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, nextEntry());
/*  814:     */    }
/*  815:     */    
/*  816: 816 */    public Reference2ObjectLinkedOpenHashMap<K, V>.MapEntry previous() { return this.entry = new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, previousEntry()); }
/*  817:     */    
/*  818:     */    public void remove()
/*  819:     */    {
/*  820: 820 */      super.remove();
/*  821: 821 */      Reference2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  822:     */    
/*  823: 823 */    public void set(Reference2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  824: 824 */    public void add(Reference2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  825:     */  }
/*  826:     */  
/*  827: 827 */  private class FastEntryIterator extends Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator implements ObjectListIterator<Reference2ObjectMap.Entry<K, V>> { final AbstractReference2ObjectMap.BasicEntry<K, V> entry = new AbstractReference2ObjectMap.BasicEntry(null, null);
/*  828: 828 */    public FastEntryIterator() { super(null); }
/*  829:     */    
/*  830: 830 */    public FastEntryIterator() { super(from, null); }
/*  831:     */    
/*  832:     */    public AbstractReference2ObjectMap.BasicEntry<K, V> next() {
/*  833: 833 */      int e = nextEntry();
/*  834: 834 */      this.entry.key = Reference2ObjectLinkedOpenHashMap.this.key[e];
/*  835: 835 */      this.entry.value = Reference2ObjectLinkedOpenHashMap.this.value[e];
/*  836: 836 */      return this.entry;
/*  837:     */    }
/*  838:     */    
/*  839: 839 */    public AbstractReference2ObjectMap.BasicEntry<K, V> previous() { int e = previousEntry();
/*  840: 840 */      this.entry.key = Reference2ObjectLinkedOpenHashMap.this.key[e];
/*  841: 841 */      this.entry.value = Reference2ObjectLinkedOpenHashMap.this.value[e];
/*  842: 842 */      return this.entry; }
/*  843:     */    
/*  844: 844 */    public void set(Reference2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*  845: 845 */    public void add(Reference2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } }
/*  846:     */  
/*  847:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ObjectMap.Entry<K, V>> implements Reference2ObjectSortedMap.FastSortedEntrySet<K, V> { private MapEntrySet() {}
/*  848:     */    
/*  849: 849 */    public ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> iterator() { return new Reference2ObjectLinkedOpenHashMap.EntryIterator(Reference2ObjectLinkedOpenHashMap.this); }
/*  850:     */    
/*  851: 851 */    public Comparator<? super Reference2ObjectMap.Entry<K, V>> comparator() { return null; }
/*  852: 852 */    public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> subSet(Reference2ObjectMap.Entry<K, V> fromElement, Reference2ObjectMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); }
/*  853: 853 */    public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> headSet(Reference2ObjectMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); }
/*  854: 854 */    public ObjectSortedSet<Reference2ObjectMap.Entry<K, V>> tailSet(Reference2ObjectMap.Entry<K, V> fromElement) { throw new UnsupportedOperationException(); }
/*  855:     */    
/*  856: 856 */    public Reference2ObjectMap.Entry<K, V> first() { if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  857: 857 */      return new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, Reference2ObjectLinkedOpenHashMap.this.first);
/*  858:     */    }
/*  859:     */    
/*  860: 860 */    public Reference2ObjectMap.Entry<K, V> last() { if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  861: 861 */      return new Reference2ObjectLinkedOpenHashMap.MapEntry(Reference2ObjectLinkedOpenHashMap.this, Reference2ObjectLinkedOpenHashMap.this.last);
/*  862:     */    }
/*  863:     */    
...
/*  868:     */      
/*  869: 869 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  870:     */      
/*  871: 871 */      while (Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  872: 872 */        if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == k) return Reference2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Reference2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  873: 873 */        pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  874:     */      }
...
/*  882:     */      
/*  883: 883 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  884:     */      
/*  885: 885 */      while (Reference2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  886: 886 */        if (Reference2ObjectLinkedOpenHashMap.this.key[pos] == k) {
/*  887: 887 */          Reference2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  888: 888 */          return true;
/*  889:     */        }
/*  890: 890 */        pos = pos + 1 & Reference2ObjectLinkedOpenHashMap.this.mask;
/*  891:     */      }
/*  892: 892 */      return false;
/*  893:     */    }
/*  894:     */    
/*  895: 895 */    public int size() { return Reference2ObjectLinkedOpenHashMap.this.size; }
/*  896:     */    
/*  897:     */    public void clear() {
/*  898: 898 */      Reference2ObjectLinkedOpenHashMap.this.clear();
/*  899:     */    }
/*  900:     */    
/*  901: 901 */    public ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> iterator(Reference2ObjectMap.Entry<K, V> from) { return new Reference2ObjectLinkedOpenHashMap.EntryIterator(Reference2ObjectLinkedOpenHashMap.this, from.getKey()); }
/*  902:     */    
/*  903:     */    public ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> fastIterator() {
/*  904: 904 */      return new Reference2ObjectLinkedOpenHashMap.FastEntryIterator(Reference2ObjectLinkedOpenHashMap.this);
/*  905:     */    }
/*  906:     */    
/*  907: 907 */    public ObjectBidirectionalIterator<Reference2ObjectMap.Entry<K, V>> fastIterator(Reference2ObjectMap.Entry<K, V> from) { return new Reference2ObjectLinkedOpenHashMap.FastEntryIterator(Reference2ObjectLinkedOpenHashMap.this, from.getKey()); }
/*  908:     */  }
/*  909:     */  
/*  910:     */  public Reference2ObjectSortedMap.FastSortedEntrySet<K, V> reference2ObjectEntrySet() {
...
/*  918:     */    extends Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*  919:     */    implements ObjectListIterator<K>
/*  920:     */  {
/*  921: 921 */    public KeyIterator() { super(k, null); }
/*  922: 922 */    public K previous() { return Reference2ObjectLinkedOpenHashMap.this.key[previousEntry()]; }
...
/*  926: 926 */    public K next() { return Reference2ObjectLinkedOpenHashMap.this.key[nextEntry()]; } }
/*  927:     */  
/*  928:     */  private final class KeySet extends AbstractReferenceSortedSet<K> { private KeySet() {}
/*  929:     */    
/*  930: 930 */    public ObjectListIterator<K> iterator(K from) { return new Reference2ObjectLinkedOpenHashMap.KeyIterator(Reference2ObjectLinkedOpenHashMap.this, from); }
/*  931:     */    
/*  932:     */    public ObjectListIterator<K> iterator() {
/*  933: 933 */      return new Reference2ObjectLinkedOpenHashMap.KeyIterator(Reference2ObjectLinkedOpenHashMap.this);
/*  934:     */    }
/*  935:     */    
/*  936: 936 */    public int size() { return Reference2ObjectLinkedOpenHashMap.this.size; }
/*  937:     */    
/*  939: 939 */    public boolean contains(Object k) { return Reference2ObjectLinkedOpenHashMap.this.containsKey(k); }
/*  940:     */    
/*  941:     */    public boolean remove(Object k) {
/*  942: 942 */      int oldSize = Reference2ObjectLinkedOpenHashMap.this.size;
/*  943: 943 */      Reference2ObjectLinkedOpenHashMap.this.remove(k);
/*  944: 944 */      return Reference2ObjectLinkedOpenHashMap.this.size != oldSize;
/*  945:     */    }
/*  946:     */    
/*  947: 947 */    public void clear() { Reference2ObjectLinkedOpenHashMap.this.clear(); }
/*  948:     */    
/*  949:     */    public K first() {
/*  950: 950 */      if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  951: 951 */      return Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.first];
/*  952:     */    }
/*  953:     */    
/*  954: 954 */    public K last() { if (Reference2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  955: 955 */      return Reference2ObjectLinkedOpenHashMap.this.key[Reference2ObjectLinkedOpenHashMap.this.last]; }
/*  956:     */    
...
/*  970:     */    extends Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*  971:     */    implements ObjectListIterator<V>
/*  972:     */  {
/*  973: 973 */    public V previous() { return Reference2ObjectLinkedOpenHashMap.this.value[previousEntry()]; }
...
/*  977: 977 */    public V next() { return Reference2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/*  978:     */  }
/*  979:     */  
...
/*  982: 982 */          return new Reference2ObjectLinkedOpenHashMap.ValueIterator(Reference2ObjectLinkedOpenHashMap.this);
/*  983:     */        }
/*  984:     */        
/*  985: 985 */        public int size() { return Reference2ObjectLinkedOpenHashMap.this.size; }
/*  986:     */        
/*  987:     */        public boolean contains(Object v) {
/*  988: 988 */          return Reference2ObjectLinkedOpenHashMap.this.containsValue(v);
/*  989:     */        }
/*  990:     */        
/*  991: 991 */        public void clear() { Reference2ObjectLinkedOpenHashMap.this.clear(); }
/*  992:     */      };
/*  993:     */    }
...
/* 1113:     */  }
/* 1114:     */  
/* 1117:     */  public Reference2ObjectLinkedOpenHashMap<K, V> clone()
/* 1118:     */  {
/* 1119:     */    Reference2ObjectLinkedOpenHashMap<K, V> c;
/* 1120:     */    
/* 1122:     */    try
/* 1123:     */    {
/* 1124:1124 */      c = (Reference2ObjectLinkedOpenHashMap)super.clone();
/* 1125:     */    }
...
/* 1163:1163 */    Reference2ObjectLinkedOpenHashMap<K, V>.MapIterator i = new MapIterator(null);
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.Reference2ObjectLinkedOpenHashMap
