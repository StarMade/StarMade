  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2IntOpenCustomHashMap(int expected, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2IntOpenCustomHashMap(Object2IntMap<K> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2IntOpenCustomHashMap(Object2IntMap<K> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2IntOpenCustomHashMap(K[] local_k, int[] local_v, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2IntOpenCustomHashMap(K[] local_k, int[] local_v, Hash.Strategy<K> strategy)
  {
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Object2IntOpenCustomHashMap.ValueIterator(Object2IntOpenCustomHashMap.this);
        }
        ...
        {
          return Object2IntOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2IntOpenCustomHashMap<K> local_c;
    try
    {
      local_c = (Object2IntOpenCustomHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    int[] value = this.value;
    Object2IntOpenCustomHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2IntOpenCustomHashMap.MapIterator
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Object2IntOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractObjectSet<K>
  {
    ...
    {
      return new Object2IntOpenCustomHashMap.KeyIterator(Object2IntOpenCustomHashMap.this);
    }
    ...
    {
      return Object2IntOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2IntOpenCustomHashMap.this.size;
      Object2IntOpenCustomHashMap.this.remove(local_k);
    ...
    implements Object2IntMap.FastEntrySet<K>
  {
    ...
    {
      return new Object2IntOpenCustomHashMap.EntryIterator(Object2IntOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Object2IntMap.Entry<K>> fastIterator()
    {
      return new Object2IntOpenCustomHashMap.FastEntryIterator(Object2IntOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2IntOpenCustomHashMap.this.mask; Object2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2IntOpenCustomHashMap.this.mask) {
        if (Object2IntOpenCustomHashMap.this.strategy.equals(Object2IntOpenCustomHashMap.this.key[pos], local_k)) {
          return Object2IntOpenCustomHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2IntOpenCustomHashMap.this.mask; Object2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2IntOpenCustomHashMap.this.mask) {
        if (Object2IntOpenCustomHashMap.this.strategy.equals(Object2IntOpenCustomHashMap.this.key[pos], local_k))
        {
          Object2IntOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Object2IntMap.Entry<K>>
  {
    ...
    public AbstractObject2IntMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2IntOpenCustomHashMap.this.key[local_e];
      this.entry.value = Object2IntOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Object2IntMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2IntOpenCustomHashMap.MapEntry(Object2IntOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Object2IntOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1704 = Object2IntOpenCustomHashMap.this.size;
    ObjectArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Object2IntOpenCustomHashMap.this.used;
      while ((this.field_1704 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1704 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1704 != 0)
      {
        boolean[] local_k = Object2IntOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2IntOpenCustomHashMap.this.mask; Object2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2IntOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Object2IntOpenCustomHashMap.this.strategy.hashCode(Object2IntOpenCustomHashMap.this.key[pos])) & Object2IntOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2IntOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Object2IntOpenCustomHashMap.this.key[pos]);
        }
        Object2IntOpenCustomHashMap.this.key[last] = Object2IntOpenCustomHashMap.this.key[pos];
        Object2IntOpenCustomHashMap.this.value[last] = Object2IntOpenCustomHashMap.this.value[pos];
      }
      Object2IntOpenCustomHashMap.this.used[last] = false;
      Object2IntOpenCustomHashMap.this.key[last] = null;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Object2IntOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
        this.last = -1;
        return;
      }
      Object2IntOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1704 > 0))
      {
        this.field_1704 += 1;
        nextEntry();
      }
    ...
    implements Object2IntMap.Entry<K>, Map.Entry<K, Integer>
  {
    ...
    public int setValue(int local_v)
    {
      ...
      Object2IntOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Integer> local_e = (Map.Entry)local_o;
      return (Object2IntOpenCustomHashMap.this.strategy.equals(Object2IntOpenCustomHashMap.this.key[this.index], local_e.getKey())) && (Object2IntOpenCustomHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
