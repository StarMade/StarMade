...
/*  12:    */
/*  58:    */public class Object2FloatMaps
/*  59:    */{
/*  60:    */  public static class EmptyMap<K>
/*  61:    */    extends Object2FloatFunctions.EmptyFunction<K>
/*  62:    */    implements Object2FloatMap<K>, Serializable, Cloneable
/*  63:    */  {
...
/*  68:    */    
/*  69: 69 */    public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() { return ObjectSets.EMPTY_SET; }
/*  70:    */    
...
/*  75: 75 */    private Object readResolve() { return Object2FloatMaps.EMPTY_MAP; }
/*  76: 76 */    public Object clone() { return Object2FloatMaps.EMPTY_MAP; }
/*  77: 77 */    public boolean isEmpty() { return true; }
/*  78:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<K, Float>> entrySet() { return object2FloatEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Object2FloatFunctions.Singleton<K>
/* 103:    */    implements Object2FloatMap<K>, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Object2FloatMap.Entry<K>> entries;
/* 108:    */    
...
/* 125:    */    
/* 126:126 */    public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Object2FloatMap.Entry<K>, Map.Entry<K, Float> { protected SingletonEntry() {}
/* 131:131 */      public K getKey() { return Object2FloatMaps.Singleton.this.key; }
/* 132:132 */      public Float getValue() { return Float.valueOf(Object2FloatMaps.Singleton.this.value); }
/* 133:    */      
/* 139:139 */      public float getFloatValue() { return Object2FloatMaps.Singleton.this.value; }
...
/* 148:    */        
/* 149:149 */        return (Object2FloatMaps.Singleton.this.key == null ? e.getKey() == null : Object2FloatMaps.Singleton.this.key.equals(e.getKey())) && (Object2FloatMaps.Singleton.this.value == ((Float)e.getValue()).floatValue());
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return (Object2FloatMaps.Singleton.this.key == null ? 0 : Object2FloatMaps.Singleton.this.key.hashCode()) ^ HashCommon.float2int(Object2FloatMaps.Singleton.this.value); }
/* 153:153 */      public String toString() { return Object2FloatMaps.Singleton.this.key + "->" + Object2FloatMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<K, Float>> entrySet() { return object2FloatEntrySet(); }
/* 160:    */    
/* 161:161 */    public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.float2int(this.value); }
/* 162:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static <K> Object2FloatMap<K> singleton(K key, float value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static <K> Object2FloatMap<K> singleton(K key, Float value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key, value.floatValue());
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap<K>
/* 205:    */    extends Object2FloatFunctions.SynchronizedFunction<K>
/* 206:    */    implements Object2FloatMap<K>, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Object2FloatMap<K> map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Object2FloatMap.Entry<K>> entries;
/* 213:    */    
/* 214:    */    protected volatile transient ObjectSet<K> keys;
/* 215:    */    protected volatile transient FloatCollection values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Object2FloatMap<K> m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Object2FloatMap<K> m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 239:    */    
/* 240:240 */    public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2FloatEntrySet(), this.sync); return this.entries; }
...
/* 258:    */  }
/* 259:    */  
/* 261:    */  public static <K> Object2FloatMap<K> synchronize(Object2FloatMap<K> m)
/* 262:    */  {
/* 263:263 */    return new SynchronizedMap(m);
/* 264:    */  }
/* 265:    */  
/* 271:271 */  public static <K> Object2FloatMap<K> synchronize(Object2FloatMap<K> m, Object sync) { return new SynchronizedMap(m, sync); }
/* 272:    */  
/* 273:    */  public static class UnmodifiableMap<K> extends Object2FloatFunctions.UnmodifiableFunction<K> implements Object2FloatMap<K>, Serializable {
/* 274:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 275:    */    protected final Object2FloatMap<K> map;
/* 276:    */    protected volatile transient ObjectSet<Object2FloatMap.Entry<K>> entries;
/* 277:    */    protected volatile transient ObjectSet<K> keys;
/* 278:    */    protected volatile transient FloatCollection values;
/* 279:    */    
/* 280:280 */    protected UnmodifiableMap(Object2FloatMap<K> m) { super();
/* 281:281 */      this.map = m; }
/* 282:    */    
...
/* 291:291 */    public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2FloatEntrySet()); return this.entries; }
...
/* 301:    */  }
/* 302:    */  
/* 306:    */  public static <K> Object2FloatMap<K> unmodifiable(Object2FloatMap<K> m)
/* 307:    */  {
