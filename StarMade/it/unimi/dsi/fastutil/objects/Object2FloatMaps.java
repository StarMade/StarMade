...
/* 291 */     public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2FloatEntrySet()); return this.entries; } 
...
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2FloatEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Object2FloatMap.Entry<K>> object2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return object2FloatEntrySet();
/*     */     }
/* 161 */     public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.float2int(this.value); }
/*     */ 
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Object2FloatMaps.Singleton.this.key; } 
/* 132 */       public Float getValue() { return Float.valueOf(Object2FloatMaps.Singleton.this.value); }
/*     */ 
/*     */ 
/*     */       public float getFloatValue()
/*     */       {
/* 139 */         return Object2FloatMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Object2FloatMaps.Singleton.this.key == null ? e.getKey() == null : Object2FloatMaps.Singleton.this.key.equals(e.getKey())) && (Object2FloatMaps.Singleton.this.value == ((Float)e.getValue()).floatValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return (Object2FloatMaps.Singleton.this.key == null ? 0 : Object2FloatMaps.Singleton.this.key.hashCode()) ^ HashCommon.float2int(Object2FloatMaps.Singleton.this.value); } 
/* 153 */       public String toString() { return Object2FloatMaps.Singleton.this.key + "->" + Object2FloatMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*  75 */     private Object readResolve() { return Object2FloatMaps.EMPTY_MAP; } 
/*  76 */     public Object clone() { return Object2FloatMaps.EMPTY_MAP; } 
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, Float>> entrySet() {
/*  80 */       return object2FloatEntrySet();
/*     */     }
