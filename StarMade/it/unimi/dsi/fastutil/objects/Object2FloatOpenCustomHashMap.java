...
/*  17:    */
/*  89:    */public class Object2FloatOpenCustomHashMap<K>
/*  90:    */  extends AbstractObject2FloatMap<K>
...
/* 103:    */  protected volatile transient Object2FloatMap.FastEntrySet<K> entries;
...
/* 107:    */  
/* 108:    */  public Object2FloatOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy)
/* 109:    */  {
...
/* 120:    */  }
/* 121:    */  
/* 125:    */  public Object2FloatOpenCustomHashMap(int expected, Hash.Strategy<K> strategy)
/* 126:    */  {
/* 127:127 */    this(expected, 0.75F, strategy);
/* 128:    */  }
/* 129:    */  
/* 132:    */  public Object2FloatOpenCustomHashMap(Hash.Strategy<K> strategy)
/* 133:    */  {
/* 134:134 */    this(16, 0.75F, strategy);
/* 135:    */  }
/* 136:    */  
/* 141:    */  public Object2FloatOpenCustomHashMap(Map<? extends K, ? extends Float> m, float f, Hash.Strategy<K> strategy)
/* 142:    */  {
/* 143:143 */    this(m.size(), f, strategy);
/* 144:144 */    putAll(m);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Object2FloatOpenCustomHashMap(Map<? extends K, ? extends Float> m, Hash.Strategy<K> strategy)
/* 151:    */  {
/* 152:152 */    this(m, 0.75F, strategy);
/* 153:    */  }
/* 154:    */  
/* 159:    */  public Object2FloatOpenCustomHashMap(Object2FloatMap<K> m, float f, Hash.Strategy<K> strategy)
/* 160:    */  {
/* 161:161 */    this(m.size(), f, strategy);
/* 162:162 */    putAll(m);
/* 163:    */  }
/* 164:    */  
/* 168:    */  public Object2FloatOpenCustomHashMap(Object2FloatMap<K> m, Hash.Strategy<K> strategy)
/* 169:    */  {
/* 170:170 */    this(m, 0.75F, strategy);
/* 171:    */  }
/* 172:    */  
/* 179:    */  public Object2FloatOpenCustomHashMap(K[] k, float[] v, float f, Hash.Strategy<K> strategy)
/* 180:    */  {
...
/* 185:    */  }
/* 186:    */  
/* 191:    */  public Object2FloatOpenCustomHashMap(K[] k, float[] v, Hash.Strategy<K> strategy)
/* 192:    */  {
...
/* 399:    */    implements Object2FloatMap.Entry<K>, Map.Entry<K, Float>
/* 400:    */  {
...
/* 406:    */    }
/* 407:    */    
/* 408:408 */    public K getKey() { return Object2FloatOpenCustomHashMap.this.key[this.index]; }
/* 409:    */    
/* 410:    */    public Float getValue() {
/* 411:411 */      return Float.valueOf(Object2FloatOpenCustomHashMap.this.value[this.index]);
/* 412:    */    }
/* 413:    */    
/* 414:414 */    public float getFloatValue() { return Object2FloatOpenCustomHashMap.this.value[this.index]; }
/* 415:    */    
/* 416:    */    public float setValue(float v) {
/* 417:417 */      float oldValue = Object2FloatOpenCustomHashMap.this.value[this.index];
/* 418:418 */      Object2FloatOpenCustomHashMap.this.value[this.index] = v;
...
/* 428:428 */      return (Object2FloatOpenCustomHashMap.this.strategy.equals(Object2FloatOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/* 429:    */    }
/* 430:    */    
/* 431:431 */    public int hashCode() { return Object2FloatOpenCustomHashMap.this.strategy.hashCode(Object2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Object2FloatOpenCustomHashMap.this.value[this.index]); }
/* 432:    */    
/* 434:434 */    public String toString() { return Object2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Object2FloatOpenCustomHashMap.this.value[this.index]; } }
/* 435:    */  
...
/* 440:    */    
/* 441:441 */    private MapIterator() { this.pos = Object2FloatOpenCustomHashMap.this.n;
/* 442:    */      
/* 444:444 */      this.last = -1;
/* 445:    */      
/* 446:446 */      this.c = Object2FloatOpenCustomHashMap.this.size;
/* 447:    */      
/* 451:451 */      boolean[] used = Object2FloatOpenCustomHashMap.this.used;
...
/* 463:    */        
/* 464:464 */        int pos = HashCommon.murmurHash3(Object2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Object2FloatOpenCustomHashMap.this.mask;
/* 465:    */        
/* 466:466 */        while (Object2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 467:467 */          if (Object2FloatOpenCustomHashMap.this.strategy.equals(Object2FloatOpenCustomHashMap.this.key[pos], k)) return pos;
/* 468:468 */          pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask;
/* 469:    */        }
/* 470:    */      }
/* 471:471 */      this.last = this.pos;
/* 472:    */      
/* 473:473 */      if (this.c != 0) {
/* 474:474 */        boolean[] used = Object2FloatOpenCustomHashMap.this.used;
...
/* 489:    */      for (;;)
/* 490:    */      {
/* 491:491 */        pos = (last = pos) + 1 & Object2FloatOpenCustomHashMap.this.mask;
/* 492:492 */        while (Object2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 493:493 */          int slot = HashCommon.murmurHash3(Object2FloatOpenCustomHashMap.this.strategy.hashCode(Object2FloatOpenCustomHashMap.this.key[pos])) & Object2FloatOpenCustomHashMap.this.mask;
/* 494:494 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 495:495 */          pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask;
/* 496:    */        }
/* 497:497 */        if (Object2FloatOpenCustomHashMap.this.used[pos] == 0) break;
/* 498:498 */        if (pos < last)
/* 499:    */        {
/* 500:500 */          if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 501:501 */          this.wrapped.add(Object2FloatOpenCustomHashMap.this.key[pos]);
/* 502:    */        }
/* 503:503 */        Object2FloatOpenCustomHashMap.this.key[last] = Object2FloatOpenCustomHashMap.this.key[pos];
/* 504:504 */        Object2FloatOpenCustomHashMap.this.value[last] = Object2FloatOpenCustomHashMap.this.value[pos];
/* 505:    */      }
/* 506:506 */      Object2FloatOpenCustomHashMap.this.used[last] = false;
/* 507:507 */      Object2FloatOpenCustomHashMap.this.key[last] = null;
/* 508:508 */      return last;
/* 509:    */    }
/* 510:    */    
...
/* 514:    */      {
/* 515:515 */        Object2FloatOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 516:516 */        this.last = -1;
/* 517:517 */        return;
/* 518:    */      }
/* 519:519 */      Object2FloatOpenCustomHashMap.this.size -= 1;
...
/* 531:    */    } }
/* 532:    */  
/* 533:533 */  private class EntryIterator extends Object2FloatOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2FloatMap.Entry<K>> { private EntryIterator() { super(null); }
/* 534:    */    
/* 535:    */    private Object2FloatOpenCustomHashMap<K>.MapEntry entry;
/* 536:536 */    public Object2FloatMap.Entry<K> next() { return this.entry = new Object2FloatOpenCustomHashMap.MapEntry(Object2FloatOpenCustomHashMap.this, nextEntry()); }
/* 537:    */    
/* 538:    */    public void remove()
/* 539:    */    {
/* 540:540 */      super.remove();
/* 541:541 */      Object2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 542:    */    } }
/* 543:    */  
/* 544:544 */  private class FastEntryIterator extends Object2FloatOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2FloatMap.Entry<K>> { private FastEntryIterator() { super(null); }
/* 545:545 */    final AbstractObject2FloatMap.BasicEntry<K> entry = new AbstractObject2FloatMap.BasicEntry(null, 0.0F);
/* 546:    */    
/* 547:547 */    public AbstractObject2FloatMap.BasicEntry<K> next() { int e = nextEntry();
/* 548:548 */      this.entry.key = Object2FloatOpenCustomHashMap.this.key[e];
/* 549:549 */      this.entry.value = Object2FloatOpenCustomHashMap.this.value[e];
/* 550:550 */      return this.entry;
/* 551:    */    } }
/* 552:    */  
/* 553:    */  private final class MapEntrySet extends AbstractObjectSet<Object2FloatMap.Entry<K>> implements Object2FloatMap.FastEntrySet<K> { private MapEntrySet() {}
/* 554:    */    
/* 555:555 */    public ObjectIterator<Object2FloatMap.Entry<K>> iterator() { return new Object2FloatOpenCustomHashMap.EntryIterator(Object2FloatOpenCustomHashMap.this, null); }
/* 556:    */    
/* 557:    */    public ObjectIterator<Object2FloatMap.Entry<K>> fastIterator() {
/* 558:558 */      return new Object2FloatOpenCustomHashMap.FastEntryIterator(Object2FloatOpenCustomHashMap.this, null);
/* 559:    */    }
/* 560:    */    
...
/* 565:    */      
/* 566:566 */      int pos = HashCommon.murmurHash3(Object2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Object2FloatOpenCustomHashMap.this.mask;
/* 567:    */      
/* 568:568 */      while (Object2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 569:569 */        if (Object2FloatOpenCustomHashMap.this.strategy.equals(Object2FloatOpenCustomHashMap.this.key[pos], k)) return Object2FloatOpenCustomHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 570:570 */        pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask;
/* 571:    */      }
...
/* 579:    */      
/* 580:580 */      int pos = HashCommon.murmurHash3(Object2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Object2FloatOpenCustomHashMap.this.mask;
/* 581:    */      
/* 582:582 */      while (Object2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 583:583 */        if (Object2FloatOpenCustomHashMap.this.strategy.equals(Object2FloatOpenCustomHashMap.this.key[pos], k)) {
/* 584:584 */          Object2FloatOpenCustomHashMap.this.remove(e.getKey());
/* 585:585 */          return true;
/* 586:    */        }
/* 587:587 */        pos = pos + 1 & Object2FloatOpenCustomHashMap.this.mask;
/* 588:    */      }
/* 589:589 */      return false;
/* 590:    */    }
/* 591:    */    
/* 592:592 */    public int size() { return Object2FloatOpenCustomHashMap.this.size; }
/* 593:    */    
/* 595:595 */    public void clear() { Object2FloatOpenCustomHashMap.this.clear(); }
/* 596:    */  }
/* 597:    */  
/* 598:    */  public Object2FloatMap.FastEntrySet<K> object2FloatEntrySet() {
...
/* 606:    */    extends Object2FloatOpenCustomHashMap<K>.MapIterator
/* 607:    */    implements ObjectIterator<K>
/* 608:    */  {
/* 609:609 */    public KeyIterator() { super(null); }
/* 610:610 */    public K next() { return Object2FloatOpenCustomHashMap.this.key[nextEntry()]; } }
/* 611:    */  
/* 612:    */  private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/* 613:    */    
/* 614:614 */    public ObjectIterator<K> iterator() { return new Object2FloatOpenCustomHashMap.KeyIterator(Object2FloatOpenCustomHashMap.this); }
/* 615:    */    
/* 616:    */    public int size() {
/* 617:617 */      return Object2FloatOpenCustomHashMap.this.size;
/* 618:    */    }
/* 619:    */    
/* 620:620 */    public boolean contains(Object k) { return Object2FloatOpenCustomHashMap.this.containsKey(k); }
/* 621:    */    
/* 622:    */    public boolean remove(Object k) {
/* 623:623 */      int oldSize = Object2FloatOpenCustomHashMap.this.size;
/* 624:624 */      Object2FloatOpenCustomHashMap.this.remove(k);
/* 625:625 */      return Object2FloatOpenCustomHashMap.this.size != oldSize;
/* 626:    */    }
/* 627:    */    
/* 628:628 */    public void clear() { Object2FloatOpenCustomHashMap.this.clear(); }
/* 629:    */  }
/* 630:    */  
...
/* 639:    */    extends Object2FloatOpenCustomHashMap.MapIterator
/* 640:    */    implements FloatIterator
/* 641:    */  {
/* 642:642 */    public ValueIterator() { super(null); }
/* 643:643 */    public float nextFloat() { return Object2FloatOpenCustomHashMap.this.value[nextEntry()]; }
/* 644:644 */    public Float next() { return Float.valueOf(Object2FloatOpenCustomHashMap.this.value[nextEntry()]); }
/* 645:    */  }
/* 646:    */  
...
/* 649:649 */          return new Object2FloatOpenCustomHashMap.ValueIterator(Object2FloatOpenCustomHashMap.this);
/* 650:    */        }
/* 651:    */        
/* 652:652 */        public int size() { return Object2FloatOpenCustomHashMap.this.size; }
/* 653:    */        
/* 654:    */        public boolean contains(float v) {
/* 655:655 */          return Object2FloatOpenCustomHashMap.this.containsValue(v);
/* 656:    */        }
/* 657:    */        
/* 658:658 */        public void clear() { Object2FloatOpenCustomHashMap.this.clear(); }
/* 659:    */      };
/* 660:    */    }
...
/* 761:    */  }
/* 762:    */  
/* 766:    */  public Object2FloatOpenCustomHashMap<K> clone()
/* 767:    */  {
/* 768:    */    Object2FloatOpenCustomHashMap<K> c;
/* 769:    */    
/* 771:    */    try
/* 772:    */    {
/* 773:773 */      c = (Object2FloatOpenCustomHashMap)super.clone();
/* 774:    */    }
...
/* 811:811 */    Object2FloatOpenCustomHashMap<K>.MapIterator i = new MapIterator(null);
