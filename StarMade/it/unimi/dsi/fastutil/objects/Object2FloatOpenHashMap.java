...
/* 629 */           return new Object2FloatOpenHashMap.ValueIterator(Object2FloatOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 632 */           return Object2FloatOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(float v) {
/* 635 */           return Object2FloatOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 638 */           Object2FloatOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 753 */       c = (Object2FloatOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Object2FloatOpenHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 622 */       super(null); } 
/* 623 */     public float nextFloat() { return Object2FloatOpenHashMap.this.value[nextEntry()]; } 
/* 624 */     public Float next() { return Float.valueOf(Object2FloatOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 594 */       return new Object2FloatOpenHashMap.KeyIterator(Object2FloatOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 597 */       return Object2FloatOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 600 */       return Object2FloatOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 603 */       int oldSize = Object2FloatOpenHashMap.this.size;
/* 604 */       Object2FloatOpenHashMap.this.remove(k);
/* 605 */       return Object2FloatOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 608 */       Object2FloatOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Object2FloatOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 589 */       super(null); } 
/* 590 */     public K next() { return Object2FloatOpenHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 535 */       return new Object2FloatOpenHashMap.EntryIterator(Object2FloatOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Object2FloatMap.Entry<K>> fastIterator() {
/* 538 */       return new Object2FloatOpenHashMap.FastEntryIterator(Object2FloatOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 546 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2FloatOpenHashMap.this.mask;
/*     */ 
/* 548 */       while (Object2FloatOpenHashMap.this.used[pos] != 0) {
/* 549 */         if (Object2FloatOpenHashMap.this.key[pos] == null ? k == null : Object2FloatOpenHashMap.this.key[pos].equals(k)) return Object2FloatOpenHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 550 */         pos = pos + 1 & Object2FloatOpenHashMap.this.mask;
/*     */       }
/* 552 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 560 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2FloatOpenHashMap.this.mask;
/*     */ 
/* 562 */       while (Object2FloatOpenHashMap.this.used[pos] != 0) {
/* 563 */         if (Object2FloatOpenHashMap.this.key[pos] == null ? k == null : Object2FloatOpenHashMap.this.key[pos].equals(k)) {
/* 564 */           Object2FloatOpenHashMap.this.remove(e.getKey());
/* 565 */           return true;
/*     */         }
/* 567 */         pos = pos + 1 & Object2FloatOpenHashMap.this.mask;
/*     */       }
/* 569 */       return false;
/*     */     }
/*     */     public int size() {
/* 572 */       return Object2FloatOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 575 */       Object2FloatOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Object2FloatOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2FloatMap.Entry<K>>
/*     */   {
/* 525 */     final AbstractObject2FloatMap.BasicEntry<K> entry = new AbstractObject2FloatMap.BasicEntry(null, 0.0F);
/*     */ 
...
/* 527 */       int e = nextEntry();
/* 528 */       this.entry.key = Object2FloatOpenHashMap.this.key[e];
/* 529 */       this.entry.value = Object2FloatOpenHashMap.this.value[e];
/* 530 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Object2FloatOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2FloatMap.Entry<K>>
/*     */   {
...
/* 516 */       return this.entry = new Object2FloatOpenHashMap.MapEntry(Object2FloatOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 520 */       super.remove();
/* 521 */       Object2FloatOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 421 */       this.pos = Object2FloatOpenHashMap.this.n;
/*     */ 
/* 424 */       this.last = -1;
/*     */ 
/* 426 */       this.c = Object2FloatOpenHashMap.this.size;
/*     */ 
/* 431 */       boolean[] used = Object2FloatOpenHashMap.this.used;
...
/*     */ 
/* 444 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2FloatOpenHashMap.this.mask;
/*     */ 
/* 446 */         while (Object2FloatOpenHashMap.this.used[pos] != 0) {
/* 447 */           if (Object2FloatOpenHashMap.this.key[pos] == null ? k == null : Object2FloatOpenHashMap.this.key[pos].equals(k)) return pos;
/* 448 */           pos = pos + 1 & Object2FloatOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 451 */       this.last = this.pos;
/*     */ 
/* 453 */       if (this.c != 0) {
/* 454 */         boolean[] used = Object2FloatOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 471 */         pos = (last = pos) + 1 & Object2FloatOpenHashMap.this.mask;
/* 472 */         while (Object2FloatOpenHashMap.this.used[pos] != 0) {
/* 473 */           int slot = (Object2FloatOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2FloatOpenHashMap.this.key[pos].hashCode())) & Object2FloatOpenHashMap.this.mask;
/* 474 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 475 */           pos = pos + 1 & Object2FloatOpenHashMap.this.mask;
/*     */         }
/* 477 */         if (Object2FloatOpenHashMap.this.used[pos] == 0) break;
/* 478 */         if (pos < last)
/*     */         {
/* 480 */           if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 481 */           this.wrapped.add(Object2FloatOpenHashMap.this.key[pos]);
/*     */         }
/* 483 */         Object2FloatOpenHashMap.this.key[last] = Object2FloatOpenHashMap.this.key[pos];
/* 484 */         Object2FloatOpenHashMap.this.value[last] = Object2FloatOpenHashMap.this.value[pos];
/*     */       }
/* 486 */       Object2FloatOpenHashMap.this.used[last] = false;
/* 487 */       Object2FloatOpenHashMap.this.key[last] = null;
/* 488 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 493 */       if (this.pos < -1)
/*     */       {
/* 495 */         Object2FloatOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 496 */         this.last = -1;
/* 497 */         return;
/*     */       }
/* 499 */       Object2FloatOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 388 */       return Object2FloatOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Float getValue() {
/* 391 */       return Float.valueOf(Object2FloatOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public float getFloatValue() {
/* 394 */       return Object2FloatOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public float setValue(float v) {
/* 397 */       float oldValue = Object2FloatOpenHashMap.this.value[this.index];
/* 398 */       Object2FloatOpenHashMap.this.value[this.index] = v;
/* 399 */       return oldValue;
/*     */     }
/*     */     public Float setValue(Float v) {
...
/* 408 */       return (Object2FloatOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2FloatOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2FloatOpenHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */     public int hashCode() {
/* 411 */       return (Object2FloatOpenHashMap.this.key[this.index] == null ? 0 : Object2FloatOpenHashMap.this.key[this.index].hashCode()) ^ HashCommon.float2int(Object2FloatOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 414 */       return Object2FloatOpenHashMap.this.key[this.index] + "=>" + Object2FloatOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
