...
/*  13:    */
/*  84:    */public class Object2ObjectOpenHashMap<K, V>
/*  85:    */  extends AbstractObject2ObjectMap<K, V>
...
/*  98:    */  protected volatile transient Object2ObjectMap.FastEntrySet<K, V> entries;
/*  99:    */  protected volatile transient ObjectSet<K> keys;
/* 100:    */  protected volatile transient ObjectCollection<V> values;
/* 101:    */  
/* 102:    */  public Object2ObjectOpenHashMap(int expected, float f)
/* 103:    */  {
...
/* 113:    */  }
/* 114:    */  
/* 117:    */  public Object2ObjectOpenHashMap(int expected)
/* 118:    */  {
/* 119:119 */    this(expected, 0.75F);
/* 120:    */  }
/* 121:    */  
/* 123:    */  public Object2ObjectOpenHashMap()
/* 124:    */  {
/* 125:125 */    this(16, 0.75F);
/* 126:    */  }
/* 127:    */  
/* 131:    */  public Object2ObjectOpenHashMap(Map<? extends K, ? extends V> m, float f)
/* 132:    */  {
/* 133:133 */    this(m.size(), f);
/* 134:134 */    putAll(m);
/* 135:    */  }
/* 136:    */  
/* 139:    */  public Object2ObjectOpenHashMap(Map<? extends K, ? extends V> m)
/* 140:    */  {
/* 141:141 */    this(m, 0.75F);
/* 142:    */  }
/* 143:    */  
/* 147:    */  public Object2ObjectOpenHashMap(Object2ObjectMap<K, V> m, float f)
/* 148:    */  {
/* 149:149 */    this(m.size(), f);
/* 150:150 */    putAll(m);
/* 151:    */  }
/* 152:    */  
/* 155:    */  public Object2ObjectOpenHashMap(Object2ObjectMap<K, V> m)
/* 156:    */  {
/* 157:157 */    this(m, 0.75F);
/* 158:    */  }
/* 159:    */  
/* 165:    */  public Object2ObjectOpenHashMap(K[] k, V[] v, float f)
/* 166:    */  {
...
/* 171:    */  }
/* 172:    */  
/* 176:    */  public Object2ObjectOpenHashMap(K[] k, V[] v)
/* 177:    */  {
...
/* 311:    */    implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V>
/* 312:    */  {
...
/* 318:    */    }
/* 319:    */    
/* 320:320 */    public K getKey() { return Object2ObjectOpenHashMap.this.key[this.index]; }
/* 321:    */    
/* 323:323 */    public V getValue() { return Object2ObjectOpenHashMap.this.value[this.index]; }
/* 324:    */    
/* 325:    */    public V setValue(V v) {
/* 326:326 */      V oldValue = Object2ObjectOpenHashMap.this.value[this.index];
/* 327:327 */      Object2ObjectOpenHashMap.this.value[this.index] = v;
...
/* 334:334 */      return (Object2ObjectOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2ObjectOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Object2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
/* 335:    */    }
/* 336:    */    
/* 337:337 */    public int hashCode() { return (Object2ObjectOpenHashMap.this.key[this.index] == null ? 0 : Object2ObjectOpenHashMap.this.key[this.index].hashCode()) ^ (Object2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Object2ObjectOpenHashMap.this.value[this.index].hashCode()); }
/* 338:    */    
/* 340:340 */    public String toString() { return Object2ObjectOpenHashMap.this.key[this.index] + "=>" + Object2ObjectOpenHashMap.this.value[this.index]; } }
/* 341:    */  
...
/* 346:    */    
/* 347:347 */    private MapIterator() { this.pos = Object2ObjectOpenHashMap.this.n;
/* 348:    */      
/* 350:350 */      this.last = -1;
/* 351:    */      
/* 352:352 */      this.c = Object2ObjectOpenHashMap.this.size;
/* 353:    */      
/* 357:357 */      boolean[] used = Object2ObjectOpenHashMap.this.used;
...
/* 369:    */        
/* 370:370 */        int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ObjectOpenHashMap.this.mask;
/* 371:    */        
/* 372:372 */        while (Object2ObjectOpenHashMap.this.used[pos] != 0) {
/* 373:373 */          if (Object2ObjectOpenHashMap.this.key[pos] == null ? k == null : Object2ObjectOpenHashMap.this.key[pos].equals(k)) return pos;
/* 374:374 */          pos = pos + 1 & Object2ObjectOpenHashMap.this.mask;
/* 375:    */        }
/* 376:    */      }
/* 377:377 */      this.last = this.pos;
/* 378:    */      
/* 379:379 */      if (this.c != 0) {
/* 380:380 */        boolean[] used = Object2ObjectOpenHashMap.this.used;
...
/* 395:    */      for (;;)
/* 396:    */      {
/* 397:397 */        pos = (last = pos) + 1 & Object2ObjectOpenHashMap.this.mask;
/* 398:398 */        while (Object2ObjectOpenHashMap.this.used[pos] != 0) {
/* 399:399 */          int slot = (Object2ObjectOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ObjectOpenHashMap.this.key[pos].hashCode())) & Object2ObjectOpenHashMap.this.mask;
/* 400:400 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 401:401 */          pos = pos + 1 & Object2ObjectOpenHashMap.this.mask;
/* 402:    */        }
/* 403:403 */        if (Object2ObjectOpenHashMap.this.used[pos] == 0) break;
/* 404:404 */        if (pos < last)
/* 405:    */        {
/* 406:406 */          if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 407:407 */          this.wrapped.add(Object2ObjectOpenHashMap.this.key[pos]);
/* 408:    */        }
/* 409:409 */        Object2ObjectOpenHashMap.this.key[last] = Object2ObjectOpenHashMap.this.key[pos];
/* 410:410 */        Object2ObjectOpenHashMap.this.value[last] = Object2ObjectOpenHashMap.this.value[pos];
/* 411:    */      }
/* 412:412 */      Object2ObjectOpenHashMap.this.used[last] = false;
/* 413:413 */      Object2ObjectOpenHashMap.this.key[last] = null;
/* 414:414 */      Object2ObjectOpenHashMap.this.value[last] = null;
/* 415:415 */      return last;
/* 416:    */    }
/* 417:    */    
...
/* 421:    */      {
/* 422:422 */        Object2ObjectOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 423:423 */        this.last = -1;
/* 424:424 */        return;
/* 425:    */      }
/* 426:426 */      Object2ObjectOpenHashMap.this.size -= 1;
...
/* 438:    */    } }
/* 439:    */  
/* 440:440 */  private class EntryIterator extends Object2ObjectOpenHashMap<K, V>.MapIterator implements ObjectIterator<Object2ObjectMap.Entry<K, V>> { private EntryIterator() { super(null); }
/* 441:    */    
/* 442:    */    private Object2ObjectOpenHashMap<K, V>.MapEntry entry;
/* 443:443 */    public Object2ObjectMap.Entry<K, V> next() { return this.entry = new Object2ObjectOpenHashMap.MapEntry(Object2ObjectOpenHashMap.this, nextEntry()); }
/* 444:    */    
/* 445:    */    public void remove()
/* 446:    */    {
/* 447:447 */      super.remove();
/* 448:448 */      Object2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 449:    */    } }
/* 450:    */  
/* 451:451 */  private class FastEntryIterator extends Object2ObjectOpenHashMap<K, V>.MapIterator implements ObjectIterator<Object2ObjectMap.Entry<K, V>> { private FastEntryIterator() { super(null); }
/* 452:452 */    final AbstractObject2ObjectMap.BasicEntry<K, V> entry = new AbstractObject2ObjectMap.BasicEntry(null, null);
/* 453:    */    
/* 454:454 */    public AbstractObject2ObjectMap.BasicEntry<K, V> next() { int e = nextEntry();
/* 455:455 */      this.entry.key = Object2ObjectOpenHashMap.this.key[e];
/* 456:456 */      this.entry.value = Object2ObjectOpenHashMap.this.value[e];
/* 457:457 */      return this.entry;
/* 458:    */    } }
/* 459:    */  
/* 460:    */  private final class MapEntrySet extends AbstractObjectSet<Object2ObjectMap.Entry<K, V>> implements Object2ObjectMap.FastEntrySet<K, V> { private MapEntrySet() {}
/* 461:    */    
/* 462:462 */    public ObjectIterator<Object2ObjectMap.Entry<K, V>> iterator() { return new Object2ObjectOpenHashMap.EntryIterator(Object2ObjectOpenHashMap.this, null); }
/* 463:    */    
/* 464:    */    public ObjectIterator<Object2ObjectMap.Entry<K, V>> fastIterator() {
/* 465:465 */      return new Object2ObjectOpenHashMap.FastEntryIterator(Object2ObjectOpenHashMap.this, null);
/* 466:    */    }
/* 467:    */    
...
/* 472:    */      
/* 473:473 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ObjectOpenHashMap.this.mask;
/* 474:    */      
/* 475:475 */      while (Object2ObjectOpenHashMap.this.used[pos] != 0) {
/* 476:476 */        if (Object2ObjectOpenHashMap.this.key[pos] == null ? k == null : Object2ObjectOpenHashMap.this.key[pos].equals(k)) return Object2ObjectOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Object2ObjectOpenHashMap.this.value[pos].equals(e.getValue());
/* 477:477 */        pos = pos + 1 & Object2ObjectOpenHashMap.this.mask;
/* 478:    */      }
...
/* 486:    */      
/* 487:487 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ObjectOpenHashMap.this.mask;
/* 488:    */      
/* 489:489 */      while (Object2ObjectOpenHashMap.this.used[pos] != 0) {
/* 490:490 */        if (Object2ObjectOpenHashMap.this.key[pos] == null ? k == null : Object2ObjectOpenHashMap.this.key[pos].equals(k)) {
/* 491:491 */          Object2ObjectOpenHashMap.this.remove(e.getKey());
/* 492:492 */          return true;
/* 493:    */        }
/* 494:494 */        pos = pos + 1 & Object2ObjectOpenHashMap.this.mask;
/* 495:    */      }
/* 496:496 */      return false;
/* 497:    */    }
/* 498:    */    
/* 499:499 */    public int size() { return Object2ObjectOpenHashMap.this.size; }
/* 500:    */    
/* 502:502 */    public void clear() { Object2ObjectOpenHashMap.this.clear(); }
/* 503:    */  }
/* 504:    */  
/* 505:    */  public Object2ObjectMap.FastEntrySet<K, V> object2ObjectEntrySet() {
...
/* 513:    */    extends Object2ObjectOpenHashMap<K, V>.MapIterator
/* 514:    */    implements ObjectIterator<K>
/* 515:    */  {
/* 516:516 */    public KeyIterator() { super(null); }
/* 517:517 */    public K next() { return Object2ObjectOpenHashMap.this.key[nextEntry()]; } }
/* 518:    */  
/* 519:    */  private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/* 520:    */    
/* 521:521 */    public ObjectIterator<K> iterator() { return new Object2ObjectOpenHashMap.KeyIterator(Object2ObjectOpenHashMap.this); }
/* 522:    */    
/* 523:    */    public int size() {
/* 524:524 */      return Object2ObjectOpenHashMap.this.size;
/* 525:    */    }
/* 526:    */    
/* 527:527 */    public boolean contains(Object k) { return Object2ObjectOpenHashMap.this.containsKey(k); }
/* 528:    */    
/* 529:    */    public boolean remove(Object k) {
/* 530:530 */      int oldSize = Object2ObjectOpenHashMap.this.size;
/* 531:531 */      Object2ObjectOpenHashMap.this.remove(k);
/* 532:532 */      return Object2ObjectOpenHashMap.this.size != oldSize;
/* 533:    */    }
/* 534:    */    
/* 535:535 */    public void clear() { Object2ObjectOpenHashMap.this.clear(); }
/* 536:    */  }
/* 537:    */  
...
/* 546:    */    extends Object2ObjectOpenHashMap<K, V>.MapIterator
/* 547:    */    implements ObjectIterator<V>
/* 548:    */  {
/* 549:549 */    public ValueIterator() { super(null); }
/* 550:550 */    public V next() { return Object2ObjectOpenHashMap.this.value[nextEntry()]; }
/* 551:    */  }
/* 552:    */  
...
/* 555:555 */          return new Object2ObjectOpenHashMap.ValueIterator(Object2ObjectOpenHashMap.this);
/* 556:    */        }
/* 557:    */        
/* 558:558 */        public int size() { return Object2ObjectOpenHashMap.this.size; }
/* 559:    */        
/* 560:    */        public boolean contains(Object v) {
/* 561:561 */          return Object2ObjectOpenHashMap.this.containsValue(v);
/* 562:    */        }
/* 563:    */        
/* 564:564 */        public void clear() { Object2ObjectOpenHashMap.this.clear(); }
/* 565:    */      };
/* 566:    */    }
...
/* 667:    */  }
/* 668:    */  
/* 672:    */  public Object2ObjectOpenHashMap<K, V> clone()
/* 673:    */  {
/* 674:    */    Object2ObjectOpenHashMap<K, V> c;
/* 675:    */    
/* 677:    */    try
/* 678:    */    {
/* 679:679 */      c = (Object2ObjectOpenHashMap)super.clone();
/* 680:    */    }
...
/* 717:717 */    Object2ObjectOpenHashMap<K, V>.MapIterator i = new MapIterator(null);
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.Object2ObjectOpenHashMap
