  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2ObjectOpenHashMap(int expected, float local_f)
  {
  ...
  public Object2ObjectOpenHashMap(Map<? extends K, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ObjectOpenHashMap(Map<? extends K, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ObjectOpenHashMap(Object2ObjectMap<K, V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ObjectOpenHashMap(Object2ObjectMap<K, V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ObjectOpenHashMap(K[] local_k, V[] local_v, float local_f)
  {
  ...
  public Object2ObjectOpenHashMap(K[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Object2ObjectOpenHashMap.ValueIterator(Object2ObjectOpenHashMap.this);
        }
        ...
        {
          return Object2ObjectOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2ObjectOpenHashMap<K, V> local_c;
    try
    {
      local_c = (Object2ObjectOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    V[] value = this.value;
    Object2ObjectOpenHashMap<K, V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractObjectSet<K>
  {
    ...
    {
      return new Object2ObjectOpenHashMap.KeyIterator(Object2ObjectOpenHashMap.this);
    }
    ...
    {
      return Object2ObjectOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2ObjectOpenHashMap.this.size;
      Object2ObjectOpenHashMap.this.remove(local_k);
    ...
    implements Object2ObjectMap.FastEntrySet<K, V>
  {
    ...
    {
      return new Object2ObjectOpenHashMap.EntryIterator(Object2ObjectOpenHashMap.this, null);
    }
    
    public ObjectIterator<Object2ObjectMap.Entry<K, V>> fastIterator()
    {
      return new Object2ObjectOpenHashMap.FastEntryIterator(Object2ObjectOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ObjectOpenHashMap.this.mask; Object2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectOpenHashMap.this.mask) {
        if (Object2ObjectOpenHashMap.this.key[pos] == null ? local_k == null : Object2ObjectOpenHashMap.this.key[pos].equals(local_k)) {
          return Object2ObjectOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Object2ObjectOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ObjectOpenHashMap.this.mask; Object2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectOpenHashMap.this.mask) {
        if (Object2ObjectOpenHashMap.this.key[pos] == null ? local_k == null : Object2ObjectOpenHashMap.this.key[pos].equals(local_k))
        {
          Object2ObjectOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Object2ObjectMap.Entry<K, V>>
  {
    ...
    public AbstractObject2ObjectMap.BasicEntry<K, V> next()
    {
      ...
      this.entry.key = Object2ObjectOpenHashMap.this.key[local_e];
      this.entry.value = Object2ObjectOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Object2ObjectMap.Entry<K, V>>
  {
    ...
    {
      return this.entry = new Object2ObjectOpenHashMap.MapEntry(Object2ObjectOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Object2ObjectOpenHashMap.this.field_49;
    int last = -1;
    int field_2073 = Object2ObjectOpenHashMap.this.size;
    ObjectArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Object2ObjectOpenHashMap.this.used;
      while ((this.field_2073 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2073 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Object2ObjectOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2ObjectOpenHashMap.this.mask; Object2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectOpenHashMap.this.mask)
        {
          int slot = (Object2ObjectOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ObjectOpenHashMap.this.key[pos].hashCode())) & Object2ObjectOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2ObjectOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Object2ObjectOpenHashMap.this.key[pos]);
        }
        Object2ObjectOpenHashMap.this.key[last] = Object2ObjectOpenHashMap.this.key[pos];
        Object2ObjectOpenHashMap.this.value[last] = Object2ObjectOpenHashMap.this.value[pos];
      }
      Object2ObjectOpenHashMap.this.used[last] = false;
      Object2ObjectOpenHashMap.this.key[last] = null;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Object2ObjectOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
        this.last = -1;
        return;
      }
      Object2ObjectOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2073 > 0))
      {
        this.field_2073 += 1;
        nextEntry();
      }
    ...
    implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Object2ObjectOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, V> local_e = (Map.Entry)local_o;
      return (Object2ObjectOpenHashMap.this.key[this.index] == null ? local_e.getKey() == null : Object2ObjectOpenHashMap.this.key[this.index].equals(local_e.getKey())) && (Object2ObjectOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Object2ObjectOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
