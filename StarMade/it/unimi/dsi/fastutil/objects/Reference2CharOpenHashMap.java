...
/*  16:    */
/*  86:    */public class Reference2CharOpenHashMap<K>
/*  87:    */  extends AbstractReference2CharMap<K>
...
/*  93:    */  protected transient char[] value;
...
/* 100:    */  protected volatile transient Reference2CharMap.FastEntrySet<K> entries;
/* 101:    */  protected volatile transient ReferenceSet<K> keys;
/* 102:    */  protected volatile transient CharCollection values;
/* 103:    */  
/* 104:    */  public Reference2CharOpenHashMap(int expected, float f)
/* 105:    */  {
...
/* 113:113 */    this.value = new char[this.n];
/* 114:114 */    this.used = new boolean[this.n];
/* 115:    */  }
/* 116:    */  
/* 119:    */  public Reference2CharOpenHashMap(int expected)
/* 120:    */  {
/* 121:121 */    this(expected, 0.75F);
/* 122:    */  }
/* 123:    */  
/* 125:    */  public Reference2CharOpenHashMap()
/* 126:    */  {
/* 127:127 */    this(16, 0.75F);
/* 128:    */  }
/* 129:    */  
/* 133:    */  public Reference2CharOpenHashMap(Map<? extends K, ? extends Character> m, float f)
/* 134:    */  {
/* 135:135 */    this(m.size(), f);
/* 136:136 */    putAll(m);
/* 137:    */  }
/* 138:    */  
/* 141:    */  public Reference2CharOpenHashMap(Map<? extends K, ? extends Character> m)
/* 142:    */  {
/* 143:143 */    this(m, 0.75F);
/* 144:    */  }
/* 145:    */  
/* 149:    */  public Reference2CharOpenHashMap(Reference2CharMap<K> m, float f)
/* 150:    */  {
/* 151:151 */    this(m.size(), f);
/* 152:152 */    putAll(m);
/* 153:    */  }
/* 154:    */  
/* 157:    */  public Reference2CharOpenHashMap(Reference2CharMap<K> m)
/* 158:    */  {
/* 159:159 */    this(m, 0.75F);
/* 160:    */  }
/* 161:    */  
/* 167:    */  public Reference2CharOpenHashMap(K[] k, char[] v, float f)
/* 168:    */  {
...
/* 173:    */  }
/* 174:    */  
/* 178:    */  public Reference2CharOpenHashMap(K[] k, char[] v)
/* 179:    */  {
/* 180:180 */    this(k, v, 0.75F);
/* 181:    */  }
/* 182:    */  
/* 186:    */  public char put(K k, char v)
/* 187:    */  {
...
/* 192:192 */        char oldValue = this.value[pos];
...
/* 204:    */  }
/* 205:    */  
/* 206:206 */  public Character put(K ok, Character ov) { char v = ov.charValue();
/* 207:207 */    K k = ok;
/* 208:    */    
...
/* 213:213 */        Character oldValue = Character.valueOf(this.value[pos]);
...
/* 249:    */  }
/* 250:    */  
/* 251:    */  public char removeChar(Object k)
/* 252:    */  {
...
/* 282:    */  }
/* 283:    */  
/* 284:    */  public char getChar(Object k)
/* 285:    */  {
...
/* 304:    */  }
/* 305:    */  
/* 306:306 */  public boolean containsValue(char v) { char[] value = this.value;
...
/* 349:    */    implements Reference2CharMap.Entry<K>, Map.Entry<K, Character>
/* 350:    */  {
...
/* 356:    */    }
/* 357:    */    
/* 358:358 */    public K getKey() { return Reference2CharOpenHashMap.this.key[this.index]; }
/* 359:    */    
/* 360:    */    public Character getValue() {
/* 361:361 */      return Character.valueOf(Reference2CharOpenHashMap.this.value[this.index]);
/* 362:    */    }
/* 363:    */    
/* 364:364 */    public char getCharValue() { return Reference2CharOpenHashMap.this.value[this.index]; }
/* 365:    */    
/* 366:    */    public char setValue(char v) {
/* 367:367 */      char oldValue = Reference2CharOpenHashMap.this.value[this.index];
/* 368:368 */      Reference2CharOpenHashMap.this.value[this.index] = v;
/* 369:369 */      return oldValue;
/* 370:    */    }
/* 371:    */    
/* 372:372 */    public Character setValue(Character v) { return Character.valueOf(setValue(v.charValue())); }
/* 373:    */    
/* 374:    */    public boolean equals(Object o)
/* 375:    */    {
/* 376:376 */      if (!(o instanceof Map.Entry)) return false;
/* 377:377 */      Map.Entry<K, Character> e = (Map.Entry)o;
/* 378:378 */      return (Reference2CharOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 379:    */    }
/* 380:    */    
/* 381:381 */    public int hashCode() { return (Reference2CharOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2CharOpenHashMap.this.key[this.index])) ^ Reference2CharOpenHashMap.this.value[this.index]; }
/* 382:    */    
/* 384:384 */    public String toString() { return Reference2CharOpenHashMap.this.key[this.index] + "=>" + Reference2CharOpenHashMap.this.value[this.index]; } }
/* 385:    */  
...
/* 390:    */    
/* 391:391 */    private MapIterator() { this.pos = Reference2CharOpenHashMap.this.n;
/* 392:    */      
/* 394:394 */      this.last = -1;
/* 395:    */      
/* 396:396 */      this.c = Reference2CharOpenHashMap.this.size;
/* 397:    */      
/* 401:401 */      boolean[] used = Reference2CharOpenHashMap.this.used;
...
/* 413:    */        
/* 414:414 */        int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2CharOpenHashMap.this.mask;
/* 415:    */        
/* 416:416 */        while (Reference2CharOpenHashMap.this.used[pos] != 0) {
/* 417:417 */          if (Reference2CharOpenHashMap.this.key[pos] == k) return pos;
/* 418:418 */          pos = pos + 1 & Reference2CharOpenHashMap.this.mask;
/* 419:    */        }
/* 420:    */      }
/* 421:421 */      this.last = this.pos;
/* 422:    */      
/* 423:423 */      if (this.c != 0) {
/* 424:424 */        boolean[] used = Reference2CharOpenHashMap.this.used;
...
/* 439:    */      for (;;)
/* 440:    */      {
/* 441:441 */        pos = (last = pos) + 1 & Reference2CharOpenHashMap.this.mask;
/* 442:442 */        while (Reference2CharOpenHashMap.this.used[pos] != 0) {
/* 443:443 */          int slot = (Reference2CharOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2CharOpenHashMap.this.key[pos]))) & Reference2CharOpenHashMap.this.mask;
/* 444:444 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 445:445 */          pos = pos + 1 & Reference2CharOpenHashMap.this.mask;
/* 446:    */        }
/* 447:447 */        if (Reference2CharOpenHashMap.this.used[pos] == 0) break;
/* 448:448 */        if (pos < last)
/* 449:    */        {
/* 450:450 */          if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 451:451 */          this.wrapped.add(Reference2CharOpenHashMap.this.key[pos]);
/* 452:    */        }
/* 453:453 */        Reference2CharOpenHashMap.this.key[last] = Reference2CharOpenHashMap.this.key[pos];
/* 454:454 */        Reference2CharOpenHashMap.this.value[last] = Reference2CharOpenHashMap.this.value[pos];
/* 455:    */      }
/* 456:456 */      Reference2CharOpenHashMap.this.used[last] = false;
/* 457:457 */      Reference2CharOpenHashMap.this.key[last] = null;
/* 458:458 */      return last;
/* 459:    */    }
/* 460:    */    
...
/* 464:    */      {
/* 465:465 */        Reference2CharOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 466:466 */        this.last = -1;
/* 467:467 */        return;
/* 468:    */      }
/* 469:469 */      Reference2CharOpenHashMap.this.size -= 1;
...
/* 481:    */    } }
/* 482:    */  
/* 483:483 */  private class EntryIterator extends Reference2CharOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2CharMap.Entry<K>> { private EntryIterator() { super(null); }
/* 484:    */    
/* 485:    */    private Reference2CharOpenHashMap<K>.MapEntry entry;
/* 486:486 */    public Reference2CharMap.Entry<K> next() { return this.entry = new Reference2CharOpenHashMap.MapEntry(Reference2CharOpenHashMap.this, nextEntry()); }
/* 487:    */    
/* 488:    */    public void remove()
/* 489:    */    {
/* 490:490 */      super.remove();
/* 491:491 */      Reference2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 492:    */    } }
/* 493:    */  
/* 494:494 */  private class FastEntryIterator extends Reference2CharOpenHashMap<K>.MapIterator implements ObjectIterator<Reference2CharMap.Entry<K>> { private FastEntryIterator() { super(null); }
/* 495:495 */    final AbstractReference2CharMap.BasicEntry<K> entry = new AbstractReference2CharMap.BasicEntry(null, '\000');
/* 496:    */    
/* 497:497 */    public AbstractReference2CharMap.BasicEntry<K> next() { int e = nextEntry();
/* 498:498 */      this.entry.key = Reference2CharOpenHashMap.this.key[e];
/* 499:499 */      this.entry.value = Reference2CharOpenHashMap.this.value[e];
/* 500:500 */      return this.entry;
/* 501:    */    } }
/* 502:    */  
/* 503:    */  private final class MapEntrySet extends AbstractObjectSet<Reference2CharMap.Entry<K>> implements Reference2CharMap.FastEntrySet<K> { private MapEntrySet() {}
/* 504:    */    
/* 505:505 */    public ObjectIterator<Reference2CharMap.Entry<K>> iterator() { return new Reference2CharOpenHashMap.EntryIterator(Reference2CharOpenHashMap.this, null); }
/* 506:    */    
/* 507:    */    public ObjectIterator<Reference2CharMap.Entry<K>> fastIterator() {
/* 508:508 */      return new Reference2CharOpenHashMap.FastEntryIterator(Reference2CharOpenHashMap.this, null);
/* 509:    */    }
/* 510:    */    
/* 511:    */    public boolean contains(Object o) {
/* 512:512 */      if (!(o instanceof Map.Entry)) return false;
/* 513:513 */      Map.Entry<K, Character> e = (Map.Entry)o;
/* 514:514 */      K k = e.getKey();
/* 515:    */      
/* 516:516 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2CharOpenHashMap.this.mask;
/* 517:    */      
/* 518:518 */      while (Reference2CharOpenHashMap.this.used[pos] != 0) {
/* 519:519 */        if (Reference2CharOpenHashMap.this.key[pos] == k) return Reference2CharOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 520:520 */        pos = pos + 1 & Reference2CharOpenHashMap.this.mask;
/* 521:    */      }
...
/* 527:527 */      Map.Entry<K, Character> e = (Map.Entry)o;
/* 528:528 */      K k = e.getKey();
/* 529:    */      
/* 530:530 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2CharOpenHashMap.this.mask;
/* 531:    */      
/* 532:532 */      while (Reference2CharOpenHashMap.this.used[pos] != 0) {
/* 533:533 */        if (Reference2CharOpenHashMap.this.key[pos] == k) {
/* 534:534 */          Reference2CharOpenHashMap.this.remove(e.getKey());
/* 535:535 */          return true;
/* 536:    */        }
/* 537:537 */        pos = pos + 1 & Reference2CharOpenHashMap.this.mask;
/* 538:    */      }
/* 539:539 */      return false;
/* 540:    */    }
/* 541:    */    
/* 542:542 */    public int size() { return Reference2CharOpenHashMap.this.size; }
/* 543:    */    
/* 545:545 */    public void clear() { Reference2CharOpenHashMap.this.clear(); }
/* 546:    */  }
/* 547:    */  
/* 548:    */  public Reference2CharMap.FastEntrySet<K> reference2CharEntrySet() {
...
/* 556:    */    extends Reference2CharOpenHashMap<K>.MapIterator
/* 557:    */    implements ObjectIterator<K>
/* 558:    */  {
/* 559:559 */    public KeyIterator() { super(null); }
/* 560:560 */    public K next() { return Reference2CharOpenHashMap.this.key[nextEntry()]; } }
/* 561:    */  
/* 562:    */  private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/* 563:    */    
/* 564:564 */    public ObjectIterator<K> iterator() { return new Reference2CharOpenHashMap.KeyIterator(Reference2CharOpenHashMap.this); }
/* 565:    */    
/* 566:    */    public int size() {
/* 567:567 */      return Reference2CharOpenHashMap.this.size;
/* 568:    */    }
/* 569:    */    
/* 570:570 */    public boolean contains(Object k) { return Reference2CharOpenHashMap.this.containsKey(k); }
/* 571:    */    
/* 572:    */    public boolean remove(Object k) {
/* 573:573 */      int oldSize = Reference2CharOpenHashMap.this.size;
/* 574:574 */      Reference2CharOpenHashMap.this.remove(k);
/* 575:575 */      return Reference2CharOpenHashMap.this.size != oldSize;
/* 576:    */    }
/* 577:    */    
/* 578:578 */    public void clear() { Reference2CharOpenHashMap.this.clear(); }
/* 579:    */  }
/* 580:    */  
...
/* 589:    */    extends Reference2CharOpenHashMap.MapIterator
/* 590:    */    implements CharIterator
/* 591:    */  {
/* 592:592 */    public ValueIterator() { super(null); }
/* 593:593 */    public char nextChar() { return Reference2CharOpenHashMap.this.value[nextEntry()]; }
/* 594:594 */    public Character next() { return Character.valueOf(Reference2CharOpenHashMap.this.value[nextEntry()]); }
/* 595:    */  }
/* 596:    */  
/* 597:597 */  public CharCollection values() { if (this.values == null) { this.values = new AbstractCharCollection() {
/* 598:    */        public CharIterator iterator() {
/* 599:599 */          return new Reference2CharOpenHashMap.ValueIterator(Reference2CharOpenHashMap.this);
/* 600:    */        }
/* 601:    */        
/* 602:602 */        public int size() { return Reference2CharOpenHashMap.this.size; }
/* 603:    */        
/* 604:    */        public boolean contains(char v) {
/* 605:605 */          return Reference2CharOpenHashMap.this.containsValue(v);
/* 606:    */        }
/* 607:    */        
/* 608:608 */        public void clear() { Reference2CharOpenHashMap.this.clear(); }
/* 609:    */      };
/* 610:    */    }
...
/* 711:    */  }
/* 712:    */  
/* 716:    */  public Reference2CharOpenHashMap<K> clone()
/* 717:    */  {
/* 718:    */    Reference2CharOpenHashMap<K> c;
/* 719:    */    
/* 721:    */    try
/* 722:    */    {
/* 723:723 */      c = (Reference2CharOpenHashMap)super.clone();
/* 724:    */    }
...
/* 732:732 */    c.value = ((char[])this.value.clone());
...
/* 759:759 */    char[] value = this.value;
/* 760:760 */    Reference2CharOpenHashMap<K>.MapIterator i = new MapIterator(null);
/* 761:761 */    s.defaultWriteObject();
/* 762:762 */    for (int j = this.size; j-- != 0;) {
/* 763:763 */      int e = i.nextEntry();
/* 764:764 */      s.writeObject(key[e]);
/* 765:765 */      s.writeChar(value[e]);
/* 766:    */    }
/* 767:    */  }
/* 768:    */  
