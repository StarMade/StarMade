  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2CharOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2CharOpenHashMap(Map<? extends K, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2CharOpenHashMap(Map<? extends K, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2CharOpenHashMap(Reference2CharMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2CharOpenHashMap(Reference2CharMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2CharOpenHashMap(K[] local_k, char[] local_v, float local_f)
  {
  ...
  public Reference2CharOpenHashMap(K[] local_k, char[] local_v)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Reference2CharOpenHashMap.ValueIterator(Reference2CharOpenHashMap.this);
        }
        ...
        {
          return Reference2CharOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2CharOpenHashMap<K> local_c;
    try
    {
      local_c = (Reference2CharOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    char[] value = this.value;
    Reference2CharOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Reference2CharOpenHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Reference2CharOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractReferenceSet<K>
  {
    ...
    {
      return new Reference2CharOpenHashMap.KeyIterator(Reference2CharOpenHashMap.this);
    }
    ...
    {
      return Reference2CharOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2CharOpenHashMap.this.size;
      Reference2CharOpenHashMap.this.remove(local_k);
    ...
    implements Reference2CharMap.FastEntrySet<K>
  {
    ...
    {
      return new Reference2CharOpenHashMap.EntryIterator(Reference2CharOpenHashMap.this, null);
    }
    
    public ObjectIterator<Reference2CharMap.Entry<K>> fastIterator()
    {
      return new Reference2CharOpenHashMap.FastEntryIterator(Reference2CharOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2CharOpenHashMap.this.mask; Reference2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2CharOpenHashMap.this.mask) {
        if (Reference2CharOpenHashMap.this.key[pos] == local_k) {
          return Reference2CharOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2CharOpenHashMap.this.mask; Reference2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2CharOpenHashMap.this.mask) {
        if (Reference2CharOpenHashMap.this.key[pos] == local_k)
        {
          Reference2CharOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Reference2CharMap.Entry<K>>
  {
    ...
    public AbstractReference2CharMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Reference2CharOpenHashMap.this.key[local_e];
      this.entry.value = Reference2CharOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Reference2CharMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Reference2CharOpenHashMap.MapEntry(Reference2CharOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Reference2CharOpenHashMap.this.field_49;
    int last = -1;
    int field_2232 = Reference2CharOpenHashMap.this.size;
    ReferenceArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Reference2CharOpenHashMap.this.used;
      while ((this.field_2232 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2232 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2232 != 0)
      {
        boolean[] local_k = Reference2CharOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2CharOpenHashMap.this.mask; Reference2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2CharOpenHashMap.this.mask)
        {
          int slot = (Reference2CharOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2CharOpenHashMap.this.key[pos]))) & Reference2CharOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Reference2CharOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Reference2CharOpenHashMap.this.key[pos]);
        }
        Reference2CharOpenHashMap.this.key[last] = Reference2CharOpenHashMap.this.key[pos];
        Reference2CharOpenHashMap.this.value[last] = Reference2CharOpenHashMap.this.value[pos];
      }
      Reference2CharOpenHashMap.this.used[last] = false;
      Reference2CharOpenHashMap.this.key[last] = null;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Reference2CharOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
        this.last = -1;
        return;
      }
      Reference2CharOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2232 > 0))
      {
        this.field_2232 += 1;
        nextEntry();
      }
    ...
    implements Reference2CharMap.Entry<K>, Map.Entry<K, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Reference2CharOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Character> local_e = (Map.Entry)local_o;
      return (Reference2CharOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2CharOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
