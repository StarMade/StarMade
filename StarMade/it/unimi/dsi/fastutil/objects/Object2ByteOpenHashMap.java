...
/* 629 */           return new Object2ByteOpenHashMap.ValueIterator(Object2ByteOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 632 */           return Object2ByteOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(byte v) {
/* 635 */           return Object2ByteOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 638 */           Object2ByteOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 753 */       c = (Object2ByteOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Object2ByteOpenHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 622 */       super(null); } 
/* 623 */     public byte nextByte() { return Object2ByteOpenHashMap.this.value[nextEntry()]; } 
/* 624 */     public Byte next() { return Byte.valueOf(Object2ByteOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 594 */       return new Object2ByteOpenHashMap.KeyIterator(Object2ByteOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 597 */       return Object2ByteOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 600 */       return Object2ByteOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 603 */       int oldSize = Object2ByteOpenHashMap.this.size;
/* 604 */       Object2ByteOpenHashMap.this.remove(k);
/* 605 */       return Object2ByteOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 608 */       Object2ByteOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Object2ByteOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 589 */       super(null); } 
/* 590 */     public K next() { return Object2ByteOpenHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 535 */       return new Object2ByteOpenHashMap.EntryIterator(Object2ByteOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Object2ByteMap.Entry<K>> fastIterator() {
/* 538 */       return new Object2ByteOpenHashMap.FastEntryIterator(Object2ByteOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 546 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ByteOpenHashMap.this.mask;
/*     */ 
/* 548 */       while (Object2ByteOpenHashMap.this.used[pos] != 0) {
/* 549 */         if (Object2ByteOpenHashMap.this.key[pos] == null ? k == null : Object2ByteOpenHashMap.this.key[pos].equals(k)) return Object2ByteOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 550 */         pos = pos + 1 & Object2ByteOpenHashMap.this.mask;
/*     */       }
/* 552 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 560 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ByteOpenHashMap.this.mask;
/*     */ 
/* 562 */       while (Object2ByteOpenHashMap.this.used[pos] != 0) {
/* 563 */         if (Object2ByteOpenHashMap.this.key[pos] == null ? k == null : Object2ByteOpenHashMap.this.key[pos].equals(k)) {
/* 564 */           Object2ByteOpenHashMap.this.remove(e.getKey());
/* 565 */           return true;
/*     */         }
/* 567 */         pos = pos + 1 & Object2ByteOpenHashMap.this.mask;
/*     */       }
/* 569 */       return false;
/*     */     }
/*     */     public int size() {
/* 572 */       return Object2ByteOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 575 */       Object2ByteOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Object2ByteOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2ByteMap.Entry<K>>
/*     */   {
/* 525 */     final AbstractObject2ByteMap.BasicEntry<K> entry = new AbstractObject2ByteMap.BasicEntry(null, (byte)0);
/*     */ 
...
/* 527 */       int e = nextEntry();
/* 528 */       this.entry.key = Object2ByteOpenHashMap.this.key[e];
/* 529 */       this.entry.value = Object2ByteOpenHashMap.this.value[e];
/* 530 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Object2ByteOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2ByteMap.Entry<K>>
/*     */   {
...
/* 516 */       return this.entry = new Object2ByteOpenHashMap.MapEntry(Object2ByteOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 520 */       super.remove();
/* 521 */       Object2ByteOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 421 */       this.pos = Object2ByteOpenHashMap.this.n;
/*     */ 
/* 424 */       this.last = -1;
/*     */ 
/* 426 */       this.c = Object2ByteOpenHashMap.this.size;
/*     */ 
/* 431 */       boolean[] used = Object2ByteOpenHashMap.this.used;
...
/*     */ 
/* 444 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ByteOpenHashMap.this.mask;
/*     */ 
/* 446 */         while (Object2ByteOpenHashMap.this.used[pos] != 0) {
/* 447 */           if (Object2ByteOpenHashMap.this.key[pos] == null ? k == null : Object2ByteOpenHashMap.this.key[pos].equals(k)) return pos;
/* 448 */           pos = pos + 1 & Object2ByteOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 451 */       this.last = this.pos;
/*     */ 
/* 453 */       if (this.c != 0) {
/* 454 */         boolean[] used = Object2ByteOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 471 */         pos = (last = pos) + 1 & Object2ByteOpenHashMap.this.mask;
/* 472 */         while (Object2ByteOpenHashMap.this.used[pos] != 0) {
/* 473 */           int slot = (Object2ByteOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ByteOpenHashMap.this.key[pos].hashCode())) & Object2ByteOpenHashMap.this.mask;
/* 474 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 475 */           pos = pos + 1 & Object2ByteOpenHashMap.this.mask;
/*     */         }
/* 477 */         if (Object2ByteOpenHashMap.this.used[pos] == 0) break;
/* 478 */         if (pos < last)
/*     */         {
/* 480 */           if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 481 */           this.wrapped.add(Object2ByteOpenHashMap.this.key[pos]);
/*     */         }
/* 483 */         Object2ByteOpenHashMap.this.key[last] = Object2ByteOpenHashMap.this.key[pos];
/* 484 */         Object2ByteOpenHashMap.this.value[last] = Object2ByteOpenHashMap.this.value[pos];
/*     */       }
/* 486 */       Object2ByteOpenHashMap.this.used[last] = false;
/* 487 */       Object2ByteOpenHashMap.this.key[last] = null;
/* 488 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 493 */       if (this.pos < -1)
/*     */       {
/* 495 */         Object2ByteOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 496 */         this.last = -1;
/* 497 */         return;
/*     */       }
/* 499 */       Object2ByteOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 388 */       return Object2ByteOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Byte getValue() {
/* 391 */       return Byte.valueOf(Object2ByteOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public byte getByteValue() {
/* 394 */       return Object2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public byte setValue(byte v) {
/* 397 */       byte oldValue = Object2ByteOpenHashMap.this.value[this.index];
/* 398 */       Object2ByteOpenHashMap.this.value[this.index] = v;
/* 399 */       return oldValue;
/*     */     }
/*     */     public Byte setValue(Byte v) {
...
/* 408 */       return (Object2ByteOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2ByteOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */     public int hashCode() {
/* 411 */       return (Object2ByteOpenHashMap.this.key[this.index] == null ? 0 : Object2ByteOpenHashMap.this.key[this.index].hashCode()) ^ Object2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 414 */       return Object2ByteOpenHashMap.this.key[this.index] + "=>" + Object2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
