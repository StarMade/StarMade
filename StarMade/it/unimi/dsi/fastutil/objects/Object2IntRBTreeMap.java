  ...
  implements Serializable, Cloneable
{
  ...
  public Object2IntRBTreeMap(Comparator<? super K> local_c)
  {
    this();
  ...
  public Object2IntRBTreeMap(Map<? extends K, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2IntRBTreeMap(SortedMap<K, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2IntRBTreeMap(Object2IntMap<? extends K> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2IntRBTreeMap(Object2IntSortedMap<K> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2IntRBTreeMap(K[] local_k, int[] local_v, Comparator<? super K> local_c)
  {
    this(local_c);
  ...
  public Object2IntRBTreeMap(K[] local_k, int[] local_v)
  {
  ...
  {
    Object2IntRBTreeMap<K>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Object2IntMap.Entry<K>> comparator = new Comparator()
        {
          ...
          {
            return Object2IntRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Object2IntRBTreeMap.EntryIterator(Object2IntRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> iterator(Object2IntMap.Entry<K> from)
        {
          return new Object2IntRBTreeMap.EntryIterator(Object2IntRBTreeMap.this, from.getKey());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Object2IntRBTreeMap.Entry<K> local_f = Object2IntRBTreeMap.this.findKey(local_e.getKey());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Object2IntRBTreeMap.Entry<K> local_f = Object2IntRBTreeMap.this.findKey(local_e.getKey());
          if (local_f != null) {
            Object2IntRBTreeMap.this.removeInt(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Object2IntRBTreeMap.this.subMap(from.getKey(), local_to.getKey()).object2IntEntrySet();
        }
        
        public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> local_to)
        {
          return Object2IntRBTreeMap.this.headMap(local_to.getKey()).object2IntEntrySet();
        }
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Object2IntRBTreeMap.ValueIterator(Object2IntRBTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Object2IntRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Object2IntRBTreeMap<K> local_c;
    try
    {
      local_c = (Object2IntRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Object2IntRBTreeMap<K>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Object2IntRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Object2IntRBTreeMap<K>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Object2IntRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Object2IntRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Object2IntMap.Entry<K>> object2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> iterator()
          {
            return new Object2IntRBTreeMap.Submap.SubmapEntryIterator(Object2IntRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Object2IntMap.Entry<K>> iterator(Object2IntMap.Entry<K> from)
          {
            return new Object2IntRBTreeMap.Submap.SubmapEntryIterator(Object2IntRBTreeMap.Submap.this, from.getKey());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<K, Integer> local_e = (Map.Entry)local_o;
            Object2IntRBTreeMap.Entry<K> local_f = Object2IntRBTreeMap.this.findKey(local_e.getKey());
            return (local_f != null) && (Object2IntRBTreeMap.Submap.this.in5(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<K, Integer> local_e = (Map.Entry)local_o;
            Object2IntRBTreeMap.Entry<K> local_f = Object2IntRBTreeMap.this.findKey(local_e.getKey());
            if ((local_f != null) && (Object2IntRBTreeMap.Submap.this.in5(local_f.key))) {
              Object2IntRBTreeMap.Submap.this.removeInt(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Object2IntRBTreeMap.Submap.SubmapIterator(Object2IntRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Object2IntRBTreeMap.Submap.this.clear();
          }
          
          public Object2IntMap.Entry<K> first()
          {
            return Object2IntRBTreeMap.Submap.this.firstEntry();
          }
          
          public Object2IntMap.Entry<K> last()
          {
            return Object2IntRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Object2IntMap.Entry<K>> subSet(Object2IntMap.Entry<K> from, Object2IntMap.Entry<K> local_to)
          {
            return Object2IntRBTreeMap.Submap.this.subMap(from.getKey(), local_to.getKey()).object2IntEntrySet();
          }
          
          public ObjectSortedSet<Object2IntMap.Entry<K>> headSet(Object2IntMap.Entry<K> local_to)
          {
            return Object2IntRBTreeMap.Submap.this.headMap(local_to.getKey()).object2IntEntrySet();
          }
          
          public ObjectSortedSet<Object2IntMap.Entry<K>> tailSet(Object2IntMap.Entry<K> from)
          {
            return Object2IntRBTreeMap.Submap.this.tailMap(from.getKey()).object2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Object2IntRBTreeMap.Submap.SubmapValueIterator(Object2IntRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Object2IntRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Object2IntRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(Object local_k)
    {
      return (in5(local_k)) && (Object2IntRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      K local_kk = local_k;
      Object2IntRBTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2IntRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public Integer get(Object local_ok)
    {
      K local_kk = local_ok;
      Object2IntRBTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2IntRBTreeMap.this.findKey(local_kk)) != null) ? local_e.getValue() : null;
    }
    ...
    public int put(K local_k, int local_v)
    {
      ...
      int oldValue = Object2IntRBTreeMap.this.put(local_k, local_v);
    ...
    public int removeInt(Object local_k)
    {
      ...
      int oldValue = Object2IntRBTreeMap.this.removeInt(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Object2IntRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Object2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Object2IntRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Object2IntSortedMap<K> tailMap(K from)
    {
      if (this.bottom) {
        return new Submap(Object2IntRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Object2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2IntRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Object2IntSortedMap<K> subMap(K from, K local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Object2IntRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Object2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Object2IntRBTreeMap.Entry<K> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Object2IntRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Object2IntRBTreeMap.this.locateKey(this.from);
        if (Object2IntRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Object2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Object2IntRBTreeMap.Entry<K> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Object2IntRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Object2IntRBTreeMap.this.locateKey(this.field_47);
        if (Object2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Object2IntRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public K firstKey()
    {
      Object2IntRBTreeMap.Entry<K> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public K lastKey()
    {
      Object2IntRBTreeMap.Entry<K> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Object2IntRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Object2IntRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Object2IntRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator()
      {
        this();
        if (this.next != null) {
          if ((!Object2IntRBTreeMap.Submap.this.bottom) && (Object2IntRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Object2IntRBTreeMap.Submap.this.top) && (Object2IntRBTreeMap.this.compare(local_k, (this.prev = Object2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Object2IntRBTreeMap.this.locateKey(local_k);
            if (Object2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Object2IntRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2IntRBTreeMap.this.compare(this.prev.key, Object2IntRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Object2IntRBTreeMap.Submap.this.top) && (this.next != null) && (Object2IntRBTreeMap.this.compare(this.next.key, Object2IntRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractObject2IntSortedMap.KeySet
    {
      ...
      {
        return new Object2IntRBTreeMap.Submap.SubmapKeyIterator(Object2IntRBTreeMap.Submap.this);
      }
      
      public ObjectBidirectionalIterator<K> iterator(K from)
      {
        return new Object2IntRBTreeMap.Submap.SubmapKeyIterator(Object2IntRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractObject2IntSortedMap.KeySet
  {
    ...
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new Object2IntRBTreeMap.KeyIterator(Object2IntRBTreeMap.this);
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new Object2IntRBTreeMap.KeyIterator(Object2IntRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    TreeIterator()
    {
      if ((this.next = Object2IntRBTreeMap.this.locateKey(local_k)) != null) {
        if (Object2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
