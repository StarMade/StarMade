...
/*   5:    */
/*  62:    */public class ObjectSemiIndirectHeaps
/*  63:    */{
/*  64:    */  public static <K> int downHeap(K[] refArray, int[] heap, int size, int i, Comparator<K> c)
/*  65:    */  {
/*  66: 66 */    if (i >= size) throw new IllegalArgumentException("Heap position (" + i + ") is larger than or equal to heap size (" + size + ")");
/*  67: 67 */    int e = heap[i];
/*  68: 68 */    K E = refArray[e];
/*  69:    */    
/*  70: 70 */    if (c == null) { int child;
/*  71: 71 */      while ((child = 2 * i + 1) < size) {
/*  72: 72 */        if ((child + 1 < size) && (((Comparable)refArray[heap[(child + 1)]]).compareTo(refArray[heap[child]]) < 0)) child++;
/*  73: 73 */        if (((Comparable)E).compareTo(refArray[heap[child]]) <= 0) break;
...
/* 116:    */  }
/* 117:    */  
/* 124:    */  public static <K> void makeHeap(K[] refArray, int offset, int length, int[] heap, Comparator<K> c)
/* 125:    */  {
/* 126:126 */    ObjectArrays.ensureOffsetLength(refArray, offset, length);
...
/* 133:    */  }
/* 134:    */  
/* 142:    */  public static <K> int[] makeHeap(K[] refArray, int offset, int length, Comparator<K> c)
/* 143:    */  {
...
/* 147:    */  }
/* 148:    */  
/* 158:    */  public static <K> void makeHeap(K[] refArray, int[] heap, int size, Comparator<K> c)
/* 159:    */  {
...
/* 163:    */  }
/* 164:    */  
/* 180:    */  public static <K> int front(K[] refArray, int[] heap, int size, int[] a)
/* 181:    */  {
/* 182:182 */    K top = refArray[heap[0]];
/* 183:183 */    int j = 0;
/* 184:184 */    int l = 0;
/* 185:185 */    int r = 1;
/* 186:186 */    int f = 0;
...
/* 192:192 */        l = -1;
/* 193:    */      }
/* 194:194 */      if (((Comparable)top).compareTo(refArray[heap[i]]) == 0) {
/* 195:195 */        a[(j++)] = heap[i];
