  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2ObjectLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Object2ObjectLinkedOpenHashMap(Map<? extends K, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ObjectLinkedOpenHashMap(Map<? extends K, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ObjectLinkedOpenHashMap(Object2ObjectMap<K, V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ObjectLinkedOpenHashMap(Object2ObjectMap<K, V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ObjectLinkedOpenHashMap(K[] local_k, V[] local_v, float local_f)
  {
  ...
  public Object2ObjectLinkedOpenHashMap(K[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Object2ObjectLinkedOpenHashMap.ValueIterator(Object2ObjectLinkedOpenHashMap.this);
        }
        ...
        {
          return Object2ObjectLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2ObjectLinkedOpenHashMap<K, V> local_c;
    try
    {
      local_c = (Object2ObjectLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    V[] value = this.value;
    Object2ObjectLinkedOpenHashMap<K, V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractObjectSortedSet<K>
  {
    ...
    {
      return new Object2ObjectLinkedOpenHashMap.KeyIterator(Object2ObjectLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Object2ObjectLinkedOpenHashMap.KeyIterator(Object2ObjectLinkedOpenHashMap.this);
    }
    ...
    {
      return Object2ObjectLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2ObjectLinkedOpenHashMap.this.size;
      Object2ObjectLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Object2ObjectSortedMap.FastSortedEntrySet<K, V>
  {
    ...
    {
      return new Object2ObjectLinkedOpenHashMap.EntryIterator(Object2ObjectLinkedOpenHashMap.this);
    }
    ...
    public Object2ObjectMap.Entry<K, V> first()
    {
      ...
      return new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this, Object2ObjectLinkedOpenHashMap.this.first);
    }
    ...
    public Object2ObjectMap.Entry<K, V> last()
    {
      ...
      return new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this, Object2ObjectLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ObjectLinkedOpenHashMap.this.mask; Object2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask) {
        if (Object2ObjectLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2ObjectLinkedOpenHashMap.this.key[pos].equals(local_k)) {
          return Object2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Object2ObjectLinkedOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ObjectLinkedOpenHashMap.this.mask; Object2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask) {
        if (Object2ObjectLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2ObjectLinkedOpenHashMap.this.key[pos].equals(local_k))
        {
          Object2ObjectLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Object2ObjectLinkedOpenHashMap.EntryIterator(Object2ObjectLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> fastIterator()
    {
      return new Object2ObjectLinkedOpenHashMap.FastEntryIterator(Object2ObjectLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> fastIterator(Object2ObjectMap.Entry<K, V> from)
    {
      return new Object2ObjectLinkedOpenHashMap.FastEntryIterator(Object2ObjectLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Object2ObjectMap.Entry<K, V>>
  {
    ...
    public AbstractObject2ObjectMap.BasicEntry<K, V> next()
    {
      ...
      this.entry.key = Object2ObjectLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Object2ObjectLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Object2ObjectMap.Entry<K, V>>
  {
    ...
    {
      return this.entry = new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this, nextEntry());
    }
    
    public Object2ObjectLinkedOpenHashMap<K, V>.MapEntry previous()
    {
      return this.entry = new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2ObjectLinkedOpenHashMap.this.mask; Object2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask) {
          if (Object2ObjectLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2ObjectLinkedOpenHashMap.this.key[pos].equals(from))
          {
    ...
    public void remove()
    {
      ...
      Object2ObjectLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Object2ObjectLinkedOpenHashMap.this.first = this.next;
      } else {
        Object2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Object2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Object2ObjectLinkedOpenHashMap.this.last = this.prev;
      } else {
        Object2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Object2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2ObjectLinkedOpenHashMap.this.mask; Object2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask)
        {
          int slot = (Object2ObjectLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ObjectLinkedOpenHashMap.this.key[pos].hashCode())) & Object2ObjectLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2ObjectLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Object2ObjectLinkedOpenHashMap.this.key[last] = Object2ObjectLinkedOpenHashMap.this.key[pos];
      ...
      Object2ObjectLinkedOpenHashMap.this.used[last] = false;
      Object2ObjectLinkedOpenHashMap.this.key[last] = null;
    ...
    implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Object2ObjectLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, V> local_e = (Map.Entry)local_o;
      return (Object2ObjectLinkedOpenHashMap.this.key[this.index] == null ? local_e.getKey() == null : Object2ObjectLinkedOpenHashMap.this.key[this.index].equals(local_e.getKey())) && (Object2ObjectLinkedOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Object2ObjectLinkedOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
