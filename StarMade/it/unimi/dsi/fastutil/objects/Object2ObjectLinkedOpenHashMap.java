...
/*  667 */   public Object2ObjectSortedMap<K, V> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  668 */   public Object2ObjectSortedMap<K, V> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  669 */   public Object2ObjectSortedMap<K, V> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*  982 */           return new Object2ObjectLinkedOpenHashMap.ValueIterator(Object2ObjectLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/*  985 */           return Object2ObjectLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/*  988 */           return Object2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/*  991 */           Object2ObjectLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1124 */       c = (Object2ObjectLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/*  973 */       return Object2ObjectLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/*  977 */     public V next() { return Object2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  930 */       return new Object2ObjectLinkedOpenHashMap.KeyIterator(Object2ObjectLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/*  933 */       return new Object2ObjectLinkedOpenHashMap.KeyIterator(Object2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/*  936 */       return Object2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/*  939 */       return Object2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/*  942 */       int oldSize = Object2ObjectLinkedOpenHashMap.this.size;
/*  943 */       Object2ObjectLinkedOpenHashMap.this.remove(k);
/*  944 */       return Object2ObjectLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/*  947 */       Object2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/*  950 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  951 */       return Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/*  954 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  955 */       return Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/*  921 */       super(k, null); } 
/*  922 */     public K previous() { return Object2ObjectLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  926 */     public K next() { return Object2ObjectLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  849 */       return new Object2ObjectLinkedOpenHashMap.EntryIterator(Object2ObjectLinkedOpenHashMap.this);
/*      */     }
/*  851 */     public Comparator<? super Object2ObjectMap.Entry<K, V>> comparator() { return null; } 
/*  852 */     public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> fromElement, Object2ObjectMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); } 
/*  853 */     public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> toElement) { throw new UnsupportedOperationException(); } 
/*  854 */     public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Object2ObjectMap.Entry<K, V> first() {
/*  856 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  857 */       return new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this, Object2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Object2ObjectMap.Entry<K, V> last() {
/*  860 */       if (Object2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  861 */       return new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this, Object2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  869 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  871 */       while (Object2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  872 */         if (Object2ObjectLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2ObjectLinkedOpenHashMap.this.key[pos].equals(k)) return Object2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Object2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  873 */         pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  875 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  883 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  885 */       while (Object2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */         if (Object2ObjectLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2ObjectLinkedOpenHashMap.this.key[pos].equals(k)) {
/*  887 */           Object2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  888 */           return true;
/*      */         }
/*  890 */         pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  892 */       return false;
/*      */     }
/*      */     public int size() {
/*  895 */       return Object2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  898 */       Object2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(Object2ObjectMap.Entry<K, V> from) {
/*  901 */       return new Object2ObjectLinkedOpenHashMap.EntryIterator(Object2ObjectLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> fastIterator() {
/*  904 */       return new Object2ObjectLinkedOpenHashMap.FastEntryIterator(Object2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> fastIterator(Object2ObjectMap.Entry<K, V> from) {
/*  907 */       return new Object2ObjectLinkedOpenHashMap.FastEntryIterator(Object2ObjectLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Object2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<Object2ObjectMap.Entry<K, V>>
/*      */   {
/*  827 */     final AbstractObject2ObjectMap.BasicEntry<K, V> entry = new AbstractObject2ObjectMap.BasicEntry(null, null);
/*      */ 
...
/*  833 */       int e = nextEntry();
/*  834 */       this.entry.key = Object2ObjectLinkedOpenHashMap.this.key[e];
/*  835 */       this.entry.value = Object2ObjectLinkedOpenHashMap.this.value[e];
/*  836 */       return this.entry;
/*      */     }
/*      */     public AbstractObject2ObjectMap.BasicEntry<K, V> previous() {
/*  839 */       int e = previousEntry();
/*  840 */       this.entry.key = Object2ObjectLinkedOpenHashMap.this.key[e];
/*  841 */       this.entry.value = Object2ObjectLinkedOpenHashMap.this.value[e];
/*  842 */       return this.entry;
/*      */     }
/*  844 */     public void set(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  845 */     public void add(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2ObjectLinkedOpenHashMap<K, V>.MapIterator
/*      */     implements ObjectListIterator<Object2ObjectMap.Entry<K, V>>
/*      */   {
...
/*  813 */       return this.entry = new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Object2ObjectLinkedOpenHashMap<K, V>.MapEntry previous() {
/*  816 */       return this.entry = new Object2ObjectLinkedOpenHashMap.MapEntry(Object2ObjectLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  820 */       super.remove();
/*  821 */       Object2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  823 */     public void set(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  824 */     public void add(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  684 */     int index = -1;
/*      */ 
/*  686 */     private MapIterator() { this.next = Object2ObjectLinkedOpenHashMap.this.first;
/*  687 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  690 */       if (Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.last] == null ? from == null : Object2ObjectLinkedOpenHashMap.this.key[Object2ObjectLinkedOpenHashMap.this.last].equals(from)) {
/*  691 */         this.prev = Object2ObjectLinkedOpenHashMap.this.last;
/*  692 */         this.index = Object2ObjectLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  696 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  698 */         while (Object2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  699 */           if (Object2ObjectLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2ObjectLinkedOpenHashMap.this.key[pos].equals(from))
/*      */           {
/*  701 */             this.next = ((int)Object2ObjectLinkedOpenHashMap.this.link[pos]);
/*  702 */             this.prev = pos;
/*  703 */             return;
/*      */           }
/*  705 */           pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  718 */       if (this.next == -1) {
/*  719 */         this.index = Object2ObjectLinkedOpenHashMap.this.size;
/*  720 */         return;
/*      */       }
/*  722 */       int pos = Object2ObjectLinkedOpenHashMap.this.first;
/*  723 */       this.index = 1;
/*  724 */       while (pos != this.prev) {
/*  725 */         pos = (int)Object2ObjectLinkedOpenHashMap.this.link[pos];
/*  726 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  738 */       if (!hasNext()) return Object2ObjectLinkedOpenHashMap.this.size();
/*  739 */       this.curr = this.next;
/*  740 */       this.next = ((int)Object2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  748 */       this.prev = ((int)(Object2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  760 */         this.index -= 1;
/*  761 */         this.prev = ((int)(Object2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  764 */         this.next = ((int)Object2ObjectLinkedOpenHashMap.this.link[this.curr]);
/*  765 */       }Object2ObjectLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  768 */       if (this.prev == -1) Object2ObjectLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  770 */         Object2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Object2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  771 */       if (this.next == -1) Object2ObjectLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  773 */         Object2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Object2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  777 */         pos = (last = pos) + 1 & Object2ObjectLinkedOpenHashMap.this.mask;
/*  778 */         while (Object2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  779 */           int slot = (Object2ObjectLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ObjectLinkedOpenHashMap.this.key[pos].hashCode())) & Object2ObjectLinkedOpenHashMap.this.mask;
/*  780 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  781 */           pos = pos + 1 & Object2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
/*  783 */         if (Object2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  784 */         Object2ObjectLinkedOpenHashMap.this.key[last] = Object2ObjectLinkedOpenHashMap.this.key[pos];
/*  785 */         Object2ObjectLinkedOpenHashMap.this.value[last] = Object2ObjectLinkedOpenHashMap.this.value[pos];
/*  786 */         if (this.next == pos) this.next = last;
/*  787 */         if (this.prev == pos) this.prev = last;
/*  788 */         Object2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  790 */       Object2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  791 */       Object2ObjectLinkedOpenHashMap.this.key[last] = null;
/*  792 */       Object2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  793 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  559 */       return Object2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  562 */       return Object2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  565 */       Object oldValue = Object2ObjectLinkedOpenHashMap.this.value[this.index];
/*  566 */       Object2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  567 */       return oldValue;
/*      */     }
/*      */ 
...
/*  573 */       return (Object2ObjectLinkedOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2ObjectLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Object2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  576 */       return (Object2ObjectLinkedOpenHashMap.this.key[this.index] == null ? 0 : Object2ObjectLinkedOpenHashMap.this.key[this.index].hashCode()) ^ (Object2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Object2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     public String toString() {
/*  579 */       return Object2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Object2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
