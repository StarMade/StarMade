...
/*      */   }
/*      */ 
/*      */   public ObjectRBTreeSet(ObjectIterator<? extends K> i)
/*      */   {
/*   73 */     allocatePaths();
/*      */ 
...
/*      */ 
/*  302 */     this.nodePath = new Entry[64];
/*      */   }
/*      */ 
...
/* 1031 */     return new Subset(from, false, null, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1226 */       c = (ObjectRBTreeSet)super.clone();
/*      */     }
...
/* 1279 */     while (n-- != 0) s.writeObject(i.next());
/*      */   }
/*      */ 
...
/*      */   {
/* 1290 */     if (n == 1) {
/* 1291 */       Entry top = new Entry(s.readObject());
/* 1292 */       top.pred(pred);
/* 1293 */       top.succ(succ);
/* 1294 */       top.black(true);
/* 1295 */       return top;
...
/* 1297 */     if (n == 2)
/*      */     {
/* 1300 */       Entry top = new Entry(s.readObject());
/* 1301 */       top.black(true);
/* 1302 */       top.right(new Entry(s.readObject()));
...
/*      */   }
/*      */ 
/* 1338 */   private int checkTree(Entry<K> e, int d, int D) { return 0; }
/*      */ 
/*      */ 
...
/*      */     {
/* 1063 */       if ((!bottom) && (!top) && (ObjectRBTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1064 */       this.from = from;
...
/*      */     {
/* 1081 */       return ((this.bottom) || (ObjectRBTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (ObjectRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(Object k)
/*      */     {
/* 1086 */       return (in(k)) && (ObjectRBTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(K k) {
...
/* 1090 */       return ObjectRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(Object k) {
/* 1094 */       if (!in(k)) return false;
/* 1095 */       return ObjectRBTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public Comparator<? super K> comparator() {
/* 1110 */       return ObjectRBTreeSet.this.actualComparator;
/*      */     }
/*      */     public ObjectBidirectionalIterator<K> iterator() {
...
/*      */     }
/*      */     public ObjectSortedSet<K> headSet(K to) {
/* 1119 */       if (this.top) return new Subset(ObjectRBTreeSet.this, this.from, this.bottom, to, false);
/* 1120 */       return ObjectRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(ObjectRBTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public ObjectSortedSet<K> tailSet(K from) {
/* 1123 */       if (this.bottom) return new Subset(ObjectRBTreeSet.this, from, false, this.to, this.top);
/* 1124 */       return ObjectRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(ObjectRBTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public ObjectSortedSet<K> subSet(K from, K to) {
/* 1127 */       if ((this.top) && (this.bottom)) return new Subset(ObjectRBTreeSet.this, from, false, to, false);
/* 1128 */       if (!this.top) to = ObjectRBTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1129 */       if (!this.bottom) from = ObjectRBTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1130 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1131 */       return new Subset(ObjectRBTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public ObjectRBTreeSet.Entry<K> firstEntry()
/*      */     {
/* 1138 */       if (ObjectRBTreeSet.this.tree == null) return null;
/* 1141 */       ObjectRBTreeSet.Entry e;
/*      */       ObjectRBTreeSet.Entry e;
/* 1141 */       if (this.bottom) { e = ObjectRBTreeSet.this.firstEntry;
/*      */       } else {
/* 1143 */         e = ObjectRBTreeSet.this.locateKey(this.from);
/*      */ 
/* 1145 */         if (ObjectRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1148 */       if ((e == null) || ((!this.top) && (ObjectRBTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1149 */       return e;
/*      */     }
/*      */ 
/*      */     public ObjectRBTreeSet.Entry<K> lastEntry()
/*      */     {
/* 1156 */       if (ObjectRBTreeSet.this.tree == null) return null;
/* 1159 */       ObjectRBTreeSet.Entry e;
/*      */       ObjectRBTreeSet.Entry e;
/* 1159 */       if (this.top) { e = ObjectRBTreeSet.this.lastEntry;
/*      */       } else {
/* 1161 */         e = ObjectRBTreeSet.this.locateKey(this.to);
/*      */ 
/* 1163 */         if (ObjectRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1166 */       if ((e == null) || ((!this.bottom) && (ObjectRBTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1167 */       return e;
/*      */     }
/*      */     public K first() {
/* 1170 */       ObjectRBTreeSet.Entry e = firstEntry();
/* 1171 */       if (e == null) throw new NoSuchElementException();
/* 1172 */       return e.key;
/*      */     }
/*      */     public K last() {
/* 1175 */       ObjectRBTreeSet.Entry e = lastEntry();
/* 1176 */       if (e == null) throw new NoSuchElementException();
/* 1177 */       return e.key;
/*      */     }
/*      */ 
/*      */     private final class SubsetIterator extends ObjectRBTreeSet.SetIterator
/*      */     {
/*      */       SubsetIterator()
/*      */       {
/* 1187 */         super();
/* 1188 */         this.next = ObjectRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator() {
/* 1191 */         this();
/* 1192 */         if (this.next != null)
/* 1193 */           if ((!ObjectRBTreeSet.Subset.this.bottom) && (ObjectRBTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1194 */           } else if ((!ObjectRBTreeSet.Subset.this.top) && (ObjectRBTreeSet.this.compare(k, (this.prev = ObjectRBTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1196 */             this.next = ObjectRBTreeSet.this.locateKey(k);
/* 1197 */             if (ObjectRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1207 */         if ((!ObjectRBTreeSet.Subset.this.bottom) && (this.prev != null) && (ObjectRBTreeSet.this.compare(this.prev.key, ObjectRBTreeSet.Subset.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1210 */         this.next = this.next.next();
/* 1211 */         if ((!ObjectRBTreeSet.Subset.this.top) && (this.next != null) && (ObjectRBTreeSet.this.compare(this.next.key, ObjectRBTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*  963 */     int index = 0;
/*      */ 
/*  965 */     SetIterator() { this.next = ObjectRBTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator() {
/*  968 */       if ((this.next = ObjectRBTreeSet.this.locateKey(k)) != null)
/*  969 */         if (ObjectRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/*  988 */     public K next() { return nextEntry().key; } 
/*  989 */     public K previous() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1012 */       updatePrevious();
/* 1013 */       updateNext();
/* 1014 */       ObjectRBTreeSet.this.remove(this.curr.key);
/* 1015 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*  896 */       Entry e = (Entry)o;
/*  897 */       return this.key == null ? false : e.key == null ? true : this.key.equals(e.key);
/*      */     }
/*      */     public int hashCode() {
/*  900 */       return this.key == null ? 0 : this.key.hashCode();
/*      */     }
