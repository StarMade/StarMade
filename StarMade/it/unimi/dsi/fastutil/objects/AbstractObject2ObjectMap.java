...
/*  84 */     if ((m instanceof Object2ObjectMap))
/*     */     {
/*  86 */       while (n-- != 0) {
/*  87 */         Object2ObjectMap.Entry e = (Object2ObjectMap.Entry)i.next();
...
/* 151 */       public boolean contains(Object k) { return AbstractObject2ObjectMap.this.containsKey(k); } 
/* 152 */       public int size() { return AbstractObject2ObjectMap.this.size(); } 
/* 153 */       public void clear() { AbstractObject2ObjectMap.this.clear(); } 
/*     */       public ObjectIterator<K> iterator() {
/* 155 */         return new AbstractObjectIterator() {
/* 156 */           final ObjectIterator<Map.Entry<K, V>> i = AbstractObject2ObjectMap.this.entrySet().iterator();
/*     */ 
/* 157 */           public K next() { return ((Object2ObjectMap.Entry)this.i.next()).getKey(); } 
...
/* 176 */       public boolean contains(Object k) { return AbstractObject2ObjectMap.this.containsValue(k); } 
/* 177 */       public int size() { return AbstractObject2ObjectMap.this.size(); } 
/* 178 */       public void clear() { AbstractObject2ObjectMap.this.clear(); } 
/*     */       public ObjectIterator<V> iterator() {
/* 180 */         return new AbstractObjectIterator() {
/* 181 */           final ObjectIterator<Map.Entry<K, V>> i = AbstractObject2ObjectMap.this.entrySet().iterator();
/*     */ 
/* 182 */           public V next() { return ((Object2ObjectMap.Entry)this.i.next()).getValue(); } 
...
/* 190 */     return object2ObjectEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 220 */         s.append(", ");
/* 221 */       Object2ObjectMap.Entry e = (Object2ObjectMap.Entry)i.next();
...
/* 129 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
/* 132 */       return (this.key == null ? 0 : this.key.hashCode()) ^ (this.value == null ? 0 : this.value.hashCode());
/*     */     }
/*     */     public String toString() {
