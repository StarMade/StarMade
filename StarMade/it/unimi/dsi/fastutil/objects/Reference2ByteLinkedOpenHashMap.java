...
/*   18:     */
/*  113:     */public class Reference2ByteLinkedOpenHashMap<K>
/*  114:     */  extends AbstractReference2ByteSortedMap<K>
...
/*  127:     */  protected volatile transient Reference2ByteSortedMap.FastSortedEntrySet<K> entries;
...
/*  141:     */  
/*  149:     */  public Reference2ByteLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Reference2ByteLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Reference2ByteLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Reference2ByteLinkedOpenHashMap(Map<? extends K, ? extends Byte> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Reference2ByteLinkedOpenHashMap(Map<? extends K, ? extends Byte> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Reference2ByteLinkedOpenHashMap(Reference2ByteMap<K> m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Reference2ByteLinkedOpenHashMap(Reference2ByteMap<K> m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Reference2ByteLinkedOpenHashMap(K[] k, byte[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Reference2ByteLinkedOpenHashMap(K[] k, byte[] v)
/*  225:     */  {
...
/*  310: 310 */          tmp54_53 = pos; byte[] tmp54_50 = this.value;tmp54_50[tmp54_53] = ((byte)(tmp54_50[tmp54_53] + incr));
...
/*  651:     */    implements Reference2ByteMap.Entry<K>, Map.Entry<K, Byte>
/*  652:     */  {
...
/*  658:     */    }
/*  659:     */    
/*  660: 660 */    public K getKey() { return Reference2ByteLinkedOpenHashMap.this.key[this.index]; }
/*  661:     */    
/*  662:     */    public Byte getValue() {
/*  663: 663 */      return Byte.valueOf(Reference2ByteLinkedOpenHashMap.this.value[this.index]);
/*  664:     */    }
/*  665:     */    
/*  666: 666 */    public byte getByteValue() { return Reference2ByteLinkedOpenHashMap.this.value[this.index]; }
/*  667:     */    
/*  668:     */    public byte setValue(byte v) {
/*  669: 669 */      byte oldValue = Reference2ByteLinkedOpenHashMap.this.value[this.index];
/*  670: 670 */      Reference2ByteLinkedOpenHashMap.this.value[this.index] = v;
...
/*  680: 680 */      return (Reference2ByteLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*  681:     */    }
/*  682:     */    
/*  683: 683 */    public int hashCode() { return (Reference2ByteLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ByteLinkedOpenHashMap.this.key[this.index])) ^ Reference2ByteLinkedOpenHashMap.this.value[this.index]; }
/*  684:     */    
/*  685:     */    public String toString() {
/*  686: 686 */      return Reference2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2ByteLinkedOpenHashMap.this.value[this.index];
/*  687:     */    }
/*  688:     */  }
/*  689:     */  
...
/*  774: 774 */  public Reference2ByteSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  775: 775 */  public Reference2ByteSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); }
/*  776: 776 */  public Reference2ByteSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  777:     */  
...
/*  791: 791 */    int index = -1;
/*  792:     */    
/*  793: 793 */    private MapIterator() { this.next = Reference2ByteLinkedOpenHashMap.this.first;
/*  794: 794 */      this.index = 0;
/*  795:     */    }
/*  796:     */    
/*  797: 797 */    private MapIterator() { if (Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.last] == from) {
/*  798: 798 */        this.prev = Reference2ByteLinkedOpenHashMap.this.last;
/*  799: 799 */        this.index = Reference2ByteLinkedOpenHashMap.this.size;
/*  800:     */      }
/*  801:     */      else
/*  802:     */      {
/*  803: 803 */        int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2ByteLinkedOpenHashMap.this.mask;
/*  804:     */        
/*  805: 805 */        while (Reference2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  806: 806 */          if (Reference2ByteLinkedOpenHashMap.this.key[pos] == from)
/*  807:     */          {
/*  808: 808 */            this.next = ((int)Reference2ByteLinkedOpenHashMap.this.link[pos]);
/*  809: 809 */            this.prev = pos;
/*  810: 810 */            return;
/*  811:     */          }
/*  812: 812 */          pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*  813:     */        }
...
/*  826: 826 */        this.index = Reference2ByteLinkedOpenHashMap.this.size;
/*  827: 827 */        return;
/*  828:     */      }
/*  829: 829 */      int pos = Reference2ByteLinkedOpenHashMap.this.first;
/*  830: 830 */      this.index = 1;
/*  831: 831 */      while (pos != this.prev) {
/*  832: 832 */        pos = (int)Reference2ByteLinkedOpenHashMap.this.link[pos];
...
/*  843:     */    }
/*  844:     */    
/*  845: 845 */    public int nextEntry() { if (!hasNext()) return Reference2ByteLinkedOpenHashMap.this.size();
/*  846: 846 */      this.curr = this.next;
/*  847: 847 */      this.next = ((int)Reference2ByteLinkedOpenHashMap.this.link[this.curr]);
...
/*  855: 855 */      this.prev = ((int)(Reference2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  868: 868 */        this.prev = ((int)(Reference2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  869:     */      }
/*  870:     */      else {
/*  871: 871 */        this.next = ((int)Reference2ByteLinkedOpenHashMap.this.link[this.curr]); }
/*  872: 872 */      Reference2ByteLinkedOpenHashMap.this.size -= 1;
/*  873:     */      
/*  875: 875 */      if (this.prev == -1) { Reference2ByteLinkedOpenHashMap.this.first = this.next;
/*  876:     */      } else
/*  877: 877 */        Reference2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Reference2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878: 878 */      if (this.next == -1) { Reference2ByteLinkedOpenHashMap.this.last = this.prev;
/*  879:     */      } else
/*  880: 880 */        Reference2ByteLinkedOpenHashMap.this.link[this.next] ^= (Reference2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  881: 881 */      int pos = this.curr;
/*  882:     */      int last;
/*  883:     */      for (;;) {
/*  884: 884 */        pos = (last = pos) + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*  885: 885 */        while (Reference2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  886: 886 */          int slot = (Reference2ByteLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ByteLinkedOpenHashMap.this.key[pos]))) & Reference2ByteLinkedOpenHashMap.this.mask;
/*  887: 887 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888: 888 */          pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*  889:     */        }
/*  890: 890 */        if (Reference2ByteLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891: 891 */        Reference2ByteLinkedOpenHashMap.this.key[last] = Reference2ByteLinkedOpenHashMap.this.key[pos];
/*  892: 892 */        Reference2ByteLinkedOpenHashMap.this.value[last] = Reference2ByteLinkedOpenHashMap.this.value[pos];
/*  893: 893 */        if (this.next == pos) this.next = last;
/*  894: 894 */        if (this.prev == pos) this.prev = last;
/*  895: 895 */        Reference2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*  896:     */      }
/*  897: 897 */      Reference2ByteLinkedOpenHashMap.this.used[last] = false;
/*  898: 898 */      Reference2ByteLinkedOpenHashMap.this.key[last] = null;
/*  899: 899 */      this.curr = -1;
/*  900:     */    }
/*  901:     */    
...
/*  910:     */    } }
/*  911:     */  
/*  912:     */  private class EntryIterator extends Reference2ByteLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Reference2ByteMap.Entry<K>> { private Reference2ByteLinkedOpenHashMap<K>.MapEntry entry;
/*  913:     */    
/*  914: 914 */    public EntryIterator() { super(null); }
/*  915:     */    
/*  916: 916 */    public EntryIterator() { super(from, null); }
/*  917:     */    
/*  918:     */    public Reference2ByteLinkedOpenHashMap<K>.MapEntry next() {
/*  919: 919 */      return this.entry = new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this, nextEntry());
/*  920:     */    }
/*  921:     */    
/*  922: 922 */    public Reference2ByteLinkedOpenHashMap<K>.MapEntry previous() { return this.entry = new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this, previousEntry()); }
/*  923:     */    
/*  924:     */    public void remove()
/*  925:     */    {
/*  926: 926 */      super.remove();
/*  927: 927 */      Reference2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  928:     */    
/*  929: 929 */    public void set(Reference2ByteMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  930: 930 */    public void add(Reference2ByteMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  931:     */  }
/*  932:     */  
/*  933: 933 */  private class FastEntryIterator extends Reference2ByteLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Reference2ByteMap.Entry<K>> { final AbstractReference2ByteMap.BasicEntry<K> entry = new AbstractReference2ByteMap.BasicEntry(null, (byte)0);
/*  934: 934 */    public FastEntryIterator() { super(null); }
/*  935:     */    
/*  936: 936 */    public FastEntryIterator() { super(from, null); }
/*  937:     */    
/*  938:     */    public AbstractReference2ByteMap.BasicEntry<K> next() {
/*  939: 939 */      int e = nextEntry();
/*  940: 940 */      this.entry.key = Reference2ByteLinkedOpenHashMap.this.key[e];
/*  941: 941 */      this.entry.value = Reference2ByteLinkedOpenHashMap.this.value[e];
/*  942: 942 */      return this.entry;
/*  943:     */    }
/*  944:     */    
/*  945: 945 */    public AbstractReference2ByteMap.BasicEntry<K> previous() { int e = previousEntry();
/*  946: 946 */      this.entry.key = Reference2ByteLinkedOpenHashMap.this.key[e];
/*  947: 947 */      this.entry.value = Reference2ByteLinkedOpenHashMap.this.value[e];
/*  948: 948 */      return this.entry; }
/*  949:     */    
/*  950: 950 */    public void set(Reference2ByteMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  951: 951 */    public void add(Reference2ByteMap.Entry<K> ok) { throw new UnsupportedOperationException(); } }
/*  952:     */  
/*  953:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Reference2ByteMap.Entry<K>> implements Reference2ByteSortedMap.FastSortedEntrySet<K> { private MapEntrySet() {}
/*  954:     */    
/*  955: 955 */    public ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> iterator() { return new Reference2ByteLinkedOpenHashMap.EntryIterator(Reference2ByteLinkedOpenHashMap.this); }
/*  956:     */    
/*  957: 957 */    public Comparator<? super Reference2ByteMap.Entry<K>> comparator() { return null; }
/*  958: 958 */    public ObjectSortedSet<Reference2ByteMap.Entry<K>> subSet(Reference2ByteMap.Entry<K> fromElement, Reference2ByteMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  959: 959 */    public ObjectSortedSet<Reference2ByteMap.Entry<K>> headSet(Reference2ByteMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  960: 960 */    public ObjectSortedSet<Reference2ByteMap.Entry<K>> tailSet(Reference2ByteMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); }
/*  961:     */    
/*  962: 962 */    public Reference2ByteMap.Entry<K> first() { if (Reference2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963: 963 */      return new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this, Reference2ByteLinkedOpenHashMap.this.first);
/*  964:     */    }
/*  965:     */    
/*  966: 966 */    public Reference2ByteMap.Entry<K> last() { if (Reference2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967: 967 */      return new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this, Reference2ByteLinkedOpenHashMap.this.last);
/*  968:     */    }
/*  969:     */    
...
/*  974:     */      
/*  975: 975 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ByteLinkedOpenHashMap.this.mask;
/*  976:     */      
/*  977: 977 */      while (Reference2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  978: 978 */        if (Reference2ByteLinkedOpenHashMap.this.key[pos] == k) return Reference2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/*  979: 979 */        pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*  980:     */      }
...
/*  988:     */      
/*  989: 989 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ByteLinkedOpenHashMap.this.mask;
/*  990:     */      
/*  991: 991 */      while (Reference2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  992: 992 */        if (Reference2ByteLinkedOpenHashMap.this.key[pos] == k) {
/*  993: 993 */          Reference2ByteLinkedOpenHashMap.this.remove(e.getKey());
/*  994: 994 */          return true;
/*  995:     */        }
/*  996: 996 */        pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*  997:     */      }
/*  998: 998 */      return false;
/*  999:     */    }
/* 1000:     */    
/* 1001:1001 */    public int size() { return Reference2ByteLinkedOpenHashMap.this.size; }
/* 1002:     */    
/* 1003:     */    public void clear() {
/* 1004:1004 */      Reference2ByteLinkedOpenHashMap.this.clear();
/* 1005:     */    }
/* 1006:     */    
/* 1007:1007 */    public ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> iterator(Reference2ByteMap.Entry<K> from) { return new Reference2ByteLinkedOpenHashMap.EntryIterator(Reference2ByteLinkedOpenHashMap.this, from.getKey()); }
/* 1008:     */    
/* 1009:     */    public ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> fastIterator() {
/* 1010:1010 */      return new Reference2ByteLinkedOpenHashMap.FastEntryIterator(Reference2ByteLinkedOpenHashMap.this);
/* 1011:     */    }
/* 1012:     */    
/* 1013:1013 */    public ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> fastIterator(Reference2ByteMap.Entry<K> from) { return new Reference2ByteLinkedOpenHashMap.FastEntryIterator(Reference2ByteLinkedOpenHashMap.this, from.getKey()); }
/* 1014:     */  }
/* 1015:     */  
/* 1016:     */  public Reference2ByteSortedMap.FastSortedEntrySet<K> reference2ByteEntrySet() {
...
/* 1024:     */    extends Reference2ByteLinkedOpenHashMap<K>.MapIterator
/* 1025:     */    implements ObjectListIterator<K>
/* 1026:     */  {
/* 1027:1027 */    public KeyIterator() { super(k, null); }
/* 1028:1028 */    public K previous() { return Reference2ByteLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1032:1032 */    public K next() { return Reference2ByteLinkedOpenHashMap.this.key[nextEntry()]; } }
/* 1033:     */  
/* 1034:     */  private final class KeySet extends AbstractReferenceSortedSet<K> { private KeySet() {}
/* 1035:     */    
/* 1036:1036 */    public ObjectListIterator<K> iterator(K from) { return new Reference2ByteLinkedOpenHashMap.KeyIterator(Reference2ByteLinkedOpenHashMap.this, from); }
/* 1037:     */    
/* 1038:     */    public ObjectListIterator<K> iterator() {
/* 1039:1039 */      return new Reference2ByteLinkedOpenHashMap.KeyIterator(Reference2ByteLinkedOpenHashMap.this);
/* 1040:     */    }
/* 1041:     */    
/* 1042:1042 */    public int size() { return Reference2ByteLinkedOpenHashMap.this.size; }
/* 1043:     */    
/* 1045:1045 */    public boolean contains(Object k) { return Reference2ByteLinkedOpenHashMap.this.containsKey(k); }
/* 1046:     */    
/* 1047:     */    public boolean remove(Object k) {
/* 1048:1048 */      int oldSize = Reference2ByteLinkedOpenHashMap.this.size;
/* 1049:1049 */      Reference2ByteLinkedOpenHashMap.this.remove(k);
/* 1050:1050 */      return Reference2ByteLinkedOpenHashMap.this.size != oldSize;
/* 1051:     */    }
/* 1052:     */    
/* 1053:1053 */    public void clear() { Reference2ByteLinkedOpenHashMap.this.clear(); }
/* 1054:     */    
/* 1055:     */    public K first() {
/* 1056:1056 */      if (Reference2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057:1057 */      return Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.first];
/* 1058:     */    }
/* 1059:     */    
/* 1060:1060 */    public K last() { if (Reference2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061:1061 */      return Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.last]; }
/* 1062:     */    
...
/* 1076:     */    extends Reference2ByteLinkedOpenHashMap.MapIterator
/* 1077:     */    implements ByteListIterator
/* 1078:     */  {
/* 1079:1079 */    public byte previousByte() { return Reference2ByteLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1080:1080 */    public Byte previous() { return Byte.valueOf(Reference2ByteLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1086:1086 */    public byte nextByte() { return Reference2ByteLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1087:1087 */    public Byte next() { return Byte.valueOf(Reference2ByteLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1088:     */  }
/* 1089:     */  
...
/* 1092:1092 */          return new Reference2ByteLinkedOpenHashMap.ValueIterator(Reference2ByteLinkedOpenHashMap.this);
/* 1093:     */        }
/* 1094:     */        
/* 1095:1095 */        public int size() { return Reference2ByteLinkedOpenHashMap.this.size; }
/* 1096:     */        
/* 1097:     */        public boolean contains(byte v) {
/* 1098:1098 */          return Reference2ByteLinkedOpenHashMap.this.containsValue(v);
/* 1099:     */        }
/* 1100:     */        
/* 1101:1101 */        public void clear() { Reference2ByteLinkedOpenHashMap.this.clear(); }
/* 1102:     */      };
/* 1103:     */    }
...
/* 1223:     */  }
/* 1224:     */  
/* 1227:     */  public Reference2ByteLinkedOpenHashMap<K> clone()
/* 1228:     */  {
/* 1229:     */    Reference2ByteLinkedOpenHashMap<K> c;
/* 1230:     */    
/* 1232:     */    try
/* 1233:     */    {
/* 1234:1234 */      c = (Reference2ByteLinkedOpenHashMap)super.clone();
/* 1235:     */    }
...
/* 1272:1272 */    Reference2ByteLinkedOpenHashMap<K>.MapIterator i = new MapIterator(null);
