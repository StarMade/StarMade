...
/*  774 */   public Reference2ByteSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  775 */   public Reference2ByteSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  776 */   public Reference2ByteSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1092 */           return new Reference2ByteLinkedOpenHashMap.ValueIterator(Reference2ByteLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1095 */           return Reference2ByteLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(byte v) {
/* 1098 */           return Reference2ByteLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1101 */           Reference2ByteLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1234 */       c = (Reference2ByteLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Reference2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public byte previousByte()
/*      */     {
/* 1079 */       return Reference2ByteLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1080 */     public Byte previous() { return Byte.valueOf(Reference2ByteLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1086 */     public byte nextByte() { return Reference2ByteLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1087 */     public Byte next() { return Byte.valueOf(Reference2ByteLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1036 */       return new Reference2ByteLinkedOpenHashMap.KeyIterator(Reference2ByteLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1039 */       return new Reference2ByteLinkedOpenHashMap.KeyIterator(Reference2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1042 */       return Reference2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1045 */       return Reference2ByteLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1048 */       int oldSize = Reference2ByteLinkedOpenHashMap.this.size;
/* 1049 */       Reference2ByteLinkedOpenHashMap.this.remove(k);
/* 1050 */       return Reference2ByteLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1053 */       Reference2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1056 */       if (Reference2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057 */       return Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1060 */       if (Reference2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061 */       return Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Reference2ByteLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1027 */       super(k, null); } 
/* 1028 */     public K previous() { return Reference2ByteLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1032 */     public K next() { return Reference2ByteLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  955 */       return new Reference2ByteLinkedOpenHashMap.EntryIterator(Reference2ByteLinkedOpenHashMap.this);
/*      */     }
/*  957 */     public Comparator<? super Reference2ByteMap.Entry<K>> comparator() { return null; } 
/*  958 */     public ObjectSortedSet<Reference2ByteMap.Entry<K>> subSet(Reference2ByteMap.Entry<K> fromElement, Reference2ByteMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  959 */     public ObjectSortedSet<Reference2ByteMap.Entry<K>> headSet(Reference2ByteMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  960 */     public ObjectSortedSet<Reference2ByteMap.Entry<K>> tailSet(Reference2ByteMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Reference2ByteMap.Entry<K> first() {
/*  962 */       if (Reference2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963 */       return new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this, Reference2ByteLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Reference2ByteMap.Entry<K> last() {
/*  966 */       if (Reference2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967 */       return new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this, Reference2ByteLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  975 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  977 */       while (Reference2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  978 */         if (Reference2ByteLinkedOpenHashMap.this.key[pos] == k) return Reference2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/*  979 */         pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/*  981 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  989 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  991 */       while (Reference2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  992 */         if (Reference2ByteLinkedOpenHashMap.this.key[pos] == k) {
/*  993 */           Reference2ByteLinkedOpenHashMap.this.remove(e.getKey());
/*  994 */           return true;
/*      */         }
/*  996 */         pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/*  998 */       return false;
/*      */     }
/*      */     public int size() {
/* 1001 */       return Reference2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1004 */       Reference2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> iterator(Reference2ByteMap.Entry<K> from) {
/* 1007 */       return new Reference2ByteLinkedOpenHashMap.EntryIterator(Reference2ByteLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> fastIterator() {
/* 1010 */       return new Reference2ByteLinkedOpenHashMap.FastEntryIterator(Reference2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2ByteMap.Entry<K>> fastIterator(Reference2ByteMap.Entry<K> from) {
/* 1013 */       return new Reference2ByteLinkedOpenHashMap.FastEntryIterator(Reference2ByteLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Reference2ByteLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Reference2ByteMap.Entry<K>>
/*      */   {
/*  933 */     final AbstractReference2ByteMap.BasicEntry<K> entry = new AbstractReference2ByteMap.BasicEntry(null, (byte)0);
/*      */ 
...
/*  939 */       int e = nextEntry();
/*  940 */       this.entry.key = Reference2ByteLinkedOpenHashMap.this.key[e];
/*  941 */       this.entry.value = Reference2ByteLinkedOpenHashMap.this.value[e];
/*  942 */       return this.entry;
/*      */     }
/*      */     public AbstractReference2ByteMap.BasicEntry<K> previous() {
/*  945 */       int e = previousEntry();
/*  946 */       this.entry.key = Reference2ByteLinkedOpenHashMap.this.key[e];
/*  947 */       this.entry.value = Reference2ByteLinkedOpenHashMap.this.value[e];
/*  948 */       return this.entry;
/*      */     }
/*  950 */     public void set(Reference2ByteMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  951 */     public void add(Reference2ByteMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Reference2ByteLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Reference2ByteMap.Entry<K>>
/*      */   {
...
/*  919 */       return this.entry = new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Reference2ByteLinkedOpenHashMap<K>.MapEntry previous() {
/*  922 */       return this.entry = new Reference2ByteLinkedOpenHashMap.MapEntry(Reference2ByteLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  926 */       super.remove();
/*  927 */       Reference2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  929 */     public void set(Reference2ByteMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  930 */     public void add(Reference2ByteMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  791 */     int index = -1;
/*      */ 
/*  793 */     private MapIterator() { this.next = Reference2ByteLinkedOpenHashMap.this.first;
/*  794 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  797 */       if (Reference2ByteLinkedOpenHashMap.this.key[Reference2ByteLinkedOpenHashMap.this.last] == from) {
/*  798 */         this.prev = Reference2ByteLinkedOpenHashMap.this.last;
/*  799 */         this.index = Reference2ByteLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  803 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  805 */         while (Reference2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  806 */           if (Reference2ByteLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  808 */             this.next = ((int)Reference2ByteLinkedOpenHashMap.this.link[pos]);
/*  809 */             this.prev = pos;
/*  810 */             return;
/*      */           }
/*  812 */           pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  825 */       if (this.next == -1) {
/*  826 */         this.index = Reference2ByteLinkedOpenHashMap.this.size;
/*  827 */         return;
/*      */       }
/*  829 */       int pos = Reference2ByteLinkedOpenHashMap.this.first;
/*  830 */       this.index = 1;
/*  831 */       while (pos != this.prev) {
/*  832 */         pos = (int)Reference2ByteLinkedOpenHashMap.this.link[pos];
/*  833 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  845 */       if (!hasNext()) return Reference2ByteLinkedOpenHashMap.this.size();
/*  846 */       this.curr = this.next;
/*  847 */       this.next = ((int)Reference2ByteLinkedOpenHashMap.this.link[this.curr]);
...
/*  855 */       this.prev = ((int)(Reference2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  867 */         this.index -= 1;
/*  868 */         this.prev = ((int)(Reference2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  871 */         this.next = ((int)Reference2ByteLinkedOpenHashMap.this.link[this.curr]);
/*  872 */       }Reference2ByteLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  875 */       if (this.prev == -1) Reference2ByteLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  877 */         Reference2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Reference2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878 */       if (this.next == -1) Reference2ByteLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  880 */         Reference2ByteLinkedOpenHashMap.this.link[this.next] ^= (Reference2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  884 */         pos = (last = pos) + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*  885 */         while (Reference2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */           int slot = (Reference2ByteLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ByteLinkedOpenHashMap.this.key[pos]))) & Reference2ByteLinkedOpenHashMap.this.mask;
/*  887 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888 */           pos = pos + 1 & Reference2ByteLinkedOpenHashMap.this.mask;
/*      */         }
/*  890 */         if (Reference2ByteLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891 */         Reference2ByteLinkedOpenHashMap.this.key[last] = Reference2ByteLinkedOpenHashMap.this.key[pos];
/*  892 */         Reference2ByteLinkedOpenHashMap.this.value[last] = Reference2ByteLinkedOpenHashMap.this.value[pos];
/*  893 */         if (this.next == pos) this.next = last;
/*  894 */         if (this.prev == pos) this.prev = last;
/*  895 */         Reference2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  897 */       Reference2ByteLinkedOpenHashMap.this.used[last] = false;
/*  898 */       Reference2ByteLinkedOpenHashMap.this.key[last] = null;
/*  899 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  660 */       return Reference2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Byte getValue() {
/*  663 */       return Byte.valueOf(Reference2ByteLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public byte getByteValue() {
/*  666 */       return Reference2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public byte setValue(byte v) {
/*  669 */       byte oldValue = Reference2ByteLinkedOpenHashMap.this.value[this.index];
/*  670 */       Reference2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  671 */       return oldValue;
/*      */     }
/*      */     public Byte setValue(Byte v) {
...
/*  680 */       return (Reference2ByteLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     public int hashCode() {
/*  683 */       return (Reference2ByteLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ByteLinkedOpenHashMap.this.key[this.index])) ^ Reference2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  686 */       return Reference2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
