  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2CharLinkedOpenCustomHashMap(int expected, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2CharLinkedOpenCustomHashMap(Map<? extends K, ? extends Character> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2CharLinkedOpenCustomHashMap(Map<? extends K, ? extends Character> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2CharLinkedOpenCustomHashMap(Object2CharMap<K> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2CharLinkedOpenCustomHashMap(Object2CharMap<K> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2CharLinkedOpenCustomHashMap(K[] local_k, char[] local_v, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2CharLinkedOpenCustomHashMap(K[] local_k, char[] local_v, Hash.Strategy<K> strategy)
  {
  ...
  public char getAndMoveToFirst(K local_k)
  {
    K[] key = this.key;
  ...
  public char getAndMoveToLast(K local_k)
  {
    K[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToFirst(K local_k, char local_v)
  {
    K[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToLast(K local_k, char local_v)
  {
    K[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Object2CharLinkedOpenCustomHashMap.ValueIterator(Object2CharLinkedOpenCustomHashMap.this);
        }
        ...
        {
          return Object2CharLinkedOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2CharLinkedOpenCustomHashMap<K> local_c;
    try
    {
      local_c = (Object2CharLinkedOpenCustomHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    char[] value = this.value;
    Object2CharLinkedOpenCustomHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2CharLinkedOpenCustomHashMap.MapIterator
    implements CharListIterator
  {
    ...
    {
      return Character.valueOf(Object2CharLinkedOpenCustomHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Character.valueOf(Object2CharLinkedOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractObjectSortedSet<K>
  {
    ...
    {
      return new Object2CharLinkedOpenCustomHashMap.KeyIterator(Object2CharLinkedOpenCustomHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Object2CharLinkedOpenCustomHashMap.KeyIterator(Object2CharLinkedOpenCustomHashMap.this);
    }
    ...
    {
      return Object2CharLinkedOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2CharLinkedOpenCustomHashMap.this.size;
      Object2CharLinkedOpenCustomHashMap.this.remove(local_k);
    ...
    implements Object2CharSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Object2CharLinkedOpenCustomHashMap.EntryIterator(Object2CharLinkedOpenCustomHashMap.this);
    }
    ...
    public Object2CharMap.Entry<K> first()
    {
      ...
      return new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this, Object2CharLinkedOpenCustomHashMap.this.first);
    }
    ...
    public Object2CharMap.Entry<K> last()
    {
      ...
      return new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this, Object2CharLinkedOpenCustomHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2CharLinkedOpenCustomHashMap.this.mask; Object2CharLinkedOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask) {
        if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[pos], local_k)) {
          return Object2CharLinkedOpenCustomHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2CharLinkedOpenCustomHashMap.this.mask; Object2CharLinkedOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask) {
        if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[pos], local_k))
        {
          Object2CharLinkedOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Object2CharLinkedOpenCustomHashMap.EntryIterator(Object2CharLinkedOpenCustomHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> fastIterator()
    {
      return new Object2CharLinkedOpenCustomHashMap.FastEntryIterator(Object2CharLinkedOpenCustomHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> fastIterator(Object2CharMap.Entry<K> from)
    {
      return new Object2CharLinkedOpenCustomHashMap.FastEntryIterator(Object2CharLinkedOpenCustomHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Object2CharMap.Entry<K>>
  {
    ...
    public AbstractObject2CharMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2CharLinkedOpenCustomHashMap.this.key[local_e];
      this.entry.value = Object2CharLinkedOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Object2CharMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this, nextEntry());
    }
    
    public Object2CharLinkedOpenCustomHashMap<K>.MapEntry previous()
    {
      return this.entry = new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2CharLinkedOpenCustomHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2CharLinkedOpenCustomHashMap.this.mask; Object2CharLinkedOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Object2CharLinkedOpenCustomHashMap.this.size -= 1;
      if (this.prev == -1) {
        Object2CharLinkedOpenCustomHashMap.this.first = this.next;
      } else {
        Object2CharLinkedOpenCustomHashMap.this.link[this.prev] ^= (Object2CharLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Object2CharLinkedOpenCustomHashMap.this.last = this.prev;
      } else {
        Object2CharLinkedOpenCustomHashMap.this.link[this.next] ^= (Object2CharLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2CharLinkedOpenCustomHashMap.this.mask; Object2CharLinkedOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(Object2CharLinkedOpenCustomHashMap.this.key[pos])) & Object2CharLinkedOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2CharLinkedOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        Object2CharLinkedOpenCustomHashMap.this.key[last] = Object2CharLinkedOpenCustomHashMap.this.key[pos];
      ...
      Object2CharLinkedOpenCustomHashMap.this.used[last] = false;
      Object2CharLinkedOpenCustomHashMap.this.key[last] = null;
      this.curr = -1;
    }
    ...
    implements Object2CharMap.Entry<K>, Map.Entry<K, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Object2CharLinkedOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Character> local_e = (Map.Entry)local_o;
      return (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[this.index], local_e.getKey())) && (Object2CharLinkedOpenCustomHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
