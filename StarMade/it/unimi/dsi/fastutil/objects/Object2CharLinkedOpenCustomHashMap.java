...
/*   10:     */import it.unimi.dsi.fastutil.chars.CharListIterator;
...
/*   19:     */
/*  113:     */public class Object2CharLinkedOpenCustomHashMap<K>
...
/*  146:     */  
/*  152:     */  public Object2CharLinkedOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy)
/*  153:     */  {
...
/*  162: 162 */    this.value = new char[this.n];
/*  163: 163 */    this.used = new boolean[this.n];
/*  164: 164 */    this.link = new long[this.n];
/*  165:     */  }
/*  166:     */  
/*  170:     */  public Object2CharLinkedOpenCustomHashMap(int expected, Hash.Strategy<K> strategy)
/*  171:     */  {
/*  172: 172 */    this(expected, 0.75F, strategy);
/*  173:     */  }
/*  174:     */  
/*  177:     */  public Object2CharLinkedOpenCustomHashMap(Hash.Strategy<K> strategy)
/*  178:     */  {
/*  179: 179 */    this(16, 0.75F, strategy);
/*  180:     */  }
/*  181:     */  
/*  186:     */  public Object2CharLinkedOpenCustomHashMap(Map<? extends K, ? extends Character> m, float f, Hash.Strategy<K> strategy)
/*  187:     */  {
/*  188: 188 */    this(m.size(), f, strategy);
/*  189: 189 */    putAll(m);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Object2CharLinkedOpenCustomHashMap(Map<? extends K, ? extends Character> m, Hash.Strategy<K> strategy)
/*  196:     */  {
/*  197: 197 */    this(m, 0.75F, strategy);
/*  198:     */  }
/*  199:     */  
/*  204:     */  public Object2CharLinkedOpenCustomHashMap(Object2CharMap<K> m, float f, Hash.Strategy<K> strategy)
/*  205:     */  {
/*  206: 206 */    this(m.size(), f, strategy);
/*  207: 207 */    putAll(m);
/*  208:     */  }
/*  209:     */  
/*  213:     */  public Object2CharLinkedOpenCustomHashMap(Object2CharMap<K> m, Hash.Strategy<K> strategy)
/*  214:     */  {
/*  215: 215 */    this(m, 0.75F, strategy);
/*  216:     */  }
/*  217:     */  
/*  224:     */  public Object2CharLinkedOpenCustomHashMap(K[] k, char[] v, float f, Hash.Strategy<K> strategy)
/*  225:     */  {
...
/*  230:     */  }
/*  231:     */  
/*  236:     */  public Object2CharLinkedOpenCustomHashMap(K[] k, char[] v, Hash.Strategy<K> strategy)
/*  237:     */  {
...
/*  246:     */  }
/*  247:     */  
/*  251:     */  public char put(K k, char v)
/*  252:     */  {
...
/*  257: 257 */        char oldValue = this.value[pos];
...
/*  279:     */  }
/*  280:     */  
/*  281: 281 */  public Character put(K ok, Character ov) { char v = ov.charValue();
/*  282: 282 */    K k = ok;
/*  283:     */    
...
/*  288: 288 */        Character oldValue = Character.valueOf(this.value[pos]);
...
/*  335:     */  }
/*  336:     */  
/*  337:     */  public char removeChar(Object k)
/*  338:     */  {
...
/*  352:     */  }
/*  353:     */  
/*  354:     */  public Character remove(Object ok) {
/*  355: 355 */    K k = ok;
/*  356:     */    
...
/*  363: 363 */        char v = this.value[pos];
/*  364: 364 */        shiftKeys(pos);
/*  365: 365 */        return Character.valueOf(v);
/*  366:     */      }
...
/*  370:     */  }
/*  371:     */  
/*  374:     */  public char removeFirstChar()
/*  375:     */  {
...
/*  384:     */    }
/*  385: 385 */    char v = this.value[pos];
/*  386: 386 */    shiftKeys(pos);
/*  387: 387 */    return v;
/*  388:     */  }
/*  389:     */  
/*  392:     */  public char removeLastChar()
/*  393:     */  {
...
/*  442:     */  }
/*  443:     */  
/*  447:     */  public char getAndMoveToFirst(K k)
/*  448:     */  {
...
/*  463:     */  }
/*  464:     */  
/*  468:     */  public char getAndMoveToLast(K k)
/*  469:     */  {
...
/*  484:     */  }
/*  485:     */  
/*  490:     */  public char putAndMoveToFirst(K k, char v)
/*  491:     */  {
...
/*  500: 500 */        char oldValue = this.value[pos];
...
/*  523:     */  }
/*  524:     */  
/*  529:     */  public char putAndMoveToLast(K k, char v)
/*  530:     */  {
...
/*  539: 539 */        char oldValue = this.value[pos];
...
/*  562:     */  }
/*  563:     */  
/*  564:     */  public char getChar(Object k)
/*  565:     */  {
...
/*  584:     */  }
/*  585:     */  
/*  586: 586 */  public boolean containsValue(char v) { char[] value = this.value;
...
/*  630:     */    implements Object2CharMap.Entry<K>, Map.Entry<K, Character>
/*  631:     */  {
...
/*  637:     */    }
/*  638:     */    
/*  639: 639 */    public K getKey() { return Object2CharLinkedOpenCustomHashMap.this.key[this.index]; }
/*  640:     */    
/*  641:     */    public Character getValue() {
/*  642: 642 */      return Character.valueOf(Object2CharLinkedOpenCustomHashMap.this.value[this.index]);
/*  643:     */    }
/*  644:     */    
/*  645: 645 */    public char getCharValue() { return Object2CharLinkedOpenCustomHashMap.this.value[this.index]; }
/*  646:     */    
/*  647:     */    public char setValue(char v) {
/*  648: 648 */      char oldValue = Object2CharLinkedOpenCustomHashMap.this.value[this.index];
/*  649: 649 */      Object2CharLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  650: 650 */      return oldValue;
/*  651:     */    }
/*  652:     */    
/*  653: 653 */    public Character setValue(Character v) { return Character.valueOf(setValue(v.charValue())); }
/*  654:     */    
/*  655:     */    public boolean equals(Object o)
/*  656:     */    {
/*  657: 657 */      if (!(o instanceof Map.Entry)) return false;
/*  658: 658 */      Map.Entry<K, Character> e = (Map.Entry)o;
/*  659: 659 */      return (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2CharLinkedOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*  660:     */    }
/*  661:     */    
/*  662: 662 */    public int hashCode() { return Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(Object2CharLinkedOpenCustomHashMap.this.key[this.index]) ^ Object2CharLinkedOpenCustomHashMap.this.value[this.index]; }
/*  663:     */    
/*  664:     */    public String toString() {
/*  665: 665 */      return Object2CharLinkedOpenCustomHashMap.this.key[this.index] + "=>" + Object2CharLinkedOpenCustomHashMap.this.value[this.index];
/*  666:     */    }
/*  667:     */  }
/*  668:     */  
...
/*  753: 753 */  public Object2CharSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  754: 754 */  public Object2CharSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); }
/*  755: 755 */  public Object2CharSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  756:     */  
...
/*  770: 770 */    int index = -1;
/*  771:     */    
/*  772: 772 */    private MapIterator() { this.next = Object2CharLinkedOpenCustomHashMap.this.first;
/*  773: 773 */      this.index = 0;
/*  774:     */    }
/*  775:     */    
/*  776: 776 */    private MapIterator() { if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[Object2CharLinkedOpenCustomHashMap.this.last], from)) {
/*  777: 777 */        this.prev = Object2CharLinkedOpenCustomHashMap.this.last;
/*  778: 778 */        this.index = Object2CharLinkedOpenCustomHashMap.this.size;
/*  779:     */      }
/*  780:     */      else
/*  781:     */      {
/*  782: 782 */        int pos = HashCommon.murmurHash3(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2CharLinkedOpenCustomHashMap.this.mask;
/*  783:     */        
/*  784: 784 */        while (Object2CharLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  785: 785 */          if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[pos], from))
/*  786:     */          {
/*  787: 787 */            this.next = ((int)Object2CharLinkedOpenCustomHashMap.this.link[pos]);
/*  788: 788 */            this.prev = pos;
/*  789: 789 */            return;
/*  790:     */          }
/*  791: 791 */          pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask;
/*  792:     */        }
...
/*  805: 805 */        this.index = Object2CharLinkedOpenCustomHashMap.this.size;
/*  806: 806 */        return;
/*  807:     */      }
/*  808: 808 */      int pos = Object2CharLinkedOpenCustomHashMap.this.first;
/*  809: 809 */      this.index = 1;
/*  810: 810 */      while (pos != this.prev) {
/*  811: 811 */        pos = (int)Object2CharLinkedOpenCustomHashMap.this.link[pos];
...
/*  822:     */    }
/*  823:     */    
/*  824: 824 */    public int nextEntry() { if (!hasNext()) return Object2CharLinkedOpenCustomHashMap.this.size();
/*  825: 825 */      this.curr = this.next;
/*  826: 826 */      this.next = ((int)Object2CharLinkedOpenCustomHashMap.this.link[this.curr]);
...
/*  834: 834 */      this.prev = ((int)(Object2CharLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
...
/*  847: 847 */        this.prev = ((int)(Object2CharLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
/*  848:     */      }
/*  849:     */      else {
/*  850: 850 */        this.next = ((int)Object2CharLinkedOpenCustomHashMap.this.link[this.curr]); }
/*  851: 851 */      Object2CharLinkedOpenCustomHashMap.this.size -= 1;
/*  852:     */      
/*  854: 854 */      if (this.prev == -1) { Object2CharLinkedOpenCustomHashMap.this.first = this.next;
/*  855:     */      } else
/*  856: 856 */        Object2CharLinkedOpenCustomHashMap.this.link[this.prev] ^= (Object2CharLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  857: 857 */      if (this.next == -1) { Object2CharLinkedOpenCustomHashMap.this.last = this.prev;
/*  858:     */      } else
/*  859: 859 */        Object2CharLinkedOpenCustomHashMap.this.link[this.next] ^= (Object2CharLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  860: 860 */      int pos = this.curr;
/*  861:     */      int last;
/*  862:     */      for (;;) {
/*  863: 863 */        pos = (last = pos) + 1 & Object2CharLinkedOpenCustomHashMap.this.mask;
/*  864: 864 */        while (Object2CharLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  865: 865 */          int slot = HashCommon.murmurHash3(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(Object2CharLinkedOpenCustomHashMap.this.key[pos])) & Object2CharLinkedOpenCustomHashMap.this.mask;
/*  866: 866 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  867: 867 */          pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask;
/*  868:     */        }
/*  869: 869 */        if (Object2CharLinkedOpenCustomHashMap.this.used[pos] == 0) break;
/*  870: 870 */        Object2CharLinkedOpenCustomHashMap.this.key[last] = Object2CharLinkedOpenCustomHashMap.this.key[pos];
/*  871: 871 */        Object2CharLinkedOpenCustomHashMap.this.value[last] = Object2CharLinkedOpenCustomHashMap.this.value[pos];
/*  872: 872 */        if (this.next == pos) this.next = last;
/*  873: 873 */        if (this.prev == pos) this.prev = last;
/*  874: 874 */        Object2CharLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*  875:     */      }
/*  876: 876 */      Object2CharLinkedOpenCustomHashMap.this.used[last] = false;
/*  877: 877 */      Object2CharLinkedOpenCustomHashMap.this.key[last] = null;
/*  878: 878 */      this.curr = -1;
/*  879:     */    }
/*  880:     */    
...
/*  889:     */    } }
/*  890:     */  
/*  891:     */  private class EntryIterator extends Object2CharLinkedOpenCustomHashMap<K>.MapIterator implements ObjectListIterator<Object2CharMap.Entry<K>> { private Object2CharLinkedOpenCustomHashMap<K>.MapEntry entry;
/*  892:     */    
/*  893: 893 */    public EntryIterator() { super(null); }
/*  894:     */    
/*  895: 895 */    public EntryIterator() { super(from, null); }
/*  896:     */    
/*  897:     */    public Object2CharLinkedOpenCustomHashMap<K>.MapEntry next() {
/*  898: 898 */      return this.entry = new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this, nextEntry());
/*  899:     */    }
/*  900:     */    
/*  901: 901 */    public Object2CharLinkedOpenCustomHashMap<K>.MapEntry previous() { return this.entry = new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this, previousEntry()); }
/*  902:     */    
/*  903:     */    public void remove()
/*  904:     */    {
/*  905: 905 */      super.remove();
/*  906: 906 */      Object2CharLinkedOpenCustomHashMap.MapEntry.access$202(this.entry, -1); }
/*  907:     */    
/*  908: 908 */    public void set(Object2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  909: 909 */    public void add(Object2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  910:     */  }
/*  911:     */  
/*  912: 912 */  private class FastEntryIterator extends Object2CharLinkedOpenCustomHashMap<K>.MapIterator implements ObjectListIterator<Object2CharMap.Entry<K>> { final AbstractObject2CharMap.BasicEntry<K> entry = new AbstractObject2CharMap.BasicEntry(null, '\000');
/*  913: 913 */    public FastEntryIterator() { super(null); }
/*  914:     */    
/*  915: 915 */    public FastEntryIterator() { super(from, null); }
/*  916:     */    
/*  917:     */    public AbstractObject2CharMap.BasicEntry<K> next() {
/*  918: 918 */      int e = nextEntry();
/*  919: 919 */      this.entry.key = Object2CharLinkedOpenCustomHashMap.this.key[e];
/*  920: 920 */      this.entry.value = Object2CharLinkedOpenCustomHashMap.this.value[e];
/*  921: 921 */      return this.entry;
/*  922:     */    }
/*  923:     */    
/*  924: 924 */    public AbstractObject2CharMap.BasicEntry<K> previous() { int e = previousEntry();
/*  925: 925 */      this.entry.key = Object2CharLinkedOpenCustomHashMap.this.key[e];
/*  926: 926 */      this.entry.value = Object2CharLinkedOpenCustomHashMap.this.value[e];
/*  927: 927 */      return this.entry; }
/*  928:     */    
/*  929: 929 */    public void set(Object2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  930: 930 */    public void add(Object2CharMap.Entry<K> ok) { throw new UnsupportedOperationException(); } }
/*  931:     */  
/*  932:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Object2CharMap.Entry<K>> implements Object2CharSortedMap.FastSortedEntrySet<K> { private MapEntrySet() {}
/*  933:     */    
/*  934: 934 */    public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator() { return new Object2CharLinkedOpenCustomHashMap.EntryIterator(Object2CharLinkedOpenCustomHashMap.this); }
/*  935:     */    
/*  936: 936 */    public Comparator<? super Object2CharMap.Entry<K>> comparator() { return null; }
/*  937: 937 */    public ObjectSortedSet<Object2CharMap.Entry<K>> subSet(Object2CharMap.Entry<K> fromElement, Object2CharMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  938: 938 */    public ObjectSortedSet<Object2CharMap.Entry<K>> headSet(Object2CharMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  939: 939 */    public ObjectSortedSet<Object2CharMap.Entry<K>> tailSet(Object2CharMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); }
/*  940:     */    
/*  941: 941 */    public Object2CharMap.Entry<K> first() { if (Object2CharLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  942: 942 */      return new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this, Object2CharLinkedOpenCustomHashMap.this.first);
/*  943:     */    }
/*  944:     */    
/*  945: 945 */    public Object2CharMap.Entry<K> last() { if (Object2CharLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  946: 946 */      return new Object2CharLinkedOpenCustomHashMap.MapEntry(Object2CharLinkedOpenCustomHashMap.this, Object2CharLinkedOpenCustomHashMap.this.last);
/*  947:     */    }
/*  948:     */    
/*  949:     */    public boolean contains(Object o) {
/*  950: 950 */      if (!(o instanceof Map.Entry)) return false;
/*  951: 951 */      Map.Entry<K, Character> e = (Map.Entry)o;
/*  952: 952 */      K k = e.getKey();
/*  953:     */      
/*  954: 954 */      int pos = HashCommon.murmurHash3(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharLinkedOpenCustomHashMap.this.mask;
/*  955:     */      
/*  956: 956 */      while (Object2CharLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  957: 957 */        if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[pos], k)) return Object2CharLinkedOpenCustomHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/*  958: 958 */        pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask;
/*  959:     */      }
...
/*  965: 965 */      Map.Entry<K, Character> e = (Map.Entry)o;
/*  966: 966 */      K k = e.getKey();
/*  967:     */      
/*  968: 968 */      int pos = HashCommon.murmurHash3(Object2CharLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharLinkedOpenCustomHashMap.this.mask;
/*  969:     */      
/*  970: 970 */      while (Object2CharLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  971: 971 */        if (Object2CharLinkedOpenCustomHashMap.this.strategy.equals(Object2CharLinkedOpenCustomHashMap.this.key[pos], k)) {
/*  972: 972 */          Object2CharLinkedOpenCustomHashMap.this.remove(e.getKey());
/*  973: 973 */          return true;
/*  974:     */        }
/*  975: 975 */        pos = pos + 1 & Object2CharLinkedOpenCustomHashMap.this.mask;
/*  976:     */      }
/*  977: 977 */      return false;
/*  978:     */    }
/*  979:     */    
/*  980: 980 */    public int size() { return Object2CharLinkedOpenCustomHashMap.this.size; }
/*  981:     */    
/*  982:     */    public void clear() {
/*  983: 983 */      Object2CharLinkedOpenCustomHashMap.this.clear();
/*  984:     */    }
/*  985:     */    
/*  986: 986 */    public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> iterator(Object2CharMap.Entry<K> from) { return new Object2CharLinkedOpenCustomHashMap.EntryIterator(Object2CharLinkedOpenCustomHashMap.this, from.getKey()); }
/*  987:     */    
/*  988:     */    public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> fastIterator() {
/*  989: 989 */      return new Object2CharLinkedOpenCustomHashMap.FastEntryIterator(Object2CharLinkedOpenCustomHashMap.this);
/*  990:     */    }
/*  991:     */    
/*  992: 992 */    public ObjectBidirectionalIterator<Object2CharMap.Entry<K>> fastIterator(Object2CharMap.Entry<K> from) { return new Object2CharLinkedOpenCustomHashMap.FastEntryIterator(Object2CharLinkedOpenCustomHashMap.this, from.getKey()); }
/*  993:     */  }
/*  994:     */  
/*  995:     */  public Object2CharSortedMap.FastSortedEntrySet<K> object2CharEntrySet() {
...
/* 1003:     */    extends Object2CharLinkedOpenCustomHashMap<K>.MapIterator
/* 1004:     */    implements ObjectListIterator<K>
/* 1005:     */  {
/* 1006:1006 */    public KeyIterator() { super(k, null); }
/* 1007:1007 */    public K previous() { return Object2CharLinkedOpenCustomHashMap.this.key[previousEntry()]; }
...
/* 1011:1011 */    public K next() { return Object2CharLinkedOpenCustomHashMap.this.key[nextEntry()]; } }
/* 1012:     */  
/* 1013:     */  private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/* 1014:     */    
/* 1015:1015 */    public ObjectListIterator<K> iterator(K from) { return new Object2CharLinkedOpenCustomHashMap.KeyIterator(Object2CharLinkedOpenCustomHashMap.this, from); }
/* 1016:     */    
/* 1017:     */    public ObjectListIterator<K> iterator() {
/* 1018:1018 */      return new Object2CharLinkedOpenCustomHashMap.KeyIterator(Object2CharLinkedOpenCustomHashMap.this);
/* 1019:     */    }
/* 1020:     */    
/* 1021:1021 */    public int size() { return Object2CharLinkedOpenCustomHashMap.this.size; }
/* 1022:     */    
/* 1024:1024 */    public boolean contains(Object k) { return Object2CharLinkedOpenCustomHashMap.this.containsKey(k); }
/* 1025:     */    
/* 1026:     */    public boolean remove(Object k) {
/* 1027:1027 */      int oldSize = Object2CharLinkedOpenCustomHashMap.this.size;
/* 1028:1028 */      Object2CharLinkedOpenCustomHashMap.this.remove(k);
/* 1029:1029 */      return Object2CharLinkedOpenCustomHashMap.this.size != oldSize;
/* 1030:     */    }
/* 1031:     */    
/* 1032:1032 */    public void clear() { Object2CharLinkedOpenCustomHashMap.this.clear(); }
/* 1033:     */    
/* 1034:     */    public K first() {
/* 1035:1035 */      if (Object2CharLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1036:1036 */      return Object2CharLinkedOpenCustomHashMap.this.key[Object2CharLinkedOpenCustomHashMap.this.first];
/* 1037:     */    }
/* 1038:     */    
/* 1039:1039 */    public K last() { if (Object2CharLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1040:1040 */      return Object2CharLinkedOpenCustomHashMap.this.key[Object2CharLinkedOpenCustomHashMap.this.last]; }
/* 1041:     */    
...
/* 1055:     */    extends Object2CharLinkedOpenCustomHashMap.MapIterator
/* 1056:     */    implements CharListIterator
/* 1057:     */  {
/* 1058:1058 */    public char previousChar() { return Object2CharLinkedOpenCustomHashMap.this.value[previousEntry()]; }
/* 1059:1059 */    public Character previous() { return Character.valueOf(Object2CharLinkedOpenCustomHashMap.this.value[previousEntry()]); }
/* 1060:1060 */    public void set(Character ok) { throw new UnsupportedOperationException(); }
/* 1061:1061 */    public void add(Character ok) { throw new UnsupportedOperationException(); }
/* 1062:1062 */    public void set(char v) { throw new UnsupportedOperationException(); }
/* 1063:1063 */    public void add(char v) { throw new UnsupportedOperationException(); }
/* 1064:1064 */    public ValueIterator() { super(null); }
/* 1065:1065 */    public char nextChar() { return Object2CharLinkedOpenCustomHashMap.this.value[nextEntry()]; }
/* 1066:1066 */    public Character next() { return Character.valueOf(Object2CharLinkedOpenCustomHashMap.this.value[nextEntry()]); }
/* 1067:     */  }
/* 1068:     */  
/* 1069:1069 */  public CharCollection values() { if (this.values == null) { this.values = new AbstractCharCollection() {
/* 1070:     */        public CharIterator iterator() {
/* 1071:1071 */          return new Object2CharLinkedOpenCustomHashMap.ValueIterator(Object2CharLinkedOpenCustomHashMap.this);
/* 1072:     */        }
/* 1073:     */        
/* 1074:1074 */        public int size() { return Object2CharLinkedOpenCustomHashMap.this.size; }
/* 1075:     */        
/* 1076:     */        public boolean contains(char v) {
/* 1077:1077 */          return Object2CharLinkedOpenCustomHashMap.this.containsValue(v);
/* 1078:     */        }
/* 1079:     */        
/* 1080:1080 */        public void clear() { Object2CharLinkedOpenCustomHashMap.this.clear(); }
/* 1081:     */      };
/* 1082:     */    }
...
/* 1202:     */  }
/* 1203:     */  
/* 1206:     */  public Object2CharLinkedOpenCustomHashMap<K> clone()
/* 1207:     */  {
/* 1208:     */    Object2CharLinkedOpenCustomHashMap<K> c;
/* 1209:     */    
/* 1211:     */    try
/* 1212:     */    {
/* 1213:1213 */      c = (Object2CharLinkedOpenCustomHashMap)super.clone();
/* 1214:     */    }
...
/* 1222:1222 */    c.value = ((char[])this.value.clone());
...
/* 1251:1251 */    char[] value = this.value;
/* 1252:1252 */    Object2CharLinkedOpenCustomHashMap<K>.MapIterator i = new MapIterator(null);
/* 1253:1253 */    s.defaultWriteObject();
/* 1254:1254 */    for (int j = this.size; j-- != 0;) {
/* 1255:1255 */      int e = i.nextEntry();
/* 1256:1256 */      s.writeObject(key[e]);
/* 1257:1257 */      s.writeChar(value[e]);
/* 1258:     */    }
/* 1259:     */  }
/* 1260:     */  
...
/* 1267:1267 */    char[] value = this.value = new char[this.n];
