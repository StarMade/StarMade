  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2ByteOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2ByteOpenHashMap(Map<? extends K, ? extends Byte> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2ByteOpenHashMap(Map<? extends K, ? extends Byte> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2ByteOpenHashMap(Reference2ByteMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2ByteOpenHashMap(Reference2ByteMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2ByteOpenHashMap(K[] local_k, byte[] local_v, float local_f)
  {
  ...
  public Reference2ByteOpenHashMap(K[] local_k, byte[] local_v)
  {
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Reference2ByteOpenHashMap.ValueIterator(Reference2ByteOpenHashMap.this);
        }
        ...
        {
          return Reference2ByteOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2ByteOpenHashMap<K> local_c;
    try
    {
      local_c = (Reference2ByteOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    byte[] value = this.value;
    Reference2ByteOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Reference2ByteOpenHashMap.MapIterator
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Reference2ByteOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractReferenceSet<K>
  {
    ...
    {
      return new Reference2ByteOpenHashMap.KeyIterator(Reference2ByteOpenHashMap.this);
    }
    ...
    {
      return Reference2ByteOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2ByteOpenHashMap.this.size;
      Reference2ByteOpenHashMap.this.remove(local_k);
    ...
    implements Reference2ByteMap.FastEntrySet<K>
  {
    ...
    {
      return new Reference2ByteOpenHashMap.EntryIterator(Reference2ByteOpenHashMap.this, null);
    }
    
    public ObjectIterator<Reference2ByteMap.Entry<K>> fastIterator()
    {
      return new Reference2ByteOpenHashMap.FastEntryIterator(Reference2ByteOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2ByteOpenHashMap.this.mask; Reference2ByteOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ByteOpenHashMap.this.mask) {
        if (Reference2ByteOpenHashMap.this.key[pos] == local_k) {
          return Reference2ByteOpenHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2ByteOpenHashMap.this.mask; Reference2ByteOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ByteOpenHashMap.this.mask) {
        if (Reference2ByteOpenHashMap.this.key[pos] == local_k)
        {
          Reference2ByteOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Reference2ByteMap.Entry<K>>
  {
    ...
    public AbstractReference2ByteMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Reference2ByteOpenHashMap.this.key[local_e];
      this.entry.value = Reference2ByteOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Reference2ByteMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Reference2ByteOpenHashMap.MapEntry(Reference2ByteOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2ByteOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Reference2ByteOpenHashMap.this.field_49;
    int last = -1;
    int field_2023 = Reference2ByteOpenHashMap.this.size;
    ReferenceArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Reference2ByteOpenHashMap.this.used;
      while ((this.field_2023 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2023 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Reference2ByteOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2ByteOpenHashMap.this.mask; Reference2ByteOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ByteOpenHashMap.this.mask)
        {
          int slot = (Reference2ByteOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ByteOpenHashMap.this.key[pos]))) & Reference2ByteOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Reference2ByteOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Reference2ByteOpenHashMap.this.key[pos]);
        }
        Reference2ByteOpenHashMap.this.key[last] = Reference2ByteOpenHashMap.this.key[pos];
        Reference2ByteOpenHashMap.this.value[last] = Reference2ByteOpenHashMap.this.value[pos];
      }
      Reference2ByteOpenHashMap.this.used[last] = false;
      Reference2ByteOpenHashMap.this.key[last] = null;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Reference2ByteOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
        this.last = -1;
        return;
      }
      Reference2ByteOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2023 > 0))
      {
        this.field_2023 += 1;
        nextEntry();
      }
    ...
    implements Reference2ByteMap.Entry<K>, Map.Entry<K, Byte>
  {
    ...
    public byte setValue(byte local_v)
    {
      ...
      Reference2ByteOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Byte> local_e = (Map.Entry)local_o;
      return (Reference2ByteOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2ByteOpenHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
    
    public int hashCode()
    {
      return (Reference2ByteOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ByteOpenHashMap.this.key[this.index])) ^ Reference2ByteOpenHashMap.this.value[this.index];
    }
