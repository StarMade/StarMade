  ...
  implements Reference2ReferenceMap<K, V>, Serializable
{
  ...
  public void putAll(Map<? extends K, ? extends V> local_m)
  {
    ...
    if ((local_m instanceof Reference2ReferenceMap)) {
      while (local_n-- != 0)
      {
        Reference2ReferenceMap.Entry<? extends K, ? extends V> local_e = (Reference2ReferenceMap.Entry)local_i.next();
  ...
  public ReferenceSet<K> keySet()
  {
    new AbstractReferenceSet()
    {
      ...
      {
        return AbstractReference2ReferenceMap.this.containsKey(local_k);
      }
      ...
      public ObjectIterator<K> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, V>> field_3 = AbstractReference2ReferenceMap.this.entrySet().iterator();
          
          public K next()
          {
            return ((Reference2ReferenceMap.Entry)this.field_3.next()).getKey();
          }
  ...
  public ReferenceCollection<V> values()
  {
    new AbstractReferenceCollection()
    {
      public boolean contains(Object local_k)
      {
        return AbstractReference2ReferenceMap.this.containsValue(local_k);
      }
      ...
      public ObjectIterator<V> iterator()
      {
        new AbstractObjectIterator()
        {
          ...
          public V next()
          {
            return ((Reference2ReferenceMap.Entry)this.field_3.next()).getValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Reference2ReferenceMap.Entry<K, V> local_e = (Reference2ReferenceMap.Entry)local_i.next();
    ...
    implements Reference2ReferenceMap.Entry<K, V>
  {
    ...
    public boolean equals(Object local_o)
    {
      ...
      return (this.key == local_e.getKey()) && (this.value == local_e.getValue());
    }
