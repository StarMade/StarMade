...
/*   8:    */
/*  60:    */public abstract class AbstractReference2ReferenceMap<K, V>
/*  61:    */  extends AbstractReference2ReferenceFunction<K, V>
/*  62:    */  implements Reference2ReferenceMap<K, V>, Serializable
/*  63:    */{
...
/*  84: 84 */    if ((m instanceof Reference2ReferenceMap))
/*  85:    */    {
/*  86: 86 */      while (n-- != 0) {
/*  87: 87 */        Reference2ReferenceMap.Entry<? extends K, ? extends V> e = (Reference2ReferenceMap.Entry)i.next();
...
/* 105:    */    implements Reference2ReferenceMap.Entry<K, V>
/* 106:    */  {
/* 107:    */    protected K key;
/* 108:    */    
...
/* 129:129 */      return (this.key == e.getKey()) && (this.value == e.getValue());
/* 130:    */    }
/* 131:    */    
/* 132:132 */    public int hashCode() { return (this.key == null ? 0 : System.identityHashCode(this.key)) ^ (this.value == null ? 0 : System.identityHashCode(this.value)); }
/* 133:    */    
...
/* 137:    */  }
/* 138:    */  
/* 148:    */  public ReferenceSet<K> keySet()
/* 149:    */  {
/* 150:150 */    new AbstractReferenceSet() {
/* 151:151 */      public boolean contains(Object k) { return AbstractReference2ReferenceMap.this.containsKey(k); }
/* 152:152 */      public int size() { return AbstractReference2ReferenceMap.this.size(); }
/* 153:153 */      public void clear() { AbstractReference2ReferenceMap.this.clear(); }
/* 154:    */      
/* 155:155 */      public ObjectIterator<K> iterator() { new AbstractObjectIterator() {
/* 156:156 */          final ObjectIterator<Map.Entry<K, V>> i = AbstractReference2ReferenceMap.this.entrySet().iterator();
/* 157:157 */          public K next() { return ((Reference2ReferenceMap.Entry)this.i.next()).getKey(); }
/* 158:158 */          public boolean hasNext() { return this.i.hasNext(); }
/* 159:    */        }; }
/* 160:    */    };
/* 161:    */  }
/* 162:    */  
/* 173:    */  public ReferenceCollection<V> values()
/* 174:    */  {
/* 175:175 */    new AbstractReferenceCollection() {
/* 176:176 */      public boolean contains(Object k) { return AbstractReference2ReferenceMap.this.containsValue(k); }
/* 177:177 */      public int size() { return AbstractReference2ReferenceMap.this.size(); }
/* 178:178 */      public void clear() { AbstractReference2ReferenceMap.this.clear(); }
/* 179:    */      
/* 180:180 */      public ObjectIterator<V> iterator() { new AbstractObjectIterator() {
/* 181:181 */          final ObjectIterator<Map.Entry<K, V>> i = AbstractReference2ReferenceMap.this.entrySet().iterator();
/* 182:182 */          public V next() { return ((Reference2ReferenceMap.Entry)this.i.next()).getValue(); }
...
/* 189:    */  {
/* 190:190 */    return reference2ReferenceEntrySet();
/* 191:    */  }
/* 192:    */  
...
/* 220:220 */        s.append(", ");
/* 221:221 */      Reference2ReferenceMap.Entry<K, V> e = (Reference2ReferenceMap.Entry)i.next();
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.AbstractReference2ReferenceMap
