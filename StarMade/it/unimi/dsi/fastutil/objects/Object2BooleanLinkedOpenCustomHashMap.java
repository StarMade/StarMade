...
/*  162 */     this.value = new boolean[this.n];
...
/*  288 */         Boolean oldValue = Boolean.valueOf(this.value[pos]);
...
/*  361 */         this.size -= 1;
/*  362 */         fixPointers(pos);
/*  363 */         boolean v = this.value[pos];
/*  364 */         shiftKeys(pos);
/*  365 */         return Boolean.valueOf(v);
/*      */       }
...
/*  500 */         boolean oldValue = this.value[pos];
...
/*  539 */         boolean oldValue = this.value[pos];
...
/*  753 */   public Object2BooleanSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  754 */   public Object2BooleanSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  755 */   public Object2BooleanSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/* 1069 */     if (this.values == null) this.values = new AbstractBooleanCollection() {
/*      */         public BooleanIterator iterator() {
/* 1071 */           return new Object2BooleanLinkedOpenCustomHashMap.ValueIterator(Object2BooleanLinkedOpenCustomHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1074 */           return Object2BooleanLinkedOpenCustomHashMap.this.size;
/*      */         }
/*      */         public boolean contains(boolean v) {
/* 1077 */           return Object2BooleanLinkedOpenCustomHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1080 */           Object2BooleanLinkedOpenCustomHashMap.this.clear();
/*      */         }
/*      */       };
...
/* 1161 */     boolean[] value = this.value;
/* 1162 */     int newMask = newN - 1;
/* 1163 */     Object[] newKey = (Object[])new Object[newN];
/* 1164 */     boolean[] newValue = new boolean[newN];
...
/*      */     try
/*      */     {
/* 1213 */       c = (Object2BooleanLinkedOpenCustomHashMap)super.clone();
/*      */     }
...
/* 1222 */     c.value = ((boolean[])this.value.clone());
...
/* 1243 */       t ^= (this.value[i] != 0 ? 1231 : 1237);
/* 1244 */       h += t;
/* 1245 */       i++;
/*      */     }
/* 1247 */     return h;
...
/* 1267 */     boolean[] value = this.value = new boolean[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2BooleanLinkedOpenCustomHashMap.MapIterator
/*      */     implements BooleanListIterator
/*      */   {
/*      */     public boolean previousBoolean()
/*      */     {
/* 1058 */       return Object2BooleanLinkedOpenCustomHashMap.this.value[previousEntry()]; } 
/* 1059 */     public Boolean previous() { return Boolean.valueOf(Object2BooleanLinkedOpenCustomHashMap.this.value[previousEntry()]); } 
/* 1060 */     public void set(Boolean ok) { throw new UnsupportedOperationException(); } 
/* 1061 */     public void add(Boolean ok) { throw new UnsupportedOperationException(); } 
/* 1062 */     public void set(boolean v) { throw new UnsupportedOperationException(); } 
/* 1063 */     public void add(boolean v) { throw new UnsupportedOperationException(); } 
/* 1064 */     public ValueIterator() { super(null); } 
/* 1065 */     public boolean nextBoolean() { return Object2BooleanLinkedOpenCustomHashMap.this.value[nextEntry()]; } 
/* 1066 */     public Boolean next() { return Boolean.valueOf(Object2BooleanLinkedOpenCustomHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1015 */       return new Object2BooleanLinkedOpenCustomHashMap.KeyIterator(Object2BooleanLinkedOpenCustomHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1018 */       return new Object2BooleanLinkedOpenCustomHashMap.KeyIterator(Object2BooleanLinkedOpenCustomHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1021 */       return Object2BooleanLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1024 */       return Object2BooleanLinkedOpenCustomHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1027 */       int oldSize = Object2BooleanLinkedOpenCustomHashMap.this.size;
/* 1028 */       Object2BooleanLinkedOpenCustomHashMap.this.remove(k);
/* 1029 */       return Object2BooleanLinkedOpenCustomHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1032 */       Object2BooleanLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1035 */       if (Object2BooleanLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1036 */       return Object2BooleanLinkedOpenCustomHashMap.this.key[Object2BooleanLinkedOpenCustomHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1039 */       if (Object2BooleanLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1040 */       return Object2BooleanLinkedOpenCustomHashMap.this.key[Object2BooleanLinkedOpenCustomHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2BooleanLinkedOpenCustomHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1006 */       super(k, null); } 
/* 1007 */     public K previous() { return Object2BooleanLinkedOpenCustomHashMap.this.key[previousEntry()]; } 
...
/* 1011 */     public K next() { return Object2BooleanLinkedOpenCustomHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  934 */       return new Object2BooleanLinkedOpenCustomHashMap.EntryIterator(Object2BooleanLinkedOpenCustomHashMap.this);
/*      */     }
/*  936 */     public Comparator<? super Object2BooleanMap.Entry<K>> comparator() { return null; } 
/*  937 */     public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> fromElement, Object2BooleanMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  938 */     public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  939 */     public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Object2BooleanMap.Entry<K> first() {
/*  941 */       if (Object2BooleanLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  942 */       return new Object2BooleanLinkedOpenCustomHashMap.MapEntry(Object2BooleanLinkedOpenCustomHashMap.this, Object2BooleanLinkedOpenCustomHashMap.this.first);
/*      */     }
/*      */     public Object2BooleanMap.Entry<K> last() {
/*  945 */       if (Object2BooleanLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  946 */       return new Object2BooleanLinkedOpenCustomHashMap.MapEntry(Object2BooleanLinkedOpenCustomHashMap.this, Object2BooleanLinkedOpenCustomHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  954 */       int pos = HashCommon.murmurHash3(Object2BooleanLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2BooleanLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  956 */       while (Object2BooleanLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  957 */         if (Object2BooleanLinkedOpenCustomHashMap.this.strategy.equals(Object2BooleanLinkedOpenCustomHashMap.this.key[pos], k)) return Object2BooleanLinkedOpenCustomHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/*  958 */         pos = pos + 1 & Object2BooleanLinkedOpenCustomHashMap.this.mask;
/*      */       }
/*  960 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  968 */       int pos = HashCommon.murmurHash3(Object2BooleanLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2BooleanLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  970 */       while (Object2BooleanLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  971 */         if (Object2BooleanLinkedOpenCustomHashMap.this.strategy.equals(Object2BooleanLinkedOpenCustomHashMap.this.key[pos], k)) {
/*  972 */           Object2BooleanLinkedOpenCustomHashMap.this.remove(e.getKey());
/*  973 */           return true;
/*      */         }
/*  975 */         pos = pos + 1 & Object2BooleanLinkedOpenCustomHashMap.this.mask;
/*      */       }
/*  977 */       return false;
/*      */     }
/*      */     public int size() {
/*  980 */       return Object2BooleanLinkedOpenCustomHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  983 */       Object2BooleanLinkedOpenCustomHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator(Object2BooleanMap.Entry<K> from) {
/*  986 */       return new Object2BooleanLinkedOpenCustomHashMap.EntryIterator(Object2BooleanLinkedOpenCustomHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> fastIterator() {
/*  989 */       return new Object2BooleanLinkedOpenCustomHashMap.FastEntryIterator(Object2BooleanLinkedOpenCustomHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> fastIterator(Object2BooleanMap.Entry<K> from) {
/*  992 */       return new Object2BooleanLinkedOpenCustomHashMap.FastEntryIterator(Object2BooleanLinkedOpenCustomHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Object2BooleanLinkedOpenCustomHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2BooleanMap.Entry<K>>
/*      */   {
/*  912 */     final AbstractObject2BooleanMap.BasicEntry<K> entry = new AbstractObject2BooleanMap.BasicEntry(null, false);
/*      */ 
...
/*  918 */       int e = nextEntry();
/*  919 */       this.entry.key = Object2BooleanLinkedOpenCustomHashMap.this.key[e];
/*  920 */       this.entry.value = Object2BooleanLinkedOpenCustomHashMap.this.value[e];
/*  921 */       return this.entry;
/*      */     }
/*      */     public AbstractObject2BooleanMap.BasicEntry<K> previous() {
/*  924 */       int e = previousEntry();
/*  925 */       this.entry.key = Object2BooleanLinkedOpenCustomHashMap.this.key[e];
/*  926 */       this.entry.value = Object2BooleanLinkedOpenCustomHashMap.this.value[e];
/*  927 */       return this.entry;
/*      */     }
/*  929 */     public void set(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  930 */     public void add(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2BooleanLinkedOpenCustomHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2BooleanMap.Entry<K>>
/*      */   {
...
/*  898 */       return this.entry = new Object2BooleanLinkedOpenCustomHashMap.MapEntry(Object2BooleanLinkedOpenCustomHashMap.this, nextEntry());
/*      */     }
/*      */     public Object2BooleanLinkedOpenCustomHashMap<K>.MapEntry previous() {
/*  901 */       return this.entry = new Object2BooleanLinkedOpenCustomHashMap.MapEntry(Object2BooleanLinkedOpenCustomHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  905 */       super.remove();
/*  906 */       Object2BooleanLinkedOpenCustomHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  908 */     public void set(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  909 */     public void add(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  770 */     int index = -1;
/*      */ 
/*  772 */     private MapIterator() { this.next = Object2BooleanLinkedOpenCustomHashMap.this.first;
/*  773 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  776 */       if (Object2BooleanLinkedOpenCustomHashMap.this.strategy.equals(Object2BooleanLinkedOpenCustomHashMap.this.key[Object2BooleanLinkedOpenCustomHashMap.this.last], from)) {
/*  777 */         this.prev = Object2BooleanLinkedOpenCustomHashMap.this.last;
/*  778 */         this.index = Object2BooleanLinkedOpenCustomHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  782 */         int pos = HashCommon.murmurHash3(Object2BooleanLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2BooleanLinkedOpenCustomHashMap.this.mask;
/*      */ 
/*  784 */         while (Object2BooleanLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  785 */           if (Object2BooleanLinkedOpenCustomHashMap.this.strategy.equals(Object2BooleanLinkedOpenCustomHashMap.this.key[pos], from))
/*      */           {
/*  787 */             this.next = ((int)Object2BooleanLinkedOpenCustomHashMap.this.link[pos]);
/*  788 */             this.prev = pos;
/*  789 */             return;
/*      */           }
/*  791 */           pos = pos + 1 & Object2BooleanLinkedOpenCustomHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  804 */       if (this.next == -1) {
/*  805 */         this.index = Object2BooleanLinkedOpenCustomHashMap.this.size;
/*  806 */         return;
/*      */       }
/*  808 */       int pos = Object2BooleanLinkedOpenCustomHashMap.this.first;
/*  809 */       this.index = 1;
/*  810 */       while (pos != this.prev) {
/*  811 */         pos = (int)Object2BooleanLinkedOpenCustomHashMap.this.link[pos];
/*  812 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  824 */       if (!hasNext()) return Object2BooleanLinkedOpenCustomHashMap.this.size();
/*  825 */       this.curr = this.next;
/*  826 */       this.next = ((int)Object2BooleanLinkedOpenCustomHashMap.this.link[this.curr]);
...
/*  834 */       this.prev = ((int)(Object2BooleanLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  846 */         this.index -= 1;
/*  847 */         this.prev = ((int)(Object2BooleanLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  850 */         this.next = ((int)Object2BooleanLinkedOpenCustomHashMap.this.link[this.curr]);
/*  851 */       }Object2BooleanLinkedOpenCustomHashMap.this.size -= 1;
/*      */ 
/*  854 */       if (this.prev == -1) Object2BooleanLinkedOpenCustomHashMap.this.first = this.next;
/*      */       else
/*  856 */         Object2BooleanLinkedOpenCustomHashMap.this.link[this.prev] ^= (Object2BooleanLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  857 */       if (this.next == -1) Object2BooleanLinkedOpenCustomHashMap.this.last = this.prev;
/*      */       else
/*  859 */         Object2BooleanLinkedOpenCustomHashMap.this.link[this.next] ^= (Object2BooleanLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  863 */         pos = (last = pos) + 1 & Object2BooleanLinkedOpenCustomHashMap.this.mask;
/*  864 */         while (Object2BooleanLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  865 */           int slot = HashCommon.murmurHash3(Object2BooleanLinkedOpenCustomHashMap.this.strategy.hashCode(Object2BooleanLinkedOpenCustomHashMap.this.key[pos])) & Object2BooleanLinkedOpenCustomHashMap.this.mask;
/*  866 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  867 */           pos = pos + 1 & Object2BooleanLinkedOpenCustomHashMap.this.mask;
/*      */         }
/*  869 */         if (Object2BooleanLinkedOpenCustomHashMap.this.used[pos] == 0) break;
/*  870 */         Object2BooleanLinkedOpenCustomHashMap.this.key[last] = Object2BooleanLinkedOpenCustomHashMap.this.key[pos];
/*  871 */         Object2BooleanLinkedOpenCustomHashMap.this.value[last] = Object2BooleanLinkedOpenCustomHashMap.this.value[pos];
/*  872 */         if (this.next == pos) this.next = last;
/*  873 */         if (this.prev == pos) this.prev = last;
/*  874 */         Object2BooleanLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*      */       }
/*  876 */       Object2BooleanLinkedOpenCustomHashMap.this.used[last] = false;
/*  877 */       Object2BooleanLinkedOpenCustomHashMap.this.key[last] = null;
/*  878 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  639 */       return Object2BooleanLinkedOpenCustomHashMap.this.key[this.index];
/*      */     }
/*      */     public Boolean getValue() {
/*  642 */       return Boolean.valueOf(Object2BooleanLinkedOpenCustomHashMap.this.value[this.index]);
/*      */     }
/*      */     public boolean getBooleanValue() {
/*  645 */       return Object2BooleanLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */     public boolean setValue(boolean v) {
/*  648 */       boolean oldValue = Object2BooleanLinkedOpenCustomHashMap.this.value[this.index];
/*  649 */       Object2BooleanLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  650 */       return oldValue;
/*      */     }
/*      */     public Boolean setValue(Boolean v) {
/*  653 */       return Boolean.valueOf(setValue(v.booleanValue()));
/*      */     }
/*      */ 
/*      */     public boolean equals(Object o) {
/*  657 */       if (!(o instanceof Map.Entry)) return false;
/*  658 */       Map.Entry e = (Map.Entry)o;
/*  659 */       return (Object2BooleanLinkedOpenCustomHashMap.this.strategy.equals(Object2BooleanLinkedOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2BooleanLinkedOpenCustomHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     public int hashCode() {
/*  662 */       return Object2BooleanLinkedOpenCustomHashMap.this.strategy.hashCode(Object2BooleanLinkedOpenCustomHashMap.this.key[this.index]) ^ (Object2BooleanLinkedOpenCustomHashMap.this.value[this.index] != 0 ? 1231 : 1237);
/*      */     }
/*      */     public String toString() {
/*  665 */       return Object2BooleanLinkedOpenCustomHashMap.this.key[this.index] + "=>" + Object2BooleanLinkedOpenCustomHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
