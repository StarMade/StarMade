...
/*  17:    */
/*  89:    */public class Reference2IntOpenCustomHashMap<K>
/*  90:    */  extends AbstractReference2IntMap<K>
...
/* 103:    */  protected volatile transient Reference2IntMap.FastEntrySet<K> entries;
...
/* 107:    */  
/* 108:    */  public Reference2IntOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy)
/* 109:    */  {
...
/* 120:    */  }
/* 121:    */  
/* 125:    */  public Reference2IntOpenCustomHashMap(int expected, Hash.Strategy<K> strategy)
/* 126:    */  {
/* 127:127 */    this(expected, 0.75F, strategy);
/* 128:    */  }
/* 129:    */  
/* 132:    */  public Reference2IntOpenCustomHashMap(Hash.Strategy<K> strategy)
/* 133:    */  {
/* 134:134 */    this(16, 0.75F, strategy);
/* 135:    */  }
/* 136:    */  
/* 141:    */  public Reference2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> m, float f, Hash.Strategy<K> strategy)
/* 142:    */  {
/* 143:143 */    this(m.size(), f, strategy);
/* 144:144 */    putAll(m);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Reference2IntOpenCustomHashMap(Map<? extends K, ? extends Integer> m, Hash.Strategy<K> strategy)
/* 151:    */  {
/* 152:152 */    this(m, 0.75F, strategy);
/* 153:    */  }
/* 154:    */  
/* 159:    */  public Reference2IntOpenCustomHashMap(Reference2IntMap<K> m, float f, Hash.Strategy<K> strategy)
/* 160:    */  {
/* 161:161 */    this(m.size(), f, strategy);
/* 162:162 */    putAll(m);
/* 163:    */  }
/* 164:    */  
/* 168:    */  public Reference2IntOpenCustomHashMap(Reference2IntMap<K> m, Hash.Strategy<K> strategy)
/* 169:    */  {
/* 170:170 */    this(m, 0.75F, strategy);
/* 171:    */  }
/* 172:    */  
/* 179:    */  public Reference2IntOpenCustomHashMap(K[] k, int[] v, float f, Hash.Strategy<K> strategy)
/* 180:    */  {
...
/* 185:    */  }
/* 186:    */  
/* 191:    */  public Reference2IntOpenCustomHashMap(K[] k, int[] v, Hash.Strategy<K> strategy)
/* 192:    */  {
...
/* 399:    */    implements Reference2IntMap.Entry<K>, Map.Entry<K, Integer>
/* 400:    */  {
...
/* 406:    */    }
/* 407:    */    
/* 408:408 */    public K getKey() { return Reference2IntOpenCustomHashMap.this.key[this.index]; }
/* 409:    */    
/* 410:    */    public Integer getValue() {
/* 411:411 */      return Integer.valueOf(Reference2IntOpenCustomHashMap.this.value[this.index]);
/* 412:    */    }
/* 413:    */    
/* 414:414 */    public int getIntValue() { return Reference2IntOpenCustomHashMap.this.value[this.index]; }
/* 415:    */    
/* 416:    */    public int setValue(int v) {
/* 417:417 */      int oldValue = Reference2IntOpenCustomHashMap.this.value[this.index];
/* 418:418 */      Reference2IntOpenCustomHashMap.this.value[this.index] = v;
...
/* 428:428 */      return (Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[this.index], e.getKey())) && (Reference2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/* 429:    */    }
/* 430:    */    
/* 431:431 */    public int hashCode() { return (Reference2IntOpenCustomHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2IntOpenCustomHashMap.this.key[this.index])) ^ Reference2IntOpenCustomHashMap.this.value[this.index]; }
/* 432:    */    
/* 434:434 */    public String toString() { return Reference2IntOpenCustomHashMap.this.key[this.index] + "=>" + Reference2IntOpenCustomHashMap.this.value[this.index]; } }
/* 435:    */  
...
/* 440:    */    
/* 441:441 */    private MapIterator() { this.pos = Reference2IntOpenCustomHashMap.this.n;
/* 442:    */      
/* 444:444 */      this.last = -1;
/* 445:    */      
/* 446:446 */      this.c = Reference2IntOpenCustomHashMap.this.size;
/* 447:    */      
/* 451:451 */      boolean[] used = Reference2IntOpenCustomHashMap.this.used;
...
/* 463:    */        
/* 464:464 */        int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntOpenCustomHashMap.this.mask;
/* 465:    */        
/* 466:466 */        while (Reference2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 467:467 */          if (Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[pos], k)) return pos;
/* 468:468 */          pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask;
/* 469:    */        }
/* 470:    */      }
/* 471:471 */      this.last = this.pos;
/* 472:    */      
/* 473:473 */      if (this.c != 0) {
/* 474:474 */        boolean[] used = Reference2IntOpenCustomHashMap.this.used;
...
/* 489:    */      for (;;)
/* 490:    */      {
/* 491:491 */        pos = (last = pos) + 1 & Reference2IntOpenCustomHashMap.this.mask;
/* 492:492 */        while (Reference2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 493:493 */          int slot = (Reference2IntOpenCustomHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2IntOpenCustomHashMap.this.key[pos]))) & Reference2IntOpenCustomHashMap.this.mask;
/* 494:494 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 495:495 */          pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask;
/* 496:    */        }
/* 497:497 */        if (Reference2IntOpenCustomHashMap.this.used[pos] == 0) break;
/* 498:498 */        if (pos < last)
/* 499:    */        {
/* 500:500 */          if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 501:501 */          this.wrapped.add(Reference2IntOpenCustomHashMap.this.key[pos]);
/* 502:    */        }
/* 503:503 */        Reference2IntOpenCustomHashMap.this.key[last] = Reference2IntOpenCustomHashMap.this.key[pos];
/* 504:504 */        Reference2IntOpenCustomHashMap.this.value[last] = Reference2IntOpenCustomHashMap.this.value[pos];
/* 505:    */      }
/* 506:506 */      Reference2IntOpenCustomHashMap.this.used[last] = false;
/* 507:507 */      Reference2IntOpenCustomHashMap.this.key[last] = null;
/* 508:508 */      return last;
/* 509:    */    }
/* 510:    */    
...
/* 514:    */      {
/* 515:515 */        Reference2IntOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 516:516 */        this.last = -1;
/* 517:517 */        return;
/* 518:    */      }
/* 519:519 */      Reference2IntOpenCustomHashMap.this.size -= 1;
...
/* 531:    */    } }
/* 532:    */  
/* 533:533 */  private class EntryIterator extends Reference2IntOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2IntMap.Entry<K>> { private EntryIterator() { super(null); }
/* 534:    */    
/* 535:    */    private Reference2IntOpenCustomHashMap<K>.MapEntry entry;
/* 536:536 */    public Reference2IntMap.Entry<K> next() { return this.entry = new Reference2IntOpenCustomHashMap.MapEntry(Reference2IntOpenCustomHashMap.this, nextEntry()); }
/* 537:    */    
/* 538:    */    public void remove()
/* 539:    */    {
/* 540:540 */      super.remove();
/* 541:541 */      Reference2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 542:    */    } }
/* 543:    */  
/* 544:544 */  private class FastEntryIterator extends Reference2IntOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Reference2IntMap.Entry<K>> { private FastEntryIterator() { super(null); }
/* 545:545 */    final AbstractReference2IntMap.BasicEntry<K> entry = new AbstractReference2IntMap.BasicEntry(null, 0);
/* 546:    */    
/* 547:547 */    public AbstractReference2IntMap.BasicEntry<K> next() { int e = nextEntry();
/* 548:548 */      this.entry.key = Reference2IntOpenCustomHashMap.this.key[e];
/* 549:549 */      this.entry.value = Reference2IntOpenCustomHashMap.this.value[e];
/* 550:550 */      return this.entry;
/* 551:    */    } }
/* 552:    */  
/* 553:    */  private final class MapEntrySet extends AbstractObjectSet<Reference2IntMap.Entry<K>> implements Reference2IntMap.FastEntrySet<K> { private MapEntrySet() {}
/* 554:    */    
/* 555:555 */    public ObjectIterator<Reference2IntMap.Entry<K>> iterator() { return new Reference2IntOpenCustomHashMap.EntryIterator(Reference2IntOpenCustomHashMap.this, null); }
/* 556:    */    
/* 557:    */    public ObjectIterator<Reference2IntMap.Entry<K>> fastIterator() {
/* 558:558 */      return new Reference2IntOpenCustomHashMap.FastEntryIterator(Reference2IntOpenCustomHashMap.this, null);
/* 559:    */    }
/* 560:    */    
...
/* 565:    */      
/* 566:566 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntOpenCustomHashMap.this.mask;
/* 567:    */      
/* 568:568 */      while (Reference2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 569:569 */        if (Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[pos], k)) return Reference2IntOpenCustomHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 570:570 */        pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask;
/* 571:    */      }
...
/* 579:    */      
/* 580:580 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntOpenCustomHashMap.this.mask;
/* 581:    */      
/* 582:582 */      while (Reference2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 583:583 */        if (Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[pos], k)) {
/* 584:584 */          Reference2IntOpenCustomHashMap.this.remove(e.getKey());
/* 585:585 */          return true;
/* 586:    */        }
/* 587:587 */        pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask;
/* 588:    */      }
/* 589:589 */      return false;
/* 590:    */    }
/* 591:    */    
/* 592:592 */    public int size() { return Reference2IntOpenCustomHashMap.this.size; }
/* 593:    */    
/* 595:595 */    public void clear() { Reference2IntOpenCustomHashMap.this.clear(); }
/* 596:    */  }
/* 597:    */  
/* 598:    */  public Reference2IntMap.FastEntrySet<K> reference2IntEntrySet() {
...
/* 606:    */    extends Reference2IntOpenCustomHashMap<K>.MapIterator
/* 607:    */    implements ObjectIterator<K>
/* 608:    */  {
/* 609:609 */    public KeyIterator() { super(null); }
/* 610:610 */    public K next() { return Reference2IntOpenCustomHashMap.this.key[nextEntry()]; } }
/* 611:    */  
/* 612:    */  private final class KeySet extends AbstractReferenceSet<K> { private KeySet() {}
/* 613:    */    
/* 614:614 */    public ObjectIterator<K> iterator() { return new Reference2IntOpenCustomHashMap.KeyIterator(Reference2IntOpenCustomHashMap.this); }
/* 615:    */    
/* 616:    */    public int size() {
/* 617:617 */      return Reference2IntOpenCustomHashMap.this.size;
/* 618:    */    }
/* 619:    */    
/* 620:620 */    public boolean contains(Object k) { return Reference2IntOpenCustomHashMap.this.containsKey(k); }
/* 621:    */    
/* 622:    */    public boolean remove(Object k) {
/* 623:623 */      int oldSize = Reference2IntOpenCustomHashMap.this.size;
/* 624:624 */      Reference2IntOpenCustomHashMap.this.remove(k);
/* 625:625 */      return Reference2IntOpenCustomHashMap.this.size != oldSize;
/* 626:    */    }
/* 627:    */    
/* 628:628 */    public void clear() { Reference2IntOpenCustomHashMap.this.clear(); }
/* 629:    */  }
/* 630:    */  
...
/* 639:    */    extends Reference2IntOpenCustomHashMap.MapIterator
/* 640:    */    implements IntIterator
/* 641:    */  {
/* 642:642 */    public ValueIterator() { super(null); }
/* 643:643 */    public int nextInt() { return Reference2IntOpenCustomHashMap.this.value[nextEntry()]; }
/* 644:644 */    public Integer next() { return Integer.valueOf(Reference2IntOpenCustomHashMap.this.value[nextEntry()]); }
/* 645:    */  }
/* 646:    */  
...
/* 649:649 */          return new Reference2IntOpenCustomHashMap.ValueIterator(Reference2IntOpenCustomHashMap.this);
/* 650:    */        }
/* 651:    */        
/* 652:652 */        public int size() { return Reference2IntOpenCustomHashMap.this.size; }
/* 653:    */        
/* 654:    */        public boolean contains(int v) {
/* 655:655 */          return Reference2IntOpenCustomHashMap.this.containsValue(v);
/* 656:    */        }
/* 657:    */        
/* 658:658 */        public void clear() { Reference2IntOpenCustomHashMap.this.clear(); }
/* 659:    */      };
/* 660:    */    }
...
/* 761:    */  }
/* 762:    */  
/* 766:    */  public Reference2IntOpenCustomHashMap<K> clone()
/* 767:    */  {
/* 768:    */    Reference2IntOpenCustomHashMap<K> c;
/* 769:    */    
/* 771:    */    try
/* 772:    */    {
/* 773:773 */      c = (Reference2IntOpenCustomHashMap)super.clone();
/* 774:    */    }
...
/* 811:811 */    Reference2IntOpenCustomHashMap<K>.MapIterator i = new MapIterator(null);
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.Reference2IntOpenCustomHashMap
