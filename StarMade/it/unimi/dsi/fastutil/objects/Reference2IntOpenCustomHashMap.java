...
/* 649 */           return new Reference2IntOpenCustomHashMap.ValueIterator(Reference2IntOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 652 */           return Reference2IntOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(int v) {
/* 655 */           return Reference2IntOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 658 */           Reference2IntOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 773 */       c = (Reference2IntOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Reference2IntOpenCustomHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 642 */       super(null); } 
/* 643 */     public int nextInt() { return Reference2IntOpenCustomHashMap.this.value[nextEntry()]; } 
/* 644 */     public Integer next() { return Integer.valueOf(Reference2IntOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 614 */       return new Reference2IntOpenCustomHashMap.KeyIterator(Reference2IntOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 617 */       return Reference2IntOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 620 */       return Reference2IntOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 623 */       int oldSize = Reference2IntOpenCustomHashMap.this.size;
/* 624 */       Reference2IntOpenCustomHashMap.this.remove(k);
/* 625 */       return Reference2IntOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 628 */       Reference2IntOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Reference2IntOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 609 */       super(null); } 
/* 610 */     public K next() { return Reference2IntOpenCustomHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
/*     */   private final class MapEntrySet extends AbstractObjectSet<Reference2IntMap.Entry<K>>
...
/*     */     {
/* 555 */       return new Reference2IntOpenCustomHashMap.EntryIterator(Reference2IntOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Reference2IntMap.Entry<K>> fastIterator() {
/* 558 */       return new Reference2IntOpenCustomHashMap.FastEntryIterator(Reference2IntOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 566 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntOpenCustomHashMap.this.mask;
/*     */ 
/* 568 */       while (Reference2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 569 */         if (Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[pos], k)) return Reference2IntOpenCustomHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 570 */         pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask;
/*     */       }
/* 572 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 580 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntOpenCustomHashMap.this.mask;
/*     */ 
/* 582 */       while (Reference2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 583 */         if (Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[pos], k)) {
/* 584 */           Reference2IntOpenCustomHashMap.this.remove(e.getKey());
/* 585 */           return true;
/*     */         }
/* 587 */         pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask;
/*     */       }
/* 589 */       return false;
/*     */     }
/*     */     public int size() {
/* 592 */       return Reference2IntOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 595 */       Reference2IntOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Reference2IntOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2IntMap.Entry<K>>
/*     */   {
/* 545 */     final AbstractReference2IntMap.BasicEntry<K> entry = new AbstractReference2IntMap.BasicEntry(null, 0);
/*     */ 
...
/* 547 */       int e = nextEntry();
/* 548 */       this.entry.key = Reference2IntOpenCustomHashMap.this.key[e];
/* 549 */       this.entry.value = Reference2IntOpenCustomHashMap.this.value[e];
/* 550 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Reference2IntOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2IntMap.Entry<K>>
/*     */   {
...
/* 536 */       return this.entry = new Reference2IntOpenCustomHashMap.MapEntry(Reference2IntOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 540 */       super.remove();
/* 541 */       Reference2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 441 */       this.pos = Reference2IntOpenCustomHashMap.this.n;
/*     */ 
/* 444 */       this.last = -1;
/*     */ 
/* 446 */       this.c = Reference2IntOpenCustomHashMap.this.size;
/*     */ 
/* 451 */       boolean[] used = Reference2IntOpenCustomHashMap.this.used;
...
/*     */ 
/* 464 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntOpenCustomHashMap.this.mask;
/*     */ 
/* 466 */         while (Reference2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 467 */           if (Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[pos], k)) return pos;
/* 468 */           pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 471 */       this.last = this.pos;
/*     */ 
/* 473 */       if (this.c != 0) {
/* 474 */         boolean[] used = Reference2IntOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 491 */         pos = (last = pos) + 1 & Reference2IntOpenCustomHashMap.this.mask;
/* 492 */         while (Reference2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 493 */           int slot = (Reference2IntOpenCustomHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2IntOpenCustomHashMap.this.key[pos]))) & Reference2IntOpenCustomHashMap.this.mask;
/* 494 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 495 */           pos = pos + 1 & Reference2IntOpenCustomHashMap.this.mask;
/*     */         }
/* 497 */         if (Reference2IntOpenCustomHashMap.this.used[pos] == 0) break;
/* 498 */         if (pos < last)
/*     */         {
/* 500 */           if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 501 */           this.wrapped.add(Reference2IntOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 503 */         Reference2IntOpenCustomHashMap.this.key[last] = Reference2IntOpenCustomHashMap.this.key[pos];
/* 504 */         Reference2IntOpenCustomHashMap.this.value[last] = Reference2IntOpenCustomHashMap.this.value[pos];
/*     */       }
/* 506 */       Reference2IntOpenCustomHashMap.this.used[last] = false;
/* 507 */       Reference2IntOpenCustomHashMap.this.key[last] = null;
/* 508 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 513 */       if (this.pos < -1)
/*     */       {
/* 515 */         Reference2IntOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 516 */         this.last = -1;
/* 517 */         return;
/*     */       }
/* 519 */       Reference2IntOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 408 */       return Reference2IntOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Integer getValue() {
/* 411 */       return Integer.valueOf(Reference2IntOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public int getIntValue() {
/* 414 */       return Reference2IntOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public int setValue(int v) {
/* 417 */       int oldValue = Reference2IntOpenCustomHashMap.this.value[this.index];
/* 418 */       Reference2IntOpenCustomHashMap.this.value[this.index] = v;
/* 419 */       return oldValue;
/*     */     }
...
/* 428 */       return (Reference2IntOpenCustomHashMap.this.strategy.equals(Reference2IntOpenCustomHashMap.this.key[this.index], e.getKey())) && (Reference2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */     public int hashCode() {
/* 431 */       return (Reference2IntOpenCustomHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2IntOpenCustomHashMap.this.key[this.index])) ^ Reference2IntOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 434 */       return Reference2IntOpenCustomHashMap.this.key[this.index] + "=>" + Reference2IntOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
