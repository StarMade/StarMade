...
/* 235 */     public ObjectSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2ReferenceEntrySet()); return this.entries; } 
...
/* 189 */     public ObjectSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2ReferenceEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Object2ReferenceMap.Entry<K, V>> object2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 142 */       return false;
/*     */     }
/* 144 */     public ObjectSet<Map.Entry<K, V>> entrySet() { return object2ReferenceEntrySet(); } 
/* 145 */     public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ (this.value == null ? 0 : System.identityHashCode(this.value)); } 
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Object2ReferenceMaps.Singleton.this.key; } 
/* 132 */       public V getValue() { return Object2ReferenceMaps.Singleton.this.value; } 
...
/* 137 */         return (Object2ReferenceMaps.Singleton.this.key == null ? e.getKey() == null : Object2ReferenceMaps.Singleton.this.key.equals(e.getKey())) && (Object2ReferenceMaps.Singleton.this.value == e.getValue());
/*     */       }
/* 139 */       public int hashCode() { return (Object2ReferenceMaps.Singleton.this.key == null ? 0 : Object2ReferenceMaps.Singleton.this.key.hashCode()) ^ (Object2ReferenceMaps.Singleton.this.value == null ? 0 : System.identityHashCode(Object2ReferenceMaps.Singleton.this.value)); } 
/* 140 */       public String toString() { return Object2ReferenceMaps.Singleton.this.key + "->" + Object2ReferenceMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     }
/*  70 */     public ObjectSet<K> keySet() { return ObjectSets.EMPTY_SET; } 
/*     */     public ReferenceCollection<V> values() {
/*  72 */       return ReferenceSets.EMPTY_SET; } 
/*  73 */     private Object readResolve() { return Object2ReferenceMaps.EMPTY_MAP; } 
/*     */     public Object clone() {
/*  75 */       return Object2ReferenceMaps.EMPTY_MAP;
/*     */     }
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, V>> entrySet() {
/*  80 */       return object2ReferenceEntrySet();
/*     */     }
