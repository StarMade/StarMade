  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2BooleanOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2BooleanOpenHashMap(Map<? extends K, ? extends Boolean> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2BooleanOpenHashMap(Map<? extends K, ? extends Boolean> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2BooleanOpenHashMap(Reference2BooleanMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2BooleanOpenHashMap(Reference2BooleanMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2BooleanOpenHashMap(K[] local_k, boolean[] local_v, float local_f)
  {
  ...
  public Reference2BooleanOpenHashMap(K[] local_k, boolean[] local_v)
  {
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Reference2BooleanOpenHashMap.ValueIterator(Reference2BooleanOpenHashMap.this);
        }
        ...
        {
          return Reference2BooleanOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2BooleanOpenHashMap<K> local_c;
    try
    {
      local_c = (Reference2BooleanOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    boolean[] value = this.value;
    Reference2BooleanOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Reference2BooleanOpenHashMap.MapIterator
    ...
    extends AbstractReferenceSet<K>
  {
    ...
    {
      return new Reference2BooleanOpenHashMap.KeyIterator(Reference2BooleanOpenHashMap.this);
    }
    ...
    {
      return Reference2BooleanOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2BooleanOpenHashMap.this.size;
      Reference2BooleanOpenHashMap.this.remove(local_k);
    ...
    implements Reference2BooleanMap.FastEntrySet<K>
  {
    ...
    {
      return new Reference2BooleanOpenHashMap.EntryIterator(Reference2BooleanOpenHashMap.this, null);
    }
    
    public ObjectIterator<Reference2BooleanMap.Entry<K>> fastIterator()
    {
      return new Reference2BooleanOpenHashMap.FastEntryIterator(Reference2BooleanOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2BooleanOpenHashMap.this.mask; Reference2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2BooleanOpenHashMap.this.mask) {
        if (Reference2BooleanOpenHashMap.this.key[pos] == local_k) {
          return Reference2BooleanOpenHashMap.this.value[pos] == ((Boolean)local_e.getValue()).booleanValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2BooleanOpenHashMap.this.mask; Reference2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2BooleanOpenHashMap.this.mask) {
        if (Reference2BooleanOpenHashMap.this.key[pos] == local_k)
        {
          Reference2BooleanOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Reference2BooleanMap.Entry<K>>
  {
    ...
    public AbstractReference2BooleanMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Reference2BooleanOpenHashMap.this.key[local_e];
      this.entry.value = Reference2BooleanOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Reference2BooleanMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Reference2BooleanOpenHashMap.MapEntry(Reference2BooleanOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2BooleanOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Reference2BooleanOpenHashMap.this.field_49;
    int last = -1;
    int field_1853 = Reference2BooleanOpenHashMap.this.size;
    ReferenceArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Reference2BooleanOpenHashMap.this.used;
      while ((this.field_1853 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1853 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1853 != 0)
      {
        boolean[] local_k = Reference2BooleanOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2BooleanOpenHashMap.this.mask; Reference2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2BooleanOpenHashMap.this.mask)
        {
          int slot = (Reference2BooleanOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2BooleanOpenHashMap.this.key[pos]))) & Reference2BooleanOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Reference2BooleanOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Reference2BooleanOpenHashMap.this.key[pos]);
        }
        Reference2BooleanOpenHashMap.this.key[last] = Reference2BooleanOpenHashMap.this.key[pos];
        Reference2BooleanOpenHashMap.this.value[last] = Reference2BooleanOpenHashMap.this.value[pos];
      }
      Reference2BooleanOpenHashMap.this.used[last] = false;
      Reference2BooleanOpenHashMap.this.key[last] = null;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Reference2BooleanOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
        this.last = -1;
        return;
      }
      Reference2BooleanOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1853 > 0))
      {
        this.field_1853 += 1;
        nextEntry();
      }
    ...
    implements Reference2BooleanMap.Entry<K>, Map.Entry<K, Boolean>
  {
    ...
    public boolean setValue(boolean local_v)
    {
      ...
      Reference2BooleanOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Boolean> local_e = (Map.Entry)local_o;
      return (Reference2BooleanOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2BooleanOpenHashMap.this.value[this.index] == ((Boolean)local_e.getValue()).booleanValue());
    }
    
    public int hashCode()
    {
      return (Reference2BooleanOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2BooleanOpenHashMap.this.key[this.index])) ^ (Reference2BooleanOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
    }
