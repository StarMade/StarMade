  ...
  implements Reference2DoubleMap<K>, Serializable
{
  ...
  public void putAll(Map<? extends K, ? extends Double> local_m)
  {
    ...
    if ((local_m instanceof Reference2DoubleMap)) {
      while (local_n-- != 0)
      {
        Reference2DoubleMap.Entry<? extends K> local_e = (Reference2DoubleMap.Entry)local_i.next();
  ...
  public ReferenceSet<K> keySet()
  {
    new AbstractReferenceSet()
    {
      ...
      {
        return AbstractReference2DoubleMap.this.containsKey(local_k);
      }
      ...
      public ObjectIterator<K> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Double>> field_3 = AbstractReference2DoubleMap.this.entrySet().iterator();
          
          public K next()
          {
            return ((Reference2DoubleMap.Entry)this.field_3.next()).getKey();
          }
  ...
  public DoubleCollection values()
  {
    new AbstractDoubleCollection()
    {
      ...
      {
        return AbstractReference2DoubleMap.this.containsValue(local_k);
      }
      ...
      public DoubleIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Double>> field_68 = AbstractReference2DoubleMap.this.entrySet().iterator();
          
          public double nextDouble()
          {
            return ((Reference2DoubleMap.Entry)this.field_68.next()).getDoubleValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Reference2DoubleMap.Entry<K> local_e = (Reference2DoubleMap.Entry)local_i.next();
    ...
    implements Reference2DoubleMap.Entry<K>
  {
    ...
    public boolean equals(Object local_o)
    {
      ...
      return (this.key == local_e.getKey()) && (this.value == ((Double)local_e.getValue()).doubleValue());
    }
