...
/*      */         int tmp73_72 = pos;
/*      */         short[] tmp73_69 = this.value; tmp73_69[tmp73_72] = ((short)(tmp73_69[tmp73_72] + incr));
/*  311 */         return oldValue;
/*      */       }
...
/*  774 */   public Object2ShortSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  775 */   public Object2ShortSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  776 */   public Object2ShortSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1092 */           return new Object2ShortLinkedOpenHashMap.ValueIterator(Object2ShortLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1095 */           return Object2ShortLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(short v) {
/* 1098 */           return Object2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1101 */           Object2ShortLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1234 */       c = (Object2ShortLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public short previousShort()
/*      */     {
/* 1079 */       return Object2ShortLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1080 */     public Short previous() { return Short.valueOf(Object2ShortLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1086 */     public short nextShort() { return Object2ShortLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1087 */     public Short next() { return Short.valueOf(Object2ShortLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1036 */       return new Object2ShortLinkedOpenHashMap.KeyIterator(Object2ShortLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1039 */       return new Object2ShortLinkedOpenHashMap.KeyIterator(Object2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1042 */       return Object2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1045 */       return Object2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1048 */       int oldSize = Object2ShortLinkedOpenHashMap.this.size;
/* 1049 */       Object2ShortLinkedOpenHashMap.this.remove(k);
/* 1050 */       return Object2ShortLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1053 */       Object2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1056 */       if (Object2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057 */       return Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1060 */       if (Object2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061 */       return Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2ShortLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1027 */       super(k, null); } 
/* 1028 */     public K previous() { return Object2ShortLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1032 */     public K next() { return Object2ShortLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  955 */       return new Object2ShortLinkedOpenHashMap.EntryIterator(Object2ShortLinkedOpenHashMap.this);
/*      */     }
/*  957 */     public Comparator<? super Object2ShortMap.Entry<K>> comparator() { return null; } 
/*  958 */     public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> fromElement, Object2ShortMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  959 */     public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  960 */     public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(Object2ShortMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Object2ShortMap.Entry<K> first() {
/*  962 */       if (Object2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963 */       return new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, Object2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Object2ShortMap.Entry<K> last() {
/*  966 */       if (Object2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967 */       return new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, Object2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  975 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  977 */       while (Object2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  978 */         if (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2ShortLinkedOpenHashMap.this.key[pos].equals(k)) return Object2ShortLinkedOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/*  979 */         pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/*  981 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  989 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  991 */       while (Object2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  992 */         if (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2ShortLinkedOpenHashMap.this.key[pos].equals(k)) {
/*  993 */           Object2ShortLinkedOpenHashMap.this.remove(e.getKey());
/*  994 */           return true;
/*      */         }
/*  996 */         pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/*  998 */       return false;
/*      */     }
/*      */     public int size() {
/* 1001 */       return Object2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1004 */       Object2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> from) {
/* 1007 */       return new Object2ShortLinkedOpenHashMap.EntryIterator(Object2ShortLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator() {
/* 1010 */       return new Object2ShortLinkedOpenHashMap.FastEntryIterator(Object2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator(Object2ShortMap.Entry<K> from) {
/* 1013 */       return new Object2ShortLinkedOpenHashMap.FastEntryIterator(Object2ShortLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Object2ShortLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2ShortMap.Entry<K>>
/*      */   {
/*  933 */     final AbstractObject2ShortMap.BasicEntry<K> entry = new AbstractObject2ShortMap.BasicEntry(null, (short)0);
/*      */ 
...
/*  939 */       int e = nextEntry();
/*  940 */       this.entry.key = Object2ShortLinkedOpenHashMap.this.key[e];
/*  941 */       this.entry.value = Object2ShortLinkedOpenHashMap.this.value[e];
/*  942 */       return this.entry;
/*      */     }
/*      */     public AbstractObject2ShortMap.BasicEntry<K> previous() {
/*  945 */       int e = previousEntry();
/*  946 */       this.entry.key = Object2ShortLinkedOpenHashMap.this.key[e];
/*  947 */       this.entry.value = Object2ShortLinkedOpenHashMap.this.value[e];
/*  948 */       return this.entry;
/*      */     }
/*  950 */     public void set(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  951 */     public void add(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2ShortLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2ShortMap.Entry<K>>
/*      */   {
...
/*  919 */       return this.entry = new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Object2ShortLinkedOpenHashMap<K>.MapEntry previous() {
/*  922 */       return this.entry = new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  926 */       super.remove();
/*  927 */       Object2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  929 */     public void set(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  930 */     public void add(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  791 */     int index = -1;
/*      */ 
/*  793 */     private MapIterator() { this.next = Object2ShortLinkedOpenHashMap.this.first;
/*  794 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  797 */       if (Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last] == null ? from == null : Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last].equals(from)) {
/*  798 */         this.prev = Object2ShortLinkedOpenHashMap.this.last;
/*  799 */         this.index = Object2ShortLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  803 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  805 */         while (Object2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  806 */           if (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2ShortLinkedOpenHashMap.this.key[pos].equals(from))
/*      */           {
/*  808 */             this.next = ((int)Object2ShortLinkedOpenHashMap.this.link[pos]);
/*  809 */             this.prev = pos;
/*  810 */             return;
/*      */           }
/*  812 */           pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  825 */       if (this.next == -1) {
/*  826 */         this.index = Object2ShortLinkedOpenHashMap.this.size;
/*  827 */         return;
/*      */       }
/*  829 */       int pos = Object2ShortLinkedOpenHashMap.this.first;
/*  830 */       this.index = 1;
/*  831 */       while (pos != this.prev) {
/*  832 */         pos = (int)Object2ShortLinkedOpenHashMap.this.link[pos];
/*  833 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  845 */       if (!hasNext()) return Object2ShortLinkedOpenHashMap.this.size();
/*  846 */       this.curr = this.next;
/*  847 */       this.next = ((int)Object2ShortLinkedOpenHashMap.this.link[this.curr]);
...
/*  855 */       this.prev = ((int)(Object2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  867 */         this.index -= 1;
/*  868 */         this.prev = ((int)(Object2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  871 */         this.next = ((int)Object2ShortLinkedOpenHashMap.this.link[this.curr]);
/*  872 */       }Object2ShortLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  875 */       if (this.prev == -1) Object2ShortLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  877 */         Object2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Object2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878 */       if (this.next == -1) Object2ShortLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  880 */         Object2ShortLinkedOpenHashMap.this.link[this.next] ^= (Object2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  884 */         pos = (last = pos) + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*  885 */         while (Object2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */           int slot = (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ShortLinkedOpenHashMap.this.key[pos].hashCode())) & Object2ShortLinkedOpenHashMap.this.mask;
/*  887 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888 */           pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*      */         }
/*  890 */         if (Object2ShortLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891 */         Object2ShortLinkedOpenHashMap.this.key[last] = Object2ShortLinkedOpenHashMap.this.key[pos];
/*  892 */         Object2ShortLinkedOpenHashMap.this.value[last] = Object2ShortLinkedOpenHashMap.this.value[pos];
/*  893 */         if (this.next == pos) this.next = last;
/*  894 */         if (this.prev == pos) this.prev = last;
/*  895 */         Object2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  897 */       Object2ShortLinkedOpenHashMap.this.used[last] = false;
/*  898 */       Object2ShortLinkedOpenHashMap.this.key[last] = null;
/*  899 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  660 */       return Object2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Short getValue() {
/*  663 */       return Short.valueOf(Object2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public short getShortValue() {
/*  666 */       return Object2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public short setValue(short v) {
/*  669 */       short oldValue = Object2ShortLinkedOpenHashMap.this.value[this.index];
/*  670 */       Object2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  671 */       return oldValue;
/*      */     }
/*      */     public Short setValue(Short v) {
...
/*  680 */       return (Object2ShortLinkedOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2ShortLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     public int hashCode() {
/*  683 */       return (Object2ShortLinkedOpenHashMap.this.key[this.index] == null ? 0 : Object2ShortLinkedOpenHashMap.this.key[this.index].hashCode()) ^ Object2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  686 */       return Object2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Object2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
