  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2ShortLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Object2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ShortLinkedOpenHashMap(Object2ShortMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2ShortLinkedOpenHashMap(Object2ShortMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2ShortLinkedOpenHashMap(K[] local_k, short[] local_v, float local_f)
  {
  ...
  public Object2ShortLinkedOpenHashMap(K[] local_k, short[] local_v)
  {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Object2ShortLinkedOpenHashMap.ValueIterator(Object2ShortLinkedOpenHashMap.this);
        }
        ...
        {
          return Object2ShortLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2ShortLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Object2ShortLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    short[] value = this.value;
    Object2ShortLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2ShortLinkedOpenHashMap.MapIterator
    implements ShortListIterator
  {
    ...
    {
      return Short.valueOf(Object2ShortLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Short next()
    {
      return Short.valueOf(Object2ShortLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractObjectSortedSet<K>
  {
    ...
    {
      return new Object2ShortLinkedOpenHashMap.KeyIterator(Object2ShortLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Object2ShortLinkedOpenHashMap.KeyIterator(Object2ShortLinkedOpenHashMap.this);
    }
    ...
    {
      return Object2ShortLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2ShortLinkedOpenHashMap.this.size;
      Object2ShortLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Object2ShortSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Object2ShortLinkedOpenHashMap.EntryIterator(Object2ShortLinkedOpenHashMap.this);
    }
    ...
    public Object2ShortMap.Entry<K> first()
    {
      ...
      return new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, Object2ShortLinkedOpenHashMap.this.first);
    }
    ...
    public Object2ShortMap.Entry<K> last()
    {
      ...
      return new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, Object2ShortLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ShortLinkedOpenHashMap.this.mask; Object2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask) {
        if (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2ShortLinkedOpenHashMap.this.key[pos].equals(local_k)) {
          return Object2ShortLinkedOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2ShortLinkedOpenHashMap.this.mask; Object2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask) {
        if (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2ShortLinkedOpenHashMap.this.key[pos].equals(local_k))
        {
          Object2ShortLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Object2ShortLinkedOpenHashMap.EntryIterator(Object2ShortLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator()
    {
      return new Object2ShortLinkedOpenHashMap.FastEntryIterator(Object2ShortLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator(Object2ShortMap.Entry<K> from)
    {
      return new Object2ShortLinkedOpenHashMap.FastEntryIterator(Object2ShortLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Object2ShortMap.Entry<K>>
  {
    ...
    public AbstractObject2ShortMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2ShortLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Object2ShortLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Object2ShortMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, nextEntry());
    }
    
    public Object2ShortLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2ShortLinkedOpenHashMap.this.mask; Object2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask) {
          if (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2ShortLinkedOpenHashMap.this.key[pos].equals(from))
          {
    ...
    public void remove()
    {
      ...
      Object2ShortLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Object2ShortLinkedOpenHashMap.this.first = this.next;
      } else {
        Object2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Object2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Object2ShortLinkedOpenHashMap.this.last = this.prev;
      } else {
        Object2ShortLinkedOpenHashMap.this.link[this.next] ^= (Object2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2ShortLinkedOpenHashMap.this.mask; Object2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask)
        {
          int slot = (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ShortLinkedOpenHashMap.this.key[pos].hashCode())) & Object2ShortLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2ShortLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Object2ShortLinkedOpenHashMap.this.key[last] = Object2ShortLinkedOpenHashMap.this.key[pos];
      ...
      Object2ShortLinkedOpenHashMap.this.used[last] = false;
      Object2ShortLinkedOpenHashMap.this.key[last] = null;
      this.curr = -1;
    }
    ...
    implements Object2ShortMap.Entry<K>, Map.Entry<K, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Object2ShortLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Short> local_e = (Map.Entry)local_o;
      return (Object2ShortLinkedOpenHashMap.this.key[this.index] == null ? local_e.getKey() == null : Object2ShortLinkedOpenHashMap.this.key[this.index].equals(local_e.getKey())) && (Object2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
