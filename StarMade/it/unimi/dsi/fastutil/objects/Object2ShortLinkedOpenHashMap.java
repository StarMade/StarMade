...
/*   18:     */
/*  113:     */public class Object2ShortLinkedOpenHashMap<K>
...
/*  141:     */  
/*  149:     */  public Object2ShortLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Object2ShortLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Object2ShortLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Object2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Object2ShortLinkedOpenHashMap(Map<? extends K, ? extends Short> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Object2ShortLinkedOpenHashMap(Object2ShortMap<K> m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Object2ShortLinkedOpenHashMap(Object2ShortMap<K> m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Object2ShortLinkedOpenHashMap(K[] k, short[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Object2ShortLinkedOpenHashMap(K[] k, short[] v)
/*  225:     */  {
...
/*  310: 310 */          tmp73_72 = pos; short[] tmp73_69 = this.value;tmp73_69[tmp73_72] = ((short)(tmp73_69[tmp73_72] + incr));
...
/*  651:     */    implements Object2ShortMap.Entry<K>, Map.Entry<K, Short>
/*  652:     */  {
...
/*  658:     */    }
/*  659:     */    
/*  660: 660 */    public K getKey() { return Object2ShortLinkedOpenHashMap.this.key[this.index]; }
/*  661:     */    
/*  662:     */    public Short getValue() {
/*  663: 663 */      return Short.valueOf(Object2ShortLinkedOpenHashMap.this.value[this.index]);
/*  664:     */    }
/*  665:     */    
/*  666: 666 */    public short getShortValue() { return Object2ShortLinkedOpenHashMap.this.value[this.index]; }
/*  667:     */    
/*  668:     */    public short setValue(short v) {
/*  669: 669 */      short oldValue = Object2ShortLinkedOpenHashMap.this.value[this.index];
/*  670: 670 */      Object2ShortLinkedOpenHashMap.this.value[this.index] = v;
...
/*  680: 680 */      return (Object2ShortLinkedOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2ShortLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*  681:     */    }
/*  682:     */    
/*  683: 683 */    public int hashCode() { return (Object2ShortLinkedOpenHashMap.this.key[this.index] == null ? 0 : Object2ShortLinkedOpenHashMap.this.key[this.index].hashCode()) ^ Object2ShortLinkedOpenHashMap.this.value[this.index]; }
/*  684:     */    
/*  685:     */    public String toString() {
/*  686: 686 */      return Object2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Object2ShortLinkedOpenHashMap.this.value[this.index];
/*  687:     */    }
/*  688:     */  }
/*  689:     */  
...
/*  774: 774 */  public Object2ShortSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  775: 775 */  public Object2ShortSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); }
/*  776: 776 */  public Object2ShortSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  777:     */  
...
/*  791: 791 */    int index = -1;
/*  792:     */    
/*  793: 793 */    private MapIterator() { this.next = Object2ShortLinkedOpenHashMap.this.first;
/*  794: 794 */      this.index = 0;
/*  795:     */    }
/*  796:     */    
/*  797: 797 */    private MapIterator() { if (Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last] == null ? from == null : Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last].equals(from)) {
/*  798: 798 */        this.prev = Object2ShortLinkedOpenHashMap.this.last;
/*  799: 799 */        this.index = Object2ShortLinkedOpenHashMap.this.size;
/*  800:     */      }
/*  801:     */      else
/*  802:     */      {
/*  803: 803 */        int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2ShortLinkedOpenHashMap.this.mask;
/*  804:     */        
/*  805: 805 */        while (Object2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  806: 806 */          if (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2ShortLinkedOpenHashMap.this.key[pos].equals(from))
/*  807:     */          {
/*  808: 808 */            this.next = ((int)Object2ShortLinkedOpenHashMap.this.link[pos]);
/*  809: 809 */            this.prev = pos;
/*  810: 810 */            return;
/*  811:     */          }
/*  812: 812 */          pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*  813:     */        }
...
/*  826: 826 */        this.index = Object2ShortLinkedOpenHashMap.this.size;
/*  827: 827 */        return;
/*  828:     */      }
/*  829: 829 */      int pos = Object2ShortLinkedOpenHashMap.this.first;
/*  830: 830 */      this.index = 1;
/*  831: 831 */      while (pos != this.prev) {
/*  832: 832 */        pos = (int)Object2ShortLinkedOpenHashMap.this.link[pos];
...
/*  843:     */    }
/*  844:     */    
/*  845: 845 */    public int nextEntry() { if (!hasNext()) return Object2ShortLinkedOpenHashMap.this.size();
/*  846: 846 */      this.curr = this.next;
/*  847: 847 */      this.next = ((int)Object2ShortLinkedOpenHashMap.this.link[this.curr]);
...
/*  855: 855 */      this.prev = ((int)(Object2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  868: 868 */        this.prev = ((int)(Object2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  869:     */      }
/*  870:     */      else {
/*  871: 871 */        this.next = ((int)Object2ShortLinkedOpenHashMap.this.link[this.curr]); }
/*  872: 872 */      Object2ShortLinkedOpenHashMap.this.size -= 1;
/*  873:     */      
/*  875: 875 */      if (this.prev == -1) { Object2ShortLinkedOpenHashMap.this.first = this.next;
/*  876:     */      } else
/*  877: 877 */        Object2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Object2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878: 878 */      if (this.next == -1) { Object2ShortLinkedOpenHashMap.this.last = this.prev;
/*  879:     */      } else
/*  880: 880 */        Object2ShortLinkedOpenHashMap.this.link[this.next] ^= (Object2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  881: 881 */      int pos = this.curr;
/*  882:     */      int last;
/*  883:     */      for (;;) {
/*  884: 884 */        pos = (last = pos) + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*  885: 885 */        while (Object2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  886: 886 */          int slot = (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ShortLinkedOpenHashMap.this.key[pos].hashCode())) & Object2ShortLinkedOpenHashMap.this.mask;
/*  887: 887 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888: 888 */          pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*  889:     */        }
/*  890: 890 */        if (Object2ShortLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891: 891 */        Object2ShortLinkedOpenHashMap.this.key[last] = Object2ShortLinkedOpenHashMap.this.key[pos];
/*  892: 892 */        Object2ShortLinkedOpenHashMap.this.value[last] = Object2ShortLinkedOpenHashMap.this.value[pos];
/*  893: 893 */        if (this.next == pos) this.next = last;
/*  894: 894 */        if (this.prev == pos) this.prev = last;
/*  895: 895 */        Object2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*  896:     */      }
/*  897: 897 */      Object2ShortLinkedOpenHashMap.this.used[last] = false;
/*  898: 898 */      Object2ShortLinkedOpenHashMap.this.key[last] = null;
/*  899: 899 */      this.curr = -1;
/*  900:     */    }
/*  901:     */    
...
/*  910:     */    } }
/*  911:     */  
/*  912:     */  private class EntryIterator extends Object2ShortLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Object2ShortMap.Entry<K>> { private Object2ShortLinkedOpenHashMap<K>.MapEntry entry;
/*  913:     */    
/*  914: 914 */    public EntryIterator() { super(null); }
/*  915:     */    
/*  916: 916 */    public EntryIterator() { super(from, null); }
/*  917:     */    
/*  918:     */    public Object2ShortLinkedOpenHashMap<K>.MapEntry next() {
/*  919: 919 */      return this.entry = new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, nextEntry());
/*  920:     */    }
/*  921:     */    
/*  922: 922 */    public Object2ShortLinkedOpenHashMap<K>.MapEntry previous() { return this.entry = new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, previousEntry()); }
/*  923:     */    
/*  924:     */    public void remove()
/*  925:     */    {
/*  926: 926 */      super.remove();
/*  927: 927 */      Object2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  928:     */    
/*  929: 929 */    public void set(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  930: 930 */    public void add(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  931:     */  }
/*  932:     */  
/*  933: 933 */  private class FastEntryIterator extends Object2ShortLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Object2ShortMap.Entry<K>> { final AbstractObject2ShortMap.BasicEntry<K> entry = new AbstractObject2ShortMap.BasicEntry(null, (short)0);
/*  934: 934 */    public FastEntryIterator() { super(null); }
/*  935:     */    
/*  936: 936 */    public FastEntryIterator() { super(from, null); }
/*  937:     */    
/*  938:     */    public AbstractObject2ShortMap.BasicEntry<K> next() {
/*  939: 939 */      int e = nextEntry();
/*  940: 940 */      this.entry.key = Object2ShortLinkedOpenHashMap.this.key[e];
/*  941: 941 */      this.entry.value = Object2ShortLinkedOpenHashMap.this.value[e];
/*  942: 942 */      return this.entry;
/*  943:     */    }
/*  944:     */    
/*  945: 945 */    public AbstractObject2ShortMap.BasicEntry<K> previous() { int e = previousEntry();
/*  946: 946 */      this.entry.key = Object2ShortLinkedOpenHashMap.this.key[e];
/*  947: 947 */      this.entry.value = Object2ShortLinkedOpenHashMap.this.value[e];
/*  948: 948 */      return this.entry; }
/*  949:     */    
/*  950: 950 */    public void set(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  951: 951 */    public void add(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); } }
/*  952:     */  
/*  953:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Object2ShortMap.Entry<K>> implements Object2ShortSortedMap.FastSortedEntrySet<K> { private MapEntrySet() {}
/*  954:     */    
/*  955: 955 */    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator() { return new Object2ShortLinkedOpenHashMap.EntryIterator(Object2ShortLinkedOpenHashMap.this); }
/*  956:     */    
/*  957: 957 */    public Comparator<? super Object2ShortMap.Entry<K>> comparator() { return null; }
/*  958: 958 */    public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> fromElement, Object2ShortMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  959: 959 */    public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  960: 960 */    public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(Object2ShortMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); }
/*  961:     */    
/*  962: 962 */    public Object2ShortMap.Entry<K> first() { if (Object2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963: 963 */      return new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, Object2ShortLinkedOpenHashMap.this.first);
/*  964:     */    }
/*  965:     */    
/*  966: 966 */    public Object2ShortMap.Entry<K> last() { if (Object2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967: 967 */      return new Object2ShortLinkedOpenHashMap.MapEntry(Object2ShortLinkedOpenHashMap.this, Object2ShortLinkedOpenHashMap.this.last);
/*  968:     */    }
/*  969:     */    
...
/*  974:     */      
/*  975: 975 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ShortLinkedOpenHashMap.this.mask;
/*  976:     */      
/*  977: 977 */      while (Object2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  978: 978 */        if (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2ShortLinkedOpenHashMap.this.key[pos].equals(k)) return Object2ShortLinkedOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/*  979: 979 */        pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*  980:     */      }
...
/*  988:     */      
/*  989: 989 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ShortLinkedOpenHashMap.this.mask;
/*  990:     */      
/*  991: 991 */      while (Object2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  992: 992 */        if (Object2ShortLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2ShortLinkedOpenHashMap.this.key[pos].equals(k)) {
/*  993: 993 */          Object2ShortLinkedOpenHashMap.this.remove(e.getKey());
/*  994: 994 */          return true;
/*  995:     */        }
/*  996: 996 */        pos = pos + 1 & Object2ShortLinkedOpenHashMap.this.mask;
/*  997:     */      }
/*  998: 998 */      return false;
/*  999:     */    }
/* 1000:     */    
/* 1001:1001 */    public int size() { return Object2ShortLinkedOpenHashMap.this.size; }
/* 1002:     */    
/* 1003:     */    public void clear() {
/* 1004:1004 */      Object2ShortLinkedOpenHashMap.this.clear();
/* 1005:     */    }
/* 1006:     */    
/* 1007:1007 */    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> from) { return new Object2ShortLinkedOpenHashMap.EntryIterator(Object2ShortLinkedOpenHashMap.this, from.getKey()); }
/* 1008:     */    
/* 1009:     */    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator() {
/* 1010:1010 */      return new Object2ShortLinkedOpenHashMap.FastEntryIterator(Object2ShortLinkedOpenHashMap.this);
/* 1011:     */    }
/* 1012:     */    
/* 1013:1013 */    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator(Object2ShortMap.Entry<K> from) { return new Object2ShortLinkedOpenHashMap.FastEntryIterator(Object2ShortLinkedOpenHashMap.this, from.getKey()); }
/* 1014:     */  }
/* 1015:     */  
/* 1016:     */  public Object2ShortSortedMap.FastSortedEntrySet<K> object2ShortEntrySet() {
...
/* 1024:     */    extends Object2ShortLinkedOpenHashMap<K>.MapIterator
/* 1025:     */    implements ObjectListIterator<K>
/* 1026:     */  {
/* 1027:1027 */    public KeyIterator() { super(k, null); }
/* 1028:1028 */    public K previous() { return Object2ShortLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1032:1032 */    public K next() { return Object2ShortLinkedOpenHashMap.this.key[nextEntry()]; } }
/* 1033:     */  
/* 1034:     */  private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/* 1035:     */    
/* 1036:1036 */    public ObjectListIterator<K> iterator(K from) { return new Object2ShortLinkedOpenHashMap.KeyIterator(Object2ShortLinkedOpenHashMap.this, from); }
/* 1037:     */    
/* 1038:     */    public ObjectListIterator<K> iterator() {
/* 1039:1039 */      return new Object2ShortLinkedOpenHashMap.KeyIterator(Object2ShortLinkedOpenHashMap.this);
/* 1040:     */    }
/* 1041:     */    
/* 1042:1042 */    public int size() { return Object2ShortLinkedOpenHashMap.this.size; }
/* 1043:     */    
/* 1045:1045 */    public boolean contains(Object k) { return Object2ShortLinkedOpenHashMap.this.containsKey(k); }
/* 1046:     */    
/* 1047:     */    public boolean remove(Object k) {
/* 1048:1048 */      int oldSize = Object2ShortLinkedOpenHashMap.this.size;
/* 1049:1049 */      Object2ShortLinkedOpenHashMap.this.remove(k);
/* 1050:1050 */      return Object2ShortLinkedOpenHashMap.this.size != oldSize;
/* 1051:     */    }
/* 1052:     */    
/* 1053:1053 */    public void clear() { Object2ShortLinkedOpenHashMap.this.clear(); }
/* 1054:     */    
/* 1055:     */    public K first() {
/* 1056:1056 */      if (Object2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057:1057 */      return Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.first];
/* 1058:     */    }
/* 1059:     */    
/* 1060:1060 */    public K last() { if (Object2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061:1061 */      return Object2ShortLinkedOpenHashMap.this.key[Object2ShortLinkedOpenHashMap.this.last]; }
/* 1062:     */    
...
/* 1076:     */    extends Object2ShortLinkedOpenHashMap.MapIterator
/* 1077:     */    implements ShortListIterator
/* 1078:     */  {
/* 1079:1079 */    public short previousShort() { return Object2ShortLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1080:1080 */    public Short previous() { return Short.valueOf(Object2ShortLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1086:1086 */    public short nextShort() { return Object2ShortLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1087:1087 */    public Short next() { return Short.valueOf(Object2ShortLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1088:     */  }
/* 1089:     */  
...
/* 1092:1092 */          return new Object2ShortLinkedOpenHashMap.ValueIterator(Object2ShortLinkedOpenHashMap.this);
/* 1093:     */        }
/* 1094:     */        
/* 1095:1095 */        public int size() { return Object2ShortLinkedOpenHashMap.this.size; }
/* 1096:     */        
/* 1097:     */        public boolean contains(short v) {
/* 1098:1098 */          return Object2ShortLinkedOpenHashMap.this.containsValue(v);
/* 1099:     */        }
/* 1100:     */        
/* 1101:1101 */        public void clear() { Object2ShortLinkedOpenHashMap.this.clear(); }
/* 1102:     */      };
/* 1103:     */    }
...
/* 1223:     */  }
/* 1224:     */  
/* 1227:     */  public Object2ShortLinkedOpenHashMap<K> clone()
/* 1228:     */  {
/* 1229:     */    Object2ShortLinkedOpenHashMap<K> c;
/* 1230:     */    
/* 1232:     */    try
/* 1233:     */    {
/* 1234:1234 */      c = (Object2ShortLinkedOpenHashMap)super.clone();
/* 1235:     */    }
...
/* 1272:1272 */    Object2ShortLinkedOpenHashMap<K>.MapIterator i = new MapIterator(null);
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.Object2ShortLinkedOpenHashMap
