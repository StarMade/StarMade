...
/*   8:    */
/*  56:    */public class Object2ObjectMaps
/*  57:    */{
/*  58:    */  public static class EmptyMap<K, V>
/*  59:    */    extends Object2ObjectFunctions.EmptyFunction<K, V>
/*  60:    */    implements Object2ObjectMap<K, V>, Serializable, Cloneable
/*  61:    */  {
...
/*  66:    */    
/*  67: 67 */    public ObjectSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() { return ObjectSets.EMPTY_SET; }
/*  68:    */    
/*  69: 69 */    public ObjectSet<K> keySet() { return ObjectSets.EMPTY_SET; }
/*  70:    */    
/*  71: 71 */    public ObjectCollection<V> values() { return ObjectSets.EMPTY_SET; }
/*  72:    */    
/*  73: 73 */    private Object readResolve() { return Object2ObjectMaps.EMPTY_MAP; }
/*  74:    */    
/*  75: 75 */    public Object clone() { return Object2ObjectMaps.EMPTY_MAP; }
/*  76:    */    
/*  77: 77 */    public boolean isEmpty() { return true; }
/*  78:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<K, V>> entrySet() { return object2ObjectEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Object2ObjectFunctions.Singleton<K, V>
/* 103:    */    implements Object2ObjectMap<K, V>, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Object2ObjectMap.Entry<K, V>> entries;
/* 108:    */    
...
/* 125:    */    
/* 126:126 */    public ObjectSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V> { protected SingletonEntry() {}
/* 131:131 */      public K getKey() { return Object2ObjectMaps.Singleton.this.key; }
/* 132:132 */      public V getValue() { return Object2ObjectMaps.Singleton.this.value; }
...
/* 137:137 */        return (Object2ObjectMaps.Singleton.this.key == null ? e.getKey() == null : Object2ObjectMaps.Singleton.this.key.equals(e.getKey())) && (Object2ObjectMaps.Singleton.this.value == null ? e.getValue() == null : Object2ObjectMaps.Singleton.this.value.equals(e.getValue())); }
/* 138:    */      
/* 139:139 */      public int hashCode() { return (Object2ObjectMaps.Singleton.this.key == null ? 0 : Object2ObjectMaps.Singleton.this.key.hashCode()) ^ (Object2ObjectMaps.Singleton.this.value == null ? 0 : Object2ObjectMaps.Singleton.this.value.hashCode()); }
/* 140:140 */      public String toString() { return Object2ObjectMaps.Singleton.this.key + "->" + Object2ObjectMaps.Singleton.this.value; } }
/* 141:    */    
/* 142:142 */    public boolean isEmpty() { return false; }
/* 143:    */    
/* 144:144 */    public ObjectSet<Map.Entry<K, V>> entrySet() { return object2ObjectEntrySet(); }
/* 145:145 */    public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ (this.value == null ? 0 : this.value.hashCode()); }
/* 146:    */    
...
/* 154:    */  }
/* 155:    */  
/* 164:164 */  public static <K, V> Object2ObjectMap<K, V> singleton(K key, V value) { return new Singleton(key, value); }
/* 165:    */  
/* 166:    */  public static class SynchronizedMap<K, V> extends Object2ObjectFunctions.SynchronizedFunction<K, V> implements Object2ObjectMap<K, V>, Serializable {
/* 167:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 168:    */    protected final Object2ObjectMap<K, V> map;
/* 169:    */    protected volatile transient ObjectSet<Object2ObjectMap.Entry<K, V>> entries;
/* 170:    */    protected volatile transient ObjectSet<K> keys;
/* 171:    */    protected volatile transient ObjectCollection<V> values;
/* 172:    */    
/* 173:    */    protected SynchronizedMap(Object2ObjectMap<K, V> m, Object sync) {
/* 174:174 */      super(sync);
/* 175:175 */      this.map = m;
/* 176:    */    }
/* 177:    */    
/* 178:178 */    protected SynchronizedMap(Object2ObjectMap<K, V> m) { super();
/* 179:179 */      this.map = m; }
/* 180:    */    
...
/* 189:189 */    public ObjectSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2ObjectEntrySet(), this.sync); return this.entries; }
...
/* 202:    */  }
/* 203:    */  
/* 205:    */  public static <K, V> Object2ObjectMap<K, V> synchronize(Object2ObjectMap<K, V> m)
/* 206:    */  {
/* 207:207 */    return new SynchronizedMap(m);
/* 208:    */  }
/* 209:    */  
/* 215:215 */  public static <K, V> Object2ObjectMap<K, V> synchronize(Object2ObjectMap<K, V> m, Object sync) { return new SynchronizedMap(m, sync); }
/* 216:    */  
/* 217:    */  public static class UnmodifiableMap<K, V> extends Object2ObjectFunctions.UnmodifiableFunction<K, V> implements Object2ObjectMap<K, V>, Serializable {
/* 218:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 219:    */    protected final Object2ObjectMap<K, V> map;
/* 220:    */    protected volatile transient ObjectSet<Object2ObjectMap.Entry<K, V>> entries;
/* 221:    */    protected volatile transient ObjectSet<K> keys;
/* 222:    */    protected volatile transient ObjectCollection<V> values;
/* 223:    */    
/* 224:224 */    protected UnmodifiableMap(Object2ObjectMap<K, V> m) { super();
/* 225:225 */      this.map = m; }
/* 226:    */    
...
/* 235:235 */    public ObjectSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2ObjectEntrySet()); return this.entries; }
...
/* 244:    */  }
/* 245:    */  
/* 249:    */  public static <K, V> Object2ObjectMap<K, V> unmodifiable(Object2ObjectMap<K, V> m)
/* 250:    */  {
