...
/*  12:    */
/*  83:    */public class ReferenceArrayList<K>
/*  84:    */  extends AbstractReferenceList<K>
...
/*  94:    */  
/*  95:    */  protected ReferenceArrayList(K[] a, boolean dummy)
/*  96:    */  {
/*  97: 97 */    this.a = a;
/*  98: 98 */    this.wrapped = true;
/*  99:    */  }
/* 100:    */  
/* 104:    */  public ReferenceArrayList(int capacity)
/* 105:    */  {
...
/* 109:    */  }
/* 110:    */  
/* 111:    */  public ReferenceArrayList()
/* 112:    */  {
/* 113:113 */    this(16);
/* 114:    */  }
/* 115:    */  
/* 118:    */  public ReferenceArrayList(Collection<? extends K> c)
/* 119:    */  {
/* 120:120 */    this(c.size());
/* 121:121 */    this.size = ObjectIterators.unwrap(c.iterator(), this.a);
/* 122:    */  }
/* 123:    */  
/* 126:    */  public ReferenceArrayList(ReferenceCollection<? extends K> c)
/* 127:    */  {
/* 128:128 */    this(c.size());
/* 129:129 */    this.size = ObjectIterators.unwrap(c.iterator(), this.a);
/* 130:    */  }
/* 131:    */  
/* 134:    */  public ReferenceArrayList(ReferenceList<? extends K> l)
/* 135:    */  {
/* 136:136 */    this(l.size());
/* 137:137 */    l.getElements(0, this.a, 0, this.size = l.size());
/* 138:    */  }
/* 139:    */  
/* 142:    */  public ReferenceArrayList(K[] a)
/* 143:    */  {
/* 144:144 */    this(a, 0, a.length);
/* 145:    */  }
/* 146:    */  
/* 151:    */  public ReferenceArrayList(K[] a, int offset, int length)
/* 152:    */  {
/* 153:153 */    this(length);
...
/* 156:    */  }
/* 157:    */  
/* 160:    */  public ReferenceArrayList(Iterator<? extends K> i)
/* 161:    */  {
/* 162:162 */    this();
...
/* 165:    */  }
/* 166:    */  
/* 168:    */  public ReferenceArrayList(ObjectIterator<? extends K> i)
/* 169:    */  {
/* 170:170 */    this();
...
/* 188:    */  }
/* 189:    */  
/* 194:    */  public static <K> ReferenceArrayList<K> wrap(K[] a, int length)
/* 195:    */  {
...
/* 197:197 */    ReferenceArrayList<K> l = new ReferenceArrayList(a, false);
/* 198:198 */    l.size = length;
/* 199:199 */    return l;
/* 200:    */  }
/* 201:    */  
/* 205:    */  public static <K> ReferenceArrayList<K> wrap(K[] a)
/* 206:    */  {
...
/* 260:    */  }
/* 261:    */  
/* 262:262 */  public int indexOf(Object k) { for (int i = 0; i < this.size; i++) if (k == this.a[i]) return i;
/* 263:263 */    return -1;
/* 264:    */  }
/* 265:    */  
/* 266:266 */  public int lastIndexOf(Object k) { for (int i = this.size; i-- != 0;) if (k == this.a[i]) return i;
/* 267:267 */    return -1;
/* 268:    */  }
/* 269:    */  
...
/* 383:383 */      public boolean hasNext() { return this.pos < ReferenceArrayList.this.size; }
/* 384:384 */      public boolean hasPrevious() { return this.pos > 0; }
/* 385:385 */      public K next() { if (!hasNext()) throw new NoSuchElementException(); return ReferenceArrayList.this.a[(this.last = this.pos++)]; }
/* 386:386 */      public K previous() { if (!hasPrevious()) throw new NoSuchElementException(); return ReferenceArrayList.this.a[(this.last = --this.pos)]; }
...
/* 406:    */  }
/* 407:    */  
/* 408:    */  public ReferenceArrayList<K> clone() {
/* 409:409 */    ReferenceArrayList<K> c = new ReferenceArrayList(this.size);
/* 410:410 */    System.arraycopy(this.a, 0, c.a, 0, this.size);
/* 411:411 */    c.size = this.size;
/* 412:412 */    return c;
/* 413:    */  }
/* 414:    */  
/* 421:    */  public boolean equals(ReferenceArrayList<K> l)
/* 422:    */  {
/* 423:423 */    if (l == this) return true;
/* 424:424 */    int s = size();
/* 425:425 */    if (s != l.size()) return false;
/* 426:426 */    K[] a1 = this.a;
/* 427:427 */    K[] a2 = l.a;
/* 428:428 */    while (s-- != 0) if (a1[s] != a2[s]) return false;
/* 429:429 */    return true;
/* 430:    */  }
/* 431:    */  
/* 432:432 */  private void writeObject(ObjectOutputStream s) throws IOException { s.defaultWriteObject();
/* 433:433 */    for (int i = 0; i < this.size; i++) s.writeObject(this.a[i]);
/* 434:    */  }
/* 435:    */  
/* 436:    */  private void readObject(ObjectInputStream s) throws IOException, ClassNotFoundException {
/* 437:437 */    s.defaultReadObject();
/* 438:438 */    this.a = ((Object[])new Object[this.size]);
/* 439:439 */    for (int i = 0; i < this.size; i++) this.a[i] = s.readObject();
/* 440:    */  }
/* 441:    */}
