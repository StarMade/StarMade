  ...
  implements RandomAccess, Cloneable, Serializable
{
  ...
  protected ReferenceArrayList(K[] local_a, boolean dummy)
  {
  ...
  public ReferenceArrayList(Collection<? extends K> local_c)
  {
    this(local_c.size());
    this.size = ObjectIterators.unwrap(local_c.iterator(), this.field_75);
  }
  
  public ReferenceArrayList(ReferenceCollection<? extends K> local_c)
  {
    this(local_c.size());
    this.size = ObjectIterators.unwrap(local_c.iterator(), this.field_75);
  }
  
  public ReferenceArrayList(ReferenceList<? extends K> local_l)
  {
    this(local_l.size());
    local_l.getElements(0, this.field_75, 0, this.size = local_l.size());
  }
  
  public ReferenceArrayList(K[] local_a)
  {
    this(local_a, 0, local_a.length);
  }
  
  public ReferenceArrayList(K[] local_a, int offset, int length)
  {
    this(length);
  ...
  public ReferenceArrayList(Iterator<? extends K> local_i)
  {
    this();
  ...
  public ReferenceArrayList(ObjectIterator<? extends K> local_i)
  {
    this();
    while (local_i.hasNext()) {
      add(local_i.next());
  ...
  public static <K> ReferenceArrayList<K> wrap(K[] local_a, int length)
  {
    ...
    ReferenceArrayList<K> local_l = new ReferenceArrayList(local_a, false);
    local_l.size = length;
    return local_l;
  }
  
  public static <K> ReferenceArrayList<K> wrap(K[] local_a)
  {
  ...
  public int indexOf(Object local_k)
  {
    for (int local_i = 0; local_i < this.size; local_i++) {
      if (local_k == this.field_75[local_i]) {
        return local_i;
      }
    }
    return -1;
  ...
  public ObjectListIterator<K> listIterator(final int index)
  {
    ...
    new AbstractObjectListIterator()
    {
      ...
      public K next()
      {
        ...
        return ReferenceArrayList.this.field_75[(this.last = this.pos++)];
      }
      ...
      public void add(K local_k)
      {
        ...
        ReferenceArrayList.this.add(this.pos++, local_k);
        this.last = -1;
      }
      ...
      public void set(K local_k)
      {
        ...
        ReferenceArrayList.this.set(this.last, local_k);
      }
  ...
  {
    ReferenceArrayList<K> local_c = new ReferenceArrayList(this.size);
    System.arraycopy(this.field_75, 0, local_c.field_75, 0, this.size);
    local_c.size = this.size;
    return local_c;
  }
  
  public boolean equals(ReferenceArrayList<K> local_l)
  {
    if (local_l == this) {
      return true;
    }
