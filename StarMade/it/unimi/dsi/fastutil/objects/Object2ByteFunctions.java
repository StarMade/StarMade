...
public class Object2ByteFunctions
{
  ...
  public static <K> Object2ByteFunction<K> synchronize(Object2ByteFunction<K> local_f)
  {
    return new SynchronizedFunction(local_f);
  }
  
  public static <K> Object2ByteFunction<K> synchronize(Object2ByteFunction<K> local_f, Object sync)
  {
    return new SynchronizedFunction(local_f, sync);
  }
  
  public static <K> Object2ByteFunction<K> unmodifiable(Object2ByteFunction<K> local_f)
  {
    ...
    implements Serializable
  {
    ...
    protected UnmodifiableFunction(Object2ByteFunction<K> local_f)
    {
      if (local_f == null) {
    ...
    implements Serializable
  {
    ...
    protected SynchronizedFunction(Object2ByteFunction<K> local_f, Object sync)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
    ...
    protected SynchronizedFunction(Object2ByteFunction<K> local_f)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
