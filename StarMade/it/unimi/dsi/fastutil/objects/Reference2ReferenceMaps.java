...
/*   8:    */
/*  57:    */public class Reference2ReferenceMaps
/*  58:    */{
/*  59:    */  public static class EmptyMap<K, V>
/*  60:    */    extends Reference2ReferenceFunctions.EmptyFunction<K, V>
/*  61:    */    implements Reference2ReferenceMap<K, V>, Serializable, Cloneable
/*  62:    */  {
...
/*  67:    */    
/*  68: 68 */    public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() { return ObjectSets.EMPTY_SET; }
/*  69:    */    
/*  70: 70 */    public ReferenceSet<K> keySet() { return ReferenceSets.EMPTY_SET; }
/*  71:    */    
/*  72: 72 */    public ReferenceCollection<V> values() { return ReferenceSets.EMPTY_SET; }
/*  73: 73 */    private Object readResolve() { return Reference2ReferenceMaps.EMPTY_MAP; }
/*  74:    */    
/*  75: 75 */    public Object clone() { return Reference2ReferenceMaps.EMPTY_MAP; }
/*  76:    */    
/*  77: 77 */    public boolean isEmpty() { return true; }
/*  78:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<K, V>> entrySet() { return reference2ReferenceEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Reference2ReferenceFunctions.Singleton<K, V>
/* 103:    */    implements Reference2ReferenceMap<K, V>, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Reference2ReferenceMap.Entry<K, V>> entries;
/* 108:    */    
...
/* 125:    */    
/* 126:126 */    public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Reference2ReferenceMap.Entry<K, V>, Map.Entry<K, V> { protected SingletonEntry() {}
/* 131:131 */      public K getKey() { return Reference2ReferenceMaps.Singleton.this.key; }
/* 132:132 */      public V getValue() { return Reference2ReferenceMaps.Singleton.this.value; }
...
/* 137:137 */        return (Reference2ReferenceMaps.Singleton.this.key == e.getKey()) && (Reference2ReferenceMaps.Singleton.this.value == e.getValue()); }
/* 138:    */      
/* 139:139 */      public int hashCode() { return (Reference2ReferenceMaps.Singleton.this.key == null ? 0 : System.identityHashCode(Reference2ReferenceMaps.Singleton.this.key)) ^ (Reference2ReferenceMaps.Singleton.this.value == null ? 0 : System.identityHashCode(Reference2ReferenceMaps.Singleton.this.value)); }
/* 140:140 */      public String toString() { return Reference2ReferenceMaps.Singleton.this.key + "->" + Reference2ReferenceMaps.Singleton.this.value; } }
/* 141:    */    
/* 142:142 */    public boolean isEmpty() { return false; }
/* 143:    */    
/* 144:144 */    public ObjectSet<Map.Entry<K, V>> entrySet() { return reference2ReferenceEntrySet(); }
/* 145:145 */    public int hashCode() { return (this.key == null ? 0 : System.identityHashCode(this.key)) ^ (this.value == null ? 0 : System.identityHashCode(this.value)); }
/* 146:    */    
...
/* 154:    */  }
/* 155:    */  
/* 164:164 */  public static <K, V> Reference2ReferenceMap<K, V> singleton(K key, V value) { return new Singleton(key, value); }
/* 165:    */  
/* 166:    */  public static class SynchronizedMap<K, V> extends Reference2ReferenceFunctions.SynchronizedFunction<K, V> implements Reference2ReferenceMap<K, V>, Serializable {
/* 167:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 168:    */    protected final Reference2ReferenceMap<K, V> map;
/* 169:    */    protected volatile transient ObjectSet<Reference2ReferenceMap.Entry<K, V>> entries;
/* 170:    */    protected volatile transient ReferenceSet<K> keys;
/* 171:    */    protected volatile transient ReferenceCollection<V> values;
/* 172:    */    
/* 173:    */    protected SynchronizedMap(Reference2ReferenceMap<K, V> m, Object sync) {
/* 174:174 */      super(sync);
/* 175:175 */      this.map = m;
/* 176:    */    }
/* 177:    */    
/* 178:178 */    protected SynchronizedMap(Reference2ReferenceMap<K, V> m) { super();
/* 179:179 */      this.map = m; }
/* 180:    */    
...
/* 189:189 */    public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2ReferenceEntrySet(), this.sync); return this.entries; }
...
/* 202:    */  }
/* 203:    */  
/* 205:    */  public static <K, V> Reference2ReferenceMap<K, V> synchronize(Reference2ReferenceMap<K, V> m)
/* 206:    */  {
/* 207:207 */    return new SynchronizedMap(m);
/* 208:    */  }
/* 209:    */  
/* 215:215 */  public static <K, V> Reference2ReferenceMap<K, V> synchronize(Reference2ReferenceMap<K, V> m, Object sync) { return new SynchronizedMap(m, sync); }
/* 216:    */  
/* 217:    */  public static class UnmodifiableMap<K, V> extends Reference2ReferenceFunctions.UnmodifiableFunction<K, V> implements Reference2ReferenceMap<K, V>, Serializable {
/* 218:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 219:    */    protected final Reference2ReferenceMap<K, V> map;
/* 220:    */    protected volatile transient ObjectSet<Reference2ReferenceMap.Entry<K, V>> entries;
/* 221:    */    protected volatile transient ReferenceSet<K> keys;
/* 222:    */    protected volatile transient ReferenceCollection<V> values;
/* 223:    */    
/* 224:224 */    protected UnmodifiableMap(Reference2ReferenceMap<K, V> m) { super();
/* 225:225 */      this.map = m; }
/* 226:    */    
...
/* 235:235 */    public ObjectSet<Reference2ReferenceMap.Entry<K, V>> reference2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.reference2ReferenceEntrySet()); return this.entries; }
...
/* 244:    */  }
/* 245:    */  
/* 249:    */  public static <K, V> Reference2ReferenceMap<K, V> unmodifiable(Reference2ReferenceMap<K, V> m)
/* 250:    */  {
