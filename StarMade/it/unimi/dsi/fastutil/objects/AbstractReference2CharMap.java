...
/*  88 */     if ((m instanceof Reference2CharMap))
/*     */     {
/*  90 */       while (n-- != 0) {
/*  91 */         Reference2CharMap.Entry e = (Reference2CharMap.Entry)i.next();
...
/* 193 */         return AbstractReference2CharMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractReference2CharMap.this.size(); } 
/* 196 */       public void clear() { AbstractReference2CharMap.this.clear(); }
/*     */ 
/*     */       public ObjectIterator<K> iterator() {
/* 199 */         return new AbstractObjectIterator() {
/* 200 */           final ObjectIterator<Map.Entry<K, Character>> i = AbstractReference2CharMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public K next() { return ((Reference2CharMap.Entry)this.i.next()).getKey(); } 
...
/* 226 */         return AbstractReference2CharMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractReference2CharMap.this.size(); } 
/* 229 */       public void clear() { AbstractReference2CharMap.this.clear(); }
/*     */ 
/*     */       public CharIterator iterator() {
/* 232 */         return new AbstractCharIterator() {
/* 233 */           final ObjectIterator<Map.Entry<K, Character>> i = AbstractReference2CharMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public char nextChar() { return ((Reference2CharMap.Entry)this.i.next()).getCharValue(); } 
/*     */           public boolean hasNext() {
...
/*     */   {
/* 246 */     return reference2CharEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Reference2CharMap.Entry e = (Reference2CharMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == e.getKey()) && (this.value == ((Character)e.getValue()).charValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
