  ...
  implements Reference2CharMap<K>, Serializable
{
  ...
  public void putAll(Map<? extends K, ? extends Character> local_m)
  {
    ...
    if ((local_m instanceof Reference2CharMap)) {
      while (local_n-- != 0)
      {
        Reference2CharMap.Entry<? extends K> local_e = (Reference2CharMap.Entry)local_i.next();
  ...
  public ReferenceSet<K> keySet()
  {
    new AbstractReferenceSet()
    {
      ...
      {
        return AbstractReference2CharMap.this.containsKey(local_k);
      }
      ...
      public ObjectIterator<K> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Character>> field_3 = AbstractReference2CharMap.this.entrySet().iterator();
          
          public K next()
          {
            return ((Reference2CharMap.Entry)this.field_3.next()).getKey();
          }
  ...
  public CharCollection values()
  {
    new AbstractCharCollection()
    {
      ...
      {
        return AbstractReference2CharMap.this.containsValue(local_k);
      }
      ...
      public CharIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Character>> field_67 = AbstractReference2CharMap.this.entrySet().iterator();
          
          public char nextChar()
          {
            return ((Reference2CharMap.Entry)this.field_67.next()).getCharValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Reference2CharMap.Entry<K> local_e = (Reference2CharMap.Entry)local_i.next();
    ...
    implements Reference2CharMap.Entry<K>
  {
    ...
    public boolean equals(Object local_o)
    {
      ...
      return (this.key == local_e.getKey()) && (this.value == ((Character)local_e.getValue()).charValue());
    }
