  ...
  implements Serializable, Cloneable
{
  ...
  public Reference2ShortArrayMap(Reference2ShortMap<K> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Reference2ShortArrayMap(Map<? extends K, ? extends Short> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Reference2ShortArrayMap<K> local_c;
    try
    {
      local_c = (Reference2ShortArrayMap)super.clone();
    }
    ...
    implements Reference2ShortMap.FastEntrySet<K>
  {
    ...
    public ObjectIterator<Reference2ShortMap.Entry<K>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Reference2ShortMap.Entry<K> next()
        {
          ...
          return new AbstractReference2ShortMap.BasicEntry(Reference2ShortArrayMap.this.key[this.next], Reference2ShortArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Reference2ShortMap.Entry<K>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Reference2ShortMap.Entry<K> next()
        {
          ...
          this.entry.key = Reference2ShortArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Reference2ShortArrayMap.this.containsKey(local_k)) && (Reference2ShortArrayMap.this.get(local_k).shortValue() == ((Short)local_e.getValue()).shortValue());
    }
  }
}
