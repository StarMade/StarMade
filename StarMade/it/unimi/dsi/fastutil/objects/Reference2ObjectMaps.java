...
/* 235 */     public ObjectSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.reference2ObjectEntrySet()); return this.entries; } 
...
/* 189 */     public ObjectSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.reference2ObjectEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Reference2ObjectMap.Entry<K, V>> reference2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 142 */       return false;
/*     */     }
/* 144 */     public ObjectSet<Map.Entry<K, V>> entrySet() { return reference2ObjectEntrySet(); } 
/* 145 */     public int hashCode() { return (this.key == null ? 0 : System.identityHashCode(this.key)) ^ (this.value == null ? 0 : this.value.hashCode()); } 
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Reference2ObjectMaps.Singleton.this.key; } 
/* 132 */       public V getValue() { return Reference2ObjectMaps.Singleton.this.value; } 
...
/* 137 */         return (Reference2ObjectMaps.Singleton.this.key == e.getKey()) && (Reference2ObjectMaps.Singleton.this.value == null ? e.getValue() == null : Reference2ObjectMaps.Singleton.this.value.equals(e.getValue()));
/*     */       }
/* 139 */       public int hashCode() { return (Reference2ObjectMaps.Singleton.this.key == null ? 0 : System.identityHashCode(Reference2ObjectMaps.Singleton.this.key)) ^ (Reference2ObjectMaps.Singleton.this.value == null ? 0 : Reference2ObjectMaps.Singleton.this.value.hashCode()); } 
/* 140 */       public String toString() { return Reference2ObjectMaps.Singleton.this.key + "->" + Reference2ObjectMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     }
/*  69 */     public ReferenceSet<K> keySet() { return ReferenceSets.EMPTY_SET; } 
/*     */     public ObjectCollection<V> values() {
/*  71 */       return ObjectSets.EMPTY_SET;
/*     */     }
/*  73 */     private Object readResolve() { return Reference2ObjectMaps.EMPTY_MAP; } 
/*     */     public Object clone() {
/*  75 */       return Reference2ObjectMaps.EMPTY_MAP;
/*     */     }
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, V>> entrySet() {
/*  80 */       return reference2ObjectEntrySet();
/*     */     }
