  ...
  implements Serializable, Cloneable
{
  ...
  public Reference2ReferenceArrayMap(Reference2ReferenceMap<K, V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Reference2ReferenceArrayMap(Map<? extends K, ? extends V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Reference2ReferenceArrayMap<K, V> local_c;
    try
    {
      local_c = (Reference2ReferenceArrayMap)super.clone();
    }
    ...
    implements Reference2ReferenceMap.FastEntrySet<K, V>
  {
    ...
    public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Reference2ReferenceMap.Entry<K, V> next()
        {
          ...
          return new AbstractReference2ReferenceMap.BasicEntry(Reference2ReferenceArrayMap.this.key[this.next], Reference2ReferenceArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Reference2ReferenceMap.Entry<K, V> next()
        {
          ...
          this.entry.key = Reference2ReferenceArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Reference2ReferenceArrayMap.this.containsKey(local_k)) && (Reference2ReferenceArrayMap.this.get(local_k) == local_e.getValue());
    }
  }
}
