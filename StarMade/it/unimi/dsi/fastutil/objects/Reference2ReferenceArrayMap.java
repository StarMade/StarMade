...
/*     */     try
/*     */     {
/* 300 */       c = (Reference2ReferenceArrayMap)super.clone();
/*     */     }
...
/* 129 */         int next = 0;
/*     */ 
/* 131 */         public boolean hasNext() { return this.next < Reference2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Reference2ReferenceMap.Entry<K, V> next()
/*     */         {
/* 135 */           if (!hasNext()) throw new NoSuchElementException();
/* 136 */           return new AbstractReference2ReferenceMap.BasicEntry(Reference2ReferenceArrayMap.this.key[this.next], Reference2ReferenceArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 142 */         int next = 0;
/* 143 */         final AbstractReference2ReferenceMap.BasicEntry<K, V> entry = new AbstractReference2ReferenceMap.BasicEntry(null, null);
/*     */ 
/* 145 */         public boolean hasNext() { return this.next < Reference2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Reference2ReferenceMap.Entry<K, V> next()
/*     */         {
/* 149 */           if (!hasNext()) throw new NoSuchElementException();
/* 150 */           this.entry.key = Reference2ReferenceArrayMap.this.key[this.next];
/* 151 */           this.entry.value = Reference2ReferenceArrayMap.this.value[(this.next++)];
/* 152 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 157 */       return Reference2ReferenceArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 164 */       return (Reference2ReferenceArrayMap.this.containsKey(k)) && (Reference2ReferenceArrayMap.this.get(k) == e.getValue());
/*     */     }
/*     */   }
/*     */ }
