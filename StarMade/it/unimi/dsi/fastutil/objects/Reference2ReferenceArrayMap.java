...
/*  10:    */
/*  64:    */public class Reference2ReferenceArrayMap<K, V>
/*  65:    */  extends AbstractReference2ReferenceMap<K, V>
...
/*  71:    */  private int size;
/*  72:    */  
/*  73:    */  public Reference2ReferenceArrayMap(Object[] key, Object[] value)
/*  74:    */  {
/*  75: 75 */    this.key = key;
...
/*  79:    */  }
/*  80:    */  
/*  81:    */  public Reference2ReferenceArrayMap()
/*  82:    */  {
/*  83: 83 */    this.key = ObjectArrays.EMPTY_ARRAY;
/*  84: 84 */    this.value = ObjectArrays.EMPTY_ARRAY;
/*  85:    */  }
/*  86:    */  
/*  89:    */  public Reference2ReferenceArrayMap(int capacity)
/*  90:    */  {
/*  91: 91 */    this.key = new Object[capacity];
/*  92: 92 */    this.value = new Object[capacity];
/*  93:    */  }
/*  94:    */  
/*  97:    */  public Reference2ReferenceArrayMap(Reference2ReferenceMap<K, V> m)
/*  98:    */  {
/*  99: 99 */    this(m.size());
/* 100:100 */    putAll(m);
/* 101:    */  }
/* 102:    */  
/* 105:    */  public Reference2ReferenceArrayMap(Map<? extends K, ? extends V> m)
/* 106:    */  {
/* 107:107 */    this(m.size());
/* 108:108 */    putAll(m);
/* 109:    */  }
/* 110:    */  
/* 117:    */  public Reference2ReferenceArrayMap(Object[] key, Object[] value, int size)
/* 118:    */  {
...
/* 124:    */  }
/* 125:    */  
/* 126:    */  private final class EntrySet extends AbstractObjectSet<Reference2ReferenceMap.Entry<K, V>> implements Reference2ReferenceMap.FastEntrySet<K, V> { private EntrySet() {}
/* 127:    */    
/* 128:128 */    public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> iterator() { new AbstractObjectIterator() {
/* 129:129 */        int next = 0;
/* 130:    */        
/* 131:131 */        public boolean hasNext() { return this.next < Reference2ReferenceArrayMap.this.size; }
/* 132:    */        
/* 133:    */        public Reference2ReferenceMap.Entry<K, V> next()
/* 134:    */        {
/* 135:135 */          if (!hasNext()) throw new NoSuchElementException();
/* 136:136 */          return new AbstractReference2ReferenceMap.BasicEntry(Reference2ReferenceArrayMap.this.key[this.next], Reference2ReferenceArrayMap.this.value[(this.next++)]);
/* 137:    */        }
/* 138:    */      }; }
/* 139:    */    
/* 140:    */    public ObjectIterator<Reference2ReferenceMap.Entry<K, V>> fastIterator() {
/* 141:141 */      new AbstractObjectIterator() {
/* 142:142 */        int next = 0;
/* 143:143 */        final AbstractReference2ReferenceMap.BasicEntry<K, V> entry = new AbstractReference2ReferenceMap.BasicEntry(null, null);
/* 144:    */        
/* 145:145 */        public boolean hasNext() { return this.next < Reference2ReferenceArrayMap.this.size; }
/* 146:    */        
/* 147:    */        public Reference2ReferenceMap.Entry<K, V> next()
/* 148:    */        {
/* 149:149 */          if (!hasNext()) throw new NoSuchElementException();
/* 150:150 */          this.entry.key = Reference2ReferenceArrayMap.this.key[this.next];
/* 151:151 */          this.entry.value = Reference2ReferenceArrayMap.this.value[(this.next++)];
/* 152:152 */          return this.entry;
/* 153:    */        }
/* 154:    */      };
/* 155:    */    }
/* 156:    */    
/* 157:157 */    public int size() { return Reference2ReferenceArrayMap.this.size; }
/* 158:    */    
...
/* 164:164 */      return (Reference2ReferenceArrayMap.this.containsKey(k)) && (Reference2ReferenceArrayMap.this.get(k) == e.getValue());
/* 165:    */    }
/* 166:    */  }
/* 167:    */  
/* 168:    */  public Reference2ReferenceMap.FastEntrySet<K, V> reference2ReferenceEntrySet() {
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Reference2ReferenceArrayMap<K, V> clone()
/* 293:    */  {
/* 294:    */    Reference2ReferenceArrayMap<K, V> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Reference2ReferenceArrayMap)super.clone();
/* 301:    */    }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.Reference2ReferenceArrayMap
