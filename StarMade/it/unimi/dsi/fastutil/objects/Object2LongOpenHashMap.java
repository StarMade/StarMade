...
/* 629 */           return new Object2LongOpenHashMap.ValueIterator(Object2LongOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 632 */           return Object2LongOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(long v) {
/* 635 */           return Object2LongOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 638 */           Object2LongOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 753 */       c = (Object2LongOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Object2LongOpenHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 622 */       super(null); } 
/* 623 */     public long nextLong() { return Object2LongOpenHashMap.this.value[nextEntry()]; } 
/* 624 */     public Long next() { return Long.valueOf(Object2LongOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 594 */       return new Object2LongOpenHashMap.KeyIterator(Object2LongOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 597 */       return Object2LongOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 600 */       return Object2LongOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 603 */       int oldSize = Object2LongOpenHashMap.this.size;
/* 604 */       Object2LongOpenHashMap.this.remove(k);
/* 605 */       return Object2LongOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 608 */       Object2LongOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Object2LongOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 589 */       super(null); } 
/* 590 */     public K next() { return Object2LongOpenHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 535 */       return new Object2LongOpenHashMap.EntryIterator(Object2LongOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Object2LongMap.Entry<K>> fastIterator() {
/* 538 */       return new Object2LongOpenHashMap.FastEntryIterator(Object2LongOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 546 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2LongOpenHashMap.this.mask;
/*     */ 
/* 548 */       while (Object2LongOpenHashMap.this.used[pos] != 0) {
/* 549 */         if (Object2LongOpenHashMap.this.key[pos] == null ? k == null : Object2LongOpenHashMap.this.key[pos].equals(k)) return Object2LongOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/* 550 */         pos = pos + 1 & Object2LongOpenHashMap.this.mask;
/*     */       }
/* 552 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 560 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2LongOpenHashMap.this.mask;
/*     */ 
/* 562 */       while (Object2LongOpenHashMap.this.used[pos] != 0) {
/* 563 */         if (Object2LongOpenHashMap.this.key[pos] == null ? k == null : Object2LongOpenHashMap.this.key[pos].equals(k)) {
/* 564 */           Object2LongOpenHashMap.this.remove(e.getKey());
/* 565 */           return true;
/*     */         }
/* 567 */         pos = pos + 1 & Object2LongOpenHashMap.this.mask;
/*     */       }
/* 569 */       return false;
/*     */     }
/*     */     public int size() {
/* 572 */       return Object2LongOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 575 */       Object2LongOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Object2LongOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2LongMap.Entry<K>>
/*     */   {
/* 525 */     final AbstractObject2LongMap.BasicEntry<K> entry = new AbstractObject2LongMap.BasicEntry(null, 0L);
/*     */ 
...
/* 527 */       int e = nextEntry();
/* 528 */       this.entry.key = Object2LongOpenHashMap.this.key[e];
/* 529 */       this.entry.value = Object2LongOpenHashMap.this.value[e];
/* 530 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Object2LongOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2LongMap.Entry<K>>
/*     */   {
...
/* 516 */       return this.entry = new Object2LongOpenHashMap.MapEntry(Object2LongOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 520 */       super.remove();
/* 521 */       Object2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 421 */       this.pos = Object2LongOpenHashMap.this.n;
/*     */ 
/* 424 */       this.last = -1;
/*     */ 
/* 426 */       this.c = Object2LongOpenHashMap.this.size;
/*     */ 
/* 431 */       boolean[] used = Object2LongOpenHashMap.this.used;
...
/*     */ 
/* 444 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2LongOpenHashMap.this.mask;
/*     */ 
/* 446 */         while (Object2LongOpenHashMap.this.used[pos] != 0) {
/* 447 */           if (Object2LongOpenHashMap.this.key[pos] == null ? k == null : Object2LongOpenHashMap.this.key[pos].equals(k)) return pos;
/* 448 */           pos = pos + 1 & Object2LongOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 451 */       this.last = this.pos;
/*     */ 
/* 453 */       if (this.c != 0) {
/* 454 */         boolean[] used = Object2LongOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 471 */         pos = (last = pos) + 1 & Object2LongOpenHashMap.this.mask;
/* 472 */         while (Object2LongOpenHashMap.this.used[pos] != 0) {
/* 473 */           int slot = (Object2LongOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2LongOpenHashMap.this.key[pos].hashCode())) & Object2LongOpenHashMap.this.mask;
/* 474 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 475 */           pos = pos + 1 & Object2LongOpenHashMap.this.mask;
/*     */         }
/* 477 */         if (Object2LongOpenHashMap.this.used[pos] == 0) break;
/* 478 */         if (pos < last)
/*     */         {
/* 480 */           if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 481 */           this.wrapped.add(Object2LongOpenHashMap.this.key[pos]);
/*     */         }
/* 483 */         Object2LongOpenHashMap.this.key[last] = Object2LongOpenHashMap.this.key[pos];
/* 484 */         Object2LongOpenHashMap.this.value[last] = Object2LongOpenHashMap.this.value[pos];
/*     */       }
/* 486 */       Object2LongOpenHashMap.this.used[last] = false;
/* 487 */       Object2LongOpenHashMap.this.key[last] = null;
/* 488 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 493 */       if (this.pos < -1)
/*     */       {
/* 495 */         Object2LongOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 496 */         this.last = -1;
/* 497 */         return;
/*     */       }
/* 499 */       Object2LongOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 388 */       return Object2LongOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Long getValue() {
/* 391 */       return Long.valueOf(Object2LongOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public long getLongValue() {
/* 394 */       return Object2LongOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public long setValue(long v) {
/* 397 */       long oldValue = Object2LongOpenHashMap.this.value[this.index];
/* 398 */       Object2LongOpenHashMap.this.value[this.index] = v;
/* 399 */       return oldValue;
/*     */     }
/*     */     public Long setValue(Long v) {
...
/* 408 */       return (Object2LongOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2LongOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*     */     }
/*     */     public int hashCode() {
/* 411 */       return (Object2LongOpenHashMap.this.key[this.index] == null ? 0 : Object2LongOpenHashMap.this.key[this.index].hashCode()) ^ HashCommon.long2int(Object2LongOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 414 */       return Object2LongOpenHashMap.this.key[this.index] + "=>" + Object2LongOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
