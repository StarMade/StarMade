...
/*   19:     */
/*  113:     */public class Object2ShortLinkedOpenCustomHashMap<K>
/*  114:     */  extends AbstractObject2ShortSortedMap<K>
...
/*  127:     */  protected volatile transient Object2ShortSortedMap.FastSortedEntrySet<K> entries;
...
/*  146:     */  
/*  152:     */  public Object2ShortLinkedOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy)
/*  153:     */  {
...
/*  162: 162 */    this.value = new short[this.n];
/*  163: 163 */    this.used = new boolean[this.n];
/*  164: 164 */    this.link = new long[this.n];
/*  165:     */  }
/*  166:     */  
/*  170:     */  public Object2ShortLinkedOpenCustomHashMap(int expected, Hash.Strategy<K> strategy)
/*  171:     */  {
/*  172: 172 */    this(expected, 0.75F, strategy);
/*  173:     */  }
/*  174:     */  
/*  177:     */  public Object2ShortLinkedOpenCustomHashMap(Hash.Strategy<K> strategy)
/*  178:     */  {
/*  179: 179 */    this(16, 0.75F, strategy);
/*  180:     */  }
/*  181:     */  
/*  186:     */  public Object2ShortLinkedOpenCustomHashMap(Map<? extends K, ? extends Short> m, float f, Hash.Strategy<K> strategy)
/*  187:     */  {
/*  188: 188 */    this(m.size(), f, strategy);
/*  189: 189 */    putAll(m);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Object2ShortLinkedOpenCustomHashMap(Map<? extends K, ? extends Short> m, Hash.Strategy<K> strategy)
/*  196:     */  {
/*  197: 197 */    this(m, 0.75F, strategy);
/*  198:     */  }
/*  199:     */  
/*  204:     */  public Object2ShortLinkedOpenCustomHashMap(Object2ShortMap<K> m, float f, Hash.Strategy<K> strategy)
/*  205:     */  {
/*  206: 206 */    this(m.size(), f, strategy);
/*  207: 207 */    putAll(m);
/*  208:     */  }
/*  209:     */  
/*  213:     */  public Object2ShortLinkedOpenCustomHashMap(Object2ShortMap<K> m, Hash.Strategy<K> strategy)
/*  214:     */  {
/*  215: 215 */    this(m, 0.75F, strategy);
/*  216:     */  }
/*  217:     */  
/*  224:     */  public Object2ShortLinkedOpenCustomHashMap(K[] k, short[] v, float f, Hash.Strategy<K> strategy)
/*  225:     */  {
...
/*  230:     */  }
/*  231:     */  
/*  236:     */  public Object2ShortLinkedOpenCustomHashMap(K[] k, short[] v, Hash.Strategy<K> strategy)
/*  237:     */  {
...
/*  246:     */  }
/*  247:     */  
/*  251:     */  public short put(K k, short v)
/*  252:     */  {
...
/*  257: 257 */        short oldValue = this.value[pos];
...
/*  279:     */  }
/*  280:     */  
/*  281: 281 */  public Short put(K ok, Short ov) { short v = ov.shortValue();
/*  282: 282 */    K k = ok;
/*  283:     */    
...
/*  288: 288 */        Short oldValue = Short.valueOf(this.value[pos]);
...
/*  310:     */  }
/*  311:     */  
/*  322:     */  public short add(K k, short incr)
/*  323:     */  {
...
/*  328: 328 */        short oldValue = this.value[pos]; int 
/*  329: 329 */          tmp60_59 = pos; short[] tmp60_56 = this.value;tmp60_56[tmp60_59] = ((short)(tmp60_56[tmp60_59] + incr));
...
/*  336: 336 */    this.value[pos] = ((short)(this.defRetValue + incr));
...
/*  375:     */  }
/*  376:     */  
/*  377:     */  public short removeShort(Object k)
/*  378:     */  {
...
/*  385: 385 */        short v = this.value[pos];
...
/*  392:     */  }
/*  393:     */  
/*  394:     */  public Short remove(Object ok) {
/*  395: 395 */    K k = ok;
/*  396:     */    
...
/*  403: 403 */        short v = this.value[pos];
/*  404: 404 */        shiftKeys(pos);
/*  405: 405 */        return Short.valueOf(v);
/*  406:     */      }
...
/*  410:     */  }
/*  411:     */  
/*  414:     */  public short removeFirstShort()
/*  415:     */  {
...
/*  424:     */    }
/*  425: 425 */    short v = this.value[pos];
/*  426: 426 */    shiftKeys(pos);
/*  427: 427 */    return v;
/*  428:     */  }
/*  429:     */  
/*  432:     */  public short removeLastShort()
/*  433:     */  {
...
/*  442:     */    }
/*  443: 443 */    short v = this.value[pos];
...
/*  482:     */  }
/*  483:     */  
/*  487:     */  public short getAndMoveToFirst(K k)
/*  488:     */  {
...
/*  503:     */  }
/*  504:     */  
/*  508:     */  public short getAndMoveToLast(K k)
/*  509:     */  {
...
/*  524:     */  }
/*  525:     */  
/*  530:     */  public short putAndMoveToFirst(K k, short v)
/*  531:     */  {
...
/*  540: 540 */        short oldValue = this.value[pos];
...
/*  563:     */  }
/*  564:     */  
/*  569:     */  public short putAndMoveToLast(K k, short v)
/*  570:     */  {
...
/*  579: 579 */        short oldValue = this.value[pos];
...
/*  602:     */  }
/*  603:     */  
/*  604:     */  public short getShort(Object k)
/*  605:     */  {
...
/*  624:     */  }
/*  625:     */  
/*  626: 626 */  public boolean containsValue(short v) { short[] value = this.value;
/*  627: 627 */    boolean[] used = this.used;
/*  628: 628 */    for (int i = this.n; i-- != 0; return true) label16: if ((used[i] == 0) || (value[i] != v)) break label16;
...
/*  670:     */    implements Object2ShortMap.Entry<K>, Map.Entry<K, Short>
/*  671:     */  {
...
/*  677:     */    }
/*  678:     */    
/*  679: 679 */    public K getKey() { return Object2ShortLinkedOpenCustomHashMap.this.key[this.index]; }
/*  680:     */    
/*  681:     */    public Short getValue() {
/*  682: 682 */      return Short.valueOf(Object2ShortLinkedOpenCustomHashMap.this.value[this.index]);
/*  683:     */    }
/*  684:     */    
/*  685: 685 */    public short getShortValue() { return Object2ShortLinkedOpenCustomHashMap.this.value[this.index]; }
/*  686:     */    
/*  687:     */    public short setValue(short v) {
/*  688: 688 */      short oldValue = Object2ShortLinkedOpenCustomHashMap.this.value[this.index];
/*  689: 689 */      Object2ShortLinkedOpenCustomHashMap.this.value[this.index] = v;
/*  690: 690 */      return oldValue;
/*  691:     */    }
/*  692:     */    
/*  693: 693 */    public Short setValue(Short v) { return Short.valueOf(setValue(v.shortValue())); }
/*  694:     */    
/*  695:     */    public boolean equals(Object o)
/*  696:     */    {
/*  697: 697 */      if (!(o instanceof Map.Entry)) return false;
/*  698: 698 */      Map.Entry<K, Short> e = (Map.Entry)o;
/*  699: 699 */      return (Object2ShortLinkedOpenCustomHashMap.this.strategy.equals(Object2ShortLinkedOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2ShortLinkedOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*  700:     */    }
/*  701:     */    
/*  702: 702 */    public int hashCode() { return Object2ShortLinkedOpenCustomHashMap.this.strategy.hashCode(Object2ShortLinkedOpenCustomHashMap.this.key[this.index]) ^ Object2ShortLinkedOpenCustomHashMap.this.value[this.index]; }
/*  703:     */    
/*  704:     */    public String toString() {
/*  705: 705 */      return Object2ShortLinkedOpenCustomHashMap.this.key[this.index] + "=>" + Object2ShortLinkedOpenCustomHashMap.this.value[this.index];
/*  706:     */    }
/*  707:     */  }
/*  708:     */  
...
/*  793: 793 */  public Object2ShortSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  794: 794 */  public Object2ShortSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); }
/*  795: 795 */  public Object2ShortSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  796:     */  
...
/*  810: 810 */    int index = -1;
/*  811:     */    
/*  812: 812 */    private MapIterator() { this.next = Object2ShortLinkedOpenCustomHashMap.this.first;
/*  813: 813 */      this.index = 0;
/*  814:     */    }
/*  815:     */    
/*  816: 816 */    private MapIterator() { if (Object2ShortLinkedOpenCustomHashMap.this.strategy.equals(Object2ShortLinkedOpenCustomHashMap.this.key[Object2ShortLinkedOpenCustomHashMap.this.last], from)) {
/*  817: 817 */        this.prev = Object2ShortLinkedOpenCustomHashMap.this.last;
/*  818: 818 */        this.index = Object2ShortLinkedOpenCustomHashMap.this.size;
/*  819:     */      }
/*  820:     */      else
/*  821:     */      {
/*  822: 822 */        int pos = HashCommon.murmurHash3(Object2ShortLinkedOpenCustomHashMap.this.strategy.hashCode(from)) & Object2ShortLinkedOpenCustomHashMap.this.mask;
/*  823:     */        
/*  824: 824 */        while (Object2ShortLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  825: 825 */          if (Object2ShortLinkedOpenCustomHashMap.this.strategy.equals(Object2ShortLinkedOpenCustomHashMap.this.key[pos], from))
/*  826:     */          {
/*  827: 827 */            this.next = ((int)Object2ShortLinkedOpenCustomHashMap.this.link[pos]);
/*  828: 828 */            this.prev = pos;
/*  829: 829 */            return;
/*  830:     */          }
/*  831: 831 */          pos = pos + 1 & Object2ShortLinkedOpenCustomHashMap.this.mask;
/*  832:     */        }
...
/*  845: 845 */        this.index = Object2ShortLinkedOpenCustomHashMap.this.size;
/*  846: 846 */        return;
/*  847:     */      }
/*  848: 848 */      int pos = Object2ShortLinkedOpenCustomHashMap.this.first;
/*  849: 849 */      this.index = 1;
/*  850: 850 */      while (pos != this.prev) {
/*  851: 851 */        pos = (int)Object2ShortLinkedOpenCustomHashMap.this.link[pos];
...
/*  862:     */    }
/*  863:     */    
/*  864: 864 */    public int nextEntry() { if (!hasNext()) return Object2ShortLinkedOpenCustomHashMap.this.size();
/*  865: 865 */      this.curr = this.next;
/*  866: 866 */      this.next = ((int)Object2ShortLinkedOpenCustomHashMap.this.link[this.curr]);
...
/*  874: 874 */      this.prev = ((int)(Object2ShortLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
...
/*  887: 887 */        this.prev = ((int)(Object2ShortLinkedOpenCustomHashMap.this.link[this.curr] >>> 32));
/*  888:     */      }
/*  889:     */      else {
/*  890: 890 */        this.next = ((int)Object2ShortLinkedOpenCustomHashMap.this.link[this.curr]); }
/*  891: 891 */      Object2ShortLinkedOpenCustomHashMap.this.size -= 1;
/*  892:     */      
/*  894: 894 */      if (this.prev == -1) { Object2ShortLinkedOpenCustomHashMap.this.first = this.next;
/*  895:     */      } else
/*  896: 896 */        Object2ShortLinkedOpenCustomHashMap.this.link[this.prev] ^= (Object2ShortLinkedOpenCustomHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  897: 897 */      if (this.next == -1) { Object2ShortLinkedOpenCustomHashMap.this.last = this.prev;
/*  898:     */      } else
/*  899: 899 */        Object2ShortLinkedOpenCustomHashMap.this.link[this.next] ^= (Object2ShortLinkedOpenCustomHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  900: 900 */      int pos = this.curr;
/*  901:     */      int last;
/*  902:     */      for (;;) {
/*  903: 903 */        pos = (last = pos) + 1 & Object2ShortLinkedOpenCustomHashMap.this.mask;
/*  904: 904 */        while (Object2ShortLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  905: 905 */          int slot = HashCommon.murmurHash3(Object2ShortLinkedOpenCustomHashMap.this.strategy.hashCode(Object2ShortLinkedOpenCustomHashMap.this.key[pos])) & Object2ShortLinkedOpenCustomHashMap.this.mask;
/*  906: 906 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  907: 907 */          pos = pos + 1 & Object2ShortLinkedOpenCustomHashMap.this.mask;
/*  908:     */        }
/*  909: 909 */        if (Object2ShortLinkedOpenCustomHashMap.this.used[pos] == 0) break;
/*  910: 910 */        Object2ShortLinkedOpenCustomHashMap.this.key[last] = Object2ShortLinkedOpenCustomHashMap.this.key[pos];
/*  911: 911 */        Object2ShortLinkedOpenCustomHashMap.this.value[last] = Object2ShortLinkedOpenCustomHashMap.this.value[pos];
/*  912: 912 */        if (this.next == pos) this.next = last;
/*  913: 913 */        if (this.prev == pos) this.prev = last;
/*  914: 914 */        Object2ShortLinkedOpenCustomHashMap.this.fixPointers(pos, last);
/*  915:     */      }
/*  916: 916 */      Object2ShortLinkedOpenCustomHashMap.this.used[last] = false;
/*  917: 917 */      Object2ShortLinkedOpenCustomHashMap.this.key[last] = null;
/*  918: 918 */      this.curr = -1;
/*  919:     */    }
/*  920:     */    
...
/*  929:     */    } }
/*  930:     */  
/*  931:     */  private class EntryIterator extends Object2ShortLinkedOpenCustomHashMap<K>.MapIterator implements ObjectListIterator<Object2ShortMap.Entry<K>> { private Object2ShortLinkedOpenCustomHashMap<K>.MapEntry entry;
/*  932:     */    
/*  933: 933 */    public EntryIterator() { super(null); }
/*  934:     */    
/*  935: 935 */    public EntryIterator() { super(from, null); }
/*  936:     */    
/*  937:     */    public Object2ShortLinkedOpenCustomHashMap<K>.MapEntry next() {
/*  938: 938 */      return this.entry = new Object2ShortLinkedOpenCustomHashMap.MapEntry(Object2ShortLinkedOpenCustomHashMap.this, nextEntry());
/*  939:     */    }
/*  940:     */    
/*  941: 941 */    public Object2ShortLinkedOpenCustomHashMap<K>.MapEntry previous() { return this.entry = new Object2ShortLinkedOpenCustomHashMap.MapEntry(Object2ShortLinkedOpenCustomHashMap.this, previousEntry()); }
/*  942:     */    
/*  943:     */    public void remove()
/*  944:     */    {
/*  945: 945 */      super.remove();
/*  946: 946 */      Object2ShortLinkedOpenCustomHashMap.MapEntry.access$202(this.entry, -1); }
/*  947:     */    
/*  948: 948 */    public void set(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  949: 949 */    public void add(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  950:     */  }
/*  951:     */  
/*  952: 952 */  private class FastEntryIterator extends Object2ShortLinkedOpenCustomHashMap<K>.MapIterator implements ObjectListIterator<Object2ShortMap.Entry<K>> { final AbstractObject2ShortMap.BasicEntry<K> entry = new AbstractObject2ShortMap.BasicEntry(null, (short)0);
/*  953: 953 */    public FastEntryIterator() { super(null); }
/*  954:     */    
/*  955: 955 */    public FastEntryIterator() { super(from, null); }
/*  956:     */    
/*  957:     */    public AbstractObject2ShortMap.BasicEntry<K> next() {
/*  958: 958 */      int e = nextEntry();
/*  959: 959 */      this.entry.key = Object2ShortLinkedOpenCustomHashMap.this.key[e];
/*  960: 960 */      this.entry.value = Object2ShortLinkedOpenCustomHashMap.this.value[e];
/*  961: 961 */      return this.entry;
/*  962:     */    }
/*  963:     */    
/*  964: 964 */    public AbstractObject2ShortMap.BasicEntry<K> previous() { int e = previousEntry();
/*  965: 965 */      this.entry.key = Object2ShortLinkedOpenCustomHashMap.this.key[e];
/*  966: 966 */      this.entry.value = Object2ShortLinkedOpenCustomHashMap.this.value[e];
/*  967: 967 */      return this.entry; }
/*  968:     */    
/*  969: 969 */    public void set(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  970: 970 */    public void add(Object2ShortMap.Entry<K> ok) { throw new UnsupportedOperationException(); } }
/*  971:     */  
/*  972:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Object2ShortMap.Entry<K>> implements Object2ShortSortedMap.FastSortedEntrySet<K> { private MapEntrySet() {}
/*  973:     */    
/*  974: 974 */    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator() { return new Object2ShortLinkedOpenCustomHashMap.EntryIterator(Object2ShortLinkedOpenCustomHashMap.this); }
/*  975:     */    
/*  976: 976 */    public Comparator<? super Object2ShortMap.Entry<K>> comparator() { return null; }
/*  977: 977 */    public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> fromElement, Object2ShortMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  978: 978 */    public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  979: 979 */    public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(Object2ShortMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); }
/*  980:     */    
/*  981: 981 */    public Object2ShortMap.Entry<K> first() { if (Object2ShortLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  982: 982 */      return new Object2ShortLinkedOpenCustomHashMap.MapEntry(Object2ShortLinkedOpenCustomHashMap.this, Object2ShortLinkedOpenCustomHashMap.this.first);
/*  983:     */    }
/*  984:     */    
/*  985: 985 */    public Object2ShortMap.Entry<K> last() { if (Object2ShortLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/*  986: 986 */      return new Object2ShortLinkedOpenCustomHashMap.MapEntry(Object2ShortLinkedOpenCustomHashMap.this, Object2ShortLinkedOpenCustomHashMap.this.last);
/*  987:     */    }
/*  988:     */    
/*  989:     */    public boolean contains(Object o) {
/*  990: 990 */      if (!(o instanceof Map.Entry)) return false;
/*  991: 991 */      Map.Entry<K, Short> e = (Map.Entry)o;
/*  992: 992 */      K k = e.getKey();
/*  993:     */      
/*  994: 994 */      int pos = HashCommon.murmurHash3(Object2ShortLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortLinkedOpenCustomHashMap.this.mask;
/*  995:     */      
/*  996: 996 */      while (Object2ShortLinkedOpenCustomHashMap.this.used[pos] != 0) {
/*  997: 997 */        if (Object2ShortLinkedOpenCustomHashMap.this.strategy.equals(Object2ShortLinkedOpenCustomHashMap.this.key[pos], k)) return Object2ShortLinkedOpenCustomHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/*  998: 998 */        pos = pos + 1 & Object2ShortLinkedOpenCustomHashMap.this.mask;
/*  999:     */      }
...
/* 1005:1005 */      Map.Entry<K, Short> e = (Map.Entry)o;
/* 1006:1006 */      K k = e.getKey();
/* 1007:     */      
/* 1008:1008 */      int pos = HashCommon.murmurHash3(Object2ShortLinkedOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortLinkedOpenCustomHashMap.this.mask;
/* 1009:     */      
/* 1010:1010 */      while (Object2ShortLinkedOpenCustomHashMap.this.used[pos] != 0) {
/* 1011:1011 */        if (Object2ShortLinkedOpenCustomHashMap.this.strategy.equals(Object2ShortLinkedOpenCustomHashMap.this.key[pos], k)) {
/* 1012:1012 */          Object2ShortLinkedOpenCustomHashMap.this.remove(e.getKey());
/* 1013:1013 */          return true;
/* 1014:     */        }
/* 1015:1015 */        pos = pos + 1 & Object2ShortLinkedOpenCustomHashMap.this.mask;
/* 1016:     */      }
/* 1017:1017 */      return false;
/* 1018:     */    }
/* 1019:     */    
/* 1020:1020 */    public int size() { return Object2ShortLinkedOpenCustomHashMap.this.size; }
/* 1021:     */    
/* 1022:     */    public void clear() {
/* 1023:1023 */      Object2ShortLinkedOpenCustomHashMap.this.clear();
/* 1024:     */    }
/* 1025:     */    
/* 1026:1026 */    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> from) { return new Object2ShortLinkedOpenCustomHashMap.EntryIterator(Object2ShortLinkedOpenCustomHashMap.this, from.getKey()); }
/* 1027:     */    
/* 1028:     */    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator() {
/* 1029:1029 */      return new Object2ShortLinkedOpenCustomHashMap.FastEntryIterator(Object2ShortLinkedOpenCustomHashMap.this);
/* 1030:     */    }
/* 1031:     */    
/* 1032:1032 */    public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> fastIterator(Object2ShortMap.Entry<K> from) { return new Object2ShortLinkedOpenCustomHashMap.FastEntryIterator(Object2ShortLinkedOpenCustomHashMap.this, from.getKey()); }
/* 1033:     */  }
/* 1034:     */  
/* 1035:     */  public Object2ShortSortedMap.FastSortedEntrySet<K> object2ShortEntrySet() {
...
/* 1043:     */    extends Object2ShortLinkedOpenCustomHashMap<K>.MapIterator
/* 1044:     */    implements ObjectListIterator<K>
/* 1045:     */  {
/* 1046:1046 */    public KeyIterator() { super(k, null); }
/* 1047:1047 */    public K previous() { return Object2ShortLinkedOpenCustomHashMap.this.key[previousEntry()]; }
...
/* 1051:1051 */    public K next() { return Object2ShortLinkedOpenCustomHashMap.this.key[nextEntry()]; } }
/* 1052:     */  
/* 1053:     */  private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/* 1054:     */    
/* 1055:1055 */    public ObjectListIterator<K> iterator(K from) { return new Object2ShortLinkedOpenCustomHashMap.KeyIterator(Object2ShortLinkedOpenCustomHashMap.this, from); }
/* 1056:     */    
/* 1057:     */    public ObjectListIterator<K> iterator() {
/* 1058:1058 */      return new Object2ShortLinkedOpenCustomHashMap.KeyIterator(Object2ShortLinkedOpenCustomHashMap.this);
/* 1059:     */    }
/* 1060:     */    
/* 1061:1061 */    public int size() { return Object2ShortLinkedOpenCustomHashMap.this.size; }
/* 1062:     */    
/* 1064:1064 */    public boolean contains(Object k) { return Object2ShortLinkedOpenCustomHashMap.this.containsKey(k); }
/* 1065:     */    
/* 1066:     */    public boolean remove(Object k) {
/* 1067:1067 */      int oldSize = Object2ShortLinkedOpenCustomHashMap.this.size;
/* 1068:1068 */      Object2ShortLinkedOpenCustomHashMap.this.remove(k);
/* 1069:1069 */      return Object2ShortLinkedOpenCustomHashMap.this.size != oldSize;
/* 1070:     */    }
/* 1071:     */    
/* 1072:1072 */    public void clear() { Object2ShortLinkedOpenCustomHashMap.this.clear(); }
/* 1073:     */    
/* 1074:     */    public K first() {
/* 1075:1075 */      if (Object2ShortLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076:1076 */      return Object2ShortLinkedOpenCustomHashMap.this.key[Object2ShortLinkedOpenCustomHashMap.this.first];
/* 1077:     */    }
/* 1078:     */    
/* 1079:1079 */    public K last() { if (Object2ShortLinkedOpenCustomHashMap.this.size == 0) throw new NoSuchElementException();
/* 1080:1080 */      return Object2ShortLinkedOpenCustomHashMap.this.key[Object2ShortLinkedOpenCustomHashMap.this.last]; }
/* 1081:     */    
...
/* 1095:     */    extends Object2ShortLinkedOpenCustomHashMap.MapIterator
/* 1096:     */    implements ShortListIterator
/* 1097:     */  {
/* 1098:1098 */    public short previousShort() { return Object2ShortLinkedOpenCustomHashMap.this.value[previousEntry()]; }
/* 1099:1099 */    public Short previous() { return Short.valueOf(Object2ShortLinkedOpenCustomHashMap.this.value[previousEntry()]); }
/* 1100:1100 */    public void set(Short ok) { throw new UnsupportedOperationException(); }
/* 1101:1101 */    public void add(Short ok) { throw new UnsupportedOperationException(); }
/* 1102:1102 */    public void set(short v) { throw new UnsupportedOperationException(); }
/* 1103:1103 */    public void add(short v) { throw new UnsupportedOperationException(); }
/* 1104:1104 */    public ValueIterator() { super(null); }
/* 1105:1105 */    public short nextShort() { return Object2ShortLinkedOpenCustomHashMap.this.value[nextEntry()]; }
/* 1106:1106 */    public Short next() { return Short.valueOf(Object2ShortLinkedOpenCustomHashMap.this.value[nextEntry()]); }
/* 1107:     */  }
/* 1108:     */  
/* 1109:1109 */  public ShortCollection values() { if (this.values == null) { this.values = new AbstractShortCollection() {
/* 1110:     */        public ShortIterator iterator() {
/* 1111:1111 */          return new Object2ShortLinkedOpenCustomHashMap.ValueIterator(Object2ShortLinkedOpenCustomHashMap.this);
/* 1112:     */        }
/* 1113:     */        
/* 1114:1114 */        public int size() { return Object2ShortLinkedOpenCustomHashMap.this.size; }
/* 1115:     */        
/* 1116:     */        public boolean contains(short v) {
/* 1117:1117 */          return Object2ShortLinkedOpenCustomHashMap.this.containsValue(v);
/* 1118:     */        }
/* 1119:     */        
/* 1120:1120 */        public void clear() { Object2ShortLinkedOpenCustomHashMap.this.clear(); }
/* 1121:     */      };
/* 1122:     */    }
...
/* 1201:1201 */    short[] value = this.value;
/* 1202:1202 */    int newMask = newN - 1;
/* 1203:1203 */    K[] newKey = (Object[])new Object[newN];
/* 1204:1204 */    short[] newValue = new short[newN];
...
/* 1242:     */  }
/* 1243:     */  
/* 1246:     */  public Object2ShortLinkedOpenCustomHashMap<K> clone()
/* 1247:     */  {
/* 1248:     */    Object2ShortLinkedOpenCustomHashMap<K> c;
/* 1249:     */    
/* 1251:     */    try
/* 1252:     */    {
/* 1253:1253 */      c = (Object2ShortLinkedOpenCustomHashMap)super.clone();
/* 1254:     */    }
...
/* 1262:1262 */    c.value = ((short[])this.value.clone());
...
/* 1291:1291 */    short[] value = this.value;
/* 1292:1292 */    Object2ShortLinkedOpenCustomHashMap<K>.MapIterator i = new MapIterator(null);
/* 1293:1293 */    s.defaultWriteObject();
/* 1294:1294 */    for (int j = this.size; j-- != 0;) {
/* 1295:1295 */      int e = i.nextEntry();
/* 1296:1296 */      s.writeObject(key[e]);
/* 1297:1297 */      s.writeShort(value[e]);
/* 1298:     */    }
/* 1299:     */  }
/* 1300:     */  
...
/* 1307:1307 */    short[] value = this.value = new short[this.n];
