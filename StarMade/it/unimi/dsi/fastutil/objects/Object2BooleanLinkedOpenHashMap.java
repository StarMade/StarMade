...
/*  304 */         int slot = (this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(this.key[pos].hashCode())) & this.mask;
...
/*      */   {
/*  320 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & this.mask;
/*      */ 
/*  322 */     while (this.used[pos] != 0) {
/*  323 */       if (this.key[pos] == null ? k == null : this.key[pos].equals(k)) {
/*  324 */         this.size -= 1;
/*  325 */         fixPointers(pos);
...
/*  336 */     Object k = ok;
/*      */ 
/*  338 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & this.mask;
/*      */ 
/*  340 */     while (this.used[pos] != 0) {
/*  341 */       if (this.key[pos] == null ? k == null : this.key[pos].equals(k)) {
/*  342 */         this.size -= 1;
/*  343 */         fixPointers(pos);
...
/*      */ 
/*  434 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & mask;
/*      */ 
/*  436 */     while (used[pos] != 0) {
/*  437 */       if (k == null ? key[pos] == null : k.equals(key[pos])) {
...
/*      */ 
/*  455 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & mask;
/*      */ 
/*  457 */     while (used[pos] != 0) {
/*  458 */       if (k == null ? key[pos] == null : k.equals(key[pos])) {
...
/*      */ 
/*  477 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & mask;
/*      */ 
/*  479 */     while (used[pos] != 0) {
/*  480 */       if (k == null ? key[pos] == null : k.equals(key[pos])) {
...
/*      */ 
/*  516 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & mask;
/*      */ 
/*  518 */     while (used[pos] != 0) {
/*  519 */       if (k == null ? key[pos] == null : k.equals(key[pos])) {
...
/*      */   {
/*  547 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & this.mask;
/*      */ 
/*  549 */     while (this.used[pos] != 0) {
/*  550 */       if (this.key[pos] == null ? k == null : this.key[pos].equals(k)) return this.value[pos];
...
/*      */   {
/*  558 */     int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & this.mask;
/*      */ 
/*  560 */     while (this.used[pos] != 0) {
/*  561 */       if (this.key[pos] == null ? k == null : this.key[pos].equals(k)) return true;
...
/*  734 */   public Object2BooleanSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  735 */   public Object2BooleanSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  736 */   public Object2BooleanSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1052 */           return new Object2BooleanLinkedOpenHashMap.ValueIterator(Object2BooleanLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1055 */           return Object2BooleanLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(boolean v) {
/* 1058 */           return Object2BooleanLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1061 */           Object2BooleanLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/* 1151 */       Object k = key[i];
/* 1152 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & newMask;
...
/*      */     try
/*      */     {
/* 1194 */       c = (Object2BooleanLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1222 */         t = this.key[i] == null ? 0 : this.key[i].hashCode();
...
/* 1257 */       pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & this.mask;
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2BooleanLinkedOpenHashMap.MapIterator
/*      */     implements BooleanListIterator
/*      */   {
/*      */     public boolean previousBoolean()
/*      */     {
/* 1039 */       return Object2BooleanLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1040 */     public Boolean previous() { return Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1046 */     public boolean nextBoolean() { return Object2BooleanLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1047 */     public Boolean next() { return Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Object2BooleanLinkedOpenHashMap.KeyIterator(Object2BooleanLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/*  999 */       return new Object2BooleanLinkedOpenHashMap.KeyIterator(Object2BooleanLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Object2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1005 */       return Object2BooleanLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1008 */       int oldSize = Object2BooleanLinkedOpenHashMap.this.size;
/* 1009 */       Object2BooleanLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Object2BooleanLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Object2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1016 */       if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1020 */       if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.last];
/*      */     }
/* 1023 */     public Comparator<? super K> comparator() { return null; } 
/* 1024 */     public final ObjectSortedSet<K> tailSet(K from) { throw new UnsupportedOperationException(); } 
/* 1025 */     public final ObjectSortedSet<K> headSet(K to) { throw new UnsupportedOperationException(); } 
/* 1026 */     public final ObjectSortedSet<K> subSet(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2BooleanLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/*  987 */       super(k, null); } 
/*  988 */     public K previous() { return Object2BooleanLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  992 */     public K next() { return Object2BooleanLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  915 */       return new Object2BooleanLinkedOpenHashMap.EntryIterator(Object2BooleanLinkedOpenHashMap.this);
/*      */     }
/*  917 */     public Comparator<? super Object2BooleanMap.Entry<K>> comparator() { return null; } 
/*  918 */     public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> fromElement, Object2BooleanMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  919 */     public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  920 */     public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Object2BooleanMap.Entry<K> first() {
/*  922 */       if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, Object2BooleanLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Object2BooleanMap.Entry<K> last() {
/*  926 */       if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  927 */       return new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, Object2BooleanLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  935 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */ 
/*  937 */       while (Object2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  938 */         if (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2BooleanLinkedOpenHashMap.this.key[pos].equals(k)) return Object2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/*  939 */         pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */       }
/*  941 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  949 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */ 
/*  951 */       while (Object2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  952 */         if (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2BooleanLinkedOpenHashMap.this.key[pos].equals(k)) {
/*  953 */           Object2BooleanLinkedOpenHashMap.this.remove(e.getKey());
/*  954 */           return true;
/*      */         }
/*  956 */         pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */       }
/*  958 */       return false;
/*      */     }
/*      */     public int size() {
/*  961 */       return Object2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  964 */       Object2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator(Object2BooleanMap.Entry<K> from) {
/*  967 */       return new Object2BooleanLinkedOpenHashMap.EntryIterator(Object2BooleanLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> fastIterator() {
/*  970 */       return new Object2BooleanLinkedOpenHashMap.FastEntryIterator(Object2BooleanLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> fastIterator(Object2BooleanMap.Entry<K> from) {
/*  973 */       return new Object2BooleanLinkedOpenHashMap.FastEntryIterator(Object2BooleanLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Object2BooleanLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2BooleanMap.Entry<K>>
/*      */   {
/*  893 */     final AbstractObject2BooleanMap.BasicEntry<K> entry = new AbstractObject2BooleanMap.BasicEntry(null, false);
/*      */ 
...
/*  899 */       int e = nextEntry();
/*  900 */       this.entry.key = Object2BooleanLinkedOpenHashMap.this.key[e];
/*  901 */       this.entry.value = Object2BooleanLinkedOpenHashMap.this.value[e];
/*  902 */       return this.entry;
/*      */     }
/*      */     public AbstractObject2BooleanMap.BasicEntry<K> previous() {
/*  905 */       int e = previousEntry();
/*  906 */       this.entry.key = Object2BooleanLinkedOpenHashMap.this.key[e];
/*  907 */       this.entry.value = Object2BooleanLinkedOpenHashMap.this.value[e];
/*  908 */       return this.entry;
/*      */     }
/*  910 */     public void set(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  911 */     public void add(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2BooleanLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Object2BooleanMap.Entry<K>>
/*      */   {
...
/*  879 */       return this.entry = new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Object2BooleanLinkedOpenHashMap<K>.MapEntry previous() {
/*  882 */       return this.entry = new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  886 */       super.remove();
/*  887 */       Object2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  889 */     public void set(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  890 */     public void add(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  751 */     int index = -1;
/*      */ 
/*  753 */     private MapIterator() { this.next = Object2BooleanLinkedOpenHashMap.this.first;
/*  754 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  757 */       if (Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.last] == null ? from == null : Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.last].equals(from)) {
/*  758 */         this.prev = Object2BooleanLinkedOpenHashMap.this.last;
/*  759 */         this.index = Object2BooleanLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  763 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */ 
/*  765 */         while (Object2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  766 */           if (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2BooleanLinkedOpenHashMap.this.key[pos].equals(from))
/*      */           {
/*  768 */             this.next = ((int)Object2BooleanLinkedOpenHashMap.this.link[pos]);
/*  769 */             this.prev = pos;
/*  770 */             return;
/*      */           }
/*  772 */           pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  785 */       if (this.next == -1) {
/*  786 */         this.index = Object2BooleanLinkedOpenHashMap.this.size;
/*  787 */         return;
/*      */       }
/*  789 */       int pos = Object2BooleanLinkedOpenHashMap.this.first;
/*  790 */       this.index = 1;
/*  791 */       while (pos != this.prev) {
/*  792 */         pos = (int)Object2BooleanLinkedOpenHashMap.this.link[pos];
/*  793 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  805 */       if (!hasNext()) return Object2BooleanLinkedOpenHashMap.this.size();
/*  806 */       this.curr = this.next;
/*  807 */       this.next = ((int)Object2BooleanLinkedOpenHashMap.this.link[this.curr]);
...
/*  815 */       this.prev = ((int)(Object2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  827 */         this.index -= 1;
/*  828 */         this.prev = ((int)(Object2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  831 */         this.next = ((int)Object2BooleanLinkedOpenHashMap.this.link[this.curr]);
/*  832 */       }Object2BooleanLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  835 */       if (this.prev == -1) Object2BooleanLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  837 */         Object2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Object2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  838 */       if (this.next == -1) Object2BooleanLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  840 */         Object2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Object2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  844 */         pos = (last = pos) + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*  845 */         while (Object2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  846 */           int slot = (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2BooleanLinkedOpenHashMap.this.key[pos].hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask;
/*  847 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  848 */           pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*      */         }
/*  850 */         if (Object2BooleanLinkedOpenHashMap.this.used[pos] == 0) break;
/*  851 */         Object2BooleanLinkedOpenHashMap.this.key[last] = Object2BooleanLinkedOpenHashMap.this.key[pos];
/*  852 */         Object2BooleanLinkedOpenHashMap.this.value[last] = Object2BooleanLinkedOpenHashMap.this.value[pos];
/*  853 */         if (this.next == pos) this.next = last;
/*  854 */         if (this.prev == pos) this.prev = last;
/*  855 */         Object2BooleanLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  857 */       Object2BooleanLinkedOpenHashMap.this.used[last] = false;
/*  858 */       Object2BooleanLinkedOpenHashMap.this.key[last] = null;
/*  859 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  620 */       return Object2BooleanLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Boolean getValue() {
/*  623 */       return Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public boolean getBooleanValue() {
/*  626 */       return Object2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public boolean setValue(boolean v) {
/*  629 */       boolean oldValue = Object2BooleanLinkedOpenHashMap.this.value[this.index];
/*  630 */       Object2BooleanLinkedOpenHashMap.this.value[this.index] = v;
/*  631 */       return oldValue;
/*      */     }
/*      */     public Boolean setValue(Boolean v) {
...
/*  640 */       return (Object2BooleanLinkedOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2BooleanLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     public int hashCode() {
/*  643 */       return (Object2BooleanLinkedOpenHashMap.this.key[this.index] == null ? 0 : Object2BooleanLinkedOpenHashMap.this.key[this.index].hashCode()) ^ (Object2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
/*      */     }
/*      */     public String toString() {
/*  646 */       return Object2BooleanLinkedOpenHashMap.this.key[this.index] + "=>" + Object2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
