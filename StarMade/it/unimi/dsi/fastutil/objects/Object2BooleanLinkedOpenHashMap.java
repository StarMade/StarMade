  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2BooleanLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Object2BooleanLinkedOpenHashMap(Map<? extends K, ? extends Boolean> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2BooleanLinkedOpenHashMap(Map<? extends K, ? extends Boolean> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2BooleanLinkedOpenHashMap(Object2BooleanMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Object2BooleanLinkedOpenHashMap(Object2BooleanMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Object2BooleanLinkedOpenHashMap(K[] local_k, boolean[] local_v, float local_f)
  {
  ...
  public Object2BooleanLinkedOpenHashMap(K[] local_k, boolean[] local_v)
  {
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Object2BooleanLinkedOpenHashMap.ValueIterator(Object2BooleanLinkedOpenHashMap.this);
        }
        ...
        {
          return Object2BooleanLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2BooleanLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Object2BooleanLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    boolean[] value = this.value;
    Object2BooleanLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2BooleanLinkedOpenHashMap.MapIterator
    implements BooleanListIterator
  {
    ...
    {
      return Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Boolean next()
    {
      return Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractObjectSortedSet<K>
  {
    ...
    {
      return new Object2BooleanLinkedOpenHashMap.KeyIterator(Object2BooleanLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Object2BooleanLinkedOpenHashMap.KeyIterator(Object2BooleanLinkedOpenHashMap.this);
    }
    ...
    {
      return Object2BooleanLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2BooleanLinkedOpenHashMap.this.size;
      Object2BooleanLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Object2BooleanSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Object2BooleanLinkedOpenHashMap.EntryIterator(Object2BooleanLinkedOpenHashMap.this);
    }
    ...
    public Object2BooleanMap.Entry<K> first()
    {
      ...
      return new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, Object2BooleanLinkedOpenHashMap.this.first);
    }
    ...
    public Object2BooleanMap.Entry<K> last()
    {
      ...
      return new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, Object2BooleanLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask; Object2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask) {
        if (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2BooleanLinkedOpenHashMap.this.key[pos].equals(local_k)) {
          return Object2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)local_e.getValue()).booleanValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(local_k.hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask; Object2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask) {
        if (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? local_k == null : Object2BooleanLinkedOpenHashMap.this.key[pos].equals(local_k))
        {
          Object2BooleanLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Object2BooleanLinkedOpenHashMap.EntryIterator(Object2BooleanLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> fastIterator()
    {
      return new Object2BooleanLinkedOpenHashMap.FastEntryIterator(Object2BooleanLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> fastIterator(Object2BooleanMap.Entry<K> from)
    {
      return new Object2BooleanLinkedOpenHashMap.FastEntryIterator(Object2BooleanLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Object2BooleanMap.Entry<K>>
  {
    ...
    public AbstractObject2BooleanMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2BooleanLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Object2BooleanLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Object2BooleanMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, nextEntry());
    }
    
    public Object2BooleanLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask; Object2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask) {
          if (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2BooleanLinkedOpenHashMap.this.key[pos].equals(from))
          {
    ...
    public void remove()
    {
      ...
      Object2BooleanLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Object2BooleanLinkedOpenHashMap.this.first = this.next;
      } else {
        Object2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Object2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Object2BooleanLinkedOpenHashMap.this.last = this.prev;
      } else {
        Object2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Object2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2BooleanLinkedOpenHashMap.this.mask; Object2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask)
        {
          int slot = (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2BooleanLinkedOpenHashMap.this.key[pos].hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2BooleanLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Object2BooleanLinkedOpenHashMap.this.key[last] = Object2BooleanLinkedOpenHashMap.this.key[pos];
      ...
      Object2BooleanLinkedOpenHashMap.this.used[last] = false;
      Object2BooleanLinkedOpenHashMap.this.key[last] = null;
      this.curr = -1;
    }
    ...
    implements Object2BooleanMap.Entry<K>, Map.Entry<K, Boolean>
  {
    ...
    public boolean setValue(boolean local_v)
    {
      ...
      Object2BooleanLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Boolean> local_e = (Map.Entry)local_o;
      return (Object2BooleanLinkedOpenHashMap.this.key[this.index] == null ? local_e.getKey() == null : Object2BooleanLinkedOpenHashMap.this.key[this.index].equals(local_e.getKey())) && (Object2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)local_e.getValue()).booleanValue());
    }
    
    public int hashCode()
    {
      return (Object2BooleanLinkedOpenHashMap.this.key[this.index] == null ? 0 : Object2BooleanLinkedOpenHashMap.this.key[this.index].hashCode()) ^ (Object2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
    }
