...
/*   18:     */
/*  113:     */public class Object2BooleanLinkedOpenHashMap<K>
...
/*  141:     */  
/*  149:     */  public Object2BooleanLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Object2BooleanLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Object2BooleanLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Object2BooleanLinkedOpenHashMap(Map<? extends K, ? extends Boolean> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Object2BooleanLinkedOpenHashMap(Map<? extends K, ? extends Boolean> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Object2BooleanLinkedOpenHashMap(Object2BooleanMap<K> m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Object2BooleanLinkedOpenHashMap(Object2BooleanMap<K> m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Object2BooleanLinkedOpenHashMap(K[] k, boolean[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Object2BooleanLinkedOpenHashMap(K[] k, boolean[] v)
/*  225:     */  {
...
/*  611:     */    implements Object2BooleanMap.Entry<K>, Map.Entry<K, Boolean>
/*  612:     */  {
...
/*  618:     */    }
/*  619:     */    
/*  620: 620 */    public K getKey() { return Object2BooleanLinkedOpenHashMap.this.key[this.index]; }
/*  621:     */    
/*  622:     */    public Boolean getValue() {
/*  623: 623 */      return Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.value[this.index]);
/*  624:     */    }
/*  625:     */    
/*  626: 626 */    public boolean getBooleanValue() { return Object2BooleanLinkedOpenHashMap.this.value[this.index]; }
/*  627:     */    
/*  628:     */    public boolean setValue(boolean v) {
/*  629: 629 */      boolean oldValue = Object2BooleanLinkedOpenHashMap.this.value[this.index];
/*  630: 630 */      Object2BooleanLinkedOpenHashMap.this.value[this.index] = v;
...
/*  640: 640 */      return (Object2BooleanLinkedOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2BooleanLinkedOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*  641:     */    }
/*  642:     */    
/*  643: 643 */    public int hashCode() { return (Object2BooleanLinkedOpenHashMap.this.key[this.index] == null ? 0 : Object2BooleanLinkedOpenHashMap.this.key[this.index].hashCode()) ^ (Object2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237); }
/*  644:     */    
/*  645:     */    public String toString() {
/*  646: 646 */      return Object2BooleanLinkedOpenHashMap.this.key[this.index] + "=>" + Object2BooleanLinkedOpenHashMap.this.value[this.index];
/*  647:     */    }
/*  648:     */  }
/*  649:     */  
...
/*  734: 734 */  public Object2BooleanSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); }
/*  735: 735 */  public Object2BooleanSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); }
/*  736: 736 */  public Object2BooleanSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*  737:     */  
...
/*  751: 751 */    int index = -1;
/*  752:     */    
/*  753: 753 */    private MapIterator() { this.next = Object2BooleanLinkedOpenHashMap.this.first;
/*  754: 754 */      this.index = 0;
/*  755:     */    }
/*  756:     */    
/*  757: 757 */    private MapIterator() { if (Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.last] == null ? from == null : Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.last].equals(from)) {
/*  758: 758 */        this.prev = Object2BooleanLinkedOpenHashMap.this.last;
/*  759: 759 */        this.index = Object2BooleanLinkedOpenHashMap.this.size;
/*  760:     */      }
/*  761:     */      else
/*  762:     */      {
/*  763: 763 */        int pos = (from == null ? 142593372 : HashCommon.murmurHash3(from.hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask;
/*  764:     */        
/*  765: 765 */        while (Object2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  766: 766 */          if (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? from == null : Object2BooleanLinkedOpenHashMap.this.key[pos].equals(from))
/*  767:     */          {
/*  768: 768 */            this.next = ((int)Object2BooleanLinkedOpenHashMap.this.link[pos]);
/*  769: 769 */            this.prev = pos;
/*  770: 770 */            return;
/*  771:     */          }
/*  772: 772 */          pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*  773:     */        }
...
/*  786: 786 */        this.index = Object2BooleanLinkedOpenHashMap.this.size;
/*  787: 787 */        return;
/*  788:     */      }
/*  789: 789 */      int pos = Object2BooleanLinkedOpenHashMap.this.first;
/*  790: 790 */      this.index = 1;
/*  791: 791 */      while (pos != this.prev) {
/*  792: 792 */        pos = (int)Object2BooleanLinkedOpenHashMap.this.link[pos];
...
/*  803:     */    }
/*  804:     */    
/*  805: 805 */    public int nextEntry() { if (!hasNext()) return Object2BooleanLinkedOpenHashMap.this.size();
/*  806: 806 */      this.curr = this.next;
/*  807: 807 */      this.next = ((int)Object2BooleanLinkedOpenHashMap.this.link[this.curr]);
...
/*  815: 815 */      this.prev = ((int)(Object2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  828: 828 */        this.prev = ((int)(Object2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  829:     */      }
/*  830:     */      else {
/*  831: 831 */        this.next = ((int)Object2BooleanLinkedOpenHashMap.this.link[this.curr]); }
/*  832: 832 */      Object2BooleanLinkedOpenHashMap.this.size -= 1;
/*  833:     */      
/*  835: 835 */      if (this.prev == -1) { Object2BooleanLinkedOpenHashMap.this.first = this.next;
/*  836:     */      } else
/*  837: 837 */        Object2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Object2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  838: 838 */      if (this.next == -1) { Object2BooleanLinkedOpenHashMap.this.last = this.prev;
/*  839:     */      } else
/*  840: 840 */        Object2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Object2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  841: 841 */      int pos = this.curr;
/*  842:     */      int last;
/*  843:     */      for (;;) {
/*  844: 844 */        pos = (last = pos) + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*  845: 845 */        while (Object2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  846: 846 */          int slot = (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2BooleanLinkedOpenHashMap.this.key[pos].hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask;
/*  847: 847 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  848: 848 */          pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*  849:     */        }
/*  850: 850 */        if (Object2BooleanLinkedOpenHashMap.this.used[pos] == 0) break;
/*  851: 851 */        Object2BooleanLinkedOpenHashMap.this.key[last] = Object2BooleanLinkedOpenHashMap.this.key[pos];
/*  852: 852 */        Object2BooleanLinkedOpenHashMap.this.value[last] = Object2BooleanLinkedOpenHashMap.this.value[pos];
/*  853: 853 */        if (this.next == pos) this.next = last;
/*  854: 854 */        if (this.prev == pos) this.prev = last;
/*  855: 855 */        Object2BooleanLinkedOpenHashMap.this.fixPointers(pos, last);
/*  856:     */      }
/*  857: 857 */      Object2BooleanLinkedOpenHashMap.this.used[last] = false;
/*  858: 858 */      Object2BooleanLinkedOpenHashMap.this.key[last] = null;
/*  859: 859 */      this.curr = -1;
/*  860:     */    }
/*  861:     */    
...
/*  870:     */    } }
/*  871:     */  
/*  872:     */  private class EntryIterator extends Object2BooleanLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Object2BooleanMap.Entry<K>> { private Object2BooleanLinkedOpenHashMap<K>.MapEntry entry;
/*  873:     */    
/*  874: 874 */    public EntryIterator() { super(null); }
/*  875:     */    
/*  876: 876 */    public EntryIterator() { super(from, null); }
/*  877:     */    
/*  878:     */    public Object2BooleanLinkedOpenHashMap<K>.MapEntry next() {
/*  879: 879 */      return this.entry = new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, nextEntry());
/*  880:     */    }
/*  881:     */    
/*  882: 882 */    public Object2BooleanLinkedOpenHashMap<K>.MapEntry previous() { return this.entry = new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, previousEntry()); }
/*  883:     */    
/*  884:     */    public void remove()
/*  885:     */    {
/*  886: 886 */      super.remove();
/*  887: 887 */      Object2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  888:     */    
/*  889: 889 */    public void set(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  890: 890 */    public void add(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  891:     */  }
/*  892:     */  
/*  893: 893 */  private class FastEntryIterator extends Object2BooleanLinkedOpenHashMap<K>.MapIterator implements ObjectListIterator<Object2BooleanMap.Entry<K>> { final AbstractObject2BooleanMap.BasicEntry<K> entry = new AbstractObject2BooleanMap.BasicEntry(null, false);
/*  894: 894 */    public FastEntryIterator() { super(null); }
/*  895:     */    
/*  896: 896 */    public FastEntryIterator() { super(from, null); }
/*  897:     */    
/*  898:     */    public AbstractObject2BooleanMap.BasicEntry<K> next() {
/*  899: 899 */      int e = nextEntry();
/*  900: 900 */      this.entry.key = Object2BooleanLinkedOpenHashMap.this.key[e];
/*  901: 901 */      this.entry.value = Object2BooleanLinkedOpenHashMap.this.value[e];
/*  902: 902 */      return this.entry;
/*  903:     */    }
/*  904:     */    
/*  905: 905 */    public AbstractObject2BooleanMap.BasicEntry<K> previous() { int e = previousEntry();
/*  906: 906 */      this.entry.key = Object2BooleanLinkedOpenHashMap.this.key[e];
/*  907: 907 */      this.entry.value = Object2BooleanLinkedOpenHashMap.this.value[e];
/*  908: 908 */      return this.entry; }
/*  909:     */    
/*  910: 910 */    public void set(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  911: 911 */    public void add(Object2BooleanMap.Entry<K> ok) { throw new UnsupportedOperationException(); } }
/*  912:     */  
/*  913:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Object2BooleanMap.Entry<K>> implements Object2BooleanSortedMap.FastSortedEntrySet<K> { private MapEntrySet() {}
/*  914:     */    
/*  915: 915 */    public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator() { return new Object2BooleanLinkedOpenHashMap.EntryIterator(Object2BooleanLinkedOpenHashMap.this); }
/*  916:     */    
/*  917: 917 */    public Comparator<? super Object2BooleanMap.Entry<K>> comparator() { return null; }
/*  918: 918 */    public ObjectSortedSet<Object2BooleanMap.Entry<K>> subSet(Object2BooleanMap.Entry<K> fromElement, Object2BooleanMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  919: 919 */    public ObjectSortedSet<Object2BooleanMap.Entry<K>> headSet(Object2BooleanMap.Entry<K> toElement) { throw new UnsupportedOperationException(); }
/*  920: 920 */    public ObjectSortedSet<Object2BooleanMap.Entry<K>> tailSet(Object2BooleanMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); }
/*  921:     */    
/*  922: 922 */    public Object2BooleanMap.Entry<K> first() { if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923: 923 */      return new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, Object2BooleanLinkedOpenHashMap.this.first);
/*  924:     */    }
/*  925:     */    
/*  926: 926 */    public Object2BooleanMap.Entry<K> last() { if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  927: 927 */      return new Object2BooleanLinkedOpenHashMap.MapEntry(Object2BooleanLinkedOpenHashMap.this, Object2BooleanLinkedOpenHashMap.this.last);
/*  928:     */    }
/*  929:     */    
...
/*  934:     */      
/*  935: 935 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask;
/*  936:     */      
/*  937: 937 */      while (Object2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  938: 938 */        if (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2BooleanLinkedOpenHashMap.this.key[pos].equals(k)) return Object2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/*  939: 939 */        pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*  940:     */      }
...
/*  948:     */      
/*  949: 949 */      int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2BooleanLinkedOpenHashMap.this.mask;
/*  950:     */      
/*  951: 951 */      while (Object2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  952: 952 */        if (Object2BooleanLinkedOpenHashMap.this.key[pos] == null ? k == null : Object2BooleanLinkedOpenHashMap.this.key[pos].equals(k)) {
/*  953: 953 */          Object2BooleanLinkedOpenHashMap.this.remove(e.getKey());
/*  954: 954 */          return true;
/*  955:     */        }
/*  956: 956 */        pos = pos + 1 & Object2BooleanLinkedOpenHashMap.this.mask;
/*  957:     */      }
/*  958: 958 */      return false;
/*  959:     */    }
/*  960:     */    
/*  961: 961 */    public int size() { return Object2BooleanLinkedOpenHashMap.this.size; }
/*  962:     */    
/*  963:     */    public void clear() {
/*  964: 964 */      Object2BooleanLinkedOpenHashMap.this.clear();
/*  965:     */    }
/*  966:     */    
/*  967: 967 */    public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> iterator(Object2BooleanMap.Entry<K> from) { return new Object2BooleanLinkedOpenHashMap.EntryIterator(Object2BooleanLinkedOpenHashMap.this, from.getKey()); }
/*  968:     */    
/*  969:     */    public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> fastIterator() {
/*  970: 970 */      return new Object2BooleanLinkedOpenHashMap.FastEntryIterator(Object2BooleanLinkedOpenHashMap.this);
/*  971:     */    }
/*  972:     */    
/*  973: 973 */    public ObjectBidirectionalIterator<Object2BooleanMap.Entry<K>> fastIterator(Object2BooleanMap.Entry<K> from) { return new Object2BooleanLinkedOpenHashMap.FastEntryIterator(Object2BooleanLinkedOpenHashMap.this, from.getKey()); }
/*  974:     */  }
/*  975:     */  
/*  976:     */  public Object2BooleanSortedMap.FastSortedEntrySet<K> object2BooleanEntrySet() {
...
/*  984:     */    extends Object2BooleanLinkedOpenHashMap<K>.MapIterator
/*  985:     */    implements ObjectListIterator<K>
/*  986:     */  {
/*  987: 987 */    public KeyIterator() { super(k, null); }
/*  988: 988 */    public K previous() { return Object2BooleanLinkedOpenHashMap.this.key[previousEntry()]; }
...
/*  992: 992 */    public K next() { return Object2BooleanLinkedOpenHashMap.this.key[nextEntry()]; } }
/*  993:     */  
/*  994:     */  private final class KeySet extends AbstractObjectSortedSet<K> { private KeySet() {}
/*  995:     */    
/*  996: 996 */    public ObjectListIterator<K> iterator(K from) { return new Object2BooleanLinkedOpenHashMap.KeyIterator(Object2BooleanLinkedOpenHashMap.this, from); }
/*  997:     */    
/*  998:     */    public ObjectListIterator<K> iterator() {
/*  999: 999 */      return new Object2BooleanLinkedOpenHashMap.KeyIterator(Object2BooleanLinkedOpenHashMap.this);
/* 1000:     */    }
/* 1001:     */    
/* 1002:1002 */    public int size() { return Object2BooleanLinkedOpenHashMap.this.size; }
/* 1003:     */    
/* 1005:1005 */    public boolean contains(Object k) { return Object2BooleanLinkedOpenHashMap.this.containsKey(k); }
/* 1006:     */    
/* 1007:     */    public boolean remove(Object k) {
/* 1008:1008 */      int oldSize = Object2BooleanLinkedOpenHashMap.this.size;
/* 1009:1009 */      Object2BooleanLinkedOpenHashMap.this.remove(k);
/* 1010:1010 */      return Object2BooleanLinkedOpenHashMap.this.size != oldSize;
/* 1011:     */    }
/* 1012:     */    
/* 1013:1013 */    public void clear() { Object2BooleanLinkedOpenHashMap.this.clear(); }
/* 1014:     */    
/* 1015:     */    public K first() {
/* 1016:1016 */      if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017:1017 */      return Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.first];
/* 1018:     */    }
/* 1019:     */    
/* 1020:1020 */    public K last() { if (Object2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021:1021 */      return Object2BooleanLinkedOpenHashMap.this.key[Object2BooleanLinkedOpenHashMap.this.last]; }
/* 1022:     */    
...
/* 1036:     */    extends Object2BooleanLinkedOpenHashMap.MapIterator
/* 1037:     */    implements BooleanListIterator
/* 1038:     */  {
/* 1039:1039 */    public boolean previousBoolean() { return Object2BooleanLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1040:1040 */    public Boolean previous() { return Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1046:1046 */    public boolean nextBoolean() { return Object2BooleanLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1047:1047 */    public Boolean next() { return Boolean.valueOf(Object2BooleanLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1048:     */  }
/* 1049:     */  
...
/* 1052:1052 */          return new Object2BooleanLinkedOpenHashMap.ValueIterator(Object2BooleanLinkedOpenHashMap.this);
/* 1053:     */        }
/* 1054:     */        
/* 1055:1055 */        public int size() { return Object2BooleanLinkedOpenHashMap.this.size; }
/* 1056:     */        
/* 1057:     */        public boolean contains(boolean v) {
/* 1058:1058 */          return Object2BooleanLinkedOpenHashMap.this.containsValue(v);
/* 1059:     */        }
/* 1060:     */        
/* 1061:1061 */        public void clear() { Object2BooleanLinkedOpenHashMap.this.clear(); }
/* 1062:     */      };
/* 1063:     */    }
...
/* 1183:     */  }
/* 1184:     */  
/* 1187:     */  public Object2BooleanLinkedOpenHashMap<K> clone()
/* 1188:     */  {
/* 1189:     */    Object2BooleanLinkedOpenHashMap<K> c;
/* 1190:     */    
/* 1192:     */    try
/* 1193:     */    {
/* 1194:1194 */      c = (Object2BooleanLinkedOpenHashMap)super.clone();
/* 1195:     */    }
...
/* 1232:1232 */    Object2BooleanLinkedOpenHashMap<K>.MapIterator i = new MapIterator(null);
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.Object2BooleanLinkedOpenHashMap
