...
/* 649 */           return new Object2ShortOpenCustomHashMap.ValueIterator(Object2ShortOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 652 */           return Object2ShortOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(short v) {
/* 655 */           return Object2ShortOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 658 */           Object2ShortOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 773 */       c = (Object2ShortOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Object2ShortOpenCustomHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 642 */       super(null); } 
/* 643 */     public short nextShort() { return Object2ShortOpenCustomHashMap.this.value[nextEntry()]; } 
/* 644 */     public Short next() { return Short.valueOf(Object2ShortOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 614 */       return new Object2ShortOpenCustomHashMap.KeyIterator(Object2ShortOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 617 */       return Object2ShortOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 620 */       return Object2ShortOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 623 */       int oldSize = Object2ShortOpenCustomHashMap.this.size;
/* 624 */       Object2ShortOpenCustomHashMap.this.remove(k);
/* 625 */       return Object2ShortOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 628 */       Object2ShortOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Object2ShortOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 609 */       super(null); } 
/* 610 */     public K next() { return Object2ShortOpenCustomHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 555 */       return new Object2ShortOpenCustomHashMap.EntryIterator(Object2ShortOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Object2ShortMap.Entry<K>> fastIterator() {
/* 558 */       return new Object2ShortOpenCustomHashMap.FastEntryIterator(Object2ShortOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 566 */       int pos = HashCommon.murmurHash3(Object2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortOpenCustomHashMap.this.mask;
/*     */ 
/* 568 */       while (Object2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 569 */         if (Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[pos], k)) return Object2ShortOpenCustomHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 570 */         pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask;
/*     */       }
/* 572 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 580 */       int pos = HashCommon.murmurHash3(Object2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortOpenCustomHashMap.this.mask;
/*     */ 
/* 582 */       while (Object2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 583 */         if (Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[pos], k)) {
/* 584 */           Object2ShortOpenCustomHashMap.this.remove(e.getKey());
/* 585 */           return true;
/*     */         }
/* 587 */         pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask;
/*     */       }
/* 589 */       return false;
/*     */     }
/*     */     public int size() {
/* 592 */       return Object2ShortOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 595 */       Object2ShortOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Object2ShortOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2ShortMap.Entry<K>>
/*     */   {
/* 545 */     final AbstractObject2ShortMap.BasicEntry<K> entry = new AbstractObject2ShortMap.BasicEntry(null, (short)0);
/*     */ 
...
/* 547 */       int e = nextEntry();
/* 548 */       this.entry.key = Object2ShortOpenCustomHashMap.this.key[e];
/* 549 */       this.entry.value = Object2ShortOpenCustomHashMap.this.value[e];
/* 550 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Object2ShortOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2ShortMap.Entry<K>>
/*     */   {
...
/* 536 */       return this.entry = new Object2ShortOpenCustomHashMap.MapEntry(Object2ShortOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 540 */       super.remove();
/* 541 */       Object2ShortOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 441 */       this.pos = Object2ShortOpenCustomHashMap.this.n;
/*     */ 
/* 444 */       this.last = -1;
/*     */ 
/* 446 */       this.c = Object2ShortOpenCustomHashMap.this.size;
/*     */ 
/* 451 */       boolean[] used = Object2ShortOpenCustomHashMap.this.used;
...
/*     */ 
/* 464 */         int pos = HashCommon.murmurHash3(Object2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortOpenCustomHashMap.this.mask;
/*     */ 
/* 466 */         while (Object2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 467 */           if (Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[pos], k)) return pos;
/* 468 */           pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 471 */       this.last = this.pos;
/*     */ 
/* 473 */       if (this.c != 0) {
/* 474 */         boolean[] used = Object2ShortOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 491 */         pos = (last = pos) + 1 & Object2ShortOpenCustomHashMap.this.mask;
/* 492 */         while (Object2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 493 */           int slot = HashCommon.murmurHash3(Object2ShortOpenCustomHashMap.this.strategy.hashCode(Object2ShortOpenCustomHashMap.this.key[pos])) & Object2ShortOpenCustomHashMap.this.mask;
/* 494 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 495 */           pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask;
/*     */         }
/* 497 */         if (Object2ShortOpenCustomHashMap.this.used[pos] == 0) break;
/* 498 */         if (pos < last)
/*     */         {
/* 500 */           if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 501 */           this.wrapped.add(Object2ShortOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 503 */         Object2ShortOpenCustomHashMap.this.key[last] = Object2ShortOpenCustomHashMap.this.key[pos];
/* 504 */         Object2ShortOpenCustomHashMap.this.value[last] = Object2ShortOpenCustomHashMap.this.value[pos];
/*     */       }
/* 506 */       Object2ShortOpenCustomHashMap.this.used[last] = false;
/* 507 */       Object2ShortOpenCustomHashMap.this.key[last] = null;
/* 508 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 513 */       if (this.pos < -1)
/*     */       {
/* 515 */         Object2ShortOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 516 */         this.last = -1;
/* 517 */         return;
/*     */       }
/* 519 */       Object2ShortOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 408 */       return Object2ShortOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Short getValue() {
/* 411 */       return Short.valueOf(Object2ShortOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public short getShortValue() {
/* 414 */       return Object2ShortOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public short setValue(short v) {
/* 417 */       short oldValue = Object2ShortOpenCustomHashMap.this.value[this.index];
/* 418 */       Object2ShortOpenCustomHashMap.this.value[this.index] = v;
/* 419 */       return oldValue;
/*     */     }
/*     */     public Short setValue(Short v) {
...
/* 428 */       return (Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2ShortOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */     public int hashCode() {
/* 431 */       return Object2ShortOpenCustomHashMap.this.strategy.hashCode(Object2ShortOpenCustomHashMap.this.key[this.index]) ^ Object2ShortOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 434 */       return Object2ShortOpenCustomHashMap.this.key[this.index] + "=>" + Object2ShortOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
