...
/*  17:    */
/*  89:    */public class Object2ShortOpenCustomHashMap<K>
/*  90:    */  extends AbstractObject2ShortMap<K>
...
/* 103:    */  protected volatile transient Object2ShortMap.FastEntrySet<K> entries;
...
/* 107:    */  
/* 108:    */  public Object2ShortOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy)
/* 109:    */  {
...
/* 120:    */  }
/* 121:    */  
/* 125:    */  public Object2ShortOpenCustomHashMap(int expected, Hash.Strategy<K> strategy)
/* 126:    */  {
/* 127:127 */    this(expected, 0.75F, strategy);
/* 128:    */  }
/* 129:    */  
/* 132:    */  public Object2ShortOpenCustomHashMap(Hash.Strategy<K> strategy)
/* 133:    */  {
/* 134:134 */    this(16, 0.75F, strategy);
/* 135:    */  }
/* 136:    */  
/* 141:    */  public Object2ShortOpenCustomHashMap(Map<? extends K, ? extends Short> m, float f, Hash.Strategy<K> strategy)
/* 142:    */  {
/* 143:143 */    this(m.size(), f, strategy);
/* 144:144 */    putAll(m);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Object2ShortOpenCustomHashMap(Map<? extends K, ? extends Short> m, Hash.Strategy<K> strategy)
/* 151:    */  {
/* 152:152 */    this(m, 0.75F, strategy);
/* 153:    */  }
/* 154:    */  
/* 159:    */  public Object2ShortOpenCustomHashMap(Object2ShortMap<K> m, float f, Hash.Strategy<K> strategy)
/* 160:    */  {
/* 161:161 */    this(m.size(), f, strategy);
/* 162:162 */    putAll(m);
/* 163:    */  }
/* 164:    */  
/* 168:    */  public Object2ShortOpenCustomHashMap(Object2ShortMap<K> m, Hash.Strategy<K> strategy)
/* 169:    */  {
/* 170:170 */    this(m, 0.75F, strategy);
/* 171:    */  }
/* 172:    */  
/* 179:    */  public Object2ShortOpenCustomHashMap(K[] k, short[] v, float f, Hash.Strategy<K> strategy)
/* 180:    */  {
...
/* 185:    */  }
/* 186:    */  
/* 191:    */  public Object2ShortOpenCustomHashMap(K[] k, short[] v, Hash.Strategy<K> strategy)
/* 192:    */  {
...
/* 264:264 */          tmp60_59 = pos; short[] tmp60_56 = this.value;tmp60_56[tmp60_59] = ((short)(tmp60_56[tmp60_59] + incr));
...
/* 399:    */    implements Object2ShortMap.Entry<K>, Map.Entry<K, Short>
/* 400:    */  {
...
/* 406:    */    }
/* 407:    */    
/* 408:408 */    public K getKey() { return Object2ShortOpenCustomHashMap.this.key[this.index]; }
/* 409:    */    
/* 410:    */    public Short getValue() {
/* 411:411 */      return Short.valueOf(Object2ShortOpenCustomHashMap.this.value[this.index]);
/* 412:    */    }
/* 413:    */    
/* 414:414 */    public short getShortValue() { return Object2ShortOpenCustomHashMap.this.value[this.index]; }
/* 415:    */    
/* 416:    */    public short setValue(short v) {
/* 417:417 */      short oldValue = Object2ShortOpenCustomHashMap.this.value[this.index];
/* 418:418 */      Object2ShortOpenCustomHashMap.this.value[this.index] = v;
...
/* 428:428 */      return (Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2ShortOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/* 429:    */    }
/* 430:    */    
/* 431:431 */    public int hashCode() { return Object2ShortOpenCustomHashMap.this.strategy.hashCode(Object2ShortOpenCustomHashMap.this.key[this.index]) ^ Object2ShortOpenCustomHashMap.this.value[this.index]; }
/* 432:    */    
/* 434:434 */    public String toString() { return Object2ShortOpenCustomHashMap.this.key[this.index] + "=>" + Object2ShortOpenCustomHashMap.this.value[this.index]; } }
/* 435:    */  
...
/* 440:    */    
/* 441:441 */    private MapIterator() { this.pos = Object2ShortOpenCustomHashMap.this.n;
/* 442:    */      
/* 444:444 */      this.last = -1;
/* 445:    */      
/* 446:446 */      this.c = Object2ShortOpenCustomHashMap.this.size;
/* 447:    */      
/* 451:451 */      boolean[] used = Object2ShortOpenCustomHashMap.this.used;
...
/* 463:    */        
/* 464:464 */        int pos = HashCommon.murmurHash3(Object2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortOpenCustomHashMap.this.mask;
/* 465:    */        
/* 466:466 */        while (Object2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 467:467 */          if (Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[pos], k)) return pos;
/* 468:468 */          pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask;
/* 469:    */        }
/* 470:    */      }
/* 471:471 */      this.last = this.pos;
/* 472:    */      
/* 473:473 */      if (this.c != 0) {
/* 474:474 */        boolean[] used = Object2ShortOpenCustomHashMap.this.used;
...
/* 489:    */      for (;;)
/* 490:    */      {
/* 491:491 */        pos = (last = pos) + 1 & Object2ShortOpenCustomHashMap.this.mask;
/* 492:492 */        while (Object2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 493:493 */          int slot = HashCommon.murmurHash3(Object2ShortOpenCustomHashMap.this.strategy.hashCode(Object2ShortOpenCustomHashMap.this.key[pos])) & Object2ShortOpenCustomHashMap.this.mask;
/* 494:494 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 495:495 */          pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask;
/* 496:    */        }
/* 497:497 */        if (Object2ShortOpenCustomHashMap.this.used[pos] == 0) break;
/* 498:498 */        if (pos < last)
/* 499:    */        {
/* 500:500 */          if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 501:501 */          this.wrapped.add(Object2ShortOpenCustomHashMap.this.key[pos]);
/* 502:    */        }
/* 503:503 */        Object2ShortOpenCustomHashMap.this.key[last] = Object2ShortOpenCustomHashMap.this.key[pos];
/* 504:504 */        Object2ShortOpenCustomHashMap.this.value[last] = Object2ShortOpenCustomHashMap.this.value[pos];
/* 505:    */      }
/* 506:506 */      Object2ShortOpenCustomHashMap.this.used[last] = false;
/* 507:507 */      Object2ShortOpenCustomHashMap.this.key[last] = null;
/* 508:508 */      return last;
/* 509:    */    }
/* 510:    */    
...
/* 514:    */      {
/* 515:515 */        Object2ShortOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 516:516 */        this.last = -1;
/* 517:517 */        return;
/* 518:    */      }
/* 519:519 */      Object2ShortOpenCustomHashMap.this.size -= 1;
...
/* 531:    */    } }
/* 532:    */  
/* 533:533 */  private class EntryIterator extends Object2ShortOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2ShortMap.Entry<K>> { private EntryIterator() { super(null); }
/* 534:    */    
/* 535:    */    private Object2ShortOpenCustomHashMap<K>.MapEntry entry;
/* 536:536 */    public Object2ShortMap.Entry<K> next() { return this.entry = new Object2ShortOpenCustomHashMap.MapEntry(Object2ShortOpenCustomHashMap.this, nextEntry()); }
/* 537:    */    
/* 538:    */    public void remove()
/* 539:    */    {
/* 540:540 */      super.remove();
/* 541:541 */      Object2ShortOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 542:    */    } }
/* 543:    */  
/* 544:544 */  private class FastEntryIterator extends Object2ShortOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2ShortMap.Entry<K>> { private FastEntryIterator() { super(null); }
/* 545:545 */    final AbstractObject2ShortMap.BasicEntry<K> entry = new AbstractObject2ShortMap.BasicEntry(null, (short)0);
/* 546:    */    
/* 547:547 */    public AbstractObject2ShortMap.BasicEntry<K> next() { int e = nextEntry();
/* 548:548 */      this.entry.key = Object2ShortOpenCustomHashMap.this.key[e];
/* 549:549 */      this.entry.value = Object2ShortOpenCustomHashMap.this.value[e];
/* 550:550 */      return this.entry;
/* 551:    */    } }
/* 552:    */  
/* 553:    */  private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<K>> implements Object2ShortMap.FastEntrySet<K> { private MapEntrySet() {}
/* 554:    */    
/* 555:555 */    public ObjectIterator<Object2ShortMap.Entry<K>> iterator() { return new Object2ShortOpenCustomHashMap.EntryIterator(Object2ShortOpenCustomHashMap.this, null); }
/* 556:    */    
/* 557:    */    public ObjectIterator<Object2ShortMap.Entry<K>> fastIterator() {
/* 558:558 */      return new Object2ShortOpenCustomHashMap.FastEntryIterator(Object2ShortOpenCustomHashMap.this, null);
/* 559:    */    }
/* 560:    */    
...
/* 565:    */      
/* 566:566 */      int pos = HashCommon.murmurHash3(Object2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortOpenCustomHashMap.this.mask;
/* 567:    */      
/* 568:568 */      while (Object2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 569:569 */        if (Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[pos], k)) return Object2ShortOpenCustomHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 570:570 */        pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask;
/* 571:    */      }
...
/* 579:    */      
/* 580:580 */      int pos = HashCommon.murmurHash3(Object2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ShortOpenCustomHashMap.this.mask;
/* 581:    */      
/* 582:582 */      while (Object2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 583:583 */        if (Object2ShortOpenCustomHashMap.this.strategy.equals(Object2ShortOpenCustomHashMap.this.key[pos], k)) {
/* 584:584 */          Object2ShortOpenCustomHashMap.this.remove(e.getKey());
/* 585:585 */          return true;
/* 586:    */        }
/* 587:587 */        pos = pos + 1 & Object2ShortOpenCustomHashMap.this.mask;
/* 588:    */      }
/* 589:589 */      return false;
/* 590:    */    }
/* 591:    */    
/* 592:592 */    public int size() { return Object2ShortOpenCustomHashMap.this.size; }
/* 593:    */    
/* 595:595 */    public void clear() { Object2ShortOpenCustomHashMap.this.clear(); }
/* 596:    */  }
/* 597:    */  
/* 598:    */  public Object2ShortMap.FastEntrySet<K> object2ShortEntrySet() {
...
/* 606:    */    extends Object2ShortOpenCustomHashMap<K>.MapIterator
/* 607:    */    implements ObjectIterator<K>
/* 608:    */  {
/* 609:609 */    public KeyIterator() { super(null); }
/* 610:610 */    public K next() { return Object2ShortOpenCustomHashMap.this.key[nextEntry()]; } }
/* 611:    */  
/* 612:    */  private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/* 613:    */    
/* 614:614 */    public ObjectIterator<K> iterator() { return new Object2ShortOpenCustomHashMap.KeyIterator(Object2ShortOpenCustomHashMap.this); }
/* 615:    */    
/* 616:    */    public int size() {
/* 617:617 */      return Object2ShortOpenCustomHashMap.this.size;
/* 618:    */    }
/* 619:    */    
/* 620:620 */    public boolean contains(Object k) { return Object2ShortOpenCustomHashMap.this.containsKey(k); }
/* 621:    */    
/* 622:    */    public boolean remove(Object k) {
/* 623:623 */      int oldSize = Object2ShortOpenCustomHashMap.this.size;
/* 624:624 */      Object2ShortOpenCustomHashMap.this.remove(k);
/* 625:625 */      return Object2ShortOpenCustomHashMap.this.size != oldSize;
/* 626:    */    }
/* 627:    */    
/* 628:628 */    public void clear() { Object2ShortOpenCustomHashMap.this.clear(); }
/* 629:    */  }
/* 630:    */  
...
/* 639:    */    extends Object2ShortOpenCustomHashMap.MapIterator
/* 640:    */    implements ShortIterator
/* 641:    */  {
/* 642:642 */    public ValueIterator() { super(null); }
/* 643:643 */    public short nextShort() { return Object2ShortOpenCustomHashMap.this.value[nextEntry()]; }
/* 644:644 */    public Short next() { return Short.valueOf(Object2ShortOpenCustomHashMap.this.value[nextEntry()]); }
/* 645:    */  }
/* 646:    */  
...
/* 649:649 */          return new Object2ShortOpenCustomHashMap.ValueIterator(Object2ShortOpenCustomHashMap.this);
/* 650:    */        }
/* 651:    */        
/* 652:652 */        public int size() { return Object2ShortOpenCustomHashMap.this.size; }
/* 653:    */        
/* 654:    */        public boolean contains(short v) {
/* 655:655 */          return Object2ShortOpenCustomHashMap.this.containsValue(v);
/* 656:    */        }
/* 657:    */        
/* 658:658 */        public void clear() { Object2ShortOpenCustomHashMap.this.clear(); }
/* 659:    */      };
/* 660:    */    }
...
/* 761:    */  }
/* 762:    */  
/* 766:    */  public Object2ShortOpenCustomHashMap<K> clone()
/* 767:    */  {
/* 768:    */    Object2ShortOpenCustomHashMap<K> c;
/* 769:    */    
/* 771:    */    try
/* 772:    */    {
/* 773:773 */      c = (Object2ShortOpenCustomHashMap)super.clone();
/* 774:    */    }
...
/* 811:811 */    Object2ShortOpenCustomHashMap<K>.MapIterator i = new MapIterator(null);
