  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2FloatLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2FloatLinkedOpenHashMap(Map<? extends K, ? extends Float> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2FloatLinkedOpenHashMap(Map<? extends K, ? extends Float> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2FloatLinkedOpenHashMap(Reference2FloatMap<K> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2FloatLinkedOpenHashMap(Reference2FloatMap<K> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2FloatLinkedOpenHashMap(K[] local_k, float[] local_v, float local_f)
  {
  ...
  public Reference2FloatLinkedOpenHashMap(K[] local_k, float[] local_v)
  {
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Reference2FloatLinkedOpenHashMap.ValueIterator(Reference2FloatLinkedOpenHashMap.this);
        }
        ...
        {
          return Reference2FloatLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2FloatLinkedOpenHashMap<K> local_c;
    try
    {
      local_c = (Reference2FloatLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    float[] value = this.value;
    Reference2FloatLinkedOpenHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Reference2FloatLinkedOpenHashMap.MapIterator
    implements FloatListIterator
  {
    ...
    {
      return Float.valueOf(Reference2FloatLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Reference2FloatLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractReferenceSortedSet<K>
  {
    ...
    {
      return new Reference2FloatLinkedOpenHashMap.KeyIterator(Reference2FloatLinkedOpenHashMap.this, from);
    }
    
    public ObjectListIterator<K> iterator()
    {
      return new Reference2FloatLinkedOpenHashMap.KeyIterator(Reference2FloatLinkedOpenHashMap.this);
    }
    ...
    {
      return Reference2FloatLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2FloatLinkedOpenHashMap.this.size;
      Reference2FloatLinkedOpenHashMap.this.remove(local_k);
    ...
    implements Reference2FloatSortedMap.FastSortedEntrySet<K>
  {
    ...
    {
      return new Reference2FloatLinkedOpenHashMap.EntryIterator(Reference2FloatLinkedOpenHashMap.this);
    }
    ...
    public Reference2FloatMap.Entry<K> first()
    {
      ...
      return new Reference2FloatLinkedOpenHashMap.MapEntry(Reference2FloatLinkedOpenHashMap.this, Reference2FloatLinkedOpenHashMap.this.first);
    }
    ...
    public Reference2FloatMap.Entry<K> last()
    {
      ...
      return new Reference2FloatLinkedOpenHashMap.MapEntry(Reference2FloatLinkedOpenHashMap.this, Reference2FloatLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2FloatLinkedOpenHashMap.this.mask; Reference2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2FloatLinkedOpenHashMap.this.mask) {
        if (Reference2FloatLinkedOpenHashMap.this.key[pos] == local_k) {
          return Reference2FloatLinkedOpenHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2FloatLinkedOpenHashMap.this.mask; Reference2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2FloatLinkedOpenHashMap.this.mask) {
        if (Reference2FloatLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Reference2FloatLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Reference2FloatLinkedOpenHashMap.EntryIterator(Reference2FloatLinkedOpenHashMap.this, from.getKey());
    }
    
    public ObjectBidirectionalIterator<Reference2FloatMap.Entry<K>> fastIterator()
    {
      return new Reference2FloatLinkedOpenHashMap.FastEntryIterator(Reference2FloatLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Reference2FloatMap.Entry<K>> fastIterator(Reference2FloatMap.Entry<K> from)
    {
      return new Reference2FloatLinkedOpenHashMap.FastEntryIterator(Reference2FloatLinkedOpenHashMap.this, from.getKey());
    }
  }
    ...
    implements ObjectListIterator<Reference2FloatMap.Entry<K>>
  {
    ...
    public AbstractReference2FloatMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Reference2FloatLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Reference2FloatLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    public void set(Reference2FloatMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
    
    public void add(Reference2FloatMap.Entry<K> local_ok)
    {
      throw new UnsupportedOperationException();
    }
  }
    ...
    implements ObjectListIterator<Reference2FloatMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Reference2FloatLinkedOpenHashMap.MapEntry(Reference2FloatLinkedOpenHashMap.this, nextEntry());
    }
    
    public Reference2FloatLinkedOpenHashMap<K>.MapEntry previous()
    {
      return this.entry = new Reference2FloatLinkedOpenHashMap.MapEntry(Reference2FloatLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2FloatLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator()
    {
      ...
      {
        for (int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2FloatLinkedOpenHashMap.this.mask; Reference2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2FloatLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Reference2FloatLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Reference2FloatLinkedOpenHashMap.this.first = this.next;
      } else {
        Reference2FloatLinkedOpenHashMap.this.link[this.prev] ^= (Reference2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Reference2FloatLinkedOpenHashMap.this.last = this.prev;
      } else {
        Reference2FloatLinkedOpenHashMap.this.link[this.next] ^= (Reference2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2FloatLinkedOpenHashMap.this.mask; Reference2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2FloatLinkedOpenHashMap.this.mask)
        {
          int slot = (Reference2FloatLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2FloatLinkedOpenHashMap.this.key[pos]))) & Reference2FloatLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Reference2FloatLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Reference2FloatLinkedOpenHashMap.this.key[last] = Reference2FloatLinkedOpenHashMap.this.key[pos];
      ...
      Reference2FloatLinkedOpenHashMap.this.used[last] = false;
      Reference2FloatLinkedOpenHashMap.this.key[last] = null;
      this.curr = -1;
    }
    ...
    implements Reference2FloatMap.Entry<K>, Map.Entry<K, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Reference2FloatLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Float> local_e = (Map.Entry)local_o;
      return (Reference2FloatLinkedOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2FloatLinkedOpenHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
    
    public int hashCode()
    {
      return (Reference2FloatLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2FloatLinkedOpenHashMap.this.key[this.index])) ^ HashCommon.float2int(Reference2FloatLinkedOpenHashMap.this.value[this.index]);
    }
