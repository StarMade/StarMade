...
/*  12:    */
/*  60:    */public abstract class AbstractReference2ShortMap<K>
/*  61:    */  extends AbstractReference2ShortFunction<K>
/*  62:    */  implements Reference2ShortMap<K>, Serializable
/*  63:    */{
...
/*  88: 88 */    if ((m instanceof Reference2ShortMap))
/*  89:    */    {
/*  90: 90 */      while (n-- != 0) {
/*  91: 91 */        Reference2ShortMap.Entry<? extends K> e = (Reference2ShortMap.Entry)i.next();
...
/* 109:    */    implements Reference2ShortMap.Entry<K>
/* 110:    */  {
/* 111:    */    protected K key;
...
/* 162:    */      
/* 163:163 */      return (this.key == e.getKey()) && (this.value == ((Short)e.getValue()).shortValue());
/* 164:    */    }
/* 165:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(Object k) { return AbstractReference2ShortMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractReference2ShortMap.this.size(); }
/* 196:196 */      public void clear() { AbstractReference2ShortMap.this.clear(); }
/* 197:    */      
/* 198:    */      public ObjectIterator<K> iterator() {
/* 199:199 */        new AbstractObjectIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<K, Short>> i = AbstractReference2ShortMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public K next() { return ((Reference2ShortMap.Entry)this.i.next()).getKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(short k) { return AbstractReference2ShortMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractReference2ShortMap.this.size(); }
/* 229:229 */      public void clear() { AbstractReference2ShortMap.this.clear(); }
/* 230:    */      
/* 231:    */      public ShortIterator iterator() {
/* 232:232 */        new AbstractShortIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<K, Short>> i = AbstractReference2ShortMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public short nextShort() { return ((Reference2ShortMap.Entry)this.i.next()).getShortValue(); }
/* 236:    */          
...
/* 245:    */  {
/* 246:246 */    return reference2ShortEntrySet();
/* 247:    */  }
/* 248:    */  
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Reference2ShortMap.Entry<K> e = (Reference2ShortMap.Entry)i.next();
/* 290:    */      
