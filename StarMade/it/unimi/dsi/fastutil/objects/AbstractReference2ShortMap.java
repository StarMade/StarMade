  ...
  implements Reference2ShortMap<K>, Serializable
{
  ...
  public void putAll(Map<? extends K, ? extends Short> local_m)
  {
    ...
    if ((local_m instanceof Reference2ShortMap)) {
      while (local_n-- != 0)
      {
        Reference2ShortMap.Entry<? extends K> local_e = (Reference2ShortMap.Entry)local_i.next();
  ...
  public ReferenceSet<K> keySet()
  {
    new AbstractReferenceSet()
    {
      ...
      {
        return AbstractReference2ShortMap.this.containsKey(local_k);
      }
      ...
      public ObjectIterator<K> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Short>> field_3 = AbstractReference2ShortMap.this.entrySet().iterator();
          
          public K next()
          {
            return ((Reference2ShortMap.Entry)this.field_3.next()).getKey();
          }
  ...
  public ShortCollection values()
  {
    new AbstractShortCollection()
    {
      ...
      {
        return AbstractReference2ShortMap.this.containsValue(local_k);
      }
      ...
      public ShortIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Short>> field_53 = AbstractReference2ShortMap.this.entrySet().iterator();
          
          public short nextShort()
          {
            return ((Reference2ShortMap.Entry)this.field_53.next()).getShortValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Reference2ShortMap.Entry<K> local_e = (Reference2ShortMap.Entry)local_i.next();
    ...
    implements Reference2ShortMap.Entry<K>
  {
    ...
    public boolean equals(Object local_o)
    {
      ...
      return (this.key == local_e.getKey()) && (this.value == ((Short)local_e.getValue()).shortValue());
    }
