  ...
  implements Serializable, Cloneable
{
  ...
  public Object2ShortAVLTreeMap(Comparator<? super K> local_c)
  {
    this();
  ...
  public Object2ShortAVLTreeMap(Map<? extends K, ? extends Short> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2ShortAVLTreeMap(SortedMap<K, Short> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2ShortAVLTreeMap(Object2ShortMap<? extends K> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2ShortAVLTreeMap(Object2ShortSortedMap<K> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2ShortAVLTreeMap(K[] local_k, short[] local_v, Comparator<? super K> local_c)
  {
    this(local_c);
  ...
  public Object2ShortAVLTreeMap(K[] local_k, short[] local_v)
  {
  ...
  public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Object2ShortMap.Entry<K>> comparator = new Comparator()
        {
          public int compare(Object2ShortMap.Entry<K> local_x, Object2ShortMap.Entry<K> local_y)
          {
            return Object2ShortAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Object2ShortAVLTreeMap.EntryIterator(Object2ShortAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> from)
        {
          return new Object2ShortAVLTreeMap.EntryIterator(Object2ShortAVLTreeMap.this, from.getKey());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Object2ShortAVLTreeMap.Entry<K> local_f = Object2ShortAVLTreeMap.this.findKey(local_e.getKey());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Object2ShortAVLTreeMap.Entry<K> local_f = Object2ShortAVLTreeMap.this.findKey(local_e.getKey());
          if (local_f != null) {
            Object2ShortAVLTreeMap.this.removeShort(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> from, Object2ShortMap.Entry<K> local_to)
        {
          return Object2ShortAVLTreeMap.this.subMap(from.getKey(), local_to.getKey()).object2ShortEntrySet();
        }
        
        public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> local_to)
        {
          return Object2ShortAVLTreeMap.this.headMap(local_to.getKey()).object2ShortEntrySet();
        }
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Object2ShortAVLTreeMap.ValueIterator(Object2ShortAVLTreeMap.this, null);
        }
        
        public boolean contains(short local_k)
        {
          return Object2ShortAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Object2ShortAVLTreeMap<K> local_c;
    try
    {
      local_c = (Object2ShortAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Object2ShortAVLTreeMap<K>.EntryIterator local_i = new EntryIterator();
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry<K> top = new Entry(local_s.readObject(), local_s.readShort());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry<K> top = new Entry(local_s.readObject(), local_s.readShort());
      top.right(new Entry(local_s.readObject(), local_s.readShort()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Object2ShortAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Object2ShortAVLTreeMap<K>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Object2ShortAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Object2ShortAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Object2ShortMap.Entry<K>> object2ShortEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator()
          {
            return new Object2ShortAVLTreeMap.Submap.SubmapEntryIterator(Object2ShortAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Object2ShortMap.Entry<K>> iterator(Object2ShortMap.Entry<K> from)
          {
            return new Object2ShortAVLTreeMap.Submap.SubmapEntryIterator(Object2ShortAVLTreeMap.Submap.this, from.getKey());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<K, Short> local_e = (Map.Entry)local_o;
            Object2ShortAVLTreeMap.Entry<K> local_f = Object2ShortAVLTreeMap.this.findKey(local_e.getKey());
            return (local_f != null) && (Object2ShortAVLTreeMap.Submap.this.in5(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<K, Short> local_e = (Map.Entry)local_o;
            Object2ShortAVLTreeMap.Entry<K> local_f = Object2ShortAVLTreeMap.this.findKey(local_e.getKey());
            if ((local_f != null) && (Object2ShortAVLTreeMap.Submap.this.in5(local_f.key))) {
              Object2ShortAVLTreeMap.Submap.this.removeShort(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Object2ShortAVLTreeMap.Submap.SubmapIterator(Object2ShortAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Object2ShortAVLTreeMap.Submap.this.clear();
          }
          
          public Object2ShortMap.Entry<K> first()
          {
            return Object2ShortAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Object2ShortMap.Entry<K> last()
          {
            return Object2ShortAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Object2ShortMap.Entry<K>> subSet(Object2ShortMap.Entry<K> from, Object2ShortMap.Entry<K> local_to)
          {
            return Object2ShortAVLTreeMap.Submap.this.subMap(from.getKey(), local_to.getKey()).object2ShortEntrySet();
          }
          
          public ObjectSortedSet<Object2ShortMap.Entry<K>> headSet(Object2ShortMap.Entry<K> local_to)
          {
            return Object2ShortAVLTreeMap.Submap.this.headMap(local_to.getKey()).object2ShortEntrySet();
          }
          
          public ObjectSortedSet<Object2ShortMap.Entry<K>> tailSet(Object2ShortMap.Entry<K> from)
          {
            return Object2ShortAVLTreeMap.Submap.this.tailMap(from.getKey()).object2ShortEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ShortCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractShortCollection()
        {
          public ShortIterator iterator()
          {
            return new Object2ShortAVLTreeMap.Submap.SubmapValueIterator(Object2ShortAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(short local_k)
          {
            return Object2ShortAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Object2ShortAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(Object local_k)
    {
      return (in5(local_k)) && (Object2ShortAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      K local_kk = local_k;
      Object2ShortAVLTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2ShortAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public Short get(Object local_ok)
    {
      K local_kk = local_ok;
      Object2ShortAVLTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2ShortAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.getValue() : null;
    }
    ...
    public short put(K local_k, short local_v)
    {
      ...
      short oldValue = Object2ShortAVLTreeMap.this.put(local_k, local_v);
    ...
    public short removeShort(Object local_k)
    {
      ...
      short oldValue = Object2ShortAVLTreeMap.this.removeShort(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Object2ShortAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Object2ShortAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Object2ShortAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Object2ShortSortedMap<K> tailMap(K from)
    {
      if (this.bottom) {
        return new Submap(Object2ShortAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Object2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2ShortAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Object2ShortSortedMap<K> subMap(K from, K local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Object2ShortAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Object2ShortAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Object2ShortAVLTreeMap.Entry<K> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Object2ShortAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Object2ShortAVLTreeMap.this.locateKey(this.from);
        if (Object2ShortAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Object2ShortAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Object2ShortAVLTreeMap.Entry<K> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Object2ShortAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Object2ShortAVLTreeMap.this.locateKey(this.field_47);
        if (Object2ShortAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Object2ShortAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public K firstKey()
    {
      Object2ShortAVLTreeMap.Entry<K> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public K lastKey()
    {
      Object2ShortAVLTreeMap.Entry<K> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Object2ShortAVLTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Object2ShortAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Object2ShortAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator()
      {
        this();
        if (this.next != null) {
          if ((!Object2ShortAVLTreeMap.Submap.this.bottom) && (Object2ShortAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Object2ShortAVLTreeMap.Submap.this.top) && (Object2ShortAVLTreeMap.this.compare(local_k, (this.prev = Object2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Object2ShortAVLTreeMap.this.locateKey(local_k);
            if (Object2ShortAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Object2ShortAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2ShortAVLTreeMap.this.compare(this.prev.key, Object2ShortAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Object2ShortAVLTreeMap.Submap.this.top) && (this.next != null) && (Object2ShortAVLTreeMap.this.compare(this.next.key, Object2ShortAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractObject2ShortSortedMap.KeySet
    {
      ...
      {
        return new Object2ShortAVLTreeMap.Submap.SubmapKeyIterator(Object2ShortAVLTreeMap.Submap.this);
      }
      
      public ObjectBidirectionalIterator<K> iterator(K from)
      {
        return new Object2ShortAVLTreeMap.Submap.SubmapKeyIterator(Object2ShortAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractObject2ShortSortedMap.KeySet
  {
    ...
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new Object2ShortAVLTreeMap.KeyIterator(Object2ShortAVLTreeMap.this);
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new Object2ShortAVLTreeMap.KeyIterator(Object2ShortAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    TreeIterator()
    {
      if ((this.next = Object2ShortAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Object2ShortAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
