  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2CharOpenCustomHashMap(int expected, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2CharOpenCustomHashMap(Map<? extends K, ? extends Character> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2CharOpenCustomHashMap(Map<? extends K, ? extends Character> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2CharOpenCustomHashMap(Object2CharMap<K> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2CharOpenCustomHashMap(Object2CharMap<K> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2CharOpenCustomHashMap(K[] local_k, char[] local_v, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2CharOpenCustomHashMap(K[] local_k, char[] local_v, Hash.Strategy<K> strategy)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Object2CharOpenCustomHashMap.ValueIterator(Object2CharOpenCustomHashMap.this);
        }
        ...
        {
          return Object2CharOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2CharOpenCustomHashMap<K> local_c;
    try
    {
      local_c = (Object2CharOpenCustomHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    char[] value = this.value;
    Object2CharOpenCustomHashMap<K>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Object2CharOpenCustomHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Object2CharOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractObjectSet<K>
  {
    ...
    {
      return new Object2CharOpenCustomHashMap.KeyIterator(Object2CharOpenCustomHashMap.this);
    }
    ...
    {
      return Object2CharOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2CharOpenCustomHashMap.this.size;
      Object2CharOpenCustomHashMap.this.remove(local_k);
    ...
    implements Object2CharMap.FastEntrySet<K>
  {
    ...
    {
      return new Object2CharOpenCustomHashMap.EntryIterator(Object2CharOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Object2CharMap.Entry<K>> fastIterator()
    {
      return new Object2CharOpenCustomHashMap.FastEntryIterator(Object2CharOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2CharOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2CharOpenCustomHashMap.this.mask; Object2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask) {
        if (Object2CharOpenCustomHashMap.this.strategy.equals(Object2CharOpenCustomHashMap.this.key[pos], local_k)) {
          return Object2CharOpenCustomHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2CharOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2CharOpenCustomHashMap.this.mask; Object2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask) {
        if (Object2CharOpenCustomHashMap.this.strategy.equals(Object2CharOpenCustomHashMap.this.key[pos], local_k))
        {
          Object2CharOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Object2CharMap.Entry<K>>
  {
    ...
    public AbstractObject2CharMap.BasicEntry<K> next()
    {
      ...
      this.entry.key = Object2CharOpenCustomHashMap.this.key[local_e];
      this.entry.value = Object2CharOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Object2CharMap.Entry<K>>
  {
    ...
    {
      return this.entry = new Object2CharOpenCustomHashMap.MapEntry(Object2CharOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Object2CharOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2147 = Object2CharOpenCustomHashMap.this.size;
    ObjectArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Object2CharOpenCustomHashMap.this.used;
      while ((this.field_2147 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2147 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2147 != 0)
      {
        boolean[] local_k = Object2CharOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2CharOpenCustomHashMap.this.mask; Object2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Object2CharOpenCustomHashMap.this.strategy.hashCode(Object2CharOpenCustomHashMap.this.key[pos])) & Object2CharOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2CharOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Object2CharOpenCustomHashMap.this.key[pos]);
        }
        Object2CharOpenCustomHashMap.this.key[last] = Object2CharOpenCustomHashMap.this.key[pos];
        Object2CharOpenCustomHashMap.this.value[last] = Object2CharOpenCustomHashMap.this.value[pos];
      }
      Object2CharOpenCustomHashMap.this.used[last] = false;
      Object2CharOpenCustomHashMap.this.key[last] = null;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Object2CharOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
        this.last = -1;
        return;
      }
      Object2CharOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2147 > 0))
      {
        this.field_2147 += 1;
        nextEntry();
      }
    ...
    implements Object2CharMap.Entry<K>, Map.Entry<K, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Object2CharOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, Character> local_e = (Map.Entry)local_o;
      return (Object2CharOpenCustomHashMap.this.strategy.equals(Object2CharOpenCustomHashMap.this.key[this.index], local_e.getKey())) && (Object2CharOpenCustomHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
