...
/*  17:    */
/*  89:    */public class Object2CharOpenCustomHashMap<K>
/*  90:    */  extends AbstractObject2CharMap<K>
...
/* 103:    */  protected volatile transient Object2CharMap.FastEntrySet<K> entries;
...
/* 107:    */  
/* 108:    */  public Object2CharOpenCustomHashMap(int expected, float f, Hash.Strategy<K> strategy)
/* 109:    */  {
...
/* 120:    */  }
/* 121:    */  
/* 125:    */  public Object2CharOpenCustomHashMap(int expected, Hash.Strategy<K> strategy)
/* 126:    */  {
/* 127:127 */    this(expected, 0.75F, strategy);
/* 128:    */  }
/* 129:    */  
/* 132:    */  public Object2CharOpenCustomHashMap(Hash.Strategy<K> strategy)
/* 133:    */  {
/* 134:134 */    this(16, 0.75F, strategy);
/* 135:    */  }
/* 136:    */  
/* 141:    */  public Object2CharOpenCustomHashMap(Map<? extends K, ? extends Character> m, float f, Hash.Strategy<K> strategy)
/* 142:    */  {
/* 143:143 */    this(m.size(), f, strategy);
/* 144:144 */    putAll(m);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Object2CharOpenCustomHashMap(Map<? extends K, ? extends Character> m, Hash.Strategy<K> strategy)
/* 151:    */  {
/* 152:152 */    this(m, 0.75F, strategy);
/* 153:    */  }
/* 154:    */  
/* 159:    */  public Object2CharOpenCustomHashMap(Object2CharMap<K> m, float f, Hash.Strategy<K> strategy)
/* 160:    */  {
/* 161:161 */    this(m.size(), f, strategy);
/* 162:162 */    putAll(m);
/* 163:    */  }
/* 164:    */  
/* 168:    */  public Object2CharOpenCustomHashMap(Object2CharMap<K> m, Hash.Strategy<K> strategy)
/* 169:    */  {
/* 170:170 */    this(m, 0.75F, strategy);
/* 171:    */  }
/* 172:    */  
/* 179:    */  public Object2CharOpenCustomHashMap(K[] k, char[] v, float f, Hash.Strategy<K> strategy)
/* 180:    */  {
...
/* 185:    */  }
/* 186:    */  
/* 191:    */  public Object2CharOpenCustomHashMap(K[] k, char[] v, Hash.Strategy<K> strategy)
/* 192:    */  {
...
/* 369:    */    implements Object2CharMap.Entry<K>, Map.Entry<K, Character>
/* 370:    */  {
...
/* 376:    */    }
/* 377:    */    
/* 378:378 */    public K getKey() { return Object2CharOpenCustomHashMap.this.key[this.index]; }
/* 379:    */    
/* 380:    */    public Character getValue() {
/* 381:381 */      return Character.valueOf(Object2CharOpenCustomHashMap.this.value[this.index]);
/* 382:    */    }
/* 383:    */    
/* 384:384 */    public char getCharValue() { return Object2CharOpenCustomHashMap.this.value[this.index]; }
/* 385:    */    
/* 386:    */    public char setValue(char v) {
/* 387:387 */      char oldValue = Object2CharOpenCustomHashMap.this.value[this.index];
/* 388:388 */      Object2CharOpenCustomHashMap.this.value[this.index] = v;
...
/* 398:398 */      return (Object2CharOpenCustomHashMap.this.strategy.equals(Object2CharOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 399:    */    }
/* 400:    */    
/* 401:401 */    public int hashCode() { return Object2CharOpenCustomHashMap.this.strategy.hashCode(Object2CharOpenCustomHashMap.this.key[this.index]) ^ Object2CharOpenCustomHashMap.this.value[this.index]; }
/* 402:    */    
/* 404:404 */    public String toString() { return Object2CharOpenCustomHashMap.this.key[this.index] + "=>" + Object2CharOpenCustomHashMap.this.value[this.index]; } }
/* 405:    */  
...
/* 410:    */    
/* 411:411 */    private MapIterator() { this.pos = Object2CharOpenCustomHashMap.this.n;
/* 412:    */      
/* 414:414 */      this.last = -1;
/* 415:    */      
/* 416:416 */      this.c = Object2CharOpenCustomHashMap.this.size;
/* 417:    */      
/* 421:421 */      boolean[] used = Object2CharOpenCustomHashMap.this.used;
...
/* 433:    */        
/* 434:434 */        int pos = HashCommon.murmurHash3(Object2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharOpenCustomHashMap.this.mask;
/* 435:    */        
/* 436:436 */        while (Object2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 437:437 */          if (Object2CharOpenCustomHashMap.this.strategy.equals(Object2CharOpenCustomHashMap.this.key[pos], k)) return pos;
/* 438:438 */          pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask;
/* 439:    */        }
/* 440:    */      }
/* 441:441 */      this.last = this.pos;
/* 442:    */      
/* 443:443 */      if (this.c != 0) {
/* 444:444 */        boolean[] used = Object2CharOpenCustomHashMap.this.used;
...
/* 459:    */      for (;;)
/* 460:    */      {
/* 461:461 */        pos = (last = pos) + 1 & Object2CharOpenCustomHashMap.this.mask;
/* 462:462 */        while (Object2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 463:463 */          int slot = HashCommon.murmurHash3(Object2CharOpenCustomHashMap.this.strategy.hashCode(Object2CharOpenCustomHashMap.this.key[pos])) & Object2CharOpenCustomHashMap.this.mask;
/* 464:464 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 465:465 */          pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask;
/* 466:    */        }
/* 467:467 */        if (Object2CharOpenCustomHashMap.this.used[pos] == 0) break;
/* 468:468 */        if (pos < last)
/* 469:    */        {
/* 470:470 */          if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 471:471 */          this.wrapped.add(Object2CharOpenCustomHashMap.this.key[pos]);
/* 472:    */        }
/* 473:473 */        Object2CharOpenCustomHashMap.this.key[last] = Object2CharOpenCustomHashMap.this.key[pos];
/* 474:474 */        Object2CharOpenCustomHashMap.this.value[last] = Object2CharOpenCustomHashMap.this.value[pos];
/* 475:    */      }
/* 476:476 */      Object2CharOpenCustomHashMap.this.used[last] = false;
/* 477:477 */      Object2CharOpenCustomHashMap.this.key[last] = null;
/* 478:478 */      return last;
/* 479:    */    }
/* 480:    */    
...
/* 484:    */      {
/* 485:485 */        Object2CharOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 486:486 */        this.last = -1;
/* 487:487 */        return;
/* 488:    */      }
/* 489:489 */      Object2CharOpenCustomHashMap.this.size -= 1;
...
/* 501:    */    } }
/* 502:    */  
/* 503:503 */  private class EntryIterator extends Object2CharOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2CharMap.Entry<K>> { private EntryIterator() { super(null); }
/* 504:    */    
/* 505:    */    private Object2CharOpenCustomHashMap<K>.MapEntry entry;
/* 506:506 */    public Object2CharMap.Entry<K> next() { return this.entry = new Object2CharOpenCustomHashMap.MapEntry(Object2CharOpenCustomHashMap.this, nextEntry()); }
/* 507:    */    
/* 508:    */    public void remove()
/* 509:    */    {
/* 510:510 */      super.remove();
/* 511:511 */      Object2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 512:    */    } }
/* 513:    */  
/* 514:514 */  private class FastEntryIterator extends Object2CharOpenCustomHashMap<K>.MapIterator implements ObjectIterator<Object2CharMap.Entry<K>> { private FastEntryIterator() { super(null); }
/* 515:515 */    final AbstractObject2CharMap.BasicEntry<K> entry = new AbstractObject2CharMap.BasicEntry(null, '\000');
/* 516:    */    
/* 517:517 */    public AbstractObject2CharMap.BasicEntry<K> next() { int e = nextEntry();
/* 518:518 */      this.entry.key = Object2CharOpenCustomHashMap.this.key[e];
/* 519:519 */      this.entry.value = Object2CharOpenCustomHashMap.this.value[e];
/* 520:520 */      return this.entry;
/* 521:    */    } }
/* 522:    */  
/* 523:    */  private final class MapEntrySet extends AbstractObjectSet<Object2CharMap.Entry<K>> implements Object2CharMap.FastEntrySet<K> { private MapEntrySet() {}
/* 524:    */    
/* 525:525 */    public ObjectIterator<Object2CharMap.Entry<K>> iterator() { return new Object2CharOpenCustomHashMap.EntryIterator(Object2CharOpenCustomHashMap.this, null); }
/* 526:    */    
/* 527:    */    public ObjectIterator<Object2CharMap.Entry<K>> fastIterator() {
/* 528:528 */      return new Object2CharOpenCustomHashMap.FastEntryIterator(Object2CharOpenCustomHashMap.this, null);
/* 529:    */    }
/* 530:    */    
...
/* 535:    */      
/* 536:536 */      int pos = HashCommon.murmurHash3(Object2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharOpenCustomHashMap.this.mask;
/* 537:    */      
/* 538:538 */      while (Object2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 539:539 */        if (Object2CharOpenCustomHashMap.this.strategy.equals(Object2CharOpenCustomHashMap.this.key[pos], k)) return Object2CharOpenCustomHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 540:540 */        pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask;
/* 541:    */      }
...
/* 549:    */      
/* 550:550 */      int pos = HashCommon.murmurHash3(Object2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Object2CharOpenCustomHashMap.this.mask;
/* 551:    */      
/* 552:552 */      while (Object2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 553:553 */        if (Object2CharOpenCustomHashMap.this.strategy.equals(Object2CharOpenCustomHashMap.this.key[pos], k)) {
/* 554:554 */          Object2CharOpenCustomHashMap.this.remove(e.getKey());
/* 555:555 */          return true;
/* 556:    */        }
/* 557:557 */        pos = pos + 1 & Object2CharOpenCustomHashMap.this.mask;
/* 558:    */      }
/* 559:559 */      return false;
/* 560:    */    }
/* 561:    */    
/* 562:562 */    public int size() { return Object2CharOpenCustomHashMap.this.size; }
/* 563:    */    
/* 565:565 */    public void clear() { Object2CharOpenCustomHashMap.this.clear(); }
/* 566:    */  }
/* 567:    */  
/* 568:    */  public Object2CharMap.FastEntrySet<K> object2CharEntrySet() {
...
/* 576:    */    extends Object2CharOpenCustomHashMap<K>.MapIterator
/* 577:    */    implements ObjectIterator<K>
/* 578:    */  {
/* 579:579 */    public KeyIterator() { super(null); }
/* 580:580 */    public K next() { return Object2CharOpenCustomHashMap.this.key[nextEntry()]; } }
/* 581:    */  
/* 582:    */  private final class KeySet extends AbstractObjectSet<K> { private KeySet() {}
/* 583:    */    
/* 584:584 */    public ObjectIterator<K> iterator() { return new Object2CharOpenCustomHashMap.KeyIterator(Object2CharOpenCustomHashMap.this); }
/* 585:    */    
/* 586:    */    public int size() {
/* 587:587 */      return Object2CharOpenCustomHashMap.this.size;
/* 588:    */    }
/* 589:    */    
/* 590:590 */    public boolean contains(Object k) { return Object2CharOpenCustomHashMap.this.containsKey(k); }
/* 591:    */    
/* 592:    */    public boolean remove(Object k) {
/* 593:593 */      int oldSize = Object2CharOpenCustomHashMap.this.size;
/* 594:594 */      Object2CharOpenCustomHashMap.this.remove(k);
/* 595:595 */      return Object2CharOpenCustomHashMap.this.size != oldSize;
/* 596:    */    }
/* 597:    */    
/* 598:598 */    public void clear() { Object2CharOpenCustomHashMap.this.clear(); }
/* 599:    */  }
/* 600:    */  
...
/* 609:    */    extends Object2CharOpenCustomHashMap.MapIterator
/* 610:    */    implements CharIterator
/* 611:    */  {
/* 612:612 */    public ValueIterator() { super(null); }
/* 613:613 */    public char nextChar() { return Object2CharOpenCustomHashMap.this.value[nextEntry()]; }
/* 614:614 */    public Character next() { return Character.valueOf(Object2CharOpenCustomHashMap.this.value[nextEntry()]); }
/* 615:    */  }
/* 616:    */  
...
/* 619:619 */          return new Object2CharOpenCustomHashMap.ValueIterator(Object2CharOpenCustomHashMap.this);
/* 620:    */        }
/* 621:    */        
/* 622:622 */        public int size() { return Object2CharOpenCustomHashMap.this.size; }
/* 623:    */        
/* 624:    */        public boolean contains(char v) {
/* 625:625 */          return Object2CharOpenCustomHashMap.this.containsValue(v);
/* 626:    */        }
/* 627:    */        
/* 628:628 */        public void clear() { Object2CharOpenCustomHashMap.this.clear(); }
/* 629:    */      };
/* 630:    */    }
...
/* 731:    */  }
/* 732:    */  
/* 736:    */  public Object2CharOpenCustomHashMap<K> clone()
/* 737:    */  {
/* 738:    */    Object2CharOpenCustomHashMap<K> c;
/* 739:    */    
/* 741:    */    try
/* 742:    */    {
/* 743:743 */      c = (Object2CharOpenCustomHashMap)super.clone();
/* 744:    */    }
...
/* 781:781 */    Object2CharOpenCustomHashMap<K>.MapIterator i = new MapIterator(null);
