  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Object2ObjectOpenCustomHashMap(int expected, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2ObjectOpenCustomHashMap(Map<? extends K, ? extends V> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2ObjectOpenCustomHashMap(Map<? extends K, ? extends V> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2ObjectOpenCustomHashMap(Object2ObjectMap<K, V> local_m, float local_f, Hash.Strategy<K> strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Object2ObjectOpenCustomHashMap(Object2ObjectMap<K, V> local_m, Hash.Strategy<K> strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Object2ObjectOpenCustomHashMap(K[] local_k, V[] local_v, float local_f, Hash.Strategy<K> strategy)
  {
  ...
  public Object2ObjectOpenCustomHashMap(K[] local_k, V[] local_v, Hash.Strategy<K> strategy)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Object2ObjectOpenCustomHashMap.ValueIterator(Object2ObjectOpenCustomHashMap.this);
        }
        ...
        {
          return Object2ObjectOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Object2ObjectOpenCustomHashMap<K, V> local_c;
    try
    {
      local_c = (Object2ObjectOpenCustomHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    V[] value = this.value;
    Object2ObjectOpenCustomHashMap<K, V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractObjectSet<K>
  {
    ...
    {
      return new Object2ObjectOpenCustomHashMap.KeyIterator(Object2ObjectOpenCustomHashMap.this);
    }
    ...
    {
      return Object2ObjectOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Object2ObjectOpenCustomHashMap.this.size;
      Object2ObjectOpenCustomHashMap.this.remove(local_k);
    ...
    implements Object2ObjectMap.FastEntrySet<K, V>
  {
    ...
    {
      return new Object2ObjectOpenCustomHashMap.EntryIterator(Object2ObjectOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Object2ObjectMap.Entry<K, V>> fastIterator()
    {
      return new Object2ObjectOpenCustomHashMap.FastEntryIterator(Object2ObjectOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2ObjectOpenCustomHashMap.this.mask; Object2ObjectOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask) {
        if (Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[pos], local_k)) {
          return Object2ObjectOpenCustomHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Object2ObjectOpenCustomHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(local_k)) & Object2ObjectOpenCustomHashMap.this.mask; Object2ObjectOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask) {
        if (Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[pos], local_k))
        {
          Object2ObjectOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Object2ObjectMap.Entry<K, V>>
  {
    ...
    public AbstractObject2ObjectMap.BasicEntry<K, V> next()
    {
      ...
      this.entry.key = Object2ObjectOpenCustomHashMap.this.key[local_e];
      this.entry.value = Object2ObjectOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Object2ObjectMap.Entry<K, V>>
  {
    ...
    {
      return this.entry = new Object2ObjectOpenCustomHashMap.MapEntry(Object2ObjectOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Object2ObjectOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Object2ObjectOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1875 = Object2ObjectOpenCustomHashMap.this.size;
    ObjectArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Object2ObjectOpenCustomHashMap.this.used;
      while ((this.field_1875 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1875 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1875 != 0)
      {
        boolean[] local_k = Object2ObjectOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Object2ObjectOpenCustomHashMap.this.mask; Object2ObjectOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(Object2ObjectOpenCustomHashMap.this.key[pos])) & Object2ObjectOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Object2ObjectOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Object2ObjectOpenCustomHashMap.this.key[pos]);
        }
        Object2ObjectOpenCustomHashMap.this.key[last] = Object2ObjectOpenCustomHashMap.this.key[pos];
        Object2ObjectOpenCustomHashMap.this.value[last] = Object2ObjectOpenCustomHashMap.this.value[pos];
      }
      Object2ObjectOpenCustomHashMap.this.used[last] = false;
      Object2ObjectOpenCustomHashMap.this.key[last] = null;
    ...
    public void remove()
    {
      ...
      Object2ObjectOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1875 > 0))
      {
        this.field_1875 += 1;
        nextEntry();
      }
    ...
    implements Object2ObjectMap.Entry<K, V>, Map.Entry<K, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Object2ObjectOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, V> local_e = (Map.Entry)local_o;
      return (Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[this.index], local_e.getKey())) && (Object2ObjectOpenCustomHashMap.this.value[this.index] == null ? local_e.getValue() == null : Object2ObjectOpenCustomHashMap.this.value[this.index].equals(local_e.getValue()));
    }
