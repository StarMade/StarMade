...
/* 575 */           return new Object2ObjectOpenCustomHashMap.ValueIterator(Object2ObjectOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 578 */           return Object2ObjectOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 581 */           return Object2ObjectOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 584 */           Object2ObjectOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 699 */       c = (Object2ObjectOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Object2ObjectOpenCustomHashMap<K, V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 569 */       super(null); } 
/* 570 */     public V next() { return Object2ObjectOpenCustomHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 541 */       return new Object2ObjectOpenCustomHashMap.KeyIterator(Object2ObjectOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 544 */       return Object2ObjectOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 547 */       return Object2ObjectOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 550 */       int oldSize = Object2ObjectOpenCustomHashMap.this.size;
/* 551 */       Object2ObjectOpenCustomHashMap.this.remove(k);
/* 552 */       return Object2ObjectOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 555 */       Object2ObjectOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Object2ObjectOpenCustomHashMap<K, V>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 536 */       super(null); } 
/* 537 */     public K next() { return Object2ObjectOpenCustomHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 482 */       return new Object2ObjectOpenCustomHashMap.EntryIterator(Object2ObjectOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Object2ObjectMap.Entry<K, V>> fastIterator() {
/* 485 */       return new Object2ObjectOpenCustomHashMap.FastEntryIterator(Object2ObjectOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 493 */       int pos = HashCommon.murmurHash3(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectOpenCustomHashMap.this.mask;
/*     */ 
/* 495 */       while (Object2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 496 */         if (Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[pos], k)) return Object2ObjectOpenCustomHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Object2ObjectOpenCustomHashMap.this.value[pos].equals(e.getValue());
/* 497 */         pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask;
/*     */       }
/* 499 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 507 */       int pos = HashCommon.murmurHash3(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectOpenCustomHashMap.this.mask;
/*     */ 
/* 509 */       while (Object2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 510 */         if (Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[pos], k)) {
/* 511 */           Object2ObjectOpenCustomHashMap.this.remove(e.getKey());
/* 512 */           return true;
/*     */         }
/* 514 */         pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask;
/*     */       }
/* 516 */       return false;
/*     */     }
/*     */     public int size() {
/* 519 */       return Object2ObjectOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 522 */       Object2ObjectOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Object2ObjectOpenCustomHashMap<K, V>.MapIterator
/*     */     implements ObjectIterator<Object2ObjectMap.Entry<K, V>>
/*     */   {
/* 472 */     final AbstractObject2ObjectMap.BasicEntry<K, V> entry = new AbstractObject2ObjectMap.BasicEntry(null, null);
/*     */ 
...
/* 474 */       int e = nextEntry();
/* 475 */       this.entry.key = Object2ObjectOpenCustomHashMap.this.key[e];
/* 476 */       this.entry.value = Object2ObjectOpenCustomHashMap.this.value[e];
/* 477 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Object2ObjectOpenCustomHashMap<K, V>.MapIterator
/*     */     implements ObjectIterator<Object2ObjectMap.Entry<K, V>>
/*     */   {
...
/* 463 */       return this.entry = new Object2ObjectOpenCustomHashMap.MapEntry(Object2ObjectOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 467 */       super.remove();
/* 468 */       Object2ObjectOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 367 */       this.pos = Object2ObjectOpenCustomHashMap.this.n;
/*     */ 
/* 370 */       this.last = -1;
/*     */ 
/* 372 */       this.c = Object2ObjectOpenCustomHashMap.this.size;
/*     */ 
/* 377 */       boolean[] used = Object2ObjectOpenCustomHashMap.this.used;
...
/*     */ 
/* 390 */         int pos = HashCommon.murmurHash3(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Object2ObjectOpenCustomHashMap.this.mask;
/*     */ 
/* 392 */         while (Object2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 393 */           if (Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[pos], k)) return pos;
/* 394 */           pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 397 */       this.last = this.pos;
/*     */ 
/* 399 */       if (this.c != 0) {
/* 400 */         boolean[] used = Object2ObjectOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 417 */         pos = (last = pos) + 1 & Object2ObjectOpenCustomHashMap.this.mask;
/* 418 */         while (Object2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 419 */           int slot = HashCommon.murmurHash3(Object2ObjectOpenCustomHashMap.this.strategy.hashCode(Object2ObjectOpenCustomHashMap.this.key[pos])) & Object2ObjectOpenCustomHashMap.this.mask;
/* 420 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 421 */           pos = pos + 1 & Object2ObjectOpenCustomHashMap.this.mask;
/*     */         }
/* 423 */         if (Object2ObjectOpenCustomHashMap.this.used[pos] == 0) break;
/* 424 */         if (pos < last)
/*     */         {
/* 426 */           if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 427 */           this.wrapped.add(Object2ObjectOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 429 */         Object2ObjectOpenCustomHashMap.this.key[last] = Object2ObjectOpenCustomHashMap.this.key[pos];
/* 430 */         Object2ObjectOpenCustomHashMap.this.value[last] = Object2ObjectOpenCustomHashMap.this.value[pos];
/*     */       }
/* 432 */       Object2ObjectOpenCustomHashMap.this.used[last] = false;
/* 433 */       Object2ObjectOpenCustomHashMap.this.key[last] = null;
/* 434 */       Object2ObjectOpenCustomHashMap.this.value[last] = null;
/* 435 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 440 */       if (this.pos < -1)
/*     */       {
/* 442 */         Object2ObjectOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 443 */         this.last = -1;
/* 444 */         return;
/*     */       }
/* 446 */       Object2ObjectOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 340 */       return Object2ObjectOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 343 */       return Object2ObjectOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 346 */       Object oldValue = Object2ObjectOpenCustomHashMap.this.value[this.index];
/* 347 */       Object2ObjectOpenCustomHashMap.this.value[this.index] = v;
/* 348 */       return oldValue;
/*     */     }
/*     */ 
...
/* 354 */       return (Object2ObjectOpenCustomHashMap.this.strategy.equals(Object2ObjectOpenCustomHashMap.this.key[this.index], e.getKey())) && (Object2ObjectOpenCustomHashMap.this.value[this.index] == null ? e.getValue() == null : Object2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
/* 357 */       return Object2ObjectOpenCustomHashMap.this.strategy.hashCode(Object2ObjectOpenCustomHashMap.this.key[this.index]) ^ (Object2ObjectOpenCustomHashMap.this.value[this.index] == null ? 0 : Object2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
/*     */     }
/*     */     public String toString() {
/* 360 */       return Object2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Object2ObjectOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
