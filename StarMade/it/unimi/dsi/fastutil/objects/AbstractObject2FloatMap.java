  ...
  implements Object2FloatMap<K>, Serializable
{
  ...
  public void putAll(Map<? extends K, ? extends Float> local_m)
  {
    ...
    if ((local_m instanceof Object2FloatMap)) {
      while (local_n-- != 0)
      {
        Object2FloatMap.Entry<? extends K> local_e = (Object2FloatMap.Entry)local_i.next();
  ...
  public ObjectSet<K> keySet()
  {
    new AbstractObjectSet()
    {
      ...
      {
        return AbstractObject2FloatMap.this.containsKey(local_k);
      }
      ...
      public ObjectIterator<K> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Float>> field_3 = AbstractObject2FloatMap.this.entrySet().iterator();
          
          public K next()
          {
            return ((Object2FloatMap.Entry)this.field_3.next()).getKey();
          }
  ...
  public FloatCollection values()
  {
    new AbstractFloatCollection()
    {
      ...
      {
        return AbstractObject2FloatMap.this.containsValue(local_k);
      }
      ...
      public FloatIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Float>> field_52 = AbstractObject2FloatMap.this.entrySet().iterator();
          
          public float nextFloat()
          {
            return ((Object2FloatMap.Entry)this.field_52.next()).getFloatValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Object2FloatMap.Entry<K> local_e = (Object2FloatMap.Entry)local_i.next();
