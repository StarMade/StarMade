...
/*  88 */     if ((m instanceof Object2FloatMap))
/*     */     {
/*  90 */       while (n-- != 0) {
/*  91 */         Object2FloatMap.Entry e = (Object2FloatMap.Entry)i.next();
...
/* 193 */         return AbstractObject2FloatMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractObject2FloatMap.this.size(); } 
/* 196 */       public void clear() { AbstractObject2FloatMap.this.clear(); }
/*     */ 
/*     */       public ObjectIterator<K> iterator() {
/* 199 */         return new AbstractObjectIterator() {
/* 200 */           final ObjectIterator<Map.Entry<K, Float>> i = AbstractObject2FloatMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public K next() { return ((Object2FloatMap.Entry)this.i.next()).getKey(); } 
...
/* 226 */         return AbstractObject2FloatMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractObject2FloatMap.this.size(); } 
/* 229 */       public void clear() { AbstractObject2FloatMap.this.clear(); }
/*     */ 
/*     */       public FloatIterator iterator() {
/* 232 */         return new AbstractFloatIterator() {
/* 233 */           final ObjectIterator<Map.Entry<K, Float>> i = AbstractObject2FloatMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public float nextFloat() { return ((Object2FloatMap.Entry)this.i.next()).getFloatValue(); } 
/*     */           public boolean hasNext() {
...
/*     */   {
/* 246 */     return object2FloatEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Object2FloatMap.Entry e = (Object2FloatMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
/* 167 */       return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.float2int(this.value);
/*     */     }
/*     */ 
/*     */     public String toString()
/*     */     {
