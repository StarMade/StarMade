...
/*  13:    */
/*  60:    */public abstract class AbstractObject2FloatMap<K>
/*  61:    */  extends AbstractObject2FloatFunction<K>
/*  62:    */  implements Object2FloatMap<K>, Serializable
/*  63:    */{
...
/*  88: 88 */    if ((m instanceof Object2FloatMap))
/*  89:    */    {
/*  90: 90 */      while (n-- != 0) {
/*  91: 91 */        Object2FloatMap.Entry<? extends K> e = (Object2FloatMap.Entry)i.next();
...
/* 109:    */    implements Object2FloatMap.Entry<K>
/* 110:    */  {
/* 111:    */    protected K key;
...
/* 162:    */      
/* 163:163 */      return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Float)e.getValue()).floatValue());
/* 164:    */    }
/* 165:    */    
/* 166:    */    public int hashCode() {
/* 167:167 */      return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.float2int(this.value);
/* 168:    */    }
/* 169:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(Object k) { return AbstractObject2FloatMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractObject2FloatMap.this.size(); }
/* 196:196 */      public void clear() { AbstractObject2FloatMap.this.clear(); }
/* 197:    */      
/* 198:    */      public ObjectIterator<K> iterator() {
/* 199:199 */        new AbstractObjectIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<K, Float>> i = AbstractObject2FloatMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public K next() { return ((Object2FloatMap.Entry)this.i.next()).getKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(float k) { return AbstractObject2FloatMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractObject2FloatMap.this.size(); }
/* 229:229 */      public void clear() { AbstractObject2FloatMap.this.clear(); }
/* 230:    */      
/* 231:    */      public FloatIterator iterator() {
/* 232:232 */        new AbstractFloatIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<K, Float>> i = AbstractObject2FloatMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public float nextFloat() { return ((Object2FloatMap.Entry)this.i.next()).getFloatValue(); }
/* 236:    */          
...
/* 245:    */  {
/* 246:246 */    return object2FloatEntrySet();
/* 247:    */  }
/* 248:    */  
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Object2FloatMap.Entry<K> e = (Object2FloatMap.Entry)i.next();
/* 290:    */      
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.AbstractObject2FloatMap
