...
/* 113 */     this.value = new short[this.n];
...
/* 192 */         short oldValue = this.value[pos];
...
/* 213 */         Short oldValue = Short.valueOf(this.value[pos]);
...
/* 243 */         short oldValue = this.value[pos];
/*     */         int tmp54_53 = pos;
...
/* 250 */     this.key[pos] = k;
/* 251 */     this.value[pos] = ((short)(this.defRetValue + incr));
...
/*     */   {
/* 627 */     if (this.values == null) this.values = new AbstractShortCollection() {
/*     */         public ShortIterator iterator() {
/* 629 */           return new Reference2ShortOpenHashMap.ValueIterator(Reference2ShortOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 632 */           return Reference2ShortOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(short v) {
/* 635 */           return Reference2ShortOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 638 */           Reference2ShortOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 753 */       c = (Reference2ShortOpenHashMap)super.clone();
/*     */     }
...
/* 762 */     c.value = ((short[])this.value.clone());
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Reference2ShortOpenHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 622 */       super(null); } 
/* 623 */     public short nextShort() { return Reference2ShortOpenHashMap.this.value[nextEntry()]; } 
/* 624 */     public Short next() { return Short.valueOf(Reference2ShortOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 594 */       return new Reference2ShortOpenHashMap.KeyIterator(Reference2ShortOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 597 */       return Reference2ShortOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 600 */       return Reference2ShortOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 603 */       int oldSize = Reference2ShortOpenHashMap.this.size;
/* 604 */       Reference2ShortOpenHashMap.this.remove(k);
/* 605 */       return Reference2ShortOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 608 */       Reference2ShortOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Reference2ShortOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 589 */       super(null); } 
/* 590 */     public K next() { return Reference2ShortOpenHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 535 */       return new Reference2ShortOpenHashMap.EntryIterator(Reference2ShortOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Reference2ShortMap.Entry<K>> fastIterator() {
/* 538 */       return new Reference2ShortOpenHashMap.FastEntryIterator(Reference2ShortOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 546 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ShortOpenHashMap.this.mask;
/*     */ 
/* 548 */       while (Reference2ShortOpenHashMap.this.used[pos] != 0) {
/* 549 */         if (Reference2ShortOpenHashMap.this.key[pos] == k) return Reference2ShortOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 550 */         pos = pos + 1 & Reference2ShortOpenHashMap.this.mask;
/*     */       }
/* 552 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 560 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ShortOpenHashMap.this.mask;
/*     */ 
/* 562 */       while (Reference2ShortOpenHashMap.this.used[pos] != 0) {
/* 563 */         if (Reference2ShortOpenHashMap.this.key[pos] == k) {
/* 564 */           Reference2ShortOpenHashMap.this.remove(e.getKey());
/* 565 */           return true;
/*     */         }
/* 567 */         pos = pos + 1 & Reference2ShortOpenHashMap.this.mask;
/*     */       }
/* 569 */       return false;
/*     */     }
/*     */     public int size() {
/* 572 */       return Reference2ShortOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 575 */       Reference2ShortOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Reference2ShortOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2ShortMap.Entry<K>>
/*     */   {
/* 525 */     final AbstractReference2ShortMap.BasicEntry<K> entry = new AbstractReference2ShortMap.BasicEntry(null, (short)0);
/*     */ 
...
/* 527 */       int e = nextEntry();
/* 528 */       this.entry.key = Reference2ShortOpenHashMap.this.key[e];
/* 529 */       this.entry.value = Reference2ShortOpenHashMap.this.value[e];
/* 530 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Reference2ShortOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2ShortMap.Entry<K>>
/*     */   {
...
/* 516 */       return this.entry = new Reference2ShortOpenHashMap.MapEntry(Reference2ShortOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 520 */       super.remove();
/* 521 */       Reference2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 421 */       this.pos = Reference2ShortOpenHashMap.this.n;
/*     */ 
/* 424 */       this.last = -1;
/*     */ 
/* 426 */       this.c = Reference2ShortOpenHashMap.this.size;
/*     */ 
/* 431 */       boolean[] used = Reference2ShortOpenHashMap.this.used;
...
/*     */ 
/* 444 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ShortOpenHashMap.this.mask;
/*     */ 
/* 446 */         while (Reference2ShortOpenHashMap.this.used[pos] != 0) {
/* 447 */           if (Reference2ShortOpenHashMap.this.key[pos] == k) return pos;
/* 448 */           pos = pos + 1 & Reference2ShortOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 451 */       this.last = this.pos;
/*     */ 
/* 453 */       if (this.c != 0) {
/* 454 */         boolean[] used = Reference2ShortOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 471 */         pos = (last = pos) + 1 & Reference2ShortOpenHashMap.this.mask;
/* 472 */         while (Reference2ShortOpenHashMap.this.used[pos] != 0) {
/* 473 */           int slot = (Reference2ShortOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ShortOpenHashMap.this.key[pos]))) & Reference2ShortOpenHashMap.this.mask;
/* 474 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 475 */           pos = pos + 1 & Reference2ShortOpenHashMap.this.mask;
/*     */         }
/* 477 */         if (Reference2ShortOpenHashMap.this.used[pos] == 0) break;
/* 478 */         if (pos < last)
/*     */         {
/* 480 */           if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 481 */           this.wrapped.add(Reference2ShortOpenHashMap.this.key[pos]);
/*     */         }
/* 483 */         Reference2ShortOpenHashMap.this.key[last] = Reference2ShortOpenHashMap.this.key[pos];
/* 484 */         Reference2ShortOpenHashMap.this.value[last] = Reference2ShortOpenHashMap.this.value[pos];
/*     */       }
/* 486 */       Reference2ShortOpenHashMap.this.used[last] = false;
/* 487 */       Reference2ShortOpenHashMap.this.key[last] = null;
/* 488 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 493 */       if (this.pos < -1)
/*     */       {
/* 495 */         Reference2ShortOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 496 */         this.last = -1;
/* 497 */         return;
/*     */       }
/* 499 */       Reference2ShortOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 388 */       return Reference2ShortOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Short getValue() {
/* 391 */       return Short.valueOf(Reference2ShortOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public short getShortValue() {
/* 394 */       return Reference2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public short setValue(short v) {
/* 397 */       short oldValue = Reference2ShortOpenHashMap.this.value[this.index];
/* 398 */       Reference2ShortOpenHashMap.this.value[this.index] = v;
/* 399 */       return oldValue;
/*     */     }
/*     */     public Short setValue(Short v) {
/* 402 */       return Short.valueOf(setValue(v.shortValue()));
/*     */     }
/*     */ 
/*     */     public boolean equals(Object o) {
/* 406 */       if (!(o instanceof Map.Entry)) return false;
/* 407 */       Map.Entry e = (Map.Entry)o;
/* 408 */       return (Reference2ShortOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ShortOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */     public int hashCode() {
/* 411 */       return (Reference2ShortOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ShortOpenHashMap.this.key[this.index])) ^ Reference2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 414 */       return Reference2ShortOpenHashMap.this.key[this.index] + "=>" + Reference2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
