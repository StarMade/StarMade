...
/*  597 */     double oldValue = put(ok, ov.doubleValue());
/*  598 */     return this.modified ? null : Double.valueOf(oldValue);
/*      */   }
/*      */   public Double remove(Object ok) {
/*  601 */     double oldValue = removeDouble(ok);
/*  602 */     return this.modified ? Double.valueOf(oldValue) : null;
/*      */   }
...
/*  949 */         final Comparator<? super Object2DoubleMap.Entry<K>> comparator = new Comparator() {
/*      */           public int compare(Object2DoubleMap.Entry<K> x, Object2DoubleMap.Entry<K> y) {
/*  951 */             return Object2DoubleRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/*  949 */         };
/*      */ 
...
/*  958 */           return new Object2DoubleRBTreeMap.EntryIterator(Object2DoubleRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) {
/*  961 */           return new Object2DoubleRBTreeMap.EntryIterator(Object2DoubleRBTreeMap.this, from.getKey());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/*  965 */           if (!(o instanceof Map.Entry)) return false;
/*  966 */           Map.Entry e = (Map.Entry)o;
/*  967 */           Object2DoubleRBTreeMap.Entry f = Object2DoubleRBTreeMap.this.findKey(e.getKey());
...
/*  974 */           Object2DoubleRBTreeMap.Entry f = Object2DoubleRBTreeMap.this.findKey(e.getKey());
/*  975 */           if (f != null) Object2DoubleRBTreeMap.this.removeDouble(f.key);
/*  976 */           return f != null;
/*      */         }
/*  978 */         public int size() { return Object2DoubleRBTreeMap.this.count; } 
/*  979 */         public void clear() { Object2DoubleRBTreeMap.this.clear(); } 
/*  980 */         public Object2DoubleMap.Entry<K> first() { return Object2DoubleRBTreeMap.this.firstEntry; } 
/*  981 */         public Object2DoubleMap.Entry<K> last() { return Object2DoubleRBTreeMap.this.lastEntry; } 
/*  982 */         public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) { return Object2DoubleRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet(); } 
/*  983 */         public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) { return Object2DoubleRBTreeMap.this.headMap(to.getKey()).object2DoubleEntrySet(); } 
/*  984 */         public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) { return Object2DoubleRBTreeMap.this.tailMap(from.getKey()).object2DoubleEntrySet(); }
/*      */       };
...
/*      */   {
/* 1044 */     if (this.values == null) this.values = new AbstractDoubleCollection() {
/*      */         public DoubleIterator iterator() {
/* 1046 */           return new Object2DoubleRBTreeMap.ValueIterator(Object2DoubleRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(double k) {
/* 1049 */           return Object2DoubleRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1052 */           return Object2DoubleRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1055 */           Object2DoubleRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1407 */       c = (Object2DoubleRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1479 */     if (n == 1) {
/* 1480 */       Entry top = new Entry(s.readObject(), s.readDouble());
/* 1481 */       top.pred(pred);
/* 1482 */       top.succ(succ);
/* 1483 */       top.black(true);
/* 1484 */       return top;
...
/* 1486 */     if (n == 2)
/*      */     {
/* 1489 */       Entry top = new Entry(s.readObject(), s.readDouble());
/* 1490 */       top.black(true);
/* 1491 */       top.right(new Entry(s.readObject(), s.readDouble()));
...
/*      */     {
/* 1108 */       if ((!bottom) && (!top) && (Object2DoubleRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1109 */       this.from = from;
/* 1110 */       this.bottom = bottom;
/* 1111 */       this.to = to;
/* 1112 */       this.top = top;
/* 1113 */       this.defRetValue = Object2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1127 */       return ((this.bottom) || (Object2DoubleRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Object2DoubleRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
/* 1131 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator() {
/* 1133 */             return new Object2DoubleRBTreeMap.Submap.SubmapEntryIterator(Object2DoubleRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) {
/* 1136 */             return new Object2DoubleRBTreeMap.Submap.SubmapEntryIterator(Object2DoubleRBTreeMap.Submap.this, from.getKey());
/*      */           }
/* 1138 */           public Comparator<? super Object2DoubleMap.Entry<K>> comparator() { return Object2DoubleRBTreeMap.this.object2DoubleEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1141 */             if (!(o instanceof Map.Entry)) return false;
/* 1142 */             Map.Entry e = (Map.Entry)o;
/* 1143 */             Object2DoubleRBTreeMap.Entry f = Object2DoubleRBTreeMap.this.findKey(e.getKey());
/* 1144 */             return (f != null) && (Object2DoubleRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1148 */             if (!(o instanceof Map.Entry)) return false;
/* 1149 */             Map.Entry e = (Map.Entry)o;
/* 1150 */             Object2DoubleRBTreeMap.Entry f = Object2DoubleRBTreeMap.this.findKey(e.getKey());
/* 1151 */             if ((f != null) && (Object2DoubleRBTreeMap.Submap.this.in(f.key))) Object2DoubleRBTreeMap.Submap.this.removeDouble(f.key);
/* 1152 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1155 */             int c = 0;
...
/* 1157 */             return c;
/*      */           }
/* 1159 */           public boolean isEmpty() { return !new Object2DoubleRBTreeMap.Submap.SubmapIterator(Object2DoubleRBTreeMap.Submap.this).hasNext(); } 
/* 1160 */           public void clear() { Object2DoubleRBTreeMap.Submap.this.clear(); } 
/* 1161 */           public Object2DoubleMap.Entry<K> first() { return Object2DoubleRBTreeMap.Submap.this.firstEntry(); } 
/* 1162 */           public Object2DoubleMap.Entry<K> last() { return Object2DoubleRBTreeMap.Submap.this.lastEntry(); } 
/* 1163 */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) { return Object2DoubleRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet(); } 
/* 1164 */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) { return Object2DoubleRBTreeMap.Submap.this.headMap(to.getKey()).object2DoubleEntrySet(); } 
/* 1165 */           public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) { return Object2DoubleRBTreeMap.Submap.this.tailMap(from.getKey()).object2DoubleEntrySet(); }
/*      */         };
...
/*      */     }
/*      */     public DoubleCollection values() {
/* 1178 */       if (this.values == null) this.values = new AbstractDoubleCollection() {
/*      */           public DoubleIterator iterator() {
/* 1180 */             return new Object2DoubleRBTreeMap.Submap.SubmapValueIterator(Object2DoubleRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(double k) {
/* 1183 */             return Object2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1186 */             return Object2DoubleRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1189 */             Object2DoubleRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(Object k) {
/* 1196 */       return (in(k)) && (Object2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(double v) {
/* 1199 */       SubmapIterator i = new SubmapIterator();
/*      */ 
/* 1201 */       while (i.hasNext()) {
/* 1202 */         double ev = i.nextEntry().value;
...
/*      */     {
/* 1210 */       Object kk = k;
/*      */       Object2DoubleRBTreeMap.Entry e;
/* 1211 */       return (in(kk)) && ((e = Object2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */ 
/*      */     public Double get(Object ok)
/*      */     {
/* 1216 */       Object kk = ok;
/*      */       Object2DoubleRBTreeMap.Entry e;
/* 1217 */       return (in(kk)) && ((e = Object2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.getValue() : null;
/*      */     }
/*      */     public double put(K k, double v) {
/* 1220 */       Object2DoubleRBTreeMap.this.modified = false;
...
/* 1222 */       double oldValue = Object2DoubleRBTreeMap.this.put(k, v);
/* 1223 */       return Object2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Double put(K ok, Double ov) {
/* 1226 */       double oldValue = put(ok, ov.doubleValue());
/* 1227 */       return Object2DoubleRBTreeMap.this.modified ? null : Double.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public double removeDouble(Object k) {
/* 1231 */       Object2DoubleRBTreeMap.this.modified = false;
/* 1232 */       if (!in(k)) return this.defRetValue;
/* 1233 */       double oldValue = Object2DoubleRBTreeMap.this.removeDouble(k);
/* 1234 */       return Object2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Double remove(Object ok) {
/* 1237 */       double oldValue = removeDouble(ok);
/* 1238 */       return Object2DoubleRBTreeMap.this.modified ? Double.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public Comparator<? super K> comparator() {
/* 1253 */       return Object2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Object2DoubleSortedMap<K> headMap(K to) {
/* 1256 */       if (this.top) return new Submap(Object2DoubleRBTreeMap.this, this.from, this.bottom, to, false);
/* 1257 */       return Object2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Object2DoubleRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Object2DoubleSortedMap<K> tailMap(K from) {
/* 1260 */       if (this.bottom) return new Submap(Object2DoubleRBTreeMap.this, from, false, this.to, this.top);
/* 1261 */       return Object2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2DoubleRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Object2DoubleSortedMap<K> subMap(K from, K to) {
/* 1264 */       if ((this.top) && (this.bottom)) return new Submap(Object2DoubleRBTreeMap.this, from, false, to, false);
/* 1265 */       if (!this.top) to = Object2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1266 */       if (!this.bottom) from = Object2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1267 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1268 */       return new Submap(Object2DoubleRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Object2DoubleRBTreeMap.Entry<K> firstEntry()
/*      */     {
/* 1275 */       if (Object2DoubleRBTreeMap.this.tree == null) return null;
/* 1278 */       Object2DoubleRBTreeMap.Entry e;
/*      */       Object2DoubleRBTreeMap.Entry e;
/* 1278 */       if (this.bottom) { e = Object2DoubleRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1280 */         e = Object2DoubleRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1282 */         if (Object2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1285 */       if ((e == null) || ((!this.top) && (Object2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1286 */       return e;
/*      */     }
/*      */ 
/*      */     public Object2DoubleRBTreeMap.Entry<K> lastEntry()
/*      */     {
/* 1293 */       if (Object2DoubleRBTreeMap.this.tree == null) return null;
/* 1296 */       Object2DoubleRBTreeMap.Entry e;
/*      */       Object2DoubleRBTreeMap.Entry e;
/* 1296 */       if (this.top) { e = Object2DoubleRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1298 */         e = Object2DoubleRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1300 */         if (Object2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1303 */       if ((e == null) || ((!this.bottom) && (Object2DoubleRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1304 */       return e;
/*      */     }
/*      */     public K firstKey() {
/* 1307 */       Object2DoubleRBTreeMap.Entry e = firstEntry();
/* 1308 */       if (e == null) throw new NoSuchElementException();
/* 1309 */       return e.key;
/*      */     }
/*      */     public K lastKey() {
/* 1312 */       Object2DoubleRBTreeMap.Entry e = lastEntry();
/* 1313 */       if (e == null) throw new NoSuchElementException();
/* 1314 */       return e.key;
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Object2DoubleRBTreeMap.Submap.SubmapIterator
/*      */       implements DoubleListIterator
/*      */     {
/*      */       private SubmapValueIterator()
/*      */       {
/* 1385 */         super(); } 
/* 1386 */       public double nextDouble() { return nextEntry().value; } 
/* 1387 */       public double previousDouble() { return previousEntry().value; } 
/* 1388 */       public void set(double v) { throw new UnsupportedOperationException(); } 
/* 1389 */       public void add(double v) { throw new UnsupportedOperationException(); } 
/* 1390 */       public Double next() { return Double.valueOf(nextEntry().value); } 
/* 1391 */       public Double previous() { return Double.valueOf(previousEntry().value); } 
/* 1392 */       public void set(Double ok) { throw new UnsupportedOperationException(); } 
/* 1393 */       public void add(Double ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Object2DoubleRBTreeMap<K>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Object2DoubleRBTreeMap<K>.Submap.SubmapIterator
...
/* 1357 */       public Object2DoubleMap.Entry<K> previous() { return previousEntry(); } 
/* 1358 */       public void set(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/* 1359 */       public void add(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Object2DoubleRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1324 */         super();
/* 1325 */         this.next = Object2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator() {
/* 1328 */         this();
/* 1329 */         if (this.next != null)
/* 1330 */           if ((!Object2DoubleRBTreeMap.Submap.this.bottom) && (Object2DoubleRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1331 */           } else if ((!Object2DoubleRBTreeMap.Submap.this.top) && (Object2DoubleRBTreeMap.this.compare(k, (this.prev = Object2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1333 */             this.next = Object2DoubleRBTreeMap.this.locateKey(k);
/* 1334 */             if (Object2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1344 */         if ((!Object2DoubleRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2DoubleRBTreeMap.this.compare(this.prev.key, Object2DoubleRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1347 */         this.next = this.next.next();
/* 1348 */         if ((!Object2DoubleRBTreeMap.Submap.this.top) && (this.next != null) && (Object2DoubleRBTreeMap.this.compare(this.next.key, Object2DoubleRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1169 */         super(); } 
/* 1170 */       public ObjectBidirectionalIterator<K> iterator() { return new Object2DoubleRBTreeMap.Submap.SubmapKeyIterator(Object2DoubleRBTreeMap.Submap.this); } 
/* 1171 */       public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2DoubleRBTreeMap.Submap.SubmapKeyIterator(Object2DoubleRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2DoubleRBTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     private ValueIterator()
/*      */     {
/* 1025 */       super(); } 
/* 1026 */     public double nextDouble() { return nextEntry().value; } 
/* 1027 */     public double previousDouble() { return previousEntry().value; } 
/* 1028 */     public void set(double v) { throw new UnsupportedOperationException(); } 
/* 1029 */     public void add(double v) { throw new UnsupportedOperationException(); } 
/* 1030 */     public Double next() { return Double.valueOf(nextEntry().value); } 
/* 1031 */     public Double previous() { return Double.valueOf(previousEntry().value); } 
/* 1032 */     public void set(Double ok) { throw new UnsupportedOperationException(); } 
/* 1033 */     public void add(Double ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class KeySet extends AbstractObject2DoubleSortedMap.KeySet
...
/*      */     {
/* 1003 */       super(); } 
/* 1004 */     public ObjectBidirectionalIterator<K> iterator() { return new Object2DoubleRBTreeMap.KeyIterator(Object2DoubleRBTreeMap.this); } 
/* 1005 */     public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2DoubleRBTreeMap.KeyIterator(Object2DoubleRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2DoubleRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2DoubleRBTreeMap<K>.TreeIterator
/*      */     implements ObjectListIterator<Object2DoubleMap.Entry<K>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/*  943 */     public Object2DoubleMap.Entry<K> previous() { return previousEntry(); } 
/*  944 */     public void set(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  945 */     public void add(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  870 */     int index = 0;
/*      */ 
/*  872 */     TreeIterator() { this.next = Object2DoubleRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator() {
/*  875 */       if ((this.next = Object2DoubleRBTreeMap.this.locateKey(k)) != null)
/*  876 */         if (Object2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/*  917 */       updatePrevious();
/*  918 */       updateNext();
/*  919 */       Object2DoubleRBTreeMap.this.removeDouble(this.curr.key);
/*  920 */       this.curr = null;
/*      */     }
...
/*  761 */       return Double.valueOf(this.value);
/*      */     }
/*      */     public double getDoubleValue() {
/*  764 */       return this.value;
/*      */     }
/*      */     public double setValue(double value) {
/*  767 */       double oldValue = this.value;
/*  768 */       this.value = value;
/*  769 */       return oldValue;
/*      */     }
/*      */     public Double setValue(Double value) {
/*  772 */       return Double.valueOf(setValue(value.doubleValue()));
/*      */     }
/*      */ 
...
/*  792 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */     public int hashCode() {
/*  795 */       return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.double2int(this.value);
/*      */     }
