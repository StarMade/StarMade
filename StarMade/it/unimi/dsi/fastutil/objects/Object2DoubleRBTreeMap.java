...
/*   18:     */
/*   72:     */public class Object2DoubleRBTreeMap<K>
...
/*   90:     */  
/*   91:     */  public Object2DoubleRBTreeMap()
/*   92:     */  {
/*   93:  93 */    allocatePaths();
/*   94:     */    
...
/*  113:     */  }
/*  114:     */  
/*  117:     */  public Object2DoubleRBTreeMap(Comparator<? super K> c)
/*  118:     */  {
/*  119: 119 */    this();
...
/*  122:     */  }
/*  123:     */  
/*  126:     */  public Object2DoubleRBTreeMap(Map<? extends K, ? extends Double> m)
/*  127:     */  {
/*  128: 128 */    this();
/*  129: 129 */    putAll(m);
/*  130:     */  }
/*  131:     */  
/*  134:     */  public Object2DoubleRBTreeMap(SortedMap<K, Double> m)
/*  135:     */  {
/*  136: 136 */    this(m.comparator());
/*  137: 137 */    putAll(m);
/*  138:     */  }
/*  139:     */  
/*  142:     */  public Object2DoubleRBTreeMap(Object2DoubleMap<? extends K> m)
/*  143:     */  {
/*  144: 144 */    this();
/*  145: 145 */    putAll(m);
/*  146:     */  }
/*  147:     */  
/*  150:     */  public Object2DoubleRBTreeMap(Object2DoubleSortedMap<K> m)
/*  151:     */  {
/*  152: 152 */    this(m.comparator());
/*  153: 153 */    putAll(m);
/*  154:     */  }
/*  155:     */  
/*  161:     */  public Object2DoubleRBTreeMap(K[] k, double[] v, Comparator<? super K> c)
/*  162:     */  {
/*  163: 163 */    this(c);
...
/*  167:     */  }
/*  168:     */  
/*  172:     */  public Object2DoubleRBTreeMap(K[] k, double[] v)
/*  173:     */  {
...
/*  233:     */  }
/*  234:     */  
/*  235:     */  public double put(K k, double v)
/*  236:     */  {
...
/*  248: 248 */          double oldValue = p.value;
/*  249: 249 */          p.value = v;
/*  250:     */          
...
/*  371:     */  }
/*  372:     */  
/*  374:     */  public double removeDouble(Object k)
/*  375:     */  {
...
/*  595:     */  }
/*  596:     */  
/*  597: 597 */  public Double put(K ok, Double ov) { double oldValue = put(ok, ov.doubleValue());
/*  598: 598 */    return this.modified ? null : Double.valueOf(oldValue);
/*  599:     */  }
/*  600:     */  
/*  601: 601 */  public Double remove(Object ok) { double oldValue = removeDouble(ok);
/*  602: 602 */    return this.modified ? Double.valueOf(oldValue) : null;
/*  603:     */  }
/*  604:     */  
/*  605: 605 */  public boolean containsValue(double v) { Object2DoubleRBTreeMap<K>.ValueIterator i = new ValueIterator(null);
/*  606:     */    
/*  607: 607 */    int j = this.count;
/*  608: 608 */    while (j-- != 0) {
/*  609: 609 */      double ev = i.nextDouble();
...
/*  626:     */    implements Cloneable, Object2DoubleMap.Entry<K>
/*  627:     */  {
...
/*  759:     */    
/*  760:     */    public Double getValue() {
/*  761: 761 */      return Double.valueOf(this.value);
/*  762:     */    }
/*  763:     */    
/*  764: 764 */    public double getDoubleValue() { return this.value; }
/*  765:     */    
/*  766:     */    public double setValue(double value) {
/*  767: 767 */      double oldValue = this.value;
/*  768: 768 */      this.value = value;
/*  769: 769 */      return oldValue;
/*  770:     */    }
/*  771:     */    
/*  772: 772 */    public Double setValue(Double value) { return Double.valueOf(setValue(value.doubleValue())); }
/*  773:     */    
...
/*  791: 791 */      Map.Entry<K, Double> e = (Map.Entry)o;
/*  792: 792 */      return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Double)e.getValue()).doubleValue());
/*  793:     */    }
/*  794:     */    
/*  795: 795 */    public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.double2int(this.value); }
/*  796:     */    
...
/*  862:     */  {
/*  863:     */    Object2DoubleRBTreeMap.Entry<K> prev;
/*  864:     */    
/*  866:     */    Object2DoubleRBTreeMap.Entry<K> next;
/*  867:     */    
/*  868:     */    Object2DoubleRBTreeMap.Entry<K> curr;
/*  869:     */    
/*  870: 870 */    int index = 0;
/*  871:     */    
/*  872: 872 */    TreeIterator() { this.next = Object2DoubleRBTreeMap.this.firstEntry; }
/*  873:     */    
/*  874:     */    TreeIterator() {
/*  875: 875 */      if ((this.next = Object2DoubleRBTreeMap.this.locateKey(k)) != null)
/*  876: 876 */        if (Object2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/*  887:     */    
/*  888:     */    Object2DoubleRBTreeMap.Entry<K> nextEntry() {
...
/*  897:     */    
/*  898:     */    Object2DoubleRBTreeMap.Entry<K> previousEntry() {
...
/*  918: 918 */      updateNext();
/*  919: 919 */      Object2DoubleRBTreeMap.this.removeDouble(this.curr.key);
...
/*  935:     */    extends Object2DoubleRBTreeMap<K>.TreeIterator
/*  936:     */    implements ObjectListIterator<Object2DoubleMap.Entry<K>>
/*  937:     */  {
/*  938: 938 */    EntryIterator() { super(); }
/*  939:     */    
/*  940: 940 */    EntryIterator() { super(k); }
/*  941:     */    
/*  942: 942 */    public Object2DoubleMap.Entry<K> next() { return nextEntry(); }
/*  943: 943 */    public Object2DoubleMap.Entry<K> previous() { return previousEntry(); }
/*  944: 944 */    public void set(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  945: 945 */    public void add(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*  946:     */  }
/*  947:     */  
/*  948: 948 */  public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*  949: 949 */        final Comparator<? super Object2DoubleMap.Entry<K>> comparator = new Comparator() {
/*  950:     */          public int compare(Object2DoubleMap.Entry<K> x, Object2DoubleMap.Entry<K> y) {
/*  951: 951 */            return Object2DoubleRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*  952:     */          }
/*  953:     */        };
/*  954:     */        
/*  955: 955 */        public Comparator<? super Object2DoubleMap.Entry<K>> comparator() { return this.comparator; }
/*  956:     */        
/*  957:     */        public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator() {
/*  958: 958 */          return new Object2DoubleRBTreeMap.EntryIterator(Object2DoubleRBTreeMap.this);
/*  959:     */        }
/*  960:     */        
/*  961: 961 */        public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) { return new Object2DoubleRBTreeMap.EntryIterator(Object2DoubleRBTreeMap.this, from.getKey()); }
/*  962:     */        
/*  963:     */        public boolean contains(Object o)
/*  964:     */        {
/*  965: 965 */          if (!(o instanceof Map.Entry)) return false;
/*  966: 966 */          Map.Entry<K, Double> e = (Map.Entry)o;
/*  967: 967 */          Object2DoubleRBTreeMap.Entry<K> f = Object2DoubleRBTreeMap.this.findKey(e.getKey());
/*  968: 968 */          return e.equals(f);
/*  969:     */        }
/*  970:     */        
/*  971:     */        public boolean remove(Object o) {
/*  972: 972 */          if (!(o instanceof Map.Entry)) return false;
/*  973: 973 */          Map.Entry<K, Double> e = (Map.Entry)o;
/*  974: 974 */          Object2DoubleRBTreeMap.Entry<K> f = Object2DoubleRBTreeMap.this.findKey(e.getKey());
/*  975: 975 */          if (f != null) Object2DoubleRBTreeMap.this.removeDouble(f.key);
/*  976: 976 */          return f != null; }
/*  977:     */        
/*  978: 978 */        public int size() { return Object2DoubleRBTreeMap.this.count; }
/*  979: 979 */        public void clear() { Object2DoubleRBTreeMap.this.clear(); }
/*  980: 980 */        public Object2DoubleMap.Entry<K> first() { return Object2DoubleRBTreeMap.this.firstEntry; }
/*  981: 981 */        public Object2DoubleMap.Entry<K> last() { return Object2DoubleRBTreeMap.this.lastEntry; }
/*  982: 982 */        public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) { return Object2DoubleRBTreeMap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet(); }
/*  983: 983 */        public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) { return Object2DoubleRBTreeMap.this.headMap(to.getKey()).object2DoubleEntrySet(); }
/*  984: 984 */        public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) { return Object2DoubleRBTreeMap.this.tailMap(from.getKey()).object2DoubleEntrySet(); }
/*  985:     */      };
/*  986: 986 */    return this.entries;
/*  987:     */  }
/*  988:     */  
/*  991:     */  private final class KeyIterator
/*  992:     */    extends Object2DoubleRBTreeMap<K>.TreeIterator
...
/* 1001:     */  }
/* 1002:     */  
/* 1003:1003 */  private class KeySet extends AbstractObject2DoubleSortedMap.KeySet { private KeySet() { super(); }
/* 1004:1004 */    public ObjectBidirectionalIterator<K> iterator() { return new Object2DoubleRBTreeMap.KeyIterator(Object2DoubleRBTreeMap.this); }
/* 1005:1005 */    public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2DoubleRBTreeMap.KeyIterator(Object2DoubleRBTreeMap.this, from); }
/* 1006:     */  }
/* 1007:     */  
...
/* 1022:     */    extends Object2DoubleRBTreeMap.TreeIterator
/* 1023:     */    implements DoubleListIterator
/* 1024:     */  {
/* 1025:1025 */    private ValueIterator() { super(); }
/* 1026:1026 */    public double nextDouble() { return nextEntry().value; }
/* 1027:1027 */    public double previousDouble() { return previousEntry().value; }
/* 1028:1028 */    public void set(double v) { throw new UnsupportedOperationException(); }
/* 1029:1029 */    public void add(double v) { throw new UnsupportedOperationException(); }
/* 1030:1030 */    public Double next() { return Double.valueOf(nextEntry().value); }
/* 1031:1031 */    public Double previous() { return Double.valueOf(previousEntry().value); }
/* 1032:1032 */    public void set(Double ok) { throw new UnsupportedOperationException(); }
/* 1033:1033 */    public void add(Double ok) { throw new UnsupportedOperationException(); }
/* 1034:     */  }
/* 1035:     */  
/* 1042:     */  public DoubleCollection values()
/* 1043:     */  {
/* 1044:1044 */    if (this.values == null) { this.values = new AbstractDoubleCollection() {
/* 1045:     */        public DoubleIterator iterator() {
/* 1046:1046 */          return new Object2DoubleRBTreeMap.ValueIterator(Object2DoubleRBTreeMap.this, null);
/* 1047:     */        }
/* 1048:     */        
/* 1049:1049 */        public boolean contains(double k) { return Object2DoubleRBTreeMap.this.containsValue(k); }
/* 1050:     */        
/* 1051:     */        public int size() {
/* 1052:1052 */          return Object2DoubleRBTreeMap.this.count;
/* 1053:     */        }
/* 1054:     */        
/* 1055:1055 */        public void clear() { Object2DoubleRBTreeMap.this.clear(); }
/* 1056:     */      };
/* 1057:     */    }
...
/* 1062:     */  
/* 1063:     */  public Object2DoubleSortedMap<K> headMap(K to) {
/* 1064:1064 */    return new Submap(null, true, to, false);
/* 1065:     */  }
/* 1066:     */  
/* 1067:1067 */  public Object2DoubleSortedMap<K> tailMap(K from) { return new Submap(from, false, null, true); }
/* 1068:     */  
/* 1069:     */  public Object2DoubleSortedMap<K> subMap(K from, K to) {
/* 1070:1070 */    return new Submap(from, false, to, false);
/* 1071:     */  }
/* 1072:     */  
/* 1076:     */  private final class Submap
/* 1077:     */    extends AbstractObject2DoubleSortedMap<K>
...
/* 1093:     */    boolean top;
/* 1094:     */    
/* 1096:     */    protected volatile transient ObjectSortedSet<Object2DoubleMap.Entry<K>> entries;
/* 1097:     */    
/* 1099:     */    protected volatile transient ObjectSortedSet<K> keys;
/* 1100:     */    
/* 1102:     */    protected volatile transient DoubleCollection values;
/* 1103:     */    
/* 1106:     */    public Submap(boolean from, K bottom, boolean to)
/* 1107:     */    {
/* 1108:1108 */      if ((!bottom) && (!top) && (Object2DoubleRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1109:1109 */      this.from = from;
/* 1110:1110 */      this.bottom = bottom;
/* 1111:1111 */      this.to = to;
/* 1112:1112 */      this.top = top;
/* 1113:1113 */      this.defRetValue = Object2DoubleRBTreeMap.this.defRetValue;
/* 1114:     */    }
/* 1115:     */    
/* 1116:1116 */    public void clear() { Object2DoubleRBTreeMap<K>.Submap.SubmapIterator i = new SubmapIterator();
...
/* 1126:     */    {
/* 1127:1127 */      return ((this.bottom) || (Object2DoubleRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Object2DoubleRBTreeMap.this.compare(k, this.to) < 0));
/* 1128:     */    }
/* 1129:     */    
/* 1130:     */    public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() {
/* 1131:1131 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1132:     */          public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator() {
/* 1133:1133 */            return new Object2DoubleRBTreeMap.Submap.SubmapEntryIterator(Object2DoubleRBTreeMap.Submap.this);
/* 1134:     */          }
/* 1135:     */          
/* 1136:1136 */          public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from) { return new Object2DoubleRBTreeMap.Submap.SubmapEntryIterator(Object2DoubleRBTreeMap.Submap.this, from.getKey()); }
/* 1137:     */          
/* 1138:1138 */          public Comparator<? super Object2DoubleMap.Entry<K>> comparator() { return Object2DoubleRBTreeMap.this.object2DoubleEntrySet().comparator(); }
/* 1139:     */          
/* 1140:     */          public boolean contains(Object o) {
/* 1141:1141 */            if (!(o instanceof Map.Entry)) return false;
/* 1142:1142 */            Map.Entry<K, Double> e = (Map.Entry)o;
/* 1143:1143 */            Object2DoubleRBTreeMap.Entry<K> f = Object2DoubleRBTreeMap.this.findKey(e.getKey());
/* 1144:1144 */            return (f != null) && (Object2DoubleRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1145:     */          }
/* 1146:     */          
/* 1147:     */          public boolean remove(Object o) {
/* 1148:1148 */            if (!(o instanceof Map.Entry)) return false;
/* 1149:1149 */            Map.Entry<K, Double> e = (Map.Entry)o;
/* 1150:1150 */            Object2DoubleRBTreeMap.Entry<K> f = Object2DoubleRBTreeMap.this.findKey(e.getKey());
/* 1151:1151 */            if ((f != null) && (Object2DoubleRBTreeMap.Submap.this.in(f.key))) Object2DoubleRBTreeMap.Submap.this.removeDouble(f.key);
...
/* 1157:1157 */            return c; }
/* 1158:     */          
/* 1159:1159 */          public boolean isEmpty() { return !new Object2DoubleRBTreeMap.Submap.SubmapIterator(Object2DoubleRBTreeMap.Submap.this).hasNext(); }
/* 1160:1160 */          public void clear() { Object2DoubleRBTreeMap.Submap.this.clear(); }
/* 1161:1161 */          public Object2DoubleMap.Entry<K> first() { return Object2DoubleRBTreeMap.Submap.this.firstEntry(); }
/* 1162:1162 */          public Object2DoubleMap.Entry<K> last() { return Object2DoubleRBTreeMap.Submap.this.lastEntry(); }
/* 1163:1163 */          public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> to) { return Object2DoubleRBTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2DoubleEntrySet(); }
/* 1164:1164 */          public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> to) { return Object2DoubleRBTreeMap.Submap.this.headMap(to.getKey()).object2DoubleEntrySet(); }
/* 1165:1165 */          public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from) { return Object2DoubleRBTreeMap.Submap.this.tailMap(from.getKey()).object2DoubleEntrySet(); }
/* 1166:     */        };
/* 1167:1167 */      return this.entries; }
/* 1168:     */    
/* 1169:1169 */    private class KeySet extends AbstractObject2DoubleSortedMap.KeySet { private KeySet() { super(); }
/* 1170:1170 */      public ObjectBidirectionalIterator<K> iterator() { return new Object2DoubleRBTreeMap.Submap.SubmapKeyIterator(Object2DoubleRBTreeMap.Submap.this); }
/* 1171:1171 */      public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2DoubleRBTreeMap.Submap.SubmapKeyIterator(Object2DoubleRBTreeMap.Submap.this, from); }
/* 1172:     */    }
/* 1173:     */    
...
/* 1176:     */    }
/* 1177:     */    
/* 1178:1178 */    public DoubleCollection values() { if (this.values == null) { this.values = new AbstractDoubleCollection() {
/* 1179:     */          public DoubleIterator iterator() {
/* 1180:1180 */            return new Object2DoubleRBTreeMap.Submap.SubmapValueIterator(Object2DoubleRBTreeMap.Submap.this, null);
/* 1181:     */          }
/* 1182:     */          
/* 1183:1183 */          public boolean contains(double k) { return Object2DoubleRBTreeMap.Submap.this.containsValue(k); }
/* 1184:     */          
/* 1185:     */          public int size() {
/* 1186:1186 */            return Object2DoubleRBTreeMap.Submap.this.size();
/* 1187:     */          }
/* 1188:     */          
/* 1189:1189 */          public void clear() { Object2DoubleRBTreeMap.Submap.this.clear(); }
/* 1190:     */        };
/* 1191:     */      }
/* 1192:1192 */      return this.values;
/* 1193:     */    }
/* 1194:     */    
/* 1196:1196 */    public boolean containsKey(Object k) { return (in(k)) && (Object2DoubleRBTreeMap.this.containsKey(k)); }
/* 1197:     */    
/* 1198:     */    public boolean containsValue(double v) {
/* 1199:1199 */      Object2DoubleRBTreeMap<K>.Submap.SubmapIterator i = new SubmapIterator();
/* 1200:     */      
/* 1201:1201 */      while (i.hasNext()) {
/* 1202:1202 */        double ev = i.nextEntry().value;
/* 1203:1203 */        if (ev == v) return true;
/* 1204:     */      }
/* 1205:1205 */      return false;
/* 1206:     */    }
/* 1207:     */    
/* 1208:     */    public double getDouble(Object k)
/* 1209:     */    {
/* 1210:1210 */      K kk = k;
/* 1211:1211 */      Object2DoubleRBTreeMap.Entry<K> e; return (in(kk)) && ((e = Object2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1212:     */    }
/* 1213:     */    
/* 1214:     */    public Double get(Object ok)
/* 1215:     */    {
/* 1216:1216 */      K kk = ok;
/* 1217:1217 */      Object2DoubleRBTreeMap.Entry<K> e; return (in(kk)) && ((e = Object2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.getValue() : null;
/* 1218:     */    }
/* 1219:     */    
/* 1220:1220 */    public double put(K k, double v) { Object2DoubleRBTreeMap.this.modified = false;
...
/* 1222:1222 */      double oldValue = Object2DoubleRBTreeMap.this.put(k, v);
/* 1223:1223 */      return Object2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1224:     */    }
/* 1225:     */    
/* 1226:1226 */    public Double put(K ok, Double ov) { double oldValue = put(ok, ov.doubleValue());
/* 1227:1227 */      return Object2DoubleRBTreeMap.this.modified ? null : Double.valueOf(oldValue);
/* 1228:     */    }
/* 1229:     */    
/* 1230:     */    public double removeDouble(Object k) {
/* 1231:1231 */      Object2DoubleRBTreeMap.this.modified = false;
/* 1232:1232 */      if (!in(k)) return this.defRetValue;
/* 1233:1233 */      double oldValue = Object2DoubleRBTreeMap.this.removeDouble(k);
/* 1234:1234 */      return Object2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1235:     */    }
/* 1236:     */    
/* 1237:1237 */    public Double remove(Object ok) { double oldValue = removeDouble(ok);
/* 1238:1238 */      return Object2DoubleRBTreeMap.this.modified ? Double.valueOf(oldValue) : null;
/* 1239:     */    }
/* 1240:     */    
/* 1241:1241 */    public int size() { Object2DoubleRBTreeMap<K>.Submap.SubmapIterator i = new SubmapIterator();
/* 1242:1242 */      int n = 0;
...
/* 1251:     */    
/* 1253:1253 */    public Comparator<? super K> comparator() { return Object2DoubleRBTreeMap.this.actualComparator; }
/* 1254:     */    
/* 1255:     */    public Object2DoubleSortedMap<K> headMap(K to) {
/* 1256:1256 */      if (this.top) return new Submap(Object2DoubleRBTreeMap.this, this.from, this.bottom, to, false);
/* 1257:1257 */      return Object2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Object2DoubleRBTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1258:     */    }
/* 1259:     */    
/* 1260:1260 */    public Object2DoubleSortedMap<K> tailMap(K from) { if (this.bottom) return new Submap(Object2DoubleRBTreeMap.this, from, false, this.to, this.top);
/* 1261:1261 */      return Object2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2DoubleRBTreeMap.this, from, false, this.to, this.top) : this;
/* 1262:     */    }
/* 1263:     */    
/* 1264:1264 */    public Object2DoubleSortedMap<K> subMap(K from, K to) { if ((this.top) && (this.bottom)) return new Submap(Object2DoubleRBTreeMap.this, from, false, to, false);
/* 1265:1265 */      if (!this.top) to = Object2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1266:1266 */      if (!this.bottom) from = Object2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1267:1267 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1268:1268 */      return new Submap(Object2DoubleRBTreeMap.this, from, false, to, false);
/* 1269:     */    }
/* 1270:     */    
/* 1273:     */    public Object2DoubleRBTreeMap.Entry<K> firstEntry()
/* 1274:     */    {
/* 1275:1275 */      if (Object2DoubleRBTreeMap.this.tree == null) return null;
/* 1276:     */      Object2DoubleRBTreeMap.Entry<K> e;
/* 1277:     */      Object2DoubleRBTreeMap.Entry<K> e;
/* 1278:1278 */      if (this.bottom) { e = Object2DoubleRBTreeMap.this.firstEntry;
/* 1279:     */      } else {
/* 1280:1280 */        e = Object2DoubleRBTreeMap.this.locateKey(this.from);
/* 1281:     */        
/* 1282:1282 */        if (Object2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1283:     */        }
/* 1284:     */      }
/* 1285:1285 */      if ((e == null) || ((!this.top) && (Object2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1286:1286 */      return e;
/* 1287:     */    }
/* 1288:     */    
/* 1291:     */    public Object2DoubleRBTreeMap.Entry<K> lastEntry()
/* 1292:     */    {
/* 1293:1293 */      if (Object2DoubleRBTreeMap.this.tree == null) return null;
/* 1294:     */      Object2DoubleRBTreeMap.Entry<K> e;
/* 1295:     */      Object2DoubleRBTreeMap.Entry<K> e;
/* 1296:1296 */      if (this.top) { e = Object2DoubleRBTreeMap.this.lastEntry;
/* 1297:     */      } else {
/* 1298:1298 */        e = Object2DoubleRBTreeMap.this.locateKey(this.to);
/* 1299:     */        
/* 1300:1300 */        if (Object2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1301:     */        }
/* 1302:     */      }
/* 1303:1303 */      if ((e == null) || ((!this.bottom) && (Object2DoubleRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1304:1304 */      return e;
/* 1305:     */    }
/* 1306:     */    
/* 1307:1307 */    public K firstKey() { Object2DoubleRBTreeMap.Entry<K> e = firstEntry();
/* 1308:1308 */      if (e == null) throw new NoSuchElementException();
/* 1309:1309 */      return e.key;
/* 1310:     */    }
/* 1311:     */    
/* 1312:1312 */    public K lastKey() { Object2DoubleRBTreeMap.Entry<K> e = lastEntry();
/* 1313:1313 */      if (e == null) throw new NoSuchElementException();
/* 1314:1314 */      return e.key;
/* 1315:     */    }
/* 1316:     */    
/* 1319:     */    private class SubmapIterator
/* 1320:     */      extends Object2DoubleRBTreeMap.TreeIterator
/* 1321:     */    {
/* 1322:     */      SubmapIterator()
/* 1323:     */      {
/* 1324:1324 */        super();
/* 1325:1325 */        this.next = Object2DoubleRBTreeMap.Submap.this.firstEntry();
/* 1326:     */      }
/* 1327:     */      
/* 1328:1328 */      SubmapIterator() { this();
/* 1329:1329 */        if (this.next != null)
/* 1330:1330 */          if ((!Object2DoubleRBTreeMap.Submap.this.bottom) && (Object2DoubleRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1331:1331 */          } else if ((!Object2DoubleRBTreeMap.Submap.this.top) && (Object2DoubleRBTreeMap.this.compare(k, (this.prev = Object2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1332:     */          } else {
/* 1333:1333 */            this.next = Object2DoubleRBTreeMap.this.locateKey(k);
/* 1334:1334 */            if (Object2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1344:1344 */        if ((!Object2DoubleRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2DoubleRBTreeMap.this.compare(this.prev.key, Object2DoubleRBTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1345:     */      }
/* 1346:     */      
/* 1347:1347 */      void updateNext() { this.next = this.next.next();
/* 1348:1348 */        if ((!Object2DoubleRBTreeMap.Submap.this.top) && (this.next != null) && (Object2DoubleRBTreeMap.this.compare(this.next.key, Object2DoubleRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1349:     */      }
/* 1350:     */    }
/* 1351:     */    
/* 1352:1352 */    private class SubmapEntryIterator extends Object2DoubleRBTreeMap<K>.Submap.SubmapIterator implements ObjectListIterator<Object2DoubleMap.Entry<K>> { SubmapEntryIterator() { super(); }
/* 1353:     */      
/* 1354:1354 */      SubmapEntryIterator() { super(k); }
/* 1355:     */      
/* 1356:1356 */      public Object2DoubleMap.Entry<K> next() { return nextEntry(); }
/* 1357:1357 */      public Object2DoubleMap.Entry<K> previous() { return previousEntry(); }
/* 1358:1358 */      public void set(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/* 1359:1359 */      public void add(Object2DoubleMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/* 1360:     */    }
/* 1361:     */    
/* 1366:     */    private final class SubmapKeyIterator
/* 1367:     */      extends Object2DoubleRBTreeMap<K>.Submap.SubmapIterator
...
/* 1382:     */      extends Object2DoubleRBTreeMap.Submap.SubmapIterator
/* 1383:     */      implements DoubleListIterator
/* 1384:     */    {
/* 1385:1385 */      private SubmapValueIterator() { super(); }
/* 1386:1386 */      public double nextDouble() { return nextEntry().value; }
/* 1387:1387 */      public double previousDouble() { return previousEntry().value; }
/* 1388:1388 */      public void set(double v) { throw new UnsupportedOperationException(); }
/* 1389:1389 */      public void add(double v) { throw new UnsupportedOperationException(); }
/* 1390:1390 */      public Double next() { return Double.valueOf(nextEntry().value); }
/* 1391:1391 */      public Double previous() { return Double.valueOf(previousEntry().value); }
/* 1392:1392 */      public void set(Double ok) { throw new UnsupportedOperationException(); }
/* 1393:1393 */      public void add(Double ok) { throw new UnsupportedOperationException(); }
/* 1394:     */    }
/* 1395:     */  }
/* 1396:     */  
/* 1400:     */  public Object2DoubleRBTreeMap<K> clone()
/* 1401:     */  {
/* 1402:     */    Object2DoubleRBTreeMap<K> c;
/* 1403:     */    
/* 1405:     */    try
/* 1406:     */    {
/* 1407:1407 */      c = (Object2DoubleRBTreeMap)super.clone();
/* 1408:     */    }
...
/* 1461:1461 */    Object2DoubleRBTreeMap<K>.EntryIterator i = new EntryIterator();
/* 1462:     */    
/* 1463:1463 */    s.defaultWriteObject();
/* 1464:1464 */    while (n-- != 0) {
/* 1465:1465 */      Entry<K> e = i.nextEntry();
/* 1466:1466 */      s.writeObject(e.key);
/* 1467:1467 */      s.writeDouble(e.value);
/* 1468:     */    }
/* 1469:     */  }
/* 1470:     */  
...
/* 1478:     */  {
/* 1479:1479 */    if (n == 1) {
/* 1480:1480 */      Entry<K> top = new Entry(s.readObject(), s.readDouble());
...
/* 1486:1486 */    if (n == 2)
/* 1487:     */    {
/* 1489:1489 */      Entry<K> top = new Entry(s.readObject(), s.readDouble());
/* 1490:1490 */      top.black(true);
/* 1491:1491 */      top.right(new Entry(s.readObject(), s.readDouble()));
...
/* 1502:1502 */    top.value = s.readDouble();
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.objects.Object2DoubleRBTreeMap
