  ...
  implements Serializable, Cloneable
{
  ...
  public Object2DoubleRBTreeMap(Comparator<? super K> local_c)
  {
    this();
  ...
  public Object2DoubleRBTreeMap(Map<? extends K, ? extends Double> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2DoubleRBTreeMap(SortedMap<K, Double> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2DoubleRBTreeMap(Object2DoubleMap<? extends K> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Object2DoubleRBTreeMap(Object2DoubleSortedMap<K> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Object2DoubleRBTreeMap(K[] local_k, double[] local_v, Comparator<? super K> local_c)
  {
    this(local_c);
  ...
  public Object2DoubleRBTreeMap(K[] local_k, double[] local_v)
  {
  ...
  {
    Object2DoubleRBTreeMap<K>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Object2DoubleMap.Entry<K>> comparator = new Comparator()
        {
          ...
          {
            return Object2DoubleRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Object2DoubleRBTreeMap.EntryIterator(Object2DoubleRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from)
        {
          return new Object2DoubleRBTreeMap.EntryIterator(Object2DoubleRBTreeMap.this, from.getKey());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Object2DoubleRBTreeMap.Entry<K> local_f = Object2DoubleRBTreeMap.this.findKey(local_e.getKey());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Object2DoubleRBTreeMap.Entry<K> local_f = Object2DoubleRBTreeMap.this.findKey(local_e.getKey());
          if (local_f != null) {
            Object2DoubleRBTreeMap.this.removeDouble(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Object2DoubleRBTreeMap.this.subMap(from.getKey(), local_to.getKey()).object2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> local_to)
        {
          return Object2DoubleRBTreeMap.this.headMap(local_to.getKey()).object2DoubleEntrySet();
        }
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Object2DoubleRBTreeMap.ValueIterator(Object2DoubleRBTreeMap.this, null);
        }
        
        public boolean contains(double local_k)
        {
          return Object2DoubleRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Object2DoubleRBTreeMap<K> local_c;
    try
    {
      local_c = (Object2DoubleRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Object2DoubleRBTreeMap<K>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Object2DoubleRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Object2DoubleRBTreeMap<K>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Object2DoubleRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Object2DoubleRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator()
          {
            return new Object2DoubleRBTreeMap.Submap.SubmapEntryIterator(Object2DoubleRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Object2DoubleMap.Entry<K>> iterator(Object2DoubleMap.Entry<K> from)
          {
            return new Object2DoubleRBTreeMap.Submap.SubmapEntryIterator(Object2DoubleRBTreeMap.Submap.this, from.getKey());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<K, Double> local_e = (Map.Entry)local_o;
            Object2DoubleRBTreeMap.Entry<K> local_f = Object2DoubleRBTreeMap.this.findKey(local_e.getKey());
            return (local_f != null) && (Object2DoubleRBTreeMap.Submap.this.in5(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<K, Double> local_e = (Map.Entry)local_o;
            Object2DoubleRBTreeMap.Entry<K> local_f = Object2DoubleRBTreeMap.this.findKey(local_e.getKey());
            if ((local_f != null) && (Object2DoubleRBTreeMap.Submap.this.in5(local_f.key))) {
              Object2DoubleRBTreeMap.Submap.this.removeDouble(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Object2DoubleRBTreeMap.Submap.SubmapIterator(Object2DoubleRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Object2DoubleRBTreeMap.Submap.this.clear();
          }
          
          public Object2DoubleMap.Entry<K> first()
          {
            return Object2DoubleRBTreeMap.Submap.this.firstEntry();
          }
          
          public Object2DoubleMap.Entry<K> last()
          {
            return Object2DoubleRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Object2DoubleMap.Entry<K>> subSet(Object2DoubleMap.Entry<K> from, Object2DoubleMap.Entry<K> local_to)
          {
            return Object2DoubleRBTreeMap.Submap.this.subMap(from.getKey(), local_to.getKey()).object2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Object2DoubleMap.Entry<K>> headSet(Object2DoubleMap.Entry<K> local_to)
          {
            return Object2DoubleRBTreeMap.Submap.this.headMap(local_to.getKey()).object2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Object2DoubleMap.Entry<K>> tailSet(Object2DoubleMap.Entry<K> from)
          {
            return Object2DoubleRBTreeMap.Submap.this.tailMap(from.getKey()).object2DoubleEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public DoubleCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractDoubleCollection()
        {
          public DoubleIterator iterator()
          {
            return new Object2DoubleRBTreeMap.Submap.SubmapValueIterator(Object2DoubleRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(double local_k)
          {
            return Object2DoubleRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Object2DoubleRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(Object local_k)
    {
      return (in5(local_k)) && (Object2DoubleRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      K local_kk = local_k;
      Object2DoubleRBTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2DoubleRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public Double get(Object local_ok)
    {
      K local_kk = local_ok;
      Object2DoubleRBTreeMap.Entry<K> local_e;
      return (in5(local_kk)) && ((local_e = Object2DoubleRBTreeMap.this.findKey(local_kk)) != null) ? local_e.getValue() : null;
    }
    ...
    public double put(K local_k, double local_v)
    {
      ...
      double oldValue = Object2DoubleRBTreeMap.this.put(local_k, local_v);
    ...
    public double removeDouble(Object local_k)
    {
      ...
      double oldValue = Object2DoubleRBTreeMap.this.removeDouble(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Object2DoubleRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Object2DoubleRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Object2DoubleRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Object2DoubleSortedMap<K> tailMap(K from)
    {
      if (this.bottom) {
        return new Submap(Object2DoubleRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Object2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2DoubleRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Object2DoubleSortedMap<K> subMap(K from, K local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Object2DoubleRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Object2DoubleRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Object2DoubleRBTreeMap.Entry<K> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Object2DoubleRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Object2DoubleRBTreeMap.this.locateKey(this.from);
        if (Object2DoubleRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Object2DoubleRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Object2DoubleRBTreeMap.Entry<K> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Object2DoubleRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Object2DoubleRBTreeMap.this.locateKey(this.field_47);
        if (Object2DoubleRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Object2DoubleRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public K firstKey()
    {
      Object2DoubleRBTreeMap.Entry<K> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public K lastKey()
    {
      Object2DoubleRBTreeMap.Entry<K> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapValueIterator
      extends Object2DoubleRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Object2DoubleRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Object2DoubleRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator()
      {
        this();
        if (this.next != null) {
          if ((!Object2DoubleRBTreeMap.Submap.this.bottom) && (Object2DoubleRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Object2DoubleRBTreeMap.Submap.this.top) && (Object2DoubleRBTreeMap.this.compare(local_k, (this.prev = Object2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Object2DoubleRBTreeMap.this.locateKey(local_k);
            if (Object2DoubleRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Object2DoubleRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2DoubleRBTreeMap.this.compare(this.prev.key, Object2DoubleRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Object2DoubleRBTreeMap.Submap.this.top) && (this.next != null) && (Object2DoubleRBTreeMap.this.compare(this.next.key, Object2DoubleRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractObject2DoubleSortedMap.KeySet
    {
      ...
      {
        return new Object2DoubleRBTreeMap.Submap.SubmapKeyIterator(Object2DoubleRBTreeMap.Submap.this);
      }
      
      public ObjectBidirectionalIterator<K> iterator(K from)
      {
        return new Object2DoubleRBTreeMap.Submap.SubmapKeyIterator(Object2DoubleRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractObject2DoubleSortedMap.KeySet
  {
    ...
    public ObjectBidirectionalIterator<K> iterator()
    {
      return new Object2DoubleRBTreeMap.KeyIterator(Object2DoubleRBTreeMap.this);
    }
    
    public ObjectBidirectionalIterator<K> iterator(K from)
    {
      return new Object2DoubleRBTreeMap.KeyIterator(Object2DoubleRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    TreeIterator()
    {
      if ((this.next = Object2DoubleRBTreeMap.this.locateKey(local_k)) != null) {
        if (Object2DoubleRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
