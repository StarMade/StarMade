...
/* 291 */     public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2DoubleEntrySet()); return this.entries; } 
...
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2DoubleEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return object2DoubleEntrySet();
/*     */     }
/* 161 */     public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.double2int(this.value); }
/*     */ 
...
/*     */       public K getKey()
/*     */       {
/* 131 */         return Object2DoubleMaps.Singleton.this.key; } 
/* 132 */       public Double getValue() { return Double.valueOf(Object2DoubleMaps.Singleton.this.value); }
/*     */ 
/*     */ 
/*     */       public double getDoubleValue()
/*     */       {
/* 139 */         return Object2DoubleMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Object2DoubleMaps.Singleton.this.key == null ? e.getKey() == null : Object2DoubleMaps.Singleton.this.key.equals(e.getKey())) && (Object2DoubleMaps.Singleton.this.value == ((Double)e.getValue()).doubleValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return (Object2DoubleMaps.Singleton.this.key == null ? 0 : Object2DoubleMaps.Singleton.this.key.hashCode()) ^ HashCommon.double2int(Object2DoubleMaps.Singleton.this.value); } 
/* 153 */       public String toString() { return Object2DoubleMaps.Singleton.this.key + "->" + Object2DoubleMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*  75 */     private Object readResolve() { return Object2DoubleMaps.EMPTY_MAP; } 
/*  76 */     public Object clone() { return Object2DoubleMaps.EMPTY_MAP; } 
/*  77 */     public boolean isEmpty() { return true; }
/*     */ 
/*     */     public ObjectSet<Map.Entry<K, Double>> entrySet() {
/*  80 */       return object2DoubleEntrySet();
/*     */     }
