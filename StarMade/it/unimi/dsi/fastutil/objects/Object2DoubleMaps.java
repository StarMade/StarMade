...
/*  12:    */
/*  58:    */public class Object2DoubleMaps
/*  59:    */{
/*  60:    */  public static class EmptyMap<K>
/*  61:    */    extends Object2DoubleFunctions.EmptyFunction<K>
/*  62:    */    implements Object2DoubleMap<K>, Serializable, Cloneable
/*  63:    */  {
...
/*  68:    */    
/*  69: 69 */    public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() { return ObjectSets.EMPTY_SET; }
/*  70:    */    
...
/*  75: 75 */    private Object readResolve() { return Object2DoubleMaps.EMPTY_MAP; }
/*  76: 76 */    public Object clone() { return Object2DoubleMaps.EMPTY_MAP; }
/*  77: 77 */    public boolean isEmpty() { return true; }
/*  78:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<K, Double>> entrySet() { return object2DoubleEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Object2DoubleFunctions.Singleton<K>
/* 103:    */    implements Object2DoubleMap<K>, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Object2DoubleMap.Entry<K>> entries;
/* 108:    */    
...
/* 125:    */    
/* 126:126 */    public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Object2DoubleMap.Entry<K>, Map.Entry<K, Double> { protected SingletonEntry() {}
/* 131:131 */      public K getKey() { return Object2DoubleMaps.Singleton.this.key; }
/* 132:132 */      public Double getValue() { return Double.valueOf(Object2DoubleMaps.Singleton.this.value); }
/* 133:    */      
/* 139:139 */      public double getDoubleValue() { return Object2DoubleMaps.Singleton.this.value; }
...
/* 148:    */        
/* 149:149 */        return (Object2DoubleMaps.Singleton.this.key == null ? e.getKey() == null : Object2DoubleMaps.Singleton.this.key.equals(e.getKey())) && (Object2DoubleMaps.Singleton.this.value == ((Double)e.getValue()).doubleValue());
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return (Object2DoubleMaps.Singleton.this.key == null ? 0 : Object2DoubleMaps.Singleton.this.key.hashCode()) ^ HashCommon.double2int(Object2DoubleMaps.Singleton.this.value); }
/* 153:153 */      public String toString() { return Object2DoubleMaps.Singleton.this.key + "->" + Object2DoubleMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<K, Double>> entrySet() { return object2DoubleEntrySet(); }
/* 160:    */    
/* 161:161 */    public int hashCode() { return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.double2int(this.value); }
/* 162:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static <K> Object2DoubleMap<K> singleton(K key, double value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static <K> Object2DoubleMap<K> singleton(K key, Double value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key, value.doubleValue());
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap<K>
/* 205:    */    extends Object2DoubleFunctions.SynchronizedFunction<K>
/* 206:    */    implements Object2DoubleMap<K>, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Object2DoubleMap<K> map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Object2DoubleMap.Entry<K>> entries;
/* 213:    */    
/* 214:    */    protected volatile transient ObjectSet<K> keys;
/* 215:    */    protected volatile transient DoubleCollection values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Object2DoubleMap<K> m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Object2DoubleMap<K> m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 239:    */    
/* 240:240 */    public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.object2DoubleEntrySet(), this.sync); return this.entries; }
...
/* 258:    */  }
/* 259:    */  
/* 261:    */  public static <K> Object2DoubleMap<K> synchronize(Object2DoubleMap<K> m)
/* 262:    */  {
/* 263:263 */    return new SynchronizedMap(m);
/* 264:    */  }
/* 265:    */  
/* 271:271 */  public static <K> Object2DoubleMap<K> synchronize(Object2DoubleMap<K> m, Object sync) { return new SynchronizedMap(m, sync); }
/* 272:    */  
/* 273:    */  public static class UnmodifiableMap<K> extends Object2DoubleFunctions.UnmodifiableFunction<K> implements Object2DoubleMap<K>, Serializable {
/* 274:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 275:    */    protected final Object2DoubleMap<K> map;
/* 276:    */    protected volatile transient ObjectSet<Object2DoubleMap.Entry<K>> entries;
/* 277:    */    protected volatile transient ObjectSet<K> keys;
/* 278:    */    protected volatile transient DoubleCollection values;
/* 279:    */    
/* 280:280 */    protected UnmodifiableMap(Object2DoubleMap<K> m) { super();
/* 281:281 */      this.map = m; }
/* 282:    */    
...
/* 291:291 */    public ObjectSet<Object2DoubleMap.Entry<K>> object2DoubleEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.object2DoubleEntrySet()); return this.entries; }
...
/* 301:    */  }
/* 302:    */  
/* 306:    */  public static <K> Object2DoubleMap<K> unmodifiable(Object2DoubleMap<K> m)
/* 307:    */  {
