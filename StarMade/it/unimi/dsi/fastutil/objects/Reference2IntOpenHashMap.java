...
/* 629 */           return new Reference2IntOpenHashMap.ValueIterator(Reference2IntOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 632 */           return Reference2IntOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(int v) {
/* 635 */           return Reference2IntOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 638 */           Reference2IntOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 753 */       c = (Reference2IntOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Reference2IntOpenHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 622 */       super(null); } 
/* 623 */     public int nextInt() { return Reference2IntOpenHashMap.this.value[nextEntry()]; } 
/* 624 */     public Integer next() { return Integer.valueOf(Reference2IntOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 594 */       return new Reference2IntOpenHashMap.KeyIterator(Reference2IntOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 597 */       return Reference2IntOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 600 */       return Reference2IntOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 603 */       int oldSize = Reference2IntOpenHashMap.this.size;
/* 604 */       Reference2IntOpenHashMap.this.remove(k);
/* 605 */       return Reference2IntOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 608 */       Reference2IntOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Reference2IntOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 589 */       super(null); } 
/* 590 */     public K next() { return Reference2IntOpenHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 535 */       return new Reference2IntOpenHashMap.EntryIterator(Reference2IntOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Reference2IntMap.Entry<K>> fastIterator() {
/* 538 */       return new Reference2IntOpenHashMap.FastEntryIterator(Reference2IntOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 546 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntOpenHashMap.this.mask;
/*     */ 
/* 548 */       while (Reference2IntOpenHashMap.this.used[pos] != 0) {
/* 549 */         if (Reference2IntOpenHashMap.this.key[pos] == k) return Reference2IntOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 550 */         pos = pos + 1 & Reference2IntOpenHashMap.this.mask;
/*     */       }
/* 552 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 560 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntOpenHashMap.this.mask;
/*     */ 
/* 562 */       while (Reference2IntOpenHashMap.this.used[pos] != 0) {
/* 563 */         if (Reference2IntOpenHashMap.this.key[pos] == k) {
/* 564 */           Reference2IntOpenHashMap.this.remove(e.getKey());
/* 565 */           return true;
/*     */         }
/* 567 */         pos = pos + 1 & Reference2IntOpenHashMap.this.mask;
/*     */       }
/* 569 */       return false;
/*     */     }
/*     */     public int size() {
/* 572 */       return Reference2IntOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 575 */       Reference2IntOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Reference2IntOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2IntMap.Entry<K>>
/*     */   {
/* 525 */     final AbstractReference2IntMap.BasicEntry<K> entry = new AbstractReference2IntMap.BasicEntry(null, 0);
/*     */ 
...
/* 527 */       int e = nextEntry();
/* 528 */       this.entry.key = Reference2IntOpenHashMap.this.key[e];
/* 529 */       this.entry.value = Reference2IntOpenHashMap.this.value[e];
/* 530 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Reference2IntOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2IntMap.Entry<K>>
/*     */   {
...
/* 516 */       return this.entry = new Reference2IntOpenHashMap.MapEntry(Reference2IntOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 520 */       super.remove();
/* 521 */       Reference2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 421 */       this.pos = Reference2IntOpenHashMap.this.n;
/*     */ 
/* 424 */       this.last = -1;
/*     */ 
/* 426 */       this.c = Reference2IntOpenHashMap.this.size;
/*     */ 
/* 431 */       boolean[] used = Reference2IntOpenHashMap.this.used;
...
/*     */ 
/* 444 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntOpenHashMap.this.mask;
/*     */ 
/* 446 */         while (Reference2IntOpenHashMap.this.used[pos] != 0) {
/* 447 */           if (Reference2IntOpenHashMap.this.key[pos] == k) return pos;
/* 448 */           pos = pos + 1 & Reference2IntOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 451 */       this.last = this.pos;
/*     */ 
/* 453 */       if (this.c != 0) {
/* 454 */         boolean[] used = Reference2IntOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 471 */         pos = (last = pos) + 1 & Reference2IntOpenHashMap.this.mask;
/* 472 */         while (Reference2IntOpenHashMap.this.used[pos] != 0) {
/* 473 */           int slot = (Reference2IntOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2IntOpenHashMap.this.key[pos]))) & Reference2IntOpenHashMap.this.mask;
/* 474 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 475 */           pos = pos + 1 & Reference2IntOpenHashMap.this.mask;
/*     */         }
/* 477 */         if (Reference2IntOpenHashMap.this.used[pos] == 0) break;
/* 478 */         if (pos < last)
/*     */         {
/* 480 */           if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 481 */           this.wrapped.add(Reference2IntOpenHashMap.this.key[pos]);
/*     */         }
/* 483 */         Reference2IntOpenHashMap.this.key[last] = Reference2IntOpenHashMap.this.key[pos];
/* 484 */         Reference2IntOpenHashMap.this.value[last] = Reference2IntOpenHashMap.this.value[pos];
/*     */       }
/* 486 */       Reference2IntOpenHashMap.this.used[last] = false;
/* 487 */       Reference2IntOpenHashMap.this.key[last] = null;
/* 488 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 493 */       if (this.pos < -1)
/*     */       {
/* 495 */         Reference2IntOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 496 */         this.last = -1;
/* 497 */         return;
/*     */       }
/* 499 */       Reference2IntOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 388 */       return Reference2IntOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Integer getValue() {
/* 391 */       return Integer.valueOf(Reference2IntOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public int getIntValue() {
/* 394 */       return Reference2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public int setValue(int v) {
/* 397 */       int oldValue = Reference2IntOpenHashMap.this.value[this.index];
/* 398 */       Reference2IntOpenHashMap.this.value[this.index] = v;
/* 399 */       return oldValue;
/*     */     }
...
/* 408 */       return (Reference2IntOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2IntOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */     public int hashCode() {
/* 411 */       return (Reference2IntOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2IntOpenHashMap.this.key[this.index])) ^ Reference2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 414 */       return Reference2IntOpenHashMap.this.key[this.index] + "=>" + Reference2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
