...
public abstract interface Reference2ObjectMap<K, V> extends Reference2ObjectFunction<K, V>, Map<K, V>
{
  ...
  public static abstract interface FastEntrySet<K, V> extends ObjectSet<Reference2ObjectMap.Entry<K, V>>
  {
