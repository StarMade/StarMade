...
/* 629 */           return new Object2ShortOpenHashMap.ValueIterator(Object2ShortOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 632 */           return Object2ShortOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(short v) {
/* 635 */           return Object2ShortOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 638 */           Object2ShortOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 753 */       c = (Object2ShortOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Object2ShortOpenHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 622 */       super(null); } 
/* 623 */     public short nextShort() { return Object2ShortOpenHashMap.this.value[nextEntry()]; } 
/* 624 */     public Short next() { return Short.valueOf(Object2ShortOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 594 */       return new Object2ShortOpenHashMap.KeyIterator(Object2ShortOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 597 */       return Object2ShortOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 600 */       return Object2ShortOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 603 */       int oldSize = Object2ShortOpenHashMap.this.size;
/* 604 */       Object2ShortOpenHashMap.this.remove(k);
/* 605 */       return Object2ShortOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 608 */       Object2ShortOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Object2ShortOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 589 */       super(null); } 
/* 590 */     public K next() { return Object2ShortOpenHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
/*     */   private final class MapEntrySet extends AbstractObjectSet<Object2ShortMap.Entry<K>>
...
/*     */     {
/* 535 */       return new Object2ShortOpenHashMap.EntryIterator(Object2ShortOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Object2ShortMap.Entry<K>> fastIterator() {
/* 538 */       return new Object2ShortOpenHashMap.FastEntryIterator(Object2ShortOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 546 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ShortOpenHashMap.this.mask;
/*     */ 
/* 548 */       while (Object2ShortOpenHashMap.this.used[pos] != 0) {
/* 549 */         if (Object2ShortOpenHashMap.this.key[pos] == null ? k == null : Object2ShortOpenHashMap.this.key[pos].equals(k)) return Object2ShortOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 550 */         pos = pos + 1 & Object2ShortOpenHashMap.this.mask;
/*     */       }
/* 552 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 560 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ShortOpenHashMap.this.mask;
/*     */ 
/* 562 */       while (Object2ShortOpenHashMap.this.used[pos] != 0) {
/* 563 */         if (Object2ShortOpenHashMap.this.key[pos] == null ? k == null : Object2ShortOpenHashMap.this.key[pos].equals(k)) {
/* 564 */           Object2ShortOpenHashMap.this.remove(e.getKey());
/* 565 */           return true;
/*     */         }
/* 567 */         pos = pos + 1 & Object2ShortOpenHashMap.this.mask;
/*     */       }
/* 569 */       return false;
/*     */     }
/*     */     public int size() {
/* 572 */       return Object2ShortOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 575 */       Object2ShortOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Object2ShortOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2ShortMap.Entry<K>>
/*     */   {
/* 525 */     final AbstractObject2ShortMap.BasicEntry<K> entry = new AbstractObject2ShortMap.BasicEntry(null, (short)0);
/*     */ 
...
/* 527 */       int e = nextEntry();
/* 528 */       this.entry.key = Object2ShortOpenHashMap.this.key[e];
/* 529 */       this.entry.value = Object2ShortOpenHashMap.this.value[e];
/* 530 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Object2ShortOpenHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Object2ShortMap.Entry<K>>
/*     */   {
...
/* 516 */       return this.entry = new Object2ShortOpenHashMap.MapEntry(Object2ShortOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 520 */       super.remove();
/* 521 */       Object2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 421 */       this.pos = Object2ShortOpenHashMap.this.n;
/*     */ 
/* 424 */       this.last = -1;
/*     */ 
/* 426 */       this.c = Object2ShortOpenHashMap.this.size;
/*     */ 
/* 431 */       boolean[] used = Object2ShortOpenHashMap.this.used;
...
/*     */ 
/* 444 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(k.hashCode())) & Object2ShortOpenHashMap.this.mask;
/*     */ 
/* 446 */         while (Object2ShortOpenHashMap.this.used[pos] != 0) {
/* 447 */           if (Object2ShortOpenHashMap.this.key[pos] == null ? k == null : Object2ShortOpenHashMap.this.key[pos].equals(k)) return pos;
/* 448 */           pos = pos + 1 & Object2ShortOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 451 */       this.last = this.pos;
/*     */ 
/* 453 */       if (this.c != 0) {
/* 454 */         boolean[] used = Object2ShortOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 471 */         pos = (last = pos) + 1 & Object2ShortOpenHashMap.this.mask;
/* 472 */         while (Object2ShortOpenHashMap.this.used[pos] != 0) {
/* 473 */           int slot = (Object2ShortOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(Object2ShortOpenHashMap.this.key[pos].hashCode())) & Object2ShortOpenHashMap.this.mask;
/* 474 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 475 */           pos = pos + 1 & Object2ShortOpenHashMap.this.mask;
/*     */         }
/* 477 */         if (Object2ShortOpenHashMap.this.used[pos] == 0) break;
/* 478 */         if (pos < last)
/*     */         {
/* 480 */           if (this.wrapped == null) this.wrapped = new ObjectArrayList();
/* 481 */           this.wrapped.add(Object2ShortOpenHashMap.this.key[pos]);
/*     */         }
/* 483 */         Object2ShortOpenHashMap.this.key[last] = Object2ShortOpenHashMap.this.key[pos];
/* 484 */         Object2ShortOpenHashMap.this.value[last] = Object2ShortOpenHashMap.this.value[pos];
/*     */       }
/* 486 */       Object2ShortOpenHashMap.this.used[last] = false;
/* 487 */       Object2ShortOpenHashMap.this.key[last] = null;
/* 488 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 493 */       if (this.pos < -1)
/*     */       {
/* 495 */         Object2ShortOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 496 */         this.last = -1;
/* 497 */         return;
/*     */       }
/* 499 */       Object2ShortOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 388 */       return Object2ShortOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Short getValue() {
/* 391 */       return Short.valueOf(Object2ShortOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public short getShortValue() {
/* 394 */       return Object2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public short setValue(short v) {
/* 397 */       short oldValue = Object2ShortOpenHashMap.this.value[this.index];
/* 398 */       Object2ShortOpenHashMap.this.value[this.index] = v;
/* 399 */       return oldValue;
/*     */     }
/*     */     public Short setValue(Short v) {
...
/* 408 */       return (Object2ShortOpenHashMap.this.key[this.index] == null ? e.getKey() == null : Object2ShortOpenHashMap.this.key[this.index].equals(e.getKey())) && (Object2ShortOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */     public int hashCode() {
/* 411 */       return (Object2ShortOpenHashMap.this.key[this.index] == null ? 0 : Object2ShortOpenHashMap.this.key[this.index].hashCode()) ^ Object2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 414 */       return Object2ShortOpenHashMap.this.key[this.index] + "=>" + Object2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
