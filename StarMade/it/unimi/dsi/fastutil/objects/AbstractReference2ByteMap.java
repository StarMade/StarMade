  ...
  implements Reference2ByteMap<K>, Serializable
{
  ...
  public void putAll(Map<? extends K, ? extends Byte> local_m)
  {
    ...
    if ((local_m instanceof Reference2ByteMap)) {
      while (local_n-- != 0)
      {
        Reference2ByteMap.Entry<? extends K> local_e = (Reference2ByteMap.Entry)local_i.next();
  ...
  public ReferenceSet<K> keySet()
  {
    new AbstractReferenceSet()
    {
      ...
      {
        return AbstractReference2ByteMap.this.containsKey(local_k);
      }
      ...
      public ObjectIterator<K> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Byte>> field_3 = AbstractReference2ByteMap.this.entrySet().iterator();
          
          public K next()
          {
            return ((Reference2ByteMap.Entry)this.field_3.next()).getKey();
          }
  ...
  public ByteCollection values()
  {
    new AbstractByteCollection()
    {
      ...
      {
        return AbstractReference2ByteMap.this.containsValue(local_k);
      }
      ...
      public ByteIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<K, Byte>> field_58 = AbstractReference2ByteMap.this.entrySet().iterator();
          
          public byte nextByte()
          {
            return ((Reference2ByteMap.Entry)this.field_58.next()).getByteValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Reference2ByteMap.Entry<K> local_e = (Reference2ByteMap.Entry)local_i.next();
    ...
    implements Reference2ByteMap.Entry<K>
  {
    ...
    public boolean equals(Object local_o)
    {
      ...
      return (this.key == local_e.getKey()) && (this.value == ((Byte)local_e.getValue()).byteValue());
    }
