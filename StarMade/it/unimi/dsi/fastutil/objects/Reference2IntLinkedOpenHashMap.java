...
/*  382 */         this.size -= 1;
/*  383 */         fixPointers(pos);
/*  384 */         int v = this.value[pos];
/*  385 */         shiftKeys(pos);
/*  386 */         return Integer.valueOf(v);
/*      */       }
...
/*  520 */       if (k == key[pos]) {
/*  521 */         int oldValue = this.value[pos];
...
/*  559 */       if (k == key[pos]) {
/*  560 */         int oldValue = this.value[pos];
...
/*  774 */   public Reference2IntSortedMap<K> tailMap(K from) { throw new UnsupportedOperationException(); } 
/*  775 */   public Reference2IntSortedMap<K> headMap(K to) { throw new UnsupportedOperationException(); } 
/*  776 */   public Reference2IntSortedMap<K> subMap(K from, K to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/* 1090 */     if (this.values == null) this.values = new AbstractIntCollection() {
/*      */         public IntIterator iterator() {
/* 1092 */           return new Reference2IntLinkedOpenHashMap.ValueIterator(Reference2IntLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1095 */           return Reference2IntLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(int v) {
/* 1098 */           return Reference2IntLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1101 */           Reference2IntLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1234 */       c = (Reference2IntLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1243 */     c.value = ((int[])this.value.clone());
...
/* 1287 */     int[] value = this.value = new int[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Reference2IntLinkedOpenHashMap.MapIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public int previousInt()
/*      */     {
/* 1079 */       return Reference2IntLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1080 */     public Integer previous() { return Integer.valueOf(Reference2IntLinkedOpenHashMap.this.value[previousEntry()]); } 
/* 1081 */     public void set(Integer ok) { throw new UnsupportedOperationException(); } 
/* 1082 */     public void add(Integer ok) { throw new UnsupportedOperationException(); } 
...
/* 1086 */     public int nextInt() { return Reference2IntLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1087 */     public Integer next() { return Integer.valueOf(Reference2IntLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1036 */       return new Reference2IntLinkedOpenHashMap.KeyIterator(Reference2IntLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ObjectListIterator<K> iterator() {
/* 1039 */       return new Reference2IntLinkedOpenHashMap.KeyIterator(Reference2IntLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1042 */       return Reference2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(Object k) {
/* 1045 */       return Reference2IntLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(Object k) {
/* 1048 */       int oldSize = Reference2IntLinkedOpenHashMap.this.size;
/* 1049 */       Reference2IntLinkedOpenHashMap.this.remove(k);
/* 1050 */       return Reference2IntLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1053 */       Reference2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public K first() {
/* 1056 */       if (Reference2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1057 */       return Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public K last() {
/* 1060 */       if (Reference2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1061 */       return Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Reference2IntLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1027 */       super(k, null); } 
/* 1028 */     public K previous() { return Reference2IntLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1032 */     public K next() { return Reference2IntLinkedOpenHashMap.this.key[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  955 */       return new Reference2IntLinkedOpenHashMap.EntryIterator(Reference2IntLinkedOpenHashMap.this);
/*      */     }
/*  957 */     public Comparator<? super Reference2IntMap.Entry<K>> comparator() { return null; } 
/*  958 */     public ObjectSortedSet<Reference2IntMap.Entry<K>> subSet(Reference2IntMap.Entry<K> fromElement, Reference2IntMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  959 */     public ObjectSortedSet<Reference2IntMap.Entry<K>> headSet(Reference2IntMap.Entry<K> toElement) { throw new UnsupportedOperationException(); } 
/*  960 */     public ObjectSortedSet<Reference2IntMap.Entry<K>> tailSet(Reference2IntMap.Entry<K> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Reference2IntMap.Entry<K> first() {
/*  962 */       if (Reference2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  963 */       return new Reference2IntLinkedOpenHashMap.MapEntry(Reference2IntLinkedOpenHashMap.this, Reference2IntLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Reference2IntMap.Entry<K> last() {
/*  966 */       if (Reference2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  967 */       return new Reference2IntLinkedOpenHashMap.MapEntry(Reference2IntLinkedOpenHashMap.this, Reference2IntLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  975 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntLinkedOpenHashMap.this.mask;
/*      */ 
/*  977 */       while (Reference2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  978 */         if (Reference2IntLinkedOpenHashMap.this.key[pos] == k) return Reference2IntLinkedOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/*  979 */         pos = pos + 1 & Reference2IntLinkedOpenHashMap.this.mask;
/*      */       }
/*  981 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  989 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2IntLinkedOpenHashMap.this.mask;
/*      */ 
/*  991 */       while (Reference2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  992 */         if (Reference2IntLinkedOpenHashMap.this.key[pos] == k) {
/*  993 */           Reference2IntLinkedOpenHashMap.this.remove(e.getKey());
/*  994 */           return true;
/*      */         }
/*  996 */         pos = pos + 1 & Reference2IntLinkedOpenHashMap.this.mask;
/*      */       }
/*  998 */       return false;
/*      */     }
/*      */     public int size() {
/* 1001 */       return Reference2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1004 */       Reference2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2IntMap.Entry<K>> iterator(Reference2IntMap.Entry<K> from) {
/* 1007 */       return new Reference2IntLinkedOpenHashMap.EntryIterator(Reference2IntLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2IntMap.Entry<K>> fastIterator() {
/* 1010 */       return new Reference2IntLinkedOpenHashMap.FastEntryIterator(Reference2IntLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Reference2IntMap.Entry<K>> fastIterator(Reference2IntMap.Entry<K> from) {
/* 1013 */       return new Reference2IntLinkedOpenHashMap.FastEntryIterator(Reference2IntLinkedOpenHashMap.this, from.getKey());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Reference2IntLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Reference2IntMap.Entry<K>>
/*      */   {
/*  933 */     final AbstractReference2IntMap.BasicEntry<K> entry = new AbstractReference2IntMap.BasicEntry(null, 0);
/*      */ 
...
/*  939 */       int e = nextEntry();
/*  940 */       this.entry.key = Reference2IntLinkedOpenHashMap.this.key[e];
/*  941 */       this.entry.value = Reference2IntLinkedOpenHashMap.this.value[e];
/*  942 */       return this.entry;
/*      */     }
/*      */     public AbstractReference2IntMap.BasicEntry<K> previous() {
/*  945 */       int e = previousEntry();
/*  946 */       this.entry.key = Reference2IntLinkedOpenHashMap.this.key[e];
/*  947 */       this.entry.value = Reference2IntLinkedOpenHashMap.this.value[e];
/*  948 */       return this.entry;
/*      */     }
/*  950 */     public void set(Reference2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  951 */     public void add(Reference2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Reference2IntLinkedOpenHashMap<K>.MapIterator
/*      */     implements ObjectListIterator<Reference2IntMap.Entry<K>>
/*      */   {
...
/*  919 */       return this.entry = new Reference2IntLinkedOpenHashMap.MapEntry(Reference2IntLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Reference2IntLinkedOpenHashMap<K>.MapEntry previous() {
/*  922 */       return this.entry = new Reference2IntLinkedOpenHashMap.MapEntry(Reference2IntLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  926 */       super.remove();
/*  927 */       Reference2IntLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  929 */     public void set(Reference2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); } 
/*  930 */     public void add(Reference2IntMap.Entry<K> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  791 */     int index = -1;
/*      */ 
/*  793 */     private MapIterator() { this.next = Reference2IntLinkedOpenHashMap.this.first;
/*  794 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator() {
/*  797 */       if (Reference2IntLinkedOpenHashMap.this.key[Reference2IntLinkedOpenHashMap.this.last] == from) {
/*  798 */         this.prev = Reference2IntLinkedOpenHashMap.this.last;
/*  799 */         this.index = Reference2IntLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  803 */         int pos = (from == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(from))) & Reference2IntLinkedOpenHashMap.this.mask;
/*      */ 
/*  805 */         while (Reference2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  806 */           if (Reference2IntLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  808 */             this.next = ((int)Reference2IntLinkedOpenHashMap.this.link[pos]);
/*  809 */             this.prev = pos;
/*  810 */             return;
/*      */           }
/*  812 */           pos = pos + 1 & Reference2IntLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  825 */       if (this.next == -1) {
/*  826 */         this.index = Reference2IntLinkedOpenHashMap.this.size;
/*  827 */         return;
/*      */       }
/*  829 */       int pos = Reference2IntLinkedOpenHashMap.this.first;
/*  830 */       this.index = 1;
/*  831 */       while (pos != this.prev) {
/*  832 */         pos = (int)Reference2IntLinkedOpenHashMap.this.link[pos];
/*  833 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  845 */       if (!hasNext()) return Reference2IntLinkedOpenHashMap.this.size();
/*  846 */       this.curr = this.next;
/*  847 */       this.next = ((int)Reference2IntLinkedOpenHashMap.this.link[this.curr]);
...
/*  855 */       this.prev = ((int)(Reference2IntLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  867 */         this.index -= 1;
/*  868 */         this.prev = ((int)(Reference2IntLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  871 */         this.next = ((int)Reference2IntLinkedOpenHashMap.this.link[this.curr]);
/*  872 */       }Reference2IntLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  875 */       if (this.prev == -1) Reference2IntLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  877 */         Reference2IntLinkedOpenHashMap.this.link[this.prev] ^= (Reference2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  878 */       if (this.next == -1) Reference2IntLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  880 */         Reference2IntLinkedOpenHashMap.this.link[this.next] ^= (Reference2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  884 */         pos = (last = pos) + 1 & Reference2IntLinkedOpenHashMap.this.mask;
/*  885 */         while (Reference2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  886 */           int slot = (Reference2IntLinkedOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2IntLinkedOpenHashMap.this.key[pos]))) & Reference2IntLinkedOpenHashMap.this.mask;
/*  887 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  888 */           pos = pos + 1 & Reference2IntLinkedOpenHashMap.this.mask;
/*      */         }
/*  890 */         if (Reference2IntLinkedOpenHashMap.this.used[pos] == 0) break;
/*  891 */         Reference2IntLinkedOpenHashMap.this.key[last] = Reference2IntLinkedOpenHashMap.this.key[pos];
/*  892 */         Reference2IntLinkedOpenHashMap.this.value[last] = Reference2IntLinkedOpenHashMap.this.value[pos];
/*  893 */         if (this.next == pos) this.next = last;
/*  894 */         if (this.prev == pos) this.prev = last;
/*  895 */         Reference2IntLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  897 */       Reference2IntLinkedOpenHashMap.this.used[last] = false;
/*  898 */       Reference2IntLinkedOpenHashMap.this.key[last] = null;
/*  899 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public K getKey() {
/*  660 */       return Reference2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Integer getValue() {
/*  663 */       return Integer.valueOf(Reference2IntLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public int getIntValue() {
/*  666 */       return Reference2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public int setValue(int v) {
/*  669 */       int oldValue = Reference2IntLinkedOpenHashMap.this.value[this.index];
/*  670 */       Reference2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  671 */       return oldValue;
/*      */     }
/*      */     public Integer setValue(Integer v) {
/*  674 */       return Integer.valueOf(setValue(v.intValue()));
/*      */     }
/*      */ 
/*      */     public boolean equals(Object o) {
/*  678 */       if (!(o instanceof Map.Entry)) return false;
/*  679 */       Map.Entry e = (Map.Entry)o;
/*  680 */       return (Reference2IntLinkedOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */     public int hashCode() {
/*  683 */       return (Reference2IntLinkedOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2IntLinkedOpenHashMap.this.key[this.index])) ^ Reference2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  686 */       return Reference2IntLinkedOpenHashMap.this.key[this.index] + "=>" + Reference2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
