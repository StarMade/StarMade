...
/* 555 */           return new Reference2ObjectOpenHashMap.ValueIterator(Reference2ObjectOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 558 */           return Reference2ObjectOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 561 */           return Reference2ObjectOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 564 */           Reference2ObjectOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 679 */       c = (Reference2ObjectOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Reference2ObjectOpenHashMap<K, V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 549 */       super(null); } 
/* 550 */     public V next() { return Reference2ObjectOpenHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 521 */       return new Reference2ObjectOpenHashMap.KeyIterator(Reference2ObjectOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 524 */       return Reference2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 527 */       return Reference2ObjectOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 530 */       int oldSize = Reference2ObjectOpenHashMap.this.size;
/* 531 */       Reference2ObjectOpenHashMap.this.remove(k);
/* 532 */       return Reference2ObjectOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 535 */       Reference2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Reference2ObjectOpenHashMap<K, V>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 516 */       super(null); } 
/* 517 */     public K next() { return Reference2ObjectOpenHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 462 */       return new Reference2ObjectOpenHashMap.EntryIterator(Reference2ObjectOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Reference2ObjectMap.Entry<K, V>> fastIterator() {
/* 465 */       return new Reference2ObjectOpenHashMap.FastEntryIterator(Reference2ObjectOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 473 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ObjectOpenHashMap.this.mask;
/*     */ 
/* 475 */       while (Reference2ObjectOpenHashMap.this.used[pos] != 0) {
/* 476 */         if (Reference2ObjectOpenHashMap.this.key[pos] == k) return Reference2ObjectOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Reference2ObjectOpenHashMap.this.value[pos].equals(e.getValue());
/* 477 */         pos = pos + 1 & Reference2ObjectOpenHashMap.this.mask;
/*     */       }
/* 479 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 487 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ObjectOpenHashMap.this.mask;
/*     */ 
/* 489 */       while (Reference2ObjectOpenHashMap.this.used[pos] != 0) {
/* 490 */         if (Reference2ObjectOpenHashMap.this.key[pos] == k) {
/* 491 */           Reference2ObjectOpenHashMap.this.remove(e.getKey());
/* 492 */           return true;
/*     */         }
/* 494 */         pos = pos + 1 & Reference2ObjectOpenHashMap.this.mask;
/*     */       }
/* 496 */       return false;
/*     */     }
/*     */     public int size() {
/* 499 */       return Reference2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 502 */       Reference2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Reference2ObjectOpenHashMap<K, V>.MapIterator
/*     */     implements ObjectIterator<Reference2ObjectMap.Entry<K, V>>
/*     */   {
/* 452 */     final AbstractReference2ObjectMap.BasicEntry<K, V> entry = new AbstractReference2ObjectMap.BasicEntry(null, null);
/*     */ 
...
/* 454 */       int e = nextEntry();
/* 455 */       this.entry.key = Reference2ObjectOpenHashMap.this.key[e];
/* 456 */       this.entry.value = Reference2ObjectOpenHashMap.this.value[e];
/* 457 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Reference2ObjectOpenHashMap<K, V>.MapIterator
/*     */     implements ObjectIterator<Reference2ObjectMap.Entry<K, V>>
/*     */   {
...
/* 443 */       return this.entry = new Reference2ObjectOpenHashMap.MapEntry(Reference2ObjectOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 447 */       super.remove();
/* 448 */       Reference2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 347 */       this.pos = Reference2ObjectOpenHashMap.this.n;
/*     */ 
/* 350 */       this.last = -1;
/*     */ 
/* 352 */       this.c = Reference2ObjectOpenHashMap.this.size;
/*     */ 
/* 357 */       boolean[] used = Reference2ObjectOpenHashMap.this.used;
...
/*     */ 
/* 370 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2ObjectOpenHashMap.this.mask;
/*     */ 
/* 372 */         while (Reference2ObjectOpenHashMap.this.used[pos] != 0) {
/* 373 */           if (Reference2ObjectOpenHashMap.this.key[pos] == k) return pos;
/* 374 */           pos = pos + 1 & Reference2ObjectOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 377 */       this.last = this.pos;
/*     */ 
/* 379 */       if (this.c != 0) {
/* 380 */         boolean[] used = Reference2ObjectOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 397 */         pos = (last = pos) + 1 & Reference2ObjectOpenHashMap.this.mask;
/* 398 */         while (Reference2ObjectOpenHashMap.this.used[pos] != 0) {
/* 399 */           int slot = (Reference2ObjectOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ObjectOpenHashMap.this.key[pos]))) & Reference2ObjectOpenHashMap.this.mask;
/* 400 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 401 */           pos = pos + 1 & Reference2ObjectOpenHashMap.this.mask;
/*     */         }
/* 403 */         if (Reference2ObjectOpenHashMap.this.used[pos] == 0) break;
/* 404 */         if (pos < last)
/*     */         {
/* 406 */           if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 407 */           this.wrapped.add(Reference2ObjectOpenHashMap.this.key[pos]);
/*     */         }
/* 409 */         Reference2ObjectOpenHashMap.this.key[last] = Reference2ObjectOpenHashMap.this.key[pos];
/* 410 */         Reference2ObjectOpenHashMap.this.value[last] = Reference2ObjectOpenHashMap.this.value[pos];
/*     */       }
/* 412 */       Reference2ObjectOpenHashMap.this.used[last] = false;
/* 413 */       Reference2ObjectOpenHashMap.this.key[last] = null;
/* 414 */       Reference2ObjectOpenHashMap.this.value[last] = null;
/* 415 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 420 */       if (this.pos < -1)
/*     */       {
/* 422 */         Reference2ObjectOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 423 */         this.last = -1;
/* 424 */         return;
/*     */       }
/* 426 */       Reference2ObjectOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 320 */       return Reference2ObjectOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 323 */       return Reference2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 326 */       Object oldValue = Reference2ObjectOpenHashMap.this.value[this.index];
/* 327 */       Reference2ObjectOpenHashMap.this.value[this.index] = v;
/* 328 */       return oldValue;
/*     */     }
/*     */ 
...
/* 334 */       return (Reference2ObjectOpenHashMap.this.key[this.index] == e.getKey()) && (Reference2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Reference2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
/* 337 */       return (Reference2ObjectOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ObjectOpenHashMap.this.key[this.index])) ^ (Reference2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Reference2ObjectOpenHashMap.this.value[this.index].hashCode());
/*     */     }
/*     */     public String toString() {
/* 340 */       return Reference2ObjectOpenHashMap.this.key[this.index] + "=>" + Reference2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
