  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Reference2ObjectOpenHashMap(int expected, float local_f)
  {
  ...
  public Reference2ObjectOpenHashMap(Map<? extends K, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2ObjectOpenHashMap(Map<? extends K, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2ObjectOpenHashMap(Reference2ObjectMap<K, V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Reference2ObjectOpenHashMap(Reference2ObjectMap<K, V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Reference2ObjectOpenHashMap(K[] local_k, V[] local_v, float local_f)
  {
  ...
  public Reference2ObjectOpenHashMap(K[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Reference2ObjectOpenHashMap.ValueIterator(Reference2ObjectOpenHashMap.this);
        }
        ...
        {
          return Reference2ObjectOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Reference2ObjectOpenHashMap<K, V> local_c;
    try
    {
      local_c = (Reference2ObjectOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    K[] key = this.key;
    V[] value = this.value;
    Reference2ObjectOpenHashMap<K, V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractReferenceSet<K>
  {
    ...
    {
      return new Reference2ObjectOpenHashMap.KeyIterator(Reference2ObjectOpenHashMap.this);
    }
    ...
    {
      return Reference2ObjectOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(Object local_k)
    {
      int oldSize = Reference2ObjectOpenHashMap.this.size;
      Reference2ObjectOpenHashMap.this.remove(local_k);
    ...
    implements Reference2ObjectMap.FastEntrySet<K, V>
  {
    ...
    {
      return new Reference2ObjectOpenHashMap.EntryIterator(Reference2ObjectOpenHashMap.this, null);
    }
    
    public ObjectIterator<Reference2ObjectMap.Entry<K, V>> fastIterator()
    {
      return new Reference2ObjectOpenHashMap.FastEntryIterator(Reference2ObjectOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2ObjectOpenHashMap.this.mask; Reference2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ObjectOpenHashMap.this.mask) {
        if (Reference2ObjectOpenHashMap.this.key[pos] == local_k) {
          return Reference2ObjectOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Reference2ObjectOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (local_k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(local_k))) & Reference2ObjectOpenHashMap.this.mask; Reference2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ObjectOpenHashMap.this.mask) {
        if (Reference2ObjectOpenHashMap.this.key[pos] == local_k)
        {
          Reference2ObjectOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Reference2ObjectMap.Entry<K, V>>
  {
    ...
    public AbstractReference2ObjectMap.BasicEntry<K, V> next()
    {
      ...
      this.entry.key = Reference2ObjectOpenHashMap.this.key[local_e];
      this.entry.value = Reference2ObjectOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Reference2ObjectMap.Entry<K, V>>
  {
    ...
    {
      return this.entry = new Reference2ObjectOpenHashMap.MapEntry(Reference2ObjectOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Reference2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Reference2ObjectOpenHashMap.this.field_49;
    int last = -1;
    int field_2044 = Reference2ObjectOpenHashMap.this.size;
    ReferenceArrayList<K> wrapped;
    
    private MapIterator()
    {
      boolean[] used = Reference2ObjectOpenHashMap.this.used;
      while ((this.field_2044 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2044 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2044 != 0)
      {
        boolean[] local_k = Reference2ObjectOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Reference2ObjectOpenHashMap.this.mask; Reference2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Reference2ObjectOpenHashMap.this.mask)
        {
          int slot = (Reference2ObjectOpenHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2ObjectOpenHashMap.this.key[pos]))) & Reference2ObjectOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Reference2ObjectOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Reference2ObjectOpenHashMap.this.key[pos]);
        }
        Reference2ObjectOpenHashMap.this.key[last] = Reference2ObjectOpenHashMap.this.key[pos];
        Reference2ObjectOpenHashMap.this.value[last] = Reference2ObjectOpenHashMap.this.value[pos];
      }
      Reference2ObjectOpenHashMap.this.used[last] = false;
      Reference2ObjectOpenHashMap.this.key[last] = null;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Reference2ObjectOpenHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
        this.last = -1;
        return;
      }
      Reference2ObjectOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2044 > 0))
      {
        this.field_2044 += 1;
        nextEntry();
      }
    ...
    implements Reference2ObjectMap.Entry<K, V>, Map.Entry<K, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Reference2ObjectOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<K, V> local_e = (Map.Entry)local_o;
      return (Reference2ObjectOpenHashMap.this.key[this.index] == local_e.getKey()) && (Reference2ObjectOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Reference2ObjectOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
    
    public int hashCode()
    {
      return (Reference2ObjectOpenHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2ObjectOpenHashMap.this.key[this.index])) ^ (Reference2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Reference2ObjectOpenHashMap.this.value[this.index].hashCode());
    }
