...
/* 619 */           return new Reference2CharOpenCustomHashMap.ValueIterator(Reference2CharOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 622 */           return Reference2CharOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(char v) {
/* 625 */           return Reference2CharOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 628 */           Reference2CharOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 743 */       c = (Reference2CharOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Reference2CharOpenCustomHashMap.MapIterator
/*     */     implements CharIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 612 */       super(null); } 
/* 613 */     public char nextChar() { return Reference2CharOpenCustomHashMap.this.value[nextEntry()]; } 
/* 614 */     public Character next() { return Character.valueOf(Reference2CharOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 584 */       return new Reference2CharOpenCustomHashMap.KeyIterator(Reference2CharOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 587 */       return Reference2CharOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(Object k) {
/* 590 */       return Reference2CharOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(Object k) {
/* 593 */       int oldSize = Reference2CharOpenCustomHashMap.this.size;
/* 594 */       Reference2CharOpenCustomHashMap.this.remove(k);
/* 595 */       return Reference2CharOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 598 */       Reference2CharOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Reference2CharOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<K>
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 579 */       super(null); } 
/* 580 */     public K next() { return Reference2CharOpenCustomHashMap.this.key[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 525 */       return new Reference2CharOpenCustomHashMap.EntryIterator(Reference2CharOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Reference2CharMap.Entry<K>> fastIterator() {
/* 528 */       return new Reference2CharOpenCustomHashMap.FastEntryIterator(Reference2CharOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 536 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2CharOpenCustomHashMap.this.mask;
/*     */ 
/* 538 */       while (Reference2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 539 */         if (Reference2CharOpenCustomHashMap.this.strategy.equals(Reference2CharOpenCustomHashMap.this.key[pos], k)) return Reference2CharOpenCustomHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 540 */         pos = pos + 1 & Reference2CharOpenCustomHashMap.this.mask;
/*     */       }
/* 542 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 550 */       int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2CharOpenCustomHashMap.this.mask;
/*     */ 
/* 552 */       while (Reference2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 553 */         if (Reference2CharOpenCustomHashMap.this.strategy.equals(Reference2CharOpenCustomHashMap.this.key[pos], k)) {
/* 554 */           Reference2CharOpenCustomHashMap.this.remove(e.getKey());
/* 555 */           return true;
/*     */         }
/* 557 */         pos = pos + 1 & Reference2CharOpenCustomHashMap.this.mask;
/*     */       }
/* 559 */       return false;
/*     */     }
/*     */     public int size() {
/* 562 */       return Reference2CharOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 565 */       Reference2CharOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Reference2CharOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2CharMap.Entry<K>>
/*     */   {
/* 515 */     final AbstractReference2CharMap.BasicEntry<K> entry = new AbstractReference2CharMap.BasicEntry(null, '\000');
/*     */ 
...
/* 517 */       int e = nextEntry();
/* 518 */       this.entry.key = Reference2CharOpenCustomHashMap.this.key[e];
/* 519 */       this.entry.value = Reference2CharOpenCustomHashMap.this.value[e];
/* 520 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Reference2CharOpenCustomHashMap<K>.MapIterator
/*     */     implements ObjectIterator<Reference2CharMap.Entry<K>>
/*     */   {
...
/* 506 */       return this.entry = new Reference2CharOpenCustomHashMap.MapEntry(Reference2CharOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 510 */       super.remove();
/* 511 */       Reference2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 411 */       this.pos = Reference2CharOpenCustomHashMap.this.n;
/*     */ 
/* 414 */       this.last = -1;
/*     */ 
/* 416 */       this.c = Reference2CharOpenCustomHashMap.this.size;
/*     */ 
/* 421 */       boolean[] used = Reference2CharOpenCustomHashMap.this.used;
...
/*     */ 
/* 434 */         int pos = (k == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(k))) & Reference2CharOpenCustomHashMap.this.mask;
/*     */ 
/* 436 */         while (Reference2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 437 */           if (Reference2CharOpenCustomHashMap.this.strategy.equals(Reference2CharOpenCustomHashMap.this.key[pos], k)) return pos;
/* 438 */           pos = pos + 1 & Reference2CharOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 441 */       this.last = this.pos;
/*     */ 
/* 443 */       if (this.c != 0) {
/* 444 */         boolean[] used = Reference2CharOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 461 */         pos = (last = pos) + 1 & Reference2CharOpenCustomHashMap.this.mask;
/* 462 */         while (Reference2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 463 */           int slot = (Reference2CharOpenCustomHashMap.this.key[pos] == null ? 142593372 : HashCommon.murmurHash3(System.identityHashCode(Reference2CharOpenCustomHashMap.this.key[pos]))) & Reference2CharOpenCustomHashMap.this.mask;
/* 464 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 465 */           pos = pos + 1 & Reference2CharOpenCustomHashMap.this.mask;
/*     */         }
/* 467 */         if (Reference2CharOpenCustomHashMap.this.used[pos] == 0) break;
/* 468 */         if (pos < last)
/*     */         {
/* 470 */           if (this.wrapped == null) this.wrapped = new ReferenceArrayList();
/* 471 */           this.wrapped.add(Reference2CharOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 473 */         Reference2CharOpenCustomHashMap.this.key[last] = Reference2CharOpenCustomHashMap.this.key[pos];
/* 474 */         Reference2CharOpenCustomHashMap.this.value[last] = Reference2CharOpenCustomHashMap.this.value[pos];
/*     */       }
/* 476 */       Reference2CharOpenCustomHashMap.this.used[last] = false;
/* 477 */       Reference2CharOpenCustomHashMap.this.key[last] = null;
/* 478 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 483 */       if (this.pos < -1)
/*     */       {
/* 485 */         Reference2CharOpenCustomHashMap.this.remove(this.wrapped.set(-this.pos - 2, null));
/* 486 */         this.last = -1;
/* 487 */         return;
/*     */       }
/* 489 */       Reference2CharOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public K getKey() {
/* 378 */       return Reference2CharOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Character getValue() {
/* 381 */       return Character.valueOf(Reference2CharOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public char getCharValue() {
/* 384 */       return Reference2CharOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public char setValue(char v) {
/* 387 */       char oldValue = Reference2CharOpenCustomHashMap.this.value[this.index];
/* 388 */       Reference2CharOpenCustomHashMap.this.value[this.index] = v;
/* 389 */       return oldValue;
/*     */     }
...
/* 398 */       return (Reference2CharOpenCustomHashMap.this.strategy.equals(Reference2CharOpenCustomHashMap.this.key[this.index], e.getKey())) && (Reference2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*     */     }
/*     */     public int hashCode() {
/* 401 */       return (Reference2CharOpenCustomHashMap.this.key[this.index] == null ? 0 : System.identityHashCode(Reference2CharOpenCustomHashMap.this.key[this.index])) ^ Reference2CharOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 404 */       return Reference2CharOpenCustomHashMap.this.key[this.index] + "=>" + Reference2CharOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
