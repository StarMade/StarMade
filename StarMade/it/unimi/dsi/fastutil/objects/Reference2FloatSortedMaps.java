...
/*     */   {
/* 162 */     return new Singleton(key, value.floatValue());
/*     */   }
/*     */ 
/*     */   public static <K> Reference2FloatSortedMap<K> singleton(K key, Float value, Comparator<? super K> comparator)
/*     */   {
/* 174 */     return new Singleton(key, value.floatValue(), comparator);
/*     */   }
/*     */ 
/*     */   public static <K> Reference2FloatSortedMap<K> singleton(K key, float value)
/*     */   {
...
/* 246 */     public ObjectSortedSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.reference2FloatEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() {
/* 248 */       return reference2FloatEntrySet(); } 
...
/* 250 */     public Reference2FloatSortedMap<K> subMap(K from, K to) { return new UnmodifiableSortedMap(this.sortedMap.subMap(from, to)); } 
/* 251 */     public Reference2FloatSortedMap<K> headMap(K to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 252 */     public Reference2FloatSortedMap<K> tailMap(K from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 212 */     public ObjectSortedSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.reference2FloatEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() {
/* 214 */       return reference2FloatEntrySet(); } 
...
/* 216 */     public Reference2FloatSortedMap<K> subMap(K from, K to) { return new SynchronizedSortedMap(this.sortedMap.subMap(from, to), this.sync); } 
/* 217 */     public Reference2FloatSortedMap<K> headMap(K to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 218 */     public Reference2FloatSortedMap<K> tailMap(K from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Reference2FloatMaps.Singleton.SingletonEntry(this), Reference2FloatSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() { return reference2FloatEntrySet(); } 
...
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Reference2FloatSortedMap<K> headMap(K to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Reference2FloatSortedMap<K> tailMap(K from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
...
/*  77 */       return null;
/*     */     }
/*  79 */     public ObjectSortedSet<Reference2FloatMap.Entry<K>> reference2FloatEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<K, Float>> entrySet() {
/*  81 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  83 */     public ReferenceSortedSet<K> keySet() { return ReferenceSortedSets.EMPTY_SET; } 
/*     */     public Reference2FloatSortedMap<K> subMap(K from, K to) {
/*  85 */       return Reference2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*  87 */     public Reference2FloatSortedMap<K> headMap(K to) { return Reference2FloatSortedMaps.EMPTY_MAP; } 
/*     */     public Reference2FloatSortedMap<K> tailMap(K from) {
/*  89 */       return Reference2FloatSortedMaps.EMPTY_MAP; } 
