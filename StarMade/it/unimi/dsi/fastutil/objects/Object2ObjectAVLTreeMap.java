...
/*  647 */       return true)
/*      */     {
/*  646 */       label16: Object ev = i.next();
/*  647 */       if (ev == null ? v != null : !ev.equals(v)) break label16;
/*      */     }
/*  649 */     return false;
/*      */   }
/*      */   public void clear() {
...
/*  985 */         final Comparator<? super Object2ObjectMap.Entry<K, V>> comparator = new Comparator() {
/*      */           public int compare(Object2ObjectMap.Entry<K, V> x, Object2ObjectMap.Entry<K, V> y) {
/*  987 */             return Object2ObjectAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/*  985 */         };
/*      */ 
...
/*  994 */           return new Object2ObjectAVLTreeMap.EntryIterator(Object2ObjectAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(Object2ObjectMap.Entry<K, V> from) {
/*  997 */           return new Object2ObjectAVLTreeMap.EntryIterator(Object2ObjectAVLTreeMap.this, from.getKey());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1001 */           if (!(o instanceof Map.Entry)) return false;
/* 1002 */           Map.Entry e = (Map.Entry)o;
/* 1003 */           Object2ObjectAVLTreeMap.Entry f = Object2ObjectAVLTreeMap.this.findKey(e.getKey());
...
/* 1010 */           Object2ObjectAVLTreeMap.Entry f = Object2ObjectAVLTreeMap.this.findKey(e.getKey());
/* 1011 */           if (f != null) Object2ObjectAVLTreeMap.this.remove(f.key);
/* 1012 */           return f != null;
/*      */         }
/* 1014 */         public int size() { return Object2ObjectAVLTreeMap.this.count; } 
/* 1015 */         public void clear() { Object2ObjectAVLTreeMap.this.clear(); } 
/* 1016 */         public Object2ObjectMap.Entry<K, V> first() { return Object2ObjectAVLTreeMap.this.firstEntry; } 
/* 1017 */         public Object2ObjectMap.Entry<K, V> last() { return Object2ObjectAVLTreeMap.this.lastEntry; } 
/* 1018 */         public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> from, Object2ObjectMap.Entry<K, V> to) { return Object2ObjectAVLTreeMap.this.subMap(from.getKey(), to.getKey()).object2ObjectEntrySet(); } 
/* 1019 */         public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) { return Object2ObjectAVLTreeMap.this.headMap(to.getKey()).object2ObjectEntrySet(); } 
/* 1020 */         public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) { return Object2ObjectAVLTreeMap.this.tailMap(from.getKey()).object2ObjectEntrySet(); }
/*      */       };
...
/*      */   {
/* 1076 */     if (this.values == null) this.values = new AbstractObjectCollection() {
/*      */         public ObjectIterator<V> iterator() {
/* 1078 */           return new Object2ObjectAVLTreeMap.ValueIterator(Object2ObjectAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1081 */           return Object2ObjectAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1084 */           return Object2ObjectAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1087 */           Object2ObjectAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1425 */       c = (Object2ObjectAVLTreeMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class Submap extends AbstractObject2ObjectSortedMap<K, V>
...
/*      */     {
/* 1140 */       if ((!bottom) && (!top) && (Object2ObjectAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1141 */       this.from = from;
/* 1142 */       this.bottom = bottom;
/* 1143 */       this.to = to;
/* 1144 */       this.top = top;
/* 1145 */       this.defRetValue = Object2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1159 */       return ((this.bottom) || (Object2ObjectAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Object2ObjectAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> object2ObjectEntrySet() {
/* 1163 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator() {
/* 1165 */             return new Object2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Object2ObjectAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Object2ObjectMap.Entry<K, V>> iterator(Object2ObjectMap.Entry<K, V> from) {
/* 1168 */             return new Object2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Object2ObjectAVLTreeMap.Submap.this, from.getKey());
/*      */           }
/* 1170 */           public Comparator<? super Object2ObjectMap.Entry<K, V>> comparator() { return Object2ObjectAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1173 */             if (!(o instanceof Map.Entry)) return false;
/* 1174 */             Map.Entry e = (Map.Entry)o;
/* 1175 */             Object2ObjectAVLTreeMap.Entry f = Object2ObjectAVLTreeMap.this.findKey(e.getKey());
/* 1176 */             return (f != null) && (Object2ObjectAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1180 */             if (!(o instanceof Map.Entry)) return false;
/* 1181 */             Map.Entry e = (Map.Entry)o;
/* 1182 */             Object2ObjectAVLTreeMap.Entry f = Object2ObjectAVLTreeMap.this.findKey(e.getKey());
/* 1183 */             if ((f != null) && (Object2ObjectAVLTreeMap.Submap.this.in(f.key))) Object2ObjectAVLTreeMap.Submap.this.remove(f.key);
/* 1184 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1187 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1192 */             return !new Object2ObjectAVLTreeMap.Submap.SubmapIterator(Object2ObjectAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1195 */             Object2ObjectAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1197 */           public Object2ObjectMap.Entry<K, V> first() { return Object2ObjectAVLTreeMap.Submap.this.firstEntry(); } 
/* 1198 */           public Object2ObjectMap.Entry<K, V> last() { return Object2ObjectAVLTreeMap.Submap.this.lastEntry(); } 
/* 1199 */           public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> subSet(Object2ObjectMap.Entry<K, V> from, Object2ObjectMap.Entry<K, V> to) { return Object2ObjectAVLTreeMap.Submap.this.subMap(from.getKey(), to.getKey()).object2ObjectEntrySet(); } 
/* 1200 */           public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> headSet(Object2ObjectMap.Entry<K, V> to) { return Object2ObjectAVLTreeMap.Submap.this.headMap(to.getKey()).object2ObjectEntrySet(); } 
/* 1201 */           public ObjectSortedSet<Object2ObjectMap.Entry<K, V>> tailSet(Object2ObjectMap.Entry<K, V> from) { return Object2ObjectAVLTreeMap.Submap.this.tailMap(from.getKey()).object2ObjectEntrySet(); }
/*      */         };
...
/*      */     }
/*      */     public ObjectCollection<V> values() {
/* 1214 */       if (this.values == null) this.values = new AbstractObjectCollection() {
/*      */           public ObjectIterator<V> iterator() {
/* 1216 */             return new Object2ObjectAVLTreeMap.Submap.SubmapValueIterator(Object2ObjectAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1219 */             return Object2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1222 */             return Object2ObjectAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1225 */             Object2ObjectAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(Object k) {
/* 1232 */       return (in(k)) && (Object2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/* 1239 */         return true)
/*      */       {
/* 1238 */         label9: Object ev = i.nextEntry().value;
/* 1239 */         if (ev == null ? v != null : !ev.equals(v)) break label9;
/*      */       }
/* 1241 */       return false;
/*      */     }
/*      */ 
...
/*      */     {
/* 1246 */       Object kk = k;
/*      */       Object2ObjectAVLTreeMap.Entry e;
/* 1247 */       return (in(kk)) && ((e = Object2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(K k, V v) {
/* 1250 */       Object2ObjectAVLTreeMap.this.modified = false;
...
/* 1252 */       Object oldValue = Object2ObjectAVLTreeMap.this.put(k, v);
/* 1253 */       return Object2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(Object k) {
/* 1257 */       Object2ObjectAVLTreeMap.this.modified = false;
/* 1258 */       if (!in(k)) return this.defRetValue;
/* 1259 */       Object oldValue = Object2ObjectAVLTreeMap.this.remove(k);
/* 1260 */       return Object2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public Comparator<? super K> comparator() {
/* 1275 */       return Object2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Object2ObjectSortedMap<K, V> headMap(K to) {
/* 1278 */       if (this.top) return new Submap(Object2ObjectAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1279 */       return Object2ObjectAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Object2ObjectAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Object2ObjectSortedMap<K, V> tailMap(K from) {
/* 1282 */       if (this.bottom) return new Submap(Object2ObjectAVLTreeMap.this, from, false, this.to, this.top);
/* 1283 */       return Object2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Object2ObjectAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Object2ObjectSortedMap<K, V> subMap(K from, K to) {
/* 1286 */       if ((this.top) && (this.bottom)) return new Submap(Object2ObjectAVLTreeMap.this, from, false, to, false);
/* 1287 */       if (!this.top) to = Object2ObjectAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1288 */       if (!this.bottom) from = Object2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1289 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1290 */       return new Submap(Object2ObjectAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Object2ObjectAVLTreeMap.Entry<K, V> firstEntry()
/*      */     {
/* 1297 */       if (Object2ObjectAVLTreeMap.this.tree == null) return null;
/* 1300 */       Object2ObjectAVLTreeMap.Entry e;
/*      */       Object2ObjectAVLTreeMap.Entry e;
/* 1300 */       if (this.bottom) { e = Object2ObjectAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1302 */         e = Object2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1304 */         if (Object2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1307 */       if ((e == null) || ((!this.top) && (Object2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1308 */       return e;
/*      */     }
/*      */ 
/*      */     public Object2ObjectAVLTreeMap.Entry<K, V> lastEntry()
/*      */     {
/* 1315 */       if (Object2ObjectAVLTreeMap.this.tree == null) return null;
/* 1318 */       Object2ObjectAVLTreeMap.Entry e;
/*      */       Object2ObjectAVLTreeMap.Entry e;
/* 1318 */       if (this.top) { e = Object2ObjectAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1320 */         e = Object2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1322 */         if (Object2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1325 */       if ((e == null) || ((!this.bottom) && (Object2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1326 */       return e;
/*      */     }
/*      */     public K firstKey() {
/* 1329 */       Object2ObjectAVLTreeMap.Entry e = firstEntry();
/* 1330 */       if (e == null) throw new NoSuchElementException();
/* 1331 */       return e.key;
/*      */     }
/*      */     public K lastKey() {
/* 1334 */       Object2ObjectAVLTreeMap.Entry e = lastEntry();
/* 1335 */       if (e == null) throw new NoSuchElementException();
/* 1336 */       return e.key;
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Object2ObjectAVLTreeMap<K, V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Object2ObjectAVLTreeMap<K, V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Object2ObjectAVLTreeMap<K, V>.Submap.SubmapIterator
...
/* 1379 */       public Object2ObjectMap.Entry<K, V> previous() { return previousEntry(); } 
/* 1380 */       public void set(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/* 1381 */       public void add(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Object2ObjectAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1346 */         super();
/* 1347 */         this.next = Object2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator() {
/* 1350 */         this();
/* 1351 */         if (this.next != null)
/* 1352 */           if ((!Object2ObjectAVLTreeMap.Submap.this.bottom) && (Object2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1353 */           } else if ((!Object2ObjectAVLTreeMap.Submap.this.top) && (Object2ObjectAVLTreeMap.this.compare(k, (this.prev = Object2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1355 */             this.next = Object2ObjectAVLTreeMap.this.locateKey(k);
/* 1356 */             if (Object2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1366 */         if ((!Object2ObjectAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Object2ObjectAVLTreeMap.this.compare(this.prev.key, Object2ObjectAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1369 */         this.next = this.next.next();
/* 1370 */         if ((!Object2ObjectAVLTreeMap.Submap.this.top) && (this.next != null) && (Object2ObjectAVLTreeMap.this.compare(this.next.key, Object2ObjectAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1205 */         super(); } 
/* 1206 */       public ObjectBidirectionalIterator<K> iterator() { return new Object2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Object2ObjectAVLTreeMap.Submap.this); } 
/* 1207 */       public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Object2ObjectAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Object2ObjectAVLTreeMap<K, V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1039 */       super(); } 
/* 1040 */     public ObjectBidirectionalIterator<K> iterator() { return new Object2ObjectAVLTreeMap.KeyIterator(Object2ObjectAVLTreeMap.this); } 
/* 1041 */     public ObjectBidirectionalIterator<K> iterator(K from) { return new Object2ObjectAVLTreeMap.KeyIterator(Object2ObjectAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Object2ObjectAVLTreeMap<K, V>.TreeIterator
/*      */     implements ObjectListIterator<K>
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Object2ObjectAVLTreeMap<K, V>.TreeIterator
/*      */     implements ObjectListIterator<Object2ObjectMap.Entry<K, V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/*  979 */     public Object2ObjectMap.Entry<K, V> previous() { return previousEntry(); } 
/*  980 */     public void set(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); } 
/*  981 */     public void add(Object2ObjectMap.Entry<K, V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  906 */     int index = 0;
/*      */ 
/*  908 */     TreeIterator() { this.next = Object2ObjectAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator() {
/*  911 */       if ((this.next = Object2ObjectAVLTreeMap.this.locateKey(k)) != null)
/*  912 */         if (Object2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/*  953 */       updatePrevious();
/*  954 */       updateNext();
/*  955 */       Object2ObjectAVLTreeMap.this.remove(this.curr.key);
/*  956 */       this.curr = null;
/*      */     }
...
/*  831 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  834 */       return (this.key == null ? 0 : this.key.hashCode()) ^ (this.value == null ? 0 : this.value.hashCode());
/*      */     }
