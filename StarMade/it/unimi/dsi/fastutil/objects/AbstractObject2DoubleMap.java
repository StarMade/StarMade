...
/*  13:    */
/*  60:    */public abstract class AbstractObject2DoubleMap<K>
/*  61:    */  extends AbstractObject2DoubleFunction<K>
/*  62:    */  implements Object2DoubleMap<K>, Serializable
/*  63:    */{
...
/*  88: 88 */    if ((m instanceof Object2DoubleMap))
/*  89:    */    {
/*  90: 90 */      while (n-- != 0) {
/*  91: 91 */        Object2DoubleMap.Entry<? extends K> e = (Object2DoubleMap.Entry)i.next();
...
/* 109:    */    implements Object2DoubleMap.Entry<K>
/* 110:    */  {
/* 111:    */    protected K key;
...
/* 162:    */      
/* 163:163 */      return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Double)e.getValue()).doubleValue());
/* 164:    */    }
/* 165:    */    
/* 166:    */    public int hashCode() {
/* 167:167 */      return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.double2int(this.value);
/* 168:    */    }
/* 169:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(Object k) { return AbstractObject2DoubleMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractObject2DoubleMap.this.size(); }
/* 196:196 */      public void clear() { AbstractObject2DoubleMap.this.clear(); }
/* 197:    */      
/* 198:    */      public ObjectIterator<K> iterator() {
/* 199:199 */        new AbstractObjectIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<K, Double>> i = AbstractObject2DoubleMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public K next() { return ((Object2DoubleMap.Entry)this.i.next()).getKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(double k) { return AbstractObject2DoubleMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractObject2DoubleMap.this.size(); }
/* 229:229 */      public void clear() { AbstractObject2DoubleMap.this.clear(); }
/* 230:    */      
/* 231:    */      public DoubleIterator iterator() {
/* 232:232 */        new AbstractDoubleIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<K, Double>> i = AbstractObject2DoubleMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public double nextDouble() { return ((Object2DoubleMap.Entry)this.i.next()).getDoubleValue(); }
/* 236:    */          
...
/* 245:    */  {
/* 246:246 */    return object2DoubleEntrySet();
/* 247:    */  }
/* 248:    */  
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Object2DoubleMap.Entry<K> e = (Object2DoubleMap.Entry)i.next();
/* 290:    */      
