...
/*  88 */     if ((m instanceof Object2DoubleMap))
/*     */     {
/*  90 */       while (n-- != 0) {
/*  91 */         Object2DoubleMap.Entry e = (Object2DoubleMap.Entry)i.next();
...
/* 193 */         return AbstractObject2DoubleMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractObject2DoubleMap.this.size(); } 
/* 196 */       public void clear() { AbstractObject2DoubleMap.this.clear(); }
/*     */ 
/*     */       public ObjectIterator<K> iterator() {
/* 199 */         return new AbstractObjectIterator() {
/* 200 */           final ObjectIterator<Map.Entry<K, Double>> i = AbstractObject2DoubleMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public K next() { return ((Object2DoubleMap.Entry)this.i.next()).getKey(); } 
...
/* 226 */         return AbstractObject2DoubleMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractObject2DoubleMap.this.size(); } 
/* 229 */       public void clear() { AbstractObject2DoubleMap.this.clear(); }
/*     */ 
/*     */       public DoubleIterator iterator() {
/* 232 */         return new AbstractDoubleIterator() {
/* 233 */           final ObjectIterator<Map.Entry<K, Double>> i = AbstractObject2DoubleMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public double nextDouble() { return ((Object2DoubleMap.Entry)this.i.next()).getDoubleValue(); } 
/*     */           public boolean hasNext() {
...
/*     */   {
/* 246 */     return object2DoubleEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Object2DoubleMap.Entry e = (Object2DoubleMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == null ? e.getKey() == null : this.key.equals(e.getKey())) && (this.value == ((Double)e.getValue()).doubleValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
/* 167 */       return (this.key == null ? 0 : this.key.hashCode()) ^ HashCommon.double2int(this.value);
/*     */     }
/*     */ 
/*     */     public String toString()
/*     */     {
