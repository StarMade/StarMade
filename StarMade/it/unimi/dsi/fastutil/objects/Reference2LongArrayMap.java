...
/*  14:    */
/*  65:    */public class Reference2LongArrayMap<K>
/*  66:    */  extends AbstractReference2LongMap<K>
...
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Reference2LongArrayMap(Object[] key, long[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Reference2LongArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = ObjectArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = LongArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Reference2LongArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new Object[capacity];
/*  93: 93 */    this.value = new long[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Reference2LongArrayMap(Reference2LongMap<K> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Reference2LongArrayMap(Map<? extends K, ? extends Long> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Reference2LongArrayMap(Object[] key, long[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Reference2LongMap.Entry<K>> implements Reference2LongMap.FastEntrySet<K> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Reference2LongMap.Entry<K>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Reference2LongArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Reference2LongMap.Entry<K> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractReference2LongMap.BasicEntry(Reference2LongArrayMap.this.key[this.next], Reference2LongArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Reference2LongMap.Entry<K>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractReference2LongMap.BasicEntry<K> entry = new AbstractReference2LongMap.BasicEntry(null, 0L);
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Reference2LongArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Reference2LongMap.Entry<K> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Reference2LongArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Reference2LongArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Reference2LongArrayMap.this.size; }
/* 159:    */    
...
/* 165:165 */      return (Reference2LongArrayMap.this.containsKey(k)) && (Reference2LongArrayMap.this.get(k).longValue() == ((Long)e.getValue()).longValue());
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Reference2LongMap.FastEntrySet<K> reference2LongEntrySet() { return new EntrySet(null); }
/* 170:    */  
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Reference2LongArrayMap<K> clone()
/* 293:    */  {
/* 294:    */    Reference2LongArrayMap<K> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Reference2LongArrayMap)super.clone();
/* 301:    */    }
