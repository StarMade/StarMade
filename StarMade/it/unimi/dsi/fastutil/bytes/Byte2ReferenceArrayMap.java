...
/*     */ 
/*     */ public class Byte2ReferenceArrayMap<V> extends AbstractByte2ReferenceMap<V>
...
/* 235 */       byte[] newKey = new byte[this.size == 0 ? 2 : this.size * 2];
...
/*     */   {
/* 280 */     return new ByteArraySet(this.key, this.size);
/*     */   }
/*     */ 
...
/*     */     try
/*     */     {
/* 300 */       c = (Byte2ReferenceArrayMap)super.clone();
/*     */     }
/*     */     catch (CloneNotSupportedException cantHappen) {
/* 303 */       throw new InternalError();
/*     */     }
/* 305 */     c.key = ((byte[])this.key.clone());
...
/* 321 */     this.key = new byte[this.size];
/* 322 */     this.value = new Object[this.size];
/* 323 */     for (int i = 0; i < this.size; i++) {
/* 324 */       this.key[i] = s.readByte();
/* 325 */       this.value[i] = s.readObject();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Byte2ReferenceMap.Entry<V>>
...
/* 130 */         int next = 0;
/*     */ 
/* 132 */         public boolean hasNext() { return this.next < Byte2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Byte2ReferenceMap.Entry<V> next()
/*     */         {
/* 136 */           if (!hasNext()) throw new NoSuchElementException();
/* 137 */           return new AbstractByte2ReferenceMap.BasicEntry(Byte2ReferenceArrayMap.this.key[this.next], Byte2ReferenceArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 143 */         int next = 0;
/* 144 */         final AbstractByte2ReferenceMap.BasicEntry<V> entry = new AbstractByte2ReferenceMap.BasicEntry((byte)0, null);
/*     */ 
/* 146 */         public boolean hasNext() { return this.next < Byte2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Byte2ReferenceMap.Entry<V> next()
/*     */         {
/* 150 */           if (!hasNext()) throw new NoSuchElementException();
/* 151 */           this.entry.key = Byte2ReferenceArrayMap.this.key[this.next];
/* 152 */           this.entry.value = Byte2ReferenceArrayMap.this.value[(this.next++)];
/* 153 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 158 */       return Byte2ReferenceArrayMap.this.size;
/*     */     }
/*     */ 
/*     */     public boolean contains(Object o) {
/* 162 */       if (!(o instanceof Map.Entry)) return false;
/* 163 */       Map.Entry e = (Map.Entry)o;
/* 164 */       byte k = ((Byte)e.getKey()).byteValue();
/* 165 */       return (Byte2ReferenceArrayMap.this.containsKey(k)) && (Byte2ReferenceArrayMap.this.get(k) == e.getValue());
/*     */     }
/*     */   }
/*     */ }
