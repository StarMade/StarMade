...
/*  17:    */
/*  66:    */public class Byte2IntArrayMap
/*  67:    */  extends AbstractByte2IntMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Byte2IntArrayMap(byte[] key, int[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Byte2IntArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = ByteArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = IntArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Byte2IntArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new byte[capacity];
/*  94: 94 */    this.value = new int[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Byte2IntArrayMap(Byte2IntMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Byte2IntArrayMap(Map<? extends Byte, ? extends Integer> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Byte2IntArrayMap(byte[] key, int[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Byte2IntMap.Entry> implements Byte2IntMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Byte2IntMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Byte2IntArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Byte2IntMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractByte2IntMap.BasicEntry(Byte2IntArrayMap.this.key[this.next], Byte2IntArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Byte2IntMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractByte2IntMap.BasicEntry entry = new AbstractByte2IntMap.BasicEntry((byte)0, 0);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Byte2IntArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Byte2IntMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Byte2IntArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Byte2IntArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Byte2IntArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Byte, Integer> e = (Map.Entry)o;
/* 165:165 */      byte k = ((Byte)e.getKey()).byteValue();
/* 166:166 */      return (Byte2IntArrayMap.this.containsKey(k)) && (Byte2IntArrayMap.this.get(k) == ((Integer)e.getValue()).intValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Byte2IntMap.FastEntrySet byte2IntEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public int put(byte k, int v)
/* 213:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Byte2IntArrayMap clone()
/* 263:    */  {
/* 264:    */    Byte2IntArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Byte2IntArrayMap)super.clone();
/* 270:    */    }
