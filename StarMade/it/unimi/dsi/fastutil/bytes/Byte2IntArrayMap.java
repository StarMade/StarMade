  ...
  implements Serializable, Cloneable
{
  ...
  public Byte2IntArrayMap(Byte2IntMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Byte2IntArrayMap(Map<? extends Byte, ? extends Integer> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Byte2IntArrayMap local_c;
    try
    {
      local_c = (Byte2IntArrayMap)super.clone();
    }
    ...
    implements Byte2IntMap.FastEntrySet
  {
    ...
    public ObjectIterator<Byte2IntMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Byte2IntMap.Entry next()
        {
          ...
          return new AbstractByte2IntMap.BasicEntry(Byte2IntArrayMap.this.key[this.next], Byte2IntArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Byte2IntArrayMap.this.containsKey(local_k)) && (Byte2IntArrayMap.this.get(local_k) == ((Integer)local_e.getValue()).intValue());
    }
  }
}
