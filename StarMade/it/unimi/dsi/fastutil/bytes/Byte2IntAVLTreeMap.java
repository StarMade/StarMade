  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2IntAVLTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2IntAVLTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2IntAVLTreeMap(Map<? extends Byte, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2IntAVLTreeMap(SortedMap<Byte, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2IntAVLTreeMap(Byte2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2IntAVLTreeMap(Byte2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2IntAVLTreeMap(byte[] local_k, int[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2IntAVLTreeMap(byte[] local_k, int[] local_v)
  {
  ...
  {
    int oldValue = put(local_ok.byteValue(), local_ov.intValue());
    return this.modified ? null : Integer.valueOf(oldValue);
  }
  
  public Integer remove(Object local_ok)
  {
    int oldValue = remove(((Byte)local_ok).byteValue());
  ...
  public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Byte2IntMap.Entry> comparator = new Comparator()
        {
          public int compare(Byte2IntMap.Entry local_x, Byte2IntMap.Entry local_y)
          {
            return Byte2IntAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2IntAVLTreeMap.EntryIterator(Byte2IntAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry from)
        {
          return new Byte2IntAVLTreeMap.EntryIterator(Byte2IntAVLTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2IntAVLTreeMap.Entry local_f = Byte2IntAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2IntAVLTreeMap.Entry local_f = Byte2IntAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2IntAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry from, Byte2IntMap.Entry local_to)
        {
          return Byte2IntAVLTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2IntEntrySet();
        }
        
        public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry local_to)
        {
          return Byte2IntAVLTreeMap.this.headMap((Byte)local_to.getKey()).byte2IntEntrySet();
        }
        
        public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry from)
        {
          return Byte2IntAVLTreeMap.this.tailMap((Byte)from.getKey()).byte2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Byte2IntAVLTreeMap.ValueIterator(Byte2IntAVLTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Byte2IntAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2IntAVLTreeMap local_c;
    try
    {
      local_c = (Byte2IntAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readByte(), local_s.readInt());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readByte(), local_s.readInt());
      top.right(new Entry(local_s.readByte(), local_s.readInt()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2IntAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2IntAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2IntAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator()
          {
            return new Byte2IntAVLTreeMap.Submap.SubmapEntryIterator(Byte2IntAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry from)
          {
            return new Byte2IntAVLTreeMap.Submap.SubmapEntryIterator(Byte2IntAVLTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Integer> local_e = (Map.Entry)local_o;
            Byte2IntAVLTreeMap.Entry local_f = Byte2IntAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2IntAVLTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Integer> local_e = (Map.Entry)local_o;
            Byte2IntAVLTreeMap.Entry local_f = Byte2IntAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2IntAVLTreeMap.Submap.this.in3(local_f.key))) {
              Byte2IntAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2IntAVLTreeMap.Submap.SubmapIterator(Byte2IntAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2IntAVLTreeMap.Submap.this.clear();
          }
          
          public Byte2IntMap.Entry first()
          {
            return Byte2IntAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2IntMap.Entry last()
          {
            return Byte2IntAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry from, Byte2IntMap.Entry local_to)
          {
            return Byte2IntAVLTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2IntEntrySet();
          }
          
          public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry local_to)
          {
            return Byte2IntAVLTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2IntEntrySet();
          }
          
          public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry from)
          {
            return Byte2IntAVLTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Byte2IntAVLTreeMap.Submap.SubmapValueIterator(Byte2IntAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Byte2IntAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2IntAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2IntAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2IntAVLTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2IntAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(byte local_k, int local_v)
    {
      ...
      int oldValue = Byte2IntAVLTreeMap.this.put(local_k, local_v);
    ...
    public int remove(byte local_k)
    {
      ...
      int oldValue = Byte2IntAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2IntAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2IntAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2IntSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2IntAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2IntAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2IntSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2IntAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2IntAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2IntAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2IntAVLTreeMap.this.locateKey(this.from);
        if (Byte2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2IntAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2IntAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2IntAVLTreeMap.this.locateKey(this.field_47);
        if (Byte2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2IntAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2IntAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      implements ObjectListIterator<Byte2IntMap.Entry>
    {
      ...
      public void set(Byte2IntMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Byte2IntMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
      ...
      extends Byte2IntAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2IntAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2IntAVLTreeMap.Submap.this.bottom) && (Byte2IntAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2IntAVLTreeMap.Submap.this.top) && (Byte2IntAVLTreeMap.this.compare(local_k, (this.prev = Byte2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2IntAVLTreeMap.this.locateKey(local_k);
            if (Byte2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2IntAVLTreeMap.this.compare(this.prev.key, Byte2IntAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Byte2IntAVLTreeMap.this.compare(this.next.key, Byte2IntAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2IntSortedMap.KeySet
    {
      ...
      {
        return new Byte2IntAVLTreeMap.Submap.SubmapKeyIterator(Byte2IntAVLTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2IntAVLTreeMap.Submap.SubmapKeyIterator(Byte2IntAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2IntSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2IntAVLTreeMap.KeyIterator(Byte2IntAVLTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2IntAVLTreeMap.KeyIterator(Byte2IntAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2IntAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Byte2IntMap.Entry
  {
    ...
    Entry(byte local_k, int local_v)
    {
      this.key = local_k;
      this.value = local_v;
