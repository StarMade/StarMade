...
/*   5:    */
/*  59:    */public class ByteHeapIndirectPriorityQueue
/*  60:    */  extends ByteHeapSemiIndirectPriorityQueue
/*  61:    */{
/*  62:    */  protected int[] inv;
/*  63:    */  
/*  64:    */  public ByteHeapIndirectPriorityQueue(byte[] refArray, int capacity, ByteComparator c)
/*  65:    */  {
...
/*  72:    */  }
/*  73:    */  
/*  77:    */  public ByteHeapIndirectPriorityQueue(byte[] refArray, int capacity)
/*  78:    */  {
/*  79: 79 */    this(refArray, capacity, null);
/*  80:    */  }
/*  81:    */  
/*  85:    */  public ByteHeapIndirectPriorityQueue(byte[] refArray, ByteComparator c)
/*  86:    */  {
/*  87: 87 */    this(refArray, refArray.length, c);
/*  88:    */  }
/*  89:    */  
/*  91:    */  public ByteHeapIndirectPriorityQueue(byte[] refArray)
/*  92:    */  {
/*  93: 93 */    this(refArray, refArray.length, null);
/*  94:    */  }
/*  95:    */  
/* 105:    */  public ByteHeapIndirectPriorityQueue(byte[] refArray, int[] a, int size, ByteComparator c)
/* 106:    */  {
...
/* 114:    */    }
/* 115:115 */    ByteIndirectHeaps.makeHeap(refArray, a, this.inv, size, c);
/* 116:    */  }
/* 117:    */  
/* 126:    */  public ByteHeapIndirectPriorityQueue(byte[] refArray, int[] a, ByteComparator c)
/* 127:    */  {
/* 128:128 */    this(refArray, a, a.length, c);
/* 129:    */  }
/* 130:    */  
/* 139:    */  public ByteHeapIndirectPriorityQueue(byte[] refArray, int[] a, int size)
/* 140:    */  {
/* 141:141 */    this(refArray, a, size, null);
/* 142:    */  }
/* 143:    */  
/* 153:153 */  public ByteHeapIndirectPriorityQueue(byte[] refArray, int[] a) { this(refArray, a, a.length); }
/* 154:    */  
...
/* 160:    */    
/* 161:161 */    ByteIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, this.size - 1, this.c);
/* 162:    */  }
/* 163:    */  
...
/* 173:    */    
/* 174:174 */    if (this.size != 0) ByteIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.c);
/* 175:175 */    return result;
/* 176:    */  }
/* 177:    */  
/* 178:    */  public void changed() {
/* 179:179 */    ByteIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.c);
/* 180:    */  }
/* 181:    */  
...
/* 185:185 */    int newPos = ByteIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, pos, this.c);
/* 186:186 */    ByteIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.c);
/* 187:    */  }
/* 188:    */  
/* 191:    */  public void allChanged()
/* 192:    */  {
/* 193:193 */    ByteIndirectHeaps.makeHeap(this.refArray, this.heap, this.inv, this.size, this.c);
/* 194:    */  }
/* 195:    */  
...
/* 204:204 */      int newPos = ByteIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, result, this.c);
/* 205:205 */      ByteIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.c);
/* 206:    */    }
/* 207:    */    
/* 208:208 */    return true;
/* 209:    */  }
