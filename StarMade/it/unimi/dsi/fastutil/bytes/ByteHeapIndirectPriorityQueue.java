...
/* 113 */       this.inv[a[i]] = i;
/*     */     }
/* 115 */     ByteIndirectHeaps.makeHeap(refArray, a, this.inv, size, c);
/*     */   }
/*     */ 
...
/*     */ 
/* 161 */     ByteIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, this.size - 1, this.c);
/*     */   }
/*     */ 
...
/*     */ 
/* 174 */     if (this.size != 0) ByteIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.c);
/* 175 */     return result;
/*     */   }
/*     */ 
/*     */   public void changed() {
...
/* 185 */     int newPos = ByteIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, pos, this.c);
/* 186 */     ByteIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.c);
/*     */   }
/*     */ 
...
/* 204 */       int newPos = ByteIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, result, this.c);
/* 205 */       ByteIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.c);
/*     */     }
/*     */ 
/* 208 */     return true;
/*     */   }
