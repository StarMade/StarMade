...
/* 627 */           return new Byte2ReferenceOpenCustomHashMap.ValueIterator(Byte2ReferenceOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 630 */           return Byte2ReferenceOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 633 */           return Byte2ReferenceOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 636 */           Byte2ReferenceOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 751 */       c = (Byte2ReferenceOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public V next() { return Byte2ReferenceOpenCustomHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 593 */       return new Byte2ReferenceOpenCustomHashMap.KeyIterator(Byte2ReferenceOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 596 */       return Byte2ReferenceOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(byte k) {
/* 599 */       return Byte2ReferenceOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(byte k) {
/* 602 */       int oldSize = Byte2ReferenceOpenCustomHashMap.this.size;
/* 603 */       Byte2ReferenceOpenCustomHashMap.this.remove(k);
/* 604 */       return Byte2ReferenceOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 607 */       Byte2ReferenceOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Byte2ReferenceOpenCustomHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 587 */       super(null); } 
/* 588 */     public byte nextByte() { return Byte2ReferenceOpenCustomHashMap.this.key[nextEntry()]; } 
/* 589 */     public Byte next() { return Byte.valueOf(Byte2ReferenceOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 533 */       return new Byte2ReferenceOpenCustomHashMap.EntryIterator(Byte2ReferenceOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Byte2ReferenceMap.Entry<V>> fastIterator() {
/* 536 */       return new Byte2ReferenceOpenCustomHashMap.FastEntryIterator(Byte2ReferenceOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 544 */       int pos = HashCommon.murmurHash3(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ReferenceOpenCustomHashMap.this.mask;
/*     */ 
/* 546 */       while (Byte2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 547 */         if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(Byte2ReferenceOpenCustomHashMap.this.key[pos], k)) return Byte2ReferenceOpenCustomHashMap.this.value[pos] == e.getValue();
/* 548 */         pos = pos + 1 & Byte2ReferenceOpenCustomHashMap.this.mask;
/*     */       }
/* 550 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ReferenceOpenCustomHashMap.this.mask;
/*     */ 
/* 560 */       while (Byte2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 561 */         if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(Byte2ReferenceOpenCustomHashMap.this.key[pos], k)) {
/* 562 */           Byte2ReferenceOpenCustomHashMap.this.remove(e.getKey());
/* 563 */           return true;
/*     */         }
/* 565 */         pos = pos + 1 & Byte2ReferenceOpenCustomHashMap.this.mask;
/*     */       }
/* 567 */       return false;
/*     */     }
/*     */     public int size() {
/* 570 */       return Byte2ReferenceOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 573 */       Byte2ReferenceOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Byte2ReferenceMap.Entry<V>>
/*     */   {
/* 523 */     final AbstractByte2ReferenceMap.BasicEntry<V> entry = new AbstractByte2ReferenceMap.BasicEntry((byte)0, null);
/*     */ 
...
/* 525 */       int e = nextEntry();
/* 526 */       this.entry.key = Byte2ReferenceOpenCustomHashMap.this.key[e];
/* 527 */       this.entry.value = Byte2ReferenceOpenCustomHashMap.this.value[e];
/* 528 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Byte2ReferenceOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Byte2ReferenceMap.Entry<V>>
/*     */   {
...
/* 514 */       return this.entry = new Byte2ReferenceOpenCustomHashMap.MapEntry(Byte2ReferenceOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 518 */       super.remove();
/* 519 */       Byte2ReferenceOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 419 */       this.pos = Byte2ReferenceOpenCustomHashMap.this.n;
/*     */ 
/* 422 */       this.last = -1;
/*     */ 
/* 424 */       this.c = Byte2ReferenceOpenCustomHashMap.this.size;
/*     */ 
/* 429 */       boolean[] used = Byte2ReferenceOpenCustomHashMap.this.used;
...
/*     */ 
/* 442 */         int pos = HashCommon.murmurHash3(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2ReferenceOpenCustomHashMap.this.mask;
/*     */ 
/* 444 */         while (Byte2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 445 */           if (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(Byte2ReferenceOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446 */           pos = pos + 1 & Byte2ReferenceOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 449 */       this.last = this.pos;
/*     */ 
/* 451 */       if (this.c != 0) {
/* 452 */         boolean[] used = Byte2ReferenceOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 469 */         pos = (last = pos) + 1 & Byte2ReferenceOpenCustomHashMap.this.mask;
/* 470 */         while (Byte2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 471 */           int slot = HashCommon.murmurHash3(Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(Byte2ReferenceOpenCustomHashMap.this.key[pos])) & Byte2ReferenceOpenCustomHashMap.this.mask;
/* 472 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473 */           pos = pos + 1 & Byte2ReferenceOpenCustomHashMap.this.mask;
/*     */         }
/* 475 */         if (Byte2ReferenceOpenCustomHashMap.this.used[pos] == 0) break;
/* 476 */         if (pos < last)
/*     */         {
/* 478 */           if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 479 */           this.wrapped.add(Byte2ReferenceOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 481 */         Byte2ReferenceOpenCustomHashMap.this.key[last] = Byte2ReferenceOpenCustomHashMap.this.key[pos];
/* 482 */         Byte2ReferenceOpenCustomHashMap.this.value[last] = Byte2ReferenceOpenCustomHashMap.this.value[pos];
/*     */       }
/* 484 */       Byte2ReferenceOpenCustomHashMap.this.used[last] = false;
/* 485 */       Byte2ReferenceOpenCustomHashMap.this.value[last] = null;
/* 486 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 491 */       if (this.pos < -1)
/*     */       {
/* 493 */         Byte2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 494 */         this.last = -1;
/* 495 */         return;
/*     */       }
/* 497 */       Byte2ReferenceOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Byte getKey() {
/* 389 */       return Byte.valueOf(Byte2ReferenceOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public byte getByteKey() {
/* 392 */       return Byte2ReferenceOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 395 */       return Byte2ReferenceOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 398 */       Object oldValue = Byte2ReferenceOpenCustomHashMap.this.value[this.index];
/* 399 */       Byte2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/* 400 */       return oldValue;
/*     */     }
/*     */ 
...
/* 406 */       return (Byte2ReferenceOpenCustomHashMap.this.strategy.equals(Byte2ReferenceOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue())) && (Byte2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/*     */     }
/*     */     public int hashCode() {
/* 409 */       return Byte2ReferenceOpenCustomHashMap.this.strategy.hashCode(Byte2ReferenceOpenCustomHashMap.this.key[this.index]) ^ (Byte2ReferenceOpenCustomHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Byte2ReferenceOpenCustomHashMap.this.value[this.index]));
/*     */     }
/*     */     public String toString() {
/* 412 */       return Byte2ReferenceOpenCustomHashMap.this.key[this.index] + "=>" + Byte2ReferenceOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
