  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2FloatOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2FloatOpenHashMap(Map<? extends Byte, ? extends Float> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2FloatOpenHashMap(Map<? extends Byte, ? extends Float> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2FloatOpenHashMap(Byte2FloatMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2FloatOpenHashMap(Byte2FloatMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2FloatOpenHashMap(byte[] local_k, float[] local_v, float local_f)
  {
  ...
  public Byte2FloatOpenHashMap(byte[] local_k, float[] local_v)
  {
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Byte2FloatOpenHashMap.ValueIterator(Byte2FloatOpenHashMap.this);
        }
        ...
        {
          return Byte2FloatOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2FloatOpenHashMap local_c;
    try
    {
      local_c = (Byte2FloatOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2FloatOpenHashMap.MapIterator
    implements FloatIterator
  {
    ...
    public Float next()
    {
      return Float.valueOf(Byte2FloatOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2FloatOpenHashMap.KeyIterator(Byte2FloatOpenHashMap.this);
    }
    ...
    {
      return Byte2FloatOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2FloatOpenHashMap.this.size;
      Byte2FloatOpenHashMap.this.remove(local_k);
    ...
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2FloatOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2FloatMap.FastEntrySet
  {
    ...
    {
      return new Byte2FloatOpenHashMap.EntryIterator(Byte2FloatOpenHashMap.this, null);
    }
    
    public ObjectIterator<Byte2FloatMap.Entry> fastIterator()
    {
      return new Byte2FloatOpenHashMap.FastEntryIterator(Byte2FloatOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2FloatOpenHashMap.this.mask; Byte2FloatOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2FloatOpenHashMap.this.mask) {
        if (Byte2FloatOpenHashMap.this.key[pos] == local_k) {
          return Byte2FloatOpenHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2FloatOpenHashMap.this.mask; Byte2FloatOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2FloatOpenHashMap.this.mask) {
        if (Byte2FloatOpenHashMap.this.key[pos] == local_k)
        {
          Byte2FloatOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2FloatMap.Entry>
  {
    ...
    public AbstractByte2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2FloatOpenHashMap.this.key[local_e];
      this.entry.value = Byte2FloatOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2FloatOpenHashMap.MapEntry(Byte2FloatOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2FloatOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2FloatOpenHashMap.this.field_49;
    int last = -1;
    int field_1922 = Byte2FloatOpenHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2FloatOpenHashMap.this.used;
      while ((this.field_1922 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1922 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1922 != 0)
      {
        boolean[] local_k = Byte2FloatOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2FloatOpenHashMap.this.mask; Byte2FloatOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2FloatOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2FloatOpenHashMap.this.key[pos]) & Byte2FloatOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2FloatOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2FloatOpenHashMap.this.key[pos]);
        }
        Byte2FloatOpenHashMap.this.key[last] = Byte2FloatOpenHashMap.this.key[pos];
        Byte2FloatOpenHashMap.this.value[last] = Byte2FloatOpenHashMap.this.value[pos];
      }
      Byte2FloatOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2FloatOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2FloatOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1922 > 0))
      {
        this.field_1922 += 1;
        nextEntry();
      }
    ...
    implements Byte2FloatMap.Entry, Map.Entry<Byte, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Byte2FloatOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Float> local_e = (Map.Entry)local_o;
      return (Byte2FloatOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2FloatOpenHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
