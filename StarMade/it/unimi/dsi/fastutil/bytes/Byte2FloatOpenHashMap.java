...
/*  18:    */
/*  87:    */public class Byte2FloatOpenHashMap
/*  88:    */  extends AbstractByte2FloatMap
...
/* 101:    */  protected volatile transient Byte2FloatMap.FastEntrySet entries;
/* 102:    */  protected volatile transient ByteSet keys;
/* 103:    */  protected volatile transient FloatCollection values;
/* 104:    */  
/* 105:    */  public Byte2FloatOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Byte2FloatOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Byte2FloatOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Byte2FloatOpenHashMap(Map<? extends Byte, ? extends Float> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Byte2FloatOpenHashMap(Map<? extends Byte, ? extends Float> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Byte2FloatOpenHashMap(Byte2FloatMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Byte2FloatOpenHashMap(Byte2FloatMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Byte2FloatOpenHashMap(byte[] k, float[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Byte2FloatOpenHashMap(byte[] k, float[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public float put(byte k, float v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Float put(Byte ok, Float ov) { float v = ov.floatValue();
...
/* 226:    */  }
/* 227:    */  
/* 238:    */  public float add(byte k, float incr)
/* 239:    */  {
...
/* 279:    */  }
/* 280:    */  
/* 281:    */  public float remove(byte k)
/* 282:    */  {
...
/* 312:    */  }
/* 313:    */  
/* 314:314 */  public Float get(Byte ok) { byte k = ok.byteValue();
/* 315:    */    
...
/* 389:    */    implements Byte2FloatMap.Entry, Map.Entry<Byte, Float>
/* 390:    */  {
...
/* 396:    */    }
/* 397:    */    
/* 398:398 */    public Byte getKey() { return Byte.valueOf(Byte2FloatOpenHashMap.this.key[this.index]); }
/* 399:    */    
/* 400:    */    public byte getByteKey() {
/* 401:401 */      return Byte2FloatOpenHashMap.this.key[this.index];
/* 402:    */    }
/* 403:    */    
/* 404:404 */    public Float getValue() { return Float.valueOf(Byte2FloatOpenHashMap.this.value[this.index]); }
/* 405:    */    
/* 407:407 */    public float getFloatValue() { return Byte2FloatOpenHashMap.this.value[this.index]; }
/* 408:    */    
/* 409:    */    public float setValue(float v) {
/* 410:410 */      float oldValue = Byte2FloatOpenHashMap.this.value[this.index];
/* 411:411 */      Byte2FloatOpenHashMap.this.value[this.index] = v;
...
/* 420:420 */      Map.Entry<Byte, Float> e = (Map.Entry)o;
/* 421:421 */      return (Byte2FloatOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2FloatOpenHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public int hashCode() { return Byte2FloatOpenHashMap.this.key[this.index] ^ HashCommon.float2int(Byte2FloatOpenHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public String toString() { return Byte2FloatOpenHashMap.this.key[this.index] + "=>" + Byte2FloatOpenHashMap.this.value[this.index]; } }
/* 428:    */  
...
/* 433:    */    
/* 434:434 */    private MapIterator() { this.pos = Byte2FloatOpenHashMap.this.n;
/* 435:    */      
/* 437:437 */      this.last = -1;
/* 438:    */      
/* 439:439 */      this.c = Byte2FloatOpenHashMap.this.size;
/* 440:    */      
/* 444:444 */      boolean[] used = Byte2FloatOpenHashMap.this.used;
...
/* 456:    */        
/* 457:457 */        int pos = HashCommon.murmurHash3(k) & Byte2FloatOpenHashMap.this.mask;
/* 458:    */        
/* 459:459 */        while (Byte2FloatOpenHashMap.this.used[pos] != 0) {
/* 460:460 */          if (Byte2FloatOpenHashMap.this.key[pos] == k) return pos;
/* 461:461 */          pos = pos + 1 & Byte2FloatOpenHashMap.this.mask;
/* 462:    */        }
/* 463:    */      }
/* 464:464 */      this.last = this.pos;
/* 465:    */      
/* 466:466 */      if (this.c != 0) {
/* 467:467 */        boolean[] used = Byte2FloatOpenHashMap.this.used;
...
/* 482:    */      for (;;)
/* 483:    */      {
/* 484:484 */        pos = (last = pos) + 1 & Byte2FloatOpenHashMap.this.mask;
/* 485:485 */        while (Byte2FloatOpenHashMap.this.used[pos] != 0) {
/* 486:486 */          int slot = HashCommon.murmurHash3(Byte2FloatOpenHashMap.this.key[pos]) & Byte2FloatOpenHashMap.this.mask;
/* 487:487 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488:488 */          pos = pos + 1 & Byte2FloatOpenHashMap.this.mask;
/* 489:    */        }
/* 490:490 */        if (Byte2FloatOpenHashMap.this.used[pos] == 0) break;
/* 491:491 */        if (pos < last)
/* 492:    */        {
/* 493:493 */          if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 494:494 */          this.wrapped.add(Byte2FloatOpenHashMap.this.key[pos]);
/* 495:    */        }
/* 496:496 */        Byte2FloatOpenHashMap.this.key[last] = Byte2FloatOpenHashMap.this.key[pos];
/* 497:497 */        Byte2FloatOpenHashMap.this.value[last] = Byte2FloatOpenHashMap.this.value[pos];
/* 498:    */      }
/* 499:499 */      Byte2FloatOpenHashMap.this.used[last] = false;
/* 500:500 */      return last;
/* 501:    */    }
/* 502:    */    
...
/* 506:    */      {
/* 507:507 */        Byte2FloatOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 508:508 */        this.last = -1;
/* 509:509 */        return;
/* 510:    */      }
/* 511:511 */      Byte2FloatOpenHashMap.this.size -= 1;
...
/* 523:    */    } }
/* 524:    */  
/* 525:525 */  private class EntryIterator extends Byte2FloatOpenHashMap.MapIterator implements ObjectIterator<Byte2FloatMap.Entry> { private EntryIterator() { super(null); }
/* 526:    */    
/* 527:    */    private Byte2FloatOpenHashMap.MapEntry entry;
/* 528:528 */    public Byte2FloatMap.Entry next() { return this.entry = new Byte2FloatOpenHashMap.MapEntry(Byte2FloatOpenHashMap.this, nextEntry()); }
/* 529:    */    
/* 530:    */    public void remove()
/* 531:    */    {
/* 532:532 */      super.remove();
/* 533:533 */      Byte2FloatOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 534:    */    } }
/* 535:    */  
/* 536:536 */  private class FastEntryIterator extends Byte2FloatOpenHashMap.MapIterator implements ObjectIterator<Byte2FloatMap.Entry> { private FastEntryIterator() { super(null); }
/* 537:537 */    final AbstractByte2FloatMap.BasicEntry entry = new AbstractByte2FloatMap.BasicEntry((byte)0, 0.0F);
/* 538:    */    
/* 539:539 */    public AbstractByte2FloatMap.BasicEntry next() { int e = nextEntry();
/* 540:540 */      this.entry.key = Byte2FloatOpenHashMap.this.key[e];
/* 541:541 */      this.entry.value = Byte2FloatOpenHashMap.this.value[e];
/* 542:542 */      return this.entry;
/* 543:    */    } }
/* 544:    */  
/* 545:    */  private final class MapEntrySet extends AbstractObjectSet<Byte2FloatMap.Entry> implements Byte2FloatMap.FastEntrySet { private MapEntrySet() {}
/* 546:    */    
/* 547:547 */    public ObjectIterator<Byte2FloatMap.Entry> iterator() { return new Byte2FloatOpenHashMap.EntryIterator(Byte2FloatOpenHashMap.this, null); }
/* 548:    */    
/* 549:    */    public ObjectIterator<Byte2FloatMap.Entry> fastIterator() {
/* 550:550 */      return new Byte2FloatOpenHashMap.FastEntryIterator(Byte2FloatOpenHashMap.this, null);
/* 551:    */    }
/* 552:    */    
/* 553:    */    public boolean contains(Object o) {
/* 554:554 */      if (!(o instanceof Map.Entry)) return false;
/* 555:555 */      Map.Entry<Byte, Float> e = (Map.Entry)o;
/* 556:556 */      byte k = ((Byte)e.getKey()).byteValue();
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(k) & Byte2FloatOpenHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Byte2FloatOpenHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Byte2FloatOpenHashMap.this.key[pos] == k) return Byte2FloatOpenHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 562:562 */        pos = pos + 1 & Byte2FloatOpenHashMap.this.mask;
/* 563:    */      }
...
/* 569:569 */      Map.Entry<Byte, Float> e = (Map.Entry)o;
/* 570:570 */      byte k = ((Byte)e.getKey()).byteValue();
/* 571:    */      
/* 572:572 */      int pos = HashCommon.murmurHash3(k) & Byte2FloatOpenHashMap.this.mask;
/* 573:    */      
/* 574:574 */      while (Byte2FloatOpenHashMap.this.used[pos] != 0) {
/* 575:575 */        if (Byte2FloatOpenHashMap.this.key[pos] == k) {
/* 576:576 */          Byte2FloatOpenHashMap.this.remove(e.getKey());
/* 577:577 */          return true;
/* 578:    */        }
/* 579:579 */        pos = pos + 1 & Byte2FloatOpenHashMap.this.mask;
/* 580:    */      }
/* 581:581 */      return false;
/* 582:    */    }
/* 583:    */    
/* 584:584 */    public int size() { return Byte2FloatOpenHashMap.this.size; }
/* 585:    */    
/* 587:587 */    public void clear() { Byte2FloatOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public Byte2FloatMap.FastEntrySet byte2FloatEntrySet() {
...
/* 598:    */    extends Byte2FloatOpenHashMap.MapIterator
/* 599:    */    implements ByteIterator
/* 600:    */  {
/* 601:601 */    public KeyIterator() { super(null); }
/* 602:602 */    public byte nextByte() { return Byte2FloatOpenHashMap.this.key[nextEntry()]; }
/* 603:603 */    public Byte next() { return Byte.valueOf(Byte2FloatOpenHashMap.this.key[nextEntry()]); } }
/* 604:    */  
/* 605:    */  private final class KeySet extends AbstractByteSet { private KeySet() {}
/* 606:    */    
/* 607:607 */    public ByteIterator iterator() { return new Byte2FloatOpenHashMap.KeyIterator(Byte2FloatOpenHashMap.this); }
/* 608:    */    
/* 609:    */    public int size() {
/* 610:610 */      return Byte2FloatOpenHashMap.this.size;
/* 611:    */    }
/* 612:    */    
/* 613:613 */    public boolean contains(byte k) { return Byte2FloatOpenHashMap.this.containsKey(k); }
/* 614:    */    
/* 615:    */    public boolean remove(byte k) {
/* 616:616 */      int oldSize = Byte2FloatOpenHashMap.this.size;
/* 617:617 */      Byte2FloatOpenHashMap.this.remove(k);
/* 618:618 */      return Byte2FloatOpenHashMap.this.size != oldSize;
/* 619:    */    }
/* 620:    */    
/* 621:621 */    public void clear() { Byte2FloatOpenHashMap.this.clear(); }
/* 622:    */  }
/* 623:    */  
...
/* 632:    */    extends Byte2FloatOpenHashMap.MapIterator
/* 633:    */    implements FloatIterator
/* 634:    */  {
/* 635:635 */    public ValueIterator() { super(null); }
/* 636:636 */    public float nextFloat() { return Byte2FloatOpenHashMap.this.value[nextEntry()]; }
/* 637:637 */    public Float next() { return Float.valueOf(Byte2FloatOpenHashMap.this.value[nextEntry()]); }
/* 638:    */  }
/* 639:    */  
...
/* 642:642 */          return new Byte2FloatOpenHashMap.ValueIterator(Byte2FloatOpenHashMap.this);
/* 643:    */        }
/* 644:    */        
/* 645:645 */        public int size() { return Byte2FloatOpenHashMap.this.size; }
/* 646:    */        
/* 647:    */        public boolean contains(float v) {
/* 648:648 */          return Byte2FloatOpenHashMap.this.containsValue(v);
/* 649:    */        }
/* 650:    */        
/* 651:651 */        public void clear() { Byte2FloatOpenHashMap.this.clear(); }
/* 652:    */      };
/* 653:    */    }
...
/* 754:    */  }
/* 755:    */  
/* 759:    */  public Byte2FloatOpenHashMap clone()
/* 760:    */  {
/* 761:    */    Byte2FloatOpenHashMap c;
/* 762:    */    
/* 764:    */    try
/* 765:    */    {
/* 766:766 */      c = (Byte2FloatOpenHashMap)super.clone();
/* 767:    */    }
