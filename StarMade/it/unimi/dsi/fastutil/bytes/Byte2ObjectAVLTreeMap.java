  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2ObjectAVLTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2ObjectAVLTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2ObjectAVLTreeMap(Map<? extends Byte, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ObjectAVLTreeMap(SortedMap<Byte, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ObjectAVLTreeMap(Byte2ObjectMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ObjectAVLTreeMap(Byte2ObjectSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ObjectAVLTreeMap(byte[] local_k, V[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2ObjectAVLTreeMap(byte[] local_k, V[] local_v)
  {
  ...
  {
    Byte2ObjectAVLTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Byte2ObjectMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Byte2ObjectAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2ObjectAVLTreeMap.EntryIterator(Byte2ObjectAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from)
        {
          return new Byte2ObjectAVLTreeMap.EntryIterator(Byte2ObjectAVLTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2ObjectAVLTreeMap.Entry<V> local_f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2ObjectAVLTreeMap.Entry<V> local_f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2ObjectAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Byte2ObjectAVLTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> local_to)
        {
          return Byte2ObjectAVLTreeMap.this.headMap((Byte)local_to.getKey()).byte2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from)
        {
          return Byte2ObjectAVLTreeMap.this.tailMap((Byte)from.getKey()).byte2ObjectEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Byte2ObjectAVLTreeMap.ValueIterator(Byte2ObjectAVLTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Byte2ObjectAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2ObjectAVLTreeMap<V> local_c;
    try
    {
      local_c = (Byte2ObjectAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Byte2ObjectAVLTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2ObjectAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Byte2ObjectAVLTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Byte2ObjectAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2ObjectAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator()
          {
            return new Byte2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Byte2ObjectAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from)
          {
            return new Byte2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Byte2ObjectAVLTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, V> local_e = (Map.Entry)local_o;
            Byte2ObjectAVLTreeMap.Entry<V> local_f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2ObjectAVLTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, V> local_e = (Map.Entry)local_o;
            Byte2ObjectAVLTreeMap.Entry<V> local_f = Byte2ObjectAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2ObjectAVLTreeMap.Submap.this.in3(local_f.key))) {
              Byte2ObjectAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2ObjectAVLTreeMap.Submap.SubmapIterator(Byte2ObjectAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2ObjectAVLTreeMap.Submap.this.clear();
          }
          
          public Byte2ObjectMap.Entry<V> first()
          {
            return Byte2ObjectAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2ObjectMap.Entry<V> last()
          {
            return Byte2ObjectAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> local_to)
          {
            return Byte2ObjectAVLTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> local_to)
          {
            return Byte2ObjectAVLTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from)
          {
            return Byte2ObjectAVLTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Byte2ObjectAVLTreeMap.Submap.SubmapValueIterator(Byte2ObjectAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Byte2ObjectAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2ObjectAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2ObjectAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2ObjectAVLTreeMap.Entry<V> local_e;
      return (in3(local_kk)) && ((local_e = Byte2ObjectAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(byte local_k, V local_v)
    {
      ...
      V oldValue = Byte2ObjectAVLTreeMap.this.put(local_k, local_v);
    ...
    public V remove(byte local_k)
    {
      ...
      V oldValue = Byte2ObjectAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2ObjectSortedMap<V> tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2ObjectAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ObjectAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2ObjectSortedMap<V> subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2ObjectAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2ObjectAVLTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2ObjectAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2ObjectAVLTreeMap.this.locateKey(this.from);
        if (Byte2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2ObjectAVLTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2ObjectAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2ObjectAVLTreeMap.this.locateKey(this.field_47);
        if (Byte2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2ObjectAVLTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2ObjectAVLTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Byte2ObjectAVLTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Byte2ObjectAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Byte2ObjectAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2ObjectAVLTreeMap.Submap.this.bottom) && (Byte2ObjectAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2ObjectAVLTreeMap.Submap.this.top) && (Byte2ObjectAVLTreeMap.this.compare(local_k, (this.prev = Byte2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2ObjectAVLTreeMap.this.locateKey(local_k);
            if (Byte2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2ObjectAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ObjectAVLTreeMap.this.compare(this.prev.key, Byte2ObjectAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2ObjectAVLTreeMap.Submap.this.top) && (this.next != null) && (Byte2ObjectAVLTreeMap.this.compare(this.next.key, Byte2ObjectAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Byte2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Byte2ObjectAVLTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Byte2ObjectAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2ObjectSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2ObjectAVLTreeMap.KeyIterator(Byte2ObjectAVLTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2ObjectAVLTreeMap.KeyIterator(Byte2ObjectAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2ObjectAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
