...
/*      */ 
/*      */ public class Byte2LongRBTreeMap extends AbstractByte2LongSortedMap
...
/*  119 */           return Byte2LongRBTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  122 */           return Byte2LongRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     long oldValue = put(ok.byteValue(), ov.longValue());
/*  731 */     return this.modified ? null : Long.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Long remove(Object ok)
/*      */   {
/*  737 */     long oldValue = remove(((Byte)ok).byteValue());
...
/* 1141 */         final Comparator<? super Byte2LongMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Byte2LongMap.Entry x, Byte2LongMap.Entry y) {
/* 1143 */             return Byte2LongRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Byte2LongRBTreeMap.EntryIterator(Byte2LongRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry from) {
/* 1153 */           return new Byte2LongRBTreeMap.EntryIterator(Byte2LongRBTreeMap.this, ((Byte)from.getKey()).byteValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Byte2LongRBTreeMap.Entry f = Byte2LongRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1166 */           Byte2LongRBTreeMap.Entry f = Byte2LongRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1167 */           if (f != null) Byte2LongRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Byte2LongRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Byte2LongRBTreeMap.this.clear(); } 
/* 1172 */         public Byte2LongMap.Entry first() { return Byte2LongRBTreeMap.this.firstEntry; } 
/* 1173 */         public Byte2LongMap.Entry last() { return Byte2LongRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry from, Byte2LongMap.Entry to) { return Byte2LongRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2LongEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry to) { return Byte2LongRBTreeMap.this.headMap((Byte)to.getKey()).byte2LongEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry from) { return Byte2LongRBTreeMap.this.tailMap((Byte)from.getKey()).byte2LongEntrySet(); }
/*      */       };
...
/* 1242 */           return new Byte2LongRBTreeMap.ValueIterator(Byte2LongRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(long k) {
/* 1245 */           return Byte2LongRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Byte2LongRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Byte2LongRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Byte2LongRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readByte(), s.readLong());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readByte(), s.readLong());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readByte(), s.readLong()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Byte2LongRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Byte2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator() {
/* 1329 */             return new Byte2LongRBTreeMap.Submap.SubmapEntryIterator(Byte2LongRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry from) {
/* 1332 */             return new Byte2LongRBTreeMap.Submap.SubmapEntryIterator(Byte2LongRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
/*      */           }
/* 1334 */           public Comparator<? super Byte2LongMap.Entry> comparator() { return Byte2LongRBTreeMap.this.byte2LongEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Byte2LongRBTreeMap.Entry f = Byte2LongRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1340 */             return (f != null) && (Byte2LongRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Byte2LongRBTreeMap.Entry f = Byte2LongRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1347 */             if ((f != null) && (Byte2LongRBTreeMap.Submap.this.in(f.key))) Byte2LongRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Byte2LongRBTreeMap.Submap.SubmapIterator(Byte2LongRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Byte2LongRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Byte2LongMap.Entry first() { return Byte2LongRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Byte2LongMap.Entry last() { return Byte2LongRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry from, Byte2LongMap.Entry to) { return Byte2LongRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2LongEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry to) { return Byte2LongRBTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2LongEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry from) { return Byte2LongRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2LongEntrySet(); }
/*      */         };
...
/*      */           public LongIterator iterator() {
/* 1376 */             return new Byte2LongRBTreeMap.Submap.SubmapValueIterator(Byte2LongRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(long k) {
/* 1379 */             return Byte2LongRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Byte2LongRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Byte2LongRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(byte k) {
/* 1392 */       return (in(k)) && (Byte2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(long v) {
...
/* 1407 */       return (in(kk)) && ((e = Byte2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public long put(byte k, long v) {
/* 1410 */       Byte2LongRBTreeMap.this.modified = false;
...
/* 1412 */       long oldValue = Byte2LongRBTreeMap.this.put(k, v);
/* 1413 */       return Byte2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Long put(Byte ok, Long ov) {
/* 1416 */       long oldValue = put(ok.byteValue(), ov.longValue());
/* 1417 */       return Byte2LongRBTreeMap.this.modified ? null : Long.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public long remove(byte k) {
/* 1421 */       Byte2LongRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       long oldValue = Byte2LongRBTreeMap.this.remove(k);
/* 1424 */       return Byte2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Long remove(Object ok) {
/* 1427 */       long oldValue = remove(((Byte)ok).byteValue());
/* 1428 */       return Byte2LongRBTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1443 */       return Byte2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Byte2LongSortedMap headMap(byte to) {
/* 1446 */       if (this.top) return new Submap(Byte2LongRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Byte2LongRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2LongRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Byte2LongSortedMap tailMap(byte from) {
/* 1450 */       if (this.bottom) return new Submap(Byte2LongRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Byte2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2LongRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Byte2LongSortedMap subMap(byte from, byte to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Byte2LongRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Byte2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Byte2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Byte2LongRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Byte2LongRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Byte2LongRBTreeMap.this.tree == null) return null;
/* 1468 */       Byte2LongRBTreeMap.Entry e;
/*      */       Byte2LongRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Byte2LongRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Byte2LongRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Byte2LongRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Byte2LongRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Byte2LongRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Byte2LongRBTreeMap.this.tree == null) return null;
/* 1486 */       Byte2LongRBTreeMap.Entry e;
/*      */       Byte2LongRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Byte2LongRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Byte2LongRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Byte2LongRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Byte2LongRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public byte firstByteKey() {
/* 1497 */       Byte2LongRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public byte lastByteKey() {
/* 1502 */       Byte2LongRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Byte firstKey() {
/* 1507 */       Byte2LongRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Byte lastKey() {
/* 1512 */       Byte2LongRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Byte2LongRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Byte2LongRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Byte2LongRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Byte2LongMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Byte2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Byte2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Byte2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Byte2LongRBTreeMap.Submap.this.bottom) && (Byte2LongRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Byte2LongRBTreeMap.Submap.this.top) && (Byte2LongRBTreeMap.this.compare(k, (this.prev = Byte2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Byte2LongRBTreeMap.this.locateKey(k);
/* 1534 */             if (Byte2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Byte2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2LongRBTreeMap.this.compare(this.prev.key, Byte2LongRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Byte2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2LongRBTreeMap.this.compare(this.next.key, Byte2LongRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public ByteBidirectionalIterator iterator() { return new Byte2LongRBTreeMap.Submap.SubmapKeyIterator(Byte2LongRBTreeMap.Submap.this); } 
/* 1367 */       public ByteBidirectionalIterator iterator(byte from) { return new Byte2LongRBTreeMap.Submap.SubmapKeyIterator(Byte2LongRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2LongRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public ByteBidirectionalIterator iterator() { return new Byte2LongRBTreeMap.KeyIterator(Byte2LongRBTreeMap.this); } 
/* 1201 */     public ByteBidirectionalIterator iterator(byte from) { return new Byte2LongRBTreeMap.KeyIterator(Byte2LongRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2LongRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2LongRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Byte2LongMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Byte2LongMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Byte2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Byte2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Byte2LongRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(byte k) {
/* 1067 */       if ((this.next = Byte2LongRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Byte2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Byte2LongRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
