  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2LongRBTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2LongRBTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2LongRBTreeMap(Map<? extends Byte, ? extends Long> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2LongRBTreeMap(SortedMap<Byte, Long> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2LongRBTreeMap(Byte2LongMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2LongRBTreeMap(Byte2LongSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2LongRBTreeMap(byte[] local_k, long[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2LongRBTreeMap(byte[] local_k, long[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Byte2LongMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Byte2LongRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2LongRBTreeMap.EntryIterator(Byte2LongRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry from)
        {
          return new Byte2LongRBTreeMap.EntryIterator(Byte2LongRBTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2LongRBTreeMap.Entry local_f = Byte2LongRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2LongRBTreeMap.Entry local_f = Byte2LongRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2LongRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Byte2LongRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2LongEntrySet();
        }
        
        public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry local_to)
        {
          return Byte2LongRBTreeMap.this.headMap((Byte)local_to.getKey()).byte2LongEntrySet();
        }
        
        public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry from)
        {
          return Byte2LongRBTreeMap.this.tailMap((Byte)from.getKey()).byte2LongEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Byte2LongRBTreeMap.ValueIterator(Byte2LongRBTreeMap.this, null);
        }
        
        public boolean contains(long local_k)
        {
          return Byte2LongRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2LongRBTreeMap local_c;
    try
    {
      local_c = (Byte2LongRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2LongRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2LongRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2LongRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator()
          {
            return new Byte2LongRBTreeMap.Submap.SubmapEntryIterator(Byte2LongRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry from)
          {
            return new Byte2LongRBTreeMap.Submap.SubmapEntryIterator(Byte2LongRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Long> local_e = (Map.Entry)local_o;
            Byte2LongRBTreeMap.Entry local_f = Byte2LongRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2LongRBTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Long> local_e = (Map.Entry)local_o;
            Byte2LongRBTreeMap.Entry local_f = Byte2LongRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2LongRBTreeMap.Submap.this.in3(local_f.key))) {
              Byte2LongRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2LongRBTreeMap.Submap.SubmapIterator(Byte2LongRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2LongRBTreeMap.Submap.this.clear();
          }
          
          public Byte2LongMap.Entry first()
          {
            return Byte2LongRBTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2LongMap.Entry last()
          {
            return Byte2LongRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry from, Byte2LongMap.Entry local_to)
          {
            return Byte2LongRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2LongEntrySet();
          }
          
          public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry local_to)
          {
            return Byte2LongRBTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2LongEntrySet();
          }
          
          public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry from)
          {
            return Byte2LongRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2LongEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public LongCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractLongCollection()
        {
          public LongIterator iterator()
          {
            return new Byte2LongRBTreeMap.Submap.SubmapValueIterator(Byte2LongRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(long local_k)
          {
            return Byte2LongRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2LongRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2LongRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2LongRBTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2LongRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public long put(byte local_k, long local_v)
    {
      ...
      long oldValue = Byte2LongRBTreeMap.this.put(local_k, local_v);
    ...
    public long remove(byte local_k)
    {
      ...
      long oldValue = Byte2LongRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2LongRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2LongRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2LongRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2LongSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2LongRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2LongRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2LongSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2LongRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2LongRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2LongRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2LongRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2LongRBTreeMap.this.locateKey(this.from);
        if (Byte2LongRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2LongRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2LongRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2LongRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2LongRBTreeMap.this.locateKey(this.field_47);
        if (Byte2LongRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2LongRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2LongRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2LongRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2LongRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2LongRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2LongRBTreeMap.Submap.this.bottom) && (Byte2LongRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2LongRBTreeMap.Submap.this.top) && (Byte2LongRBTreeMap.this.compare(local_k, (this.prev = Byte2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2LongRBTreeMap.this.locateKey(local_k);
            if (Byte2LongRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2LongRBTreeMap.this.compare(this.prev.key, Byte2LongRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2LongRBTreeMap.this.compare(this.next.key, Byte2LongRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2LongSortedMap.KeySet
    {
      ...
      {
        return new Byte2LongRBTreeMap.Submap.SubmapKeyIterator(Byte2LongRBTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2LongRBTreeMap.Submap.SubmapKeyIterator(Byte2LongRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2LongSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2LongRBTreeMap.KeyIterator(Byte2LongRBTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2LongRBTreeMap.KeyIterator(Byte2LongRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2LongRBTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2LongRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
