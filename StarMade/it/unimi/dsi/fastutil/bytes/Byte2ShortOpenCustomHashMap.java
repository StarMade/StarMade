  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2ShortOpenCustomHashMap(int expected, float local_f, ByteHash.Strategy strategy)
  {
  ...
  public Byte2ShortOpenCustomHashMap(Map<? extends Byte, ? extends Short> local_m, float local_f, ByteHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Byte2ShortOpenCustomHashMap(Map<? extends Byte, ? extends Short> local_m, ByteHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Byte2ShortOpenCustomHashMap(Byte2ShortMap local_m, float local_f, ByteHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Byte2ShortOpenCustomHashMap(Byte2ShortMap local_m, ByteHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Byte2ShortOpenCustomHashMap(byte[] local_k, short[] local_v, float local_f, ByteHash.Strategy strategy)
  {
  ...
  public Byte2ShortOpenCustomHashMap(byte[] local_k, short[] local_v, ByteHash.Strategy strategy)
  {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Byte2ShortOpenCustomHashMap.ValueIterator(Byte2ShortOpenCustomHashMap.this);
        }
        ...
        {
          return Byte2ShortOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2ShortOpenCustomHashMap local_c;
    try
    {
      local_c = (Byte2ShortOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2ShortOpenCustomHashMap.MapIterator
    implements ShortIterator
  {
    ...
    public Short next()
    {
      return Short.valueOf(Byte2ShortOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2ShortOpenCustomHashMap.KeyIterator(Byte2ShortOpenCustomHashMap.this);
    }
    ...
    {
      return Byte2ShortOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2ShortOpenCustomHashMap.this.size;
      Byte2ShortOpenCustomHashMap.this.remove(local_k);
    ...
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2ShortOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2ShortMap.FastEntrySet
  {
    ...
    {
      return new Byte2ShortOpenCustomHashMap.EntryIterator(Byte2ShortOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Byte2ShortMap.Entry> fastIterator()
    {
      return new Byte2ShortOpenCustomHashMap.FastEntryIterator(Byte2ShortOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(local_k)) & Byte2ShortOpenCustomHashMap.this.mask; Byte2ShortOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ShortOpenCustomHashMap.this.mask) {
        if (Byte2ShortOpenCustomHashMap.this.strategy.equals(Byte2ShortOpenCustomHashMap.this.key[pos], local_k)) {
          return Byte2ShortOpenCustomHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(local_k)) & Byte2ShortOpenCustomHashMap.this.mask; Byte2ShortOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ShortOpenCustomHashMap.this.mask) {
        if (Byte2ShortOpenCustomHashMap.this.strategy.equals(Byte2ShortOpenCustomHashMap.this.key[pos], local_k))
        {
          Byte2ShortOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2ShortMap.Entry>
  {
    ...
    public AbstractByte2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2ShortOpenCustomHashMap.this.key[local_e];
      this.entry.value = Byte2ShortOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2ShortOpenCustomHashMap.MapEntry(Byte2ShortOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2ShortOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2ShortOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1735 = Byte2ShortOpenCustomHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2ShortOpenCustomHashMap.this.used;
      while ((this.field_1735 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1735 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1735 != 0)
      {
        boolean[] local_k = Byte2ShortOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2ShortOpenCustomHashMap.this.mask; Byte2ShortOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ShortOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2ShortOpenCustomHashMap.this.strategy.hashCode(Byte2ShortOpenCustomHashMap.this.key[pos])) & Byte2ShortOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2ShortOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2ShortOpenCustomHashMap.this.key[pos]);
        }
        Byte2ShortOpenCustomHashMap.this.key[last] = Byte2ShortOpenCustomHashMap.this.key[pos];
        Byte2ShortOpenCustomHashMap.this.value[last] = Byte2ShortOpenCustomHashMap.this.value[pos];
      }
      Byte2ShortOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2ShortOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2ShortOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1735 > 0))
      {
        this.field_1735 += 1;
        nextEntry();
      }
    ...
    implements Byte2ShortMap.Entry, Map.Entry<Byte, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Byte2ShortOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Short> local_e = (Map.Entry)local_o;
      return (Byte2ShortOpenCustomHashMap.this.strategy.equals(Byte2ShortOpenCustomHashMap.this.key[this.index], ((Byte)local_e.getKey()).byteValue())) && (Byte2ShortOpenCustomHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
