  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2LongAVLTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2LongAVLTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2LongAVLTreeMap(Map<? extends Byte, ? extends Long> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2LongAVLTreeMap(SortedMap<Byte, Long> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2LongAVLTreeMap(Byte2LongMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2LongAVLTreeMap(Byte2LongSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2LongAVLTreeMap(byte[] local_k, long[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2LongAVLTreeMap(byte[] local_k, long[] local_v)
  {
  ...
  {
    long oldValue = put(local_ok.byteValue(), local_ov.longValue());
    return this.modified ? null : Long.valueOf(oldValue);
  }
  
  public Long remove(Object local_ok)
  {
    long oldValue = remove(((Byte)local_ok).byteValue());
  ...
  public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Byte2LongMap.Entry> comparator = new Comparator()
        {
          public int compare(Byte2LongMap.Entry local_x, Byte2LongMap.Entry local_y)
          {
            return Byte2LongAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2LongAVLTreeMap.EntryIterator(Byte2LongAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry from)
        {
          return new Byte2LongAVLTreeMap.EntryIterator(Byte2LongAVLTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2LongAVLTreeMap.Entry local_f = Byte2LongAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2LongAVLTreeMap.Entry local_f = Byte2LongAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2LongAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry from, Byte2LongMap.Entry local_to)
        {
          return Byte2LongAVLTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2LongEntrySet();
        }
        
        public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry local_to)
        {
          return Byte2LongAVLTreeMap.this.headMap((Byte)local_to.getKey()).byte2LongEntrySet();
        }
        
        public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry from)
        {
          return Byte2LongAVLTreeMap.this.tailMap((Byte)from.getKey()).byte2LongEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Byte2LongAVLTreeMap.ValueIterator(Byte2LongAVLTreeMap.this, null);
        }
        
        public boolean contains(long local_k)
        {
          return Byte2LongAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2LongAVLTreeMap local_c;
    try
    {
      local_c = (Byte2LongAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readByte(), local_s.readLong());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readByte(), local_s.readLong());
      top.right(new Entry(local_s.readByte(), local_s.readLong()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2LongAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2LongAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2LongAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2LongMap.Entry> byte2LongEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator()
          {
            return new Byte2LongAVLTreeMap.Submap.SubmapEntryIterator(Byte2LongAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry from)
          {
            return new Byte2LongAVLTreeMap.Submap.SubmapEntryIterator(Byte2LongAVLTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Long> local_e = (Map.Entry)local_o;
            Byte2LongAVLTreeMap.Entry local_f = Byte2LongAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2LongAVLTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Long> local_e = (Map.Entry)local_o;
            Byte2LongAVLTreeMap.Entry local_f = Byte2LongAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2LongAVLTreeMap.Submap.this.in3(local_f.key))) {
              Byte2LongAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2LongAVLTreeMap.Submap.SubmapIterator(Byte2LongAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2LongAVLTreeMap.Submap.this.clear();
          }
          
          public Byte2LongMap.Entry first()
          {
            return Byte2LongAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2LongMap.Entry last()
          {
            return Byte2LongAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry from, Byte2LongMap.Entry local_to)
          {
            return Byte2LongAVLTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2LongEntrySet();
          }
          
          public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry local_to)
          {
            return Byte2LongAVLTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2LongEntrySet();
          }
          
          public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry from)
          {
            return Byte2LongAVLTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2LongEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public LongCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractLongCollection()
        {
          public LongIterator iterator()
          {
            return new Byte2LongAVLTreeMap.Submap.SubmapValueIterator(Byte2LongAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(long local_k)
          {
            return Byte2LongAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2LongAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2LongAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2LongAVLTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2LongAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public long put(byte local_k, long local_v)
    {
      ...
      long oldValue = Byte2LongAVLTreeMap.this.put(local_k, local_v);
    ...
    public long remove(byte local_k)
    {
      ...
      long oldValue = Byte2LongAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2LongAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2LongAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2LongSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2LongAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2LongAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2LongAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2LongSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2LongAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2LongAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2LongAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2LongAVLTreeMap.this.locateKey(this.from);
        if (Byte2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2LongAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2LongAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2LongAVLTreeMap.this.locateKey(this.field_47);
        if (Byte2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2LongAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2LongAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2LongAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2LongAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2LongAVLTreeMap.Submap.this.bottom) && (Byte2LongAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2LongAVLTreeMap.Submap.this.top) && (Byte2LongAVLTreeMap.this.compare(local_k, (this.prev = Byte2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2LongAVLTreeMap.this.locateKey(local_k);
            if (Byte2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2LongAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2LongAVLTreeMap.this.compare(this.prev.key, Byte2LongAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2LongAVLTreeMap.Submap.this.top) && (this.next != null) && (Byte2LongAVLTreeMap.this.compare(this.next.key, Byte2LongAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2LongSortedMap.KeySet
    {
      ...
      {
        return new Byte2LongAVLTreeMap.Submap.SubmapKeyIterator(Byte2LongAVLTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2LongAVLTreeMap.Submap.SubmapKeyIterator(Byte2LongAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2LongSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2LongAVLTreeMap.KeyIterator(Byte2LongAVLTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2LongAVLTreeMap.KeyIterator(Byte2LongAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2LongAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Byte2LongMap.Entry
  {
    ...
    Entry(byte local_k, long local_v)
    {
      this.key = local_k;
      this.value = local_v;
