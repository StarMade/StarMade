...
/*   9:    */
/*  56:    */public abstract class AbstractByteList
/*  57:    */  extends AbstractByteCollection
/*  58:    */  implements ByteList, ByteStack
/*  59:    */{
...
/*  73:    */  }
/*  74:    */  
/*  75: 75 */  public void add(int index, byte k) { throw new UnsupportedOperationException(); }
/*  76:    */  
/*  77:    */  public boolean add(byte k) {
/*  78: 78 */    add(size(), k);
/*  79: 79 */    return true;
/*  80:    */  }
/*  81:    */  
/*  82: 82 */  public byte removeByte(int i) { throw new UnsupportedOperationException(); }
/*  83:    */  
/*  85: 85 */  public byte set(int index, byte k) { throw new UnsupportedOperationException(); }
/*  86:    */  
/*  87:    */  public boolean addAll(int index, Collection<? extends Byte> c) {
/*  88: 88 */    ensureIndex(index);
/*  89: 89 */    int n = c.size();
/*  90: 90 */    if (n == 0) return false;
/*  91: 91 */    Iterator<? extends Byte> i = c.iterator();
/*  92: 92 */    while (n-- != 0) add(index++, (Byte)i.next());
/*  93: 93 */    return true;
/*  94:    */  }
/*  95:    */  
/*  96:    */  public boolean addAll(Collection<? extends Byte> c) {
/*  97: 97 */    return addAll(size(), c);
/*  98:    */  }
/*  99:    */  
/* 100:    */  @Deprecated
/* 101:    */  public ByteListIterator byteListIterator() {
/* 102:102 */    return listIterator();
/* 103:    */  }
/* 104:    */  
/* 105:    */  @Deprecated
/* 106:    */  public ByteListIterator byteListIterator(int index) {
/* 107:107 */    return listIterator(index);
/* 108:    */  }
/* 109:    */  
/* 110:110 */  public ByteListIterator iterator() { return listIterator(); }
/* 111:    */  
/* 112:    */  public ByteListIterator listIterator() {
/* 113:113 */    return listIterator(0);
/* 114:    */  }
/* 115:    */  
/* 116:116 */  public ByteListIterator listIterator(final int index) { new AbstractByteListIterator() {
/* 117:117 */      int last = -1; int pos = index;
/* 118:118 */      public boolean hasNext() { return this.pos < AbstractByteList.this.size(); }
/* 119:119 */      public boolean hasPrevious() { return this.pos > 0; }
/* 120:120 */      public byte nextByte() { if (!hasNext()) throw new NoSuchElementException(); return AbstractByteList.this.getByte(this.last = this.pos++); }
/* 121:121 */      public byte previousByte() { if (!hasPrevious()) throw new NoSuchElementException(); return AbstractByteList.this.getByte(this.last = --this.pos); }
/* 122:122 */      public int nextIndex() { return this.pos; }
/* 123:123 */      public int previousIndex() { return this.pos - 1; }
/* 124:    */      
/* 125:125 */      public void add(byte k) { if (this.last == -1) throw new IllegalStateException();
/* 126:126 */        AbstractByteList.this.add(this.pos++, k);
/* 127:127 */        this.last = -1;
/* 128:    */      }
/* 129:    */      
/* 130:130 */      public void set(byte k) { if (this.last == -1) throw new IllegalStateException();
/* 131:131 */        AbstractByteList.this.set(this.last, k);
/* 132:    */      }
/* 133:    */      
/* 134:134 */      public void remove() { if (this.last == -1) throw new IllegalStateException();
/* 135:135 */        AbstractByteList.this.removeByte(this.last);
/* 136:    */        
...
/* 147:    */  }
/* 148:    */  
/* 149:    */  public int indexOf(byte k) {
/* 150:150 */    ByteListIterator i = listIterator();
/* 151:    */    
...
/* 157:    */  }
/* 158:    */  
/* 159:    */  public int lastIndexOf(byte k) {
/* 160:160 */    ByteListIterator i = listIterator(size());
/* 161:    */    
...
/* 173:    */  }
/* 174:    */  
/* 175:    */  public ByteList subList(int from, int to)
/* 176:    */  {
...
/* 180:    */    }
/* 181:181 */    return new ByteSubList(this, from, to);
/* 182:    */  }
/* 183:    */  
/* 185:    */  @Deprecated
/* 186:    */  public ByteList byteSubList(int from, int to)
/* 187:    */  {
...
/* 203:203 */    ByteListIterator i = listIterator(from);
...
/* 210:    */  }
/* 211:    */  
/* 222:    */  public void addElements(int index, byte[] a, int offset, int length)
/* 223:    */  {
...
/* 228:    */  }
/* 229:    */  
/* 230:    */  public void addElements(int index, byte[] a) {
/* 231:231 */    addElements(index, a, 0, a.length);
/* 232:    */  }
/* 233:    */  
/* 244:    */  public void getElements(int from, byte[] a, int offset, int length)
/* 245:    */  {
/* 246:246 */    ByteListIterator i = listIterator(from);
...
/* 250:250 */    while (length-- != 0) a[(offset++)] = i.nextByte();
/* 251:    */  }
/* 252:    */  
...
/* 274:    */  }
/* 275:    */  
/* 288:    */  public int compareTo(List<? extends Byte> l)
/* 289:    */  {
/* 290:290 */    if (l == this) { return 0;
/* 291:    */    }
/* 292:292 */    if ((l instanceof ByteList))
/* 293:    */    {
/* 294:294 */      ByteListIterator i1 = listIterator();ByteListIterator i2 = ((ByteList)l).listIterator();
/* 295:    */      
/* 298:298 */      while ((i1.hasNext()) && (i2.hasNext())) {
/* 299:299 */        byte e1 = i1.nextByte();
/* 300:300 */        byte e2 = i2.nextByte();
/* 301:301 */        int r; if ((r = e1 == e2 ? 0 : e1 < e2 ? -1 : 1) != 0) return r;
/* 302:    */      }
/* 303:303 */      return i1.hasNext() ? 1 : i2.hasNext() ? -1 : 0;
/* 304:    */    }
/* 305:    */    
/* 306:306 */    ListIterator<? extends Byte> i1 = listIterator();ListIterator<? extends Byte> i2 = l.listIterator();
/* 307:    */    
...
/* 320:    */  {
/* 321:321 */    ByteIterator i = iterator();
...
/* 333:    */  }
/* 334:    */  
/* 335:    */  public byte popByte() {
/* 336:336 */    if (isEmpty()) throw new NoSuchElementException();
/* 337:337 */    return removeByte(size() - 1);
/* 338:    */  }
/* 339:    */  
/* 340:    */  public byte topByte() {
/* 341:341 */    if (isEmpty()) throw new NoSuchElementException();
/* 342:342 */    return getByte(size() - 1);
/* 343:    */  }
/* 344:    */  
/* 345:    */  public byte peekByte(int i) {
/* 346:346 */    return getByte(size() - 1 - i);
/* 347:    */  }
/* 348:    */  
/* 350:    */  public boolean rem(byte k)
/* 351:    */  {
/* 352:352 */    int index = indexOf(k);
/* 353:353 */    if (index == -1) return false;
/* 354:354 */    removeByte(index);
/* 355:355 */    return true;
/* 356:    */  }
/* 357:    */  
/* 358:    */  public boolean remove(Object o)
/* 359:    */  {
/* 360:360 */    return rem(((Byte)o).byteValue());
/* 361:    */  }
/* 362:    */  
/* 363:    */  public boolean addAll(int index, ByteCollection c)
/* 364:    */  {
/* 365:365 */    return addAll(index, c);
/* 366:    */  }
/* 367:    */  
/* 368:    */  public boolean addAll(int index, ByteList l)
/* 369:    */  {
/* 370:370 */    return addAll(index, l);
/* 371:    */  }
/* 372:    */  
/* 373:    */  public boolean addAll(ByteCollection c) {
/* 374:374 */    return addAll(size(), c);
/* 375:    */  }
/* 376:    */  
/* 377:    */  public boolean addAll(ByteList l) {
/* 378:378 */    return addAll(size(), l);
/* 379:    */  }
/* 380:    */  
/* 381:    */  public void add(int index, Byte ok)
/* 382:    */  {
/* 383:383 */    add(index, ok.byteValue());
/* 384:    */  }
/* 385:    */  
/* 386:    */  public Byte set(int index, Byte ok)
/* 387:    */  {
/* 388:388 */    return Byte.valueOf(set(index, ok.byteValue()));
/* 389:    */  }
/* 390:    */  
/* 391:    */  public Byte get(int index)
/* 392:    */  {
/* 393:393 */    return Byte.valueOf(getByte(index));
/* 394:    */  }
/* 395:    */  
/* 396:    */  public int indexOf(Object ok)
/* 397:    */  {
/* 398:398 */    return indexOf(((Byte)ok).byteValue());
/* 399:    */  }
/* 400:    */  
/* 401:    */  public int lastIndexOf(Object ok)
/* 402:    */  {
/* 403:403 */    return lastIndexOf(((Byte)ok).byteValue());
/* 404:    */  }
/* 405:    */  
/* 406:    */  public Byte remove(int index)
/* 407:    */  {
/* 408:408 */    return Byte.valueOf(removeByte(index));
/* 409:    */  }
/* 410:    */  
/* 411:    */  public void push(Byte o)
/* 412:    */  {
/* 413:413 */    push(o.byteValue());
/* 414:    */  }
/* 415:    */  
/* 416:    */  public Byte pop()
/* 417:    */  {
/* 418:418 */    return Byte.valueOf(popByte());
/* 419:    */  }
/* 420:    */  
/* 421:    */  public Byte top()
/* 422:    */  {
/* 423:423 */    return Byte.valueOf(topByte());
/* 424:    */  }
/* 425:    */  
/* 426:    */  public Byte peek(int i)
/* 427:    */  {
/* 428:428 */    return Byte.valueOf(peekByte(i));
/* 429:    */  }
/* 430:    */  
/* 433:    */  public String toString()
/* 434:    */  {
/* 435:435 */    StringBuilder s = new StringBuilder();
/* 436:436 */    ByteIterator i = iterator();
/* 437:437 */    int n = size();
/* 438:    */    
...
/* 488:    */    }
/* 489:    */    
/* 490:    */    public void add(int index, byte k) {
/* 491:491 */      ensureIndex(index);
/* 492:492 */      this.l.add(this.from + index, k);
/* 493:493 */      this.to += 1;
/* 494:    */    }
/* 495:    */    
/* 496:    */    public boolean addAll(int index, Collection<? extends Byte> c)
/* 497:    */    {
...
/* 506:    */    }
/* 507:    */    
/* 508:    */    public byte getByte(int index) {
/* 509:509 */      ensureRestrictedIndex(index);
/* 510:510 */      return this.l.getByte(this.from + index);
/* 511:    */    }
/* 512:    */    
/* 513:    */    public byte removeByte(int index) {
/* 514:514 */      ensureRestrictedIndex(index);
/* 515:515 */      this.to -= 1;
/* 516:516 */      return this.l.removeByte(this.from + index);
/* 517:    */    }
/* 518:    */    
/* 519:    */    public byte set(int index, byte k) {
...
/* 531:    */    }
/* 532:    */    
/* 533:    */    public void getElements(int from, byte[] a, int offset, int length) {
...
/* 544:    */    }
/* 545:    */    
/* 546:    */    public void addElements(int index, byte[] a, int offset, int length)
/* 547:    */    {
...
/* 551:    */    }
/* 552:    */    
/* 553:    */    public ByteListIterator listIterator(final int index)
/* 554:    */    {
/* 555:555 */      ensureIndex(index);
/* 556:    */      
/* 557:557 */      new AbstractByteListIterator() {
/* 558:558 */        int last = -1; int pos = index;
/* 559:    */        
/* 560:560 */        public boolean hasNext() { return this.pos < AbstractByteList.ByteSubList.this.size(); }
/* 561:561 */        public boolean hasPrevious() { return this.pos > 0; }
/* 562:562 */        public byte nextByte() { if (!hasNext()) throw new NoSuchElementException(); return AbstractByteList.ByteSubList.this.l.getByte(AbstractByteList.ByteSubList.this.from + (this.last = this.pos++)); }
/* 563:563 */        public byte previousByte() { if (!hasPrevious()) throw new NoSuchElementException(); return AbstractByteList.ByteSubList.this.l.getByte(AbstractByteList.ByteSubList.this.from + (this.last = --this.pos)); }
/* 564:564 */        public int nextIndex() { return this.pos; }
/* 565:565 */        public int previousIndex() { return this.pos - 1; }
/* 566:    */        
/* 567:567 */        public void add(byte k) { if (this.last == -1) throw new IllegalStateException();
/* 568:568 */          AbstractByteList.ByteSubList.this.add(this.pos++, k);
/* 569:569 */          this.last = -1;
/* 570:    */        }
/* 571:    */        
/* 572:    */        public void set(byte k) {
/* 573:573 */          if (this.last == -1) throw new IllegalStateException();
/* 574:574 */          AbstractByteList.ByteSubList.this.set(this.last, k);
/* 575:    */        }
/* 576:    */        
/* 577:577 */        public void remove() { if (this.last == -1) throw new IllegalStateException();
/* 578:578 */          AbstractByteList.ByteSubList.this.removeByte(this.last);
/* 579:    */          
...
/* 584:    */    }
/* 585:    */    
/* 586:    */    public ByteList subList(int from, int to)
/* 587:    */    {
...
/* 591:    */      }
/* 592:592 */      return new ByteSubList(this, from, to);
/* 593:    */    }
/* 594:    */    
/* 596:    */    public boolean rem(byte k)
/* 597:    */    {
/* 598:598 */      int index = indexOf(k);
/* 599:599 */      if (index == -1) return false;
/* 600:600 */      this.to -= 1;
/* 601:601 */      this.l.removeByte(this.from + index);
/* 602:    */      
/* 603:603 */      return true;
/* 604:    */    }
/* 605:    */    
/* 606:    */    public boolean remove(Object o) {
/* 607:607 */      return rem(((Byte)o).byteValue());
/* 608:    */    }
/* 609:    */    
/* 610:    */    public boolean addAll(int index, ByteCollection c) {
...
/* 619:    */    }
/* 620:    */    
/* 621:    */    public boolean addAll(int index, ByteList l) {
