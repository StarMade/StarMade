...
/*      */   }
/*      */ 
/*      */   public long add(byte k, long incr)
/*      */   {
...
/*  786 */   public Byte2LongSortedMap tailMap(byte from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Byte2LongSortedMap headMap(byte to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Byte2LongSortedMap subMap(byte from, byte to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Byte2LongLinkedOpenHashMap.ValueIterator(Byte2LongLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Byte2LongLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(long v) {
/* 1113 */           return Byte2LongLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Byte2LongLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Byte2LongLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2LongLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public long previousLong()
/*      */     {
/* 1094 */       return Byte2LongLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Long previous() { return Long.valueOf(Byte2LongLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public long nextLong() { return Byte2LongLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Long next() { return Long.valueOf(Byte2LongLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Byte2LongLinkedOpenHashMap.KeyIterator(Byte2LongLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ByteListIterator iterator() {
/* 1054 */       return new Byte2LongLinkedOpenHashMap.KeyIterator(Byte2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Byte2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(byte k) {
/* 1060 */       return Byte2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(byte k) {
/* 1063 */       int oldSize = Byte2LongLinkedOpenHashMap.this.size;
/* 1064 */       Byte2LongLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Byte2LongLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Byte2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public byte firstByte() {
/* 1071 */       if (Byte2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Byte2LongLinkedOpenHashMap.this.key[Byte2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public byte lastByte() {
/* 1075 */       if (Byte2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Byte2LongLinkedOpenHashMap.this.key[Byte2LongLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2LongLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator(byte k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public byte previousByte() { return Byte2LongLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Byte previous() { return Byte.valueOf(Byte2LongLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public byte nextByte() { return Byte2LongLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Byte next() { return Byte.valueOf(Byte2LongLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Byte2LongMap.Entry>
...
/*      */     {
/*  966 */       return new Byte2LongLinkedOpenHashMap.EntryIterator(Byte2LongLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Byte2LongMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Byte2LongMap.Entry> subSet(Byte2LongMap.Entry fromElement, Byte2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Byte2LongMap.Entry> headSet(Byte2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Byte2LongMap.Entry> tailSet(Byte2LongMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Byte2LongMap.Entry first() {
/*  973 */       if (Byte2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Byte2LongLinkedOpenHashMap.MapEntry(Byte2LongLinkedOpenHashMap.this, Byte2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Byte2LongMap.Entry last() {
/*  977 */       if (Byte2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Byte2LongLinkedOpenHashMap.MapEntry(Byte2LongLinkedOpenHashMap.this, Byte2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Byte2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Byte2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Byte2LongLinkedOpenHashMap.this.key[pos] == k) return Byte2LongLinkedOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  990 */         pos = pos + 1 & Byte2LongLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Byte2LongLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Byte2LongLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Byte2LongLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Byte2LongLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Byte2LongLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Byte2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Byte2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2LongMap.Entry> iterator(Byte2LongMap.Entry from) {
/* 1018 */       return new Byte2LongLinkedOpenHashMap.EntryIterator(Byte2LongLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2LongMap.Entry> fastIterator() {
/* 1021 */       return new Byte2LongLinkedOpenHashMap.FastEntryIterator(Byte2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2LongMap.Entry> fastIterator(Byte2LongMap.Entry from) {
/* 1024 */       return new Byte2LongLinkedOpenHashMap.FastEntryIterator(Byte2LongLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Byte2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Byte2LongMap.Entry>
/*      */   {
/*  944 */     final AbstractByte2LongMap.BasicEntry entry = new AbstractByte2LongMap.BasicEntry((byte)0, 0L);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Byte2LongLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Byte2LongLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractByte2LongMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Byte2LongLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Byte2LongLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Byte2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Byte2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Byte2LongMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Byte2LongLinkedOpenHashMap.MapEntry(Byte2LongLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Byte2LongLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Byte2LongLinkedOpenHashMap.MapEntry(Byte2LongLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Byte2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Byte2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Byte2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Byte2LongLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(byte from) {
/*  809 */       if (Byte2LongLinkedOpenHashMap.this.key[Byte2LongLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Byte2LongLinkedOpenHashMap.this.last;
/*  811 */         this.index = Byte2LongLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Byte2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Byte2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Byte2LongLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Byte2LongLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Byte2LongLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Byte2LongLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Byte2LongLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Byte2LongLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Byte2LongLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Byte2LongLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Byte2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Byte2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Byte2LongLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Byte2LongLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Byte2LongLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Byte2LongLinkedOpenHashMap.this.link[this.prev] ^= (Byte2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Byte2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Byte2LongLinkedOpenHashMap.this.link[this.next] ^= (Byte2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Byte2LongLinkedOpenHashMap.this.mask;
/*  897 */         while (Byte2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Byte2LongLinkedOpenHashMap.this.key[pos]) & Byte2LongLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Byte2LongLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Byte2LongLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Byte2LongLinkedOpenHashMap.this.key[last] = Byte2LongLinkedOpenHashMap.this.key[pos];
/*  904 */         Byte2LongLinkedOpenHashMap.this.value[last] = Byte2LongLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Byte2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Byte2LongLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Byte getKey() {
/*  669 */       return Byte.valueOf(Byte2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public byte getByteKey() {
/*  672 */       return Byte2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Long getValue() {
/*  675 */       return Long.valueOf(Byte2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public long getLongValue() {
/*  678 */       return Byte2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public long setValue(long v) {
/*  681 */       long oldValue = Byte2LongLinkedOpenHashMap.this.value[this.index];
/*  682 */       Byte2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Long setValue(Long v) {
...
/*  692 */       return (Byte2LongLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Byte2LongLinkedOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Byte2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Byte2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
