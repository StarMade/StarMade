...
/*      */ 
/*      */ public class Byte2FloatAVLTreeMap extends AbstractByte2FloatSortedMap
...
/*  117 */           return Byte2FloatAVLTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  120 */           return Byte2FloatAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     float oldValue = put(ok.byteValue(), ov.floatValue());
/*  780 */     return this.modified ? null : Float.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Float remove(Object ok)
/*      */   {
/*  788 */     float oldValue = remove(((Byte)ok).byteValue());
...
/* 1203 */         final Comparator<? super Byte2FloatMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Byte2FloatMap.Entry x, Byte2FloatMap.Entry y) {
/* 1205 */             return Byte2FloatAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Byte2FloatAVLTreeMap.EntryIterator(Byte2FloatAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Byte2FloatMap.Entry> iterator(Byte2FloatMap.Entry from) {
/* 1215 */           return new Byte2FloatAVLTreeMap.EntryIterator(Byte2FloatAVLTreeMap.this, ((Byte)from.getKey()).byteValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Byte2FloatAVLTreeMap.Entry f = Byte2FloatAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1228 */           Byte2FloatAVLTreeMap.Entry f = Byte2FloatAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1229 */           if (f != null) Byte2FloatAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Byte2FloatAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Byte2FloatAVLTreeMap.this.clear(); } 
/* 1234 */         public Byte2FloatMap.Entry first() { return Byte2FloatAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Byte2FloatMap.Entry last() { return Byte2FloatAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Byte2FloatMap.Entry> subSet(Byte2FloatMap.Entry from, Byte2FloatMap.Entry to) { return Byte2FloatAVLTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2FloatEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Byte2FloatMap.Entry> headSet(Byte2FloatMap.Entry to) { return Byte2FloatAVLTreeMap.this.headMap((Byte)to.getKey()).byte2FloatEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Byte2FloatMap.Entry> tailSet(Byte2FloatMap.Entry from) { return Byte2FloatAVLTreeMap.this.tailMap((Byte)from.getKey()).byte2FloatEntrySet(); }
/*      */       };
...
/* 1304 */           return new Byte2FloatAVLTreeMap.ValueIterator(Byte2FloatAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(float k) {
/* 1307 */           return Byte2FloatAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Byte2FloatAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Byte2FloatAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Byte2FloatAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readByte(), s.readFloat());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readByte(), s.readFloat());
/* 1759 */       top.right(new Entry(s.readByte(), s.readFloat()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Byte2FloatAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Byte2FloatAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Byte2FloatAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Byte2FloatAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Byte2FloatMap.Entry> iterator() {
/* 1391 */             return new Byte2FloatAVLTreeMap.Submap.SubmapEntryIterator(Byte2FloatAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Byte2FloatMap.Entry> iterator(Byte2FloatMap.Entry from) {
/* 1394 */             return new Byte2FloatAVLTreeMap.Submap.SubmapEntryIterator(Byte2FloatAVLTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
/*      */           }
/* 1396 */           public Comparator<? super Byte2FloatMap.Entry> comparator() { return Byte2FloatAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Byte2FloatAVLTreeMap.Entry f = Byte2FloatAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1402 */             return (f != null) && (Byte2FloatAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Byte2FloatAVLTreeMap.Entry f = Byte2FloatAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1409 */             if ((f != null) && (Byte2FloatAVLTreeMap.Submap.this.in(f.key))) Byte2FloatAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Byte2FloatAVLTreeMap.Submap.SubmapIterator(Byte2FloatAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Byte2FloatAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Byte2FloatMap.Entry first() { return Byte2FloatAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Byte2FloatMap.Entry last() { return Byte2FloatAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Byte2FloatMap.Entry> subSet(Byte2FloatMap.Entry from, Byte2FloatMap.Entry to) { return Byte2FloatAVLTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2FloatEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Byte2FloatMap.Entry> headSet(Byte2FloatMap.Entry to) { return Byte2FloatAVLTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2FloatEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Byte2FloatMap.Entry> tailSet(Byte2FloatMap.Entry from) { return Byte2FloatAVLTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2FloatEntrySet(); }
/*      */         };
...
/*      */           public FloatIterator iterator() {
/* 1442 */             return new Byte2FloatAVLTreeMap.Submap.SubmapValueIterator(Byte2FloatAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(float k) {
/* 1445 */             return Byte2FloatAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Byte2FloatAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Byte2FloatAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(byte k) {
/* 1458 */       return (in(k)) && (Byte2FloatAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(float v) {
...
/* 1473 */       return (in(kk)) && ((e = Byte2FloatAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public float put(byte k, float v) {
/* 1476 */       Byte2FloatAVLTreeMap.this.modified = false;
...
/* 1478 */       float oldValue = Byte2FloatAVLTreeMap.this.put(k, v);
/* 1479 */       return Byte2FloatAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Float put(Byte ok, Float ov) {
/* 1482 */       float oldValue = put(ok.byteValue(), ov.floatValue());
/* 1483 */       return Byte2FloatAVLTreeMap.this.modified ? null : Float.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public float remove(byte k) {
/* 1487 */       Byte2FloatAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       float oldValue = Byte2FloatAVLTreeMap.this.remove(k);
/* 1490 */       return Byte2FloatAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Float remove(Object ok) {
/* 1493 */       float oldValue = remove(((Byte)ok).byteValue());
/* 1494 */       return Byte2FloatAVLTreeMap.this.modified ? Float.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1509 */       return Byte2FloatAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Byte2FloatSortedMap headMap(byte to) {
/* 1512 */       if (this.top) return new Submap(Byte2FloatAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Byte2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2FloatAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Byte2FloatSortedMap tailMap(byte from) {
/* 1516 */       if (this.bottom) return new Submap(Byte2FloatAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Byte2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2FloatAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Byte2FloatSortedMap subMap(byte from, byte to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Byte2FloatAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Byte2FloatAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Byte2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Byte2FloatAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Byte2FloatAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Byte2FloatAVLTreeMap.this.tree == null) return null;
/* 1534 */       Byte2FloatAVLTreeMap.Entry e;
/*      */       Byte2FloatAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Byte2FloatAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Byte2FloatAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Byte2FloatAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Byte2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Byte2FloatAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Byte2FloatAVLTreeMap.this.tree == null) return null;
/* 1552 */       Byte2FloatAVLTreeMap.Entry e;
/*      */       Byte2FloatAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Byte2FloatAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Byte2FloatAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Byte2FloatAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Byte2FloatAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public byte firstByteKey() {
/* 1563 */       Byte2FloatAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public byte lastByteKey() {
/* 1568 */       Byte2FloatAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Byte firstKey() {
/* 1573 */       Byte2FloatAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Byte lastKey() {
/* 1578 */       Byte2FloatAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Byte2FloatAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Byte2FloatAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Byte2FloatAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Byte2FloatMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Byte2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Byte2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Byte2FloatAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Byte2FloatAVLTreeMap.Submap.this.bottom) && (Byte2FloatAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Byte2FloatAVLTreeMap.Submap.this.top) && (Byte2FloatAVLTreeMap.this.compare(k, (this.prev = Byte2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Byte2FloatAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Byte2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Byte2FloatAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2FloatAVLTreeMap.this.compare(this.prev.key, Byte2FloatAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Byte2FloatAVLTreeMap.Submap.this.top) && (this.next != null) && (Byte2FloatAVLTreeMap.this.compare(this.next.key, Byte2FloatAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public ByteBidirectionalIterator iterator() { return new Byte2FloatAVLTreeMap.Submap.SubmapKeyIterator(Byte2FloatAVLTreeMap.Submap.this); } 
/* 1433 */       public ByteBidirectionalIterator iterator(byte from) { return new Byte2FloatAVLTreeMap.Submap.SubmapKeyIterator(Byte2FloatAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2FloatAVLTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public ByteBidirectionalIterator iterator() { return new Byte2FloatAVLTreeMap.KeyIterator(Byte2FloatAVLTreeMap.this); } 
/* 1263 */     public ByteBidirectionalIterator iterator(byte from) { return new Byte2FloatAVLTreeMap.KeyIterator(Byte2FloatAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2FloatAVLTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2FloatAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Byte2FloatMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Byte2FloatMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Byte2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Byte2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Byte2FloatAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(byte k) {
/* 1129 */       if ((this.next = Byte2FloatAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Byte2FloatAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Byte2FloatAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Float)e.getValue()).floatValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
