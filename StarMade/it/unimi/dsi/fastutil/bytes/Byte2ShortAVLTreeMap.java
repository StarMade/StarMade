  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2ShortAVLTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2ShortAVLTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2ShortAVLTreeMap(Map<? extends Byte, ? extends Short> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ShortAVLTreeMap(SortedMap<Byte, Short> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ShortAVLTreeMap(Byte2ShortMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ShortAVLTreeMap(Byte2ShortSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ShortAVLTreeMap(byte[] local_k, short[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2ShortAVLTreeMap(byte[] local_k, short[] local_v)
  {
  ...
  {
    short oldValue = put(local_ok.byteValue(), local_ov.shortValue());
    return this.modified ? null : Short.valueOf(oldValue);
  }
  
  public Short remove(Object local_ok)
  {
    short oldValue = remove(((Byte)local_ok).byteValue());
  ...
  public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Byte2ShortMap.Entry> comparator = new Comparator()
        {
          public int compare(Byte2ShortMap.Entry local_x, Byte2ShortMap.Entry local_y)
          {
            return Byte2ShortAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2ShortAVLTreeMap.EntryIterator(Byte2ShortAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from)
        {
          return new Byte2ShortAVLTreeMap.EntryIterator(Byte2ShortAVLTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2ShortAVLTreeMap.Entry local_f = Byte2ShortAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2ShortAVLTreeMap.Entry local_f = Byte2ShortAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2ShortAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry local_to)
        {
          return Byte2ShortAVLTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ShortEntrySet();
        }
        
        public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry local_to)
        {
          return Byte2ShortAVLTreeMap.this.headMap((Byte)local_to.getKey()).byte2ShortEntrySet();
        }
        
        public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from)
        {
          return Byte2ShortAVLTreeMap.this.tailMap((Byte)from.getKey()).byte2ShortEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Byte2ShortAVLTreeMap.ValueIterator(Byte2ShortAVLTreeMap.this, null);
        }
        
        public boolean contains(short local_k)
        {
          return Byte2ShortAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2ShortAVLTreeMap local_c;
    try
    {
      local_c = (Byte2ShortAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readByte(), local_s.readShort());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readByte(), local_s.readShort());
      top.right(new Entry(local_s.readByte(), local_s.readShort()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2ShortAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2ShortAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2ShortAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator()
          {
            return new Byte2ShortAVLTreeMap.Submap.SubmapEntryIterator(Byte2ShortAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from)
          {
            return new Byte2ShortAVLTreeMap.Submap.SubmapEntryIterator(Byte2ShortAVLTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Short> local_e = (Map.Entry)local_o;
            Byte2ShortAVLTreeMap.Entry local_f = Byte2ShortAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2ShortAVLTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Short> local_e = (Map.Entry)local_o;
            Byte2ShortAVLTreeMap.Entry local_f = Byte2ShortAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2ShortAVLTreeMap.Submap.this.in3(local_f.key))) {
              Byte2ShortAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2ShortAVLTreeMap.Submap.SubmapIterator(Byte2ShortAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2ShortAVLTreeMap.Submap.this.clear();
          }
          
          public Byte2ShortMap.Entry first()
          {
            return Byte2ShortAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2ShortMap.Entry last()
          {
            return Byte2ShortAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry local_to)
          {
            return Byte2ShortAVLTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ShortEntrySet();
          }
          
          public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry local_to)
          {
            return Byte2ShortAVLTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2ShortEntrySet();
          }
          
          public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from)
          {
            return Byte2ShortAVLTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ShortEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ShortCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractShortCollection()
        {
          public ShortIterator iterator()
          {
            return new Byte2ShortAVLTreeMap.Submap.SubmapValueIterator(Byte2ShortAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(short local_k)
          {
            return Byte2ShortAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2ShortAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2ShortAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2ShortAVLTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2ShortAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public short put(byte local_k, short local_v)
    {
      ...
      short oldValue = Byte2ShortAVLTreeMap.this.put(local_k, local_v);
    ...
    public short remove(byte local_k)
    {
      ...
      short oldValue = Byte2ShortAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2ShortAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2ShortAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2ShortAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2ShortSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2ShortAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ShortAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2ShortSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2ShortAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2ShortAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2ShortAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2ShortAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2ShortAVLTreeMap.this.locateKey(this.from);
        if (Byte2ShortAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2ShortAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2ShortAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2ShortAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2ShortAVLTreeMap.this.locateKey(this.field_47);
        if (Byte2ShortAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2ShortAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2ShortAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2ShortAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2ShortAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2ShortAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2ShortAVLTreeMap.Submap.this.bottom) && (Byte2ShortAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2ShortAVLTreeMap.Submap.this.top) && (Byte2ShortAVLTreeMap.this.compare(local_k, (this.prev = Byte2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2ShortAVLTreeMap.this.locateKey(local_k);
            if (Byte2ShortAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2ShortAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ShortAVLTreeMap.this.compare(this.prev.key, Byte2ShortAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2ShortAVLTreeMap.Submap.this.top) && (this.next != null) && (Byte2ShortAVLTreeMap.this.compare(this.next.key, Byte2ShortAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2ShortSortedMap.KeySet
    {
      ...
      {
        return new Byte2ShortAVLTreeMap.Submap.SubmapKeyIterator(Byte2ShortAVLTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2ShortAVLTreeMap.Submap.SubmapKeyIterator(Byte2ShortAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2ShortSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2ShortAVLTreeMap.KeyIterator(Byte2ShortAVLTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2ShortAVLTreeMap.KeyIterator(Byte2ShortAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2ShortAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2ShortAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Byte2ShortMap.Entry
  {
    ...
    Entry(byte local_k, short local_v)
    {
      this.key = local_k;
      this.value = local_v;
