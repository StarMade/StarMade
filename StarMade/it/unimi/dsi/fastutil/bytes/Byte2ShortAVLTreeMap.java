...
/*      */ 
/*      */ public class Byte2ShortAVLTreeMap extends AbstractByte2ShortSortedMap
...
/*  117 */           return Byte2ShortAVLTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  120 */           return Byte2ShortAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     short oldValue = put(ok.byteValue(), ov.shortValue());
/*  780 */     return this.modified ? null : Short.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Short remove(Object ok)
/*      */   {
/*  788 */     short oldValue = remove(((Byte)ok).byteValue());
...
/* 1203 */         final Comparator<? super Byte2ShortMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Byte2ShortMap.Entry x, Byte2ShortMap.Entry y) {
/* 1205 */             return Byte2ShortAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Byte2ShortAVLTreeMap.EntryIterator(Byte2ShortAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from) {
/* 1215 */           return new Byte2ShortAVLTreeMap.EntryIterator(Byte2ShortAVLTreeMap.this, ((Byte)from.getKey()).byteValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1228 */           Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1229 */           if (f != null) Byte2ShortAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Byte2ShortAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Byte2ShortAVLTreeMap.this.clear(); } 
/* 1234 */         public Byte2ShortMap.Entry first() { return Byte2ShortAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Byte2ShortMap.Entry last() { return Byte2ShortAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry to) { return Byte2ShortAVLTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ShortEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry to) { return Byte2ShortAVLTreeMap.this.headMap((Byte)to.getKey()).byte2ShortEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from) { return Byte2ShortAVLTreeMap.this.tailMap((Byte)from.getKey()).byte2ShortEntrySet(); }
/*      */       };
...
/* 1304 */           return new Byte2ShortAVLTreeMap.ValueIterator(Byte2ShortAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(short k) {
/* 1307 */           return Byte2ShortAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Byte2ShortAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Byte2ShortAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Byte2ShortAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readByte(), s.readShort());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readByte(), s.readShort());
/* 1759 */       top.right(new Entry(s.readByte(), s.readShort()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Byte2ShortAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Byte2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Byte2ShortAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Byte2ShortAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator() {
/* 1391 */             return new Byte2ShortAVLTreeMap.Submap.SubmapEntryIterator(Byte2ShortAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from) {
/* 1394 */             return new Byte2ShortAVLTreeMap.Submap.SubmapEntryIterator(Byte2ShortAVLTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
/*      */           }
/* 1396 */           public Comparator<? super Byte2ShortMap.Entry> comparator() { return Byte2ShortAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1402 */             return (f != null) && (Byte2ShortAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Byte2ShortAVLTreeMap.Entry f = Byte2ShortAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1409 */             if ((f != null) && (Byte2ShortAVLTreeMap.Submap.this.in(f.key))) Byte2ShortAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Byte2ShortAVLTreeMap.Submap.SubmapIterator(Byte2ShortAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Byte2ShortAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Byte2ShortMap.Entry first() { return Byte2ShortAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Byte2ShortMap.Entry last() { return Byte2ShortAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry to) { return Byte2ShortAVLTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ShortEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry to) { return Byte2ShortAVLTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2ShortEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from) { return Byte2ShortAVLTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ShortEntrySet(); }
/*      */         };
...
/*      */           public ShortIterator iterator() {
/* 1442 */             return new Byte2ShortAVLTreeMap.Submap.SubmapValueIterator(Byte2ShortAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(short k) {
/* 1445 */             return Byte2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Byte2ShortAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Byte2ShortAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(byte k) {
/* 1458 */       return (in(k)) && (Byte2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(short v) {
...
/* 1473 */       return (in(kk)) && ((e = Byte2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public short put(byte k, short v) {
/* 1476 */       Byte2ShortAVLTreeMap.this.modified = false;
...
/* 1478 */       short oldValue = Byte2ShortAVLTreeMap.this.put(k, v);
/* 1479 */       return Byte2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Short put(Byte ok, Short ov) {
/* 1482 */       short oldValue = put(ok.byteValue(), ov.shortValue());
/* 1483 */       return Byte2ShortAVLTreeMap.this.modified ? null : Short.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public short remove(byte k) {
/* 1487 */       Byte2ShortAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       short oldValue = Byte2ShortAVLTreeMap.this.remove(k);
/* 1490 */       return Byte2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Short remove(Object ok) {
/* 1493 */       short oldValue = remove(((Byte)ok).byteValue());
/* 1494 */       return Byte2ShortAVLTreeMap.this.modified ? Short.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1509 */       return Byte2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Byte2ShortSortedMap headMap(byte to) {
/* 1512 */       if (this.top) return new Submap(Byte2ShortAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Byte2ShortAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2ShortAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Byte2ShortSortedMap tailMap(byte from) {
/* 1516 */       if (this.bottom) return new Submap(Byte2ShortAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Byte2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ShortAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Byte2ShortSortedMap subMap(byte from, byte to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Byte2ShortAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Byte2ShortAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Byte2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Byte2ShortAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Byte2ShortAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Byte2ShortAVLTreeMap.this.tree == null) return null;
/* 1534 */       Byte2ShortAVLTreeMap.Entry e;
/*      */       Byte2ShortAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Byte2ShortAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Byte2ShortAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Byte2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Byte2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Byte2ShortAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Byte2ShortAVLTreeMap.this.tree == null) return null;
/* 1552 */       Byte2ShortAVLTreeMap.Entry e;
/*      */       Byte2ShortAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Byte2ShortAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Byte2ShortAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Byte2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Byte2ShortAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public byte firstByteKey() {
/* 1563 */       Byte2ShortAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public byte lastByteKey() {
/* 1568 */       Byte2ShortAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Byte firstKey() {
/* 1573 */       Byte2ShortAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Byte lastKey() {
/* 1578 */       Byte2ShortAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Byte2ShortAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Byte2ShortAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Byte2ShortAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Byte2ShortMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Byte2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Byte2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Byte2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Byte2ShortAVLTreeMap.Submap.this.bottom) && (Byte2ShortAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Byte2ShortAVLTreeMap.Submap.this.top) && (Byte2ShortAVLTreeMap.this.compare(k, (this.prev = Byte2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Byte2ShortAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Byte2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Byte2ShortAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ShortAVLTreeMap.this.compare(this.prev.key, Byte2ShortAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Byte2ShortAVLTreeMap.Submap.this.top) && (this.next != null) && (Byte2ShortAVLTreeMap.this.compare(this.next.key, Byte2ShortAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public ByteBidirectionalIterator iterator() { return new Byte2ShortAVLTreeMap.Submap.SubmapKeyIterator(Byte2ShortAVLTreeMap.Submap.this); } 
/* 1433 */       public ByteBidirectionalIterator iterator(byte from) { return new Byte2ShortAVLTreeMap.Submap.SubmapKeyIterator(Byte2ShortAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2ShortAVLTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public ByteBidirectionalIterator iterator() { return new Byte2ShortAVLTreeMap.KeyIterator(Byte2ShortAVLTreeMap.this); } 
/* 1263 */     public ByteBidirectionalIterator iterator(byte from) { return new Byte2ShortAVLTreeMap.KeyIterator(Byte2ShortAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2ShortAVLTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2ShortAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Byte2ShortMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Byte2ShortMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Byte2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Byte2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Byte2ShortAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(byte k) {
/* 1129 */       if ((this.next = Byte2ShortAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Byte2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Byte2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
