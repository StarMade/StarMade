...
public abstract interface Byte2ReferenceMap<V> extends Byte2ReferenceFunction<V>, Map<Byte, V>
{
  ...
  public static abstract interface Entry<V> extends Map.Entry<Byte, V>
  {
    public abstract byte getByteKey();
  }

  public static abstract interface FastEntrySet<V> extends ObjectSet<Byte2ReferenceMap.Entry<V>>
  {
