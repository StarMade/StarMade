...
/*  13:    */
/*  89:    */public class ByteLinkedOpenCustomHashSet
/*  90:    */  extends AbstractByteSortedSet
...
/* 110:    */  
/* 114:    */  protected ByteHash.Strategy strategy;
/* 115:    */  
/* 120:    */  public ByteLinkedOpenCustomHashSet(int expected, float f, ByteHash.Strategy strategy)
/* 121:    */  {
...
/* 129:129 */    this.key = new byte[this.n];
/* 130:130 */    this.used = new boolean[this.n];
/* 131:131 */    this.link = new long[this.n];
/* 132:    */  }
/* 133:    */  
/* 137:    */  public ByteLinkedOpenCustomHashSet(int expected, ByteHash.Strategy strategy)
/* 138:    */  {
/* 139:139 */    this(expected, 0.75F, strategy);
/* 140:    */  }
/* 141:    */  
/* 144:    */  public ByteLinkedOpenCustomHashSet(ByteHash.Strategy strategy)
/* 145:    */  {
/* 146:146 */    this(16, 0.75F, strategy);
/* 147:    */  }
/* 148:    */  
/* 153:    */  public ByteLinkedOpenCustomHashSet(Collection<? extends Byte> c, float f, ByteHash.Strategy strategy)
/* 154:    */  {
/* 155:155 */    this(c.size(), f, strategy);
/* 156:156 */    addAll(c);
/* 157:    */  }
/* 158:    */  
/* 163:    */  public ByteLinkedOpenCustomHashSet(Collection<? extends Byte> c, ByteHash.Strategy strategy)
/* 164:    */  {
/* 165:165 */    this(c, 0.75F, strategy);
/* 166:    */  }
/* 167:    */  
/* 172:    */  public ByteLinkedOpenCustomHashSet(ByteCollection c, float f, ByteHash.Strategy strategy)
/* 173:    */  {
/* 174:174 */    this(c.size(), f, strategy);
/* 175:175 */    addAll(c);
/* 176:    */  }
/* 177:    */  
/* 182:    */  public ByteLinkedOpenCustomHashSet(ByteCollection c, ByteHash.Strategy strategy)
/* 183:    */  {
/* 184:184 */    this(c, 0.75F, strategy);
/* 185:    */  }
/* 186:    */  
/* 191:    */  public ByteLinkedOpenCustomHashSet(ByteIterator i, float f, ByteHash.Strategy strategy)
/* 192:    */  {
/* 193:193 */    this(16, f, strategy);
/* 194:194 */    while (i.hasNext()) { add(i.nextByte());
/* 195:    */    }
/* 196:    */  }
/* 197:    */  
/* 200:    */  public ByteLinkedOpenCustomHashSet(ByteIterator i, ByteHash.Strategy strategy)
/* 201:    */  {
/* 202:202 */    this(i, 0.75F, strategy);
/* 203:    */  }
/* 204:    */  
/* 209:    */  public ByteLinkedOpenCustomHashSet(Iterator<?> i, float f, ByteHash.Strategy strategy)
/* 210:    */  {
/* 211:211 */    this(ByteIterators.asByteIterator(i), f, strategy);
/* 212:    */  }
/* 213:    */  
/* 217:    */  public ByteLinkedOpenCustomHashSet(Iterator<?> i, ByteHash.Strategy strategy)
/* 218:    */  {
/* 219:219 */    this(ByteIterators.asByteIterator(i), strategy);
/* 220:    */  }
/* 221:    */  
/* 228:    */  public ByteLinkedOpenCustomHashSet(byte[] a, int offset, int length, float f, ByteHash.Strategy strategy)
/* 229:    */  {
/* 230:230 */    this(length < 0 ? 0 : length, f, strategy);
/* 231:231 */    ByteArrays.ensureOffsetLength(a, offset, length);
/* 232:232 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 233:    */    }
/* 234:    */  }
/* 235:    */  
/* 240:    */  public ByteLinkedOpenCustomHashSet(byte[] a, int offset, int length, ByteHash.Strategy strategy)
/* 241:    */  {
/* 242:242 */    this(a, offset, length, 0.75F, strategy);
/* 243:    */  }
/* 244:    */  
/* 249:    */  public ByteLinkedOpenCustomHashSet(byte[] a, float f, ByteHash.Strategy strategy)
/* 250:    */  {
/* 251:251 */    this(a, 0, a.length, f, strategy);
/* 252:    */  }
/* 253:    */  
/* 258:    */  public ByteLinkedOpenCustomHashSet(byte[] a, ByteHash.Strategy strategy)
/* 259:    */  {
/* 260:260 */    this(a, 0.75F, strategy);
/* 261:    */  }
/* 262:    */  
/* 265:    */  public ByteHash.Strategy strategy()
/* 266:    */  {
/* 267:267 */    return this.strategy;
/* 268:    */  }
/* 269:    */  
/* 273:    */  public boolean add(byte k)
/* 274:    */  {
...
/* 319:    */  }
/* 320:    */  
/* 321:    */  public boolean remove(byte k)
/* 322:    */  {
...
/* 336:    */  }
/* 337:    */  
/* 338:    */  public boolean contains(byte k)
/* 339:    */  {
...
/* 347:    */  }
/* 348:    */  
/* 351:    */  public byte removeFirstByte()
/* 352:    */  {
...
/* 361:    */    }
/* 362:362 */    byte k = this.key[pos];
/* 363:363 */    shiftKeys(pos);
/* 364:364 */    return k;
/* 365:    */  }
/* 366:    */  
/* 369:    */  public byte removeLastByte()
/* 370:    */  {
...
/* 419:    */  }
/* 420:    */  
/* 424:    */  public boolean addAndMoveToFirst(byte k)
/* 425:    */  {
/* 426:426 */    byte[] key = this.key;
...
/* 454:    */  }
/* 455:    */  
/* 459:    */  public boolean addAndMoveToLast(byte k)
/* 460:    */  {
...
/* 592:    */  }
/* 593:    */  
/* 596:    */  public byte firstByte()
/* 597:    */  {
/* 598:598 */    if (this.size == 0) throw new NoSuchElementException();
/* 599:599 */    return this.key[this.first];
/* 600:    */  }
/* 601:    */  
/* 604:    */  public byte lastByte()
/* 605:    */  {
/* 606:606 */    if (this.size == 0) throw new NoSuchElementException();
/* 607:607 */    return this.key[this.last]; }
/* 608:    */  
/* 609:609 */  public ByteSortedSet tailSet(byte from) { throw new UnsupportedOperationException(); }
/* 610:610 */  public ByteSortedSet headSet(byte to) { throw new UnsupportedOperationException(); }
/* 611:611 */  public ByteSortedSet subSet(byte from, byte to) { throw new UnsupportedOperationException(); }
/* 612:612 */  public ByteComparator comparator() { return null; }
/* 613:    */  
/* 618:    */  private class SetIterator
/* 619:    */    extends AbstractByteListIterator
/* 620:    */  {
/* 621:621 */    int prev = -1;
/* 622:    */    
/* 623:623 */    int next = -1;
...
/* 627:627 */    int index = -1;
/* 628:    */    
/* 629:629 */    SetIterator() { this.next = ByteLinkedOpenCustomHashSet.this.first;
/* 630:630 */      this.index = 0;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    SetIterator(byte from) { if (ByteLinkedOpenCustomHashSet.this.strategy.equals(ByteLinkedOpenCustomHashSet.this.key[ByteLinkedOpenCustomHashSet.this.last], from)) {
/* 634:634 */        this.prev = ByteLinkedOpenCustomHashSet.this.last;
/* 635:635 */        this.index = ByteLinkedOpenCustomHashSet.this.size;
/* 636:    */      }
/* 637:    */      else
/* 638:    */      {
/* 639:639 */        int pos = HashCommon.murmurHash3(ByteLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & ByteLinkedOpenCustomHashSet.this.mask;
/* 640:    */        
/* 641:641 */        while (ByteLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 642:642 */          if (ByteLinkedOpenCustomHashSet.this.strategy.equals(ByteLinkedOpenCustomHashSet.this.key[pos], from))
/* 643:    */          {
/* 644:644 */            this.next = ((int)ByteLinkedOpenCustomHashSet.this.link[pos]);
/* 645:645 */            this.prev = pos;
/* 646:646 */            return;
/* 647:    */          }
/* 648:648 */          pos = pos + 1 & ByteLinkedOpenCustomHashSet.this.mask;
/* 649:    */        }
...
/* 655:    */    
/* 656:656 */    public byte nextByte() { if (!hasNext()) throw new NoSuchElementException();
/* 657:657 */      this.curr = this.next;
/* 658:658 */      this.next = ((int)ByteLinkedOpenCustomHashSet.this.link[this.curr]);
/* 659:659 */      this.prev = this.curr;
/* 660:660 */      if (this.index >= 0) { this.index += 1;
/* 661:    */      }
/* 662:662 */      return ByteLinkedOpenCustomHashSet.this.key[this.curr];
/* 663:    */    }
/* 664:    */    
/* 665:665 */    public byte previousByte() { if (!hasPrevious()) throw new NoSuchElementException();
/* 666:666 */      this.curr = this.prev;
/* 667:667 */      this.prev = ((int)(ByteLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 668:668 */      this.next = this.curr;
/* 669:669 */      if (this.index >= 0) this.index -= 1;
/* 670:670 */      return ByteLinkedOpenCustomHashSet.this.key[this.curr];
/* 671:    */    }
/* 672:    */    
...
/* 679:679 */        this.index = ByteLinkedOpenCustomHashSet.this.size;
/* 680:680 */        return;
/* 681:    */      }
/* 682:682 */      int pos = ByteLinkedOpenCustomHashSet.this.first;
/* 683:683 */      this.index = 1;
/* 684:684 */      while (pos != this.prev) {
/* 685:685 */        pos = (int)ByteLinkedOpenCustomHashSet.this.link[pos];
...
/* 705:705 */        this.prev = ((int)(ByteLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 706:    */      }
/* 707:    */      else {
/* 708:708 */        this.next = ((int)ByteLinkedOpenCustomHashSet.this.link[this.curr]); }
/* 709:709 */      ByteLinkedOpenCustomHashSet.this.size -= 1;
/* 710:    */      
/* 712:712 */      if (this.prev == -1) { ByteLinkedOpenCustomHashSet.this.first = this.next;
/* 713:    */      } else
/* 714:714 */        ByteLinkedOpenCustomHashSet.this.link[this.prev] ^= (ByteLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/* 715:715 */      if (this.next == -1) { ByteLinkedOpenCustomHashSet.this.last = this.prev;
/* 716:    */      } else
/* 717:717 */        ByteLinkedOpenCustomHashSet.this.link[this.next] ^= (ByteLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/* 718:718 */      int pos = this.curr;
/* 719:    */      int last;
/* 720:    */      for (;;) {
/* 721:721 */        pos = (last = pos) + 1 & ByteLinkedOpenCustomHashSet.this.mask;
/* 722:722 */        while (ByteLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 723:723 */          int slot = HashCommon.murmurHash3(ByteLinkedOpenCustomHashSet.this.strategy.hashCode(ByteLinkedOpenCustomHashSet.this.key[pos])) & ByteLinkedOpenCustomHashSet.this.mask;
/* 724:724 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 725:725 */          pos = pos + 1 & ByteLinkedOpenCustomHashSet.this.mask;
/* 726:    */        }
/* 727:727 */        if (ByteLinkedOpenCustomHashSet.this.used[pos] == 0) break;
/* 728:728 */        ByteLinkedOpenCustomHashSet.this.key[last] = ByteLinkedOpenCustomHashSet.this.key[pos];
/* 729:729 */        if (this.next == pos) this.next = last;
/* 730:730 */        if (this.prev == pos) this.prev = last;
/* 731:731 */        ByteLinkedOpenCustomHashSet.this.fixPointers(pos, last);
/* 732:    */      }
/* 733:733 */      ByteLinkedOpenCustomHashSet.this.used[last] = false;
/* 734:734 */      this.curr = -1;
/* 735:    */    }
/* 736:    */  }
/* 737:    */  
/* 743:    */  public ByteListIterator iterator(byte from)
/* 744:    */  {
/* 745:745 */    return new SetIterator(from);
/* 746:    */  }
/* 747:    */  
/* 748:748 */  public ByteListIterator iterator() { return new SetIterator(); }
/* 749:    */  
/* 759:    */  @Deprecated
...
/* 824:    */    
/* 825:825 */    byte[] key = this.key;
/* 826:826 */    int newMask = newN - 1;
/* 827:827 */    byte[] newKey = new byte[newN];
...
/* 863:    */  }
/* 864:    */  
/* 867:    */  public ByteLinkedOpenCustomHashSet clone()
/* 868:    */  {
/* 869:    */    ByteLinkedOpenCustomHashSet c;
/* 870:    */    
/* 872:    */    try
/* 873:    */    {
/* 874:874 */      c = (ByteLinkedOpenCustomHashSet)super.clone();
/* 875:    */    }
/* 876:    */    catch (CloneNotSupportedException cantHappen) {
/* 877:877 */      throw new InternalError();
/* 878:    */    }
/* 879:879 */    c.key = ((byte[])this.key.clone());
...
/* 902:    */  }
/* 903:    */  
/* 904:904 */  private void writeObject(ObjectOutputStream s) throws IOException { ByteIterator i = iterator();
/* 905:905 */    s.defaultWriteObject();
/* 906:906 */    for (int j = this.size; j-- != 0; s.writeByte(i.nextByte())) {}
/* 907:    */  }
/* 908:    */  
...
/* 914:914 */    byte[] key = this.key = new byte[this.n];
