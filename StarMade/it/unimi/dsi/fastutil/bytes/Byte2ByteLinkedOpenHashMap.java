  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2ByteLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2ByteLinkedOpenHashMap(Map<? extends Byte, ? extends Byte> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2ByteLinkedOpenHashMap(Map<? extends Byte, ? extends Byte> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2ByteLinkedOpenHashMap(Byte2ByteMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2ByteLinkedOpenHashMap(Byte2ByteMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2ByteLinkedOpenHashMap(byte[] local_k, byte[] local_v, float local_f)
  {
  ...
  public Byte2ByteLinkedOpenHashMap(byte[] local_k, byte[] local_v)
  {
  ...
  public byte add(byte local_k, byte incr)
  {
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k)
      {
  ...
  public byte getAndMoveToFirst(byte local_k)
  {
    byte[] key = this.key;
  ...
  public byte getAndMoveToLast(byte local_k)
  {
    byte[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public byte putAndMoveToFirst(byte local_k, byte local_v)
  {
    byte[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public byte putAndMoveToLast(byte local_k, byte local_v)
  {
    byte[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Byte2ByteLinkedOpenHashMap.ValueIterator(Byte2ByteLinkedOpenHashMap.this);
        }
        ...
        {
          return Byte2ByteLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2ByteLinkedOpenHashMap local_c;
    try
    {
      local_c = (Byte2ByteLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2ByteLinkedOpenHashMap.MapIterator
    implements ByteListIterator
  {
    public byte previousByte()
    {
      return Byte2ByteLinkedOpenHashMap.this.value[previousEntry()];
    }
    
    public Byte previous()
    {
      return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Byte2ByteLinkedOpenHashMap.this.value[nextEntry()];
    }
    
    public Byte next()
    {
      return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSortedSet
  {
    ...
    {
      return new Byte2ByteLinkedOpenHashMap.KeyIterator(Byte2ByteLinkedOpenHashMap.this, from);
    }
    
    public ByteListIterator iterator()
    {
      return new Byte2ByteLinkedOpenHashMap.KeyIterator(Byte2ByteLinkedOpenHashMap.this);
    }
    ...
    {
      return Byte2ByteLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2ByteLinkedOpenHashMap.this.size;
      Byte2ByteLinkedOpenHashMap.this.remove(local_k);
    ...
    implements ByteListIterator
  {
    ...
    public byte previousByte()
    {
      return Byte2ByteLinkedOpenHashMap.this.key[previousEntry()];
    }
    ...
    public Byte previous()
    {
      return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public byte nextByte()
    {
      return Byte2ByteLinkedOpenHashMap.this.key[nextEntry()];
    }
    
    public Byte next()
    {
      return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2ByteSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Byte2ByteLinkedOpenHashMap.EntryIterator(Byte2ByteLinkedOpenHashMap.this);
    }
    ...
    public Byte2ByteMap.Entry first()
    {
      ...
      return new Byte2ByteLinkedOpenHashMap.MapEntry(Byte2ByteLinkedOpenHashMap.this, Byte2ByteLinkedOpenHashMap.this.first);
    }
    ...
    public Byte2ByteMap.Entry last()
    {
      ...
      return new Byte2ByteLinkedOpenHashMap.MapEntry(Byte2ByteLinkedOpenHashMap.this, Byte2ByteLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2ByteLinkedOpenHashMap.this.mask; Byte2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask) {
        if (Byte2ByteLinkedOpenHashMap.this.key[pos] == local_k) {
          return Byte2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2ByteLinkedOpenHashMap.this.mask; Byte2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask) {
        if (Byte2ByteLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Byte2ByteLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Byte2ByteLinkedOpenHashMap.EntryIterator(Byte2ByteLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
    }
    
    public ObjectBidirectionalIterator<Byte2ByteMap.Entry> fastIterator()
    {
      return new Byte2ByteLinkedOpenHashMap.FastEntryIterator(Byte2ByteLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Byte2ByteMap.Entry> fastIterator(Byte2ByteMap.Entry from)
    {
      return new Byte2ByteLinkedOpenHashMap.FastEntryIterator(Byte2ByteLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
    }
  }
    ...
    implements ObjectListIterator<Byte2ByteMap.Entry>
  {
    ...
    public AbstractByte2ByteMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2ByteLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Byte2ByteLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Byte2ByteMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2ByteLinkedOpenHashMap.MapEntry(Byte2ByteLinkedOpenHashMap.this, nextEntry());
    }
    
    public Byte2ByteLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Byte2ByteLinkedOpenHashMap.MapEntry(Byte2ByteLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(byte from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Byte2ByteLinkedOpenHashMap.this.mask; Byte2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Byte2ByteLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Byte2ByteLinkedOpenHashMap.this.first = this.next;
      } else {
        Byte2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Byte2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Byte2ByteLinkedOpenHashMap.this.last = this.prev;
      } else {
        Byte2ByteLinkedOpenHashMap.this.link[this.next] ^= (Byte2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2ByteLinkedOpenHashMap.this.mask; Byte2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask)
        {
        ...
        if (Byte2ByteLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Byte2ByteMap.Entry, Map.Entry<Byte, Byte>
  {
    ...
    public Byte getKey()
    {
      return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.key[this.index]);
    }
    ...
    {
      return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.value[this.index]);
    }
    ...
    public byte setValue(byte local_v)
    {
      ...
      Byte2ByteLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Byte> local_e = (Map.Entry)local_o;
      return (Byte2ByteLinkedOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
