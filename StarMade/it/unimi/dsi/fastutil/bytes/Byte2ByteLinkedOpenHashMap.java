...
/*  786 */   public Byte2ByteSortedMap tailMap(byte from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Byte2ByteSortedMap headMap(byte to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Byte2ByteSortedMap subMap(byte from, byte to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Byte2ByteLinkedOpenHashMap.ValueIterator(Byte2ByteLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Byte2ByteLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(byte v) {
/* 1113 */           return Byte2ByteLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Byte2ByteLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Byte2ByteLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public byte previousByte()
/*      */     {
/* 1094 */       return Byte2ByteLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Byte previous() { return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public byte nextByte() { return Byte2ByteLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Byte next() { return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Byte2ByteLinkedOpenHashMap.KeyIterator(Byte2ByteLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ByteListIterator iterator() {
/* 1054 */       return new Byte2ByteLinkedOpenHashMap.KeyIterator(Byte2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Byte2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(byte k) {
/* 1060 */       return Byte2ByteLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(byte k) {
/* 1063 */       int oldSize = Byte2ByteLinkedOpenHashMap.this.size;
/* 1064 */       Byte2ByteLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Byte2ByteLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Byte2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public byte firstByte() {
/* 1071 */       if (Byte2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Byte2ByteLinkedOpenHashMap.this.key[Byte2ByteLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public byte lastByte() {
/* 1075 */       if (Byte2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Byte2ByteLinkedOpenHashMap.this.key[Byte2ByteLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator(byte k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public byte previousByte() { return Byte2ByteLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Byte previous() { return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public byte nextByte() { return Byte2ByteLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Byte next() { return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Byte2ByteMap.Entry>
...
/*      */     {
/*  966 */       return new Byte2ByteLinkedOpenHashMap.EntryIterator(Byte2ByteLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Byte2ByteMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry fromElement, Byte2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Byte2ByteMap.Entry first() {
/*  973 */       if (Byte2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Byte2ByteLinkedOpenHashMap.MapEntry(Byte2ByteLinkedOpenHashMap.this, Byte2ByteLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Byte2ByteMap.Entry last() {
/*  977 */       if (Byte2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Byte2ByteLinkedOpenHashMap.MapEntry(Byte2ByteLinkedOpenHashMap.this, Byte2ByteLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Byte2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Byte2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Byte2ByteLinkedOpenHashMap.this.key[pos] == k) return Byte2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/*  990 */         pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Byte2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Byte2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Byte2ByteLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Byte2ByteLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Byte2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Byte2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from) {
/* 1018 */       return new Byte2ByteLinkedOpenHashMap.EntryIterator(Byte2ByteLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2ByteMap.Entry> fastIterator() {
/* 1021 */       return new Byte2ByteLinkedOpenHashMap.FastEntryIterator(Byte2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2ByteMap.Entry> fastIterator(Byte2ByteMap.Entry from) {
/* 1024 */       return new Byte2ByteLinkedOpenHashMap.FastEntryIterator(Byte2ByteLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Byte2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Byte2ByteMap.Entry>
/*      */   {
/*  944 */     final AbstractByte2ByteMap.BasicEntry entry = new AbstractByte2ByteMap.BasicEntry((byte)0, (byte)0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Byte2ByteLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Byte2ByteLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractByte2ByteMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Byte2ByteLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Byte2ByteLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Byte2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Byte2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Byte2ByteMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Byte2ByteLinkedOpenHashMap.MapEntry(Byte2ByteLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Byte2ByteLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Byte2ByteLinkedOpenHashMap.MapEntry(Byte2ByteLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Byte2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Byte2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Byte2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Byte2ByteLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(byte from) {
/*  809 */       if (Byte2ByteLinkedOpenHashMap.this.key[Byte2ByteLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Byte2ByteLinkedOpenHashMap.this.last;
/*  811 */         this.index = Byte2ByteLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Byte2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Byte2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Byte2ByteLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Byte2ByteLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Byte2ByteLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Byte2ByteLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Byte2ByteLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Byte2ByteLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Byte2ByteLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Byte2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Byte2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Byte2ByteLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Byte2ByteLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Byte2ByteLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Byte2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Byte2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Byte2ByteLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Byte2ByteLinkedOpenHashMap.this.link[this.next] ^= (Byte2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Byte2ByteLinkedOpenHashMap.this.mask;
/*  897 */         while (Byte2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Byte2ByteLinkedOpenHashMap.this.key[pos]) & Byte2ByteLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Byte2ByteLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Byte2ByteLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Byte2ByteLinkedOpenHashMap.this.key[last] = Byte2ByteLinkedOpenHashMap.this.key[pos];
/*  904 */         Byte2ByteLinkedOpenHashMap.this.value[last] = Byte2ByteLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Byte2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Byte2ByteLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Byte getKey() {
/*  669 */       return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public byte getByteKey() {
/*  672 */       return Byte2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Byte getValue() {
/*  675 */       return Byte.valueOf(Byte2ByteLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public byte getByteValue() {
/*  678 */       return Byte2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public byte setValue(byte v) {
/*  681 */       byte oldValue = Byte2ByteLinkedOpenHashMap.this.value[this.index];
/*  682 */       Byte2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Byte setValue(Byte v) {
...
/*  692 */       return (Byte2ByteLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Byte2ByteLinkedOpenHashMap.this.key[this.index] ^ Byte2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Byte2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
