...
/*     */     {
/*  92 */       while (n-- != 0) {
/*  93 */         Byte2BooleanMap.Entry e = (Byte2BooleanMap.Entry)i.next();
/*  94 */         put(e.getByteKey(), e.getBooleanValue());
/*     */       }
/*     */     }
/*     */     else
/*     */     {
...
/* 101 */         put((Byte)e.getKey(), (Boolean)e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 193 */         return AbstractByte2BooleanMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractByte2BooleanMap.this.size(); } 
/* 196 */       public void clear() { AbstractByte2BooleanMap.this.clear(); }
/*     */ 
/*     */       public ByteIterator iterator() {
/* 199 */         return new AbstractByteIterator() {
/* 200 */           final ObjectIterator<Map.Entry<Byte, Boolean>> i = AbstractByte2BooleanMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public byte nextByte() { return ((Byte2BooleanMap.Entry)this.i.next()).getByteKey(); } 
...
/* 226 */         return AbstractByte2BooleanMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractByte2BooleanMap.this.size(); } 
/* 229 */       public void clear() { AbstractByte2BooleanMap.this.clear(); }
/*     */ 
/*     */       public BooleanIterator iterator() {
/* 232 */         return new AbstractBooleanIterator() {
/* 233 */           final ObjectIterator<Map.Entry<Byte, Boolean>> i = AbstractByte2BooleanMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public boolean nextBoolean() { return ((Byte2BooleanMap.Entry)this.i.next()).getBooleanValue(); } 
/*     */           public boolean hasNext() {
...
/*     */   {
/* 246 */     return byte2BooleanEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Byte2BooleanMap.Entry e = (Byte2BooleanMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
