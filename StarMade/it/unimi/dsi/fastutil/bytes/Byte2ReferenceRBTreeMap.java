  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2ReferenceRBTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2ReferenceRBTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2ReferenceRBTreeMap(Map<? extends Byte, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ReferenceRBTreeMap(SortedMap<Byte, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ReferenceRBTreeMap(Byte2ReferenceMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ReferenceRBTreeMap(Byte2ReferenceSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ReferenceRBTreeMap(byte[] local_k, V[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2ReferenceRBTreeMap(byte[] local_k, V[] local_v)
  {
  ...
  {
    Byte2ReferenceRBTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Byte2ReferenceMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Byte2ReferenceRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2ReferenceRBTreeMap.EntryIterator(Byte2ReferenceRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from)
        {
          return new Byte2ReferenceRBTreeMap.EntryIterator(Byte2ReferenceRBTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2ReferenceRBTreeMap.Entry<V> local_f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2ReferenceRBTreeMap.Entry<V> local_f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2ReferenceRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Byte2ReferenceRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> local_to)
        {
          return Byte2ReferenceRBTreeMap.this.headMap((Byte)local_to.getKey()).byte2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from)
        {
          return Byte2ReferenceRBTreeMap.this.tailMap((Byte)from.getKey()).byte2ReferenceEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Byte2ReferenceRBTreeMap.ValueIterator(Byte2ReferenceRBTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Byte2ReferenceRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2ReferenceRBTreeMap<V> local_c;
    try
    {
      local_c = (Byte2ReferenceRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Byte2ReferenceRBTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2ReferenceRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Byte2ReferenceRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2ReferenceRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator()
          {
            return new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Byte2ReferenceRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from)
          {
            return new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Byte2ReferenceRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, V> local_e = (Map.Entry)local_o;
            Byte2ReferenceRBTreeMap.Entry<V> local_f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2ReferenceRBTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, V> local_e = (Map.Entry)local_o;
            Byte2ReferenceRBTreeMap.Entry<V> local_f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2ReferenceRBTreeMap.Submap.this.in3(local_f.key))) {
              Byte2ReferenceRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2ReferenceRBTreeMap.Submap.SubmapIterator(Byte2ReferenceRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2ReferenceRBTreeMap.Submap.this.clear();
          }
          
          public Byte2ReferenceMap.Entry<V> first()
          {
            return Byte2ReferenceRBTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2ReferenceMap.Entry<V> last()
          {
            return Byte2ReferenceRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> local_to)
          {
            return Byte2ReferenceRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> local_to)
          {
            return Byte2ReferenceRBTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from)
          {
            return Byte2ReferenceRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ReferenceEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ReferenceCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractReferenceCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Byte2ReferenceRBTreeMap.Submap.SubmapValueIterator(Byte2ReferenceRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Byte2ReferenceRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2ReferenceRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2ReferenceRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2ReferenceRBTreeMap.Entry<V> local_e;
      return (in3(local_kk)) && ((local_e = Byte2ReferenceRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(byte local_k, V local_v)
    {
      ...
      V oldValue = Byte2ReferenceRBTreeMap.this.put(local_k, local_v);
    ...
    public V remove(byte local_k)
    {
      ...
      V oldValue = Byte2ReferenceRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2ReferenceSortedMap<V> tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2ReferenceRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ReferenceRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2ReferenceSortedMap<V> subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2ReferenceRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2ReferenceRBTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2ReferenceRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2ReferenceRBTreeMap.this.locateKey(this.from);
        if (Byte2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2ReferenceRBTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2ReferenceRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2ReferenceRBTreeMap.this.locateKey(this.field_47);
        if (Byte2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2ReferenceRBTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2ReferenceRBTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Byte2ReferenceRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Byte2ReferenceRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Byte2ReferenceRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2ReferenceRBTreeMap.Submap.this.bottom) && (Byte2ReferenceRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2ReferenceRBTreeMap.Submap.this.top) && (Byte2ReferenceRBTreeMap.this.compare(local_k, (this.prev = Byte2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2ReferenceRBTreeMap.this.locateKey(local_k);
            if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ReferenceRBTreeMap.this.compare(this.prev.key, Byte2ReferenceRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2ReferenceRBTreeMap.this.compare(this.next.key, Byte2ReferenceRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2ReferenceSortedMap.KeySet
    {
      ...
      {
        return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Byte2ReferenceRBTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Byte2ReferenceRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2ReferenceSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2ReferenceRBTreeMap.KeyIterator(Byte2ReferenceRBTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2ReferenceRBTreeMap.KeyIterator(Byte2ReferenceRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2ReferenceRBTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
