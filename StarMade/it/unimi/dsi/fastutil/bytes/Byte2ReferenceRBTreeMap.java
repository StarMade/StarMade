...
/*   20:     */
/*   71:     */public class Byte2ReferenceRBTreeMap<V>
...
/*   89:     */  
/*   90:     */  public Byte2ReferenceRBTreeMap()
/*   91:     */  {
/*   92:  92 */    allocatePaths();
/*   93:     */    
...
/*  119: 119 */          return Byte2ReferenceRBTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*  120:     */        }
/*  121:     */        
/*  122: 122 */        public int compare(Byte ok1, Byte ok2) { return Byte2ReferenceRBTreeMap.this.storedComparator.compare(ok1, ok2); }
/*  123:     */      };
/*  124:     */    }
/*  125:     */  }
/*  126:     */  
/*  133:     */  public Byte2ReferenceRBTreeMap(Comparator<? super Byte> c)
/*  134:     */  {
/*  135: 135 */    this();
...
/*  138:     */  }
/*  139:     */  
/*  145:     */  public Byte2ReferenceRBTreeMap(Map<? extends Byte, ? extends V> m)
/*  146:     */  {
/*  147: 147 */    this();
/*  148: 148 */    putAll(m);
/*  149:     */  }
/*  150:     */  
/*  155:     */  public Byte2ReferenceRBTreeMap(SortedMap<Byte, V> m)
/*  156:     */  {
/*  157: 157 */    this(m.comparator());
/*  158: 158 */    putAll(m);
/*  159:     */  }
/*  160:     */  
/*  165:     */  public Byte2ReferenceRBTreeMap(Byte2ReferenceMap<? extends V> m)
/*  166:     */  {
/*  167: 167 */    this();
/*  168: 168 */    putAll(m);
/*  169:     */  }
/*  170:     */  
/*  175:     */  public Byte2ReferenceRBTreeMap(Byte2ReferenceSortedMap<V> m)
/*  176:     */  {
/*  177: 177 */    this(m.comparator());
/*  178: 178 */    putAll(m);
/*  179:     */  }
/*  180:     */  
/*  188:     */  public Byte2ReferenceRBTreeMap(byte[] k, V[] v, Comparator<? super Byte> c)
/*  189:     */  {
/*  190: 190 */    this(c);
...
/*  194:     */  }
/*  195:     */  
/*  201:     */  public Byte2ReferenceRBTreeMap(byte[] k, V[] v)
/*  202:     */  {
...
/*  231:     */  }
/*  232:     */  
/*  240:     */  final Entry<V> findKey(byte k)
/*  241:     */  {
...
/*  248:     */  }
/*  249:     */  
/*  256:     */  final Entry<V> locateKey(byte k)
/*  257:     */  {
...
/*  724:     */  }
/*  725:     */  
/*  728:     */  public V put(Byte ok, V ov)
/*  729:     */  {
/*  730: 730 */    V oldValue = put(ok.byteValue(), ov);
/*  731: 731 */    return this.modified ? this.defRetValue : oldValue;
/*  732:     */  }
/*  733:     */  
/*  735:     */  public V remove(Object ok)
/*  736:     */  {
/*  737: 737 */    V oldValue = remove(((Byte)ok).byteValue());
/*  738: 738 */    return this.modified ? oldValue : this.defRetValue;
/*  739:     */  }
/*  740:     */  
/*  742:     */  public boolean containsValue(Object v)
/*  743:     */  {
/*  744: 744 */    Byte2ReferenceRBTreeMap<V>.ValueIterator i = new ValueIterator(null);
/*  745:     */    
...
/*  769:     */    implements Cloneable, Byte2ReferenceMap.Entry<V>
/*  770:     */  {
...
/*  965: 965 */      Map.Entry<Byte, V> e = (Map.Entry)o;
/*  966: 966 */      return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == e.getValue());
/*  967:     */    }
/*  968:     */    
...
/*  974:     */  }
/*  975:     */  
/* 1004:     */  public boolean containsKey(byte k)
/* 1005:     */  {
...
/* 1013:     */  }
/* 1014:     */  
/* 1015:     */  public V get(byte k) {
/* 1016:1016 */    Entry<V> e = findKey(k);
/* 1017:1017 */    return e == null ? this.defRetValue : e.value;
/* 1018:     */  }
/* 1019:     */  
/* 1020:1020 */  public byte firstByteKey() { if (this.tree == null) throw new NoSuchElementException();
/* 1021:1021 */    return this.firstEntry.key;
/* 1022:     */  }
/* 1023:     */  
/* 1024:1024 */  public byte lastByteKey() { if (this.tree == null) throw new NoSuchElementException();
/* 1025:1025 */    return this.lastEntry.key;
/* 1026:     */  }
/* 1027:     */  
/* 1030:     */  private class TreeIterator
/* 1031:     */  {
/* 1032:     */    Byte2ReferenceRBTreeMap.Entry<V> prev;
/* 1033:     */    
/* 1035:     */    Byte2ReferenceRBTreeMap.Entry<V> next;
/* 1036:     */    
/* 1037:     */    Byte2ReferenceRBTreeMap.Entry<V> curr;
/* 1038:     */    
/* 1039:1039 */    int index = 0;
/* 1040:     */    
/* 1041:1041 */    TreeIterator() { this.next = Byte2ReferenceRBTreeMap.this.firstEntry; }
/* 1042:     */    
/* 1043:     */    TreeIterator(byte k) {
/* 1044:1044 */      if ((this.next = Byte2ReferenceRBTreeMap.this.locateKey(k)) != null)
/* 1045:1045 */        if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1056:     */    
/* 1057:     */    Byte2ReferenceRBTreeMap.Entry<V> nextEntry() {
...
/* 1066:     */    
/* 1067:     */    Byte2ReferenceRBTreeMap.Entry<V> previousEntry() {
...
/* 1088:1088 */      Byte2ReferenceRBTreeMap.this.remove(this.curr.key);
...
/* 1104:     */    extends Byte2ReferenceRBTreeMap<V>.TreeIterator
/* 1105:     */    implements ObjectListIterator<Byte2ReferenceMap.Entry<V>>
/* 1106:     */  {
/* 1107:1107 */    EntryIterator() { super(); }
/* 1108:     */    
/* 1109:1109 */    EntryIterator(byte k) { super(k); }
/* 1110:     */    
/* 1111:1111 */    public Byte2ReferenceMap.Entry<V> next() { return nextEntry(); }
/* 1112:1112 */    public Byte2ReferenceMap.Entry<V> previous() { return previousEntry(); }
/* 1113:1113 */    public void set(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/* 1114:1114 */    public void add(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/* 1115:     */  }
/* 1116:     */  
/* 1117:1117 */  public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1118:1118 */        final Comparator<? super Byte2ReferenceMap.Entry<V>> comparator = new Comparator() {
/* 1119:     */          public int compare(Byte2ReferenceMap.Entry<V> x, Byte2ReferenceMap.Entry<V> y) {
/* 1120:1120 */            return Byte2ReferenceRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/* 1121:     */          }
/* 1122:     */        };
/* 1123:     */        
/* 1124:1124 */        public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() { return this.comparator; }
/* 1125:     */        
/* 1126:     */        public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator() {
/* 1127:1127 */          return new Byte2ReferenceRBTreeMap.EntryIterator(Byte2ReferenceRBTreeMap.this);
/* 1128:     */        }
/* 1129:     */        
/* 1130:1130 */        public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) { return new Byte2ReferenceRBTreeMap.EntryIterator(Byte2ReferenceRBTreeMap.this, ((Byte)from.getKey()).byteValue()); }
/* 1131:     */        
/* 1132:     */        public boolean contains(Object o)
/* 1133:     */        {
/* 1134:1134 */          if (!(o instanceof Map.Entry)) return false;
/* 1135:1135 */          Map.Entry<Byte, V> e = (Map.Entry)o;
/* 1136:1136 */          Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1137:1137 */          return e.equals(f);
/* 1138:     */        }
/* 1139:     */        
/* 1140:     */        public boolean remove(Object o) {
/* 1141:1141 */          if (!(o instanceof Map.Entry)) return false;
/* 1142:1142 */          Map.Entry<Byte, V> e = (Map.Entry)o;
/* 1143:1143 */          Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1144:1144 */          if (f != null) Byte2ReferenceRBTreeMap.this.remove(f.key);
/* 1145:1145 */          return f != null; }
/* 1146:     */        
/* 1147:1147 */        public int size() { return Byte2ReferenceRBTreeMap.this.count; }
/* 1148:1148 */        public void clear() { Byte2ReferenceRBTreeMap.this.clear(); }
/* 1149:1149 */        public Byte2ReferenceMap.Entry<V> first() { return Byte2ReferenceRBTreeMap.this.firstEntry; }
/* 1150:1150 */        public Byte2ReferenceMap.Entry<V> last() { return Byte2ReferenceRBTreeMap.this.lastEntry; }
/* 1151:1151 */        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) { return Byte2ReferenceRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ReferenceEntrySet(); }
/* 1152:1152 */        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) { return Byte2ReferenceRBTreeMap.this.headMap((Byte)to.getKey()).byte2ReferenceEntrySet(); }
/* 1153:1153 */        public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) { return Byte2ReferenceRBTreeMap.this.tailMap((Byte)from.getKey()).byte2ReferenceEntrySet(); }
/* 1154:     */      };
/* 1155:1155 */    return this.entries;
/* 1156:     */  }
/* 1157:     */  
/* 1160:     */  private final class KeyIterator
/* 1161:     */    extends Byte2ReferenceRBTreeMap.TreeIterator
/* 1162:     */    implements ByteListIterator
/* 1163:     */  {
/* 1164:1164 */    public KeyIterator() { super(); }
/* 1165:1165 */    public KeyIterator(byte k) { super(k); }
/* 1166:1166 */    public byte nextByte() { return nextEntry().key; }
/* 1167:1167 */    public byte previousByte() { return previousEntry().key; }
/* 1168:1168 */    public void set(byte k) { throw new UnsupportedOperationException(); }
/* 1169:1169 */    public void add(byte k) { throw new UnsupportedOperationException(); }
/* 1170:1170 */    public Byte next() { return Byte.valueOf(nextEntry().key); }
/* 1171:1171 */    public Byte previous() { return Byte.valueOf(previousEntry().key); }
/* 1172:1172 */    public void set(Byte ok) { throw new UnsupportedOperationException(); }
/* 1173:1173 */    public void add(Byte ok) { throw new UnsupportedOperationException(); }
/* 1174:     */  }
/* 1175:     */  
/* 1176:1176 */  private class KeySet extends AbstractByte2ReferenceSortedMap.KeySet { private KeySet() { super(); }
/* 1177:1177 */    public ByteBidirectionalIterator iterator() { return new Byte2ReferenceRBTreeMap.KeyIterator(Byte2ReferenceRBTreeMap.this); }
/* 1178:1178 */    public ByteBidirectionalIterator iterator(byte from) { return new Byte2ReferenceRBTreeMap.KeyIterator(Byte2ReferenceRBTreeMap.this, from); }
/* 1179:     */  }
/* 1180:     */  
/* 1187:     */  public ByteSortedSet keySet()
/* 1188:     */  {
...
/* 1195:     */    extends Byte2ReferenceRBTreeMap<V>.TreeIterator
...
/* 1215:1215 */          return new Byte2ReferenceRBTreeMap.ValueIterator(Byte2ReferenceRBTreeMap.this, null);
/* 1216:     */        }
/* 1217:     */        
/* 1218:1218 */        public boolean contains(Object k) { return Byte2ReferenceRBTreeMap.this.containsValue(k); }
/* 1219:     */        
/* 1220:     */        public int size() {
/* 1221:1221 */          return Byte2ReferenceRBTreeMap.this.count;
/* 1222:     */        }
/* 1223:     */        
/* 1224:1224 */        public void clear() { Byte2ReferenceRBTreeMap.this.clear(); }
/* 1225:     */      };
/* 1226:     */    }
/* 1227:1227 */    return this.values;
/* 1228:     */  }
/* 1229:     */  
/* 1230:1230 */  public ByteComparator comparator() { return this.actualComparator; }
/* 1231:     */  
/* 1232:     */  public Byte2ReferenceSortedMap<V> headMap(byte to) {
/* 1233:1233 */    return new Submap((byte)0, true, to, false);
/* 1234:     */  }
/* 1235:     */  
/* 1236:1236 */  public Byte2ReferenceSortedMap<V> tailMap(byte from) { return new Submap(from, false, (byte)0, true); }
/* 1237:     */  
/* 1238:     */  public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) {
/* 1239:1239 */    return new Submap(from, false, to, false);
/* 1240:     */  }
/* 1241:     */  
/* 1245:     */  private final class Submap
/* 1246:     */    extends AbstractByte2ReferenceSortedMap<V>
...
/* 1262:     */    boolean top;
/* 1263:     */    
/* 1265:     */    protected volatile transient ObjectSortedSet<Byte2ReferenceMap.Entry<V>> entries;
/* 1266:     */    
/* 1268:     */    protected volatile transient ByteSortedSet keys;
/* 1269:     */    
/* 1271:     */    protected volatile transient ReferenceCollection<V> values;
/* 1272:     */    
/* 1275:     */    public Submap(byte from, boolean bottom, byte to, boolean top)
/* 1276:     */    {
/* 1277:1277 */      if ((!bottom) && (!top) && (Byte2ReferenceRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278:1278 */      this.from = from;
/* 1279:1279 */      this.bottom = bottom;
/* 1280:1280 */      this.to = to;
/* 1281:1281 */      this.top = top;
/* 1282:1282 */      this.defRetValue = Byte2ReferenceRBTreeMap.this.defRetValue;
/* 1283:     */    }
/* 1284:     */    
/* 1285:1285 */    public void clear() { Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
...
/* 1290:     */    }
/* 1291:     */    
/* 1294:     */    final boolean in(byte k)
/* 1295:     */    {
/* 1296:1296 */      return ((this.bottom) || (Byte2ReferenceRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Byte2ReferenceRBTreeMap.this.compare(k, this.to) < 0));
/* 1297:     */    }
/* 1298:     */    
/* 1299:     */    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
/* 1300:1300 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1301:     */          public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator() {
/* 1302:1302 */            return new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Byte2ReferenceRBTreeMap.Submap.this);
/* 1303:     */          }
/* 1304:     */          
/* 1305:1305 */          public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) { return new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Byte2ReferenceRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue()); }
/* 1306:     */          
/* 1307:1307 */          public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() { return Byte2ReferenceRBTreeMap.this.byte2ReferenceEntrySet().comparator(); }
/* 1308:     */          
/* 1309:     */          public boolean contains(Object o) {
/* 1310:1310 */            if (!(o instanceof Map.Entry)) return false;
/* 1311:1311 */            Map.Entry<Byte, V> e = (Map.Entry)o;
/* 1312:1312 */            Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1313:1313 */            return (f != null) && (Byte2ReferenceRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1314:     */          }
/* 1315:     */          
/* 1316:     */          public boolean remove(Object o) {
/* 1317:1317 */            if (!(o instanceof Map.Entry)) return false;
/* 1318:1318 */            Map.Entry<Byte, V> e = (Map.Entry)o;
/* 1319:1319 */            Byte2ReferenceRBTreeMap.Entry<V> f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1320:1320 */            if ((f != null) && (Byte2ReferenceRBTreeMap.Submap.this.in(f.key))) Byte2ReferenceRBTreeMap.Submap.this.remove(f.key);
...
/* 1326:1326 */            return c; }
/* 1327:     */          
/* 1328:1328 */          public boolean isEmpty() { return !new Byte2ReferenceRBTreeMap.Submap.SubmapIterator(Byte2ReferenceRBTreeMap.Submap.this).hasNext(); }
/* 1329:1329 */          public void clear() { Byte2ReferenceRBTreeMap.Submap.this.clear(); }
/* 1330:1330 */          public Byte2ReferenceMap.Entry<V> first() { return Byte2ReferenceRBTreeMap.Submap.this.firstEntry(); }
/* 1331:1331 */          public Byte2ReferenceMap.Entry<V> last() { return Byte2ReferenceRBTreeMap.Submap.this.lastEntry(); }
/* 1332:1332 */          public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) { return Byte2ReferenceRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ReferenceEntrySet(); }
/* 1333:1333 */          public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) { return Byte2ReferenceRBTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2ReferenceEntrySet(); }
/* 1334:1334 */          public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) { return Byte2ReferenceRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ReferenceEntrySet(); }
/* 1335:     */        };
/* 1336:1336 */      return this.entries; }
/* 1337:     */    
/* 1338:1338 */    private class KeySet extends AbstractByte2ReferenceSortedMap.KeySet { private KeySet() { super(); }
/* 1339:1339 */      public ByteBidirectionalIterator iterator() { return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Byte2ReferenceRBTreeMap.Submap.this); }
/* 1340:1340 */      public ByteBidirectionalIterator iterator(byte from) { return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Byte2ReferenceRBTreeMap.Submap.this, from); }
/* 1341:     */    }
/* 1342:     */    
/* 1343:1343 */    public ByteSortedSet keySet() { if (this.keys == null) this.keys = new KeySet(null);
...
/* 1349:1349 */            return new Byte2ReferenceRBTreeMap.Submap.SubmapValueIterator(Byte2ReferenceRBTreeMap.Submap.this, null);
/* 1350:     */          }
/* 1351:     */          
/* 1352:1352 */          public boolean contains(Object k) { return Byte2ReferenceRBTreeMap.Submap.this.containsValue(k); }
/* 1353:     */          
/* 1354:     */          public int size() {
/* 1355:1355 */            return Byte2ReferenceRBTreeMap.Submap.this.size();
/* 1356:     */          }
/* 1357:     */          
/* 1358:1358 */          public void clear() { Byte2ReferenceRBTreeMap.Submap.this.clear(); }
/* 1359:     */        };
/* 1360:     */      }
/* 1361:1361 */      return this.values;
/* 1362:     */    }
/* 1363:     */    
/* 1365:1365 */    public boolean containsKey(byte k) { return (in(k)) && (Byte2ReferenceRBTreeMap.this.containsKey(k)); }
/* 1366:     */    
/* 1367:     */    public boolean containsValue(Object v) {
/* 1368:1368 */      Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
/* 1369:     */      
...
/* 1375:     */    }
/* 1376:     */    
/* 1377:     */    public V get(byte k)
/* 1378:     */    {
/* 1379:1379 */      byte kk = k;
/* 1380:1380 */      Byte2ReferenceRBTreeMap.Entry<V> e; return (in(kk)) && ((e = Byte2ReferenceRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1381:     */    }
/* 1382:     */    
/* 1383:1383 */    public V put(byte k, V v) { Byte2ReferenceRBTreeMap.this.modified = false;
...
/* 1385:1385 */      V oldValue = Byte2ReferenceRBTreeMap.this.put(k, v);
/* 1386:1386 */      return Byte2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1387:     */    }
/* 1388:     */    
/* 1389:1389 */    public V put(Byte ok, V ov) { V oldValue = put(ok.byteValue(), ov);
/* 1390:1390 */      return Byte2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1391:     */    }
/* 1392:     */    
/* 1393:     */    public V remove(byte k) {
/* 1394:1394 */      Byte2ReferenceRBTreeMap.this.modified = false;
/* 1395:1395 */      if (!in(k)) return this.defRetValue;
/* 1396:1396 */      V oldValue = Byte2ReferenceRBTreeMap.this.remove(k);
/* 1397:1397 */      return Byte2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1398:     */    }
/* 1399:     */    
/* 1400:1400 */    public V remove(Object ok) { V oldValue = remove(((Byte)ok).byteValue());
/* 1401:1401 */      return Byte2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1402:     */    }
/* 1403:     */    
/* 1404:1404 */    public int size() { Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
/* 1405:1405 */      int n = 0;
...
/* 1414:     */    
/* 1416:1416 */    public ByteComparator comparator() { return Byte2ReferenceRBTreeMap.this.actualComparator; }
/* 1417:     */    
/* 1418:     */    public Byte2ReferenceSortedMap<V> headMap(byte to) {
/* 1419:1419 */      if (this.top) return new Submap(Byte2ReferenceRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420:1420 */      return Byte2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2ReferenceRBTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1421:     */    }
/* 1422:     */    
/* 1423:1423 */    public Byte2ReferenceSortedMap<V> tailMap(byte from) { if (this.bottom) return new Submap(Byte2ReferenceRBTreeMap.this, from, false, this.to, this.top);
/* 1424:1424 */      return Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ReferenceRBTreeMap.this, from, false, this.to, this.top) : this;
/* 1425:     */    }
/* 1426:     */    
/* 1427:1427 */    public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) { if ((this.top) && (this.bottom)) return new Submap(Byte2ReferenceRBTreeMap.this, from, false, to, false);
/* 1428:1428 */      if (!this.top) to = Byte2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429:1429 */      if (!this.bottom) from = Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430:1430 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431:1431 */      return new Submap(Byte2ReferenceRBTreeMap.this, from, false, to, false);
/* 1432:     */    }
/* 1433:     */    
/* 1436:     */    public Byte2ReferenceRBTreeMap.Entry<V> firstEntry()
/* 1437:     */    {
/* 1438:1438 */      if (Byte2ReferenceRBTreeMap.this.tree == null) return null;
/* 1439:     */      Byte2ReferenceRBTreeMap.Entry<V> e;
/* 1440:     */      Byte2ReferenceRBTreeMap.Entry<V> e;
/* 1441:1441 */      if (this.bottom) { e = Byte2ReferenceRBTreeMap.this.firstEntry;
/* 1442:     */      } else {
/* 1443:1443 */        e = Byte2ReferenceRBTreeMap.this.locateKey(this.from);
/* 1444:     */        
/* 1445:1445 */        if (Byte2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1446:     */        }
/* 1447:     */      }
/* 1448:1448 */      if ((e == null) || ((!this.top) && (Byte2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449:1449 */      return e;
/* 1450:     */    }
/* 1451:     */    
/* 1454:     */    public Byte2ReferenceRBTreeMap.Entry<V> lastEntry()
/* 1455:     */    {
/* 1456:1456 */      if (Byte2ReferenceRBTreeMap.this.tree == null) return null;
/* 1457:     */      Byte2ReferenceRBTreeMap.Entry<V> e;
/* 1458:     */      Byte2ReferenceRBTreeMap.Entry<V> e;
/* 1459:1459 */      if (this.top) { e = Byte2ReferenceRBTreeMap.this.lastEntry;
/* 1460:     */      } else {
/* 1461:1461 */        e = Byte2ReferenceRBTreeMap.this.locateKey(this.to);
/* 1462:     */        
/* 1463:1463 */        if (Byte2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1464:     */        }
/* 1465:     */      }
/* 1466:1466 */      if ((e == null) || ((!this.bottom) && (Byte2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467:1467 */      return e;
/* 1468:     */    }
/* 1469:     */    
/* 1470:1470 */    public byte firstByteKey() { Byte2ReferenceRBTreeMap.Entry<V> e = firstEntry();
/* 1471:1471 */      if (e == null) throw new NoSuchElementException();
/* 1472:1472 */      return e.key;
/* 1473:     */    }
/* 1474:     */    
/* 1475:1475 */    public byte lastByteKey() { Byte2ReferenceRBTreeMap.Entry<V> e = lastEntry();
/* 1476:1476 */      if (e == null) throw new NoSuchElementException();
/* 1477:1477 */      return e.key;
/* 1478:     */    }
/* 1479:     */    
/* 1480:1480 */    public Byte firstKey() { Byte2ReferenceRBTreeMap.Entry<V> e = firstEntry();
/* 1481:1481 */      if (e == null) throw new NoSuchElementException();
/* 1482:1482 */      return e.getKey();
/* 1483:     */    }
/* 1484:     */    
/* 1485:1485 */    public Byte lastKey() { Byte2ReferenceRBTreeMap.Entry<V> e = lastEntry();
/* 1486:1486 */      if (e == null) throw new NoSuchElementException();
/* 1487:1487 */      return e.getKey();
/* 1488:     */    }
/* 1489:     */    
/* 1492:     */    private class SubmapIterator
/* 1493:     */      extends Byte2ReferenceRBTreeMap.TreeIterator
/* 1494:     */    {
/* 1495:     */      SubmapIterator()
/* 1496:     */      {
/* 1497:1497 */        super();
/* 1498:1498 */        this.next = Byte2ReferenceRBTreeMap.Submap.this.firstEntry();
/* 1499:     */      }
/* 1500:     */      
/* 1501:1501 */      SubmapIterator(byte k) { this();
/* 1502:1502 */        if (this.next != null)
/* 1503:1503 */          if ((!Byte2ReferenceRBTreeMap.Submap.this.bottom) && (Byte2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504:1504 */          } else if ((!Byte2ReferenceRBTreeMap.Submap.this.top) && (Byte2ReferenceRBTreeMap.this.compare(k, (this.prev = Byte2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1505:     */          } else {
/* 1506:1506 */            this.next = Byte2ReferenceRBTreeMap.this.locateKey(k);
/* 1507:1507 */            if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517:1517 */        if ((!Byte2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ReferenceRBTreeMap.this.compare(this.prev.key, Byte2ReferenceRBTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1518:     */      }
/* 1519:     */      
/* 1520:1520 */      void updateNext() { this.next = this.next.next();
/* 1521:1521 */        if ((!Byte2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2ReferenceRBTreeMap.this.compare(this.next.key, Byte2ReferenceRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1522:     */      }
/* 1523:     */    }
/* 1524:     */    
/* 1525:1525 */    private class SubmapEntryIterator extends Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> { SubmapEntryIterator() { super(); }
/* 1526:     */      
/* 1527:1527 */      SubmapEntryIterator(byte k) { super(k); }
/* 1528:     */      
/* 1529:1529 */      public Byte2ReferenceMap.Entry<V> next() { return nextEntry(); }
/* 1530:1530 */      public Byte2ReferenceMap.Entry<V> previous() { return previousEntry(); }
/* 1531:1531 */      public void set(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/* 1532:1532 */      public void add(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/* 1533:     */    }
/* 1534:     */    
/* 1539:     */    private final class SubmapKeyIterator
/* 1540:     */      extends Byte2ReferenceRBTreeMap.Submap.SubmapIterator
/* 1541:     */      implements ByteListIterator
/* 1542:     */    {
/* 1543:1543 */      public SubmapKeyIterator() { super(); }
/* 1544:1544 */      public SubmapKeyIterator(byte from) { super(from); }
/* 1545:1545 */      public byte nextByte() { return nextEntry().key; }
/* 1546:1546 */      public byte previousByte() { return previousEntry().key; }
/* 1547:1547 */      public void set(byte k) { throw new UnsupportedOperationException(); }
/* 1548:1548 */      public void add(byte k) { throw new UnsupportedOperationException(); }
/* 1549:1549 */      public Byte next() { return Byte.valueOf(nextEntry().key); }
/* 1550:1550 */      public Byte previous() { return Byte.valueOf(previousEntry().key); }
/* 1551:1551 */      public void set(Byte ok) { throw new UnsupportedOperationException(); }
/* 1552:1552 */      public void add(Byte ok) { throw new UnsupportedOperationException(); }
/* 1553:     */    }
/* 1554:     */    
/* 1558:     */    private final class SubmapValueIterator
/* 1559:     */      extends Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/* 1568:     */  }
/* 1569:     */  
/* 1573:     */  public Byte2ReferenceRBTreeMap<V> clone()
/* 1574:     */  {
/* 1575:     */    Byte2ReferenceRBTreeMap<V> c;
/* 1576:     */    
/* 1578:     */    try
/* 1579:     */    {
/* 1580:1580 */      c = (Byte2ReferenceRBTreeMap)super.clone();
/* 1581:     */    }
...
/* 1634:1634 */    Byte2ReferenceRBTreeMap<V>.EntryIterator i = new EntryIterator();
/* 1635:     */    
/* 1636:1636 */    s.defaultWriteObject();
/* 1637:1637 */    while (n-- != 0) {
/* 1638:1638 */      Entry<V> e = i.nextEntry();
/* 1639:1639 */      s.writeByte(e.key);
...
/* 1651:     */  {
/* 1652:1652 */    if (n == 1) {
/* 1653:1653 */      Entry<V> top = new Entry(s.readByte(), s.readObject());
...
/* 1659:1659 */    if (n == 2)
/* 1660:     */    {
/* 1662:1662 */      Entry<V> top = new Entry(s.readByte(), s.readObject());
/* 1663:1663 */      top.black(true);
/* 1664:1664 */      top.right(new Entry(s.readByte(), s.readObject()));
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.bytes.Byte2ReferenceRBTreeMap
