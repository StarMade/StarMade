...
/*  119 */           return Byte2ReferenceRBTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  122 */           return Byte2ReferenceRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     Object oldValue = put(ok.byteValue(), ov);
/*  731 */     return this.modified ? this.defRetValue : oldValue;
/*      */   }
/*      */ 
/*      */   public V remove(Object ok)
/*      */   {
/*  737 */     Object oldValue = remove(((Byte)ok).byteValue());
...
/* 1118 */         final Comparator<? super Byte2ReferenceMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Byte2ReferenceMap.Entry<V> x, Byte2ReferenceMap.Entry<V> y) {
/* 1120 */             return Byte2ReferenceRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Byte2ReferenceRBTreeMap.EntryIterator(Byte2ReferenceRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) {
/* 1130 */           return new Byte2ReferenceRBTreeMap.EntryIterator(Byte2ReferenceRBTreeMap.this, ((Byte)from.getKey()).byteValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Byte2ReferenceRBTreeMap.Entry f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1143 */           Byte2ReferenceRBTreeMap.Entry f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1144 */           if (f != null) Byte2ReferenceRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Byte2ReferenceRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Byte2ReferenceRBTreeMap.this.clear(); } 
/* 1149 */         public Byte2ReferenceMap.Entry<V> first() { return Byte2ReferenceRBTreeMap.this.firstEntry; } 
/* 1150 */         public Byte2ReferenceMap.Entry<V> last() { return Byte2ReferenceRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) { return Byte2ReferenceRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ReferenceEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) { return Byte2ReferenceRBTreeMap.this.headMap((Byte)to.getKey()).byte2ReferenceEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) { return Byte2ReferenceRBTreeMap.this.tailMap((Byte)from.getKey()).byte2ReferenceEntrySet(); }
/*      */       };
...
/* 1215 */           return new Byte2ReferenceRBTreeMap.ValueIterator(Byte2ReferenceRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Byte2ReferenceRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Byte2ReferenceRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Byte2ReferenceRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/* 1233 */     return new Submap((byte)0, true, to, false);
/*      */   }
/*      */   public Byte2ReferenceSortedMap<V> tailMap(byte from) {
/* 1236 */     return new Submap(from, false, (byte)0, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1580 */       c = (Byte2ReferenceRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1652 */     if (n == 1) {
/* 1653 */       Entry top = new Entry(s.readByte(), s.readObject());
/* 1654 */       top.pred(pred);
/* 1655 */       top.succ(succ);
/* 1656 */       top.black(true);
/* 1657 */       return top;
...
/* 1659 */     if (n == 2)
/*      */     {
/* 1662 */       Entry top = new Entry(s.readByte(), s.readObject());
/* 1663 */       top.black(true);
/* 1664 */       top.right(new Entry(s.readByte(), s.readObject()));
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Byte2ReferenceRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Byte2ReferenceRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Byte2ReferenceRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> byte2ReferenceEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator() {
/* 1302 */             return new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Byte2ReferenceRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) {
/* 1305 */             return new Byte2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Byte2ReferenceRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
/*      */           }
/* 1307 */           public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() { return Byte2ReferenceRBTreeMap.this.byte2ReferenceEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Byte2ReferenceRBTreeMap.Entry f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1313 */             return (f != null) && (Byte2ReferenceRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Byte2ReferenceRBTreeMap.Entry f = Byte2ReferenceRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1320 */             if ((f != null) && (Byte2ReferenceRBTreeMap.Submap.this.in(f.key))) Byte2ReferenceRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Byte2ReferenceRBTreeMap.Submap.SubmapIterator(Byte2ReferenceRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Byte2ReferenceRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Byte2ReferenceMap.Entry<V> first() { return Byte2ReferenceRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Byte2ReferenceMap.Entry<V> last() { return Byte2ReferenceRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> from, Byte2ReferenceMap.Entry<V> to) { return Byte2ReferenceRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ReferenceEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> to) { return Byte2ReferenceRBTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2ReferenceEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> from) { return Byte2ReferenceRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ReferenceEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Byte2ReferenceRBTreeMap.Submap.SubmapValueIterator(Byte2ReferenceRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Byte2ReferenceRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Byte2ReferenceRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Byte2ReferenceRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(byte k) {
/* 1365 */       return (in(k)) && (Byte2ReferenceRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/* 1380 */       return (in(kk)) && ((e = Byte2ReferenceRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(byte k, V v) {
/* 1383 */       Byte2ReferenceRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Byte2ReferenceRBTreeMap.this.put(k, v);
/* 1386 */       return Byte2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Byte ok, V ov) {
/* 1389 */       Object oldValue = put(ok.byteValue(), ov);
/* 1390 */       return Byte2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(byte k) {
/* 1394 */       Byte2ReferenceRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Byte2ReferenceRBTreeMap.this.remove(k);
/* 1397 */       return Byte2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Byte)ok).byteValue());
/* 1401 */       return Byte2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1416 */       return Byte2ReferenceRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Byte2ReferenceSortedMap<V> headMap(byte to) {
/* 1419 */       if (this.top) return new Submap(Byte2ReferenceRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Byte2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2ReferenceRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Byte2ReferenceSortedMap<V> tailMap(byte from) {
/* 1423 */       if (this.bottom) return new Submap(Byte2ReferenceRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ReferenceRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Byte2ReferenceRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Byte2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Byte2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Byte2ReferenceRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Byte2ReferenceRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Byte2ReferenceRBTreeMap.this.tree == null) return null;
/* 1441 */       Byte2ReferenceRBTreeMap.Entry e;
/*      */       Byte2ReferenceRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Byte2ReferenceRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Byte2ReferenceRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Byte2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Byte2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Byte2ReferenceRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Byte2ReferenceRBTreeMap.this.tree == null) return null;
/* 1459 */       Byte2ReferenceRBTreeMap.Entry e;
/*      */       Byte2ReferenceRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Byte2ReferenceRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Byte2ReferenceRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Byte2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Byte2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public byte firstByteKey() {
/* 1470 */       Byte2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public byte lastByteKey() {
/* 1475 */       Byte2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Byte firstKey() {
/* 1480 */       Byte2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Byte lastKey() {
/* 1485 */       Byte2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Byte2ReferenceRBTreeMap.Submap.SubmapIterator
/*      */       implements ByteListIterator
/*      */     {
/*      */       public SubmapKeyIterator()
/*      */       {
/* 1543 */         super(); } 
/* 1544 */       public SubmapKeyIterator(byte from) { super(from); } 
/* 1545 */       public byte nextByte() { return nextEntry().key; } 
/* 1546 */       public byte previousByte() { return previousEntry().key; } 
/* 1547 */       public void set(byte k) { throw new UnsupportedOperationException(); } 
/* 1548 */       public void add(byte k) { throw new UnsupportedOperationException(); } 
/* 1549 */       public Byte next() { return Byte.valueOf(nextEntry().key); } 
/* 1550 */       public Byte previous() { return Byte.valueOf(previousEntry().key); } 
/* 1551 */       public void set(Byte ok) { throw new UnsupportedOperationException(); } 
/* 1552 */       public void add(Byte ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Byte2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/* 1525 */         super();
/*      */       }
/* 1527 */       SubmapEntryIterator(byte k) { super(k); } 
/*      */       public Byte2ReferenceMap.Entry<V> next() {
/* 1529 */         return nextEntry(); } 
/* 1530 */       public Byte2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Byte2ReferenceRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Byte2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Byte2ReferenceRBTreeMap.Submap.this.bottom) && (Byte2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Byte2ReferenceRBTreeMap.Submap.this.top) && (Byte2ReferenceRBTreeMap.this.compare(k, (this.prev = Byte2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Byte2ReferenceRBTreeMap.this.locateKey(k);
/* 1507 */             if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Byte2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ReferenceRBTreeMap.this.compare(this.prev.key, Byte2ReferenceRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Byte2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2ReferenceRBTreeMap.this.compare(this.next.key, Byte2ReferenceRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public ByteBidirectionalIterator iterator() { return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Byte2ReferenceRBTreeMap.Submap.this); } 
/* 1340 */       public ByteBidirectionalIterator iterator(byte from) { return new Byte2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Byte2ReferenceRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public ByteBidirectionalIterator iterator() { return new Byte2ReferenceRBTreeMap.KeyIterator(Byte2ReferenceRBTreeMap.this); } 
/* 1178 */     public ByteBidirectionalIterator iterator(byte from) { return new Byte2ReferenceRBTreeMap.KeyIterator(Byte2ReferenceRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2ReferenceRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1164 */       super(); } 
/* 1165 */     public KeyIterator(byte k) { super(k); } 
/* 1166 */     public byte nextByte() { return nextEntry().key; } 
/* 1167 */     public byte previousByte() { return previousEntry().key; } 
/* 1168 */     public void set(byte k) { throw new UnsupportedOperationException(); } 
/* 1169 */     public void add(byte k) { throw new UnsupportedOperationException(); } 
/* 1170 */     public Byte next() { return Byte.valueOf(nextEntry().key); } 
/* 1171 */     public Byte previous() { return Byte.valueOf(previousEntry().key); } 
/* 1172 */     public void set(Byte ok) { throw new UnsupportedOperationException(); } 
/* 1173 */     public void add(Byte ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Byte2ReferenceMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
/* 1107 */       super();
/*      */     }
/* 1109 */     EntryIterator(byte k) { super(k); } 
/*      */     public Byte2ReferenceMap.Entry<V> next() {
/* 1111 */       return nextEntry(); } 
/* 1112 */     public Byte2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Byte2ReferenceRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(byte k) {
/* 1044 */       if ((this.next = Byte2ReferenceRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Byte2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Byte2ReferenceRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  969 */       return this.key ^ (this.value == null ? 0 : System.identityHashCode(this.value));
/*      */     }
