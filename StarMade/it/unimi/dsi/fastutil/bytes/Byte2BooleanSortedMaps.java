...
public class Byte2BooleanSortedMaps
{
  ...
  public static Byte2BooleanSortedMap synchronize(Byte2BooleanSortedMap local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static Byte2BooleanSortedMap synchronize(Byte2BooleanSortedMap local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static Byte2BooleanSortedMap unmodifiable(Byte2BooleanSortedMap local_m)
  {
    ...
    implements Byte2BooleanSortedMap, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Byte2BooleanSortedMap local_m)
    {
      super();
    ...
    implements Byte2BooleanSortedMap, Serializable
  {
    ...
    protected SynchronizedSortedMap(Byte2BooleanSortedMap local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Byte2BooleanSortedMap local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Byte2BooleanSortedMap, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Byte2BooleanMaps.Singleton.SingletonEntry(this), Byte2BooleanSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
