...
/*  13:    */
/*  81:    */public class ByteOpenCustomHashSet
/*  82:    */  extends AbstractByteSet
...
/*  87:    */  protected transient byte[] key;
...
/*  94:    */  protected ByteHash.Strategy strategy;
/*  95:    */  
/*  96:    */  public ByteOpenCustomHashSet(int expected, float f, ByteHash.Strategy strategy)
/*  97:    */  {
...
/* 105:105 */    this.key = new byte[this.n];
/* 106:106 */    this.used = new boolean[this.n];
/* 107:    */  }
/* 108:    */  
/* 112:    */  public ByteOpenCustomHashSet(int expected, ByteHash.Strategy strategy)
/* 113:    */  {
/* 114:114 */    this(expected, 0.75F, strategy);
/* 115:    */  }
/* 116:    */  
/* 119:    */  public ByteOpenCustomHashSet(ByteHash.Strategy strategy)
/* 120:    */  {
/* 121:121 */    this(16, 0.75F, strategy);
/* 122:    */  }
/* 123:    */  
/* 128:    */  public ByteOpenCustomHashSet(Collection<? extends Byte> c, float f, ByteHash.Strategy strategy)
/* 129:    */  {
/* 130:130 */    this(c.size(), f, strategy);
/* 131:131 */    addAll(c);
/* 132:    */  }
/* 133:    */  
/* 138:    */  public ByteOpenCustomHashSet(Collection<? extends Byte> c, ByteHash.Strategy strategy)
/* 139:    */  {
/* 140:140 */    this(c, 0.75F, strategy);
/* 141:    */  }
/* 142:    */  
/* 147:    */  public ByteOpenCustomHashSet(ByteCollection c, float f, ByteHash.Strategy strategy)
/* 148:    */  {
/* 149:149 */    this(c.size(), f, strategy);
/* 150:150 */    addAll(c);
/* 151:    */  }
/* 152:    */  
/* 157:    */  public ByteOpenCustomHashSet(ByteCollection c, ByteHash.Strategy strategy)
/* 158:    */  {
/* 159:159 */    this(c, 0.75F, strategy);
/* 160:    */  }
/* 161:    */  
/* 166:    */  public ByteOpenCustomHashSet(ByteIterator i, float f, ByteHash.Strategy strategy)
/* 167:    */  {
/* 168:168 */    this(16, f, strategy);
/* 169:169 */    while (i.hasNext()) { add(i.nextByte());
/* 170:    */    }
/* 171:    */  }
/* 172:    */  
/* 175:    */  public ByteOpenCustomHashSet(ByteIterator i, ByteHash.Strategy strategy)
/* 176:    */  {
/* 177:177 */    this(i, 0.75F, strategy);
/* 178:    */  }
/* 179:    */  
/* 184:    */  public ByteOpenCustomHashSet(Iterator<?> i, float f, ByteHash.Strategy strategy)
/* 185:    */  {
/* 186:186 */    this(ByteIterators.asByteIterator(i), f, strategy);
/* 187:    */  }
/* 188:    */  
/* 192:    */  public ByteOpenCustomHashSet(Iterator<?> i, ByteHash.Strategy strategy)
/* 193:    */  {
/* 194:194 */    this(ByteIterators.asByteIterator(i), strategy);
/* 195:    */  }
/* 196:    */  
/* 203:    */  public ByteOpenCustomHashSet(byte[] a, int offset, int length, float f, ByteHash.Strategy strategy)
/* 204:    */  {
/* 205:205 */    this(length < 0 ? 0 : length, f, strategy);
/* 206:206 */    ByteArrays.ensureOffsetLength(a, offset, length);
/* 207:207 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 208:    */    }
/* 209:    */  }
/* 210:    */  
/* 215:    */  public ByteOpenCustomHashSet(byte[] a, int offset, int length, ByteHash.Strategy strategy)
/* 216:    */  {
/* 217:217 */    this(a, offset, length, 0.75F, strategy);
/* 218:    */  }
/* 219:    */  
/* 224:    */  public ByteOpenCustomHashSet(byte[] a, float f, ByteHash.Strategy strategy)
/* 225:    */  {
/* 226:226 */    this(a, 0, a.length, f, strategy);
/* 227:    */  }
/* 228:    */  
/* 233:    */  public ByteOpenCustomHashSet(byte[] a, ByteHash.Strategy strategy)
/* 234:    */  {
/* 235:235 */    this(a, 0.75F, strategy);
/* 236:    */  }
/* 237:    */  
/* 240:    */  public ByteHash.Strategy strategy()
/* 241:    */  {
...
/* 283:    */  }
/* 284:    */  
/* 285:    */  public boolean remove(byte k)
/* 286:    */  {
...
/* 299:    */  }
/* 300:    */  
/* 301:    */  public boolean contains(byte k)
/* 302:    */  {
...
/* 344:    */  
/* 345:    */  private class SetIterator extends AbstractByteIterator {
/* 346:    */    int pos;
/* 347:    */    int last;
/* 348:    */    
/* 349:349 */    private SetIterator() { this.pos = ByteOpenCustomHashSet.this.n;
/* 350:    */      
/* 352:352 */      this.last = -1;
/* 353:    */      
/* 354:354 */      this.c = ByteOpenCustomHashSet.this.size;
/* 355:    */      
/* 359:359 */      boolean[] used = ByteOpenCustomHashSet.this.used;
/* 360:360 */      while ((this.c != 0) && (used[(--this.pos)] == 0)) {}
/* 361:    */    }
/* 362:    */    
/* 363:363 */    public boolean hasNext() { return this.c != 0; }
/* 364:    */    
/* 365:    */    public byte nextByte() {
/* 366:366 */      if (!hasNext()) throw new NoSuchElementException();
/* 367:367 */      this.c -= 1;
/* 368:    */      
/* 369:369 */      if (this.pos < 0) return this.wrapped.getByte(-(this.last = --this.pos) - 2);
/* 370:370 */      byte retVal = ByteOpenCustomHashSet.this.key[(this.last = this.pos)];
/* 371:    */      
/* 372:372 */      if (this.c != 0) {
/* 373:373 */        boolean[] used = ByteOpenCustomHashSet.this.used;
...
/* 388:    */      for (;;)
/* 389:    */      {
/* 390:390 */        pos = (last = pos) + 1 & ByteOpenCustomHashSet.this.mask;
/* 391:391 */        while (ByteOpenCustomHashSet.this.used[pos] != 0) {
/* 392:392 */          int slot = HashCommon.murmurHash3(ByteOpenCustomHashSet.this.strategy.hashCode(ByteOpenCustomHashSet.this.key[pos])) & ByteOpenCustomHashSet.this.mask;
/* 393:393 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 394:394 */          pos = pos + 1 & ByteOpenCustomHashSet.this.mask;
/* 395:    */        }
/* 396:396 */        if (ByteOpenCustomHashSet.this.used[pos] == 0) break;
/* 397:397 */        if (pos < last)
/* 398:    */        {
/* 399:399 */          if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 400:400 */          this.wrapped.add(ByteOpenCustomHashSet.this.key[pos]);
/* 401:    */        }
/* 402:402 */        ByteOpenCustomHashSet.this.key[last] = ByteOpenCustomHashSet.this.key[pos];
/* 403:    */      }
/* 404:404 */      ByteOpenCustomHashSet.this.used[last] = false;
/* 405:405 */      return last;
/* 406:    */    }
/* 407:    */    
...
/* 411:    */      {
/* 412:412 */        ByteOpenCustomHashSet.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 413:413 */        this.last = -1;
/* 414:414 */        return;
/* 415:    */      }
/* 416:416 */      ByteOpenCustomHashSet.this.size -= 1;
...
/* 423:    */  }
/* 424:    */  
/* 425:    */  public ByteIterator iterator() {
...
/* 522:    */  }
/* 523:    */  
/* 527:    */  public ByteOpenCustomHashSet clone()
/* 528:    */  {
/* 529:    */    ByteOpenCustomHashSet c;
/* 530:    */    
/* 532:    */    try
/* 533:    */    {
/* 534:534 */      c = (ByteOpenCustomHashSet)super.clone();
/* 535:    */    }
/* 536:    */    catch (CloneNotSupportedException cantHappen) {
/* 537:537 */      throw new InternalError();
/* 538:    */    }
/* 539:539 */    c.key = ((byte[])this.key.clone());
...
/* 561:    */  }
/* 562:    */  
/* 563:563 */  private void writeObject(ObjectOutputStream s) throws IOException { ByteIterator i = iterator();
/* 564:564 */    s.defaultWriteObject();
/* 565:565 */    for (int j = this.size; j-- != 0; s.writeByte(i.nextByte())) {}
/* 566:    */  }
/* 567:    */  
