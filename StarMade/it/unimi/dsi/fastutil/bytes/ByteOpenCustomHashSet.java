...
/*     */ 
/*     */ public class ByteOpenCustomHashSet extends AbstractByteSet
...
/* 169 */     while (i.hasNext()) add(i.nextByte());
/*     */   }
/*     */ 
...
/*     */   {
/* 186 */     this(ByteIterators.asByteIterator(i), f, strategy);
/*     */   }
/*     */ 
/*     */   public ByteOpenCustomHashSet(Iterator<?> i, ByteHash.Strategy strategy)
/*     */   {
/* 194 */     this(ByteIterators.asByteIterator(i), strategy);
/*     */   }
/*     */ 
...
/* 206 */     ByteArrays.ensureOffsetLength(a, offset, length);
...
/*     */ 
/* 504 */     byte[] key = this.key;
/* 505 */     int newMask = newN - 1;
/* 506 */     byte[] newKey = new byte[newN];
...
/*     */     try
/*     */     {
/* 534 */       c = (ByteOpenCustomHashSet)super.clone();
/*     */     }
/*     */     catch (CloneNotSupportedException cantHappen) {
/* 537 */       throw new InternalError();
/*     */     }
/* 539 */     c.key = ((byte[])this.key.clone());
...
/*     */     }
/* 560 */     return h; } 
/* 563 */   private void writeObject(ObjectOutputStream s) throws IOException { ByteIterator i = iterator();
/* 564 */     s.defaultWriteObject();
/* 565 */     for (int j = this.size; j-- != 0; s.writeByte(i.nextByte()));
/*     */   }
/*     */ 
...
/*     */     private SetIterator()
/*     */     {
/* 349 */       this.pos = ByteOpenCustomHashSet.this.n;
/*     */ 
/* 352 */       this.last = -1;
/*     */ 
/* 354 */       this.c = ByteOpenCustomHashSet.this.size;
/*     */ 
/* 359 */       boolean[] used = ByteOpenCustomHashSet.this.used;
...
/* 367 */       this.c -= 1;
/*     */ 
/* 369 */       if (this.pos < 0) return this.wrapped.getByte(-(this.last = --this.pos) - 2);
/* 370 */       byte retVal = ByteOpenCustomHashSet.this.key[(this.last = this.pos)];
/*     */ 
/* 372 */       if (this.c != 0) {
/* 373 */         boolean[] used = ByteOpenCustomHashSet.this.used;
...
/*     */       while (true)
/*     */       {
/* 390 */         pos = (last = pos) + 1 & ByteOpenCustomHashSet.this.mask;
/* 391 */         while (ByteOpenCustomHashSet.this.used[pos] != 0) {
/* 392 */           int slot = HashCommon.murmurHash3(ByteOpenCustomHashSet.this.strategy.hashCode(ByteOpenCustomHashSet.this.key[pos])) & ByteOpenCustomHashSet.this.mask;
/* 393 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 394 */           pos = pos + 1 & ByteOpenCustomHashSet.this.mask;
/*     */         }
/* 396 */         if (ByteOpenCustomHashSet.this.used[pos] == 0) break;
/* 397 */         if (pos < last)
/*     */         {
/* 399 */           if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 400 */           this.wrapped.add(ByteOpenCustomHashSet.this.key[pos]);
/*     */         }
/* 402 */         ByteOpenCustomHashSet.this.key[last] = ByteOpenCustomHashSet.this.key[pos];
/*     */       }
/* 404 */       ByteOpenCustomHashSet.this.used[last] = false;
/* 405 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 410 */       if (this.pos < -1)
/*     */       {
/* 412 */         ByteOpenCustomHashSet.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 413 */         this.last = -1;
/* 414 */         return;
/*     */       }
/* 416 */       ByteOpenCustomHashSet.this.size -= 1;
