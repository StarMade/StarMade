...
/*     */   {
/*  73 */     if (capacity > 0) this.array = new byte[capacity];
...
/*  91 */     byte t = this.array[this.start];
...
/* 110 */     byte[] newArray = ByteArrays.grow(this.array, this.length + 1, 0);
...
/*     */   {
/* 165 */     int size = size();
/* 166 */     byte[] newArray = new byte[size + 1];
/*     */ 
