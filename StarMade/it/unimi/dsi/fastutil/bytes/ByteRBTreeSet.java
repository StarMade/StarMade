  ...
  implements Serializable, Cloneable, ByteSortedSet
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return ByteRBTreeSet.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public ByteRBTreeSet(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public ByteRBTreeSet(Collection<? extends Byte> local_c)
  {
    this();
    addAll(local_c);
  }
  
  public ByteRBTreeSet(SortedSet<Byte> local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public ByteRBTreeSet(ByteCollection local_c)
  {
    this();
    addAll(local_c);
  }
  
  public ByteRBTreeSet(ByteSortedSet local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public ByteRBTreeSet(ByteIterator local_i)
  {
    allocatePaths();
  ...
  public ByteRBTreeSet(Iterator<? extends Byte> local_i)
  {
    this(ByteIterators.asByteIterator(local_i));
  }
  
  public ByteRBTreeSet(byte[] local_a, int offset, int length, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public ByteRBTreeSet(byte[] local_a, int offset, int length)
  {
    this(local_a, offset, length, null);
  }
  
  public ByteRBTreeSet(byte[] local_a)
  {
    this();
  ...
  public ByteRBTreeSet(byte[] local_a, Comparator<? super Byte> local_c)
  {
    this(local_c);
    int local_i = local_a.length;
    while (local_i-- != 0) {
  ...
  public Object clone()
  {
    ByteRBTreeSet local_c;
    try
    {
      local_c = (ByteRBTreeSet)super.clone();
    }
    ...
    implements Serializable, ByteSortedSet
  {
    ...
    {
      if ((!bottom) && (!top) && (ByteRBTreeSet.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (ByteRBTreeSet.this.compare(local_k, this.from) >= 0)) && ((this.top) || (ByteRBTreeSet.this.compare(local_k, this.field_289) < 0));
    }
    
    public boolean contains(byte local_k)
    {
      return (in(local_k)) && (ByteRBTreeSet.this.contains(local_k));
    }
    ...
    public boolean add(byte local_k)
    {
      ...
      return ByteRBTreeSet.this.add(local_k);
    }
    ...
    public boolean remove(byte local_k)
    {
      ...
      return ByteRBTreeSet.this.remove(local_k);
    }
    ...
    {
      if (this.top) {
        return new Subset(ByteRBTreeSet.this, this.from, this.bottom, local_to, false);
      }
      return ByteRBTreeSet.this.compare(local_to, this.field_289) < 0 ? new Subset(ByteRBTreeSet.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public ByteSortedSet tailSet(byte from)
    {
      if (this.bottom) {
        return new Subset(ByteRBTreeSet.this, from, false, this.field_289, this.top);
      }
      return ByteRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(ByteRBTreeSet.this, from, false, this.field_289, this.top) : this;
    }
    
    public ByteSortedSet subSet(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Subset(ByteRBTreeSet.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = ByteRBTreeSet.this.compare(local_to, this.field_289) < 0 ? local_to : this.field_289;
      }
      if (!this.bottom) {
    ...
    public ByteRBTreeSet.Entry firstEntry()
    {
      ...
      ByteRBTreeSet.Entry local_e;
      ByteRBTreeSet.Entry local_e;
      if (this.bottom)
      {
        local_e = ByteRBTreeSet.this.firstEntry;
      }
      else
      {
        local_e = ByteRBTreeSet.this.locateKey(this.from);
        if (ByteRBTreeSet.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (ByteRBTreeSet.this.compare(local_e.key, this.field_289) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public ByteRBTreeSet.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = ByteRBTreeSet.this.lastEntry;
      }
      else
      {
        local_e = ByteRBTreeSet.this.locateKey(this.field_289);
        if (ByteRBTreeSet.this.compare(local_e.key, this.field_289) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (ByteRBTreeSet.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByte()
    {
      ByteRBTreeSet.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByte()
    {
      ByteRBTreeSet.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends ByteRBTreeSet.SetIterator
    {
      ...
      {
        super();
        this.next = ByteRBTreeSet.Subset.this.firstEntry();
      }
      ...
      SubsetIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!ByteRBTreeSet.Subset.this.bottom) && (ByteRBTreeSet.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!ByteRBTreeSet.Subset.this.top) && (ByteRBTreeSet.this.compare(local_k, (this.prev = ByteRBTreeSet.Subset.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = ByteRBTreeSet.this.locateKey(local_k);
            if (ByteRBTreeSet.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!ByteRBTreeSet.Subset.this.bottom) && (this.prev != null) && (ByteRBTreeSet.this.compare(this.prev.key, ByteRBTreeSet.Subset.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!ByteRBTreeSet.Subset.this.top) && (this.next != null) && (ByteRBTreeSet.this.compare(this.next.key, ByteRBTreeSet.Subset.this.field_289) >= 0)) {
          this.next = null;
        }
      }
    }
    ...
    extends AbstractByteListIterator
  {
    ...
    {
      if ((this.next = ByteRBTreeSet.this.locateKey(local_k)) != null) {
        if (ByteRBTreeSet.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
