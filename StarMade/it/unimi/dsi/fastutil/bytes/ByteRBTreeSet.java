...
/*   12:     */
/*   57:     */public class ByteRBTreeSet
/*   58:     */  extends AbstractByteSortedSet
/*   59:     */  implements Serializable, Cloneable, ByteSortedSet
/*   60:     */{
...
/*   65:     */  protected Comparator<? super Byte> storedComparator;
/*   66:     */  protected transient ByteComparator actualComparator;
...
/*   97:  97 */          return ByteRBTreeSet.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*   98:     */        }
/*   99:     */        
/*  100: 100 */        public int compare(Byte ok1, Byte ok2) { return ByteRBTreeSet.this.storedComparator.compare(ok1, ok2); }
/*  101:     */      };
/*  102:     */    }
/*  103:     */  }
/*  104:     */  
/*  107:     */  public ByteRBTreeSet(Comparator<? super Byte> c)
/*  108:     */  {
/*  109: 109 */    this();
...
/*  112:     */  }
/*  113:     */  
/*  117:     */  public ByteRBTreeSet(Collection<? extends Byte> c)
/*  118:     */  {
/*  119: 119 */    this();
/*  120: 120 */    addAll(c);
/*  121:     */  }
/*  122:     */  
/*  127:     */  public ByteRBTreeSet(SortedSet<Byte> s)
/*  128:     */  {
/*  129: 129 */    this(s.comparator());
/*  130: 130 */    addAll(s);
/*  131:     */  }
/*  132:     */  
/*  137:     */  public ByteRBTreeSet(ByteCollection c)
/*  138:     */  {
/*  139: 139 */    this();
/*  140: 140 */    addAll(c);
/*  141:     */  }
/*  142:     */  
/*  147:     */  public ByteRBTreeSet(ByteSortedSet s)
/*  148:     */  {
/*  149: 149 */    this(s.comparator());
/*  150: 150 */    addAll(s);
/*  151:     */  }
/*  152:     */  
/*  153:     */  public ByteRBTreeSet(ByteIterator i)
/*  154:     */  {
...
/*  243:     */  }
/*  244:     */  
/*  250:     */  public ByteRBTreeSet(Iterator<? extends Byte> i)
/*  251:     */  {
/*  252: 171 */    this(ByteIterators.asByteIterator(i));
/*  253:     */  }
/*  254:     */  
/*  263:     */  public ByteRBTreeSet(byte[] a, int offset, int length, Comparator<? super Byte> c)
/*  264:     */  {
/*  265: 184 */    this(c);
...
/*  269:     */  }
/*  270:     */  
/*  277:     */  public ByteRBTreeSet(byte[] a, int offset, int length)
/*  278:     */  {
/*  279: 198 */    this(a, offset, length, null);
/*  280:     */  }
/*  281:     */  
/*  287:     */  public ByteRBTreeSet(byte[] a)
/*  288:     */  {
/*  289: 208 */    this();
...
/*  293:     */  }
/*  294:     */  
/*  300:     */  public ByteRBTreeSet(byte[] a, Comparator<? super Byte> c)
/*  301:     */  {
/*  302: 221 */    this(c);
...
/*  551:     */  }
/*  552:     */  
/*  554:     */  public boolean remove(byte k)
/*  555:     */  {
...
/*  820:     */  }
/*  821:     */  
/*  824: 743 */  public boolean contains(byte k) { return findKey(k) != null; }
/*  825:     */  
...
/* 1023:     */  
/* 1024:     */  public byte firstByte() {
/* 1025: 944 */    if (this.tree == null) throw new NoSuchElementException();
/* 1026: 945 */    return this.firstEntry.key;
/* 1027:     */  }
/* 1028:     */  
/* 1029: 948 */  public byte lastByte() { if (this.tree == null) throw new NoSuchElementException();
/* 1030: 949 */    return this.lastEntry.key;
/* 1031:     */  }
/* 1032:     */  
/* 1035:     */  private class SetIterator
/* 1036:     */    extends AbstractByteListIterator
/* 1037:     */  {
/* 1038:     */    ByteRBTreeSet.Entry prev;
/* 1039:     */    
/* 1040:     */    ByteRBTreeSet.Entry next;
/* 1041:     */    
/* 1042:     */    ByteRBTreeSet.Entry curr;
/* 1043:     */    
/* 1044: 963 */    int index = 0;
/* 1045:     */    
/* 1046: 965 */    SetIterator() { this.next = ByteRBTreeSet.this.firstEntry; }
/* 1047:     */    
/* 1048:     */    SetIterator(byte k) {
/* 1049: 968 */      if ((this.next = ByteRBTreeSet.this.locateKey(k)) != null)
/* 1050: 969 */        if (ByteRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1061:     */    
/* 1062:     */    ByteRBTreeSet.Entry nextEntry() {
...
/* 1068:     */    
/* 1069: 988 */    public byte nextByte() { return nextEntry().key; }
/* 1070: 989 */    public byte previousByte() { return previousEntry().key; }
/* 1071:     */    
/* 1072: 991 */    void updatePrevious() { this.prev = this.prev.prev(); }
/* 1073:     */    
/* 1074:     */    ByteRBTreeSet.Entry previousEntry() {
...
/* 1095:1014 */      ByteRBTreeSet.this.remove(this.curr.key);
/* 1096:1015 */      this.curr = null;
/* 1097:     */    }
/* 1098:     */  }
/* 1099:     */  
/* 1100:1019 */  public ByteBidirectionalIterator iterator() { return new SetIterator(); }
/* 1101:     */  
/* 1102:     */  public ByteBidirectionalIterator iterator(byte from) {
/* 1103:1022 */    return new SetIterator(from);
/* 1104:     */  }
/* 1105:     */  
/* 1106:1025 */  public ByteComparator comparator() { return this.actualComparator; }
/* 1107:     */  
/* 1108:     */  public ByteSortedSet headSet(byte to) {
/* 1109:1028 */    return new Subset((byte)0, true, to, false);
/* 1110:     */  }
/* 1111:     */  
/* 1112:1031 */  public ByteSortedSet tailSet(byte from) { return new Subset(from, false, (byte)0, true); }
/* 1113:     */  
/* 1114:     */  public ByteSortedSet subSet(byte from, byte to) {
/* 1115:1034 */    return new Subset(from, false, to, false);
/* 1116:     */  }
/* 1117:     */  
/* 1121:     */  private final class Subset
/* 1122:     */    extends AbstractByteSortedSet
/* 1123:     */    implements Serializable, ByteSortedSet
/* 1124:     */  {
...
/* 1138:     */    boolean top;
/* 1139:     */    
/* 1142:     */    public Subset(byte from, boolean bottom, byte to, boolean top)
/* 1143:     */    {
/* 1144:1063 */      if ((!bottom) && (!top) && (ByteRBTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
...
/* 1156:     */    }
/* 1157:     */    
/* 1160:     */    final boolean in(byte k)
/* 1161:     */    {
/* 1162:1081 */      return ((this.bottom) || (ByteRBTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (ByteRBTreeSet.this.compare(k, this.to) < 0));
/* 1163:     */    }
/* 1164:     */    
/* 1167:1086 */    public boolean contains(byte k) { return (in(k)) && (ByteRBTreeSet.this.contains(k)); }
/* 1168:     */    
/* 1169:     */    public boolean add(byte k) {
...
/* 1171:1090 */      return ByteRBTreeSet.this.add(k);
/* 1172:     */    }
/* 1173:     */    
/* 1174:     */    public boolean remove(byte k) {
/* 1175:1094 */      if (!in(k)) return false;
/* 1176:1095 */      return ByteRBTreeSet.this.remove(k);
/* 1177:     */    }
/* 1178:     */    
...
/* 1189:     */    
/* 1190:     */    public ByteComparator comparator() {
/* 1191:1110 */      return ByteRBTreeSet.this.actualComparator;
/* 1192:     */    }
/* 1193:     */    
/* 1194:1113 */    public ByteBidirectionalIterator iterator() { return new SubsetIterator(); }
/* 1195:     */    
/* 1197:1116 */    public ByteBidirectionalIterator iterator(byte from) { return new SubsetIterator(from); }
/* 1198:     */    
/* 1199:     */    public ByteSortedSet headSet(byte to) {
/* 1200:1119 */      if (this.top) return new Subset(ByteRBTreeSet.this, this.from, this.bottom, to, false);
/* 1201:1120 */      return ByteRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(ByteRBTreeSet.this, this.from, this.bottom, to, false) : this;
/* 1202:     */    }
/* 1203:     */    
/* 1204:1123 */    public ByteSortedSet tailSet(byte from) { if (this.bottom) return new Subset(ByteRBTreeSet.this, from, false, this.to, this.top);
/* 1205:1124 */      return ByteRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(ByteRBTreeSet.this, from, false, this.to, this.top) : this;
/* 1206:     */    }
/* 1207:     */    
/* 1208:1127 */    public ByteSortedSet subSet(byte from, byte to) { if ((this.top) && (this.bottom)) return new Subset(ByteRBTreeSet.this, from, false, to, false);
/* 1209:1128 */      if (!this.top) to = ByteRBTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1210:1129 */      if (!this.bottom) from = ByteRBTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1211:1130 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1212:1131 */      return new Subset(ByteRBTreeSet.this, from, false, to, false);
/* 1213:     */    }
/* 1214:     */    
/* 1217:     */    public ByteRBTreeSet.Entry firstEntry()
/* 1218:     */    {
/* 1219:1138 */      if (ByteRBTreeSet.this.tree == null) return null;
/* 1220:     */      ByteRBTreeSet.Entry e;
/* 1221:     */      ByteRBTreeSet.Entry e;
/* 1222:1141 */      if (this.bottom) { e = ByteRBTreeSet.this.firstEntry;
/* 1223:     */      } else {
/* 1224:1143 */        e = ByteRBTreeSet.this.locateKey(this.from);
/* 1225:     */        
/* 1226:1145 */        if (ByteRBTreeSet.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1227:     */        }
/* 1228:     */      }
/* 1229:1148 */      if ((e == null) || ((!this.top) && (ByteRBTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1230:1149 */      return e;
/* 1231:     */    }
/* 1232:     */    
/* 1235:     */    public ByteRBTreeSet.Entry lastEntry()
/* 1236:     */    {
/* 1237:1156 */      if (ByteRBTreeSet.this.tree == null) return null;
/* 1238:     */      ByteRBTreeSet.Entry e;
/* 1239:     */      ByteRBTreeSet.Entry e;
/* 1240:1159 */      if (this.top) { e = ByteRBTreeSet.this.lastEntry;
/* 1241:     */      } else {
/* 1242:1161 */        e = ByteRBTreeSet.this.locateKey(this.to);
/* 1243:     */        
/* 1244:1163 */        if (ByteRBTreeSet.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1245:     */        }
/* 1246:     */      }
/* 1247:1166 */      if ((e == null) || ((!this.bottom) && (ByteRBTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1248:1167 */      return e;
/* 1249:     */    }
/* 1250:     */    
/* 1251:1170 */    public byte firstByte() { ByteRBTreeSet.Entry e = firstEntry();
/* 1252:1171 */      if (e == null) throw new NoSuchElementException();
/* 1253:1172 */      return e.key;
/* 1254:     */    }
/* 1255:     */    
/* 1256:1175 */    public byte lastByte() { ByteRBTreeSet.Entry e = lastEntry();
/* 1257:1176 */      if (e == null) throw new NoSuchElementException();
/* 1258:1177 */      return e.key;
/* 1259:     */    }
/* 1260:     */    
/* 1263:     */    private final class SubsetIterator
/* 1264:     */      extends ByteRBTreeSet.SetIterator
/* 1265:     */    {
/* 1266:     */      SubsetIterator()
/* 1267:     */      {
/* 1268:1187 */        super();
/* 1269:1188 */        this.next = ByteRBTreeSet.Subset.this.firstEntry();
/* 1270:     */      }
/* 1271:     */      
/* 1272:1191 */      SubsetIterator(byte k) { this();
/* 1273:1192 */        if (this.next != null)
/* 1274:1193 */          if ((!ByteRBTreeSet.Subset.this.bottom) && (ByteRBTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1275:1194 */          } else if ((!ByteRBTreeSet.Subset.this.top) && (ByteRBTreeSet.this.compare(k, (this.prev = ByteRBTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1276:     */          } else {
/* 1277:1196 */            this.next = ByteRBTreeSet.this.locateKey(k);
/* 1278:1197 */            if (ByteRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1288:1207 */        if ((!ByteRBTreeSet.Subset.this.bottom) && (this.prev != null) && (ByteRBTreeSet.this.compare(this.prev.key, ByteRBTreeSet.Subset.this.from) < 0)) this.prev = null;
/* 1289:     */      }
/* 1290:     */      
/* 1291:1210 */      void updateNext() { this.next = this.next.next();
/* 1292:1211 */        if ((!ByteRBTreeSet.Subset.this.top) && (this.next != null) && (ByteRBTreeSet.this.compare(this.next.key, ByteRBTreeSet.Subset.this.to) >= 0)) { this.next = null;
/* 1293:     */        }
/* 1294:     */      }
/* 1295:     */    }
/* 1296:     */  }
...
/* 1301:     */  {
/* 1302:     */    ByteRBTreeSet c;
/* 1303:     */    
/* 1305:     */    try
/* 1306:     */    {
/* 1307:1226 */      c = (ByteRBTreeSet)super.clone();
/* 1308:     */    }
...
/* 1360:1279 */    while (n-- != 0) { s.writeByte(i.nextByte());
/* 1361:     */    }
/* 1362:     */  }
/* 1363:     */  
...
/* 1370:     */  {
/* 1371:1290 */    if (n == 1) {
/* 1372:1291 */      Entry top = new Entry(s.readByte());
...
/* 1378:1297 */    if (n == 2)
/* 1379:     */    {
/* 1381:1300 */      Entry top = new Entry(s.readByte());
/* 1382:1301 */      top.black(true);
/* 1383:1302 */      top.right(new Entry(s.readByte()));
