...
/*   22:     */
/*  113:     */public class Byte2CharLinkedOpenHashMap
/*  114:     */  extends AbstractByte2CharSortedMap
...
/*  127:     */  protected volatile transient Byte2CharSortedMap.FastSortedEntrySet entries;
...
/*  141:     */  
/*  149:     */  public Byte2CharLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Byte2CharLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Byte2CharLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Byte2CharLinkedOpenHashMap(Map<? extends Byte, ? extends Character> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Byte2CharLinkedOpenHashMap(Map<? extends Byte, ? extends Character> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Byte2CharLinkedOpenHashMap(Byte2CharMap m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Byte2CharLinkedOpenHashMap(Byte2CharMap m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Byte2CharLinkedOpenHashMap(byte[] k, char[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Byte2CharLinkedOpenHashMap(byte[] k, char[] v)
/*  225:     */  {
/*  226: 226 */    this(k, v, 0.75F);
/*  227:     */  }
/*  228:     */  
/*  232:     */  public char put(byte k, char v)
/*  233:     */  {
...
/*  260:     */  }
/*  261:     */  
/*  262: 262 */  public Character put(Byte ok, Character ov) { char v = ov.charValue();
...
/*  422:     */  }
/*  423:     */  
/*  427:     */  public char getAndMoveToFirst(byte k)
/*  428:     */  {
...
/*  443:     */  }
/*  444:     */  
/*  448:     */  public char getAndMoveToLast(byte k)
/*  449:     */  {
...
/*  464:     */  }
/*  465:     */  
/*  470:     */  public char putAndMoveToFirst(byte k, char v)
/*  471:     */  {
...
/*  503:     */  }
/*  504:     */  
/*  509:     */  public char putAndMoveToLast(byte k, char v)
/*  510:     */  {
...
/*  542:     */  }
/*  543:     */  
/*  544: 544 */  public Character get(Byte ok) { byte k = ok.byteValue();
/*  545:     */    
...
/*  620:     */    implements Byte2CharMap.Entry, Map.Entry<Byte, Character>
/*  621:     */  {
...
/*  627:     */    }
/*  628:     */    
/*  629: 629 */    public Byte getKey() { return Byte.valueOf(Byte2CharLinkedOpenHashMap.this.key[this.index]); }
/*  630:     */    
/*  631:     */    public byte getByteKey() {
/*  632: 632 */      return Byte2CharLinkedOpenHashMap.this.key[this.index];
/*  633:     */    }
/*  634:     */    
/*  635: 635 */    public Character getValue() { return Character.valueOf(Byte2CharLinkedOpenHashMap.this.value[this.index]); }
/*  636:     */    
/*  638: 638 */    public char getCharValue() { return Byte2CharLinkedOpenHashMap.this.value[this.index]; }
/*  639:     */    
/*  640:     */    public char setValue(char v) {
/*  641: 641 */      char oldValue = Byte2CharLinkedOpenHashMap.this.value[this.index];
/*  642: 642 */      Byte2CharLinkedOpenHashMap.this.value[this.index] = v;
...
/*  651: 651 */      Map.Entry<Byte, Character> e = (Map.Entry)o;
/*  652: 652 */      return (Byte2CharLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*  653:     */    }
/*  654:     */    
/*  655: 655 */    public int hashCode() { return Byte2CharLinkedOpenHashMap.this.key[this.index] ^ Byte2CharLinkedOpenHashMap.this.value[this.index]; }
/*  656:     */    
/*  657:     */    public String toString() {
/*  658: 658 */      return Byte2CharLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2CharLinkedOpenHashMap.this.value[this.index];
/*  659:     */    }
/*  660:     */  }
/*  661:     */  
...
/*  746: 746 */  public Byte2CharSortedMap tailMap(byte from) { throw new UnsupportedOperationException(); }
/*  747: 747 */  public Byte2CharSortedMap headMap(byte to) { throw new UnsupportedOperationException(); }
/*  748: 748 */  public Byte2CharSortedMap subMap(byte from, byte to) { throw new UnsupportedOperationException(); }
/*  749:     */  
...
/*  763: 763 */    int index = -1;
/*  764:     */    
/*  765: 765 */    private MapIterator() { this.next = Byte2CharLinkedOpenHashMap.this.first;
/*  766: 766 */      this.index = 0;
/*  767:     */    }
/*  768:     */    
/*  769: 769 */    private MapIterator(byte from) { if (Byte2CharLinkedOpenHashMap.this.key[Byte2CharLinkedOpenHashMap.this.last] == from) {
/*  770: 770 */        this.prev = Byte2CharLinkedOpenHashMap.this.last;
/*  771: 771 */        this.index = Byte2CharLinkedOpenHashMap.this.size;
/*  772:     */      }
/*  773:     */      else
/*  774:     */      {
/*  775: 775 */        int pos = HashCommon.murmurHash3(from) & Byte2CharLinkedOpenHashMap.this.mask;
/*  776:     */        
/*  777: 777 */        while (Byte2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  778: 778 */          if (Byte2CharLinkedOpenHashMap.this.key[pos] == from)
/*  779:     */          {
/*  780: 780 */            this.next = ((int)Byte2CharLinkedOpenHashMap.this.link[pos]);
/*  781: 781 */            this.prev = pos;
/*  782: 782 */            return;
/*  783:     */          }
/*  784: 784 */          pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask;
/*  785:     */        }
...
/*  798: 798 */        this.index = Byte2CharLinkedOpenHashMap.this.size;
/*  799: 799 */        return;
/*  800:     */      }
/*  801: 801 */      int pos = Byte2CharLinkedOpenHashMap.this.first;
/*  802: 802 */      this.index = 1;
/*  803: 803 */      while (pos != this.prev) {
/*  804: 804 */        pos = (int)Byte2CharLinkedOpenHashMap.this.link[pos];
...
/*  815:     */    }
/*  816:     */    
/*  817: 817 */    public int nextEntry() { if (!hasNext()) return Byte2CharLinkedOpenHashMap.this.size();
/*  818: 818 */      this.curr = this.next;
/*  819: 819 */      this.next = ((int)Byte2CharLinkedOpenHashMap.this.link[this.curr]);
...
/*  827: 827 */      this.prev = ((int)(Byte2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  840: 840 */        this.prev = ((int)(Byte2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  841:     */      }
/*  842:     */      else {
/*  843: 843 */        this.next = ((int)Byte2CharLinkedOpenHashMap.this.link[this.curr]); }
/*  844: 844 */      Byte2CharLinkedOpenHashMap.this.size -= 1;
/*  845:     */      
/*  847: 847 */      if (this.prev == -1) { Byte2CharLinkedOpenHashMap.this.first = this.next;
/*  848:     */      } else
/*  849: 849 */        Byte2CharLinkedOpenHashMap.this.link[this.prev] ^= (Byte2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  850: 850 */      if (this.next == -1) { Byte2CharLinkedOpenHashMap.this.last = this.prev;
/*  851:     */      } else
/*  852: 852 */        Byte2CharLinkedOpenHashMap.this.link[this.next] ^= (Byte2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  853: 853 */      int pos = this.curr;
/*  854:     */      int last;
/*  855:     */      for (;;) {
/*  856: 856 */        pos = (last = pos) + 1 & Byte2CharLinkedOpenHashMap.this.mask;
/*  857: 857 */        while (Byte2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  858: 858 */          int slot = HashCommon.murmurHash3(Byte2CharLinkedOpenHashMap.this.key[pos]) & Byte2CharLinkedOpenHashMap.this.mask;
/*  859: 859 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  860: 860 */          pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask;
/*  861:     */        }
/*  862: 862 */        if (Byte2CharLinkedOpenHashMap.this.used[pos] == 0) break;
/*  863: 863 */        Byte2CharLinkedOpenHashMap.this.key[last] = Byte2CharLinkedOpenHashMap.this.key[pos];
/*  864: 864 */        Byte2CharLinkedOpenHashMap.this.value[last] = Byte2CharLinkedOpenHashMap.this.value[pos];
/*  865: 865 */        if (this.next == pos) this.next = last;
/*  866: 866 */        if (this.prev == pos) this.prev = last;
/*  867: 867 */        Byte2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*  868:     */      }
/*  869: 869 */      Byte2CharLinkedOpenHashMap.this.used[last] = false;
/*  870: 870 */      this.curr = -1;
/*  871:     */    }
/*  872:     */    
...
/*  881:     */    } }
/*  882:     */  
/*  883:     */  private class EntryIterator extends Byte2CharLinkedOpenHashMap.MapIterator implements ObjectListIterator<Byte2CharMap.Entry> { private Byte2CharLinkedOpenHashMap.MapEntry entry;
/*  884:     */    
/*  885: 885 */    public EntryIterator() { super(null); }
/*  886:     */    
/*  887: 887 */    public EntryIterator(byte from) { super(from, null); }
/*  888:     */    
/*  889:     */    public Byte2CharLinkedOpenHashMap.MapEntry next() {
/*  890: 890 */      return this.entry = new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this, nextEntry());
/*  891:     */    }
/*  892:     */    
/*  893: 893 */    public Byte2CharLinkedOpenHashMap.MapEntry previous() { return this.entry = new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this, previousEntry()); }
/*  894:     */    
/*  895:     */    public void remove()
/*  896:     */    {
/*  897: 897 */      super.remove();
/*  898: 898 */      Byte2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  899:     */    
/*  900: 900 */    public void set(Byte2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  901: 901 */    public void add(Byte2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  902:     */  }
/*  903:     */  
/*  904: 904 */  private class FastEntryIterator extends Byte2CharLinkedOpenHashMap.MapIterator implements ObjectListIterator<Byte2CharMap.Entry> { final AbstractByte2CharMap.BasicEntry entry = new AbstractByte2CharMap.BasicEntry((byte)0, '\000');
/*  905: 905 */    public FastEntryIterator() { super(null); }
/*  906:     */    
/*  907: 907 */    public FastEntryIterator(byte from) { super(from, null); }
/*  908:     */    
/*  909:     */    public AbstractByte2CharMap.BasicEntry next() {
/*  910: 910 */      int e = nextEntry();
/*  911: 911 */      this.entry.key = Byte2CharLinkedOpenHashMap.this.key[e];
/*  912: 912 */      this.entry.value = Byte2CharLinkedOpenHashMap.this.value[e];
/*  913: 913 */      return this.entry;
/*  914:     */    }
/*  915:     */    
/*  916: 916 */    public AbstractByte2CharMap.BasicEntry previous() { int e = previousEntry();
/*  917: 917 */      this.entry.key = Byte2CharLinkedOpenHashMap.this.key[e];
/*  918: 918 */      this.entry.value = Byte2CharLinkedOpenHashMap.this.value[e];
/*  919: 919 */      return this.entry; }
/*  920:     */    
/*  921: 921 */    public void set(Byte2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  922: 922 */    public void add(Byte2CharMap.Entry ok) { throw new UnsupportedOperationException(); } }
/*  923:     */  
/*  924:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Byte2CharMap.Entry> implements Byte2CharSortedMap.FastSortedEntrySet { private MapEntrySet() {}
/*  925:     */    
/*  926: 926 */    public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator() { return new Byte2CharLinkedOpenHashMap.EntryIterator(Byte2CharLinkedOpenHashMap.this); }
/*  927:     */    
/*  928: 928 */    public Comparator<? super Byte2CharMap.Entry> comparator() { return null; }
/*  929: 929 */    public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry fromElement, Byte2CharMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  930: 930 */    public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  931: 931 */    public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry fromElement) { throw new UnsupportedOperationException(); }
/*  932:     */    
/*  933: 933 */    public Byte2CharMap.Entry first() { if (Byte2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  934: 934 */      return new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this, Byte2CharLinkedOpenHashMap.this.first);
/*  935:     */    }
/*  936:     */    
/*  937: 937 */    public Byte2CharMap.Entry last() { if (Byte2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  938: 938 */      return new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this, Byte2CharLinkedOpenHashMap.this.last);
/*  939:     */    }
/*  940:     */    
/*  941:     */    public boolean contains(Object o) {
/*  942: 942 */      if (!(o instanceof Map.Entry)) return false;
/*  943: 943 */      Map.Entry<Byte, Character> e = (Map.Entry)o;
/*  944: 944 */      byte k = ((Byte)e.getKey()).byteValue();
/*  945:     */      
/*  946: 946 */      int pos = HashCommon.murmurHash3(k) & Byte2CharLinkedOpenHashMap.this.mask;
/*  947:     */      
/*  948: 948 */      while (Byte2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  949: 949 */        if (Byte2CharLinkedOpenHashMap.this.key[pos] == k) return Byte2CharLinkedOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/*  950: 950 */        pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask;
/*  951:     */      }
...
/*  957: 957 */      Map.Entry<Byte, Character> e = (Map.Entry)o;
/*  958: 958 */      byte k = ((Byte)e.getKey()).byteValue();
/*  959:     */      
/*  960: 960 */      int pos = HashCommon.murmurHash3(k) & Byte2CharLinkedOpenHashMap.this.mask;
/*  961:     */      
/*  962: 962 */      while (Byte2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  963: 963 */        if (Byte2CharLinkedOpenHashMap.this.key[pos] == k) {
/*  964: 964 */          Byte2CharLinkedOpenHashMap.this.remove(e.getKey());
/*  965: 965 */          return true;
/*  966:     */        }
/*  967: 967 */        pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask;
/*  968:     */      }
/*  969: 969 */      return false;
/*  970:     */    }
/*  971:     */    
/*  972: 972 */    public int size() { return Byte2CharLinkedOpenHashMap.this.size; }
/*  973:     */    
/*  974:     */    public void clear() {
/*  975: 975 */      Byte2CharLinkedOpenHashMap.this.clear();
/*  976:     */    }
/*  977:     */    
/*  978: 978 */    public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from) { return new Byte2CharLinkedOpenHashMap.EntryIterator(Byte2CharLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue()); }
/*  979:     */    
/*  980:     */    public ObjectBidirectionalIterator<Byte2CharMap.Entry> fastIterator() {
/*  981: 981 */      return new Byte2CharLinkedOpenHashMap.FastEntryIterator(Byte2CharLinkedOpenHashMap.this);
/*  982:     */    }
/*  983:     */    
/*  984: 984 */    public ObjectBidirectionalIterator<Byte2CharMap.Entry> fastIterator(Byte2CharMap.Entry from) { return new Byte2CharLinkedOpenHashMap.FastEntryIterator(Byte2CharLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue()); }
/*  985:     */  }
/*  986:     */  
/*  987:     */  public Byte2CharSortedMap.FastSortedEntrySet byte2CharEntrySet() {
...
/*  995:     */    extends Byte2CharLinkedOpenHashMap.MapIterator
/*  996:     */    implements ByteListIterator
/*  997:     */  {
/*  998: 998 */    public KeyIterator(byte k) { super(k, null); }
/*  999: 999 */    public byte previousByte() { return Byte2CharLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1002:1002 */    public Byte previous() { return Byte.valueOf(Byte2CharLinkedOpenHashMap.this.key[previousEntry()]); }
...
/* 1006:1006 */    public byte nextByte() { return Byte2CharLinkedOpenHashMap.this.key[nextEntry()]; }
/* 1007:1007 */    public Byte next() { return Byte.valueOf(Byte2CharLinkedOpenHashMap.this.key[nextEntry()]); } }
/* 1008:     */  
/* 1009:     */  private final class KeySet extends AbstractByteSortedSet { private KeySet() {}
/* 1010:     */    
/* 1011:1011 */    public ByteListIterator iterator(byte from) { return new Byte2CharLinkedOpenHashMap.KeyIterator(Byte2CharLinkedOpenHashMap.this, from); }
/* 1012:     */    
/* 1013:     */    public ByteListIterator iterator() {
/* 1014:1014 */      return new Byte2CharLinkedOpenHashMap.KeyIterator(Byte2CharLinkedOpenHashMap.this);
/* 1015:     */    }
/* 1016:     */    
/* 1017:1017 */    public int size() { return Byte2CharLinkedOpenHashMap.this.size; }
/* 1018:     */    
/* 1020:1020 */    public boolean contains(byte k) { return Byte2CharLinkedOpenHashMap.this.containsKey(k); }
/* 1021:     */    
/* 1022:     */    public boolean remove(byte k) {
/* 1023:1023 */      int oldSize = Byte2CharLinkedOpenHashMap.this.size;
/* 1024:1024 */      Byte2CharLinkedOpenHashMap.this.remove(k);
/* 1025:1025 */      return Byte2CharLinkedOpenHashMap.this.size != oldSize;
/* 1026:     */    }
/* 1027:     */    
/* 1028:1028 */    public void clear() { Byte2CharLinkedOpenHashMap.this.clear(); }
/* 1029:     */    
/* 1030:     */    public byte firstByte() {
/* 1031:1031 */      if (Byte2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1032:1032 */      return Byte2CharLinkedOpenHashMap.this.key[Byte2CharLinkedOpenHashMap.this.first];
/* 1033:     */    }
/* 1034:     */    
/* 1035:1035 */    public byte lastByte() { if (Byte2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1036:1036 */      return Byte2CharLinkedOpenHashMap.this.key[Byte2CharLinkedOpenHashMap.this.last]; }
/* 1037:     */    
...
/* 1051:     */    extends Byte2CharLinkedOpenHashMap.MapIterator
/* 1052:     */    implements CharListIterator
/* 1053:     */  {
/* 1054:1054 */    public char previousChar() { return Byte2CharLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1055:1055 */    public Character previous() { return Character.valueOf(Byte2CharLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1061:1061 */    public char nextChar() { return Byte2CharLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1062:1062 */    public Character next() { return Character.valueOf(Byte2CharLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1063:     */  }
/* 1064:     */  
...
/* 1067:1067 */          return new Byte2CharLinkedOpenHashMap.ValueIterator(Byte2CharLinkedOpenHashMap.this);
/* 1068:     */        }
/* 1069:     */        
/* 1070:1070 */        public int size() { return Byte2CharLinkedOpenHashMap.this.size; }
/* 1071:     */        
/* 1072:     */        public boolean contains(char v) {
/* 1073:1073 */          return Byte2CharLinkedOpenHashMap.this.containsValue(v);
/* 1074:     */        }
/* 1075:     */        
/* 1076:1076 */        public void clear() { Byte2CharLinkedOpenHashMap.this.clear(); }
/* 1077:     */      };
/* 1078:     */    }
...
/* 1198:     */  }
/* 1199:     */  
/* 1202:     */  public Byte2CharLinkedOpenHashMap clone()
/* 1203:     */  {
/* 1204:     */    Byte2CharLinkedOpenHashMap c;
/* 1205:     */    
/* 1207:     */    try
/* 1208:     */    {
/* 1209:1209 */      c = (Byte2CharLinkedOpenHashMap)super.clone();
/* 1210:     */    }
