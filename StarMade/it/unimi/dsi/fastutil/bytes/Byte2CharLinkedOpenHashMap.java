  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2CharLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2CharLinkedOpenHashMap(Map<? extends Byte, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2CharLinkedOpenHashMap(Map<? extends Byte, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2CharLinkedOpenHashMap(Byte2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2CharLinkedOpenHashMap(Byte2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2CharLinkedOpenHashMap(byte[] local_k, char[] local_v, float local_f)
  {
  ...
  public Byte2CharLinkedOpenHashMap(byte[] local_k, char[] local_v)
  {
  ...
  public char getAndMoveToFirst(byte local_k)
  {
    byte[] key = this.key;
  ...
  public char getAndMoveToLast(byte local_k)
  {
    byte[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToFirst(byte local_k, char local_v)
  {
    byte[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToLast(byte local_k, char local_v)
  {
    byte[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public Character get(Byte local_ok)
  {
    byte local_k = local_ok.byteValue();
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k) {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Byte2CharLinkedOpenHashMap.ValueIterator(Byte2CharLinkedOpenHashMap.this);
        }
        ...
        {
          return Byte2CharLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2CharLinkedOpenHashMap local_c;
    try
    {
      local_c = (Byte2CharLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2CharLinkedOpenHashMap.MapIterator
    implements CharListIterator
  {
    ...
    {
      return Character.valueOf(Byte2CharLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Character.valueOf(Byte2CharLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSortedSet
  {
    ...
    {
      return new Byte2CharLinkedOpenHashMap.KeyIterator(Byte2CharLinkedOpenHashMap.this, from);
    }
    
    public ByteListIterator iterator()
    {
      return new Byte2CharLinkedOpenHashMap.KeyIterator(Byte2CharLinkedOpenHashMap.this);
    }
    ...
    {
      return Byte2CharLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2CharLinkedOpenHashMap.this.size;
      Byte2CharLinkedOpenHashMap.this.remove(local_k);
    ...
    implements ByteListIterator
  {
    ...
    {
      return Byte.valueOf(Byte2CharLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2CharLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2CharSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Byte2CharLinkedOpenHashMap.EntryIterator(Byte2CharLinkedOpenHashMap.this);
    }
    ...
    public Byte2CharMap.Entry first()
    {
      ...
      return new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this, Byte2CharLinkedOpenHashMap.this.first);
    }
    ...
    public Byte2CharMap.Entry last()
    {
      ...
      return new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this, Byte2CharLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2CharLinkedOpenHashMap.this.mask; Byte2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask) {
        if (Byte2CharLinkedOpenHashMap.this.key[pos] == local_k) {
          return Byte2CharLinkedOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2CharLinkedOpenHashMap.this.mask; Byte2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask) {
        if (Byte2CharLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Byte2CharLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Byte2CharLinkedOpenHashMap.EntryIterator(Byte2CharLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
    }
    
    public ObjectBidirectionalIterator<Byte2CharMap.Entry> fastIterator()
    {
      return new Byte2CharLinkedOpenHashMap.FastEntryIterator(Byte2CharLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Byte2CharMap.Entry> fastIterator(Byte2CharMap.Entry from)
    {
      return new Byte2CharLinkedOpenHashMap.FastEntryIterator(Byte2CharLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
    }
  }
    ...
    implements ObjectListIterator<Byte2CharMap.Entry>
  {
    ...
    public AbstractByte2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2CharLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Byte2CharLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Byte2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this, nextEntry());
    }
    
    public Byte2CharLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Byte2CharLinkedOpenHashMap.MapEntry(Byte2CharLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(byte from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Byte2CharLinkedOpenHashMap.this.mask; Byte2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Byte2CharLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Byte2CharLinkedOpenHashMap.this.first = this.next;
      } else {
        Byte2CharLinkedOpenHashMap.this.link[this.prev] ^= (Byte2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Byte2CharLinkedOpenHashMap.this.last = this.prev;
      } else {
        Byte2CharLinkedOpenHashMap.this.link[this.next] ^= (Byte2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2CharLinkedOpenHashMap.this.mask; Byte2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2CharLinkedOpenHashMap.this.key[pos]) & Byte2CharLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2CharLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Byte2CharLinkedOpenHashMap.this.key[last] = Byte2CharLinkedOpenHashMap.this.key[pos];
      ...
      Byte2CharLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Byte2CharMap.Entry, Map.Entry<Byte, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Byte2CharLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Character> local_e = (Map.Entry)local_o;
      return (Byte2CharLinkedOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2CharLinkedOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
