  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2ByteOpenCustomHashMap(int expected, float local_f, ByteHash.Strategy strategy)
  {
  ...
  public Byte2ByteOpenCustomHashMap(Map<? extends Byte, ? extends Byte> local_m, float local_f, ByteHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Byte2ByteOpenCustomHashMap(Map<? extends Byte, ? extends Byte> local_m, ByteHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Byte2ByteOpenCustomHashMap(Byte2ByteMap local_m, float local_f, ByteHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Byte2ByteOpenCustomHashMap(Byte2ByteMap local_m, ByteHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Byte2ByteOpenCustomHashMap(byte[] local_k, byte[] local_v, float local_f, ByteHash.Strategy strategy)
  {
  ...
  public Byte2ByteOpenCustomHashMap(byte[] local_k, byte[] local_v, ByteHash.Strategy strategy)
  {
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Byte2ByteOpenCustomHashMap.ValueIterator(Byte2ByteOpenCustomHashMap.this);
        }
        ...
        {
          return Byte2ByteOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2ByteOpenCustomHashMap local_c;
    try
    {
      local_c = (Byte2ByteOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2ByteOpenCustomHashMap.MapIterator
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2ByteOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSet
  {
    ...
    public ByteIterator iterator()
    {
      return new Byte2ByteOpenCustomHashMap.KeyIterator(Byte2ByteOpenCustomHashMap.this);
    }
    ...
    {
      return Byte2ByteOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2ByteOpenCustomHashMap.this.size;
      Byte2ByteOpenCustomHashMap.this.remove(local_k);
    ...
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2ByteOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2ByteMap.FastEntrySet
  {
    ...
    {
      return new Byte2ByteOpenCustomHashMap.EntryIterator(Byte2ByteOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Byte2ByteMap.Entry> fastIterator()
    {
      return new Byte2ByteOpenCustomHashMap.FastEntryIterator(Byte2ByteOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Byte2ByteOpenCustomHashMap.this.strategy.hashCode(local_k)) & Byte2ByteOpenCustomHashMap.this.mask; Byte2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteOpenCustomHashMap.this.mask) {
        if (Byte2ByteOpenCustomHashMap.this.strategy.equals(Byte2ByteOpenCustomHashMap.this.key[pos], local_k)) {
          return Byte2ByteOpenCustomHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Byte2ByteOpenCustomHashMap.this.strategy.hashCode(local_k)) & Byte2ByteOpenCustomHashMap.this.mask; Byte2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteOpenCustomHashMap.this.mask) {
        if (Byte2ByteOpenCustomHashMap.this.strategy.equals(Byte2ByteOpenCustomHashMap.this.key[pos], local_k))
        {
          Byte2ByteOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2ByteMap.Entry>
  {
    ...
    public AbstractByte2ByteMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2ByteOpenCustomHashMap.this.key[local_e];
      this.entry.value = Byte2ByteOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2ByteMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2ByteOpenCustomHashMap.MapEntry(Byte2ByteOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2ByteOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2ByteOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2170 = Byte2ByteOpenCustomHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2ByteOpenCustomHashMap.this.used;
      while ((this.field_2170 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2170 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Byte2ByteOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2ByteOpenCustomHashMap.this.mask; Byte2ByteOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2ByteOpenCustomHashMap.this.strategy.hashCode(Byte2ByteOpenCustomHashMap.this.key[pos])) & Byte2ByteOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2ByteOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2ByteOpenCustomHashMap.this.key[pos]);
        }
        Byte2ByteOpenCustomHashMap.this.key[last] = Byte2ByteOpenCustomHashMap.this.key[pos];
        Byte2ByteOpenCustomHashMap.this.value[last] = Byte2ByteOpenCustomHashMap.this.value[pos];
      }
      Byte2ByteOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2ByteOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2ByteOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2170 > 0))
      {
        this.field_2170 += 1;
        nextEntry();
      }
    ...
    implements Byte2ByteMap.Entry, Map.Entry<Byte, Byte>
  {
    ...
    public byte setValue(byte local_v)
    {
      ...
      Byte2ByteOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Byte> local_e = (Map.Entry)local_o;
      return (Byte2ByteOpenCustomHashMap.this.strategy.equals(Byte2ByteOpenCustomHashMap.this.key[this.index], ((Byte)local_e.getKey()).byteValue())) && (Byte2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
