...
/*  13:    */
/*  61:    */public abstract class AbstractByte2ReferenceMap<V>
/*  62:    */  extends AbstractByte2ReferenceFunction<V>
/*  63:    */  implements Byte2ReferenceMap<V>, Serializable
/*  64:    */{
...
/*  85: 85 */    if ((m instanceof Byte2ReferenceMap))
/*  86:    */    {
/*  87: 87 */      while (n-- != 0) {
/*  88: 88 */        Byte2ReferenceMap.Entry<? extends V> e = (Byte2ReferenceMap.Entry)i.next();
...
/* 106:    */    implements Byte2ReferenceMap.Entry<V>
/* 107:    */  {
...
/* 153:153 */      return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == e.getValue());
/* 154:    */    }
/* 155:    */    
...
/* 175:175 */      public boolean contains(byte k) { return AbstractByte2ReferenceMap.this.containsKey(k); }
/* 176:176 */      public int size() { return AbstractByte2ReferenceMap.this.size(); }
/* 177:177 */      public void clear() { AbstractByte2ReferenceMap.this.clear(); }
/* 178:    */      
/* 179:179 */      public ByteIterator iterator() { new AbstractByteIterator() {
/* 180:180 */          final ObjectIterator<Map.Entry<Byte, V>> i = AbstractByte2ReferenceMap.this.entrySet().iterator();
/* 181:181 */          public byte nextByte() { return ((Byte2ReferenceMap.Entry)this.i.next()).getByteKey(); }
...
/* 200:200 */      public boolean contains(Object k) { return AbstractByte2ReferenceMap.this.containsValue(k); }
/* 201:201 */      public int size() { return AbstractByte2ReferenceMap.this.size(); }
/* 202:202 */      public void clear() { AbstractByte2ReferenceMap.this.clear(); }
/* 203:    */      
/* 204:204 */      public ObjectIterator<V> iterator() { new AbstractObjectIterator() {
/* 205:205 */          final ObjectIterator<Map.Entry<Byte, V>> i = AbstractByte2ReferenceMap.this.entrySet().iterator();
/* 206:206 */          public V next() { return ((Byte2ReferenceMap.Entry)this.i.next()).getValue(); }
...
/* 213:    */  {
/* 214:214 */    return byte2ReferenceEntrySet();
/* 215:    */  }
/* 216:    */  
...
/* 244:244 */        s.append(", ");
/* 245:245 */      Byte2ReferenceMap.Entry<V> e = (Byte2ReferenceMap.Entry)i.next();
