...
/*   22:     */
/*  101:     */public class Byte2ReferenceLinkedOpenHashMap<V>
/*  102:     */  extends AbstractByte2ReferenceSortedMap<V>
...
/*  115:     */  protected volatile transient Byte2ReferenceSortedMap.FastSortedEntrySet<V> entries;
...
/*  129:     */  
/*  137:     */  public Byte2ReferenceLinkedOpenHashMap(int expected, float f)
/*  138:     */  {
...
/*  149:     */  }
/*  150:     */  
/*  153:     */  public Byte2ReferenceLinkedOpenHashMap(int expected)
/*  154:     */  {
/*  155: 155 */    this(expected, 0.75F);
/*  156:     */  }
/*  157:     */  
/*  159:     */  public Byte2ReferenceLinkedOpenHashMap()
/*  160:     */  {
/*  161: 161 */    this(16, 0.75F);
/*  162:     */  }
/*  163:     */  
/*  167:     */  public Byte2ReferenceLinkedOpenHashMap(Map<? extends Byte, ? extends V> m, float f)
/*  168:     */  {
/*  169: 169 */    this(m.size(), f);
/*  170: 170 */    putAll(m);
/*  171:     */  }
/*  172:     */  
/*  175:     */  public Byte2ReferenceLinkedOpenHashMap(Map<? extends Byte, ? extends V> m)
/*  176:     */  {
/*  177: 177 */    this(m, 0.75F);
/*  178:     */  }
/*  179:     */  
/*  183:     */  public Byte2ReferenceLinkedOpenHashMap(Byte2ReferenceMap<V> m, float f)
/*  184:     */  {
/*  185: 185 */    this(m.size(), f);
/*  186: 186 */    putAll(m);
/*  187:     */  }
/*  188:     */  
/*  191:     */  public Byte2ReferenceLinkedOpenHashMap(Byte2ReferenceMap<V> m)
/*  192:     */  {
/*  193: 193 */    this(m, 0.75F);
/*  194:     */  }
/*  195:     */  
/*  201:     */  public Byte2ReferenceLinkedOpenHashMap(byte[] k, V[] v, float f)
/*  202:     */  {
...
/*  207:     */  }
/*  208:     */  
/*  212:     */  public Byte2ReferenceLinkedOpenHashMap(byte[] k, V[] v)
/*  213:     */  {
...
/*  610:     */    implements Byte2ReferenceMap.Entry<V>, Map.Entry<Byte, V>
/*  611:     */  {
...
/*  617:     */    }
/*  618:     */    
/*  619: 619 */    public Byte getKey() { return Byte.valueOf(Byte2ReferenceLinkedOpenHashMap.this.key[this.index]); }
/*  620:     */    
/*  621:     */    public byte getByteKey() {
/*  622: 622 */      return Byte2ReferenceLinkedOpenHashMap.this.key[this.index];
/*  623:     */    }
/*  624:     */    
/*  625: 625 */    public V getValue() { return Byte2ReferenceLinkedOpenHashMap.this.value[this.index]; }
/*  626:     */    
/*  627:     */    public V setValue(V v) {
/*  628: 628 */      V oldValue = Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  629: 629 */      Byte2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
...
/*  636: 636 */      return (Byte2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*  637:     */    }
/*  638:     */    
/*  639: 639 */    public int hashCode() { return Byte2ReferenceLinkedOpenHashMap.this.key[this.index] ^ (Byte2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Byte2ReferenceLinkedOpenHashMap.this.value[this.index])); }
/*  640:     */    
/*  641:     */    public String toString() {
/*  642: 642 */      return Byte2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  643:     */    }
/*  644:     */  }
/*  645:     */  
...
/*  730: 730 */  public Byte2ReferenceSortedMap<V> tailMap(byte from) { throw new UnsupportedOperationException(); }
/*  731: 731 */  public Byte2ReferenceSortedMap<V> headMap(byte to) { throw new UnsupportedOperationException(); }
/*  732: 732 */  public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) { throw new UnsupportedOperationException(); }
/*  733:     */  
...
/*  747: 747 */    int index = -1;
/*  748:     */    
/*  749: 749 */    private MapIterator() { this.next = Byte2ReferenceLinkedOpenHashMap.this.first;
/*  750: 750 */      this.index = 0;
/*  751:     */    }
/*  752:     */    
/*  753: 753 */    private MapIterator(byte from) { if (Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.last] == from) {
/*  754: 754 */        this.prev = Byte2ReferenceLinkedOpenHashMap.this.last;
/*  755: 755 */        this.index = Byte2ReferenceLinkedOpenHashMap.this.size;
/*  756:     */      }
/*  757:     */      else
/*  758:     */      {
/*  759: 759 */        int pos = HashCommon.murmurHash3(from) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  760:     */        
/*  761: 761 */        while (Byte2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  762: 762 */          if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == from)
/*  763:     */          {
/*  764: 764 */            this.next = ((int)Byte2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  765: 765 */            this.prev = pos;
/*  766: 766 */            return;
/*  767:     */          }
/*  768: 768 */          pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  769:     */        }
...
/*  782: 782 */        this.index = Byte2ReferenceLinkedOpenHashMap.this.size;
/*  783: 783 */        return;
/*  784:     */      }
/*  785: 785 */      int pos = Byte2ReferenceLinkedOpenHashMap.this.first;
/*  786: 786 */      this.index = 1;
/*  787: 787 */      while (pos != this.prev) {
/*  788: 788 */        pos = (int)Byte2ReferenceLinkedOpenHashMap.this.link[pos];
...
/*  799:     */    }
/*  800:     */    
/*  801: 801 */    public int nextEntry() { if (!hasNext()) return Byte2ReferenceLinkedOpenHashMap.this.size();
/*  802: 802 */      this.curr = this.next;
/*  803: 803 */      this.next = ((int)Byte2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  811: 811 */      this.prev = ((int)(Byte2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  824: 824 */        this.prev = ((int)(Byte2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  825:     */      }
/*  826:     */      else {
/*  827: 827 */        this.next = ((int)Byte2ReferenceLinkedOpenHashMap.this.link[this.curr]); }
/*  828: 828 */      Byte2ReferenceLinkedOpenHashMap.this.size -= 1;
/*  829:     */      
/*  831: 831 */      if (this.prev == -1) { Byte2ReferenceLinkedOpenHashMap.this.first = this.next;
/*  832:     */      } else
/*  833: 833 */        Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834: 834 */      if (this.next == -1) { Byte2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*  835:     */      } else
/*  836: 836 */        Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  837: 837 */      int pos = this.curr;
/*  838:     */      int last;
/*  839:     */      for (;;) {
/*  840: 840 */        pos = (last = pos) + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  841: 841 */        while (Byte2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  842: 842 */          int slot = HashCommon.murmurHash3(Byte2ReferenceLinkedOpenHashMap.this.key[pos]) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  843: 843 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844: 844 */          pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  845:     */        }
/*  846: 846 */        if (Byte2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847: 847 */        Byte2ReferenceLinkedOpenHashMap.this.key[last] = Byte2ReferenceLinkedOpenHashMap.this.key[pos];
/*  848: 848 */        Byte2ReferenceLinkedOpenHashMap.this.value[last] = Byte2ReferenceLinkedOpenHashMap.this.value[pos];
/*  849: 849 */        if (this.next == pos) this.next = last;
/*  850: 850 */        if (this.prev == pos) this.prev = last;
/*  851: 851 */        Byte2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*  852:     */      }
/*  853: 853 */      Byte2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  854: 854 */      Byte2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  855: 855 */      this.curr = -1;
/*  856:     */    }
/*  857:     */    
...
/*  866:     */    } }
/*  867:     */  
/*  868:     */  private class EntryIterator extends Byte2ReferenceLinkedOpenHashMap<V>.MapIterator implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> { private Byte2ReferenceLinkedOpenHashMap<V>.MapEntry entry;
/*  869:     */    
/*  870: 870 */    public EntryIterator() { super(null); }
/*  871:     */    
/*  872: 872 */    public EntryIterator(byte from) { super(from, null); }
/*  873:     */    
/*  874:     */    public Byte2ReferenceLinkedOpenHashMap<V>.MapEntry next() {
/*  875: 875 */      return this.entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this, nextEntry());
/*  876:     */    }
/*  877:     */    
/*  878: 878 */    public Byte2ReferenceLinkedOpenHashMap<V>.MapEntry previous() { return this.entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this, previousEntry()); }
/*  879:     */    
/*  880:     */    public void remove()
/*  881:     */    {
/*  882: 882 */      super.remove();
/*  883: 883 */      Byte2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  884:     */    
/*  885: 885 */    public void set(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*  886: 886 */    public void add(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*  887:     */  }
/*  888:     */  
/*  889: 889 */  private class FastEntryIterator extends Byte2ReferenceLinkedOpenHashMap<V>.MapIterator implements ObjectListIterator<Byte2ReferenceMap.Entry<V>> { final AbstractByte2ReferenceMap.BasicEntry<V> entry = new AbstractByte2ReferenceMap.BasicEntry((byte)0, null);
/*  890: 890 */    public FastEntryIterator() { super(null); }
/*  891:     */    
/*  892: 892 */    public FastEntryIterator(byte from) { super(from, null); }
/*  893:     */    
/*  894:     */    public AbstractByte2ReferenceMap.BasicEntry<V> next() {
/*  895: 895 */      int e = nextEntry();
/*  896: 896 */      this.entry.key = Byte2ReferenceLinkedOpenHashMap.this.key[e];
/*  897: 897 */      this.entry.value = Byte2ReferenceLinkedOpenHashMap.this.value[e];
/*  898: 898 */      return this.entry;
/*  899:     */    }
/*  900:     */    
/*  901: 901 */    public AbstractByte2ReferenceMap.BasicEntry<V> previous() { int e = previousEntry();
/*  902: 902 */      this.entry.key = Byte2ReferenceLinkedOpenHashMap.this.key[e];
/*  903: 903 */      this.entry.value = Byte2ReferenceLinkedOpenHashMap.this.value[e];
/*  904: 904 */      return this.entry; }
/*  905:     */    
/*  906: 906 */    public void set(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*  907: 907 */    public void add(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } }
/*  908:     */  
/*  909:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Byte2ReferenceMap.Entry<V>> implements Byte2ReferenceSortedMap.FastSortedEntrySet<V> { private MapEntrySet() {}
/*  910:     */    
/*  911: 911 */    public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator() { return new Byte2ReferenceLinkedOpenHashMap.EntryIterator(Byte2ReferenceLinkedOpenHashMap.this); }
/*  912:     */    
/*  913: 913 */    public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() { return null; }
/*  914: 914 */    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> fromElement, Byte2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); }
/*  915: 915 */    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); }
/*  916: 916 */    public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); }
/*  917:     */    
/*  918: 918 */    public Byte2ReferenceMap.Entry<V> first() { if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919: 919 */      return new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this, Byte2ReferenceLinkedOpenHashMap.this.first);
/*  920:     */    }
/*  921:     */    
/*  922: 922 */    public Byte2ReferenceMap.Entry<V> last() { if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923: 923 */      return new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this, Byte2ReferenceLinkedOpenHashMap.this.last);
/*  924:     */    }
/*  925:     */    
...
/*  930:     */      
/*  931: 931 */      int pos = HashCommon.murmurHash3(k) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  932:     */      
/*  933: 933 */      while (Byte2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  934: 934 */        if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == k) return Byte2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  935: 935 */        pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  936:     */      }
...
/*  944:     */      
/*  945: 945 */      int pos = HashCommon.murmurHash3(k) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  946:     */      
/*  947: 947 */      while (Byte2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  948: 948 */        if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == k) {
/*  949: 949 */          Byte2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  950: 950 */          return true;
/*  951:     */        }
/*  952: 952 */        pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  953:     */      }
/*  954: 954 */      return false;
/*  955:     */    }
/*  956:     */    
/*  957: 957 */    public int size() { return Byte2ReferenceLinkedOpenHashMap.this.size; }
/*  958:     */    
/*  959:     */    public void clear() {
/*  960: 960 */      Byte2ReferenceLinkedOpenHashMap.this.clear();
/*  961:     */    }
/*  962:     */    
/*  963: 963 */    public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) { return new Byte2ReferenceLinkedOpenHashMap.EntryIterator(Byte2ReferenceLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue()); }
/*  964:     */    
/*  965:     */    public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> fastIterator() {
/*  966: 966 */      return new Byte2ReferenceLinkedOpenHashMap.FastEntryIterator(Byte2ReferenceLinkedOpenHashMap.this);
/*  967:     */    }
/*  968:     */    
/*  969: 969 */    public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> fastIterator(Byte2ReferenceMap.Entry<V> from) { return new Byte2ReferenceLinkedOpenHashMap.FastEntryIterator(Byte2ReferenceLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue()); }
/*  970:     */  }
/*  971:     */  
/*  972:     */  public Byte2ReferenceSortedMap.FastSortedEntrySet<V> byte2ReferenceEntrySet() {
...
/*  980:     */    extends Byte2ReferenceLinkedOpenHashMap.MapIterator
/*  981:     */    implements ByteListIterator
/*  982:     */  {
/*  983: 983 */    public KeyIterator(byte k) { super(k, null); }
/*  984: 984 */    public byte previousByte() { return Byte2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; }
...
/*  987: 987 */    public Byte previous() { return Byte.valueOf(Byte2ReferenceLinkedOpenHashMap.this.key[previousEntry()]); }
...
/*  991: 991 */    public byte nextByte() { return Byte2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; }
/*  992: 992 */    public Byte next() { return Byte.valueOf(Byte2ReferenceLinkedOpenHashMap.this.key[nextEntry()]); } }
/*  993:     */  
/*  994:     */  private final class KeySet extends AbstractByteSortedSet { private KeySet() {}
/*  995:     */    
/*  996: 996 */    public ByteListIterator iterator(byte from) { return new Byte2ReferenceLinkedOpenHashMap.KeyIterator(Byte2ReferenceLinkedOpenHashMap.this, from); }
/*  997:     */    
/*  998:     */    public ByteListIterator iterator() {
/*  999: 999 */      return new Byte2ReferenceLinkedOpenHashMap.KeyIterator(Byte2ReferenceLinkedOpenHashMap.this);
/* 1000:     */    }
/* 1001:     */    
/* 1002:1002 */    public int size() { return Byte2ReferenceLinkedOpenHashMap.this.size; }
/* 1003:     */    
/* 1005:1005 */    public boolean contains(byte k) { return Byte2ReferenceLinkedOpenHashMap.this.containsKey(k); }
/* 1006:     */    
/* 1007:     */    public boolean remove(byte k) {
/* 1008:1008 */      int oldSize = Byte2ReferenceLinkedOpenHashMap.this.size;
/* 1009:1009 */      Byte2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1010:1010 */      return Byte2ReferenceLinkedOpenHashMap.this.size != oldSize;
/* 1011:     */    }
/* 1012:     */    
/* 1013:1013 */    public void clear() { Byte2ReferenceLinkedOpenHashMap.this.clear(); }
/* 1014:     */    
/* 1015:     */    public byte firstByte() {
/* 1016:1016 */      if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017:1017 */      return Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.first];
/* 1018:     */    }
/* 1019:     */    
/* 1020:1020 */    public byte lastByte() { if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021:1021 */      return Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.last]; }
/* 1022:     */    
...
/* 1036:     */    extends Byte2ReferenceLinkedOpenHashMap<V>.MapIterator
/* 1037:     */    implements ObjectListIterator<V>
/* 1038:     */  {
/* 1039:1039 */    public V previous() { return Byte2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; }
...
/* 1043:1043 */    public V next() { return Byte2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1044:     */  }
/* 1045:     */  
...
/* 1048:1048 */          return new Byte2ReferenceLinkedOpenHashMap.ValueIterator(Byte2ReferenceLinkedOpenHashMap.this);
/* 1049:     */        }
/* 1050:     */        
/* 1051:1051 */        public int size() { return Byte2ReferenceLinkedOpenHashMap.this.size; }
/* 1052:     */        
/* 1053:     */        public boolean contains(Object v) {
/* 1054:1054 */          return Byte2ReferenceLinkedOpenHashMap.this.containsValue(v);
/* 1055:     */        }
/* 1056:     */        
/* 1057:1057 */        public void clear() { Byte2ReferenceLinkedOpenHashMap.this.clear(); }
/* 1058:     */      };
/* 1059:     */    }
...
/* 1179:     */  }
/* 1180:     */  
/* 1183:     */  public Byte2ReferenceLinkedOpenHashMap<V> clone()
/* 1184:     */  {
/* 1185:     */    Byte2ReferenceLinkedOpenHashMap<V> c;
/* 1186:     */    
/* 1188:     */    try
/* 1189:     */    {
/* 1190:1190 */      c = (Byte2ReferenceLinkedOpenHashMap)super.clone();
/* 1191:     */    }
...
/* 1228:1228 */    Byte2ReferenceLinkedOpenHashMap<V>.MapIterator i = new MapIterator(null);
