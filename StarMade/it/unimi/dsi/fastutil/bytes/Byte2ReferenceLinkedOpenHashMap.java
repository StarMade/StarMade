...
/*      */   }
/*  729 */   public ByteComparator comparator() { return null; } 
/*  730 */   public Byte2ReferenceSortedMap<V> tailMap(byte from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Byte2ReferenceSortedMap<V> headMap(byte to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Byte2ReferenceSortedMap<V> subMap(byte from, byte to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Byte2ReferenceLinkedOpenHashMap.ValueIterator(Byte2ReferenceLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Byte2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Byte2ReferenceLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */ 
/* 1137 */     byte[] key = this.key;
/* 1138 */     Object[] value = this.value;
/* 1139 */     int newMask = newN - 1;
/* 1140 */     byte[] newKey = new byte[newN];
...
/*      */     try
/*      */     {
/* 1190 */       c = (Byte2ReferenceLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1196 */     c.values = null;
/* 1197 */     c.entries = null;
/* 1198 */     c.key = ((byte[])this.key.clone());
...
/* 1242 */     byte[] key = this.key = new byte[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Byte2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Byte2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Byte2ReferenceLinkedOpenHashMap.KeyIterator(Byte2ReferenceLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ByteListIterator iterator() {
/*  999 */       return new Byte2ReferenceLinkedOpenHashMap.KeyIterator(Byte2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(byte k) {
/* 1005 */       return Byte2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(byte k) {
/* 1008 */       int oldSize = Byte2ReferenceLinkedOpenHashMap.this.size;
/* 1009 */       Byte2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Byte2ReferenceLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Byte2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public byte firstByte() {
/* 1016 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public byte lastByte() {
/* 1020 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
/* 1023 */     public ByteComparator comparator() { return null; } 
/* 1024 */     public final ByteSortedSet tailSet(byte from) { throw new UnsupportedOperationException(); } 
/* 1025 */     public final ByteSortedSet headSet(byte to) { throw new UnsupportedOperationException(); } 
/* 1026 */     public final ByteSortedSet subSet(byte from, byte to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2ReferenceLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator(byte k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public byte previousByte() { return Byte2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; } 
/*  985 */     public void set(byte k) { throw new UnsupportedOperationException(); } 
/*  986 */     public void add(byte k) { throw new UnsupportedOperationException(); } 
/*  987 */     public Byte previous() { return Byte.valueOf(Byte2ReferenceLinkedOpenHashMap.this.key[previousEntry()]); } 
/*  988 */     public void set(Byte ok) { throw new UnsupportedOperationException(); } 
/*  989 */     public void add(Byte ok) { throw new UnsupportedOperationException(); } 
/*  990 */     public KeyIterator() { super(null); } 
/*  991 */     public byte nextByte() { return Byte2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Byte next() { return Byte.valueOf(Byte2ReferenceLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Byte2ReferenceLinkedOpenHashMap.EntryIterator(Byte2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Byte2ReferenceMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> subSet(Byte2ReferenceMap.Entry<V> fromElement, Byte2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> headSet(Byte2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Byte2ReferenceMap.Entry<V>> tailSet(Byte2ReferenceMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Byte2ReferenceMap.Entry<V> first() {
/*  918 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this, Byte2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Byte2ReferenceMap.Entry<V> last() {
/*  922 */       if (Byte2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this, Byte2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     public boolean contains(Object o) {
/*  927 */       if (!(o instanceof Map.Entry)) return false;
/*  928 */       Map.Entry e = (Map.Entry)o;
/*  929 */       byte k = ((Byte)e.getKey()).byteValue();
/*      */ 
/*  931 */       int pos = HashCommon.murmurHash3(k) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Byte2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == k) return Byte2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  935 */         pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*  943 */       byte k = ((Byte)e.getKey()).byteValue();
/*      */ 
/*  945 */       int pos = HashCommon.murmurHash3(k) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Byte2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Byte2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Byte2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> iterator(Byte2ReferenceMap.Entry<V> from) {
/*  963 */       return new Byte2ReferenceLinkedOpenHashMap.EntryIterator(Byte2ReferenceLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> fastIterator() {
/*  966 */       return new Byte2ReferenceLinkedOpenHashMap.FastEntryIterator(Byte2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2ReferenceMap.Entry<V>> fastIterator(Byte2ReferenceMap.Entry<V> from) {
/*  969 */       return new Byte2ReferenceLinkedOpenHashMap.FastEntryIterator(Byte2ReferenceLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Byte2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Byte2ReferenceMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractByte2ReferenceMap.BasicEntry<V> entry = new AbstractByte2ReferenceMap.BasicEntry((byte)0, null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Byte2ReferenceLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Byte2ReferenceLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractByte2ReferenceMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Byte2ReferenceLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Byte2ReferenceLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Byte2ReferenceMap.Entry<V>>
/*      */   {
...
/*  870 */       super(null);
/*      */     }
/*  872 */     public EntryIterator(byte from) { super(from, null); }
/*      */ 
/*      */     public Byte2ReferenceLinkedOpenHashMap<V>.MapEntry next() {
/*  875 */       return this.entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Byte2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Byte2ReferenceLinkedOpenHashMap.MapEntry(Byte2ReferenceLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Byte2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Byte2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Byte2ReferenceLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(byte from) {
/*  753 */       if (Byte2ReferenceLinkedOpenHashMap.this.key[Byte2ReferenceLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Byte2ReferenceLinkedOpenHashMap.this.last;
/*  755 */         this.index = Byte2ReferenceLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = HashCommon.murmurHash3(from) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Byte2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Byte2ReferenceLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Byte2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Byte2ReferenceLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Byte2ReferenceLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Byte2ReferenceLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Byte2ReferenceLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Byte2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Byte2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Byte2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Byte2ReferenceLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Byte2ReferenceLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Byte2ReferenceLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Byte2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Byte2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Byte2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  841 */         while (Byte2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = HashCommon.murmurHash3(Byte2ReferenceLinkedOpenHashMap.this.key[pos]) & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Byte2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Byte2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Byte2ReferenceLinkedOpenHashMap.this.key[last] = Byte2ReferenceLinkedOpenHashMap.this.key[pos];
/*  848 */         Byte2ReferenceLinkedOpenHashMap.this.value[last] = Byte2ReferenceLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Byte2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Byte2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Byte2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Byte getKey() {
/*  619 */       return Byte.valueOf(Byte2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public byte getByteKey() {
/*  622 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  629 */       Byte2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Byte2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index] ^ (Byte2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Byte2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */     public String toString() {
/*  642 */       return Byte2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
