...
/*  17:    */
/*  66:    */public class Byte2DoubleArrayMap
/*  67:    */  extends AbstractByte2DoubleMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Byte2DoubleArrayMap(byte[] key, double[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Byte2DoubleArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = ByteArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = DoubleArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Byte2DoubleArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new byte[capacity];
/*  94: 94 */    this.value = new double[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Byte2DoubleArrayMap(Byte2DoubleMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Byte2DoubleArrayMap(Map<? extends Byte, ? extends Double> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Byte2DoubleArrayMap(byte[] key, double[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry> implements Byte2DoubleMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Byte2DoubleMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Byte2DoubleArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Byte2DoubleMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractByte2DoubleMap.BasicEntry(Byte2DoubleArrayMap.this.key[this.next], Byte2DoubleArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Byte2DoubleMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractByte2DoubleMap.BasicEntry entry = new AbstractByte2DoubleMap.BasicEntry((byte)0, 0.0D);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Byte2DoubleArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Byte2DoubleMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Byte2DoubleArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Byte2DoubleArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Byte2DoubleArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Byte, Double> e = (Map.Entry)o;
/* 165:165 */      byte k = ((Byte)e.getKey()).byteValue();
/* 166:166 */      return (Byte2DoubleArrayMap.this.containsKey(k)) && (Byte2DoubleArrayMap.this.get(k) == ((Double)e.getValue()).doubleValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Byte2DoubleMap.FastEntrySet byte2DoubleEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public double put(byte k, double v)
/* 213:    */  {
...
/* 234:    */  }
/* 235:    */  
/* 236:    */  public double remove(byte k)
/* 237:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Byte2DoubleArrayMap clone()
/* 263:    */  {
/* 264:    */    Byte2DoubleArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Byte2DoubleArrayMap)super.clone();
/* 270:    */    }
