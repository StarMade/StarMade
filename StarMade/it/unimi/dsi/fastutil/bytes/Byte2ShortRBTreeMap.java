  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2ShortRBTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2ShortRBTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2ShortRBTreeMap(Map<? extends Byte, ? extends Short> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ShortRBTreeMap(SortedMap<Byte, Short> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ShortRBTreeMap(Byte2ShortMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ShortRBTreeMap(Byte2ShortSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ShortRBTreeMap(byte[] local_k, short[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2ShortRBTreeMap(byte[] local_k, short[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Byte2ShortMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Byte2ShortRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2ShortRBTreeMap.EntryIterator(Byte2ShortRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from)
        {
          return new Byte2ShortRBTreeMap.EntryIterator(Byte2ShortRBTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2ShortRBTreeMap.Entry local_f = Byte2ShortRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2ShortRBTreeMap.Entry local_f = Byte2ShortRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2ShortRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Byte2ShortRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ShortEntrySet();
        }
        
        public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry local_to)
        {
          return Byte2ShortRBTreeMap.this.headMap((Byte)local_to.getKey()).byte2ShortEntrySet();
        }
        
        public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from)
        {
          return Byte2ShortRBTreeMap.this.tailMap((Byte)from.getKey()).byte2ShortEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Byte2ShortRBTreeMap.ValueIterator(Byte2ShortRBTreeMap.this, null);
        }
        
        public boolean contains(short local_k)
        {
          return Byte2ShortRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2ShortRBTreeMap local_c;
    try
    {
      local_c = (Byte2ShortRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2ShortRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2ShortRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2ShortRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator()
          {
            return new Byte2ShortRBTreeMap.Submap.SubmapEntryIterator(Byte2ShortRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from)
          {
            return new Byte2ShortRBTreeMap.Submap.SubmapEntryIterator(Byte2ShortRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Short> local_e = (Map.Entry)local_o;
            Byte2ShortRBTreeMap.Entry local_f = Byte2ShortRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2ShortRBTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Short> local_e = (Map.Entry)local_o;
            Byte2ShortRBTreeMap.Entry local_f = Byte2ShortRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2ShortRBTreeMap.Submap.this.in3(local_f.key))) {
              Byte2ShortRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2ShortRBTreeMap.Submap.SubmapIterator(Byte2ShortRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2ShortRBTreeMap.Submap.this.clear();
          }
          
          public Byte2ShortMap.Entry first()
          {
            return Byte2ShortRBTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2ShortMap.Entry last()
          {
            return Byte2ShortRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry local_to)
          {
            return Byte2ShortRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ShortEntrySet();
          }
          
          public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry local_to)
          {
            return Byte2ShortRBTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2ShortEntrySet();
          }
          
          public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from)
          {
            return Byte2ShortRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ShortEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ShortCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractShortCollection()
        {
          public ShortIterator iterator()
          {
            return new Byte2ShortRBTreeMap.Submap.SubmapValueIterator(Byte2ShortRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(short local_k)
          {
            return Byte2ShortRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2ShortRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2ShortRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2ShortRBTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2ShortRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public short put(byte local_k, short local_v)
    {
      ...
      short oldValue = Byte2ShortRBTreeMap.this.put(local_k, local_v);
    ...
    public short remove(byte local_k)
    {
      ...
      short oldValue = Byte2ShortRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2ShortRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2ShortRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2ShortSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2ShortRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ShortRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2ShortSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2ShortRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2ShortRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2ShortRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2ShortRBTreeMap.this.locateKey(this.from);
        if (Byte2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2ShortRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2ShortRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2ShortRBTreeMap.this.locateKey(this.field_47);
        if (Byte2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2ShortRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2ShortRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2ShortRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2ShortRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2ShortRBTreeMap.Submap.this.bottom) && (Byte2ShortRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2ShortRBTreeMap.Submap.this.top) && (Byte2ShortRBTreeMap.this.compare(local_k, (this.prev = Byte2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2ShortRBTreeMap.this.locateKey(local_k);
            if (Byte2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2ShortRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ShortRBTreeMap.this.compare(this.prev.key, Byte2ShortRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2ShortRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2ShortRBTreeMap.this.compare(this.next.key, Byte2ShortRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2ShortSortedMap.KeySet
    {
      ...
      {
        return new Byte2ShortRBTreeMap.Submap.SubmapKeyIterator(Byte2ShortRBTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2ShortRBTreeMap.Submap.SubmapKeyIterator(Byte2ShortRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2ShortSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2ShortRBTreeMap.KeyIterator(Byte2ShortRBTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2ShortRBTreeMap.KeyIterator(Byte2ShortRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2ShortRBTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
