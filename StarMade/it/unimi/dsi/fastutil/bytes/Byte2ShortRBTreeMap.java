...
/*      */ 
/*      */ public class Byte2ShortRBTreeMap extends AbstractByte2ShortSortedMap
...
/*      */   protected volatile transient ObjectSortedSet<Byte2ShortMap.Entry> entries;
...
/*  119 */           return Byte2ShortRBTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  122 */           return Byte2ShortRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     short oldValue = put(ok.byteValue(), ov.shortValue());
/*  731 */     return this.modified ? null : Short.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Short remove(Object ok)
/*      */   {
/*  737 */     short oldValue = remove(((Byte)ok).byteValue());
...
/* 1141 */         final Comparator<? super Byte2ShortMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Byte2ShortMap.Entry x, Byte2ShortMap.Entry y) {
/* 1143 */             return Byte2ShortRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Byte2ShortRBTreeMap.EntryIterator(Byte2ShortRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from) {
/* 1153 */           return new Byte2ShortRBTreeMap.EntryIterator(Byte2ShortRBTreeMap.this, ((Byte)from.getKey()).byteValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Byte2ShortRBTreeMap.Entry f = Byte2ShortRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1166 */           Byte2ShortRBTreeMap.Entry f = Byte2ShortRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1167 */           if (f != null) Byte2ShortRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Byte2ShortRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Byte2ShortRBTreeMap.this.clear(); } 
/* 1172 */         public Byte2ShortMap.Entry first() { return Byte2ShortRBTreeMap.this.firstEntry; } 
/* 1173 */         public Byte2ShortMap.Entry last() { return Byte2ShortRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry to) { return Byte2ShortRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ShortEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry to) { return Byte2ShortRBTreeMap.this.headMap((Byte)to.getKey()).byte2ShortEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from) { return Byte2ShortRBTreeMap.this.tailMap((Byte)from.getKey()).byte2ShortEntrySet(); }
/*      */       };
...
/* 1242 */           return new Byte2ShortRBTreeMap.ValueIterator(Byte2ShortRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(short k) {
/* 1245 */           return Byte2ShortRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Byte2ShortRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Byte2ShortRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Byte2ShortRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readByte(), s.readShort());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readByte(), s.readShort());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readByte(), s.readShort()));
...
/*      */ 
/*      */ 
/*      */   private final class Submap extends AbstractByte2ShortSortedMap
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Byte2ShortRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Byte2ShortRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator() {
/* 1329 */             return new Byte2ShortRBTreeMap.Submap.SubmapEntryIterator(Byte2ShortRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Byte2ShortMap.Entry> iterator(Byte2ShortMap.Entry from) {
/* 1332 */             return new Byte2ShortRBTreeMap.Submap.SubmapEntryIterator(Byte2ShortRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
/*      */           }
/* 1334 */           public Comparator<? super Byte2ShortMap.Entry> comparator() { return Byte2ShortRBTreeMap.this.byte2ShortEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Byte2ShortRBTreeMap.Entry f = Byte2ShortRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1340 */             return (f != null) && (Byte2ShortRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Byte2ShortRBTreeMap.Entry f = Byte2ShortRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1347 */             if ((f != null) && (Byte2ShortRBTreeMap.Submap.this.in(f.key))) Byte2ShortRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Byte2ShortRBTreeMap.Submap.SubmapIterator(Byte2ShortRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Byte2ShortRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Byte2ShortMap.Entry first() { return Byte2ShortRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Byte2ShortMap.Entry last() { return Byte2ShortRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Byte2ShortMap.Entry> subSet(Byte2ShortMap.Entry from, Byte2ShortMap.Entry to) { return Byte2ShortRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ShortEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Byte2ShortMap.Entry> headSet(Byte2ShortMap.Entry to) { return Byte2ShortRBTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2ShortEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Byte2ShortMap.Entry> tailSet(Byte2ShortMap.Entry from) { return Byte2ShortRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ShortEntrySet(); }
/*      */         };
...
/*      */           public ShortIterator iterator() {
/* 1376 */             return new Byte2ShortRBTreeMap.Submap.SubmapValueIterator(Byte2ShortRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(short k) {
/* 1379 */             return Byte2ShortRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Byte2ShortRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Byte2ShortRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(byte k) {
/* 1392 */       return (in(k)) && (Byte2ShortRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(short v) {
...
/* 1407 */       return (in(kk)) && ((e = Byte2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public short put(byte k, short v) {
/* 1410 */       Byte2ShortRBTreeMap.this.modified = false;
...
/* 1412 */       short oldValue = Byte2ShortRBTreeMap.this.put(k, v);
/* 1413 */       return Byte2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Short put(Byte ok, Short ov) {
/* 1416 */       short oldValue = put(ok.byteValue(), ov.shortValue());
/* 1417 */       return Byte2ShortRBTreeMap.this.modified ? null : Short.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public short remove(byte k) {
/* 1421 */       Byte2ShortRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       short oldValue = Byte2ShortRBTreeMap.this.remove(k);
/* 1424 */       return Byte2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Short remove(Object ok) {
/* 1427 */       short oldValue = remove(((Byte)ok).byteValue());
/* 1428 */       return Byte2ShortRBTreeMap.this.modified ? Short.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1443 */       return Byte2ShortRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Byte2ShortSortedMap headMap(byte to) {
/* 1446 */       if (this.top) return new Submap(Byte2ShortRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Byte2ShortRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2ShortRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Byte2ShortSortedMap tailMap(byte from) {
/* 1450 */       if (this.bottom) return new Submap(Byte2ShortRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Byte2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ShortRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Byte2ShortSortedMap subMap(byte from, byte to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Byte2ShortRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Byte2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Byte2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Byte2ShortRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Byte2ShortRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Byte2ShortRBTreeMap.this.tree == null) return null;
/* 1468 */       Byte2ShortRBTreeMap.Entry e;
/*      */       Byte2ShortRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Byte2ShortRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Byte2ShortRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Byte2ShortRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Byte2ShortRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Byte2ShortRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Byte2ShortRBTreeMap.this.tree == null) return null;
/* 1486 */       Byte2ShortRBTreeMap.Entry e;
/*      */       Byte2ShortRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Byte2ShortRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Byte2ShortRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Byte2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Byte2ShortRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public byte firstByteKey() {
/* 1497 */       Byte2ShortRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public byte lastByteKey() {
/* 1502 */       Byte2ShortRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Byte firstKey() {
/* 1507 */       Byte2ShortRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Byte lastKey() {
/* 1512 */       Byte2ShortRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Byte2ShortRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Byte2ShortRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Byte2ShortRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Byte2ShortMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Byte2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Byte2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Byte2ShortRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Byte2ShortRBTreeMap.Submap.this.bottom) && (Byte2ShortRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Byte2ShortRBTreeMap.Submap.this.top) && (Byte2ShortRBTreeMap.this.compare(k, (this.prev = Byte2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Byte2ShortRBTreeMap.this.locateKey(k);
/* 1534 */             if (Byte2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Byte2ShortRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ShortRBTreeMap.this.compare(this.prev.key, Byte2ShortRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Byte2ShortRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2ShortRBTreeMap.this.compare(this.next.key, Byte2ShortRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public ByteBidirectionalIterator iterator() { return new Byte2ShortRBTreeMap.Submap.SubmapKeyIterator(Byte2ShortRBTreeMap.Submap.this); } 
/* 1367 */       public ByteBidirectionalIterator iterator(byte from) { return new Byte2ShortRBTreeMap.Submap.SubmapKeyIterator(Byte2ShortRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2ShortRBTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public ByteBidirectionalIterator iterator() { return new Byte2ShortRBTreeMap.KeyIterator(Byte2ShortRBTreeMap.this); } 
/* 1201 */     public ByteBidirectionalIterator iterator(byte from) { return new Byte2ShortRBTreeMap.KeyIterator(Byte2ShortRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2ShortRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2ShortRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Byte2ShortMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Byte2ShortMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Byte2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Byte2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Byte2ShortRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(byte k) {
/* 1067 */       if ((this.next = Byte2ShortRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Byte2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Byte2ShortRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */     implements Cloneable, Byte2ShortMap.Entry
/*      */   {
...
/*      */ 
/*  979 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
