...
/*  730 */   public Byte2ObjectSortedMap<V> tailMap(byte from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Byte2ObjectSortedMap<V> headMap(byte to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Byte2ObjectSortedMap<V> subMap(byte from, byte to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Byte2ObjectLinkedOpenHashMap.ValueIterator(Byte2ObjectLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Byte2ObjectLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Byte2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Byte2ObjectLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1190 */       c = (Byte2ObjectLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Byte2ObjectLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Byte2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Byte2ObjectLinkedOpenHashMap.KeyIterator(Byte2ObjectLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ByteListIterator iterator() {
/*  999 */       return new Byte2ObjectLinkedOpenHashMap.KeyIterator(Byte2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Byte2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(byte k) {
/* 1005 */       return Byte2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(byte k) {
/* 1008 */       int oldSize = Byte2ObjectLinkedOpenHashMap.this.size;
/* 1009 */       Byte2ObjectLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Byte2ObjectLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Byte2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public byte firstByte() {
/* 1016 */       if (Byte2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Byte2ObjectLinkedOpenHashMap.this.key[Byte2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public byte lastByte() {
/* 1020 */       if (Byte2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Byte2ObjectLinkedOpenHashMap.this.key[Byte2ObjectLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2ObjectLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator(byte k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public byte previousByte() { return Byte2ObjectLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  987 */     public Byte previous() { return Byte.valueOf(Byte2ObjectLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/*  991 */     public byte nextByte() { return Byte2ObjectLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Byte next() { return Byte.valueOf(Byte2ObjectLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Byte2ObjectLinkedOpenHashMap.EntryIterator(Byte2ObjectLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Byte2ObjectMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> fromElement, Byte2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Byte2ObjectMap.Entry<V> first() {
/*  918 */       if (Byte2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Byte2ObjectLinkedOpenHashMap.MapEntry(Byte2ObjectLinkedOpenHashMap.this, Byte2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Byte2ObjectMap.Entry<V> last() {
/*  922 */       if (Byte2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Byte2ObjectLinkedOpenHashMap.MapEntry(Byte2ObjectLinkedOpenHashMap.this, Byte2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  931 */       int pos = HashCommon.murmurHash3(k) & Byte2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Byte2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Byte2ObjectLinkedOpenHashMap.this.key[pos] == k) return Byte2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Byte2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  935 */         pos = pos + 1 & Byte2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  945 */       int pos = HashCommon.murmurHash3(k) & Byte2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Byte2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Byte2ObjectLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Byte2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Byte2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Byte2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Byte2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from) {
/*  963 */       return new Byte2ObjectLinkedOpenHashMap.EntryIterator(Byte2ObjectLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> fastIterator() {
/*  966 */       return new Byte2ObjectLinkedOpenHashMap.FastEntryIterator(Byte2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> fastIterator(Byte2ObjectMap.Entry<V> from) {
/*  969 */       return new Byte2ObjectLinkedOpenHashMap.FastEntryIterator(Byte2ObjectLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Byte2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Byte2ObjectMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractByte2ObjectMap.BasicEntry<V> entry = new AbstractByte2ObjectMap.BasicEntry((byte)0, null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Byte2ObjectLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Byte2ObjectLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractByte2ObjectMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Byte2ObjectLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Byte2ObjectLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Byte2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Byte2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Byte2ObjectMap.Entry<V>>
/*      */   {
...
/*  875 */       return this.entry = new Byte2ObjectLinkedOpenHashMap.MapEntry(Byte2ObjectLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Byte2ObjectLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Byte2ObjectLinkedOpenHashMap.MapEntry(Byte2ObjectLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Byte2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Byte2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Byte2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Byte2ObjectLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(byte from) {
/*  753 */       if (Byte2ObjectLinkedOpenHashMap.this.key[Byte2ObjectLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Byte2ObjectLinkedOpenHashMap.this.last;
/*  755 */         this.index = Byte2ObjectLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = HashCommon.murmurHash3(from) & Byte2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Byte2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Byte2ObjectLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Byte2ObjectLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Byte2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Byte2ObjectLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Byte2ObjectLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Byte2ObjectLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Byte2ObjectLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Byte2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Byte2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Byte2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Byte2ObjectLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Byte2ObjectLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Byte2ObjectLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Byte2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Byte2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Byte2ObjectLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Byte2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Byte2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Byte2ObjectLinkedOpenHashMap.this.mask;
/*  841 */         while (Byte2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = HashCommon.murmurHash3(Byte2ObjectLinkedOpenHashMap.this.key[pos]) & Byte2ObjectLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Byte2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Byte2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Byte2ObjectLinkedOpenHashMap.this.key[last] = Byte2ObjectLinkedOpenHashMap.this.key[pos];
/*  848 */         Byte2ObjectLinkedOpenHashMap.this.value[last] = Byte2ObjectLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Byte2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Byte2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Byte2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Byte getKey() {
/*  619 */       return Byte.valueOf(Byte2ObjectLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public byte getByteKey() {
/*  622 */       return Byte2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Byte2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Byte2ObjectLinkedOpenHashMap.this.value[this.index];
/*  629 */       Byte2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Byte2ObjectLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Byte2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return Byte2ObjectLinkedOpenHashMap.this.key[this.index] ^ (Byte2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Byte2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     public String toString() {
/*  642 */       return Byte2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
