...
/*      */ 
/*      */ public class Byte2ByteRBTreeMap extends AbstractByte2ByteSortedMap
...
/*  119 */           return Byte2ByteRBTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  122 */           return Byte2ByteRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     byte oldValue = put(ok.byteValue(), ov.byteValue());
/*  731 */     return this.modified ? null : Byte.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Byte remove(Object ok)
/*      */   {
/*  737 */     byte oldValue = remove(((Byte)ok).byteValue());
...
/* 1141 */         final Comparator<? super Byte2ByteMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Byte2ByteMap.Entry x, Byte2ByteMap.Entry y) {
/* 1143 */             return Byte2ByteRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Byte2ByteRBTreeMap.EntryIterator(Byte2ByteRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from) {
/* 1153 */           return new Byte2ByteRBTreeMap.EntryIterator(Byte2ByteRBTreeMap.this, ((Byte)from.getKey()).byteValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1166 */           Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1167 */           if (f != null) Byte2ByteRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Byte2ByteRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Byte2ByteRBTreeMap.this.clear(); } 
/* 1172 */         public Byte2ByteMap.Entry first() { return Byte2ByteRBTreeMap.this.firstEntry; } 
/* 1173 */         public Byte2ByteMap.Entry last() { return Byte2ByteRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry from, Byte2ByteMap.Entry to) { return Byte2ByteRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ByteEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry to) { return Byte2ByteRBTreeMap.this.headMap((Byte)to.getKey()).byte2ByteEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from) { return Byte2ByteRBTreeMap.this.tailMap((Byte)from.getKey()).byte2ByteEntrySet(); }
/*      */       };
...
/* 1242 */           return new Byte2ByteRBTreeMap.ValueIterator(Byte2ByteRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(byte k) {
/* 1245 */           return Byte2ByteRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Byte2ByteRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Byte2ByteRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Byte2ByteRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readByte(), s.readByte());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readByte(), s.readByte());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readByte(), s.readByte()));
...
/*      */ 
/*      */ 
/*      */   private final class Submap extends AbstractByte2ByteSortedMap
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Byte2ByteRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Byte2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1323 */       return ((this.bottom) || (Byte2ByteRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Byte2ByteRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
/* 1327 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator() {
/* 1329 */             return new Byte2ByteRBTreeMap.Submap.SubmapEntryIterator(Byte2ByteRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from) {
/* 1332 */             return new Byte2ByteRBTreeMap.Submap.SubmapEntryIterator(Byte2ByteRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
/*      */           }
/* 1334 */           public Comparator<? super Byte2ByteMap.Entry> comparator() { return Byte2ByteRBTreeMap.this.byte2ByteEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1340 */             return (f != null) && (Byte2ByteRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Byte2ByteRBTreeMap.Entry f = Byte2ByteRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1347 */             if ((f != null) && (Byte2ByteRBTreeMap.Submap.this.in(f.key))) Byte2ByteRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Byte2ByteRBTreeMap.Submap.SubmapIterator(Byte2ByteRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Byte2ByteRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Byte2ByteMap.Entry first() { return Byte2ByteRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Byte2ByteMap.Entry last() { return Byte2ByteRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry from, Byte2ByteMap.Entry to) { return Byte2ByteRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ByteEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry to) { return Byte2ByteRBTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2ByteEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from) { return Byte2ByteRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ByteEntrySet(); }
/*      */         };
...
/*      */           public ByteIterator iterator() {
/* 1376 */             return new Byte2ByteRBTreeMap.Submap.SubmapValueIterator(Byte2ByteRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(byte k) {
/* 1379 */             return Byte2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Byte2ByteRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Byte2ByteRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(byte k) {
/* 1392 */       return (in(k)) && (Byte2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(byte v) {
...
/* 1407 */       return (in(kk)) && ((e = Byte2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public byte put(byte k, byte v) {
/* 1410 */       Byte2ByteRBTreeMap.this.modified = false;
...
/* 1412 */       byte oldValue = Byte2ByteRBTreeMap.this.put(k, v);
/* 1413 */       return Byte2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Byte put(Byte ok, Byte ov) {
/* 1416 */       byte oldValue = put(ok.byteValue(), ov.byteValue());
/* 1417 */       return Byte2ByteRBTreeMap.this.modified ? null : Byte.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public byte remove(byte k) {
/* 1421 */       Byte2ByteRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       byte oldValue = Byte2ByteRBTreeMap.this.remove(k);
/* 1424 */       return Byte2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Byte remove(Object ok) {
/* 1427 */       byte oldValue = remove(((Byte)ok).byteValue());
/* 1428 */       return Byte2ByteRBTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1443 */       return Byte2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Byte2ByteSortedMap headMap(byte to) {
/* 1446 */       if (this.top) return new Submap(Byte2ByteRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Byte2ByteRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2ByteRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Byte2ByteSortedMap tailMap(byte from) {
/* 1450 */       if (this.bottom) return new Submap(Byte2ByteRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Byte2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ByteRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Byte2ByteSortedMap subMap(byte from, byte to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Byte2ByteRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Byte2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Byte2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Byte2ByteRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Byte2ByteRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Byte2ByteRBTreeMap.this.tree == null) return null;
/* 1468 */       Byte2ByteRBTreeMap.Entry e;
/*      */       Byte2ByteRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Byte2ByteRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Byte2ByteRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Byte2ByteRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Byte2ByteRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Byte2ByteRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Byte2ByteRBTreeMap.this.tree == null) return null;
/* 1486 */       Byte2ByteRBTreeMap.Entry e;
/*      */       Byte2ByteRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Byte2ByteRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Byte2ByteRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Byte2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Byte2ByteRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public byte firstByteKey() {
/* 1497 */       Byte2ByteRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public byte lastByteKey() {
/* 1502 */       Byte2ByteRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Byte firstKey() {
/* 1507 */       Byte2ByteRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Byte lastKey() {
/* 1512 */       Byte2ByteRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Byte2ByteRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Byte2ByteRBTreeMap.Submap.SubmapIterator
/*      */       implements ByteListIterator
/*      */     {
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Byte2ByteRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Byte2ByteMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Byte2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Byte2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Byte2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Byte2ByteRBTreeMap.Submap.this.bottom) && (Byte2ByteRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Byte2ByteRBTreeMap.Submap.this.top) && (Byte2ByteRBTreeMap.this.compare(k, (this.prev = Byte2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Byte2ByteRBTreeMap.this.locateKey(k);
/* 1534 */             if (Byte2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Byte2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ByteRBTreeMap.this.compare(this.prev.key, Byte2ByteRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Byte2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2ByteRBTreeMap.this.compare(this.next.key, Byte2ByteRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public ByteBidirectionalIterator iterator() { return new Byte2ByteRBTreeMap.Submap.SubmapKeyIterator(Byte2ByteRBTreeMap.Submap.this); } 
/* 1367 */       public ByteBidirectionalIterator iterator(byte from) { return new Byte2ByteRBTreeMap.Submap.SubmapKeyIterator(Byte2ByteRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2ByteRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public ByteBidirectionalIterator iterator() { return new Byte2ByteRBTreeMap.KeyIterator(Byte2ByteRBTreeMap.this); } 
/* 1201 */     public ByteBidirectionalIterator iterator(byte from) { return new Byte2ByteRBTreeMap.KeyIterator(Byte2ByteRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2ByteRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2ByteRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Byte2ByteMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Byte2ByteMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Byte2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Byte2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Byte2ByteRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(byte k) {
/* 1067 */       if ((this.next = Byte2ByteRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Byte2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Byte2ByteRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
