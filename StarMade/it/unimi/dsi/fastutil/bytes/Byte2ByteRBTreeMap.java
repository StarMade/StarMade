  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2ByteRBTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2ByteRBTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2ByteRBTreeMap(Map<? extends Byte, ? extends Byte> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ByteRBTreeMap(SortedMap<Byte, Byte> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ByteRBTreeMap(Byte2ByteMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2ByteRBTreeMap(Byte2ByteSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2ByteRBTreeMap(byte[] local_k, byte[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2ByteRBTreeMap(byte[] local_k, byte[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Byte2ByteMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Byte2ByteRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2ByteRBTreeMap.EntryIterator(Byte2ByteRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from)
        {
          return new Byte2ByteRBTreeMap.EntryIterator(Byte2ByteRBTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2ByteRBTreeMap.Entry local_f = Byte2ByteRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2ByteRBTreeMap.Entry local_f = Byte2ByteRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2ByteRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Byte2ByteRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ByteEntrySet();
        }
        
        public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry local_to)
        {
          return Byte2ByteRBTreeMap.this.headMap((Byte)local_to.getKey()).byte2ByteEntrySet();
        }
        
        public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from)
        {
          return Byte2ByteRBTreeMap.this.tailMap((Byte)from.getKey()).byte2ByteEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Byte2ByteRBTreeMap.ValueIterator(Byte2ByteRBTreeMap.this, null);
        }
        
        public boolean contains(byte local_k)
        {
          return Byte2ByteRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2ByteRBTreeMap local_c;
    try
    {
      local_c = (Byte2ByteRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2ByteRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2ByteRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2ByteRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2ByteMap.Entry> byte2ByteEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator()
          {
            return new Byte2ByteRBTreeMap.Submap.SubmapEntryIterator(Byte2ByteRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2ByteMap.Entry> iterator(Byte2ByteMap.Entry from)
          {
            return new Byte2ByteRBTreeMap.Submap.SubmapEntryIterator(Byte2ByteRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Byte> local_e = (Map.Entry)local_o;
            Byte2ByteRBTreeMap.Entry local_f = Byte2ByteRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2ByteRBTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Byte> local_e = (Map.Entry)local_o;
            Byte2ByteRBTreeMap.Entry local_f = Byte2ByteRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2ByteRBTreeMap.Submap.this.in3(local_f.key))) {
              Byte2ByteRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2ByteRBTreeMap.Submap.SubmapIterator(Byte2ByteRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2ByteRBTreeMap.Submap.this.clear();
          }
          
          public Byte2ByteMap.Entry first()
          {
            return Byte2ByteRBTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2ByteMap.Entry last()
          {
            return Byte2ByteRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2ByteMap.Entry> subSet(Byte2ByteMap.Entry from, Byte2ByteMap.Entry local_to)
          {
            return Byte2ByteRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2ByteEntrySet();
          }
          
          public ObjectSortedSet<Byte2ByteMap.Entry> headSet(Byte2ByteMap.Entry local_to)
          {
            return Byte2ByteRBTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2ByteEntrySet();
          }
          
          public ObjectSortedSet<Byte2ByteMap.Entry> tailSet(Byte2ByteMap.Entry from)
          {
            return Byte2ByteRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ByteEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ByteCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractByteCollection()
        {
          public ByteIterator iterator()
          {
            return new Byte2ByteRBTreeMap.Submap.SubmapValueIterator(Byte2ByteRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(byte local_k)
          {
            return Byte2ByteRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2ByteRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2ByteRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2ByteRBTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2ByteRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public byte put(byte local_k, byte local_v)
    {
      ...
      byte oldValue = Byte2ByteRBTreeMap.this.put(local_k, local_v);
    ...
    public byte remove(byte local_k)
    {
      ...
      byte oldValue = Byte2ByteRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2ByteRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2ByteRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2ByteSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2ByteRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ByteRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2ByteSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2ByteRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2ByteRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2ByteRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2ByteRBTreeMap.this.locateKey(this.from);
        if (Byte2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2ByteRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2ByteRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2ByteRBTreeMap.this.locateKey(this.field_47);
        if (Byte2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2ByteRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2ByteRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2ByteRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2ByteRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2ByteRBTreeMap.Submap.this.bottom) && (Byte2ByteRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2ByteRBTreeMap.Submap.this.top) && (Byte2ByteRBTreeMap.this.compare(local_k, (this.prev = Byte2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2ByteRBTreeMap.this.locateKey(local_k);
            if (Byte2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ByteRBTreeMap.this.compare(this.prev.key, Byte2ByteRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2ByteRBTreeMap.this.compare(this.next.key, Byte2ByteRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2ByteSortedMap.KeySet
    {
      ...
      {
        return new Byte2ByteRBTreeMap.Submap.SubmapKeyIterator(Byte2ByteRBTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2ByteRBTreeMap.Submap.SubmapKeyIterator(Byte2ByteRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2ByteSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2ByteRBTreeMap.KeyIterator(Byte2ByteRBTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2ByteRBTreeMap.KeyIterator(Byte2ByteRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2ByteRBTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
