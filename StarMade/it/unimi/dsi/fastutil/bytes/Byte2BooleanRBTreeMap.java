  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2BooleanRBTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2BooleanRBTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2BooleanRBTreeMap(Map<? extends Byte, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2BooleanRBTreeMap(SortedMap<Byte, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2BooleanRBTreeMap(Byte2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2BooleanRBTreeMap(Byte2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2BooleanRBTreeMap(byte[] local_k, boolean[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2BooleanRBTreeMap(byte[] local_k, boolean[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Byte2BooleanMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Byte2BooleanRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2BooleanRBTreeMap.EntryIterator(Byte2BooleanRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from)
        {
          return new Byte2BooleanRBTreeMap.EntryIterator(Byte2BooleanRBTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2BooleanRBTreeMap.Entry local_f = Byte2BooleanRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2BooleanRBTreeMap.Entry local_f = Byte2BooleanRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2BooleanRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Byte2BooleanRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry local_to)
        {
          return Byte2BooleanRBTreeMap.this.headMap((Byte)local_to.getKey()).byte2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from)
        {
          return Byte2BooleanRBTreeMap.this.tailMap((Byte)from.getKey()).byte2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Byte2BooleanRBTreeMap.ValueIterator(Byte2BooleanRBTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Byte2BooleanRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2BooleanRBTreeMap local_c;
    try
    {
      local_c = (Byte2BooleanRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2BooleanRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2BooleanRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2BooleanRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator()
          {
            return new Byte2BooleanRBTreeMap.Submap.SubmapEntryIterator(Byte2BooleanRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from)
          {
            return new Byte2BooleanRBTreeMap.Submap.SubmapEntryIterator(Byte2BooleanRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Boolean> local_e = (Map.Entry)local_o;
            Byte2BooleanRBTreeMap.Entry local_f = Byte2BooleanRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2BooleanRBTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Boolean> local_e = (Map.Entry)local_o;
            Byte2BooleanRBTreeMap.Entry local_f = Byte2BooleanRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2BooleanRBTreeMap.Submap.this.in3(local_f.key))) {
              Byte2BooleanRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2BooleanRBTreeMap.Submap.SubmapIterator(Byte2BooleanRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2BooleanRBTreeMap.Submap.this.clear();
          }
          
          public Byte2BooleanMap.Entry first()
          {
            return Byte2BooleanRBTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2BooleanMap.Entry last()
          {
            return Byte2BooleanRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry local_to)
          {
            return Byte2BooleanRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry local_to)
          {
            return Byte2BooleanRBTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from)
          {
            return Byte2BooleanRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Byte2BooleanRBTreeMap.Submap.SubmapValueIterator(Byte2BooleanRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Byte2BooleanRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2BooleanRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2BooleanRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2BooleanRBTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2BooleanRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(byte local_k, boolean local_v)
    {
      ...
      boolean oldValue = Byte2BooleanRBTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(byte local_k)
    {
      ...
      boolean oldValue = Byte2BooleanRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2BooleanRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2BooleanRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2BooleanRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2BooleanSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2BooleanRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2BooleanRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2BooleanSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2BooleanRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2BooleanRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2BooleanRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2BooleanRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2BooleanRBTreeMap.this.locateKey(this.from);
        if (Byte2BooleanRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2BooleanRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2BooleanRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2BooleanRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2BooleanRBTreeMap.this.locateKey(this.field_47);
        if (Byte2BooleanRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2BooleanRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2BooleanRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2BooleanRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2BooleanRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2BooleanRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2BooleanRBTreeMap.Submap.this.bottom) && (Byte2BooleanRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2BooleanRBTreeMap.Submap.this.top) && (Byte2BooleanRBTreeMap.this.compare(local_k, (this.prev = Byte2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2BooleanRBTreeMap.this.locateKey(local_k);
            if (Byte2BooleanRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2BooleanRBTreeMap.this.compare(this.prev.key, Byte2BooleanRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2BooleanRBTreeMap.this.compare(this.next.key, Byte2BooleanRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Byte2BooleanRBTreeMap.Submap.SubmapKeyIterator(Byte2BooleanRBTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2BooleanRBTreeMap.Submap.SubmapKeyIterator(Byte2BooleanRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2BooleanSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2BooleanRBTreeMap.KeyIterator(Byte2BooleanRBTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2BooleanRBTreeMap.KeyIterator(Byte2BooleanRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2BooleanRBTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2BooleanRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
