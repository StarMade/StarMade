...
/*      */ 
/*      */ public class Byte2BooleanRBTreeMap extends AbstractByte2BooleanSortedMap
...
/*  119 */           return Byte2BooleanRBTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  122 */           return Byte2BooleanRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     boolean oldValue = put(ok.byteValue(), ov.booleanValue());
/*  731 */     return this.modified ? null : Boolean.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Boolean remove(Object ok)
/*      */   {
/*  737 */     boolean oldValue = remove(((Byte)ok).byteValue());
...
/* 1141 */         final Comparator<? super Byte2BooleanMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Byte2BooleanMap.Entry x, Byte2BooleanMap.Entry y) {
/* 1143 */             return Byte2BooleanRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Byte2BooleanRBTreeMap.EntryIterator(Byte2BooleanRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from) {
/* 1153 */           return new Byte2BooleanRBTreeMap.EntryIterator(Byte2BooleanRBTreeMap.this, ((Byte)from.getKey()).byteValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1166 */           Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1167 */           if (f != null) Byte2BooleanRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Byte2BooleanRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Byte2BooleanRBTreeMap.this.clear(); } 
/* 1172 */         public Byte2BooleanMap.Entry first() { return Byte2BooleanRBTreeMap.this.firstEntry; } 
/* 1173 */         public Byte2BooleanMap.Entry last() { return Byte2BooleanRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry to) { return Byte2BooleanRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2BooleanEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry to) { return Byte2BooleanRBTreeMap.this.headMap((Byte)to.getKey()).byte2BooleanEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from) { return Byte2BooleanRBTreeMap.this.tailMap((Byte)from.getKey()).byte2BooleanEntrySet(); }
/*      */       };
...
/* 1242 */           return new Byte2BooleanRBTreeMap.ValueIterator(Byte2BooleanRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(boolean k) {
/* 1245 */           return Byte2BooleanRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Byte2BooleanRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
...
/*      */     try
/*      */     {
/* 1611 */       c = (Byte2BooleanRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readByte(), s.readBoolean());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readByte(), s.readBoolean());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readByte(), s.readBoolean()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Byte2BooleanRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Byte2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1323 */       return ((this.bottom) || (Byte2BooleanRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Byte2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Byte2BooleanMap.Entry> byte2BooleanEntrySet() {
/* 1327 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator() {
/* 1329 */             return new Byte2BooleanRBTreeMap.Submap.SubmapEntryIterator(Byte2BooleanRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Byte2BooleanMap.Entry> iterator(Byte2BooleanMap.Entry from) {
/* 1332 */             return new Byte2BooleanRBTreeMap.Submap.SubmapEntryIterator(Byte2BooleanRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
/*      */           }
/* 1334 */           public Comparator<? super Byte2BooleanMap.Entry> comparator() { return Byte2BooleanRBTreeMap.this.byte2BooleanEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1340 */             return (f != null) && (Byte2BooleanRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Byte2BooleanRBTreeMap.Entry f = Byte2BooleanRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1347 */             if ((f != null) && (Byte2BooleanRBTreeMap.Submap.this.in(f.key))) Byte2BooleanRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Byte2BooleanRBTreeMap.Submap.SubmapIterator(Byte2BooleanRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Byte2BooleanRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Byte2BooleanMap.Entry first() { return Byte2BooleanRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Byte2BooleanMap.Entry last() { return Byte2BooleanRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Byte2BooleanMap.Entry> subSet(Byte2BooleanMap.Entry from, Byte2BooleanMap.Entry to) { return Byte2BooleanRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2BooleanEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Byte2BooleanMap.Entry> headSet(Byte2BooleanMap.Entry to) { return Byte2BooleanRBTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2BooleanEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Byte2BooleanMap.Entry> tailSet(Byte2BooleanMap.Entry from) { return Byte2BooleanRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2BooleanEntrySet(); }
/*      */         };
...
/*      */           public BooleanIterator iterator() {
/* 1376 */             return new Byte2BooleanRBTreeMap.Submap.SubmapValueIterator(Byte2BooleanRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(boolean k) {
/* 1379 */             return Byte2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Byte2BooleanRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Byte2BooleanRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(byte k) {
/* 1392 */       return (in(k)) && (Byte2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(boolean v) {
...
/* 1407 */       return (in(kk)) && ((e = Byte2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public boolean put(byte k, boolean v) {
/* 1410 */       Byte2BooleanRBTreeMap.this.modified = false;
...
/* 1412 */       boolean oldValue = Byte2BooleanRBTreeMap.this.put(k, v);
/* 1413 */       return Byte2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Boolean put(Byte ok, Boolean ov) {
/* 1416 */       boolean oldValue = put(ok.byteValue(), ov.booleanValue());
/* 1417 */       return Byte2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public boolean remove(byte k) {
/* 1421 */       Byte2BooleanRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       boolean oldValue = Byte2BooleanRBTreeMap.this.remove(k);
/* 1424 */       return Byte2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Boolean remove(Object ok) {
/* 1427 */       boolean oldValue = remove(((Byte)ok).byteValue());
/* 1428 */       return Byte2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1443 */       return Byte2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Byte2BooleanSortedMap headMap(byte to) {
/* 1446 */       if (this.top) return new Submap(Byte2BooleanRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Byte2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2BooleanRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Byte2BooleanSortedMap tailMap(byte from) {
/* 1450 */       if (this.bottom) return new Submap(Byte2BooleanRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Byte2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2BooleanRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Byte2BooleanSortedMap subMap(byte from, byte to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Byte2BooleanRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Byte2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Byte2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Byte2BooleanRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Byte2BooleanRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Byte2BooleanRBTreeMap.this.tree == null) return null;
/* 1468 */       Byte2BooleanRBTreeMap.Entry e;
/*      */       Byte2BooleanRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Byte2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Byte2BooleanRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Byte2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Byte2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Byte2BooleanRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Byte2BooleanRBTreeMap.this.tree == null) return null;
/* 1486 */       Byte2BooleanRBTreeMap.Entry e;
/*      */       Byte2BooleanRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Byte2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Byte2BooleanRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Byte2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Byte2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public byte firstByteKey() {
/* 1497 */       Byte2BooleanRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public byte lastByteKey() {
/* 1502 */       Byte2BooleanRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Byte firstKey() {
/* 1507 */       Byte2BooleanRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Byte lastKey() {
/* 1512 */       Byte2BooleanRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Byte2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Byte2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Byte2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Byte2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Byte2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Byte2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Byte2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Byte2BooleanRBTreeMap.Submap.this.bottom) && (Byte2BooleanRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Byte2BooleanRBTreeMap.Submap.this.top) && (Byte2BooleanRBTreeMap.this.compare(k, (this.prev = Byte2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Byte2BooleanRBTreeMap.this.locateKey(k);
/* 1534 */             if (Byte2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Byte2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2BooleanRBTreeMap.this.compare(this.prev.key, Byte2BooleanRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Byte2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2BooleanRBTreeMap.this.compare(this.next.key, Byte2BooleanRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public ByteBidirectionalIterator iterator() { return new Byte2BooleanRBTreeMap.Submap.SubmapKeyIterator(Byte2BooleanRBTreeMap.Submap.this); } 
/* 1367 */       public ByteBidirectionalIterator iterator(byte from) { return new Byte2BooleanRBTreeMap.Submap.SubmapKeyIterator(Byte2BooleanRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2BooleanRBTreeMap.TreeIterator
/*      */     implements BooleanListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public ByteBidirectionalIterator iterator() { return new Byte2BooleanRBTreeMap.KeyIterator(Byte2BooleanRBTreeMap.this); } 
/* 1201 */     public ByteBidirectionalIterator iterator(byte from) { return new Byte2BooleanRBTreeMap.KeyIterator(Byte2BooleanRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2BooleanRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2BooleanRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Byte2BooleanMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Byte2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Byte2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Byte2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Byte2BooleanRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(byte k) {
/* 1067 */       if ((this.next = Byte2BooleanRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Byte2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Byte2BooleanRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
