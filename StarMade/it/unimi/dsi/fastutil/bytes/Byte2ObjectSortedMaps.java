...
public class Byte2ObjectSortedMaps
{
  ...
  public static <V> Byte2ObjectSortedMap<V> synchronize(Byte2ObjectSortedMap<V> local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static <V> Byte2ObjectSortedMap<V> synchronize(Byte2ObjectSortedMap<V> local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static <V> Byte2ObjectSortedMap<V> unmodifiable(Byte2ObjectSortedMap<V> local_m)
  {
    ...
    implements Byte2ObjectSortedMap<V>, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Byte2ObjectSortedMap<V> local_m)
    {
      super();
    ...
    implements Byte2ObjectSortedMap<V>, Serializable
  {
    ...
    protected SynchronizedSortedMap(Byte2ObjectSortedMap<V> local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Byte2ObjectSortedMap<V> local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Byte2ObjectSortedMap<V>, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Byte2ObjectMaps.Singleton.SingletonEntry(this), Byte2ObjectSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
