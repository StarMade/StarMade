...
/*     */     }
/* 302 */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.byte2ObjectEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Byte, V>> entrySet() {
/* 304 */       return byte2ObjectEntrySet(); } 
...
/* 308 */     public Byte2ObjectSortedMap<V> headMap(byte to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Byte2ObjectSortedMap<V> tailMap(byte from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Byte2ObjectSortedMap<V> headMap(Byte to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Byte2ObjectSortedMap<V> tailMap(Byte from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.byte2ObjectEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Byte, V>> entrySet() {
/* 244 */       return byte2ObjectEntrySet(); } 
...
/* 248 */     public Byte2ObjectSortedMap<V> headMap(byte to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Byte2ObjectSortedMap<V> tailMap(byte from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public byte firstByteKey() {
...
/* 259 */     public Byte2ObjectSortedMap<V> headMap(Byte to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Byte2ObjectSortedMap<V> tailMap(Byte from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Byte2ObjectMaps.Singleton.SingletonEntry(this), Byte2ObjectSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Byte, V>> entrySet() { return byte2ObjectEntrySet(); } 
/*     */     public ByteSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = ByteSortedSets.singleton(this.key, this.comparator); return (ByteSortedSet)this.keys;
/*     */     }
/*     */     public Byte2ObjectSortedMap<V> subMap(byte from, byte to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Byte2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Byte2ObjectSortedMap<V> headMap(byte to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Byte2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Byte2ObjectSortedMap<V> tailMap(byte from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Byte2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Byte2ObjectSortedMap<V> tailMap(Byte ofrom) { return tailMap(ofrom.byteValue()); } 
/* 156 */     public Byte2ObjectSortedMap<V> subMap(Byte ofrom, Byte oto) { return subMap(ofrom.byteValue(), oto.byteValue()); } 
/*     */     public Byte firstKey() {
...
/*  77 */       return null;
/*     */     }
/*  79 */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Byte, V>> entrySet() {
/*  81 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  83 */     public ByteSortedSet keySet() { return ByteSortedSets.EMPTY_SET; } 
/*     */     public Byte2ObjectSortedMap<V> subMap(byte from, byte to) {
/*  85 */       return Byte2ObjectSortedMaps.EMPTY_MAP;
/*     */     }
/*  87 */     public Byte2ObjectSortedMap<V> headMap(byte to) { return Byte2ObjectSortedMaps.EMPTY_MAP; } 
/*     */     public Byte2ObjectSortedMap<V> tailMap(byte from) {
/*  89 */       return Byte2ObjectSortedMaps.EMPTY_MAP; } 
/*  90 */     public byte firstByteKey() { throw new NoSuchElementException(); } 
/*  91 */     public byte lastByteKey() { throw new NoSuchElementException(); } 
/*  92 */     public Byte2ObjectSortedMap<V> headMap(Byte oto) { return headMap(oto.byteValue()); } 
/*  93 */     public Byte2ObjectSortedMap<V> tailMap(Byte ofrom) { return tailMap(ofrom.byteValue()); } 
/*  94 */     public Byte2ObjectSortedMap<V> subMap(Byte ofrom, Byte oto) { return subMap(ofrom.byteValue(), oto.byteValue()); } 
