...
public class Byte2DoubleMaps
{
  ...
  public static Byte2DoubleMap synchronize(Byte2DoubleMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Byte2DoubleMap synchronize(Byte2DoubleMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Byte2DoubleMap unmodifiable(Byte2DoubleMap local_m)
  {
    ...
    implements Byte2DoubleMap, Serializable
  {
    ...
    protected UnmodifiableMap(Byte2DoubleMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Byte2DoubleMap, Serializable
  {
    ...
    protected SynchronizedMap(Byte2DoubleMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Byte2DoubleMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Byte2DoubleMap, Serializable, Cloneable
  {
      ...
      implements Byte2DoubleMap.Entry, Map.Entry<Byte, Double>
    {
      ...
      public Byte getKey()
      {
        return Byte.valueOf(Byte2DoubleMaps.Singleton.this.key);
      }
      
      public Double getValue()
      {
        return Double.valueOf(Byte2DoubleMaps.Singleton.this.value);
      }
      
      public byte getByteKey()
      {
        return Byte2DoubleMaps.Singleton.this.key;
      }
      
      public double getDoubleValue()
      {
        return Byte2DoubleMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Byte2DoubleMaps.Singleton.this.key == ((Byte)local_e.getKey()).byteValue()) && (Byte2DoubleMaps.Singleton.this.value == ((Double)local_e.getValue()).doubleValue());
      }
      
      public int hashCode()
      {
        return Byte2DoubleMaps.Singleton.this.key ^ HashCommon.double2int(Byte2DoubleMaps.Singleton.this.value);
      }
      
      public String toString()
      {
        return Byte2DoubleMaps.Singleton.this.key + "->" + Byte2DoubleMaps.Singleton.this.value;
      }
    }
  }
