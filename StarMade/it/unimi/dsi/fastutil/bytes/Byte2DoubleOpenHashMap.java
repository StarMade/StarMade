  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2DoubleOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2DoubleOpenHashMap(Map<? extends Byte, ? extends Double> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2DoubleOpenHashMap(Map<? extends Byte, ? extends Double> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2DoubleOpenHashMap(Byte2DoubleMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2DoubleOpenHashMap(Byte2DoubleMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2DoubleOpenHashMap(byte[] local_k, double[] local_v, float local_f)
  {
  ...
  public Byte2DoubleOpenHashMap(byte[] local_k, double[] local_v)
  {
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Byte2DoubleOpenHashMap.ValueIterator(Byte2DoubleOpenHashMap.this);
        }
        ...
        {
          return Byte2DoubleOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2DoubleOpenHashMap local_c;
    try
    {
      local_c = (Byte2DoubleOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2DoubleOpenHashMap.MapIterator
    implements DoubleIterator
  {
    ...
    public Double next()
    {
      return Double.valueOf(Byte2DoubleOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2DoubleOpenHashMap.KeyIterator(Byte2DoubleOpenHashMap.this);
    }
    ...
    {
      return Byte2DoubleOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2DoubleOpenHashMap.this.size;
      Byte2DoubleOpenHashMap.this.remove(local_k);
    ...
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2DoubleOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2DoubleMap.FastEntrySet
  {
    ...
    {
      return new Byte2DoubleOpenHashMap.EntryIterator(Byte2DoubleOpenHashMap.this, null);
    }
    
    public ObjectIterator<Byte2DoubleMap.Entry> fastIterator()
    {
      return new Byte2DoubleOpenHashMap.FastEntryIterator(Byte2DoubleOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2DoubleOpenHashMap.this.mask; Byte2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2DoubleOpenHashMap.this.mask) {
        if (Byte2DoubleOpenHashMap.this.key[pos] == local_k) {
          return Byte2DoubleOpenHashMap.this.value[pos] == ((Double)local_e.getValue()).doubleValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2DoubleOpenHashMap.this.mask; Byte2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2DoubleOpenHashMap.this.mask) {
        if (Byte2DoubleOpenHashMap.this.key[pos] == local_k)
        {
          Byte2DoubleOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2DoubleMap.Entry>
  {
    ...
    public AbstractByte2DoubleMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2DoubleOpenHashMap.this.key[local_e];
      this.entry.value = Byte2DoubleOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2DoubleMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2DoubleOpenHashMap.MapEntry(Byte2DoubleOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2DoubleOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2DoubleOpenHashMap.this.field_49;
    int last = -1;
    int field_1880 = Byte2DoubleOpenHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2DoubleOpenHashMap.this.used;
      while ((this.field_1880 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1880 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1880 != 0)
      {
        boolean[] local_k = Byte2DoubleOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2DoubleOpenHashMap.this.mask; Byte2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2DoubleOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2DoubleOpenHashMap.this.key[pos]) & Byte2DoubleOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2DoubleOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2DoubleOpenHashMap.this.key[pos]);
        }
        Byte2DoubleOpenHashMap.this.key[last] = Byte2DoubleOpenHashMap.this.key[pos];
        Byte2DoubleOpenHashMap.this.value[last] = Byte2DoubleOpenHashMap.this.value[pos];
      }
      Byte2DoubleOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2DoubleOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2DoubleOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1880 > 0))
      {
        this.field_1880 += 1;
        nextEntry();
      }
    ...
    implements Byte2DoubleMap.Entry, Map.Entry<Byte, Double>
  {
    ...
    public double setValue(double local_v)
    {
      ...
      Byte2DoubleOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Double> local_e = (Map.Entry)local_o;
      return (Byte2DoubleOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2DoubleOpenHashMap.this.value[this.index] == ((Double)local_e.getValue()).doubleValue());
    }
