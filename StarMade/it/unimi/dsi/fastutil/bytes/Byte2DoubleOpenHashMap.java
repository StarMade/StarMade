...
/*     */ 
/*     */ public class Byte2DoubleOpenHashMap extends AbstractByte2DoubleMap
...
/* 642 */           return new Byte2DoubleOpenHashMap.ValueIterator(Byte2DoubleOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Byte2DoubleOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(double v) {
/* 648 */           return Byte2DoubleOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Byte2DoubleOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Byte2DoubleOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Byte2DoubleOpenHashMap.MapIterator
/*     */     implements DoubleIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public double nextDouble() { return Byte2DoubleOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Double next() { return Double.valueOf(Byte2DoubleOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Byte2DoubleOpenHashMap.KeyIterator(Byte2DoubleOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Byte2DoubleOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(byte k) {
/* 613 */       return Byte2DoubleOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(byte k) {
/* 616 */       int oldSize = Byte2DoubleOpenHashMap.this.size;
/* 617 */       Byte2DoubleOpenHashMap.this.remove(k);
/* 618 */       return Byte2DoubleOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Byte2DoubleOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Byte2DoubleOpenHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public byte nextByte() { return Byte2DoubleOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Byte next() { return Byte.valueOf(Byte2DoubleOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Byte2DoubleOpenHashMap.EntryIterator(Byte2DoubleOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Byte2DoubleMap.Entry> fastIterator() {
/* 550 */       return new Byte2DoubleOpenHashMap.FastEntryIterator(Byte2DoubleOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Byte2DoubleOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Byte2DoubleOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Byte2DoubleOpenHashMap.this.key[pos] == k) return Byte2DoubleOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/* 562 */         pos = pos + 1 & Byte2DoubleOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Byte2DoubleOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Byte2DoubleOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Byte2DoubleOpenHashMap.this.key[pos] == k) {
/* 576 */           Byte2DoubleOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Byte2DoubleOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Byte2DoubleOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Byte2DoubleOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Byte2DoubleOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2DoubleMap.Entry>
/*     */   {
/* 537 */     final AbstractByte2DoubleMap.BasicEntry entry = new AbstractByte2DoubleMap.BasicEntry((byte)0, 0.0D);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Byte2DoubleOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Byte2DoubleOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Byte2DoubleOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2DoubleMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Byte2DoubleOpenHashMap.MapEntry(Byte2DoubleOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Byte2DoubleOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Byte2DoubleOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Byte2DoubleOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Byte2DoubleOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Byte2DoubleOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Byte2DoubleOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Byte2DoubleOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Byte2DoubleOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Byte2DoubleOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Byte2DoubleOpenHashMap.this.mask;
/* 485 */         while (Byte2DoubleOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Byte2DoubleOpenHashMap.this.key[pos]) & Byte2DoubleOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Byte2DoubleOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Byte2DoubleOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 494 */           this.wrapped.add(Byte2DoubleOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Byte2DoubleOpenHashMap.this.key[last] = Byte2DoubleOpenHashMap.this.key[pos];
/* 497 */         Byte2DoubleOpenHashMap.this.value[last] = Byte2DoubleOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Byte2DoubleOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Byte2DoubleOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Byte2DoubleOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Byte getKey() {
/* 398 */       return Byte.valueOf(Byte2DoubleOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public byte getByteKey() {
/* 401 */       return Byte2DoubleOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Double getValue() {
/* 404 */       return Double.valueOf(Byte2DoubleOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public double getDoubleValue() {
/* 407 */       return Byte2DoubleOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public double setValue(double v) {
/* 410 */       double oldValue = Byte2DoubleOpenHashMap.this.value[this.index];
/* 411 */       Byte2DoubleOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Double setValue(Double v) {
...
/* 421 */       return (Byte2DoubleOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2DoubleOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Byte2DoubleOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Byte2DoubleOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 427 */       return Byte2DoubleOpenHashMap.this.key[this.index] + "=>" + Byte2DoubleOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
