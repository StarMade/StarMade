  ...
  implements ByteIndirectPriorityQueue
{
  ...
  public ByteArrayIndirectPriorityQueue(byte[] refArray, int capacity, ByteComparator local_c)
  {
    if (capacity > 0) {
  ...
  public ByteArrayIndirectPriorityQueue(byte[] refArray, ByteComparator local_c)
  {
  ...
  public ByteArrayIndirectPriorityQueue(byte[] refArray, int[] local_a, int size, ByteComparator local_c)
  {
  ...
  public ByteArrayIndirectPriorityQueue(byte[] refArray, int[] local_a, ByteComparator local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public ByteArrayIndirectPriorityQueue(byte[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public ByteArrayIndirectPriorityQueue(byte[] refArray, int[] local_a)
  {
  ...
  {
    byte top = this.refArray[this.array[findFirst()]];
    int local_i = this.size;
    int local_c = 0;
    while (local_i-- != 0) {
