  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2DoubleRBTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2DoubleRBTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2DoubleRBTreeMap(Map<? extends Byte, ? extends Double> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2DoubleRBTreeMap(SortedMap<Byte, Double> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2DoubleRBTreeMap(Byte2DoubleMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2DoubleRBTreeMap(Byte2DoubleSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2DoubleRBTreeMap(byte[] local_k, double[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2DoubleRBTreeMap(byte[] local_k, double[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Byte2DoubleMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Byte2DoubleRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2DoubleRBTreeMap.EntryIterator(Byte2DoubleRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry from)
        {
          return new Byte2DoubleRBTreeMap.EntryIterator(Byte2DoubleRBTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2DoubleRBTreeMap.Entry local_f = Byte2DoubleRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2DoubleRBTreeMap.Entry local_f = Byte2DoubleRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2DoubleRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Byte2DoubleRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry local_to)
        {
          return Byte2DoubleRBTreeMap.this.headMap((Byte)local_to.getKey()).byte2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry from)
        {
          return Byte2DoubleRBTreeMap.this.tailMap((Byte)from.getKey()).byte2DoubleEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Byte2DoubleRBTreeMap.ValueIterator(Byte2DoubleRBTreeMap.this, null);
        }
        
        public boolean contains(double local_k)
        {
          return Byte2DoubleRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2DoubleRBTreeMap local_c;
    try
    {
      local_c = (Byte2DoubleRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2DoubleRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2DoubleRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2DoubleRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator()
          {
            return new Byte2DoubleRBTreeMap.Submap.SubmapEntryIterator(Byte2DoubleRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry from)
          {
            return new Byte2DoubleRBTreeMap.Submap.SubmapEntryIterator(Byte2DoubleRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Double> local_e = (Map.Entry)local_o;
            Byte2DoubleRBTreeMap.Entry local_f = Byte2DoubleRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2DoubleRBTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Double> local_e = (Map.Entry)local_o;
            Byte2DoubleRBTreeMap.Entry local_f = Byte2DoubleRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2DoubleRBTreeMap.Submap.this.in3(local_f.key))) {
              Byte2DoubleRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2DoubleRBTreeMap.Submap.SubmapIterator(Byte2DoubleRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2DoubleRBTreeMap.Submap.this.clear();
          }
          
          public Byte2DoubleMap.Entry first()
          {
            return Byte2DoubleRBTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2DoubleMap.Entry last()
          {
            return Byte2DoubleRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry from, Byte2DoubleMap.Entry local_to)
          {
            return Byte2DoubleRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry local_to)
          {
            return Byte2DoubleRBTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry from)
          {
            return Byte2DoubleRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2DoubleEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public DoubleCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractDoubleCollection()
        {
          public DoubleIterator iterator()
          {
            return new Byte2DoubleRBTreeMap.Submap.SubmapValueIterator(Byte2DoubleRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(double local_k)
          {
            return Byte2DoubleRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2DoubleRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2DoubleRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2DoubleRBTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2DoubleRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public double put(byte local_k, double local_v)
    {
      ...
      double oldValue = Byte2DoubleRBTreeMap.this.put(local_k, local_v);
    ...
    public double remove(byte local_k)
    {
      ...
      double oldValue = Byte2DoubleRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2DoubleRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2DoubleRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2DoubleRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2DoubleSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2DoubleRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2DoubleRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2DoubleSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2DoubleRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2DoubleRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2DoubleRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2DoubleRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2DoubleRBTreeMap.this.locateKey(this.from);
        if (Byte2DoubleRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2DoubleRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2DoubleRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2DoubleRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2DoubleRBTreeMap.this.locateKey(this.field_47);
        if (Byte2DoubleRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2DoubleRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2DoubleRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2DoubleRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2DoubleRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2DoubleRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2DoubleRBTreeMap.Submap.this.bottom) && (Byte2DoubleRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2DoubleRBTreeMap.Submap.this.top) && (Byte2DoubleRBTreeMap.this.compare(local_k, (this.prev = Byte2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2DoubleRBTreeMap.this.locateKey(local_k);
            if (Byte2DoubleRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2DoubleRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2DoubleRBTreeMap.this.compare(this.prev.key, Byte2DoubleRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2DoubleRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2DoubleRBTreeMap.this.compare(this.next.key, Byte2DoubleRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2DoubleSortedMap.KeySet
    {
      ...
      {
        return new Byte2DoubleRBTreeMap.Submap.SubmapKeyIterator(Byte2DoubleRBTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2DoubleRBTreeMap.Submap.SubmapKeyIterator(Byte2DoubleRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2DoubleSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2DoubleRBTreeMap.KeyIterator(Byte2DoubleRBTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2DoubleRBTreeMap.KeyIterator(Byte2DoubleRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2DoubleRBTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2DoubleRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
