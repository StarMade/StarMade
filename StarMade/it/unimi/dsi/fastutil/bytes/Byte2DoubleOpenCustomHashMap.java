...
/*     */   protected int size;
/*     */   protected volatile transient Byte2DoubleMap.FastEntrySet entries;
...
/* 662 */           return new Byte2DoubleOpenCustomHashMap.ValueIterator(Byte2DoubleOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 665 */           return Byte2DoubleOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(double v) {
/* 668 */           return Byte2DoubleOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 671 */           Byte2DoubleOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 786 */       c = (Byte2DoubleOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Byte2DoubleOpenCustomHashMap.MapIterator
/*     */     implements DoubleIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 655 */       super(null); } 
/* 656 */     public double nextDouble() { return Byte2DoubleOpenCustomHashMap.this.value[nextEntry()]; } 
/* 657 */     public Double next() { return Double.valueOf(Byte2DoubleOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 627 */       return new Byte2DoubleOpenCustomHashMap.KeyIterator(Byte2DoubleOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 630 */       return Byte2DoubleOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(byte k) {
/* 633 */       return Byte2DoubleOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(byte k) {
/* 636 */       int oldSize = Byte2DoubleOpenCustomHashMap.this.size;
/* 637 */       Byte2DoubleOpenCustomHashMap.this.remove(k);
/* 638 */       return Byte2DoubleOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 641 */       Byte2DoubleOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Byte2DoubleOpenCustomHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public byte nextByte() { return Byte2DoubleOpenCustomHashMap.this.key[nextEntry()]; } 
/* 623 */     public Byte next() { return Byte.valueOf(Byte2DoubleOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
/*     */   private final class MapEntrySet extends AbstractObjectSet<Byte2DoubleMap.Entry>
...
/*     */     {
/* 567 */       return new Byte2DoubleOpenCustomHashMap.EntryIterator(Byte2DoubleOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Byte2DoubleMap.Entry> fastIterator() {
/* 570 */       return new Byte2DoubleOpenCustomHashMap.FastEntryIterator(Byte2DoubleOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 578 */       int pos = HashCommon.murmurHash3(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask;
/*     */ 
/* 580 */       while (Byte2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 581 */         if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[pos], k)) return Byte2DoubleOpenCustomHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/* 582 */         pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask;
/*     */       }
/* 584 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 592 */       int pos = HashCommon.murmurHash3(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask;
/*     */ 
/* 594 */       while (Byte2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 595 */         if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[pos], k)) {
/* 596 */           Byte2DoubleOpenCustomHashMap.this.remove(e.getKey());
/* 597 */           return true;
/*     */         }
/* 599 */         pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask;
/*     */       }
/* 601 */       return false;
/*     */     }
/*     */     public int size() {
/* 604 */       return Byte2DoubleOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 607 */       Byte2DoubleOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Byte2DoubleOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2DoubleMap.Entry>
/*     */   {
/* 557 */     final AbstractByte2DoubleMap.BasicEntry entry = new AbstractByte2DoubleMap.BasicEntry((byte)0, 0.0D);
/*     */ 
...
/* 559 */       int e = nextEntry();
/* 560 */       this.entry.key = Byte2DoubleOpenCustomHashMap.this.key[e];
/* 561 */       this.entry.value = Byte2DoubleOpenCustomHashMap.this.value[e];
/* 562 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Byte2DoubleOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2DoubleMap.Entry>
/*     */   {
...
/* 548 */       return this.entry = new Byte2DoubleOpenCustomHashMap.MapEntry(Byte2DoubleOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 552 */       super.remove();
/* 553 */       Byte2DoubleOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 454 */       this.pos = Byte2DoubleOpenCustomHashMap.this.n;
/*     */ 
/* 457 */       this.last = -1;
/*     */ 
/* 459 */       this.c = Byte2DoubleOpenCustomHashMap.this.size;
/*     */ 
/* 464 */       boolean[] used = Byte2DoubleOpenCustomHashMap.this.used;
...
/*     */ 
/* 477 */         int pos = HashCommon.murmurHash3(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2DoubleOpenCustomHashMap.this.mask;
/*     */ 
/* 479 */         while (Byte2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 480 */           if (Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481 */           pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 484 */       this.last = this.pos;
/*     */ 
/* 486 */       if (this.c != 0) {
/* 487 */         boolean[] used = Byte2DoubleOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 504 */         pos = (last = pos) + 1 & Byte2DoubleOpenCustomHashMap.this.mask;
/* 505 */         while (Byte2DoubleOpenCustomHashMap.this.used[pos] != 0) {
/* 506 */           int slot = HashCommon.murmurHash3(Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(Byte2DoubleOpenCustomHashMap.this.key[pos])) & Byte2DoubleOpenCustomHashMap.this.mask;
/* 507 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508 */           pos = pos + 1 & Byte2DoubleOpenCustomHashMap.this.mask;
/*     */         }
/* 510 */         if (Byte2DoubleOpenCustomHashMap.this.used[pos] == 0) break;
/* 511 */         if (pos < last)
/*     */         {
/* 513 */           if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 514 */           this.wrapped.add(Byte2DoubleOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 516 */         Byte2DoubleOpenCustomHashMap.this.key[last] = Byte2DoubleOpenCustomHashMap.this.key[pos];
/* 517 */         Byte2DoubleOpenCustomHashMap.this.value[last] = Byte2DoubleOpenCustomHashMap.this.value[pos];
/*     */       }
/* 519 */       Byte2DoubleOpenCustomHashMap.this.used[last] = false;
/* 520 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 525 */       if (this.pos < -1)
/*     */       {
/* 527 */         Byte2DoubleOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 528 */         this.last = -1;
/* 529 */         return;
/*     */       }
/* 531 */       Byte2DoubleOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Byte getKey() {
/* 418 */       return Byte.valueOf(Byte2DoubleOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public byte getByteKey() {
/* 421 */       return Byte2DoubleOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Double getValue() {
/* 424 */       return Double.valueOf(Byte2DoubleOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public double getDoubleValue() {
/* 427 */       return Byte2DoubleOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public double setValue(double v) {
/* 430 */       double oldValue = Byte2DoubleOpenCustomHashMap.this.value[this.index];
/* 431 */       Byte2DoubleOpenCustomHashMap.this.value[this.index] = v;
/* 432 */       return oldValue;
/*     */     }
/*     */     public Double setValue(Double v) {
...
/* 441 */       return (Byte2DoubleOpenCustomHashMap.this.strategy.equals(Byte2DoubleOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue())) && (Byte2DoubleOpenCustomHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*     */     }
/*     */     public int hashCode() {
/* 444 */       return Byte2DoubleOpenCustomHashMap.this.strategy.hashCode(Byte2DoubleOpenCustomHashMap.this.key[this.index]) ^ HashCommon.double2int(Byte2DoubleOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 447 */       return Byte2DoubleOpenCustomHashMap.this.key[this.index] + "=>" + Byte2DoubleOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
