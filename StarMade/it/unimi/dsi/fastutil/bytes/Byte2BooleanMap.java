...
public abstract interface Byte2BooleanMap extends Byte2BooleanFunction, Map<Byte, Boolean>
{
  ...
  public static abstract interface Entry extends Map.Entry<Byte, Boolean>
  {
  ...
  public static abstract interface FastEntrySet extends ObjectSet<Byte2BooleanMap.Entry>
  {
