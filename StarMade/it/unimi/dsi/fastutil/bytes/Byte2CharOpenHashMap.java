  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2CharOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2CharOpenHashMap(Map<? extends Byte, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2CharOpenHashMap(Map<? extends Byte, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2CharOpenHashMap(Byte2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2CharOpenHashMap(Byte2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2CharOpenHashMap(byte[] local_k, char[] local_v, float local_f)
  {
  ...
  public Byte2CharOpenHashMap(byte[] local_k, char[] local_v)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Byte2CharOpenHashMap.ValueIterator(Byte2CharOpenHashMap.this);
        }
        ...
        {
          return Byte2CharOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2CharOpenHashMap local_c;
    try
    {
      local_c = (Byte2CharOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2CharOpenHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Byte2CharOpenHashMap.this.value[nextEntry()];
    }
    
    public Character next()
    {
      return Character.valueOf(Byte2CharOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2CharOpenHashMap.KeyIterator(Byte2CharOpenHashMap.this);
    }
    ...
    {
      return Byte2CharOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2CharOpenHashMap.this.size;
      Byte2CharOpenHashMap.this.remove(local_k);
    ...
    implements ByteIterator
  {
    ...
    {
      return Byte2CharOpenHashMap.this.key[nextEntry()];
    }
    
    public Byte next()
    {
      return Byte.valueOf(Byte2CharOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2CharMap.FastEntrySet
  {
    ...
    {
      return new Byte2CharOpenHashMap.EntryIterator(Byte2CharOpenHashMap.this, null);
    }
    
    public ObjectIterator<Byte2CharMap.Entry> fastIterator()
    {
      return new Byte2CharOpenHashMap.FastEntryIterator(Byte2CharOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2CharOpenHashMap.this.mask; Byte2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharOpenHashMap.this.mask) {
        if (Byte2CharOpenHashMap.this.key[pos] == local_k) {
          return Byte2CharOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2CharOpenHashMap.this.mask; Byte2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharOpenHashMap.this.mask) {
        if (Byte2CharOpenHashMap.this.key[pos] == local_k)
        {
          Byte2CharOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2CharMap.Entry>
  {
    ...
    public AbstractByte2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2CharOpenHashMap.this.key[local_e];
      this.entry.value = Byte2CharOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2CharOpenHashMap.MapEntry(Byte2CharOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2CharOpenHashMap.this.field_49;
    int last = -1;
    int field_1787 = Byte2CharOpenHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2CharOpenHashMap.this.used;
      while ((this.field_1787 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1787 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1787 != 0)
      {
        boolean[] local_k = Byte2CharOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2CharOpenHashMap.this.mask; Byte2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2CharOpenHashMap.this.key[pos]) & Byte2CharOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2CharOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2CharOpenHashMap.this.key[pos]);
        }
        Byte2CharOpenHashMap.this.key[last] = Byte2CharOpenHashMap.this.key[pos];
        Byte2CharOpenHashMap.this.value[last] = Byte2CharOpenHashMap.this.value[pos];
      }
      Byte2CharOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2CharOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2CharOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1787 > 0))
      {
        this.field_1787 += 1;
        nextEntry();
      }
    ...
    implements Byte2CharMap.Entry, Map.Entry<Byte, Character>
  {
    ...
    public Byte getKey()
    {
      return Byte.valueOf(Byte2CharOpenHashMap.this.key[this.index]);
    }
    ...
    public char setValue(char local_v)
    {
      ...
      Byte2CharOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Character> local_e = (Map.Entry)local_o;
      return (Byte2CharOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2CharOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
