  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2CharRBTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2CharRBTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2CharRBTreeMap(Map<? extends Byte, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2CharRBTreeMap(SortedMap<Byte, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2CharRBTreeMap(Byte2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2CharRBTreeMap(Byte2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2CharRBTreeMap(byte[] local_k, char[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2CharRBTreeMap(byte[] local_k, char[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Byte2CharMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Byte2CharRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2CharRBTreeMap.EntryIterator(Byte2CharRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from)
        {
          return new Byte2CharRBTreeMap.EntryIterator(Byte2CharRBTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2CharRBTreeMap.Entry local_f = Byte2CharRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2CharRBTreeMap.Entry local_f = Byte2CharRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2CharRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Byte2CharRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2CharEntrySet();
        }
        
        public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry local_to)
        {
          return Byte2CharRBTreeMap.this.headMap((Byte)local_to.getKey()).byte2CharEntrySet();
        }
        
        public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from)
        {
          return Byte2CharRBTreeMap.this.tailMap((Byte)from.getKey()).byte2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Byte2CharRBTreeMap.ValueIterator(Byte2CharRBTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Byte2CharRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2CharRBTreeMap local_c;
    try
    {
      local_c = (Byte2CharRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2CharRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2CharRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2CharRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator()
          {
            return new Byte2CharRBTreeMap.Submap.SubmapEntryIterator(Byte2CharRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from)
          {
            return new Byte2CharRBTreeMap.Submap.SubmapEntryIterator(Byte2CharRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Character> local_e = (Map.Entry)local_o;
            Byte2CharRBTreeMap.Entry local_f = Byte2CharRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2CharRBTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Character> local_e = (Map.Entry)local_o;
            Byte2CharRBTreeMap.Entry local_f = Byte2CharRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2CharRBTreeMap.Submap.this.in3(local_f.key))) {
              Byte2CharRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2CharRBTreeMap.Submap.SubmapIterator(Byte2CharRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2CharRBTreeMap.Submap.this.clear();
          }
          
          public Byte2CharMap.Entry first()
          {
            return Byte2CharRBTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2CharMap.Entry last()
          {
            return Byte2CharRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry local_to)
          {
            return Byte2CharRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2CharEntrySet();
          }
          
          public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry local_to)
          {
            return Byte2CharRBTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2CharEntrySet();
          }
          
          public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from)
          {
            return Byte2CharRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Byte2CharRBTreeMap.Submap.SubmapValueIterator(Byte2CharRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Byte2CharRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2CharRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2CharRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2CharRBTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2CharRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(byte local_k, char local_v)
    {
      ...
      char oldValue = Byte2CharRBTreeMap.this.put(local_k, local_v);
    ...
    public char remove(byte local_k)
    {
      ...
      char oldValue = Byte2CharRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2CharRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2CharRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2CharSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2CharRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2CharRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2CharRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2CharSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2CharRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2CharRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2CharRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2CharRBTreeMap.this.locateKey(this.from);
        if (Byte2CharRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2CharRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2CharRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2CharRBTreeMap.this.locateKey(this.field_47);
        if (Byte2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2CharRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2CharRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2CharRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2CharRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2CharRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2CharRBTreeMap.Submap.this.bottom) && (Byte2CharRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2CharRBTreeMap.Submap.this.top) && (Byte2CharRBTreeMap.this.compare(local_k, (this.prev = Byte2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2CharRBTreeMap.this.locateKey(local_k);
            if (Byte2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2CharRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2CharRBTreeMap.this.compare(this.prev.key, Byte2CharRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2CharRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2CharRBTreeMap.this.compare(this.next.key, Byte2CharRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2CharSortedMap.KeySet
    {
      ...
      {
        return new Byte2CharRBTreeMap.Submap.SubmapKeyIterator(Byte2CharRBTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2CharRBTreeMap.Submap.SubmapKeyIterator(Byte2CharRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2CharSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2CharRBTreeMap.KeyIterator(Byte2CharRBTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2CharRBTreeMap.KeyIterator(Byte2CharRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2CharRBTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
