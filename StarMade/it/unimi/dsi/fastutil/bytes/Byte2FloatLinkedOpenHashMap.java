...
/*      */   protected int size;
/*      */   protected volatile transient Byte2FloatSortedMap.FastSortedEntrySet entries;
...
/*  786 */   public Byte2FloatSortedMap tailMap(byte from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Byte2FloatSortedMap headMap(byte to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Byte2FloatSortedMap subMap(byte from, byte to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Byte2FloatLinkedOpenHashMap.ValueIterator(Byte2FloatLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Byte2FloatLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(float v) {
/* 1113 */           return Byte2FloatLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Byte2FloatLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Byte2FloatLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2FloatLinkedOpenHashMap.MapIterator
/*      */     implements FloatListIterator
/*      */   {
/*      */     public float previousFloat()
/*      */     {
/* 1094 */       return Byte2FloatLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Float previous() { return Float.valueOf(Byte2FloatLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public float nextFloat() { return Byte2FloatLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Float next() { return Float.valueOf(Byte2FloatLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Byte2FloatLinkedOpenHashMap.KeyIterator(Byte2FloatLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ByteListIterator iterator() {
/* 1054 */       return new Byte2FloatLinkedOpenHashMap.KeyIterator(Byte2FloatLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Byte2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(byte k) {
/* 1060 */       return Byte2FloatLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(byte k) {
/* 1063 */       int oldSize = Byte2FloatLinkedOpenHashMap.this.size;
/* 1064 */       Byte2FloatLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Byte2FloatLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Byte2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public byte firstByte() {
/* 1071 */       if (Byte2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Byte2FloatLinkedOpenHashMap.this.key[Byte2FloatLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public byte lastByte() {
/* 1075 */       if (Byte2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Byte2FloatLinkedOpenHashMap.this.key[Byte2FloatLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2FloatLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator(byte k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public byte previousByte() { return Byte2FloatLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Byte previous() { return Byte.valueOf(Byte2FloatLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public byte nextByte() { return Byte2FloatLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Byte next() { return Byte.valueOf(Byte2FloatLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Byte2FloatMap.Entry>
...
/*      */     {
/*  966 */       return new Byte2FloatLinkedOpenHashMap.EntryIterator(Byte2FloatLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Byte2FloatMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Byte2FloatMap.Entry> subSet(Byte2FloatMap.Entry fromElement, Byte2FloatMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Byte2FloatMap.Entry> headSet(Byte2FloatMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Byte2FloatMap.Entry> tailSet(Byte2FloatMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Byte2FloatMap.Entry first() {
/*  973 */       if (Byte2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Byte2FloatLinkedOpenHashMap.MapEntry(Byte2FloatLinkedOpenHashMap.this, Byte2FloatLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Byte2FloatMap.Entry last() {
/*  977 */       if (Byte2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Byte2FloatLinkedOpenHashMap.MapEntry(Byte2FloatLinkedOpenHashMap.this, Byte2FloatLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Byte2FloatLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Byte2FloatLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Byte2FloatLinkedOpenHashMap.this.key[pos] == k) return Byte2FloatLinkedOpenHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/*  990 */         pos = pos + 1 & Byte2FloatLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Byte2FloatLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Byte2FloatLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Byte2FloatLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Byte2FloatLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Byte2FloatLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Byte2FloatLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Byte2FloatLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2FloatMap.Entry> iterator(Byte2FloatMap.Entry from) {
/* 1018 */       return new Byte2FloatLinkedOpenHashMap.EntryIterator(Byte2FloatLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2FloatMap.Entry> fastIterator() {
/* 1021 */       return new Byte2FloatLinkedOpenHashMap.FastEntryIterator(Byte2FloatLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2FloatMap.Entry> fastIterator(Byte2FloatMap.Entry from) {
/* 1024 */       return new Byte2FloatLinkedOpenHashMap.FastEntryIterator(Byte2FloatLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Byte2FloatLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Byte2FloatMap.Entry>
/*      */   {
/*  944 */     final AbstractByte2FloatMap.BasicEntry entry = new AbstractByte2FloatMap.BasicEntry((byte)0, 0.0F);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Byte2FloatLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Byte2FloatLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractByte2FloatMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Byte2FloatLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Byte2FloatLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Byte2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Byte2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2FloatLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Byte2FloatMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Byte2FloatLinkedOpenHashMap.MapEntry(Byte2FloatLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Byte2FloatLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Byte2FloatLinkedOpenHashMap.MapEntry(Byte2FloatLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Byte2FloatLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Byte2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Byte2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Byte2FloatLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(byte from) {
/*  809 */       if (Byte2FloatLinkedOpenHashMap.this.key[Byte2FloatLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Byte2FloatLinkedOpenHashMap.this.last;
/*  811 */         this.index = Byte2FloatLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Byte2FloatLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Byte2FloatLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Byte2FloatLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Byte2FloatLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Byte2FloatLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Byte2FloatLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Byte2FloatLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Byte2FloatLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Byte2FloatLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Byte2FloatLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Byte2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Byte2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Byte2FloatLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Byte2FloatLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Byte2FloatLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Byte2FloatLinkedOpenHashMap.this.link[this.prev] ^= (Byte2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Byte2FloatLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Byte2FloatLinkedOpenHashMap.this.link[this.next] ^= (Byte2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Byte2FloatLinkedOpenHashMap.this.mask;
/*  897 */         while (Byte2FloatLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Byte2FloatLinkedOpenHashMap.this.key[pos]) & Byte2FloatLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Byte2FloatLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Byte2FloatLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Byte2FloatLinkedOpenHashMap.this.key[last] = Byte2FloatLinkedOpenHashMap.this.key[pos];
/*  904 */         Byte2FloatLinkedOpenHashMap.this.value[last] = Byte2FloatLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Byte2FloatLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Byte2FloatLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Byte getKey() {
/*  669 */       return Byte.valueOf(Byte2FloatLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public byte getByteKey() {
/*  672 */       return Byte2FloatLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Float getValue() {
/*  675 */       return Float.valueOf(Byte2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public float getFloatValue() {
/*  678 */       return Byte2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public float setValue(float v) {
/*  681 */       float oldValue = Byte2FloatLinkedOpenHashMap.this.value[this.index];
/*  682 */       Byte2FloatLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Float setValue(Float v) {
...
/*  692 */       return (Byte2FloatLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2FloatLinkedOpenHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Byte2FloatLinkedOpenHashMap.this.key[this.index] ^ HashCommon.float2int(Byte2FloatLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Byte2FloatLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2FloatLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
