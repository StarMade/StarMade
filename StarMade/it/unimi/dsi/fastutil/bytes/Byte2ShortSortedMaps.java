...
/*     */   {
/* 173 */     return new Singleton(key.byteValue(), value.shortValue());
/*     */   }
/*     */ 
/*     */   public static Byte2ShortSortedMap singleton(Byte key, Short value, ByteComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.byteValue(), value.shortValue(), comparator);
/*     */   }
/*     */ 
/*     */   public static Byte2ShortSortedMap singleton(byte key, short value)
/*     */   {
...
/*     */     }
/* 302 */     public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.byte2ShortEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Byte, Short>> entrySet() {
/* 304 */       return byte2ShortEntrySet(); } 
...
/* 308 */     public Byte2ShortSortedMap headMap(byte to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Byte2ShortSortedMap tailMap(byte from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Byte2ShortSortedMap headMap(Byte to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Byte2ShortSortedMap tailMap(Byte from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.byte2ShortEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Byte, Short>> entrySet() {
/* 244 */       return byte2ShortEntrySet(); } 
...
/* 248 */     public Byte2ShortSortedMap headMap(byte to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Byte2ShortSortedMap tailMap(byte from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public byte firstByteKey() {
...
/* 259 */     public Byte2ShortSortedMap headMap(Byte to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Byte2ShortSortedMap tailMap(Byte from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Byte2ShortMaps.Singleton.SingletonEntry(this), Byte2ShortSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Byte, Short>> entrySet() { return byte2ShortEntrySet(); } 
/*     */     public ByteSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = ByteSortedSets.singleton(this.key, this.comparator); return (ByteSortedSet)this.keys;
/*     */     }
/*     */     public Byte2ShortSortedMap subMap(byte from, byte to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Byte2ShortSortedMap headMap(byte to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Byte2ShortSortedMap tailMap(byte from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Byte2ShortSortedMap tailMap(Byte ofrom) { return tailMap(ofrom.byteValue()); } 
/* 156 */     public Byte2ShortSortedMap subMap(Byte ofrom, Byte oto) { return subMap(ofrom.byteValue(), oto.byteValue()); } 
/*     */     public Byte firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Byte2ShortMap.Entry> byte2ShortEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Byte, Short>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public ByteSortedSet keySet() { return ByteSortedSets.EMPTY_SET; } 
/*     */     public Byte2ShortSortedMap subMap(byte from, byte to) {
/*  86 */       return Byte2ShortSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Byte2ShortSortedMap headMap(byte to) { return Byte2ShortSortedMaps.EMPTY_MAP; } 
/*     */     public Byte2ShortSortedMap tailMap(byte from) {
/*  90 */       return Byte2ShortSortedMaps.EMPTY_MAP; } 
/*  91 */     public byte firstByteKey() { throw new NoSuchElementException(); } 
/*  92 */     public byte lastByteKey() { throw new NoSuchElementException(); } 
/*  93 */     public Byte2ShortSortedMap headMap(Byte oto) { return headMap(oto.byteValue()); } 
/*  94 */     public Byte2ShortSortedMap tailMap(Byte ofrom) { return tailMap(ofrom.byteValue()); } 
/*  95 */     public Byte2ShortSortedMap subMap(Byte ofrom, Byte oto) { return subMap(ofrom.byteValue(), oto.byteValue()); } 
