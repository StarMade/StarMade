  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2LongOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2LongOpenHashMap(Map<? extends Byte, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2LongOpenHashMap(Map<? extends Byte, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2LongOpenHashMap(Byte2LongMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2LongOpenHashMap(Byte2LongMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2LongOpenHashMap(byte[] local_k, long[] local_v, float local_f)
  {
  ...
  public Byte2LongOpenHashMap(byte[] local_k, long[] local_v)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Byte2LongOpenHashMap.ValueIterator(Byte2LongOpenHashMap.this);
        }
        ...
        {
          return Byte2LongOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2LongOpenHashMap local_c;
    try
    {
      local_c = (Byte2LongOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2LongOpenHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Byte2LongOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2LongOpenHashMap.KeyIterator(Byte2LongOpenHashMap.this);
    }
    ...
    {
      return Byte2LongOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2LongOpenHashMap.this.size;
      Byte2LongOpenHashMap.this.remove(local_k);
    ...
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2LongOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2LongMap.FastEntrySet
  {
    ...
    {
      return new Byte2LongOpenHashMap.EntryIterator(Byte2LongOpenHashMap.this, null);
    }
    
    public ObjectIterator<Byte2LongMap.Entry> fastIterator()
    {
      return new Byte2LongOpenHashMap.FastEntryIterator(Byte2LongOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2LongOpenHashMap.this.mask; Byte2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2LongOpenHashMap.this.mask) {
        if (Byte2LongOpenHashMap.this.key[pos] == local_k) {
          return Byte2LongOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2LongOpenHashMap.this.mask; Byte2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2LongOpenHashMap.this.mask) {
        if (Byte2LongOpenHashMap.this.key[pos] == local_k)
        {
          Byte2LongOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2LongMap.Entry>
  {
    ...
    public AbstractByte2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2LongOpenHashMap.this.key[local_e];
      this.entry.value = Byte2LongOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2LongOpenHashMap.MapEntry(Byte2LongOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2LongOpenHashMap.this.field_49;
    int last = -1;
    int field_480 = Byte2LongOpenHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2LongOpenHashMap.this.used;
      while ((this.field_480 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_480 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      if (this.field_480 != 0)
      {
        boolean[] local_k = Byte2LongOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2LongOpenHashMap.this.mask; Byte2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2LongOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2LongOpenHashMap.this.key[pos]) & Byte2LongOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2LongOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2LongOpenHashMap.this.key[pos]);
        }
        Byte2LongOpenHashMap.this.key[last] = Byte2LongOpenHashMap.this.key[pos];
        Byte2LongOpenHashMap.this.value[last] = Byte2LongOpenHashMap.this.value[pos];
      }
      Byte2LongOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2LongOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2LongOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_480 > 0))
      {
        this.field_480 += 1;
        nextEntry();
      }
    ...
    implements Byte2LongMap.Entry, Map.Entry<Byte, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Byte2LongOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Long> local_e = (Map.Entry)local_o;
      return (Byte2LongOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2LongOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
