...
/*     */ 
/*     */ public class Byte2LongOpenHashMap extends AbstractByte2LongMap
...
/* 642 */           return new Byte2LongOpenHashMap.ValueIterator(Byte2LongOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Byte2LongOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(long v) {
/* 648 */           return Byte2LongOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Byte2LongOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Byte2LongOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Byte2LongOpenHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public long nextLong() { return Byte2LongOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Long next() { return Long.valueOf(Byte2LongOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Byte2LongOpenHashMap.KeyIterator(Byte2LongOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Byte2LongOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(byte k) {
/* 613 */       return Byte2LongOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(byte k) {
/* 616 */       int oldSize = Byte2LongOpenHashMap.this.size;
/* 617 */       Byte2LongOpenHashMap.this.remove(k);
/* 618 */       return Byte2LongOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Byte2LongOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Byte2LongOpenHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public byte nextByte() { return Byte2LongOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Byte next() { return Byte.valueOf(Byte2LongOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Byte2LongOpenHashMap.EntryIterator(Byte2LongOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Byte2LongMap.Entry> fastIterator() {
/* 550 */       return new Byte2LongOpenHashMap.FastEntryIterator(Byte2LongOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Byte2LongOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Byte2LongOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Byte2LongOpenHashMap.this.key[pos] == k) return Byte2LongOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/* 562 */         pos = pos + 1 & Byte2LongOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Byte2LongOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Byte2LongOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Byte2LongOpenHashMap.this.key[pos] == k) {
/* 576 */           Byte2LongOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Byte2LongOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Byte2LongOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Byte2LongOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Byte2LongOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2LongMap.Entry>
/*     */   {
/* 537 */     final AbstractByte2LongMap.BasicEntry entry = new AbstractByte2LongMap.BasicEntry((byte)0, 0L);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Byte2LongOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Byte2LongOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Byte2LongOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2LongMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Byte2LongOpenHashMap.MapEntry(Byte2LongOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Byte2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Byte2LongOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Byte2LongOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Byte2LongOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Byte2LongOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Byte2LongOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Byte2LongOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Byte2LongOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Byte2LongOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Byte2LongOpenHashMap.this.mask;
/* 485 */         while (Byte2LongOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Byte2LongOpenHashMap.this.key[pos]) & Byte2LongOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Byte2LongOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Byte2LongOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 494 */           this.wrapped.add(Byte2LongOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Byte2LongOpenHashMap.this.key[last] = Byte2LongOpenHashMap.this.key[pos];
/* 497 */         Byte2LongOpenHashMap.this.value[last] = Byte2LongOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Byte2LongOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Byte2LongOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Byte2LongOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Byte getKey() {
/* 398 */       return Byte.valueOf(Byte2LongOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public byte getByteKey() {
/* 401 */       return Byte2LongOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Long getValue() {
/* 404 */       return Long.valueOf(Byte2LongOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public long getLongValue() {
/* 407 */       return Byte2LongOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public long setValue(long v) {
/* 410 */       long oldValue = Byte2LongOpenHashMap.this.value[this.index];
/* 411 */       Byte2LongOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Long setValue(Long v) {
...
/* 421 */       return (Byte2LongOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Byte2LongOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Byte2LongOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 427 */       return Byte2LongOpenHashMap.this.key[this.index] + "=>" + Byte2LongOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
