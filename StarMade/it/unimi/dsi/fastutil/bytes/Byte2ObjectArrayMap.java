...
/*  17:    */
/*  65:    */public class Byte2ObjectArrayMap<V>
/*  66:    */  extends AbstractByte2ObjectMap<V>
...
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Byte2ObjectArrayMap(byte[] key, Object[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Byte2ObjectArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = ByteArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = ObjectArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Byte2ObjectArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new byte[capacity];
/*  93: 93 */    this.value = new Object[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Byte2ObjectArrayMap(Byte2ObjectMap<V> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Byte2ObjectArrayMap(Map<? extends Byte, ? extends V> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Byte2ObjectArrayMap(byte[] key, Object[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Byte2ObjectMap.Entry<V>> implements Byte2ObjectMap.FastEntrySet<V> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Byte2ObjectMap.Entry<V>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Byte2ObjectArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Byte2ObjectMap.Entry<V> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractByte2ObjectMap.BasicEntry(Byte2ObjectArrayMap.this.key[this.next], Byte2ObjectArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Byte2ObjectMap.Entry<V>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractByte2ObjectMap.BasicEntry<V> entry = new AbstractByte2ObjectMap.BasicEntry((byte)0, null);
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Byte2ObjectArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Byte2ObjectMap.Entry<V> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Byte2ObjectArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Byte2ObjectArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Byte2ObjectArrayMap.this.size; }
/* 159:    */    
...
/* 165:165 */      return (Byte2ObjectArrayMap.this.containsKey(k)) && (Byte2ObjectArrayMap.this.get(k) == null ? e.getValue() == null : Byte2ObjectArrayMap.this.get(k).equals(e.getValue()));
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Byte2ObjectMap.FastEntrySet<V> byte2ObjectEntrySet() { return new EntrySet(null); }
/* 170:    */  
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Byte2ObjectArrayMap<V> clone()
/* 293:    */  {
/* 294:    */    Byte2ObjectArrayMap<V> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Byte2ObjectArrayMap)super.clone();
/* 301:    */    }
