...
/*     */     {
/*  92 */       while (n-- != 0) {
/*  93 */         Byte2ShortMap.Entry e = (Byte2ShortMap.Entry)i.next();
/*  94 */         put(e.getByteKey(), e.getShortValue());
/*     */       }
/*     */     }
/*     */     else
/*     */     {
...
/* 101 */         put((Byte)e.getKey(), (Short)e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 193 */         return AbstractByte2ShortMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractByte2ShortMap.this.size(); } 
/* 196 */       public void clear() { AbstractByte2ShortMap.this.clear(); }
/*     */ 
/*     */       public ByteIterator iterator() {
/* 199 */         return new AbstractByteIterator() {
/* 200 */           final ObjectIterator<Map.Entry<Byte, Short>> i = AbstractByte2ShortMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public byte nextByte() { return ((Byte2ShortMap.Entry)this.i.next()).getByteKey(); } 
...
/* 226 */         return AbstractByte2ShortMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractByte2ShortMap.this.size(); } 
/* 229 */       public void clear() { AbstractByte2ShortMap.this.clear(); }
/*     */ 
/*     */       public ShortIterator iterator() {
/* 232 */         return new AbstractShortIterator() {
/* 233 */           final ObjectIterator<Map.Entry<Byte, Short>> i = AbstractByte2ShortMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public short nextShort() { return ((Byte2ShortMap.Entry)this.i.next()).getShortValue(); } 
/*     */           public boolean hasNext() {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Byte2ShortMap.Entry e = (Byte2ShortMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
