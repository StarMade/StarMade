...
/*  14:    */
/*  62:    */public abstract class AbstractByte2ShortMap
/*  63:    */  extends AbstractByte2ShortFunction
/*  64:    */  implements Byte2ShortMap, Serializable
/*  65:    */{
...
/*  79:    */  }
/*  80:    */  
/*  86:    */  public void putAll(Map<? extends Byte, ? extends Short> m)
/*  87:    */  {
/*  88: 88 */    int n = m.size();
/*  89: 89 */    Iterator<? extends Map.Entry<? extends Byte, ? extends Short>> i = m.entrySet().iterator();
/*  90: 90 */    if ((m instanceof Byte2ShortMap))
/*  91:    */    {
/*  92: 92 */      while (n-- != 0) {
/*  93: 93 */        Byte2ShortMap.Entry e = (Byte2ShortMap.Entry)i.next();
/*  94: 94 */        put(e.getByteKey(), e.getShortValue());
/*  95:    */      }
/*  96:    */      
/*  97:    */    }
/*  98:    */    else
/*  99: 99 */      while (n-- != 0) {
/* 100:100 */        Map.Entry<? extends Byte, ? extends Short> e = (Map.Entry)i.next();
/* 101:101 */        put((Byte)e.getKey(), (Short)e.getValue());
/* 102:    */      }
/* 103:    */  }
/* 104:    */  
...
/* 111:    */    implements Byte2ShortMap.Entry
/* 112:    */  {
/* 113:    */    protected byte key;
/* 114:    */    protected short value;
/* 115:    */    
/* 116:    */    public BasicEntry(Byte key, Short value)
/* 117:    */    {
/* 118:118 */      this.key = key.byteValue();
/* 119:119 */      this.value = value.shortValue();
/* 120:    */    }
/* 121:    */    
/* 122:122 */    public BasicEntry(byte key, short value) { this.key = key;
...
/* 162:    */      
/* 163:163 */      return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Short)e.getValue()).shortValue());
/* 164:    */    }
/* 165:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(byte k) { return AbstractByte2ShortMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractByte2ShortMap.this.size(); }
/* 196:196 */      public void clear() { AbstractByte2ShortMap.this.clear(); }
/* 197:    */      
/* 198:    */      public ByteIterator iterator() {
/* 199:199 */        new AbstractByteIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<Byte, Short>> i = AbstractByte2ShortMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public byte nextByte() { return ((Byte2ShortMap.Entry)this.i.next()).getByteKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(short k) { return AbstractByte2ShortMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractByte2ShortMap.this.size(); }
/* 229:229 */      public void clear() { AbstractByte2ShortMap.this.clear(); }
/* 230:    */      
/* 231:    */      public ShortIterator iterator() {
/* 232:232 */        new AbstractShortIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<Byte, Short>> i = AbstractByte2ShortMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public short nextShort() { return ((Byte2ShortMap.Entry)this.i.next()).getShortValue(); }
/* 236:    */          
...
/* 241:    */  }
/* 242:    */  
/* 244:    */  public ObjectSet<Map.Entry<Byte, Short>> entrySet()
/* 245:    */  {
/* 246:246 */    return byte2ShortEntrySet();
/* 247:    */  }
/* 248:    */  
/* 257:    */  public int hashCode()
/* 258:    */  {
/* 259:259 */    int h = 0;int n = size();
/* 260:260 */    ObjectIterator<? extends Map.Entry<Byte, Short>> i = entrySet().iterator();
/* 261:    */    
...
/* 278:278 */    ObjectIterator<? extends Map.Entry<Byte, Short>> i = entrySet().iterator();
/* 279:279 */    int n = size();
/* 280:    */    
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Byte2ShortMap.Entry e = (Byte2ShortMap.Entry)i.next();
/* 290:    */      
