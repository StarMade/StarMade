  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2CharOpenCustomHashMap(int expected, float local_f, ByteHash.Strategy strategy)
  {
  ...
  public Byte2CharOpenCustomHashMap(Map<? extends Byte, ? extends Character> local_m, float local_f, ByteHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Byte2CharOpenCustomHashMap(Map<? extends Byte, ? extends Character> local_m, ByteHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Byte2CharOpenCustomHashMap(Byte2CharMap local_m, float local_f, ByteHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Byte2CharOpenCustomHashMap(Byte2CharMap local_m, ByteHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Byte2CharOpenCustomHashMap(byte[] local_k, char[] local_v, float local_f, ByteHash.Strategy strategy)
  {
  ...
  public Byte2CharOpenCustomHashMap(byte[] local_k, char[] local_v, ByteHash.Strategy strategy)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Byte2CharOpenCustomHashMap.ValueIterator(Byte2CharOpenCustomHashMap.this);
        }
        ...
        {
          return Byte2CharOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2CharOpenCustomHashMap local_c;
    try
    {
      local_c = (Byte2CharOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2CharOpenCustomHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Byte2CharOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2CharOpenCustomHashMap.KeyIterator(Byte2CharOpenCustomHashMap.this);
    }
    ...
    {
      return Byte2CharOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2CharOpenCustomHashMap.this.size;
      Byte2CharOpenCustomHashMap.this.remove(local_k);
    ...
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2CharOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2CharMap.FastEntrySet
  {
    ...
    {
      return new Byte2CharOpenCustomHashMap.EntryIterator(Byte2CharOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Byte2CharMap.Entry> fastIterator()
    {
      return new Byte2CharOpenCustomHashMap.FastEntryIterator(Byte2CharOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Byte2CharOpenCustomHashMap.this.strategy.hashCode(local_k)) & Byte2CharOpenCustomHashMap.this.mask; Byte2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharOpenCustomHashMap.this.mask) {
        if (Byte2CharOpenCustomHashMap.this.strategy.equals(Byte2CharOpenCustomHashMap.this.key[pos], local_k)) {
          return Byte2CharOpenCustomHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Byte2CharOpenCustomHashMap.this.strategy.hashCode(local_k)) & Byte2CharOpenCustomHashMap.this.mask; Byte2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharOpenCustomHashMap.this.mask) {
        if (Byte2CharOpenCustomHashMap.this.strategy.equals(Byte2CharOpenCustomHashMap.this.key[pos], local_k))
        {
          Byte2CharOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2CharMap.Entry>
  {
    ...
    public AbstractByte2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2CharOpenCustomHashMap.this.key[local_e];
      this.entry.value = Byte2CharOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2CharOpenCustomHashMap.MapEntry(Byte2CharOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2CharOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2224 = Byte2CharOpenCustomHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2CharOpenCustomHashMap.this.used;
      while ((this.field_2224 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2224 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2224 != 0)
      {
        boolean[] local_k = Byte2CharOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2CharOpenCustomHashMap.this.mask; Byte2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2CharOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2CharOpenCustomHashMap.this.strategy.hashCode(Byte2CharOpenCustomHashMap.this.key[pos])) & Byte2CharOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2CharOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2CharOpenCustomHashMap.this.key[pos]);
        }
        Byte2CharOpenCustomHashMap.this.key[last] = Byte2CharOpenCustomHashMap.this.key[pos];
        Byte2CharOpenCustomHashMap.this.value[last] = Byte2CharOpenCustomHashMap.this.value[pos];
      }
      Byte2CharOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2CharOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2CharOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2224 > 0))
      {
        this.field_2224 += 1;
        nextEntry();
      }
    ...
    implements Byte2CharMap.Entry, Map.Entry<Byte, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Byte2CharOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Character> local_e = (Map.Entry)local_o;
      return (Byte2CharOpenCustomHashMap.this.strategy.equals(Byte2CharOpenCustomHashMap.this.key[this.index], ((Byte)local_e.getKey()).byteValue())) && (Byte2CharOpenCustomHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
