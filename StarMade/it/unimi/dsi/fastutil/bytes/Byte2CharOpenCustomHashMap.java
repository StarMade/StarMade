...
/*  18:    */
/*  90:    */public class Byte2CharOpenCustomHashMap
/*  91:    */  extends AbstractByte2CharMap
...
/* 104:    */  protected volatile transient Byte2CharMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Byte2CharOpenCustomHashMap(int expected, float f, ByteHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Byte2CharOpenCustomHashMap(int expected, ByteHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Byte2CharOpenCustomHashMap(ByteHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Byte2CharOpenCustomHashMap(Map<? extends Byte, ? extends Character> m, float f, ByteHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Byte2CharOpenCustomHashMap(Map<? extends Byte, ? extends Character> m, ByteHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Byte2CharOpenCustomHashMap(Byte2CharMap m, float f, ByteHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Byte2CharOpenCustomHashMap(Byte2CharMap m, ByteHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Byte2CharOpenCustomHashMap(byte[] k, char[] v, float f, ByteHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Byte2CharOpenCustomHashMap(byte[] k, char[] v, ByteHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public char put(byte k, char v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Character put(Byte ok, Character ov) { char v = ov.charValue();
...
/* 302:    */  }
/* 303:    */  
/* 304:304 */  public Character get(Byte ok) { byte k = ok.byteValue();
/* 305:    */    
...
/* 379:    */    implements Byte2CharMap.Entry, Map.Entry<Byte, Character>
/* 380:    */  {
...
/* 386:    */    }
/* 387:    */    
/* 388:388 */    public Byte getKey() { return Byte.valueOf(Byte2CharOpenCustomHashMap.this.key[this.index]); }
/* 389:    */    
/* 390:    */    public byte getByteKey() {
/* 391:391 */      return Byte2CharOpenCustomHashMap.this.key[this.index];
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public Character getValue() { return Character.valueOf(Byte2CharOpenCustomHashMap.this.value[this.index]); }
/* 395:    */    
/* 397:397 */    public char getCharValue() { return Byte2CharOpenCustomHashMap.this.value[this.index]; }
/* 398:    */    
/* 399:    */    public char setValue(char v) {
/* 400:400 */      char oldValue = Byte2CharOpenCustomHashMap.this.value[this.index];
/* 401:401 */      Byte2CharOpenCustomHashMap.this.value[this.index] = v;
...
/* 410:410 */      Map.Entry<Byte, Character> e = (Map.Entry)o;
/* 411:411 */      return (Byte2CharOpenCustomHashMap.this.strategy.equals(Byte2CharOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue())) && (Byte2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 412:    */    }
/* 413:    */    
/* 414:414 */    public int hashCode() { return Byte2CharOpenCustomHashMap.this.strategy.hashCode(Byte2CharOpenCustomHashMap.this.key[this.index]) ^ Byte2CharOpenCustomHashMap.this.value[this.index]; }
/* 415:    */    
/* 417:417 */    public String toString() { return Byte2CharOpenCustomHashMap.this.key[this.index] + "=>" + Byte2CharOpenCustomHashMap.this.value[this.index]; } }
/* 418:    */  
...
/* 423:    */    
/* 424:424 */    private MapIterator() { this.pos = Byte2CharOpenCustomHashMap.this.n;
/* 425:    */      
/* 427:427 */      this.last = -1;
/* 428:    */      
/* 429:429 */      this.c = Byte2CharOpenCustomHashMap.this.size;
/* 430:    */      
/* 434:434 */      boolean[] used = Byte2CharOpenCustomHashMap.this.used;
...
/* 446:    */        
/* 447:447 */        int pos = HashCommon.murmurHash3(Byte2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2CharOpenCustomHashMap.this.mask;
/* 448:    */        
/* 449:449 */        while (Byte2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 450:450 */          if (Byte2CharOpenCustomHashMap.this.strategy.equals(Byte2CharOpenCustomHashMap.this.key[pos], k)) return pos;
/* 451:451 */          pos = pos + 1 & Byte2CharOpenCustomHashMap.this.mask;
/* 452:    */        }
/* 453:    */      }
/* 454:454 */      this.last = this.pos;
/* 455:    */      
/* 456:456 */      if (this.c != 0) {
/* 457:457 */        boolean[] used = Byte2CharOpenCustomHashMap.this.used;
...
/* 472:    */      for (;;)
/* 473:    */      {
/* 474:474 */        pos = (last = pos) + 1 & Byte2CharOpenCustomHashMap.this.mask;
/* 475:475 */        while (Byte2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 476:476 */          int slot = HashCommon.murmurHash3(Byte2CharOpenCustomHashMap.this.strategy.hashCode(Byte2CharOpenCustomHashMap.this.key[pos])) & Byte2CharOpenCustomHashMap.this.mask;
/* 477:477 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 478:478 */          pos = pos + 1 & Byte2CharOpenCustomHashMap.this.mask;
/* 479:    */        }
/* 480:480 */        if (Byte2CharOpenCustomHashMap.this.used[pos] == 0) break;
/* 481:481 */        if (pos < last)
/* 482:    */        {
/* 483:483 */          if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 484:484 */          this.wrapped.add(Byte2CharOpenCustomHashMap.this.key[pos]);
/* 485:    */        }
/* 486:486 */        Byte2CharOpenCustomHashMap.this.key[last] = Byte2CharOpenCustomHashMap.this.key[pos];
/* 487:487 */        Byte2CharOpenCustomHashMap.this.value[last] = Byte2CharOpenCustomHashMap.this.value[pos];
/* 488:    */      }
/* 489:489 */      Byte2CharOpenCustomHashMap.this.used[last] = false;
/* 490:490 */      return last;
/* 491:    */    }
/* 492:    */    
...
/* 496:    */      {
/* 497:497 */        Byte2CharOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 498:498 */        this.last = -1;
/* 499:499 */        return;
/* 500:    */      }
/* 501:501 */      Byte2CharOpenCustomHashMap.this.size -= 1;
...
/* 513:    */    } }
/* 514:    */  
/* 515:515 */  private class EntryIterator extends Byte2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2CharMap.Entry> { private EntryIterator() { super(null); }
/* 516:    */    
/* 517:    */    private Byte2CharOpenCustomHashMap.MapEntry entry;
/* 518:518 */    public Byte2CharMap.Entry next() { return this.entry = new Byte2CharOpenCustomHashMap.MapEntry(Byte2CharOpenCustomHashMap.this, nextEntry()); }
/* 519:    */    
/* 520:    */    public void remove()
/* 521:    */    {
/* 522:522 */      super.remove();
/* 523:523 */      Byte2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 524:    */    } }
/* 525:    */  
/* 526:526 */  private class FastEntryIterator extends Byte2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2CharMap.Entry> { private FastEntryIterator() { super(null); }
/* 527:527 */    final AbstractByte2CharMap.BasicEntry entry = new AbstractByte2CharMap.BasicEntry((byte)0, '\000');
/* 528:    */    
/* 529:529 */    public AbstractByte2CharMap.BasicEntry next() { int e = nextEntry();
/* 530:530 */      this.entry.key = Byte2CharOpenCustomHashMap.this.key[e];
/* 531:531 */      this.entry.value = Byte2CharOpenCustomHashMap.this.value[e];
/* 532:532 */      return this.entry;
/* 533:    */    } }
/* 534:    */  
/* 535:    */  private final class MapEntrySet extends AbstractObjectSet<Byte2CharMap.Entry> implements Byte2CharMap.FastEntrySet { private MapEntrySet() {}
/* 536:    */    
/* 537:537 */    public ObjectIterator<Byte2CharMap.Entry> iterator() { return new Byte2CharOpenCustomHashMap.EntryIterator(Byte2CharOpenCustomHashMap.this, null); }
/* 538:    */    
/* 539:    */    public ObjectIterator<Byte2CharMap.Entry> fastIterator() {
/* 540:540 */      return new Byte2CharOpenCustomHashMap.FastEntryIterator(Byte2CharOpenCustomHashMap.this, null);
/* 541:    */    }
/* 542:    */    
/* 543:    */    public boolean contains(Object o) {
/* 544:544 */      if (!(o instanceof Map.Entry)) return false;
/* 545:545 */      Map.Entry<Byte, Character> e = (Map.Entry)o;
/* 546:546 */      byte k = ((Byte)e.getKey()).byteValue();
/* 547:    */      
/* 548:548 */      int pos = HashCommon.murmurHash3(Byte2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2CharOpenCustomHashMap.this.mask;
/* 549:    */      
/* 550:550 */      while (Byte2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 551:551 */        if (Byte2CharOpenCustomHashMap.this.strategy.equals(Byte2CharOpenCustomHashMap.this.key[pos], k)) return Byte2CharOpenCustomHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 552:552 */        pos = pos + 1 & Byte2CharOpenCustomHashMap.this.mask;
/* 553:    */      }
...
/* 559:559 */      Map.Entry<Byte, Character> e = (Map.Entry)o;
/* 560:560 */      byte k = ((Byte)e.getKey()).byteValue();
/* 561:    */      
/* 562:562 */      int pos = HashCommon.murmurHash3(Byte2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2CharOpenCustomHashMap.this.mask;
/* 563:    */      
/* 564:564 */      while (Byte2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 565:565 */        if (Byte2CharOpenCustomHashMap.this.strategy.equals(Byte2CharOpenCustomHashMap.this.key[pos], k)) {
/* 566:566 */          Byte2CharOpenCustomHashMap.this.remove(e.getKey());
/* 567:567 */          return true;
/* 568:    */        }
/* 569:569 */        pos = pos + 1 & Byte2CharOpenCustomHashMap.this.mask;
/* 570:    */      }
/* 571:571 */      return false;
/* 572:    */    }
/* 573:    */    
/* 574:574 */    public int size() { return Byte2CharOpenCustomHashMap.this.size; }
/* 575:    */    
/* 577:577 */    public void clear() { Byte2CharOpenCustomHashMap.this.clear(); }
/* 578:    */  }
/* 579:    */  
/* 580:    */  public Byte2CharMap.FastEntrySet byte2CharEntrySet() {
...
/* 588:    */    extends Byte2CharOpenCustomHashMap.MapIterator
/* 589:    */    implements ByteIterator
/* 590:    */  {
/* 591:591 */    public KeyIterator() { super(null); }
/* 592:592 */    public byte nextByte() { return Byte2CharOpenCustomHashMap.this.key[nextEntry()]; }
/* 593:593 */    public Byte next() { return Byte.valueOf(Byte2CharOpenCustomHashMap.this.key[nextEntry()]); } }
/* 594:    */  
/* 595:    */  private final class KeySet extends AbstractByteSet { private KeySet() {}
/* 596:    */    
/* 597:597 */    public ByteIterator iterator() { return new Byte2CharOpenCustomHashMap.KeyIterator(Byte2CharOpenCustomHashMap.this); }
/* 598:    */    
/* 599:    */    public int size() {
/* 600:600 */      return Byte2CharOpenCustomHashMap.this.size;
/* 601:    */    }
/* 602:    */    
/* 603:603 */    public boolean contains(byte k) { return Byte2CharOpenCustomHashMap.this.containsKey(k); }
/* 604:    */    
/* 605:    */    public boolean remove(byte k) {
/* 606:606 */      int oldSize = Byte2CharOpenCustomHashMap.this.size;
/* 607:607 */      Byte2CharOpenCustomHashMap.this.remove(k);
/* 608:608 */      return Byte2CharOpenCustomHashMap.this.size != oldSize;
/* 609:    */    }
/* 610:    */    
/* 611:611 */    public void clear() { Byte2CharOpenCustomHashMap.this.clear(); }
/* 612:    */  }
/* 613:    */  
...
/* 622:    */    extends Byte2CharOpenCustomHashMap.MapIterator
/* 623:    */    implements CharIterator
/* 624:    */  {
/* 625:625 */    public ValueIterator() { super(null); }
/* 626:626 */    public char nextChar() { return Byte2CharOpenCustomHashMap.this.value[nextEntry()]; }
/* 627:627 */    public Character next() { return Character.valueOf(Byte2CharOpenCustomHashMap.this.value[nextEntry()]); }
/* 628:    */  }
/* 629:    */  
...
/* 632:632 */          return new Byte2CharOpenCustomHashMap.ValueIterator(Byte2CharOpenCustomHashMap.this);
/* 633:    */        }
/* 634:    */        
/* 635:635 */        public int size() { return Byte2CharOpenCustomHashMap.this.size; }
/* 636:    */        
/* 637:    */        public boolean contains(char v) {
/* 638:638 */          return Byte2CharOpenCustomHashMap.this.containsValue(v);
/* 639:    */        }
/* 640:    */        
/* 641:641 */        public void clear() { Byte2CharOpenCustomHashMap.this.clear(); }
/* 642:    */      };
/* 643:    */    }
...
/* 744:    */  }
/* 745:    */  
/* 749:    */  public Byte2CharOpenCustomHashMap clone()
/* 750:    */  {
/* 751:    */    Byte2CharOpenCustomHashMap c;
/* 752:    */    
/* 754:    */    try
/* 755:    */    {
/* 756:756 */      c = (Byte2CharOpenCustomHashMap)super.clone();
/* 757:    */    }
