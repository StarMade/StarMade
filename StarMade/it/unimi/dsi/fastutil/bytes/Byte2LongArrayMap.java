...
/*  17:    */
/*  66:    */public class Byte2LongArrayMap
/*  67:    */  extends AbstractByte2LongMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Byte2LongArrayMap(byte[] key, long[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Byte2LongArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = ByteArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = LongArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Byte2LongArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new byte[capacity];
/*  94: 94 */    this.value = new long[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Byte2LongArrayMap(Byte2LongMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Byte2LongArrayMap(Map<? extends Byte, ? extends Long> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Byte2LongArrayMap(byte[] key, long[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Byte2LongMap.Entry> implements Byte2LongMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Byte2LongMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Byte2LongArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Byte2LongMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractByte2LongMap.BasicEntry(Byte2LongArrayMap.this.key[this.next], Byte2LongArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Byte2LongMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractByte2LongMap.BasicEntry entry = new AbstractByte2LongMap.BasicEntry((byte)0, 0L);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Byte2LongArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Byte2LongMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Byte2LongArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Byte2LongArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Byte2LongArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Byte, Long> e = (Map.Entry)o;
/* 165:165 */      byte k = ((Byte)e.getKey()).byteValue();
/* 166:166 */      return (Byte2LongArrayMap.this.containsKey(k)) && (Byte2LongArrayMap.this.get(k) == ((Long)e.getValue()).longValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Byte2LongMap.FastEntrySet byte2LongEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public long put(byte k, long v)
/* 213:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Byte2LongArrayMap clone()
/* 263:    */  {
/* 264:    */    Byte2LongArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Byte2LongArrayMap)super.clone();
/* 270:    */    }
