...
/*     */ 
/*     */ public class Byte2LongArrayMap extends AbstractByte2LongMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Byte2LongArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Byte2LongMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Byte2LongArrayMap.this.size; }
/*     */ 
/*     */         public Byte2LongMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractByte2LongMap.BasicEntry(Byte2LongArrayMap.this.key[this.next], Byte2LongArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractByte2LongMap.BasicEntry entry = new AbstractByte2LongMap.BasicEntry((byte)0, 0L);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Byte2LongArrayMap.this.size; }
/*     */ 
/*     */         public Byte2LongMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Byte2LongArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Byte2LongArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Byte2LongArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Byte2LongArrayMap.this.containsKey(k)) && (Byte2LongArrayMap.this.get(k) == ((Long)e.getValue()).longValue());
/*     */     }
/*     */   }
/*     */ }
