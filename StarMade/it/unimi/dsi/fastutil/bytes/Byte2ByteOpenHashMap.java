  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2ByteOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2ByteOpenHashMap(Map<? extends Byte, ? extends Byte> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2ByteOpenHashMap(Map<? extends Byte, ? extends Byte> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2ByteOpenHashMap(Byte2ByteMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2ByteOpenHashMap(Byte2ByteMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2ByteOpenHashMap(byte[] local_k, byte[] local_v, float local_f)
  {
  ...
  public Byte2ByteOpenHashMap(byte[] local_k, byte[] local_v)
  {
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Byte2ByteOpenHashMap.ValueIterator(Byte2ByteOpenHashMap.this);
        }
        ...
        {
          return Byte2ByteOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2ByteOpenHashMap local_c;
    try
    {
      local_c = (Byte2ByteOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2ByteOpenHashMap.MapIterator
    implements ByteIterator
  {
    ...
    {
      return Byte2ByteOpenHashMap.this.value[nextEntry()];
    }
    
    public Byte next()
    {
      return Byte.valueOf(Byte2ByteOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSet
  {
    ...
    public ByteIterator iterator()
    {
      return new Byte2ByteOpenHashMap.KeyIterator(Byte2ByteOpenHashMap.this);
    }
    ...
    {
      return Byte2ByteOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2ByteOpenHashMap.this.size;
      Byte2ByteOpenHashMap.this.remove(local_k);
    ...
    implements ByteIterator
  {
    ...
    public byte nextByte()
    {
      return Byte2ByteOpenHashMap.this.key[nextEntry()];
    }
    
    public Byte next()
    {
      return Byte.valueOf(Byte2ByteOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2ByteMap.FastEntrySet
  {
    ...
    {
      return new Byte2ByteOpenHashMap.EntryIterator(Byte2ByteOpenHashMap.this, null);
    }
    
    public ObjectIterator<Byte2ByteMap.Entry> fastIterator()
    {
      return new Byte2ByteOpenHashMap.FastEntryIterator(Byte2ByteOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2ByteOpenHashMap.this.mask; Byte2ByteOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteOpenHashMap.this.mask) {
        if (Byte2ByteOpenHashMap.this.key[pos] == local_k) {
          return Byte2ByteOpenHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2ByteOpenHashMap.this.mask; Byte2ByteOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteOpenHashMap.this.mask) {
        if (Byte2ByteOpenHashMap.this.key[pos] == local_k)
        {
          Byte2ByteOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2ByteMap.Entry>
  {
    ...
    public AbstractByte2ByteMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2ByteOpenHashMap.this.key[local_e];
      this.entry.value = Byte2ByteOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2ByteMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2ByteOpenHashMap.MapEntry(Byte2ByteOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2ByteOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2ByteOpenHashMap.this.field_49;
    int last = -1;
    int field_2055 = Byte2ByteOpenHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2ByteOpenHashMap.this.used;
      while ((this.field_2055 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2055 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2055 != 0)
      {
        boolean[] local_k = Byte2ByteOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2ByteOpenHashMap.this.mask; Byte2ByteOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ByteOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2ByteOpenHashMap.this.key[pos]) & Byte2ByteOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2ByteOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2ByteOpenHashMap.this.key[pos]);
        }
        Byte2ByteOpenHashMap.this.key[last] = Byte2ByteOpenHashMap.this.key[pos];
        Byte2ByteOpenHashMap.this.value[last] = Byte2ByteOpenHashMap.this.value[pos];
      }
      Byte2ByteOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2ByteOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2ByteOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2055 > 0))
      {
        this.field_2055 += 1;
        nextEntry();
      }
    ...
    implements Byte2ByteMap.Entry, Map.Entry<Byte, Byte>
  {
    ...
    public Byte getKey()
    {
      return Byte.valueOf(Byte2ByteOpenHashMap.this.key[this.index]);
    }
    ...
    {
      return Byte.valueOf(Byte2ByteOpenHashMap.this.value[this.index]);
    }
    ...
    public byte setValue(byte local_v)
    {
      ...
      Byte2ByteOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Byte> local_e = (Map.Entry)local_o;
      return (Byte2ByteOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2ByteOpenHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
