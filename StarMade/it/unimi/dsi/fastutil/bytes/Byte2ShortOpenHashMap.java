...
/*     */ 
/*     */ public class Byte2ShortOpenHashMap extends AbstractByte2ShortMap
...
/* 642 */           return new Byte2ShortOpenHashMap.ValueIterator(Byte2ShortOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Byte2ShortOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(short v) {
/* 648 */           return Byte2ShortOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Byte2ShortOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Byte2ShortOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Byte2ShortOpenHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public short nextShort() { return Byte2ShortOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Short next() { return Short.valueOf(Byte2ShortOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Byte2ShortOpenHashMap.KeyIterator(Byte2ShortOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Byte2ShortOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(byte k) {
/* 613 */       return Byte2ShortOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(byte k) {
/* 616 */       int oldSize = Byte2ShortOpenHashMap.this.size;
/* 617 */       Byte2ShortOpenHashMap.this.remove(k);
/* 618 */       return Byte2ShortOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Byte2ShortOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Byte2ShortOpenHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public byte nextByte() { return Byte2ShortOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Byte next() { return Byte.valueOf(Byte2ShortOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Byte2ShortOpenHashMap.EntryIterator(Byte2ShortOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Byte2ShortMap.Entry> fastIterator() {
/* 550 */       return new Byte2ShortOpenHashMap.FastEntryIterator(Byte2ShortOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Byte2ShortOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Byte2ShortOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Byte2ShortOpenHashMap.this.key[pos] == k) return Byte2ShortOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 562 */         pos = pos + 1 & Byte2ShortOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Byte2ShortOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Byte2ShortOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Byte2ShortOpenHashMap.this.key[pos] == k) {
/* 576 */           Byte2ShortOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Byte2ShortOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Byte2ShortOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Byte2ShortOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Byte2ShortOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2ShortMap.Entry>
/*     */   {
/* 537 */     final AbstractByte2ShortMap.BasicEntry entry = new AbstractByte2ShortMap.BasicEntry((byte)0, (short)0);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Byte2ShortOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Byte2ShortOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Byte2ShortOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2ShortMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Byte2ShortOpenHashMap.MapEntry(Byte2ShortOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Byte2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Byte2ShortOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Byte2ShortOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Byte2ShortOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Byte2ShortOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Byte2ShortOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Byte2ShortOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Byte2ShortOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Byte2ShortOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Byte2ShortOpenHashMap.this.mask;
/* 485 */         while (Byte2ShortOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Byte2ShortOpenHashMap.this.key[pos]) & Byte2ShortOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Byte2ShortOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Byte2ShortOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 494 */           this.wrapped.add(Byte2ShortOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Byte2ShortOpenHashMap.this.key[last] = Byte2ShortOpenHashMap.this.key[pos];
/* 497 */         Byte2ShortOpenHashMap.this.value[last] = Byte2ShortOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Byte2ShortOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Byte2ShortOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Byte2ShortOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Byte getKey() {
/* 398 */       return Byte.valueOf(Byte2ShortOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public byte getByteKey() {
/* 401 */       return Byte2ShortOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Short getValue() {
/* 404 */       return Short.valueOf(Byte2ShortOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public short getShortValue() {
/* 407 */       return Byte2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public short setValue(short v) {
/* 410 */       short oldValue = Byte2ShortOpenHashMap.this.value[this.index];
/* 411 */       Byte2ShortOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Short setValue(Short v) {
...
/* 421 */       return (Byte2ShortOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2ShortOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Byte2ShortOpenHashMap.this.key[this.index] ^ Byte2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 427 */       return Byte2ShortOpenHashMap.this.key[this.index] + "=>" + Byte2ShortOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
