...
/*  119 */           return Byte2ObjectRBTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  122 */           return Byte2ObjectRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* 1118 */         final Comparator<? super Byte2ObjectMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Byte2ObjectMap.Entry<V> x, Byte2ObjectMap.Entry<V> y) {
/* 1120 */             return Byte2ObjectRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Byte2ObjectRBTreeMap.EntryIterator(Byte2ObjectRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from) {
/* 1130 */           return new Byte2ObjectRBTreeMap.EntryIterator(Byte2ObjectRBTreeMap.this, ((Byte)from.getKey()).byteValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Byte2ObjectRBTreeMap.Entry f = Byte2ObjectRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1143 */           Byte2ObjectRBTreeMap.Entry f = Byte2ObjectRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1144 */           if (f != null) Byte2ObjectRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Byte2ObjectRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Byte2ObjectRBTreeMap.this.clear(); } 
/* 1149 */         public Byte2ObjectMap.Entry<V> first() { return Byte2ObjectRBTreeMap.this.firstEntry; } 
/* 1150 */         public Byte2ObjectMap.Entry<V> last() { return Byte2ObjectRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> to) { return Byte2ObjectRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ObjectEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to) { return Byte2ObjectRBTreeMap.this.headMap((Byte)to.getKey()).byte2ObjectEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from) { return Byte2ObjectRBTreeMap.this.tailMap((Byte)from.getKey()).byte2ObjectEntrySet(); }
/*      */       };
...
/* 1215 */           return new Byte2ObjectRBTreeMap.ValueIterator(Byte2ObjectRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Byte2ObjectRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Byte2ObjectRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Byte2ObjectRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1580 */       c = (Byte2ObjectRBTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Byte2ObjectRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Byte2ObjectRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Byte2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Byte2ObjectMap.Entry<V>> byte2ObjectEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator() {
/* 1302 */             return new Byte2ObjectRBTreeMap.Submap.SubmapEntryIterator(Byte2ObjectRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Byte2ObjectMap.Entry<V>> iterator(Byte2ObjectMap.Entry<V> from) {
/* 1305 */             return new Byte2ObjectRBTreeMap.Submap.SubmapEntryIterator(Byte2ObjectRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
/*      */           }
/* 1307 */           public Comparator<? super Byte2ObjectMap.Entry<V>> comparator() { return Byte2ObjectRBTreeMap.this.byte2ObjectEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Byte2ObjectRBTreeMap.Entry f = Byte2ObjectRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1313 */             return (f != null) && (Byte2ObjectRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Byte2ObjectRBTreeMap.Entry f = Byte2ObjectRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1320 */             if ((f != null) && (Byte2ObjectRBTreeMap.Submap.this.in(f.key))) Byte2ObjectRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Byte2ObjectRBTreeMap.Submap.SubmapIterator(Byte2ObjectRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Byte2ObjectRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Byte2ObjectMap.Entry<V> first() { return Byte2ObjectRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Byte2ObjectMap.Entry<V> last() { return Byte2ObjectRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> subSet(Byte2ObjectMap.Entry<V> from, Byte2ObjectMap.Entry<V> to) { return Byte2ObjectRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2ObjectEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> headSet(Byte2ObjectMap.Entry<V> to) { return Byte2ObjectRBTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2ObjectEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Byte2ObjectMap.Entry<V>> tailSet(Byte2ObjectMap.Entry<V> from) { return Byte2ObjectRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2ObjectEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Byte2ObjectRBTreeMap.Submap.SubmapValueIterator(Byte2ObjectRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Byte2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Byte2ObjectRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Byte2ObjectRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(byte k) {
/* 1365 */       return (in(k)) && (Byte2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       byte kk = k;
/*      */       Byte2ObjectRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Byte2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(byte k, V v) {
/* 1383 */       Byte2ObjectRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Byte2ObjectRBTreeMap.this.put(k, v);
/* 1386 */       return Byte2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Byte ok, V ov) {
/* 1389 */       Object oldValue = put(ok.byteValue(), ov);
/* 1390 */       return Byte2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(byte k) {
/* 1394 */       Byte2ObjectRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Byte2ObjectRBTreeMap.this.remove(k);
/* 1397 */       return Byte2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Byte)ok).byteValue());
/* 1401 */       return Byte2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1416 */       return Byte2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Byte2ObjectSortedMap<V> headMap(byte to) {
/* 1419 */       if (this.top) return new Submap(Byte2ObjectRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Byte2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2ObjectRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Byte2ObjectSortedMap<V> tailMap(byte from) {
/* 1423 */       if (this.bottom) return new Submap(Byte2ObjectRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Byte2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2ObjectRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Byte2ObjectSortedMap<V> subMap(byte from, byte to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Byte2ObjectRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Byte2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Byte2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Byte2ObjectRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Byte2ObjectRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Byte2ObjectRBTreeMap.this.tree == null) return null;
/* 1441 */       Byte2ObjectRBTreeMap.Entry e;
/*      */       Byte2ObjectRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Byte2ObjectRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Byte2ObjectRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Byte2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Byte2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Byte2ObjectRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Byte2ObjectRBTreeMap.this.tree == null) return null;
/* 1459 */       Byte2ObjectRBTreeMap.Entry e;
/*      */       Byte2ObjectRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Byte2ObjectRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Byte2ObjectRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Byte2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Byte2ObjectRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public byte firstByteKey() {
/* 1470 */       Byte2ObjectRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public byte lastByteKey() {
/* 1475 */       Byte2ObjectRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Byte firstKey() {
/* 1480 */       Byte2ObjectRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Byte lastKey() {
/* 1485 */       Byte2ObjectRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Byte2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Byte2ObjectRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Byte2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/* 1530 */       public Byte2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Byte2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Byte2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Byte2ObjectRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Byte2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Byte2ObjectRBTreeMap.Submap.this.bottom) && (Byte2ObjectRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Byte2ObjectRBTreeMap.Submap.this.top) && (Byte2ObjectRBTreeMap.this.compare(k, (this.prev = Byte2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Byte2ObjectRBTreeMap.this.locateKey(k);
/* 1507 */             if (Byte2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Byte2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2ObjectRBTreeMap.this.compare(this.prev.key, Byte2ObjectRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Byte2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2ObjectRBTreeMap.this.compare(this.next.key, Byte2ObjectRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public ByteBidirectionalIterator iterator() { return new Byte2ObjectRBTreeMap.Submap.SubmapKeyIterator(Byte2ObjectRBTreeMap.Submap.this); } 
/* 1340 */       public ByteBidirectionalIterator iterator(byte from) { return new Byte2ObjectRBTreeMap.Submap.SubmapKeyIterator(Byte2ObjectRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public ByteBidirectionalIterator iterator() { return new Byte2ObjectRBTreeMap.KeyIterator(Byte2ObjectRBTreeMap.this); } 
/* 1178 */     public ByteBidirectionalIterator iterator(byte from) { return new Byte2ObjectRBTreeMap.KeyIterator(Byte2ObjectRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2ObjectRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Byte2ObjectMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1112 */     public Byte2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Byte2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Byte2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Byte2ObjectRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(byte k) {
/* 1044 */       if ((this.next = Byte2ObjectRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Byte2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Byte2ObjectRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
