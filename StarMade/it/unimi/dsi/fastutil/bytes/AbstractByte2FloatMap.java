...
/*     */     {
/*  92 */       while (n-- != 0) {
/*  93 */         Byte2FloatMap.Entry e = (Byte2FloatMap.Entry)i.next();
/*  94 */         put(e.getByteKey(), e.getFloatValue());
/*     */       }
/*     */     }
/*     */     else
/*     */     {
...
/* 101 */         put((Byte)e.getKey(), (Float)e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 193 */         return AbstractByte2FloatMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractByte2FloatMap.this.size(); } 
/* 196 */       public void clear() { AbstractByte2FloatMap.this.clear(); }
/*     */ 
/*     */       public ByteIterator iterator() {
/* 199 */         return new AbstractByteIterator() {
/* 200 */           final ObjectIterator<Map.Entry<Byte, Float>> i = AbstractByte2FloatMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public byte nextByte() { return ((Byte2FloatMap.Entry)this.i.next()).getByteKey(); } 
...
/* 226 */         return AbstractByte2FloatMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractByte2FloatMap.this.size(); } 
/* 229 */       public void clear() { AbstractByte2FloatMap.this.clear(); }
/*     */ 
/*     */       public FloatIterator iterator() {
/* 232 */         return new AbstractFloatIterator() {
/* 233 */           final ObjectIterator<Map.Entry<Byte, Float>> i = AbstractByte2FloatMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public float nextFloat() { return ((Byte2FloatMap.Entry)this.i.next()).getFloatValue(); } 
/*     */           public boolean hasNext() {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Byte2FloatMap.Entry e = (Byte2FloatMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
