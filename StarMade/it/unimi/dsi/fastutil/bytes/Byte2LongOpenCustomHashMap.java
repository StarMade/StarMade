...
/*     */ 
/*     */ public class Byte2LongOpenCustomHashMap extends AbstractByte2LongMap
...
/*     */   protected int size;
/*     */   protected volatile transient Byte2LongMap.FastEntrySet entries;
...
/* 662 */           return new Byte2LongOpenCustomHashMap.ValueIterator(Byte2LongOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 665 */           return Byte2LongOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(long v) {
/* 668 */           return Byte2LongOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 671 */           Byte2LongOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 786 */       c = (Byte2LongOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Byte2LongOpenCustomHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 655 */       super(null); } 
/* 656 */     public long nextLong() { return Byte2LongOpenCustomHashMap.this.value[nextEntry()]; } 
/* 657 */     public Long next() { return Long.valueOf(Byte2LongOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 627 */       return new Byte2LongOpenCustomHashMap.KeyIterator(Byte2LongOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 630 */       return Byte2LongOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(byte k) {
/* 633 */       return Byte2LongOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(byte k) {
/* 636 */       int oldSize = Byte2LongOpenCustomHashMap.this.size;
/* 637 */       Byte2LongOpenCustomHashMap.this.remove(k);
/* 638 */       return Byte2LongOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 641 */       Byte2LongOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Byte2LongOpenCustomHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public byte nextByte() { return Byte2LongOpenCustomHashMap.this.key[nextEntry()]; } 
/* 623 */     public Byte next() { return Byte.valueOf(Byte2LongOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
/*     */   private final class MapEntrySet extends AbstractObjectSet<Byte2LongMap.Entry>
...
/*     */     {
/* 567 */       return new Byte2LongOpenCustomHashMap.EntryIterator(Byte2LongOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Byte2LongMap.Entry> fastIterator() {
/* 570 */       return new Byte2LongOpenCustomHashMap.FastEntryIterator(Byte2LongOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 578 */       int pos = HashCommon.murmurHash3(Byte2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2LongOpenCustomHashMap.this.mask;
/*     */ 
/* 580 */       while (Byte2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 581 */         if (Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[pos], k)) return Byte2LongOpenCustomHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/* 582 */         pos = pos + 1 & Byte2LongOpenCustomHashMap.this.mask;
/*     */       }
/* 584 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 592 */       int pos = HashCommon.murmurHash3(Byte2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2LongOpenCustomHashMap.this.mask;
/*     */ 
/* 594 */       while (Byte2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 595 */         if (Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[pos], k)) {
/* 596 */           Byte2LongOpenCustomHashMap.this.remove(e.getKey());
/* 597 */           return true;
/*     */         }
/* 599 */         pos = pos + 1 & Byte2LongOpenCustomHashMap.this.mask;
/*     */       }
/* 601 */       return false;
/*     */     }
/*     */     public int size() {
/* 604 */       return Byte2LongOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 607 */       Byte2LongOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Byte2LongOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2LongMap.Entry>
/*     */   {
/* 557 */     final AbstractByte2LongMap.BasicEntry entry = new AbstractByte2LongMap.BasicEntry((byte)0, 0L);
/*     */ 
...
/* 559 */       int e = nextEntry();
/* 560 */       this.entry.key = Byte2LongOpenCustomHashMap.this.key[e];
/* 561 */       this.entry.value = Byte2LongOpenCustomHashMap.this.value[e];
/* 562 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Byte2LongOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2LongMap.Entry>
/*     */   {
...
/* 548 */       return this.entry = new Byte2LongOpenCustomHashMap.MapEntry(Byte2LongOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 552 */       super.remove();
/* 553 */       Byte2LongOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 454 */       this.pos = Byte2LongOpenCustomHashMap.this.n;
/*     */ 
/* 457 */       this.last = -1;
/*     */ 
/* 459 */       this.c = Byte2LongOpenCustomHashMap.this.size;
/*     */ 
/* 464 */       boolean[] used = Byte2LongOpenCustomHashMap.this.used;
...
/*     */ 
/* 477 */         int pos = HashCommon.murmurHash3(Byte2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2LongOpenCustomHashMap.this.mask;
/*     */ 
/* 479 */         while (Byte2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 480 */           if (Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481 */           pos = pos + 1 & Byte2LongOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 484 */       this.last = this.pos;
/*     */ 
/* 486 */       if (this.c != 0) {
/* 487 */         boolean[] used = Byte2LongOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 504 */         pos = (last = pos) + 1 & Byte2LongOpenCustomHashMap.this.mask;
/* 505 */         while (Byte2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 506 */           int slot = HashCommon.murmurHash3(Byte2LongOpenCustomHashMap.this.strategy.hashCode(Byte2LongOpenCustomHashMap.this.key[pos])) & Byte2LongOpenCustomHashMap.this.mask;
/* 507 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508 */           pos = pos + 1 & Byte2LongOpenCustomHashMap.this.mask;
/*     */         }
/* 510 */         if (Byte2LongOpenCustomHashMap.this.used[pos] == 0) break;
/* 511 */         if (pos < last)
/*     */         {
/* 513 */           if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 514 */           this.wrapped.add(Byte2LongOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 516 */         Byte2LongOpenCustomHashMap.this.key[last] = Byte2LongOpenCustomHashMap.this.key[pos];
/* 517 */         Byte2LongOpenCustomHashMap.this.value[last] = Byte2LongOpenCustomHashMap.this.value[pos];
/*     */       }
/* 519 */       Byte2LongOpenCustomHashMap.this.used[last] = false;
/* 520 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 525 */       if (this.pos < -1)
/*     */       {
/* 527 */         Byte2LongOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 528 */         this.last = -1;
/* 529 */         return;
/*     */       }
/* 531 */       Byte2LongOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Byte getKey() {
/* 418 */       return Byte.valueOf(Byte2LongOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public byte getByteKey() {
/* 421 */       return Byte2LongOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Long getValue() {
/* 424 */       return Long.valueOf(Byte2LongOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public long getLongValue() {
/* 427 */       return Byte2LongOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public long setValue(long v) {
/* 430 */       long oldValue = Byte2LongOpenCustomHashMap.this.value[this.index];
/* 431 */       Byte2LongOpenCustomHashMap.this.value[this.index] = v;
/* 432 */       return oldValue;
/*     */     }
/*     */     public Long setValue(Long v) {
...
/* 441 */       return (Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue())) && (Byte2LongOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*     */     }
/*     */     public int hashCode() {
/* 444 */       return Byte2LongOpenCustomHashMap.this.strategy.hashCode(Byte2LongOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Byte2LongOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 447 */       return Byte2LongOpenCustomHashMap.this.key[this.index] + "=>" + Byte2LongOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
