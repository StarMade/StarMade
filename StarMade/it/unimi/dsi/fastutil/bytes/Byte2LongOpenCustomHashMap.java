  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2LongOpenCustomHashMap(int expected, float local_f, ByteHash.Strategy strategy)
  {
  ...
  public Byte2LongOpenCustomHashMap(Map<? extends Byte, ? extends Long> local_m, float local_f, ByteHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Byte2LongOpenCustomHashMap(Map<? extends Byte, ? extends Long> local_m, ByteHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Byte2LongOpenCustomHashMap(Byte2LongMap local_m, float local_f, ByteHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Byte2LongOpenCustomHashMap(Byte2LongMap local_m, ByteHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Byte2LongOpenCustomHashMap(byte[] local_k, long[] local_v, float local_f, ByteHash.Strategy strategy)
  {
  ...
  public Byte2LongOpenCustomHashMap(byte[] local_k, long[] local_v, ByteHash.Strategy strategy)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Byte2LongOpenCustomHashMap.ValueIterator(Byte2LongOpenCustomHashMap.this);
        }
        ...
        {
          return Byte2LongOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2LongOpenCustomHashMap local_c;
    try
    {
      local_c = (Byte2LongOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2LongOpenCustomHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Byte2LongOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2LongOpenCustomHashMap.KeyIterator(Byte2LongOpenCustomHashMap.this);
    }
    ...
    {
      return Byte2LongOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2LongOpenCustomHashMap.this.size;
      Byte2LongOpenCustomHashMap.this.remove(local_k);
    ...
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2LongOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2LongMap.FastEntrySet
  {
    ...
    {
      return new Byte2LongOpenCustomHashMap.EntryIterator(Byte2LongOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Byte2LongMap.Entry> fastIterator()
    {
      return new Byte2LongOpenCustomHashMap.FastEntryIterator(Byte2LongOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Byte2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Byte2LongOpenCustomHashMap.this.mask; Byte2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2LongOpenCustomHashMap.this.mask) {
        if (Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[pos], local_k)) {
          return Byte2LongOpenCustomHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Byte2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Byte2LongOpenCustomHashMap.this.mask; Byte2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2LongOpenCustomHashMap.this.mask) {
        if (Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[pos], local_k))
        {
          Byte2LongOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2LongMap.Entry>
  {
    ...
    public AbstractByte2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2LongOpenCustomHashMap.this.key[local_e];
      this.entry.value = Byte2LongOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2LongOpenCustomHashMap.MapEntry(Byte2LongOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2LongOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2LongOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2248 = Byte2LongOpenCustomHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2LongOpenCustomHashMap.this.used;
      while ((this.field_2248 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2248 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2248 != 0)
      {
        boolean[] local_k = Byte2LongOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2LongOpenCustomHashMap.this.mask; Byte2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2LongOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2LongOpenCustomHashMap.this.strategy.hashCode(Byte2LongOpenCustomHashMap.this.key[pos])) & Byte2LongOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2LongOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2LongOpenCustomHashMap.this.key[pos]);
        }
        Byte2LongOpenCustomHashMap.this.key[last] = Byte2LongOpenCustomHashMap.this.key[pos];
        Byte2LongOpenCustomHashMap.this.value[last] = Byte2LongOpenCustomHashMap.this.value[pos];
      }
      Byte2LongOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2LongOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2LongOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2248 > 0))
      {
        this.field_2248 += 1;
        nextEntry();
      }
    ...
    implements Byte2LongMap.Entry, Map.Entry<Byte, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Byte2LongOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Long> local_e = (Map.Entry)local_o;
      return (Byte2LongOpenCustomHashMap.this.strategy.equals(Byte2LongOpenCustomHashMap.this.key[this.index], ((Byte)local_e.getKey()).byteValue())) && (Byte2LongOpenCustomHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
