  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2ObjectOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2ObjectOpenHashMap(Map<? extends Byte, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2ObjectOpenHashMap(Map<? extends Byte, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2ObjectOpenHashMap(Byte2ObjectMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2ObjectOpenHashMap(Byte2ObjectMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2ObjectOpenHashMap(byte[] local_k, V[] local_v, float local_f)
  {
  ...
  public Byte2ObjectOpenHashMap(byte[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Byte2ObjectOpenHashMap.ValueIterator(Byte2ObjectOpenHashMap.this);
        }
        ...
        {
          return Byte2ObjectOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2ObjectOpenHashMap<V> local_c;
    try
    {
      local_c = (Byte2ObjectOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    byte[] key = this.key;
    V[] value = this.value;
    Byte2ObjectOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Byte2ObjectOpenHashMap<V>.MapIterator
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2ObjectOpenHashMap.KeyIterator(Byte2ObjectOpenHashMap.this);
    }
    ...
    {
      return Byte2ObjectOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2ObjectOpenHashMap.this.size;
      Byte2ObjectOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Byte2ObjectOpenHashMap.MapIterator
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2ObjectOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2ObjectMap.FastEntrySet<V>
  {
    ...
    {
      return new Byte2ObjectOpenHashMap.EntryIterator(Byte2ObjectOpenHashMap.this, null);
    }
    
    public ObjectIterator<Byte2ObjectMap.Entry<V>> fastIterator()
    {
      return new Byte2ObjectOpenHashMap.FastEntryIterator(Byte2ObjectOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2ObjectOpenHashMap.this.mask; Byte2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask) {
        if (Byte2ObjectOpenHashMap.this.key[pos] == local_k) {
          return Byte2ObjectOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Byte2ObjectOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2ObjectOpenHashMap.this.mask; Byte2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask) {
        if (Byte2ObjectOpenHashMap.this.key[pos] == local_k)
        {
          Byte2ObjectOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2ObjectMap.Entry<V>>
  {
    ...
    public AbstractByte2ObjectMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Byte2ObjectOpenHashMap.this.key[local_e];
      this.entry.value = Byte2ObjectOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2ObjectMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Byte2ObjectOpenHashMap.MapEntry(Byte2ObjectOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2ObjectOpenHashMap.this.field_49;
    int last = -1;
    int field_1900 = Byte2ObjectOpenHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2ObjectOpenHashMap.this.used;
      while ((this.field_1900 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1900 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1900 != 0)
      {
        boolean[] local_k = Byte2ObjectOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2ObjectOpenHashMap.this.mask; Byte2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2ObjectOpenHashMap.this.key[pos]) & Byte2ObjectOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2ObjectOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2ObjectOpenHashMap.this.key[pos]);
        }
        Byte2ObjectOpenHashMap.this.key[last] = Byte2ObjectOpenHashMap.this.key[pos];
        Byte2ObjectOpenHashMap.this.value[last] = Byte2ObjectOpenHashMap.this.value[pos];
      }
      Byte2ObjectOpenHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2ObjectOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2ObjectOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1900 > 0))
      {
        this.field_1900 += 1;
        nextEntry();
      }
    ...
    implements Byte2ObjectMap.Entry<V>, Map.Entry<Byte, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Byte2ObjectOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, V> local_e = (Map.Entry)local_o;
      return (Byte2ObjectOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2ObjectOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Byte2ObjectOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
