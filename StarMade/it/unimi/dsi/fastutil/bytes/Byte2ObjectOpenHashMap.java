...
/* 607 */           return new Byte2ObjectOpenHashMap.ValueIterator(Byte2ObjectOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 610 */           return Byte2ObjectOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 613 */           return Byte2ObjectOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 616 */           Byte2ObjectOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 731 */       c = (Byte2ObjectOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Byte2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public V next() { return Byte2ObjectOpenHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 573 */       return new Byte2ObjectOpenHashMap.KeyIterator(Byte2ObjectOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 576 */       return Byte2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(byte k) {
/* 579 */       return Byte2ObjectOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(byte k) {
/* 582 */       int oldSize = Byte2ObjectOpenHashMap.this.size;
/* 583 */       Byte2ObjectOpenHashMap.this.remove(k);
/* 584 */       return Byte2ObjectOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 587 */       Byte2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Byte2ObjectOpenHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 567 */       super(null); } 
/* 568 */     public byte nextByte() { return Byte2ObjectOpenHashMap.this.key[nextEntry()]; } 
/* 569 */     public Byte next() { return Byte.valueOf(Byte2ObjectOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 513 */       return new Byte2ObjectOpenHashMap.EntryIterator(Byte2ObjectOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Byte2ObjectMap.Entry<V>> fastIterator() {
/* 516 */       return new Byte2ObjectOpenHashMap.FastEntryIterator(Byte2ObjectOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 524 */       int pos = HashCommon.murmurHash3(k) & Byte2ObjectOpenHashMap.this.mask;
/*     */ 
/* 526 */       while (Byte2ObjectOpenHashMap.this.used[pos] != 0) {
/* 527 */         if (Byte2ObjectOpenHashMap.this.key[pos] == k) return Byte2ObjectOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Byte2ObjectOpenHashMap.this.value[pos].equals(e.getValue());
/* 528 */         pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask;
/*     */       }
/* 530 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 538 */       int pos = HashCommon.murmurHash3(k) & Byte2ObjectOpenHashMap.this.mask;
/*     */ 
/* 540 */       while (Byte2ObjectOpenHashMap.this.used[pos] != 0) {
/* 541 */         if (Byte2ObjectOpenHashMap.this.key[pos] == k) {
/* 542 */           Byte2ObjectOpenHashMap.this.remove(e.getKey());
/* 543 */           return true;
/*     */         }
/* 545 */         pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask;
/*     */       }
/* 547 */       return false;
/*     */     }
/*     */     public int size() {
/* 550 */       return Byte2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 553 */       Byte2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Byte2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Byte2ObjectMap.Entry<V>>
/*     */   {
/* 503 */     final AbstractByte2ObjectMap.BasicEntry<V> entry = new AbstractByte2ObjectMap.BasicEntry((byte)0, null);
/*     */ 
...
/* 505 */       int e = nextEntry();
/* 506 */       this.entry.key = Byte2ObjectOpenHashMap.this.key[e];
/* 507 */       this.entry.value = Byte2ObjectOpenHashMap.this.value[e];
/* 508 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Byte2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Byte2ObjectMap.Entry<V>>
/*     */   {
...
/* 494 */       return this.entry = new Byte2ObjectOpenHashMap.MapEntry(Byte2ObjectOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 498 */       super.remove();
/* 499 */       Byte2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 399 */       this.pos = Byte2ObjectOpenHashMap.this.n;
/*     */ 
/* 402 */       this.last = -1;
/*     */ 
/* 404 */       this.c = Byte2ObjectOpenHashMap.this.size;
/*     */ 
/* 409 */       boolean[] used = Byte2ObjectOpenHashMap.this.used;
...
/*     */ 
/* 422 */         int pos = HashCommon.murmurHash3(k) & Byte2ObjectOpenHashMap.this.mask;
/*     */ 
/* 424 */         while (Byte2ObjectOpenHashMap.this.used[pos] != 0) {
/* 425 */           if (Byte2ObjectOpenHashMap.this.key[pos] == k) return pos;
/* 426 */           pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 429 */       this.last = this.pos;
/*     */ 
/* 431 */       if (this.c != 0) {
/* 432 */         boolean[] used = Byte2ObjectOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 449 */         pos = (last = pos) + 1 & Byte2ObjectOpenHashMap.this.mask;
/* 450 */         while (Byte2ObjectOpenHashMap.this.used[pos] != 0) {
/* 451 */           int slot = HashCommon.murmurHash3(Byte2ObjectOpenHashMap.this.key[pos]) & Byte2ObjectOpenHashMap.this.mask;
/* 452 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453 */           pos = pos + 1 & Byte2ObjectOpenHashMap.this.mask;
/*     */         }
/* 455 */         if (Byte2ObjectOpenHashMap.this.used[pos] == 0) break;
/* 456 */         if (pos < last)
/*     */         {
/* 458 */           if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 459 */           this.wrapped.add(Byte2ObjectOpenHashMap.this.key[pos]);
/*     */         }
/* 461 */         Byte2ObjectOpenHashMap.this.key[last] = Byte2ObjectOpenHashMap.this.key[pos];
/* 462 */         Byte2ObjectOpenHashMap.this.value[last] = Byte2ObjectOpenHashMap.this.value[pos];
/*     */       }
/* 464 */       Byte2ObjectOpenHashMap.this.used[last] = false;
/* 465 */       Byte2ObjectOpenHashMap.this.value[last] = null;
/* 466 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 471 */       if (this.pos < -1)
/*     */       {
/* 473 */         Byte2ObjectOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 474 */         this.last = -1;
/* 475 */         return;
/*     */       }
/* 477 */       Byte2ObjectOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Byte getKey() {
/* 369 */       return Byte.valueOf(Byte2ObjectOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public byte getByteKey() {
/* 372 */       return Byte2ObjectOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 375 */       return Byte2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 378 */       Object oldValue = Byte2ObjectOpenHashMap.this.value[this.index];
/* 379 */       Byte2ObjectOpenHashMap.this.value[this.index] = v;
/* 380 */       return oldValue;
/*     */     }
/*     */ 
...
/* 386 */       return (Byte2ObjectOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Byte2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
/* 389 */       return Byte2ObjectOpenHashMap.this.key[this.index] ^ (Byte2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Byte2ObjectOpenHashMap.this.value[this.index].hashCode());
/*     */     }
/*     */     public String toString() {
/* 392 */       return Byte2ObjectOpenHashMap.this.key[this.index] + "=>" + Byte2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
