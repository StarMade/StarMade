  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2IntLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2IntLinkedOpenHashMap(Map<? extends Byte, ? extends Integer> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2IntLinkedOpenHashMap(Map<? extends Byte, ? extends Integer> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2IntLinkedOpenHashMap(Byte2IntMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2IntLinkedOpenHashMap(Byte2IntMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2IntLinkedOpenHashMap(byte[] local_k, int[] local_v, float local_f)
  {
  ...
  public Byte2IntLinkedOpenHashMap(byte[] local_k, int[] local_v)
  {
  ...
  public int getAndMoveToFirst(byte local_k)
  {
    byte[] key = this.key;
  ...
  public int getAndMoveToLast(byte local_k)
  {
    byte[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public int putAndMoveToFirst(byte local_k, int local_v)
  {
    byte[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public int putAndMoveToLast(byte local_k, int local_v)
  {
    byte[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Byte2IntLinkedOpenHashMap.ValueIterator(Byte2IntLinkedOpenHashMap.this);
        }
        ...
        {
          return Byte2IntLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2IntLinkedOpenHashMap local_c;
    try
    {
      local_c = (Byte2IntLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2IntLinkedOpenHashMap.MapIterator
    implements IntListIterator
  {
    public int previousInt()
    {
      return Byte2IntLinkedOpenHashMap.this.value[previousEntry()];
    }
    
    public Integer previous()
    {
      return Integer.valueOf(Byte2IntLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public int nextInt()
    {
      return Byte2IntLinkedOpenHashMap.this.value[nextEntry()];
    }
    
    public Integer next()
    {
      return Integer.valueOf(Byte2IntLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractByteSortedSet
  {
    ...
    {
      return new Byte2IntLinkedOpenHashMap.KeyIterator(Byte2IntLinkedOpenHashMap.this, from);
    }
    
    public ByteListIterator iterator()
    {
      return new Byte2IntLinkedOpenHashMap.KeyIterator(Byte2IntLinkedOpenHashMap.this);
    }
    ...
    {
      return Byte2IntLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2IntLinkedOpenHashMap.this.size;
      Byte2IntLinkedOpenHashMap.this.remove(local_k);
    ...
    implements ByteListIterator
  {
    ...
    {
      return Byte2IntLinkedOpenHashMap.this.key[previousEntry()];
    }
    ...
    {
      return Byte.valueOf(Byte2IntLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    {
      return Byte2IntLinkedOpenHashMap.this.key[nextEntry()];
    }
    
    public Byte next()
    {
      return Byte.valueOf(Byte2IntLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2IntSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Byte2IntLinkedOpenHashMap.EntryIterator(Byte2IntLinkedOpenHashMap.this);
    }
    ...
    public Byte2IntMap.Entry first()
    {
      ...
      return new Byte2IntLinkedOpenHashMap.MapEntry(Byte2IntLinkedOpenHashMap.this, Byte2IntLinkedOpenHashMap.this.first);
    }
    ...
    public Byte2IntMap.Entry last()
    {
      ...
      return new Byte2IntLinkedOpenHashMap.MapEntry(Byte2IntLinkedOpenHashMap.this, Byte2IntLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2IntLinkedOpenHashMap.this.mask; Byte2IntLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2IntLinkedOpenHashMap.this.mask) {
        if (Byte2IntLinkedOpenHashMap.this.key[pos] == local_k) {
          return Byte2IntLinkedOpenHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2IntLinkedOpenHashMap.this.mask; Byte2IntLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2IntLinkedOpenHashMap.this.mask) {
        if (Byte2IntLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Byte2IntLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Byte2IntLinkedOpenHashMap.EntryIterator(Byte2IntLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
    }
    
    public ObjectBidirectionalIterator<Byte2IntMap.Entry> fastIterator()
    {
      return new Byte2IntLinkedOpenHashMap.FastEntryIterator(Byte2IntLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Byte2IntMap.Entry> fastIterator(Byte2IntMap.Entry from)
    {
      return new Byte2IntLinkedOpenHashMap.FastEntryIterator(Byte2IntLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
    }
  }
    ...
    implements ObjectListIterator<Byte2IntMap.Entry>
  {
    ...
    public AbstractByte2IntMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2IntLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Byte2IntLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Byte2IntMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2IntLinkedOpenHashMap.MapEntry(Byte2IntLinkedOpenHashMap.this, nextEntry());
    }
    
    public Byte2IntLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Byte2IntLinkedOpenHashMap.MapEntry(Byte2IntLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2IntLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(byte from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Byte2IntLinkedOpenHashMap.this.mask; Byte2IntLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2IntLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Byte2IntLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Byte2IntLinkedOpenHashMap.this.first = this.next;
      } else {
        Byte2IntLinkedOpenHashMap.this.link[this.prev] ^= (Byte2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Byte2IntLinkedOpenHashMap.this.last = this.prev;
      } else {
        Byte2IntLinkedOpenHashMap.this.link[this.next] ^= (Byte2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2IntLinkedOpenHashMap.this.mask; Byte2IntLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2IntLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2IntLinkedOpenHashMap.this.key[pos]) & Byte2IntLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2IntLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Byte2IntLinkedOpenHashMap.this.key[last] = Byte2IntLinkedOpenHashMap.this.key[pos];
      ...
      Byte2IntLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Byte2IntMap.Entry, Map.Entry<Byte, Integer>
  {
    ...
    public Byte getKey()
    {
      return Byte.valueOf(Byte2IntLinkedOpenHashMap.this.key[this.index]);
    }
    ...
    {
      return Integer.valueOf(Byte2IntLinkedOpenHashMap.this.value[this.index]);
    }
    ...
    public int setValue(int local_v)
    {
      ...
      Byte2IntLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Integer> local_e = (Map.Entry)local_o;
      return (Byte2IntLinkedOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
