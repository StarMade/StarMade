  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2ReferenceOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2ReferenceOpenHashMap(Map<? extends Byte, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2ReferenceOpenHashMap(Map<? extends Byte, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2ReferenceOpenHashMap(Byte2ReferenceMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2ReferenceOpenHashMap(Byte2ReferenceMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2ReferenceOpenHashMap(byte[] local_k, V[] local_v, float local_f)
  {
  ...
  public Byte2ReferenceOpenHashMap(byte[] local_k, V[] local_v)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Byte2ReferenceOpenHashMap.ValueIterator(Byte2ReferenceOpenHashMap.this);
        }
        ...
        {
          return Byte2ReferenceOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2ReferenceOpenHashMap<V> local_c;
    try
    {
      local_c = (Byte2ReferenceOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    byte[] key = this.key;
    V[] value = this.value;
    Byte2ReferenceOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2ReferenceOpenHashMap.KeyIterator(Byte2ReferenceOpenHashMap.this);
    }
    ...
    {
      return Byte2ReferenceOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2ReferenceOpenHashMap.this.size;
      Byte2ReferenceOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Byte2ReferenceOpenHashMap.MapIterator
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Byte2ReferenceOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Byte2ReferenceMap.FastEntrySet<V>
  {
    ...
    {
      return new Byte2ReferenceOpenHashMap.EntryIterator(Byte2ReferenceOpenHashMap.this, null);
    }
    
    public ObjectIterator<Byte2ReferenceMap.Entry<V>> fastIterator()
    {
      return new Byte2ReferenceOpenHashMap.FastEntryIterator(Byte2ReferenceOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2ReferenceOpenHashMap.this.mask; Byte2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ReferenceOpenHashMap.this.mask) {
        if (Byte2ReferenceOpenHashMap.this.key[pos] == local_k) {
          return Byte2ReferenceOpenHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2ReferenceOpenHashMap.this.mask; Byte2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ReferenceOpenHashMap.this.mask) {
        if (Byte2ReferenceOpenHashMap.this.key[pos] == local_k)
        {
          Byte2ReferenceOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2ReferenceMap.Entry<V>>
  {
    ...
    public AbstractByte2ReferenceMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Byte2ReferenceOpenHashMap.this.key[local_e];
      this.entry.value = Byte2ReferenceOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2ReferenceMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Byte2ReferenceOpenHashMap.MapEntry(Byte2ReferenceOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2ReferenceOpenHashMap.this.field_49;
    int last = -1;
    int field_1860 = Byte2ReferenceOpenHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2ReferenceOpenHashMap.this.used;
      while ((this.field_1860 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1860 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1860 != 0)
      {
        boolean[] local_k = Byte2ReferenceOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2ReferenceOpenHashMap.this.mask; Byte2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2ReferenceOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2ReferenceOpenHashMap.this.key[pos]) & Byte2ReferenceOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2ReferenceOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2ReferenceOpenHashMap.this.key[pos]);
        }
        Byte2ReferenceOpenHashMap.this.key[last] = Byte2ReferenceOpenHashMap.this.key[pos];
        Byte2ReferenceOpenHashMap.this.value[last] = Byte2ReferenceOpenHashMap.this.value[pos];
      }
      Byte2ReferenceOpenHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2ReferenceOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2ReferenceOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1860 > 0))
      {
        this.field_1860 += 1;
        nextEntry();
      }
    ...
    implements Byte2ReferenceMap.Entry<V>, Map.Entry<Byte, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Byte2ReferenceOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, V> local_e = (Map.Entry)local_o;
      return (Byte2ReferenceOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2ReferenceOpenHashMap.this.value[this.index] == local_e.getValue());
    }
