...
/*   4:    */
/*  63:    */public class ByteIndirectHeaps
/*  64:    */{
/*  65:    */  public static int downHeap(byte[] refArray, int[] heap, int[] inv, int size, int i, ByteComparator c)
/*  66:    */  {
/*  67: 67 */    if (i >= size) throw new IllegalArgumentException("Heap position (" + i + ") is larger than or equal to heap size (" + size + ")");
/*  68: 68 */    int e = heap[i];
/*  69: 69 */    byte E = refArray[e];
/*  70:    */    
...
/*  90:    */  }
/*  91:    */  
/* 103:    */  public static int upHeap(byte[] refArray, int[] heap, int[] inv, int size, int i, ByteComparator c)
/* 104:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 135:    */  public static void makeHeap(byte[] refArray, int offset, int length, int[] heap, int[] inv, ByteComparator c)
/* 136:    */  {
/* 137:137 */    ByteArrays.ensureOffsetLength(refArray, offset, length);
