...
{
  public static int downHeap(byte[] refArray, int[] heap, int[] inv, int size, int local_i, ByteComparator local_c)
  {
    if (local_i >= size) {
  ...
  public static int upHeap(byte[] refArray, int[] heap, int[] inv, int size, int local_i, ByteComparator local_c)
  {
    if (local_i >= size) {
      throw new IllegalArgumentException("Heap position (" + local_i + ") is larger than or equal to heap size (" + size + ")");
    }
  ...
  public static void makeHeap(byte[] refArray, int offset, int length, int[] heap, int[] inv, ByteComparator local_c)
  {
  ...
  public static void makeHeap(byte[] refArray, int[] heap, int[] inv, int size, ByteComparator local_c)
  {
    int local_i = size / 2;
    while (local_i-- != 0) {
