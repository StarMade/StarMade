  ...
  implements Serializable, Cloneable
{
  ...
  public Byte2ShortArrayMap(Byte2ShortMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Byte2ShortArrayMap(Map<? extends Byte, ? extends Short> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Byte2ShortArrayMap local_c;
    try
    {
      local_c = (Byte2ShortArrayMap)super.clone();
    }
    ...
    implements Byte2ShortMap.FastEntrySet
  {
    ...
    public ObjectIterator<Byte2ShortMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Byte2ShortMap.Entry next()
        {
          ...
          return new AbstractByte2ShortMap.BasicEntry(Byte2ShortArrayMap.this.key[this.next], Byte2ShortArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Byte2ShortMap.Entry> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Byte2ShortMap.Entry next()
        {
          ...
          this.entry.key = Byte2ShortArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Byte2ShortArrayMap.this.containsKey(local_k)) && (Byte2ShortArrayMap.this.get(local_k) == ((Short)local_e.getValue()).shortValue());
    }
  }
}
