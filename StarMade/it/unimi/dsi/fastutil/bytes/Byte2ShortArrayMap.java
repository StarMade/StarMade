...
/*     */ 
/*     */ public class Byte2ShortArrayMap extends AbstractByte2ShortMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Byte2ShortArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Byte2ShortMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Byte2ShortArrayMap.this.size; }
/*     */ 
/*     */         public Byte2ShortMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractByte2ShortMap.BasicEntry(Byte2ShortArrayMap.this.key[this.next], Byte2ShortArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractByte2ShortMap.BasicEntry entry = new AbstractByte2ShortMap.BasicEntry((byte)0, (short)0);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Byte2ShortArrayMap.this.size; }
/*     */ 
/*     */         public Byte2ShortMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Byte2ShortArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Byte2ShortArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Byte2ShortArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Byte2ShortArrayMap.this.containsKey(k)) && (Byte2ShortArrayMap.this.get(k) == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */   }
/*     */ }
