...
/*  17:    */
/*  66:    */public class Byte2ShortArrayMap
/*  67:    */  extends AbstractByte2ShortMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Byte2ShortArrayMap(byte[] key, short[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Byte2ShortArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = ByteArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = ShortArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Byte2ShortArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new byte[capacity];
/*  94: 94 */    this.value = new short[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Byte2ShortArrayMap(Byte2ShortMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Byte2ShortArrayMap(Map<? extends Byte, ? extends Short> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Byte2ShortArrayMap(byte[] key, short[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Byte2ShortMap.Entry> implements Byte2ShortMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Byte2ShortMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Byte2ShortArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Byte2ShortMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractByte2ShortMap.BasicEntry(Byte2ShortArrayMap.this.key[this.next], Byte2ShortArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Byte2ShortMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractByte2ShortMap.BasicEntry entry = new AbstractByte2ShortMap.BasicEntry((byte)0, (short)0);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Byte2ShortArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Byte2ShortMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Byte2ShortArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Byte2ShortArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Byte2ShortArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Byte, Short> e = (Map.Entry)o;
/* 165:165 */      byte k = ((Byte)e.getKey()).byteValue();
/* 166:166 */      return (Byte2ShortArrayMap.this.containsKey(k)) && (Byte2ShortArrayMap.this.get(k) == ((Short)e.getValue()).shortValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Byte2ShortMap.FastEntrySet byte2ShortEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public short put(byte k, short v)
/* 213:    */  {
...
/* 234:    */  }
/* 235:    */  
/* 236:    */  public short remove(byte k)
/* 237:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Byte2ShortArrayMap clone()
/* 263:    */  {
/* 264:    */    Byte2ShortArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Byte2ShortArrayMap)super.clone();
/* 270:    */    }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.bytes.Byte2ShortArrayMap
