...
/*     */   public static Byte2ByteMap singleton(Byte key, Byte value)
/*     */   {
/* 200 */     return new Singleton(key.byteValue(), value.byteValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.byte2ByteEntrySet()); return this.entries; } 
...
/* 335 */     public byte get(byte k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Byte, Byte>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Byte, ? extends Byte> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.byte2ByteEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public byte get(byte k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Byte, Byte>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/*     */       public Byte getKey()
/*     */       {
/* 131 */         return Byte.valueOf(Byte2ByteMaps.Singleton.this.key); } 
/* 132 */       public Byte getValue() { return Byte.valueOf(Byte2ByteMaps.Singleton.this.value); }
/*     */ 
/*     */       public byte getByteKey() {
/* 135 */         return Byte2ByteMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public byte getByteValue() {
/* 139 */         return Byte2ByteMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Byte2ByteMaps.Singleton.this.key == ((Byte)e.getKey()).byteValue()) && (Byte2ByteMaps.Singleton.this.value == ((Byte)e.getValue()).byteValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return Byte2ByteMaps.Singleton.this.key ^ Byte2ByteMaps.Singleton.this.value; } 
/* 153 */       public String toString() { return Byte2ByteMaps.Singleton.this.key + "->" + Byte2ByteMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Byte, ? extends Byte> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Byte2ByteMap.Entry> byte2ByteEntrySet() {
...
/*  76 */     private Object readResolve() { return Byte2ByteMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Byte2ByteMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Byte, Byte>> entrySet() {
/*  80 */       return byte2ByteEntrySet();
/*     */     }
