  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2CharAVLTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2CharAVLTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2CharAVLTreeMap(Map<? extends Byte, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2CharAVLTreeMap(SortedMap<Byte, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2CharAVLTreeMap(Byte2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2CharAVLTreeMap(Byte2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2CharAVLTreeMap(byte[] local_k, char[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2CharAVLTreeMap(byte[] local_k, char[] local_v)
  {
  ...
  {
    char oldValue = put(local_ok.byteValue(), local_ov.charValue());
    return this.modified ? null : Character.valueOf(oldValue);
  }
  
  public Character remove(Object local_ok)
  {
    char oldValue = remove(((Byte)local_ok).byteValue());
  ...
  public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Byte2CharMap.Entry> comparator = new Comparator()
        {
          public int compare(Byte2CharMap.Entry local_x, Byte2CharMap.Entry local_y)
          {
            return Byte2CharAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2CharAVLTreeMap.EntryIterator(Byte2CharAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from)
        {
          return new Byte2CharAVLTreeMap.EntryIterator(Byte2CharAVLTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2CharAVLTreeMap.Entry local_f = Byte2CharAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2CharAVLTreeMap.Entry local_f = Byte2CharAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2CharAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry local_to)
        {
          return Byte2CharAVLTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2CharEntrySet();
        }
        
        public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry local_to)
        {
          return Byte2CharAVLTreeMap.this.headMap((Byte)local_to.getKey()).byte2CharEntrySet();
        }
        
        public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from)
        {
          return Byte2CharAVLTreeMap.this.tailMap((Byte)from.getKey()).byte2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Byte2CharAVLTreeMap.ValueIterator(Byte2CharAVLTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Byte2CharAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2CharAVLTreeMap local_c;
    try
    {
      local_c = (Byte2CharAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readByte(), local_s.readChar());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readByte(), local_s.readChar());
      top.right(new Entry(local_s.readByte(), local_s.readChar()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2CharAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2CharAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2CharAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator()
          {
            return new Byte2CharAVLTreeMap.Submap.SubmapEntryIterator(Byte2CharAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from)
          {
            return new Byte2CharAVLTreeMap.Submap.SubmapEntryIterator(Byte2CharAVLTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Character> local_e = (Map.Entry)local_o;
            Byte2CharAVLTreeMap.Entry local_f = Byte2CharAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2CharAVLTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Character> local_e = (Map.Entry)local_o;
            Byte2CharAVLTreeMap.Entry local_f = Byte2CharAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2CharAVLTreeMap.Submap.this.in3(local_f.key))) {
              Byte2CharAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2CharAVLTreeMap.Submap.SubmapIterator(Byte2CharAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2CharAVLTreeMap.Submap.this.clear();
          }
          
          public Byte2CharMap.Entry first()
          {
            return Byte2CharAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2CharMap.Entry last()
          {
            return Byte2CharAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry local_to)
          {
            return Byte2CharAVLTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2CharEntrySet();
          }
          
          public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry local_to)
          {
            return Byte2CharAVLTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2CharEntrySet();
          }
          
          public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from)
          {
            return Byte2CharAVLTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Byte2CharAVLTreeMap.Submap.SubmapValueIterator(Byte2CharAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Byte2CharAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2CharAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2CharAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2CharAVLTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2CharAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(byte local_k, char local_v)
    {
      ...
      char oldValue = Byte2CharAVLTreeMap.this.put(local_k, local_v);
    ...
    public char remove(byte local_k)
    {
      ...
      char oldValue = Byte2CharAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2CharAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2CharAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2CharSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2CharAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2CharAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2CharSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2CharAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2CharAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2CharAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2CharAVLTreeMap.this.locateKey(this.from);
        if (Byte2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2CharAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2CharAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2CharAVLTreeMap.this.locateKey(this.field_47);
        if (Byte2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2CharAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2CharAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      implements ObjectListIterator<Byte2CharMap.Entry>
    {
      ...
      public void set(Byte2CharMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Byte2CharMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
      ...
      extends Byte2CharAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2CharAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2CharAVLTreeMap.Submap.this.bottom) && (Byte2CharAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2CharAVLTreeMap.Submap.this.top) && (Byte2CharAVLTreeMap.this.compare(local_k, (this.prev = Byte2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2CharAVLTreeMap.this.locateKey(local_k);
            if (Byte2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2CharAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2CharAVLTreeMap.this.compare(this.prev.key, Byte2CharAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2CharAVLTreeMap.Submap.this.top) && (this.next != null) && (Byte2CharAVLTreeMap.this.compare(this.next.key, Byte2CharAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2CharSortedMap.KeySet
    {
      ...
      {
        return new Byte2CharAVLTreeMap.Submap.SubmapKeyIterator(Byte2CharAVLTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2CharAVLTreeMap.Submap.SubmapKeyIterator(Byte2CharAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2CharSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2CharAVLTreeMap.KeyIterator(Byte2CharAVLTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2CharAVLTreeMap.KeyIterator(Byte2CharAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2CharAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Byte2CharMap.Entry
  {
    ...
    Entry(byte local_k, char local_v)
    {
      this.key = local_k;
      this.value = local_v;
