...
/*   21:     */
/*   73:     */public class Byte2CharAVLTreeMap
...
/*  117: 117 */          return Byte2CharAVLTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*  118:     */        }
/*  119:     */        
/*  120: 120 */        public int compare(Byte ok1, Byte ok2) { return Byte2CharAVLTreeMap.this.storedComparator.compare(ok1, ok2); }
/*  121:     */      };
/*  122:     */    }
/*  123:     */  }
/*  124:     */  
/*  131:     */  public Byte2CharAVLTreeMap(Comparator<? super Byte> c)
/*  132:     */  {
/*  133: 133 */    this();
...
/*  136:     */  }
/*  137:     */  
/*  143:     */  public Byte2CharAVLTreeMap(Map<? extends Byte, ? extends Character> m)
/*  144:     */  {
/*  145: 145 */    this();
/*  146: 146 */    putAll(m);
/*  147:     */  }
/*  148:     */  
/*  153:     */  public Byte2CharAVLTreeMap(SortedMap<Byte, Character> m)
/*  154:     */  {
/*  155: 155 */    this(m.comparator());
/*  156: 156 */    putAll(m);
/*  157:     */  }
/*  158:     */  
/*  163:     */  public Byte2CharAVLTreeMap(Byte2CharMap m)
/*  164:     */  {
/*  165: 165 */    this();
/*  166: 166 */    putAll(m);
/*  167:     */  }
/*  168:     */  
/*  173:     */  public Byte2CharAVLTreeMap(Byte2CharSortedMap m)
/*  174:     */  {
/*  175: 175 */    this(m.comparator());
/*  176: 176 */    putAll(m);
/*  177:     */  }
/*  178:     */  
/*  186:     */  public Byte2CharAVLTreeMap(byte[] k, char[] v, Comparator<? super Byte> c)
/*  187:     */  {
/*  188: 188 */    this(c);
...
/*  192:     */  }
/*  193:     */  
/*  199:     */  public Byte2CharAVLTreeMap(byte[] k, char[] v)
/*  200:     */  {
...
/*  273:     */  }
/*  274:     */  
/*  278:     */  public char put(byte k, char v)
/*  279:     */  {
...
/*  774:     */  }
/*  775:     */  
/*  777:     */  public Character put(Byte ok, Character ov)
/*  778:     */  {
/*  779: 779 */    char oldValue = put(ok.byteValue(), ov.charValue());
/*  780: 780 */    return this.modified ? null : Character.valueOf(oldValue);
/*  781:     */  }
/*  782:     */  
/*  786:     */  public Character remove(Object ok)
/*  787:     */  {
/*  788: 788 */    char oldValue = remove(((Byte)ok).byteValue());
...
/*  819:     */    implements Cloneable, Byte2CharMap.Entry
/*  820:     */  {
...
/* 1036:1036 */      Map.Entry<Byte, Character> e = (Map.Entry)o;
/* 1037:     */      
/* 1038:1038 */      return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Character)e.getValue()).charValue());
/* 1039:     */    }
/* 1040:     */    
...
/* 1116:     */  {
/* 1117:     */    Byte2CharAVLTreeMap.Entry prev;
/* 1118:     */    
/* 1120:     */    Byte2CharAVLTreeMap.Entry next;
/* 1121:     */    
/* 1122:     */    Byte2CharAVLTreeMap.Entry curr;
/* 1123:     */    
/* 1124:1124 */    int index = 0;
/* 1125:     */    
/* 1126:1126 */    TreeIterator() { this.next = Byte2CharAVLTreeMap.this.firstEntry; }
/* 1127:     */    
/* 1128:     */    TreeIterator(byte k) {
/* 1129:1129 */      if ((this.next = Byte2CharAVLTreeMap.this.locateKey(k)) != null)
/* 1130:1130 */        if (Byte2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1141:     */    
/* 1142:     */    Byte2CharAVLTreeMap.Entry nextEntry() {
...
/* 1151:     */    
/* 1152:     */    Byte2CharAVLTreeMap.Entry previousEntry() {
...
/* 1173:1173 */      Byte2CharAVLTreeMap.this.remove(this.curr.key);
...
/* 1189:     */    extends Byte2CharAVLTreeMap.TreeIterator
/* 1190:     */    implements ObjectListIterator<Byte2CharMap.Entry>
/* 1191:     */  {
/* 1192:1192 */    EntryIterator() { super(); }
/* 1193:     */    
/* 1194:1194 */    EntryIterator(byte k) { super(k); }
/* 1195:     */    
/* 1196:1196 */    public Byte2CharMap.Entry next() { return nextEntry(); }
/* 1197:1197 */    public Byte2CharMap.Entry previous() { return previousEntry(); }
/* 1198:1198 */    public void set(Byte2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1199:1199 */    public void add(Byte2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1200:     */  }
/* 1201:     */  
/* 1202:1202 */  public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1203:1203 */        final Comparator<? super Byte2CharMap.Entry> comparator = new Comparator() {
/* 1204:     */          public int compare(Byte2CharMap.Entry x, Byte2CharMap.Entry y) {
/* 1205:1205 */            return Byte2CharAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/* 1206:     */          }
/* 1207:     */        };
/* 1208:     */        
/* 1209:1209 */        public Comparator<? super Byte2CharMap.Entry> comparator() { return this.comparator; }
/* 1210:     */        
/* 1211:     */        public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator() {
/* 1212:1212 */          return new Byte2CharAVLTreeMap.EntryIterator(Byte2CharAVLTreeMap.this);
/* 1213:     */        }
/* 1214:     */        
/* 1215:1215 */        public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from) { return new Byte2CharAVLTreeMap.EntryIterator(Byte2CharAVLTreeMap.this, ((Byte)from.getKey()).byteValue()); }
/* 1216:     */        
/* 1217:     */        public boolean contains(Object o)
/* 1218:     */        {
/* 1219:1219 */          if (!(o instanceof Map.Entry)) return false;
/* 1220:1220 */          Map.Entry<Byte, Character> e = (Map.Entry)o;
/* 1221:1221 */          Byte2CharAVLTreeMap.Entry f = Byte2CharAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1222:1222 */          return e.equals(f);
/* 1223:     */        }
/* 1224:     */        
/* 1225:     */        public boolean remove(Object o) {
/* 1226:1226 */          if (!(o instanceof Map.Entry)) return false;
/* 1227:1227 */          Map.Entry<Byte, Character> e = (Map.Entry)o;
/* 1228:1228 */          Byte2CharAVLTreeMap.Entry f = Byte2CharAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1229:1229 */          if (f != null) Byte2CharAVLTreeMap.this.remove(f.key);
/* 1230:1230 */          return f != null; }
/* 1231:     */        
/* 1232:1232 */        public int size() { return Byte2CharAVLTreeMap.this.count; }
/* 1233:1233 */        public void clear() { Byte2CharAVLTreeMap.this.clear(); }
/* 1234:1234 */        public Byte2CharMap.Entry first() { return Byte2CharAVLTreeMap.this.firstEntry; }
/* 1235:1235 */        public Byte2CharMap.Entry last() { return Byte2CharAVLTreeMap.this.lastEntry; }
/* 1236:1236 */        public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry to) { return Byte2CharAVLTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2CharEntrySet(); }
/* 1237:1237 */        public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry to) { return Byte2CharAVLTreeMap.this.headMap((Byte)to.getKey()).byte2CharEntrySet(); }
/* 1238:1238 */        public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from) { return Byte2CharAVLTreeMap.this.tailMap((Byte)from.getKey()).byte2CharEntrySet(); }
/* 1239:     */      };
/* 1240:1240 */    return this.entries;
/* 1241:     */  }
/* 1242:     */  
/* 1245:     */  private final class KeyIterator
/* 1246:     */    extends Byte2CharAVLTreeMap.TreeIterator
...
/* 1259:     */  }
/* 1260:     */  
/* 1261:1261 */  private class KeySet extends AbstractByte2CharSortedMap.KeySet { private KeySet() { super(); }
/* 1262:1262 */    public ByteBidirectionalIterator iterator() { return new Byte2CharAVLTreeMap.KeyIterator(Byte2CharAVLTreeMap.this); }
/* 1263:1263 */    public ByteBidirectionalIterator iterator(byte from) { return new Byte2CharAVLTreeMap.KeyIterator(Byte2CharAVLTreeMap.this, from); }
/* 1264:     */  }
/* 1265:     */  
...
/* 1280:     */    extends Byte2CharAVLTreeMap.TreeIterator
...
/* 1304:1304 */          return new Byte2CharAVLTreeMap.ValueIterator(Byte2CharAVLTreeMap.this, null);
/* 1305:     */        }
/* 1306:     */        
/* 1307:1307 */        public boolean contains(char k) { return Byte2CharAVLTreeMap.this.containsValue(k); }
/* 1308:     */        
/* 1309:     */        public int size() {
/* 1310:1310 */          return Byte2CharAVLTreeMap.this.count;
/* 1311:     */        }
/* 1312:     */        
/* 1313:1313 */        public void clear() { Byte2CharAVLTreeMap.this.clear(); }
/* 1314:     */      };
/* 1315:     */    }
...
/* 1320:     */  
/* 1321:     */  public Byte2CharSortedMap headMap(byte to) {
/* 1322:1322 */    return new Submap((byte)0, true, to, false);
/* 1323:     */  }
/* 1324:     */  
/* 1325:1325 */  public Byte2CharSortedMap tailMap(byte from) { return new Submap(from, false, (byte)0, true); }
/* 1326:     */  
/* 1327:     */  public Byte2CharSortedMap subMap(byte from, byte to) {
/* 1328:1328 */    return new Submap(from, false, to, false);
/* 1329:     */  }
/* 1330:     */  
/* 1334:     */  private final class Submap
/* 1335:     */    extends AbstractByte2CharSortedMap
...
/* 1351:     */    boolean top;
/* 1352:     */    
/* 1354:     */    protected volatile transient ObjectSortedSet<Byte2CharMap.Entry> entries;
/* 1355:     */    
...
/* 1365:     */    {
/* 1366:1366 */      if ((!bottom) && (!top) && (Byte2CharAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367:1367 */      this.from = from;
/* 1368:1368 */      this.bottom = bottom;
/* 1369:1369 */      this.to = to;
/* 1370:1370 */      this.top = top;
/* 1371:1371 */      this.defRetValue = Byte2CharAVLTreeMap.this.defRetValue;
/* 1372:     */    }
/* 1373:     */    
...
/* 1384:     */    {
/* 1385:1385 */      return ((this.bottom) || (Byte2CharAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Byte2CharAVLTreeMap.this.compare(k, this.to) < 0));
/* 1386:     */    }
/* 1387:     */    
/* 1388:     */    public ObjectSortedSet<Byte2CharMap.Entry> byte2CharEntrySet() {
/* 1389:1389 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1390:     */          public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator() {
/* 1391:1391 */            return new Byte2CharAVLTreeMap.Submap.SubmapEntryIterator(Byte2CharAVLTreeMap.Submap.this);
/* 1392:     */          }
/* 1393:     */          
/* 1394:1394 */          public ObjectBidirectionalIterator<Byte2CharMap.Entry> iterator(Byte2CharMap.Entry from) { return new Byte2CharAVLTreeMap.Submap.SubmapEntryIterator(Byte2CharAVLTreeMap.Submap.this, ((Byte)from.getKey()).byteValue()); }
/* 1395:     */          
/* 1396:1396 */          public Comparator<? super Byte2CharMap.Entry> comparator() { return Byte2CharAVLTreeMap.this.entrySet().comparator(); }
/* 1397:     */          
/* 1398:     */          public boolean contains(Object o) {
/* 1399:1399 */            if (!(o instanceof Map.Entry)) return false;
/* 1400:1400 */            Map.Entry<Byte, Character> e = (Map.Entry)o;
/* 1401:1401 */            Byte2CharAVLTreeMap.Entry f = Byte2CharAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1402:1402 */            return (f != null) && (Byte2CharAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1403:     */          }
/* 1404:     */          
/* 1405:     */          public boolean remove(Object o) {
/* 1406:1406 */            if (!(o instanceof Map.Entry)) return false;
/* 1407:1407 */            Map.Entry<Byte, Character> e = (Map.Entry)o;
/* 1408:1408 */            Byte2CharAVLTreeMap.Entry f = Byte2CharAVLTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1409:1409 */            if ((f != null) && (Byte2CharAVLTreeMap.Submap.this.in(f.key))) Byte2CharAVLTreeMap.Submap.this.remove(f.key);
...
/* 1416:     */          }
/* 1417:     */          
/* 1418:1418 */          public boolean isEmpty() { return !new Byte2CharAVLTreeMap.Submap.SubmapIterator(Byte2CharAVLTreeMap.Submap.this).hasNext(); }
/* 1419:     */          
/* 1421:1421 */          public void clear() { Byte2CharAVLTreeMap.Submap.this.clear(); }
/* 1422:     */          
/* 1423:1423 */          public Byte2CharMap.Entry first() { return Byte2CharAVLTreeMap.Submap.this.firstEntry(); }
/* 1424:1424 */          public Byte2CharMap.Entry last() { return Byte2CharAVLTreeMap.Submap.this.lastEntry(); }
/* 1425:1425 */          public ObjectSortedSet<Byte2CharMap.Entry> subSet(Byte2CharMap.Entry from, Byte2CharMap.Entry to) { return Byte2CharAVLTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2CharEntrySet(); }
/* 1426:1426 */          public ObjectSortedSet<Byte2CharMap.Entry> headSet(Byte2CharMap.Entry to) { return Byte2CharAVLTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2CharEntrySet(); }
/* 1427:1427 */          public ObjectSortedSet<Byte2CharMap.Entry> tailSet(Byte2CharMap.Entry from) { return Byte2CharAVLTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2CharEntrySet(); }
/* 1428:     */        };
/* 1429:1429 */      return this.entries; }
/* 1430:     */    
/* 1431:1431 */    private class KeySet extends AbstractByte2CharSortedMap.KeySet { private KeySet() { super(); }
/* 1432:1432 */      public ByteBidirectionalIterator iterator() { return new Byte2CharAVLTreeMap.Submap.SubmapKeyIterator(Byte2CharAVLTreeMap.Submap.this); }
/* 1433:1433 */      public ByteBidirectionalIterator iterator(byte from) { return new Byte2CharAVLTreeMap.Submap.SubmapKeyIterator(Byte2CharAVLTreeMap.Submap.this, from); }
/* 1434:     */    }
/* 1435:     */    
...
/* 1442:1442 */            return new Byte2CharAVLTreeMap.Submap.SubmapValueIterator(Byte2CharAVLTreeMap.Submap.this, null);
/* 1443:     */          }
/* 1444:     */          
/* 1445:1445 */          public boolean contains(char k) { return Byte2CharAVLTreeMap.Submap.this.containsValue(k); }
/* 1446:     */          
/* 1447:     */          public int size() {
/* 1448:1448 */            return Byte2CharAVLTreeMap.Submap.this.size();
/* 1449:     */          }
/* 1450:     */          
/* 1451:1451 */          public void clear() { Byte2CharAVLTreeMap.Submap.this.clear(); }
/* 1452:     */        };
/* 1453:     */      }
/* 1454:1454 */      return this.values;
/* 1455:     */    }
/* 1456:     */    
/* 1458:1458 */    public boolean containsKey(byte k) { return (in(k)) && (Byte2CharAVLTreeMap.this.containsKey(k)); }
/* 1459:     */    
...
/* 1468:     */    }
/* 1469:     */    
/* 1470:     */    public char get(byte k)
/* 1471:     */    {
/* 1472:1472 */      byte kk = k;
/* 1473:1473 */      Byte2CharAVLTreeMap.Entry e; return (in(kk)) && ((e = Byte2CharAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1474:     */    }
/* 1475:     */    
/* 1476:1476 */    public char put(byte k, char v) { Byte2CharAVLTreeMap.this.modified = false;
...
/* 1478:1478 */      char oldValue = Byte2CharAVLTreeMap.this.put(k, v);
/* 1479:1479 */      return Byte2CharAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1480:     */    }
/* 1481:     */    
/* 1482:1482 */    public Character put(Byte ok, Character ov) { char oldValue = put(ok.byteValue(), ov.charValue());
/* 1483:1483 */      return Byte2CharAVLTreeMap.this.modified ? null : Character.valueOf(oldValue);
/* 1484:     */    }
/* 1485:     */    
/* 1486:     */    public char remove(byte k) {
/* 1487:1487 */      Byte2CharAVLTreeMap.this.modified = false;
/* 1488:1488 */      if (!in(k)) return this.defRetValue;
/* 1489:1489 */      char oldValue = Byte2CharAVLTreeMap.this.remove(k);
/* 1490:1490 */      return Byte2CharAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1491:     */    }
/* 1492:     */    
/* 1493:1493 */    public Character remove(Object ok) { char oldValue = remove(((Byte)ok).byteValue());
/* 1494:1494 */      return Byte2CharAVLTreeMap.this.modified ? Character.valueOf(oldValue) : null;
/* 1495:     */    }
/* 1496:     */    
...
/* 1507:     */    
/* 1509:1509 */    public ByteComparator comparator() { return Byte2CharAVLTreeMap.this.actualComparator; }
/* 1510:     */    
/* 1511:     */    public Byte2CharSortedMap headMap(byte to) {
/* 1512:1512 */      if (this.top) return new Submap(Byte2CharAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513:1513 */      return Byte2CharAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2CharAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1514:     */    }
/* 1515:     */    
/* 1516:1516 */    public Byte2CharSortedMap tailMap(byte from) { if (this.bottom) return new Submap(Byte2CharAVLTreeMap.this, from, false, this.to, this.top);
/* 1517:1517 */      return Byte2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2CharAVLTreeMap.this, from, false, this.to, this.top) : this;
/* 1518:     */    }
/* 1519:     */    
/* 1520:1520 */    public Byte2CharSortedMap subMap(byte from, byte to) { if ((this.top) && (this.bottom)) return new Submap(Byte2CharAVLTreeMap.this, from, false, to, false);
/* 1521:1521 */      if (!this.top) to = Byte2CharAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522:1522 */      if (!this.bottom) from = Byte2CharAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523:1523 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524:1524 */      return new Submap(Byte2CharAVLTreeMap.this, from, false, to, false);
/* 1525:     */    }
/* 1526:     */    
/* 1529:     */    public Byte2CharAVLTreeMap.Entry firstEntry()
/* 1530:     */    {
/* 1531:1531 */      if (Byte2CharAVLTreeMap.this.tree == null) return null;
/* 1532:     */      Byte2CharAVLTreeMap.Entry e;
/* 1533:     */      Byte2CharAVLTreeMap.Entry e;
/* 1534:1534 */      if (this.bottom) { e = Byte2CharAVLTreeMap.this.firstEntry;
/* 1535:     */      } else {
/* 1536:1536 */        e = Byte2CharAVLTreeMap.this.locateKey(this.from);
/* 1537:     */        
/* 1538:1538 */        if (Byte2CharAVLTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1539:     */        }
/* 1540:     */      }
/* 1541:1541 */      if ((e == null) || ((!this.top) && (Byte2CharAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542:1542 */      return e;
/* 1543:     */    }
/* 1544:     */    
/* 1547:     */    public Byte2CharAVLTreeMap.Entry lastEntry()
/* 1548:     */    {
/* 1549:1549 */      if (Byte2CharAVLTreeMap.this.tree == null) return null;
/* 1550:     */      Byte2CharAVLTreeMap.Entry e;
/* 1551:     */      Byte2CharAVLTreeMap.Entry e;
/* 1552:1552 */      if (this.top) { e = Byte2CharAVLTreeMap.this.lastEntry;
/* 1553:     */      } else {
/* 1554:1554 */        e = Byte2CharAVLTreeMap.this.locateKey(this.to);
/* 1555:     */        
/* 1556:1556 */        if (Byte2CharAVLTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1557:     */        }
/* 1558:     */      }
/* 1559:1559 */      if ((e == null) || ((!this.bottom) && (Byte2CharAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560:1560 */      return e;
/* 1561:     */    }
/* 1562:     */    
/* 1563:1563 */    public byte firstByteKey() { Byte2CharAVLTreeMap.Entry e = firstEntry();
/* 1564:1564 */      if (e == null) throw new NoSuchElementException();
/* 1565:1565 */      return e.key;
/* 1566:     */    }
/* 1567:     */    
/* 1568:1568 */    public byte lastByteKey() { Byte2CharAVLTreeMap.Entry e = lastEntry();
/* 1569:1569 */      if (e == null) throw new NoSuchElementException();
/* 1570:1570 */      return e.key;
/* 1571:     */    }
/* 1572:     */    
/* 1573:1573 */    public Byte firstKey() { Byte2CharAVLTreeMap.Entry e = firstEntry();
/* 1574:1574 */      if (e == null) throw new NoSuchElementException();
/* 1575:1575 */      return e.getKey();
/* 1576:     */    }
/* 1577:     */    
/* 1578:1578 */    public Byte lastKey() { Byte2CharAVLTreeMap.Entry e = lastEntry();
/* 1579:1579 */      if (e == null) throw new NoSuchElementException();
/* 1580:1580 */      return e.getKey();
/* 1581:     */    }
/* 1582:     */    
/* 1585:     */    private class SubmapIterator
/* 1586:     */      extends Byte2CharAVLTreeMap.TreeIterator
/* 1587:     */    {
/* 1588:     */      SubmapIterator()
/* 1589:     */      {
/* 1590:1590 */        super();
/* 1591:1591 */        this.next = Byte2CharAVLTreeMap.Submap.this.firstEntry();
/* 1592:     */      }
/* 1593:     */      
/* 1594:1594 */      SubmapIterator(byte k) { this();
/* 1595:1595 */        if (this.next != null)
/* 1596:1596 */          if ((!Byte2CharAVLTreeMap.Submap.this.bottom) && (Byte2CharAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597:1597 */          } else if ((!Byte2CharAVLTreeMap.Submap.this.top) && (Byte2CharAVLTreeMap.this.compare(k, (this.prev = Byte2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1598:     */          } else {
/* 1599:1599 */            this.next = Byte2CharAVLTreeMap.this.locateKey(k);
/* 1600:1600 */            if (Byte2CharAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610:1610 */        if ((!Byte2CharAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2CharAVLTreeMap.this.compare(this.prev.key, Byte2CharAVLTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1611:     */      }
/* 1612:     */      
/* 1613:1613 */      void updateNext() { this.next = this.next.next();
/* 1614:1614 */        if ((!Byte2CharAVLTreeMap.Submap.this.top) && (this.next != null) && (Byte2CharAVLTreeMap.this.compare(this.next.key, Byte2CharAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1615:     */      }
/* 1616:     */    }
/* 1617:     */    
/* 1618:1618 */    private class SubmapEntryIterator extends Byte2CharAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Byte2CharMap.Entry> { SubmapEntryIterator() { super(); }
/* 1619:     */      
/* 1620:1620 */      SubmapEntryIterator(byte k) { super(k); }
/* 1621:     */      
/* 1622:1622 */      public Byte2CharMap.Entry next() { return nextEntry(); }
/* 1623:1623 */      public Byte2CharMap.Entry previous() { return previousEntry(); }
/* 1624:1624 */      public void set(Byte2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1625:1625 */      public void add(Byte2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1626:     */    }
/* 1627:     */    
/* 1632:     */    private final class SubmapKeyIterator
/* 1633:     */      extends Byte2CharAVLTreeMap.Submap.SubmapIterator
...
/* 1652:     */      extends Byte2CharAVLTreeMap.Submap.SubmapIterator
...
/* 1665:     */  }
/* 1666:     */  
/* 1670:     */  public Byte2CharAVLTreeMap clone()
/* 1671:     */  {
/* 1672:     */    Byte2CharAVLTreeMap c;
/* 1673:     */    
/* 1675:     */    try
/* 1676:     */    {
/* 1677:1677 */      c = (Byte2CharAVLTreeMap)super.clone();
/* 1678:     */    }
...
/* 1748:     */  {
/* 1749:1749 */    if (n == 1) {
/* 1750:1750 */      Entry top = new Entry(s.readByte(), s.readChar());
...
/* 1755:1755 */    if (n == 2)
/* 1756:     */    {
/* 1758:1758 */      Entry top = new Entry(s.readByte(), s.readChar());
/* 1759:1759 */      top.right(new Entry(s.readByte(), s.readChar()));
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.bytes.Byte2CharAVLTreeMap
