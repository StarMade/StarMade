...
/*  18:    */
/*  90:    */public class Byte2FloatOpenCustomHashMap
/*  91:    */  extends AbstractByte2FloatMap
...
/* 104:    */  protected volatile transient Byte2FloatMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Byte2FloatOpenCustomHashMap(int expected, float f, ByteHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Byte2FloatOpenCustomHashMap(int expected, ByteHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Byte2FloatOpenCustomHashMap(ByteHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Byte2FloatOpenCustomHashMap(Map<? extends Byte, ? extends Float> m, float f, ByteHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Byte2FloatOpenCustomHashMap(Map<? extends Byte, ? extends Float> m, ByteHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Byte2FloatOpenCustomHashMap(Byte2FloatMap m, float f, ByteHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Byte2FloatOpenCustomHashMap(Byte2FloatMap m, ByteHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Byte2FloatOpenCustomHashMap(byte[] k, float[] v, float f, ByteHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Byte2FloatOpenCustomHashMap(byte[] k, float[] v, ByteHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public float put(byte k, float v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Float put(Byte ok, Float ov) { float v = ov.floatValue();
...
/* 246:    */  }
/* 247:    */  
/* 258:    */  public float add(byte k, float incr)
/* 259:    */  {
...
/* 299:    */  }
/* 300:    */  
/* 301:    */  public float remove(byte k)
/* 302:    */  {
...
/* 332:    */  }
/* 333:    */  
/* 334:334 */  public Float get(Byte ok) { byte k = ok.byteValue();
/* 335:    */    
...
/* 409:    */    implements Byte2FloatMap.Entry, Map.Entry<Byte, Float>
/* 410:    */  {
...
/* 416:    */    }
/* 417:    */    
/* 418:418 */    public Byte getKey() { return Byte.valueOf(Byte2FloatOpenCustomHashMap.this.key[this.index]); }
/* 419:    */    
/* 420:    */    public byte getByteKey() {
/* 421:421 */      return Byte2FloatOpenCustomHashMap.this.key[this.index];
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public Float getValue() { return Float.valueOf(Byte2FloatOpenCustomHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public float getFloatValue() { return Byte2FloatOpenCustomHashMap.this.value[this.index]; }
/* 428:    */    
/* 429:    */    public float setValue(float v) {
/* 430:430 */      float oldValue = Byte2FloatOpenCustomHashMap.this.value[this.index];
/* 431:431 */      Byte2FloatOpenCustomHashMap.this.value[this.index] = v;
...
/* 440:440 */      Map.Entry<Byte, Float> e = (Map.Entry)o;
/* 441:441 */      return (Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[this.index], ((Byte)e.getKey()).byteValue())) && (Byte2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/* 442:    */    }
/* 443:    */    
/* 444:444 */    public int hashCode() { return Byte2FloatOpenCustomHashMap.this.strategy.hashCode(Byte2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Byte2FloatOpenCustomHashMap.this.value[this.index]); }
/* 445:    */    
/* 447:447 */    public String toString() { return Byte2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Byte2FloatOpenCustomHashMap.this.value[this.index]; } }
/* 448:    */  
...
/* 453:    */    
/* 454:454 */    private MapIterator() { this.pos = Byte2FloatOpenCustomHashMap.this.n;
/* 455:    */      
/* 457:457 */      this.last = -1;
/* 458:    */      
/* 459:459 */      this.c = Byte2FloatOpenCustomHashMap.this.size;
/* 460:    */      
/* 464:464 */      boolean[] used = Byte2FloatOpenCustomHashMap.this.used;
...
/* 476:    */        
/* 477:477 */        int pos = HashCommon.murmurHash3(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2FloatOpenCustomHashMap.this.mask;
/* 478:    */        
/* 479:479 */        while (Byte2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 480:480 */          if (Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481:481 */          pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask;
/* 482:    */        }
/* 483:    */      }
/* 484:484 */      this.last = this.pos;
/* 485:    */      
/* 486:486 */      if (this.c != 0) {
/* 487:487 */        boolean[] used = Byte2FloatOpenCustomHashMap.this.used;
...
/* 502:    */      for (;;)
/* 503:    */      {
/* 504:504 */        pos = (last = pos) + 1 & Byte2FloatOpenCustomHashMap.this.mask;
/* 505:505 */        while (Byte2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 506:506 */          int slot = HashCommon.murmurHash3(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(Byte2FloatOpenCustomHashMap.this.key[pos])) & Byte2FloatOpenCustomHashMap.this.mask;
/* 507:507 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508:508 */          pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask;
/* 509:    */        }
/* 510:510 */        if (Byte2FloatOpenCustomHashMap.this.used[pos] == 0) break;
/* 511:511 */        if (pos < last)
/* 512:    */        {
/* 513:513 */          if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 514:514 */          this.wrapped.add(Byte2FloatOpenCustomHashMap.this.key[pos]);
/* 515:    */        }
/* 516:516 */        Byte2FloatOpenCustomHashMap.this.key[last] = Byte2FloatOpenCustomHashMap.this.key[pos];
/* 517:517 */        Byte2FloatOpenCustomHashMap.this.value[last] = Byte2FloatOpenCustomHashMap.this.value[pos];
/* 518:    */      }
/* 519:519 */      Byte2FloatOpenCustomHashMap.this.used[last] = false;
/* 520:520 */      return last;
/* 521:    */    }
/* 522:    */    
...
/* 526:    */      {
/* 527:527 */        Byte2FloatOpenCustomHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 528:528 */        this.last = -1;
/* 529:529 */        return;
/* 530:    */      }
/* 531:531 */      Byte2FloatOpenCustomHashMap.this.size -= 1;
...
/* 543:    */    } }
/* 544:    */  
/* 545:545 */  private class EntryIterator extends Byte2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2FloatMap.Entry> { private EntryIterator() { super(null); }
/* 546:    */    
/* 547:    */    private Byte2FloatOpenCustomHashMap.MapEntry entry;
/* 548:548 */    public Byte2FloatMap.Entry next() { return this.entry = new Byte2FloatOpenCustomHashMap.MapEntry(Byte2FloatOpenCustomHashMap.this, nextEntry()); }
/* 549:    */    
/* 550:    */    public void remove()
/* 551:    */    {
/* 552:552 */      super.remove();
/* 553:553 */      Byte2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 554:    */    } }
/* 555:    */  
/* 556:556 */  private class FastEntryIterator extends Byte2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Byte2FloatMap.Entry> { private FastEntryIterator() { super(null); }
/* 557:557 */    final AbstractByte2FloatMap.BasicEntry entry = new AbstractByte2FloatMap.BasicEntry((byte)0, 0.0F);
/* 558:    */    
/* 559:559 */    public AbstractByte2FloatMap.BasicEntry next() { int e = nextEntry();
/* 560:560 */      this.entry.key = Byte2FloatOpenCustomHashMap.this.key[e];
/* 561:561 */      this.entry.value = Byte2FloatOpenCustomHashMap.this.value[e];
/* 562:562 */      return this.entry;
/* 563:    */    } }
/* 564:    */  
/* 565:    */  private final class MapEntrySet extends AbstractObjectSet<Byte2FloatMap.Entry> implements Byte2FloatMap.FastEntrySet { private MapEntrySet() {}
/* 566:    */    
/* 567:567 */    public ObjectIterator<Byte2FloatMap.Entry> iterator() { return new Byte2FloatOpenCustomHashMap.EntryIterator(Byte2FloatOpenCustomHashMap.this, null); }
/* 568:    */    
/* 569:    */    public ObjectIterator<Byte2FloatMap.Entry> fastIterator() {
/* 570:570 */      return new Byte2FloatOpenCustomHashMap.FastEntryIterator(Byte2FloatOpenCustomHashMap.this, null);
/* 571:    */    }
/* 572:    */    
/* 573:    */    public boolean contains(Object o) {
/* 574:574 */      if (!(o instanceof Map.Entry)) return false;
/* 575:575 */      Map.Entry<Byte, Float> e = (Map.Entry)o;
/* 576:576 */      byte k = ((Byte)e.getKey()).byteValue();
/* 577:    */      
/* 578:578 */      int pos = HashCommon.murmurHash3(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2FloatOpenCustomHashMap.this.mask;
/* 579:    */      
/* 580:580 */      while (Byte2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 581:581 */        if (Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[pos], k)) return Byte2FloatOpenCustomHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 582:582 */        pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask;
/* 583:    */      }
...
/* 589:589 */      Map.Entry<Byte, Float> e = (Map.Entry)o;
/* 590:590 */      byte k = ((Byte)e.getKey()).byteValue();
/* 591:    */      
/* 592:592 */      int pos = HashCommon.murmurHash3(Byte2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Byte2FloatOpenCustomHashMap.this.mask;
/* 593:    */      
/* 594:594 */      while (Byte2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 595:595 */        if (Byte2FloatOpenCustomHashMap.this.strategy.equals(Byte2FloatOpenCustomHashMap.this.key[pos], k)) {
/* 596:596 */          Byte2FloatOpenCustomHashMap.this.remove(e.getKey());
/* 597:597 */          return true;
/* 598:    */        }
/* 599:599 */        pos = pos + 1 & Byte2FloatOpenCustomHashMap.this.mask;
/* 600:    */      }
/* 601:601 */      return false;
/* 602:    */    }
/* 603:    */    
/* 604:604 */    public int size() { return Byte2FloatOpenCustomHashMap.this.size; }
/* 605:    */    
/* 607:607 */    public void clear() { Byte2FloatOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
/* 610:    */  public Byte2FloatMap.FastEntrySet byte2FloatEntrySet() {
...
/* 618:    */    extends Byte2FloatOpenCustomHashMap.MapIterator
/* 619:    */    implements ByteIterator
/* 620:    */  {
/* 621:621 */    public KeyIterator() { super(null); }
/* 622:622 */    public byte nextByte() { return Byte2FloatOpenCustomHashMap.this.key[nextEntry()]; }
/* 623:623 */    public Byte next() { return Byte.valueOf(Byte2FloatOpenCustomHashMap.this.key[nextEntry()]); } }
/* 624:    */  
/* 625:    */  private final class KeySet extends AbstractByteSet { private KeySet() {}
/* 626:    */    
/* 627:627 */    public ByteIterator iterator() { return new Byte2FloatOpenCustomHashMap.KeyIterator(Byte2FloatOpenCustomHashMap.this); }
/* 628:    */    
/* 629:    */    public int size() {
/* 630:630 */      return Byte2FloatOpenCustomHashMap.this.size;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    public boolean contains(byte k) { return Byte2FloatOpenCustomHashMap.this.containsKey(k); }
/* 634:    */    
/* 635:    */    public boolean remove(byte k) {
/* 636:636 */      int oldSize = Byte2FloatOpenCustomHashMap.this.size;
/* 637:637 */      Byte2FloatOpenCustomHashMap.this.remove(k);
/* 638:638 */      return Byte2FloatOpenCustomHashMap.this.size != oldSize;
/* 639:    */    }
/* 640:    */    
/* 641:641 */    public void clear() { Byte2FloatOpenCustomHashMap.this.clear(); }
/* 642:    */  }
/* 643:    */  
...
/* 652:    */    extends Byte2FloatOpenCustomHashMap.MapIterator
/* 653:    */    implements FloatIterator
/* 654:    */  {
/* 655:655 */    public ValueIterator() { super(null); }
/* 656:656 */    public float nextFloat() { return Byte2FloatOpenCustomHashMap.this.value[nextEntry()]; }
/* 657:657 */    public Float next() { return Float.valueOf(Byte2FloatOpenCustomHashMap.this.value[nextEntry()]); }
/* 658:    */  }
/* 659:    */  
...
/* 662:662 */          return new Byte2FloatOpenCustomHashMap.ValueIterator(Byte2FloatOpenCustomHashMap.this);
/* 663:    */        }
/* 664:    */        
/* 665:665 */        public int size() { return Byte2FloatOpenCustomHashMap.this.size; }
/* 666:    */        
/* 667:    */        public boolean contains(float v) {
/* 668:668 */          return Byte2FloatOpenCustomHashMap.this.containsValue(v);
/* 669:    */        }
/* 670:    */        
/* 671:671 */        public void clear() { Byte2FloatOpenCustomHashMap.this.clear(); }
/* 672:    */      };
/* 673:    */    }
...
/* 774:    */  }
/* 775:    */  
/* 779:    */  public Byte2FloatOpenCustomHashMap clone()
/* 780:    */  {
/* 781:    */    Byte2FloatOpenCustomHashMap c;
/* 782:    */    
/* 784:    */    try
/* 785:    */    {
/* 786:786 */      c = (Byte2FloatOpenCustomHashMap)super.clone();
/* 787:    */    }
