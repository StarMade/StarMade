  ...
  implements ByteIndirectPriorityQueue
{
  ...
  protected int size;
  protected ByteComparator field_69;
  
  public ByteHeapSemiIndirectPriorityQueue(byte[] refArray, int capacity, ByteComparator local_c)
  {
    if (capacity > 0) {
  ...
  public ByteHeapSemiIndirectPriorityQueue(byte[] refArray, ByteComparator local_c)
  {
  ...
  public ByteHeapSemiIndirectPriorityQueue(byte[] refArray, int[] local_a, int size, ByteComparator local_c)
  {
    this(refArray, 0, local_c);
    this.heap = local_a;
    this.size = size;
    ByteSemiIndirectHeaps.makeHeap(refArray, local_a, size, local_c);
  }
  
  public ByteHeapSemiIndirectPriorityQueue(byte[] refArray, int[] local_a, ByteComparator local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public ByteHeapSemiIndirectPriorityQueue(byte[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public ByteHeapSemiIndirectPriorityQueue(byte[] refArray, int[] local_a)
  {
  ...
  public void enqueue(int local_x)
  {
    ...
    ByteSemiIndirectHeaps.upHeap(this.refArray, this.heap, this.size, this.size - 1, this.field_69);
  }
  ...
  public int dequeue()
  {
    ...
    if (this.size != 0) {
      ByteSemiIndirectHeaps.downHeap(this.refArray, this.heap, this.size, 0, this.field_69);
    }
    return result;
  }
  ...
  {
    ByteSemiIndirectHeaps.makeHeap(this.refArray, this.heap, this.size, this.field_69);
  }
  ...
  {
    return ByteSemiIndirectHeaps.front(this.refArray, this.heap, this.size, local_a);
  }
