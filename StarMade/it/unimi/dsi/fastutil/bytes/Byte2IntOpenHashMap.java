...
/*     */ 
/*     */ public class Byte2IntOpenHashMap extends AbstractByte2IntMap
...
/* 642 */           return new Byte2IntOpenHashMap.ValueIterator(Byte2IntOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Byte2IntOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(int v) {
/* 648 */           return Byte2IntOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Byte2IntOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Byte2IntOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Byte2IntOpenHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public int nextInt() { return Byte2IntOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Integer next() { return Integer.valueOf(Byte2IntOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Byte2IntOpenHashMap.KeyIterator(Byte2IntOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Byte2IntOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(byte k) {
/* 613 */       return Byte2IntOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(byte k) {
/* 616 */       int oldSize = Byte2IntOpenHashMap.this.size;
/* 617 */       Byte2IntOpenHashMap.this.remove(k);
/* 618 */       return Byte2IntOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Byte2IntOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Byte2IntOpenHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public byte nextByte() { return Byte2IntOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Byte next() { return Byte.valueOf(Byte2IntOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Byte2IntOpenHashMap.EntryIterator(Byte2IntOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Byte2IntMap.Entry> fastIterator() {
/* 550 */       return new Byte2IntOpenHashMap.FastEntryIterator(Byte2IntOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Byte2IntOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Byte2IntOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Byte2IntOpenHashMap.this.key[pos] == k) return Byte2IntOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 562 */         pos = pos + 1 & Byte2IntOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Byte2IntOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Byte2IntOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Byte2IntOpenHashMap.this.key[pos] == k) {
/* 576 */           Byte2IntOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Byte2IntOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Byte2IntOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Byte2IntOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Byte2IntOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2IntMap.Entry>
/*     */   {
/* 537 */     final AbstractByte2IntMap.BasicEntry entry = new AbstractByte2IntMap.BasicEntry((byte)0, 0);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Byte2IntOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Byte2IntOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Byte2IntOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Byte2IntMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Byte2IntOpenHashMap.MapEntry(Byte2IntOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Byte2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Byte2IntOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Byte2IntOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Byte2IntOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Byte2IntOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Byte2IntOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Byte2IntOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Byte2IntOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Byte2IntOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Byte2IntOpenHashMap.this.mask;
/* 485 */         while (Byte2IntOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Byte2IntOpenHashMap.this.key[pos]) & Byte2IntOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Byte2IntOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Byte2IntOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new ByteArrayList();
/* 494 */           this.wrapped.add(Byte2IntOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Byte2IntOpenHashMap.this.key[last] = Byte2IntOpenHashMap.this.key[pos];
/* 497 */         Byte2IntOpenHashMap.this.value[last] = Byte2IntOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Byte2IntOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Byte2IntOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Byte2IntOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Byte getKey() {
/* 398 */       return Byte.valueOf(Byte2IntOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public byte getByteKey() {
/* 401 */       return Byte2IntOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Integer getValue() {
/* 404 */       return Integer.valueOf(Byte2IntOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public int getIntValue() {
/* 407 */       return Byte2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public int setValue(int v) {
/* 410 */       int oldValue = Byte2IntOpenHashMap.this.value[this.index];
/* 411 */       Byte2IntOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
...
/* 421 */       return (Byte2IntOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2IntOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Byte2IntOpenHashMap.this.key[this.index] ^ Byte2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 427 */       return Byte2IntOpenHashMap.this.key[this.index] + "=>" + Byte2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
