  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Byte2IntOpenHashMap(int expected, float local_f)
  {
  ...
  public Byte2IntOpenHashMap(Map<? extends Byte, ? extends Integer> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2IntOpenHashMap(Map<? extends Byte, ? extends Integer> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2IntOpenHashMap(Byte2IntMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Byte2IntOpenHashMap(Byte2IntMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Byte2IntOpenHashMap(byte[] local_k, int[] local_v, float local_f)
  {
  ...
  public Byte2IntOpenHashMap(byte[] local_k, int[] local_v)
  {
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Byte2IntOpenHashMap.ValueIterator(Byte2IntOpenHashMap.this);
        }
        ...
        {
          return Byte2IntOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Byte2IntOpenHashMap local_c;
    try
    {
      local_c = (Byte2IntOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Byte2IntOpenHashMap.MapIterator
    ...
    extends AbstractByteSet
  {
    ...
    {
      return new Byte2IntOpenHashMap.KeyIterator(Byte2IntOpenHashMap.this);
    }
    ...
    {
      return Byte2IntOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(byte local_k)
    {
      int oldSize = Byte2IntOpenHashMap.this.size;
      Byte2IntOpenHashMap.this.remove(local_k);
    ...
    implements Byte2IntMap.FastEntrySet
  {
    ...
    {
      return new Byte2IntOpenHashMap.EntryIterator(Byte2IntOpenHashMap.this, null);
    }
    
    public ObjectIterator<Byte2IntMap.Entry> fastIterator()
    {
      return new Byte2IntOpenHashMap.FastEntryIterator(Byte2IntOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2IntOpenHashMap.this.mask; Byte2IntOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2IntOpenHashMap.this.mask) {
        if (Byte2IntOpenHashMap.this.key[pos] == local_k) {
          return Byte2IntOpenHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Byte2IntOpenHashMap.this.mask; Byte2IntOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2IntOpenHashMap.this.mask) {
        if (Byte2IntOpenHashMap.this.key[pos] == local_k)
        {
          Byte2IntOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Byte2IntMap.Entry>
  {
    ...
    public AbstractByte2IntMap.BasicEntry next()
    {
      ...
      this.entry.key = Byte2IntOpenHashMap.this.key[local_e];
      this.entry.value = Byte2IntOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Byte2IntMap.Entry>
  {
    ...
    {
      return this.entry = new Byte2IntOpenHashMap.MapEntry(Byte2IntOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Byte2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Byte2IntOpenHashMap.this.field_49;
    int last = -1;
    int field_1793 = Byte2IntOpenHashMap.this.size;
    ByteArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Byte2IntOpenHashMap.this.used;
      while ((this.field_1793 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1793 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1793 != 0)
      {
        boolean[] local_k = Byte2IntOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Byte2IntOpenHashMap.this.mask; Byte2IntOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Byte2IntOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Byte2IntOpenHashMap.this.key[pos]) & Byte2IntOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Byte2IntOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Byte2IntOpenHashMap.this.key[pos]);
        }
        Byte2IntOpenHashMap.this.key[last] = Byte2IntOpenHashMap.this.key[pos];
        Byte2IntOpenHashMap.this.value[last] = Byte2IntOpenHashMap.this.value[pos];
      }
      Byte2IntOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Byte2IntOpenHashMap.this.remove(this.wrapped.getByte(-this.pos - 2));
        this.last = -1;
        return;
      }
      Byte2IntOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1793 > 0))
      {
        this.field_1793 += 1;
        nextEntry();
      }
    ...
    implements Byte2IntMap.Entry, Map.Entry<Byte, Integer>
  {
    ...
    public int setValue(int local_v)
    {
      ...
      Byte2IntOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Byte, Integer> local_e = (Map.Entry)local_o;
      return (Byte2IntOpenHashMap.this.key[this.index] == ((Byte)local_e.getKey()).byteValue()) && (Byte2IntOpenHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
