...
/*     */   {
/* 200 */     return new Singleton(key.byteValue(), value.charValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Byte2CharMap.Entry> byte2CharEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.byte2CharEntrySet()); return this.entries; } 
...
/* 335 */     public char get(byte k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Byte, Character>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Byte, ? extends Character> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Byte2CharMap.Entry> byte2CharEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.byte2CharEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public char get(byte k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Byte, Character>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Byte2CharMap.Entry> byte2CharEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/*     */       public Byte getKey()
/*     */       {
/* 131 */         return Byte.valueOf(Byte2CharMaps.Singleton.this.key); } 
/* 132 */       public Character getValue() { return Character.valueOf(Byte2CharMaps.Singleton.this.value); }
/*     */ 
/*     */       public byte getByteKey() {
/* 135 */         return Byte2CharMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public char getCharValue() {
/* 139 */         return Byte2CharMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Byte2CharMaps.Singleton.this.key == ((Byte)e.getKey()).byteValue()) && (Byte2CharMaps.Singleton.this.value == ((Character)e.getValue()).charValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return Byte2CharMaps.Singleton.this.key ^ Byte2CharMaps.Singleton.this.value; } 
/* 153 */       public String toString() { return Byte2CharMaps.Singleton.this.key + "->" + Byte2CharMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Byte, ? extends Character> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Byte2CharMap.Entry> byte2CharEntrySet() {
...
/*  76 */     private Object readResolve() { return Byte2CharMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Byte2CharMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Byte, Character>> entrySet() {
/*  80 */       return byte2CharEntrySet();
/*     */     }
