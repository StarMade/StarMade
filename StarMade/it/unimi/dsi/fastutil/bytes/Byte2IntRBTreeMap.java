...
/*      */ 
/*      */ public class Byte2IntRBTreeMap extends AbstractByte2IntSortedMap
...
/*  119 */           return Byte2IntRBTreeMap.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  122 */           return Byte2IntRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     int oldValue = put(ok.byteValue(), ov.intValue());
/*  731 */     return this.modified ? null : Integer.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Integer remove(Object ok)
/*      */   {
/*  737 */     int oldValue = remove(((Byte)ok).byteValue());
...
/* 1141 */         final Comparator<? super Byte2IntMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Byte2IntMap.Entry x, Byte2IntMap.Entry y) {
/* 1143 */             return Byte2IntRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Byte2IntRBTreeMap.EntryIterator(Byte2IntRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry from) {
/* 1153 */           return new Byte2IntRBTreeMap.EntryIterator(Byte2IntRBTreeMap.this, ((Byte)from.getKey()).byteValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Byte2IntRBTreeMap.Entry f = Byte2IntRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
...
/* 1166 */           Byte2IntRBTreeMap.Entry f = Byte2IntRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1167 */           if (f != null) Byte2IntRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Byte2IntRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Byte2IntRBTreeMap.this.clear(); } 
/* 1172 */         public Byte2IntMap.Entry first() { return Byte2IntRBTreeMap.this.firstEntry; } 
/* 1173 */         public Byte2IntMap.Entry last() { return Byte2IntRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry from, Byte2IntMap.Entry to) { return Byte2IntRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2IntEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry to) { return Byte2IntRBTreeMap.this.headMap((Byte)to.getKey()).byte2IntEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry from) { return Byte2IntRBTreeMap.this.tailMap((Byte)from.getKey()).byte2IntEntrySet(); }
/*      */       };
...
/* 1242 */           return new Byte2IntRBTreeMap.ValueIterator(Byte2IntRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(int k) {
/* 1245 */           return Byte2IntRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Byte2IntRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Byte2IntRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Byte2IntRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readByte(), s.readInt());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readByte(), s.readInt());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readByte(), s.readInt()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Byte2IntRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Byte2IntRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator() {
/* 1329 */             return new Byte2IntRBTreeMap.Submap.SubmapEntryIterator(Byte2IntRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry from) {
/* 1332 */             return new Byte2IntRBTreeMap.Submap.SubmapEntryIterator(Byte2IntRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
/*      */           }
/* 1334 */           public Comparator<? super Byte2IntMap.Entry> comparator() { return Byte2IntRBTreeMap.this.byte2IntEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Byte2IntRBTreeMap.Entry f = Byte2IntRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1340 */             return (f != null) && (Byte2IntRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Byte2IntRBTreeMap.Entry f = Byte2IntRBTreeMap.this.findKey(((Byte)e.getKey()).byteValue());
/* 1347 */             if ((f != null) && (Byte2IntRBTreeMap.Submap.this.in(f.key))) Byte2IntRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Byte2IntRBTreeMap.Submap.SubmapIterator(Byte2IntRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Byte2IntRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Byte2IntMap.Entry first() { return Byte2IntRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Byte2IntMap.Entry last() { return Byte2IntRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry from, Byte2IntMap.Entry to) { return Byte2IntRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)to.getKey()).byte2IntEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry to) { return Byte2IntRBTreeMap.Submap.this.headMap((Byte)to.getKey()).byte2IntEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry from) { return Byte2IntRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2IntEntrySet(); }
/*      */         };
...
/*      */           public IntIterator iterator() {
/* 1376 */             return new Byte2IntRBTreeMap.Submap.SubmapValueIterator(Byte2IntRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(int k) {
/* 1379 */             return Byte2IntRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Byte2IntRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Byte2IntRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(byte k) {
/* 1392 */       return (in(k)) && (Byte2IntRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(int v) {
...
/* 1407 */       return (in(kk)) && ((e = Byte2IntRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public int put(byte k, int v) {
/* 1410 */       Byte2IntRBTreeMap.this.modified = false;
...
/* 1412 */       int oldValue = Byte2IntRBTreeMap.this.put(k, v);
/* 1413 */       return Byte2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Integer put(Byte ok, Integer ov) {
/* 1416 */       int oldValue = put(ok.byteValue(), ov.intValue());
/* 1417 */       return Byte2IntRBTreeMap.this.modified ? null : Integer.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public int remove(byte k) {
/* 1421 */       Byte2IntRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       int oldValue = Byte2IntRBTreeMap.this.remove(k);
/* 1424 */       return Byte2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Integer remove(Object ok) {
/* 1427 */       int oldValue = remove(((Byte)ok).byteValue());
/* 1428 */       return Byte2IntRBTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1443 */       return Byte2IntRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Byte2IntSortedMap headMap(byte to) {
/* 1446 */       if (this.top) return new Submap(Byte2IntRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Byte2IntRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Byte2IntRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Byte2IntSortedMap tailMap(byte from) {
/* 1450 */       if (this.bottom) return new Submap(Byte2IntRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Byte2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2IntRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Byte2IntSortedMap subMap(byte from, byte to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Byte2IntRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Byte2IntRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Byte2IntRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Byte2IntRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Byte2IntRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Byte2IntRBTreeMap.this.tree == null) return null;
/* 1468 */       Byte2IntRBTreeMap.Entry e;
/*      */       Byte2IntRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Byte2IntRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Byte2IntRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Byte2IntRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Byte2IntRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Byte2IntRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Byte2IntRBTreeMap.this.tree == null) return null;
/* 1486 */       Byte2IntRBTreeMap.Entry e;
/*      */       Byte2IntRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Byte2IntRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Byte2IntRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Byte2IntRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Byte2IntRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public byte firstByteKey() {
/* 1497 */       Byte2IntRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public byte lastByteKey() {
/* 1502 */       Byte2IntRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Byte firstKey() {
/* 1507 */       Byte2IntRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Byte lastKey() {
/* 1512 */       Byte2IntRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Byte2IntRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Byte2IntRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Byte2IntRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Byte2IntMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Byte2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Byte2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Byte2IntRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(byte k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Byte2IntRBTreeMap.Submap.this.bottom) && (Byte2IntRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Byte2IntRBTreeMap.Submap.this.top) && (Byte2IntRBTreeMap.this.compare(k, (this.prev = Byte2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Byte2IntRBTreeMap.this.locateKey(k);
/* 1534 */             if (Byte2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Byte2IntRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2IntRBTreeMap.this.compare(this.prev.key, Byte2IntRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Byte2IntRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2IntRBTreeMap.this.compare(this.next.key, Byte2IntRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public ByteBidirectionalIterator iterator() { return new Byte2IntRBTreeMap.Submap.SubmapKeyIterator(Byte2IntRBTreeMap.Submap.this); } 
/* 1367 */       public ByteBidirectionalIterator iterator(byte from) { return new Byte2IntRBTreeMap.Submap.SubmapKeyIterator(Byte2IntRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2IntRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public ByteBidirectionalIterator iterator() { return new Byte2IntRBTreeMap.KeyIterator(Byte2IntRBTreeMap.this); } 
/* 1201 */     public ByteBidirectionalIterator iterator(byte from) { return new Byte2IntRBTreeMap.KeyIterator(Byte2IntRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2IntRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2IntRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Byte2IntMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Byte2IntMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Byte2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Byte2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Byte2IntRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(byte k) {
/* 1067 */       if ((this.next = Byte2IntRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Byte2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Byte2IntRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Byte)e.getKey()).byteValue()) && (this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
