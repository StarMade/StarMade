  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2IntRBTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2IntRBTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2IntRBTreeMap(Map<? extends Byte, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2IntRBTreeMap(SortedMap<Byte, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2IntRBTreeMap(Byte2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2IntRBTreeMap(Byte2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2IntRBTreeMap(byte[] local_k, int[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2IntRBTreeMap(byte[] local_k, int[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Byte2IntMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Byte2IntRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2IntRBTreeMap.EntryIterator(Byte2IntRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry from)
        {
          return new Byte2IntRBTreeMap.EntryIterator(Byte2IntRBTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2IntRBTreeMap.Entry local_f = Byte2IntRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2IntRBTreeMap.Entry local_f = Byte2IntRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2IntRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Byte2IntRBTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2IntEntrySet();
        }
        
        public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry local_to)
        {
          return Byte2IntRBTreeMap.this.headMap((Byte)local_to.getKey()).byte2IntEntrySet();
        }
        
        public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry from)
        {
          return Byte2IntRBTreeMap.this.tailMap((Byte)from.getKey()).byte2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Byte2IntRBTreeMap.ValueIterator(Byte2IntRBTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Byte2IntRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2IntRBTreeMap local_c;
    try
    {
      local_c = (Byte2IntRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2IntRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2IntRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2IntRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2IntMap.Entry> byte2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator()
          {
            return new Byte2IntRBTreeMap.Submap.SubmapEntryIterator(Byte2IntRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2IntMap.Entry> iterator(Byte2IntMap.Entry from)
          {
            return new Byte2IntRBTreeMap.Submap.SubmapEntryIterator(Byte2IntRBTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Integer> local_e = (Map.Entry)local_o;
            Byte2IntRBTreeMap.Entry local_f = Byte2IntRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2IntRBTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Integer> local_e = (Map.Entry)local_o;
            Byte2IntRBTreeMap.Entry local_f = Byte2IntRBTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2IntRBTreeMap.Submap.this.in3(local_f.key))) {
              Byte2IntRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2IntRBTreeMap.Submap.SubmapIterator(Byte2IntRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2IntRBTreeMap.Submap.this.clear();
          }
          
          public Byte2IntMap.Entry first()
          {
            return Byte2IntRBTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2IntMap.Entry last()
          {
            return Byte2IntRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2IntMap.Entry> subSet(Byte2IntMap.Entry from, Byte2IntMap.Entry local_to)
          {
            return Byte2IntRBTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2IntEntrySet();
          }
          
          public ObjectSortedSet<Byte2IntMap.Entry> headSet(Byte2IntMap.Entry local_to)
          {
            return Byte2IntRBTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2IntEntrySet();
          }
          
          public ObjectSortedSet<Byte2IntMap.Entry> tailSet(Byte2IntMap.Entry from)
          {
            return Byte2IntRBTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Byte2IntRBTreeMap.Submap.SubmapValueIterator(Byte2IntRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Byte2IntRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2IntRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2IntRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2IntRBTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2IntRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(byte local_k, int local_v)
    {
      ...
      int oldValue = Byte2IntRBTreeMap.this.put(local_k, local_v);
    ...
    public int remove(byte local_k)
    {
      ...
      int oldValue = Byte2IntRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2IntRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2IntRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2IntSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2IntRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2IntRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2IntSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2IntRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2IntRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2IntRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2IntRBTreeMap.this.locateKey(this.from);
        if (Byte2IntRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2IntRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2IntRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2IntRBTreeMap.this.locateKey(this.field_47);
        if (Byte2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2IntRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2IntRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2IntRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2IntRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2IntRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2IntRBTreeMap.Submap.this.bottom) && (Byte2IntRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2IntRBTreeMap.Submap.this.top) && (Byte2IntRBTreeMap.this.compare(local_k, (this.prev = Byte2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2IntRBTreeMap.this.locateKey(local_k);
            if (Byte2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2IntRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2IntRBTreeMap.this.compare(this.prev.key, Byte2IntRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2IntRBTreeMap.Submap.this.top) && (this.next != null) && (Byte2IntRBTreeMap.this.compare(this.next.key, Byte2IntRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2IntSortedMap.KeySet
    {
      ...
      {
        return new Byte2IntRBTreeMap.Submap.SubmapKeyIterator(Byte2IntRBTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2IntRBTreeMap.Submap.SubmapKeyIterator(Byte2IntRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2IntSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2IntRBTreeMap.KeyIterator(Byte2IntRBTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2IntRBTreeMap.KeyIterator(Byte2IntRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2IntRBTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
