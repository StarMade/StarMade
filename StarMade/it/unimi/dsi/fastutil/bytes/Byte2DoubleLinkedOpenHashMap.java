...
/*      */   }
/*      */ 
/*      */   public double add(byte k, double incr)
/*      */   {
...
/*  786 */   public Byte2DoubleSortedMap tailMap(byte from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Byte2DoubleSortedMap headMap(byte to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Byte2DoubleSortedMap subMap(byte from, byte to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Byte2DoubleLinkedOpenHashMap.ValueIterator(Byte2DoubleLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Byte2DoubleLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(double v) {
/* 1113 */           return Byte2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Byte2DoubleLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Byte2DoubleLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Byte2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public double previousDouble()
/*      */     {
/* 1094 */       return Byte2DoubleLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Double previous() { return Double.valueOf(Byte2DoubleLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public double nextDouble() { return Byte2DoubleLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Double next() { return Double.valueOf(Byte2DoubleLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Byte2DoubleLinkedOpenHashMap.KeyIterator(Byte2DoubleLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ByteListIterator iterator() {
/* 1054 */       return new Byte2DoubleLinkedOpenHashMap.KeyIterator(Byte2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Byte2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(byte k) {
/* 1060 */       return Byte2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(byte k) {
/* 1063 */       int oldSize = Byte2DoubleLinkedOpenHashMap.this.size;
/* 1064 */       Byte2DoubleLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Byte2DoubleLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Byte2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public byte firstByte() {
/* 1071 */       if (Byte2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Byte2DoubleLinkedOpenHashMap.this.key[Byte2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public byte lastByte() {
/* 1075 */       if (Byte2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Byte2DoubleLinkedOpenHashMap.this.key[Byte2DoubleLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Byte2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public KeyIterator(byte k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public byte previousByte() { return Byte2DoubleLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Byte previous() { return Byte.valueOf(Byte2DoubleLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public byte nextByte() { return Byte2DoubleLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Byte next() { return Byte.valueOf(Byte2DoubleLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Byte2DoubleLinkedOpenHashMap.EntryIterator(Byte2DoubleLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Byte2DoubleMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry fromElement, Byte2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Byte2DoubleMap.Entry first() {
/*  973 */       if (Byte2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Byte2DoubleLinkedOpenHashMap.MapEntry(Byte2DoubleLinkedOpenHashMap.this, Byte2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Byte2DoubleMap.Entry last() {
/*  977 */       if (Byte2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Byte2DoubleLinkedOpenHashMap.MapEntry(Byte2DoubleLinkedOpenHashMap.this, Byte2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Byte2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Byte2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Byte2DoubleLinkedOpenHashMap.this.key[pos] == k) return Byte2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/*  990 */         pos = pos + 1 & Byte2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Byte2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Byte2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Byte2DoubleLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Byte2DoubleLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Byte2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Byte2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Byte2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry from) {
/* 1018 */       return new Byte2DoubleLinkedOpenHashMap.EntryIterator(Byte2DoubleLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> fastIterator() {
/* 1021 */       return new Byte2DoubleLinkedOpenHashMap.FastEntryIterator(Byte2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> fastIterator(Byte2DoubleMap.Entry from) {
/* 1024 */       return new Byte2DoubleLinkedOpenHashMap.FastEntryIterator(Byte2DoubleLinkedOpenHashMap.this, ((Byte)from.getKey()).byteValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Byte2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Byte2DoubleMap.Entry>
/*      */   {
/*  944 */     final AbstractByte2DoubleMap.BasicEntry entry = new AbstractByte2DoubleMap.BasicEntry((byte)0, 0.0D);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Byte2DoubleLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Byte2DoubleLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractByte2DoubleMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Byte2DoubleLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Byte2DoubleLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Byte2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Byte2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Byte2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Byte2DoubleMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Byte2DoubleLinkedOpenHashMap.MapEntry(Byte2DoubleLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Byte2DoubleLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Byte2DoubleLinkedOpenHashMap.MapEntry(Byte2DoubleLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Byte2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Byte2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Byte2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Byte2DoubleLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(byte from) {
/*  809 */       if (Byte2DoubleLinkedOpenHashMap.this.key[Byte2DoubleLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Byte2DoubleLinkedOpenHashMap.this.last;
/*  811 */         this.index = Byte2DoubleLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Byte2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Byte2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Byte2DoubleLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Byte2DoubleLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Byte2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Byte2DoubleLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Byte2DoubleLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Byte2DoubleLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Byte2DoubleLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Byte2DoubleLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Byte2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Byte2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Byte2DoubleLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Byte2DoubleLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Byte2DoubleLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Byte2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Byte2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Byte2DoubleLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Byte2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Byte2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Byte2DoubleLinkedOpenHashMap.this.mask;
/*  897 */         while (Byte2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Byte2DoubleLinkedOpenHashMap.this.key[pos]) & Byte2DoubleLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Byte2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Byte2DoubleLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Byte2DoubleLinkedOpenHashMap.this.key[last] = Byte2DoubleLinkedOpenHashMap.this.key[pos];
/*  904 */         Byte2DoubleLinkedOpenHashMap.this.value[last] = Byte2DoubleLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Byte2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Byte2DoubleLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Byte getKey() {
/*  669 */       return Byte.valueOf(Byte2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public byte getByteKey() {
/*  672 */       return Byte2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Double getValue() {
/*  675 */       return Double.valueOf(Byte2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public double getDoubleValue() {
/*  678 */       return Byte2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public double setValue(double v) {
/*  681 */       double oldValue = Byte2DoubleLinkedOpenHashMap.this.value[this.index];
/*  682 */       Byte2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Double setValue(Double v) {
...
/*  692 */       return (Byte2DoubleLinkedOpenHashMap.this.key[this.index] == ((Byte)e.getKey()).byteValue()) && (Byte2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Byte2DoubleLinkedOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Byte2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Byte2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Byte2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
