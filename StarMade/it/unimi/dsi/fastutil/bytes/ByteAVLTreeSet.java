...
/*      */ 
/*      */ public class ByteAVLTreeSet extends AbstractByteSortedSet
...
/*   97 */           return ByteAVLTreeSet.this.storedComparator.compare(Byte.valueOf(k1), Byte.valueOf(k2));
/*      */         }
/*      */         public int compare(Byte ok1, Byte ok2) {
/*  100 */           return ByteAVLTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   public ByteAVLTreeSet(Iterator<? extends Byte> i)
/*      */   {
...
/* 1086 */     return new Subset((byte)0, true, to, false);
/*      */   }
/*      */   public ByteSortedSet tailSet(byte from) {
/* 1089 */     return new Subset(from, false, (byte)0, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1284 */       c = (ByteAVLTreeSet)super.clone();
/*      */     }
...
/* 1337 */     while (n-- != 0) s.writeByte(i.nextByte());
/*      */   }
/*      */ 
...
/*      */   {
/* 1348 */     if (n == 1) {
/* 1349 */       Entry top = new Entry(s.readByte());
/* 1350 */       top.pred(pred);
/* 1351 */       top.succ(succ);
/* 1352 */       return top;
/*      */     }
/* 1354 */     if (n == 2)
/*      */     {
/* 1357 */       Entry top = new Entry(s.readByte());
/* 1358 */       top.right(new Entry(s.readByte()));
...
/*      */     {
/* 1121 */       if ((!bottom) && (!top) && (ByteAVLTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1122 */       this.from = from;
...
/*      */     {
/* 1139 */       return ((this.bottom) || (ByteAVLTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (ByteAVLTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(byte k)
/*      */     {
/* 1144 */       return (in(k)) && (ByteAVLTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(byte k) {
...
/* 1148 */       return ByteAVLTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(byte k) {
/* 1152 */       if (!in(k)) return false;
/* 1153 */       return ByteAVLTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ByteComparator comparator() {
/* 1168 */       return ByteAVLTreeSet.this.actualComparator;
/*      */     }
/*      */     public ByteBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public ByteSortedSet headSet(byte to) {
/* 1177 */       if (this.top) return new Subset(ByteAVLTreeSet.this, this.from, this.bottom, to, false);
/* 1178 */       return ByteAVLTreeSet.this.compare(to, this.to) < 0 ? new Subset(ByteAVLTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public ByteSortedSet tailSet(byte from) {
/* 1181 */       if (this.bottom) return new Subset(ByteAVLTreeSet.this, from, false, this.to, this.top);
/* 1182 */       return ByteAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(ByteAVLTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public ByteSortedSet subSet(byte from, byte to) {
/* 1185 */       if ((this.top) && (this.bottom)) return new Subset(ByteAVLTreeSet.this, from, false, to, false);
/* 1186 */       if (!this.top) to = ByteAVLTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1187 */       if (!this.bottom) from = ByteAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1188 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1189 */       return new Subset(ByteAVLTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public ByteAVLTreeSet.Entry firstEntry()
/*      */     {
/* 1196 */       if (ByteAVLTreeSet.this.tree == null) return null;
/* 1199 */       ByteAVLTreeSet.Entry e;
/*      */       ByteAVLTreeSet.Entry e;
/* 1199 */       if (this.bottom) { e = ByteAVLTreeSet.this.firstEntry;
/*      */       } else {
/* 1201 */         e = ByteAVLTreeSet.this.locateKey(this.from);
/*      */ 
/* 1203 */         if (ByteAVLTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1206 */       if ((e == null) || ((!this.top) && (ByteAVLTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1207 */       return e;
/*      */     }
/*      */ 
/*      */     public ByteAVLTreeSet.Entry lastEntry()
/*      */     {
/* 1214 */       if (ByteAVLTreeSet.this.tree == null) return null;
/* 1217 */       ByteAVLTreeSet.Entry e;
/*      */       ByteAVLTreeSet.Entry e;
/* 1217 */       if (this.top) { e = ByteAVLTreeSet.this.lastEntry;
/*      */       } else {
/* 1219 */         e = ByteAVLTreeSet.this.locateKey(this.to);
/*      */ 
/* 1221 */         if (ByteAVLTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1224 */       if ((e == null) || ((!this.bottom) && (ByteAVLTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1225 */       return e;
/*      */     }
/*      */     public byte firstByte() {
/* 1228 */       ByteAVLTreeSet.Entry e = firstEntry();
/* 1229 */       if (e == null) throw new NoSuchElementException();
/* 1230 */       return e.key;
/*      */     }
/*      */     public byte lastByte() {
/* 1233 */       ByteAVLTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1245 */         super();
/* 1246 */         this.next = ByteAVLTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(byte k) {
/* 1249 */         this();
/* 1250 */         if (this.next != null)
/* 1251 */           if ((!ByteAVLTreeSet.Subset.this.bottom) && (ByteAVLTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1252 */           } else if ((!ByteAVLTreeSet.Subset.this.top) && (ByteAVLTreeSet.this.compare(k, (this.prev = ByteAVLTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1254 */             this.next = ByteAVLTreeSet.this.locateKey(k);
/* 1255 */             if (ByteAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1269 */         if ((!ByteAVLTreeSet.Subset.this.top) && (this.next != null) && (ByteAVLTreeSet.this.compare(this.next.key, ByteAVLTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/* 1021 */     int index = 0;
/*      */ 
/* 1023 */     SetIterator() { this.next = ByteAVLTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(byte k) {
/* 1026 */       if ((this.next = ByteAVLTreeSet.this.locateKey(k)) != null)
/* 1027 */         if (ByteAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/* 1046 */     public byte nextByte() { return nextEntry().key; } 
/* 1047 */     public byte previousByte() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1070 */       updatePrevious();
/* 1071 */       updateNext();
/* 1072 */       ByteAVLTreeSet.this.remove(this.curr.key);
/* 1073 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
