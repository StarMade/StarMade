  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ByteComparator))) {
      ...
      this.actualComparator = new ByteComparator()
      {
        ...
        {
          return Byte2DoubleAVLTreeMap.this.storedComparator.compare(Byte.valueOf(local_k1), Byte.valueOf(local_k2));
        }
  ...
  public Byte2DoubleAVLTreeMap(Comparator<? super Byte> local_c)
  {
    this();
  ...
  public Byte2DoubleAVLTreeMap(Map<? extends Byte, ? extends Double> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2DoubleAVLTreeMap(SortedMap<Byte, Double> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2DoubleAVLTreeMap(Byte2DoubleMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Byte2DoubleAVLTreeMap(Byte2DoubleSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Byte2DoubleAVLTreeMap(byte[] local_k, double[] local_v, Comparator<? super Byte> local_c)
  {
    this(local_c);
  ...
  public Byte2DoubleAVLTreeMap(byte[] local_k, double[] local_v)
  {
  ...
  {
    double oldValue = put(local_ok.byteValue(), local_ov.doubleValue());
    return this.modified ? null : Double.valueOf(oldValue);
  }
  
  public Double remove(Object local_ok)
  {
    double oldValue = remove(((Byte)local_ok).byteValue());
  ...
  public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Byte2DoubleMap.Entry> comparator = new Comparator()
        {
          public int compare(Byte2DoubleMap.Entry local_x, Byte2DoubleMap.Entry local_y)
          {
            return Byte2DoubleAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Byte2DoubleAVLTreeMap.EntryIterator(Byte2DoubleAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry from)
        {
          return new Byte2DoubleAVLTreeMap.EntryIterator(Byte2DoubleAVLTreeMap.this, ((Byte)from.getKey()).byteValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Byte2DoubleAVLTreeMap.Entry local_f = Byte2DoubleAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Byte2DoubleAVLTreeMap.Entry local_f = Byte2DoubleAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
          if (local_f != null) {
            Byte2DoubleAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry from, Byte2DoubleMap.Entry local_to)
        {
          return Byte2DoubleAVLTreeMap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry local_to)
        {
          return Byte2DoubleAVLTreeMap.this.headMap((Byte)local_to.getKey()).byte2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry from)
        {
          return Byte2DoubleAVLTreeMap.this.tailMap((Byte)from.getKey()).byte2DoubleEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Byte2DoubleAVLTreeMap.ValueIterator(Byte2DoubleAVLTreeMap.this, null);
        }
        
        public boolean contains(double local_k)
        {
          return Byte2DoubleAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Byte2DoubleAVLTreeMap local_c;
    try
    {
      local_c = (Byte2DoubleAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readByte(), local_s.readDouble());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readByte(), local_s.readDouble());
      top.right(new Entry(local_s.readByte(), local_s.readDouble()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Byte2DoubleAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Byte2DoubleAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Byte2DoubleAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Byte2DoubleMap.Entry> byte2DoubleEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator()
          {
            return new Byte2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Byte2DoubleAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Byte2DoubleMap.Entry> iterator(Byte2DoubleMap.Entry from)
          {
            return new Byte2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Byte2DoubleAVLTreeMap.Submap.this, ((Byte)from.getKey()).byteValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Byte, Double> local_e = (Map.Entry)local_o;
            Byte2DoubleAVLTreeMap.Entry local_f = Byte2DoubleAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            return (local_f != null) && (Byte2DoubleAVLTreeMap.Submap.this.in3(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Byte, Double> local_e = (Map.Entry)local_o;
            Byte2DoubleAVLTreeMap.Entry local_f = Byte2DoubleAVLTreeMap.this.findKey(((Byte)local_e.getKey()).byteValue());
            if ((local_f != null) && (Byte2DoubleAVLTreeMap.Submap.this.in3(local_f.key))) {
              Byte2DoubleAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Byte2DoubleAVLTreeMap.Submap.SubmapIterator(Byte2DoubleAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Byte2DoubleAVLTreeMap.Submap.this.clear();
          }
          
          public Byte2DoubleMap.Entry first()
          {
            return Byte2DoubleAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Byte2DoubleMap.Entry last()
          {
            return Byte2DoubleAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Byte2DoubleMap.Entry> subSet(Byte2DoubleMap.Entry from, Byte2DoubleMap.Entry local_to)
          {
            return Byte2DoubleAVLTreeMap.Submap.this.subMap((Byte)from.getKey(), (Byte)local_to.getKey()).byte2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Byte2DoubleMap.Entry> headSet(Byte2DoubleMap.Entry local_to)
          {
            return Byte2DoubleAVLTreeMap.Submap.this.headMap((Byte)local_to.getKey()).byte2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Byte2DoubleMap.Entry> tailSet(Byte2DoubleMap.Entry from)
          {
            return Byte2DoubleAVLTreeMap.Submap.this.tailMap((Byte)from.getKey()).byte2DoubleEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public DoubleCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractDoubleCollection()
        {
          public DoubleIterator iterator()
          {
            return new Byte2DoubleAVLTreeMap.Submap.SubmapValueIterator(Byte2DoubleAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(double local_k)
          {
            return Byte2DoubleAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Byte2DoubleAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(byte local_k)
    {
      return (in3(local_k)) && (Byte2DoubleAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      byte local_kk = local_k;
      Byte2DoubleAVLTreeMap.Entry local_e;
      return (in3(local_kk)) && ((local_e = Byte2DoubleAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public double put(byte local_k, double local_v)
    {
      ...
      double oldValue = Byte2DoubleAVLTreeMap.this.put(local_k, local_v);
    ...
    public double remove(byte local_k)
    {
      ...
      double oldValue = Byte2DoubleAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Byte2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Byte2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Byte2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Byte2DoubleSortedMap tailMap(byte from)
    {
      if (this.bottom) {
        return new Submap(Byte2DoubleAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Byte2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Byte2DoubleAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Byte2DoubleSortedMap subMap(byte from, byte local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Byte2DoubleAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Byte2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Byte2DoubleAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Byte2DoubleAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Byte2DoubleAVLTreeMap.this.locateKey(this.from);
        if (Byte2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Byte2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Byte2DoubleAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Byte2DoubleAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Byte2DoubleAVLTreeMap.this.locateKey(this.field_47);
        if (Byte2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Byte2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public byte firstByteKey()
    {
      Byte2DoubleAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public byte lastByteKey()
    {
      Byte2DoubleAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Byte2DoubleAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Byte2DoubleAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(byte local_k)
      {
        this();
        if (this.next != null) {
          if ((!Byte2DoubleAVLTreeMap.Submap.this.bottom) && (Byte2DoubleAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Byte2DoubleAVLTreeMap.Submap.this.top) && (Byte2DoubleAVLTreeMap.this.compare(local_k, (this.prev = Byte2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Byte2DoubleAVLTreeMap.this.locateKey(local_k);
            if (Byte2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Byte2DoubleAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Byte2DoubleAVLTreeMap.this.compare(this.prev.key, Byte2DoubleAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Byte2DoubleAVLTreeMap.Submap.this.top) && (this.next != null) && (Byte2DoubleAVLTreeMap.this.compare(this.next.key, Byte2DoubleAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractByte2DoubleSortedMap.KeySet
    {
      ...
      {
        return new Byte2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Byte2DoubleAVLTreeMap.Submap.this);
      }
      
      public ByteBidirectionalIterator iterator(byte from)
      {
        return new Byte2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Byte2DoubleAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractByte2DoubleSortedMap.KeySet
  {
    ...
    public ByteBidirectionalIterator iterator()
    {
      return new Byte2DoubleAVLTreeMap.KeyIterator(Byte2DoubleAVLTreeMap.this);
    }
    
    public ByteBidirectionalIterator iterator(byte from)
    {
      return new Byte2DoubleAVLTreeMap.KeyIterator(Byte2DoubleAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Byte2DoubleAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Byte2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Byte2DoubleMap.Entry
  {
    ...
    Entry(byte local_k, double local_v)
    {
      this.key = local_k;
      this.value = local_v;
