...
/*     */   public static Byte2LongFunction singleton(Byte key, Long value)
/*     */   {
/* 124 */     return new Singleton(key.byteValue(), value.longValue());
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static class UnmodifiableFunction extends AbstractByte2LongFunction
...
/* 227 */     public long get(byte k) { return this.function.get(k); } 
/* 228 */     public boolean containsKey(Object ok) { return this.function.containsKey(ok); }
/*     */ 
/*     */   }
/*     */ 
/*     */   public static class SynchronizedFunction extends AbstractByte2LongFunction
/*     */     implements Serializable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Byte2LongFunction function;
...
/* 170 */     public long get(byte k) { synchronized (this.sync) { return this.function.get(k); }  } 
/* 171 */     public boolean containsKey(Object ok) { synchronized (this.sync) { return this.function.containsKey(ok); }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
/*     */   public static class Singleton extends AbstractByte2LongFunction
...
/*     */     }
/*  92 */     public long get(byte k) { if (this.key == k) return this.value; return this.defRetValue; } 
/*     */     public int size() {
/*  94 */       return 1;
/*     */     }
...
/*     */   }
/*     */ 
/*     */   public static class EmptyFunction extends AbstractByte2LongFunction
/*     */     implements Serializable, Cloneable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */ 
...
/*     */     public void clear() {  } 
/*  68 */     private Object readResolve() { return Byte2LongFunctions.EMPTY_FUNCTION; } 
/*  69 */     public Object clone() { return Byte2LongFunctions.EMPTY_FUNCTION; }
/*     */ 
/*     */   }
/*     */ }
