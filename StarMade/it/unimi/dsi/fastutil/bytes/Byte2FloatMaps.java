...
/*     */   public static Byte2FloatMap singleton(Byte key, Float value)
/*     */   {
/* 200 */     return new Singleton(key.byteValue(), value.floatValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Byte2FloatMap.Entry> byte2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.byte2FloatEntrySet()); return this.entries; } 
...
/* 335 */     public float get(byte k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Byte, Float>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Byte, ? extends Float> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.byte2FloatEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public float get(byte k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Byte, Float>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Byte2FloatMap.Entry> byte2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/*     */       public Byte getKey()
/*     */       {
/* 131 */         return Byte.valueOf(Byte2FloatMaps.Singleton.this.key); } 
/* 132 */       public Float getValue() { return Float.valueOf(Byte2FloatMaps.Singleton.this.value); }
/*     */ 
/*     */       public byte getByteKey() {
/* 135 */         return Byte2FloatMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public float getFloatValue() {
/* 139 */         return Byte2FloatMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Byte2FloatMaps.Singleton.this.key == ((Byte)e.getKey()).byteValue()) && (Byte2FloatMaps.Singleton.this.value == ((Float)e.getValue()).floatValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return Byte2FloatMaps.Singleton.this.key ^ HashCommon.float2int(Byte2FloatMaps.Singleton.this.value); } 
/* 153 */       public String toString() { return Byte2FloatMaps.Singleton.this.key + "->" + Byte2FloatMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Byte, ? extends Float> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Byte2FloatMap.Entry> byte2FloatEntrySet() {
...
/*  76 */     private Object readResolve() { return Byte2FloatMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Byte2FloatMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Byte, Float>> entrySet() {
/*  80 */       return byte2FloatEntrySet();
/*     */     }
