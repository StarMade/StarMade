  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2DoubleRBTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2DoubleRBTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2DoubleRBTreeMap(Map<? extends Long, ? extends Double> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2DoubleRBTreeMap(SortedMap<Long, Double> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2DoubleRBTreeMap(Long2DoubleMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2DoubleRBTreeMap(Long2DoubleSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2DoubleRBTreeMap(long[] local_k, double[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2DoubleRBTreeMap(long[] local_k, double[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Long2DoubleMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Long2DoubleRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2DoubleRBTreeMap.EntryIterator(Long2DoubleRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from)
        {
          return new Long2DoubleRBTreeMap.EntryIterator(Long2DoubleRBTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2DoubleRBTreeMap.Entry local_f = Long2DoubleRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2DoubleRBTreeMap.Entry local_f = Long2DoubleRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2DoubleRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Long2DoubleRBTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry local_to)
        {
          return Long2DoubleRBTreeMap.this.headMap((Long)local_to.getKey()).long2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from)
        {
          return Long2DoubleRBTreeMap.this.tailMap((Long)from.getKey()).long2DoubleEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Long2DoubleRBTreeMap.ValueIterator(Long2DoubleRBTreeMap.this, null);
        }
        
        public boolean contains(double local_k)
        {
          return Long2DoubleRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2DoubleRBTreeMap local_c;
    try
    {
      local_c = (Long2DoubleRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2DoubleRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2DoubleRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2DoubleRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator()
          {
            return new Long2DoubleRBTreeMap.Submap.SubmapEntryIterator(Long2DoubleRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from)
          {
            return new Long2DoubleRBTreeMap.Submap.SubmapEntryIterator(Long2DoubleRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Double> local_e = (Map.Entry)local_o;
            Long2DoubleRBTreeMap.Entry local_f = Long2DoubleRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2DoubleRBTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Double> local_e = (Map.Entry)local_o;
            Long2DoubleRBTreeMap.Entry local_f = Long2DoubleRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2DoubleRBTreeMap.Submap.this.in1(local_f.key))) {
              Long2DoubleRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2DoubleRBTreeMap.Submap.SubmapIterator(Long2DoubleRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2DoubleRBTreeMap.Submap.this.clear();
          }
          
          public Long2DoubleMap.Entry first()
          {
            return Long2DoubleRBTreeMap.Submap.this.firstEntry();
          }
          
          public Long2DoubleMap.Entry last()
          {
            return Long2DoubleRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry local_to)
          {
            return Long2DoubleRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry local_to)
          {
            return Long2DoubleRBTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from)
          {
            return Long2DoubleRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2DoubleEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public DoubleCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractDoubleCollection()
        {
          public DoubleIterator iterator()
          {
            return new Long2DoubleRBTreeMap.Submap.SubmapValueIterator(Long2DoubleRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(double local_k)
          {
            return Long2DoubleRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2DoubleRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2DoubleRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2DoubleRBTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2DoubleRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public double put(long local_k, double local_v)
    {
      ...
      double oldValue = Long2DoubleRBTreeMap.this.put(local_k, local_v);
    ...
    public double remove(long local_k)
    {
      ...
      double oldValue = Long2DoubleRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2DoubleRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2DoubleRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2DoubleRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2DoubleSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2DoubleRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2DoubleRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2DoubleSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2DoubleRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2DoubleRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2DoubleRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2DoubleRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2DoubleRBTreeMap.this.locateKey(this.from);
        if (Long2DoubleRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2DoubleRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2DoubleRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2DoubleRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2DoubleRBTreeMap.this.locateKey(this.field_47);
        if (Long2DoubleRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2DoubleRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2DoubleRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2DoubleRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Long2DoubleRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2DoubleRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2DoubleRBTreeMap.Submap.this.bottom) && (Long2DoubleRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2DoubleRBTreeMap.Submap.this.top) && (Long2DoubleRBTreeMap.this.compare(local_k, (this.prev = Long2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2DoubleRBTreeMap.this.locateKey(local_k);
            if (Long2DoubleRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2DoubleRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2DoubleRBTreeMap.this.compare(this.prev.key, Long2DoubleRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2DoubleRBTreeMap.Submap.this.top) && (this.next != null) && (Long2DoubleRBTreeMap.this.compare(this.next.key, Long2DoubleRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2DoubleSortedMap.KeySet
    {
      ...
      {
        return new Long2DoubleRBTreeMap.Submap.SubmapKeyIterator(Long2DoubleRBTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2DoubleRBTreeMap.Submap.SubmapKeyIterator(Long2DoubleRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2DoubleSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2DoubleRBTreeMap.KeyIterator(Long2DoubleRBTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2DoubleRBTreeMap.KeyIterator(Long2DoubleRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2DoubleRBTreeMap.this.locateKey(local_k)) != null) {
        if (Long2DoubleRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
