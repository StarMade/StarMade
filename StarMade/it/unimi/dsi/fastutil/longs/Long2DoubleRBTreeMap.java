...
/*      */ 
/*      */ public class Long2DoubleRBTreeMap extends AbstractLong2DoubleSortedMap
...
/*      */   protected volatile transient ObjectSortedSet<Long2DoubleMap.Entry> entries;
...
/*  119 */           return Long2DoubleRBTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  122 */           return Long2DoubleRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     double oldValue = put(ok.longValue(), ov.doubleValue());
/*  731 */     return this.modified ? null : Double.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Double remove(Object ok)
/*      */   {
/*  737 */     double oldValue = remove(((Long)ok).longValue());
...
/* 1141 */         final Comparator<? super Long2DoubleMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Long2DoubleMap.Entry x, Long2DoubleMap.Entry y) {
/* 1143 */             return Long2DoubleRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Long2DoubleRBTreeMap.EntryIterator(Long2DoubleRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from) {
/* 1153 */           return new Long2DoubleRBTreeMap.EntryIterator(Long2DoubleRBTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Long2DoubleRBTreeMap.Entry f = Long2DoubleRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1166 */           Long2DoubleRBTreeMap.Entry f = Long2DoubleRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1167 */           if (f != null) Long2DoubleRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Long2DoubleRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Long2DoubleRBTreeMap.this.clear(); } 
/* 1172 */         public Long2DoubleMap.Entry first() { return Long2DoubleRBTreeMap.this.firstEntry; } 
/* 1173 */         public Long2DoubleMap.Entry last() { return Long2DoubleRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry to) { return Long2DoubleRBTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2DoubleEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry to) { return Long2DoubleRBTreeMap.this.headMap((Long)to.getKey()).long2DoubleEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from) { return Long2DoubleRBTreeMap.this.tailMap((Long)from.getKey()).long2DoubleEntrySet(); }
/*      */       };
...
/* 1242 */           return new Long2DoubleRBTreeMap.ValueIterator(Long2DoubleRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(double k) {
/* 1245 */           return Long2DoubleRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Long2DoubleRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Long2DoubleRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Long2DoubleRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readLong(), s.readDouble());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readLong(), s.readDouble());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readLong(), s.readDouble()));
...
/*      */ 
/*      */ 
/*      */   private final class Submap extends AbstractLong2DoubleSortedMap
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Long2DoubleRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Long2DoubleRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator() {
/* 1329 */             return new Long2DoubleRBTreeMap.Submap.SubmapEntryIterator(Long2DoubleRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from) {
/* 1332 */             return new Long2DoubleRBTreeMap.Submap.SubmapEntryIterator(Long2DoubleRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1334 */           public Comparator<? super Long2DoubleMap.Entry> comparator() { return Long2DoubleRBTreeMap.this.long2DoubleEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Long2DoubleRBTreeMap.Entry f = Long2DoubleRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1340 */             return (f != null) && (Long2DoubleRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Long2DoubleRBTreeMap.Entry f = Long2DoubleRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1347 */             if ((f != null) && (Long2DoubleRBTreeMap.Submap.this.in(f.key))) Long2DoubleRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Long2DoubleRBTreeMap.Submap.SubmapIterator(Long2DoubleRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Long2DoubleRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Long2DoubleMap.Entry first() { return Long2DoubleRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Long2DoubleMap.Entry last() { return Long2DoubleRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry to) { return Long2DoubleRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2DoubleEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry to) { return Long2DoubleRBTreeMap.Submap.this.headMap((Long)to.getKey()).long2DoubleEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from) { return Long2DoubleRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2DoubleEntrySet(); }
/*      */         };
...
/*      */           public DoubleIterator iterator() {
/* 1376 */             return new Long2DoubleRBTreeMap.Submap.SubmapValueIterator(Long2DoubleRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(double k) {
/* 1379 */             return Long2DoubleRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Long2DoubleRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Long2DoubleRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1392 */       return (in(k)) && (Long2DoubleRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(double v) {
...
/* 1407 */       return (in(kk)) && ((e = Long2DoubleRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public double put(long k, double v) {
/* 1410 */       Long2DoubleRBTreeMap.this.modified = false;
...
/* 1412 */       double oldValue = Long2DoubleRBTreeMap.this.put(k, v);
/* 1413 */       return Long2DoubleRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Double put(Long ok, Double ov) {
/* 1416 */       double oldValue = put(ok.longValue(), ov.doubleValue());
/* 1417 */       return Long2DoubleRBTreeMap.this.modified ? null : Double.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public double remove(long k) {
/* 1421 */       Long2DoubleRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       double oldValue = Long2DoubleRBTreeMap.this.remove(k);
/* 1424 */       return Long2DoubleRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Double remove(Object ok) {
/* 1427 */       double oldValue = remove(((Long)ok).longValue());
/* 1428 */       return Long2DoubleRBTreeMap.this.modified ? Double.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1443 */       return Long2DoubleRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2DoubleSortedMap headMap(long to) {
/* 1446 */       if (this.top) return new Submap(Long2DoubleRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Long2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2DoubleRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2DoubleSortedMap tailMap(long from) {
/* 1450 */       if (this.bottom) return new Submap(Long2DoubleRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Long2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2DoubleRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2DoubleSortedMap subMap(long from, long to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Long2DoubleRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Long2DoubleRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Long2DoubleRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Long2DoubleRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2DoubleRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Long2DoubleRBTreeMap.this.tree == null) return null;
/* 1468 */       Long2DoubleRBTreeMap.Entry e;
/*      */       Long2DoubleRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Long2DoubleRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Long2DoubleRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Long2DoubleRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Long2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2DoubleRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Long2DoubleRBTreeMap.this.tree == null) return null;
/* 1486 */       Long2DoubleRBTreeMap.Entry e;
/*      */       Long2DoubleRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Long2DoubleRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Long2DoubleRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Long2DoubleRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Long2DoubleRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1497 */       Long2DoubleRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1502 */       Long2DoubleRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1507 */       Long2DoubleRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1512 */       Long2DoubleRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2DoubleRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2DoubleRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2DoubleRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Long2DoubleMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Long2DoubleRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Long2DoubleRBTreeMap.Submap.this.bottom) && (Long2DoubleRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Long2DoubleRBTreeMap.Submap.this.top) && (Long2DoubleRBTreeMap.this.compare(k, (this.prev = Long2DoubleRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Long2DoubleRBTreeMap.this.locateKey(k);
/* 1534 */             if (Long2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Long2DoubleRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2DoubleRBTreeMap.this.compare(this.prev.key, Long2DoubleRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Long2DoubleRBTreeMap.Submap.this.top) && (this.next != null) && (Long2DoubleRBTreeMap.this.compare(this.next.key, Long2DoubleRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public LongBidirectionalIterator iterator() { return new Long2DoubleRBTreeMap.Submap.SubmapKeyIterator(Long2DoubleRBTreeMap.Submap.this); } 
/* 1367 */       public LongBidirectionalIterator iterator(long from) { return new Long2DoubleRBTreeMap.Submap.SubmapKeyIterator(Long2DoubleRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2DoubleRBTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public LongBidirectionalIterator iterator() { return new Long2DoubleRBTreeMap.KeyIterator(Long2DoubleRBTreeMap.this); } 
/* 1201 */     public LongBidirectionalIterator iterator(long from) { return new Long2DoubleRBTreeMap.KeyIterator(Long2DoubleRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2DoubleRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2DoubleRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Long2DoubleMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Long2DoubleMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Long2DoubleRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1067 */       if ((this.next = Long2DoubleRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Long2DoubleRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Long2DoubleRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */     implements Cloneable, Long2DoubleMap.Entry
/*      */   {
...
/*      */ 
/*  979 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/*  983 */       return HashCommon.long2int(this.key) ^ HashCommon.double2int(this.value);
/*      */     }
/*      */ 
