...
/*     */   {
/* 173 */     return new Singleton(key.longValue(), value.booleanValue());
/*     */   }
/*     */ 
/*     */   public static Long2BooleanSortedMap singleton(Long key, Boolean value, LongComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.longValue(), value.booleanValue(), comparator);
/*     */   }
/*     */ 
/*     */   public static Long2BooleanSortedMap singleton(long key, boolean value)
/*     */   {
...
/* 304 */       return long2BooleanEntrySet(); } 
...
/* 308 */     public Long2BooleanSortedMap headMap(long to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Long2BooleanSortedMap tailMap(long from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Long2BooleanSortedMap headMap(Long to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Long2BooleanSortedMap tailMap(Long from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     public ObjectSortedSet<Map.Entry<Long, Boolean>> entrySet() {
/* 244 */       return long2BooleanEntrySet(); } 
...
/* 248 */     public Long2BooleanSortedMap headMap(long to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Long2BooleanSortedMap tailMap(long from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public long firstLongKey() {
...
/* 259 */     public Long2BooleanSortedMap headMap(Long to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Long2BooleanSortedMap tailMap(Long from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Long2BooleanMaps.Singleton.SingletonEntry(this), Long2BooleanSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Long, Boolean>> entrySet() { return long2BooleanEntrySet(); } 
/*     */     public LongSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = LongSortedSets.singleton(this.key, this.comparator); return (LongSortedSet)this.keys;
/*     */     }
/*     */     public Long2BooleanSortedMap subMap(long from, long to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Long2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Long2BooleanSortedMap headMap(long to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Long2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Long2BooleanSortedMap tailMap(long from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Long2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Long2BooleanSortedMap tailMap(Long ofrom) { return tailMap(ofrom.longValue()); } 
/* 156 */     public Long2BooleanSortedMap subMap(Long ofrom, Long oto) { return subMap(ofrom.longValue(), oto.longValue()); } 
/*     */     public Long firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Long, Boolean>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public LongSortedSet keySet() { return LongSortedSets.EMPTY_SET; } 
/*     */     public Long2BooleanSortedMap subMap(long from, long to) {
/*  86 */       return Long2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Long2BooleanSortedMap headMap(long to) { return Long2BooleanSortedMaps.EMPTY_MAP; } 
/*     */     public Long2BooleanSortedMap tailMap(long from) {
/*  90 */       return Long2BooleanSortedMaps.EMPTY_MAP; } 
/*  91 */     public long firstLongKey() { throw new NoSuchElementException(); } 
/*  92 */     public long lastLongKey() { throw new NoSuchElementException(); } 
/*  93 */     public Long2BooleanSortedMap headMap(Long oto) { return headMap(oto.longValue()); } 
/*  94 */     public Long2BooleanSortedMap tailMap(Long ofrom) { return tailMap(ofrom.longValue()); } 
/*  95 */     public Long2BooleanSortedMap subMap(Long ofrom, Long oto) { return subMap(ofrom.longValue(), oto.longValue()); } 
