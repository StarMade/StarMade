...
/* 612 */           return new Long2CharOpenHashMap.ValueIterator(Long2CharOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 615 */           return Long2CharOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(char v) {
/* 618 */           return Long2CharOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 621 */           Long2CharOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 736 */       c = (Long2CharOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Long2CharOpenHashMap.MapIterator
/*     */     implements CharIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 605 */       super(null); } 
/* 606 */     public char nextChar() { return Long2CharOpenHashMap.this.value[nextEntry()]; } 
/* 607 */     public Character next() { return Character.valueOf(Long2CharOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 577 */       return new Long2CharOpenHashMap.KeyIterator(Long2CharOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 580 */       return Long2CharOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(long k) {
/* 583 */       return Long2CharOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(long k) {
/* 586 */       int oldSize = Long2CharOpenHashMap.this.size;
/* 587 */       Long2CharOpenHashMap.this.remove(k);
/* 588 */       return Long2CharOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 591 */       Long2CharOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Long2CharOpenHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 571 */       super(null); } 
/* 572 */     public long nextLong() { return Long2CharOpenHashMap.this.key[nextEntry()]; } 
/* 573 */     public Long next() { return Long.valueOf(Long2CharOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 517 */       return new Long2CharOpenHashMap.EntryIterator(Long2CharOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Long2CharMap.Entry> fastIterator() {
/* 520 */       return new Long2CharOpenHashMap.FastEntryIterator(Long2CharOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 528 */       int pos = (int)HashCommon.murmurHash3(k) & Long2CharOpenHashMap.this.mask;
/*     */ 
/* 530 */       while (Long2CharOpenHashMap.this.used[pos] != 0) {
/* 531 */         if (Long2CharOpenHashMap.this.key[pos] == k) return Long2CharOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 532 */         pos = pos + 1 & Long2CharOpenHashMap.this.mask;
/*     */       }
/* 534 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 542 */       int pos = (int)HashCommon.murmurHash3(k) & Long2CharOpenHashMap.this.mask;
/*     */ 
/* 544 */       while (Long2CharOpenHashMap.this.used[pos] != 0) {
/* 545 */         if (Long2CharOpenHashMap.this.key[pos] == k) {
/* 546 */           Long2CharOpenHashMap.this.remove(e.getKey());
/* 547 */           return true;
/*     */         }
/* 549 */         pos = pos + 1 & Long2CharOpenHashMap.this.mask;
/*     */       }
/* 551 */       return false;
/*     */     }
/*     */     public int size() {
/* 554 */       return Long2CharOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 557 */       Long2CharOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Long2CharOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Long2CharMap.Entry>
/*     */   {
/* 507 */     final AbstractLong2CharMap.BasicEntry entry = new AbstractLong2CharMap.BasicEntry(0L, '\000');
/*     */ 
...
/* 509 */       int e = nextEntry();
/* 510 */       this.entry.key = Long2CharOpenHashMap.this.key[e];
/* 511 */       this.entry.value = Long2CharOpenHashMap.this.value[e];
/* 512 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Long2CharOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Long2CharMap.Entry>
/*     */   {
...
/* 498 */       return this.entry = new Long2CharOpenHashMap.MapEntry(Long2CharOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 502 */       super.remove();
/* 503 */       Long2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 404 */       this.pos = Long2CharOpenHashMap.this.n;
/*     */ 
/* 407 */       this.last = -1;
/*     */ 
/* 409 */       this.c = Long2CharOpenHashMap.this.size;
/*     */ 
/* 414 */       boolean[] used = Long2CharOpenHashMap.this.used;
...
/*     */ 
/* 427 */         int pos = (int)HashCommon.murmurHash3(k) & Long2CharOpenHashMap.this.mask;
/*     */ 
/* 429 */         while (Long2CharOpenHashMap.this.used[pos] != 0) {
/* 430 */           if (Long2CharOpenHashMap.this.key[pos] == k) return pos;
/* 431 */           pos = pos + 1 & Long2CharOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 434 */       this.last = this.pos;
/*     */ 
/* 436 */       if (this.c != 0) {
/* 437 */         boolean[] used = Long2CharOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 454 */         pos = (last = pos) + 1 & Long2CharOpenHashMap.this.mask;
/* 455 */         while (Long2CharOpenHashMap.this.used[pos] != 0) {
/* 456 */           int slot = (int)HashCommon.murmurHash3(Long2CharOpenHashMap.this.key[pos]) & Long2CharOpenHashMap.this.mask;
/* 457 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 458 */           pos = pos + 1 & Long2CharOpenHashMap.this.mask;
/*     */         }
/* 460 */         if (Long2CharOpenHashMap.this.used[pos] == 0) break;
/* 461 */         if (pos < last)
/*     */         {
/* 463 */           if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 464 */           this.wrapped.add(Long2CharOpenHashMap.this.key[pos]);
/*     */         }
/* 466 */         Long2CharOpenHashMap.this.key[last] = Long2CharOpenHashMap.this.key[pos];
/* 467 */         Long2CharOpenHashMap.this.value[last] = Long2CharOpenHashMap.this.value[pos];
/*     */       }
/* 469 */       Long2CharOpenHashMap.this.used[last] = false;
/* 470 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 475 */       if (this.pos < -1)
/*     */       {
/* 477 */         Long2CharOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 478 */         this.last = -1;
/* 479 */         return;
/*     */       }
/* 481 */       Long2CharOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Long getKey() {
/* 368 */       return Long.valueOf(Long2CharOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public long getLongKey() {
/* 371 */       return Long2CharOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Character getValue() {
/* 374 */       return Character.valueOf(Long2CharOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public char getCharValue() {
/* 377 */       return Long2CharOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public char setValue(char v) {
/* 380 */       char oldValue = Long2CharOpenHashMap.this.value[this.index];
/* 381 */       Long2CharOpenHashMap.this.value[this.index] = v;
/* 382 */       return oldValue;
/*     */     }
...
/* 391 */       return (Long2CharOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*     */     }
/*     */     public int hashCode() {
/* 394 */       return HashCommon.long2int(Long2CharOpenHashMap.this.key[this.index]) ^ Long2CharOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 397 */       return Long2CharOpenHashMap.this.key[this.index] + "=>" + Long2CharOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
