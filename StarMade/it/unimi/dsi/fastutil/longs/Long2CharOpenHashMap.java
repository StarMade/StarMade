  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2CharOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2CharOpenHashMap(Map<? extends Long, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2CharOpenHashMap(Map<? extends Long, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2CharOpenHashMap(Long2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2CharOpenHashMap(Long2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2CharOpenHashMap(long[] local_k, char[] local_v, float local_f)
  {
  ...
  public Long2CharOpenHashMap(long[] local_k, char[] local_v)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Long2CharOpenHashMap.ValueIterator(Long2CharOpenHashMap.this);
        }
        ...
        {
          return Long2CharOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2CharOpenHashMap local_c;
    try
    {
      local_c = (Long2CharOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Long2CharOpenHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Long2CharOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSet
  {
    ...
    {
      return new Long2CharOpenHashMap.KeyIterator(Long2CharOpenHashMap.this);
    }
    ...
    {
      return Long2CharOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2CharOpenHashMap.this.size;
      Long2CharOpenHashMap.this.remove(local_k);
    ...
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Long2CharOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2CharMap.FastEntrySet
  {
    ...
    {
      return new Long2CharOpenHashMap.EntryIterator(Long2CharOpenHashMap.this, null);
    }
    
    public ObjectIterator<Long2CharMap.Entry> fastIterator()
    {
      return new Long2CharOpenHashMap.FastEntryIterator(Long2CharOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2CharOpenHashMap.this.mask; Long2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2CharOpenHashMap.this.mask) {
        if (Long2CharOpenHashMap.this.key[pos] == local_k) {
          return Long2CharOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2CharOpenHashMap.this.mask; Long2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2CharOpenHashMap.this.mask) {
        if (Long2CharOpenHashMap.this.key[pos] == local_k)
        {
          Long2CharOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Long2CharMap.Entry>
  {
    ...
    public AbstractLong2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2CharOpenHashMap.this.key[local_e];
      this.entry.value = Long2CharOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Long2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Long2CharOpenHashMap.MapEntry(Long2CharOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Long2CharOpenHashMap.this.field_49;
    int last = -1;
    int field_1730 = Long2CharOpenHashMap.this.size;
    LongArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Long2CharOpenHashMap.this.used;
      while ((this.field_1730 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1730 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1730 != 0)
      {
        boolean[] local_k = Long2CharOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2CharOpenHashMap.this.mask; Long2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2CharOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2CharOpenHashMap.this.key[pos]) & Long2CharOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2CharOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Long2CharOpenHashMap.this.key[pos]);
        }
        Long2CharOpenHashMap.this.key[last] = Long2CharOpenHashMap.this.key[pos];
        Long2CharOpenHashMap.this.value[last] = Long2CharOpenHashMap.this.value[pos];
      }
      Long2CharOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Long2CharOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
        this.last = -1;
        return;
      }
      Long2CharOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1730 > 0))
      {
        this.field_1730 += 1;
        nextEntry();
      }
    ...
    implements Long2CharMap.Entry, Map.Entry<Long, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Long2CharOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Character> local_e = (Map.Entry)local_o;
      return (Long2CharOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2CharOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
