  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2ObjectAVLTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2ObjectAVLTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2ObjectAVLTreeMap(Map<? extends Long, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2ObjectAVLTreeMap(SortedMap<Long, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2ObjectAVLTreeMap(Long2ObjectMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2ObjectAVLTreeMap(Long2ObjectSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2ObjectAVLTreeMap(long[] local_k, V[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2ObjectAVLTreeMap(long[] local_k, V[] local_v)
  {
  ...
  {
    Long2ObjectAVLTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Long2ObjectMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Long2ObjectAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2ObjectAVLTreeMap.EntryIterator(Long2ObjectAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from)
        {
          return new Long2ObjectAVLTreeMap.EntryIterator(Long2ObjectAVLTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2ObjectAVLTreeMap.Entry<V> local_f = Long2ObjectAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2ObjectAVLTreeMap.Entry<V> local_f = Long2ObjectAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2ObjectAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Long2ObjectAVLTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> local_to)
        {
          return Long2ObjectAVLTreeMap.this.headMap((Long)local_to.getKey()).long2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from)
        {
          return Long2ObjectAVLTreeMap.this.tailMap((Long)from.getKey()).long2ObjectEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Long2ObjectAVLTreeMap.ValueIterator(Long2ObjectAVLTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Long2ObjectAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2ObjectAVLTreeMap<V> local_c;
    try
    {
      local_c = (Long2ObjectAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Long2ObjectAVLTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2ObjectAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Long2ObjectAVLTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Long2ObjectAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2ObjectAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator()
          {
            return new Long2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Long2ObjectAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from)
          {
            return new Long2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Long2ObjectAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, V> local_e = (Map.Entry)local_o;
            Long2ObjectAVLTreeMap.Entry<V> local_f = Long2ObjectAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2ObjectAVLTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, V> local_e = (Map.Entry)local_o;
            Long2ObjectAVLTreeMap.Entry<V> local_f = Long2ObjectAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2ObjectAVLTreeMap.Submap.this.in1(local_f.key))) {
              Long2ObjectAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2ObjectAVLTreeMap.Submap.SubmapIterator(Long2ObjectAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2ObjectAVLTreeMap.Submap.this.clear();
          }
          
          public Long2ObjectMap.Entry<V> first()
          {
            return Long2ObjectAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Long2ObjectMap.Entry<V> last()
          {
            return Long2ObjectAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> local_to)
          {
            return Long2ObjectAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> local_to)
          {
            return Long2ObjectAVLTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from)
          {
            return Long2ObjectAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Long2ObjectAVLTreeMap.Submap.SubmapValueIterator(Long2ObjectAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Long2ObjectAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2ObjectAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2ObjectAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2ObjectAVLTreeMap.Entry<V> local_e;
      return (in1(local_kk)) && ((local_e = Long2ObjectAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(long local_k, V local_v)
    {
      ...
      V oldValue = Long2ObjectAVLTreeMap.this.put(local_k, local_v);
    ...
    public V remove(long local_k)
    {
      ...
      V oldValue = Long2ObjectAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2ObjectSortedMap<V> tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2ObjectAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2ObjectAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2ObjectSortedMap<V> subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2ObjectAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2ObjectAVLTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2ObjectAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2ObjectAVLTreeMap.this.locateKey(this.from);
        if (Long2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2ObjectAVLTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2ObjectAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2ObjectAVLTreeMap.this.locateKey(this.field_47);
        if (Long2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2ObjectAVLTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2ObjectAVLTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Long2ObjectAVLTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Long2ObjectAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Long2ObjectAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2ObjectAVLTreeMap.Submap.this.bottom) && (Long2ObjectAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2ObjectAVLTreeMap.Submap.this.top) && (Long2ObjectAVLTreeMap.this.compare(local_k, (this.prev = Long2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2ObjectAVLTreeMap.this.locateKey(local_k);
            if (Long2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2ObjectAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2ObjectAVLTreeMap.this.compare(this.prev.key, Long2ObjectAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2ObjectAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2ObjectAVLTreeMap.this.compare(this.next.key, Long2ObjectAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Long2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Long2ObjectAVLTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Long2ObjectAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2ObjectSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2ObjectAVLTreeMap.KeyIterator(Long2ObjectAVLTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2ObjectAVLTreeMap.KeyIterator(Long2ObjectAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2ObjectAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Long2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
