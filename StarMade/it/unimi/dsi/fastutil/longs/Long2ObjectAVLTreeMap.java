...
/*  117 */           return Long2ObjectAVLTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  120 */           return Long2ObjectAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* 1179 */         final Comparator<? super Long2ObjectMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Long2ObjectMap.Entry<V> x, Long2ObjectMap.Entry<V> y) {
/* 1181 */             return Long2ObjectAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1179 */         };
/*      */ 
...
/* 1188 */           return new Long2ObjectAVLTreeMap.EntryIterator(Long2ObjectAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
/* 1191 */           return new Long2ObjectAVLTreeMap.EntryIterator(Long2ObjectAVLTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1195 */           if (!(o instanceof Map.Entry)) return false;
/* 1196 */           Map.Entry e = (Map.Entry)o;
/* 1197 */           Long2ObjectAVLTreeMap.Entry f = Long2ObjectAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1204 */           Long2ObjectAVLTreeMap.Entry f = Long2ObjectAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1205 */           if (f != null) Long2ObjectAVLTreeMap.this.remove(f.key);
/* 1206 */           return f != null;
/*      */         }
/* 1208 */         public int size() { return Long2ObjectAVLTreeMap.this.count; } 
/* 1209 */         public void clear() { Long2ObjectAVLTreeMap.this.clear(); } 
/* 1210 */         public Long2ObjectMap.Entry<V> first() { return Long2ObjectAVLTreeMap.this.firstEntry; } 
/* 1211 */         public Long2ObjectMap.Entry<V> last() { return Long2ObjectAVLTreeMap.this.lastEntry; } 
/* 1212 */         public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) { return Long2ObjectAVLTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ObjectEntrySet(); } 
/* 1213 */         public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) { return Long2ObjectAVLTreeMap.this.headMap((Long)to.getKey()).long2ObjectEntrySet(); } 
/* 1214 */         public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) { return Long2ObjectAVLTreeMap.this.tailMap((Long)from.getKey()).long2ObjectEntrySet(); }
/*      */       };
...
/* 1276 */           return new Long2ObjectAVLTreeMap.ValueIterator(Long2ObjectAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1279 */           return Long2ObjectAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1282 */           return Long2ObjectAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1285 */           Long2ObjectAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1645 */       c = (Long2ObjectAVLTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1338 */       if ((!bottom) && (!top) && (Long2ObjectAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1339 */       this.from = from;
/* 1340 */       this.bottom = bottom;
/* 1341 */       this.to = to;
/* 1342 */       this.top = top;
/* 1343 */       this.defRetValue = Long2ObjectAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1357 */       return ((this.bottom) || (Long2ObjectAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Long2ObjectAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
/* 1361 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator() {
/* 1363 */             return new Long2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Long2ObjectAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
/* 1366 */             return new Long2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Long2ObjectAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1368 */           public Comparator<? super Long2ObjectMap.Entry<V>> comparator() { return Long2ObjectAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1371 */             if (!(o instanceof Map.Entry)) return false;
/* 1372 */             Map.Entry e = (Map.Entry)o;
/* 1373 */             Long2ObjectAVLTreeMap.Entry f = Long2ObjectAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1374 */             return (f != null) && (Long2ObjectAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1378 */             if (!(o instanceof Map.Entry)) return false;
/* 1379 */             Map.Entry e = (Map.Entry)o;
/* 1380 */             Long2ObjectAVLTreeMap.Entry f = Long2ObjectAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1381 */             if ((f != null) && (Long2ObjectAVLTreeMap.Submap.this.in(f.key))) Long2ObjectAVLTreeMap.Submap.this.remove(f.key);
/* 1382 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1385 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1390 */             return !new Long2ObjectAVLTreeMap.Submap.SubmapIterator(Long2ObjectAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1393 */             Long2ObjectAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1395 */           public Long2ObjectMap.Entry<V> first() { return Long2ObjectAVLTreeMap.Submap.this.firstEntry(); } 
/* 1396 */           public Long2ObjectMap.Entry<V> last() { return Long2ObjectAVLTreeMap.Submap.this.lastEntry(); } 
/* 1397 */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) { return Long2ObjectAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ObjectEntrySet(); } 
/* 1398 */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) { return Long2ObjectAVLTreeMap.Submap.this.headMap((Long)to.getKey()).long2ObjectEntrySet(); } 
/* 1399 */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) { return Long2ObjectAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2ObjectEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1414 */             return new Long2ObjectAVLTreeMap.Submap.SubmapValueIterator(Long2ObjectAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1417 */             return Long2ObjectAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1420 */             return Long2ObjectAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1423 */             Long2ObjectAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1430 */       return (in(k)) && (Long2ObjectAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1444 */       long kk = k;
/*      */       Long2ObjectAVLTreeMap.Entry e;
/* 1445 */       return (in(kk)) && ((e = Long2ObjectAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(long k, V v) {
/* 1448 */       Long2ObjectAVLTreeMap.this.modified = false;
...
/* 1450 */       Object oldValue = Long2ObjectAVLTreeMap.this.put(k, v);
/* 1451 */       return Long2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Long ok, V ov) {
/* 1454 */       Object oldValue = put(ok.longValue(), ov);
/* 1455 */       return Long2ObjectAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(long k) {
/* 1459 */       Long2ObjectAVLTreeMap.this.modified = false;
/* 1460 */       if (!in(k)) return this.defRetValue;
/* 1461 */       Object oldValue = Long2ObjectAVLTreeMap.this.remove(k);
/* 1462 */       return Long2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1465 */       Object oldValue = remove(((Long)ok).longValue());
/* 1466 */       return Long2ObjectAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1481 */       return Long2ObjectAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2ObjectSortedMap<V> headMap(long to) {
/* 1484 */       if (this.top) return new Submap(Long2ObjectAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1485 */       return Long2ObjectAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2ObjectAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2ObjectSortedMap<V> tailMap(long from) {
/* 1488 */       if (this.bottom) return new Submap(Long2ObjectAVLTreeMap.this, from, false, this.to, this.top);
/* 1489 */       return Long2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2ObjectAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2ObjectSortedMap<V> subMap(long from, long to) {
/* 1492 */       if ((this.top) && (this.bottom)) return new Submap(Long2ObjectAVLTreeMap.this, from, false, to, false);
/* 1493 */       if (!this.top) to = Long2ObjectAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1494 */       if (!this.bottom) from = Long2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1495 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1496 */       return new Submap(Long2ObjectAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2ObjectAVLTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1503 */       if (Long2ObjectAVLTreeMap.this.tree == null) return null;
/* 1506 */       Long2ObjectAVLTreeMap.Entry e;
/*      */       Long2ObjectAVLTreeMap.Entry e;
/* 1506 */       if (this.bottom) { e = Long2ObjectAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1508 */         e = Long2ObjectAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1510 */         if (Long2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1513 */       if ((e == null) || ((!this.top) && (Long2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1514 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2ObjectAVLTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1521 */       if (Long2ObjectAVLTreeMap.this.tree == null) return null;
/* 1524 */       Long2ObjectAVLTreeMap.Entry e;
/*      */       Long2ObjectAVLTreeMap.Entry e;
/* 1524 */       if (this.top) { e = Long2ObjectAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1526 */         e = Long2ObjectAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1528 */         if (Long2ObjectAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1531 */       if ((e == null) || ((!this.bottom) && (Long2ObjectAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1532 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1535 */       Long2ObjectAVLTreeMap.Entry e = firstEntry();
/* 1536 */       if (e == null) throw new NoSuchElementException();
/* 1537 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1540 */       Long2ObjectAVLTreeMap.Entry e = lastEntry();
/* 1541 */       if (e == null) throw new NoSuchElementException();
/* 1542 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1545 */       Long2ObjectAVLTreeMap.Entry e = firstEntry();
/* 1546 */       if (e == null) throw new NoSuchElementException();
/* 1547 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1550 */       Long2ObjectAVLTreeMap.Entry e = lastEntry();
/* 1551 */       if (e == null) throw new NoSuchElementException();
/* 1552 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2ObjectAVLTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2ObjectAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2ObjectAVLTreeMap<V>.Submap.SubmapIterator
...
/* 1595 */       public Long2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1596 */       public void set(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1597 */       public void add(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Long2ObjectAVLTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1562 */         super();
/* 1563 */         this.next = Long2ObjectAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1566 */         this();
/* 1567 */         if (this.next != null)
/* 1568 */           if ((!Long2ObjectAVLTreeMap.Submap.this.bottom) && (Long2ObjectAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1569 */           } else if ((!Long2ObjectAVLTreeMap.Submap.this.top) && (Long2ObjectAVLTreeMap.this.compare(k, (this.prev = Long2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1571 */             this.next = Long2ObjectAVLTreeMap.this.locateKey(k);
/* 1572 */             if (Long2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1582 */         if ((!Long2ObjectAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2ObjectAVLTreeMap.this.compare(this.prev.key, Long2ObjectAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1585 */         this.next = this.next.next();
/* 1586 */         if ((!Long2ObjectAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2ObjectAVLTreeMap.this.compare(this.next.key, Long2ObjectAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1403 */         super(); } 
/* 1404 */       public LongBidirectionalIterator iterator() { return new Long2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Long2ObjectAVLTreeMap.Submap.this); } 
/* 1405 */       public LongBidirectionalIterator iterator(long from) { return new Long2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Long2ObjectAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2ObjectAVLTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1237 */       super(); } 
/* 1238 */     public LongBidirectionalIterator iterator() { return new Long2ObjectAVLTreeMap.KeyIterator(Long2ObjectAVLTreeMap.this); } 
/* 1239 */     public LongBidirectionalIterator iterator(long from) { return new Long2ObjectAVLTreeMap.KeyIterator(Long2ObjectAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2ObjectAVLTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2ObjectAVLTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Long2ObjectMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1173 */     public Long2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1174 */     public void set(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1175 */     public void add(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1100 */     int index = 0;
/*      */ 
/* 1102 */     TreeIterator() { this.next = Long2ObjectAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1105 */       if ((this.next = Long2ObjectAVLTreeMap.this.locateKey(k)) != null)
/* 1106 */         if (Long2ObjectAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1147 */       updatePrevious();
/* 1148 */       updateNext();
/* 1149 */       Long2ObjectAVLTreeMap.this.remove(this.curr.key);
/* 1150 */       this.curr = null;
/*      */     }
...
/* 1025 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/* 1028 */       return HashCommon.long2int(this.key) ^ (this.value == null ? 0 : this.value.hashCode());
/*      */     }
