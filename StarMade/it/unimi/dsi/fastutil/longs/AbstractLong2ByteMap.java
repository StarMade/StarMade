...
/*     */     {
/*  92 */       while (n-- != 0) {
/*  93 */         Long2ByteMap.Entry e = (Long2ByteMap.Entry)i.next();
/*  94 */         put(e.getLongKey(), e.getByteValue());
/*     */       }
/*     */     }
/*     */     else
/*     */     {
...
/* 101 */         put((Long)e.getKey(), (Byte)e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 193 */         return AbstractLong2ByteMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractLong2ByteMap.this.size(); } 
/* 196 */       public void clear() { AbstractLong2ByteMap.this.clear(); }
/*     */ 
/*     */       public LongIterator iterator() {
/* 199 */         return new AbstractLongIterator() {
/* 200 */           final ObjectIterator<Map.Entry<Long, Byte>> i = AbstractLong2ByteMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public long nextLong() { return ((Long2ByteMap.Entry)this.i.next()).getLongKey(); } 
...
/* 226 */         return AbstractLong2ByteMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractLong2ByteMap.this.size(); } 
/* 229 */       public void clear() { AbstractLong2ByteMap.this.clear(); }
/*     */ 
/*     */       public ByteIterator iterator() {
/* 232 */         return new AbstractByteIterator() {
/* 233 */           final ObjectIterator<Map.Entry<Long, Byte>> i = AbstractLong2ByteMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public byte nextByte() { return ((Long2ByteMap.Entry)this.i.next()).getByteValue(); } 
/*     */           public boolean hasNext() {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Long2ByteMap.Entry e = (Long2ByteMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
