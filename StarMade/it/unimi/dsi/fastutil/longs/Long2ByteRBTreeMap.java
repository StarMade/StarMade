  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2ByteRBTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2ByteRBTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2ByteRBTreeMap(Map<? extends Long, ? extends Byte> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2ByteRBTreeMap(SortedMap<Long, Byte> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2ByteRBTreeMap(Long2ByteMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2ByteRBTreeMap(Long2ByteSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2ByteRBTreeMap(long[] local_k, byte[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2ByteRBTreeMap(long[] local_k, byte[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Long2ByteMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Long2ByteRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2ByteRBTreeMap.EntryIterator(Long2ByteRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry from)
        {
          return new Long2ByteRBTreeMap.EntryIterator(Long2ByteRBTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2ByteRBTreeMap.Entry local_f = Long2ByteRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2ByteRBTreeMap.Entry local_f = Long2ByteRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2ByteRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Long2ByteRBTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2ByteEntrySet();
        }
        
        public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry local_to)
        {
          return Long2ByteRBTreeMap.this.headMap((Long)local_to.getKey()).long2ByteEntrySet();
        }
        
        public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry from)
        {
          return Long2ByteRBTreeMap.this.tailMap((Long)from.getKey()).long2ByteEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Long2ByteRBTreeMap.ValueIterator(Long2ByteRBTreeMap.this, null);
        }
        
        public boolean contains(byte local_k)
        {
          return Long2ByteRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2ByteRBTreeMap local_c;
    try
    {
      local_c = (Long2ByteRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2ByteRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2ByteRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2ByteRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator()
          {
            return new Long2ByteRBTreeMap.Submap.SubmapEntryIterator(Long2ByteRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry from)
          {
            return new Long2ByteRBTreeMap.Submap.SubmapEntryIterator(Long2ByteRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Byte> local_e = (Map.Entry)local_o;
            Long2ByteRBTreeMap.Entry local_f = Long2ByteRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2ByteRBTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Byte> local_e = (Map.Entry)local_o;
            Long2ByteRBTreeMap.Entry local_f = Long2ByteRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2ByteRBTreeMap.Submap.this.in1(local_f.key))) {
              Long2ByteRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2ByteRBTreeMap.Submap.SubmapIterator(Long2ByteRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2ByteRBTreeMap.Submap.this.clear();
          }
          
          public Long2ByteMap.Entry first()
          {
            return Long2ByteRBTreeMap.Submap.this.firstEntry();
          }
          
          public Long2ByteMap.Entry last()
          {
            return Long2ByteRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry from, Long2ByteMap.Entry local_to)
          {
            return Long2ByteRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2ByteEntrySet();
          }
          
          public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry local_to)
          {
            return Long2ByteRBTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2ByteEntrySet();
          }
          
          public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry from)
          {
            return Long2ByteRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2ByteEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ByteCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractByteCollection()
        {
          public ByteIterator iterator()
          {
            return new Long2ByteRBTreeMap.Submap.SubmapValueIterator(Long2ByteRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(byte local_k)
          {
            return Long2ByteRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2ByteRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2ByteRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2ByteRBTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2ByteRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public byte put(long local_k, byte local_v)
    {
      ...
      byte oldValue = Long2ByteRBTreeMap.this.put(local_k, local_v);
    ...
    public byte remove(long local_k)
    {
      ...
      byte oldValue = Long2ByteRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2ByteRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2ByteRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2ByteSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2ByteRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2ByteRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2ByteSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2ByteRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2ByteRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2ByteRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2ByteRBTreeMap.this.locateKey(this.from);
        if (Long2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2ByteRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2ByteRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2ByteRBTreeMap.this.locateKey(this.field_47);
        if (Long2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2ByteRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2ByteRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Long2ByteRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2ByteRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2ByteRBTreeMap.Submap.this.bottom) && (Long2ByteRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2ByteRBTreeMap.Submap.this.top) && (Long2ByteRBTreeMap.this.compare(local_k, (this.prev = Long2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2ByteRBTreeMap.this.locateKey(local_k);
            if (Long2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2ByteRBTreeMap.this.compare(this.prev.key, Long2ByteRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Long2ByteRBTreeMap.this.compare(this.next.key, Long2ByteRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2ByteSortedMap.KeySet
    {
      ...
      {
        return new Long2ByteRBTreeMap.Submap.SubmapKeyIterator(Long2ByteRBTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2ByteRBTreeMap.Submap.SubmapKeyIterator(Long2ByteRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2ByteSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2ByteRBTreeMap.KeyIterator(Long2ByteRBTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2ByteRBTreeMap.KeyIterator(Long2ByteRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2ByteRBTreeMap.this.locateKey(local_k)) != null) {
        if (Long2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
