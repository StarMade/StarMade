...
/*     */ 
/*     */ public class Long2ByteOpenHashMap extends AbstractLong2ByteMap
...
/* 642 */           return new Long2ByteOpenHashMap.ValueIterator(Long2ByteOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Long2ByteOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(byte v) {
/* 648 */           return Long2ByteOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Long2ByteOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Long2ByteOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Long2ByteOpenHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public byte nextByte() { return Long2ByteOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Byte next() { return Byte.valueOf(Long2ByteOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Long2ByteOpenHashMap.KeyIterator(Long2ByteOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Long2ByteOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(long k) {
/* 613 */       return Long2ByteOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(long k) {
/* 616 */       int oldSize = Long2ByteOpenHashMap.this.size;
/* 617 */       Long2ByteOpenHashMap.this.remove(k);
/* 618 */       return Long2ByteOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Long2ByteOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Long2ByteOpenHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public long nextLong() { return Long2ByteOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Long next() { return Long.valueOf(Long2ByteOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Long2ByteOpenHashMap.EntryIterator(Long2ByteOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Long2ByteMap.Entry> fastIterator() {
/* 550 */       return new Long2ByteOpenHashMap.FastEntryIterator(Long2ByteOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ByteOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Long2ByteOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Long2ByteOpenHashMap.this.key[pos] == k) return Long2ByteOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 562 */         pos = pos + 1 & Long2ByteOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ByteOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Long2ByteOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Long2ByteOpenHashMap.this.key[pos] == k) {
/* 576 */           Long2ByteOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Long2ByteOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Long2ByteOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Long2ByteOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Long2ByteOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Long2ByteMap.Entry>
/*     */   {
/* 537 */     final AbstractLong2ByteMap.BasicEntry entry = new AbstractLong2ByteMap.BasicEntry(0L, (byte)0);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Long2ByteOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Long2ByteOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Long2ByteOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Long2ByteMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Long2ByteOpenHashMap.MapEntry(Long2ByteOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Long2ByteOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Long2ByteOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Long2ByteOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Long2ByteOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = (int)HashCommon.murmurHash3(k) & Long2ByteOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Long2ByteOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Long2ByteOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Long2ByteOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Long2ByteOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Long2ByteOpenHashMap.this.mask;
/* 485 */         while (Long2ByteOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = (int)HashCommon.murmurHash3(Long2ByteOpenHashMap.this.key[pos]) & Long2ByteOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Long2ByteOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Long2ByteOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 494 */           this.wrapped.add(Long2ByteOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Long2ByteOpenHashMap.this.key[last] = Long2ByteOpenHashMap.this.key[pos];
/* 497 */         Long2ByteOpenHashMap.this.value[last] = Long2ByteOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Long2ByteOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Long2ByteOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Long2ByteOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Long getKey() {
/* 398 */       return Long.valueOf(Long2ByteOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public long getLongKey() {
/* 401 */       return Long2ByteOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Byte getValue() {
/* 404 */       return Byte.valueOf(Long2ByteOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public byte getByteValue() {
/* 407 */       return Long2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public byte setValue(byte v) {
/* 410 */       byte oldValue = Long2ByteOpenHashMap.this.value[this.index];
/* 411 */       Long2ByteOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Byte setValue(Byte v) {
...
/* 421 */       return (Long2ByteOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return HashCommon.long2int(Long2ByteOpenHashMap.this.key[this.index]) ^ Long2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 427 */       return Long2ByteOpenHashMap.this.key[this.index] + "=>" + Long2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
