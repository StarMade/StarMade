...
/*  18:    */
/*  87:    */public class Long2ByteOpenHashMap
/*  88:    */  extends AbstractLong2ByteMap
...
/* 101:    */  protected volatile transient Long2ByteMap.FastEntrySet entries;
/* 102:    */  protected volatile transient LongSet keys;
/* 103:    */  protected volatile transient ByteCollection values;
/* 104:    */  
/* 105:    */  public Long2ByteOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Long2ByteOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Long2ByteOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Long2ByteOpenHashMap(Map<? extends Long, ? extends Byte> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Long2ByteOpenHashMap(Map<? extends Long, ? extends Byte> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Long2ByteOpenHashMap(Long2ByteMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Long2ByteOpenHashMap(Long2ByteMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Long2ByteOpenHashMap(long[] k, byte[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Long2ByteOpenHashMap(long[] k, byte[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public byte put(long k, byte v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Byte put(Long ok, Byte ov) { byte v = ov.byteValue();
...
/* 226:    */  }
/* 227:    */  
/* 238:    */  public byte add(long k, byte incr)
/* 239:    */  {
...
/* 245:245 */          tmp49_47 = pos; byte[] tmp49_44 = this.value;tmp49_44[tmp49_47] = ((byte)(tmp49_44[tmp49_47] + incr));
...
/* 312:    */  }
/* 313:    */  
/* 314:314 */  public Byte get(Long ok) { long k = ok.longValue();
/* 315:    */    
...
/* 389:    */    implements Long2ByteMap.Entry, Map.Entry<Long, Byte>
/* 390:    */  {
...
/* 396:    */    }
/* 397:    */    
/* 398:398 */    public Long getKey() { return Long.valueOf(Long2ByteOpenHashMap.this.key[this.index]); }
/* 399:    */    
/* 400:    */    public long getLongKey() {
/* 401:401 */      return Long2ByteOpenHashMap.this.key[this.index];
/* 402:    */    }
/* 403:    */    
/* 404:404 */    public Byte getValue() { return Byte.valueOf(Long2ByteOpenHashMap.this.value[this.index]); }
/* 405:    */    
/* 407:407 */    public byte getByteValue() { return Long2ByteOpenHashMap.this.value[this.index]; }
/* 408:    */    
/* 409:    */    public byte setValue(byte v) {
/* 410:410 */      byte oldValue = Long2ByteOpenHashMap.this.value[this.index];
/* 411:411 */      Long2ByteOpenHashMap.this.value[this.index] = v;
...
/* 420:420 */      Map.Entry<Long, Byte> e = (Map.Entry)o;
/* 421:421 */      return (Long2ByteOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public int hashCode() { return HashCommon.long2int(Long2ByteOpenHashMap.this.key[this.index]) ^ Long2ByteOpenHashMap.this.value[this.index]; }
/* 425:    */    
/* 427:427 */    public String toString() { return Long2ByteOpenHashMap.this.key[this.index] + "=>" + Long2ByteOpenHashMap.this.value[this.index]; } }
/* 428:    */  
...
/* 433:    */    
/* 434:434 */    private MapIterator() { this.pos = Long2ByteOpenHashMap.this.n;
/* 435:    */      
/* 437:437 */      this.last = -1;
/* 438:    */      
/* 439:439 */      this.c = Long2ByteOpenHashMap.this.size;
/* 440:    */      
/* 444:444 */      boolean[] used = Long2ByteOpenHashMap.this.used;
...
/* 456:    */        
/* 457:457 */        int pos = (int)HashCommon.murmurHash3(k) & Long2ByteOpenHashMap.this.mask;
/* 458:    */        
/* 459:459 */        while (Long2ByteOpenHashMap.this.used[pos] != 0) {
/* 460:460 */          if (Long2ByteOpenHashMap.this.key[pos] == k) return pos;
/* 461:461 */          pos = pos + 1 & Long2ByteOpenHashMap.this.mask;
/* 462:    */        }
/* 463:    */      }
/* 464:464 */      this.last = this.pos;
/* 465:    */      
/* 466:466 */      if (this.c != 0) {
/* 467:467 */        boolean[] used = Long2ByteOpenHashMap.this.used;
...
/* 482:    */      for (;;)
/* 483:    */      {
/* 484:484 */        pos = (last = pos) + 1 & Long2ByteOpenHashMap.this.mask;
/* 485:485 */        while (Long2ByteOpenHashMap.this.used[pos] != 0) {
/* 486:486 */          int slot = (int)HashCommon.murmurHash3(Long2ByteOpenHashMap.this.key[pos]) & Long2ByteOpenHashMap.this.mask;
/* 487:487 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488:488 */          pos = pos + 1 & Long2ByteOpenHashMap.this.mask;
/* 489:    */        }
/* 490:490 */        if (Long2ByteOpenHashMap.this.used[pos] == 0) break;
/* 491:491 */        if (pos < last)
/* 492:    */        {
/* 493:493 */          if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 494:494 */          this.wrapped.add(Long2ByteOpenHashMap.this.key[pos]);
/* 495:    */        }
/* 496:496 */        Long2ByteOpenHashMap.this.key[last] = Long2ByteOpenHashMap.this.key[pos];
/* 497:497 */        Long2ByteOpenHashMap.this.value[last] = Long2ByteOpenHashMap.this.value[pos];
/* 498:    */      }
/* 499:499 */      Long2ByteOpenHashMap.this.used[last] = false;
/* 500:500 */      return last;
/* 501:    */    }
/* 502:    */    
...
/* 506:    */      {
/* 507:507 */        Long2ByteOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 508:508 */        this.last = -1;
/* 509:509 */        return;
/* 510:    */      }
/* 511:511 */      Long2ByteOpenHashMap.this.size -= 1;
...
/* 523:    */    } }
/* 524:    */  
/* 525:525 */  private class EntryIterator extends Long2ByteOpenHashMap.MapIterator implements ObjectIterator<Long2ByteMap.Entry> { private EntryIterator() { super(null); }
/* 526:    */    
/* 527:    */    private Long2ByteOpenHashMap.MapEntry entry;
/* 528:528 */    public Long2ByteMap.Entry next() { return this.entry = new Long2ByteOpenHashMap.MapEntry(Long2ByteOpenHashMap.this, nextEntry()); }
/* 529:    */    
/* 530:    */    public void remove()
/* 531:    */    {
/* 532:532 */      super.remove();
/* 533:533 */      Long2ByteOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 534:    */    } }
/* 535:    */  
/* 536:536 */  private class FastEntryIterator extends Long2ByteOpenHashMap.MapIterator implements ObjectIterator<Long2ByteMap.Entry> { private FastEntryIterator() { super(null); }
/* 537:537 */    final AbstractLong2ByteMap.BasicEntry entry = new AbstractLong2ByteMap.BasicEntry(0L, (byte)0);
/* 538:    */    
/* 539:539 */    public AbstractLong2ByteMap.BasicEntry next() { int e = nextEntry();
/* 540:540 */      this.entry.key = Long2ByteOpenHashMap.this.key[e];
/* 541:541 */      this.entry.value = Long2ByteOpenHashMap.this.value[e];
/* 542:542 */      return this.entry;
/* 543:    */    } }
/* 544:    */  
/* 545:    */  private final class MapEntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteMap.FastEntrySet { private MapEntrySet() {}
/* 546:    */    
/* 547:547 */    public ObjectIterator<Long2ByteMap.Entry> iterator() { return new Long2ByteOpenHashMap.EntryIterator(Long2ByteOpenHashMap.this, null); }
/* 548:    */    
/* 549:    */    public ObjectIterator<Long2ByteMap.Entry> fastIterator() {
/* 550:550 */      return new Long2ByteOpenHashMap.FastEntryIterator(Long2ByteOpenHashMap.this, null);
/* 551:    */    }
/* 552:    */    
/* 553:    */    public boolean contains(Object o) {
/* 554:554 */      if (!(o instanceof Map.Entry)) return false;
/* 555:555 */      Map.Entry<Long, Byte> e = (Map.Entry)o;
/* 556:556 */      long k = ((Long)e.getKey()).longValue();
/* 557:    */      
/* 558:558 */      int pos = (int)HashCommon.murmurHash3(k) & Long2ByteOpenHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Long2ByteOpenHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Long2ByteOpenHashMap.this.key[pos] == k) return Long2ByteOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 562:562 */        pos = pos + 1 & Long2ByteOpenHashMap.this.mask;
/* 563:    */      }
...
/* 569:569 */      Map.Entry<Long, Byte> e = (Map.Entry)o;
/* 570:570 */      long k = ((Long)e.getKey()).longValue();
/* 571:    */      
/* 572:572 */      int pos = (int)HashCommon.murmurHash3(k) & Long2ByteOpenHashMap.this.mask;
/* 573:    */      
/* 574:574 */      while (Long2ByteOpenHashMap.this.used[pos] != 0) {
/* 575:575 */        if (Long2ByteOpenHashMap.this.key[pos] == k) {
/* 576:576 */          Long2ByteOpenHashMap.this.remove(e.getKey());
/* 577:577 */          return true;
/* 578:    */        }
/* 579:579 */        pos = pos + 1 & Long2ByteOpenHashMap.this.mask;
/* 580:    */      }
/* 581:581 */      return false;
/* 582:    */    }
/* 583:    */    
/* 584:584 */    public int size() { return Long2ByteOpenHashMap.this.size; }
/* 585:    */    
/* 587:587 */    public void clear() { Long2ByteOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public Long2ByteMap.FastEntrySet long2ByteEntrySet() {
...
/* 598:    */    extends Long2ByteOpenHashMap.MapIterator
/* 599:    */    implements LongIterator
/* 600:    */  {
/* 601:601 */    public KeyIterator() { super(null); }
/* 602:602 */    public long nextLong() { return Long2ByteOpenHashMap.this.key[nextEntry()]; }
/* 603:603 */    public Long next() { return Long.valueOf(Long2ByteOpenHashMap.this.key[nextEntry()]); } }
/* 604:    */  
/* 605:    */  private final class KeySet extends AbstractLongSet { private KeySet() {}
/* 606:    */    
/* 607:607 */    public LongIterator iterator() { return new Long2ByteOpenHashMap.KeyIterator(Long2ByteOpenHashMap.this); }
/* 608:    */    
/* 609:    */    public int size() {
/* 610:610 */      return Long2ByteOpenHashMap.this.size;
/* 611:    */    }
/* 612:    */    
/* 613:613 */    public boolean contains(long k) { return Long2ByteOpenHashMap.this.containsKey(k); }
/* 614:    */    
/* 615:    */    public boolean remove(long k) {
/* 616:616 */      int oldSize = Long2ByteOpenHashMap.this.size;
/* 617:617 */      Long2ByteOpenHashMap.this.remove(k);
/* 618:618 */      return Long2ByteOpenHashMap.this.size != oldSize;
/* 619:    */    }
/* 620:    */    
/* 621:621 */    public void clear() { Long2ByteOpenHashMap.this.clear(); }
/* 622:    */  }
/* 623:    */  
...
/* 632:    */    extends Long2ByteOpenHashMap.MapIterator
/* 633:    */    implements ByteIterator
/* 634:    */  {
/* 635:635 */    public ValueIterator() { super(null); }
/* 636:636 */    public byte nextByte() { return Long2ByteOpenHashMap.this.value[nextEntry()]; }
/* 637:637 */    public Byte next() { return Byte.valueOf(Long2ByteOpenHashMap.this.value[nextEntry()]); }
/* 638:    */  }
/* 639:    */  
...
/* 642:642 */          return new Long2ByteOpenHashMap.ValueIterator(Long2ByteOpenHashMap.this);
/* 643:    */        }
/* 644:    */        
/* 645:645 */        public int size() { return Long2ByteOpenHashMap.this.size; }
/* 646:    */        
/* 647:    */        public boolean contains(byte v) {
/* 648:648 */          return Long2ByteOpenHashMap.this.containsValue(v);
/* 649:    */        }
/* 650:    */        
/* 651:651 */        public void clear() { Long2ByteOpenHashMap.this.clear(); }
/* 652:    */      };
/* 653:    */    }
...
/* 754:    */  }
/* 755:    */  
/* 759:    */  public Long2ByteOpenHashMap clone()
/* 760:    */  {
/* 761:    */    Long2ByteOpenHashMap c;
/* 762:    */    
/* 764:    */    try
/* 765:    */    {
/* 766:766 */      c = (Long2ByteOpenHashMap)super.clone();
/* 767:    */    }
