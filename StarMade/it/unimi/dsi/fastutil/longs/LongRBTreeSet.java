...
/*      */ 
/*      */ public class LongRBTreeSet extends AbstractLongSortedSet
...
/*   97 */           return LongRBTreeSet.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  100 */           return LongRBTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   public LongRBTreeSet(Iterator<? extends Long> i)
/*      */   {
...
/* 1028 */     return new Subset(0L, true, to, false);
/*      */   }
/*      */   public LongSortedSet tailSet(long from) {
/* 1031 */     return new Subset(from, false, 0L, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1226 */       c = (LongRBTreeSet)super.clone();
/*      */     }
...
/* 1279 */     while (n-- != 0) s.writeLong(i.nextLong());
/*      */   }
/*      */ 
...
/*      */   {
/* 1290 */     if (n == 1) {
/* 1291 */       Entry top = new Entry(s.readLong());
/* 1292 */       top.pred(pred);
/* 1293 */       top.succ(succ);
/* 1294 */       top.black(true);
/* 1295 */       return top;
...
/* 1297 */     if (n == 2)
/*      */     {
/* 1300 */       Entry top = new Entry(s.readLong());
/* 1301 */       top.black(true);
/* 1302 */       top.right(new Entry(s.readLong()));
...
/*      */     {
/* 1063 */       if ((!bottom) && (!top) && (LongRBTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1064 */       this.from = from;
...
/*      */     {
/* 1081 */       return ((this.bottom) || (LongRBTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (LongRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(long k)
/*      */     {
/* 1086 */       return (in(k)) && (LongRBTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(long k) {
...
/* 1090 */       return LongRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(long k) {
/* 1094 */       if (!in(k)) return false;
/* 1095 */       return LongRBTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1110 */       return LongRBTreeSet.this.actualComparator;
/*      */     }
/*      */     public LongBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public LongSortedSet headSet(long to) {
/* 1119 */       if (this.top) return new Subset(LongRBTreeSet.this, this.from, this.bottom, to, false);
/* 1120 */       return LongRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(LongRBTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public LongSortedSet tailSet(long from) {
/* 1123 */       if (this.bottom) return new Subset(LongRBTreeSet.this, from, false, this.to, this.top);
/* 1124 */       return LongRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(LongRBTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public LongSortedSet subSet(long from, long to) {
/* 1127 */       if ((this.top) && (this.bottom)) return new Subset(LongRBTreeSet.this, from, false, to, false);
...
/* 1131 */       return new Subset(LongRBTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public LongRBTreeSet.Entry firstEntry()
/*      */     {
/* 1138 */       if (LongRBTreeSet.this.tree == null) return null;
/* 1141 */       LongRBTreeSet.Entry e;
/*      */       LongRBTreeSet.Entry e;
/* 1141 */       if (this.bottom) { e = LongRBTreeSet.this.firstEntry;
/*      */       } else {
/* 1143 */         e = LongRBTreeSet.this.locateKey(this.from);
/*      */ 
/* 1145 */         if (LongRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1148 */       if ((e == null) || ((!this.top) && (LongRBTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1149 */       return e;
/*      */     }
/*      */ 
/*      */     public LongRBTreeSet.Entry lastEntry()
/*      */     {
/* 1156 */       if (LongRBTreeSet.this.tree == null) return null;
/* 1159 */       LongRBTreeSet.Entry e;
/*      */       LongRBTreeSet.Entry e;
/* 1159 */       if (this.top) { e = LongRBTreeSet.this.lastEntry;
/*      */       } else {
/* 1161 */         e = LongRBTreeSet.this.locateKey(this.to);
/*      */ 
/* 1163 */         if (LongRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1166 */       if ((e == null) || ((!this.bottom) && (LongRBTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1167 */       return e;
/*      */     }
/*      */     public long firstLong() {
/* 1170 */       LongRBTreeSet.Entry e = firstEntry();
/* 1171 */       if (e == null) throw new NoSuchElementException();
/* 1172 */       return e.key;
/*      */     }
/*      */     public long lastLong() {
/* 1175 */       LongRBTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1187 */         super();
/* 1188 */         this.next = LongRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(long k) {
/* 1191 */         this();
/* 1192 */         if (this.next != null)
/* 1193 */           if ((!LongRBTreeSet.Subset.this.bottom) && (LongRBTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1194 */           } else if ((!LongRBTreeSet.Subset.this.top) && (LongRBTreeSet.this.compare(k, (this.prev = LongRBTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1196 */             this.next = LongRBTreeSet.this.locateKey(k);
/* 1197 */             if (LongRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1207 */         if ((!LongRBTreeSet.Subset.this.bottom) && (this.prev != null) && (LongRBTreeSet.this.compare(this.prev.key, LongRBTreeSet.Subset.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1210 */         this.next = this.next.next();
/* 1211 */         if ((!LongRBTreeSet.Subset.this.top) && (this.next != null) && (LongRBTreeSet.this.compare(this.next.key, LongRBTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*  963 */     int index = 0;
/*      */ 
/*  965 */     SetIterator() { this.next = LongRBTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(long k) {
/*  968 */       if ((this.next = LongRBTreeSet.this.locateKey(k)) != null)
/*  969 */         if (LongRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/*  988 */     public long nextLong() { return nextEntry().key; } 
/*  989 */     public long previousLong() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1012 */       updatePrevious();
/* 1013 */       updateNext();
/* 1014 */       LongRBTreeSet.this.remove(this.curr.key);
/* 1015 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*      */     }
/*      */     public int hashCode() {
/*  900 */       return HashCommon.long2int(this.key);
/*      */     }
