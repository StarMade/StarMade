  ...
  implements Serializable, Cloneable, LongSortedSet
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return LongRBTreeSet.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public LongRBTreeSet(Comparator<? super Long> local_c)
  {
    this();
  ...
  public LongRBTreeSet(Collection<? extends Long> local_c)
  {
    this();
    addAll(local_c);
  }
  
  public LongRBTreeSet(SortedSet<Long> local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public LongRBTreeSet(LongCollection local_c)
  {
    this();
    addAll(local_c);
  }
  
  public LongRBTreeSet(LongSortedSet local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public LongRBTreeSet(LongIterator local_i)
  {
    allocatePaths();
  ...
  public LongRBTreeSet(Iterator<? extends Long> local_i)
  {
    this(LongIterators.asLongIterator(local_i));
  }
  
  public LongRBTreeSet(long[] local_a, int offset, int length, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public LongRBTreeSet(long[] local_a, int offset, int length)
  {
    this(local_a, offset, length, null);
  }
  
  public LongRBTreeSet(long[] local_a)
  {
    this();
  ...
  public LongRBTreeSet(long[] local_a, Comparator<? super Long> local_c)
  {
    this(local_c);
    int local_i = local_a.length;
    while (local_i-- != 0) {
  ...
  public Object clone()
  {
    LongRBTreeSet local_c;
    try
    {
      local_c = (LongRBTreeSet)super.clone();
    }
    ...
    implements Serializable, LongSortedSet
  {
    ...
    {
      if ((!bottom) && (!top) && (LongRBTreeSet.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (LongRBTreeSet.this.compare(local_k, this.from) >= 0)) && ((this.top) || (LongRBTreeSet.this.compare(local_k, this.field_303) < 0));
    }
    
    public boolean contains(long local_k)
    {
      return (in(local_k)) && (LongRBTreeSet.this.contains(local_k));
    }
    ...
    public boolean add(long local_k)
    {
      ...
      return LongRBTreeSet.this.add(local_k);
    }
    ...
    public boolean remove(long local_k)
    {
      ...
      return LongRBTreeSet.this.remove(local_k);
    }
    ...
    {
      if (this.top) {
        return new Subset(LongRBTreeSet.this, this.from, this.bottom, local_to, false);
      }
      return LongRBTreeSet.this.compare(local_to, this.field_303) < 0 ? new Subset(LongRBTreeSet.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public LongSortedSet tailSet(long from)
    {
      if (this.bottom) {
        return new Subset(LongRBTreeSet.this, from, false, this.field_303, this.top);
      }
      return LongRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(LongRBTreeSet.this, from, false, this.field_303, this.top) : this;
    }
    
    public LongSortedSet subSet(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Subset(LongRBTreeSet.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = LongRBTreeSet.this.compare(local_to, this.field_303) < 0 ? local_to : this.field_303;
      }
      if (!this.bottom) {
    ...
    public LongRBTreeSet.Entry firstEntry()
    {
      ...
      LongRBTreeSet.Entry local_e;
      LongRBTreeSet.Entry local_e;
      if (this.bottom)
      {
        local_e = LongRBTreeSet.this.firstEntry;
      }
      else
      {
        local_e = LongRBTreeSet.this.locateKey(this.from);
        if (LongRBTreeSet.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (LongRBTreeSet.this.compare(local_e.key, this.field_303) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public LongRBTreeSet.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = LongRBTreeSet.this.lastEntry;
      }
      else
      {
        local_e = LongRBTreeSet.this.locateKey(this.field_303);
        if (LongRBTreeSet.this.compare(local_e.key, this.field_303) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (LongRBTreeSet.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLong()
    {
      LongRBTreeSet.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLong()
    {
      LongRBTreeSet.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends LongRBTreeSet.SetIterator
    {
      ...
      {
        super();
        this.next = LongRBTreeSet.Subset.this.firstEntry();
      }
      ...
      SubsetIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!LongRBTreeSet.Subset.this.bottom) && (LongRBTreeSet.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!LongRBTreeSet.Subset.this.top) && (LongRBTreeSet.this.compare(local_k, (this.prev = LongRBTreeSet.Subset.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = LongRBTreeSet.this.locateKey(local_k);
            if (LongRBTreeSet.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!LongRBTreeSet.Subset.this.bottom) && (this.prev != null) && (LongRBTreeSet.this.compare(this.prev.key, LongRBTreeSet.Subset.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!LongRBTreeSet.Subset.this.top) && (this.next != null) && (LongRBTreeSet.this.compare(this.next.key, LongRBTreeSet.Subset.this.field_303) >= 0)) {
          this.next = null;
        }
      }
    }
    ...
    extends AbstractLongListIterator
  {
    ...
    {
      if ((this.next = LongRBTreeSet.this.locateKey(local_k)) != null) {
        if (LongRBTreeSet.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
