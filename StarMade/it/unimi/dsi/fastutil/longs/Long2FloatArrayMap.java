...
/*  17:    */
/*  66:    */public class Long2FloatArrayMap
/*  67:    */  extends AbstractLong2FloatMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Long2FloatArrayMap(long[] key, float[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Long2FloatArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = LongArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = FloatArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Long2FloatArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new long[capacity];
/*  94: 94 */    this.value = new float[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Long2FloatArrayMap(Long2FloatMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Long2FloatArrayMap(Map<? extends Long, ? extends Float> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Long2FloatArrayMap(long[] key, float[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Long2FloatMap.Entry> implements Long2FloatMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Long2FloatMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Long2FloatArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Long2FloatMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractLong2FloatMap.BasicEntry(Long2FloatArrayMap.this.key[this.next], Long2FloatArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Long2FloatMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractLong2FloatMap.BasicEntry entry = new AbstractLong2FloatMap.BasicEntry(0L, 0.0F);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Long2FloatArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Long2FloatMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Long2FloatArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Long2FloatArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Long2FloatArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Long, Float> e = (Map.Entry)o;
/* 165:165 */      long k = ((Long)e.getKey()).longValue();
/* 166:166 */      return (Long2FloatArrayMap.this.containsKey(k)) && (Long2FloatArrayMap.this.get(k) == ((Float)e.getValue()).floatValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Long2FloatMap.FastEntrySet long2FloatEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public float put(long k, float v)
/* 213:    */  {
...
/* 234:    */  }
/* 235:    */  
/* 236:    */  public float remove(long k)
/* 237:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Long2FloatArrayMap clone()
/* 263:    */  {
/* 264:    */    Long2FloatArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Long2FloatArrayMap)super.clone();
/* 270:    */    }
