...
/*  344 */         int slot = (int)HashCommon.murmurHash3(this.key[pos]) & this.mask;
...
/*      */   {
/*  359 */     int pos = (int)HashCommon.murmurHash3(k) & this.mask;
/*      */ 
/*  361 */     while (this.used[pos] != 0) {
/*  362 */       if (this.key[pos] == k) {
/*  363 */         this.size -= 1;
/*  364 */         fixPointers(pos);
/*  365 */         double v = this.value[pos];
/*  366 */         shiftKeys(pos);
/*  367 */         return v;
/*      */       }
...
/*  375 */     long k = ((Long)ok).longValue();
/*      */ 
/*  377 */     int pos = (int)HashCommon.murmurHash3(k) & this.mask;
/*      */ 
/*  379 */     while (this.used[pos] != 0) {
/*  380 */       if (this.key[pos] == k) {
/*  381 */         this.size -= 1;
/*  382 */         fixPointers(pos);
/*  383 */         double v = this.value[pos];
/*  384 */         shiftKeys(pos);
/*  385 */         return Double.valueOf(v);
/*      */       }
...
/*      */ 
/*  473 */     int pos = (int)HashCommon.murmurHash3(k) & mask;
/*      */ 
...
/*      */   {
/*  490 */     long[] key = this.key;
/*  491 */     boolean[] used = this.used;
/*  492 */     int mask = this.mask;
/*      */ 
/*  494 */     int pos = (int)HashCommon.murmurHash3(k) & mask;
/*      */ 
...
/*  519 */       if (k == key[pos]) {
/*  520 */         double oldValue = this.value[pos];
...
/*  558 */       if (k == key[pos]) {
/*  559 */         double oldValue = this.value[pos];
...
/*  584 */     long k = ok.longValue();
/*      */ 
/*  586 */     int pos = (int)HashCommon.murmurHash3(k) & this.mask;
/*      */ 
/*  588 */     while (this.used[pos] != 0) {
/*  589 */       if (this.key[pos] == k) return Double.valueOf(this.value[pos]);
...
/*      */   {
/*  597 */     int pos = (int)HashCommon.murmurHash3(k) & this.mask;
/*      */ 
...
/*      */   {
/*  608 */     int pos = (int)HashCommon.murmurHash3(k) & this.mask;
/*      */ 
...
/*      */   }
/*  785 */   public LongComparator comparator() { return null; } 
/*  786 */   public Long2DoubleSortedMap tailMap(long from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Long2DoubleSortedMap headMap(long to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Long2DoubleSortedMap subMap(long from, long to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/* 1105 */     if (this.values == null) this.values = new AbstractDoubleCollection() {
/*      */         public DoubleIterator iterator() {
/* 1107 */           return new Long2DoubleLinkedOpenHashMap.ValueIterator(Long2DoubleLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Long2DoubleLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(double v) {
/* 1113 */           return Long2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Long2DoubleLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/* 1197 */     double[] value = this.value;
/* 1198 */     int newMask = newN - 1;
/* 1199 */     long[] newKey = new long[newN];
/* 1200 */     double[] newValue = new double[newN];
...
/*      */     try
/*      */     {
/* 1249 */       c = (Long2DoubleLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1255 */     c.values = null;
/* 1256 */     c.entries = null;
/* 1257 */     c.key = ((long[])this.key.clone());
/* 1258 */     c.value = ((double[])this.value.clone());
...
/* 1276 */       t = HashCommon.long2int(this.key[i]);
/* 1277 */       t ^= HashCommon.double2int(this.value[i]);
/* 1278 */       h += t;
/* 1279 */       i++;
/*      */     }
/* 1281 */     return h;
...
/* 1301 */     double[] value = this.value = new double[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public double previousDouble()
/*      */     {
/* 1094 */       return Long2DoubleLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Double previous() { return Double.valueOf(Long2DoubleLinkedOpenHashMap.this.value[previousEntry()]); } 
/* 1096 */     public void set(Double ok) { throw new UnsupportedOperationException(); } 
/* 1097 */     public void add(Double ok) { throw new UnsupportedOperationException(); } 
/* 1098 */     public void set(double v) { throw new UnsupportedOperationException(); } 
/* 1099 */     public void add(double v) { throw new UnsupportedOperationException(); } 
/* 1100 */     public ValueIterator() { super(null); } 
/* 1101 */     public double nextDouble() { return Long2DoubleLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Double next() { return Double.valueOf(Long2DoubleLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Long2DoubleLinkedOpenHashMap.KeyIterator(Long2DoubleLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public LongListIterator iterator() {
/* 1054 */       return new Long2DoubleLinkedOpenHashMap.KeyIterator(Long2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Long2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(long k) {
/* 1060 */       return Long2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(long k) {
/* 1063 */       int oldSize = Long2DoubleLinkedOpenHashMap.this.size;
/* 1064 */       Long2DoubleLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Long2DoubleLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Long2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public long firstLong() {
/* 1071 */       if (Long2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Long2DoubleLinkedOpenHashMap.this.key[Long2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public long lastLong() {
/* 1075 */       if (Long2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Long2DoubleLinkedOpenHashMap.this.key[Long2DoubleLinkedOpenHashMap.this.last];
/*      */     }
/* 1078 */     public LongComparator comparator() { return null; } 
/* 1079 */     public final LongSortedSet tailSet(long from) { throw new UnsupportedOperationException(); } 
/* 1080 */     public final LongSortedSet headSet(long to) { throw new UnsupportedOperationException(); } 
/* 1081 */     public final LongSortedSet subSet(long from, long to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator(long k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public long previousLong() { return Long2DoubleLinkedOpenHashMap.this.key[previousEntry()]; } 
/* 1040 */     public void set(long k) { throw new UnsupportedOperationException(); } 
/* 1041 */     public void add(long k) { throw new UnsupportedOperationException(); } 
/* 1042 */     public Long previous() { return Long.valueOf(Long2DoubleLinkedOpenHashMap.this.key[previousEntry()]); } 
/* 1043 */     public void set(Long ok) { throw new UnsupportedOperationException(); } 
/* 1044 */     public void add(Long ok) { throw new UnsupportedOperationException(); } 
/* 1045 */     public KeyIterator() { super(null); } 
/* 1046 */     public long nextLong() { return Long2DoubleLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Long next() { return Long.valueOf(Long2DoubleLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Long2DoubleLinkedOpenHashMap.EntryIterator(Long2DoubleLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Long2DoubleMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry fromElement, Long2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Long2DoubleMap.Entry first() {
/*  973 */       if (Long2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Long2DoubleLinkedOpenHashMap.MapEntry(Long2DoubleLinkedOpenHashMap.this, Long2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Long2DoubleMap.Entry last() {
/*  977 */       if (Long2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Long2DoubleLinkedOpenHashMap.MapEntry(Long2DoubleLinkedOpenHashMap.this, Long2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     public boolean contains(Object o) {
/*  982 */       if (!(o instanceof Map.Entry)) return false;
/*  983 */       Map.Entry e = (Map.Entry)o;
/*  984 */       long k = ((Long)e.getKey()).longValue();
/*      */ 
/*  986 */       int pos = (int)HashCommon.murmurHash3(k) & Long2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Long2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Long2DoubleLinkedOpenHashMap.this.key[pos] == k) return Long2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/*  990 */         pos = pos + 1 & Long2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*  998 */       long k = ((Long)e.getKey()).longValue();
/*      */ 
/* 1000 */       int pos = (int)HashCommon.murmurHash3(k) & Long2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Long2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Long2DoubleLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Long2DoubleLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Long2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Long2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Long2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from) {
/* 1018 */       return new Long2DoubleLinkedOpenHashMap.EntryIterator(Long2DoubleLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2DoubleMap.Entry> fastIterator() {
/* 1021 */       return new Long2DoubleLinkedOpenHashMap.FastEntryIterator(Long2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2DoubleMap.Entry> fastIterator(Long2DoubleMap.Entry from) {
/* 1024 */       return new Long2DoubleLinkedOpenHashMap.FastEntryIterator(Long2DoubleLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Long2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2DoubleMap.Entry>
/*      */   {
/*  944 */     final AbstractLong2DoubleMap.BasicEntry entry = new AbstractLong2DoubleMap.BasicEntry(0L, 0.0D);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Long2DoubleLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Long2DoubleLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractLong2DoubleMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Long2DoubleLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Long2DoubleLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2DoubleMap.Entry>
/*      */   {
...
/*  925 */       super(null);
/*      */     }
/*  927 */     public EntryIterator(long from) { super(from, null); }
/*      */ 
/*      */     public Long2DoubleLinkedOpenHashMap.MapEntry next() {
/*  930 */       return this.entry = new Long2DoubleLinkedOpenHashMap.MapEntry(Long2DoubleLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Long2DoubleLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Long2DoubleLinkedOpenHashMap.MapEntry(Long2DoubleLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Long2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Long2DoubleLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(long from) {
/*  809 */       if (Long2DoubleLinkedOpenHashMap.this.key[Long2DoubleLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Long2DoubleLinkedOpenHashMap.this.last;
/*  811 */         this.index = Long2DoubleLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = (int)HashCommon.murmurHash3(from) & Long2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Long2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Long2DoubleLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Long2DoubleLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Long2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Long2DoubleLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Long2DoubleLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Long2DoubleLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Long2DoubleLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Long2DoubleLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Long2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Long2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Long2DoubleLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Long2DoubleLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Long2DoubleLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Long2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Long2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Long2DoubleLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Long2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Long2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Long2DoubleLinkedOpenHashMap.this.mask;
/*  897 */         while (Long2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = (int)HashCommon.murmurHash3(Long2DoubleLinkedOpenHashMap.this.key[pos]) & Long2DoubleLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Long2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Long2DoubleLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Long2DoubleLinkedOpenHashMap.this.key[last] = Long2DoubleLinkedOpenHashMap.this.key[pos];
/*  904 */         Long2DoubleLinkedOpenHashMap.this.value[last] = Long2DoubleLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Long2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Long2DoubleLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Long getKey() {
/*  669 */       return Long.valueOf(Long2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public long getLongKey() {
/*  672 */       return Long2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Double getValue() {
/*  675 */       return Double.valueOf(Long2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public double getDoubleValue() {
/*  678 */       return Long2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public double setValue(double v) {
/*  681 */       double oldValue = Long2DoubleLinkedOpenHashMap.this.value[this.index];
/*  682 */       Long2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Double setValue(Double v) {
/*  686 */       return Double.valueOf(setValue(v.doubleValue()));
/*      */     }
/*      */ 
/*      */     public boolean equals(Object o) {
/*  690 */       if (!(o instanceof Map.Entry)) return false;
/*  691 */       Map.Entry e = (Map.Entry)o;
/*  692 */       return (Long2DoubleLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.long2int(Long2DoubleLinkedOpenHashMap.this.key[this.index]) ^ HashCommon.double2int(Long2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Long2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Long2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
