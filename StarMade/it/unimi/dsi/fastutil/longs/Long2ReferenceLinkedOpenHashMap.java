  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2ReferenceLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2ReferenceLinkedOpenHashMap(Map<? extends Long, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ReferenceLinkedOpenHashMap(Map<? extends Long, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ReferenceLinkedOpenHashMap(Long2ReferenceMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ReferenceLinkedOpenHashMap(Long2ReferenceMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ReferenceLinkedOpenHashMap(long[] local_k, V[] local_v, float local_f)
  {
  ...
  public Long2ReferenceLinkedOpenHashMap(long[] local_k, V[] local_v)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Long2ReferenceLinkedOpenHashMap.ValueIterator(Long2ReferenceLinkedOpenHashMap.this);
        }
        ...
        {
          return Long2ReferenceLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2ReferenceLinkedOpenHashMap<V> local_c;
    try
    {
      local_c = (Long2ReferenceLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    long[] key = this.key;
    V[] value = this.value;
    Long2ReferenceLinkedOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractLongSortedSet
  {
    ...
    {
      return new Long2ReferenceLinkedOpenHashMap.KeyIterator(Long2ReferenceLinkedOpenHashMap.this, from);
    }
    
    public LongListIterator iterator()
    {
      return new Long2ReferenceLinkedOpenHashMap.KeyIterator(Long2ReferenceLinkedOpenHashMap.this);
    }
    ...
    {
      return Long2ReferenceLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2ReferenceLinkedOpenHashMap.this.size;
      Long2ReferenceLinkedOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Long2ReferenceLinkedOpenHashMap.MapIterator
    implements LongListIterator
  {
    ...
    {
      return Long.valueOf(Long2ReferenceLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Long next()
    {
      return Long.valueOf(Long2ReferenceLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2ReferenceSortedMap.FastSortedEntrySet<V>
  {
    ...
    {
      return new Long2ReferenceLinkedOpenHashMap.EntryIterator(Long2ReferenceLinkedOpenHashMap.this);
    }
    ...
    public Long2ReferenceMap.Entry<V> first()
    {
      ...
      return new Long2ReferenceLinkedOpenHashMap.MapEntry(Long2ReferenceLinkedOpenHashMap.this, Long2ReferenceLinkedOpenHashMap.this.first);
    }
    ...
    public Long2ReferenceMap.Entry<V> last()
    {
      ...
      return new Long2ReferenceLinkedOpenHashMap.MapEntry(Long2ReferenceLinkedOpenHashMap.this, Long2ReferenceLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ReferenceLinkedOpenHashMap.this.mask; Long2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ReferenceLinkedOpenHashMap.this.mask) {
        if (Long2ReferenceLinkedOpenHashMap.this.key[pos] == local_k) {
          return Long2ReferenceLinkedOpenHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ReferenceLinkedOpenHashMap.this.mask; Long2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ReferenceLinkedOpenHashMap.this.mask) {
        if (Long2ReferenceLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Long2ReferenceLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Long2ReferenceLinkedOpenHashMap.EntryIterator(Long2ReferenceLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
    
    public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> fastIterator()
    {
      return new Long2ReferenceLinkedOpenHashMap.FastEntryIterator(Long2ReferenceLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> fastIterator(Long2ReferenceMap.Entry<V> from)
    {
      return new Long2ReferenceLinkedOpenHashMap.FastEntryIterator(Long2ReferenceLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
  }
    ...
    implements ObjectListIterator<Long2ReferenceMap.Entry<V>>
  {
    ...
    public AbstractLong2ReferenceMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Long2ReferenceLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Long2ReferenceLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Long2ReferenceMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Long2ReferenceLinkedOpenHashMap.MapEntry(Long2ReferenceLinkedOpenHashMap.this, nextEntry());
    }
    
    public Long2ReferenceLinkedOpenHashMap<V>.MapEntry previous()
    {
      return this.entry = new Long2ReferenceLinkedOpenHashMap.MapEntry(Long2ReferenceLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(long from)
    {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(from) & Long2ReferenceLinkedOpenHashMap.this.mask; Long2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ReferenceLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Long2ReferenceLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Long2ReferenceLinkedOpenHashMap.this.first = this.next;
      } else {
        Long2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Long2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Long2ReferenceLinkedOpenHashMap.this.last = this.prev;
      } else {
        Long2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Long2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2ReferenceLinkedOpenHashMap.this.mask; Long2ReferenceLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ReferenceLinkedOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2ReferenceLinkedOpenHashMap.this.key[pos]) & Long2ReferenceLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2ReferenceLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Long2ReferenceLinkedOpenHashMap.this.key[last] = Long2ReferenceLinkedOpenHashMap.this.key[pos];
      ...
      Long2ReferenceLinkedOpenHashMap.this.used[last] = false;
    ...
    implements Long2ReferenceMap.Entry<V>, Map.Entry<Long, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Long2ReferenceLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, V> local_e = (Map.Entry)local_o;
      return (Long2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2ReferenceLinkedOpenHashMap.this.value[this.index] == local_e.getValue());
    }
