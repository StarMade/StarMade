...
/*      */ 
/*      */ public class Long2DoubleAVLTreeMap extends AbstractLong2DoubleSortedMap
...
/*  117 */           return Long2DoubleAVLTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  120 */           return Long2DoubleAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     double oldValue = put(ok.longValue(), ov.doubleValue());
/*  780 */     return this.modified ? null : Double.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Double remove(Object ok)
/*      */   {
/*  788 */     double oldValue = remove(((Long)ok).longValue());
...
/* 1203 */         final Comparator<? super Long2DoubleMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Long2DoubleMap.Entry x, Long2DoubleMap.Entry y) {
/* 1205 */             return Long2DoubleAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Long2DoubleAVLTreeMap.EntryIterator(Long2DoubleAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from) {
/* 1215 */           return new Long2DoubleAVLTreeMap.EntryIterator(Long2DoubleAVLTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1228 */           Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1229 */           if (f != null) Long2DoubleAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Long2DoubleAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Long2DoubleAVLTreeMap.this.clear(); } 
/* 1234 */         public Long2DoubleMap.Entry first() { return Long2DoubleAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Long2DoubleMap.Entry last() { return Long2DoubleAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry to) { return Long2DoubleAVLTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2DoubleEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry to) { return Long2DoubleAVLTreeMap.this.headMap((Long)to.getKey()).long2DoubleEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from) { return Long2DoubleAVLTreeMap.this.tailMap((Long)from.getKey()).long2DoubleEntrySet(); }
/*      */       };
...
/* 1304 */           return new Long2DoubleAVLTreeMap.ValueIterator(Long2DoubleAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(double k) {
/* 1307 */           return Long2DoubleAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Long2DoubleAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Long2DoubleAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Long2DoubleAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readLong(), s.readDouble());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readLong(), s.readDouble());
/* 1759 */       top.right(new Entry(s.readLong(), s.readDouble()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Long2DoubleAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Long2DoubleAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Long2DoubleAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Long2DoubleAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator() {
/* 1391 */             return new Long2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Long2DoubleAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from) {
/* 1394 */             return new Long2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Long2DoubleAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1396 */           public Comparator<? super Long2DoubleMap.Entry> comparator() { return Long2DoubleAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1402 */             return (f != null) && (Long2DoubleAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Long2DoubleAVLTreeMap.Entry f = Long2DoubleAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1409 */             if ((f != null) && (Long2DoubleAVLTreeMap.Submap.this.in(f.key))) Long2DoubleAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Long2DoubleAVLTreeMap.Submap.SubmapIterator(Long2DoubleAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Long2DoubleAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Long2DoubleMap.Entry first() { return Long2DoubleAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Long2DoubleMap.Entry last() { return Long2DoubleAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry to) { return Long2DoubleAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2DoubleEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry to) { return Long2DoubleAVLTreeMap.Submap.this.headMap((Long)to.getKey()).long2DoubleEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from) { return Long2DoubleAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2DoubleEntrySet(); }
/*      */         };
...
/*      */           public DoubleIterator iterator() {
/* 1442 */             return new Long2DoubleAVLTreeMap.Submap.SubmapValueIterator(Long2DoubleAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(double k) {
/* 1445 */             return Long2DoubleAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Long2DoubleAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Long2DoubleAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1458 */       return (in(k)) && (Long2DoubleAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(double v) {
...
/* 1473 */       return (in(kk)) && ((e = Long2DoubleAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public double put(long k, double v) {
/* 1476 */       Long2DoubleAVLTreeMap.this.modified = false;
...
/* 1478 */       double oldValue = Long2DoubleAVLTreeMap.this.put(k, v);
/* 1479 */       return Long2DoubleAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Double put(Long ok, Double ov) {
/* 1482 */       double oldValue = put(ok.longValue(), ov.doubleValue());
/* 1483 */       return Long2DoubleAVLTreeMap.this.modified ? null : Double.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public double remove(long k) {
/* 1487 */       Long2DoubleAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       double oldValue = Long2DoubleAVLTreeMap.this.remove(k);
/* 1490 */       return Long2DoubleAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Double remove(Object ok) {
/* 1493 */       double oldValue = remove(((Long)ok).longValue());
/* 1494 */       return Long2DoubleAVLTreeMap.this.modified ? Double.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1509 */       return Long2DoubleAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2DoubleSortedMap headMap(long to) {
/* 1512 */       if (this.top) return new Submap(Long2DoubleAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Long2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2DoubleAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2DoubleSortedMap tailMap(long from) {
/* 1516 */       if (this.bottom) return new Submap(Long2DoubleAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Long2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2DoubleAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2DoubleSortedMap subMap(long from, long to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Long2DoubleAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Long2DoubleAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Long2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Long2DoubleAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2DoubleAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Long2DoubleAVLTreeMap.this.tree == null) return null;
/* 1534 */       Long2DoubleAVLTreeMap.Entry e;
/*      */       Long2DoubleAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Long2DoubleAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Long2DoubleAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Long2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Long2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2DoubleAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Long2DoubleAVLTreeMap.this.tree == null) return null;
/* 1552 */       Long2DoubleAVLTreeMap.Entry e;
/*      */       Long2DoubleAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Long2DoubleAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Long2DoubleAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Long2DoubleAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Long2DoubleAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1563 */       Long2DoubleAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1568 */       Long2DoubleAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1573 */       Long2DoubleAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1578 */       Long2DoubleAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2DoubleAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2DoubleAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2DoubleAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Long2DoubleMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Long2DoubleAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Long2DoubleAVLTreeMap.Submap.this.bottom) && (Long2DoubleAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Long2DoubleAVLTreeMap.Submap.this.top) && (Long2DoubleAVLTreeMap.this.compare(k, (this.prev = Long2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Long2DoubleAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Long2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Long2DoubleAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2DoubleAVLTreeMap.this.compare(this.prev.key, Long2DoubleAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Long2DoubleAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2DoubleAVLTreeMap.this.compare(this.next.key, Long2DoubleAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public LongBidirectionalIterator iterator() { return new Long2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Long2DoubleAVLTreeMap.Submap.this); } 
/* 1433 */       public LongBidirectionalIterator iterator(long from) { return new Long2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Long2DoubleAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2DoubleAVLTreeMap.TreeIterator
/*      */     implements DoubleListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public LongBidirectionalIterator iterator() { return new Long2DoubleAVLTreeMap.KeyIterator(Long2DoubleAVLTreeMap.this); } 
/* 1263 */     public LongBidirectionalIterator iterator(long from) { return new Long2DoubleAVLTreeMap.KeyIterator(Long2DoubleAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2DoubleAVLTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2DoubleAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Long2DoubleMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Long2DoubleMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Long2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Long2DoubleAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1129 */       if ((this.next = Long2DoubleAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Long2DoubleAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Long2DoubleAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/* 1042 */       return HashCommon.long2int(this.key) ^ HashCommon.double2int(this.value);
/*      */     }
/*      */ 
