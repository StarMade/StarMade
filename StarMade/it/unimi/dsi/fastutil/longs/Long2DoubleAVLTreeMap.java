  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2DoubleAVLTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2DoubleAVLTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2DoubleAVLTreeMap(Map<? extends Long, ? extends Double> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2DoubleAVLTreeMap(SortedMap<Long, Double> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2DoubleAVLTreeMap(Long2DoubleMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2DoubleAVLTreeMap(Long2DoubleSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2DoubleAVLTreeMap(long[] local_k, double[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2DoubleAVLTreeMap(long[] local_k, double[] local_v)
  {
  ...
  {
    double oldValue = put(local_ok.longValue(), local_ov.doubleValue());
    return this.modified ? null : Double.valueOf(oldValue);
  }
  
  public Double remove(Object local_ok)
  {
    double oldValue = remove(((Long)local_ok).longValue());
  ...
  public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Long2DoubleMap.Entry> comparator = new Comparator()
        {
          public int compare(Long2DoubleMap.Entry local_x, Long2DoubleMap.Entry local_y)
          {
            return Long2DoubleAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2DoubleAVLTreeMap.EntryIterator(Long2DoubleAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from)
        {
          return new Long2DoubleAVLTreeMap.EntryIterator(Long2DoubleAVLTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2DoubleAVLTreeMap.Entry local_f = Long2DoubleAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2DoubleAVLTreeMap.Entry local_f = Long2DoubleAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2DoubleAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry local_to)
        {
          return Long2DoubleAVLTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry local_to)
        {
          return Long2DoubleAVLTreeMap.this.headMap((Long)local_to.getKey()).long2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from)
        {
          return Long2DoubleAVLTreeMap.this.tailMap((Long)from.getKey()).long2DoubleEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Long2DoubleAVLTreeMap.ValueIterator(Long2DoubleAVLTreeMap.this, null);
        }
        
        public boolean contains(double local_k)
        {
          return Long2DoubleAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2DoubleAVLTreeMap local_c;
    try
    {
      local_c = (Long2DoubleAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readLong(), local_s.readDouble());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readLong(), local_s.readDouble());
      top.right(new Entry(local_s.readLong(), local_s.readDouble()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2DoubleAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2DoubleAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2DoubleAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2DoubleMap.Entry> long2DoubleEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator()
          {
            return new Long2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Long2DoubleAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2DoubleMap.Entry> iterator(Long2DoubleMap.Entry from)
          {
            return new Long2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Long2DoubleAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Double> local_e = (Map.Entry)local_o;
            Long2DoubleAVLTreeMap.Entry local_f = Long2DoubleAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2DoubleAVLTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Double> local_e = (Map.Entry)local_o;
            Long2DoubleAVLTreeMap.Entry local_f = Long2DoubleAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2DoubleAVLTreeMap.Submap.this.in1(local_f.key))) {
              Long2DoubleAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2DoubleAVLTreeMap.Submap.SubmapIterator(Long2DoubleAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2DoubleAVLTreeMap.Submap.this.clear();
          }
          
          public Long2DoubleMap.Entry first()
          {
            return Long2DoubleAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Long2DoubleMap.Entry last()
          {
            return Long2DoubleAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2DoubleMap.Entry> subSet(Long2DoubleMap.Entry from, Long2DoubleMap.Entry local_to)
          {
            return Long2DoubleAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Long2DoubleMap.Entry> headSet(Long2DoubleMap.Entry local_to)
          {
            return Long2DoubleAVLTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Long2DoubleMap.Entry> tailSet(Long2DoubleMap.Entry from)
          {
            return Long2DoubleAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2DoubleEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public DoubleCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractDoubleCollection()
        {
          public DoubleIterator iterator()
          {
            return new Long2DoubleAVLTreeMap.Submap.SubmapValueIterator(Long2DoubleAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(double local_k)
          {
            return Long2DoubleAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2DoubleAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2DoubleAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2DoubleAVLTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2DoubleAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public double put(long local_k, double local_v)
    {
      ...
      double oldValue = Long2DoubleAVLTreeMap.this.put(local_k, local_v);
    ...
    public double remove(long local_k)
    {
      ...
      double oldValue = Long2DoubleAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2DoubleSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2DoubleAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2DoubleAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2DoubleSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2DoubleAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2DoubleAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2DoubleAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2DoubleAVLTreeMap.this.locateKey(this.from);
        if (Long2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2DoubleAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2DoubleAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2DoubleAVLTreeMap.this.locateKey(this.field_47);
        if (Long2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2DoubleAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2DoubleAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Long2DoubleAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2DoubleAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2DoubleAVLTreeMap.Submap.this.bottom) && (Long2DoubleAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2DoubleAVLTreeMap.Submap.this.top) && (Long2DoubleAVLTreeMap.this.compare(local_k, (this.prev = Long2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2DoubleAVLTreeMap.this.locateKey(local_k);
            if (Long2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2DoubleAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2DoubleAVLTreeMap.this.compare(this.prev.key, Long2DoubleAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2DoubleAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2DoubleAVLTreeMap.this.compare(this.next.key, Long2DoubleAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2DoubleSortedMap.KeySet
    {
      ...
      {
        return new Long2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Long2DoubleAVLTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Long2DoubleAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2DoubleSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2DoubleAVLTreeMap.KeyIterator(Long2DoubleAVLTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2DoubleAVLTreeMap.KeyIterator(Long2DoubleAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2DoubleAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Long2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Long2DoubleMap.Entry
  {
    ...
    Entry(long local_k, double local_v)
    {
      this.key = local_k;
      this.value = local_v;
