...
public class Long2ReferenceFunctions
{
  ...
  public static <V> Long2ReferenceFunction<V> synchronize(Long2ReferenceFunction<V> local_f)
  {
    return new SynchronizedFunction(local_f);
  }
  
  public static <V> Long2ReferenceFunction<V> synchronize(Long2ReferenceFunction<V> local_f, Object sync)
  {
    return new SynchronizedFunction(local_f, sync);
  }
  
  public static <V> Long2ReferenceFunction<V> unmodifiable(Long2ReferenceFunction<V> local_f)
  {
    ...
    implements Serializable
  {
    ...
    protected UnmodifiableFunction(Long2ReferenceFunction<V> local_f)
    {
      if (local_f == null) {
    ...
    implements Serializable
  {
    ...
    protected SynchronizedFunction(Long2ReferenceFunction<V> local_f, Object sync)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
    ...
    protected SynchronizedFunction(Long2ReferenceFunction<V> local_f)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
