...
/*     */   public static Long2BooleanFunction singleton(Long key, Boolean value)
/*     */   {
/* 124 */     return new Singleton(key.longValue(), value.booleanValue());
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static class UnmodifiableFunction extends AbstractLong2BooleanFunction
...
/* 227 */     public boolean get(long k) { return this.function.get(k); } 
/* 228 */     public boolean containsKey(Object ok) { return this.function.containsKey(ok); }
/*     */ 
/*     */   }
/*     */ 
/*     */   public static class SynchronizedFunction extends AbstractLong2BooleanFunction
/*     */     implements Serializable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */     protected final Long2BooleanFunction function;
...
/* 170 */     public boolean get(long k) { synchronized (this.sync) { return this.function.get(k); }  } 
/* 171 */     public boolean containsKey(Object ok) { synchronized (this.sync) { return this.function.containsKey(ok); }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
/*     */   public static class Singleton extends AbstractLong2BooleanFunction
...
/*     */     }
/*  92 */     public boolean get(long k) { if (this.key == k) return this.value; return this.defRetValue; } 
/*     */     public int size() {
/*  94 */       return 1;
/*     */     }
...
/*     */   }
/*     */ 
/*     */   public static class EmptyFunction extends AbstractLong2BooleanFunction
/*     */     implements Serializable, Cloneable
/*     */   {
/*     */     public static final long serialVersionUID = -7046029254386353129L;
/*     */ 
...
/*     */     public void clear() {  } 
/*  68 */     private Object readResolve() { return Long2BooleanFunctions.EMPTY_FUNCTION; } 
/*  69 */     public Object clone() { return Long2BooleanFunctions.EMPTY_FUNCTION; }
/*     */ 
/*     */   }
/*     */ }
