...
/*     */     {
/*  92 */       while (n-- != 0) {
/*  93 */         Long2FloatMap.Entry e = (Long2FloatMap.Entry)i.next();
/*  94 */         put(e.getLongKey(), e.getFloatValue());
/*     */       }
/*     */     }
/*     */     else
/*     */     {
...
/* 101 */         put((Long)e.getKey(), (Float)e.getValue());
/*     */       }
/*     */     }
/*     */   }
/*     */ 
...
/* 193 */         return AbstractLong2FloatMap.this.containsKey(k);
/*     */       }
/* 195 */       public int size() { return AbstractLong2FloatMap.this.size(); } 
/* 196 */       public void clear() { AbstractLong2FloatMap.this.clear(); }
/*     */ 
/*     */       public LongIterator iterator() {
/* 199 */         return new AbstractLongIterator() {
/* 200 */           final ObjectIterator<Map.Entry<Long, Float>> i = AbstractLong2FloatMap.this.entrySet().iterator();
/*     */ 
/* 202 */           public long nextLong() { return ((Long2FloatMap.Entry)this.i.next()).getLongKey(); } 
...
/* 226 */         return AbstractLong2FloatMap.this.containsValue(k);
/*     */       }
/* 228 */       public int size() { return AbstractLong2FloatMap.this.size(); } 
/* 229 */       public void clear() { AbstractLong2FloatMap.this.clear(); }
/*     */ 
/*     */       public FloatIterator iterator() {
/* 232 */         return new AbstractFloatIterator() {
/* 233 */           final ObjectIterator<Map.Entry<Long, Float>> i = AbstractLong2FloatMap.this.entrySet().iterator();
/*     */ 
/* 235 */           public float nextFloat() { return ((Long2FloatMap.Entry)this.i.next()).getFloatValue(); } 
/*     */           public boolean hasNext() {
...
/* 287 */         s.append(", ");
/*     */       }
/* 289 */       Long2FloatMap.Entry e = (Long2FloatMap.Entry)i.next();
/*     */ 
...
/*     */ 
/* 163 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */ 
/*     */     public int hashCode() {
/* 167 */       return HashCommon.long2int(this.key) ^ HashCommon.float2int(this.value);
/*     */     }
/*     */ 
/*     */     public String toString()
/*     */     {
