  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2ReferenceOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2ReferenceOpenHashMap(Map<? extends Long, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ReferenceOpenHashMap(Map<? extends Long, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ReferenceOpenHashMap(Long2ReferenceMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ReferenceOpenHashMap(Long2ReferenceMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ReferenceOpenHashMap(long[] local_k, V[] local_v, float local_f)
  {
  ...
  public Long2ReferenceOpenHashMap(long[] local_k, V[] local_v)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Long2ReferenceOpenHashMap.ValueIterator(Long2ReferenceOpenHashMap.this);
        }
        ...
        {
          return Long2ReferenceOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2ReferenceOpenHashMap<V> local_c;
    try
    {
      local_c = (Long2ReferenceOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    long[] key = this.key;
    V[] value = this.value;
    Long2ReferenceOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractLongSet
  {
    ...
    {
      return new Long2ReferenceOpenHashMap.KeyIterator(Long2ReferenceOpenHashMap.this);
    }
    ...
    {
      return Long2ReferenceOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2ReferenceOpenHashMap.this.size;
      Long2ReferenceOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Long2ReferenceOpenHashMap.MapIterator
    implements LongIterator
  {
    ...
    {
      return Long2ReferenceOpenHashMap.this.key[nextEntry()];
    }
    
    public Long next()
    {
      return Long.valueOf(Long2ReferenceOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2ReferenceMap.FastEntrySet<V>
  {
    ...
    {
      return new Long2ReferenceOpenHashMap.EntryIterator(Long2ReferenceOpenHashMap.this, null);
    }
    
    public ObjectIterator<Long2ReferenceMap.Entry<V>> fastIterator()
    {
      return new Long2ReferenceOpenHashMap.FastEntryIterator(Long2ReferenceOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ReferenceOpenHashMap.this.mask; Long2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ReferenceOpenHashMap.this.mask) {
        if (Long2ReferenceOpenHashMap.this.key[pos] == local_k) {
          return Long2ReferenceOpenHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ReferenceOpenHashMap.this.mask; Long2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ReferenceOpenHashMap.this.mask) {
        if (Long2ReferenceOpenHashMap.this.key[pos] == local_k)
        {
          Long2ReferenceOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Long2ReferenceMap.Entry<V>>
  {
    ...
    public AbstractLong2ReferenceMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Long2ReferenceOpenHashMap.this.key[local_e];
      this.entry.value = Long2ReferenceOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Long2ReferenceMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Long2ReferenceOpenHashMap.MapEntry(Long2ReferenceOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Long2ReferenceOpenHashMap.this.field_49;
    int last = -1;
    int field_1532 = Long2ReferenceOpenHashMap.this.size;
    LongArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Long2ReferenceOpenHashMap.this.used;
      while ((this.field_1532 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1532 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1532 != 0)
      {
        boolean[] local_k = Long2ReferenceOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2ReferenceOpenHashMap.this.mask; Long2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ReferenceOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2ReferenceOpenHashMap.this.key[pos]) & Long2ReferenceOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2ReferenceOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Long2ReferenceOpenHashMap.this.key[pos]);
        }
        Long2ReferenceOpenHashMap.this.key[last] = Long2ReferenceOpenHashMap.this.key[pos];
        Long2ReferenceOpenHashMap.this.value[last] = Long2ReferenceOpenHashMap.this.value[pos];
      }
      Long2ReferenceOpenHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Long2ReferenceOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
        this.last = -1;
        return;
      }
      Long2ReferenceOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1532 > 0))
      {
        this.field_1532 += 1;
        nextEntry();
      }
    ...
    implements Long2ReferenceMap.Entry<V>, Map.Entry<Long, V>
  {
    ...
    public Long getKey()
    {
      return Long.valueOf(Long2ReferenceOpenHashMap.this.key[this.index]);
    }
    ...
    public V setValue(V local_v)
    {
      ...
      Long2ReferenceOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, V> local_e = (Map.Entry)local_o;
      return (Long2ReferenceOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2ReferenceOpenHashMap.this.value[this.index] == local_e.getValue());
    }
