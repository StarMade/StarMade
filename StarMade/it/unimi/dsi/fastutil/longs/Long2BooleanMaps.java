...
/*     */   public static Long2BooleanMap singleton(Long key, Boolean value)
/*     */   {
/* 200 */     return new Singleton(key.longValue(), value.booleanValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Long2BooleanMap.Entry> long2BooleanEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.long2BooleanEntrySet()); return this.entries; } 
...
/* 335 */     public boolean get(long k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Long, Boolean>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Long, ? extends Boolean> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.long2BooleanEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public boolean get(long k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Long, Boolean>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Long2BooleanMap.Entry> long2BooleanEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return long2BooleanEntrySet();
/*     */     }
/* 161 */     public int hashCode() { return HashCommon.long2int(this.key) ^ (this.value ? 1231 : 1237); }
/*     */ 
...
/*     */       public Long getKey()
/*     */       {
/* 131 */         return Long.valueOf(Long2BooleanMaps.Singleton.this.key); } 
/* 132 */       public Boolean getValue() { return Boolean.valueOf(Long2BooleanMaps.Singleton.this.value); }
/*     */ 
/*     */       public long getLongKey() {
/* 135 */         return Long2BooleanMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public boolean getBooleanValue() {
/* 139 */         return Long2BooleanMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Long2BooleanMaps.Singleton.this.key == ((Long)e.getKey()).longValue()) && (Long2BooleanMaps.Singleton.this.value == ((Boolean)e.getValue()).booleanValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return HashCommon.long2int(Long2BooleanMaps.Singleton.this.key) ^ (Long2BooleanMaps.Singleton.this.value ? 1231 : 1237); } 
/* 153 */       public String toString() { return Long2BooleanMaps.Singleton.this.key + "->" + Long2BooleanMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Long, ? extends Boolean> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
...
/*  76 */     private Object readResolve() { return Long2BooleanMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Long2BooleanMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Long, Boolean>> entrySet() {
/*  80 */       return long2BooleanEntrySet();
/*     */     }
