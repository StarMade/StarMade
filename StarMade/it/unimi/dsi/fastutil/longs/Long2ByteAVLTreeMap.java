...
/*      */ 
/*      */ public class Long2ByteAVLTreeMap extends AbstractLong2ByteSortedMap
...
/*  117 */           return Long2ByteAVLTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  120 */           return Long2ByteAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     byte oldValue = put(ok.longValue(), ov.byteValue());
/*  780 */     return this.modified ? null : Byte.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Byte remove(Object ok)
/*      */   {
/*  788 */     byte oldValue = remove(((Long)ok).longValue());
...
/* 1203 */         final Comparator<? super Long2ByteMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Long2ByteMap.Entry x, Long2ByteMap.Entry y) {
/* 1205 */             return Long2ByteAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Long2ByteAVLTreeMap.EntryIterator(Long2ByteAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry from) {
/* 1215 */           return new Long2ByteAVLTreeMap.EntryIterator(Long2ByteAVLTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Long2ByteAVLTreeMap.Entry f = Long2ByteAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1228 */           Long2ByteAVLTreeMap.Entry f = Long2ByteAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1229 */           if (f != null) Long2ByteAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Long2ByteAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Long2ByteAVLTreeMap.this.clear(); } 
/* 1234 */         public Long2ByteMap.Entry first() { return Long2ByteAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Long2ByteMap.Entry last() { return Long2ByteAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry from, Long2ByteMap.Entry to) { return Long2ByteAVLTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ByteEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry to) { return Long2ByteAVLTreeMap.this.headMap((Long)to.getKey()).long2ByteEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry from) { return Long2ByteAVLTreeMap.this.tailMap((Long)from.getKey()).long2ByteEntrySet(); }
/*      */       };
...
/* 1304 */           return new Long2ByteAVLTreeMap.ValueIterator(Long2ByteAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(byte k) {
/* 1307 */           return Long2ByteAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Long2ByteAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Long2ByteAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Long2ByteAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readLong(), s.readByte());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readLong(), s.readByte());
/* 1759 */       top.right(new Entry(s.readLong(), s.readByte()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Long2ByteAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Long2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Long2ByteAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Long2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Long2ByteMap.Entry> long2ByteEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator() {
/* 1391 */             return new Long2ByteAVLTreeMap.Submap.SubmapEntryIterator(Long2ByteAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry from) {
/* 1394 */             return new Long2ByteAVLTreeMap.Submap.SubmapEntryIterator(Long2ByteAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1396 */           public Comparator<? super Long2ByteMap.Entry> comparator() { return Long2ByteAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Long2ByteAVLTreeMap.Entry f = Long2ByteAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1402 */             return (f != null) && (Long2ByteAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Long2ByteAVLTreeMap.Entry f = Long2ByteAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1409 */             if ((f != null) && (Long2ByteAVLTreeMap.Submap.this.in(f.key))) Long2ByteAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Long2ByteAVLTreeMap.Submap.SubmapIterator(Long2ByteAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Long2ByteAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Long2ByteMap.Entry first() { return Long2ByteAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Long2ByteMap.Entry last() { return Long2ByteAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry from, Long2ByteMap.Entry to) { return Long2ByteAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ByteEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry to) { return Long2ByteAVLTreeMap.Submap.this.headMap((Long)to.getKey()).long2ByteEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry from) { return Long2ByteAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2ByteEntrySet(); }
/*      */         };
...
/*      */           public ByteIterator iterator() {
/* 1442 */             return new Long2ByteAVLTreeMap.Submap.SubmapValueIterator(Long2ByteAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(byte k) {
/* 1445 */             return Long2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Long2ByteAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Long2ByteAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1458 */       return (in(k)) && (Long2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(byte v) {
...
/* 1473 */       return (in(kk)) && ((e = Long2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public byte put(long k, byte v) {
/* 1476 */       Long2ByteAVLTreeMap.this.modified = false;
...
/* 1478 */       byte oldValue = Long2ByteAVLTreeMap.this.put(k, v);
/* 1479 */       return Long2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Byte put(Long ok, Byte ov) {
/* 1482 */       byte oldValue = put(ok.longValue(), ov.byteValue());
/* 1483 */       return Long2ByteAVLTreeMap.this.modified ? null : Byte.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public byte remove(long k) {
/* 1487 */       Long2ByteAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       byte oldValue = Long2ByteAVLTreeMap.this.remove(k);
/* 1490 */       return Long2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Byte remove(Object ok) {
/* 1493 */       byte oldValue = remove(((Long)ok).longValue());
/* 1494 */       return Long2ByteAVLTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1509 */       return Long2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2ByteSortedMap headMap(long to) {
/* 1512 */       if (this.top) return new Submap(Long2ByteAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Long2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2ByteAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2ByteSortedMap tailMap(long from) {
/* 1516 */       if (this.bottom) return new Submap(Long2ByteAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Long2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2ByteAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2ByteSortedMap subMap(long from, long to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Long2ByteAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Long2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Long2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Long2ByteAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2ByteAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Long2ByteAVLTreeMap.this.tree == null) return null;
/* 1534 */       Long2ByteAVLTreeMap.Entry e;
/*      */       Long2ByteAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Long2ByteAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Long2ByteAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Long2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Long2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2ByteAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Long2ByteAVLTreeMap.this.tree == null) return null;
/* 1552 */       Long2ByteAVLTreeMap.Entry e;
/*      */       Long2ByteAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Long2ByteAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Long2ByteAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Long2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Long2ByteAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1563 */       Long2ByteAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1568 */       Long2ByteAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1573 */       Long2ByteAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1578 */       Long2ByteAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2ByteAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2ByteAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2ByteAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Long2ByteMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Long2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Long2ByteAVLTreeMap.Submap.this.bottom) && (Long2ByteAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Long2ByteAVLTreeMap.Submap.this.top) && (Long2ByteAVLTreeMap.this.compare(k, (this.prev = Long2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Long2ByteAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Long2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Long2ByteAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2ByteAVLTreeMap.this.compare(this.prev.key, Long2ByteAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Long2ByteAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2ByteAVLTreeMap.this.compare(this.next.key, Long2ByteAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public LongBidirectionalIterator iterator() { return new Long2ByteAVLTreeMap.Submap.SubmapKeyIterator(Long2ByteAVLTreeMap.Submap.this); } 
/* 1433 */       public LongBidirectionalIterator iterator(long from) { return new Long2ByteAVLTreeMap.Submap.SubmapKeyIterator(Long2ByteAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2ByteAVLTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public LongBidirectionalIterator iterator() { return new Long2ByteAVLTreeMap.KeyIterator(Long2ByteAVLTreeMap.this); } 
/* 1263 */     public LongBidirectionalIterator iterator(long from) { return new Long2ByteAVLTreeMap.KeyIterator(Long2ByteAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2ByteAVLTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2ByteAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Long2ByteMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Long2ByteMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Long2ByteAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1129 */       if ((this.next = Long2ByteAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Long2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Long2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
