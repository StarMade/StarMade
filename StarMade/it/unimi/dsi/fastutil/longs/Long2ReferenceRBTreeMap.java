...
/*  119 */           return Long2ReferenceRBTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  122 */           return Long2ReferenceRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     Object oldValue = put(ok.longValue(), ov);
/*  731 */     return this.modified ? this.defRetValue : oldValue;
/*      */   }
/*      */ 
/*      */   public V remove(Object ok)
/*      */   {
/*  737 */     Object oldValue = remove(((Long)ok).longValue());
...
/* 1118 */         final Comparator<? super Long2ReferenceMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Long2ReferenceMap.Entry<V> x, Long2ReferenceMap.Entry<V> y) {
/* 1120 */             return Long2ReferenceRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Long2ReferenceRBTreeMap.EntryIterator(Long2ReferenceRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator(Long2ReferenceMap.Entry<V> from) {
/* 1130 */           return new Long2ReferenceRBTreeMap.EntryIterator(Long2ReferenceRBTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Long2ReferenceRBTreeMap.Entry f = Long2ReferenceRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1143 */           Long2ReferenceRBTreeMap.Entry f = Long2ReferenceRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1144 */           if (f != null) Long2ReferenceRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Long2ReferenceRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Long2ReferenceRBTreeMap.this.clear(); } 
/* 1149 */         public Long2ReferenceMap.Entry<V> first() { return Long2ReferenceRBTreeMap.this.firstEntry; } 
/* 1150 */         public Long2ReferenceMap.Entry<V> last() { return Long2ReferenceRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Long2ReferenceMap.Entry<V>> subSet(Long2ReferenceMap.Entry<V> from, Long2ReferenceMap.Entry<V> to) { return Long2ReferenceRBTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ReferenceEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Long2ReferenceMap.Entry<V>> headSet(Long2ReferenceMap.Entry<V> to) { return Long2ReferenceRBTreeMap.this.headMap((Long)to.getKey()).long2ReferenceEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Long2ReferenceMap.Entry<V>> tailSet(Long2ReferenceMap.Entry<V> from) { return Long2ReferenceRBTreeMap.this.tailMap((Long)from.getKey()).long2ReferenceEntrySet(); }
/*      */       };
...
/* 1215 */           return new Long2ReferenceRBTreeMap.ValueIterator(Long2ReferenceRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Long2ReferenceRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Long2ReferenceRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Long2ReferenceRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/* 1233 */     return new Submap(0L, true, to, false);
/*      */   }
/*      */   public Long2ReferenceSortedMap<V> tailMap(long from) {
/* 1236 */     return new Submap(from, false, 0L, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1580 */       c = (Long2ReferenceRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1652 */     if (n == 1) {
/* 1653 */       Entry top = new Entry(s.readLong(), s.readObject());
/* 1654 */       top.pred(pred);
/* 1655 */       top.succ(succ);
/* 1656 */       top.black(true);
/* 1657 */       return top;
...
/* 1659 */     if (n == 2)
/*      */     {
/* 1662 */       Entry top = new Entry(s.readLong(), s.readObject());
/* 1663 */       top.black(true);
/* 1664 */       top.right(new Entry(s.readLong(), s.readObject()));
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Long2ReferenceRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Long2ReferenceRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Long2ReferenceRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator() {
/* 1302 */             return new Long2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Long2ReferenceRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator(Long2ReferenceMap.Entry<V> from) {
/* 1305 */             return new Long2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Long2ReferenceRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1307 */           public Comparator<? super Long2ReferenceMap.Entry<V>> comparator() { return Long2ReferenceRBTreeMap.this.long2ReferenceEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Long2ReferenceRBTreeMap.Entry f = Long2ReferenceRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1313 */             return (f != null) && (Long2ReferenceRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Long2ReferenceRBTreeMap.Entry f = Long2ReferenceRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1320 */             if ((f != null) && (Long2ReferenceRBTreeMap.Submap.this.in(f.key))) Long2ReferenceRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Long2ReferenceRBTreeMap.Submap.SubmapIterator(Long2ReferenceRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Long2ReferenceRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Long2ReferenceMap.Entry<V> first() { return Long2ReferenceRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Long2ReferenceMap.Entry<V> last() { return Long2ReferenceRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Long2ReferenceMap.Entry<V>> subSet(Long2ReferenceMap.Entry<V> from, Long2ReferenceMap.Entry<V> to) { return Long2ReferenceRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ReferenceEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Long2ReferenceMap.Entry<V>> headSet(Long2ReferenceMap.Entry<V> to) { return Long2ReferenceRBTreeMap.Submap.this.headMap((Long)to.getKey()).long2ReferenceEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Long2ReferenceMap.Entry<V>> tailSet(Long2ReferenceMap.Entry<V> from) { return Long2ReferenceRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2ReferenceEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Long2ReferenceRBTreeMap.Submap.SubmapValueIterator(Long2ReferenceRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Long2ReferenceRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Long2ReferenceRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Long2ReferenceRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1365 */       return (in(k)) && (Long2ReferenceRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       long kk = k;
/*      */       Long2ReferenceRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Long2ReferenceRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(long k, V v) {
/* 1383 */       Long2ReferenceRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Long2ReferenceRBTreeMap.this.put(k, v);
/* 1386 */       return Long2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Long ok, V ov) {
/* 1389 */       Object oldValue = put(ok.longValue(), ov);
/* 1390 */       return Long2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(long k) {
/* 1394 */       Long2ReferenceRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Long2ReferenceRBTreeMap.this.remove(k);
/* 1397 */       return Long2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Long)ok).longValue());
/* 1401 */       return Long2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1416 */       return Long2ReferenceRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2ReferenceSortedMap<V> headMap(long to) {
/* 1419 */       if (this.top) return new Submap(Long2ReferenceRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Long2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2ReferenceRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2ReferenceSortedMap<V> tailMap(long from) {
/* 1423 */       if (this.bottom) return new Submap(Long2ReferenceRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Long2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2ReferenceRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2ReferenceSortedMap<V> subMap(long from, long to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Long2ReferenceRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Long2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Long2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Long2ReferenceRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2ReferenceRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Long2ReferenceRBTreeMap.this.tree == null) return null;
/* 1441 */       Long2ReferenceRBTreeMap.Entry e;
/*      */       Long2ReferenceRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Long2ReferenceRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Long2ReferenceRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Long2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Long2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2ReferenceRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Long2ReferenceRBTreeMap.this.tree == null) return null;
/* 1459 */       Long2ReferenceRBTreeMap.Entry e;
/*      */       Long2ReferenceRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Long2ReferenceRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Long2ReferenceRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Long2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Long2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1470 */       Long2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1475 */       Long2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1480 */       Long2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1485 */       Long2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2ReferenceRBTreeMap.Submap.SubmapIterator
/*      */       implements LongListIterator
/*      */     {
/*      */       public SubmapKeyIterator()
/*      */       {
/* 1543 */         super(); } 
/* 1544 */       public SubmapKeyIterator(long from) { super(from); } 
/* 1545 */       public long nextLong() { return nextEntry().key; } 
/* 1546 */       public long previousLong() { return previousEntry().key; } 
/* 1547 */       public void set(long k) { throw new UnsupportedOperationException(); } 
/* 1548 */       public void add(long k) { throw new UnsupportedOperationException(); } 
/* 1549 */       public Long next() { return Long.valueOf(nextEntry().key); } 
/* 1550 */       public Long previous() { return Long.valueOf(previousEntry().key); } 
/* 1551 */       public void set(Long ok) { throw new UnsupportedOperationException(); } 
/* 1552 */       public void add(Long ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/* 1525 */         super();
/*      */       }
/* 1527 */       SubmapEntryIterator(long k) { super(k); } 
/*      */       public Long2ReferenceMap.Entry<V> next() {
/* 1529 */         return nextEntry(); } 
/* 1530 */       public Long2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Long2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Long2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Long2ReferenceRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Long2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Long2ReferenceRBTreeMap.Submap.this.bottom) && (Long2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Long2ReferenceRBTreeMap.Submap.this.top) && (Long2ReferenceRBTreeMap.this.compare(k, (this.prev = Long2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Long2ReferenceRBTreeMap.this.locateKey(k);
/* 1507 */             if (Long2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Long2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2ReferenceRBTreeMap.this.compare(this.prev.key, Long2ReferenceRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Long2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Long2ReferenceRBTreeMap.this.compare(this.next.key, Long2ReferenceRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public LongBidirectionalIterator iterator() { return new Long2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Long2ReferenceRBTreeMap.Submap.this); } 
/* 1340 */       public LongBidirectionalIterator iterator(long from) { return new Long2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Long2ReferenceRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public LongBidirectionalIterator iterator() { return new Long2ReferenceRBTreeMap.KeyIterator(Long2ReferenceRBTreeMap.this); } 
/* 1178 */     public LongBidirectionalIterator iterator(long from) { return new Long2ReferenceRBTreeMap.KeyIterator(Long2ReferenceRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2ReferenceRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
/* 1164 */       super(); } 
/* 1165 */     public KeyIterator(long k) { super(k); } 
/* 1166 */     public long nextLong() { return nextEntry().key; } 
/* 1167 */     public long previousLong() { return previousEntry().key; } 
/* 1168 */     public void set(long k) { throw new UnsupportedOperationException(); } 
/* 1169 */     public void add(long k) { throw new UnsupportedOperationException(); } 
/* 1170 */     public Long next() { return Long.valueOf(nextEntry().key); } 
/* 1171 */     public Long previous() { return Long.valueOf(previousEntry().key); } 
/* 1172 */     public void set(Long ok) { throw new UnsupportedOperationException(); } 
/* 1173 */     public void add(Long ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Long2ReferenceMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
/* 1107 */       super();
/*      */     }
/* 1109 */     EntryIterator(long k) { super(k); } 
/*      */     public Long2ReferenceMap.Entry<V> next() {
/* 1111 */       return nextEntry(); } 
/* 1112 */     public Long2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Long2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Long2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Long2ReferenceRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1044 */       if ((this.next = Long2ReferenceRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Long2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Long2ReferenceRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  969 */       return HashCommon.long2int(this.key) ^ (this.value == null ? 0 : System.identityHashCode(this.value));
/*      */     }
