...
/*  85 */     if ((m instanceof Long2ReferenceMap))
/*     */     {
/*  87 */       while (n-- != 0) {
/*  88 */         Long2ReferenceMap.Entry e = (Long2ReferenceMap.Entry)i.next();
...
/* 175 */       public boolean contains(long k) { return AbstractLong2ReferenceMap.this.containsKey(k); } 
/* 176 */       public int size() { return AbstractLong2ReferenceMap.this.size(); } 
/* 177 */       public void clear() { AbstractLong2ReferenceMap.this.clear(); } 
/*     */       public LongIterator iterator() {
/* 179 */         return new AbstractLongIterator() {
/* 180 */           final ObjectIterator<Map.Entry<Long, V>> i = AbstractLong2ReferenceMap.this.entrySet().iterator();
/*     */ 
/* 181 */           public long nextLong() { return ((Long2ReferenceMap.Entry)this.i.next()).getLongKey(); } 
...
/* 200 */       public boolean contains(Object k) { return AbstractLong2ReferenceMap.this.containsValue(k); } 
/* 201 */       public int size() { return AbstractLong2ReferenceMap.this.size(); } 
/* 202 */       public void clear() { AbstractLong2ReferenceMap.this.clear(); } 
/*     */       public ObjectIterator<V> iterator() {
/* 204 */         return new AbstractObjectIterator() {
/* 205 */           final ObjectIterator<Map.Entry<Long, V>> i = AbstractLong2ReferenceMap.this.entrySet().iterator();
/*     */ 
/* 206 */           public V next() { return ((Long2ReferenceMap.Entry)this.i.next()).getValue(); } 
...
/* 214 */     return long2ReferenceEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 244 */         s.append(", ");
/* 245 */       Long2ReferenceMap.Entry e = (Long2ReferenceMap.Entry)i.next();
...
/* 153 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == e.getValue());
/*     */     }
/*     */     public int hashCode() {
/* 156 */       return HashCommon.long2int(this.key) ^ (this.value == null ? 0 : System.identityHashCode(this.value));
/*     */     }
/*     */     public String toString() {
