...
/*      */   protected int size;
/*      */   protected volatile transient Long2LongSortedMap.FastSortedEntrySet entries;
...
/*  786 */   public Long2LongSortedMap tailMap(long from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Long2LongSortedMap headMap(long to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Long2LongSortedMap subMap(long from, long to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Long2LongLinkedOpenHashMap.ValueIterator(Long2LongLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Long2LongLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(long v) {
/* 1113 */           return Long2LongLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Long2LongLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Long2LongLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2LongLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public long previousLong()
/*      */     {
/* 1094 */       return Long2LongLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Long previous() { return Long.valueOf(Long2LongLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public long nextLong() { return Long2LongLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Long next() { return Long.valueOf(Long2LongLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Long2LongLinkedOpenHashMap.KeyIterator(Long2LongLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public LongListIterator iterator() {
/* 1054 */       return new Long2LongLinkedOpenHashMap.KeyIterator(Long2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Long2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(long k) {
/* 1060 */       return Long2LongLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(long k) {
/* 1063 */       int oldSize = Long2LongLinkedOpenHashMap.this.size;
/* 1064 */       Long2LongLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Long2LongLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Long2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public long firstLong() {
/* 1071 */       if (Long2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Long2LongLinkedOpenHashMap.this.key[Long2LongLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public long lastLong() {
/* 1075 */       if (Long2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Long2LongLinkedOpenHashMap.this.key[Long2LongLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2LongLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator(long k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public long previousLong() { return Long2LongLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Long previous() { return Long.valueOf(Long2LongLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public long nextLong() { return Long2LongLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Long next() { return Long.valueOf(Long2LongLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Long2LongMap.Entry>
...
/*      */     {
/*  966 */       return new Long2LongLinkedOpenHashMap.EntryIterator(Long2LongLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Long2LongMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry fromElement, Long2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Long2LongMap.Entry first() {
/*  973 */       if (Long2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Long2LongLinkedOpenHashMap.MapEntry(Long2LongLinkedOpenHashMap.this, Long2LongLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Long2LongMap.Entry last() {
/*  977 */       if (Long2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Long2LongLinkedOpenHashMap.MapEntry(Long2LongLinkedOpenHashMap.this, Long2LongLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = (int)HashCommon.murmurHash3(k) & Long2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Long2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Long2LongLinkedOpenHashMap.this.key[pos] == k) return Long2LongLinkedOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  990 */         pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = (int)HashCommon.murmurHash3(k) & Long2LongLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Long2LongLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Long2LongLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Long2LongLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Long2LongLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Long2LongLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from) {
/* 1018 */       return new Long2LongLinkedOpenHashMap.EntryIterator(Long2LongLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2LongMap.Entry> fastIterator() {
/* 1021 */       return new Long2LongLinkedOpenHashMap.FastEntryIterator(Long2LongLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2LongMap.Entry> fastIterator(Long2LongMap.Entry from) {
/* 1024 */       return new Long2LongLinkedOpenHashMap.FastEntryIterator(Long2LongLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Long2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2LongMap.Entry>
/*      */   {
/*  944 */     final AbstractLong2LongMap.BasicEntry entry = new AbstractLong2LongMap.BasicEntry(0L, 0L);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Long2LongLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Long2LongLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractLong2LongMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Long2LongLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Long2LongLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2LongLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2LongMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Long2LongLinkedOpenHashMap.MapEntry(Long2LongLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Long2LongLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Long2LongLinkedOpenHashMap.MapEntry(Long2LongLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Long2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Long2LongLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(long from) {
/*  809 */       if (Long2LongLinkedOpenHashMap.this.key[Long2LongLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Long2LongLinkedOpenHashMap.this.last;
/*  811 */         this.index = Long2LongLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = (int)HashCommon.murmurHash3(from) & Long2LongLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Long2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Long2LongLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Long2LongLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Long2LongLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Long2LongLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Long2LongLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Long2LongLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Long2LongLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Long2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Long2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Long2LongLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Long2LongLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Long2LongLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Long2LongLinkedOpenHashMap.this.link[this.prev] ^= (Long2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Long2LongLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Long2LongLinkedOpenHashMap.this.link[this.next] ^= (Long2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Long2LongLinkedOpenHashMap.this.mask;
/*  897 */         while (Long2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = (int)HashCommon.murmurHash3(Long2LongLinkedOpenHashMap.this.key[pos]) & Long2LongLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Long2LongLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Long2LongLinkedOpenHashMap.this.key[last] = Long2LongLinkedOpenHashMap.this.key[pos];
/*  904 */         Long2LongLinkedOpenHashMap.this.value[last] = Long2LongLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Long2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Long2LongLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Long getKey() {
/*  669 */       return Long.valueOf(Long2LongLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public long getLongKey() {
/*  672 */       return Long2LongLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Long getValue() {
/*  675 */       return Long.valueOf(Long2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public long getLongValue() {
/*  678 */       return Long2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public long setValue(long v) {
/*  681 */       long oldValue = Long2LongLinkedOpenHashMap.this.value[this.index];
/*  682 */       Long2LongLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Long setValue(Long v) {
...
/*  692 */       return (Long2LongLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.long2int(Long2LongLinkedOpenHashMap.this.key[this.index]) ^ HashCommon.long2int(Long2LongLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Long2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Long2LongLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
