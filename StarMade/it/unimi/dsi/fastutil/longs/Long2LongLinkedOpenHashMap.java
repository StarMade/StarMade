  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2LongLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2LongLinkedOpenHashMap(Map<? extends Long, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2LongLinkedOpenHashMap(Map<? extends Long, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2LongLinkedOpenHashMap(Long2LongMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2LongLinkedOpenHashMap(Long2LongMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2LongLinkedOpenHashMap(long[] local_k, long[] local_v, float local_f)
  {
  ...
  public Long2LongLinkedOpenHashMap(long[] local_k, long[] local_v)
  {
  ...
  public long getAndMoveToFirst(long local_k)
  {
    long[] key = this.key;
  ...
  public long getAndMoveToLast(long local_k)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public long putAndMoveToFirst(long local_k, long local_v)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public long putAndMoveToLast(long local_k, long local_v)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Long2LongLinkedOpenHashMap.ValueIterator(Long2LongLinkedOpenHashMap.this);
        }
        ...
        {
          return Long2LongLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2LongLinkedOpenHashMap local_c;
    try
    {
      local_c = (Long2LongLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Long2LongLinkedOpenHashMap.MapIterator
    implements LongListIterator
  {
    ...
    {
      return Long.valueOf(Long2LongLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Long next()
    {
      return Long.valueOf(Long2LongLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSortedSet
  {
    ...
    {
      return new Long2LongLinkedOpenHashMap.KeyIterator(Long2LongLinkedOpenHashMap.this, from);
    }
    
    public LongListIterator iterator()
    {
      return new Long2LongLinkedOpenHashMap.KeyIterator(Long2LongLinkedOpenHashMap.this);
    }
    ...
    {
      return Long2LongLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2LongLinkedOpenHashMap.this.size;
      Long2LongLinkedOpenHashMap.this.remove(local_k);
    ...
    implements LongListIterator
  {
    ...
    public Long previous()
    {
      return Long.valueOf(Long2LongLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Long next()
    {
      return Long.valueOf(Long2LongLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2LongSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Long2LongLinkedOpenHashMap.EntryIterator(Long2LongLinkedOpenHashMap.this);
    }
    ...
    public Long2LongMap.Entry first()
    {
      ...
      return new Long2LongLinkedOpenHashMap.MapEntry(Long2LongLinkedOpenHashMap.this, Long2LongLinkedOpenHashMap.this.first);
    }
    ...
    public Long2LongMap.Entry last()
    {
      ...
      return new Long2LongLinkedOpenHashMap.MapEntry(Long2LongLinkedOpenHashMap.this, Long2LongLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2LongLinkedOpenHashMap.this.mask; Long2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask) {
        if (Long2LongLinkedOpenHashMap.this.key[pos] == local_k) {
          return Long2LongLinkedOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2LongLinkedOpenHashMap.this.mask; Long2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask) {
        if (Long2LongLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Long2LongLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Long2LongLinkedOpenHashMap.EntryIterator(Long2LongLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
    
    public ObjectBidirectionalIterator<Long2LongMap.Entry> fastIterator()
    {
      return new Long2LongLinkedOpenHashMap.FastEntryIterator(Long2LongLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Long2LongMap.Entry> fastIterator(Long2LongMap.Entry from)
    {
      return new Long2LongLinkedOpenHashMap.FastEntryIterator(Long2LongLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
  }
    ...
    implements ObjectListIterator<Long2LongMap.Entry>
  {
    ...
    public AbstractLong2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2LongLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Long2LongLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Long2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Long2LongLinkedOpenHashMap.MapEntry(Long2LongLinkedOpenHashMap.this, nextEntry());
    }
    
    public Long2LongLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Long2LongLinkedOpenHashMap.MapEntry(Long2LongLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(long from)
    {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(from) & Long2LongLinkedOpenHashMap.this.mask; Long2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Long2LongLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Long2LongLinkedOpenHashMap.this.first = this.next;
      } else {
        Long2LongLinkedOpenHashMap.this.link[this.prev] ^= (Long2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Long2LongLinkedOpenHashMap.this.last = this.prev;
      } else {
        Long2LongLinkedOpenHashMap.this.link[this.next] ^= (Long2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2LongLinkedOpenHashMap.this.mask; Long2LongLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2LongLinkedOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2LongLinkedOpenHashMap.this.key[pos]) & Long2LongLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2LongLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Long2LongLinkedOpenHashMap.this.key[last] = Long2LongLinkedOpenHashMap.this.key[pos];
      ...
      Long2LongLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Long2LongMap.Entry, Map.Entry<Long, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Long2LongLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Long> local_e = (Map.Entry)local_o;
      return (Long2LongLinkedOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2LongLinkedOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
