  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2IntOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2IntOpenHashMap(Map<? extends Long, ? extends Integer> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2IntOpenHashMap(Map<? extends Long, ? extends Integer> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2IntOpenHashMap(Long2IntMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2IntOpenHashMap(Long2IntMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2IntOpenHashMap(long[] local_k, int[] local_v, float local_f)
  {
  ...
  public Long2IntOpenHashMap(long[] local_k, int[] local_v)
  {
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Long2IntOpenHashMap.ValueIterator(Long2IntOpenHashMap.this);
        }
        ...
        {
          return Long2IntOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2IntOpenHashMap local_c;
    try
    {
      local_c = (Long2IntOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Long2IntOpenHashMap.MapIterator
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Long2IntOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSet
  {
    ...
    {
      return new Long2IntOpenHashMap.KeyIterator(Long2IntOpenHashMap.this);
    }
    ...
    {
      return Long2IntOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2IntOpenHashMap.this.size;
      Long2IntOpenHashMap.this.remove(local_k);
    ...
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Long2IntOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2IntMap.FastEntrySet
  {
    ...
    {
      return new Long2IntOpenHashMap.EntryIterator(Long2IntOpenHashMap.this, null);
    }
    
    public ObjectIterator<Long2IntMap.Entry> fastIterator()
    {
      return new Long2IntOpenHashMap.FastEntryIterator(Long2IntOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2IntOpenHashMap.this.mask; Long2IntOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2IntOpenHashMap.this.mask) {
        if (Long2IntOpenHashMap.this.key[pos] == local_k) {
          return Long2IntOpenHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2IntOpenHashMap.this.mask; Long2IntOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2IntOpenHashMap.this.mask) {
        if (Long2IntOpenHashMap.this.key[pos] == local_k)
        {
          Long2IntOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Long2IntMap.Entry>
  {
    ...
    public AbstractLong2IntMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2IntOpenHashMap.this.key[local_e];
      this.entry.value = Long2IntOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Long2IntMap.Entry>
  {
    ...
    {
      return this.entry = new Long2IntOpenHashMap.MapEntry(Long2IntOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Long2IntOpenHashMap.this.field_49;
    int last = -1;
    int field_1654 = Long2IntOpenHashMap.this.size;
    LongArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Long2IntOpenHashMap.this.used;
      while ((this.field_1654 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1654 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1654 != 0)
      {
        boolean[] local_k = Long2IntOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2IntOpenHashMap.this.mask; Long2IntOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2IntOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2IntOpenHashMap.this.key[pos]) & Long2IntOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2IntOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
    ...
    public void remove()
    {
      ...
      Long2IntOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1654 > 0))
      {
        this.field_1654 += 1;
        nextEntry();
      }
    ...
    implements Long2IntMap.Entry, Map.Entry<Long, Integer>
  {
    ...
    public int setValue(int local_v)
    {
      ...
      Long2IntOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Integer> local_e = (Map.Entry)local_o;
      return (Long2IntOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2IntOpenHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
