...
public class Long2DoubleMaps
{
  ...
  public static Long2DoubleMap synchronize(Long2DoubleMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Long2DoubleMap synchronize(Long2DoubleMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Long2DoubleMap unmodifiable(Long2DoubleMap local_m)
  {
    ...
    implements Long2DoubleMap, Serializable
  {
    ...
    protected UnmodifiableMap(Long2DoubleMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Long2DoubleMap, Serializable
  {
    ...
    protected SynchronizedMap(Long2DoubleMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Long2DoubleMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Long2DoubleMap, Serializable, Cloneable
  {
      ...
      implements Long2DoubleMap.Entry, Map.Entry<Long, Double>
    {
      ...
      public Long getKey()
      {
        return Long.valueOf(Long2DoubleMaps.Singleton.this.key);
      }
      
      public Double getValue()
      {
        return Double.valueOf(Long2DoubleMaps.Singleton.this.value);
      }
      
      public long getLongKey()
      {
        return Long2DoubleMaps.Singleton.this.key;
      }
      
      public double getDoubleValue()
      {
        return Long2DoubleMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Long2DoubleMaps.Singleton.this.key == ((Long)local_e.getKey()).longValue()) && (Long2DoubleMaps.Singleton.this.value == ((Double)local_e.getValue()).doubleValue());
      }
      
      public int hashCode()
      {
        return HashCommon.long2int(Long2DoubleMaps.Singleton.this.key) ^ HashCommon.double2int(Long2DoubleMaps.Singleton.this.value);
      }
      
      public String toString()
      {
        return Long2DoubleMaps.Singleton.this.key + "->" + Long2DoubleMaps.Singleton.this.value;
      }
    }
  }
