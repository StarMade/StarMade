  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2ShortOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2ShortOpenHashMap(Map<? extends Long, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ShortOpenHashMap(Map<? extends Long, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ShortOpenHashMap(Long2ShortMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ShortOpenHashMap(Long2ShortMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ShortOpenHashMap(long[] local_k, short[] local_v, float local_f)
  {
  ...
  public Long2ShortOpenHashMap(long[] local_k, short[] local_v)
  {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Long2ShortOpenHashMap.ValueIterator(Long2ShortOpenHashMap.this);
        }
        ...
        {
          return Long2ShortOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2ShortOpenHashMap local_c;
    try
    {
      local_c = (Long2ShortOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Long2ShortOpenHashMap.MapIterator
    implements ShortIterator
  {
    ...
    public Short next()
    {
      return Short.valueOf(Long2ShortOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSet
  {
    ...
    {
      return new Long2ShortOpenHashMap.KeyIterator(Long2ShortOpenHashMap.this);
    }
    ...
    {
      return Long2ShortOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2ShortOpenHashMap.this.size;
      Long2ShortOpenHashMap.this.remove(local_k);
    ...
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Long2ShortOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2ShortMap.FastEntrySet
  {
    ...
    {
      return new Long2ShortOpenHashMap.EntryIterator(Long2ShortOpenHashMap.this, null);
    }
    
    public ObjectIterator<Long2ShortMap.Entry> fastIterator()
    {
      return new Long2ShortOpenHashMap.FastEntryIterator(Long2ShortOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ShortOpenHashMap.this.mask; Long2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ShortOpenHashMap.this.mask) {
        if (Long2ShortOpenHashMap.this.key[pos] == local_k) {
          return Long2ShortOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ShortOpenHashMap.this.mask; Long2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ShortOpenHashMap.this.mask) {
        if (Long2ShortOpenHashMap.this.key[pos] == local_k)
        {
          Long2ShortOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Long2ShortMap.Entry>
  {
    ...
    public AbstractLong2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2ShortOpenHashMap.this.key[local_e];
      this.entry.value = Long2ShortOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Long2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Long2ShortOpenHashMap.MapEntry(Long2ShortOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Long2ShortOpenHashMap.this.field_49;
    int last = -1;
    int field_2067 = Long2ShortOpenHashMap.this.size;
    LongArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Long2ShortOpenHashMap.this.used;
      while ((this.field_2067 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2067 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2067 != 0)
      {
        boolean[] local_k = Long2ShortOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2ShortOpenHashMap.this.mask; Long2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ShortOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2ShortOpenHashMap.this.key[pos]) & Long2ShortOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2ShortOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Long2ShortOpenHashMap.this.key[pos]);
        }
        Long2ShortOpenHashMap.this.key[last] = Long2ShortOpenHashMap.this.key[pos];
        Long2ShortOpenHashMap.this.value[last] = Long2ShortOpenHashMap.this.value[pos];
      }
      Long2ShortOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Long2ShortOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
        this.last = -1;
        return;
      }
      Long2ShortOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2067 > 0))
      {
        this.field_2067 += 1;
        nextEntry();
      }
    ...
    implements Long2ShortMap.Entry, Map.Entry<Long, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Long2ShortOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Short> local_e = (Map.Entry)local_o;
      return (Long2ShortOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2ShortOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
