...
/*  18:    */
/*  90:    */public class Long2CharOpenCustomHashMap
/*  91:    */  extends AbstractLong2CharMap
...
/* 104:    */  protected volatile transient Long2CharMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Long2CharOpenCustomHashMap(int expected, float f, LongHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Long2CharOpenCustomHashMap(int expected, LongHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Long2CharOpenCustomHashMap(LongHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Long2CharOpenCustomHashMap(Map<? extends Long, ? extends Character> m, float f, LongHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Long2CharOpenCustomHashMap(Map<? extends Long, ? extends Character> m, LongHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Long2CharOpenCustomHashMap(Long2CharMap m, float f, LongHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Long2CharOpenCustomHashMap(Long2CharMap m, LongHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Long2CharOpenCustomHashMap(long[] k, char[] v, float f, LongHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Long2CharOpenCustomHashMap(long[] k, char[] v, LongHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public char put(long k, char v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Character put(Long ok, Character ov) { char v = ov.charValue();
...
/* 302:    */  }
/* 303:    */  
/* 304:304 */  public Character get(Long ok) { long k = ok.longValue();
/* 305:    */    
...
/* 379:    */    implements Long2CharMap.Entry, Map.Entry<Long, Character>
/* 380:    */  {
...
/* 386:    */    }
/* 387:    */    
/* 388:388 */    public Long getKey() { return Long.valueOf(Long2CharOpenCustomHashMap.this.key[this.index]); }
/* 389:    */    
/* 390:    */    public long getLongKey() {
/* 391:391 */      return Long2CharOpenCustomHashMap.this.key[this.index];
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public Character getValue() { return Character.valueOf(Long2CharOpenCustomHashMap.this.value[this.index]); }
/* 395:    */    
/* 397:397 */    public char getCharValue() { return Long2CharOpenCustomHashMap.this.value[this.index]; }
/* 398:    */    
/* 399:    */    public char setValue(char v) {
/* 400:400 */      char oldValue = Long2CharOpenCustomHashMap.this.value[this.index];
/* 401:401 */      Long2CharOpenCustomHashMap.this.value[this.index] = v;
...
/* 410:410 */      Map.Entry<Long, Character> e = (Map.Entry)o;
/* 411:411 */      return (Long2CharOpenCustomHashMap.this.strategy.equals(Long2CharOpenCustomHashMap.this.key[this.index], ((Long)e.getKey()).longValue())) && (Long2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 412:    */    }
/* 413:    */    
/* 414:414 */    public int hashCode() { return Long2CharOpenCustomHashMap.this.strategy.hashCode(Long2CharOpenCustomHashMap.this.key[this.index]) ^ Long2CharOpenCustomHashMap.this.value[this.index]; }
/* 415:    */    
/* 417:417 */    public String toString() { return Long2CharOpenCustomHashMap.this.key[this.index] + "=>" + Long2CharOpenCustomHashMap.this.value[this.index]; } }
/* 418:    */  
...
/* 423:    */    
/* 424:424 */    private MapIterator() { this.pos = Long2CharOpenCustomHashMap.this.n;
/* 425:    */      
/* 427:427 */      this.last = -1;
/* 428:    */      
/* 429:429 */      this.c = Long2CharOpenCustomHashMap.this.size;
/* 430:    */      
/* 434:434 */      boolean[] used = Long2CharOpenCustomHashMap.this.used;
...
/* 446:    */        
/* 447:447 */        int pos = HashCommon.murmurHash3(Long2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Long2CharOpenCustomHashMap.this.mask;
/* 448:    */        
/* 449:449 */        while (Long2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 450:450 */          if (Long2CharOpenCustomHashMap.this.strategy.equals(Long2CharOpenCustomHashMap.this.key[pos], k)) return pos;
/* 451:451 */          pos = pos + 1 & Long2CharOpenCustomHashMap.this.mask;
/* 452:    */        }
/* 453:    */      }
/* 454:454 */      this.last = this.pos;
/* 455:    */      
/* 456:456 */      if (this.c != 0) {
/* 457:457 */        boolean[] used = Long2CharOpenCustomHashMap.this.used;
...
/* 472:    */      for (;;)
/* 473:    */      {
/* 474:474 */        pos = (last = pos) + 1 & Long2CharOpenCustomHashMap.this.mask;
/* 475:475 */        while (Long2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 476:476 */          int slot = HashCommon.murmurHash3(Long2CharOpenCustomHashMap.this.strategy.hashCode(Long2CharOpenCustomHashMap.this.key[pos])) & Long2CharOpenCustomHashMap.this.mask;
/* 477:477 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 478:478 */          pos = pos + 1 & Long2CharOpenCustomHashMap.this.mask;
/* 479:    */        }
/* 480:480 */        if (Long2CharOpenCustomHashMap.this.used[pos] == 0) break;
/* 481:481 */        if (pos < last)
/* 482:    */        {
/* 483:483 */          if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 484:484 */          this.wrapped.add(Long2CharOpenCustomHashMap.this.key[pos]);
/* 485:    */        }
/* 486:486 */        Long2CharOpenCustomHashMap.this.key[last] = Long2CharOpenCustomHashMap.this.key[pos];
/* 487:487 */        Long2CharOpenCustomHashMap.this.value[last] = Long2CharOpenCustomHashMap.this.value[pos];
/* 488:    */      }
/* 489:489 */      Long2CharOpenCustomHashMap.this.used[last] = false;
/* 490:490 */      return last;
/* 491:    */    }
/* 492:    */    
...
/* 496:    */      {
/* 497:497 */        Long2CharOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 498:498 */        this.last = -1;
/* 499:499 */        return;
/* 500:    */      }
/* 501:501 */      Long2CharOpenCustomHashMap.this.size -= 1;
...
/* 513:    */    } }
/* 514:    */  
/* 515:515 */  private class EntryIterator extends Long2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Long2CharMap.Entry> { private EntryIterator() { super(null); }
/* 516:    */    
/* 517:    */    private Long2CharOpenCustomHashMap.MapEntry entry;
/* 518:518 */    public Long2CharMap.Entry next() { return this.entry = new Long2CharOpenCustomHashMap.MapEntry(Long2CharOpenCustomHashMap.this, nextEntry()); }
/* 519:    */    
/* 520:    */    public void remove()
/* 521:    */    {
/* 522:522 */      super.remove();
/* 523:523 */      Long2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 524:    */    } }
/* 525:    */  
/* 526:526 */  private class FastEntryIterator extends Long2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Long2CharMap.Entry> { private FastEntryIterator() { super(null); }
/* 527:527 */    final AbstractLong2CharMap.BasicEntry entry = new AbstractLong2CharMap.BasicEntry(0L, '\000');
/* 528:    */    
/* 529:529 */    public AbstractLong2CharMap.BasicEntry next() { int e = nextEntry();
/* 530:530 */      this.entry.key = Long2CharOpenCustomHashMap.this.key[e];
/* 531:531 */      this.entry.value = Long2CharOpenCustomHashMap.this.value[e];
/* 532:532 */      return this.entry;
/* 533:    */    } }
/* 534:    */  
/* 535:    */  private final class MapEntrySet extends AbstractObjectSet<Long2CharMap.Entry> implements Long2CharMap.FastEntrySet { private MapEntrySet() {}
/* 536:    */    
/* 537:537 */    public ObjectIterator<Long2CharMap.Entry> iterator() { return new Long2CharOpenCustomHashMap.EntryIterator(Long2CharOpenCustomHashMap.this, null); }
/* 538:    */    
/* 539:    */    public ObjectIterator<Long2CharMap.Entry> fastIterator() {
/* 540:540 */      return new Long2CharOpenCustomHashMap.FastEntryIterator(Long2CharOpenCustomHashMap.this, null);
/* 541:    */    }
/* 542:    */    
/* 543:    */    public boolean contains(Object o) {
/* 544:544 */      if (!(o instanceof Map.Entry)) return false;
/* 545:545 */      Map.Entry<Long, Character> e = (Map.Entry)o;
/* 546:546 */      long k = ((Long)e.getKey()).longValue();
/* 547:    */      
/* 548:548 */      int pos = HashCommon.murmurHash3(Long2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Long2CharOpenCustomHashMap.this.mask;
/* 549:    */      
/* 550:550 */      while (Long2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 551:551 */        if (Long2CharOpenCustomHashMap.this.strategy.equals(Long2CharOpenCustomHashMap.this.key[pos], k)) return Long2CharOpenCustomHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 552:552 */        pos = pos + 1 & Long2CharOpenCustomHashMap.this.mask;
/* 553:    */      }
...
/* 559:559 */      Map.Entry<Long, Character> e = (Map.Entry)o;
/* 560:560 */      long k = ((Long)e.getKey()).longValue();
/* 561:    */      
/* 562:562 */      int pos = HashCommon.murmurHash3(Long2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Long2CharOpenCustomHashMap.this.mask;
/* 563:    */      
/* 564:564 */      while (Long2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 565:565 */        if (Long2CharOpenCustomHashMap.this.strategy.equals(Long2CharOpenCustomHashMap.this.key[pos], k)) {
/* 566:566 */          Long2CharOpenCustomHashMap.this.remove(e.getKey());
/* 567:567 */          return true;
/* 568:    */        }
/* 569:569 */        pos = pos + 1 & Long2CharOpenCustomHashMap.this.mask;
/* 570:    */      }
/* 571:571 */      return false;
/* 572:    */    }
/* 573:    */    
/* 574:574 */    public int size() { return Long2CharOpenCustomHashMap.this.size; }
/* 575:    */    
/* 577:577 */    public void clear() { Long2CharOpenCustomHashMap.this.clear(); }
/* 578:    */  }
/* 579:    */  
/* 580:    */  public Long2CharMap.FastEntrySet long2CharEntrySet() {
...
/* 588:    */    extends Long2CharOpenCustomHashMap.MapIterator
/* 589:    */    implements LongIterator
/* 590:    */  {
/* 591:591 */    public KeyIterator() { super(null); }
/* 592:592 */    public long nextLong() { return Long2CharOpenCustomHashMap.this.key[nextEntry()]; }
/* 593:593 */    public Long next() { return Long.valueOf(Long2CharOpenCustomHashMap.this.key[nextEntry()]); } }
/* 594:    */  
/* 595:    */  private final class KeySet extends AbstractLongSet { private KeySet() {}
/* 596:    */    
/* 597:597 */    public LongIterator iterator() { return new Long2CharOpenCustomHashMap.KeyIterator(Long2CharOpenCustomHashMap.this); }
/* 598:    */    
/* 599:    */    public int size() {
/* 600:600 */      return Long2CharOpenCustomHashMap.this.size;
/* 601:    */    }
/* 602:    */    
/* 603:603 */    public boolean contains(long k) { return Long2CharOpenCustomHashMap.this.containsKey(k); }
/* 604:    */    
/* 605:    */    public boolean remove(long k) {
/* 606:606 */      int oldSize = Long2CharOpenCustomHashMap.this.size;
/* 607:607 */      Long2CharOpenCustomHashMap.this.remove(k);
/* 608:608 */      return Long2CharOpenCustomHashMap.this.size != oldSize;
/* 609:    */    }
/* 610:    */    
/* 611:611 */    public void clear() { Long2CharOpenCustomHashMap.this.clear(); }
/* 612:    */  }
/* 613:    */  
...
/* 622:    */    extends Long2CharOpenCustomHashMap.MapIterator
/* 623:    */    implements CharIterator
/* 624:    */  {
/* 625:625 */    public ValueIterator() { super(null); }
/* 626:626 */    public char nextChar() { return Long2CharOpenCustomHashMap.this.value[nextEntry()]; }
/* 627:627 */    public Character next() { return Character.valueOf(Long2CharOpenCustomHashMap.this.value[nextEntry()]); }
/* 628:    */  }
/* 629:    */  
...
/* 632:632 */          return new Long2CharOpenCustomHashMap.ValueIterator(Long2CharOpenCustomHashMap.this);
/* 633:    */        }
/* 634:    */        
/* 635:635 */        public int size() { return Long2CharOpenCustomHashMap.this.size; }
/* 636:    */        
/* 637:    */        public boolean contains(char v) {
/* 638:638 */          return Long2CharOpenCustomHashMap.this.containsValue(v);
/* 639:    */        }
/* 640:    */        
/* 641:641 */        public void clear() { Long2CharOpenCustomHashMap.this.clear(); }
/* 642:    */      };
/* 643:    */    }
...
/* 744:    */  }
/* 745:    */  
/* 749:    */  public Long2CharOpenCustomHashMap clone()
/* 750:    */  {
/* 751:    */    Long2CharOpenCustomHashMap c;
/* 752:    */    
/* 754:    */    try
/* 755:    */    {
/* 756:756 */      c = (Long2CharOpenCustomHashMap)super.clone();
/* 757:    */    }
