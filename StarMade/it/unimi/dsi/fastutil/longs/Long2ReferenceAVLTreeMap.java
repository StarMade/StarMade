  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2ReferenceAVLTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2ReferenceAVLTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2ReferenceAVLTreeMap(Map<? extends Long, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2ReferenceAVLTreeMap(SortedMap<Long, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2ReferenceAVLTreeMap(Long2ReferenceMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2ReferenceAVLTreeMap(Long2ReferenceSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2ReferenceAVLTreeMap(long[] local_k, V[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2ReferenceAVLTreeMap(long[] local_k, V[] local_v)
  {
  ...
  {
    Long2ReferenceAVLTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Long2ReferenceMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Long2ReferenceAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2ReferenceAVLTreeMap.EntryIterator(Long2ReferenceAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator(Long2ReferenceMap.Entry<V> from)
        {
          return new Long2ReferenceAVLTreeMap.EntryIterator(Long2ReferenceAVLTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2ReferenceAVLTreeMap.Entry<V> local_f = Long2ReferenceAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2ReferenceAVLTreeMap.Entry<V> local_f = Long2ReferenceAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2ReferenceAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Long2ReferenceAVLTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Long2ReferenceMap.Entry<V>> headSet(Long2ReferenceMap.Entry<V> local_to)
        {
          return Long2ReferenceAVLTreeMap.this.headMap((Long)local_to.getKey()).long2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Long2ReferenceMap.Entry<V>> tailSet(Long2ReferenceMap.Entry<V> from)
        {
          return Long2ReferenceAVLTreeMap.this.tailMap((Long)from.getKey()).long2ReferenceEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Long2ReferenceAVLTreeMap.ValueIterator(Long2ReferenceAVLTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Long2ReferenceAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2ReferenceAVLTreeMap<V> local_c;
    try
    {
      local_c = (Long2ReferenceAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Long2ReferenceAVLTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2ReferenceAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Long2ReferenceAVLTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Long2ReferenceAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2ReferenceAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2ReferenceMap.Entry<V>> long2ReferenceEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator()
          {
            return new Long2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(Long2ReferenceAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2ReferenceMap.Entry<V>> iterator(Long2ReferenceMap.Entry<V> from)
          {
            return new Long2ReferenceAVLTreeMap.Submap.SubmapEntryIterator(Long2ReferenceAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, V> local_e = (Map.Entry)local_o;
            Long2ReferenceAVLTreeMap.Entry<V> local_f = Long2ReferenceAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2ReferenceAVLTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, V> local_e = (Map.Entry)local_o;
            Long2ReferenceAVLTreeMap.Entry<V> local_f = Long2ReferenceAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2ReferenceAVLTreeMap.Submap.this.in1(local_f.key))) {
              Long2ReferenceAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2ReferenceAVLTreeMap.Submap.SubmapIterator(Long2ReferenceAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2ReferenceAVLTreeMap.Submap.this.clear();
          }
          
          public Long2ReferenceMap.Entry<V> first()
          {
            return Long2ReferenceAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Long2ReferenceMap.Entry<V> last()
          {
            return Long2ReferenceAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2ReferenceMap.Entry<V>> subSet(Long2ReferenceMap.Entry<V> from, Long2ReferenceMap.Entry<V> local_to)
          {
            return Long2ReferenceAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Long2ReferenceMap.Entry<V>> headSet(Long2ReferenceMap.Entry<V> local_to)
          {
            return Long2ReferenceAVLTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Long2ReferenceMap.Entry<V>> tailSet(Long2ReferenceMap.Entry<V> from)
          {
            return Long2ReferenceAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2ReferenceEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ReferenceCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractReferenceCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Long2ReferenceAVLTreeMap.Submap.SubmapValueIterator(Long2ReferenceAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Long2ReferenceAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2ReferenceAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2ReferenceAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2ReferenceAVLTreeMap.Entry<V> local_e;
      return (in1(local_kk)) && ((local_e = Long2ReferenceAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(long local_k, V local_v)
    {
      ...
      V oldValue = Long2ReferenceAVLTreeMap.this.put(local_k, local_v);
    ...
    public V remove(long local_k)
    {
      ...
      V oldValue = Long2ReferenceAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2ReferenceAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2ReferenceAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2ReferenceAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2ReferenceSortedMap<V> tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2ReferenceAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2ReferenceAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2ReferenceAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2ReferenceSortedMap<V> subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2ReferenceAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2ReferenceAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2ReferenceAVLTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2ReferenceAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2ReferenceAVLTreeMap.this.locateKey(this.from);
        if (Long2ReferenceAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2ReferenceAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2ReferenceAVLTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2ReferenceAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2ReferenceAVLTreeMap.this.locateKey(this.field_47);
        if (Long2ReferenceAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2ReferenceAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2ReferenceAVLTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2ReferenceAVLTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Long2ReferenceAVLTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Long2ReferenceAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Long2ReferenceAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2ReferenceAVLTreeMap.Submap.this.bottom) && (Long2ReferenceAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2ReferenceAVLTreeMap.Submap.this.top) && (Long2ReferenceAVLTreeMap.this.compare(local_k, (this.prev = Long2ReferenceAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2ReferenceAVLTreeMap.this.locateKey(local_k);
            if (Long2ReferenceAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2ReferenceAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2ReferenceAVLTreeMap.this.compare(this.prev.key, Long2ReferenceAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2ReferenceAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2ReferenceAVLTreeMap.this.compare(this.next.key, Long2ReferenceAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2ReferenceSortedMap.KeySet
    {
      ...
      {
        return new Long2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(Long2ReferenceAVLTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2ReferenceAVLTreeMap.Submap.SubmapKeyIterator(Long2ReferenceAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2ReferenceSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2ReferenceAVLTreeMap.KeyIterator(Long2ReferenceAVLTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2ReferenceAVLTreeMap.KeyIterator(Long2ReferenceAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2ReferenceAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Long2ReferenceAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
