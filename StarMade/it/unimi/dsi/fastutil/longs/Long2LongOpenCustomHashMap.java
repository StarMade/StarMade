  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2LongOpenCustomHashMap(int expected, float local_f, LongHash.Strategy strategy)
  {
  ...
  public Long2LongOpenCustomHashMap(Map<? extends Long, ? extends Long> local_m, float local_f, LongHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Long2LongOpenCustomHashMap(Map<? extends Long, ? extends Long> local_m, LongHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Long2LongOpenCustomHashMap(Long2LongMap local_m, float local_f, LongHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Long2LongOpenCustomHashMap(Long2LongMap local_m, LongHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Long2LongOpenCustomHashMap(long[] local_k, long[] local_v, float local_f, LongHash.Strategy strategy)
  {
  ...
  public Long2LongOpenCustomHashMap(long[] local_k, long[] local_v, LongHash.Strategy strategy)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Long2LongOpenCustomHashMap.ValueIterator(Long2LongOpenCustomHashMap.this);
        }
        ...
        {
          return Long2LongOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2LongOpenCustomHashMap local_c;
    try
    {
      local_c = (Long2LongOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Long2LongOpenCustomHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Long2LongOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSet
  {
    ...
    public LongIterator iterator()
    {
      return new Long2LongOpenCustomHashMap.KeyIterator(Long2LongOpenCustomHashMap.this);
    }
    ...
    {
      return Long2LongOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2LongOpenCustomHashMap.this.size;
      Long2LongOpenCustomHashMap.this.remove(local_k);
    ...
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Long2LongOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2LongMap.FastEntrySet
  {
    ...
    {
      return new Long2LongOpenCustomHashMap.EntryIterator(Long2LongOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Long2LongMap.Entry> fastIterator()
    {
      return new Long2LongOpenCustomHashMap.FastEntryIterator(Long2LongOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Long2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Long2LongOpenCustomHashMap.this.mask; Long2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Long2LongOpenCustomHashMap.this.mask) {
        if (Long2LongOpenCustomHashMap.this.strategy.equals(Long2LongOpenCustomHashMap.this.key[pos], local_k)) {
          return Long2LongOpenCustomHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Long2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Long2LongOpenCustomHashMap.this.mask; Long2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Long2LongOpenCustomHashMap.this.mask) {
        if (Long2LongOpenCustomHashMap.this.strategy.equals(Long2LongOpenCustomHashMap.this.key[pos], local_k))
        {
          Long2LongOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Long2LongMap.Entry>
  {
    ...
    public AbstractLong2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2LongOpenCustomHashMap.this.key[local_e];
      this.entry.value = Long2LongOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Long2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Long2LongOpenCustomHashMap.MapEntry(Long2LongOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2LongOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Long2LongOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1918 = Long2LongOpenCustomHashMap.this.size;
    LongArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Long2LongOpenCustomHashMap.this.used;
      while ((this.field_1918 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1918 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1918 != 0)
      {
        boolean[] local_k = Long2LongOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2LongOpenCustomHashMap.this.mask; Long2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Long2LongOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Long2LongOpenCustomHashMap.this.strategy.hashCode(Long2LongOpenCustomHashMap.this.key[pos])) & Long2LongOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2LongOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Long2LongOpenCustomHashMap.this.key[pos]);
        }
        Long2LongOpenCustomHashMap.this.key[last] = Long2LongOpenCustomHashMap.this.key[pos];
        Long2LongOpenCustomHashMap.this.value[last] = Long2LongOpenCustomHashMap.this.value[pos];
      }
      Long2LongOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Long2LongOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
        this.last = -1;
        return;
      }
      Long2LongOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1918 > 0))
      {
        this.field_1918 += 1;
        nextEntry();
      }
    ...
    implements Long2LongMap.Entry, Map.Entry<Long, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Long2LongOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Long> local_e = (Map.Entry)local_o;
      return (Long2LongOpenCustomHashMap.this.strategy.equals(Long2LongOpenCustomHashMap.this.key[this.index], ((Long)local_e.getKey()).longValue())) && (Long2LongOpenCustomHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
