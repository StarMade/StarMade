...
/*  15:    */
/*  90:    */public class Long2LongOpenCustomHashMap
/*  91:    */  extends AbstractLong2LongMap
...
/* 104:    */  protected volatile transient Long2LongMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Long2LongOpenCustomHashMap(int expected, float f, LongHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Long2LongOpenCustomHashMap(int expected, LongHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Long2LongOpenCustomHashMap(LongHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Long2LongOpenCustomHashMap(Map<? extends Long, ? extends Long> m, float f, LongHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Long2LongOpenCustomHashMap(Map<? extends Long, ? extends Long> m, LongHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Long2LongOpenCustomHashMap(Long2LongMap m, float f, LongHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Long2LongOpenCustomHashMap(Long2LongMap m, LongHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Long2LongOpenCustomHashMap(long[] k, long[] v, float f, LongHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Long2LongOpenCustomHashMap(long[] k, long[] v, LongHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public long put(long k, long v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Long put(Long ok, Long ov) { long v = ov.longValue();
...
/* 246:    */  }
/* 247:    */  
/* 258:    */  public long add(long k, long incr)
/* 259:    */  {
...
/* 332:    */  }
/* 333:    */  
/* 334:334 */  public Long get(Long ok) { long k = ok.longValue();
/* 335:    */    
...
/* 409:    */    implements Long2LongMap.Entry, Map.Entry<Long, Long>
/* 410:    */  {
...
/* 416:    */    }
/* 417:    */    
/* 418:418 */    public Long getKey() { return Long.valueOf(Long2LongOpenCustomHashMap.this.key[this.index]); }
/* 419:    */    
/* 420:    */    public long getLongKey() {
/* 421:421 */      return Long2LongOpenCustomHashMap.this.key[this.index];
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public Long getValue() { return Long.valueOf(Long2LongOpenCustomHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public long getLongValue() { return Long2LongOpenCustomHashMap.this.value[this.index]; }
/* 428:    */    
/* 429:    */    public long setValue(long v) {
/* 430:430 */      long oldValue = Long2LongOpenCustomHashMap.this.value[this.index];
/* 431:431 */      Long2LongOpenCustomHashMap.this.value[this.index] = v;
...
/* 440:440 */      Map.Entry<Long, Long> e = (Map.Entry)o;
/* 441:441 */      return (Long2LongOpenCustomHashMap.this.strategy.equals(Long2LongOpenCustomHashMap.this.key[this.index], ((Long)e.getKey()).longValue())) && (Long2LongOpenCustomHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/* 442:    */    }
/* 443:    */    
/* 444:444 */    public int hashCode() { return Long2LongOpenCustomHashMap.this.strategy.hashCode(Long2LongOpenCustomHashMap.this.key[this.index]) ^ HashCommon.long2int(Long2LongOpenCustomHashMap.this.value[this.index]); }
/* 445:    */    
/* 447:447 */    public String toString() { return Long2LongOpenCustomHashMap.this.key[this.index] + "=>" + Long2LongOpenCustomHashMap.this.value[this.index]; } }
/* 448:    */  
...
/* 453:    */    
/* 454:454 */    private MapIterator() { this.pos = Long2LongOpenCustomHashMap.this.n;
/* 455:    */      
/* 457:457 */      this.last = -1;
/* 458:    */      
/* 459:459 */      this.c = Long2LongOpenCustomHashMap.this.size;
/* 460:    */      
/* 464:464 */      boolean[] used = Long2LongOpenCustomHashMap.this.used;
...
/* 476:    */        
/* 477:477 */        int pos = HashCommon.murmurHash3(Long2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Long2LongOpenCustomHashMap.this.mask;
/* 478:    */        
/* 479:479 */        while (Long2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 480:480 */          if (Long2LongOpenCustomHashMap.this.strategy.equals(Long2LongOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481:481 */          pos = pos + 1 & Long2LongOpenCustomHashMap.this.mask;
/* 482:    */        }
/* 483:    */      }
/* 484:484 */      this.last = this.pos;
/* 485:    */      
/* 486:486 */      if (this.c != 0) {
/* 487:487 */        boolean[] used = Long2LongOpenCustomHashMap.this.used;
...
/* 502:    */      for (;;)
/* 503:    */      {
/* 504:504 */        pos = (last = pos) + 1 & Long2LongOpenCustomHashMap.this.mask;
/* 505:505 */        while (Long2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 506:506 */          int slot = HashCommon.murmurHash3(Long2LongOpenCustomHashMap.this.strategy.hashCode(Long2LongOpenCustomHashMap.this.key[pos])) & Long2LongOpenCustomHashMap.this.mask;
/* 507:507 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508:508 */          pos = pos + 1 & Long2LongOpenCustomHashMap.this.mask;
/* 509:    */        }
/* 510:510 */        if (Long2LongOpenCustomHashMap.this.used[pos] == 0) break;
/* 511:511 */        if (pos < last)
/* 512:    */        {
/* 513:513 */          if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 514:514 */          this.wrapped.add(Long2LongOpenCustomHashMap.this.key[pos]);
/* 515:    */        }
/* 516:516 */        Long2LongOpenCustomHashMap.this.key[last] = Long2LongOpenCustomHashMap.this.key[pos];
/* 517:517 */        Long2LongOpenCustomHashMap.this.value[last] = Long2LongOpenCustomHashMap.this.value[pos];
/* 518:    */      }
/* 519:519 */      Long2LongOpenCustomHashMap.this.used[last] = false;
/* 520:520 */      return last;
/* 521:    */    }
/* 522:    */    
...
/* 526:    */      {
/* 527:527 */        Long2LongOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 528:528 */        this.last = -1;
/* 529:529 */        return;
/* 530:    */      }
/* 531:531 */      Long2LongOpenCustomHashMap.this.size -= 1;
...
/* 543:    */    } }
/* 544:    */  
/* 545:545 */  private class EntryIterator extends Long2LongOpenCustomHashMap.MapIterator implements ObjectIterator<Long2LongMap.Entry> { private EntryIterator() { super(null); }
/* 546:    */    
/* 547:    */    private Long2LongOpenCustomHashMap.MapEntry entry;
/* 548:548 */    public Long2LongMap.Entry next() { return this.entry = new Long2LongOpenCustomHashMap.MapEntry(Long2LongOpenCustomHashMap.this, nextEntry()); }
/* 549:    */    
/* 550:    */    public void remove()
/* 551:    */    {
/* 552:552 */      super.remove();
/* 553:553 */      Long2LongOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 554:    */    } }
/* 555:    */  
/* 556:556 */  private class FastEntryIterator extends Long2LongOpenCustomHashMap.MapIterator implements ObjectIterator<Long2LongMap.Entry> { private FastEntryIterator() { super(null); }
/* 557:557 */    final AbstractLong2LongMap.BasicEntry entry = new AbstractLong2LongMap.BasicEntry(0L, 0L);
/* 558:    */    
/* 559:559 */    public AbstractLong2LongMap.BasicEntry next() { int e = nextEntry();
/* 560:560 */      this.entry.key = Long2LongOpenCustomHashMap.this.key[e];
/* 561:561 */      this.entry.value = Long2LongOpenCustomHashMap.this.value[e];
/* 562:562 */      return this.entry;
/* 563:    */    } }
/* 564:    */  
/* 565:    */  private final class MapEntrySet extends AbstractObjectSet<Long2LongMap.Entry> implements Long2LongMap.FastEntrySet { private MapEntrySet() {}
/* 566:    */    
/* 567:567 */    public ObjectIterator<Long2LongMap.Entry> iterator() { return new Long2LongOpenCustomHashMap.EntryIterator(Long2LongOpenCustomHashMap.this, null); }
/* 568:    */    
/* 569:    */    public ObjectIterator<Long2LongMap.Entry> fastIterator() {
/* 570:570 */      return new Long2LongOpenCustomHashMap.FastEntryIterator(Long2LongOpenCustomHashMap.this, null);
/* 571:    */    }
/* 572:    */    
/* 573:    */    public boolean contains(Object o) {
/* 574:574 */      if (!(o instanceof Map.Entry)) return false;
/* 575:575 */      Map.Entry<Long, Long> e = (Map.Entry)o;
/* 576:576 */      long k = ((Long)e.getKey()).longValue();
/* 577:    */      
/* 578:578 */      int pos = HashCommon.murmurHash3(Long2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Long2LongOpenCustomHashMap.this.mask;
/* 579:    */      
/* 580:580 */      while (Long2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 581:581 */        if (Long2LongOpenCustomHashMap.this.strategy.equals(Long2LongOpenCustomHashMap.this.key[pos], k)) return Long2LongOpenCustomHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/* 582:582 */        pos = pos + 1 & Long2LongOpenCustomHashMap.this.mask;
/* 583:    */      }
...
/* 589:589 */      Map.Entry<Long, Long> e = (Map.Entry)o;
/* 590:590 */      long k = ((Long)e.getKey()).longValue();
/* 591:    */      
/* 592:592 */      int pos = HashCommon.murmurHash3(Long2LongOpenCustomHashMap.this.strategy.hashCode(k)) & Long2LongOpenCustomHashMap.this.mask;
/* 593:    */      
/* 594:594 */      while (Long2LongOpenCustomHashMap.this.used[pos] != 0) {
/* 595:595 */        if (Long2LongOpenCustomHashMap.this.strategy.equals(Long2LongOpenCustomHashMap.this.key[pos], k)) {
/* 596:596 */          Long2LongOpenCustomHashMap.this.remove(e.getKey());
/* 597:597 */          return true;
/* 598:    */        }
/* 599:599 */        pos = pos + 1 & Long2LongOpenCustomHashMap.this.mask;
/* 600:    */      }
/* 601:601 */      return false;
/* 602:    */    }
/* 603:    */    
/* 604:604 */    public int size() { return Long2LongOpenCustomHashMap.this.size; }
/* 605:    */    
/* 607:607 */    public void clear() { Long2LongOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
/* 610:    */  public Long2LongMap.FastEntrySet long2LongEntrySet() {
...
/* 618:    */    extends Long2LongOpenCustomHashMap.MapIterator
/* 619:    */    implements LongIterator
/* 620:    */  {
/* 621:621 */    public KeyIterator() { super(null); }
/* 622:622 */    public long nextLong() { return Long2LongOpenCustomHashMap.this.key[nextEntry()]; }
/* 623:623 */    public Long next() { return Long.valueOf(Long2LongOpenCustomHashMap.this.key[nextEntry()]); } }
/* 624:    */  
/* 625:    */  private final class KeySet extends AbstractLongSet { private KeySet() {}
/* 626:    */    
/* 627:627 */    public LongIterator iterator() { return new Long2LongOpenCustomHashMap.KeyIterator(Long2LongOpenCustomHashMap.this); }
/* 628:    */    
/* 629:    */    public int size() {
/* 630:630 */      return Long2LongOpenCustomHashMap.this.size;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    public boolean contains(long k) { return Long2LongOpenCustomHashMap.this.containsKey(k); }
/* 634:    */    
/* 635:    */    public boolean remove(long k) {
/* 636:636 */      int oldSize = Long2LongOpenCustomHashMap.this.size;
/* 637:637 */      Long2LongOpenCustomHashMap.this.remove(k);
/* 638:638 */      return Long2LongOpenCustomHashMap.this.size != oldSize;
/* 639:    */    }
/* 640:    */    
/* 641:641 */    public void clear() { Long2LongOpenCustomHashMap.this.clear(); }
/* 642:    */  }
/* 643:    */  
...
/* 652:    */    extends Long2LongOpenCustomHashMap.MapIterator
/* 653:    */    implements LongIterator
/* 654:    */  {
/* 655:655 */    public ValueIterator() { super(null); }
/* 656:656 */    public long nextLong() { return Long2LongOpenCustomHashMap.this.value[nextEntry()]; }
/* 657:657 */    public Long next() { return Long.valueOf(Long2LongOpenCustomHashMap.this.value[nextEntry()]); }
/* 658:    */  }
/* 659:    */  
...
/* 662:662 */          return new Long2LongOpenCustomHashMap.ValueIterator(Long2LongOpenCustomHashMap.this);
/* 663:    */        }
/* 664:    */        
/* 665:665 */        public int size() { return Long2LongOpenCustomHashMap.this.size; }
/* 666:    */        
/* 667:    */        public boolean contains(long v) {
/* 668:668 */          return Long2LongOpenCustomHashMap.this.containsValue(v);
/* 669:    */        }
/* 670:    */        
/* 671:671 */        public void clear() { Long2LongOpenCustomHashMap.this.clear(); }
/* 672:    */      };
/* 673:    */    }
...
/* 774:    */  }
/* 775:    */  
/* 779:    */  public Long2LongOpenCustomHashMap clone()
/* 780:    */  {
/* 781:    */    Long2LongOpenCustomHashMap c;
/* 782:    */    
/* 784:    */    try
/* 785:    */    {
/* 786:786 */      c = (Long2LongOpenCustomHashMap)super.clone();
/* 787:    */    }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.longs.Long2LongOpenCustomHashMap
