...
/*     */ 
/*     */ public class LongOpenCustomHashSet extends AbstractLongSet
...
/* 169 */     while (i.hasNext()) add(i.nextLong());
/*     */   }
/*     */ 
...
/*     */   {
/* 186 */     this(LongIterators.asLongIterator(i), f, strategy);
/*     */   }
/*     */ 
/*     */   public LongOpenCustomHashSet(Iterator<?> i, LongHash.Strategy strategy)
/*     */   {
/* 194 */     this(LongIterators.asLongIterator(i), strategy);
/*     */   }
/*     */ 
...
/* 206 */     LongArrays.ensureOffsetLength(a, offset, length);
...
/*     */ 
/* 504 */     long[] key = this.key;
/* 505 */     int newMask = newN - 1;
/* 506 */     long[] newKey = new long[newN];
...
/*     */     try
/*     */     {
/* 534 */       c = (LongOpenCustomHashSet)super.clone();
/*     */     }
/*     */     catch (CloneNotSupportedException cantHappen) {
/* 537 */       throw new InternalError();
/*     */     }
/* 539 */     c.key = ((long[])this.key.clone());
...
/*     */     }
/* 560 */     return h; } 
/* 563 */   private void writeObject(ObjectOutputStream s) throws IOException { LongIterator i = iterator();
/* 564 */     s.defaultWriteObject();
/* 565 */     for (int j = this.size; j-- != 0; s.writeLong(i.nextLong()));
/*     */   }
/*     */ 
...
/*     */     private SetIterator()
/*     */     {
/* 349 */       this.pos = LongOpenCustomHashSet.this.n;
/*     */ 
/* 352 */       this.last = -1;
/*     */ 
/* 354 */       this.c = LongOpenCustomHashSet.this.size;
/*     */ 
/* 359 */       boolean[] used = LongOpenCustomHashSet.this.used;
...
/* 367 */       this.c -= 1;
/*     */ 
/* 369 */       if (this.pos < 0) return this.wrapped.getLong(-(this.last = --this.pos) - 2);
/* 370 */       long retVal = LongOpenCustomHashSet.this.key[(this.last = this.pos)];
/*     */ 
/* 372 */       if (this.c != 0) {
/* 373 */         boolean[] used = LongOpenCustomHashSet.this.used;
...
/*     */       while (true)
/*     */       {
/* 390 */         pos = (last = pos) + 1 & LongOpenCustomHashSet.this.mask;
/* 391 */         while (LongOpenCustomHashSet.this.used[pos] != 0) {
/* 392 */           int slot = HashCommon.murmurHash3(LongOpenCustomHashSet.this.strategy.hashCode(LongOpenCustomHashSet.this.key[pos])) & LongOpenCustomHashSet.this.mask;
/* 393 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 394 */           pos = pos + 1 & LongOpenCustomHashSet.this.mask;
/*     */         }
/* 396 */         if (LongOpenCustomHashSet.this.used[pos] == 0) break;
/* 397 */         if (pos < last)
/*     */         {
/* 399 */           if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 400 */           this.wrapped.add(LongOpenCustomHashSet.this.key[pos]);
/*     */         }
/* 402 */         LongOpenCustomHashSet.this.key[last] = LongOpenCustomHashSet.this.key[pos];
/*     */       }
/* 404 */       LongOpenCustomHashSet.this.used[last] = false;
/* 405 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 410 */       if (this.pos < -1)
/*     */       {
/* 412 */         LongOpenCustomHashSet.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 413 */         this.last = -1;
/* 414 */         return;
/*     */       }
/* 416 */       LongOpenCustomHashSet.this.size -= 1;
