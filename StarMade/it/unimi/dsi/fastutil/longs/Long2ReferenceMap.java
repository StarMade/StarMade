...
public abstract interface Long2ReferenceMap<V> extends Long2ReferenceFunction<V>, Map<Long, V>
{
  ...
  public static abstract interface Entry<V> extends Map.Entry<Long, V>
  {
    public abstract long getLongKey();
  }

  public static abstract interface FastEntrySet<V> extends ObjectSet<Long2ReferenceMap.Entry<V>>
  {
