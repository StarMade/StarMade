  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2CharRBTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2CharRBTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2CharRBTreeMap(Map<? extends Long, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2CharRBTreeMap(SortedMap<Long, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2CharRBTreeMap(Long2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2CharRBTreeMap(Long2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2CharRBTreeMap(long[] local_k, char[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2CharRBTreeMap(long[] local_k, char[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Long2CharMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Long2CharRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2CharRBTreeMap.EntryIterator(Long2CharRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from)
        {
          return new Long2CharRBTreeMap.EntryIterator(Long2CharRBTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2CharRBTreeMap.Entry local_f = Long2CharRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2CharRBTreeMap.Entry local_f = Long2CharRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2CharRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Long2CharRBTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2CharEntrySet();
        }
        
        public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry local_to)
        {
          return Long2CharRBTreeMap.this.headMap((Long)local_to.getKey()).long2CharEntrySet();
        }
        
        public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from)
        {
          return Long2CharRBTreeMap.this.tailMap((Long)from.getKey()).long2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Long2CharRBTreeMap.ValueIterator(Long2CharRBTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Long2CharRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2CharRBTreeMap local_c;
    try
    {
      local_c = (Long2CharRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2CharRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2CharRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2CharRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator()
          {
            return new Long2CharRBTreeMap.Submap.SubmapEntryIterator(Long2CharRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from)
          {
            return new Long2CharRBTreeMap.Submap.SubmapEntryIterator(Long2CharRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Character> local_e = (Map.Entry)local_o;
            Long2CharRBTreeMap.Entry local_f = Long2CharRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2CharRBTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Character> local_e = (Map.Entry)local_o;
            Long2CharRBTreeMap.Entry local_f = Long2CharRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2CharRBTreeMap.Submap.this.in1(local_f.key))) {
              Long2CharRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2CharRBTreeMap.Submap.SubmapIterator(Long2CharRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2CharRBTreeMap.Submap.this.clear();
          }
          
          public Long2CharMap.Entry first()
          {
            return Long2CharRBTreeMap.Submap.this.firstEntry();
          }
          
          public Long2CharMap.Entry last()
          {
            return Long2CharRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry local_to)
          {
            return Long2CharRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2CharEntrySet();
          }
          
          public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry local_to)
          {
            return Long2CharRBTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2CharEntrySet();
          }
          
          public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from)
          {
            return Long2CharRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Long2CharRBTreeMap.Submap.SubmapValueIterator(Long2CharRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Long2CharRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2CharRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2CharRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2CharRBTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2CharRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(long local_k, char local_v)
    {
      ...
      char oldValue = Long2CharRBTreeMap.this.put(local_k, local_v);
    ...
    public char remove(long local_k)
    {
      ...
      char oldValue = Long2CharRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2CharRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2CharRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2CharSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2CharRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2CharRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2CharRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2CharSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2CharRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2CharRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2CharRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2CharRBTreeMap.this.locateKey(this.from);
        if (Long2CharRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2CharRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2CharRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2CharRBTreeMap.this.locateKey(this.field_47);
        if (Long2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2CharRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2CharRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2CharRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Long2CharRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2CharRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2CharRBTreeMap.Submap.this.bottom) && (Long2CharRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2CharRBTreeMap.Submap.this.top) && (Long2CharRBTreeMap.this.compare(local_k, (this.prev = Long2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2CharRBTreeMap.this.locateKey(local_k);
            if (Long2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2CharRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2CharRBTreeMap.this.compare(this.prev.key, Long2CharRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2CharRBTreeMap.Submap.this.top) && (this.next != null) && (Long2CharRBTreeMap.this.compare(this.next.key, Long2CharRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2CharSortedMap.KeySet
    {
      ...
      {
        return new Long2CharRBTreeMap.Submap.SubmapKeyIterator(Long2CharRBTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2CharRBTreeMap.Submap.SubmapKeyIterator(Long2CharRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2CharSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2CharRBTreeMap.KeyIterator(Long2CharRBTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2CharRBTreeMap.KeyIterator(Long2CharRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2CharRBTreeMap.this.locateKey(local_k)) != null) {
        if (Long2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
