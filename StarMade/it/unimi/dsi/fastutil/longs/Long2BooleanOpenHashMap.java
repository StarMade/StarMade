...
/*     */ 
/*     */ public class Long2BooleanOpenHashMap extends AbstractLong2BooleanMap
...
/* 239 */         int slot = (int)HashCommon.murmurHash3(this.key[pos]) & this.mask;
...
/* 612 */           return new Long2BooleanOpenHashMap.ValueIterator(Long2BooleanOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 615 */           return Long2BooleanOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(boolean v) {
/* 618 */           return Long2BooleanOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 621 */           Long2BooleanOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 736 */       c = (Long2BooleanOpenHashMap)super.clone();
/*     */     }
...
/* 762 */       t = HashCommon.long2int(this.key[i]);
...
/* 786 */     long[] key = this.key = new long[this.n];
...
/* 792 */       long k = s.readLong();
/* 793 */       boolean v = s.readBoolean();
/* 794 */       pos = (int)HashCommon.murmurHash3(k) & this.mask;
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Long2BooleanOpenHashMap.MapIterator
/*     */     implements BooleanIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 605 */       super(null); } 
/* 606 */     public boolean nextBoolean() { return Long2BooleanOpenHashMap.this.value[nextEntry()]; } 
/* 607 */     public Boolean next() { return Boolean.valueOf(Long2BooleanOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 577 */       return new Long2BooleanOpenHashMap.KeyIterator(Long2BooleanOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 580 */       return Long2BooleanOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(long k) {
/* 583 */       return Long2BooleanOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(long k) {
/* 586 */       int oldSize = Long2BooleanOpenHashMap.this.size;
/* 587 */       Long2BooleanOpenHashMap.this.remove(k);
/* 588 */       return Long2BooleanOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 591 */       Long2BooleanOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Long2BooleanOpenHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 571 */       super(null); } 
/* 572 */     public long nextLong() { return Long2BooleanOpenHashMap.this.key[nextEntry()]; } 
/* 573 */     public Long next() { return Long.valueOf(Long2BooleanOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 517 */       return new Long2BooleanOpenHashMap.EntryIterator(Long2BooleanOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Long2BooleanMap.Entry> fastIterator() {
/* 520 */       return new Long2BooleanOpenHashMap.FastEntryIterator(Long2BooleanOpenHashMap.this, null);
/*     */     }
/*     */ 
/*     */     public boolean contains(Object o) {
/* 524 */       if (!(o instanceof Map.Entry)) return false;
/* 525 */       Map.Entry e = (Map.Entry)o;
/* 526 */       long k = ((Long)e.getKey()).longValue();
/*     */ 
/* 528 */       int pos = (int)HashCommon.murmurHash3(k) & Long2BooleanOpenHashMap.this.mask;
/*     */ 
/* 530 */       while (Long2BooleanOpenHashMap.this.used[pos] != 0) {
/* 531 */         if (Long2BooleanOpenHashMap.this.key[pos] == k) return Long2BooleanOpenHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/* 532 */         pos = pos + 1 & Long2BooleanOpenHashMap.this.mask;
/*     */       }
/* 534 */       return false;
/*     */     }
/*     */ 
...
/* 540 */       long k = ((Long)e.getKey()).longValue();
/*     */ 
/* 542 */       int pos = (int)HashCommon.murmurHash3(k) & Long2BooleanOpenHashMap.this.mask;
/*     */ 
/* 544 */       while (Long2BooleanOpenHashMap.this.used[pos] != 0) {
/* 545 */         if (Long2BooleanOpenHashMap.this.key[pos] == k) {
/* 546 */           Long2BooleanOpenHashMap.this.remove(e.getKey());
/* 547 */           return true;
/*     */         }
/* 549 */         pos = pos + 1 & Long2BooleanOpenHashMap.this.mask;
/*     */       }
/* 551 */       return false;
/*     */     }
/*     */     public int size() {
/* 554 */       return Long2BooleanOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 557 */       Long2BooleanOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Long2BooleanOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Long2BooleanMap.Entry>
/*     */   {
/* 507 */     final AbstractLong2BooleanMap.BasicEntry entry = new AbstractLong2BooleanMap.BasicEntry(0L, false);
/*     */ 
...
/* 509 */       int e = nextEntry();
/* 510 */       this.entry.key = Long2BooleanOpenHashMap.this.key[e];
/* 511 */       this.entry.value = Long2BooleanOpenHashMap.this.value[e];
/* 512 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Long2BooleanOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Long2BooleanMap.Entry>
/*     */   {
...
/* 498 */       return this.entry = new Long2BooleanOpenHashMap.MapEntry(Long2BooleanOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 502 */       super.remove();
/* 503 */       Long2BooleanOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 404 */       this.pos = Long2BooleanOpenHashMap.this.n;
/*     */ 
/* 407 */       this.last = -1;
/*     */ 
/* 409 */       this.c = Long2BooleanOpenHashMap.this.size;
/*     */ 
/* 414 */       boolean[] used = Long2BooleanOpenHashMap.this.used;
...
/*     */ 
/* 424 */       if (this.pos < 0) {
/* 425 */         long k = this.wrapped.getLong(-(this.last = --this.pos) - 2);
/*     */ 
/* 427 */         int pos = (int)HashCommon.murmurHash3(k) & Long2BooleanOpenHashMap.this.mask;
/*     */ 
/* 429 */         while (Long2BooleanOpenHashMap.this.used[pos] != 0) {
/* 430 */           if (Long2BooleanOpenHashMap.this.key[pos] == k) return pos;
/* 431 */           pos = pos + 1 & Long2BooleanOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 434 */       this.last = this.pos;
/*     */ 
/* 436 */       if (this.c != 0) {
/* 437 */         boolean[] used = Long2BooleanOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 454 */         pos = (last = pos) + 1 & Long2BooleanOpenHashMap.this.mask;
/* 455 */         while (Long2BooleanOpenHashMap.this.used[pos] != 0) {
/* 456 */           int slot = (int)HashCommon.murmurHash3(Long2BooleanOpenHashMap.this.key[pos]) & Long2BooleanOpenHashMap.this.mask;
/* 457 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 458 */           pos = pos + 1 & Long2BooleanOpenHashMap.this.mask;
/*     */         }
/* 460 */         if (Long2BooleanOpenHashMap.this.used[pos] == 0) break;
/* 461 */         if (pos < last)
/*     */         {
/* 463 */           if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 464 */           this.wrapped.add(Long2BooleanOpenHashMap.this.key[pos]);
/*     */         }
/* 466 */         Long2BooleanOpenHashMap.this.key[last] = Long2BooleanOpenHashMap.this.key[pos];
/* 467 */         Long2BooleanOpenHashMap.this.value[last] = Long2BooleanOpenHashMap.this.value[pos];
/*     */       }
/* 469 */       Long2BooleanOpenHashMap.this.used[last] = false;
/* 470 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 475 */       if (this.pos < -1)
/*     */       {
/* 477 */         Long2BooleanOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 478 */         this.last = -1;
/* 479 */         return;
/*     */       }
/* 481 */       Long2BooleanOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Long getKey() {
/* 368 */       return Long.valueOf(Long2BooleanOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public long getLongKey() {
/* 371 */       return Long2BooleanOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Boolean getValue() {
/* 374 */       return Boolean.valueOf(Long2BooleanOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public boolean getBooleanValue() {
/* 377 */       return Long2BooleanOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public boolean setValue(boolean v) {
/* 380 */       boolean oldValue = Long2BooleanOpenHashMap.this.value[this.index];
/* 381 */       Long2BooleanOpenHashMap.this.value[this.index] = v;
/* 382 */       return oldValue;
/*     */     }
/*     */     public Boolean setValue(Boolean v) {
...
/* 391 */       return (Long2BooleanOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2BooleanOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*     */     }
/*     */     public int hashCode() {
/* 394 */       return HashCommon.long2int(Long2BooleanOpenHashMap.this.key[this.index]) ^ (Long2BooleanOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
/*     */     }
/*     */     public String toString() {
/* 397 */       return Long2BooleanOpenHashMap.this.key[this.index] + "=>" + Long2BooleanOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
