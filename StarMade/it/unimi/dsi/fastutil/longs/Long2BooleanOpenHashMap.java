  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2BooleanOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2BooleanOpenHashMap(Map<? extends Long, ? extends Boolean> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2BooleanOpenHashMap(Map<? extends Long, ? extends Boolean> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2BooleanOpenHashMap(Long2BooleanMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2BooleanOpenHashMap(Long2BooleanMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2BooleanOpenHashMap(long[] local_k, boolean[] local_v, float local_f)
  {
  ...
  public Long2BooleanOpenHashMap(long[] local_k, boolean[] local_v)
  {
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Long2BooleanOpenHashMap.ValueIterator(Long2BooleanOpenHashMap.this);
        }
        ...
        {
          return Long2BooleanOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2BooleanOpenHashMap local_c;
    try
    {
      local_c = (Long2BooleanOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Long2BooleanOpenHashMap.MapIterator
    implements BooleanIterator
  {
    ...
    public Boolean next()
    {
      return Boolean.valueOf(Long2BooleanOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSet
  {
    ...
    {
      return new Long2BooleanOpenHashMap.KeyIterator(Long2BooleanOpenHashMap.this);
    }
    ...
    {
      return Long2BooleanOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2BooleanOpenHashMap.this.size;
      Long2BooleanOpenHashMap.this.remove(local_k);
    ...
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Long2BooleanOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2BooleanMap.FastEntrySet
  {
    ...
    {
      return new Long2BooleanOpenHashMap.EntryIterator(Long2BooleanOpenHashMap.this, null);
    }
    
    public ObjectIterator<Long2BooleanMap.Entry> fastIterator()
    {
      return new Long2BooleanOpenHashMap.FastEntryIterator(Long2BooleanOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2BooleanOpenHashMap.this.mask; Long2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2BooleanOpenHashMap.this.mask) {
        if (Long2BooleanOpenHashMap.this.key[pos] == local_k) {
          return Long2BooleanOpenHashMap.this.value[pos] == ((Boolean)local_e.getValue()).booleanValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2BooleanOpenHashMap.this.mask; Long2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2BooleanOpenHashMap.this.mask) {
        if (Long2BooleanOpenHashMap.this.key[pos] == local_k)
        {
          Long2BooleanOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Long2BooleanMap.Entry>
  {
    ...
    public AbstractLong2BooleanMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2BooleanOpenHashMap.this.key[local_e];
      this.entry.value = Long2BooleanOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Long2BooleanMap.Entry>
  {
    ...
    {
      return this.entry = new Long2BooleanOpenHashMap.MapEntry(Long2BooleanOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2BooleanOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Long2BooleanOpenHashMap.this.field_49;
    int last = -1;
    int field_1750 = Long2BooleanOpenHashMap.this.size;
    LongArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Long2BooleanOpenHashMap.this.used;
      while ((this.field_1750 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1750 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1750 != 0)
      {
        boolean[] local_k = Long2BooleanOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2BooleanOpenHashMap.this.mask; Long2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2BooleanOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2BooleanOpenHashMap.this.key[pos]) & Long2BooleanOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2BooleanOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Long2BooleanOpenHashMap.this.key[pos]);
        }
        Long2BooleanOpenHashMap.this.key[last] = Long2BooleanOpenHashMap.this.key[pos];
        Long2BooleanOpenHashMap.this.value[last] = Long2BooleanOpenHashMap.this.value[pos];
      }
      Long2BooleanOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Long2BooleanOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
        this.last = -1;
        return;
      }
      Long2BooleanOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1750 > 0))
      {
        this.field_1750 += 1;
        nextEntry();
      }
    ...
    implements Long2BooleanMap.Entry, Map.Entry<Long, Boolean>
  {
    ...
    public boolean setValue(boolean local_v)
    {
      ...
      Long2BooleanOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Boolean> local_e = (Map.Entry)local_o;
      return (Long2BooleanOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2BooleanOpenHashMap.this.value[this.index] == ((Boolean)local_e.getValue()).booleanValue());
    }
    
    public int hashCode()
    {
      return HashCommon.long2int(Long2BooleanOpenHashMap.this.key[this.index]) ^ (Long2BooleanOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
    }
