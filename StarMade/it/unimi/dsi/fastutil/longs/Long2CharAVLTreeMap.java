  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2CharAVLTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2CharAVLTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2CharAVLTreeMap(Map<? extends Long, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2CharAVLTreeMap(SortedMap<Long, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2CharAVLTreeMap(Long2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2CharAVLTreeMap(Long2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2CharAVLTreeMap(long[] local_k, char[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2CharAVLTreeMap(long[] local_k, char[] local_v)
  {
  ...
  {
    char oldValue = put(local_ok.longValue(), local_ov.charValue());
    return this.modified ? null : Character.valueOf(oldValue);
  }
  
  public Character remove(Object local_ok)
  {
    char oldValue = remove(((Long)local_ok).longValue());
  ...
  public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Long2CharMap.Entry> comparator = new Comparator()
        {
          public int compare(Long2CharMap.Entry local_x, Long2CharMap.Entry local_y)
          {
            return Long2CharAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2CharAVLTreeMap.EntryIterator(Long2CharAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from)
        {
          return new Long2CharAVLTreeMap.EntryIterator(Long2CharAVLTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2CharAVLTreeMap.Entry local_f = Long2CharAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2CharAVLTreeMap.Entry local_f = Long2CharAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2CharAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry local_to)
        {
          return Long2CharAVLTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2CharEntrySet();
        }
        
        public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry local_to)
        {
          return Long2CharAVLTreeMap.this.headMap((Long)local_to.getKey()).long2CharEntrySet();
        }
        
        public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from)
        {
          return Long2CharAVLTreeMap.this.tailMap((Long)from.getKey()).long2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Long2CharAVLTreeMap.ValueIterator(Long2CharAVLTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Long2CharAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2CharAVLTreeMap local_c;
    try
    {
      local_c = (Long2CharAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readLong(), local_s.readChar());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readLong(), local_s.readChar());
      top.right(new Entry(local_s.readLong(), local_s.readChar()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2CharAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2CharAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2CharAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2CharMap.Entry> long2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator()
          {
            return new Long2CharAVLTreeMap.Submap.SubmapEntryIterator(Long2CharAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2CharMap.Entry> iterator(Long2CharMap.Entry from)
          {
            return new Long2CharAVLTreeMap.Submap.SubmapEntryIterator(Long2CharAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Character> local_e = (Map.Entry)local_o;
            Long2CharAVLTreeMap.Entry local_f = Long2CharAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2CharAVLTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Character> local_e = (Map.Entry)local_o;
            Long2CharAVLTreeMap.Entry local_f = Long2CharAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2CharAVLTreeMap.Submap.this.in1(local_f.key))) {
              Long2CharAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2CharAVLTreeMap.Submap.SubmapIterator(Long2CharAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2CharAVLTreeMap.Submap.this.clear();
          }
          
          public Long2CharMap.Entry first()
          {
            return Long2CharAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Long2CharMap.Entry last()
          {
            return Long2CharAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2CharMap.Entry> subSet(Long2CharMap.Entry from, Long2CharMap.Entry local_to)
          {
            return Long2CharAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2CharEntrySet();
          }
          
          public ObjectSortedSet<Long2CharMap.Entry> headSet(Long2CharMap.Entry local_to)
          {
            return Long2CharAVLTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2CharEntrySet();
          }
          
          public ObjectSortedSet<Long2CharMap.Entry> tailSet(Long2CharMap.Entry from)
          {
            return Long2CharAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Long2CharAVLTreeMap.Submap.SubmapValueIterator(Long2CharAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Long2CharAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2CharAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2CharAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2CharAVLTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2CharAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(long local_k, char local_v)
    {
      ...
      char oldValue = Long2CharAVLTreeMap.this.put(local_k, local_v);
    ...
    public char remove(long local_k)
    {
      ...
      char oldValue = Long2CharAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2CharAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2CharAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2CharSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2CharAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2CharAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2CharSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2CharAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2CharAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2CharAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2CharAVLTreeMap.this.locateKey(this.from);
        if (Long2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2CharAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2CharAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2CharAVLTreeMap.this.locateKey(this.field_47);
        if (Long2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2CharAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2CharAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      implements ObjectListIterator<Long2CharMap.Entry>
    {
      ...
      public void set(Long2CharMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Long2CharMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
      ...
      extends Long2CharAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2CharAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2CharAVLTreeMap.Submap.this.bottom) && (Long2CharAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2CharAVLTreeMap.Submap.this.top) && (Long2CharAVLTreeMap.this.compare(local_k, (this.prev = Long2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2CharAVLTreeMap.this.locateKey(local_k);
            if (Long2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2CharAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2CharAVLTreeMap.this.compare(this.prev.key, Long2CharAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2CharAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2CharAVLTreeMap.this.compare(this.next.key, Long2CharAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2CharSortedMap.KeySet
    {
      ...
      {
        return new Long2CharAVLTreeMap.Submap.SubmapKeyIterator(Long2CharAVLTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2CharAVLTreeMap.Submap.SubmapKeyIterator(Long2CharAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2CharSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2CharAVLTreeMap.KeyIterator(Long2CharAVLTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2CharAVLTreeMap.KeyIterator(Long2CharAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2CharAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Long2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Long2CharMap.Entry
  {
    ...
    Entry(long local_k, char local_v)
    {
      this.key = local_k;
      this.value = local_v;
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Character> local_e = (Map.Entry)local_o;
      return (this.key == ((Long)local_e.getKey()).longValue()) && (this.value == ((Character)local_e.getValue()).charValue());
    }
