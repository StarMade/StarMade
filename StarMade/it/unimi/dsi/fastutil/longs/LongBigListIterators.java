...
/* 157 */       this.i.set(ok); } 
/* 158 */     public void add(long ok) { this.i.add(ok); } 
...
/* 166 */     public long nextLong() { return this.i.nextLong(); } 
/* 167 */     public long previousLong() { return this.i.previousLong(); } 
...
/* 125 */     public long nextLong() { return this.i.nextLong(); } 
/* 126 */     public long previousLong() { return this.i.previousLong(); } 
/* 127 */     public long nextIndex() { return this.i.nextIndex(); } 
/* 128 */     public long previousIndex() { return this.i.previousIndex(); } 
/*     */     public Long next() {
/* 130 */       return (Long)this.i.next(); } 
/* 131 */     public Long previous() { return (Long)this.i.previous(); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */   }
/*     */ 
/*     */   public static class EmptyBigListIterator extends AbstractLongBigListIterator
...
/*  63 */     public long nextLong() { throw new NoSuchElementException(); } 
/*  64 */     public long previousLong() { throw new NoSuchElementException(); } 
...
/*  69 */     public Object clone() { return LongBigListIterators.EMPTY_BIG_LIST_ITERATOR; } 
/*  70 */     private Object readResolve() { return LongBigListIterators.EMPTY_BIG_LIST_ITERATOR; }
/*     */ 
/*     */   }
/*     */ }
