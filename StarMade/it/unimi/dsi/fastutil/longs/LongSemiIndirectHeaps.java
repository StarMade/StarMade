...
{
  public static int downHeap(long[] refArray, int[] heap, int size, int local_i, LongComparator local_c)
  {
    if (local_i >= size) {
  ...
  public static int upHeap(long[] refArray, int[] heap, int size, int local_i, LongComparator local_c)
  {
    if (local_i >= size) {
      throw new IllegalArgumentException("Heap position (" + local_i + ") is larger than or equal to heap size (" + size + ")");
    }
  ...
  public static void makeHeap(long[] refArray, int offset, int length, int[] heap, LongComparator local_c)
  {
  ...
  public static int[] makeHeap(long[] refArray, int offset, int length, LongComparator local_c)
  {
  ...
  public static void makeHeap(long[] refArray, int[] heap, int size, LongComparator local_c)
  {
    int local_i = size / 2;
    while (local_i-- != 0) {
  ...
  public static int front(long[] refArray, int[] heap, int size, int[] local_a)
  {
