...
/*     */ 
/*     */ public class Long2IntArrayMap extends AbstractLong2IntMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Long2IntArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Long2IntMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Long2IntArrayMap.this.size; }
/*     */ 
/*     */         public Long2IntMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractLong2IntMap.BasicEntry(Long2IntArrayMap.this.key[this.next], Long2IntArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractLong2IntMap.BasicEntry entry = new AbstractLong2IntMap.BasicEntry(0L, 0);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Long2IntArrayMap.this.size; }
/*     */ 
/*     */         public Long2IntMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Long2IntArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Long2IntArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Long2IntArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Long2IntArrayMap.this.containsKey(k)) && (Long2IntArrayMap.this.get(k) == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */   }
/*     */ }
