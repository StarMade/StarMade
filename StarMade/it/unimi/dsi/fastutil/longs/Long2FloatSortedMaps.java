...
public class Long2FloatSortedMaps
{
  ...
  public static Long2FloatSortedMap synchronize(Long2FloatSortedMap local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static Long2FloatSortedMap synchronize(Long2FloatSortedMap local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static Long2FloatSortedMap unmodifiable(Long2FloatSortedMap local_m)
  {
    ...
    implements Long2FloatSortedMap, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Long2FloatSortedMap local_m)
    {
      super();
    ...
    implements Long2FloatSortedMap, Serializable
  {
    ...
    protected SynchronizedSortedMap(Long2FloatSortedMap local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Long2FloatSortedMap local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Long2FloatSortedMap, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Long2FloatMaps.Singleton.SingletonEntry(this), Long2FloatSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
