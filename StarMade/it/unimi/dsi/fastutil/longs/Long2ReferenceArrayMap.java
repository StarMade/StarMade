  ...
  implements Serializable, Cloneable
{
  ...
  public Long2ReferenceArrayMap(Long2ReferenceMap<V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Long2ReferenceArrayMap(Map<? extends Long, ? extends V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Long2ReferenceArrayMap<V> local_c;
    try
    {
      local_c = (Long2ReferenceArrayMap)super.clone();
    }
    ...
    implements Long2ReferenceMap.FastEntrySet<V>
  {
    ...
    public ObjectIterator<Long2ReferenceMap.Entry<V>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Long2ReferenceMap.Entry<V> next()
        {
          ...
          return new AbstractLong2ReferenceMap.BasicEntry(Long2ReferenceArrayMap.this.key[this.next], Long2ReferenceArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Long2ReferenceMap.Entry<V>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Long2ReferenceMap.Entry<V> next()
        {
          ...
          this.entry.key = Long2ReferenceArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Long2ReferenceArrayMap.this.containsKey(local_k)) && (Long2ReferenceArrayMap.this.get(local_k) == local_e.getValue());
    }
  }
}
