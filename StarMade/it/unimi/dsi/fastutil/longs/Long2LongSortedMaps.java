...
public class Long2LongSortedMaps
{
  ...
  public static Long2LongSortedMap synchronize(Long2LongSortedMap local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static Long2LongSortedMap synchronize(Long2LongSortedMap local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static Long2LongSortedMap unmodifiable(Long2LongSortedMap local_m)
  {
    ...
    implements Long2LongSortedMap, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Long2LongSortedMap local_m)
    {
      super();
    ...
    implements Long2LongSortedMap, Serializable
  {
    ...
    protected SynchronizedSortedMap(Long2LongSortedMap local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Long2LongSortedMap local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Long2LongSortedMap, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Long2LongMaps.Singleton.SingletonEntry(this), Long2LongSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
