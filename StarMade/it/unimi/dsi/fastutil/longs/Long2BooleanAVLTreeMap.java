  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2BooleanAVLTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2BooleanAVLTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2BooleanAVLTreeMap(Map<? extends Long, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2BooleanAVLTreeMap(SortedMap<Long, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2BooleanAVLTreeMap(Long2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2BooleanAVLTreeMap(Long2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2BooleanAVLTreeMap(long[] local_k, boolean[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2BooleanAVLTreeMap(long[] local_k, boolean[] local_v)
  {
  ...
  {
    boolean oldValue = put(local_ok.longValue(), local_ov.booleanValue());
    return this.modified ? null : Boolean.valueOf(oldValue);
  }
  
  public Boolean remove(Object local_ok)
  {
    boolean oldValue = remove(((Long)local_ok).longValue());
  ...
  public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Long2BooleanMap.Entry> comparator = new Comparator()
        {
          public int compare(Long2BooleanMap.Entry local_x, Long2BooleanMap.Entry local_y)
          {
            return Long2BooleanAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2BooleanAVLTreeMap.EntryIterator(Long2BooleanAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator(Long2BooleanMap.Entry from)
        {
          return new Long2BooleanAVLTreeMap.EntryIterator(Long2BooleanAVLTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2BooleanAVLTreeMap.Entry local_f = Long2BooleanAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2BooleanAVLTreeMap.Entry local_f = Long2BooleanAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2BooleanAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry from, Long2BooleanMap.Entry local_to)
        {
          return Long2BooleanAVLTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry local_to)
        {
          return Long2BooleanAVLTreeMap.this.headMap((Long)local_to.getKey()).long2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry from)
        {
          return Long2BooleanAVLTreeMap.this.tailMap((Long)from.getKey()).long2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Long2BooleanAVLTreeMap.ValueIterator(Long2BooleanAVLTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Long2BooleanAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2BooleanAVLTreeMap local_c;
    try
    {
      local_c = (Long2BooleanAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readLong(), local_s.readBoolean());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readLong(), local_s.readBoolean());
      top.right(new Entry(local_s.readLong(), local_s.readBoolean()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2BooleanAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2BooleanAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2BooleanAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator()
          {
            return new Long2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Long2BooleanAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator(Long2BooleanMap.Entry from)
          {
            return new Long2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Long2BooleanAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Boolean> local_e = (Map.Entry)local_o;
            Long2BooleanAVLTreeMap.Entry local_f = Long2BooleanAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2BooleanAVLTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Boolean> local_e = (Map.Entry)local_o;
            Long2BooleanAVLTreeMap.Entry local_f = Long2BooleanAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2BooleanAVLTreeMap.Submap.this.in1(local_f.key))) {
              Long2BooleanAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2BooleanAVLTreeMap.Submap.SubmapIterator(Long2BooleanAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2BooleanAVLTreeMap.Submap.this.clear();
          }
          
          public Long2BooleanMap.Entry first()
          {
            return Long2BooleanAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Long2BooleanMap.Entry last()
          {
            return Long2BooleanAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry from, Long2BooleanMap.Entry local_to)
          {
            return Long2BooleanAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry local_to)
          {
            return Long2BooleanAVLTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry from)
          {
            return Long2BooleanAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Long2BooleanAVLTreeMap.Submap.SubmapValueIterator(Long2BooleanAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Long2BooleanAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2BooleanAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2BooleanAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2BooleanAVLTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2BooleanAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(long local_k, boolean local_v)
    {
      ...
      boolean oldValue = Long2BooleanAVLTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(long local_k)
    {
      ...
      boolean oldValue = Long2BooleanAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2BooleanSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2BooleanAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2BooleanAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2BooleanSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2BooleanAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2BooleanAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2BooleanAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2BooleanAVLTreeMap.this.locateKey(this.from);
        if (Long2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2BooleanAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2BooleanAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2BooleanAVLTreeMap.this.locateKey(this.field_47);
        if (Long2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2BooleanAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2BooleanAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      implements ObjectListIterator<Long2BooleanMap.Entry>
    {
      ...
      public void set(Long2BooleanMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Long2BooleanMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
      ...
      extends Long2BooleanAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2BooleanAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2BooleanAVLTreeMap.Submap.this.bottom) && (Long2BooleanAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2BooleanAVLTreeMap.Submap.this.top) && (Long2BooleanAVLTreeMap.this.compare(local_k, (this.prev = Long2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2BooleanAVLTreeMap.this.locateKey(local_k);
            if (Long2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2BooleanAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2BooleanAVLTreeMap.this.compare(this.prev.key, Long2BooleanAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2BooleanAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2BooleanAVLTreeMap.this.compare(this.next.key, Long2BooleanAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Long2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Long2BooleanAVLTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Long2BooleanAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2BooleanSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2BooleanAVLTreeMap.KeyIterator(Long2BooleanAVLTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2BooleanAVLTreeMap.KeyIterator(Long2BooleanAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2BooleanAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Long2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Long2BooleanMap.Entry
  {
    ...
    Entry(long local_k, boolean local_v)
    {
      this.key = local_k;
      this.value = local_v;
