  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2IntRBTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2IntRBTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2IntRBTreeMap(Map<? extends Long, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2IntRBTreeMap(SortedMap<Long, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2IntRBTreeMap(Long2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2IntRBTreeMap(Long2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2IntRBTreeMap(long[] local_k, int[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2IntRBTreeMap(long[] local_k, int[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Long2IntMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Long2IntRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2IntRBTreeMap.EntryIterator(Long2IntRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry from)
        {
          return new Long2IntRBTreeMap.EntryIterator(Long2IntRBTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2IntRBTreeMap.Entry local_f = Long2IntRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2IntRBTreeMap.Entry local_f = Long2IntRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2IntRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Long2IntRBTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2IntEntrySet();
        }
        
        public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry local_to)
        {
          return Long2IntRBTreeMap.this.headMap((Long)local_to.getKey()).long2IntEntrySet();
        }
        
        public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry from)
        {
          return Long2IntRBTreeMap.this.tailMap((Long)from.getKey()).long2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Long2IntRBTreeMap.ValueIterator(Long2IntRBTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Long2IntRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2IntRBTreeMap local_c;
    try
    {
      local_c = (Long2IntRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2IntRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2IntRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2IntRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator()
          {
            return new Long2IntRBTreeMap.Submap.SubmapEntryIterator(Long2IntRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry from)
          {
            return new Long2IntRBTreeMap.Submap.SubmapEntryIterator(Long2IntRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Integer> local_e = (Map.Entry)local_o;
            Long2IntRBTreeMap.Entry local_f = Long2IntRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2IntRBTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Integer> local_e = (Map.Entry)local_o;
            Long2IntRBTreeMap.Entry local_f = Long2IntRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2IntRBTreeMap.Submap.this.in1(local_f.key))) {
              Long2IntRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2IntRBTreeMap.Submap.SubmapIterator(Long2IntRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2IntRBTreeMap.Submap.this.clear();
          }
          
          public Long2IntMap.Entry first()
          {
            return Long2IntRBTreeMap.Submap.this.firstEntry();
          }
          
          public Long2IntMap.Entry last()
          {
            return Long2IntRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry from, Long2IntMap.Entry local_to)
          {
            return Long2IntRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2IntEntrySet();
          }
          
          public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry local_to)
          {
            return Long2IntRBTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2IntEntrySet();
          }
          
          public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry from)
          {
            return Long2IntRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Long2IntRBTreeMap.Submap.SubmapValueIterator(Long2IntRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Long2IntRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2IntRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2IntRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2IntRBTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2IntRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(long local_k, int local_v)
    {
      ...
      int oldValue = Long2IntRBTreeMap.this.put(local_k, local_v);
    ...
    public int remove(long local_k)
    {
      ...
      int oldValue = Long2IntRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2IntRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2IntRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2IntSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2IntRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2IntRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2IntSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2IntRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2IntRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2IntRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2IntRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2IntRBTreeMap.this.locateKey(this.from);
        if (Long2IntRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2IntRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2IntRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2IntRBTreeMap.this.locateKey(this.field_47);
        if (Long2IntRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2IntRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2IntRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2IntRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Long2IntRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2IntRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2IntRBTreeMap.Submap.this.bottom) && (Long2IntRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2IntRBTreeMap.Submap.this.top) && (Long2IntRBTreeMap.this.compare(local_k, (this.prev = Long2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2IntRBTreeMap.this.locateKey(local_k);
            if (Long2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2IntRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2IntRBTreeMap.this.compare(this.prev.key, Long2IntRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2IntRBTreeMap.Submap.this.top) && (this.next != null) && (Long2IntRBTreeMap.this.compare(this.next.key, Long2IntRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2IntSortedMap.KeySet
    {
      ...
      {
        return new Long2IntRBTreeMap.Submap.SubmapKeyIterator(Long2IntRBTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2IntRBTreeMap.Submap.SubmapKeyIterator(Long2IntRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2IntSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2IntRBTreeMap.KeyIterator(Long2IntRBTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2IntRBTreeMap.KeyIterator(Long2IntRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2IntRBTreeMap.this.locateKey(local_k)) != null) {
        if (Long2IntRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
