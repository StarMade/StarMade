...
/*      */ 
/*      */ public class Long2IntRBTreeMap extends AbstractLong2IntSortedMap
...
/*  119 */           return Long2IntRBTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  122 */           return Long2IntRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     int oldValue = put(ok.longValue(), ov.intValue());
/*  731 */     return this.modified ? null : Integer.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Integer remove(Object ok)
/*      */   {
/*  737 */     int oldValue = remove(((Long)ok).longValue());
...
/* 1141 */         final Comparator<? super Long2IntMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Long2IntMap.Entry x, Long2IntMap.Entry y) {
/* 1143 */             return Long2IntRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Long2IntRBTreeMap.EntryIterator(Long2IntRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry from) {
/* 1153 */           return new Long2IntRBTreeMap.EntryIterator(Long2IntRBTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Long2IntRBTreeMap.Entry f = Long2IntRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1166 */           Long2IntRBTreeMap.Entry f = Long2IntRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1167 */           if (f != null) Long2IntRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Long2IntRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Long2IntRBTreeMap.this.clear(); } 
/* 1172 */         public Long2IntMap.Entry first() { return Long2IntRBTreeMap.this.firstEntry; } 
/* 1173 */         public Long2IntMap.Entry last() { return Long2IntRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry from, Long2IntMap.Entry to) { return Long2IntRBTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2IntEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry to) { return Long2IntRBTreeMap.this.headMap((Long)to.getKey()).long2IntEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry from) { return Long2IntRBTreeMap.this.tailMap((Long)from.getKey()).long2IntEntrySet(); }
/*      */       };
...
/* 1242 */           return new Long2IntRBTreeMap.ValueIterator(Long2IntRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(int k) {
/* 1245 */           return Long2IntRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Long2IntRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Long2IntRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Long2IntRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readLong(), s.readInt());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readLong(), s.readInt());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readLong(), s.readInt()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Long2IntRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Long2IntRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator() {
/* 1329 */             return new Long2IntRBTreeMap.Submap.SubmapEntryIterator(Long2IntRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry from) {
/* 1332 */             return new Long2IntRBTreeMap.Submap.SubmapEntryIterator(Long2IntRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1334 */           public Comparator<? super Long2IntMap.Entry> comparator() { return Long2IntRBTreeMap.this.long2IntEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Long2IntRBTreeMap.Entry f = Long2IntRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1340 */             return (f != null) && (Long2IntRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Long2IntRBTreeMap.Entry f = Long2IntRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1347 */             if ((f != null) && (Long2IntRBTreeMap.Submap.this.in(f.key))) Long2IntRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Long2IntRBTreeMap.Submap.SubmapIterator(Long2IntRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Long2IntRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Long2IntMap.Entry first() { return Long2IntRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Long2IntMap.Entry last() { return Long2IntRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry from, Long2IntMap.Entry to) { return Long2IntRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2IntEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry to) { return Long2IntRBTreeMap.Submap.this.headMap((Long)to.getKey()).long2IntEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry from) { return Long2IntRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2IntEntrySet(); }
/*      */         };
...
/*      */           public IntIterator iterator() {
/* 1376 */             return new Long2IntRBTreeMap.Submap.SubmapValueIterator(Long2IntRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(int k) {
/* 1379 */             return Long2IntRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Long2IntRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Long2IntRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1392 */       return (in(k)) && (Long2IntRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(int v) {
...
/* 1407 */       return (in(kk)) && ((e = Long2IntRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public int put(long k, int v) {
/* 1410 */       Long2IntRBTreeMap.this.modified = false;
...
/* 1412 */       int oldValue = Long2IntRBTreeMap.this.put(k, v);
/* 1413 */       return Long2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Integer put(Long ok, Integer ov) {
/* 1416 */       int oldValue = put(ok.longValue(), ov.intValue());
/* 1417 */       return Long2IntRBTreeMap.this.modified ? null : Integer.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public int remove(long k) {
/* 1421 */       Long2IntRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       int oldValue = Long2IntRBTreeMap.this.remove(k);
/* 1424 */       return Long2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Integer remove(Object ok) {
/* 1427 */       int oldValue = remove(((Long)ok).longValue());
/* 1428 */       return Long2IntRBTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1443 */       return Long2IntRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2IntSortedMap headMap(long to) {
/* 1446 */       if (this.top) return new Submap(Long2IntRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Long2IntRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2IntRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2IntSortedMap tailMap(long from) {
/* 1450 */       if (this.bottom) return new Submap(Long2IntRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Long2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2IntRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2IntSortedMap subMap(long from, long to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Long2IntRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Long2IntRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Long2IntRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Long2IntRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2IntRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Long2IntRBTreeMap.this.tree == null) return null;
/* 1468 */       Long2IntRBTreeMap.Entry e;
/*      */       Long2IntRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Long2IntRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Long2IntRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Long2IntRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Long2IntRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2IntRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Long2IntRBTreeMap.this.tree == null) return null;
/* 1486 */       Long2IntRBTreeMap.Entry e;
/*      */       Long2IntRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Long2IntRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Long2IntRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Long2IntRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Long2IntRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1497 */       Long2IntRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1502 */       Long2IntRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1507 */       Long2IntRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1512 */       Long2IntRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2IntRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2IntRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2IntRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Long2IntMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Long2IntRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Long2IntRBTreeMap.Submap.this.bottom) && (Long2IntRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Long2IntRBTreeMap.Submap.this.top) && (Long2IntRBTreeMap.this.compare(k, (this.prev = Long2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Long2IntRBTreeMap.this.locateKey(k);
/* 1534 */             if (Long2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Long2IntRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2IntRBTreeMap.this.compare(this.prev.key, Long2IntRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Long2IntRBTreeMap.Submap.this.top) && (this.next != null) && (Long2IntRBTreeMap.this.compare(this.next.key, Long2IntRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public LongBidirectionalIterator iterator() { return new Long2IntRBTreeMap.Submap.SubmapKeyIterator(Long2IntRBTreeMap.Submap.this); } 
/* 1367 */       public LongBidirectionalIterator iterator(long from) { return new Long2IntRBTreeMap.Submap.SubmapKeyIterator(Long2IntRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2IntRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public LongBidirectionalIterator iterator() { return new Long2IntRBTreeMap.KeyIterator(Long2IntRBTreeMap.this); } 
/* 1201 */     public LongBidirectionalIterator iterator(long from) { return new Long2IntRBTreeMap.KeyIterator(Long2IntRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2IntRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2IntRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Long2IntMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Long2IntMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Long2IntRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1067 */       if ((this.next = Long2IntRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Long2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Long2IntRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
