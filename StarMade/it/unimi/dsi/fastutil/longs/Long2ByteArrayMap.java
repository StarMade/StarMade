...
/*  17:    */
/*  66:    */public class Long2ByteArrayMap
/*  67:    */  extends AbstractLong2ByteMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Long2ByteArrayMap(long[] key, byte[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Long2ByteArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = LongArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = ByteArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Long2ByteArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new long[capacity];
/*  94: 94 */    this.value = new byte[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Long2ByteArrayMap(Long2ByteMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Long2ByteArrayMap(Map<? extends Long, ? extends Byte> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Long2ByteArrayMap(long[] key, byte[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Long2ByteMap.Entry> implements Long2ByteMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Long2ByteMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Long2ByteArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Long2ByteMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractLong2ByteMap.BasicEntry(Long2ByteArrayMap.this.key[this.next], Long2ByteArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Long2ByteMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractLong2ByteMap.BasicEntry entry = new AbstractLong2ByteMap.BasicEntry(0L, (byte)0);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Long2ByteArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Long2ByteMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Long2ByteArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Long2ByteArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Long2ByteArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Long, Byte> e = (Map.Entry)o;
/* 165:165 */      long k = ((Long)e.getKey()).longValue();
/* 166:166 */      return (Long2ByteArrayMap.this.containsKey(k)) && (Long2ByteArrayMap.this.get(k) == ((Byte)e.getValue()).byteValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Long2ByteMap.FastEntrySet long2ByteEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public byte put(long k, byte v)
/* 213:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Long2ByteArrayMap clone()
/* 263:    */  {
/* 264:    */    Long2ByteArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Long2ByteArrayMap)super.clone();
/* 270:    */    }
