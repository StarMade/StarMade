...
public class Long2ByteSortedMaps
{
  ...
  public static Long2ByteSortedMap synchronize(Long2ByteSortedMap local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static Long2ByteSortedMap synchronize(Long2ByteSortedMap local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static Long2ByteSortedMap unmodifiable(Long2ByteSortedMap local_m)
  {
    ...
    implements Long2ByteSortedMap, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Long2ByteSortedMap local_m)
    {
      super();
    ...
    implements Long2ByteSortedMap, Serializable
  {
    ...
    protected SynchronizedSortedMap(Long2ByteSortedMap local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Long2ByteSortedMap local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Long2ByteSortedMap, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Long2ByteMaps.Singleton.SingletonEntry(this), Long2ByteSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
