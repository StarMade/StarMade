...
/* 194 */     while (i.hasNext()) add(i.nextLong());
/*     */   }
/*     */ 
...
/*     */   {
/* 211 */     this(LongIterators.asLongIterator(i), f, strategy);
/*     */   }
/*     */ 
/*     */   public LongLinkedOpenCustomHashSet(Iterator<?> i, LongHash.Strategy strategy)
/*     */   {
/* 219 */     this(LongIterators.asLongIterator(i), strategy);
/*     */   }
/*     */ 
...
/*     */   }
/* 609 */   public LongSortedSet tailSet(long from) { throw new UnsupportedOperationException(); } 
/* 610 */   public LongSortedSet headSet(long to) { throw new UnsupportedOperationException(); } 
/* 611 */   public LongSortedSet subSet(long from, long to) { throw new UnsupportedOperationException(); } 
/* 612 */   public LongComparator comparator() { return null; }
/*     */ 
/*     */ 
...
/*     */ 
/* 825 */     long[] key = this.key;
/* 826 */     int newMask = newN - 1;
/* 827 */     long[] newKey = new long[newN];
...
/*     */     try
/*     */     {
/* 874 */       c = (LongLinkedOpenCustomHashSet)super.clone();
/*     */     }
/*     */     catch (CloneNotSupportedException cantHappen) {
/* 877 */       throw new InternalError();
/*     */     }
/* 879 */     c.key = ((long[])this.key.clone());
...
/*     */     }
/* 901 */     return h; } 
/* 904 */   private void writeObject(ObjectOutputStream s) throws IOException { LongIterator i = iterator();
/* 905 */     s.defaultWriteObject();
/* 906 */     for (int j = this.size; j-- != 0; s.writeLong(i.nextLong()));
/*     */   }
/*     */ 
...
/* 914 */     long[] key = this.key = new long[this.n];
...
/* 627 */     int index = -1;
/*     */ 
/* 629 */     SetIterator() { this.next = LongLinkedOpenCustomHashSet.this.first;
/* 630 */       this.index = 0; }
/*     */ 
/*     */     SetIterator(long from) {
/* 633 */       if (LongLinkedOpenCustomHashSet.this.strategy.equals(LongLinkedOpenCustomHashSet.this.key[LongLinkedOpenCustomHashSet.this.last], from)) {
/* 634 */         this.prev = LongLinkedOpenCustomHashSet.this.last;
/* 635 */         this.index = LongLinkedOpenCustomHashSet.this.size;
/*     */       }
/*     */       else
/*     */       {
/* 639 */         int pos = HashCommon.murmurHash3(LongLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & LongLinkedOpenCustomHashSet.this.mask;
/*     */ 
/* 641 */         while (LongLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 642 */           if (LongLinkedOpenCustomHashSet.this.strategy.equals(LongLinkedOpenCustomHashSet.this.key[pos], from))
/*     */           {
/* 644 */             this.next = ((int)LongLinkedOpenCustomHashSet.this.link[pos]);
/* 645 */             this.prev = pos;
/* 646 */             return;
/*     */           }
/* 648 */           pos = pos + 1 & LongLinkedOpenCustomHashSet.this.mask;
/*     */         }
...
/* 658 */       this.next = ((int)LongLinkedOpenCustomHashSet.this.link[this.curr]);
/* 659 */       this.prev = this.curr;
/* 660 */       if (this.index >= 0) this.index += 1;
/*     */ 
/* 662 */       return LongLinkedOpenCustomHashSet.this.key[this.curr];
/*     */     }
/*     */     public long previousLong() {
/* 665 */       if (!hasPrevious()) throw new NoSuchElementException();
/* 666 */       this.curr = this.prev;
/* 667 */       this.prev = ((int)(LongLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 668 */       this.next = this.curr;
/* 669 */       if (this.index >= 0) this.index -= 1;
/* 670 */       return LongLinkedOpenCustomHashSet.this.key[this.curr];
/*     */     }
...
/*     */       }
/* 678 */       if (this.next == -1) {
/* 679 */         this.index = LongLinkedOpenCustomHashSet.this.size;
/* 680 */         return;
/*     */       }
/* 682 */       int pos = LongLinkedOpenCustomHashSet.this.first;
/* 683 */       this.index = 1;
/* 684 */       while (pos != this.prev) {
/* 685 */         pos = (int)LongLinkedOpenCustomHashSet.this.link[pos];
/* 686 */         this.index += 1;
/*     */       }
/*     */     }
/*     */ 
...
/*     */       {
/* 704 */         this.index -= 1;
/* 705 */         this.prev = ((int)(LongLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/*     */       }
/*     */       else {
/* 708 */         this.next = ((int)LongLinkedOpenCustomHashSet.this.link[this.curr]);
/* 709 */       }LongLinkedOpenCustomHashSet.this.size -= 1;
/*     */ 
/* 712 */       if (this.prev == -1) LongLinkedOpenCustomHashSet.this.first = this.next;
/*     */       else
/* 714 */         LongLinkedOpenCustomHashSet.this.link[this.prev] ^= (LongLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/* 715 */       if (this.next == -1) LongLinkedOpenCustomHashSet.this.last = this.prev;
/*     */       else
/* 717 */         LongLinkedOpenCustomHashSet.this.link[this.next] ^= (LongLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*     */       int last;
/*     */       while (true) {
/* 721 */         pos = (last = pos) + 1 & LongLinkedOpenCustomHashSet.this.mask;
/* 722 */         while (LongLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 723 */           int slot = HashCommon.murmurHash3(LongLinkedOpenCustomHashSet.this.strategy.hashCode(LongLinkedOpenCustomHashSet.this.key[pos])) & LongLinkedOpenCustomHashSet.this.mask;
/* 724 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 725 */           pos = pos + 1 & LongLinkedOpenCustomHashSet.this.mask;
/*     */         }
/* 727 */         if (LongLinkedOpenCustomHashSet.this.used[pos] == 0) break;
/* 728 */         LongLinkedOpenCustomHashSet.this.key[last] = LongLinkedOpenCustomHashSet.this.key[pos];
/* 729 */         if (this.next == pos) this.next = last;
/* 730 */         if (this.prev == pos) this.prev = last;
/* 731 */         LongLinkedOpenCustomHashSet.this.fixPointers(pos, last);
/*     */       }
/* 733 */       LongLinkedOpenCustomHashSet.this.used[last] = false;
/* 734 */       this.curr = -1;
/*     */     }
/*     */   }
/*     */ }
