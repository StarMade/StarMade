...
/*  13:    */
/*  89:    */public class LongLinkedOpenCustomHashSet
/*  90:    */  extends AbstractLongSortedSet
...
/* 110:    */  
/* 114:    */  protected LongHash.Strategy strategy;
/* 115:    */  
/* 120:    */  public LongLinkedOpenCustomHashSet(int expected, float f, LongHash.Strategy strategy)
/* 121:    */  {
...
/* 129:129 */    this.key = new long[this.n];
/* 130:130 */    this.used = new boolean[this.n];
/* 131:131 */    this.link = new long[this.n];
/* 132:    */  }
/* 133:    */  
/* 137:    */  public LongLinkedOpenCustomHashSet(int expected, LongHash.Strategy strategy)
/* 138:    */  {
/* 139:139 */    this(expected, 0.75F, strategy);
/* 140:    */  }
/* 141:    */  
/* 144:    */  public LongLinkedOpenCustomHashSet(LongHash.Strategy strategy)
/* 145:    */  {
/* 146:146 */    this(16, 0.75F, strategy);
/* 147:    */  }
/* 148:    */  
/* 153:    */  public LongLinkedOpenCustomHashSet(Collection<? extends Long> c, float f, LongHash.Strategy strategy)
/* 154:    */  {
/* 155:155 */    this(c.size(), f, strategy);
/* 156:156 */    addAll(c);
/* 157:    */  }
/* 158:    */  
/* 163:    */  public LongLinkedOpenCustomHashSet(Collection<? extends Long> c, LongHash.Strategy strategy)
/* 164:    */  {
/* 165:165 */    this(c, 0.75F, strategy);
/* 166:    */  }
/* 167:    */  
/* 172:    */  public LongLinkedOpenCustomHashSet(LongCollection c, float f, LongHash.Strategy strategy)
/* 173:    */  {
/* 174:174 */    this(c.size(), f, strategy);
/* 175:175 */    addAll(c);
/* 176:    */  }
/* 177:    */  
/* 182:    */  public LongLinkedOpenCustomHashSet(LongCollection c, LongHash.Strategy strategy)
/* 183:    */  {
/* 184:184 */    this(c, 0.75F, strategy);
/* 185:    */  }
/* 186:    */  
/* 191:    */  public LongLinkedOpenCustomHashSet(LongIterator i, float f, LongHash.Strategy strategy)
/* 192:    */  {
/* 193:193 */    this(16, f, strategy);
/* 194:194 */    while (i.hasNext()) { add(i.nextLong());
/* 195:    */    }
/* 196:    */  }
/* 197:    */  
/* 200:    */  public LongLinkedOpenCustomHashSet(LongIterator i, LongHash.Strategy strategy)
/* 201:    */  {
/* 202:202 */    this(i, 0.75F, strategy);
/* 203:    */  }
/* 204:    */  
/* 209:    */  public LongLinkedOpenCustomHashSet(Iterator<?> i, float f, LongHash.Strategy strategy)
/* 210:    */  {
/* 211:211 */    this(LongIterators.asLongIterator(i), f, strategy);
/* 212:    */  }
/* 213:    */  
/* 217:    */  public LongLinkedOpenCustomHashSet(Iterator<?> i, LongHash.Strategy strategy)
/* 218:    */  {
/* 219:219 */    this(LongIterators.asLongIterator(i), strategy);
/* 220:    */  }
/* 221:    */  
/* 228:    */  public LongLinkedOpenCustomHashSet(long[] a, int offset, int length, float f, LongHash.Strategy strategy)
/* 229:    */  {
/* 230:230 */    this(length < 0 ? 0 : length, f, strategy);
/* 231:231 */    LongArrays.ensureOffsetLength(a, offset, length);
/* 232:232 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 233:    */    }
/* 234:    */  }
/* 235:    */  
/* 240:    */  public LongLinkedOpenCustomHashSet(long[] a, int offset, int length, LongHash.Strategy strategy)
/* 241:    */  {
/* 242:242 */    this(a, offset, length, 0.75F, strategy);
/* 243:    */  }
/* 244:    */  
/* 249:    */  public LongLinkedOpenCustomHashSet(long[] a, float f, LongHash.Strategy strategy)
/* 250:    */  {
/* 251:251 */    this(a, 0, a.length, f, strategy);
/* 252:    */  }
/* 253:    */  
/* 258:    */  public LongLinkedOpenCustomHashSet(long[] a, LongHash.Strategy strategy)
/* 259:    */  {
/* 260:260 */    this(a, 0.75F, strategy);
/* 261:    */  }
/* 262:    */  
/* 265:    */  public LongHash.Strategy strategy()
/* 266:    */  {
/* 267:267 */    return this.strategy;
/* 268:    */  }
/* 269:    */  
/* 273:    */  public boolean add(long k)
/* 274:    */  {
...
/* 319:    */  }
/* 320:    */  
/* 321:    */  public boolean remove(long k)
/* 322:    */  {
...
/* 336:    */  }
/* 337:    */  
/* 338:    */  public boolean contains(long k)
/* 339:    */  {
...
/* 347:    */  }
/* 348:    */  
/* 351:    */  public long removeFirstLong()
/* 352:    */  {
...
/* 361:    */    }
/* 362:362 */    long k = this.key[pos];
/* 363:363 */    shiftKeys(pos);
/* 364:364 */    return k;
/* 365:    */  }
/* 366:    */  
/* 369:    */  public long removeLastLong()
/* 370:    */  {
...
/* 419:    */  }
/* 420:    */  
/* 424:    */  public boolean addAndMoveToFirst(long k)
/* 425:    */  {
/* 426:426 */    long[] key = this.key;
...
/* 454:    */  }
/* 455:    */  
/* 459:    */  public boolean addAndMoveToLast(long k)
/* 460:    */  {
...
/* 592:    */  }
/* 593:    */  
/* 596:    */  public long firstLong()
/* 597:    */  {
/* 598:598 */    if (this.size == 0) throw new NoSuchElementException();
/* 599:599 */    return this.key[this.first];
/* 600:    */  }
/* 601:    */  
/* 604:    */  public long lastLong()
/* 605:    */  {
/* 606:606 */    if (this.size == 0) throw new NoSuchElementException();
/* 607:607 */    return this.key[this.last]; }
/* 608:    */  
/* 609:609 */  public LongSortedSet tailSet(long from) { throw new UnsupportedOperationException(); }
/* 610:610 */  public LongSortedSet headSet(long to) { throw new UnsupportedOperationException(); }
/* 611:611 */  public LongSortedSet subSet(long from, long to) { throw new UnsupportedOperationException(); }
/* 612:612 */  public LongComparator comparator() { return null; }
/* 613:    */  
/* 618:    */  private class SetIterator
/* 619:    */    extends AbstractLongListIterator
/* 620:    */  {
/* 621:621 */    int prev = -1;
/* 622:    */    
/* 623:623 */    int next = -1;
...
/* 627:627 */    int index = -1;
/* 628:    */    
/* 629:629 */    SetIterator() { this.next = LongLinkedOpenCustomHashSet.this.first;
/* 630:630 */      this.index = 0;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    SetIterator(long from) { if (LongLinkedOpenCustomHashSet.this.strategy.equals(LongLinkedOpenCustomHashSet.this.key[LongLinkedOpenCustomHashSet.this.last], from)) {
/* 634:634 */        this.prev = LongLinkedOpenCustomHashSet.this.last;
/* 635:635 */        this.index = LongLinkedOpenCustomHashSet.this.size;
/* 636:    */      }
/* 637:    */      else
/* 638:    */      {
/* 639:639 */        int pos = HashCommon.murmurHash3(LongLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & LongLinkedOpenCustomHashSet.this.mask;
/* 640:    */        
/* 641:641 */        while (LongLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 642:642 */          if (LongLinkedOpenCustomHashSet.this.strategy.equals(LongLinkedOpenCustomHashSet.this.key[pos], from))
/* 643:    */          {
/* 644:644 */            this.next = ((int)LongLinkedOpenCustomHashSet.this.link[pos]);
/* 645:645 */            this.prev = pos;
/* 646:646 */            return;
/* 647:    */          }
/* 648:648 */          pos = pos + 1 & LongLinkedOpenCustomHashSet.this.mask;
/* 649:    */        }
...
/* 655:    */    
/* 656:656 */    public long nextLong() { if (!hasNext()) throw new NoSuchElementException();
/* 657:657 */      this.curr = this.next;
/* 658:658 */      this.next = ((int)LongLinkedOpenCustomHashSet.this.link[this.curr]);
/* 659:659 */      this.prev = this.curr;
/* 660:660 */      if (this.index >= 0) { this.index += 1;
/* 661:    */      }
/* 662:662 */      return LongLinkedOpenCustomHashSet.this.key[this.curr];
/* 663:    */    }
/* 664:    */    
/* 665:665 */    public long previousLong() { if (!hasPrevious()) throw new NoSuchElementException();
/* 666:666 */      this.curr = this.prev;
/* 667:667 */      this.prev = ((int)(LongLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 668:668 */      this.next = this.curr;
/* 669:669 */      if (this.index >= 0) this.index -= 1;
/* 670:670 */      return LongLinkedOpenCustomHashSet.this.key[this.curr];
/* 671:    */    }
/* 672:    */    
...
/* 679:679 */        this.index = LongLinkedOpenCustomHashSet.this.size;
/* 680:680 */        return;
/* 681:    */      }
/* 682:682 */      int pos = LongLinkedOpenCustomHashSet.this.first;
/* 683:683 */      this.index = 1;
/* 684:684 */      while (pos != this.prev) {
/* 685:685 */        pos = (int)LongLinkedOpenCustomHashSet.this.link[pos];
...
/* 705:705 */        this.prev = ((int)(LongLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 706:    */      }
/* 707:    */      else {
/* 708:708 */        this.next = ((int)LongLinkedOpenCustomHashSet.this.link[this.curr]); }
/* 709:709 */      LongLinkedOpenCustomHashSet.this.size -= 1;
/* 710:    */      
/* 712:712 */      if (this.prev == -1) { LongLinkedOpenCustomHashSet.this.first = this.next;
/* 713:    */      } else
/* 714:714 */        LongLinkedOpenCustomHashSet.this.link[this.prev] ^= (LongLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/* 715:715 */      if (this.next == -1) { LongLinkedOpenCustomHashSet.this.last = this.prev;
/* 716:    */      } else
/* 717:717 */        LongLinkedOpenCustomHashSet.this.link[this.next] ^= (LongLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/* 718:718 */      int pos = this.curr;
/* 719:    */      int last;
/* 720:    */      for (;;) {
/* 721:721 */        pos = (last = pos) + 1 & LongLinkedOpenCustomHashSet.this.mask;
/* 722:722 */        while (LongLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 723:723 */          int slot = HashCommon.murmurHash3(LongLinkedOpenCustomHashSet.this.strategy.hashCode(LongLinkedOpenCustomHashSet.this.key[pos])) & LongLinkedOpenCustomHashSet.this.mask;
/* 724:724 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 725:725 */          pos = pos + 1 & LongLinkedOpenCustomHashSet.this.mask;
/* 726:    */        }
/* 727:727 */        if (LongLinkedOpenCustomHashSet.this.used[pos] == 0) break;
/* 728:728 */        LongLinkedOpenCustomHashSet.this.key[last] = LongLinkedOpenCustomHashSet.this.key[pos];
/* 729:729 */        if (this.next == pos) this.next = last;
/* 730:730 */        if (this.prev == pos) this.prev = last;
/* 731:731 */        LongLinkedOpenCustomHashSet.this.fixPointers(pos, last);
/* 732:    */      }
/* 733:733 */      LongLinkedOpenCustomHashSet.this.used[last] = false;
/* 734:734 */      this.curr = -1;
/* 735:    */    }
/* 736:    */  }
/* 737:    */  
/* 743:    */  public LongListIterator iterator(long from)
/* 744:    */  {
/* 745:745 */    return new SetIterator(from);
/* 746:    */  }
/* 747:    */  
/* 748:748 */  public LongListIterator iterator() { return new SetIterator(); }
/* 749:    */  
/* 759:    */  @Deprecated
...
/* 824:    */    
/* 825:825 */    long[] key = this.key;
/* 826:826 */    int newMask = newN - 1;
/* 827:827 */    long[] newKey = new long[newN];
...
/* 863:    */  }
/* 864:    */  
/* 867:    */  public LongLinkedOpenCustomHashSet clone()
/* 868:    */  {
/* 869:    */    LongLinkedOpenCustomHashSet c;
/* 870:    */    
/* 872:    */    try
/* 873:    */    {
/* 874:874 */      c = (LongLinkedOpenCustomHashSet)super.clone();
/* 875:    */    }
/* 876:    */    catch (CloneNotSupportedException cantHappen) {
/* 877:877 */      throw new InternalError();
/* 878:    */    }
/* 879:879 */    c.key = ((long[])this.key.clone());
...
/* 902:    */  }
/* 903:    */  
/* 904:904 */  private void writeObject(ObjectOutputStream s) throws IOException { LongIterator i = iterator();
/* 905:905 */    s.defaultWriteObject();
/* 906:906 */    for (int j = this.size; j-- != 0; s.writeLong(i.nextLong())) {}
/* 907:    */  }
/* 908:    */  
...
/* 914:914 */    long[] key = this.key = new long[this.n];
