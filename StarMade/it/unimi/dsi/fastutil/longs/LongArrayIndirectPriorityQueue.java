  ...
  implements LongIndirectPriorityQueue
{
  ...
  public LongArrayIndirectPriorityQueue(long[] refArray, int capacity, LongComparator local_c)
  {
    if (capacity > 0) {
  ...
  public LongArrayIndirectPriorityQueue(long[] refArray, LongComparator local_c)
  {
  ...
  public LongArrayIndirectPriorityQueue(long[] refArray, int[] local_a, int size, LongComparator local_c)
  {
  ...
  public LongArrayIndirectPriorityQueue(long[] refArray, int[] local_a, LongComparator local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public LongArrayIndirectPriorityQueue(long[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public LongArrayIndirectPriorityQueue(long[] refArray, int[] local_a)
  {
