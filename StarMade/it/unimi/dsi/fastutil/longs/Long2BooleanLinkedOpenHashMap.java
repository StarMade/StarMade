  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2BooleanLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2BooleanLinkedOpenHashMap(Map<? extends Long, ? extends Boolean> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2BooleanLinkedOpenHashMap(Map<? extends Long, ? extends Boolean> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2BooleanLinkedOpenHashMap(Long2BooleanMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2BooleanLinkedOpenHashMap(Long2BooleanMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2BooleanLinkedOpenHashMap(long[] local_k, boolean[] local_v, float local_f)
  {
  ...
  public Long2BooleanLinkedOpenHashMap(long[] local_k, boolean[] local_v)
  {
  ...
  public boolean getAndMoveToFirst(long local_k)
  {
    long[] key = this.key;
  ...
  public boolean getAndMoveToLast(long local_k)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public boolean putAndMoveToFirst(long local_k, boolean local_v)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public boolean putAndMoveToLast(long local_k, boolean local_v)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Long2BooleanLinkedOpenHashMap.ValueIterator(Long2BooleanLinkedOpenHashMap.this);
        }
        ...
        {
          return Long2BooleanLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2BooleanLinkedOpenHashMap local_c;
    try
    {
      local_c = (Long2BooleanLinkedOpenHashMap)super.clone();
    }
    ...
    implements BooleanListIterator
  {
    ...
    {
      return Boolean.valueOf(Long2BooleanLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Boolean next()
    {
      return Boolean.valueOf(Long2BooleanLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSortedSet
  {
    ...
    {
      return new Long2BooleanLinkedOpenHashMap.KeyIterator(Long2BooleanLinkedOpenHashMap.this, from);
    }
    
    public LongListIterator iterator()
    {
      return new Long2BooleanLinkedOpenHashMap.KeyIterator(Long2BooleanLinkedOpenHashMap.this);
    }
    ...
    {
      return Long2BooleanLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2BooleanLinkedOpenHashMap.this.size;
      Long2BooleanLinkedOpenHashMap.this.remove(local_k);
    ...
    implements LongListIterator
  {
    ...
    {
      return Long.valueOf(Long2BooleanLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Long next()
    {
      return Long.valueOf(Long2BooleanLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2BooleanSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Long2BooleanLinkedOpenHashMap.EntryIterator(Long2BooleanLinkedOpenHashMap.this);
    }
    ...
    public Long2BooleanMap.Entry first()
    {
      ...
      return new Long2BooleanLinkedOpenHashMap.MapEntry(Long2BooleanLinkedOpenHashMap.this, Long2BooleanLinkedOpenHashMap.this.first);
    }
    ...
    public Long2BooleanMap.Entry last()
    {
      ...
      return new Long2BooleanLinkedOpenHashMap.MapEntry(Long2BooleanLinkedOpenHashMap.this, Long2BooleanLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2BooleanLinkedOpenHashMap.this.mask; Long2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2BooleanLinkedOpenHashMap.this.mask) {
        if (Long2BooleanLinkedOpenHashMap.this.key[pos] == local_k) {
          return Long2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)local_e.getValue()).booleanValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2BooleanLinkedOpenHashMap.this.mask; Long2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2BooleanLinkedOpenHashMap.this.mask) {
        if (Long2BooleanLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Long2BooleanLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Long2BooleanLinkedOpenHashMap.EntryIterator(Long2BooleanLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
    
    public ObjectBidirectionalIterator<Long2BooleanMap.Entry> fastIterator()
    {
      return new Long2BooleanLinkedOpenHashMap.FastEntryIterator(Long2BooleanLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Long2BooleanMap.Entry> fastIterator(Long2BooleanMap.Entry from)
    {
      return new Long2BooleanLinkedOpenHashMap.FastEntryIterator(Long2BooleanLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
  }
    ...
    implements ObjectListIterator<Long2BooleanMap.Entry>
  {
    ...
    public AbstractLong2BooleanMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2BooleanLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Long2BooleanLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Long2BooleanMap.Entry>
  {
    ...
    {
      return this.entry = new Long2BooleanLinkedOpenHashMap.MapEntry(Long2BooleanLinkedOpenHashMap.this, nextEntry());
    }
    
    public Long2BooleanLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Long2BooleanLinkedOpenHashMap.MapEntry(Long2BooleanLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(long from)
    {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(from) & Long2BooleanLinkedOpenHashMap.this.mask; Long2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2BooleanLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Long2BooleanLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Long2BooleanLinkedOpenHashMap.this.first = this.next;
      } else {
        Long2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Long2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Long2BooleanLinkedOpenHashMap.this.last = this.prev;
      } else {
        Long2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Long2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2BooleanLinkedOpenHashMap.this.mask; Long2BooleanLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2BooleanLinkedOpenHashMap.this.mask)
        {
        ...
        if (Long2BooleanLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Long2BooleanMap.Entry, Map.Entry<Long, Boolean>
  {
    ...
    public boolean setValue(boolean local_v)
    {
      ...
      Long2BooleanLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Boolean> local_e = (Map.Entry)local_o;
      return (Long2BooleanLinkedOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)local_e.getValue()).booleanValue());
    }
    
    public int hashCode()
    {
      return HashCommon.long2int(Long2BooleanLinkedOpenHashMap.this.key[this.index]) ^ (Long2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
    }
