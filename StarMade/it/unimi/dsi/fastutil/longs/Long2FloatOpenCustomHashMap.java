  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2FloatOpenCustomHashMap(int expected, float local_f, LongHash.Strategy strategy)
  {
  ...
  public Long2FloatOpenCustomHashMap(Map<? extends Long, ? extends Float> local_m, float local_f, LongHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Long2FloatOpenCustomHashMap(Map<? extends Long, ? extends Float> local_m, LongHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Long2FloatOpenCustomHashMap(Long2FloatMap local_m, float local_f, LongHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Long2FloatOpenCustomHashMap(Long2FloatMap local_m, LongHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Long2FloatOpenCustomHashMap(long[] local_k, float[] local_v, float local_f, LongHash.Strategy strategy)
  {
  ...
  public Long2FloatOpenCustomHashMap(long[] local_k, float[] local_v, LongHash.Strategy strategy)
  {
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Long2FloatOpenCustomHashMap.ValueIterator(Long2FloatOpenCustomHashMap.this);
        }
        ...
        {
          return Long2FloatOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2FloatOpenCustomHashMap local_c;
    try
    {
      local_c = (Long2FloatOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Long2FloatOpenCustomHashMap.MapIterator
    implements FloatIterator
  {
    ...
    public Float next()
    {
      return Float.valueOf(Long2FloatOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSet
  {
    ...
    {
      return new Long2FloatOpenCustomHashMap.KeyIterator(Long2FloatOpenCustomHashMap.this);
    }
    ...
    {
      return Long2FloatOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2FloatOpenCustomHashMap.this.size;
      Long2FloatOpenCustomHashMap.this.remove(local_k);
    ...
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Long2FloatOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2FloatMap.FastEntrySet
  {
    ...
    {
      return new Long2FloatOpenCustomHashMap.EntryIterator(Long2FloatOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Long2FloatMap.Entry> fastIterator()
    {
      return new Long2FloatOpenCustomHashMap.FastEntryIterator(Long2FloatOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Long2FloatOpenCustomHashMap.this.strategy.hashCode(local_k)) & Long2FloatOpenCustomHashMap.this.mask; Long2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Long2FloatOpenCustomHashMap.this.mask) {
        if (Long2FloatOpenCustomHashMap.this.strategy.equals(Long2FloatOpenCustomHashMap.this.key[pos], local_k)) {
          return Long2FloatOpenCustomHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Long2FloatOpenCustomHashMap.this.strategy.hashCode(local_k)) & Long2FloatOpenCustomHashMap.this.mask; Long2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Long2FloatOpenCustomHashMap.this.mask) {
        if (Long2FloatOpenCustomHashMap.this.strategy.equals(Long2FloatOpenCustomHashMap.this.key[pos], local_k))
        {
          Long2FloatOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Long2FloatMap.Entry>
  {
    ...
    public AbstractLong2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2FloatOpenCustomHashMap.this.key[local_e];
      this.entry.value = Long2FloatOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Long2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Long2FloatOpenCustomHashMap.MapEntry(Long2FloatOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Long2FloatOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1647 = Long2FloatOpenCustomHashMap.this.size;
    LongArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Long2FloatOpenCustomHashMap.this.used;
      while ((this.field_1647 != 0) && (used[(--this.pos)] == 0)) {}
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Long2FloatOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2FloatOpenCustomHashMap.this.mask; Long2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Long2FloatOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Long2FloatOpenCustomHashMap.this.strategy.hashCode(Long2FloatOpenCustomHashMap.this.key[pos])) & Long2FloatOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2FloatOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Long2FloatOpenCustomHashMap.this.key[pos]);
        }
        Long2FloatOpenCustomHashMap.this.key[last] = Long2FloatOpenCustomHashMap.this.key[pos];
        Long2FloatOpenCustomHashMap.this.value[last] = Long2FloatOpenCustomHashMap.this.value[pos];
      }
      Long2FloatOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Long2FloatOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
        this.last = -1;
        return;
      }
      Long2FloatOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1647 > 0))
      {
        this.field_1647 += 1;
        nextEntry();
      }
    ...
    implements Long2FloatMap.Entry, Map.Entry<Long, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Long2FloatOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Float> local_e = (Map.Entry)local_o;
      return (Long2FloatOpenCustomHashMap.this.strategy.equals(Long2FloatOpenCustomHashMap.this.key[this.index], ((Long)local_e.getKey()).longValue())) && (Long2FloatOpenCustomHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
