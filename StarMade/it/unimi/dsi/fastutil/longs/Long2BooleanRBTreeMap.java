...
/*      */ 
/*      */ public class Long2BooleanRBTreeMap extends AbstractLong2BooleanSortedMap
...
/*  119 */           return Long2BooleanRBTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  122 */           return Long2BooleanRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     boolean oldValue = put(ok.longValue(), ov.booleanValue());
/*  731 */     return this.modified ? null : Boolean.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Boolean remove(Object ok)
/*      */   {
/*  737 */     boolean oldValue = remove(((Long)ok).longValue());
...
/* 1141 */         final Comparator<? super Long2BooleanMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Long2BooleanMap.Entry x, Long2BooleanMap.Entry y) {
/* 1143 */             return Long2BooleanRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Long2BooleanRBTreeMap.EntryIterator(Long2BooleanRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator(Long2BooleanMap.Entry from) {
/* 1153 */           return new Long2BooleanRBTreeMap.EntryIterator(Long2BooleanRBTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Long2BooleanRBTreeMap.Entry f = Long2BooleanRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1166 */           Long2BooleanRBTreeMap.Entry f = Long2BooleanRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1167 */           if (f != null) Long2BooleanRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Long2BooleanRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Long2BooleanRBTreeMap.this.clear(); } 
/* 1172 */         public Long2BooleanMap.Entry first() { return Long2BooleanRBTreeMap.this.firstEntry; } 
/* 1173 */         public Long2BooleanMap.Entry last() { return Long2BooleanRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry from, Long2BooleanMap.Entry to) { return Long2BooleanRBTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2BooleanEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry to) { return Long2BooleanRBTreeMap.this.headMap((Long)to.getKey()).long2BooleanEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry from) { return Long2BooleanRBTreeMap.this.tailMap((Long)from.getKey()).long2BooleanEntrySet(); }
/*      */       };
...
/* 1242 */           return new Long2BooleanRBTreeMap.ValueIterator(Long2BooleanRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(boolean k) {
/* 1245 */           return Long2BooleanRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Long2BooleanRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
...
/*      */     try
/*      */     {
/* 1611 */       c = (Long2BooleanRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readLong(), s.readBoolean());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readLong(), s.readBoolean());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readLong(), s.readBoolean()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Long2BooleanRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Long2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1323 */       return ((this.bottom) || (Long2BooleanRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Long2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet() {
/* 1327 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator() {
/* 1329 */             return new Long2BooleanRBTreeMap.Submap.SubmapEntryIterator(Long2BooleanRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator(Long2BooleanMap.Entry from) {
/* 1332 */             return new Long2BooleanRBTreeMap.Submap.SubmapEntryIterator(Long2BooleanRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1334 */           public Comparator<? super Long2BooleanMap.Entry> comparator() { return Long2BooleanRBTreeMap.this.long2BooleanEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Long2BooleanRBTreeMap.Entry f = Long2BooleanRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1340 */             return (f != null) && (Long2BooleanRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Long2BooleanRBTreeMap.Entry f = Long2BooleanRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1347 */             if ((f != null) && (Long2BooleanRBTreeMap.Submap.this.in(f.key))) Long2BooleanRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Long2BooleanRBTreeMap.Submap.SubmapIterator(Long2BooleanRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Long2BooleanRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Long2BooleanMap.Entry first() { return Long2BooleanRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Long2BooleanMap.Entry last() { return Long2BooleanRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry from, Long2BooleanMap.Entry to) { return Long2BooleanRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2BooleanEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry to) { return Long2BooleanRBTreeMap.Submap.this.headMap((Long)to.getKey()).long2BooleanEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry from) { return Long2BooleanRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2BooleanEntrySet(); }
/*      */         };
...
/*      */           public BooleanIterator iterator() {
/* 1376 */             return new Long2BooleanRBTreeMap.Submap.SubmapValueIterator(Long2BooleanRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(boolean k) {
/* 1379 */             return Long2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Long2BooleanRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Long2BooleanRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1392 */       return (in(k)) && (Long2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(boolean v) {
...
/* 1407 */       return (in(kk)) && ((e = Long2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public boolean put(long k, boolean v) {
/* 1410 */       Long2BooleanRBTreeMap.this.modified = false;
...
/* 1412 */       boolean oldValue = Long2BooleanRBTreeMap.this.put(k, v);
/* 1413 */       return Long2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Boolean put(Long ok, Boolean ov) {
/* 1416 */       boolean oldValue = put(ok.longValue(), ov.booleanValue());
/* 1417 */       return Long2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public boolean remove(long k) {
/* 1421 */       Long2BooleanRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       boolean oldValue = Long2BooleanRBTreeMap.this.remove(k);
/* 1424 */       return Long2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Boolean remove(Object ok) {
/* 1427 */       boolean oldValue = remove(((Long)ok).longValue());
/* 1428 */       return Long2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1443 */       return Long2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2BooleanSortedMap headMap(long to) {
/* 1446 */       if (this.top) return new Submap(Long2BooleanRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Long2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2BooleanRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2BooleanSortedMap tailMap(long from) {
/* 1450 */       if (this.bottom) return new Submap(Long2BooleanRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Long2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2BooleanRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2BooleanSortedMap subMap(long from, long to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Long2BooleanRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Long2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Long2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Long2BooleanRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2BooleanRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Long2BooleanRBTreeMap.this.tree == null) return null;
/* 1468 */       Long2BooleanRBTreeMap.Entry e;
/*      */       Long2BooleanRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Long2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Long2BooleanRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Long2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Long2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2BooleanRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Long2BooleanRBTreeMap.this.tree == null) return null;
/* 1486 */       Long2BooleanRBTreeMap.Entry e;
/*      */       Long2BooleanRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Long2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Long2BooleanRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Long2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Long2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1497 */       Long2BooleanRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1502 */       Long2BooleanRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1507 */       Long2BooleanRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1512 */       Long2BooleanRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Long2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Long2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Long2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Long2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Long2BooleanRBTreeMap.Submap.this.bottom) && (Long2BooleanRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Long2BooleanRBTreeMap.Submap.this.top) && (Long2BooleanRBTreeMap.this.compare(k, (this.prev = Long2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Long2BooleanRBTreeMap.this.locateKey(k);
/* 1534 */             if (Long2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Long2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2BooleanRBTreeMap.this.compare(this.prev.key, Long2BooleanRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Long2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Long2BooleanRBTreeMap.this.compare(this.next.key, Long2BooleanRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public LongBidirectionalIterator iterator() { return new Long2BooleanRBTreeMap.Submap.SubmapKeyIterator(Long2BooleanRBTreeMap.Submap.this); } 
/* 1367 */       public LongBidirectionalIterator iterator(long from) { return new Long2BooleanRBTreeMap.Submap.SubmapKeyIterator(Long2BooleanRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2BooleanRBTreeMap.TreeIterator
/*      */     implements BooleanListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public LongBidirectionalIterator iterator() { return new Long2BooleanRBTreeMap.KeyIterator(Long2BooleanRBTreeMap.this); } 
/* 1201 */     public LongBidirectionalIterator iterator(long from) { return new Long2BooleanRBTreeMap.KeyIterator(Long2BooleanRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2BooleanRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2BooleanRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Long2BooleanMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Long2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Long2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Long2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Long2BooleanRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1067 */       if ((this.next = Long2BooleanRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Long2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Long2BooleanRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/*  983 */       return HashCommon.long2int(this.key) ^ (this.value ? 1231 : 1237);
/*      */     }
/*      */ 
