  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2BooleanRBTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2BooleanRBTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2BooleanRBTreeMap(Map<? extends Long, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2BooleanRBTreeMap(SortedMap<Long, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2BooleanRBTreeMap(Long2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2BooleanRBTreeMap(Long2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2BooleanRBTreeMap(long[] local_k, boolean[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2BooleanRBTreeMap(long[] local_k, boolean[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Long2BooleanMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Long2BooleanRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2BooleanRBTreeMap.EntryIterator(Long2BooleanRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator(Long2BooleanMap.Entry from)
        {
          return new Long2BooleanRBTreeMap.EntryIterator(Long2BooleanRBTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2BooleanRBTreeMap.Entry local_f = Long2BooleanRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2BooleanRBTreeMap.Entry local_f = Long2BooleanRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2BooleanRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Long2BooleanRBTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry local_to)
        {
          return Long2BooleanRBTreeMap.this.headMap((Long)local_to.getKey()).long2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry from)
        {
          return Long2BooleanRBTreeMap.this.tailMap((Long)from.getKey()).long2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Long2BooleanRBTreeMap.ValueIterator(Long2BooleanRBTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Long2BooleanRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2BooleanRBTreeMap local_c;
    try
    {
      local_c = (Long2BooleanRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2BooleanRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2BooleanRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2BooleanRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2BooleanMap.Entry> long2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator()
          {
            return new Long2BooleanRBTreeMap.Submap.SubmapEntryIterator(Long2BooleanRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2BooleanMap.Entry> iterator(Long2BooleanMap.Entry from)
          {
            return new Long2BooleanRBTreeMap.Submap.SubmapEntryIterator(Long2BooleanRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Boolean> local_e = (Map.Entry)local_o;
            Long2BooleanRBTreeMap.Entry local_f = Long2BooleanRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2BooleanRBTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Boolean> local_e = (Map.Entry)local_o;
            Long2BooleanRBTreeMap.Entry local_f = Long2BooleanRBTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2BooleanRBTreeMap.Submap.this.in1(local_f.key))) {
              Long2BooleanRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2BooleanRBTreeMap.Submap.SubmapIterator(Long2BooleanRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2BooleanRBTreeMap.Submap.this.clear();
          }
          
          public Long2BooleanMap.Entry first()
          {
            return Long2BooleanRBTreeMap.Submap.this.firstEntry();
          }
          
          public Long2BooleanMap.Entry last()
          {
            return Long2BooleanRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2BooleanMap.Entry> subSet(Long2BooleanMap.Entry from, Long2BooleanMap.Entry local_to)
          {
            return Long2BooleanRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Long2BooleanMap.Entry> headSet(Long2BooleanMap.Entry local_to)
          {
            return Long2BooleanRBTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Long2BooleanMap.Entry> tailSet(Long2BooleanMap.Entry from)
          {
            return Long2BooleanRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Long2BooleanRBTreeMap.Submap.SubmapValueIterator(Long2BooleanRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Long2BooleanRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2BooleanRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2BooleanRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2BooleanRBTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2BooleanRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(long local_k, boolean local_v)
    {
      ...
      boolean oldValue = Long2BooleanRBTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(long local_k)
    {
      ...
      boolean oldValue = Long2BooleanRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2BooleanRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2BooleanRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2BooleanRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2BooleanSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2BooleanRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2BooleanRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2BooleanSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2BooleanRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2BooleanRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2BooleanRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2BooleanRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2BooleanRBTreeMap.this.locateKey(this.from);
        if (Long2BooleanRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2BooleanRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2BooleanRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2BooleanRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2BooleanRBTreeMap.this.locateKey(this.field_47);
        if (Long2BooleanRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2BooleanRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2BooleanRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2BooleanRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Long2BooleanRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2BooleanRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2BooleanRBTreeMap.Submap.this.bottom) && (Long2BooleanRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2BooleanRBTreeMap.Submap.this.top) && (Long2BooleanRBTreeMap.this.compare(local_k, (this.prev = Long2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2BooleanRBTreeMap.this.locateKey(local_k);
            if (Long2BooleanRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2BooleanRBTreeMap.this.compare(this.prev.key, Long2BooleanRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Long2BooleanRBTreeMap.this.compare(this.next.key, Long2BooleanRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Long2BooleanRBTreeMap.Submap.SubmapKeyIterator(Long2BooleanRBTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2BooleanRBTreeMap.Submap.SubmapKeyIterator(Long2BooleanRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2BooleanSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2BooleanRBTreeMap.KeyIterator(Long2BooleanRBTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2BooleanRBTreeMap.KeyIterator(Long2BooleanRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2BooleanRBTreeMap.this.locateKey(local_k)) != null) {
        if (Long2BooleanRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
