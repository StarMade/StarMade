  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2FloatAVLTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2FloatAVLTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2FloatAVLTreeMap(Map<? extends Long, ? extends Float> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2FloatAVLTreeMap(SortedMap<Long, Float> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2FloatAVLTreeMap(Long2FloatMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2FloatAVLTreeMap(Long2FloatSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2FloatAVLTreeMap(long[] local_k, float[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2FloatAVLTreeMap(long[] local_k, float[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Long2FloatMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Long2FloatAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2FloatAVLTreeMap.EntryIterator(Long2FloatAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from)
        {
          return new Long2FloatAVLTreeMap.EntryIterator(Long2FloatAVLTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2FloatAVLTreeMap.Entry local_f = Long2FloatAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2FloatAVLTreeMap.Entry local_f = Long2FloatAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2FloatAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Long2FloatAVLTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2FloatEntrySet();
        }
        
        public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry local_to)
        {
          return Long2FloatAVLTreeMap.this.headMap((Long)local_to.getKey()).long2FloatEntrySet();
        }
        
        public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from)
        {
          return Long2FloatAVLTreeMap.this.tailMap((Long)from.getKey()).long2FloatEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Long2FloatAVLTreeMap.ValueIterator(Long2FloatAVLTreeMap.this, null);
        }
        
        public boolean contains(float local_k)
        {
          return Long2FloatAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2FloatAVLTreeMap local_c;
    try
    {
      local_c = (Long2FloatAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2FloatAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2FloatAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2FloatAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2FloatMap.Entry> long2FloatEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator()
          {
            return new Long2FloatAVLTreeMap.Submap.SubmapEntryIterator(Long2FloatAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from)
          {
            return new Long2FloatAVLTreeMap.Submap.SubmapEntryIterator(Long2FloatAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Float> local_e = (Map.Entry)local_o;
            Long2FloatAVLTreeMap.Entry local_f = Long2FloatAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2FloatAVLTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Float> local_e = (Map.Entry)local_o;
            Long2FloatAVLTreeMap.Entry local_f = Long2FloatAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2FloatAVLTreeMap.Submap.this.in1(local_f.key))) {
              Long2FloatAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2FloatAVLTreeMap.Submap.SubmapIterator(Long2FloatAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2FloatAVLTreeMap.Submap.this.clear();
          }
          
          public Long2FloatMap.Entry first()
          {
            return Long2FloatAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Long2FloatMap.Entry last()
          {
            return Long2FloatAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry local_to)
          {
            return Long2FloatAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2FloatEntrySet();
          }
          
          public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry local_to)
          {
            return Long2FloatAVLTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2FloatEntrySet();
          }
          
          public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from)
          {
            return Long2FloatAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2FloatEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public FloatCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractFloatCollection()
        {
          public FloatIterator iterator()
          {
            return new Long2FloatAVLTreeMap.Submap.SubmapValueIterator(Long2FloatAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(float local_k)
          {
            return Long2FloatAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2FloatAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2FloatAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2FloatAVLTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2FloatAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public float put(long local_k, float local_v)
    {
      ...
      float oldValue = Long2FloatAVLTreeMap.this.put(local_k, local_v);
    ...
    public float remove(long local_k)
    {
      ...
      float oldValue = Long2FloatAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2FloatAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2FloatAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2FloatAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2FloatSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2FloatAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2FloatAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2FloatAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2FloatSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2FloatAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2FloatAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2FloatAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2FloatAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2FloatAVLTreeMap.this.locateKey(this.from);
        if (Long2FloatAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2FloatAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2FloatAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2FloatAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2FloatAVLTreeMap.this.locateKey(this.field_47);
        if (Long2FloatAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2FloatAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2FloatAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2FloatAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Long2FloatAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2FloatAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2FloatAVLTreeMap.Submap.this.bottom) && (Long2FloatAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2FloatAVLTreeMap.Submap.this.top) && (Long2FloatAVLTreeMap.this.compare(local_k, (this.prev = Long2FloatAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2FloatAVLTreeMap.this.locateKey(local_k);
            if (Long2FloatAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2FloatAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2FloatAVLTreeMap.this.compare(this.prev.key, Long2FloatAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2FloatAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2FloatAVLTreeMap.this.compare(this.next.key, Long2FloatAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2FloatSortedMap.KeySet
    {
      ...
      {
        return new Long2FloatAVLTreeMap.Submap.SubmapKeyIterator(Long2FloatAVLTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2FloatAVLTreeMap.Submap.SubmapKeyIterator(Long2FloatAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2FloatSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2FloatAVLTreeMap.KeyIterator(Long2FloatAVLTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2FloatAVLTreeMap.KeyIterator(Long2FloatAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2FloatAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Long2FloatAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
