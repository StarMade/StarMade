...
/*  730 */   public Long2ObjectSortedMap<V> tailMap(long from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Long2ObjectSortedMap<V> headMap(long to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Long2ObjectSortedMap<V> subMap(long from, long to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Long2ObjectLinkedOpenHashMap.ValueIterator(Long2ObjectLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Long2ObjectLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Long2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Long2ObjectLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1190 */       c = (Long2ObjectLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Long2ObjectLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Long2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Long2ObjectLinkedOpenHashMap.KeyIterator(Long2ObjectLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public LongListIterator iterator() {
/*  999 */       return new Long2ObjectLinkedOpenHashMap.KeyIterator(Long2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Long2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(long k) {
/* 1005 */       return Long2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(long k) {
/* 1008 */       int oldSize = Long2ObjectLinkedOpenHashMap.this.size;
/* 1009 */       Long2ObjectLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Long2ObjectLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Long2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public long firstLong() {
/* 1016 */       if (Long2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Long2ObjectLinkedOpenHashMap.this.key[Long2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public long lastLong() {
/* 1020 */       if (Long2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Long2ObjectLinkedOpenHashMap.this.key[Long2ObjectLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2ObjectLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator(long k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public long previousLong() { return Long2ObjectLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  987 */     public Long previous() { return Long.valueOf(Long2ObjectLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/*  991 */     public long nextLong() { return Long2ObjectLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Long next() { return Long.valueOf(Long2ObjectLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Long2ObjectLinkedOpenHashMap.EntryIterator(Long2ObjectLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Long2ObjectMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> fromElement, Long2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Long2ObjectMap.Entry<V> first() {
/*  918 */       if (Long2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Long2ObjectLinkedOpenHashMap.MapEntry(Long2ObjectLinkedOpenHashMap.this, Long2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Long2ObjectMap.Entry<V> last() {
/*  922 */       if (Long2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Long2ObjectLinkedOpenHashMap.MapEntry(Long2ObjectLinkedOpenHashMap.this, Long2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  931 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Long2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Long2ObjectLinkedOpenHashMap.this.key[pos] == k) return Long2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Long2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  935 */         pos = pos + 1 & Long2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  945 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Long2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Long2ObjectLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Long2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Long2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Long2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Long2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
/*  963 */       return new Long2ObjectLinkedOpenHashMap.EntryIterator(Long2ObjectLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> fastIterator() {
/*  966 */       return new Long2ObjectLinkedOpenHashMap.FastEntryIterator(Long2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> fastIterator(Long2ObjectMap.Entry<V> from) {
/*  969 */       return new Long2ObjectLinkedOpenHashMap.FastEntryIterator(Long2ObjectLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Long2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Long2ObjectMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractLong2ObjectMap.BasicEntry<V> entry = new AbstractLong2ObjectMap.BasicEntry(0L, null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Long2ObjectLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Long2ObjectLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractLong2ObjectMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Long2ObjectLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Long2ObjectLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Long2ObjectMap.Entry<V>>
/*      */   {
...
/*  875 */       return this.entry = new Long2ObjectLinkedOpenHashMap.MapEntry(Long2ObjectLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Long2ObjectLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Long2ObjectLinkedOpenHashMap.MapEntry(Long2ObjectLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Long2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Long2ObjectLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(long from) {
/*  753 */       if (Long2ObjectLinkedOpenHashMap.this.key[Long2ObjectLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Long2ObjectLinkedOpenHashMap.this.last;
/*  755 */         this.index = Long2ObjectLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = (int)HashCommon.murmurHash3(from) & Long2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Long2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Long2ObjectLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Long2ObjectLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Long2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Long2ObjectLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Long2ObjectLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Long2ObjectLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Long2ObjectLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Long2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Long2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Long2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Long2ObjectLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Long2ObjectLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Long2ObjectLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Long2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Long2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Long2ObjectLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Long2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Long2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Long2ObjectLinkedOpenHashMap.this.mask;
/*  841 */         while (Long2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = (int)HashCommon.murmurHash3(Long2ObjectLinkedOpenHashMap.this.key[pos]) & Long2ObjectLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Long2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Long2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Long2ObjectLinkedOpenHashMap.this.key[last] = Long2ObjectLinkedOpenHashMap.this.key[pos];
/*  848 */         Long2ObjectLinkedOpenHashMap.this.value[last] = Long2ObjectLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Long2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Long2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Long2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Long getKey() {
/*  619 */       return Long.valueOf(Long2ObjectLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public long getLongKey() {
/*  622 */       return Long2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Long2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Long2ObjectLinkedOpenHashMap.this.value[this.index];
/*  629 */       Long2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Long2ObjectLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Long2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return HashCommon.long2int(Long2ObjectLinkedOpenHashMap.this.key[this.index]) ^ (Long2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Long2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     public String toString() {
/*  642 */       return Long2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Long2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
