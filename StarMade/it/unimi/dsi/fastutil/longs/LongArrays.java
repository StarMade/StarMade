...
public class LongArrays
{
  ...
  public static long[] grow(long[] array, int length)
  {
    if (length > array.length)
    {
      ...
      long[] local_t = new long[newLength];
      System.arraycopy(array, 0, local_t, 0, array.length);
      return local_t;
    }
    return array;
  ...
  public static long[] trim(long[] array, int length)
  {
    ...
    long[] local_t = length == 0 ? EMPTY_ARRAY : new long[length];
  ...
  public static long[] copy(long[] array, int offset, int length)
  {
    ...
    long[] local_a = length == 0 ? EMPTY_ARRAY : new long[length];
  ...
  public static void fill(long[] array, int from, int local_to, long value)
  {
  ...
  public static boolean equals(long[] local_a1, long[] local_a2)
  {
  ...
  public static void ensureFromTo(long[] local_a, int from, int local_to)
  {
    it.unimi.dsi.fastutil.Arrays.ensureFromTo(local_a.length, from, local_to);
  }
  
  public static void ensureOffsetLength(long[] local_a, int offset, int length)
  {
    it.unimi.dsi.fastutil.Arrays.ensureOffsetLength(local_a.length, offset, length);
  }
  
  private static void swap(long[] local_x, int local_a, int local_b)
  {
    long local_t = local_x[local_a];
    local_x[local_a] = local_x[local_b];
    local_x[local_b] = local_t;
  }
  
  private static void vecSwap(long[] local_x, int local_a, int local_b, int local_n)
  {
    int local_i = 0;
  ...
  private static int med3(long[] local_x, int local_a, int local_b, int local_c, LongComparator comp)
  {
  ...
  private static void selectionSort(long[] local_a, int from, int local_to, LongComparator comp)
  {
  ...
  private static void insertionSort(long[] local_a, int from, int local_to, LongComparator comp)
  {
    int local_i = from;
    for (;;)
    {
      ...
      long local_t = local_a[local_i];
      int local_j = local_i;
      for (long local_u = local_a[(local_j - 1)]; comp.compare(local_t, local_u) < 0; local_u = local_a[(--local_j - 1)])
      {
  ...
  private static void selectionSort(long[] local_a, int from, int local_to)
  {
    for (int local_i = from; local_i < local_to - 1; local_i++)
    {
      int local_m = local_i;
  ...
  private static void insertionSort(long[] local_a, int from, int local_to)
  {
    int local_i = from;
    for (;;)
    {
      ...
      long local_t = local_a[local_i];
      int local_j = local_i;
      for (long local_u = local_a[(local_j - 1)]; local_t < local_u; local_u = local_a[(--local_j - 1)])
      {
        local_a[local_j] = local_u;
        if (from == local_j - 1)
        {
  ...
  public static void quickSort(long[] local_x, int from, int local_to, LongComparator comp)
  {
  ...
  public static void quickSort(long[] local_x, LongComparator comp)
  {
    quickSort(local_x, 0, local_x.length, comp);
  }
  
  private static int med3(long[] local_x, int local_a, int local_b, int local_c)
  {
  ...
  public static void quickSort(long[] local_x, int from, int local_to)
  {
    int len = local_to - from;
    if (len < 7)
    {
  ...
  public static void quickSort(long[] local_x)
  {
    quickSort(local_x, 0, local_x.length);
  }
  
  public static void mergeSort(long[] local_a, int from, int local_to, long[] supp)
  {
    int len = local_to - from;
    if (len < 7)
    {
  ...
  public static void mergeSort(long[] local_a, int from, int local_to)
  {
    mergeSort(local_a, from, local_to, (long[])local_a.clone());
  }
  
  public static void mergeSort(long[] local_a)
  {
    mergeSort(local_a, 0, local_a.length);
  }
  
  public static void mergeSort(long[] local_a, int from, int local_to, LongComparator comp, long[] supp)
  {
    int len = local_to - from;
    if (len < 7)
    {
  ...
  public static void mergeSort(long[] local_a, int from, int local_to, LongComparator comp)
  {
    mergeSort(local_a, from, local_to, comp, (long[])local_a.clone());
  }
  
  public static void mergeSort(long[] local_a, LongComparator comp)
  {
    mergeSort(local_a, 0, local_a.length, comp);
  }
  
  public static int binarySearch(long[] local_a, int from, int local_to, long key)
  {
    
    while (from <= local_to)
    {
      int mid = from + local_to >>> 1;
      long midVal = local_a[mid];
      if (midVal < key) {
        from = mid + 1;
      } else if (midVal > key) {
        local_to = mid - 1;
  ...
  public static int binarySearch(long[] local_a, long key)
  {
    return binarySearch(local_a, 0, local_a.length, key);
  }
  
  public static int binarySearch(long[] local_a, int from, int local_to, long key, LongComparator local_c)
  {
  ...
  public static int binarySearch(long[] local_a, long key, LongComparator local_c)
  {
    return binarySearch(local_a, 0, local_a.length, key, local_c);
  }
  
  public static void radixSort(long[] local_a)
  {
    radixSort(local_a, 0, local_a.length);
  }
  
  public static void radixSort(long[] local_a, int from, int local_to)
  {
    int maxLevel = 7;
    int stackSize = 1786;
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        int local_i = length;
        while (local_i-- != 0) {
          digit[local_i] = ((byte)(int)(local_a[(first + local_i)] >>> shift & 0xFF ^ signMask));
        }
        int local_i = length;
        while (local_i-- != 0) {
        ...
        while (local_i1 < 256)
        {
          ...
          int tmp340_339 = (local_p + count[local_i1]);
          local_p = tmp340_339;
        ...
        {
          long local_t = local_a[(local_p + first)];
  ...
  private static void insertionSortIndirect(int[] perm, long[] local_a, int from, int local_to)
  {
    int local_i = from;
    for (;;)
    {
  ...
  public static void radixSortIndirect(int[] perm, long[] local_a, boolean stable)
  {
    radixSortIndirect(perm, local_a, 0, perm.length, stable);
  }
  
  public static void radixSortIndirect(int[] perm, long[] local_a, int from, int local_to, boolean stable)
  {
    int maxLevel = 7;
    int stackSize = 1786;
    int[] offsetStack = new int[1786];
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        int local_i = length;
        while (local_i-- != 0) {
          digit[local_i] = ((byte)(int)(local_a[perm[(first + local_i)]] >>> shift & 0xFF ^ signMask));
        }
        int local_i = length;
        while (local_i-- != 0) {
          count[(digit[local_i] & 0xFF)] += 1;
        ...
        while (local_i1 < 256)
        {
          ...
          if (stable)
          {
            int tmp373_372 = (local_p + count[local_i1]);
            local_p = tmp373_372;
            count[local_i1] = tmp373_372;
          }
          else
          {
            int tmp392_391 = (local_p + count[local_i1]);
            local_p = tmp392_391;
            pos[local_i1] = tmp392_391;
          }
          local_i1++;
        }
        if (stable)
        {
          ...
          while (local_i1-- != 0)
          {
            byte tmp432_431 = (digit[local_i1] & 0xFF);
            int[] tmp432_421 = count;
            int tmp436_435 = (tmp432_421[tmp432_431] - 1);
            tmp432_421[tmp432_431] = tmp436_435;
            support[tmp436_435] = perm[(first + local_i1)];
          }
  ...
  private static void selectionSort(long[] local_a, long[] local_b, int from, int local_to)
  {
    for (int local_i = from; local_i < local_to - 1; local_i++)
    {
      int local_m = local_i;
  ...
  public static void radixSort(long[] local_a, long[] local_b)
  {
    radixSort(local_a, local_b, 0, local_a.length);
  }
  
  public static void radixSort(long[] local_a, long[] local_b, int from, int local_to)
  {
    int layers = 2;
    ...
    while (offsetPos > 0)
    {
      ...
      {
        long[] local_k = level < 8 ? local_a : local_b;
        int shift = (7 - level % 8) * 8;
        int local_i = length;
        while (local_i-- != 0) {
          digit[local_i] = ((byte)(int)(local_k[(first + local_i)] >>> shift & 0xFF ^ signMask));
        }
        int local_i = length;
        while (local_i-- != 0) {
          count[(digit[local_i] & 0xFF)] += 1;
        ...
        {
          long local_t = local_a[(local_p + first)];
          long local_u = local_b[(local_p + first)];
          local_c = digit[local_p] & 0xFF;
          for (;;)
          {
            int local_d;
  ...
  private static void insertionSortIndirect(int[] perm, long[] local_a, long[] local_b, int from, int local_to)
  {
    int local_i = from;
    for (;;)
    {
  ...
  public static void radixSortIndirect(int[] perm, long[] local_a, long[] local_b, boolean stable)
  {
    radixSortIndirect(perm, local_a, local_b, 0, perm.length, stable);
  }
  
  public static void radixSortIndirect(int[] perm, long[] local_a, long[] local_b, int from, int local_to, boolean stable)
  {
    int layers = 2;
    if (local_a.length != local_b.length) {
      throw new IllegalArgumentException("Array size mismatch.");
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        int local_i = length;
        while (local_i-- != 0) {
          digit[local_i] = ((byte)(int)(local_k[perm[(first + local_i)]] >>> shift & 0xFF ^ signMask));
        }
        int local_i = length;
        while (local_i-- != 0) {
          count[(digit[local_i] & 0xFF)] += 1;
  ...
  private static void selectionSort(long[][] local_a, int from, int local_to, int level)
  {
    ...
    for (int local_i = from; local_i < local_to - 1; local_i++)
    {
      ...
      if (local_m != local_i)
      {
        ...
        while (local_j-- != 0)
        {
          long local_p = local_a[local_j][local_i];
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        while (local_i1 < 256)
        {
          ...
          int tmp433_432 = (local_p1 + count[local_i1]);
          local_p1 = tmp433_432;
          pos[local_i1] = tmp433_432;
          local_i1++;
        }
        int local_i1 = length - count[local_i];
        count[local_i] = 0;
  ...
  public static long[] shuffle(long[] local_a, int from, int local_to, Random random)
  {
    int local_i = local_to - from;
    while (local_i-- != 0)
    {
      int local_p = random.nextInt(local_i + 1);
      long local_t = local_a[(from + local_i)];
  ...
  public static long[] shuffle(long[] local_a, Random random)
  {
  ...
  public static long[] reverse(long[] local_a)
  {
    int length = local_a.length;
    int local_i = length / 2;
    while (local_i-- != 0)
    {
      long local_t = local_a[(length - local_i - 1)];
    ...
    implements Hash.Strategy<long[]>, Serializable
  {
    ...
    public int hashCode(long[] local_o)
    {
      return java.util.Arrays.hashCode(local_o);
    }
    
    public boolean equals(long[] local_a, long[] local_b)
    {
      return LongArrays.equals(local_a, local_b);
    }
  }
}
