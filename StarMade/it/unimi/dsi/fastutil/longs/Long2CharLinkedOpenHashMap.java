  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2CharLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2CharLinkedOpenHashMap(Map<? extends Long, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2CharLinkedOpenHashMap(Map<? extends Long, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2CharLinkedOpenHashMap(Long2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2CharLinkedOpenHashMap(Long2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2CharLinkedOpenHashMap(long[] local_k, char[] local_v, float local_f)
  {
  ...
  public Long2CharLinkedOpenHashMap(long[] local_k, char[] local_v)
  {
  ...
  public char getAndMoveToFirst(long local_k)
  {
    long[] key = this.key;
  ...
  public char getAndMoveToLast(long local_k)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToFirst(long local_k, char local_v)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public char putAndMoveToLast(long local_k, char local_v)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Long2CharLinkedOpenHashMap.ValueIterator(Long2CharLinkedOpenHashMap.this);
        }
        ...
        {
          return Long2CharLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2CharLinkedOpenHashMap local_c;
    try
    {
      local_c = (Long2CharLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Long2CharLinkedOpenHashMap.MapIterator
    implements CharListIterator
  {
    ...
    {
      return Character.valueOf(Long2CharLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Character.valueOf(Long2CharLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSortedSet
  {
    ...
    {
      return new Long2CharLinkedOpenHashMap.KeyIterator(Long2CharLinkedOpenHashMap.this, from);
    }
    
    public LongListIterator iterator()
    {
      return new Long2CharLinkedOpenHashMap.KeyIterator(Long2CharLinkedOpenHashMap.this);
    }
    ...
    {
      return Long2CharLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2CharLinkedOpenHashMap.this.size;
      Long2CharLinkedOpenHashMap.this.remove(local_k);
    ...
    implements LongListIterator
  {
    ...
    {
      return Long.valueOf(Long2CharLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Long next()
    {
      return Long.valueOf(Long2CharLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2CharSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Long2CharLinkedOpenHashMap.EntryIterator(Long2CharLinkedOpenHashMap.this);
    }
    ...
    public Long2CharMap.Entry first()
    {
      ...
      return new Long2CharLinkedOpenHashMap.MapEntry(Long2CharLinkedOpenHashMap.this, Long2CharLinkedOpenHashMap.this.first);
    }
    ...
    public Long2CharMap.Entry last()
    {
      ...
      return new Long2CharLinkedOpenHashMap.MapEntry(Long2CharLinkedOpenHashMap.this, Long2CharLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2CharLinkedOpenHashMap.this.mask; Long2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask) {
        if (Long2CharLinkedOpenHashMap.this.key[pos] == local_k) {
          return Long2CharLinkedOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2CharLinkedOpenHashMap.this.mask; Long2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask) {
        if (Long2CharLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Long2CharLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Long2CharLinkedOpenHashMap.EntryIterator(Long2CharLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
    
    public ObjectBidirectionalIterator<Long2CharMap.Entry> fastIterator()
    {
      return new Long2CharLinkedOpenHashMap.FastEntryIterator(Long2CharLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Long2CharMap.Entry> fastIterator(Long2CharMap.Entry from)
    {
      return new Long2CharLinkedOpenHashMap.FastEntryIterator(Long2CharLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
  }
    ...
    implements ObjectListIterator<Long2CharMap.Entry>
  {
    ...
    public AbstractLong2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2CharLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Long2CharLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Long2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Long2CharLinkedOpenHashMap.MapEntry(Long2CharLinkedOpenHashMap.this, nextEntry());
    }
    
    public Long2CharLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Long2CharLinkedOpenHashMap.MapEntry(Long2CharLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(long from)
    {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(from) & Long2CharLinkedOpenHashMap.this.mask; Long2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Long2CharLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Long2CharLinkedOpenHashMap.this.first = this.next;
      } else {
        Long2CharLinkedOpenHashMap.this.link[this.prev] ^= (Long2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Long2CharLinkedOpenHashMap.this.last = this.prev;
      } else {
        Long2CharLinkedOpenHashMap.this.link[this.next] ^= (Long2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2CharLinkedOpenHashMap.this.mask; Long2CharLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2CharLinkedOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2CharLinkedOpenHashMap.this.key[pos]) & Long2CharLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2CharLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Long2CharLinkedOpenHashMap.this.key[last] = Long2CharLinkedOpenHashMap.this.key[pos];
      ...
      Long2CharLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Long2CharMap.Entry, Map.Entry<Long, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Long2CharLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Character> local_e = (Map.Entry)local_o;
      return (Long2CharLinkedOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2CharLinkedOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
