  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2ShortLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2ShortLinkedOpenHashMap(Map<? extends Long, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ShortLinkedOpenHashMap(Map<? extends Long, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ShortLinkedOpenHashMap(Long2ShortMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ShortLinkedOpenHashMap(Long2ShortMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ShortLinkedOpenHashMap(long[] local_k, short[] local_v, float local_f)
  {
  ...
  public Long2ShortLinkedOpenHashMap(long[] local_k, short[] local_v)
  {
  ...
  public short add(long local_k, short incr)
  {
    for (int pos = (int)HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k)
      {
        short oldValue = this.value[pos];
        int tmp49_47 = pos;
        short[] tmp49_44 = this.value;
        tmp49_44[tmp49_47] = ((short)(tmp49_44[tmp49_47] + incr));
        return tmp49_47;
      }
    }
    this.used[pos] = true;
  ...
  public short getAndMoveToFirst(long local_k)
  {
    long[] key = this.key;
  ...
  public short getAndMoveToLast(long local_k)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public short putAndMoveToFirst(long local_k, short local_v)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public short putAndMoveToLast(long local_k, short local_v)
  {
    long[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public Short get(Long local_ok)
  {
    long local_k = local_ok.longValue();
    for (int pos = (int)HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k) {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Long2ShortLinkedOpenHashMap.ValueIterator(Long2ShortLinkedOpenHashMap.this);
        }
        ...
        {
          return Long2ShortLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2ShortLinkedOpenHashMap local_c;
    try
    {
      local_c = (Long2ShortLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Long2ShortLinkedOpenHashMap.MapIterator
    implements ShortListIterator
  {
    ...
    {
      return Short.valueOf(Long2ShortLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Short next()
    {
      return Short.valueOf(Long2ShortLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractLongSortedSet
  {
    ...
    {
      return new Long2ShortLinkedOpenHashMap.KeyIterator(Long2ShortLinkedOpenHashMap.this, from);
    }
    
    public LongListIterator iterator()
    {
      return new Long2ShortLinkedOpenHashMap.KeyIterator(Long2ShortLinkedOpenHashMap.this);
    }
    ...
    {
      return Long2ShortLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2ShortLinkedOpenHashMap.this.size;
      Long2ShortLinkedOpenHashMap.this.remove(local_k);
    ...
    implements LongListIterator
  {
    ...
    {
      return Long.valueOf(Long2ShortLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Long next()
    {
      return Long.valueOf(Long2ShortLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2ShortSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Long2ShortLinkedOpenHashMap.EntryIterator(Long2ShortLinkedOpenHashMap.this);
    }
    ...
    public Long2ShortMap.Entry first()
    {
      ...
      return new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this, Long2ShortLinkedOpenHashMap.this.first);
    }
    ...
    public Long2ShortMap.Entry last()
    {
      ...
      return new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this, Long2ShortLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ShortLinkedOpenHashMap.this.mask; Long2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask) {
        if (Long2ShortLinkedOpenHashMap.this.key[pos] == local_k) {
          return Long2ShortLinkedOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ShortLinkedOpenHashMap.this.mask; Long2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask) {
        if (Long2ShortLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Long2ShortLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Long2ShortLinkedOpenHashMap.EntryIterator(Long2ShortLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
    
    public ObjectBidirectionalIterator<Long2ShortMap.Entry> fastIterator()
    {
      return new Long2ShortLinkedOpenHashMap.FastEntryIterator(Long2ShortLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Long2ShortMap.Entry> fastIterator(Long2ShortMap.Entry from)
    {
      return new Long2ShortLinkedOpenHashMap.FastEntryIterator(Long2ShortLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
    }
  }
    ...
    implements ObjectListIterator<Long2ShortMap.Entry>
  {
    ...
    public AbstractLong2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Long2ShortLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Long2ShortLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Long2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this, nextEntry());
    }
    
    public Long2ShortLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(long from)
    {
      ...
      {
        for (int pos = (int)HashCommon.murmurHash3(from) & Long2ShortLinkedOpenHashMap.this.mask; Long2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Long2ShortLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Long2ShortLinkedOpenHashMap.this.first = this.next;
      } else {
        Long2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Long2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Long2ShortLinkedOpenHashMap.this.last = this.prev;
      } else {
        Long2ShortLinkedOpenHashMap.this.link[this.next] ^= (Long2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2ShortLinkedOpenHashMap.this.mask; Long2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2ShortLinkedOpenHashMap.this.key[pos]) & Long2ShortLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2ShortLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Long2ShortLinkedOpenHashMap.this.key[last] = Long2ShortLinkedOpenHashMap.this.key[pos];
      ...
      Long2ShortLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Long2ShortMap.Entry, Map.Entry<Long, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Long2ShortLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, Short> local_e = (Map.Entry)local_o;
      return (Long2ShortLinkedOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
