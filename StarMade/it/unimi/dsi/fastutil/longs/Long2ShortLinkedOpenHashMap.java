...
/*      */   protected int size;
/*      */   protected volatile transient Long2ShortSortedMap.FastSortedEntrySet entries;
...
/*  786 */   public Long2ShortSortedMap tailMap(long from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Long2ShortSortedMap headMap(long to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Long2ShortSortedMap subMap(long from, long to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Long2ShortLinkedOpenHashMap.ValueIterator(Long2ShortLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Long2ShortLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(short v) {
/* 1113 */           return Long2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Long2ShortLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Long2ShortLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public short previousShort()
/*      */     {
/* 1094 */       return Long2ShortLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Short previous() { return Short.valueOf(Long2ShortLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public short nextShort() { return Long2ShortLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Short next() { return Short.valueOf(Long2ShortLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Long2ShortLinkedOpenHashMap.KeyIterator(Long2ShortLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public LongListIterator iterator() {
/* 1054 */       return new Long2ShortLinkedOpenHashMap.KeyIterator(Long2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Long2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(long k) {
/* 1060 */       return Long2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(long k) {
/* 1063 */       int oldSize = Long2ShortLinkedOpenHashMap.this.size;
/* 1064 */       Long2ShortLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Long2ShortLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Long2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public long firstLong() {
/* 1071 */       if (Long2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Long2ShortLinkedOpenHashMap.this.key[Long2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public long lastLong() {
/* 1075 */       if (Long2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Long2ShortLinkedOpenHashMap.this.key[Long2ShortLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2ShortLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator(long k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public long previousLong() { return Long2ShortLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Long previous() { return Long.valueOf(Long2ShortLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public long nextLong() { return Long2ShortLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Long next() { return Long.valueOf(Long2ShortLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Long2ShortMap.Entry>
...
/*      */     {
/*  966 */       return new Long2ShortLinkedOpenHashMap.EntryIterator(Long2ShortLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Long2ShortMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Long2ShortMap.Entry> subSet(Long2ShortMap.Entry fromElement, Long2ShortMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Long2ShortMap.Entry> headSet(Long2ShortMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Long2ShortMap.Entry> tailSet(Long2ShortMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Long2ShortMap.Entry first() {
/*  973 */       if (Long2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this, Long2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Long2ShortMap.Entry last() {
/*  977 */       if (Long2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this, Long2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Long2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Long2ShortLinkedOpenHashMap.this.key[pos] == k) return Long2ShortLinkedOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/*  990 */         pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Long2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Long2ShortLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Long2ShortLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Long2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Long2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2ShortMap.Entry> iterator(Long2ShortMap.Entry from) {
/* 1018 */       return new Long2ShortLinkedOpenHashMap.EntryIterator(Long2ShortLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2ShortMap.Entry> fastIterator() {
/* 1021 */       return new Long2ShortLinkedOpenHashMap.FastEntryIterator(Long2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2ShortMap.Entry> fastIterator(Long2ShortMap.Entry from) {
/* 1024 */       return new Long2ShortLinkedOpenHashMap.FastEntryIterator(Long2ShortLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Long2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2ShortMap.Entry>
/*      */   {
/*  944 */     final AbstractLong2ShortMap.BasicEntry entry = new AbstractLong2ShortMap.BasicEntry(0L, (short)0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Long2ShortLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Long2ShortLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractLong2ShortMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Long2ShortLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Long2ShortLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Long2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Long2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2ShortMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Long2ShortLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Long2ShortLinkedOpenHashMap.MapEntry(Long2ShortLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Long2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Long2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Long2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Long2ShortLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(long from) {
/*  809 */       if (Long2ShortLinkedOpenHashMap.this.key[Long2ShortLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Long2ShortLinkedOpenHashMap.this.last;
/*  811 */         this.index = Long2ShortLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = (int)HashCommon.murmurHash3(from) & Long2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Long2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Long2ShortLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Long2ShortLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Long2ShortLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Long2ShortLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Long2ShortLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Long2ShortLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Long2ShortLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Long2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Long2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Long2ShortLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Long2ShortLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Long2ShortLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Long2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Long2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Long2ShortLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Long2ShortLinkedOpenHashMap.this.link[this.next] ^= (Long2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Long2ShortLinkedOpenHashMap.this.mask;
/*  897 */         while (Long2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = (int)HashCommon.murmurHash3(Long2ShortLinkedOpenHashMap.this.key[pos]) & Long2ShortLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Long2ShortLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Long2ShortLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Long2ShortLinkedOpenHashMap.this.key[last] = Long2ShortLinkedOpenHashMap.this.key[pos];
/*  904 */         Long2ShortLinkedOpenHashMap.this.value[last] = Long2ShortLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Long2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Long2ShortLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Long getKey() {
/*  669 */       return Long.valueOf(Long2ShortLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public long getLongKey() {
/*  672 */       return Long2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Short getValue() {
/*  675 */       return Short.valueOf(Long2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public short getShortValue() {
/*  678 */       return Long2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public short setValue(short v) {
/*  681 */       short oldValue = Long2ShortLinkedOpenHashMap.this.value[this.index];
/*  682 */       Long2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Short setValue(Short v) {
...
/*  692 */       return (Long2ShortLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.long2int(Long2ShortLinkedOpenHashMap.this.key[this.index]) ^ Long2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Long2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Long2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
