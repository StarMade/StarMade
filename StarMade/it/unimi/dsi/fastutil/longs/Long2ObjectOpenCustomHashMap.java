...
/*  18:    */
/*  89:    */public class Long2ObjectOpenCustomHashMap<V>
/*  90:    */  extends AbstractLong2ObjectMap<V>
...
/* 103:    */  protected volatile transient Long2ObjectMap.FastEntrySet<V> entries;
...
/* 107:    */  
/* 108:    */  public Long2ObjectOpenCustomHashMap(int expected, float f, LongHash.Strategy strategy)
/* 109:    */  {
...
/* 120:    */  }
/* 121:    */  
/* 125:    */  public Long2ObjectOpenCustomHashMap(int expected, LongHash.Strategy strategy)
/* 126:    */  {
/* 127:127 */    this(expected, 0.75F, strategy);
/* 128:    */  }
/* 129:    */  
/* 132:    */  public Long2ObjectOpenCustomHashMap(LongHash.Strategy strategy)
/* 133:    */  {
/* 134:134 */    this(16, 0.75F, strategy);
/* 135:    */  }
/* 136:    */  
/* 141:    */  public Long2ObjectOpenCustomHashMap(Map<? extends Long, ? extends V> m, float f, LongHash.Strategy strategy)
/* 142:    */  {
/* 143:143 */    this(m.size(), f, strategy);
/* 144:144 */    putAll(m);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Long2ObjectOpenCustomHashMap(Map<? extends Long, ? extends V> m, LongHash.Strategy strategy)
/* 151:    */  {
/* 152:152 */    this(m, 0.75F, strategy);
/* 153:    */  }
/* 154:    */  
/* 159:    */  public Long2ObjectOpenCustomHashMap(Long2ObjectMap<V> m, float f, LongHash.Strategy strategy)
/* 160:    */  {
/* 161:161 */    this(m.size(), f, strategy);
/* 162:162 */    putAll(m);
/* 163:    */  }
/* 164:    */  
/* 168:    */  public Long2ObjectOpenCustomHashMap(Long2ObjectMap<V> m, LongHash.Strategy strategy)
/* 169:    */  {
/* 170:170 */    this(m, 0.75F, strategy);
/* 171:    */  }
/* 172:    */  
/* 179:    */  public Long2ObjectOpenCustomHashMap(long[] k, V[] v, float f, LongHash.Strategy strategy)
/* 180:    */  {
...
/* 185:    */  }
/* 186:    */  
/* 191:    */  public Long2ObjectOpenCustomHashMap(long[] k, V[] v, LongHash.Strategy strategy)
/* 192:    */  {
...
/* 380:    */    implements Long2ObjectMap.Entry<V>, Map.Entry<Long, V>
/* 381:    */  {
...
/* 387:    */    }
/* 388:    */    
/* 389:389 */    public Long getKey() { return Long.valueOf(Long2ObjectOpenCustomHashMap.this.key[this.index]); }
/* 390:    */    
/* 391:    */    public long getLongKey() {
/* 392:392 */      return Long2ObjectOpenCustomHashMap.this.key[this.index];
/* 393:    */    }
/* 394:    */    
/* 395:395 */    public V getValue() { return Long2ObjectOpenCustomHashMap.this.value[this.index]; }
/* 396:    */    
/* 397:    */    public V setValue(V v) {
/* 398:398 */      V oldValue = Long2ObjectOpenCustomHashMap.this.value[this.index];
/* 399:399 */      Long2ObjectOpenCustomHashMap.this.value[this.index] = v;
...
/* 406:406 */      return (Long2ObjectOpenCustomHashMap.this.strategy.equals(Long2ObjectOpenCustomHashMap.this.key[this.index], ((Long)e.getKey()).longValue())) && (Long2ObjectOpenCustomHashMap.this.value[this.index] == null ? e.getValue() == null : Long2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()));
/* 407:    */    }
/* 408:    */    
/* 409:409 */    public int hashCode() { return Long2ObjectOpenCustomHashMap.this.strategy.hashCode(Long2ObjectOpenCustomHashMap.this.key[this.index]) ^ (Long2ObjectOpenCustomHashMap.this.value[this.index] == null ? 0 : Long2ObjectOpenCustomHashMap.this.value[this.index].hashCode()); }
/* 410:    */    
/* 412:412 */    public String toString() { return Long2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Long2ObjectOpenCustomHashMap.this.value[this.index]; } }
/* 413:    */  
...
/* 418:    */    
/* 419:419 */    private MapIterator() { this.pos = Long2ObjectOpenCustomHashMap.this.n;
/* 420:    */      
/* 422:422 */      this.last = -1;
/* 423:    */      
/* 424:424 */      this.c = Long2ObjectOpenCustomHashMap.this.size;
/* 425:    */      
/* 429:429 */      boolean[] used = Long2ObjectOpenCustomHashMap.this.used;
...
/* 441:    */        
/* 442:442 */        int pos = HashCommon.murmurHash3(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ObjectOpenCustomHashMap.this.mask;
/* 443:    */        
/* 444:444 */        while (Long2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 445:445 */          if (Long2ObjectOpenCustomHashMap.this.strategy.equals(Long2ObjectOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446:446 */          pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask;
/* 447:    */        }
/* 448:    */      }
/* 449:449 */      this.last = this.pos;
/* 450:    */      
/* 451:451 */      if (this.c != 0) {
/* 452:452 */        boolean[] used = Long2ObjectOpenCustomHashMap.this.used;
...
/* 467:    */      for (;;)
/* 468:    */      {
/* 469:469 */        pos = (last = pos) + 1 & Long2ObjectOpenCustomHashMap.this.mask;
/* 470:470 */        while (Long2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 471:471 */          int slot = HashCommon.murmurHash3(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(Long2ObjectOpenCustomHashMap.this.key[pos])) & Long2ObjectOpenCustomHashMap.this.mask;
/* 472:472 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473:473 */          pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask;
/* 474:    */        }
/* 475:475 */        if (Long2ObjectOpenCustomHashMap.this.used[pos] == 0) break;
/* 476:476 */        if (pos < last)
/* 477:    */        {
/* 478:478 */          if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 479:479 */          this.wrapped.add(Long2ObjectOpenCustomHashMap.this.key[pos]);
/* 480:    */        }
/* 481:481 */        Long2ObjectOpenCustomHashMap.this.key[last] = Long2ObjectOpenCustomHashMap.this.key[pos];
/* 482:482 */        Long2ObjectOpenCustomHashMap.this.value[last] = Long2ObjectOpenCustomHashMap.this.value[pos];
/* 483:    */      }
/* 484:484 */      Long2ObjectOpenCustomHashMap.this.used[last] = false;
/* 485:485 */      Long2ObjectOpenCustomHashMap.this.value[last] = null;
/* 486:486 */      return last;
/* 487:    */    }
/* 488:    */    
...
/* 492:    */      {
/* 493:493 */        Long2ObjectOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 494:494 */        this.last = -1;
/* 495:495 */        return;
/* 496:    */      }
/* 497:497 */      Long2ObjectOpenCustomHashMap.this.size -= 1;
...
/* 509:    */    } }
/* 510:    */  
/* 511:511 */  private class EntryIterator extends Long2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Long2ObjectMap.Entry<V>> { private EntryIterator() { super(null); }
/* 512:    */    
/* 513:    */    private Long2ObjectOpenCustomHashMap<V>.MapEntry entry;
/* 514:514 */    public Long2ObjectMap.Entry<V> next() { return this.entry = new Long2ObjectOpenCustomHashMap.MapEntry(Long2ObjectOpenCustomHashMap.this, nextEntry()); }
/* 515:    */    
/* 516:    */    public void remove()
/* 517:    */    {
/* 518:518 */      super.remove();
/* 519:519 */      Long2ObjectOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 520:    */    } }
/* 521:    */  
/* 522:522 */  private class FastEntryIterator extends Long2ObjectOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Long2ObjectMap.Entry<V>> { private FastEntryIterator() { super(null); }
/* 523:523 */    final AbstractLong2ObjectMap.BasicEntry<V> entry = new AbstractLong2ObjectMap.BasicEntry(0L, null);
/* 524:    */    
/* 525:525 */    public AbstractLong2ObjectMap.BasicEntry<V> next() { int e = nextEntry();
/* 526:526 */      this.entry.key = Long2ObjectOpenCustomHashMap.this.key[e];
/* 527:527 */      this.entry.value = Long2ObjectOpenCustomHashMap.this.value[e];
/* 528:528 */      return this.entry;
/* 529:    */    } }
/* 530:    */  
/* 531:    */  private final class MapEntrySet extends AbstractObjectSet<Long2ObjectMap.Entry<V>> implements Long2ObjectMap.FastEntrySet<V> { private MapEntrySet() {}
/* 532:    */    
/* 533:533 */    public ObjectIterator<Long2ObjectMap.Entry<V>> iterator() { return new Long2ObjectOpenCustomHashMap.EntryIterator(Long2ObjectOpenCustomHashMap.this, null); }
/* 534:    */    
/* 535:    */    public ObjectIterator<Long2ObjectMap.Entry<V>> fastIterator() {
/* 536:536 */      return new Long2ObjectOpenCustomHashMap.FastEntryIterator(Long2ObjectOpenCustomHashMap.this, null);
/* 537:    */    }
/* 538:    */    
...
/* 543:    */      
/* 544:544 */      int pos = HashCommon.murmurHash3(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ObjectOpenCustomHashMap.this.mask;
/* 545:    */      
/* 546:546 */      while (Long2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 547:547 */        if (Long2ObjectOpenCustomHashMap.this.strategy.equals(Long2ObjectOpenCustomHashMap.this.key[pos], k)) return Long2ObjectOpenCustomHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Long2ObjectOpenCustomHashMap.this.value[pos].equals(e.getValue());
/* 548:548 */        pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask;
/* 549:    */      }
...
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(Long2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Long2ObjectOpenCustomHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Long2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Long2ObjectOpenCustomHashMap.this.strategy.equals(Long2ObjectOpenCustomHashMap.this.key[pos], k)) {
/* 562:562 */          Long2ObjectOpenCustomHashMap.this.remove(e.getKey());
/* 563:563 */          return true;
/* 564:    */        }
/* 565:565 */        pos = pos + 1 & Long2ObjectOpenCustomHashMap.this.mask;
/* 566:    */      }
/* 567:567 */      return false;
/* 568:    */    }
/* 569:    */    
/* 570:570 */    public int size() { return Long2ObjectOpenCustomHashMap.this.size; }
/* 571:    */    
/* 573:573 */    public void clear() { Long2ObjectOpenCustomHashMap.this.clear(); }
/* 574:    */  }
/* 575:    */  
/* 576:    */  public Long2ObjectMap.FastEntrySet<V> long2ObjectEntrySet() {
...
/* 584:    */    extends Long2ObjectOpenCustomHashMap.MapIterator
/* 585:    */    implements LongIterator
/* 586:    */  {
/* 587:587 */    public KeyIterator() { super(null); }
/* 588:588 */    public long nextLong() { return Long2ObjectOpenCustomHashMap.this.key[nextEntry()]; }
/* 589:589 */    public Long next() { return Long.valueOf(Long2ObjectOpenCustomHashMap.this.key[nextEntry()]); } }
/* 590:    */  
/* 591:    */  private final class KeySet extends AbstractLongSet { private KeySet() {}
/* 592:    */    
/* 593:593 */    public LongIterator iterator() { return new Long2ObjectOpenCustomHashMap.KeyIterator(Long2ObjectOpenCustomHashMap.this); }
/* 594:    */    
/* 595:    */    public int size() {
/* 596:596 */      return Long2ObjectOpenCustomHashMap.this.size;
/* 597:    */    }
/* 598:    */    
/* 599:599 */    public boolean contains(long k) { return Long2ObjectOpenCustomHashMap.this.containsKey(k); }
/* 600:    */    
/* 601:    */    public boolean remove(long k) {
/* 602:602 */      int oldSize = Long2ObjectOpenCustomHashMap.this.size;
/* 603:603 */      Long2ObjectOpenCustomHashMap.this.remove(k);
/* 604:604 */      return Long2ObjectOpenCustomHashMap.this.size != oldSize;
/* 605:    */    }
/* 606:    */    
/* 607:607 */    public void clear() { Long2ObjectOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
...
/* 618:    */    extends Long2ObjectOpenCustomHashMap<V>.MapIterator
/* 619:    */    implements ObjectIterator<V>
/* 620:    */  {
/* 621:621 */    public ValueIterator() { super(null); }
/* 622:622 */    public V next() { return Long2ObjectOpenCustomHashMap.this.value[nextEntry()]; }
/* 623:    */  }
/* 624:    */  
...
/* 627:627 */          return new Long2ObjectOpenCustomHashMap.ValueIterator(Long2ObjectOpenCustomHashMap.this);
/* 628:    */        }
/* 629:    */        
/* 630:630 */        public int size() { return Long2ObjectOpenCustomHashMap.this.size; }
/* 631:    */        
/* 632:    */        public boolean contains(Object v) {
/* 633:633 */          return Long2ObjectOpenCustomHashMap.this.containsValue(v);
/* 634:    */        }
/* 635:    */        
/* 636:636 */        public void clear() { Long2ObjectOpenCustomHashMap.this.clear(); }
/* 637:    */      };
/* 638:    */    }
...
/* 739:    */  }
/* 740:    */  
/* 744:    */  public Long2ObjectOpenCustomHashMap<V> clone()
/* 745:    */  {
/* 746:    */    Long2ObjectOpenCustomHashMap<V> c;
/* 747:    */    
/* 749:    */    try
/* 750:    */    {
/* 751:751 */      c = (Long2ObjectOpenCustomHashMap)super.clone();
/* 752:    */    }
...
/* 789:789 */    Long2ObjectOpenCustomHashMap<V>.MapIterator i = new MapIterator(null);
