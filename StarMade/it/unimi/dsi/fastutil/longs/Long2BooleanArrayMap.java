  ...
  implements Serializable, Cloneable
{
  ...
  public Long2BooleanArrayMap(Long2BooleanMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Long2BooleanArrayMap(Map<? extends Long, ? extends Boolean> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Long2BooleanArrayMap local_c;
    try
    {
      local_c = (Long2BooleanArrayMap)super.clone();
    }
    ...
    implements Long2BooleanMap.FastEntrySet
  {
    ...
    public ObjectIterator<Long2BooleanMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Long2BooleanMap.Entry next()
        {
          ...
          return new AbstractLong2BooleanMap.BasicEntry(Long2BooleanArrayMap.this.key[this.next], Long2BooleanArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Long2BooleanMap.Entry> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Long2BooleanMap.Entry next()
        {
          ...
          this.entry.key = Long2BooleanArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Long2BooleanArrayMap.this.containsKey(local_k)) && (Long2BooleanArrayMap.this.get(local_k) == ((Boolean)local_e.getValue()).booleanValue());
    }
  }
}
