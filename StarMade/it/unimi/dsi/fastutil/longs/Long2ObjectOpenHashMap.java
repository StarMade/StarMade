...
/* 607 */           return new Long2ObjectOpenHashMap.ValueIterator(Long2ObjectOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 610 */           return Long2ObjectOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 613 */           return Long2ObjectOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 616 */           Long2ObjectOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 731 */       c = (Long2ObjectOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Long2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public V next() { return Long2ObjectOpenHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 573 */       return new Long2ObjectOpenHashMap.KeyIterator(Long2ObjectOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 576 */       return Long2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(long k) {
/* 579 */       return Long2ObjectOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(long k) {
/* 582 */       int oldSize = Long2ObjectOpenHashMap.this.size;
/* 583 */       Long2ObjectOpenHashMap.this.remove(k);
/* 584 */       return Long2ObjectOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 587 */       Long2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Long2ObjectOpenHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 567 */       super(null); } 
/* 568 */     public long nextLong() { return Long2ObjectOpenHashMap.this.key[nextEntry()]; } 
/* 569 */     public Long next() { return Long.valueOf(Long2ObjectOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 513 */       return new Long2ObjectOpenHashMap.EntryIterator(Long2ObjectOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Long2ObjectMap.Entry<V>> fastIterator() {
/* 516 */       return new Long2ObjectOpenHashMap.FastEntryIterator(Long2ObjectOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 524 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ObjectOpenHashMap.this.mask;
/*     */ 
/* 526 */       while (Long2ObjectOpenHashMap.this.used[pos] != 0) {
/* 527 */         if (Long2ObjectOpenHashMap.this.key[pos] == k) return Long2ObjectOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Long2ObjectOpenHashMap.this.value[pos].equals(e.getValue());
/* 528 */         pos = pos + 1 & Long2ObjectOpenHashMap.this.mask;
/*     */       }
/* 530 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 538 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ObjectOpenHashMap.this.mask;
/*     */ 
/* 540 */       while (Long2ObjectOpenHashMap.this.used[pos] != 0) {
/* 541 */         if (Long2ObjectOpenHashMap.this.key[pos] == k) {
/* 542 */           Long2ObjectOpenHashMap.this.remove(e.getKey());
/* 543 */           return true;
/*     */         }
/* 545 */         pos = pos + 1 & Long2ObjectOpenHashMap.this.mask;
/*     */       }
/* 547 */       return false;
/*     */     }
/*     */     public int size() {
/* 550 */       return Long2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 553 */       Long2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Long2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Long2ObjectMap.Entry<V>>
/*     */   {
/* 503 */     final AbstractLong2ObjectMap.BasicEntry<V> entry = new AbstractLong2ObjectMap.BasicEntry(0L, null);
/*     */ 
...
/* 505 */       int e = nextEntry();
/* 506 */       this.entry.key = Long2ObjectOpenHashMap.this.key[e];
/* 507 */       this.entry.value = Long2ObjectOpenHashMap.this.value[e];
/* 508 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Long2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Long2ObjectMap.Entry<V>>
/*     */   {
...
/* 494 */       return this.entry = new Long2ObjectOpenHashMap.MapEntry(Long2ObjectOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 498 */       super.remove();
/* 499 */       Long2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 399 */       this.pos = Long2ObjectOpenHashMap.this.n;
/*     */ 
/* 402 */       this.last = -1;
/*     */ 
/* 404 */       this.c = Long2ObjectOpenHashMap.this.size;
/*     */ 
/* 409 */       boolean[] used = Long2ObjectOpenHashMap.this.used;
...
/*     */ 
/* 422 */         int pos = (int)HashCommon.murmurHash3(k) & Long2ObjectOpenHashMap.this.mask;
/*     */ 
/* 424 */         while (Long2ObjectOpenHashMap.this.used[pos] != 0) {
/* 425 */           if (Long2ObjectOpenHashMap.this.key[pos] == k) return pos;
/* 426 */           pos = pos + 1 & Long2ObjectOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 429 */       this.last = this.pos;
/*     */ 
/* 431 */       if (this.c != 0) {
/* 432 */         boolean[] used = Long2ObjectOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 449 */         pos = (last = pos) + 1 & Long2ObjectOpenHashMap.this.mask;
/* 450 */         while (Long2ObjectOpenHashMap.this.used[pos] != 0) {
/* 451 */           int slot = (int)HashCommon.murmurHash3(Long2ObjectOpenHashMap.this.key[pos]) & Long2ObjectOpenHashMap.this.mask;
/* 452 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453 */           pos = pos + 1 & Long2ObjectOpenHashMap.this.mask;
/*     */         }
/* 455 */         if (Long2ObjectOpenHashMap.this.used[pos] == 0) break;
/* 456 */         if (pos < last)
/*     */         {
/* 458 */           if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 459 */           this.wrapped.add(Long2ObjectOpenHashMap.this.key[pos]);
/*     */         }
/* 461 */         Long2ObjectOpenHashMap.this.key[last] = Long2ObjectOpenHashMap.this.key[pos];
/* 462 */         Long2ObjectOpenHashMap.this.value[last] = Long2ObjectOpenHashMap.this.value[pos];
/*     */       }
/* 464 */       Long2ObjectOpenHashMap.this.used[last] = false;
/* 465 */       Long2ObjectOpenHashMap.this.value[last] = null;
/* 466 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 471 */       if (this.pos < -1)
/*     */       {
/* 473 */         Long2ObjectOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 474 */         this.last = -1;
/* 475 */         return;
/*     */       }
/* 477 */       Long2ObjectOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Long getKey() {
/* 369 */       return Long.valueOf(Long2ObjectOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public long getLongKey() {
/* 372 */       return Long2ObjectOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 375 */       return Long2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 378 */       Object oldValue = Long2ObjectOpenHashMap.this.value[this.index];
/* 379 */       Long2ObjectOpenHashMap.this.value[this.index] = v;
/* 380 */       return oldValue;
/*     */     }
/*     */ 
...
/* 386 */       return (Long2ObjectOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Long2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
/* 389 */       return HashCommon.long2int(Long2ObjectOpenHashMap.this.key[this.index]) ^ (Long2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Long2ObjectOpenHashMap.this.value[this.index].hashCode());
/*     */     }
/*     */     public String toString() {
/* 392 */       return Long2ObjectOpenHashMap.this.key[this.index] + "=>" + Long2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
