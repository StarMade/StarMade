  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Long2ObjectOpenHashMap(int expected, float local_f)
  {
  ...
  public Long2ObjectOpenHashMap(Map<? extends Long, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ObjectOpenHashMap(Map<? extends Long, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ObjectOpenHashMap(Long2ObjectMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Long2ObjectOpenHashMap(Long2ObjectMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Long2ObjectOpenHashMap(long[] local_k, V[] local_v, float local_f)
  {
  ...
  public Long2ObjectOpenHashMap(long[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Long2ObjectOpenHashMap.ValueIterator(Long2ObjectOpenHashMap.this);
        }
        ...
        {
          return Long2ObjectOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Long2ObjectOpenHashMap<V> local_c;
    try
    {
      local_c = (Long2ObjectOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    long[] key = this.key;
    V[] value = this.value;
    Long2ObjectOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Long2ObjectOpenHashMap<V>.MapIterator
    ...
    extends AbstractLongSet
  {
    ...
    {
      return new Long2ObjectOpenHashMap.KeyIterator(Long2ObjectOpenHashMap.this);
    }
    ...
    {
      return Long2ObjectOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(long local_k)
    {
      int oldSize = Long2ObjectOpenHashMap.this.size;
      Long2ObjectOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Long2ObjectOpenHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Long2ObjectOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Long2ObjectMap.FastEntrySet<V>
  {
    ...
    {
      return new Long2ObjectOpenHashMap.EntryIterator(Long2ObjectOpenHashMap.this, null);
    }
    
    public ObjectIterator<Long2ObjectMap.Entry<V>> fastIterator()
    {
      return new Long2ObjectOpenHashMap.FastEntryIterator(Long2ObjectOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ObjectOpenHashMap.this.mask; Long2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ObjectOpenHashMap.this.mask) {
        if (Long2ObjectOpenHashMap.this.key[pos] == local_k) {
          return Long2ObjectOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Long2ObjectOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = (int)HashCommon.murmurHash3(local_k) & Long2ObjectOpenHashMap.this.mask; Long2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ObjectOpenHashMap.this.mask) {
        if (Long2ObjectOpenHashMap.this.key[pos] == local_k)
        {
          Long2ObjectOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Long2ObjectMap.Entry<V>>
  {
    ...
    public AbstractLong2ObjectMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Long2ObjectOpenHashMap.this.key[local_e];
      this.entry.value = Long2ObjectOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Long2ObjectMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Long2ObjectOpenHashMap.MapEntry(Long2ObjectOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Long2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Long2ObjectOpenHashMap.this.field_49;
    int last = -1;
    int field_2231 = Long2ObjectOpenHashMap.this.size;
    LongArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Long2ObjectOpenHashMap.this.used;
      while ((this.field_2231 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2231 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2231 != 0)
      {
        boolean[] local_k = Long2ObjectOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Long2ObjectOpenHashMap.this.mask; Long2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Long2ObjectOpenHashMap.this.mask)
        {
          int slot = (int)HashCommon.murmurHash3(Long2ObjectOpenHashMap.this.key[pos]) & Long2ObjectOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Long2ObjectOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Long2ObjectOpenHashMap.this.key[pos]);
        }
        Long2ObjectOpenHashMap.this.key[last] = Long2ObjectOpenHashMap.this.key[pos];
        Long2ObjectOpenHashMap.this.value[last] = Long2ObjectOpenHashMap.this.value[pos];
      }
      Long2ObjectOpenHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Long2ObjectOpenHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
        this.last = -1;
        return;
      }
      Long2ObjectOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2231 > 0))
      {
        this.field_2231 += 1;
        nextEntry();
      }
    ...
    implements Long2ObjectMap.Entry<V>, Map.Entry<Long, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Long2ObjectOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Long, V> local_e = (Map.Entry)local_o;
      return (Long2ObjectOpenHashMap.this.key[this.index] == ((Long)local_e.getKey()).longValue()) && (Long2ObjectOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Long2ObjectOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
