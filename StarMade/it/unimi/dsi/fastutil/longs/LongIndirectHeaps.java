...
/*   4:    */
/*  63:    */public class LongIndirectHeaps
/*  64:    */{
/*  65:    */  public static int downHeap(long[] refArray, int[] heap, int[] inv, int size, int i, LongComparator c)
/*  66:    */  {
/*  67: 67 */    if (i >= size) throw new IllegalArgumentException("Heap position (" + i + ") is larger than or equal to heap size (" + size + ")");
/*  68: 68 */    int e = heap[i];
/*  69: 69 */    long E = refArray[e];
/*  70:    */    
...
/*  90:    */  }
/*  91:    */  
/* 103:    */  public static int upHeap(long[] refArray, int[] heap, int[] inv, int size, int i, LongComparator c)
/* 104:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 135:    */  public static void makeHeap(long[] refArray, int offset, int length, int[] heap, int[] inv, LongComparator c)
/* 136:    */  {
/* 137:137 */    LongArrays.ensureOffsetLength(refArray, offset, length);
