...
/*  14:    */
/*  75:    */public class LongOpenHashBigSet
/*  76:    */  extends AbstractLongSet
...
/*  81:    */  protected transient long[][] key;
...
/*  99:    */  }
/* 100:    */  
/* 107:    */  public LongOpenHashBigSet(long expected, float f)
/* 108:    */  {
...
/* 114:114 */    this.key = LongBigArrays.newBigArray(this.n);
/* 115:115 */    this.used = BooleanBigArrays.newBigArray(this.n);
/* 116:116 */    initMasks();
/* 117:    */  }
/* 118:    */  
/* 122:    */  public LongOpenHashBigSet(long expected)
/* 123:    */  {
/* 124:124 */    this(expected, 0.75F);
/* 125:    */  }
/* 126:    */  
/* 130:    */  public LongOpenHashBigSet()
/* 131:    */  {
/* 132:132 */    this(16L, 0.75F);
/* 133:    */  }
/* 134:    */  
/* 140:    */  public LongOpenHashBigSet(Collection<? extends Long> c, float f)
/* 141:    */  {
/* 142:142 */    this(c.size(), f);
/* 143:143 */    addAll(c);
/* 144:    */  }
/* 145:    */  
/* 151:    */  public LongOpenHashBigSet(Collection<? extends Long> c)
/* 152:    */  {
/* 153:153 */    this(c, 0.75F);
/* 154:    */  }
/* 155:    */  
/* 161:    */  public LongOpenHashBigSet(LongCollection c, float f)
/* 162:    */  {
/* 163:163 */    this(c.size(), f);
/* 164:164 */    addAll(c);
/* 165:    */  }
/* 166:    */  
/* 172:    */  public LongOpenHashBigSet(LongCollection c)
/* 173:    */  {
/* 174:174 */    this(c, 0.75F);
/* 175:    */  }
/* 176:    */  
/* 182:    */  public LongOpenHashBigSet(LongIterator i, float f)
/* 183:    */  {
/* 184:184 */    this(16L, f);
/* 185:185 */    while (i.hasNext()) { add(i.nextLong());
/* 186:    */    }
/* 187:    */  }
/* 188:    */  
/* 192:    */  public LongOpenHashBigSet(LongIterator i)
/* 193:    */  {
/* 194:194 */    this(i, 0.75F);
/* 195:    */  }
/* 196:    */  
/* 205:    */  public LongOpenHashBigSet(Iterator<?> i, float f)
/* 206:    */  {
/* 207:207 */    this(LongIterators.asLongIterator(i), f);
/* 208:    */  }
/* 209:    */  
/* 213:    */  public LongOpenHashBigSet(Iterator<?> i)
/* 214:    */  {
/* 215:215 */    this(LongIterators.asLongIterator(i));
/* 216:    */  }
/* 217:    */  
/* 228:    */  public LongOpenHashBigSet(long[] a, int offset, int length, float f)
/* 229:    */  {
...
/* 234:    */  }
/* 235:    */  
/* 241:    */  public LongOpenHashBigSet(long[] a, int offset, int length)
/* 242:    */  {
/* 243:243 */    this(a, offset, length, 0.75F);
/* 244:    */  }
/* 245:    */  
/* 251:    */  public LongOpenHashBigSet(long[] a, float f)
/* 252:    */  {
/* 253:253 */    this(a, 0, a.length, f);
/* 254:    */  }
/* 255:    */  
/* 261:    */  public LongOpenHashBigSet(long[] a)
/* 262:    */  {
/* 263:263 */    this(a, 0.75F);
/* 264:    */  }
/* 265:    */  
/* 266:    */  public boolean add(long k) {
/* 267:267 */    long h = HashCommon.murmurHash3(k);
/* 268:    */    
...
/* 305:305 */        long slot = HashCommon.murmurHash3(LongBigArrays.get(this.key, pos)) & this.mask;
...
/* 311:    */        break;
/* 312:312 */      LongBigArrays.set(this.key, last, LongBigArrays.get(this.key, pos));
/* 313:    */    }
/* 314:    */    
...
/* 320:    */  }
/* 321:    */  
/* 322:    */  public boolean remove(long k)
/* 323:    */  {
/* 324:324 */    long h = HashCommon.murmurHash3(k);
/* 325:    */    
...
/* 342:    */  }
/* 343:    */  
/* 344:    */  public boolean contains(long k)
/* 345:    */  {
/* 346:346 */    long h = HashCommon.murmurHash3(k);
/* 347:    */    
...
/* 374:    */    extends AbstractLongIterator
/* 375:    */  {
/* 376:    */    int base;
/* 377:    */    int displ;
/* 378:    */    int lastBase;
/* 379:    */    int lastDispl;
/* 380:    */    long c;
/* 381:    */    LongArrayList wrapped;
/* 382:    */    
/* 383:    */    private SetIterator()
/* 384:    */    {
/* 385:385 */      this.c = LongOpenHashBigSet.this.size;
/* 386:    */      
/* 390:390 */      this.base = LongOpenHashBigSet.this.key.length;
/* 391:391 */      this.lastBase = -1;
/* 392:392 */      boolean[][] used = LongOpenHashBigSet.this.used;
/* 393:393 */      if (this.c != 0L)
/* 394:394 */        do { if (this.displ-- == 0) {
/* 395:395 */            this.base -= 1;
/* 396:396 */            this.displ = ((int)LongOpenHashBigSet.this.mask);
/* 397:    */          }
...
/* 402:    */    
/* 403:    */    public long nextLong() {
/* 404:404 */      if (!hasNext()) throw new NoSuchElementException();
/* 405:405 */      this.c -= 1L;
/* 406:    */      
/* 407:407 */      if (this.base < 0) return this.wrapped.getLong(-(this.lastBase = --this.base) - 2);
/* 408:408 */      long retVal = LongOpenHashBigSet.this.key[(this.lastBase = this.base)][(this.lastDispl = this.displ)];
/* 409:409 */      if (this.c != 0L) {
/* 410:410 */        boolean[][] used = LongOpenHashBigSet.this.used;
/* 411:    */        do {
/* 412:412 */          if (this.displ-- == 0) {
/* 413:413 */            if (this.base-- == 0) break;
/* 414:414 */            this.displ = ((int)LongOpenHashBigSet.this.mask);
/* 415:    */          }
...
/* 434:    */      for (;;)
/* 435:    */      {
/* 436:436 */        pos = (last = pos) + 1L & LongOpenHashBigSet.this.mask;
/* 437:437 */        while (BooleanBigArrays.get(LongOpenHashBigSet.this.used, pos)) {
/* 438:438 */          long slot = HashCommon.murmurHash3(LongBigArrays.get(LongOpenHashBigSet.this.key, pos)) & LongOpenHashBigSet.this.mask;
/* 439:439 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 440:440 */          pos = pos + 1L & LongOpenHashBigSet.this.mask;
/* 441:    */        }
/* 442:442 */        if (!BooleanBigArrays.get(LongOpenHashBigSet.this.used, pos)) break;
/* 443:443 */        if (pos < last)
/* 444:    */        {
/* 445:445 */          if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 446:446 */          this.wrapped.add(LongBigArrays.get(LongOpenHashBigSet.this.key, pos));
/* 447:    */        }
/* 448:448 */        LongBigArrays.set(LongOpenHashBigSet.this.key, last, LongBigArrays.get(LongOpenHashBigSet.this.key, pos));
/* 449:    */      }
/* 450:450 */      BooleanBigArrays.set(LongOpenHashBigSet.this.used, last, false);
/* 451:451 */      return last;
/* 452:    */    }
/* 453:    */    
...
/* 457:    */      {
/* 458:458 */        LongOpenHashBigSet.this.remove(this.wrapped.getLong(-this.base - 2));
/* 459:459 */        this.lastBase = -1;
/* 460:460 */        return;
/* 461:    */      }
/* 462:462 */      LongOpenHashBigSet.this.size -= 1L;
...
/* 469:    */  }
/* 470:    */  
/* 471:    */  public LongIterator iterator() {
...
/* 548:548 */    long[][] key = this.key;
/* 549:549 */    boolean[][] newUsed = BooleanBigArrays.newBigArray(newN);
/* 550:550 */    long[][] newKey = LongBigArrays.newBigArray(newN);
...
/* 559:559 */      long k = key[base][displ];
/* 560:560 */      long h = HashCommon.murmurHash3(k);
/* 561:    */      
...
/* 584:    */  
/* 588:    */  public LongOpenHashBigSet clone()
/* 589:    */  {
/* 590:    */    LongOpenHashBigSet c;
/* 591:    */    
/* 594:    */    try
/* 595:    */    {
/* 596:596 */      c = (LongOpenHashBigSet)super.clone();
/* 597:    */    }
/* 598:    */    catch (CloneNotSupportedException cantHappen) {
/* 599:599 */      throw new InternalError();
/* 600:    */    }
/* 601:601 */    c.key = LongBigArrays.copy(this.key);
...
/* 621:621 */      h += HashCommon.long2int(key[base][displ]);
/* 622:622 */      base += ((displ = displ + 1 & this.segmentMask) == 0 ? 1 : 0);
/* 623:    */    }
/* 624:624 */    return h;
/* 625:    */  }
/* 626:    */  
/* 627:627 */  private void writeObject(ObjectOutputStream s) throws IOException { LongIterator i = iterator();
/* 628:628 */    s.defaultWriteObject();
/* 629:629 */    for (long j = this.size; j-- != 0L; s.writeLong(i.nextLong())) {}
/* 630:    */  }
/* 631:    */  
...
/* 636:636 */    long[][] key = this.key = LongBigArrays.newBigArray(this.n);
/* 637:637 */    boolean[][] used = this.used = BooleanBigArrays.newBigArray(this.n);
/* 638:638 */    initMasks();
/* 639:    */    
/* 642:642 */    for (long i = this.size; i-- != 0L;) {
/* 643:643 */      long k = s.readLong();
/* 644:644 */      long h = HashCommon.murmurHash3(k);
