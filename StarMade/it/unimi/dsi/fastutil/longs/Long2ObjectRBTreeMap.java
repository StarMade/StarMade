...
/*   21:     */
/*   71:     */public class Long2ObjectRBTreeMap<V>
...
/*   89:     */  
/*   90:     */  public Long2ObjectRBTreeMap()
/*   91:     */  {
/*   92:  92 */    allocatePaths();
/*   93:     */    
...
/*  119: 119 */          return Long2ObjectRBTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*  120:     */        }
/*  121:     */        
/*  122: 122 */        public int compare(Long ok1, Long ok2) { return Long2ObjectRBTreeMap.this.storedComparator.compare(ok1, ok2); }
/*  123:     */      };
/*  124:     */    }
/*  125:     */  }
/*  126:     */  
/*  133:     */  public Long2ObjectRBTreeMap(Comparator<? super Long> c)
/*  134:     */  {
/*  135: 135 */    this();
...
/*  138:     */  }
/*  139:     */  
/*  145:     */  public Long2ObjectRBTreeMap(Map<? extends Long, ? extends V> m)
/*  146:     */  {
/*  147: 147 */    this();
/*  148: 148 */    putAll(m);
/*  149:     */  }
/*  150:     */  
/*  155:     */  public Long2ObjectRBTreeMap(SortedMap<Long, V> m)
/*  156:     */  {
/*  157: 157 */    this(m.comparator());
/*  158: 158 */    putAll(m);
/*  159:     */  }
/*  160:     */  
/*  165:     */  public Long2ObjectRBTreeMap(Long2ObjectMap<? extends V> m)
/*  166:     */  {
/*  167: 167 */    this();
/*  168: 168 */    putAll(m);
/*  169:     */  }
/*  170:     */  
/*  175:     */  public Long2ObjectRBTreeMap(Long2ObjectSortedMap<V> m)
/*  176:     */  {
/*  177: 177 */    this(m.comparator());
/*  178: 178 */    putAll(m);
/*  179:     */  }
/*  180:     */  
/*  188:     */  public Long2ObjectRBTreeMap(long[] k, V[] v, Comparator<? super Long> c)
/*  189:     */  {
/*  190: 190 */    this(c);
...
/*  194:     */  }
/*  195:     */  
/*  201:     */  public Long2ObjectRBTreeMap(long[] k, V[] v)
/*  202:     */  {
...
/*  743:     */  {
/*  744: 744 */    Long2ObjectRBTreeMap<V>.ValueIterator i = new ValueIterator(null);
/*  745:     */    
...
/*  773:     */    implements Cloneable, Long2ObjectMap.Entry<V>
/*  774:     */  {
...
/*  925:     */    }
/*  926:     */    
/*  927:     */    public Long getKey() {
/*  928: 924 */      return Long.valueOf(this.key);
/*  929:     */    }
/*  930:     */    
/*  931:     */    public long getLongKey()
/*  932:     */    {
...
/*  969: 965 */      Map.Entry<Long, V> e = (Map.Entry)o;
/*  970: 966 */      return (this.key == ((Long)e.getKey()).longValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*  971:     */    }
/*  972:     */    
/*  973: 969 */    public int hashCode() { return HashCommon.long2int(this.key) ^ (this.value == null ? 0 : this.value.hashCode()); }
/*  974:     */    
...
/*  978:     */  }
/*  979:     */  
/* 1008:     */  public boolean containsKey(long k)
/* 1009:     */  {
...
/* 1017:     */  }
/* 1018:     */  
/* 1019:     */  public V get(long k) {
/* 1020:1016 */    Entry<V> e = findKey(k);
/* 1021:1017 */    return e == null ? this.defRetValue : e.value;
/* 1022:     */  }
/* 1023:     */  
/* 1024:1020 */  public long firstLongKey() { if (this.tree == null) throw new NoSuchElementException();
/* 1025:1021 */    return this.firstEntry.key;
/* 1026:     */  }
/* 1027:     */  
/* 1028:1024 */  public long lastLongKey() { if (this.tree == null) throw new NoSuchElementException();
/* 1029:1025 */    return this.lastEntry.key;
/* 1030:     */  }
/* 1031:     */  
/* 1034:     */  private class TreeIterator
/* 1035:     */  {
/* 1036:     */    Long2ObjectRBTreeMap.Entry<V> prev;
/* 1037:     */    
/* 1039:     */    Long2ObjectRBTreeMap.Entry<V> next;
/* 1040:     */    
/* 1041:     */    Long2ObjectRBTreeMap.Entry<V> curr;
/* 1042:     */    
/* 1043:1039 */    int index = 0;
/* 1044:     */    
/* 1045:1041 */    TreeIterator() { this.next = Long2ObjectRBTreeMap.this.firstEntry; }
/* 1046:     */    
/* 1047:     */    TreeIterator(long k) {
/* 1048:1044 */      if ((this.next = Long2ObjectRBTreeMap.this.locateKey(k)) != null)
/* 1049:1045 */        if (Long2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1060:     */    
/* 1061:     */    Long2ObjectRBTreeMap.Entry<V> nextEntry() {
...
/* 1070:     */    
/* 1071:     */    Long2ObjectRBTreeMap.Entry<V> previousEntry() {
...
/* 1092:1088 */      Long2ObjectRBTreeMap.this.remove(this.curr.key);
...
/* 1108:     */    extends Long2ObjectRBTreeMap<V>.TreeIterator
/* 1109:     */    implements ObjectListIterator<Long2ObjectMap.Entry<V>>
/* 1110:     */  {
/* 1111:1107 */    EntryIterator() { super(); }
/* 1112:     */    
/* 1113:1109 */    EntryIterator(long k) { super(k); }
/* 1114:     */    
/* 1115:1111 */    public Long2ObjectMap.Entry<V> next() { return nextEntry(); }
/* 1116:1112 */    public Long2ObjectMap.Entry<V> previous() { return previousEntry(); }
/* 1117:1113 */    public void set(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/* 1118:1114 */    public void add(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/* 1119:     */  }
/* 1120:     */  
/* 1121:1117 */  public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1122:1118 */        final Comparator<? super Long2ObjectMap.Entry<V>> comparator = new Comparator() {
/* 1123:     */          public int compare(Long2ObjectMap.Entry<V> x, Long2ObjectMap.Entry<V> y) {
/* 1124:1120 */            return Long2ObjectRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/* 1125:     */          }
/* 1126:     */        };
/* 1127:     */        
/* 1128:1124 */        public Comparator<? super Long2ObjectMap.Entry<V>> comparator() { return this.comparator; }
/* 1129:     */        
/* 1130:     */        public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator() {
/* 1131:1127 */          return new Long2ObjectRBTreeMap.EntryIterator(Long2ObjectRBTreeMap.this);
/* 1132:     */        }
/* 1133:     */        
/* 1134:1130 */        public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) { return new Long2ObjectRBTreeMap.EntryIterator(Long2ObjectRBTreeMap.this, ((Long)from.getKey()).longValue()); }
/* 1135:     */        
/* 1136:     */        public boolean contains(Object o)
/* 1137:     */        {
/* 1138:1134 */          if (!(o instanceof Map.Entry)) return false;
/* 1139:1135 */          Map.Entry<Long, V> e = (Map.Entry)o;
/* 1140:1136 */          Long2ObjectRBTreeMap.Entry<V> f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1141:1137 */          return e.equals(f);
/* 1142:     */        }
/* 1143:     */        
/* 1144:     */        public boolean remove(Object o) {
/* 1145:1141 */          if (!(o instanceof Map.Entry)) return false;
/* 1146:1142 */          Map.Entry<Long, V> e = (Map.Entry)o;
/* 1147:1143 */          Long2ObjectRBTreeMap.Entry<V> f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1148:1144 */          if (f != null) Long2ObjectRBTreeMap.this.remove(f.key);
/* 1149:1145 */          return f != null; }
/* 1150:     */        
/* 1151:1147 */        public int size() { return Long2ObjectRBTreeMap.this.count; }
/* 1152:1148 */        public void clear() { Long2ObjectRBTreeMap.this.clear(); }
/* 1153:1149 */        public Long2ObjectMap.Entry<V> first() { return Long2ObjectRBTreeMap.this.firstEntry; }
/* 1154:1150 */        public Long2ObjectMap.Entry<V> last() { return Long2ObjectRBTreeMap.this.lastEntry; }
/* 1155:1151 */        public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) { return Long2ObjectRBTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ObjectEntrySet(); }
/* 1156:1152 */        public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) { return Long2ObjectRBTreeMap.this.headMap((Long)to.getKey()).long2ObjectEntrySet(); }
/* 1157:1153 */        public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) { return Long2ObjectRBTreeMap.this.tailMap((Long)from.getKey()).long2ObjectEntrySet(); }
/* 1158:     */      };
/* 1159:1155 */    return this.entries;
/* 1160:     */  }
/* 1161:     */  
/* 1164:     */  private final class KeyIterator
/* 1165:     */    extends Long2ObjectRBTreeMap.TreeIterator
/* 1166:     */    implements LongListIterator
/* 1167:     */  {
/* 1168:1164 */    public KeyIterator() { super(); }
/* 1169:1165 */    public KeyIterator(long k) { super(k); }
/* 1170:1166 */    public long nextLong() { return nextEntry().key; }
/* 1171:1167 */    public long previousLong() { return previousEntry().key; }
/* 1172:1168 */    public void set(long k) { throw new UnsupportedOperationException(); }
/* 1173:1169 */    public void add(long k) { throw new UnsupportedOperationException(); }
/* 1174:1170 */    public Long next() { return Long.valueOf(nextEntry().key); }
/* 1175:1171 */    public Long previous() { return Long.valueOf(previousEntry().key); }
/* 1176:1172 */    public void set(Long ok) { throw new UnsupportedOperationException(); }
/* 1177:1173 */    public void add(Long ok) { throw new UnsupportedOperationException(); }
/* 1178:     */  }
/* 1179:     */  
/* 1180:1176 */  private class KeySet extends AbstractLong2ObjectSortedMap.KeySet { private KeySet() { super(); }
/* 1181:1177 */    public LongBidirectionalIterator iterator() { return new Long2ObjectRBTreeMap.KeyIterator(Long2ObjectRBTreeMap.this); }
/* 1182:1178 */    public LongBidirectionalIterator iterator(long from) { return new Long2ObjectRBTreeMap.KeyIterator(Long2ObjectRBTreeMap.this, from); }
/* 1183:     */  }
/* 1184:     */  
/* 1191:     */  public LongSortedSet keySet()
/* 1192:     */  {
...
/* 1199:     */    extends Long2ObjectRBTreeMap<V>.TreeIterator
...
/* 1219:1215 */          return new Long2ObjectRBTreeMap.ValueIterator(Long2ObjectRBTreeMap.this, null);
/* 1220:     */        }
/* 1221:     */        
/* 1222:1218 */        public boolean contains(Object k) { return Long2ObjectRBTreeMap.this.containsValue(k); }
/* 1223:     */        
/* 1224:     */        public int size() {
/* 1225:1221 */          return Long2ObjectRBTreeMap.this.count;
/* 1226:     */        }
/* 1227:     */        
/* 1228:1224 */        public void clear() { Long2ObjectRBTreeMap.this.clear(); }
/* 1229:     */      };
/* 1230:     */    }
/* 1231:1227 */    return this.values;
/* 1232:     */  }
/* 1233:     */  
/* 1234:1230 */  public LongComparator comparator() { return this.actualComparator; }
/* 1235:     */  
/* 1236:     */  public Long2ObjectSortedMap<V> headMap(long to) {
/* 1237:1233 */    return new Submap(0L, true, to, false);
/* 1238:     */  }
/* 1239:     */  
/* 1240:1236 */  public Long2ObjectSortedMap<V> tailMap(long from) { return new Submap(from, false, 0L, true); }
/* 1241:     */  
/* 1242:     */  public Long2ObjectSortedMap<V> subMap(long from, long to) {
/* 1243:1239 */    return new Submap(from, false, to, false);
/* 1244:     */  }
/* 1245:     */  
/* 1249:     */  private final class Submap
/* 1250:     */    extends AbstractLong2ObjectSortedMap<V>
...
/* 1266:     */    boolean top;
/* 1267:     */    
/* 1269:     */    protected volatile transient ObjectSortedSet<Long2ObjectMap.Entry<V>> entries;
/* 1270:     */    
/* 1272:     */    protected volatile transient LongSortedSet keys;
/* 1273:     */    
/* 1275:     */    protected volatile transient ObjectCollection<V> values;
/* 1276:     */    
/* 1279:     */    public Submap(long from, boolean bottom, long to, boolean top)
/* 1280:     */    {
/* 1281:1277 */      if ((!bottom) && (!top) && (Long2ObjectRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1282:1278 */      this.from = from;
/* 1283:1279 */      this.bottom = bottom;
/* 1284:1280 */      this.to = to;
/* 1285:1281 */      this.top = top;
/* 1286:1282 */      this.defRetValue = Long2ObjectRBTreeMap.this.defRetValue;
/* 1287:     */    }
/* 1288:     */    
/* 1289:1285 */    public void clear() { Long2ObjectRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
...
/* 1294:     */    }
/* 1295:     */    
/* 1298:     */    final boolean in(long k)
/* 1299:     */    {
/* 1300:1296 */      return ((this.bottom) || (Long2ObjectRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Long2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/* 1301:     */    }
/* 1302:     */    
/* 1303:     */    public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
/* 1304:1300 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1305:     */          public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator() {
/* 1306:1302 */            return new Long2ObjectRBTreeMap.Submap.SubmapEntryIterator(Long2ObjectRBTreeMap.Submap.this);
/* 1307:     */          }
/* 1308:     */          
/* 1309:1305 */          public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) { return new Long2ObjectRBTreeMap.Submap.SubmapEntryIterator(Long2ObjectRBTreeMap.Submap.this, ((Long)from.getKey()).longValue()); }
/* 1310:     */          
/* 1311:1307 */          public Comparator<? super Long2ObjectMap.Entry<V>> comparator() { return Long2ObjectRBTreeMap.this.long2ObjectEntrySet().comparator(); }
/* 1312:     */          
/* 1313:     */          public boolean contains(Object o) {
/* 1314:1310 */            if (!(o instanceof Map.Entry)) return false;
/* 1315:1311 */            Map.Entry<Long, V> e = (Map.Entry)o;
/* 1316:1312 */            Long2ObjectRBTreeMap.Entry<V> f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1317:1313 */            return (f != null) && (Long2ObjectRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1318:     */          }
/* 1319:     */          
/* 1320:     */          public boolean remove(Object o) {
/* 1321:1317 */            if (!(o instanceof Map.Entry)) return false;
/* 1322:1318 */            Map.Entry<Long, V> e = (Map.Entry)o;
/* 1323:1319 */            Long2ObjectRBTreeMap.Entry<V> f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1324:1320 */            if ((f != null) && (Long2ObjectRBTreeMap.Submap.this.in(f.key))) Long2ObjectRBTreeMap.Submap.this.remove(f.key);
...
/* 1330:1326 */            return c; }
/* 1331:     */          
/* 1332:1328 */          public boolean isEmpty() { return !new Long2ObjectRBTreeMap.Submap.SubmapIterator(Long2ObjectRBTreeMap.Submap.this).hasNext(); }
/* 1333:1329 */          public void clear() { Long2ObjectRBTreeMap.Submap.this.clear(); }
/* 1334:1330 */          public Long2ObjectMap.Entry<V> first() { return Long2ObjectRBTreeMap.Submap.this.firstEntry(); }
/* 1335:1331 */          public Long2ObjectMap.Entry<V> last() { return Long2ObjectRBTreeMap.Submap.this.lastEntry(); }
/* 1336:1332 */          public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) { return Long2ObjectRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ObjectEntrySet(); }
/* 1337:1333 */          public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) { return Long2ObjectRBTreeMap.Submap.this.headMap((Long)to.getKey()).long2ObjectEntrySet(); }
/* 1338:1334 */          public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) { return Long2ObjectRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2ObjectEntrySet(); }
/* 1339:     */        };
/* 1340:1336 */      return this.entries; }
/* 1341:     */    
/* 1342:1338 */    private class KeySet extends AbstractLong2ObjectSortedMap.KeySet { private KeySet() { super(); }
/* 1343:1339 */      public LongBidirectionalIterator iterator() { return new Long2ObjectRBTreeMap.Submap.SubmapKeyIterator(Long2ObjectRBTreeMap.Submap.this); }
/* 1344:1340 */      public LongBidirectionalIterator iterator(long from) { return new Long2ObjectRBTreeMap.Submap.SubmapKeyIterator(Long2ObjectRBTreeMap.Submap.this, from); }
/* 1345:     */    }
/* 1346:     */    
/* 1347:1343 */    public LongSortedSet keySet() { if (this.keys == null) this.keys = new KeySet(null);
...
/* 1353:1349 */            return new Long2ObjectRBTreeMap.Submap.SubmapValueIterator(Long2ObjectRBTreeMap.Submap.this, null);
/* 1354:     */          }
/* 1355:     */          
/* 1356:1352 */          public boolean contains(Object k) { return Long2ObjectRBTreeMap.Submap.this.containsValue(k); }
/* 1357:     */          
/* 1358:     */          public int size() {
/* 1359:1355 */            return Long2ObjectRBTreeMap.Submap.this.size();
/* 1360:     */          }
/* 1361:     */          
/* 1362:1358 */          public void clear() { Long2ObjectRBTreeMap.Submap.this.clear(); }
/* 1363:     */        };
/* 1364:     */      }
/* 1365:1361 */      return this.values;
/* 1366:     */    }
/* 1367:     */    
/* 1369:1365 */    public boolean containsKey(long k) { return (in(k)) && (Long2ObjectRBTreeMap.this.containsKey(k)); }
/* 1370:     */    
/* 1371:     */    public boolean containsValue(Object v) {
/* 1372:1368 */      Long2ObjectRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
/* 1373:1370 */      for (; 
/* 1374:1370 */          i.hasNext(); 
/* 1375:     */          
...
/* 1383:     */    }
/* 1384:     */    
/* 1385:     */    public V get(long k)
/* 1386:     */    {
/* 1387:1379 */      long kk = k;
/* 1388:1380 */      Long2ObjectRBTreeMap.Entry<V> e; return (in(kk)) && ((e = Long2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1389:     */    }
/* 1390:     */    
/* 1391:1383 */    public V put(long k, V v) { Long2ObjectRBTreeMap.this.modified = false;
...
/* 1393:1385 */      V oldValue = Long2ObjectRBTreeMap.this.put(k, v);
/* 1394:1386 */      return Long2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1395:     */    }
/* 1396:     */    
/* 1397:1389 */    public V put(Long ok, V ov) { V oldValue = put(ok.longValue(), ov);
/* 1398:1390 */      return Long2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1399:     */    }
/* 1400:     */    
/* 1401:     */    public V remove(long k) {
/* 1402:1394 */      Long2ObjectRBTreeMap.this.modified = false;
/* 1403:1395 */      if (!in(k)) return this.defRetValue;
/* 1404:1396 */      V oldValue = Long2ObjectRBTreeMap.this.remove(k);
/* 1405:1397 */      return Long2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1406:     */    }
/* 1407:     */    
/* 1408:1400 */    public V remove(Object ok) { V oldValue = remove(((Long)ok).longValue());
/* 1409:1401 */      return Long2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1410:     */    }
/* 1411:     */    
/* 1412:1404 */    public int size() { Long2ObjectRBTreeMap<V>.Submap.SubmapIterator i = new SubmapIterator();
/* 1413:1405 */      int n = 0;
...
/* 1422:     */    
/* 1424:1416 */    public LongComparator comparator() { return Long2ObjectRBTreeMap.this.actualComparator; }
/* 1425:     */    
/* 1426:     */    public Long2ObjectSortedMap<V> headMap(long to) {
/* 1427:1419 */      if (this.top) return new Submap(Long2ObjectRBTreeMap.this, this.from, this.bottom, to, false);
/* 1428:1420 */      return Long2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2ObjectRBTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1429:     */    }
/* 1430:     */    
/* 1431:1423 */    public Long2ObjectSortedMap<V> tailMap(long from) { if (this.bottom) return new Submap(Long2ObjectRBTreeMap.this, from, false, this.to, this.top);
/* 1432:1424 */      return Long2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2ObjectRBTreeMap.this, from, false, this.to, this.top) : this;
/* 1433:     */    }
/* 1434:     */    
/* 1435:1427 */    public Long2ObjectSortedMap<V> subMap(long from, long to) { if ((this.top) && (this.bottom)) return new Submap(Long2ObjectRBTreeMap.this, from, false, to, false);
/* 1436:1428 */      if (!this.top) to = Long2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1437:1429 */      if (!this.bottom) from = Long2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1438:1430 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1439:1431 */      return new Submap(Long2ObjectRBTreeMap.this, from, false, to, false);
/* 1440:     */    }
/* 1441:     */    
/* 1444:     */    public Long2ObjectRBTreeMap.Entry<V> firstEntry()
/* 1445:     */    {
/* 1446:1438 */      if (Long2ObjectRBTreeMap.this.tree == null) return null;
/* 1447:     */      Long2ObjectRBTreeMap.Entry<V> e;
/* 1448:     */      Long2ObjectRBTreeMap.Entry<V> e;
/* 1449:1441 */      if (this.bottom) { e = Long2ObjectRBTreeMap.this.firstEntry;
/* 1450:     */      } else {
/* 1451:1443 */        e = Long2ObjectRBTreeMap.this.locateKey(this.from);
/* 1452:     */        
/* 1453:1445 */        if (Long2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1454:     */        }
/* 1455:     */      }
/* 1456:1448 */      if ((e == null) || ((!this.top) && (Long2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1457:1449 */      return e;
/* 1458:     */    }
/* 1459:     */    
/* 1462:     */    public Long2ObjectRBTreeMap.Entry<V> lastEntry()
/* 1463:     */    {
/* 1464:1456 */      if (Long2ObjectRBTreeMap.this.tree == null) return null;
/* 1465:     */      Long2ObjectRBTreeMap.Entry<V> e;
/* 1466:     */      Long2ObjectRBTreeMap.Entry<V> e;
/* 1467:1459 */      if (this.top) { e = Long2ObjectRBTreeMap.this.lastEntry;
/* 1468:     */      } else {
/* 1469:1461 */        e = Long2ObjectRBTreeMap.this.locateKey(this.to);
/* 1470:     */        
/* 1471:1463 */        if (Long2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1472:     */        }
/* 1473:     */      }
/* 1474:1466 */      if ((e == null) || ((!this.bottom) && (Long2ObjectRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1475:1467 */      return e;
/* 1476:     */    }
/* 1477:     */    
/* 1478:1470 */    public long firstLongKey() { Long2ObjectRBTreeMap.Entry<V> e = firstEntry();
/* 1479:1471 */      if (e == null) throw new NoSuchElementException();
/* 1480:1472 */      return e.key;
/* 1481:     */    }
/* 1482:     */    
/* 1483:1475 */    public long lastLongKey() { Long2ObjectRBTreeMap.Entry<V> e = lastEntry();
/* 1484:1476 */      if (e == null) throw new NoSuchElementException();
/* 1485:1477 */      return e.key;
/* 1486:     */    }
/* 1487:     */    
/* 1488:1480 */    public Long firstKey() { Long2ObjectRBTreeMap.Entry<V> e = firstEntry();
/* 1489:1481 */      if (e == null) throw new NoSuchElementException();
/* 1490:1482 */      return e.getKey();
/* 1491:     */    }
/* 1492:     */    
/* 1493:1485 */    public Long lastKey() { Long2ObjectRBTreeMap.Entry<V> e = lastEntry();
/* 1494:1486 */      if (e == null) throw new NoSuchElementException();
/* 1495:1487 */      return e.getKey();
/* 1496:     */    }
/* 1497:     */    
/* 1500:     */    private class SubmapIterator
/* 1501:     */      extends Long2ObjectRBTreeMap.TreeIterator
/* 1502:     */    {
/* 1503:     */      SubmapIterator()
/* 1504:     */      {
/* 1505:1497 */        super();
/* 1506:1498 */        this.next = Long2ObjectRBTreeMap.Submap.this.firstEntry();
/* 1507:     */      }
/* 1508:     */      
/* 1509:1501 */      SubmapIterator(long k) { this();
/* 1510:1502 */        if (this.next != null)
/* 1511:1503 */          if ((!Long2ObjectRBTreeMap.Submap.this.bottom) && (Long2ObjectRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1512:1504 */          } else if ((!Long2ObjectRBTreeMap.Submap.this.top) && (Long2ObjectRBTreeMap.this.compare(k, (this.prev = Long2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1513:     */          } else {
/* 1514:1506 */            this.next = Long2ObjectRBTreeMap.this.locateKey(k);
/* 1515:1507 */            if (Long2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1525:1517 */        if ((!Long2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2ObjectRBTreeMap.this.compare(this.prev.key, Long2ObjectRBTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1526:     */      }
/* 1527:     */      
/* 1528:1520 */      void updateNext() { this.next = this.next.next();
/* 1529:1521 */        if ((!Long2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Long2ObjectRBTreeMap.this.compare(this.next.key, Long2ObjectRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1530:     */      }
/* 1531:     */    }
/* 1532:     */    
/* 1533:1525 */    private class SubmapEntryIterator extends Long2ObjectRBTreeMap<V>.Submap.SubmapIterator implements ObjectListIterator<Long2ObjectMap.Entry<V>> { SubmapEntryIterator() { super(); }
/* 1534:     */      
/* 1535:1527 */      SubmapEntryIterator(long k) { super(k); }
/* 1536:     */      
/* 1537:1529 */      public Long2ObjectMap.Entry<V> next() { return nextEntry(); }
/* 1538:1530 */      public Long2ObjectMap.Entry<V> previous() { return previousEntry(); }
/* 1539:1531 */      public void set(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/* 1540:1532 */      public void add(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/* 1541:     */    }
/* 1542:     */    
/* 1547:     */    private final class SubmapKeyIterator
/* 1548:     */      extends Long2ObjectRBTreeMap.Submap.SubmapIterator
/* 1549:     */      implements LongListIterator
/* 1550:     */    {
/* 1551:1543 */      public SubmapKeyIterator() { super(); }
/* 1552:1544 */      public SubmapKeyIterator(long from) { super(from); }
/* 1553:1545 */      public long nextLong() { return nextEntry().key; }
/* 1554:1546 */      public long previousLong() { return previousEntry().key; }
/* 1555:1547 */      public void set(long k) { throw new UnsupportedOperationException(); }
/* 1556:1548 */      public void add(long k) { throw new UnsupportedOperationException(); }
/* 1557:1549 */      public Long next() { return Long.valueOf(nextEntry().key); }
/* 1558:1550 */      public Long previous() { return Long.valueOf(previousEntry().key); }
/* 1559:1551 */      public void set(Long ok) { throw new UnsupportedOperationException(); }
/* 1560:1552 */      public void add(Long ok) { throw new UnsupportedOperationException(); }
/* 1561:     */    }
/* 1562:     */    
/* 1566:     */    private final class SubmapValueIterator
/* 1567:     */      extends Long2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/* 1576:     */  }
/* 1577:     */  
/* 1581:     */  public Long2ObjectRBTreeMap<V> clone()
/* 1582:     */  {
/* 1583:     */    Long2ObjectRBTreeMap<V> c;
/* 1584:     */    
/* 1586:     */    try
/* 1587:     */    {
/* 1588:1580 */      c = (Long2ObjectRBTreeMap)super.clone();
/* 1589:     */    }
...
/* 1642:1634 */    Long2ObjectRBTreeMap<V>.EntryIterator i = new EntryIterator();
/* 1643:     */    
/* 1644:1636 */    s.defaultWriteObject();
/* 1645:1637 */    while (n-- != 0) {
/* 1646:1638 */      Entry<V> e = i.nextEntry();
/* 1647:1639 */      s.writeLong(e.key);
...
/* 1659:     */  {
/* 1660:1652 */    if (n == 1) {
/* 1661:1653 */      Entry<V> top = new Entry(s.readLong(), s.readObject());
...
/* 1667:1659 */    if (n == 2)
/* 1668:     */    {
/* 1670:1662 */      Entry<V> top = new Entry(s.readLong(), s.readObject());
/* 1671:1663 */      top.black(true);
/* 1672:1664 */      top.right(new Entry(s.readLong(), s.readObject()));
