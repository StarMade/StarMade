...
/*  119 */           return Long2ObjectRBTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  122 */           return Long2ObjectRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* 1118 */         final Comparator<? super Long2ObjectMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Long2ObjectMap.Entry<V> x, Long2ObjectMap.Entry<V> y) {
/* 1120 */             return Long2ObjectRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Long2ObjectRBTreeMap.EntryIterator(Long2ObjectRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
/* 1130 */           return new Long2ObjectRBTreeMap.EntryIterator(Long2ObjectRBTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Long2ObjectRBTreeMap.Entry f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1143 */           Long2ObjectRBTreeMap.Entry f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1144 */           if (f != null) Long2ObjectRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Long2ObjectRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Long2ObjectRBTreeMap.this.clear(); } 
/* 1149 */         public Long2ObjectMap.Entry<V> first() { return Long2ObjectRBTreeMap.this.firstEntry; } 
/* 1150 */         public Long2ObjectMap.Entry<V> last() { return Long2ObjectRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) { return Long2ObjectRBTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ObjectEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) { return Long2ObjectRBTreeMap.this.headMap((Long)to.getKey()).long2ObjectEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) { return Long2ObjectRBTreeMap.this.tailMap((Long)from.getKey()).long2ObjectEntrySet(); }
/*      */       };
...
/* 1215 */           return new Long2ObjectRBTreeMap.ValueIterator(Long2ObjectRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Long2ObjectRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Long2ObjectRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Long2ObjectRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1580 */       c = (Long2ObjectRBTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Long2ObjectRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Long2ObjectRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Long2ObjectRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Long2ObjectMap.Entry<V>> long2ObjectEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator() {
/* 1302 */             return new Long2ObjectRBTreeMap.Submap.SubmapEntryIterator(Long2ObjectRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2ObjectMap.Entry<V>> iterator(Long2ObjectMap.Entry<V> from) {
/* 1305 */             return new Long2ObjectRBTreeMap.Submap.SubmapEntryIterator(Long2ObjectRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1307 */           public Comparator<? super Long2ObjectMap.Entry<V>> comparator() { return Long2ObjectRBTreeMap.this.long2ObjectEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Long2ObjectRBTreeMap.Entry f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1313 */             return (f != null) && (Long2ObjectRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Long2ObjectRBTreeMap.Entry f = Long2ObjectRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1320 */             if ((f != null) && (Long2ObjectRBTreeMap.Submap.this.in(f.key))) Long2ObjectRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Long2ObjectRBTreeMap.Submap.SubmapIterator(Long2ObjectRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Long2ObjectRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Long2ObjectMap.Entry<V> first() { return Long2ObjectRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Long2ObjectMap.Entry<V> last() { return Long2ObjectRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> subSet(Long2ObjectMap.Entry<V> from, Long2ObjectMap.Entry<V> to) { return Long2ObjectRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2ObjectEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> headSet(Long2ObjectMap.Entry<V> to) { return Long2ObjectRBTreeMap.Submap.this.headMap((Long)to.getKey()).long2ObjectEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Long2ObjectMap.Entry<V>> tailSet(Long2ObjectMap.Entry<V> from) { return Long2ObjectRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2ObjectEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Long2ObjectRBTreeMap.Submap.SubmapValueIterator(Long2ObjectRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Long2ObjectRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Long2ObjectRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Long2ObjectRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1365 */       return (in(k)) && (Long2ObjectRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       long kk = k;
/*      */       Long2ObjectRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Long2ObjectRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(long k, V v) {
/* 1383 */       Long2ObjectRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Long2ObjectRBTreeMap.this.put(k, v);
/* 1386 */       return Long2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Long ok, V ov) {
/* 1389 */       Object oldValue = put(ok.longValue(), ov);
/* 1390 */       return Long2ObjectRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(long k) {
/* 1394 */       Long2ObjectRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Long2ObjectRBTreeMap.this.remove(k);
/* 1397 */       return Long2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Long)ok).longValue());
/* 1401 */       return Long2ObjectRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1416 */       return Long2ObjectRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2ObjectSortedMap<V> headMap(long to) {
/* 1419 */       if (this.top) return new Submap(Long2ObjectRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Long2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2ObjectRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2ObjectSortedMap<V> tailMap(long from) {
/* 1423 */       if (this.bottom) return new Submap(Long2ObjectRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Long2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2ObjectRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2ObjectSortedMap<V> subMap(long from, long to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Long2ObjectRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Long2ObjectRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Long2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Long2ObjectRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2ObjectRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Long2ObjectRBTreeMap.this.tree == null) return null;
/* 1441 */       Long2ObjectRBTreeMap.Entry e;
/*      */       Long2ObjectRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Long2ObjectRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Long2ObjectRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Long2ObjectRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Long2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2ObjectRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Long2ObjectRBTreeMap.this.tree == null) return null;
/* 1459 */       Long2ObjectRBTreeMap.Entry e;
/*      */       Long2ObjectRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Long2ObjectRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Long2ObjectRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Long2ObjectRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Long2ObjectRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1470 */       Long2ObjectRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1475 */       Long2ObjectRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1480 */       Long2ObjectRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1485 */       Long2ObjectRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2ObjectRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2ObjectRBTreeMap<V>.Submap.SubmapIterator
...
/* 1530 */       public Long2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Long2ObjectRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Long2ObjectRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Long2ObjectRBTreeMap.Submap.this.bottom) && (Long2ObjectRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Long2ObjectRBTreeMap.Submap.this.top) && (Long2ObjectRBTreeMap.this.compare(k, (this.prev = Long2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Long2ObjectRBTreeMap.this.locateKey(k);
/* 1507 */             if (Long2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Long2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2ObjectRBTreeMap.this.compare(this.prev.key, Long2ObjectRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Long2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Long2ObjectRBTreeMap.this.compare(this.next.key, Long2ObjectRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public LongBidirectionalIterator iterator() { return new Long2ObjectRBTreeMap.Submap.SubmapKeyIterator(Long2ObjectRBTreeMap.Submap.this); } 
/* 1340 */       public LongBidirectionalIterator iterator(long from) { return new Long2ObjectRBTreeMap.Submap.SubmapKeyIterator(Long2ObjectRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public LongBidirectionalIterator iterator() { return new Long2ObjectRBTreeMap.KeyIterator(Long2ObjectRBTreeMap.this); } 
/* 1178 */     public LongBidirectionalIterator iterator(long from) { return new Long2ObjectRBTreeMap.KeyIterator(Long2ObjectRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2ObjectRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2ObjectRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Long2ObjectMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1112 */     public Long2ObjectMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Long2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Long2ObjectRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1044 */       if ((this.next = Long2ObjectRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Long2ObjectRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Long2ObjectRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  969 */       return HashCommon.long2int(this.key) ^ (this.value == null ? 0 : this.value.hashCode());
/*      */     }
