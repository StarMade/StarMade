...
public class Long2ByteFunctions
{
  ...
  public static Long2ByteFunction synchronize(Long2ByteFunction local_f)
  {
    return new SynchronizedFunction(local_f);
  }
  
  public static Long2ByteFunction synchronize(Long2ByteFunction local_f, Object sync)
  {
    return new SynchronizedFunction(local_f, sync);
  }
  
  public static Long2ByteFunction unmodifiable(Long2ByteFunction local_f)
  {
    ...
    implements Serializable
  {
    ...
    protected UnmodifiableFunction(Long2ByteFunction local_f)
    {
      if (local_f == null) {
    ...
    implements Serializable
  {
    ...
    protected SynchronizedFunction(Long2ByteFunction local_f, Object sync)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
    ...
    protected SynchronizedFunction(Long2ByteFunction local_f)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
