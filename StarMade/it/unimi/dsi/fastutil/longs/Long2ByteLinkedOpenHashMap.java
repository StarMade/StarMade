...
/*   22:     */
/*  113:     */public class Long2ByteLinkedOpenHashMap
/*  114:     */  extends AbstractLong2ByteSortedMap
...
/*  127:     */  protected volatile transient Long2ByteSortedMap.FastSortedEntrySet entries;
...
/*  141:     */  
/*  149:     */  public Long2ByteLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Long2ByteLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Long2ByteLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Long2ByteLinkedOpenHashMap(Map<? extends Long, ? extends Byte> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Long2ByteLinkedOpenHashMap(Map<? extends Long, ? extends Byte> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Long2ByteLinkedOpenHashMap(Long2ByteMap m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Long2ByteLinkedOpenHashMap(Long2ByteMap m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Long2ByteLinkedOpenHashMap(long[] k, byte[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Long2ByteLinkedOpenHashMap(long[] k, byte[] v)
/*  225:     */  {
/*  226: 226 */    this(k, v, 0.75F);
/*  227:     */  }
/*  228:     */  
/*  232:     */  public byte put(long k, byte v)
/*  233:     */  {
...
/*  260:     */  }
/*  261:     */  
/*  262: 262 */  public Byte put(Long ok, Byte ov) { byte v = ov.byteValue();
...
/*  291:     */  }
/*  292:     */  
/*  303:     */  public byte add(long k, byte incr)
/*  304:     */  {
...
/*  310: 310 */          tmp49_47 = pos; byte[] tmp49_44 = this.value;tmp49_44[tmp49_47] = ((byte)(tmp49_44[tmp49_47] + incr));
...
/*  462:     */  }
/*  463:     */  
/*  467:     */  public byte getAndMoveToFirst(long k)
/*  468:     */  {
...
/*  483:     */  }
/*  484:     */  
/*  488:     */  public byte getAndMoveToLast(long k)
/*  489:     */  {
...
/*  504:     */  }
/*  505:     */  
/*  510:     */  public byte putAndMoveToFirst(long k, byte v)
/*  511:     */  {
...
/*  543:     */  }
/*  544:     */  
/*  549:     */  public byte putAndMoveToLast(long k, byte v)
/*  550:     */  {
...
/*  582:     */  }
/*  583:     */  
/*  584: 584 */  public Byte get(Long ok) { long k = ok.longValue();
/*  585:     */    
...
/*  660:     */    implements Long2ByteMap.Entry, Map.Entry<Long, Byte>
/*  661:     */  {
...
/*  667:     */    }
/*  668:     */    
/*  669: 669 */    public Long getKey() { return Long.valueOf(Long2ByteLinkedOpenHashMap.this.key[this.index]); }
/*  670:     */    
/*  671:     */    public long getLongKey() {
/*  672: 672 */      return Long2ByteLinkedOpenHashMap.this.key[this.index];
/*  673:     */    }
/*  674:     */    
/*  675: 675 */    public Byte getValue() { return Byte.valueOf(Long2ByteLinkedOpenHashMap.this.value[this.index]); }
/*  676:     */    
/*  678: 678 */    public byte getByteValue() { return Long2ByteLinkedOpenHashMap.this.value[this.index]; }
/*  679:     */    
/*  680:     */    public byte setValue(byte v) {
/*  681: 681 */      byte oldValue = Long2ByteLinkedOpenHashMap.this.value[this.index];
/*  682: 682 */      Long2ByteLinkedOpenHashMap.this.value[this.index] = v;
...
/*  691: 691 */      Map.Entry<Long, Byte> e = (Map.Entry)o;
/*  692: 692 */      return (Long2ByteLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*  693:     */    }
/*  694:     */    
/*  695: 695 */    public int hashCode() { return HashCommon.long2int(Long2ByteLinkedOpenHashMap.this.key[this.index]) ^ Long2ByteLinkedOpenHashMap.this.value[this.index]; }
/*  696:     */    
/*  697:     */    public String toString() {
/*  698: 698 */      return Long2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Long2ByteLinkedOpenHashMap.this.value[this.index];
/*  699:     */    }
/*  700:     */  }
/*  701:     */  
...
/*  786: 786 */  public Long2ByteSortedMap tailMap(long from) { throw new UnsupportedOperationException(); }
/*  787: 787 */  public Long2ByteSortedMap headMap(long to) { throw new UnsupportedOperationException(); }
/*  788: 788 */  public Long2ByteSortedMap subMap(long from, long to) { throw new UnsupportedOperationException(); }
/*  789:     */  
...
/*  803: 803 */    int index = -1;
/*  804:     */    
/*  805: 805 */    private MapIterator() { this.next = Long2ByteLinkedOpenHashMap.this.first;
/*  806: 806 */      this.index = 0;
/*  807:     */    }
/*  808:     */    
/*  809: 809 */    private MapIterator(long from) { if (Long2ByteLinkedOpenHashMap.this.key[Long2ByteLinkedOpenHashMap.this.last] == from) {
/*  810: 810 */        this.prev = Long2ByteLinkedOpenHashMap.this.last;
/*  811: 811 */        this.index = Long2ByteLinkedOpenHashMap.this.size;
/*  812:     */      }
/*  813:     */      else
/*  814:     */      {
/*  815: 815 */        int pos = (int)HashCommon.murmurHash3(from) & Long2ByteLinkedOpenHashMap.this.mask;
/*  816:     */        
/*  817: 817 */        while (Long2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  818: 818 */          if (Long2ByteLinkedOpenHashMap.this.key[pos] == from)
/*  819:     */          {
/*  820: 820 */            this.next = ((int)Long2ByteLinkedOpenHashMap.this.link[pos]);
/*  821: 821 */            this.prev = pos;
/*  822: 822 */            return;
/*  823:     */          }
/*  824: 824 */          pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*  825:     */        }
...
/*  838: 838 */        this.index = Long2ByteLinkedOpenHashMap.this.size;
/*  839: 839 */        return;
/*  840:     */      }
/*  841: 841 */      int pos = Long2ByteLinkedOpenHashMap.this.first;
/*  842: 842 */      this.index = 1;
/*  843: 843 */      while (pos != this.prev) {
/*  844: 844 */        pos = (int)Long2ByteLinkedOpenHashMap.this.link[pos];
...
/*  855:     */    }
/*  856:     */    
/*  857: 857 */    public int nextEntry() { if (!hasNext()) return Long2ByteLinkedOpenHashMap.this.size();
/*  858: 858 */      this.curr = this.next;
/*  859: 859 */      this.next = ((int)Long2ByteLinkedOpenHashMap.this.link[this.curr]);
...
/*  867: 867 */      this.prev = ((int)(Long2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  880: 880 */        this.prev = ((int)(Long2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  881:     */      }
/*  882:     */      else {
/*  883: 883 */        this.next = ((int)Long2ByteLinkedOpenHashMap.this.link[this.curr]); }
/*  884: 884 */      Long2ByteLinkedOpenHashMap.this.size -= 1;
/*  885:     */      
/*  887: 887 */      if (this.prev == -1) { Long2ByteLinkedOpenHashMap.this.first = this.next;
/*  888:     */      } else
/*  889: 889 */        Long2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Long2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890: 890 */      if (this.next == -1) { Long2ByteLinkedOpenHashMap.this.last = this.prev;
/*  891:     */      } else
/*  892: 892 */        Long2ByteLinkedOpenHashMap.this.link[this.next] ^= (Long2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  893: 893 */      int pos = this.curr;
/*  894:     */      int last;
/*  895:     */      for (;;) {
/*  896: 896 */        pos = (last = pos) + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*  897: 897 */        while (Long2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  898: 898 */          int slot = (int)HashCommon.murmurHash3(Long2ByteLinkedOpenHashMap.this.key[pos]) & Long2ByteLinkedOpenHashMap.this.mask;
/*  899: 899 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900: 900 */          pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*  901:     */        }
/*  902: 902 */        if (Long2ByteLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903: 903 */        Long2ByteLinkedOpenHashMap.this.key[last] = Long2ByteLinkedOpenHashMap.this.key[pos];
/*  904: 904 */        Long2ByteLinkedOpenHashMap.this.value[last] = Long2ByteLinkedOpenHashMap.this.value[pos];
/*  905: 905 */        if (this.next == pos) this.next = last;
/*  906: 906 */        if (this.prev == pos) this.prev = last;
/*  907: 907 */        Long2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*  908:     */      }
/*  909: 909 */      Long2ByteLinkedOpenHashMap.this.used[last] = false;
/*  910: 910 */      this.curr = -1;
/*  911:     */    }
/*  912:     */    
...
/*  921:     */    } }
/*  922:     */  
/*  923:     */  private class EntryIterator extends Long2ByteLinkedOpenHashMap.MapIterator implements ObjectListIterator<Long2ByteMap.Entry> { private Long2ByteLinkedOpenHashMap.MapEntry entry;
/*  924:     */    
/*  925: 925 */    public EntryIterator() { super(null); }
/*  926:     */    
/*  927: 927 */    public EntryIterator(long from) { super(from, null); }
/*  928:     */    
/*  929:     */    public Long2ByteLinkedOpenHashMap.MapEntry next() {
/*  930: 930 */      return this.entry = new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this, nextEntry());
/*  931:     */    }
/*  932:     */    
/*  933: 933 */    public Long2ByteLinkedOpenHashMap.MapEntry previous() { return this.entry = new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this, previousEntry()); }
/*  934:     */    
/*  935:     */    public void remove()
/*  936:     */    {
/*  937: 937 */      super.remove();
/*  938: 938 */      Long2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  939:     */    
/*  940: 940 */    public void set(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  941: 941 */    public void add(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  942:     */  }
/*  943:     */  
/*  944: 944 */  private class FastEntryIterator extends Long2ByteLinkedOpenHashMap.MapIterator implements ObjectListIterator<Long2ByteMap.Entry> { final AbstractLong2ByteMap.BasicEntry entry = new AbstractLong2ByteMap.BasicEntry(0L, (byte)0);
/*  945: 945 */    public FastEntryIterator() { super(null); }
/*  946:     */    
/*  947: 947 */    public FastEntryIterator(long from) { super(from, null); }
/*  948:     */    
/*  949:     */    public AbstractLong2ByteMap.BasicEntry next() {
/*  950: 950 */      int e = nextEntry();
/*  951: 951 */      this.entry.key = Long2ByteLinkedOpenHashMap.this.key[e];
/*  952: 952 */      this.entry.value = Long2ByteLinkedOpenHashMap.this.value[e];
/*  953: 953 */      return this.entry;
/*  954:     */    }
/*  955:     */    
/*  956: 956 */    public AbstractLong2ByteMap.BasicEntry previous() { int e = previousEntry();
/*  957: 957 */      this.entry.key = Long2ByteLinkedOpenHashMap.this.key[e];
/*  958: 958 */      this.entry.value = Long2ByteLinkedOpenHashMap.this.value[e];
/*  959: 959 */      return this.entry; }
/*  960:     */    
/*  961: 961 */    public void set(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  962: 962 */    public void add(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } }
/*  963:     */  
/*  964:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Long2ByteMap.Entry> implements Long2ByteSortedMap.FastSortedEntrySet { private MapEntrySet() {}
/*  965:     */    
/*  966: 966 */    public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator() { return new Long2ByteLinkedOpenHashMap.EntryIterator(Long2ByteLinkedOpenHashMap.this); }
/*  967:     */    
/*  968: 968 */    public Comparator<? super Long2ByteMap.Entry> comparator() { return null; }
/*  969: 969 */    public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry fromElement, Long2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  970: 970 */    public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  971: 971 */    public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry fromElement) { throw new UnsupportedOperationException(); }
/*  972:     */    
/*  973: 973 */    public Long2ByteMap.Entry first() { if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974: 974 */      return new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this, Long2ByteLinkedOpenHashMap.this.first);
/*  975:     */    }
/*  976:     */    
/*  977: 977 */    public Long2ByteMap.Entry last() { if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978: 978 */      return new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this, Long2ByteLinkedOpenHashMap.this.last);
/*  979:     */    }
/*  980:     */    
/*  981:     */    public boolean contains(Object o) {
/*  982: 982 */      if (!(o instanceof Map.Entry)) return false;
/*  983: 983 */      Map.Entry<Long, Byte> e = (Map.Entry)o;
/*  984: 984 */      long k = ((Long)e.getKey()).longValue();
/*  985:     */      
/*  986: 986 */      int pos = (int)HashCommon.murmurHash3(k) & Long2ByteLinkedOpenHashMap.this.mask;
/*  987:     */      
/*  988: 988 */      while (Long2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  989: 989 */        if (Long2ByteLinkedOpenHashMap.this.key[pos] == k) return Long2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/*  990: 990 */        pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*  991:     */      }
...
/*  997: 997 */      Map.Entry<Long, Byte> e = (Map.Entry)o;
/*  998: 998 */      long k = ((Long)e.getKey()).longValue();
/*  999:     */      
/* 1000:1000 */      int pos = (int)HashCommon.murmurHash3(k) & Long2ByteLinkedOpenHashMap.this.mask;
/* 1001:     */      
/* 1002:1002 */      while (Long2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003:1003 */        if (Long2ByteLinkedOpenHashMap.this.key[pos] == k) {
/* 1004:1004 */          Long2ByteLinkedOpenHashMap.this.remove(e.getKey());
/* 1005:1005 */          return true;
/* 1006:     */        }
/* 1007:1007 */        pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/* 1008:     */      }
/* 1009:1009 */      return false;
/* 1010:     */    }
/* 1011:     */    
/* 1012:1012 */    public int size() { return Long2ByteLinkedOpenHashMap.this.size; }
/* 1013:     */    
/* 1014:     */    public void clear() {
/* 1015:1015 */      Long2ByteLinkedOpenHashMap.this.clear();
/* 1016:     */    }
/* 1017:     */    
/* 1018:1018 */    public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry from) { return new Long2ByteLinkedOpenHashMap.EntryIterator(Long2ByteLinkedOpenHashMap.this, ((Long)from.getKey()).longValue()); }
/* 1019:     */    
/* 1020:     */    public ObjectBidirectionalIterator<Long2ByteMap.Entry> fastIterator() {
/* 1021:1021 */      return new Long2ByteLinkedOpenHashMap.FastEntryIterator(Long2ByteLinkedOpenHashMap.this);
/* 1022:     */    }
/* 1023:     */    
/* 1024:1024 */    public ObjectBidirectionalIterator<Long2ByteMap.Entry> fastIterator(Long2ByteMap.Entry from) { return new Long2ByteLinkedOpenHashMap.FastEntryIterator(Long2ByteLinkedOpenHashMap.this, ((Long)from.getKey()).longValue()); }
/* 1025:     */  }
/* 1026:     */  
/* 1027:     */  public Long2ByteSortedMap.FastSortedEntrySet long2ByteEntrySet() {
...
/* 1035:     */    extends Long2ByteLinkedOpenHashMap.MapIterator
/* 1036:     */    implements LongListIterator
/* 1037:     */  {
/* 1038:1038 */    public KeyIterator(long k) { super(k, null); }
/* 1039:1039 */    public long previousLong() { return Long2ByteLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1042:1042 */    public Long previous() { return Long.valueOf(Long2ByteLinkedOpenHashMap.this.key[previousEntry()]); }
...
/* 1046:1046 */    public long nextLong() { return Long2ByteLinkedOpenHashMap.this.key[nextEntry()]; }
/* 1047:1047 */    public Long next() { return Long.valueOf(Long2ByteLinkedOpenHashMap.this.key[nextEntry()]); } }
/* 1048:     */  
/* 1049:     */  private final class KeySet extends AbstractLongSortedSet { private KeySet() {}
/* 1050:     */    
/* 1051:1051 */    public LongListIterator iterator(long from) { return new Long2ByteLinkedOpenHashMap.KeyIterator(Long2ByteLinkedOpenHashMap.this, from); }
/* 1052:     */    
/* 1053:     */    public LongListIterator iterator() {
/* 1054:1054 */      return new Long2ByteLinkedOpenHashMap.KeyIterator(Long2ByteLinkedOpenHashMap.this);
/* 1055:     */    }
/* 1056:     */    
/* 1057:1057 */    public int size() { return Long2ByteLinkedOpenHashMap.this.size; }
/* 1058:     */    
/* 1060:1060 */    public boolean contains(long k) { return Long2ByteLinkedOpenHashMap.this.containsKey(k); }
/* 1061:     */    
/* 1062:     */    public boolean remove(long k) {
/* 1063:1063 */      int oldSize = Long2ByteLinkedOpenHashMap.this.size;
/* 1064:1064 */      Long2ByteLinkedOpenHashMap.this.remove(k);
/* 1065:1065 */      return Long2ByteLinkedOpenHashMap.this.size != oldSize;
/* 1066:     */    }
/* 1067:     */    
/* 1068:1068 */    public void clear() { Long2ByteLinkedOpenHashMap.this.clear(); }
/* 1069:     */    
/* 1070:     */    public long firstLong() {
/* 1071:1071 */      if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072:1072 */      return Long2ByteLinkedOpenHashMap.this.key[Long2ByteLinkedOpenHashMap.this.first];
/* 1073:     */    }
/* 1074:     */    
/* 1075:1075 */    public long lastLong() { if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076:1076 */      return Long2ByteLinkedOpenHashMap.this.key[Long2ByteLinkedOpenHashMap.this.last]; }
/* 1077:     */    
...
/* 1091:     */    extends Long2ByteLinkedOpenHashMap.MapIterator
/* 1092:     */    implements ByteListIterator
/* 1093:     */  {
/* 1094:1094 */    public byte previousByte() { return Long2ByteLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1095:1095 */    public Byte previous() { return Byte.valueOf(Long2ByteLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1101:1101 */    public byte nextByte() { return Long2ByteLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1102:1102 */    public Byte next() { return Byte.valueOf(Long2ByteLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1103:     */  }
/* 1104:     */  
...
/* 1107:1107 */          return new Long2ByteLinkedOpenHashMap.ValueIterator(Long2ByteLinkedOpenHashMap.this);
/* 1108:     */        }
/* 1109:     */        
/* 1110:1110 */        public int size() { return Long2ByteLinkedOpenHashMap.this.size; }
/* 1111:     */        
/* 1112:     */        public boolean contains(byte v) {
/* 1113:1113 */          return Long2ByteLinkedOpenHashMap.this.containsValue(v);
/* 1114:     */        }
/* 1115:     */        
/* 1116:1116 */        public void clear() { Long2ByteLinkedOpenHashMap.this.clear(); }
/* 1117:     */      };
/* 1118:     */    }
...
/* 1238:     */  }
/* 1239:     */  
/* 1242:     */  public Long2ByteLinkedOpenHashMap clone()
/* 1243:     */  {
/* 1244:     */    Long2ByteLinkedOpenHashMap c;
/* 1245:     */    
/* 1247:     */    try
/* 1248:     */    {
/* 1249:1249 */      c = (Long2ByteLinkedOpenHashMap)super.clone();
/* 1250:     */    }
