...
/*      */         int tmp49_47 = pos;
/*      */         byte[] tmp49_44 = this.value; tmp49_44[tmp49_47] = ((byte)(tmp49_44[tmp49_47] + incr));
/*  311 */         return tmp49_47;
/*      */       }
...
/*  381 */         this.size -= 1;
/*  382 */         fixPointers(pos);
/*  383 */         byte v = this.value[pos];
/*  384 */         shiftKeys(pos);
/*  385 */         return Byte.valueOf(v);
/*      */       }
...
/*  519 */       if (k == key[pos]) {
/*  520 */         byte oldValue = this.value[pos];
...
/*  558 */       if (k == key[pos]) {
/*  559 */         byte oldValue = this.value[pos];
...
/*  589 */       if (this.key[pos] == k) return Byte.valueOf(this.value[pos]);
...
/*  786 */   public Long2ByteSortedMap tailMap(long from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Long2ByteSortedMap headMap(long to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Long2ByteSortedMap subMap(long from, long to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/*      */   {
/* 1105 */     if (this.values == null) this.values = new AbstractByteCollection() {
/*      */         public ByteIterator iterator() {
/* 1107 */           return new Long2ByteLinkedOpenHashMap.ValueIterator(Long2ByteLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Long2ByteLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(byte v) {
/* 1113 */           return Long2ByteLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Long2ByteLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/* 1200 */     byte[] newValue = new byte[newN];
...
/*      */     try
/*      */     {
/* 1249 */       c = (Long2ByteLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1258 */     c.value = ((byte[])this.value.clone());
...
/* 1301 */     byte[] value = this.value = new byte[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public byte previousByte()
/*      */     {
/* 1094 */       return Long2ByteLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Byte previous() { return Byte.valueOf(Long2ByteLinkedOpenHashMap.this.value[previousEntry()]); } 
/* 1096 */     public void set(Byte ok) { throw new UnsupportedOperationException(); } 
/* 1097 */     public void add(Byte ok) { throw new UnsupportedOperationException(); } 
/* 1098 */     public void set(byte v) { throw new UnsupportedOperationException(); } 
/* 1099 */     public void add(byte v) { throw new UnsupportedOperationException(); } 
/* 1100 */     public ValueIterator() { super(null); } 
/* 1101 */     public byte nextByte() { return Long2ByteLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Byte next() { return Byte.valueOf(Long2ByteLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Long2ByteLinkedOpenHashMap.KeyIterator(Long2ByteLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public LongListIterator iterator() {
/* 1054 */       return new Long2ByteLinkedOpenHashMap.KeyIterator(Long2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Long2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(long k) {
/* 1060 */       return Long2ByteLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(long k) {
/* 1063 */       int oldSize = Long2ByteLinkedOpenHashMap.this.size;
/* 1064 */       Long2ByteLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Long2ByteLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Long2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public long firstLong() {
/* 1071 */       if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Long2ByteLinkedOpenHashMap.this.key[Long2ByteLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public long lastLong() {
/* 1075 */       if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Long2ByteLinkedOpenHashMap.this.key[Long2ByteLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2ByteLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator(long k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public long previousLong() { return Long2ByteLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Long previous() { return Long.valueOf(Long2ByteLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public long nextLong() { return Long2ByteLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Long next() { return Long.valueOf(Long2ByteLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Long2ByteLinkedOpenHashMap.EntryIterator(Long2ByteLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Long2ByteMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Long2ByteMap.Entry> subSet(Long2ByteMap.Entry fromElement, Long2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Long2ByteMap.Entry> headSet(Long2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Long2ByteMap.Entry> tailSet(Long2ByteMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Long2ByteMap.Entry first() {
/*  973 */       if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this, Long2ByteLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Long2ByteMap.Entry last() {
/*  977 */       if (Long2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this, Long2ByteLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Long2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Long2ByteLinkedOpenHashMap.this.key[pos] == k) return Long2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/*  990 */         pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = (int)HashCommon.murmurHash3(k) & Long2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Long2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Long2ByteLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Long2ByteLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Long2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Long2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2ByteMap.Entry> iterator(Long2ByteMap.Entry from) {
/* 1018 */       return new Long2ByteLinkedOpenHashMap.EntryIterator(Long2ByteLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2ByteMap.Entry> fastIterator() {
/* 1021 */       return new Long2ByteLinkedOpenHashMap.FastEntryIterator(Long2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2ByteMap.Entry> fastIterator(Long2ByteMap.Entry from) {
/* 1024 */       return new Long2ByteLinkedOpenHashMap.FastEntryIterator(Long2ByteLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Long2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2ByteMap.Entry>
/*      */   {
/*  944 */     final AbstractLong2ByteMap.BasicEntry entry = new AbstractLong2ByteMap.BasicEntry(0L, (byte)0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Long2ByteLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Long2ByteLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractLong2ByteMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Long2ByteLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Long2ByteLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2ByteMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Long2ByteLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Long2ByteLinkedOpenHashMap.MapEntry(Long2ByteLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Long2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Long2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Long2ByteLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(long from) {
/*  809 */       if (Long2ByteLinkedOpenHashMap.this.key[Long2ByteLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Long2ByteLinkedOpenHashMap.this.last;
/*  811 */         this.index = Long2ByteLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = (int)HashCommon.murmurHash3(from) & Long2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Long2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Long2ByteLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Long2ByteLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Long2ByteLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Long2ByteLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Long2ByteLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Long2ByteLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Long2ByteLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Long2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Long2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Long2ByteLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Long2ByteLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Long2ByteLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Long2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Long2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Long2ByteLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Long2ByteLinkedOpenHashMap.this.link[this.next] ^= (Long2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*  897 */         while (Long2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = (int)HashCommon.murmurHash3(Long2ByteLinkedOpenHashMap.this.key[pos]) & Long2ByteLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Long2ByteLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Long2ByteLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Long2ByteLinkedOpenHashMap.this.key[last] = Long2ByteLinkedOpenHashMap.this.key[pos];
/*  904 */         Long2ByteLinkedOpenHashMap.this.value[last] = Long2ByteLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Long2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Long2ByteLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Long getKey() {
/*  669 */       return Long.valueOf(Long2ByteLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public long getLongKey() {
/*  672 */       return Long2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Byte getValue() {
/*  675 */       return Byte.valueOf(Long2ByteLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public byte getByteValue() {
/*  678 */       return Long2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public byte setValue(byte v) {
/*  681 */       byte oldValue = Long2ByteLinkedOpenHashMap.this.value[this.index];
/*  682 */       Long2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Byte setValue(Byte v) {
/*  686 */       return Byte.valueOf(setValue(v.byteValue()));
/*      */     }
/*      */ 
/*      */     public boolean equals(Object o) {
/*  690 */       if (!(o instanceof Map.Entry)) return false;
/*  691 */       Map.Entry e = (Map.Entry)o;
/*  692 */       return (Long2ByteLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.long2int(Long2ByteLinkedOpenHashMap.this.key[this.index]) ^ Long2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Long2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Long2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
