  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2IntAVLTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2IntAVLTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2IntAVLTreeMap(Map<? extends Long, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2IntAVLTreeMap(SortedMap<Long, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2IntAVLTreeMap(Long2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2IntAVLTreeMap(Long2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2IntAVLTreeMap(long[] local_k, int[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2IntAVLTreeMap(long[] local_k, int[] local_v)
  {
  ...
  {
    int oldValue = put(local_ok.longValue(), local_ov.intValue());
    return this.modified ? null : Integer.valueOf(oldValue);
  }
  
  public Integer remove(Object local_ok)
  {
    int oldValue = remove(((Long)local_ok).longValue());
  ...
  public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Long2IntMap.Entry> comparator = new Comparator()
        {
          public int compare(Long2IntMap.Entry local_x, Long2IntMap.Entry local_y)
          {
            return Long2IntAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2IntAVLTreeMap.EntryIterator(Long2IntAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry from)
        {
          return new Long2IntAVLTreeMap.EntryIterator(Long2IntAVLTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2IntAVLTreeMap.Entry local_f = Long2IntAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2IntAVLTreeMap.Entry local_f = Long2IntAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2IntAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry from, Long2IntMap.Entry local_to)
        {
          return Long2IntAVLTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2IntEntrySet();
        }
        
        public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry local_to)
        {
          return Long2IntAVLTreeMap.this.headMap((Long)local_to.getKey()).long2IntEntrySet();
        }
        
        public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry from)
        {
          return Long2IntAVLTreeMap.this.tailMap((Long)from.getKey()).long2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Long2IntAVLTreeMap.ValueIterator(Long2IntAVLTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Long2IntAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2IntAVLTreeMap local_c;
    try
    {
      local_c = (Long2IntAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readLong(), local_s.readInt());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readLong(), local_s.readInt());
      top.right(new Entry(local_s.readLong(), local_s.readInt()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2IntAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2IntAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2IntAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2IntMap.Entry> long2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator()
          {
            return new Long2IntAVLTreeMap.Submap.SubmapEntryIterator(Long2IntAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry from)
          {
            return new Long2IntAVLTreeMap.Submap.SubmapEntryIterator(Long2IntAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Integer> local_e = (Map.Entry)local_o;
            Long2IntAVLTreeMap.Entry local_f = Long2IntAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2IntAVLTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Integer> local_e = (Map.Entry)local_o;
            Long2IntAVLTreeMap.Entry local_f = Long2IntAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2IntAVLTreeMap.Submap.this.in1(local_f.key))) {
              Long2IntAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2IntAVLTreeMap.Submap.SubmapIterator(Long2IntAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2IntAVLTreeMap.Submap.this.clear();
          }
          
          public Long2IntMap.Entry first()
          {
            return Long2IntAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Long2IntMap.Entry last()
          {
            return Long2IntAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry from, Long2IntMap.Entry local_to)
          {
            return Long2IntAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2IntEntrySet();
          }
          
          public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry local_to)
          {
            return Long2IntAVLTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2IntEntrySet();
          }
          
          public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry from)
          {
            return Long2IntAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Long2IntAVLTreeMap.Submap.SubmapValueIterator(Long2IntAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Long2IntAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2IntAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2IntAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2IntAVLTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2IntAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(long local_k, int local_v)
    {
      ...
      int oldValue = Long2IntAVLTreeMap.this.put(local_k, local_v);
    ...
    public int remove(long local_k)
    {
      ...
      int oldValue = Long2IntAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2IntAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2IntAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2IntSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2IntAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2IntAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2IntSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2IntAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2IntAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2IntAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2IntAVLTreeMap.this.locateKey(this.from);
        if (Long2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2IntAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2IntAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2IntAVLTreeMap.this.locateKey(this.field_47);
        if (Long2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2IntAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2IntAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Long2IntAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2IntAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2IntAVLTreeMap.Submap.this.bottom) && (Long2IntAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2IntAVLTreeMap.Submap.this.top) && (Long2IntAVLTreeMap.this.compare(local_k, (this.prev = Long2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2IntAVLTreeMap.this.locateKey(local_k);
            if (Long2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2IntAVLTreeMap.this.compare(this.prev.key, Long2IntAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2IntAVLTreeMap.this.compare(this.next.key, Long2IntAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2IntSortedMap.KeySet
    {
      ...
      {
        return new Long2IntAVLTreeMap.Submap.SubmapKeyIterator(Long2IntAVLTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2IntAVLTreeMap.Submap.SubmapKeyIterator(Long2IntAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2IntSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2IntAVLTreeMap.KeyIterator(Long2IntAVLTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2IntAVLTreeMap.KeyIterator(Long2IntAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2IntAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Long2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Long2IntMap.Entry
  {
    ...
    Entry(long local_k, int local_v)
    {
      this.key = local_k;
      this.value = local_v;
