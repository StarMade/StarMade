...
/*  786 */   public Long2IntSortedMap tailMap(long from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Long2IntSortedMap headMap(long to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Long2IntSortedMap subMap(long from, long to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Long2IntLinkedOpenHashMap.ValueIterator(Long2IntLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Long2IntLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(int v) {
/* 1113 */           return Long2IntLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Long2IntLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Long2IntLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2IntLinkedOpenHashMap.MapIterator
/*      */     implements IntListIterator
/*      */   {
/*      */     public int previousInt()
/*      */     {
/* 1094 */       return Long2IntLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Integer previous() { return Integer.valueOf(Long2IntLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public int nextInt() { return Long2IntLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Integer next() { return Integer.valueOf(Long2IntLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Long2IntLinkedOpenHashMap.KeyIterator(Long2IntLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public LongListIterator iterator() {
/* 1054 */       return new Long2IntLinkedOpenHashMap.KeyIterator(Long2IntLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Long2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(long k) {
/* 1060 */       return Long2IntLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(long k) {
/* 1063 */       int oldSize = Long2IntLinkedOpenHashMap.this.size;
/* 1064 */       Long2IntLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Long2IntLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Long2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public long firstLong() {
/* 1071 */       if (Long2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Long2IntLinkedOpenHashMap.this.key[Long2IntLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public long lastLong() {
/* 1075 */       if (Long2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Long2IntLinkedOpenHashMap.this.key[Long2IntLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2IntLinkedOpenHashMap.MapIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator(long k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public long previousLong() { return Long2IntLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Long previous() { return Long.valueOf(Long2IntLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public long nextLong() { return Long2IntLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Long next() { return Long.valueOf(Long2IntLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Long2IntMap.Entry>
...
/*      */     {
/*  966 */       return new Long2IntLinkedOpenHashMap.EntryIterator(Long2IntLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Long2IntMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Long2IntMap.Entry> subSet(Long2IntMap.Entry fromElement, Long2IntMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Long2IntMap.Entry> headSet(Long2IntMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Long2IntMap.Entry> tailSet(Long2IntMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Long2IntMap.Entry first() {
/*  973 */       if (Long2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Long2IntLinkedOpenHashMap.MapEntry(Long2IntLinkedOpenHashMap.this, Long2IntLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Long2IntMap.Entry last() {
/*  977 */       if (Long2IntLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Long2IntLinkedOpenHashMap.MapEntry(Long2IntLinkedOpenHashMap.this, Long2IntLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = (int)HashCommon.murmurHash3(k) & Long2IntLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Long2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Long2IntLinkedOpenHashMap.this.key[pos] == k) return Long2IntLinkedOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/*  990 */         pos = pos + 1 & Long2IntLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = (int)HashCommon.murmurHash3(k) & Long2IntLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Long2IntLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Long2IntLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Long2IntLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Long2IntLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Long2IntLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Long2IntLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2IntMap.Entry> iterator(Long2IntMap.Entry from) {
/* 1018 */       return new Long2IntLinkedOpenHashMap.EntryIterator(Long2IntLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2IntMap.Entry> fastIterator() {
/* 1021 */       return new Long2IntLinkedOpenHashMap.FastEntryIterator(Long2IntLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Long2IntMap.Entry> fastIterator(Long2IntMap.Entry from) {
/* 1024 */       return new Long2IntLinkedOpenHashMap.FastEntryIterator(Long2IntLinkedOpenHashMap.this, ((Long)from.getKey()).longValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Long2IntLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2IntMap.Entry>
/*      */   {
/*  944 */     final AbstractLong2IntMap.BasicEntry entry = new AbstractLong2IntMap.BasicEntry(0L, 0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Long2IntLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Long2IntLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractLong2IntMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Long2IntLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Long2IntLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2IntLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Long2IntMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Long2IntLinkedOpenHashMap.MapEntry(Long2IntLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Long2IntLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Long2IntLinkedOpenHashMap.MapEntry(Long2IntLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Long2IntLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Long2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Long2IntLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(long from) {
/*  809 */       if (Long2IntLinkedOpenHashMap.this.key[Long2IntLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Long2IntLinkedOpenHashMap.this.last;
/*  811 */         this.index = Long2IntLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = (int)HashCommon.murmurHash3(from) & Long2IntLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Long2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Long2IntLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Long2IntLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Long2IntLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Long2IntLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Long2IntLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Long2IntLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Long2IntLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Long2IntLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Long2IntLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Long2IntLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Long2IntLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Long2IntLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Long2IntLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Long2IntLinkedOpenHashMap.this.link[this.prev] ^= (Long2IntLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Long2IntLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Long2IntLinkedOpenHashMap.this.link[this.next] ^= (Long2IntLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Long2IntLinkedOpenHashMap.this.mask;
/*  897 */         while (Long2IntLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = (int)HashCommon.murmurHash3(Long2IntLinkedOpenHashMap.this.key[pos]) & Long2IntLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Long2IntLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Long2IntLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Long2IntLinkedOpenHashMap.this.key[last] = Long2IntLinkedOpenHashMap.this.key[pos];
/*  904 */         Long2IntLinkedOpenHashMap.this.value[last] = Long2IntLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Long2IntLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Long2IntLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Long getKey() {
/*  669 */       return Long.valueOf(Long2IntLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public long getLongKey() {
/*  672 */       return Long2IntLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Integer getValue() {
/*  675 */       return Integer.valueOf(Long2IntLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public int getIntValue() {
/*  678 */       return Long2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public int setValue(int v) {
/*  681 */       int oldValue = Long2IntLinkedOpenHashMap.this.value[this.index];
/*  682 */       Long2IntLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
...
/*  692 */       return (Long2IntLinkedOpenHashMap.this.key[this.index] == ((Long)e.getKey()).longValue()) && (Long2IntLinkedOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return HashCommon.long2int(Long2IntLinkedOpenHashMap.this.key[this.index]) ^ Long2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Long2IntLinkedOpenHashMap.this.key[this.index] + "=>" + Long2IntLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
