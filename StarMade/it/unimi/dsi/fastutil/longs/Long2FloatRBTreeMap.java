...
/*      */ 
/*      */ public class Long2FloatRBTreeMap extends AbstractLong2FloatSortedMap
...
/*  119 */           return Long2FloatRBTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  122 */           return Long2FloatRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     float oldValue = put(ok.longValue(), ov.floatValue());
/*  731 */     return this.modified ? null : Float.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Float remove(Object ok)
/*      */   {
/*  737 */     float oldValue = remove(((Long)ok).longValue());
...
/* 1141 */         final Comparator<? super Long2FloatMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Long2FloatMap.Entry x, Long2FloatMap.Entry y) {
/* 1143 */             return Long2FloatRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Long2FloatRBTreeMap.EntryIterator(Long2FloatRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from) {
/* 1153 */           return new Long2FloatRBTreeMap.EntryIterator(Long2FloatRBTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Long2FloatRBTreeMap.Entry f = Long2FloatRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1166 */           Long2FloatRBTreeMap.Entry f = Long2FloatRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1167 */           if (f != null) Long2FloatRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Long2FloatRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Long2FloatRBTreeMap.this.clear(); } 
/* 1172 */         public Long2FloatMap.Entry first() { return Long2FloatRBTreeMap.this.firstEntry; } 
/* 1173 */         public Long2FloatMap.Entry last() { return Long2FloatRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) { return Long2FloatRBTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2FloatEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry to) { return Long2FloatRBTreeMap.this.headMap((Long)to.getKey()).long2FloatEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from) { return Long2FloatRBTreeMap.this.tailMap((Long)from.getKey()).long2FloatEntrySet(); }
/*      */       };
...
/* 1242 */           return new Long2FloatRBTreeMap.ValueIterator(Long2FloatRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(float k) {
/* 1245 */           return Long2FloatRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Long2FloatRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Long2FloatRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Long2FloatRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readLong(), s.readFloat());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readLong(), s.readFloat());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readLong(), s.readFloat()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Long2FloatRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Long2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator() {
/* 1329 */             return new Long2FloatRBTreeMap.Submap.SubmapEntryIterator(Long2FloatRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2FloatMap.Entry> iterator(Long2FloatMap.Entry from) {
/* 1332 */             return new Long2FloatRBTreeMap.Submap.SubmapEntryIterator(Long2FloatRBTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1334 */           public Comparator<? super Long2FloatMap.Entry> comparator() { return Long2FloatRBTreeMap.this.long2FloatEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Long2FloatRBTreeMap.Entry f = Long2FloatRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1340 */             return (f != null) && (Long2FloatRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Long2FloatRBTreeMap.Entry f = Long2FloatRBTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1347 */             if ((f != null) && (Long2FloatRBTreeMap.Submap.this.in(f.key))) Long2FloatRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Long2FloatRBTreeMap.Submap.SubmapIterator(Long2FloatRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Long2FloatRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Long2FloatMap.Entry first() { return Long2FloatRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Long2FloatMap.Entry last() { return Long2FloatRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Long2FloatMap.Entry> subSet(Long2FloatMap.Entry from, Long2FloatMap.Entry to) { return Long2FloatRBTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2FloatEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Long2FloatMap.Entry> headSet(Long2FloatMap.Entry to) { return Long2FloatRBTreeMap.Submap.this.headMap((Long)to.getKey()).long2FloatEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Long2FloatMap.Entry> tailSet(Long2FloatMap.Entry from) { return Long2FloatRBTreeMap.Submap.this.tailMap((Long)from.getKey()).long2FloatEntrySet(); }
/*      */         };
...
/*      */           public FloatIterator iterator() {
/* 1376 */             return new Long2FloatRBTreeMap.Submap.SubmapValueIterator(Long2FloatRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(float k) {
/* 1379 */             return Long2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Long2FloatRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Long2FloatRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1392 */       return (in(k)) && (Long2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(float v) {
...
/* 1407 */       return (in(kk)) && ((e = Long2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public float put(long k, float v) {
/* 1410 */       Long2FloatRBTreeMap.this.modified = false;
...
/* 1412 */       float oldValue = Long2FloatRBTreeMap.this.put(k, v);
/* 1413 */       return Long2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Float put(Long ok, Float ov) {
/* 1416 */       float oldValue = put(ok.longValue(), ov.floatValue());
/* 1417 */       return Long2FloatRBTreeMap.this.modified ? null : Float.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public float remove(long k) {
/* 1421 */       Long2FloatRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       float oldValue = Long2FloatRBTreeMap.this.remove(k);
/* 1424 */       return Long2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Float remove(Object ok) {
/* 1427 */       float oldValue = remove(((Long)ok).longValue());
/* 1428 */       return Long2FloatRBTreeMap.this.modified ? Float.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1443 */       return Long2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2FloatSortedMap headMap(long to) {
/* 1446 */       if (this.top) return new Submap(Long2FloatRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Long2FloatRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2FloatRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2FloatSortedMap tailMap(long from) {
/* 1450 */       if (this.bottom) return new Submap(Long2FloatRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Long2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2FloatRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2FloatSortedMap subMap(long from, long to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Long2FloatRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Long2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Long2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Long2FloatRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2FloatRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Long2FloatRBTreeMap.this.tree == null) return null;
/* 1468 */       Long2FloatRBTreeMap.Entry e;
/*      */       Long2FloatRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Long2FloatRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Long2FloatRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Long2FloatRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Long2FloatRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2FloatRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Long2FloatRBTreeMap.this.tree == null) return null;
/* 1486 */       Long2FloatRBTreeMap.Entry e;
/*      */       Long2FloatRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Long2FloatRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Long2FloatRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Long2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Long2FloatRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1497 */       Long2FloatRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1502 */       Long2FloatRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1507 */       Long2FloatRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1512 */       Long2FloatRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2FloatRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2FloatRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2FloatRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Long2FloatMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Long2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Long2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Long2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Long2FloatRBTreeMap.Submap.this.bottom) && (Long2FloatRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Long2FloatRBTreeMap.Submap.this.top) && (Long2FloatRBTreeMap.this.compare(k, (this.prev = Long2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Long2FloatRBTreeMap.this.locateKey(k);
/* 1534 */             if (Long2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Long2FloatRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2FloatRBTreeMap.this.compare(this.prev.key, Long2FloatRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Long2FloatRBTreeMap.Submap.this.top) && (this.next != null) && (Long2FloatRBTreeMap.this.compare(this.next.key, Long2FloatRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public LongBidirectionalIterator iterator() { return new Long2FloatRBTreeMap.Submap.SubmapKeyIterator(Long2FloatRBTreeMap.Submap.this); } 
/* 1367 */       public LongBidirectionalIterator iterator(long from) { return new Long2FloatRBTreeMap.Submap.SubmapKeyIterator(Long2FloatRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2FloatRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public LongBidirectionalIterator iterator() { return new Long2FloatRBTreeMap.KeyIterator(Long2FloatRBTreeMap.this); } 
/* 1201 */     public LongBidirectionalIterator iterator(long from) { return new Long2FloatRBTreeMap.KeyIterator(Long2FloatRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2FloatRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2FloatRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Long2FloatMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Long2FloatMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Long2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Long2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Long2FloatRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1067 */       if ((this.next = Long2FloatRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Long2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Long2FloatRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == ((Float)e.getValue()).floatValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/*  983 */       return HashCommon.long2int(this.key) ^ HashCommon.float2int(this.value);
/*      */     }
/*      */ 
