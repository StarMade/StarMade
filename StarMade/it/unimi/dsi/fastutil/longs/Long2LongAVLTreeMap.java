...
/*      */ 
/*      */ public class Long2LongAVLTreeMap extends AbstractLong2LongSortedMap
...
/*  117 */           return Long2LongAVLTreeMap.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  120 */           return Long2LongAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     long oldValue = put(ok.longValue(), ov.longValue());
/*  780 */     return this.modified ? null : Long.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Long remove(Object ok)
/*      */   {
/*  788 */     long oldValue = remove(((Long)ok).longValue());
...
/* 1203 */         final Comparator<? super Long2LongMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Long2LongMap.Entry x, Long2LongMap.Entry y) {
/* 1205 */             return Long2LongAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Long2LongAVLTreeMap.EntryIterator(Long2LongAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from) {
/* 1215 */           return new Long2LongAVLTreeMap.EntryIterator(Long2LongAVLTreeMap.this, ((Long)from.getKey()).longValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Long2LongAVLTreeMap.Entry f = Long2LongAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
...
/* 1228 */           Long2LongAVLTreeMap.Entry f = Long2LongAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1229 */           if (f != null) Long2LongAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Long2LongAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Long2LongAVLTreeMap.this.clear(); } 
/* 1234 */         public Long2LongMap.Entry first() { return Long2LongAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Long2LongMap.Entry last() { return Long2LongAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) { return Long2LongAVLTreeMap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2LongEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry to) { return Long2LongAVLTreeMap.this.headMap((Long)to.getKey()).long2LongEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from) { return Long2LongAVLTreeMap.this.tailMap((Long)from.getKey()).long2LongEntrySet(); }
/*      */       };
...
/* 1304 */           return new Long2LongAVLTreeMap.ValueIterator(Long2LongAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(long k) {
/* 1307 */           return Long2LongAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Long2LongAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Long2LongAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Long2LongAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readLong(), s.readLong());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readLong(), s.readLong());
/* 1759 */       top.right(new Entry(s.readLong(), s.readLong()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Long2LongAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Long2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Long2LongAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Long2LongAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator() {
/* 1391 */             return new Long2LongAVLTreeMap.Submap.SubmapEntryIterator(Long2LongAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from) {
/* 1394 */             return new Long2LongAVLTreeMap.Submap.SubmapEntryIterator(Long2LongAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
/*      */           }
/* 1396 */           public Comparator<? super Long2LongMap.Entry> comparator() { return Long2LongAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Long2LongAVLTreeMap.Entry f = Long2LongAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1402 */             return (f != null) && (Long2LongAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Long2LongAVLTreeMap.Entry f = Long2LongAVLTreeMap.this.findKey(((Long)e.getKey()).longValue());
/* 1409 */             if ((f != null) && (Long2LongAVLTreeMap.Submap.this.in(f.key))) Long2LongAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Long2LongAVLTreeMap.Submap.SubmapIterator(Long2LongAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Long2LongAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Long2LongMap.Entry first() { return Long2LongAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Long2LongMap.Entry last() { return Long2LongAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry to) { return Long2LongAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)to.getKey()).long2LongEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry to) { return Long2LongAVLTreeMap.Submap.this.headMap((Long)to.getKey()).long2LongEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from) { return Long2LongAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2LongEntrySet(); }
/*      */         };
...
/*      */           public LongIterator iterator() {
/* 1442 */             return new Long2LongAVLTreeMap.Submap.SubmapValueIterator(Long2LongAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(long k) {
/* 1445 */             return Long2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Long2LongAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Long2LongAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(long k) {
/* 1458 */       return (in(k)) && (Long2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(long v) {
...
/* 1473 */       return (in(kk)) && ((e = Long2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public long put(long k, long v) {
/* 1476 */       Long2LongAVLTreeMap.this.modified = false;
...
/* 1478 */       long oldValue = Long2LongAVLTreeMap.this.put(k, v);
/* 1479 */       return Long2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Long put(Long ok, Long ov) {
/* 1482 */       long oldValue = put(ok.longValue(), ov.longValue());
/* 1483 */       return Long2LongAVLTreeMap.this.modified ? null : Long.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public long remove(long k) {
/* 1487 */       Long2LongAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       long oldValue = Long2LongAVLTreeMap.this.remove(k);
/* 1490 */       return Long2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Long remove(Object ok) {
/* 1493 */       long oldValue = remove(((Long)ok).longValue());
/* 1494 */       return Long2LongAVLTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1509 */       return Long2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Long2LongSortedMap headMap(long to) {
/* 1512 */       if (this.top) return new Submap(Long2LongAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Long2LongAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Long2LongAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Long2LongSortedMap tailMap(long from) {
/* 1516 */       if (this.bottom) return new Submap(Long2LongAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Long2LongAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2LongAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Long2LongSortedMap subMap(long from, long to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Long2LongAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Long2LongAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Long2LongAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Long2LongAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Long2LongAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Long2LongAVLTreeMap.this.tree == null) return null;
/* 1534 */       Long2LongAVLTreeMap.Entry e;
/*      */       Long2LongAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Long2LongAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Long2LongAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Long2LongAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Long2LongAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Long2LongAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Long2LongAVLTreeMap.this.tree == null) return null;
/* 1552 */       Long2LongAVLTreeMap.Entry e;
/*      */       Long2LongAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Long2LongAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Long2LongAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Long2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Long2LongAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public long firstLongKey() {
/* 1563 */       Long2LongAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public long lastLongKey() {
/* 1568 */       Long2LongAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Long firstKey() {
/* 1573 */       Long2LongAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Long lastKey() {
/* 1578 */       Long2LongAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Long2LongAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Long2LongAVLTreeMap.Submap.SubmapIterator
/*      */       implements LongListIterator
/*      */     {
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Long2LongAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Long2LongMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Long2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(long k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Long2LongAVLTreeMap.Submap.this.bottom) && (Long2LongAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Long2LongAVLTreeMap.Submap.this.top) && (Long2LongAVLTreeMap.this.compare(k, (this.prev = Long2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Long2LongAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Long2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Long2LongAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2LongAVLTreeMap.this.compare(this.prev.key, Long2LongAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Long2LongAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2LongAVLTreeMap.this.compare(this.next.key, Long2LongAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public LongBidirectionalIterator iterator() { return new Long2LongAVLTreeMap.Submap.SubmapKeyIterator(Long2LongAVLTreeMap.Submap.this); } 
/* 1433 */       public LongBidirectionalIterator iterator(long from) { return new Long2LongAVLTreeMap.Submap.SubmapKeyIterator(Long2LongAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Long2LongAVLTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public LongBidirectionalIterator iterator() { return new Long2LongAVLTreeMap.KeyIterator(Long2LongAVLTreeMap.this); } 
/* 1263 */     public LongBidirectionalIterator iterator(long from) { return new Long2LongAVLTreeMap.KeyIterator(Long2LongAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Long2LongAVLTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Long2LongAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Long2LongMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Long2LongMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Long2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Long2LongAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(long k) {
/* 1129 */       if ((this.next = Long2LongAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Long2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Long2LongAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Long)e.getKey()).longValue()) && (this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/* 1042 */       return HashCommon.long2int(this.key) ^ HashCommon.long2int(this.value);
/*      */     }
/*      */ 
