  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return Long2LongAVLTreeMap.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public Long2LongAVLTreeMap(Comparator<? super Long> local_c)
  {
    this();
  ...
  public Long2LongAVLTreeMap(Map<? extends Long, ? extends Long> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2LongAVLTreeMap(SortedMap<Long, Long> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2LongAVLTreeMap(Long2LongMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Long2LongAVLTreeMap(Long2LongSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Long2LongAVLTreeMap(long[] local_k, long[] local_v, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public Long2LongAVLTreeMap(long[] local_k, long[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Long2LongMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Long2LongAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Long2LongAVLTreeMap.EntryIterator(Long2LongAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from)
        {
          return new Long2LongAVLTreeMap.EntryIterator(Long2LongAVLTreeMap.this, ((Long)from.getKey()).longValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Long2LongAVLTreeMap.Entry local_f = Long2LongAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Long2LongAVLTreeMap.Entry local_f = Long2LongAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
          if (local_f != null) {
            Long2LongAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Long2LongAVLTreeMap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2LongEntrySet();
        }
        
        public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry local_to)
        {
          return Long2LongAVLTreeMap.this.headMap((Long)local_to.getKey()).long2LongEntrySet();
        }
        
        public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from)
        {
          return Long2LongAVLTreeMap.this.tailMap((Long)from.getKey()).long2LongEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Long2LongAVLTreeMap.ValueIterator(Long2LongAVLTreeMap.this, null);
        }
        
        public boolean contains(long local_k)
        {
          return Long2LongAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Long2LongAVLTreeMap local_c;
    try
    {
      local_c = (Long2LongAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Long2LongAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Long2LongAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Long2LongAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Long2LongMap.Entry> long2LongEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator()
          {
            return new Long2LongAVLTreeMap.Submap.SubmapEntryIterator(Long2LongAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Long2LongMap.Entry> iterator(Long2LongMap.Entry from)
          {
            return new Long2LongAVLTreeMap.Submap.SubmapEntryIterator(Long2LongAVLTreeMap.Submap.this, ((Long)from.getKey()).longValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Long, Long> local_e = (Map.Entry)local_o;
            Long2LongAVLTreeMap.Entry local_f = Long2LongAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            return (local_f != null) && (Long2LongAVLTreeMap.Submap.this.in1(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Long, Long> local_e = (Map.Entry)local_o;
            Long2LongAVLTreeMap.Entry local_f = Long2LongAVLTreeMap.this.findKey(((Long)local_e.getKey()).longValue());
            if ((local_f != null) && (Long2LongAVLTreeMap.Submap.this.in1(local_f.key))) {
              Long2LongAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Long2LongAVLTreeMap.Submap.SubmapIterator(Long2LongAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Long2LongAVLTreeMap.Submap.this.clear();
          }
          
          public Long2LongMap.Entry first()
          {
            return Long2LongAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Long2LongMap.Entry last()
          {
            return Long2LongAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Long2LongMap.Entry> subSet(Long2LongMap.Entry from, Long2LongMap.Entry local_to)
          {
            return Long2LongAVLTreeMap.Submap.this.subMap((Long)from.getKey(), (Long)local_to.getKey()).long2LongEntrySet();
          }
          
          public ObjectSortedSet<Long2LongMap.Entry> headSet(Long2LongMap.Entry local_to)
          {
            return Long2LongAVLTreeMap.Submap.this.headMap((Long)local_to.getKey()).long2LongEntrySet();
          }
          
          public ObjectSortedSet<Long2LongMap.Entry> tailSet(Long2LongMap.Entry from)
          {
            return Long2LongAVLTreeMap.Submap.this.tailMap((Long)from.getKey()).long2LongEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public LongCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractLongCollection()
        {
          public LongIterator iterator()
          {
            return new Long2LongAVLTreeMap.Submap.SubmapValueIterator(Long2LongAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(long local_k)
          {
            return Long2LongAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Long2LongAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(long local_k)
    {
      return (in1(local_k)) && (Long2LongAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      long local_kk = local_k;
      Long2LongAVLTreeMap.Entry local_e;
      return (in1(local_kk)) && ((local_e = Long2LongAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public long put(long local_k, long local_v)
    {
      ...
      long oldValue = Long2LongAVLTreeMap.this.put(local_k, local_v);
    ...
    public long remove(long local_k)
    {
      ...
      long oldValue = Long2LongAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Long2LongAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Long2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Long2LongAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Long2LongSortedMap tailMap(long from)
    {
      if (this.bottom) {
        return new Submap(Long2LongAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Long2LongAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Long2LongAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Long2LongSortedMap subMap(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Long2LongAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Long2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Long2LongAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Long2LongAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Long2LongAVLTreeMap.this.locateKey(this.from);
        if (Long2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Long2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Long2LongAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Long2LongAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Long2LongAVLTreeMap.this.locateKey(this.field_47);
        if (Long2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Long2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLongKey()
    {
      Long2LongAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLongKey()
    {
      Long2LongAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Long2LongAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Long2LongAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!Long2LongAVLTreeMap.Submap.this.bottom) && (Long2LongAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Long2LongAVLTreeMap.Submap.this.top) && (Long2LongAVLTreeMap.this.compare(local_k, (this.prev = Long2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Long2LongAVLTreeMap.this.locateKey(local_k);
            if (Long2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Long2LongAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Long2LongAVLTreeMap.this.compare(this.prev.key, Long2LongAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Long2LongAVLTreeMap.Submap.this.top) && (this.next != null) && (Long2LongAVLTreeMap.this.compare(this.next.key, Long2LongAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractLong2LongSortedMap.KeySet
    {
      ...
      {
        return new Long2LongAVLTreeMap.Submap.SubmapKeyIterator(Long2LongAVLTreeMap.Submap.this);
      }
      
      public LongBidirectionalIterator iterator(long from)
      {
        return new Long2LongAVLTreeMap.Submap.SubmapKeyIterator(Long2LongAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractLong2LongSortedMap.KeySet
  {
    ...
    public LongBidirectionalIterator iterator()
    {
      return new Long2LongAVLTreeMap.KeyIterator(Long2LongAVLTreeMap.this);
    }
    
    public LongBidirectionalIterator iterator(long from)
    {
      return new Long2LongAVLTreeMap.KeyIterator(Long2LongAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Long2LongAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Long2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
