...
/*  14:    */
/*  61:    */public abstract class AbstractLong2ObjectMap<V>
/*  62:    */  extends AbstractLong2ObjectFunction<V>
/*  63:    */  implements Long2ObjectMap<V>, Serializable
/*  64:    */{
...
/*  85: 85 */    if ((m instanceof Long2ObjectMap))
/*  86:    */    {
/*  87: 87 */      while (n-- != 0) {
/*  88: 88 */        Long2ObjectMap.Entry<? extends V> e = (Long2ObjectMap.Entry)i.next();
...
/* 106:    */    implements Long2ObjectMap.Entry<V>
/* 107:    */  {
...
/* 153:153 */      return (this.key == ((Long)e.getKey()).longValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public int hashCode() { return HashCommon.long2int(this.key) ^ (this.value == null ? 0 : this.value.hashCode()); }
/* 157:    */    
...
/* 175:175 */      public boolean contains(long k) { return AbstractLong2ObjectMap.this.containsKey(k); }
/* 176:176 */      public int size() { return AbstractLong2ObjectMap.this.size(); }
/* 177:177 */      public void clear() { AbstractLong2ObjectMap.this.clear(); }
/* 178:    */      
/* 179:179 */      public LongIterator iterator() { new AbstractLongIterator() {
/* 180:180 */          final ObjectIterator<Map.Entry<Long, V>> i = AbstractLong2ObjectMap.this.entrySet().iterator();
/* 181:181 */          public long nextLong() { return ((Long2ObjectMap.Entry)this.i.next()).getLongKey(); }
...
/* 200:200 */      public boolean contains(Object k) { return AbstractLong2ObjectMap.this.containsValue(k); }
/* 201:201 */      public int size() { return AbstractLong2ObjectMap.this.size(); }
/* 202:202 */      public void clear() { AbstractLong2ObjectMap.this.clear(); }
/* 203:    */      
/* 204:204 */      public ObjectIterator<V> iterator() { new AbstractObjectIterator() {
/* 205:205 */          final ObjectIterator<Map.Entry<Long, V>> i = AbstractLong2ObjectMap.this.entrySet().iterator();
/* 206:206 */          public V next() { return ((Long2ObjectMap.Entry)this.i.next()).getValue(); }
...
/* 213:    */  {
/* 214:214 */    return long2ObjectEntrySet();
/* 215:    */  }
/* 216:    */  
...
/* 244:244 */        s.append(", ");
/* 245:245 */      Long2ObjectMap.Entry<V> e = (Long2ObjectMap.Entry)i.next();
