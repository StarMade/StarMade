  ...
  implements Serializable, Cloneable, LongSortedSet
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) {
      ...
      this.actualComparator = new LongComparator()
      {
        ...
        {
          return LongAVLTreeSet.this.storedComparator.compare(Long.valueOf(local_k1), Long.valueOf(local_k2));
        }
  ...
  public LongAVLTreeSet(Comparator<? super Long> local_c)
  {
    this();
  ...
  public LongAVLTreeSet(Collection<? extends Long> local_c)
  {
    this();
    addAll(local_c);
  }
  
  public LongAVLTreeSet(SortedSet<Long> local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public LongAVLTreeSet(LongCollection local_c)
  {
    this();
    addAll(local_c);
  }
  
  public LongAVLTreeSet(LongSortedSet local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public LongAVLTreeSet(LongIterator local_i)
  {
    allocatePaths();
  ...
  public LongAVLTreeSet(Iterator<? extends Long> local_i)
  {
    this(LongIterators.asLongIterator(local_i));
  }
  
  public LongAVLTreeSet(long[] local_a, int offset, int length, Comparator<? super Long> local_c)
  {
    this(local_c);
  ...
  public LongAVLTreeSet(long[] local_a, int offset, int length)
  {
    this(local_a, offset, length, null);
  }
  
  public LongAVLTreeSet(long[] local_a)
  {
    this();
  ...
  public LongAVLTreeSet(long[] local_a, Comparator<? super Long> local_c)
  {
    this(local_c);
    int local_i = local_a.length;
    while (local_i-- != 0) {
  ...
  private Entry findKey(long local_k)
  {
    int cmp;
  ...
  {
    return new Subset(0L, true, local_to, false);
  }
  ...
  public Object clone()
  {
    LongAVLTreeSet local_c;
    try
    {
      local_c = (LongAVLTreeSet)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readLong());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readLong());
      top.right(new Entry(local_s.readLong()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable, LongSortedSet
  {
    ...
    public Subset(long from, boolean bottom, long local_to, boolean top)
    {
      if ((!bottom) && (!top) && (LongAVLTreeSet.this.compare(from, local_to) > 0)) {
    ...
    final boolean in(long local_k)
    {
      return ((this.bottom) || (LongAVLTreeSet.this.compare(local_k, this.from) >= 0)) && ((this.top) || (LongAVLTreeSet.this.compare(local_k, this.field_303) < 0));
    }
    
    public boolean contains(long local_k)
    {
      return (in(local_k)) && (LongAVLTreeSet.this.contains(local_k));
    }
    
    public boolean add(long local_k)
    {
      if (!in(local_k)) {
        throw new IllegalArgumentException("Element (" + local_k + ") out of range [" + (this.bottom ? "-" : String.valueOf(this.from)) + ", " + (this.top ? "-" : String.valueOf(this.field_303)) + ")");
      }
      return LongAVLTreeSet.this.add(local_k);
    }
    ...
    public boolean remove(long local_k)
    {
      ...
      return LongAVLTreeSet.this.remove(local_k);
    }
    ...
    {
      if (this.top) {
        return new Subset(LongAVLTreeSet.this, this.from, this.bottom, local_to, false);
      }
      return LongAVLTreeSet.this.compare(local_to, this.field_303) < 0 ? new Subset(LongAVLTreeSet.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public LongSortedSet tailSet(long from)
    {
      if (this.bottom) {
        return new Subset(LongAVLTreeSet.this, from, false, this.field_303, this.top);
      }
      return LongAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(LongAVLTreeSet.this, from, false, this.field_303, this.top) : this;
    }
    
    public LongSortedSet subSet(long from, long local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Subset(LongAVLTreeSet.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = LongAVLTreeSet.this.compare(local_to, this.field_303) < 0 ? local_to : this.field_303;
      }
      if (!this.bottom) {
        from = LongAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
      }
      if ((!this.top) && (!this.bottom) && (from == this.from) && (local_to == this.field_303)) {
        return this;
      }
      return new Subset(LongAVLTreeSet.this, from, false, local_to, false);
    }
    ...
    public LongAVLTreeSet.Entry firstEntry()
    {
      ...
      LongAVLTreeSet.Entry local_e;
      LongAVLTreeSet.Entry local_e;
      if (this.bottom)
      {
        local_e = LongAVLTreeSet.this.firstEntry;
      }
      else
      {
        local_e = LongAVLTreeSet.this.locateKey(this.from);
        if (LongAVLTreeSet.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (LongAVLTreeSet.this.compare(local_e.key, this.field_303) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public LongAVLTreeSet.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = LongAVLTreeSet.this.lastEntry;
      }
      else
      {
        local_e = LongAVLTreeSet.this.locateKey(this.field_303);
        if (LongAVLTreeSet.this.compare(local_e.key, this.field_303) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (LongAVLTreeSet.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public long firstLong()
    {
      LongAVLTreeSet.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public long lastLong()
    {
      LongAVLTreeSet.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends LongAVLTreeSet.SetIterator
    {
      ...
      {
        super();
        this.next = LongAVLTreeSet.Subset.this.firstEntry();
      }
      
      SubsetIterator(long local_k)
      {
        this();
        if (this.next != null) {
          if ((!LongAVLTreeSet.Subset.this.bottom) && (LongAVLTreeSet.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!LongAVLTreeSet.Subset.this.top) && (LongAVLTreeSet.this.compare(local_k, (this.prev = LongAVLTreeSet.Subset.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = LongAVLTreeSet.this.locateKey(local_k);
            if (LongAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!LongAVLTreeSet.Subset.this.bottom) && (this.prev != null) && (LongAVLTreeSet.this.compare(this.prev.key, LongAVLTreeSet.Subset.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!LongAVLTreeSet.Subset.this.top) && (this.next != null) && (LongAVLTreeSet.this.compare(this.next.key, LongAVLTreeSet.Subset.this.field_303) >= 0)) {
          this.next = null;
        }
      }
    }
    ...
    extends AbstractLongListIterator
  {
    ...
    SetIterator(long local_k)
    {
      if ((this.next = LongAVLTreeSet.this.locateKey(local_k)) != null) {
        if (LongAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
