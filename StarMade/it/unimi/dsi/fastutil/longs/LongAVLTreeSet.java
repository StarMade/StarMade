...
/*      */ 
/*      */ public class LongAVLTreeSet extends AbstractLongSortedSet
...
/*      */   {
/*   94 */     if ((this.storedComparator == null) || ((this.storedComparator instanceof LongComparator))) this.actualComparator = ((LongComparator)this.storedComparator); else
/*   95 */       this.actualComparator = new LongComparator() {
/*      */         public int compare(long k1, long k2) {
/*   97 */           return LongAVLTreeSet.this.storedComparator.compare(Long.valueOf(k1), Long.valueOf(k2));
/*      */         }
/*      */         public int compare(Long ok1, Long ok2) {
/*  100 */           return LongAVLTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*   74 */     allocatePaths();
/*      */ 
/*  160 */     while (i.hasNext()) add(i.nextLong());
/*      */   }
/*      */ 
/*      */   public LongAVLTreeSet(Iterator<? extends Long> i)
/*      */   {
/*  171 */     this(LongIterators.asLongIterator(i));
/*      */   }
/*      */ 
/*      */   public LongAVLTreeSet(long[] a, int offset, int length, Comparator<? super Long> c)
/*      */   {
/*  184 */     this(c);
/*  185 */     LongArrays.ensureOffsetLength(a, offset, length);
...
/* 1086 */     return new Subset(0L, true, to, false);
/*      */   }
/*      */   public LongSortedSet tailSet(long from) {
/* 1089 */     return new Subset(from, false, 0L, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1284 */       c = (LongAVLTreeSet)super.clone();
/*      */     }
...
/* 1337 */     while (n-- != 0) s.writeLong(i.nextLong());
/*      */   }
/*      */ 
...
/*      */   {
/* 1348 */     if (n == 1) {
/* 1349 */       Entry top = new Entry(s.readLong());
/* 1350 */       top.pred(pred);
/* 1351 */       top.succ(succ);
/* 1352 */       return top;
/*      */     }
/* 1354 */     if (n == 2)
/*      */     {
/* 1357 */       Entry top = new Entry(s.readLong());
/* 1358 */       top.right(new Entry(s.readLong()));
...
/*      */   }
/*      */ 
/*      */   private final class Subset extends AbstractLongSortedSet
...
/*      */     {
/* 1121 */       if ((!bottom) && (!top) && (LongAVLTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1122 */       this.from = from;
...
/*      */     {
/* 1139 */       return ((this.bottom) || (LongAVLTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (LongAVLTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(long k)
/*      */     {
/* 1144 */       return (in(k)) && (LongAVLTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(long k) {
...
/* 1148 */       return LongAVLTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(long k) {
/* 1152 */       if (!in(k)) return false;
/* 1153 */       return LongAVLTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public LongComparator comparator() {
/* 1168 */       return LongAVLTreeSet.this.actualComparator;
/*      */     }
/*      */     public LongBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public LongSortedSet headSet(long to) {
/* 1177 */       if (this.top) return new Subset(LongAVLTreeSet.this, this.from, this.bottom, to, false);
/* 1178 */       return LongAVLTreeSet.this.compare(to, this.to) < 0 ? new Subset(LongAVLTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public LongSortedSet tailSet(long from) {
/* 1181 */       if (this.bottom) return new Subset(LongAVLTreeSet.this, from, false, this.to, this.top);
/* 1182 */       return LongAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(LongAVLTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public LongSortedSet subSet(long from, long to) {
/* 1185 */       if ((this.top) && (this.bottom)) return new Subset(LongAVLTreeSet.this, from, false, to, false);
/* 1186 */       if (!this.top) to = LongAVLTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1187 */       if (!this.bottom) from = LongAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1188 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1189 */       return new Subset(LongAVLTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public LongAVLTreeSet.Entry firstEntry()
/*      */     {
/* 1196 */       if (LongAVLTreeSet.this.tree == null) return null;
/* 1199 */       LongAVLTreeSet.Entry e;
/*      */       LongAVLTreeSet.Entry e;
/* 1199 */       if (this.bottom) { e = LongAVLTreeSet.this.firstEntry;
/*      */       } else {
/* 1201 */         e = LongAVLTreeSet.this.locateKey(this.from);
/*      */ 
/* 1203 */         if (LongAVLTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1206 */       if ((e == null) || ((!this.top) && (LongAVLTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1207 */       return e;
/*      */     }
/*      */ 
/*      */     public LongAVLTreeSet.Entry lastEntry()
/*      */     {
/* 1214 */       if (LongAVLTreeSet.this.tree == null) return null;
/* 1217 */       LongAVLTreeSet.Entry e;
/*      */       LongAVLTreeSet.Entry e;
/* 1217 */       if (this.top) { e = LongAVLTreeSet.this.lastEntry;
/*      */       } else {
/* 1219 */         e = LongAVLTreeSet.this.locateKey(this.to);
/*      */ 
/* 1221 */         if (LongAVLTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1224 */       if ((e == null) || ((!this.bottom) && (LongAVLTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1225 */       return e;
/*      */     }
/*      */     public long firstLong() {
/* 1228 */       LongAVLTreeSet.Entry e = firstEntry();
/* 1229 */       if (e == null) throw new NoSuchElementException();
/* 1230 */       return e.key;
/*      */     }
/*      */     public long lastLong() {
/* 1233 */       LongAVLTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1245 */         super();
/* 1246 */         this.next = LongAVLTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(long k) {
/* 1249 */         this();
/* 1250 */         if (this.next != null)
/* 1251 */           if ((!LongAVLTreeSet.Subset.this.bottom) && (LongAVLTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1252 */           } else if ((!LongAVLTreeSet.Subset.this.top) && (LongAVLTreeSet.this.compare(k, (this.prev = LongAVLTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1254 */             this.next = LongAVLTreeSet.this.locateKey(k);
/* 1255 */             if (LongAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1269 */         if ((!LongAVLTreeSet.Subset.this.top) && (this.next != null) && (LongAVLTreeSet.this.compare(this.next.key, LongAVLTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/* 1021 */     int index = 0;
/*      */ 
/* 1023 */     SetIterator() { this.next = LongAVLTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(long k) {
/* 1026 */       if ((this.next = LongAVLTreeSet.this.locateKey(k)) != null)
/* 1027 */         if (LongAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/* 1046 */     public long nextLong() { return nextEntry().key; } 
/* 1047 */     public long previousLong() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1070 */       updatePrevious();
/* 1071 */       updateNext();
/* 1072 */       LongAVLTreeSet.this.remove(this.curr.key);
/* 1073 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
...
/*      */     }
/*      */     public int hashCode() {
/*  958 */       return HashCommon.long2int(this.key);
/*      */     }
