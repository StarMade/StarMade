  ...
  implements Serializable, Cloneable
{
  ...
  public Long2ObjectArrayMap(Long2ObjectMap<V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Long2ObjectArrayMap(Map<? extends Long, ? extends V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Long2ObjectArrayMap<V> local_c;
    try
    {
      local_c = (Long2ObjectArrayMap)super.clone();
    }
    ...
    implements Long2ObjectMap.FastEntrySet<V>
  {
    ...
    public ObjectIterator<Long2ObjectMap.Entry<V>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Long2ObjectMap.Entry<V> next()
        {
          ...
          return new AbstractLong2ObjectMap.BasicEntry(Long2ObjectArrayMap.this.key[this.next], Long2ObjectArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Long2ObjectMap.Entry<V>> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Long2ObjectMap.Entry<V> next()
        {
          ...
          this.entry.key = Long2ObjectArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Long2ObjectArrayMap.this.containsKey(local_k)) && (Long2ObjectArrayMap.this.get(local_k) == null ? local_e.getValue() == null : Long2ObjectArrayMap.this.get(local_k).equals(local_e.getValue()));
    }
  }
}
