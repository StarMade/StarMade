...
/*     */ 
/*     */ public class Long2IntOpenCustomHashMap extends AbstractLong2IntMap
...
/* 662 */           return new Long2IntOpenCustomHashMap.ValueIterator(Long2IntOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 665 */           return Long2IntOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(int v) {
/* 668 */           return Long2IntOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 671 */           Long2IntOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 786 */       c = (Long2IntOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Long2IntOpenCustomHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 655 */       super(null); } 
/* 656 */     public int nextInt() { return Long2IntOpenCustomHashMap.this.value[nextEntry()]; } 
/* 657 */     public Integer next() { return Integer.valueOf(Long2IntOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 627 */       return new Long2IntOpenCustomHashMap.KeyIterator(Long2IntOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 630 */       return Long2IntOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(long k) {
/* 633 */       return Long2IntOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(long k) {
/* 636 */       int oldSize = Long2IntOpenCustomHashMap.this.size;
/* 637 */       Long2IntOpenCustomHashMap.this.remove(k);
/* 638 */       return Long2IntOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 641 */       Long2IntOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Long2IntOpenCustomHashMap.MapIterator
/*     */     implements LongIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public long nextLong() { return Long2IntOpenCustomHashMap.this.key[nextEntry()]; } 
/* 623 */     public Long next() { return Long.valueOf(Long2IntOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 567 */       return new Long2IntOpenCustomHashMap.EntryIterator(Long2IntOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Long2IntMap.Entry> fastIterator() {
/* 570 */       return new Long2IntOpenCustomHashMap.FastEntryIterator(Long2IntOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 578 */       int pos = HashCommon.murmurHash3(Long2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Long2IntOpenCustomHashMap.this.mask;
/*     */ 
/* 580 */       while (Long2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 581 */         if (Long2IntOpenCustomHashMap.this.strategy.equals(Long2IntOpenCustomHashMap.this.key[pos], k)) return Long2IntOpenCustomHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 582 */         pos = pos + 1 & Long2IntOpenCustomHashMap.this.mask;
/*     */       }
/* 584 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 592 */       int pos = HashCommon.murmurHash3(Long2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Long2IntOpenCustomHashMap.this.mask;
/*     */ 
/* 594 */       while (Long2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 595 */         if (Long2IntOpenCustomHashMap.this.strategy.equals(Long2IntOpenCustomHashMap.this.key[pos], k)) {
/* 596 */           Long2IntOpenCustomHashMap.this.remove(e.getKey());
/* 597 */           return true;
/*     */         }
/* 599 */         pos = pos + 1 & Long2IntOpenCustomHashMap.this.mask;
/*     */       }
/* 601 */       return false;
/*     */     }
/*     */     public int size() {
/* 604 */       return Long2IntOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 607 */       Long2IntOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Long2IntOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Long2IntMap.Entry>
/*     */   {
/* 557 */     final AbstractLong2IntMap.BasicEntry entry = new AbstractLong2IntMap.BasicEntry(0L, 0);
/*     */ 
...
/* 559 */       int e = nextEntry();
/* 560 */       this.entry.key = Long2IntOpenCustomHashMap.this.key[e];
/* 561 */       this.entry.value = Long2IntOpenCustomHashMap.this.value[e];
/* 562 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Long2IntOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Long2IntMap.Entry>
/*     */   {
...
/* 548 */       return this.entry = new Long2IntOpenCustomHashMap.MapEntry(Long2IntOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 552 */       super.remove();
/* 553 */       Long2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 454 */       this.pos = Long2IntOpenCustomHashMap.this.n;
/*     */ 
/* 457 */       this.last = -1;
/*     */ 
/* 459 */       this.c = Long2IntOpenCustomHashMap.this.size;
/*     */ 
/* 464 */       boolean[] used = Long2IntOpenCustomHashMap.this.used;
...
/*     */ 
/* 477 */         int pos = HashCommon.murmurHash3(Long2IntOpenCustomHashMap.this.strategy.hashCode(k)) & Long2IntOpenCustomHashMap.this.mask;
/*     */ 
/* 479 */         while (Long2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 480 */           if (Long2IntOpenCustomHashMap.this.strategy.equals(Long2IntOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481 */           pos = pos + 1 & Long2IntOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 484 */       this.last = this.pos;
/*     */ 
/* 486 */       if (this.c != 0) {
/* 487 */         boolean[] used = Long2IntOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 504 */         pos = (last = pos) + 1 & Long2IntOpenCustomHashMap.this.mask;
/* 505 */         while (Long2IntOpenCustomHashMap.this.used[pos] != 0) {
/* 506 */           int slot = HashCommon.murmurHash3(Long2IntOpenCustomHashMap.this.strategy.hashCode(Long2IntOpenCustomHashMap.this.key[pos])) & Long2IntOpenCustomHashMap.this.mask;
/* 507 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508 */           pos = pos + 1 & Long2IntOpenCustomHashMap.this.mask;
/*     */         }
/* 510 */         if (Long2IntOpenCustomHashMap.this.used[pos] == 0) break;
/* 511 */         if (pos < last)
/*     */         {
/* 513 */           if (this.wrapped == null) this.wrapped = new LongArrayList();
/* 514 */           this.wrapped.add(Long2IntOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 516 */         Long2IntOpenCustomHashMap.this.key[last] = Long2IntOpenCustomHashMap.this.key[pos];
/* 517 */         Long2IntOpenCustomHashMap.this.value[last] = Long2IntOpenCustomHashMap.this.value[pos];
/*     */       }
/* 519 */       Long2IntOpenCustomHashMap.this.used[last] = false;
/* 520 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 525 */       if (this.pos < -1)
/*     */       {
/* 527 */         Long2IntOpenCustomHashMap.this.remove(this.wrapped.getLong(-this.pos - 2));
/* 528 */         this.last = -1;
/* 529 */         return;
/*     */       }
/* 531 */       Long2IntOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Long getKey() {
/* 418 */       return Long.valueOf(Long2IntOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public long getLongKey() {
/* 421 */       return Long2IntOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Integer getValue() {
/* 424 */       return Integer.valueOf(Long2IntOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public int getIntValue() {
/* 427 */       return Long2IntOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public int setValue(int v) {
/* 430 */       int oldValue = Long2IntOpenCustomHashMap.this.value[this.index];
/* 431 */       Long2IntOpenCustomHashMap.this.value[this.index] = v;
/* 432 */       return oldValue;
/*     */     }
...
/* 441 */       return (Long2IntOpenCustomHashMap.this.strategy.equals(Long2IntOpenCustomHashMap.this.key[this.index], ((Long)e.getKey()).longValue())) && (Long2IntOpenCustomHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */     public int hashCode() {
/* 444 */       return Long2IntOpenCustomHashMap.this.strategy.hashCode(Long2IntOpenCustomHashMap.this.key[this.index]) ^ Long2IntOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 447 */       return Long2IntOpenCustomHashMap.this.key[this.index] + "=>" + Long2IntOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
