...
public abstract interface Char2ObjectMap<V> extends Char2ObjectFunction<V>, Map<Character, V>
{
  ...
  public static abstract interface FastEntrySet<V> extends ObjectSet<Char2ObjectMap.Entry<V>>
  {
