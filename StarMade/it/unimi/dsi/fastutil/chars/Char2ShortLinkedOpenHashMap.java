...
/*      */   protected int size;
/*      */   protected volatile transient Char2ShortSortedMap.FastSortedEntrySet entries;
...
/*  786 */   public Char2ShortSortedMap tailMap(char from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Char2ShortSortedMap headMap(char to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Char2ShortSortedMap subMap(char from, char to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Char2ShortLinkedOpenHashMap.ValueIterator(Char2ShortLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Char2ShortLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(short v) {
/* 1113 */           return Char2ShortLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Char2ShortLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Char2ShortLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public short previousShort()
/*      */     {
/* 1094 */       return Char2ShortLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Short previous() { return Short.valueOf(Char2ShortLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public short nextShort() { return Char2ShortLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Short next() { return Short.valueOf(Char2ShortLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Char2ShortLinkedOpenHashMap.KeyIterator(Char2ShortLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public CharListIterator iterator() {
/* 1054 */       return new Char2ShortLinkedOpenHashMap.KeyIterator(Char2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Char2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(char k) {
/* 1060 */       return Char2ShortLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(char k) {
/* 1063 */       int oldSize = Char2ShortLinkedOpenHashMap.this.size;
/* 1064 */       Char2ShortLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Char2ShortLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Char2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public char firstChar() {
/* 1071 */       if (Char2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Char2ShortLinkedOpenHashMap.this.key[Char2ShortLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public char lastChar() {
/* 1075 */       if (Char2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Char2ShortLinkedOpenHashMap.this.key[Char2ShortLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2ShortLinkedOpenHashMap.MapIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator(char k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public char previousChar() { return Char2ShortLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Character previous() { return Character.valueOf(Char2ShortLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public char nextChar() { return Char2ShortLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Character next() { return Character.valueOf(Char2ShortLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Char2ShortMap.Entry>
...
/*      */     {
/*  966 */       return new Char2ShortLinkedOpenHashMap.EntryIterator(Char2ShortLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Char2ShortMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry fromElement, Char2ShortMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Char2ShortMap.Entry first() {
/*  973 */       if (Char2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Char2ShortLinkedOpenHashMap.MapEntry(Char2ShortLinkedOpenHashMap.this, Char2ShortLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Char2ShortMap.Entry last() {
/*  977 */       if (Char2ShortLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Char2ShortLinkedOpenHashMap.MapEntry(Char2ShortLinkedOpenHashMap.this, Char2ShortLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Char2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Char2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Char2ShortLinkedOpenHashMap.this.key[pos] == k) return Char2ShortLinkedOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/*  990 */         pos = pos + 1 & Char2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Char2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Char2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Char2ShortLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Char2ShortLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Char2ShortLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Char2ShortLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Char2ShortLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry from) {
/* 1018 */       return new Char2ShortLinkedOpenHashMap.EntryIterator(Char2ShortLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ShortMap.Entry> fastIterator() {
/* 1021 */       return new Char2ShortLinkedOpenHashMap.FastEntryIterator(Char2ShortLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ShortMap.Entry> fastIterator(Char2ShortMap.Entry from) {
/* 1024 */       return new Char2ShortLinkedOpenHashMap.FastEntryIterator(Char2ShortLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Char2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Char2ShortMap.Entry>
/*      */   {
/*  944 */     final AbstractChar2ShortMap.BasicEntry entry = new AbstractChar2ShortMap.BasicEntry('\000', (short)0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Char2ShortLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Char2ShortLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractChar2ShortMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Char2ShortLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Char2ShortLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Char2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Char2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2ShortLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Char2ShortMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Char2ShortLinkedOpenHashMap.MapEntry(Char2ShortLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Char2ShortLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Char2ShortLinkedOpenHashMap.MapEntry(Char2ShortLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Char2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Char2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Char2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Char2ShortLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(char from) {
/*  809 */       if (Char2ShortLinkedOpenHashMap.this.key[Char2ShortLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Char2ShortLinkedOpenHashMap.this.last;
/*  811 */         this.index = Char2ShortLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Char2ShortLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Char2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Char2ShortLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Char2ShortLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Char2ShortLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Char2ShortLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Char2ShortLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Char2ShortLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Char2ShortLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Char2ShortLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Char2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Char2ShortLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Char2ShortLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Char2ShortLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Char2ShortLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Char2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Char2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Char2ShortLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Char2ShortLinkedOpenHashMap.this.link[this.next] ^= (Char2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Char2ShortLinkedOpenHashMap.this.mask;
/*  897 */         while (Char2ShortLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Char2ShortLinkedOpenHashMap.this.key[pos]) & Char2ShortLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Char2ShortLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Char2ShortLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Char2ShortLinkedOpenHashMap.this.key[last] = Char2ShortLinkedOpenHashMap.this.key[pos];
/*  904 */         Char2ShortLinkedOpenHashMap.this.value[last] = Char2ShortLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Char2ShortLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Char2ShortLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*  669 */       return Character.valueOf(Char2ShortLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public char getCharKey() {
/*  672 */       return Char2ShortLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Short getValue() {
/*  675 */       return Short.valueOf(Char2ShortLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public short getShortValue() {
/*  678 */       return Char2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public short setValue(short v) {
/*  681 */       short oldValue = Char2ShortLinkedOpenHashMap.this.value[this.index];
/*  682 */       Char2ShortLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Short setValue(Short v) {
...
/*  692 */       return (Char2ShortLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Char2ShortLinkedOpenHashMap.this.key[this.index] ^ Char2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Char2ShortLinkedOpenHashMap.this.key[this.index] + "=>" + Char2ShortLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
