  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2ShortLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2ShortLinkedOpenHashMap(Map<? extends Character, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ShortLinkedOpenHashMap(Map<? extends Character, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ShortLinkedOpenHashMap(Char2ShortMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ShortLinkedOpenHashMap(Char2ShortMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ShortLinkedOpenHashMap(char[] local_k, short[] local_v, float local_f)
  {
  ...
  public Char2ShortLinkedOpenHashMap(char[] local_k, short[] local_v)
  {
  ...
  public short getAndMoveToFirst(char local_k)
  {
    char[] key = this.key;
  ...
  public short getAndMoveToLast(char local_k)
  {
    char[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public short putAndMoveToFirst(char local_k, short local_v)
  {
    char[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public short putAndMoveToLast(char local_k, short local_v)
  {
    char[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Char2ShortLinkedOpenHashMap.ValueIterator(Char2ShortLinkedOpenHashMap.this);
        }
        ...
        {
          return Char2ShortLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2ShortLinkedOpenHashMap local_c;
    try
    {
      local_c = (Char2ShortLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2ShortLinkedOpenHashMap.MapIterator
    implements ShortListIterator
  {
    ...
    {
      return Short.valueOf(Char2ShortLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Short next()
    {
      return Short.valueOf(Char2ShortLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSortedSet
  {
    ...
    {
      return new Char2ShortLinkedOpenHashMap.KeyIterator(Char2ShortLinkedOpenHashMap.this, from);
    }
    
    public CharListIterator iterator()
    {
      return new Char2ShortLinkedOpenHashMap.KeyIterator(Char2ShortLinkedOpenHashMap.this);
    }
    ...
    {
      return Char2ShortLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2ShortLinkedOpenHashMap.this.size;
      Char2ShortLinkedOpenHashMap.this.remove(local_k);
    ...
    implements CharListIterator
  {
    ...
    {
      return Character.valueOf(Char2ShortLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    {
      return Character.valueOf(Char2ShortLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2ShortSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Char2ShortLinkedOpenHashMap.EntryIterator(Char2ShortLinkedOpenHashMap.this);
    }
    ...
    public Char2ShortMap.Entry first()
    {
      ...
      return new Char2ShortLinkedOpenHashMap.MapEntry(Char2ShortLinkedOpenHashMap.this, Char2ShortLinkedOpenHashMap.this.first);
    }
    ...
    public Char2ShortMap.Entry last()
    {
      ...
      return new Char2ShortLinkedOpenHashMap.MapEntry(Char2ShortLinkedOpenHashMap.this, Char2ShortLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ShortLinkedOpenHashMap.this.mask; Char2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ShortLinkedOpenHashMap.this.mask) {
        if (Char2ShortLinkedOpenHashMap.this.key[pos] == local_k) {
          return Char2ShortLinkedOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ShortLinkedOpenHashMap.this.mask; Char2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ShortLinkedOpenHashMap.this.mask) {
        if (Char2ShortLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Char2ShortLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Char2ShortLinkedOpenHashMap.EntryIterator(Char2ShortLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
    }
    
    public ObjectBidirectionalIterator<Char2ShortMap.Entry> fastIterator()
    {
      return new Char2ShortLinkedOpenHashMap.FastEntryIterator(Char2ShortLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Char2ShortMap.Entry> fastIterator(Char2ShortMap.Entry from)
    {
      return new Char2ShortLinkedOpenHashMap.FastEntryIterator(Char2ShortLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
    }
  }
    ...
    implements ObjectListIterator<Char2ShortMap.Entry>
  {
    ...
    public AbstractChar2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2ShortLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Char2ShortLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Char2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Char2ShortLinkedOpenHashMap.MapEntry(Char2ShortLinkedOpenHashMap.this, nextEntry());
    }
    
    public Char2ShortLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Char2ShortLinkedOpenHashMap.MapEntry(Char2ShortLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(char from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Char2ShortLinkedOpenHashMap.this.mask; Char2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ShortLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Char2ShortLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Char2ShortLinkedOpenHashMap.this.first = this.next;
      } else {
        Char2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Char2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Char2ShortLinkedOpenHashMap.this.last = this.prev;
      } else {
        Char2ShortLinkedOpenHashMap.this.link[this.next] ^= (Char2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2ShortLinkedOpenHashMap.this.mask; Char2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ShortLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2ShortLinkedOpenHashMap.this.key[pos]) & Char2ShortLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2ShortLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Char2ShortLinkedOpenHashMap.this.key[last] = Char2ShortLinkedOpenHashMap.this.key[pos];
      ...
      Char2ShortLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Char2ShortMap.Entry, Map.Entry<Character, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Char2ShortLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Short> local_e = (Map.Entry)local_o;
      return (Char2ShortLinkedOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
