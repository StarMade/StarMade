  ...
  implements Char2ReferenceMap<V>, Serializable
{
  ...
  public void putAll(Map<? extends Character, ? extends V> local_m)
  {
    ...
    if ((local_m instanceof Char2ReferenceMap)) {
      while (local_n-- != 0)
      {
        Char2ReferenceMap.Entry<? extends V> local_e = (Char2ReferenceMap.Entry)local_i.next();
  ...
  public CharSet keySet()
  {
    new AbstractCharSet()
    {
      ...
      {
        return AbstractChar2ReferenceMap.this.containsKey(local_k);
      }
      ...
      public CharIterator iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<Character, V>> field_67 = AbstractChar2ReferenceMap.this.entrySet().iterator();
          
          public char nextChar()
          {
            return ((Char2ReferenceMap.Entry)this.field_67.next()).getCharKey();
          }
  ...
  public ReferenceCollection<V> values()
  {
    new AbstractReferenceCollection()
    {
      ...
      {
        return AbstractChar2ReferenceMap.this.containsValue(local_k);
      }
      ...
      public ObjectIterator<V> iterator()
      {
        ...
        {
          final ObjectIterator<Map.Entry<Character, V>> field_3 = AbstractChar2ReferenceMap.this.entrySet().iterator();
          
          public V next()
          {
            return ((Char2ReferenceMap.Entry)this.field_3.next()).getValue();
          }
  ...
  public String toString()
  {
    ...
    while (local_n-- != 0)
    {
      ...
      Char2ReferenceMap.Entry<V> local_e = (Char2ReferenceMap.Entry)local_i.next();
