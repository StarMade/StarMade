...
/*  13:    */
/*  61:    */public abstract class AbstractChar2ReferenceMap<V>
/*  62:    */  extends AbstractChar2ReferenceFunction<V>
/*  63:    */  implements Char2ReferenceMap<V>, Serializable
/*  64:    */{
...
/*  85: 85 */    if ((m instanceof Char2ReferenceMap))
/*  86:    */    {
/*  87: 87 */      while (n-- != 0) {
/*  88: 88 */        Char2ReferenceMap.Entry<? extends V> e = (Char2ReferenceMap.Entry)i.next();
...
/* 106:    */    implements Char2ReferenceMap.Entry<V>
/* 107:    */  {
...
/* 153:153 */      return (this.key == ((Character)e.getKey()).charValue()) && (this.value == e.getValue());
/* 154:    */    }
/* 155:    */    
...
/* 175:175 */      public boolean contains(char k) { return AbstractChar2ReferenceMap.this.containsKey(k); }
/* 176:176 */      public int size() { return AbstractChar2ReferenceMap.this.size(); }
/* 177:177 */      public void clear() { AbstractChar2ReferenceMap.this.clear(); }
/* 178:    */      
/* 179:179 */      public CharIterator iterator() { new AbstractCharIterator() {
/* 180:180 */          final ObjectIterator<Map.Entry<Character, V>> i = AbstractChar2ReferenceMap.this.entrySet().iterator();
/* 181:181 */          public char nextChar() { return ((Char2ReferenceMap.Entry)this.i.next()).getCharKey(); }
...
/* 200:200 */      public boolean contains(Object k) { return AbstractChar2ReferenceMap.this.containsValue(k); }
/* 201:201 */      public int size() { return AbstractChar2ReferenceMap.this.size(); }
/* 202:202 */      public void clear() { AbstractChar2ReferenceMap.this.clear(); }
/* 203:    */      
/* 204:204 */      public ObjectIterator<V> iterator() { new AbstractObjectIterator() {
/* 205:205 */          final ObjectIterator<Map.Entry<Character, V>> i = AbstractChar2ReferenceMap.this.entrySet().iterator();
/* 206:206 */          public V next() { return ((Char2ReferenceMap.Entry)this.i.next()).getValue(); }
...
/* 213:    */  {
/* 214:214 */    return char2ReferenceEntrySet();
/* 215:    */  }
/* 216:    */  
...
/* 244:244 */        s.append(", ");
/* 245:245 */      Char2ReferenceMap.Entry<V> e = (Char2ReferenceMap.Entry)i.next();
