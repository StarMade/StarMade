  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2FloatOpenCustomHashMap(int expected, float local_f, CharHash.Strategy strategy)
  {
  ...
  public Char2FloatOpenCustomHashMap(Map<? extends Character, ? extends Float> local_m, float local_f, CharHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Char2FloatOpenCustomHashMap(Map<? extends Character, ? extends Float> local_m, CharHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Char2FloatOpenCustomHashMap(Char2FloatMap local_m, float local_f, CharHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Char2FloatOpenCustomHashMap(Char2FloatMap local_m, CharHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Char2FloatOpenCustomHashMap(char[] local_k, float[] local_v, float local_f, CharHash.Strategy strategy)
  {
  ...
  public Char2FloatOpenCustomHashMap(char[] local_k, float[] local_v, CharHash.Strategy strategy)
  {
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Char2FloatOpenCustomHashMap.ValueIterator(Char2FloatOpenCustomHashMap.this);
        }
        ...
        {
          return Char2FloatOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2FloatOpenCustomHashMap local_c;
    try
    {
      local_c = (Char2FloatOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2FloatOpenCustomHashMap.MapIterator
    implements FloatIterator
  {
    ...
    {
      return Char2FloatOpenCustomHashMap.this.value[nextEntry()];
    }
    
    public Float next()
    {
      return Float.valueOf(Char2FloatOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSet
  {
    ...
    {
      return new Char2FloatOpenCustomHashMap.KeyIterator(Char2FloatOpenCustomHashMap.this);
    }
    ...
    {
      return Char2FloatOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2FloatOpenCustomHashMap.this.size;
      Char2FloatOpenCustomHashMap.this.remove(local_k);
    ...
    implements CharIterator
  {
    ...
    {
      return Char2FloatOpenCustomHashMap.this.key[nextEntry()];
    }
    
    public Character next()
    {
      return Character.valueOf(Char2FloatOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2FloatMap.FastEntrySet
  {
    ...
    {
      return new Char2FloatOpenCustomHashMap.EntryIterator(Char2FloatOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Char2FloatMap.Entry> fastIterator()
    {
      return new Char2FloatOpenCustomHashMap.FastEntryIterator(Char2FloatOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Char2FloatOpenCustomHashMap.this.strategy.hashCode(local_k)) & Char2FloatOpenCustomHashMap.this.mask; Char2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask) {
        if (Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[pos], local_k)) {
          return Char2FloatOpenCustomHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Char2FloatOpenCustomHashMap.this.strategy.hashCode(local_k)) & Char2FloatOpenCustomHashMap.this.mask; Char2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask) {
        if (Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[pos], local_k))
        {
          Char2FloatOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2FloatMap.Entry>
  {
    ...
    public AbstractChar2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2FloatOpenCustomHashMap.this.key[local_e];
      this.entry.value = Char2FloatOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Char2FloatOpenCustomHashMap.MapEntry(Char2FloatOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2FloatOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1751 = Char2FloatOpenCustomHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2FloatOpenCustomHashMap.this.used;
      while ((this.field_1751 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1751 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1751 != 0)
      {
        boolean[] local_k = Char2FloatOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2FloatOpenCustomHashMap.this.mask; Char2FloatOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2FloatOpenCustomHashMap.this.strategy.hashCode(Char2FloatOpenCustomHashMap.this.key[pos])) & Char2FloatOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2FloatOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2FloatOpenCustomHashMap.this.key[pos]);
        }
        Char2FloatOpenCustomHashMap.this.key[last] = Char2FloatOpenCustomHashMap.this.key[pos];
        Char2FloatOpenCustomHashMap.this.value[last] = Char2FloatOpenCustomHashMap.this.value[pos];
      }
      Char2FloatOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2FloatOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2FloatOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1751 > 0))
      {
        this.field_1751 += 1;
        nextEntry();
      }
    ...
    implements Char2FloatMap.Entry, Map.Entry<Character, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Char2FloatOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Float> local_e = (Map.Entry)local_o;
      return (Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[this.index], ((Character)local_e.getKey()).charValue())) && (Char2FloatOpenCustomHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
