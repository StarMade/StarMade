...
/*  18:    */
/*  90:    */public class Char2FloatOpenCustomHashMap
/*  91:    */  extends AbstractChar2FloatMap
...
/* 104:    */  protected volatile transient Char2FloatMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Char2FloatOpenCustomHashMap(int expected, float f, CharHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Char2FloatOpenCustomHashMap(int expected, CharHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Char2FloatOpenCustomHashMap(CharHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Char2FloatOpenCustomHashMap(Map<? extends Character, ? extends Float> m, float f, CharHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Char2FloatOpenCustomHashMap(Map<? extends Character, ? extends Float> m, CharHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Char2FloatOpenCustomHashMap(Char2FloatMap m, float f, CharHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Char2FloatOpenCustomHashMap(Char2FloatMap m, CharHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Char2FloatOpenCustomHashMap(char[] k, float[] v, float f, CharHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Char2FloatOpenCustomHashMap(char[] k, float[] v, CharHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public float put(char k, float v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Float put(Character ok, Float ov) { float v = ov.floatValue();
...
/* 246:    */  }
/* 247:    */  
/* 258:    */  public float add(char k, float incr)
/* 259:    */  {
...
/* 299:    */  }
/* 300:    */  
/* 301:    */  public float remove(char k)
/* 302:    */  {
...
/* 332:    */  }
/* 333:    */  
/* 334:334 */  public Float get(Character ok) { char k = ok.charValue();
/* 335:    */    
...
/* 409:    */    implements Char2FloatMap.Entry, Map.Entry<Character, Float>
/* 410:    */  {
...
/* 416:    */    }
/* 417:    */    
/* 418:418 */    public Character getKey() { return Character.valueOf(Char2FloatOpenCustomHashMap.this.key[this.index]); }
/* 419:    */    
/* 420:    */    public char getCharKey() {
/* 421:421 */      return Char2FloatOpenCustomHashMap.this.key[this.index];
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public Float getValue() { return Float.valueOf(Char2FloatOpenCustomHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public float getFloatValue() { return Char2FloatOpenCustomHashMap.this.value[this.index]; }
/* 428:    */    
/* 429:    */    public float setValue(float v) {
/* 430:430 */      float oldValue = Char2FloatOpenCustomHashMap.this.value[this.index];
/* 431:431 */      Char2FloatOpenCustomHashMap.this.value[this.index] = v;
...
/* 440:440 */      Map.Entry<Character, Float> e = (Map.Entry)o;
/* 441:441 */      return (Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue())) && (Char2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/* 442:    */    }
/* 443:    */    
/* 444:444 */    public int hashCode() { return Char2FloatOpenCustomHashMap.this.strategy.hashCode(Char2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Char2FloatOpenCustomHashMap.this.value[this.index]); }
/* 445:    */    
/* 447:447 */    public String toString() { return Char2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Char2FloatOpenCustomHashMap.this.value[this.index]; } }
/* 448:    */  
...
/* 453:    */    
/* 454:454 */    private MapIterator() { this.pos = Char2FloatOpenCustomHashMap.this.n;
/* 455:    */      
/* 457:457 */      this.last = -1;
/* 458:    */      
/* 459:459 */      this.c = Char2FloatOpenCustomHashMap.this.size;
/* 460:    */      
/* 464:464 */      boolean[] used = Char2FloatOpenCustomHashMap.this.used;
...
/* 476:    */        
/* 477:477 */        int pos = HashCommon.murmurHash3(Char2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Char2FloatOpenCustomHashMap.this.mask;
/* 478:    */        
/* 479:479 */        while (Char2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 480:480 */          if (Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481:481 */          pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask;
/* 482:    */        }
/* 483:    */      }
/* 484:484 */      this.last = this.pos;
/* 485:    */      
/* 486:486 */      if (this.c != 0) {
/* 487:487 */        boolean[] used = Char2FloatOpenCustomHashMap.this.used;
...
/* 502:    */      for (;;)
/* 503:    */      {
/* 504:504 */        pos = (last = pos) + 1 & Char2FloatOpenCustomHashMap.this.mask;
/* 505:505 */        while (Char2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 506:506 */          int slot = HashCommon.murmurHash3(Char2FloatOpenCustomHashMap.this.strategy.hashCode(Char2FloatOpenCustomHashMap.this.key[pos])) & Char2FloatOpenCustomHashMap.this.mask;
/* 507:507 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508:508 */          pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask;
/* 509:    */        }
/* 510:510 */        if (Char2FloatOpenCustomHashMap.this.used[pos] == 0) break;
/* 511:511 */        if (pos < last)
/* 512:    */        {
/* 513:513 */          if (this.wrapped == null) this.wrapped = new CharArrayList();
/* 514:514 */          this.wrapped.add(Char2FloatOpenCustomHashMap.this.key[pos]);
/* 515:    */        }
/* 516:516 */        Char2FloatOpenCustomHashMap.this.key[last] = Char2FloatOpenCustomHashMap.this.key[pos];
/* 517:517 */        Char2FloatOpenCustomHashMap.this.value[last] = Char2FloatOpenCustomHashMap.this.value[pos];
/* 518:    */      }
/* 519:519 */      Char2FloatOpenCustomHashMap.this.used[last] = false;
/* 520:520 */      return last;
/* 521:    */    }
/* 522:    */    
...
/* 526:    */      {
/* 527:527 */        Char2FloatOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
/* 528:528 */        this.last = -1;
/* 529:529 */        return;
/* 530:    */      }
/* 531:531 */      Char2FloatOpenCustomHashMap.this.size -= 1;
...
/* 543:    */    } }
/* 544:    */  
/* 545:545 */  private class EntryIterator extends Char2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Char2FloatMap.Entry> { private EntryIterator() { super(null); }
/* 546:    */    
/* 547:    */    private Char2FloatOpenCustomHashMap.MapEntry entry;
/* 548:548 */    public Char2FloatMap.Entry next() { return this.entry = new Char2FloatOpenCustomHashMap.MapEntry(Char2FloatOpenCustomHashMap.this, nextEntry()); }
/* 549:    */    
/* 550:    */    public void remove()
/* 551:    */    {
/* 552:552 */      super.remove();
/* 553:553 */      Char2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 554:    */    } }
/* 555:    */  
/* 556:556 */  private class FastEntryIterator extends Char2FloatOpenCustomHashMap.MapIterator implements ObjectIterator<Char2FloatMap.Entry> { private FastEntryIterator() { super(null); }
/* 557:557 */    final AbstractChar2FloatMap.BasicEntry entry = new AbstractChar2FloatMap.BasicEntry('\000', 0.0F);
/* 558:    */    
/* 559:559 */    public AbstractChar2FloatMap.BasicEntry next() { int e = nextEntry();
/* 560:560 */      this.entry.key = Char2FloatOpenCustomHashMap.this.key[e];
/* 561:561 */      this.entry.value = Char2FloatOpenCustomHashMap.this.value[e];
/* 562:562 */      return this.entry;
/* 563:    */    } }
/* 564:    */  
/* 565:    */  private final class MapEntrySet extends AbstractObjectSet<Char2FloatMap.Entry> implements Char2FloatMap.FastEntrySet { private MapEntrySet() {}
/* 566:    */    
/* 567:567 */    public ObjectIterator<Char2FloatMap.Entry> iterator() { return new Char2FloatOpenCustomHashMap.EntryIterator(Char2FloatOpenCustomHashMap.this, null); }
/* 568:    */    
/* 569:    */    public ObjectIterator<Char2FloatMap.Entry> fastIterator() {
/* 570:570 */      return new Char2FloatOpenCustomHashMap.FastEntryIterator(Char2FloatOpenCustomHashMap.this, null);
/* 571:    */    }
/* 572:    */    
/* 573:    */    public boolean contains(Object o) {
/* 574:574 */      if (!(o instanceof Map.Entry)) return false;
/* 575:575 */      Map.Entry<Character, Float> e = (Map.Entry)o;
/* 576:576 */      char k = ((Character)e.getKey()).charValue();
/* 577:    */      
/* 578:578 */      int pos = HashCommon.murmurHash3(Char2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Char2FloatOpenCustomHashMap.this.mask;
/* 579:    */      
/* 580:580 */      while (Char2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 581:581 */        if (Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[pos], k)) return Char2FloatOpenCustomHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 582:582 */        pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask;
/* 583:    */      }
...
/* 589:589 */      Map.Entry<Character, Float> e = (Map.Entry)o;
/* 590:590 */      char k = ((Character)e.getKey()).charValue();
/* 591:    */      
/* 592:592 */      int pos = HashCommon.murmurHash3(Char2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Char2FloatOpenCustomHashMap.this.mask;
/* 593:    */      
/* 594:594 */      while (Char2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 595:595 */        if (Char2FloatOpenCustomHashMap.this.strategy.equals(Char2FloatOpenCustomHashMap.this.key[pos], k)) {
/* 596:596 */          Char2FloatOpenCustomHashMap.this.remove(e.getKey());
/* 597:597 */          return true;
/* 598:    */        }
/* 599:599 */        pos = pos + 1 & Char2FloatOpenCustomHashMap.this.mask;
/* 600:    */      }
/* 601:601 */      return false;
/* 602:    */    }
/* 603:    */    
/* 604:604 */    public int size() { return Char2FloatOpenCustomHashMap.this.size; }
/* 605:    */    
/* 607:607 */    public void clear() { Char2FloatOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
/* 610:    */  public Char2FloatMap.FastEntrySet char2FloatEntrySet() {
...
/* 618:    */    extends Char2FloatOpenCustomHashMap.MapIterator
/* 619:    */    implements CharIterator
/* 620:    */  {
/* 621:621 */    public KeyIterator() { super(null); }
/* 622:622 */    public char nextChar() { return Char2FloatOpenCustomHashMap.this.key[nextEntry()]; }
/* 623:623 */    public Character next() { return Character.valueOf(Char2FloatOpenCustomHashMap.this.key[nextEntry()]); } }
/* 624:    */  
/* 625:    */  private final class KeySet extends AbstractCharSet { private KeySet() {}
/* 626:    */    
/* 627:627 */    public CharIterator iterator() { return new Char2FloatOpenCustomHashMap.KeyIterator(Char2FloatOpenCustomHashMap.this); }
/* 628:    */    
/* 629:    */    public int size() {
/* 630:630 */      return Char2FloatOpenCustomHashMap.this.size;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    public boolean contains(char k) { return Char2FloatOpenCustomHashMap.this.containsKey(k); }
/* 634:    */    
/* 635:    */    public boolean remove(char k) {
/* 636:636 */      int oldSize = Char2FloatOpenCustomHashMap.this.size;
/* 637:637 */      Char2FloatOpenCustomHashMap.this.remove(k);
/* 638:638 */      return Char2FloatOpenCustomHashMap.this.size != oldSize;
/* 639:    */    }
/* 640:    */    
/* 641:641 */    public void clear() { Char2FloatOpenCustomHashMap.this.clear(); }
/* 642:    */  }
/* 643:    */  
...
/* 652:    */    extends Char2FloatOpenCustomHashMap.MapIterator
/* 653:    */    implements FloatIterator
/* 654:    */  {
/* 655:655 */    public ValueIterator() { super(null); }
/* 656:656 */    public float nextFloat() { return Char2FloatOpenCustomHashMap.this.value[nextEntry()]; }
/* 657:657 */    public Float next() { return Float.valueOf(Char2FloatOpenCustomHashMap.this.value[nextEntry()]); }
/* 658:    */  }
/* 659:    */  
...
/* 662:662 */          return new Char2FloatOpenCustomHashMap.ValueIterator(Char2FloatOpenCustomHashMap.this);
/* 663:    */        }
/* 664:    */        
/* 665:665 */        public int size() { return Char2FloatOpenCustomHashMap.this.size; }
/* 666:    */        
/* 667:    */        public boolean contains(float v) {
/* 668:668 */          return Char2FloatOpenCustomHashMap.this.containsValue(v);
/* 669:    */        }
/* 670:    */        
/* 671:671 */        public void clear() { Char2FloatOpenCustomHashMap.this.clear(); }
/* 672:    */      };
/* 673:    */    }
...
/* 774:    */  }
/* 775:    */  
/* 779:    */  public Char2FloatOpenCustomHashMap clone()
/* 780:    */  {
/* 781:    */    Char2FloatOpenCustomHashMap c;
/* 782:    */    
/* 784:    */    try
/* 785:    */    {
/* 786:786 */      c = (Char2FloatOpenCustomHashMap)super.clone();
/* 787:    */    }
