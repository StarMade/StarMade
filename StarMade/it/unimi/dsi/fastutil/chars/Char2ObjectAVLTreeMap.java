  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2ObjectAVLTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2ObjectAVLTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2ObjectAVLTreeMap(Map<? extends Character, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ObjectAVLTreeMap(SortedMap<Character, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ObjectAVLTreeMap(Char2ObjectMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ObjectAVLTreeMap(Char2ObjectSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ObjectAVLTreeMap(char[] local_k, V[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2ObjectAVLTreeMap(char[] local_k, V[] local_v)
  {
  ...
  {
    Char2ObjectAVLTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
  ...
  public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Char2ObjectMap.Entry<V>> comparator = new Comparator()
        {
          public int compare(Char2ObjectMap.Entry<V> local_x, Char2ObjectMap.Entry<V> local_y)
          {
            return Char2ObjectAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2ObjectAVLTreeMap.EntryIterator(Char2ObjectAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from)
        {
          return new Char2ObjectAVLTreeMap.EntryIterator(Char2ObjectAVLTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2ObjectAVLTreeMap.Entry<V> local_f = Char2ObjectAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2ObjectAVLTreeMap.Entry<V> local_f = Char2ObjectAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2ObjectAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> local_to)
        {
          return Char2ObjectAVLTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> local_to)
        {
          return Char2ObjectAVLTreeMap.this.headMap((Character)local_to.getKey()).char2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from)
        {
          return Char2ObjectAVLTreeMap.this.tailMap((Character)from.getKey()).char2ObjectEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Char2ObjectAVLTreeMap.ValueIterator(Char2ObjectAVLTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Char2ObjectAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2ObjectAVLTreeMap<V> local_c;
    try
    {
      local_c = (Char2ObjectAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Char2ObjectAVLTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2ObjectAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Char2ObjectAVLTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Char2ObjectAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2ObjectAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator()
          {
            return new Char2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Char2ObjectAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from)
          {
            return new Char2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Char2ObjectAVLTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, V> local_e = (Map.Entry)local_o;
            Char2ObjectAVLTreeMap.Entry<V> local_f = Char2ObjectAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2ObjectAVLTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, V> local_e = (Map.Entry)local_o;
            Char2ObjectAVLTreeMap.Entry<V> local_f = Char2ObjectAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2ObjectAVLTreeMap.Submap.this.in2(local_f.key))) {
              Char2ObjectAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2ObjectAVLTreeMap.Submap.SubmapIterator(Char2ObjectAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2ObjectAVLTreeMap.Submap.this.clear();
          }
          
          public Char2ObjectMap.Entry<V> first()
          {
            return Char2ObjectAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Char2ObjectMap.Entry<V> last()
          {
            return Char2ObjectAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> local_to)
          {
            return Char2ObjectAVLTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> local_to)
          {
            return Char2ObjectAVLTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from)
          {
            return Char2ObjectAVLTreeMap.Submap.this.tailMap((Character)from.getKey()).char2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Char2ObjectAVLTreeMap.Submap.SubmapValueIterator(Char2ObjectAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Char2ObjectAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2ObjectAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2ObjectAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2ObjectAVLTreeMap.Entry<V> local_e;
      return (in2(local_kk)) && ((local_e = Char2ObjectAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(char local_k, V local_v)
    {
      ...
      V oldValue = Char2ObjectAVLTreeMap.this.put(local_k, local_v);
    ...
    public V remove(char local_k)
    {
      ...
      V oldValue = Char2ObjectAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2ObjectSortedMap<V> tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2ObjectAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2ObjectAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2ObjectSortedMap<V> subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2ObjectAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2ObjectAVLTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2ObjectAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2ObjectAVLTreeMap.this.locateKey(this.from);
        if (Char2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2ObjectAVLTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2ObjectAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2ObjectAVLTreeMap.this.locateKey(this.field_47);
        if (Char2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2ObjectAVLTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2ObjectAVLTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Char2ObjectAVLTreeMap.Submap.SubmapIterator
      ...
      implements ObjectListIterator<Char2ObjectMap.Entry<V>>
    {
      ...
      public void set(Char2ObjectMap.Entry<V> local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Char2ObjectMap.Entry<V> local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
    ...
    private class SubmapIterator
      extends Char2ObjectAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Char2ObjectAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2ObjectAVLTreeMap.Submap.this.bottom) && (Char2ObjectAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2ObjectAVLTreeMap.Submap.this.top) && (Char2ObjectAVLTreeMap.this.compare(local_k, (this.prev = Char2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2ObjectAVLTreeMap.this.locateKey(local_k);
            if (Char2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2ObjectAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2ObjectAVLTreeMap.this.compare(this.prev.key, Char2ObjectAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2ObjectAVLTreeMap.Submap.this.top) && (this.next != null) && (Char2ObjectAVLTreeMap.this.compare(this.next.key, Char2ObjectAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Char2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Char2ObjectAVLTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Char2ObjectAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2ObjectSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2ObjectAVLTreeMap.KeyIterator(Char2ObjectAVLTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2ObjectAVLTreeMap.KeyIterator(Char2ObjectAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2ObjectAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Char2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
