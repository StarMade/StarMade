...
/*  14:    */
/*  59:    */public class Char2ShortMaps
/*  60:    */{
/*  61:    */  public static class EmptyMap
/*  62:    */    extends Char2ShortFunctions.EmptyFunction
/*  63:    */    implements Char2ShortMap, Serializable, Cloneable
/*  64:    */  {
/*  65:    */    public static final long serialVersionUID = -7046029254386353129L;
/*  66:    */    
/*  67: 67 */    public boolean containsValue(short v) { return false; }
/*  68: 68 */    public void putAll(Map<? extends Character, ? extends Short> m) { throw new UnsupportedOperationException(); }
/*  69:    */    
/*  70: 70 */    public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() { return ObjectSets.EMPTY_SET; }
/*  71:    */    
...
/*  76: 76 */    private Object readResolve() { return Char2ShortMaps.EMPTY_MAP; }
/*  77: 77 */    public Object clone() { return Char2ShortMaps.EMPTY_MAP; }
/*  78: 78 */    public boolean isEmpty() { return true; }
/*  79:    */    
/*  80: 80 */    public ObjectSet<Map.Entry<Character, Short>> entrySet() { return char2ShortEntrySet(); }
/*  81:    */    
...
/* 102:    */    extends Char2ShortFunctions.Singleton
/* 103:    */    implements Char2ShortMap, Serializable, Cloneable
/* 104:    */  {
/* 105:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 106:    */    
/* 107:    */    protected volatile transient ObjectSet<Char2ShortMap.Entry> entries;
/* 108:    */    
/* 109:    */    protected volatile transient CharSet keys;
/* 110:    */    
/* 111:    */    protected volatile transient ShortCollection values;
/* 112:    */    
/* 114:    */    protected Singleton(char key, short value)
/* 115:    */    {
/* 116:116 */      super(value);
/* 117:    */    }
/* 118:    */    
...
/* 122:    */    
/* 124:124 */    public void putAll(Map<? extends Character, ? extends Short> m) { throw new UnsupportedOperationException(); }
/* 125:    */    
/* 126:126 */    public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; }
...
/* 129:    */    
/* 130:    */    protected class SingletonEntry implements Char2ShortMap.Entry, Map.Entry<Character, Short> { protected SingletonEntry() {}
/* 131:131 */      public Character getKey() { return Character.valueOf(Char2ShortMaps.Singleton.this.key); }
/* 132:132 */      public Short getValue() { return Short.valueOf(Char2ShortMaps.Singleton.this.value); }
/* 133:    */      
/* 134:    */      public char getCharKey() {
/* 135:135 */        return Char2ShortMaps.Singleton.this.key;
/* 136:    */      }
/* 137:    */      
/* 139:139 */      public short getShortValue() { return Char2ShortMaps.Singleton.this.value; }
...
/* 148:    */        
/* 149:149 */        return (Char2ShortMaps.Singleton.this.key == ((Character)e.getKey()).charValue()) && (Char2ShortMaps.Singleton.this.value == ((Short)e.getValue()).shortValue());
/* 150:    */      }
/* 151:    */      
/* 152:152 */      public int hashCode() { return Char2ShortMaps.Singleton.this.key ^ Char2ShortMaps.Singleton.this.value; }
/* 153:153 */      public String toString() { return Char2ShortMaps.Singleton.this.key + "->" + Char2ShortMaps.Singleton.this.value; }
/* 154:    */    }
/* 155:    */    
/* 156:156 */    public boolean isEmpty() { return false; }
/* 157:    */    
/* 159:159 */    public ObjectSet<Map.Entry<Character, Short>> entrySet() { return char2ShortEntrySet(); }
/* 160:    */    
...
/* 173:    */  }
/* 174:    */  
/* 183:    */  public static Char2ShortMap singleton(char key, short value)
/* 184:    */  {
/* 185:185 */    return new Singleton(key, value);
/* 186:    */  }
/* 187:    */  
/* 198:    */  public static Char2ShortMap singleton(Character key, Short value)
/* 199:    */  {
/* 200:200 */    return new Singleton(key.charValue(), value.shortValue());
/* 201:    */  }
/* 202:    */  
/* 204:    */  public static class SynchronizedMap
/* 205:    */    extends Char2ShortFunctions.SynchronizedFunction
/* 206:    */    implements Char2ShortMap, Serializable
/* 207:    */  {
/* 208:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 209:    */    
/* 210:    */    protected final Char2ShortMap map;
/* 211:    */    
/* 212:    */    protected volatile transient ObjectSet<Char2ShortMap.Entry> entries;
/* 213:    */    
/* 214:    */    protected volatile transient CharSet keys;
/* 215:    */    protected volatile transient ShortCollection values;
/* 216:    */    
/* 217:    */    protected SynchronizedMap(Char2ShortMap m, Object sync)
/* 218:    */    {
/* 219:219 */      super(sync);
/* 220:220 */      this.map = m;
/* 221:    */    }
/* 222:    */    
/* 223:    */    protected SynchronizedMap(Char2ShortMap m) {
/* 224:224 */      super();
/* 225:225 */      this.map = m;
/* 226:    */    }
/* 227:    */    
...
/* 234:    */    
/* 235:235 */    public short put(char k, short v) { synchronized (this.sync) { return this.map.put(k, v);
/* 236:    */      } }
/* 237:    */    
/* 238:238 */    public void putAll(Map<? extends Character, ? extends Short> m) { synchronized (this.sync) { this.map.putAll(m); } }
/* 239:    */    
/* 240:240 */    public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.char2ShortEntrySet(), this.sync); return this.entries; }
...
/* 246:    */      } }
/* 247:    */    
/* 248:248 */    public Short put(Character k, Short v) { synchronized (this.sync) { return (Short)this.map.put(k, v);
/* 249:    */      }
/* 250:    */    }
/* 251:    */    
/* 252:252 */    public short remove(char k) { synchronized (this.sync) { return this.map.remove(k); } }
/* 253:253 */    public short get(char k) { synchronized (this.sync) { return this.map.get(k); } }
...
/* 267:267 */    public ObjectSet<Map.Entry<Character, Short>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); } }
/* 268:    */    
...
/* 273:    */  }
/* 274:    */  
/* 277:    */  public static Char2ShortMap synchronize(Char2ShortMap m)
/* 278:    */  {
/* 279:279 */    return new SynchronizedMap(m);
/* 280:    */  }
/* 281:    */  
/* 287:    */  public static Char2ShortMap synchronize(Char2ShortMap m, Object sync)
/* 288:    */  {
/* 289:289 */    return new SynchronizedMap(m, sync);
/* 290:    */  }
/* 291:    */  
/* 293:    */  public static class UnmodifiableMap
/* 294:    */    extends Char2ShortFunctions.UnmodifiableFunction
/* 295:    */    implements Char2ShortMap, Serializable
/* 296:    */  {
/* 297:    */    public static final long serialVersionUID = -7046029254386353129L;
/* 298:    */    
/* 299:    */    protected final Char2ShortMap map;
/* 300:    */    protected volatile transient ObjectSet<Char2ShortMap.Entry> entries;
/* 301:    */    protected volatile transient CharSet keys;
/* 302:    */    protected volatile transient ShortCollection values;
/* 303:    */    
/* 304:    */    protected UnmodifiableMap(Char2ShortMap m)
/* 305:    */    {
/* 306:306 */      super();
/* 307:307 */      this.map = m;
/* 308:    */    }
...
/* 316:    */    
/* 317:317 */    public short put(char k, short v) { throw new UnsupportedOperationException(); }
/* 318:    */    
/* 320:320 */    public void putAll(Map<? extends Character, ? extends Short> m) { throw new UnsupportedOperationException(); }
/* 321:    */    
/* 322:322 */    public ObjectSet<Char2ShortMap.Entry> char2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.char2ShortEntrySet()); return this.entries; }
...
/* 328:    */    
/* 329:    */    public Short put(Character k, Short v) {
/* 330:330 */      throw new UnsupportedOperationException();
/* 331:    */    }
/* 332:    */    
/* 334:334 */    public short remove(char k) { throw new UnsupportedOperationException(); }
/* 335:335 */    public short get(char k) { return this.map.get(k); }
...
/* 349:349 */    public ObjectSet<Map.Entry<Character, Short>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/* 350:    */  }
/* 351:    */  
/* 356:    */  public static Char2ShortMap unmodifiable(Char2ShortMap m)
/* 357:    */  {
