  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2ShortRBTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2ShortRBTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2ShortRBTreeMap(Map<? extends Character, ? extends Short> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ShortRBTreeMap(SortedMap<Character, Short> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ShortRBTreeMap(Char2ShortMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ShortRBTreeMap(Char2ShortSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ShortRBTreeMap(char[] local_k, short[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2ShortRBTreeMap(char[] local_k, short[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Char2ShortMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Char2ShortRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2ShortRBTreeMap.EntryIterator(Char2ShortRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry from)
        {
          return new Char2ShortRBTreeMap.EntryIterator(Char2ShortRBTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2ShortRBTreeMap.Entry local_f = Char2ShortRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2ShortRBTreeMap.Entry local_f = Char2ShortRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2ShortRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Char2ShortRBTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ShortEntrySet();
        }
        
        public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry local_to)
        {
          return Char2ShortRBTreeMap.this.headMap((Character)local_to.getKey()).char2ShortEntrySet();
        }
        
        public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry from)
        {
          return Char2ShortRBTreeMap.this.tailMap((Character)from.getKey()).char2ShortEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Char2ShortRBTreeMap.ValueIterator(Char2ShortRBTreeMap.this, null);
        }
        
        public boolean contains(short local_k)
        {
          return Char2ShortRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2ShortRBTreeMap local_c;
    try
    {
      local_c = (Char2ShortRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2ShortRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Char2ShortRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2ShortRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator()
          {
            return new Char2ShortRBTreeMap.Submap.SubmapEntryIterator(Char2ShortRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry from)
          {
            return new Char2ShortRBTreeMap.Submap.SubmapEntryIterator(Char2ShortRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, Short> local_e = (Map.Entry)local_o;
            Char2ShortRBTreeMap.Entry local_f = Char2ShortRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2ShortRBTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, Short> local_e = (Map.Entry)local_o;
            Char2ShortRBTreeMap.Entry local_f = Char2ShortRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2ShortRBTreeMap.Submap.this.in2(local_f.key))) {
              Char2ShortRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2ShortRBTreeMap.Submap.SubmapIterator(Char2ShortRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2ShortRBTreeMap.Submap.this.clear();
          }
          
          public Char2ShortMap.Entry first()
          {
            return Char2ShortRBTreeMap.Submap.this.firstEntry();
          }
          
          public Char2ShortMap.Entry last()
          {
            return Char2ShortRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry from, Char2ShortMap.Entry local_to)
          {
            return Char2ShortRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ShortEntrySet();
          }
          
          public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry local_to)
          {
            return Char2ShortRBTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2ShortEntrySet();
          }
          
          public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry from)
          {
            return Char2ShortRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2ShortEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ShortCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractShortCollection()
        {
          public ShortIterator iterator()
          {
            return new Char2ShortRBTreeMap.Submap.SubmapValueIterator(Char2ShortRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(short local_k)
          {
            return Char2ShortRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2ShortRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2ShortRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2ShortRBTreeMap.Entry local_e;
      return (in2(local_kk)) && ((local_e = Char2ShortRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public short put(char local_k, short local_v)
    {
      ...
      short oldValue = Char2ShortRBTreeMap.this.put(local_k, local_v);
    ...
    public short remove(char local_k)
    {
      ...
      short oldValue = Char2ShortRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2ShortRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2ShortRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2ShortSortedMap tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2ShortRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2ShortRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2ShortSortedMap subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2ShortRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2ShortRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2ShortRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2ShortRBTreeMap.this.locateKey(this.from);
        if (Char2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2ShortRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2ShortRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2ShortRBTreeMap.this.locateKey(this.field_47);
        if (Char2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2ShortRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2ShortRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Char2ShortRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Char2ShortRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2ShortRBTreeMap.Submap.this.bottom) && (Char2ShortRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2ShortRBTreeMap.Submap.this.top) && (Char2ShortRBTreeMap.this.compare(local_k, (this.prev = Char2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2ShortRBTreeMap.this.locateKey(local_k);
            if (Char2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2ShortRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2ShortRBTreeMap.this.compare(this.prev.key, Char2ShortRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2ShortRBTreeMap.Submap.this.top) && (this.next != null) && (Char2ShortRBTreeMap.this.compare(this.next.key, Char2ShortRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2ShortSortedMap.KeySet
    {
      ...
      {
        return new Char2ShortRBTreeMap.Submap.SubmapKeyIterator(Char2ShortRBTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2ShortRBTreeMap.Submap.SubmapKeyIterator(Char2ShortRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2ShortSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2ShortRBTreeMap.KeyIterator(Char2ShortRBTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2ShortRBTreeMap.KeyIterator(Char2ShortRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2ShortRBTreeMap.this.locateKey(local_k)) != null) {
        if (Char2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
