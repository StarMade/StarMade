...
/*  18:    */
/*  86:    */public class Char2ReferenceOpenHashMap<V>
/*  87:    */  extends AbstractChar2ReferenceMap<V>
...
/* 100:    */  protected volatile transient Char2ReferenceMap.FastEntrySet<V> entries;
/* 101:    */  protected volatile transient CharSet keys;
/* 102:    */  protected volatile transient ReferenceCollection<V> values;
/* 103:    */  
/* 104:    */  public Char2ReferenceOpenHashMap(int expected, float f)
/* 105:    */  {
...
/* 115:    */  }
/* 116:    */  
/* 119:    */  public Char2ReferenceOpenHashMap(int expected)
/* 120:    */  {
/* 121:121 */    this(expected, 0.75F);
/* 122:    */  }
/* 123:    */  
/* 125:    */  public Char2ReferenceOpenHashMap()
/* 126:    */  {
/* 127:127 */    this(16, 0.75F);
/* 128:    */  }
/* 129:    */  
/* 133:    */  public Char2ReferenceOpenHashMap(Map<? extends Character, ? extends V> m, float f)
/* 134:    */  {
/* 135:135 */    this(m.size(), f);
/* 136:136 */    putAll(m);
/* 137:    */  }
/* 138:    */  
/* 141:    */  public Char2ReferenceOpenHashMap(Map<? extends Character, ? extends V> m)
/* 142:    */  {
/* 143:143 */    this(m, 0.75F);
/* 144:    */  }
/* 145:    */  
/* 149:    */  public Char2ReferenceOpenHashMap(Char2ReferenceMap<V> m, float f)
/* 150:    */  {
/* 151:151 */    this(m.size(), f);
/* 152:152 */    putAll(m);
/* 153:    */  }
/* 154:    */  
/* 157:    */  public Char2ReferenceOpenHashMap(Char2ReferenceMap<V> m)
/* 158:    */  {
/* 159:159 */    this(m, 0.75F);
/* 160:    */  }
/* 161:    */  
/* 167:    */  public Char2ReferenceOpenHashMap(char[] k, V[] v, float f)
/* 168:    */  {
...
/* 173:    */  }
/* 174:    */  
/* 178:    */  public Char2ReferenceOpenHashMap(char[] k, V[] v)
/* 179:    */  {
...
/* 360:    */    implements Char2ReferenceMap.Entry<V>, Map.Entry<Character, V>
/* 361:    */  {
...
/* 367:    */    }
/* 368:    */    
/* 369:369 */    public Character getKey() { return Character.valueOf(Char2ReferenceOpenHashMap.this.key[this.index]); }
/* 370:    */    
/* 371:    */    public char getCharKey() {
/* 372:372 */      return Char2ReferenceOpenHashMap.this.key[this.index];
/* 373:    */    }
/* 374:    */    
/* 375:375 */    public V getValue() { return Char2ReferenceOpenHashMap.this.value[this.index]; }
/* 376:    */    
/* 377:    */    public V setValue(V v) {
/* 378:378 */      V oldValue = Char2ReferenceOpenHashMap.this.value[this.index];
/* 379:379 */      Char2ReferenceOpenHashMap.this.value[this.index] = v;
...
/* 386:386 */      return (Char2ReferenceOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2ReferenceOpenHashMap.this.value[this.index] == e.getValue());
/* 387:    */    }
/* 388:    */    
/* 389:389 */    public int hashCode() { return Char2ReferenceOpenHashMap.this.key[this.index] ^ (Char2ReferenceOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Char2ReferenceOpenHashMap.this.value[this.index])); }
/* 390:    */    
/* 392:392 */    public String toString() { return Char2ReferenceOpenHashMap.this.key[this.index] + "=>" + Char2ReferenceOpenHashMap.this.value[this.index]; } }
/* 393:    */  
...
/* 398:    */    
/* 399:399 */    private MapIterator() { this.pos = Char2ReferenceOpenHashMap.this.n;
/* 400:    */      
/* 402:402 */      this.last = -1;
/* 403:    */      
/* 404:404 */      this.c = Char2ReferenceOpenHashMap.this.size;
/* 405:    */      
/* 409:409 */      boolean[] used = Char2ReferenceOpenHashMap.this.used;
...
/* 421:    */        
/* 422:422 */        int pos = HashCommon.murmurHash3(k) & Char2ReferenceOpenHashMap.this.mask;
/* 423:    */        
/* 424:424 */        while (Char2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 425:425 */          if (Char2ReferenceOpenHashMap.this.key[pos] == k) return pos;
/* 426:426 */          pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask;
/* 427:    */        }
/* 428:    */      }
/* 429:429 */      this.last = this.pos;
/* 430:    */      
/* 431:431 */      if (this.c != 0) {
/* 432:432 */        boolean[] used = Char2ReferenceOpenHashMap.this.used;
...
/* 447:    */      for (;;)
/* 448:    */      {
/* 449:449 */        pos = (last = pos) + 1 & Char2ReferenceOpenHashMap.this.mask;
/* 450:450 */        while (Char2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 451:451 */          int slot = HashCommon.murmurHash3(Char2ReferenceOpenHashMap.this.key[pos]) & Char2ReferenceOpenHashMap.this.mask;
/* 452:452 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453:453 */          pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask;
/* 454:    */        }
/* 455:455 */        if (Char2ReferenceOpenHashMap.this.used[pos] == 0) break;
/* 456:456 */        if (pos < last)
/* 457:    */        {
/* 458:458 */          if (this.wrapped == null) this.wrapped = new CharArrayList();
/* 459:459 */          this.wrapped.add(Char2ReferenceOpenHashMap.this.key[pos]);
/* 460:    */        }
/* 461:461 */        Char2ReferenceOpenHashMap.this.key[last] = Char2ReferenceOpenHashMap.this.key[pos];
/* 462:462 */        Char2ReferenceOpenHashMap.this.value[last] = Char2ReferenceOpenHashMap.this.value[pos];
/* 463:    */      }
/* 464:464 */      Char2ReferenceOpenHashMap.this.used[last] = false;
/* 465:465 */      Char2ReferenceOpenHashMap.this.value[last] = null;
/* 466:466 */      return last;
/* 467:    */    }
/* 468:    */    
...
/* 472:    */      {
/* 473:473 */        Char2ReferenceOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
/* 474:474 */        this.last = -1;
/* 475:475 */        return;
/* 476:    */      }
/* 477:477 */      Char2ReferenceOpenHashMap.this.size -= 1;
...
/* 489:    */    } }
/* 490:    */  
/* 491:491 */  private class EntryIterator extends Char2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Char2ReferenceMap.Entry<V>> { private EntryIterator() { super(null); }
/* 492:    */    
/* 493:    */    private Char2ReferenceOpenHashMap<V>.MapEntry entry;
/* 494:494 */    public Char2ReferenceMap.Entry<V> next() { return this.entry = new Char2ReferenceOpenHashMap.MapEntry(Char2ReferenceOpenHashMap.this, nextEntry()); }
/* 495:    */    
/* 496:    */    public void remove()
/* 497:    */    {
/* 498:498 */      super.remove();
/* 499:499 */      Char2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 500:    */    } }
/* 501:    */  
/* 502:502 */  private class FastEntryIterator extends Char2ReferenceOpenHashMap<V>.MapIterator implements ObjectIterator<Char2ReferenceMap.Entry<V>> { private FastEntryIterator() { super(null); }
/* 503:503 */    final AbstractChar2ReferenceMap.BasicEntry<V> entry = new AbstractChar2ReferenceMap.BasicEntry('\000', null);
/* 504:    */    
/* 505:505 */    public AbstractChar2ReferenceMap.BasicEntry<V> next() { int e = nextEntry();
/* 506:506 */      this.entry.key = Char2ReferenceOpenHashMap.this.key[e];
/* 507:507 */      this.entry.value = Char2ReferenceOpenHashMap.this.value[e];
/* 508:508 */      return this.entry;
/* 509:    */    } }
/* 510:    */  
/* 511:    */  private final class MapEntrySet extends AbstractObjectSet<Char2ReferenceMap.Entry<V>> implements Char2ReferenceMap.FastEntrySet<V> { private MapEntrySet() {}
/* 512:    */    
/* 513:513 */    public ObjectIterator<Char2ReferenceMap.Entry<V>> iterator() { return new Char2ReferenceOpenHashMap.EntryIterator(Char2ReferenceOpenHashMap.this, null); }
/* 514:    */    
/* 515:    */    public ObjectIterator<Char2ReferenceMap.Entry<V>> fastIterator() {
/* 516:516 */      return new Char2ReferenceOpenHashMap.FastEntryIterator(Char2ReferenceOpenHashMap.this, null);
/* 517:    */    }
/* 518:    */    
...
/* 523:    */      
/* 524:524 */      int pos = HashCommon.murmurHash3(k) & Char2ReferenceOpenHashMap.this.mask;
/* 525:    */      
/* 526:526 */      while (Char2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 527:527 */        if (Char2ReferenceOpenHashMap.this.key[pos] == k) return Char2ReferenceOpenHashMap.this.value[pos] == e.getValue();
/* 528:528 */        pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask;
/* 529:    */      }
...
/* 537:    */      
/* 538:538 */      int pos = HashCommon.murmurHash3(k) & Char2ReferenceOpenHashMap.this.mask;
/* 539:    */      
/* 540:540 */      while (Char2ReferenceOpenHashMap.this.used[pos] != 0) {
/* 541:541 */        if (Char2ReferenceOpenHashMap.this.key[pos] == k) {
/* 542:542 */          Char2ReferenceOpenHashMap.this.remove(e.getKey());
/* 543:543 */          return true;
/* 544:    */        }
/* 545:545 */        pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask;
/* 546:    */      }
/* 547:547 */      return false;
/* 548:    */    }
/* 549:    */    
/* 550:550 */    public int size() { return Char2ReferenceOpenHashMap.this.size; }
/* 551:    */    
/* 553:553 */    public void clear() { Char2ReferenceOpenHashMap.this.clear(); }
/* 554:    */  }
/* 555:    */  
/* 556:    */  public Char2ReferenceMap.FastEntrySet<V> char2ReferenceEntrySet() {
...
/* 564:    */    extends Char2ReferenceOpenHashMap.MapIterator
/* 565:    */    implements CharIterator
/* 566:    */  {
/* 567:567 */    public KeyIterator() { super(null); }
/* 568:568 */    public char nextChar() { return Char2ReferenceOpenHashMap.this.key[nextEntry()]; }
/* 569:569 */    public Character next() { return Character.valueOf(Char2ReferenceOpenHashMap.this.key[nextEntry()]); } }
/* 570:    */  
/* 571:    */  private final class KeySet extends AbstractCharSet { private KeySet() {}
/* 572:    */    
/* 573:573 */    public CharIterator iterator() { return new Char2ReferenceOpenHashMap.KeyIterator(Char2ReferenceOpenHashMap.this); }
/* 574:    */    
/* 575:    */    public int size() {
/* 576:576 */      return Char2ReferenceOpenHashMap.this.size;
/* 577:    */    }
/* 578:    */    
/* 579:579 */    public boolean contains(char k) { return Char2ReferenceOpenHashMap.this.containsKey(k); }
/* 580:    */    
/* 581:    */    public boolean remove(char k) {
/* 582:582 */      int oldSize = Char2ReferenceOpenHashMap.this.size;
/* 583:583 */      Char2ReferenceOpenHashMap.this.remove(k);
/* 584:584 */      return Char2ReferenceOpenHashMap.this.size != oldSize;
/* 585:    */    }
/* 586:    */    
/* 587:587 */    public void clear() { Char2ReferenceOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
...
/* 598:    */    extends Char2ReferenceOpenHashMap<V>.MapIterator
/* 599:    */    implements ObjectIterator<V>
/* 600:    */  {
/* 601:601 */    public ValueIterator() { super(null); }
/* 602:602 */    public V next() { return Char2ReferenceOpenHashMap.this.value[nextEntry()]; }
/* 603:    */  }
/* 604:    */  
...
/* 607:607 */          return new Char2ReferenceOpenHashMap.ValueIterator(Char2ReferenceOpenHashMap.this);
/* 608:    */        }
/* 609:    */        
/* 610:610 */        public int size() { return Char2ReferenceOpenHashMap.this.size; }
/* 611:    */        
/* 612:    */        public boolean contains(Object v) {
/* 613:613 */          return Char2ReferenceOpenHashMap.this.containsValue(v);
/* 614:    */        }
/* 615:    */        
/* 616:616 */        public void clear() { Char2ReferenceOpenHashMap.this.clear(); }
/* 617:    */      };
/* 618:    */    }
...
/* 719:    */  }
/* 720:    */  
/* 724:    */  public Char2ReferenceOpenHashMap<V> clone()
/* 725:    */  {
/* 726:    */    Char2ReferenceOpenHashMap<V> c;
/* 727:    */    
/* 729:    */    try
/* 730:    */    {
/* 731:731 */      c = (Char2ReferenceOpenHashMap)super.clone();
/* 732:    */    }
...
/* 768:768 */    Char2ReferenceOpenHashMap<V>.MapIterator i = new MapIterator(null);
