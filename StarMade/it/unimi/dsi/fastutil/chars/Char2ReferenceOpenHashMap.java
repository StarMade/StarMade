  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2ReferenceOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2ReferenceOpenHashMap(Map<? extends Character, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ReferenceOpenHashMap(Map<? extends Character, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ReferenceOpenHashMap(Char2ReferenceMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ReferenceOpenHashMap(Char2ReferenceMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ReferenceOpenHashMap(char[] local_k, V[] local_v, float local_f)
  {
  ...
  public Char2ReferenceOpenHashMap(char[] local_k, V[] local_v)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Char2ReferenceOpenHashMap.ValueIterator(Char2ReferenceOpenHashMap.this);
        }
        ...
        {
          return Char2ReferenceOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2ReferenceOpenHashMap<V> local_c;
    try
    {
      local_c = (Char2ReferenceOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    char[] key = this.key;
    V[] value = this.value;
    Char2ReferenceOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractCharSet
  {
    ...
    {
      return new Char2ReferenceOpenHashMap.KeyIterator(Char2ReferenceOpenHashMap.this);
    }
    ...
    {
      return Char2ReferenceOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2ReferenceOpenHashMap.this.size;
      Char2ReferenceOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Char2ReferenceOpenHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Char2ReferenceOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2ReferenceMap.FastEntrySet<V>
  {
    ...
    {
      return new Char2ReferenceOpenHashMap.EntryIterator(Char2ReferenceOpenHashMap.this, null);
    }
    
    public ObjectIterator<Char2ReferenceMap.Entry<V>> fastIterator()
    {
      return new Char2ReferenceOpenHashMap.FastEntryIterator(Char2ReferenceOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ReferenceOpenHashMap.this.mask; Char2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask) {
        if (Char2ReferenceOpenHashMap.this.key[pos] == local_k) {
          return Char2ReferenceOpenHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ReferenceOpenHashMap.this.mask; Char2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask) {
        if (Char2ReferenceOpenHashMap.this.key[pos] == local_k)
        {
          Char2ReferenceOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2ReferenceMap.Entry<V>>
  {
    ...
    public AbstractChar2ReferenceMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Char2ReferenceOpenHashMap.this.key[local_e];
      this.entry.value = Char2ReferenceOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2ReferenceMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Char2ReferenceOpenHashMap.MapEntry(Char2ReferenceOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2ReferenceOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2ReferenceOpenHashMap.this.field_49;
    int last = -1;
    int field_511 = Char2ReferenceOpenHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2ReferenceOpenHashMap.this.used;
      while ((this.field_511 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_511 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      if (this.field_511 != 0)
      {
        boolean[] local_k = Char2ReferenceOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2ReferenceOpenHashMap.this.mask; Char2ReferenceOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ReferenceOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2ReferenceOpenHashMap.this.key[pos]) & Char2ReferenceOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2ReferenceOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2ReferenceOpenHashMap.this.key[pos]);
        }
        Char2ReferenceOpenHashMap.this.key[last] = Char2ReferenceOpenHashMap.this.key[pos];
        Char2ReferenceOpenHashMap.this.value[last] = Char2ReferenceOpenHashMap.this.value[pos];
      }
      Char2ReferenceOpenHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2ReferenceOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2ReferenceOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_511 > 0))
      {
        this.field_511 += 1;
        nextEntry();
      }
    ...
    implements Char2ReferenceMap.Entry<V>, Map.Entry<Character, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Char2ReferenceOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, V> local_e = (Map.Entry)local_o;
      return (Char2ReferenceOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2ReferenceOpenHashMap.this.value[this.index] == local_e.getValue());
    }
