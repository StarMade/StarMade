  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2FloatRBTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2FloatRBTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2FloatRBTreeMap(Map<? extends Character, ? extends Float> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2FloatRBTreeMap(SortedMap<Character, Float> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2FloatRBTreeMap(Char2FloatMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2FloatRBTreeMap(Char2FloatSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2FloatRBTreeMap(char[] local_k, float[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2FloatRBTreeMap(char[] local_k, float[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Char2FloatMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Char2FloatRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2FloatRBTreeMap.EntryIterator(Char2FloatRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from)
        {
          return new Char2FloatRBTreeMap.EntryIterator(Char2FloatRBTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2FloatRBTreeMap.Entry local_f = Char2FloatRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2FloatRBTreeMap.Entry local_f = Char2FloatRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2FloatRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Char2FloatRBTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2FloatEntrySet();
        }
        
        public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry local_to)
        {
          return Char2FloatRBTreeMap.this.headMap((Character)local_to.getKey()).char2FloatEntrySet();
        }
        
        public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from)
        {
          return Char2FloatRBTreeMap.this.tailMap((Character)from.getKey()).char2FloatEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Char2FloatRBTreeMap.ValueIterator(Char2FloatRBTreeMap.this, null);
        }
        
        public boolean contains(float local_k)
        {
          return Char2FloatRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2FloatRBTreeMap local_c;
    try
    {
      local_c = (Char2FloatRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2FloatRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Char2FloatRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2FloatRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2FloatMap.Entry> char2FloatEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator()
          {
            return new Char2FloatRBTreeMap.Submap.SubmapEntryIterator(Char2FloatRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from)
          {
            return new Char2FloatRBTreeMap.Submap.SubmapEntryIterator(Char2FloatRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, Float> local_e = (Map.Entry)local_o;
            Char2FloatRBTreeMap.Entry local_f = Char2FloatRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2FloatRBTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, Float> local_e = (Map.Entry)local_o;
            Char2FloatRBTreeMap.Entry local_f = Char2FloatRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2FloatRBTreeMap.Submap.this.in2(local_f.key))) {
              Char2FloatRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2FloatRBTreeMap.Submap.SubmapIterator(Char2FloatRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2FloatRBTreeMap.Submap.this.clear();
          }
          
          public Char2FloatMap.Entry first()
          {
            return Char2FloatRBTreeMap.Submap.this.firstEntry();
          }
          
          public Char2FloatMap.Entry last()
          {
            return Char2FloatRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry from, Char2FloatMap.Entry local_to)
          {
            return Char2FloatRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2FloatEntrySet();
          }
          
          public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry local_to)
          {
            return Char2FloatRBTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2FloatEntrySet();
          }
          
          public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry from)
          {
            return Char2FloatRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2FloatEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public FloatCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractFloatCollection()
        {
          public FloatIterator iterator()
          {
            return new Char2FloatRBTreeMap.Submap.SubmapValueIterator(Char2FloatRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(float local_k)
          {
            return Char2FloatRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2FloatRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2FloatRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2FloatRBTreeMap.Entry local_e;
      return (in2(local_kk)) && ((local_e = Char2FloatRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public float put(char local_k, float local_v)
    {
      ...
      float oldValue = Char2FloatRBTreeMap.this.put(local_k, local_v);
    ...
    public float remove(char local_k)
    {
      ...
      float oldValue = Char2FloatRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2FloatRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2FloatRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2FloatRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2FloatSortedMap tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2FloatRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2FloatRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2FloatSortedMap subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2FloatRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2FloatRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2FloatRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2FloatRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2FloatRBTreeMap.this.locateKey(this.from);
        if (Char2FloatRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2FloatRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2FloatRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2FloatRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2FloatRBTreeMap.this.locateKey(this.field_47);
        if (Char2FloatRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2FloatRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2FloatRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2FloatRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Char2FloatRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Char2FloatRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2FloatRBTreeMap.Submap.this.bottom) && (Char2FloatRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2FloatRBTreeMap.Submap.this.top) && (Char2FloatRBTreeMap.this.compare(local_k, (this.prev = Char2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2FloatRBTreeMap.this.locateKey(local_k);
            if (Char2FloatRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2FloatRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2FloatRBTreeMap.this.compare(this.prev.key, Char2FloatRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2FloatRBTreeMap.Submap.this.top) && (this.next != null) && (Char2FloatRBTreeMap.this.compare(this.next.key, Char2FloatRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2FloatSortedMap.KeySet
    {
      ...
      {
        return new Char2FloatRBTreeMap.Submap.SubmapKeyIterator(Char2FloatRBTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2FloatRBTreeMap.Submap.SubmapKeyIterator(Char2FloatRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2FloatSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2FloatRBTreeMap.KeyIterator(Char2FloatRBTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2FloatRBTreeMap.KeyIterator(Char2FloatRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2FloatRBTreeMap.this.locateKey(local_k)) != null) {
        if (Char2FloatRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
