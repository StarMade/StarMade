  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2DoubleOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2DoubleOpenHashMap(Map<? extends Character, ? extends Double> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2DoubleOpenHashMap(Map<? extends Character, ? extends Double> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2DoubleOpenHashMap(Char2DoubleMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2DoubleOpenHashMap(Char2DoubleMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2DoubleOpenHashMap(char[] local_k, double[] local_v, float local_f)
  {
  ...
  public Char2DoubleOpenHashMap(char[] local_k, double[] local_v)
  {
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Char2DoubleOpenHashMap.ValueIterator(Char2DoubleOpenHashMap.this);
        }
        ...
        {
          return Char2DoubleOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2DoubleOpenHashMap local_c;
    try
    {
      local_c = (Char2DoubleOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2DoubleOpenHashMap.MapIterator
    implements DoubleIterator
  {
    ...
    public Double next()
    {
      return Double.valueOf(Char2DoubleOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSet
  {
    ...
    {
      return new Char2DoubleOpenHashMap.KeyIterator(Char2DoubleOpenHashMap.this);
    }
    ...
    {
      return Char2DoubleOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2DoubleOpenHashMap.this.size;
      Char2DoubleOpenHashMap.this.remove(local_k);
    ...
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Char2DoubleOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2DoubleMap.FastEntrySet
  {
    ...
    {
      return new Char2DoubleOpenHashMap.EntryIterator(Char2DoubleOpenHashMap.this, null);
    }
    
    public ObjectIterator<Char2DoubleMap.Entry> fastIterator()
    {
      return new Char2DoubleOpenHashMap.FastEntryIterator(Char2DoubleOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2DoubleOpenHashMap.this.mask; Char2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2DoubleOpenHashMap.this.mask) {
        if (Char2DoubleOpenHashMap.this.key[pos] == local_k) {
          return Char2DoubleOpenHashMap.this.value[pos] == ((Double)local_e.getValue()).doubleValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2DoubleOpenHashMap.this.mask; Char2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2DoubleOpenHashMap.this.mask) {
        if (Char2DoubleOpenHashMap.this.key[pos] == local_k)
        {
          Char2DoubleOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2DoubleMap.Entry>
  {
    ...
    public AbstractChar2DoubleMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2DoubleOpenHashMap.this.key[local_e];
      this.entry.value = Char2DoubleOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2DoubleMap.Entry>
  {
    ...
    {
      return this.entry = new Char2DoubleOpenHashMap.MapEntry(Char2DoubleOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2DoubleOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2DoubleOpenHashMap.this.field_49;
    int last = -1;
    int field_566 = Char2DoubleOpenHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2DoubleOpenHashMap.this.used;
      while ((this.field_566 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_566 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      if (this.field_566 != 0)
      {
        boolean[] local_k = Char2DoubleOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2DoubleOpenHashMap.this.mask; Char2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2DoubleOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2DoubleOpenHashMap.this.key[pos]) & Char2DoubleOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2DoubleOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2DoubleOpenHashMap.this.key[pos]);
        }
        Char2DoubleOpenHashMap.this.key[last] = Char2DoubleOpenHashMap.this.key[pos];
        Char2DoubleOpenHashMap.this.value[last] = Char2DoubleOpenHashMap.this.value[pos];
      }
      Char2DoubleOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2DoubleOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2DoubleOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_566 > 0))
      {
        this.field_566 += 1;
        nextEntry();
      }
    ...
    implements Char2DoubleMap.Entry, Map.Entry<Character, Double>
  {
    ...
    public double setValue(double local_v)
    {
      ...
      Char2DoubleOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Double> local_e = (Map.Entry)local_o;
      return (Char2DoubleOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2DoubleOpenHashMap.this.value[this.index] == ((Double)local_e.getValue()).doubleValue());
    }
