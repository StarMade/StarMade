...
/*     */ 
/*     */ public class Char2DoubleOpenHashMap extends AbstractChar2DoubleMap
...
/* 642 */           return new Char2DoubleOpenHashMap.ValueIterator(Char2DoubleOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Char2DoubleOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(double v) {
/* 648 */           return Char2DoubleOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Char2DoubleOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Char2DoubleOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Char2DoubleOpenHashMap.MapIterator
/*     */     implements DoubleIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public double nextDouble() { return Char2DoubleOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Double next() { return Double.valueOf(Char2DoubleOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Char2DoubleOpenHashMap.KeyIterator(Char2DoubleOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Char2DoubleOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(char k) {
/* 613 */       return Char2DoubleOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(char k) {
/* 616 */       int oldSize = Char2DoubleOpenHashMap.this.size;
/* 617 */       Char2DoubleOpenHashMap.this.remove(k);
/* 618 */       return Char2DoubleOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Char2DoubleOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Char2DoubleOpenHashMap.MapIterator
/*     */     implements CharIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public char nextChar() { return Char2DoubleOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Character next() { return Character.valueOf(Char2DoubleOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Char2DoubleOpenHashMap.EntryIterator(Char2DoubleOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Char2DoubleMap.Entry> fastIterator() {
/* 550 */       return new Char2DoubleOpenHashMap.FastEntryIterator(Char2DoubleOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Char2DoubleOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Char2DoubleOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Char2DoubleOpenHashMap.this.key[pos] == k) return Char2DoubleOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/* 562 */         pos = pos + 1 & Char2DoubleOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Char2DoubleOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Char2DoubleOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Char2DoubleOpenHashMap.this.key[pos] == k) {
/* 576 */           Char2DoubleOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Char2DoubleOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Char2DoubleOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Char2DoubleOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Char2DoubleOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Char2DoubleMap.Entry>
/*     */   {
/* 537 */     final AbstractChar2DoubleMap.BasicEntry entry = new AbstractChar2DoubleMap.BasicEntry('\000', 0.0D);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Char2DoubleOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Char2DoubleOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Char2DoubleOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Char2DoubleMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Char2DoubleOpenHashMap.MapEntry(Char2DoubleOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Char2DoubleOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Char2DoubleOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Char2DoubleOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Char2DoubleOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Char2DoubleOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Char2DoubleOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Char2DoubleOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Char2DoubleOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Char2DoubleOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Char2DoubleOpenHashMap.this.mask;
/* 485 */         while (Char2DoubleOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Char2DoubleOpenHashMap.this.key[pos]) & Char2DoubleOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Char2DoubleOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Char2DoubleOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new CharArrayList();
/* 494 */           this.wrapped.add(Char2DoubleOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Char2DoubleOpenHashMap.this.key[last] = Char2DoubleOpenHashMap.this.key[pos];
/* 497 */         Char2DoubleOpenHashMap.this.value[last] = Char2DoubleOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Char2DoubleOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Char2DoubleOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Char2DoubleOpenHashMap.this.size -= 1;
...
/* 398 */       return Character.valueOf(Char2DoubleOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public char getCharKey() {
/* 401 */       return Char2DoubleOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Double getValue() {
/* 404 */       return Double.valueOf(Char2DoubleOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public double getDoubleValue() {
/* 407 */       return Char2DoubleOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public double setValue(double v) {
/* 410 */       double oldValue = Char2DoubleOpenHashMap.this.value[this.index];
/* 411 */       Char2DoubleOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Double setValue(Double v) {
...
/* 421 */       return (Char2DoubleOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2DoubleOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Char2DoubleOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Char2DoubleOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 427 */       return Char2DoubleOpenHashMap.this.key[this.index] + "=>" + Char2DoubleOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
