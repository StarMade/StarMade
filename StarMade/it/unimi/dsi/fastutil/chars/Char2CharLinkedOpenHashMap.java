...
/*  746 */   public Char2CharSortedMap tailMap(char from) { throw new UnsupportedOperationException(); } 
/*  747 */   public Char2CharSortedMap headMap(char to) { throw new UnsupportedOperationException(); } 
/*  748 */   public Char2CharSortedMap subMap(char from, char to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1067 */           return new Char2CharLinkedOpenHashMap.ValueIterator(Char2CharLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1070 */           return Char2CharLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(char v) {
/* 1073 */           return Char2CharLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1076 */           Char2CharLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1209 */       c = (Char2CharLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2CharLinkedOpenHashMap.MapIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public char previousChar()
/*      */     {
/* 1054 */       return Char2CharLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1055 */     public Character previous() { return Character.valueOf(Char2CharLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1061 */     public char nextChar() { return Char2CharLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1062 */     public Character next() { return Character.valueOf(Char2CharLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1011 */       return new Char2CharLinkedOpenHashMap.KeyIterator(Char2CharLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public CharListIterator iterator() {
/* 1014 */       return new Char2CharLinkedOpenHashMap.KeyIterator(Char2CharLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1017 */       return Char2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(char k) {
/* 1020 */       return Char2CharLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(char k) {
/* 1023 */       int oldSize = Char2CharLinkedOpenHashMap.this.size;
/* 1024 */       Char2CharLinkedOpenHashMap.this.remove(k);
/* 1025 */       return Char2CharLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1028 */       Char2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public char firstChar() {
/* 1031 */       if (Char2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1032 */       return Char2CharLinkedOpenHashMap.this.key[Char2CharLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public char lastChar() {
/* 1035 */       if (Char2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1036 */       return Char2CharLinkedOpenHashMap.this.key[Char2CharLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2CharLinkedOpenHashMap.MapIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator(char k)
/*      */     {
/*  998 */       super(k, null); } 
/*  999 */     public char previousChar() { return Char2CharLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1002 */     public Character previous() { return Character.valueOf(Char2CharLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1006 */     public char nextChar() { return Char2CharLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1007 */     public Character next() { return Character.valueOf(Char2CharLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Char2CharMap.Entry>
...
/*      */     {
/*  926 */       return new Char2CharLinkedOpenHashMap.EntryIterator(Char2CharLinkedOpenHashMap.this);
/*      */     }
/*  928 */     public Comparator<? super Char2CharMap.Entry> comparator() { return null; } 
/*  929 */     public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry fromElement, Char2CharMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  930 */     public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  931 */     public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Char2CharMap.Entry first() {
/*  933 */       if (Char2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  934 */       return new Char2CharLinkedOpenHashMap.MapEntry(Char2CharLinkedOpenHashMap.this, Char2CharLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Char2CharMap.Entry last() {
/*  937 */       if (Char2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  938 */       return new Char2CharLinkedOpenHashMap.MapEntry(Char2CharLinkedOpenHashMap.this, Char2CharLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  946 */       int pos = HashCommon.murmurHash3(k) & Char2CharLinkedOpenHashMap.this.mask;
/*      */ 
/*  948 */       while (Char2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  949 */         if (Char2CharLinkedOpenHashMap.this.key[pos] == k) return Char2CharLinkedOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/*  950 */         pos = pos + 1 & Char2CharLinkedOpenHashMap.this.mask;
/*      */       }
/*  952 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  960 */       int pos = HashCommon.murmurHash3(k) & Char2CharLinkedOpenHashMap.this.mask;
/*      */ 
/*  962 */       while (Char2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  963 */         if (Char2CharLinkedOpenHashMap.this.key[pos] == k) {
/*  964 */           Char2CharLinkedOpenHashMap.this.remove(e.getKey());
/*  965 */           return true;
/*      */         }
/*  967 */         pos = pos + 1 & Char2CharLinkedOpenHashMap.this.mask;
/*      */       }
/*  969 */       return false;
/*      */     }
/*      */     public int size() {
/*  972 */       return Char2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  975 */       Char2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry from) {
/*  978 */       return new Char2CharLinkedOpenHashMap.EntryIterator(Char2CharLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2CharMap.Entry> fastIterator() {
/*  981 */       return new Char2CharLinkedOpenHashMap.FastEntryIterator(Char2CharLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2CharMap.Entry> fastIterator(Char2CharMap.Entry from) {
/*  984 */       return new Char2CharLinkedOpenHashMap.FastEntryIterator(Char2CharLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Char2CharLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Char2CharMap.Entry>
/*      */   {
/*  904 */     final AbstractChar2CharMap.BasicEntry entry = new AbstractChar2CharMap.BasicEntry('\000', '\000');
/*      */ 
...
/*  910 */       int e = nextEntry();
/*  911 */       this.entry.key = Char2CharLinkedOpenHashMap.this.key[e];
/*  912 */       this.entry.value = Char2CharLinkedOpenHashMap.this.value[e];
/*  913 */       return this.entry;
/*      */     }
/*      */     public AbstractChar2CharMap.BasicEntry previous() {
/*  916 */       int e = previousEntry();
/*  917 */       this.entry.key = Char2CharLinkedOpenHashMap.this.key[e];
/*  918 */       this.entry.value = Char2CharLinkedOpenHashMap.this.value[e];
/*  919 */       return this.entry;
/*      */     }
/*  921 */     public void set(Char2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  922 */     public void add(Char2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2CharLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Char2CharMap.Entry>
/*      */   {
...
/*  890 */       return this.entry = new Char2CharLinkedOpenHashMap.MapEntry(Char2CharLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Char2CharLinkedOpenHashMap.MapEntry previous() {
/*  893 */       return this.entry = new Char2CharLinkedOpenHashMap.MapEntry(Char2CharLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  897 */       super.remove();
/*  898 */       Char2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  900 */     public void set(Char2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  901 */     public void add(Char2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  763 */     int index = -1;
/*      */ 
/*  765 */     private MapIterator() { this.next = Char2CharLinkedOpenHashMap.this.first;
/*  766 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(char from) {
/*  769 */       if (Char2CharLinkedOpenHashMap.this.key[Char2CharLinkedOpenHashMap.this.last] == from) {
/*  770 */         this.prev = Char2CharLinkedOpenHashMap.this.last;
/*  771 */         this.index = Char2CharLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  775 */         int pos = HashCommon.murmurHash3(from) & Char2CharLinkedOpenHashMap.this.mask;
/*      */ 
/*  777 */         while (Char2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  778 */           if (Char2CharLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  780 */             this.next = ((int)Char2CharLinkedOpenHashMap.this.link[pos]);
/*  781 */             this.prev = pos;
/*  782 */             return;
/*      */           }
/*  784 */           pos = pos + 1 & Char2CharLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  797 */       if (this.next == -1) {
/*  798 */         this.index = Char2CharLinkedOpenHashMap.this.size;
/*  799 */         return;
/*      */       }
/*  801 */       int pos = Char2CharLinkedOpenHashMap.this.first;
/*  802 */       this.index = 1;
/*  803 */       while (pos != this.prev) {
/*  804 */         pos = (int)Char2CharLinkedOpenHashMap.this.link[pos];
/*  805 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  817 */       if (!hasNext()) return Char2CharLinkedOpenHashMap.this.size();
/*  818 */       this.curr = this.next;
/*  819 */       this.next = ((int)Char2CharLinkedOpenHashMap.this.link[this.curr]);
...
/*  827 */       this.prev = ((int)(Char2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  839 */         this.index -= 1;
/*  840 */         this.prev = ((int)(Char2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  843 */         this.next = ((int)Char2CharLinkedOpenHashMap.this.link[this.curr]);
/*  844 */       }Char2CharLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  847 */       if (this.prev == -1) Char2CharLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  849 */         Char2CharLinkedOpenHashMap.this.link[this.prev] ^= (Char2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  850 */       if (this.next == -1) Char2CharLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  852 */         Char2CharLinkedOpenHashMap.this.link[this.next] ^= (Char2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  856 */         pos = (last = pos) + 1 & Char2CharLinkedOpenHashMap.this.mask;
/*  857 */         while (Char2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  858 */           int slot = HashCommon.murmurHash3(Char2CharLinkedOpenHashMap.this.key[pos]) & Char2CharLinkedOpenHashMap.this.mask;
/*  859 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  860 */           pos = pos + 1 & Char2CharLinkedOpenHashMap.this.mask;
/*      */         }
/*  862 */         if (Char2CharLinkedOpenHashMap.this.used[pos] == 0) break;
/*  863 */         Char2CharLinkedOpenHashMap.this.key[last] = Char2CharLinkedOpenHashMap.this.key[pos];
/*  864 */         Char2CharLinkedOpenHashMap.this.value[last] = Char2CharLinkedOpenHashMap.this.value[pos];
/*  865 */         if (this.next == pos) this.next = last;
/*  866 */         if (this.prev == pos) this.prev = last;
/*  867 */         Char2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  869 */       Char2CharLinkedOpenHashMap.this.used[last] = false;
/*  870 */       this.curr = -1;
/*      */     }
...
/*  629 */       return Character.valueOf(Char2CharLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public char getCharKey() {
/*  632 */       return Char2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Character getValue() {
/*  635 */       return Character.valueOf(Char2CharLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public char getCharValue() {
/*  638 */       return Char2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public char setValue(char v) {
/*  641 */       char oldValue = Char2CharLinkedOpenHashMap.this.value[this.index];
/*  642 */       Char2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  643 */       return oldValue;
/*      */     }
...
/*  652 */       return (Char2CharLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     public int hashCode() {
/*  655 */       return Char2CharLinkedOpenHashMap.this.key[this.index] ^ Char2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  658 */       return Char2CharLinkedOpenHashMap.this.key[this.index] + "=>" + Char2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
