...
/*  786 */   public Char2ByteSortedMap tailMap(char from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Char2ByteSortedMap headMap(char to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Char2ByteSortedMap subMap(char from, char to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Char2ByteLinkedOpenHashMap.ValueIterator(Char2ByteLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Char2ByteLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(byte v) {
/* 1113 */           return Char2ByteLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Char2ByteLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Char2ByteLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public byte previousByte()
/*      */     {
/* 1094 */       return Char2ByteLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Byte previous() { return Byte.valueOf(Char2ByteLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public byte nextByte() { return Char2ByteLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Byte next() { return Byte.valueOf(Char2ByteLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Char2ByteLinkedOpenHashMap.KeyIterator(Char2ByteLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public CharListIterator iterator() {
/* 1054 */       return new Char2ByteLinkedOpenHashMap.KeyIterator(Char2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Char2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(char k) {
/* 1060 */       return Char2ByteLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(char k) {
/* 1063 */       int oldSize = Char2ByteLinkedOpenHashMap.this.size;
/* 1064 */       Char2ByteLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Char2ByteLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Char2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public char firstChar() {
/* 1071 */       if (Char2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Char2ByteLinkedOpenHashMap.this.key[Char2ByteLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public char lastChar() {
/* 1075 */       if (Char2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Char2ByteLinkedOpenHashMap.this.key[Char2ByteLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2ByteLinkedOpenHashMap.MapIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator(char k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public char previousChar() { return Char2ByteLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Character previous() { return Character.valueOf(Char2ByteLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public char nextChar() { return Char2ByteLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Character next() { return Character.valueOf(Char2ByteLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Char2ByteMap.Entry>
...
/*      */     {
/*  966 */       return new Char2ByteLinkedOpenHashMap.EntryIterator(Char2ByteLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Char2ByteMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry fromElement, Char2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Char2ByteMap.Entry first() {
/*  973 */       if (Char2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this, Char2ByteLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Char2ByteMap.Entry last() {
/*  977 */       if (Char2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this, Char2ByteLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Char2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Char2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Char2ByteLinkedOpenHashMap.this.key[pos] == k) return Char2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/*  990 */         pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Char2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Char2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Char2ByteLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Char2ByteLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Char2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Char2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from) {
/* 1018 */       return new Char2ByteLinkedOpenHashMap.EntryIterator(Char2ByteLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ByteMap.Entry> fastIterator() {
/* 1021 */       return new Char2ByteLinkedOpenHashMap.FastEntryIterator(Char2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ByteMap.Entry> fastIterator(Char2ByteMap.Entry from) {
/* 1024 */       return new Char2ByteLinkedOpenHashMap.FastEntryIterator(Char2ByteLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Char2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Char2ByteMap.Entry>
/*      */   {
/*  944 */     final AbstractChar2ByteMap.BasicEntry entry = new AbstractChar2ByteMap.BasicEntry('\000', (byte)0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Char2ByteLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Char2ByteLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractChar2ByteMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Char2ByteLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Char2ByteLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Char2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Char2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Char2ByteMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Char2ByteLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Char2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Char2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Char2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Char2ByteLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(char from) {
/*  809 */       if (Char2ByteLinkedOpenHashMap.this.key[Char2ByteLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Char2ByteLinkedOpenHashMap.this.last;
/*  811 */         this.index = Char2ByteLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Char2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Char2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Char2ByteLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Char2ByteLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Char2ByteLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Char2ByteLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Char2ByteLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Char2ByteLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Char2ByteLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Char2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Char2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Char2ByteLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Char2ByteLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Char2ByteLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Char2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Char2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Char2ByteLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Char2ByteLinkedOpenHashMap.this.link[this.next] ^= (Char2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Char2ByteLinkedOpenHashMap.this.mask;
/*  897 */         while (Char2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Char2ByteLinkedOpenHashMap.this.key[pos]) & Char2ByteLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Char2ByteLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Char2ByteLinkedOpenHashMap.this.key[last] = Char2ByteLinkedOpenHashMap.this.key[pos];
/*  904 */         Char2ByteLinkedOpenHashMap.this.value[last] = Char2ByteLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Char2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Char2ByteLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*  669 */       return Character.valueOf(Char2ByteLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public char getCharKey() {
/*  672 */       return Char2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Byte getValue() {
/*  675 */       return Byte.valueOf(Char2ByteLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public byte getByteValue() {
/*  678 */       return Char2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public byte setValue(byte v) {
/*  681 */       byte oldValue = Char2ByteLinkedOpenHashMap.this.value[this.index];
/*  682 */       Char2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Byte setValue(Byte v) {
...
/*  692 */       return (Char2ByteLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Char2ByteLinkedOpenHashMap.this.key[this.index] ^ Char2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Char2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Char2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
