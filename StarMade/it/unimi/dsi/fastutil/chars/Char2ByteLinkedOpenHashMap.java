  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2ByteLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2ByteLinkedOpenHashMap(Map<? extends Character, ? extends Byte> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ByteLinkedOpenHashMap(Map<? extends Character, ? extends Byte> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ByteLinkedOpenHashMap(Char2ByteMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ByteLinkedOpenHashMap(Char2ByteMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ByteLinkedOpenHashMap(char[] local_k, byte[] local_v, float local_f)
  {
  ...
  public Char2ByteLinkedOpenHashMap(char[] local_k, byte[] local_v)
  {
  ...
  public byte add(char local_k, byte incr)
  {
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k)
      {
  ...
  public byte getAndMoveToFirst(char local_k)
  {
    char[] key = this.key;
  ...
  public byte getAndMoveToLast(char local_k)
  {
    char[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public byte putAndMoveToFirst(char local_k, byte local_v)
  {
    char[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public byte putAndMoveToLast(char local_k, byte local_v)
  {
    char[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public Byte get(Character local_ok)
  {
    char local_k = local_ok.charValue();
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k) {
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Char2ByteLinkedOpenHashMap.ValueIterator(Char2ByteLinkedOpenHashMap.this);
        }
        ...
        {
          return Char2ByteLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2ByteLinkedOpenHashMap local_c;
    try
    {
      local_c = (Char2ByteLinkedOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2ByteLinkedOpenHashMap.MapIterator
    implements ByteListIterator
  {
    public byte previousByte()
    {
      return Char2ByteLinkedOpenHashMap.this.value[previousEntry()];
    }
    
    public Byte previous()
    {
      return Byte.valueOf(Char2ByteLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    {
      return Char2ByteLinkedOpenHashMap.this.value[nextEntry()];
    }
    
    public Byte next()
    {
      return Byte.valueOf(Char2ByteLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSortedSet
  {
    ...
    {
      return new Char2ByteLinkedOpenHashMap.KeyIterator(Char2ByteLinkedOpenHashMap.this, from);
    }
    
    public CharListIterator iterator()
    {
      return new Char2ByteLinkedOpenHashMap.KeyIterator(Char2ByteLinkedOpenHashMap.this);
    }
    ...
    {
      return Char2ByteLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2ByteLinkedOpenHashMap.this.size;
      Char2ByteLinkedOpenHashMap.this.remove(local_k);
    ...
    implements CharListIterator
  {
    ...
    {
      return Char2ByteLinkedOpenHashMap.this.key[previousEntry()];
    }
    ...
    {
      return Character.valueOf(Char2ByteLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    {
      return Char2ByteLinkedOpenHashMap.this.key[nextEntry()];
    }
    
    public Character next()
    {
      return Character.valueOf(Char2ByteLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2ByteSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Char2ByteLinkedOpenHashMap.EntryIterator(Char2ByteLinkedOpenHashMap.this);
    }
    ...
    public Char2ByteMap.Entry first()
    {
      ...
      return new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this, Char2ByteLinkedOpenHashMap.this.first);
    }
    ...
    public Char2ByteMap.Entry last()
    {
      ...
      return new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this, Char2ByteLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ByteLinkedOpenHashMap.this.mask; Char2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask) {
        if (Char2ByteLinkedOpenHashMap.this.key[pos] == local_k) {
          return Char2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ByteLinkedOpenHashMap.this.mask; Char2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask) {
        if (Char2ByteLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Char2ByteLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Char2ByteLinkedOpenHashMap.EntryIterator(Char2ByteLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
    }
    
    public ObjectBidirectionalIterator<Char2ByteMap.Entry> fastIterator()
    {
      return new Char2ByteLinkedOpenHashMap.FastEntryIterator(Char2ByteLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Char2ByteMap.Entry> fastIterator(Char2ByteMap.Entry from)
    {
      return new Char2ByteLinkedOpenHashMap.FastEntryIterator(Char2ByteLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
    }
  }
    ...
    implements ObjectListIterator<Char2ByteMap.Entry>
  {
    ...
    public AbstractChar2ByteMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2ByteLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Char2ByteLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Char2ByteMap.Entry>
  {
    ...
    {
      return this.entry = new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this, nextEntry());
    }
    
    public Char2ByteLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Char2ByteLinkedOpenHashMap.MapEntry(Char2ByteLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(char from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Char2ByteLinkedOpenHashMap.this.mask; Char2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Char2ByteLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Char2ByteLinkedOpenHashMap.this.first = this.next;
      } else {
        Char2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Char2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Char2ByteLinkedOpenHashMap.this.last = this.prev;
      } else {
        Char2ByteLinkedOpenHashMap.this.link[this.next] ^= (Char2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2ByteLinkedOpenHashMap.this.mask; Char2ByteLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ByteLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2ByteLinkedOpenHashMap.this.key[pos]) & Char2ByteLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2ByteLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Char2ByteMap.Entry, Map.Entry<Character, Byte>
  {
    ...
    {
      return Byte.valueOf(Char2ByteLinkedOpenHashMap.this.value[this.index]);
    }
    ...
    public byte setValue(byte local_v)
    {
      ...
      Char2ByteLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Byte> local_e = (Map.Entry)local_o;
      return (Char2ByteLinkedOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
