...
public class Char2ByteMaps
{
  ...
  public static Char2ByteMap synchronize(Char2ByteMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Char2ByteMap synchronize(Char2ByteMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Char2ByteMap unmodifiable(Char2ByteMap local_m)
  {
    ...
    implements Char2ByteMap, Serializable
  {
    ...
    protected UnmodifiableMap(Char2ByteMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    public Byte put(Character local_k, Byte local_v)
    {
      throw new UnsupportedOperationException();
    }
    ...
    implements Char2ByteMap, Serializable
  {
    ...
    protected SynchronizedMap(Char2ByteMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Char2ByteMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Char2ByteMap, Serializable, Cloneable
  {
      ...
      implements Char2ByteMap.Entry, Map.Entry<Character, Byte>
    {
      ...
      {
        return Character.valueOf(Char2ByteMaps.Singleton.this.key);
      }
      
      public Byte getValue()
      {
        return Byte.valueOf(Char2ByteMaps.Singleton.this.value);
      }
      
      public char getCharKey()
      {
        return Char2ByteMaps.Singleton.this.key;
      }
      
      public byte getByteValue()
      {
        return Char2ByteMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Char2ByteMaps.Singleton.this.key == ((Character)local_e.getKey()).charValue()) && (Char2ByteMaps.Singleton.this.value == ((Byte)local_e.getValue()).byteValue());
      }
      
      public int hashCode()
      {
        return Char2ByteMaps.Singleton.this.key ^ Char2ByteMaps.Singleton.this.value;
      }
