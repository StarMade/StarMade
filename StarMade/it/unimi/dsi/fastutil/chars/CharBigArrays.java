...
/*   84 */   public static final char[][] EMPTY_BIG_ARRAY = new char[0][];
/*      */ 
...
/*      */     char[] tmp10_5 = array[BigArrays.segment(index)]; tmp10_5[tmp10_7] = ((char)(tmp10_5[tmp10_7] + tmp10_7));
/*      */   }
/*      */ 
...
/*      */   {
/*      */     int tmp10_7 = BigArrays.displacement(index);
/*      */     char[] tmp10_5 = array[BigArrays.segment(index)]; tmp10_5[tmp10_7] = ((char)(tmp10_5[tmp10_7] + '\001'));
/*      */   }
/*      */ 
...
/*  263 */     char[][] base = new char[baseLength][];
/*  264 */     int residual = (int)(length & 0x7FFFFFF);
/*  265 */     if (residual != 0) {
/*  266 */       for (int i = 0; i < baseLength - 1; i++) base[i] = new char[134217728];
/*  267 */       base[(baseLength - 1)] = new char[residual];
/*      */     } else {
/*  269 */       for (int i = 0; i < baseLength; i++) base[i] = new char[134217728]; 
/*      */     }
/*  270 */     return base;
/*      */   }
/*      */ 
...
/*  281 */     if (array.length <= 134217728) return new char[][] { array };
/*  282 */     char[][] bigArray = newBigArray(array.length);
...
/*  320 */       char[][] base = (char[][])Arrays.copyOf(array, baseLength);
/*  321 */       int residual = (int)(length & 0x7FFFFFF);
/*  322 */       if (residual != 0) {
/*  323 */         for (int i = valid; i < baseLength - 1; i++) base[i] = new char[134217728];
/*  324 */         base[(baseLength - 1)] = new char[residual];
/*      */       } else {
/*  326 */         for (int i = valid; i < baseLength; i++) base[i] = new char[134217728]; 
/*      */       }
...
/*  394 */     char[][] base = (char[][])Arrays.copyOf(array, baseLength);
/*  395 */     int residual = (int)(length & 0x7FFFFFF);
/*  396 */     if (residual != 0) base[(baseLength - 1)] = CharArrays.trim(base[(baseLength - 1)], residual);
/*  397 */     return base;
/*      */   }
/*      */ 
...
/*      */   {
/*  441 */     char[][] base = (char[][])array.clone();
/*  442 */     for (int i = base.length; i-- != 0; base[i] = ((char[])array[i].clone()));
/*  443 */     return base;
/*      */   }
/*      */ 
/*      */   public static void fill(char[][] array, char value)
/*      */   {
/*  454 */     for (int i = array.length; i-- != 0; CharArrays.fill(array[i], value));
/*      */   }
/*      */ 
...
/*  475 */       CharArrays.fill(array[fromSegment], fromDispl, toDispl, value);
/*  476 */       return;
/*      */     }
/*  478 */     if (toDispl != 0) CharArrays.fill(array[toSegment], 0, toDispl, value); while (true) {
/*  479 */       toSegment--; if (toSegment <= fromSegment) break; CharArrays.fill(array[toSegment], value);
/*  480 */     }CharArrays.fill(array[fromSegment], fromDispl, 134217728, value);
/*      */   }
/*      */ 
/*      */   public static boolean equals(char[][] a1, char[][] a2)
/*      */   {
/*  492 */     if (length(a1) != length(a2)) return false; char[] t;
/*      */     char[] u;
/*      */     int j;
/*      */     do { int i = a1.length;
/*      */ 
...
/*      */   }
/*      */ 
/*  571 */   private static long med3(char[][] x, long a, long b, long c, CharComparator comp) { int ab = comp.compare(get(x, a), get(x, b));
...
/*      */ 
/*  924 */         for (long i = length; i-- != 0L; ByteBigArrays.set(digit, i, (byte)(get(a, first + i) >>> shift & 0xFF ^ 0x0)));
...
/*      */             }
/*      */           }
/*      */           long tmp340_339 = (p + count[i]); p = tmp340_339; pos[i] = tmp340_339;
/*      */         }
/*      */ 
...
/*      */       }
/*      */       else {
/* 1046 */         char[][] k = level < 2 ? a : b;
/* 1047 */         int shift = (1 - level % 2) * 8;
/*      */ 
/* 1049 */         for (long i = length; i-- != 0L; ByteBigArrays.set(digit, i, (byte)(get(k, first + i) >>> shift & 0xFF ^ 0x0)));
...
/*      */             }
/*      */           }
/*      */           long tmp382_381 = (p + count[i]); p = tmp382_381; pos[i] = tmp382_381;
/*      */         }
/*      */ 
...
/* 1071 */           char t = get(a, i + first);
/* 1072 */           char u = get(b, i + first);
...
/*  554 */       return CharBigArrays.equals(a, b);
/*      */     }
/*      */   }
/*      */ }
