...
/*      */ 
/*      */ public class Char2LongRBTreeMap extends AbstractChar2LongSortedMap
...
/*  119 */           return Char2LongRBTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*      */         }
/*      */         public int compare(Character ok1, Character ok2) {
/*  122 */           return Char2LongRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     long oldValue = put(ok.charValue(), ov.longValue());
/*  731 */     return this.modified ? null : Long.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Long remove(Object ok)
/*      */   {
/*  737 */     long oldValue = remove(((Character)ok).charValue());
...
/* 1141 */         final Comparator<? super Char2LongMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Char2LongMap.Entry x, Char2LongMap.Entry y) {
/* 1143 */             return Char2LongRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Char2LongRBTreeMap.EntryIterator(Char2LongRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator(Char2LongMap.Entry from) {
/* 1153 */           return new Char2LongRBTreeMap.EntryIterator(Char2LongRBTreeMap.this, ((Character)from.getKey()).charValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Char2LongRBTreeMap.Entry f = Char2LongRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1166 */           Char2LongRBTreeMap.Entry f = Char2LongRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1167 */           if (f != null) Char2LongRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Char2LongRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Char2LongRBTreeMap.this.clear(); } 
/* 1172 */         public Char2LongMap.Entry first() { return Char2LongRBTreeMap.this.firstEntry; } 
/* 1173 */         public Char2LongMap.Entry last() { return Char2LongRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry from, Char2LongMap.Entry to) { return Char2LongRBTreeMap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2LongEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry to) { return Char2LongRBTreeMap.this.headMap((Character)to.getKey()).char2LongEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry from) { return Char2LongRBTreeMap.this.tailMap((Character)from.getKey()).char2LongEntrySet(); }
/*      */       };
...
/* 1242 */           return new Char2LongRBTreeMap.ValueIterator(Char2LongRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(long k) {
/* 1245 */           return Char2LongRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Char2LongRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Char2LongRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Char2LongRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readChar(), s.readLong());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readChar(), s.readLong());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readChar(), s.readLong()));
...
/*      */ 
/*      */ 
/*      */   private final class Submap extends AbstractChar2LongSortedMap
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Char2LongRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Char2LongRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator() {
/* 1329 */             return new Char2LongRBTreeMap.Submap.SubmapEntryIterator(Char2LongRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator(Char2LongMap.Entry from) {
/* 1332 */             return new Char2LongRBTreeMap.Submap.SubmapEntryIterator(Char2LongRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
/*      */           }
/* 1334 */           public Comparator<? super Char2LongMap.Entry> comparator() { return Char2LongRBTreeMap.this.char2LongEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Char2LongRBTreeMap.Entry f = Char2LongRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1340 */             return (f != null) && (Char2LongRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Char2LongRBTreeMap.Entry f = Char2LongRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1347 */             if ((f != null) && (Char2LongRBTreeMap.Submap.this.in(f.key))) Char2LongRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Char2LongRBTreeMap.Submap.SubmapIterator(Char2LongRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Char2LongRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Char2LongMap.Entry first() { return Char2LongRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Char2LongMap.Entry last() { return Char2LongRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry from, Char2LongMap.Entry to) { return Char2LongRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2LongEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry to) { return Char2LongRBTreeMap.Submap.this.headMap((Character)to.getKey()).char2LongEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry from) { return Char2LongRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2LongEntrySet(); }
/*      */         };
...
/*      */           public LongIterator iterator() {
/* 1376 */             return new Char2LongRBTreeMap.Submap.SubmapValueIterator(Char2LongRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(long k) {
/* 1379 */             return Char2LongRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Char2LongRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Char2LongRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(char k) {
/* 1392 */       return (in(k)) && (Char2LongRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(long v) {
...
/* 1407 */       return (in(kk)) && ((e = Char2LongRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public long put(char k, long v) {
/* 1410 */       Char2LongRBTreeMap.this.modified = false;
...
/* 1412 */       long oldValue = Char2LongRBTreeMap.this.put(k, v);
/* 1413 */       return Char2LongRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Long put(Character ok, Long ov) {
/* 1416 */       long oldValue = put(ok.charValue(), ov.longValue());
/* 1417 */       return Char2LongRBTreeMap.this.modified ? null : Long.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public long remove(char k) {
/* 1421 */       Char2LongRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       long oldValue = Char2LongRBTreeMap.this.remove(k);
/* 1424 */       return Char2LongRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Long remove(Object ok) {
/* 1427 */       long oldValue = remove(((Character)ok).charValue());
/* 1428 */       return Char2LongRBTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public CharComparator comparator() {
/* 1443 */       return Char2LongRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Char2LongSortedMap headMap(char to) {
/* 1446 */       if (this.top) return new Submap(Char2LongRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Char2LongRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Char2LongRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Char2LongSortedMap tailMap(char from) {
/* 1450 */       if (this.bottom) return new Submap(Char2LongRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Char2LongRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2LongRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Char2LongSortedMap subMap(char from, char to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Char2LongRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Char2LongRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Char2LongRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Char2LongRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Char2LongRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Char2LongRBTreeMap.this.tree == null) return null;
/* 1468 */       Char2LongRBTreeMap.Entry e;
/*      */       Char2LongRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Char2LongRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Char2LongRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Char2LongRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Char2LongRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Char2LongRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Char2LongRBTreeMap.this.tree == null) return null;
/* 1486 */       Char2LongRBTreeMap.Entry e;
/*      */       Char2LongRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Char2LongRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Char2LongRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Char2LongRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Char2LongRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public char firstCharKey() {
/* 1497 */       Char2LongRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public char lastCharKey() {
/* 1502 */       Char2LongRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Character firstKey() {
/* 1507 */       Char2LongRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Character lastKey() {
/* 1512 */       Char2LongRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Char2LongRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Char2LongRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Char2LongRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Char2LongMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Char2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Char2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Char2LongRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Char2LongRBTreeMap.Submap.this.bottom) && (Char2LongRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Char2LongRBTreeMap.Submap.this.top) && (Char2LongRBTreeMap.this.compare(k, (this.prev = Char2LongRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Char2LongRBTreeMap.this.locateKey(k);
/* 1534 */             if (Char2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Char2LongRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2LongRBTreeMap.this.compare(this.prev.key, Char2LongRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Char2LongRBTreeMap.Submap.this.top) && (this.next != null) && (Char2LongRBTreeMap.this.compare(this.next.key, Char2LongRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public CharBidirectionalIterator iterator() { return new Char2LongRBTreeMap.Submap.SubmapKeyIterator(Char2LongRBTreeMap.Submap.this); } 
/* 1367 */       public CharBidirectionalIterator iterator(char from) { return new Char2LongRBTreeMap.Submap.SubmapKeyIterator(Char2LongRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2LongRBTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public CharBidirectionalIterator iterator() { return new Char2LongRBTreeMap.KeyIterator(Char2LongRBTreeMap.this); } 
/* 1201 */     public CharBidirectionalIterator iterator(char from) { return new Char2LongRBTreeMap.KeyIterator(Char2LongRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2LongRBTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2LongRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Char2LongMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Char2LongMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Char2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Char2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Char2LongRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(char k) {
/* 1067 */       if ((this.next = Char2LongRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Char2LongRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Char2LongRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Character)e.getKey()).charValue()) && (this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
