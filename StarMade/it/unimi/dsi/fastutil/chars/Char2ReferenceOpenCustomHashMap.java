  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2ReferenceOpenCustomHashMap(int expected, float local_f, CharHash.Strategy strategy)
  {
  ...
  public Char2ReferenceOpenCustomHashMap(Map<? extends Character, ? extends V> local_m, float local_f, CharHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Char2ReferenceOpenCustomHashMap(Map<? extends Character, ? extends V> local_m, CharHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Char2ReferenceOpenCustomHashMap(Char2ReferenceMap<V> local_m, float local_f, CharHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Char2ReferenceOpenCustomHashMap(Char2ReferenceMap<V> local_m, CharHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Char2ReferenceOpenCustomHashMap(char[] local_k, V[] local_v, float local_f, CharHash.Strategy strategy)
  {
  ...
  public Char2ReferenceOpenCustomHashMap(char[] local_k, V[] local_v, CharHash.Strategy strategy)
  {
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Char2ReferenceOpenCustomHashMap.ValueIterator(Char2ReferenceOpenCustomHashMap.this);
        }
        ...
        {
          return Char2ReferenceOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2ReferenceOpenCustomHashMap<V> local_c;
    try
    {
      local_c = (Char2ReferenceOpenCustomHashMap)super.clone();
    }
    ...
    throws IOException
  {
    char[] key = this.key;
    V[] value = this.value;
    Char2ReferenceOpenCustomHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractCharSet
  {
    ...
    {
      return new Char2ReferenceOpenCustomHashMap.KeyIterator(Char2ReferenceOpenCustomHashMap.this);
    }
    ...
    {
      return Char2ReferenceOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2ReferenceOpenCustomHashMap.this.size;
      Char2ReferenceOpenCustomHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Char2ReferenceOpenCustomHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Char2ReferenceOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2ReferenceMap.FastEntrySet<V>
  {
    ...
    {
      return new Char2ReferenceOpenCustomHashMap.EntryIterator(Char2ReferenceOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Char2ReferenceMap.Entry<V>> fastIterator()
    {
      return new Char2ReferenceOpenCustomHashMap.FastEntryIterator(Char2ReferenceOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Char2ReferenceOpenCustomHashMap.this.strategy.hashCode(local_k)) & Char2ReferenceOpenCustomHashMap.this.mask; Char2ReferenceOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ReferenceOpenCustomHashMap.this.mask) {
        if (Char2ReferenceOpenCustomHashMap.this.strategy.equals(Char2ReferenceOpenCustomHashMap.this.key[pos], local_k)) {
          return Char2ReferenceOpenCustomHashMap.this.value[pos] == local_e.getValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Char2ReferenceOpenCustomHashMap.this.strategy.hashCode(local_k)) & Char2ReferenceOpenCustomHashMap.this.mask; Char2ReferenceOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ReferenceOpenCustomHashMap.this.mask) {
        if (Char2ReferenceOpenCustomHashMap.this.strategy.equals(Char2ReferenceOpenCustomHashMap.this.key[pos], local_k))
        {
          Char2ReferenceOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2ReferenceMap.Entry<V>>
  {
    ...
    public AbstractChar2ReferenceMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Char2ReferenceOpenCustomHashMap.this.key[local_e];
      this.entry.value = Char2ReferenceOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2ReferenceMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Char2ReferenceOpenCustomHashMap.MapEntry(Char2ReferenceOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2ReferenceOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2ReferenceOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2171 = Char2ReferenceOpenCustomHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2ReferenceOpenCustomHashMap.this.used;
      while ((this.field_2171 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2171 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2171 != 0)
      {
        boolean[] local_k = Char2ReferenceOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2ReferenceOpenCustomHashMap.this.mask; Char2ReferenceOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ReferenceOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2ReferenceOpenCustomHashMap.this.strategy.hashCode(Char2ReferenceOpenCustomHashMap.this.key[pos])) & Char2ReferenceOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2ReferenceOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2ReferenceOpenCustomHashMap.this.key[pos]);
        }
        Char2ReferenceOpenCustomHashMap.this.key[last] = Char2ReferenceOpenCustomHashMap.this.key[pos];
        Char2ReferenceOpenCustomHashMap.this.value[last] = Char2ReferenceOpenCustomHashMap.this.value[pos];
      }
      Char2ReferenceOpenCustomHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2ReferenceOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2171 > 0))
      {
        this.field_2171 += 1;
        nextEntry();
      }
    ...
    implements Char2ReferenceMap.Entry<V>, Map.Entry<Character, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Char2ReferenceOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, V> local_e = (Map.Entry)local_o;
      return (Char2ReferenceOpenCustomHashMap.this.strategy.equals(Char2ReferenceOpenCustomHashMap.this.key[this.index], ((Character)local_e.getKey()).charValue())) && (Char2ReferenceOpenCustomHashMap.this.value[this.index] == local_e.getValue());
    }
