...
/*  17:    */
/*  65:    */public class Char2ObjectArrayMap<V>
/*  66:    */  extends AbstractChar2ObjectMap<V>
...
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Char2ObjectArrayMap(char[] key, Object[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Char2ObjectArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = CharArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = ObjectArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Char2ObjectArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new char[capacity];
/*  93: 93 */    this.value = new Object[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Char2ObjectArrayMap(Char2ObjectMap<V> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Char2ObjectArrayMap(Map<? extends Character, ? extends V> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Char2ObjectArrayMap(char[] key, Object[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>> implements Char2ObjectMap.FastEntrySet<V> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Char2ObjectMap.Entry<V>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Char2ObjectArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Char2ObjectMap.Entry<V> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractChar2ObjectMap.BasicEntry(Char2ObjectArrayMap.this.key[this.next], Char2ObjectArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Char2ObjectMap.Entry<V>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractChar2ObjectMap.BasicEntry<V> entry = new AbstractChar2ObjectMap.BasicEntry('\000', null);
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Char2ObjectArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Char2ObjectMap.Entry<V> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Char2ObjectArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Char2ObjectArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Char2ObjectArrayMap.this.size; }
/* 159:    */    
...
/* 165:165 */      return (Char2ObjectArrayMap.this.containsKey(k)) && (Char2ObjectArrayMap.this.get(k) == null ? e.getValue() == null : Char2ObjectArrayMap.this.get(k).equals(e.getValue()));
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Char2ObjectMap.FastEntrySet<V> char2ObjectEntrySet() { return new EntrySet(null); }
/* 170:    */  
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Char2ObjectArrayMap<V> clone()
/* 293:    */  {
/* 294:    */    Char2ObjectArrayMap<V> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Char2ObjectArrayMap)super.clone();
/* 301:    */    }
