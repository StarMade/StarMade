  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2BooleanAVLTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2BooleanAVLTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2BooleanAVLTreeMap(Map<? extends Character, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2BooleanAVLTreeMap(SortedMap<Character, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2BooleanAVLTreeMap(Char2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2BooleanAVLTreeMap(Char2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2BooleanAVLTreeMap(char[] local_k, boolean[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2BooleanAVLTreeMap(char[] local_k, boolean[] local_v)
  {
  ...
  {
    boolean oldValue = put(local_ok.charValue(), local_ov.booleanValue());
    return this.modified ? null : Boolean.valueOf(oldValue);
  }
  
  public Boolean remove(Object local_ok)
  {
    boolean oldValue = remove(((Character)local_ok).charValue());
  ...
  public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Char2BooleanMap.Entry> comparator = new Comparator()
        {
          public int compare(Char2BooleanMap.Entry local_x, Char2BooleanMap.Entry local_y)
          {
            return Char2BooleanAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2BooleanAVLTreeMap.EntryIterator(Char2BooleanAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from)
        {
          return new Char2BooleanAVLTreeMap.EntryIterator(Char2BooleanAVLTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2BooleanAVLTreeMap.Entry local_f = Char2BooleanAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2BooleanAVLTreeMap.Entry local_f = Char2BooleanAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2BooleanAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry local_to)
        {
          return Char2BooleanAVLTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry local_to)
        {
          return Char2BooleanAVLTreeMap.this.headMap((Character)local_to.getKey()).char2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from)
        {
          return Char2BooleanAVLTreeMap.this.tailMap((Character)from.getKey()).char2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Char2BooleanAVLTreeMap.ValueIterator(Char2BooleanAVLTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Char2BooleanAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2BooleanAVLTreeMap local_c;
    try
    {
      local_c = (Char2BooleanAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readChar(), local_s.readBoolean());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readChar(), local_s.readBoolean());
      top.right(new Entry(local_s.readChar(), local_s.readBoolean()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2BooleanAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Char2BooleanAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2BooleanAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator()
          {
            return new Char2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Char2BooleanAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from)
          {
            return new Char2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Char2BooleanAVLTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, Boolean> local_e = (Map.Entry)local_o;
            Char2BooleanAVLTreeMap.Entry local_f = Char2BooleanAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2BooleanAVLTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, Boolean> local_e = (Map.Entry)local_o;
            Char2BooleanAVLTreeMap.Entry local_f = Char2BooleanAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2BooleanAVLTreeMap.Submap.this.in2(local_f.key))) {
              Char2BooleanAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2BooleanAVLTreeMap.Submap.SubmapIterator(Char2BooleanAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2BooleanAVLTreeMap.Submap.this.clear();
          }
          
          public Char2BooleanMap.Entry first()
          {
            return Char2BooleanAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Char2BooleanMap.Entry last()
          {
            return Char2BooleanAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry local_to)
          {
            return Char2BooleanAVLTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry local_to)
          {
            return Char2BooleanAVLTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from)
          {
            return Char2BooleanAVLTreeMap.Submap.this.tailMap((Character)from.getKey()).char2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Char2BooleanAVLTreeMap.Submap.SubmapValueIterator(Char2BooleanAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Char2BooleanAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2BooleanAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2BooleanAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2BooleanAVLTreeMap.Entry local_e;
      return (in2(local_kk)) && ((local_e = Char2BooleanAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(char local_k, boolean local_v)
    {
      ...
      boolean oldValue = Char2BooleanAVLTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(char local_k)
    {
      ...
      boolean oldValue = Char2BooleanAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2BooleanSortedMap tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2BooleanAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2BooleanAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2BooleanSortedMap subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2BooleanAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2BooleanAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2BooleanAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2BooleanAVLTreeMap.this.locateKey(this.from);
        if (Char2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2BooleanAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2BooleanAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2BooleanAVLTreeMap.this.locateKey(this.field_47);
        if (Char2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2BooleanAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2BooleanAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Char2BooleanAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Char2BooleanAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2BooleanAVLTreeMap.Submap.this.bottom) && (Char2BooleanAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2BooleanAVLTreeMap.Submap.this.top) && (Char2BooleanAVLTreeMap.this.compare(local_k, (this.prev = Char2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2BooleanAVLTreeMap.this.locateKey(local_k);
            if (Char2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2BooleanAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2BooleanAVLTreeMap.this.compare(this.prev.key, Char2BooleanAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2BooleanAVLTreeMap.Submap.this.top) && (this.next != null) && (Char2BooleanAVLTreeMap.this.compare(this.next.key, Char2BooleanAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Char2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Char2BooleanAVLTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Char2BooleanAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2BooleanSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2BooleanAVLTreeMap.KeyIterator(Char2BooleanAVLTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2BooleanAVLTreeMap.KeyIterator(Char2BooleanAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2BooleanAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Char2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Char2BooleanMap.Entry
  {
    ...
    Entry(char local_k, boolean local_v)
    {
      this.key = local_k;
      this.value = local_v;
