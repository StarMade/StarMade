  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2CharOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2CharOpenHashMap(Map<? extends Character, ? extends Character> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2CharOpenHashMap(Map<? extends Character, ? extends Character> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2CharOpenHashMap(Char2CharMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2CharOpenHashMap(Char2CharMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2CharOpenHashMap(char[] local_k, char[] local_v, float local_f)
  {
  ...
  public Char2CharOpenHashMap(char[] local_k, char[] local_v)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Char2CharOpenHashMap.ValueIterator(Char2CharOpenHashMap.this);
        }
        ...
        {
          return Char2CharOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2CharOpenHashMap local_c;
    try
    {
      local_c = (Char2CharOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2CharOpenHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Char2CharOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSet
  {
    ...
    public CharIterator iterator()
    {
      return new Char2CharOpenHashMap.KeyIterator(Char2CharOpenHashMap.this);
    }
    ...
    {
      return Char2CharOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2CharOpenHashMap.this.size;
      Char2CharOpenHashMap.this.remove(local_k);
    ...
    implements CharIterator
  {
    ...
    public Character next()
    {
      return Character.valueOf(Char2CharOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2CharMap.FastEntrySet
  {
    ...
    {
      return new Char2CharOpenHashMap.EntryIterator(Char2CharOpenHashMap.this, null);
    }
    
    public ObjectIterator<Char2CharMap.Entry> fastIterator()
    {
      return new Char2CharOpenHashMap.FastEntryIterator(Char2CharOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2CharOpenHashMap.this.mask; Char2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2CharOpenHashMap.this.mask) {
        if (Char2CharOpenHashMap.this.key[pos] == local_k) {
          return Char2CharOpenHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2CharOpenHashMap.this.mask; Char2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2CharOpenHashMap.this.mask) {
        if (Char2CharOpenHashMap.this.key[pos] == local_k)
        {
          Char2CharOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2CharMap.Entry>
  {
    ...
    public AbstractChar2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2CharOpenHashMap.this.key[local_e];
      this.entry.value = Char2CharOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Char2CharOpenHashMap.MapEntry(Char2CharOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2CharOpenHashMap.this.field_49;
    int last = -1;
    int field_1913 = Char2CharOpenHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2CharOpenHashMap.this.used;
      while ((this.field_1913 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1913 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1913 != 0)
      {
        boolean[] local_k = Char2CharOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2CharOpenHashMap.this.mask; Char2CharOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2CharOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2CharOpenHashMap.this.key[pos]) & Char2CharOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2CharOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2CharOpenHashMap.this.key[pos]);
        }
        Char2CharOpenHashMap.this.key[last] = Char2CharOpenHashMap.this.key[pos];
        Char2CharOpenHashMap.this.value[last] = Char2CharOpenHashMap.this.value[pos];
      }
      Char2CharOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2CharOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2CharOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1913 > 0))
      {
        this.field_1913 += 1;
        nextEntry();
      }
    ...
    implements Char2CharMap.Entry, Map.Entry<Character, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Char2CharOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Character> local_e = (Map.Entry)local_o;
      return (Char2CharOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2CharOpenHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
