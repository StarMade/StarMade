  ...
  implements Serializable, Cloneable, CharSortedSet
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return CharAVLTreeSet.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public CharAVLTreeSet(Comparator<? super Character> local_c)
  {
    this();
  ...
  public CharAVLTreeSet(Collection<? extends Character> local_c)
  {
    this();
    addAll(local_c);
  }
  
  public CharAVLTreeSet(SortedSet<Character> local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public CharAVLTreeSet(CharCollection local_c)
  {
    this();
    addAll(local_c);
  }
  
  public CharAVLTreeSet(CharSortedSet local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public CharAVLTreeSet(CharIterator local_i)
  {
    allocatePaths();
  ...
  public CharAVLTreeSet(Iterator<? extends Character> local_i)
  {
    this(CharIterators.asCharIterator(local_i));
  }
  
  public CharAVLTreeSet(char[] local_a, int offset, int length, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public CharAVLTreeSet(char[] local_a, int offset, int length)
  {
    this(local_a, offset, length, null);
  }
  
  public CharAVLTreeSet(char[] local_a)
  {
    this();
  ...
  public CharAVLTreeSet(char[] local_a, Comparator<? super Character> local_c)
  {
    this(local_c);
    int local_i = local_a.length;
    while (local_i-- != 0) {
  ...
  public Object clone()
  {
    CharAVLTreeSet local_c;
    try
    {
      local_c = (CharAVLTreeSet)super.clone();
    }
    ...
    implements Serializable, CharSortedSet
  {
    ...
    {
      if ((!bottom) && (!top) && (CharAVLTreeSet.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (CharAVLTreeSet.this.compare(local_k, this.from) >= 0)) && ((this.top) || (CharAVLTreeSet.this.compare(local_k, this.field_309) < 0));
    }
    
    public boolean contains(char local_k)
    {
      return (in(local_k)) && (CharAVLTreeSet.this.contains(local_k));
    }
    ...
    public boolean add(char local_k)
    {
      ...
      return CharAVLTreeSet.this.add(local_k);
    }
    ...
    public boolean remove(char local_k)
    {
      ...
      return CharAVLTreeSet.this.remove(local_k);
    }
    ...
    {
      if (this.top) {
        return new Subset(CharAVLTreeSet.this, this.from, this.bottom, local_to, false);
      }
      return CharAVLTreeSet.this.compare(local_to, this.field_309) < 0 ? new Subset(CharAVLTreeSet.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public CharSortedSet tailSet(char from)
    {
      if (this.bottom) {
        return new Subset(CharAVLTreeSet.this, from, false, this.field_309, this.top);
      }
      return CharAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(CharAVLTreeSet.this, from, false, this.field_309, this.top) : this;
    }
    
    public CharSortedSet subSet(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Subset(CharAVLTreeSet.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = CharAVLTreeSet.this.compare(local_to, this.field_309) < 0 ? local_to : this.field_309;
      }
      if (!this.bottom) {
    ...
    public CharAVLTreeSet.Entry firstEntry()
    {
      ...
      CharAVLTreeSet.Entry local_e;
      CharAVLTreeSet.Entry local_e;
      if (this.bottom)
      {
        local_e = CharAVLTreeSet.this.firstEntry;
      }
      else
      {
        local_e = CharAVLTreeSet.this.locateKey(this.from);
        if (CharAVLTreeSet.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (CharAVLTreeSet.this.compare(local_e.key, this.field_309) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public CharAVLTreeSet.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = CharAVLTreeSet.this.lastEntry;
      }
      else
      {
        local_e = CharAVLTreeSet.this.locateKey(this.field_309);
        if (CharAVLTreeSet.this.compare(local_e.key, this.field_309) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (CharAVLTreeSet.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstChar()
    {
      CharAVLTreeSet.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastChar()
    {
      CharAVLTreeSet.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends CharAVLTreeSet.SetIterator
    {
      ...
      {
        super();
        this.next = CharAVLTreeSet.Subset.this.firstEntry();
      }
      ...
      SubsetIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!CharAVLTreeSet.Subset.this.bottom) && (CharAVLTreeSet.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!CharAVLTreeSet.Subset.this.top) && (CharAVLTreeSet.this.compare(local_k, (this.prev = CharAVLTreeSet.Subset.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = CharAVLTreeSet.this.locateKey(local_k);
            if (CharAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!CharAVLTreeSet.Subset.this.bottom) && (this.prev != null) && (CharAVLTreeSet.this.compare(this.prev.key, CharAVLTreeSet.Subset.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!CharAVLTreeSet.Subset.this.top) && (this.next != null) && (CharAVLTreeSet.this.compare(this.next.key, CharAVLTreeSet.Subset.this.field_309) >= 0)) {
          this.next = null;
        }
      }
    }
    ...
    extends AbstractCharListIterator
  {
    ...
    {
      if ((this.next = CharAVLTreeSet.this.locateKey(local_k)) != null) {
        if (CharAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
