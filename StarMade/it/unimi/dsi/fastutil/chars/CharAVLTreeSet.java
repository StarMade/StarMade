...
/*      */ 
/*      */ public class CharAVLTreeSet extends AbstractCharSortedSet
...
/*      */   {
/*   94 */     if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) this.actualComparator = ((CharComparator)this.storedComparator); else
/*   95 */       this.actualComparator = new CharComparator() {
/*      */         public int compare(char k1, char k2) {
/*   97 */           return CharAVLTreeSet.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*      */         }
/*      */         public int compare(Character ok1, Character ok2) {
/*  100 */           return CharAVLTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*   74 */     allocatePaths();
/*      */ 
/*  160 */     while (i.hasNext()) add(i.nextChar());
/*      */   }
/*      */ 
/*      */   public CharAVLTreeSet(Iterator<? extends Character> i)
/*      */   {
/*  171 */     this(CharIterators.asCharIterator(i));
/*      */   }
/*      */ 
/*      */   public CharAVLTreeSet(char[] a, int offset, int length, Comparator<? super Character> c)
/*      */   {
/*  184 */     this(c);
/*  185 */     CharArrays.ensureOffsetLength(a, offset, length);
...
/* 1086 */     return new Subset('\000', true, to, false);
/*      */   }
/*      */   public CharSortedSet tailSet(char from) {
/* 1089 */     return new Subset(from, false, '\000', true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1284 */       c = (CharAVLTreeSet)super.clone();
/*      */     }
...
/* 1337 */     while (n-- != 0) s.writeChar(i.nextChar());
/*      */   }
/*      */ 
...
/*      */   {
/* 1348 */     if (n == 1) {
/* 1349 */       Entry top = new Entry(s.readChar());
/* 1350 */       top.pred(pred);
/* 1351 */       top.succ(succ);
/* 1352 */       return top;
/*      */     }
/* 1354 */     if (n == 2)
/*      */     {
/* 1357 */       Entry top = new Entry(s.readChar());
/* 1358 */       top.right(new Entry(s.readChar()));
...
/*      */   }
/*      */ 
/*      */   private final class Subset extends AbstractCharSortedSet
...
/*      */     {
/* 1121 */       if ((!bottom) && (!top) && (CharAVLTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1122 */       this.from = from;
...
/*      */     {
/* 1139 */       return ((this.bottom) || (CharAVLTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (CharAVLTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(char k)
/*      */     {
/* 1144 */       return (in(k)) && (CharAVLTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(char k) {
...
/* 1148 */       return CharAVLTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(char k) {
/* 1152 */       if (!in(k)) return false;
/* 1153 */       return CharAVLTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public CharComparator comparator() {
/* 1168 */       return CharAVLTreeSet.this.actualComparator;
/*      */     }
/*      */     public CharBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public CharSortedSet headSet(char to) {
/* 1177 */       if (this.top) return new Subset(CharAVLTreeSet.this, this.from, this.bottom, to, false);
/* 1178 */       return CharAVLTreeSet.this.compare(to, this.to) < 0 ? new Subset(CharAVLTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public CharSortedSet tailSet(char from) {
/* 1181 */       if (this.bottom) return new Subset(CharAVLTreeSet.this, from, false, this.to, this.top);
/* 1182 */       return CharAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(CharAVLTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public CharSortedSet subSet(char from, char to) {
/* 1185 */       if ((this.top) && (this.bottom)) return new Subset(CharAVLTreeSet.this, from, false, to, false);
/* 1186 */       if (!this.top) to = CharAVLTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1187 */       if (!this.bottom) from = CharAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1188 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1189 */       return new Subset(CharAVLTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public CharAVLTreeSet.Entry firstEntry()
/*      */     {
/* 1196 */       if (CharAVLTreeSet.this.tree == null) return null;
/* 1199 */       CharAVLTreeSet.Entry e;
/*      */       CharAVLTreeSet.Entry e;
/* 1199 */       if (this.bottom) { e = CharAVLTreeSet.this.firstEntry;
/*      */       } else {
/* 1201 */         e = CharAVLTreeSet.this.locateKey(this.from);
/*      */ 
/* 1203 */         if (CharAVLTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1206 */       if ((e == null) || ((!this.top) && (CharAVLTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1207 */       return e;
/*      */     }
/*      */ 
/*      */     public CharAVLTreeSet.Entry lastEntry()
/*      */     {
/* 1214 */       if (CharAVLTreeSet.this.tree == null) return null;
/* 1217 */       CharAVLTreeSet.Entry e;
/*      */       CharAVLTreeSet.Entry e;
/* 1217 */       if (this.top) { e = CharAVLTreeSet.this.lastEntry;
/*      */       } else {
/* 1219 */         e = CharAVLTreeSet.this.locateKey(this.to);
/*      */ 
/* 1221 */         if (CharAVLTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1224 */       if ((e == null) || ((!this.bottom) && (CharAVLTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1225 */       return e;
/*      */     }
/*      */     public char firstChar() {
/* 1228 */       CharAVLTreeSet.Entry e = firstEntry();
/* 1229 */       if (e == null) throw new NoSuchElementException();
/* 1230 */       return e.key;
/*      */     }
/*      */     public char lastChar() {
/* 1233 */       CharAVLTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1245 */         super();
/* 1246 */         this.next = CharAVLTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(char k) {
/* 1249 */         this();
/* 1250 */         if (this.next != null)
/* 1251 */           if ((!CharAVLTreeSet.Subset.this.bottom) && (CharAVLTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1252 */           } else if ((!CharAVLTreeSet.Subset.this.top) && (CharAVLTreeSet.this.compare(k, (this.prev = CharAVLTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1254 */             this.next = CharAVLTreeSet.this.locateKey(k);
/* 1255 */             if (CharAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1269 */         if ((!CharAVLTreeSet.Subset.this.top) && (this.next != null) && (CharAVLTreeSet.this.compare(this.next.key, CharAVLTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/* 1021 */     int index = 0;
/*      */ 
/* 1023 */     SetIterator() { this.next = CharAVLTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(char k) {
/* 1026 */       if ((this.next = CharAVLTreeSet.this.locateKey(k)) != null)
/* 1027 */         if (CharAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/* 1046 */     public char nextChar() { return nextEntry().key; } 
/* 1047 */     public char previousChar() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1070 */       updatePrevious();
/* 1071 */       updateNext();
/* 1072 */       CharAVLTreeSet.this.remove(this.curr.key);
/* 1073 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
