...
/*  14:    */
/*  62:    */public abstract class AbstractChar2BooleanMap
/*  63:    */  extends AbstractChar2BooleanFunction
/*  64:    */  implements Char2BooleanMap, Serializable
/*  65:    */{
...
/*  79:    */  }
/*  80:    */  
/*  86:    */  public void putAll(Map<? extends Character, ? extends Boolean> m)
/*  87:    */  {
/*  88: 88 */    int n = m.size();
/*  89: 89 */    Iterator<? extends Map.Entry<? extends Character, ? extends Boolean>> i = m.entrySet().iterator();
/*  90: 90 */    if ((m instanceof Char2BooleanMap))
/*  91:    */    {
/*  92: 92 */      while (n-- != 0) {
/*  93: 93 */        Char2BooleanMap.Entry e = (Char2BooleanMap.Entry)i.next();
/*  94: 94 */        put(e.getCharKey(), e.getBooleanValue());
/*  95:    */      }
/*  96:    */      
/*  97:    */    }
/*  98:    */    else
/*  99: 99 */      while (n-- != 0) {
/* 100:100 */        Map.Entry<? extends Character, ? extends Boolean> e = (Map.Entry)i.next();
/* 101:101 */        put((Character)e.getKey(), (Boolean)e.getValue());
/* 102:    */      }
/* 103:    */  }
/* 104:    */  
...
/* 111:    */    implements Char2BooleanMap.Entry
/* 112:    */  {
/* 113:    */    protected char key;
/* 114:    */    protected boolean value;
/* 115:    */    
/* 116:    */    public BasicEntry(Character key, Boolean value)
/* 117:    */    {
/* 118:118 */      this.key = key.charValue();
/* 119:119 */      this.value = value.booleanValue();
/* 120:    */    }
/* 121:    */    
/* 122:122 */    public BasicEntry(char key, boolean value) { this.key = key;
...
/* 162:    */      
/* 163:163 */      return (this.key == ((Character)e.getKey()).charValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/* 164:    */    }
/* 165:    */    
/* 166:    */    public int hashCode() {
/* 167:167 */      return this.key ^ (this.value ? 'ӏ' : 'ӕ');
/* 168:    */    }
/* 169:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(char k) { return AbstractChar2BooleanMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractChar2BooleanMap.this.size(); }
/* 196:196 */      public void clear() { AbstractChar2BooleanMap.this.clear(); }
/* 197:    */      
/* 198:    */      public CharIterator iterator() {
/* 199:199 */        new AbstractCharIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<Character, Boolean>> i = AbstractChar2BooleanMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public char nextChar() { return ((Char2BooleanMap.Entry)this.i.next()).getCharKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(boolean k) { return AbstractChar2BooleanMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractChar2BooleanMap.this.size(); }
/* 229:229 */      public void clear() { AbstractChar2BooleanMap.this.clear(); }
/* 230:    */      
/* 231:    */      public BooleanIterator iterator() {
/* 232:232 */        new AbstractBooleanIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<Character, Boolean>> i = AbstractChar2BooleanMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public boolean nextBoolean() { return ((Char2BooleanMap.Entry)this.i.next()).getBooleanValue(); }
/* 236:    */          
...
/* 241:    */  }
/* 242:    */  
/* 244:    */  public ObjectSet<Map.Entry<Character, Boolean>> entrySet()
/* 245:    */  {
/* 246:246 */    return char2BooleanEntrySet();
/* 247:    */  }
/* 248:    */  
/* 257:    */  public int hashCode()
/* 258:    */  {
/* 259:259 */    int h = 0;int n = size();
/* 260:260 */    ObjectIterator<? extends Map.Entry<Character, Boolean>> i = entrySet().iterator();
/* 261:    */    
...
/* 278:278 */    ObjectIterator<? extends Map.Entry<Character, Boolean>> i = entrySet().iterator();
/* 279:279 */    int n = size();
/* 280:    */    
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Char2BooleanMap.Entry e = (Char2BooleanMap.Entry)i.next();
/* 290:    */      
