  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2CharRBTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2CharRBTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2CharRBTreeMap(Map<? extends Character, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2CharRBTreeMap(SortedMap<Character, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2CharRBTreeMap(Char2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2CharRBTreeMap(Char2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2CharRBTreeMap(char[] local_k, char[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2CharRBTreeMap(char[] local_k, char[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Char2CharMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Char2CharRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2CharRBTreeMap.EntryIterator(Char2CharRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry from)
        {
          return new Char2CharRBTreeMap.EntryIterator(Char2CharRBTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2CharRBTreeMap.Entry local_f = Char2CharRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2CharRBTreeMap.Entry local_f = Char2CharRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2CharRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Char2CharRBTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2CharEntrySet();
        }
        
        public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry local_to)
        {
          return Char2CharRBTreeMap.this.headMap((Character)local_to.getKey()).char2CharEntrySet();
        }
        
        public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry from)
        {
          return Char2CharRBTreeMap.this.tailMap((Character)from.getKey()).char2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Char2CharRBTreeMap.ValueIterator(Char2CharRBTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Char2CharRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2CharRBTreeMap local_c;
    try
    {
      local_c = (Char2CharRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2CharRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Char2CharRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2CharRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator()
          {
            return new Char2CharRBTreeMap.Submap.SubmapEntryIterator(Char2CharRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry from)
          {
            return new Char2CharRBTreeMap.Submap.SubmapEntryIterator(Char2CharRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, Character> local_e = (Map.Entry)local_o;
            Char2CharRBTreeMap.Entry local_f = Char2CharRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2CharRBTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, Character> local_e = (Map.Entry)local_o;
            Char2CharRBTreeMap.Entry local_f = Char2CharRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2CharRBTreeMap.Submap.this.in2(local_f.key))) {
              Char2CharRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2CharRBTreeMap.Submap.SubmapIterator(Char2CharRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2CharRBTreeMap.Submap.this.clear();
          }
          
          public Char2CharMap.Entry first()
          {
            return Char2CharRBTreeMap.Submap.this.firstEntry();
          }
          
          public Char2CharMap.Entry last()
          {
            return Char2CharRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry from, Char2CharMap.Entry local_to)
          {
            return Char2CharRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2CharEntrySet();
          }
          
          public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry local_to)
          {
            return Char2CharRBTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2CharEntrySet();
          }
          
          public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry from)
          {
            return Char2CharRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Char2CharRBTreeMap.Submap.SubmapValueIterator(Char2CharRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Char2CharRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2CharRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2CharRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2CharRBTreeMap.Entry local_e;
      return (in2(local_kk)) && ((local_e = Char2CharRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(char local_k, char local_v)
    {
      ...
      char oldValue = Char2CharRBTreeMap.this.put(local_k, local_v);
    ...
    public char remove(char local_k)
    {
      ...
      char oldValue = Char2CharRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2CharRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2CharRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2CharSortedMap tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2CharRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2CharRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2CharRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2CharSortedMap subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2CharRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2CharRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2CharRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2CharRBTreeMap.this.locateKey(this.from);
        if (Char2CharRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2CharRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2CharRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2CharRBTreeMap.this.locateKey(this.field_47);
        if (Char2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2CharRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2CharRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2CharRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Char2CharRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Char2CharRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2CharRBTreeMap.Submap.this.bottom) && (Char2CharRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2CharRBTreeMap.Submap.this.top) && (Char2CharRBTreeMap.this.compare(local_k, (this.prev = Char2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2CharRBTreeMap.this.locateKey(local_k);
            if (Char2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2CharRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2CharRBTreeMap.this.compare(this.prev.key, Char2CharRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2CharRBTreeMap.Submap.this.top) && (this.next != null) && (Char2CharRBTreeMap.this.compare(this.next.key, Char2CharRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2CharSortedMap.KeySet
    {
      ...
      {
        return new Char2CharRBTreeMap.Submap.SubmapKeyIterator(Char2CharRBTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2CharRBTreeMap.Submap.SubmapKeyIterator(Char2CharRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2CharSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2CharRBTreeMap.KeyIterator(Char2CharRBTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2CharRBTreeMap.KeyIterator(Char2CharRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2CharRBTreeMap.this.locateKey(local_k)) != null) {
        if (Char2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
