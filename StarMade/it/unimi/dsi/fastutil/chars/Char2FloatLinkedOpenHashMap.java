...
/*   22:     */
/*  113:     */public class Char2FloatLinkedOpenHashMap
/*  114:     */  extends AbstractChar2FloatSortedMap
...
/*  127:     */  protected volatile transient Char2FloatSortedMap.FastSortedEntrySet entries;
...
/*  141:     */  
/*  149:     */  public Char2FloatLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Char2FloatLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Char2FloatLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Char2FloatLinkedOpenHashMap(Map<? extends Character, ? extends Float> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Char2FloatLinkedOpenHashMap(Map<? extends Character, ? extends Float> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Char2FloatLinkedOpenHashMap(Char2FloatMap m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Char2FloatLinkedOpenHashMap(Char2FloatMap m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Char2FloatLinkedOpenHashMap(char[] k, float[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Char2FloatLinkedOpenHashMap(char[] k, float[] v)
/*  225:     */  {
/*  226: 226 */    this(k, v, 0.75F);
/*  227:     */  }
/*  228:     */  
/*  232:     */  public float put(char k, float v)
/*  233:     */  {
...
/*  260:     */  }
/*  261:     */  
/*  262: 262 */  public Float put(Character ok, Float ov) { float v = ov.floatValue();
...
/*  291:     */  }
/*  292:     */  
/*  303:     */  public float add(char k, float incr)
/*  304:     */  {
...
/*  355:     */  }
/*  356:     */  
/*  357:     */  public float remove(char k)
/*  358:     */  {
...
/*  462:     */  }
/*  463:     */  
/*  467:     */  public float getAndMoveToFirst(char k)
/*  468:     */  {
...
/*  483:     */  }
/*  484:     */  
/*  488:     */  public float getAndMoveToLast(char k)
/*  489:     */  {
...
/*  504:     */  }
/*  505:     */  
/*  510:     */  public float putAndMoveToFirst(char k, float v)
/*  511:     */  {
...
/*  543:     */  }
/*  544:     */  
/*  549:     */  public float putAndMoveToLast(char k, float v)
/*  550:     */  {
...
/*  582:     */  }
/*  583:     */  
/*  584: 584 */  public Float get(Character ok) { char k = ok.charValue();
/*  585:     */    
...
/*  660:     */    implements Char2FloatMap.Entry, Map.Entry<Character, Float>
/*  661:     */  {
...
/*  667:     */    }
/*  668:     */    
/*  669: 669 */    public Character getKey() { return Character.valueOf(Char2FloatLinkedOpenHashMap.this.key[this.index]); }
/*  670:     */    
/*  671:     */    public char getCharKey() {
/*  672: 672 */      return Char2FloatLinkedOpenHashMap.this.key[this.index];
/*  673:     */    }
/*  674:     */    
/*  675: 675 */    public Float getValue() { return Float.valueOf(Char2FloatLinkedOpenHashMap.this.value[this.index]); }
/*  676:     */    
/*  678: 678 */    public float getFloatValue() { return Char2FloatLinkedOpenHashMap.this.value[this.index]; }
/*  679:     */    
/*  680:     */    public float setValue(float v) {
/*  681: 681 */      float oldValue = Char2FloatLinkedOpenHashMap.this.value[this.index];
/*  682: 682 */      Char2FloatLinkedOpenHashMap.this.value[this.index] = v;
...
/*  691: 691 */      Map.Entry<Character, Float> e = (Map.Entry)o;
/*  692: 692 */      return (Char2FloatLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2FloatLinkedOpenHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/*  693:     */    }
/*  694:     */    
/*  695: 695 */    public int hashCode() { return Char2FloatLinkedOpenHashMap.this.key[this.index] ^ HashCommon.float2int(Char2FloatLinkedOpenHashMap.this.value[this.index]); }
/*  696:     */    
/*  697:     */    public String toString() {
/*  698: 698 */      return Char2FloatLinkedOpenHashMap.this.key[this.index] + "=>" + Char2FloatLinkedOpenHashMap.this.value[this.index];
/*  699:     */    }
/*  700:     */  }
/*  701:     */  
...
/*  786: 786 */  public Char2FloatSortedMap tailMap(char from) { throw new UnsupportedOperationException(); }
/*  787: 787 */  public Char2FloatSortedMap headMap(char to) { throw new UnsupportedOperationException(); }
/*  788: 788 */  public Char2FloatSortedMap subMap(char from, char to) { throw new UnsupportedOperationException(); }
/*  789:     */  
...
/*  803: 803 */    int index = -1;
/*  804:     */    
/*  805: 805 */    private MapIterator() { this.next = Char2FloatLinkedOpenHashMap.this.first;
/*  806: 806 */      this.index = 0;
/*  807:     */    }
/*  808:     */    
/*  809: 809 */    private MapIterator(char from) { if (Char2FloatLinkedOpenHashMap.this.key[Char2FloatLinkedOpenHashMap.this.last] == from) {
/*  810: 810 */        this.prev = Char2FloatLinkedOpenHashMap.this.last;
/*  811: 811 */        this.index = Char2FloatLinkedOpenHashMap.this.size;
/*  812:     */      }
/*  813:     */      else
/*  814:     */      {
/*  815: 815 */        int pos = HashCommon.murmurHash3(from) & Char2FloatLinkedOpenHashMap.this.mask;
/*  816:     */        
/*  817: 817 */        while (Char2FloatLinkedOpenHashMap.this.used[pos] != 0) {
/*  818: 818 */          if (Char2FloatLinkedOpenHashMap.this.key[pos] == from)
/*  819:     */          {
/*  820: 820 */            this.next = ((int)Char2FloatLinkedOpenHashMap.this.link[pos]);
/*  821: 821 */            this.prev = pos;
/*  822: 822 */            return;
/*  823:     */          }
/*  824: 824 */          pos = pos + 1 & Char2FloatLinkedOpenHashMap.this.mask;
/*  825:     */        }
...
/*  838: 838 */        this.index = Char2FloatLinkedOpenHashMap.this.size;
/*  839: 839 */        return;
/*  840:     */      }
/*  841: 841 */      int pos = Char2FloatLinkedOpenHashMap.this.first;
/*  842: 842 */      this.index = 1;
/*  843: 843 */      while (pos != this.prev) {
/*  844: 844 */        pos = (int)Char2FloatLinkedOpenHashMap.this.link[pos];
...
/*  855:     */    }
/*  856:     */    
/*  857: 857 */    public int nextEntry() { if (!hasNext()) return Char2FloatLinkedOpenHashMap.this.size();
/*  858: 858 */      this.curr = this.next;
/*  859: 859 */      this.next = ((int)Char2FloatLinkedOpenHashMap.this.link[this.curr]);
...
/*  867: 867 */      this.prev = ((int)(Char2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  880: 880 */        this.prev = ((int)(Char2FloatLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  881:     */      }
/*  882:     */      else {
/*  883: 883 */        this.next = ((int)Char2FloatLinkedOpenHashMap.this.link[this.curr]); }
/*  884: 884 */      Char2FloatLinkedOpenHashMap.this.size -= 1;
/*  885:     */      
/*  887: 887 */      if (this.prev == -1) { Char2FloatLinkedOpenHashMap.this.first = this.next;
/*  888:     */      } else
/*  889: 889 */        Char2FloatLinkedOpenHashMap.this.link[this.prev] ^= (Char2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890: 890 */      if (this.next == -1) { Char2FloatLinkedOpenHashMap.this.last = this.prev;
/*  891:     */      } else
/*  892: 892 */        Char2FloatLinkedOpenHashMap.this.link[this.next] ^= (Char2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  893: 893 */      int pos = this.curr;
/*  894:     */      int last;
/*  895:     */      for (;;) {
/*  896: 896 */        pos = (last = pos) + 1 & Char2FloatLinkedOpenHashMap.this.mask;
/*  897: 897 */        while (Char2FloatLinkedOpenHashMap.this.used[pos] != 0) {
/*  898: 898 */          int slot = HashCommon.murmurHash3(Char2FloatLinkedOpenHashMap.this.key[pos]) & Char2FloatLinkedOpenHashMap.this.mask;
/*  899: 899 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900: 900 */          pos = pos + 1 & Char2FloatLinkedOpenHashMap.this.mask;
/*  901:     */        }
/*  902: 902 */        if (Char2FloatLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903: 903 */        Char2FloatLinkedOpenHashMap.this.key[last] = Char2FloatLinkedOpenHashMap.this.key[pos];
/*  904: 904 */        Char2FloatLinkedOpenHashMap.this.value[last] = Char2FloatLinkedOpenHashMap.this.value[pos];
/*  905: 905 */        if (this.next == pos) this.next = last;
/*  906: 906 */        if (this.prev == pos) this.prev = last;
/*  907: 907 */        Char2FloatLinkedOpenHashMap.this.fixPointers(pos, last);
/*  908:     */      }
/*  909: 909 */      Char2FloatLinkedOpenHashMap.this.used[last] = false;
/*  910: 910 */      this.curr = -1;
/*  911:     */    }
/*  912:     */    
...
/*  921:     */    } }
/*  922:     */  
/*  923:     */  private class EntryIterator extends Char2FloatLinkedOpenHashMap.MapIterator implements ObjectListIterator<Char2FloatMap.Entry> { private Char2FloatLinkedOpenHashMap.MapEntry entry;
/*  924:     */    
/*  925: 925 */    public EntryIterator() { super(null); }
/*  926:     */    
/*  927: 927 */    public EntryIterator(char from) { super(from, null); }
/*  928:     */    
/*  929:     */    public Char2FloatLinkedOpenHashMap.MapEntry next() {
/*  930: 930 */      return this.entry = new Char2FloatLinkedOpenHashMap.MapEntry(Char2FloatLinkedOpenHashMap.this, nextEntry());
/*  931:     */    }
/*  932:     */    
/*  933: 933 */    public Char2FloatLinkedOpenHashMap.MapEntry previous() { return this.entry = new Char2FloatLinkedOpenHashMap.MapEntry(Char2FloatLinkedOpenHashMap.this, previousEntry()); }
/*  934:     */    
/*  935:     */    public void remove()
/*  936:     */    {
/*  937: 937 */      super.remove();
/*  938: 938 */      Char2FloatLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  939:     */    
/*  940: 940 */    public void set(Char2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  941: 941 */    public void add(Char2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  942:     */  }
/*  943:     */  
/*  944: 944 */  private class FastEntryIterator extends Char2FloatLinkedOpenHashMap.MapIterator implements ObjectListIterator<Char2FloatMap.Entry> { final AbstractChar2FloatMap.BasicEntry entry = new AbstractChar2FloatMap.BasicEntry('\000', 0.0F);
/*  945: 945 */    public FastEntryIterator() { super(null); }
/*  946:     */    
/*  947: 947 */    public FastEntryIterator(char from) { super(from, null); }
/*  948:     */    
/*  949:     */    public AbstractChar2FloatMap.BasicEntry next() {
/*  950: 950 */      int e = nextEntry();
/*  951: 951 */      this.entry.key = Char2FloatLinkedOpenHashMap.this.key[e];
/*  952: 952 */      this.entry.value = Char2FloatLinkedOpenHashMap.this.value[e];
/*  953: 953 */      return this.entry;
/*  954:     */    }
/*  955:     */    
/*  956: 956 */    public AbstractChar2FloatMap.BasicEntry previous() { int e = previousEntry();
/*  957: 957 */      this.entry.key = Char2FloatLinkedOpenHashMap.this.key[e];
/*  958: 958 */      this.entry.value = Char2FloatLinkedOpenHashMap.this.value[e];
/*  959: 959 */      return this.entry; }
/*  960:     */    
/*  961: 961 */    public void set(Char2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  962: 962 */    public void add(Char2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } }
/*  963:     */  
/*  964:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Char2FloatMap.Entry> implements Char2FloatSortedMap.FastSortedEntrySet { private MapEntrySet() {}
/*  965:     */    
/*  966: 966 */    public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator() { return new Char2FloatLinkedOpenHashMap.EntryIterator(Char2FloatLinkedOpenHashMap.this); }
/*  967:     */    
/*  968: 968 */    public Comparator<? super Char2FloatMap.Entry> comparator() { return null; }
/*  969: 969 */    public ObjectSortedSet<Char2FloatMap.Entry> subSet(Char2FloatMap.Entry fromElement, Char2FloatMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  970: 970 */    public ObjectSortedSet<Char2FloatMap.Entry> headSet(Char2FloatMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  971: 971 */    public ObjectSortedSet<Char2FloatMap.Entry> tailSet(Char2FloatMap.Entry fromElement) { throw new UnsupportedOperationException(); }
/*  972:     */    
/*  973: 973 */    public Char2FloatMap.Entry first() { if (Char2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974: 974 */      return new Char2FloatLinkedOpenHashMap.MapEntry(Char2FloatLinkedOpenHashMap.this, Char2FloatLinkedOpenHashMap.this.first);
/*  975:     */    }
/*  976:     */    
/*  977: 977 */    public Char2FloatMap.Entry last() { if (Char2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978: 978 */      return new Char2FloatLinkedOpenHashMap.MapEntry(Char2FloatLinkedOpenHashMap.this, Char2FloatLinkedOpenHashMap.this.last);
/*  979:     */    }
/*  980:     */    
/*  981:     */    public boolean contains(Object o) {
/*  982: 982 */      if (!(o instanceof Map.Entry)) return false;
/*  983: 983 */      Map.Entry<Character, Float> e = (Map.Entry)o;
/*  984: 984 */      char k = ((Character)e.getKey()).charValue();
/*  985:     */      
/*  986: 986 */      int pos = HashCommon.murmurHash3(k) & Char2FloatLinkedOpenHashMap.this.mask;
/*  987:     */      
/*  988: 988 */      while (Char2FloatLinkedOpenHashMap.this.used[pos] != 0) {
/*  989: 989 */        if (Char2FloatLinkedOpenHashMap.this.key[pos] == k) return Char2FloatLinkedOpenHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/*  990: 990 */        pos = pos + 1 & Char2FloatLinkedOpenHashMap.this.mask;
/*  991:     */      }
...
/*  997: 997 */      Map.Entry<Character, Float> e = (Map.Entry)o;
/*  998: 998 */      char k = ((Character)e.getKey()).charValue();
/*  999:     */      
/* 1000:1000 */      int pos = HashCommon.murmurHash3(k) & Char2FloatLinkedOpenHashMap.this.mask;
/* 1001:     */      
/* 1002:1002 */      while (Char2FloatLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003:1003 */        if (Char2FloatLinkedOpenHashMap.this.key[pos] == k) {
/* 1004:1004 */          Char2FloatLinkedOpenHashMap.this.remove(e.getKey());
/* 1005:1005 */          return true;
/* 1006:     */        }
/* 1007:1007 */        pos = pos + 1 & Char2FloatLinkedOpenHashMap.this.mask;
/* 1008:     */      }
/* 1009:1009 */      return false;
/* 1010:     */    }
/* 1011:     */    
/* 1012:1012 */    public int size() { return Char2FloatLinkedOpenHashMap.this.size; }
/* 1013:     */    
/* 1014:     */    public void clear() {
/* 1015:1015 */      Char2FloatLinkedOpenHashMap.this.clear();
/* 1016:     */    }
/* 1017:     */    
/* 1018:1018 */    public ObjectBidirectionalIterator<Char2FloatMap.Entry> iterator(Char2FloatMap.Entry from) { return new Char2FloatLinkedOpenHashMap.EntryIterator(Char2FloatLinkedOpenHashMap.this, ((Character)from.getKey()).charValue()); }
/* 1019:     */    
/* 1020:     */    public ObjectBidirectionalIterator<Char2FloatMap.Entry> fastIterator() {
/* 1021:1021 */      return new Char2FloatLinkedOpenHashMap.FastEntryIterator(Char2FloatLinkedOpenHashMap.this);
/* 1022:     */    }
/* 1023:     */    
/* 1024:1024 */    public ObjectBidirectionalIterator<Char2FloatMap.Entry> fastIterator(Char2FloatMap.Entry from) { return new Char2FloatLinkedOpenHashMap.FastEntryIterator(Char2FloatLinkedOpenHashMap.this, ((Character)from.getKey()).charValue()); }
/* 1025:     */  }
/* 1026:     */  
/* 1027:     */  public Char2FloatSortedMap.FastSortedEntrySet char2FloatEntrySet() {
...
/* 1035:     */    extends Char2FloatLinkedOpenHashMap.MapIterator
/* 1036:     */    implements CharListIterator
/* 1037:     */  {
/* 1038:1038 */    public KeyIterator(char k) { super(k, null); }
/* 1039:1039 */    public char previousChar() { return Char2FloatLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1042:1042 */    public Character previous() { return Character.valueOf(Char2FloatLinkedOpenHashMap.this.key[previousEntry()]); }
...
/* 1046:1046 */    public char nextChar() { return Char2FloatLinkedOpenHashMap.this.key[nextEntry()]; }
/* 1047:1047 */    public Character next() { return Character.valueOf(Char2FloatLinkedOpenHashMap.this.key[nextEntry()]); } }
/* 1048:     */  
/* 1049:     */  private final class KeySet extends AbstractCharSortedSet { private KeySet() {}
/* 1050:     */    
/* 1051:1051 */    public CharListIterator iterator(char from) { return new Char2FloatLinkedOpenHashMap.KeyIterator(Char2FloatLinkedOpenHashMap.this, from); }
/* 1052:     */    
/* 1053:     */    public CharListIterator iterator() {
/* 1054:1054 */      return new Char2FloatLinkedOpenHashMap.KeyIterator(Char2FloatLinkedOpenHashMap.this);
/* 1055:     */    }
/* 1056:     */    
/* 1057:1057 */    public int size() { return Char2FloatLinkedOpenHashMap.this.size; }
/* 1058:     */    
/* 1060:1060 */    public boolean contains(char k) { return Char2FloatLinkedOpenHashMap.this.containsKey(k); }
/* 1061:     */    
/* 1062:     */    public boolean remove(char k) {
/* 1063:1063 */      int oldSize = Char2FloatLinkedOpenHashMap.this.size;
/* 1064:1064 */      Char2FloatLinkedOpenHashMap.this.remove(k);
/* 1065:1065 */      return Char2FloatLinkedOpenHashMap.this.size != oldSize;
/* 1066:     */    }
/* 1067:     */    
/* 1068:1068 */    public void clear() { Char2FloatLinkedOpenHashMap.this.clear(); }
/* 1069:     */    
/* 1070:     */    public char firstChar() {
/* 1071:1071 */      if (Char2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072:1072 */      return Char2FloatLinkedOpenHashMap.this.key[Char2FloatLinkedOpenHashMap.this.first];
/* 1073:     */    }
/* 1074:     */    
/* 1075:1075 */    public char lastChar() { if (Char2FloatLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076:1076 */      return Char2FloatLinkedOpenHashMap.this.key[Char2FloatLinkedOpenHashMap.this.last]; }
/* 1077:     */    
...
/* 1091:     */    extends Char2FloatLinkedOpenHashMap.MapIterator
/* 1092:     */    implements FloatListIterator
/* 1093:     */  {
/* 1094:1094 */    public float previousFloat() { return Char2FloatLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1095:1095 */    public Float previous() { return Float.valueOf(Char2FloatLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1101:1101 */    public float nextFloat() { return Char2FloatLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1102:1102 */    public Float next() { return Float.valueOf(Char2FloatLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1103:     */  }
/* 1104:     */  
...
/* 1107:1107 */          return new Char2FloatLinkedOpenHashMap.ValueIterator(Char2FloatLinkedOpenHashMap.this);
/* 1108:     */        }
/* 1109:     */        
/* 1110:1110 */        public int size() { return Char2FloatLinkedOpenHashMap.this.size; }
/* 1111:     */        
/* 1112:     */        public boolean contains(float v) {
/* 1113:1113 */          return Char2FloatLinkedOpenHashMap.this.containsValue(v);
/* 1114:     */        }
/* 1115:     */        
/* 1116:1116 */        public void clear() { Char2FloatLinkedOpenHashMap.this.clear(); }
/* 1117:     */      };
/* 1118:     */    }
...
/* 1238:     */  }
/* 1239:     */  
/* 1242:     */  public Char2FloatLinkedOpenHashMap clone()
/* 1243:     */  {
/* 1244:     */    Char2FloatLinkedOpenHashMap c;
/* 1245:     */    
/* 1247:     */    try
/* 1248:     */    {
/* 1249:1249 */      c = (Char2FloatLinkedOpenHashMap)super.clone();
/* 1250:     */    }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.chars.Char2FloatLinkedOpenHashMap
