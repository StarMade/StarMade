...
/*      */ 
/*      */ public class Char2IntRBTreeMap extends AbstractChar2IntSortedMap
...
/*  119 */           return Char2IntRBTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*      */         }
/*      */         public int compare(Character ok1, Character ok2) {
/*  122 */           return Char2IntRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     int oldValue = put(ok.charValue(), ov.intValue());
/*  731 */     return this.modified ? null : Integer.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Integer remove(Object ok)
/*      */   {
/*  737 */     int oldValue = remove(((Character)ok).charValue());
...
/* 1141 */         final Comparator<? super Char2IntMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Char2IntMap.Entry x, Char2IntMap.Entry y) {
/* 1143 */             return Char2IntRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Char2IntRBTreeMap.EntryIterator(Char2IntRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1153 */           return new Char2IntRBTreeMap.EntryIterator(Char2IntRBTreeMap.this, ((Character)from.getKey()).charValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Char2IntRBTreeMap.Entry f = Char2IntRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1166 */           Char2IntRBTreeMap.Entry f = Char2IntRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1167 */           if (f != null) Char2IntRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Char2IntRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Char2IntRBTreeMap.this.clear(); } 
/* 1172 */         public Char2IntMap.Entry first() { return Char2IntRBTreeMap.this.firstEntry; } 
/* 1173 */         public Char2IntMap.Entry last() { return Char2IntRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) { return Char2IntRBTreeMap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2IntEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) { return Char2IntRBTreeMap.this.headMap((Character)to.getKey()).char2IntEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) { return Char2IntRBTreeMap.this.tailMap((Character)from.getKey()).char2IntEntrySet(); }
/*      */       };
...
/* 1242 */           return new Char2IntRBTreeMap.ValueIterator(Char2IntRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(int k) {
/* 1245 */           return Char2IntRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Char2IntRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Char2IntRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Char2IntRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readChar(), s.readInt());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readChar(), s.readInt());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readChar(), s.readInt()));
...
/*      */ 
/*      */ 
/*      */   private final class Submap extends AbstractChar2IntSortedMap
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Char2IntRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Char2IntRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator() {
/* 1329 */             return new Char2IntRBTreeMap.Submap.SubmapEntryIterator(Char2IntRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1332 */             return new Char2IntRBTreeMap.Submap.SubmapEntryIterator(Char2IntRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
/*      */           }
/* 1334 */           public Comparator<? super Char2IntMap.Entry> comparator() { return Char2IntRBTreeMap.this.char2IntEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Char2IntRBTreeMap.Entry f = Char2IntRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1340 */             return (f != null) && (Char2IntRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Char2IntRBTreeMap.Entry f = Char2IntRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1347 */             if ((f != null) && (Char2IntRBTreeMap.Submap.this.in(f.key))) Char2IntRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Char2IntRBTreeMap.Submap.SubmapIterator(Char2IntRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Char2IntRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Char2IntMap.Entry first() { return Char2IntRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Char2IntMap.Entry last() { return Char2IntRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) { return Char2IntRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2IntEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) { return Char2IntRBTreeMap.Submap.this.headMap((Character)to.getKey()).char2IntEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) { return Char2IntRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2IntEntrySet(); }
/*      */         };
...
/*      */           public IntIterator iterator() {
/* 1376 */             return new Char2IntRBTreeMap.Submap.SubmapValueIterator(Char2IntRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(int k) {
/* 1379 */             return Char2IntRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Char2IntRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Char2IntRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(char k) {
/* 1392 */       return (in(k)) && (Char2IntRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(int v) {
...
/* 1407 */       return (in(kk)) && ((e = Char2IntRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public int put(char k, int v) {
/* 1410 */       Char2IntRBTreeMap.this.modified = false;
...
/* 1412 */       int oldValue = Char2IntRBTreeMap.this.put(k, v);
/* 1413 */       return Char2IntRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Integer put(Character ok, Integer ov) {
/* 1416 */       int oldValue = put(ok.charValue(), ov.intValue());
/* 1417 */       return Char2IntRBTreeMap.this.modified ? null : Integer.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public int remove(char k) {
/* 1421 */       Char2IntRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       int oldValue = Char2IntRBTreeMap.this.remove(k);
/* 1424 */       return Char2IntRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Integer remove(Object ok) {
/* 1427 */       int oldValue = remove(((Character)ok).charValue());
/* 1428 */       return Char2IntRBTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public CharComparator comparator() {
/* 1443 */       return Char2IntRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Char2IntSortedMap headMap(char to) {
/* 1446 */       if (this.top) return new Submap(Char2IntRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Char2IntRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Char2IntRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Char2IntSortedMap tailMap(char from) {
/* 1450 */       if (this.bottom) return new Submap(Char2IntRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Char2IntRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2IntRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Char2IntSortedMap subMap(char from, char to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Char2IntRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Char2IntRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Char2IntRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Char2IntRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Char2IntRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Char2IntRBTreeMap.this.tree == null) return null;
/* 1468 */       Char2IntRBTreeMap.Entry e;
/*      */       Char2IntRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Char2IntRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Char2IntRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Char2IntRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Char2IntRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Char2IntRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Char2IntRBTreeMap.this.tree == null) return null;
/* 1486 */       Char2IntRBTreeMap.Entry e;
/*      */       Char2IntRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Char2IntRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Char2IntRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Char2IntRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Char2IntRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public char firstCharKey() {
/* 1497 */       Char2IntRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public char lastCharKey() {
/* 1502 */       Char2IntRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Character firstKey() {
/* 1507 */       Char2IntRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Character lastKey() {
/* 1512 */       Char2IntRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Char2IntRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Char2IntRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Char2IntRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Char2IntMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Char2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Char2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Char2IntRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Char2IntRBTreeMap.Submap.this.bottom) && (Char2IntRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Char2IntRBTreeMap.Submap.this.top) && (Char2IntRBTreeMap.this.compare(k, (this.prev = Char2IntRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Char2IntRBTreeMap.this.locateKey(k);
/* 1534 */             if (Char2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Char2IntRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2IntRBTreeMap.this.compare(this.prev.key, Char2IntRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Char2IntRBTreeMap.Submap.this.top) && (this.next != null) && (Char2IntRBTreeMap.this.compare(this.next.key, Char2IntRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public CharBidirectionalIterator iterator() { return new Char2IntRBTreeMap.Submap.SubmapKeyIterator(Char2IntRBTreeMap.Submap.this); } 
/* 1367 */       public CharBidirectionalIterator iterator(char from) { return new Char2IntRBTreeMap.Submap.SubmapKeyIterator(Char2IntRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2IntRBTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public CharBidirectionalIterator iterator() { return new Char2IntRBTreeMap.KeyIterator(Char2IntRBTreeMap.this); } 
/* 1201 */     public CharBidirectionalIterator iterator(char from) { return new Char2IntRBTreeMap.KeyIterator(Char2IntRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2IntRBTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2IntRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Char2IntMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Char2IntMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Char2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Char2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Char2IntRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(char k) {
/* 1067 */       if ((this.next = Char2IntRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Char2IntRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Char2IntRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Character)e.getKey()).charValue()) && (this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
