  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2ByteOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2ByteOpenHashMap(Map<? extends Character, ? extends Byte> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ByteOpenHashMap(Map<? extends Character, ? extends Byte> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ByteOpenHashMap(Char2ByteMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ByteOpenHashMap(Char2ByteMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ByteOpenHashMap(char[] local_k, byte[] local_v, float local_f)
  {
  ...
  public Char2ByteOpenHashMap(char[] local_k, byte[] local_v)
  {
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Char2ByteOpenHashMap.ValueIterator(Char2ByteOpenHashMap.this);
        }
        ...
        {
          return Char2ByteOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2ByteOpenHashMap local_c;
    try
    {
      local_c = (Char2ByteOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2ByteOpenHashMap.MapIterator
    implements ByteIterator
  {
    ...
    public Byte next()
    {
      return Byte.valueOf(Char2ByteOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSet
  {
    ...
    {
      return new Char2ByteOpenHashMap.KeyIterator(Char2ByteOpenHashMap.this);
    }
    ...
    {
      return Char2ByteOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2ByteOpenHashMap.this.size;
      Char2ByteOpenHashMap.this.remove(local_k);
    ...
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Char2ByteOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2ByteMap.FastEntrySet
  {
    ...
    {
      return new Char2ByteOpenHashMap.EntryIterator(Char2ByteOpenHashMap.this, null);
    }
    
    public ObjectIterator<Char2ByteMap.Entry> fastIterator()
    {
      return new Char2ByteOpenHashMap.FastEntryIterator(Char2ByteOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ByteOpenHashMap.this.mask; Char2ByteOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ByteOpenHashMap.this.mask) {
        if (Char2ByteOpenHashMap.this.key[pos] == local_k) {
          return Char2ByteOpenHashMap.this.value[pos] == ((Byte)local_e.getValue()).byteValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ByteOpenHashMap.this.mask; Char2ByteOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ByteOpenHashMap.this.mask) {
        if (Char2ByteOpenHashMap.this.key[pos] == local_k)
        {
          Char2ByteOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2ByteMap.Entry>
  {
    ...
    public AbstractChar2ByteMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2ByteOpenHashMap.this.key[local_e];
      this.entry.value = Char2ByteOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2ByteMap.Entry>
  {
    ...
    {
      return this.entry = new Char2ByteOpenHashMap.MapEntry(Char2ByteOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2ByteOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2ByteOpenHashMap.this.field_49;
    int last = -1;
    int field_2141 = Char2ByteOpenHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2ByteOpenHashMap.this.used;
      while ((this.field_2141 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2141 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2141 != 0)
      {
        boolean[] local_k = Char2ByteOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2ByteOpenHashMap.this.mask; Char2ByteOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ByteOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2ByteOpenHashMap.this.key[pos]) & Char2ByteOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2ByteOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2ByteOpenHashMap.this.key[pos]);
        }
        Char2ByteOpenHashMap.this.key[last] = Char2ByteOpenHashMap.this.key[pos];
        Char2ByteOpenHashMap.this.value[last] = Char2ByteOpenHashMap.this.value[pos];
      }
      Char2ByteOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2ByteOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2ByteOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2141 > 0))
      {
        this.field_2141 += 1;
        nextEntry();
      }
    ...
    implements Char2ByteMap.Entry, Map.Entry<Character, Byte>
  {
    ...
    public byte setValue(byte local_v)
    {
      ...
      Char2ByteOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Byte> local_e = (Map.Entry)local_o;
      return (Char2ByteOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2ByteOpenHashMap.this.value[this.index] == ((Byte)local_e.getValue()).byteValue());
    }
