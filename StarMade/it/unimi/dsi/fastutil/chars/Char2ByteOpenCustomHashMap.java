...
/*  18:    */
/*  90:    */public class Char2ByteOpenCustomHashMap
/*  91:    */  extends AbstractChar2ByteMap
...
/* 104:    */  protected volatile transient Char2ByteMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Char2ByteOpenCustomHashMap(int expected, float f, CharHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Char2ByteOpenCustomHashMap(int expected, CharHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Char2ByteOpenCustomHashMap(CharHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Char2ByteOpenCustomHashMap(Map<? extends Character, ? extends Byte> m, float f, CharHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Char2ByteOpenCustomHashMap(Map<? extends Character, ? extends Byte> m, CharHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Char2ByteOpenCustomHashMap(Char2ByteMap m, float f, CharHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Char2ByteOpenCustomHashMap(Char2ByteMap m, CharHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Char2ByteOpenCustomHashMap(char[] k, byte[] v, float f, CharHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Char2ByteOpenCustomHashMap(char[] k, byte[] v, CharHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public byte put(char k, byte v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Byte put(Character ok, Byte ov) { byte v = ov.byteValue();
...
/* 246:    */  }
/* 247:    */  
/* 258:    */  public byte add(char k, byte incr)
/* 259:    */  {
...
/* 332:    */  }
/* 333:    */  
/* 334:334 */  public Byte get(Character ok) { char k = ok.charValue();
/* 335:    */    
...
/* 409:    */    implements Char2ByteMap.Entry, Map.Entry<Character, Byte>
/* 410:    */  {
...
/* 416:    */    }
/* 417:    */    
/* 418:418 */    public Character getKey() { return Character.valueOf(Char2ByteOpenCustomHashMap.this.key[this.index]); }
/* 419:    */    
/* 420:    */    public char getCharKey() {
/* 421:421 */      return Char2ByteOpenCustomHashMap.this.key[this.index];
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public Byte getValue() { return Byte.valueOf(Char2ByteOpenCustomHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public byte getByteValue() { return Char2ByteOpenCustomHashMap.this.value[this.index]; }
/* 428:    */    
/* 429:    */    public byte setValue(byte v) {
/* 430:430 */      byte oldValue = Char2ByteOpenCustomHashMap.this.value[this.index];
/* 431:431 */      Char2ByteOpenCustomHashMap.this.value[this.index] = v;
...
/* 440:440 */      Map.Entry<Character, Byte> e = (Map.Entry)o;
/* 441:441 */      return (Char2ByteOpenCustomHashMap.this.strategy.equals(Char2ByteOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue())) && (Char2ByteOpenCustomHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/* 442:    */    }
/* 443:    */    
/* 444:444 */    public int hashCode() { return Char2ByteOpenCustomHashMap.this.strategy.hashCode(Char2ByteOpenCustomHashMap.this.key[this.index]) ^ Char2ByteOpenCustomHashMap.this.value[this.index]; }
/* 445:    */    
/* 447:447 */    public String toString() { return Char2ByteOpenCustomHashMap.this.key[this.index] + "=>" + Char2ByteOpenCustomHashMap.this.value[this.index]; } }
/* 448:    */  
...
/* 453:    */    
/* 454:454 */    private MapIterator() { this.pos = Char2ByteOpenCustomHashMap.this.n;
/* 455:    */      
/* 457:457 */      this.last = -1;
/* 458:    */      
/* 459:459 */      this.c = Char2ByteOpenCustomHashMap.this.size;
/* 460:    */      
/* 464:464 */      boolean[] used = Char2ByteOpenCustomHashMap.this.used;
...
/* 476:    */        
/* 477:477 */        int pos = HashCommon.murmurHash3(Char2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ByteOpenCustomHashMap.this.mask;
/* 478:    */        
/* 479:479 */        while (Char2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 480:480 */          if (Char2ByteOpenCustomHashMap.this.strategy.equals(Char2ByteOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481:481 */          pos = pos + 1 & Char2ByteOpenCustomHashMap.this.mask;
/* 482:    */        }
/* 483:    */      }
/* 484:484 */      this.last = this.pos;
/* 485:    */      
/* 486:486 */      if (this.c != 0) {
/* 487:487 */        boolean[] used = Char2ByteOpenCustomHashMap.this.used;
...
/* 502:    */      for (;;)
/* 503:    */      {
/* 504:504 */        pos = (last = pos) + 1 & Char2ByteOpenCustomHashMap.this.mask;
/* 505:505 */        while (Char2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 506:506 */          int slot = HashCommon.murmurHash3(Char2ByteOpenCustomHashMap.this.strategy.hashCode(Char2ByteOpenCustomHashMap.this.key[pos])) & Char2ByteOpenCustomHashMap.this.mask;
/* 507:507 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508:508 */          pos = pos + 1 & Char2ByteOpenCustomHashMap.this.mask;
/* 509:    */        }
/* 510:510 */        if (Char2ByteOpenCustomHashMap.this.used[pos] == 0) break;
/* 511:511 */        if (pos < last)
/* 512:    */        {
/* 513:513 */          if (this.wrapped == null) this.wrapped = new CharArrayList();
/* 514:514 */          this.wrapped.add(Char2ByteOpenCustomHashMap.this.key[pos]);
/* 515:    */        }
/* 516:516 */        Char2ByteOpenCustomHashMap.this.key[last] = Char2ByteOpenCustomHashMap.this.key[pos];
/* 517:517 */        Char2ByteOpenCustomHashMap.this.value[last] = Char2ByteOpenCustomHashMap.this.value[pos];
/* 518:    */      }
/* 519:519 */      Char2ByteOpenCustomHashMap.this.used[last] = false;
/* 520:520 */      return last;
/* 521:    */    }
/* 522:    */    
...
/* 526:    */      {
/* 527:527 */        Char2ByteOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
/* 528:528 */        this.last = -1;
/* 529:529 */        return;
/* 530:    */      }
/* 531:531 */      Char2ByteOpenCustomHashMap.this.size -= 1;
...
/* 543:    */    } }
/* 544:    */  
/* 545:545 */  private class EntryIterator extends Char2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Char2ByteMap.Entry> { private EntryIterator() { super(null); }
/* 546:    */    
/* 547:    */    private Char2ByteOpenCustomHashMap.MapEntry entry;
/* 548:548 */    public Char2ByteMap.Entry next() { return this.entry = new Char2ByteOpenCustomHashMap.MapEntry(Char2ByteOpenCustomHashMap.this, nextEntry()); }
/* 549:    */    
/* 550:    */    public void remove()
/* 551:    */    {
/* 552:552 */      super.remove();
/* 553:553 */      Char2ByteOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 554:    */    } }
/* 555:    */  
/* 556:556 */  private class FastEntryIterator extends Char2ByteOpenCustomHashMap.MapIterator implements ObjectIterator<Char2ByteMap.Entry> { private FastEntryIterator() { super(null); }
/* 557:557 */    final AbstractChar2ByteMap.BasicEntry entry = new AbstractChar2ByteMap.BasicEntry('\000', (byte)0);
/* 558:    */    
/* 559:559 */    public AbstractChar2ByteMap.BasicEntry next() { int e = nextEntry();
/* 560:560 */      this.entry.key = Char2ByteOpenCustomHashMap.this.key[e];
/* 561:561 */      this.entry.value = Char2ByteOpenCustomHashMap.this.value[e];
/* 562:562 */      return this.entry;
/* 563:    */    } }
/* 564:    */  
/* 565:    */  private final class MapEntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteMap.FastEntrySet { private MapEntrySet() {}
/* 566:    */    
/* 567:567 */    public ObjectIterator<Char2ByteMap.Entry> iterator() { return new Char2ByteOpenCustomHashMap.EntryIterator(Char2ByteOpenCustomHashMap.this, null); }
/* 568:    */    
/* 569:    */    public ObjectIterator<Char2ByteMap.Entry> fastIterator() {
/* 570:570 */      return new Char2ByteOpenCustomHashMap.FastEntryIterator(Char2ByteOpenCustomHashMap.this, null);
/* 571:    */    }
/* 572:    */    
/* 573:    */    public boolean contains(Object o) {
/* 574:574 */      if (!(o instanceof Map.Entry)) return false;
/* 575:575 */      Map.Entry<Character, Byte> e = (Map.Entry)o;
/* 576:576 */      char k = ((Character)e.getKey()).charValue();
/* 577:    */      
/* 578:578 */      int pos = HashCommon.murmurHash3(Char2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ByteOpenCustomHashMap.this.mask;
/* 579:    */      
/* 580:580 */      while (Char2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 581:581 */        if (Char2ByteOpenCustomHashMap.this.strategy.equals(Char2ByteOpenCustomHashMap.this.key[pos], k)) return Char2ByteOpenCustomHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 582:582 */        pos = pos + 1 & Char2ByteOpenCustomHashMap.this.mask;
/* 583:    */      }
...
/* 589:589 */      Map.Entry<Character, Byte> e = (Map.Entry)o;
/* 590:590 */      char k = ((Character)e.getKey()).charValue();
/* 591:    */      
/* 592:592 */      int pos = HashCommon.murmurHash3(Char2ByteOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ByteOpenCustomHashMap.this.mask;
/* 593:    */      
/* 594:594 */      while (Char2ByteOpenCustomHashMap.this.used[pos] != 0) {
/* 595:595 */        if (Char2ByteOpenCustomHashMap.this.strategy.equals(Char2ByteOpenCustomHashMap.this.key[pos], k)) {
/* 596:596 */          Char2ByteOpenCustomHashMap.this.remove(e.getKey());
/* 597:597 */          return true;
/* 598:    */        }
/* 599:599 */        pos = pos + 1 & Char2ByteOpenCustomHashMap.this.mask;
/* 600:    */      }
/* 601:601 */      return false;
/* 602:    */    }
/* 603:    */    
/* 604:604 */    public int size() { return Char2ByteOpenCustomHashMap.this.size; }
/* 605:    */    
/* 607:607 */    public void clear() { Char2ByteOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
/* 610:    */  public Char2ByteMap.FastEntrySet char2ByteEntrySet() {
...
/* 618:    */    extends Char2ByteOpenCustomHashMap.MapIterator
/* 619:    */    implements CharIterator
/* 620:    */  {
/* 621:621 */    public KeyIterator() { super(null); }
/* 622:622 */    public char nextChar() { return Char2ByteOpenCustomHashMap.this.key[nextEntry()]; }
/* 623:623 */    public Character next() { return Character.valueOf(Char2ByteOpenCustomHashMap.this.key[nextEntry()]); } }
/* 624:    */  
/* 625:    */  private final class KeySet extends AbstractCharSet { private KeySet() {}
/* 626:    */    
/* 627:627 */    public CharIterator iterator() { return new Char2ByteOpenCustomHashMap.KeyIterator(Char2ByteOpenCustomHashMap.this); }
/* 628:    */    
/* 629:    */    public int size() {
/* 630:630 */      return Char2ByteOpenCustomHashMap.this.size;
/* 631:    */    }
/* 632:    */    
/* 633:633 */    public boolean contains(char k) { return Char2ByteOpenCustomHashMap.this.containsKey(k); }
/* 634:    */    
/* 635:    */    public boolean remove(char k) {
/* 636:636 */      int oldSize = Char2ByteOpenCustomHashMap.this.size;
/* 637:637 */      Char2ByteOpenCustomHashMap.this.remove(k);
/* 638:638 */      return Char2ByteOpenCustomHashMap.this.size != oldSize;
/* 639:    */    }
/* 640:    */    
/* 641:641 */    public void clear() { Char2ByteOpenCustomHashMap.this.clear(); }
/* 642:    */  }
/* 643:    */  
...
/* 652:    */    extends Char2ByteOpenCustomHashMap.MapIterator
/* 653:    */    implements ByteIterator
/* 654:    */  {
/* 655:655 */    public ValueIterator() { super(null); }
/* 656:656 */    public byte nextByte() { return Char2ByteOpenCustomHashMap.this.value[nextEntry()]; }
/* 657:657 */    public Byte next() { return Byte.valueOf(Char2ByteOpenCustomHashMap.this.value[nextEntry()]); }
/* 658:    */  }
/* 659:    */  
...
/* 662:662 */          return new Char2ByteOpenCustomHashMap.ValueIterator(Char2ByteOpenCustomHashMap.this);
/* 663:    */        }
/* 664:    */        
/* 665:665 */        public int size() { return Char2ByteOpenCustomHashMap.this.size; }
/* 666:    */        
/* 667:    */        public boolean contains(byte v) {
/* 668:668 */          return Char2ByteOpenCustomHashMap.this.containsValue(v);
/* 669:    */        }
/* 670:    */        
/* 671:671 */        public void clear() { Char2ByteOpenCustomHashMap.this.clear(); }
/* 672:    */      };
/* 673:    */    }
...
/* 774:    */  }
/* 775:    */  
/* 779:    */  public Char2ByteOpenCustomHashMap clone()
/* 780:    */  {
/* 781:    */    Char2ByteOpenCustomHashMap c;
/* 782:    */    
/* 784:    */    try
/* 785:    */    {
/* 786:786 */      c = (Char2ByteOpenCustomHashMap)super.clone();
/* 787:    */    }
