  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2ObjectLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2ObjectLinkedOpenHashMap(Map<? extends Character, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ObjectLinkedOpenHashMap(Map<? extends Character, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ObjectLinkedOpenHashMap(Char2ObjectMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ObjectLinkedOpenHashMap(Char2ObjectMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ObjectLinkedOpenHashMap(char[] local_k, V[] local_v, float local_f)
  {
  ...
  public Char2ObjectLinkedOpenHashMap(char[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Char2ObjectLinkedOpenHashMap.ValueIterator(Char2ObjectLinkedOpenHashMap.this);
        }
        ...
        {
          return Char2ObjectLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2ObjectLinkedOpenHashMap<V> local_c;
    try
    {
      local_c = (Char2ObjectLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    char[] key = this.key;
    V[] value = this.value;
    Char2ObjectLinkedOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractCharSortedSet
  {
    ...
    {
      return new Char2ObjectLinkedOpenHashMap.KeyIterator(Char2ObjectLinkedOpenHashMap.this, from);
    }
    
    public CharListIterator iterator()
    {
      return new Char2ObjectLinkedOpenHashMap.KeyIterator(Char2ObjectLinkedOpenHashMap.this);
    }
    ...
    {
      return Char2ObjectLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2ObjectLinkedOpenHashMap.this.size;
      Char2ObjectLinkedOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Char2ObjectLinkedOpenHashMap.MapIterator
    implements CharListIterator
  {
    ...
    {
      return Character.valueOf(Char2ObjectLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    {
      return Character.valueOf(Char2ObjectLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2ObjectSortedMap.FastSortedEntrySet<V>
  {
    ...
    {
      return new Char2ObjectLinkedOpenHashMap.EntryIterator(Char2ObjectLinkedOpenHashMap.this);
    }
    ...
    public Char2ObjectMap.Entry<V> first()
    {
      ...
      return new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this, Char2ObjectLinkedOpenHashMap.this.first);
    }
    ...
    public Char2ObjectMap.Entry<V> last()
    {
      ...
      return new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this, Char2ObjectLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ObjectLinkedOpenHashMap.this.mask; Char2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask) {
        if (Char2ObjectLinkedOpenHashMap.this.key[pos] == local_k) {
          return Char2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Char2ObjectLinkedOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ObjectLinkedOpenHashMap.this.mask; Char2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask) {
        if (Char2ObjectLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Char2ObjectLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Char2ObjectLinkedOpenHashMap.EntryIterator(Char2ObjectLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
    }
    
    public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> fastIterator()
    {
      return new Char2ObjectLinkedOpenHashMap.FastEntryIterator(Char2ObjectLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> fastIterator(Char2ObjectMap.Entry<V> from)
    {
      return new Char2ObjectLinkedOpenHashMap.FastEntryIterator(Char2ObjectLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
    }
  }
    ...
    implements ObjectListIterator<Char2ObjectMap.Entry<V>>
  {
    ...
    public AbstractChar2ObjectMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Char2ObjectLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Char2ObjectLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Char2ObjectMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this, nextEntry());
    }
    
    public Char2ObjectLinkedOpenHashMap<V>.MapEntry previous()
    {
      return this.entry = new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(char from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Char2ObjectLinkedOpenHashMap.this.mask; Char2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Char2ObjectLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Char2ObjectLinkedOpenHashMap.this.first = this.next;
      } else {
        Char2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Char2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Char2ObjectLinkedOpenHashMap.this.last = this.prev;
      } else {
        Char2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Char2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2ObjectLinkedOpenHashMap.this.mask; Char2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2ObjectLinkedOpenHashMap.this.key[pos]) & Char2ObjectLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2ObjectLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Char2ObjectLinkedOpenHashMap.this.key[last] = Char2ObjectLinkedOpenHashMap.this.key[pos];
      ...
      Char2ObjectLinkedOpenHashMap.this.used[last] = false;
    ...
    implements Char2ObjectMap.Entry<V>, Map.Entry<Character, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Char2ObjectLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, V> local_e = (Map.Entry)local_o;
      return (Char2ObjectLinkedOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2ObjectLinkedOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Char2ObjectLinkedOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
