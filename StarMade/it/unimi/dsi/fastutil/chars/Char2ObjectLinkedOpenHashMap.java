...
/*      */   protected int size;
/*      */   protected volatile transient Char2ObjectSortedMap.FastSortedEntrySet<V> entries;
...
/*  324 */     char k = ((Character)ok).charValue();
/*      */ 
...
/*      */   }
/*  729 */   public CharComparator comparator() { return null; } 
/*  730 */   public Char2ObjectSortedMap<V> tailMap(char from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Char2ObjectSortedMap<V> headMap(char to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Char2ObjectSortedMap<V> subMap(char from, char to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Char2ObjectLinkedOpenHashMap.ValueIterator(Char2ObjectLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Char2ObjectLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Char2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Char2ObjectLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */ 
/* 1137 */     char[] key = this.key;
/* 1138 */     Object[] value = this.value;
/* 1139 */     int newMask = newN - 1;
/* 1140 */     char[] newKey = new char[newN];
...
/*      */     try
/*      */     {
/* 1190 */       c = (Char2ObjectLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1196 */     c.values = null;
/* 1197 */     c.entries = null;
/* 1198 */     c.key = ((char[])this.key.clone());
...
/* 1242 */     char[] key = this.key = new char[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Char2ObjectLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Char2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Char2ObjectLinkedOpenHashMap.KeyIterator(Char2ObjectLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public CharListIterator iterator() {
/*  999 */       return new Char2ObjectLinkedOpenHashMap.KeyIterator(Char2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Char2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(char k) {
/* 1005 */       return Char2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(char k) {
/* 1008 */       int oldSize = Char2ObjectLinkedOpenHashMap.this.size;
/* 1009 */       Char2ObjectLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Char2ObjectLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Char2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public char firstChar() {
/* 1016 */       if (Char2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Char2ObjectLinkedOpenHashMap.this.key[Char2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public char lastChar() {
/* 1020 */       if (Char2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Char2ObjectLinkedOpenHashMap.this.key[Char2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/* 1023 */     public CharComparator comparator() { return null; } 
/* 1024 */     public final CharSortedSet tailSet(char from) { throw new UnsupportedOperationException(); } 
/* 1025 */     public final CharSortedSet headSet(char to) { throw new UnsupportedOperationException(); } 
/* 1026 */     public final CharSortedSet subSet(char from, char to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2ObjectLinkedOpenHashMap.MapIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator(char k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public char previousChar() { return Char2ObjectLinkedOpenHashMap.this.key[previousEntry()]; } 
/*  985 */     public void set(char k) { throw new UnsupportedOperationException(); } 
/*  986 */     public void add(char k) { throw new UnsupportedOperationException(); } 
/*  987 */     public Character previous() { return Character.valueOf(Char2ObjectLinkedOpenHashMap.this.key[previousEntry()]); } 
/*  988 */     public void set(Character ok) { throw new UnsupportedOperationException(); } 
/*  989 */     public void add(Character ok) { throw new UnsupportedOperationException(); } 
/*  990 */     public KeyIterator() { super(null); } 
/*  991 */     public char nextChar() { return Char2ObjectLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Character next() { return Character.valueOf(Char2ObjectLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Char2ObjectLinkedOpenHashMap.EntryIterator(Char2ObjectLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Char2ObjectMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> fromElement, Char2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Char2ObjectMap.Entry<V> first() {
/*  918 */       if (Char2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this, Char2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Char2ObjectMap.Entry<V> last() {
/*  922 */       if (Char2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this, Char2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     public boolean contains(Object o) {
/*  927 */       if (!(o instanceof Map.Entry)) return false;
/*  928 */       Map.Entry e = (Map.Entry)o;
/*  929 */       char k = ((Character)e.getKey()).charValue();
/*      */ 
/*  931 */       int pos = HashCommon.murmurHash3(k) & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Char2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Char2ObjectLinkedOpenHashMap.this.key[pos] == k) return Char2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Char2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  935 */         pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*  943 */       char k = ((Character)e.getKey()).charValue();
/*      */ 
/*  945 */       int pos = HashCommon.murmurHash3(k) & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Char2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Char2ObjectLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Char2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Char2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Char2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from) {
/*  963 */       return new Char2ObjectLinkedOpenHashMap.EntryIterator(Char2ObjectLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> fastIterator() {
/*  966 */       return new Char2ObjectLinkedOpenHashMap.FastEntryIterator(Char2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> fastIterator(Char2ObjectMap.Entry<V> from) {
/*  969 */       return new Char2ObjectLinkedOpenHashMap.FastEntryIterator(Char2ObjectLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Char2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Char2ObjectMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractChar2ObjectMap.BasicEntry<V> entry = new AbstractChar2ObjectMap.BasicEntry('\000', null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Char2ObjectLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Char2ObjectLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractChar2ObjectMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Char2ObjectLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Char2ObjectLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Char2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Char2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Char2ObjectMap.Entry<V>>
/*      */   {
...
/*  870 */       super(null);
/*      */     }
/*  872 */     public EntryIterator(char from) { super(from, null); }
/*      */ 
/*      */     public Char2ObjectLinkedOpenHashMap<V>.MapEntry next() {
/*  875 */       return this.entry = new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Char2ObjectLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Char2ObjectLinkedOpenHashMap.MapEntry(Char2ObjectLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Char2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Char2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Char2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Char2ObjectLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(char from) {
/*  753 */       if (Char2ObjectLinkedOpenHashMap.this.key[Char2ObjectLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Char2ObjectLinkedOpenHashMap.this.last;
/*  755 */         this.index = Char2ObjectLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = HashCommon.murmurHash3(from) & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Char2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Char2ObjectLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Char2ObjectLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Char2ObjectLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Char2ObjectLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Char2ObjectLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Char2ObjectLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Char2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Char2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Char2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Char2ObjectLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Char2ObjectLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Char2ObjectLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Char2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Char2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Char2ObjectLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Char2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Char2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Char2ObjectLinkedOpenHashMap.this.mask;
/*  841 */         while (Char2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = HashCommon.murmurHash3(Char2ObjectLinkedOpenHashMap.this.key[pos]) & Char2ObjectLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Char2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Char2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Char2ObjectLinkedOpenHashMap.this.key[last] = Char2ObjectLinkedOpenHashMap.this.key[pos];
/*  848 */         Char2ObjectLinkedOpenHashMap.this.value[last] = Char2ObjectLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Char2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Char2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Char2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*  619 */       return Character.valueOf(Char2ObjectLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public char getCharKey() {
/*  622 */       return Char2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Char2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Char2ObjectLinkedOpenHashMap.this.value[this.index];
/*  629 */       Char2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Char2ObjectLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Char2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return Char2ObjectLinkedOpenHashMap.this.key[this.index] ^ (Char2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Char2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     public String toString() {
/*  642 */       return Char2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Char2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
