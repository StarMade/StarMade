...
{
  public static int downHeap(char[] refArray, int[] heap, int size, int local_i, CharComparator local_c)
  {
    if (local_i >= size) {
  ...
  public static int upHeap(char[] refArray, int[] heap, int size, int local_i, CharComparator local_c)
  {
    if (local_i >= size) {
      throw new IllegalArgumentException("Heap position (" + local_i + ") is larger than or equal to heap size (" + size + ")");
    }
  ...
  public static void makeHeap(char[] refArray, int offset, int length, int[] heap, CharComparator local_c)
  {
  ...
  public static int[] makeHeap(char[] refArray, int offset, int length, CharComparator local_c)
  {
  ...
  public static void makeHeap(char[] refArray, int[] heap, int size, CharComparator local_c)
  {
    int local_i = size / 2;
    while (local_i-- != 0) {
  ...
  public static int front(char[] refArray, int[] heap, int size, int[] local_a)
  {
