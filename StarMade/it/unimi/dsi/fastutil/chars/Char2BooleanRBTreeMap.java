  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2BooleanRBTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2BooleanRBTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2BooleanRBTreeMap(Map<? extends Character, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2BooleanRBTreeMap(SortedMap<Character, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2BooleanRBTreeMap(Char2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2BooleanRBTreeMap(Char2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2BooleanRBTreeMap(char[] local_k, boolean[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2BooleanRBTreeMap(char[] local_k, boolean[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Char2BooleanMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Char2BooleanRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2BooleanRBTreeMap.EntryIterator(Char2BooleanRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from)
        {
          return new Char2BooleanRBTreeMap.EntryIterator(Char2BooleanRBTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2BooleanRBTreeMap.Entry local_f = Char2BooleanRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2BooleanRBTreeMap.Entry local_f = Char2BooleanRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2BooleanRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Char2BooleanRBTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry local_to)
        {
          return Char2BooleanRBTreeMap.this.headMap((Character)local_to.getKey()).char2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from)
        {
          return Char2BooleanRBTreeMap.this.tailMap((Character)from.getKey()).char2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Char2BooleanRBTreeMap.ValueIterator(Char2BooleanRBTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Char2BooleanRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2BooleanRBTreeMap local_c;
    try
    {
      local_c = (Char2BooleanRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2BooleanRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Char2BooleanRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2BooleanRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator()
          {
            return new Char2BooleanRBTreeMap.Submap.SubmapEntryIterator(Char2BooleanRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from)
          {
            return new Char2BooleanRBTreeMap.Submap.SubmapEntryIterator(Char2BooleanRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, Boolean> local_e = (Map.Entry)local_o;
            Char2BooleanRBTreeMap.Entry local_f = Char2BooleanRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2BooleanRBTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, Boolean> local_e = (Map.Entry)local_o;
            Char2BooleanRBTreeMap.Entry local_f = Char2BooleanRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2BooleanRBTreeMap.Submap.this.in2(local_f.key))) {
              Char2BooleanRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2BooleanRBTreeMap.Submap.SubmapIterator(Char2BooleanRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2BooleanRBTreeMap.Submap.this.clear();
          }
          
          public Char2BooleanMap.Entry first()
          {
            return Char2BooleanRBTreeMap.Submap.this.firstEntry();
          }
          
          public Char2BooleanMap.Entry last()
          {
            return Char2BooleanRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry local_to)
          {
            return Char2BooleanRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry local_to)
          {
            return Char2BooleanRBTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from)
          {
            return Char2BooleanRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Char2BooleanRBTreeMap.Submap.SubmapValueIterator(Char2BooleanRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Char2BooleanRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2BooleanRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2BooleanRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2BooleanRBTreeMap.Entry local_e;
      return (in2(local_kk)) && ((local_e = Char2BooleanRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(char local_k, boolean local_v)
    {
      ...
      boolean oldValue = Char2BooleanRBTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(char local_k)
    {
      ...
      boolean oldValue = Char2BooleanRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2BooleanRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2BooleanRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2BooleanRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2BooleanSortedMap tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2BooleanRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2BooleanRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2BooleanSortedMap subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2BooleanRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2BooleanRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2BooleanRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2BooleanRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2BooleanRBTreeMap.this.locateKey(this.from);
        if (Char2BooleanRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2BooleanRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2BooleanRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2BooleanRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2BooleanRBTreeMap.this.locateKey(this.field_47);
        if (Char2BooleanRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2BooleanRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2BooleanRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2BooleanRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Char2BooleanRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Char2BooleanRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2BooleanRBTreeMap.Submap.this.bottom) && (Char2BooleanRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2BooleanRBTreeMap.Submap.this.top) && (Char2BooleanRBTreeMap.this.compare(local_k, (this.prev = Char2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2BooleanRBTreeMap.this.locateKey(local_k);
            if (Char2BooleanRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2BooleanRBTreeMap.this.compare(this.prev.key, Char2BooleanRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Char2BooleanRBTreeMap.this.compare(this.next.key, Char2BooleanRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Char2BooleanRBTreeMap.Submap.SubmapKeyIterator(Char2BooleanRBTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2BooleanRBTreeMap.Submap.SubmapKeyIterator(Char2BooleanRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2BooleanSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2BooleanRBTreeMap.KeyIterator(Char2BooleanRBTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2BooleanRBTreeMap.KeyIterator(Char2BooleanRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2BooleanRBTreeMap.this.locateKey(local_k)) != null) {
        if (Char2BooleanRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
