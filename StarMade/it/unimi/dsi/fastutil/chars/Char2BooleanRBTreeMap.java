...
/*      */ 
/*      */ public class Char2BooleanRBTreeMap extends AbstractChar2BooleanSortedMap
...
/*  119 */           return Char2BooleanRBTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*      */         }
/*      */         public int compare(Character ok1, Character ok2) {
/*  122 */           return Char2BooleanRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     boolean oldValue = put(ok.charValue(), ov.booleanValue());
/*  731 */     return this.modified ? null : Boolean.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Boolean remove(Object ok)
/*      */   {
/*  737 */     boolean oldValue = remove(((Character)ok).charValue());
...
/* 1141 */         final Comparator<? super Char2BooleanMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Char2BooleanMap.Entry x, Char2BooleanMap.Entry y) {
/* 1143 */             return Char2BooleanRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Char2BooleanRBTreeMap.EntryIterator(Char2BooleanRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1153 */           return new Char2BooleanRBTreeMap.EntryIterator(Char2BooleanRBTreeMap.this, ((Character)from.getKey()).charValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1166 */           Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1167 */           if (f != null) Char2BooleanRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Char2BooleanRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Char2BooleanRBTreeMap.this.clear(); } 
/* 1172 */         public Char2BooleanMap.Entry first() { return Char2BooleanRBTreeMap.this.firstEntry; } 
/* 1173 */         public Char2BooleanMap.Entry last() { return Char2BooleanRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) { return Char2BooleanRBTreeMap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2BooleanEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) { return Char2BooleanRBTreeMap.this.headMap((Character)to.getKey()).char2BooleanEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) { return Char2BooleanRBTreeMap.this.tailMap((Character)from.getKey()).char2BooleanEntrySet(); }
/*      */       };
...
/* 1242 */           return new Char2BooleanRBTreeMap.ValueIterator(Char2BooleanRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(boolean k) {
/* 1245 */           return Char2BooleanRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Char2BooleanRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
...
/*      */     try
/*      */     {
/* 1611 */       c = (Char2BooleanRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readChar(), s.readBoolean());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readChar(), s.readBoolean());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readChar(), s.readBoolean()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Char2BooleanRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Char2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1323 */       return ((this.bottom) || (Char2BooleanRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Char2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Char2BooleanMap.Entry> char2BooleanEntrySet() {
/* 1327 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator() {
/* 1329 */             return new Char2BooleanRBTreeMap.Submap.SubmapEntryIterator(Char2BooleanRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Char2BooleanMap.Entry> iterator(Char2BooleanMap.Entry from) {
/* 1332 */             return new Char2BooleanRBTreeMap.Submap.SubmapEntryIterator(Char2BooleanRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
/*      */           }
/* 1334 */           public Comparator<? super Char2BooleanMap.Entry> comparator() { return Char2BooleanRBTreeMap.this.char2BooleanEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1340 */             return (f != null) && (Char2BooleanRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Char2BooleanRBTreeMap.Entry f = Char2BooleanRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1347 */             if ((f != null) && (Char2BooleanRBTreeMap.Submap.this.in(f.key))) Char2BooleanRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Char2BooleanRBTreeMap.Submap.SubmapIterator(Char2BooleanRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Char2BooleanRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Char2BooleanMap.Entry first() { return Char2BooleanRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Char2BooleanMap.Entry last() { return Char2BooleanRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Char2BooleanMap.Entry> subSet(Char2BooleanMap.Entry from, Char2BooleanMap.Entry to) { return Char2BooleanRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2BooleanEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Char2BooleanMap.Entry> headSet(Char2BooleanMap.Entry to) { return Char2BooleanRBTreeMap.Submap.this.headMap((Character)to.getKey()).char2BooleanEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Char2BooleanMap.Entry> tailSet(Char2BooleanMap.Entry from) { return Char2BooleanRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2BooleanEntrySet(); }
/*      */         };
...
/*      */           public BooleanIterator iterator() {
/* 1376 */             return new Char2BooleanRBTreeMap.Submap.SubmapValueIterator(Char2BooleanRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(boolean k) {
/* 1379 */             return Char2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Char2BooleanRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Char2BooleanRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(char k) {
/* 1392 */       return (in(k)) && (Char2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(boolean v) {
...
/* 1407 */       return (in(kk)) && ((e = Char2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public boolean put(char k, boolean v) {
/* 1410 */       Char2BooleanRBTreeMap.this.modified = false;
...
/* 1412 */       boolean oldValue = Char2BooleanRBTreeMap.this.put(k, v);
/* 1413 */       return Char2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Boolean put(Character ok, Boolean ov) {
/* 1416 */       boolean oldValue = put(ok.charValue(), ov.booleanValue());
/* 1417 */       return Char2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public boolean remove(char k) {
/* 1421 */       Char2BooleanRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       boolean oldValue = Char2BooleanRBTreeMap.this.remove(k);
/* 1424 */       return Char2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Boolean remove(Object ok) {
/* 1427 */       boolean oldValue = remove(((Character)ok).charValue());
/* 1428 */       return Char2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public CharComparator comparator() {
/* 1443 */       return Char2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Char2BooleanSortedMap headMap(char to) {
/* 1446 */       if (this.top) return new Submap(Char2BooleanRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Char2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Char2BooleanRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Char2BooleanSortedMap tailMap(char from) {
/* 1450 */       if (this.bottom) return new Submap(Char2BooleanRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Char2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2BooleanRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Char2BooleanSortedMap subMap(char from, char to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Char2BooleanRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Char2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Char2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Char2BooleanRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Char2BooleanRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Char2BooleanRBTreeMap.this.tree == null) return null;
/* 1468 */       Char2BooleanRBTreeMap.Entry e;
/*      */       Char2BooleanRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Char2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Char2BooleanRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Char2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Char2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Char2BooleanRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Char2BooleanRBTreeMap.this.tree == null) return null;
/* 1486 */       Char2BooleanRBTreeMap.Entry e;
/*      */       Char2BooleanRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Char2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Char2BooleanRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Char2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Char2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public char firstCharKey() {
/* 1497 */       Char2BooleanRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public char lastCharKey() {
/* 1502 */       Char2BooleanRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Character firstKey() {
/* 1507 */       Char2BooleanRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Character lastKey() {
/* 1512 */       Char2BooleanRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Char2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Char2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Char2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Char2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Char2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Char2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Char2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Char2BooleanRBTreeMap.Submap.this.bottom) && (Char2BooleanRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Char2BooleanRBTreeMap.Submap.this.top) && (Char2BooleanRBTreeMap.this.compare(k, (this.prev = Char2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Char2BooleanRBTreeMap.this.locateKey(k);
/* 1534 */             if (Char2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Char2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2BooleanRBTreeMap.this.compare(this.prev.key, Char2BooleanRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Char2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Char2BooleanRBTreeMap.this.compare(this.next.key, Char2BooleanRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public CharBidirectionalIterator iterator() { return new Char2BooleanRBTreeMap.Submap.SubmapKeyIterator(Char2BooleanRBTreeMap.Submap.this); } 
/* 1367 */       public CharBidirectionalIterator iterator(char from) { return new Char2BooleanRBTreeMap.Submap.SubmapKeyIterator(Char2BooleanRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2BooleanRBTreeMap.TreeIterator
/*      */     implements BooleanListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public CharBidirectionalIterator iterator() { return new Char2BooleanRBTreeMap.KeyIterator(Char2BooleanRBTreeMap.this); } 
/* 1201 */     public CharBidirectionalIterator iterator(char from) { return new Char2BooleanRBTreeMap.KeyIterator(Char2BooleanRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2BooleanRBTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2BooleanRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Char2BooleanMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Char2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Char2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Char2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Char2BooleanRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(char k) {
/* 1067 */       if ((this.next = Char2BooleanRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Char2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Char2BooleanRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Character)e.getKey()).charValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/*  983 */       return this.key ^ (this.value ? 'ӏ' : 'ӕ');
/*      */     }
/*      */ 
