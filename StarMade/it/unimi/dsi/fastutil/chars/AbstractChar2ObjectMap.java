...
/*  85 */     if ((m instanceof Char2ObjectMap))
/*     */     {
/*  87 */       while (n-- != 0) {
/*  88 */         Char2ObjectMap.Entry e = (Char2ObjectMap.Entry)i.next();
...
/* 175 */       public boolean contains(char k) { return AbstractChar2ObjectMap.this.containsKey(k); } 
/* 176 */       public int size() { return AbstractChar2ObjectMap.this.size(); } 
/* 177 */       public void clear() { AbstractChar2ObjectMap.this.clear(); } 
/*     */       public CharIterator iterator() {
/* 179 */         return new AbstractCharIterator() {
/* 180 */           final ObjectIterator<Map.Entry<Character, V>> i = AbstractChar2ObjectMap.this.entrySet().iterator();
/*     */ 
/* 181 */           public char nextChar() { return ((Char2ObjectMap.Entry)this.i.next()).getCharKey(); } 
...
/* 200 */       public boolean contains(Object k) { return AbstractChar2ObjectMap.this.containsValue(k); } 
/* 201 */       public int size() { return AbstractChar2ObjectMap.this.size(); } 
/* 202 */       public void clear() { AbstractChar2ObjectMap.this.clear(); } 
/*     */       public ObjectIterator<V> iterator() {
/* 204 */         return new AbstractObjectIterator() {
/* 205 */           final ObjectIterator<Map.Entry<Character, V>> i = AbstractChar2ObjectMap.this.entrySet().iterator();
/*     */ 
/* 206 */           public V next() { return ((Char2ObjectMap.Entry)this.i.next()).getValue(); } 
...
/* 214 */     return char2ObjectEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 244 */         s.append(", ");
/* 245 */       Char2ObjectMap.Entry e = (Char2ObjectMap.Entry)i.next();
...
/* 153 */       return (this.key == ((Character)e.getKey()).charValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
