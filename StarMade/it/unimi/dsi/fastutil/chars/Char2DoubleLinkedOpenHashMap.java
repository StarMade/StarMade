  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2DoubleLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2DoubleLinkedOpenHashMap(Map<? extends Character, ? extends Double> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2DoubleLinkedOpenHashMap(Map<? extends Character, ? extends Double> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2DoubleLinkedOpenHashMap(Char2DoubleMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2DoubleLinkedOpenHashMap(Char2DoubleMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2DoubleLinkedOpenHashMap(char[] local_k, double[] local_v, float local_f)
  {
  ...
  public Char2DoubleLinkedOpenHashMap(char[] local_k, double[] local_v)
  {
  ...
  public double getAndMoveToFirst(char local_k)
  {
    char[] key = this.key;
  ...
  public double getAndMoveToLast(char local_k)
  {
    char[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public double putAndMoveToFirst(char local_k, double local_v)
  {
    char[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public double putAndMoveToLast(char local_k, double local_v)
  {
    char[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Char2DoubleLinkedOpenHashMap.ValueIterator(Char2DoubleLinkedOpenHashMap.this);
        }
        ...
        {
          return Char2DoubleLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2DoubleLinkedOpenHashMap local_c;
    try
    {
      local_c = (Char2DoubleLinkedOpenHashMap)super.clone();
    }
    ...
    implements DoubleListIterator
  {
    ...
    {
      return Double.valueOf(Char2DoubleLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Double next()
    {
      return Double.valueOf(Char2DoubleLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSortedSet
  {
    ...
    {
      return new Char2DoubleLinkedOpenHashMap.KeyIterator(Char2DoubleLinkedOpenHashMap.this, from);
    }
    
    public CharListIterator iterator()
    {
      return new Char2DoubleLinkedOpenHashMap.KeyIterator(Char2DoubleLinkedOpenHashMap.this);
    }
    ...
    {
      return Char2DoubleLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2DoubleLinkedOpenHashMap.this.size;
      Char2DoubleLinkedOpenHashMap.this.remove(local_k);
    ...
    implements CharListIterator
  {
    ...
    {
      return Character.valueOf(Char2DoubleLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    {
      return Character.valueOf(Char2DoubleLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2DoubleSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Char2DoubleLinkedOpenHashMap.EntryIterator(Char2DoubleLinkedOpenHashMap.this);
    }
    ...
    public Char2DoubleMap.Entry first()
    {
      ...
      return new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this, Char2DoubleLinkedOpenHashMap.this.first);
    }
    ...
    public Char2DoubleMap.Entry last()
    {
      ...
      return new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this, Char2DoubleLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2DoubleLinkedOpenHashMap.this.mask; Char2DoubleLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask) {
        if (Char2DoubleLinkedOpenHashMap.this.key[pos] == local_k) {
          return Char2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)local_e.getValue()).doubleValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2DoubleLinkedOpenHashMap.this.mask; Char2DoubleLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask) {
        if (Char2DoubleLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Char2DoubleLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Char2DoubleLinkedOpenHashMap.EntryIterator(Char2DoubleLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
    }
    
    public ObjectBidirectionalIterator<Char2DoubleMap.Entry> fastIterator()
    {
      return new Char2DoubleLinkedOpenHashMap.FastEntryIterator(Char2DoubleLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Char2DoubleMap.Entry> fastIterator(Char2DoubleMap.Entry from)
    {
      return new Char2DoubleLinkedOpenHashMap.FastEntryIterator(Char2DoubleLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
    }
  }
    ...
    implements ObjectListIterator<Char2DoubleMap.Entry>
  {
    ...
    public AbstractChar2DoubleMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2DoubleLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Char2DoubleLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Char2DoubleMap.Entry>
  {
    ...
    {
      return this.entry = new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this, nextEntry());
    }
    
    public Char2DoubleLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(char from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Char2DoubleLinkedOpenHashMap.this.mask; Char2DoubleLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Char2DoubleLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Char2DoubleLinkedOpenHashMap.this.first = this.next;
      } else {
        Char2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Char2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Char2DoubleLinkedOpenHashMap.this.last = this.prev;
      } else {
        Char2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Char2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2DoubleLinkedOpenHashMap.this.mask; Char2DoubleLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask)
        {
        ...
        if (Char2DoubleLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Char2DoubleMap.Entry, Map.Entry<Character, Double>
  {
    ...
    public double setValue(double local_v)
    {
      ...
      Char2DoubleLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Double> local_e = (Map.Entry)local_o;
      return (Char2DoubleLinkedOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)local_e.getValue()).doubleValue());
    }
