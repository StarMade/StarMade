...
/*  786 */   public Char2DoubleSortedMap tailMap(char from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Char2DoubleSortedMap headMap(char to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Char2DoubleSortedMap subMap(char from, char to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Char2DoubleLinkedOpenHashMap.ValueIterator(Char2DoubleLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Char2DoubleLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(double v) {
/* 1113 */           return Char2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Char2DoubleLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Char2DoubleLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public double previousDouble()
/*      */     {
/* 1094 */       return Char2DoubleLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Double previous() { return Double.valueOf(Char2DoubleLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public double nextDouble() { return Char2DoubleLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Double next() { return Double.valueOf(Char2DoubleLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Char2DoubleLinkedOpenHashMap.KeyIterator(Char2DoubleLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public CharListIterator iterator() {
/* 1054 */       return new Char2DoubleLinkedOpenHashMap.KeyIterator(Char2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Char2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(char k) {
/* 1060 */       return Char2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(char k) {
/* 1063 */       int oldSize = Char2DoubleLinkedOpenHashMap.this.size;
/* 1064 */       Char2DoubleLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Char2DoubleLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Char2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public char firstChar() {
/* 1071 */       if (Char2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Char2DoubleLinkedOpenHashMap.this.key[Char2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public char lastChar() {
/* 1075 */       if (Char2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Char2DoubleLinkedOpenHashMap.this.key[Char2DoubleLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator(char k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public char previousChar() { return Char2DoubleLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Character previous() { return Character.valueOf(Char2DoubleLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public char nextChar() { return Char2DoubleLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Character next() { return Character.valueOf(Char2DoubleLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Char2DoubleLinkedOpenHashMap.EntryIterator(Char2DoubleLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Char2DoubleMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Char2DoubleMap.Entry> subSet(Char2DoubleMap.Entry fromElement, Char2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Char2DoubleMap.Entry> headSet(Char2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Char2DoubleMap.Entry> tailSet(Char2DoubleMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Char2DoubleMap.Entry first() {
/*  973 */       if (Char2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this, Char2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Char2DoubleMap.Entry last() {
/*  977 */       if (Char2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this, Char2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Char2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Char2DoubleLinkedOpenHashMap.this.key[pos] == k) return Char2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/*  990 */         pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Char2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Char2DoubleLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Char2DoubleLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Char2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Char2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2DoubleMap.Entry> iterator(Char2DoubleMap.Entry from) {
/* 1018 */       return new Char2DoubleLinkedOpenHashMap.EntryIterator(Char2DoubleLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2DoubleMap.Entry> fastIterator() {
/* 1021 */       return new Char2DoubleLinkedOpenHashMap.FastEntryIterator(Char2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2DoubleMap.Entry> fastIterator(Char2DoubleMap.Entry from) {
/* 1024 */       return new Char2DoubleLinkedOpenHashMap.FastEntryIterator(Char2DoubleLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Char2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Char2DoubleMap.Entry>
/*      */   {
/*  944 */     final AbstractChar2DoubleMap.BasicEntry entry = new AbstractChar2DoubleMap.BasicEntry('\000', 0.0D);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Char2DoubleLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Char2DoubleLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractChar2DoubleMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Char2DoubleLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Char2DoubleLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Char2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Char2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Char2DoubleMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Char2DoubleLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Char2DoubleLinkedOpenHashMap.MapEntry(Char2DoubleLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Char2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Char2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Char2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Char2DoubleLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(char from) {
/*  809 */       if (Char2DoubleLinkedOpenHashMap.this.key[Char2DoubleLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Char2DoubleLinkedOpenHashMap.this.last;
/*  811 */         this.index = Char2DoubleLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Char2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Char2DoubleLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Char2DoubleLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Char2DoubleLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Char2DoubleLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Char2DoubleLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Char2DoubleLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Char2DoubleLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Char2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Char2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Char2DoubleLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Char2DoubleLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Char2DoubleLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Char2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Char2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Char2DoubleLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Char2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Char2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Char2DoubleLinkedOpenHashMap.this.mask;
/*  897 */         while (Char2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Char2DoubleLinkedOpenHashMap.this.key[pos]) & Char2DoubleLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Char2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Char2DoubleLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Char2DoubleLinkedOpenHashMap.this.key[last] = Char2DoubleLinkedOpenHashMap.this.key[pos];
/*  904 */         Char2DoubleLinkedOpenHashMap.this.value[last] = Char2DoubleLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Char2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Char2DoubleLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*  669 */       return Character.valueOf(Char2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public char getCharKey() {
/*  672 */       return Char2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Double getValue() {
/*  675 */       return Double.valueOf(Char2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public double getDoubleValue() {
/*  678 */       return Char2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public double setValue(double v) {
/*  681 */       double oldValue = Char2DoubleLinkedOpenHashMap.this.value[this.index];
/*  682 */       Char2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Double setValue(Double v) {
...
/*  692 */       return (Char2DoubleLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Char2DoubleLinkedOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Char2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Char2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Char2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
