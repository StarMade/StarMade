...
/*   22:     */
/*  113:     */public class Char2LongLinkedOpenHashMap
/*  114:     */  extends AbstractChar2LongSortedMap
...
/*  127:     */  protected volatile transient Char2LongSortedMap.FastSortedEntrySet entries;
...
/*  141:     */  
/*  149:     */  public Char2LongLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Char2LongLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Char2LongLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Char2LongLinkedOpenHashMap(Map<? extends Character, ? extends Long> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Char2LongLinkedOpenHashMap(Map<? extends Character, ? extends Long> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Char2LongLinkedOpenHashMap(Char2LongMap m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Char2LongLinkedOpenHashMap(Char2LongMap m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Char2LongLinkedOpenHashMap(char[] k, long[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Char2LongLinkedOpenHashMap(char[] k, long[] v)
/*  225:     */  {
/*  226: 226 */    this(k, v, 0.75F);
/*  227:     */  }
/*  228:     */  
/*  232:     */  public long put(char k, long v)
/*  233:     */  {
...
/*  260:     */  }
/*  261:     */  
/*  262: 262 */  public Long put(Character ok, Long ov) { long v = ov.longValue();
...
/*  291:     */  }
/*  292:     */  
/*  303:     */  public long add(char k, long incr)
/*  304:     */  {
...
/*  462:     */  }
/*  463:     */  
/*  467:     */  public long getAndMoveToFirst(char k)
/*  468:     */  {
...
/*  483:     */  }
/*  484:     */  
/*  488:     */  public long getAndMoveToLast(char k)
/*  489:     */  {
...
/*  504:     */  }
/*  505:     */  
/*  510:     */  public long putAndMoveToFirst(char k, long v)
/*  511:     */  {
...
/*  543:     */  }
/*  544:     */  
/*  549:     */  public long putAndMoveToLast(char k, long v)
/*  550:     */  {
...
/*  582:     */  }
/*  583:     */  
/*  584: 584 */  public Long get(Character ok) { char k = ok.charValue();
/*  585:     */    
...
/*  660:     */    implements Char2LongMap.Entry, Map.Entry<Character, Long>
/*  661:     */  {
...
/*  667:     */    }
/*  668:     */    
/*  669: 669 */    public Character getKey() { return Character.valueOf(Char2LongLinkedOpenHashMap.this.key[this.index]); }
/*  670:     */    
/*  671:     */    public char getCharKey() {
/*  672: 672 */      return Char2LongLinkedOpenHashMap.this.key[this.index];
/*  673:     */    }
/*  674:     */    
/*  675: 675 */    public Long getValue() { return Long.valueOf(Char2LongLinkedOpenHashMap.this.value[this.index]); }
/*  676:     */    
/*  678: 678 */    public long getLongValue() { return Char2LongLinkedOpenHashMap.this.value[this.index]; }
/*  679:     */    
/*  680:     */    public long setValue(long v) {
/*  681: 681 */      long oldValue = Char2LongLinkedOpenHashMap.this.value[this.index];
/*  682: 682 */      Char2LongLinkedOpenHashMap.this.value[this.index] = v;
...
/*  691: 691 */      Map.Entry<Character, Long> e = (Map.Entry)o;
/*  692: 692 */      return (Char2LongLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2LongLinkedOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/*  693:     */    }
/*  694:     */    
/*  695: 695 */    public int hashCode() { return Char2LongLinkedOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Char2LongLinkedOpenHashMap.this.value[this.index]); }
/*  696:     */    
/*  697:     */    public String toString() {
/*  698: 698 */      return Char2LongLinkedOpenHashMap.this.key[this.index] + "=>" + Char2LongLinkedOpenHashMap.this.value[this.index];
/*  699:     */    }
/*  700:     */  }
/*  701:     */  
...
/*  786: 786 */  public Char2LongSortedMap tailMap(char from) { throw new UnsupportedOperationException(); }
/*  787: 787 */  public Char2LongSortedMap headMap(char to) { throw new UnsupportedOperationException(); }
/*  788: 788 */  public Char2LongSortedMap subMap(char from, char to) { throw new UnsupportedOperationException(); }
/*  789:     */  
...
/*  803: 803 */    int index = -1;
/*  804:     */    
/*  805: 805 */    private MapIterator() { this.next = Char2LongLinkedOpenHashMap.this.first;
/*  806: 806 */      this.index = 0;
/*  807:     */    }
/*  808:     */    
/*  809: 809 */    private MapIterator(char from) { if (Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.last] == from) {
/*  810: 810 */        this.prev = Char2LongLinkedOpenHashMap.this.last;
/*  811: 811 */        this.index = Char2LongLinkedOpenHashMap.this.size;
/*  812:     */      }
/*  813:     */      else
/*  814:     */      {
/*  815: 815 */        int pos = HashCommon.murmurHash3(from) & Char2LongLinkedOpenHashMap.this.mask;
/*  816:     */        
/*  817: 817 */        while (Char2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  818: 818 */          if (Char2LongLinkedOpenHashMap.this.key[pos] == from)
/*  819:     */          {
/*  820: 820 */            this.next = ((int)Char2LongLinkedOpenHashMap.this.link[pos]);
/*  821: 821 */            this.prev = pos;
/*  822: 822 */            return;
/*  823:     */          }
/*  824: 824 */          pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*  825:     */        }
...
/*  838: 838 */        this.index = Char2LongLinkedOpenHashMap.this.size;
/*  839: 839 */        return;
/*  840:     */      }
/*  841: 841 */      int pos = Char2LongLinkedOpenHashMap.this.first;
/*  842: 842 */      this.index = 1;
/*  843: 843 */      while (pos != this.prev) {
/*  844: 844 */        pos = (int)Char2LongLinkedOpenHashMap.this.link[pos];
...
/*  855:     */    }
/*  856:     */    
/*  857: 857 */    public int nextEntry() { if (!hasNext()) return Char2LongLinkedOpenHashMap.this.size();
/*  858: 858 */      this.curr = this.next;
/*  859: 859 */      this.next = ((int)Char2LongLinkedOpenHashMap.this.link[this.curr]);
...
/*  867: 867 */      this.prev = ((int)(Char2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  880: 880 */        this.prev = ((int)(Char2LongLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  881:     */      }
/*  882:     */      else {
/*  883: 883 */        this.next = ((int)Char2LongLinkedOpenHashMap.this.link[this.curr]); }
/*  884: 884 */      Char2LongLinkedOpenHashMap.this.size -= 1;
/*  885:     */      
/*  887: 887 */      if (this.prev == -1) { Char2LongLinkedOpenHashMap.this.first = this.next;
/*  888:     */      } else
/*  889: 889 */        Char2LongLinkedOpenHashMap.this.link[this.prev] ^= (Char2LongLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890: 890 */      if (this.next == -1) { Char2LongLinkedOpenHashMap.this.last = this.prev;
/*  891:     */      } else
/*  892: 892 */        Char2LongLinkedOpenHashMap.this.link[this.next] ^= (Char2LongLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  893: 893 */      int pos = this.curr;
/*  894:     */      int last;
/*  895:     */      for (;;) {
/*  896: 896 */        pos = (last = pos) + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*  897: 897 */        while (Char2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  898: 898 */          int slot = HashCommon.murmurHash3(Char2LongLinkedOpenHashMap.this.key[pos]) & Char2LongLinkedOpenHashMap.this.mask;
/*  899: 899 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900: 900 */          pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*  901:     */        }
/*  902: 902 */        if (Char2LongLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903: 903 */        Char2LongLinkedOpenHashMap.this.key[last] = Char2LongLinkedOpenHashMap.this.key[pos];
/*  904: 904 */        Char2LongLinkedOpenHashMap.this.value[last] = Char2LongLinkedOpenHashMap.this.value[pos];
/*  905: 905 */        if (this.next == pos) this.next = last;
/*  906: 906 */        if (this.prev == pos) this.prev = last;
/*  907: 907 */        Char2LongLinkedOpenHashMap.this.fixPointers(pos, last);
/*  908:     */      }
/*  909: 909 */      Char2LongLinkedOpenHashMap.this.used[last] = false;
/*  910: 910 */      this.curr = -1;
/*  911:     */    }
/*  912:     */    
...
/*  921:     */    } }
/*  922:     */  
/*  923:     */  private class EntryIterator extends Char2LongLinkedOpenHashMap.MapIterator implements ObjectListIterator<Char2LongMap.Entry> { private Char2LongLinkedOpenHashMap.MapEntry entry;
/*  924:     */    
/*  925: 925 */    public EntryIterator() { super(null); }
/*  926:     */    
/*  927: 927 */    public EntryIterator(char from) { super(from, null); }
/*  928:     */    
/*  929:     */    public Char2LongLinkedOpenHashMap.MapEntry next() {
/*  930: 930 */      return this.entry = new Char2LongLinkedOpenHashMap.MapEntry(Char2LongLinkedOpenHashMap.this, nextEntry());
/*  931:     */    }
/*  932:     */    
/*  933: 933 */    public Char2LongLinkedOpenHashMap.MapEntry previous() { return this.entry = new Char2LongLinkedOpenHashMap.MapEntry(Char2LongLinkedOpenHashMap.this, previousEntry()); }
/*  934:     */    
/*  935:     */    public void remove()
/*  936:     */    {
/*  937: 937 */      super.remove();
/*  938: 938 */      Char2LongLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  939:     */    
/*  940: 940 */    public void set(Char2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  941: 941 */    public void add(Char2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  942:     */  }
/*  943:     */  
/*  944: 944 */  private class FastEntryIterator extends Char2LongLinkedOpenHashMap.MapIterator implements ObjectListIterator<Char2LongMap.Entry> { final AbstractChar2LongMap.BasicEntry entry = new AbstractChar2LongMap.BasicEntry('\000', 0L);
/*  945: 945 */    public FastEntryIterator() { super(null); }
/*  946:     */    
/*  947: 947 */    public FastEntryIterator(char from) { super(from, null); }
/*  948:     */    
/*  949:     */    public AbstractChar2LongMap.BasicEntry next() {
/*  950: 950 */      int e = nextEntry();
/*  951: 951 */      this.entry.key = Char2LongLinkedOpenHashMap.this.key[e];
/*  952: 952 */      this.entry.value = Char2LongLinkedOpenHashMap.this.value[e];
/*  953: 953 */      return this.entry;
/*  954:     */    }
/*  955:     */    
/*  956: 956 */    public AbstractChar2LongMap.BasicEntry previous() { int e = previousEntry();
/*  957: 957 */      this.entry.key = Char2LongLinkedOpenHashMap.this.key[e];
/*  958: 958 */      this.entry.value = Char2LongLinkedOpenHashMap.this.value[e];
/*  959: 959 */      return this.entry; }
/*  960:     */    
/*  961: 961 */    public void set(Char2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  962: 962 */    public void add(Char2LongMap.Entry ok) { throw new UnsupportedOperationException(); } }
/*  963:     */  
/*  964:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Char2LongMap.Entry> implements Char2LongSortedMap.FastSortedEntrySet { private MapEntrySet() {}
/*  965:     */    
/*  966: 966 */    public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator() { return new Char2LongLinkedOpenHashMap.EntryIterator(Char2LongLinkedOpenHashMap.this); }
/*  967:     */    
/*  968: 968 */    public Comparator<? super Char2LongMap.Entry> comparator() { return null; }
/*  969: 969 */    public ObjectSortedSet<Char2LongMap.Entry> subSet(Char2LongMap.Entry fromElement, Char2LongMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  970: 970 */    public ObjectSortedSet<Char2LongMap.Entry> headSet(Char2LongMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  971: 971 */    public ObjectSortedSet<Char2LongMap.Entry> tailSet(Char2LongMap.Entry fromElement) { throw new UnsupportedOperationException(); }
/*  972:     */    
/*  973: 973 */    public Char2LongMap.Entry first() { if (Char2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974: 974 */      return new Char2LongLinkedOpenHashMap.MapEntry(Char2LongLinkedOpenHashMap.this, Char2LongLinkedOpenHashMap.this.first);
/*  975:     */    }
/*  976:     */    
/*  977: 977 */    public Char2LongMap.Entry last() { if (Char2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978: 978 */      return new Char2LongLinkedOpenHashMap.MapEntry(Char2LongLinkedOpenHashMap.this, Char2LongLinkedOpenHashMap.this.last);
/*  979:     */    }
/*  980:     */    
/*  981:     */    public boolean contains(Object o) {
/*  982: 982 */      if (!(o instanceof Map.Entry)) return false;
/*  983: 983 */      Map.Entry<Character, Long> e = (Map.Entry)o;
/*  984: 984 */      char k = ((Character)e.getKey()).charValue();
/*  985:     */      
/*  986: 986 */      int pos = HashCommon.murmurHash3(k) & Char2LongLinkedOpenHashMap.this.mask;
/*  987:     */      
/*  988: 988 */      while (Char2LongLinkedOpenHashMap.this.used[pos] != 0) {
/*  989: 989 */        if (Char2LongLinkedOpenHashMap.this.key[pos] == k) return Char2LongLinkedOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/*  990: 990 */        pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask;
/*  991:     */      }
...
/*  997: 997 */      Map.Entry<Character, Long> e = (Map.Entry)o;
/*  998: 998 */      char k = ((Character)e.getKey()).charValue();
/*  999:     */      
/* 1000:1000 */      int pos = HashCommon.murmurHash3(k) & Char2LongLinkedOpenHashMap.this.mask;
/* 1001:     */      
/* 1002:1002 */      while (Char2LongLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003:1003 */        if (Char2LongLinkedOpenHashMap.this.key[pos] == k) {
/* 1004:1004 */          Char2LongLinkedOpenHashMap.this.remove(e.getKey());
/* 1005:1005 */          return true;
/* 1006:     */        }
/* 1007:1007 */        pos = pos + 1 & Char2LongLinkedOpenHashMap.this.mask;
/* 1008:     */      }
/* 1009:1009 */      return false;
/* 1010:     */    }
/* 1011:     */    
/* 1012:1012 */    public int size() { return Char2LongLinkedOpenHashMap.this.size; }
/* 1013:     */    
/* 1014:     */    public void clear() {
/* 1015:1015 */      Char2LongLinkedOpenHashMap.this.clear();
/* 1016:     */    }
/* 1017:     */    
/* 1018:1018 */    public ObjectBidirectionalIterator<Char2LongMap.Entry> iterator(Char2LongMap.Entry from) { return new Char2LongLinkedOpenHashMap.EntryIterator(Char2LongLinkedOpenHashMap.this, ((Character)from.getKey()).charValue()); }
/* 1019:     */    
/* 1020:     */    public ObjectBidirectionalIterator<Char2LongMap.Entry> fastIterator() {
/* 1021:1021 */      return new Char2LongLinkedOpenHashMap.FastEntryIterator(Char2LongLinkedOpenHashMap.this);
/* 1022:     */    }
/* 1023:     */    
/* 1024:1024 */    public ObjectBidirectionalIterator<Char2LongMap.Entry> fastIterator(Char2LongMap.Entry from) { return new Char2LongLinkedOpenHashMap.FastEntryIterator(Char2LongLinkedOpenHashMap.this, ((Character)from.getKey()).charValue()); }
/* 1025:     */  }
/* 1026:     */  
/* 1027:     */  public Char2LongSortedMap.FastSortedEntrySet char2LongEntrySet() {
...
/* 1035:     */    extends Char2LongLinkedOpenHashMap.MapIterator
/* 1036:     */    implements CharListIterator
/* 1037:     */  {
/* 1038:1038 */    public KeyIterator(char k) { super(k, null); }
/* 1039:1039 */    public char previousChar() { return Char2LongLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1042:1042 */    public Character previous() { return Character.valueOf(Char2LongLinkedOpenHashMap.this.key[previousEntry()]); }
...
/* 1046:1046 */    public char nextChar() { return Char2LongLinkedOpenHashMap.this.key[nextEntry()]; }
/* 1047:1047 */    public Character next() { return Character.valueOf(Char2LongLinkedOpenHashMap.this.key[nextEntry()]); } }
/* 1048:     */  
/* 1049:     */  private final class KeySet extends AbstractCharSortedSet { private KeySet() {}
/* 1050:     */    
/* 1051:1051 */    public CharListIterator iterator(char from) { return new Char2LongLinkedOpenHashMap.KeyIterator(Char2LongLinkedOpenHashMap.this, from); }
/* 1052:     */    
/* 1053:     */    public CharListIterator iterator() {
/* 1054:1054 */      return new Char2LongLinkedOpenHashMap.KeyIterator(Char2LongLinkedOpenHashMap.this);
/* 1055:     */    }
/* 1056:     */    
/* 1057:1057 */    public int size() { return Char2LongLinkedOpenHashMap.this.size; }
/* 1058:     */    
/* 1060:1060 */    public boolean contains(char k) { return Char2LongLinkedOpenHashMap.this.containsKey(k); }
/* 1061:     */    
/* 1062:     */    public boolean remove(char k) {
/* 1063:1063 */      int oldSize = Char2LongLinkedOpenHashMap.this.size;
/* 1064:1064 */      Char2LongLinkedOpenHashMap.this.remove(k);
/* 1065:1065 */      return Char2LongLinkedOpenHashMap.this.size != oldSize;
/* 1066:     */    }
/* 1067:     */    
/* 1068:1068 */    public void clear() { Char2LongLinkedOpenHashMap.this.clear(); }
/* 1069:     */    
/* 1070:     */    public char firstChar() {
/* 1071:1071 */      if (Char2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072:1072 */      return Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.first];
/* 1073:     */    }
/* 1074:     */    
/* 1075:1075 */    public char lastChar() { if (Char2LongLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076:1076 */      return Char2LongLinkedOpenHashMap.this.key[Char2LongLinkedOpenHashMap.this.last]; }
/* 1077:     */    
...
/* 1091:     */    extends Char2LongLinkedOpenHashMap.MapIterator
/* 1092:     */    implements LongListIterator
/* 1093:     */  {
/* 1094:1094 */    public long previousLong() { return Char2LongLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1095:1095 */    public Long previous() { return Long.valueOf(Char2LongLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1101:1101 */    public long nextLong() { return Char2LongLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1102:1102 */    public Long next() { return Long.valueOf(Char2LongLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1103:     */  }
/* 1104:     */  
...
/* 1107:1107 */          return new Char2LongLinkedOpenHashMap.ValueIterator(Char2LongLinkedOpenHashMap.this);
/* 1108:     */        }
/* 1109:     */        
/* 1110:1110 */        public int size() { return Char2LongLinkedOpenHashMap.this.size; }
/* 1111:     */        
/* 1112:     */        public boolean contains(long v) {
/* 1113:1113 */          return Char2LongLinkedOpenHashMap.this.containsValue(v);
/* 1114:     */        }
/* 1115:     */        
/* 1116:1116 */        public void clear() { Char2LongLinkedOpenHashMap.this.clear(); }
/* 1117:     */      };
/* 1118:     */    }
...
/* 1238:     */  }
/* 1239:     */  
/* 1242:     */  public Char2LongLinkedOpenHashMap clone()
/* 1243:     */  {
/* 1244:     */    Char2LongLinkedOpenHashMap c;
/* 1245:     */    
/* 1247:     */    try
/* 1248:     */    {
/* 1249:1249 */      c = (Char2LongLinkedOpenHashMap)super.clone();
/* 1250:     */    }
