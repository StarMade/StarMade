...
/*  18:    */
/*  87:    */public class Char2BooleanOpenHashMap
/*  88:    */  extends AbstractChar2BooleanMap
...
/* 101:    */  protected volatile transient Char2BooleanMap.FastEntrySet entries;
/* 102:    */  protected volatile transient CharSet keys;
/* 103:    */  protected volatile transient BooleanCollection values;
/* 104:    */  
/* 105:    */  public Char2BooleanOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Char2BooleanOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Char2BooleanOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Char2BooleanOpenHashMap(Map<? extends Character, ? extends Boolean> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Char2BooleanOpenHashMap(Map<? extends Character, ? extends Boolean> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Char2BooleanOpenHashMap(Char2BooleanMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Char2BooleanOpenHashMap(Char2BooleanMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Char2BooleanOpenHashMap(char[] k, boolean[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Char2BooleanOpenHashMap(char[] k, boolean[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public boolean put(char k, boolean v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Boolean put(Character ok, Boolean ov) { boolean v = ov.booleanValue();
...
/* 249:    */  }
/* 250:    */  
/* 251:    */  public boolean remove(char k)
/* 252:    */  {
...
/* 282:    */  }
/* 283:    */  
/* 284:284 */  public Boolean get(Character ok) { char k = ok.charValue();
/* 285:    */    
...
/* 359:    */    implements Char2BooleanMap.Entry, Map.Entry<Character, Boolean>
/* 360:    */  {
...
/* 366:    */    }
/* 367:    */    
/* 368:368 */    public Character getKey() { return Character.valueOf(Char2BooleanOpenHashMap.this.key[this.index]); }
/* 369:    */    
/* 370:    */    public char getCharKey() {
/* 371:371 */      return Char2BooleanOpenHashMap.this.key[this.index];
/* 372:    */    }
/* 373:    */    
/* 374:374 */    public Boolean getValue() { return Boolean.valueOf(Char2BooleanOpenHashMap.this.value[this.index]); }
/* 375:    */    
/* 377:377 */    public boolean getBooleanValue() { return Char2BooleanOpenHashMap.this.value[this.index]; }
/* 378:    */    
/* 379:    */    public boolean setValue(boolean v) {
/* 380:380 */      boolean oldValue = Char2BooleanOpenHashMap.this.value[this.index];
/* 381:381 */      Char2BooleanOpenHashMap.this.value[this.index] = v;
...
/* 390:390 */      Map.Entry<Character, Boolean> e = (Map.Entry)o;
/* 391:391 */      return (Char2BooleanOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2BooleanOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public int hashCode() { return Char2BooleanOpenHashMap.this.key[this.index] ^ (Char2BooleanOpenHashMap.this.value[this.index] != 0 ? 'ӏ' : 'ӕ'); }
/* 395:    */    
/* 397:397 */    public String toString() { return Char2BooleanOpenHashMap.this.key[this.index] + "=>" + Char2BooleanOpenHashMap.this.value[this.index]; } }
/* 398:    */  
...
/* 403:    */    
/* 404:404 */    private MapIterator() { this.pos = Char2BooleanOpenHashMap.this.n;
/* 405:    */      
/* 407:407 */      this.last = -1;
/* 408:    */      
/* 409:409 */      this.c = Char2BooleanOpenHashMap.this.size;
/* 410:    */      
/* 414:414 */      boolean[] used = Char2BooleanOpenHashMap.this.used;
...
/* 426:    */        
/* 427:427 */        int pos = HashCommon.murmurHash3(k) & Char2BooleanOpenHashMap.this.mask;
/* 428:    */        
/* 429:429 */        while (Char2BooleanOpenHashMap.this.used[pos] != 0) {
/* 430:430 */          if (Char2BooleanOpenHashMap.this.key[pos] == k) return pos;
/* 431:431 */          pos = pos + 1 & Char2BooleanOpenHashMap.this.mask;
/* 432:    */        }
/* 433:    */      }
/* 434:434 */      this.last = this.pos;
/* 435:    */      
/* 436:436 */      if (this.c != 0) {
/* 437:437 */        boolean[] used = Char2BooleanOpenHashMap.this.used;
...
/* 452:    */      for (;;)
/* 453:    */      {
/* 454:454 */        pos = (last = pos) + 1 & Char2BooleanOpenHashMap.this.mask;
/* 455:455 */        while (Char2BooleanOpenHashMap.this.used[pos] != 0) {
/* 456:456 */          int slot = HashCommon.murmurHash3(Char2BooleanOpenHashMap.this.key[pos]) & Char2BooleanOpenHashMap.this.mask;
/* 457:457 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 458:458 */          pos = pos + 1 & Char2BooleanOpenHashMap.this.mask;
/* 459:    */        }
/* 460:460 */        if (Char2BooleanOpenHashMap.this.used[pos] == 0) break;
/* 461:461 */        if (pos < last)
/* 462:    */        {
/* 463:463 */          if (this.wrapped == null) this.wrapped = new CharArrayList();
/* 464:464 */          this.wrapped.add(Char2BooleanOpenHashMap.this.key[pos]);
/* 465:    */        }
/* 466:466 */        Char2BooleanOpenHashMap.this.key[last] = Char2BooleanOpenHashMap.this.key[pos];
/* 467:467 */        Char2BooleanOpenHashMap.this.value[last] = Char2BooleanOpenHashMap.this.value[pos];
/* 468:    */      }
/* 469:469 */      Char2BooleanOpenHashMap.this.used[last] = false;
/* 470:470 */      return last;
/* 471:    */    }
/* 472:    */    
...
/* 476:    */      {
/* 477:477 */        Char2BooleanOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
/* 478:478 */        this.last = -1;
/* 479:479 */        return;
/* 480:    */      }
/* 481:481 */      Char2BooleanOpenHashMap.this.size -= 1;
...
/* 493:    */    } }
/* 494:    */  
/* 495:495 */  private class EntryIterator extends Char2BooleanOpenHashMap.MapIterator implements ObjectIterator<Char2BooleanMap.Entry> { private EntryIterator() { super(null); }
/* 496:    */    
/* 497:    */    private Char2BooleanOpenHashMap.MapEntry entry;
/* 498:498 */    public Char2BooleanMap.Entry next() { return this.entry = new Char2BooleanOpenHashMap.MapEntry(Char2BooleanOpenHashMap.this, nextEntry()); }
/* 499:    */    
/* 500:    */    public void remove()
/* 501:    */    {
/* 502:502 */      super.remove();
/* 503:503 */      Char2BooleanOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 504:    */    } }
/* 505:    */  
/* 506:506 */  private class FastEntryIterator extends Char2BooleanOpenHashMap.MapIterator implements ObjectIterator<Char2BooleanMap.Entry> { private FastEntryIterator() { super(null); }
/* 507:507 */    final AbstractChar2BooleanMap.BasicEntry entry = new AbstractChar2BooleanMap.BasicEntry('\000', false);
/* 508:    */    
/* 509:509 */    public AbstractChar2BooleanMap.BasicEntry next() { int e = nextEntry();
/* 510:510 */      this.entry.key = Char2BooleanOpenHashMap.this.key[e];
/* 511:511 */      this.entry.value = Char2BooleanOpenHashMap.this.value[e];
/* 512:512 */      return this.entry;
/* 513:    */    } }
/* 514:    */  
/* 515:    */  private final class MapEntrySet extends AbstractObjectSet<Char2BooleanMap.Entry> implements Char2BooleanMap.FastEntrySet { private MapEntrySet() {}
/* 516:    */    
/* 517:517 */    public ObjectIterator<Char2BooleanMap.Entry> iterator() { return new Char2BooleanOpenHashMap.EntryIterator(Char2BooleanOpenHashMap.this, null); }
/* 518:    */    
/* 519:    */    public ObjectIterator<Char2BooleanMap.Entry> fastIterator() {
/* 520:520 */      return new Char2BooleanOpenHashMap.FastEntryIterator(Char2BooleanOpenHashMap.this, null);
/* 521:    */    }
/* 522:    */    
/* 523:    */    public boolean contains(Object o) {
/* 524:524 */      if (!(o instanceof Map.Entry)) return false;
/* 525:525 */      Map.Entry<Character, Boolean> e = (Map.Entry)o;
/* 526:526 */      char k = ((Character)e.getKey()).charValue();
/* 527:    */      
/* 528:528 */      int pos = HashCommon.murmurHash3(k) & Char2BooleanOpenHashMap.this.mask;
/* 529:    */      
/* 530:530 */      while (Char2BooleanOpenHashMap.this.used[pos] != 0) {
/* 531:531 */        if (Char2BooleanOpenHashMap.this.key[pos] == k) return Char2BooleanOpenHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/* 532:532 */        pos = pos + 1 & Char2BooleanOpenHashMap.this.mask;
/* 533:    */      }
...
/* 539:539 */      Map.Entry<Character, Boolean> e = (Map.Entry)o;
/* 540:540 */      char k = ((Character)e.getKey()).charValue();
/* 541:    */      
/* 542:542 */      int pos = HashCommon.murmurHash3(k) & Char2BooleanOpenHashMap.this.mask;
/* 543:    */      
/* 544:544 */      while (Char2BooleanOpenHashMap.this.used[pos] != 0) {
/* 545:545 */        if (Char2BooleanOpenHashMap.this.key[pos] == k) {
/* 546:546 */          Char2BooleanOpenHashMap.this.remove(e.getKey());
/* 547:547 */          return true;
/* 548:    */        }
/* 549:549 */        pos = pos + 1 & Char2BooleanOpenHashMap.this.mask;
/* 550:    */      }
/* 551:551 */      return false;
/* 552:    */    }
/* 553:    */    
/* 554:554 */    public int size() { return Char2BooleanOpenHashMap.this.size; }
/* 555:    */    
/* 557:557 */    public void clear() { Char2BooleanOpenHashMap.this.clear(); }
/* 558:    */  }
/* 559:    */  
/* 560:    */  public Char2BooleanMap.FastEntrySet char2BooleanEntrySet() {
...
/* 568:    */    extends Char2BooleanOpenHashMap.MapIterator
/* 569:    */    implements CharIterator
/* 570:    */  {
/* 571:571 */    public KeyIterator() { super(null); }
/* 572:572 */    public char nextChar() { return Char2BooleanOpenHashMap.this.key[nextEntry()]; }
/* 573:573 */    public Character next() { return Character.valueOf(Char2BooleanOpenHashMap.this.key[nextEntry()]); } }
/* 574:    */  
/* 575:    */  private final class KeySet extends AbstractCharSet { private KeySet() {}
/* 576:    */    
/* 577:577 */    public CharIterator iterator() { return new Char2BooleanOpenHashMap.KeyIterator(Char2BooleanOpenHashMap.this); }
/* 578:    */    
/* 579:    */    public int size() {
/* 580:580 */      return Char2BooleanOpenHashMap.this.size;
/* 581:    */    }
/* 582:    */    
/* 583:583 */    public boolean contains(char k) { return Char2BooleanOpenHashMap.this.containsKey(k); }
/* 584:    */    
/* 585:    */    public boolean remove(char k) {
/* 586:586 */      int oldSize = Char2BooleanOpenHashMap.this.size;
/* 587:587 */      Char2BooleanOpenHashMap.this.remove(k);
/* 588:588 */      return Char2BooleanOpenHashMap.this.size != oldSize;
/* 589:    */    }
/* 590:    */    
/* 591:591 */    public void clear() { Char2BooleanOpenHashMap.this.clear(); }
/* 592:    */  }
/* 593:    */  
...
/* 602:    */    extends Char2BooleanOpenHashMap.MapIterator
/* 603:    */    implements BooleanIterator
/* 604:    */  {
/* 605:605 */    public ValueIterator() { super(null); }
/* 606:606 */    public boolean nextBoolean() { return Char2BooleanOpenHashMap.this.value[nextEntry()]; }
/* 607:607 */    public Boolean next() { return Boolean.valueOf(Char2BooleanOpenHashMap.this.value[nextEntry()]); }
/* 608:    */  }
/* 609:    */  
...
/* 612:612 */          return new Char2BooleanOpenHashMap.ValueIterator(Char2BooleanOpenHashMap.this);
/* 613:    */        }
/* 614:    */        
/* 615:615 */        public int size() { return Char2BooleanOpenHashMap.this.size; }
/* 616:    */        
/* 617:    */        public boolean contains(boolean v) {
/* 618:618 */          return Char2BooleanOpenHashMap.this.containsValue(v);
/* 619:    */        }
/* 620:    */        
/* 621:621 */        public void clear() { Char2BooleanOpenHashMap.this.clear(); }
/* 622:    */      };
/* 623:    */    }
...
/* 724:    */  }
/* 725:    */  
/* 729:    */  public Char2BooleanOpenHashMap clone()
/* 730:    */  {
/* 731:    */    Char2BooleanOpenHashMap c;
/* 732:    */    
/* 734:    */    try
/* 735:    */    {
/* 736:736 */      c = (Char2BooleanOpenHashMap)super.clone();
/* 737:    */    }
