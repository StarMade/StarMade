  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2BooleanOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2BooleanOpenHashMap(Map<? extends Character, ? extends Boolean> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2BooleanOpenHashMap(Map<? extends Character, ? extends Boolean> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2BooleanOpenHashMap(Char2BooleanMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2BooleanOpenHashMap(Char2BooleanMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2BooleanOpenHashMap(char[] local_k, boolean[] local_v, float local_f)
  {
  ...
  public Char2BooleanOpenHashMap(char[] local_k, boolean[] local_v)
  {
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Char2BooleanOpenHashMap.ValueIterator(Char2BooleanOpenHashMap.this);
        }
        ...
        {
          return Char2BooleanOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2BooleanOpenHashMap local_c;
    try
    {
      local_c = (Char2BooleanOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2BooleanOpenHashMap.MapIterator
    ...
    extends AbstractCharSet
  {
    ...
    {
      return new Char2BooleanOpenHashMap.KeyIterator(Char2BooleanOpenHashMap.this);
    }
    ...
    {
      return Char2BooleanOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2BooleanOpenHashMap.this.size;
      Char2BooleanOpenHashMap.this.remove(local_k);
    ...
    implements Char2BooleanMap.FastEntrySet
  {
    ...
    {
      return new Char2BooleanOpenHashMap.EntryIterator(Char2BooleanOpenHashMap.this, null);
    }
    
    public ObjectIterator<Char2BooleanMap.Entry> fastIterator()
    {
      return new Char2BooleanOpenHashMap.FastEntryIterator(Char2BooleanOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2BooleanOpenHashMap.this.mask; Char2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2BooleanOpenHashMap.this.mask) {
        if (Char2BooleanOpenHashMap.this.key[pos] == local_k) {
          return Char2BooleanOpenHashMap.this.value[pos] == ((Boolean)local_e.getValue()).booleanValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2BooleanOpenHashMap.this.mask; Char2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2BooleanOpenHashMap.this.mask) {
        if (Char2BooleanOpenHashMap.this.key[pos] == local_k)
        {
          Char2BooleanOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2BooleanMap.Entry>
  {
    ...
    public AbstractChar2BooleanMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2BooleanOpenHashMap.this.key[local_e];
      this.entry.value = Char2BooleanOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2BooleanMap.Entry>
  {
    ...
    {
      return this.entry = new Char2BooleanOpenHashMap.MapEntry(Char2BooleanOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2BooleanOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2BooleanOpenHashMap.this.field_49;
    int last = -1;
    int field_1678 = Char2BooleanOpenHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2BooleanOpenHashMap.this.used;
      while ((this.field_1678 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1678 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1678 != 0)
      {
        boolean[] local_k = Char2BooleanOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2BooleanOpenHashMap.this.mask; Char2BooleanOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2BooleanOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2BooleanOpenHashMap.this.key[pos]) & Char2BooleanOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2BooleanOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2BooleanOpenHashMap.this.key[pos]);
        }
        Char2BooleanOpenHashMap.this.key[last] = Char2BooleanOpenHashMap.this.key[pos];
        Char2BooleanOpenHashMap.this.value[last] = Char2BooleanOpenHashMap.this.value[pos];
      }
      Char2BooleanOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2BooleanOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2BooleanOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1678 > 0))
      {
        this.field_1678 += 1;
        nextEntry();
      }
    ...
    implements Char2BooleanMap.Entry, Map.Entry<Character, Boolean>
  {
    ...
    public boolean setValue(boolean local_v)
    {
      ...
      Char2BooleanOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Boolean> local_e = (Map.Entry)local_o;
      return (Char2BooleanOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2BooleanOpenHashMap.this.value[this.index] == ((Boolean)local_e.getValue()).booleanValue());
    }
    
    public int hashCode()
    {
      return Char2BooleanOpenHashMap.this.key[this.index] ^ (Char2BooleanOpenHashMap.this.value[this.index] != 0 ? 'ӏ' : 'ӕ');
    }
