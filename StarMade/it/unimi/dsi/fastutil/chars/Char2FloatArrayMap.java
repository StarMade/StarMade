...
/*  17:    */
/*  66:    */public class Char2FloatArrayMap
/*  67:    */  extends AbstractChar2FloatMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Char2FloatArrayMap(char[] key, float[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Char2FloatArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = CharArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = FloatArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Char2FloatArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new char[capacity];
/*  94: 94 */    this.value = new float[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Char2FloatArrayMap(Char2FloatMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Char2FloatArrayMap(Map<? extends Character, ? extends Float> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Char2FloatArrayMap(char[] key, float[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Char2FloatMap.Entry> implements Char2FloatMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Char2FloatMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Char2FloatArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Char2FloatMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractChar2FloatMap.BasicEntry(Char2FloatArrayMap.this.key[this.next], Char2FloatArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Char2FloatMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractChar2FloatMap.BasicEntry entry = new AbstractChar2FloatMap.BasicEntry('\000', 0.0F);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Char2FloatArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Char2FloatMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Char2FloatArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Char2FloatArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Char2FloatArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Character, Float> e = (Map.Entry)o;
/* 165:165 */      char k = ((Character)e.getKey()).charValue();
/* 166:166 */      return (Char2FloatArrayMap.this.containsKey(k)) && (Char2FloatArrayMap.this.get(k) == ((Float)e.getValue()).floatValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Char2FloatMap.FastEntrySet char2FloatEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public float put(char k, float v)
/* 213:    */  {
...
/* 234:    */  }
/* 235:    */  
/* 236:    */  public float remove(char k)
/* 237:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Char2FloatArrayMap clone()
/* 263:    */  {
/* 264:    */    Char2FloatArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Char2FloatArrayMap)super.clone();
/* 270:    */    }
