...
/*  730 */   public Char2ReferenceSortedMap<V> tailMap(char from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Char2ReferenceSortedMap<V> headMap(char to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Char2ReferenceSortedMap<V> subMap(char from, char to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Char2ReferenceLinkedOpenHashMap.ValueIterator(Char2ReferenceLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Char2ReferenceLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Char2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Char2ReferenceLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1190 */       c = (Char2ReferenceLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Char2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Char2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Char2ReferenceLinkedOpenHashMap.KeyIterator(Char2ReferenceLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public CharListIterator iterator() {
/*  999 */       return new Char2ReferenceLinkedOpenHashMap.KeyIterator(Char2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Char2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(char k) {
/* 1005 */       return Char2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(char k) {
/* 1008 */       int oldSize = Char2ReferenceLinkedOpenHashMap.this.size;
/* 1009 */       Char2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Char2ReferenceLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Char2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public char firstChar() {
/* 1016 */       if (Char2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public char lastChar() {
/* 1020 */       if (Char2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2ReferenceLinkedOpenHashMap.MapIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator(char k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public char previousChar() { return Char2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  987 */     public Character previous() { return Character.valueOf(Char2ReferenceLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/*  991 */     public char nextChar() { return Char2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Character next() { return Character.valueOf(Char2ReferenceLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Char2ReferenceLinkedOpenHashMap.EntryIterator(Char2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Char2ReferenceMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> fromElement, Char2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Char2ReferenceMap.Entry<V> first() {
/*  918 */       if (Char2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Char2ReferenceLinkedOpenHashMap.MapEntry(Char2ReferenceLinkedOpenHashMap.this, Char2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Char2ReferenceMap.Entry<V> last() {
/*  922 */       if (Char2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Char2ReferenceLinkedOpenHashMap.MapEntry(Char2ReferenceLinkedOpenHashMap.this, Char2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  931 */       int pos = HashCommon.murmurHash3(k) & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Char2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Char2ReferenceLinkedOpenHashMap.this.key[pos] == k) return Char2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  935 */         pos = pos + 1 & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  945 */       int pos = HashCommon.murmurHash3(k) & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Char2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Char2ReferenceLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Char2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Char2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Char2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> from) {
/*  963 */       return new Char2ReferenceLinkedOpenHashMap.EntryIterator(Char2ReferenceLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> fastIterator() {
/*  966 */       return new Char2ReferenceLinkedOpenHashMap.FastEntryIterator(Char2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> fastIterator(Char2ReferenceMap.Entry<V> from) {
/*  969 */       return new Char2ReferenceLinkedOpenHashMap.FastEntryIterator(Char2ReferenceLinkedOpenHashMap.this, ((Character)from.getKey()).charValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Char2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Char2ReferenceMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractChar2ReferenceMap.BasicEntry<V> entry = new AbstractChar2ReferenceMap.BasicEntry('\000', null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Char2ReferenceLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Char2ReferenceLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractChar2ReferenceMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Char2ReferenceLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Char2ReferenceLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Char2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Char2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Char2ReferenceMap.Entry<V>>
/*      */   {
...
/*  875 */       return this.entry = new Char2ReferenceLinkedOpenHashMap.MapEntry(Char2ReferenceLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Char2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Char2ReferenceLinkedOpenHashMap.MapEntry(Char2ReferenceLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Char2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Char2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Char2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Char2ReferenceLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(char from) {
/*  753 */       if (Char2ReferenceLinkedOpenHashMap.this.key[Char2ReferenceLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Char2ReferenceLinkedOpenHashMap.this.last;
/*  755 */         this.index = Char2ReferenceLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = HashCommon.murmurHash3(from) & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Char2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Char2ReferenceLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Char2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Char2ReferenceLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Char2ReferenceLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Char2ReferenceLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Char2ReferenceLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Char2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Char2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Char2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Char2ReferenceLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Char2ReferenceLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Char2ReferenceLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Char2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Char2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Char2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Char2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Char2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Char2ReferenceLinkedOpenHashMap.this.mask;
/*  841 */         while (Char2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = HashCommon.murmurHash3(Char2ReferenceLinkedOpenHashMap.this.key[pos]) & Char2ReferenceLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Char2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Char2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Char2ReferenceLinkedOpenHashMap.this.key[last] = Char2ReferenceLinkedOpenHashMap.this.key[pos];
/*  848 */         Char2ReferenceLinkedOpenHashMap.this.value[last] = Char2ReferenceLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Char2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Char2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Char2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*  619 */       return Character.valueOf(Char2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public char getCharKey() {
/*  622 */       return Char2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Char2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Char2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  629 */       Char2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Char2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return Char2ReferenceLinkedOpenHashMap.this.key[this.index] ^ (Char2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Char2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */     public String toString() {
/*  642 */       return Char2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Char2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
