...
/* 627 */           return new Char2ObjectOpenCustomHashMap.ValueIterator(Char2ObjectOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 630 */           return Char2ObjectOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 633 */           return Char2ObjectOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 636 */           Char2ObjectOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 751 */       c = (Char2ObjectOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Char2ObjectOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public V next() { return Char2ObjectOpenCustomHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 593 */       return new Char2ObjectOpenCustomHashMap.KeyIterator(Char2ObjectOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 596 */       return Char2ObjectOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(char k) {
/* 599 */       return Char2ObjectOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(char k) {
/* 602 */       int oldSize = Char2ObjectOpenCustomHashMap.this.size;
/* 603 */       Char2ObjectOpenCustomHashMap.this.remove(k);
/* 604 */       return Char2ObjectOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 607 */       Char2ObjectOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Char2ObjectOpenCustomHashMap.MapIterator
/*     */     implements CharIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 587 */       super(null); } 
/* 588 */     public char nextChar() { return Char2ObjectOpenCustomHashMap.this.key[nextEntry()]; } 
/* 589 */     public Character next() { return Character.valueOf(Char2ObjectOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
/*     */   private final class MapEntrySet extends AbstractObjectSet<Char2ObjectMap.Entry<V>>
...
/*     */     {
/* 533 */       return new Char2ObjectOpenCustomHashMap.EntryIterator(Char2ObjectOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Char2ObjectMap.Entry<V>> fastIterator() {
/* 536 */       return new Char2ObjectOpenCustomHashMap.FastEntryIterator(Char2ObjectOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 544 */       int pos = HashCommon.murmurHash3(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ObjectOpenCustomHashMap.this.mask;
/*     */ 
/* 546 */       while (Char2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 547 */         if (Char2ObjectOpenCustomHashMap.this.strategy.equals(Char2ObjectOpenCustomHashMap.this.key[pos], k)) return Char2ObjectOpenCustomHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Char2ObjectOpenCustomHashMap.this.value[pos].equals(e.getValue());
/* 548 */         pos = pos + 1 & Char2ObjectOpenCustomHashMap.this.mask;
/*     */       }
/* 550 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ObjectOpenCustomHashMap.this.mask;
/*     */ 
/* 560 */       while (Char2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 561 */         if (Char2ObjectOpenCustomHashMap.this.strategy.equals(Char2ObjectOpenCustomHashMap.this.key[pos], k)) {
/* 562 */           Char2ObjectOpenCustomHashMap.this.remove(e.getKey());
/* 563 */           return true;
/*     */         }
/* 565 */         pos = pos + 1 & Char2ObjectOpenCustomHashMap.this.mask;
/*     */       }
/* 567 */       return false;
/*     */     }
/*     */     public int size() {
/* 570 */       return Char2ObjectOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 573 */       Char2ObjectOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Char2ObjectOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Char2ObjectMap.Entry<V>>
/*     */   {
/* 523 */     final AbstractChar2ObjectMap.BasicEntry<V> entry = new AbstractChar2ObjectMap.BasicEntry('\000', null);
/*     */ 
...
/* 525 */       int e = nextEntry();
/* 526 */       this.entry.key = Char2ObjectOpenCustomHashMap.this.key[e];
/* 527 */       this.entry.value = Char2ObjectOpenCustomHashMap.this.value[e];
/* 528 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Char2ObjectOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Char2ObjectMap.Entry<V>>
/*     */   {
...
/* 514 */       return this.entry = new Char2ObjectOpenCustomHashMap.MapEntry(Char2ObjectOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 518 */       super.remove();
/* 519 */       Char2ObjectOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 419 */       this.pos = Char2ObjectOpenCustomHashMap.this.n;
/*     */ 
/* 422 */       this.last = -1;
/*     */ 
/* 424 */       this.c = Char2ObjectOpenCustomHashMap.this.size;
/*     */ 
/* 429 */       boolean[] used = Char2ObjectOpenCustomHashMap.this.used;
...
/*     */ 
/* 442 */         int pos = HashCommon.murmurHash3(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(k)) & Char2ObjectOpenCustomHashMap.this.mask;
/*     */ 
/* 444 */         while (Char2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 445 */           if (Char2ObjectOpenCustomHashMap.this.strategy.equals(Char2ObjectOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446 */           pos = pos + 1 & Char2ObjectOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 449 */       this.last = this.pos;
/*     */ 
/* 451 */       if (this.c != 0) {
/* 452 */         boolean[] used = Char2ObjectOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 469 */         pos = (last = pos) + 1 & Char2ObjectOpenCustomHashMap.this.mask;
/* 470 */         while (Char2ObjectOpenCustomHashMap.this.used[pos] != 0) {
/* 471 */           int slot = HashCommon.murmurHash3(Char2ObjectOpenCustomHashMap.this.strategy.hashCode(Char2ObjectOpenCustomHashMap.this.key[pos])) & Char2ObjectOpenCustomHashMap.this.mask;
/* 472 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473 */           pos = pos + 1 & Char2ObjectOpenCustomHashMap.this.mask;
/*     */         }
/* 475 */         if (Char2ObjectOpenCustomHashMap.this.used[pos] == 0) break;
/* 476 */         if (pos < last)
/*     */         {
/* 478 */           if (this.wrapped == null) this.wrapped = new CharArrayList();
/* 479 */           this.wrapped.add(Char2ObjectOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 481 */         Char2ObjectOpenCustomHashMap.this.key[last] = Char2ObjectOpenCustomHashMap.this.key[pos];
/* 482 */         Char2ObjectOpenCustomHashMap.this.value[last] = Char2ObjectOpenCustomHashMap.this.value[pos];
/*     */       }
/* 484 */       Char2ObjectOpenCustomHashMap.this.used[last] = false;
/* 485 */       Char2ObjectOpenCustomHashMap.this.value[last] = null;
/* 486 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 491 */       if (this.pos < -1)
/*     */       {
/* 493 */         Char2ObjectOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
/* 494 */         this.last = -1;
/* 495 */         return;
/*     */       }
/* 497 */       Char2ObjectOpenCustomHashMap.this.size -= 1;
...
/* 389 */       return Character.valueOf(Char2ObjectOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public char getCharKey() {
/* 392 */       return Char2ObjectOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 395 */       return Char2ObjectOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 398 */       Object oldValue = Char2ObjectOpenCustomHashMap.this.value[this.index];
/* 399 */       Char2ObjectOpenCustomHashMap.this.value[this.index] = v;
/* 400 */       return oldValue;
/*     */     }
/*     */ 
...
/* 406 */       return (Char2ObjectOpenCustomHashMap.this.strategy.equals(Char2ObjectOpenCustomHashMap.this.key[this.index], ((Character)e.getKey()).charValue())) && (Char2ObjectOpenCustomHashMap.this.value[this.index] == null ? e.getValue() == null : Char2ObjectOpenCustomHashMap.this.value[this.index].equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
/* 409 */       return Char2ObjectOpenCustomHashMap.this.strategy.hashCode(Char2ObjectOpenCustomHashMap.this.key[this.index]) ^ (Char2ObjectOpenCustomHashMap.this.value[this.index] == null ? 0 : Char2ObjectOpenCustomHashMap.this.value[this.index].hashCode());
/*     */     }
/*     */     public String toString() {
/* 412 */       return Char2ObjectOpenCustomHashMap.this.key[this.index] + "=>" + Char2ObjectOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
