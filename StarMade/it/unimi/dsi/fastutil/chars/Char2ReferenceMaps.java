...
/* 294 */     public ObjectSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.char2ReferenceEntrySet()); return this.entries; } 
...
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.char2ReferenceEntrySet(), this.sync); return this.entries; } 
...
/*     */     }
/* 126 */     public ObjectSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return char2ReferenceEntrySet();
/*     */     }
...
/*     */       {
/* 131 */         return Character.valueOf(Char2ReferenceMaps.Singleton.this.key); } 
/* 132 */       public V getValue() { return Char2ReferenceMaps.Singleton.this.value; }
/*     */ 
/*     */       public char getCharKey() {
/* 135 */         return Char2ReferenceMaps.Singleton.this.key;
/*     */       }
/*     */ 
...
/*     */ 
/* 149 */         return (Char2ReferenceMaps.Singleton.this.key == ((Character)e.getKey()).charValue()) && (Char2ReferenceMaps.Singleton.this.value == e.getValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return Char2ReferenceMaps.Singleton.this.key ^ (Char2ReferenceMaps.Singleton.this.value == null ? 0 : System.identityHashCode(Char2ReferenceMaps.Singleton.this.value)); } 
/* 153 */       public String toString() { return Char2ReferenceMaps.Singleton.this.key + "->" + Char2ReferenceMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  66 */       return false; } 
/*  67 */     public void putAll(Map<? extends Character, ? extends V> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
/*  69 */       return ObjectSets.EMPTY_SET;
/*     */     }
/*  71 */     public CharSet keySet() { return CharSets.EMPTY_SET; } 
/*     */     public ReferenceCollection<V> values() {
/*  73 */       return ReferenceSets.EMPTY_SET; } 
/*  74 */     private Object readResolve() { return Char2ReferenceMaps.EMPTY_MAP; } 
/*  75 */     public Object clone() { return Char2ReferenceMaps.EMPTY_MAP; } 
/*     */     public boolean isEmpty() {
/*  77 */       return true;
/*     */     }
/*     */     public ObjectSet<Map.Entry<Character, V>> entrySet() {
/*  80 */       return char2ReferenceEntrySet();
/*     */     }
