...
/* 607 */           return new Char2ObjectOpenHashMap.ValueIterator(Char2ObjectOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 610 */           return Char2ObjectOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 613 */           return Char2ObjectOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 616 */           Char2ObjectOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 731 */       c = (Char2ObjectOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Char2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public V next() { return Char2ObjectOpenHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 573 */       return new Char2ObjectOpenHashMap.KeyIterator(Char2ObjectOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 576 */       return Char2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(char k) {
/* 579 */       return Char2ObjectOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(char k) {
/* 582 */       int oldSize = Char2ObjectOpenHashMap.this.size;
/* 583 */       Char2ObjectOpenHashMap.this.remove(k);
/* 584 */       return Char2ObjectOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 587 */       Char2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Char2ObjectOpenHashMap.MapIterator
/*     */     implements CharIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 567 */       super(null); } 
/* 568 */     public char nextChar() { return Char2ObjectOpenHashMap.this.key[nextEntry()]; } 
/* 569 */     public Character next() { return Character.valueOf(Char2ObjectOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 513 */       return new Char2ObjectOpenHashMap.EntryIterator(Char2ObjectOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Char2ObjectMap.Entry<V>> fastIterator() {
/* 516 */       return new Char2ObjectOpenHashMap.FastEntryIterator(Char2ObjectOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 524 */       int pos = HashCommon.murmurHash3(k) & Char2ObjectOpenHashMap.this.mask;
/*     */ 
/* 526 */       while (Char2ObjectOpenHashMap.this.used[pos] != 0) {
/* 527 */         if (Char2ObjectOpenHashMap.this.key[pos] == k) return Char2ObjectOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Char2ObjectOpenHashMap.this.value[pos].equals(e.getValue());
/* 528 */         pos = pos + 1 & Char2ObjectOpenHashMap.this.mask;
/*     */       }
/* 530 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 538 */       int pos = HashCommon.murmurHash3(k) & Char2ObjectOpenHashMap.this.mask;
/*     */ 
/* 540 */       while (Char2ObjectOpenHashMap.this.used[pos] != 0) {
/* 541 */         if (Char2ObjectOpenHashMap.this.key[pos] == k) {
/* 542 */           Char2ObjectOpenHashMap.this.remove(e.getKey());
/* 543 */           return true;
/*     */         }
/* 545 */         pos = pos + 1 & Char2ObjectOpenHashMap.this.mask;
/*     */       }
/* 547 */       return false;
/*     */     }
/*     */     public int size() {
/* 550 */       return Char2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 553 */       Char2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Char2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Char2ObjectMap.Entry<V>>
/*     */   {
/* 503 */     final AbstractChar2ObjectMap.BasicEntry<V> entry = new AbstractChar2ObjectMap.BasicEntry('\000', null);
/*     */ 
...
/* 505 */       int e = nextEntry();
/* 506 */       this.entry.key = Char2ObjectOpenHashMap.this.key[e];
/* 507 */       this.entry.value = Char2ObjectOpenHashMap.this.value[e];
/* 508 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Char2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Char2ObjectMap.Entry<V>>
/*     */   {
...
/* 494 */       return this.entry = new Char2ObjectOpenHashMap.MapEntry(Char2ObjectOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 498 */       super.remove();
/* 499 */       Char2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 399 */       this.pos = Char2ObjectOpenHashMap.this.n;
/*     */ 
/* 402 */       this.last = -1;
/*     */ 
/* 404 */       this.c = Char2ObjectOpenHashMap.this.size;
/*     */ 
/* 409 */       boolean[] used = Char2ObjectOpenHashMap.this.used;
...
/*     */ 
/* 422 */         int pos = HashCommon.murmurHash3(k) & Char2ObjectOpenHashMap.this.mask;
/*     */ 
/* 424 */         while (Char2ObjectOpenHashMap.this.used[pos] != 0) {
/* 425 */           if (Char2ObjectOpenHashMap.this.key[pos] == k) return pos;
/* 426 */           pos = pos + 1 & Char2ObjectOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 429 */       this.last = this.pos;
/*     */ 
/* 431 */       if (this.c != 0) {
/* 432 */         boolean[] used = Char2ObjectOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 449 */         pos = (last = pos) + 1 & Char2ObjectOpenHashMap.this.mask;
/* 450 */         while (Char2ObjectOpenHashMap.this.used[pos] != 0) {
/* 451 */           int slot = HashCommon.murmurHash3(Char2ObjectOpenHashMap.this.key[pos]) & Char2ObjectOpenHashMap.this.mask;
/* 452 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453 */           pos = pos + 1 & Char2ObjectOpenHashMap.this.mask;
/*     */         }
/* 455 */         if (Char2ObjectOpenHashMap.this.used[pos] == 0) break;
/* 456 */         if (pos < last)
/*     */         {
/* 458 */           if (this.wrapped == null) this.wrapped = new CharArrayList();
/* 459 */           this.wrapped.add(Char2ObjectOpenHashMap.this.key[pos]);
/*     */         }
/* 461 */         Char2ObjectOpenHashMap.this.key[last] = Char2ObjectOpenHashMap.this.key[pos];
/* 462 */         Char2ObjectOpenHashMap.this.value[last] = Char2ObjectOpenHashMap.this.value[pos];
/*     */       }
/* 464 */       Char2ObjectOpenHashMap.this.used[last] = false;
/* 465 */       Char2ObjectOpenHashMap.this.value[last] = null;
/* 466 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 471 */       if (this.pos < -1)
/*     */       {
/* 473 */         Char2ObjectOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
/* 474 */         this.last = -1;
/* 475 */         return;
/*     */       }
/* 477 */       Char2ObjectOpenHashMap.this.size -= 1;
...
/* 369 */       return Character.valueOf(Char2ObjectOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public char getCharKey() {
/* 372 */       return Char2ObjectOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 375 */       return Char2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 378 */       Object oldValue = Char2ObjectOpenHashMap.this.value[this.index];
/* 379 */       Char2ObjectOpenHashMap.this.value[this.index] = v;
/* 380 */       return oldValue;
/*     */     }
/*     */ 
...
/* 386 */       return (Char2ObjectOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Char2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
/* 389 */       return Char2ObjectOpenHashMap.this.key[this.index] ^ (Char2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Char2ObjectOpenHashMap.this.value[this.index].hashCode());
/*     */     }
/*     */     public String toString() {
/* 392 */       return Char2ObjectOpenHashMap.this.key[this.index] + "=>" + Char2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
