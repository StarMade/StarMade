  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2ObjectOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2ObjectOpenHashMap(Map<? extends Character, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ObjectOpenHashMap(Map<? extends Character, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ObjectOpenHashMap(Char2ObjectMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ObjectOpenHashMap(Char2ObjectMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ObjectOpenHashMap(char[] local_k, V[] local_v, float local_f)
  {
  ...
  public Char2ObjectOpenHashMap(char[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Char2ObjectOpenHashMap.ValueIterator(Char2ObjectOpenHashMap.this);
        }
        ...
        {
          return Char2ObjectOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2ObjectOpenHashMap<V> local_c;
    try
    {
      local_c = (Char2ObjectOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    char[] key = this.key;
    V[] value = this.value;
    Char2ObjectOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
  ...
  private final class ValueIterator
    extends Char2ObjectOpenHashMap<V>.MapIterator
    ...
    extends AbstractCharSet
  {
    ...
    {
      return new Char2ObjectOpenHashMap.KeyIterator(Char2ObjectOpenHashMap.this);
    }
    ...
    {
      return Char2ObjectOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2ObjectOpenHashMap.this.size;
      Char2ObjectOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Char2ObjectOpenHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Char2ObjectOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2ObjectMap.FastEntrySet<V>
  {
    ...
    {
      return new Char2ObjectOpenHashMap.EntryIterator(Char2ObjectOpenHashMap.this, null);
    }
    
    public ObjectIterator<Char2ObjectMap.Entry<V>> fastIterator()
    {
      return new Char2ObjectOpenHashMap.FastEntryIterator(Char2ObjectOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ObjectOpenHashMap.this.mask; Char2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ObjectOpenHashMap.this.mask) {
        if (Char2ObjectOpenHashMap.this.key[pos] == local_k) {
          return Char2ObjectOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Char2ObjectOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ObjectOpenHashMap.this.mask; Char2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ObjectOpenHashMap.this.mask) {
        if (Char2ObjectOpenHashMap.this.key[pos] == local_k)
        {
          Char2ObjectOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2ObjectMap.Entry<V>>
  {
    ...
    public AbstractChar2ObjectMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Char2ObjectOpenHashMap.this.key[local_e];
      this.entry.value = Char2ObjectOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2ObjectMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Char2ObjectOpenHashMap.MapEntry(Char2ObjectOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2ObjectOpenHashMap.this.field_49;
    int last = -1;
    int field_1745 = Char2ObjectOpenHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2ObjectOpenHashMap.this.used;
      while ((this.field_1745 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1745 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1745 != 0)
      {
        boolean[] local_k = Char2ObjectOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2ObjectOpenHashMap.this.mask; Char2ObjectOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ObjectOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2ObjectOpenHashMap.this.key[pos]) & Char2ObjectOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2ObjectOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2ObjectOpenHashMap.this.key[pos]);
        }
        Char2ObjectOpenHashMap.this.key[last] = Char2ObjectOpenHashMap.this.key[pos];
        Char2ObjectOpenHashMap.this.value[last] = Char2ObjectOpenHashMap.this.value[pos];
      }
      Char2ObjectOpenHashMap.this.used[last] = false;
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2ObjectOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2ObjectOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1745 > 0))
      {
        this.field_1745 += 1;
        nextEntry();
      }
    ...
    implements Char2ObjectMap.Entry<V>, Map.Entry<Character, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Char2ObjectOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, V> local_e = (Map.Entry)local_o;
      return (Char2ObjectOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2ObjectOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Char2ObjectOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
