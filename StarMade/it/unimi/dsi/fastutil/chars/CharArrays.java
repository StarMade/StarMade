...
public class CharArrays
{
  ...
  public static char[] grow(char[] array, int length)
  {
    if (length > array.length)
    {
      ...
      char[] local_t = new char[newLength];
      System.arraycopy(array, 0, local_t, 0, array.length);
      return local_t;
    }
    return array;
  ...
  public static char[] trim(char[] array, int length)
  {
    ...
    char[] local_t = length == 0 ? EMPTY_ARRAY : new char[length];
  ...
  public static char[] copy(char[] array, int offset, int length)
  {
    ...
    char[] local_a = length == 0 ? EMPTY_ARRAY : new char[length];
  ...
  public static void fill(char[] array, int from, int local_to, char value)
  {
  ...
  public static void ensureFromTo(char[] local_a, int from, int local_to)
  {
    it.unimi.dsi.fastutil.Arrays.ensureFromTo(local_a.length, from, local_to);
  }
  
  public static void ensureOffsetLength(char[] local_a, int offset, int length)
  {
    it.unimi.dsi.fastutil.Arrays.ensureOffsetLength(local_a.length, offset, length);
  }
  
  private static void swap(char[] local_x, int local_a, int local_b)
  {
    char local_t = local_x[local_a];
    local_x[local_a] = local_x[local_b];
    local_x[local_b] = local_t;
  }
  
  private static void vecSwap(char[] local_x, int local_a, int local_b, int local_n)
  {
    int local_i = 0;
  ...
  private static int med3(char[] local_x, int local_a, int local_b, int local_c, CharComparator comp)
  {
  ...
  private static void selectionSort(char[] local_a, int from, int local_to, CharComparator comp)
  {
  ...
  private static void insertionSort(char[] local_a, int from, int local_to, CharComparator comp)
  {
    int local_i = from;
    for (;;)
    {
      ...
      char local_t = local_a[local_i];
      int local_j = local_i;
      for (char local_u = local_a[(local_j - 1)]; comp.compare(local_t, local_u) < 0; local_u = local_a[(--local_j - 1)])
      {
  ...
  private static void selectionSort(char[] local_a, int from, int local_to)
  {
    for (int local_i = from; local_i < local_to - 1; local_i++)
    {
      int local_m = local_i;
  ...
  private static void insertionSort(char[] local_a, int from, int local_to)
  {
    int local_i = from;
    for (;;)
    {
      ...
      char local_t = local_a[local_i];
      int local_j = local_i;
      for (char local_u = local_a[(local_j - 1)]; local_t < local_u; local_u = local_a[(--local_j - 1)])
      {
        local_a[local_j] = local_u;
        if (from == local_j - 1)
        {
  ...
  public static void quickSort(char[] local_x, int from, int local_to, CharComparator comp)
  {
  ...
  private static int med3(char[] local_x, int local_a, int local_b, int local_c)
  {
  ...
  public static void quickSort(char[] local_x, int from, int local_to)
  {
    int len = local_to - from;
    if (len < 7)
    {
  ...
  public static void mergeSort(char[] local_a, int from, int local_to, char[] supp)
  {
    int len = local_to - from;
    if (len < 7)
    {
  ...
  public static void mergeSort(char[] local_a, int from, int local_to)
  {
    mergeSort(local_a, from, local_to, (char[])local_a.clone());
  }
  
  public static void mergeSort(char[] local_a)
  {
    mergeSort(local_a, 0, local_a.length);
  }
  
  public static void mergeSort(char[] local_a, int from, int local_to, CharComparator comp, char[] supp)
  {
    int len = local_to - from;
    if (len < 7)
    {
  ...
  public static void mergeSort(char[] local_a, int from, int local_to, CharComparator comp)
  {
    mergeSort(local_a, from, local_to, comp, (char[])local_a.clone());
  }
  
  public static void mergeSort(char[] local_a, CharComparator comp)
  {
    mergeSort(local_a, 0, local_a.length, comp);
  }
  
  public static int binarySearch(char[] local_a, int from, int local_to, char key)
  {
    
    while (from <= local_to)
    {
      int mid = from + local_to >>> 1;
      char midVal = local_a[mid];
      if (midVal < key) {
        from = mid + 1;
      } else if (midVal > key) {
        local_to = mid - 1;
  ...
  public static int binarySearch(char[] local_a, char key)
  {
    return binarySearch(local_a, 0, local_a.length, key);
  }
  
  public static int binarySearch(char[] local_a, int from, int local_to, char key, CharComparator local_c)
  {
  ...
  public static int binarySearch(char[] local_a, char key, CharComparator local_c)
  {
  ...
  public static void radixSort(char[] local_a, int from, int local_to)
  {
    int maxLevel = 1;
    int stackSize = 256;
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        int local_i = length;
        while (local_i-- != 0) {
          digit[local_i] = ((byte)(local_a[(first + local_i)] >>> shift & 0xFF ^ 0x0));
        }
        int local_i = length;
        while (local_i-- != 0) {
        ...
        while (local_i1 < 256)
        {
          ...
          int tmp319_318 = (local_p + count[local_i1]);
          local_p = tmp319_318;
          pos[local_i1] = tmp319_318;
          local_i1++;
        }
        ...
        {
          char local_t = local_a[(local_p + first)];
  ...
  private static void insertionSortIndirect(int[] perm, char[] local_a, int from, int local_to)
  {
    int local_i = from;
    for (;;)
    {
  ...
  public static void radixSortIndirect(int[] perm, char[] local_a, boolean stable)
  {
    radixSortIndirect(perm, local_a, 0, perm.length, stable);
  }
  
  public static void radixSortIndirect(int[] perm, char[] local_a, int from, int local_to, boolean stable)
  {
    int maxLevel = 1;
    int stackSize = 256;
    int[] offsetStack = new int[256];
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        int local_i = length;
        while (local_i-- != 0) {
          digit[local_i] = ((byte)(local_a[perm[(first + local_i)]] >>> shift & 0xFF ^ 0x0));
        }
        int local_i = length;
        while (local_i-- != 0) {
          count[(digit[local_i] & 0xFF)] += 1;
        ...
        while (local_i1 < 256)
        {
          ...
          if (stable)
          {
            int tmp352_351 = (local_p + count[local_i1]);
            local_p = tmp352_351;
            count[local_i1] = tmp352_351;
          }
          else
          {
        ...
        if (stable)
        {
          ...
          while (local_i1-- != 0)
          {
            byte tmp411_410 = (digit[local_i1] & 0xFF);
            int[] tmp411_400 = count;
            int tmp415_414 = (tmp411_400[tmp411_410] - 1);
            tmp411_400[tmp411_410] = tmp415_414;
            support[tmp415_414] = perm[(first + local_i1)];
          }
  ...
  private static void selectionSort(char[] local_a, char[] local_b, int from, int local_to)
  {
    for (int local_i = from; local_i < local_to - 1; local_i++)
    {
      int local_m = local_i;
  ...
  public static void radixSort(char[] local_a, char[] local_b, int from, int local_to)
  {
    int layers = 2;
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        int local_i = length;
        while (local_i-- != 0) {
          digit[local_i] = ((byte)(local_k[(first + local_i)] >>> shift & 0xFF ^ 0x0));
        }
        int local_i = length;
        while (local_i-- != 0) {
          count[(digit[local_i] & 0xFF)] += 1;
        ...
        while (local_i1 < 256)
        {
          ...
          int tmp355_354 = (local_p + count[local_i1]);
          local_p = tmp355_354;
          pos[local_i1] = tmp355_354;
          local_i1++;
        }
        int local_i1 = length - count[local_i];
        count[local_i] = 0;
        ...
        {
          char local_t = local_a[(local_p + first)];
          char local_u = local_b[(local_p + first)];
          local_c = digit[local_p] & 0xFF;
          for (;;)
          {
            int local_d;
  ...
  private static void insertionSortIndirect(int[] perm, char[] local_a, char[] local_b, int from, int local_to)
  {
    int local_i = from;
    for (;;)
    {
  ...
  public static void radixSortIndirect(int[] perm, char[] local_a, char[] local_b, boolean stable)
  {
    radixSortIndirect(perm, local_a, local_b, 0, perm.length, stable);
  }
  
  public static void radixSortIndirect(int[] perm, char[] local_a, char[] local_b, int from, int local_to, boolean stable)
  {
    int layers = 2;
    if (local_a.length != local_b.length) {
      throw new IllegalArgumentException("Array size mismatch.");
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        int local_i = length;
        while (local_i-- != 0) {
          digit[local_i] = ((byte)(local_k[perm[(first + local_i)]] >>> shift & 0xFF ^ 0x0));
        }
        int local_i = length;
        while (local_i-- != 0) {
          count[(digit[local_i] & 0xFF)] += 1;
        ...
        while (local_i1 < 256)
        {
          ...
          if (stable)
          {
            int tmp389_388 = (local_p + count[local_i1]);
            local_p = tmp389_388;
            count[local_i1] = tmp389_388;
          }
          else
          {
            int tmp408_407 = (local_p + count[local_i1]);
            local_p = tmp408_407;
            pos[local_i1] = tmp408_407;
          }
          local_i1++;
        }
        if (stable)
        {
          ...
          while (local_i1-- != 0)
          {
            byte tmp448_447 = (digit[local_i1] & 0xFF);
            int[] tmp448_437 = count;
            int tmp452_451 = (tmp448_437[tmp448_447] - 1);
            tmp448_437[tmp448_447] = tmp452_451;
            support[tmp452_451] = perm[(first + local_i1)];
          }
          System.arraycopy(support, 0, perm, first, length);
          IntArrays.fill(count, 0);
        }
  ...
  private static void selectionSort(char[][] local_a, int from, int local_to, int level)
  {
    ...
    for (int local_i = from; local_i < local_to - 1; local_i++)
    {
      ...
      if (local_m != local_i)
      {
        ...
        while (local_j-- != 0)
        {
          char local_p = local_a[local_j][local_i];
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        while (local_i1 < 256)
        {
          ...
          int tmp411_410 = (local_p1 + count[local_i1]);
          local_p1 = tmp411_410;
          pos[local_i1] = tmp411_410;
          local_i1++;
        }
        int local_i1 = length - count[local_i];
        count[local_i] = 0;
  ...
  public static char[] shuffle(char[] local_a, int from, int local_to, Random random)
  {
    int local_i = local_to - from;
    while (local_i-- != 0)
    {
      int local_p = random.nextInt(local_i + 1);
      char local_t = local_a[(from + local_i)];
  ...
  public static char[] reverse(char[] local_a)
  {
    int length = local_a.length;
    int local_i = length / 2;
    while (local_i-- != 0)
    {
      char local_t = local_a[(length - local_i - 1)];
    ...
    implements Hash.Strategy<char[]>, Serializable
  {
    ...
    {
      return CharArrays.equals(local_a, local_b);
    }
  }
}
