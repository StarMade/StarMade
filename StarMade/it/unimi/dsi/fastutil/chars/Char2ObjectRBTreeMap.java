  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2ObjectRBTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2ObjectRBTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2ObjectRBTreeMap(Map<? extends Character, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ObjectRBTreeMap(SortedMap<Character, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ObjectRBTreeMap(Char2ObjectMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ObjectRBTreeMap(Char2ObjectSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ObjectRBTreeMap(char[] local_k, V[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2ObjectRBTreeMap(char[] local_k, V[] local_v)
  {
  ...
  {
    Char2ObjectRBTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Char2ObjectMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Char2ObjectRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2ObjectRBTreeMap.EntryIterator(Char2ObjectRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from)
        {
          return new Char2ObjectRBTreeMap.EntryIterator(Char2ObjectRBTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2ObjectRBTreeMap.Entry<V> local_f = Char2ObjectRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2ObjectRBTreeMap.Entry<V> local_f = Char2ObjectRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2ObjectRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Char2ObjectRBTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> local_to)
        {
          return Char2ObjectRBTreeMap.this.headMap((Character)local_to.getKey()).char2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from)
        {
          return Char2ObjectRBTreeMap.this.tailMap((Character)from.getKey()).char2ObjectEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Char2ObjectRBTreeMap.ValueIterator(Char2ObjectRBTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Char2ObjectRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2ObjectRBTreeMap<V> local_c;
    try
    {
      local_c = (Char2ObjectRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Char2ObjectRBTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2ObjectRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Char2ObjectRBTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Char2ObjectRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2ObjectRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2ObjectMap.Entry<V>> char2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator()
          {
            return new Char2ObjectRBTreeMap.Submap.SubmapEntryIterator(Char2ObjectRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2ObjectMap.Entry<V>> iterator(Char2ObjectMap.Entry<V> from)
          {
            return new Char2ObjectRBTreeMap.Submap.SubmapEntryIterator(Char2ObjectRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, V> local_e = (Map.Entry)local_o;
            Char2ObjectRBTreeMap.Entry<V> local_f = Char2ObjectRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2ObjectRBTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, V> local_e = (Map.Entry)local_o;
            Char2ObjectRBTreeMap.Entry<V> local_f = Char2ObjectRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2ObjectRBTreeMap.Submap.this.in2(local_f.key))) {
              Char2ObjectRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2ObjectRBTreeMap.Submap.SubmapIterator(Char2ObjectRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2ObjectRBTreeMap.Submap.this.clear();
          }
          
          public Char2ObjectMap.Entry<V> first()
          {
            return Char2ObjectRBTreeMap.Submap.this.firstEntry();
          }
          
          public Char2ObjectMap.Entry<V> last()
          {
            return Char2ObjectRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2ObjectMap.Entry<V>> subSet(Char2ObjectMap.Entry<V> from, Char2ObjectMap.Entry<V> local_to)
          {
            return Char2ObjectRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Char2ObjectMap.Entry<V>> headSet(Char2ObjectMap.Entry<V> local_to)
          {
            return Char2ObjectRBTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Char2ObjectMap.Entry<V>> tailSet(Char2ObjectMap.Entry<V> from)
          {
            return Char2ObjectRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Char2ObjectRBTreeMap.Submap.SubmapValueIterator(Char2ObjectRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Char2ObjectRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2ObjectRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2ObjectRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2ObjectRBTreeMap.Entry<V> local_e;
      return (in2(local_kk)) && ((local_e = Char2ObjectRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(char local_k, V local_v)
    {
      ...
      V oldValue = Char2ObjectRBTreeMap.this.put(local_k, local_v);
    ...
    public V remove(char local_k)
    {
      ...
      V oldValue = Char2ObjectRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2ObjectRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2ObjectRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2ObjectRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2ObjectSortedMap<V> tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2ObjectRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2ObjectRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2ObjectRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2ObjectSortedMap<V> subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2ObjectRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2ObjectRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2ObjectRBTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2ObjectRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2ObjectRBTreeMap.this.locateKey(this.from);
        if (Char2ObjectRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2ObjectRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2ObjectRBTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2ObjectRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2ObjectRBTreeMap.this.locateKey(this.field_47);
        if (Char2ObjectRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2ObjectRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2ObjectRBTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2ObjectRBTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Char2ObjectRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Char2ObjectRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Char2ObjectRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2ObjectRBTreeMap.Submap.this.bottom) && (Char2ObjectRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2ObjectRBTreeMap.Submap.this.top) && (Char2ObjectRBTreeMap.this.compare(local_k, (this.prev = Char2ObjectRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2ObjectRBTreeMap.this.locateKey(local_k);
            if (Char2ObjectRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2ObjectRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2ObjectRBTreeMap.this.compare(this.prev.key, Char2ObjectRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2ObjectRBTreeMap.Submap.this.top) && (this.next != null) && (Char2ObjectRBTreeMap.this.compare(this.next.key, Char2ObjectRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Char2ObjectRBTreeMap.Submap.SubmapKeyIterator(Char2ObjectRBTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2ObjectRBTreeMap.Submap.SubmapKeyIterator(Char2ObjectRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2ObjectSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2ObjectRBTreeMap.KeyIterator(Char2ObjectRBTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2ObjectRBTreeMap.KeyIterator(Char2ObjectRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2ObjectRBTreeMap.this.locateKey(local_k)) != null) {
        if (Char2ObjectRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
