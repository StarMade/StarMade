  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2CharOpenCustomHashMap(int expected, float local_f, CharHash.Strategy strategy)
  {
  ...
  public Char2CharOpenCustomHashMap(Map<? extends Character, ? extends Character> local_m, float local_f, CharHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Char2CharOpenCustomHashMap(Map<? extends Character, ? extends Character> local_m, CharHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Char2CharOpenCustomHashMap(Char2CharMap local_m, float local_f, CharHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Char2CharOpenCustomHashMap(Char2CharMap local_m, CharHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Char2CharOpenCustomHashMap(char[] local_k, char[] local_v, float local_f, CharHash.Strategy strategy)
  {
  ...
  public Char2CharOpenCustomHashMap(char[] local_k, char[] local_v, CharHash.Strategy strategy)
  {
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Char2CharOpenCustomHashMap.ValueIterator(Char2CharOpenCustomHashMap.this);
        }
        ...
        {
          return Char2CharOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2CharOpenCustomHashMap local_c;
    try
    {
      local_c = (Char2CharOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2CharOpenCustomHashMap.MapIterator
    implements CharIterator
  {
    ...
    {
      return Char2CharOpenCustomHashMap.this.value[nextEntry()];
    }
    
    public Character next()
    {
      return Character.valueOf(Char2CharOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSet
  {
    ...
    public CharIterator iterator()
    {
      return new Char2CharOpenCustomHashMap.KeyIterator(Char2CharOpenCustomHashMap.this);
    }
    ...
    {
      return Char2CharOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2CharOpenCustomHashMap.this.size;
      Char2CharOpenCustomHashMap.this.remove(local_k);
    ...
    implements CharIterator
  {
    ...
    public char nextChar()
    {
      return Char2CharOpenCustomHashMap.this.key[nextEntry()];
    }
    
    public Character next()
    {
      return Character.valueOf(Char2CharOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2CharMap.FastEntrySet
  {
    ...
    {
      return new Char2CharOpenCustomHashMap.EntryIterator(Char2CharOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Char2CharMap.Entry> fastIterator()
    {
      return new Char2CharOpenCustomHashMap.FastEntryIterator(Char2CharOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Char2CharOpenCustomHashMap.this.strategy.hashCode(local_k)) & Char2CharOpenCustomHashMap.this.mask; Char2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2CharOpenCustomHashMap.this.mask) {
        if (Char2CharOpenCustomHashMap.this.strategy.equals(Char2CharOpenCustomHashMap.this.key[pos], local_k)) {
          return Char2CharOpenCustomHashMap.this.value[pos] == ((Character)local_e.getValue()).charValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Char2CharOpenCustomHashMap.this.strategy.hashCode(local_k)) & Char2CharOpenCustomHashMap.this.mask; Char2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2CharOpenCustomHashMap.this.mask) {
        if (Char2CharOpenCustomHashMap.this.strategy.equals(Char2CharOpenCustomHashMap.this.key[pos], local_k))
        {
          Char2CharOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2CharMap.Entry>
  {
    ...
    public AbstractChar2CharMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2CharOpenCustomHashMap.this.key[local_e];
      this.entry.value = Char2CharOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2CharMap.Entry>
  {
    ...
    {
      return this.entry = new Char2CharOpenCustomHashMap.MapEntry(Char2CharOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2CharOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1802 = Char2CharOpenCustomHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2CharOpenCustomHashMap.this.used;
      while ((this.field_1802 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1802 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1802 != 0)
      {
        boolean[] local_k = Char2CharOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2CharOpenCustomHashMap.this.mask; Char2CharOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2CharOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2CharOpenCustomHashMap.this.strategy.hashCode(Char2CharOpenCustomHashMap.this.key[pos])) & Char2CharOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2CharOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2CharOpenCustomHashMap.this.key[pos]);
        }
        Char2CharOpenCustomHashMap.this.key[last] = Char2CharOpenCustomHashMap.this.key[pos];
        Char2CharOpenCustomHashMap.this.value[last] = Char2CharOpenCustomHashMap.this.value[pos];
      }
      Char2CharOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2CharOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2CharOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1802 > 0))
      {
        this.field_1802 += 1;
        nextEntry();
      }
    ...
    implements Char2CharMap.Entry, Map.Entry<Character, Character>
  {
    ...
    public char setValue(char local_v)
    {
      ...
      Char2CharOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Character> local_e = (Map.Entry)local_o;
      return (Char2CharOpenCustomHashMap.this.strategy.equals(Char2CharOpenCustomHashMap.this.key[this.index], ((Character)local_e.getKey()).charValue())) && (Char2CharOpenCustomHashMap.this.value[this.index] == ((Character)local_e.getValue()).charValue());
    }
