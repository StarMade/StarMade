  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2ReferenceRBTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2ReferenceRBTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2ReferenceRBTreeMap(Map<? extends Character, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ReferenceRBTreeMap(SortedMap<Character, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ReferenceRBTreeMap(Char2ReferenceMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ReferenceRBTreeMap(Char2ReferenceSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ReferenceRBTreeMap(char[] local_k, V[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2ReferenceRBTreeMap(char[] local_k, V[] local_v)
  {
  ...
  {
    Char2ReferenceRBTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Char2ReferenceMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Char2ReferenceRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2ReferenceRBTreeMap.EntryIterator(Char2ReferenceRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> from)
        {
          return new Char2ReferenceRBTreeMap.EntryIterator(Char2ReferenceRBTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2ReferenceRBTreeMap.Entry<V> local_f = Char2ReferenceRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2ReferenceRBTreeMap.Entry<V> local_f = Char2ReferenceRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2ReferenceRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Char2ReferenceRBTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> local_to)
        {
          return Char2ReferenceRBTreeMap.this.headMap((Character)local_to.getKey()).char2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> from)
        {
          return Char2ReferenceRBTreeMap.this.tailMap((Character)from.getKey()).char2ReferenceEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Char2ReferenceRBTreeMap.ValueIterator(Char2ReferenceRBTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Char2ReferenceRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2ReferenceRBTreeMap<V> local_c;
    try
    {
      local_c = (Char2ReferenceRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Char2ReferenceRBTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2ReferenceRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Char2ReferenceRBTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Char2ReferenceRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2ReferenceRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator()
          {
            return new Char2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Char2ReferenceRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> from)
          {
            return new Char2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Char2ReferenceRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, V> local_e = (Map.Entry)local_o;
            Char2ReferenceRBTreeMap.Entry<V> local_f = Char2ReferenceRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2ReferenceRBTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, V> local_e = (Map.Entry)local_o;
            Char2ReferenceRBTreeMap.Entry<V> local_f = Char2ReferenceRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2ReferenceRBTreeMap.Submap.this.in2(local_f.key))) {
              Char2ReferenceRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2ReferenceRBTreeMap.Submap.SubmapIterator(Char2ReferenceRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2ReferenceRBTreeMap.Submap.this.clear();
          }
          
          public Char2ReferenceMap.Entry<V> first()
          {
            return Char2ReferenceRBTreeMap.Submap.this.firstEntry();
          }
          
          public Char2ReferenceMap.Entry<V> last()
          {
            return Char2ReferenceRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> from, Char2ReferenceMap.Entry<V> local_to)
          {
            return Char2ReferenceRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> local_to)
          {
            return Char2ReferenceRBTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> from)
          {
            return Char2ReferenceRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2ReferenceEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ReferenceCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractReferenceCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Char2ReferenceRBTreeMap.Submap.SubmapValueIterator(Char2ReferenceRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Char2ReferenceRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2ReferenceRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2ReferenceRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2ReferenceRBTreeMap.Entry<V> local_e;
      return (in2(local_kk)) && ((local_e = Char2ReferenceRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(char local_k, V local_v)
    {
      ...
      V oldValue = Char2ReferenceRBTreeMap.this.put(local_k, local_v);
    ...
    public V remove(char local_k)
    {
      ...
      V oldValue = Char2ReferenceRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2ReferenceSortedMap<V> tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2ReferenceRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2ReferenceRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2ReferenceSortedMap<V> subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2ReferenceRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2ReferenceRBTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2ReferenceRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2ReferenceRBTreeMap.this.locateKey(this.from);
        if (Char2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2ReferenceRBTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2ReferenceRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2ReferenceRBTreeMap.this.locateKey(this.field_47);
        if (Char2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2ReferenceRBTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2ReferenceRBTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Char2ReferenceRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Char2ReferenceRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Char2ReferenceRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2ReferenceRBTreeMap.Submap.this.bottom) && (Char2ReferenceRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2ReferenceRBTreeMap.Submap.this.top) && (Char2ReferenceRBTreeMap.this.compare(local_k, (this.prev = Char2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2ReferenceRBTreeMap.this.locateKey(local_k);
            if (Char2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2ReferenceRBTreeMap.this.compare(this.prev.key, Char2ReferenceRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Char2ReferenceRBTreeMap.this.compare(this.next.key, Char2ReferenceRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2ReferenceSortedMap.KeySet
    {
      ...
      {
        return new Char2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Char2ReferenceRBTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Char2ReferenceRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2ReferenceSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2ReferenceRBTreeMap.KeyIterator(Char2ReferenceRBTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2ReferenceRBTreeMap.KeyIterator(Char2ReferenceRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2ReferenceRBTreeMap.this.locateKey(local_k)) != null) {
        if (Char2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
