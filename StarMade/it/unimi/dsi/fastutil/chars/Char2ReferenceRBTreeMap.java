...
/*  119 */           return Char2ReferenceRBTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*      */         }
/*      */         public int compare(Character ok1, Character ok2) {
/*  122 */           return Char2ReferenceRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* 1118 */         final Comparator<? super Char2ReferenceMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Char2ReferenceMap.Entry<V> x, Char2ReferenceMap.Entry<V> y) {
/* 1120 */             return Char2ReferenceRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Char2ReferenceRBTreeMap.EntryIterator(Char2ReferenceRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> from) {
/* 1130 */           return new Char2ReferenceRBTreeMap.EntryIterator(Char2ReferenceRBTreeMap.this, ((Character)from.getKey()).charValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Char2ReferenceRBTreeMap.Entry f = Char2ReferenceRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1143 */           Char2ReferenceRBTreeMap.Entry f = Char2ReferenceRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1144 */           if (f != null) Char2ReferenceRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Char2ReferenceRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Char2ReferenceRBTreeMap.this.clear(); } 
/* 1149 */         public Char2ReferenceMap.Entry<V> first() { return Char2ReferenceRBTreeMap.this.firstEntry; } 
/* 1150 */         public Char2ReferenceMap.Entry<V> last() { return Char2ReferenceRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> from, Char2ReferenceMap.Entry<V> to) { return Char2ReferenceRBTreeMap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2ReferenceEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> to) { return Char2ReferenceRBTreeMap.this.headMap((Character)to.getKey()).char2ReferenceEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> from) { return Char2ReferenceRBTreeMap.this.tailMap((Character)from.getKey()).char2ReferenceEntrySet(); }
/*      */       };
...
/* 1215 */           return new Char2ReferenceRBTreeMap.ValueIterator(Char2ReferenceRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Char2ReferenceRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Char2ReferenceRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Char2ReferenceRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1580 */       c = (Char2ReferenceRBTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Char2ReferenceRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Char2ReferenceRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Char2ReferenceRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator() {
/* 1302 */             return new Char2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Char2ReferenceRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Char2ReferenceMap.Entry<V>> iterator(Char2ReferenceMap.Entry<V> from) {
/* 1305 */             return new Char2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Char2ReferenceRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
/*      */           }
/* 1307 */           public Comparator<? super Char2ReferenceMap.Entry<V>> comparator() { return Char2ReferenceRBTreeMap.this.char2ReferenceEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Char2ReferenceRBTreeMap.Entry f = Char2ReferenceRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1313 */             return (f != null) && (Char2ReferenceRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Char2ReferenceRBTreeMap.Entry f = Char2ReferenceRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1320 */             if ((f != null) && (Char2ReferenceRBTreeMap.Submap.this.in(f.key))) Char2ReferenceRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Char2ReferenceRBTreeMap.Submap.SubmapIterator(Char2ReferenceRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Char2ReferenceRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Char2ReferenceMap.Entry<V> first() { return Char2ReferenceRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Char2ReferenceMap.Entry<V> last() { return Char2ReferenceRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Char2ReferenceMap.Entry<V>> subSet(Char2ReferenceMap.Entry<V> from, Char2ReferenceMap.Entry<V> to) { return Char2ReferenceRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2ReferenceEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Char2ReferenceMap.Entry<V>> headSet(Char2ReferenceMap.Entry<V> to) { return Char2ReferenceRBTreeMap.Submap.this.headMap((Character)to.getKey()).char2ReferenceEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Char2ReferenceMap.Entry<V>> tailSet(Char2ReferenceMap.Entry<V> from) { return Char2ReferenceRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2ReferenceEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Char2ReferenceRBTreeMap.Submap.SubmapValueIterator(Char2ReferenceRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Char2ReferenceRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Char2ReferenceRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Char2ReferenceRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(char k) {
/* 1365 */       return (in(k)) && (Char2ReferenceRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       char kk = k;
/*      */       Char2ReferenceRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Char2ReferenceRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(char k, V v) {
/* 1383 */       Char2ReferenceRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Char2ReferenceRBTreeMap.this.put(k, v);
/* 1386 */       return Char2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Character ok, V ov) {
/* 1389 */       Object oldValue = put(ok.charValue(), ov);
/* 1390 */       return Char2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(char k) {
/* 1394 */       Char2ReferenceRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Char2ReferenceRBTreeMap.this.remove(k);
/* 1397 */       return Char2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Character)ok).charValue());
/* 1401 */       return Char2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public CharComparator comparator() {
/* 1416 */       return Char2ReferenceRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Char2ReferenceSortedMap<V> headMap(char to) {
/* 1419 */       if (this.top) return new Submap(Char2ReferenceRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Char2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Char2ReferenceRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Char2ReferenceSortedMap<V> tailMap(char from) {
/* 1423 */       if (this.bottom) return new Submap(Char2ReferenceRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Char2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2ReferenceRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Char2ReferenceSortedMap<V> subMap(char from, char to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Char2ReferenceRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Char2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Char2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Char2ReferenceRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Char2ReferenceRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Char2ReferenceRBTreeMap.this.tree == null) return null;
/* 1441 */       Char2ReferenceRBTreeMap.Entry e;
/*      */       Char2ReferenceRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Char2ReferenceRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Char2ReferenceRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Char2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Char2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Char2ReferenceRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Char2ReferenceRBTreeMap.this.tree == null) return null;
/* 1459 */       Char2ReferenceRBTreeMap.Entry e;
/*      */       Char2ReferenceRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Char2ReferenceRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Char2ReferenceRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Char2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Char2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public char firstCharKey() {
/* 1470 */       Char2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public char lastCharKey() {
/* 1475 */       Char2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Character firstKey() {
/* 1480 */       Char2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Character lastKey() {
/* 1485 */       Char2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Char2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Char2ReferenceRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Char2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/* 1530 */       public Char2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Char2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Char2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Char2ReferenceRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Char2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Char2ReferenceRBTreeMap.Submap.this.bottom) && (Char2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Char2ReferenceRBTreeMap.Submap.this.top) && (Char2ReferenceRBTreeMap.this.compare(k, (this.prev = Char2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Char2ReferenceRBTreeMap.this.locateKey(k);
/* 1507 */             if (Char2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Char2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2ReferenceRBTreeMap.this.compare(this.prev.key, Char2ReferenceRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Char2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Char2ReferenceRBTreeMap.this.compare(this.next.key, Char2ReferenceRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public CharBidirectionalIterator iterator() { return new Char2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Char2ReferenceRBTreeMap.Submap.this); } 
/* 1340 */       public CharBidirectionalIterator iterator(char from) { return new Char2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Char2ReferenceRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public CharBidirectionalIterator iterator() { return new Char2ReferenceRBTreeMap.KeyIterator(Char2ReferenceRBTreeMap.this); } 
/* 1178 */     public CharBidirectionalIterator iterator(char from) { return new Char2ReferenceRBTreeMap.KeyIterator(Char2ReferenceRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2ReferenceRBTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Char2ReferenceMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1112 */     public Char2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Char2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Char2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Char2ReferenceRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(char k) {
/* 1044 */       if ((this.next = Char2ReferenceRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Char2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Char2ReferenceRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Character)e.getKey()).charValue()) && (this.value == e.getValue());
/*      */     }
/*      */     public int hashCode() {
