...
public class Char2CharMaps
{
  ...
  public static Char2CharMap synchronize(Char2CharMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Char2CharMap synchronize(Char2CharMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Char2CharMap unmodifiable(Char2CharMap local_m)
  {
    ...
    implements Char2CharMap, Serializable
  {
    ...
    protected UnmodifiableMap(Char2CharMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Char2CharMap, Serializable
  {
    ...
    protected SynchronizedMap(Char2CharMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Char2CharMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Char2CharMap, Serializable, Cloneable
  {
      ...
      implements Char2CharMap.Entry, Map.Entry<Character, Character>
    {
      ...
      {
        return Character.valueOf(Char2CharMaps.Singleton.this.key);
      }
      
      public Character getValue()
      {
        return Character.valueOf(Char2CharMaps.Singleton.this.value);
      }
      
      public char getCharKey()
      {
        return Char2CharMaps.Singleton.this.key;
      }
      
      public char getCharValue()
      {
        return Char2CharMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Char2CharMaps.Singleton.this.key == ((Character)local_e.getKey()).charValue()) && (Char2CharMaps.Singleton.this.value == ((Character)local_e.getValue()).charValue());
      }
      
      public int hashCode()
      {
        return Char2CharMaps.Singleton.this.key ^ Char2CharMaps.Singleton.this.value;
      }
