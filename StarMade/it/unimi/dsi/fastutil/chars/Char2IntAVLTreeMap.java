...
/*      */ 
/*      */ public class Char2IntAVLTreeMap extends AbstractChar2IntSortedMap
...
/*  117 */           return Char2IntAVLTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*      */         }
/*      */         public int compare(Character ok1, Character ok2) {
/*  120 */           return Char2IntAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     int oldValue = put(ok.charValue(), ov.intValue());
/*  780 */     return this.modified ? null : Integer.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Integer remove(Object ok)
/*      */   {
/*  788 */     int oldValue = remove(((Character)ok).charValue());
...
/* 1203 */         final Comparator<? super Char2IntMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Char2IntMap.Entry x, Char2IntMap.Entry y) {
/* 1205 */             return Char2IntAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Char2IntAVLTreeMap.EntryIterator(Char2IntAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1215 */           return new Char2IntAVLTreeMap.EntryIterator(Char2IntAVLTreeMap.this, ((Character)from.getKey()).charValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1228 */           Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1229 */           if (f != null) Char2IntAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Char2IntAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Char2IntAVLTreeMap.this.clear(); } 
/* 1234 */         public Char2IntMap.Entry first() { return Char2IntAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Char2IntMap.Entry last() { return Char2IntAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) { return Char2IntAVLTreeMap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2IntEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) { return Char2IntAVLTreeMap.this.headMap((Character)to.getKey()).char2IntEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) { return Char2IntAVLTreeMap.this.tailMap((Character)from.getKey()).char2IntEntrySet(); }
/*      */       };
...
/* 1304 */           return new Char2IntAVLTreeMap.ValueIterator(Char2IntAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(int k) {
/* 1307 */           return Char2IntAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Char2IntAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Char2IntAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Char2IntAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readChar(), s.readInt());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readChar(), s.readInt());
/* 1759 */       top.right(new Entry(s.readChar(), s.readInt()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Char2IntAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Char2IntAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Char2IntAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Char2IntAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator() {
/* 1391 */             return new Char2IntAVLTreeMap.Submap.SubmapEntryIterator(Char2IntAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from) {
/* 1394 */             return new Char2IntAVLTreeMap.Submap.SubmapEntryIterator(Char2IntAVLTreeMap.Submap.this, ((Character)from.getKey()).charValue());
/*      */           }
/* 1396 */           public Comparator<? super Char2IntMap.Entry> comparator() { return Char2IntAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1402 */             return (f != null) && (Char2IntAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Char2IntAVLTreeMap.Entry f = Char2IntAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1409 */             if ((f != null) && (Char2IntAVLTreeMap.Submap.this.in(f.key))) Char2IntAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Char2IntAVLTreeMap.Submap.SubmapIterator(Char2IntAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Char2IntAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Char2IntMap.Entry first() { return Char2IntAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Char2IntMap.Entry last() { return Char2IntAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry to) { return Char2IntAVLTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2IntEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry to) { return Char2IntAVLTreeMap.Submap.this.headMap((Character)to.getKey()).char2IntEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from) { return Char2IntAVLTreeMap.Submap.this.tailMap((Character)from.getKey()).char2IntEntrySet(); }
/*      */         };
...
/*      */           public IntIterator iterator() {
/* 1442 */             return new Char2IntAVLTreeMap.Submap.SubmapValueIterator(Char2IntAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(int k) {
/* 1445 */             return Char2IntAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Char2IntAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Char2IntAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(char k) {
/* 1458 */       return (in(k)) && (Char2IntAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(int v) {
...
/* 1473 */       return (in(kk)) && ((e = Char2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public int put(char k, int v) {
/* 1476 */       Char2IntAVLTreeMap.this.modified = false;
...
/* 1478 */       int oldValue = Char2IntAVLTreeMap.this.put(k, v);
/* 1479 */       return Char2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Integer put(Character ok, Integer ov) {
/* 1482 */       int oldValue = put(ok.charValue(), ov.intValue());
/* 1483 */       return Char2IntAVLTreeMap.this.modified ? null : Integer.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public int remove(char k) {
/* 1487 */       Char2IntAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       int oldValue = Char2IntAVLTreeMap.this.remove(k);
/* 1490 */       return Char2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Integer remove(Object ok) {
/* 1493 */       int oldValue = remove(((Character)ok).charValue());
/* 1494 */       return Char2IntAVLTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public CharComparator comparator() {
/* 1509 */       return Char2IntAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Char2IntSortedMap headMap(char to) {
/* 1512 */       if (this.top) return new Submap(Char2IntAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Char2IntAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Char2IntAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Char2IntSortedMap tailMap(char from) {
/* 1516 */       if (this.bottom) return new Submap(Char2IntAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Char2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2IntAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Char2IntSortedMap subMap(char from, char to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Char2IntAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Char2IntAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Char2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Char2IntAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Char2IntAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Char2IntAVLTreeMap.this.tree == null) return null;
/* 1534 */       Char2IntAVLTreeMap.Entry e;
/*      */       Char2IntAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Char2IntAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Char2IntAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Char2IntAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Char2IntAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Char2IntAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Char2IntAVLTreeMap.this.tree == null) return null;
/* 1552 */       Char2IntAVLTreeMap.Entry e;
/*      */       Char2IntAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Char2IntAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Char2IntAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Char2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Char2IntAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public char firstCharKey() {
/* 1563 */       Char2IntAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public char lastCharKey() {
/* 1568 */       Char2IntAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Character firstKey() {
/* 1573 */       Char2IntAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Character lastKey() {
/* 1578 */       Char2IntAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Char2IntAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Char2IntAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Char2IntAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Char2IntMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Char2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Char2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Char2IntAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Char2IntAVLTreeMap.Submap.this.bottom) && (Char2IntAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Char2IntAVLTreeMap.Submap.this.top) && (Char2IntAVLTreeMap.this.compare(k, (this.prev = Char2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Char2IntAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Char2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Char2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2IntAVLTreeMap.this.compare(this.prev.key, Char2IntAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Char2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Char2IntAVLTreeMap.this.compare(this.next.key, Char2IntAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public CharBidirectionalIterator iterator() { return new Char2IntAVLTreeMap.Submap.SubmapKeyIterator(Char2IntAVLTreeMap.Submap.this); } 
/* 1433 */       public CharBidirectionalIterator iterator(char from) { return new Char2IntAVLTreeMap.Submap.SubmapKeyIterator(Char2IntAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2IntAVLTreeMap.TreeIterator
/*      */     implements IntListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public CharBidirectionalIterator iterator() { return new Char2IntAVLTreeMap.KeyIterator(Char2IntAVLTreeMap.this); } 
/* 1263 */     public CharBidirectionalIterator iterator(char from) { return new Char2IntAVLTreeMap.KeyIterator(Char2IntAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2IntAVLTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2IntAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Char2IntMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Char2IntMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Char2IntMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Char2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Char2IntAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(char k) {
/* 1129 */       if ((this.next = Char2IntAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Char2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Char2IntAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Character)e.getKey()).charValue()) && (this.value == ((Integer)e.getValue()).intValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
