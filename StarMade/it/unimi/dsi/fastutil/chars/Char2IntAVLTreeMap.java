  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2IntAVLTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2IntAVLTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2IntAVLTreeMap(Map<? extends Character, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2IntAVLTreeMap(SortedMap<Character, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2IntAVLTreeMap(Char2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2IntAVLTreeMap(Char2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2IntAVLTreeMap(char[] local_k, int[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2IntAVLTreeMap(char[] local_k, int[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Char2IntMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Char2IntAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2IntAVLTreeMap.EntryIterator(Char2IntAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from)
        {
          return new Char2IntAVLTreeMap.EntryIterator(Char2IntAVLTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2IntAVLTreeMap.Entry local_f = Char2IntAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2IntAVLTreeMap.Entry local_f = Char2IntAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2IntAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Char2IntAVLTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2IntEntrySet();
        }
        
        public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry local_to)
        {
          return Char2IntAVLTreeMap.this.headMap((Character)local_to.getKey()).char2IntEntrySet();
        }
        
        public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from)
        {
          return Char2IntAVLTreeMap.this.tailMap((Character)from.getKey()).char2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Char2IntAVLTreeMap.ValueIterator(Char2IntAVLTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Char2IntAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2IntAVLTreeMap local_c;
    try
    {
      local_c = (Char2IntAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2IntAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Char2IntAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2IntAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2IntMap.Entry> char2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator()
          {
            return new Char2IntAVLTreeMap.Submap.SubmapEntryIterator(Char2IntAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2IntMap.Entry> iterator(Char2IntMap.Entry from)
          {
            return new Char2IntAVLTreeMap.Submap.SubmapEntryIterator(Char2IntAVLTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, Integer> local_e = (Map.Entry)local_o;
            Char2IntAVLTreeMap.Entry local_f = Char2IntAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2IntAVLTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, Integer> local_e = (Map.Entry)local_o;
            Char2IntAVLTreeMap.Entry local_f = Char2IntAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2IntAVLTreeMap.Submap.this.in2(local_f.key))) {
              Char2IntAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2IntAVLTreeMap.Submap.SubmapIterator(Char2IntAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2IntAVLTreeMap.Submap.this.clear();
          }
          
          public Char2IntMap.Entry first()
          {
            return Char2IntAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Char2IntMap.Entry last()
          {
            return Char2IntAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2IntMap.Entry> subSet(Char2IntMap.Entry from, Char2IntMap.Entry local_to)
          {
            return Char2IntAVLTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2IntEntrySet();
          }
          
          public ObjectSortedSet<Char2IntMap.Entry> headSet(Char2IntMap.Entry local_to)
          {
            return Char2IntAVLTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2IntEntrySet();
          }
          
          public ObjectSortedSet<Char2IntMap.Entry> tailSet(Char2IntMap.Entry from)
          {
            return Char2IntAVLTreeMap.Submap.this.tailMap((Character)from.getKey()).char2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Char2IntAVLTreeMap.Submap.SubmapValueIterator(Char2IntAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Char2IntAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2IntAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2IntAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2IntAVLTreeMap.Entry local_e;
      return (in2(local_kk)) && ((local_e = Char2IntAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(char local_k, int local_v)
    {
      ...
      int oldValue = Char2IntAVLTreeMap.this.put(local_k, local_v);
    ...
    public int remove(char local_k)
    {
      ...
      int oldValue = Char2IntAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2IntAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2IntAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2IntSortedMap tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2IntAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2IntAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2IntSortedMap subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2IntAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2IntAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2IntAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2IntAVLTreeMap.this.locateKey(this.from);
        if (Char2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2IntAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2IntAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2IntAVLTreeMap.this.locateKey(this.field_47);
        if (Char2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2IntAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2IntAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Char2IntAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Char2IntAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2IntAVLTreeMap.Submap.this.bottom) && (Char2IntAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2IntAVLTreeMap.Submap.this.top) && (Char2IntAVLTreeMap.this.compare(local_k, (this.prev = Char2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2IntAVLTreeMap.this.locateKey(local_k);
            if (Char2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2IntAVLTreeMap.this.compare(this.prev.key, Char2IntAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Char2IntAVLTreeMap.this.compare(this.next.key, Char2IntAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2IntSortedMap.KeySet
    {
      ...
      {
        return new Char2IntAVLTreeMap.Submap.SubmapKeyIterator(Char2IntAVLTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2IntAVLTreeMap.Submap.SubmapKeyIterator(Char2IntAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2IntSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2IntAVLTreeMap.KeyIterator(Char2IntAVLTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2IntAVLTreeMap.KeyIterator(Char2IntAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2IntAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Char2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
