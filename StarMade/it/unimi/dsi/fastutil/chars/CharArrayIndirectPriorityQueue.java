  ...
  implements CharIndirectPriorityQueue
{
  ...
  public CharArrayIndirectPriorityQueue(char[] refArray, int capacity, CharComparator local_c)
  {
    if (capacity > 0) {
  ...
  public CharArrayIndirectPriorityQueue(char[] refArray, CharComparator local_c)
  {
  ...
  public CharArrayIndirectPriorityQueue(char[] refArray, int[] local_a, int size, CharComparator local_c)
  {
  ...
  public CharArrayIndirectPriorityQueue(char[] refArray, int[] local_a, CharComparator local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public CharArrayIndirectPriorityQueue(char[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public CharArrayIndirectPriorityQueue(char[] refArray, int[] local_a)
  {
  ...
  {
    char top = this.refArray[this.array[findFirst()]];
    int local_i = this.size;
    int local_c = 0;
    while (local_i-- != 0) {
