...
/*   6:    */
/*  57:    */public class CharHeapSemiIndirectPriorityQueue
/*  58:    */  extends AbstractIndirectPriorityQueue<Character>
/*  59:    */  implements CharIndirectPriorityQueue
/*  60:    */{
/*  61:    */  protected char[] refArray;
/*  62: 62 */  protected int[] heap = IntArrays.EMPTY_ARRAY;
/*  63:    */  
/*  65:    */  protected int size;
/*  66:    */  
/*  68:    */  protected CharComparator c;
/*  69:    */  
/*  72:    */  public CharHeapSemiIndirectPriorityQueue(char[] refArray, int capacity, CharComparator c)
/*  73:    */  {
...
/*  77:    */  }
/*  78:    */  
/*  82:    */  public CharHeapSemiIndirectPriorityQueue(char[] refArray, int capacity)
/*  83:    */  {
/*  84: 84 */    this(refArray, capacity, null);
/*  85:    */  }
/*  86:    */  
/*  90:    */  public CharHeapSemiIndirectPriorityQueue(char[] refArray, CharComparator c)
/*  91:    */  {
/*  92: 92 */    this(refArray, refArray.length, c);
/*  93:    */  }
/*  94:    */  
/*  96:    */  public CharHeapSemiIndirectPriorityQueue(char[] refArray)
/*  97:    */  {
/*  98: 98 */    this(refArray, refArray.length, null);
/*  99:    */  }
/* 100:    */  
/* 110:    */  public CharHeapSemiIndirectPriorityQueue(char[] refArray, int[] a, int size, CharComparator c)
/* 111:    */  {
/* 112:112 */    this(refArray, 0, c);
/* 113:113 */    this.heap = a;
/* 114:114 */    this.size = size;
/* 115:115 */    CharSemiIndirectHeaps.makeHeap(refArray, a, size, c);
/* 116:    */  }
/* 117:    */  
/* 126:    */  public CharHeapSemiIndirectPriorityQueue(char[] refArray, int[] a, CharComparator c)
/* 127:    */  {
/* 128:128 */    this(refArray, a, a.length, c);
/* 129:    */  }
/* 130:    */  
/* 139:    */  public CharHeapSemiIndirectPriorityQueue(char[] refArray, int[] a, int size)
/* 140:    */  {
/* 141:141 */    this(refArray, a, size, null);
/* 142:    */  }
/* 143:    */  
/* 151:    */  public CharHeapSemiIndirectPriorityQueue(char[] refArray, int[] a)
/* 152:    */  {
...
/* 172:172 */    CharSemiIndirectHeaps.upHeap(this.refArray, this.heap, this.size, this.size - 1, this.c);
/* 173:    */  }
/* 174:    */  
...
/* 179:179 */    if (this.size != 0) CharSemiIndirectHeaps.downHeap(this.refArray, this.heap, this.size, 0, this.c);
...
/* 196:    */  {
/* 197:197 */    CharSemiIndirectHeaps.downHeap(this.refArray, this.heap, this.size, 0, this.c);
/* 198:    */  }
/* 199:    */  
/* 202:    */  public void allChanged()
/* 203:    */  {
/* 204:204 */    CharSemiIndirectHeaps.makeHeap(this.refArray, this.heap, this.size, this.c);
/* 205:    */  }
/* 206:    */  
...
/* 216:    */  }
/* 217:    */  
/* 218:218 */  public CharComparator comparator() { return this.c; }
/* 219:    */  
/* 220:    */  public int front(int[] a) {
/* 221:221 */    return CharSemiIndirectHeaps.front(this.refArray, this.heap, this.size, a);
/* 222:    */  }
/* 223:    */  
