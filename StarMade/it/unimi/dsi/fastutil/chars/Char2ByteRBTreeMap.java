  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2ByteRBTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2ByteRBTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2ByteRBTreeMap(Map<? extends Character, ? extends Byte> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ByteRBTreeMap(SortedMap<Character, Byte> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ByteRBTreeMap(Char2ByteMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ByteRBTreeMap(Char2ByteSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ByteRBTreeMap(char[] local_k, byte[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2ByteRBTreeMap(char[] local_k, byte[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Char2ByteMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Char2ByteRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2ByteRBTreeMap.EntryIterator(Char2ByteRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from)
        {
          return new Char2ByteRBTreeMap.EntryIterator(Char2ByteRBTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2ByteRBTreeMap.Entry local_f = Char2ByteRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2ByteRBTreeMap.Entry local_f = Char2ByteRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2ByteRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Char2ByteRBTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ByteEntrySet();
        }
        
        public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry local_to)
        {
          return Char2ByteRBTreeMap.this.headMap((Character)local_to.getKey()).char2ByteEntrySet();
        }
        
        public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from)
        {
          return Char2ByteRBTreeMap.this.tailMap((Character)from.getKey()).char2ByteEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Char2ByteRBTreeMap.ValueIterator(Char2ByteRBTreeMap.this, null);
        }
        
        public boolean contains(byte local_k)
        {
          return Char2ByteRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2ByteRBTreeMap local_c;
    try
    {
      local_c = (Char2ByteRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2ByteRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Char2ByteRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2ByteRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2ByteMap.Entry> char2ByteEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator()
          {
            return new Char2ByteRBTreeMap.Submap.SubmapEntryIterator(Char2ByteRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from)
          {
            return new Char2ByteRBTreeMap.Submap.SubmapEntryIterator(Char2ByteRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, Byte> local_e = (Map.Entry)local_o;
            Char2ByteRBTreeMap.Entry local_f = Char2ByteRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2ByteRBTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, Byte> local_e = (Map.Entry)local_o;
            Char2ByteRBTreeMap.Entry local_f = Char2ByteRBTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2ByteRBTreeMap.Submap.this.in2(local_f.key))) {
              Char2ByteRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2ByteRBTreeMap.Submap.SubmapIterator(Char2ByteRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2ByteRBTreeMap.Submap.this.clear();
          }
          
          public Char2ByteMap.Entry first()
          {
            return Char2ByteRBTreeMap.Submap.this.firstEntry();
          }
          
          public Char2ByteMap.Entry last()
          {
            return Char2ByteRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry local_to)
          {
            return Char2ByteRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ByteEntrySet();
          }
          
          public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry local_to)
          {
            return Char2ByteRBTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2ByteEntrySet();
          }
          
          public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from)
          {
            return Char2ByteRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2ByteEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ByteCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractByteCollection()
        {
          public ByteIterator iterator()
          {
            return new Char2ByteRBTreeMap.Submap.SubmapValueIterator(Char2ByteRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(byte local_k)
          {
            return Char2ByteRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2ByteRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2ByteRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2ByteRBTreeMap.Entry local_e;
      return (in2(local_kk)) && ((local_e = Char2ByteRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public byte put(char local_k, byte local_v)
    {
      ...
      byte oldValue = Char2ByteRBTreeMap.this.put(local_k, local_v);
    ...
    public byte remove(char local_k)
    {
      ...
      byte oldValue = Char2ByteRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2ByteRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2ByteRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2ByteSortedMap tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2ByteRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2ByteRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2ByteSortedMap subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2ByteRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2ByteRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2ByteRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2ByteRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2ByteRBTreeMap.this.locateKey(this.from);
        if (Char2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2ByteRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2ByteRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2ByteRBTreeMap.this.locateKey(this.field_47);
        if (Char2ByteRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2ByteRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2ByteRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2ByteRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Char2ByteRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Char2ByteRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2ByteRBTreeMap.Submap.this.bottom) && (Char2ByteRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2ByteRBTreeMap.Submap.this.top) && (Char2ByteRBTreeMap.this.compare(local_k, (this.prev = Char2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2ByteRBTreeMap.this.locateKey(local_k);
            if (Char2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2ByteRBTreeMap.this.compare(this.prev.key, Char2ByteRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Char2ByteRBTreeMap.this.compare(this.next.key, Char2ByteRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2ByteSortedMap.KeySet
    {
      ...
      {
        return new Char2ByteRBTreeMap.Submap.SubmapKeyIterator(Char2ByteRBTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2ByteRBTreeMap.Submap.SubmapKeyIterator(Char2ByteRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2ByteSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2ByteRBTreeMap.KeyIterator(Char2ByteRBTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2ByteRBTreeMap.KeyIterator(Char2ByteRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2ByteRBTreeMap.this.locateKey(local_k)) != null) {
        if (Char2ByteRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
