...
/*      */ 
/*      */ public class Char2ByteRBTreeMap extends AbstractChar2ByteSortedMap
...
/*  119 */           return Char2ByteRBTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*      */         }
/*      */         public int compare(Character ok1, Character ok2) {
/*  122 */           return Char2ByteRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     byte oldValue = put(ok.charValue(), ov.byteValue());
/*  731 */     return this.modified ? null : Byte.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Byte remove(Object ok)
/*      */   {
/*  737 */     byte oldValue = remove(((Character)ok).charValue());
...
/* 1141 */         final Comparator<? super Char2ByteMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Char2ByteMap.Entry x, Char2ByteMap.Entry y) {
/* 1143 */             return Char2ByteRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Char2ByteRBTreeMap.EntryIterator(Char2ByteRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from) {
/* 1153 */           return new Char2ByteRBTreeMap.EntryIterator(Char2ByteRBTreeMap.this, ((Character)from.getKey()).charValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Char2ByteRBTreeMap.Entry f = Char2ByteRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1166 */           Char2ByteRBTreeMap.Entry f = Char2ByteRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1167 */           if (f != null) Char2ByteRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Char2ByteRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Char2ByteRBTreeMap.this.clear(); } 
/* 1172 */         public Char2ByteMap.Entry first() { return Char2ByteRBTreeMap.this.firstEntry; } 
/* 1173 */         public Char2ByteMap.Entry last() { return Char2ByteRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to) { return Char2ByteRBTreeMap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2ByteEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to) { return Char2ByteRBTreeMap.this.headMap((Character)to.getKey()).char2ByteEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from) { return Char2ByteRBTreeMap.this.tailMap((Character)from.getKey()).char2ByteEntrySet(); }
/*      */       };
...
/* 1242 */           return new Char2ByteRBTreeMap.ValueIterator(Char2ByteRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(byte k) {
/* 1245 */           return Char2ByteRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Char2ByteRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Char2ByteRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Char2ByteRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readChar(), s.readByte());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readChar(), s.readByte());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readChar(), s.readByte()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Char2ByteRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Char2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator() {
/* 1329 */             return new Char2ByteRBTreeMap.Submap.SubmapEntryIterator(Char2ByteRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Char2ByteMap.Entry> iterator(Char2ByteMap.Entry from) {
/* 1332 */             return new Char2ByteRBTreeMap.Submap.SubmapEntryIterator(Char2ByteRBTreeMap.Submap.this, ((Character)from.getKey()).charValue());
/*      */           }
/* 1334 */           public Comparator<? super Char2ByteMap.Entry> comparator() { return Char2ByteRBTreeMap.this.char2ByteEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Char2ByteRBTreeMap.Entry f = Char2ByteRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1340 */             return (f != null) && (Char2ByteRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Char2ByteRBTreeMap.Entry f = Char2ByteRBTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1347 */             if ((f != null) && (Char2ByteRBTreeMap.Submap.this.in(f.key))) Char2ByteRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Char2ByteRBTreeMap.Submap.SubmapIterator(Char2ByteRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Char2ByteRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Char2ByteMap.Entry first() { return Char2ByteRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Char2ByteMap.Entry last() { return Char2ByteRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Char2ByteMap.Entry> subSet(Char2ByteMap.Entry from, Char2ByteMap.Entry to) { return Char2ByteRBTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2ByteEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Char2ByteMap.Entry> headSet(Char2ByteMap.Entry to) { return Char2ByteRBTreeMap.Submap.this.headMap((Character)to.getKey()).char2ByteEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Char2ByteMap.Entry> tailSet(Char2ByteMap.Entry from) { return Char2ByteRBTreeMap.Submap.this.tailMap((Character)from.getKey()).char2ByteEntrySet(); }
/*      */         };
...
/*      */           public ByteIterator iterator() {
/* 1376 */             return new Char2ByteRBTreeMap.Submap.SubmapValueIterator(Char2ByteRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(byte k) {
/* 1379 */             return Char2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Char2ByteRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Char2ByteRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(char k) {
/* 1392 */       return (in(k)) && (Char2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(byte v) {
...
/* 1407 */       return (in(kk)) && ((e = Char2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public byte put(char k, byte v) {
/* 1410 */       Char2ByteRBTreeMap.this.modified = false;
...
/* 1412 */       byte oldValue = Char2ByteRBTreeMap.this.put(k, v);
/* 1413 */       return Char2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Byte put(Character ok, Byte ov) {
/* 1416 */       byte oldValue = put(ok.charValue(), ov.byteValue());
/* 1417 */       return Char2ByteRBTreeMap.this.modified ? null : Byte.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public byte remove(char k) {
/* 1421 */       Char2ByteRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       byte oldValue = Char2ByteRBTreeMap.this.remove(k);
/* 1424 */       return Char2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Byte remove(Object ok) {
/* 1427 */       byte oldValue = remove(((Character)ok).charValue());
/* 1428 */       return Char2ByteRBTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public CharComparator comparator() {
/* 1443 */       return Char2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Char2ByteSortedMap headMap(char to) {
/* 1446 */       if (this.top) return new Submap(Char2ByteRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Char2ByteRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Char2ByteRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Char2ByteSortedMap tailMap(char from) {
/* 1450 */       if (this.bottom) return new Submap(Char2ByteRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Char2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2ByteRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Char2ByteSortedMap subMap(char from, char to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Char2ByteRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Char2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Char2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Char2ByteRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Char2ByteRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Char2ByteRBTreeMap.this.tree == null) return null;
/* 1468 */       Char2ByteRBTreeMap.Entry e;
/*      */       Char2ByteRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Char2ByteRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Char2ByteRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Char2ByteRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Char2ByteRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Char2ByteRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Char2ByteRBTreeMap.this.tree == null) return null;
/* 1486 */       Char2ByteRBTreeMap.Entry e;
/*      */       Char2ByteRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Char2ByteRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Char2ByteRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Char2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Char2ByteRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public char firstCharKey() {
/* 1497 */       Char2ByteRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public char lastCharKey() {
/* 1502 */       Char2ByteRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Character firstKey() {
/* 1507 */       Char2ByteRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Character lastKey() {
/* 1512 */       Char2ByteRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Char2ByteRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Char2ByteRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Char2ByteRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Char2ByteMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Char2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Char2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Char2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Char2ByteRBTreeMap.Submap.this.bottom) && (Char2ByteRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Char2ByteRBTreeMap.Submap.this.top) && (Char2ByteRBTreeMap.this.compare(k, (this.prev = Char2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Char2ByteRBTreeMap.this.locateKey(k);
/* 1534 */             if (Char2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Char2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2ByteRBTreeMap.this.compare(this.prev.key, Char2ByteRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Char2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Char2ByteRBTreeMap.this.compare(this.next.key, Char2ByteRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public CharBidirectionalIterator iterator() { return new Char2ByteRBTreeMap.Submap.SubmapKeyIterator(Char2ByteRBTreeMap.Submap.this); } 
/* 1367 */       public CharBidirectionalIterator iterator(char from) { return new Char2ByteRBTreeMap.Submap.SubmapKeyIterator(Char2ByteRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2ByteRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public CharBidirectionalIterator iterator() { return new Char2ByteRBTreeMap.KeyIterator(Char2ByteRBTreeMap.this); } 
/* 1201 */     public CharBidirectionalIterator iterator(char from) { return new Char2ByteRBTreeMap.KeyIterator(Char2ByteRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2ByteRBTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2ByteRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Char2ByteMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Char2ByteMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Char2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Char2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Char2ByteRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(char k) {
/* 1067 */       if ((this.next = Char2ByteRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Char2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Char2ByteRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Character)e.getKey()).charValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
