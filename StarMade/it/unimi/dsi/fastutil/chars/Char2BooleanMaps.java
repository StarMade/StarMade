...
public class Char2BooleanMaps
{
  ...
  public static Char2BooleanMap synchronize(Char2BooleanMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Char2BooleanMap synchronize(Char2BooleanMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Char2BooleanMap unmodifiable(Char2BooleanMap local_m)
  {
    ...
    implements Char2BooleanMap, Serializable
  {
    ...
    protected UnmodifiableMap(Char2BooleanMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Char2BooleanMap, Serializable
  {
    ...
    protected SynchronizedMap(Char2BooleanMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Char2BooleanMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Char2BooleanMap, Serializable, Cloneable
  {
      ...
      implements Char2BooleanMap.Entry, Map.Entry<Character, Boolean>
    {
      ...
      {
        return Character.valueOf(Char2BooleanMaps.Singleton.this.key);
      }
      
      public Boolean getValue()
      {
        return Boolean.valueOf(Char2BooleanMaps.Singleton.this.value);
      }
      
      public char getCharKey()
      {
        return Char2BooleanMaps.Singleton.this.key;
      }
      
      public boolean getBooleanValue()
      {
        return Char2BooleanMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Char2BooleanMaps.Singleton.this.key == ((Character)local_e.getKey()).charValue()) && (Char2BooleanMaps.Singleton.this.value == ((Boolean)local_e.getValue()).booleanValue());
      }
      
      public int hashCode()
      {
        return Char2BooleanMaps.Singleton.this.key ^ (Char2BooleanMaps.Singleton.this.value ? 'ӏ' : 'ӕ');
      }
      
      public String toString()
      {
        return Char2BooleanMaps.Singleton.this.key + "->" + Char2BooleanMaps.Singleton.this.value;
      }
    }
  }
