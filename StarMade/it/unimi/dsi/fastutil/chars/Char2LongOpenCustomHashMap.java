  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2LongOpenCustomHashMap(int expected, float local_f, CharHash.Strategy strategy)
  {
  ...
  public Char2LongOpenCustomHashMap(Map<? extends Character, ? extends Long> local_m, float local_f, CharHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Char2LongOpenCustomHashMap(Map<? extends Character, ? extends Long> local_m, CharHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Char2LongOpenCustomHashMap(Char2LongMap local_m, float local_f, CharHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Char2LongOpenCustomHashMap(Char2LongMap local_m, CharHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Char2LongOpenCustomHashMap(char[] local_k, long[] local_v, float local_f, CharHash.Strategy strategy)
  {
  ...
  public Char2LongOpenCustomHashMap(char[] local_k, long[] local_v, CharHash.Strategy strategy)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Char2LongOpenCustomHashMap.ValueIterator(Char2LongOpenCustomHashMap.this);
        }
        ...
        {
          return Char2LongOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2LongOpenCustomHashMap local_c;
    try
    {
      local_c = (Char2LongOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2LongOpenCustomHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Char2LongOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSet
  {
    ...
    {
      return new Char2LongOpenCustomHashMap.KeyIterator(Char2LongOpenCustomHashMap.this);
    }
    ...
    {
      return Char2LongOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2LongOpenCustomHashMap.this.size;
      Char2LongOpenCustomHashMap.this.remove(local_k);
    ...
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Char2LongOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2LongMap.FastEntrySet
  {
    ...
    {
      return new Char2LongOpenCustomHashMap.EntryIterator(Char2LongOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Char2LongMap.Entry> fastIterator()
    {
      return new Char2LongOpenCustomHashMap.FastEntryIterator(Char2LongOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Char2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Char2LongOpenCustomHashMap.this.mask; Char2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2LongOpenCustomHashMap.this.mask) {
        if (Char2LongOpenCustomHashMap.this.strategy.equals(Char2LongOpenCustomHashMap.this.key[pos], local_k)) {
          return Char2LongOpenCustomHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Char2LongOpenCustomHashMap.this.strategy.hashCode(local_k)) & Char2LongOpenCustomHashMap.this.mask; Char2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2LongOpenCustomHashMap.this.mask) {
        if (Char2LongOpenCustomHashMap.this.strategy.equals(Char2LongOpenCustomHashMap.this.key[pos], local_k))
        {
          Char2LongOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2LongMap.Entry>
  {
    ...
    public AbstractChar2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2LongOpenCustomHashMap.this.key[local_e];
      this.entry.value = Char2LongOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Char2LongOpenCustomHashMap.MapEntry(Char2LongOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2LongOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2LongOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1080 = Char2LongOpenCustomHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2LongOpenCustomHashMap.this.used;
      while ((this.field_1080 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1080 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Char2LongOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2LongOpenCustomHashMap.this.mask; Char2LongOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Char2LongOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2LongOpenCustomHashMap.this.strategy.hashCode(Char2LongOpenCustomHashMap.this.key[pos])) & Char2LongOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2LongOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2LongOpenCustomHashMap.this.key[pos]);
        }
        Char2LongOpenCustomHashMap.this.key[last] = Char2LongOpenCustomHashMap.this.key[pos];
        Char2LongOpenCustomHashMap.this.value[last] = Char2LongOpenCustomHashMap.this.value[pos];
      }
      Char2LongOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2LongOpenCustomHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2LongOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1080 > 0))
      {
        this.field_1080 += 1;
        nextEntry();
      }
    ...
    implements Char2LongMap.Entry, Map.Entry<Character, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Char2LongOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Long> local_e = (Map.Entry)local_o;
      return (Char2LongOpenCustomHashMap.this.strategy.equals(Char2LongOpenCustomHashMap.this.key[this.index], ((Character)local_e.getKey()).charValue())) && (Char2LongOpenCustomHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
