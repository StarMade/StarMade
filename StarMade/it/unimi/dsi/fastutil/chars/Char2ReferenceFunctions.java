...
public class Char2ReferenceFunctions
{
  ...
  public static <V> Char2ReferenceFunction<V> synchronize(Char2ReferenceFunction<V> local_f)
  {
    return new SynchronizedFunction(local_f);
  }
  
  public static <V> Char2ReferenceFunction<V> synchronize(Char2ReferenceFunction<V> local_f, Object sync)
  {
    return new SynchronizedFunction(local_f, sync);
  }
  
  public static <V> Char2ReferenceFunction<V> unmodifiable(Char2ReferenceFunction<V> local_f)
  {
    ...
    implements Serializable
  {
    ...
    protected UnmodifiableFunction(Char2ReferenceFunction<V> local_f)
    {
      if (local_f == null) {
    ...
    implements Serializable
  {
    ...
    protected SynchronizedFunction(Char2ReferenceFunction<V> local_f, Object sync)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
    ...
    protected SynchronizedFunction(Char2ReferenceFunction<V> local_f)
    {
      if (local_f == null) {
        throw new NullPointerException();
      }
