...
/*     */   {
/* 173 */     return new Singleton(key.charValue(), value.longValue());
/*     */   }
/*     */ 
/*     */   public static Char2LongSortedMap singleton(Character key, Long value, CharComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.charValue(), value.longValue(), comparator);
/*     */   }
/*     */ 
...
/*     */     }
/* 302 */     public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.char2LongEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Character, Long>> entrySet() {
/* 304 */       return char2LongEntrySet(); } 
...
/* 308 */     public Char2LongSortedMap headMap(char to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Char2LongSortedMap tailMap(char from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Char2LongSortedMap headMap(Character to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Char2LongSortedMap tailMap(Character from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.char2LongEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Character, Long>> entrySet() {
/* 244 */       return char2LongEntrySet(); } 
...
/* 248 */     public Char2LongSortedMap headMap(char to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Char2LongSortedMap tailMap(char from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public char firstCharKey() {
...
/* 259 */     public Char2LongSortedMap headMap(Character to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Char2LongSortedMap tailMap(Character from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Char2LongMaps.Singleton.SingletonEntry(this), Char2LongSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Character, Long>> entrySet() { return char2LongEntrySet(); } 
/*     */     public CharSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = CharSortedSets.singleton(this.key, this.comparator); return (CharSortedSet)this.keys;
/*     */     }
/*     */     public Char2LongSortedMap subMap(char from, char to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Char2LongSortedMap headMap(char to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Char2LongSortedMap tailMap(char from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Char2LongSortedMap tailMap(Character ofrom) { return tailMap(ofrom.charValue()); } 
/* 156 */     public Char2LongSortedMap subMap(Character ofrom, Character oto) { return subMap(ofrom.charValue(), oto.charValue()); } 
/*     */     public Character firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Char2LongMap.Entry> char2LongEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Character, Long>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public CharSortedSet keySet() { return CharSortedSets.EMPTY_SET; } 
/*     */     public Char2LongSortedMap subMap(char from, char to) {
/*  86 */       return Char2LongSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Char2LongSortedMap headMap(char to) { return Char2LongSortedMaps.EMPTY_MAP; } 
/*     */     public Char2LongSortedMap tailMap(char from) {
/*  90 */       return Char2LongSortedMaps.EMPTY_MAP; } 
/*  91 */     public char firstCharKey() { throw new NoSuchElementException(); } 
/*  92 */     public char lastCharKey() { throw new NoSuchElementException(); } 
/*  93 */     public Char2LongSortedMap headMap(Character oto) { return headMap(oto.charValue()); } 
/*  94 */     public Char2LongSortedMap tailMap(Character ofrom) { return tailMap(ofrom.charValue()); } 
/*  95 */     public Char2LongSortedMap subMap(Character ofrom, Character oto) { return subMap(ofrom.charValue(), oto.charValue()); } 
