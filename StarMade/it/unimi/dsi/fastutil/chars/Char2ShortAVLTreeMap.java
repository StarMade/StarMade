  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2ShortAVLTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2ShortAVLTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2ShortAVLTreeMap(Map<? extends Character, ? extends Short> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ShortAVLTreeMap(SortedMap<Character, Short> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ShortAVLTreeMap(Char2ShortMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2ShortAVLTreeMap(Char2ShortSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2ShortAVLTreeMap(char[] local_k, short[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2ShortAVLTreeMap(char[] local_k, short[] local_v)
  {
  ...
  {
    short oldValue = put(local_ok.charValue(), local_ov.shortValue());
    return this.modified ? null : Short.valueOf(oldValue);
  }
  
  public Short remove(Object local_ok)
  {
    short oldValue = remove(((Character)local_ok).charValue());
  ...
  public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Char2ShortMap.Entry> comparator = new Comparator()
        {
          public int compare(Char2ShortMap.Entry local_x, Char2ShortMap.Entry local_y)
          {
            return Char2ShortAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2ShortAVLTreeMap.EntryIterator(Char2ShortAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry from)
        {
          return new Char2ShortAVLTreeMap.EntryIterator(Char2ShortAVLTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2ShortAVLTreeMap.Entry local_f = Char2ShortAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2ShortAVLTreeMap.Entry local_f = Char2ShortAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2ShortAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry from, Char2ShortMap.Entry local_to)
        {
          return Char2ShortAVLTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ShortEntrySet();
        }
        
        public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry local_to)
        {
          return Char2ShortAVLTreeMap.this.headMap((Character)local_to.getKey()).char2ShortEntrySet();
        }
        
        public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry from)
        {
          return Char2ShortAVLTreeMap.this.tailMap((Character)from.getKey()).char2ShortEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Char2ShortAVLTreeMap.ValueIterator(Char2ShortAVLTreeMap.this, null);
        }
        
        public boolean contains(short local_k)
        {
          return Char2ShortAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2ShortAVLTreeMap local_c;
    try
    {
      local_c = (Char2ShortAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readChar(), local_s.readShort());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readChar(), local_s.readShort());
      top.right(new Entry(local_s.readChar(), local_s.readShort()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2ShortAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Char2ShortAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2ShortAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator()
          {
            return new Char2ShortAVLTreeMap.Submap.SubmapEntryIterator(Char2ShortAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry from)
          {
            return new Char2ShortAVLTreeMap.Submap.SubmapEntryIterator(Char2ShortAVLTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, Short> local_e = (Map.Entry)local_o;
            Char2ShortAVLTreeMap.Entry local_f = Char2ShortAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2ShortAVLTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, Short> local_e = (Map.Entry)local_o;
            Char2ShortAVLTreeMap.Entry local_f = Char2ShortAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2ShortAVLTreeMap.Submap.this.in2(local_f.key))) {
              Char2ShortAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2ShortAVLTreeMap.Submap.SubmapIterator(Char2ShortAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2ShortAVLTreeMap.Submap.this.clear();
          }
          
          public Char2ShortMap.Entry first()
          {
            return Char2ShortAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Char2ShortMap.Entry last()
          {
            return Char2ShortAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry from, Char2ShortMap.Entry local_to)
          {
            return Char2ShortAVLTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2ShortEntrySet();
          }
          
          public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry local_to)
          {
            return Char2ShortAVLTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2ShortEntrySet();
          }
          
          public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry from)
          {
            return Char2ShortAVLTreeMap.Submap.this.tailMap((Character)from.getKey()).char2ShortEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ShortCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractShortCollection()
        {
          public ShortIterator iterator()
          {
            return new Char2ShortAVLTreeMap.Submap.SubmapValueIterator(Char2ShortAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(short local_k)
          {
            return Char2ShortAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2ShortAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2ShortAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2ShortAVLTreeMap.Entry local_e;
      return (in2(local_kk)) && ((local_e = Char2ShortAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public short put(char local_k, short local_v)
    {
      ...
      short oldValue = Char2ShortAVLTreeMap.this.put(local_k, local_v);
    ...
    public short remove(char local_k)
    {
      ...
      short oldValue = Char2ShortAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2ShortAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2ShortAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2ShortAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2ShortSortedMap tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2ShortAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2ShortAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2ShortSortedMap subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2ShortAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2ShortAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2ShortAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2ShortAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2ShortAVLTreeMap.this.locateKey(this.from);
        if (Char2ShortAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2ShortAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2ShortAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2ShortAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2ShortAVLTreeMap.this.locateKey(this.field_47);
        if (Char2ShortAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2ShortAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2ShortAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2ShortAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      implements ObjectListIterator<Char2ShortMap.Entry>
    {
      ...
      public void set(Char2ShortMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Char2ShortMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
      ...
      extends Char2ShortAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Char2ShortAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2ShortAVLTreeMap.Submap.this.bottom) && (Char2ShortAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2ShortAVLTreeMap.Submap.this.top) && (Char2ShortAVLTreeMap.this.compare(local_k, (this.prev = Char2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2ShortAVLTreeMap.this.locateKey(local_k);
            if (Char2ShortAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2ShortAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2ShortAVLTreeMap.this.compare(this.prev.key, Char2ShortAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2ShortAVLTreeMap.Submap.this.top) && (this.next != null) && (Char2ShortAVLTreeMap.this.compare(this.next.key, Char2ShortAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2ShortSortedMap.KeySet
    {
      ...
      {
        return new Char2ShortAVLTreeMap.Submap.SubmapKeyIterator(Char2ShortAVLTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2ShortAVLTreeMap.Submap.SubmapKeyIterator(Char2ShortAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2ShortSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2ShortAVLTreeMap.KeyIterator(Char2ShortAVLTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2ShortAVLTreeMap.KeyIterator(Char2ShortAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2ShortAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Char2ShortAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Char2ShortMap.Entry
  {
    ...
    Entry(char local_k, short local_v)
    {
      this.key = local_k;
      this.value = local_v;
