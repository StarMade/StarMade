...
/*      */ 
/*      */ public class Char2ShortAVLTreeMap extends AbstractChar2ShortSortedMap
...
/*  117 */           return Char2ShortAVLTreeMap.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*      */         }
/*      */         public int compare(Character ok1, Character ok2) {
/*  120 */           return Char2ShortAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     short oldValue = put(ok.charValue(), ov.shortValue());
/*  780 */     return this.modified ? null : Short.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Short remove(Object ok)
/*      */   {
/*  788 */     short oldValue = remove(((Character)ok).charValue());
...
/* 1203 */         final Comparator<? super Char2ShortMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Char2ShortMap.Entry x, Char2ShortMap.Entry y) {
/* 1205 */             return Char2ShortAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Char2ShortAVLTreeMap.EntryIterator(Char2ShortAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry from) {
/* 1215 */           return new Char2ShortAVLTreeMap.EntryIterator(Char2ShortAVLTreeMap.this, ((Character)from.getKey()).charValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Char2ShortAVLTreeMap.Entry f = Char2ShortAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
...
/* 1228 */           Char2ShortAVLTreeMap.Entry f = Char2ShortAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1229 */           if (f != null) Char2ShortAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Char2ShortAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Char2ShortAVLTreeMap.this.clear(); } 
/* 1234 */         public Char2ShortMap.Entry first() { return Char2ShortAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Char2ShortMap.Entry last() { return Char2ShortAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry from, Char2ShortMap.Entry to) { return Char2ShortAVLTreeMap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2ShortEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry to) { return Char2ShortAVLTreeMap.this.headMap((Character)to.getKey()).char2ShortEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry from) { return Char2ShortAVLTreeMap.this.tailMap((Character)from.getKey()).char2ShortEntrySet(); }
/*      */       };
...
/* 1304 */           return new Char2ShortAVLTreeMap.ValueIterator(Char2ShortAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(short k) {
/* 1307 */           return Char2ShortAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Char2ShortAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Char2ShortAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Char2ShortAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readChar(), s.readShort());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readChar(), s.readShort());
/* 1759 */       top.right(new Entry(s.readChar(), s.readShort()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Char2ShortAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Char2ShortAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Char2ShortAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Char2ShortAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Char2ShortMap.Entry> char2ShortEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator() {
/* 1391 */             return new Char2ShortAVLTreeMap.Submap.SubmapEntryIterator(Char2ShortAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Char2ShortMap.Entry> iterator(Char2ShortMap.Entry from) {
/* 1394 */             return new Char2ShortAVLTreeMap.Submap.SubmapEntryIterator(Char2ShortAVLTreeMap.Submap.this, ((Character)from.getKey()).charValue());
/*      */           }
/* 1396 */           public Comparator<? super Char2ShortMap.Entry> comparator() { return Char2ShortAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Char2ShortAVLTreeMap.Entry f = Char2ShortAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1402 */             return (f != null) && (Char2ShortAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Char2ShortAVLTreeMap.Entry f = Char2ShortAVLTreeMap.this.findKey(((Character)e.getKey()).charValue());
/* 1409 */             if ((f != null) && (Char2ShortAVLTreeMap.Submap.this.in(f.key))) Char2ShortAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Char2ShortAVLTreeMap.Submap.SubmapIterator(Char2ShortAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Char2ShortAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Char2ShortMap.Entry first() { return Char2ShortAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Char2ShortMap.Entry last() { return Char2ShortAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Char2ShortMap.Entry> subSet(Char2ShortMap.Entry from, Char2ShortMap.Entry to) { return Char2ShortAVLTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)to.getKey()).char2ShortEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Char2ShortMap.Entry> headSet(Char2ShortMap.Entry to) { return Char2ShortAVLTreeMap.Submap.this.headMap((Character)to.getKey()).char2ShortEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Char2ShortMap.Entry> tailSet(Char2ShortMap.Entry from) { return Char2ShortAVLTreeMap.Submap.this.tailMap((Character)from.getKey()).char2ShortEntrySet(); }
/*      */         };
...
/*      */           public ShortIterator iterator() {
/* 1442 */             return new Char2ShortAVLTreeMap.Submap.SubmapValueIterator(Char2ShortAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(short k) {
/* 1445 */             return Char2ShortAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Char2ShortAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Char2ShortAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(char k) {
/* 1458 */       return (in(k)) && (Char2ShortAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(short v) {
...
/* 1473 */       return (in(kk)) && ((e = Char2ShortAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public short put(char k, short v) {
/* 1476 */       Char2ShortAVLTreeMap.this.modified = false;
...
/* 1478 */       short oldValue = Char2ShortAVLTreeMap.this.put(k, v);
/* 1479 */       return Char2ShortAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Short put(Character ok, Short ov) {
/* 1482 */       short oldValue = put(ok.charValue(), ov.shortValue());
/* 1483 */       return Char2ShortAVLTreeMap.this.modified ? null : Short.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public short remove(char k) {
/* 1487 */       Char2ShortAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       short oldValue = Char2ShortAVLTreeMap.this.remove(k);
/* 1490 */       return Char2ShortAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Short remove(Object ok) {
/* 1493 */       short oldValue = remove(((Character)ok).charValue());
/* 1494 */       return Char2ShortAVLTreeMap.this.modified ? Short.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public CharComparator comparator() {
/* 1509 */       return Char2ShortAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Char2ShortSortedMap headMap(char to) {
/* 1512 */       if (this.top) return new Submap(Char2ShortAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Char2ShortAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Char2ShortAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Char2ShortSortedMap tailMap(char from) {
/* 1516 */       if (this.bottom) return new Submap(Char2ShortAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Char2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2ShortAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Char2ShortSortedMap subMap(char from, char to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Char2ShortAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Char2ShortAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Char2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Char2ShortAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Char2ShortAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Char2ShortAVLTreeMap.this.tree == null) return null;
/* 1534 */       Char2ShortAVLTreeMap.Entry e;
/*      */       Char2ShortAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Char2ShortAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Char2ShortAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Char2ShortAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Char2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Char2ShortAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Char2ShortAVLTreeMap.this.tree == null) return null;
/* 1552 */       Char2ShortAVLTreeMap.Entry e;
/*      */       Char2ShortAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Char2ShortAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Char2ShortAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Char2ShortAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Char2ShortAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public char firstCharKey() {
/* 1563 */       Char2ShortAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public char lastCharKey() {
/* 1568 */       Char2ShortAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Character firstKey() {
/* 1573 */       Char2ShortAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Character lastKey() {
/* 1578 */       Char2ShortAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Char2ShortAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Char2ShortAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Char2ShortAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Char2ShortMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Char2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Char2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Char2ShortAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(char k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Char2ShortAVLTreeMap.Submap.this.bottom) && (Char2ShortAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Char2ShortAVLTreeMap.Submap.this.top) && (Char2ShortAVLTreeMap.this.compare(k, (this.prev = Char2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Char2ShortAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Char2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Char2ShortAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2ShortAVLTreeMap.this.compare(this.prev.key, Char2ShortAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Char2ShortAVLTreeMap.Submap.this.top) && (this.next != null) && (Char2ShortAVLTreeMap.this.compare(this.next.key, Char2ShortAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public CharBidirectionalIterator iterator() { return new Char2ShortAVLTreeMap.Submap.SubmapKeyIterator(Char2ShortAVLTreeMap.Submap.this); } 
/* 1433 */       public CharBidirectionalIterator iterator(char from) { return new Char2ShortAVLTreeMap.Submap.SubmapKeyIterator(Char2ShortAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Char2ShortAVLTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public CharBidirectionalIterator iterator() { return new Char2ShortAVLTreeMap.KeyIterator(Char2ShortAVLTreeMap.this); } 
/* 1263 */     public CharBidirectionalIterator iterator(char from) { return new Char2ShortAVLTreeMap.KeyIterator(Char2ShortAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Char2ShortAVLTreeMap.TreeIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Char2ShortAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Char2ShortMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Char2ShortMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Char2ShortMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Char2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Char2ShortAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(char k) {
/* 1129 */       if ((this.next = Char2ShortAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Char2ShortAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Char2ShortAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Character)e.getKey()).charValue()) && (this.value == ((Short)e.getValue()).shortValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
