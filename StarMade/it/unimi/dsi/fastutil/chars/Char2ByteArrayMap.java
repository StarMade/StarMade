...
/*  17:    */
/*  66:    */public class Char2ByteArrayMap
/*  67:    */  extends AbstractChar2ByteMap
...
/*  73:    */  private int size;
/*  74:    */  
/*  75:    */  public Char2ByteArrayMap(char[] key, byte[] value)
/*  76:    */  {
/*  77: 77 */    this.key = key;
...
/*  81:    */  }
/*  82:    */  
/*  83:    */  public Char2ByteArrayMap()
/*  84:    */  {
/*  85: 85 */    this.key = CharArrays.EMPTY_ARRAY;
/*  86: 86 */    this.value = ByteArrays.EMPTY_ARRAY;
/*  87:    */  }
/*  88:    */  
/*  91:    */  public Char2ByteArrayMap(int capacity)
/*  92:    */  {
/*  93: 93 */    this.key = new char[capacity];
/*  94: 94 */    this.value = new byte[capacity];
/*  95:    */  }
/*  96:    */  
/*  99:    */  public Char2ByteArrayMap(Char2ByteMap m)
/* 100:    */  {
/* 101:101 */    this(m.size());
/* 102:102 */    putAll(m);
/* 103:    */  }
/* 104:    */  
/* 107:    */  public Char2ByteArrayMap(Map<? extends Character, ? extends Byte> m)
/* 108:    */  {
/* 109:109 */    this(m.size());
/* 110:110 */    putAll(m);
/* 111:    */  }
/* 112:    */  
/* 119:    */  public Char2ByteArrayMap(char[] key, byte[] value, int size)
/* 120:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 128:    */  private final class EntrySet extends AbstractObjectSet<Char2ByteMap.Entry> implements Char2ByteMap.FastEntrySet { private EntrySet() {}
/* 129:    */    
/* 130:130 */    public ObjectIterator<Char2ByteMap.Entry> iterator() { new AbstractObjectIterator() {
/* 131:131 */        int next = 0;
/* 132:    */        
/* 133:133 */        public boolean hasNext() { return this.next < Char2ByteArrayMap.this.size; }
/* 134:    */        
/* 135:    */        public Char2ByteMap.Entry next()
/* 136:    */        {
/* 137:137 */          if (!hasNext()) throw new NoSuchElementException();
/* 138:138 */          return new AbstractChar2ByteMap.BasicEntry(Char2ByteArrayMap.this.key[this.next], Char2ByteArrayMap.this.value[(this.next++)]);
/* 139:    */        }
/* 140:    */      }; }
/* 141:    */    
/* 142:    */    public ObjectIterator<Char2ByteMap.Entry> fastIterator() {
/* 143:143 */      new AbstractObjectIterator() {
/* 144:144 */        int next = 0;
/* 145:145 */        final AbstractChar2ByteMap.BasicEntry entry = new AbstractChar2ByteMap.BasicEntry('\000', (byte)0);
/* 146:    */        
/* 147:147 */        public boolean hasNext() { return this.next < Char2ByteArrayMap.this.size; }
/* 148:    */        
/* 149:    */        public Char2ByteMap.Entry next()
/* 150:    */        {
/* 151:151 */          if (!hasNext()) throw new NoSuchElementException();
/* 152:152 */          this.entry.key = Char2ByteArrayMap.this.key[this.next];
/* 153:153 */          this.entry.value = Char2ByteArrayMap.this.value[(this.next++)];
/* 154:154 */          return this.entry;
/* 155:    */        }
/* 156:    */      };
/* 157:    */    }
/* 158:    */    
/* 159:159 */    public int size() { return Char2ByteArrayMap.this.size; }
/* 160:    */    
/* 161:    */    public boolean contains(Object o)
/* 162:    */    {
/* 163:163 */      if (!(o instanceof Map.Entry)) return false;
/* 164:164 */      Map.Entry<Character, Byte> e = (Map.Entry)o;
/* 165:165 */      char k = ((Character)e.getKey()).charValue();
/* 166:166 */      return (Char2ByteArrayMap.this.containsKey(k)) && (Char2ByteArrayMap.this.get(k) == ((Byte)e.getValue()).byteValue());
/* 167:    */    }
/* 168:    */  }
/* 169:    */  
/* 170:170 */  public Char2ByteMap.FastEntrySet char2ByteEntrySet() { return new EntrySet(null); }
/* 171:    */  
...
/* 210:    */  }
/* 211:    */  
/* 212:    */  public byte put(char k, byte v)
/* 213:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 262:    */  public Char2ByteArrayMap clone()
/* 263:    */  {
/* 264:    */    Char2ByteArrayMap c;
/* 265:    */    
/* 267:    */    try
/* 268:    */    {
/* 269:269 */      c = (Char2ByteArrayMap)super.clone();
/* 270:    */    }
