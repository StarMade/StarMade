...
/*      */ 
/*      */ public class CharRBTreeSet extends AbstractCharSortedSet
...
/*   97 */           return CharRBTreeSet.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*      */         }
/*      */         public int compare(Character ok1, Character ok2) {
/*  100 */           return CharRBTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   public CharRBTreeSet(Iterator<? extends Character> i)
/*      */   {
...
/* 1028 */     return new Subset('\000', true, to, false);
/*      */   }
/*      */   public CharSortedSet tailSet(char from) {
/* 1031 */     return new Subset(from, false, '\000', true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1226 */       c = (CharRBTreeSet)super.clone();
/*      */     }
...
/* 1279 */     while (n-- != 0) s.writeChar(i.nextChar());
/*      */   }
/*      */ 
...
/*      */   {
/* 1290 */     if (n == 1) {
/* 1291 */       Entry top = new Entry(s.readChar());
/* 1292 */       top.pred(pred);
/* 1293 */       top.succ(succ);
/* 1294 */       top.black(true);
/* 1295 */       return top;
...
/* 1297 */     if (n == 2)
/*      */     {
/* 1300 */       Entry top = new Entry(s.readChar());
/* 1301 */       top.black(true);
/* 1302 */       top.right(new Entry(s.readChar()));
...
/*      */     {
/* 1063 */       if ((!bottom) && (!top) && (CharRBTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1064 */       this.from = from;
...
/*      */     {
/* 1081 */       return ((this.bottom) || (CharRBTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (CharRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(char k)
/*      */     {
/* 1086 */       return (in(k)) && (CharRBTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(char k) {
...
/* 1090 */       return CharRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(char k) {
/* 1094 */       if (!in(k)) return false;
/* 1095 */       return CharRBTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public CharComparator comparator() {
/* 1110 */       return CharRBTreeSet.this.actualComparator;
/*      */     }
/*      */     public CharBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public CharSortedSet headSet(char to) {
/* 1119 */       if (this.top) return new Subset(CharRBTreeSet.this, this.from, this.bottom, to, false);
/* 1120 */       return CharRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(CharRBTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public CharSortedSet tailSet(char from) {
/* 1123 */       if (this.bottom) return new Subset(CharRBTreeSet.this, from, false, this.to, this.top);
/* 1124 */       return CharRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(CharRBTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public CharSortedSet subSet(char from, char to) {
/* 1127 */       if ((this.top) && (this.bottom)) return new Subset(CharRBTreeSet.this, from, false, to, false);
...
/* 1131 */       return new Subset(CharRBTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public CharRBTreeSet.Entry firstEntry()
/*      */     {
/* 1138 */       if (CharRBTreeSet.this.tree == null) return null;
/* 1141 */       CharRBTreeSet.Entry e;
/*      */       CharRBTreeSet.Entry e;
/* 1141 */       if (this.bottom) { e = CharRBTreeSet.this.firstEntry;
/*      */       } else {
/* 1143 */         e = CharRBTreeSet.this.locateKey(this.from);
/*      */ 
/* 1145 */         if (CharRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1148 */       if ((e == null) || ((!this.top) && (CharRBTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1149 */       return e;
/*      */     }
/*      */ 
/*      */     public CharRBTreeSet.Entry lastEntry()
/*      */     {
/* 1156 */       if (CharRBTreeSet.this.tree == null) return null;
/* 1159 */       CharRBTreeSet.Entry e;
/*      */       CharRBTreeSet.Entry e;
/* 1159 */       if (this.top) { e = CharRBTreeSet.this.lastEntry;
/*      */       } else {
/* 1161 */         e = CharRBTreeSet.this.locateKey(this.to);
/*      */ 
/* 1163 */         if (CharRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1166 */       if ((e == null) || ((!this.bottom) && (CharRBTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1167 */       return e;
/*      */     }
/*      */     public char firstChar() {
/* 1170 */       CharRBTreeSet.Entry e = firstEntry();
/* 1171 */       if (e == null) throw new NoSuchElementException();
/* 1172 */       return e.key;
/*      */     }
/*      */     public char lastChar() {
/* 1175 */       CharRBTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1187 */         super();
/* 1188 */         this.next = CharRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(char k) {
/* 1191 */         this();
/* 1192 */         if (this.next != null)
/* 1193 */           if ((!CharRBTreeSet.Subset.this.bottom) && (CharRBTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1194 */           } else if ((!CharRBTreeSet.Subset.this.top) && (CharRBTreeSet.this.compare(k, (this.prev = CharRBTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1196 */             this.next = CharRBTreeSet.this.locateKey(k);
/* 1197 */             if (CharRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1207 */         if ((!CharRBTreeSet.Subset.this.bottom) && (this.prev != null) && (CharRBTreeSet.this.compare(this.prev.key, CharRBTreeSet.Subset.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1210 */         this.next = this.next.next();
/* 1211 */         if ((!CharRBTreeSet.Subset.this.top) && (this.next != null) && (CharRBTreeSet.this.compare(this.next.key, CharRBTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*  963 */     int index = 0;
/*      */ 
/*  965 */     SetIterator() { this.next = CharRBTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(char k) {
/*  968 */       if ((this.next = CharRBTreeSet.this.locateKey(k)) != null)
/*  969 */         if (CharRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/*  988 */     public char nextChar() { return nextEntry().key; } 
/*  989 */     public char previousChar() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1012 */       updatePrevious();
/* 1013 */       updateNext();
/* 1014 */       CharRBTreeSet.this.remove(this.curr.key);
/* 1015 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
