...
/*   12:     */
/*   57:     */public class CharRBTreeSet
/*   58:     */  extends AbstractCharSortedSet
/*   59:     */  implements Serializable, Cloneable, CharSortedSet
/*   60:     */{
...
/*   65:     */  protected Comparator<? super Character> storedComparator;
/*   66:     */  protected transient CharComparator actualComparator;
...
/*   97:  97 */          return CharRBTreeSet.this.storedComparator.compare(Character.valueOf(k1), Character.valueOf(k2));
/*   98:     */        }
/*   99:     */        
/*  100: 100 */        public int compare(Character ok1, Character ok2) { return CharRBTreeSet.this.storedComparator.compare(ok1, ok2); }
/*  101:     */      };
/*  102:     */    }
/*  103:     */  }
/*  104:     */  
/*  107:     */  public CharRBTreeSet(Comparator<? super Character> c)
/*  108:     */  {
/*  109: 109 */    this();
...
/*  112:     */  }
/*  113:     */  
/*  117:     */  public CharRBTreeSet(Collection<? extends Character> c)
/*  118:     */  {
/*  119: 119 */    this();
/*  120: 120 */    addAll(c);
/*  121:     */  }
/*  122:     */  
/*  127:     */  public CharRBTreeSet(SortedSet<Character> s)
/*  128:     */  {
/*  129: 129 */    this(s.comparator());
/*  130: 130 */    addAll(s);
/*  131:     */  }
/*  132:     */  
/*  137:     */  public CharRBTreeSet(CharCollection c)
/*  138:     */  {
/*  139: 139 */    this();
/*  140: 140 */    addAll(c);
/*  141:     */  }
/*  142:     */  
/*  147:     */  public CharRBTreeSet(CharSortedSet s)
/*  148:     */  {
/*  149: 149 */    this(s.comparator());
/*  150: 150 */    addAll(s);
/*  151:     */  }
/*  152:     */  
/*  153:     */  public CharRBTreeSet(CharIterator i)
/*  154:     */  {
...
/*  243:     */  }
/*  244:     */  
/*  250:     */  public CharRBTreeSet(Iterator<? extends Character> i)
/*  251:     */  {
/*  252: 171 */    this(CharIterators.asCharIterator(i));
/*  253:     */  }
/*  254:     */  
/*  263:     */  public CharRBTreeSet(char[] a, int offset, int length, Comparator<? super Character> c)
/*  264:     */  {
/*  265: 184 */    this(c);
...
/*  269:     */  }
/*  270:     */  
/*  277:     */  public CharRBTreeSet(char[] a, int offset, int length)
/*  278:     */  {
/*  279: 198 */    this(a, offset, length, null);
/*  280:     */  }
/*  281:     */  
/*  287:     */  public CharRBTreeSet(char[] a)
/*  288:     */  {
/*  289: 208 */    this();
...
/*  293:     */  }
/*  294:     */  
/*  300:     */  public CharRBTreeSet(char[] a, Comparator<? super Character> c)
/*  301:     */  {
/*  302: 221 */    this(c);
...
/*  551:     */  }
/*  552:     */  
/*  554:     */  public boolean remove(char k)
/*  555:     */  {
...
/*  820:     */  }
/*  821:     */  
/*  824: 743 */  public boolean contains(char k) { return findKey(k) != null; }
/*  825:     */  
...
/* 1023:     */  
/* 1024:     */  public char firstChar() {
/* 1025: 944 */    if (this.tree == null) throw new NoSuchElementException();
/* 1026: 945 */    return this.firstEntry.key;
/* 1027:     */  }
/* 1028:     */  
/* 1029: 948 */  public char lastChar() { if (this.tree == null) throw new NoSuchElementException();
/* 1030: 949 */    return this.lastEntry.key;
/* 1031:     */  }
/* 1032:     */  
/* 1035:     */  private class SetIterator
/* 1036:     */    extends AbstractCharListIterator
/* 1037:     */  {
/* 1038:     */    CharRBTreeSet.Entry prev;
/* 1039:     */    
/* 1040:     */    CharRBTreeSet.Entry next;
/* 1041:     */    
/* 1042:     */    CharRBTreeSet.Entry curr;
/* 1043:     */    
/* 1044: 963 */    int index = 0;
/* 1045:     */    
/* 1046: 965 */    SetIterator() { this.next = CharRBTreeSet.this.firstEntry; }
/* 1047:     */    
/* 1048:     */    SetIterator(char k) {
/* 1049: 968 */      if ((this.next = CharRBTreeSet.this.locateKey(k)) != null)
/* 1050: 969 */        if (CharRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1061:     */    
/* 1062:     */    CharRBTreeSet.Entry nextEntry() {
...
/* 1068:     */    
/* 1069: 988 */    public char nextChar() { return nextEntry().key; }
/* 1070: 989 */    public char previousChar() { return previousEntry().key; }
/* 1071:     */    
/* 1072: 991 */    void updatePrevious() { this.prev = this.prev.prev(); }
/* 1073:     */    
/* 1074:     */    CharRBTreeSet.Entry previousEntry() {
...
/* 1095:1014 */      CharRBTreeSet.this.remove(this.curr.key);
/* 1096:1015 */      this.curr = null;
/* 1097:     */    }
/* 1098:     */  }
/* 1099:     */  
/* 1100:1019 */  public CharBidirectionalIterator iterator() { return new SetIterator(); }
/* 1101:     */  
/* 1102:     */  public CharBidirectionalIterator iterator(char from) {
/* 1103:1022 */    return new SetIterator(from);
/* 1104:     */  }
/* 1105:     */  
/* 1106:1025 */  public CharComparator comparator() { return this.actualComparator; }
/* 1107:     */  
/* 1108:     */  public CharSortedSet headSet(char to) {
/* 1109:1028 */    return new Subset('\000', true, to, false);
/* 1110:     */  }
/* 1111:     */  
/* 1112:1031 */  public CharSortedSet tailSet(char from) { return new Subset(from, false, '\000', true); }
/* 1113:     */  
/* 1114:     */  public CharSortedSet subSet(char from, char to) {
/* 1115:1034 */    return new Subset(from, false, to, false);
/* 1116:     */  }
/* 1117:     */  
/* 1121:     */  private final class Subset
/* 1122:     */    extends AbstractCharSortedSet
/* 1123:     */    implements Serializable, CharSortedSet
/* 1124:     */  {
...
/* 1138:     */    boolean top;
/* 1139:     */    
/* 1142:     */    public Subset(char from, boolean bottom, char to, boolean top)
/* 1143:     */    {
/* 1144:1063 */      if ((!bottom) && (!top) && (CharRBTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
...
/* 1156:     */    }
/* 1157:     */    
/* 1160:     */    final boolean in(char k)
/* 1161:     */    {
/* 1162:1081 */      return ((this.bottom) || (CharRBTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (CharRBTreeSet.this.compare(k, this.to) < 0));
/* 1163:     */    }
/* 1164:     */    
/* 1167:1086 */    public boolean contains(char k) { return (in(k)) && (CharRBTreeSet.this.contains(k)); }
/* 1168:     */    
/* 1169:     */    public boolean add(char k) {
...
/* 1171:1090 */      return CharRBTreeSet.this.add(k);
/* 1172:     */    }
/* 1173:     */    
/* 1174:     */    public boolean remove(char k) {
/* 1175:1094 */      if (!in(k)) return false;
/* 1176:1095 */      return CharRBTreeSet.this.remove(k);
/* 1177:     */    }
/* 1178:     */    
...
/* 1189:     */    
/* 1190:     */    public CharComparator comparator() {
/* 1191:1110 */      return CharRBTreeSet.this.actualComparator;
/* 1192:     */    }
/* 1193:     */    
/* 1194:1113 */    public CharBidirectionalIterator iterator() { return new SubsetIterator(); }
/* 1195:     */    
/* 1197:1116 */    public CharBidirectionalIterator iterator(char from) { return new SubsetIterator(from); }
/* 1198:     */    
/* 1199:     */    public CharSortedSet headSet(char to) {
/* 1200:1119 */      if (this.top) return new Subset(CharRBTreeSet.this, this.from, this.bottom, to, false);
/* 1201:1120 */      return CharRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(CharRBTreeSet.this, this.from, this.bottom, to, false) : this;
/* 1202:     */    }
/* 1203:     */    
/* 1204:1123 */    public CharSortedSet tailSet(char from) { if (this.bottom) return new Subset(CharRBTreeSet.this, from, false, this.to, this.top);
/* 1205:1124 */      return CharRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(CharRBTreeSet.this, from, false, this.to, this.top) : this;
/* 1206:     */    }
/* 1207:     */    
/* 1208:1127 */    public CharSortedSet subSet(char from, char to) { if ((this.top) && (this.bottom)) return new Subset(CharRBTreeSet.this, from, false, to, false);
/* 1209:1128 */      if (!this.top) to = CharRBTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1210:1129 */      if (!this.bottom) from = CharRBTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1211:1130 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1212:1131 */      return new Subset(CharRBTreeSet.this, from, false, to, false);
/* 1213:     */    }
/* 1214:     */    
/* 1217:     */    public CharRBTreeSet.Entry firstEntry()
/* 1218:     */    {
/* 1219:1138 */      if (CharRBTreeSet.this.tree == null) return null;
/* 1220:     */      CharRBTreeSet.Entry e;
/* 1221:     */      CharRBTreeSet.Entry e;
/* 1222:1141 */      if (this.bottom) { e = CharRBTreeSet.this.firstEntry;
/* 1223:     */      } else {
/* 1224:1143 */        e = CharRBTreeSet.this.locateKey(this.from);
/* 1225:     */        
/* 1226:1145 */        if (CharRBTreeSet.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1227:     */        }
/* 1228:     */      }
/* 1229:1148 */      if ((e == null) || ((!this.top) && (CharRBTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1230:1149 */      return e;
/* 1231:     */    }
/* 1232:     */    
/* 1235:     */    public CharRBTreeSet.Entry lastEntry()
/* 1236:     */    {
/* 1237:1156 */      if (CharRBTreeSet.this.tree == null) return null;
/* 1238:     */      CharRBTreeSet.Entry e;
/* 1239:     */      CharRBTreeSet.Entry e;
/* 1240:1159 */      if (this.top) { e = CharRBTreeSet.this.lastEntry;
/* 1241:     */      } else {
/* 1242:1161 */        e = CharRBTreeSet.this.locateKey(this.to);
/* 1243:     */        
/* 1244:1163 */        if (CharRBTreeSet.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1245:     */        }
/* 1246:     */      }
/* 1247:1166 */      if ((e == null) || ((!this.bottom) && (CharRBTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1248:1167 */      return e;
/* 1249:     */    }
/* 1250:     */    
/* 1251:1170 */    public char firstChar() { CharRBTreeSet.Entry e = firstEntry();
/* 1252:1171 */      if (e == null) throw new NoSuchElementException();
/* 1253:1172 */      return e.key;
/* 1254:     */    }
/* 1255:     */    
/* 1256:1175 */    public char lastChar() { CharRBTreeSet.Entry e = lastEntry();
/* 1257:1176 */      if (e == null) throw new NoSuchElementException();
/* 1258:1177 */      return e.key;
/* 1259:     */    }
/* 1260:     */    
/* 1263:     */    private final class SubsetIterator
/* 1264:     */      extends CharRBTreeSet.SetIterator
/* 1265:     */    {
/* 1266:     */      SubsetIterator()
/* 1267:     */      {
/* 1268:1187 */        super();
/* 1269:1188 */        this.next = CharRBTreeSet.Subset.this.firstEntry();
/* 1270:     */      }
/* 1271:     */      
/* 1272:1191 */      SubsetIterator(char k) { this();
/* 1273:1192 */        if (this.next != null)
/* 1274:1193 */          if ((!CharRBTreeSet.Subset.this.bottom) && (CharRBTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1275:1194 */          } else if ((!CharRBTreeSet.Subset.this.top) && (CharRBTreeSet.this.compare(k, (this.prev = CharRBTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1276:     */          } else {
/* 1277:1196 */            this.next = CharRBTreeSet.this.locateKey(k);
/* 1278:1197 */            if (CharRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1288:1207 */        if ((!CharRBTreeSet.Subset.this.bottom) && (this.prev != null) && (CharRBTreeSet.this.compare(this.prev.key, CharRBTreeSet.Subset.this.from) < 0)) this.prev = null;
/* 1289:     */      }
/* 1290:     */      
/* 1291:1210 */      void updateNext() { this.next = this.next.next();
/* 1292:1211 */        if ((!CharRBTreeSet.Subset.this.top) && (this.next != null) && (CharRBTreeSet.this.compare(this.next.key, CharRBTreeSet.Subset.this.to) >= 0)) { this.next = null;
/* 1293:     */        }
/* 1294:     */      }
/* 1295:     */    }
/* 1296:     */  }
...
/* 1301:     */  {
/* 1302:     */    CharRBTreeSet c;
/* 1303:     */    
/* 1305:     */    try
/* 1306:     */    {
/* 1307:1226 */      c = (CharRBTreeSet)super.clone();
/* 1308:     */    }
...
/* 1360:1279 */    while (n-- != 0) { s.writeChar(i.nextChar());
/* 1361:     */    }
/* 1362:     */  }
/* 1363:     */  
...
/* 1370:     */  {
/* 1371:1290 */    if (n == 1) {
/* 1372:1291 */      Entry top = new Entry(s.readChar());
...
/* 1378:1297 */    if (n == 2)
/* 1379:     */    {
/* 1381:1300 */      Entry top = new Entry(s.readChar());
/* 1382:1301 */      top.black(true);
/* 1383:1302 */      top.right(new Entry(s.readChar()));
