...
/*   4:    */
/*  63:    */public class CharIndirectHeaps
/*  64:    */{
/*  65:    */  public static int downHeap(char[] refArray, int[] heap, int[] inv, int size, int i, CharComparator c)
/*  66:    */  {
/*  67: 67 */    if (i >= size) throw new IllegalArgumentException("Heap position (" + i + ") is larger than or equal to heap size (" + size + ")");
/*  68: 68 */    int e = heap[i];
/*  69: 69 */    char E = refArray[e];
/*  70:    */    
...
/*  90:    */  }
/*  91:    */  
/* 103:    */  public static int upHeap(char[] refArray, int[] heap, int[] inv, int size, int i, CharComparator c)
/* 104:    */  {
...
/* 126:    */  }
/* 127:    */  
/* 135:    */  public static void makeHeap(char[] refArray, int offset, int length, int[] heap, int[] inv, CharComparator c)
/* 136:    */  {
/* 137:137 */    CharArrays.ensureOffsetLength(refArray, offset, length);
