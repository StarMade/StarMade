  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Char2ShortOpenHashMap(int expected, float local_f)
  {
  ...
  public Char2ShortOpenHashMap(Map<? extends Character, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ShortOpenHashMap(Map<? extends Character, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ShortOpenHashMap(Char2ShortMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Char2ShortOpenHashMap(Char2ShortMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Char2ShortOpenHashMap(char[] local_k, short[] local_v, float local_f)
  {
  ...
  public Char2ShortOpenHashMap(char[] local_k, short[] local_v)
  {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Char2ShortOpenHashMap.ValueIterator(Char2ShortOpenHashMap.this);
        }
        ...
        {
          return Char2ShortOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Char2ShortOpenHashMap local_c;
    try
    {
      local_c = (Char2ShortOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Char2ShortOpenHashMap.MapIterator
    implements ShortIterator
  {
    ...
    public Short next()
    {
      return Short.valueOf(Char2ShortOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractCharSet
  {
    ...
    {
      return new Char2ShortOpenHashMap.KeyIterator(Char2ShortOpenHashMap.this);
    }
    ...
    {
      return Char2ShortOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(char local_k)
    {
      int oldSize = Char2ShortOpenHashMap.this.size;
      Char2ShortOpenHashMap.this.remove(local_k);
    ...
    implements CharIterator
  {
    ...
    {
      return Character.valueOf(Char2ShortOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Char2ShortMap.FastEntrySet
  {
    ...
    {
      return new Char2ShortOpenHashMap.EntryIterator(Char2ShortOpenHashMap.this, null);
    }
    
    public ObjectIterator<Char2ShortMap.Entry> fastIterator()
    {
      return new Char2ShortOpenHashMap.FastEntryIterator(Char2ShortOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ShortOpenHashMap.this.mask; Char2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ShortOpenHashMap.this.mask) {
        if (Char2ShortOpenHashMap.this.key[pos] == local_k) {
          return Char2ShortOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Char2ShortOpenHashMap.this.mask; Char2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ShortOpenHashMap.this.mask) {
        if (Char2ShortOpenHashMap.this.key[pos] == local_k)
        {
          Char2ShortOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Char2ShortMap.Entry>
  {
    ...
    public AbstractChar2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Char2ShortOpenHashMap.this.key[local_e];
      this.entry.value = Char2ShortOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Char2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Char2ShortOpenHashMap.MapEntry(Char2ShortOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Char2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Char2ShortOpenHashMap.this.field_49;
    int last = -1;
    int field_2132 = Char2ShortOpenHashMap.this.size;
    CharArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Char2ShortOpenHashMap.this.used;
      while ((this.field_2132 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2132 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2132 != 0)
      {
        boolean[] local_k = Char2ShortOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Char2ShortOpenHashMap.this.mask; Char2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Char2ShortOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Char2ShortOpenHashMap.this.key[pos]) & Char2ShortOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Char2ShortOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Char2ShortOpenHashMap.this.key[pos]);
        }
        Char2ShortOpenHashMap.this.key[last] = Char2ShortOpenHashMap.this.key[pos];
        Char2ShortOpenHashMap.this.value[last] = Char2ShortOpenHashMap.this.value[pos];
      }
      Char2ShortOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Char2ShortOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
        this.last = -1;
        return;
      }
      Char2ShortOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2132 > 0))
      {
        this.field_2132 += 1;
        nextEntry();
      }
    ...
    implements Char2ShortMap.Entry, Map.Entry<Character, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Char2ShortOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Character, Short> local_e = (Map.Entry)local_o;
      return (Char2ShortOpenHashMap.this.key[this.index] == ((Character)local_e.getKey()).charValue()) && (Char2ShortOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
