  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof CharComparator))) {
      ...
      this.actualComparator = new CharComparator()
      {
        ...
        {
          return Char2CharAVLTreeMap.this.storedComparator.compare(Character.valueOf(local_k1), Character.valueOf(local_k2));
        }
  ...
  public Char2CharAVLTreeMap(Comparator<? super Character> local_c)
  {
    this();
  ...
  public Char2CharAVLTreeMap(Map<? extends Character, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2CharAVLTreeMap(SortedMap<Character, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2CharAVLTreeMap(Char2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Char2CharAVLTreeMap(Char2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Char2CharAVLTreeMap(char[] local_k, char[] local_v, Comparator<? super Character> local_c)
  {
    this(local_c);
  ...
  public Char2CharAVLTreeMap(char[] local_k, char[] local_v)
  {
  ...
  {
    char oldValue = put(local_ok.charValue(), local_ov.charValue());
    return this.modified ? null : Character.valueOf(oldValue);
  }
  
  public Character remove(Object local_ok)
  {
    char oldValue = remove(((Character)local_ok).charValue());
  ...
  public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Char2CharMap.Entry> comparator = new Comparator()
        {
          public int compare(Char2CharMap.Entry local_x, Char2CharMap.Entry local_y)
          {
            return Char2CharAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Char2CharAVLTreeMap.EntryIterator(Char2CharAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry from)
        {
          return new Char2CharAVLTreeMap.EntryIterator(Char2CharAVLTreeMap.this, ((Character)from.getKey()).charValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Char2CharAVLTreeMap.Entry local_f = Char2CharAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Char2CharAVLTreeMap.Entry local_f = Char2CharAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
          if (local_f != null) {
            Char2CharAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry from, Char2CharMap.Entry local_to)
        {
          return Char2CharAVLTreeMap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2CharEntrySet();
        }
        
        public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry local_to)
        {
          return Char2CharAVLTreeMap.this.headMap((Character)local_to.getKey()).char2CharEntrySet();
        }
        
        public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry from)
        {
          return Char2CharAVLTreeMap.this.tailMap((Character)from.getKey()).char2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Char2CharAVLTreeMap.ValueIterator(Char2CharAVLTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Char2CharAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Char2CharAVLTreeMap local_c;
    try
    {
      local_c = (Char2CharAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readChar(), local_s.readChar());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readChar(), local_s.readChar());
      top.right(new Entry(local_s.readChar(), local_s.readChar()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Char2CharAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Char2CharAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Char2CharAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Char2CharMap.Entry> char2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator()
          {
            return new Char2CharAVLTreeMap.Submap.SubmapEntryIterator(Char2CharAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Char2CharMap.Entry> iterator(Char2CharMap.Entry from)
          {
            return new Char2CharAVLTreeMap.Submap.SubmapEntryIterator(Char2CharAVLTreeMap.Submap.this, ((Character)from.getKey()).charValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Character, Character> local_e = (Map.Entry)local_o;
            Char2CharAVLTreeMap.Entry local_f = Char2CharAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            return (local_f != null) && (Char2CharAVLTreeMap.Submap.this.in2(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Character, Character> local_e = (Map.Entry)local_o;
            Char2CharAVLTreeMap.Entry local_f = Char2CharAVLTreeMap.this.findKey(((Character)local_e.getKey()).charValue());
            if ((local_f != null) && (Char2CharAVLTreeMap.Submap.this.in2(local_f.key))) {
              Char2CharAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Char2CharAVLTreeMap.Submap.SubmapIterator(Char2CharAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Char2CharAVLTreeMap.Submap.this.clear();
          }
          
          public Char2CharMap.Entry first()
          {
            return Char2CharAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Char2CharMap.Entry last()
          {
            return Char2CharAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Char2CharMap.Entry> subSet(Char2CharMap.Entry from, Char2CharMap.Entry local_to)
          {
            return Char2CharAVLTreeMap.Submap.this.subMap((Character)from.getKey(), (Character)local_to.getKey()).char2CharEntrySet();
          }
          
          public ObjectSortedSet<Char2CharMap.Entry> headSet(Char2CharMap.Entry local_to)
          {
            return Char2CharAVLTreeMap.Submap.this.headMap((Character)local_to.getKey()).char2CharEntrySet();
          }
          
          public ObjectSortedSet<Char2CharMap.Entry> tailSet(Char2CharMap.Entry from)
          {
            return Char2CharAVLTreeMap.Submap.this.tailMap((Character)from.getKey()).char2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Char2CharAVLTreeMap.Submap.SubmapValueIterator(Char2CharAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Char2CharAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Char2CharAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(char local_k)
    {
      return (in2(local_k)) && (Char2CharAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      char local_kk = local_k;
      Char2CharAVLTreeMap.Entry local_e;
      return (in2(local_kk)) && ((local_e = Char2CharAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(char local_k, char local_v)
    {
      ...
      char oldValue = Char2CharAVLTreeMap.this.put(local_k, local_v);
    ...
    public char remove(char local_k)
    {
      ...
      char oldValue = Char2CharAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Char2CharAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Char2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Char2CharAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Char2CharSortedMap tailMap(char from)
    {
      if (this.bottom) {
        return new Submap(Char2CharAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Char2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Char2CharAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Char2CharSortedMap subMap(char from, char local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Char2CharAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Char2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Char2CharAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Char2CharAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Char2CharAVLTreeMap.this.locateKey(this.from);
        if (Char2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Char2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Char2CharAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Char2CharAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Char2CharAVLTreeMap.this.locateKey(this.field_47);
        if (Char2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Char2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public char firstCharKey()
    {
      Char2CharAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public char lastCharKey()
    {
      Char2CharAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Char2CharAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Char2CharAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(char local_k)
      {
        this();
        if (this.next != null) {
          if ((!Char2CharAVLTreeMap.Submap.this.bottom) && (Char2CharAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Char2CharAVLTreeMap.Submap.this.top) && (Char2CharAVLTreeMap.this.compare(local_k, (this.prev = Char2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Char2CharAVLTreeMap.this.locateKey(local_k);
            if (Char2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Char2CharAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Char2CharAVLTreeMap.this.compare(this.prev.key, Char2CharAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Char2CharAVLTreeMap.Submap.this.top) && (this.next != null) && (Char2CharAVLTreeMap.this.compare(this.next.key, Char2CharAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractChar2CharSortedMap.KeySet
    {
      ...
      {
        return new Char2CharAVLTreeMap.Submap.SubmapKeyIterator(Char2CharAVLTreeMap.Submap.this);
      }
      
      public CharBidirectionalIterator iterator(char from)
      {
        return new Char2CharAVLTreeMap.Submap.SubmapKeyIterator(Char2CharAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractChar2CharSortedMap.KeySet
  {
    ...
    public CharBidirectionalIterator iterator()
    {
      return new Char2CharAVLTreeMap.KeyIterator(Char2CharAVLTreeMap.this);
    }
    
    public CharBidirectionalIterator iterator(char from)
    {
      return new Char2CharAVLTreeMap.KeyIterator(Char2CharAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Char2CharAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Char2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Char2CharMap.Entry
  {
    ...
    Entry(char local_k, char local_v)
    {
      this.key = local_k;
      this.value = local_v;
