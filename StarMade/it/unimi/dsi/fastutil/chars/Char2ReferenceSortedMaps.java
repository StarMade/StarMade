...
/*     */     }
/* 302 */     public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.char2ReferenceEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Character, V>> entrySet() {
/* 304 */       return char2ReferenceEntrySet(); } 
...
/* 308 */     public Char2ReferenceSortedMap<V> headMap(char to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Char2ReferenceSortedMap<V> tailMap(char from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Char2ReferenceSortedMap<V> headMap(Character to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Char2ReferenceSortedMap<V> tailMap(Character from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.char2ReferenceEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Character, V>> entrySet() {
/* 244 */       return char2ReferenceEntrySet(); } 
...
/* 248 */     public Char2ReferenceSortedMap<V> headMap(char to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Char2ReferenceSortedMap<V> tailMap(char from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public char firstCharKey() {
...
/* 259 */     public Char2ReferenceSortedMap<V> headMap(Character to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Char2ReferenceSortedMap<V> tailMap(Character from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Char2ReferenceMaps.Singleton.SingletonEntry(this), Char2ReferenceSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Character, V>> entrySet() { return char2ReferenceEntrySet(); } 
/*     */     public CharSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = CharSortedSets.singleton(this.key, this.comparator); return (CharSortedSet)this.keys;
/*     */     }
/*     */     public Char2ReferenceSortedMap<V> subMap(char from, char to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Char2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Char2ReferenceSortedMap<V> headMap(char to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Char2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Char2ReferenceSortedMap<V> tailMap(char from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Char2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Char2ReferenceSortedMap<V> tailMap(Character ofrom) { return tailMap(ofrom.charValue()); } 
/* 156 */     public Char2ReferenceSortedMap<V> subMap(Character ofrom, Character oto) { return subMap(ofrom.charValue(), oto.charValue()); } 
/*     */     public Character firstKey() {
...
/*  77 */       return null;
/*     */     }
/*  79 */     public ObjectSortedSet<Char2ReferenceMap.Entry<V>> char2ReferenceEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Character, V>> entrySet() {
/*  81 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  83 */     public CharSortedSet keySet() { return CharSortedSets.EMPTY_SET; } 
/*     */     public Char2ReferenceSortedMap<V> subMap(char from, char to) {
/*  85 */       return Char2ReferenceSortedMaps.EMPTY_MAP;
/*     */     }
/*  87 */     public Char2ReferenceSortedMap<V> headMap(char to) { return Char2ReferenceSortedMaps.EMPTY_MAP; } 
/*     */     public Char2ReferenceSortedMap<V> tailMap(char from) {
/*  89 */       return Char2ReferenceSortedMaps.EMPTY_MAP; } 
/*  90 */     public char firstCharKey() { throw new NoSuchElementException(); } 
/*  91 */     public char lastCharKey() { throw new NoSuchElementException(); } 
/*  92 */     public Char2ReferenceSortedMap<V> headMap(Character oto) { return headMap(oto.charValue()); } 
/*  93 */     public Char2ReferenceSortedMap<V> tailMap(Character ofrom) { return tailMap(ofrom.charValue()); } 
/*  94 */     public Char2ReferenceSortedMap<V> subMap(Character ofrom, Character oto) { return subMap(ofrom.charValue(), oto.charValue()); } 
