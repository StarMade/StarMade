...
/*     */ 
/*     */ public class Char2IntOpenHashMap extends AbstractChar2IntMap
...
/* 642 */           return new Char2IntOpenHashMap.ValueIterator(Char2IntOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Char2IntOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(int v) {
/* 648 */           return Char2IntOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Char2IntOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Char2IntOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Char2IntOpenHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public int nextInt() { return Char2IntOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Integer next() { return Integer.valueOf(Char2IntOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Char2IntOpenHashMap.KeyIterator(Char2IntOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Char2IntOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(char k) {
/* 613 */       return Char2IntOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(char k) {
/* 616 */       int oldSize = Char2IntOpenHashMap.this.size;
/* 617 */       Char2IntOpenHashMap.this.remove(k);
/* 618 */       return Char2IntOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Char2IntOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Char2IntOpenHashMap.MapIterator
/*     */     implements CharIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public char nextChar() { return Char2IntOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Character next() { return Character.valueOf(Char2IntOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Char2IntOpenHashMap.EntryIterator(Char2IntOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Char2IntMap.Entry> fastIterator() {
/* 550 */       return new Char2IntOpenHashMap.FastEntryIterator(Char2IntOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Char2IntOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Char2IntOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Char2IntOpenHashMap.this.key[pos] == k) return Char2IntOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 562 */         pos = pos + 1 & Char2IntOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Char2IntOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Char2IntOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Char2IntOpenHashMap.this.key[pos] == k) {
/* 576 */           Char2IntOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Char2IntOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Char2IntOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Char2IntOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Char2IntOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Char2IntMap.Entry>
/*     */   {
/* 537 */     final AbstractChar2IntMap.BasicEntry entry = new AbstractChar2IntMap.BasicEntry('\000', 0);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Char2IntOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Char2IntOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Char2IntOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Char2IntMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Char2IntOpenHashMap.MapEntry(Char2IntOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Char2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Char2IntOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Char2IntOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Char2IntOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Char2IntOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Char2IntOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Char2IntOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Char2IntOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Char2IntOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Char2IntOpenHashMap.this.mask;
/* 485 */         while (Char2IntOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Char2IntOpenHashMap.this.key[pos]) & Char2IntOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Char2IntOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Char2IntOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new CharArrayList();
/* 494 */           this.wrapped.add(Char2IntOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Char2IntOpenHashMap.this.key[last] = Char2IntOpenHashMap.this.key[pos];
/* 497 */         Char2IntOpenHashMap.this.value[last] = Char2IntOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Char2IntOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Char2IntOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Char2IntOpenHashMap.this.size -= 1;
...
/* 398 */       return Character.valueOf(Char2IntOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public char getCharKey() {
/* 401 */       return Char2IntOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Integer getValue() {
/* 404 */       return Integer.valueOf(Char2IntOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public int getIntValue() {
/* 407 */       return Char2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public int setValue(int v) {
/* 410 */       int oldValue = Char2IntOpenHashMap.this.value[this.index];
/* 411 */       Char2IntOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
...
/* 421 */       return (Char2IntOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2IntOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Char2IntOpenHashMap.this.key[this.index] ^ Char2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 427 */       return Char2IntOpenHashMap.this.key[this.index] + "=>" + Char2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
