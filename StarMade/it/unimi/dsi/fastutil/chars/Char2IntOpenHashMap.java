...
/*  18:    */
/*  87:    */public class Char2IntOpenHashMap
/*  88:    */  extends AbstractChar2IntMap
...
/* 101:    */  protected volatile transient Char2IntMap.FastEntrySet entries;
/* 102:    */  protected volatile transient CharSet keys;
/* 103:    */  protected volatile transient IntCollection values;
/* 104:    */  
/* 105:    */  public Char2IntOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Char2IntOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Char2IntOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Char2IntOpenHashMap(Map<? extends Character, ? extends Integer> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Char2IntOpenHashMap(Map<? extends Character, ? extends Integer> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Char2IntOpenHashMap(Char2IntMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Char2IntOpenHashMap(Char2IntMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Char2IntOpenHashMap(char[] k, int[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Char2IntOpenHashMap(char[] k, int[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public int put(char k, int v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Integer put(Character ok, Integer ov) { int v = ov.intValue();
...
/* 226:    */  }
/* 227:    */  
/* 238:    */  public int add(char k, int incr)
/* 239:    */  {
...
/* 312:    */  }
/* 313:    */  
/* 314:314 */  public Integer get(Character ok) { char k = ok.charValue();
/* 315:    */    
...
/* 389:    */    implements Char2IntMap.Entry, Map.Entry<Character, Integer>
/* 390:    */  {
...
/* 396:    */    }
/* 397:    */    
/* 398:398 */    public Character getKey() { return Character.valueOf(Char2IntOpenHashMap.this.key[this.index]); }
/* 399:    */    
/* 400:    */    public char getCharKey() {
/* 401:401 */      return Char2IntOpenHashMap.this.key[this.index];
/* 402:    */    }
/* 403:    */    
/* 404:404 */    public Integer getValue() { return Integer.valueOf(Char2IntOpenHashMap.this.value[this.index]); }
/* 405:    */    
/* 407:407 */    public int getIntValue() { return Char2IntOpenHashMap.this.value[this.index]; }
/* 408:    */    
/* 409:    */    public int setValue(int v) {
/* 410:410 */      int oldValue = Char2IntOpenHashMap.this.value[this.index];
/* 411:411 */      Char2IntOpenHashMap.this.value[this.index] = v;
...
/* 420:420 */      Map.Entry<Character, Integer> e = (Map.Entry)o;
/* 421:421 */      return (Char2IntOpenHashMap.this.key[this.index] == ((Character)e.getKey()).charValue()) && (Char2IntOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public int hashCode() { return Char2IntOpenHashMap.this.key[this.index] ^ Char2IntOpenHashMap.this.value[this.index]; }
/* 425:    */    
/* 427:427 */    public String toString() { return Char2IntOpenHashMap.this.key[this.index] + "=>" + Char2IntOpenHashMap.this.value[this.index]; } }
/* 428:    */  
...
/* 433:    */    
/* 434:434 */    private MapIterator() { this.pos = Char2IntOpenHashMap.this.n;
/* 435:    */      
/* 437:437 */      this.last = -1;
/* 438:    */      
/* 439:439 */      this.c = Char2IntOpenHashMap.this.size;
/* 440:    */      
/* 444:444 */      boolean[] used = Char2IntOpenHashMap.this.used;
...
/* 456:    */        
/* 457:457 */        int pos = HashCommon.murmurHash3(k) & Char2IntOpenHashMap.this.mask;
/* 458:    */        
/* 459:459 */        while (Char2IntOpenHashMap.this.used[pos] != 0) {
/* 460:460 */          if (Char2IntOpenHashMap.this.key[pos] == k) return pos;
/* 461:461 */          pos = pos + 1 & Char2IntOpenHashMap.this.mask;
/* 462:    */        }
/* 463:    */      }
/* 464:464 */      this.last = this.pos;
/* 465:    */      
/* 466:466 */      if (this.c != 0) {
/* 467:467 */        boolean[] used = Char2IntOpenHashMap.this.used;
...
/* 482:    */      for (;;)
/* 483:    */      {
/* 484:484 */        pos = (last = pos) + 1 & Char2IntOpenHashMap.this.mask;
/* 485:485 */        while (Char2IntOpenHashMap.this.used[pos] != 0) {
/* 486:486 */          int slot = HashCommon.murmurHash3(Char2IntOpenHashMap.this.key[pos]) & Char2IntOpenHashMap.this.mask;
/* 487:487 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488:488 */          pos = pos + 1 & Char2IntOpenHashMap.this.mask;
/* 489:    */        }
/* 490:490 */        if (Char2IntOpenHashMap.this.used[pos] == 0) break;
/* 491:491 */        if (pos < last)
/* 492:    */        {
/* 493:493 */          if (this.wrapped == null) this.wrapped = new CharArrayList();
/* 494:494 */          this.wrapped.add(Char2IntOpenHashMap.this.key[pos]);
/* 495:    */        }
/* 496:496 */        Char2IntOpenHashMap.this.key[last] = Char2IntOpenHashMap.this.key[pos];
/* 497:497 */        Char2IntOpenHashMap.this.value[last] = Char2IntOpenHashMap.this.value[pos];
/* 498:    */      }
/* 499:499 */      Char2IntOpenHashMap.this.used[last] = false;
/* 500:500 */      return last;
/* 501:    */    }
/* 502:    */    
...
/* 506:    */      {
/* 507:507 */        Char2IntOpenHashMap.this.remove(this.wrapped.getChar(-this.pos - 2));
/* 508:508 */        this.last = -1;
/* 509:509 */        return;
/* 510:    */      }
/* 511:511 */      Char2IntOpenHashMap.this.size -= 1;
...
/* 523:    */    } }
/* 524:    */  
/* 525:525 */  private class EntryIterator extends Char2IntOpenHashMap.MapIterator implements ObjectIterator<Char2IntMap.Entry> { private EntryIterator() { super(null); }
/* 526:    */    
/* 527:    */    private Char2IntOpenHashMap.MapEntry entry;
/* 528:528 */    public Char2IntMap.Entry next() { return this.entry = new Char2IntOpenHashMap.MapEntry(Char2IntOpenHashMap.this, nextEntry()); }
/* 529:    */    
/* 530:    */    public void remove()
/* 531:    */    {
/* 532:532 */      super.remove();
/* 533:533 */      Char2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 534:    */    } }
/* 535:    */  
/* 536:536 */  private class FastEntryIterator extends Char2IntOpenHashMap.MapIterator implements ObjectIterator<Char2IntMap.Entry> { private FastEntryIterator() { super(null); }
/* 537:537 */    final AbstractChar2IntMap.BasicEntry entry = new AbstractChar2IntMap.BasicEntry('\000', 0);
/* 538:    */    
/* 539:539 */    public AbstractChar2IntMap.BasicEntry next() { int e = nextEntry();
/* 540:540 */      this.entry.key = Char2IntOpenHashMap.this.key[e];
/* 541:541 */      this.entry.value = Char2IntOpenHashMap.this.value[e];
/* 542:542 */      return this.entry;
/* 543:    */    } }
/* 544:    */  
/* 545:    */  private final class MapEntrySet extends AbstractObjectSet<Char2IntMap.Entry> implements Char2IntMap.FastEntrySet { private MapEntrySet() {}
/* 546:    */    
/* 547:547 */    public ObjectIterator<Char2IntMap.Entry> iterator() { return new Char2IntOpenHashMap.EntryIterator(Char2IntOpenHashMap.this, null); }
/* 548:    */    
/* 549:    */    public ObjectIterator<Char2IntMap.Entry> fastIterator() {
/* 550:550 */      return new Char2IntOpenHashMap.FastEntryIterator(Char2IntOpenHashMap.this, null);
/* 551:    */    }
/* 552:    */    
/* 553:    */    public boolean contains(Object o) {
/* 554:554 */      if (!(o instanceof Map.Entry)) return false;
/* 555:555 */      Map.Entry<Character, Integer> e = (Map.Entry)o;
/* 556:556 */      char k = ((Character)e.getKey()).charValue();
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(k) & Char2IntOpenHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Char2IntOpenHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Char2IntOpenHashMap.this.key[pos] == k) return Char2IntOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 562:562 */        pos = pos + 1 & Char2IntOpenHashMap.this.mask;
/* 563:    */      }
...
/* 569:569 */      Map.Entry<Character, Integer> e = (Map.Entry)o;
/* 570:570 */      char k = ((Character)e.getKey()).charValue();
/* 571:    */      
/* 572:572 */      int pos = HashCommon.murmurHash3(k) & Char2IntOpenHashMap.this.mask;
/* 573:    */      
/* 574:574 */      while (Char2IntOpenHashMap.this.used[pos] != 0) {
/* 575:575 */        if (Char2IntOpenHashMap.this.key[pos] == k) {
/* 576:576 */          Char2IntOpenHashMap.this.remove(e.getKey());
/* 577:577 */          return true;
/* 578:    */        }
/* 579:579 */        pos = pos + 1 & Char2IntOpenHashMap.this.mask;
/* 580:    */      }
/* 581:581 */      return false;
/* 582:    */    }
/* 583:    */    
/* 584:584 */    public int size() { return Char2IntOpenHashMap.this.size; }
/* 585:    */    
/* 587:587 */    public void clear() { Char2IntOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public Char2IntMap.FastEntrySet char2IntEntrySet() {
...
/* 598:    */    extends Char2IntOpenHashMap.MapIterator
/* 599:    */    implements CharIterator
/* 600:    */  {
/* 601:601 */    public KeyIterator() { super(null); }
/* 602:602 */    public char nextChar() { return Char2IntOpenHashMap.this.key[nextEntry()]; }
/* 603:603 */    public Character next() { return Character.valueOf(Char2IntOpenHashMap.this.key[nextEntry()]); } }
/* 604:    */  
/* 605:    */  private final class KeySet extends AbstractCharSet { private KeySet() {}
/* 606:    */    
/* 607:607 */    public CharIterator iterator() { return new Char2IntOpenHashMap.KeyIterator(Char2IntOpenHashMap.this); }
/* 608:    */    
/* 609:    */    public int size() {
/* 610:610 */      return Char2IntOpenHashMap.this.size;
/* 611:    */    }
/* 612:    */    
/* 613:613 */    public boolean contains(char k) { return Char2IntOpenHashMap.this.containsKey(k); }
/* 614:    */    
/* 615:    */    public boolean remove(char k) {
/* 616:616 */      int oldSize = Char2IntOpenHashMap.this.size;
/* 617:617 */      Char2IntOpenHashMap.this.remove(k);
/* 618:618 */      return Char2IntOpenHashMap.this.size != oldSize;
/* 619:    */    }
/* 620:    */    
/* 621:621 */    public void clear() { Char2IntOpenHashMap.this.clear(); }
/* 622:    */  }
/* 623:    */  
...
/* 632:    */    extends Char2IntOpenHashMap.MapIterator
/* 633:    */    implements IntIterator
/* 634:    */  {
/* 635:635 */    public ValueIterator() { super(null); }
/* 636:636 */    public int nextInt() { return Char2IntOpenHashMap.this.value[nextEntry()]; }
/* 637:637 */    public Integer next() { return Integer.valueOf(Char2IntOpenHashMap.this.value[nextEntry()]); }
/* 638:    */  }
/* 639:    */  
...
/* 642:642 */          return new Char2IntOpenHashMap.ValueIterator(Char2IntOpenHashMap.this);
/* 643:    */        }
/* 644:    */        
/* 645:645 */        public int size() { return Char2IntOpenHashMap.this.size; }
/* 646:    */        
/* 647:    */        public boolean contains(int v) {
/* 648:648 */          return Char2IntOpenHashMap.this.containsValue(v);
/* 649:    */        }
/* 650:    */        
/* 651:651 */        public void clear() { Char2IntOpenHashMap.this.clear(); }
/* 652:    */      };
/* 653:    */    }
...
/* 754:    */  }
/* 755:    */  
/* 759:    */  public Char2IntOpenHashMap clone()
/* 760:    */  {
/* 761:    */    Char2IntOpenHashMap c;
/* 762:    */    
/* 764:    */    try
/* 765:    */    {
/* 766:766 */      c = (Char2IntOpenHashMap)super.clone();
/* 767:    */    }
