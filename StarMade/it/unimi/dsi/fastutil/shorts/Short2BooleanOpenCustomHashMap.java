...
/* 632 */           return new Short2BooleanOpenCustomHashMap.ValueIterator(Short2BooleanOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 635 */           return Short2BooleanOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(boolean v) {
/* 638 */           return Short2BooleanOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 641 */           Short2BooleanOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 756 */       c = (Short2BooleanOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Short2BooleanOpenCustomHashMap.MapIterator
/*     */     implements BooleanIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 625 */       super(null); } 
/* 626 */     public boolean nextBoolean() { return Short2BooleanOpenCustomHashMap.this.value[nextEntry()]; } 
/* 627 */     public Boolean next() { return Boolean.valueOf(Short2BooleanOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 597 */       return new Short2BooleanOpenCustomHashMap.KeyIterator(Short2BooleanOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 600 */       return Short2BooleanOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(short k) {
/* 603 */       return Short2BooleanOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(short k) {
/* 606 */       int oldSize = Short2BooleanOpenCustomHashMap.this.size;
/* 607 */       Short2BooleanOpenCustomHashMap.this.remove(k);
/* 608 */       return Short2BooleanOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 611 */       Short2BooleanOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Short2BooleanOpenCustomHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 591 */       super(null); } 
/* 592 */     public short nextShort() { return Short2BooleanOpenCustomHashMap.this.key[nextEntry()]; } 
/* 593 */     public Short next() { return Short.valueOf(Short2BooleanOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 537 */       return new Short2BooleanOpenCustomHashMap.EntryIterator(Short2BooleanOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Short2BooleanMap.Entry> fastIterator() {
/* 540 */       return new Short2BooleanOpenCustomHashMap.FastEntryIterator(Short2BooleanOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 548 */       int pos = HashCommon.murmurHash3(Short2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Short2BooleanOpenCustomHashMap.this.mask;
/*     */ 
/* 550 */       while (Short2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 551 */         if (Short2BooleanOpenCustomHashMap.this.strategy.equals(Short2BooleanOpenCustomHashMap.this.key[pos], k)) return Short2BooleanOpenCustomHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/* 552 */         pos = pos + 1 & Short2BooleanOpenCustomHashMap.this.mask;
/*     */       }
/* 554 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 562 */       int pos = HashCommon.murmurHash3(Short2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Short2BooleanOpenCustomHashMap.this.mask;
/*     */ 
/* 564 */       while (Short2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 565 */         if (Short2BooleanOpenCustomHashMap.this.strategy.equals(Short2BooleanOpenCustomHashMap.this.key[pos], k)) {
/* 566 */           Short2BooleanOpenCustomHashMap.this.remove(e.getKey());
/* 567 */           return true;
/*     */         }
/* 569 */         pos = pos + 1 & Short2BooleanOpenCustomHashMap.this.mask;
/*     */       }
/* 571 */       return false;
/*     */     }
/*     */     public int size() {
/* 574 */       return Short2BooleanOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 577 */       Short2BooleanOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Short2BooleanOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Short2BooleanMap.Entry>
/*     */   {
/* 527 */     final AbstractShort2BooleanMap.BasicEntry entry = new AbstractShort2BooleanMap.BasicEntry((short)0, false);
/*     */ 
...
/* 529 */       int e = nextEntry();
/* 530 */       this.entry.key = Short2BooleanOpenCustomHashMap.this.key[e];
/* 531 */       this.entry.value = Short2BooleanOpenCustomHashMap.this.value[e];
/* 532 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Short2BooleanOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Short2BooleanMap.Entry>
/*     */   {
...
/* 518 */       return this.entry = new Short2BooleanOpenCustomHashMap.MapEntry(Short2BooleanOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 522 */       super.remove();
/* 523 */       Short2BooleanOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 424 */       this.pos = Short2BooleanOpenCustomHashMap.this.n;
/*     */ 
/* 427 */       this.last = -1;
/*     */ 
/* 429 */       this.c = Short2BooleanOpenCustomHashMap.this.size;
/*     */ 
/* 434 */       boolean[] used = Short2BooleanOpenCustomHashMap.this.used;
...
/*     */ 
/* 447 */         int pos = HashCommon.murmurHash3(Short2BooleanOpenCustomHashMap.this.strategy.hashCode(k)) & Short2BooleanOpenCustomHashMap.this.mask;
/*     */ 
/* 449 */         while (Short2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 450 */           if (Short2BooleanOpenCustomHashMap.this.strategy.equals(Short2BooleanOpenCustomHashMap.this.key[pos], k)) return pos;
/* 451 */           pos = pos + 1 & Short2BooleanOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 454 */       this.last = this.pos;
/*     */ 
/* 456 */       if (this.c != 0) {
/* 457 */         boolean[] used = Short2BooleanOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 474 */         pos = (last = pos) + 1 & Short2BooleanOpenCustomHashMap.this.mask;
/* 475 */         while (Short2BooleanOpenCustomHashMap.this.used[pos] != 0) {
/* 476 */           int slot = HashCommon.murmurHash3(Short2BooleanOpenCustomHashMap.this.strategy.hashCode(Short2BooleanOpenCustomHashMap.this.key[pos])) & Short2BooleanOpenCustomHashMap.this.mask;
/* 477 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 478 */           pos = pos + 1 & Short2BooleanOpenCustomHashMap.this.mask;
/*     */         }
/* 480 */         if (Short2BooleanOpenCustomHashMap.this.used[pos] == 0) break;
/* 481 */         if (pos < last)
/*     */         {
/* 483 */           if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 484 */           this.wrapped.add(Short2BooleanOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 486 */         Short2BooleanOpenCustomHashMap.this.key[last] = Short2BooleanOpenCustomHashMap.this.key[pos];
/* 487 */         Short2BooleanOpenCustomHashMap.this.value[last] = Short2BooleanOpenCustomHashMap.this.value[pos];
/*     */       }
/* 489 */       Short2BooleanOpenCustomHashMap.this.used[last] = false;
/* 490 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 495 */       if (this.pos < -1)
/*     */       {
/* 497 */         Short2BooleanOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 498 */         this.last = -1;
/* 499 */         return;
/*     */       }
/* 501 */       Short2BooleanOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Short getKey() {
/* 388 */       return Short.valueOf(Short2BooleanOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public short getShortKey() {
/* 391 */       return Short2BooleanOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Boolean getValue() {
/* 394 */       return Boolean.valueOf(Short2BooleanOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public boolean getBooleanValue() {
/* 397 */       return Short2BooleanOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public boolean setValue(boolean v) {
/* 400 */       boolean oldValue = Short2BooleanOpenCustomHashMap.this.value[this.index];
/* 401 */       Short2BooleanOpenCustomHashMap.this.value[this.index] = v;
/* 402 */       return oldValue;
/*     */     }
/*     */     public Boolean setValue(Boolean v) {
...
/* 411 */       return (Short2BooleanOpenCustomHashMap.this.strategy.equals(Short2BooleanOpenCustomHashMap.this.key[this.index], ((Short)e.getKey()).shortValue())) && (Short2BooleanOpenCustomHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*     */     }
/*     */     public int hashCode() {
/* 414 */       return Short2BooleanOpenCustomHashMap.this.strategy.hashCode(Short2BooleanOpenCustomHashMap.this.key[this.index]) ^ (Short2BooleanOpenCustomHashMap.this.value[this.index] != 0 ? 1231 : 1237);
/*     */     }
/*     */     public String toString() {
/* 417 */       return Short2BooleanOpenCustomHashMap.this.key[this.index] + "=>" + Short2BooleanOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
