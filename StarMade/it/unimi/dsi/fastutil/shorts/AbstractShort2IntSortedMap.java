  ...
  implements Short2IntSortedMap
{
  ...
  {
    protected final ObjectBidirectionalIterator<Map.Entry<Short, Integer>> field_70;
    
    public ValuesIterator(ObjectBidirectionalIterator<Map.Entry<Short, Integer>> local_i)
    {
    ...
    extends AbstractIntCollection
  {
    ...
    {
      return new AbstractShort2IntSortedMap.ValuesIterator(AbstractShort2IntSortedMap.this.entrySet().iterator());
    }
    
    public boolean contains(int local_k)
    {
      return AbstractShort2IntSortedMap.this.containsValue(local_k);
    }
  ...
  {
    protected final ObjectBidirectionalIterator<Map.Entry<Short, Integer>> field_53;
    
    public KeySetIterator(ObjectBidirectionalIterator<Map.Entry<Short, Integer>> local_i)
    {
    ...
    extends AbstractShortSortedSet
  {
    ...
    {
      return AbstractShort2IntSortedMap.this.containsKey(local_k);
    }
    ...
    {
      return AbstractShort2IntSortedMap.this.headMap(local_to).keySet();
    }
    ...
    {
      return AbstractShort2IntSortedMap.this.subMap(from, local_to).keySet();
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new AbstractShort2IntSortedMap.KeySetIterator(AbstractShort2IntSortedMap.this.entrySet().iterator(new AbstractShort2IntMap.BasicEntry(from, 0)));
    }
    
    public ShortBidirectionalIterator iterator()
    {
      return new AbstractShort2IntSortedMap.KeySetIterator(AbstractShort2IntSortedMap.this.entrySet().iterator());
    }
  }
}
