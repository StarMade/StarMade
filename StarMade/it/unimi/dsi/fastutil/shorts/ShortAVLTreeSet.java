  ...
  implements Serializable, Cloneable, ShortSortedSet
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return ShortAVLTreeSet.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public ShortAVLTreeSet(Comparator<? super Short> local_c)
  {
    this();
  ...
  public ShortAVLTreeSet(Collection<? extends Short> local_c)
  {
    this();
    addAll(local_c);
  }
  
  public ShortAVLTreeSet(SortedSet<Short> local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public ShortAVLTreeSet(ShortCollection local_c)
  {
    this();
    addAll(local_c);
  }
  
  public ShortAVLTreeSet(ShortSortedSet local_s)
  {
    this(local_s.comparator());
    addAll(local_s);
  }
  
  public ShortAVLTreeSet(ShortIterator local_i)
  {
    allocatePaths();
  ...
  public ShortAVLTreeSet(Iterator<? extends Short> local_i)
  {
    this(ShortIterators.asShortIterator(local_i));
  }
  
  public ShortAVLTreeSet(short[] local_a, int offset, int length, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public ShortAVLTreeSet(short[] local_a, int offset, int length)
  {
    this(local_a, offset, length, null);
  }
  
  public ShortAVLTreeSet(short[] local_a)
  {
    this();
  ...
  public ShortAVLTreeSet(short[] local_a, Comparator<? super Short> local_c)
  {
    this(local_c);
    int local_i = local_a.length;
    while (local_i-- != 0) {
  ...
  public Object clone()
  {
    ShortAVLTreeSet local_c;
    try
    {
      local_c = (ShortAVLTreeSet)super.clone();
    }
    ...
    implements Serializable, ShortSortedSet
  {
    ...
    {
      if ((!bottom) && (!top) && (ShortAVLTreeSet.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (ShortAVLTreeSet.this.compare(local_k, this.from) >= 0)) && ((this.top) || (ShortAVLTreeSet.this.compare(local_k, this.field_339) < 0));
    }
    
    public boolean contains(short local_k)
    {
      return (in(local_k)) && (ShortAVLTreeSet.this.contains(local_k));
    }
    ...
    public boolean add(short local_k)
    {
      ...
      return ShortAVLTreeSet.this.add(local_k);
    }
    ...
    public boolean remove(short local_k)
    {
      ...
      return ShortAVLTreeSet.this.remove(local_k);
    }
    ...
    {
      if (this.top) {
        return new Subset(ShortAVLTreeSet.this, this.from, this.bottom, local_to, false);
      }
      return ShortAVLTreeSet.this.compare(local_to, this.field_339) < 0 ? new Subset(ShortAVLTreeSet.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public ShortSortedSet tailSet(short from)
    {
      if (this.bottom) {
        return new Subset(ShortAVLTreeSet.this, from, false, this.field_339, this.top);
      }
      return ShortAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(ShortAVLTreeSet.this, from, false, this.field_339, this.top) : this;
    }
    
    public ShortSortedSet subSet(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Subset(ShortAVLTreeSet.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = ShortAVLTreeSet.this.compare(local_to, this.field_339) < 0 ? local_to : this.field_339;
      }
      if (!this.bottom) {
    ...
    public ShortAVLTreeSet.Entry firstEntry()
    {
      ...
      ShortAVLTreeSet.Entry local_e;
      ShortAVLTreeSet.Entry local_e;
      if (this.bottom)
      {
        local_e = ShortAVLTreeSet.this.firstEntry;
      }
      else
      {
        local_e = ShortAVLTreeSet.this.locateKey(this.from);
        if (ShortAVLTreeSet.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (ShortAVLTreeSet.this.compare(local_e.key, this.field_339) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public ShortAVLTreeSet.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = ShortAVLTreeSet.this.lastEntry;
      }
      else
      {
        local_e = ShortAVLTreeSet.this.locateKey(this.field_339);
        if (ShortAVLTreeSet.this.compare(local_e.key, this.field_339) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (ShortAVLTreeSet.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShort()
    {
      ShortAVLTreeSet.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShort()
    {
      ShortAVLTreeSet.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends ShortAVLTreeSet.SetIterator
    {
      ...
      {
        super();
        this.next = ShortAVLTreeSet.Subset.this.firstEntry();
      }
      ...
      SubsetIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!ShortAVLTreeSet.Subset.this.bottom) && (ShortAVLTreeSet.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!ShortAVLTreeSet.Subset.this.top) && (ShortAVLTreeSet.this.compare(local_k, (this.prev = ShortAVLTreeSet.Subset.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = ShortAVLTreeSet.this.locateKey(local_k);
            if (ShortAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!ShortAVLTreeSet.Subset.this.bottom) && (this.prev != null) && (ShortAVLTreeSet.this.compare(this.prev.key, ShortAVLTreeSet.Subset.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!ShortAVLTreeSet.Subset.this.top) && (this.next != null) && (ShortAVLTreeSet.this.compare(this.next.key, ShortAVLTreeSet.Subset.this.field_339) >= 0)) {
          this.next = null;
        }
      }
    }
    ...
    extends AbstractShortListIterator
  {
    ...
    {
      if ((this.next = ShortAVLTreeSet.this.locateKey(local_k)) != null) {
        if (ShortAVLTreeSet.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
