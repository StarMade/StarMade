...
/*      */ 
/*      */ public class ShortAVLTreeSet extends AbstractShortSortedSet
...
/*      */   {
/*   94 */     if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) this.actualComparator = ((ShortComparator)this.storedComparator); else
/*   95 */       this.actualComparator = new ShortComparator() {
/*      */         public int compare(short k1, short k2) {
/*   97 */           return ShortAVLTreeSet.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*      */         }
/*      */         public int compare(Short ok1, Short ok2) {
/*  100 */           return ShortAVLTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*   74 */     allocatePaths();
/*      */ 
/*  160 */     while (i.hasNext()) add(i.nextShort());
/*      */   }
/*      */ 
/*      */   public ShortAVLTreeSet(Iterator<? extends Short> i)
/*      */   {
/*  171 */     this(ShortIterators.asShortIterator(i));
/*      */   }
/*      */ 
/*      */   public ShortAVLTreeSet(short[] a, int offset, int length, Comparator<? super Short> c)
/*      */   {
/*  184 */     this(c);
/*  185 */     ShortArrays.ensureOffsetLength(a, offset, length);
...
/* 1086 */     return new Subset((short)0, true, to, false);
/*      */   }
/*      */   public ShortSortedSet tailSet(short from) {
/* 1089 */     return new Subset(from, false, (short)0, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1284 */       c = (ShortAVLTreeSet)super.clone();
/*      */     }
...
/* 1337 */     while (n-- != 0) s.writeShort(i.nextShort());
/*      */   }
/*      */ 
...
/*      */   {
/* 1348 */     if (n == 1) {
/* 1349 */       Entry top = new Entry(s.readShort());
/* 1350 */       top.pred(pred);
/* 1351 */       top.succ(succ);
/* 1352 */       return top;
/*      */     }
/* 1354 */     if (n == 2)
/*      */     {
/* 1357 */       Entry top = new Entry(s.readShort());
/* 1358 */       top.right(new Entry(s.readShort()));
...
/*      */     {
/* 1121 */       if ((!bottom) && (!top) && (ShortAVLTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1122 */       this.from = from;
...
/*      */     {
/* 1139 */       return ((this.bottom) || (ShortAVLTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (ShortAVLTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(short k)
/*      */     {
/* 1144 */       return (in(k)) && (ShortAVLTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(short k) {
...
/* 1148 */       return ShortAVLTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(short k) {
/* 1152 */       if (!in(k)) return false;
/* 1153 */       return ShortAVLTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ShortComparator comparator() {
/* 1168 */       return ShortAVLTreeSet.this.actualComparator;
/*      */     }
/*      */     public ShortBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public ShortSortedSet headSet(short to) {
/* 1177 */       if (this.top) return new Subset(ShortAVLTreeSet.this, this.from, this.bottom, to, false);
/* 1178 */       return ShortAVLTreeSet.this.compare(to, this.to) < 0 ? new Subset(ShortAVLTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public ShortSortedSet tailSet(short from) {
/* 1181 */       if (this.bottom) return new Subset(ShortAVLTreeSet.this, from, false, this.to, this.top);
/* 1182 */       return ShortAVLTreeSet.this.compare(from, this.from) > 0 ? new Subset(ShortAVLTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public ShortSortedSet subSet(short from, short to) {
/* 1185 */       if ((this.top) && (this.bottom)) return new Subset(ShortAVLTreeSet.this, from, false, to, false);
/* 1186 */       if (!this.top) to = ShortAVLTreeSet.this.compare(to, this.to) < 0 ? to : this.to;
/* 1187 */       if (!this.bottom) from = ShortAVLTreeSet.this.compare(from, this.from) > 0 ? from : this.from;
/* 1188 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1189 */       return new Subset(ShortAVLTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public ShortAVLTreeSet.Entry firstEntry()
/*      */     {
/* 1196 */       if (ShortAVLTreeSet.this.tree == null) return null;
/* 1199 */       ShortAVLTreeSet.Entry e;
/*      */       ShortAVLTreeSet.Entry e;
/* 1199 */       if (this.bottom) { e = ShortAVLTreeSet.this.firstEntry;
/*      */       } else {
/* 1201 */         e = ShortAVLTreeSet.this.locateKey(this.from);
/*      */ 
/* 1203 */         if (ShortAVLTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1206 */       if ((e == null) || ((!this.top) && (ShortAVLTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1207 */       return e;
/*      */     }
/*      */ 
/*      */     public ShortAVLTreeSet.Entry lastEntry()
/*      */     {
/* 1214 */       if (ShortAVLTreeSet.this.tree == null) return null;
/* 1217 */       ShortAVLTreeSet.Entry e;
/*      */       ShortAVLTreeSet.Entry e;
/* 1217 */       if (this.top) { e = ShortAVLTreeSet.this.lastEntry;
/*      */       } else {
/* 1219 */         e = ShortAVLTreeSet.this.locateKey(this.to);
/*      */ 
/* 1221 */         if (ShortAVLTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1224 */       if ((e == null) || ((!this.bottom) && (ShortAVLTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1225 */       return e;
/*      */     }
/*      */     public short firstShort() {
/* 1228 */       ShortAVLTreeSet.Entry e = firstEntry();
/* 1229 */       if (e == null) throw new NoSuchElementException();
/* 1230 */       return e.key;
/*      */     }
/*      */     public short lastShort() {
/* 1233 */       ShortAVLTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1245 */         super();
/* 1246 */         this.next = ShortAVLTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(short k) {
/* 1249 */         this();
/* 1250 */         if (this.next != null)
/* 1251 */           if ((!ShortAVLTreeSet.Subset.this.bottom) && (ShortAVLTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1252 */           } else if ((!ShortAVLTreeSet.Subset.this.top) && (ShortAVLTreeSet.this.compare(k, (this.prev = ShortAVLTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1254 */             this.next = ShortAVLTreeSet.this.locateKey(k);
/* 1255 */             if (ShortAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1269 */         if ((!ShortAVLTreeSet.Subset.this.top) && (this.next != null) && (ShortAVLTreeSet.this.compare(this.next.key, ShortAVLTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/* 1021 */     int index = 0;
/*      */ 
/* 1023 */     SetIterator() { this.next = ShortAVLTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(short k) {
/* 1026 */       if ((this.next = ShortAVLTreeSet.this.locateKey(k)) != null)
/* 1027 */         if (ShortAVLTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/* 1046 */     public short nextShort() { return nextEntry().key; } 
/* 1047 */     public short previousShort() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1070 */       updatePrevious();
/* 1071 */       updateNext();
/* 1072 */       ShortAVLTreeSet.this.remove(this.curr.key);
/* 1073 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
