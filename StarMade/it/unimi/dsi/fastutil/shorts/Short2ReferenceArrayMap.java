...
/*     */     try
/*     */     {
/* 300 */       c = (Short2ReferenceArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>>
...
/* 130 */         int next = 0;
/*     */ 
/* 132 */         public boolean hasNext() { return this.next < Short2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Short2ReferenceMap.Entry<V> next()
/*     */         {
/* 136 */           if (!hasNext()) throw new NoSuchElementException();
/* 137 */           return new AbstractShort2ReferenceMap.BasicEntry(Short2ReferenceArrayMap.this.key[this.next], Short2ReferenceArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 143 */         int next = 0;
/* 144 */         final AbstractShort2ReferenceMap.BasicEntry<V> entry = new AbstractShort2ReferenceMap.BasicEntry((short)0, null);
/*     */ 
/* 146 */         public boolean hasNext() { return this.next < Short2ReferenceArrayMap.this.size; }
/*     */ 
/*     */         public Short2ReferenceMap.Entry<V> next()
/*     */         {
/* 150 */           if (!hasNext()) throw new NoSuchElementException();
/* 151 */           this.entry.key = Short2ReferenceArrayMap.this.key[this.next];
/* 152 */           this.entry.value = Short2ReferenceArrayMap.this.value[(this.next++)];
/* 153 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 158 */       return Short2ReferenceArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 165 */       return (Short2ReferenceArrayMap.this.containsKey(k)) && (Short2ReferenceArrayMap.this.get(k) == e.getValue());
/*     */     }
/*     */   }
/*     */ }
