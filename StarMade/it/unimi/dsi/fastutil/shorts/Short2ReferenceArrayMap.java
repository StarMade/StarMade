...
/*  17:    */
/*  65:    */public class Short2ReferenceArrayMap<V>
/*  66:    */  extends AbstractShort2ReferenceMap<V>
...
/*  72:    */  private int size;
/*  73:    */  
/*  74:    */  public Short2ReferenceArrayMap(short[] key, Object[] value)
/*  75:    */  {
/*  76: 76 */    this.key = key;
...
/*  80:    */  }
/*  81:    */  
/*  82:    */  public Short2ReferenceArrayMap()
/*  83:    */  {
/*  84: 84 */    this.key = ShortArrays.EMPTY_ARRAY;
/*  85: 85 */    this.value = ObjectArrays.EMPTY_ARRAY;
/*  86:    */  }
/*  87:    */  
/*  90:    */  public Short2ReferenceArrayMap(int capacity)
/*  91:    */  {
/*  92: 92 */    this.key = new short[capacity];
/*  93: 93 */    this.value = new Object[capacity];
/*  94:    */  }
/*  95:    */  
/*  98:    */  public Short2ReferenceArrayMap(Short2ReferenceMap<V> m)
/*  99:    */  {
/* 100:100 */    this(m.size());
/* 101:101 */    putAll(m);
/* 102:    */  }
/* 103:    */  
/* 106:    */  public Short2ReferenceArrayMap(Map<? extends Short, ? extends V> m)
/* 107:    */  {
/* 108:108 */    this(m.size());
/* 109:109 */    putAll(m);
/* 110:    */  }
/* 111:    */  
/* 118:    */  public Short2ReferenceArrayMap(short[] key, Object[] value, int size)
/* 119:    */  {
...
/* 125:    */  }
/* 126:    */  
/* 127:    */  private final class EntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>> implements Short2ReferenceMap.FastEntrySet<V> { private EntrySet() {}
/* 128:    */    
/* 129:129 */    public ObjectIterator<Short2ReferenceMap.Entry<V>> iterator() { new AbstractObjectIterator() {
/* 130:130 */        int next = 0;
/* 131:    */        
/* 132:132 */        public boolean hasNext() { return this.next < Short2ReferenceArrayMap.this.size; }
/* 133:    */        
/* 134:    */        public Short2ReferenceMap.Entry<V> next()
/* 135:    */        {
/* 136:136 */          if (!hasNext()) throw new NoSuchElementException();
/* 137:137 */          return new AbstractShort2ReferenceMap.BasicEntry(Short2ReferenceArrayMap.this.key[this.next], Short2ReferenceArrayMap.this.value[(this.next++)]);
/* 138:    */        }
/* 139:    */      }; }
/* 140:    */    
/* 141:    */    public ObjectIterator<Short2ReferenceMap.Entry<V>> fastIterator() {
/* 142:142 */      new AbstractObjectIterator() {
/* 143:143 */        int next = 0;
/* 144:144 */        final AbstractShort2ReferenceMap.BasicEntry<V> entry = new AbstractShort2ReferenceMap.BasicEntry((short)0, null);
/* 145:    */        
/* 146:146 */        public boolean hasNext() { return this.next < Short2ReferenceArrayMap.this.size; }
/* 147:    */        
/* 148:    */        public Short2ReferenceMap.Entry<V> next()
/* 149:    */        {
/* 150:150 */          if (!hasNext()) throw new NoSuchElementException();
/* 151:151 */          this.entry.key = Short2ReferenceArrayMap.this.key[this.next];
/* 152:152 */          this.entry.value = Short2ReferenceArrayMap.this.value[(this.next++)];
/* 153:153 */          return this.entry;
/* 154:    */        }
/* 155:    */      };
/* 156:    */    }
/* 157:    */    
/* 158:158 */    public int size() { return Short2ReferenceArrayMap.this.size; }
/* 159:    */    
...
/* 165:165 */      return (Short2ReferenceArrayMap.this.containsKey(k)) && (Short2ReferenceArrayMap.this.get(k) == e.getValue());
/* 166:    */    }
/* 167:    */  }
/* 168:    */  
/* 169:169 */  public Short2ReferenceMap.FastEntrySet<V> short2ReferenceEntrySet() { return new EntrySet(null); }
/* 170:    */  
...
/* 286:    */  }
/* 287:    */  
/* 292:    */  public Short2ReferenceArrayMap<V> clone()
/* 293:    */  {
/* 294:    */    Short2ReferenceArrayMap<V> c;
/* 295:    */    
/* 298:    */    try
/* 299:    */    {
/* 300:300 */      c = (Short2ReferenceArrayMap)super.clone();
/* 301:    */    }
