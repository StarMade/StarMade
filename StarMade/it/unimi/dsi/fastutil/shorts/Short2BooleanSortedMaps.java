...
/*     */   {
/* 173 */     return new Singleton(key.shortValue(), value.booleanValue());
/*     */   }
/*     */ 
/*     */   public static Short2BooleanSortedMap singleton(Short key, Boolean value, ShortComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.shortValue(), value.booleanValue(), comparator);
/*     */   }
/*     */ 
/*     */   public static Short2BooleanSortedMap singleton(short key, boolean value)
/*     */   {
...
/*     */     }
/* 302 */     public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.short2BooleanEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Boolean>> entrySet() {
/* 304 */       return short2BooleanEntrySet(); } 
...
/* 308 */     public Short2BooleanSortedMap headMap(short to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Short2BooleanSortedMap tailMap(short from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Short2BooleanSortedMap headMap(Short to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Short2BooleanSortedMap tailMap(Short from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.short2BooleanEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Boolean>> entrySet() {
/* 244 */       return short2BooleanEntrySet(); } 
...
/* 248 */     public Short2BooleanSortedMap headMap(short to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Short2BooleanSortedMap tailMap(short from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public short firstShortKey() {
...
/* 259 */     public Short2BooleanSortedMap headMap(Short to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Short2BooleanSortedMap tailMap(Short from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Short2BooleanMaps.Singleton.SingletonEntry(this), Short2BooleanSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Short, Boolean>> entrySet() { return short2BooleanEntrySet(); } 
/*     */     public ShortSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = ShortSortedSets.singleton(this.key, this.comparator); return (ShortSortedSet)this.keys;
/*     */     }
/*     */     public Short2BooleanSortedMap subMap(short from, short to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Short2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Short2BooleanSortedMap headMap(short to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Short2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Short2BooleanSortedMap tailMap(short from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Short2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Short2BooleanSortedMap tailMap(Short ofrom) { return tailMap(ofrom.shortValue()); } 
/* 156 */     public Short2BooleanSortedMap subMap(Short ofrom, Short oto) { return subMap(ofrom.shortValue(), oto.shortValue()); } 
/*     */     public Short firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Boolean>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public ShortSortedSet keySet() { return ShortSortedSets.EMPTY_SET; } 
/*     */     public Short2BooleanSortedMap subMap(short from, short to) {
/*  86 */       return Short2BooleanSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Short2BooleanSortedMap headMap(short to) { return Short2BooleanSortedMaps.EMPTY_MAP; } 
/*     */     public Short2BooleanSortedMap tailMap(short from) {
/*  90 */       return Short2BooleanSortedMaps.EMPTY_MAP; } 
...
/*  93 */     public Short2BooleanSortedMap headMap(Short oto) { return headMap(oto.shortValue()); } 
/*  94 */     public Short2BooleanSortedMap tailMap(Short ofrom) { return tailMap(ofrom.shortValue()); } 
/*  95 */     public Short2BooleanSortedMap subMap(Short ofrom, Short oto) { return subMap(ofrom.shortValue(), oto.shortValue()); } 
