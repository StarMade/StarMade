...
/*      */ 
/*      */ public class Short2ByteAVLTreeMap extends AbstractShort2ByteSortedMap
...
/*  117 */           return Short2ByteAVLTreeMap.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*      */         }
/*      */         public int compare(Short ok1, Short ok2) {
/*  120 */           return Short2ByteAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     byte oldValue = put(ok.shortValue(), ov.byteValue());
/*  780 */     return this.modified ? null : Byte.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Byte remove(Object ok)
/*      */   {
/*  788 */     byte oldValue = remove(((Short)ok).shortValue());
...
/* 1203 */         final Comparator<? super Short2ByteMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Short2ByteMap.Entry x, Short2ByteMap.Entry y) {
/* 1205 */             return Short2ByteAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Short2ByteAVLTreeMap.EntryIterator(Short2ByteAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry from) {
/* 1215 */           return new Short2ByteAVLTreeMap.EntryIterator(Short2ByteAVLTreeMap.this, ((Short)from.getKey()).shortValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Short2ByteAVLTreeMap.Entry f = Short2ByteAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1228 */           Short2ByteAVLTreeMap.Entry f = Short2ByteAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1229 */           if (f != null) Short2ByteAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Short2ByteAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Short2ByteAVLTreeMap.this.clear(); } 
/* 1234 */         public Short2ByteMap.Entry first() { return Short2ByteAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Short2ByteMap.Entry last() { return Short2ByteAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry from, Short2ByteMap.Entry to) { return Short2ByteAVLTreeMap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2ByteEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry to) { return Short2ByteAVLTreeMap.this.headMap((Short)to.getKey()).short2ByteEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry from) { return Short2ByteAVLTreeMap.this.tailMap((Short)from.getKey()).short2ByteEntrySet(); }
/*      */       };
...
/* 1304 */           return new Short2ByteAVLTreeMap.ValueIterator(Short2ByteAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(byte k) {
/* 1307 */           return Short2ByteAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Short2ByteAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Short2ByteAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Short2ByteAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readShort(), s.readByte());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readShort(), s.readByte());
/* 1759 */       top.right(new Entry(s.readShort(), s.readByte()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Short2ByteAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Short2ByteAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Short2ByteAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Short2ByteAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator() {
/* 1391 */             return new Short2ByteAVLTreeMap.Submap.SubmapEntryIterator(Short2ByteAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry from) {
/* 1394 */             return new Short2ByteAVLTreeMap.Submap.SubmapEntryIterator(Short2ByteAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
/*      */           }
/* 1396 */           public Comparator<? super Short2ByteMap.Entry> comparator() { return Short2ByteAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Short2ByteAVLTreeMap.Entry f = Short2ByteAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1402 */             return (f != null) && (Short2ByteAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Short2ByteAVLTreeMap.Entry f = Short2ByteAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1409 */             if ((f != null) && (Short2ByteAVLTreeMap.Submap.this.in(f.key))) Short2ByteAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Short2ByteAVLTreeMap.Submap.SubmapIterator(Short2ByteAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Short2ByteAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Short2ByteMap.Entry first() { return Short2ByteAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Short2ByteMap.Entry last() { return Short2ByteAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry from, Short2ByteMap.Entry to) { return Short2ByteAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2ByteEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry to) { return Short2ByteAVLTreeMap.Submap.this.headMap((Short)to.getKey()).short2ByteEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry from) { return Short2ByteAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2ByteEntrySet(); }
/*      */         };
...
/*      */           public ByteIterator iterator() {
/* 1442 */             return new Short2ByteAVLTreeMap.Submap.SubmapValueIterator(Short2ByteAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(byte k) {
/* 1445 */             return Short2ByteAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Short2ByteAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Short2ByteAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(short k) {
/* 1458 */       return (in(k)) && (Short2ByteAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(byte v) {
...
/* 1473 */       return (in(kk)) && ((e = Short2ByteAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public byte put(short k, byte v) {
/* 1476 */       Short2ByteAVLTreeMap.this.modified = false;
...
/* 1478 */       byte oldValue = Short2ByteAVLTreeMap.this.put(k, v);
/* 1479 */       return Short2ByteAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Byte put(Short ok, Byte ov) {
/* 1482 */       byte oldValue = put(ok.shortValue(), ov.byteValue());
/* 1483 */       return Short2ByteAVLTreeMap.this.modified ? null : Byte.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public byte remove(short k) {
/* 1487 */       Short2ByteAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       byte oldValue = Short2ByteAVLTreeMap.this.remove(k);
/* 1490 */       return Short2ByteAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Byte remove(Object ok) {
/* 1493 */       byte oldValue = remove(((Short)ok).shortValue());
/* 1494 */       return Short2ByteAVLTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ShortComparator comparator() {
/* 1509 */       return Short2ByteAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Short2ByteSortedMap headMap(short to) {
/* 1512 */       if (this.top) return new Submap(Short2ByteAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Short2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Short2ByteAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Short2ByteSortedMap tailMap(short from) {
/* 1516 */       if (this.bottom) return new Submap(Short2ByteAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Short2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2ByteAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Short2ByteSortedMap subMap(short from, short to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Short2ByteAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Short2ByteAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Short2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Short2ByteAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Short2ByteAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Short2ByteAVLTreeMap.this.tree == null) return null;
/* 1534 */       Short2ByteAVLTreeMap.Entry e;
/*      */       Short2ByteAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Short2ByteAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Short2ByteAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Short2ByteAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Short2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Short2ByteAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Short2ByteAVLTreeMap.this.tree == null) return null;
/* 1552 */       Short2ByteAVLTreeMap.Entry e;
/*      */       Short2ByteAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Short2ByteAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Short2ByteAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Short2ByteAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Short2ByteAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public short firstShortKey() {
/* 1563 */       Short2ByteAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public short lastShortKey() {
/* 1568 */       Short2ByteAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Short firstKey() {
/* 1573 */       Short2ByteAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Short lastKey() {
/* 1578 */       Short2ByteAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Short2ByteAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Short2ByteAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Short2ByteAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Short2ByteMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Short2ByteAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Short2ByteAVLTreeMap.Submap.this.bottom) && (Short2ByteAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Short2ByteAVLTreeMap.Submap.this.top) && (Short2ByteAVLTreeMap.this.compare(k, (this.prev = Short2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Short2ByteAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Short2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Short2ByteAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2ByteAVLTreeMap.this.compare(this.prev.key, Short2ByteAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Short2ByteAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2ByteAVLTreeMap.this.compare(this.next.key, Short2ByteAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public ShortBidirectionalIterator iterator() { return new Short2ByteAVLTreeMap.Submap.SubmapKeyIterator(Short2ByteAVLTreeMap.Submap.this); } 
/* 1433 */       public ShortBidirectionalIterator iterator(short from) { return new Short2ByteAVLTreeMap.Submap.SubmapKeyIterator(Short2ByteAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2ByteAVLTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public ShortBidirectionalIterator iterator() { return new Short2ByteAVLTreeMap.KeyIterator(Short2ByteAVLTreeMap.this); } 
/* 1263 */     public ShortBidirectionalIterator iterator(short from) { return new Short2ByteAVLTreeMap.KeyIterator(Short2ByteAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2ByteAVLTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2ByteAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Short2ByteMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Short2ByteMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Short2ByteAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(short k) {
/* 1129 */       if ((this.next = Short2ByteAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Short2ByteAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Short2ByteAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
