  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2ByteAVLTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2ByteAVLTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2ByteAVLTreeMap(Map<? extends Short, ? extends Byte> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ByteAVLTreeMap(SortedMap<Short, Byte> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ByteAVLTreeMap(Short2ByteMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ByteAVLTreeMap(Short2ByteSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ByteAVLTreeMap(short[] local_k, byte[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2ByteAVLTreeMap(short[] local_k, byte[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2ByteMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Short2ByteAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2ByteAVLTreeMap.EntryIterator(Short2ByteAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry from)
        {
          return new Short2ByteAVLTreeMap.EntryIterator(Short2ByteAVLTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2ByteAVLTreeMap.Entry local_f = Short2ByteAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2ByteAVLTreeMap.Entry local_f = Short2ByteAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2ByteAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2ByteAVLTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ByteEntrySet();
        }
        
        public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry local_to)
        {
          return Short2ByteAVLTreeMap.this.headMap((Short)local_to.getKey()).short2ByteEntrySet();
        }
        
        public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry from)
        {
          return Short2ByteAVLTreeMap.this.tailMap((Short)from.getKey()).short2ByteEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ByteCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractByteCollection()
      {
        ...
        {
          return new Short2ByteAVLTreeMap.ValueIterator(Short2ByteAVLTreeMap.this, null);
        }
        
        public boolean contains(byte local_k)
        {
          return Short2ByteAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2ByteAVLTreeMap local_c;
    try
    {
      local_c = (Short2ByteAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2ByteAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2ByteAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2ByteAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator()
          {
            return new Short2ByteAVLTreeMap.Submap.SubmapEntryIterator(Short2ByteAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry from)
          {
            return new Short2ByteAVLTreeMap.Submap.SubmapEntryIterator(Short2ByteAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Byte> local_e = (Map.Entry)local_o;
            Short2ByteAVLTreeMap.Entry local_f = Short2ByteAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2ByteAVLTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Byte> local_e = (Map.Entry)local_o;
            Short2ByteAVLTreeMap.Entry local_f = Short2ByteAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2ByteAVLTreeMap.Submap.this.in6(local_f.key))) {
              Short2ByteAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2ByteAVLTreeMap.Submap.SubmapIterator(Short2ByteAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2ByteAVLTreeMap.Submap.this.clear();
          }
          
          public Short2ByteMap.Entry first()
          {
            return Short2ByteAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Short2ByteMap.Entry last()
          {
            return Short2ByteAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry from, Short2ByteMap.Entry local_to)
          {
            return Short2ByteAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ByteEntrySet();
          }
          
          public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry local_to)
          {
            return Short2ByteAVLTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2ByteEntrySet();
          }
          
          public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry from)
          {
            return Short2ByteAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2ByteEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ByteCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractByteCollection()
        {
          public ByteIterator iterator()
          {
            return new Short2ByteAVLTreeMap.Submap.SubmapValueIterator(Short2ByteAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(byte local_k)
          {
            return Short2ByteAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2ByteAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2ByteAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2ByteAVLTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2ByteAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public byte put(short local_k, byte local_v)
    {
      ...
      byte oldValue = Short2ByteAVLTreeMap.this.put(local_k, local_v);
    ...
    public byte remove(short local_k)
    {
      ...
      byte oldValue = Short2ByteAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2ByteAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2ByteAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2ByteAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2ByteSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2ByteAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2ByteAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2ByteAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2ByteSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2ByteAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2ByteAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2ByteAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2ByteAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2ByteAVLTreeMap.this.locateKey(this.from);
        if (Short2ByteAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2ByteAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2ByteAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2ByteAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2ByteAVLTreeMap.this.locateKey(this.field_47);
        if (Short2ByteAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2ByteAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2ByteAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2ByteAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2ByteAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2ByteAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2ByteAVLTreeMap.Submap.this.bottom) && (Short2ByteAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2ByteAVLTreeMap.Submap.this.top) && (Short2ByteAVLTreeMap.this.compare(local_k, (this.prev = Short2ByteAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2ByteAVLTreeMap.this.locateKey(local_k);
            if (Short2ByteAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2ByteAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2ByteAVLTreeMap.this.compare(this.prev.key, Short2ByteAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2ByteAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2ByteAVLTreeMap.this.compare(this.next.key, Short2ByteAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2ByteSortedMap.KeySet
    {
      ...
      {
        return new Short2ByteAVLTreeMap.Submap.SubmapKeyIterator(Short2ByteAVLTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2ByteAVLTreeMap.Submap.SubmapKeyIterator(Short2ByteAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2ByteSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2ByteAVLTreeMap.KeyIterator(Short2ByteAVLTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2ByteAVLTreeMap.KeyIterator(Short2ByteAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2ByteAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Short2ByteAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
