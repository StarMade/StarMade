...
/*  746 */   public Short2CharSortedMap tailMap(short from) { throw new UnsupportedOperationException(); } 
/*  747 */   public Short2CharSortedMap headMap(short to) { throw new UnsupportedOperationException(); } 
/*  748 */   public Short2CharSortedMap subMap(short from, short to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1067 */           return new Short2CharLinkedOpenHashMap.ValueIterator(Short2CharLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1070 */           return Short2CharLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(char v) {
/* 1073 */           return Short2CharLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1076 */           Short2CharLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1209 */       c = (Short2CharLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2CharLinkedOpenHashMap.MapIterator
/*      */     implements CharListIterator
/*      */   {
/*      */     public char previousChar()
/*      */     {
/* 1054 */       return Short2CharLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1055 */     public Character previous() { return Character.valueOf(Short2CharLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1061 */     public char nextChar() { return Short2CharLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1062 */     public Character next() { return Character.valueOf(Short2CharLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1011 */       return new Short2CharLinkedOpenHashMap.KeyIterator(Short2CharLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ShortListIterator iterator() {
/* 1014 */       return new Short2CharLinkedOpenHashMap.KeyIterator(Short2CharLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1017 */       return Short2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(short k) {
/* 1020 */       return Short2CharLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(short k) {
/* 1023 */       int oldSize = Short2CharLinkedOpenHashMap.this.size;
/* 1024 */       Short2CharLinkedOpenHashMap.this.remove(k);
/* 1025 */       return Short2CharLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1028 */       Short2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public short firstShort() {
/* 1031 */       if (Short2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1032 */       return Short2CharLinkedOpenHashMap.this.key[Short2CharLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public short lastShort() {
/* 1035 */       if (Short2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1036 */       return Short2CharLinkedOpenHashMap.this.key[Short2CharLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2CharLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator(short k)
/*      */     {
/*  998 */       super(k, null); } 
/*  999 */     public short previousShort() { return Short2CharLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1002 */     public Short previous() { return Short.valueOf(Short2CharLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1006 */     public short nextShort() { return Short2CharLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1007 */     public Short next() { return Short.valueOf(Short2CharLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Short2CharMap.Entry>
...
/*      */     {
/*  926 */       return new Short2CharLinkedOpenHashMap.EntryIterator(Short2CharLinkedOpenHashMap.this);
/*      */     }
/*  928 */     public Comparator<? super Short2CharMap.Entry> comparator() { return null; } 
/*  929 */     public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry fromElement, Short2CharMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  930 */     public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  931 */     public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Short2CharMap.Entry first() {
/*  933 */       if (Short2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  934 */       return new Short2CharLinkedOpenHashMap.MapEntry(Short2CharLinkedOpenHashMap.this, Short2CharLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Short2CharMap.Entry last() {
/*  937 */       if (Short2CharLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  938 */       return new Short2CharLinkedOpenHashMap.MapEntry(Short2CharLinkedOpenHashMap.this, Short2CharLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  946 */       int pos = HashCommon.murmurHash3(k) & Short2CharLinkedOpenHashMap.this.mask;
/*      */ 
/*  948 */       while (Short2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  949 */         if (Short2CharLinkedOpenHashMap.this.key[pos] == k) return Short2CharLinkedOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/*  950 */         pos = pos + 1 & Short2CharLinkedOpenHashMap.this.mask;
/*      */       }
/*  952 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  960 */       int pos = HashCommon.murmurHash3(k) & Short2CharLinkedOpenHashMap.this.mask;
/*      */ 
/*  962 */       while (Short2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  963 */         if (Short2CharLinkedOpenHashMap.this.key[pos] == k) {
/*  964 */           Short2CharLinkedOpenHashMap.this.remove(e.getKey());
/*  965 */           return true;
/*      */         }
/*  967 */         pos = pos + 1 & Short2CharLinkedOpenHashMap.this.mask;
/*      */       }
/*  969 */       return false;
/*      */     }
/*      */     public int size() {
/*  972 */       return Short2CharLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  975 */       Short2CharLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from) {
/*  978 */       return new Short2CharLinkedOpenHashMap.EntryIterator(Short2CharLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2CharMap.Entry> fastIterator() {
/*  981 */       return new Short2CharLinkedOpenHashMap.FastEntryIterator(Short2CharLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2CharMap.Entry> fastIterator(Short2CharMap.Entry from) {
/*  984 */       return new Short2CharLinkedOpenHashMap.FastEntryIterator(Short2CharLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Short2CharLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Short2CharMap.Entry>
/*      */   {
/*  904 */     final AbstractShort2CharMap.BasicEntry entry = new AbstractShort2CharMap.BasicEntry((short)0, '\000');
/*      */ 
...
/*  910 */       int e = nextEntry();
/*  911 */       this.entry.key = Short2CharLinkedOpenHashMap.this.key[e];
/*  912 */       this.entry.value = Short2CharLinkedOpenHashMap.this.value[e];
/*  913 */       return this.entry;
/*      */     }
/*      */     public AbstractShort2CharMap.BasicEntry previous() {
/*  916 */       int e = previousEntry();
/*  917 */       this.entry.key = Short2CharLinkedOpenHashMap.this.key[e];
/*  918 */       this.entry.value = Short2CharLinkedOpenHashMap.this.value[e];
/*  919 */       return this.entry;
/*      */     }
/*  921 */     public void set(Short2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  922 */     public void add(Short2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2CharLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Short2CharMap.Entry>
/*      */   {
...
/*  890 */       return this.entry = new Short2CharLinkedOpenHashMap.MapEntry(Short2CharLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Short2CharLinkedOpenHashMap.MapEntry previous() {
/*  893 */       return this.entry = new Short2CharLinkedOpenHashMap.MapEntry(Short2CharLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  897 */       super.remove();
/*  898 */       Short2CharLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  900 */     public void set(Short2CharMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  901 */     public void add(Short2CharMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  763 */     int index = -1;
/*      */ 
/*  765 */     private MapIterator() { this.next = Short2CharLinkedOpenHashMap.this.first;
/*  766 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(short from) {
/*  769 */       if (Short2CharLinkedOpenHashMap.this.key[Short2CharLinkedOpenHashMap.this.last] == from) {
/*  770 */         this.prev = Short2CharLinkedOpenHashMap.this.last;
/*  771 */         this.index = Short2CharLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  775 */         int pos = HashCommon.murmurHash3(from) & Short2CharLinkedOpenHashMap.this.mask;
/*      */ 
/*  777 */         while (Short2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  778 */           if (Short2CharLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  780 */             this.next = ((int)Short2CharLinkedOpenHashMap.this.link[pos]);
/*  781 */             this.prev = pos;
/*  782 */             return;
/*      */           }
/*  784 */           pos = pos + 1 & Short2CharLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  797 */       if (this.next == -1) {
/*  798 */         this.index = Short2CharLinkedOpenHashMap.this.size;
/*  799 */         return;
/*      */       }
/*  801 */       int pos = Short2CharLinkedOpenHashMap.this.first;
/*  802 */       this.index = 1;
/*  803 */       while (pos != this.prev) {
/*  804 */         pos = (int)Short2CharLinkedOpenHashMap.this.link[pos];
/*  805 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  817 */       if (!hasNext()) return Short2CharLinkedOpenHashMap.this.size();
/*  818 */       this.curr = this.next;
/*  819 */       this.next = ((int)Short2CharLinkedOpenHashMap.this.link[this.curr]);
...
/*  827 */       this.prev = ((int)(Short2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  839 */         this.index -= 1;
/*  840 */         this.prev = ((int)(Short2CharLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  843 */         this.next = ((int)Short2CharLinkedOpenHashMap.this.link[this.curr]);
/*  844 */       }Short2CharLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  847 */       if (this.prev == -1) Short2CharLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  849 */         Short2CharLinkedOpenHashMap.this.link[this.prev] ^= (Short2CharLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  850 */       if (this.next == -1) Short2CharLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  852 */         Short2CharLinkedOpenHashMap.this.link[this.next] ^= (Short2CharLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  856 */         pos = (last = pos) + 1 & Short2CharLinkedOpenHashMap.this.mask;
/*  857 */         while (Short2CharLinkedOpenHashMap.this.used[pos] != 0) {
/*  858 */           int slot = HashCommon.murmurHash3(Short2CharLinkedOpenHashMap.this.key[pos]) & Short2CharLinkedOpenHashMap.this.mask;
/*  859 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  860 */           pos = pos + 1 & Short2CharLinkedOpenHashMap.this.mask;
/*      */         }
/*  862 */         if (Short2CharLinkedOpenHashMap.this.used[pos] == 0) break;
/*  863 */         Short2CharLinkedOpenHashMap.this.key[last] = Short2CharLinkedOpenHashMap.this.key[pos];
/*  864 */         Short2CharLinkedOpenHashMap.this.value[last] = Short2CharLinkedOpenHashMap.this.value[pos];
/*  865 */         if (this.next == pos) this.next = last;
/*  866 */         if (this.prev == pos) this.prev = last;
/*  867 */         Short2CharLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  869 */       Short2CharLinkedOpenHashMap.this.used[last] = false;
/*  870 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Short getKey() {
/*  629 */       return Short.valueOf(Short2CharLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public short getShortKey() {
/*  632 */       return Short2CharLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Character getValue() {
/*  635 */       return Character.valueOf(Short2CharLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public char getCharValue() {
/*  638 */       return Short2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public char setValue(char v) {
/*  641 */       char oldValue = Short2CharLinkedOpenHashMap.this.value[this.index];
/*  642 */       Short2CharLinkedOpenHashMap.this.value[this.index] = v;
/*  643 */       return oldValue;
/*      */     }
...
/*  652 */       return (Short2CharLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2CharLinkedOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/*      */     }
/*      */     public int hashCode() {
/*  655 */       return Short2CharLinkedOpenHashMap.this.key[this.index] ^ Short2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  658 */       return Short2CharLinkedOpenHashMap.this.key[this.index] + "=>" + Short2CharLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
