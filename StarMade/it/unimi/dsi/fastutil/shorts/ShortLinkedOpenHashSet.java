...
/*  13:    */
/*  89:    */public class ShortLinkedOpenHashSet
...
/* 111:    */  
/* 117:    */  public ShortLinkedOpenHashSet(int expected, float f)
/* 118:    */  {
...
/* 125:125 */    this.key = new short[this.n];
/* 126:126 */    this.used = new boolean[this.n];
/* 127:127 */    this.link = new long[this.n];
/* 128:    */  }
/* 129:    */  
/* 132:    */  public ShortLinkedOpenHashSet(int expected)
/* 133:    */  {
/* 134:134 */    this(expected, 0.75F);
/* 135:    */  }
/* 136:    */  
/* 138:    */  public ShortLinkedOpenHashSet()
/* 139:    */  {
/* 140:140 */    this(16, 0.75F);
/* 141:    */  }
/* 142:    */  
/* 146:    */  public ShortLinkedOpenHashSet(Collection<? extends Short> c, float f)
/* 147:    */  {
/* 148:148 */    this(c.size(), f);
/* 149:149 */    addAll(c);
/* 150:    */  }
/* 151:    */  
/* 155:    */  public ShortLinkedOpenHashSet(Collection<? extends Short> c)
/* 156:    */  {
/* 157:157 */    this(c, 0.75F);
/* 158:    */  }
/* 159:    */  
/* 163:    */  public ShortLinkedOpenHashSet(ShortCollection c, float f)
/* 164:    */  {
/* 165:165 */    this(c.size(), f);
/* 166:166 */    addAll(c);
/* 167:    */  }
/* 168:    */  
/* 172:    */  public ShortLinkedOpenHashSet(ShortCollection c)
/* 173:    */  {
/* 174:174 */    this(c, 0.75F);
/* 175:    */  }
/* 176:    */  
/* 180:    */  public ShortLinkedOpenHashSet(ShortIterator i, float f)
/* 181:    */  {
/* 182:182 */    this(16, f);
/* 183:183 */    while (i.hasNext()) { add(i.nextShort());
/* 184:    */    }
/* 185:    */  }
/* 186:    */  
/* 188:    */  public ShortLinkedOpenHashSet(ShortIterator i)
/* 189:    */  {
/* 190:190 */    this(i, 0.75F);
/* 191:    */  }
/* 192:    */  
/* 196:    */  public ShortLinkedOpenHashSet(Iterator<?> i, float f)
/* 197:    */  {
/* 198:198 */    this(ShortIterators.asShortIterator(i), f);
/* 199:    */  }
/* 200:    */  
/* 203:    */  public ShortLinkedOpenHashSet(Iterator<?> i)
/* 204:    */  {
/* 205:205 */    this(ShortIterators.asShortIterator(i));
/* 206:    */  }
/* 207:    */  
/* 213:    */  public ShortLinkedOpenHashSet(short[] a, int offset, int length, float f)
/* 214:    */  {
/* 215:215 */    this(length < 0 ? 0 : length, f);
/* 216:216 */    ShortArrays.ensureOffsetLength(a, offset, length);
/* 217:217 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 218:    */    }
/* 219:    */  }
/* 220:    */  
/* 224:    */  public ShortLinkedOpenHashSet(short[] a, int offset, int length)
/* 225:    */  {
/* 226:226 */    this(a, offset, length, 0.75F);
/* 227:    */  }
/* 228:    */  
/* 232:    */  public ShortLinkedOpenHashSet(short[] a, float f)
/* 233:    */  {
/* 234:234 */    this(a, 0, a.length, f);
/* 235:    */  }
/* 236:    */  
/* 240:    */  public ShortLinkedOpenHashSet(short[] a)
/* 241:    */  {
/* 242:242 */    this(a, 0.75F);
/* 243:    */  }
/* 244:    */  
/* 248:    */  public boolean add(short k)
/* 249:    */  {
/* 250:250 */    int pos = HashCommon.murmurHash3(k) & this.mask;
/* 251:    */    
...
/* 284:284 */        int slot = HashCommon.murmurHash3(this.key[pos]) & this.mask;
...
/* 294:    */  }
/* 295:    */  
/* 296:    */  public boolean remove(short k)
/* 297:    */  {
/* 298:298 */    int pos = HashCommon.murmurHash3(k) & this.mask;
/* 299:    */    
...
/* 311:    */  }
/* 312:    */  
/* 313:    */  public boolean contains(short k)
/* 314:    */  {
/* 315:315 */    int pos = HashCommon.murmurHash3(k) & this.mask;
/* 316:    */    
...
/* 322:    */  }
/* 323:    */  
/* 326:    */  public short removeFirstShort()
/* 327:    */  {
...
/* 336:    */    }
/* 337:337 */    short k = this.key[pos];
/* 338:338 */    shiftKeys(pos);
/* 339:339 */    return k;
/* 340:    */  }
/* 341:    */  
/* 344:    */  public short removeLastShort()
/* 345:    */  {
...
/* 394:    */  }
/* 395:    */  
/* 399:    */  public boolean addAndMoveToFirst(short k)
/* 400:    */  {
/* 401:401 */    short[] key = this.key;
/* 402:402 */    boolean[] used = this.used;
/* 403:403 */    int mask = this.mask;
/* 404:    */    
/* 405:405 */    int pos = HashCommon.murmurHash3(k) & mask;
/* 406:    */    
...
/* 429:    */  }
/* 430:    */  
/* 434:    */  public boolean addAndMoveToLast(short k)
/* 435:    */  {
/* 436:436 */    short[] key = this.key;
/* 437:437 */    boolean[] used = this.used;
/* 438:438 */    int mask = this.mask;
/* 439:    */    
/* 440:440 */    int pos = HashCommon.murmurHash3(k) & mask;
/* 441:    */    
...
/* 567:    */  }
/* 568:    */  
/* 571:    */  public short firstShort()
/* 572:    */  {
/* 573:573 */    if (this.size == 0) throw new NoSuchElementException();
/* 574:574 */    return this.key[this.first];
/* 575:    */  }
/* 576:    */  
/* 579:    */  public short lastShort()
/* 580:    */  {
/* 581:581 */    if (this.size == 0) throw new NoSuchElementException();
/* 582:582 */    return this.key[this.last]; }
/* 583:    */  
/* 584:584 */  public ShortSortedSet tailSet(short from) { throw new UnsupportedOperationException(); }
/* 585:585 */  public ShortSortedSet headSet(short to) { throw new UnsupportedOperationException(); }
/* 586:586 */  public ShortSortedSet subSet(short from, short to) { throw new UnsupportedOperationException(); }
/* 587:587 */  public ShortComparator comparator() { return null; }
/* 588:    */  
/* 593:    */  private class SetIterator
/* 594:    */    extends AbstractShortListIterator
/* 595:    */  {
/* 596:596 */    int prev = -1;
/* 597:    */    
/* 598:598 */    int next = -1;
...
/* 602:602 */    int index = -1;
/* 603:    */    
/* 604:604 */    SetIterator() { this.next = ShortLinkedOpenHashSet.this.first;
/* 605:605 */      this.index = 0;
/* 606:    */    }
/* 607:    */    
/* 608:608 */    SetIterator(short from) { if (ShortLinkedOpenHashSet.this.key[ShortLinkedOpenHashSet.this.last] == from) {
/* 609:609 */        this.prev = ShortLinkedOpenHashSet.this.last;
/* 610:610 */        this.index = ShortLinkedOpenHashSet.this.size;
/* 611:    */      }
/* 612:    */      else
/* 613:    */      {
/* 614:614 */        int pos = HashCommon.murmurHash3(from) & ShortLinkedOpenHashSet.this.mask;
/* 615:    */        
/* 616:616 */        while (ShortLinkedOpenHashSet.this.used[pos] != 0) {
/* 617:617 */          if (ShortLinkedOpenHashSet.this.key[pos] == from)
/* 618:    */          {
/* 619:619 */            this.next = ((int)ShortLinkedOpenHashSet.this.link[pos]);
/* 620:620 */            this.prev = pos;
/* 621:621 */            return;
/* 622:    */          }
/* 623:623 */          pos = pos + 1 & ShortLinkedOpenHashSet.this.mask;
/* 624:    */        }
...
/* 630:    */    
/* 631:631 */    public short nextShort() { if (!hasNext()) throw new NoSuchElementException();
/* 632:632 */      this.curr = this.next;
/* 633:633 */      this.next = ((int)ShortLinkedOpenHashSet.this.link[this.curr]);
/* 634:634 */      this.prev = this.curr;
/* 635:635 */      if (this.index >= 0) { this.index += 1;
/* 636:    */      }
/* 637:637 */      return ShortLinkedOpenHashSet.this.key[this.curr];
/* 638:    */    }
/* 639:    */    
/* 640:640 */    public short previousShort() { if (!hasPrevious()) throw new NoSuchElementException();
/* 641:641 */      this.curr = this.prev;
/* 642:642 */      this.prev = ((int)(ShortLinkedOpenHashSet.this.link[this.curr] >>> 32));
/* 643:643 */      this.next = this.curr;
/* 644:644 */      if (this.index >= 0) this.index -= 1;
/* 645:645 */      return ShortLinkedOpenHashSet.this.key[this.curr];
/* 646:    */    }
/* 647:    */    
...
/* 654:654 */        this.index = ShortLinkedOpenHashSet.this.size;
/* 655:655 */        return;
/* 656:    */      }
/* 657:657 */      int pos = ShortLinkedOpenHashSet.this.first;
/* 658:658 */      this.index = 1;
/* 659:659 */      while (pos != this.prev) {
/* 660:660 */        pos = (int)ShortLinkedOpenHashSet.this.link[pos];
...
/* 680:680 */        this.prev = ((int)(ShortLinkedOpenHashSet.this.link[this.curr] >>> 32));
/* 681:    */      }
/* 682:    */      else {
/* 683:683 */        this.next = ((int)ShortLinkedOpenHashSet.this.link[this.curr]); }
/* 684:684 */      ShortLinkedOpenHashSet.this.size -= 1;
/* 685:    */      
/* 687:687 */      if (this.prev == -1) { ShortLinkedOpenHashSet.this.first = this.next;
/* 688:    */      } else
/* 689:689 */        ShortLinkedOpenHashSet.this.link[this.prev] ^= (ShortLinkedOpenHashSet.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/* 690:690 */      if (this.next == -1) { ShortLinkedOpenHashSet.this.last = this.prev;
/* 691:    */      } else
/* 692:692 */        ShortLinkedOpenHashSet.this.link[this.next] ^= (ShortLinkedOpenHashSet.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/* 693:693 */      int pos = this.curr;
/* 694:    */      int last;
/* 695:    */      for (;;) {
/* 696:696 */        pos = (last = pos) + 1 & ShortLinkedOpenHashSet.this.mask;
/* 697:697 */        while (ShortLinkedOpenHashSet.this.used[pos] != 0) {
/* 698:698 */          int slot = HashCommon.murmurHash3(ShortLinkedOpenHashSet.this.key[pos]) & ShortLinkedOpenHashSet.this.mask;
/* 699:699 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 700:700 */          pos = pos + 1 & ShortLinkedOpenHashSet.this.mask;
/* 701:    */        }
/* 702:702 */        if (ShortLinkedOpenHashSet.this.used[pos] == 0) break;
/* 703:703 */        ShortLinkedOpenHashSet.this.key[last] = ShortLinkedOpenHashSet.this.key[pos];
/* 704:704 */        if (this.next == pos) this.next = last;
/* 705:705 */        if (this.prev == pos) this.prev = last;
/* 706:706 */        ShortLinkedOpenHashSet.this.fixPointers(pos, last);
/* 707:    */      }
/* 708:708 */      ShortLinkedOpenHashSet.this.used[last] = false;
/* 709:709 */      this.curr = -1;
/* 710:    */    }
/* 711:    */  }
/* 712:    */  
/* 718:    */  public ShortListIterator iterator(short from)
/* 719:    */  {
/* 720:720 */    return new SetIterator(from);
/* 721:    */  }
/* 722:    */  
/* 723:723 */  public ShortListIterator iterator() { return new SetIterator(); }
/* 724:    */  
/* 734:    */  @Deprecated
...
/* 799:    */    
/* 800:800 */    short[] key = this.key;
/* 801:801 */    int newMask = newN - 1;
/* 802:802 */    short[] newKey = new short[newN];
...
/* 808:808 */      short k = key[i];
/* 809:809 */      int pos = HashCommon.murmurHash3(k) & newMask;
...
/* 838:    */  }
/* 839:    */  
/* 842:    */  public ShortLinkedOpenHashSet clone()
/* 843:    */  {
/* 844:    */    ShortLinkedOpenHashSet c;
/* 845:    */    
/* 847:    */    try
/* 848:    */    {
/* 849:849 */      c = (ShortLinkedOpenHashSet)super.clone();
/* 850:    */    }
/* 851:    */    catch (CloneNotSupportedException cantHappen) {
/* 852:852 */      throw new InternalError();
/* 853:    */    }
/* 854:854 */    c.key = ((short[])this.key.clone());
...
/* 872:872 */      h += this.key[i];
/* 873:873 */      i++;
/* 874:    */    }
/* 875:875 */    return h;
/* 876:    */  }
/* 877:    */  
/* 878:878 */  private void writeObject(ObjectOutputStream s) throws IOException { ShortIterator i = iterator();
/* 879:879 */    s.defaultWriteObject();
/* 880:880 */    for (int j = this.size; j-- != 0; s.writeShort(i.nextShort())) {}
/* 881:    */  }
/* 882:    */  
...
/* 888:888 */    short[] key = this.key = new short[this.n];
...
/* 895:895 */      short k = s.readShort();
/* 896:896 */      pos = HashCommon.murmurHash3(k) & this.mask;
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.shorts.ShortLinkedOpenHashSet
