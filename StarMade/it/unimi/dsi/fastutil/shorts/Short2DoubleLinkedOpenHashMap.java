...
/*  786 */   public Short2DoubleSortedMap tailMap(short from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Short2DoubleSortedMap headMap(short to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Short2DoubleSortedMap subMap(short from, short to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Short2DoubleLinkedOpenHashMap.ValueIterator(Short2DoubleLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Short2DoubleLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(double v) {
/* 1113 */           return Short2DoubleLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Short2DoubleLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Short2DoubleLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements DoubleListIterator
/*      */   {
/*      */     public double previousDouble()
/*      */     {
/* 1094 */       return Short2DoubleLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Double previous() { return Double.valueOf(Short2DoubleLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public double nextDouble() { return Short2DoubleLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Double next() { return Double.valueOf(Short2DoubleLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Short2DoubleLinkedOpenHashMap.KeyIterator(Short2DoubleLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ShortListIterator iterator() {
/* 1054 */       return new Short2DoubleLinkedOpenHashMap.KeyIterator(Short2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Short2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(short k) {
/* 1060 */       return Short2DoubleLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(short k) {
/* 1063 */       int oldSize = Short2DoubleLinkedOpenHashMap.this.size;
/* 1064 */       Short2DoubleLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Short2DoubleLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Short2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public short firstShort() {
/* 1071 */       if (Short2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public short lastShort() {
/* 1075 */       if (Short2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator(short k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public short previousShort() { return Short2DoubleLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Short previous() { return Short.valueOf(Short2DoubleLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public short nextShort() { return Short2DoubleLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Short next() { return Short.valueOf(Short2DoubleLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  966 */       return new Short2DoubleLinkedOpenHashMap.EntryIterator(Short2DoubleLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Short2DoubleMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry fromElement, Short2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Short2DoubleMap.Entry first() {
/*  973 */       if (Short2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this, Short2DoubleLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Short2DoubleMap.Entry last() {
/*  977 */       if (Short2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this, Short2DoubleLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Short2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Short2DoubleLinkedOpenHashMap.this.key[pos] == k) return Short2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/*  990 */         pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Short2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Short2DoubleLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Short2DoubleLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Short2DoubleLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Short2DoubleLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from) {
/* 1018 */       return new Short2DoubleLinkedOpenHashMap.EntryIterator(Short2DoubleLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2DoubleMap.Entry> fastIterator() {
/* 1021 */       return new Short2DoubleLinkedOpenHashMap.FastEntryIterator(Short2DoubleLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2DoubleMap.Entry> fastIterator(Short2DoubleMap.Entry from) {
/* 1024 */       return new Short2DoubleLinkedOpenHashMap.FastEntryIterator(Short2DoubleLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Short2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Short2DoubleMap.Entry>
/*      */   {
/*  944 */     final AbstractShort2DoubleMap.BasicEntry entry = new AbstractShort2DoubleMap.BasicEntry((short)0, 0.0D);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Short2DoubleLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Short2DoubleLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractShort2DoubleMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Short2DoubleLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Short2DoubleLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2DoubleLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Short2DoubleMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Short2DoubleLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Short2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Short2DoubleLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(short from) {
/*  809 */       if (Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Short2DoubleLinkedOpenHashMap.this.last;
/*  811 */         this.index = Short2DoubleLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Short2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Short2DoubleLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Short2DoubleLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Short2DoubleLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Short2DoubleLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Short2DoubleLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Short2DoubleLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Short2DoubleLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Short2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Short2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Short2DoubleLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Short2DoubleLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Short2DoubleLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Short2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Short2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Short2DoubleLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Short2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Short2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*  897 */         while (Short2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Short2DoubleLinkedOpenHashMap.this.key[pos]) & Short2DoubleLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Short2DoubleLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Short2DoubleLinkedOpenHashMap.this.key[last] = Short2DoubleLinkedOpenHashMap.this.key[pos];
/*  904 */         Short2DoubleLinkedOpenHashMap.this.value[last] = Short2DoubleLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Short2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Short2DoubleLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Short getKey() {
/*  669 */       return Short.valueOf(Short2DoubleLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public short getShortKey() {
/*  672 */       return Short2DoubleLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Double getValue() {
/*  675 */       return Double.valueOf(Short2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public double getDoubleValue() {
/*  678 */       return Short2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public double setValue(double v) {
/*  681 */       double oldValue = Short2DoubleLinkedOpenHashMap.this.value[this.index];
/*  682 */       Short2DoubleLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Double setValue(Double v) {
...
/*  692 */       return (Short2DoubleLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Short2DoubleLinkedOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Short2DoubleLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public String toString() {
/*  698 */       return Short2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Short2DoubleLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
