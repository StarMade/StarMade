...
/*   22:     */
/*  113:     */public class Short2DoubleLinkedOpenHashMap
/*  114:     */  extends AbstractShort2DoubleSortedMap
...
/*  127:     */  protected volatile transient Short2DoubleSortedMap.FastSortedEntrySet entries;
...
/*  141:     */  
/*  149:     */  public Short2DoubleLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Short2DoubleLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Short2DoubleLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Short2DoubleLinkedOpenHashMap(Map<? extends Short, ? extends Double> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Short2DoubleLinkedOpenHashMap(Map<? extends Short, ? extends Double> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Short2DoubleLinkedOpenHashMap(Short2DoubleMap m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Short2DoubleLinkedOpenHashMap(Short2DoubleMap m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Short2DoubleLinkedOpenHashMap(short[] k, double[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Short2DoubleLinkedOpenHashMap(short[] k, double[] v)
/*  225:     */  {
/*  226: 226 */    this(k, v, 0.75F);
/*  227:     */  }
/*  228:     */  
/*  232:     */  public double put(short k, double v)
/*  233:     */  {
...
/*  260:     */  }
/*  261:     */  
/*  262: 262 */  public Double put(Short ok, Double ov) { double v = ov.doubleValue();
...
/*  291:     */  }
/*  292:     */  
/*  303:     */  public double add(short k, double incr)
/*  304:     */  {
...
/*  355:     */  }
/*  356:     */  
/*  357:     */  public double remove(short k)
/*  358:     */  {
...
/*  462:     */  }
/*  463:     */  
/*  467:     */  public double getAndMoveToFirst(short k)
/*  468:     */  {
...
/*  483:     */  }
/*  484:     */  
/*  488:     */  public double getAndMoveToLast(short k)
/*  489:     */  {
...
/*  504:     */  }
/*  505:     */  
/*  510:     */  public double putAndMoveToFirst(short k, double v)
/*  511:     */  {
...
/*  543:     */  }
/*  544:     */  
/*  549:     */  public double putAndMoveToLast(short k, double v)
/*  550:     */  {
...
/*  582:     */  }
/*  583:     */  
/*  584: 584 */  public Double get(Short ok) { short k = ok.shortValue();
/*  585:     */    
...
/*  660:     */    implements Short2DoubleMap.Entry, Map.Entry<Short, Double>
/*  661:     */  {
...
/*  667:     */    }
/*  668:     */    
/*  669: 669 */    public Short getKey() { return Short.valueOf(Short2DoubleLinkedOpenHashMap.this.key[this.index]); }
/*  670:     */    
/*  671:     */    public short getShortKey() {
/*  672: 672 */      return Short2DoubleLinkedOpenHashMap.this.key[this.index];
/*  673:     */    }
/*  674:     */    
/*  675: 675 */    public Double getValue() { return Double.valueOf(Short2DoubleLinkedOpenHashMap.this.value[this.index]); }
/*  676:     */    
/*  678: 678 */    public double getDoubleValue() { return Short2DoubleLinkedOpenHashMap.this.value[this.index]; }
/*  679:     */    
/*  680:     */    public double setValue(double v) {
/*  681: 681 */      double oldValue = Short2DoubleLinkedOpenHashMap.this.value[this.index];
/*  682: 682 */      Short2DoubleLinkedOpenHashMap.this.value[this.index] = v;
...
/*  691: 691 */      Map.Entry<Short, Double> e = (Map.Entry)o;
/*  692: 692 */      return (Short2DoubleLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2DoubleLinkedOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/*  693:     */    }
/*  694:     */    
/*  695: 695 */    public int hashCode() { return Short2DoubleLinkedOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Short2DoubleLinkedOpenHashMap.this.value[this.index]); }
/*  696:     */    
/*  697:     */    public String toString() {
/*  698: 698 */      return Short2DoubleLinkedOpenHashMap.this.key[this.index] + "=>" + Short2DoubleLinkedOpenHashMap.this.value[this.index];
/*  699:     */    }
/*  700:     */  }
/*  701:     */  
...
/*  786: 786 */  public Short2DoubleSortedMap tailMap(short from) { throw new UnsupportedOperationException(); }
/*  787: 787 */  public Short2DoubleSortedMap headMap(short to) { throw new UnsupportedOperationException(); }
/*  788: 788 */  public Short2DoubleSortedMap subMap(short from, short to) { throw new UnsupportedOperationException(); }
/*  789:     */  
...
/*  803: 803 */    int index = -1;
/*  804:     */    
/*  805: 805 */    private MapIterator() { this.next = Short2DoubleLinkedOpenHashMap.this.first;
/*  806: 806 */      this.index = 0;
/*  807:     */    }
/*  808:     */    
/*  809: 809 */    private MapIterator(short from) { if (Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.last] == from) {
/*  810: 810 */        this.prev = Short2DoubleLinkedOpenHashMap.this.last;
/*  811: 811 */        this.index = Short2DoubleLinkedOpenHashMap.this.size;
/*  812:     */      }
/*  813:     */      else
/*  814:     */      {
/*  815: 815 */        int pos = HashCommon.murmurHash3(from) & Short2DoubleLinkedOpenHashMap.this.mask;
/*  816:     */        
/*  817: 817 */        while (Short2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  818: 818 */          if (Short2DoubleLinkedOpenHashMap.this.key[pos] == from)
/*  819:     */          {
/*  820: 820 */            this.next = ((int)Short2DoubleLinkedOpenHashMap.this.link[pos]);
/*  821: 821 */            this.prev = pos;
/*  822: 822 */            return;
/*  823:     */          }
/*  824: 824 */          pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*  825:     */        }
...
/*  838: 838 */        this.index = Short2DoubleLinkedOpenHashMap.this.size;
/*  839: 839 */        return;
/*  840:     */      }
/*  841: 841 */      int pos = Short2DoubleLinkedOpenHashMap.this.first;
/*  842: 842 */      this.index = 1;
/*  843: 843 */      while (pos != this.prev) {
/*  844: 844 */        pos = (int)Short2DoubleLinkedOpenHashMap.this.link[pos];
...
/*  855:     */    }
/*  856:     */    
/*  857: 857 */    public int nextEntry() { if (!hasNext()) return Short2DoubleLinkedOpenHashMap.this.size();
/*  858: 858 */      this.curr = this.next;
/*  859: 859 */      this.next = ((int)Short2DoubleLinkedOpenHashMap.this.link[this.curr]);
...
/*  867: 867 */      this.prev = ((int)(Short2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  880: 880 */        this.prev = ((int)(Short2DoubleLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  881:     */      }
/*  882:     */      else {
/*  883: 883 */        this.next = ((int)Short2DoubleLinkedOpenHashMap.this.link[this.curr]); }
/*  884: 884 */      Short2DoubleLinkedOpenHashMap.this.size -= 1;
/*  885:     */      
/*  887: 887 */      if (this.prev == -1) { Short2DoubleLinkedOpenHashMap.this.first = this.next;
/*  888:     */      } else
/*  889: 889 */        Short2DoubleLinkedOpenHashMap.this.link[this.prev] ^= (Short2DoubleLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890: 890 */      if (this.next == -1) { Short2DoubleLinkedOpenHashMap.this.last = this.prev;
/*  891:     */      } else
/*  892: 892 */        Short2DoubleLinkedOpenHashMap.this.link[this.next] ^= (Short2DoubleLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  893: 893 */      int pos = this.curr;
/*  894:     */      int last;
/*  895:     */      for (;;) {
/*  896: 896 */        pos = (last = pos) + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*  897: 897 */        while (Short2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  898: 898 */          int slot = HashCommon.murmurHash3(Short2DoubleLinkedOpenHashMap.this.key[pos]) & Short2DoubleLinkedOpenHashMap.this.mask;
/*  899: 899 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900: 900 */          pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*  901:     */        }
/*  902: 902 */        if (Short2DoubleLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903: 903 */        Short2DoubleLinkedOpenHashMap.this.key[last] = Short2DoubleLinkedOpenHashMap.this.key[pos];
/*  904: 904 */        Short2DoubleLinkedOpenHashMap.this.value[last] = Short2DoubleLinkedOpenHashMap.this.value[pos];
/*  905: 905 */        if (this.next == pos) this.next = last;
/*  906: 906 */        if (this.prev == pos) this.prev = last;
/*  907: 907 */        Short2DoubleLinkedOpenHashMap.this.fixPointers(pos, last);
/*  908:     */      }
/*  909: 909 */      Short2DoubleLinkedOpenHashMap.this.used[last] = false;
/*  910: 910 */      this.curr = -1;
/*  911:     */    }
/*  912:     */    
...
/*  921:     */    } }
/*  922:     */  
/*  923:     */  private class EntryIterator extends Short2DoubleLinkedOpenHashMap.MapIterator implements ObjectListIterator<Short2DoubleMap.Entry> { private Short2DoubleLinkedOpenHashMap.MapEntry entry;
/*  924:     */    
/*  925: 925 */    public EntryIterator() { super(null); }
/*  926:     */    
/*  927: 927 */    public EntryIterator(short from) { super(from, null); }
/*  928:     */    
/*  929:     */    public Short2DoubleLinkedOpenHashMap.MapEntry next() {
/*  930: 930 */      return this.entry = new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this, nextEntry());
/*  931:     */    }
/*  932:     */    
/*  933: 933 */    public Short2DoubleLinkedOpenHashMap.MapEntry previous() { return this.entry = new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this, previousEntry()); }
/*  934:     */    
/*  935:     */    public void remove()
/*  936:     */    {
/*  937: 937 */      super.remove();
/*  938: 938 */      Short2DoubleLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  939:     */    
/*  940: 940 */    public void set(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  941: 941 */    public void add(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  942:     */  }
/*  943:     */  
/*  944: 944 */  private class FastEntryIterator extends Short2DoubleLinkedOpenHashMap.MapIterator implements ObjectListIterator<Short2DoubleMap.Entry> { final AbstractShort2DoubleMap.BasicEntry entry = new AbstractShort2DoubleMap.BasicEntry((short)0, 0.0D);
/*  945: 945 */    public FastEntryIterator() { super(null); }
/*  946:     */    
/*  947: 947 */    public FastEntryIterator(short from) { super(from, null); }
/*  948:     */    
/*  949:     */    public AbstractShort2DoubleMap.BasicEntry next() {
/*  950: 950 */      int e = nextEntry();
/*  951: 951 */      this.entry.key = Short2DoubleLinkedOpenHashMap.this.key[e];
/*  952: 952 */      this.entry.value = Short2DoubleLinkedOpenHashMap.this.value[e];
/*  953: 953 */      return this.entry;
/*  954:     */    }
/*  955:     */    
/*  956: 956 */    public AbstractShort2DoubleMap.BasicEntry previous() { int e = previousEntry();
/*  957: 957 */      this.entry.key = Short2DoubleLinkedOpenHashMap.this.key[e];
/*  958: 958 */      this.entry.value = Short2DoubleLinkedOpenHashMap.this.value[e];
/*  959: 959 */      return this.entry; }
/*  960:     */    
/*  961: 961 */    public void set(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  962: 962 */    public void add(Short2DoubleMap.Entry ok) { throw new UnsupportedOperationException(); } }
/*  963:     */  
/*  964:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Short2DoubleMap.Entry> implements Short2DoubleSortedMap.FastSortedEntrySet { private MapEntrySet() {}
/*  965:     */    
/*  966: 966 */    public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator() { return new Short2DoubleLinkedOpenHashMap.EntryIterator(Short2DoubleLinkedOpenHashMap.this); }
/*  967:     */    
/*  968: 968 */    public Comparator<? super Short2DoubleMap.Entry> comparator() { return null; }
/*  969: 969 */    public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry fromElement, Short2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  970: 970 */    public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  971: 971 */    public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry fromElement) { throw new UnsupportedOperationException(); }
/*  972:     */    
/*  973: 973 */    public Short2DoubleMap.Entry first() { if (Short2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974: 974 */      return new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this, Short2DoubleLinkedOpenHashMap.this.first);
/*  975:     */    }
/*  976:     */    
/*  977: 977 */    public Short2DoubleMap.Entry last() { if (Short2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978: 978 */      return new Short2DoubleLinkedOpenHashMap.MapEntry(Short2DoubleLinkedOpenHashMap.this, Short2DoubleLinkedOpenHashMap.this.last);
/*  979:     */    }
/*  980:     */    
/*  981:     */    public boolean contains(Object o) {
/*  982: 982 */      if (!(o instanceof Map.Entry)) return false;
/*  983: 983 */      Map.Entry<Short, Double> e = (Map.Entry)o;
/*  984: 984 */      short k = ((Short)e.getKey()).shortValue();
/*  985:     */      
/*  986: 986 */      int pos = HashCommon.murmurHash3(k) & Short2DoubleLinkedOpenHashMap.this.mask;
/*  987:     */      
/*  988: 988 */      while (Short2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/*  989: 989 */        if (Short2DoubleLinkedOpenHashMap.this.key[pos] == k) return Short2DoubleLinkedOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/*  990: 990 */        pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/*  991:     */      }
...
/*  997: 997 */      Map.Entry<Short, Double> e = (Map.Entry)o;
/*  998: 998 */      short k = ((Short)e.getKey()).shortValue();
/*  999:     */      
/* 1000:1000 */      int pos = HashCommon.murmurHash3(k) & Short2DoubleLinkedOpenHashMap.this.mask;
/* 1001:     */      
/* 1002:1002 */      while (Short2DoubleLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003:1003 */        if (Short2DoubleLinkedOpenHashMap.this.key[pos] == k) {
/* 1004:1004 */          Short2DoubleLinkedOpenHashMap.this.remove(e.getKey());
/* 1005:1005 */          return true;
/* 1006:     */        }
/* 1007:1007 */        pos = pos + 1 & Short2DoubleLinkedOpenHashMap.this.mask;
/* 1008:     */      }
/* 1009:1009 */      return false;
/* 1010:     */    }
/* 1011:     */    
/* 1012:1012 */    public int size() { return Short2DoubleLinkedOpenHashMap.this.size; }
/* 1013:     */    
/* 1014:     */    public void clear() {
/* 1015:1015 */      Short2DoubleLinkedOpenHashMap.this.clear();
/* 1016:     */    }
/* 1017:     */    
/* 1018:1018 */    public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from) { return new Short2DoubleLinkedOpenHashMap.EntryIterator(Short2DoubleLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue()); }
/* 1019:     */    
/* 1020:     */    public ObjectBidirectionalIterator<Short2DoubleMap.Entry> fastIterator() {
/* 1021:1021 */      return new Short2DoubleLinkedOpenHashMap.FastEntryIterator(Short2DoubleLinkedOpenHashMap.this);
/* 1022:     */    }
/* 1023:     */    
/* 1024:1024 */    public ObjectBidirectionalIterator<Short2DoubleMap.Entry> fastIterator(Short2DoubleMap.Entry from) { return new Short2DoubleLinkedOpenHashMap.FastEntryIterator(Short2DoubleLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue()); }
/* 1025:     */  }
/* 1026:     */  
/* 1027:     */  public Short2DoubleSortedMap.FastSortedEntrySet short2DoubleEntrySet() {
...
/* 1035:     */    extends Short2DoubleLinkedOpenHashMap.MapIterator
/* 1036:     */    implements ShortListIterator
/* 1037:     */  {
/* 1038:1038 */    public KeyIterator(short k) { super(k, null); }
/* 1039:1039 */    public short previousShort() { return Short2DoubleLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1042:1042 */    public Short previous() { return Short.valueOf(Short2DoubleLinkedOpenHashMap.this.key[previousEntry()]); }
...
/* 1046:1046 */    public short nextShort() { return Short2DoubleLinkedOpenHashMap.this.key[nextEntry()]; }
/* 1047:1047 */    public Short next() { return Short.valueOf(Short2DoubleLinkedOpenHashMap.this.key[nextEntry()]); } }
/* 1048:     */  
/* 1049:     */  private final class KeySet extends AbstractShortSortedSet { private KeySet() {}
/* 1050:     */    
/* 1051:1051 */    public ShortListIterator iterator(short from) { return new Short2DoubleLinkedOpenHashMap.KeyIterator(Short2DoubleLinkedOpenHashMap.this, from); }
/* 1052:     */    
/* 1053:     */    public ShortListIterator iterator() {
/* 1054:1054 */      return new Short2DoubleLinkedOpenHashMap.KeyIterator(Short2DoubleLinkedOpenHashMap.this);
/* 1055:     */    }
/* 1056:     */    
/* 1057:1057 */    public int size() { return Short2DoubleLinkedOpenHashMap.this.size; }
/* 1058:     */    
/* 1060:1060 */    public boolean contains(short k) { return Short2DoubleLinkedOpenHashMap.this.containsKey(k); }
/* 1061:     */    
/* 1062:     */    public boolean remove(short k) {
/* 1063:1063 */      int oldSize = Short2DoubleLinkedOpenHashMap.this.size;
/* 1064:1064 */      Short2DoubleLinkedOpenHashMap.this.remove(k);
/* 1065:1065 */      return Short2DoubleLinkedOpenHashMap.this.size != oldSize;
/* 1066:     */    }
/* 1067:     */    
/* 1068:1068 */    public void clear() { Short2DoubleLinkedOpenHashMap.this.clear(); }
/* 1069:     */    
/* 1070:     */    public short firstShort() {
/* 1071:1071 */      if (Short2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072:1072 */      return Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.first];
/* 1073:     */    }
/* 1074:     */    
/* 1075:1075 */    public short lastShort() { if (Short2DoubleLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076:1076 */      return Short2DoubleLinkedOpenHashMap.this.key[Short2DoubleLinkedOpenHashMap.this.last]; }
/* 1077:     */    
...
/* 1091:     */    extends Short2DoubleLinkedOpenHashMap.MapIterator
/* 1092:     */    implements DoubleListIterator
/* 1093:     */  {
/* 1094:1094 */    public double previousDouble() { return Short2DoubleLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1095:1095 */    public Double previous() { return Double.valueOf(Short2DoubleLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1101:1101 */    public double nextDouble() { return Short2DoubleLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1102:1102 */    public Double next() { return Double.valueOf(Short2DoubleLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1103:     */  }
/* 1104:     */  
...
/* 1107:1107 */          return new Short2DoubleLinkedOpenHashMap.ValueIterator(Short2DoubleLinkedOpenHashMap.this);
/* 1108:     */        }
/* 1109:     */        
/* 1110:1110 */        public int size() { return Short2DoubleLinkedOpenHashMap.this.size; }
/* 1111:     */        
/* 1112:     */        public boolean contains(double v) {
/* 1113:1113 */          return Short2DoubleLinkedOpenHashMap.this.containsValue(v);
/* 1114:     */        }
/* 1115:     */        
/* 1116:1116 */        public void clear() { Short2DoubleLinkedOpenHashMap.this.clear(); }
/* 1117:     */      };
/* 1118:     */    }
...
/* 1238:     */  }
/* 1239:     */  
/* 1242:     */  public Short2DoubleLinkedOpenHashMap clone()
/* 1243:     */  {
/* 1244:     */    Short2DoubleLinkedOpenHashMap c;
/* 1245:     */    
/* 1247:     */    try
/* 1248:     */    {
/* 1249:1249 */      c = (Short2DoubleLinkedOpenHashMap)super.clone();
/* 1250:     */    }
