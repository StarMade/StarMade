...
/*     */ 
/*     */ public class Short2ByteOpenHashMap extends AbstractShort2ByteMap
...
/* 642 */           return new Short2ByteOpenHashMap.ValueIterator(Short2ByteOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Short2ByteOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(byte v) {
/* 648 */           return Short2ByteOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Short2ByteOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Short2ByteOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Short2ByteOpenHashMap.MapIterator
/*     */     implements ByteIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public byte nextByte() { return Short2ByteOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Byte next() { return Byte.valueOf(Short2ByteOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Short2ByteOpenHashMap.KeyIterator(Short2ByteOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Short2ByteOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(short k) {
/* 613 */       return Short2ByteOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(short k) {
/* 616 */       int oldSize = Short2ByteOpenHashMap.this.size;
/* 617 */       Short2ByteOpenHashMap.this.remove(k);
/* 618 */       return Short2ByteOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Short2ByteOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Short2ByteOpenHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public short nextShort() { return Short2ByteOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Short next() { return Short.valueOf(Short2ByteOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Short2ByteOpenHashMap.EntryIterator(Short2ByteOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Short2ByteMap.Entry> fastIterator() {
/* 550 */       return new Short2ByteOpenHashMap.FastEntryIterator(Short2ByteOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Short2ByteOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Short2ByteOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Short2ByteOpenHashMap.this.key[pos] == k) return Short2ByteOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/* 562 */         pos = pos + 1 & Short2ByteOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Short2ByteOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Short2ByteOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Short2ByteOpenHashMap.this.key[pos] == k) {
/* 576 */           Short2ByteOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Short2ByteOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Short2ByteOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Short2ByteOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Short2ByteOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Short2ByteMap.Entry>
/*     */   {
/* 537 */     final AbstractShort2ByteMap.BasicEntry entry = new AbstractShort2ByteMap.BasicEntry((short)0, (byte)0);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Short2ByteOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Short2ByteOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Short2ByteOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Short2ByteMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Short2ByteOpenHashMap.MapEntry(Short2ByteOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Short2ByteOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Short2ByteOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Short2ByteOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Short2ByteOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Short2ByteOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Short2ByteOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Short2ByteOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Short2ByteOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Short2ByteOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Short2ByteOpenHashMap.this.mask;
/* 485 */         while (Short2ByteOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Short2ByteOpenHashMap.this.key[pos]) & Short2ByteOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Short2ByteOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Short2ByteOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 494 */           this.wrapped.add(Short2ByteOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Short2ByteOpenHashMap.this.key[last] = Short2ByteOpenHashMap.this.key[pos];
/* 497 */         Short2ByteOpenHashMap.this.value[last] = Short2ByteOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Short2ByteOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Short2ByteOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Short2ByteOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Short getKey() {
/* 398 */       return Short.valueOf(Short2ByteOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public short getShortKey() {
/* 401 */       return Short2ByteOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Byte getValue() {
/* 404 */       return Byte.valueOf(Short2ByteOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public byte getByteValue() {
/* 407 */       return Short2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public byte setValue(byte v) {
/* 410 */       byte oldValue = Short2ByteOpenHashMap.this.value[this.index];
/* 411 */       Short2ByteOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
/*     */     public Byte setValue(Byte v) {
...
/* 421 */       return (Short2ByteOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2ByteOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Short2ByteOpenHashMap.this.key[this.index] ^ Short2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 427 */       return Short2ByteOpenHashMap.this.key[this.index] + "=>" + Short2ByteOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
