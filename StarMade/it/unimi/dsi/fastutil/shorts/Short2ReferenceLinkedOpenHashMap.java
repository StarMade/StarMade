...
/*  730 */   public Short2ReferenceSortedMap<V> tailMap(short from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Short2ReferenceSortedMap<V> headMap(short to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Short2ReferenceSortedMap<V> subMap(short from, short to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Short2ReferenceLinkedOpenHashMap.ValueIterator(Short2ReferenceLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Short2ReferenceLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Short2ReferenceLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Short2ReferenceLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1190 */       c = (Short2ReferenceLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Short2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Short2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Short2ReferenceLinkedOpenHashMap.KeyIterator(Short2ReferenceLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ShortListIterator iterator() {
/*  999 */       return new Short2ReferenceLinkedOpenHashMap.KeyIterator(Short2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Short2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(short k) {
/* 1005 */       return Short2ReferenceLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(short k) {
/* 1008 */       int oldSize = Short2ReferenceLinkedOpenHashMap.this.size;
/* 1009 */       Short2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Short2ReferenceLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Short2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public short firstShort() {
/* 1016 */       if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Short2ReferenceLinkedOpenHashMap.this.key[Short2ReferenceLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public short lastShort() {
/* 1020 */       if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Short2ReferenceLinkedOpenHashMap.this.key[Short2ReferenceLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2ReferenceLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator(short k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public short previousShort() { return Short2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/*  987 */     public Short previous() { return Short.valueOf(Short2ReferenceLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/*  991 */     public short nextShort() { return Short2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Short next() { return Short.valueOf(Short2ReferenceLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Short2ReferenceLinkedOpenHashMap.EntryIterator(Short2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Short2ReferenceMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Short2ReferenceMap.Entry<V>> subSet(Short2ReferenceMap.Entry<V> fromElement, Short2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Short2ReferenceMap.Entry<V>> headSet(Short2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Short2ReferenceMap.Entry<V>> tailSet(Short2ReferenceMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Short2ReferenceMap.Entry<V> first() {
/*  918 */       if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this, Short2ReferenceLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Short2ReferenceMap.Entry<V> last() {
/*  922 */       if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this, Short2ReferenceLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  931 */       int pos = HashCommon.murmurHash3(k) & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Short2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Short2ReferenceLinkedOpenHashMap.this.key[pos] == k) return Short2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  935 */         pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/*  945 */       int pos = HashCommon.murmurHash3(k) & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Short2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Short2ReferenceLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Short2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Short2ReferenceLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Short2ReferenceLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> from) {
/*  963 */       return new Short2ReferenceLinkedOpenHashMap.EntryIterator(Short2ReferenceLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> fastIterator() {
/*  966 */       return new Short2ReferenceLinkedOpenHashMap.FastEntryIterator(Short2ReferenceLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> fastIterator(Short2ReferenceMap.Entry<V> from) {
/*  969 */       return new Short2ReferenceLinkedOpenHashMap.FastEntryIterator(Short2ReferenceLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Short2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Short2ReferenceMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractShort2ReferenceMap.BasicEntry<V> entry = new AbstractShort2ReferenceMap.BasicEntry((short)0, null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Short2ReferenceLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Short2ReferenceLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractShort2ReferenceMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Short2ReferenceLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Short2ReferenceLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2ReferenceLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Short2ReferenceMap.Entry<V>>
/*      */   {
...
/*  875 */       return this.entry = new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Short2ReferenceLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Short2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Short2ReferenceLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(short from) {
/*  753 */       if (Short2ReferenceLinkedOpenHashMap.this.key[Short2ReferenceLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Short2ReferenceLinkedOpenHashMap.this.last;
/*  755 */         this.index = Short2ReferenceLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = HashCommon.murmurHash3(from) & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Short2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Short2ReferenceLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Short2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Short2ReferenceLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Short2ReferenceLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Short2ReferenceLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Short2ReferenceLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Short2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Short2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Short2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Short2ReferenceLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Short2ReferenceLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Short2ReferenceLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Short2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Short2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Short2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Short2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Short2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  841 */         while (Short2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = HashCommon.murmurHash3(Short2ReferenceLinkedOpenHashMap.this.key[pos]) & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Short2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Short2ReferenceLinkedOpenHashMap.this.key[last] = Short2ReferenceLinkedOpenHashMap.this.key[pos];
/*  848 */         Short2ReferenceLinkedOpenHashMap.this.value[last] = Short2ReferenceLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Short2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Short2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Short2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Short getKey() {
/*  619 */       return Short.valueOf(Short2ReferenceLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public short getShortKey() {
/*  622 */       return Short2ReferenceLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Short2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Short2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  629 */       Short2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Short2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return Short2ReferenceLinkedOpenHashMap.this.key[this.index] ^ (Short2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Short2ReferenceLinkedOpenHashMap.this.value[this.index]));
/*      */     }
/*      */     public String toString() {
/*  642 */       return Short2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Short2ReferenceLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
