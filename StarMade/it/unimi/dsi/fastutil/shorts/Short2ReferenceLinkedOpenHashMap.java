...
/*   22:     */
/*  101:     */public class Short2ReferenceLinkedOpenHashMap<V>
/*  102:     */  extends AbstractShort2ReferenceSortedMap<V>
...
/*  107:     */  protected transient short[] key;
...
/*  115:     */  protected volatile transient Short2ReferenceSortedMap.FastSortedEntrySet<V> entries;
/*  116:     */  protected volatile transient ShortSortedSet keys;
...
/*  129:     */  
/*  137:     */  public Short2ReferenceLinkedOpenHashMap(int expected, float f)
/*  138:     */  {
...
/*  145: 145 */    this.key = new short[this.n];
/*  146: 146 */    this.value = ((Object[])new Object[this.n]);
/*  147: 147 */    this.used = new boolean[this.n];
/*  148: 148 */    this.link = new long[this.n];
/*  149:     */  }
/*  150:     */  
/*  153:     */  public Short2ReferenceLinkedOpenHashMap(int expected)
/*  154:     */  {
/*  155: 155 */    this(expected, 0.75F);
/*  156:     */  }
/*  157:     */  
/*  159:     */  public Short2ReferenceLinkedOpenHashMap()
/*  160:     */  {
/*  161: 161 */    this(16, 0.75F);
/*  162:     */  }
/*  163:     */  
/*  167:     */  public Short2ReferenceLinkedOpenHashMap(Map<? extends Short, ? extends V> m, float f)
/*  168:     */  {
/*  169: 169 */    this(m.size(), f);
/*  170: 170 */    putAll(m);
/*  171:     */  }
/*  172:     */  
/*  175:     */  public Short2ReferenceLinkedOpenHashMap(Map<? extends Short, ? extends V> m)
/*  176:     */  {
/*  177: 177 */    this(m, 0.75F);
/*  178:     */  }
/*  179:     */  
/*  183:     */  public Short2ReferenceLinkedOpenHashMap(Short2ReferenceMap<V> m, float f)
/*  184:     */  {
/*  185: 185 */    this(m.size(), f);
/*  186: 186 */    putAll(m);
/*  187:     */  }
/*  188:     */  
/*  191:     */  public Short2ReferenceLinkedOpenHashMap(Short2ReferenceMap<V> m)
/*  192:     */  {
/*  193: 193 */    this(m, 0.75F);
/*  194:     */  }
/*  195:     */  
/*  201:     */  public Short2ReferenceLinkedOpenHashMap(short[] k, V[] v, float f)
/*  202:     */  {
...
/*  207:     */  }
/*  208:     */  
/*  212:     */  public Short2ReferenceLinkedOpenHashMap(short[] k, V[] v)
/*  213:     */  {
/*  214: 214 */    this(k, v, 0.75F);
/*  215:     */  }
/*  216:     */  
/*  220:     */  public V put(short k, V v)
/*  221:     */  {
...
/*  248:     */  }
/*  249:     */  
/*  250: 250 */  public V put(Short ok, V ov) { V v = ov;
/*  251: 251 */    short k = ok.shortValue();
/*  252:     */    
...
/*  324: 324 */    short k = ((Short)ok).shortValue();
/*  325:     */    
...
/*  411:     */  }
/*  412:     */  
/*  416:     */  public V getAndMoveToFirst(short k)
/*  417:     */  {
/*  418: 418 */    short[] key = this.key;
...
/*  432:     */  }
/*  433:     */  
/*  437:     */  public V getAndMoveToLast(short k)
/*  438:     */  {
/*  439: 439 */    short[] key = this.key;
...
/*  453:     */  }
/*  454:     */  
/*  459:     */  public V putAndMoveToFirst(short k, V v)
/*  460:     */  {
/*  461: 461 */    short[] key = this.key;
...
/*  492:     */  }
/*  493:     */  
/*  498:     */  public V putAndMoveToLast(short k, V v)
/*  499:     */  {
/*  500: 500 */    short[] key = this.key;
...
/*  531:     */  }
/*  532:     */  
/*  533: 533 */  public V get(Short ok) { short k = ok.shortValue();
/*  534:     */    
...
/*  553:     */  }
/*  554:     */  
/*  555:     */  public boolean containsKey(short k)
/*  556:     */  {
...
/*  610:     */    implements Short2ReferenceMap.Entry<V>, Map.Entry<Short, V>
/*  611:     */  {
...
/*  617:     */    }
/*  618:     */    
/*  619: 619 */    public Short getKey() { return Short.valueOf(Short2ReferenceLinkedOpenHashMap.this.key[this.index]); }
/*  620:     */    
/*  621:     */    public short getShortKey() {
/*  622: 622 */      return Short2ReferenceLinkedOpenHashMap.this.key[this.index];
/*  623:     */    }
/*  624:     */    
/*  625: 625 */    public V getValue() { return Short2ReferenceLinkedOpenHashMap.this.value[this.index]; }
/*  626:     */    
/*  627:     */    public V setValue(V v) {
/*  628: 628 */      V oldValue = Short2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  629: 629 */      Short2ReferenceLinkedOpenHashMap.this.value[this.index] = v;
/*  630: 630 */      return oldValue;
/*  631:     */    }
/*  632:     */    
/*  633:     */    public boolean equals(Object o) {
/*  634: 634 */      if (!(o instanceof Map.Entry)) return false;
/*  635: 635 */      Map.Entry<Short, V> e = (Map.Entry)o;
/*  636: 636 */      return (Short2ReferenceLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2ReferenceLinkedOpenHashMap.this.value[this.index] == e.getValue());
/*  637:     */    }
/*  638:     */    
/*  639: 639 */    public int hashCode() { return Short2ReferenceLinkedOpenHashMap.this.key[this.index] ^ (Short2ReferenceLinkedOpenHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Short2ReferenceLinkedOpenHashMap.this.value[this.index])); }
/*  640:     */    
/*  641:     */    public String toString() {
/*  642: 642 */      return Short2ReferenceLinkedOpenHashMap.this.key[this.index] + "=>" + Short2ReferenceLinkedOpenHashMap.this.value[this.index];
/*  643:     */    }
/*  644:     */  }
/*  645:     */  
...
/*  712:     */  }
/*  713:     */  
/*  716:     */  public short firstShortKey()
/*  717:     */  {
/*  718: 718 */    if (this.size == 0) throw new NoSuchElementException();
/*  719: 719 */    return this.key[this.first];
/*  720:     */  }
/*  721:     */  
/*  724:     */  public short lastShortKey()
/*  725:     */  {
/*  726: 726 */    if (this.size == 0) throw new NoSuchElementException();
/*  727: 727 */    return this.key[this.last]; }
/*  728:     */  
/*  729: 729 */  public ShortComparator comparator() { return null; }
/*  730: 730 */  public Short2ReferenceSortedMap<V> tailMap(short from) { throw new UnsupportedOperationException(); }
/*  731: 731 */  public Short2ReferenceSortedMap<V> headMap(short to) { throw new UnsupportedOperationException(); }
/*  732: 732 */  public Short2ReferenceSortedMap<V> subMap(short from, short to) { throw new UnsupportedOperationException(); }
/*  733:     */  
...
/*  747: 747 */    int index = -1;
/*  748:     */    
/*  749: 749 */    private MapIterator() { this.next = Short2ReferenceLinkedOpenHashMap.this.first;
/*  750: 750 */      this.index = 0;
/*  751:     */    }
/*  752:     */    
/*  753: 753 */    private MapIterator(short from) { if (Short2ReferenceLinkedOpenHashMap.this.key[Short2ReferenceLinkedOpenHashMap.this.last] == from) {
/*  754: 754 */        this.prev = Short2ReferenceLinkedOpenHashMap.this.last;
/*  755: 755 */        this.index = Short2ReferenceLinkedOpenHashMap.this.size;
/*  756:     */      }
/*  757:     */      else
/*  758:     */      {
/*  759: 759 */        int pos = HashCommon.murmurHash3(from) & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  760:     */        
/*  761: 761 */        while (Short2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  762: 762 */          if (Short2ReferenceLinkedOpenHashMap.this.key[pos] == from)
/*  763:     */          {
/*  764: 764 */            this.next = ((int)Short2ReferenceLinkedOpenHashMap.this.link[pos]);
/*  765: 765 */            this.prev = pos;
/*  766: 766 */            return;
/*  767:     */          }
/*  768: 768 */          pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  769:     */        }
...
/*  782: 782 */        this.index = Short2ReferenceLinkedOpenHashMap.this.size;
/*  783: 783 */        return;
/*  784:     */      }
/*  785: 785 */      int pos = Short2ReferenceLinkedOpenHashMap.this.first;
/*  786: 786 */      this.index = 1;
/*  787: 787 */      while (pos != this.prev) {
/*  788: 788 */        pos = (int)Short2ReferenceLinkedOpenHashMap.this.link[pos];
...
/*  799:     */    }
/*  800:     */    
/*  801: 801 */    public int nextEntry() { if (!hasNext()) return Short2ReferenceLinkedOpenHashMap.this.size();
/*  802: 802 */      this.curr = this.next;
/*  803: 803 */      this.next = ((int)Short2ReferenceLinkedOpenHashMap.this.link[this.curr]);
...
/*  811: 811 */      this.prev = ((int)(Short2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  824: 824 */        this.prev = ((int)(Short2ReferenceLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  825:     */      }
/*  826:     */      else {
/*  827: 827 */        this.next = ((int)Short2ReferenceLinkedOpenHashMap.this.link[this.curr]); }
/*  828: 828 */      Short2ReferenceLinkedOpenHashMap.this.size -= 1;
/*  829:     */      
/*  831: 831 */      if (this.prev == -1) { Short2ReferenceLinkedOpenHashMap.this.first = this.next;
/*  832:     */      } else
/*  833: 833 */        Short2ReferenceLinkedOpenHashMap.this.link[this.prev] ^= (Short2ReferenceLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834: 834 */      if (this.next == -1) { Short2ReferenceLinkedOpenHashMap.this.last = this.prev;
/*  835:     */      } else
/*  836: 836 */        Short2ReferenceLinkedOpenHashMap.this.link[this.next] ^= (Short2ReferenceLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  837: 837 */      int pos = this.curr;
/*  838:     */      int last;
/*  839:     */      for (;;) {
/*  840: 840 */        pos = (last = pos) + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  841: 841 */        while (Short2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  842: 842 */          int slot = HashCommon.murmurHash3(Short2ReferenceLinkedOpenHashMap.this.key[pos]) & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  843: 843 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844: 844 */          pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  845:     */        }
/*  846: 846 */        if (Short2ReferenceLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847: 847 */        Short2ReferenceLinkedOpenHashMap.this.key[last] = Short2ReferenceLinkedOpenHashMap.this.key[pos];
/*  848: 848 */        Short2ReferenceLinkedOpenHashMap.this.value[last] = Short2ReferenceLinkedOpenHashMap.this.value[pos];
/*  849: 849 */        if (this.next == pos) this.next = last;
/*  850: 850 */        if (this.prev == pos) this.prev = last;
/*  851: 851 */        Short2ReferenceLinkedOpenHashMap.this.fixPointers(pos, last);
/*  852:     */      }
/*  853: 853 */      Short2ReferenceLinkedOpenHashMap.this.used[last] = false;
/*  854: 854 */      Short2ReferenceLinkedOpenHashMap.this.value[last] = null;
/*  855: 855 */      this.curr = -1;
/*  856:     */    }
/*  857:     */    
...
/*  866:     */    } }
/*  867:     */  
/*  868:     */  private class EntryIterator extends Short2ReferenceLinkedOpenHashMap<V>.MapIterator implements ObjectListIterator<Short2ReferenceMap.Entry<V>> { private Short2ReferenceLinkedOpenHashMap<V>.MapEntry entry;
/*  869:     */    
/*  870: 870 */    public EntryIterator() { super(null); }
/*  871:     */    
/*  872: 872 */    public EntryIterator(short from) { super(from, null); }
/*  873:     */    
/*  874:     */    public Short2ReferenceLinkedOpenHashMap<V>.MapEntry next() {
/*  875: 875 */      return this.entry = new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this, nextEntry());
/*  876:     */    }
/*  877:     */    
/*  878: 878 */    public Short2ReferenceLinkedOpenHashMap<V>.MapEntry previous() { return this.entry = new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this, previousEntry()); }
/*  879:     */    
/*  880:     */    public void remove()
/*  881:     */    {
/*  882: 882 */      super.remove();
/*  883: 883 */      Short2ReferenceLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  884:     */    
/*  885: 885 */    public void set(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*  886: 886 */    public void add(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*  887:     */  }
/*  888:     */  
/*  889: 889 */  private class FastEntryIterator extends Short2ReferenceLinkedOpenHashMap<V>.MapIterator implements ObjectListIterator<Short2ReferenceMap.Entry<V>> { final AbstractShort2ReferenceMap.BasicEntry<V> entry = new AbstractShort2ReferenceMap.BasicEntry((short)0, null);
/*  890: 890 */    public FastEntryIterator() { super(null); }
/*  891:     */    
/*  892: 892 */    public FastEntryIterator(short from) { super(from, null); }
/*  893:     */    
/*  894:     */    public AbstractShort2ReferenceMap.BasicEntry<V> next() {
/*  895: 895 */      int e = nextEntry();
/*  896: 896 */      this.entry.key = Short2ReferenceLinkedOpenHashMap.this.key[e];
/*  897: 897 */      this.entry.value = Short2ReferenceLinkedOpenHashMap.this.value[e];
/*  898: 898 */      return this.entry;
/*  899:     */    }
/*  900:     */    
/*  901: 901 */    public AbstractShort2ReferenceMap.BasicEntry<V> previous() { int e = previousEntry();
/*  902: 902 */      this.entry.key = Short2ReferenceLinkedOpenHashMap.this.key[e];
/*  903: 903 */      this.entry.value = Short2ReferenceLinkedOpenHashMap.this.value[e];
/*  904: 904 */      return this.entry; }
/*  905:     */    
/*  906: 906 */    public void set(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*  907: 907 */    public void add(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } }
/*  908:     */  
/*  909:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Short2ReferenceMap.Entry<V>> implements Short2ReferenceSortedMap.FastSortedEntrySet<V> { private MapEntrySet() {}
/*  910:     */    
/*  911: 911 */    public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator() { return new Short2ReferenceLinkedOpenHashMap.EntryIterator(Short2ReferenceLinkedOpenHashMap.this); }
/*  912:     */    
/*  913: 913 */    public Comparator<? super Short2ReferenceMap.Entry<V>> comparator() { return null; }
/*  914: 914 */    public ObjectSortedSet<Short2ReferenceMap.Entry<V>> subSet(Short2ReferenceMap.Entry<V> fromElement, Short2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); }
/*  915: 915 */    public ObjectSortedSet<Short2ReferenceMap.Entry<V>> headSet(Short2ReferenceMap.Entry<V> toElement) { throw new UnsupportedOperationException(); }
/*  916: 916 */    public ObjectSortedSet<Short2ReferenceMap.Entry<V>> tailSet(Short2ReferenceMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); }
/*  917:     */    
/*  918: 918 */    public Short2ReferenceMap.Entry<V> first() { if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919: 919 */      return new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this, Short2ReferenceLinkedOpenHashMap.this.first);
/*  920:     */    }
/*  921:     */    
/*  922: 922 */    public Short2ReferenceMap.Entry<V> last() { if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923: 923 */      return new Short2ReferenceLinkedOpenHashMap.MapEntry(Short2ReferenceLinkedOpenHashMap.this, Short2ReferenceLinkedOpenHashMap.this.last);
/*  924:     */    }
/*  925:     */    
/*  926:     */    public boolean contains(Object o) {
/*  927: 927 */      if (!(o instanceof Map.Entry)) return false;
/*  928: 928 */      Map.Entry<Short, V> e = (Map.Entry)o;
/*  929: 929 */      short k = ((Short)e.getKey()).shortValue();
/*  930:     */      
/*  931: 931 */      int pos = HashCommon.murmurHash3(k) & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  932:     */      
/*  933: 933 */      while (Short2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  934: 934 */        if (Short2ReferenceLinkedOpenHashMap.this.key[pos] == k) return Short2ReferenceLinkedOpenHashMap.this.value[pos] == e.getValue();
/*  935: 935 */        pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  936:     */      }
...
/*  942: 942 */      Map.Entry<Short, V> e = (Map.Entry)o;
/*  943: 943 */      short k = ((Short)e.getKey()).shortValue();
/*  944:     */      
/*  945: 945 */      int pos = HashCommon.murmurHash3(k) & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  946:     */      
/*  947: 947 */      while (Short2ReferenceLinkedOpenHashMap.this.used[pos] != 0) {
/*  948: 948 */        if (Short2ReferenceLinkedOpenHashMap.this.key[pos] == k) {
/*  949: 949 */          Short2ReferenceLinkedOpenHashMap.this.remove(e.getKey());
/*  950: 950 */          return true;
/*  951:     */        }
/*  952: 952 */        pos = pos + 1 & Short2ReferenceLinkedOpenHashMap.this.mask;
/*  953:     */      }
/*  954: 954 */      return false;
/*  955:     */    }
/*  956:     */    
/*  957: 957 */    public int size() { return Short2ReferenceLinkedOpenHashMap.this.size; }
/*  958:     */    
/*  959:     */    public void clear() {
/*  960: 960 */      Short2ReferenceLinkedOpenHashMap.this.clear();
/*  961:     */    }
/*  962:     */    
/*  963: 963 */    public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> from) { return new Short2ReferenceLinkedOpenHashMap.EntryIterator(Short2ReferenceLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue()); }
/*  964:     */    
/*  965:     */    public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> fastIterator() {
/*  966: 966 */      return new Short2ReferenceLinkedOpenHashMap.FastEntryIterator(Short2ReferenceLinkedOpenHashMap.this);
/*  967:     */    }
/*  968:     */    
/*  969: 969 */    public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> fastIterator(Short2ReferenceMap.Entry<V> from) { return new Short2ReferenceLinkedOpenHashMap.FastEntryIterator(Short2ReferenceLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue()); }
/*  970:     */  }
/*  971:     */  
/*  972:     */  public Short2ReferenceSortedMap.FastSortedEntrySet<V> short2ReferenceEntrySet() {
...
/*  980:     */    extends Short2ReferenceLinkedOpenHashMap.MapIterator
/*  981:     */    implements ShortListIterator
/*  982:     */  {
/*  983: 983 */    public KeyIterator(short k) { super(k, null); }
/*  984: 984 */    public short previousShort() { return Short2ReferenceLinkedOpenHashMap.this.key[previousEntry()]; }
/*  985: 985 */    public void set(short k) { throw new UnsupportedOperationException(); }
/*  986: 986 */    public void add(short k) { throw new UnsupportedOperationException(); }
/*  987: 987 */    public Short previous() { return Short.valueOf(Short2ReferenceLinkedOpenHashMap.this.key[previousEntry()]); }
/*  988: 988 */    public void set(Short ok) { throw new UnsupportedOperationException(); }
/*  989: 989 */    public void add(Short ok) { throw new UnsupportedOperationException(); }
/*  990: 990 */    public KeyIterator() { super(null); }
/*  991: 991 */    public short nextShort() { return Short2ReferenceLinkedOpenHashMap.this.key[nextEntry()]; }
/*  992: 992 */    public Short next() { return Short.valueOf(Short2ReferenceLinkedOpenHashMap.this.key[nextEntry()]); } }
/*  993:     */  
/*  994:     */  private final class KeySet extends AbstractShortSortedSet { private KeySet() {}
/*  995:     */    
/*  996: 996 */    public ShortListIterator iterator(short from) { return new Short2ReferenceLinkedOpenHashMap.KeyIterator(Short2ReferenceLinkedOpenHashMap.this, from); }
/*  997:     */    
/*  998:     */    public ShortListIterator iterator() {
/*  999: 999 */      return new Short2ReferenceLinkedOpenHashMap.KeyIterator(Short2ReferenceLinkedOpenHashMap.this);
/* 1000:     */    }
/* 1001:     */    
/* 1002:1002 */    public int size() { return Short2ReferenceLinkedOpenHashMap.this.size; }
/* 1003:     */    
/* 1005:1005 */    public boolean contains(short k) { return Short2ReferenceLinkedOpenHashMap.this.containsKey(k); }
/* 1006:     */    
/* 1007:     */    public boolean remove(short k) {
/* 1008:1008 */      int oldSize = Short2ReferenceLinkedOpenHashMap.this.size;
/* 1009:1009 */      Short2ReferenceLinkedOpenHashMap.this.remove(k);
/* 1010:1010 */      return Short2ReferenceLinkedOpenHashMap.this.size != oldSize;
/* 1011:     */    }
/* 1012:     */    
/* 1013:1013 */    public void clear() { Short2ReferenceLinkedOpenHashMap.this.clear(); }
/* 1014:     */    
/* 1015:     */    public short firstShort() {
/* 1016:1016 */      if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017:1017 */      return Short2ReferenceLinkedOpenHashMap.this.key[Short2ReferenceLinkedOpenHashMap.this.first];
/* 1018:     */    }
/* 1019:     */    
/* 1020:1020 */    public short lastShort() { if (Short2ReferenceLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021:1021 */      return Short2ReferenceLinkedOpenHashMap.this.key[Short2ReferenceLinkedOpenHashMap.this.last]; }
/* 1022:     */    
/* 1023:1023 */    public ShortComparator comparator() { return null; }
/* 1024:1024 */    public final ShortSortedSet tailSet(short from) { throw new UnsupportedOperationException(); }
/* 1025:1025 */    public final ShortSortedSet headSet(short to) { throw new UnsupportedOperationException(); }
/* 1026:1026 */    public final ShortSortedSet subSet(short from, short to) { throw new UnsupportedOperationException(); }
/* 1027:     */  }
/* 1028:     */  
/* 1029:1029 */  public ShortSortedSet keySet() { if (this.keys == null) this.keys = new KeySet(null);
/* 1030:1030 */    return this.keys;
/* 1031:     */  }
/* 1032:     */  
/* 1035:     */  private final class ValueIterator
/* 1036:     */    extends Short2ReferenceLinkedOpenHashMap<V>.MapIterator
/* 1037:     */    implements ObjectListIterator<V>
/* 1038:     */  {
/* 1039:1039 */    public V previous() { return Short2ReferenceLinkedOpenHashMap.this.value[previousEntry()]; }
...
/* 1043:1043 */    public V next() { return Short2ReferenceLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1044:     */  }
/* 1045:     */  
...
/* 1048:1048 */          return new Short2ReferenceLinkedOpenHashMap.ValueIterator(Short2ReferenceLinkedOpenHashMap.this);
/* 1049:     */        }
/* 1050:     */        
/* 1051:1051 */        public int size() { return Short2ReferenceLinkedOpenHashMap.this.size; }
/* 1052:     */        
/* 1053:     */        public boolean contains(Object v) {
/* 1054:1054 */          return Short2ReferenceLinkedOpenHashMap.this.containsValue(v);
/* 1055:     */        }
/* 1056:     */        
/* 1057:1057 */        public void clear() { Short2ReferenceLinkedOpenHashMap.this.clear(); }
/* 1058:     */      };
/* 1059:     */    }
...
/* 1136:     */    
/* 1137:1137 */    short[] key = this.key;
/* 1138:1138 */    V[] value = this.value;
/* 1139:1139 */    int newMask = newN - 1;
/* 1140:1140 */    short[] newKey = new short[newN];
...
/* 1179:     */  }
/* 1180:     */  
/* 1183:     */  public Short2ReferenceLinkedOpenHashMap<V> clone()
/* 1184:     */  {
/* 1185:     */    Short2ReferenceLinkedOpenHashMap<V> c;
/* 1186:     */    
/* 1188:     */    try
/* 1189:     */    {
/* 1190:1190 */      c = (Short2ReferenceLinkedOpenHashMap)super.clone();
/* 1191:     */    }
...
/* 1198:1198 */    c.key = ((short[])this.key.clone());
...
/* 1224:     */  }
/* 1225:     */  
/* 1226:1226 */  private void writeObject(ObjectOutputStream s) throws IOException { short[] key = this.key;
/* 1227:1227 */    V[] value = this.value;
/* 1228:1228 */    Short2ReferenceLinkedOpenHashMap<V>.MapIterator i = new MapIterator(null);
/* 1229:1229 */    s.defaultWriteObject();
/* 1230:1230 */    for (int j = this.size; j-- != 0;) {
/* 1231:1231 */      int e = i.nextEntry();
/* 1232:1232 */      s.writeShort(key[e]);
...
/* 1242:1242 */    short[] key = this.key = new short[this.n];
