  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2ShortAVLTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2ShortAVLTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2ShortAVLTreeMap(Map<? extends Short, ? extends Short> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ShortAVLTreeMap(SortedMap<Short, Short> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ShortAVLTreeMap(Short2ShortMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ShortAVLTreeMap(Short2ShortSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ShortAVLTreeMap(short[] local_k, short[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2ShortAVLTreeMap(short[] local_k, short[] local_v)
  {
  ...
  {
    short oldValue = put(local_ok.shortValue(), local_ov.shortValue());
    return this.modified ? null : Short.valueOf(oldValue);
  }
  
  public Short remove(Object local_ok)
  {
    short oldValue = remove(((Short)local_ok).shortValue());
  ...
  public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Short2ShortMap.Entry> comparator = new Comparator()
        {
          public int compare(Short2ShortMap.Entry local_x, Short2ShortMap.Entry local_y)
          {
            return Short2ShortAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2ShortAVLTreeMap.EntryIterator(Short2ShortAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from)
        {
          return new Short2ShortAVLTreeMap.EntryIterator(Short2ShortAVLTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2ShortAVLTreeMap.Entry local_f = Short2ShortAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2ShortAVLTreeMap.Entry local_f = Short2ShortAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2ShortAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry local_to)
        {
          return Short2ShortAVLTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ShortEntrySet();
        }
        
        public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry local_to)
        {
          return Short2ShortAVLTreeMap.this.headMap((Short)local_to.getKey()).short2ShortEntrySet();
        }
        
        public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from)
        {
          return Short2ShortAVLTreeMap.this.tailMap((Short)from.getKey()).short2ShortEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Short2ShortAVLTreeMap.ValueIterator(Short2ShortAVLTreeMap.this, null);
        }
        
        public boolean contains(short local_k)
        {
          return Short2ShortAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2ShortAVLTreeMap local_c;
    try
    {
      local_c = (Short2ShortAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readShort(), local_s.readShort());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readShort(), local_s.readShort());
      top.right(new Entry(local_s.readShort(), local_s.readShort()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2ShortAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2ShortAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2ShortAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator()
          {
            return new Short2ShortAVLTreeMap.Submap.SubmapEntryIterator(Short2ShortAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from)
          {
            return new Short2ShortAVLTreeMap.Submap.SubmapEntryIterator(Short2ShortAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Short> local_e = (Map.Entry)local_o;
            Short2ShortAVLTreeMap.Entry local_f = Short2ShortAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2ShortAVLTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Short> local_e = (Map.Entry)local_o;
            Short2ShortAVLTreeMap.Entry local_f = Short2ShortAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2ShortAVLTreeMap.Submap.this.in6(local_f.key))) {
              Short2ShortAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2ShortAVLTreeMap.Submap.SubmapIterator(Short2ShortAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2ShortAVLTreeMap.Submap.this.clear();
          }
          
          public Short2ShortMap.Entry first()
          {
            return Short2ShortAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Short2ShortMap.Entry last()
          {
            return Short2ShortAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry local_to)
          {
            return Short2ShortAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ShortEntrySet();
          }
          
          public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry local_to)
          {
            return Short2ShortAVLTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2ShortEntrySet();
          }
          
          public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from)
          {
            return Short2ShortAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2ShortEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ShortCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractShortCollection()
        {
          public ShortIterator iterator()
          {
            return new Short2ShortAVLTreeMap.Submap.SubmapValueIterator(Short2ShortAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(short local_k)
          {
            return Short2ShortAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2ShortAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2ShortAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2ShortAVLTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2ShortAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public short put(short local_k, short local_v)
    {
      ...
      short oldValue = Short2ShortAVLTreeMap.this.put(local_k, local_v);
    ...
    public short remove(short local_k)
    {
      ...
      short oldValue = Short2ShortAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2ShortAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2ShortAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2ShortAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2ShortSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2ShortAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2ShortAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2ShortAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2ShortSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2ShortAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2ShortAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2ShortAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2ShortAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2ShortAVLTreeMap.this.locateKey(this.from);
        if (Short2ShortAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2ShortAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2ShortAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2ShortAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2ShortAVLTreeMap.this.locateKey(this.field_47);
        if (Short2ShortAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2ShortAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2ShortAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2ShortAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      implements ObjectListIterator<Short2ShortMap.Entry>
    {
      ...
      public void set(Short2ShortMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
      
      public void add(Short2ShortMap.Entry local_ok)
      {
        throw new UnsupportedOperationException();
      }
    }
      ...
      extends Short2ShortAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2ShortAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2ShortAVLTreeMap.Submap.this.bottom) && (Short2ShortAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2ShortAVLTreeMap.Submap.this.top) && (Short2ShortAVLTreeMap.this.compare(local_k, (this.prev = Short2ShortAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2ShortAVLTreeMap.this.locateKey(local_k);
            if (Short2ShortAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2ShortAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2ShortAVLTreeMap.this.compare(this.prev.key, Short2ShortAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2ShortAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2ShortAVLTreeMap.this.compare(this.next.key, Short2ShortAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2ShortSortedMap.KeySet
    {
      ...
      {
        return new Short2ShortAVLTreeMap.Submap.SubmapKeyIterator(Short2ShortAVLTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2ShortAVLTreeMap.Submap.SubmapKeyIterator(Short2ShortAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2ShortSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2ShortAVLTreeMap.KeyIterator(Short2ShortAVLTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2ShortAVLTreeMap.KeyIterator(Short2ShortAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2ShortAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Short2ShortAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Short2ShortMap.Entry
  {
    ...
    Entry(short local_k, short local_v)
    {
      this.key = local_k;
      this.value = local_v;
