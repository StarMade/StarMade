  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2IntOpenCustomHashMap(int expected, float local_f, ShortHash.Strategy strategy)
  {
  ...
  public Short2IntOpenCustomHashMap(Map<? extends Short, ? extends Integer> local_m, float local_f, ShortHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Short2IntOpenCustomHashMap(Map<? extends Short, ? extends Integer> local_m, ShortHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Short2IntOpenCustomHashMap(Short2IntMap local_m, float local_f, ShortHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Short2IntOpenCustomHashMap(Short2IntMap local_m, ShortHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Short2IntOpenCustomHashMap(short[] local_k, int[] local_v, float local_f, ShortHash.Strategy strategy)
  {
  ...
  public Short2IntOpenCustomHashMap(short[] local_k, int[] local_v, ShortHash.Strategy strategy)
  {
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Short2IntOpenCustomHashMap.ValueIterator(Short2IntOpenCustomHashMap.this);
        }
        ...
        {
          return Short2IntOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2IntOpenCustomHashMap local_c;
    try
    {
      local_c = (Short2IntOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Short2IntOpenCustomHashMap.MapIterator
    implements IntIterator
  {
    ...
    public int nextInt()
    {
      return Short2IntOpenCustomHashMap.this.value[nextEntry()];
    }
    
    public Integer next()
    {
      return Integer.valueOf(Short2IntOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractShortSet
  {
    ...
    {
      return new Short2IntOpenCustomHashMap.KeyIterator(Short2IntOpenCustomHashMap.this);
    }
    ...
    {
      return Short2IntOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2IntOpenCustomHashMap.this.size;
      Short2IntOpenCustomHashMap.this.remove(local_k);
    ...
    implements ShortIterator
  {
    ...
    {
      return Short2IntOpenCustomHashMap.this.key[nextEntry()];
    }
    
    public Short next()
    {
      return Short.valueOf(Short2IntOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Short2IntMap.FastEntrySet
  {
    ...
    {
      return new Short2IntOpenCustomHashMap.EntryIterator(Short2IntOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Short2IntMap.Entry> fastIterator()
    {
      return new Short2IntOpenCustomHashMap.FastEntryIterator(Short2IntOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Short2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Short2IntOpenCustomHashMap.this.mask; Short2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Short2IntOpenCustomHashMap.this.mask) {
        if (Short2IntOpenCustomHashMap.this.strategy.equals(Short2IntOpenCustomHashMap.this.key[pos], local_k)) {
          return Short2IntOpenCustomHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Short2IntOpenCustomHashMap.this.strategy.hashCode(local_k)) & Short2IntOpenCustomHashMap.this.mask; Short2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Short2IntOpenCustomHashMap.this.mask) {
        if (Short2IntOpenCustomHashMap.this.strategy.equals(Short2IntOpenCustomHashMap.this.key[pos], local_k))
        {
          Short2IntOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Short2IntMap.Entry>
  {
    ...
    public AbstractShort2IntMap.BasicEntry next()
    {
      ...
      this.entry.key = Short2IntOpenCustomHashMap.this.key[local_e];
      this.entry.value = Short2IntOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Short2IntMap.Entry>
  {
    ...
    {
      return this.entry = new Short2IntOpenCustomHashMap.MapEntry(Short2IntOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2IntOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Short2IntOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_2056 = Short2IntOpenCustomHashMap.this.size;
    ShortArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Short2IntOpenCustomHashMap.this.used;
      while ((this.field_2056 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2056 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2056 != 0)
      {
        boolean[] local_k = Short2IntOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2IntOpenCustomHashMap.this.mask; Short2IntOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Short2IntOpenCustomHashMap.this.mask)
        {
        ...
        if (Short2IntOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
    ...
    public void remove()
    {
      ...
      Short2IntOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2056 > 0))
      {
        this.field_2056 += 1;
        nextEntry();
      }
    ...
    implements Short2IntMap.Entry, Map.Entry<Short, Integer>
  {
    ...
    public Short getKey()
    {
      return Short.valueOf(Short2IntOpenCustomHashMap.this.key[this.index]);
    }
    ...
    {
      return Integer.valueOf(Short2IntOpenCustomHashMap.this.value[this.index]);
    }
    ...
    public int setValue(int local_v)
    {
      ...
      Short2IntOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, Integer> local_e = (Map.Entry)local_o;
      return (Short2IntOpenCustomHashMap.this.strategy.equals(Short2IntOpenCustomHashMap.this.key[this.index], ((Short)local_e.getKey()).shortValue())) && (Short2IntOpenCustomHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
