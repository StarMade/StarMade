...
/*     */ 
/*     */ public class Short2FloatArrayMap extends AbstractShort2FloatMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Short2FloatArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Short2FloatMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Short2FloatArrayMap.this.size; }
/*     */ 
/*     */         public Short2FloatMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractShort2FloatMap.BasicEntry(Short2FloatArrayMap.this.key[this.next], Short2FloatArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractShort2FloatMap.BasicEntry entry = new AbstractShort2FloatMap.BasicEntry((short)0, 0.0F);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Short2FloatArrayMap.this.size; }
/*     */ 
/*     */         public Short2FloatMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Short2FloatArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Short2FloatArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Short2FloatArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Short2FloatArrayMap.this.containsKey(k)) && (Short2FloatArrayMap.this.get(k) == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */   }
/*     */ }
