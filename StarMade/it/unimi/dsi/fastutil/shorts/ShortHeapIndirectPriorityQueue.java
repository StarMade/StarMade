...
/*   5:    */
/*  59:    */public class ShortHeapIndirectPriorityQueue
/*  60:    */  extends ShortHeapSemiIndirectPriorityQueue
/*  61:    */{
/*  62:    */  protected int[] inv;
/*  63:    */  
/*  64:    */  public ShortHeapIndirectPriorityQueue(short[] refArray, int capacity, ShortComparator c)
/*  65:    */  {
...
/*  72:    */  }
/*  73:    */  
/*  77:    */  public ShortHeapIndirectPriorityQueue(short[] refArray, int capacity)
/*  78:    */  {
/*  79: 79 */    this(refArray, capacity, null);
/*  80:    */  }
/*  81:    */  
/*  85:    */  public ShortHeapIndirectPriorityQueue(short[] refArray, ShortComparator c)
/*  86:    */  {
/*  87: 87 */    this(refArray, refArray.length, c);
/*  88:    */  }
/*  89:    */  
/*  91:    */  public ShortHeapIndirectPriorityQueue(short[] refArray)
/*  92:    */  {
/*  93: 93 */    this(refArray, refArray.length, null);
/*  94:    */  }
/*  95:    */  
/* 105:    */  public ShortHeapIndirectPriorityQueue(short[] refArray, int[] a, int size, ShortComparator c)
/* 106:    */  {
...
/* 114:    */    }
/* 115:115 */    ShortIndirectHeaps.makeHeap(refArray, a, this.inv, size, c);
/* 116:    */  }
/* 117:    */  
/* 126:    */  public ShortHeapIndirectPriorityQueue(short[] refArray, int[] a, ShortComparator c)
/* 127:    */  {
/* 128:128 */    this(refArray, a, a.length, c);
/* 129:    */  }
/* 130:    */  
/* 139:    */  public ShortHeapIndirectPriorityQueue(short[] refArray, int[] a, int size)
/* 140:    */  {
/* 141:141 */    this(refArray, a, size, null);
/* 142:    */  }
/* 143:    */  
/* 153:153 */  public ShortHeapIndirectPriorityQueue(short[] refArray, int[] a) { this(refArray, a, a.length); }
/* 154:    */  
...
/* 160:    */    
/* 161:161 */    ShortIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, this.size - 1, this.c);
/* 162:    */  }
/* 163:    */  
...
/* 173:    */    
/* 174:174 */    if (this.size != 0) ShortIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.c);
/* 175:175 */    return result;
/* 176:    */  }
/* 177:    */  
/* 178:    */  public void changed() {
/* 179:179 */    ShortIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, 0, this.c);
/* 180:    */  }
/* 181:    */  
...
/* 185:185 */    int newPos = ShortIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, pos, this.c);
/* 186:186 */    ShortIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.c);
/* 187:    */  }
/* 188:    */  
/* 191:    */  public void allChanged()
/* 192:    */  {
/* 193:193 */    ShortIndirectHeaps.makeHeap(this.refArray, this.heap, this.inv, this.size, this.c);
/* 194:    */  }
/* 195:    */  
...
/* 204:204 */      int newPos = ShortIndirectHeaps.upHeap(this.refArray, this.heap, this.inv, this.size, result, this.c);
/* 205:205 */      ShortIndirectHeaps.downHeap(this.refArray, this.heap, this.inv, this.size, newPos, this.c);
/* 206:    */    }
/* 207:    */    
/* 208:208 */    return true;
/* 209:    */  }
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.shorts.ShortHeapIndirectPriorityQueue
