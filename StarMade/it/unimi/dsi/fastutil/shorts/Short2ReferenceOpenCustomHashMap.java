...
/*  18:    */
/*  89:    */public class Short2ReferenceOpenCustomHashMap<V>
/*  90:    */  extends AbstractShort2ReferenceMap<V>
...
/* 103:    */  protected volatile transient Short2ReferenceMap.FastEntrySet<V> entries;
...
/* 107:    */  
/* 108:    */  public Short2ReferenceOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy)
/* 109:    */  {
...
/* 120:    */  }
/* 121:    */  
/* 125:    */  public Short2ReferenceOpenCustomHashMap(int expected, ShortHash.Strategy strategy)
/* 126:    */  {
/* 127:127 */    this(expected, 0.75F, strategy);
/* 128:    */  }
/* 129:    */  
/* 132:    */  public Short2ReferenceOpenCustomHashMap(ShortHash.Strategy strategy)
/* 133:    */  {
/* 134:134 */    this(16, 0.75F, strategy);
/* 135:    */  }
/* 136:    */  
/* 141:    */  public Short2ReferenceOpenCustomHashMap(Map<? extends Short, ? extends V> m, float f, ShortHash.Strategy strategy)
/* 142:    */  {
/* 143:143 */    this(m.size(), f, strategy);
/* 144:144 */    putAll(m);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Short2ReferenceOpenCustomHashMap(Map<? extends Short, ? extends V> m, ShortHash.Strategy strategy)
/* 151:    */  {
/* 152:152 */    this(m, 0.75F, strategy);
/* 153:    */  }
/* 154:    */  
/* 159:    */  public Short2ReferenceOpenCustomHashMap(Short2ReferenceMap<V> m, float f, ShortHash.Strategy strategy)
/* 160:    */  {
/* 161:161 */    this(m.size(), f, strategy);
/* 162:162 */    putAll(m);
/* 163:    */  }
/* 164:    */  
/* 168:    */  public Short2ReferenceOpenCustomHashMap(Short2ReferenceMap<V> m, ShortHash.Strategy strategy)
/* 169:    */  {
/* 170:170 */    this(m, 0.75F, strategy);
/* 171:    */  }
/* 172:    */  
/* 179:    */  public Short2ReferenceOpenCustomHashMap(short[] k, V[] v, float f, ShortHash.Strategy strategy)
/* 180:    */  {
...
/* 185:    */  }
/* 186:    */  
/* 191:    */  public Short2ReferenceOpenCustomHashMap(short[] k, V[] v, ShortHash.Strategy strategy)
/* 192:    */  {
...
/* 380:    */    implements Short2ReferenceMap.Entry<V>, Map.Entry<Short, V>
/* 381:    */  {
...
/* 387:    */    }
/* 388:    */    
/* 389:389 */    public Short getKey() { return Short.valueOf(Short2ReferenceOpenCustomHashMap.this.key[this.index]); }
/* 390:    */    
/* 391:    */    public short getShortKey() {
/* 392:392 */      return Short2ReferenceOpenCustomHashMap.this.key[this.index];
/* 393:    */    }
/* 394:    */    
/* 395:395 */    public V getValue() { return Short2ReferenceOpenCustomHashMap.this.value[this.index]; }
/* 396:    */    
/* 397:    */    public V setValue(V v) {
/* 398:398 */      V oldValue = Short2ReferenceOpenCustomHashMap.this.value[this.index];
/* 399:399 */      Short2ReferenceOpenCustomHashMap.this.value[this.index] = v;
...
/* 406:406 */      return (Short2ReferenceOpenCustomHashMap.this.strategy.equals(Short2ReferenceOpenCustomHashMap.this.key[this.index], ((Short)e.getKey()).shortValue())) && (Short2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/* 407:    */    }
/* 408:    */    
/* 409:409 */    public int hashCode() { return Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(Short2ReferenceOpenCustomHashMap.this.key[this.index]) ^ (Short2ReferenceOpenCustomHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Short2ReferenceOpenCustomHashMap.this.value[this.index])); }
/* 410:    */    
/* 412:412 */    public String toString() { return Short2ReferenceOpenCustomHashMap.this.key[this.index] + "=>" + Short2ReferenceOpenCustomHashMap.this.value[this.index]; } }
/* 413:    */  
...
/* 418:    */    
/* 419:419 */    private MapIterator() { this.pos = Short2ReferenceOpenCustomHashMap.this.n;
/* 420:    */      
/* 422:422 */      this.last = -1;
/* 423:    */      
/* 424:424 */      this.c = Short2ReferenceOpenCustomHashMap.this.size;
/* 425:    */      
/* 429:429 */      boolean[] used = Short2ReferenceOpenCustomHashMap.this.used;
...
/* 441:    */        
/* 442:442 */        int pos = HashCommon.murmurHash3(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ReferenceOpenCustomHashMap.this.mask;
/* 443:    */        
/* 444:444 */        while (Short2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 445:445 */          if (Short2ReferenceOpenCustomHashMap.this.strategy.equals(Short2ReferenceOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446:446 */          pos = pos + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/* 447:    */        }
/* 448:    */      }
/* 449:449 */      this.last = this.pos;
/* 450:    */      
/* 451:451 */      if (this.c != 0) {
/* 452:452 */        boolean[] used = Short2ReferenceOpenCustomHashMap.this.used;
...
/* 467:    */      for (;;)
/* 468:    */      {
/* 469:469 */        pos = (last = pos) + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/* 470:470 */        while (Short2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 471:471 */          int slot = HashCommon.murmurHash3(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(Short2ReferenceOpenCustomHashMap.this.key[pos])) & Short2ReferenceOpenCustomHashMap.this.mask;
/* 472:472 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473:473 */          pos = pos + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/* 474:    */        }
/* 475:475 */        if (Short2ReferenceOpenCustomHashMap.this.used[pos] == 0) break;
/* 476:476 */        if (pos < last)
/* 477:    */        {
/* 478:478 */          if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 479:479 */          this.wrapped.add(Short2ReferenceOpenCustomHashMap.this.key[pos]);
/* 480:    */        }
/* 481:481 */        Short2ReferenceOpenCustomHashMap.this.key[last] = Short2ReferenceOpenCustomHashMap.this.key[pos];
/* 482:482 */        Short2ReferenceOpenCustomHashMap.this.value[last] = Short2ReferenceOpenCustomHashMap.this.value[pos];
/* 483:    */      }
/* 484:484 */      Short2ReferenceOpenCustomHashMap.this.used[last] = false;
/* 485:485 */      Short2ReferenceOpenCustomHashMap.this.value[last] = null;
/* 486:486 */      return last;
/* 487:    */    }
/* 488:    */    
...
/* 492:    */      {
/* 493:493 */        Short2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 494:494 */        this.last = -1;
/* 495:495 */        return;
/* 496:    */      }
/* 497:497 */      Short2ReferenceOpenCustomHashMap.this.size -= 1;
...
/* 509:    */    } }
/* 510:    */  
/* 511:511 */  private class EntryIterator extends Short2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Short2ReferenceMap.Entry<V>> { private EntryIterator() { super(null); }
/* 512:    */    
/* 513:    */    private Short2ReferenceOpenCustomHashMap<V>.MapEntry entry;
/* 514:514 */    public Short2ReferenceMap.Entry<V> next() { return this.entry = new Short2ReferenceOpenCustomHashMap.MapEntry(Short2ReferenceOpenCustomHashMap.this, nextEntry()); }
/* 515:    */    
/* 516:    */    public void remove()
/* 517:    */    {
/* 518:518 */      super.remove();
/* 519:519 */      Short2ReferenceOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 520:    */    } }
/* 521:    */  
/* 522:522 */  private class FastEntryIterator extends Short2ReferenceOpenCustomHashMap<V>.MapIterator implements ObjectIterator<Short2ReferenceMap.Entry<V>> { private FastEntryIterator() { super(null); }
/* 523:523 */    final AbstractShort2ReferenceMap.BasicEntry<V> entry = new AbstractShort2ReferenceMap.BasicEntry((short)0, null);
/* 524:    */    
/* 525:525 */    public AbstractShort2ReferenceMap.BasicEntry<V> next() { int e = nextEntry();
/* 526:526 */      this.entry.key = Short2ReferenceOpenCustomHashMap.this.key[e];
/* 527:527 */      this.entry.value = Short2ReferenceOpenCustomHashMap.this.value[e];
/* 528:528 */      return this.entry;
/* 529:    */    } }
/* 530:    */  
/* 531:    */  private final class MapEntrySet extends AbstractObjectSet<Short2ReferenceMap.Entry<V>> implements Short2ReferenceMap.FastEntrySet<V> { private MapEntrySet() {}
/* 532:    */    
/* 533:533 */    public ObjectIterator<Short2ReferenceMap.Entry<V>> iterator() { return new Short2ReferenceOpenCustomHashMap.EntryIterator(Short2ReferenceOpenCustomHashMap.this, null); }
/* 534:    */    
/* 535:    */    public ObjectIterator<Short2ReferenceMap.Entry<V>> fastIterator() {
/* 536:536 */      return new Short2ReferenceOpenCustomHashMap.FastEntryIterator(Short2ReferenceOpenCustomHashMap.this, null);
/* 537:    */    }
/* 538:    */    
...
/* 543:    */      
/* 544:544 */      int pos = HashCommon.murmurHash3(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ReferenceOpenCustomHashMap.this.mask;
/* 545:    */      
/* 546:546 */      while (Short2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 547:547 */        if (Short2ReferenceOpenCustomHashMap.this.strategy.equals(Short2ReferenceOpenCustomHashMap.this.key[pos], k)) return Short2ReferenceOpenCustomHashMap.this.value[pos] == e.getValue();
/* 548:548 */        pos = pos + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/* 549:    */      }
...
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ReferenceOpenCustomHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Short2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Short2ReferenceOpenCustomHashMap.this.strategy.equals(Short2ReferenceOpenCustomHashMap.this.key[pos], k)) {
/* 562:562 */          Short2ReferenceOpenCustomHashMap.this.remove(e.getKey());
/* 563:563 */          return true;
/* 564:    */        }
/* 565:565 */        pos = pos + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/* 566:    */      }
/* 567:567 */      return false;
/* 568:    */    }
/* 569:    */    
/* 570:570 */    public int size() { return Short2ReferenceOpenCustomHashMap.this.size; }
/* 571:    */    
/* 573:573 */    public void clear() { Short2ReferenceOpenCustomHashMap.this.clear(); }
/* 574:    */  }
/* 575:    */  
/* 576:    */  public Short2ReferenceMap.FastEntrySet<V> short2ReferenceEntrySet() {
...
/* 584:    */    extends Short2ReferenceOpenCustomHashMap.MapIterator
/* 585:    */    implements ShortIterator
/* 586:    */  {
/* 587:587 */    public KeyIterator() { super(null); }
/* 588:588 */    public short nextShort() { return Short2ReferenceOpenCustomHashMap.this.key[nextEntry()]; }
/* 589:589 */    public Short next() { return Short.valueOf(Short2ReferenceOpenCustomHashMap.this.key[nextEntry()]); } }
/* 590:    */  
/* 591:    */  private final class KeySet extends AbstractShortSet { private KeySet() {}
/* 592:    */    
/* 593:593 */    public ShortIterator iterator() { return new Short2ReferenceOpenCustomHashMap.KeyIterator(Short2ReferenceOpenCustomHashMap.this); }
/* 594:    */    
/* 595:    */    public int size() {
/* 596:596 */      return Short2ReferenceOpenCustomHashMap.this.size;
/* 597:    */    }
/* 598:    */    
/* 599:599 */    public boolean contains(short k) { return Short2ReferenceOpenCustomHashMap.this.containsKey(k); }
/* 600:    */    
/* 601:    */    public boolean remove(short k) {
/* 602:602 */      int oldSize = Short2ReferenceOpenCustomHashMap.this.size;
/* 603:603 */      Short2ReferenceOpenCustomHashMap.this.remove(k);
/* 604:604 */      return Short2ReferenceOpenCustomHashMap.this.size != oldSize;
/* 605:    */    }
/* 606:    */    
/* 607:607 */    public void clear() { Short2ReferenceOpenCustomHashMap.this.clear(); }
/* 608:    */  }
/* 609:    */  
...
/* 618:    */    extends Short2ReferenceOpenCustomHashMap<V>.MapIterator
/* 619:    */    implements ObjectIterator<V>
/* 620:    */  {
/* 621:621 */    public ValueIterator() { super(null); }
/* 622:622 */    public V next() { return Short2ReferenceOpenCustomHashMap.this.value[nextEntry()]; }
/* 623:    */  }
/* 624:    */  
...
/* 627:627 */          return new Short2ReferenceOpenCustomHashMap.ValueIterator(Short2ReferenceOpenCustomHashMap.this);
/* 628:    */        }
/* 629:    */        
/* 630:630 */        public int size() { return Short2ReferenceOpenCustomHashMap.this.size; }
/* 631:    */        
/* 632:    */        public boolean contains(Object v) {
/* 633:633 */          return Short2ReferenceOpenCustomHashMap.this.containsValue(v);
/* 634:    */        }
/* 635:    */        
/* 636:636 */        public void clear() { Short2ReferenceOpenCustomHashMap.this.clear(); }
/* 637:    */      };
/* 638:    */    }
...
/* 739:    */  }
/* 740:    */  
/* 744:    */  public Short2ReferenceOpenCustomHashMap<V> clone()
/* 745:    */  {
/* 746:    */    Short2ReferenceOpenCustomHashMap<V> c;
/* 747:    */    
/* 749:    */    try
/* 750:    */    {
/* 751:751 */      c = (Short2ReferenceOpenCustomHashMap)super.clone();
/* 752:    */    }
...
/* 789:789 */    Short2ReferenceOpenCustomHashMap<V>.MapIterator i = new MapIterator(null);
