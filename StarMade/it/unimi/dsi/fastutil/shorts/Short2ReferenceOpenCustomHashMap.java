...
/* 627 */           return new Short2ReferenceOpenCustomHashMap.ValueIterator(Short2ReferenceOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 630 */           return Short2ReferenceOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 633 */           return Short2ReferenceOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 636 */           Short2ReferenceOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 751 */       c = (Short2ReferenceOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Short2ReferenceOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public V next() { return Short2ReferenceOpenCustomHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 593 */       return new Short2ReferenceOpenCustomHashMap.KeyIterator(Short2ReferenceOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 596 */       return Short2ReferenceOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(short k) {
/* 599 */       return Short2ReferenceOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(short k) {
/* 602 */       int oldSize = Short2ReferenceOpenCustomHashMap.this.size;
/* 603 */       Short2ReferenceOpenCustomHashMap.this.remove(k);
/* 604 */       return Short2ReferenceOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 607 */       Short2ReferenceOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Short2ReferenceOpenCustomHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 587 */       super(null); } 
/* 588 */     public short nextShort() { return Short2ReferenceOpenCustomHashMap.this.key[nextEntry()]; } 
/* 589 */     public Short next() { return Short.valueOf(Short2ReferenceOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 533 */       return new Short2ReferenceOpenCustomHashMap.EntryIterator(Short2ReferenceOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Short2ReferenceMap.Entry<V>> fastIterator() {
/* 536 */       return new Short2ReferenceOpenCustomHashMap.FastEntryIterator(Short2ReferenceOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 544 */       int pos = HashCommon.murmurHash3(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ReferenceOpenCustomHashMap.this.mask;
/*     */ 
/* 546 */       while (Short2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 547 */         if (Short2ReferenceOpenCustomHashMap.this.strategy.equals(Short2ReferenceOpenCustomHashMap.this.key[pos], k)) return Short2ReferenceOpenCustomHashMap.this.value[pos] == e.getValue();
/* 548 */         pos = pos + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/*     */       }
/* 550 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ReferenceOpenCustomHashMap.this.mask;
/*     */ 
/* 560 */       while (Short2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 561 */         if (Short2ReferenceOpenCustomHashMap.this.strategy.equals(Short2ReferenceOpenCustomHashMap.this.key[pos], k)) {
/* 562 */           Short2ReferenceOpenCustomHashMap.this.remove(e.getKey());
/* 563 */           return true;
/*     */         }
/* 565 */         pos = pos + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/*     */       }
/* 567 */       return false;
/*     */     }
/*     */     public int size() {
/* 570 */       return Short2ReferenceOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 573 */       Short2ReferenceOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Short2ReferenceOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Short2ReferenceMap.Entry<V>>
/*     */   {
/* 523 */     final AbstractShort2ReferenceMap.BasicEntry<V> entry = new AbstractShort2ReferenceMap.BasicEntry((short)0, null);
/*     */ 
...
/* 525 */       int e = nextEntry();
/* 526 */       this.entry.key = Short2ReferenceOpenCustomHashMap.this.key[e];
/* 527 */       this.entry.value = Short2ReferenceOpenCustomHashMap.this.value[e];
/* 528 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Short2ReferenceOpenCustomHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Short2ReferenceMap.Entry<V>>
/*     */   {
...
/* 514 */       return this.entry = new Short2ReferenceOpenCustomHashMap.MapEntry(Short2ReferenceOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 518 */       super.remove();
/* 519 */       Short2ReferenceOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 419 */       this.pos = Short2ReferenceOpenCustomHashMap.this.n;
/*     */ 
/* 422 */       this.last = -1;
/*     */ 
/* 424 */       this.c = Short2ReferenceOpenCustomHashMap.this.size;
/*     */ 
/* 429 */       boolean[] used = Short2ReferenceOpenCustomHashMap.this.used;
...
/*     */ 
/* 442 */         int pos = HashCommon.murmurHash3(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ReferenceOpenCustomHashMap.this.mask;
/*     */ 
/* 444 */         while (Short2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 445 */           if (Short2ReferenceOpenCustomHashMap.this.strategy.equals(Short2ReferenceOpenCustomHashMap.this.key[pos], k)) return pos;
/* 446 */           pos = pos + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 449 */       this.last = this.pos;
/*     */ 
/* 451 */       if (this.c != 0) {
/* 452 */         boolean[] used = Short2ReferenceOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 469 */         pos = (last = pos) + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/* 470 */         while (Short2ReferenceOpenCustomHashMap.this.used[pos] != 0) {
/* 471 */           int slot = HashCommon.murmurHash3(Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(Short2ReferenceOpenCustomHashMap.this.key[pos])) & Short2ReferenceOpenCustomHashMap.this.mask;
/* 472 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 473 */           pos = pos + 1 & Short2ReferenceOpenCustomHashMap.this.mask;
/*     */         }
/* 475 */         if (Short2ReferenceOpenCustomHashMap.this.used[pos] == 0) break;
/* 476 */         if (pos < last)
/*     */         {
/* 478 */           if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 479 */           this.wrapped.add(Short2ReferenceOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 481 */         Short2ReferenceOpenCustomHashMap.this.key[last] = Short2ReferenceOpenCustomHashMap.this.key[pos];
/* 482 */         Short2ReferenceOpenCustomHashMap.this.value[last] = Short2ReferenceOpenCustomHashMap.this.value[pos];
/*     */       }
/* 484 */       Short2ReferenceOpenCustomHashMap.this.used[last] = false;
/* 485 */       Short2ReferenceOpenCustomHashMap.this.value[last] = null;
/* 486 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 491 */       if (this.pos < -1)
/*     */       {
/* 493 */         Short2ReferenceOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 494 */         this.last = -1;
/* 495 */         return;
/*     */       }
/* 497 */       Short2ReferenceOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Short getKey() {
/* 389 */       return Short.valueOf(Short2ReferenceOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public short getShortKey() {
/* 392 */       return Short2ReferenceOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 395 */       return Short2ReferenceOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 398 */       Object oldValue = Short2ReferenceOpenCustomHashMap.this.value[this.index];
/* 399 */       Short2ReferenceOpenCustomHashMap.this.value[this.index] = v;
/* 400 */       return oldValue;
/*     */     }
/*     */ 
...
/* 406 */       return (Short2ReferenceOpenCustomHashMap.this.strategy.equals(Short2ReferenceOpenCustomHashMap.this.key[this.index], ((Short)e.getKey()).shortValue())) && (Short2ReferenceOpenCustomHashMap.this.value[this.index] == e.getValue());
/*     */     }
/*     */     public int hashCode() {
/* 409 */       return Short2ReferenceOpenCustomHashMap.this.strategy.hashCode(Short2ReferenceOpenCustomHashMap.this.key[this.index]) ^ (Short2ReferenceOpenCustomHashMap.this.value[this.index] == null ? 0 : System.identityHashCode(Short2ReferenceOpenCustomHashMap.this.value[this.index]));
/*     */     }
/*     */     public String toString() {
/* 412 */       return Short2ReferenceOpenCustomHashMap.this.key[this.index] + "=>" + Short2ReferenceOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
