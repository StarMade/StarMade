...
/*  18:    */
/*  87:    */public class Short2LongOpenHashMap
/*  88:    */  extends AbstractShort2LongMap
...
/* 101:    */  protected volatile transient Short2LongMap.FastEntrySet entries;
/* 102:    */  protected volatile transient ShortSet keys;
/* 103:    */  protected volatile transient LongCollection values;
/* 104:    */  
/* 105:    */  public Short2LongOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Short2LongOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Short2LongOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Short2LongOpenHashMap(Map<? extends Short, ? extends Long> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Short2LongOpenHashMap(Map<? extends Short, ? extends Long> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Short2LongOpenHashMap(Short2LongMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Short2LongOpenHashMap(Short2LongMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Short2LongOpenHashMap(short[] k, long[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Short2LongOpenHashMap(short[] k, long[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public long put(short k, long v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Long put(Short ok, Long ov) { long v = ov.longValue();
...
/* 226:    */  }
/* 227:    */  
/* 238:    */  public long add(short k, long incr)
/* 239:    */  {
...
/* 279:    */  }
/* 280:    */  
/* 281:    */  public long remove(short k)
/* 282:    */  {
...
/* 312:    */  }
/* 313:    */  
/* 314:314 */  public Long get(Short ok) { short k = ok.shortValue();
/* 315:    */    
...
/* 389:    */    implements Short2LongMap.Entry, Map.Entry<Short, Long>
/* 390:    */  {
...
/* 396:    */    }
/* 397:    */    
/* 398:398 */    public Short getKey() { return Short.valueOf(Short2LongOpenHashMap.this.key[this.index]); }
/* 399:    */    
/* 400:    */    public short getShortKey() {
/* 401:401 */      return Short2LongOpenHashMap.this.key[this.index];
/* 402:    */    }
/* 403:    */    
/* 404:404 */    public Long getValue() { return Long.valueOf(Short2LongOpenHashMap.this.value[this.index]); }
/* 405:    */    
/* 407:407 */    public long getLongValue() { return Short2LongOpenHashMap.this.value[this.index]; }
/* 408:    */    
/* 409:    */    public long setValue(long v) {
/* 410:410 */      long oldValue = Short2LongOpenHashMap.this.value[this.index];
/* 411:411 */      Short2LongOpenHashMap.this.value[this.index] = v;
...
/* 420:420 */      Map.Entry<Short, Long> e = (Map.Entry)o;
/* 421:421 */      return (Short2LongOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2LongOpenHashMap.this.value[this.index] == ((Long)e.getValue()).longValue());
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public int hashCode() { return Short2LongOpenHashMap.this.key[this.index] ^ HashCommon.long2int(Short2LongOpenHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public String toString() { return Short2LongOpenHashMap.this.key[this.index] + "=>" + Short2LongOpenHashMap.this.value[this.index]; } }
/* 428:    */  
...
/* 433:    */    
/* 434:434 */    private MapIterator() { this.pos = Short2LongOpenHashMap.this.n;
/* 435:    */      
/* 437:437 */      this.last = -1;
/* 438:    */      
/* 439:439 */      this.c = Short2LongOpenHashMap.this.size;
/* 440:    */      
/* 444:444 */      boolean[] used = Short2LongOpenHashMap.this.used;
...
/* 456:    */        
/* 457:457 */        int pos = HashCommon.murmurHash3(k) & Short2LongOpenHashMap.this.mask;
/* 458:    */        
/* 459:459 */        while (Short2LongOpenHashMap.this.used[pos] != 0) {
/* 460:460 */          if (Short2LongOpenHashMap.this.key[pos] == k) return pos;
/* 461:461 */          pos = pos + 1 & Short2LongOpenHashMap.this.mask;
/* 462:    */        }
/* 463:    */      }
/* 464:464 */      this.last = this.pos;
/* 465:    */      
/* 466:466 */      if (this.c != 0) {
/* 467:467 */        boolean[] used = Short2LongOpenHashMap.this.used;
...
/* 482:    */      for (;;)
/* 483:    */      {
/* 484:484 */        pos = (last = pos) + 1 & Short2LongOpenHashMap.this.mask;
/* 485:485 */        while (Short2LongOpenHashMap.this.used[pos] != 0) {
/* 486:486 */          int slot = HashCommon.murmurHash3(Short2LongOpenHashMap.this.key[pos]) & Short2LongOpenHashMap.this.mask;
/* 487:487 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488:488 */          pos = pos + 1 & Short2LongOpenHashMap.this.mask;
/* 489:    */        }
/* 490:490 */        if (Short2LongOpenHashMap.this.used[pos] == 0) break;
/* 491:491 */        if (pos < last)
/* 492:    */        {
/* 493:493 */          if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 494:494 */          this.wrapped.add(Short2LongOpenHashMap.this.key[pos]);
/* 495:    */        }
/* 496:496 */        Short2LongOpenHashMap.this.key[last] = Short2LongOpenHashMap.this.key[pos];
/* 497:497 */        Short2LongOpenHashMap.this.value[last] = Short2LongOpenHashMap.this.value[pos];
/* 498:    */      }
/* 499:499 */      Short2LongOpenHashMap.this.used[last] = false;
/* 500:500 */      return last;
/* 501:    */    }
/* 502:    */    
...
/* 506:    */      {
/* 507:507 */        Short2LongOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 508:508 */        this.last = -1;
/* 509:509 */        return;
/* 510:    */      }
/* 511:511 */      Short2LongOpenHashMap.this.size -= 1;
...
/* 523:    */    } }
/* 524:    */  
/* 525:525 */  private class EntryIterator extends Short2LongOpenHashMap.MapIterator implements ObjectIterator<Short2LongMap.Entry> { private EntryIterator() { super(null); }
/* 526:    */    
/* 527:    */    private Short2LongOpenHashMap.MapEntry entry;
/* 528:528 */    public Short2LongMap.Entry next() { return this.entry = new Short2LongOpenHashMap.MapEntry(Short2LongOpenHashMap.this, nextEntry()); }
/* 529:    */    
/* 530:    */    public void remove()
/* 531:    */    {
/* 532:532 */      super.remove();
/* 533:533 */      Short2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 534:    */    } }
/* 535:    */  
/* 536:536 */  private class FastEntryIterator extends Short2LongOpenHashMap.MapIterator implements ObjectIterator<Short2LongMap.Entry> { private FastEntryIterator() { super(null); }
/* 537:537 */    final AbstractShort2LongMap.BasicEntry entry = new AbstractShort2LongMap.BasicEntry((short)0, 0L);
/* 538:    */    
/* 539:539 */    public AbstractShort2LongMap.BasicEntry next() { int e = nextEntry();
/* 540:540 */      this.entry.key = Short2LongOpenHashMap.this.key[e];
/* 541:541 */      this.entry.value = Short2LongOpenHashMap.this.value[e];
/* 542:542 */      return this.entry;
/* 543:    */    } }
/* 544:    */  
/* 545:    */  private final class MapEntrySet extends AbstractObjectSet<Short2LongMap.Entry> implements Short2LongMap.FastEntrySet { private MapEntrySet() {}
/* 546:    */    
/* 547:547 */    public ObjectIterator<Short2LongMap.Entry> iterator() { return new Short2LongOpenHashMap.EntryIterator(Short2LongOpenHashMap.this, null); }
/* 548:    */    
/* 549:    */    public ObjectIterator<Short2LongMap.Entry> fastIterator() {
/* 550:550 */      return new Short2LongOpenHashMap.FastEntryIterator(Short2LongOpenHashMap.this, null);
/* 551:    */    }
/* 552:    */    
/* 553:    */    public boolean contains(Object o) {
/* 554:554 */      if (!(o instanceof Map.Entry)) return false;
/* 555:555 */      Map.Entry<Short, Long> e = (Map.Entry)o;
/* 556:556 */      short k = ((Short)e.getKey()).shortValue();
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(k) & Short2LongOpenHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Short2LongOpenHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Short2LongOpenHashMap.this.key[pos] == k) return Short2LongOpenHashMap.this.value[pos] == ((Long)e.getValue()).longValue();
/* 562:562 */        pos = pos + 1 & Short2LongOpenHashMap.this.mask;
/* 563:    */      }
...
/* 569:569 */      Map.Entry<Short, Long> e = (Map.Entry)o;
/* 570:570 */      short k = ((Short)e.getKey()).shortValue();
/* 571:    */      
/* 572:572 */      int pos = HashCommon.murmurHash3(k) & Short2LongOpenHashMap.this.mask;
/* 573:    */      
/* 574:574 */      while (Short2LongOpenHashMap.this.used[pos] != 0) {
/* 575:575 */        if (Short2LongOpenHashMap.this.key[pos] == k) {
/* 576:576 */          Short2LongOpenHashMap.this.remove(e.getKey());
/* 577:577 */          return true;
/* 578:    */        }
/* 579:579 */        pos = pos + 1 & Short2LongOpenHashMap.this.mask;
/* 580:    */      }
/* 581:581 */      return false;
/* 582:    */    }
/* 583:    */    
/* 584:584 */    public int size() { return Short2LongOpenHashMap.this.size; }
/* 585:    */    
/* 587:587 */    public void clear() { Short2LongOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public Short2LongMap.FastEntrySet short2LongEntrySet() {
...
/* 598:    */    extends Short2LongOpenHashMap.MapIterator
/* 599:    */    implements ShortIterator
/* 600:    */  {
/* 601:601 */    public KeyIterator() { super(null); }
/* 602:602 */    public short nextShort() { return Short2LongOpenHashMap.this.key[nextEntry()]; }
/* 603:603 */    public Short next() { return Short.valueOf(Short2LongOpenHashMap.this.key[nextEntry()]); } }
/* 604:    */  
/* 605:    */  private final class KeySet extends AbstractShortSet { private KeySet() {}
/* 606:    */    
/* 607:607 */    public ShortIterator iterator() { return new Short2LongOpenHashMap.KeyIterator(Short2LongOpenHashMap.this); }
/* 608:    */    
/* 609:    */    public int size() {
/* 610:610 */      return Short2LongOpenHashMap.this.size;
/* 611:    */    }
/* 612:    */    
/* 613:613 */    public boolean contains(short k) { return Short2LongOpenHashMap.this.containsKey(k); }
/* 614:    */    
/* 615:    */    public boolean remove(short k) {
/* 616:616 */      int oldSize = Short2LongOpenHashMap.this.size;
/* 617:617 */      Short2LongOpenHashMap.this.remove(k);
/* 618:618 */      return Short2LongOpenHashMap.this.size != oldSize;
/* 619:    */    }
/* 620:    */    
/* 621:621 */    public void clear() { Short2LongOpenHashMap.this.clear(); }
/* 622:    */  }
/* 623:    */  
...
/* 632:    */    extends Short2LongOpenHashMap.MapIterator
/* 633:    */    implements LongIterator
/* 634:    */  {
/* 635:635 */    public ValueIterator() { super(null); }
/* 636:636 */    public long nextLong() { return Short2LongOpenHashMap.this.value[nextEntry()]; }
/* 637:637 */    public Long next() { return Long.valueOf(Short2LongOpenHashMap.this.value[nextEntry()]); }
/* 638:    */  }
/* 639:    */  
...
/* 642:642 */          return new Short2LongOpenHashMap.ValueIterator(Short2LongOpenHashMap.this);
/* 643:    */        }
/* 644:    */        
/* 645:645 */        public int size() { return Short2LongOpenHashMap.this.size; }
/* 646:    */        
/* 647:    */        public boolean contains(long v) {
/* 648:648 */          return Short2LongOpenHashMap.this.containsValue(v);
/* 649:    */        }
/* 650:    */        
/* 651:651 */        public void clear() { Short2LongOpenHashMap.this.clear(); }
/* 652:    */      };
/* 653:    */    }
...
/* 754:    */  }
/* 755:    */  
/* 759:    */  public Short2LongOpenHashMap clone()
/* 760:    */  {
/* 761:    */    Short2LongOpenHashMap c;
/* 762:    */    
/* 764:    */    try
/* 765:    */    {
/* 766:766 */      c = (Short2LongOpenHashMap)super.clone();
/* 767:    */    }
