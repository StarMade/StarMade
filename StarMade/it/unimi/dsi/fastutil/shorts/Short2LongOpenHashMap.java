  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2LongOpenHashMap(int expected, float local_f)
  {
  ...
  public Short2LongOpenHashMap(Map<? extends Short, ? extends Long> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2LongOpenHashMap(Map<? extends Short, ? extends Long> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2LongOpenHashMap(Short2LongMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2LongOpenHashMap(Short2LongMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2LongOpenHashMap(short[] local_k, long[] local_v, float local_f)
  {
  ...
  public Short2LongOpenHashMap(short[] local_k, long[] local_v)
  {
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Short2LongOpenHashMap.ValueIterator(Short2LongOpenHashMap.this);
        }
        ...
        {
          return Short2LongOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2LongOpenHashMap local_c;
    try
    {
      local_c = (Short2LongOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Short2LongOpenHashMap.MapIterator
    implements LongIterator
  {
    ...
    public Long next()
    {
      return Long.valueOf(Short2LongOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractShortSet
  {
    ...
    {
      return new Short2LongOpenHashMap.KeyIterator(Short2LongOpenHashMap.this);
    }
    ...
    {
      return Short2LongOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2LongOpenHashMap.this.size;
      Short2LongOpenHashMap.this.remove(local_k);
    ...
    implements ShortIterator
  {
    ...
    public Short next()
    {
      return Short.valueOf(Short2LongOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Short2LongMap.FastEntrySet
  {
    ...
    {
      return new Short2LongOpenHashMap.EntryIterator(Short2LongOpenHashMap.this, null);
    }
    
    public ObjectIterator<Short2LongMap.Entry> fastIterator()
    {
      return new Short2LongOpenHashMap.FastEntryIterator(Short2LongOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2LongOpenHashMap.this.mask; Short2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2LongOpenHashMap.this.mask) {
        if (Short2LongOpenHashMap.this.key[pos] == local_k) {
          return Short2LongOpenHashMap.this.value[pos] == ((Long)local_e.getValue()).longValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2LongOpenHashMap.this.mask; Short2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2LongOpenHashMap.this.mask) {
        if (Short2LongOpenHashMap.this.key[pos] == local_k)
        {
          Short2LongOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Short2LongMap.Entry>
  {
    ...
    public AbstractShort2LongMap.BasicEntry next()
    {
      ...
      this.entry.key = Short2LongOpenHashMap.this.key[local_e];
      this.entry.value = Short2LongOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Short2LongMap.Entry>
  {
    ...
    {
      return this.entry = new Short2LongOpenHashMap.MapEntry(Short2LongOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2LongOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Short2LongOpenHashMap.this.field_49;
    int last = -1;
    int field_2036 = Short2LongOpenHashMap.this.size;
    ShortArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Short2LongOpenHashMap.this.used;
      while ((this.field_2036 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2036 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2036 != 0)
      {
        boolean[] local_k = Short2LongOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2LongOpenHashMap.this.mask; Short2LongOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2LongOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Short2LongOpenHashMap.this.key[pos]) & Short2LongOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Short2LongOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Short2LongOpenHashMap.this.key[pos]);
        }
        Short2LongOpenHashMap.this.key[last] = Short2LongOpenHashMap.this.key[pos];
        Short2LongOpenHashMap.this.value[last] = Short2LongOpenHashMap.this.value[pos];
      }
      Short2LongOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Short2LongOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
        this.last = -1;
        return;
      }
      Short2LongOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2036 > 0))
      {
        this.field_2036 += 1;
        nextEntry();
      }
    ...
    implements Short2LongMap.Entry, Map.Entry<Short, Long>
  {
    ...
    public long setValue(long local_v)
    {
      ...
      Short2LongOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, Long> local_e = (Map.Entry)local_o;
      return (Short2LongOpenHashMap.this.key[this.index] == ((Short)local_e.getKey()).shortValue()) && (Short2LongOpenHashMap.this.value[this.index] == ((Long)local_e.getValue()).longValue());
    }
