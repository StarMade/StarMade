...
{
  public static int downHeap(short[] refArray, int[] heap, int size, int local_i, ShortComparator local_c)
  {
    if (local_i >= size) {
    ...
    short local_E = refArray[local_e];
    if (local_c == null)
    {
      int child;
  ...
  public static int upHeap(short[] refArray, int[] heap, int size, int local_i, ShortComparator local_c)
  {
    if (local_i >= size) {
      throw new IllegalArgumentException("Heap position (" + local_i + ") is larger than or equal to heap size (" + size + ")");
    }
  ...
  public static void makeHeap(short[] refArray, int offset, int length, int[] heap, ShortComparator local_c)
  {
  ...
  public static int[] makeHeap(short[] refArray, int offset, int length, ShortComparator local_c)
  {
  ...
  public static void makeHeap(short[] refArray, int[] heap, int size, ShortComparator local_c)
  {
    int local_i = size / 2;
    while (local_i-- != 0) {
  ...
  public static int front(short[] refArray, int[] heap, int size, int[] local_a)
  {
