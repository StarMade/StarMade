  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2IntOpenHashMap(int expected, float local_f)
  {
  ...
  public Short2IntOpenHashMap(Map<? extends Short, ? extends Integer> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2IntOpenHashMap(Map<? extends Short, ? extends Integer> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2IntOpenHashMap(Short2IntMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2IntOpenHashMap(Short2IntMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2IntOpenHashMap(short[] local_k, int[] local_v, float local_f)
  {
  ...
  public Short2IntOpenHashMap(short[] local_k, int[] local_v)
  {
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Short2IntOpenHashMap.ValueIterator(Short2IntOpenHashMap.this);
        }
        ...
        {
          return Short2IntOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2IntOpenHashMap local_c;
    try
    {
      local_c = (Short2IntOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Short2IntOpenHashMap.MapIterator
    implements IntIterator
  {
    ...
    public Integer next()
    {
      return Integer.valueOf(Short2IntOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractShortSet
  {
    ...
    {
      return new Short2IntOpenHashMap.KeyIterator(Short2IntOpenHashMap.this);
    }
    ...
    {
      return Short2IntOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2IntOpenHashMap.this.size;
      Short2IntOpenHashMap.this.remove(local_k);
    ...
    implements ShortIterator
  {
    ...
    public Short next()
    {
      return Short.valueOf(Short2IntOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Short2IntMap.FastEntrySet
  {
    ...
    {
      return new Short2IntOpenHashMap.EntryIterator(Short2IntOpenHashMap.this, null);
    }
    
    public ObjectIterator<Short2IntMap.Entry> fastIterator()
    {
      return new Short2IntOpenHashMap.FastEntryIterator(Short2IntOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2IntOpenHashMap.this.mask; Short2IntOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2IntOpenHashMap.this.mask) {
        if (Short2IntOpenHashMap.this.key[pos] == local_k) {
          return Short2IntOpenHashMap.this.value[pos] == ((Integer)local_e.getValue()).intValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2IntOpenHashMap.this.mask; Short2IntOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2IntOpenHashMap.this.mask) {
        if (Short2IntOpenHashMap.this.key[pos] == local_k)
        {
          Short2IntOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Short2IntMap.Entry>
  {
    ...
    public AbstractShort2IntMap.BasicEntry next()
    {
      ...
      this.entry.key = Short2IntOpenHashMap.this.key[local_e];
      this.entry.value = Short2IntOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Short2IntMap.Entry>
  {
    ...
    {
      return this.entry = new Short2IntOpenHashMap.MapEntry(Short2IntOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Short2IntOpenHashMap.this.field_49;
    int last = -1;
    int field_2047 = Short2IntOpenHashMap.this.size;
    ShortArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Short2IntOpenHashMap.this.used;
      while ((this.field_2047 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2047 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2047 != 0)
      {
        boolean[] local_k = Short2IntOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2IntOpenHashMap.this.mask; Short2IntOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2IntOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Short2IntOpenHashMap.this.key[pos]) & Short2IntOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Short2IntOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Short2IntOpenHashMap.this.key[pos]);
        }
        Short2IntOpenHashMap.this.key[last] = Short2IntOpenHashMap.this.key[pos];
        Short2IntOpenHashMap.this.value[last] = Short2IntOpenHashMap.this.value[pos];
      }
      Short2IntOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Short2IntOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
        this.last = -1;
        return;
      }
      Short2IntOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2047 > 0))
      {
        this.field_2047 += 1;
        nextEntry();
      }
    ...
    implements Short2IntMap.Entry, Map.Entry<Short, Integer>
  {
    ...
    public int setValue(int local_v)
    {
      ...
      Short2IntOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, Integer> local_e = (Map.Entry)local_o;
      return (Short2IntOpenHashMap.this.key[this.index] == ((Short)local_e.getKey()).shortValue()) && (Short2IntOpenHashMap.this.value[this.index] == ((Integer)local_e.getValue()).intValue());
    }
