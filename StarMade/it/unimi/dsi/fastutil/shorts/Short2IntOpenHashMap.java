...
/*     */ 
/*     */ public class Short2IntOpenHashMap extends AbstractShort2IntMap
...
/* 642 */           return new Short2IntOpenHashMap.ValueIterator(Short2IntOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 645 */           return Short2IntOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(int v) {
/* 648 */           return Short2IntOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 651 */           Short2IntOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 766 */       c = (Short2IntOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Short2IntOpenHashMap.MapIterator
/*     */     implements IntIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 635 */       super(null); } 
/* 636 */     public int nextInt() { return Short2IntOpenHashMap.this.value[nextEntry()]; } 
/* 637 */     public Integer next() { return Integer.valueOf(Short2IntOpenHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 607 */       return new Short2IntOpenHashMap.KeyIterator(Short2IntOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 610 */       return Short2IntOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(short k) {
/* 613 */       return Short2IntOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(short k) {
/* 616 */       int oldSize = Short2IntOpenHashMap.this.size;
/* 617 */       Short2IntOpenHashMap.this.remove(k);
/* 618 */       return Short2IntOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 621 */       Short2IntOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Short2IntOpenHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public short nextShort() { return Short2IntOpenHashMap.this.key[nextEntry()]; } 
/* 603 */     public Short next() { return Short.valueOf(Short2IntOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 547 */       return new Short2IntOpenHashMap.EntryIterator(Short2IntOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Short2IntMap.Entry> fastIterator() {
/* 550 */       return new Short2IntOpenHashMap.FastEntryIterator(Short2IntOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 558 */       int pos = HashCommon.murmurHash3(k) & Short2IntOpenHashMap.this.mask;
/*     */ 
/* 560 */       while (Short2IntOpenHashMap.this.used[pos] != 0) {
/* 561 */         if (Short2IntOpenHashMap.this.key[pos] == k) return Short2IntOpenHashMap.this.value[pos] == ((Integer)e.getValue()).intValue();
/* 562 */         pos = pos + 1 & Short2IntOpenHashMap.this.mask;
/*     */       }
/* 564 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 572 */       int pos = HashCommon.murmurHash3(k) & Short2IntOpenHashMap.this.mask;
/*     */ 
/* 574 */       while (Short2IntOpenHashMap.this.used[pos] != 0) {
/* 575 */         if (Short2IntOpenHashMap.this.key[pos] == k) {
/* 576 */           Short2IntOpenHashMap.this.remove(e.getKey());
/* 577 */           return true;
/*     */         }
/* 579 */         pos = pos + 1 & Short2IntOpenHashMap.this.mask;
/*     */       }
/* 581 */       return false;
/*     */     }
/*     */     public int size() {
/* 584 */       return Short2IntOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 587 */       Short2IntOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Short2IntOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Short2IntMap.Entry>
/*     */   {
/* 537 */     final AbstractShort2IntMap.BasicEntry entry = new AbstractShort2IntMap.BasicEntry((short)0, 0);
/*     */ 
...
/* 539 */       int e = nextEntry();
/* 540 */       this.entry.key = Short2IntOpenHashMap.this.key[e];
/* 541 */       this.entry.value = Short2IntOpenHashMap.this.value[e];
/* 542 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Short2IntOpenHashMap.MapIterator
/*     */     implements ObjectIterator<Short2IntMap.Entry>
/*     */   {
...
/* 528 */       return this.entry = new Short2IntOpenHashMap.MapEntry(Short2IntOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 532 */       super.remove();
/* 533 */       Short2IntOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 434 */       this.pos = Short2IntOpenHashMap.this.n;
/*     */ 
/* 437 */       this.last = -1;
/*     */ 
/* 439 */       this.c = Short2IntOpenHashMap.this.size;
/*     */ 
/* 444 */       boolean[] used = Short2IntOpenHashMap.this.used;
...
/*     */ 
/* 457 */         int pos = HashCommon.murmurHash3(k) & Short2IntOpenHashMap.this.mask;
/*     */ 
/* 459 */         while (Short2IntOpenHashMap.this.used[pos] != 0) {
/* 460 */           if (Short2IntOpenHashMap.this.key[pos] == k) return pos;
/* 461 */           pos = pos + 1 & Short2IntOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 464 */       this.last = this.pos;
/*     */ 
/* 466 */       if (this.c != 0) {
/* 467 */         boolean[] used = Short2IntOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 484 */         pos = (last = pos) + 1 & Short2IntOpenHashMap.this.mask;
/* 485 */         while (Short2IntOpenHashMap.this.used[pos] != 0) {
/* 486 */           int slot = HashCommon.murmurHash3(Short2IntOpenHashMap.this.key[pos]) & Short2IntOpenHashMap.this.mask;
/* 487 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488 */           pos = pos + 1 & Short2IntOpenHashMap.this.mask;
/*     */         }
/* 490 */         if (Short2IntOpenHashMap.this.used[pos] == 0) break;
/* 491 */         if (pos < last)
/*     */         {
/* 493 */           if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 494 */           this.wrapped.add(Short2IntOpenHashMap.this.key[pos]);
/*     */         }
/* 496 */         Short2IntOpenHashMap.this.key[last] = Short2IntOpenHashMap.this.key[pos];
/* 497 */         Short2IntOpenHashMap.this.value[last] = Short2IntOpenHashMap.this.value[pos];
/*     */       }
/* 499 */       Short2IntOpenHashMap.this.used[last] = false;
/* 500 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 505 */       if (this.pos < -1)
/*     */       {
/* 507 */         Short2IntOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 508 */         this.last = -1;
/* 509 */         return;
/*     */       }
/* 511 */       Short2IntOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Short getKey() {
/* 398 */       return Short.valueOf(Short2IntOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public short getShortKey() {
/* 401 */       return Short2IntOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public Integer getValue() {
/* 404 */       return Integer.valueOf(Short2IntOpenHashMap.this.value[this.index]);
/*     */     }
/*     */     public int getIntValue() {
/* 407 */       return Short2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public int setValue(int v) {
/* 410 */       int oldValue = Short2IntOpenHashMap.this.value[this.index];
/* 411 */       Short2IntOpenHashMap.this.value[this.index] = v;
/* 412 */       return oldValue;
/*     */     }
...
/* 421 */       return (Short2IntOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2IntOpenHashMap.this.value[this.index] == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */     public int hashCode() {
/* 424 */       return Short2IntOpenHashMap.this.key[this.index] ^ Short2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 427 */       return Short2IntOpenHashMap.this.key[this.index] + "=>" + Short2IntOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
