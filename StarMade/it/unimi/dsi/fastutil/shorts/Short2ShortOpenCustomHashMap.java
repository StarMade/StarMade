  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2ShortOpenCustomHashMap(int expected, float local_f, ShortHash.Strategy strategy)
  {
  ...
  public Short2ShortOpenCustomHashMap(Map<? extends Short, ? extends Short> local_m, float local_f, ShortHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Short2ShortOpenCustomHashMap(Map<? extends Short, ? extends Short> local_m, ShortHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Short2ShortOpenCustomHashMap(Short2ShortMap local_m, float local_f, ShortHash.Strategy strategy)
  {
    this(local_m.size(), local_f, strategy);
    putAll(local_m);
  }
  
  public Short2ShortOpenCustomHashMap(Short2ShortMap local_m, ShortHash.Strategy strategy)
  {
    this(local_m, 0.75F, strategy);
  }
  
  public Short2ShortOpenCustomHashMap(short[] local_k, short[] local_v, float local_f, ShortHash.Strategy strategy)
  {
  ...
  public Short2ShortOpenCustomHashMap(short[] local_k, short[] local_v, ShortHash.Strategy strategy)
  {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Short2ShortOpenCustomHashMap.ValueIterator(Short2ShortOpenCustomHashMap.this);
        }
        ...
        {
          return Short2ShortOpenCustomHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2ShortOpenCustomHashMap local_c;
    try
    {
      local_c = (Short2ShortOpenCustomHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Short2ShortOpenCustomHashMap.MapIterator
    implements ShortIterator
  {
    ...
    public Short next()
    {
      return Short.valueOf(Short2ShortOpenCustomHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractShortSet
  {
    ...
    public ShortIterator iterator()
    {
      return new Short2ShortOpenCustomHashMap.KeyIterator(Short2ShortOpenCustomHashMap.this);
    }
    ...
    {
      return Short2ShortOpenCustomHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2ShortOpenCustomHashMap.this.size;
      Short2ShortOpenCustomHashMap.this.remove(local_k);
    ...
    implements ShortIterator
  {
    ...
    public Short next()
    {
      return Short.valueOf(Short2ShortOpenCustomHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Short2ShortMap.FastEntrySet
  {
    ...
    {
      return new Short2ShortOpenCustomHashMap.EntryIterator(Short2ShortOpenCustomHashMap.this, null);
    }
    
    public ObjectIterator<Short2ShortMap.Entry> fastIterator()
    {
      return new Short2ShortOpenCustomHashMap.FastEntryIterator(Short2ShortOpenCustomHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Short2ShortOpenCustomHashMap.this.strategy.hashCode(local_k)) & Short2ShortOpenCustomHashMap.this.mask; Short2ShortOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortOpenCustomHashMap.this.mask) {
        if (Short2ShortOpenCustomHashMap.this.strategy.equals(Short2ShortOpenCustomHashMap.this.key[pos], local_k)) {
          return Short2ShortOpenCustomHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(Short2ShortOpenCustomHashMap.this.strategy.hashCode(local_k)) & Short2ShortOpenCustomHashMap.this.mask; Short2ShortOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortOpenCustomHashMap.this.mask) {
        if (Short2ShortOpenCustomHashMap.this.strategy.equals(Short2ShortOpenCustomHashMap.this.key[pos], local_k))
        {
          Short2ShortOpenCustomHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Short2ShortMap.Entry>
  {
    ...
    public AbstractShort2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Short2ShortOpenCustomHashMap.this.key[local_e];
      this.entry.value = Short2ShortOpenCustomHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Short2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Short2ShortOpenCustomHashMap.MapEntry(Short2ShortOpenCustomHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2ShortOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Short2ShortOpenCustomHashMap.this.field_49;
    int last = -1;
    int field_1783 = Short2ShortOpenCustomHashMap.this.size;
    ShortArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Short2ShortOpenCustomHashMap.this.used;
      while ((this.field_1783 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1783 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Short2ShortOpenCustomHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2ShortOpenCustomHashMap.this.mask; Short2ShortOpenCustomHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortOpenCustomHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Short2ShortOpenCustomHashMap.this.strategy.hashCode(Short2ShortOpenCustomHashMap.this.key[pos])) & Short2ShortOpenCustomHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Short2ShortOpenCustomHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Short2ShortOpenCustomHashMap.this.key[pos]);
        }
        Short2ShortOpenCustomHashMap.this.key[last] = Short2ShortOpenCustomHashMap.this.key[pos];
        Short2ShortOpenCustomHashMap.this.value[last] = Short2ShortOpenCustomHashMap.this.value[pos];
      }
      Short2ShortOpenCustomHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Short2ShortOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
        this.last = -1;
        return;
      }
      Short2ShortOpenCustomHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1783 > 0))
      {
        this.field_1783 += 1;
        nextEntry();
      }
    ...
    implements Short2ShortMap.Entry, Map.Entry<Short, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Short2ShortOpenCustomHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, Short> local_e = (Map.Entry)local_o;
      return (Short2ShortOpenCustomHashMap.this.strategy.equals(Short2ShortOpenCustomHashMap.this.key[this.index], ((Short)local_e.getKey()).shortValue())) && (Short2ShortOpenCustomHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
