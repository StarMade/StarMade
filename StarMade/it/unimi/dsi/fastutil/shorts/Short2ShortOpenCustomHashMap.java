...
/* 662 */           return new Short2ShortOpenCustomHashMap.ValueIterator(Short2ShortOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 665 */           return Short2ShortOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(short v) {
/* 668 */           return Short2ShortOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 671 */           Short2ShortOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 786 */       c = (Short2ShortOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Short2ShortOpenCustomHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 655 */       super(null); } 
/* 656 */     public short nextShort() { return Short2ShortOpenCustomHashMap.this.value[nextEntry()]; } 
/* 657 */     public Short next() { return Short.valueOf(Short2ShortOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     public ShortIterator iterator()
/*     */     {
/* 627 */       return new Short2ShortOpenCustomHashMap.KeyIterator(Short2ShortOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 630 */       return Short2ShortOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(short k) {
/* 633 */       return Short2ShortOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(short k) {
/* 636 */       int oldSize = Short2ShortOpenCustomHashMap.this.size;
/* 637 */       Short2ShortOpenCustomHashMap.this.remove(k);
/* 638 */       return Short2ShortOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 641 */       Short2ShortOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Short2ShortOpenCustomHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public short nextShort() { return Short2ShortOpenCustomHashMap.this.key[nextEntry()]; } 
/* 623 */     public Short next() { return Short.valueOf(Short2ShortOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 567 */       return new Short2ShortOpenCustomHashMap.EntryIterator(Short2ShortOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Short2ShortMap.Entry> fastIterator() {
/* 570 */       return new Short2ShortOpenCustomHashMap.FastEntryIterator(Short2ShortOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 578 */       int pos = HashCommon.murmurHash3(Short2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ShortOpenCustomHashMap.this.mask;
/*     */ 
/* 580 */       while (Short2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 581 */         if (Short2ShortOpenCustomHashMap.this.strategy.equals(Short2ShortOpenCustomHashMap.this.key[pos], k)) return Short2ShortOpenCustomHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 582 */         pos = pos + 1 & Short2ShortOpenCustomHashMap.this.mask;
/*     */       }
/* 584 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 592 */       int pos = HashCommon.murmurHash3(Short2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ShortOpenCustomHashMap.this.mask;
/*     */ 
/* 594 */       while (Short2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 595 */         if (Short2ShortOpenCustomHashMap.this.strategy.equals(Short2ShortOpenCustomHashMap.this.key[pos], k)) {
/* 596 */           Short2ShortOpenCustomHashMap.this.remove(e.getKey());
/* 597 */           return true;
/*     */         }
/* 599 */         pos = pos + 1 & Short2ShortOpenCustomHashMap.this.mask;
/*     */       }
/* 601 */       return false;
/*     */     }
/*     */     public int size() {
/* 604 */       return Short2ShortOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 607 */       Short2ShortOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Short2ShortOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Short2ShortMap.Entry>
/*     */   {
/* 557 */     final AbstractShort2ShortMap.BasicEntry entry = new AbstractShort2ShortMap.BasicEntry((short)0, (short)0);
/*     */ 
...
/* 559 */       int e = nextEntry();
/* 560 */       this.entry.key = Short2ShortOpenCustomHashMap.this.key[e];
/* 561 */       this.entry.value = Short2ShortOpenCustomHashMap.this.value[e];
/* 562 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Short2ShortOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Short2ShortMap.Entry>
/*     */   {
...
/* 548 */       return this.entry = new Short2ShortOpenCustomHashMap.MapEntry(Short2ShortOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 552 */       super.remove();
/* 553 */       Short2ShortOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 454 */       this.pos = Short2ShortOpenCustomHashMap.this.n;
/*     */ 
/* 457 */       this.last = -1;
/*     */ 
/* 459 */       this.c = Short2ShortOpenCustomHashMap.this.size;
/*     */ 
/* 464 */       boolean[] used = Short2ShortOpenCustomHashMap.this.used;
...
/*     */ 
/* 477 */         int pos = HashCommon.murmurHash3(Short2ShortOpenCustomHashMap.this.strategy.hashCode(k)) & Short2ShortOpenCustomHashMap.this.mask;
/*     */ 
/* 479 */         while (Short2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 480 */           if (Short2ShortOpenCustomHashMap.this.strategy.equals(Short2ShortOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481 */           pos = pos + 1 & Short2ShortOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 484 */       this.last = this.pos;
/*     */ 
/* 486 */       if (this.c != 0) {
/* 487 */         boolean[] used = Short2ShortOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 504 */         pos = (last = pos) + 1 & Short2ShortOpenCustomHashMap.this.mask;
/* 505 */         while (Short2ShortOpenCustomHashMap.this.used[pos] != 0) {
/* 506 */           int slot = HashCommon.murmurHash3(Short2ShortOpenCustomHashMap.this.strategy.hashCode(Short2ShortOpenCustomHashMap.this.key[pos])) & Short2ShortOpenCustomHashMap.this.mask;
/* 507 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508 */           pos = pos + 1 & Short2ShortOpenCustomHashMap.this.mask;
/*     */         }
/* 510 */         if (Short2ShortOpenCustomHashMap.this.used[pos] == 0) break;
/* 511 */         if (pos < last)
/*     */         {
/* 513 */           if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 514 */           this.wrapped.add(Short2ShortOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 516 */         Short2ShortOpenCustomHashMap.this.key[last] = Short2ShortOpenCustomHashMap.this.key[pos];
/* 517 */         Short2ShortOpenCustomHashMap.this.value[last] = Short2ShortOpenCustomHashMap.this.value[pos];
/*     */       }
/* 519 */       Short2ShortOpenCustomHashMap.this.used[last] = false;
/* 520 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 525 */       if (this.pos < -1)
/*     */       {
/* 527 */         Short2ShortOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 528 */         this.last = -1;
/* 529 */         return;
/*     */       }
/* 531 */       Short2ShortOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Short getKey() {
/* 418 */       return Short.valueOf(Short2ShortOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public short getShortKey() {
/* 421 */       return Short2ShortOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Short getValue() {
/* 424 */       return Short.valueOf(Short2ShortOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public short getShortValue() {
/* 427 */       return Short2ShortOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public short setValue(short v) {
/* 430 */       short oldValue = Short2ShortOpenCustomHashMap.this.value[this.index];
/* 431 */       Short2ShortOpenCustomHashMap.this.value[this.index] = v;
/* 432 */       return oldValue;
/*     */     }
/*     */     public Short setValue(Short v) {
...
/* 441 */       return (Short2ShortOpenCustomHashMap.this.strategy.equals(Short2ShortOpenCustomHashMap.this.key[this.index], ((Short)e.getKey()).shortValue())) && (Short2ShortOpenCustomHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/*     */     }
/*     */     public int hashCode() {
/* 444 */       return Short2ShortOpenCustomHashMap.this.strategy.hashCode(Short2ShortOpenCustomHashMap.this.key[this.index]) ^ Short2ShortOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public String toString() {
/* 447 */       return Short2ShortOpenCustomHashMap.this.key[this.index] + "=>" + Short2ShortOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
