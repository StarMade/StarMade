...
/*      */ 
/*      */ public class Short2FloatRBTreeMap extends AbstractShort2FloatSortedMap
...
/*  119 */           return Short2FloatRBTreeMap.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*      */         }
/*      */         public int compare(Short ok1, Short ok2) {
/*  122 */           return Short2FloatRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     float oldValue = put(ok.shortValue(), ov.floatValue());
/*  731 */     return this.modified ? null : Float.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Float remove(Object ok)
/*      */   {
/*  737 */     float oldValue = remove(((Short)ok).shortValue());
...
/* 1141 */         final Comparator<? super Short2FloatMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Short2FloatMap.Entry x, Short2FloatMap.Entry y) {
/* 1143 */             return Short2FloatRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Short2FloatRBTreeMap.EntryIterator(Short2FloatRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1153 */           return new Short2FloatRBTreeMap.EntryIterator(Short2FloatRBTreeMap.this, ((Short)from.getKey()).shortValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1166 */           Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1167 */           if (f != null) Short2FloatRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Short2FloatRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Short2FloatRBTreeMap.this.clear(); } 
/* 1172 */         public Short2FloatMap.Entry first() { return Short2FloatRBTreeMap.this.firstEntry; } 
/* 1173 */         public Short2FloatMap.Entry last() { return Short2FloatRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) { return Short2FloatRBTreeMap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2FloatEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) { return Short2FloatRBTreeMap.this.headMap((Short)to.getKey()).short2FloatEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) { return Short2FloatRBTreeMap.this.tailMap((Short)from.getKey()).short2FloatEntrySet(); }
/*      */       };
...
/* 1242 */           return new Short2FloatRBTreeMap.ValueIterator(Short2FloatRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(float k) {
/* 1245 */           return Short2FloatRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Short2FloatRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Short2FloatRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Short2FloatRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readShort(), s.readFloat());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readShort(), s.readFloat());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readShort(), s.readFloat()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Short2FloatRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Short2FloatRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator() {
/* 1329 */             return new Short2FloatRBTreeMap.Submap.SubmapEntryIterator(Short2FloatRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from) {
/* 1332 */             return new Short2FloatRBTreeMap.Submap.SubmapEntryIterator(Short2FloatRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
/*      */           }
/* 1334 */           public Comparator<? super Short2FloatMap.Entry> comparator() { return Short2FloatRBTreeMap.this.short2FloatEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1340 */             return (f != null) && (Short2FloatRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Short2FloatRBTreeMap.Entry f = Short2FloatRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1347 */             if ((f != null) && (Short2FloatRBTreeMap.Submap.this.in(f.key))) Short2FloatRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Short2FloatRBTreeMap.Submap.SubmapIterator(Short2FloatRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Short2FloatRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Short2FloatMap.Entry first() { return Short2FloatRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Short2FloatMap.Entry last() { return Short2FloatRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry to) { return Short2FloatRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2FloatEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry to) { return Short2FloatRBTreeMap.Submap.this.headMap((Short)to.getKey()).short2FloatEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from) { return Short2FloatRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2FloatEntrySet(); }
/*      */         };
...
/*      */           public FloatIterator iterator() {
/* 1376 */             return new Short2FloatRBTreeMap.Submap.SubmapValueIterator(Short2FloatRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(float k) {
/* 1379 */             return Short2FloatRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Short2FloatRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Short2FloatRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(short k) {
/* 1392 */       return (in(k)) && (Short2FloatRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(float v) {
...
/* 1407 */       return (in(kk)) && ((e = Short2FloatRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public float put(short k, float v) {
/* 1410 */       Short2FloatRBTreeMap.this.modified = false;
...
/* 1412 */       float oldValue = Short2FloatRBTreeMap.this.put(k, v);
/* 1413 */       return Short2FloatRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Float put(Short ok, Float ov) {
/* 1416 */       float oldValue = put(ok.shortValue(), ov.floatValue());
/* 1417 */       return Short2FloatRBTreeMap.this.modified ? null : Float.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public float remove(short k) {
/* 1421 */       Short2FloatRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       float oldValue = Short2FloatRBTreeMap.this.remove(k);
/* 1424 */       return Short2FloatRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Float remove(Object ok) {
/* 1427 */       float oldValue = remove(((Short)ok).shortValue());
/* 1428 */       return Short2FloatRBTreeMap.this.modified ? Float.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ShortComparator comparator() {
/* 1443 */       return Short2FloatRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Short2FloatSortedMap headMap(short to) {
/* 1446 */       if (this.top) return new Submap(Short2FloatRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Short2FloatRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Short2FloatRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Short2FloatSortedMap tailMap(short from) {
/* 1450 */       if (this.bottom) return new Submap(Short2FloatRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Short2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2FloatRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Short2FloatSortedMap subMap(short from, short to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Short2FloatRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Short2FloatRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Short2FloatRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Short2FloatRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Short2FloatRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Short2FloatRBTreeMap.this.tree == null) return null;
/* 1468 */       Short2FloatRBTreeMap.Entry e;
/*      */       Short2FloatRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Short2FloatRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Short2FloatRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Short2FloatRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Short2FloatRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Short2FloatRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Short2FloatRBTreeMap.this.tree == null) return null;
/* 1486 */       Short2FloatRBTreeMap.Entry e;
/*      */       Short2FloatRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Short2FloatRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Short2FloatRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Short2FloatRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Short2FloatRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public short firstShortKey() {
/* 1497 */       Short2FloatRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public short lastShortKey() {
/* 1502 */       Short2FloatRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Short firstKey() {
/* 1507 */       Short2FloatRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Short lastKey() {
/* 1512 */       Short2FloatRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Short2FloatRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Short2FloatRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Short2FloatRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Short2FloatMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Short2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Short2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Short2FloatRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Short2FloatRBTreeMap.Submap.this.bottom) && (Short2FloatRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Short2FloatRBTreeMap.Submap.this.top) && (Short2FloatRBTreeMap.this.compare(k, (this.prev = Short2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Short2FloatRBTreeMap.this.locateKey(k);
/* 1534 */             if (Short2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Short2FloatRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2FloatRBTreeMap.this.compare(this.prev.key, Short2FloatRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Short2FloatRBTreeMap.Submap.this.top) && (this.next != null) && (Short2FloatRBTreeMap.this.compare(this.next.key, Short2FloatRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public ShortBidirectionalIterator iterator() { return new Short2FloatRBTreeMap.Submap.SubmapKeyIterator(Short2FloatRBTreeMap.Submap.this); } 
/* 1367 */       public ShortBidirectionalIterator iterator(short from) { return new Short2FloatRBTreeMap.Submap.SubmapKeyIterator(Short2FloatRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2FloatRBTreeMap.TreeIterator
/*      */     implements FloatListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public ShortBidirectionalIterator iterator() { return new Short2FloatRBTreeMap.KeyIterator(Short2FloatRBTreeMap.this); } 
/* 1201 */     public ShortBidirectionalIterator iterator(short from) { return new Short2FloatRBTreeMap.KeyIterator(Short2FloatRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2FloatRBTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2FloatRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Short2FloatMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Short2FloatMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Short2FloatMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Short2FloatMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Short2FloatRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(short k) {
/* 1067 */       if ((this.next = Short2FloatRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Short2FloatRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Short2FloatRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == ((Float)e.getValue()).floatValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
