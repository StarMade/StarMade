  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2FloatRBTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2FloatRBTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2FloatRBTreeMap(Map<? extends Short, ? extends Float> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2FloatRBTreeMap(SortedMap<Short, Float> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2FloatRBTreeMap(Short2FloatMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2FloatRBTreeMap(Short2FloatSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2FloatRBTreeMap(short[] local_k, float[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2FloatRBTreeMap(short[] local_k, float[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2FloatMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Short2FloatRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2FloatRBTreeMap.EntryIterator(Short2FloatRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from)
        {
          return new Short2FloatRBTreeMap.EntryIterator(Short2FloatRBTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2FloatRBTreeMap.Entry local_f = Short2FloatRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2FloatRBTreeMap.Entry local_f = Short2FloatRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2FloatRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2FloatRBTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2FloatEntrySet();
        }
        
        public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry local_to)
        {
          return Short2FloatRBTreeMap.this.headMap((Short)local_to.getKey()).short2FloatEntrySet();
        }
        
        public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from)
        {
          return Short2FloatRBTreeMap.this.tailMap((Short)from.getKey()).short2FloatEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Short2FloatRBTreeMap.ValueIterator(Short2FloatRBTreeMap.this, null);
        }
        
        public boolean contains(float local_k)
        {
          return Short2FloatRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2FloatRBTreeMap local_c;
    try
    {
      local_c = (Short2FloatRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2FloatRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2FloatRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2FloatRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator()
          {
            return new Short2FloatRBTreeMap.Submap.SubmapEntryIterator(Short2FloatRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2FloatMap.Entry> iterator(Short2FloatMap.Entry from)
          {
            return new Short2FloatRBTreeMap.Submap.SubmapEntryIterator(Short2FloatRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Float> local_e = (Map.Entry)local_o;
            Short2FloatRBTreeMap.Entry local_f = Short2FloatRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2FloatRBTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Float> local_e = (Map.Entry)local_o;
            Short2FloatRBTreeMap.Entry local_f = Short2FloatRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2FloatRBTreeMap.Submap.this.in6(local_f.key))) {
              Short2FloatRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2FloatRBTreeMap.Submap.SubmapIterator(Short2FloatRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2FloatRBTreeMap.Submap.this.clear();
          }
          
          public Short2FloatMap.Entry first()
          {
            return Short2FloatRBTreeMap.Submap.this.firstEntry();
          }
          
          public Short2FloatMap.Entry last()
          {
            return Short2FloatRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2FloatMap.Entry> subSet(Short2FloatMap.Entry from, Short2FloatMap.Entry local_to)
          {
            return Short2FloatRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2FloatEntrySet();
          }
          
          public ObjectSortedSet<Short2FloatMap.Entry> headSet(Short2FloatMap.Entry local_to)
          {
            return Short2FloatRBTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2FloatEntrySet();
          }
          
          public ObjectSortedSet<Short2FloatMap.Entry> tailSet(Short2FloatMap.Entry from)
          {
            return Short2FloatRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2FloatEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public FloatCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractFloatCollection()
        {
          public FloatIterator iterator()
          {
            return new Short2FloatRBTreeMap.Submap.SubmapValueIterator(Short2FloatRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(float local_k)
          {
            return Short2FloatRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2FloatRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2FloatRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2FloatRBTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2FloatRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public float put(short local_k, float local_v)
    {
      ...
      float oldValue = Short2FloatRBTreeMap.this.put(local_k, local_v);
    ...
    public float remove(short local_k)
    {
      ...
      float oldValue = Short2FloatRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2FloatRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2FloatRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2FloatRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2FloatSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2FloatRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2FloatRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2FloatRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2FloatSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2FloatRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2FloatRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2FloatRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2FloatRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2FloatRBTreeMap.this.locateKey(this.from);
        if (Short2FloatRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2FloatRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2FloatRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2FloatRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2FloatRBTreeMap.this.locateKey(this.field_47);
        if (Short2FloatRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2FloatRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2FloatRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2FloatRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2FloatRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2FloatRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2FloatRBTreeMap.Submap.this.bottom) && (Short2FloatRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2FloatRBTreeMap.Submap.this.top) && (Short2FloatRBTreeMap.this.compare(local_k, (this.prev = Short2FloatRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2FloatRBTreeMap.this.locateKey(local_k);
            if (Short2FloatRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2FloatRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2FloatRBTreeMap.this.compare(this.prev.key, Short2FloatRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2FloatRBTreeMap.Submap.this.top) && (this.next != null) && (Short2FloatRBTreeMap.this.compare(this.next.key, Short2FloatRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2FloatSortedMap.KeySet
    {
      ...
      {
        return new Short2FloatRBTreeMap.Submap.SubmapKeyIterator(Short2FloatRBTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2FloatRBTreeMap.Submap.SubmapKeyIterator(Short2FloatRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2FloatSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2FloatRBTreeMap.KeyIterator(Short2FloatRBTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2FloatRBTreeMap.KeyIterator(Short2FloatRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2FloatRBTreeMap.this.locateKey(local_k)) != null) {
        if (Short2FloatRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
