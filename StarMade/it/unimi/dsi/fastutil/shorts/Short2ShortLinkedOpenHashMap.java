  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2ShortLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Short2ShortLinkedOpenHashMap(Map<? extends Short, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2ShortLinkedOpenHashMap(Map<? extends Short, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2ShortLinkedOpenHashMap(Short2ShortMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2ShortLinkedOpenHashMap(Short2ShortMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2ShortLinkedOpenHashMap(short[] local_k, short[] local_v, float local_f)
  {
  ...
  public Short2ShortLinkedOpenHashMap(short[] local_k, short[] local_v)
  {
  ...
  public short add(short local_k, short incr)
  {
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k)
      {
  ...
  public short getAndMoveToFirst(short local_k)
  {
    short[] key = this.key;
  ...
  public short getAndMoveToLast(short local_k)
  {
    short[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public short putAndMoveToFirst(short local_k, short local_v)
  {
    short[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public short putAndMoveToLast(short local_k, short local_v)
  {
    short[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public Short get(Short local_ok)
  {
    short local_k = local_ok.shortValue();
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k) {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Short2ShortLinkedOpenHashMap.ValueIterator(Short2ShortLinkedOpenHashMap.this);
        }
        ...
        {
          return Short2ShortLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2ShortLinkedOpenHashMap local_c;
    try
    {
      local_c = (Short2ShortLinkedOpenHashMap)super.clone();
    }
    ...
    implements ShortListIterator
  {
    ...
    {
      return Short.valueOf(Short2ShortLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Short next()
    {
      return Short.valueOf(Short2ShortLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractShortSortedSet
  {
    ...
    {
      return new Short2ShortLinkedOpenHashMap.KeyIterator(Short2ShortLinkedOpenHashMap.this, from);
    }
    
    public ShortListIterator iterator()
    {
      return new Short2ShortLinkedOpenHashMap.KeyIterator(Short2ShortLinkedOpenHashMap.this);
    }
    ...
    {
      return Short2ShortLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2ShortLinkedOpenHashMap.this.size;
      Short2ShortLinkedOpenHashMap.this.remove(local_k);
    ...
    implements ShortListIterator
  {
    ...
    public Short previous()
    {
      return Short.valueOf(Short2ShortLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Short next()
    {
      return Short.valueOf(Short2ShortLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Short2ShortSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Short2ShortLinkedOpenHashMap.EntryIterator(Short2ShortLinkedOpenHashMap.this);
    }
    ...
    public Short2ShortMap.Entry first()
    {
      ...
      return new Short2ShortLinkedOpenHashMap.MapEntry(Short2ShortLinkedOpenHashMap.this, Short2ShortLinkedOpenHashMap.this.first);
    }
    ...
    public Short2ShortMap.Entry last()
    {
      ...
      return new Short2ShortLinkedOpenHashMap.MapEntry(Short2ShortLinkedOpenHashMap.this, Short2ShortLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2ShortLinkedOpenHashMap.this.mask; Short2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortLinkedOpenHashMap.this.mask) {
        if (Short2ShortLinkedOpenHashMap.this.key[pos] == local_k) {
          return Short2ShortLinkedOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2ShortLinkedOpenHashMap.this.mask; Short2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortLinkedOpenHashMap.this.mask) {
        if (Short2ShortLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Short2ShortLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Short2ShortLinkedOpenHashMap.EntryIterator(Short2ShortLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
    }
    
    public ObjectBidirectionalIterator<Short2ShortMap.Entry> fastIterator()
    {
      return new Short2ShortLinkedOpenHashMap.FastEntryIterator(Short2ShortLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Short2ShortMap.Entry> fastIterator(Short2ShortMap.Entry from)
    {
      return new Short2ShortLinkedOpenHashMap.FastEntryIterator(Short2ShortLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
    }
  }
    ...
    implements ObjectListIterator<Short2ShortMap.Entry>
  {
    ...
    public AbstractShort2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Short2ShortLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Short2ShortLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Short2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Short2ShortLinkedOpenHashMap.MapEntry(Short2ShortLinkedOpenHashMap.this, nextEntry());
    }
    
    public Short2ShortLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Short2ShortLinkedOpenHashMap.MapEntry(Short2ShortLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2ShortLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(short from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Short2ShortLinkedOpenHashMap.this.mask; Short2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Short2ShortLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Short2ShortLinkedOpenHashMap.this.first = this.next;
      } else {
        Short2ShortLinkedOpenHashMap.this.link[this.prev] ^= (Short2ShortLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Short2ShortLinkedOpenHashMap.this.last = this.prev;
      } else {
        Short2ShortLinkedOpenHashMap.this.link[this.next] ^= (Short2ShortLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2ShortLinkedOpenHashMap.this.mask; Short2ShortLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortLinkedOpenHashMap.this.mask)
        {
        ...
        if (Short2ShortLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Short2ShortMap.Entry, Map.Entry<Short, Short>
  {
    ...
    public short setValue(short local_v)
    {
      ...
      Short2ShortLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, Short> local_e = (Map.Entry)local_o;
      return (Short2ShortLinkedOpenHashMap.this.key[this.index] == ((Short)local_e.getKey()).shortValue()) && (Short2ShortLinkedOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
