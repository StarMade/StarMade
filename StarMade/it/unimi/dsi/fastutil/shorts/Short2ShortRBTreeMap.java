  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2ShortRBTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2ShortRBTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2ShortRBTreeMap(Map<? extends Short, ? extends Short> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ShortRBTreeMap(SortedMap<Short, Short> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ShortRBTreeMap(Short2ShortMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ShortRBTreeMap(Short2ShortSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ShortRBTreeMap(short[] local_k, short[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2ShortRBTreeMap(short[] local_k, short[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2ShortMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Short2ShortRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2ShortRBTreeMap.EntryIterator(Short2ShortRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from)
        {
          return new Short2ShortRBTreeMap.EntryIterator(Short2ShortRBTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2ShortRBTreeMap.Entry local_f = Short2ShortRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2ShortRBTreeMap.Entry local_f = Short2ShortRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2ShortRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2ShortRBTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ShortEntrySet();
        }
        
        public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry local_to)
        {
          return Short2ShortRBTreeMap.this.headMap((Short)local_to.getKey()).short2ShortEntrySet();
        }
        
        public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from)
        {
          return Short2ShortRBTreeMap.this.tailMap((Short)from.getKey()).short2ShortEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Short2ShortRBTreeMap.ValueIterator(Short2ShortRBTreeMap.this, null);
        }
        
        public boolean contains(short local_k)
        {
          return Short2ShortRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2ShortRBTreeMap local_c;
    try
    {
      local_c = (Short2ShortRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2ShortRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2ShortRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2ShortRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator()
          {
            return new Short2ShortRBTreeMap.Submap.SubmapEntryIterator(Short2ShortRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from)
          {
            return new Short2ShortRBTreeMap.Submap.SubmapEntryIterator(Short2ShortRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Short> local_e = (Map.Entry)local_o;
            Short2ShortRBTreeMap.Entry local_f = Short2ShortRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2ShortRBTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Short> local_e = (Map.Entry)local_o;
            Short2ShortRBTreeMap.Entry local_f = Short2ShortRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2ShortRBTreeMap.Submap.this.in6(local_f.key))) {
              Short2ShortRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2ShortRBTreeMap.Submap.SubmapIterator(Short2ShortRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2ShortRBTreeMap.Submap.this.clear();
          }
          
          public Short2ShortMap.Entry first()
          {
            return Short2ShortRBTreeMap.Submap.this.firstEntry();
          }
          
          public Short2ShortMap.Entry last()
          {
            return Short2ShortRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry local_to)
          {
            return Short2ShortRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ShortEntrySet();
          }
          
          public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry local_to)
          {
            return Short2ShortRBTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2ShortEntrySet();
          }
          
          public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from)
          {
            return Short2ShortRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2ShortEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ShortCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractShortCollection()
        {
          public ShortIterator iterator()
          {
            return new Short2ShortRBTreeMap.Submap.SubmapValueIterator(Short2ShortRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(short local_k)
          {
            return Short2ShortRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2ShortRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2ShortRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2ShortRBTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2ShortRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public short put(short local_k, short local_v)
    {
      ...
      short oldValue = Short2ShortRBTreeMap.this.put(local_k, local_v);
    ...
    public short remove(short local_k)
    {
      ...
      short oldValue = Short2ShortRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2ShortRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2ShortRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2ShortSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2ShortRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2ShortRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2ShortSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2ShortRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2ShortRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2ShortRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2ShortRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2ShortRBTreeMap.this.locateKey(this.from);
        if (Short2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2ShortRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2ShortRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2ShortRBTreeMap.this.locateKey(this.field_47);
        if (Short2ShortRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2ShortRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2ShortRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2ShortRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2ShortRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2ShortRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2ShortRBTreeMap.Submap.this.bottom) && (Short2ShortRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2ShortRBTreeMap.Submap.this.top) && (Short2ShortRBTreeMap.this.compare(local_k, (this.prev = Short2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2ShortRBTreeMap.this.locateKey(local_k);
            if (Short2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2ShortRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2ShortRBTreeMap.this.compare(this.prev.key, Short2ShortRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2ShortRBTreeMap.Submap.this.top) && (this.next != null) && (Short2ShortRBTreeMap.this.compare(this.next.key, Short2ShortRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2ShortSortedMap.KeySet
    {
      ...
      {
        return new Short2ShortRBTreeMap.Submap.SubmapKeyIterator(Short2ShortRBTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2ShortRBTreeMap.Submap.SubmapKeyIterator(Short2ShortRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2ShortSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2ShortRBTreeMap.KeyIterator(Short2ShortRBTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2ShortRBTreeMap.KeyIterator(Short2ShortRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2ShortRBTreeMap.this.locateKey(local_k)) != null) {
        if (Short2ShortRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
