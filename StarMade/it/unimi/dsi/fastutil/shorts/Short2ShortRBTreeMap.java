...
/*   17:     */
/*   73:     */public class Short2ShortRBTreeMap
/*   74:     */  extends AbstractShort2ShortSortedMap
...
/*   81:     */  protected volatile transient ObjectSortedSet<Short2ShortMap.Entry> entries;
...
/*   91:     */  
/*   92:     */  public Short2ShortRBTreeMap()
/*   93:     */  {
/*   94:  94 */    allocatePaths();
/*   95:     */    
...
/*  119: 119 */          return Short2ShortRBTreeMap.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*  120:     */        }
/*  121:     */        
/*  122: 122 */        public int compare(Short ok1, Short ok2) { return Short2ShortRBTreeMap.this.storedComparator.compare(ok1, ok2); }
/*  123:     */      };
/*  124:     */    }
/*  125:     */  }
/*  126:     */  
/*  133:     */  public Short2ShortRBTreeMap(Comparator<? super Short> c)
/*  134:     */  {
/*  135: 135 */    this();
...
/*  138:     */  }
/*  139:     */  
/*  145:     */  public Short2ShortRBTreeMap(Map<? extends Short, ? extends Short> m)
/*  146:     */  {
/*  147: 147 */    this();
/*  148: 148 */    putAll(m);
/*  149:     */  }
/*  150:     */  
/*  155:     */  public Short2ShortRBTreeMap(SortedMap<Short, Short> m)
/*  156:     */  {
/*  157: 157 */    this(m.comparator());
/*  158: 158 */    putAll(m);
/*  159:     */  }
/*  160:     */  
/*  165:     */  public Short2ShortRBTreeMap(Short2ShortMap m)
/*  166:     */  {
/*  167: 167 */    this();
/*  168: 168 */    putAll(m);
/*  169:     */  }
/*  170:     */  
/*  175:     */  public Short2ShortRBTreeMap(Short2ShortSortedMap m)
/*  176:     */  {
/*  177: 177 */    this(m.comparator());
/*  178: 178 */    putAll(m);
/*  179:     */  }
/*  180:     */  
/*  188:     */  public Short2ShortRBTreeMap(short[] k, short[] v, Comparator<? super Short> c)
/*  189:     */  {
/*  190: 190 */    this(c);
...
/*  194:     */  }
/*  195:     */  
/*  201:     */  public Short2ShortRBTreeMap(short[] k, short[] v)
/*  202:     */  {
...
/*  278:     */  }
/*  279:     */  
/*  282:     */  public short put(short k, short v)
/*  283:     */  {
...
/*  448:     */  }
/*  449:     */  
/*  454:     */  public short remove(short k)
/*  455:     */  {
...
/*  724:     */  }
/*  725:     */  
/*  728:     */  public Short put(Short ok, Short ov)
/*  729:     */  {
/*  730: 730 */    short oldValue = put(ok.shortValue(), ov.shortValue());
/*  731: 731 */    return this.modified ? null : Short.valueOf(oldValue);
/*  732:     */  }
/*  733:     */  
/*  735:     */  public Short remove(Object ok)
/*  736:     */  {
/*  737: 737 */    short oldValue = remove(((Short)ok).shortValue());
...
/*  769:     */    implements Cloneable, Short2ShortMap.Entry
/*  770:     */  {
...
/*  977: 977 */      Map.Entry<Short, Short> e = (Map.Entry)o;
/*  978:     */      
/*  979: 979 */      return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == ((Short)e.getValue()).shortValue());
/*  980:     */    }
/*  981:     */    
...
/* 1054:     */  {
/* 1055:     */    Short2ShortRBTreeMap.Entry prev;
/* 1056:     */    
/* 1058:     */    Short2ShortRBTreeMap.Entry next;
/* 1059:     */    
/* 1060:     */    Short2ShortRBTreeMap.Entry curr;
/* 1061:     */    
/* 1062:1062 */    int index = 0;
/* 1063:     */    
/* 1064:1064 */    TreeIterator() { this.next = Short2ShortRBTreeMap.this.firstEntry; }
/* 1065:     */    
/* 1066:     */    TreeIterator(short k) {
/* 1067:1067 */      if ((this.next = Short2ShortRBTreeMap.this.locateKey(k)) != null)
/* 1068:1068 */        if (Short2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1079:     */    
/* 1080:     */    Short2ShortRBTreeMap.Entry nextEntry() {
...
/* 1089:     */    
/* 1090:     */    Short2ShortRBTreeMap.Entry previousEntry() {
...
/* 1111:1111 */      Short2ShortRBTreeMap.this.remove(this.curr.key);
...
/* 1127:     */    extends Short2ShortRBTreeMap.TreeIterator
/* 1128:     */    implements ObjectListIterator<Short2ShortMap.Entry>
/* 1129:     */  {
/* 1130:1130 */    EntryIterator() { super(); }
/* 1131:     */    
/* 1132:1132 */    EntryIterator(short k) { super(k); }
/* 1133:     */    
/* 1134:1134 */    public Short2ShortMap.Entry next() { return nextEntry(); }
/* 1135:1135 */    public Short2ShortMap.Entry previous() { return previousEntry(); }
/* 1136:1136 */    public void set(Short2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1137:1137 */    public void add(Short2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1138:     */  }
/* 1139:     */  
/* 1140:1140 */  public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1141:1141 */        final Comparator<? super Short2ShortMap.Entry> comparator = new Comparator() {
/* 1142:     */          public int compare(Short2ShortMap.Entry x, Short2ShortMap.Entry y) {
/* 1143:1143 */            return Short2ShortRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/* 1144:     */          }
/* 1145:     */        };
/* 1146:     */        
/* 1147:1147 */        public Comparator<? super Short2ShortMap.Entry> comparator() { return this.comparator; }
/* 1148:     */        
/* 1149:     */        public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator() {
/* 1150:1150 */          return new Short2ShortRBTreeMap.EntryIterator(Short2ShortRBTreeMap.this);
/* 1151:     */        }
/* 1152:     */        
/* 1153:1153 */        public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from) { return new Short2ShortRBTreeMap.EntryIterator(Short2ShortRBTreeMap.this, ((Short)from.getKey()).shortValue()); }
/* 1154:     */        
/* 1155:     */        public boolean contains(Object o)
/* 1156:     */        {
/* 1157:1157 */          if (!(o instanceof Map.Entry)) return false;
/* 1158:1158 */          Map.Entry<Short, Short> e = (Map.Entry)o;
/* 1159:1159 */          Short2ShortRBTreeMap.Entry f = Short2ShortRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1160:1160 */          return e.equals(f);
/* 1161:     */        }
/* 1162:     */        
/* 1163:     */        public boolean remove(Object o) {
/* 1164:1164 */          if (!(o instanceof Map.Entry)) return false;
/* 1165:1165 */          Map.Entry<Short, Short> e = (Map.Entry)o;
/* 1166:1166 */          Short2ShortRBTreeMap.Entry f = Short2ShortRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1167:1167 */          if (f != null) Short2ShortRBTreeMap.this.remove(f.key);
/* 1168:1168 */          return f != null; }
/* 1169:     */        
/* 1170:1170 */        public int size() { return Short2ShortRBTreeMap.this.count; }
/* 1171:1171 */        public void clear() { Short2ShortRBTreeMap.this.clear(); }
/* 1172:1172 */        public Short2ShortMap.Entry first() { return Short2ShortRBTreeMap.this.firstEntry; }
/* 1173:1173 */        public Short2ShortMap.Entry last() { return Short2ShortRBTreeMap.this.lastEntry; }
/* 1174:1174 */        public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry to) { return Short2ShortRBTreeMap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2ShortEntrySet(); }
/* 1175:1175 */        public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry to) { return Short2ShortRBTreeMap.this.headMap((Short)to.getKey()).short2ShortEntrySet(); }
/* 1176:1176 */        public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from) { return Short2ShortRBTreeMap.this.tailMap((Short)from.getKey()).short2ShortEntrySet(); }
/* 1177:     */      };
/* 1178:1178 */    return this.entries;
/* 1179:     */  }
/* 1180:     */  
/* 1183:     */  private final class KeyIterator
/* 1184:     */    extends Short2ShortRBTreeMap.TreeIterator
...
/* 1197:     */  }
/* 1198:     */  
/* 1199:1199 */  private class KeySet extends AbstractShort2ShortSortedMap.KeySet { private KeySet() { super(); }
/* 1200:1200 */    public ShortBidirectionalIterator iterator() { return new Short2ShortRBTreeMap.KeyIterator(Short2ShortRBTreeMap.this); }
/* 1201:1201 */    public ShortBidirectionalIterator iterator(short from) { return new Short2ShortRBTreeMap.KeyIterator(Short2ShortRBTreeMap.this, from); }
/* 1202:     */  }
/* 1203:     */  
...
/* 1218:     */    extends Short2ShortRBTreeMap.TreeIterator
...
/* 1242:1242 */          return new Short2ShortRBTreeMap.ValueIterator(Short2ShortRBTreeMap.this, null);
/* 1243:     */        }
/* 1244:     */        
/* 1245:1245 */        public boolean contains(short k) { return Short2ShortRBTreeMap.this.containsValue(k); }
/* 1246:     */        
/* 1247:     */        public int size() {
/* 1248:1248 */          return Short2ShortRBTreeMap.this.count;
/* 1249:     */        }
/* 1250:     */        
/* 1251:1251 */        public void clear() { Short2ShortRBTreeMap.this.clear(); }
/* 1252:     */      };
/* 1253:     */    }
...
/* 1258:     */  
/* 1259:     */  public Short2ShortSortedMap headMap(short to) {
/* 1260:1260 */    return new Submap((short)0, true, to, false);
/* 1261:     */  }
/* 1262:     */  
/* 1263:1263 */  public Short2ShortSortedMap tailMap(short from) { return new Submap(from, false, (short)0, true); }
/* 1264:     */  
/* 1265:     */  public Short2ShortSortedMap subMap(short from, short to) {
/* 1266:1266 */    return new Submap(from, false, to, false);
/* 1267:     */  }
/* 1268:     */  
/* 1272:     */  private final class Submap
/* 1273:     */    extends AbstractShort2ShortSortedMap
...
/* 1289:     */    boolean top;
/* 1290:     */    
/* 1292:     */    protected volatile transient ObjectSortedSet<Short2ShortMap.Entry> entries;
/* 1293:     */    
...
/* 1303:     */    {
/* 1304:1304 */      if ((!bottom) && (!top) && (Short2ShortRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305:1305 */      this.from = from;
/* 1306:1306 */      this.bottom = bottom;
/* 1307:1307 */      this.to = to;
/* 1308:1308 */      this.top = top;
/* 1309:1309 */      this.defRetValue = Short2ShortRBTreeMap.this.defRetValue;
/* 1310:     */    }
/* 1311:     */    
...
/* 1322:     */    {
/* 1323:1323 */      return ((this.bottom) || (Short2ShortRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Short2ShortRBTreeMap.this.compare(k, this.to) < 0));
/* 1324:     */    }
/* 1325:     */    
/* 1326:     */    public ObjectSortedSet<Short2ShortMap.Entry> short2ShortEntrySet() {
/* 1327:1327 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1328:     */          public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator() {
/* 1329:1329 */            return new Short2ShortRBTreeMap.Submap.SubmapEntryIterator(Short2ShortRBTreeMap.Submap.this);
/* 1330:     */          }
/* 1331:     */          
/* 1332:1332 */          public ObjectBidirectionalIterator<Short2ShortMap.Entry> iterator(Short2ShortMap.Entry from) { return new Short2ShortRBTreeMap.Submap.SubmapEntryIterator(Short2ShortRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue()); }
/* 1333:     */          
/* 1334:1334 */          public Comparator<? super Short2ShortMap.Entry> comparator() { return Short2ShortRBTreeMap.this.short2ShortEntrySet().comparator(); }
/* 1335:     */          
/* 1336:     */          public boolean contains(Object o) {
/* 1337:1337 */            if (!(o instanceof Map.Entry)) return false;
/* 1338:1338 */            Map.Entry<Short, Short> e = (Map.Entry)o;
/* 1339:1339 */            Short2ShortRBTreeMap.Entry f = Short2ShortRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1340:1340 */            return (f != null) && (Short2ShortRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1341:     */          }
/* 1342:     */          
/* 1343:     */          public boolean remove(Object o) {
/* 1344:1344 */            if (!(o instanceof Map.Entry)) return false;
/* 1345:1345 */            Map.Entry<Short, Short> e = (Map.Entry)o;
/* 1346:1346 */            Short2ShortRBTreeMap.Entry f = Short2ShortRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1347:1347 */            if ((f != null) && (Short2ShortRBTreeMap.Submap.this.in(f.key))) Short2ShortRBTreeMap.Submap.this.remove(f.key);
...
/* 1353:1353 */            return c; }
/* 1354:     */          
/* 1355:1355 */          public boolean isEmpty() { return !new Short2ShortRBTreeMap.Submap.SubmapIterator(Short2ShortRBTreeMap.Submap.this).hasNext(); }
/* 1356:1356 */          public void clear() { Short2ShortRBTreeMap.Submap.this.clear(); }
/* 1357:1357 */          public Short2ShortMap.Entry first() { return Short2ShortRBTreeMap.Submap.this.firstEntry(); }
/* 1358:1358 */          public Short2ShortMap.Entry last() { return Short2ShortRBTreeMap.Submap.this.lastEntry(); }
/* 1359:1359 */          public ObjectSortedSet<Short2ShortMap.Entry> subSet(Short2ShortMap.Entry from, Short2ShortMap.Entry to) { return Short2ShortRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2ShortEntrySet(); }
/* 1360:1360 */          public ObjectSortedSet<Short2ShortMap.Entry> headSet(Short2ShortMap.Entry to) { return Short2ShortRBTreeMap.Submap.this.headMap((Short)to.getKey()).short2ShortEntrySet(); }
/* 1361:1361 */          public ObjectSortedSet<Short2ShortMap.Entry> tailSet(Short2ShortMap.Entry from) { return Short2ShortRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2ShortEntrySet(); }
/* 1362:     */        };
/* 1363:1363 */      return this.entries; }
/* 1364:     */    
/* 1365:1365 */    private class KeySet extends AbstractShort2ShortSortedMap.KeySet { private KeySet() { super(); }
/* 1366:1366 */      public ShortBidirectionalIterator iterator() { return new Short2ShortRBTreeMap.Submap.SubmapKeyIterator(Short2ShortRBTreeMap.Submap.this); }
/* 1367:1367 */      public ShortBidirectionalIterator iterator(short from) { return new Short2ShortRBTreeMap.Submap.SubmapKeyIterator(Short2ShortRBTreeMap.Submap.this, from); }
/* 1368:     */    }
/* 1369:     */    
...
/* 1376:1376 */            return new Short2ShortRBTreeMap.Submap.SubmapValueIterator(Short2ShortRBTreeMap.Submap.this, null);
/* 1377:     */          }
/* 1378:     */          
/* 1379:1379 */          public boolean contains(short k) { return Short2ShortRBTreeMap.Submap.this.containsValue(k); }
/* 1380:     */          
/* 1381:     */          public int size() {
/* 1382:1382 */            return Short2ShortRBTreeMap.Submap.this.size();
/* 1383:     */          }
/* 1384:     */          
/* 1385:1385 */          public void clear() { Short2ShortRBTreeMap.Submap.this.clear(); }
/* 1386:     */        };
/* 1387:     */      }
/* 1388:1388 */      return this.values;
/* 1389:     */    }
/* 1390:     */    
/* 1392:1392 */    public boolean containsKey(short k) { return (in(k)) && (Short2ShortRBTreeMap.this.containsKey(k)); }
/* 1393:     */    
...
/* 1402:     */    }
/* 1403:     */    
/* 1404:     */    public short get(short k)
/* 1405:     */    {
/* 1406:1406 */      short kk = k;
/* 1407:1407 */      Short2ShortRBTreeMap.Entry e; return (in(kk)) && ((e = Short2ShortRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1408:     */    }
/* 1409:     */    
/* 1410:1410 */    public short put(short k, short v) { Short2ShortRBTreeMap.this.modified = false;
...
/* 1412:1412 */      short oldValue = Short2ShortRBTreeMap.this.put(k, v);
/* 1413:1413 */      return Short2ShortRBTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1414:     */    }
/* 1415:     */    
/* 1416:1416 */    public Short put(Short ok, Short ov) { short oldValue = put(ok.shortValue(), ov.shortValue());
/* 1417:1417 */      return Short2ShortRBTreeMap.this.modified ? null : Short.valueOf(oldValue);
/* 1418:     */    }
/* 1419:     */    
/* 1420:     */    public short remove(short k) {
/* 1421:1421 */      Short2ShortRBTreeMap.this.modified = false;
/* 1422:1422 */      if (!in(k)) return this.defRetValue;
/* 1423:1423 */      short oldValue = Short2ShortRBTreeMap.this.remove(k);
/* 1424:1424 */      return Short2ShortRBTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1425:     */    }
/* 1426:     */    
/* 1427:1427 */    public Short remove(Object ok) { short oldValue = remove(((Short)ok).shortValue());
/* 1428:1428 */      return Short2ShortRBTreeMap.this.modified ? Short.valueOf(oldValue) : null;
/* 1429:     */    }
/* 1430:     */    
...
/* 1441:     */    
/* 1443:1443 */    public ShortComparator comparator() { return Short2ShortRBTreeMap.this.actualComparator; }
/* 1444:     */    
/* 1445:     */    public Short2ShortSortedMap headMap(short to) {
/* 1446:1446 */      if (this.top) return new Submap(Short2ShortRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447:1447 */      return Short2ShortRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Short2ShortRBTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1448:     */    }
/* 1449:     */    
/* 1450:1450 */    public Short2ShortSortedMap tailMap(short from) { if (this.bottom) return new Submap(Short2ShortRBTreeMap.this, from, false, this.to, this.top);
/* 1451:1451 */      return Short2ShortRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2ShortRBTreeMap.this, from, false, this.to, this.top) : this;
/* 1452:     */    }
/* 1453:     */    
/* 1454:1454 */    public Short2ShortSortedMap subMap(short from, short to) { if ((this.top) && (this.bottom)) return new Submap(Short2ShortRBTreeMap.this, from, false, to, false);
/* 1455:1455 */      if (!this.top) to = Short2ShortRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456:1456 */      if (!this.bottom) from = Short2ShortRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457:1457 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458:1458 */      return new Submap(Short2ShortRBTreeMap.this, from, false, to, false);
/* 1459:     */    }
/* 1460:     */    
/* 1463:     */    public Short2ShortRBTreeMap.Entry firstEntry()
/* 1464:     */    {
/* 1465:1465 */      if (Short2ShortRBTreeMap.this.tree == null) return null;
/* 1466:     */      Short2ShortRBTreeMap.Entry e;
/* 1467:     */      Short2ShortRBTreeMap.Entry e;
/* 1468:1468 */      if (this.bottom) { e = Short2ShortRBTreeMap.this.firstEntry;
/* 1469:     */      } else {
/* 1470:1470 */        e = Short2ShortRBTreeMap.this.locateKey(this.from);
/* 1471:     */        
/* 1472:1472 */        if (Short2ShortRBTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1473:     */        }
/* 1474:     */      }
/* 1475:1475 */      if ((e == null) || ((!this.top) && (Short2ShortRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476:1476 */      return e;
/* 1477:     */    }
/* 1478:     */    
/* 1481:     */    public Short2ShortRBTreeMap.Entry lastEntry()
/* 1482:     */    {
/* 1483:1483 */      if (Short2ShortRBTreeMap.this.tree == null) return null;
/* 1484:     */      Short2ShortRBTreeMap.Entry e;
/* 1485:     */      Short2ShortRBTreeMap.Entry e;
/* 1486:1486 */      if (this.top) { e = Short2ShortRBTreeMap.this.lastEntry;
/* 1487:     */      } else {
/* 1488:1488 */        e = Short2ShortRBTreeMap.this.locateKey(this.to);
/* 1489:     */        
/* 1490:1490 */        if (Short2ShortRBTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1491:     */        }
/* 1492:     */      }
/* 1493:1493 */      if ((e == null) || ((!this.bottom) && (Short2ShortRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494:1494 */      return e;
/* 1495:     */    }
/* 1496:     */    
/* 1497:1497 */    public short firstShortKey() { Short2ShortRBTreeMap.Entry e = firstEntry();
/* 1498:1498 */      if (e == null) throw new NoSuchElementException();
/* 1499:1499 */      return e.key;
/* 1500:     */    }
/* 1501:     */    
/* 1502:1502 */    public short lastShortKey() { Short2ShortRBTreeMap.Entry e = lastEntry();
/* 1503:1503 */      if (e == null) throw new NoSuchElementException();
/* 1504:1504 */      return e.key;
/* 1505:     */    }
/* 1506:     */    
/* 1507:1507 */    public Short firstKey() { Short2ShortRBTreeMap.Entry e = firstEntry();
/* 1508:1508 */      if (e == null) throw new NoSuchElementException();
/* 1509:1509 */      return e.getKey();
/* 1510:     */    }
/* 1511:     */    
/* 1512:1512 */    public Short lastKey() { Short2ShortRBTreeMap.Entry e = lastEntry();
/* 1513:1513 */      if (e == null) throw new NoSuchElementException();
/* 1514:1514 */      return e.getKey();
/* 1515:     */    }
/* 1516:     */    
/* 1519:     */    private class SubmapIterator
/* 1520:     */      extends Short2ShortRBTreeMap.TreeIterator
/* 1521:     */    {
/* 1522:     */      SubmapIterator()
/* 1523:     */      {
/* 1524:1524 */        super();
/* 1525:1525 */        this.next = Short2ShortRBTreeMap.Submap.this.firstEntry();
/* 1526:     */      }
/* 1527:     */      
/* 1528:1528 */      SubmapIterator(short k) { this();
/* 1529:1529 */        if (this.next != null)
/* 1530:1530 */          if ((!Short2ShortRBTreeMap.Submap.this.bottom) && (Short2ShortRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531:1531 */          } else if ((!Short2ShortRBTreeMap.Submap.this.top) && (Short2ShortRBTreeMap.this.compare(k, (this.prev = Short2ShortRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1532:     */          } else {
/* 1533:1533 */            this.next = Short2ShortRBTreeMap.this.locateKey(k);
/* 1534:1534 */            if (Short2ShortRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544:1544 */        if ((!Short2ShortRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2ShortRBTreeMap.this.compare(this.prev.key, Short2ShortRBTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1545:     */      }
/* 1546:     */      
/* 1547:1547 */      void updateNext() { this.next = this.next.next();
/* 1548:1548 */        if ((!Short2ShortRBTreeMap.Submap.this.top) && (this.next != null) && (Short2ShortRBTreeMap.this.compare(this.next.key, Short2ShortRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1549:     */      }
/* 1550:     */    }
/* 1551:     */    
/* 1552:1552 */    private class SubmapEntryIterator extends Short2ShortRBTreeMap.Submap.SubmapIterator implements ObjectListIterator<Short2ShortMap.Entry> { SubmapEntryIterator() { super(); }
/* 1553:     */      
/* 1554:1554 */      SubmapEntryIterator(short k) { super(k); }
/* 1555:     */      
/* 1556:1556 */      public Short2ShortMap.Entry next() { return nextEntry(); }
/* 1557:1557 */      public Short2ShortMap.Entry previous() { return previousEntry(); }
/* 1558:1558 */      public void set(Short2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1559:1559 */      public void add(Short2ShortMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1560:     */    }
/* 1561:     */    
/* 1566:     */    private final class SubmapKeyIterator
/* 1567:     */      extends Short2ShortRBTreeMap.Submap.SubmapIterator
...
/* 1586:     */      extends Short2ShortRBTreeMap.Submap.SubmapIterator
...
/* 1599:     */  }
/* 1600:     */  
/* 1604:     */  public Short2ShortRBTreeMap clone()
/* 1605:     */  {
/* 1606:     */    Short2ShortRBTreeMap c;
/* 1607:     */    
/* 1609:     */    try
/* 1610:     */    {
/* 1611:1611 */      c = (Short2ShortRBTreeMap)super.clone();
/* 1612:     */    }
...
/* 1682:     */  {
/* 1683:1683 */    if (n == 1) {
/* 1684:1684 */      Entry top = new Entry(s.readShort(), s.readShort());
...
/* 1690:1690 */    if (n == 2)
/* 1691:     */    {
/* 1693:1693 */      Entry top = new Entry(s.readShort(), s.readShort());
/* 1694:1694 */      top.black(true);
/* 1695:1695 */      top.right(new Entry(s.readShort(), s.readShort()));
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.shorts.Short2ShortRBTreeMap
