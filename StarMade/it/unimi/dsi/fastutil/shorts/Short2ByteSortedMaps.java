...
/*     */   {
/* 173 */     return new Singleton(key.shortValue(), value.byteValue());
/*     */   }
/*     */ 
/*     */   public static Short2ByteSortedMap singleton(Short key, Byte value, ShortComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.shortValue(), value.byteValue(), comparator);
/*     */   }
/*     */ 
/*     */   public static Short2ByteSortedMap singleton(short key, byte value)
/*     */   {
...
/*     */     }
/* 302 */     public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.short2ByteEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Byte>> entrySet() {
/* 304 */       return short2ByteEntrySet(); } 
...
/* 308 */     public Short2ByteSortedMap headMap(short to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Short2ByteSortedMap tailMap(short from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Short2ByteSortedMap headMap(Short to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Short2ByteSortedMap tailMap(Short from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.short2ByteEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Byte>> entrySet() {
/* 244 */       return short2ByteEntrySet(); } 
...
/* 248 */     public Short2ByteSortedMap headMap(short to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Short2ByteSortedMap tailMap(short from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public short firstShortKey() {
...
/* 259 */     public Short2ByteSortedMap headMap(Short to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Short2ByteSortedMap tailMap(Short from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Short2ByteMaps.Singleton.SingletonEntry(this), Short2ByteSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Short, Byte>> entrySet() { return short2ByteEntrySet(); } 
/*     */     public ShortSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = ShortSortedSets.singleton(this.key, this.comparator); return (ShortSortedSet)this.keys;
/*     */     }
/*     */     public Short2ByteSortedMap subMap(short from, short to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Short2ByteSortedMap headMap(short to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Short2ByteSortedMap tailMap(short from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Short2ByteSortedMap tailMap(Short ofrom) { return tailMap(ofrom.shortValue()); } 
/* 156 */     public Short2ByteSortedMap subMap(Short ofrom, Short oto) { return subMap(ofrom.shortValue(), oto.shortValue()); } 
/*     */     public Short firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Short2ByteMap.Entry> short2ByteEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Byte>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public ShortSortedSet keySet() { return ShortSortedSets.EMPTY_SET; } 
/*     */     public Short2ByteSortedMap subMap(short from, short to) {
/*  86 */       return Short2ByteSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Short2ByteSortedMap headMap(short to) { return Short2ByteSortedMaps.EMPTY_MAP; } 
/*     */     public Short2ByteSortedMap tailMap(short from) {
/*  90 */       return Short2ByteSortedMaps.EMPTY_MAP; } 
...
/*  93 */     public Short2ByteSortedMap headMap(Short oto) { return headMap(oto.shortValue()); } 
/*  94 */     public Short2ByteSortedMap tailMap(Short ofrom) { return tailMap(ofrom.shortValue()); } 
/*  95 */     public Short2ByteSortedMap subMap(Short ofrom, Short oto) { return subMap(ofrom.shortValue(), oto.shortValue()); } 
