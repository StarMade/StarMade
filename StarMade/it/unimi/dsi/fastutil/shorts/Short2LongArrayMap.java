...
/*     */ 
/*     */ public class Short2LongArrayMap extends AbstractShort2LongMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Short2LongArrayMap)super.clone();
/*     */     }
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Short2LongArrayMap.this.size; }
/*     */ 
/*     */         public Short2LongMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractShort2LongMap.BasicEntry(Short2LongArrayMap.this.key[this.next], Short2LongArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractShort2LongMap.BasicEntry entry = new AbstractShort2LongMap.BasicEntry((short)0, 0L);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Short2LongArrayMap.this.size; }
/*     */ 
/*     */         public Short2LongMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Short2LongArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Short2LongArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Short2LongArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Short2LongArrayMap.this.containsKey(k)) && (Short2LongArrayMap.this.get(k) == ((Long)e.getValue()).longValue());
/*     */     }
/*     */   }
/*     */ }
