...
/*     */   public static Short2LongMap singleton(Short key, Long value)
/*     */   {
/* 200 */     return new Singleton(key.shortValue(), value.longValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Short2LongMap.Entry> short2LongEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.short2LongEntrySet()); return this.entries; } 
...
/* 335 */     public long get(short k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Short, Long>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Short, ? extends Long> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.short2LongEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public long get(short k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Short, Long>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Short2LongMap.Entry> short2LongEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/*     */       public Short getKey()
/*     */       {
/* 131 */         return Short.valueOf(Short2LongMaps.Singleton.this.key); } 
/* 132 */       public Long getValue() { return Long.valueOf(Short2LongMaps.Singleton.this.value); }
/*     */ 
/*     */       public short getShortKey() {
/* 135 */         return Short2LongMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public long getLongValue() {
/* 139 */         return Short2LongMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Short2LongMaps.Singleton.this.key == ((Short)e.getKey()).shortValue()) && (Short2LongMaps.Singleton.this.value == ((Long)e.getValue()).longValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return Short2LongMaps.Singleton.this.key ^ HashCommon.long2int(Short2LongMaps.Singleton.this.value); } 
/* 153 */       public String toString() { return Short2LongMaps.Singleton.this.key + "->" + Short2LongMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Short, ? extends Long> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Short2LongMap.Entry> short2LongEntrySet() {
...
/*  76 */     private Object readResolve() { return Short2LongMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Short2LongMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Short, Long>> entrySet() {
/*  80 */       return short2LongEntrySet();
/*     */     }
