...
public class Short2CharMaps
{
  ...
  public static Short2CharMap synchronize(Short2CharMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Short2CharMap synchronize(Short2CharMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Short2CharMap unmodifiable(Short2CharMap local_m)
  {
    ...
    implements Short2CharMap, Serializable
  {
    ...
    protected UnmodifiableMap(Short2CharMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Short2CharMap, Serializable
  {
    ...
    protected SynchronizedMap(Short2CharMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Short2CharMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Short2CharMap, Serializable, Cloneable
  {
      ...
      implements Short2CharMap.Entry, Map.Entry<Short, Character>
    {
      ...
      public Short getKey()
      {
        return Short.valueOf(Short2CharMaps.Singleton.this.key);
      }
      
      public Character getValue()
      {
        return Character.valueOf(Short2CharMaps.Singleton.this.value);
      }
      
      public short getShortKey()
      {
        return Short2CharMaps.Singleton.this.key;
      }
      
      public char getCharValue()
      {
        return Short2CharMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Short2CharMaps.Singleton.this.key == ((Short)local_e.getKey()).shortValue()) && (Short2CharMaps.Singleton.this.value == ((Character)local_e.getValue()).charValue());
      }
      
      public int hashCode()
      {
        return Short2CharMaps.Singleton.this.key ^ Short2CharMaps.Singleton.this.value;
      }
