...
/*   22:     */
/*  113:     */public class Short2BooleanLinkedOpenHashMap
/*  114:     */  extends AbstractShort2BooleanSortedMap
...
/*  127:     */  protected volatile transient Short2BooleanSortedMap.FastSortedEntrySet entries;
...
/*  141:     */  
/*  149:     */  public Short2BooleanLinkedOpenHashMap(int expected, float f)
/*  150:     */  {
...
/*  161:     */  }
/*  162:     */  
/*  165:     */  public Short2BooleanLinkedOpenHashMap(int expected)
/*  166:     */  {
/*  167: 167 */    this(expected, 0.75F);
/*  168:     */  }
/*  169:     */  
/*  171:     */  public Short2BooleanLinkedOpenHashMap()
/*  172:     */  {
/*  173: 173 */    this(16, 0.75F);
/*  174:     */  }
/*  175:     */  
/*  179:     */  public Short2BooleanLinkedOpenHashMap(Map<? extends Short, ? extends Boolean> m, float f)
/*  180:     */  {
/*  181: 181 */    this(m.size(), f);
/*  182: 182 */    putAll(m);
/*  183:     */  }
/*  184:     */  
/*  187:     */  public Short2BooleanLinkedOpenHashMap(Map<? extends Short, ? extends Boolean> m)
/*  188:     */  {
/*  189: 189 */    this(m, 0.75F);
/*  190:     */  }
/*  191:     */  
/*  195:     */  public Short2BooleanLinkedOpenHashMap(Short2BooleanMap m, float f)
/*  196:     */  {
/*  197: 197 */    this(m.size(), f);
/*  198: 198 */    putAll(m);
/*  199:     */  }
/*  200:     */  
/*  203:     */  public Short2BooleanLinkedOpenHashMap(Short2BooleanMap m)
/*  204:     */  {
/*  205: 205 */    this(m, 0.75F);
/*  206:     */  }
/*  207:     */  
/*  213:     */  public Short2BooleanLinkedOpenHashMap(short[] k, boolean[] v, float f)
/*  214:     */  {
...
/*  219:     */  }
/*  220:     */  
/*  224:     */  public Short2BooleanLinkedOpenHashMap(short[] k, boolean[] v)
/*  225:     */  {
/*  226: 226 */    this(k, v, 0.75F);
/*  227:     */  }
/*  228:     */  
/*  232:     */  public boolean put(short k, boolean v)
/*  233:     */  {
...
/*  260:     */  }
/*  261:     */  
/*  262: 262 */  public Boolean put(Short ok, Boolean ov) { boolean v = ov.booleanValue();
...
/*  315:     */  }
/*  316:     */  
/*  317:     */  public boolean remove(short k)
/*  318:     */  {
...
/*  422:     */  }
/*  423:     */  
/*  427:     */  public boolean getAndMoveToFirst(short k)
/*  428:     */  {
...
/*  443:     */  }
/*  444:     */  
/*  448:     */  public boolean getAndMoveToLast(short k)
/*  449:     */  {
...
/*  464:     */  }
/*  465:     */  
/*  470:     */  public boolean putAndMoveToFirst(short k, boolean v)
/*  471:     */  {
...
/*  503:     */  }
/*  504:     */  
/*  509:     */  public boolean putAndMoveToLast(short k, boolean v)
/*  510:     */  {
...
/*  542:     */  }
/*  543:     */  
/*  544: 544 */  public Boolean get(Short ok) { short k = ok.shortValue();
/*  545:     */    
...
/*  553:     */  }
/*  554:     */  
/*  555:     */  public boolean get(short k)
/*  556:     */  {
...
/*  620:     */    implements Short2BooleanMap.Entry, Map.Entry<Short, Boolean>
/*  621:     */  {
...
/*  627:     */    }
/*  628:     */    
/*  629: 629 */    public Short getKey() { return Short.valueOf(Short2BooleanLinkedOpenHashMap.this.key[this.index]); }
/*  630:     */    
/*  631:     */    public short getShortKey() {
/*  632: 632 */      return Short2BooleanLinkedOpenHashMap.this.key[this.index];
/*  633:     */    }
/*  634:     */    
/*  635: 635 */    public Boolean getValue() { return Boolean.valueOf(Short2BooleanLinkedOpenHashMap.this.value[this.index]); }
/*  636:     */    
/*  638: 638 */    public boolean getBooleanValue() { return Short2BooleanLinkedOpenHashMap.this.value[this.index]; }
/*  639:     */    
/*  640:     */    public boolean setValue(boolean v) {
/*  641: 641 */      boolean oldValue = Short2BooleanLinkedOpenHashMap.this.value[this.index];
/*  642: 642 */      Short2BooleanLinkedOpenHashMap.this.value[this.index] = v;
...
/*  651: 651 */      Map.Entry<Short, Boolean> e = (Map.Entry)o;
/*  652: 652 */      return (Short2BooleanLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*  653:     */    }
/*  654:     */    
/*  655: 655 */    public int hashCode() { return Short2BooleanLinkedOpenHashMap.this.key[this.index] ^ (Short2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237); }
/*  656:     */    
/*  657:     */    public String toString() {
/*  658: 658 */      return Short2BooleanLinkedOpenHashMap.this.key[this.index] + "=>" + Short2BooleanLinkedOpenHashMap.this.value[this.index];
/*  659:     */    }
/*  660:     */  }
/*  661:     */  
...
/*  746: 746 */  public Short2BooleanSortedMap tailMap(short from) { throw new UnsupportedOperationException(); }
/*  747: 747 */  public Short2BooleanSortedMap headMap(short to) { throw new UnsupportedOperationException(); }
/*  748: 748 */  public Short2BooleanSortedMap subMap(short from, short to) { throw new UnsupportedOperationException(); }
/*  749:     */  
...
/*  763: 763 */    int index = -1;
/*  764:     */    
/*  765: 765 */    private MapIterator() { this.next = Short2BooleanLinkedOpenHashMap.this.first;
/*  766: 766 */      this.index = 0;
/*  767:     */    }
/*  768:     */    
/*  769: 769 */    private MapIterator(short from) { if (Short2BooleanLinkedOpenHashMap.this.key[Short2BooleanLinkedOpenHashMap.this.last] == from) {
/*  770: 770 */        this.prev = Short2BooleanLinkedOpenHashMap.this.last;
/*  771: 771 */        this.index = Short2BooleanLinkedOpenHashMap.this.size;
/*  772:     */      }
/*  773:     */      else
/*  774:     */      {
/*  775: 775 */        int pos = HashCommon.murmurHash3(from) & Short2BooleanLinkedOpenHashMap.this.mask;
/*  776:     */        
/*  777: 777 */        while (Short2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  778: 778 */          if (Short2BooleanLinkedOpenHashMap.this.key[pos] == from)
/*  779:     */          {
/*  780: 780 */            this.next = ((int)Short2BooleanLinkedOpenHashMap.this.link[pos]);
/*  781: 781 */            this.prev = pos;
/*  782: 782 */            return;
/*  783:     */          }
/*  784: 784 */          pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*  785:     */        }
...
/*  798: 798 */        this.index = Short2BooleanLinkedOpenHashMap.this.size;
/*  799: 799 */        return;
/*  800:     */      }
/*  801: 801 */      int pos = Short2BooleanLinkedOpenHashMap.this.first;
/*  802: 802 */      this.index = 1;
/*  803: 803 */      while (pos != this.prev) {
/*  804: 804 */        pos = (int)Short2BooleanLinkedOpenHashMap.this.link[pos];
...
/*  815:     */    }
/*  816:     */    
/*  817: 817 */    public int nextEntry() { if (!hasNext()) return Short2BooleanLinkedOpenHashMap.this.size();
/*  818: 818 */      this.curr = this.next;
/*  819: 819 */      this.next = ((int)Short2BooleanLinkedOpenHashMap.this.link[this.curr]);
...
/*  827: 827 */      this.prev = ((int)(Short2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*  840: 840 */        this.prev = ((int)(Short2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*  841:     */      }
/*  842:     */      else {
/*  843: 843 */        this.next = ((int)Short2BooleanLinkedOpenHashMap.this.link[this.curr]); }
/*  844: 844 */      Short2BooleanLinkedOpenHashMap.this.size -= 1;
/*  845:     */      
/*  847: 847 */      if (this.prev == -1) { Short2BooleanLinkedOpenHashMap.this.first = this.next;
/*  848:     */      } else
/*  849: 849 */        Short2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Short2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  850: 850 */      if (this.next == -1) { Short2BooleanLinkedOpenHashMap.this.last = this.prev;
/*  851:     */      } else
/*  852: 852 */        Short2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Short2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
/*  853: 853 */      int pos = this.curr;
/*  854:     */      int last;
/*  855:     */      for (;;) {
/*  856: 856 */        pos = (last = pos) + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*  857: 857 */        while (Short2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  858: 858 */          int slot = HashCommon.murmurHash3(Short2BooleanLinkedOpenHashMap.this.key[pos]) & Short2BooleanLinkedOpenHashMap.this.mask;
/*  859: 859 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  860: 860 */          pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*  861:     */        }
/*  862: 862 */        if (Short2BooleanLinkedOpenHashMap.this.used[pos] == 0) break;
/*  863: 863 */        Short2BooleanLinkedOpenHashMap.this.key[last] = Short2BooleanLinkedOpenHashMap.this.key[pos];
/*  864: 864 */        Short2BooleanLinkedOpenHashMap.this.value[last] = Short2BooleanLinkedOpenHashMap.this.value[pos];
/*  865: 865 */        if (this.next == pos) this.next = last;
/*  866: 866 */        if (this.prev == pos) this.prev = last;
/*  867: 867 */        Short2BooleanLinkedOpenHashMap.this.fixPointers(pos, last);
/*  868:     */      }
/*  869: 869 */      Short2BooleanLinkedOpenHashMap.this.used[last] = false;
/*  870: 870 */      this.curr = -1;
/*  871:     */    }
/*  872:     */    
...
/*  881:     */    } }
/*  882:     */  
/*  883:     */  private class EntryIterator extends Short2BooleanLinkedOpenHashMap.MapIterator implements ObjectListIterator<Short2BooleanMap.Entry> { private Short2BooleanLinkedOpenHashMap.MapEntry entry;
/*  884:     */    
/*  885: 885 */    public EntryIterator() { super(null); }
/*  886:     */    
/*  887: 887 */    public EntryIterator(short from) { super(from, null); }
/*  888:     */    
/*  889:     */    public Short2BooleanLinkedOpenHashMap.MapEntry next() {
/*  890: 890 */      return this.entry = new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this, nextEntry());
/*  891:     */    }
/*  892:     */    
/*  893: 893 */    public Short2BooleanLinkedOpenHashMap.MapEntry previous() { return this.entry = new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this, previousEntry()); }
/*  894:     */    
/*  895:     */    public void remove()
/*  896:     */    {
/*  897: 897 */      super.remove();
/*  898: 898 */      Short2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1); }
/*  899:     */    
/*  900: 900 */    public void set(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  901: 901 */    public void add(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  902:     */  }
/*  903:     */  
/*  904: 904 */  private class FastEntryIterator extends Short2BooleanLinkedOpenHashMap.MapIterator implements ObjectListIterator<Short2BooleanMap.Entry> { final AbstractShort2BooleanMap.BasicEntry entry = new AbstractShort2BooleanMap.BasicEntry((short)0, false);
/*  905: 905 */    public FastEntryIterator() { super(null); }
/*  906:     */    
/*  907: 907 */    public FastEntryIterator(short from) { super(from, null); }
/*  908:     */    
/*  909:     */    public AbstractShort2BooleanMap.BasicEntry next() {
/*  910: 910 */      int e = nextEntry();
/*  911: 911 */      this.entry.key = Short2BooleanLinkedOpenHashMap.this.key[e];
/*  912: 912 */      this.entry.value = Short2BooleanLinkedOpenHashMap.this.value[e];
/*  913: 913 */      return this.entry;
/*  914:     */    }
/*  915:     */    
/*  916: 916 */    public AbstractShort2BooleanMap.BasicEntry previous() { int e = previousEntry();
/*  917: 917 */      this.entry.key = Short2BooleanLinkedOpenHashMap.this.key[e];
/*  918: 918 */      this.entry.value = Short2BooleanLinkedOpenHashMap.this.value[e];
/*  919: 919 */      return this.entry; }
/*  920:     */    
/*  921: 921 */    public void set(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*  922: 922 */    public void add(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } }
/*  923:     */  
/*  924:     */  private final class MapEntrySet extends AbstractObjectSortedSet<Short2BooleanMap.Entry> implements Short2BooleanSortedMap.FastSortedEntrySet { private MapEntrySet() {}
/*  925:     */    
/*  926: 926 */    public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator() { return new Short2BooleanLinkedOpenHashMap.EntryIterator(Short2BooleanLinkedOpenHashMap.this); }
/*  927:     */    
/*  928: 928 */    public Comparator<? super Short2BooleanMap.Entry> comparator() { return null; }
/*  929: 929 */    public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry fromElement, Short2BooleanMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  930: 930 */    public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry toElement) { throw new UnsupportedOperationException(); }
/*  931: 931 */    public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry fromElement) { throw new UnsupportedOperationException(); }
/*  932:     */    
/*  933: 933 */    public Short2BooleanMap.Entry first() { if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  934: 934 */      return new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this, Short2BooleanLinkedOpenHashMap.this.first);
/*  935:     */    }
/*  936:     */    
/*  937: 937 */    public Short2BooleanMap.Entry last() { if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  938: 938 */      return new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this, Short2BooleanLinkedOpenHashMap.this.last);
/*  939:     */    }
/*  940:     */    
/*  941:     */    public boolean contains(Object o) {
/*  942: 942 */      if (!(o instanceof Map.Entry)) return false;
/*  943: 943 */      Map.Entry<Short, Boolean> e = (Map.Entry)o;
/*  944: 944 */      short k = ((Short)e.getKey()).shortValue();
/*  945:     */      
/*  946: 946 */      int pos = HashCommon.murmurHash3(k) & Short2BooleanLinkedOpenHashMap.this.mask;
/*  947:     */      
/*  948: 948 */      while (Short2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  949: 949 */        if (Short2BooleanLinkedOpenHashMap.this.key[pos] == k) return Short2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/*  950: 950 */        pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*  951:     */      }
...
/*  957: 957 */      Map.Entry<Short, Boolean> e = (Map.Entry)o;
/*  958: 958 */      short k = ((Short)e.getKey()).shortValue();
/*  959:     */      
/*  960: 960 */      int pos = HashCommon.murmurHash3(k) & Short2BooleanLinkedOpenHashMap.this.mask;
/*  961:     */      
/*  962: 962 */      while (Short2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  963: 963 */        if (Short2BooleanLinkedOpenHashMap.this.key[pos] == k) {
/*  964: 964 */          Short2BooleanLinkedOpenHashMap.this.remove(e.getKey());
/*  965: 965 */          return true;
/*  966:     */        }
/*  967: 967 */        pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*  968:     */      }
/*  969: 969 */      return false;
/*  970:     */    }
/*  971:     */    
/*  972: 972 */    public int size() { return Short2BooleanLinkedOpenHashMap.this.size; }
/*  973:     */    
/*  974:     */    public void clear() {
/*  975: 975 */      Short2BooleanLinkedOpenHashMap.this.clear();
/*  976:     */    }
/*  977:     */    
/*  978: 978 */    public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from) { return new Short2BooleanLinkedOpenHashMap.EntryIterator(Short2BooleanLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue()); }
/*  979:     */    
/*  980:     */    public ObjectBidirectionalIterator<Short2BooleanMap.Entry> fastIterator() {
/*  981: 981 */      return new Short2BooleanLinkedOpenHashMap.FastEntryIterator(Short2BooleanLinkedOpenHashMap.this);
/*  982:     */    }
/*  983:     */    
/*  984: 984 */    public ObjectBidirectionalIterator<Short2BooleanMap.Entry> fastIterator(Short2BooleanMap.Entry from) { return new Short2BooleanLinkedOpenHashMap.FastEntryIterator(Short2BooleanLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue()); }
/*  985:     */  }
/*  986:     */  
/*  987:     */  public Short2BooleanSortedMap.FastSortedEntrySet short2BooleanEntrySet() {
...
/*  995:     */    extends Short2BooleanLinkedOpenHashMap.MapIterator
/*  996:     */    implements ShortListIterator
/*  997:     */  {
/*  998: 998 */    public KeyIterator(short k) { super(k, null); }
/*  999: 999 */    public short previousShort() { return Short2BooleanLinkedOpenHashMap.this.key[previousEntry()]; }
...
/* 1002:1002 */    public Short previous() { return Short.valueOf(Short2BooleanLinkedOpenHashMap.this.key[previousEntry()]); }
...
/* 1006:1006 */    public short nextShort() { return Short2BooleanLinkedOpenHashMap.this.key[nextEntry()]; }
/* 1007:1007 */    public Short next() { return Short.valueOf(Short2BooleanLinkedOpenHashMap.this.key[nextEntry()]); } }
/* 1008:     */  
/* 1009:     */  private final class KeySet extends AbstractShortSortedSet { private KeySet() {}
/* 1010:     */    
/* 1011:1011 */    public ShortListIterator iterator(short from) { return new Short2BooleanLinkedOpenHashMap.KeyIterator(Short2BooleanLinkedOpenHashMap.this, from); }
/* 1012:     */    
/* 1013:     */    public ShortListIterator iterator() {
/* 1014:1014 */      return new Short2BooleanLinkedOpenHashMap.KeyIterator(Short2BooleanLinkedOpenHashMap.this);
/* 1015:     */    }
/* 1016:     */    
/* 1017:1017 */    public int size() { return Short2BooleanLinkedOpenHashMap.this.size; }
/* 1018:     */    
/* 1020:1020 */    public boolean contains(short k) { return Short2BooleanLinkedOpenHashMap.this.containsKey(k); }
/* 1021:     */    
/* 1022:     */    public boolean remove(short k) {
/* 1023:1023 */      int oldSize = Short2BooleanLinkedOpenHashMap.this.size;
/* 1024:1024 */      Short2BooleanLinkedOpenHashMap.this.remove(k);
/* 1025:1025 */      return Short2BooleanLinkedOpenHashMap.this.size != oldSize;
/* 1026:     */    }
/* 1027:     */    
/* 1028:1028 */    public void clear() { Short2BooleanLinkedOpenHashMap.this.clear(); }
/* 1029:     */    
/* 1030:     */    public short firstShort() {
/* 1031:1031 */      if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1032:1032 */      return Short2BooleanLinkedOpenHashMap.this.key[Short2BooleanLinkedOpenHashMap.this.first];
/* 1033:     */    }
/* 1034:     */    
/* 1035:1035 */    public short lastShort() { if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1036:1036 */      return Short2BooleanLinkedOpenHashMap.this.key[Short2BooleanLinkedOpenHashMap.this.last]; }
/* 1037:     */    
...
/* 1051:     */    extends Short2BooleanLinkedOpenHashMap.MapIterator
/* 1052:     */    implements BooleanListIterator
/* 1053:     */  {
/* 1054:1054 */    public boolean previousBoolean() { return Short2BooleanLinkedOpenHashMap.this.value[previousEntry()]; }
/* 1055:1055 */    public Boolean previous() { return Boolean.valueOf(Short2BooleanLinkedOpenHashMap.this.value[previousEntry()]); }
...
/* 1061:1061 */    public boolean nextBoolean() { return Short2BooleanLinkedOpenHashMap.this.value[nextEntry()]; }
/* 1062:1062 */    public Boolean next() { return Boolean.valueOf(Short2BooleanLinkedOpenHashMap.this.value[nextEntry()]); }
/* 1063:     */  }
/* 1064:     */  
...
/* 1067:1067 */          return new Short2BooleanLinkedOpenHashMap.ValueIterator(Short2BooleanLinkedOpenHashMap.this);
/* 1068:     */        }
/* 1069:     */        
/* 1070:1070 */        public int size() { return Short2BooleanLinkedOpenHashMap.this.size; }
/* 1071:     */        
/* 1072:     */        public boolean contains(boolean v) {
/* 1073:1073 */          return Short2BooleanLinkedOpenHashMap.this.containsValue(v);
/* 1074:     */        }
/* 1075:     */        
/* 1076:1076 */        public void clear() { Short2BooleanLinkedOpenHashMap.this.clear(); }
/* 1077:     */      };
/* 1078:     */    }
...
/* 1198:     */  }
/* 1199:     */  
/* 1202:     */  public Short2BooleanLinkedOpenHashMap clone()
/* 1203:     */  {
/* 1204:     */    Short2BooleanLinkedOpenHashMap c;
/* 1205:     */    
/* 1207:     */    try
/* 1208:     */    {
/* 1209:1209 */      c = (Short2BooleanLinkedOpenHashMap)super.clone();
/* 1210:     */    }
