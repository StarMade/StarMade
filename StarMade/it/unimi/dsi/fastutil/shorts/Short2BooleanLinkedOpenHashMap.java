...
/*  335 */     short k = ((Short)ok).shortValue();
/*      */ 
...
/*      */   }
/*  745 */   public ShortComparator comparator() { return null; } 
/*  746 */   public Short2BooleanSortedMap tailMap(short from) { throw new UnsupportedOperationException(); } 
/*  747 */   public Short2BooleanSortedMap headMap(short to) { throw new UnsupportedOperationException(); } 
/*  748 */   public Short2BooleanSortedMap subMap(short from, short to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1067 */           return new Short2BooleanLinkedOpenHashMap.ValueIterator(Short2BooleanLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1070 */           return Short2BooleanLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(boolean v) {
/* 1073 */           return Short2BooleanLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1076 */           Short2BooleanLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */ 
/* 1156 */     short[] key = this.key;
/* 1157 */     boolean[] value = this.value;
/* 1158 */     int newMask = newN - 1;
/* 1159 */     short[] newKey = new short[newN];
...
/*      */     try
/*      */     {
/* 1209 */       c = (Short2BooleanLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1215 */     c.values = null;
/* 1216 */     c.entries = null;
/* 1217 */     c.key = ((short[])this.key.clone());
...
/* 1260 */     short[] key = this.key = new short[this.n];
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2BooleanLinkedOpenHashMap.MapIterator
/*      */     implements BooleanListIterator
/*      */   {
/*      */     public boolean previousBoolean()
/*      */     {
/* 1054 */       return Short2BooleanLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1055 */     public Boolean previous() { return Boolean.valueOf(Short2BooleanLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1061 */     public boolean nextBoolean() { return Short2BooleanLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1062 */     public Boolean next() { return Boolean.valueOf(Short2BooleanLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1011 */       return new Short2BooleanLinkedOpenHashMap.KeyIterator(Short2BooleanLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ShortListIterator iterator() {
/* 1014 */       return new Short2BooleanLinkedOpenHashMap.KeyIterator(Short2BooleanLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1017 */       return Short2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(short k) {
/* 1020 */       return Short2BooleanLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(short k) {
/* 1023 */       int oldSize = Short2BooleanLinkedOpenHashMap.this.size;
/* 1024 */       Short2BooleanLinkedOpenHashMap.this.remove(k);
/* 1025 */       return Short2BooleanLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1028 */       Short2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public short firstShort() {
/* 1031 */       if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1032 */       return Short2BooleanLinkedOpenHashMap.this.key[Short2BooleanLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public short lastShort() {
/* 1035 */       if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1036 */       return Short2BooleanLinkedOpenHashMap.this.key[Short2BooleanLinkedOpenHashMap.this.last];
/*      */     }
/* 1038 */     public ShortComparator comparator() { return null; } 
/* 1039 */     public final ShortSortedSet tailSet(short from) { throw new UnsupportedOperationException(); } 
/* 1040 */     public final ShortSortedSet headSet(short to) { throw new UnsupportedOperationException(); } 
/* 1041 */     public final ShortSortedSet subSet(short from, short to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2BooleanLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator(short k)
/*      */     {
/*  998 */       super(k, null); } 
/*  999 */     public short previousShort() { return Short2BooleanLinkedOpenHashMap.this.key[previousEntry()]; } 
/* 1000 */     public void set(short k) { throw new UnsupportedOperationException(); } 
/* 1001 */     public void add(short k) { throw new UnsupportedOperationException(); } 
/* 1002 */     public Short previous() { return Short.valueOf(Short2BooleanLinkedOpenHashMap.this.key[previousEntry()]); } 
/* 1003 */     public void set(Short ok) { throw new UnsupportedOperationException(); } 
/* 1004 */     public void add(Short ok) { throw new UnsupportedOperationException(); } 
/* 1005 */     public KeyIterator() { super(null); } 
/* 1006 */     public short nextShort() { return Short2BooleanLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1007 */     public Short next() { return Short.valueOf(Short2BooleanLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  926 */       return new Short2BooleanLinkedOpenHashMap.EntryIterator(Short2BooleanLinkedOpenHashMap.this);
/*      */     }
/*  928 */     public Comparator<? super Short2BooleanMap.Entry> comparator() { return null; } 
/*  929 */     public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry fromElement, Short2BooleanMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  930 */     public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  931 */     public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Short2BooleanMap.Entry first() {
/*  933 */       if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  934 */       return new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this, Short2BooleanLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Short2BooleanMap.Entry last() {
/*  937 */       if (Short2BooleanLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  938 */       return new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this, Short2BooleanLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     public boolean contains(Object o) {
/*  942 */       if (!(o instanceof Map.Entry)) return false;
/*  943 */       Map.Entry e = (Map.Entry)o;
/*  944 */       short k = ((Short)e.getKey()).shortValue();
/*      */ 
/*  946 */       int pos = HashCommon.murmurHash3(k) & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */ 
/*  948 */       while (Short2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  949 */         if (Short2BooleanLinkedOpenHashMap.this.key[pos] == k) return Short2BooleanLinkedOpenHashMap.this.value[pos] == ((Boolean)e.getValue()).booleanValue();
/*  950 */         pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */       }
/*  952 */       return false;
/*      */     }
/*      */ 
...
/*  958 */       short k = ((Short)e.getKey()).shortValue();
/*      */ 
/*  960 */       int pos = HashCommon.murmurHash3(k) & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */ 
/*  962 */       while (Short2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  963 */         if (Short2BooleanLinkedOpenHashMap.this.key[pos] == k) {
/*  964 */           Short2BooleanLinkedOpenHashMap.this.remove(e.getKey());
/*  965 */           return true;
/*      */         }
/*  967 */         pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */       }
/*  969 */       return false;
/*      */     }
/*      */     public int size() {
/*  972 */       return Short2BooleanLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  975 */       Short2BooleanLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from) {
/*  978 */       return new Short2BooleanLinkedOpenHashMap.EntryIterator(Short2BooleanLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2BooleanMap.Entry> fastIterator() {
/*  981 */       return new Short2BooleanLinkedOpenHashMap.FastEntryIterator(Short2BooleanLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2BooleanMap.Entry> fastIterator(Short2BooleanMap.Entry from) {
/*  984 */       return new Short2BooleanLinkedOpenHashMap.FastEntryIterator(Short2BooleanLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Short2BooleanLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Short2BooleanMap.Entry>
/*      */   {
/*  904 */     final AbstractShort2BooleanMap.BasicEntry entry = new AbstractShort2BooleanMap.BasicEntry((short)0, false);
/*      */ 
...
/*  910 */       int e = nextEntry();
/*  911 */       this.entry.key = Short2BooleanLinkedOpenHashMap.this.key[e];
/*  912 */       this.entry.value = Short2BooleanLinkedOpenHashMap.this.value[e];
/*  913 */       return this.entry;
/*      */     }
/*      */     public AbstractShort2BooleanMap.BasicEntry previous() {
/*  916 */       int e = previousEntry();
/*  917 */       this.entry.key = Short2BooleanLinkedOpenHashMap.this.key[e];
/*  918 */       this.entry.value = Short2BooleanLinkedOpenHashMap.this.value[e];
/*  919 */       return this.entry;
/*      */     }
/*  921 */     public void set(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  922 */     public void add(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2BooleanLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Short2BooleanMap.Entry>
/*      */   {
...
/*  885 */       super(null);
/*      */     }
/*  887 */     public EntryIterator(short from) { super(from, null); }
/*      */ 
/*      */     public Short2BooleanLinkedOpenHashMap.MapEntry next() {
/*  890 */       return this.entry = new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Short2BooleanLinkedOpenHashMap.MapEntry previous() {
/*  893 */       return this.entry = new Short2BooleanLinkedOpenHashMap.MapEntry(Short2BooleanLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  897 */       super.remove();
/*  898 */       Short2BooleanLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  900 */     public void set(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  901 */     public void add(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  763 */     int index = -1;
/*      */ 
/*  765 */     private MapIterator() { this.next = Short2BooleanLinkedOpenHashMap.this.first;
/*  766 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(short from) {
/*  769 */       if (Short2BooleanLinkedOpenHashMap.this.key[Short2BooleanLinkedOpenHashMap.this.last] == from) {
/*  770 */         this.prev = Short2BooleanLinkedOpenHashMap.this.last;
/*  771 */         this.index = Short2BooleanLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  775 */         int pos = HashCommon.murmurHash3(from) & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */ 
/*  777 */         while (Short2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  778 */           if (Short2BooleanLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  780 */             this.next = ((int)Short2BooleanLinkedOpenHashMap.this.link[pos]);
/*  781 */             this.prev = pos;
/*  782 */             return;
/*      */           }
/*  784 */           pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  797 */       if (this.next == -1) {
/*  798 */         this.index = Short2BooleanLinkedOpenHashMap.this.size;
/*  799 */         return;
/*      */       }
/*  801 */       int pos = Short2BooleanLinkedOpenHashMap.this.first;
/*  802 */       this.index = 1;
/*  803 */       while (pos != this.prev) {
/*  804 */         pos = (int)Short2BooleanLinkedOpenHashMap.this.link[pos];
/*  805 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  817 */       if (!hasNext()) return Short2BooleanLinkedOpenHashMap.this.size();
/*  818 */       this.curr = this.next;
/*  819 */       this.next = ((int)Short2BooleanLinkedOpenHashMap.this.link[this.curr]);
...
/*  827 */       this.prev = ((int)(Short2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  839 */         this.index -= 1;
/*  840 */         this.prev = ((int)(Short2BooleanLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  843 */         this.next = ((int)Short2BooleanLinkedOpenHashMap.this.link[this.curr]);
/*  844 */       }Short2BooleanLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  847 */       if (this.prev == -1) Short2BooleanLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  849 */         Short2BooleanLinkedOpenHashMap.this.link[this.prev] ^= (Short2BooleanLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  850 */       if (this.next == -1) Short2BooleanLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  852 */         Short2BooleanLinkedOpenHashMap.this.link[this.next] ^= (Short2BooleanLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  856 */         pos = (last = pos) + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*  857 */         while (Short2BooleanLinkedOpenHashMap.this.used[pos] != 0) {
/*  858 */           int slot = HashCommon.murmurHash3(Short2BooleanLinkedOpenHashMap.this.key[pos]) & Short2BooleanLinkedOpenHashMap.this.mask;
/*  859 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  860 */           pos = pos + 1 & Short2BooleanLinkedOpenHashMap.this.mask;
/*      */         }
/*  862 */         if (Short2BooleanLinkedOpenHashMap.this.used[pos] == 0) break;
/*  863 */         Short2BooleanLinkedOpenHashMap.this.key[last] = Short2BooleanLinkedOpenHashMap.this.key[pos];
/*  864 */         Short2BooleanLinkedOpenHashMap.this.value[last] = Short2BooleanLinkedOpenHashMap.this.value[pos];
/*  865 */         if (this.next == pos) this.next = last;
/*  866 */         if (this.prev == pos) this.prev = last;
/*  867 */         Short2BooleanLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  869 */       Short2BooleanLinkedOpenHashMap.this.used[last] = false;
/*  870 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Short getKey() {
/*  629 */       return Short.valueOf(Short2BooleanLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public short getShortKey() {
/*  632 */       return Short2BooleanLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Boolean getValue() {
/*  635 */       return Boolean.valueOf(Short2BooleanLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public boolean getBooleanValue() {
/*  638 */       return Short2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public boolean setValue(boolean v) {
/*  641 */       boolean oldValue = Short2BooleanLinkedOpenHashMap.this.value[this.index];
/*  642 */       Short2BooleanLinkedOpenHashMap.this.value[this.index] = v;
/*  643 */       return oldValue;
/*      */     }
/*      */     public Boolean setValue(Boolean v) {
...
/*  652 */       return (Short2BooleanLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2BooleanLinkedOpenHashMap.this.value[this.index] == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */     public int hashCode() {
/*  655 */       return Short2BooleanLinkedOpenHashMap.this.key[this.index] ^ (Short2BooleanLinkedOpenHashMap.this.value[this.index] != 0 ? 1231 : 1237);
/*      */     }
/*      */     public String toString() {
/*  658 */       return Short2BooleanLinkedOpenHashMap.this.key[this.index] + "=>" + Short2BooleanLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
