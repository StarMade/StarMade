  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2BooleanRBTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2BooleanRBTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2BooleanRBTreeMap(Map<? extends Short, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2BooleanRBTreeMap(SortedMap<Short, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2BooleanRBTreeMap(Short2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2BooleanRBTreeMap(Short2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2BooleanRBTreeMap(short[] local_k, boolean[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2BooleanRBTreeMap(short[] local_k, boolean[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2BooleanMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Short2BooleanRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2BooleanRBTreeMap.EntryIterator(Short2BooleanRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from)
        {
          return new Short2BooleanRBTreeMap.EntryIterator(Short2BooleanRBTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2BooleanRBTreeMap.Entry local_f = Short2BooleanRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2BooleanRBTreeMap.Entry local_f = Short2BooleanRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2BooleanRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2BooleanRBTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry local_to)
        {
          return Short2BooleanRBTreeMap.this.headMap((Short)local_to.getKey()).short2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry from)
        {
          return Short2BooleanRBTreeMap.this.tailMap((Short)from.getKey()).short2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Short2BooleanRBTreeMap.ValueIterator(Short2BooleanRBTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Short2BooleanRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2BooleanRBTreeMap local_c;
    try
    {
      local_c = (Short2BooleanRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2BooleanRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2BooleanRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2BooleanRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator()
          {
            return new Short2BooleanRBTreeMap.Submap.SubmapEntryIterator(Short2BooleanRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from)
          {
            return new Short2BooleanRBTreeMap.Submap.SubmapEntryIterator(Short2BooleanRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Boolean> local_e = (Map.Entry)local_o;
            Short2BooleanRBTreeMap.Entry local_f = Short2BooleanRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2BooleanRBTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Boolean> local_e = (Map.Entry)local_o;
            Short2BooleanRBTreeMap.Entry local_f = Short2BooleanRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2BooleanRBTreeMap.Submap.this.in6(local_f.key))) {
              Short2BooleanRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2BooleanRBTreeMap.Submap.SubmapIterator(Short2BooleanRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2BooleanRBTreeMap.Submap.this.clear();
          }
          
          public Short2BooleanMap.Entry first()
          {
            return Short2BooleanRBTreeMap.Submap.this.firstEntry();
          }
          
          public Short2BooleanMap.Entry last()
          {
            return Short2BooleanRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry from, Short2BooleanMap.Entry local_to)
          {
            return Short2BooleanRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry local_to)
          {
            return Short2BooleanRBTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry from)
          {
            return Short2BooleanRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Short2BooleanRBTreeMap.Submap.SubmapValueIterator(Short2BooleanRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Short2BooleanRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2BooleanRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2BooleanRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2BooleanRBTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2BooleanRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(short local_k, boolean local_v)
    {
      ...
      boolean oldValue = Short2BooleanRBTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(short local_k)
    {
      ...
      boolean oldValue = Short2BooleanRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2BooleanRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2BooleanRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2BooleanRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2BooleanSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2BooleanRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2BooleanRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2BooleanSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2BooleanRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2BooleanRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2BooleanRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2BooleanRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2BooleanRBTreeMap.this.locateKey(this.from);
        if (Short2BooleanRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2BooleanRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2BooleanRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2BooleanRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2BooleanRBTreeMap.this.locateKey(this.field_47);
        if (Short2BooleanRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2BooleanRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2BooleanRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2BooleanRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2BooleanRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2BooleanRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2BooleanRBTreeMap.Submap.this.bottom) && (Short2BooleanRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2BooleanRBTreeMap.Submap.this.top) && (Short2BooleanRBTreeMap.this.compare(local_k, (this.prev = Short2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2BooleanRBTreeMap.this.locateKey(local_k);
            if (Short2BooleanRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2BooleanRBTreeMap.this.compare(this.prev.key, Short2BooleanRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Short2BooleanRBTreeMap.this.compare(this.next.key, Short2BooleanRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Short2BooleanRBTreeMap.Submap.SubmapKeyIterator(Short2BooleanRBTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2BooleanRBTreeMap.Submap.SubmapKeyIterator(Short2BooleanRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2BooleanSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2BooleanRBTreeMap.KeyIterator(Short2BooleanRBTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2BooleanRBTreeMap.KeyIterator(Short2BooleanRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2BooleanRBTreeMap.this.locateKey(local_k)) != null) {
        if (Short2BooleanRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
