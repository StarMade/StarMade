...
/*      */ 
/*      */ public class Short2BooleanRBTreeMap extends AbstractShort2BooleanSortedMap
...
/*  119 */           return Short2BooleanRBTreeMap.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*      */         }
/*      */         public int compare(Short ok1, Short ok2) {
/*  122 */           return Short2BooleanRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     boolean oldValue = put(ok.shortValue(), ov.booleanValue());
/*  731 */     return this.modified ? null : Boolean.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Boolean remove(Object ok)
/*      */   {
/*  737 */     boolean oldValue = remove(((Short)ok).shortValue());
...
/* 1141 */         final Comparator<? super Short2BooleanMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Short2BooleanMap.Entry x, Short2BooleanMap.Entry y) {
/* 1143 */             return Short2BooleanRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Short2BooleanRBTreeMap.EntryIterator(Short2BooleanRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from) {
/* 1153 */           return new Short2BooleanRBTreeMap.EntryIterator(Short2BooleanRBTreeMap.this, ((Short)from.getKey()).shortValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Short2BooleanRBTreeMap.Entry f = Short2BooleanRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1166 */           Short2BooleanRBTreeMap.Entry f = Short2BooleanRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1167 */           if (f != null) Short2BooleanRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Short2BooleanRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Short2BooleanRBTreeMap.this.clear(); } 
/* 1172 */         public Short2BooleanMap.Entry first() { return Short2BooleanRBTreeMap.this.firstEntry; } 
/* 1173 */         public Short2BooleanMap.Entry last() { return Short2BooleanRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry from, Short2BooleanMap.Entry to) { return Short2BooleanRBTreeMap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2BooleanEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry to) { return Short2BooleanRBTreeMap.this.headMap((Short)to.getKey()).short2BooleanEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry from) { return Short2BooleanRBTreeMap.this.tailMap((Short)from.getKey()).short2BooleanEntrySet(); }
/*      */       };
...
/* 1242 */           return new Short2BooleanRBTreeMap.ValueIterator(Short2BooleanRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(boolean k) {
/* 1245 */           return Short2BooleanRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Short2BooleanRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
...
/*      */     try
/*      */     {
/* 1611 */       c = (Short2BooleanRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readShort(), s.readBoolean());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readShort(), s.readBoolean());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readShort(), s.readBoolean()));
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Short2BooleanRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Short2BooleanRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1323 */       return ((this.bottom) || (Short2BooleanRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Short2BooleanRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet() {
/* 1327 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator() {
/* 1329 */             return new Short2BooleanRBTreeMap.Submap.SubmapEntryIterator(Short2BooleanRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from) {
/* 1332 */             return new Short2BooleanRBTreeMap.Submap.SubmapEntryIterator(Short2BooleanRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
/*      */           }
/* 1334 */           public Comparator<? super Short2BooleanMap.Entry> comparator() { return Short2BooleanRBTreeMap.this.short2BooleanEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Short2BooleanRBTreeMap.Entry f = Short2BooleanRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1340 */             return (f != null) && (Short2BooleanRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Short2BooleanRBTreeMap.Entry f = Short2BooleanRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1347 */             if ((f != null) && (Short2BooleanRBTreeMap.Submap.this.in(f.key))) Short2BooleanRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Short2BooleanRBTreeMap.Submap.SubmapIterator(Short2BooleanRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Short2BooleanRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Short2BooleanMap.Entry first() { return Short2BooleanRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Short2BooleanMap.Entry last() { return Short2BooleanRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry from, Short2BooleanMap.Entry to) { return Short2BooleanRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2BooleanEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry to) { return Short2BooleanRBTreeMap.Submap.this.headMap((Short)to.getKey()).short2BooleanEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry from) { return Short2BooleanRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2BooleanEntrySet(); }
/*      */         };
...
/*      */           public BooleanIterator iterator() {
/* 1376 */             return new Short2BooleanRBTreeMap.Submap.SubmapValueIterator(Short2BooleanRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(boolean k) {
/* 1379 */             return Short2BooleanRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Short2BooleanRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Short2BooleanRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(short k) {
/* 1392 */       return (in(k)) && (Short2BooleanRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(boolean v) {
...
/* 1407 */       return (in(kk)) && ((e = Short2BooleanRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public boolean put(short k, boolean v) {
/* 1410 */       Short2BooleanRBTreeMap.this.modified = false;
...
/* 1412 */       boolean oldValue = Short2BooleanRBTreeMap.this.put(k, v);
/* 1413 */       return Short2BooleanRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Boolean put(Short ok, Boolean ov) {
/* 1416 */       boolean oldValue = put(ok.shortValue(), ov.booleanValue());
/* 1417 */       return Short2BooleanRBTreeMap.this.modified ? null : Boolean.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public boolean remove(short k) {
/* 1421 */       Short2BooleanRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       boolean oldValue = Short2BooleanRBTreeMap.this.remove(k);
/* 1424 */       return Short2BooleanRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Boolean remove(Object ok) {
/* 1427 */       boolean oldValue = remove(((Short)ok).shortValue());
/* 1428 */       return Short2BooleanRBTreeMap.this.modified ? Boolean.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ShortComparator comparator() {
/* 1443 */       return Short2BooleanRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Short2BooleanSortedMap headMap(short to) {
/* 1446 */       if (this.top) return new Submap(Short2BooleanRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Short2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Short2BooleanRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Short2BooleanSortedMap tailMap(short from) {
/* 1450 */       if (this.bottom) return new Submap(Short2BooleanRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Short2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2BooleanRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Short2BooleanSortedMap subMap(short from, short to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Short2BooleanRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Short2BooleanRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Short2BooleanRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Short2BooleanRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Short2BooleanRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Short2BooleanRBTreeMap.this.tree == null) return null;
/* 1468 */       Short2BooleanRBTreeMap.Entry e;
/*      */       Short2BooleanRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Short2BooleanRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Short2BooleanRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Short2BooleanRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Short2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Short2BooleanRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Short2BooleanRBTreeMap.this.tree == null) return null;
/* 1486 */       Short2BooleanRBTreeMap.Entry e;
/*      */       Short2BooleanRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Short2BooleanRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Short2BooleanRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Short2BooleanRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Short2BooleanRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public short firstShortKey() {
/* 1497 */       Short2BooleanRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public short lastShortKey() {
/* 1502 */       Short2BooleanRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Short firstKey() {
/* 1507 */       Short2BooleanRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Short lastKey() {
/* 1512 */       Short2BooleanRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Short2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Short2BooleanRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Short2BooleanRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Short2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Short2BooleanRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Short2BooleanRBTreeMap.Submap.this.bottom) && (Short2BooleanRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Short2BooleanRBTreeMap.Submap.this.top) && (Short2BooleanRBTreeMap.this.compare(k, (this.prev = Short2BooleanRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Short2BooleanRBTreeMap.this.locateKey(k);
/* 1534 */             if (Short2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Short2BooleanRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2BooleanRBTreeMap.this.compare(this.prev.key, Short2BooleanRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Short2BooleanRBTreeMap.Submap.this.top) && (this.next != null) && (Short2BooleanRBTreeMap.this.compare(this.next.key, Short2BooleanRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public ShortBidirectionalIterator iterator() { return new Short2BooleanRBTreeMap.Submap.SubmapKeyIterator(Short2BooleanRBTreeMap.Submap.this); } 
/* 1367 */       public ShortBidirectionalIterator iterator(short from) { return new Short2BooleanRBTreeMap.Submap.SubmapKeyIterator(Short2BooleanRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2BooleanRBTreeMap.TreeIterator
/*      */     implements BooleanListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public ShortBidirectionalIterator iterator() { return new Short2BooleanRBTreeMap.KeyIterator(Short2BooleanRBTreeMap.this); } 
/* 1201 */     public ShortBidirectionalIterator iterator(short from) { return new Short2BooleanRBTreeMap.KeyIterator(Short2BooleanRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2BooleanRBTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2BooleanRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Short2BooleanMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Short2BooleanMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Short2BooleanMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Short2BooleanRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(short k) {
/* 1067 */       if ((this.next = Short2BooleanRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Short2BooleanRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Short2BooleanRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
/*  983 */       return this.key ^ (this.value ? 1231 : 1237);
/*      */     }
/*      */ 
