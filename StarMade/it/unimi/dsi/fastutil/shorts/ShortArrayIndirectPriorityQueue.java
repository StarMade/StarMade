  ...
  implements ShortIndirectPriorityQueue
{
  ...
  public ShortArrayIndirectPriorityQueue(short[] refArray, int capacity, ShortComparator local_c)
  {
    if (capacity > 0) {
  ...
  public ShortArrayIndirectPriorityQueue(short[] refArray, ShortComparator local_c)
  {
  ...
  public ShortArrayIndirectPriorityQueue(short[] refArray, int[] local_a, int size, ShortComparator local_c)
  {
  ...
  public ShortArrayIndirectPriorityQueue(short[] refArray, int[] local_a, ShortComparator local_c)
  {
    this(refArray, local_a, local_a.length, local_c);
  }
  
  public ShortArrayIndirectPriorityQueue(short[] refArray, int[] local_a, int size)
  {
    this(refArray, local_a, size, null);
  }
  
  public ShortArrayIndirectPriorityQueue(short[] refArray, int[] local_a)
  {
