  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2ObjectAVLTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2ObjectAVLTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2ObjectAVLTreeMap(Map<? extends Short, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ObjectAVLTreeMap(SortedMap<Short, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ObjectAVLTreeMap(Short2ObjectMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ObjectAVLTreeMap(Short2ObjectSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ObjectAVLTreeMap(short[] local_k, V[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2ObjectAVLTreeMap(short[] local_k, V[] local_v)
  {
  ...
  {
    Short2ObjectAVLTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2ObjectMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Short2ObjectAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2ObjectAVLTreeMap.EntryIterator(Short2ObjectAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator(Short2ObjectMap.Entry<V> from)
        {
          return new Short2ObjectAVLTreeMap.EntryIterator(Short2ObjectAVLTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2ObjectAVLTreeMap.Entry<V> local_f = Short2ObjectAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2ObjectAVLTreeMap.Entry<V> local_f = Short2ObjectAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2ObjectAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2ObjectAVLTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Short2ObjectMap.Entry<V>> headSet(Short2ObjectMap.Entry<V> local_to)
        {
          return Short2ObjectAVLTreeMap.this.headMap((Short)local_to.getKey()).short2ObjectEntrySet();
        }
        
        public ObjectSortedSet<Short2ObjectMap.Entry<V>> tailSet(Short2ObjectMap.Entry<V> from)
        {
          return Short2ObjectAVLTreeMap.this.tailMap((Short)from.getKey()).short2ObjectEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Short2ObjectAVLTreeMap.ValueIterator(Short2ObjectAVLTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Short2ObjectAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2ObjectAVLTreeMap<V> local_c;
    try
    {
      local_c = (Short2ObjectAVLTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Short2ObjectAVLTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2ObjectAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Short2ObjectAVLTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Short2ObjectAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2ObjectAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2ObjectMap.Entry<V>> short2ObjectEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator()
          {
            return new Short2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Short2ObjectAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator(Short2ObjectMap.Entry<V> from)
          {
            return new Short2ObjectAVLTreeMap.Submap.SubmapEntryIterator(Short2ObjectAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, V> local_e = (Map.Entry)local_o;
            Short2ObjectAVLTreeMap.Entry<V> local_f = Short2ObjectAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2ObjectAVLTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, V> local_e = (Map.Entry)local_o;
            Short2ObjectAVLTreeMap.Entry<V> local_f = Short2ObjectAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2ObjectAVLTreeMap.Submap.this.in6(local_f.key))) {
              Short2ObjectAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2ObjectAVLTreeMap.Submap.SubmapIterator(Short2ObjectAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2ObjectAVLTreeMap.Submap.this.clear();
          }
          
          public Short2ObjectMap.Entry<V> first()
          {
            return Short2ObjectAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Short2ObjectMap.Entry<V> last()
          {
            return Short2ObjectAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2ObjectMap.Entry<V>> subSet(Short2ObjectMap.Entry<V> from, Short2ObjectMap.Entry<V> local_to)
          {
            return Short2ObjectAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Short2ObjectMap.Entry<V>> headSet(Short2ObjectMap.Entry<V> local_to)
          {
            return Short2ObjectAVLTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2ObjectEntrySet();
          }
          
          public ObjectSortedSet<Short2ObjectMap.Entry<V>> tailSet(Short2ObjectMap.Entry<V> from)
          {
            return Short2ObjectAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2ObjectEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ObjectCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractObjectCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Short2ObjectAVLTreeMap.Submap.SubmapValueIterator(Short2ObjectAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Short2ObjectAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2ObjectAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2ObjectAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2ObjectAVLTreeMap.Entry<V> local_e;
      return (in6(local_kk)) && ((local_e = Short2ObjectAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(short local_k, V local_v)
    {
      ...
      V oldValue = Short2ObjectAVLTreeMap.this.put(local_k, local_v);
    ...
    public V remove(short local_k)
    {
      ...
      V oldValue = Short2ObjectAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2ObjectAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2ObjectSortedMap<V> tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2ObjectAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2ObjectAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2ObjectAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2ObjectSortedMap<V> subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2ObjectAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2ObjectAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2ObjectAVLTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2ObjectAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2ObjectAVLTreeMap.this.locateKey(this.from);
        if (Short2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2ObjectAVLTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2ObjectAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2ObjectAVLTreeMap.this.locateKey(this.field_47);
        if (Short2ObjectAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2ObjectAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2ObjectAVLTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2ObjectAVLTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Short2ObjectAVLTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Short2ObjectAVLTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Short2ObjectAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2ObjectAVLTreeMap.Submap.this.bottom) && (Short2ObjectAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2ObjectAVLTreeMap.Submap.this.top) && (Short2ObjectAVLTreeMap.this.compare(local_k, (this.prev = Short2ObjectAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2ObjectAVLTreeMap.this.locateKey(local_k);
            if (Short2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2ObjectAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2ObjectAVLTreeMap.this.compare(this.prev.key, Short2ObjectAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2ObjectAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2ObjectAVLTreeMap.this.compare(this.next.key, Short2ObjectAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2ObjectSortedMap.KeySet
    {
      ...
      {
        return new Short2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Short2ObjectAVLTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2ObjectAVLTreeMap.Submap.SubmapKeyIterator(Short2ObjectAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2ObjectSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2ObjectAVLTreeMap.KeyIterator(Short2ObjectAVLTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2ObjectAVLTreeMap.KeyIterator(Short2ObjectAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2ObjectAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Short2ObjectAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
