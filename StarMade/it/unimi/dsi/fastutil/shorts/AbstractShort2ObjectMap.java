...
/*  85 */     if ((m instanceof Short2ObjectMap))
/*     */     {
/*  87 */       while (n-- != 0) {
/*  88 */         Short2ObjectMap.Entry e = (Short2ObjectMap.Entry)i.next();
...
/* 175 */       public boolean contains(short k) { return AbstractShort2ObjectMap.this.containsKey(k); } 
/* 176 */       public int size() { return AbstractShort2ObjectMap.this.size(); } 
/* 177 */       public void clear() { AbstractShort2ObjectMap.this.clear(); } 
/*     */       public ShortIterator iterator() {
/* 179 */         return new AbstractShortIterator() {
/* 180 */           final ObjectIterator<Map.Entry<Short, V>> i = AbstractShort2ObjectMap.this.entrySet().iterator();
/*     */ 
/* 181 */           public short nextShort() { return ((Short2ObjectMap.Entry)this.i.next()).getShortKey(); } 
...
/* 200 */       public boolean contains(Object k) { return AbstractShort2ObjectMap.this.containsValue(k); } 
/* 201 */       public int size() { return AbstractShort2ObjectMap.this.size(); } 
/* 202 */       public void clear() { AbstractShort2ObjectMap.this.clear(); } 
/*     */       public ObjectIterator<V> iterator() {
/* 204 */         return new AbstractObjectIterator() {
/* 205 */           final ObjectIterator<Map.Entry<Short, V>> i = AbstractShort2ObjectMap.this.entrySet().iterator();
/*     */ 
/* 206 */           public V next() { return ((Short2ObjectMap.Entry)this.i.next()).getValue(); } 
...
/* 214 */     return short2ObjectEntrySet();
/*     */   }
/*     */ 
/*     */   public int hashCode()
/*     */   {
...
/* 244 */         s.append(", ");
/* 245 */       Short2ObjectMap.Entry e = (Short2ObjectMap.Entry)i.next();
...
/* 153 */       return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
