...
/*  13:    */
/*  61:    */public abstract class AbstractShort2ObjectMap<V>
/*  62:    */  extends AbstractShort2ObjectFunction<V>
/*  63:    */  implements Short2ObjectMap<V>, Serializable
/*  64:    */{
...
/*  85: 85 */    if ((m instanceof Short2ObjectMap))
/*  86:    */    {
/*  87: 87 */      while (n-- != 0) {
/*  88: 88 */        Short2ObjectMap.Entry<? extends V> e = (Short2ObjectMap.Entry)i.next();
...
/* 106:    */    implements Short2ObjectMap.Entry<V>
/* 107:    */  {
...
/* 153:153 */      return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == null ? e.getValue() == null : this.value.equals(e.getValue()));
/* 154:    */    }
/* 155:    */    
...
/* 175:175 */      public boolean contains(short k) { return AbstractShort2ObjectMap.this.containsKey(k); }
/* 176:176 */      public int size() { return AbstractShort2ObjectMap.this.size(); }
/* 177:177 */      public void clear() { AbstractShort2ObjectMap.this.clear(); }
/* 178:    */      
/* 179:179 */      public ShortIterator iterator() { new AbstractShortIterator() {
/* 180:180 */          final ObjectIterator<Map.Entry<Short, V>> i = AbstractShort2ObjectMap.this.entrySet().iterator();
/* 181:181 */          public short nextShort() { return ((Short2ObjectMap.Entry)this.i.next()).getShortKey(); }
...
/* 200:200 */      public boolean contains(Object k) { return AbstractShort2ObjectMap.this.containsValue(k); }
/* 201:201 */      public int size() { return AbstractShort2ObjectMap.this.size(); }
/* 202:202 */      public void clear() { AbstractShort2ObjectMap.this.clear(); }
/* 203:    */      
/* 204:204 */      public ObjectIterator<V> iterator() { new AbstractObjectIterator() {
/* 205:205 */          final ObjectIterator<Map.Entry<Short, V>> i = AbstractShort2ObjectMap.this.entrySet().iterator();
/* 206:206 */          public V next() { return ((Short2ObjectMap.Entry)this.i.next()).getValue(); }
...
/* 213:    */  {
/* 214:214 */    return short2ObjectEntrySet();
/* 215:    */  }
/* 216:    */  
...
/* 244:244 */        s.append(", ");
/* 245:245 */      Short2ObjectMap.Entry<V> e = (Short2ObjectMap.Entry)i.next();
