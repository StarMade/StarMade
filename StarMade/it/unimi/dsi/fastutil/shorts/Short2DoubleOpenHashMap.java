  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2DoubleOpenHashMap(int expected, float local_f)
  {
  ...
  public Short2DoubleOpenHashMap(Map<? extends Short, ? extends Double> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2DoubleOpenHashMap(Map<? extends Short, ? extends Double> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2DoubleOpenHashMap(Short2DoubleMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2DoubleOpenHashMap(Short2DoubleMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2DoubleOpenHashMap(short[] local_k, double[] local_v, float local_f)
  {
  ...
  public Short2DoubleOpenHashMap(short[] local_k, double[] local_v)
  {
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Short2DoubleOpenHashMap.ValueIterator(Short2DoubleOpenHashMap.this);
        }
        ...
        {
          return Short2DoubleOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2DoubleOpenHashMap local_c;
    try
    {
      local_c = (Short2DoubleOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Short2DoubleOpenHashMap.MapIterator
    ...
    extends AbstractShortSet
  {
    ...
    {
      return new Short2DoubleOpenHashMap.KeyIterator(Short2DoubleOpenHashMap.this);
    }
    ...
    {
      return Short2DoubleOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2DoubleOpenHashMap.this.size;
      Short2DoubleOpenHashMap.this.remove(local_k);
    ...
    implements Short2DoubleMap.FastEntrySet
  {
    ...
    {
      return new Short2DoubleOpenHashMap.EntryIterator(Short2DoubleOpenHashMap.this, null);
    }
    
    public ObjectIterator<Short2DoubleMap.Entry> fastIterator()
    {
      return new Short2DoubleOpenHashMap.FastEntryIterator(Short2DoubleOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2DoubleOpenHashMap.this.mask; Short2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2DoubleOpenHashMap.this.mask) {
        if (Short2DoubleOpenHashMap.this.key[pos] == local_k) {
          return Short2DoubleOpenHashMap.this.value[pos] == ((Double)local_e.getValue()).doubleValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2DoubleOpenHashMap.this.mask; Short2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2DoubleOpenHashMap.this.mask) {
        if (Short2DoubleOpenHashMap.this.key[pos] == local_k)
        {
          Short2DoubleOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Short2DoubleMap.Entry>
  {
    ...
    public AbstractShort2DoubleMap.BasicEntry next()
    {
      ...
      this.entry.key = Short2DoubleOpenHashMap.this.key[local_e];
      this.entry.value = Short2DoubleOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Short2DoubleMap.Entry>
  {
    ...
    {
      return this.entry = new Short2DoubleOpenHashMap.MapEntry(Short2DoubleOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2DoubleOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Short2DoubleOpenHashMap.this.field_49;
    int last = -1;
    int field_2041 = Short2DoubleOpenHashMap.this.size;
    ShortArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Short2DoubleOpenHashMap.this.used;
      while ((this.field_2041 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2041 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      {
        boolean[] local_k = Short2DoubleOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2DoubleOpenHashMap.this.mask; Short2DoubleOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2DoubleOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Short2DoubleOpenHashMap.this.key[pos]) & Short2DoubleOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Short2DoubleOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Short2DoubleOpenHashMap.this.key[pos]);
        }
        Short2DoubleOpenHashMap.this.key[last] = Short2DoubleOpenHashMap.this.key[pos];
        Short2DoubleOpenHashMap.this.value[last] = Short2DoubleOpenHashMap.this.value[pos];
      }
      Short2DoubleOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Short2DoubleOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
        this.last = -1;
        return;
      }
      Short2DoubleOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2041 > 0))
      {
        this.field_2041 += 1;
        nextEntry();
      }
    ...
    implements Short2DoubleMap.Entry, Map.Entry<Short, Double>
  {
    ...
    public double setValue(double local_v)
    {
      ...
      Short2DoubleOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, Double> local_e = (Map.Entry)local_o;
      return (Short2DoubleOpenHashMap.this.key[this.index] == ((Short)local_e.getKey()).shortValue()) && (Short2DoubleOpenHashMap.this.value[this.index] == ((Double)local_e.getValue()).doubleValue());
    }
