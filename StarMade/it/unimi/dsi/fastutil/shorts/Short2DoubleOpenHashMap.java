...
/*  18:    */
/*  87:    */public class Short2DoubleOpenHashMap
/*  88:    */  extends AbstractShort2DoubleMap
...
/* 101:    */  protected volatile transient Short2DoubleMap.FastEntrySet entries;
/* 102:    */  protected volatile transient ShortSet keys;
/* 103:    */  protected volatile transient DoubleCollection values;
/* 104:    */  
/* 105:    */  public Short2DoubleOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Short2DoubleOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Short2DoubleOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Short2DoubleOpenHashMap(Map<? extends Short, ? extends Double> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Short2DoubleOpenHashMap(Map<? extends Short, ? extends Double> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Short2DoubleOpenHashMap(Short2DoubleMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Short2DoubleOpenHashMap(Short2DoubleMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Short2DoubleOpenHashMap(short[] k, double[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Short2DoubleOpenHashMap(short[] k, double[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public double put(short k, double v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Double put(Short ok, Double ov) { double v = ov.doubleValue();
...
/* 226:    */  }
/* 227:    */  
/* 238:    */  public double add(short k, double incr)
/* 239:    */  {
...
/* 279:    */  }
/* 280:    */  
/* 281:    */  public double remove(short k)
/* 282:    */  {
...
/* 312:    */  }
/* 313:    */  
/* 314:314 */  public Double get(Short ok) { short k = ok.shortValue();
/* 315:    */    
...
/* 389:    */    implements Short2DoubleMap.Entry, Map.Entry<Short, Double>
/* 390:    */  {
...
/* 396:    */    }
/* 397:    */    
/* 398:398 */    public Short getKey() { return Short.valueOf(Short2DoubleOpenHashMap.this.key[this.index]); }
/* 399:    */    
/* 400:    */    public short getShortKey() {
/* 401:401 */      return Short2DoubleOpenHashMap.this.key[this.index];
/* 402:    */    }
/* 403:    */    
/* 404:404 */    public Double getValue() { return Double.valueOf(Short2DoubleOpenHashMap.this.value[this.index]); }
/* 405:    */    
/* 407:407 */    public double getDoubleValue() { return Short2DoubleOpenHashMap.this.value[this.index]; }
/* 408:    */    
/* 409:    */    public double setValue(double v) {
/* 410:410 */      double oldValue = Short2DoubleOpenHashMap.this.value[this.index];
/* 411:411 */      Short2DoubleOpenHashMap.this.value[this.index] = v;
...
/* 420:420 */      Map.Entry<Short, Double> e = (Map.Entry)o;
/* 421:421 */      return (Short2DoubleOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2DoubleOpenHashMap.this.value[this.index] == ((Double)e.getValue()).doubleValue());
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public int hashCode() { return Short2DoubleOpenHashMap.this.key[this.index] ^ HashCommon.double2int(Short2DoubleOpenHashMap.this.value[this.index]); }
/* 425:    */    
/* 427:427 */    public String toString() { return Short2DoubleOpenHashMap.this.key[this.index] + "=>" + Short2DoubleOpenHashMap.this.value[this.index]; } }
/* 428:    */  
...
/* 433:    */    
/* 434:434 */    private MapIterator() { this.pos = Short2DoubleOpenHashMap.this.n;
/* 435:    */      
/* 437:437 */      this.last = -1;
/* 438:    */      
/* 439:439 */      this.c = Short2DoubleOpenHashMap.this.size;
/* 440:    */      
/* 444:444 */      boolean[] used = Short2DoubleOpenHashMap.this.used;
...
/* 456:    */        
/* 457:457 */        int pos = HashCommon.murmurHash3(k) & Short2DoubleOpenHashMap.this.mask;
/* 458:    */        
/* 459:459 */        while (Short2DoubleOpenHashMap.this.used[pos] != 0) {
/* 460:460 */          if (Short2DoubleOpenHashMap.this.key[pos] == k) return pos;
/* 461:461 */          pos = pos + 1 & Short2DoubleOpenHashMap.this.mask;
/* 462:    */        }
/* 463:    */      }
/* 464:464 */      this.last = this.pos;
/* 465:    */      
/* 466:466 */      if (this.c != 0) {
/* 467:467 */        boolean[] used = Short2DoubleOpenHashMap.this.used;
...
/* 482:    */      for (;;)
/* 483:    */      {
/* 484:484 */        pos = (last = pos) + 1 & Short2DoubleOpenHashMap.this.mask;
/* 485:485 */        while (Short2DoubleOpenHashMap.this.used[pos] != 0) {
/* 486:486 */          int slot = HashCommon.murmurHash3(Short2DoubleOpenHashMap.this.key[pos]) & Short2DoubleOpenHashMap.this.mask;
/* 487:487 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488:488 */          pos = pos + 1 & Short2DoubleOpenHashMap.this.mask;
/* 489:    */        }
/* 490:490 */        if (Short2DoubleOpenHashMap.this.used[pos] == 0) break;
/* 491:491 */        if (pos < last)
/* 492:    */        {
/* 493:493 */          if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 494:494 */          this.wrapped.add(Short2DoubleOpenHashMap.this.key[pos]);
/* 495:    */        }
/* 496:496 */        Short2DoubleOpenHashMap.this.key[last] = Short2DoubleOpenHashMap.this.key[pos];
/* 497:497 */        Short2DoubleOpenHashMap.this.value[last] = Short2DoubleOpenHashMap.this.value[pos];
/* 498:    */      }
/* 499:499 */      Short2DoubleOpenHashMap.this.used[last] = false;
/* 500:500 */      return last;
/* 501:    */    }
/* 502:    */    
...
/* 506:    */      {
/* 507:507 */        Short2DoubleOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 508:508 */        this.last = -1;
/* 509:509 */        return;
/* 510:    */      }
/* 511:511 */      Short2DoubleOpenHashMap.this.size -= 1;
...
/* 523:    */    } }
/* 524:    */  
/* 525:525 */  private class EntryIterator extends Short2DoubleOpenHashMap.MapIterator implements ObjectIterator<Short2DoubleMap.Entry> { private EntryIterator() { super(null); }
/* 526:    */    
/* 527:    */    private Short2DoubleOpenHashMap.MapEntry entry;
/* 528:528 */    public Short2DoubleMap.Entry next() { return this.entry = new Short2DoubleOpenHashMap.MapEntry(Short2DoubleOpenHashMap.this, nextEntry()); }
/* 529:    */    
/* 530:    */    public void remove()
/* 531:    */    {
/* 532:532 */      super.remove();
/* 533:533 */      Short2DoubleOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 534:    */    } }
/* 535:    */  
/* 536:536 */  private class FastEntryIterator extends Short2DoubleOpenHashMap.MapIterator implements ObjectIterator<Short2DoubleMap.Entry> { private FastEntryIterator() { super(null); }
/* 537:537 */    final AbstractShort2DoubleMap.BasicEntry entry = new AbstractShort2DoubleMap.BasicEntry((short)0, 0.0D);
/* 538:    */    
/* 539:539 */    public AbstractShort2DoubleMap.BasicEntry next() { int e = nextEntry();
/* 540:540 */      this.entry.key = Short2DoubleOpenHashMap.this.key[e];
/* 541:541 */      this.entry.value = Short2DoubleOpenHashMap.this.value[e];
/* 542:542 */      return this.entry;
/* 543:    */    } }
/* 544:    */  
/* 545:    */  private final class MapEntrySet extends AbstractObjectSet<Short2DoubleMap.Entry> implements Short2DoubleMap.FastEntrySet { private MapEntrySet() {}
/* 546:    */    
/* 547:547 */    public ObjectIterator<Short2DoubleMap.Entry> iterator() { return new Short2DoubleOpenHashMap.EntryIterator(Short2DoubleOpenHashMap.this, null); }
/* 548:    */    
/* 549:    */    public ObjectIterator<Short2DoubleMap.Entry> fastIterator() {
/* 550:550 */      return new Short2DoubleOpenHashMap.FastEntryIterator(Short2DoubleOpenHashMap.this, null);
/* 551:    */    }
/* 552:    */    
/* 553:    */    public boolean contains(Object o) {
/* 554:554 */      if (!(o instanceof Map.Entry)) return false;
/* 555:555 */      Map.Entry<Short, Double> e = (Map.Entry)o;
/* 556:556 */      short k = ((Short)e.getKey()).shortValue();
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(k) & Short2DoubleOpenHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Short2DoubleOpenHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Short2DoubleOpenHashMap.this.key[pos] == k) return Short2DoubleOpenHashMap.this.value[pos] == ((Double)e.getValue()).doubleValue();
/* 562:562 */        pos = pos + 1 & Short2DoubleOpenHashMap.this.mask;
/* 563:    */      }
...
/* 569:569 */      Map.Entry<Short, Double> e = (Map.Entry)o;
/* 570:570 */      short k = ((Short)e.getKey()).shortValue();
/* 571:    */      
/* 572:572 */      int pos = HashCommon.murmurHash3(k) & Short2DoubleOpenHashMap.this.mask;
/* 573:    */      
/* 574:574 */      while (Short2DoubleOpenHashMap.this.used[pos] != 0) {
/* 575:575 */        if (Short2DoubleOpenHashMap.this.key[pos] == k) {
/* 576:576 */          Short2DoubleOpenHashMap.this.remove(e.getKey());
/* 577:577 */          return true;
/* 578:    */        }
/* 579:579 */        pos = pos + 1 & Short2DoubleOpenHashMap.this.mask;
/* 580:    */      }
/* 581:581 */      return false;
/* 582:    */    }
/* 583:    */    
/* 584:584 */    public int size() { return Short2DoubleOpenHashMap.this.size; }
/* 585:    */    
/* 587:587 */    public void clear() { Short2DoubleOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public Short2DoubleMap.FastEntrySet short2DoubleEntrySet() {
...
/* 598:    */    extends Short2DoubleOpenHashMap.MapIterator
/* 599:    */    implements ShortIterator
/* 600:    */  {
/* 601:601 */    public KeyIterator() { super(null); }
/* 602:602 */    public short nextShort() { return Short2DoubleOpenHashMap.this.key[nextEntry()]; }
/* 603:603 */    public Short next() { return Short.valueOf(Short2DoubleOpenHashMap.this.key[nextEntry()]); } }
/* 604:    */  
/* 605:    */  private final class KeySet extends AbstractShortSet { private KeySet() {}
/* 606:    */    
/* 607:607 */    public ShortIterator iterator() { return new Short2DoubleOpenHashMap.KeyIterator(Short2DoubleOpenHashMap.this); }
/* 608:    */    
/* 609:    */    public int size() {
/* 610:610 */      return Short2DoubleOpenHashMap.this.size;
/* 611:    */    }
/* 612:    */    
/* 613:613 */    public boolean contains(short k) { return Short2DoubleOpenHashMap.this.containsKey(k); }
/* 614:    */    
/* 615:    */    public boolean remove(short k) {
/* 616:616 */      int oldSize = Short2DoubleOpenHashMap.this.size;
/* 617:617 */      Short2DoubleOpenHashMap.this.remove(k);
/* 618:618 */      return Short2DoubleOpenHashMap.this.size != oldSize;
/* 619:    */    }
/* 620:    */    
/* 621:621 */    public void clear() { Short2DoubleOpenHashMap.this.clear(); }
/* 622:    */  }
/* 623:    */  
...
/* 632:    */    extends Short2DoubleOpenHashMap.MapIterator
/* 633:    */    implements DoubleIterator
/* 634:    */  {
/* 635:635 */    public ValueIterator() { super(null); }
/* 636:636 */    public double nextDouble() { return Short2DoubleOpenHashMap.this.value[nextEntry()]; }
/* 637:637 */    public Double next() { return Double.valueOf(Short2DoubleOpenHashMap.this.value[nextEntry()]); }
/* 638:    */  }
/* 639:    */  
...
/* 642:642 */          return new Short2DoubleOpenHashMap.ValueIterator(Short2DoubleOpenHashMap.this);
/* 643:    */        }
/* 644:    */        
/* 645:645 */        public int size() { return Short2DoubleOpenHashMap.this.size; }
/* 646:    */        
/* 647:    */        public boolean contains(double v) {
/* 648:648 */          return Short2DoubleOpenHashMap.this.containsValue(v);
/* 649:    */        }
/* 650:    */        
/* 651:651 */        public void clear() { Short2DoubleOpenHashMap.this.clear(); }
/* 652:    */      };
/* 653:    */    }
...
/* 754:    */  }
/* 755:    */  
/* 759:    */  public Short2DoubleOpenHashMap clone()
/* 760:    */  {
/* 761:    */    Short2DoubleOpenHashMap c;
/* 762:    */    
/* 764:    */    try
/* 765:    */    {
/* 766:766 */      c = (Short2DoubleOpenHashMap)super.clone();
/* 767:    */    }
