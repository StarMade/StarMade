...
public class ShortBigArrays
{
  ...
  {
    short local_t = array[BigArrays.segment(first)][BigArrays.displacement(first)];
  ...
  public static void add(short[][] array, long index, short incr)
  {
    ...
    short[] tmp10_5 = array[BigArrays.segment(index)];
    tmp10_5[tmp10_7] = ((short)(tmp10_5[tmp10_7] + tmp10_7));
  }
  ...
  public static void incr(short[][] array, long index)
  {
    int tmp10_7 = BigArrays.displacement(index);
    short[] tmp10_5 = array[BigArrays.segment(index)];
    tmp10_5[tmp10_7] = ((short)(tmp10_5[tmp10_7] + 1));
  }
  ...
  public static short[][] newBigArray(long length)
  {
    ...
    if (residual != 0)
    {
      for (int local_i = 0; local_i < baseLength - 1; local_i++) {
        base[local_i] = new short[134217728];
      }
  ...
  public static short[][] wrap(short[] array)
  {
    ...
    short[][] bigArray = newBigArray(array.length);
  ...
  public static short[][] copy(short[][] array, long offset, long length)
  {
    ...
    short[][] local_a = newBigArray(length);
  ...
  public static short[][] copy(short[][] array)
  {
    ...
    while (local_i-- != 0) {
      base[local_i] = ((short[])array[local_i].clone());
    }
    return base;
  }
  ...
  public static void fill(short[][] array, short value)
  {
    ...
    while (local_i-- != 0) {
      ShortArrays.fill(array[local_i], value);
    }
  }
  
  public static void fill(short[][] array, long from, long local_to, short value)
  {
    ...
    ShortArrays.fill(array[fromSegment], fromDispl, 134217728, value);
  }
  ...
  public static String toString(short[][] local_a)
  {
    if (local_a == null) {
      return "null";
    }
  ...
  public static void ensureFromTo(short[][] local_a, long from, long local_to)
  {
    BigArrays.ensureFromTo(length(local_a), from, local_to);
  }
  
  public static void ensureOffsetLength(short[][] local_a, long offset, long length)
  {
    BigArrays.ensureOffsetLength(length(local_a), offset, length);
  }
  
  private static void vecSwap(short[][] local_x, long local_a, long local_b, long local_n)
  {
    int local_i = 0;
  ...
  private static long med3(short[][] local_x, long local_a, long local_b, long local_c, ShortComparator comp)
  {
  ...
  private static void selectionSort(short[][] local_a, long from, long local_to, ShortComparator comp)
  {
  ...
  public static void quickSort(short[][] local_x, long from, long local_to, ShortComparator comp)
  {
    ...
    short local_j = get(local_x, local_i);
    long local_a = from;
  ...
  private static long med3(short[][] local_x, long local_a, long local_b, long local_c)
  {
  ...
  private static void selectionSort(short[][] local_a, long from, long local_to)
  {
    for (long local_i = from; local_i < local_to - 1L; local_i += 1L)
    {
      long local_m = local_i;
  ...
  public static void quickSort(short[][] local_x, long from, long local_to)
  {
    long len = local_to - from;
    if (len < 7L)
    {
  ...
  public static long binarySearch(short[][] local_a, long from, long local_to, short key)
  {
    local_to -= 1L;
    while (from <= local_to)
    {
      long mid = from + local_to >>> 1;
      short midVal = get(local_a, mid);
      if (midVal < key) {
        from = mid + 1L;
      } else if (midVal > key) {
        local_to = mid - 1L;
  ...
  public static long binarySearch(short[][] local_a, short key)
  {
    return binarySearch(local_a, 0L, length(local_a), key);
  }
  
  public static long binarySearch(short[][] local_a, long from, long local_to, short key, ShortComparator local_c)
  {
    local_to -= 1L;
    while (from <= local_to)
    {
  ...
  public static long binarySearch(short[][] local_a, short key, ShortComparator local_c)
  {
  ...
  public static void radixSort(short[][] local_a, long from, long local_to)
  {
    int maxLevel = 1;
    int stackSize = 256;
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        {
          short local_t = get(local_a, local_i2 + first);
  ...
  private static void selectionSort(short[][] local_a, short[][] local_b, long from, long local_to)
  {
    for (long local_i = from; local_i < local_to - 1L; local_i += 1L)
    {
      long local_m = local_i;
      ...
      if (local_m != local_i)
      {
        short local_j = get(local_a, local_i);
  ...
  public static void radixSort(short[][] local_a, short[][] local_b, long from, long local_to)
  {
    int layers = 2;
    ...
    while (offsetPos > 0)
    {
      ...
      else
      {
        ...
        {
          short local_t = get(local_a, local_i2 + first);
          short local_u = get(local_b, local_i2 + first);
          local_c = ByteBigArrays.get(digit, local_i2) & 0xFF;
          for (;;)
          {
            long local_d;
  ...
  public static short[][] shuffle(short[][] local_a, long from, long local_to, Random random)
  {
    long local_i = local_to - from;
    while (local_i-- != 0L)
    {
      long local_p = (random.nextLong() & 0xFFFFFFFF) % (local_i + 1L);
      short local_t = get(local_a, from + local_i);
  ...
  public static short[][] shuffle(short[][] local_a, Random random)
  {
    ...
    {
      long local_p = (random.nextLong() & 0xFFFFFFFF) % (local_i + 1L);
      short local_t = get(local_a, local_i);
    ...
    implements Hash.Strategy<short[][]>, Serializable
  {
    ...
    {
      return ShortBigArrays.equals(local_a, local_b);
    }
  }
}
