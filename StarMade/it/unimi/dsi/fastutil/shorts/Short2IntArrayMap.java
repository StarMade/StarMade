...
/*     */ 
/*     */ public class Short2IntArrayMap extends AbstractShort2IntMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Short2IntArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Short2IntMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Short2IntArrayMap.this.size; }
/*     */ 
/*     */         public Short2IntMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractShort2IntMap.BasicEntry(Short2IntArrayMap.this.key[this.next], Short2IntArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractShort2IntMap.BasicEntry entry = new AbstractShort2IntMap.BasicEntry((short)0, 0);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Short2IntArrayMap.this.size; }
/*     */ 
/*     */         public Short2IntMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Short2IntArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Short2IntArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Short2IntArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Short2IntArrayMap.this.containsKey(k)) && (Short2IntArrayMap.this.get(k) == ((Integer)e.getValue()).intValue());
/*     */     }
/*     */   }
/*     */ }
