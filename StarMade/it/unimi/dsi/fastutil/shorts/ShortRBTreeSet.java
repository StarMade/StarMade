...
/*   97 */           return ShortRBTreeSet.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*      */         }
/*      */         public int compare(Short ok1, Short ok2) {
/*  100 */           return ShortRBTreeSet.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   }
/*      */ 
/*      */   public ShortRBTreeSet(Iterator<? extends Short> i)
/*      */   {
...
/* 1028 */     return new Subset((short)0, true, to, false);
/*      */   }
/*      */   public ShortSortedSet tailSet(short from) {
/* 1031 */     return new Subset(from, false, (short)0, true);
/*      */   }
...
/*      */     try
/*      */     {
/* 1226 */       c = (ShortRBTreeSet)super.clone();
/*      */     }
...
/* 1279 */     while (n-- != 0) s.writeShort(i.nextShort());
/*      */   }
/*      */ 
...
/*      */   {
/* 1290 */     if (n == 1) {
/* 1291 */       Entry top = new Entry(s.readShort());
/* 1292 */       top.pred(pred);
/* 1293 */       top.succ(succ);
/* 1294 */       top.black(true);
/* 1295 */       return top;
...
/* 1297 */     if (n == 2)
/*      */     {
/* 1300 */       Entry top = new Entry(s.readShort());
/* 1301 */       top.black(true);
/* 1302 */       top.right(new Entry(s.readShort()));
...
/*      */     {
/* 1063 */       if ((!bottom) && (!top) && (ShortRBTreeSet.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start element (").append(from).append(") is larger than end element (").append(to).append(")").toString());
/* 1064 */       this.from = from;
...
/*      */     {
/* 1081 */       return ((this.bottom) || (ShortRBTreeSet.this.compare(k, this.from) >= 0)) && ((this.top) || (ShortRBTreeSet.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public boolean contains(short k)
/*      */     {
/* 1086 */       return (in(k)) && (ShortRBTreeSet.this.contains(k));
/*      */     }
/*      */     public boolean add(short k) {
...
/* 1090 */       return ShortRBTreeSet.this.add(k);
/*      */     }
/*      */ 
/*      */     public boolean remove(short k) {
/* 1094 */       if (!in(k)) return false;
/* 1095 */       return ShortRBTreeSet.this.remove(k);
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ShortComparator comparator() {
/* 1110 */       return ShortRBTreeSet.this.actualComparator;
/*      */     }
/*      */     public ShortBidirectionalIterator iterator() {
...
/*      */     }
/*      */     public ShortSortedSet headSet(short to) {
/* 1119 */       if (this.top) return new Subset(ShortRBTreeSet.this, this.from, this.bottom, to, false);
/* 1120 */       return ShortRBTreeSet.this.compare(to, this.to) < 0 ? new Subset(ShortRBTreeSet.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public ShortSortedSet tailSet(short from) {
/* 1123 */       if (this.bottom) return new Subset(ShortRBTreeSet.this, from, false, this.to, this.top);
/* 1124 */       return ShortRBTreeSet.this.compare(from, this.from) > 0 ? new Subset(ShortRBTreeSet.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public ShortSortedSet subSet(short from, short to) {
/* 1127 */       if ((this.top) && (this.bottom)) return new Subset(ShortRBTreeSet.this, from, false, to, false);
...
/* 1131 */       return new Subset(ShortRBTreeSet.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public ShortRBTreeSet.Entry firstEntry()
/*      */     {
/* 1138 */       if (ShortRBTreeSet.this.tree == null) return null;
/* 1141 */       ShortRBTreeSet.Entry e;
/*      */       ShortRBTreeSet.Entry e;
/* 1141 */       if (this.bottom) { e = ShortRBTreeSet.this.firstEntry;
/*      */       } else {
/* 1143 */         e = ShortRBTreeSet.this.locateKey(this.from);
/*      */ 
/* 1145 */         if (ShortRBTreeSet.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1148 */       if ((e == null) || ((!this.top) && (ShortRBTreeSet.this.compare(e.key, this.to) >= 0))) return null;
/* 1149 */       return e;
/*      */     }
/*      */ 
/*      */     public ShortRBTreeSet.Entry lastEntry()
/*      */     {
/* 1156 */       if (ShortRBTreeSet.this.tree == null) return null;
/* 1159 */       ShortRBTreeSet.Entry e;
/*      */       ShortRBTreeSet.Entry e;
/* 1159 */       if (this.top) { e = ShortRBTreeSet.this.lastEntry;
/*      */       } else {
/* 1161 */         e = ShortRBTreeSet.this.locateKey(this.to);
/*      */ 
/* 1163 */         if (ShortRBTreeSet.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1166 */       if ((e == null) || ((!this.bottom) && (ShortRBTreeSet.this.compare(e.key, this.from) < 0))) return null;
/* 1167 */       return e;
/*      */     }
/*      */     public short firstShort() {
/* 1170 */       ShortRBTreeSet.Entry e = firstEntry();
/* 1171 */       if (e == null) throw new NoSuchElementException();
/* 1172 */       return e.key;
/*      */     }
/*      */     public short lastShort() {
/* 1175 */       ShortRBTreeSet.Entry e = lastEntry();
...
/*      */       {
/* 1187 */         super();
/* 1188 */         this.next = ShortRBTreeSet.Subset.this.firstEntry();
/*      */       }
/*      */       SubsetIterator(short k) {
/* 1191 */         this();
/* 1192 */         if (this.next != null)
/* 1193 */           if ((!ShortRBTreeSet.Subset.this.bottom) && (ShortRBTreeSet.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1194 */           } else if ((!ShortRBTreeSet.Subset.this.top) && (ShortRBTreeSet.this.compare(k, (this.prev = ShortRBTreeSet.Subset.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1196 */             this.next = ShortRBTreeSet.this.locateKey(k);
/* 1197 */             if (ShortRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/* 1207 */         if ((!ShortRBTreeSet.Subset.this.bottom) && (this.prev != null) && (ShortRBTreeSet.this.compare(this.prev.key, ShortRBTreeSet.Subset.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1210 */         this.next = this.next.next();
/* 1211 */         if ((!ShortRBTreeSet.Subset.this.top) && (this.next != null) && (ShortRBTreeSet.this.compare(this.next.key, ShortRBTreeSet.Subset.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */   }
/*      */ 
...
/*  963 */     int index = 0;
/*      */ 
/*  965 */     SetIterator() { this.next = ShortRBTreeSet.this.firstEntry; }
/*      */ 
/*      */     SetIterator(short k) {
/*  968 */       if ((this.next = ShortRBTreeSet.this.locateKey(k)) != null)
/*  969 */         if (ShortRBTreeSet.this.compare(this.next.key, k) <= 0) {
...
/*      */     }
/*  988 */     public short nextShort() { return nextEntry().key; } 
/*  989 */     public short previousShort() { return previousEntry().key; } 
/*      */     void updatePrevious() {
...
/* 1012 */       updatePrevious();
/* 1013 */       updateNext();
/* 1014 */       ShortRBTreeSet.this.remove(this.curr.key);
/* 1015 */       this.curr = null;
/*      */     }
/*      */   }
/*      */ 
