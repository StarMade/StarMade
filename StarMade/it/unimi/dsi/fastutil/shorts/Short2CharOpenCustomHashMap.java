...
/*  18:    */
/*  90:    */public class Short2CharOpenCustomHashMap
/*  91:    */  extends AbstractShort2CharMap
...
/* 104:    */  protected volatile transient Short2CharMap.FastEntrySet entries;
...
/* 108:    */  
/* 109:    */  public Short2CharOpenCustomHashMap(int expected, float f, ShortHash.Strategy strategy)
/* 110:    */  {
...
/* 121:    */  }
/* 122:    */  
/* 126:    */  public Short2CharOpenCustomHashMap(int expected, ShortHash.Strategy strategy)
/* 127:    */  {
/* 128:128 */    this(expected, 0.75F, strategy);
/* 129:    */  }
/* 130:    */  
/* 133:    */  public Short2CharOpenCustomHashMap(ShortHash.Strategy strategy)
/* 134:    */  {
/* 135:135 */    this(16, 0.75F, strategy);
/* 136:    */  }
/* 137:    */  
/* 142:    */  public Short2CharOpenCustomHashMap(Map<? extends Short, ? extends Character> m, float f, ShortHash.Strategy strategy)
/* 143:    */  {
/* 144:144 */    this(m.size(), f, strategy);
/* 145:145 */    putAll(m);
/* 146:    */  }
/* 147:    */  
/* 151:    */  public Short2CharOpenCustomHashMap(Map<? extends Short, ? extends Character> m, ShortHash.Strategy strategy)
/* 152:    */  {
/* 153:153 */    this(m, 0.75F, strategy);
/* 154:    */  }
/* 155:    */  
/* 160:    */  public Short2CharOpenCustomHashMap(Short2CharMap m, float f, ShortHash.Strategy strategy)
/* 161:    */  {
/* 162:162 */    this(m.size(), f, strategy);
/* 163:163 */    putAll(m);
/* 164:    */  }
/* 165:    */  
/* 169:    */  public Short2CharOpenCustomHashMap(Short2CharMap m, ShortHash.Strategy strategy)
/* 170:    */  {
/* 171:171 */    this(m, 0.75F, strategy);
/* 172:    */  }
/* 173:    */  
/* 180:    */  public Short2CharOpenCustomHashMap(short[] k, char[] v, float f, ShortHash.Strategy strategy)
/* 181:    */  {
...
/* 186:    */  }
/* 187:    */  
/* 192:    */  public Short2CharOpenCustomHashMap(short[] k, char[] v, ShortHash.Strategy strategy)
/* 193:    */  {
...
/* 202:    */  }
/* 203:    */  
/* 207:    */  public char put(short k, char v)
/* 208:    */  {
...
/* 225:    */  }
/* 226:    */  
/* 227:227 */  public Character put(Short ok, Character ov) { char v = ov.charValue();
...
/* 269:    */  }
/* 270:    */  
/* 271:    */  public char remove(short k)
/* 272:    */  {
...
/* 302:    */  }
/* 303:    */  
/* 304:304 */  public Character get(Short ok) { short k = ok.shortValue();
/* 305:    */    
...
/* 379:    */    implements Short2CharMap.Entry, Map.Entry<Short, Character>
/* 380:    */  {
...
/* 386:    */    }
/* 387:    */    
/* 388:388 */    public Short getKey() { return Short.valueOf(Short2CharOpenCustomHashMap.this.key[this.index]); }
/* 389:    */    
/* 390:    */    public short getShortKey() {
/* 391:391 */      return Short2CharOpenCustomHashMap.this.key[this.index];
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public Character getValue() { return Character.valueOf(Short2CharOpenCustomHashMap.this.value[this.index]); }
/* 395:    */    
/* 397:397 */    public char getCharValue() { return Short2CharOpenCustomHashMap.this.value[this.index]; }
/* 398:    */    
/* 399:    */    public char setValue(char v) {
/* 400:400 */      char oldValue = Short2CharOpenCustomHashMap.this.value[this.index];
/* 401:401 */      Short2CharOpenCustomHashMap.this.value[this.index] = v;
...
/* 410:410 */      Map.Entry<Short, Character> e = (Map.Entry)o;
/* 411:411 */      return (Short2CharOpenCustomHashMap.this.strategy.equals(Short2CharOpenCustomHashMap.this.key[this.index], ((Short)e.getKey()).shortValue())) && (Short2CharOpenCustomHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 412:    */    }
/* 413:    */    
/* 414:414 */    public int hashCode() { return Short2CharOpenCustomHashMap.this.strategy.hashCode(Short2CharOpenCustomHashMap.this.key[this.index]) ^ Short2CharOpenCustomHashMap.this.value[this.index]; }
/* 415:    */    
/* 417:417 */    public String toString() { return Short2CharOpenCustomHashMap.this.key[this.index] + "=>" + Short2CharOpenCustomHashMap.this.value[this.index]; } }
/* 418:    */  
...
/* 423:    */    
/* 424:424 */    private MapIterator() { this.pos = Short2CharOpenCustomHashMap.this.n;
/* 425:    */      
/* 427:427 */      this.last = -1;
/* 428:    */      
/* 429:429 */      this.c = Short2CharOpenCustomHashMap.this.size;
/* 430:    */      
/* 434:434 */      boolean[] used = Short2CharOpenCustomHashMap.this.used;
...
/* 446:    */        
/* 447:447 */        int pos = HashCommon.murmurHash3(Short2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Short2CharOpenCustomHashMap.this.mask;
/* 448:    */        
/* 449:449 */        while (Short2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 450:450 */          if (Short2CharOpenCustomHashMap.this.strategy.equals(Short2CharOpenCustomHashMap.this.key[pos], k)) return pos;
/* 451:451 */          pos = pos + 1 & Short2CharOpenCustomHashMap.this.mask;
/* 452:    */        }
/* 453:    */      }
/* 454:454 */      this.last = this.pos;
/* 455:    */      
/* 456:456 */      if (this.c != 0) {
/* 457:457 */        boolean[] used = Short2CharOpenCustomHashMap.this.used;
...
/* 472:    */      for (;;)
/* 473:    */      {
/* 474:474 */        pos = (last = pos) + 1 & Short2CharOpenCustomHashMap.this.mask;
/* 475:475 */        while (Short2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 476:476 */          int slot = HashCommon.murmurHash3(Short2CharOpenCustomHashMap.this.strategy.hashCode(Short2CharOpenCustomHashMap.this.key[pos])) & Short2CharOpenCustomHashMap.this.mask;
/* 477:477 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 478:478 */          pos = pos + 1 & Short2CharOpenCustomHashMap.this.mask;
/* 479:    */        }
/* 480:480 */        if (Short2CharOpenCustomHashMap.this.used[pos] == 0) break;
/* 481:481 */        if (pos < last)
/* 482:    */        {
/* 483:483 */          if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 484:484 */          this.wrapped.add(Short2CharOpenCustomHashMap.this.key[pos]);
/* 485:    */        }
/* 486:486 */        Short2CharOpenCustomHashMap.this.key[last] = Short2CharOpenCustomHashMap.this.key[pos];
/* 487:487 */        Short2CharOpenCustomHashMap.this.value[last] = Short2CharOpenCustomHashMap.this.value[pos];
/* 488:    */      }
/* 489:489 */      Short2CharOpenCustomHashMap.this.used[last] = false;
/* 490:490 */      return last;
/* 491:    */    }
/* 492:    */    
...
/* 496:    */      {
/* 497:497 */        Short2CharOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 498:498 */        this.last = -1;
/* 499:499 */        return;
/* 500:    */      }
/* 501:501 */      Short2CharOpenCustomHashMap.this.size -= 1;
...
/* 513:    */    } }
/* 514:    */  
/* 515:515 */  private class EntryIterator extends Short2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Short2CharMap.Entry> { private EntryIterator() { super(null); }
/* 516:    */    
/* 517:    */    private Short2CharOpenCustomHashMap.MapEntry entry;
/* 518:518 */    public Short2CharMap.Entry next() { return this.entry = new Short2CharOpenCustomHashMap.MapEntry(Short2CharOpenCustomHashMap.this, nextEntry()); }
/* 519:    */    
/* 520:    */    public void remove()
/* 521:    */    {
/* 522:522 */      super.remove();
/* 523:523 */      Short2CharOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/* 524:    */    } }
/* 525:    */  
/* 526:526 */  private class FastEntryIterator extends Short2CharOpenCustomHashMap.MapIterator implements ObjectIterator<Short2CharMap.Entry> { private FastEntryIterator() { super(null); }
/* 527:527 */    final AbstractShort2CharMap.BasicEntry entry = new AbstractShort2CharMap.BasicEntry((short)0, '\000');
/* 528:    */    
/* 529:529 */    public AbstractShort2CharMap.BasicEntry next() { int e = nextEntry();
/* 530:530 */      this.entry.key = Short2CharOpenCustomHashMap.this.key[e];
/* 531:531 */      this.entry.value = Short2CharOpenCustomHashMap.this.value[e];
/* 532:532 */      return this.entry;
/* 533:    */    } }
/* 534:    */  
/* 535:    */  private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharMap.FastEntrySet { private MapEntrySet() {}
/* 536:    */    
/* 537:537 */    public ObjectIterator<Short2CharMap.Entry> iterator() { return new Short2CharOpenCustomHashMap.EntryIterator(Short2CharOpenCustomHashMap.this, null); }
/* 538:    */    
/* 539:    */    public ObjectIterator<Short2CharMap.Entry> fastIterator() {
/* 540:540 */      return new Short2CharOpenCustomHashMap.FastEntryIterator(Short2CharOpenCustomHashMap.this, null);
/* 541:    */    }
/* 542:    */    
/* 543:    */    public boolean contains(Object o) {
/* 544:544 */      if (!(o instanceof Map.Entry)) return false;
/* 545:545 */      Map.Entry<Short, Character> e = (Map.Entry)o;
/* 546:546 */      short k = ((Short)e.getKey()).shortValue();
/* 547:    */      
/* 548:548 */      int pos = HashCommon.murmurHash3(Short2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Short2CharOpenCustomHashMap.this.mask;
/* 549:    */      
/* 550:550 */      while (Short2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 551:551 */        if (Short2CharOpenCustomHashMap.this.strategy.equals(Short2CharOpenCustomHashMap.this.key[pos], k)) return Short2CharOpenCustomHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 552:552 */        pos = pos + 1 & Short2CharOpenCustomHashMap.this.mask;
/* 553:    */      }
...
/* 559:559 */      Map.Entry<Short, Character> e = (Map.Entry)o;
/* 560:560 */      short k = ((Short)e.getKey()).shortValue();
/* 561:    */      
/* 562:562 */      int pos = HashCommon.murmurHash3(Short2CharOpenCustomHashMap.this.strategy.hashCode(k)) & Short2CharOpenCustomHashMap.this.mask;
/* 563:    */      
/* 564:564 */      while (Short2CharOpenCustomHashMap.this.used[pos] != 0) {
/* 565:565 */        if (Short2CharOpenCustomHashMap.this.strategy.equals(Short2CharOpenCustomHashMap.this.key[pos], k)) {
/* 566:566 */          Short2CharOpenCustomHashMap.this.remove(e.getKey());
/* 567:567 */          return true;
/* 568:    */        }
/* 569:569 */        pos = pos + 1 & Short2CharOpenCustomHashMap.this.mask;
/* 570:    */      }
/* 571:571 */      return false;
/* 572:    */    }
/* 573:    */    
/* 574:574 */    public int size() { return Short2CharOpenCustomHashMap.this.size; }
/* 575:    */    
/* 577:577 */    public void clear() { Short2CharOpenCustomHashMap.this.clear(); }
/* 578:    */  }
/* 579:    */  
/* 580:    */  public Short2CharMap.FastEntrySet short2CharEntrySet() {
...
/* 588:    */    extends Short2CharOpenCustomHashMap.MapIterator
/* 589:    */    implements ShortIterator
/* 590:    */  {
/* 591:591 */    public KeyIterator() { super(null); }
/* 592:592 */    public short nextShort() { return Short2CharOpenCustomHashMap.this.key[nextEntry()]; }
/* 593:593 */    public Short next() { return Short.valueOf(Short2CharOpenCustomHashMap.this.key[nextEntry()]); } }
/* 594:    */  
/* 595:    */  private final class KeySet extends AbstractShortSet { private KeySet() {}
/* 596:    */    
/* 597:597 */    public ShortIterator iterator() { return new Short2CharOpenCustomHashMap.KeyIterator(Short2CharOpenCustomHashMap.this); }
/* 598:    */    
/* 599:    */    public int size() {
/* 600:600 */      return Short2CharOpenCustomHashMap.this.size;
/* 601:    */    }
/* 602:    */    
/* 603:603 */    public boolean contains(short k) { return Short2CharOpenCustomHashMap.this.containsKey(k); }
/* 604:    */    
/* 605:    */    public boolean remove(short k) {
/* 606:606 */      int oldSize = Short2CharOpenCustomHashMap.this.size;
/* 607:607 */      Short2CharOpenCustomHashMap.this.remove(k);
/* 608:608 */      return Short2CharOpenCustomHashMap.this.size != oldSize;
/* 609:    */    }
/* 610:    */    
/* 611:611 */    public void clear() { Short2CharOpenCustomHashMap.this.clear(); }
/* 612:    */  }
/* 613:    */  
...
/* 622:    */    extends Short2CharOpenCustomHashMap.MapIterator
/* 623:    */    implements CharIterator
/* 624:    */  {
/* 625:625 */    public ValueIterator() { super(null); }
/* 626:626 */    public char nextChar() { return Short2CharOpenCustomHashMap.this.value[nextEntry()]; }
/* 627:627 */    public Character next() { return Character.valueOf(Short2CharOpenCustomHashMap.this.value[nextEntry()]); }
/* 628:    */  }
/* 629:    */  
...
/* 632:632 */          return new Short2CharOpenCustomHashMap.ValueIterator(Short2CharOpenCustomHashMap.this);
/* 633:    */        }
/* 634:    */        
/* 635:635 */        public int size() { return Short2CharOpenCustomHashMap.this.size; }
/* 636:    */        
/* 637:    */        public boolean contains(char v) {
/* 638:638 */          return Short2CharOpenCustomHashMap.this.containsValue(v);
/* 639:    */        }
/* 640:    */        
/* 641:641 */        public void clear() { Short2CharOpenCustomHashMap.this.clear(); }
/* 642:    */      };
/* 643:    */    }
...
/* 744:    */  }
/* 745:    */  
/* 749:    */  public Short2CharOpenCustomHashMap clone()
/* 750:    */  {
/* 751:    */    Short2CharOpenCustomHashMap c;
/* 752:    */    
/* 754:    */    try
/* 755:    */    {
/* 756:756 */      c = (Short2CharOpenCustomHashMap)super.clone();
/* 757:    */    }
