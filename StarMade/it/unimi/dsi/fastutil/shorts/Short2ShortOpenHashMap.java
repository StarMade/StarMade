...
/*  15:    */
/*  87:    */public class Short2ShortOpenHashMap
/*  88:    */  extends AbstractShort2ShortMap
...
/* 101:    */  protected volatile transient Short2ShortMap.FastEntrySet entries;
/* 102:    */  protected volatile transient ShortSet keys;
/* 103:    */  protected volatile transient ShortCollection values;
/* 104:    */  
/* 105:    */  public Short2ShortOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Short2ShortOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Short2ShortOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Short2ShortOpenHashMap(Map<? extends Short, ? extends Short> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Short2ShortOpenHashMap(Map<? extends Short, ? extends Short> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Short2ShortOpenHashMap(Short2ShortMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Short2ShortOpenHashMap(Short2ShortMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Short2ShortOpenHashMap(short[] k, short[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Short2ShortOpenHashMap(short[] k, short[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public short put(short k, short v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Short put(Short ok, Short ov) { short v = ov.shortValue();
...
/* 226:    */  }
/* 227:    */  
/* 238:    */  public short add(short k, short incr)
/* 239:    */  {
...
/* 279:    */  }
/* 280:    */  
/* 281:    */  public short remove(short k)
/* 282:    */  {
...
/* 312:    */  }
/* 313:    */  
/* 314:314 */  public Short get(Short ok) { short k = ok.shortValue();
/* 315:    */    
...
/* 389:    */    implements Short2ShortMap.Entry, Map.Entry<Short, Short>
/* 390:    */  {
...
/* 396:    */    }
/* 397:    */    
/* 398:398 */    public Short getKey() { return Short.valueOf(Short2ShortOpenHashMap.this.key[this.index]); }
/* 399:    */    
/* 400:    */    public short getShortKey() {
/* 401:401 */      return Short2ShortOpenHashMap.this.key[this.index];
/* 402:    */    }
/* 403:    */    
/* 404:404 */    public Short getValue() { return Short.valueOf(Short2ShortOpenHashMap.this.value[this.index]); }
/* 405:    */    
/* 407:407 */    public short getShortValue() { return Short2ShortOpenHashMap.this.value[this.index]; }
/* 408:    */    
/* 409:    */    public short setValue(short v) {
/* 410:410 */      short oldValue = Short2ShortOpenHashMap.this.value[this.index];
/* 411:411 */      Short2ShortOpenHashMap.this.value[this.index] = v;
...
/* 420:420 */      Map.Entry<Short, Short> e = (Map.Entry)o;
/* 421:421 */      return (Short2ShortOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2ShortOpenHashMap.this.value[this.index] == ((Short)e.getValue()).shortValue());
/* 422:    */    }
/* 423:    */    
/* 424:424 */    public int hashCode() { return Short2ShortOpenHashMap.this.key[this.index] ^ Short2ShortOpenHashMap.this.value[this.index]; }
/* 425:    */    
/* 427:427 */    public String toString() { return Short2ShortOpenHashMap.this.key[this.index] + "=>" + Short2ShortOpenHashMap.this.value[this.index]; } }
/* 428:    */  
...
/* 433:    */    
/* 434:434 */    private MapIterator() { this.pos = Short2ShortOpenHashMap.this.n;
/* 435:    */      
/* 437:437 */      this.last = -1;
/* 438:    */      
/* 439:439 */      this.c = Short2ShortOpenHashMap.this.size;
/* 440:    */      
/* 444:444 */      boolean[] used = Short2ShortOpenHashMap.this.used;
...
/* 456:    */        
/* 457:457 */        int pos = HashCommon.murmurHash3(k) & Short2ShortOpenHashMap.this.mask;
/* 458:    */        
/* 459:459 */        while (Short2ShortOpenHashMap.this.used[pos] != 0) {
/* 460:460 */          if (Short2ShortOpenHashMap.this.key[pos] == k) return pos;
/* 461:461 */          pos = pos + 1 & Short2ShortOpenHashMap.this.mask;
/* 462:    */        }
/* 463:    */      }
/* 464:464 */      this.last = this.pos;
/* 465:    */      
/* 466:466 */      if (this.c != 0) {
/* 467:467 */        boolean[] used = Short2ShortOpenHashMap.this.used;
...
/* 482:    */      for (;;)
/* 483:    */      {
/* 484:484 */        pos = (last = pos) + 1 & Short2ShortOpenHashMap.this.mask;
/* 485:485 */        while (Short2ShortOpenHashMap.this.used[pos] != 0) {
/* 486:486 */          int slot = HashCommon.murmurHash3(Short2ShortOpenHashMap.this.key[pos]) & Short2ShortOpenHashMap.this.mask;
/* 487:487 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 488:488 */          pos = pos + 1 & Short2ShortOpenHashMap.this.mask;
/* 489:    */        }
/* 490:490 */        if (Short2ShortOpenHashMap.this.used[pos] == 0) break;
/* 491:491 */        if (pos < last)
/* 492:    */        {
/* 493:493 */          if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 494:494 */          this.wrapped.add(Short2ShortOpenHashMap.this.key[pos]);
/* 495:    */        }
/* 496:496 */        Short2ShortOpenHashMap.this.key[last] = Short2ShortOpenHashMap.this.key[pos];
/* 497:497 */        Short2ShortOpenHashMap.this.value[last] = Short2ShortOpenHashMap.this.value[pos];
/* 498:    */      }
/* 499:499 */      Short2ShortOpenHashMap.this.used[last] = false;
/* 500:500 */      return last;
/* 501:    */    }
/* 502:    */    
...
/* 506:    */      {
/* 507:507 */        Short2ShortOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 508:508 */        this.last = -1;
/* 509:509 */        return;
/* 510:    */      }
/* 511:511 */      Short2ShortOpenHashMap.this.size -= 1;
...
/* 523:    */    } }
/* 524:    */  
/* 525:525 */  private class EntryIterator extends Short2ShortOpenHashMap.MapIterator implements ObjectIterator<Short2ShortMap.Entry> { private EntryIterator() { super(null); }
/* 526:    */    
/* 527:    */    private Short2ShortOpenHashMap.MapEntry entry;
/* 528:528 */    public Short2ShortMap.Entry next() { return this.entry = new Short2ShortOpenHashMap.MapEntry(Short2ShortOpenHashMap.this, nextEntry()); }
/* 529:    */    
/* 530:    */    public void remove()
/* 531:    */    {
/* 532:532 */      super.remove();
/* 533:533 */      Short2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 534:    */    } }
/* 535:    */  
/* 536:536 */  private class FastEntryIterator extends Short2ShortOpenHashMap.MapIterator implements ObjectIterator<Short2ShortMap.Entry> { private FastEntryIterator() { super(null); }
/* 537:537 */    final AbstractShort2ShortMap.BasicEntry entry = new AbstractShort2ShortMap.BasicEntry((short)0, (short)0);
/* 538:    */    
/* 539:539 */    public AbstractShort2ShortMap.BasicEntry next() { int e = nextEntry();
/* 540:540 */      this.entry.key = Short2ShortOpenHashMap.this.key[e];
/* 541:541 */      this.entry.value = Short2ShortOpenHashMap.this.value[e];
/* 542:542 */      return this.entry;
/* 543:    */    } }
/* 544:    */  
/* 545:    */  private final class MapEntrySet extends AbstractObjectSet<Short2ShortMap.Entry> implements Short2ShortMap.FastEntrySet { private MapEntrySet() {}
/* 546:    */    
/* 547:547 */    public ObjectIterator<Short2ShortMap.Entry> iterator() { return new Short2ShortOpenHashMap.EntryIterator(Short2ShortOpenHashMap.this, null); }
/* 548:    */    
/* 549:    */    public ObjectIterator<Short2ShortMap.Entry> fastIterator() {
/* 550:550 */      return new Short2ShortOpenHashMap.FastEntryIterator(Short2ShortOpenHashMap.this, null);
/* 551:    */    }
/* 552:    */    
/* 553:    */    public boolean contains(Object o) {
/* 554:554 */      if (!(o instanceof Map.Entry)) return false;
/* 555:555 */      Map.Entry<Short, Short> e = (Map.Entry)o;
/* 556:556 */      short k = ((Short)e.getKey()).shortValue();
/* 557:    */      
/* 558:558 */      int pos = HashCommon.murmurHash3(k) & Short2ShortOpenHashMap.this.mask;
/* 559:    */      
/* 560:560 */      while (Short2ShortOpenHashMap.this.used[pos] != 0) {
/* 561:561 */        if (Short2ShortOpenHashMap.this.key[pos] == k) return Short2ShortOpenHashMap.this.value[pos] == ((Short)e.getValue()).shortValue();
/* 562:562 */        pos = pos + 1 & Short2ShortOpenHashMap.this.mask;
/* 563:    */      }
...
/* 569:569 */      Map.Entry<Short, Short> e = (Map.Entry)o;
/* 570:570 */      short k = ((Short)e.getKey()).shortValue();
/* 571:    */      
/* 572:572 */      int pos = HashCommon.murmurHash3(k) & Short2ShortOpenHashMap.this.mask;
/* 573:    */      
/* 574:574 */      while (Short2ShortOpenHashMap.this.used[pos] != 0) {
/* 575:575 */        if (Short2ShortOpenHashMap.this.key[pos] == k) {
/* 576:576 */          Short2ShortOpenHashMap.this.remove(e.getKey());
/* 577:577 */          return true;
/* 578:    */        }
/* 579:579 */        pos = pos + 1 & Short2ShortOpenHashMap.this.mask;
/* 580:    */      }
/* 581:581 */      return false;
/* 582:    */    }
/* 583:    */    
/* 584:584 */    public int size() { return Short2ShortOpenHashMap.this.size; }
/* 585:    */    
/* 587:587 */    public void clear() { Short2ShortOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
/* 590:    */  public Short2ShortMap.FastEntrySet short2ShortEntrySet() {
...
/* 598:    */    extends Short2ShortOpenHashMap.MapIterator
/* 599:    */    implements ShortIterator
/* 600:    */  {
/* 601:601 */    public KeyIterator() { super(null); }
/* 602:602 */    public short nextShort() { return Short2ShortOpenHashMap.this.key[nextEntry()]; }
/* 603:603 */    public Short next() { return Short.valueOf(Short2ShortOpenHashMap.this.key[nextEntry()]); } }
/* 604:    */  
/* 605:    */  private final class KeySet extends AbstractShortSet { private KeySet() {}
/* 606:    */    
/* 607:607 */    public ShortIterator iterator() { return new Short2ShortOpenHashMap.KeyIterator(Short2ShortOpenHashMap.this); }
/* 608:    */    
/* 609:    */    public int size() {
/* 610:610 */      return Short2ShortOpenHashMap.this.size;
/* 611:    */    }
/* 612:    */    
/* 613:613 */    public boolean contains(short k) { return Short2ShortOpenHashMap.this.containsKey(k); }
/* 614:    */    
/* 615:    */    public boolean remove(short k) {
/* 616:616 */      int oldSize = Short2ShortOpenHashMap.this.size;
/* 617:617 */      Short2ShortOpenHashMap.this.remove(k);
/* 618:618 */      return Short2ShortOpenHashMap.this.size != oldSize;
/* 619:    */    }
/* 620:    */    
/* 621:621 */    public void clear() { Short2ShortOpenHashMap.this.clear(); }
/* 622:    */  }
/* 623:    */  
...
/* 632:    */    extends Short2ShortOpenHashMap.MapIterator
/* 633:    */    implements ShortIterator
/* 634:    */  {
/* 635:635 */    public ValueIterator() { super(null); }
/* 636:636 */    public short nextShort() { return Short2ShortOpenHashMap.this.value[nextEntry()]; }
/* 637:637 */    public Short next() { return Short.valueOf(Short2ShortOpenHashMap.this.value[nextEntry()]); }
/* 638:    */  }
/* 639:    */  
...
/* 642:642 */          return new Short2ShortOpenHashMap.ValueIterator(Short2ShortOpenHashMap.this);
/* 643:    */        }
/* 644:    */        
/* 645:645 */        public int size() { return Short2ShortOpenHashMap.this.size; }
/* 646:    */        
/* 647:    */        public boolean contains(short v) {
/* 648:648 */          return Short2ShortOpenHashMap.this.containsValue(v);
/* 649:    */        }
/* 650:    */        
/* 651:651 */        public void clear() { Short2ShortOpenHashMap.this.clear(); }
/* 652:    */      };
/* 653:    */    }
...
/* 754:    */  }
/* 755:    */  
/* 759:    */  public Short2ShortOpenHashMap clone()
/* 760:    */  {
/* 761:    */    Short2ShortOpenHashMap c;
/* 762:    */    
/* 764:    */    try
/* 765:    */    {
/* 766:766 */      c = (Short2ShortOpenHashMap)super.clone();
/* 767:    */    }
