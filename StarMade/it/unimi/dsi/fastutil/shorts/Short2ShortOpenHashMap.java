  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2ShortOpenHashMap(int expected, float local_f)
  {
  ...
  public Short2ShortOpenHashMap(Map<? extends Short, ? extends Short> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2ShortOpenHashMap(Map<? extends Short, ? extends Short> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2ShortOpenHashMap(Short2ShortMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2ShortOpenHashMap(Short2ShortMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2ShortOpenHashMap(short[] local_k, short[] local_v, float local_f)
  {
  ...
  public Short2ShortOpenHashMap(short[] local_k, short[] local_v)
  {
  ...
  public ShortCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractShortCollection()
      {
        ...
        {
          return new Short2ShortOpenHashMap.ValueIterator(Short2ShortOpenHashMap.this);
        }
        ...
        {
          return Short2ShortOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2ShortOpenHashMap local_c;
    try
    {
      local_c = (Short2ShortOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Short2ShortOpenHashMap.MapIterator
    implements ShortIterator
  {
    ...
    {
      return Short2ShortOpenHashMap.this.value[nextEntry()];
    }
    
    public Short next()
    {
      return Short.valueOf(Short2ShortOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractShortSet
  {
    ...
    public ShortIterator iterator()
    {
      return new Short2ShortOpenHashMap.KeyIterator(Short2ShortOpenHashMap.this);
    }
    ...
    {
      return Short2ShortOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2ShortOpenHashMap.this.size;
      Short2ShortOpenHashMap.this.remove(local_k);
    ...
    implements ShortIterator
  {
    ...
    public short nextShort()
    {
      return Short2ShortOpenHashMap.this.key[nextEntry()];
    }
    
    public Short next()
    {
      return Short.valueOf(Short2ShortOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Short2ShortMap.FastEntrySet
  {
    ...
    {
      return new Short2ShortOpenHashMap.EntryIterator(Short2ShortOpenHashMap.this, null);
    }
    
    public ObjectIterator<Short2ShortMap.Entry> fastIterator()
    {
      return new Short2ShortOpenHashMap.FastEntryIterator(Short2ShortOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2ShortOpenHashMap.this.mask; Short2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortOpenHashMap.this.mask) {
        if (Short2ShortOpenHashMap.this.key[pos] == local_k) {
          return Short2ShortOpenHashMap.this.value[pos] == ((Short)local_e.getValue()).shortValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2ShortOpenHashMap.this.mask; Short2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortOpenHashMap.this.mask) {
        if (Short2ShortOpenHashMap.this.key[pos] == local_k)
        {
          Short2ShortOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Short2ShortMap.Entry>
  {
    ...
    public AbstractShort2ShortMap.BasicEntry next()
    {
      ...
      this.entry.key = Short2ShortOpenHashMap.this.key[local_e];
      this.entry.value = Short2ShortOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Short2ShortMap.Entry>
  {
    ...
    {
      return this.entry = new Short2ShortOpenHashMap.MapEntry(Short2ShortOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2ShortOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Short2ShortOpenHashMap.this.field_49;
    int last = -1;
    int field_2128 = Short2ShortOpenHashMap.this.size;
    ShortArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Short2ShortOpenHashMap.this.used;
      while ((this.field_2128 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_2128 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_2128 != 0)
      {
        boolean[] local_k = Short2ShortOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2ShortOpenHashMap.this.mask; Short2ShortOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ShortOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Short2ShortOpenHashMap.this.key[pos]) & Short2ShortOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Short2ShortOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
          ...
          this.wrapped.add(Short2ShortOpenHashMap.this.key[pos]);
        }
        Short2ShortOpenHashMap.this.key[last] = Short2ShortOpenHashMap.this.key[pos];
        Short2ShortOpenHashMap.this.value[last] = Short2ShortOpenHashMap.this.value[pos];
      }
      Short2ShortOpenHashMap.this.used[last] = false;
      return last;
    }
    ...
    public void remove()
    {
      ...
      if (this.pos < -1)
      {
        Short2ShortOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
        this.last = -1;
        return;
      }
      Short2ShortOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_2128 > 0))
      {
        this.field_2128 += 1;
        nextEntry();
      }
    ...
    implements Short2ShortMap.Entry, Map.Entry<Short, Short>
  {
    ...
    public Short getKey()
    {
      return Short.valueOf(Short2ShortOpenHashMap.this.key[this.index]);
    }
    ...
    {
      return Short.valueOf(Short2ShortOpenHashMap.this.value[this.index]);
    }
    ...
    public short setValue(short local_v)
    {
      ...
      Short2ShortOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, Short> local_e = (Map.Entry)local_o;
      return (Short2ShortOpenHashMap.this.key[this.index] == ((Short)local_e.getKey()).shortValue()) && (Short2ShortOpenHashMap.this.value[this.index] == ((Short)local_e.getValue()).shortValue());
    }
