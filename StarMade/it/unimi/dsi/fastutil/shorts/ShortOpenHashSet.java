...
/*  13:    */
/*  78:    */public class ShortOpenHashSet
/*  79:    */  extends AbstractShortSet
...
/*  84:    */  protected transient short[] key;
...
/*  91:    */  
/*  92:    */  public ShortOpenHashSet(int expected, float f)
/*  93:    */  {
...
/* 100:100 */    this.key = new short[this.n];
/* 101:101 */    this.used = new boolean[this.n];
/* 102:    */  }
/* 103:    */  
/* 106:    */  public ShortOpenHashSet(int expected)
/* 107:    */  {
/* 108:108 */    this(expected, 0.75F);
/* 109:    */  }
/* 110:    */  
/* 112:    */  public ShortOpenHashSet()
/* 113:    */  {
/* 114:114 */    this(16, 0.75F);
/* 115:    */  }
/* 116:    */  
/* 120:    */  public ShortOpenHashSet(Collection<? extends Short> c, float f)
/* 121:    */  {
/* 122:122 */    this(c.size(), f);
/* 123:123 */    addAll(c);
/* 124:    */  }
/* 125:    */  
/* 129:    */  public ShortOpenHashSet(Collection<? extends Short> c)
/* 130:    */  {
/* 131:131 */    this(c, 0.75F);
/* 132:    */  }
/* 133:    */  
/* 137:    */  public ShortOpenHashSet(ShortCollection c, float f)
/* 138:    */  {
/* 139:139 */    this(c.size(), f);
/* 140:140 */    addAll(c);
/* 141:    */  }
/* 142:    */  
/* 146:    */  public ShortOpenHashSet(ShortCollection c)
/* 147:    */  {
/* 148:148 */    this(c, 0.75F);
/* 149:    */  }
/* 150:    */  
/* 154:    */  public ShortOpenHashSet(ShortIterator i, float f)
/* 155:    */  {
/* 156:156 */    this(16, f);
/* 157:157 */    while (i.hasNext()) { add(i.nextShort());
/* 158:    */    }
/* 159:    */  }
/* 160:    */  
/* 162:    */  public ShortOpenHashSet(ShortIterator i)
/* 163:    */  {
/* 164:164 */    this(i, 0.75F);
/* 165:    */  }
/* 166:    */  
/* 170:    */  public ShortOpenHashSet(Iterator<?> i, float f)
/* 171:    */  {
/* 172:172 */    this(ShortIterators.asShortIterator(i), f);
/* 173:    */  }
/* 174:    */  
/* 177:    */  public ShortOpenHashSet(Iterator<?> i)
/* 178:    */  {
/* 179:179 */    this(ShortIterators.asShortIterator(i));
/* 180:    */  }
/* 181:    */  
/* 187:    */  public ShortOpenHashSet(short[] a, int offset, int length, float f)
/* 188:    */  {
/* 189:189 */    this(length < 0 ? 0 : length, f);
/* 190:190 */    ShortArrays.ensureOffsetLength(a, offset, length);
/* 191:191 */    for (int i = 0; i < length; i++) { add(a[(offset + i)]);
/* 192:    */    }
/* 193:    */  }
/* 194:    */  
/* 198:    */  public ShortOpenHashSet(short[] a, int offset, int length)
/* 199:    */  {
/* 200:200 */    this(a, offset, length, 0.75F);
/* 201:    */  }
/* 202:    */  
/* 206:    */  public ShortOpenHashSet(short[] a, float f)
/* 207:    */  {
/* 208:208 */    this(a, 0, a.length, f);
/* 209:    */  }
/* 210:    */  
/* 214:    */  public ShortOpenHashSet(short[] a)
/* 215:    */  {
/* 216:216 */    this(a, 0.75F);
/* 217:    */  }
/* 218:    */  
/* 222:    */  public boolean add(short k)
/* 223:    */  {
...
/* 257:    */  }
/* 258:    */  
/* 259:    */  public boolean remove(short k)
/* 260:    */  {
...
/* 273:    */  }
/* 274:    */  
/* 275:    */  public boolean contains(short k)
/* 276:    */  {
...
/* 318:    */  
/* 319:    */  private class SetIterator extends AbstractShortIterator {
/* 320:    */    int pos;
/* 321:    */    int last;
/* 322:    */    
/* 323:323 */    private SetIterator() { this.pos = ShortOpenHashSet.this.n;
/* 324:    */      
/* 326:326 */      this.last = -1;
/* 327:    */      
/* 328:328 */      this.c = ShortOpenHashSet.this.size;
/* 329:    */      
/* 333:333 */      boolean[] used = ShortOpenHashSet.this.used;
/* 334:334 */      while ((this.c != 0) && (used[(--this.pos)] == 0)) {}
/* 335:    */    }
/* 336:    */    
/* 337:337 */    public boolean hasNext() { return this.c != 0; }
/* 338:    */    
/* 339:    */    public short nextShort() {
/* 340:340 */      if (!hasNext()) throw new NoSuchElementException();
/* 341:341 */      this.c -= 1;
/* 342:    */      
/* 343:343 */      if (this.pos < 0) return this.wrapped.getShort(-(this.last = --this.pos) - 2);
/* 344:344 */      short retVal = ShortOpenHashSet.this.key[(this.last = this.pos)];
/* 345:    */      
/* 346:346 */      if (this.c != 0) {
/* 347:347 */        boolean[] used = ShortOpenHashSet.this.used;
...
/* 362:    */      for (;;)
/* 363:    */      {
/* 364:364 */        pos = (last = pos) + 1 & ShortOpenHashSet.this.mask;
/* 365:365 */        while (ShortOpenHashSet.this.used[pos] != 0) {
/* 366:366 */          int slot = HashCommon.murmurHash3(ShortOpenHashSet.this.key[pos]) & ShortOpenHashSet.this.mask;
/* 367:367 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 368:368 */          pos = pos + 1 & ShortOpenHashSet.this.mask;
/* 369:    */        }
/* 370:370 */        if (ShortOpenHashSet.this.used[pos] == 0) break;
/* 371:371 */        if (pos < last)
/* 372:    */        {
/* 373:373 */          if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 374:374 */          this.wrapped.add(ShortOpenHashSet.this.key[pos]);
/* 375:    */        }
/* 376:376 */        ShortOpenHashSet.this.key[last] = ShortOpenHashSet.this.key[pos];
/* 377:    */      }
/* 378:378 */      ShortOpenHashSet.this.used[last] = false;
/* 379:379 */      return last;
/* 380:    */    }
/* 381:    */    
...
/* 385:    */      {
/* 386:386 */        ShortOpenHashSet.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 387:387 */        this.last = -1;
/* 388:388 */        return;
/* 389:    */      }
/* 390:390 */      ShortOpenHashSet.this.size -= 1;
...
/* 397:    */  }
/* 398:    */  
/* 399:    */  public ShortIterator iterator() {
...
/* 496:    */  }
/* 497:    */  
/* 501:    */  public ShortOpenHashSet clone()
/* 502:    */  {
/* 503:    */    ShortOpenHashSet c;
/* 504:    */    
/* 506:    */    try
/* 507:    */    {
/* 508:508 */      c = (ShortOpenHashSet)super.clone();
/* 509:    */    }
/* 510:    */    catch (CloneNotSupportedException cantHappen) {
/* 511:511 */      throw new InternalError();
/* 512:    */    }
/* 513:513 */    c.key = ((short[])this.key.clone());
...
/* 534:    */  }
/* 535:    */  
/* 536:536 */  private void writeObject(ObjectOutputStream s) throws IOException { ShortIterator i = iterator();
/* 537:537 */    s.defaultWriteObject();
/* 538:538 */    for (int j = this.size; j-- != 0; s.writeShort(i.nextShort())) {}
/* 539:    */  }
/* 540:    */  
