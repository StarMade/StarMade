...
/*     */   public static Short2ShortMap singleton(Short key, Short value)
/*     */   {
/* 200 */     return new Singleton(key.shortValue(), value.shortValue());
/*     */   }
/*     */ 
...
/*     */     }
/* 322 */     public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.unmodifiable(this.map.short2ShortEntrySet()); return this.entries; } 
...
/* 335 */     public short get(short k) { return this.map.get(k); } 
...
/* 349 */     public ObjectSet<Map.Entry<Short, Short>> entrySet() { return ObjectSets.unmodifiable(this.map.entrySet()); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/*     */ 
/* 238 */     public void putAll(Map<? extends Short, ? extends Short> m) { synchronized (this.sync) { this.map.putAll(m); }  } 
/*     */     public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() {
/* 240 */       if (this.entries == null) this.entries = ObjectSets.synchronize(this.map.short2ShortEntrySet(), this.sync); return this.entries; } 
...
/* 253 */     public short get(short k) { synchronized (this.sync) { return this.map.get(k); }  } 
...
/* 267 */     public ObjectSet<Map.Entry<Short, Short>> entrySet() { synchronized (this.sync) { return this.map.entrySet(); }  } 
/*     */     public int hashCode() {
...
/*     */     }
/* 126 */     public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() { if (this.entries == null) this.entries = ObjectSets.singleton(new SingletonEntry()); return this.entries; } 
...
/* 159 */       return short2ShortEntrySet();
/*     */     }
...
/*     */       public Short getKey()
/*     */       {
/* 131 */         return Short.valueOf(Short2ShortMaps.Singleton.this.key); } 
/* 132 */       public Short getValue() { return Short.valueOf(Short2ShortMaps.Singleton.this.value); }
/*     */ 
/*     */       public short getShortKey() {
/* 135 */         return Short2ShortMaps.Singleton.this.key;
/*     */       }
/*     */ 
/*     */       public short getShortValue() {
/* 139 */         return Short2ShortMaps.Singleton.this.value; } 
...
/*     */ 
/* 149 */         return (Short2ShortMaps.Singleton.this.key == ((Short)e.getKey()).shortValue()) && (Short2ShortMaps.Singleton.this.value == ((Short)e.getValue()).shortValue());
/*     */       }
/*     */       public int hashCode() {
/* 152 */         return Short2ShortMaps.Singleton.this.key ^ Short2ShortMaps.Singleton.this.value; } 
/* 153 */       public String toString() { return Short2ShortMaps.Singleton.this.key + "->" + Short2ShortMaps.Singleton.this.value; }
/*     */ 
/*     */     }
/*     */   }
/*     */ 
...
/*     */     {
/*  67 */       return false; } 
/*  68 */     public void putAll(Map<? extends Short, ? extends Short> m) { throw new UnsupportedOperationException(); } 
/*     */     public ObjectSet<Short2ShortMap.Entry> short2ShortEntrySet() {
...
/*  76 */     private Object readResolve() { return Short2ShortMaps.EMPTY_MAP; } 
/*  77 */     public Object clone() { return Short2ShortMaps.EMPTY_MAP; } 
/*  78 */     public boolean isEmpty() { return true; } 
/*     */     public ObjectSet<Map.Entry<Short, Short>> entrySet() {
/*  80 */       return short2ShortEntrySet();
/*     */     }
