...
/*     */   {
/* 173 */     return new Singleton(key.shortValue(), value.intValue());
/*     */   }
/*     */ 
/*     */   public static Short2IntSortedMap singleton(Short key, Integer value, ShortComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.shortValue(), value.intValue(), comparator);
/*     */   }
/*     */ 
...
/*     */     }
/* 302 */     public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.short2IntEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Integer>> entrySet() {
/* 304 */       return short2IntEntrySet(); } 
...
/* 308 */     public Short2IntSortedMap headMap(short to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Short2IntSortedMap tailMap(short from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Short2IntSortedMap headMap(Short to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Short2IntSortedMap tailMap(Short from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.short2IntEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Integer>> entrySet() {
/* 244 */       return short2IntEntrySet(); } 
...
/* 248 */     public Short2IntSortedMap headMap(short to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Short2IntSortedMap tailMap(short from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public short firstShortKey() {
...
/* 259 */     public Short2IntSortedMap headMap(Short to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Short2IntSortedMap tailMap(Short from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Short2IntMaps.Singleton.SingletonEntry(this), Short2IntSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Short, Integer>> entrySet() { return short2IntEntrySet(); } 
/*     */     public ShortSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = ShortSortedSets.singleton(this.key, this.comparator); return (ShortSortedSet)this.keys;
/*     */     }
/*     */     public Short2IntSortedMap subMap(short from, short to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Short2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Short2IntSortedMap headMap(short to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Short2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Short2IntSortedMap tailMap(short from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Short2IntSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Short2IntSortedMap tailMap(Short ofrom) { return tailMap(ofrom.shortValue()); } 
/* 156 */     public Short2IntSortedMap subMap(Short ofrom, Short oto) { return subMap(ofrom.shortValue(), oto.shortValue()); } 
/*     */     public Short firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Integer>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public ShortSortedSet keySet() { return ShortSortedSets.EMPTY_SET; } 
/*     */     public Short2IntSortedMap subMap(short from, short to) {
/*  86 */       return Short2IntSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Short2IntSortedMap headMap(short to) { return Short2IntSortedMaps.EMPTY_MAP; } 
/*     */     public Short2IntSortedMap tailMap(short from) {
/*  90 */       return Short2IntSortedMaps.EMPTY_MAP; } 
...
/*  93 */     public Short2IntSortedMap headMap(Short oto) { return headMap(oto.shortValue()); } 
/*  94 */     public Short2IntSortedMap tailMap(Short ofrom) { return tailMap(ofrom.shortValue()); } 
/*  95 */     public Short2IntSortedMap subMap(Short ofrom, Short oto) { return subMap(ofrom.shortValue(), oto.shortValue()); } 
