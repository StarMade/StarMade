...
/*  18:    */
/*  87:    */public class Short2CharOpenHashMap
/*  88:    */  extends AbstractShort2CharMap
...
/* 101:    */  protected volatile transient Short2CharMap.FastEntrySet entries;
/* 102:    */  protected volatile transient ShortSet keys;
/* 103:    */  protected volatile transient CharCollection values;
/* 104:    */  
/* 105:    */  public Short2CharOpenHashMap(int expected, float f)
/* 106:    */  {
...
/* 116:    */  }
/* 117:    */  
/* 120:    */  public Short2CharOpenHashMap(int expected)
/* 121:    */  {
/* 122:122 */    this(expected, 0.75F);
/* 123:    */  }
/* 124:    */  
/* 126:    */  public Short2CharOpenHashMap()
/* 127:    */  {
/* 128:128 */    this(16, 0.75F);
/* 129:    */  }
/* 130:    */  
/* 134:    */  public Short2CharOpenHashMap(Map<? extends Short, ? extends Character> m, float f)
/* 135:    */  {
/* 136:136 */    this(m.size(), f);
/* 137:137 */    putAll(m);
/* 138:    */  }
/* 139:    */  
/* 142:    */  public Short2CharOpenHashMap(Map<? extends Short, ? extends Character> m)
/* 143:    */  {
/* 144:144 */    this(m, 0.75F);
/* 145:    */  }
/* 146:    */  
/* 150:    */  public Short2CharOpenHashMap(Short2CharMap m, float f)
/* 151:    */  {
/* 152:152 */    this(m.size(), f);
/* 153:153 */    putAll(m);
/* 154:    */  }
/* 155:    */  
/* 158:    */  public Short2CharOpenHashMap(Short2CharMap m)
/* 159:    */  {
/* 160:160 */    this(m, 0.75F);
/* 161:    */  }
/* 162:    */  
/* 168:    */  public Short2CharOpenHashMap(short[] k, char[] v, float f)
/* 169:    */  {
...
/* 174:    */  }
/* 175:    */  
/* 179:    */  public Short2CharOpenHashMap(short[] k, char[] v)
/* 180:    */  {
/* 181:181 */    this(k, v, 0.75F);
/* 182:    */  }
/* 183:    */  
/* 187:    */  public char put(short k, char v)
/* 188:    */  {
...
/* 205:    */  }
/* 206:    */  
/* 207:207 */  public Character put(Short ok, Character ov) { char v = ov.charValue();
...
/* 249:    */  }
/* 250:    */  
/* 251:    */  public char remove(short k)
/* 252:    */  {
...
/* 282:    */  }
/* 283:    */  
/* 284:284 */  public Character get(Short ok) { short k = ok.shortValue();
/* 285:    */    
...
/* 359:    */    implements Short2CharMap.Entry, Map.Entry<Short, Character>
/* 360:    */  {
...
/* 366:    */    }
/* 367:    */    
/* 368:368 */    public Short getKey() { return Short.valueOf(Short2CharOpenHashMap.this.key[this.index]); }
/* 369:    */    
/* 370:    */    public short getShortKey() {
/* 371:371 */      return Short2CharOpenHashMap.this.key[this.index];
/* 372:    */    }
/* 373:    */    
/* 374:374 */    public Character getValue() { return Character.valueOf(Short2CharOpenHashMap.this.value[this.index]); }
/* 375:    */    
/* 377:377 */    public char getCharValue() { return Short2CharOpenHashMap.this.value[this.index]; }
/* 378:    */    
/* 379:    */    public char setValue(char v) {
/* 380:380 */      char oldValue = Short2CharOpenHashMap.this.value[this.index];
/* 381:381 */      Short2CharOpenHashMap.this.value[this.index] = v;
...
/* 390:390 */      Map.Entry<Short, Character> e = (Map.Entry)o;
/* 391:391 */      return (Short2CharOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2CharOpenHashMap.this.value[this.index] == ((Character)e.getValue()).charValue());
/* 392:    */    }
/* 393:    */    
/* 394:394 */    public int hashCode() { return Short2CharOpenHashMap.this.key[this.index] ^ Short2CharOpenHashMap.this.value[this.index]; }
/* 395:    */    
/* 397:397 */    public String toString() { return Short2CharOpenHashMap.this.key[this.index] + "=>" + Short2CharOpenHashMap.this.value[this.index]; } }
/* 398:    */  
...
/* 403:    */    
/* 404:404 */    private MapIterator() { this.pos = Short2CharOpenHashMap.this.n;
/* 405:    */      
/* 407:407 */      this.last = -1;
/* 408:    */      
/* 409:409 */      this.c = Short2CharOpenHashMap.this.size;
/* 410:    */      
/* 414:414 */      boolean[] used = Short2CharOpenHashMap.this.used;
...
/* 426:    */        
/* 427:427 */        int pos = HashCommon.murmurHash3(k) & Short2CharOpenHashMap.this.mask;
/* 428:    */        
/* 429:429 */        while (Short2CharOpenHashMap.this.used[pos] != 0) {
/* 430:430 */          if (Short2CharOpenHashMap.this.key[pos] == k) return pos;
/* 431:431 */          pos = pos + 1 & Short2CharOpenHashMap.this.mask;
/* 432:    */        }
/* 433:    */      }
/* 434:434 */      this.last = this.pos;
/* 435:    */      
/* 436:436 */      if (this.c != 0) {
/* 437:437 */        boolean[] used = Short2CharOpenHashMap.this.used;
...
/* 452:    */      for (;;)
/* 453:    */      {
/* 454:454 */        pos = (last = pos) + 1 & Short2CharOpenHashMap.this.mask;
/* 455:455 */        while (Short2CharOpenHashMap.this.used[pos] != 0) {
/* 456:456 */          int slot = HashCommon.murmurHash3(Short2CharOpenHashMap.this.key[pos]) & Short2CharOpenHashMap.this.mask;
/* 457:457 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 458:458 */          pos = pos + 1 & Short2CharOpenHashMap.this.mask;
/* 459:    */        }
/* 460:460 */        if (Short2CharOpenHashMap.this.used[pos] == 0) break;
/* 461:461 */        if (pos < last)
/* 462:    */        {
/* 463:463 */          if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 464:464 */          this.wrapped.add(Short2CharOpenHashMap.this.key[pos]);
/* 465:    */        }
/* 466:466 */        Short2CharOpenHashMap.this.key[last] = Short2CharOpenHashMap.this.key[pos];
/* 467:467 */        Short2CharOpenHashMap.this.value[last] = Short2CharOpenHashMap.this.value[pos];
/* 468:    */      }
/* 469:469 */      Short2CharOpenHashMap.this.used[last] = false;
/* 470:470 */      return last;
/* 471:    */    }
/* 472:    */    
...
/* 476:    */      {
/* 477:477 */        Short2CharOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 478:478 */        this.last = -1;
/* 479:479 */        return;
/* 480:    */      }
/* 481:481 */      Short2CharOpenHashMap.this.size -= 1;
...
/* 493:    */    } }
/* 494:    */  
/* 495:495 */  private class EntryIterator extends Short2CharOpenHashMap.MapIterator implements ObjectIterator<Short2CharMap.Entry> { private EntryIterator() { super(null); }
/* 496:    */    
/* 497:    */    private Short2CharOpenHashMap.MapEntry entry;
/* 498:498 */    public Short2CharMap.Entry next() { return this.entry = new Short2CharOpenHashMap.MapEntry(Short2CharOpenHashMap.this, nextEntry()); }
/* 499:    */    
/* 500:    */    public void remove()
/* 501:    */    {
/* 502:502 */      super.remove();
/* 503:503 */      Short2CharOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 504:    */    } }
/* 505:    */  
/* 506:506 */  private class FastEntryIterator extends Short2CharOpenHashMap.MapIterator implements ObjectIterator<Short2CharMap.Entry> { private FastEntryIterator() { super(null); }
/* 507:507 */    final AbstractShort2CharMap.BasicEntry entry = new AbstractShort2CharMap.BasicEntry((short)0, '\000');
/* 508:    */    
/* 509:509 */    public AbstractShort2CharMap.BasicEntry next() { int e = nextEntry();
/* 510:510 */      this.entry.key = Short2CharOpenHashMap.this.key[e];
/* 511:511 */      this.entry.value = Short2CharOpenHashMap.this.value[e];
/* 512:512 */      return this.entry;
/* 513:    */    } }
/* 514:    */  
/* 515:    */  private final class MapEntrySet extends AbstractObjectSet<Short2CharMap.Entry> implements Short2CharMap.FastEntrySet { private MapEntrySet() {}
/* 516:    */    
/* 517:517 */    public ObjectIterator<Short2CharMap.Entry> iterator() { return new Short2CharOpenHashMap.EntryIterator(Short2CharOpenHashMap.this, null); }
/* 518:    */    
/* 519:    */    public ObjectIterator<Short2CharMap.Entry> fastIterator() {
/* 520:520 */      return new Short2CharOpenHashMap.FastEntryIterator(Short2CharOpenHashMap.this, null);
/* 521:    */    }
/* 522:    */    
/* 523:    */    public boolean contains(Object o) {
/* 524:524 */      if (!(o instanceof Map.Entry)) return false;
/* 525:525 */      Map.Entry<Short, Character> e = (Map.Entry)o;
/* 526:526 */      short k = ((Short)e.getKey()).shortValue();
/* 527:    */      
/* 528:528 */      int pos = HashCommon.murmurHash3(k) & Short2CharOpenHashMap.this.mask;
/* 529:    */      
/* 530:530 */      while (Short2CharOpenHashMap.this.used[pos] != 0) {
/* 531:531 */        if (Short2CharOpenHashMap.this.key[pos] == k) return Short2CharOpenHashMap.this.value[pos] == ((Character)e.getValue()).charValue();
/* 532:532 */        pos = pos + 1 & Short2CharOpenHashMap.this.mask;
/* 533:    */      }
...
/* 539:539 */      Map.Entry<Short, Character> e = (Map.Entry)o;
/* 540:540 */      short k = ((Short)e.getKey()).shortValue();
/* 541:    */      
/* 542:542 */      int pos = HashCommon.murmurHash3(k) & Short2CharOpenHashMap.this.mask;
/* 543:    */      
/* 544:544 */      while (Short2CharOpenHashMap.this.used[pos] != 0) {
/* 545:545 */        if (Short2CharOpenHashMap.this.key[pos] == k) {
/* 546:546 */          Short2CharOpenHashMap.this.remove(e.getKey());
/* 547:547 */          return true;
/* 548:    */        }
/* 549:549 */        pos = pos + 1 & Short2CharOpenHashMap.this.mask;
/* 550:    */      }
/* 551:551 */      return false;
/* 552:    */    }
/* 553:    */    
/* 554:554 */    public int size() { return Short2CharOpenHashMap.this.size; }
/* 555:    */    
/* 557:557 */    public void clear() { Short2CharOpenHashMap.this.clear(); }
/* 558:    */  }
/* 559:    */  
/* 560:    */  public Short2CharMap.FastEntrySet short2CharEntrySet() {
...
/* 568:    */    extends Short2CharOpenHashMap.MapIterator
/* 569:    */    implements ShortIterator
/* 570:    */  {
/* 571:571 */    public KeyIterator() { super(null); }
/* 572:572 */    public short nextShort() { return Short2CharOpenHashMap.this.key[nextEntry()]; }
/* 573:573 */    public Short next() { return Short.valueOf(Short2CharOpenHashMap.this.key[nextEntry()]); } }
/* 574:    */  
/* 575:    */  private final class KeySet extends AbstractShortSet { private KeySet() {}
/* 576:    */    
/* 577:577 */    public ShortIterator iterator() { return new Short2CharOpenHashMap.KeyIterator(Short2CharOpenHashMap.this); }
/* 578:    */    
/* 579:    */    public int size() {
/* 580:580 */      return Short2CharOpenHashMap.this.size;
/* 581:    */    }
/* 582:    */    
/* 583:583 */    public boolean contains(short k) { return Short2CharOpenHashMap.this.containsKey(k); }
/* 584:    */    
/* 585:    */    public boolean remove(short k) {
/* 586:586 */      int oldSize = Short2CharOpenHashMap.this.size;
/* 587:587 */      Short2CharOpenHashMap.this.remove(k);
/* 588:588 */      return Short2CharOpenHashMap.this.size != oldSize;
/* 589:    */    }
/* 590:    */    
/* 591:591 */    public void clear() { Short2CharOpenHashMap.this.clear(); }
/* 592:    */  }
/* 593:    */  
...
/* 602:    */    extends Short2CharOpenHashMap.MapIterator
/* 603:    */    implements CharIterator
/* 604:    */  {
/* 605:605 */    public ValueIterator() { super(null); }
/* 606:606 */    public char nextChar() { return Short2CharOpenHashMap.this.value[nextEntry()]; }
/* 607:607 */    public Character next() { return Character.valueOf(Short2CharOpenHashMap.this.value[nextEntry()]); }
/* 608:    */  }
/* 609:    */  
...
/* 612:612 */          return new Short2CharOpenHashMap.ValueIterator(Short2CharOpenHashMap.this);
/* 613:    */        }
/* 614:    */        
/* 615:615 */        public int size() { return Short2CharOpenHashMap.this.size; }
/* 616:    */        
/* 617:    */        public boolean contains(char v) {
/* 618:618 */          return Short2CharOpenHashMap.this.containsValue(v);
/* 619:    */        }
/* 620:    */        
/* 621:621 */        public void clear() { Short2CharOpenHashMap.this.clear(); }
/* 622:    */      };
/* 623:    */    }
...
/* 724:    */  }
/* 725:    */  
/* 729:    */  public Short2CharOpenHashMap clone()
/* 730:    */  {
/* 731:    */    Short2CharOpenHashMap c;
/* 732:    */    
/* 734:    */    try
/* 735:    */    {
/* 736:736 */      c = (Short2CharOpenHashMap)super.clone();
/* 737:    */    }
