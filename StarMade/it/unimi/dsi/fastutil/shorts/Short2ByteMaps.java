...
public class Short2ByteMaps
{
  ...
  public static Short2ByteMap synchronize(Short2ByteMap local_m)
  {
    return new SynchronizedMap(local_m);
  }
  
  public static Short2ByteMap synchronize(Short2ByteMap local_m, Object sync)
  {
    return new SynchronizedMap(local_m, sync);
  }
  
  public static Short2ByteMap unmodifiable(Short2ByteMap local_m)
  {
    ...
    implements Short2ByteMap, Serializable
  {
    ...
    protected UnmodifiableMap(Short2ByteMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Short2ByteMap, Serializable
  {
    ...
    protected SynchronizedMap(Short2ByteMap local_m, Object sync)
    {
      super(sync);
      this.map = local_m;
    }
    
    protected SynchronizedMap(Short2ByteMap local_m)
    {
      super();
      this.map = local_m;
    }
    ...
    implements Short2ByteMap, Serializable, Cloneable
  {
      ...
      implements Short2ByteMap.Entry, Map.Entry<Short, Byte>
    {
      ...
      public Short getKey()
      {
        return Short.valueOf(Short2ByteMaps.Singleton.this.key);
      }
      
      public Byte getValue()
      {
        return Byte.valueOf(Short2ByteMaps.Singleton.this.value);
      }
      
      public short getShortKey()
      {
        return Short2ByteMaps.Singleton.this.key;
      }
      
      public byte getByteValue()
      {
        return Short2ByteMaps.Singleton.this.value;
      }
      ...
      public boolean equals(Object local_o)
      {
        ...
        return (Short2ByteMaps.Singleton.this.key == ((Short)local_e.getKey()).shortValue()) && (Short2ByteMaps.Singleton.this.value == ((Byte)local_e.getValue()).byteValue());
      }
      
      public int hashCode()
      {
        return Short2ByteMaps.Singleton.this.key ^ Short2ByteMaps.Singleton.this.value;
      }
