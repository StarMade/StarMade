  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2ReferenceRBTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2ReferenceRBTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2ReferenceRBTreeMap(Map<? extends Short, ? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ReferenceRBTreeMap(SortedMap<Short, V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ReferenceRBTreeMap(Short2ReferenceMap<? extends V> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2ReferenceRBTreeMap(Short2ReferenceSortedMap<V> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2ReferenceRBTreeMap(short[] local_k, V[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2ReferenceRBTreeMap(short[] local_k, V[] local_v)
  {
  ...
  {
    Short2ReferenceRBTreeMap<V>.ValueIterator local_i = new ValueIterator(null);
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2ReferenceMap.Entry<V>> comparator = new Comparator()
        {
          ...
          {
            return Short2ReferenceRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2ReferenceRBTreeMap.EntryIterator(Short2ReferenceRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> from)
        {
          return new Short2ReferenceRBTreeMap.EntryIterator(Short2ReferenceRBTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2ReferenceRBTreeMap.Entry<V> local_f = Short2ReferenceRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2ReferenceRBTreeMap.Entry<V> local_f = Short2ReferenceRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2ReferenceRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2ReferenceRBTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Short2ReferenceMap.Entry<V>> headSet(Short2ReferenceMap.Entry<V> local_to)
        {
          return Short2ReferenceRBTreeMap.this.headMap((Short)local_to.getKey()).short2ReferenceEntrySet();
        }
        
        public ObjectSortedSet<Short2ReferenceMap.Entry<V>> tailSet(Short2ReferenceMap.Entry<V> from)
        {
          return Short2ReferenceRBTreeMap.this.tailMap((Short)from.getKey()).short2ReferenceEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public ReferenceCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractReferenceCollection()
      {
        ...
        {
          return new Short2ReferenceRBTreeMap.ValueIterator(Short2ReferenceRBTreeMap.this, null);
        }
        
        public boolean contains(Object local_k)
        {
          return Short2ReferenceRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2ReferenceRBTreeMap<V> local_c;
    try
    {
      local_c = (Short2ReferenceRBTreeMap)super.clone();
    }
    ...
    throws IOException
  {
    ...
    Short2ReferenceRBTreeMap<V>.EntryIterator local_i = new EntryIterator();
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2ReferenceRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    public void clear()
    {
      Short2ReferenceRBTreeMap<V>.Submap.SubmapIterator local_i = new SubmapIterator();
    ...
    {
      return ((this.bottom) || (Short2ReferenceRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2ReferenceRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator()
          {
            return new Short2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Short2ReferenceRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> from)
          {
            return new Short2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Short2ReferenceRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, V> local_e = (Map.Entry)local_o;
            Short2ReferenceRBTreeMap.Entry<V> local_f = Short2ReferenceRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2ReferenceRBTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, V> local_e = (Map.Entry)local_o;
            Short2ReferenceRBTreeMap.Entry<V> local_f = Short2ReferenceRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2ReferenceRBTreeMap.Submap.this.in6(local_f.key))) {
              Short2ReferenceRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2ReferenceRBTreeMap.Submap.SubmapIterator(Short2ReferenceRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2ReferenceRBTreeMap.Submap.this.clear();
          }
          
          public Short2ReferenceMap.Entry<V> first()
          {
            return Short2ReferenceRBTreeMap.Submap.this.firstEntry();
          }
          
          public Short2ReferenceMap.Entry<V> last()
          {
            return Short2ReferenceRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2ReferenceMap.Entry<V>> subSet(Short2ReferenceMap.Entry<V> from, Short2ReferenceMap.Entry<V> local_to)
          {
            return Short2ReferenceRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Short2ReferenceMap.Entry<V>> headSet(Short2ReferenceMap.Entry<V> local_to)
          {
            return Short2ReferenceRBTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2ReferenceEntrySet();
          }
          
          public ObjectSortedSet<Short2ReferenceMap.Entry<V>> tailSet(Short2ReferenceMap.Entry<V> from)
          {
            return Short2ReferenceRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2ReferenceEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public ReferenceCollection<V> values()
    {
      if (this.values == null) {
        this.values = new AbstractReferenceCollection()
        {
          public ObjectIterator<V> iterator()
          {
            return new Short2ReferenceRBTreeMap.Submap.SubmapValueIterator(Short2ReferenceRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(Object local_k)
          {
            return Short2ReferenceRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2ReferenceRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2ReferenceRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2ReferenceRBTreeMap.Entry<V> local_e;
      return (in6(local_kk)) && ((local_e = Short2ReferenceRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public V put(short local_k, V local_v)
    {
      ...
      V oldValue = Short2ReferenceRBTreeMap.this.put(local_k, local_v);
    ...
    public V remove(short local_k)
    {
      ...
      V oldValue = Short2ReferenceRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2ReferenceRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2ReferenceSortedMap<V> tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2ReferenceRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2ReferenceRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2ReferenceSortedMap<V> subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2ReferenceRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2ReferenceRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2ReferenceRBTreeMap.Entry<V> firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2ReferenceRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2ReferenceRBTreeMap.this.locateKey(this.from);
        if (Short2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2ReferenceRBTreeMap.Entry<V> lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2ReferenceRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2ReferenceRBTreeMap.this.locateKey(this.field_47);
        if (Short2ReferenceRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2ReferenceRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2ReferenceRBTreeMap.Entry<V> local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2ReferenceRBTreeMap.Entry<V> local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    private final class SubmapKeyIterator
      extends Short2ReferenceRBTreeMap.Submap.SubmapIterator
    ...
    private class SubmapIterator
      extends Short2ReferenceRBTreeMap.TreeIterator
    {
      SubmapIterator()
      {
        super();
        this.next = Short2ReferenceRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2ReferenceRBTreeMap.Submap.this.bottom) && (Short2ReferenceRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2ReferenceRBTreeMap.Submap.this.top) && (Short2ReferenceRBTreeMap.this.compare(local_k, (this.prev = Short2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2ReferenceRBTreeMap.this.locateKey(local_k);
            if (Short2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2ReferenceRBTreeMap.this.compare(this.prev.key, Short2ReferenceRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Short2ReferenceRBTreeMap.this.compare(this.next.key, Short2ReferenceRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2ReferenceSortedMap.KeySet
    {
      ...
      {
        return new Short2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Short2ReferenceRBTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Short2ReferenceRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2ReferenceSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2ReferenceRBTreeMap.KeyIterator(Short2ReferenceRBTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2ReferenceRBTreeMap.KeyIterator(Short2ReferenceRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2ReferenceRBTreeMap.this.locateKey(local_k)) != null) {
        if (Short2ReferenceRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
