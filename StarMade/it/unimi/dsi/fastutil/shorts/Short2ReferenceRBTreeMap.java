...
/*  119 */           return Short2ReferenceRBTreeMap.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*      */         }
/*      */         public int compare(Short ok1, Short ok2) {
/*  122 */           return Short2ReferenceRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/* 1118 */         final Comparator<? super Short2ReferenceMap.Entry<V>> comparator = new Comparator() {
/*      */           public int compare(Short2ReferenceMap.Entry<V> x, Short2ReferenceMap.Entry<V> y) {
/* 1120 */             return Short2ReferenceRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1118 */         };
/*      */ 
...
/* 1127 */           return new Short2ReferenceRBTreeMap.EntryIterator(Short2ReferenceRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> from) {
/* 1130 */           return new Short2ReferenceRBTreeMap.EntryIterator(Short2ReferenceRBTreeMap.this, ((Short)from.getKey()).shortValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1134 */           if (!(o instanceof Map.Entry)) return false;
/* 1135 */           Map.Entry e = (Map.Entry)o;
/* 1136 */           Short2ReferenceRBTreeMap.Entry f = Short2ReferenceRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1143 */           Short2ReferenceRBTreeMap.Entry f = Short2ReferenceRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1144 */           if (f != null) Short2ReferenceRBTreeMap.this.remove(f.key);
/* 1145 */           return f != null;
/*      */         }
/* 1147 */         public int size() { return Short2ReferenceRBTreeMap.this.count; } 
/* 1148 */         public void clear() { Short2ReferenceRBTreeMap.this.clear(); } 
/* 1149 */         public Short2ReferenceMap.Entry<V> first() { return Short2ReferenceRBTreeMap.this.firstEntry; } 
/* 1150 */         public Short2ReferenceMap.Entry<V> last() { return Short2ReferenceRBTreeMap.this.lastEntry; } 
/* 1151 */         public ObjectSortedSet<Short2ReferenceMap.Entry<V>> subSet(Short2ReferenceMap.Entry<V> from, Short2ReferenceMap.Entry<V> to) { return Short2ReferenceRBTreeMap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2ReferenceEntrySet(); } 
/* 1152 */         public ObjectSortedSet<Short2ReferenceMap.Entry<V>> headSet(Short2ReferenceMap.Entry<V> to) { return Short2ReferenceRBTreeMap.this.headMap((Short)to.getKey()).short2ReferenceEntrySet(); } 
/* 1153 */         public ObjectSortedSet<Short2ReferenceMap.Entry<V>> tailSet(Short2ReferenceMap.Entry<V> from) { return Short2ReferenceRBTreeMap.this.tailMap((Short)from.getKey()).short2ReferenceEntrySet(); }
/*      */       };
...
/* 1215 */           return new Short2ReferenceRBTreeMap.ValueIterator(Short2ReferenceRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(Object k) {
/* 1218 */           return Short2ReferenceRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1221 */           return Short2ReferenceRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1224 */           Short2ReferenceRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1580 */       c = (Short2ReferenceRBTreeMap)super.clone();
/*      */     }
...
/*      */     {
/* 1277 */       if ((!bottom) && (!top) && (Short2ReferenceRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1278 */       this.from = from;
...
/*      */     {
/* 1296 */       return ((this.bottom) || (Short2ReferenceRBTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Short2ReferenceRBTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Short2ReferenceMap.Entry<V>> short2ReferenceEntrySet() {
/* 1300 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator() {
/* 1302 */             return new Short2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Short2ReferenceRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Short2ReferenceMap.Entry<V>> iterator(Short2ReferenceMap.Entry<V> from) {
/* 1305 */             return new Short2ReferenceRBTreeMap.Submap.SubmapEntryIterator(Short2ReferenceRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
/*      */           }
/* 1307 */           public Comparator<? super Short2ReferenceMap.Entry<V>> comparator() { return Short2ReferenceRBTreeMap.this.short2ReferenceEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1310 */             if (!(o instanceof Map.Entry)) return false;
/* 1311 */             Map.Entry e = (Map.Entry)o;
/* 1312 */             Short2ReferenceRBTreeMap.Entry f = Short2ReferenceRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1313 */             return (f != null) && (Short2ReferenceRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1317 */             if (!(o instanceof Map.Entry)) return false;
/* 1318 */             Map.Entry e = (Map.Entry)o;
/* 1319 */             Short2ReferenceRBTreeMap.Entry f = Short2ReferenceRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1320 */             if ((f != null) && (Short2ReferenceRBTreeMap.Submap.this.in(f.key))) Short2ReferenceRBTreeMap.Submap.this.remove(f.key);
/* 1321 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1324 */             int c = 0;
...
/* 1326 */             return c;
/*      */           }
/* 1328 */           public boolean isEmpty() { return !new Short2ReferenceRBTreeMap.Submap.SubmapIterator(Short2ReferenceRBTreeMap.Submap.this).hasNext(); } 
/* 1329 */           public void clear() { Short2ReferenceRBTreeMap.Submap.this.clear(); } 
/* 1330 */           public Short2ReferenceMap.Entry<V> first() { return Short2ReferenceRBTreeMap.Submap.this.firstEntry(); } 
/* 1331 */           public Short2ReferenceMap.Entry<V> last() { return Short2ReferenceRBTreeMap.Submap.this.lastEntry(); } 
/* 1332 */           public ObjectSortedSet<Short2ReferenceMap.Entry<V>> subSet(Short2ReferenceMap.Entry<V> from, Short2ReferenceMap.Entry<V> to) { return Short2ReferenceRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2ReferenceEntrySet(); } 
/* 1333 */           public ObjectSortedSet<Short2ReferenceMap.Entry<V>> headSet(Short2ReferenceMap.Entry<V> to) { return Short2ReferenceRBTreeMap.Submap.this.headMap((Short)to.getKey()).short2ReferenceEntrySet(); } 
/* 1334 */           public ObjectSortedSet<Short2ReferenceMap.Entry<V>> tailSet(Short2ReferenceMap.Entry<V> from) { return Short2ReferenceRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2ReferenceEntrySet(); }
/*      */         };
...
/*      */           public ObjectIterator<V> iterator() {
/* 1349 */             return new Short2ReferenceRBTreeMap.Submap.SubmapValueIterator(Short2ReferenceRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(Object k) {
/* 1352 */             return Short2ReferenceRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1355 */             return Short2ReferenceRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1358 */             Short2ReferenceRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(short k) {
/* 1365 */       return (in(k)) && (Short2ReferenceRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(Object v) {
...
/*      */     {
/* 1379 */       short kk = k;
/*      */       Short2ReferenceRBTreeMap.Entry e;
/* 1380 */       return (in(kk)) && ((e = Short2ReferenceRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public V put(short k, V v) {
/* 1383 */       Short2ReferenceRBTreeMap.this.modified = false;
...
/* 1385 */       Object oldValue = Short2ReferenceRBTreeMap.this.put(k, v);
/* 1386 */       return Short2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public V put(Short ok, V ov) {
/* 1389 */       Object oldValue = put(ok.shortValue(), ov);
/* 1390 */       return Short2ReferenceRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */ 
/*      */     public V remove(short k) {
/* 1394 */       Short2ReferenceRBTreeMap.this.modified = false;
/* 1395 */       if (!in(k)) return this.defRetValue;
/* 1396 */       Object oldValue = Short2ReferenceRBTreeMap.this.remove(k);
/* 1397 */       return Short2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public V remove(Object ok) {
/* 1400 */       Object oldValue = remove(((Short)ok).shortValue());
/* 1401 */       return Short2ReferenceRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ShortComparator comparator() {
/* 1416 */       return Short2ReferenceRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Short2ReferenceSortedMap<V> headMap(short to) {
/* 1419 */       if (this.top) return new Submap(Short2ReferenceRBTreeMap.this, this.from, this.bottom, to, false);
/* 1420 */       return Short2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Short2ReferenceRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Short2ReferenceSortedMap<V> tailMap(short from) {
/* 1423 */       if (this.bottom) return new Submap(Short2ReferenceRBTreeMap.this, from, false, this.to, this.top);
/* 1424 */       return Short2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2ReferenceRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Short2ReferenceSortedMap<V> subMap(short from, short to) {
/* 1427 */       if ((this.top) && (this.bottom)) return new Submap(Short2ReferenceRBTreeMap.this, from, false, to, false);
/* 1428 */       if (!this.top) to = Short2ReferenceRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1429 */       if (!this.bottom) from = Short2ReferenceRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1430 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1431 */       return new Submap(Short2ReferenceRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Short2ReferenceRBTreeMap.Entry<V> firstEntry()
/*      */     {
/* 1438 */       if (Short2ReferenceRBTreeMap.this.tree == null) return null;
/* 1441 */       Short2ReferenceRBTreeMap.Entry e;
/*      */       Short2ReferenceRBTreeMap.Entry e;
/* 1441 */       if (this.bottom) { e = Short2ReferenceRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1443 */         e = Short2ReferenceRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1445 */         if (Short2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1448 */       if ((e == null) || ((!this.top) && (Short2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1449 */       return e;
/*      */     }
/*      */ 
/*      */     public Short2ReferenceRBTreeMap.Entry<V> lastEntry()
/*      */     {
/* 1456 */       if (Short2ReferenceRBTreeMap.this.tree == null) return null;
/* 1459 */       Short2ReferenceRBTreeMap.Entry e;
/*      */       Short2ReferenceRBTreeMap.Entry e;
/* 1459 */       if (this.top) { e = Short2ReferenceRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1461 */         e = Short2ReferenceRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1463 */         if (Short2ReferenceRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1466 */       if ((e == null) || ((!this.bottom) && (Short2ReferenceRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1467 */       return e;
/*      */     }
/*      */     public short firstShortKey() {
/* 1470 */       Short2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1471 */       if (e == null) throw new NoSuchElementException();
/* 1472 */       return e.key;
/*      */     }
/*      */     public short lastShortKey() {
/* 1475 */       Short2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1476 */       if (e == null) throw new NoSuchElementException();
/* 1477 */       return e.key;
/*      */     }
/*      */     public Short firstKey() {
/* 1480 */       Short2ReferenceRBTreeMap.Entry e = firstEntry();
/* 1481 */       if (e == null) throw new NoSuchElementException();
/* 1482 */       return e.getKey();
/*      */     }
/*      */     public Short lastKey() {
/* 1485 */       Short2ReferenceRBTreeMap.Entry e = lastEntry();
/* 1486 */       if (e == null) throw new NoSuchElementException();
/* 1487 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Short2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Short2ReferenceRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Short2ReferenceRBTreeMap<V>.Submap.SubmapIterator
...
/* 1530 */       public Short2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1531 */       public void set(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1532 */       public void add(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
/*      */     private class SubmapIterator extends Short2ReferenceRBTreeMap.TreeIterator
/*      */     {
/*      */       SubmapIterator()
/*      */       {
/* 1497 */         super();
/* 1498 */         this.next = Short2ReferenceRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1501 */         this();
/* 1502 */         if (this.next != null)
/* 1503 */           if ((!Short2ReferenceRBTreeMap.Submap.this.bottom) && (Short2ReferenceRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1504 */           } else if ((!Short2ReferenceRBTreeMap.Submap.this.top) && (Short2ReferenceRBTreeMap.this.compare(k, (this.prev = Short2ReferenceRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1506 */             this.next = Short2ReferenceRBTreeMap.this.locateKey(k);
/* 1507 */             if (Short2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1517 */         if ((!Short2ReferenceRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2ReferenceRBTreeMap.this.compare(this.prev.key, Short2ReferenceRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1520 */         this.next = this.next.next();
/* 1521 */         if ((!Short2ReferenceRBTreeMap.Submap.this.top) && (this.next != null) && (Short2ReferenceRBTreeMap.this.compare(this.next.key, Short2ReferenceRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1338 */         super(); } 
/* 1339 */       public ShortBidirectionalIterator iterator() { return new Short2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Short2ReferenceRBTreeMap.Submap.this); } 
/* 1340 */       public ShortBidirectionalIterator iterator(short from) { return new Short2ReferenceRBTreeMap.Submap.SubmapKeyIterator(Short2ReferenceRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
...
/*      */     {
/* 1176 */       super(); } 
/* 1177 */     public ShortBidirectionalIterator iterator() { return new Short2ReferenceRBTreeMap.KeyIterator(Short2ReferenceRBTreeMap.this); } 
/* 1178 */     public ShortBidirectionalIterator iterator(short from) { return new Short2ReferenceRBTreeMap.KeyIterator(Short2ReferenceRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2ReferenceRBTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2ReferenceRBTreeMap<V>.TreeIterator
/*      */     implements ObjectListIterator<Short2ReferenceMap.Entry<V>>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1112 */     public Short2ReferenceMap.Entry<V> previous() { return previousEntry(); } 
/* 1113 */     public void set(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/* 1114 */     public void add(Short2ReferenceMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1039 */     int index = 0;
/*      */ 
/* 1041 */     TreeIterator() { this.next = Short2ReferenceRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(short k) {
/* 1044 */       if ((this.next = Short2ReferenceRBTreeMap.this.locateKey(k)) != null)
/* 1045 */         if (Short2ReferenceRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1086 */       updatePrevious();
/* 1087 */       updateNext();
/* 1088 */       Short2ReferenceRBTreeMap.this.remove(this.curr.key);
/* 1089 */       this.curr = null;
/*      */     }
...
/*  966 */       return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == e.getValue());
/*      */     }
/*      */     public int hashCode() {
