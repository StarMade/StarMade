...
/*  18:    */
/*  86:    */public class Short2ObjectOpenHashMap<V>
/*  87:    */  extends AbstractShort2ObjectMap<V>
...
/* 100:    */  protected volatile transient Short2ObjectMap.FastEntrySet<V> entries;
/* 101:    */  protected volatile transient ShortSet keys;
/* 102:    */  protected volatile transient ObjectCollection<V> values;
/* 103:    */  
/* 104:    */  public Short2ObjectOpenHashMap(int expected, float f)
/* 105:    */  {
...
/* 115:    */  }
/* 116:    */  
/* 119:    */  public Short2ObjectOpenHashMap(int expected)
/* 120:    */  {
/* 121:121 */    this(expected, 0.75F);
/* 122:    */  }
/* 123:    */  
/* 125:    */  public Short2ObjectOpenHashMap()
/* 126:    */  {
/* 127:127 */    this(16, 0.75F);
/* 128:    */  }
/* 129:    */  
/* 133:    */  public Short2ObjectOpenHashMap(Map<? extends Short, ? extends V> m, float f)
/* 134:    */  {
/* 135:135 */    this(m.size(), f);
/* 136:136 */    putAll(m);
/* 137:    */  }
/* 138:    */  
/* 141:    */  public Short2ObjectOpenHashMap(Map<? extends Short, ? extends V> m)
/* 142:    */  {
/* 143:143 */    this(m, 0.75F);
/* 144:    */  }
/* 145:    */  
/* 149:    */  public Short2ObjectOpenHashMap(Short2ObjectMap<V> m, float f)
/* 150:    */  {
/* 151:151 */    this(m.size(), f);
/* 152:152 */    putAll(m);
/* 153:    */  }
/* 154:    */  
/* 157:    */  public Short2ObjectOpenHashMap(Short2ObjectMap<V> m)
/* 158:    */  {
/* 159:159 */    this(m, 0.75F);
/* 160:    */  }
/* 161:    */  
/* 167:    */  public Short2ObjectOpenHashMap(short[] k, V[] v, float f)
/* 168:    */  {
...
/* 173:    */  }
/* 174:    */  
/* 178:    */  public Short2ObjectOpenHashMap(short[] k, V[] v)
/* 179:    */  {
...
/* 360:    */    implements Short2ObjectMap.Entry<V>, Map.Entry<Short, V>
/* 361:    */  {
...
/* 367:    */    }
/* 368:    */    
/* 369:369 */    public Short getKey() { return Short.valueOf(Short2ObjectOpenHashMap.this.key[this.index]); }
/* 370:    */    
/* 371:    */    public short getShortKey() {
/* 372:372 */      return Short2ObjectOpenHashMap.this.key[this.index];
/* 373:    */    }
/* 374:    */    
/* 375:375 */    public V getValue() { return Short2ObjectOpenHashMap.this.value[this.index]; }
/* 376:    */    
/* 377:    */    public V setValue(V v) {
/* 378:378 */      V oldValue = Short2ObjectOpenHashMap.this.value[this.index];
/* 379:379 */      Short2ObjectOpenHashMap.this.value[this.index] = v;
...
/* 386:386 */      return (Short2ObjectOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Short2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
/* 387:    */    }
/* 388:    */    
/* 389:389 */    public int hashCode() { return Short2ObjectOpenHashMap.this.key[this.index] ^ (Short2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Short2ObjectOpenHashMap.this.value[this.index].hashCode()); }
/* 390:    */    
/* 392:392 */    public String toString() { return Short2ObjectOpenHashMap.this.key[this.index] + "=>" + Short2ObjectOpenHashMap.this.value[this.index]; } }
/* 393:    */  
...
/* 398:    */    
/* 399:399 */    private MapIterator() { this.pos = Short2ObjectOpenHashMap.this.n;
/* 400:    */      
/* 402:402 */      this.last = -1;
/* 403:    */      
/* 404:404 */      this.c = Short2ObjectOpenHashMap.this.size;
/* 405:    */      
/* 409:409 */      boolean[] used = Short2ObjectOpenHashMap.this.used;
...
/* 421:    */        
/* 422:422 */        int pos = HashCommon.murmurHash3(k) & Short2ObjectOpenHashMap.this.mask;
/* 423:    */        
/* 424:424 */        while (Short2ObjectOpenHashMap.this.used[pos] != 0) {
/* 425:425 */          if (Short2ObjectOpenHashMap.this.key[pos] == k) return pos;
/* 426:426 */          pos = pos + 1 & Short2ObjectOpenHashMap.this.mask;
/* 427:    */        }
/* 428:    */      }
/* 429:429 */      this.last = this.pos;
/* 430:    */      
/* 431:431 */      if (this.c != 0) {
/* 432:432 */        boolean[] used = Short2ObjectOpenHashMap.this.used;
...
/* 447:    */      for (;;)
/* 448:    */      {
/* 449:449 */        pos = (last = pos) + 1 & Short2ObjectOpenHashMap.this.mask;
/* 450:450 */        while (Short2ObjectOpenHashMap.this.used[pos] != 0) {
/* 451:451 */          int slot = HashCommon.murmurHash3(Short2ObjectOpenHashMap.this.key[pos]) & Short2ObjectOpenHashMap.this.mask;
/* 452:452 */          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453:453 */          pos = pos + 1 & Short2ObjectOpenHashMap.this.mask;
/* 454:    */        }
/* 455:455 */        if (Short2ObjectOpenHashMap.this.used[pos] == 0) break;
/* 456:456 */        if (pos < last)
/* 457:    */        {
/* 458:458 */          if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 459:459 */          this.wrapped.add(Short2ObjectOpenHashMap.this.key[pos]);
/* 460:    */        }
/* 461:461 */        Short2ObjectOpenHashMap.this.key[last] = Short2ObjectOpenHashMap.this.key[pos];
/* 462:462 */        Short2ObjectOpenHashMap.this.value[last] = Short2ObjectOpenHashMap.this.value[pos];
/* 463:    */      }
/* 464:464 */      Short2ObjectOpenHashMap.this.used[last] = false;
/* 465:465 */      Short2ObjectOpenHashMap.this.value[last] = null;
/* 466:466 */      return last;
/* 467:    */    }
/* 468:    */    
...
/* 472:    */      {
/* 473:473 */        Short2ObjectOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 474:474 */        this.last = -1;
/* 475:475 */        return;
/* 476:    */      }
/* 477:477 */      Short2ObjectOpenHashMap.this.size -= 1;
...
/* 489:    */    } }
/* 490:    */  
/* 491:491 */  private class EntryIterator extends Short2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Short2ObjectMap.Entry<V>> { private EntryIterator() { super(null); }
/* 492:    */    
/* 493:    */    private Short2ObjectOpenHashMap<V>.MapEntry entry;
/* 494:494 */    public Short2ObjectMap.Entry<V> next() { return this.entry = new Short2ObjectOpenHashMap.MapEntry(Short2ObjectOpenHashMap.this, nextEntry()); }
/* 495:    */    
/* 496:    */    public void remove()
/* 497:    */    {
/* 498:498 */      super.remove();
/* 499:499 */      Short2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
/* 500:    */    } }
/* 501:    */  
/* 502:502 */  private class FastEntryIterator extends Short2ObjectOpenHashMap<V>.MapIterator implements ObjectIterator<Short2ObjectMap.Entry<V>> { private FastEntryIterator() { super(null); }
/* 503:503 */    final AbstractShort2ObjectMap.BasicEntry<V> entry = new AbstractShort2ObjectMap.BasicEntry((short)0, null);
/* 504:    */    
/* 505:505 */    public AbstractShort2ObjectMap.BasicEntry<V> next() { int e = nextEntry();
/* 506:506 */      this.entry.key = Short2ObjectOpenHashMap.this.key[e];
/* 507:507 */      this.entry.value = Short2ObjectOpenHashMap.this.value[e];
/* 508:508 */      return this.entry;
/* 509:    */    } }
/* 510:    */  
/* 511:    */  private final class MapEntrySet extends AbstractObjectSet<Short2ObjectMap.Entry<V>> implements Short2ObjectMap.FastEntrySet<V> { private MapEntrySet() {}
/* 512:    */    
/* 513:513 */    public ObjectIterator<Short2ObjectMap.Entry<V>> iterator() { return new Short2ObjectOpenHashMap.EntryIterator(Short2ObjectOpenHashMap.this, null); }
/* 514:    */    
/* 515:    */    public ObjectIterator<Short2ObjectMap.Entry<V>> fastIterator() {
/* 516:516 */      return new Short2ObjectOpenHashMap.FastEntryIterator(Short2ObjectOpenHashMap.this, null);
/* 517:    */    }
/* 518:    */    
...
/* 523:    */      
/* 524:524 */      int pos = HashCommon.murmurHash3(k) & Short2ObjectOpenHashMap.this.mask;
/* 525:    */      
/* 526:526 */      while (Short2ObjectOpenHashMap.this.used[pos] != 0) {
/* 527:527 */        if (Short2ObjectOpenHashMap.this.key[pos] == k) return Short2ObjectOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Short2ObjectOpenHashMap.this.value[pos].equals(e.getValue());
/* 528:528 */        pos = pos + 1 & Short2ObjectOpenHashMap.this.mask;
/* 529:    */      }
...
/* 537:    */      
/* 538:538 */      int pos = HashCommon.murmurHash3(k) & Short2ObjectOpenHashMap.this.mask;
/* 539:    */      
/* 540:540 */      while (Short2ObjectOpenHashMap.this.used[pos] != 0) {
/* 541:541 */        if (Short2ObjectOpenHashMap.this.key[pos] == k) {
/* 542:542 */          Short2ObjectOpenHashMap.this.remove(e.getKey());
/* 543:543 */          return true;
/* 544:    */        }
/* 545:545 */        pos = pos + 1 & Short2ObjectOpenHashMap.this.mask;
/* 546:    */      }
/* 547:547 */      return false;
/* 548:    */    }
/* 549:    */    
/* 550:550 */    public int size() { return Short2ObjectOpenHashMap.this.size; }
/* 551:    */    
/* 553:553 */    public void clear() { Short2ObjectOpenHashMap.this.clear(); }
/* 554:    */  }
/* 555:    */  
/* 556:    */  public Short2ObjectMap.FastEntrySet<V> short2ObjectEntrySet() {
...
/* 564:    */    extends Short2ObjectOpenHashMap.MapIterator
/* 565:    */    implements ShortIterator
/* 566:    */  {
/* 567:567 */    public KeyIterator() { super(null); }
/* 568:568 */    public short nextShort() { return Short2ObjectOpenHashMap.this.key[nextEntry()]; }
/* 569:569 */    public Short next() { return Short.valueOf(Short2ObjectOpenHashMap.this.key[nextEntry()]); } }
/* 570:    */  
/* 571:    */  private final class KeySet extends AbstractShortSet { private KeySet() {}
/* 572:    */    
/* 573:573 */    public ShortIterator iterator() { return new Short2ObjectOpenHashMap.KeyIterator(Short2ObjectOpenHashMap.this); }
/* 574:    */    
/* 575:    */    public int size() {
/* 576:576 */      return Short2ObjectOpenHashMap.this.size;
/* 577:    */    }
/* 578:    */    
/* 579:579 */    public boolean contains(short k) { return Short2ObjectOpenHashMap.this.containsKey(k); }
/* 580:    */    
/* 581:    */    public boolean remove(short k) {
/* 582:582 */      int oldSize = Short2ObjectOpenHashMap.this.size;
/* 583:583 */      Short2ObjectOpenHashMap.this.remove(k);
/* 584:584 */      return Short2ObjectOpenHashMap.this.size != oldSize;
/* 585:    */    }
/* 586:    */    
/* 587:587 */    public void clear() { Short2ObjectOpenHashMap.this.clear(); }
/* 588:    */  }
/* 589:    */  
...
/* 598:    */    extends Short2ObjectOpenHashMap<V>.MapIterator
/* 599:    */    implements ObjectIterator<V>
/* 600:    */  {
/* 601:601 */    public ValueIterator() { super(null); }
/* 602:602 */    public V next() { return Short2ObjectOpenHashMap.this.value[nextEntry()]; }
/* 603:    */  }
/* 604:    */  
...
/* 607:607 */          return new Short2ObjectOpenHashMap.ValueIterator(Short2ObjectOpenHashMap.this);
/* 608:    */        }
/* 609:    */        
/* 610:610 */        public int size() { return Short2ObjectOpenHashMap.this.size; }
/* 611:    */        
/* 612:    */        public boolean contains(Object v) {
/* 613:613 */          return Short2ObjectOpenHashMap.this.containsValue(v);
/* 614:    */        }
/* 615:    */        
/* 616:616 */        public void clear() { Short2ObjectOpenHashMap.this.clear(); }
/* 617:    */      };
/* 618:    */    }
...
/* 719:    */  }
/* 720:    */  
/* 724:    */  public Short2ObjectOpenHashMap<V> clone()
/* 725:    */  {
/* 726:    */    Short2ObjectOpenHashMap<V> c;
/* 727:    */    
/* 729:    */    try
/* 730:    */    {
/* 731:731 */      c = (Short2ObjectOpenHashMap)super.clone();
/* 732:    */    }
...
/* 768:768 */    Short2ObjectOpenHashMap<V>.MapIterator i = new MapIterator(null);
