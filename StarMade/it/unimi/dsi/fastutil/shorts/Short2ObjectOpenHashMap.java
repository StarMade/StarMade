...
/* 607 */           return new Short2ObjectOpenHashMap.ValueIterator(Short2ObjectOpenHashMap.this);
/*     */         }
/*     */         public int size() {
/* 610 */           return Short2ObjectOpenHashMap.this.size;
/*     */         }
/*     */         public boolean contains(Object v) {
/* 613 */           return Short2ObjectOpenHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 616 */           Short2ObjectOpenHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 731 */       c = (Short2ObjectOpenHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Short2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<V>
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 601 */       super(null); } 
/* 602 */     public V next() { return Short2ObjectOpenHashMap.this.value[nextEntry()]; }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 573 */       return new Short2ObjectOpenHashMap.KeyIterator(Short2ObjectOpenHashMap.this);
/*     */     }
/*     */     public int size() {
/* 576 */       return Short2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public boolean contains(short k) {
/* 579 */       return Short2ObjectOpenHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(short k) {
/* 582 */       int oldSize = Short2ObjectOpenHashMap.this.size;
/* 583 */       Short2ObjectOpenHashMap.this.remove(k);
/* 584 */       return Short2ObjectOpenHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 587 */       Short2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Short2ObjectOpenHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 567 */       super(null); } 
/* 568 */     public short nextShort() { return Short2ObjectOpenHashMap.this.key[nextEntry()]; } 
/* 569 */     public Short next() { return Short.valueOf(Short2ObjectOpenHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 513 */       return new Short2ObjectOpenHashMap.EntryIterator(Short2ObjectOpenHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Short2ObjectMap.Entry<V>> fastIterator() {
/* 516 */       return new Short2ObjectOpenHashMap.FastEntryIterator(Short2ObjectOpenHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 524 */       int pos = HashCommon.murmurHash3(k) & Short2ObjectOpenHashMap.this.mask;
/*     */ 
/* 526 */       while (Short2ObjectOpenHashMap.this.used[pos] != 0) {
/* 527 */         if (Short2ObjectOpenHashMap.this.key[pos] == k) return Short2ObjectOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Short2ObjectOpenHashMap.this.value[pos].equals(e.getValue());
/* 528 */         pos = pos + 1 & Short2ObjectOpenHashMap.this.mask;
/*     */       }
/* 530 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 538 */       int pos = HashCommon.murmurHash3(k) & Short2ObjectOpenHashMap.this.mask;
/*     */ 
/* 540 */       while (Short2ObjectOpenHashMap.this.used[pos] != 0) {
/* 541 */         if (Short2ObjectOpenHashMap.this.key[pos] == k) {
/* 542 */           Short2ObjectOpenHashMap.this.remove(e.getKey());
/* 543 */           return true;
/*     */         }
/* 545 */         pos = pos + 1 & Short2ObjectOpenHashMap.this.mask;
/*     */       }
/* 547 */       return false;
/*     */     }
/*     */     public int size() {
/* 550 */       return Short2ObjectOpenHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 553 */       Short2ObjectOpenHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Short2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Short2ObjectMap.Entry<V>>
/*     */   {
/* 503 */     final AbstractShort2ObjectMap.BasicEntry<V> entry = new AbstractShort2ObjectMap.BasicEntry((short)0, null);
/*     */ 
...
/* 505 */       int e = nextEntry();
/* 506 */       this.entry.key = Short2ObjectOpenHashMap.this.key[e];
/* 507 */       this.entry.value = Short2ObjectOpenHashMap.this.value[e];
/* 508 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Short2ObjectOpenHashMap<V>.MapIterator
/*     */     implements ObjectIterator<Short2ObjectMap.Entry<V>>
/*     */   {
...
/* 494 */       return this.entry = new Short2ObjectOpenHashMap.MapEntry(Short2ObjectOpenHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 498 */       super.remove();
/* 499 */       Short2ObjectOpenHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 399 */       this.pos = Short2ObjectOpenHashMap.this.n;
/*     */ 
/* 402 */       this.last = -1;
/*     */ 
/* 404 */       this.c = Short2ObjectOpenHashMap.this.size;
/*     */ 
/* 409 */       boolean[] used = Short2ObjectOpenHashMap.this.used;
...
/*     */ 
/* 422 */         int pos = HashCommon.murmurHash3(k) & Short2ObjectOpenHashMap.this.mask;
/*     */ 
/* 424 */         while (Short2ObjectOpenHashMap.this.used[pos] != 0) {
/* 425 */           if (Short2ObjectOpenHashMap.this.key[pos] == k) return pos;
/* 426 */           pos = pos + 1 & Short2ObjectOpenHashMap.this.mask;
/*     */         }
/*     */       }
/* 429 */       this.last = this.pos;
/*     */ 
/* 431 */       if (this.c != 0) {
/* 432 */         boolean[] used = Short2ObjectOpenHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 449 */         pos = (last = pos) + 1 & Short2ObjectOpenHashMap.this.mask;
/* 450 */         while (Short2ObjectOpenHashMap.this.used[pos] != 0) {
/* 451 */           int slot = HashCommon.murmurHash3(Short2ObjectOpenHashMap.this.key[pos]) & Short2ObjectOpenHashMap.this.mask;
/* 452 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 453 */           pos = pos + 1 & Short2ObjectOpenHashMap.this.mask;
/*     */         }
/* 455 */         if (Short2ObjectOpenHashMap.this.used[pos] == 0) break;
/* 456 */         if (pos < last)
/*     */         {
/* 458 */           if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 459 */           this.wrapped.add(Short2ObjectOpenHashMap.this.key[pos]);
/*     */         }
/* 461 */         Short2ObjectOpenHashMap.this.key[last] = Short2ObjectOpenHashMap.this.key[pos];
/* 462 */         Short2ObjectOpenHashMap.this.value[last] = Short2ObjectOpenHashMap.this.value[pos];
/*     */       }
/* 464 */       Short2ObjectOpenHashMap.this.used[last] = false;
/* 465 */       Short2ObjectOpenHashMap.this.value[last] = null;
/* 466 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 471 */       if (this.pos < -1)
/*     */       {
/* 473 */         Short2ObjectOpenHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 474 */         this.last = -1;
/* 475 */         return;
/*     */       }
/* 477 */       Short2ObjectOpenHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Short getKey() {
/* 369 */       return Short.valueOf(Short2ObjectOpenHashMap.this.key[this.index]);
/*     */     }
/*     */     public short getShortKey() {
/* 372 */       return Short2ObjectOpenHashMap.this.key[this.index];
/*     */     }
/*     */     public V getValue() {
/* 375 */       return Short2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */     public V setValue(V v) {
/* 378 */       Object oldValue = Short2ObjectOpenHashMap.this.value[this.index];
/* 379 */       Short2ObjectOpenHashMap.this.value[this.index] = v;
/* 380 */       return oldValue;
/*     */     }
/*     */ 
...
/* 386 */       return (Short2ObjectOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2ObjectOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Short2ObjectOpenHashMap.this.value[this.index].equals(e.getValue()));
/*     */     }
/*     */     public int hashCode() {
/* 389 */       return Short2ObjectOpenHashMap.this.key[this.index] ^ (Short2ObjectOpenHashMap.this.value[this.index] == null ? 0 : Short2ObjectOpenHashMap.this.value[this.index].hashCode());
/*     */     }
/*     */     public String toString() {
/* 392 */       return Short2ObjectOpenHashMap.this.key[this.index] + "=>" + Short2ObjectOpenHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
