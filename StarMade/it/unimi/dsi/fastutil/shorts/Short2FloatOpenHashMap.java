  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2FloatOpenHashMap(int expected, float local_f)
  {
  ...
  public Short2FloatOpenHashMap(Map<? extends Short, ? extends Float> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2FloatOpenHashMap(Map<? extends Short, ? extends Float> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2FloatOpenHashMap(Short2FloatMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2FloatOpenHashMap(Short2FloatMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2FloatOpenHashMap(short[] local_k, float[] local_v, float local_f)
  {
  ...
  public Short2FloatOpenHashMap(short[] local_k, float[] local_v)
  {
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Short2FloatOpenHashMap.ValueIterator(Short2FloatOpenHashMap.this);
        }
        ...
        {
          return Short2FloatOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2FloatOpenHashMap local_c;
    try
    {
      local_c = (Short2FloatOpenHashMap)super.clone();
    }
  ...
  private final class ValueIterator
    extends Short2FloatOpenHashMap.MapIterator
    implements FloatIterator
  {
    ...
    public Float next()
    {
      return Float.valueOf(Short2FloatOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractShortSet
  {
    ...
    {
      return new Short2FloatOpenHashMap.KeyIterator(Short2FloatOpenHashMap.this);
    }
    ...
    {
      return Short2FloatOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2FloatOpenHashMap.this.size;
      Short2FloatOpenHashMap.this.remove(local_k);
    ...
    implements ShortIterator
  {
    ...
    public Short next()
    {
      return Short.valueOf(Short2FloatOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Short2FloatMap.FastEntrySet
  {
    ...
    {
      return new Short2FloatOpenHashMap.EntryIterator(Short2FloatOpenHashMap.this, null);
    }
    
    public ObjectIterator<Short2FloatMap.Entry> fastIterator()
    {
      return new Short2FloatOpenHashMap.FastEntryIterator(Short2FloatOpenHashMap.this, null);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2FloatOpenHashMap.this.mask; Short2FloatOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2FloatOpenHashMap.this.mask) {
        if (Short2FloatOpenHashMap.this.key[pos] == local_k) {
          return Short2FloatOpenHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2FloatOpenHashMap.this.mask; Short2FloatOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2FloatOpenHashMap.this.mask) {
        if (Short2FloatOpenHashMap.this.key[pos] == local_k)
        {
          Short2FloatOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    implements ObjectIterator<Short2FloatMap.Entry>
  {
    ...
    public AbstractShort2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Short2FloatOpenHashMap.this.key[local_e];
      this.entry.value = Short2FloatOpenHashMap.this.value[local_e];
      return this.entry;
    }
  }
    ...
    implements ObjectIterator<Short2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Short2FloatOpenHashMap.MapEntry(Short2FloatOpenHashMap.this, nextEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2FloatOpenHashMap.MapEntry.access$102(this.entry, -1);
    }
  }
  
  private class MapIterator
  {
    int pos = Short2FloatOpenHashMap.this.field_49;
    int last = -1;
    int field_1932 = Short2FloatOpenHashMap.this.size;
    ShortArrayList wrapped;
    
    private MapIterator()
    {
      boolean[] used = Short2FloatOpenHashMap.this.used;
      while ((this.field_1932 != 0) && (used[(--this.pos)] == 0)) {}
    }
    
    public boolean hasNext()
    {
      return this.field_1932 != 0;
    }
    ...
    public int nextEntry()
    {
      ...
      this.last = this.pos;
      if (this.field_1932 != 0)
      {
        boolean[] local_k = Short2FloatOpenHashMap.this.used;
    ...
    protected final int shiftKeys(int pos)
    {
      ...
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2FloatOpenHashMap.this.mask; Short2FloatOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2FloatOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Short2FloatOpenHashMap.this.key[pos]) & Short2FloatOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Short2FloatOpenHashMap.this.used[pos] == 0) {
          break;
        }
        if (pos < last)
        {
    ...
    public void remove()
    {
      ...
      Short2FloatOpenHashMap.this.size -= 1;
      if ((shiftKeys(this.last) == this.pos) && (this.field_1932 > 0))
      {
        this.field_1932 += 1;
        nextEntry();
      }
    ...
    implements Short2FloatMap.Entry, Map.Entry<Short, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Short2FloatOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, Float> local_e = (Map.Entry)local_o;
      return (Short2FloatOpenHashMap.this.key[this.index] == ((Short)local_e.getKey()).shortValue()) && (Short2FloatOpenHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
