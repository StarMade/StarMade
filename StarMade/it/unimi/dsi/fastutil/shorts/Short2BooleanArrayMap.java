  ...
  implements Serializable, Cloneable
{
  ...
  public Short2BooleanArrayMap(Short2BooleanMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Short2BooleanArrayMap(Map<? extends Short, ? extends Boolean> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Short2BooleanArrayMap local_c;
    try
    {
      local_c = (Short2BooleanArrayMap)super.clone();
    }
    ...
    implements Short2BooleanMap.FastEntrySet
  {
    ...
    public ObjectIterator<Short2BooleanMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Short2BooleanMap.Entry next()
        {
          ...
          return new AbstractShort2BooleanMap.BasicEntry(Short2BooleanArrayMap.this.key[this.next], Short2BooleanArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public ObjectIterator<Short2BooleanMap.Entry> fastIterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Short2BooleanMap.Entry next()
        {
          ...
          this.entry.key = Short2BooleanArrayMap.this.key[this.next];
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Short2BooleanArrayMap.this.containsKey(local_k)) && (Short2BooleanArrayMap.this.get(local_k) == ((Boolean)local_e.getValue()).booleanValue());
    }
  }
}
