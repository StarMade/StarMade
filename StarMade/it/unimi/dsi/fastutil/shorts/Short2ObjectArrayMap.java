  ...
  implements Serializable, Cloneable
{
  ...
  public Short2ObjectArrayMap(Short2ObjectMap<V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Short2ObjectArrayMap(Map<? extends Short, ? extends V> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Short2ObjectArrayMap<V> local_c;
    try
    {
      local_c = (Short2ObjectArrayMap)super.clone();
    }
    ...
    implements Short2ObjectMap.FastEntrySet<V>
  {
    ...
    public ObjectIterator<Short2ObjectMap.Entry<V>> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Short2ObjectMap.Entry<V> next()
        {
          ...
          return new AbstractShort2ObjectMap.BasicEntry(Short2ObjectArrayMap.this.key[this.next], Short2ObjectArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Short2ObjectArrayMap.this.containsKey(local_k)) && (Short2ObjectArrayMap.this.get(local_k) == null ? local_e.getValue() == null : Short2ObjectArrayMap.this.get(local_k).equals(local_e.getValue()));
    }
  }
}
