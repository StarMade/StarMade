...
/* 662 */           return new Short2FloatOpenCustomHashMap.ValueIterator(Short2FloatOpenCustomHashMap.this);
/*     */         }
/*     */         public int size() {
/* 665 */           return Short2FloatOpenCustomHashMap.this.size;
/*     */         }
/*     */         public boolean contains(float v) {
/* 668 */           return Short2FloatOpenCustomHashMap.this.containsValue(v);
/*     */         }
/*     */         public void clear() {
/* 671 */           Short2FloatOpenCustomHashMap.this.clear();
/*     */         }
/*     */       };
...
/*     */     try
/*     */     {
/* 786 */       c = (Short2FloatOpenCustomHashMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class ValueIterator extends Short2FloatOpenCustomHashMap.MapIterator
/*     */     implements FloatIterator
/*     */   {
/*     */     public ValueIterator()
/*     */     {
/* 655 */       super(null); } 
/* 656 */     public float nextFloat() { return Short2FloatOpenCustomHashMap.this.value[nextEntry()]; } 
/* 657 */     public Float next() { return Float.valueOf(Short2FloatOpenCustomHashMap.this.value[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 627 */       return new Short2FloatOpenCustomHashMap.KeyIterator(Short2FloatOpenCustomHashMap.this);
/*     */     }
/*     */     public int size() {
/* 630 */       return Short2FloatOpenCustomHashMap.this.size;
/*     */     }
/*     */     public boolean contains(short k) {
/* 633 */       return Short2FloatOpenCustomHashMap.this.containsKey(k);
/*     */     }
/*     */     public boolean remove(short k) {
/* 636 */       int oldSize = Short2FloatOpenCustomHashMap.this.size;
/* 637 */       Short2FloatOpenCustomHashMap.this.remove(k);
/* 638 */       return Short2FloatOpenCustomHashMap.this.size != oldSize;
/*     */     }
/*     */     public void clear() {
/* 641 */       Short2FloatOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private final class KeyIterator extends Short2FloatOpenCustomHashMap.MapIterator
/*     */     implements ShortIterator
/*     */   {
/*     */     public KeyIterator()
/*     */     {
/* 621 */       super(null); } 
/* 622 */     public short nextShort() { return Short2FloatOpenCustomHashMap.this.key[nextEntry()]; } 
/* 623 */     public Short next() { return Short.valueOf(Short2FloatOpenCustomHashMap.this.key[nextEntry()]); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     {
/* 567 */       return new Short2FloatOpenCustomHashMap.EntryIterator(Short2FloatOpenCustomHashMap.this, null);
/*     */     }
/*     */     public ObjectIterator<Short2FloatMap.Entry> fastIterator() {
/* 570 */       return new Short2FloatOpenCustomHashMap.FastEntryIterator(Short2FloatOpenCustomHashMap.this, null);
/*     */     }
/*     */ 
...
/*     */ 
/* 578 */       int pos = HashCommon.murmurHash3(Short2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Short2FloatOpenCustomHashMap.this.mask;
/*     */ 
/* 580 */       while (Short2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 581 */         if (Short2FloatOpenCustomHashMap.this.strategy.equals(Short2FloatOpenCustomHashMap.this.key[pos], k)) return Short2FloatOpenCustomHashMap.this.value[pos] == ((Float)e.getValue()).floatValue();
/* 582 */         pos = pos + 1 & Short2FloatOpenCustomHashMap.this.mask;
/*     */       }
/* 584 */       return false;
/*     */     }
/*     */ 
...
/*     */ 
/* 592 */       int pos = HashCommon.murmurHash3(Short2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Short2FloatOpenCustomHashMap.this.mask;
/*     */ 
/* 594 */       while (Short2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 595 */         if (Short2FloatOpenCustomHashMap.this.strategy.equals(Short2FloatOpenCustomHashMap.this.key[pos], k)) {
/* 596 */           Short2FloatOpenCustomHashMap.this.remove(e.getKey());
/* 597 */           return true;
/*     */         }
/* 599 */         pos = pos + 1 & Short2FloatOpenCustomHashMap.this.mask;
/*     */       }
/* 601 */       return false;
/*     */     }
/*     */     public int size() {
/* 604 */       return Short2FloatOpenCustomHashMap.this.size;
/*     */     }
/*     */     public void clear() {
/* 607 */       Short2FloatOpenCustomHashMap.this.clear();
/*     */     }
/*     */   }
/*     */ 
/*     */   private class FastEntryIterator extends Short2FloatOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Short2FloatMap.Entry>
/*     */   {
/* 557 */     final AbstractShort2FloatMap.BasicEntry entry = new AbstractShort2FloatMap.BasicEntry((short)0, 0.0F);
/*     */ 
...
/* 559 */       int e = nextEntry();
/* 560 */       this.entry.key = Short2FloatOpenCustomHashMap.this.key[e];
/* 561 */       this.entry.value = Short2FloatOpenCustomHashMap.this.value[e];
/* 562 */       return this.entry;
/*     */     }
/*     */   }
/*     */ 
/*     */   private class EntryIterator extends Short2FloatOpenCustomHashMap.MapIterator
/*     */     implements ObjectIterator<Short2FloatMap.Entry>
/*     */   {
...
/* 548 */       return this.entry = new Short2FloatOpenCustomHashMap.MapEntry(Short2FloatOpenCustomHashMap.this, nextEntry());
/*     */     }
/*     */ 
/*     */     public void remove() {
/* 552 */       super.remove();
/* 553 */       Short2FloatOpenCustomHashMap.MapEntry.access$102(this.entry, -1);
/*     */     }
/*     */   }
/*     */ 
...
/*     */     private MapIterator()
/*     */     {
/* 454 */       this.pos = Short2FloatOpenCustomHashMap.this.n;
/*     */ 
/* 457 */       this.last = -1;
/*     */ 
/* 459 */       this.c = Short2FloatOpenCustomHashMap.this.size;
/*     */ 
/* 464 */       boolean[] used = Short2FloatOpenCustomHashMap.this.used;
...
/*     */ 
/* 477 */         int pos = HashCommon.murmurHash3(Short2FloatOpenCustomHashMap.this.strategy.hashCode(k)) & Short2FloatOpenCustomHashMap.this.mask;
/*     */ 
/* 479 */         while (Short2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 480 */           if (Short2FloatOpenCustomHashMap.this.strategy.equals(Short2FloatOpenCustomHashMap.this.key[pos], k)) return pos;
/* 481 */           pos = pos + 1 & Short2FloatOpenCustomHashMap.this.mask;
/*     */         }
/*     */       }
/* 484 */       this.last = this.pos;
/*     */ 
/* 486 */       if (this.c != 0) {
/* 487 */         boolean[] used = Short2FloatOpenCustomHashMap.this.used;
...
/*     */       while (true)
/*     */       {
/* 504 */         pos = (last = pos) + 1 & Short2FloatOpenCustomHashMap.this.mask;
/* 505 */         while (Short2FloatOpenCustomHashMap.this.used[pos] != 0) {
/* 506 */           int slot = HashCommon.murmurHash3(Short2FloatOpenCustomHashMap.this.strategy.hashCode(Short2FloatOpenCustomHashMap.this.key[pos])) & Short2FloatOpenCustomHashMap.this.mask;
/* 507 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 508 */           pos = pos + 1 & Short2FloatOpenCustomHashMap.this.mask;
/*     */         }
/* 510 */         if (Short2FloatOpenCustomHashMap.this.used[pos] == 0) break;
/* 511 */         if (pos < last)
/*     */         {
/* 513 */           if (this.wrapped == null) this.wrapped = new ShortArrayList();
/* 514 */           this.wrapped.add(Short2FloatOpenCustomHashMap.this.key[pos]);
/*     */         }
/* 516 */         Short2FloatOpenCustomHashMap.this.key[last] = Short2FloatOpenCustomHashMap.this.key[pos];
/* 517 */         Short2FloatOpenCustomHashMap.this.value[last] = Short2FloatOpenCustomHashMap.this.value[pos];
/*     */       }
/* 519 */       Short2FloatOpenCustomHashMap.this.used[last] = false;
/* 520 */       return last;
/*     */     }
/*     */ 
/*     */     public void remove() {
...
/* 525 */       if (this.pos < -1)
/*     */       {
/* 527 */         Short2FloatOpenCustomHashMap.this.remove(this.wrapped.getShort(-this.pos - 2));
/* 528 */         this.last = -1;
/* 529 */         return;
/*     */       }
/* 531 */       Short2FloatOpenCustomHashMap.this.size -= 1;
...
/*     */     }
/*     */     public Short getKey() {
/* 418 */       return Short.valueOf(Short2FloatOpenCustomHashMap.this.key[this.index]);
/*     */     }
/*     */     public short getShortKey() {
/* 421 */       return Short2FloatOpenCustomHashMap.this.key[this.index];
/*     */     }
/*     */     public Float getValue() {
/* 424 */       return Float.valueOf(Short2FloatOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public float getFloatValue() {
/* 427 */       return Short2FloatOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */     public float setValue(float v) {
/* 430 */       float oldValue = Short2FloatOpenCustomHashMap.this.value[this.index];
/* 431 */       Short2FloatOpenCustomHashMap.this.value[this.index] = v;
/* 432 */       return oldValue;
/*     */     }
/*     */     public Float setValue(Float v) {
...
/* 441 */       return (Short2FloatOpenCustomHashMap.this.strategy.equals(Short2FloatOpenCustomHashMap.this.key[this.index], ((Short)e.getKey()).shortValue())) && (Short2FloatOpenCustomHashMap.this.value[this.index] == ((Float)e.getValue()).floatValue());
/*     */     }
/*     */     public int hashCode() {
/* 444 */       return Short2FloatOpenCustomHashMap.this.strategy.hashCode(Short2FloatOpenCustomHashMap.this.key[this.index]) ^ HashCommon.float2int(Short2FloatOpenCustomHashMap.this.value[this.index]);
/*     */     }
/*     */     public String toString() {
/* 447 */       return Short2FloatOpenCustomHashMap.this.key[this.index] + "=>" + Short2FloatOpenCustomHashMap.this.value[this.index];
/*     */     }
/*     */   }
/*     */ }
