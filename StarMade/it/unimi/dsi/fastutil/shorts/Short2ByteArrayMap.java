...
/*     */ 
/*     */ public class Short2ByteArrayMap extends AbstractShort2ByteMap
...
/*     */     try
/*     */     {
/* 269 */       c = (Short2ByteArrayMap)super.clone();
/*     */     }
...
/*     */   }
/*     */ 
/*     */   private final class EntrySet extends AbstractObjectSet<Short2ByteMap.Entry>
...
/* 131 */         int next = 0;
/*     */ 
/* 133 */         public boolean hasNext() { return this.next < Short2ByteArrayMap.this.size; }
/*     */ 
/*     */         public Short2ByteMap.Entry next()
/*     */         {
/* 137 */           if (!hasNext()) throw new NoSuchElementException();
/* 138 */           return new AbstractShort2ByteMap.BasicEntry(Short2ByteArrayMap.this.key[this.next], Short2ByteArrayMap.this.value[(this.next++)]);
/*     */         } } ;
/*     */     }
/*     */ 
...
/* 144 */         int next = 0;
/* 145 */         final AbstractShort2ByteMap.BasicEntry entry = new AbstractShort2ByteMap.BasicEntry((short)0, (byte)0);
/*     */ 
/* 147 */         public boolean hasNext() { return this.next < Short2ByteArrayMap.this.size; }
/*     */ 
/*     */         public Short2ByteMap.Entry next()
/*     */         {
/* 151 */           if (!hasNext()) throw new NoSuchElementException();
/* 152 */           this.entry.key = Short2ByteArrayMap.this.key[this.next];
/* 153 */           this.entry.value = Short2ByteArrayMap.this.value[(this.next++)];
/* 154 */           return this.entry;
/*     */         } } ;
/*     */     }
/*     */ 
/*     */     public int size() {
/* 159 */       return Short2ByteArrayMap.this.size;
/*     */     }
/*     */ 
...
/* 166 */       return (Short2ByteArrayMap.this.containsKey(k)) && (Short2ByteArrayMap.this.get(k) == ((Byte)e.getValue()).byteValue());
/*     */     }
/*     */   }
/*     */ }
