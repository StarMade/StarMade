...
/*      */   {
/*  222 */     int pos = HashCommon.murmurHash3(k) & this.mask;
/*      */ 
...
/*  292 */         int slot = HashCommon.murmurHash3(this.key[pos]) & this.mask;
...
/*  324 */     short k = ((Short)ok).shortValue();
/*      */ 
/*  326 */     int pos = HashCommon.murmurHash3(k) & this.mask;
/*      */ 
...
/*      */ 
/*  422 */     int pos = HashCommon.murmurHash3(k) & mask;
/*      */ 
...
/*      */ 
/*  443 */     int pos = HashCommon.murmurHash3(k) & mask;
/*      */ 
...
/*      */   {
/*  461 */     short[] key = this.key;
/*  462 */     boolean[] used = this.used;
/*  463 */     int mask = this.mask;
/*      */ 
/*  465 */     int pos = HashCommon.murmurHash3(k) & mask;
/*      */ 
...
/*      */   {
/*  500 */     short[] key = this.key;
/*  501 */     boolean[] used = this.used;
/*  502 */     int mask = this.mask;
/*      */ 
/*  504 */     int pos = HashCommon.murmurHash3(k) & mask;
/*      */ 
...
/*  533 */     short k = ok.shortValue();
/*      */ 
/*  535 */     int pos = HashCommon.murmurHash3(k) & this.mask;
/*      */ 
...
/*      */   }
/*  729 */   public ShortComparator comparator() { return null; } 
/*  730 */   public Short2ObjectSortedMap<V> tailMap(short from) { throw new UnsupportedOperationException(); } 
/*  731 */   public Short2ObjectSortedMap<V> headMap(short to) { throw new UnsupportedOperationException(); } 
/*  732 */   public Short2ObjectSortedMap<V> subMap(short from, short to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1048 */           return new Short2ObjectLinkedOpenHashMap.ValueIterator(Short2ObjectLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1051 */           return Short2ObjectLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(Object v) {
/* 1054 */           return Short2ObjectLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1057 */           Short2ObjectLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/* 1140 */     short[] newKey = new short[newN];
...
/* 1147 */       short k = key[i];
/* 1148 */       int pos = HashCommon.murmurHash3(k) & newMask;
...
/*      */     try
/*      */     {
/* 1190 */       c = (Short2ObjectLinkedOpenHashMap)super.clone();
/*      */     }
...
/* 1196 */     c.values = null;
/* 1197 */     c.entries = null;
/* 1198 */     c.key = ((short[])this.key.clone());
...
/* 1242 */     short[] key = this.key = new short[this.n];
...
/* 1251 */       short k = s.readShort();
/* 1252 */       Object v = s.readObject();
/* 1253 */       pos = HashCommon.murmurHash3(k) & this.mask;
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<V>
/*      */   {
/*      */     public V previous()
/*      */     {
/* 1039 */       return Short2ObjectLinkedOpenHashMap.this.value[previousEntry()]; } 
...
/* 1043 */     public V next() { return Short2ObjectLinkedOpenHashMap.this.value[nextEntry()]; }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  996 */       return new Short2ObjectLinkedOpenHashMap.KeyIterator(Short2ObjectLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ShortListIterator iterator() {
/*  999 */       return new Short2ObjectLinkedOpenHashMap.KeyIterator(Short2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1002 */       return Short2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(short k) {
/* 1005 */       return Short2ObjectLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(short k) {
/* 1008 */       int oldSize = Short2ObjectLinkedOpenHashMap.this.size;
/* 1009 */       Short2ObjectLinkedOpenHashMap.this.remove(k);
/* 1010 */       return Short2ObjectLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1013 */       Short2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public short firstShort() {
/* 1016 */       if (Short2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1017 */       return Short2ObjectLinkedOpenHashMap.this.key[Short2ObjectLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public short lastShort() {
/* 1020 */       if (Short2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1021 */       return Short2ObjectLinkedOpenHashMap.this.key[Short2ObjectLinkedOpenHashMap.this.last];
/*      */     }
/* 1023 */     public ShortComparator comparator() { return null; } 
/* 1024 */     public final ShortSortedSet tailSet(short from) { throw new UnsupportedOperationException(); } 
/* 1025 */     public final ShortSortedSet headSet(short to) { throw new UnsupportedOperationException(); } 
/* 1026 */     public final ShortSortedSet subSet(short from, short to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2ObjectLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator(short k)
/*      */     {
/*  983 */       super(k, null); } 
/*  984 */     public short previousShort() { return Short2ObjectLinkedOpenHashMap.this.key[previousEntry()]; } 
/*  985 */     public void set(short k) { throw new UnsupportedOperationException(); } 
/*  986 */     public void add(short k) { throw new UnsupportedOperationException(); } 
/*  987 */     public Short previous() { return Short.valueOf(Short2ObjectLinkedOpenHashMap.this.key[previousEntry()]); } 
/*  988 */     public void set(Short ok) { throw new UnsupportedOperationException(); } 
/*  989 */     public void add(Short ok) { throw new UnsupportedOperationException(); } 
/*  990 */     public KeyIterator() { super(null); } 
/*  991 */     public short nextShort() { return Short2ObjectLinkedOpenHashMap.this.key[nextEntry()]; } 
/*  992 */     public Short next() { return Short.valueOf(Short2ObjectLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/*  911 */       return new Short2ObjectLinkedOpenHashMap.EntryIterator(Short2ObjectLinkedOpenHashMap.this);
/*      */     }
/*  913 */     public Comparator<? super Short2ObjectMap.Entry<V>> comparator() { return null; } 
/*  914 */     public ObjectSortedSet<Short2ObjectMap.Entry<V>> subSet(Short2ObjectMap.Entry<V> fromElement, Short2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  915 */     public ObjectSortedSet<Short2ObjectMap.Entry<V>> headSet(Short2ObjectMap.Entry<V> toElement) { throw new UnsupportedOperationException(); } 
/*  916 */     public ObjectSortedSet<Short2ObjectMap.Entry<V>> tailSet(Short2ObjectMap.Entry<V> fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Short2ObjectMap.Entry<V> first() {
/*  918 */       if (Short2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  919 */       return new Short2ObjectLinkedOpenHashMap.MapEntry(Short2ObjectLinkedOpenHashMap.this, Short2ObjectLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Short2ObjectMap.Entry<V> last() {
/*  922 */       if (Short2ObjectLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  923 */       return new Short2ObjectLinkedOpenHashMap.MapEntry(Short2ObjectLinkedOpenHashMap.this, Short2ObjectLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
/*      */     public boolean contains(Object o) {
/*  927 */       if (!(o instanceof Map.Entry)) return false;
/*  928 */       Map.Entry e = (Map.Entry)o;
/*  929 */       short k = ((Short)e.getKey()).shortValue();
/*      */ 
/*  931 */       int pos = HashCommon.murmurHash3(k) & Short2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  933 */       while (Short2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  934 */         if (Short2ObjectLinkedOpenHashMap.this.key[pos] == k) return Short2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : e.getValue() == null ? true : Short2ObjectLinkedOpenHashMap.this.value[pos].equals(e.getValue());
/*  935 */         pos = pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  937 */       return false;
/*      */     }
/*      */ 
...
/*  943 */       short k = ((Short)e.getKey()).shortValue();
/*      */ 
/*  945 */       int pos = HashCommon.murmurHash3(k) & Short2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  947 */       while (Short2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  948 */         if (Short2ObjectLinkedOpenHashMap.this.key[pos] == k) {
/*  949 */           Short2ObjectLinkedOpenHashMap.this.remove(e.getKey());
/*  950 */           return true;
/*      */         }
/*  952 */         pos = pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask;
/*      */       }
/*  954 */       return false;
/*      */     }
/*      */     public int size() {
/*  957 */       return Short2ObjectLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/*  960 */       Short2ObjectLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> iterator(Short2ObjectMap.Entry<V> from) {
/*  963 */       return new Short2ObjectLinkedOpenHashMap.EntryIterator(Short2ObjectLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> fastIterator() {
/*  966 */       return new Short2ObjectLinkedOpenHashMap.FastEntryIterator(Short2ObjectLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> fastIterator(Short2ObjectMap.Entry<V> from) {
/*  969 */       return new Short2ObjectLinkedOpenHashMap.FastEntryIterator(Short2ObjectLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Short2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Short2ObjectMap.Entry<V>>
/*      */   {
/*  889 */     final AbstractShort2ObjectMap.BasicEntry<V> entry = new AbstractShort2ObjectMap.BasicEntry((short)0, null);
/*      */ 
...
/*  895 */       int e = nextEntry();
/*  896 */       this.entry.key = Short2ObjectLinkedOpenHashMap.this.key[e];
/*  897 */       this.entry.value = Short2ObjectLinkedOpenHashMap.this.value[e];
/*  898 */       return this.entry;
/*      */     }
/*      */     public AbstractShort2ObjectMap.BasicEntry<V> previous() {
/*  901 */       int e = previousEntry();
/*  902 */       this.entry.key = Short2ObjectLinkedOpenHashMap.this.key[e];
/*  903 */       this.entry.value = Short2ObjectLinkedOpenHashMap.this.value[e];
/*  904 */       return this.entry;
/*      */     }
/*  906 */     public void set(Short2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  907 */     public void add(Short2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2ObjectLinkedOpenHashMap<V>.MapIterator
/*      */     implements ObjectListIterator<Short2ObjectMap.Entry<V>>
/*      */   {
...
/*  870 */       super(null);
/*      */     }
/*  872 */     public EntryIterator(short from) { super(from, null); }
/*      */ 
/*      */     public Short2ObjectLinkedOpenHashMap<V>.MapEntry next() {
/*  875 */       return this.entry = new Short2ObjectLinkedOpenHashMap.MapEntry(Short2ObjectLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Short2ObjectLinkedOpenHashMap<V>.MapEntry previous() {
/*  878 */       return this.entry = new Short2ObjectLinkedOpenHashMap.MapEntry(Short2ObjectLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  882 */       super.remove();
/*  883 */       Short2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  885 */     public void set(Short2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); } 
/*  886 */     public void add(Short2ObjectMap.Entry<V> ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  747 */     int index = -1;
/*      */ 
/*  749 */     private MapIterator() { this.next = Short2ObjectLinkedOpenHashMap.this.first;
/*  750 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(short from) {
/*  753 */       if (Short2ObjectLinkedOpenHashMap.this.key[Short2ObjectLinkedOpenHashMap.this.last] == from) {
/*  754 */         this.prev = Short2ObjectLinkedOpenHashMap.this.last;
/*  755 */         this.index = Short2ObjectLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  759 */         int pos = HashCommon.murmurHash3(from) & Short2ObjectLinkedOpenHashMap.this.mask;
/*      */ 
/*  761 */         while (Short2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  762 */           if (Short2ObjectLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  764 */             this.next = ((int)Short2ObjectLinkedOpenHashMap.this.link[pos]);
/*  765 */             this.prev = pos;
/*  766 */             return;
/*      */           }
/*  768 */           pos = pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  781 */       if (this.next == -1) {
/*  782 */         this.index = Short2ObjectLinkedOpenHashMap.this.size;
/*  783 */         return;
/*      */       }
/*  785 */       int pos = Short2ObjectLinkedOpenHashMap.this.first;
/*  786 */       this.index = 1;
/*  787 */       while (pos != this.prev) {
/*  788 */         pos = (int)Short2ObjectLinkedOpenHashMap.this.link[pos];
/*  789 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  801 */       if (!hasNext()) return Short2ObjectLinkedOpenHashMap.this.size();
/*  802 */       this.curr = this.next;
/*  803 */       this.next = ((int)Short2ObjectLinkedOpenHashMap.this.link[this.curr]);
...
/*  811 */       this.prev = ((int)(Short2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  823 */         this.index -= 1;
/*  824 */         this.prev = ((int)(Short2ObjectLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  827 */         this.next = ((int)Short2ObjectLinkedOpenHashMap.this.link[this.curr]);
/*  828 */       }Short2ObjectLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  831 */       if (this.prev == -1) Short2ObjectLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  833 */         Short2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Short2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  834 */       if (this.next == -1) Short2ObjectLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  836 */         Short2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Short2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  840 */         pos = (last = pos) + 1 & Short2ObjectLinkedOpenHashMap.this.mask;
/*  841 */         while (Short2ObjectLinkedOpenHashMap.this.used[pos] != 0) {
/*  842 */           int slot = HashCommon.murmurHash3(Short2ObjectLinkedOpenHashMap.this.key[pos]) & Short2ObjectLinkedOpenHashMap.this.mask;
/*  843 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  844 */           pos = pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask;
/*      */         }
/*  846 */         if (Short2ObjectLinkedOpenHashMap.this.used[pos] == 0) break;
/*  847 */         Short2ObjectLinkedOpenHashMap.this.key[last] = Short2ObjectLinkedOpenHashMap.this.key[pos];
/*  848 */         Short2ObjectLinkedOpenHashMap.this.value[last] = Short2ObjectLinkedOpenHashMap.this.value[pos];
/*  849 */         if (this.next == pos) this.next = last;
/*  850 */         if (this.prev == pos) this.prev = last;
/*  851 */         Short2ObjectLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  853 */       Short2ObjectLinkedOpenHashMap.this.used[last] = false;
/*  854 */       Short2ObjectLinkedOpenHashMap.this.value[last] = null;
/*  855 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Short getKey() {
/*  619 */       return Short.valueOf(Short2ObjectLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public short getShortKey() {
/*  622 */       return Short2ObjectLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public V getValue() {
/*  625 */       return Short2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public V setValue(V v) {
/*  628 */       Object oldValue = Short2ObjectLinkedOpenHashMap.this.value[this.index];
/*  629 */       Short2ObjectLinkedOpenHashMap.this.value[this.index] = v;
/*  630 */       return oldValue;
/*      */     }
/*      */ 
...
/*  636 */       return (Short2ObjectLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2ObjectLinkedOpenHashMap.this.value[this.index] == null ? e.getValue() == null : Short2ObjectLinkedOpenHashMap.this.value[this.index].equals(e.getValue()));
/*      */     }
/*      */     public int hashCode() {
/*  639 */       return Short2ObjectLinkedOpenHashMap.this.key[this.index] ^ (Short2ObjectLinkedOpenHashMap.this.value[this.index] == null ? 0 : Short2ObjectLinkedOpenHashMap.this.value[this.index].hashCode());
/*      */     }
/*      */     public String toString() {
/*  642 */       return Short2ObjectLinkedOpenHashMap.this.key[this.index] + "=>" + Short2ObjectLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
