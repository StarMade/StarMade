  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2ObjectLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Short2ObjectLinkedOpenHashMap(Map<? extends Short, ? extends V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2ObjectLinkedOpenHashMap(Map<? extends Short, ? extends V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2ObjectLinkedOpenHashMap(Short2ObjectMap<V> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2ObjectLinkedOpenHashMap(Short2ObjectMap<V> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2ObjectLinkedOpenHashMap(short[] local_k, V[] local_v, float local_f)
  {
  ...
  public Short2ObjectLinkedOpenHashMap(short[] local_k, V[] local_v)
  {
  ...
  public ObjectCollection<V> values()
  {
    if (this.values == null) {
      this.values = new AbstractObjectCollection()
      {
        ...
        {
          return new Short2ObjectLinkedOpenHashMap.ValueIterator(Short2ObjectLinkedOpenHashMap.this);
        }
        ...
        {
          return Short2ObjectLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2ObjectLinkedOpenHashMap<V> local_c;
    try
    {
      local_c = (Short2ObjectLinkedOpenHashMap)super.clone();
    }
    ...
    throws IOException
  {
    short[] key = this.key;
    V[] value = this.value;
    Short2ObjectLinkedOpenHashMap<V>.MapIterator local_i = new MapIterator(null);
    ...
    extends AbstractShortSortedSet
  {
    ...
    {
      return new Short2ObjectLinkedOpenHashMap.KeyIterator(Short2ObjectLinkedOpenHashMap.this, from);
    }
    
    public ShortListIterator iterator()
    {
      return new Short2ObjectLinkedOpenHashMap.KeyIterator(Short2ObjectLinkedOpenHashMap.this);
    }
    ...
    {
      return Short2ObjectLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2ObjectLinkedOpenHashMap.this.size;
      Short2ObjectLinkedOpenHashMap.this.remove(local_k);
  ...
  private final class KeyIterator
    extends Short2ObjectLinkedOpenHashMap.MapIterator
    implements ShortListIterator
  {
    ...
    {
      return Short.valueOf(Short2ObjectLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Short next()
    {
      return Short.valueOf(Short2ObjectLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Short2ObjectSortedMap.FastSortedEntrySet<V>
  {
    ...
    {
      return new Short2ObjectLinkedOpenHashMap.EntryIterator(Short2ObjectLinkedOpenHashMap.this);
    }
    ...
    public Short2ObjectMap.Entry<V> first()
    {
      ...
      return new Short2ObjectLinkedOpenHashMap.MapEntry(Short2ObjectLinkedOpenHashMap.this, Short2ObjectLinkedOpenHashMap.this.first);
    }
    ...
    public Short2ObjectMap.Entry<V> last()
    {
      ...
      return new Short2ObjectLinkedOpenHashMap.MapEntry(Short2ObjectLinkedOpenHashMap.this, Short2ObjectLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2ObjectLinkedOpenHashMap.this.mask; Short2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask) {
        if (Short2ObjectLinkedOpenHashMap.this.key[pos] == local_k) {
          return Short2ObjectLinkedOpenHashMap.this.value[pos] == null ? false : local_e.getValue() == null ? true : Short2ObjectLinkedOpenHashMap.this.value[pos].equals(local_e.getValue());
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2ObjectLinkedOpenHashMap.this.mask; Short2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask) {
        if (Short2ObjectLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Short2ObjectLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Short2ObjectLinkedOpenHashMap.EntryIterator(Short2ObjectLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
    }
    
    public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> fastIterator()
    {
      return new Short2ObjectLinkedOpenHashMap.FastEntryIterator(Short2ObjectLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Short2ObjectMap.Entry<V>> fastIterator(Short2ObjectMap.Entry<V> from)
    {
      return new Short2ObjectLinkedOpenHashMap.FastEntryIterator(Short2ObjectLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
    }
  }
    ...
    implements ObjectListIterator<Short2ObjectMap.Entry<V>>
  {
    ...
    public AbstractShort2ObjectMap.BasicEntry<V> next()
    {
      ...
      this.entry.key = Short2ObjectLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Short2ObjectLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Short2ObjectMap.Entry<V>>
  {
    ...
    {
      return this.entry = new Short2ObjectLinkedOpenHashMap.MapEntry(Short2ObjectLinkedOpenHashMap.this, nextEntry());
    }
    
    public Short2ObjectLinkedOpenHashMap<V>.MapEntry previous()
    {
      return this.entry = new Short2ObjectLinkedOpenHashMap.MapEntry(Short2ObjectLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2ObjectLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(short from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Short2ObjectLinkedOpenHashMap.this.mask; Short2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Short2ObjectLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Short2ObjectLinkedOpenHashMap.this.first = this.next;
      } else {
        Short2ObjectLinkedOpenHashMap.this.link[this.prev] ^= (Short2ObjectLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Short2ObjectLinkedOpenHashMap.this.last = this.prev;
      } else {
        Short2ObjectLinkedOpenHashMap.this.link[this.next] ^= (Short2ObjectLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2ObjectLinkedOpenHashMap.this.mask; Short2ObjectLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2ObjectLinkedOpenHashMap.this.mask)
        {
        ...
        if (Short2ObjectLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
    ...
    implements Short2ObjectMap.Entry<V>, Map.Entry<Short, V>
  {
    ...
    public V setValue(V local_v)
    {
      ...
      Short2ObjectLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, V> local_e = (Map.Entry)local_o;
      return (Short2ObjectLinkedOpenHashMap.this.key[this.index] == ((Short)local_e.getKey()).shortValue()) && (Short2ObjectLinkedOpenHashMap.this.value[this.index] == null ? local_e.getValue() == null : Short2ObjectLinkedOpenHashMap.this.value[this.index].equals(local_e.getValue()));
    }
