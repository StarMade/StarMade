...
/*      */ 
/*      */ public class Short2LongAVLTreeMap extends AbstractShort2LongSortedMap
...
/*  117 */           return Short2LongAVLTreeMap.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*      */         }
/*      */         public int compare(Short ok1, Short ok2) {
/*  120 */           return Short2LongAVLTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  779 */     long oldValue = put(ok.shortValue(), ov.longValue());
/*  780 */     return this.modified ? null : Long.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Long remove(Object ok)
/*      */   {
/*  788 */     long oldValue = remove(((Short)ok).shortValue());
...
/* 1203 */         final Comparator<? super Short2LongMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Short2LongMap.Entry x, Short2LongMap.Entry y) {
/* 1205 */             return Short2LongAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1203 */         };
/*      */ 
...
/* 1212 */           return new Short2LongAVLTreeMap.EntryIterator(Short2LongAVLTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from) {
/* 1215 */           return new Short2LongAVLTreeMap.EntryIterator(Short2LongAVLTreeMap.this, ((Short)from.getKey()).shortValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1219 */           if (!(o instanceof Map.Entry)) return false;
/* 1220 */           Map.Entry e = (Map.Entry)o;
/* 1221 */           Short2LongAVLTreeMap.Entry f = Short2LongAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1228 */           Short2LongAVLTreeMap.Entry f = Short2LongAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1229 */           if (f != null) Short2LongAVLTreeMap.this.remove(f.key);
/* 1230 */           return f != null;
/*      */         }
/* 1232 */         public int size() { return Short2LongAVLTreeMap.this.count; } 
/* 1233 */         public void clear() { Short2LongAVLTreeMap.this.clear(); } 
/* 1234 */         public Short2LongMap.Entry first() { return Short2LongAVLTreeMap.this.firstEntry; } 
/* 1235 */         public Short2LongMap.Entry last() { return Short2LongAVLTreeMap.this.lastEntry; } 
/* 1236 */         public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) { return Short2LongAVLTreeMap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2LongEntrySet(); } 
/* 1237 */         public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry to) { return Short2LongAVLTreeMap.this.headMap((Short)to.getKey()).short2LongEntrySet(); } 
/* 1238 */         public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from) { return Short2LongAVLTreeMap.this.tailMap((Short)from.getKey()).short2LongEntrySet(); }
/*      */       };
...
/* 1304 */           return new Short2LongAVLTreeMap.ValueIterator(Short2LongAVLTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(long k) {
/* 1307 */           return Short2LongAVLTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1310 */           return Short2LongAVLTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1313 */           Short2LongAVLTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1677 */       c = (Short2LongAVLTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1749 */     if (n == 1) {
/* 1750 */       Entry top = new Entry(s.readShort(), s.readLong());
/* 1751 */       top.pred(pred);
/* 1752 */       top.succ(succ);
/* 1753 */       return top;
/*      */     }
/* 1755 */     if (n == 2)
/*      */     {
/* 1758 */       Entry top = new Entry(s.readShort(), s.readLong());
/* 1759 */       top.right(new Entry(s.readShort(), s.readLong()));
...
/*      */     {
/* 1366 */       if ((!bottom) && (!top) && (Short2LongAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367 */       this.from = from;
/* 1368 */       this.bottom = bottom;
/* 1369 */       this.to = to;
/* 1370 */       this.top = top;
/* 1371 */       this.defRetValue = Short2LongAVLTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */     {
/* 1385 */       return ((this.bottom) || (Short2LongAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Short2LongAVLTreeMap.this.compare(k, this.to) < 0));
/*      */     }
/*      */ 
/*      */     public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet() {
/* 1389 */       if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/*      */           public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator() {
/* 1391 */             return new Short2LongAVLTreeMap.Submap.SubmapEntryIterator(Short2LongAVLTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from) {
/* 1394 */             return new Short2LongAVLTreeMap.Submap.SubmapEntryIterator(Short2LongAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
/*      */           }
/* 1396 */           public Comparator<? super Short2LongMap.Entry> comparator() { return Short2LongAVLTreeMap.this.entrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1399 */             if (!(o instanceof Map.Entry)) return false;
/* 1400 */             Map.Entry e = (Map.Entry)o;
/* 1401 */             Short2LongAVLTreeMap.Entry f = Short2LongAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1402 */             return (f != null) && (Short2LongAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1406 */             if (!(o instanceof Map.Entry)) return false;
/* 1407 */             Map.Entry e = (Map.Entry)o;
/* 1408 */             Short2LongAVLTreeMap.Entry f = Short2LongAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1409 */             if ((f != null) && (Short2LongAVLTreeMap.Submap.this.in(f.key))) Short2LongAVLTreeMap.Submap.this.remove(f.key);
/* 1410 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1413 */             int c = 0;
...
/*      */           }
/*      */           public boolean isEmpty() {
/* 1418 */             return !new Short2LongAVLTreeMap.Submap.SubmapIterator(Short2LongAVLTreeMap.Submap.this).hasNext();
/*      */           }
/*      */           public void clear() {
/* 1421 */             Short2LongAVLTreeMap.Submap.this.clear();
/*      */           }
/* 1423 */           public Short2LongMap.Entry first() { return Short2LongAVLTreeMap.Submap.this.firstEntry(); } 
/* 1424 */           public Short2LongMap.Entry last() { return Short2LongAVLTreeMap.Submap.this.lastEntry(); } 
/* 1425 */           public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry to) { return Short2LongAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2LongEntrySet(); } 
/* 1426 */           public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry to) { return Short2LongAVLTreeMap.Submap.this.headMap((Short)to.getKey()).short2LongEntrySet(); } 
/* 1427 */           public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from) { return Short2LongAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2LongEntrySet(); }
/*      */         };
...
/*      */           public LongIterator iterator() {
/* 1442 */             return new Short2LongAVLTreeMap.Submap.SubmapValueIterator(Short2LongAVLTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(long k) {
/* 1445 */             return Short2LongAVLTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1448 */             return Short2LongAVLTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1451 */             Short2LongAVLTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(short k) {
/* 1458 */       return (in(k)) && (Short2LongAVLTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(long v) {
...
/* 1473 */       return (in(kk)) && ((e = Short2LongAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public long put(short k, long v) {
/* 1476 */       Short2LongAVLTreeMap.this.modified = false;
...
/* 1478 */       long oldValue = Short2LongAVLTreeMap.this.put(k, v);
/* 1479 */       return Short2LongAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Long put(Short ok, Long ov) {
/* 1482 */       long oldValue = put(ok.shortValue(), ov.longValue());
/* 1483 */       return Short2LongAVLTreeMap.this.modified ? null : Long.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public long remove(short k) {
/* 1487 */       Short2LongAVLTreeMap.this.modified = false;
/* 1488 */       if (!in(k)) return this.defRetValue;
/* 1489 */       long oldValue = Short2LongAVLTreeMap.this.remove(k);
/* 1490 */       return Short2LongAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Long remove(Object ok) {
/* 1493 */       long oldValue = remove(((Short)ok).shortValue());
/* 1494 */       return Short2LongAVLTreeMap.this.modified ? Long.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ShortComparator comparator() {
/* 1509 */       return Short2LongAVLTreeMap.this.actualComparator;
/*      */     }
/*      */     public Short2LongSortedMap headMap(short to) {
/* 1512 */       if (this.top) return new Submap(Short2LongAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513 */       return Short2LongAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Short2LongAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Short2LongSortedMap tailMap(short from) {
/* 1516 */       if (this.bottom) return new Submap(Short2LongAVLTreeMap.this, from, false, this.to, this.top);
/* 1517 */       return Short2LongAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2LongAVLTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Short2LongSortedMap subMap(short from, short to) {
/* 1520 */       if ((this.top) && (this.bottom)) return new Submap(Short2LongAVLTreeMap.this, from, false, to, false);
/* 1521 */       if (!this.top) to = Short2LongAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522 */       if (!this.bottom) from = Short2LongAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524 */       return new Submap(Short2LongAVLTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Short2LongAVLTreeMap.Entry firstEntry()
/*      */     {
/* 1531 */       if (Short2LongAVLTreeMap.this.tree == null) return null;
/* 1534 */       Short2LongAVLTreeMap.Entry e;
/*      */       Short2LongAVLTreeMap.Entry e;
/* 1534 */       if (this.bottom) { e = Short2LongAVLTreeMap.this.firstEntry;
/*      */       } else {
/* 1536 */         e = Short2LongAVLTreeMap.this.locateKey(this.from);
/*      */ 
/* 1538 */         if (Short2LongAVLTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1541 */       if ((e == null) || ((!this.top) && (Short2LongAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542 */       return e;
/*      */     }
/*      */ 
/*      */     public Short2LongAVLTreeMap.Entry lastEntry()
/*      */     {
/* 1549 */       if (Short2LongAVLTreeMap.this.tree == null) return null;
/* 1552 */       Short2LongAVLTreeMap.Entry e;
/*      */       Short2LongAVLTreeMap.Entry e;
/* 1552 */       if (this.top) { e = Short2LongAVLTreeMap.this.lastEntry;
/*      */       } else {
/* 1554 */         e = Short2LongAVLTreeMap.this.locateKey(this.to);
/*      */ 
/* 1556 */         if (Short2LongAVLTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1559 */       if ((e == null) || ((!this.bottom) && (Short2LongAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560 */       return e;
/*      */     }
/*      */     public short firstShortKey() {
/* 1563 */       Short2LongAVLTreeMap.Entry e = firstEntry();
/* 1564 */       if (e == null) throw new NoSuchElementException();
/* 1565 */       return e.key;
/*      */     }
/*      */     public short lastShortKey() {
/* 1568 */       Short2LongAVLTreeMap.Entry e = lastEntry();
/* 1569 */       if (e == null) throw new NoSuchElementException();
/* 1570 */       return e.key;
/*      */     }
/*      */     public Short firstKey() {
/* 1573 */       Short2LongAVLTreeMap.Entry e = firstEntry();
/* 1574 */       if (e == null) throw new NoSuchElementException();
/* 1575 */       return e.getKey();
/*      */     }
/*      */     public Short lastKey() {
/* 1578 */       Short2LongAVLTreeMap.Entry e = lastEntry();
/* 1579 */       if (e == null) throw new NoSuchElementException();
/* 1580 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Short2LongAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Short2LongAVLTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Short2LongAVLTreeMap.Submap.SubmapIterator
...
/* 1623 */       public Short2LongMap.Entry previous() { return previousEntry(); } 
/* 1624 */       public void set(Short2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1625 */       public void add(Short2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1590 */         super();
/* 1591 */         this.next = Short2LongAVLTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1594 */         this();
/* 1595 */         if (this.next != null)
/* 1596 */           if ((!Short2LongAVLTreeMap.Submap.this.bottom) && (Short2LongAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597 */           } else if ((!Short2LongAVLTreeMap.Submap.this.top) && (Short2LongAVLTreeMap.this.compare(k, (this.prev = Short2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1599 */             this.next = Short2LongAVLTreeMap.this.locateKey(k);
/* 1600 */             if (Short2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610 */         if ((!Short2LongAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2LongAVLTreeMap.this.compare(this.prev.key, Short2LongAVLTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1613 */         this.next = this.next.next();
/* 1614 */         if ((!Short2LongAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2LongAVLTreeMap.this.compare(this.next.key, Short2LongAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1431 */         super(); } 
/* 1432 */       public ShortBidirectionalIterator iterator() { return new Short2LongAVLTreeMap.Submap.SubmapKeyIterator(Short2LongAVLTreeMap.Submap.this); } 
/* 1433 */       public ShortBidirectionalIterator iterator(short from) { return new Short2LongAVLTreeMap.Submap.SubmapKeyIterator(Short2LongAVLTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2LongAVLTreeMap.TreeIterator
/*      */     implements LongListIterator
/*      */   {
...
/*      */     {
/* 1261 */       super(); } 
/* 1262 */     public ShortBidirectionalIterator iterator() { return new Short2LongAVLTreeMap.KeyIterator(Short2LongAVLTreeMap.this); } 
/* 1263 */     public ShortBidirectionalIterator iterator(short from) { return new Short2LongAVLTreeMap.KeyIterator(Short2LongAVLTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2LongAVLTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2LongAVLTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Short2LongMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1197 */     public Short2LongMap.Entry previous() { return previousEntry(); } 
/* 1198 */     public void set(Short2LongMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1199 */     public void add(Short2LongMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1124 */     int index = 0;
/*      */ 
/* 1126 */     TreeIterator() { this.next = Short2LongAVLTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(short k) {
/* 1129 */       if ((this.next = Short2LongAVLTreeMap.this.locateKey(k)) != null)
/* 1130 */         if (Short2LongAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1171 */       updatePrevious();
/* 1172 */       updateNext();
/* 1173 */       Short2LongAVLTreeMap.this.remove(this.curr.key);
/* 1174 */       this.curr = null;
/*      */     }
...
/*      */ 
/* 1038 */       return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == ((Long)e.getValue()).longValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
