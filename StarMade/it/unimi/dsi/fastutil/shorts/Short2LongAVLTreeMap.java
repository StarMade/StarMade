  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2LongAVLTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2LongAVLTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2LongAVLTreeMap(Map<? extends Short, ? extends Long> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2LongAVLTreeMap(SortedMap<Short, Long> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2LongAVLTreeMap(Short2LongMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2LongAVLTreeMap(Short2LongSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2LongAVLTreeMap(short[] local_k, long[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2LongAVLTreeMap(short[] local_k, long[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2LongMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Short2LongAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2LongAVLTreeMap.EntryIterator(Short2LongAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from)
        {
          return new Short2LongAVLTreeMap.EntryIterator(Short2LongAVLTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2LongAVLTreeMap.Entry local_f = Short2LongAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2LongAVLTreeMap.Entry local_f = Short2LongAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2LongAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2LongAVLTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2LongEntrySet();
        }
        
        public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry local_to)
        {
          return Short2LongAVLTreeMap.this.headMap((Short)local_to.getKey()).short2LongEntrySet();
        }
        
        public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from)
        {
          return Short2LongAVLTreeMap.this.tailMap((Short)from.getKey()).short2LongEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public LongCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractLongCollection()
      {
        ...
        {
          return new Short2LongAVLTreeMap.ValueIterator(Short2LongAVLTreeMap.this, null);
        }
        
        public boolean contains(long local_k)
        {
          return Short2LongAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2LongAVLTreeMap local_c;
    try
    {
      local_c = (Short2LongAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2LongAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2LongAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2LongAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2LongMap.Entry> short2LongEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator()
          {
            return new Short2LongAVLTreeMap.Submap.SubmapEntryIterator(Short2LongAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2LongMap.Entry> iterator(Short2LongMap.Entry from)
          {
            return new Short2LongAVLTreeMap.Submap.SubmapEntryIterator(Short2LongAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Long> local_e = (Map.Entry)local_o;
            Short2LongAVLTreeMap.Entry local_f = Short2LongAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2LongAVLTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Long> local_e = (Map.Entry)local_o;
            Short2LongAVLTreeMap.Entry local_f = Short2LongAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2LongAVLTreeMap.Submap.this.in6(local_f.key))) {
              Short2LongAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2LongAVLTreeMap.Submap.SubmapIterator(Short2LongAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2LongAVLTreeMap.Submap.this.clear();
          }
          
          public Short2LongMap.Entry first()
          {
            return Short2LongAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Short2LongMap.Entry last()
          {
            return Short2LongAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2LongMap.Entry> subSet(Short2LongMap.Entry from, Short2LongMap.Entry local_to)
          {
            return Short2LongAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2LongEntrySet();
          }
          
          public ObjectSortedSet<Short2LongMap.Entry> headSet(Short2LongMap.Entry local_to)
          {
            return Short2LongAVLTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2LongEntrySet();
          }
          
          public ObjectSortedSet<Short2LongMap.Entry> tailSet(Short2LongMap.Entry from)
          {
            return Short2LongAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2LongEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public LongCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractLongCollection()
        {
          public LongIterator iterator()
          {
            return new Short2LongAVLTreeMap.Submap.SubmapValueIterator(Short2LongAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(long local_k)
          {
            return Short2LongAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2LongAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2LongAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2LongAVLTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2LongAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public long put(short local_k, long local_v)
    {
      ...
      long oldValue = Short2LongAVLTreeMap.this.put(local_k, local_v);
    ...
    public long remove(short local_k)
    {
      ...
      long oldValue = Short2LongAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2LongAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2LongAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2LongSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2LongAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2LongAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2LongAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2LongSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2LongAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2LongAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2LongAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2LongAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2LongAVLTreeMap.this.locateKey(this.from);
        if (Short2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2LongAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2LongAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2LongAVLTreeMap.this.locateKey(this.field_47);
        if (Short2LongAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2LongAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2LongAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2LongAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2LongAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2LongAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2LongAVLTreeMap.Submap.this.bottom) && (Short2LongAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2LongAVLTreeMap.Submap.this.top) && (Short2LongAVLTreeMap.this.compare(local_k, (this.prev = Short2LongAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2LongAVLTreeMap.this.locateKey(local_k);
            if (Short2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2LongAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2LongAVLTreeMap.this.compare(this.prev.key, Short2LongAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2LongAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2LongAVLTreeMap.this.compare(this.next.key, Short2LongAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2LongSortedMap.KeySet
    {
      ...
      {
        return new Short2LongAVLTreeMap.Submap.SubmapKeyIterator(Short2LongAVLTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2LongAVLTreeMap.Submap.SubmapKeyIterator(Short2LongAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2LongSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2LongAVLTreeMap.KeyIterator(Short2LongAVLTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2LongAVLTreeMap.KeyIterator(Short2LongAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2LongAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Short2LongAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
