  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2DoubleAVLTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2DoubleAVLTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2DoubleAVLTreeMap(Map<? extends Short, ? extends Double> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2DoubleAVLTreeMap(SortedMap<Short, Double> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2DoubleAVLTreeMap(Short2DoubleMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2DoubleAVLTreeMap(Short2DoubleSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2DoubleAVLTreeMap(short[] local_k, double[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2DoubleAVLTreeMap(short[] local_k, double[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2DoubleMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Short2DoubleAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2DoubleAVLTreeMap.EntryIterator(Short2DoubleAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from)
        {
          return new Short2DoubleAVLTreeMap.EntryIterator(Short2DoubleAVLTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2DoubleAVLTreeMap.Entry local_f = Short2DoubleAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2DoubleAVLTreeMap.Entry local_f = Short2DoubleAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2DoubleAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2DoubleAVLTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry local_to)
        {
          return Short2DoubleAVLTreeMap.this.headMap((Short)local_to.getKey()).short2DoubleEntrySet();
        }
        
        public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry from)
        {
          return Short2DoubleAVLTreeMap.this.tailMap((Short)from.getKey()).short2DoubleEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public DoubleCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractDoubleCollection()
      {
        ...
        {
          return new Short2DoubleAVLTreeMap.ValueIterator(Short2DoubleAVLTreeMap.this, null);
        }
        
        public boolean contains(double local_k)
        {
          return Short2DoubleAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2DoubleAVLTreeMap local_c;
    try
    {
      local_c = (Short2DoubleAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2DoubleAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2DoubleAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2DoubleAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2DoubleMap.Entry> short2DoubleEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator()
          {
            return new Short2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Short2DoubleAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2DoubleMap.Entry> iterator(Short2DoubleMap.Entry from)
          {
            return new Short2DoubleAVLTreeMap.Submap.SubmapEntryIterator(Short2DoubleAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Double> local_e = (Map.Entry)local_o;
            Short2DoubleAVLTreeMap.Entry local_f = Short2DoubleAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2DoubleAVLTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Double> local_e = (Map.Entry)local_o;
            Short2DoubleAVLTreeMap.Entry local_f = Short2DoubleAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2DoubleAVLTreeMap.Submap.this.in6(local_f.key))) {
              Short2DoubleAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2DoubleAVLTreeMap.Submap.SubmapIterator(Short2DoubleAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2DoubleAVLTreeMap.Submap.this.clear();
          }
          
          public Short2DoubleMap.Entry first()
          {
            return Short2DoubleAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Short2DoubleMap.Entry last()
          {
            return Short2DoubleAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2DoubleMap.Entry> subSet(Short2DoubleMap.Entry from, Short2DoubleMap.Entry local_to)
          {
            return Short2DoubleAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Short2DoubleMap.Entry> headSet(Short2DoubleMap.Entry local_to)
          {
            return Short2DoubleAVLTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2DoubleEntrySet();
          }
          
          public ObjectSortedSet<Short2DoubleMap.Entry> tailSet(Short2DoubleMap.Entry from)
          {
            return Short2DoubleAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2DoubleEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public DoubleCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractDoubleCollection()
        {
          public DoubleIterator iterator()
          {
            return new Short2DoubleAVLTreeMap.Submap.SubmapValueIterator(Short2DoubleAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(double local_k)
          {
            return Short2DoubleAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2DoubleAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2DoubleAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2DoubleAVLTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2DoubleAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public double put(short local_k, double local_v)
    {
      ...
      double oldValue = Short2DoubleAVLTreeMap.this.put(local_k, local_v);
    ...
    public double remove(short local_k)
    {
      ...
      double oldValue = Short2DoubleAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2DoubleAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2DoubleSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2DoubleAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2DoubleAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2DoubleAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2DoubleSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2DoubleAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2DoubleAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2DoubleAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2DoubleAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2DoubleAVLTreeMap.this.locateKey(this.from);
        if (Short2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2DoubleAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2DoubleAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2DoubleAVLTreeMap.this.locateKey(this.field_47);
        if (Short2DoubleAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2DoubleAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2DoubleAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2DoubleAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2DoubleAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2DoubleAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2DoubleAVLTreeMap.Submap.this.bottom) && (Short2DoubleAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2DoubleAVLTreeMap.Submap.this.top) && (Short2DoubleAVLTreeMap.this.compare(local_k, (this.prev = Short2DoubleAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2DoubleAVLTreeMap.this.locateKey(local_k);
            if (Short2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2DoubleAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2DoubleAVLTreeMap.this.compare(this.prev.key, Short2DoubleAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2DoubleAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2DoubleAVLTreeMap.this.compare(this.next.key, Short2DoubleAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2DoubleSortedMap.KeySet
    {
      ...
      {
        return new Short2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Short2DoubleAVLTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2DoubleAVLTreeMap.Submap.SubmapKeyIterator(Short2DoubleAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2DoubleSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2DoubleAVLTreeMap.KeyIterator(Short2DoubleAVLTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2DoubleAVLTreeMap.KeyIterator(Short2DoubleAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2DoubleAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Short2DoubleAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
