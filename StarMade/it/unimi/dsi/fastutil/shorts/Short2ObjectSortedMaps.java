...
public class Short2ObjectSortedMaps
{
  ...
  public static <V> Short2ObjectSortedMap<V> synchronize(Short2ObjectSortedMap<V> local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static <V> Short2ObjectSortedMap<V> synchronize(Short2ObjectSortedMap<V> local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static <V> Short2ObjectSortedMap<V> unmodifiable(Short2ObjectSortedMap<V> local_m)
  {
    ...
    implements Short2ObjectSortedMap<V>, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Short2ObjectSortedMap<V> local_m)
    {
      super();
    ...
    implements Short2ObjectSortedMap<V>, Serializable
  {
    ...
    protected SynchronizedSortedMap(Short2ObjectSortedMap<V> local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Short2ObjectSortedMap<V> local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Short2ObjectSortedMap<V>, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Short2ObjectMaps.Singleton.SingletonEntry(this), Short2ObjectSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
