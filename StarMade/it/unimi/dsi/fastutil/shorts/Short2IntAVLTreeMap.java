...
/*   21:     */
/*   73:     */public class Short2IntAVLTreeMap
/*   74:     */  extends AbstractShort2IntSortedMap
...
/*   81:     */  protected volatile transient ObjectSortedSet<Short2IntMap.Entry> entries;
...
/*  117: 117 */          return Short2IntAVLTreeMap.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*  118:     */        }
/*  119:     */        
/*  120: 120 */        public int compare(Short ok1, Short ok2) { return Short2IntAVLTreeMap.this.storedComparator.compare(ok1, ok2); }
/*  121:     */      };
/*  122:     */    }
/*  123:     */  }
/*  124:     */  
/*  131:     */  public Short2IntAVLTreeMap(Comparator<? super Short> c)
/*  132:     */  {
/*  133: 133 */    this();
...
/*  136:     */  }
/*  137:     */  
/*  143:     */  public Short2IntAVLTreeMap(Map<? extends Short, ? extends Integer> m)
/*  144:     */  {
/*  145: 145 */    this();
/*  146: 146 */    putAll(m);
/*  147:     */  }
/*  148:     */  
/*  153:     */  public Short2IntAVLTreeMap(SortedMap<Short, Integer> m)
/*  154:     */  {
/*  155: 155 */    this(m.comparator());
/*  156: 156 */    putAll(m);
/*  157:     */  }
/*  158:     */  
/*  163:     */  public Short2IntAVLTreeMap(Short2IntMap m)
/*  164:     */  {
/*  165: 165 */    this();
/*  166: 166 */    putAll(m);
/*  167:     */  }
/*  168:     */  
/*  173:     */  public Short2IntAVLTreeMap(Short2IntSortedMap m)
/*  174:     */  {
/*  175: 175 */    this(m.comparator());
/*  176: 176 */    putAll(m);
/*  177:     */  }
/*  178:     */  
/*  186:     */  public Short2IntAVLTreeMap(short[] k, int[] v, Comparator<? super Short> c)
/*  187:     */  {
/*  188: 188 */    this(c);
...
/*  192:     */  }
/*  193:     */  
/*  199:     */  public Short2IntAVLTreeMap(short[] k, int[] v)
/*  200:     */  {
...
/*  273:     */  }
/*  274:     */  
/*  278:     */  public int put(short k, int v)
/*  279:     */  {
...
/*  774:     */  }
/*  775:     */  
/*  777:     */  public Integer put(Short ok, Integer ov)
/*  778:     */  {
/*  779: 779 */    int oldValue = put(ok.shortValue(), ov.intValue());
/*  780: 780 */    return this.modified ? null : Integer.valueOf(oldValue);
/*  781:     */  }
/*  782:     */  
/*  786:     */  public Integer remove(Object ok)
/*  787:     */  {
/*  788: 788 */    int oldValue = remove(((Short)ok).shortValue());
...
/*  819:     */    implements Cloneable, Short2IntMap.Entry
/*  820:     */  {
...
/* 1036:1036 */      Map.Entry<Short, Integer> e = (Map.Entry)o;
/* 1037:     */      
/* 1038:1038 */      return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == ((Integer)e.getValue()).intValue());
/* 1039:     */    }
/* 1040:     */    
...
/* 1116:     */  {
/* 1117:     */    Short2IntAVLTreeMap.Entry prev;
/* 1118:     */    
/* 1120:     */    Short2IntAVLTreeMap.Entry next;
/* 1121:     */    
/* 1122:     */    Short2IntAVLTreeMap.Entry curr;
/* 1123:     */    
/* 1124:1124 */    int index = 0;
/* 1125:     */    
/* 1126:1126 */    TreeIterator() { this.next = Short2IntAVLTreeMap.this.firstEntry; }
/* 1127:     */    
/* 1128:     */    TreeIterator(short k) {
/* 1129:1129 */      if ((this.next = Short2IntAVLTreeMap.this.locateKey(k)) != null)
/* 1130:1130 */        if (Short2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1141:     */    
/* 1142:     */    Short2IntAVLTreeMap.Entry nextEntry() {
...
/* 1151:     */    
/* 1152:     */    Short2IntAVLTreeMap.Entry previousEntry() {
...
/* 1173:1173 */      Short2IntAVLTreeMap.this.remove(this.curr.key);
...
/* 1189:     */    extends Short2IntAVLTreeMap.TreeIterator
/* 1190:     */    implements ObjectListIterator<Short2IntMap.Entry>
/* 1191:     */  {
/* 1192:1192 */    EntryIterator() { super(); }
/* 1193:     */    
/* 1194:1194 */    EntryIterator(short k) { super(k); }
/* 1195:     */    
/* 1196:1196 */    public Short2IntMap.Entry next() { return nextEntry(); }
/* 1197:1197 */    public Short2IntMap.Entry previous() { return previousEntry(); }
/* 1198:1198 */    public void set(Short2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1199:1199 */    public void add(Short2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1200:     */  }
/* 1201:     */  
/* 1202:1202 */  public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() { if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1203:1203 */        final Comparator<? super Short2IntMap.Entry> comparator = new Comparator() {
/* 1204:     */          public int compare(Short2IntMap.Entry x, Short2IntMap.Entry y) {
/* 1205:1205 */            return Short2IntAVLTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/* 1206:     */          }
/* 1207:     */        };
/* 1208:     */        
/* 1209:1209 */        public Comparator<? super Short2IntMap.Entry> comparator() { return this.comparator; }
/* 1210:     */        
/* 1211:     */        public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator() {
/* 1212:1212 */          return new Short2IntAVLTreeMap.EntryIterator(Short2IntAVLTreeMap.this);
/* 1213:     */        }
/* 1214:     */        
/* 1215:1215 */        public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from) { return new Short2IntAVLTreeMap.EntryIterator(Short2IntAVLTreeMap.this, ((Short)from.getKey()).shortValue()); }
/* 1216:     */        
/* 1217:     */        public boolean contains(Object o)
/* 1218:     */        {
/* 1219:1219 */          if (!(o instanceof Map.Entry)) return false;
/* 1220:1220 */          Map.Entry<Short, Integer> e = (Map.Entry)o;
/* 1221:1221 */          Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1222:1222 */          return e.equals(f);
/* 1223:     */        }
/* 1224:     */        
/* 1225:     */        public boolean remove(Object o) {
/* 1226:1226 */          if (!(o instanceof Map.Entry)) return false;
/* 1227:1227 */          Map.Entry<Short, Integer> e = (Map.Entry)o;
/* 1228:1228 */          Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1229:1229 */          if (f != null) Short2IntAVLTreeMap.this.remove(f.key);
/* 1230:1230 */          return f != null; }
/* 1231:     */        
/* 1232:1232 */        public int size() { return Short2IntAVLTreeMap.this.count; }
/* 1233:1233 */        public void clear() { Short2IntAVLTreeMap.this.clear(); }
/* 1234:1234 */        public Short2IntMap.Entry first() { return Short2IntAVLTreeMap.this.firstEntry; }
/* 1235:1235 */        public Short2IntMap.Entry last() { return Short2IntAVLTreeMap.this.lastEntry; }
/* 1236:1236 */        public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry from, Short2IntMap.Entry to) { return Short2IntAVLTreeMap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2IntEntrySet(); }
/* 1237:1237 */        public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry to) { return Short2IntAVLTreeMap.this.headMap((Short)to.getKey()).short2IntEntrySet(); }
/* 1238:1238 */        public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from) { return Short2IntAVLTreeMap.this.tailMap((Short)from.getKey()).short2IntEntrySet(); }
/* 1239:     */      };
/* 1240:1240 */    return this.entries;
/* 1241:     */  }
/* 1242:     */  
/* 1245:     */  private final class KeyIterator
/* 1246:     */    extends Short2IntAVLTreeMap.TreeIterator
...
/* 1259:     */  }
/* 1260:     */  
/* 1261:1261 */  private class KeySet extends AbstractShort2IntSortedMap.KeySet { private KeySet() { super(); }
/* 1262:1262 */    public ShortBidirectionalIterator iterator() { return new Short2IntAVLTreeMap.KeyIterator(Short2IntAVLTreeMap.this); }
/* 1263:1263 */    public ShortBidirectionalIterator iterator(short from) { return new Short2IntAVLTreeMap.KeyIterator(Short2IntAVLTreeMap.this, from); }
/* 1264:     */  }
/* 1265:     */  
...
/* 1280:     */    extends Short2IntAVLTreeMap.TreeIterator
...
/* 1304:1304 */          return new Short2IntAVLTreeMap.ValueIterator(Short2IntAVLTreeMap.this, null);
/* 1305:     */        }
/* 1306:     */        
/* 1307:1307 */        public boolean contains(int k) { return Short2IntAVLTreeMap.this.containsValue(k); }
/* 1308:     */        
/* 1309:     */        public int size() {
/* 1310:1310 */          return Short2IntAVLTreeMap.this.count;
/* 1311:     */        }
/* 1312:     */        
/* 1313:1313 */        public void clear() { Short2IntAVLTreeMap.this.clear(); }
/* 1314:     */      };
/* 1315:     */    }
...
/* 1320:     */  
/* 1321:     */  public Short2IntSortedMap headMap(short to) {
/* 1322:1322 */    return new Submap((short)0, true, to, false);
/* 1323:     */  }
/* 1324:     */  
/* 1325:1325 */  public Short2IntSortedMap tailMap(short from) { return new Submap(from, false, (short)0, true); }
/* 1326:     */  
/* 1327:     */  public Short2IntSortedMap subMap(short from, short to) {
/* 1328:1328 */    return new Submap(from, false, to, false);
/* 1329:     */  }
/* 1330:     */  
/* 1334:     */  private final class Submap
/* 1335:     */    extends AbstractShort2IntSortedMap
...
/* 1351:     */    boolean top;
/* 1352:     */    
/* 1354:     */    protected volatile transient ObjectSortedSet<Short2IntMap.Entry> entries;
/* 1355:     */    
...
/* 1365:     */    {
/* 1366:1366 */      if ((!bottom) && (!top) && (Short2IntAVLTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1367:1367 */      this.from = from;
/* 1368:1368 */      this.bottom = bottom;
/* 1369:1369 */      this.to = to;
/* 1370:1370 */      this.top = top;
/* 1371:1371 */      this.defRetValue = Short2IntAVLTreeMap.this.defRetValue;
/* 1372:     */    }
/* 1373:     */    
...
/* 1384:     */    {
/* 1385:1385 */      return ((this.bottom) || (Short2IntAVLTreeMap.this.compare(k, this.from) >= 0)) && ((this.top) || (Short2IntAVLTreeMap.this.compare(k, this.to) < 0));
/* 1386:     */    }
/* 1387:     */    
/* 1388:     */    public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet() {
/* 1389:1389 */      if (this.entries == null) this.entries = new AbstractObjectSortedSet() {
/* 1390:     */          public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator() {
/* 1391:1391 */            return new Short2IntAVLTreeMap.Submap.SubmapEntryIterator(Short2IntAVLTreeMap.Submap.this);
/* 1392:     */          }
/* 1393:     */          
/* 1394:1394 */          public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from) { return new Short2IntAVLTreeMap.Submap.SubmapEntryIterator(Short2IntAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue()); }
/* 1395:     */          
/* 1396:1396 */          public Comparator<? super Short2IntMap.Entry> comparator() { return Short2IntAVLTreeMap.this.entrySet().comparator(); }
/* 1397:     */          
/* 1398:     */          public boolean contains(Object o) {
/* 1399:1399 */            if (!(o instanceof Map.Entry)) return false;
/* 1400:1400 */            Map.Entry<Short, Integer> e = (Map.Entry)o;
/* 1401:1401 */            Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1402:1402 */            return (f != null) && (Short2IntAVLTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/* 1403:     */          }
/* 1404:     */          
/* 1405:     */          public boolean remove(Object o) {
/* 1406:1406 */            if (!(o instanceof Map.Entry)) return false;
/* 1407:1407 */            Map.Entry<Short, Integer> e = (Map.Entry)o;
/* 1408:1408 */            Short2IntAVLTreeMap.Entry f = Short2IntAVLTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1409:1409 */            if ((f != null) && (Short2IntAVLTreeMap.Submap.this.in(f.key))) Short2IntAVLTreeMap.Submap.this.remove(f.key);
...
/* 1416:     */          }
/* 1417:     */          
/* 1418:1418 */          public boolean isEmpty() { return !new Short2IntAVLTreeMap.Submap.SubmapIterator(Short2IntAVLTreeMap.Submap.this).hasNext(); }
/* 1419:     */          
/* 1421:1421 */          public void clear() { Short2IntAVLTreeMap.Submap.this.clear(); }
/* 1422:     */          
/* 1423:1423 */          public Short2IntMap.Entry first() { return Short2IntAVLTreeMap.Submap.this.firstEntry(); }
/* 1424:1424 */          public Short2IntMap.Entry last() { return Short2IntAVLTreeMap.Submap.this.lastEntry(); }
/* 1425:1425 */          public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry from, Short2IntMap.Entry to) { return Short2IntAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2IntEntrySet(); }
/* 1426:1426 */          public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry to) { return Short2IntAVLTreeMap.Submap.this.headMap((Short)to.getKey()).short2IntEntrySet(); }
/* 1427:1427 */          public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from) { return Short2IntAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2IntEntrySet(); }
/* 1428:     */        };
/* 1429:1429 */      return this.entries; }
/* 1430:     */    
/* 1431:1431 */    private class KeySet extends AbstractShort2IntSortedMap.KeySet { private KeySet() { super(); }
/* 1432:1432 */      public ShortBidirectionalIterator iterator() { return new Short2IntAVLTreeMap.Submap.SubmapKeyIterator(Short2IntAVLTreeMap.Submap.this); }
/* 1433:1433 */      public ShortBidirectionalIterator iterator(short from) { return new Short2IntAVLTreeMap.Submap.SubmapKeyIterator(Short2IntAVLTreeMap.Submap.this, from); }
/* 1434:     */    }
/* 1435:     */    
...
/* 1442:1442 */            return new Short2IntAVLTreeMap.Submap.SubmapValueIterator(Short2IntAVLTreeMap.Submap.this, null);
/* 1443:     */          }
/* 1444:     */          
/* 1445:1445 */          public boolean contains(int k) { return Short2IntAVLTreeMap.Submap.this.containsValue(k); }
/* 1446:     */          
/* 1447:     */          public int size() {
/* 1448:1448 */            return Short2IntAVLTreeMap.Submap.this.size();
/* 1449:     */          }
/* 1450:     */          
/* 1451:1451 */          public void clear() { Short2IntAVLTreeMap.Submap.this.clear(); }
/* 1452:     */        };
/* 1453:     */      }
/* 1454:1454 */      return this.values;
/* 1455:     */    }
/* 1456:     */    
/* 1458:1458 */    public boolean containsKey(short k) { return (in(k)) && (Short2IntAVLTreeMap.this.containsKey(k)); }
/* 1459:     */    
...
/* 1468:     */    }
/* 1469:     */    
/* 1470:     */    public int get(short k)
/* 1471:     */    {
/* 1472:1472 */      short kk = k;
/* 1473:1473 */      Short2IntAVLTreeMap.Entry e; return (in(kk)) && ((e = Short2IntAVLTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/* 1474:     */    }
/* 1475:     */    
/* 1476:1476 */    public int put(short k, int v) { Short2IntAVLTreeMap.this.modified = false;
...
/* 1478:1478 */      int oldValue = Short2IntAVLTreeMap.this.put(k, v);
/* 1479:1479 */      return Short2IntAVLTreeMap.this.modified ? this.defRetValue : oldValue;
/* 1480:     */    }
/* 1481:     */    
/* 1482:1482 */    public Integer put(Short ok, Integer ov) { int oldValue = put(ok.shortValue(), ov.intValue());
/* 1483:1483 */      return Short2IntAVLTreeMap.this.modified ? null : Integer.valueOf(oldValue);
/* 1484:     */    }
/* 1485:     */    
/* 1486:     */    public int remove(short k) {
/* 1487:1487 */      Short2IntAVLTreeMap.this.modified = false;
/* 1488:1488 */      if (!in(k)) return this.defRetValue;
/* 1489:1489 */      int oldValue = Short2IntAVLTreeMap.this.remove(k);
/* 1490:1490 */      return Short2IntAVLTreeMap.this.modified ? oldValue : this.defRetValue;
/* 1491:     */    }
/* 1492:     */    
/* 1493:1493 */    public Integer remove(Object ok) { int oldValue = remove(((Short)ok).shortValue());
/* 1494:1494 */      return Short2IntAVLTreeMap.this.modified ? Integer.valueOf(oldValue) : null;
/* 1495:     */    }
/* 1496:     */    
...
/* 1507:     */    
/* 1509:1509 */    public ShortComparator comparator() { return Short2IntAVLTreeMap.this.actualComparator; }
/* 1510:     */    
/* 1511:     */    public Short2IntSortedMap headMap(short to) {
/* 1512:1512 */      if (this.top) return new Submap(Short2IntAVLTreeMap.this, this.from, this.bottom, to, false);
/* 1513:1513 */      return Short2IntAVLTreeMap.this.compare(to, this.to) < 0 ? new Submap(Short2IntAVLTreeMap.this, this.from, this.bottom, to, false) : this;
/* 1514:     */    }
/* 1515:     */    
/* 1516:1516 */    public Short2IntSortedMap tailMap(short from) { if (this.bottom) return new Submap(Short2IntAVLTreeMap.this, from, false, this.to, this.top);
/* 1517:1517 */      return Short2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2IntAVLTreeMap.this, from, false, this.to, this.top) : this;
/* 1518:     */    }
/* 1519:     */    
/* 1520:1520 */    public Short2IntSortedMap subMap(short from, short to) { if ((this.top) && (this.bottom)) return new Submap(Short2IntAVLTreeMap.this, from, false, to, false);
/* 1521:1521 */      if (!this.top) to = Short2IntAVLTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1522:1522 */      if (!this.bottom) from = Short2IntAVLTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1523:1523 */      if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1524:1524 */      return new Submap(Short2IntAVLTreeMap.this, from, false, to, false);
/* 1525:     */    }
/* 1526:     */    
/* 1529:     */    public Short2IntAVLTreeMap.Entry firstEntry()
/* 1530:     */    {
/* 1531:1531 */      if (Short2IntAVLTreeMap.this.tree == null) return null;
/* 1532:     */      Short2IntAVLTreeMap.Entry e;
/* 1533:     */      Short2IntAVLTreeMap.Entry e;
/* 1534:1534 */      if (this.bottom) { e = Short2IntAVLTreeMap.this.firstEntry;
/* 1535:     */      } else {
/* 1536:1536 */        e = Short2IntAVLTreeMap.this.locateKey(this.from);
/* 1537:     */        
/* 1538:1538 */        if (Short2IntAVLTreeMap.this.compare(e.key, this.from) < 0) { e = e.next();
/* 1539:     */        }
/* 1540:     */      }
/* 1541:1541 */      if ((e == null) || ((!this.top) && (Short2IntAVLTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1542:1542 */      return e;
/* 1543:     */    }
/* 1544:     */    
/* 1547:     */    public Short2IntAVLTreeMap.Entry lastEntry()
/* 1548:     */    {
/* 1549:1549 */      if (Short2IntAVLTreeMap.this.tree == null) return null;
/* 1550:     */      Short2IntAVLTreeMap.Entry e;
/* 1551:     */      Short2IntAVLTreeMap.Entry e;
/* 1552:1552 */      if (this.top) { e = Short2IntAVLTreeMap.this.lastEntry;
/* 1553:     */      } else {
/* 1554:1554 */        e = Short2IntAVLTreeMap.this.locateKey(this.to);
/* 1555:     */        
/* 1556:1556 */        if (Short2IntAVLTreeMap.this.compare(e.key, this.to) >= 0) { e = e.prev();
/* 1557:     */        }
/* 1558:     */      }
/* 1559:1559 */      if ((e == null) || ((!this.bottom) && (Short2IntAVLTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1560:1560 */      return e;
/* 1561:     */    }
/* 1562:     */    
/* 1563:1563 */    public short firstShortKey() { Short2IntAVLTreeMap.Entry e = firstEntry();
/* 1564:1564 */      if (e == null) throw new NoSuchElementException();
/* 1565:1565 */      return e.key;
/* 1566:     */    }
/* 1567:     */    
/* 1568:1568 */    public short lastShortKey() { Short2IntAVLTreeMap.Entry e = lastEntry();
/* 1569:1569 */      if (e == null) throw new NoSuchElementException();
/* 1570:1570 */      return e.key;
/* 1571:     */    }
/* 1572:     */    
/* 1573:1573 */    public Short firstKey() { Short2IntAVLTreeMap.Entry e = firstEntry();
/* 1574:1574 */      if (e == null) throw new NoSuchElementException();
/* 1575:1575 */      return e.getKey();
/* 1576:     */    }
/* 1577:     */    
/* 1578:1578 */    public Short lastKey() { Short2IntAVLTreeMap.Entry e = lastEntry();
/* 1579:1579 */      if (e == null) throw new NoSuchElementException();
/* 1580:1580 */      return e.getKey();
/* 1581:     */    }
/* 1582:     */    
/* 1585:     */    private class SubmapIterator
/* 1586:     */      extends Short2IntAVLTreeMap.TreeIterator
/* 1587:     */    {
/* 1588:     */      SubmapIterator()
/* 1589:     */      {
/* 1590:1590 */        super();
/* 1591:1591 */        this.next = Short2IntAVLTreeMap.Submap.this.firstEntry();
/* 1592:     */      }
/* 1593:     */      
/* 1594:1594 */      SubmapIterator(short k) { this();
/* 1595:1595 */        if (this.next != null)
/* 1596:1596 */          if ((!Short2IntAVLTreeMap.Submap.this.bottom) && (Short2IntAVLTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1597:1597 */          } else if ((!Short2IntAVLTreeMap.Submap.this.top) && (Short2IntAVLTreeMap.this.compare(k, (this.prev = Short2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/* 1598:     */          } else {
/* 1599:1599 */            this.next = Short2IntAVLTreeMap.this.locateKey(k);
/* 1600:1600 */            if (Short2IntAVLTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1610:1610 */        if ((!Short2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2IntAVLTreeMap.this.compare(this.prev.key, Short2IntAVLTreeMap.Submap.this.from) < 0)) this.prev = null;
/* 1611:     */      }
/* 1612:     */      
/* 1613:1613 */      void updateNext() { this.next = this.next.next();
/* 1614:1614 */        if ((!Short2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2IntAVLTreeMap.this.compare(this.next.key, Short2IntAVLTreeMap.Submap.this.to) >= 0)) this.next = null;
/* 1615:     */      }
/* 1616:     */    }
/* 1617:     */    
/* 1618:1618 */    private class SubmapEntryIterator extends Short2IntAVLTreeMap.Submap.SubmapIterator implements ObjectListIterator<Short2IntMap.Entry> { SubmapEntryIterator() { super(); }
/* 1619:     */      
/* 1620:1620 */      SubmapEntryIterator(short k) { super(k); }
/* 1621:     */      
/* 1622:1622 */      public Short2IntMap.Entry next() { return nextEntry(); }
/* 1623:1623 */      public Short2IntMap.Entry previous() { return previousEntry(); }
/* 1624:1624 */      public void set(Short2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1625:1625 */      public void add(Short2IntMap.Entry ok) { throw new UnsupportedOperationException(); }
/* 1626:     */    }
/* 1627:     */    
/* 1632:     */    private final class SubmapKeyIterator
/* 1633:     */      extends Short2IntAVLTreeMap.Submap.SubmapIterator
...
/* 1652:     */      extends Short2IntAVLTreeMap.Submap.SubmapIterator
...
/* 1665:     */  }
/* 1666:     */  
/* 1670:     */  public Short2IntAVLTreeMap clone()
/* 1671:     */  {
/* 1672:     */    Short2IntAVLTreeMap c;
/* 1673:     */    
/* 1675:     */    try
/* 1676:     */    {
/* 1677:1677 */      c = (Short2IntAVLTreeMap)super.clone();
/* 1678:     */    }
...
/* 1748:     */  {
/* 1749:1749 */    if (n == 1) {
/* 1750:1750 */      Entry top = new Entry(s.readShort(), s.readInt());
...
/* 1755:1755 */    if (n == 2)
/* 1756:     */    {
/* 1758:1758 */      Entry top = new Entry(s.readShort(), s.readInt());
/* 1759:1759 */      top.right(new Entry(s.readShort(), s.readInt()));
 ...
 * Qualified Name:     it.unimi.dsi.fastutil.shorts.Short2IntAVLTreeMap
