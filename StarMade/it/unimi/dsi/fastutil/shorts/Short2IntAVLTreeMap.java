  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2IntAVLTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2IntAVLTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2IntAVLTreeMap(Map<? extends Short, ? extends Integer> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2IntAVLTreeMap(SortedMap<Short, Integer> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2IntAVLTreeMap(Short2IntMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2IntAVLTreeMap(Short2IntSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2IntAVLTreeMap(short[] local_k, int[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2IntAVLTreeMap(short[] local_k, int[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2IntMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Short2IntAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2IntAVLTreeMap.EntryIterator(Short2IntAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from)
        {
          return new Short2IntAVLTreeMap.EntryIterator(Short2IntAVLTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2IntAVLTreeMap.Entry local_f = Short2IntAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2IntAVLTreeMap.Entry local_f = Short2IntAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2IntAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2IntAVLTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2IntEntrySet();
        }
        
        public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry local_to)
        {
          return Short2IntAVLTreeMap.this.headMap((Short)local_to.getKey()).short2IntEntrySet();
        }
        
        public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from)
        {
          return Short2IntAVLTreeMap.this.tailMap((Short)from.getKey()).short2IntEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public IntCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractIntCollection()
      {
        ...
        {
          return new Short2IntAVLTreeMap.ValueIterator(Short2IntAVLTreeMap.this, null);
        }
        
        public boolean contains(int local_k)
        {
          return Short2IntAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2IntAVLTreeMap local_c;
    try
    {
      local_c = (Short2IntAVLTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2IntAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2IntAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2IntAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2IntMap.Entry> short2IntEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator()
          {
            return new Short2IntAVLTreeMap.Submap.SubmapEntryIterator(Short2IntAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2IntMap.Entry> iterator(Short2IntMap.Entry from)
          {
            return new Short2IntAVLTreeMap.Submap.SubmapEntryIterator(Short2IntAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Integer> local_e = (Map.Entry)local_o;
            Short2IntAVLTreeMap.Entry local_f = Short2IntAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2IntAVLTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Integer> local_e = (Map.Entry)local_o;
            Short2IntAVLTreeMap.Entry local_f = Short2IntAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2IntAVLTreeMap.Submap.this.in6(local_f.key))) {
              Short2IntAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2IntAVLTreeMap.Submap.SubmapIterator(Short2IntAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2IntAVLTreeMap.Submap.this.clear();
          }
          
          public Short2IntMap.Entry first()
          {
            return Short2IntAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Short2IntMap.Entry last()
          {
            return Short2IntAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2IntMap.Entry> subSet(Short2IntMap.Entry from, Short2IntMap.Entry local_to)
          {
            return Short2IntAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2IntEntrySet();
          }
          
          public ObjectSortedSet<Short2IntMap.Entry> headSet(Short2IntMap.Entry local_to)
          {
            return Short2IntAVLTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2IntEntrySet();
          }
          
          public ObjectSortedSet<Short2IntMap.Entry> tailSet(Short2IntMap.Entry from)
          {
            return Short2IntAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2IntEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public IntCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractIntCollection()
        {
          public IntIterator iterator()
          {
            return new Short2IntAVLTreeMap.Submap.SubmapValueIterator(Short2IntAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(int local_k)
          {
            return Short2IntAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2IntAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2IntAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2IntAVLTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2IntAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public int put(short local_k, int local_v)
    {
      ...
      int oldValue = Short2IntAVLTreeMap.this.put(local_k, local_v);
    ...
    public int remove(short local_k)
    {
      ...
      int oldValue = Short2IntAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2IntAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2IntAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2IntSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2IntAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2IntAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2IntAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2IntSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2IntAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2IntAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2IntAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2IntAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2IntAVLTreeMap.this.locateKey(this.from);
        if (Short2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2IntAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2IntAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2IntAVLTreeMap.this.locateKey(this.field_47);
        if (Short2IntAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2IntAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2IntAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2IntAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2IntAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2IntAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2IntAVLTreeMap.Submap.this.bottom) && (Short2IntAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2IntAVLTreeMap.Submap.this.top) && (Short2IntAVLTreeMap.this.compare(local_k, (this.prev = Short2IntAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2IntAVLTreeMap.this.locateKey(local_k);
            if (Short2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2IntAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2IntAVLTreeMap.this.compare(this.prev.key, Short2IntAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2IntAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2IntAVLTreeMap.this.compare(this.next.key, Short2IntAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2IntSortedMap.KeySet
    {
      ...
      {
        return new Short2IntAVLTreeMap.Submap.SubmapKeyIterator(Short2IntAVLTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2IntAVLTreeMap.Submap.SubmapKeyIterator(Short2IntAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2IntSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2IntAVLTreeMap.KeyIterator(Short2IntAVLTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2IntAVLTreeMap.KeyIterator(Short2IntAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2IntAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Short2IntAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
