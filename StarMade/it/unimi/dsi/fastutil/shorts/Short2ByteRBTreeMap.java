...
/*      */ 
/*      */ public class Short2ByteRBTreeMap extends AbstractShort2ByteSortedMap
...
/*  119 */           return Short2ByteRBTreeMap.this.storedComparator.compare(Short.valueOf(k1), Short.valueOf(k2));
/*      */         }
/*      */         public int compare(Short ok1, Short ok2) {
/*  122 */           return Short2ByteRBTreeMap.this.storedComparator.compare(ok1, ok2);
/*      */         }
/*      */       };
/*      */   }
/*      */ 
...
/*      */   {
/*  730 */     byte oldValue = put(ok.shortValue(), ov.byteValue());
/*  731 */     return this.modified ? null : Byte.valueOf(oldValue);
/*      */   }
/*      */ 
/*      */   public Byte remove(Object ok)
/*      */   {
/*  737 */     byte oldValue = remove(((Short)ok).shortValue());
...
/* 1141 */         final Comparator<? super Short2ByteMap.Entry> comparator = new Comparator() {
/*      */           public int compare(Short2ByteMap.Entry x, Short2ByteMap.Entry y) {
/* 1143 */             return Short2ByteRBTreeMap.this.storedComparator.compare(x.getKey(), y.getKey());
/*      */           }
/* 1141 */         };
/*      */ 
...
/* 1150 */           return new Short2ByteRBTreeMap.EntryIterator(Short2ByteRBTreeMap.this);
/*      */         }
/*      */         public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry from) {
/* 1153 */           return new Short2ByteRBTreeMap.EntryIterator(Short2ByteRBTreeMap.this, ((Short)from.getKey()).shortValue());
/*      */         }
/*      */ 
/*      */         public boolean contains(Object o) {
/* 1157 */           if (!(o instanceof Map.Entry)) return false;
/* 1158 */           Map.Entry e = (Map.Entry)o;
/* 1159 */           Short2ByteRBTreeMap.Entry f = Short2ByteRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
...
/* 1166 */           Short2ByteRBTreeMap.Entry f = Short2ByteRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1167 */           if (f != null) Short2ByteRBTreeMap.this.remove(f.key);
/* 1168 */           return f != null;
/*      */         }
/* 1170 */         public int size() { return Short2ByteRBTreeMap.this.count; } 
/* 1171 */         public void clear() { Short2ByteRBTreeMap.this.clear(); } 
/* 1172 */         public Short2ByteMap.Entry first() { return Short2ByteRBTreeMap.this.firstEntry; } 
/* 1173 */         public Short2ByteMap.Entry last() { return Short2ByteRBTreeMap.this.lastEntry; } 
/* 1174 */         public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry from, Short2ByteMap.Entry to) { return Short2ByteRBTreeMap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2ByteEntrySet(); } 
/* 1175 */         public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry to) { return Short2ByteRBTreeMap.this.headMap((Short)to.getKey()).short2ByteEntrySet(); } 
/* 1176 */         public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry from) { return Short2ByteRBTreeMap.this.tailMap((Short)from.getKey()).short2ByteEntrySet(); }
/*      */       };
...
/* 1242 */           return new Short2ByteRBTreeMap.ValueIterator(Short2ByteRBTreeMap.this, null);
/*      */         }
/*      */         public boolean contains(byte k) {
/* 1245 */           return Short2ByteRBTreeMap.this.containsValue(k);
/*      */         }
/*      */         public int size() {
/* 1248 */           return Short2ByteRBTreeMap.this.count;
/*      */         }
/*      */         public void clear() {
/* 1251 */           Short2ByteRBTreeMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1611 */       c = (Short2ByteRBTreeMap)super.clone();
/*      */     }
...
/*      */   {
/* 1683 */     if (n == 1) {
/* 1684 */       Entry top = new Entry(s.readShort(), s.readByte());
/* 1685 */       top.pred(pred);
/* 1686 */       top.succ(succ);
/* 1687 */       top.black(true);
/* 1688 */       return top;
...
/* 1690 */     if (n == 2)
/*      */     {
/* 1693 */       Entry top = new Entry(s.readShort(), s.readByte());
/* 1694 */       top.black(true);
/* 1695 */       top.right(new Entry(s.readShort(), s.readByte()));
...
/*      */ 
/*      */ 
/*      */   private final class Submap extends AbstractShort2ByteSortedMap
...
/*      */     {
/* 1304 */       if ((!bottom) && (!top) && (Short2ByteRBTreeMap.this.compare(from, to) > 0)) throw new IllegalArgumentException(new StringBuilder().append("Start key (").append(from).append(") is larger than end key (").append(to).append(")").toString());
/* 1305 */       this.from = from;
/* 1306 */       this.bottom = bottom;
/* 1307 */       this.to = to;
/* 1308 */       this.top = top;
/* 1309 */       this.defRetValue = Short2ByteRBTreeMap.this.defRetValue;
/*      */     }
/*      */     public void clear() {
...
/*      */           public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator() {
/* 1329 */             return new Short2ByteRBTreeMap.Submap.SubmapEntryIterator(Short2ByteRBTreeMap.Submap.this);
/*      */           }
/*      */           public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry from) {
/* 1332 */             return new Short2ByteRBTreeMap.Submap.SubmapEntryIterator(Short2ByteRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
/*      */           }
/* 1334 */           public Comparator<? super Short2ByteMap.Entry> comparator() { return Short2ByteRBTreeMap.this.short2ByteEntrySet().comparator(); }
/*      */ 
/*      */           public boolean contains(Object o) {
/* 1337 */             if (!(o instanceof Map.Entry)) return false;
/* 1338 */             Map.Entry e = (Map.Entry)o;
/* 1339 */             Short2ByteRBTreeMap.Entry f = Short2ByteRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1340 */             return (f != null) && (Short2ByteRBTreeMap.Submap.this.in(f.key)) && (e.equals(f));
/*      */           }
/*      */ 
/*      */           public boolean remove(Object o) {
/* 1344 */             if (!(o instanceof Map.Entry)) return false;
/* 1345 */             Map.Entry e = (Map.Entry)o;
/* 1346 */             Short2ByteRBTreeMap.Entry f = Short2ByteRBTreeMap.this.findKey(((Short)e.getKey()).shortValue());
/* 1347 */             if ((f != null) && (Short2ByteRBTreeMap.Submap.this.in(f.key))) Short2ByteRBTreeMap.Submap.this.remove(f.key);
/* 1348 */             return f != null;
/*      */           }
/*      */           public int size() {
/* 1351 */             int c = 0;
...
/* 1353 */             return c;
/*      */           }
/* 1355 */           public boolean isEmpty() { return !new Short2ByteRBTreeMap.Submap.SubmapIterator(Short2ByteRBTreeMap.Submap.this).hasNext(); } 
/* 1356 */           public void clear() { Short2ByteRBTreeMap.Submap.this.clear(); } 
/* 1357 */           public Short2ByteMap.Entry first() { return Short2ByteRBTreeMap.Submap.this.firstEntry(); } 
/* 1358 */           public Short2ByteMap.Entry last() { return Short2ByteRBTreeMap.Submap.this.lastEntry(); } 
/* 1359 */           public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry from, Short2ByteMap.Entry to) { return Short2ByteRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)to.getKey()).short2ByteEntrySet(); } 
/* 1360 */           public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry to) { return Short2ByteRBTreeMap.Submap.this.headMap((Short)to.getKey()).short2ByteEntrySet(); } 
/* 1361 */           public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry from) { return Short2ByteRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2ByteEntrySet(); }
/*      */         };
...
/*      */           public ByteIterator iterator() {
/* 1376 */             return new Short2ByteRBTreeMap.Submap.SubmapValueIterator(Short2ByteRBTreeMap.Submap.this, null);
/*      */           }
/*      */           public boolean contains(byte k) {
/* 1379 */             return Short2ByteRBTreeMap.Submap.this.containsValue(k);
/*      */           }
/*      */           public int size() {
/* 1382 */             return Short2ByteRBTreeMap.Submap.this.size();
/*      */           }
/*      */           public void clear() {
/* 1385 */             Short2ByteRBTreeMap.Submap.this.clear();
/*      */           }
/*      */         };
...
/*      */ 
/*      */     public boolean containsKey(short k) {
/* 1392 */       return (in(k)) && (Short2ByteRBTreeMap.this.containsKey(k));
/*      */     }
/*      */     public boolean containsValue(byte v) {
...
/* 1407 */       return (in(kk)) && ((e = Short2ByteRBTreeMap.this.findKey(kk)) != null) ? e.value : this.defRetValue;
/*      */     }
/*      */     public byte put(short k, byte v) {
/* 1410 */       Short2ByteRBTreeMap.this.modified = false;
...
/* 1412 */       byte oldValue = Short2ByteRBTreeMap.this.put(k, v);
/* 1413 */       return Short2ByteRBTreeMap.this.modified ? this.defRetValue : oldValue;
/*      */     }
/*      */     public Byte put(Short ok, Byte ov) {
/* 1416 */       byte oldValue = put(ok.shortValue(), ov.byteValue());
/* 1417 */       return Short2ByteRBTreeMap.this.modified ? null : Byte.valueOf(oldValue);
/*      */     }
/*      */ 
/*      */     public byte remove(short k) {
/* 1421 */       Short2ByteRBTreeMap.this.modified = false;
/* 1422 */       if (!in(k)) return this.defRetValue;
/* 1423 */       byte oldValue = Short2ByteRBTreeMap.this.remove(k);
/* 1424 */       return Short2ByteRBTreeMap.this.modified ? oldValue : this.defRetValue;
/*      */     }
/*      */     public Byte remove(Object ok) {
/* 1427 */       byte oldValue = remove(((Short)ok).shortValue());
/* 1428 */       return Short2ByteRBTreeMap.this.modified ? Byte.valueOf(oldValue) : null;
/*      */     }
/*      */     public int size() {
...
/*      */     }
/*      */     public ShortComparator comparator() {
/* 1443 */       return Short2ByteRBTreeMap.this.actualComparator;
/*      */     }
/*      */     public Short2ByteSortedMap headMap(short to) {
/* 1446 */       if (this.top) return new Submap(Short2ByteRBTreeMap.this, this.from, this.bottom, to, false);
/* 1447 */       return Short2ByteRBTreeMap.this.compare(to, this.to) < 0 ? new Submap(Short2ByteRBTreeMap.this, this.from, this.bottom, to, false) : this;
/*      */     }
/*      */     public Short2ByteSortedMap tailMap(short from) {
/* 1450 */       if (this.bottom) return new Submap(Short2ByteRBTreeMap.this, from, false, this.to, this.top);
/* 1451 */       return Short2ByteRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2ByteRBTreeMap.this, from, false, this.to, this.top) : this;
/*      */     }
/*      */     public Short2ByteSortedMap subMap(short from, short to) {
/* 1454 */       if ((this.top) && (this.bottom)) return new Submap(Short2ByteRBTreeMap.this, from, false, to, false);
/* 1455 */       if (!this.top) to = Short2ByteRBTreeMap.this.compare(to, this.to) < 0 ? to : this.to;
/* 1456 */       if (!this.bottom) from = Short2ByteRBTreeMap.this.compare(from, this.from) > 0 ? from : this.from;
/* 1457 */       if ((!this.top) && (!this.bottom) && (from == this.from) && (to == this.to)) return this;
/* 1458 */       return new Submap(Short2ByteRBTreeMap.this, from, false, to, false);
/*      */     }
/*      */ 
/*      */     public Short2ByteRBTreeMap.Entry firstEntry()
/*      */     {
/* 1465 */       if (Short2ByteRBTreeMap.this.tree == null) return null;
/* 1468 */       Short2ByteRBTreeMap.Entry e;
/*      */       Short2ByteRBTreeMap.Entry e;
/* 1468 */       if (this.bottom) { e = Short2ByteRBTreeMap.this.firstEntry;
/*      */       } else {
/* 1470 */         e = Short2ByteRBTreeMap.this.locateKey(this.from);
/*      */ 
/* 1472 */         if (Short2ByteRBTreeMap.this.compare(e.key, this.from) < 0) e = e.next();
/*      */       }
/*      */ 
/* 1475 */       if ((e == null) || ((!this.top) && (Short2ByteRBTreeMap.this.compare(e.key, this.to) >= 0))) return null;
/* 1476 */       return e;
/*      */     }
/*      */ 
/*      */     public Short2ByteRBTreeMap.Entry lastEntry()
/*      */     {
/* 1483 */       if (Short2ByteRBTreeMap.this.tree == null) return null;
/* 1486 */       Short2ByteRBTreeMap.Entry e;
/*      */       Short2ByteRBTreeMap.Entry e;
/* 1486 */       if (this.top) { e = Short2ByteRBTreeMap.this.lastEntry;
/*      */       } else {
/* 1488 */         e = Short2ByteRBTreeMap.this.locateKey(this.to);
/*      */ 
/* 1490 */         if (Short2ByteRBTreeMap.this.compare(e.key, this.to) >= 0) e = e.prev();
/*      */       }
/*      */ 
/* 1493 */       if ((e == null) || ((!this.bottom) && (Short2ByteRBTreeMap.this.compare(e.key, this.from) < 0))) return null;
/* 1494 */       return e;
/*      */     }
/*      */     public short firstShortKey() {
/* 1497 */       Short2ByteRBTreeMap.Entry e = firstEntry();
/* 1498 */       if (e == null) throw new NoSuchElementException();
/* 1499 */       return e.key;
/*      */     }
/*      */     public short lastShortKey() {
/* 1502 */       Short2ByteRBTreeMap.Entry e = lastEntry();
/* 1503 */       if (e == null) throw new NoSuchElementException();
/* 1504 */       return e.key;
/*      */     }
/*      */     public Short firstKey() {
/* 1507 */       Short2ByteRBTreeMap.Entry e = firstEntry();
/* 1508 */       if (e == null) throw new NoSuchElementException();
/* 1509 */       return e.getKey();
/*      */     }
/*      */     public Short lastKey() {
/* 1512 */       Short2ByteRBTreeMap.Entry e = lastEntry();
/* 1513 */       if (e == null) throw new NoSuchElementException();
/* 1514 */       return e.getKey();
/*      */     }
/*      */ 
/*      */     private final class SubmapValueIterator extends Short2ByteRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private final class SubmapKeyIterator extends Short2ByteRBTreeMap.Submap.SubmapIterator
...
/*      */     }
/*      */ 
/*      */     private class SubmapEntryIterator extends Short2ByteRBTreeMap.Submap.SubmapIterator
...
/* 1557 */       public Short2ByteMap.Entry previous() { return previousEntry(); } 
/* 1558 */       public void set(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1559 */       public void add(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */     }
/*      */ 
...
/*      */       {
/* 1524 */         super();
/* 1525 */         this.next = Short2ByteRBTreeMap.Submap.this.firstEntry();
/*      */       }
/*      */       SubmapIterator(short k) {
/* 1528 */         this();
/* 1529 */         if (this.next != null)
/* 1530 */           if ((!Short2ByteRBTreeMap.Submap.this.bottom) && (Short2ByteRBTreeMap.this.compare(k, this.next.key) < 0)) { this.prev = null;
/* 1531 */           } else if ((!Short2ByteRBTreeMap.Submap.this.top) && (Short2ByteRBTreeMap.this.compare(k, (this.prev = Short2ByteRBTreeMap.Submap.this.lastEntry()).key) >= 0)) { this.next = null;
/*      */           } else {
/* 1533 */             this.next = Short2ByteRBTreeMap.this.locateKey(k);
/* 1534 */             if (Short2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1544 */         if ((!Short2ByteRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2ByteRBTreeMap.this.compare(this.prev.key, Short2ByteRBTreeMap.Submap.this.from) < 0)) this.prev = null;  } 
/*      */       void updateNext()
/*      */       {
/* 1547 */         this.next = this.next.next();
/* 1548 */         if ((!Short2ByteRBTreeMap.Submap.this.top) && (this.next != null) && (Short2ByteRBTreeMap.this.compare(this.next.key, Short2ByteRBTreeMap.Submap.this.to) >= 0)) this.next = null;
/*      */       }
/*      */     }
/*      */ 
...
/*      */       {
/* 1365 */         super(); } 
/* 1366 */       public ShortBidirectionalIterator iterator() { return new Short2ByteRBTreeMap.Submap.SubmapKeyIterator(Short2ByteRBTreeMap.Submap.this); } 
/* 1367 */       public ShortBidirectionalIterator iterator(short from) { return new Short2ByteRBTreeMap.Submap.SubmapKeyIterator(Short2ByteRBTreeMap.Submap.this, from); }
/*      */ 
/*      */     }
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2ByteRBTreeMap.TreeIterator
/*      */     implements ByteListIterator
/*      */   {
...
/*      */     {
/* 1199 */       super(); } 
/* 1200 */     public ShortBidirectionalIterator iterator() { return new Short2ByteRBTreeMap.KeyIterator(Short2ByteRBTreeMap.this); } 
/* 1201 */     public ShortBidirectionalIterator iterator(short from) { return new Short2ByteRBTreeMap.KeyIterator(Short2ByteRBTreeMap.this, from); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2ByteRBTreeMap.TreeIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator()
/*      */     {
...
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2ByteRBTreeMap.TreeIterator
/*      */     implements ObjectListIterator<Short2ByteMap.Entry>
/*      */   {
/*      */     EntryIterator()
/*      */     {
...
/* 1135 */     public Short2ByteMap.Entry previous() { return previousEntry(); } 
/* 1136 */     public void set(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/* 1137 */     public void add(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/* 1062 */     int index = 0;
/*      */ 
/* 1064 */     TreeIterator() { this.next = Short2ByteRBTreeMap.this.firstEntry; }
/*      */ 
/*      */     TreeIterator(short k) {
/* 1067 */       if ((this.next = Short2ByteRBTreeMap.this.locateKey(k)) != null)
/* 1068 */         if (Short2ByteRBTreeMap.this.compare(this.next.key, k) <= 0) {
...
/* 1109 */       updatePrevious();
/* 1110 */       updateNext();
/* 1111 */       Short2ByteRBTreeMap.this.remove(this.curr.key);
/* 1112 */       this.curr = null;
/*      */     }
...
/*      */ 
/*  979 */       return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */ 
/*      */     public int hashCode() {
