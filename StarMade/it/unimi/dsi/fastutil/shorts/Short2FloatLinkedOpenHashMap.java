  ...
  implements Serializable, Cloneable, Hash
{
  ...
  public Short2FloatLinkedOpenHashMap(int expected, float local_f)
  {
  ...
  public Short2FloatLinkedOpenHashMap(Map<? extends Short, ? extends Float> local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2FloatLinkedOpenHashMap(Map<? extends Short, ? extends Float> local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2FloatLinkedOpenHashMap(Short2FloatMap local_m, float local_f)
  {
    this(local_m.size(), local_f);
    putAll(local_m);
  }
  
  public Short2FloatLinkedOpenHashMap(Short2FloatMap local_m)
  {
    this(local_m, 0.75F);
  }
  
  public Short2FloatLinkedOpenHashMap(short[] local_k, float[] local_v, float local_f)
  {
  ...
  public Short2FloatLinkedOpenHashMap(short[] local_k, float[] local_v)
  {
  ...
  public float add(short local_k, float incr)
  {
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k)
      {
  ...
  public float getAndMoveToFirst(short local_k)
  {
    short[] key = this.key;
  ...
  public float getAndMoveToLast(short local_k)
  {
    short[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public float putAndMoveToFirst(short local_k, float local_v)
  {
    short[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public float putAndMoveToLast(short local_k, float local_v)
  {
    short[] key = this.key;
    boolean[] used = this.used;
    int mask = this.mask;
  ...
  public Float get(Short local_ok)
  {
    short local_k = local_ok.shortValue();
    for (int pos = HashCommon.murmurHash3(local_k) & this.mask; this.used[pos] != 0; pos = pos + 1 & this.mask) {
      if (this.key[pos] == local_k) {
  ...
  public FloatCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractFloatCollection()
      {
        ...
        {
          return new Short2FloatLinkedOpenHashMap.ValueIterator(Short2FloatLinkedOpenHashMap.this);
        }
        ...
        {
          return Short2FloatLinkedOpenHashMap.this.containsValue(local_v);
        }
  ...
  {
    Short2FloatLinkedOpenHashMap local_c;
    try
    {
      local_c = (Short2FloatLinkedOpenHashMap)super.clone();
    }
    ...
    implements FloatListIterator
  {
    ...
    {
      return Float.valueOf(Short2FloatLinkedOpenHashMap.this.value[previousEntry()]);
    }
    ...
    public Float next()
    {
      return Float.valueOf(Short2FloatLinkedOpenHashMap.this.value[nextEntry()]);
    }
  }
    ...
    extends AbstractShortSortedSet
  {
    ...
    {
      return new Short2FloatLinkedOpenHashMap.KeyIterator(Short2FloatLinkedOpenHashMap.this, from);
    }
    
    public ShortListIterator iterator()
    {
      return new Short2FloatLinkedOpenHashMap.KeyIterator(Short2FloatLinkedOpenHashMap.this);
    }
    ...
    {
      return Short2FloatLinkedOpenHashMap.this.containsKey(local_k);
    }
    
    public boolean remove(short local_k)
    {
      int oldSize = Short2FloatLinkedOpenHashMap.this.size;
      Short2FloatLinkedOpenHashMap.this.remove(local_k);
    ...
    implements ShortListIterator
  {
    ...
    {
      return Short.valueOf(Short2FloatLinkedOpenHashMap.this.key[previousEntry()]);
    }
    ...
    public Short next()
    {
      return Short.valueOf(Short2FloatLinkedOpenHashMap.this.key[nextEntry()]);
    }
  }
    ...
    implements Short2FloatSortedMap.FastSortedEntrySet
  {
    ...
    {
      return new Short2FloatLinkedOpenHashMap.EntryIterator(Short2FloatLinkedOpenHashMap.this);
    }
    ...
    public Short2FloatMap.Entry first()
    {
      ...
      return new Short2FloatLinkedOpenHashMap.MapEntry(Short2FloatLinkedOpenHashMap.this, Short2FloatLinkedOpenHashMap.this.first);
    }
    ...
    public Short2FloatMap.Entry last()
    {
      ...
      return new Short2FloatLinkedOpenHashMap.MapEntry(Short2FloatLinkedOpenHashMap.this, Short2FloatLinkedOpenHashMap.this.last);
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2FloatLinkedOpenHashMap.this.mask; Short2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2FloatLinkedOpenHashMap.this.mask) {
        if (Short2FloatLinkedOpenHashMap.this.key[pos] == local_k) {
          return Short2FloatLinkedOpenHashMap.this.value[pos] == ((Float)local_e.getValue()).floatValue();
        }
      }
      return false;
    }
    ...
    public boolean remove(Object local_o)
    {
      ...
      for (int pos = HashCommon.murmurHash3(local_k) & Short2FloatLinkedOpenHashMap.this.mask; Short2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2FloatLinkedOpenHashMap.this.mask) {
        if (Short2FloatLinkedOpenHashMap.this.key[pos] == local_k)
        {
          Short2FloatLinkedOpenHashMap.this.remove(local_e.getKey());
          return true;
        }
      }
      return false;
    ...
    {
      return new Short2FloatLinkedOpenHashMap.EntryIterator(Short2FloatLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
    }
    
    public ObjectBidirectionalIterator<Short2FloatMap.Entry> fastIterator()
    {
      return new Short2FloatLinkedOpenHashMap.FastEntryIterator(Short2FloatLinkedOpenHashMap.this);
    }
    
    public ObjectBidirectionalIterator<Short2FloatMap.Entry> fastIterator(Short2FloatMap.Entry from)
    {
      return new Short2FloatLinkedOpenHashMap.FastEntryIterator(Short2FloatLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
    }
  }
    ...
    implements ObjectListIterator<Short2FloatMap.Entry>
  {
    ...
    public AbstractShort2FloatMap.BasicEntry next()
    {
      ...
      this.entry.key = Short2FloatLinkedOpenHashMap.this.key[local_e];
      this.entry.value = Short2FloatLinkedOpenHashMap.this.value[local_e];
      return this.entry;
    }
    ...
    implements ObjectListIterator<Short2FloatMap.Entry>
  {
    ...
    {
      return this.entry = new Short2FloatLinkedOpenHashMap.MapEntry(Short2FloatLinkedOpenHashMap.this, nextEntry());
    }
    
    public Short2FloatLinkedOpenHashMap.MapEntry previous()
    {
      return this.entry = new Short2FloatLinkedOpenHashMap.MapEntry(Short2FloatLinkedOpenHashMap.this, previousEntry());
    }
    
    public void remove()
    {
      super.remove();
      Short2FloatLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
    }
  ...
  private class MapIterator
  {
    ...
    private MapIterator(short from)
    {
      ...
      {
        for (int pos = HashCommon.murmurHash3(from) & Short2FloatLinkedOpenHashMap.this.mask; Short2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2FloatLinkedOpenHashMap.this.mask) {
    ...
    public void remove()
    {
      ...
      Short2FloatLinkedOpenHashMap.this.size -= 1;
      if (this.prev == -1) {
        Short2FloatLinkedOpenHashMap.this.first = this.next;
      } else {
        Short2FloatLinkedOpenHashMap.this.link[this.prev] ^= (Short2FloatLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
      }
      if (this.next == -1) {
        Short2FloatLinkedOpenHashMap.this.last = this.prev;
      } else {
        Short2FloatLinkedOpenHashMap.this.link[this.next] ^= (Short2FloatLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0;
      }
      int pos = this.curr;
      int last;
      for (;;)
      {
        for (pos = (last = pos) + 1 & Short2FloatLinkedOpenHashMap.this.mask; Short2FloatLinkedOpenHashMap.this.used[pos] != 0; pos = pos + 1 & Short2FloatLinkedOpenHashMap.this.mask)
        {
          int slot = HashCommon.murmurHash3(Short2FloatLinkedOpenHashMap.this.key[pos]) & Short2FloatLinkedOpenHashMap.this.mask;
          if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) {
            break;
          }
        }
        if (Short2FloatLinkedOpenHashMap.this.used[pos] == 0) {
          break;
        }
        Short2FloatLinkedOpenHashMap.this.key[last] = Short2FloatLinkedOpenHashMap.this.key[pos];
      ...
      Short2FloatLinkedOpenHashMap.this.used[last] = false;
      this.curr = -1;
    }
    ...
    implements Short2FloatMap.Entry, Map.Entry<Short, Float>
  {
    ...
    public float setValue(float local_v)
    {
      ...
      Short2FloatLinkedOpenHashMap.this.value[this.index] = local_v;
      return oldValue;
    }
    ...
    public boolean equals(Object local_o)
    {
      ...
      Map.Entry<Short, Float> local_e = (Map.Entry)local_o;
      return (Short2FloatLinkedOpenHashMap.this.key[this.index] == ((Short)local_e.getKey()).shortValue()) && (Short2FloatLinkedOpenHashMap.this.value[this.index] == ((Float)local_e.getValue()).floatValue());
    }
