...
/*  14:    */
/*  62:    */public abstract class AbstractShort2BooleanMap
/*  63:    */  extends AbstractShort2BooleanFunction
/*  64:    */  implements Short2BooleanMap, Serializable
/*  65:    */{
...
/*  79:    */  }
/*  80:    */  
/*  86:    */  public void putAll(Map<? extends Short, ? extends Boolean> m)
/*  87:    */  {
/*  88: 88 */    int n = m.size();
/*  89: 89 */    Iterator<? extends Map.Entry<? extends Short, ? extends Boolean>> i = m.entrySet().iterator();
/*  90: 90 */    if ((m instanceof Short2BooleanMap))
/*  91:    */    {
/*  92: 92 */      while (n-- != 0) {
/*  93: 93 */        Short2BooleanMap.Entry e = (Short2BooleanMap.Entry)i.next();
/*  94: 94 */        put(e.getShortKey(), e.getBooleanValue());
/*  95:    */      }
/*  96:    */      
/*  97:    */    }
/*  98:    */    else
/*  99: 99 */      while (n-- != 0) {
/* 100:100 */        Map.Entry<? extends Short, ? extends Boolean> e = (Map.Entry)i.next();
/* 101:101 */        put((Short)e.getKey(), (Boolean)e.getValue());
/* 102:    */      }
/* 103:    */  }
/* 104:    */  
...
/* 111:    */    implements Short2BooleanMap.Entry
/* 112:    */  {
/* 113:    */    protected short key;
/* 114:    */    protected boolean value;
/* 115:    */    
/* 116:    */    public BasicEntry(Short key, Boolean value)
/* 117:    */    {
/* 118:118 */      this.key = key.shortValue();
/* 119:119 */      this.value = value.booleanValue();
/* 120:    */    }
/* 121:    */    
/* 122:122 */    public BasicEntry(short key, boolean value) { this.key = key;
...
/* 162:    */      
/* 163:163 */      return (this.key == ((Short)e.getKey()).shortValue()) && (this.value == ((Boolean)e.getValue()).booleanValue());
/* 164:    */    }
/* 165:    */    
...
/* 192:    */    {
/* 193:193 */      public boolean contains(short k) { return AbstractShort2BooleanMap.this.containsKey(k); }
/* 194:    */      
/* 195:195 */      public int size() { return AbstractShort2BooleanMap.this.size(); }
/* 196:196 */      public void clear() { AbstractShort2BooleanMap.this.clear(); }
/* 197:    */      
/* 198:    */      public ShortIterator iterator() {
/* 199:199 */        new AbstractShortIterator() {
/* 200:200 */          final ObjectIterator<Map.Entry<Short, Boolean>> i = AbstractShort2BooleanMap.this.entrySet().iterator();
/* 201:    */          
/* 202:202 */          public short nextShort() { return ((Short2BooleanMap.Entry)this.i.next()).getShortKey(); }
/* 203:    */          
...
/* 225:    */    {
/* 226:226 */      public boolean contains(boolean k) { return AbstractShort2BooleanMap.this.containsValue(k); }
/* 227:    */      
/* 228:228 */      public int size() { return AbstractShort2BooleanMap.this.size(); }
/* 229:229 */      public void clear() { AbstractShort2BooleanMap.this.clear(); }
/* 230:    */      
/* 231:    */      public BooleanIterator iterator() {
/* 232:232 */        new AbstractBooleanIterator() {
/* 233:233 */          final ObjectIterator<Map.Entry<Short, Boolean>> i = AbstractShort2BooleanMap.this.entrySet().iterator();
/* 234:    */          
/* 235:235 */          public boolean nextBoolean() { return ((Short2BooleanMap.Entry)this.i.next()).getBooleanValue(); }
/* 236:    */          
...
/* 241:    */  }
/* 242:    */  
/* 244:    */  public ObjectSet<Map.Entry<Short, Boolean>> entrySet()
/* 245:    */  {
/* 246:246 */    return short2BooleanEntrySet();
/* 247:    */  }
/* 248:    */  
/* 257:    */  public int hashCode()
/* 258:    */  {
/* 259:259 */    int h = 0;int n = size();
/* 260:260 */    ObjectIterator<? extends Map.Entry<Short, Boolean>> i = entrySet().iterator();
/* 261:    */    
...
/* 278:278 */    ObjectIterator<? extends Map.Entry<Short, Boolean>> i = entrySet().iterator();
/* 279:279 */    int n = size();
/* 280:    */    
...
/* 287:287 */        s.append(", ");
/* 288:    */      }
/* 289:289 */      Short2BooleanMap.Entry e = (Short2BooleanMap.Entry)i.next();
/* 290:    */      
