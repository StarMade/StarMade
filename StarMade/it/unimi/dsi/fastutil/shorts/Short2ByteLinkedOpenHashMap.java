...
/*      */   }
/*      */ 
/*      */   public byte add(short k, byte incr)
/*      */   {
...
/*  786 */   public Short2ByteSortedMap tailMap(short from) { throw new UnsupportedOperationException(); } 
/*  787 */   public Short2ByteSortedMap headMap(short to) { throw new UnsupportedOperationException(); } 
/*  788 */   public Short2ByteSortedMap subMap(short from, short to) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */ 
...
/* 1107 */           return new Short2ByteLinkedOpenHashMap.ValueIterator(Short2ByteLinkedOpenHashMap.this);
/*      */         }
/*      */         public int size() {
/* 1110 */           return Short2ByteLinkedOpenHashMap.this.size;
/*      */         }
/*      */         public boolean contains(byte v) {
/* 1113 */           return Short2ByteLinkedOpenHashMap.this.containsValue(v);
/*      */         }
/*      */         public void clear() {
/* 1116 */           Short2ByteLinkedOpenHashMap.this.clear();
/*      */         }
/*      */       };
...
/*      */     try
/*      */     {
/* 1249 */       c = (Short2ByteLinkedOpenHashMap)super.clone();
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class ValueIterator extends Short2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ByteListIterator
/*      */   {
/*      */     public byte previousByte()
/*      */     {
/* 1094 */       return Short2ByteLinkedOpenHashMap.this.value[previousEntry()]; } 
/* 1095 */     public Byte previous() { return Byte.valueOf(Short2ByteLinkedOpenHashMap.this.value[previousEntry()]); } 
...
/* 1101 */     public byte nextByte() { return Short2ByteLinkedOpenHashMap.this.value[nextEntry()]; } 
/* 1102 */     public Byte next() { return Byte.valueOf(Short2ByteLinkedOpenHashMap.this.value[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
...
/*      */     {
/* 1051 */       return new Short2ByteLinkedOpenHashMap.KeyIterator(Short2ByteLinkedOpenHashMap.this, from);
/*      */     }
/*      */     public ShortListIterator iterator() {
/* 1054 */       return new Short2ByteLinkedOpenHashMap.KeyIterator(Short2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public int size() {
/* 1057 */       return Short2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public boolean contains(short k) {
/* 1060 */       return Short2ByteLinkedOpenHashMap.this.containsKey(k);
/*      */     }
/*      */     public boolean remove(short k) {
/* 1063 */       int oldSize = Short2ByteLinkedOpenHashMap.this.size;
/* 1064 */       Short2ByteLinkedOpenHashMap.this.remove(k);
/* 1065 */       return Short2ByteLinkedOpenHashMap.this.size != oldSize;
/*      */     }
/*      */     public void clear() {
/* 1068 */       Short2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public short firstShort() {
/* 1071 */       if (Short2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1072 */       return Short2ByteLinkedOpenHashMap.this.key[Short2ByteLinkedOpenHashMap.this.first];
/*      */     }
/*      */     public short lastShort() {
/* 1075 */       if (Short2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/* 1076 */       return Short2ByteLinkedOpenHashMap.this.key[Short2ByteLinkedOpenHashMap.this.last];
/*      */     }
...
/*      */   }
/*      */ 
/*      */   private final class KeyIterator extends Short2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ShortListIterator
/*      */   {
/*      */     public KeyIterator(short k)
/*      */     {
/* 1038 */       super(k, null); } 
/* 1039 */     public short previousShort() { return Short2ByteLinkedOpenHashMap.this.key[previousEntry()]; } 
...
/* 1042 */     public Short previous() { return Short.valueOf(Short2ByteLinkedOpenHashMap.this.key[previousEntry()]); } 
...
/* 1046 */     public short nextShort() { return Short2ByteLinkedOpenHashMap.this.key[nextEntry()]; } 
/* 1047 */     public Short next() { return Short.valueOf(Short2ByteLinkedOpenHashMap.this.key[nextEntry()]); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private final class MapEntrySet extends AbstractObjectSortedSet<Short2ByteMap.Entry>
...
/*      */     {
/*  966 */       return new Short2ByteLinkedOpenHashMap.EntryIterator(Short2ByteLinkedOpenHashMap.this);
/*      */     }
/*  968 */     public Comparator<? super Short2ByteMap.Entry> comparator() { return null; } 
/*  969 */     public ObjectSortedSet<Short2ByteMap.Entry> subSet(Short2ByteMap.Entry fromElement, Short2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  970 */     public ObjectSortedSet<Short2ByteMap.Entry> headSet(Short2ByteMap.Entry toElement) { throw new UnsupportedOperationException(); } 
/*  971 */     public ObjectSortedSet<Short2ByteMap.Entry> tailSet(Short2ByteMap.Entry fromElement) { throw new UnsupportedOperationException(); } 
/*      */     public Short2ByteMap.Entry first() {
/*  973 */       if (Short2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  974 */       return new Short2ByteLinkedOpenHashMap.MapEntry(Short2ByteLinkedOpenHashMap.this, Short2ByteLinkedOpenHashMap.this.first);
/*      */     }
/*      */     public Short2ByteMap.Entry last() {
/*  977 */       if (Short2ByteLinkedOpenHashMap.this.size == 0) throw new NoSuchElementException();
/*  978 */       return new Short2ByteLinkedOpenHashMap.MapEntry(Short2ByteLinkedOpenHashMap.this, Short2ByteLinkedOpenHashMap.this.last);
/*      */     }
/*      */ 
...
/*      */ 
/*  986 */       int pos = HashCommon.murmurHash3(k) & Short2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  988 */       while (Short2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  989 */         if (Short2ByteLinkedOpenHashMap.this.key[pos] == k) return Short2ByteLinkedOpenHashMap.this.value[pos] == ((Byte)e.getValue()).byteValue();
/*  990 */         pos = pos + 1 & Short2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/*  992 */       return false;
/*      */     }
/*      */ 
...
/*      */ 
/* 1000 */       int pos = HashCommon.murmurHash3(k) & Short2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/* 1002 */       while (Short2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/* 1003 */         if (Short2ByteLinkedOpenHashMap.this.key[pos] == k) {
/* 1004 */           Short2ByteLinkedOpenHashMap.this.remove(e.getKey());
/* 1005 */           return true;
/*      */         }
/* 1007 */         pos = pos + 1 & Short2ByteLinkedOpenHashMap.this.mask;
/*      */       }
/* 1009 */       return false;
/*      */     }
/*      */     public int size() {
/* 1012 */       return Short2ByteLinkedOpenHashMap.this.size;
/*      */     }
/*      */     public void clear() {
/* 1015 */       Short2ByteLinkedOpenHashMap.this.clear();
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2ByteMap.Entry> iterator(Short2ByteMap.Entry from) {
/* 1018 */       return new Short2ByteLinkedOpenHashMap.EntryIterator(Short2ByteLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2ByteMap.Entry> fastIterator() {
/* 1021 */       return new Short2ByteLinkedOpenHashMap.FastEntryIterator(Short2ByteLinkedOpenHashMap.this);
/*      */     }
/*      */     public ObjectBidirectionalIterator<Short2ByteMap.Entry> fastIterator(Short2ByteMap.Entry from) {
/* 1024 */       return new Short2ByteLinkedOpenHashMap.FastEntryIterator(Short2ByteLinkedOpenHashMap.this, ((Short)from.getKey()).shortValue());
/*      */     }
/*      */   }
/*      */ 
/*      */   private class FastEntryIterator extends Short2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Short2ByteMap.Entry>
/*      */   {
/*  944 */     final AbstractShort2ByteMap.BasicEntry entry = new AbstractShort2ByteMap.BasicEntry((short)0, (byte)0);
/*      */ 
...
/*  950 */       int e = nextEntry();
/*  951 */       this.entry.key = Short2ByteLinkedOpenHashMap.this.key[e];
/*  952 */       this.entry.value = Short2ByteLinkedOpenHashMap.this.value[e];
/*  953 */       return this.entry;
/*      */     }
/*      */     public AbstractShort2ByteMap.BasicEntry previous() {
/*  956 */       int e = previousEntry();
/*  957 */       this.entry.key = Short2ByteLinkedOpenHashMap.this.key[e];
/*  958 */       this.entry.value = Short2ByteLinkedOpenHashMap.this.value[e];
/*  959 */       return this.entry;
/*      */     }
/*  961 */     public void set(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  962 */     public void add(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
/*      */   private class EntryIterator extends Short2ByteLinkedOpenHashMap.MapIterator
/*      */     implements ObjectListIterator<Short2ByteMap.Entry>
/*      */   {
...
/*  930 */       return this.entry = new Short2ByteLinkedOpenHashMap.MapEntry(Short2ByteLinkedOpenHashMap.this, nextEntry());
/*      */     }
/*      */     public Short2ByteLinkedOpenHashMap.MapEntry previous() {
/*  933 */       return this.entry = new Short2ByteLinkedOpenHashMap.MapEntry(Short2ByteLinkedOpenHashMap.this, previousEntry());
/*      */     }
/*      */ 
/*      */     public void remove() {
/*  937 */       super.remove();
/*  938 */       Short2ByteLinkedOpenHashMap.MapEntry.access$202(this.entry, -1);
/*      */     }
/*  940 */     public void set(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); } 
/*  941 */     public void add(Short2ByteMap.Entry ok) { throw new UnsupportedOperationException(); }
/*      */ 
/*      */   }
/*      */ 
...
/*  803 */     int index = -1;
/*      */ 
/*  805 */     private MapIterator() { this.next = Short2ByteLinkedOpenHashMap.this.first;
/*  806 */       this.index = 0; }
/*      */ 
/*      */     private MapIterator(short from) {
/*  809 */       if (Short2ByteLinkedOpenHashMap.this.key[Short2ByteLinkedOpenHashMap.this.last] == from) {
/*  810 */         this.prev = Short2ByteLinkedOpenHashMap.this.last;
/*  811 */         this.index = Short2ByteLinkedOpenHashMap.this.size;
/*      */       }
/*      */       else
/*      */       {
/*  815 */         int pos = HashCommon.murmurHash3(from) & Short2ByteLinkedOpenHashMap.this.mask;
/*      */ 
/*  817 */         while (Short2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  818 */           if (Short2ByteLinkedOpenHashMap.this.key[pos] == from)
/*      */           {
/*  820 */             this.next = ((int)Short2ByteLinkedOpenHashMap.this.link[pos]);
/*  821 */             this.prev = pos;
/*  822 */             return;
/*      */           }
/*  824 */           pos = pos + 1 & Short2ByteLinkedOpenHashMap.this.mask;
/*      */         }
...
/*      */       }
/*  837 */       if (this.next == -1) {
/*  838 */         this.index = Short2ByteLinkedOpenHashMap.this.size;
/*  839 */         return;
/*      */       }
/*  841 */       int pos = Short2ByteLinkedOpenHashMap.this.first;
/*  842 */       this.index = 1;
/*  843 */       while (pos != this.prev) {
/*  844 */         pos = (int)Short2ByteLinkedOpenHashMap.this.link[pos];
/*  845 */         this.index += 1;
/*      */       }
/*      */     }
/*      */ 
...
/*  857 */       if (!hasNext()) return Short2ByteLinkedOpenHashMap.this.size();
/*  858 */       this.curr = this.next;
/*  859 */       this.next = ((int)Short2ByteLinkedOpenHashMap.this.link[this.curr]);
...
/*  867 */       this.prev = ((int)(Short2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
...
/*      */       {
/*  879 */         this.index -= 1;
/*  880 */         this.prev = ((int)(Short2ByteLinkedOpenHashMap.this.link[this.curr] >>> 32));
/*      */       }
/*      */       else {
/*  883 */         this.next = ((int)Short2ByteLinkedOpenHashMap.this.link[this.curr]);
/*  884 */       }Short2ByteLinkedOpenHashMap.this.size -= 1;
/*      */ 
/*  887 */       if (this.prev == -1) Short2ByteLinkedOpenHashMap.this.first = this.next;
/*      */       else
/*  889 */         Short2ByteLinkedOpenHashMap.this.link[this.prev] ^= (Short2ByteLinkedOpenHashMap.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/*  890 */       if (this.next == -1) Short2ByteLinkedOpenHashMap.this.last = this.prev;
/*      */       else
/*  892 */         Short2ByteLinkedOpenHashMap.this.link[this.next] ^= (Short2ByteLinkedOpenHashMap.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*      */       int last;
/*      */       while (true) {
/*  896 */         pos = (last = pos) + 1 & Short2ByteLinkedOpenHashMap.this.mask;
/*  897 */         while (Short2ByteLinkedOpenHashMap.this.used[pos] != 0) {
/*  898 */           int slot = HashCommon.murmurHash3(Short2ByteLinkedOpenHashMap.this.key[pos]) & Short2ByteLinkedOpenHashMap.this.mask;
/*  899 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/*  900 */           pos = pos + 1 & Short2ByteLinkedOpenHashMap.this.mask;
/*      */         }
/*  902 */         if (Short2ByteLinkedOpenHashMap.this.used[pos] == 0) break;
/*  903 */         Short2ByteLinkedOpenHashMap.this.key[last] = Short2ByteLinkedOpenHashMap.this.key[pos];
/*  904 */         Short2ByteLinkedOpenHashMap.this.value[last] = Short2ByteLinkedOpenHashMap.this.value[pos];
/*  905 */         if (this.next == pos) this.next = last;
/*  906 */         if (this.prev == pos) this.prev = last;
/*  907 */         Short2ByteLinkedOpenHashMap.this.fixPointers(pos, last);
/*      */       }
/*  909 */       Short2ByteLinkedOpenHashMap.this.used[last] = false;
/*  910 */       this.curr = -1;
/*      */     }
...
/*      */     }
/*      */     public Short getKey() {
/*  669 */       return Short.valueOf(Short2ByteLinkedOpenHashMap.this.key[this.index]);
/*      */     }
/*      */     public short getShortKey() {
/*  672 */       return Short2ByteLinkedOpenHashMap.this.key[this.index];
/*      */     }
/*      */     public Byte getValue() {
/*  675 */       return Byte.valueOf(Short2ByteLinkedOpenHashMap.this.value[this.index]);
/*      */     }
/*      */     public byte getByteValue() {
/*  678 */       return Short2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public byte setValue(byte v) {
/*  681 */       byte oldValue = Short2ByteLinkedOpenHashMap.this.value[this.index];
/*  682 */       Short2ByteLinkedOpenHashMap.this.value[this.index] = v;
/*  683 */       return oldValue;
/*      */     }
/*      */     public Byte setValue(Byte v) {
...
/*  692 */       return (Short2ByteLinkedOpenHashMap.this.key[this.index] == ((Short)e.getKey()).shortValue()) && (Short2ByteLinkedOpenHashMap.this.value[this.index] == ((Byte)e.getValue()).byteValue());
/*      */     }
/*      */     public int hashCode() {
/*  695 */       return Short2ByteLinkedOpenHashMap.this.key[this.index] ^ Short2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */     public String toString() {
/*  698 */       return Short2ByteLinkedOpenHashMap.this.key[this.index] + "=>" + Short2ByteLinkedOpenHashMap.this.value[this.index];
/*      */     }
/*      */   }
/*      */ }
