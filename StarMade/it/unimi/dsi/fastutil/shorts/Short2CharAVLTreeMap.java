  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2CharAVLTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2CharAVLTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2CharAVLTreeMap(Map<? extends Short, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2CharAVLTreeMap(SortedMap<Short, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2CharAVLTreeMap(Short2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2CharAVLTreeMap(Short2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2CharAVLTreeMap(short[] local_k, char[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2CharAVLTreeMap(short[] local_k, char[] local_v)
  {
  ...
  {
    char oldValue = put(local_ok.shortValue(), local_ov.charValue());
    return this.modified ? null : Character.valueOf(oldValue);
  }
  
  public Character remove(Object local_ok)
  {
    char oldValue = remove(((Short)local_ok).shortValue());
  ...
  public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Short2CharMap.Entry> comparator = new Comparator()
        {
          public int compare(Short2CharMap.Entry local_x, Short2CharMap.Entry local_y)
          {
            return Short2CharAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2CharAVLTreeMap.EntryIterator(Short2CharAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from)
        {
          return new Short2CharAVLTreeMap.EntryIterator(Short2CharAVLTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2CharAVLTreeMap.Entry local_f = Short2CharAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2CharAVLTreeMap.Entry local_f = Short2CharAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2CharAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry from, Short2CharMap.Entry local_to)
        {
          return Short2CharAVLTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2CharEntrySet();
        }
        
        public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry local_to)
        {
          return Short2CharAVLTreeMap.this.headMap((Short)local_to.getKey()).short2CharEntrySet();
        }
        
        public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from)
        {
          return Short2CharAVLTreeMap.this.tailMap((Short)from.getKey()).short2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Short2CharAVLTreeMap.ValueIterator(Short2CharAVLTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Short2CharAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2CharAVLTreeMap local_c;
    try
    {
      local_c = (Short2CharAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readShort(), local_s.readChar());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readShort(), local_s.readChar());
      top.right(new Entry(local_s.readShort(), local_s.readChar()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2CharAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2CharAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2CharAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator()
          {
            return new Short2CharAVLTreeMap.Submap.SubmapEntryIterator(Short2CharAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from)
          {
            return new Short2CharAVLTreeMap.Submap.SubmapEntryIterator(Short2CharAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Character> local_e = (Map.Entry)local_o;
            Short2CharAVLTreeMap.Entry local_f = Short2CharAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2CharAVLTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Character> local_e = (Map.Entry)local_o;
            Short2CharAVLTreeMap.Entry local_f = Short2CharAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2CharAVLTreeMap.Submap.this.in6(local_f.key))) {
              Short2CharAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2CharAVLTreeMap.Submap.SubmapIterator(Short2CharAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2CharAVLTreeMap.Submap.this.clear();
          }
          
          public Short2CharMap.Entry first()
          {
            return Short2CharAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Short2CharMap.Entry last()
          {
            return Short2CharAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry from, Short2CharMap.Entry local_to)
          {
            return Short2CharAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2CharEntrySet();
          }
          
          public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry local_to)
          {
            return Short2CharAVLTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2CharEntrySet();
          }
          
          public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from)
          {
            return Short2CharAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Short2CharAVLTreeMap.Submap.SubmapValueIterator(Short2CharAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Short2CharAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2CharAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2CharAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2CharAVLTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2CharAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(short local_k, char local_v)
    {
      ...
      char oldValue = Short2CharAVLTreeMap.this.put(local_k, local_v);
    ...
    public char remove(short local_k)
    {
      ...
      char oldValue = Short2CharAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2CharAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2CharAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2CharSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2CharAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2CharAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2CharAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2CharSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2CharAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2CharAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2CharAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2CharAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2CharAVLTreeMap.this.locateKey(this.from);
        if (Short2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2CharAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2CharAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2CharAVLTreeMap.this.locateKey(this.field_47);
        if (Short2CharAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2CharAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2CharAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2CharAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2CharAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2CharAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2CharAVLTreeMap.Submap.this.bottom) && (Short2CharAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2CharAVLTreeMap.Submap.this.top) && (Short2CharAVLTreeMap.this.compare(local_k, (this.prev = Short2CharAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2CharAVLTreeMap.this.locateKey(local_k);
            if (Short2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2CharAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2CharAVLTreeMap.this.compare(this.prev.key, Short2CharAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2CharAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2CharAVLTreeMap.this.compare(this.next.key, Short2CharAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2CharSortedMap.KeySet
    {
      ...
      {
        return new Short2CharAVLTreeMap.Submap.SubmapKeyIterator(Short2CharAVLTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2CharAVLTreeMap.Submap.SubmapKeyIterator(Short2CharAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2CharSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2CharAVLTreeMap.KeyIterator(Short2CharAVLTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2CharAVLTreeMap.KeyIterator(Short2CharAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2CharAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Short2CharAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Short2CharMap.Entry
  {
    ...
    Entry(short local_k, char local_v)
    {
      this.key = local_k;
      this.value = local_v;
