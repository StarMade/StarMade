  ...
  implements Serializable, Cloneable
{
  ...
  public Short2CharArrayMap(Short2CharMap local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  
  public Short2CharArrayMap(Map<? extends Short, ? extends Character> local_m)
  {
    this(local_m.size());
    putAll(local_m);
  }
  ...
  {
    Short2CharArrayMap local_c;
    try
    {
      local_c = (Short2CharArrayMap)super.clone();
    }
    ...
    implements Short2CharMap.FastEntrySet
  {
    ...
    public ObjectIterator<Short2CharMap.Entry> iterator()
    {
      new AbstractObjectIterator()
      {
        ...
        public Short2CharMap.Entry next()
        {
          ...
          return new AbstractShort2CharMap.BasicEntry(Short2CharArrayMap.this.key[this.next], Short2CharArrayMap.this.value[(this.next++)]);
        }
      };
    }
    ...
    public boolean contains(Object local_o)
    {
      ...
      return (Short2CharArrayMap.this.containsKey(local_k)) && (Short2CharArrayMap.this.get(local_k) == ((Character)local_e.getValue()).charValue());
    }
  }
}
