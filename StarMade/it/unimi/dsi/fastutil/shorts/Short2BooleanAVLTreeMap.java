  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2BooleanAVLTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2BooleanAVLTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2BooleanAVLTreeMap(Map<? extends Short, ? extends Boolean> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2BooleanAVLTreeMap(SortedMap<Short, Boolean> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2BooleanAVLTreeMap(Short2BooleanMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2BooleanAVLTreeMap(Short2BooleanSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2BooleanAVLTreeMap(short[] local_k, boolean[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2BooleanAVLTreeMap(short[] local_k, boolean[] local_v)
  {
  ...
  {
    boolean oldValue = put(local_ok.shortValue(), local_ov.booleanValue());
    return this.modified ? null : Boolean.valueOf(oldValue);
  }
  
  public Boolean remove(Object local_ok)
  {
    boolean oldValue = remove(((Short)local_ok).shortValue());
  ...
  public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet()
  {
    if (this.entries == null) {
      ...
      {
        final Comparator<? super Short2BooleanMap.Entry> comparator = new Comparator()
        {
          public int compare(Short2BooleanMap.Entry local_x, Short2BooleanMap.Entry local_y)
          {
            return Short2BooleanAVLTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2BooleanAVLTreeMap.EntryIterator(Short2BooleanAVLTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from)
        {
          return new Short2BooleanAVLTreeMap.EntryIterator(Short2BooleanAVLTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2BooleanAVLTreeMap.Entry local_f = Short2BooleanAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2BooleanAVLTreeMap.Entry local_f = Short2BooleanAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2BooleanAVLTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry from, Short2BooleanMap.Entry local_to)
        {
          return Short2BooleanAVLTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry local_to)
        {
          return Short2BooleanAVLTreeMap.this.headMap((Short)local_to.getKey()).short2BooleanEntrySet();
        }
        
        public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry from)
        {
          return Short2BooleanAVLTreeMap.this.tailMap((Short)from.getKey()).short2BooleanEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public BooleanCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractBooleanCollection()
      {
        ...
        {
          return new Short2BooleanAVLTreeMap.ValueIterator(Short2BooleanAVLTreeMap.this, null);
        }
        
        public boolean contains(boolean local_k)
        {
          return Short2BooleanAVLTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2BooleanAVLTreeMap local_c;
    try
    {
      local_c = (Short2BooleanAVLTreeMap)super.clone();
    }
    ...
    throws IOException, ClassNotFoundException
  {
    if (local_n == 1)
    {
      Entry top = new Entry(local_s.readShort(), local_s.readBoolean());
      top.pred(pred);
      top.succ(succ);
      return top;
    }
    ...
    {
      Entry top = new Entry(local_s.readShort(), local_s.readBoolean());
      top.right(new Entry(local_s.readShort(), local_s.readBoolean()));
      top.right.pred(top);
      top.balance(1);
      top.pred(pred);
      top.right.succ(succ);
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2BooleanAVLTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2BooleanAVLTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2BooleanAVLTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2BooleanMap.Entry> short2BooleanEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator()
          {
            return new Short2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Short2BooleanAVLTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2BooleanMap.Entry> iterator(Short2BooleanMap.Entry from)
          {
            return new Short2BooleanAVLTreeMap.Submap.SubmapEntryIterator(Short2BooleanAVLTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Boolean> local_e = (Map.Entry)local_o;
            Short2BooleanAVLTreeMap.Entry local_f = Short2BooleanAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2BooleanAVLTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Boolean> local_e = (Map.Entry)local_o;
            Short2BooleanAVLTreeMap.Entry local_f = Short2BooleanAVLTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2BooleanAVLTreeMap.Submap.this.in6(local_f.key))) {
              Short2BooleanAVLTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2BooleanAVLTreeMap.Submap.SubmapIterator(Short2BooleanAVLTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2BooleanAVLTreeMap.Submap.this.clear();
          }
          
          public Short2BooleanMap.Entry first()
          {
            return Short2BooleanAVLTreeMap.Submap.this.firstEntry();
          }
          
          public Short2BooleanMap.Entry last()
          {
            return Short2BooleanAVLTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2BooleanMap.Entry> subSet(Short2BooleanMap.Entry from, Short2BooleanMap.Entry local_to)
          {
            return Short2BooleanAVLTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Short2BooleanMap.Entry> headSet(Short2BooleanMap.Entry local_to)
          {
            return Short2BooleanAVLTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2BooleanEntrySet();
          }
          
          public ObjectSortedSet<Short2BooleanMap.Entry> tailSet(Short2BooleanMap.Entry from)
          {
            return Short2BooleanAVLTreeMap.Submap.this.tailMap((Short)from.getKey()).short2BooleanEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public BooleanCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractBooleanCollection()
        {
          public BooleanIterator iterator()
          {
            return new Short2BooleanAVLTreeMap.Submap.SubmapValueIterator(Short2BooleanAVLTreeMap.Submap.this, null);
          }
          
          public boolean contains(boolean local_k)
          {
            return Short2BooleanAVLTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2BooleanAVLTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2BooleanAVLTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2BooleanAVLTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2BooleanAVLTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public boolean put(short local_k, boolean local_v)
    {
      ...
      boolean oldValue = Short2BooleanAVLTreeMap.this.put(local_k, local_v);
    ...
    public boolean remove(short local_k)
    {
      ...
      boolean oldValue = Short2BooleanAVLTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2BooleanAVLTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2BooleanSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2BooleanAVLTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2BooleanAVLTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2BooleanAVLTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2BooleanSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2BooleanAVLTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2BooleanAVLTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2BooleanAVLTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2BooleanAVLTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2BooleanAVLTreeMap.this.locateKey(this.from);
        if (Short2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2BooleanAVLTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2BooleanAVLTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2BooleanAVLTreeMap.this.locateKey(this.field_47);
        if (Short2BooleanAVLTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2BooleanAVLTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2BooleanAVLTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2BooleanAVLTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2BooleanAVLTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2BooleanAVLTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2BooleanAVLTreeMap.Submap.this.bottom) && (Short2BooleanAVLTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2BooleanAVLTreeMap.Submap.this.top) && (Short2BooleanAVLTreeMap.this.compare(local_k, (this.prev = Short2BooleanAVLTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2BooleanAVLTreeMap.this.locateKey(local_k);
            if (Short2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2BooleanAVLTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2BooleanAVLTreeMap.this.compare(this.prev.key, Short2BooleanAVLTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2BooleanAVLTreeMap.Submap.this.top) && (this.next != null) && (Short2BooleanAVLTreeMap.this.compare(this.next.key, Short2BooleanAVLTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2BooleanSortedMap.KeySet
    {
      ...
      {
        return new Short2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Short2BooleanAVLTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2BooleanAVLTreeMap.Submap.SubmapKeyIterator(Short2BooleanAVLTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2BooleanSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2BooleanAVLTreeMap.KeyIterator(Short2BooleanAVLTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2BooleanAVLTreeMap.KeyIterator(Short2BooleanAVLTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2BooleanAVLTreeMap.this.locateKey(local_k)) != null) {
        if (Short2BooleanAVLTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
    ...
    implements Cloneable, Short2BooleanMap.Entry
  {
    ...
    Entry(short local_k, boolean local_v)
    {
      this.key = local_k;
      this.value = local_v;
