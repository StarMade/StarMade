...
/* 194 */     while (i.hasNext()) add(i.nextShort());
/*     */   }
/*     */ 
...
/*     */   {
/* 211 */     this(ShortIterators.asShortIterator(i), f, strategy);
/*     */   }
/*     */ 
/*     */   public ShortLinkedOpenCustomHashSet(Iterator<?> i, ShortHash.Strategy strategy)
/*     */   {
/* 219 */     this(ShortIterators.asShortIterator(i), strategy);
/*     */   }
/*     */ 
...
/* 231 */     ShortArrays.ensureOffsetLength(a, offset, length);
...
/*     */   }
/* 609 */   public ShortSortedSet tailSet(short from) { throw new UnsupportedOperationException(); } 
/* 610 */   public ShortSortedSet headSet(short to) { throw new UnsupportedOperationException(); } 
/* 611 */   public ShortSortedSet subSet(short from, short to) { throw new UnsupportedOperationException(); } 
/* 612 */   public ShortComparator comparator() { return null; }
/*     */ 
/*     */ 
...
/*     */ 
/* 825 */     short[] key = this.key;
/* 826 */     int newMask = newN - 1;
/* 827 */     short[] newKey = new short[newN];
...
/*     */     try
/*     */     {
/* 874 */       c = (ShortLinkedOpenCustomHashSet)super.clone();
/*     */     }
/*     */     catch (CloneNotSupportedException cantHappen) {
/* 877 */       throw new InternalError();
/*     */     }
/* 879 */     c.key = ((short[])this.key.clone());
...
/*     */     }
/* 901 */     return h; } 
/* 904 */   private void writeObject(ObjectOutputStream s) throws IOException { ShortIterator i = iterator();
/* 905 */     s.defaultWriteObject();
/* 906 */     for (int j = this.size; j-- != 0; s.writeShort(i.nextShort()));
/*     */   }
/*     */ 
...
/* 914 */     short[] key = this.key = new short[this.n];
...
/* 627 */     int index = -1;
/*     */ 
/* 629 */     SetIterator() { this.next = ShortLinkedOpenCustomHashSet.this.first;
/* 630 */       this.index = 0; }
/*     */ 
/*     */     SetIterator(short from) {
/* 633 */       if (ShortLinkedOpenCustomHashSet.this.strategy.equals(ShortLinkedOpenCustomHashSet.this.key[ShortLinkedOpenCustomHashSet.this.last], from)) {
/* 634 */         this.prev = ShortLinkedOpenCustomHashSet.this.last;
/* 635 */         this.index = ShortLinkedOpenCustomHashSet.this.size;
/*     */       }
/*     */       else
/*     */       {
/* 639 */         int pos = HashCommon.murmurHash3(ShortLinkedOpenCustomHashSet.this.strategy.hashCode(from)) & ShortLinkedOpenCustomHashSet.this.mask;
/*     */ 
/* 641 */         while (ShortLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 642 */           if (ShortLinkedOpenCustomHashSet.this.strategy.equals(ShortLinkedOpenCustomHashSet.this.key[pos], from))
/*     */           {
/* 644 */             this.next = ((int)ShortLinkedOpenCustomHashSet.this.link[pos]);
/* 645 */             this.prev = pos;
/* 646 */             return;
/*     */           }
/* 648 */           pos = pos + 1 & ShortLinkedOpenCustomHashSet.this.mask;
/*     */         }
...
/* 658 */       this.next = ((int)ShortLinkedOpenCustomHashSet.this.link[this.curr]);
/* 659 */       this.prev = this.curr;
/* 660 */       if (this.index >= 0) this.index += 1;
/*     */ 
/* 662 */       return ShortLinkedOpenCustomHashSet.this.key[this.curr];
/*     */     }
/*     */     public short previousShort() {
/* 665 */       if (!hasPrevious()) throw new NoSuchElementException();
/* 666 */       this.curr = this.prev;
/* 667 */       this.prev = ((int)(ShortLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/* 668 */       this.next = this.curr;
/* 669 */       if (this.index >= 0) this.index -= 1;
/* 670 */       return ShortLinkedOpenCustomHashSet.this.key[this.curr];
/*     */     }
...
/*     */       }
/* 678 */       if (this.next == -1) {
/* 679 */         this.index = ShortLinkedOpenCustomHashSet.this.size;
/* 680 */         return;
/*     */       }
/* 682 */       int pos = ShortLinkedOpenCustomHashSet.this.first;
/* 683 */       this.index = 1;
/* 684 */       while (pos != this.prev) {
/* 685 */         pos = (int)ShortLinkedOpenCustomHashSet.this.link[pos];
/* 686 */         this.index += 1;
/*     */       }
/*     */     }
/*     */ 
...
/*     */       {
/* 704 */         this.index -= 1;
/* 705 */         this.prev = ((int)(ShortLinkedOpenCustomHashSet.this.link[this.curr] >>> 32));
/*     */       }
/*     */       else {
/* 708 */         this.next = ((int)ShortLinkedOpenCustomHashSet.this.link[this.curr]);
/* 709 */       }ShortLinkedOpenCustomHashSet.this.size -= 1;
/*     */ 
/* 712 */       if (this.prev == -1) ShortLinkedOpenCustomHashSet.this.first = this.next;
/*     */       else
/* 714 */         ShortLinkedOpenCustomHashSet.this.link[this.prev] ^= (ShortLinkedOpenCustomHashSet.this.link[this.prev] ^ this.next & 0xFFFFFFFF) & 0xFFFFFFFF;
/* 715 */       if (this.next == -1) ShortLinkedOpenCustomHashSet.this.last = this.prev;
/*     */       else
/* 717 */         ShortLinkedOpenCustomHashSet.this.link[this.next] ^= (ShortLinkedOpenCustomHashSet.this.link[this.next] ^ (this.prev & 0xFFFFFFFF) << 32) & 0x0; int pos = this.curr;
/*     */       int last;
/*     */       while (true) {
/* 721 */         pos = (last = pos) + 1 & ShortLinkedOpenCustomHashSet.this.mask;
/* 722 */         while (ShortLinkedOpenCustomHashSet.this.used[pos] != 0) {
/* 723 */           int slot = HashCommon.murmurHash3(ShortLinkedOpenCustomHashSet.this.strategy.hashCode(ShortLinkedOpenCustomHashSet.this.key[pos])) & ShortLinkedOpenCustomHashSet.this.mask;
/* 724 */           if (last <= pos ? (last < slot) && (slot <= pos) : (last >= slot) && (slot > pos)) break;
/* 725 */           pos = pos + 1 & ShortLinkedOpenCustomHashSet.this.mask;
/*     */         }
/* 727 */         if (ShortLinkedOpenCustomHashSet.this.used[pos] == 0) break;
/* 728 */         ShortLinkedOpenCustomHashSet.this.key[last] = ShortLinkedOpenCustomHashSet.this.key[pos];
/* 729 */         if (this.next == pos) this.next = last;
/* 730 */         if (this.prev == pos) this.prev = last;
/* 731 */         ShortLinkedOpenCustomHashSet.this.fixPointers(pos, last);
/*     */       }
/* 733 */       ShortLinkedOpenCustomHashSet.this.used[last] = false;
/* 734 */       this.curr = -1;
/*     */     }
/*     */   }
/*     */ }
