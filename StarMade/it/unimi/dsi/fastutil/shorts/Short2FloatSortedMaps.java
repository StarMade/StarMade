...
/*     */   {
/* 173 */     return new Singleton(key.shortValue(), value.floatValue());
/*     */   }
/*     */ 
/*     */   public static Short2FloatSortedMap singleton(Short key, Float value, ShortComparator comparator)
/*     */   {
/* 187 */     return new Singleton(key.shortValue(), value.floatValue(), comparator);
/*     */   }
/*     */ 
/*     */   public static Short2FloatSortedMap singleton(short key, float value)
/*     */   {
...
/*     */     }
/* 302 */     public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.unmodifiable(this.sortedMap.short2FloatEntrySet()); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Float>> entrySet() {
/* 304 */       return short2FloatEntrySet(); } 
...
/* 308 */     public Short2FloatSortedMap headMap(short to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 309 */     public Short2FloatSortedMap tailMap(short from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); } 
...
/* 319 */     public Short2FloatSortedMap headMap(Short to) { return new UnmodifiableSortedMap(this.sortedMap.headMap(to)); } 
/* 320 */     public Short2FloatSortedMap tailMap(Short from) { return new UnmodifiableSortedMap(this.sortedMap.tailMap(from)); }
/*     */ 
/*     */   }
/*     */ 
...
/*     */     }
/* 242 */     public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() { if (this.entries == null) this.entries = ObjectSortedSets.synchronize(this.sortedMap.short2FloatEntrySet(), this.sync); return (ObjectSortedSet)this.entries; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Float>> entrySet() {
/* 244 */       return short2FloatEntrySet(); } 
...
/* 248 */     public Short2FloatSortedMap headMap(short to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 249 */     public Short2FloatSortedMap tailMap(short from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); } 
/*     */     public short firstShortKey() {
...
/* 259 */     public Short2FloatSortedMap headMap(Short to) { return new SynchronizedSortedMap(this.sortedMap.headMap(to), this.sync); } 
/* 260 */     public Short2FloatSortedMap tailMap(Short from) { return new SynchronizedSortedMap(this.sortedMap.tailMap(from), this.sync); }
/*     */ 
/*     */   }
/*     */ 
...
/* 135 */       if (this.entries == null) this.entries = ObjectSortedSets.singleton(new Short2FloatMaps.Singleton.SingletonEntry(this), Short2FloatSortedMaps.entryComparator(this.comparator)); return (ObjectSortedSet)this.entries;
/*     */     }
/* 137 */     public ObjectSortedSet<Map.Entry<Short, Float>> entrySet() { return short2FloatEntrySet(); } 
/*     */     public ShortSortedSet keySet() {
/* 139 */       if (this.keys == null) this.keys = ShortSortedSets.singleton(this.key, this.comparator); return (ShortSortedSet)this.keys;
/*     */     }
/*     */     public Short2FloatSortedMap subMap(short from, short to) {
/* 142 */       if ((compare(from, this.key) <= 0) && (compare(this.key, to) < 0)) return this; return Short2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Short2FloatSortedMap headMap(short to) {
/* 145 */       if (compare(this.key, to) < 0) return this; return Short2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*     */     public Short2FloatSortedMap tailMap(short from) {
/* 148 */       if (compare(from, this.key) <= 0) return this; return Short2FloatSortedMaps.EMPTY_MAP;
/*     */     }
...
/* 155 */     public Short2FloatSortedMap tailMap(Short ofrom) { return tailMap(ofrom.shortValue()); } 
/* 156 */     public Short2FloatSortedMap subMap(Short ofrom, Short oto) { return subMap(ofrom.shortValue(), oto.shortValue()); } 
/*     */     public Short firstKey() {
...
/*  78 */       return null;
/*     */     }
/*  80 */     public ObjectSortedSet<Short2FloatMap.Entry> short2FloatEntrySet() { return ObjectSortedSets.EMPTY_SET; } 
/*     */     public ObjectSortedSet<Map.Entry<Short, Float>> entrySet() {
/*  82 */       return ObjectSortedSets.EMPTY_SET;
/*     */     }
/*  84 */     public ShortSortedSet keySet() { return ShortSortedSets.EMPTY_SET; } 
/*     */     public Short2FloatSortedMap subMap(short from, short to) {
/*  86 */       return Short2FloatSortedMaps.EMPTY_MAP;
/*     */     }
/*  88 */     public Short2FloatSortedMap headMap(short to) { return Short2FloatSortedMaps.EMPTY_MAP; } 
/*     */     public Short2FloatSortedMap tailMap(short from) {
/*  90 */       return Short2FloatSortedMaps.EMPTY_MAP; } 
...
/*  93 */     public Short2FloatSortedMap headMap(Short oto) { return headMap(oto.shortValue()); } 
/*  94 */     public Short2FloatSortedMap tailMap(Short ofrom) { return tailMap(ofrom.shortValue()); } 
/*  95 */     public Short2FloatSortedMap subMap(Short ofrom, Short oto) { return subMap(ofrom.shortValue(), oto.shortValue()); } 
