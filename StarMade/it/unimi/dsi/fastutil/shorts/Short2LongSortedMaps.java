...
public class Short2LongSortedMaps
{
  ...
  public static Short2LongSortedMap synchronize(Short2LongSortedMap local_m)
  {
    return new SynchronizedSortedMap(local_m);
  }
  
  public static Short2LongSortedMap synchronize(Short2LongSortedMap local_m, Object sync)
  {
    return new SynchronizedSortedMap(local_m, sync);
  }
  
  public static Short2LongSortedMap unmodifiable(Short2LongSortedMap local_m)
  {
    ...
    implements Short2LongSortedMap, Serializable
  {
    ...
    protected UnmodifiableSortedMap(Short2LongSortedMap local_m)
    {
      super();
    ...
    implements Short2LongSortedMap, Serializable
  {
    ...
    protected SynchronizedSortedMap(Short2LongSortedMap local_m, Object sync)
    {
      super(sync);
      this.sortedMap = local_m;
    }
    
    protected SynchronizedSortedMap(Short2LongSortedMap local_m)
    {
      super();
      this.sortedMap = local_m;
    }
    ...
    implements Short2LongSortedMap, Serializable, Cloneable
  {
    ...
    {
      if (this.entries == null) {
        this.entries = ObjectSortedSets.singleton(new Short2LongMaps.Singleton.SingletonEntry(this), Short2LongSortedMaps.entryComparator(this.comparator));
      }
      return (ObjectSortedSet)this.entries;
    }
