  ...
  implements Serializable, Cloneable
{
  ...
  private void setActualComparator()
  {
    if ((this.storedComparator == null) || ((this.storedComparator instanceof ShortComparator))) {
      ...
      this.actualComparator = new ShortComparator()
      {
        ...
        {
          return Short2CharRBTreeMap.this.storedComparator.compare(Short.valueOf(local_k1), Short.valueOf(local_k2));
        }
  ...
  public Short2CharRBTreeMap(Comparator<? super Short> local_c)
  {
    this();
  ...
  public Short2CharRBTreeMap(Map<? extends Short, ? extends Character> local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2CharRBTreeMap(SortedMap<Short, Character> local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2CharRBTreeMap(Short2CharMap local_m)
  {
    this();
    putAll(local_m);
  }
  
  public Short2CharRBTreeMap(Short2CharSortedMap local_m)
  {
    this(local_m.comparator());
    putAll(local_m);
  }
  
  public Short2CharRBTreeMap(short[] local_k, char[] local_v, Comparator<? super Short> local_c)
  {
    this(local_c);
  ...
  public Short2CharRBTreeMap(short[] local_k, char[] local_v)
  {
    ...
    if (this.entries == null) {
      this.entries = new AbstractObjectSortedSet()
      {
        final Comparator<? super Short2CharMap.Entry> comparator = new Comparator()
        {
          ...
          {
            return Short2CharRBTreeMap.this.storedComparator.compare(local_x.getKey(), local_y.getKey());
          }
        };
        ...
        {
          return new Short2CharRBTreeMap.EntryIterator(Short2CharRBTreeMap.this);
        }
        
        public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from)
        {
          return new Short2CharRBTreeMap.EntryIterator(Short2CharRBTreeMap.this, ((Short)from.getKey()).shortValue());
        }
        ...
        public boolean contains(Object local_o)
        {
          ...
          Short2CharRBTreeMap.Entry local_f = Short2CharRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
        ...
        public boolean remove(Object local_o)
        {
          ...
          Short2CharRBTreeMap.Entry local_f = Short2CharRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
          if (local_f != null) {
            Short2CharRBTreeMap.this.remove(local_f.key);
          }
          return local_f != null;
        }
        ...
        {
          return Short2CharRBTreeMap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2CharEntrySet();
        }
        
        public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry local_to)
        {
          return Short2CharRBTreeMap.this.headMap((Short)local_to.getKey()).short2CharEntrySet();
        }
        
        public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from)
        {
          return Short2CharRBTreeMap.this.tailMap((Short)from.getKey()).short2CharEntrySet();
        }
      };
    }
    return this.entries;
  ...
  public CharCollection values()
  {
    if (this.values == null) {
      this.values = new AbstractCharCollection()
      {
        ...
        {
          return new Short2CharRBTreeMap.ValueIterator(Short2CharRBTreeMap.this, null);
        }
        
        public boolean contains(char local_k)
        {
          return Short2CharRBTreeMap.this.containsValue(local_k);
        }
  ...
  {
    Short2CharRBTreeMap local_c;
    try
    {
      local_c = (Short2CharRBTreeMap)super.clone();
    }
    ...
    implements Serializable
  {
    ...
    {
      if ((!bottom) && (!top) && (Short2CharRBTreeMap.this.compare(from, local_to) > 0)) {
    ...
    {
      return ((this.bottom) || (Short2CharRBTreeMap.this.compare(local_k, this.from) >= 0)) && ((this.top) || (Short2CharRBTreeMap.this.compare(local_k, this.field_47) < 0));
    }
    ...
    public ObjectSortedSet<Short2CharMap.Entry> short2CharEntrySet()
    {
      if (this.entries == null) {
        this.entries = new AbstractObjectSortedSet()
        {
          public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator()
          {
            return new Short2CharRBTreeMap.Submap.SubmapEntryIterator(Short2CharRBTreeMap.Submap.this);
          }
          
          public ObjectBidirectionalIterator<Short2CharMap.Entry> iterator(Short2CharMap.Entry from)
          {
            return new Short2CharRBTreeMap.Submap.SubmapEntryIterator(Short2CharRBTreeMap.Submap.this, ((Short)from.getKey()).shortValue());
          }
          ...
          public boolean contains(Object local_o)
          {
            ...
            Map.Entry<Short, Character> local_e = (Map.Entry)local_o;
            Short2CharRBTreeMap.Entry local_f = Short2CharRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            return (local_f != null) && (Short2CharRBTreeMap.Submap.this.in6(local_f.key)) && (local_e.equals(local_f));
          }
          ...
          public boolean remove(Object local_o)
          {
            ...
            Map.Entry<Short, Character> local_e = (Map.Entry)local_o;
            Short2CharRBTreeMap.Entry local_f = Short2CharRBTreeMap.this.findKey(((Short)local_e.getKey()).shortValue());
            if ((local_f != null) && (Short2CharRBTreeMap.Submap.this.in6(local_f.key))) {
              Short2CharRBTreeMap.Submap.this.remove(local_f.key);
            }
            return local_f != null;
          }
          ...
          public boolean isEmpty()
          {
            return !new Short2CharRBTreeMap.Submap.SubmapIterator(Short2CharRBTreeMap.Submap.this).hasNext();
          }
          
          public void clear()
          {
            Short2CharRBTreeMap.Submap.this.clear();
          }
          
          public Short2CharMap.Entry first()
          {
            return Short2CharRBTreeMap.Submap.this.firstEntry();
          }
          
          public Short2CharMap.Entry last()
          {
            return Short2CharRBTreeMap.Submap.this.lastEntry();
          }
          
          public ObjectSortedSet<Short2CharMap.Entry> subSet(Short2CharMap.Entry from, Short2CharMap.Entry local_to)
          {
            return Short2CharRBTreeMap.Submap.this.subMap((Short)from.getKey(), (Short)local_to.getKey()).short2CharEntrySet();
          }
          
          public ObjectSortedSet<Short2CharMap.Entry> headSet(Short2CharMap.Entry local_to)
          {
            return Short2CharRBTreeMap.Submap.this.headMap((Short)local_to.getKey()).short2CharEntrySet();
          }
          
          public ObjectSortedSet<Short2CharMap.Entry> tailSet(Short2CharMap.Entry from)
          {
            return Short2CharRBTreeMap.Submap.this.tailMap((Short)from.getKey()).short2CharEntrySet();
          }
        };
      }
      return this.entries;
    ...
    public CharCollection values()
    {
      if (this.values == null) {
        this.values = new AbstractCharCollection()
        {
          public CharIterator iterator()
          {
            return new Short2CharRBTreeMap.Submap.SubmapValueIterator(Short2CharRBTreeMap.Submap.this, null);
          }
          
          public boolean contains(char local_k)
          {
            return Short2CharRBTreeMap.Submap.this.containsValue(local_k);
          }
          
          public int size()
          {
            return Short2CharRBTreeMap.Submap.this.size();
          }
    ...
    public boolean containsKey(short local_k)
    {
      return (in6(local_k)) && (Short2CharRBTreeMap.this.containsKey(local_k));
    }
    ...
    {
      short local_kk = local_k;
      Short2CharRBTreeMap.Entry local_e;
      return (in6(local_kk)) && ((local_e = Short2CharRBTreeMap.this.findKey(local_kk)) != null) ? local_e.value : this.defRetValue;
    }
    ...
    public char put(short local_k, char local_v)
    {
      ...
      char oldValue = Short2CharRBTreeMap.this.put(local_k, local_v);
    ...
    public char remove(short local_k)
    {
      ...
      char oldValue = Short2CharRBTreeMap.this.remove(local_k);
    ...
    {
      if (this.top) {
        return new Submap(Short2CharRBTreeMap.this, this.from, this.bottom, local_to, false);
      }
      return Short2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? new Submap(Short2CharRBTreeMap.this, this.from, this.bottom, local_to, false) : this;
    }
    
    public Short2CharSortedMap tailMap(short from)
    {
      if (this.bottom) {
        return new Submap(Short2CharRBTreeMap.this, from, false, this.field_47, this.top);
      }
      return Short2CharRBTreeMap.this.compare(from, this.from) > 0 ? new Submap(Short2CharRBTreeMap.this, from, false, this.field_47, this.top) : this;
    }
    
    public Short2CharSortedMap subMap(short from, short local_to)
    {
      if ((this.top) && (this.bottom)) {
        return new Submap(Short2CharRBTreeMap.this, from, false, local_to, false);
      }
      if (!this.top) {
        local_to = Short2CharRBTreeMap.this.compare(local_to, this.field_47) < 0 ? local_to : this.field_47;
      }
      if (!this.bottom) {
    ...
    public Short2CharRBTreeMap.Entry firstEntry()
    {
      ...
      if (this.bottom)
      {
        local_e = Short2CharRBTreeMap.this.firstEntry;
      }
      else
      {
        local_e = Short2CharRBTreeMap.this.locateKey(this.from);
        if (Short2CharRBTreeMap.this.compare(local_e.key, this.from) < 0) {
          local_e = local_e.next();
        }
      }
      if ((local_e == null) || ((!this.top) && (Short2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public Short2CharRBTreeMap.Entry lastEntry()
    {
      ...
      if (this.top)
      {
        local_e = Short2CharRBTreeMap.this.lastEntry;
      }
      else
      {
        local_e = Short2CharRBTreeMap.this.locateKey(this.field_47);
        if (Short2CharRBTreeMap.this.compare(local_e.key, this.field_47) >= 0) {
          local_e = local_e.prev();
        }
      }
      if ((local_e == null) || ((!this.bottom) && (Short2CharRBTreeMap.this.compare(local_e.key, this.from) < 0))) {
        return null;
      }
      return local_e;
    }
    ...
    public short firstShortKey()
    {
      Short2CharRBTreeMap.Entry local_e = firstEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
    ...
    public short lastShortKey()
    {
      Short2CharRBTreeMap.Entry local_e = lastEntry();
      if (local_e == null) {
        throw new NoSuchElementException();
      }
      return local_e.key;
      ...
      extends Short2CharRBTreeMap.TreeIterator
    {
      ...
      {
        super();
        this.next = Short2CharRBTreeMap.Submap.this.firstEntry();
      }
      ...
      SubmapIterator(short local_k)
      {
        this();
        if (this.next != null) {
          if ((!Short2CharRBTreeMap.Submap.this.bottom) && (Short2CharRBTreeMap.this.compare(local_k, this.next.key) < 0))
          {
            this.prev = null;
          }
          else if ((!Short2CharRBTreeMap.Submap.this.top) && (Short2CharRBTreeMap.this.compare(local_k, (this.prev = Short2CharRBTreeMap.Submap.this.lastEntry()).key) >= 0))
          {
            this.next = null;
          }
          else
          {
            this.next = Short2CharRBTreeMap.this.locateKey(local_k);
            if (Short2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
            {
              this.prev = this.next;
      ...
      void updatePrevious()
      {
        ...
        if ((!Short2CharRBTreeMap.Submap.this.bottom) && (this.prev != null) && (Short2CharRBTreeMap.this.compare(this.prev.key, Short2CharRBTreeMap.Submap.this.from) < 0)) {
          this.prev = null;
        }
      }
      ...
      {
        this.next = this.next.next();
        if ((!Short2CharRBTreeMap.Submap.this.top) && (this.next != null) && (Short2CharRBTreeMap.this.compare(this.next.key, Short2CharRBTreeMap.Submap.this.field_47) >= 0)) {
          this.next = null;
        }
      }
    }
      ...
      extends AbstractShort2CharSortedMap.KeySet
    {
      ...
      {
        return new Short2CharRBTreeMap.Submap.SubmapKeyIterator(Short2CharRBTreeMap.Submap.this);
      }
      
      public ShortBidirectionalIterator iterator(short from)
      {
        return new Short2CharRBTreeMap.Submap.SubmapKeyIterator(Short2CharRBTreeMap.Submap.this, from);
      }
    }
  }
    ...
    extends AbstractShort2CharSortedMap.KeySet
  {
    ...
    public ShortBidirectionalIterator iterator()
    {
      return new Short2CharRBTreeMap.KeyIterator(Short2CharRBTreeMap.this);
    }
    
    public ShortBidirectionalIterator iterator(short from)
    {
      return new Short2CharRBTreeMap.KeyIterator(Short2CharRBTreeMap.this, from);
    }
  }
  ...
  private class TreeIterator
  {
    ...
    {
      if ((this.next = Short2CharRBTreeMap.this.locateKey(local_k)) != null) {
        if (Short2CharRBTreeMap.this.compare(this.next.key, local_k) <= 0)
        {
          this.prev = this.next;
          this.next = this.next.next();
