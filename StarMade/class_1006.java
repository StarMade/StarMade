  ...
  implements class_1010
{
  ...
  public class_1006(Camera paramCamera)
  {
    ...
    this.jdField_field_122_of_type_ComBulletphysicsLinearmathTransform.setIdentity();
  }
  ...
  {
    this.jdField_field_123_of_type_OrgSchemaSchineGraphicsengineCameraCamera.getWorldTransform().set(this.jdField_field_122_of_type_ComBulletphysicsLinearmathTransform);
    ...
    this.jdField_field_122_of_type_ComBulletphysicsLinearmathTransform.set(this.jdField_field_123_of_type_OrgSchemaSchineGraphicsengineCameraCamera.getWorldTransform());
    this.jdField_field_123_of_type_ComBulletphysicsLinearmathTransform.basis.mul(this.jdField_field_123_of_type_OrgSchemaSchineGraphicsengineCameraCamera.getWorldTransform().basis);
    this.jdField_field_123_of_type_OrgSchemaSchineGraphicsengineCameraCamera.getWorldTransform().set(this.jdField_field_123_of_type_ComBulletphysicsLinearmathTransform);
  }
