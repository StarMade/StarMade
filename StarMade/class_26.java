...
public final class class_26
  extends class_16
{
  public class_26(class_371 paramclass_371)
  {
    ...
    if (paramBoolean)
    {
      synchronized (a6().b())
      {
        ...
        while (localIterator.hasNext()) {
          if (((class_12)localIterator.next() instanceof class_2)) {
            i = 1;
          }
        }
      }
    ...
    else
    {
      ...
      synchronized (a6().b())
      {
        for (int j = 0; j < a6().b().size(); j++) {
          if (((class_12)a6().b().get(j) instanceof class_2))
          {
