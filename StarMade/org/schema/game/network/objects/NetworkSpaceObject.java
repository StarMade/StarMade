...
public class NetworkSpaceObject
  extends NetworkEntity
{
  public static final int TYPE_ASTEROID = 0;
  public static final int TYPE_ASTEROID_STYLE_1 = 0;
  public RemoteInteger starSystemId = new RemoteInteger(Integer.valueOf(-1), this);
  public RemoteInteger objectType = new RemoteInteger(Integer.valueOf(-1), this);
  public RemoteInteger objectSubtype = new RemoteInteger(Integer.valueOf(-1), this);
  
  public NetworkSpaceObject(StateInterface paramStateInterface)
  {
