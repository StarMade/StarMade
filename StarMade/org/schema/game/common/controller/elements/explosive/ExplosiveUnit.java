...
/* 16:   */  }
/* 17:   */  
/* 18:   */  public void refreshExplosiveCapabilities() {
/* 19:19 */    this.explosive = Math.max(0.0F, getMax().c - getMin().c);
/* 20:20 */    this.explosive += Math.max(0.0F, getMax().a - getMin().a);
/* 21:21 */    this.explosive += Math.max(0.0F, getMax().b - getMin().b);
/* 22:22 */    float f = (float)Math.pow(size(), 1.25D);
/* 23:   */    
/* 24:24 */    this.explosive += f;
/* 25:25 */    this.explosive = Math.max(1.0F, this.explosive);
/* 26:   */  }
/* 27:   */  
