...
/*    */ import xq;
/*    */ 
/*    */ public class PowerSupplyBeamHandler extends BeamHandler
/*    */ {
/*    */   private static final float BEAM_TIMEOUT_IN_SECS = 0.5F;
/*    */ 
/*    */   public PowerSupplyBeamHandler(SegmentController paramSegmentController, jq paramjq)
/*    */   {
...
/*    */     {
/* 66 */       double d = Math.min(paramq.getPower(), paramBeamState * 10000);
/*    */ 
/* 68 */       paramq.consumePowerInstantly(d);
/* 69 */       paramSegment.incPower(d);
/*    */     }
/*    */   }
/*    */ }
