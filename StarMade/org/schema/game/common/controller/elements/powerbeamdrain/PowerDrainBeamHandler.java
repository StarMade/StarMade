...
public class PowerDrainBeamHandler
  extends BeamHandler
{
  private static final float BEAM_TIMEOUT_IN_SECS = 0.5F;
  
  public PowerDrainBeamHandler(SegmentController paramSegmentController, class_721 paramclass_721)
  {
  ...
  public void onBeamHit(BeamHandler.BeamState paramBeamState, class_721 paramclass_721, class_48 paramclass_48, Segment paramSegment, Vector3f paramVector3f1, Vector3f paramVector3f2, CubeRayCastResult paramCubeRayCastResult, class_941 paramclass_941, Collection paramCollection)
  {
    ...
    if (((paramBeamState = paramclass_721.getHandler().beamHit(paramBeamState, paramVector3f1)) > 0) && ((paramVector3f1.a9() == 331) || (paramVector3f1.a9() == 2)))
    {
      double d = Math.min(paramSegment.getPower(), paramBeamState * 10000);
      paramSegment.consumePowerInstantly(d);
      paramclass_48.incPower(d);
    }
  }
}
