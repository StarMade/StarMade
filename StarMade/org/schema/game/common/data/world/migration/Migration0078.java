...
public class Migration0078
{
  private static class_48 jdField_field_2150_of_type_Class_48;
  private static int jdField_field_2150_of_type_Int = (Migration0078.jdField_field_2150_of_type_Class_48 = new class_48(16, 16, 16)).field_475 * jdField_field_2150_of_type_Class_48.field_476 * jdField_field_2150_of_type_Class_48.field_477;
  private static byte[] jdField_field_2150_of_type_ArrayOfByte = new byte[8];
  private static int jdField_field_2151_of_type_Int = jdField_field_2150_of_type_Int << 3;
  private static byte[] jdField_field_2151_of_type_ArrayOfByte = new byte[8];
  private static int field_2152 = jdField_field_2150_of_type_Int << 3;
  private static int field_2153;
  private static int field_2154;
  private static int field_2155;
  private static long jdField_field_2150_of_type_Long;
  ...
  public static void a1(File paramFile)
  {
    ...
    for (File localFile : paramFile)
    {
      ...
      if (localFile.getName().endsWith(".smd"))
      {
        ...
        while (l1 < jdField_field_2151_of_type_Int)
        {
          ...
          try
          {
            ...
            if (localSegmentData1 >= 0)
            {
              ...
              int i1 = k;
              long l2 = l1 / jdField_field_2150_of_type_ArrayOfByte.length;
              int n = localSegmentData1;
              Object localObject1 = localRandomAccessFile;
              long l3 = jdField_field_2151_of_type_Int + l2 * jdField_field_2151_of_type_ArrayOfByte.length;
              long l4 = jdField_field_2151_of_type_Int + field_2152 + n * 5120;
              System.err.println("LEN " + ((RandomAccessFile)localObject1).length() + " -> " + l3 + "; offest: " + n + "; headerSize: " + jdField_field_2151_of_type_Int + "; tsArray " + jdField_field_2151_of_type_ArrayOfByte.length + "; read lenth: " + i1 + " -- data position: " + l4);
              ((RandomAccessFile)localObject1).seek(l3);
              ((RandomAccessFile)localObject1).readLong();
              ((RandomAccessFile)localObject1).seek(l4);
              if ((!jdField_field_2150_of_type_Boolean) && ((i1 <= 0) || (i1 >= 5120) || (i1 > localObject3.length))) {
              ...
              if (jdField_field_2150_of_type_Int < 0) {
                localObject5 = new DataInputStream(new GZIPInputStream((InputStream)localObject1));
              } else {
                localObject5 = new DataInputStream(new GZIPInputStream((InputStream)localObject1, jdField_field_2150_of_type_Int));
              }
              jdField_field_2150_of_type_Long = ((DataInputStream)localObject5).readLong();
              field_2153 = ((DataInputStream)localObject5).readInt();
              field_2154 = ((DataInputStream)localObject5).readInt();
              field_2155 = ((DataInputStream)localObject5).readInt();
              ((DataInputStream)localObject5).readByte();
              (localObject6 = new class_793()).a1((DataInputStream)localObject5);
              Object localObject4 = localObject6;
              localByteArrayInputStream.close();
              localDataInputStream.close();
              localObject1 = localObject4;
              SegmentData localSegmentData2 = new SegmentData(false);
              a((class_793)localObject1, localSegmentData2);
              Object localObject2 = localSegmentData2;
              l2 = l1 / jdField_field_2150_of_type_ArrayOfByte.length;
              ...
              ((class_726)localObject3).a1(jdField_field_2151_of_type_Int + field_2152 + localSegmentData2 * 5120);
              localObject4 = localObject2;
              long l5 = jdField_field_2150_of_type_Long;
              int i2 = field_2155;
              m = field_2154;
              int i4 = field_2153;
              ...
              if ((!jdField_field_2150_of_type_Boolean) && (((DataOutputStream)localObject5).size() != 0)) {
              ...
              ((class_726)localObject3).a1(l2 * jdField_field_2150_of_type_ArrayOfByte.length);
              ...
              ((class_726)localObject3).a1(jdField_field_2151_of_type_Int + l2 * jdField_field_2151_of_type_ArrayOfByte.length);
              localDataOutputStream1.writeLong(jdField_field_2150_of_type_Long);
            ...
            else if ((!jdField_field_2150_of_type_Boolean) && (m > 0))
            {
          ...
          l1 += jdField_field_2150_of_type_ArrayOfByte.length;
        }
 ...
 * Qualified Name:     org.schema.game.common.data.world.migration.Migration0078
