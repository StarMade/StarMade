...
/*   8:    */
/*  10:    */public class RemoteIntArrayBuffer
/*  11:    */  extends RemoteBuffer
/*  12:    */{
/*  13:    */  private ArrayBufferPool pool;
/*  14:    */  private final int arraySize;
/*  15:    */  
/*  16:    */  public RemoteIntArrayBuffer(int paramInt, NetworkObject paramNetworkObject)
/*  17:    */  {
/*  18: 18 */    super(RemoteIntArray.class, paramNetworkObject);
/*  19:    */    
/*  20: 20 */    this.arraySize = paramInt;
/*  21: 21 */    cacheConstructor();
/*  22:    */  }
/*  23:    */  
/*  24: 24 */  public RemoteIntArrayBuffer(int paramInt, boolean paramBoolean) { super(RemoteIntArray.class, paramBoolean);
/*  25:    */    
/*  26: 26 */    this.arraySize = paramInt;
/*  27: 27 */    cacheConstructor();
/*  28:    */  }
/*  29:    */  
/*  33:    */  public boolean add(RemoteIntArray paramRemoteIntArray)
/*  34:    */  {
/*  35: 35 */    assert (paramRemoteIntArray.getIntArray().length == this.arraySize) : ("Invalid Array Size: " + paramRemoteIntArray.getIntArray().length + " != " + this.arraySize);
/*  36: 36 */    return super.add(paramRemoteIntArray);
/*  37:    */  }
/*  38:    */  
...
/*  66: 66 */      RemoteIntArray localRemoteIntArray = (RemoteIntArray)this.pool.get(this.onServer);
/*  67: 67 */      assert (localRemoteIntArray.arrayLength() == this.arraySize) : (localRemoteIntArray.byteLength() + " / " + this.arraySize);
/*  68: 68 */      localRemoteIntArray.fromByteStream(paramDataInputStream, paramInt);
/*  69: 69 */      this.receiveBuffer.add(localRemoteIntArray);
/*  70:    */    }
/*  71:    */  }
/*  72:    */  
