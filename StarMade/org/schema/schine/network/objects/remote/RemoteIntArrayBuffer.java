...
/*     */ 
/*     */ public class RemoteIntArrayBuffer extends RemoteBuffer
/*     */ {
...
/*     */   {
/*  18 */     super(RemoteIntArray.class, paramNetworkObject);
/*     */ 
/*  20 */     this.arraySize = paramInt;
/*  21 */     cacheConstructor();
/*     */   }
/*     */   public RemoteIntArrayBuffer(int paramInt, boolean paramBoolean) {
/*  24 */     super(RemoteIntArray.class, paramBoolean);
/*     */ 
...
/*     */   {
/*  35 */     assert (paramRemoteIntArray.getIntArray().length == this.arraySize) : ("Invalid Array Size: " + paramRemoteIntArray.getIntArray().length + " != " + this.arraySize);
/*  36 */     return super.add(paramRemoteIntArray);
/*     */   }
/*     */ 
...
/*  66 */       RemoteIntArray localRemoteIntArray = (RemoteIntArray)this.pool.get(this.onServer);
/*  67 */       assert (localRemoteIntArray.arrayLength() == this.arraySize) : (localRemoteIntArray.byteLength() + " / " + this.arraySize);
/*  68 */       localRemoteIntArray.fromByteStream(paramDataInputStream, paramInt);
/*  69 */       this.receiveBuffer.add(localRemoteIntArray);
/*     */     }
/*     */   }
/*     */ 
