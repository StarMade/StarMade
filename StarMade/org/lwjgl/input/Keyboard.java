...
public class Keyboard
{
  ...
  {
    readBuffer.limit(0);
    for (int local_i = 0; local_i < keyDownBuffer.remaining(); local_i++) {
      keyDownBuffer.put(local_i, (byte)0);
    }
    current_event.reset();
  }
  ...
  public static int getNumKeyboardEvents()
  {
    synchronized (OpenGLPackageAccess.global_lock)
    {
      ...
      for (int num_events = 0; (readNext(tmp_event)) && ((!tmp_event.repeat) || (repeat_enabled)); num_events++) {}
