...
public final class ARBImaging
{
  ...
  public static void glCopyColorSubTable(int target, int start, int local_x, int local_y, int width)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glCopyColorSubTable;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglCopyColorSubTable(target, start, local_x, local_y, width, function_pointer);
  }
  ...
  public static void glCopyColorTable(int target, int internalformat, int local_x, int local_y, int width)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glCopyColorTable;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglCopyColorTable(target, internalformat, local_x, local_y, width, function_pointer);
  }
  ...
  public static void glCopyConvolutionFilter1D(int target, int internalformat, int local_x, int local_y, int width)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glCopyConvolutionFilter1D;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglCopyConvolutionFilter1D(target, internalformat, local_x, local_y, width, function_pointer);
  }
  ...
  public static void glCopyConvolutionFilter2D(int target, int internalformat, int local_x, int local_y, int width, int height)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glCopyConvolutionFilter2D;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglCopyConvolutionFilter2D(target, internalformat, local_x, local_y, width, height, function_pointer);
  }
