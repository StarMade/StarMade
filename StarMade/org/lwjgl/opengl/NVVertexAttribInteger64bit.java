...
public final class NVVertexAttribInteger64bit
{
  ...
  public static void glVertexAttribL1i64NV(int index, long local_x)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL1i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL1i64NV(index, local_x, function_pointer);
  }
  
  static native void nglVertexAttribL1i64NV(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVertexAttribL2i64NV(int index, long local_x, long local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL2i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL2i64NV(index, local_x, local_y, function_pointer);
  }
  
  static native void nglVertexAttribL2i64NV(int paramInt, long paramLong1, long paramLong2, long paramLong3);
  
  public static void glVertexAttribL3i64NV(int index, long local_x, long local_y, long local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL3i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL3i64NV(index, local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglVertexAttribL3i64NV(int paramInt, long paramLong1, long paramLong2, long paramLong3, long paramLong4);
  
  public static void glVertexAttribL4i64NV(int index, long local_x, long local_y, long local_z, long local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL4i64NV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL4i64NV(index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttribL1uNV(int index, LongBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL1ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 1);
    nglVertexAttribL1ui64vNV(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribL1ui64vNV(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVertexAttribL2uNV(int index, LongBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL2ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 2);
    nglVertexAttribL2ui64vNV(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribL2ui64vNV(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVertexAttribL3uNV(int index, LongBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL3ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 3);
    nglVertexAttribL3ui64vNV(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribL3ui64vNV(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVertexAttribL4uNV(int index, LongBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL4ui64vNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 4);
    nglVertexAttribL4ui64vNV(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
