...
public final class GL40
{
  ...
  public static void glUniform1d(int location, double local_x)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform1d(location, local_x, function_pointer);
  }
  ...
  public static void glUniform2d(int location, double local_x, double local_y)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform2d(location, local_x, local_y, function_pointer);
  }
  ...
  public static void glUniform3d(int location, double local_x, double local_y, double local_z)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform3d(location, local_x, local_y, local_z, function_pointer);
  }
  ...
  public static void glUniform4d(int location, double local_x, double local_y, double local_z, double local_w)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform4d(location, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glBindTransformFeedback(int target, int local_id)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglBindTransformFeedback(target, local_id, function_pointer);
  }
  ...
  public static void glDeleteTransformFeedbacks(int local_id)
  {
    ...
    long function_pointer = caps.glDeleteTransformFeedbacks;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDeleteTransformFeedbacks(1, APIUtil.getInt(caps, local_id), function_pointer);
  }
  ...
  public static boolean glIsTransformFeedback(int local_id)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    boolean __result = nglIsTransformFeedback(local_id, function_pointer);
    return __result;
  }
  ...
  public static void glDrawTransformFeedback(int mode, int local_id)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDrawTransformFeedback(mode, local_id, function_pointer);
  }
  ...
  public static void glDrawTransformFeedbackStream(int mode, int local_id, int stream)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDrawTransformFeedbackStream(mode, local_id, stream, function_pointer);
  }
  ...
  public static void glBeginQueryIndexed(int target, int index, int local_id)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglBeginQueryIndexed(target, index, local_id, function_pointer);
  }
