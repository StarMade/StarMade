...
public final class GL41
{
  ...
  public static void glDepthRangef(float local_n, float local_f)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDepthRangef(local_n, local_f, function_pointer);
  }
  ...
  public static void glClearDepthf(float local_d)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglClearDepthf(local_d, function_pointer);
  }
  ...
  public static void glProgramUniform1i(int program, int location, int local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform1i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform1i(program, location, local_v0, function_pointer);
  }
  
  static native void nglProgramUniform1i(int paramInt1, int paramInt2, int paramInt3, long paramLong);
  
  public static void glProgramUniform2i(int program, int location, int local_v0, int local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform2i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform2i(program, location, local_v0, local_v1, function_pointer);
  }
  
  static native void nglProgramUniform2i(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong);
  
  public static void glProgramUniform3i(int program, int location, int local_v0, int local_v1, int local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform3i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform3i(program, location, local_v0, local_v1, local_v2, function_pointer);
  }
  ...
  public static void glProgramUniform4i(int program, int location, int local_v0, int local_v1, int local_v2, int local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform4i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform4i(program, location, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glProgramUniform1f(int program, int location, float local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform1f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform1f(program, location, local_v0, function_pointer);
  }
  
  static native void nglProgramUniform1f(int paramInt1, int paramInt2, float paramFloat, long paramLong);
  
  public static void glProgramUniform2f(int program, int location, float local_v0, float local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform2f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform2f(program, location, local_v0, local_v1, function_pointer);
  }
  
  static native void nglProgramUniform2f(int paramInt1, int paramInt2, float paramFloat1, float paramFloat2, long paramLong);
  
  public static void glProgramUniform3f(int program, int location, float local_v0, float local_v1, float local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform3f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform3f(program, location, local_v0, local_v1, local_v2, function_pointer);
  }
  ...
  public static void glProgramUniform4f(int program, int location, float local_v0, float local_v1, float local_v2, float local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform4f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform4f(program, location, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glProgramUniform1d(int program, int location, double local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform1d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform1d(program, location, local_v0, function_pointer);
  }
  
  static native void nglProgramUniform1d(int paramInt1, int paramInt2, double paramDouble, long paramLong);
  
  public static void glProgramUniform2d(int program, int location, double local_v0, double local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform2d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform2d(program, location, local_v0, local_v1, function_pointer);
  }
  ...
  public static void glProgramUniform3d(int program, int location, double local_v0, double local_v1, double local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform3d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform3d(program, location, local_v0, local_v1, local_v2, function_pointer);
  }
  ...
  public static void glProgramUniform4d(int program, int location, double local_v0, double local_v1, double local_v2, double local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform4d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform4d(program, location, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glProgramUniform1ui(int program, int location, int local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform1ui;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform1ui(program, location, local_v0, function_pointer);
  }
  
  static native void nglProgramUniform1ui(int paramInt1, int paramInt2, int paramInt3, long paramLong);
  
  public static void glProgramUniform2ui(int program, int location, int local_v0, int local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform2ui;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform2ui(program, location, local_v0, local_v1, function_pointer);
  }
  
  static native void nglProgramUniform2ui(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong);
  
  public static void glProgramUniform3ui(int program, int location, int local_v0, int local_v1, int local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform3ui;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform3ui(program, location, local_v0, local_v1, local_v2, function_pointer);
  }
  ...
  public static void glProgramUniform4ui(int program, int location, int local_v0, int local_v1, int local_v2, int local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform4ui;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform4ui(program, location, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glVertexAttribL1d(int index, double local_x)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL1d(index, local_x, function_pointer);
  }
  ...
  public static void glVertexAttribL2d(int index, double local_x, double local_y)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL2d(index, local_x, local_y, function_pointer);
  }
  ...
  public static void glVertexAttribL3d(int index, double local_x, double local_y, double local_z)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL3d(index, local_x, local_y, local_z, function_pointer);
  }
  ...
  public static void glVertexAttribL4d(int index, double local_x, double local_y, double local_z, double local_w)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL4d(index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttribL1(int index, DoubleBuffer local_v)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 1);
    nglVertexAttribL1dv(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glVertexAttribL2(int index, DoubleBuffer local_v)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 2);
    nglVertexAttribL2dv(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glVertexAttribL3(int index, DoubleBuffer local_v)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 3);
    nglVertexAttribL3dv(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glVertexAttribL4(int index, DoubleBuffer local_v)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 4);
    nglVertexAttribL4dv(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glViewportArray(int first, FloatBuffer local_v)
  {
    ...
    nglViewportArrayv(first, local_v.remaining() >> 2, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glViewportIndexedf(int index, float local_x, float local_y, float local_w, float local_h)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglViewportIndexedf(index, local_x, local_y, local_w, local_h, function_pointer);
  }
  ...
  public static void glViewportIndexed(int index, FloatBuffer local_v)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 4);
    nglViewportIndexedfv(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glScissorArray(int first, IntBuffer local_v)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglScissorArrayv(first, local_v.remaining() >> 2, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glScissorIndexed(int index, IntBuffer local_v)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 4);
    nglScissorIndexedv(index, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glDepthRangeArray(int first, DoubleBuffer local_v)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglDepthRangeArrayv(first, local_v.remaining() >> 1, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glDepthRangeIndexed(int index, double local_n, double local_f)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDepthRangeIndexed(index, local_n, local_f, function_pointer);
  }
