...
public final class ARBOcclusionQuery
{
  ...
  public static void glDeleteQueriesARB(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDeleteQueriesARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDeleteQueriesARB(1, APIUtil.getInt(caps, local_id), function_pointer);
  }
  
  public static boolean glIsQueryARB(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glIsQueryARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    boolean __result = nglIsQueryARB(local_id, function_pointer);
    return __result;
  }
  
  static native boolean nglIsQueryARB(int paramInt, long paramLong);
  
  public static void glBeginQueryARB(int target, int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glBeginQueryARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglBeginQueryARB(target, local_id, function_pointer);
  }
  ...
  public static void glGetQueryObjectARB(int local_id, int pname, IntBuffer params)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetQueryObjectivARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
    nglGetQueryObjectivARB(local_id, pname, MemoryUtil.getAddress(params), function_pointer);
  }
  
  static native void nglGetQueryObjectivARB(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static int glGetQueryObjectiARB(int local_id, int pname)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetQueryObjectivARB;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetQueryObjectuARB(int local_id, int pname, IntBuffer params)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetQueryObjectuivARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
    nglGetQueryObjectuivARB(local_id, pname, MemoryUtil.getAddress(params), function_pointer);
  }
  
  static native void nglGetQueryObjectuivARB(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static int glGetQueryObjectuiARB(int local_id, int pname)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetQueryObjectuivARB;
    BufferChecks.checkFunctionAddress(function_pointer);
