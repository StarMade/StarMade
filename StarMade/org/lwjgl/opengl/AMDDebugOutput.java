...
public final class AMDDebugOutput
{
  ...
  public static void glDebugMessageInsertAMD(int category, int severity, int local_id, ByteBuffer buf)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDebugMessageInsertAMD;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(buf);
    nglDebugMessageInsertAMD(category, severity, local_id, buf.remaining(), MemoryUtil.getAddress(buf), function_pointer);
  }
  ...
  public static void glDebugMessageInsertAMD(int category, int severity, int local_id, CharSequence buf)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDebugMessageInsertAMD;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDebugMessageInsertAMD(category, severity, local_id, buf.length(), APIUtil.getBuffer(caps, buf), function_pointer);
  }
