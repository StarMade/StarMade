...
public final class NVPathRendering
{
  ...
  public static boolean glIsPointInFillPathNV(int path, int mask, float local_x, float local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glIsPointInFillPathNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    boolean __result = nglIsPointInFillPathNV(path, mask, local_x, local_y, function_pointer);
    return __result;
  }
  ...
  public static boolean glIsPointInStrokePathNV(int path, float local_x, float local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glIsPointInStrokePathNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    boolean __result = nglIsPointInStrokePathNV(path, local_x, local_y, function_pointer);
    return __result;
  }
  ...
  public static boolean glPointAlongPathNV(int path, int startSegment, int numSegments, float distance, FloatBuffer local_x, FloatBuffer local_y, FloatBuffer tangentX, FloatBuffer tangentY)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glPointAlongPathNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    if (local_x != null) {
      BufferChecks.checkBuffer(local_x, 1);
    }
    if (local_y != null) {
      BufferChecks.checkBuffer(local_y, 1);
    }
    if (tangentX != null) {
    ...
    boolean __result = nglPointAlongPathNV(path, startSegment, numSegments, distance, MemoryUtil.getAddressSafe(local_x), MemoryUtil.getAddressSafe(local_y), MemoryUtil.getAddressSafe(tangentX), MemoryUtil.getAddressSafe(tangentY), function_pointer);
    return __result;
  }
