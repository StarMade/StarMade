...
public final class EXTVertexShader
{
  ...
  public static void glBindVertexShaderEXT(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glBindVertexShaderEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglBindVertexShaderEXT(local_id, function_pointer);
  }
  ...
  public static void glDeleteVertexShaderEXT(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDeleteVertexShaderEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDeleteVertexShaderEXT(local_id, function_pointer);
  }
  
  static native void nglDeleteVertexShaderEXT(int paramInt, long paramLong);
  
  public static void glShaderOp1EXT(int local_op, int res, int arg1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glShaderOp1EXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglShaderOp1EXT(local_op, res, arg1, function_pointer);
  }
  
  static native void nglShaderOp1EXT(int paramInt1, int paramInt2, int paramInt3, long paramLong);
  
  public static void glShaderOp2EXT(int local_op, int res, int arg1, int arg2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glShaderOp2EXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglShaderOp2EXT(local_op, res, arg1, arg2, function_pointer);
  }
  
  static native void nglShaderOp2EXT(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong);
  
  public static void glShaderOp3EXT(int local_op, int res, int arg1, int arg2, int arg3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glShaderOp3EXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglShaderOp3EXT(local_op, res, arg1, arg2, arg3, function_pointer);
  }
  
  static native void nglShaderOp3EXT(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5, long paramLong);
  
  public static void glSwizzleEXT(int res, int local_in, int outX, int outY, int outZ, int outW)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSwizzleEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglSwizzleEXT(res, local_in, outX, outY, outZ, outW, function_pointer);
  }
  ...
  public static void glWriteMaskEXT(int res, int local_in, int outX, int outY, int outZ, int outW)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glWriteMaskEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglWriteMaskEXT(res, local_in, outX, outY, outZ, outW, function_pointer);
  }
  ...
  public static void glSetInvariantEXT(int local_id, DoubleBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetInvariantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetInvariantEXT(local_id, 5130, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glSetInvariantEXT(int local_id, FloatBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetInvariantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetInvariantEXT(local_id, 5126, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glSetInvariantEXT(int local_id, boolean unsigned, ByteBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetInvariantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetInvariantEXT(local_id, unsigned ? 5121 : 5120, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glSetInvariantEXT(int local_id, boolean unsigned, IntBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetInvariantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetInvariantEXT(local_id, unsigned ? 5125 : 5124, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glSetInvariantEXT(int local_id, boolean unsigned, ShortBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetInvariantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetInvariantEXT(local_id, unsigned ? 5123 : 5122, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglSetInvariantEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glSetLocalConstantEXT(int local_id, DoubleBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetLocalConstantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetLocalConstantEXT(local_id, 5130, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glSetLocalConstantEXT(int local_id, FloatBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetLocalConstantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetLocalConstantEXT(local_id, 5126, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glSetLocalConstantEXT(int local_id, boolean unsigned, ByteBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetLocalConstantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetLocalConstantEXT(local_id, unsigned ? 5121 : 5120, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glSetLocalConstantEXT(int local_id, boolean unsigned, IntBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetLocalConstantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetLocalConstantEXT(local_id, unsigned ? 5125 : 5124, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glSetLocalConstantEXT(int local_id, boolean unsigned, ShortBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glSetLocalConstantEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglSetLocalConstantEXT(local_id, unsigned ? 5123 : 5122, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglSetLocalConstantEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVariantEXT(int local_id, ByteBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantbvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglVariantbvEXT(local_id, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglVariantbvEXT(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVariantEXT(int local_id, ShortBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantsvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglVariantsvEXT(local_id, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglVariantsvEXT(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVariantEXT(int local_id, IntBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantivEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglVariantivEXT(local_id, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglVariantivEXT(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVariantEXT(int local_id, FloatBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantfvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglVariantfvEXT(local_id, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglVariantfvEXT(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVariantEXT(int local_id, DoubleBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantdvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglVariantdvEXT(local_id, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglVariantdvEXT(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVariantuEXT(int local_id, ByteBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantubvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglVariantubvEXT(local_id, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglVariantubvEXT(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVariantuEXT(int local_id, ShortBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantusvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglVariantusvEXT(local_id, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglVariantusvEXT(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVariantuEXT(int local_id, IntBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantuivEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pAddr, 4);
    nglVariantuivEXT(local_id, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglVariantuivEXT(int paramInt, long paramLong1, long paramLong2);
  
  public static void glVariantPointerEXT(int local_id, int stride, DoubleBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    ...
    nglVariantPointerEXT(local_id, 5130, stride, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glVariantPointerEXT(int local_id, int stride, FloatBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantPointerEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    ...
    nglVariantPointerEXT(local_id, 5126, stride, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glVariantPointerEXT(int local_id, boolean unsigned, int stride, ByteBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantPointerEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    ...
    nglVariantPointerEXT(local_id, unsigned ? 5121 : 5120, stride, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glVariantPointerEXT(int local_id, boolean unsigned, int stride, IntBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantPointerEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    ...
    nglVariantPointerEXT(local_id, unsigned ? 5125 : 5124, stride, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  public static void glVariantPointerEXT(int local_id, boolean unsigned, int stride, ShortBuffer pAddr)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantPointerEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    ...
    nglVariantPointerEXT(local_id, unsigned ? 5123 : 5122, stride, MemoryUtil.getAddress(pAddr), function_pointer);
  }
  
  static native void nglVariantPointerEXT(int paramInt1, int paramInt2, int paramInt3, long paramLong1, long paramLong2);
  
  public static void glVariantPointerEXT(int local_id, int type, int stride, long pAddr_buffer_offset)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVariantPointerEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    GLChecks.ensureArrayVBOenabled(caps);
    nglVariantPointerEXTBO(local_id, type, stride, pAddr_buffer_offset, function_pointer);
  }
  
  static native void nglVariantPointerEXTBO(int paramInt1, int paramInt2, int paramInt3, long paramLong1, long paramLong2);
  
  public static void glEnableVariantClientStateEXT(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glEnableVariantClientStateEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglEnableVariantClientStateEXT(local_id, function_pointer);
  }
  
  static native void nglEnableVariantClientStateEXT(int paramInt, long paramLong);
  
  public static void glDisableVariantClientStateEXT(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDisableVariantClientStateEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDisableVariantClientStateEXT(local_id, function_pointer);
  }
  ...
  public static boolean glIsVariantEnabledEXT(int local_id, int cap)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glIsVariantEnabledEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    boolean __result = nglIsVariantEnabledEXT(local_id, cap, function_pointer);
    return __result;
  }
  
  static native boolean nglIsVariantEnabledEXT(int paramInt1, int paramInt2, long paramLong);
  
  public static void glGetVariantBooleanEXT(int local_id, int value, ByteBuffer pbData)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetVariantBooleanvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pbData, 4);
    nglGetVariantBooleanvEXT(local_id, value, MemoryUtil.getAddress(pbData), function_pointer);
  }
  
  static native void nglGetVariantBooleanvEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glGetVariantIntegerEXT(int local_id, int value, IntBuffer pbData)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetVariantIntegervEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pbData, 4);
    nglGetVariantIntegervEXT(local_id, value, MemoryUtil.getAddress(pbData), function_pointer);
  }
  
  static native void nglGetVariantIntegervEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glGetVariantFloatEXT(int local_id, int value, FloatBuffer pbData)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetVariantFloatvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pbData, 4);
    nglGetVariantFloatvEXT(local_id, value, MemoryUtil.getAddress(pbData), function_pointer);
  }
  
  static native void nglGetVariantFloatvEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static ByteBuffer glGetVariantPointerEXT(int local_id, int value, long result_size)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetVariantPointervEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    ByteBuffer __result = nglGetVariantPointervEXT(local_id, value, result_size, function_pointer);
  ...
  public static void glGetInvariantBooleanEXT(int local_id, int value, ByteBuffer pbData)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetInvariantBooleanvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pbData, 4);
    nglGetInvariantBooleanvEXT(local_id, value, MemoryUtil.getAddress(pbData), function_pointer);
  }
  
  static native void nglGetInvariantBooleanvEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glGetInvariantIntegerEXT(int local_id, int value, IntBuffer pbData)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetInvariantIntegervEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pbData, 4);
    nglGetInvariantIntegervEXT(local_id, value, MemoryUtil.getAddress(pbData), function_pointer);
  }
  
  static native void nglGetInvariantIntegervEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glGetInvariantFloatEXT(int local_id, int value, FloatBuffer pbData)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetInvariantFloatvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pbData, 4);
    nglGetInvariantFloatvEXT(local_id, value, MemoryUtil.getAddress(pbData), function_pointer);
  }
  
  static native void nglGetInvariantFloatvEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glGetLocalConstantBooleanEXT(int local_id, int value, ByteBuffer pbData)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetLocalConstantBooleanvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pbData, 4);
    nglGetLocalConstantBooleanvEXT(local_id, value, MemoryUtil.getAddress(pbData), function_pointer);
  }
  
  static native void nglGetLocalConstantBooleanvEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glGetLocalConstantIntegerEXT(int local_id, int value, IntBuffer pbData)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetLocalConstantIntegervEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pbData, 4);
    nglGetLocalConstantIntegervEXT(local_id, value, MemoryUtil.getAddress(pbData), function_pointer);
  }
  
  static native void nglGetLocalConstantIntegervEXT(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glGetLocalConstantFloatEXT(int local_id, int value, FloatBuffer pbData)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetLocalConstantFloatvEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(pbData, 4);
    nglGetLocalConstantFloatvEXT(local_id, value, MemoryUtil.getAddress(pbData), function_pointer);
  }
