  ...
  implements DisplayImplementation
{
    ...
    throws LWJGLException
  {
    ...
    try
    {
      this.window = nCreateWindow(local_x, local_y, mode.getWidth(), mode.getHeight(), fullscreen, isUndecorated(), resizable, parented, peer_handle, window_handle);
      if (fullscreen)
      {
  ...
  public native void setGammaRamp(FloatBuffer paramFloatBuffer)
    throws LWJGLException;
