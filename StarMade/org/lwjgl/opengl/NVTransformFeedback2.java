...
public final class NVTransformFeedback2
{
  ...
  public static void glBindTransformFeedbackNV(int target, int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glBindTransformFeedbackNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglBindTransformFeedbackNV(target, local_id, function_pointer);
  }
  ...
  public static void glDeleteTransformFeedbacksNV(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDeleteTransformFeedbacksNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDeleteTransformFeedbacksNV(1, APIUtil.getInt(caps, local_id), function_pointer);
  }
  ...
  public static boolean glIsTransformFeedbackNV(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glIsTransformFeedbackNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    boolean __result = nglIsTransformFeedbackNV(local_id, function_pointer);
    return __result;
  }
  ...
  public static void glDrawTransformFeedbackNV(int mode, int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDrawTransformFeedbackNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDrawTransformFeedbackNV(mode, local_id, function_pointer);
  }
