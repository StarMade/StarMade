...
public final class ARBVertexShader
{
  ...
  public static void glVertexAttrib1sARB(int index, short local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib1sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib1sARB(index, local_v0, function_pointer);
  }
  
  static native void nglVertexAttrib1sARB(int paramInt, short paramShort, long paramLong);
  
  public static void glVertexAttrib1fARB(int index, float local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib1fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib1fARB(index, local_v0, function_pointer);
  }
  
  static native void nglVertexAttrib1fARB(int paramInt, float paramFloat, long paramLong);
  
  public static void glVertexAttrib1dARB(int index, double local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib1dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib1dARB(index, local_v0, function_pointer);
  }
  
  static native void nglVertexAttrib1dARB(int paramInt, double paramDouble, long paramLong);
  
  public static void glVertexAttrib2sARB(int index, short local_v0, short local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib2sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib2sARB(index, local_v0, local_v1, function_pointer);
  }
  
  static native void nglVertexAttrib2sARB(int paramInt, short paramShort1, short paramShort2, long paramLong);
  
  public static void glVertexAttrib2fARB(int index, float local_v0, float local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib2fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib2fARB(index, local_v0, local_v1, function_pointer);
  }
  
  static native void nglVertexAttrib2fARB(int paramInt, float paramFloat1, float paramFloat2, long paramLong);
  
  public static void glVertexAttrib2dARB(int index, double local_v0, double local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib2dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib2dARB(index, local_v0, local_v1, function_pointer);
  }
  
  static native void nglVertexAttrib2dARB(int paramInt, double paramDouble1, double paramDouble2, long paramLong);
  
  public static void glVertexAttrib3sARB(int index, short local_v0, short local_v1, short local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib3sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib3sARB(index, local_v0, local_v1, local_v2, function_pointer);
  }
  ...
  public static void glVertexAttrib3fARB(int index, float local_v0, float local_v1, float local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib3fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib3fARB(index, local_v0, local_v1, local_v2, function_pointer);
  }
  ...
  public static void glVertexAttrib3dARB(int index, double local_v0, double local_v1, double local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib3dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib3dARB(index, local_v0, local_v1, local_v2, function_pointer);
  }
  ...
  public static void glVertexAttrib4sARB(int index, short local_v0, short local_v1, short local_v2, short local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4sARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4sARB(index, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glVertexAttrib4fARB(int index, float local_v0, float local_v1, float local_v2, float local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4fARB(index, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glVertexAttrib4dARB(int index, double local_v0, double local_v1, double local_v2, double local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4dARB(index, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glVertexAttrib4NubARB(int index, byte local_x, byte local_y, byte local_z, byte local_w)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4NubARB(index, local_x, local_y, local_z, local_w, function_pointer);
  }
