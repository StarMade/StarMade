...
public final class GL43
{
  ...
  public static void glDebugMessageInsert(int source, int type, int local_id, int severity, ByteBuffer buf)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDebugMessageInsert;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(buf);
    nglDebugMessageInsert(source, type, local_id, severity, buf.remaining(), MemoryUtil.getAddress(buf), function_pointer);
  }
  ...
  public static void glDebugMessageInsert(int source, int type, int local_id, int severity, CharSequence buf)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDebugMessageInsert;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDebugMessageInsert(source, type, local_id, severity, buf.length(), APIUtil.getBuffer(caps, buf), function_pointer);
  }
  ...
  public static void glPushDebugGroup(int source, int local_id, ByteBuffer message)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glPushDebugGroup;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(message);
    nglPushDebugGroup(source, local_id, message.remaining(), MemoryUtil.getAddress(message), function_pointer);
  }
  
  static native void nglPushDebugGroup(int paramInt1, int paramInt2, int paramInt3, long paramLong1, long paramLong2);
  
  public static void glPushDebugGroup(int source, int local_id, CharSequence message)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glPushDebugGroup;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglPushDebugGroup(source, local_id, message.length(), APIUtil.getBuffer(caps, message), function_pointer);
  }
  ...
  public static void glInvalidateSubFramebuffer(int target, IntBuffer attachments, int local_x, int local_y, int width, int height)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glInvalidateSubFramebuffer;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(attachments);
    nglInvalidateSubFramebuffer(target, attachments.remaining(), MemoryUtil.getAddress(attachments), local_x, local_y, width, height, function_pointer);
  }
