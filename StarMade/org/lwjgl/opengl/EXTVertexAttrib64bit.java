...
public final class EXTVertexAttrib64bit
{
  ...
  public static void glVertexAttribL1dEXT(int index, double local_x)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL1dEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL1dEXT(index, local_x, function_pointer);
  }
  
  static native void nglVertexAttribL1dEXT(int paramInt, double paramDouble, long paramLong);
  
  public static void glVertexAttribL2dEXT(int index, double local_x, double local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL2dEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL2dEXT(index, local_x, local_y, function_pointer);
  }
  
  static native void nglVertexAttribL2dEXT(int paramInt, double paramDouble1, double paramDouble2, long paramLong);
  
  public static void glVertexAttribL3dEXT(int index, double local_x, double local_y, double local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL3dEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL3dEXT(index, local_x, local_y, local_z, function_pointer);
  }
  ...
  public static void glVertexAttribL4dEXT(int index, double local_x, double local_y, double local_z, double local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribL4dEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttribL4dEXT(index, local_x, local_y, local_z, local_w, function_pointer);
  }
