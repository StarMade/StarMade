...
public final class GL14
{
  ...
  public static void glWindowPos2f(float local_x, float local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glWindowPos2f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglWindowPos2f(local_x, local_y, function_pointer);
  }
  
  static native void nglWindowPos2f(float paramFloat1, float paramFloat2, long paramLong);
  
  public static void glWindowPos2d(double local_x, double local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glWindowPos2d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglWindowPos2d(local_x, local_y, function_pointer);
  }
  
  static native void nglWindowPos2d(double paramDouble1, double paramDouble2, long paramLong);
  
  public static void glWindowPos2i(int local_x, int local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glWindowPos2i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglWindowPos2i(local_x, local_y, function_pointer);
  }
  
  static native void nglWindowPos2i(int paramInt1, int paramInt2, long paramLong);
  
  public static void glWindowPos3f(float local_x, float local_y, float local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glWindowPos3f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglWindowPos3f(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglWindowPos3f(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong);
  
  public static void glWindowPos3d(double local_x, double local_y, double local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glWindowPos3d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglWindowPos3d(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglWindowPos3d(double paramDouble1, double paramDouble2, double paramDouble3, long paramLong);
  
  public static void glWindowPos3i(int local_x, int local_y, int local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glWindowPos3i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglWindowPos3i(local_x, local_y, local_z, function_pointer);
  }
