...
public final class GL33
{
  ...
  public static void glQueryCounter(int local_id, int target)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    nglQueryCounter(local_id, target, function_pointer);
  }
  ...
  public static void glGetQueryObject(int local_id, int pname, LongBuffer params)
  {
    ...
    nglGetQueryObjecti64v(local_id, pname, MemoryUtil.getAddress(params), function_pointer);
  }
  
  static native void nglGetQueryObjecti64v(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  @Deprecated
  public static long glGetQueryObject(int local_id, int pname)
  {
    return glGetQueryObjecti64(local_id, pname);
  }
  ...
  public static void glGetQueryObjectu(int local_id, int pname, LongBuffer params)
  {
    ...
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
    nglGetQueryObjectui64v(local_id, pname, MemoryUtil.getAddress(params), function_pointer);
  }
  
  static native void nglGetQueryObjectui64v(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  @Deprecated
  public static long glGetQueryObjectu(int local_id, int pname)
  {
    return glGetQueryObjectui64(local_id, pname);
  }
