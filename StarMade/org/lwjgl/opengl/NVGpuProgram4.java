...
public final class NVGpuProgram4
{
  ...
  public static void glProgramLocalParameterI4iNV(int target, int index, int local_x, int local_y, int local_z, int local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramLocalParameterI4iNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramLocalParameterI4iNV(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glProgramLocalParameterI4uiNV(int target, int index, int local_x, int local_y, int local_z, int local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramLocalParameterI4uiNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramLocalParameterI4uiNV(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glProgramEnvParameterI4iNV(int target, int index, int local_x, int local_y, int local_z, int local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramEnvParameterI4iNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramEnvParameterI4iNV(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glProgramEnvParameterI4uiNV(int target, int index, int local_x, int local_y, int local_z, int local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramEnvParameterI4uiNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramEnvParameterI4uiNV(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
