...
public final class ARBDebugOutput
{
  ...
  public static void glDebugMessageInsertARB(int source, int type, int local_id, int severity, ByteBuffer buf)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDebugMessageInsertARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(buf);
    nglDebugMessageInsertARB(source, type, local_id, severity, buf.remaining(), MemoryUtil.getAddress(buf), function_pointer);
  }
  ...
  public static void glDebugMessageInsertARB(int source, int type, int local_id, int severity, CharSequence buf)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDebugMessageInsertARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDebugMessageInsertARB(source, type, local_id, severity, buf.length(), APIUtil.getBuffer(caps, buf), function_pointer);
  }
