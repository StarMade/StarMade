...
public final class GL11
{
  ...
  public static void glAccum(int local_op, float value)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glAccum;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglAccum(local_op, value, function_pointer);
  }
  ...
  public static void glArrayElement(int local_i)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glArrayElement;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglArrayElement(local_i, function_pointer);
  }
  ...
  public static void glCopyTexSubImage2D(int target, int level, int xoffset, int yoffset, int local_x, int local_y, int width, int height)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glCopyTexSubImage2D;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglCopyTexSubImage2D(target, level, xoffset, yoffset, local_x, local_y, width, height, function_pointer);
  }
  ...
  public static void glCopyTexSubImage1D(int target, int level, int xoffset, int local_x, int local_y, int width)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glCopyTexSubImage1D;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglCopyTexSubImage1D(target, level, xoffset, local_x, local_y, width, function_pointer);
  }
  ...
  public static void glCopyTexImage2D(int target, int level, int internalFormat, int local_x, int local_y, int width, int height, int border)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glCopyTexImage2D;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglCopyTexImage2D(target, level, internalFormat, local_x, local_y, width, height, border, function_pointer);
  }
  ...
  public static void glCopyTexImage1D(int target, int level, int internalFormat, int local_x, int local_y, int width, int border)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glCopyTexImage1D;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglCopyTexImage1D(target, level, internalFormat, local_x, local_y, width, border, function_pointer);
  }
  ...
  public static void glCopyPixels(int local_x, int local_y, int width, int height, int type)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glCopyPixels;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglCopyPixels(local_x, local_y, width, height, type, function_pointer);
  }
  ...
  public static void glGetMap(int target, int query, FloatBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetMapfv;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 256);
    nglGetMapfv(target, query, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglGetMapfv(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glGetMap(int target, int query, DoubleBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetMapdv;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 256);
    nglGetMapdv(target, query, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglGetMapdv(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glGetMap(int target, int query, IntBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetMapiv;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_v, 256);
    nglGetMapiv(target, query, MemoryUtil.getAddress(local_v), function_pointer);
  }
  ...
  public static void glMapGrid1f(int local_un, float local_u1, float local_u2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMapGrid1f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglMapGrid1f(local_un, local_u1, local_u2, function_pointer);
  }
  
  static native void nglMapGrid1f(int paramInt, float paramFloat1, float paramFloat2, long paramLong);
  
  public static void glMapGrid1d(int local_un, double local_u1, double local_u2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMapGrid1d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglMapGrid1d(local_un, local_u1, local_u2, function_pointer);
  }
  
  static native void nglMapGrid1d(int paramInt, double paramDouble1, double paramDouble2, long paramLong);
  
  public static void glMapGrid2f(int local_un, float local_u1, float local_u2, int local_vn, float local_v1, float local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMapGrid2f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglMapGrid2f(local_un, local_u1, local_u2, local_vn, local_v1, local_v2, function_pointer);
  }
  ...
  public static void glMapGrid2d(int local_un, double local_u1, double local_u2, int local_vn, double local_v1, double local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMapGrid2d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglMapGrid2d(local_un, local_u1, local_u2, local_vn, local_v1, local_v2, function_pointer);
  }
  ...
  public static void glMap2f(int target, float local_u1, float local_u2, int ustride, int uorder, float local_v1, float local_v2, int vstride, int vorder, FloatBuffer points)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMap2f;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(points);
    nglMap2f(target, local_u1, local_u2, ustride, uorder, local_v1, local_v2, vstride, vorder, MemoryUtil.getAddress(points), function_pointer);
  }
  ...
  public static void glMap2d(int target, double local_u1, double local_u2, int ustride, int uorder, double local_v1, double local_v2, int vstride, int vorder, DoubleBuffer points)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMap2d;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(points);
    nglMap2d(target, local_u1, local_u2, ustride, uorder, local_v1, local_v2, vstride, vorder, MemoryUtil.getAddress(points), function_pointer);
  }
  ...
  public static void glMap1f(int target, float local_u1, float local_u2, int stride, int order, FloatBuffer points)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMap1f;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(points);
    nglMap1f(target, local_u1, local_u2, stride, order, MemoryUtil.getAddress(points), function_pointer);
  }
  ...
  public static void glMap1d(int target, double local_u1, double local_u2, int stride, int order, DoubleBuffer points)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMap1d;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(points);
    nglMap1d(target, local_u1, local_u2, stride, order, MemoryUtil.getAddress(points), function_pointer);
  }
  ...
  public static void glLoadMatrix(FloatBuffer local_m)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glLoadMatrixf;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_m, 16);
    nglLoadMatrixf(MemoryUtil.getAddress(local_m), function_pointer);
  }
  
  static native void nglLoadMatrixf(long paramLong1, long paramLong2);
  
  public static void glLoadMatrix(DoubleBuffer local_m)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glLoadMatrixd;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_m, 16);
    nglLoadMatrixd(MemoryUtil.getAddress(local_m), function_pointer);
  }
  ...
  public static void glNormal3b(byte local_nx, byte local_ny, byte local_nz)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glNormal3b;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglNormal3b(local_nx, local_ny, local_nz, function_pointer);
  }
  
  static native void nglNormal3b(byte paramByte1, byte paramByte2, byte paramByte3, long paramLong);
  
  public static void glNormal3f(float local_nx, float local_ny, float local_nz)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glNormal3f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglNormal3f(local_nx, local_ny, local_nz, function_pointer);
  }
  
  static native void nglNormal3f(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong);
  
  public static void glNormal3d(double local_nx, double local_ny, double local_nz)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glNormal3d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglNormal3d(local_nx, local_ny, local_nz, function_pointer);
  }
  
  static native void nglNormal3d(double paramDouble1, double paramDouble2, double paramDouble3, long paramLong);
  
  public static void glNormal3i(int local_nx, int local_ny, int local_nz)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glNormal3i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglNormal3i(local_nx, local_ny, local_nz, function_pointer);
  }
  ...
  public static void glMultMatrix(FloatBuffer local_m)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMultMatrixf;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_m, 16);
    nglMultMatrixf(MemoryUtil.getAddress(local_m), function_pointer);
  }
  
  static native void nglMultMatrixf(long paramLong1, long paramLong2);
  
  public static void glMultMatrix(DoubleBuffer local_m)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMultMatrixd;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(local_m, 16);
    nglMultMatrixd(MemoryUtil.getAddress(local_m), function_pointer);
  }
  ...
  public static void glScissor(int local_x, int local_y, int width, int height)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glScissor;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglScissor(local_x, local_y, width, height, function_pointer);
  }
  
  static native void nglScissor(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong);
  
  public static void glScalef(float local_x, float local_y, float local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glScalef;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglScalef(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglScalef(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong);
  
  public static void glScaled(double local_x, double local_y, double local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glScaled;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglScaled(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglScaled(double paramDouble1, double paramDouble2, double paramDouble3, long paramLong);
  
  public static void glRotatef(float angle, float local_x, float local_y, float local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRotatef;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRotatef(angle, local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglRotatef(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, long paramLong);
  
  public static void glRotated(double angle, double local_x, double local_y, double local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRotated;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRotated(angle, local_x, local_y, local_z, function_pointer);
  }
  ...
  public static void glRectf(float local_x1, float local_y1, float local_x2, float local_y2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRectf;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRectf(local_x1, local_y1, local_x2, local_y2, function_pointer);
  }
  
  static native void nglRectf(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, long paramLong);
  
  public static void glRectd(double local_x1, double local_y1, double local_x2, double local_y2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRectd;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRectd(local_x1, local_y1, local_x2, local_y2, function_pointer);
  }
  ...
  public static void glRecti(int local_x1, int local_y1, int local_x2, int local_y2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRecti;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRecti(local_x1, local_y1, local_x2, local_y2, function_pointer);
  }
  
  static native void nglRecti(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong);
  
  public static void glReadPixels(int local_x, int local_y, int width, int height, int format, int type, ByteBuffer pixels)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    ...
    GLChecks.ensurePackPBOdisabled(caps);
    BufferChecks.checkBuffer(pixels, GLChecks.calculateImageStorage(pixels, format, type, width, height, 1));
    nglReadPixels(local_x, local_y, width, height, format, type, MemoryUtil.getAddress(pixels), function_pointer);
  }
  
  public static void glReadPixels(int local_x, int local_y, int width, int height, int format, int type, DoubleBuffer pixels)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glReadPixels;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glReadPixels(int local_x, int local_y, int width, int height, int format, int type, FloatBuffer pixels)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glReadPixels;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glReadPixels(int local_x, int local_y, int width, int height, int format, int type, IntBuffer pixels)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glReadPixels;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glReadPixels(int local_x, int local_y, int width, int height, int format, int type, ShortBuffer pixels)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glReadPixels;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glReadPixels(int local_x, int local_y, int width, int height, int format, int type, long pixels_buffer_offset)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glReadPixels;
    BufferChecks.checkFunctionAddress(function_pointer);
    GLChecks.ensurePackPBOenabled(caps);
    nglReadPixelsBO(local_x, local_y, width, height, format, type, pixels_buffer_offset, function_pointer);
  }
  ...
  public static void glRasterPos2f(float local_x, float local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRasterPos2f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRasterPos2f(local_x, local_y, function_pointer);
  }
  
  static native void nglRasterPos2f(float paramFloat1, float paramFloat2, long paramLong);
  
  public static void glRasterPos2d(double local_x, double local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRasterPos2d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRasterPos2d(local_x, local_y, function_pointer);
  }
  
  static native void nglRasterPos2d(double paramDouble1, double paramDouble2, long paramLong);
  
  public static void glRasterPos2i(int local_x, int local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRasterPos2i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRasterPos2i(local_x, local_y, function_pointer);
  }
  
  static native void nglRasterPos2i(int paramInt1, int paramInt2, long paramLong);
  
  public static void glRasterPos3f(float local_x, float local_y, float local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRasterPos3f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRasterPos3f(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglRasterPos3f(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong);
  
  public static void glRasterPos3d(double local_x, double local_y, double local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRasterPos3d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRasterPos3d(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglRasterPos3d(double paramDouble1, double paramDouble2, double paramDouble3, long paramLong);
  
  public static void glRasterPos3i(int local_x, int local_y, int local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRasterPos3i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRasterPos3i(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglRasterPos3i(int paramInt1, int paramInt2, int paramInt3, long paramLong);
  
  public static void glRasterPos4f(float local_x, float local_y, float local_z, float local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRasterPos4f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRasterPos4f(local_x, local_y, local_z, local_w, function_pointer);
  }
  
  static native void nglRasterPos4f(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, long paramLong);
  
  public static void glRasterPos4d(double local_x, double local_y, double local_z, double local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRasterPos4d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRasterPos4d(local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glRasterPos4i(int local_x, int local_y, int local_z, int local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glRasterPos4i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglRasterPos4i(local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertex2f(float local_x, float local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertex2f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertex2f(local_x, local_y, function_pointer);
  }
  
  static native void nglVertex2f(float paramFloat1, float paramFloat2, long paramLong);
  
  public static void glVertex2d(double local_x, double local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertex2d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertex2d(local_x, local_y, function_pointer);
  }
  
  static native void nglVertex2d(double paramDouble1, double paramDouble2, long paramLong);
  
  public static void glVertex2i(int local_x, int local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertex2i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertex2i(local_x, local_y, function_pointer);
  }
  
  static native void nglVertex2i(int paramInt1, int paramInt2, long paramLong);
  
  public static void glVertex3f(float local_x, float local_y, float local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertex3f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertex3f(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglVertex3f(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong);
  
  public static void glVertex3d(double local_x, double local_y, double local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertex3d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertex3d(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglVertex3d(double paramDouble1, double paramDouble2, double paramDouble3, long paramLong);
  
  public static void glVertex3i(int local_x, int local_y, int local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertex3i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertex3i(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglVertex3i(int paramInt1, int paramInt2, int paramInt3, long paramLong);
  
  public static void glVertex4f(float local_x, float local_y, float local_z, float local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertex4f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertex4f(local_x, local_y, local_z, local_w, function_pointer);
  }
  
  static native void nglVertex4f(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, long paramLong);
  
  public static void glVertex4d(double local_x, double local_y, double local_z, double local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertex4d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertex4d(local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertex4i(int local_x, int local_y, int local_z, int local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertex4i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertex4i(local_x, local_y, local_z, local_w, function_pointer);
  }
  
  static native void nglVertex4i(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong);
  
  public static void glTranslatef(float local_x, float local_y, float local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glTranslatef;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglTranslatef(local_x, local_y, local_z, function_pointer);
  }
  
  static native void nglTranslatef(float paramFloat1, float paramFloat2, float paramFloat3, long paramLong);
  
  public static void glTranslated(double local_x, double local_y, double local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glTranslated;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglTranslated(local_x, local_y, local_z, function_pointer);
  }
  ...
  public static void glViewport(int local_x, int local_y, int width, int height)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glViewport;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglViewport(local_x, local_y, width, height, function_pointer);
  }
