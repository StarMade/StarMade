...
public final class ARBShaderObjects
{
  ...
  public static void glUniform1fARB(int location, float local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform1fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform1fARB(location, local_v0, function_pointer);
  }
  
  static native void nglUniform1fARB(int paramInt, float paramFloat, long paramLong);
  
  public static void glUniform2fARB(int location, float local_v0, float local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform2fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform2fARB(location, local_v0, local_v1, function_pointer);
  }
  
  static native void nglUniform2fARB(int paramInt, float paramFloat1, float paramFloat2, long paramLong);
  
  public static void glUniform3fARB(int location, float local_v0, float local_v1, float local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform3fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform3fARB(location, local_v0, local_v1, local_v2, function_pointer);
  }
  
  static native void nglUniform3fARB(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3, long paramLong);
  
  public static void glUniform4fARB(int location, float local_v0, float local_v1, float local_v2, float local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform4fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform4fARB(location, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glUniform1iARB(int location, int local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform1iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform1iARB(location, local_v0, function_pointer);
  }
  
  static native void nglUniform1iARB(int paramInt1, int paramInt2, long paramLong);
  
  public static void glUniform2iARB(int location, int local_v0, int local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform2iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform2iARB(location, local_v0, local_v1, function_pointer);
  }
  
  static native void nglUniform2iARB(int paramInt1, int paramInt2, int paramInt3, long paramLong);
  
  public static void glUniform3iARB(int location, int local_v0, int local_v1, int local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform3iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform3iARB(location, local_v0, local_v1, local_v2, function_pointer);
  }
  
  static native void nglUniform3iARB(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong);
  
  public static void glUniform4iARB(int location, int local_v0, int local_v1, int local_v2, int local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform4iARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform4iARB(location, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
