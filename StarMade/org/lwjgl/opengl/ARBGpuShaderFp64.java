...
public final class ARBGpuShaderFp64
{
  ...
  public static void glUniform1d(int location, double local_x)
  {
    GL40.glUniform1d(location, local_x);
  }
  
  public static void glUniform2d(int location, double local_x, double local_y)
  {
    GL40.glUniform2d(location, local_x, local_y);
  }
  
  public static void glUniform3d(int location, double local_x, double local_y, double local_z)
  {
    GL40.glUniform3d(location, local_x, local_y, local_z);
  }
  
  public static void glUniform4d(int location, double local_x, double local_y, double local_z, double local_w)
  {
    GL40.glUniform4d(location, local_x, local_y, local_z, local_w);
  }
  ...
  public static void glProgramUniform1dEXT(int program, int location, double local_x)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform1dEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform1dEXT(program, location, local_x, function_pointer);
  }
  
  static native void nglProgramUniform1dEXT(int paramInt1, int paramInt2, double paramDouble, long paramLong);
  
  public static void glProgramUniform2dEXT(int program, int location, double local_x, double local_y)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform2dEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform2dEXT(program, location, local_x, local_y, function_pointer);
  }
  ...
  public static void glProgramUniform3dEXT(int program, int location, double local_x, double local_y, double local_z)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform3dEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform3dEXT(program, location, local_x, local_y, local_z, function_pointer);
  }
  ...
  public static void glProgramUniform4dEXT(int program, int location, double local_x, double local_y, double local_z, double local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramUniform4dEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramUniform4dEXT(program, location, local_x, local_y, local_z, local_w, function_pointer);
  }
