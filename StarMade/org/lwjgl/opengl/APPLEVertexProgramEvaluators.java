...
public final class APPLEVertexProgramEvaluators
{
  ...
  public static void glMapVertexAttrib1dAPPLE(int index, int size, double local_u1, double local_u2, int stride, int order, DoubleBuffer points)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMapVertexAttrib1dAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(points);
    nglMapVertexAttrib1dAPPLE(index, size, local_u1, local_u2, stride, order, MemoryUtil.getAddress(points), function_pointer);
  }
  ...
  public static void glMapVertexAttrib1fAPPLE(int index, int size, float local_u1, float local_u2, int stride, int order, FloatBuffer points)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMapVertexAttrib1fAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(points);
    nglMapVertexAttrib1fAPPLE(index, size, local_u1, local_u2, stride, order, MemoryUtil.getAddress(points), function_pointer);
  }
  ...
  public static void glMapVertexAttrib2dAPPLE(int index, int size, double local_u1, double local_u2, int ustride, int uorder, double local_v1, double local_v2, int vstride, int vorder, DoubleBuffer points)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMapVertexAttrib2dAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(points);
    nglMapVertexAttrib2dAPPLE(index, size, local_u1, local_u2, ustride, uorder, local_v1, local_v2, vstride, vorder, MemoryUtil.getAddress(points), function_pointer);
  }
  ...
  public static void glMapVertexAttrib2fAPPLE(int index, int size, float local_u1, float local_u2, int ustride, int uorder, float local_v1, float local_v2, int vstride, int vorder, FloatBuffer points)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glMapVertexAttrib2fAPPLE;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(points);
    nglMapVertexAttrib2fAPPLE(index, size, local_u1, local_u2, ustride, uorder, local_v1, local_v2, vstride, vorder, MemoryUtil.getAddress(points), function_pointer);
  }
