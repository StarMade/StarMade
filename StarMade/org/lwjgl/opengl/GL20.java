...
public final class GL20
{
  ...
  public static void glUniform1f(int location, float local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform1f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform1f(location, local_v0, function_pointer);
  }
  
  static native void nglUniform1f(int paramInt, float paramFloat, long paramLong);
  
  public static void glUniform2f(int location, float local_v0, float local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform2f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform2f(location, local_v0, local_v1, function_pointer);
  }
  
  static native void nglUniform2f(int paramInt, float paramFloat1, float paramFloat2, long paramLong);
  
  public static void glUniform3f(int location, float local_v0, float local_v1, float local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform3f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform3f(location, local_v0, local_v1, local_v2, function_pointer);
  }
  
  static native void nglUniform3f(int paramInt, float paramFloat1, float paramFloat2, float paramFloat3, long paramLong);
  
  public static void glUniform4f(int location, float local_v0, float local_v1, float local_v2, float local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform4f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform4f(location, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glUniform1i(int location, int local_v0)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform1i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform1i(location, local_v0, function_pointer);
  }
  
  static native void nglUniform1i(int paramInt1, int paramInt2, long paramLong);
  
  public static void glUniform2i(int location, int local_v0, int local_v1)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform2i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform2i(location, local_v0, local_v1, function_pointer);
  }
  
  static native void nglUniform2i(int paramInt1, int paramInt2, int paramInt3, long paramLong);
  
  public static void glUniform3i(int location, int local_v0, int local_v1, int local_v2)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform3i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform3i(location, local_v0, local_v1, local_v2, function_pointer);
  }
  
  static native void nglUniform3i(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong);
  
  public static void glUniform4i(int location, int local_v0, int local_v1, int local_v2, int local_v3)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glUniform4i;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglUniform4i(location, local_v0, local_v1, local_v2, local_v3, function_pointer);
  }
  ...
  public static void glVertexAttrib4s(int index, short local_x, short local_y, short local_z, short local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4s;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4s(index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttrib4f(int index, float local_x, float local_y, float local_z, float local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4f;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4f(index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttrib4d(int index, double local_x, double local_y, double local_z, double local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4d;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4d(index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttrib4Nub(int index, byte local_x, byte local_y, byte local_z, byte local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4Nub;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4Nub(index, local_x, local_y, local_z, local_w, function_pointer);
  }
