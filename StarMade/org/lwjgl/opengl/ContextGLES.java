  ...
  implements Context
{
  ...
  ContextGLES(DrawableGLES drawable, ContextAttribs attribs, ContextGLES shared_context)
  ...
  public static void setSwapInterval(int value)
  {
    ...
    if (current_context != null) {
      ...
      {
        LWJGLUtil.log("Failed to set swap interval. Reason: " + local_e.getMessage());
      }
    }
  }
