...
public final class EXTTextureInteger
{
  ...
  public static void glClearColorIiEXT(int local_r, int local_g, int local_b, int local_a)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glClearColorIiEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglClearColorIiEXT(local_r, local_g, local_b, local_a, function_pointer);
  }
  
  static native void nglClearColorIiEXT(int paramInt1, int paramInt2, int paramInt3, int paramInt4, long paramLong);
  
  public static void glClearColorIuiEXT(int local_r, int local_g, int local_b, int local_a)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glClearColorIuiEXT;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglClearColorIuiEXT(local_r, local_g, local_b, local_a, function_pointer);
  }
