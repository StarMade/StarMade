  ...
  extends NVProgram
{
  ...
  public static void glExecuteProgramNV(int target, int local_id, FloatBuffer params)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glExecuteProgramNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 4);
    nglExecuteProgramNV(target, local_id, MemoryUtil.getAddress(params), function_pointer);
  }
  ...
  public static void glProgramParameter4fNV(int target, int index, float local_x, float local_y, float local_z, float local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramParameter4fNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramParameter4fNV(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glProgramParameter4dNV(int target, int index, double local_x, double local_y, double local_z, double local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramParameter4dNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramParameter4dNV(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttrib4sNV(int index, short local_x, short local_y, short local_z, short local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4sNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4sNV(index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttrib4fNV(int index, float local_x, float local_y, float local_z, float local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4fNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4fNV(index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttrib4dNV(int index, double local_x, double local_y, double local_z, double local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4dNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4dNV(index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttrib4ubNV(int index, byte local_x, byte local_y, byte local_z, byte local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttrib4ubNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglVertexAttrib4ubNV(index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glVertexAttribs1NV(int index, ShortBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs1svNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs1svNV(index, local_v.remaining(), MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs1svNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs1NV(int index, FloatBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs1fvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs1fvNV(index, local_v.remaining(), MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs1fvNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs1NV(int index, DoubleBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs1dvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs1dvNV(index, local_v.remaining(), MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs1dvNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs2NV(int index, ShortBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs2svNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs2svNV(index, local_v.remaining() >> 1, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs2svNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs2NV(int index, FloatBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs2fvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs2fvNV(index, local_v.remaining() >> 1, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs2fvNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs2NV(int index, DoubleBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs2dvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs2dvNV(index, local_v.remaining() >> 1, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs2dvNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs3NV(int index, ShortBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs3svNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs3svNV(index, local_v.remaining() / 3, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs3svNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs3NV(int index, FloatBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs3fvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs3fvNV(index, local_v.remaining() / 3, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs3fvNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs3NV(int index, DoubleBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs3dvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs3dvNV(index, local_v.remaining() / 3, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs3dvNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs4NV(int index, ShortBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs4svNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs4svNV(index, local_v.remaining() >> 2, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs4svNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs4NV(int index, FloatBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs4fvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs4fvNV(index, local_v.remaining() >> 2, MemoryUtil.getAddress(local_v), function_pointer);
  }
  
  static native void nglVertexAttribs4fvNV(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static void glVertexAttribs4NV(int index, DoubleBuffer local_v)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glVertexAttribs4dvNV;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkDirect(local_v);
    nglVertexAttribs4dvNV(index, local_v.remaining() >> 2, MemoryUtil.getAddress(local_v), function_pointer);
  }
