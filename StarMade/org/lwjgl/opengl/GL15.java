...
public final class GL15
{
  ...
  public static void glDeleteQueries(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glDeleteQueries;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglDeleteQueries(1, APIUtil.getInt(caps, local_id), function_pointer);
  }
  
  public static boolean glIsQuery(int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glIsQuery;
    BufferChecks.checkFunctionAddress(function_pointer);
    boolean __result = nglIsQuery(local_id, function_pointer);
    return __result;
  }
  
  static native boolean nglIsQuery(int paramInt, long paramLong);
  
  public static void glBeginQuery(int target, int local_id)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glBeginQuery;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglBeginQuery(target, local_id, function_pointer);
  }
  ...
  public static void glGetQueryObject(int local_id, int pname, IntBuffer params)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetQueryObjectiv;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
    nglGetQueryObjectiv(local_id, pname, MemoryUtil.getAddress(params), function_pointer);
  }
  
  static native void nglGetQueryObjectiv(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static int glGetQueryObjecti(int local_id, int pname)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetQueryObjectiv;
    BufferChecks.checkFunctionAddress(function_pointer);
  ...
  public static void glGetQueryObjectu(int local_id, int pname, IntBuffer params)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetQueryObjectuiv;
    BufferChecks.checkFunctionAddress(function_pointer);
    BufferChecks.checkBuffer(params, 1);
    nglGetQueryObjectuiv(local_id, pname, MemoryUtil.getAddress(params), function_pointer);
  }
  
  static native void nglGetQueryObjectuiv(int paramInt1, int paramInt2, long paramLong1, long paramLong2);
  
  public static int glGetQueryObjectui(int local_id, int pname)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glGetQueryObjectuiv;
    BufferChecks.checkFunctionAddress(function_pointer);
