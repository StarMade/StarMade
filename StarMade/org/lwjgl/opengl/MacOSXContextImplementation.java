  ...
  implements ContextImplementation
{
    ...
    throws LWJGLException
  {
    ...
    try
    {
      ByteBuffer localByteBuffer1 = nCreate(peer_handle, shared_context_handle);
  ...
  private static native ByteBuffer nCreate(ByteBuffer paramByteBuffer1, ByteBuffer paramByteBuffer2)
    throws LWJGLException;
  ...
  private static native void clearDrawable(ByteBuffer paramByteBuffer)
    throws LWJGLException;
  
  static void resetView(PeerInfo peer_info, ContextGL context)
    throws LWJGLException
  {
    ByteBuffer peer_handle = peer_info.lockAndGetHandle();
    try
  ...
  private static native void setView(ByteBuffer paramByteBuffer1, ByteBuffer paramByteBuffer2)
    throws LWJGLException;
  
  private static native void nMakeCurrent(ByteBuffer paramByteBuffer)
    throws LWJGLException;
