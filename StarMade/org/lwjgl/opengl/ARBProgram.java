...
public class ARBProgram
{
  ...
  public static void glProgramEnvParameter4fARB(int target, int index, float local_x, float local_y, float local_z, float local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramEnvParameter4fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramEnvParameter4fARB(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glProgramEnvParameter4dARB(int target, int index, double local_x, double local_y, double local_z, double local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramEnvParameter4dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramEnvParameter4dARB(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glProgramLocalParameter4fARB(int target, int index, float local_x, float local_y, float local_z, float local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramLocalParameter4fARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramLocalParameter4fARB(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
  ...
  public static void glProgramLocalParameter4dARB(int target, int index, double local_x, double local_y, double local_z, double local_w)
  {
    ContextCapabilities caps = GLContext.getCapabilities();
    long function_pointer = caps.glProgramLocalParameter4dARB;
    BufferChecks.checkFunctionAddress(function_pointer);
    nglProgramLocalParameter4dARB(target, index, local_x, local_y, local_z, local_w, function_pointer);
  }
