...
public class BufferChecks
{
  ...
  public static void checkNullTerminated(ByteBuffer buf, int count)
  {
    ...
    {
      int nullFound = 0;
      for (int local_i = buf.position(); local_i < buf.limit(); local_i++) {
        if (buf.get(local_i) == 0) {
          nullFound++;
        }
      }
      if (nullFound < count) {
  ...
  public static void checkNotNull(Object local_o)
  {
    if ((LWJGLUtil.CHECKS) && (local_o == null)) {
