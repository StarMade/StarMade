...
{
  public static void setup(MappedObject local_mo, ByteBuffer buffer, int align, int sizeof)
  {
    if ((LWJGLUtil.CHECKS) && (local_mo.baseAddress != 0L)) {
    ...
    local_mo.baseAddress = (local_mo.viewAddress = addr);
  }
