  ...
  implements Serializable
{
  ...
  public static Vector3f transform(Matrix3f left, Vector3f right, Vector3f dest)
  {
    ...
    float local_x = left.m00 * right.field_140 + left.m10 * right.field_141 + left.m20 * right.field_142;
    float local_y = left.m01 * right.field_140 + left.m11 * right.field_141 + left.m21 * right.field_142;
    float local_z = left.m02 * right.field_140 + left.m12 * right.field_141 + left.m22 * right.field_142;
  ...
  {
    float local_f = this.m00 * (this.m11 * this.m22 - this.m12 * this.m21) + this.m01 * (this.m12 * this.m20 - this.m10 * this.m22) + this.m02 * (this.m10 * this.m21 - this.m11 * this.m20);
    return local_f;
  }
  ...
  public static Matrix3f setIdentity(Matrix3f local_m)
  {
    local_m.m00 = 1.0F;
    local_m.m01 = 0.0F;
    local_m.m02 = 0.0F;
  ...
  public static Matrix3f setZero(Matrix3f local_m)
  {
    local_m.m00 = 0.0F;
    local_m.m01 = 0.0F;
    local_m.m02 = 0.0F;
