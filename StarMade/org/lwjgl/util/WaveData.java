...
public class WaveData
{
  ...
  public static WaveData create(URL path)
  {
    ...
    {
      LWJGLUtil.log("Unable to create from: " + path + ", " + wfr.getMessage());
    }
    return null;
  }
  ...
  public static WaveData create(InputStream local_is)
  {
    try
    {
    ...
    {
      LWJGLUtil.log("Unable to create from inputstream, " + local_e.getMessage());
    }
    return null;
  }
  ...
  public static WaveData create(byte[] buffer)
  {
    ...
    {
      LWJGLUtil.log("Unable to create from byte array, " + local_e.getMessage());
    }
    return null;
  }
  ...
  public static WaveData create(ByteBuffer buffer)
  {
    ...
    {
      LWJGLUtil.log("Unable to create from ByteBuffer, " + bytes.getMessage());
    }
    return null;
  }
  ...
  public static WaveData create(AudioInputStream ais)
  {
    ...
    WaveData available = new WaveData(buffer, channels, (int)audioformat.getSampleRate());
    try
    {
      ais.close();
    }
