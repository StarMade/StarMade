...
public class GLU
{
  static final float field_1827 = 3.141593F;
  ...
  public static void gluPickMatrix(float local_x, float local_y, float width, float height, IntBuffer viewport)
  {
    Project.gluPickMatrix(local_x, local_y, width, height, viewport);
  }
