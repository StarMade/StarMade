...
public class CLDeviceCapabilities
{
  ...
  public CLDeviceCapabilities(CLDevice device)
  {
    ...
    this.CL_AMD_device_attribute_query = tokenizer.contains("cl_amd_device_attribute_query");
    this.CL_AMD_device_memory_flags = tokenizer.contains("cl_amd_device_memory_flags");
    this.CL_AMD_fp64 = tokenizer.contains("cl_amd_fp64");
    this.CL_AMD_media_ops = tokenizer.contains("cl_amd_media_ops");
    this.CL_AMD_media_ops2 = tokenizer.contains("cl_amd_media_ops2");
    this.CL_AMD_offline_devices = tokenizer.contains("cl_amd_offline_devices");
    this.CL_AMD_popcnt = tokenizer.contains("cl_amd_popcnt");
    this.CL_AMD_printf = tokenizer.contains("cl_amd_printf");
    this.CL_AMD_vec3 = tokenizer.contains("cl_amd_vec3");
    this.CL_APPLE_ContextLoggingFunctions = ((tokenizer.contains("cl_apple_contextloggingfunctions")) && (CLCapabilities.CL_APPLE_ContextLoggingFunctions));
    this.CL_APPLE_SetMemObjectDestructor = ((tokenizer.contains("cl_apple_setmemobjectdestructor")) && (CLCapabilities.CL_APPLE_SetMemObjectDestructor));
    this.CL_APPLE_gl_sharing = ((tokenizer.contains("cl_apple_gl_sharing")) && (CLCapabilities.CL_APPLE_gl_sharing));
    this.CL_EXT_atomic_counters_32 = tokenizer.contains("cl_ext_atomic_counters_32");
    this.CL_EXT_atomic_counters_64 = tokenizer.contains("cl_ext_atomic_counters_64");
    this.CL_EXT_device_fission = ((tokenizer.contains("cl_ext_device_fission")) && (CLCapabilities.CL_EXT_device_fission));
    this.CL_EXT_migrate_memobject = ((tokenizer.contains("cl_ext_migrate_memobject")) && (CLCapabilities.CL_EXT_migrate_memobject));
    this.CL_INTEL_immediate_execution = tokenizer.contains("cl_intel_immediate_execution");
    this.CL_INTEL_printf = tokenizer.contains("cl_intel_printf");
    this.CL_INTEL_thread_local_exec = tokenizer.contains("cl_intel_thread_local_exec");
    this.CL_KHR_3d_image_writes = tokenizer.contains("cl_khr_3d_image_writes");
    this.CL_KHR_byte_addressable_store = tokenizer.contains("cl_khr_byte_addressable_store");
    this.CL_KHR_depth_images = tokenizer.contains("cl_khr_depth_images");
    this.CL_KHR_fp16 = tokenizer.contains("cl_khr_fp16");
    this.CL_KHR_fp64 = tokenizer.contains("cl_khr_fp64");
    this.CL_KHR_gl_depth_images = tokenizer.contains("cl_khr_gl_depth_images");
    this.CL_KHR_gl_event = ((tokenizer.contains("cl_khr_gl_event")) && (CLCapabilities.CL_KHR_gl_event));
    this.CL_KHR_gl_msaa_sharing = tokenizer.contains("cl_khr_gl_msaa_sharing");
    this.CL_KHR_gl_sharing = ((tokenizer.contains("cl_khr_gl_sharing")) && (CLCapabilities.CL_KHR_gl_sharing));
    this.CL_KHR_global_int32_base_atomics = tokenizer.contains("cl_khr_global_int32_base_atomics");
    this.CL_KHR_global_int32_extended_atomics = tokenizer.contains("cl_khr_global_int32_extended_atomics");
    this.CL_KHR_image2d_from_buffer = tokenizer.contains("cl_khr_image2d_from_buffer");
    this.CL_KHR_initialize_memory = tokenizer.contains("cl_khr_initialize_memory");
    this.CL_KHR_int64_base_atomics = tokenizer.contains("cl_khr_int64_base_atomics");
    this.CL_KHR_int64_extended_atomics = tokenizer.contains("cl_khr_int64_extended_atomics");
    this.CL_KHR_local_int32_base_atomics = tokenizer.contains("cl_khr_local_int32_base_atomics");
    this.CL_KHR_local_int32_extended_atomics = tokenizer.contains("cl_khr_local_int32_extended_atomics");
    this.CL_KHR_select_fprounding_mode = tokenizer.contains("cl_khr_select_fprounding_mode");
    this.CL_KHR_spir = tokenizer.contains("cl_khr_spir");
    this.CL_KHR_terminate_context = ((tokenizer.contains("cl_khr_terminate_context")) && (CLCapabilities.CL_KHR_terminate_context));
    this.CL_NV_compiler_options = tokenizer.contains("cl_nv_compiler_options");
    this.CL_NV_device_attribute_query = tokenizer.contains("cl_nv_device_attribute_query");
    this.CL_NV_pragma_unroll = tokenizer.contains("cl_nv_pragma_unroll");
  }
