...
public final class CL10
{
  ...
  public static int clGetProgramInfo(CLProgram program, PointerBuffer sizes, ByteBuffer param_value, PointerBuffer param_value_size_ret)
  {
    ...
    int __result = nclGetProgramInfo2(program.getPointer(), 4454, sizes.remainingByte(), MemoryUtil.getAddress(sizes), MemoryUtil.getAddress(param_value), MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
    return __result;
  }
  ...
  public static int clGetProgramInfo(CLProgram program, ByteBuffer[] param_value, PointerBuffer param_value_size_ret)
  {
    ...
    int __result = nclGetProgramInfo3(program.getPointer(), 4454, param_value.length * PointerBuffer.getPointerSize(), param_value, MemoryUtil.getAddressSafe(param_value_size_ret), function_pointer);
    return __result;
  }
