...
public final class AL11
{
  ...
  public static void alListener3i(int pname, int local_v1, int local_v2, int local_v3)
  {
    nalListener3i(pname, local_v1, local_v2, local_v3);
  }
  ...
  public static void alSource3i(int source, int pname, int local_v1, int local_v2, int local_v3)
  {
    nalSource3i(source, pname, local_v1, local_v2, local_v3);
  }
  ...
  public static void alBuffer3f(int buffer, int pname, float local_v1, float local_v2, float local_v3)
  {
    nalBuffer3f(buffer, pname, local_v1, local_v2, local_v3);
  }
  ...
  public static void alBuffer3i(int buffer, int pname, int local_v1, int local_v2, int local_v3)
  {
    nalBuffer3i(buffer, pname, local_v1, local_v2, local_v3);
  }
