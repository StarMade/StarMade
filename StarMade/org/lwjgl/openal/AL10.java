...
public final class AL10
{
  ...
  public static void alListener3f(int pname, float local_v1, float local_v2, float local_v3)
  {
    nalListener3f(pname, local_v1, local_v2, local_v3);
  }
  ...
  public static boolean alIsSource(int local_id)
  {
    boolean __result = nalIsSource(local_id);
    return __result;
  }
  ...
  public static void alSource3f(int source, int pname, float local_v1, float local_v2, float local_v3)
  {
    nalSource3f(source, pname, local_v1, local_v2, local_v3);
  }
