  ...
  implements Serializable
{
  ...
  {
    Map<Object, Object> local_m = getRegistry();
    return (local_m != null) && (local_m.containsKey(value));
  }
  ...
  protected void removeLastFieldSeparator(StringBuffer buffer)
  {
    ...
    {
      boolean match = true;
      for (int local_i = 0; local_i < sepLen; local_i++) {
        if (buffer.charAt(len - 1 - local_i) != this.fieldSeparator.charAt(sepLen - 1 - local_i))
        {
          match = false;
          break;
        }
  ...
  protected void reflectionAppendArrayDetail(StringBuffer buffer, String fieldName, Object array)
  {
    ...
    {
      Object item = Array.get(array, local_i);
      if (local_i > 0) {
        buffer.append(this.arraySeparator);
      }
      if (item == null) {
  ...
  protected void appendDetail(StringBuffer buffer, String fieldName, long[] array)
  {
    ...
    for (int local_i = 0; local_i < array.length; local_i++)
    {
      ...
      appendDetail(buffer, fieldName, array[local_i]);
    }
    buffer.append(this.arrayEnd);
  }
