  ...
  implements Builder<Integer>
{
  ...
  private static void reflectionAppend(Object lhs, Object rhs, Class<?> clazz, CompareToBuilder builder, boolean useTransients, String[] excludeFields)
  {
    ...
    for (int local_i = 0; (local_i < fields.length) && (builder.comparison == 0); local_i++)
    {
  ...
  public CompareToBuilder append(Object lhs, Object rhs, Comparator<?> comparator)
  {
    ...
    {
      Comparator<Object> comparable = comparator;
      this.comparison = comparable.compare(lhs, rhs);
    }
    return this;
  }
  ...
  public CompareToBuilder append(Object[] lhs, Object[] rhs, Comparator<?> comparator)
  {
    ...
    for (int local_i = 0; (local_i < lhs.length) && (this.comparison == 0); local_i++) {
      append(lhs[local_i], rhs[local_i], comparator);
    }
    return this;
  }
