...
public class TimedSemaphore
{
  ...
  public TimedSemaphore(ScheduledExecutorService service, long timePeriod, TimeUnit timeUnit, int limit)
  {
    ...
    {
      ScheduledThreadPoolExecutor local_s = new ScheduledThreadPoolExecutor(1);
      local_s.setContinueExistingPeriodicTasksAfterShutdownPolicy(false);
      local_s.setExecuteExistingDelayedTasksAfterShutdownPolicy(false);
      this.executorService = local_s;
