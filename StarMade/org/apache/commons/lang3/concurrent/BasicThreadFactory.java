  ...
  implements ThreadFactory
{
  ...
  public Thread newThread(Runnable local_r)
  {
    Thread local_t = getWrappedFactory().newThread(local_r);
    initializeThread(local_t);
    return local_t;
  }
  
  private void initializeThread(Thread local_t)
  {
    if (getNamingPattern() != null)
    {
      Long count = Long.valueOf(this.threadCounter.incrementAndGet());
      local_t.setName(String.format(getNamingPattern(), new Object[] { count }));
    }
    if (getUncaughtExceptionHandler() != null) {
      local_t.setUncaughtExceptionHandler(getUncaughtExceptionHandler());
    }
    if (getPriority() != null) {
      local_t.setPriority(getPriority().intValue());
    }
    if (getDaemonFlag() != null) {
      local_t.setDaemon(getDaemonFlag().booleanValue());
    }
  }
    ...
    implements Builder<BasicThreadFactory>
  {
    ...
    public Builder daemon(boolean local_f)
    {
      this.daemonFlag = Boolean.valueOf(local_f);
      return this;
    }
