...
public class Validate
{
  ...
  public static <T> T[] noNullElements(T[] array, String message, Object... values)
  {
    ...
    for (int local_i = 0; local_i < array.length; local_i++) {
      ...
      {
        Object[] values2 = ArrayUtils.add(values, Integer.valueOf(local_i));
  ...
  public static <T extends Iterable<?>> T noNullElements(T iterable, String message, Object... values)
  {
    ...
    {
      if (local_it.next() == null)
      {
        Object[] values2 = ArrayUtils.addAll(values, new Object[] { Integer.valueOf(local_i) });
        throw new IllegalArgumentException(String.format(message, values2));
      }
      local_i++;
    }
