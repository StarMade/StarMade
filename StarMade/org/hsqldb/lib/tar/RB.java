  ...
  implements RefCapableRBInterface
{
  ...
  public String getExpandedString(String[] paramArrayOfString)
  {
    return vrb.getExpandedString(this, paramArrayOfString);
  }

  public String getString(String[] paramArrayOfString)
  {
    return vrb.getString(this, paramArrayOfString);
  }
