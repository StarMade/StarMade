...
public class ValidatingResourceBundle
{
  ...
  public String getString(Enum<?> paramEnum, String[] paramArrayOfString)
  {
    if (!this.enumType.isInstance(paramEnum))
      throw new IllegalArgumentException("Key is a " + paramEnum.getClass().getName() + ",not a " + this.enumType.getName() + ":  " + paramEnum);
    return this.wrappedRCPRB.getString(paramEnum.toString(), paramArrayOfString, this.missingPosValueBehavior);
  }
  ...
  public String getExpandedString(Enum<?> paramEnum, String[] paramArrayOfString)
  {
    if (!this.enumType.isInstance(paramEnum))
      throw new IllegalArgumentException("Key is a " + paramEnum.getClass().getName() + ",not a " + this.enumType.getName() + ":  " + paramEnum);
    return this.wrappedRCPRB.getExpandedString(paramEnum.toString(), paramArrayOfString, this.missingPropertyBehavior, this.missingPosValueBehavior);
  }
